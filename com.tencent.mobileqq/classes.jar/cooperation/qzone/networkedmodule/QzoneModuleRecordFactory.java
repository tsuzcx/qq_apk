...
public class QzoneModuleRecordFactory
{
  ...
  private HashMap<String, bjmw> mMethodMap = new HashMap();
  ...
  private HashMap<String, bjmw> loadMethods(Object paramObject, Class<?> paramClass)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        try
        {
          if (localObject.isAnnotationPresent(bjmr.class))
          {
            localObject.setAccessible(true);
            String str = ((bjmr)localObject.getAnnotation(bjmr.class)).a();
            bjmw localbjmw = new bjmw(null);
            localbjmw.jdField_a_of_type_JavaLangObject = paramObject;
            localbjmw.jdField_a_of_type_JavaLangReflectMethod = localObject;
            localHashMap.put(str, localbjmw);
          }
          i += 1;
        }
  ...
  @bjmr(a="upload.so")
  public bjmm createQzoneUploadSo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("upload.so").d(str1).e(str2);
    return localbjmn.a();
  }
  
  public bjmm createRecord(String paramString)
  {
    paramString = (bjmw)this.mMethodMap.get(paramString);
    if (paramString != null) {
      try
      {
        paramString = (bjmm)paramString.jdField_a_of_type_JavaLangReflectMethod.invoke(paramString.jdField_a_of_type_JavaLangObject, new Object[0]);
        return paramString;
      }
  ...
  @bjmr(a="libandroidndkbeauty.so")
  public bjmm createRecordForAntiBeautyDMSo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("libandroidndkbeauty.so").d(str1).e(str2).a(i);
    return localbjmn.a();
  }
  
  @bjmr(a="pictureMarkerSo.zip")
  public bjmm createRecordForAntishakeDMSo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("pictureMarkerSo.zip").d(str1).e(str2).a(l);
    return localbjmn.a();
  }
  
  @bjmr(a="qzlive_live_audio.jar")
  public bjmm createRecordForLiveAudioSo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("qzlive_live_audio.jar").d(str1).e(str2);
    return localbjmn.a();
  }
  
  @bjmr(a="qzlive_res1_yt_facedetect.jar")
  public bjmm createRecordForLivePtuDMSo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("qzlive_res1_yt_facedetect.jar").d(str1).e(str2);
    return localbjmn.a();
  }
  
  @bjmr(a="qzlive_res1_yt_seg_and_hand.jar")
  public bjmm createRecordForLivePtuSegAndHandDetect()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("qzlive_res1_yt_seg_and_hand.jar").d(str1).e(str2);
    return localbjmn.a();
  }
  
  @bjmr(a="osk_exoplayer2_bundle.jar")
  public bjmm createRecordForOskPlayer()
  {
    ...
    Object localObject2 = new bjmn();
    ((bjmn)localObject2).a("osk_exoplayer2_bundle.jar").d((String)localObject1).e(str1).f("com.tencent.mobileqq.qzoneplayer.player.Exo2MediaPlayer").b("1").c(bjdm.a());
    QLog.i("QzoneModuleRecordFactory", 1, "oskplayerconfig:" + str2);
    return ((bjmn)localObject2).a();
  }
  
  @bjmr(a="filterengine.bundle.jar")
  public bjmm createRecordForPtuFilterEngineJar()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("filterengine.bundle.jar").d(str1).e(str2).f("com.tencent.filterengine.bundle.BuildConfig").b("1").c(bjdm.a());
    return localbjmn.a();
  }
  
  @bjmr(a="libalgo_rithm_jni.so")
  public bjmm createRecordForPtuJniSo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("libalgo_rithm_jni.so").d(str1).e(str2).b("1").c(bjdm.a());
    return localbjmn.a();
  }
  
  @bjmr(a="libsuperresolution.jar")
  public bjmm createRecordForSuperResolutionSo()
  {
    String str1 = biln.a().a("QZoneSetting", "libSuperResolutionJarUrl", "https://d3g.qq.com/sngapp/app/update/20181204152623_3844/libsuperresolution.jar");
    String str2 = biln.a().a("QZoneSetting", "libSuperResolutionJarMD5", "6dc8f2f6f95d50ef6daef91c0f1595ec");
    bjmn localbjmn = new bjmn();
    localbjmn.a("libsuperresolution.jar").d(str1).e(str2).b("1").c(bjdm.a());
    return localbjmn.a();
  }
  
  @bjmr(a="tag_classify.jar")
  public bjmm createRecordForTagClassifySo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("tag_classify.jar").d(str1).e(str2);
    return localbjmn.a();
  }
  
  @bjmr(a="test_log.dex")
  public bjmm createRecordForTest()
  {
    bjmn localbjmn = new bjmn();
    localbjmn.a("test_log.dex").d("http://d3g.qq.com/sngapp/app/update/20161212150740_4388/qzonemodule_mapsdk.jar").e("158c17d81b2aa6c0f8347aaa64dd015b").f("com.tencent.tencentmap.mapsdk.map.Projection").b("1").c(bjdm.a());
    return localbjmn.a();
  }
  
  @bjmr(a="upload.jar")
  public bjmm createRecordForUploadJar()
  {
  ...
  public bjmm createRecordForVoiceShuoshuoAnimation()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("frameanimation.jar").d(str1).e(str2).a(l);
    return localbjmn.a();
  }
  
  @bjmr(a="vip_tar_engine.jar")
  public bjmm createRecrodForARTarEngineJar()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("vip_tar_engine.jar").d(str1).e(str2).b(str3).c(bjdm.a());
    return localbjmn.a();
  }
  
  @bjmr(a="libTar.so")
  public bjmm createRecrodForARTarEngineSo()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("libTar.so").d(str1).e(str2).b(str3).c(bjdm.a());
    return localbjmn.a();
  }
  
  @bjmr(a="animatedWebp.so")
  public bjmm createRecrodForAnimatedWebp()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("animatedWebp.so").d(str1).e(str2);
    return localbjmn.a();
  }
  
  @bjmr(a="cyber_clink_version_2.jar")
  public bjmm createRecrodForDLNAJar()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("cyber_clink_version_2.jar").d(str1).f("com.qzone.album.business.dlna.DLNAServiceImpl").e(str2);
    return localbjmn.a();
  }
  
  @bjmr(a="qzlive_filterbundle.jar")
  public bjmm createRecrodForLiveFilterBundle()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("qzlive_filterbundle.jar").d(str1).e(str2);
    return localbjmn.a();
  }
  
  @bjmr(a="xmpcore.jar")
  public bjmm createRecrodForXMPCoreJar()
  {
    ...
    bjmn localbjmn = new bjmn();
    localbjmn.a("xmpcore.jar").d(str1).e(str2);
    return localbjmn.a();
  }
}
