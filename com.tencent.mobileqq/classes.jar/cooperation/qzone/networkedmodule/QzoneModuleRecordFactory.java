...
public class QzoneModuleRecordFactory
{
  ...
  private HashMap<String, bhgn> mMethodMap = new HashMap();
  ...
  private HashMap<String, bhgn> loadMethods(Object paramObject, Class<?> paramClass)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        try
        {
          if (localObject.isAnnotationPresent(bhgi.class))
          {
            localObject.setAccessible(true);
            String str = ((bhgi)localObject.getAnnotation(bhgi.class)).a();
            bhgn localbhgn = new bhgn(null);
            localbhgn.jdField_a_of_type_JavaLangObject = paramObject;
            localbhgn.jdField_a_of_type_JavaLangReflectMethod = localObject;
            localHashMap.put(str, localbhgn);
          }
          i += 1;
        }
  ...
  @bhgi(a="upload.so")
  public bhgd createQzoneUploadSo()
  {
    ...
    localbhge.a("upload.so").d(str1).e(str2);
    return localbhge.a();
  }
  
  public bhgd createRecord(String paramString)
  {
    paramString = (bhgn)this.mMethodMap.get(paramString);
    if (paramString != null) {
      try
      {
        paramString = (bhgd)paramString.jdField_a_of_type_JavaLangReflectMethod.invoke(paramString.jdField_a_of_type_JavaLangObject, new Object[0]);
        return paramString;
      }
  ...
  @bhgi(a="libandroidndkbeauty.so")
  public bhgd createRecordForAntiBeautyDMSo()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("libandroidndkbeauty.so").d(str1).e(str2).a(i);
    return localbhge.a();
  }
  
  @bhgi(a="pictureMarkerSo.zip")
  public bhgd createRecordForAntishakeDMSo()
  {
    String str2;
    String str1;
    if (AppSetting.b)
    ...
    {
      bhge localbhge = new bhge();
      localbhge.a("pictureMarkerSo.zip").d(str2).e(str1).a(l);
      return localbhge.a();
  ...
  @bhgi(a="qzlive_live_audio.jar")
  public bhgd createRecordForLiveAudioSo()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("qzlive_live_audio.jar").d(str1).e(str2);
    return localbhge.a();
  }
  
  @bhgi(a="qzlive_res1_yt_facedetect.jar")
  public bhgd createRecordForLivePtuDMSo()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("qzlive_res1_yt_facedetect.jar").d(str1).e(str2);
    return localbhge.a();
  }
  
  @bhgi(a="qzlive_res1_yt_seg_and_hand.jar")
  public bhgd createRecordForLivePtuSegAndHandDetect()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("qzlive_res1_yt_seg_and_hand.jar").d(str1).e(str2);
    return localbhge.a();
  }
  
  @bhgi(a="osk_exoplayer2_bundle.jar")
  public bhgd createRecordForOskPlayer()
  {
    ...
    Object localObject2 = new bhge();
    ((bhge)localObject2).a("osk_exoplayer2_bundle.jar").d((String)localObject1).e(str1).f("com.tencent.mobileqq.qzoneplayer.player.Exo2MediaPlayer").b("1").c(bgxr.a());
    QLog.i("QzoneModuleRecordFactory", 1, "oskplayerconfig:" + str2);
    return ((bhge)localObject2).a();
  }
  
  @bhgi(a="filterengine.bundle.jar")
  public bhgd createRecordForPtuFilterEngineJar()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("filterengine.bundle.jar").d(str1).e(str2).f("com.tencent.filterengine.bundle.BuildConfig").b("1").c(bgxr.a());
    return localbhge.a();
  }
  
  @bhgi(a="libalgo_rithm_jni.so")
  public bhgd createRecordForPtuJniSo()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("libalgo_rithm_jni.so").d(str1).e(str2).b("1").c(bgxr.a());
    return localbhge.a();
  }
  
  @bhgi(a="libsuperresolution.jar")
  public bhgd createRecordForSuperResolutionSo()
  {
    String str2;
    if (AppSetting.b) {
      str2 = bgfr.a().a("QZoneSetting", "libSuperResolutionJarUrl_64", "https://d3g.qq.com/sngapp/app/update/20191105145019_6289/libsuperresolution.jar");
    }
    for (String str1 = bgfr.a().a("QZoneSetting", "libSuperResolutionJarMD5_64", "f12dae831c929686229d1666fffcb012");; str1 = bgfr.a().a("QZoneSetting", "libSuperResolutionJarMD5", "6dc8f2f6f95d50ef6daef91c0f1595ec"))
    {
      bhge localbhge = new bhge();
      localbhge.a("libsuperresolution.jar").d(str2).e(str1).b("1").c(bgxr.a());
      return localbhge.a();
      str2 = bgfr.a().a("QZoneSetting", "libSuperResolutionJarUrl", "https://d3g.qq.com/sngapp/app/update/20181204152623_3844/libsuperresolution.jar");
    }
  }
  
  @bhgi(a="tag_classify.jar")
  public bhgd createRecordForTagClassifySo()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("tag_classify.jar").d(str1).e(str2);
    return localbhge.a();
  }
  
  @bhgi(a="test_log.dex")
  public bhgd createRecordForTest()
  {
    bhge localbhge = new bhge();
    localbhge.a("test_log.dex").d("http://d3g.qq.com/sngapp/app/update/20161212150740_4388/qzonemodule_mapsdk.jar").e("158c17d81b2aa6c0f8347aaa64dd015b").f("com.tencent.tencentmap.mapsdk.map.Projection").b("1").c(bgxr.a());
    return localbhge.a();
  }
  
  @bhgi(a="upload.jar")
  public bhgd createRecordForUploadJar()
  {
  ...
  public bhgd createRecordForVoiceShuoshuoAnimation()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("frameanimation.jar").d(str1).e(str2).a(l);
    return localbhge.a();
  }
  
  @bhgi(a="vip_tar_engine.jar")
  public bhgd createRecrodForARTarEngineJar()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("vip_tar_engine.jar").d(str1).e(str2).b(str3).c(bgxr.a());
    return localbhge.a();
  }
  
  @bhgi(a="libTar.so")
  public bhgd createRecrodForARTarEngineSo()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("libTar.so").d(str1).e(str2).b(str3).c(bgxr.a());
    return localbhge.a();
  }
  
  @bhgi(a="animatedWebp.so")
  public bhgd createRecrodForAnimatedWebp()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("animatedWebp.so").d(str1).e(str2);
    return localbhge.a();
  }
  
  @bhgi(a="cyber_clink_version_2.jar")
  public bhgd createRecrodForDLNAJar()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("cyber_clink_version_2.jar").d(str1).f("com.qzone.album.business.dlna.DLNAServiceImpl").e(str2);
    return localbhge.a();
  }
  
  @bhgi(a="qzlive_filterbundle.jar")
  public bhgd createRecrodForLiveFilterBundle()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("qzlive_filterbundle.jar").d(str1).e(str2);
    return localbhge.a();
  }
  
  @bhgi(a="xmpcore.jar")
  public bhgd createRecrodForXMPCoreJar()
  {
    ...
    bhge localbhge = new bhge();
    localbhge.a("xmpcore.jar").d(str1).e(str2);
    return localbhge.a();
  }
}
