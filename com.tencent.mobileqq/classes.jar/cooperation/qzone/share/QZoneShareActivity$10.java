  ...
  implements TextWatcher
{
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramInt3 == 1) && (paramInt2 == 0) && (paramCharSequence.toString().substring(paramInt1, paramInt1 + 1).equals("@")))
    {
      ...
      ((ISelectMemberApi)QRoute.api(ISelectMemberApi.class)).startSelectMemberActivityForResult(this.this$0, paramCharSequence, 1000);
    }
    paramCharSequence = this.this$0;
    if (QZoneShareActivity.access$1300(paramCharSequence, QZoneShareActivity.access$1200(paramCharSequence), false)) {
