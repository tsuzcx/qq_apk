...
public final class VasRewardAdParams$Builder
{
  ...
  public VasRewardAdParams$Builder()
  {
    this(null, null, null, null, null, null, null, 127, null);
  }
  
  public VasRewardAdParams$Builder(@Nullable Integer paramInteger1, @Nullable Integer paramInteger2, @Nullable String paramString1, @Nullable String paramString2, @Nullable Long paramLong, @Nullable String paramString3, @Nullable String paramString4)
  {
  ...
  {
    ((Builder)this).jdField_a_of_type_JavaLangInteger = Integer.valueOf(paramInt);
    return (Builder)this;
  }
  
  @NotNull
  public final Builder a(@NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramString, "rewardItem");
    ((Builder)this).jdField_a_of_type_JavaLangString = paramString;
    return (Builder)this;
  }
  
  @NotNull
  public final VasRewardAdParams a()
  {
    ...
    for (;;)
    {
      return new VasRewardAdParams(i, j, str2, str3, l, (String)localObject, str1, null);
      ...
      label149:
      l = VasAdvSupport.a.a().a();
      break;
      label162:
      localObject = VasAdvSupport.a.a().a();
      break label79;
      label176:
      str1 = "biz_src_jc_vip";
    }
  ...
  {
    ((Builder)this).jdField_b_of_type_JavaLangInteger = Integer.valueOf(paramInt);
    return (Builder)this;
  }
  ...
  {
    ((Builder)this).jdField_b_of_type_JavaLangString = paramString;
    return (Builder)this;
  }
  
  @NotNull
  public final Builder c(@NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramString, "gdtBizId");
    ((Builder)this).c = paramString;
    return (Builder)this;
  }
  
  @NotNull
  public final Builder d(@NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramString, "bizSrcId");
    ((Builder)this).d = paramString;
    return (Builder)this;
  }
 ...
 * Qualified Name:     cooperation.vip.reward.VasRewardAdParams.Builder
