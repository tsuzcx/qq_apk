...
{
  public static final Parcelable.Creator<AlumBasicData> CREATOR = new bkfk();
  public int a;
  public long a;
  public String a;
  public List<bkfl> a;
  ...
  public AlumBasicData(Parcel paramParcel)
  {
    ...
    try
    {
      ...
      paramParcel.readList(this.jdField_a_of_type_JavaUtilList, bkfl.class.getClassLoader());
  ...
  public static AlumBasicData a(byte[] paramArrayOfByte)
  {
    ...
    else
    {
      ...
      if ((((vac_adv_get.VacFeedsAdvMetaInfo)localObject1).droplist.has()) && (((vac_adv_get.VacFeedsAdvMetaInfo)localObject1).droplist.get() != null) && (((vac_adv_get.VacFeedsAdvMetaInfo)localObject1).droplist.get().size() != 0))
      {
        ...
        {
          localAlumBasicData.jdField_a_of_type_JavaUtilList.add(bkfl.a((vac_adv_get.DropList)((vac_adv_get.VacFeedsAdvMetaInfo)localObject1).droplist.get().get(k)));
          k += 1;
        }
      }
