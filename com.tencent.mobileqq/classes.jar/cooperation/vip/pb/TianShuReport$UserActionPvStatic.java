  ...
  extends MessageMicro<UserActionPvStatic>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 50, 56, 64 }, new String[] { "appid", "page_id", "module_id", "sub_module_id", "rule_id", "item_id", "action_id", "value" }, new Object[] { "", "", "", "", localLong, "", Integer.valueOf(100), localLong }, UserActionPvStatic.class);
  }
}
