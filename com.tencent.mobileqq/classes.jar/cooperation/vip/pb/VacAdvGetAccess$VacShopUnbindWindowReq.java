...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "ware_house_id", "media_type", "content_type", "content_id" }, new Object[] { Integer.valueOf(100), Integer.valueOf(0), Integer.valueOf(0), "" }, VacShopUnbindWindowReq.class);
 ...
 * Qualified Name:     cooperation.vip.pb.VacAdvGetAccess.VacShopUnbindWindowReq
