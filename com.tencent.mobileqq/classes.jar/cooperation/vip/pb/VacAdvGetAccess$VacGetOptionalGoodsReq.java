...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 58, 64 }, new String[] { "ware_house_id", "media_type", "content_type", "content_id", "page_number", "page_size", "group_owner_openid", "seller_id" }, new Object[] { Integer.valueOf(100), Integer.valueOf(0), Integer.valueOf(0), "", Integer.valueOf(0), Integer.valueOf(0), "", Long.valueOf(0L) }, VacGetOptionalGoodsReq.class);
 ...
 * Qualified Name:     cooperation.vip.pb.VacAdvGetAccess.VacGetOptionalGoodsReq
