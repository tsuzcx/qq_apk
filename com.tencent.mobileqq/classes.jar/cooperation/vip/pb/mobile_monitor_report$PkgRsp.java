  ...
  extends MessageMicro<PkgRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "ret", "err_msg", "mult_cnt", "mult_delay" }, new Object[] { localInteger, "", localInteger, localInteger }, PkgRsp.class);
  }
}
