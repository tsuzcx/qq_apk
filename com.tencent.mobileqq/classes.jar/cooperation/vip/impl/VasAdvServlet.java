  ...
  extends MSFServlet
{
  ...
  static
  {
    jdField_a_of_type_CooperationVipImplVasAdvServlet$Companion = new VasAdvServlet.Companion(null);
  ...
  public void onReceive(@Nullable Intent paramIntent, @Nullable FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      paramIntent = (VasAdvCallback)jdField_a_of_type_JavaUtilMap.remove(str);
 ...
 * Qualified Name:     cooperation.vip.impl.VasAdvServlet
