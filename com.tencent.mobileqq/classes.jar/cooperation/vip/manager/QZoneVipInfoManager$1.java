  ...
  public void onSharedPreferenceChanged(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    if (paramSharedPreferences != null)
    {
      ...
      if ((!QZoneVipInfoManager.a(this.a)) && (QZoneVipInfoManager.a(this.a) != null))
      {
        ...
        {
          localObject = this.a;
          QZoneVipInfoManager.a((QZoneVipInfoManager)localObject, QZoneVipInfoManager.a((QZoneVipInfoManager)localObject).getInt(paramString, 0));
        }
        if (QZoneVipInfoManager.b(this.a, paramSharedPreferences.getAccount()).equals(paramString))
        {
          localObject = this.a;
          QZoneVipInfoManager.c((QZoneVipInfoManager)localObject, QZoneVipInfoManager.a((QZoneVipInfoManager)localObject).getString(paramString, null));
        }
        if (QZoneVipInfoManager.d(this.a, paramSharedPreferences.getAccount()).equals(paramString))
        {
          paramSharedPreferences = this.a;
          QZoneVipInfoManager.e(paramSharedPreferences, QZoneVipInfoManager.a(paramSharedPreferences).getString(paramString, null));
        }
        if (QLog.isColorLevel())
        {
          paramSharedPreferences = new StringBuilder();
          paramSharedPreferences.append("onSharedPreferenceChanged value = ");
          paramSharedPreferences.append(QZoneVipInfoManager.a(this.a));
