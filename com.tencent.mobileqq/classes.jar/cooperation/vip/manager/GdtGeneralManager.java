...
public class GdtGeneralManager
{
  private static final Singleton<GdtGeneralManager, Void> jdField_a_of_type_CooperationQzoneStatisticSingleton = new GdtGeneralManager.1();
  public WeakReference<GdtGeneralManager.InnerCallback> a;
  ...
  public static GdtGeneralManager a()
  {
    return (GdtGeneralManager)jdField_a_of_type_CooperationQzoneStatisticSingleton.get(null);
  }
  ...
  public qq_ad_get.QQAdGet.DeviceInfo a()
  {
    for (;;)
    {
      try
      {
        ...
        ((GdtDeviceInfoHelper.Params)localObject).a = "1018ec";
        localObject = GdtDeviceInfoHelper.a(BaseApplicationImpl.getApplication(), (GdtDeviceInfoHelper.Params)localObject);
        if (localObject == null) {
          continue;
        }
        localObject = ((GdtDeviceInfoHelper.Result)localObject).jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo;
  ...
  public void a(long paramLong, int paramInt1, String paramString, int paramInt2, GdtGeneralManager.InnerCallback paramInnerCallback)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramInnerCallback);
  ...
  public void a(AdvReportSsoModel paramAdvReportSsoModel)
  {
    ...
    {
      QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new GdtGeneralManager.3(this, paramAdvReportSsoModel));
      return;
    }
    GdtGeneralServlet.a(paramAdvReportSsoModel, this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo);
  ...
  public void a(vac_adv_get.VacAdvRsp paramVacAdvRsp)
  {
    ...
    {
      ((GdtGeneralManager.InnerCallback)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a((AlumBasicData)localArrayList.get(0));
 ...
 * Qualified Name:     cooperation.vip.manager.GdtGeneralManager
