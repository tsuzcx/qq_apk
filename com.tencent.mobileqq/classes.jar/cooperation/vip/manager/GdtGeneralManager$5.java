...
public class GdtGeneralManager$5
  implements Runnable
{
  public GdtGeneralManager$5(bhzt parambhzt) {}
  
  public void run()
  {
    try
    {
      if (bhzt.a(this.this$0) == null) {
        bhzt.a(this.this$0, this.this$0.a());
      }
      if (bhzt.a(this.this$0) != null)
      {
        Object localObject2 = bfnn.c("35e972");
        String str = bfnn.a("35e972");
        PBStringField localPBStringField = bhzt.a(this.this$0).mac;
        Object localObject1 = localObject2;
        if (localObject2 == null) {
          localObject1 = "";
        }
        localPBStringField.set((String)localObject1);
        localObject2 = bhzt.a(this.this$0).imei;
        localObject1 = str;
        if (str == null) {
          localObject1 = "";
        }
