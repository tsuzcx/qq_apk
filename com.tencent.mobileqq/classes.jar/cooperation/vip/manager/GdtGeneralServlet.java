...
public class GdtGeneralServlet
  extends MSFServlet
{
  public static void a(long paramLong, int paramInt1, String paramString, int paramInt2, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    try
    {
      ...
      paramDeviceInfo = new NewIntent(paramString.getApplication(), GdtGeneralServlet.class);
      paramDeviceInfo.putExtra("data", WupUtil.a(localVacAdvReq.toByteArray()));
  ...
  public static void a(AdvReportSsoModel paramAdvReportSsoModel, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    if (paramAdvReportSsoModel == null) {
      return;
    }
    for (;;)
    {
      try
      {
        ...
        if (paramAdvReportSsoModel.jdField_a_of_type_JavaLangString == null)
        {
          str = "";
          localPBStringField.set(str);
          localMobileAdvReportReq.adv_pos.set(paramAdvReportSsoModel.jdField_a_of_type_Int);
          localMobileAdvReportReq.action_type.set(paramAdvReportSsoModel.jdField_b_of_type_Int);
          localMobileAdvReportReq.action_value.set(paramAdvReportSsoModel.d);
          localMobileAdvReportReq.feed_index.set(paramAdvReportSsoModel.c);
          if (paramDeviceInfo != null) {
            localMobileAdvReportReq.device_info.set(paramDeviceInfo);
          }
          localMobileAdvReportReq.qq.set(paramAdvReportSsoModel.jdField_a_of_type_Long);
          if (!TextUtils.isEmpty(paramAdvReportSsoModel.jdField_b_of_type_JavaLangString))
          {
            paramDeviceInfo = new adv_report.SubscribeInfo();
            paramDeviceInfo.id.set(paramAdvReportSsoModel.jdField_b_of_type_JavaLangString);
            localMobileAdvReportReq.subscribe_info.set(paramDeviceInfo);
          }
          paramDeviceInfo = new NewIntent(localAppRuntime.getApplication(), GdtGeneralServlet.class);
          paramDeviceInfo.putExtra("data", WupUtil.a(localMobileAdvReportReq.toByteArray()));
          paramDeviceInfo.putExtra("cmd", "MobileAdv.AdvReport");
          if (QZLog.isColorLevel()) {
            QZLog.i("GdtGeneralServlet", " @getGdtInfo sendGdtADVReportReq " + paramAdvReportSsoModel.toString());
          }
          localAppRuntime.startServlet(paramDeviceInfo);
          return;
        }
      }
      catch (Exception paramAdvReportSsoModel)
      {
        QZLog.e("GdtGeneralServlet", "sendGdtADVReportReq error" + paramAdvReportSsoModel.toString());
        return;
      }
      String str = paramAdvReportSsoModel.jdField_a_of_type_JavaLangString;
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        {
          GdtGeneralManager.a().a(i, paramFromServiceMsg);
          return;
        }
 ...
 * Qualified Name:     cooperation.vip.manager.GdtGeneralServlet
