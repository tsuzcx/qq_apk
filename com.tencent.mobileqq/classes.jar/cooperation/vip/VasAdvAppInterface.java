...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcooperation/vip/VasAdvAppInterface;", "", "account", "", "context", "Landroid/content/Context;", "execute", "", "runnable", "Ljava/lang/Runnable;", "networkJob", "", "autoRetrieve", "initTbsEnvironment", "isAppInstalled", "pkgName", "", "postDelayed", "delay", "preloadWebView", "Landroid/view/View;", "runOnUiThread", "sendCmd", "cmd", "cmdKey", "reqBytes", "", "callback", "Lcooperation/vip/VasAdvCallback;", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
 ...
 * Qualified Name:     cooperation.vip.VasAdvAppInterface
