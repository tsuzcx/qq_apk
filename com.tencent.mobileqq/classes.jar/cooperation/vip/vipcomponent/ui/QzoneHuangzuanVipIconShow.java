...
public class QzoneHuangzuanVipIconShow
{
  ...
  public static int ICON_ADJUST_ANNUALVIP_MARGIN_TOP = (int)(bdkf.a() * 9.0F);
  public static int ICON_ANNUALVIP_HEIGHT = 0;
  public static int ICON_ANNUALVIP_WIDTH = (int)(bdkf.a() * 21.0F);
  public static int ICON_DEFAULT_SIZE = bkcr.b;
  ...
  public static int PERSONALIZED_ICON_LV_WIDTH = (int)(26.0F * bdkf.a());
  ...
  private static final bjoe<QzoneHuangzuanVipIconShow, Context> sSingleton = new bkcp();
  ...
  static
  {
    PERSONALIZED_ICON_LV_HEIGHT = (int)(bdkf.a() * 9.0F);
    PERSONALIZED_ICON_HEAD_HEIGHT = (int)(23.0F * bdkf.a());
    PERSONALIZED_ICON_HEAD_WIDTH = (int)(11.0F * bdkf.a());
    PERSONALIZED_ICON_YEAR_WIDTH = (int)(bdkf.a() * 40.0F);
    PERSONALIZED_ICON_YEAR_HEIGHT = (int)(24.0F * bdkf.a());
    PERSONALIZED_ICON_LV_MARGIN_TOP = (int)(bdkf.a() * 21.0F);
    RIBBON_ICON_BG_MARGIN_LEFT = (int)(bdkf.a() * 1.0F);
    ANUAL_ICON_MARGIN_LEFT = (int)(2.0F * bdkf.a());
    PERSONALIZED_ICON_AVATAR_TOP = (int)(bdkf.a() * 1.0F);
    LV9_GUAN_ICON_MARGIN_LEFT = (int)(bdkf.a() * 1.0F);
    LV9_GUAN_ICON_MARGIN_TOP = (int)(-3.0F * bdkf.a());
    LV9_GUAN_ICON_WIDTH = (int)(22.0F * bdkf.a());
    LV9_GUAN_ICON_HEIGHT = (int)(10.5D * bdkf.a());
    LV9_WINDS_MARGIN_TOP = (int)(4.5D * bdkf.a());
    LV9_WINDS_MARGIN_LEFT = (int)(-8.0F * bdkf.a());
    LV9_WINDS_HEIGHT = (int)(9.5D * bdkf.a());
    LV9_WINDS_WIDTH = (int)(bdkf.a() * 40.0F);
    PERSONALIZED_ICON_ANUAL_LEFT = (int)(10.0F * bdkf.a());
    RIBBON_ICON_LEVEL_MARGIN_TOP = (int)(6.0F * bdkf.a());
    ICON_ANNUALVIP_HEIGHT = (int)(12.0F * bdkf.a());
  }
  ...
  private void addToCache(bkcn parambkcn, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean1, String paramString, int paramInt4, boolean paramBoolean2, int paramInt5)
  {
    ...
    for (paramInt1 = 1;; paramInt1 = 2)
    {
      ...
      if (parambkcn != null) {
        this.layerCache.put(paramString, parambkcn.a());
      }
      return;
    }
  }
  
  private static Drawable getBackground(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, bkcy parambkcy, int paramInt5)
  {
    switch (paramInt1)
    {
    default: 
    ...
    do
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramInt4 == 4)) {
        return bkcu.a(2, paramInt3, parambkcy);
      }
      if (8 == paramInt2)
      {
        if (paramInt5 != 1) {
          return bkcu.a(3, paramInt3, parambkcy);
        }
        return bkcu.a(2, paramInt3, parambkcy);
      }
      return bkcu.a(2, paramInt3, parambkcy);
      if ((!TextUtils.isEmpty(paramString)) && (paramInt4 == 4)) {
        return bkcu.a(1, paramInt3, parambkcy);
      }
      if (8 == paramInt2)
      {
        if (paramInt5 != 1) {
          return bkcu.a(4, paramInt3, parambkcy);
        }
        return bkcu.a(1, paramInt3, parambkcy);
      }
      return bkcu.a(1, paramInt3, parambkcy);
      if (8 == paramInt2) {
        return bkcu.a(5, paramInt3, parambkcy);
      }
      if (paramInt2 != 0) {
        break;
      }
    ...
    return bkcu.a(6, paramInt3, parambkcy);
    return bkcu.a(6, paramInt3, parambkcy);
  }
  
  private Drawable getDefaultDrawable(int paramInt, bkcy parambkcy)
  {
    bkcn localbkcn = new bkcn();
    parambkcy = bkcu.a(1, 1, parambkcy);
    parambkcy.setBounds(0, 0, getRealSize(ICON_DEFAULT_SIZE, paramInt), getRealSize(ICON_DEFAULT_SIZE, paramInt));
    localbkcn.a(parambkcy);
    return localbkcn;
  }
  ...
  private Drawable getLevelDrawable(int paramInt1, int paramInt2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2, bkcy parambkcy)
  {
    if (paramBoolean2)
    {
      if ((paramBoolean1) && (paramInt1 == 4))
      {
        if ((paramInt3 > 0) && (paramInt3 <= 9)) {
          return bkcu.a(this.mAnunalGrayVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambkcy);
        }
      }
      else if ((paramInt3 > 0) && (paramInt3 <= 9)) {
        return bkcu.a(this.mNormalGrayVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambkcy);
      }
    }
    else
    {
      ...
      {
        if ((paramInt3 > 0) && (paramInt3 <= 9)) {
          return bkcu.a(this.mAnunalVipIdListInRibbon[(paramInt3 - 1)], paramInt2, parambkcy);
        }
      }
      else if ((!paramBoolean1) && (paramInt1 == 7) && (paramInt3 > 0) && (paramInt3 <= 9)) {
        return bkcu.a(this.mNormalVipIdListInRibbon[(paramInt3 - 1)], paramInt2, parambkcy);
      }
      if ((paramBoolean1) && (paramInt1 == 4))
      {
        if ((paramInt3 > 0) && (paramInt3 <= 9)) {
          return bkcu.a(this.mAnunalVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambkcy);
        }
      }
      else if ((paramInt3 > 0) && (paramInt3 <= 9)) {
        return bkcu.a(this.mNormalVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambkcy);
      }
    }
    return null;
  }
  
  private static Drawable getLv9Guan(int paramInt1, int paramInt2, int paramInt3, int paramInt4, bkcy parambkcy)
  {
    switch (paramInt1)
    {
    default: 
    ...
    case 1: 
    case 2: 
      return bkcu.a(121, paramInt4, parambkcy);
    }
    return bkcu.a(122, paramInt4, parambkcy);
  }
  ...
  private static Drawable getWindsDrawalbe(int paramInt1, int paramInt2, int paramInt3, bkcy parambkcy)
  {
    if (paramInt2 != 9) {
      return null;
    }
    ...
    default: 
      return null;
    case 0: 
      return bkcu.a(120, paramInt3, parambkcy);
    }
    return bkcu.a(119, paramInt3, parambkcy);
  }
  ...
  public Drawable getLayers(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt3, int paramInt4, String paramString2, VipResourcesListener paramVipResourcesListener, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localbkcn = new bkcn();
        localbkcq = new bkcq(this, paramVipResourcesListener, paramInt4, localbkcn, n, paramInt1, paramBoolean2, paramString1, paramInt3, paramBoolean1, paramInt2);
        if (!showCustomDiamond(paramInt2, paramBoolean2, paramString1)) {
          break label208;
        }
        paramString2 = bkcu.a(paramString1, paramInt2, 10, paramInt1, paramBoolean1, paramInt3, localbkcq);
        if (paramString2 != null)
        {
          ...
          localbkcn.g(paramString2);
          addToCache(localbkcn, n, paramInt4, paramInt1, paramBoolean2, paramString1, paramInt3, paramBoolean1, paramInt2);
          localObject1 = localbkcn;
          continue;
        }
        localObject1 = getDefaultDrawable(paramInt4, localbkcq);
      }
      finally {}
      continue;
      j = 0;
      ...
      else
      {
        ...
        {
          j = 1;
          localObject1 = getLv9Guan(paramInt2, paramInt1, paramInt3, 7, localbkcq);
          paramVipResourcesListener = (VipResourcesListener)localObject1;
          i = j;
          if (localObject1 != null)
          {
            ...
            localbkcn.d((Drawable)localObject1);
            i = j;
            paramVipResourcesListener = (VipResourcesListener)localObject1;
          }
        }
      }
      localObject1 = getWindsDrawalbe(paramInt2, paramInt1, 8, localbkcq);
      if (localObject1 == null) {
        break label1490;
      }
      ...
      localbkcn.e((Drawable)localObject1);
      break label1490;
      if (paramInt3 == 7)
      {
        localDrawable1 = getBackground(paramInt2, paramInt1, 1, paramInt3, paramString2, localbkcq, paramInt5);
        if (localDrawable1 != null)
        {
          localDrawable1.setBounds(0, 0, getRealSize(ICON_DEFAULT_SIZE, paramInt4), getRealSize(ICON_DEFAULT_SIZE, paramInt4));
          localbkcn.a(localDrawable1);
        }
        if (TextUtils.isEmpty(paramString2)) {
          break label1537;
        }
        localObject1 = bkcu.a(paramString2, 4, paramInt1, paramInt3, localbkcq);
        ...
        localbkcn.b((Drawable)localObject1);
        paramString2 = (String)localObject1;
        break label1504;
        localObject1 = getDefaultDrawable(paramInt4, localbkcq);
        continue;
        localObject1 = getLevelDrawable(paramInt3, 3, paramBoolean1, paramInt1, bool, localbkcq);
        paramString2 = (String)localObject1;
        if (localObject1 == null) {
          break label1504;
        }
      ...
      else
      {
        ...
        break label1557;
        label718:
        localDrawable2 = getLevelDrawable(paramInt3, 2, paramBoolean1, paramInt1, bool, localbkcq);
        if ((paramInt3 == 6) || (paramInt3 == 5) || (paramInt3 == 8))
        {
          bkct.b("vipIcon", "come to annual vip icon show");
          if ((paramInt5 == 1) && (!TextUtils.isEmpty(paramString2)))
          {
            localObject1 = bkcu.a(paramString2, 9, paramInt1, paramInt3, localbkcq, paramInt5);
            bkct.b("@vipIcon", "get is kingtype  url = " + paramString2);
            if (localObject1 != null)
            {
              ...
              localbkcn.f((Drawable)localObject1);
            }
          }
          if (localDrawable1 != null)
          {
          ...
          if (localDrawable2 != null)
          {
            ...
            localbkcn.b(localDrawable2);
          }
          if (!TextUtils.isEmpty(paramString2))
          {
            localObject1 = bkcu.a(paramString2, 6, paramInt1, paramInt3, localbkcq);
            bkct.b("@vipIcon", "feeds personalized  url = " + paramString2);
            if (localObject1 == null) {
              break label1563;
            }
            ...
            localbkcn.c((Drawable)localObject1);
            break label1563;
            label1081:
            bkct.c("vipIconShow", "personalized Drawable is null");
            localObject1 = getDefaultDrawable(paramInt4, localbkcq);
          }
          else
          {
            ...
            paramString2 = bkcu.a(7, 5, localbkcq);
            if (paramString2 == null) {
              break label1607;
            }
            ...
            localbkcn.c(paramString2);
            break label1607;
            label1189:
            bkct.c("vipIconShow", "nameplateDrawable is null");
            localObject1 = getDefaultDrawable(paramInt4, localbkcq);
            continue;
            label1211:
            localObject1 = getDefaultDrawable(paramInt4, localbkcq);
        ...
        else
        {
          ...
          if (paramInt3 == 4)
          {
            ...
            paramString2 = bkcu.a(paramString2, 0, paramInt1, paramInt3, localbkcq);
            if (paramString2 == null) {
              break label1678;
            }
