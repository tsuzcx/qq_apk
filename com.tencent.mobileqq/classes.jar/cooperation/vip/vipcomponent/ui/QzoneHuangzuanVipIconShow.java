...
public class QzoneHuangzuanVipIconShow
{
  ...
  public static int ICON_ADJUST_ANNUALVIP_MARGIN_TOP = (int)(bbkx.a() * 9.0F);
  public static int ICON_ANNUALVIP_HEIGHT = 0;
  public static int ICON_ANNUALVIP_WIDTH = (int)(bbkx.a() * 21.0F);
  public static int ICON_DEFAULT_SIZE = biae.b;
  ...
  public static int PERSONALIZED_ICON_LV_WIDTH = (int)(26.0F * bbkx.a());
  ...
  private static final bhmc<QzoneHuangzuanVipIconShow, Context> sSingleton = new biac();
  ...
  static
  {
    PERSONALIZED_ICON_LV_HEIGHT = (int)(bbkx.a() * 9.0F);
    PERSONALIZED_ICON_HEAD_HEIGHT = (int)(23.0F * bbkx.a());
    PERSONALIZED_ICON_HEAD_WIDTH = (int)(11.0F * bbkx.a());
    PERSONALIZED_ICON_YEAR_WIDTH = (int)(bbkx.a() * 40.0F);
    PERSONALIZED_ICON_YEAR_HEIGHT = (int)(24.0F * bbkx.a());
    PERSONALIZED_ICON_LV_MARGIN_TOP = (int)(bbkx.a() * 21.0F);
    RIBBON_ICON_BG_MARGIN_LEFT = (int)(bbkx.a() * 1.0F);
    ANUAL_ICON_MARGIN_LEFT = (int)(2.0F * bbkx.a());
    PERSONALIZED_ICON_AVATAR_TOP = (int)(bbkx.a() * 1.0F);
    LV9_GUAN_ICON_MARGIN_LEFT = (int)(bbkx.a() * 1.0F);
    LV9_GUAN_ICON_MARGIN_TOP = (int)(-3.0F * bbkx.a());
    LV9_GUAN_ICON_WIDTH = (int)(22.0F * bbkx.a());
    LV9_GUAN_ICON_HEIGHT = (int)(10.5D * bbkx.a());
    LV9_WINDS_MARGIN_TOP = (int)(4.5D * bbkx.a());
    LV9_WINDS_MARGIN_LEFT = (int)(-8.0F * bbkx.a());
    LV9_WINDS_HEIGHT = (int)(9.5D * bbkx.a());
    LV9_WINDS_WIDTH = (int)(bbkx.a() * 40.0F);
    PERSONALIZED_ICON_ANUAL_LEFT = (int)(10.0F * bbkx.a());
    RIBBON_ICON_LEVEL_MARGIN_TOP = (int)(6.0F * bbkx.a());
    ICON_ANNUALVIP_HEIGHT = (int)(12.0F * bbkx.a());
  }
  ...
  private void addToCache(biaa parambiaa, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean1, String paramString, int paramInt4, boolean paramBoolean2, int paramInt5)
  {
    ...
    for (paramInt1 = 1;; paramInt1 = 2)
    {
      ...
      if (parambiaa != null) {
        this.layerCache.put(paramString, parambiaa.a());
      }
      return;
    }
  }
  
  private static Drawable getBackground(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, bial parambial, int paramInt5)
  {
    switch (paramInt1)
    {
    default: 
    ...
    do
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramInt4 == 4)) {
        return biah.a(2, paramInt3, parambial);
      }
      if (8 == paramInt2)
      {
        if (paramInt5 != 1) {
          return biah.a(3, paramInt3, parambial);
        }
        return biah.a(2, paramInt3, parambial);
      }
      return biah.a(2, paramInt3, parambial);
      if ((!TextUtils.isEmpty(paramString)) && (paramInt4 == 4)) {
        return biah.a(1, paramInt3, parambial);
      }
      if (8 == paramInt2)
      {
        if (paramInt5 != 1) {
          return biah.a(4, paramInt3, parambial);
        }
        return biah.a(1, paramInt3, parambial);
      }
      return biah.a(1, paramInt3, parambial);
      if (8 == paramInt2) {
        return biah.a(5, paramInt3, parambial);
      }
      if (paramInt2 != 0) {
        break;
      }
    ...
    return biah.a(6, paramInt3, parambial);
    return biah.a(6, paramInt3, parambial);
  }
  
  private Drawable getDefaultDrawable(int paramInt, bial parambial)
  {
    biaa localbiaa = new biaa();
    parambial = biah.a(1, 1, parambial);
    parambial.setBounds(0, 0, getRealSize(ICON_DEFAULT_SIZE, paramInt), getRealSize(ICON_DEFAULT_SIZE, paramInt));
    localbiaa.a(parambial);
    return localbiaa;
  }
  ...
  private Drawable getLevelDrawable(int paramInt1, int paramInt2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2, bial parambial)
  {
    if (paramBoolean2)
    {
      if ((paramBoolean1) && (paramInt1 == 4))
      {
        if ((paramInt3 > 0) && (paramInt3 <= 9)) {
          return biah.a(this.mAnunalGrayVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambial);
        }
      }
      else if ((paramInt3 > 0) && (paramInt3 <= 9)) {
        return biah.a(this.mNormalGrayVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambial);
      }
    }
    else
    {
      ...
      {
        if ((paramInt3 > 0) && (paramInt3 <= 9)) {
          return biah.a(this.mAnunalVipIdListInRibbon[(paramInt3 - 1)], paramInt2, parambial);
        }
      }
      else if ((!paramBoolean1) && (paramInt1 == 7) && (paramInt3 > 0) && (paramInt3 <= 9)) {
        return biah.a(this.mNormalVipIdListInRibbon[(paramInt3 - 1)], paramInt2, parambial);
      }
      if ((paramBoolean1) && (paramInt1 == 4))
      {
        if ((paramInt3 > 0) && (paramInt3 <= 9)) {
          return biah.a(this.mAnunalVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambial);
        }
      }
      else if ((paramInt3 > 0) && (paramInt3 <= 9)) {
        return biah.a(this.mNormalVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambial);
      }
    }
    return null;
  }
  
  private static Drawable getLv9Guan(int paramInt1, int paramInt2, int paramInt3, int paramInt4, bial parambial)
  {
    switch (paramInt1)
    {
    default: 
    ...
    case 1: 
    case 2: 
      return biah.a(121, paramInt4, parambial);
    }
    return biah.a(122, paramInt4, parambial);
  }
  ...
  private static Drawable getWindsDrawalbe(int paramInt1, int paramInt2, int paramInt3, bial parambial)
  {
    if (paramInt2 != 9) {
      return null;
    }
    ...
    default: 
      return null;
    case 0: 
      return biah.a(120, paramInt3, parambial);
    }
    return biah.a(119, paramInt3, parambial);
  }
  ...
  public Drawable getLayers(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt3, int paramInt4, String paramString2, VipResourcesListener paramVipResourcesListener, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localbiaa = new biaa();
        localbiad = new biad(this, paramVipResourcesListener, paramInt4, localbiaa, n, paramInt1, paramBoolean2, paramString1, paramInt3, paramBoolean1, paramInt2);
        if (!showCustomDiamond(paramInt2, paramBoolean2, paramString1)) {
          break label208;
        }
        paramString2 = biah.a(paramString1, paramInt2, 10, paramInt1, paramBoolean1, paramInt3, localbiad);
        if (paramString2 != null)
        {
          ...
          localbiaa.g(paramString2);
          addToCache(localbiaa, n, paramInt4, paramInt1, paramBoolean2, paramString1, paramInt3, paramBoolean1, paramInt2);
          localObject1 = localbiaa;
          continue;
        }
        localObject1 = getDefaultDrawable(paramInt4, localbiad);
      }
      finally {}
      continue;
      j = 0;
      ...
      else
      {
        ...
        {
          j = 1;
          localObject1 = getLv9Guan(paramInt2, paramInt1, paramInt3, 7, localbiad);
          paramVipResourcesListener = (VipResourcesListener)localObject1;
          i = j;
          if (localObject1 != null)
          {
            ...
            localbiaa.d((Drawable)localObject1);
            i = j;
            paramVipResourcesListener = (VipResourcesListener)localObject1;
          }
        }
      }
      localObject1 = getWindsDrawalbe(paramInt2, paramInt1, 8, localbiad);
      if (localObject1 == null) {
        break label1490;
      }
      ...
      localbiaa.e((Drawable)localObject1);
      break label1490;
      if (paramInt3 == 7)
      {
        localDrawable1 = getBackground(paramInt2, paramInt1, 1, paramInt3, paramString2, localbiad, paramInt5);
        if (localDrawable1 != null)
        {
          localDrawable1.setBounds(0, 0, getRealSize(ICON_DEFAULT_SIZE, paramInt4), getRealSize(ICON_DEFAULT_SIZE, paramInt4));
          localbiaa.a(localDrawable1);
        }
        if (TextUtils.isEmpty(paramString2)) {
          break label1537;
        }
        localObject1 = biah.a(paramString2, 4, paramInt1, paramInt3, localbiad);
        ...
        localbiaa.b((Drawable)localObject1);
        paramString2 = (String)localObject1;
        break label1504;
        localObject1 = getDefaultDrawable(paramInt4, localbiad);
        continue;
        localObject1 = getLevelDrawable(paramInt3, 3, paramBoolean1, paramInt1, bool, localbiad);
        paramString2 = (String)localObject1;
        if (localObject1 == null) {
          break label1504;
        }
      ...
      else
      {
        ...
        break label1557;
        label718:
        localDrawable2 = getLevelDrawable(paramInt3, 2, paramBoolean1, paramInt1, bool, localbiad);
        if ((paramInt3 == 6) || (paramInt3 == 5) || (paramInt3 == 8))
        {
          biag.b("vipIcon", "come to annual vip icon show");
          if ((paramInt5 == 1) && (!TextUtils.isEmpty(paramString2)))
          {
            localObject1 = biah.a(paramString2, 9, paramInt1, paramInt3, localbiad, paramInt5);
            biag.b("@vipIcon", "get is kingtype  url = " + paramString2);
            if (localObject1 != null)
            {
              ...
              localbiaa.f((Drawable)localObject1);
            }
          }
          if (localDrawable1 != null)
          {
          ...
          if (localDrawable2 != null)
          {
            ...
            localbiaa.b(localDrawable2);
          }
          if (!TextUtils.isEmpty(paramString2))
          {
            localObject1 = biah.a(paramString2, 6, paramInt1, paramInt3, localbiad);
            biag.b("@vipIcon", "feeds personalized  url = " + paramString2);
            if (localObject1 == null) {
              break label1563;
            }
            ...
            localbiaa.c((Drawable)localObject1);
            break label1563;
            label1081:
            biag.c("vipIconShow", "personalized Drawable is null");
            localObject1 = getDefaultDrawable(paramInt4, localbiad);
          }
          else
          {
            ...
            paramString2 = biah.a(7, 5, localbiad);
            if (paramString2 == null) {
              break label1607;
            }
            ...
            localbiaa.c(paramString2);
            break label1607;
            label1189:
            biag.c("vipIconShow", "nameplateDrawable is null");
            localObject1 = getDefaultDrawable(paramInt4, localbiad);
            continue;
            label1211:
            localObject1 = getDefaultDrawable(paramInt4, localbiad);
        ...
        else
        {
          ...
          if (paramInt3 == 4)
          {
            ...
            paramString2 = biah.a(paramString2, 0, paramInt1, paramInt3, localbiad);
            if (paramString2 == null) {
              break label1678;
            }
