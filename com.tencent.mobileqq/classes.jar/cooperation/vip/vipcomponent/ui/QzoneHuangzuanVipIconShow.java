...
public class QzoneHuangzuanVipIconShow
{
  ...
  public static int ICON_ADJUST_ANNUALVIP_MARGIN_TOP = (int)(bhtq.a() * 9.0F);
  public static int ICON_ANNUALVIP_HEIGHT = 0;
  public static int ICON_ANNUALVIP_WIDTH = (int)(27.0F * bhtq.a());
  public static int ICON_DEFAULT_SIZE = bnxa.b;
  ...
  public static int PERSONALIZED_ICON_LV_WIDTH = (int)(26.0F * bhtq.a());
  ...
  private static final bnhx<QzoneHuangzuanVipIconShow, Context> sSingleton = new bnwy();
  ...
  static
  {
    PERSONALIZED_ICON_LV_HEIGHT = (int)(bhtq.a() * 9.0F);
    PERSONALIZED_ICON_HEAD_HEIGHT = (int)(23.0F * bhtq.a());
    PERSONALIZED_ICON_HEAD_WIDTH = (int)(11.0F * bhtq.a());
    PERSONALIZED_ICON_YEAR_WIDTH = (int)(bhtq.a() * 40.0F);
    PERSONALIZED_ICON_YEAR_HEIGHT = (int)(24.0F * bhtq.a());
    PERSONALIZED_ICON_LV_MARGIN_TOP = (int)(21.0F * bhtq.a());
    RIBBON_ICON_BG_MARGIN_LEFT = (int)(bhtq.a() * 1.0F);
    ANUAL_ICON_MARGIN_LEFT = (int)(2.0F * bhtq.a());
    ANUAL_ICON_MARGIN_LEFT_IF_LV9 = (int)(5.0F * bhtq.a());
    PERSONALIZED_ICON_AVATAR_TOP = (int)(bhtq.a() * 1.0F);
    LV9_GUAN_ICON_MARGIN_LEFT = (int)(bhtq.a() * 1.0F);
    LV9_GUAN_ICON_MARGIN_TOP = (int)(-3.0F * bhtq.a());
    LV9_GUAN_ICON_WIDTH = (int)(22.0F * bhtq.a());
    LV9_GUAN_ICON_HEIGHT = (int)(10.5D * bhtq.a());
    LV9_WINDS_MARGIN_TOP = (int)(4.5D * bhtq.a());
    LV9_WINDS_MARGIN_LEFT = (int)(-8.0F * bhtq.a());
    LV9_WINDS_HEIGHT = (int)(9.5D * bhtq.a());
    LV9_WINDS_WIDTH = (int)(bhtq.a() * 40.0F);
    PERSONALIZED_ICON_ANUAL_LEFT = (int)(10.0F * bhtq.a());
    RIBBON_ICON_LEVEL_MARGIN_TOP = (int)(6.0F * bhtq.a());
    ICON_ANNUALVIP_HEIGHT = (int)(12.0F * bhtq.a());
  }
  ...
  private void addToCache(bnww parambnww, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean1, String paramString, int paramInt4, boolean paramBoolean2, int paramInt5)
  {
    ...
    for (paramInt1 = 1;; paramInt1 = 2)
    {
      ...
      if (parambnww != null) {
        this.layerCache.put(paramString, parambnww.a());
      }
      return;
    }
  }
  
  private static Drawable getBackground(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, bnxh parambnxh, int paramInt5)
  {
    switch (paramInt1)
    {
    default: 
    ...
    do
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramInt4 == 4)) {
        return bnxd.a(2, paramInt3, parambnxh);
      }
      if (8 == paramInt2)
      {
        if (paramInt5 != 1) {
          return bnxd.a(3, paramInt3, parambnxh);
        }
        return bnxd.a(2, paramInt3, parambnxh);
      }
      return bnxd.a(2, paramInt3, parambnxh);
      if ((!TextUtils.isEmpty(paramString)) && (paramInt4 == 4)) {
        return bnxd.a(1, paramInt3, parambnxh);
      }
      if (8 == paramInt2)
      {
        if (paramInt5 != 1) {
          return bnxd.a(4, paramInt3, parambnxh);
        }
        return bnxd.a(1, paramInt3, parambnxh);
      }
      return bnxd.a(1, paramInt3, parambnxh);
      if (8 == paramInt2) {
        return bnxd.a(5, paramInt3, parambnxh);
      }
      if (paramInt2 != 0) {
        break;
      }
    ...
    return bnxd.a(6, paramInt3, parambnxh);
    return bnxd.a(6, paramInt3, parambnxh);
  }
  
  private Drawable getDefaultDrawable(int paramInt, bnxh parambnxh)
  {
    bnww localbnww = new bnww();
    parambnxh = bnxd.a(1, 1, parambnxh);
    parambnxh.setBounds(0, 0, getRealSize(ICON_DEFAULT_SIZE, paramInt), getRealSize(ICON_DEFAULT_SIZE, paramInt));
    localbnww.a(parambnxh);
    return localbnww;
  }
  
  private boolean getDefaultDrawableFromUrl(int paramInt1, boolean paramBoolean1, int paramInt2, int paramInt3, String paramString, bnww parambnww, bnxh parambnxh, boolean paramBoolean2, boolean paramBoolean3, Drawable paramDrawable1, Drawable paramDrawable2, Drawable paramDrawable3, Drawable paramDrawable4)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      if (handlePersonalized(paramInt1, paramInt2, paramInt3, paramString, parambnww, parambnxh, paramBoolean2, paramBoolean3, paramDrawable1, paramDrawable2, paramDrawable3, paramDrawable4)) {
        return true;
      }
    }
    else if (paramBoolean1)
    {
      if (handleAnunalVip(paramInt3, parambnww, parambnxh, paramBoolean2, paramBoolean3, paramDrawable1, paramDrawable2, paramDrawable3, paramDrawable4)) {
        return true;
      }
    }
  ...
  private Drawable getLevelDrawable(int paramInt1, int paramInt2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2, bnxh parambnxh)
  {
    ...
    if (paramBoolean2)
    {
      if ((paramBoolean1) && (paramInt1 == 4)) {
        return bnxd.a(this.mAnunalGrayVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambnxh);
      }
      return bnxd.a(this.mNormalGrayVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambnxh);
    }
    if ((paramBoolean1) && (paramInt1 == 7)) {
      return bnxd.a(this.mAnunalVipIdListInRibbon[(paramInt3 - 1)], paramInt2, parambnxh);
    }
    if ((!paramBoolean1) && (paramInt1 == 7)) {
      return bnxd.a(this.mNormalVipIdListInRibbon[(paramInt3 - 1)], paramInt2, parambnxh);
    }
    if ((paramBoolean1) && (paramInt1 == 4)) {
      return bnxd.a(this.mAnunalVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambnxh);
    }
    return bnxd.a(this.mNormalVipIdListInAvatar[(paramInt3 - 1)], paramInt2, parambnxh);
  }
  
  private static Drawable getLv9Guan(int paramInt1, int paramInt2, int paramInt3, int paramInt4, bnxh parambnxh)
  {
    switch (paramInt1)
    {
    default: 
    ...
    case 1: 
    case 2: 
      return bnxd.a(121, paramInt4, parambnxh);
    }
    return bnxd.a(122, paramInt4, parambnxh);
  }
  ...
  private static Drawable getWindsDrawalbe(int paramInt1, int paramInt2, int paramInt3, bnxh parambnxh)
  {
    if (paramInt2 != 9) {
      return null;
    }
    ...
    default: 
      return null;
    case 0: 
      return bnxd.a(120, paramInt3, parambnxh);
    }
    return bnxd.a(119, paramInt3, parambnxh);
  }
  
  private boolean handleAnunalVip(int paramInt, bnww parambnww, bnxh parambnxh, boolean paramBoolean1, boolean paramBoolean2, Drawable paramDrawable1, Drawable paramDrawable2, Drawable paramDrawable3, Drawable paramDrawable4)
  {
    parambnxh = bnxd.a(7, 5, parambnxh);
    if (parambnxh != null) {
    ...
    {
      parambnxh.setBounds(getRealSize(ICON_DEFAULT_SIZE / 2 + ANUAL_ICON_MARGIN_LEFT + i, paramInt), getRealSize(ICON_ADJUST_ANNUALVIP_MARGIN_TOP, paramInt), getRealSize(i + (ICON_ANNUALVIP_WIDTH + ICON_DEFAULT_SIZE / 2 + ANUAL_ICON_MARGIN_LEFT), paramInt), getRealSize(ICON_ADJUST_ANNUALVIP_MARGIN_TOP + ICON_ANNUALVIP_HEIGHT, paramInt));
      parambnww.c(parambnxh);
      if ((paramDrawable3 != null) && (paramDrawable4 != null) && (parambnxh != null) && ((!paramBoolean2) || (paramDrawable1 != null)) && ((!paramBoolean1) || (paramDrawable2 != null))) {
        break;
      }
      bnxc.c("vipIconShow", "nameplateDrawable is null");
      return true;
    }
    return false;
  }
  
  private Drawable handleCustomDiamond(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString, int paramInt3, int paramInt4, int paramInt5, bnww parambnww, bnxh parambnxh)
  {
    Drawable localDrawable = bnxd.a(paramString, paramInt2, 10, paramInt1, paramBoolean1, paramInt3, parambnxh);
    if (localDrawable != null)
    {
      ...
      parambnww.g(localDrawable);
      addToCache(parambnww, paramInt5, paramInt4, paramInt1, paramBoolean2, paramString, paramInt3, paramBoolean1, paramInt2);
      return parambnww;
    }
    return getDefaultDrawable(paramInt4, parambnxh);
  }
  
  private void handleDownloadSuccess(int paramInt1, Drawable paramDrawable, int paramInt2, bnww parambnww, int paramInt3)
  {
    int i = 0;
    ...
    case 6: 
      ...
      parambnww.c(paramDrawable);
      bnxc.b("@vipIcon", "left" + ICON_DEFAULT_SIZE / 2 + " width = " + paramDrawable.getIntrinsicWidth() + " defualt_width =" + ICON_DEFAULT_SIZE + " height = " + paramDrawable.getIntrinsicHeight());
      return;
    case 4: 
    ...
    case 9: 
      ...
      parambnww.f(paramDrawable);
      bnxc.b("@vipIcon KINGBG", "left=" + (ICON_DEFAULT_SIZE - paramDrawable.getIntrinsicWidth()) / 2 + " width = " + paramDrawable.getIntrinsicWidth() + " defualt_width =" + ICON_DEFAULT_SIZE + " height = " + paramDrawable.getIntrinsicHeight() + " bitmapwith =" + (int)(((BitmapDrawable)paramDrawable).getBitmap().getWidth() / 2 * bhtq.a()) + "bitmapheight =" + (int)(((BitmapDrawable)paramDrawable).getBitmap().getHeight() / 2 * bhtq.a()));
      return;
    }
  ...
  private Drawable handleLocationAvatar(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt3, int paramInt4, String paramString2, int paramInt5, bnww parambnww, bnxh parambnxh, boolean paramBoolean3, boolean paramBoolean4, Drawable paramDrawable1, Drawable paramDrawable2, Drawable paramDrawable3, boolean paramBoolean5, Drawable paramDrawable4)
  {
    ...
    if (paramInt3 == 4)
    {
      ...
      if (paramDrawable4 != null)
      {
        ...
        parambnww.b(paramDrawable4);
      }
      if (paramBoolean5)
      {
        paramString2 = bnxd.a(paramString2, 0, paramInt1, paramInt3, parambnxh);
        ...
        localObject = getDefaultDrawable(paramInt4, parambnxh);
      }
    }
    else
    {
    ...
    label257:
    addToCache(parambnww, paramInt5, paramInt4, paramInt1, paramBoolean2, paramString1, paramInt3, paramBoolean1, paramInt2);
    return parambnww;
  }
  
  private Drawable handleLocationRibbon(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt3, int paramInt4, String paramString2, int paramInt5, int paramInt6, bnww parambnww, bnxh parambnxh, boolean paramBoolean3, boolean paramBoolean4, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    Drawable localDrawable2 = getBackground(paramInt2, paramInt1, 1, paramInt3, paramString2, parambnxh, paramInt5);
    if (localDrawable2 != null)
    {
      localDrawable2.setBounds(0, 0, getRealSize(ICON_DEFAULT_SIZE, paramInt4), getRealSize(ICON_DEFAULT_SIZE, paramInt4));
      parambnww.a(localDrawable2);
    }
    Drawable localDrawable1;
    if (!TextUtils.isEmpty(paramString2))
    {
      localDrawable1 = bnxd.a(paramString2, 4, paramInt1, paramInt3, parambnxh);
    ...
    else
    {
      ...
      {
        localDrawable1 = getLevelDrawable(paramInt3, 3, paramBoolean1, paramInt1, bool, parambnxh);
        paramString2 = localDrawable1;
        if (localDrawable1 == null) {
          break;
        }
    ...
    addToCache(parambnww, paramInt6, paramInt4, paramInt1, paramBoolean2, paramString1, paramInt3, paramBoolean1, paramInt2);
    return parambnww;
  }
  ...
  {
    bnxc.b("vipIcon", "come to annual vip icon show");
    if ((paramInt5 == 1) && (!TextUtils.isEmpty(paramString2)))
    {
      Drawable localDrawable = bnxd.a(paramString2, 9, paramInt1, paramInt3, parambnxh, paramInt5);
      bnxc.b("@vipIcon", "get is kingtype  url = " + paramString2);
      if (localDrawable != null)
      {
    ...
    if (getDefaultDrawableFromUrl(paramInt1, paramBoolean1, paramInt3, paramInt4, paramString2, parambnww, parambnxh, paramBoolean3, paramBoolean4, paramDrawable1, paramDrawable2, paramDrawable3, paramDrawable4)) {
      return getDefaultDrawable(paramInt4, parambnxh);
    }
    addToCache(parambnww, paramInt6, paramInt4, paramInt1, paramBoolean2, paramString1, paramInt3, paramBoolean1, paramInt2);
    return parambnww;
  ...
  private Drawable handleNotRibbon(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt3, int paramInt4, String paramString2, int paramInt5, int paramInt6, bnww parambnww, bnxh parambnxh, boolean paramBoolean3, boolean paramBoolean4, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    ...
    Drawable localDrawable1 = getBackground(paramInt2, paramInt1, 1, paramInt3, paramString2, parambnxh, paramInt5);
    if ((paramInt1 == 0) || (paramInt2 == 0)) {}
    Drawable localDrawable2;
    for (bool2 = true;; bool2 = false)
    {
      localDrawable2 = getLevelDrawable(paramInt3, 2, paramBoolean1, paramInt1, bool2, parambnxh);
      if ((paramInt3 != 6) && (paramInt3 != 5) && (paramInt3 != 8)) {
        break;
      }
      return handleNotLocationAvatar(paramInt1, paramInt2, paramBoolean1, paramBoolean2, paramString1, paramInt3, paramInt4, paramString2, paramInt5, paramInt6, parambnww, parambnxh, paramBoolean3, paramBoolean4, paramDrawable1, paramDrawable2, localDrawable1, localDrawable2);
    }
    return handleLocationAvatar(paramInt1, paramInt2, paramBoolean1, paramBoolean2, paramString1, paramInt3, paramInt4, paramString2, paramInt6, parambnww, parambnxh, paramBoolean3, paramBoolean4, paramDrawable1, paramDrawable2, localDrawable1, bool1, localDrawable2);
  }
  
  private boolean handlePersonalized(int paramInt1, int paramInt2, int paramInt3, String paramString, bnww parambnww, bnxh parambnxh, boolean paramBoolean1, boolean paramBoolean2, Drawable paramDrawable1, Drawable paramDrawable2, Drawable paramDrawable3, Drawable paramDrawable4)
  {
    parambnxh = bnxd.a(paramString, 6, paramInt1, paramInt2, parambnxh);
    bnxc.b("@vipIcon", "feeds personalized  url = " + paramString);
    if (parambnxh != null)
    {
      parambnxh.setBounds(getRealSize(ICON_DEFAULT_SIZE - PERSONALIZED_ICON_ANUAL_LEFT, paramInt3), getRealSize(ICON_DEFAULT_SIZE - parambnxh.getIntrinsicHeight(), paramInt3), getRealSize(ICON_DEFAULT_SIZE - PERSONALIZED_ICON_ANUAL_LEFT + parambnxh.getIntrinsicWidth(), paramInt3), getRealSize(ICON_DEFAULT_SIZE, paramInt3));
      parambnww.c(parambnxh);
    }
    if ((paramDrawable3 == null) || (paramDrawable4 == null) || (parambnxh == null) || ((paramBoolean2) && (paramDrawable1 == null)) || ((paramBoolean1) && (paramDrawable2 == null)))
    {
      bnxc.c("vipIconShow", "personalized Drawable is null");
      return true;
    }
    return false;
  }
  ...
  public Drawable getLayers(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt3, int paramInt4, String paramString2, VipResourcesListener paramVipResourcesListener, int paramInt5)
  {
    ...
    //   4: iload 6
    //   6: iload_1
    //   7: invokespecial 414	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:isVipIcon	(III)Z
    //   10: istore 12
    //   12: iload 12
    //   14: ifne +11 -> 25
    //   17: aconst_null
    ...
    //   24: areturn
    //   25: aload 8
    //   27: invokestatic 419	bnwv:a	(Ljava/lang/String;)I
    //   30: istore 11
    //   32: aload_0
    //   33: iload 11
    //   35: iload 7
    ...
    //   44: iload_3
    //   45: iload_2
    //   46: invokespecial 421	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getFromCache	(IIIZLjava/lang/String;IZI)Landroid/graphics/drawable/Drawable;
    //   49: astore 17
    //   51: aload 17
    //   53: astore 16
    //   55: aload 17
    ...
    //   60: new 223	bnww
    //   63: dup
    //   64: invokespecial 246	bnww:<init>	()V
    //   67: astore 19
    //   69: new 423	bnwz
    //   72: dup
    //   73: aload_0
    ...
    //   89: iload_3
    //   90: iload_2
    //   91: invokespecial 426	bnwz:<init>	(Lcooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow;Lcooperation/vip/vipcomponent/util/VipResourcesListener;ILbnww;IIZLjava/lang/String;IZI)V
    //   94: astore 20
    //   96: iload_2
    //   97: iload 4
    //   99: aload 5
    //   101: invokestatic 428	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:showCustomDiamond	(IZLjava/lang/String;)Z
    //   104: ifeq +29 -> 133
    //   107: aload_0
    //   108: iload_1
    //   109: iload_2
    ...
    //   121: aload 19
    //   123: aload 20
    //   125: invokespecial 430	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:handleCustomDiamond	(IIZZLjava/lang/String;IIILbnww;Lbnxh;)Landroid/graphics/drawable/Drawable;
    //   128: astore 16
    //   130: goto -110 -> 20
    //   133: iconst_0
    //   134: istore 13
    ...
    //   200: bipush 7
    //   202: aload 20
    //   204: invokestatic 432	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getLv9Guan	(IIIILbnxh;)Landroid/graphics/drawable/Drawable;
    //   207: astore 16
    //   209: iload 13
    //   211: istore 12
    //   213: aload 16
    ...
    //   267: aload 19
    //   269: aload 16
    //   271: invokevirtual 327	bnww:d	(Landroid/graphics/drawable/Drawable;)V
    //   274: aload 16
    //   276: astore 9
    //   278: iload 13
    //   280: istore 12
    ...
    //   287: bipush 8
    //   289: aload 20
    //   291: invokestatic 434	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getWindsDrawalbe	(IIILbnxh;)Landroid/graphics/drawable/Drawable;
    //   294: astore 18
    //   296: iload 15
    //   298: istore 13
    //   300: iload 12
    ...
    //   362: aload 19
    //   364: aload 18
    //   366: invokevirtual 344	bnww:e	(Landroid/graphics/drawable/Drawable;)V
    //   369: aload 18
    //   371: astore 17
    //   373: aload 9
    //   375: astore 16
    ...
    //   418: aload 16
    //   420: aload 17
    //   422: invokespecial 436	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:handleLocationRibbon	(IIZZLjava/lang/String;IILjava/lang/String;IILbnww;Lbnxh;ZZLandroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    //   425: astore 16
    //   427: goto -407 -> 20
    //   430: aload_0
    //   431: iload_1
    ...
    //   456: aload 16
    //   458: aload 17
    //   460: invokespecial 438	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:handleNotRibbon	(IIZZLjava/lang/String;IILjava/lang/String;IILbnww;Lbnxh;ZZLandroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    //   463: astore 16
    //   465: goto -445 -> 20
    //   468: astore 5
    //   470: aload_0
    ...
    //   67	382	19	localbnww	bnww
    //   94	357	20	localbnwz	bnwz
    // Exception table:
    //   from	to	target	type
    //   2	12	468	finally
    //   25	51	468	finally
