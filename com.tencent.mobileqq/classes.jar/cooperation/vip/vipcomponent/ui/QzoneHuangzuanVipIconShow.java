...
public class QzoneHuangzuanVipIconShow
{
  ...
  public static int PERSONALIZED_ICON_LV_WIDTH = (int)(26.0F * ViewUtils.getDensity());
  ...
  static
  {
    ...
    PERSONALIZED_ICON_HEAD_HEIGHT = (int)(23.0F * ViewUtils.getDensity());
    PERSONALIZED_ICON_HEAD_WIDTH = (int)(11.0F * ViewUtils.getDensity());
    PERSONALIZED_ICON_YEAR_WIDTH = (int)(ViewUtils.getDensity() * 40.0F);
    PERSONALIZED_ICON_YEAR_HEIGHT = (int)(24.0F * ViewUtils.getDensity());
    PERSONALIZED_ICON_LV_MARGIN_TOP = (int)(21.0F * ViewUtils.getDensity());
    RIBBON_ICON_BG_MARGIN_LEFT = (int)(ViewUtils.getDensity() * 1.0F);
    ANUAL_ICON_MARGIN_LEFT = (int)(2.0F * ViewUtils.getDensity());
    ANUAL_ICON_MARGIN_LEFT_IF_LV9 = (int)(5.0F * ViewUtils.getDensity());
    PERSONALIZED_ICON_AVATAR_TOP = (int)(ViewUtils.getDensity() * 1.0F);
    LV9_GUAN_ICON_MARGIN_LEFT = (int)(ViewUtils.getDensity() * 1.0F);
    LV9_GUAN_ICON_MARGIN_TOP = (int)(-3.0F * ViewUtils.getDensity());
    LV9_GUAN_ICON_WIDTH = (int)(22.0F * ViewUtils.getDensity());
    LV9_GUAN_ICON_HEIGHT = (int)(10.5D * ViewUtils.getDensity());
    LV9_WINDS_MARGIN_TOP = (int)(4.5D * ViewUtils.getDensity());
    LV9_WINDS_MARGIN_LEFT = (int)(-8.0F * ViewUtils.getDensity());
    LV9_WINDS_HEIGHT = (int)(9.5D * ViewUtils.getDensity());
    LV9_WINDS_WIDTH = (int)(ViewUtils.getDensity() * 40.0F);
    PERSONALIZED_ICON_ANUAL_LEFT = (int)(10.0F * ViewUtils.getDensity());
    RIBBON_ICON_LEVEL_MARGIN_TOP = (int)(6.0F * ViewUtils.getDensity());
    ICON_ANNUALVIP_HEIGHT = (int)(12.0F * ViewUtils.getDensity());
  }
  ...
  public Drawable getLayers(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, String paramString1, int paramInt3, int paramInt4, String paramString2, VipResourcesListener paramVipResourcesListener, int paramInt5)
  {
    ...
    //   157: aload 8
    //   159: invokestatic 239	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   162: ifne +17 -> 179
    //   165: iload 15
    //   167: istore 12
    //   169: aload 18
    ...
    //   227: iload 7
    //   229: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
    //   232: getstatic 122	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:LV9_GUAN_ICON_MARGIN_TOP	I
    //   235: iload 7
    //   237: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
    ...
    //   246: iadd
    //   247: iload 7
    //   249: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
    ...
    //   258: iadd
    //   259: iload 7
    //   261: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
    ...
    //   322: iload 7
    //   324: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
    //   327: getstatic 133	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:LV9_WINDS_MARGIN_TOP	I
    //   330: iload 7
    //   332: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
    ...
    //   341: iadd
    //   342: iload 7
    //   344: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
    ...
    //   353: iadd
    //   354: iload 7
    //   356: invokestatic 251	cooperation/vip/vipcomponent/ui/QzoneHuangzuanVipIconShow:getRealSize	(II)I
