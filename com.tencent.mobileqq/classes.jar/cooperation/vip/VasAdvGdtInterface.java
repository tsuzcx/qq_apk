...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"Lcooperation/vip/VasAdvGdtInterface;", "", "convertPbToJson", "", "T", "Lcom/tencent/mobileqq/pb/PBField;", "pbField", "(Lcom/tencent/mobileqq/pb/PBField;)Ljava/lang/String;", "doCgiReport", "", "exposureUrl", "doExposure", "adView", "Landroid/view/View;", "pbAdInfo", "Ltencent/gdt/qq_ad_get$QQAdGetRsp$AdInfo;", "resultCallback", "Lcooperation/vip/VasResultCallback;", "", "doOriginalExposure", "context", "Landroid/content/Context;", "jsonGdtAdInfo", "getDeviceInfo", "Ltencent/gdt/qq_ad_get$QQAdGet$DeviceInfo;", "gdtBizId", "getDeviceInfoAsJson", "getGdtCountdownTime", "", "gdtTangramAdJson", "getIndustryLabels", "", "getMarketPendantImgUrl", "initGdtContext", "showMotiveAd", "activity", "Landroid/app/Activity;", "adInfo", "profitableCallback", "Lcooperation/vip/reward/VasProfitableCallback;", "rewardText", "bizSrc", "toLandingPage", "params", "Lcooperation/vip/LandingPageParams;", "unregisterAppReceiver", "vasGdtBizId", "AQQLiteApp_release"}, k=1, mv={1, 1, 16})
 ...
 * Qualified Name:     cooperation.vip.VasAdvGdtInterface
