...
{
  static INetEngine.IBreakDownFix jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new anpw();
  ...
  static
  {
    jdField_a_of_type_ComTencentWeiyunUtilsSingleton = new anpv();
  }
  
  private WyDownloader()
  {
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, new anpx(this));
  }
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new anqb(this, localLong, localNetReq));
  }
  ...
  public int a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      ...
      if (!localArrayList.isEmpty()) {
        this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new anqc(this, localArrayList));
      }
      return j + i;
    }
  }
  ...
  public String a(String paramString1, String paramString2, String paramString3, String paramString4, WyDownloader.IDownloadStatusListener paramIDownloadStatusListener)
  {
    ...
    a(paramString1, paramString2, paramString3, paramString4, new anpy(this, paramIDownloadStatusListener, i), Integer.toString(i));
  ...
  {
    paramString1 = DownloadJobContext.a(paramString4, paramString1, paramString2, paramString3, jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix, new anpz(this, paramIDownloadListener, paramString4, paramString2));
    ...
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new anqa(this, paramString1));
  ...
  public int b()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      localArrayList.addAll(this.jdField_a_of_type_JavaUtilHashMap.keySet());
      if (!localArrayList.isEmpty()) {
        this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new anqd(this, localArrayList));
      }
      return k + (i + j);
    }
  }
  ...
  public int c()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaUtilHashSet)
    {
      ...
      if (!localArrayList.isEmpty()) {
        this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new anqe(this, localArrayList));
      }
      return i;
    }
  }
