...
public class DownloadJobContext
{
  ...
  public static HttpNetReq a(Object paramObject, String paramString1, String paramString2, String paramString3, INetEngine.IBreakDownFix paramIBreakDownFix, INetEngine.INetEngineListener paramINetEngineListener, String paramString4)
  {
    ...
    localHttpNetReq.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = paramINetEngineListener;
    localHttpNetReq.jdField_a_of_type_JavaLangString = paramString1;
    localHttpNetReq.jdField_a_of_type_Int = 0;
    if (!TextUtils.isEmpty(paramString3))
    {
      localHttpNetReq.jdField_a_of_type_JavaUtilHashMap = new HashMap();
      localHttpNetReq.jdField_a_of_type_JavaUtilHashMap.put("Cookie", paramString3);
    }
    if (!TextUtils.isEmpty(paramString4)) {
      localHttpNetReq.jdField_d_of_type_JavaLangString = paramString4;
    }
    localHttpNetReq.jdField_c_of_type_JavaLangString = paramString2;
    localHttpNetReq.e = 1;
    localHttpNetReq.a(paramObject);
    localHttpNetReq.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = paramIBreakDownFix;
