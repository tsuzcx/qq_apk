  ...
  implements Handler.Callback
{
  ...
  public UrlFetcher(UrlFetcher.UrlFetcherCallback paramUrlFetcherCallback, WyDownloader.IFetchListener paramIFetchListener, ReleaseLooperHandler paramReleaseLooperHandler)
  {
  ...
  private void b(DownloadJobContext paramDownloadJobContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_CooperationWeiyunSdkDownloadWyDownloader$IFetchListener.a(paramDownloadJobContext.a().a(), paramInt, new UrlFetcher.1(this, str, l, paramDownloadJobContext, paramInt));
  }
