  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    boolean bool1 = bkhv.a(this.a, String.valueOf(l), "key_pwd_queried", false);
    boolean bool2 = bkhv.a(this.a, String.valueOf(l), "key_pwd_has", false);
    boolean bool3 = bkhv.a(this.a, String.valueOf(l), "key_pwd_verified", false);
    bkgd.a()[0].set(bool1);
    bkgd.a()[1].set(bool2);
    bkgd.a()[2].set(bool3);
  }
