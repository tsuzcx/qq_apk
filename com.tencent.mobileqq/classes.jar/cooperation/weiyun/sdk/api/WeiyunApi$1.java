  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    boolean bool1 = bnap.a(this.a, String.valueOf(l), "key_pwd_queried", false);
    boolean bool2 = bnap.a(this.a, String.valueOf(l), "key_pwd_has", false);
    boolean bool3 = bnap.a(this.a, String.valueOf(l), "key_pwd_verified", false);
    bmyx.a()[0].set(bool1);
    bmyx.a()[1].set(bool2);
    bmyx.a()[2].set(bool3);
  }
