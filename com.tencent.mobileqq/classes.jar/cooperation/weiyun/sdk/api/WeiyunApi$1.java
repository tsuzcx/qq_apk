  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    boolean bool1 = bifz.a(this.a, String.valueOf(l), "key_pwd_queried", false);
    boolean bool2 = bifz.a(this.a, String.valueOf(l), "key_pwd_has", false);
    boolean bool3 = bifz.a(this.a, String.valueOf(l), "key_pwd_verified", false);
    bieh.a()[0].set(bool1);
    bieh.a()[1].set(bool2);
    bieh.a()[2].set(bool3);
  }
