  ...
  public void fetchUploadServerInfo(UploadFile paramUploadFile, UploadType paramUploadType, WeiyunTransmissionGlobal.UploadServerInfoCallback paramUploadServerInfoCallback)
  {
    if (paramUploadFile.cmdType == 1)
    {
      ...
      if ((paramUploadFile.isCompress) && (!TextUtils.isEmpty(paramUploadFile.compressedPath)))
      {
        ...
        WeiyunApi.a((WeiyunPB.DiskPicBackupReq)localObject, new TransmissionHelper.TransmissionHostInterfaceImpl.1(this, paramUploadServerInfoCallback, paramUploadFile));
      }
    }
    label311:
    ...
    for (;;)
    {
      ...
      WeiyunApi.a((WeiyunPB.QqSdkFileUploadMsgReq)localObject, new TransmissionHelper.TransmissionHostInterfaceImpl.2(this, paramUploadServerInfoCallback, paramUploadFile));
      return;
      if (paramUploadFile.sha != null) {
 ...
 * Qualified Name:     cooperation.weiyun.TransmissionHelper.TransmissionHostInterfaceImpl
