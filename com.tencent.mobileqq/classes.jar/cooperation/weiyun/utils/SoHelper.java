...
public class SoHelper
{
  ...
  static int a(String paramString)
  {
    ...
    //   30: iconst_0
    //   31: ifeq +11 -> 42
    //   34: new 64	java/lang/NullPointerException
    //   37: dup
    //   38: invokespecial 65	java/lang/NullPointerException:<init>	()V
    //   41: athrow
    //   42: iconst_0
    //   43: ifeq +11 -> 54
    //   46: new 64	java/lang/NullPointerException
    //   49: dup
    //   50: invokespecial 65	java/lang/NullPointerException:<init>	()V
    //   53: athrow
    //   54: iconst_0
    //   55: ifeq +11 -> 66
    //   58: new 64	java/lang/NullPointerException
    //   61: dup
    //   62: invokespecial 65	java/lang/NullPointerException:<init>	()V
    //   65: athrow
    //   66: iconst_0
    //   67: ireturn
    //   68: new 67	java/io/FileInputStream
    //   71: dup
    //   72: aload_0
    //   73: invokespecial 70	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   76: astore 5
    //   78: aload 5
    //   80: ifnull +358 -> 438
    //   83: new 72	java/io/InputStreamReader
    //   86: dup
    //   87: aload 5
    //   89: invokespecial 75	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   92: astore_3
    //   93: new 77	java/io/BufferedReader
    //   96: dup
    //   97: aload_3
    //   98: invokespecial 80	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   101: astore 4
    //   103: ldc 82
    //   105: astore_0
    //   106: aload 4
    //   108: invokevirtual 85	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   111: astore 6
    //   113: aload 6
    //   115: ifnull +30 -> 145
    ...
    //   147: ifnull +8 -> 155
    //   150: aload 5
    //   152: invokevirtual 90	java/io/InputStream:close	()V
    //   155: aload_3
    //   156: ifnull +7 -> 163
    //   159: aload_3
    //   160: invokevirtual 91	java/io/InputStreamReader:close	()V
    //   163: aload_0
    //   164: astore_3
    //   165: aload 4
    //   167: ifnull +10 -> 177
    ...
    //   176: astore_3
    //   177: aload_3
    //   178: invokestatic 98	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   181: ifne +161 -> 342
    //   184: aload_3
    //   185: invokestatic 103	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   188: istore_1
    //   189: iload_1
    //   190: ireturn
    //   191: astore_0
    ...
    //   206: ifnull +8 -> 214
    //   209: aload 5
    //   211: invokevirtual 90	java/io/InputStream:close	()V
    //   214: aload_3
    //   215: ifnull +7 -> 222
    //   218: aload_3
    //   219: invokevirtual 91	java/io/InputStreamReader:close	()V
    //   222: aload_0
    //   223: astore_3
    //   224: aload 4
    //   226: ifnull -49 -> 177
    //   229: aload 4
    //   231: invokevirtual 92	java/io/BufferedReader:close	()V
    //   234: aload_0
    //   235: astore_3
    //   236: goto -59 -> 177
    //   239: astore_3
    ...
    //   260: ifnull +8 -> 268
    //   263: aload 5
    //   265: invokevirtual 90	java/io/InputStream:close	()V
    //   268: aload_3
    //   269: ifnull +7 -> 276
    //   272: aload_3
    //   273: invokevirtual 91	java/io/InputStreamReader:close	()V
    //   276: aload_0
    //   277: astore_3
    //   278: aload 4
    //   280: ifnull -103 -> 177
    //   283: aload 4
    //   285: invokevirtual 92	java/io/BufferedReader:close	()V
    //   288: aload_0
    //   289: astore_3
    //   290: goto -113 -> 177
    //   293: astore_3
    ...
    //   311: ifnull +8 -> 319
    //   314: aload 5
    //   316: invokevirtual 90	java/io/InputStream:close	()V
    //   319: aload_3
    //   320: ifnull +7 -> 327
    //   323: aload_3
    //   324: invokevirtual 91	java/io/InputStreamReader:close	()V
    //   327: aload 4
    //   329: ifnull +8 -> 337
    //   332: aload 4
    //   334: invokevirtual 92	java/io/BufferedReader:close	()V
    //   337: aload_0
    //   338: athrow
    //   339: astore_0
    //   340: iconst_0
  ...
  public static void a(Context paramContext, SoHelper.SoListener paramSoListener)
  {
    ...
    String str2 = WeiyunPathUtil.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    WyDownloader.a().a(b, str1, "SoHelper", new SoHelper.1(str2, str1, paramSoListener, paramContext, localFile1, localFile2));
  }
