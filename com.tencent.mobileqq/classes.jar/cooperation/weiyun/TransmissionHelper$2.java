...
{
  public void a(DownloadFile paramDownloadFile, int paramInt, WyDownloader.DownloadServerInfoCallback paramDownloadServerInfoCallback)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      WeiyunApi.a((WeiyunPB.DiskFileBatchDownloadMsgReq)localObject2, new TransmissionHelper.2.1(this, paramDownloadFile, paramDownloadServerInfoCallback, paramInt));
      return;
      bool = false;
    }
  }
 ...
 * Qualified Name:     cooperation.weiyun.TransmissionHelper.2
