  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 19218, 19314, 20074, 22426, 22434, 88010, 88042, 208906, 1964162, 1965602, 1965650, 1968002, 1968010 }, new String[] { "DiskFileBatchDownloadMsgReq_body", "DiskFileDocDownloadAbsMsgReq_body", "DiskDirFileBatchDeleteExMsgReq_body", "DiskPicBackupReq_body", "DiskAlbumStatusReportReq_body", "PwdQueryMsgReq_body", "PwdVerifyMsgReq_body", "LibInfoListGetMsgReq_body", "WeiyunTrialCouponUseMsgReq_body", "CrossBidProxyCopyFileToOtherBidMsgReq_body", "CrossBidProxyOfflineFileGetListMsgReq_body", "QqSdkFileUploadMsgReq_body", "AioPicAndVideoCopyToWeiyunMsgReq_body" }, new Object[] { null, null, null, null, null, null, null, null, null, null, null, null, null }, ReqMsgBody.class);
 ...
 * Qualified Name:     cooperation.weiyun.channel.pb.WeiyunPB.ReqMsgBody
