...
final class PBSerialization
{
  ...
  public static PBPackage a(byte[] paramArrayOfByte)
  {
    ...
    System.arraycopy(paramArrayOfByte, i + PBCommonHead.d, arrayOfByte, 0, j);
  ...
  public static byte[] a(PBPackage paramPBPackage)
  {
    ...
    System.arraycopy(paramPBPackage, 0, arrayOfByte2, arrayOfByte1.length + i, paramPBPackage.length);
    return arrayOfByte2;
  }
}
 ...
 * Qualified Name:     cooperation.weiyun.channel.PBSerialization
