...
public class OpenWeiyunVipHelper
{
  private static volatile long jdField_a_of_type_Long = 0L;
  private static QQCustomDialog jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = null;
  private static OpenWeiyunVipHelper.OpenVipHandler jdField_a_of_type_CooperationWeiyunVipOpenWeiyunVipHelper$OpenVipHandler = new OpenWeiyunVipHelper.OpenVipHandler(Looper.getMainLooper());
  ...
  {
    Message localMessage = jdField_a_of_type_CooperationWeiyunVipOpenWeiyunVipHelper$OpenVipHandler.obtainMessage();
    localMessage.what = 3001;
    jdField_a_of_type_CooperationWeiyunVipOpenWeiyunVipHelper$OpenVipHandler.sendMessage(localMessage);
  }
  ...
  public static void b(Activity paramActivity, int paramInt)
  {
    ...
    jdField_a_of_type_CooperationWeiyunVipOpenWeiyunVipHelper$OpenVipHandler.removeMessages(3000);
    Message localMessage = jdField_a_of_type_CooperationWeiyunVipOpenWeiyunVipHelper$OpenVipHandler.obtainMessage();
    localMessage.what = 3000;
    localMessage.obj = paramActivity;
    localMessage.arg1 = paramInt;
    jdField_a_of_type_CooperationWeiyunVipOpenWeiyunVipHelper$OpenVipHandler.sendMessageDelayed(localMessage, 1000L);
  }
  ...
  private static void d(Activity paramActivity, int paramInt)
  {
    ...
    if (b(paramInt))
    {
      str1 = BaseApplicationImpl.getContext().getString(2131692653);
      if (!b(paramInt)) {
        break label161;
      }
    }
    label161:
    for (String str2 = BaseApplicationImpl.getContext().getString(2131692646);; str2 = BaseApplicationImpl.getContext().getString(2131692649))
    {
      jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(paramActivity, 230, str1, str2, 2131692651, 2131692652, new OpenWeiyunVipHelper.1(paramInt, paramActivity), new OpenWeiyunVipHelper.2());
      jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new OpenWeiyunVipHelper.3());
      jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
      return;
      str1 = BaseApplicationImpl.getContext().getString(2131692654);
      break;
    }
  }
}
 ...
 * Qualified Name:     cooperation.weiyun.vip.OpenWeiyunVipHelper
