  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      ocd.a(null, this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), "0X8009662", "0X8009662", 0, 0, String.valueOf(this.jdField_a_of_type_Int), String.valueOf(this.b), "", localJSONObject.toString(), false);
      return;
    }
