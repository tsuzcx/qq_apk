  ...
  implements Runnable
{
  ...
  {
    int j = 0;
    Object localObject1 = bhvh.a("local_kd_tab_has_set");
    ...
    for (int i = 1;; i = 0)
    {
      bhvh.a("local_kd_tab_has_set_prefix", Integer.valueOf(i));
      ...
      if ((localObject2 instanceof Boolean))
      {
        ...
        bhvh.a("local_kd_tab_switch_prefix", Integer.valueOf(i));
      }
