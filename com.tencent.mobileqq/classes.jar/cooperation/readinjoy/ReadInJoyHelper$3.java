  ...
  implements Runnable
{
  ...
  {
    int j = 0;
    Object localObject1 = bmqa.a("local_kd_tab_has_set");
    ...
    for (int i = 1;; i = 0)
    {
      bmqa.a("local_kd_tab_has_set_prefix", Integer.valueOf(i));
      Object localObject2 = bmqa.a("local_kd_tab_switch");
      if ((localObject2 instanceof Boolean))
      {
        ...
        bmqa.a("local_kd_tab_switch_prefix", Integer.valueOf(i));
      }
