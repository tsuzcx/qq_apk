  ...
  extends AppContentProvider
{
  ...
  private SQLiteDatabase a(Uri paramUri, boolean paramBoolean)
  {
    ...
    return null;
    if ((this.jdField_a_of_type_Bkwu == null) || (!this.jdField_a_of_type_Bkwu.jdField_a_of_type_JavaLangString.equals(str2)))
    {
      this.jdField_a_of_type_Bkwu = new bkwu(this, localAppRuntime.getApplication().getApplicationContext(), str1);
      this.jdField_a_of_type_Bkwu.jdField_a_of_type_JavaLangString = str2;
    }
    if (paramBoolean) {
      return this.jdField_a_of_type_Bkwu.getReadableDatabase();
    }
    return this.jdField_a_of_type_Bkwu.getWritableDatabase();
  }
