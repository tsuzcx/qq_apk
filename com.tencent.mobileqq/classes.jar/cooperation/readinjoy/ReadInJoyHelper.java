...
import com.tencent.biz.pubaccount.readinjoy.config.QQAladdinLogger;
import com.tencent.biz.pubaccount.readinjoy.config.QQAladdinRequestHandler;
import com.tencent.biz.pubaccount.readinjoy.config.QQAsyncTaskExecutor;
...
public class ReadInJoyHelper
{
  ...
  private static List<SelfInfoModule.BusinessCountInfo> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131712984);
  ...
  public static boolean A()
  {
    ...
    Object localObject2 = a(ReadInJoyUtils.a(), true, true);
  ...
  public static int D(AppRuntime paramAppRuntime)
  {
    ...
    A = paramAppRuntime.getInt("key_kandian_ad_exposure_threshold", ReadInJoyConstants.jdField_c_of_type_Int);
  ...
  {
    boolean bool = ((Boolean)a(k(), Boolean.valueOf(false))).booleanValue();
    if (QLog.isColorLevel()) {
  ...
  {
    boolean bool = ((Boolean)a(l(), Boolean.valueOf(true))).booleanValue();
    if (QLog.isColorLevel()) {
  ...
  public static int a(int paramInt)
  {
    ...
    if (RIJUserLevelModule.a().a(4, false)) {
      paramInt = i1;
    }
    return paramInt;
  }
  ...
  {
    Object localObject = a(ReadInJoyUtils.a(), false, true);
    if (localObject == null) {
      localObject = null;
    }
  ...
  public static LebaViewItem a(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject = localILebaHelperService.getLebaMgrList();
    if ((localObject == null) || (((List)localObject).isEmpty()))
    {
      localILebaHelperService.initLebaHelper();
      localILebaHelperService.reloadLebaItems(paramQQAppInterface);
    }
    for (paramQQAppInterface = localILebaHelperService.getLebaMgrList();; paramQQAppInterface = (QQAppInterface)localObject)
    {
      if (paramQQAppInterface != null)
      {
        localObject = paramQQAppInterface.iterator();
        do
        {
          if (!((Iterator)localObject).hasNext()) {
            break;
          }
          paramQQAppInterface = (LebaViewItem)((Iterator)localObject).next();
        } while ((paramQQAppInterface == null) || (paramQQAppInterface.jdField_a_of_type_ComTencentMobileqqLebaEntityLebaPluginInfo == null) || (paramQQAppInterface.jdField_a_of_type_ComTencentMobileqqLebaEntityLebaPluginInfo.uiResId != 1130L));
      }
      for (;;)
      {
  ...
  public static ReadInJoyHelper.VideoPackSetting a(AppRuntime paramAppRuntime)
  {
    ...
    ReadInJoyHelper.VideoPackSetting localVideoPackSetting;
    do
    {
      return null;
      localVideoPackSetting = new ReadInJoyHelper.VideoPackSetting();
      ...
      try
      {
        ...
        if (((Node)localObject).getNodeType() == 1)
        {
          ...
          if (TextUtils.equals("video_width", str1)) {
            localVideoPackSetting.jdField_b_of_type_Int = Integer.parseInt(str2);
          }
        }
        else
        {
        ...
        localVideoPackSetting.jdField_b_of_type_Float = Float.parseFloat(str2);
        continue;
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (TextUtils.equals((CharSequence)localObject, "double_video")) {
        for (localObject = localNode.getFirstChild(); localObject != null; localObject = ((Node)localObject).getNextSibling()) {
          if (((Node)localObject).getNodeType() == 1)
          {
            ...
            str2 = ((Node)localObject).getFirstChild().getNodeValue();
            if (TextUtils.equals("aspect_ratio", str1)) {
              localVideoPackSetting.jdField_a_of_type_Float = Float.parseFloat(str2);
            }
          }
        }
      }
      if (TextUtils.equals((CharSequence)localObject, "is_play_button_show")) {
        localVideoPackSetting.jdField_a_of_type_Boolean = str1.equals("1");
      }
      for (;;)
      {
        label447:
        ...
        if (TextUtils.equals((CharSequence)localObject, "title_label_number_of_lines")) {
          localVideoPackSetting.jdField_a_of_type_Int = Integer.parseInt(str1);
        } else if (TextUtils.equals((CharSequence)localObject, "title_hidden")) {
          localVideoPackSetting.jdField_b_of_type_Boolean = str1.equals("0");
        } else if (TextUtils.equals((CharSequence)localObject, "play_and_comment_hidden")) {
          localVideoPackSetting.jdField_c_of_type_Boolean = str1.equals("0");
        }
      }
      label529:
  ...
  public static <T> T a(String paramString, T paramT, boolean paramBoolean)
  {
    ...
    SharedPreferences localSharedPreferences = a(ReadInJoyUtils.a(), paramBoolean, true);
    if (localSharedPreferences == null) {
  ...
  public static String a(long paramLong1, long paramLong2, String paramString1, String paramString2)
  {
    ...
    if ((paramLong1 >= 10000L) && (paramLong1 < paramLong2))
    {
      ...
      if (Math.round(d1) - d1 == 0.0D) {
        return String.valueOf(d1) + HardCodeUtil.a(2131712906);
      }
      return String.valueOf(d1) + HardCodeUtil.a(2131712713);
    }
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      ...
      localJSONObject2.put("bettery_level", UserActionReportUtils.a());
      localJSONObject2.put("network_type", UserActionReportUtils.a());
      localJSONObject2.put("king_card", d());
      localJSONObject2.put("system_brightness", UserActionReportUtils.a((Context)localObject));
      localJSONObject2.put("headset_on", UserActionReportUtils.a((Context)localObject));
      localJSONObject2.put("volume", UserActionReportUtils.b((Context)localObject));
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    while (((!DailyModeConfigHandler.c((int)paramBaseArticleInfo.mChannelID)) && (!a(paramBaseArticleInfo.mChannelID))) || (!B())) {
      return;
    }
  ...
  public static void a(LikeAnimationInfo paramLikeAnimationInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = a(ReadInJoyUtils.a(), false, true);
      } while (localObject == null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    //   2: monitorenter
    //   3: iload_1
    //   4: putstatic 68	cooperation/readinjoy/ReadInJoyHelper:jdField_b_of_type_Boolean	Z
    //   7: aload_0
    //   8: iconst_1
    //   9: invokestatic 600	cooperation/readinjoy/ReadInJoyHelper:a	(Lcom/tencent/mobileqq/app/QQAppInterface;I)Landroid/content/SharedPreferences;
    //   12: astore_2
    //   13: aload_2
    //   14: ifnonnull +7 -> 21
    //   17: ldc 2
    ...
    //   20: return
    //   21: aload_2
    //   22: invokeinterface 294 1 0
    //   27: astore_2
    //   28: aload_2
    //   29: ldc_w 1285
    //   32: iload_1
    //   33: invokeinterface 1129 3 0
    //   38: pop
    //   39: aload_2
    //   40: iconst_1
    //   41: invokestatic 305	cooperation/readinjoy/ReadInJoyHelper:a	(Landroid/content/SharedPreferences$Editor;Z)V
    //   44: aload_0
    //   45: iload_1
    //   46: invokestatic 1289	com/tencent/biz/pubaccount/readinjoy/decoupling/uilayer/framewrok/util/RIJAppSetting:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Z)V
    //   49: goto -32 -> 17
    //   52: astore_0
    //   53: ldc 2
    //   55: monitorexit
  ...
  public static <T> void a(String paramString, T paramT, boolean paramBoolean)
  {
    ...
    Object localObject = a(ReadInJoyUtils.a(), paramBoolean, true);
    if (localObject == null)
    {
  ...
  public static void a(AppRuntime paramAppRuntime, ReadInJoyMedalInfo paramReadInJoyMedalInfo)
  {
    ...
    {
      return;
      paramReadInJoyMedalInfo.jdField_e_of_type_JavaLangString = "1";
      paramReadInJoyMedalInfo.jdField_f_of_type_JavaLangString = "1";
      paramReadInJoyMedalInfo.jdField_h_of_type_JavaLangString = ReadInJoyUtils.a();
      paramReadInJoyMedalInfo = paramReadInJoyMedalInfo.a();
    } while (TextUtils.isEmpty(paramReadInJoyMedalInfo));
    jdField_i_of_type_JavaLangString = paramReadInJoyMedalInfo;
    L(paramAppRuntime, paramReadInJoyMedalInfo);
  ...
  public static boolean a(RIJTabFrameBase.KandianFrameStatus paramKandianFrameStatus, boolean paramBoolean)
  {
    boolean bool1 = false;
    if (paramKandianFrameStatus.a() != paramBoolean) {
      bool1 = true;
    }
    boolean bool2 = RIJXTabConfigHandler.a.a().a();
    if (paramKandianFrameStatus.b() != bool2) {
      bool1 = true;
    }
    QLog.d("ReadInJoyHelper", 1, "needUpdateKandianFrame,currentIsShow=" + paramBoolean + " isCurrentXTabMode=" + bool2 + " flag=" + bool1 + "\t KandianFrameStatus=" + paramKandianFrameStatus);
    return bool1;
  }
  
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    if ((paramArticleInfo == null) || (TextUtils.isEmpty(paramArticleInfo.mArticleContentUrl))) {
      return false;
    }
    return d(paramArticleInfo.mArticleContentUrl);
  }
  ...
  public static String b(int paramInt)
  {
    ...
    if (paramInt < 99989500)
    {
      if (paramInt % 10000 < 500) {
        return paramInt / 10000 + HardCodeUtil.a(2131712838);
      }
      int i1 = paramInt;
      if (paramInt % 500 == 0) {
        i1 = paramInt + 1;
      ...
      if (i1 % 10000 > 9500) {
        return (i1 + 500) / 10000 + HardCodeUtil.a(2131712986);
      }
  ...
  public static void b(AppRuntime paramAppRuntime)
  {
    ...
    paramAppRuntime = paramAppRuntime.edit();
    paramAppRuntime.putString("readinjoy_individual_push_date", RIJMergeKanDianMessage.a.format(Long.valueOf(System.currentTimeMillis())));
    a(paramAppRuntime, true);
  }
  ...
  public static boolean b(int paramInt)
  {
    boolean bool1 = true;
    boolean bool2 = true;
    SharedPreferences localSharedPreferences = a(ReadInJoyUtils.a(), false, true);
    if (localSharedPreferences == null) {
      return bool2;
    }
  ...
  public static void c(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(str)) {
        ReadInJoyConstants.jdField_h_of_type_JavaLangString = str;
      }
      ...
      ReadInJoyConstants.k = ReadInJoyConstants.jdField_g_of_type_JavaLangString;
  ...
  public static boolean d(String paramString)
  {
    ...
    {
      QLog.d("ReadInJoyHelper", 1, "isWxArticle error!  msg=" + paramString);
    }
    return false;
  }
  ...
  {
    String str = (String)a("readinjoy_viola_url_personal_homepage", ReadInJoyConstants.jdField_g_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
  ...
  {
    if ((paramBoolean) && (!RIJXTabFrameUtils.a.a())) {
      z += 1;
    }
    for (;;)
    {
  ...
  {
    boolean bool = true;
    SharedPreferences localSharedPreferences = a(RIJQQAppInterfaceUtil.a(), true, true);
    if (localSharedPreferences == null)
    {
      QLog.d("ReadInJoyHelper", 1, "failed to get sp IndividualPushSwitch");
      return false;
  ...
  public static int f()
  {
    int i1 = ((Integer)a("readinjoy_video_recommend_entrance_direct", Integer.valueOf(3))).intValue();
  ...
  public static void f()
  {
    ...
    {
      Aladdin.initialize(Aladdin.InitParams.newBuilder().withUserId(ReadInJoyUtils.a()).withAppVersion("8.5.5").withContext(BaseApplicationImpl.getContext()).withExecutor(QQAsyncTaskExecutor.a).withRequestHandler(new QQAladdinRequestHandler()).withLogger(new QQAladdinLogger()).withAppFlavorId(AppSetting.a() + "").build());
  ...
  public static boolean g()
  {
    return Aladdin.getConfig(436).getIntegerFromString("comment_topic_switch", 0) == 1;
  }
  ...
  public static boolean j()
  {
    ...
    {
      QLog.d("ReadInJoyHelper", 1, "hideKandianTab error! msg=" + localException);
    }
    return bool2;
  }
  ...
  {
    return ReadInJoyUtils.a() + "_" + "readinjoy_ugc_account_create_complete";
  }
  ...
  {
    return ReadInJoyUtils.a() + "_" + "readinjoy_first_ugc_account_create";
  }
  ...
  public static int r(AppRuntime paramAppRuntime)
  {
    ...
    t = paramAppRuntime.getInt("kandian_default_bit_rate", ReadInJoyConstants.jdField_a_of_type_Int);
    return t;
  }
  ...
  {
    return (z > 0) || (RIJXTabFrameUtils.a.a());
  }
