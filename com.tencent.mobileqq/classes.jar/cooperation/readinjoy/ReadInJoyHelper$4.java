  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject1 = bgmq.a("remote_kd_tab_switch");
    Object localObject2 = bgmq.a("local_kd_tab_switch");
    int k;
    int n;
    int i1;
    label63:
    ...
    {
      k = 1;
      n = bgmq.a("local_kd_tab_switch").intValue();
      i1 = bgmq.a("local_kd_tab_switch_prefix").intValue();
      ...
      m = i;
      label66:
      localObject1 = bgmq.a("local_kd_tab_has_set");
      ...
      for (int j = -1;; j = -1) {
        for (;;)
        {
          ...
          try
          {
            ...
            bgmq.a((JSONObject)localObject2);
            ndn.a(null, this.a.getAccount(), "0X8009663", "0X8009663", 0, 0, String.valueOf(i), String.valueOf(j), String.valueOf(k), ((JSONObject)localObject2).toString(), false);
