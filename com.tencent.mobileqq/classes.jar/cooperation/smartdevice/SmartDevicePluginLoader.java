  ...
  implements Handler.Callback, PluginManagerHelper.OnPluginManagerLoadedListener
{
  ...
  private IPluginManager.PluginParams jdField_a_of_type_CooperationPluginIPluginManager$PluginParams;
  ...
  private void b()
  {
    ...
    if ((this.jdField_b_of_type_JavaLangString != null) && (this.jdField_b_of_type_JavaLangString.compareToIgnoreCase("launchService") == 0))
    {
      ...
      if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_b_of_type_CooperationPluginIPluginManager$PluginParams != null))
      {
        ...
        IPluginManager.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_CooperationPluginIPluginManager$PluginParams);
        this.jdField_b_of_type_CooperationPluginIPluginManager$PluginParams = null;
        this.jdField_a_of_type_AndroidContentContext = null;
      }
    }
  ...
  public void a(Activity paramActivity, AppRuntime paramAppRuntime, String paramString1, Intent paramIntent, String paramString2, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener, Class paramClass)
  {
    ...
    paramAppRuntime = new QQProgressDialog(paramActivity, paramActivity.getResources().getDimensionPixelSize(2131558448));
    ...
    for (;;)
    {
      ...
      ((SmartDeviceProxyMgr)paramOnDismissListener.a(51)).c();
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: plugin is installed " + this.jdField_a_of_type_CooperationPluginIPluginManager$PluginParams.e);
        }
        if (bool)
        {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: waiting for plugin to install " + this.jdField_a_of_type_CooperationPluginIPluginManager$PluginParams.e);
      }
      this.c = "openActivity";
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getContext(), this);
      return;
  ...
  public void a(AppRuntime paramAppRuntime, ServiceConnection paramServiceConnection)
  {
    ...
    this.jdField_b_of_type_CooperationPluginIPluginManager$PluginParams.d = "智能设备";
    ...
    this.jdField_b_of_type_CooperationPluginIPluginManager$PluginParams.e = "com.tencent.device.ipc.QQSmartDeviceService";
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      IPluginManager.b(paramAppRuntime.getApplication(), this.jdField_b_of_type_CooperationPluginIPluginManager$PluginParams);
      this.jdField_b_of_type_CooperationPluginIPluginManager$PluginParams = null;
      this.jdField_a_of_type_AndroidContentContext = null;
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader]  launchPluginActivity:" + this.jdField_a_of_type_CooperationPluginIPluginManager$PluginParams.e);
        }
        IPluginManager.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_CooperationPluginIPluginManager$PluginParams);
      }
      this.jdField_a_of_type_AndroidAppActivity = null;
