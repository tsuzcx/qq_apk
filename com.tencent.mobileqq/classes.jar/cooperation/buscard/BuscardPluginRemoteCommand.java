  ...
  extends RemoteCommand
{
  ...
  public BuscardPluginRemoteCommand(String paramString, boolean paramBoolean)
  {
    super(paramString);
    this.a = paramBoolean;
  }
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = BitmapManager.a(paramResources, 2130841170);
  ...
  private Bundle a(Bundle paramBundle1, Bundle paramBundle2, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (Bundle localBundle = new Bundle();; localBundle = paramBundle2)
    {
      ...
      if (!TextUtils.isEmpty(paramBundle2))
      {
        ...
        if (!TextUtils.isEmpty(paramBundle2))
        {
          localObject1 = TroopShareUtility.a(paramBundle2, BaseApplicationImpl.getContext().getResources(), i, j, bool1);
          if (localObject1 != null) {
            localBundle.putString("path", QRUtils.a(BaseApplicationImpl.getContext(), paramBundle2.hashCode() + "", (Bitmap)localObject1));
          }
        }
      }
      if (QLog.isColorLevel())
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        {
          SosoInterface.a(new alsy(this, 3, true, true, 300000L, false, false, "buscardLocation", localBundle, paramOnInvokeFinishLinstener));
          break;
        }
        Object localObject2;
        if (paramBundle2.equals("publicAccount"))
        {
          ...
          for (paramBundle2 = (Bundle)localObject1;; paramBundle2 = "null")
          {
            ...
            PublicAccountUtil.a(a(), a().getApp(), (String)localObject1, new alsz(this, localBundle, paramOnInvokeFinishLinstener));
            break;
          }
        }
        ...
        else
        {
          ...
          if (a() != null)
          {
            ...
            if (!TextUtils.isEmpty(paramBundle2))
            {
              localObject2 = (PublicAccountDataManager)a().getManager(55);
              if (localObject2 != null) {
                bool1 = ((PublicAccountDataManager)localObject2).a(Long.valueOf(paramBundle2));
              }
              bool2 = bool1;
              if (QLog.isColorLevel())
              {
  ...
  public static void a()
  {
    ...
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand"))) {
      localPluginCommunicationHandler.register(new BuscardPluginRemoteCommand("com.tencent.nfc.buscard.remotecommand", true));
    }
    if ((localPluginCommunicationHandler != null) && (!localPluginCommunicationHandler.containsCmd("com.tencent.nfc.buscard.remotecommand.async"))) {
      localPluginCommunicationHandler.register(new BuscardPluginRemoteCommand("com.tencent.nfc.buscard.remotecommand.async", false));
    }
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    try
    {
      ...
      {
        new Handler(Looper.getMainLooper()).post(new alsx(this, paramBundle, localBundle, paramOnInvokeFinishLinstener));
        return localBundle;
      }
 ...
 * Qualified Name:     cooperation.buscard.BuscardPluginRemoteCommand
