...
class BuscardHelper$BuscardInstallListener
  implements OnPluginInstallListener, Runnable
{
  ...
  public BuscardHelper$BuscardInstallListener(AppRuntime paramAppRuntime, Intent paramIntent)
  {
  ...
  public void onInstallDownloadProgress(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsResultReceiver != null)
    {
      ...
      this.jdField_a_of_type_AndroidOsResultReceiver.send(1, paramString);
    }
  }
 ...
 * Qualified Name:     cooperation.buscard.BuscardHelper.BuscardInstallListener
