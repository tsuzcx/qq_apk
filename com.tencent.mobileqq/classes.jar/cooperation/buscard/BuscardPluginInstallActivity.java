  ...
  extends BaseActivity
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new bggr(this);
    ...
    try
    {
      ...
      if (BridgeHelper.a("BuscardPlugin.apk", this.app.getCurrentAccountUin(), (Context)localObject1)) {
        if (getIntent() != null)
        {
          ...
          localIntent.putExtra("qq_version", bbdh.c());
          ...
          ((JSONObject)localObject2).put("font_level", ajwc.a());
    ...
    catch (Throwable localThrowable1)
    {
      try
      {
        ...
        else
        {
          ...
          l1 = System.currentTimeMillis();
          if (!this.jdField_a_of_type_Bglh.isPlugininstalled("BuscardPlugin.apk")) {
            break label644;
          }
      ...
      catch (Throwable localThrowable2)
      {
        ...
        this.jdField_a_of_type_Bglh.installPlugin("BuscardPlugin.apk", this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener);
      }
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    while ((this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog == null) || (!this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog.isShowing()))
    {
      ...
      this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog.setMessage(ajya.a(2131701241));
      this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog.show();
      return;
    }
  ...
  private void b()
  {
    ...
    for (;;)
    {
      localIntent.putExtra("skey", this.c);
      localIntent.putExtra("skey_type", "2");
      localIntent.putExtra("font_level", ajwc.a());
      ...
      try
      {
        ...
        localObject1 = new bglq(1);
        ((bglq)localObject1).jdField_b_of_type_JavaLangString = "BuscardPlugin.apk";
        ((bglq)localObject1).d = "BuscardPlugin";
        ((bglq)localObject1).jdField_a_of_type_AndroidAppDialog = null;
        ((bglq)localObject1).jdField_a_of_type_JavaLangString = this.app.getCurrentAccountUin();
        ((bglq)localObject1).jdField_a_of_type_AndroidContentIntent = localIntent;
        ((bglq)localObject1).e = a(this.jdField_a_of_type_JavaLangString, localIntent);
        ((bglq)localObject1).jdField_a_of_type_JavaLangClass = QWalletNFCProxyActivity.class;
        ((bglq)localObject1).jdField_b_of_type_Int = 19;
        ((bglq)localObject1).c = 15000;
        ((bglq)localObject1).jdField_b_of_type_Boolean = false;
        ((bglq)localObject1).f = null;
        bglh.a(this, (bglq)localObject1);
        l2 = System.currentTimeMillis();
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bggs = new bggs(this, null);
      registerReceiver(this.jdField_a_of_type_Bggs, paramBundle);
  ...
  public void doOnDestroy()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Bggs != null) {
        unregisterReceiver(this.jdField_a_of_type_Bggs);
      }
      a(false);
      super.doOnDestroy();
      return;
