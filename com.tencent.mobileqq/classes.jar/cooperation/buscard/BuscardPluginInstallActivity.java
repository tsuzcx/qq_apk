  ...
  extends BaseActivity
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new bihp(this);
    ...
    try
    {
      ...
      if (BridgeHelper.a("BuscardPlugin.apk", this.app.getCurrentAccountUin(), (Context)localObject1)) {
        if (getIntent() != null)
        {
          ...
          localIntent.putExtra("qq_version", bdcb.c());
          ...
          ((JSONObject)localObject2).put("font_level", alnq.a());
    ...
    catch (Throwable localThrowable1)
    {
      try
      {
        ...
        else
        {
          ...
          l1 = System.currentTimeMillis();
          if (!this.jdField_a_of_type_Bimg.isPlugininstalled("BuscardPlugin.apk")) {
            break label644;
          }
      ...
      catch (Throwable localThrowable2)
      {
        ...
        this.jdField_a_of_type_Bimg.installPlugin("BuscardPlugin.apk", this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener);
      }
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    while ((this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog == null) || (!this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog.isShowing()))
    {
      ...
      this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog.setMessage(alpo.a(2131701610));
      this.jdField_a_of_type_CooperationQwalletPluginQWalletPayProgressDialog.show();
      return;
    }
  ...
  private void b()
  {
    ...
    for (;;)
    {
      localIntent.putExtra("skey", this.c);
      localIntent.putExtra("skey_type", "2");
      localIntent.putExtra("font_level", alnq.a());
      ...
      try
      {
        ...
        localObject1 = new bimp(1);
        ((bimp)localObject1).jdField_b_of_type_JavaLangString = "BuscardPlugin.apk";
        ((bimp)localObject1).d = "BuscardPlugin";
        ((bimp)localObject1).jdField_a_of_type_AndroidAppDialog = null;
        ((bimp)localObject1).jdField_a_of_type_JavaLangString = this.app.getCurrentAccountUin();
        ((bimp)localObject1).jdField_a_of_type_AndroidContentIntent = localIntent;
        ((bimp)localObject1).e = a(this.jdField_a_of_type_JavaLangString, localIntent);
        ((bimp)localObject1).jdField_a_of_type_JavaLangClass = QWalletNFCProxyActivity.class;
        ((bimp)localObject1).jdField_b_of_type_Int = 19;
        ((bimp)localObject1).c = 15000;
        ((bimp)localObject1).jdField_b_of_type_Boolean = false;
        ((bimp)localObject1).f = null;
        bimg.a(this, (bimp)localObject1);
        l2 = System.currentTimeMillis();
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bihq = new bihq(this, null);
      registerReceiver(this.jdField_a_of_type_Bihq, paramBundle);
  ...
  public void doOnDestroy()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Bihq != null) {
        unregisterReceiver(this.jdField_a_of_type_Bihq);
      }
      a(false);
      super.doOnDestroy();
      return;
