  ...
  extends SimpleBaseEvent
{
  ...
  private byte[] assembleFakeStFeed(QCircleFakeFeed paramQCircleFakeFeed, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      localStFeed.title.set(vhd.a(paramQCircleFakeFeed.getTitle()));
      localStFeed.content.set(vhd.a(paramQCircleFakeFeed.getContent()));
    ...
    for (long l = System.currentTimeMillis() / 1000L;; l = paramQCircleFakeFeed.getCreateTime())
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        ((FeedCloudMeta.StTagInfo)localObject4).tagName.set(vhd.a(((LabelInfo)localObject3).name));
        ((FeedCloudMeta.StTagInfo)localObject4).tagId.set(vhd.a(((LabelInfo)localObject3).id));
    ...
    {
      localStFeed.poiInfo.address.set(vhd.a(paramQCircleFakeFeed.getPoiInfo().address));
      localStFeed.poiInfo.defaultName.set(vhd.a(paramQCircleFakeFeed.getPoiInfo().poiDefaultName));
      localStFeed.poiInfo.name.set(vhd.a(paramQCircleFakeFeed.getPoiInfo().poiName));
    }
    localStFeed.poster.set(vhb.a());
    if (!TextUtils.isEmpty(vhb.b())) {
      localStFeed.poster.nick.set(vhd.a(vhb.b()));
    }
    localStFeed.cover.picUrl.set(vhd.a(paramQCircleFakeFeed.getCoverPath()));
    ...
    for (;;)
    {
      ...
      localStFeed.video.playUrl.set(vhd.a(paramQCircleFakeFeed.getVideoPath()));
      if (!TextUtils.isEmpty((CharSequence)((ArrayList)localObject4).get(0)))
      {
        ...
        {
          paramInt = 0;
          while (paramInt < paramQCircleFakeFeed.getImgLists().size())
          {
            Object localObject5 = (String)paramQCircleFakeFeed.getImgLists().get(paramInt);
