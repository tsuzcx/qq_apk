...
public class RFWPicDownLoadTask
  implements Runnable
{
  ...
  public RFWPicDownLoadTask(@NotNull Option paramOption)
  {
  ...
  {
    RFWPicDownLoader localRFWPicDownLoader = RFWPicDownLoader.g();
    Option localOption = this.mOption;
    localRFWPicDownLoader.downLoad(localOption, new RFWPicDownLoadTask.1(this, localOption, paramLong));
  }
 ...
 * Qualified Name:     cooperation.qqcircle.picload.RFWPicDownLoadTask
