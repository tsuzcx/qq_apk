...
public class RFWPicDecodeTask
  extends RFWPicDownLoadTask
{
  public RFWPicDecodeTask(Option paramOption)
  {
    super(paramOption);
    this.mStatus = 5;
  }
  ...
  public void run()
  {
    ...
    QLog.i("QCircleFeedPicLoader", 4, ((StringBuilder)localObject).toString());
    if (this.mListener != null) {
 ...
 * Qualified Name:     cooperation.qqcircle.picload.RFWPicDecodeTask
