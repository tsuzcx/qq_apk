  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (QCircleLpReportDc05501.DataBuilder.access$2600(this.val$builder) != null) {
      localObject1 = QCircleReportHelper.getInstance().newSessionEntries(QCircleLpReportDc05501.DataBuilder.access$000(this.val$builder), QCircleLpReportDc05501.DataBuilder.access$2600(this.val$builder));
    } else {
      localObject1 = QCircleReportHelper.getInstance().newSessionEntries(QCircleLpReportDc05501.DataBuilder.access$000(this.val$builder));
    }
