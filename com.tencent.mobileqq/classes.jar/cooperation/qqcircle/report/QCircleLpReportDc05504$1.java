...
final class QCircleLpReportDc05504$1
  implements Runnable
{
  QCircleLpReportDc05504$1(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, List paramList, byte[] paramArrayOfByte) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      if (this.val$extList != null) {
        ((List)localObject).addAll(this.val$extList);
      }
