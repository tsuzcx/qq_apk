  ...
  extends BroadcastReceiver
{
  ...
  {
    this.fragmentWeakReference = new WeakReference(paramQCircleHybirdFragment);
  }
  
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    paramContext = (QCircleHybirdFragment)this.fragmentWeakReference.get();
    Object localObject;
    ...
    for (;;)
    {
      ...
      if (TextUtils.equals((CharSequence)localObject, "action_update_web_tag_follow_state")) {
        ...
        {
          QLog.e(QCircleHybirdFragment.access$000(), 1, "update tag follow state error.", paramContext);
        }
      }
    }
  }
 ...
 * Qualified Name:     cooperation.qqcircle.hybird.QCircleHybirdFragment.QCircleHybirdBroadcastReceiver
