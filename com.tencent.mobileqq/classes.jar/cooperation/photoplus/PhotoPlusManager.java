  ...
  implements Manager
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alof.aX + "PhotoPlus/";
  }
  ...
  public PhotoPlusManager(AppInterface paramAppInterface)
  {
    ...
    paramAppInterface.a();
    this.jdField_a_of_type_Bhsl = new bhsl(ThreadManager.getFileThreadLooper(), null);
    a(false);
  }
  
  private void a(String paramString1, String paramString2, String paramString3)
  {
    beae localbeae = (beae)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
    if (localbeae != null)
    {
    ...
    localbeae = new beae(paramString1, new File(paramString2));
    localbeae.n = true;
    beaj localbeaj = ((beag)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(47)).a(1);
    if (QLog.isColorLevel()) {
    ...
    localbeaj.a(localbeae, new biqf(this, paramString2, paramString1, paramString3), null);
  }
              ...
              if (j < n)
              {
                ...
                if (localSticker.isDirectory()) {
                  if (!localSticker.getName().equals(String.valueOf(m)))
                  {
                    ...
                    bdhb.a(localSticker.getAbsolutePath());
                  }
                }
                for (;;)
                {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bhsl.post(new PhotoPlusManager.UpdateTask(this, this.jdField_a_of_type_JavaUtilList, paramBoolean));
  }
  ...
  public boolean a(String paramString)
  {
    ...
    //   161: invokevirtual 70	com/tencent/common/app/AppInterface:getEntityManagerFactory	()Lawgg;
    //   164: invokevirtual 76	awgg:createEntityManager	()Lawgf;
    //   167: astore_2
    //   168: aload_2
    //   169: invokevirtual 322	awgf:a	()Lawgh;
    //   172: astore_1
    //   173: aload_1
    //   174: invokevirtual 325	awgh:a	()V
    //   177: aload_2
    //   178: ldc 78
    //   180: invokevirtual 328	awgf:a	(Ljava/lang/Class;)Z
    //   183: pop
    //   184: aload_0
    ...
    //   213: invokevirtual 331	awgf:b	(Lawge;)V
    //   216: goto -22 -> 194
    //   219: astore_3
    ...
    //   236: aload_1
    //   237: invokevirtual 335	awgh:b	()V
    //   240: aload_2
    //   241: invokevirtual 91	awgf:a	()V
    //   244: aload_0
    //   245: iconst_1
    ...
    //   250: ireturn
    //   251: aload_1
    //   252: invokevirtual 338	awgh:c	()V
    //   255: aload_1
    //   256: invokevirtual 335	awgh:b	()V
    //   259: goto -19 -> 240
    //   262: astore_2
    //   263: aload_1
    //   264: invokevirtual 335	awgh:b	()V
    //   267: aload_2
    //   268: athrow
