...
class awyh
  extends azkz
{
  awyh(awyg paramawyg, MessageForMixedMsg paramMessageForMixedMsg, QQAppInterface paramQQAppInterface, String paramString, int paramInt) {}
  ...
  private boolean a(MessageForPic paramMessageForPic, azkf paramazkf)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = FileUtils.calcMd5(awyg.a());
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("MixedMsgManager", 2, "WTF, picResult.mExtraObj is " + paramazkf.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
        }
        i = 0;
        break label227;
        if (QLog.isColorLevel())
  ...
  private boolean a(ArrayList<azkf> paramArrayList)
  {
    ...
    if (localMessageForMixedMsg.msgElemList != null)
    {
      ...
      if (!a((MessageForPic)localObject, (azkf)paramArrayList.get(i))) {
        bool1 = false;
      }
      i += 1;
    }
  ...
  public void a(int paramInt, ArrayList<azkf> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (!bool)
      {
        ...
        awyg.a(this.jdField_a_of_type_Awyg, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail");
        return;
      }
      ...
      awyg.a(this.jdField_a_of_type_Awyg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, bool);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.e("MixedMsgManager", 2, "onForwardMultiMsgPicsUpload failed");
    }
    awyg.a(this.jdField_a_of_type_Awyg, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail : result = " + paramInt);
  }
}
