...
{
  bfss jdField_a_of_type_Bfss = new bfss();
  private volatile boolean jdField_a_of_type_Boolean = true;
  
  public bfsq()
  {
    this.jdField_a_of_type_Bfss.a();
  }
  ...
  {
    return babp.b(BaseApplication.getContext());
  }
  ...
  {
    boolean bool = this.jdField_a_of_type_Bfss.a(paramString);
  ...
  public void registerNetworkStateObserver(UploadConfiguration.NetworkStateObserver paramNetworkStateObserver)
  {
    ...
    cooperation.qzone.util.NetworkState.addListener(new bfsr(this, paramNetworkStateObserver));
  }
}
