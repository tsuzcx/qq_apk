  ...
  public HashMap<String, String> a()
  {
    ...
    for (String str = "";; str = this.jdField_a_of_type_JavaLangString)
    {
      ...
      if (this.jdField_a_of_type_Int == 2)
      {
        ...
        localHashMap.put("param_device_info", rwi.a());
      }
      ...
      localHashMap.put("param_version", "8.4.1.4680");
      localHashMap.put("param_subversion", "8.4.1");
      ...
      localHashMap.put("param_prepareOptimizeConfigJson", pha.m());
      localHashMap.put("param_httpbuffertime_for_playpreload", String.valueOf(bmqa.e()));
      localHashMap.put("param_dynamic_buffer_switch", String.valueOf(bmqa.f()));
      localHashMap.put("param_dynamic_buffer_config_json", bmqa.c());
      ...
      localHashMap.put("param_isSuperPlayer", String.valueOf(siy.a.a()));
      ...
      localHashMap.put("param_codecReuseConfigVersion", String.valueOf(rui.a.a()));
      localHashMap.put("param_codecReuseDeviceSupport", String.valueOf(rui.a.a()));
