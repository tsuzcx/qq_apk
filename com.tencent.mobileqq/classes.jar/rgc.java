...
{
  private static final String jdField_a_of_type_JavaLangString = ajyc.a(2131713138);
  ...
  public rgc(@NonNull Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  public rgc(@NonNull Context paramContext, Runnable paramRunnable)
  {
    this(paramContext, 0);
  ...
  private Drawable a()
  {
    float f = actn.a(3.0F, getContext().getResources());
  ...
  private SpannableString a()
  {
    ...
    localSpannableString.setSpan(new rgd(this, Color.parseColor("#12B7F5")), i, "《QQ看点用户行为规范》".length() + i, 33);
  ...
  public static boolean a(BaseActivity paramBaseActivity, Runnable paramRunnable)
  {
    ...
    paramRunnable = new rgc(paramBaseActivity, paramRunnable);
    paramRunnable.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    paramRunnable.show();
    noo.a(null, "", "0X800992C", "0X800992C", 0, 0, "", "", "", "");
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBundle.findViewById(2131364720));
    this.jdField_a_of_type_AndroidWidgetTextView.setFocusable(false);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramBundle.findViewById(2131362211));
    this.jdField_a_of_type_AndroidViewView = paramBundle.findViewById(2131364275);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a());
    this.jdField_a_of_type_AndroidWidgetTextView.setMovementMethod(new rge());
    ...
    paramBundle.findViewById(2131363158).setBackgroundDrawable(localDrawable);
    setContentView(paramBundle);
    paramBundle = getWindow().getAttributes();
    paramBundle.height = -2;
    paramBundle.width = actn.a(320.0F, getContext().getResources());
