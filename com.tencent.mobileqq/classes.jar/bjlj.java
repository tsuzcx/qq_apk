...
public class bjlj
{
  ...
  HashMap<String, bjlk> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public bjlj(TraeAudioManager paramTraeAudioManager) {}
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    paramString = (bjlk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {}
  ...
  public String a(int paramInt)
  {
    ...
    for (localObject = (bjlk)localEntry.getValue();; localObject = null)
    {
      if (localObject != null) {}
      for (localObject = ((bjlk)localObject).a();; localObject = "DEVICE_NONE")
      {
        this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
        return localObject;
        i += 1;
  ...
  public String a(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bjlk localbjlk = (bjlk)((Map.Entry)localObject2).getValue();
      if ((localbjlk != null) && (localbjlk.a()) && (!localbjlk.a().equals(paramString)))
      {
        if (localObject1 == null) {
          localObject2 = localbjlk;
        }
        for (;;)
        {
  ...
  boolean a(String paramString, int paramInt)
  {
    ...
    bjlk localbjlk = new bjlk(this);
    if (localbjlk.a(paramString, paramInt)) {
    ...
    {
      return false;
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localbjlk);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    Object localObject = (bjlk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if ((localObject != null) && (((bjlk)localObject).a() != paramBoolean))
    {
      ((bjlk)localObject).a(paramBoolean);
      ((bjlk)localObject).b(paramBoolean);
      this.jdField_a_of_type_Boolean = true;
      if (QLog.isColorLevel())
      {
  ...
  public String b()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      ((Map.Entry)localObject2).getValue();
      bjlk localbjlk = (bjlk)((Map.Entry)localObject2).getValue();
      if ((localbjlk != null) && (localbjlk.a()) && (localbjlk.b()))
      {
        if (localObject1 == null) {
          localObject2 = localbjlk;
        }
  ...
  ArrayList<String> b()
  {
    ...
    while (localIterator.hasNext())
    {
      bjlk localbjlk = (bjlk)((Map.Entry)localIterator.next()).getValue();
      if ((localbjlk != null) && (localbjlk.a()) && (localbjlk.b())) {
        localArrayList.add(localbjlk.a());
      }
    }
    return localArrayList;
  }
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    Object localObject = (bjlk)this.jdField_a_of_type_JavaUtilHashMap.get(this.c);
    if ((localObject != null) && (((bjlk)localObject).a())) {}
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    bjlk localbjlk = (bjlk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if ((localbjlk != null) && (localbjlk.a())) {
      this.c = paramString;
    }
  ...
  String f()
  {
    bjlk localbjlk = (bjlk)this.jdField_a_of_type_JavaUtilHashMap.get(this.b);
    if ((localbjlk != null) && (localbjlk.a())) {
      return this.b;
    }
    return "DEVICE_NONE";
  ...
  String g()
  {
    bjlk localbjlk = (bjlk)this.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_JavaLangString);
    if ((localbjlk != null) && (localbjlk.a())) {
