  ...
  implements bkpa
{
  ...
  private SparseArray<bksn> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray(1);
  private bkso jdField_a_of_type_Bkso;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new bksm(this);
  ...
  private bksl(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidUtilSparseArray.put(1, bksn.a());
  ...
  public static bksl a(AppInterface paramAppInterface)
  {
    try
    {
      if (jdField_a_of_type_Bksl == null)
      {
        jdField_a_of_type_Bksl = new bksl(paramAppInterface);
        bkow.a(paramAppInterface).a(jdField_a_of_type_Bksl);
      }
      paramAppInterface = jdField_a_of_type_Bksl;
  ...
  public static void a()
  {
    try
    {
      if (jdField_a_of_type_Bksl != null)
      {
        jdField_a_of_type_Bksl.c();
        jdField_a_of_type_Bksl = null;
      }
      bkow.a();
      return;
    }
  ...
  private void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.usable) && (a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType)) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType == paramInt))
    {
      ...
      if ((this.jdField_a_of_type_Bkso != null) && (bool))
      {
        ...
        this.jdField_a_of_type_Bkso.a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name);
      }
    }
  }
  ...
  private void b()
  {
    bksn localbksn = (bksn)this.jdField_a_of_type_AndroidUtilSparseArray.get(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType);
    ...
    if ((localbksn == null) || (!this.jdField_a_of_type_Boolean)) {}
    do
    {
      return;
      a("startLocationUsingActivity", String.format("mRequestStatus=%s", new Object[] { localbksn.a() }), null);
    } while (localbksn.jdField_a_of_type_Int != 3);
    a("startLocationUsingActivity", String.format("mRequestBeginTime=%s", new Object[] { "" + localbksn.jdField_a_of_type_Long }), null);
    if (localbksn.jdField_a_of_type_Long > 0L)
    {
      long l = System.currentTimeMillis() - localbksn.jdField_a_of_type_Long;
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      localbksn.c();
      localbksn.b();
      localbksn.jdField_a_of_type_Int = 1;
      localbksn.jdField_a_of_type_Long = System.currentTimeMillis();
      bkow.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType);
      return;
    }
  }
  ...
  {
    bksn localbksn = (bksn)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localbksn != null)
    {
      ...
      if (localbksn.jdField_a_of_type_Int == 3) {
        break label98;
      }
      localbksn.jdField_a_of_type_Boolean = paramBoolean;
      if (paramBoolean) {
        localbksn.jdField_a_of_type_Int = 2;
      }
    }
    else
    {
    ...
    localbksn.jdField_a_of_type_Int = 3;
    a(paramInt);
    return;
    label98:
    a("processLocationPermission", String.format("[Error]Status=%s", new Object[] { localbksn.a() }), null);
    localbksn.jdField_a_of_type_Boolean = paramBoolean;
    localbksn.jdField_a_of_type_JavaUtilArrayList.clear();
    localbksn.jdField_a_of_type_Bksn.jdField_a_of_type_JavaUtilArrayList.clear();
    a(paramInt);
  }
  ...
  private void b(int paramInt, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (localbksn != null)
    {
      ...
      if (localbksn.jdField_a_of_type_Int != 3)
      {
        if (paramBoolean)
        {
          localbksn.jdField_a_of_type_JavaUtilArrayList.addAll(paramArrayList);
    ...
    a("processLocationForTemplate", String.format("[Error]templateIds= %s,Status=%s", new Object[] { paramArrayList.toString(), localbksn.a() }), null);
  }
  
  private boolean b(int paramInt)
  {
    bksn localbksn = (bksn)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if ((localbksn.jdField_a_of_type_Boolean) && (localbksn.a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id))) {}
