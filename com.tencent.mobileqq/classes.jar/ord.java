...
public class ord
  extends osm
{
  public ord(ReadInJoyDynamicChannelFragment paramReadInJoyDynamicChannelFragment) {}
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    {
      ReadInJoyDynamicChannelFragment.a(this.a).a(osg.a().a(Integer.valueOf(ReadInJoyDynamicChannelFragment.b(this.a)), paramList));
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    for (String str = String.format(this.a.getResources().getString(2131718338), new Object[] { Integer.valueOf(paramInt) });; str = this.a.getResources().getString(2131718337))
    {
      ReadInJoyDynamicChannelFragment.c(this.a).a(paramBoolean1, str);
      if ((paramBoolean1) && (paramList != null) && (paramList.size() > 0)) {
        ReadInJoyDynamicChannelFragment.a(this.a).a(osg.a().a(Integer.valueOf(ReadInJoyDynamicChannelFragment.e(this.a)), paramList));
      }
  ...
  public void b(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean1) && (paramList != null) && (paramList.size() > 0)) {
      ReadInJoyDynamicChannelFragment.a(this.a).a(osg.a().a(Integer.valueOf(ReadInJoyDynamicChannelFragment.g(this.a)), paramList));
    }
