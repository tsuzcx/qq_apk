...
public class ord
  extends oqr<Long, BaseArticleInfo>
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ore(this);
  private orb jdField_a_of_type_Orb = new orb();
  private int b;
  public final String b;
  
  public ord(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    ...
    this.jdField_a_of_type_Orb.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, 3);
  }
  ...
  private void a(ArticleInfo paramArticleInfo)
  {
    ...
    if (localpai != null) {
      this.jdField_b_of_type_Int = localpai.a(localArticleInfo.mArticleContentUrl, String.valueOf(localArticleInfo.innerUniqueID), localArticleInfo.mSubscribeID, 1, null);
    }
    b(localArticleInfo);
  }
  ...
  {
    if (this.jdField_a_of_type_Orb.a(paramInt))
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if ((paramInt == oqo.jdField_b_of_type_Int) && (paramViewGroup != null)) {
        ...
        return new orf(this, (View)localObject);
      }
    ...
    for (;;)
    {
      ...
      if (orc.a(paramInt))
      {
        paramViewGroup = orc.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt, a());
        break;
      }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    while (!onk.a(paramView.mArticleContentUrl, paramView.mChannelID, paramView)) {
      return;
    }
    a(paramView);
  }
  ...
  public void a(bfyo parambfyo, int paramInt)
  {
    ...
    {
      if (!this.jdField_a_of_type_Orb.a(i)) {
        break label143;
      }
      if (i != oqo.jdField_b_of_type_Int) {
        break label124;
      }
    ...
    for (;;)
    {
      ...
      QLog.d("ReadInJoyDynamicChannelAdapter", 2, new Object[] { "onBindViewHolder, articleInfo = ", localBaseArticleInfo, ", proteusItemView = ", parambfyo, ", position = ", Integer.valueOf(paramInt), ", type = ", Integer.valueOf(i) });
      return;
      label124:
      this.jdField_a_of_type_Orb.a(parambfyo, i, localBaseArticleInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt);
      continue;
      label143:
      if (orc.a(i)) {
        orc.a(parambfyo, i, localBaseArticleInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt, a());
      } else {
  ...
  public void b()
  {
    pai localpai = ((oso)onk.a().getManager(163)).a().a();
    if (localpai != null) {
      localpai.b(this.jdField_b_of_type_Int);
    }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    if (localBaseArticleInfo != null)
    {
      if (!this.jdField_a_of_type_Orb.a(localBaseArticleInfo)) {
        break label42;
      }
      paramInt = this.jdField_a_of_type_Orb.a(localBaseArticleInfo);
