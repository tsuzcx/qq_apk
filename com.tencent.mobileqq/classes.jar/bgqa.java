  ...
  implements Handler.Callback
{
  ...
  protected Handler a;
  protected View a;
  private ArrayList<bgqa> a;
  protected int b;
  protected String c;
  
  public bgqa(View paramView)
  {
  ...
  public bgqa(String paramString, View paramView)
  {
    this(paramView);
    this.c = paramString;
  }
  ...
  public ViewGroup.LayoutParams a(JSONObject paramJSONObject, bgqa parambgqa)
  {
    ...
    parambgqa.a((ViewGroup.LayoutParams)localObject1, paramJSONObject);
    return localObject1;
  }
  
  public bgqa a(String paramString)
  {
    bgqa localbgqa2 = null;
    bgqa localbgqa1 = localbgqa2;
    if (!TextUtils.isEmpty(this.c))
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null) {
        break label25;
      }
      localbgqa1 = localbgqa2;
    }
    label25:
    do
    {
      ...
      localbgqa2 = (bgqa)localIterator.next();
      if (localbgqa2 == null) {
        break label110;
      }
      localbgqa2 = localbgqa2.a(paramString);
      localbgqa1 = localbgqa2;
    } while (localbgqa2 != null);
    localbgqa1 = localbgqa2;
    label110:
    for (;;)
    {
  ...
  public void a(bgqa parambgqa)
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList.add(parambgqa);
  }
  ...
  public void c()
  {
    ...
    while (localIterator.hasNext())
    {
      bgqa localbgqa = (bgqa)localIterator.next();
      if (localbgqa != null) {
        localbgqa.c();
      }
    }
