  ...
  extends CrashHandler
{
  ...
  private static bbmw jdField_a_of_type_Bbmw;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new arzz(Looper.getMainLooper());
    jdField_a_of_type_Bbmw = new asaa();
  ...
  public static void a(Context paramContext, boolean paramBoolean)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = asab.a(paramContext, "/Tencent/MobileQQ/log/") + "/";
      asab.jdField_a_of_type_JavaLangString = paramContext.getPackageManager().getPackageInfo(paramContext.getPackageName(), 0).versionName;
      asab.jdField_b_of_type_JavaLangString = Build.MODEL;
      asab.c = Build.VERSION.RELEASE;
      return;
    }
  ...
  public static void a(com.tencent.mobileqq.utils.httputils.HttpCommunicator paramHttpCommunicator, Context paramContext, ProgressDialog paramProgressDialog, String paramString1, String paramString2)
  {
    ...
    //   20: return
    //   21: aload_2
    //   22: putstatic 147	arzy:jdField_a_of_type_AndroidAppProgressDialog	Landroid/app/ProgressDialog;
    //   25: new 76	java/lang/StringBuilder
    //   28: dup
    //   29: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   32: aload_1
    //   33: ldc 32
    //   35: invokestatic 82	asab:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   49: putstatic 34	arzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   52: new 149	java/io/File
    //   55: dup
    //   56: new 76	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   63: getstatic 34	arzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   91: ldc 160
    //   93: iconst_1
    //   94: invokestatic 163	arzy:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   97: iconst_1
    //   98: putstatic 165	arzy:jdField_a_of_type_Boolean	Z
    //   101: aload 9
    ...
    //   204: pop
    //   205: getstatic 198	arzy:jdField_b_of_type_ArrayOfByte	[B
    //   208: ifnonnull +178 -> 386
    //   211: ldc 200
    //   213: invokevirtual 24	java/lang/String:getBytes	()[B
    //   216: putstatic 198	arzy:jdField_b_of_type_ArrayOfByte	[B
    //   219: goto +167 -> 386
    ...
    //   256: aload_2
    //   257: getstatic 198	arzy:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   275: aload_1
    //   276: getstatic 26	arzy:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   302: new 247	bbmu
    //   305: dup
    //   306: getstatic 58	arzy:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   309: aload_2
    //   310: invokevirtual 248	KQQ/HttpUploadReq:toByteArray	()[B
    //   313: getstatic 54	arzy:jdField_a_of_type_Bbmw	Lbbmw;
    //   316: invokespecial 251	bbmu:<init>	(Ljava/lang/String;[BLbbmw;)V
    //   319: astore_1
    //   320: aload_1
    //   321: ldc 253
    //   323: invokevirtual 255	bbmu:b	(Ljava/lang/String;)V
    //   326: aload_0
    //   327: aload_1
    //   328: invokevirtual 260	com/tencent/mobileqq/utils/httputils/HttpCommunicator:a	(Lbbmu;)I
    //   331: pop
    //   332: iconst_0
    //   333: putstatic 165	arzy:jdField_a_of_type_Boolean	Z
    //   336: iconst_0
    //   337: ifeq -317 -> 20
  ...
  {
    asab.a(paramString1, paramString2, paramBoolean);
  }
  
  private boolean a(Throwable paramThrowable)
  {
    boolean bool = true;
    if ((paramThrowable == null) || (1 != BaseApplicationImpl.sProcessId) || (System.currentTimeMillis() - axrn.jdField_b_of_type_Long > 600000L)) {}
    Object localObject2;
    do
    {
      return false;
  ...
  public void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    if (a(paramThrowable))
    {
      xop.a(ajya.a(2131713423));
      axrn.jdField_b_of_type_Boolean = true;
      axpu.a(new Throwable(paramThrowable), "notExitOnSafeMode");
    ...
    try
    {
      asab.jdField_a_of_type_JavaLangString = paramThread.getPackageManager().getPackageInfo(paramThread.getPackageName(), 0).versionName;
      asab.jdField_b_of_type_JavaLangString = Build.MODEL;
      asab.c = Build.VERSION.RELEASE;
      label295:
      paramThread.crashed();
