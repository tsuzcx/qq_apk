...
public class ajyq
  extends MqqHandler
{
  public ajyq(ShortVideoPlayActivity paramShortVideoPlayActivity) {}
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          paramMessage = bdcd.a(this.a.jdField_a_of_type_AndroidContentContext, 232, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131720130), this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131720129), 2131720112, 2131719197, new ajyr(this), new ajys(this));
