  ...
  implements GestureDetector.OnGestureListener
{
  ...
  private mmb(VideoLayerUI paramVideoLayerUI) {}
  ...
  public boolean onScroll(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    {
      bdla.b(null, "CliOper", "", "", "0X8009F62", "0X8009F62", 0, 0, "", "", "", "");
  ...
  public boolean onSingleTapUp(MotionEvent paramMotionEvent)
  {
    ...
    if (VideoLayerUI.e(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI))
    {
      ...
      paramMotionEvent = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMeu[0];
      ...
      if (((ArrayList)localObject1).size() > VideoLayerUI.f(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI))
      {
        ...
        bdla.b(null, "CliOper", "", "", "0X800A069", "0X800A069", 0, 0, "", "", "", "");
      ...
      localObject2 = (mmg)((ArrayList)localObject1).get(j + 1);
      boolean bool2;
      if ((localObject2 != null) && (((mmg)localObject2).c()))
      {
        bool1 = true;
        if ((localObject2 == null) || (!str.equalsIgnoreCase(String.valueOf(((mmg)localObject2).jdField_a_of_type_Long))) || (((mmg)localObject2).b() != k)) {
          break label746;
        }
        bool2 = true;
        label367:
        ...
        {
          bool2 = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Mjo.b();
          if ((!bool2) || (!bool1)) {
            break label752;
          }
          bdla.b(null, "CliOper", "", "", "0X8009F63", "0X8009F63", 0, 0, "", "", "", "");
          str = paramMotionEvent.c();
          i = paramMotionEvent.h();
          long l = ((mmg)localObject2).jdField_a_of_type_Long;
          k = ((mmg)localObject2).b();
          ...
          if (!bool1)
          {
            if (!((mmg)localObject2).a()) {
              break label832;
            }
            if (((mmg)localObject2).a() != this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) {
              break label809;
            }
            bool1 = true;
            if (!bool1) {
            ...
            mbf.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1051);
      ...
      for (;;)
      {
        bdla.b(null, "CliOper", "", "", "0X800A068", "0X800A068", 0, 0, "", "", "", "");
        return true;
        bool1 = false;
        break;
        label746:
        ...
        break label661;
        label815:
        mbf.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1052);
        break label680;
        label832:
        mbf.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1053);
    ...
    {
      i = j + 1;
      if ((this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMeu == null) || (i <= 0) || (i >= this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMeu.length)) {
        return true;
      }
      localObject2 = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMeu[0];
      paramMotionEvent = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMeu[i];
      if ((localObject2 == null) || (paramMotionEvent == null)) {
        return true;
      }
      if (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Mjo.b())
      {
        bdla.b(null, "CliOper", "", "", "0X8009F63", "0X8009F63", 0, 0, "", "", "", "");
        localObject1 = ((meu)localObject2).c();
        j = ((meu)localObject2).h();
      ...
      QLog.d(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_JavaLangString, 1, "condition print onSingleTapUp mTargetIndex:=" + this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.r + ",canSwitchView=" + this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Mjo.b());
    }
    for (;;)
    {
      return true;
