  ...
  implements bfoq
{
  ...
  public xnq(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.tencent.map", ajyc.a(2131710446));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.google.android.apps.maps", "Google地图");
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.autonavi.minimap", ajyc.a(2131710444));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.baidu.BaiduMap", ajyc.a(2131710445));
  ...
  public static String a(double paramDouble)
  {
    if (paramDouble < 1000.0D) {
      return String.format(ajyc.a(2131710452), new Object[] { Double.valueOf(paramDouble) });
    }
    return String.format(ajyc.a(2131710451), new Object[] { Double.valueOf(paramDouble / 1000.0D) });
  }
  ...
  {
    axqw.b(null, "dc00899", "Pb_account_lifeservice", "", "rec_locate_android", paramString1, 0, 0, paramString2, paramString3, "", "");
    if (QLog.isColorLevel()) {
  ...
  {
    axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "rec_locate", paramString1, 0, 0, paramString2, "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Xns != null) {
        if (!this.jdField_a_of_type_Xns.b())
        {
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2)
  {
    if (!bbev.g(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      bcpw.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, paramGeoPoint1.getString(2131694609), 1).b(paramGeoPoint1.getDimensionPixelSize(2131298865));
      return;
    }
    ...
    for (;;)
    {
      ...
      new bahn(str, "GET", new xnr(this), 1000, localBundle2, true).execute(new HashMap[] { paramGeoPoint1 });
      return;
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2, String paramString1, String paramString2)
  {
    ...
    {
      bcpw.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 0, ajyc.a(2131710449), 1).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865));
      return;
    }
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = ajyc.a(2131710447);
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = ajyc.a(2131710443);
    }
    ...
    if (d > 1000.0D)
    {
      ...
      if ((this.jdField_a_of_type_Xns == null) || (this.jdField_a_of_type_Xns.b())) {
        break label469;
      }
      this.jdField_a_of_type_Bfol.c(ajyc.a(2131710450));
      label295:
      this.jdField_a_of_type_ArrayOfInt[0] = 0;
      this.jdField_a_of_type_Bfol.c(ajyc.a(2131710448));
      this.jdField_a_of_type_ArrayOfInt[1] = 1;
      this.jdField_a_of_type_Bfol.c((CharSequence)this.jdField_a_of_type_JavaUtilLinkedHashMap.get("com.tencent.map"));
      ...
      this.jdField_a_of_type_Bfol.c(paramString1);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 0;
      break;
      this.jdField_a_of_type_Bfol.c(ajyc.a(2131710442));
      break label295;
  ...
  public void a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Xns != null) {
        this.jdField_a_of_type_Xns.a(paramJSONObject, paramInt);
      }
      return;
      if (paramInt == 1)
      {
