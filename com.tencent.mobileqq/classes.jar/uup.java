...
public class uup
{
  ...
  public static uup a(List<uup> paramList, long paramLong)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramLong == localuup.jdField_a_of_type_Long) {
        return localuup;
      }
    }
    return null;
  ...
  public void a(@NonNull JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem = ((uro)urr.a(5)).a(this.jdField_a_of_type_JavaLangString);
      }
      return;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof uup)) {
        return false;
      }
      paramObject = (uup)paramObject;
