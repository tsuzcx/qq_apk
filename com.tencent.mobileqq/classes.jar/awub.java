...
public class awub
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, awpk paramawpk)
  {
    if (paramawpk == null) {}
    do
    {
      ...
      {
        return 0;
        paramQQAppInterface = awpq.a(paramQQAppInterface).a(paramawpk);
  ...
  public static void a()
  {
    ...
    {
      jdField_a_of_type_Int = bhsi.G(localBaseApplicationImpl);
      c = bhsi.d(localBaseApplicationImpl);
      if (QLog.isColorLevel()) {
    ...
    bhsi.a(localBaseApplicationImpl, false, 0);
  }
  ...
  public static void b()
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Int != 0))
    {
      ...
      if ((localObject instanceof QQAppInterface))
      {
        ...
        bdmc.a(BaseApplication.getContext()).a(localQQAppInterface.getCurrentAccountUin(), "actLocationBgReportSampling", true, jdField_a_of_type_Int, 0L, localHashMap, "");
        if (QLog.isColorLevel()) {
  ...
  public static void d()
  {
    ...
    bdll.b(null, "CliOper", "", "", "0X800A976", "0X800A976", 0, 0, String.valueOf(l), "0", "0", "");
  }
