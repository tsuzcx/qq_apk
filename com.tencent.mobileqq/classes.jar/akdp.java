  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((akdn.a(this.a).getCount() <= 0) || (paramInt <= 0)) {
      return;
    }
    paramAdapterView = (akcy)akdn.a(this.a).getItem(paramInt - 1);
    if ((paramAdapterView != null) && (paramAdapterView.a != null))
    {
      ...
      if (acnh.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType)) {
      ...
      for (;;)
      {
        bdla.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A175", "0X800A175", akdn.a(this.a), 0, "", "", "s_qq_history_tab", "");
        this.a.a(true);
        return;
