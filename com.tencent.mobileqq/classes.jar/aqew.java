...
{
  public aqew(DynamicAvatarRecordActivity paramDynamicAvatarRecordActivity) {}
  ...
  public boolean queueIdle()
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 14) {
        this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(this.a, 230).setMessage(anvx.a(2131703050)).setPositiveButton(this.a.getString(2131693764), new aqex(this));
      }
      try
      {
