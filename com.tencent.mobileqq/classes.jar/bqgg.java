...
public class bqgg
  extends bqgi
  implements bqcg, IEventReceiver
{
  ...
  public bqgg(@NonNull bqgk parambqgk)
  {
    super(parambqgk);
  }
  ...
  private void b(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
      ...
      if (localObject != null)
      {
        ...
        ((bqgu)localObject).b(paramLong, paramBoolean1);
      }
    }
    for (;;)
    {
      ...
      if (localObject != null) {
        ((bqch)localObject).a(paramLong);
      }
      return;
      label340:
      ((bqgu)localObject).a(paramLong, paramBoolean1);
    }
  }
  ...
  public void a()
  {
    ...
    a(bqcg.class, this);
    if ((this.jdField_a_of_type_Bqgk.a.a instanceof EditLocalVideoSource))
    {
      long l = ((EditLocalVideoSource)this.jdField_a_of_type_Bqgk.a.a).a * -1;
  ...
  public void b()
  {
    Object localObject = (bqgu)a(bqgu.class);
    if (localObject != null) {
      ((bqgu)localObject).k();
    }
    localObject = (bqch)a(bqch.class);
    if (localObject != null) {
      ((bqch)localObject).ab_();
    }
  }
  ...
  public boolean n_()
  {
    ...
    bqgu localbqgu = (bqgu)a(bqgu.class);
    if (localbqgu != null) {
      this.jdField_b_of_type_Boolean = localbqgu.a(this.c);
    }
