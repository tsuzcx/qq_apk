...
public class aila
  implements aimh, Handler.Callback, View.OnClickListener
{
  private static final String jdField_a_of_type_JavaLangString = anni.a(2131700079);
  private static final String jdField_b_of_type_JavaLangString = anni.a(2131700080);
  private int jdField_a_of_type_Int;
  private aimj jdField_a_of_type_Aimj;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bjft jdField_a_of_type_Bjft;
  ...
  public aila(BaseActivity paramBaseActivity, aimj paramaimj)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Aimj = paramaimj;
    this.jdField_a_of_type_Bjft = ((bjft)paramBaseActivity.app.getManager(165));
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131558645, null);
    TextView localTextView = (TextView)paramVarArgs.findViewById(2131362488);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramVarArgs.findViewById(2131362487).setOnClickListener(this);
        return paramVarArgs;
      }
  ...
  {
    if ((paramMessage.what == 1) && (this.jdField_a_of_type_Aimj.a() == this)) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009788", "ClickLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bjft.a(this.f), "8.4.1", "");
      continue;
      ...
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
      this.jdField_a_of_type_Aimj.a();
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009789", "CloseLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bjft.a(this.f), "8.4.1", "");
    }
  }
}
