...
public class axtm
{
  ...
  {
    return arec.a().jdField_a_of_type_JavaLangString;
  }
  ...
  {
    Uri.Builder localBuilder = Uri.parse(arec.a().jdField_b_of_type_JavaLangString).buildUpon();
  ...
  public static List<String> a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    String str3 = axsg.a(paramQQAppInterface, paramString1, paramInt, 0L);
    String str1 = axsg.a(paramQQAppInterface, paramString1, paramInt, 1L);
    String str2 = axsg.a(paramQQAppInterface, paramString1, paramInt, 2L);
  ...
  public static List<String> a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, anyw paramanyw, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    String str3 = axsg.a(paramQQAppInterface, paramInt, 0L);
    String str2 = axsg.a(paramQQAppInterface, paramInt, 1L);
    String str1 = axsg.a(paramQQAppInterface, paramInt, 2L);
    paramInt = paramanyw.n;
    int i = paramanyw.o;
    int j = paramanyw.p;
    paramQQAppInterface = paramString1;
    ...
    localArrayList.add(0, paramString1.replace(anzj.a(2131703767), paramString2));
    return localArrayList;
  }
  
  private static void a(QQAppInterface paramQQAppInterface, anyw paramanyw, String paramString1, String paramString2, int paramInt1, int paramInt2, aotc paramaotc, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
      QLog.i("FriendIntimateRelationshipHelper", 2, "insertGrayTips uin:" + paramString1 + " grayTips:" + paramString2 + " intimateType:" + paramInt1);
    }
    if ((TextUtils.isEmpty(paramString2)) || (axsr.a(paramQQAppInterface))) {
      return;
    }
    Object localObject2 = bhlg.m(paramQQAppInterface, paramString1);
    ...
    if (paramInt3 == 2097154)
    {
      ...
      if (paramInt4 == 0)
      {
        localObject3 = arnc.c();
        localObject1 = paramString2;
        if (((arnb)localObject3).jdField_a_of_type_Boolean) {
          localObject1 = paramString2 + ((arnb)localObject3).jdField_a_of_type_JavaLangString;
        }
      }
    }
    localObject2 = a(paramQQAppInterface, (String)localObject1, (String)localObject2, paramanyw, paramInt1);
    Object localObject3 = a(paramQQAppInterface, paramString1, (String)((List)localObject2).get(0), paramInt1);
    paramanyw = (String)((List)localObject3).get(0);
    ((List)localObject3).remove(0);
    ((List)localObject2).remove(0);
    paramString2 = new avpd(paramString1, paramString1, paramanyw, 0, -5040, paramInt3, bcrg.a());
    ...
    ((MessageForUniteGrayTip)localObject1).tipParam.d = (paramString1 + "_intimate_" + String.valueOf(paramaotc.jdField_b_of_type_Long) + "_" + String.valueOf(paramaotc.jdField_b_of_type_Int));
    int i;
    Object localObject4;
    int j;
    if (((List)localObject3).size() > 0)
    {
      ...
      {
        paramaotc = new Bundle();
        localObject4 = (String)((List)localObject3).get(i);
        if (!TextUtils.isEmpty((CharSequence)localObject4))
        {
          paramaotc.putString("image_resource", (String)localObject4);
          j = 0;
          do
          {
            k = paramanyw.indexOf((String)localObject4, j);
            j = ((String)localObject4).length() + k;
            if (k >= 0)
            {
              paramString2.a(k, j, paramaotc);
              if (QLog.isColorLevel()) {
    ...
    {
      Collections.sort((List)localObject2, new axto());
      paramaotc = new ArrayList();
      i = 0;
      m = 0;
      if (m < ((List)localObject2).size())
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          ...
          j = 0;
          i2 = paramanyw.indexOf(str1, j);
          i3 = str1.length();
          i1 = i2 + i3;
          localObject5 = paramaotc.iterator();
          do
          {
          ...
          if (i2 >= 0)
          {
            ...
            if (i2 < j)
            {
              ...
              if (i1 >= 0)
              {
                n = k;
                if (i1 < j) {
                  if (paramanyw.indexOf(str1, i1) >= 0)
                  {
                    j = 1;
                    ...
                    localObject5 = paramanyw.substring(0, i2);
                    localObject6 = paramanyw.substring(i1);
        ...
        if (((String)localObject5).endsWith(str2))
        {
          ...
          for (;;)
          {
            if (i2 < 0)
            {
              ...
              i = j;
              break;
              paramaotc.add(new Pair(Integer.valueOf(i2), Integer.valueOf(i2 + i3)));
              j = i;
              if (i2 >= 0)
              {
                i += 1;
              ...
              {
                paramaotc = arnc.c();
                if (paramaotc.jdField_a_of_type_Boolean)
                {
              ...
              for (;;)
              {
                ((Bundle)localObject2).putString("key_action_DATA", String.format(paramaotc.jdField_b_of_type_JavaLangString, new Object[] { paramString1, Integer.valueOf(paramInt1) }));
                paramInt2 = paramanyw.length() - paramaotc.jdField_a_of_type_JavaLangString.length();
                if (paramInt2 >= 0)
                {
                  paramString2.a(paramInt2, paramanyw.length(), (Bundle)localObject2);
                  bdll.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009CA5", paramInt1, 0, "", "", "", "");
                }
                avpe.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject1);
                return;
                if (paramInt2 == 0)
                {
                  paramInt1 = 25;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FriendIntimateRelationshipHelper", 1, "decodeC2CMsgPkgSubMsgType0xc7 app:" + paramQQAppInterface + "  changeInfo:" + paramRelationalChainChange + "  msginfo:" + paramaotc);
    }
    ...
    do
    {
      ...
      {
        return;
        l1 = paramaotc.jdField_b_of_type_Long;
        l2 = paramaotc.c;
        localaghx = aghx.a(paramRelationalChainChange, paramaotc.jdField_a_of_type_Boolean);
      ...
      paramRelationalChainChange = localanyw.e(localaghx.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 msginfo:" + paramaotc + "changePushInfo:" + localaghx);
      }
    ...
    if (localExtensionInfo == null)
    {
      ...
      localExtensionInfo.uin = localaghx.jdField_b_of_type_JavaLangString;
    }
    for (;;)
    {
      Object localObject4 = (avgv)paramQQAppInterface.a(153);
      ...
      case 1: 
        do
        {
          ...
          QLog.i("FriendIntimateRelationshipHelper", 1, "decodeC2CMsgPkgSubMsgType0xc7 changeType:" + localaghx.jdField_a_of_type_Int + " grayTips:" + paramRelationalChainChange + " uin:" + localExtensionInfo.uin + " isOpen:" + a(localaghx.jdField_a_of_type_JavaLangString) + " intimate_type:" + localExtensionInfo.intimate_type + " intimate_level:" + localExtensionInfo.intimate_level + " intimate_chatDays:" + localExtensionInfo.intimate_chatDays + " isExtinguish:" + localExtensionInfo.isExtinguish + " last_intimate_chatTime:" + localExtensionInfo.last_intimate_chatTime);
          return;
          paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
        } while (localaghx.jdField_b_of_type_Agia == null);
        if ((localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 1) || (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 2) || (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 3))
        {
          localExtensionInfo.intimate_type = localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int;
          localExtensionInfo.intimate_chatDays = 0;
          localExtensionInfo.intimate_level = localaghx.jdField_b_of_type_Agia.a();
          localExtensionInfo.isExtinguish = false;
          if ((localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic != null) && (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic.c > 0L)) {
            localExtensionInfo.last_intimate_chatTime = localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic.c;
          }
          localObject1 = axtp.a(paramQQAppInterface.getApp(), 162);
          localanyw.a(localExtensionInfo);
          if (a(localaghx.jdField_a_of_type_JavaLangString))
          {
            i = axsl.a(localaghx);
            a(paramQQAppInterface, localanyw, localaghx.jdField_b_of_type_JavaLangString, (String)localObject1, localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int, localaghx.jdField_b_of_type_Agia.a(), paramaotc, 2097153, i);
            ((avgv)localObject4).notifyUI(2, true, new Object[] { localaghx.jdField_b_of_type_JavaLangString });
          }
          paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
          if (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 1)
          {
            paramQQAppInterface = (aobj)paramQQAppInterface.a(172);
            paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
            if (paramQQAppInterface != null) {
      ...
      for (paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;; paramRelationalChainChange = null)
      {
        if (QLog.isColorLevel())
        {
          QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Add friendUin:" + localaghx.jdField_b_of_type_JavaLangString + " changePushInfo.now:" + localaghx.jdField_b_of_type_Agia);
          break label327;
          int k = 0;
          int j = 0;
          if (localaghx.jdField_a_of_type_Agia != null)
          {
            k = localaghx.jdField_a_of_type_Agia.jdField_a_of_type_Int;
            j = localaghx.jdField_a_of_type_Agia.a();
          }
          int m = j;
          i = k;
          if (k == 0)
          {
            m = j;
            i = k;
            if (localaghx.jdField_b_of_type_Agia != null)
            {
              i = localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int;
              m = localaghx.jdField_b_of_type_Agia.a();
            }
          }
          if (i == 0)
          {
          ...
          for (;;)
          {
            if ((j == 1) || (j == 2) || (j == 3))
            {
              ...
              if (k == 1)
              {
                i = 164;
                label939:
                localObject1 = axtp.a(paramQQAppInterface.getApp(), i);
                localanyw.a(localExtensionInfo);
                if (a(localaghx.jdField_a_of_type_JavaLangString))
                {
                  a(paramQQAppInterface, localanyw, localaghx.jdField_b_of_type_JavaLangString, (String)localObject1, j, 0, paramaotc, 2097154, 1);
                  ((avgv)localObject4).notifyUI(1, true, new Object[] { localaghx.jdField_b_of_type_JavaLangString, Boolean.valueOf(true) });
                  ((avgx)paramQQAppInterface.getManager(323)).a(localaghx.jdField_b_of_type_JavaLangString);
                }
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                if (j == 1)
                {
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Del intimate_type:" + j + " intimate_level:" + k + " friendUin:" + localaghx.jdField_b_of_type_JavaLangString);
              }
              break label327;
              if (k != 2) {
                break label939;
              ...
              k = localaghx.jdField_b_of_type_Agia.a();
              m = localaghx.jdField_a_of_type_Agia.a();
              if ((localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int != 1) && (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int != 2))
              {
                localObject1 = localObject2;
                if (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int != 3) {}
              }
              else
              {
                localObject1 = localObject2;
              ...
              for (;;)
              {
                ...
                localanyw.a(localExtensionInfo);
                i = axsl.a(localaghx);
                a(paramQQAppInterface, localanyw, localaghx.jdField_b_of_type_JavaLangString, (String)localObject1, localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int, k, paramaotc, 2097153, i);
                ((avgv)localObject4).notifyUI(3, true, new Object[] { localaghx.jdField_b_of_type_JavaLangString, Integer.valueOf(localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int), Integer.valueOf(m), Integer.valueOf(k) });
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                if (!QLog.isColorLevel()) {
                  break;
                }
                QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Upgrade intimate_type:" + localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int + " intimate_level:" + k + " old_intimate_level:" + m);
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                break;
                label1514:
                if (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 2)
                {
                  i = 158;
                }
                else
                {
                  ...
                  if (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 3)
                  {
                    ...
                    if (k == 2) {
                      ...
                      else if (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 2)
                      {
                        i = 159;
                      }
                      else
              ...
              for (;;)
              {
                ...
                localExtensionInfo.intimate_level = k;
                localanyw.a(localExtensionInfo);
                a(paramQQAppInterface, localanyw, localaghx.jdField_b_of_type_JavaLangString, (String)localObject1, localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int, k, paramaotc, 2097154, 0);
                ((avgv)localObject4).notifyUI(3, true, new Object[] { localaghx.jdField_b_of_type_JavaLangString, Integer.valueOf(localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int), Integer.valueOf(m), Integer.valueOf(k) });
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                if (!QLog.isColorLevel()) {
                  break;
                }
                QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Downgrade intimate_type:" + localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int + " intimate_level:" + k + " old_intimate_level:" + m);
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                break;
                label1991:
                if (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int == 2)
              ...
              if ((localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int != 0) && (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic != null)) {
                if ((!TextUtils.isEmpty(localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic.jdField_a_of_type_JavaLangString)) && (!axsr.a(paramQQAppInterface)))
                {
                  localObject2 = axtp.a(paramQQAppInterface, localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic.jdField_a_of_type_JavaLangString, bhlg.m(paramQQAppInterface, localaghx.jdField_b_of_type_JavaLangString), localanyw);
                  localObject3 = axtp.a(paramQQAppInterface, (String)((List)localObject2).get(0), localaghx.jdField_b_of_type_JavaLangString);
                  paramRelationalChainChange = (String)((List)localObject3).get(0);
                  ((List)localObject2).remove(0);
                  ((List)localObject3).remove(0);
                  paramaotc = new avpd(localaghx.jdField_b_of_type_JavaLangString, localaghx.jdField_b_of_type_JavaLangString, paramRelationalChainChange, 0, -5020, 2097153, bcrg.a());
                  if ((localObject3 != null) && (((List)localObject3).size() > 0))
                  {
                    ...
                    while (i < ((List)localObject3).size())
                    {
                      ...
                      if (!TextUtils.isEmpty(str))
                      {
                        ...
                        if (j >= 0) {
                          paramaotc.a(j, str.length() + j, localBundle);
                        }
                        if (QLog.isColorLevel()) {
                  ...
                  {
                    Collections.sort((List)localObject2, new axtn());
              ...
              for (;;)
              {
                ...
                for (k = 1;; k = 0)
                {
                  ...
                  ((MessageForUniteGrayTip)localObject2).initGrayTipMsg(paramQQAppInterface, paramaotc);
                  paramaotc = new StringBuilder(21);
                  paramaotc.append(l1).append("_").append(l2);
                  ((MessageForUniteGrayTip)localObject2).tipParam.d = paramaotc.toString();
                  paramaotc = paramQQAppInterface.a().b(localaghx.jdField_b_of_type_JavaLangString, 0);
                  if ((paramaotc != null) && (!paramaotc.isEmpty()))
                  {
                    paramaotc = (MessageRecord)paramaotc.get(paramaotc.size() - 1);
                    if (((paramaotc instanceof MessageForUniteGrayTip)) && (((MessageForUniteGrayTip)paramaotc).tipParam != null) && (((MessageForUniteGrayTip)paramaotc).subType == ((MessageForUniteGrayTip)localObject2).subType) && (((MessageForUniteGrayTip)paramaotc).tipParam.c.equals(((MessageForUniteGrayTip)localObject2).tipParam.c)) && (((MessageForUniteGrayTip)localObject2).tipParam.jdField_a_of_type_Long - ((MessageForUniteGrayTip)paramaotc).tipParam.jdField_a_of_type_Long <= 1L))
                    {
                      if (!QLog.isColorLevel()) {
                        break;
                      }
                  ...
                  if (!TextUtils.isEmpty(paramRelationalChainChange)) {
                    avpe.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject2);
                  }
                  localExtensionInfo.intimate_level = localaghx.jdField_b_of_type_Agia.a();
                  if (localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic.c > 0L) {
                    localExtensionInfo.last_intimate_chatTime = localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Agic.c;
                  }
                  localanyw.a(localExtensionInfo);
                  paramRelationalChainChange = new ArrayList();
                  paramRelationalChainChange.add(localaghx.jdField_b_of_type_JavaLangString);
                  paramQQAppInterface.a(1).notifyUI(107, true, paramRelationalChainChange);
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!QLog.isColorLevel()) {
                    break label327;
                  }
                  QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Egalitarian_Soon intimate_type:" + localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int + " intimate_level:" + localaghx.jdField_b_of_type_Agia.a());
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  break label327;
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!a()) {
                  ...
                  else
                  {
                    localExtensionInfo.isExtinguish = false;
                    localanyw.a(localExtensionInfo);
                    localObject1 = axtp.a(paramQQAppInterface.getApp(), 167);
                    a(paramQQAppInterface, localanyw, localaghx.jdField_b_of_type_JavaLangString, (String)localObject1, localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int, localaghx.jdField_b_of_type_Agia.a(), paramaotc, 2097153, 0);
                    ((avgv)localObject4).notifyUI(3, true, new Object[] { localaghx.jdField_b_of_type_JavaLangString, Integer.valueOf(localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int), Integer.valueOf(localaghx.jdField_b_of_type_Agia.a()), Integer.valueOf(localaghx.jdField_b_of_type_Agia.a()) });
                    ((FriendListHandler)paramQQAppInterface.a(1)).notifyUI(3, true, localaghx.jdField_b_of_type_JavaLangString);
                  }
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!QLog.isColorLevel()) {
                    break label327;
                  }
                  QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Icon_Light intimate_type:" + localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int + " intimate_level:" + localaghx.jdField_b_of_type_Agia.a());
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  break label327;
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!a()) {
                  ...
                  else
                  {
                    ...
                    localanyw.a(localExtensionInfo);
                    localObject1 = axtp.a(paramQQAppInterface.getApp(), 166);
                    a(paramQQAppInterface, localanyw, localaghx.jdField_b_of_type_JavaLangString, (String)localObject1, localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int, localaghx.jdField_b_of_type_Agia.a(), paramaotc, 2097154, 0);
                    ((avgv)localObject4).notifyUI(3, true, new Object[] { localaghx.jdField_b_of_type_JavaLangString, Integer.valueOf(localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int), Integer.valueOf(localaghx.jdField_b_of_type_Agia.a()), Integer.valueOf(localaghx.jdField_b_of_type_Agia.a()) });
                    ((FriendListHandler)paramQQAppInterface.a(1)).notifyUI(3, true, localaghx.jdField_b_of_type_JavaLangString);
                  }
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  ...
                  QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Icon_Extinguish intimate_type:" + localaghx.jdField_b_of_type_Agia.jdField_a_of_type_Int + " intimate_level:" + localaghx.jdField_b_of_type_Agia.a());
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  break label327;
                }
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, intimate_relation.IntimateInfo paramIntimateInfo)
  {
    ...
    ExtensionInfo localExtensionInfo2 = localanyw.a(Long.toString(l));
  ...
  public static boolean a()
  {
    ...
    b = arec.a().jdField_a_of_type_Boolean;
    if (QLog.isColorLevel()) {
