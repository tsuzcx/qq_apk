  ...
  implements agrk
{
  ...
  protected agrm(AlbumListFragment paramAlbumListFragment)
  {
    super(paramAlbumListFragment);
    this.jdField_a_of_type_Agrk = this;
    this.a = new agre();
    this.jdField_a_of_type_Agre = ((agre)this.a);
  }
  
  public static agrj a(AlbumListFragment paramAlbumListFragment)
  {
    if ((jdField_a_of_type_Agrj == null) || (jdField_a_of_type_Agrj.jdField_a_of_type_MqqUtilWeakReference.get() != paramAlbumListFragment)) {}
    try
    {
      if ((jdField_a_of_type_Agrj == null) || (jdField_a_of_type_Agrj.jdField_a_of_type_MqqUtilWeakReference.get() != paramAlbumListFragment)) {
        jdField_a_of_type_Agrj = new agrm(paramAlbumListFragment);
      }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = paramViewGroup.jdField_a_of_type_AndroidContentResResources.getDrawable(2130846744);
  ...
  {
    return super.a(paramContext, paramInt1, paramInt2, paramaglx, paramInt3, paramBoolean, paramArrayList);
  }
  ...
  {
    super.a(paramIntent);
    this.jdField_a_of_type_Agre.a = new agrn(this);
    this.jdField_a_of_type_Agre.c = paramIntent.getBooleanExtra("PhotoConst.IS_FINISH_RESTART_INIT_ACTIVITY", false);
    this.jdField_a_of_type_Agsb.c = paramIntent.getBooleanExtra("PhotoConst.IS_SHOW_QZONE_ALBUM", false);
    String str2 = paramIntent.getStringExtra("peak.myUin");
    String str1 = str2;
    if (str2 == null) {
      str1 = bizu.a().getCurrentAccountUin();
    }
    if (str1 != null) {
      this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaLangString = str1;
    }
    if (this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaLangString == null) {
      throw new RuntimeException("must set MY_UIN");
    }
    ((AlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).a.a(this.jdField_a_of_type_Agsb.c);
    ((AlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).a.a(this.jdField_a_of_type_Agsb.jdField_a_of_type_Long);
    this.jdField_a_of_type_Agsb.jdField_b_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.DISABLE_UPLOAD_TO_TROOP_ALBUM", this.jdField_a_of_type_Agsb.jdField_b_of_type_Boolean);
    if (this.jdField_a_of_type_Agsb.c)
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(this.jdField_a_of_type_Agre.a);
  ...
  protected void a(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    if (paramQQAlbumInfo._id.equals("qzone_album"))
    {
      ...
      bgxy.a(((AlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramIntent, paramQQAlbumInfo, 100016);
    }
    do
    {
      return;
