  ...
  extends BaseAdapter
{
  ...
  public agrm(AlbumListFragment paramAlbumListFragment)
  {
  ...
  public QQAlbumInfo a(Context paramContext)
  {
    ...
    //   18: aload 4
    //   20: getstatic 226	bbbw:n	Ljava/lang/String;
    ...
    //   40: aload_2
    //   41: getstatic 140	agrm:jdField_c_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   44: ldc 246
    //   46: aconst_null
    //   47: ldc 248
    ...
    //   54: astore_1
    //   55: iconst_2
    //   56: invokestatic 259	aglv:a	(I)Laglv;
    //   59: astore 5
    //   61: aload 5
    //   63: ifnull +14 -> 77
    //   66: aload_2
    ...
    //   70: iconst_m1
    //   71: aload 5
    //   73: invokevirtual 262	agrm:a	(Landroid/database/Cursor;ILaglv;)Ljava/util/List;
    //   76: astore_3
    //   77: aload_2
    //   78: astore_1
    //   79: invokestatic 268	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   82: invokestatic 273	agmg:a	(Landroid/content/Context;)Lagmg;
    //   85: iconst_0
    //   86: iconst_m1
    //   87: invokevirtual 276	agmg:a	(ZI)Ljava/util/ArrayList;
    //   90: astore 5
    //   92: aload_3
    //   93: ifnull +50 -> 143
    //   96: aload_2
    ...
    //   237: aload_3
    //   238: getfield 302	agml:jdField_a_of_type_Int	I
    //   241: i2l
    ...
    //   252: aload_3
    //   253: getfield 306	agml:jdField_c_of_type_Long	J
    ...
    //   266: aload_3
    //   267: getfield 311	agml:jdField_a_of_type_Long	J
    ...
    //   280: aload_3
    //   281: getfield 316	agml:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   308: aload_3
    //   309: getfield 321	agml:d	Ljava/lang/String;
  ...
  QQAlbumInfo a(Context paramContext, int paramInt1, int paramInt2, aglv paramaglv)
  {
    ...
    //   38: aload 8
    //   40: getstatic 359	bbbw:l	Ljava/lang/String;
    ...
    //   82: aload 5
    //   84: getstatic 140	agrm:jdField_c_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   87: ldc 246
    //   89: aconst_null
    //   90: ldc 248
    ...
    //   106: iload_3
    //   107: aload 4
    //   109: invokevirtual 262	agrm:a	(Landroid/database/Cursor;ILaglv;)Ljava/util/List;
    //   112: astore 6
    //   114: aload 6
    //   116: ifnull +59 -> 175
    //   119: aload_1
  ...
  QQAlbumInfo a(Context paramContext, int paramInt1, int paramInt2, aglv paramaglv, int paramInt3, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    paramArrayList = ((AlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).a.a.a(paramContext, paramInt1, paramInt2, paramaglv, paramInt3, paramBoolean, paramArrayList);
  ...
  public List<QQAlbumInfo> a(Context paramContext, int paramInt)
  {
    ...
    //   13: aload 12
    //   15: getstatic 52	agrm:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   18: aload_0
    //   19: getfield 162	agrm:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   28: getfield 388	com/tencent/mobileqq/activity/photo/album/AlbumListFragment:a	Lagrh;
    //   31: getfield 393	agrh:a	Lagri;
  ...
  public List<QQAlbumInfo> a(Context paramContext, int paramInt, aglv paramaglv)
  {
    ...
    //   12: aload_3
    //   13: getstatic 142	agrm:d	[Ljava/lang/String;
    //   16: ldc_w 464
    //   19: aconst_null
    //   20: ldc_w 413
