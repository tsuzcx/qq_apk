  ...
  extends alwx
{
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    {
      alul.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSendMessageHandler.a(paramString1), paramString2, true);
      if ((paramInt2 == 112) || (paramInt2 == 113))
      {
        aluv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, 6);
        aluv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
    }
    this.a.e(196608);
  }
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      if (this.a.jdField_a_of_type_Bbqg != null)
      {
        ...
        if (i != -1)
        {
          ...
          long l = localauga.b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
          if (((MessageRecord)localObject).uniseq == l) {
            localauga.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, i);
          }
          this.a.jdField_a_of_type_Bbqg.a(((MessageRecord)localObject).uniseq);
          if (QLog.isColorLevel())
          {
