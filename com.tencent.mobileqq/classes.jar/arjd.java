  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      if (paramString.has("local_day_last_time"))
      {
        ...
        long l = bcrg.a();
        if (!auea.a(this.jdField_a_of_type_Long * 1000L, l * 1000L, TimeZone.getDefault()))
        {
