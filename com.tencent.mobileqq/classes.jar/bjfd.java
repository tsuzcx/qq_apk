...
public class bjfd
{
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, bjff parambjff)
  {
    ...
    bjfe localbjfe2 = b();
    if (QLog.isColorLevel()) {
      QLog.d("QZoneVideoCommonUtils", 2, "support record=" + localbjfe1.a() + ", support trim=" + localbjfe2.a());
    }
    if ((!localbjfe1.a()) && (!localbjfe2.a()))
    {
      if (localbjfe1.b()) {}
      for (paramString = localbjfe1.a();; paramString = null)
      {
        String str;
        if (paramString != null)
        {
        ...
        {
          str = paramActivity.getString(2131718650);
        }
        if (parambjff != null) {
          parambjff.onFail(paramActivity, str);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbjfe1.a() + ",trimSupport tips=" + localbjfe2.a() + ",show tips=" + str);
        return;
      }
    }
    a(paramLong, paramActivity, localbjfe1.a(), localbjfe2.a(), paramString);
    PerfTracer.traceEnd("Video_component_pre_launch");
  }
  
  public static void a(long paramLong, Activity paramActivity, String paramString, bjff parambjff, Bundle paramBundle)
  {
    PerfTracer.traceStart("Video_component_pre_launch");
    if (paramActivity == null)
    {
    ...
    if ((!localbjfe1.a()) && (!localbjfe2.a()))
    {
      ...
      for (paramString = localbjfe1.a();; paramString = null)
      {
        ...
        {
          paramBundle = paramActivity.getString(2131718650);
        }
        if (parambjff != null) {
          parambjff.onFail(paramActivity, paramBundle);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbjfe1.a() + ",trimSupport tips=" + localbjfe2.a() + ",show tips=" + paramBundle);
        return;
      }
    }
