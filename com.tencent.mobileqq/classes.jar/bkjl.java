  ...
  implements IEventReceiver
{
  ...
  private void a(View paramView)
  {
    ...
    paramView = new SpannableString(ajya.a(2131710803));
    ...
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.addTextChangedListener(new bkjn(this));
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnEditorActionListener(new bkjm(this));
  }
