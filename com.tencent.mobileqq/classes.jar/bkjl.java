  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  private bkjm jdField_a_of_type_Bkjm;
  ...
  public bkjl(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Bkjm = new bkjm();
    this.jdField_a_of_type_Bkjm.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Bkjm.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bkjm.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bkjm = null;
  ...
  {
    this.jdField_a_of_type_Bkjm.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bkjm.a("before updateTexImage");
