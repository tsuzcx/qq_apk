  ...
  extends bkey
{
  protected double a;
  public int a;
  bkeu jdField_a_of_type_Bkeu;
  bkfs jdField_a_of_type_Bkfs = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (paramVideoMaterial != null)
    {
      ...
      if (localDoodleItem != null) {
        localObject1 = new bkfr(localDoodleItem, paramVideoMaterial.getDataPath());
      }
    }
    return localObject1;
  }
  ...
  {
    return new bkfq(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bkfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Bkfs.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt1, int paramInt2, bkfs parambkfs)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap == null) || (this.jdField_a_of_type_JavaUtilHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(parambkfs.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    parambkfs.jdField_a_of_type_Boolean = true;
  }
  
  public void a(bkfs parambkfs)
  {
    if ((parambkfs.jdField_d_of_type_Boolean) && (parambkfs.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!parambkfs.jdField_a_of_type_Boolean) && (parambkfs.jdField_b_of_type_Boolean))
      {
        if (parambkfs.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, parambkfs);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (parambkfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, parambkfs);
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, bkfs parambkfs)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap == null) || (this.jdField_a_of_type_JavaUtilHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = parambkfs.jdField_d_of_type_Boolean;
    localArrayList.addAll(parambkfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilHashMap.get(parambkfs.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof bkfr))
    {
      localObject = (bkfr)localObject;
      ((bkfr)localObject).a(localArrayList);
      ((bkfr)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((bkfr)localObject).a(parambkfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((bkfr)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        parambkfs.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!parambkfs.jdField_d_of_type_Boolean) || (!parambkfs.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = parambkfs.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof bkfp))
      {
        localObject = (bkfp)localObject;
        ((bkfp)localObject).a();
        ((bkfp)localObject).a(localArrayList, bool, parambkfs);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((bkfp)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((bkfp)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          parambkfs.b();
        }
      }
      else if ((localObject instanceof bkfq))
      {
        localObject = (bkfq)localObject;
        ((bkfq)localObject).a(localArrayList);
        bkfu.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((bkfq)localObject).a();
        bkfu.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((bkfq)localObject).a(parambkfs.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          bkfu.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          parambkfs.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Bkeu != null) {
        this.jdField_a_of_type_Bkeu.a(paramVideoMaterial);
      }
      return;
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Bkfs == null) || (!this.jdField_a_of_type_Bkfs.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    bcql.a(QQStoryContext.a().getApp(), ajya.a(2131707963), 0).a();
    return true;
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    int i;
    if (paramMotionEvent.getAction() == 2) {
      if (this.jdField_a_of_type_Bkfs != null)
      {
        a(f1, f2, false);
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        if ((this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId())))
        {
          ...
          if (this.jdField_a_of_type_Bkeu != null) {}
          for (i = this.jdField_a_of_type_Bkeu.a();; i = 0)
          {
            this.jdField_a_of_type_Bkfs = new bkfs(102, paramMotionEvent, i);
            this.jdField_f_of_type_Int += 1;
            this.jdField_a_of_type_Bkfs.jdField_c_of_type_Boolean = true;
            if (this.jdField_a_of_type_Bkeu != null) {
              this.jdField_a_of_type_Bkeu.a(this.jdField_a_of_type_Bkfs);
            }
            a(f1, f2, false);
      ...
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Bkfs != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bkeu != null)
      {
        this.jdField_a_of_type_Bkeu.a(localBitmap);
        return;
      }
    }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 86	bkft:jdField_f_of_type_Boolean	Z
    //   4: ifeq +29 -> 33
    //   7: aload_0
    //   8: aload_0
    //   9: getfield 70	bkft:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   12: invokevirtual 318	com/tencent/aekit/openrender/internal/Frame:getFBO	()I
    //   15: aload_0
    //   16: getfield 70	bkft:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   19: invokevirtual 143	com/tencent/aekit/openrender/internal/Frame:getTextureId	()I
    //   22: aload_0
    //   23: getfield 88	bkft:jdField_a_of_type_Int	I
    //   26: aload_0
    //   27: getfield 203	bkft:jdField_b_of_type_Int	I
    //   30: invokevirtual 359	bkft:a	(IIII)V
    //   33: aload_0
    //   34: getfield 66	bkft:jdField_b_of_type_ComTencentFilterBaseFilter	Lcom/tencent/filter/BaseFilter;
    //   37: aload_0
    //   38: getfield 70	bkft:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   41: invokevirtual 143	com/tencent/aekit/openrender/internal/Frame:getTextureId	()I
    //   44: aload_0
    //   45: getfield 29	bkft:jdField_c_of_type_Int	I
    //   48: aload_0
    //   49: getfield 31	bkft:jdField_d_of_type_Int	I
    //   52: iconst_0
    //   53: aload_0
    //   54: getfield 35	bkft:jdField_a_of_type_Double	D
    //   57: aload_0
    //   58: getfield 68	bkft:jdField_c_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   61: invokevirtual 314	com/tencent/filter/BaseFilter:RenderProcess	(IIIIDLcom/tencent/aekit/openrender/internal/Frame;)V
    //   64: aload_0
    //   65: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   68: ifnull +23 -> 91
    //   71: aload_0
    //   72: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   75: instanceof 539
    //   78: ifeq +13 -> 91
    //   81: aload_0
    //   82: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   85: checkcast 539	bkew
    //   88: invokevirtual 541	bkew:f	()V
    //   91: aload_0
    //   92: getfield 219	bkft:jdField_g_of_type_Boolean	Z
    //   95: ifeq +285 -> 380
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 219	bkft:jdField_g_of_type_Boolean	Z
    //   103: aconst_null
    //   104: astore 8
    //   106: aconst_null
    //   107: astore 7
    ...
    //   130: astore 6
    //   132: aload_0
    //   133: getfield 29	bkft:jdField_c_of_type_Int	I
    //   136: aload_0
    //   137: getfield 31	bkft:jdField_d_of_type_Int	I
    //   140: imul
    ...
    //   151: iconst_0
    //   152: aload_0
    //   153: getfield 29	bkft:jdField_c_of_type_Int	I
    //   156: aload_0
    //   157: getfield 31	bkft:jdField_d_of_type_Int	I
    //   160: sipush 6408
    //   163: sipush 5121
    //   166: aload 9
    ...
    //   184: astore 6
    //   186: aload_0
    //   187: getfield 29	bkft:jdField_c_of_type_Int	I
    //   190: aload_0
    //   191: getfield 31	bkft:jdField_d_of_type_Int	I
    ...
    //   223: astore 6
    //   225: aload_0
    //   226: getfield 90	bkft:jdField_g_of_type_Int	I
    //   229: i2f
    //   230: fconst_1
    //   231: fmul
    //   232: aload_0
    //   233: getfield 29	bkft:jdField_c_of_type_Int	I
    //   236: i2f
    //   237: fdiv
    //   238: fstore_1
    //   239: aload 8
    ...
    //   317: aload_0
    //   318: iconst_0
    //   319: putfield 460	bkft:jdField_d_of_type_Boolean	Z
    //   322: aload_0
    //   323: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   326: ifnull +14 -> 340
    //   329: aload_0
    //   330: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   333: aload 6
    ...
    //   413: aload_0
    //   414: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   417: ifnull -77 -> 340
    //   420: aload_0
    //   421: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   424: aload 6
    ...
    //   478: aload_0
    //   479: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   482: ifnull -142 -> 340
    //   485: aload_0
    //   486: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   489: aload 7
    ...
    //   507: astore 6
    //   509: aload_0
    //   510: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   513: ifnull +14 -> 527
    //   516: aload_0
    //   517: getfield 92	bkft:jdField_a_of_type_Bkeu	Lbkeu;
    //   520: aload 7
