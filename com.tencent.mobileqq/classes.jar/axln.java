  ...
  implements BadcaseReportUtils.ReportItemData
{
  ...
  {
    if (paramBoolean) {}
    for (BadcaseReportUtils.ENABLE_REPORT = azfz.h();; BadcaseReportUtils.ENABLE_REPORT = false)
    {
      BadcaseReportUtils.sTotalReportNumber = azfz.c();
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject = new StringBuilder(ajni.a);
