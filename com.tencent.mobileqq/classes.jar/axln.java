...
{
  public BroadcastReceiver a = new axlo(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("ptv".equals(paramString2))
    {
      ...
      for (;;)
      {
        ...
        localbiic.f = str21;
        localbiic.g = str22;
        localbiic.h = ((String)localObject2);
        if (!TextUtils.isEmpty(str9))
        {
          axll.a(this.mRuntime.a(), this.mRuntime.a(), str4, str5, str6, str7, str10, str11, str12, str13, str14, str15, str16, str17, str18, str8, str19, paramString3, str9, paramString1, paramJsBridgeListener, paramString2, (String)localObject1, localbiic);
          continue;
          continue;
            ...
            if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
              for (;;)
              {
                try
                {
                  ...
                  bool1 = axll.c(this.mRuntime.a());
                  boolean bool2 = axjg.c();
                  boolean bool3 = VideoEnvironment.e(this.mRuntime.a());
                  boolean bool4 = axle.a(BaseApplicationImpl.getContext());
          ...
          else if ("onClickShareBattle".equals(paramString3))
          {
            try
            {
              ...
              vkc.a().a(paramString1, Integer.valueOf(i).toString());
            }
            catch (JSONException paramJsBridgeListener) {}
            if (QLog.isColorLevel())
            {
          ...
          else if (("startStoryActivity".equals(paramString3)) && (paramVarArgs != null))
          {
            try
            {
              ...
              axll.a(this.mRuntime.a(), this.mRuntime.a(), i);
            }
