...
public class ayxd
{
  ...
  private String jdField_a_of_type_JavaLangString = bhlo.c();
  private Callback jdField_a_of_type_Okhttp3Callback = new ayxe(this);
  private String b = String.valueOf(bhlo.a(this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication));
  private String c = a();
  private String d;
  private String e;
  ...
  static
  {
    jdField_a_of_type_Ayxd = new ayxd();
  }
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        if (!"bid".equals(str2))
        {
          ...
          if (!bhsr.a(paramBundle.getString(str2))) {
            break label111;
          }
        }
        label111:
  ...
  private void b(Bundle paramBundle)
  {
    ...
    aywg.a().newCall(paramBundle).enqueue(this.jdField_a_of_type_Okhttp3Callback);
  }
  ...
  public Bundle a()
  {
    ...
    localBundle.putString("uin", String.valueOf(aywr.a()));
