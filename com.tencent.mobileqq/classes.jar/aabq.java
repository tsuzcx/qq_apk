...
public class aabq
{
  public static aabl a(@NonNull Activity paramActivity, int paramInt, String paramString)
  {
    return a(paramActivity, paramInt, paramString, null);
  }
  
  public static aabl a(@NonNull Activity paramActivity, int paramInt, String paramString, Bundle paramBundle)
  {
    String str = null;
    aabs localaabs = null;
    ...
    Object localObject = localaabs;
    switch (paramInt)
    {
    default: 
      localObject = localaabs;
    case 2: 
    case 0: 
    case 1: 
    case 3: 
    ...
    case 5: 
      while (localObject == null)
      {
        ...
        localObject = new aadl(paramActivity, paramInt, paramString, paramBundle);
        continue;
        localaabs = new aabs(paramActivity, paramInt, paramString);
        if (paramBundle == null) {
          break label305;
        }
    ...
    for (;;)
    {
      ((aabs)localaabs).a((String)localObject, paramBundle, paramActivity);
      localObject = localaabs;
      break;
      localObject = new aaci(paramActivity, paramInt, paramString);
      break;
      ((aabl)localObject).a();
      return localObject;
      label305:
