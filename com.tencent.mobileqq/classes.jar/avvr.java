...
public class avvr
{
  ...
  public avvr(Settings paramSettings)
  {
  ...
  {
    return avvw.a(paramFloat1, this.jdField_a_of_type_Float / paramFloat2, this.b * paramFloat2);
  }
  
  public avvr a(avvt paramavvt)
  {
    ...
    if (!avvt.a(f9, 0.0F))
    {
      ...
      label202:
      switch (avvs.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
