  ...
  implements BadcaseReportUtils.ReportItemData
{
  ...
  {
    if (paramBoolean) {}
    for (BadcaseReportUtils.ENABLE_REPORT = azki.h();; BadcaseReportUtils.ENABLE_REPORT = false)
    {
      BadcaseReportUtils.sTotalReportNumber = azki.c();
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject = new StringBuilder(ajrx.a);
