...
public class bcgu
{
  ...
  public bcgu(Activity paramActivity, CustomWebView paramCustomWebView, ViewGroup paramViewGroup)
  {
  ...
  void a()
  {
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364675));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364685));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364683));
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131363369);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bbky localbbky = new bbky(Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), new bcgw(this, paramInt2));
    localbbky.setDuration(paramInt3);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidViewView.startAnimation(localbbky);
  }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131562614, paramViewGroup, true);
  }
