  ...
  implements IArConfigManager
{
  ...
  /* Error */
  public com.tencent.mobileqq.ar.aidl.ARCommonConfigInfo a()
  {
    // Byte code:
    ...
    //   14: aload_0
    //   15: getfield 15	zzw:a	Landroid/os/IBinder;
    //   18: iconst_5
    //   19: aload_2
    //   20: aload_3
    //   21: iconst_0
    ...
    //   36: ifeq +26 -> 62
    //   39: getstatic 48	com/tencent/mobileqq/ar/aidl/ARCommonConfigInfo:CREATOR	Landroid/os/Parcelable$Creator;
    //   42: aload_3
    //   43: invokeinterface 54 2 0
    //   48: checkcast 44	com/tencent/mobileqq/ar/aidl/ARCommonConfigInfo
    //   51: astore_1
    //   52: aload_3
    ...
    //   0	78	0	this	zzw
    //   51	13	1	localARCommonConfigInfo	com.tencent.mobileqq.ar.aidl.ARCommonConfigInfo
  ...
  public com.tencent.mobileqq.ar.aidl.ArConfigInfo a()
  {
    ...
    //   33: invokevirtual 42	android/os/Parcel:readInt	()I
    //   36: ifeq +26 -> 62
    //   39: getstatic 61	com/tencent/mobileqq/ar/aidl/ArConfigInfo:CREATOR	Landroid/os/Parcelable$Creator;
    //   42: aload_3
    //   43: invokeinterface 54 2 0
    //   48: checkcast 60	com/tencent/mobileqq/ar/aidl/ArConfigInfo
    //   51: astore_1
    //   52: aload_3
    //   53: invokevirtual 57	android/os/Parcel:recycle	()V
    //   56: aload_2
  ...
  public com.tencent.mobileqq.ar.aidl.ArEffectConfig a()
  {
    ...
    //   33: invokevirtual 42	android/os/Parcel:readInt	()I
    //   36: ifeq +26 -> 62
    //   39: getstatic 65	com/tencent/mobileqq/ar/aidl/ArEffectConfig:CREATOR	Landroid/os/Parcelable$Creator;
    //   42: aload_3
    //   43: invokeinterface 54 2 0
    //   48: checkcast 64	com/tencent/mobileqq/ar/aidl/ArEffectConfig
    //   51: astore_1
    //   52: aload_3
    //   53: invokevirtual 57	android/os/Parcel:recycle	()V
    //   56: aload_2
  ...
  /* Error */
  public void a(com.tencent.mobileqq.ar.aidl.ArConfigInfo paramArConfigInfo)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 74	com/tencent/mobileqq/ar/aidl/ArConfigInfo:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	zzw:a	Landroid/os/IBinder;
    //   33: bipush 12
    //   35: aload_2
    //   36: aload_3
    //   37: iconst_0
    ...
    //   start	length	slot	name	signature
    //   0	76	0	this	zzw
    //   0	76	1	paramArConfigInfo	com.tencent.mobileqq.ar.aidl.ArConfigInfo
  ...
  /* Error */
  public void a(com.tencent.mobileqq.ar.aidl.IArFaceCallback paramIArFaceCallback)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   30: aload_0
    //   31: getfield 15	zzw:a	Landroid/os/IBinder;
    //   34: bipush 8
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
    ...
    //   start	length	slot	name	signature
    //   0	74	0	this	zzw
    //   0	74	1	paramIArFaceCallback	com.tencent.mobileqq.ar.aidl.IArFaceCallback
  ...
  /* Error */
  public void a(com.tencent.mobileqq.ar.aidl.IArSoCallback paramIArSoCallback)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   start	length	slot	name	signature
    //   0	74	0	this	zzw
    //   0	74	1	paramIArSoCallback	com.tencent.mobileqq.ar.aidl.IArSoCallback
    //   3	66	2	localParcel1	Parcel
    //   7	58	3	localParcel2	Parcel
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public void b(com.tencent.mobileqq.ar.aidl.IArFaceCallback paramIArFaceCallback)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
  ...
  /* Error */
  public void b(com.tencent.mobileqq.ar.aidl.IArSoCallback paramIArSoCallback)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
