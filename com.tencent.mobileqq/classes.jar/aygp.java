...
public class aygp
  extends ayfn
{
  public aygp(TeamWorkAuthorizeSettingFragment paramTeamWorkAuthorizeSettingFragment) {}
  
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    this.a.stopTitleProgress();
    if (!paramBoolean) {
      aptx.a(ajya.a(2131714811));
    }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt, List<TimDocSSOMsg.UinRightInfo> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localayec.jdField_a_of_type_JavaLangString = String.valueOf(paramList.uint64_uin.get());
      localayec.jdField_a_of_type_ComTencentPbTeamworkTimDocSSOMsg$UinRightInfo = paramList;
      this.a.jdField_a_of_type_Ayea.a(localayec);
    }
    this.a.b = paramInt;
    TeamWorkAuthorizeSettingFragment.a(this.a, this.a.b);
    TeamWorkAuthorizeSettingFragment.a(this.a);
  ...
  public void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    this.a.stopTitleProgress();
    if (!paramBoolean) {
      aptx.a(ajya.a(2131714754));
    }
    Intent localIntent;
    do
    {
      return;
      aptx.b(ajya.a(2131714756));
      this.a.stopTitleProgress();
