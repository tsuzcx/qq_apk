...
{
  adlu(adls paramadls, MessageForArkApp paramMessageForArkApp) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while (this.jdField_a_of_type_Adls.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null);
          paramInt = paramDialogInterface.getProcessState();
          this.jdField_a_of_type_Adls.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_Adls.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Adls.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDataMessageForArkApp.uniseq);
    ...
    return;
    this.jdField_a_of_type_Adls.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramDialogInterface, null, true);
  }
}
