...
public class acrm
{
  ...
  public static void a(Ad paramAd, int paramInt)
  {
    ...
    {
      acqy.d("GdtTraceReporter", String.format("report %d error", new Object[] { Integer.valueOf(paramInt) }));
      return;
    }
    acqy.b("GdtTraceReporter", String.format("report %d", new Object[] { Integer.valueOf(paramInt) }));
