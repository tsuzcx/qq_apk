...
{
  public acrm(FileManagerEntity paramFileManagerEntity, Activity paramActivity, IFileBrowser paramIFileBrowser) {}
    ...
    try
    {
      ...
      while (this.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerIFileBrowser != null)
      {
        ...
        if (FileModel.a(paramView).a(false)) {
          FMDialogUtil.a(this.jdField_a_of_type_AndroidAppActivity, 2131428241, 2131428237, new acrn(this, (Intent)localObject2));
        } else {
