...
public class aikr
{
  private static aikr jdField_a_of_type_Aikr;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = anhk.cV + "icons/";
  private static final String jdField_c_of_type_JavaLangString = anhk.cV + "zip/";
  private static final String jdField_d_of_type_JavaLangString = anni.a(2131713676);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bhhf(paramString1, new File(jdField_c_of_type_JavaLangString + "android_tim_theme_icons.zip"));
  ...
  public static aikr a()
  {
    if (jdField_a_of_type_Aikr == null) {
      jdField_a_of_type_Aikr = new aikr();
    }
    return jdField_a_of_type_Aikr;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	aikr:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	aikr:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 143	bgmg:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	aikr:jdField_b_of_type_JavaLangString	Ljava/lang/String;
        ...
        if (localBitmap != null)
        {
          ...
          if (localObject2 == null)
          {
            ...
            if (localBitmap != null)
            {
              ...
              {
                localObject2 = bgmo.a(jdField_b_of_type_JavaLangString + "tim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bgmo.a(jdField_b_of_type_JavaLangString + "aio_tim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
