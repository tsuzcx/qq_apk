  ...
  extends amyi<amzx>
{
  ...
  @NonNull
  public amzx a(ampi[] paramArrayOfampi)
  {
    int j = -1;
    ...
    if (i < m)
    {
      ...
      int k = localampi.jdField_a_of_type_Int;
      if (k < j) {
        veg.e("QVipStickerProcessor", "received old task id " + k + ", latest task id: " + j);
      }
      for (;;)
      {
        i += 1;
        ...
        try
        {
          JSONObject localJSONObject = new JSONObject(new String(localampi.jdField_a_of_type_JavaLangString.getBytes("utf-8")));
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          ...
          veg.e("QVipStickerProcessor", "item.content=" + localampi.jdField_a_of_type_JavaLangString + " e=" + localUnsupportedEncodingException);
        }
        catch (JSONException localJSONException)
        {
          localJSONException.printStackTrace();
          veg.e("QVipStickerProcessor", "item.content=" + localampi.jdField_a_of_type_JavaLangString + " e=" + localJSONException);
        }
      }
    }
    return new amzx();
