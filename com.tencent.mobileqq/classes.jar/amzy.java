  ...
  implements auas
{
  ...
  private auap jdField_a_of_type_Auap;
  private Set<Long> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  private CopyOnWriteArrayList<WeakReference<auas>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  private boolean jdField_a_of_type_Boolean;
  private CopyOnWriteArrayList<WeakReference<anac>> jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  private boolean h;
  private boolean i;
  private boolean j;
  private boolean k = amuc.a().f;
  private boolean l = amuc.a().g;
  ...
  private amtv a()
  {
    try
    {
      ...
      amtv localamtv = this.jdField_a_of_type_Amtv;
      return localamtv;
    }
    finally {}
  }
  ...
  {
    if (jdField_a_of_type_Amzy == null) {}
    try
    {
      if (jdField_a_of_type_Amzy == null) {
        jdField_a_of_type_Amzy = new amzy();
      }
      return jdField_a_of_type_Amzy;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          int m = anaj.b("QMCF_qr");
          int n = anaj.b("yuvutil");
          if ((m != 0) || (n != 0)) {
            continue;
          }
          bool3 = true;
        ...
        catch (Throwable localThrowable2)
        {
          ...
          continue;
          auap localauap = this.jdField_a_of_type_Auap;
          if (localauap == null) {
            continue;
          }
          bool1 = true;
        ...
        if ((!this.l) || (!bool2) || (!e) || (!bool1) || (this.jdField_a_of_type_Auap != null)) {
          continue;
        }
        bool1 = anai.a();
        if (!bool1) {
        ...
        try
        {
          ...
          this.jdField_a_of_type_Auap = new auap(null, this.jdField_a_of_type_Int, 0, 0);
          this.jdField_a_of_type_Auap.a(this);
          localObject1 = anai.a() + File.separator + anai.a("qr_detection_model.bin");
          localObject3 = anai.a() + File.separator + anai.a("qr_detection_model.txt");
          str1 = anai.a() + File.separator + anai.a("qr_anchor.bin");
          String str2 = auan.b();
          File localFile = new File(str2);
          if (!localFile.exists()) {
            localFile.mkdirs();
          }
          this.jdField_a_of_type_Auap.a((String)localObject1, (String)localObject3, str1, str2);
          bool1 = true;
        }
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    if (bool) {
      try
      {
        if (this.jdField_a_of_type_Auap != null)
        {
          this.jdField_a_of_type_Auap.a();
          this.jdField_a_of_type_Auap = null;
        }
        if (this.jdField_a_of_type_Amtv != null) {
  ...
  public void a(anac paramanac)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      anac localanac = (anac)((WeakReference)localIterator.next()).get();
      if ((localanac != null) && (localanac == paramanac)) {
        return;
      }
    }
    this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramanac));
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          ...
          {
            this.j = true;
            paramString.a(paramContext, new anaa(this, paramString), new anab(this));
            if (d) {
              c();
            }
            a();
  ...
  public void a(List<amzu> paramList, long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      auas localauas = (auas)((WeakReference)localIterator.next()).get();
      if (localauas != null) {
        localauas.a(paramList, paramLong);
      }
    }
  }
  ...
  public boolean a(Bitmap paramBitmap, long paramLong)
  {
    ...
    {
      return bool1;
      bool2 = localauap.a(paramBitmap, paramLong);
      bool1 = bool2;
    } while (!QLog.isColorLevel());
  ...
  {
    auap localauap = this.jdField_a_of_type_Auap;
    if ((!e) || (localauap == null) || (paramRect == null)) {
      return false;
    }
    ...
    for (;;)
    {
      ...
      paramRect = new amzz(this, paramRect, paramLong, localObject, localauap, arrayOfBoolean, paramBitmap);
      boolean bool1;
      if ((bool2) && (localauap.a(paramBitmap, paramLong)))
      {
        bool1 = true;
        label97:
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int >= 0)
        {
          ...
          if ((this.l) && (m != 0) && (this.jdField_a_of_type_Auap == null) && (!this.c))
          {
            if (!anai.a()) {
              break label256;
            }
          ...
          return;
          if (this.jdField_a_of_type_Amtv != null) {
            this.jdField_a_of_type_Amtv.c(0);
          }
          if (!QLog.isColorLevel()) {
            continue;
          }
      ...
      label224:
      if (this.jdField_a_of_type_Amtv != null) {
        this.jdField_a_of_type_Amtv.c(1);
      }
      if (QLog.isColorLevel())
      {
        ...
        label256:
        if (this.jdField_a_of_type_Amtv != null) {
          this.jdField_a_of_type_Amtv.c(2);
        }
        if (QLog.isColorLevel()) {
  ...
  public void c(auas paramauas)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      anac localanac = (anac)localWeakReference.get();
      if ((localanac != null) && (localanac == paramauas)) {
