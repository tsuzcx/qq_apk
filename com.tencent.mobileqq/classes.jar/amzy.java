  ...
  extends BusinessHandler
{
  ...
  amzy(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidOsHandler = new amzz(this, Looper.getMainLooper());
  }
            ...
            if (paramFromServiceMsg.getServiceCmd().equals("RegPrxySvc.PushParam"))
            {
              if (paramObject != null)
              {
                ...
                if (paramObject.clientType == 9)
                {
                  ...
                  if (!((yyd)this.app.getManager(335)).a(localSvcRespParam)) {
                    break label535;
                  }
                }
                for (i = 1;; i = 0)
