...
{
  public bbvc(StatusJsHandler paramStatusJsHandler) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 0)
        {
          ...
          obj.a().a(localBaseActivity.getApplicationContext(), localBaseActivity.app, this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin, null, true);
