...
{
  public bbvc(HomeWorkTroopSelectorFragment paramHomeWorkTroopSelectorFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (HomeWorkTroopSelectorFragment.a(this.a) != null)
    {
      ...
      while (i < j)
      {
        localObject = (bbvh)HomeWorkTroopSelectorFragment.a(this.a).getItem(i);
        if ((((Boolean)((bbvh)localObject).b).booleanValue()) && (!HomeWorkTroopSelectorFragment.a(this.a).equals(((TroopInfo)((bbvh)localObject).a).troopuin)))
        {
          paramView.add(((TroopInfo)((bbvh)localObject).a).troopname);
          localArrayList.add(((TroopInfo)((bbvh)localObject).a).troopuin);
        }
        i += 1;
      }
    }
