...
public class akgt
  implements bfyc, bfye
{
  private static akgt jdField_a_of_type_Akgt;
  public int a;
  ...
  public WeakReference<akhb> a;
  public HashMap<MessageForPtt, MessageForQQWalletMsg> a;
  public Map<MessageForPtt, akhd> a;
  ...
  public static akgt a()
  {
    try
    {
      if (jdField_a_of_type_Akgt == null) {
        jdField_a_of_type_Akgt = new akgt();
      }
      akgt localakgt = jdField_a_of_type_Akgt;
      return localakgt;
    }
    finally {}
  }
  
  private akhc a(byte[] paramArrayOfByte)
  {
    boolean bool = true;
    akhc localakhc = new akhc();
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0)) {
      return localakhc;
    }
    akgs.a().a();
    if (akgs.a().a(paramArrayOfByte, paramArrayOfByte.length) == 1) {}
    for (;;)
    {
      localakhc.jdField_a_of_type_Boolean = bool;
      localakhc.jdField_a_of_type_Float = akgs.a().a();
      localakhc.jdField_a_of_type_JavaLangString = a(localakhc.jdField_a_of_type_Float);
      akgs.a().b();
  ...
  private akhc a(byte[] paramArrayOfByte, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  private void a(int paramInt1, long paramLong, int paramInt2, MessageForQQWalletMsg paramMessageForQQWalletMsg, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (akgs.a().a(localQQAppInterface)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
  ...
  {
    akhb localakhb = (akhb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localakhb != null) && (!localakhb.c())) {
      localakhb.a(paramInt, paramString);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong, byte[] paramArrayOfByte, String paramString)
  {
    ...
    try
    {
      MessageForPtt localMessageForPtt = acvv.a(akgd.a(), paramMessageRecord.getLocalFilePath(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramMessageRecord.voiceType);
      if (localMessageForPtt != null)
      {
        this.jdField_a_of_type_JavaUtilMap.put(localMessageForPtt, new akhd(paramMessageRecord, paramLong, paramArrayOfByte, paramString));
        paramArrayOfByte = new QQRecorder.RecorderParam(bfyl.jdField_b_of_type_Int, 16000, 1);
        if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangString, paramMessageRecord.getLocalFilePath(), paramArrayOfByte))
        {
          ...
          if ((paramString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (localMessageForPtt != null))
          {
            ...
            paramArrayOfByte = (akhb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    ...
    for (;;)
    {
      try
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          localmnf = new mnf(paramRecorderParam.jdField_a_of_type_Int, 16, 1);
          localmnf.a(new akgu(this));
          l = System.currentTimeMillis();
        }
        try
        {
          localmnf.a(paramString1, str);
          if (QLog.isColorLevel()) {
          ...
          azbu.a(paramString2);
          paramRecorderParam = bfyl.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
          azbu.a(paramString2, paramRecorderParam, paramRecorderParam.length);
          ...
          azbu.a(paramString2, ((azcv)localObject).jdField_a_of_type_ArrayOfByte, ((azcv)localObject).jdField_a_of_type_Int);
        }
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    paramString = (akhb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
  ...
  public String a(float paramFloat)
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject1 != null)
      {
        localObject1 = ((ajyg)localObject1).a("voice_pwd", new String[] { "scoreIdMap" });
        if (localObject1 == null) {}
      }
    }
    int i;
  ...
  public void a(akha paramakha)
  {
    ...
    if ((localObject == null) || (paramakha == null)) {}
    do
    {
      return;
      localObject = ((TicketManager)((QQAppInterface)localObject).getManager(2)).getSkey(((QQAppInterface)localObject).getCurrentAccountUin(), 16L, new akgz(this, paramakha));
    } while ((localObject == null) || (((Ticket)localObject)._sig == null) || (((Ticket)localObject)._sig.length == 0));
    paramakha.a(new String(((Ticket)localObject)._sig));
  }
  
  public void a(akhb paramakhb)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakhb);
  }
  ...
  public void a(SessionInfo paramSessionInfo, MessageForQQWalletMsg paramMessageForQQWalletMsg, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      i = ahdf.a(paramMessageForQQWalletMsg.messageType);
      str1 = paramString;
      if (TextUtils.isEmpty(paramString)) {
      ...
      localRecorderParam = new QQRecorder.RecorderParam(bfyl.jdField_b_of_type_Int, 16000, 1);
    ...
    boolean bool2 = true;
    long l1 = ajvu.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone", 0L);
    ...
    if ((!this.jdField_c_of_type_Boolean) && (!bool1)) {
      a(2, ajvu.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone_tips", BaseApplicationImpl.getContext().getResources().getString(2131694839)));
    }
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        paramSessionInfo = acvv.a(localQQAppInterface, paramString, paramSessionInfo, -2, localRecorderParam.jdField_c_of_type_Int);
  ...
  public void a(MessageRecord paramMessageRecord, amwl paramamwl, long paramLong, byte[] paramArrayOfByte, String paramString, BaseUploadProcessor paramBaseUploadProcessor)
  {
    QQAppInterface localQQAppInterface;
    Object localObject1;
    Object localObject2;
    ...
    {
      localQQAppInterface = akgd.a();
      localObject1 = (akhb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      i = 0;
      if (localObject1 != null) {
        i = localObject1.hashCode();
      }
      if ((localQQAppInterface == null) || (paramMessageRecord == null) || (!(paramMessageRecord instanceof MessageForPtt)) || (localObject1 == null) || (((akhb)localObject1).c()) || (this.jdField_b_of_type_Boolean) || (i != this.jdField_a_of_type_Int)) {
        return;
      }
      ...
      if (i == 1)
      {
        paramMessageRecord = (akhb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        ...
        localQQAppInterface.getMessageFacade().addAndSendMessage((MessageRecord)localObject2, paramamwl);
        return;
      }
      if (i != 2) {
        break label307;
    ...
    for (;;)
    {
      a(new akgv(this, localQQAppInterface, (MessageForQQWalletMsg)localObject1, i, paramLong, paramArrayOfByte, paramString, (MessageForPtt)localObject2, paramBaseUploadProcessor, paramamwl));
      return;
    ...
    if (i == 3)
    {
      ...
      {
        paramMessageRecord = (MessageForPtt)paramMessageRecord;
        localObject2 = (akhd)this.jdField_a_of_type_JavaUtilMap.get(paramMessageRecord);
        ...
        for (;;)
        {
          a(new akgx(this, localMessageForQQWalletMsg, localQQAppInterface, i, (akhd)localObject2, paramLong, paramArrayOfByte, paramString, (MessageForQQWalletMsg)localObject1, paramMessageRecord, paramBaseUploadProcessor, paramamwl));
          return;
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    byte[] arrayOfByte = bfyl.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
    azbu.a(paramString);
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bool = ((akhc)localObject2).jdField_a_of_type_Boolean;
      if (bool) {
        b(((akhc)localObject2).jdField_a_of_type_JavaLangString, (MessageRecord)localObject1);
      }
      localObject2 = (akhb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject2 == null) || (((akhb)localObject2).c()) || (bool)) {
        break label674;
      }
      ((akhb)localObject2).a(false, "");
      break label674;
      localObject2 = (MessageForQQWalletMsg)this.jdField_a_of_type_JavaUtilHashMap.get(localObject1);
      ...
      j = ahdf.a(((MessageForQQWalletMsg)localObject2).messageType);
      if (j == 8) {
        if (((MessageForQQWalletMsg)localObject2).mQQWalletRedPacketMsg.elem.songFlag == 0) {
          if (this.jdField_d_of_type_Int == -1) {
            if (!akgd.a(BaseApplicationImpl.getContext())) {
              break label677;
            }
          }
        }
  ...
  public void b(int paramInt)
  {
    ...
    localQQAppInterface.runOnUiThread(new VoiceRedPacketHelper.1(this, localBaseApplication, paramInt, localBaseApplication.getResources().getDimensionPixelSize(2131299076)));
  }
  
  public void b(azcu paramazcu, azcv paramazcv)
  {
    if (((paramazcu instanceof WechatNsWrapper)) && (this.jdField_a_of_type_JavaIoByteArrayOutputStream != null) && (paramazcv != null) && (this.jdField_d_of_type_Boolean)) {
      this.jdField_a_of_type_JavaIoByteArrayOutputStream.write(paramazcv.jdField_a_of_type_ArrayOfByte, 0, paramazcv.jdField_a_of_type_Int);
    }
  }
