  ...
  extends ohe
{
  ...
  private WeakReference<opp> jdField_b_of_type_JavaLangRefWeakReference;
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  
  public ogx(AppInterface paramAppInterface, opp paramopp)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramAppInterface);
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramopp);
  ...
  private void a(atmp paramatmp, long paramLong, int paramInt)
  {
    if (paramatmp == null)
    {
    ...
    {
      ReadinjoyFollowingUserBriefInfo localReadinjoyFollowingUserBriefInfo = (ReadinjoyFollowingUserBriefInfo)paramatmp.a(ReadinjoyFollowingUserBriefInfo.class, String.valueOf(paramLong));
      if (localReadinjoyFollowingUserBriefInfo != null) {
        paramatmp.b(localReadinjoyFollowingUserBriefInfo);
      }
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(paramLong));
      return;
    }
    paramatmp.b(new ReadinjoyFollowingUserBriefInfo(paramLong, paramInt));
    this.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(paramLong));
  }
  
  private void a(List<ppg> paramList, int paramInt)
  {
    if (paramList == null) {}
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        while (paramList.hasNext()) {
          a((atmp)localObject, ((ppg)paramList.next()).a().longValue(), paramInt);
        }
      }
    }
  }
  
  private void a(List<ppg> paramList, boolean paramBoolean)
  {
    ...
    {
      return;
      paramList = (opp)this.jdField_b_of_type_JavaLangRefWeakReference.get();
