...
public class axcw
{
  ...
  public static String a(awzz paramawzz)
  {
    String str = String.format("%s_%d", new Object[] { paramawzz.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramawzz.jdField_a_of_type_Int)) });
    if (!TextUtils.isEmpty(paramawzz.b)) {
      str = String.format("%s_%d_%s", new Object[] { paramawzz.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramawzz.jdField_a_of_type_Int)), paramawzz.b });
    }
    return axcp.c + str + ".db";
  }
  ...
  {
    FileUtil.deleteFile(axcp.jdField_a_of_type_JavaLangString);
  }
  ...
  public static void a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    int i = bcsc.b(paramMessageRecord.msgUid);
  ...
  public static void a(MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    if ((b) && (paramMsgBackupMsgEntity != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.decryptFromString(paramMsgBackupMsgEntity.chatUin, awzs.c);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extraData, awzs.c);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extensionData, awzs.c);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (awzs.b != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupResEntity.extraData, awzs.b);
    }
  }
  
  public static void a(String paramString, awzz paramawzz)
  {
    paramString = paramString.substring(0, paramString.indexOf(".")).split("_");
    paramawzz.jdField_a_of_type_JavaLangString = paramString[0];
    paramawzz.jdField_a_of_type_Int = c(Integer.parseInt(paramString[1]));
    if (paramString.length > 2) {
      paramawzz.b = paramString[2];
    }
  }
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (bool2)
      {
        File localFile = new File(axcp.b);
  ...
  public static long b(MessageRecord paramMessageRecord)
  {
    ...
    return bcsc.b(paramMessageRecord.msgUid);
  }
  ...
  {
    if ((b) && (paramMsgBackupMsgEntity != null) && (awzs.b != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.encryptFromString(paramMsgBackupMsgEntity.chatUin, awzs.b);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extraData, awzs.b);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extensionData, awzs.b);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (awzs.c != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupResEntity.extraData, awzs.c);
    }
  }
