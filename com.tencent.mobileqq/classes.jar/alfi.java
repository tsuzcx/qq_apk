  ...
  implements alfe
{
  ...
  private alfc jdField_a_of_type_Alfc;
  ...
  public FloatBuffer a(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    boolean bool3 = true;
    boolean bool2 = true;
    if ((this.jdField_a_of_type_ComHuaweiHiarARSession == null) || (this.jdField_a_of_type_Alfc == null))
    {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_ComHuaweiHiarARSession != null)
    {
      ...
      this.jdField_a_of_type_Alfc.b();
      this.jdField_a_of_type_ComHuaweiHiarARSession = null;
      this.jdField_a_of_type_Alfc = null;
  ...
  {
    if (this.jdField_a_of_type_Alfc == null) {
      this.jdField_a_of_type_Alfc = new alfc(BaseApplicationImpl.getContext());
    }
    this.jdField_a_of_type_Alfc.a(paramInt1, paramInt2);
  ...
  public boolean a(Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_ComHuaweiHiarARSession == null)
    {
      if (!alfg.b((Activity)paramContext)) {
        break label151;
      }
      try
      {
