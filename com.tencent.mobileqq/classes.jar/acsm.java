  ...
  extends MSFServlet
{
  ...
  private static final String jdField_a_of_type_JavaLangString = acsm.class.getSimpleName();
  
  private static AcsHead a()
  {
    AcsHead localAcsHead = new AcsHead();
    localAcsHead.model = bbdh.i();
    localAcsHead.platform = "Android";
    localAcsHead.version = bbdh.c();
    return localAcsHead;
  }
  ...
  public static void a(int paramInt1, int paramInt2, BusinessObserver paramBusinessObserver)
  {
    ...
    NewIntent localNewIntent = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acsm.class);
  ...
  public static void a(String paramString1, String paramString2, BusinessObserver paramBusinessObserver)
  {
    ...
    paramString1 = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acsm.class);
  ...
  public static void a(String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    paramString = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acsm.class);
  ...
  public static void a(ArrayList<String> paramArrayList, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayList = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acsm.class);
