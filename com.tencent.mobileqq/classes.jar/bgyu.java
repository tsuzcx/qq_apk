...
public class bgyu
{
  private static volatile bgyu jdField_a_of_type_Bgyu;
  ...
  private Vector<bgyw> jdField_a_of_type_JavaUtilVector = new Vector();
  ...
  {
    if (jdField_a_of_type_Bgyu == null) {}
    try
    {
      if (jdField_a_of_type_Bgyu == null) {
        jdField_a_of_type_Bgyu = new bgyu();
      }
      return jdField_a_of_type_Bgyu;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    if (Build.VERSION.SDK_INT > 16)
    {
      if (this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback == null) {
        this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new bgyv(this);
      }
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ((bgyw)this.jdField_a_of_type_JavaUtilVector.get(i)).onInfo(this.jdField_a_of_type_Long, d);
          i += 1;
        }
      }
      finally {}
  ...
  public void a(bgyw parambgyw)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (!this.jdField_a_of_type_JavaUtilVector.contains(parambgyw)) {
        this.jdField_a_of_type_JavaUtilVector.add(parambgyw);
      }
  ...
  public void b(bgyw parambgyw)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilVector.contains(parambgyw)) {
        this.jdField_a_of_type_JavaUtilVector.remove(parambgyw);
      }
      if (this.jdField_a_of_type_JavaUtilVector.size() <= 0) {
        b();
      }
