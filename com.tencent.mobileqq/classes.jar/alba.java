...
@TargetApi(14)
public class alba
  implements alad, SurfaceTexture.OnFrameAvailableListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener
{
  ...
  private alkf jdField_a_of_type_Alkf = new albb(this);
  ...
  public alba(alaf paramalaf, albc paramalbc)
  {
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_Alaf = paramalaf;
    this.jdField_a_of_type_Albc = paramalbc;
    this.jdField_a_of_type_JavaLangString = paramalbc.jdField_b_of_type_JavaLangString;
    this.jdField_c_of_type_Int = paramalbc.jdField_e_of_type_Int;
    this.jdField_a_of_type_Int = paramalbc.jdField_d_of_type_Int;
    this.jdField_a_of_type_Alkh = paramalbc.jdField_a_of_type_Alkh;
    paramalaf = Build.MODEL.toLowerCase();
    if ((Build.MANUFACTURER.toLowerCase().contains("meizu")) && (paramalaf.contains("m040"))) {
  ...
  private void g()
  {
    if (this.jdField_a_of_type_Alke == null)
    {
      ...
      this.jdField_a_of_type_Alke.a(this.jdField_a_of_type_Albc.jdField_c_of_type_Int, this.jdField_a_of_type_Albc.jdField_a_of_type_Float, this.jdField_a_of_type_Albc.jdField_b_of_type_Float, this.jdField_a_of_type_Albc.jdField_c_of_type_Float);
    }
  }
  ...
  {
    if ((!this.jdField_e_of_type_Boolean) || (paramArrayOfFloat2 == null) || (paramArrayOfFloat3 == null) || (paramArrayOfFloat4 == null) || (this.jdField_a_of_type_Albc == null)) {
      return;
    }
    ...
    int j;
    alkh localalkh;
    if ((this.jdField_a_of_type_Albc != null) && (this.jdField_a_of_type_Albc.jdField_b_of_type_Int == 1)) {
      if (this.jdField_a_of_type_Alke != null)
      {
        paramArrayOfFloat2 = this.jdField_a_of_type_Alke;
        j = this.jdField_d_of_type_Int;
        localalkh = this.jdField_a_of_type_Alkh;
        ...
        paramArrayOfFloat2.a(new int[] { j }, localalkh, paramArrayOfFloat1, paramArrayOfFloat3);
      }
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Alke != null)
      {
        paramArrayOfFloat3 = this.jdField_a_of_type_Alke;
        j = this.jdField_d_of_type_Int;
        localalkh = this.jdField_a_of_type_Alkh;
        ...
        paramArrayOfFloat3.a(new int[] { j }, localalkh, paramArrayOfFloat1, paramArrayOfFloat2);
      }
    }
  }
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2)
    {
      if (this.jdField_a_of_type_Albc.jdField_a_of_type_Aldz != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Albc.jdField_a_of_type_Aldz.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Albc.jdField_a_of_type_Aldz.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Albc.jdField_a_of_type_Aldz.jdField_c_of_type_Float, this.jdField_a_of_type_Albc.jdField_a_of_type_Aldz.d, this.jdField_a_of_type_Albc.jdField_a_of_type_Aldz.e);
      }
      return this.jdField_a_of_type_ArrayOfFloat;
    }
    if (this.jdField_a_of_type_Albc.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Albc != null) {
      return this.jdField_a_of_type_Albc.jdField_a_of_type_Int;
    }
    return 2;
  }
  ...
  {
    if (this.jdField_a_of_type_Albc != null) {
      return this.jdField_a_of_type_Albc.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Albc.jdField_a_of_type_JavaLangString;
  }
  ...
  public void d()
  {
    ...
    //   43: aload_0
    //   44: getfield 376	alba:jdField_b_of_type_Boolean	Z
    //   47: ifne +20 -> 67
    //   50: aload_0
    //   51: getfield 167	alba:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   54: ifnull +13 -> 67
    //   57: aload_0
    //   58: getfield 167	alba:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   89: aload_0
    //   90: getfield 376	alba:jdField_b_of_type_Boolean	Z
    ...
    //   102: aload_0
    //   103: getfield 167	alba:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   116: aload_0
    //   117: iconst_0
    //   118: putfield 385	alba:h	Z
    //   121: aload_0
    //   122: iconst_0
    //   123: putfield 309	alba:jdField_e_of_type_Boolean	Z
    //   126: new 387	java/io/FileInputStream
    //   129: dup
    //   130: new 153	java/io/File
    //   133: dup
    //   134: aload_0
    //   135: getfield 80	alba:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: astore_2
    //   155: aload_0
    //   156: getfield 167	alba:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   159: aload 4
    ...
    //   166: aload_0
    //   167: iconst_1
    //   168: putfield 248	alba:jdField_b_of_type_Int	I
    //   171: aload_3
    //   172: astore_2
    //   173: aload_0
    //   174: getfield 167	alba:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   177: astore 4
    //   179: aload_3
    //   180: astore_2
    //   181: aload_0
    //   182: getfield 50	alba:jdField_c_of_type_Int	I
    //   185: ifne +96 -> 281
    //   188: aload_3
    //   189: astore_2
    //   190: aload 4
    ...
    //   198: aload_0
    //   199: iconst_1
    //   200: putfield 400	alba:g	Z
    //   203: aload_3
    //   204: astore_2
    //   205: aload_0
    //   206: getfield 167	alba:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   209: invokevirtual 403	android/media/MediaPlayer:prepare	()V
    //   212: aload_3
    //   213: astore_2
    //   214: aload_0
    //   215: iconst_0
    //   216: putfield 405	alba:f	Z
    //   219: aload_3
    //   220: astore_2
    //   221: aload_0
    //   222: getfield 167	alba:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   225: invokevirtual 407	android/media/MediaPlayer:start	()V
    //   228: aload_3
    //   229: astore_2
    //   230: aload_0
    //   231: iconst_1
    //   232: putfield 376	alba:jdField_b_of_type_Boolean	Z
    //   235: aload_3
    //   236: astore_2
    //   237: aload_0
    //   238: getfield 72	alba:jdField_a_of_type_Alaf	Lalaf;
    //   241: ifnull +19 -> 260
    //   244: aload_3
    //   245: astore_2
    //   246: aload_0
    //   247: getfield 72	alba:jdField_a_of_type_Alaf	Lalaf;
    //   250: iconst_0
    //   251: aload_0
    //   252: getfield 50	alba:jdField_c_of_type_Int	I
    ...
    //   338: astore_2
    //   339: aload_0
    //   340: invokevirtual 420	alba:f	()V
    //   343: aload_3
    //   344: ifnull -229 -> 115
    //   347: aload_3
    ...
    //   416: astore_2
    //   417: aload_0
    //   418: invokevirtual 420	alba:f	()V
    //   421: aload_3
    //   422: ifnull -307 -> 115
    //   425: aload_3
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Alaf != null) {
      this.jdField_a_of_type_Alaf.b(2, this.jdField_c_of_type_Int - this.jdField_b_of_type_Int);
    }
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Alaf != null) {
      this.jdField_a_of_type_Alaf.a(this.jdField_a_of_type_Albc.jdField_a_of_type_JavaLangString);
    }
    ...
    paramMediaPlayer.put("url", this.jdField_a_of_type_Albc.jdField_a_of_type_JavaLangString);
    axrl.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_on_error", true, 0L, 0L, paramMediaPlayer, "", false);
    f();
    return false;
  }
