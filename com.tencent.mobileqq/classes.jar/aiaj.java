  ...
  implements View.OnClickListener
{
  ...
  protected ajjj a;
  protected Context a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aiak(this);
  protected azxt a;
  protected QQAppInterface a;
  protected HashMap<Integer, ArrayList<atmo>> a;
  protected List<atmo> a;
  ...
  public aiaj(Context paramContext, ExpandableListView paramExpandableListView, QQAppInterface paramQQAppInterface, List<atmo> paramList, aiam paramaiam, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Azxt = new azxt(paramContext);
    this.jdField_a_of_type_Azxt.a((int)(this.jdField_a_of_type_Float * 100.0F), (int)(this.jdField_a_of_type_Float * 100.0F));
    a(paramList, false);
  ...
  private ArrayList<atmo> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!azzz.a(localRecentUser.uin)) && (localRecentUser.getType() == 0) && (!azzz.c(localRecentUser.uin)) && (this.jdField_a_of_type_Ajjj != null) && (this.jdField_a_of_type_Ajjj.b(localRecentUser.uin))) {
        localArrayList.add(this.jdField_a_of_type_Ajjj.e(localRecentUser.uin));
      }
    }
    ...
    if ((((PhoneContactManagerImp)localObject1).c()) || (i == 8))
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (!((ArrayList)localObject1).isEmpty())
        {
          ...
          ((Groups)localObject2).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131629351);
  ...
  public List<atmo> a(int paramInt)
  {
  ...
  {
    aial localaial = (aial)paramView.getTag();
    if (localaial == null)
    {
      localaial = new aial();
      localaial.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301599));
      localaial.b = ((TextView)paramView.findViewById(2131299071));
      paramView.findViewById(2131302936).setVisibility(0);
      paramView.setTag(localaial);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localaial.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      localaial.b.setText(String.valueOf(localGroups.group_friend_count));
      ((CheckBox)paramView.findViewById(2131302936)).setChecked(this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(paramInt));
      return;
    }
  }
  
  public void a(List<atmo> paramList, boolean paramBoolean)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      for (;;)
      {
        ...
        break label94;
        Object localObject = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(String.valueOf(localGroups.group_id));
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      for (paramViewGroup.jdField_c_of_type_Int = 11;; paramViewGroup.jdField_c_of_type_Int = 1)
      {
        ...
        paramBoolean = this.jdField_a_of_type_Aiam.a(paramView, paramInt1);
        boolean bool = azgu.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
        ...
        paramViewGroup = (aian)localForwardRecentItemView.getTag();
        break;
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493280, paramViewGroup, false);
      paramViewGroup = new aial();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301599));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131299071));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (aial)paramView.getTag();
    }
  }
  ...
  {
    paramView = (aial)paramView.getTag();
