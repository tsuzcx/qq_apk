  ...
  implements BusinessObserver
{
  ...
  private ajkh jdField_a_of_type_Ajkh;
  private final String jdField_a_of_type_JavaLangString;
  private final List<ajkf> jdField_a_of_type_JavaUtilList;
  private JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private boolean jdField_a_of_type_Boolean;
  private final String jdField_b_of_type_JavaLangString;
  private boolean jdField_b_of_type_Boolean;
  
  public ajkg(ajkh paramajkh, String paramString1, String paramString2)
  {
  ...
  public JSONObject a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (i == 1001)
    {
      ...
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", ajyc.a(2131700576));
    }
    for (;;)
    {
      localJSONObject.put("ssoRet", 202);
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", ajyc.a(2131700573));
      label473:
      do
      {
        localJSONObject.put("ssoRet", 255);
        localJSONObject.put("businessRet", 0);
        localJSONObject.put("msg", ajyc.a(2131700577));
  ...
  public void a()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      while (localIterator.hasNext()) {
        ((ajkf)localIterator.next()).a(this, this.jdField_a_of_type_Ajkh);
      }
  ...
  public void a(ajkf paramajkf)
  {
    if (paramajkf != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramajkf);
    }
  }
  ...
  public void a(Context paramContext, String paramString, JSONObject paramJSONObject, AppInterface paramAppInterface)
  {
    ...
    if ((paramJSONObject.optInt("needCookie") == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("apollo_client_ApolloWebDataHandler", 2, "Get cookie:" + nax.c((String)localObject, new String[0]) + " from " + nax.b(paramString, new String[0]));
      }
    }
    ...
    {
      paramContext = this.jdField_a_of_type_Ajkh;
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    try
    {
      ...
      a();
      if (this.jdField_a_of_type_Ajkh != null) {
        this.jdField_a_of_type_Ajkh.b = System.currentTimeMillis();
      }
      return;
    }
    catch (Exception paramBundle)
