...
public class ader
{
  private static ader jdField_a_of_type_Ader;
  ...
  private Map<Integer, ades> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(int paramInt, boolean paramBoolean)
  {
    ...
    ades localades = (ades)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localades != null)
    {
      Object localObject = localades.jdField_a_of_type_JavaLangRefWeakReference;
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            if ((!((DoodleMsgLayout)localObject).b()) && (this.jdField_a_of_type_Long != localades.jdField_b_of_type_Long) && (((DoodleMsgLayout)localObject).a()))
            {
              if (paramBoolean)
              {
                a((DoodleMsgLayout)localObject, false);
                if (localades.jdField_b_of_type_Long == this.jdField_c_of_type_Long) {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: can not play:" + localades.jdField_a_of_type_Long + "uniID:" + localades.jdField_b_of_type_Long + " mPlayedID:" + this.jdField_a_of_type_Long);
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: invisible MsgID:" + localades.jdField_a_of_type_Long + "uniID:" + localades.jdField_b_of_type_Long);
          }
        }
      }
    }
  ...
  public static ader a()
  {
    try
    {
      if (jdField_a_of_type_Ader == null) {
        jdField_a_of_type_Ader = new ader();
      }
      return jdField_a_of_type_Ader;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        ades localades = (ades)((Map.Entry)localIterator.next()).getValue();
        if ((localades == null) || (localades.jdField_a_of_type_Int < paramInt1) || (localades.jdField_a_of_type_Int > paramInt2)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (ades)localIterator.next();
        if ((localObject != null) && (((ades)localObject).jdField_a_of_type_Int >= this.d) && (((ades)localObject).jdField_a_of_type_Int <= this.e))
        {
          localObject = ((ades)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          if (localObject != null)
          {
            localObject = (DoodleMsgLayout)((WeakReference)localObject).get();
            if (localObject != null) {
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      do
      {
        do
        {
          ...
          ades localades = (ades)((Iterator)localObject).next();
          if (localades.jdField_b_of_type_Long != this.jdField_c_of_type_Long) {
            break;
          }
          localObject = localades.jdField_a_of_type_JavaLangRefWeakReference;
    ...
    for (;;)
    {
      ...
      break;
      label135:
      localObject = (ades)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(i));
      if ((localObject != null) && ((((ades)localObject).jdField_a_of_type_Long > this.jdField_b_of_type_Long) || (((ades)localObject).jdField_b_of_type_Long == this.jdField_c_of_type_Long)))
      {
        localObject = ((ades)localObject).jdField_a_of_type_JavaLangRefWeakReference;
        if (localObject != null)
        {
  ...
  public static void b()
  {
    try
    {
      if (jdField_a_of_type_Ader != null)
      {
        jdField_a_of_type_Ader.a();
        jdField_a_of_type_Ader = null;
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, DoodleMsgLayout paramDoodleMsgLayout)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new ades(this, paramLong1, paramLong2, paramInt, paramDoodleMsgLayout));
    boolean bool;
    if (this.jdField_a_of_type_Int != 0)
    {
      bool = true;
  ...
  public void a(DoodleMsgLayout paramDoodleMsgLayout, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          ades localades = (ades)((Iterator)localObject).next();
          if ((localades.jdField_a_of_type_JavaLangRefWeakReference != null) && (localades.jdField_a_of_type_JavaLangRefWeakReference.get() == paramDoodleMsgLayout))
          {
            this.jdField_a_of_type_Long = localades.jdField_b_of_type_Long;
            if (QLog.isColorLevel()) {
