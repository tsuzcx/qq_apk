...
public class anvu
{
  ...
  public anvu(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new anvv(this);
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static ascz a(JSONObject paramJSONObject)
  {
  ...
  public anvu a(String paramString1, String paramString2)
  {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    } while (localSharedPreferences.getInt("magic_promotion_old_ver_" + anpc.a(), -1) >= paramJSONObject.jdField_b_of_type_Int);
    localSharedPreferences.edit().putBoolean("magic_promotion_is_new_content_" + anpc.a(), true).commit();
    localSharedPreferences.edit().putInt("magic_promotion_old_ver_" + anpc.a(), paramJSONObject.jdField_b_of_type_Int).commit();
  }
}
