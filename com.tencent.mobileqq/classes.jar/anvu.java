  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private aocj jdField_a_of_type_Aocj = new anvz(this);
  public aodj a;
  private bmkd jdField_a_of_type_Bmkd;
  ...
  public anvu(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Aodj = new aodj(paramQQAppInterface);
    this.jdField_a_of_type_Dk = new dk(paramQQAppInterface);
    this.jdField_a_of_type_Dc = new dc(paramQQAppInterface);
    this.jdField_c_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296770);
    this.jdField_d_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296769);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new anvv(this);
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new anvx(this, paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new anvy(this);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Aocj);
    this.jdField_a_of_type_Bmkd = new bmkd(paramQQAppInterface);
    f();
    g();
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2, int paramInt4)
  {
    ...
    localbcsd.jdField_a_of_type_Int = paramInt2;
    localbcsd.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, localbcsd, l, bcsa.b(paramLong1), paramLong2);
  ...
  private void a(int paramInt, long paramLong, String paramString)
  {
    ...
    localDataLineMsgRecord.md5 = bhml.a(paramString);
    if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
      QLog.d("DataLineHandler", 4, "SessionUpdateType_FileMD5, uSessionID[" + paramLong + "], strValuebuf[" + paramString + "], strMD5MR[" + bhml.a(localDataLineMsgRecord.md5) + "], strMD5Notify" + paramString);
    }
    this.app.a().a(i).a(localDataLineMsgRecord.msgId, localDataLineMsgRecord.serverPath, localDataLineMsgRecord.md5);
  }
  ...
  private void a(int paramInt1, DataLineMsgRecord paramDataLineMsgRecord, int paramInt2)
  {
    ...
    if (paramDataLineMsgRecord.isSend()) {
      if (paramInt2 == 2)
      {
        ...
        if ((paramDataLineMsgRecord.nSessionState == 2) && (auog.a(paramDataLineMsgRecord.path))) {
          this.app.a().a(paramInt1).b(paramDataLineMsgRecord.msgId, paramDataLineMsgRecord.path);
        }
        bdll.b(this.app, "CliOper", "", "", "0X8006223", "0X8006223", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
      {
        ...
        bdll.b(this.app, "CliOper", "", "", "0X8006224", "0X8006224", 0, 0, "", "", "", "");
      }
      else
      {
        paramDataLineMsgRecord.fileMsgStatus = 0L;
        ...
        if (paramInt2 == 2)
        {
          ...
          String str = aunz.a(paramDataLineMsgRecord.path);
          if (str != null)
          {
            bhmi.d(paramDataLineMsgRecord.path);
            paramDataLineMsgRecord.path = str;
            this.app.a().a(paramInt1).b(paramDataLineMsgRecord.msgId, str);
          }
          this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
          this.app.a().a(paramInt1).a(paramDataLineMsgRecord.msgId);
          this.app.a().a(paramInt1).c();
          bdll.b(this.app, "CliOper", "", "", "0X8006226", "0X8006226", 0, 0, "", "", "", "");
        }
        else if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
        {
          ...
          this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
          this.app.a().a(paramInt1).b(paramDataLineMsgRecord.msgId);
          bdll.b(this.app, "CliOper", "", "", "0X8006227", "0X8006227", 0, 0, "", "", "", "");
        }
        else
        {
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      {
        ((bedn)this.app.getManager(305)).a(localDataLineMsgRecord, i);
        return;
      }
  ...
  private void a(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      for (;;)
      {
        ...
        if ((paramBoolean) && (paramNFCInfo.nSessionState != 1) && ((!paramNFCInfo.isSend()) || (!aunj.b(paramNFCInfo.path)))) {
          a(paramNFCInfo.path);
        }
        if (!paramSession.bSend) {
          break label676;
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.a().a().a(paramWeiYunFileInfo, new anvw(this, l));
  }
  
  private void a(ToServiceMsg paramToServiceMsg)
  {
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), anwc.class);
    ...
    if (this.jdField_a_of_type_Int == 0) {
      while (i < localStringBuffer.length())
      {
        ...
        if (localStringBuffer.charAt(i) == '\024')
        {
          ...
          {
            k = asle.a(localStringBuffer.charAt(i + 1));
            j = i;
            if (k >= 0)
            {
  ...
  private void b(List<SubMsgType0x7.MsgBody.MoloNotify> paramList)
  {
    ...
    for (;;)
    {
      ...
      localDataLineMsgRecord.fileMsgStatus = 1L;
      bool = bhnv.h(BaseApplication.getContext());
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    paramToServiceMsg.path = (antf.bp + paramToServiceMsg.filename);
  ...
  private void e(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (bhmi.b(paramDataLineMsgRecord.thumbPath));
      str = aunj.a(str, 384, 384);
  ...
  public void GetThumbFilePath(int paramInt, Session paramSession)
  {
    ...
    Object localObject = (aogj)this.app.a(10);
    if ((localObject != null) && (((aogj)localObject).a() == 0))
    {
  ...
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    if (paramSession.bSend)
    {
      bdll.b(this.app, "CliOper", "", "", "0X8006222", "0X8006222", 0, 0, "", "", "", "");
      if ((paramSession.actionInfo != null) && (paramSession.actionInfo.strServiceName != null) && (paramSession.actionInfo.strServiceName.length() != 0)) {
        break label210;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      a(paramSession);
      return;
      bdll.b(this.app, "CliOper", "", "", "0X8006225", "0X8006225", 0, 0, "", "", "", "");
      break;
      label199:
  ...
  public bmkd a()
  {
    return this.jdField_a_of_type_Bmkd;
  }
  ...
  public Session a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      localSession.strFilePathSrc = aunz.c(localDataLineMsgRecord.path);
      ...
      if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
        QLog.d("DataLineHandler", 4, "getSessionFromMsgRecord, uSessionID[" + localDataLineMsgRecord.sessionid + "], strMR[" + bhml.a(localDataLineMsgRecord.md5) + "], filesize[" + localDataLineMsgRecord.filesize);
      }
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x345 paramMsgCSBody0x345)
  {
    ...
    for (localObject = arrayOfByte;; localObject = createToServiceMsg("GTalkFileAppSvr.CMD_DISCUSS_FILE", null))
    {
      ...
      if (localObject != null)
      {
        ...
        bhvd.a(arrayOfByte, 0, paramMsgCSBody0x345.length + 4);
        bhvd.a(arrayOfByte, 4, paramMsgCSBody0x345, paramMsgCSBody0x345.length);
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x346 paramMsgCSBody0x346)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bhvd.a((byte[])localObject2, 0, paramMsgCSBody0x346.length + 4);
        bhvd.a((byte[])localObject2, 4, paramMsgCSBody0x346, paramMsgCSBody0x346.length);
        paramMsgCSBody0x346 = (MsgCSBody0x346)localObject1;
  ...
  public Long a(String paramString, int paramInt)
  {
    ...
    localDataLineMsgRecord.issuc = false;
    ((aogu)this.app.a(13)).a(localDataLineMsgRecord);
          ...
          default: 
            ...
            if (i == 1)
            {
              ...
              if (i < begd.a.length)
              {
                ...
                if (paramGenericSubCmd.indexOf('\024' + begd.a[i]) == -1) {
                  break label714;
                }
                paramMsgHeader = paramGenericSubCmd.replace('\024' + begd.a[i], "\024" + (char)i);
                break label714;
              }
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = auog.a(auog.a(this.app.getApplication()), aunj.a(paramFileManagerEntity.strThumbPath));
      bhmi.d(paramFileManagerEntity.strThumbPath, localDataLineMsgRecord.thumbPath);
    }
    ...
    Object localObject = (anvu)this.app.a(8);
    localDataLineMsgRecord.sessionid = ((anvu)localObject).a(0, 0).longValue();
    localDataLineMsgRecord.msg = "";
    localDataLineMsgRecord.issend = 1;
    localDataLineMsgRecord.isread = true;
    localDataLineMsgRecord.issuc = false;
    ...
    ((anvu)localObject).a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.a().a(DataLineMsgRecord.getDevTypeBySeId(localDataLineMsgRecord.sessionid)).a(localDataLineMsgRecord, true);
    localanvu.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getServiceCmd().equals("MessageSvc.PbSendMsg"))
    {
      ...
      axga.a().a(paramToServiceMsg, paramFromServiceMsg, paramObject);
    }
    label72:
  ...
  {
    this.jdField_a_of_type_Bmkd.a(paramMsg);
  }
  
  public void a(msg_comm.Msg paramMsg, SubMsgType0x7.MsgBody paramMsgBody)
  {
    this.jdField_a_of_type_Bmkd.a(paramMsg, paramMsgBody);
    DataLineMsgRecord localDataLineMsgRecord;
    try
    {
      localDataLineMsgRecord = new DataLineMsgRecord();
    ...
    localObject = (aogj)this.app.a(10);
    if ((localObject != null) && (((aogj)localObject).d() != 1)) {
      ((aogj)localObject).e(1);
    }
  ...
  public void a(msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    this.jdField_a_of_type_Aodj.a(this, paramMsg, paramMsgBody);
  }
  ...
  public boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    for (;;)
    {
      ...
      bhvd.a(arrayOfByte, 0, localObject2.length + 4);
      bhvd.a(arrayOfByte, 4, (byte[])localObject2, localObject2.length);
      if (localObject1 != null)
      {
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    bhvd.a(arrayOfByte, 0, paramFromServiceMsg.getWupBuffer(), 4, j);
    label390:
  ...
  public void d()
  {
    long l = this.app.a().a(String.valueOf(antf.z), 6000).time;
    ...
    if ((l != 0L) && (l != this.jdField_c_of_type_Long))
    {
      ...
      ((aczw)this.app.a().a("c2c_processor")).a(localArrayList);
      this.jdField_c_of_type_Long = l;
    }
    l = this.app.a().a(String.valueOf(antf.A), 6003).time;
  ...
  public void onDestroy()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if ((this.app != null) && (this.app.getApp() != null) && (this.jdField_a_of_type_Aocj != null))
        {
        ...
        this.jdField_a_of_type_Bmkd.a();
        this.jdField_a_of_type_Dg.a();
        this.jdField_a_of_type_Aodj.a();
  ...
  {
    this.jdField_a_of_type_Bmkd.a(paramToServiceMsg, paramFromServiceMsg, (byte[])paramObject);
