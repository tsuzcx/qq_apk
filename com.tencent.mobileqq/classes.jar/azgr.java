...
{
  public azgr(TroopBarPublishActivity paramTroopBarPublishActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBoolean)
    {
      ...
      bcpw.a(localTroopBarPublishActivity, 1, paramBundle, 0).b(this.a.getTitleBarHeight());
      if (this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar != null) {
        break label800;
      }
      paramBundle = "0";
      bair.a("pub_page", "fail", paramBundle, "4", TroopBarPublishActivity.b(this.a), "");
      ...
      if (!TextUtils.isEmpty(bair.a(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText))) {
      ...
      if (this.a.h) {
        if (!TextUtils.isEmpty(bair.a(this.a.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText)))
        {
    ...
    {
      axqw.b(null, "P_CliOper", "Grp_tribe", "", "pub_page", "suc", paramInt, 0, paramBundle, this.a.jdField_b_of_type_JavaLangString, localStringBuffer.toString(), "");
      this.a.e = true;
      ...
      for (;;)
      {
        bbkg.a(this.a.app, "share_suc", paramBundle);
        if (this.a.jdField_a_of_type_Azaj != null) {
          this.a.u();
        }
        if ((this.a.jdField_a_of_type_Azcq != null) && (!TroopBarPublishActivity.a(this.a).equals("###...^_^###"))) {
          axqw.b(null, "dc00899", "Grp_tribe", "", "pub_page", "sus_prefixpub", 0, 0, this.a.q, "", "", "");
        }
