...
public class azgr
{
  ...
  public static boolean a(AppInterface paramAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, String paramString15, String paramString16, String paramString17, String paramString18, String paramString19, String paramString20, String paramString21, bkjx parambkjx)
  {
    if (QLog.isColorLevel()) {
    ...
    for (int j = 1;; j = 0)
    {
      if (parambkjx != null)
      {
        parambkjx.jdField_a_of_type_Boolean = "1".equals(parambkjx.jdField_a_of_type_JavaLangString);
        parambkjx.jdField_b_of_type_Boolean = "1".equals(parambkjx.jdField_b_of_type_JavaLangString);
        parambkjx.c = "1".equals(parambkjx.e);
        parambkjx.d = "1".equals(parambkjx.f);
      }
      if (axld.a()) {
        break label406;
      }
    ...
    label406:
    paramAppInterface = bkjy.a(bool1, bool2, i, bool3, bool4, bool6, paramString7, paramString8, bool5, bool7, paramString11, paramString12, j, paramString15, paramString16, paramString17, paramString18, paramString19, paramString20, paramString21, parambkjx);
  ...
  public static boolean c(AppInterface paramAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        return false;
        if (azgk.a(BaseApplicationImpl.getContext()) == 1) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d(jdField_a_of_type_JavaLangString, 2, "ispublicResReady iissupportFilterSo is false");
