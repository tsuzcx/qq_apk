...
public class azgr
{
  ...
  public azgr(azgq paramazgq)
  {
    this.jdField_a_of_type_JavaLangString = paramazgq.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramazgq.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramazgq.jdField_a_of_type_Int;
    this.d = paramazgq.jdField_b_of_type_Int;
    this.e = paramazgq.jdField_c_of_type_Int;
    if (paramazgq.jdField_b_of_type_Boolean)
    {
      this.jdField_a_of_type_Long = paramazgq.d;
      this.jdField_a_of_type_ArrayOfByte = a(paramazgq.jdField_c_of_type_Long);
      this.jdField_b_of_type_Long = paramazgq.jdField_b_of_type_Long;
      this.jdField_b_of_type_ArrayOfByte = a(paramazgq.jdField_a_of_type_Long);
      return;
    }
    this.jdField_a_of_type_Long = paramazgq.jdField_b_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = a(paramazgq.jdField_a_of_type_Long);
  }
