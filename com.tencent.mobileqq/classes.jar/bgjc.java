  ...
  extends bgix
{
  ...
  bgjc()
  {
    this.jdField_a_of_type_Bfuz = new bgjd(this);
  }
  
  private static void a(bbac parambbac, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      bgku.a(Integer.valueOf(i), Long.valueOf(parambbac.a().getLongAccountUin()));
      return;
    }
  ...
  public static void a(CustomWebView paramCustomWebView)
  {
    try
    {
      ...
      paramCustomWebView.setTag(2131308840, Boolean.FALSE);
      paramCustomWebView.setTag(2131308843, Boolean.FALSE);
      return;
    }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(bfuw.a(i, str1, str2, paramVarArgs)))
      {
        a(str2, 0, "success");
        return;
      }
      ...
      do
      {
        paramVarArgs = this.jdField_a_of_type_Bfuz;
        break;
  ...
  private void b()
  {
    ...
    try
    {
      ...
      localCustomWebView.setTag(2131308843, Boolean.TRUE);
    ...
    Object localObject2 = localException.getTag(2131308840);
  ...
  private static void b(bbac parambbac, String... paramVarArgs)
  {
    int j = 0;
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        new HashMap();
        localObject = bgku.a(Long.valueOf(parambbac.a().getLongAccountUin()));
        i = j;
      ...
      bgku.a((Map)localObject, Long.valueOf(parambbac.a().getLongAccountUin()));
      return;
      label190:
      i += 1;
    }
  ...
  private static void c(bbac parambbac, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    }
    try
    {
      ...
      bfpr.a(parambbac.a(), bfpy.a(), localIntent);
      return;
    }
    catch (JSONException parambbac)
    {
  ...
  private void c(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        localObject2 = new bfvf();
        ((bfvf)localObject2).jdField_a_of_type_Int = i;
        ((bfvf)localObject2).jdField_a_of_type_JavaLangString = bfvf.a(i, paramVarArgs, (String)localObject1, str1, str2, j);
        bfuw.a(l, (bfvf)localObject2);
        ...
        bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bfpy.a(), paramVarArgs);
        if (i > 0)
        {
          bfuw.a(l, null);
          bfuw.a(l, null);
  ...
  private static void d(bbac parambbac, String... paramVarArgs)
  {
    int i = 0;
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {}
    for (;;)
        ...
        if (((JSONObject)localObject).getInt("success") == 1)
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length() > 0))
          {
            if ((((JSONObject)localObject).has("toast")) && (((JSONObject)localObject).getBoolean("toast"))) {
              bbmy.a(parambbac.a(), 2, 2131624061, 0).a();
            }
            ...
            parambbac.a().setResult(-1, paramVarArgs);
            parambbac.a().finish();
            return;
          }
        }
  ...
  private void d(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        bfvh localbfvh = new bfvh();
        localbfvh.jdField_a_of_type_Int = i;
        localbfvh.jdField_a_of_type_JavaLangString = paramVarArgs;
        bfuw.a(l, localbfvh);
        if (i > 0)
        {
          bfuw.a(l, null);
  ...
  private void e(bbac parambbac, String... paramVarArgs)
  {
    Intent localIntent = new Intent("action_personalize_js2qzone");
    Bundle localBundle = new Bundle();
    ...
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0)) {
      for (;;)
      {
        ...
        try
        {
          ...
          i = localbfvg.jdField_a_of_type_Int;
        }
        ...
        continue;
        label194:
        int i = localbfvh.jdField_a_of_type_Int;
        continue;
        label203:
        i = localbfvf.jdField_a_of_type_Int;
      }
    }
  }
  ...
  private void f(String... paramVarArgs)
  {
    try
    {
      ...
      localIntent.putExtras(localBundle);
      bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bfpy.a(), localIntent);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void g(String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        {
          bfpr.a(((BasePluginActivity)localActivity).getOutActivity(), paramArrayOfString, -1, null, null);
          return;
        }
        bfpr.a(localActivity, paramArrayOfString, -1, null, null);
        return;
      }
      if ((localActivity instanceof BasePluginActivity))
      {
  ...
  private void h(String[] paramArrayOfString)
  {
    try
    {
      ...
      if (bool)
      {
        ...
        bgbz.a().a("cmd.getYellowDiamondRedPocket", localBundle, false);
      }
      return;
    }
    catch (Exception paramArrayOfString)
  ...
  private void j(String[] paramArrayOfString)
  {
    try
    {
      ...
      bgbz.a().a("cmd.setResponsiveLike", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
  ...
  private void k(String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      bgbz.a().a("cmd.setDIYData", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
  ...
  private void l(String[] paramArrayOfString)
  {
    try
    {
      ...
      bgbz.a().a("cmd.setCustomTrack", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      bgky.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
      return true;
    }
    if (paramString3.equals("SetPersonalizeFinished"))
    {
      bgkv.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
      return true;
    }
    if (paramString3.equals("openNameplateSucc"))
    {
      bgkr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
      return true;
    }
    ...
    {
      bgbz.a().a("cmd.refeshDecoCustom", null, false);
      return true;
    }
