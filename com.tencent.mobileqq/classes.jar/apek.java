...
public class apek
{
  ...
  public long a;
  private apel jdField_a_of_type_Apel = new apel();
  ...
  public apel a(int paramInt1, int paramInt2)
  {
    if (this.jdField_f_of_type_Boolean)
    {
      ...
      ((apel)localObject2).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((apel)localObject2).a("CAMERA_MATRIX", arrayOfFloat2);
      ((apel)localObject2).a("CAMERA_POSITION", localObject1);
      ((apel)localObject2).a("POSE", arrayOfFloat1);
      return localObject2;
    }
    if (paramInt1 == 100)
    {
      ...
      ((apel)localObject2).a("CAMERA_POSITION", localObject1);
      ((apel)localObject2).a("POSE", arrayOfFloat1);
      ((apel)localObject2).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject2;
    }
    if (paramInt1 == 8)
    {
      ...
      Matrix.setIdentityM(arrayOfFloat1, 0);
      ((apel)localObject1).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((apel)localObject1).a("CAMERA_MATRIX", localObject2);
      ((apel)localObject1).a("CAMERA_POSITION", arrayOfFloat1);
      ((apel)localObject1).a("POSE", arrayOfFloat2);
      ((apel)localObject1).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject1;
    }
    ...
    if ((this.jdField_h_of_type_Boolean) && (((paramInt2 == 0) && (!this.jdField_c_of_type_Boolean)) || (paramInt2 == 2) || ((paramInt2 == 1) && (!this.jdField_d_of_type_Boolean))))
    {
      ...
      localapel = new apel();
      localapel.a("TARGET_SIZE", localObject1);
      localapel.a("CAMERA_MATRIX", localObject2);
      localapel.a("CAMERA_POSITION", arrayOfFloat1);
      localapel.a("POSE", arrayOfFloat2);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Apel.a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
    this.jdField_a_of_type_Apel.a("POSE", arrayOfFloat1);
    this.jdField_a_of_type_Apel.a("CAMERA_MATRIX", arrayOfFloat2);
    this.jdField_a_of_type_Apel.a("CAMERA_POSITION", arrayOfFloat3);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
  }
  
  public void a(int paramInt1, int paramInt2, aphz paramaphz)
  {
    ...
    float f3;
    if (paramInt2 == 0) {
      if ((paramaphz.jdField_a_of_type_Int == 0) || (paramaphz.jdField_b_of_type_Int == 0))
      {
        this.k[0] = appa.jdField_a_of_type_Int;
        this.k[1] = appa.jdField_b_of_type_Int;
        paramaphz = new float[jdField_a_of_type_Int];
        Matrix.setIdentityM(paramaphz, 0);
        Matrix.perspectiveM(paramaphz, 0, 45.0F, 1.0F * appa.jdField_b_of_type_Int / appa.jdField_a_of_type_Int, 100.0F, 8000.0F);
        float[] arrayOfFloat = new float[16];
        Matrix.setRotateM(arrayOfFloat, 0, 270.0F, 0.0F, 0.0F, 1.0F);
        Matrix.multiplyMM(this.l, 0, arrayOfFloat, 0, paramaphz, 0);
        if (paramInt2 != 0) {
          break label659;
        }
        f1 = 1.25F;
        if (this.k[0] <= appa.jdField_a_of_type_Int) {
          break label665;
        }
        f2 = this.k[0];
        if (this.k[0] == 0.0F) {
        ...
        f3 = this.k[1] / this.k[0] / (1.0F * appa.jdField_b_of_type_Int / appa.jdField_a_of_type_Int);
        label233:
        if ((f3 <= 1.0F) || (this.k[1] <= appa.jdField_b_of_type_Int)) {
          break label680;
        }
        f1 *= f3;
      }
    ...
    for (;;)
    {
      ...
      paramaphz = new float[jdField_a_of_type_Int];
      Matrix.setIdentityM(paramaphz, 0);
      Matrix.translateM(paramaphz, 0, this.k[1] / 2.0F, -this.k[0] / 2.0F, -f2 / 2.0F * 2.414214F * f1);
      Matrix.rotateM(paramaphz, 0, 90.0F, 0.0F, 0.0F, 1.0F);
      System.arraycopy(paramaphz, 0, this.m, 0, jdField_a_of_type_Int);
      ...
      System.arraycopy(this.n, 0, this.j, 0, jdField_a_of_type_Int);
      return;
      this.k[0] = paramaphz.jdField_a_of_type_Int;
      this.k[1] = paramaphz.jdField_b_of_type_Int;
      break;
  ...
  public void a(apei paramapei)
  {
    ...
    paramapei = (apeg)paramapei;
    this.jdField_c_of_type_Int = paramapei.jdField_a_of_type_Int;
    this.jdField_g_of_type_ArrayOfFloat[0] = paramapei.jdField_a_of_type_Float;
    this.jdField_g_of_type_ArrayOfFloat[1] = paramapei.jdField_b_of_type_Float;
    System.arraycopy(paramapei.jdField_b_of_type_ArrayOfFloat, 0, this.jdField_h_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    System.arraycopy(paramapei.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_i_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
    System.arraycopy(paramapei.jdField_a_of_type_ArrayOfFloat, 0, this.j, 0, jdField_a_of_type_Int);
  }
  
  public void a(boolean paramBoolean, apeh paramapeh)
  {
    QLog.i("AREngine_ARRenerArumentManager", 1, "start. trackMode = " + paramapeh.jdField_b_of_type_Int + ", arType = " + paramapeh.jdField_a_of_type_Int + ", isObjectAnim = " + paramBoolean);
    this.jdField_f_of_type_Boolean = paramBoolean;
    this.jdField_b_of_type_Int = paramapeh.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramapeh.jdField_c_of_type_Int;
    this.jdField_h_of_type_Boolean = false;
    if ((this.jdField_f_of_type_Boolean) || (paramapeh.jdField_a_of_type_Int == 100) || (paramapeh.jdField_a_of_type_Int == 8))
    {
      this.jdField_g_of_type_Boolean = true;
      return;
    }
    Object localObject;
    if (paramapeh.jdField_a_of_type_Int == 0)
    {
      localObject = (apet)paramapeh;
      a(this.jdField_b_of_type_Int, paramapeh.jdField_a_of_type_Int, ((apet)localObject).a);
    }
    for (;;)
    {
      this.jdField_g_of_type_Boolean = true;
      return;
      if ((paramapeh.jdField_a_of_type_Int == 2) || (paramapeh.jdField_a_of_type_Int == 3))
      {
        localObject = (apfc)paramapeh;
        a(this.jdField_b_of_type_Int, paramapeh.jdField_a_of_type_Int, ((apfc)localObject).a);
      }
      else if (paramapeh.jdField_a_of_type_Int == 4)
      {
        localObject = (apff)paramapeh;
        a(this.jdField_b_of_type_Int, paramapeh.jdField_a_of_type_Int, ((apff)localObject).a);
      }
    }
  }
