...
public class awon
{
  static awop jdField_a_of_type_Awop;
  ...
  {
    if (jdField_a_of_type_Awop == null)
    {
      ...
      paramString1.start();
      jdField_a_of_type_Awop = new awop(paramString1.getLooper());
      jdField_a_of_type_Awop.sendEmptyMessageDelayed(1, paramLong);
      if (BaseApplicationImpl.sProcessId == 1) {
        jdField_a_of_type_Awop.sendEmptyMessageDelayed(2, paramLong);
      }
    }
  }
  ...
  static void b(long paramLong)
  {
    ...
    for (;;)
    {
      i += 1;
      break;
      localArrayList.add(new awoo(localObject2.lastModified(), localObject2.length(), localObject2.getPath()));
      ...
      if (l1 > 104857600L)
      {
        ...
        {
          localObject1 = new File(((awoo)localArrayList.remove(0)).a());
