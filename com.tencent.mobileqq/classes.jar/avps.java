  ...
  implements Manager
{
  ...
  public avps(AppInterface paramAppInterface)
  {
  ...
  public static String a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    StringBuilder localStringBuilder = actj.a().append(paramAppInfo.path.get()).append(":");
  ...
  {
    if (paramInt == 6) {
      bhem.a().a(paramAppInfo, 102);
    }
    while (paramInt != 1) {
      return;
    }
    bhem.a().a(paramAppInfo, 101);
  }
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, int paramInt, String paramString1, boolean paramBoolean, List<Long> paramList, List<String> paramList1, String paramString2)
  {
    ...
    localReportReqBody.clientver.set("8.3.0.4480");
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      setChanged();
      if (i != 0) {
        akfh.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      }
      return;
      ...
      try
      {
        ...
        if ((localTimeRspBody != null) && (localTimeRspBody.rptMsgAppInfo.has()))
        {
          ...
          if (i < localTimeRspBody.rptMsgAppInfo.size())
          {
            ...
            localObject = (axbv)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(12);
            if (localObject != null) {
              ((axbv)localObject).a(paramString);
            }
          }
        }
        a(localTimeRspBody);
  ...
  private int b(String paramString, int paramInt)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 35	avps:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: aload_1
    ...
    //   20: ireturn
    //   21: aload_0
    //   22: invokevirtual 78	avps:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   25: astore 6
    //   27: iload 4
    //   29: istore_3
    //   30: aload 6
    ...
    //   61: ifnonnull +19 -> 80
    //   64: ldc 188
    //   66: invokestatic 52	avps:a	(Ljava/lang/String;)V
    //   69: aload 5
    //   71: monitorexit
    //   72: iconst_0
    //   73: ireturn
  ...
  private void b(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      axqy.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00899", "Grp_tribe", "", "dynamic", "Clk_tribe", 0, 0, i + "", "", "", "");
      ...
      a(pot.a("OidbSvc.0xd40_0", 3392, 0, paramAppInfo.toByteArray()));
      return;
    }
  }
  ...
  private void c()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        try
        {
          byte[] arrayOfByte = bbdx.a(localFile);
          if (arrayOfByte != null) {
            break;
          }
  ...
  private void d()
  {
    ...
    {
      ((akfh)((QQAppInterface)localObject).a(87)).a(true, true);
      return;
    }
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo a(QQAppInterface paramQQAppInterface, boolean paramBoolean, Map<Long, LebaPluginInfo> paramMap)
  {
    ...
    for (;;)
    {
      ...
      else if (!ajzo.a(paramQQAppInterface, ((BusinessInfoCheckUpdate.AppInfo)localObject5).uiAppId.get(), paramBoolean, paramMap))
      {
    ...
    if (paramArrayOfByte != null) {
      try
      {
        ...
        while (paramArrayOfByte.hasNext())
        {
          ...
          if ((a((Submsgtype0x89.NumRedBusiInfo)localObject)) && (avpv.a((Submsgtype0x89.NumRedBusiInfo)localObject))) {
  ...
  {
    ((avpo)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(65)).a(paramArrayOfLong, paramString, paramavpn);
  }
  ...
  public boolean a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	avps:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   4: invokevirtual 138	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   7: astore 5
    //   9: aload_0
    //   10: getfield 35	avps:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 4
    //   15: aload 4
    //   17: monitorenter
    //   18: aload_1
    ...
    //   24: aload 4
    //   26: monitorexit
    //   27: getstatic 30	avps:b	Ljava/lang/Object;
    //   30: astore 4
    //   32: aload 4
    //   34: monitorenter
    //   35: getstatic 25	avps:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   38: invokevirtual 1095	java/util/concurrent/atomic/AtomicInteger:incrementAndGet	()I
    //   41: istore_2
    //   42: new 676	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: getfield 37	avps:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   83: aload 6
    //   85: iconst_0
    //   86: invokestatic 1101	bbdx:a	(Ljava/lang/String;[BZ)Z
    //   89: istore_3
    //   90: iload_3
    //   91: ifeq +91 -> 182
    //   94: getstatic 1104	axbv:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload 5
    //   99: iconst_0
    ...
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 35	avps:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   114: astore 4
    //   116: aload 4
    //   118: monitorenter
    //   119: iload_3
    //   120: ifeq +18 -> 138
    //   123: iload_2
    //   124: getstatic 25	avps:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   127: invokevirtual 1113	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   130: if_icmpne +8 -> 138
    //   133: aload_0
    //   134: aload_1
    //   135: invokespecial 1115	avps:b	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;)V
    //   138: aload 4
    //   140: monitorexit
    //   141: iload_3
    //   142: ireturn
  ...
  public boolean b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	avps:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_3
    //   5: aload_3
    //   6: monitorenter
    //   7: iload_1
    ...
    //   14: ireturn
    //   15: aload_0
    //   16: invokevirtual 78	avps:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnonnull +7 -> 30
    //   26: aload_3
