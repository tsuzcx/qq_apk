...
public class xde
  implements View.OnClickListener, bcms
{
  protected Dialog a;
  ...
  @TargetApi(11)
  public xde(TroopGiftPanel paramTroopGiftPanel, Context paramContext)
  {
    ...
    this.b = ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131364616));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131363858));
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_AndroidWidgetEditText.setCustomSelectionActionModeCallback(new xdf(this, paramTroopGiftPanel));
    }
    this.jdField_a_of_type_AndroidWidgetEditText.setOnEditorActionListener(new xdg(this, paramTroopGiftPanel));
    this.b.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    paramContext.setOnClickListener(new xdh(this, paramTroopGiftPanel));
  }
  
  public void a()
  {
    this.jdField_a_of_type_AndroidAppDialog.setOnShowListener(new xdi(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFilters(new InputFilter[] { new xdd(this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel, 5) });
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.jdField_a_of_type_Xdl.a();
    }
    for (;;)
    {
  ...
  {
    if (mye.a().a(this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a())) {}
    for (int i = 2;; i = 1) {
    ...
    if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.k >= 4)
    {
      akbk.a("gift_store", "sure_num", this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a(), this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a() + "", "", "");
      return;
    }
