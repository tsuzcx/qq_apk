...
public class also
{
  private static also jdField_a_of_type_Also;
  public static final String a;
  public static final String b;
  private static boolean jdField_b_of_type_Boolean;
  public static final String c;
  private static final String d = alrs.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  private static final String e = d + "SKINCOLOR" + File.separator;
  private int jdField_a_of_type_Int;
  private alss jdField_a_of_type_Alss;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alrs.jdField_a_of_type_JavaLangString + "/qsvf" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lbd.f("VideoFilterTools", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lbd.f("VideoFilterTools", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  
  public static also a()
  {
    if (jdField_a_of_type_Also == null) {
      jdField_a_of_type_Also = new also();
    }
    return jdField_a_of_type_Also;
  }
  
  private static alst a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lbd.f("VideoFilterTools", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localalst = new alst(i, str1, str2);
        try
        {
          lbd.f("VideoFilterTools", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localalst;
        }
      ...
      try
      {
        ...
        lbd.f("VideoFilterTools", "parseConfig failed. info = " + localJSONObject);
        return localalst;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lbd.f("VideoFilterTools", "parseConfig|parse failed.context = " + paramString);
        return localalst;
      }
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      lbd.f("VideoFilterTools", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  {
    lbd.f("VideoFilterTools", "setQQShortVideoFilterConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lbd.f("VideoFilterTools", "updateQQShortVideoFilterConfig error ");
      return;
    }
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        lbd.f("VideoFilterTools", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lbd.f("VideoFilterTools", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                lbd.f("VideoFilterTools", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  {
    if (paramString == null) {
      lbd.f("VideoFilterTools", "handleQQSvCommonConfig empty content!");
    }
    do
    {
      for (;;)
      ...
      try
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            lbd.f("VideoFilterTools", "parseConfig:" + k + "|" + m + "|" + n + "|" + str5 + "|" + str1 + "|" + str4 + "|" + str2 + "|" + str3);
            i += 1;
          }
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lbd.f("VideoFilterTools", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = llq.e();
    if (paramInt2 < paramInt1)
    {
      lbd.f("VideoFilterTools", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = llq.d();
    if (l < paramLong1)
    {
      lbd.f("VideoFilterTools", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = DeviceInfoUtil.getSystemTotalMemory();
    if (paramLong1 < paramLong2)
    {
      lbd.f("VideoFilterTools", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lbd.f("VideoFilterTools", "getVideoEffectBeautyConfig:" + d + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return FileUtils.readFileToString(localFile);
      }
      b(paramContext, 0);
  ...
  public static void b(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lbd.f("VideoFilterTools", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new HttpNetReq();
          ((HttpNetReq)localObject).mCallback = new alsq();
  ...
  {
    lbd.f("VideoFilterTools", "setVideoEffectBeautyConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static boolean b(Context paramContext)
  {
    ...
    lbd.f("VideoFilterTools", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  public FilterRender a(int paramInt1, int paramInt2)
  {
    ...
    {
      lbd.f("VideoFilterTools", "getFilter|init texture.");
    ...
    {
      lbd.f("VideoFilterTools", "getFilterRender|destroy current filterRender.");
  ...
  public List<FilterDesc> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        lbd.f("VideoFilterTools", "getFilterDescs " + str1 + " exist: " + bool);
        if (bool)
        {
          ...
          lbd.f("VideoFilterTools", "getFilterDescs " + str2 + " exist: " + bool);
    ...
    while (((Iterator)???).hasNext())
    {
      ...
      lbd.f("VideoFilterTools", "getFilterDescs " + (String)localObject3 + " exist: " + bool);
      if (bool)
      {
  ...
  public void a()
  {
    this.jdField_a_of_type_Alss = null;
    if (this.jdField_c_of_type_Int != -1) {
      this.jdField_c_of_type_Int = -1;
    }
    if (this.jdField_a_of_type_ArrayOfInt[0] != -1) {
  ...
  public void a(Context paramContext, alss arg2)
  {
    if (QLog.isColorLevel()) {
      com.tencent.av.video.effect.QavVideoEffect.DEBUG_MODE = true;
    }
    lbd.f("VideoFilterTools", "init");
    if (this.jdField_a_of_type_JavaUtilArrayList == null) {
      this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    }
    this.jdField_a_of_type_Alss = ???;
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      a(a(paramContext), this.jdField_a_of_type_JavaUtilArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList);
      lbd.f("VideoFilterTools", "filter list size:" + this.jdField_a_of_type_JavaUtilArrayList.size());
  ...
  void a(List<FilterDesc> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      lbd.f("VideoFilterTools", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      lbd.f("VideoFilterTools", "preDownloadResource list size: " + paramList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        FilterDesc localFilterDesc = (FilterDesc)paramList.next();
        lbd.f("VideoFilterTools", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
        if (localFilterDesc.predownload == 1)
        {
          ...
          if (!TextUtils.isEmpty(localFilterDesc.iconurl))
          {
            ...
            lbd.f("VideoFilterTools", "preDownloadResource " + (String)localObject1 + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject2 = new HttpNetReq();
              ((HttpNetReq)localObject2).mCallback = new alsr(this);
          ...
          if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            lbd.f("VideoFilterTools", "preDownloadResource " + (String)localObject1 + "params.json" + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject1 = new HttpNetReq();
              ((HttpNetReq)localObject1).mCallback = new alsp(this);
              ...
              lbf.a().sendReq((NetReq)localObject1);
              this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
            }
          }
        }
      }
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Alss == null));
    this.jdField_a_of_type_Alss.a(false);
  }
  ...
  public void b()
  {
    lbd.f("VideoFilterTools", "destroy");
  ...
  public void c(Context paramContext)
  {
    if (new File(d + "beauty_config.json").exists())
    {
      ...
      {
        lbd.f("VideoFilterTools", "!JasonFile.exists()");
        b(paramContext);
      }
      return;
    }
    lbd.f("VideoFilterTools", "BEAUTY_CONFIG  is not exsit");
  }
