  ...
  extends bmrx<bmrp>
{
  ...
  public bmsi(Context paramContext, FaceListPage paramFaceListPage)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561423, null);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131380035));
      this.b = ((ImageView)localView.findViewById(2131375164));
