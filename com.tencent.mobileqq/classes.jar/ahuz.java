  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("tencent.video.q2v.startUploadPTV".equals(paramContext))
    {
      ...
      case 1: 
        ...
        {
          str = "";
          if (this.a.jdField_a_of_type_Ahwb != null) {
            str = this.a.jdField_a_of_type_Ahwb.a();
          }
    ...
    for (;;)
    {
      ...
      {
        ahub.a("", paramContext, str, "", NewFlowCameraActivity.a(this.a), "");
        if (QLog.isColorLevel()) {
      ...
      if (i == 2)
      {
        ...
        if (bool)
        {
          ...
          axqw.b(null, "dc00898", "", "", "0X8007BB6", "0X8007BB6", 0, 0, "", "", "", "");
