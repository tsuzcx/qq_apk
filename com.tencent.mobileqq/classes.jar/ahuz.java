  ...
  public void a(NetResp paramNetResp)
  {
    ...
    if (paramNetResp.jdField_a_of_type_Int == 0)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.resType == 1) {
        localObject = ScribbleResMgr.b(this.a.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.resType, this.a.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.sourceId);
      }
      if (this.a.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.resType == 2) {
        localObject = ScribbleResMgr.a(this.a.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.sourceId);
      }
      ...
      str1 = ScribbleResMgr.b(this.a.jdField_a_of_type_ComTencentMobileqqScribbleScribbleResMgr$ResInfo.sourceId);
