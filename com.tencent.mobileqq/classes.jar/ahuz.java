...
public class ahuz
{
  ...
  public ahuz(ahuu paramahuu, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new ahva(this, paramahuu));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams = new RelativeLayout.LayoutParams(-1, -1);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.topMargin = paramahuu.a;
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new ahvb(this, paramahuu);
    this.jdField_a_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.3(this, paramahuu);
    this.jdField_b_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.4(this, paramahuu);
  }
  ...
  public boolean a(ahur paramahur, int paramInt)
  {
    this.jdField_a_of_type_Ahur = paramahur;
    this.jdField_b_of_type_Int = paramInt;
    paramahur.itemView.getLocationInWindow(this.jdField_c_of_type_ArrayOfInt);
    paramahur = this.jdField_a_of_type_Ahur.a.getDrawable();
    this.jdField_a_of_type_ComTencentWidgetRoundRectImageView.setImageDrawable(paramahur);
  ...
  void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_Ahur.itemView.clearAnimation();
