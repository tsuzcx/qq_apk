...
{
  public adpk(BaseChatPie paramBaseChatPie) {}
  ...
  public void onLayoutChange(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    ...
    for (;;)
    {
      paramView = (agne)this.a.a(52);
      if ((paramView != null) && (paramView.b()) && (paramInt3 == 0))
      {
        paramInt7 = afur.a(39.0F, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
      ...
      for (paramInt1 = paramInt7;; paramInt1 = paramInt7)
      {
        ...
        label456:
        this.a.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setOnMeasureListener(new adpl(this, paramView, paramInt3, paramInt2, paramInt1 + (paramInt5 + paramInt3)));
        return;
        paramInt7 = 0;
        paramInt5 = paramInt1;
      }
