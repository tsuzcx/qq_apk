...
public class veb
{
  ...
  private she jdField_a_of_type_She = new she();
  ArrayList<bawt> b;
  private ArrayList<ver> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = BaseApplicationImpl.sApplication.getFilesDir() + File.separator + "blessVoiceChange.json";
    jdField_b_of_type_JavaLangString = ajed.aU + "voiceChange/bless/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    a();
  }
  
  public veb(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bawt(k, (String)localObject4, (String)localObject5, 0, j, 1, new bawu(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bawt)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bawt)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bawt)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bawt)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bawt)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bawt)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bawt)localObject5).jdField_a_of_type_Int))) {
          ((bawt)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bawt)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (banq.a(((JSONObject)localObject4).getString("QQVersion"), "8.2.6"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bawt)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bawt)localObject3).d = 1;
            ((bawt)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bawt)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bawt)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bawt)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bawt)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bawt)localObject3).jdField_a_of_type_Bawu.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = balu.jdField_a_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bawt)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bawt)localObject4).jdField_a_of_type_Int))) {
            ((bawt)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bawt)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bawt)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bawt)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bawt)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new vec(this, this.jdField_a_of_type_She, l).executeOnExecutor(Bosses.get().getExecutor(16), new ssi[] { new ssi(str1, str2, null) });
  }
  ...
  public void a(ver paramver)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      if (!localFile.exists()) {
        bace.a(new File((String)localObject1), localFile);
      }
      localObject2 = new baws((String)localObject2, i, 64000, 2, paramver.c);
      bawv.a(BaseApplicationImpl.getContext(), (baws)localObject2, jdField_c_of_type_JavaLangString, new ved(paramver, (String)localObject1), new bawx(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramver.c);
      aeqf.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  protected void b()
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      if (localFile.exists()) {
        bace.a(localFile, new File((String)localObject));
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      {
        bawt localbawt = (bawt)localIterator.next();
        if (localbawt.jdField_b_of_type_Int == 2)
        {
          ver localver = new ver(4, localbawt.jdField_a_of_type_JavaLangString, localbawt.jdField_a_of_type_Bawu.jdField_a_of_type_Int, localbawt.jdField_a_of_type_Int);
          if ((localbawt.jdField_a_of_type_Bawu.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbawt.jdField_a_of_type_Bawu.jdField_a_of_type_JavaLangString))) {
            localver.g = (jdField_b_of_type_JavaLangString + localbawt.jdField_a_of_type_Bawu.jdField_a_of_type_JavaLangString.substring(localbawt.jdField_a_of_type_Bawu.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localver);
        }
      }
    }
