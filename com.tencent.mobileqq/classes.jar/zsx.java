  ...
  implements aabt, SimpleEventReceiver
{
  ...
  private ztb jdField_a_of_type_Ztb;
  ...
  {
    Object localObject = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131559686, paramViewGroup, false);
    paramViewGroup = new zth(this, (View)localObject);
  ...
  private FrameLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setText(anvx.a(2131701006));
  ...
  private void d(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    aanb.b(paramStFeed.poster.id.get(), "auth_follow", "press", 0, 0, new String[0]);
    zzk.b(a(), paramStFeed.poster.id.get(), new zsz(this, paramStFeed));
  }
  ...
  public CertifiedAccountMeta.StFeed a()
  {
    ...
    while (k < a().size())
    {
      ...
      if ((localStFeed != null) && (zqm.a(localStFeed.type.get())))
      {
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed, zyw paramzyw, zyv paramzyv)
  {
    if (paramStFeed == null) {
      return;
    }
    zyr.a(a(), paramStFeed, paramzyw, paramzyv);
  }
  ...
  {
    paramContext = new bluy(paramContext, "subscription", paramString1, paramString2, false, paramArrayList, "", paramInt);
  ...
  {
    a().addOnScrollListener(new zta(this));
  }
  ...
  public void a(String paramString, zos paramzos)
  {
    ...
    if ((paramString.equals("share_key_subscribe_feeds_update")) && (paramzos.jdField_a_of_type_JavaLangObject != null))
    {
      this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed = ((CertifiedAccountMeta.StFeed)paramzos.jdField_a_of_type_JavaLangObject);
      if (paramzos.jdField_a_of_type_Boolean) {
        a();
      }
    }
  }
  ...
  public void a(zoz paramzoz)
  {
    ...
    if ((this.f != -1) && ((paramzoz.c()) || (paramzoz.d()))) {
    ...
    for (;;)
    {
      ...
      {
        return;
        if ((this.f != -1) && (paramzoz.e())) {
          localGetSubscribeFeedListRequest = new GetSubscribeFeedListRequest(this.f, a().b(), a().a(), a().b());
        }
      }
      else
      {
        VSNetworkHelper.getInstance().sendRequest(localGetSubscribeFeedListRequest, new zsy(this, paramzoz));
        return;
      }
  ...
  public void a(ztb paramztb)
  {
    this.jdField_a_of_type_Ztb = paramztb;
  }
  ...
  public void c(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    {
      CertifiedAccountMeta.StFeed localStFeed = (CertifiedAccountMeta.StFeed)a().get(k);
      if ((localStFeed != null) && (zqm.a(localStFeed.type.get())) && (localStFeed.id.get().equals(paramStFeed.id.get())))
      {
        this.jdField_e_of_type_Int = k;
        return;
      }
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((paramViewHolder instanceof zth))
      {
        localStFeed = (CertifiedAccountMeta.StFeed)this.jdField_a_of_type_JavaUtilArrayList.get(k);
        ((zth)paramViewHolder).a(localStFeed);
        ((zth)paramViewHolder).a((zth)paramViewHolder, localStFeed);
      }
      else
      {
        localStFeed = (CertifiedAccountMeta.StFeed)a().get(k);
        ((ztc)paramViewHolder).a(localStFeed, a());
      }
    }
  }
  ...
  {
    if (paramInt == 100000) {
      return new ztc(this, a(paramViewGroup));
    }
    if (paramInt == 1) {
      return new ztc(this, new RelativeAdFeedItemView(paramViewGroup.getContext(), this));
    }
    if (paramInt == 100003) {
      return a(paramViewGroup);
    }
    return new ztc(this, new RelativeFeedItemView(paramViewGroup.getContext()));
  }
}
