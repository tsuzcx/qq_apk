  ...
  implements ITransactionCallback
{
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QIMWebVideoUploader", 2, "<BDH_LOG> Transaction End : Failed. New : SendTotalCost:" + (l - aytr.a(this.a)) + "ms");
    }
    aytr.a(this.a).put("serverip", paramHashMap.get("ip"));
    aytr.a(this.a).put("param_bdhSrv", paramHashMap.get("ip"));
    aytr.a(this.a).put("param_bdhPort", paramHashMap.get("port"));
    aytr.a(this.a).put("X-piccachetime", paramArrayOfByte);
    aytr.a(this.a).put("param_BdhTrans", str1);
    aytr.a(this.a).put("param_segspercnt", str2);
    aytr.a(this.a).put("param_conf_segSize", str3);
    aytr.a(this.a).put("param_conf_segNum", str4);
    aytr.a(this.a).put("param_conf_connNum", str5);
    aytr.a(this.a).put("param_fin_lost", str6);
    aytr.a(this.a).put("param_retry_seg_count", paramHashMap.get("param_retry_seg_count"));
    aytr.a(this.a).put("param_max_retry_times", paramHashMap.get("param_max_retry_times"));
    aytr.a(this.a).put("param_total_retry_times", paramHashMap.get("param_total_retry_times"));
    aytr.a(this.a).put("param_retry_code", paramHashMap.get("param_retry_code"));
    aytr.a(this.a).put("param_heart_resp", paramHashMap.get("param_heart_resp"));
    aytr.a(this.a).put("param_ip_index", paramHashMap.get("param_ip_index"));
    aytr.a(this.a).put("param_Ip_ConnCost", paramHashMap.get("param_Ip_ConnCost"));
    if (TextUtils.equals((CharSequence)paramHashMap.get("param_BDH_Cache_Diff"), String.valueOf(true))) {
      aytr.a(this.a, true);
    }
    aytr.a(this.a, paramInt);
    aytr.c(this.a, "sessionKey or sigSession is null");
    aytr.a(this.a).a(paramInt, aytr.b(this.a));
    aytr.a(this.a, false);
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aytr.a(this.a, paramArrayOfByte);
        aytr.a(this.a).a(paramArrayOfByte);
        if (QLog.isColorLevel()) {
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        String str2;
        String str3;
        aytr.a(this.a).a(i, "mergeFrom respData Exception");
      ...
      aytr.b(this.a, (String)paramHashMap.get("rep_bdhTrans"));
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QIMWebVideoUploader", 2, "<BDH_LOG> Transaction End : Success. New : SendTotalCost:" + (l3 - aytr.a(this.a)) + "ms transInfo:" + aytr.a(this.a));
      }
      aytr.a(this.a).put("serverip", paramHashMap.get("ip"));
      aytr.a(this.a).put("param_bdhSrv", paramHashMap.get("ip"));
      aytr.a(this.a).put("param_bdhPort", paramHashMap.get("port"));
      aytr.a(this.a).put("X-piccachetime", String.valueOf(aytr.a(this.a).mTransReport.timeCost_Cache));
      aytr.a(this.a).put("param_BdhTrans", aytr.a(this.a));
      aytr.a(this.a).put("param_segspercnt", paramArrayOfByte);
      aytr.a(this.a).put("param_conf_segSize", localObject);
      aytr.a(this.a).put("param_conf_segNum", str1);
      aytr.a(this.a).put("param_conf_connNum", str2);
      aytr.a(this.a).put("param_fin_lost", str3);
      aytr.a(this.a).put("param_retry_seg_count", paramHashMap.get("param_retry_seg_count"));
      aytr.a(this.a).put("param_max_retry_times", paramHashMap.get("param_max_retry_times"));
      aytr.a(this.a).put("param_total_retry_times", paramHashMap.get("param_total_retry_times"));
      aytr.a(this.a).put("param_retry_code", paramHashMap.get("param_retry_code"));
      ...
      continue;
      aytr.a(this.a).a(i, "uuid is null");
      continue;
      ...
      aytr.a(this.a).a(i, paramArrayOfByte);
    }
  }
