...
public class mtl
{
  static volatile mtl jdField_a_of_type_Mtl;
  public int a;
  ...
  private mtl(Context paramContext)
  {
    ...
    if (Looper.myLooper() != null) {
      this.jdField_a_of_type_Mtn = new mtn(this);
    }
  ...
  public static mtl a(Context paramContext)
  {
    if (jdField_a_of_type_Mtl == null) {}
    try
    {
      if (jdField_a_of_type_Mtl == null) {
        jdField_a_of_type_Mtl = new mtl(paramContext);
      }
      return jdField_a_of_type_Mtl;
    }
    finally {}
  }
  ...
  private String b()
  {
    ...
    {
      lcg.c("SignalStrengthReport", "getGateway e:" + localException);
    }
    return "";
  }
  ...
  private int g()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          ...
          {
            lcg.c("SignalStrengthReport", "getPingInterval config:" + (String)localObject);
    ...
    {
      lcg.c("SignalStrengthReport", "getPingInterval e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  int a(SignalStrength paramSignalStrength)
  {
    ...
    for (;;)
    {
      ...
      {
        lcg.c("SignalStrengthReport", "getLevelPercentBySignalStrength reflect getLevel e:" + paramSignalStrength);
        return 0;
      }
    }
  }
  ...
  public void a()
  {
    ...
    {
      return;
      lcg.c("SignalStrengthReport", "report start");
    ...
    } while ((this.jdField_a_of_type_Mtn == null) || (this.jdField_a_of_type_AndroidTelephonyTelephonyManager == null));
    this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtn, 256);
  }
  ...
  int b(SignalStrength paramSignalStrength)
  {
    ...
    //   112: invokestatic 148	lcg:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   115: iconst_m1
    //   116: istore_2
    //   117: goto -74 -> 43
    //   120: aload_1
    ...
    //   183: invokestatic 148	lcg:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   186: iconst_m1
    //   187: ireturn
    //   188: iload_2
    //   189: ireturn
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Int = -1;
    if ((this.jdField_a_of_type_Mtn != null) && (this.jdField_a_of_type_AndroidTelephonyTelephonyManager != null)) {
      this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtn, 0);
    }
    ...
    this.jdField_a_of_type_JavaLangString = "";
    lcg.c("SignalStrengthReport", "report stop");
  }
  ...
  public int c()
  {
    ...
    {
      lcg.c("SignalStrengthReport", "getWifiLevelPercent e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  public int d()
  {
    ...
    {
      lcg.c("SignalStrengthReport", "getWifiDbm e:" + localException);
    }
    return -1;
  }
}
