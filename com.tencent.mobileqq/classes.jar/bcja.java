...
public class bcja
  extends ypv
{
  public bcja(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.ResendRspBody paramResendRspBody, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      paramResendRspBody = new bcii(((TroopFileTransferManager.Item)localObject).FileName, this.a.e, 3, 207);
    ...
    else
    {
      ...
      if (!this.a.b((TroopFileTransferManager.Item)localObject)) {
        this.a.jdField_a_of_type_ArrayOfBcjh[2].a(new TroopFileTransferManager.TaskHttpUpload(this.a, (TroopFileTransferManager.Item)localObject));
      }
    }
  }
}
