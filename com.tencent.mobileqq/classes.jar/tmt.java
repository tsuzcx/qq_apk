...
public class tmt
{
  private static Map<String, tmu> a = new ConcurrentHashMap();
  ...
  public static String a(String paramString)
  {
    ...
    try
    {
      localObject = (tmu)a.get(paramString);
      localJSONObject.put("app", "QQ");
      localJSONObject.put("appVersion", "8.4.10");
      localJSONObject.put("businessID", ((tmu)localObject).b);
      localJSONObject.put("os", "android");
      localObject = new JSONObject();
      paramString = tmw.a(paramString, false);
      if (paramString != null)
      {
  ...
  public static tmw a(String paramString)
  {
    if (a.containsKey(paramString))
    {
      paramString = (tmu)a.get(paramString);
      if ((paramString != null) && (paramString.jdField_a_of_type_Tmv != null)) {
        return paramString.jdField_a_of_type_Tmv.a();
      }
    }
    return null;
  }
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      localtmu = (tmu)a.get(paramString1);
    } while (localtmu == null);
    paramString1 = tmw.a(paramString1, true);
    ...
    for (;;)
    {
      try
      {
        ...
        localtmu.jdField_a_of_type_Tmv.a(localArrayList);
      }
      ...
      localtmu.jdField_a_of_type_Tmv.a(paramString1, (JSONObject)localObject, true);
      i += 1;
      continue;
      label282:
      int i = 0;
  ...
  public static void a(tmu paramtmu)
  {
    if ((paramtmu.jdField_a_of_type_JavaLangString == null) || (paramtmu.b == null)) {
      return;
    }
    a.put(paramtmu.jdField_a_of_type_JavaLangString, paramtmu);
  }
}
