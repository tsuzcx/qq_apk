...
public class avmd
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anzj.a(2131709164);
    b = anzj.a(2131709163);
    c = anzj.a(2131709165);
  ...
  public static StateListDrawable a(Context paramContext)
  {
    ...
    float f1 = agej.a(4.0F, paramContext.getResources());
    float f2 = agej.a(4.0F, paramContext.getResources());
    float f3 = agej.a(4.0F, paramContext.getResources());
    float f4 = agej.a(4.0F, paramContext.getResources());
    int i = 0;
    while (i < 2)
    {
      localObject2 = new RoundRectShape(new float[] { f1, f1, f2, f2, f3, f3, f4, f4 }, null, null);
      localShapeDrawable = new ShapeDrawable();
      localShapeDrawable.setPadding(agej.a(2.0F, paramContext.getResources()), agej.a(0.0F, paramContext.getResources()), agej.a(2.0F, paramContext.getResources()), agej.a(2.0F, paramContext.getResources()));
  ...
  public static StateListDrawable a(Context paramContext, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    paramFloat1 = agej.a(paramFloat1, paramContext.getResources());
    paramFloat2 = agej.a(paramFloat2, paramContext.getResources());
    paramFloat3 = agej.a(paramFloat3, paramContext.getResources());
    float f = agej.a(paramFloat4, paramContext.getResources());
    int i = 0;
    if (i < 4)
    {
      ...
      localShapeDrawable = new ShapeDrawable();
      if (paramFloat4 == 0.0F) {
        localShapeDrawable.setPadding(agej.a(2.0F, paramContext.getResources()), agej.a(0.0F, paramContext.getResources()), agej.a(2.0F, paramContext.getResources()), 0);
      }
      for (;;)
      {
        localShapeDrawable.setShape((Shape)localObject2);
  ...
  {
    paramString1 = URLDrawable.getDrawable(paramString1, paramContext.getResources().getDrawable(2130850045), paramContext.getResources().getDrawable(2130850045));
  ...
  public static String a(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        str1 = str2;
        paramMessageRecord = apeg.a(((JSONObject)localObject).optString("report_key_bytes_oac_msg_extend", ""));
        str1 = str2;
  ...
  public static String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    //   54: astore 9
    //   56: aload_0
    //   57: invokestatic 287	avmd:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Ljava/lang/String;
    //   60: astore 12
    //   62: iload_1
    //   63: ifne +564 -> 627
    ...
    //   87: astore 7
    //   89: getstatic 43	avmd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   92: aload 7
    //   94: invokeinterface 295 2 0
    //   99: ifeq +74 -> 173
    //   102: getstatic 43	avmd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   105: aload 7
    ...
    //   382: aload 8
    //   384: astore 7
    //   386: getstatic 43	avmd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   418: aload 8
    //   420: astore 7
    //   422: getstatic 43	avmd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   454: aload 8
    //   456: astore 7
    //   458: getstatic 43	avmd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   490: aload 8
    //   492: astore 7
    //   494: getstatic 43	avmd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   769: astore 8
    //   771: getstatic 43	avmd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   1020: checkcast 390	bdom
    //   1023: checkcast 390	bdom
    //   1026: getfield 393	bdom:a	Ljava/util/ArrayList;
    //   1029: astore 8
    //   1031: iload_1
    //   1032: istore_3
    //   1033: iload_2
    ...
    //   1085: checkcast 397	bdol
    //   1088: getfield 398	bdol:b	Ljava/lang/String;
    //   1091: invokestatic 399	avmd:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1094: areturn
    //   1095: iload_1
    //   1096: istore_3
    //   1097: aload 8
    ...
    //   1130: invokestatic 399	avmd:a	(Ljava/lang/String;)Ljava/lang/String;
    //   1133: astore_0
    //   1134: aload_0
    //   1135: areturn
    //   1136: astore_0
  ...
  {
    bguq.a(paramContext, TroopInfoActivity.a(paramString, 3001), 2);
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, Context paramContext)
  {
    if (TextUtils.isEmpty(paramString3))
    {
      ...
      QQToast.a(paramContext, 1, anzj.a(2131709162), 0).b(0);
      return;
    }
    ...
    localbcqt.a(localAppInterface, paramContext, paramString1, paramString3, paramString2, 536870912);
