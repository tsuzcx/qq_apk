...
public abstract class afxd
  implements afxi
{
  private afxf jdField_a_of_type_Afxf = new afxe(this);
  ...
  public afxd(Context paramContext)
  {
  ...
  @Nullable
  public static afxi a(@IntRange(from=0L, to=3L) int paramInt, Activity paramActivity)
  {
    if (QLog.isColorLevel()) {
    ...
    default: 
      return null;
    case 1: 
      return new afws(paramActivity);
    case 2: 
      return new afwu(paramActivity);
    }
    return new afwy(paramActivity);
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimFriendshipImplBaseFriendShipLayout == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimFriendshipImplBaseFriendShipLayout.setBackListener(this.jdField_a_of_type_Afxf);
