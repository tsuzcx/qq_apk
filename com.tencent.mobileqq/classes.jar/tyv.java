...
{
  tyv(tym paramtym, String paramString) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          ...
          this.jdField_a_of_type_Tym.k = ((JSONObject)localObject2).optString("puin");
          if (i == -1)
          {
            paramInt = ((JSONObject)localObject2).optInt("refuseSec");
            if (paramInt > 0)
            {
              this.jdField_a_of_type_Tym.jdField_a_of_type_Boolean = true;
              this.jdField_a_of_type_Tym.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1000, paramInt * 1000);
            }
          }
          ...
          {
            localObject4 = tym.a(((Integer)((Iterator)localObject3).next()).intValue());
          ...
          Object localObject4 = (ArrayList)tym.b.get(this.jdField_a_of_type_JavaLangString);
          paramInt = 0;
          if (paramInt < ((ArrayList)localObject2).size())
          {
            String str = (String)tym.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
            if ((str != null) && (((Integer)((ArrayList)localObject2).get(paramInt)).intValue() == 1) && (tym.a((ArrayList)localObject4, str))) {
              ((ArrayList)localObject3).add(str);
            }
          }
          else
          {
            tym.jdField_a_of_type_JavaUtilMap.put(this.jdField_a_of_type_JavaLangString, localObject3);
            tym.b.remove(this.jdField_a_of_type_JavaLangString);
            localObject2 = new ArrayList();
            if (localObject4 != null)
            {
              ...
              {
                if (tym.a((ArrayList)localObject3, (String)((ArrayList)localObject4).get(paramInt))) {
                  break label583;
                }
        ...
        else
        {
          ...
          if (this.jdField_a_of_type_Tym.m != null) {
            this.jdField_a_of_type_Tym.callJs(this.jdField_a_of_type_Tym.m, new String[] { paramBundle });
          }
          return;
        }
      }
