  ...
  extends apov
{
  ...
  public apox(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, EmoticonPackage paramEmoticonPackage, appt paramappt, BaseChatPie paramBaseChatPie, int paramInt4)
  {
    super(paramQQAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramappt);
    this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener = new appe(this);
  ...
  private View a(VipIPSiteInfo paramVipIPSiteInfo)
  {
    if (paramVipIPSiteInfo != null)
    {
      ...
      try
      {
        ...
        catch (Exception localException2)
        {
          for (;;)
          {
            ...
            continue;
            ((TextView)localObject10).setText(alpo.a(2131701470));
            localImageView.setVisibility(8);
            localObject3 = localException2;
            if (localException2 == null) {
              localObject3 = new RelativeLayout.LayoutParams(aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
            }
            ((RelativeLayout.LayoutParams)localObject3).width = aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
            ((RelativeLayout.LayoutParams)localObject3).height = aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
            ((TextView)localObject7).setMaxWidth(aekt.a(126.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
            ((TextView)localObject8).setMaxWidth(aekt.a(126.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
            continue;
            ((TextView)localObject10).setText(alpo.a(2131701463));
            localImageView.setVisibility(0);
            localObject3 = localException2;
            if (localException2 == null) {
              localObject3 = new RelativeLayout.LayoutParams(aekt.a(140.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
            }
            ((RelativeLayout.LayoutParams)localObject3).width = aekt.a(140.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
            ((RelativeLayout.LayoutParams)localObject3).height = aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
            ((TextView)localObject7).setMaxWidth(aekt.a(90.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
            ((TextView)localObject8).setMaxWidth(aekt.a(90.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
          }
        ...
        localObject5 = new apoz(this, paramVipIPSiteInfo, str1, str3);
        localObject1 = paramVipIPSiteInfo.strType;
        if ("comic".equals(localObject1))
        {
          localObject4 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559067, null, false);
          ...
          ((TextView)localObject1).setText(paramVipIPSiteInfo.ipName + alpo.a(2131701465));
          ((TextView)localObject3).setText(bdkd.a(paramVipIPSiteInfo.ipContent));
          if (paramVipIPSiteInfo.ipList != null)
          {
            ...
            while (i < paramVipIPSiteInfo.ipList.size())
            {
              ...
              if ((localObject1 instanceof IPSiteModel.Comic))
              {
                ...
                localappa = new appa(this, localComic, str1, str3);
                localObject1 = (RelativeLayout.LayoutParams)localRelativeLayout.getLayoutParams();
              }
              switch (localComic.comicType)
              {
              default: 
                ((ImageView)localObject6).setImageDrawable(bdkd.a(localComic.cover, this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener, this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable));
                ((TextView)localObject7).setText(localComic.name);
                ((TextView)localObject8).setText(localComic.desc);
                ((Button)localObject9).setOnClickListener(localappa);
                ((RelativeLayout)localObject5).setOnClickListener(localappa);
                i += 1;
              }
            }
          }
      ...
      for (;;)
      {
        ...
        {
          localObject2 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559065, null, false);
          ...
          ((TextView)localObject8).setText(paramVipIPSiteInfo.ipName + alpo.a(2131701468));
          ((TextView)localObject9).setText(bdkd.a(paramVipIPSiteInfo.ipContent));
          if (paramVipIPSiteInfo.ipList != null)
          {
            i = 0;
            while (i < paramVipIPSiteInfo.ipList.size())
            {
              ...
              if ((localObject8 instanceof IPSiteModel.Game))
              {
                ...
                localObject9 = new appb(this, (IPSiteModel.Game)localObject8, str2, str3);
                ((ImageView)localObject4).setImageDrawable(bdkd.a(((IPSiteModel.Game)localObject8).cover, this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener, this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable));
        ...
        else if ("goods".equals(localObject2))
        {
          ...
          ((TextView)localObject3).setText(paramVipIPSiteInfo.ipName + alpo.a(2131701461));
          ((TextView)localObject4).setText(bdkd.a(paramVipIPSiteInfo.ipContent));
          localObject3 = (HorizontalListView)((View)localObject2).findViewById(2131362316);
          if (paramVipIPSiteInfo.ipList != null)
          {
            paramVipIPSiteInfo = new apte(this.jdField_a_of_type_AndroidContentContext, paramVipIPSiteInfo.ipList, this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener, this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), str3, str2);
            ((HorizontalListView)localObject3).setDividerWidth(aekt.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        ...
        {
          localObject3 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559066, null, false);
          ...
          ((TextView)localObject2).setText(paramVipIPSiteInfo.ipName + alpo.a(2131701469));
          ((TextView)localObject9).setText(bdkd.a(paramVipIPSiteInfo.ipContent));
          if (paramVipIPSiteInfo.ipList != null)
          {
            i = 0;
            if (i < paramVipIPSiteInfo.ipList.size())
            {
              ...
              if ((localObject2 instanceof IPSiteModel.Video))
              {
                ...
                localObject10 = new appc(this, (IPSiteModel.Video)localObject9, str2, str3);
                if (!TextUtils.isEmpty(((IPSiteModel.Video)localObject9).buttonDesc)) {
                  break label1874;
                }
                localObject2 = alpo.a(2131701460);
                label1736:
                ((ImageView)localObject5).setImageDrawable(bdkd.a(((IPSiteModel.Video)localObject9).cover, this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener, this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable));
                ...
                if (!((String)localObject2).equals(alpo.a(2131701466))) {
                  break label1919;
                }
                j = 2130839444;
                label1813:
                ((Button)localObject8).setBackgroundResource(j);
                if (!((String)localObject2).equals(alpo.a(2131701459))) {
                  break label1926;
                }
              }
              label1926:
              for (int j = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165394);; j = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165448))
              {
                ...
                break label1736;
                label1884:
                ((TextView)localObject7).setText(((IPSiteModel.Video)localObject9).showDate + alpo.a(2131701458));
                break label1788;
                label1919:
                j = 2130839443;
                break label1813;
        ...
        {
          localObject2 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559068, null, false);
          localObject8 = (TextView)((View)localObject2).findViewById(2131362318);
          localObject9 = (TextView)((View)localObject2).findViewById(2131362299);
          ...
          ((TextView)localObject8).setText(paramVipIPSiteInfo.ipName + alpo.a(2131701467));
          ((TextView)localObject9).setText(bdkd.a(paramVipIPSiteInfo.ipContent));
          if (paramVipIPSiteInfo.ipList != null)
          {
            i = 0;
            while (i < paramVipIPSiteInfo.ipList.size())
            {
              ...
              if ((localObject8 instanceof IPSiteModel.Book))
              {
                ...
                localObject9 = new appd(this, (IPSiteModel.Book)localObject8, str2, str3);
                ((ImageView)localObject4).setImageDrawable(bdkd.a(((IPSiteModel.Book)localObject8).cover, this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener, this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable));
  ...
  public View a(apow paramapow, int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject1 = (appf)paramapow;
    int i;
    if (getItemViewType(paramInt) == 0)
    {
      ...
      ((appf)localObject1).jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout = new RelativeLayout[this.jdField_a_of_type_Int];
      i = 0;
      while (i < this.jdField_a_of_type_Int)
      {
        ((appf)localObject1).jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i] = ((RelativeLayout)paramView.getChildAt(i));
        i += 1;
      }
    ...
    for (;;)
    {
      ...
      if (i < this.jdField_a_of_type_Int)
      {
        ...
        for (;;)
        {
          ...
          paramViewGroup = (apsj)this.jdField_a_of_type_JavaUtilList.get(j);
          if (paramView != null)
          {
            if (paramViewGroup == paramView.getTag(2131379913)) {
              paramView.setVisibility(0);
            } else {
              paramView.setTag(2131379913, paramViewGroup);
            }
          }
          else
          {
      ...
      paramViewGroup = (aubd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(200);
      Object localObject2 = (aube)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14);
      paramapow = this.jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage.ipSiteInfo;
      if ((paramapow == null) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage.ipSiteInfoBytes != null) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage.ipSiteInfoBytes.length > 0)) {
        paramapow = ((aube)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage.ipSiteInfoBytes);
      }
      for (;;)
      {
        if (paramViewGroup != null) {}
        for (boolean bool = paramViewGroup.a(paramapow);; bool = false)
        {
          if (bool)
          {
            paramViewGroup = a(paramapow);
            paramapow = paramView;
            if (paramViewGroup == null) {
              break;
            }
            paramViewGroup.setTag(localObject1);
            paramapow = paramViewGroup;
            break;
          }
          ...
          ((LinearLayout)localObject2).setLayoutParams(paramapow);
          paramViewGroup = aprk.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage.epId, true);
          ...
          if (paramViewGroup.a)
          {
            ...
            ((ImageView)localObject3).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846585));
            ((LinearLayout)localObject2).addView((View)localObject3, paramapow);
            paramView.addView((View)localObject2);
            ((appf)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localObject2);
            ((appf)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(new apoy(this, paramViewGroup));
            ((appf)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
            paramView.setTag(localObject1);
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "exp_bq_detail", 0, 0, "", this.jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage.epId, "", "");
          ...
          label1064:
          for (paramapow = "1";; paramapow = "2")
          {
            VasWebviewUtil.reportCommercialDrainage((String)localObject1, "ep_mall", "exp_bq_detail", null, 1, 0, 0, null, (String)localObject2, paramapow);
            paramapow = paramView;
            break;
            paramapow = alpo.a(2131701464);
            break label826;
          }
        }
      }
