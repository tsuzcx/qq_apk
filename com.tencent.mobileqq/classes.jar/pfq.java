  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        ...
        if (localObject2 != null)
        {
          ...
          {
            localpfn = (pfn)((Iterator)localObject2).next();
            if (localpfn != null) {
              localpfn.setResult(0, new Object[] { paramMessage[1] });
            }
          }
        }
        ...
        if (localObject2 != null)
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            localpfn = (pfn)((Iterator)localObject2).next();
            if (localpfn != null) {
              localpfn.setResult(1, new Object[] { paramMessage[1] });
            }
          }
        }
      ...
      if (localObject2 != null)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          localpfn = (pfn)((Iterator)localObject2).next();
          if (localpfn != null) {
            localpfn.setResult(2, new Object[] { paramMessage[1], paramMessage[2], paramMessage[3] });
          }
        }
      }
    ...
    case 11: 
      ...
      if (localObject2 != null)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          localpfn = (pfn)((Iterator)localObject2).next();
          if (localpfn != null) {
            localpfn.setResult(11, new Object[] { paramMessage[1] });
          }
        }
      }
    ...
    if (localObject1 != null)
    {
      ...
      {
        localObject2 = (pfn)((Iterator)localObject1).next();
        if (localObject2 != null) {
          ((pfn)localObject2).setResult(12, new Object[0]);
        }
      }
    }
