...
public class pfq
  implements phs
{
  private void a(Context paramContext, BaseArticleInfo paramBaseArticleInfo, rap paramrap)
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo.get() != null))
    {
      ...
      if (localUrlJumpInfo != null) {
        qol.a(paramContext, localUrlJumpInfo);
      }
    }
    while (paramrap == null)
    {
      ...
      paramrap.a(rap.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
      return;
    }
    paramrap.a(rap.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
  }
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (int i = paramBaseArticleInfo.mVideoColumnInfo.a;; i = -1)
    {
      ...
      for (int j = 0;; j = 1)
      {
        paramBaseArticleInfo = new qze(null, null, null, null).X(Integer.valueOf("1031").intValue()).h(paramBaseArticleInfo.getInnerUniqueID()).ac(j).s(paramJSONObject.optString("double_videocard_jump_page")).t(paramJSONObject.optString("double_videocard_jump_src")).u(paramBaseArticleInfo.mSubscribeName).f(paramBaseArticleInfo);
        if (i != -1) {
          paramBaseArticleInfo.ab(i);
        }
        paramBaseArticleInfo = paramBaseArticleInfo.a().a();
        noo.a(null, null, "0X8007625", "0X8007625", 0, 0, "", "", "", paramBaseArticleInfo, false);
        noo.a(null, null, "0X800A5A9", "0X800A5A9", 0, 0, "", "", "", paramBaseArticleInfo, false);
        return;
      }
    }
  }
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_1", onk.a(paramBaseArticleInfo.mFirstPagePicUrl, bbkx.b(180.5F), bbkx.b(102.0F)));
          localJSONObject2.put("cover_image_1", localObject1);
          localJSONObject2.put("id_paly_wrapper_1", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = qol.a(paramBaseArticleInfo.mVideoDuration * 1000);
          ...
          ((JSONObject)localObject2).put("article_title_1_textsize", ooz.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = qol.d(paramBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_1", (String)localObject2 + ajyc.a(2131703432));
          ...
          localJSONObject2.put("id_container_1", localObject1);
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_2", onk.a(localBaseArticleInfo.mFirstPagePicUrl, bbkx.b(180.5F), bbkx.b(102.0F)));
          localJSONObject2.put("cover_image_2", localObject1);
          localJSONObject2.put("id_play_wrapper_2", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = qol.a(localBaseArticleInfo.mVideoDuration * 1000);
          if (localObject2 != null)
          {
            localObject2 = ((StringBuilder)localObject2).toString();
            if (!TextUtils.isEmpty((CharSequence)localObject2))
          ...
          ((JSONObject)localObject2).put("article_title_2_textsize", ooz.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = qol.d(localBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_2", (String)localObject2 + ajyc.a(2131703433));
  ...
  public void a(int paramInt1, Container paramContainer, pax parampax, int paramInt2)
  {
    ...
    {
      return;
      a(paramContainer.findViewBaseByName("id_artilce_title_1"), parampax.a());
    } while ((parampax.a() == null) || (parampax.a().mSubArtilceList == null) || (parampax.a().mSubArtilceList.size() <= 0) || (parampax.a().mSubArtilceList.get(0) == null));
    a(paramContainer.findViewBaseByName("id_artilce_title_2"), (BaseArticleInfo)parampax.a().mSubArtilceList.get(0));
  }
  ...
  public boolean a(int paramInt, Container paramContainer, pax parampax, ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener(new pfr(this, parampax, paramInt, paramContainer));
    return true;
  }
}
