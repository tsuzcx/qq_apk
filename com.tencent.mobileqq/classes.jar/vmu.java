...
public class vmu
{
  ...
  public vmu(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new vmv(this, paramSwipeUpAndDragListener));
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new vmw(this, paramSwipeUpAndDragListener);
    this.jdField_a_of_type_JavaLangRunnable = new vmx(this, paramSwipeUpAndDragListener);
    this.jdField_b_of_type_JavaLangRunnable = new vmy(this, paramSwipeUpAndDragListener);
  }
