  ...
  implements Handler.Callback, Manager
{
  ...
  private befq jdField_a_of_type_Befq = new befq(ThreadManagerV2.getSubThreadLooper(), this);
  ...
  public arim(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    localawqs.e = paramString4;
    localawqs.d = paramString5;
    localawqs.f = paramString1;
    localawqs.i = paramString2;
    awqr.a(paramString3, localawqs);
    awqr.a(paramQQAppInterface, localawqs);
  }
  ...
  private boolean a(SubMsgType0x27.PushPlatform paramPushPlatform, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (afgd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295);
      if (localObject != null)
      {
        bool2 = ((afgd)localObject).b();
        bool1 = bool2;
        if (bool2)
        {
          bool1 = bool2;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(1, 30000L);
  }
  ...
  public void a(long paramLong, String arg3, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        boolean bool = bahj.a(paramString2);
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Pause) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop) || (bool))
        {
          ...
          synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
          {
            ...
            if (bool)
            {
              ??? = (ario)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(72);
              if (SettingCloneUtil.readValue(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString2.getString(2131628378), "qqsetting_lock_screen_whenexit_key", true))
              {
                if (QLog.isColorLevel()) {
  ...
  public void a(Context paramContext, Intent paramIntent)
  {
    ...
    if (j == 1041)
    {
      localIntent = aciy.a(new Intent(paramContext, SplashActivity.class), null);
  ...
  public void a(SubMsgType0x27.MsgBody paramMsgBody, short paramShort, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramMsgBody = new String(asat.a(paramMsgBody), "UTF-8");
        localObject1 = null;
      ...
      catch (Exception paramMsgBody)
      {
        try
        {
          ...
          this.jdField_a_of_type_Befq.removeMessages(1);
          localObject4 = new awqs();
          ((awqs)localObject4).e = "0X800923D";
          ((awqs)localObject4).d = "收到Push协议";
          ((awqs)localObject4).f = (((SubMsgType0x27.ClientReport)localObject3).uint32_service_id.get() + "");
          ((awqs)localObject4).i = ((SubMsgType0x27.ClientReport)localObject3).str_content_id.get();
          awqr.a(paramMsgBody, (awqs)localObject4);
          awqr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (awqs)localObject4);
          l = awao.a();
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemNoticeData == null)
          {
            ...
            a(paramLong, str, paramMsgBody, (String)localObject2, i, j, ((awqs)localObject4).f, ((awqs)localObject4).i, (Bundle)localObject1);
            return;
