...
public class aqny
{
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      if (!paramBoolean) {
        aqrl.a(BaseApplicationImpl.getContext(), 5, false);
      }
  ...
  {
    Object localObject = aqop.a();
    if ((localObject != null) && (((aqoo)localObject).a())) {}
    for (int i = 1;; i = 0)
    {
      if ((i != 0) && (paramColorNote != null) && (this.a != null) && (aqos.a().a()))
      {
        localObject = aqoq.a(paramColorNote);
