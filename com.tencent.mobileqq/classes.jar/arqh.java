  ...
  implements View.OnClickListener
{
  ...
  public arqh(Context paramContext)
  {
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      paramQQAppInterface = bbex.a(paramQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
  ...
  private void a(String paramString1, String paramString2, String paramString3, List<String> paramList, int paramInt)
  {
    ...
    for (paramList = (String)paramList.get(0);; paramList = null)
    {
      if ("url".equals(paramString2))
      {
        ...
        paramString2 = arqg.a("banner_exp");
      ...
      paramString2 = arqg.a("banner_clk");
      paramString2.jdField_b_of_type_Int = i;
      paramString2.a = paramString3;
      paramString2.jdField_b_of_type_JavaLangString = paramList;
      paramString2.e = paramString1;
  ...
  {
    ((LebaRoundLayout)paramView.findViewById(2131363711)).a = bbll.a(16.0F);
    Object localObject = (LinearLayout)paramView.findViewById(2131369435);
    if (ThemeUtil.isNowThemeIsNight(paramAppRuntime, false, null))
    {
      ((LinearLayout)localObject).setBackgroundResource(2130840180);
    ...
    for (;;)
    {
      ...
      break;
      label240:
      paramView = paramView.findViewById(2131369358);
      paramView = new RedTouch(this.jdField_a_of_type_AndroidContentContext, paramView).c(bbll.b(5.0F)).b(bbll.b(1.0F)).a(3).a();
    ...
    if ((!this.jdField_a_of_type_JavaUtilHashSet.contains(Integer.valueOf(paramAppInfo.uiAppId.get()))) && (paramAppInfo.iNewFlag.get() != 0))
    {
      ...
      ((avps)paramAppRuntime.getManager(36)).a(paramAppInfo.uiAppId.get(), 30);
    ...
    try
    {
      ...
      if (AppSetting.d) {
        baww.a(paramView, paramView.a(), Button.class.getName());
      }
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = (avps)localAppRuntime.getManager(36);
    if (paramView != null)
    {
