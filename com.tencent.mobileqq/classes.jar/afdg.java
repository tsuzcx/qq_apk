  ...
  implements View.OnClickListener
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = afdg.class.getSimpleName();
  }
  
  public afdg(BaseActivity paramBaseActivity, int paramInt, View paramView)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramBaseActivity);
    this.jdField_a_of_type_Int = paramInt;
    paramBaseActivity = paramView.findViewById(2131309940);
    IphoneTitleBarActivity.setLayerType(paramBaseActivity);
    paramView = paramBaseActivity.findViewById(2131297934);
    if (paramView != null) {
      paramView.setVisibility(8);
    }
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramBaseActivity.findViewById(2131300167));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBaseActivity.findViewById(2131312509));
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(avis.b());
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      avsv.a(null, i, 0, "0X8009D15", 0, 0, null, null);
