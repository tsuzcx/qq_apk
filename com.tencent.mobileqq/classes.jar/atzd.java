...
{
  private atyg jdField_a_of_type_Atyg;
  private atze jdField_a_of_type_Atze;
  private atze b;
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    if (this.b == null) {
      this.b = new atze(this);
    }
    if (this.b.a(paramArrayOfByte1, paramArrayOfByte2, paramInt1, paramInt2, paramInt3, paramInt4, paramFloat, paramBoolean)) {}
    try
    {
      this.jdField_a_of_type_Atze = null;
      this.jdField_a_of_type_Atze = this.b;
      if (QLog.isColorLevel()) {
        QLog.d("GLRender", 2, "func copyFrame2Render ends, mCurData:" + this.jdField_a_of_type_Atze);
      }
      return;
    }
    finally {}
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    //   33: aload_0
    //   34: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   37: ifnull +10 -> 47
    //   40: aload_0
    //   41: getfield 66	atzd:jdField_a_of_type_Atyg	Latyg;
    //   44: ifnonnull +52 -> 96
    ...
    //   68: aload_0
    //   69: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    ...
    //   80: aload_0
    //   81: getfield 66	atzd:jdField_a_of_type_Atyg	Latyg;
    ...
    //   95: return
    //   96: aload_0
    //   97: getfield 66	atzd:jdField_a_of_type_Atyg	Latyg;
    //   100: aload_0
    //   101: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   104: getfield 73	atze:jdField_a_of_type_ArrayOfByte	[B
    //   107: aload_0
    //   108: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   111: getfield 75	atze:jdField_b_of_type_ArrayOfByte	[B
    //   114: aload_0
    //   115: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   118: getfield 79	atze:c	I
    //   121: aload_0
    //   122: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   125: getfield 81	atze:d	I
    //   128: aload_0
    //   129: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   132: getfield 83	atze:jdField_a_of_type_Int	I
    //   135: aload_0
    //   136: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   139: getfield 85	atze:jdField_b_of_type_Int	I
    //   142: aload_0
    //   143: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   146: getfield 88	atze:jdField_a_of_type_Float	F
    //   149: aload_0
    //   150: getfield 56	atzd:jdField_a_of_type_Atze	Latze;
    //   153: getfield 91	atze:jdField_a_of_type_Boolean	Z
    //   156: invokevirtual 95	atyg:a	([B[BIIIIFZ)V
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    try
    {
      this.jdField_a_of_type_Atyg = new atyg();
      this.jdField_a_of_type_Atze = null;
