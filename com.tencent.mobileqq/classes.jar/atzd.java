...
public class atzd
{
  public static akbj a;
  public static String a;
  
  static
  {
    jdField_a_of_type_Akbj = new atze();
  ...
  public static long a(ArrayList<WadlResult> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        int j = abet.a((String)localObject1);
  ...
  public static void a(int paramInt1, QQGameMsgInfo paramQQGameMsgInfo, int paramInt2)
  {
    ...
    do
    {
      return;
      if (paramInt1 == 117) {
        anxs.a(paramQQGameMsgInfo.frienduin, paramQQGameMsgInfo.uniseq);
      }
      str = "";
    ...
    anxs.a(paramInt1, paramInt2, str, paramQQGameMsgInfo.triggerInfo);
  }
  ...
  public static boolean a(atzp paramatzp)
  {
    return ((paramatzp instanceof GameArkView)) && (a(paramatzp.a()));
  }
  ...
  public static int b()
  {
    ...
    do
    {
      ...
      if (UpdateSetting.getInstance().getModuleVersion("QQGameCenter") <= 0)
      {
        ...
        new HippyQQUpdateManager().checkUpdate("QQGameCenter", 0, null);
        return -2;
      }
    } while (HippyQQLibraryManager.getInstance().isLibrayExists());
  ...
  private static boolean b()
  {
    ...
    long l = a();
    if (NetConnInfoCenter.getServerTimeMillis() - l < atzb.a() * 24 * 60 * 60 * 1000)
    {
