...
{
  public acvu(EditInfoActivity paramEditInfoActivity) {}
  
  public void onClick(View paramView)
  {
    paramView = this.a.a.getText();
    if (paramView != null) {}
    for (paramView = new bamp(paramView.toString(), 3);; paramView = null)
    {
      Object localObject1;
      if (paramView == null)
      {
        ...
        if (!this.a.jdField_g_of_type_Boolean)
        {
          if (this.a.jdField_e_of_type_Int == 0)
          {
            ...
            while (!this.a.b.equals(paramView))
            {
              ...
              QQToast.a(this.a, this.a.getString(2131693681), 0).b(this.a.getTitleBarHeight());
              return;
            }
      ...
      {
        localacwe = new acwe(null);
        if (EditInfoActivity.a(this.a, localacwe))
        {
          this.a.b(true);
          paramView = (bdug)this.a.app.a(71);
          ...
          } while (((benz)((Iterator)localObject1).next()).c != 1);
        }
      }
      for (int i = 1;; i = 0)
      {
        if (i == 0)
        {
          QQToast.a(this.a, alud.a(2131704014), 0).b(this.a.getTitleBarHeight());
          return;
        }
        ...
        {
          QQToast.a(this.a, this.a.getString(2131693558), 0).b(this.a.getTitleBarHeight());
          return;
        }
        ...
        localObject2 = (amdu)this.a.app.a(20);
        if ((localObject2 != null) && (!TextUtils.isEmpty(this.a.jdField_e_of_type_JavaLangString)))
        {
          this.a.b(true);
          ((amdu)localObject2).a(this.a.jdField_e_of_type_JavaLangString, paramView, (ArrayList)localObject1);
        }
        ...
        {
          this.a.j = true;
          azqs.b(this.a.app, "P_CliOper", "Grp_manage", "", "modify_name", "complete", 0, 0, this.a.jdField_e_of_type_JavaLangString, i + "", "" + this.a.d, "");
          return;
