...
public class alcr
  extends MqqHandler
{
  public alcr(ShortVideoPlayActivity paramShortVideoPlayActivity) {}
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          paramMessage = bfur.a(this.a.jdField_a_of_type_AndroidContentContext, 232, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718478), this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718477), 2131718461, 2131717677, new alcs(this), new alct(this));
