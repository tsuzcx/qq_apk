  ...
  extends asbm
{
  ...
  public asbo(bdjz parambdjz, QQAppInterface paramQQAppInterface)
  {
    super(parambdjz);
  ...
  private void a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForMixedMsg))
    {
      ...
      if (paramChatMessage.msgElemList != null)
      {
        ...
        while (paramChatMessage.hasNext())
        {
          ...
          if ((localObject2 instanceof MessageForText))
          {
            ...
            ((AnimationTextView)localObject1).setSpannableFactory(bamp.a);
            if (!TextUtils.isEmpty(((MessageForText)localObject2).sb2)) {
              ((AnimationTextView)localObject1).setText(new bamp(((MessageForText)localObject2).sb2.toString(), 5, 20));
            }
            for (;;)
            {
              ...
              if (!TextUtils.isEmpty(((MessageForText)localObject2).sb)) {
                ((AnimationTextView)localObject1).setText(new bamp(((MessageForText)localObject2).sb.toString(), 5, 20));
              } else if (!TextUtils.isEmpty(((MessageForText)localObject2).msg)) {
                ((AnimationTextView)localObject1).setText(new bamp(((MessageForText)localObject2).msg, 5, 20));
              }
            }
          }
          if ((localObject2 instanceof MessageForPic))
          {
            ...
            localObject2 = afwu.a(this.jdField_a_of_type_AndroidContentContext, (MessageForPic)localObject2);
            if (localObject2 != null)
            {
              if (((((URLDrawable)localObject2).getCurrDrawable() instanceof RoundRectDrawable)) && (a()))
              {
                ...
                ((ImageView)localObject1).setImageDrawable(new apkp(0, localRoundRectDrawable.getIntrinsicWidth(), localRoundRectDrawable.getIntrinsicHeight()));
          ...
          else if ((localObject2 instanceof MessageForReplyText))
          {
            ...
            {
              ((AnimationTextView)localObject1).setText(new bamp(((MessageForReplyText)localObject2).sb.toString(), 5, 20));
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.getViewTreeObserver().addOnGlobalLayoutListener(new asbp(this));
    }
  }
  ...
  private void f()
  {
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getHeight() >= bdoo.a(this.jdField_a_of_type_Int + 1))
    {
      this.jdField_a_of_type_ComTencentWidgetMaxHeightRelativelayout.setMaxHeight(bdoo.a(450.0F));
