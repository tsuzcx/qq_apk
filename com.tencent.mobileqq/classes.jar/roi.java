...
{
  public roi(AddFriendVerifyActivity paramAddFriendVerifyActivity, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity.getString(2131434483).equals(paramView)) && (!AddFriendVerifyActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity))) {
