      ...
      if (paramVideoInfo.a.jdField_a_of_type_Int == 0)
      {
        ...
        else
        {
          ...
          if (((oidb_0x885.KdTagItem)localObject2).bytes_name.has()) {
            ((VideoInfo.KdTagItem)localObject3).jdField_a_of_type_JavaLangString = ozs.a(((oidb_0x885.KdTagItem)localObject2).bytes_name);
          }
  ...
  public static void a(oidb_0x6cf.RspBody paramRspBody, Bundle paramBundle, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          tpx.a("AdVideoDataLink", "parseTagInfoResult:rspBody.msg_ad_rsp is not null");
          ...
          tpx.a("AdVideoDataLink", "parseTagInfoResult:rspBody.rpt_msg_pos_ad_info posAdInfos size >>" + ((List)localObject1).size());
      ...
      {
        tpx.a("AdVideoDataLink", "handleGetRecommendList: parse game ad info error, e= " + paramRspBody.getMessage());
      }
      label408:
    ...
    if (!paramRspBody.isEmpty())
    {
      ...
      tpx.a("AdVideoDataLink", paramBundle.toString());
      return;
    }
    tpx.a("AdVideoDataLink", "parseTagInfoResult:no softAd or gameComponent");
    return;
    label550:
    tpx.a("AdVideoDataLink", "parseTagInfoResult:rspBody.rpt_msg_pos_ad_info null ");
  }
}
