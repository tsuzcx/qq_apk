  ...
  extends Handler
{
  ...
  public ajpt(SendPhotoActivity paramSendPhotoActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      return;
      localSendPhotoActivity.a(2131694451);
      return;
      if (localSendPhotoActivity.jdField_a_of_type_AndroidOsHandler.hasMessages(2))
      {
        ayde.b(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage", "remove delayed Message:MSG_CANCLE_PROGRESS");
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        ((Intent)localObject2).putExtra(bftk.h, 2);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          ayde.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage print CompressInfo", "info:" + localObject3);
      ...
      ayde.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "CompressLog", "compress startTime = " + localSendPhotoActivity.b + "ns,finishTime = " + l1 + "ns,duration = " + l2 + "ms,count = " + i + ",isShowing = " + bool1);
      ajpv.a(l2, i, bool1);
      localSendPhotoActivity.app.getTransFileController().initAllPSProcessorEnterAioTime(l1);
      ayde.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "TimeCompare", "CompressFinish Time = " + l1 + "ns");
      ...
      ayfc.a(BaseApplication.getContext(), paramMessage);
      return;
      if (QLog.isColorLevel()) {
