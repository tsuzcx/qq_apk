...
public class aaiu
  extends aafx<CertifiedAccountMeta.StComment>
  implements View.OnClickListener, Animation.AnimationListener, CompoundButton.OnCheckedChangeListener, IEventReceiver
{
  private static final String jdField_a_of_type_JavaLangString = aaiu.class.getSimpleName();
  ...
  private aahs jdField_a_of_type_Aahs;
  protected aaid a;
  private final aajb jdField_a_of_type_Aajb;
  private aajc jdField_a_of_type_Aajc;
  private aajd jdField_a_of_type_Aajd;
  private aaje jdField_a_of_type_Aaje;
  private aaka jdField_a_of_type_Aaka;
  private aakc jdField_a_of_type_Aakc;
  private aakh jdField_a_of_type_Aakh;
  private final Activity jdField_a_of_type_AndroidAppActivity;
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new aaix(this);
  private ViewStub jdField_a_of_type_AndroidViewViewStub;
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  private AbsListView.OnScrollListener jdField_a_of_type_AndroidWidgetAbsListView$OnScrollListener = new aaiw(this);
  public ListView a;
  ...
  public aaiu(Activity paramActivity, boolean paramBoolean, CertifiedAccountMeta.StFeed paramStFeed, aajd paramaajd, ExtraTypeInfo paramExtraTypeInfo)
  {
    super(paramActivity, paramBoolean);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Aajb = new aajb(this);
    wjj.a().registerSubscriber(this.jdField_a_of_type_Aajb);
    this.jdField_a_of_type_Aajd = paramaajd;
  ...
  private aaid a()
  {
    if (this.jdField_a_of_type_Aaid == null)
    {
      ...
      this.jdField_e_of_type_Int = this.jdField_a_of_type_Aaid.hashCode();
    }
  ...
  private void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(a(), 1, a().getResources().getString(2131693974), 0).a();
      return;
    }
  ...
  private void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Aakh == null) {
      this.jdField_a_of_type_Aakh = new aakh((Activity)this.jdField_a_of_type_AndroidContentContext);
    }
    String str2;
    String str1;
    if (paramStReply != null) {
      ...
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692046), new Object[] { paramStReply.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
        ...
        this.jdField_a_of_type_Aakh.b(str1);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Aakh.a(new aaiy(this, paramStComment, paramStReply));
      c(paramStComment, paramStReply);
      this.jdField_a_of_type_Aakh.a(paramBoolean2);
      return;
      if ((paramStComment != null) && (paramStComment.postUser != null))
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692046), new Object[] { paramStComment.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
          str1 = str2.substring(0, 10);
      ...
      {
        this.jdField_a_of_type_Aakh.b(this.jdField_a_of_type_AndroidContentContext.getString(2131692041));
      }
    }
  }
  ...
  private void a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    for (paramStComment = paramStReply;; paramStComment = str)
    {
      ...
      aamo.a(this.jdField_a_of_type_AndroidContentContext, paramStReply);
      return;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Aakh != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Aakh.a());
      }
      return;
      k = 0;
    }
  ...
  private void a(Object[] paramArrayOfObject)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              do
              {
                do
                {
                  for (;;)
                  {
                    ...
                    if (paramArrayOfObject[3] != null)
                    {
                      ...
                      if (this.jdField_a_of_type_Aajd != null) {
                        this.jdField_a_of_type_Aajd.a((CertifiedAccountRead.StGetFeedDetailRsp)localObject2, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if ((paramArrayOfObject.length >= 6) && (paramArrayOfObject[5] != null))
                      {
                        ...
                        if (((COMM.StCommonExt)localObject1).mapInfo.size() > 0)
                        {
                          ...
                          h();
                          aaak.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), (CertifiedAccountMeta.StReply)localObject1));
                          this.i = true;
                          this.j = true;
                        }
                      }
                    ...
                    for (;;)
                    {
                      ...
                      break;
                      h();
                      aaak.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), null));
                      break;
                      a(new CommentPresenter.12(this));
                      break;
                      QLog.w(jdField_a_of_type_JavaLangString, 1, "get feed detail response failed");
                      if (this.jdField_a_of_type_Aajd != null) {
                        this.jdField_a_of_type_Aajd.a(null, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if (!this.h) {
                  ...
                  if (this.jdField_a_of_type_Aakh != null) {
                    this.jdField_a_of_type_Aakh.b(this.jdField_a_of_type_AndroidWidgetTextView);
                  }
                ...
                if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp))
                {
                  ...
                  if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Aaka != null) && (this.jdField_a_of_type_Aaka.a(String.valueOf(paramArrayOfObject[4])))) {
                    m();
                  }
                  if (localLong.longValue() == 0L)
                  {
                    if ((this.jdField_a_of_type_Aaka != null) && (this.jdField_a_of_type_Aaka.a(String.valueOf(paramArrayOfObject[4]), (CertifiedAccountMeta.StComment)localObject2))) {
                      m();
                    }
                    b(1);
                  }
                }
                a(localLong.longValue(), anzj.a(2131701107), (String)localObject1);
              ...
              if ((localLong.longValue() == 0L) && ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp)))
              {
                ...
                if ((this.jdField_a_of_type_Aaka != null) && (this.jdField_a_of_type_Aaka.a(paramArrayOfObject))) {
                  m();
                }
                b(-1);
              }
              a(localLong.longValue(), anzj.a(2131701101), anzj.a(2131701110));
              return;
            ...
            if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoReplyRsp))
            {
              ...
              if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Aaka != null) && (this.jdField_a_of_type_Aaka.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject))) {
                m();
              }
              if ((localLong.longValue() == 0L) && (this.jdField_a_of_type_Aaka != null) && (this.jdField_a_of_type_Aaka.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject, (CertifiedAccountMeta.StReply)localObject1))) {
                m();
              }
            }
            a(localLong.longValue(), anzj.a(2131701100), anzj.a(2131701111));
            return;
          } while (a(5, paramArrayOfObject));
          a(localLong.longValue(), anzj.a(2131701106), anzj.a(2131701113));
      ...
      } while ((localLong.longValue() != 0L) || (this.jdField_a_of_type_Aaka == null) || (TextUtils.isEmpty(paramArrayOfObject)) || (TextUtils.isEmpty((CharSequence)localObject1)));
      this.jdField_a_of_type_Aaka.a(paramArrayOfObject, (String)localObject1);
      m();
      return;
    ...
    label414:
    label486:
    if (this.jdField_a_of_type_Aaka != null)
    {
    ...
    label1207:
    for (paramArrayOfObject = this.jdField_a_of_type_Aaid.a((List)localObject1, (String)paramArrayOfObject[5]);; paramArrayOfObject = (Object[])localObject1)
    {
      this.jdField_a_of_type_Aaka.a(paramArrayOfObject);
      m();
      return;
    }
  }
  ...
  {
    if ((paramStUser != null) && (aaee.a() != null) && (paramStUser.id.get().equals(aaee.a().id.get()))) {}
  ...
  private void b(int paramInt)
  {
    ...
    wjj.a().dispatch(new aaiq(5, new Object[] { b(), Integer.valueOf(this.jdField_d_of_type_Int) }));
  }
  ...
  private void c(int paramInt)
  {
    ...
    if (paramInt == 0) {
      this.jdField_a_of_type_Aaka.a(a().poster.id.get());
    }
  ...
  private void c(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    this.jdField_a_of_type_Aakh.setOnShowListener(new aaiz(this, paramStComment, paramStReply));
    this.jdField_a_of_type_Aakh.a(new aaja(this, paramStComment, paramStReply));
  }
  ...
  private void n()
  {
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)a(2131366388));
    this.jdField_b_of_type_AndroidViewView = a(2131364804);
    this.jdField_e_of_type_AndroidViewView = a(2131366389);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131364834));
    this.jdField_c_of_type_AndroidViewView = a(2131364815);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131378684));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131363798);
    ...
    this.jdField_a_of_type_Aaje = new aaje(this);
    this.jdField_a_of_type_Aaka = new aaka(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Aaje);
    this.jdField_a_of_type_Aaka.a(this.jdField_d_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Aaka);
    this.jdField_a_of_type_AndroidWidgetListView.setEmptyView(this.jdField_c_of_type_AndroidViewView);
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new aaiv(this));
    }
  }
  ...
  private void p()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 294	aaiu:jdField_a_of_type_Aaid	Laaid;
    //   6: ifnonnull +16 -> 22
    //   9: getstatic 65	aaiu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: iconst_1
    //   13: ldc_w 902
    ...
    //   22: aload_0
    //   23: aload_0
    //   24: invokespecial 307	aaiu:a	()Laaid;
    //   27: aload_0
    //   28: invokespecial 329	aaiu:b	()Ljava/lang/String;
    //   31: invokevirtual 617	aaid:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   34: putfield 335	aaiu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   37: aload_0
    //   38: aload_0
    //   39: invokespecial 307	aaiu:a	()Laaid;
    //   42: aload_0
    //   43: invokespecial 329	aaiu:b	()Ljava/lang/String;
    //   46: invokevirtual 905	aaid:a	(Ljava/lang/String;)LNS_COMM/COMM$StCommonExt;
    //   49: putfield 286	aaiu:jdField_a_of_type_NS_COMMCOMM$StCommonExt	LNS_COMM/COMM$StCommonExt;
    //   52: aload_0
    //   53: getfield 335	aaiu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   56: ifnull -37 -> 19
    //   59: aload_0
    //   60: getfield 311	aaiu:jdField_a_of_type_Aaka	Laaka;
    //   63: ifnull +44 -> 107
    //   66: aload_0
    //   67: getfield 311	aaiu:jdField_a_of_type_Aaka	Laaka;
    //   70: invokevirtual 907	aaka:a	()V
    //   73: aload_0
    //   74: getfield 311	aaiu:jdField_a_of_type_Aaka	Laaka;
    //   77: aload_0
    //   78: getfield 335	aaiu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   81: invokevirtual 765	aaka:a	(Ljava/util/Collection;)Z
    //   84: pop
    //   85: aload_0
    //   86: getfield 662	aaiu:i	Z
    //   89: ifeq +11 -> 100
    //   92: aload_0
    //   93: getfield 311	aaiu:jdField_a_of_type_Aaka	Laaka;
    //   96: iconst_0
    //   97: invokevirtual 909	aaka:a	(I)V
    //   100: aload_0
    //   101: getfield 311	aaiu:jdField_a_of_type_Aaka	Laaka;
    //   104: invokevirtual 912	aaka:notifyDataSetChanged	()V
    //   107: aload_0
    //   108: getfield 339	aaiu:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   111: ifnull +47 -> 158
    //   114: aload_0
    //   115: getfield 97	aaiu:jdField_g_of_type_Int	I
    //   118: aload_0
    //   119: invokevirtual 149	aaiu:a	()I
    //   122: if_icmpeq +36 -> 158
    //   125: aload_0
    //   126: getfield 662	aaiu:i	Z
    //   129: ifeq +29 -> 158
    //   132: aload_0
    //   133: aload_0
    //   134: invokevirtual 149	aaiu:a	()I
    //   137: putfield 97	aaiu:jdField_g_of_type_Int	I
    //   140: getstatic 65	aaiu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   143: iconst_1
    //   144: ldc_w 914
    //   147: invokestatic 373	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: getfield 339	aaiu:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   154: iconst_0
    //   155: invokevirtual 917	android/widget/ListView:setSelection	(I)V
    //   158: aload_0
    //   159: getfield 335	aaiu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   162: ifnull -143 -> 19
    //   165: aload_0
    //   166: getfield 335	aaiu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   169: invokevirtual 632	java/util/ArrayList:size	()I
    //   172: ifle -153 -> 19
    //   175: aload_0
    //   176: aload_0
    //   177: invokespecial 307	aaiu:a	()Laaid;
    //   180: aload_0
    //   181: invokespecial 329	aaiu:b	()Ljava/lang/String;
    //   184: invokevirtual 781	aaid:a	(Ljava/lang/String;)I
    //   187: putfield 131	aaiu:jdField_d_of_type_Int	I
    //   190: goto -171 -> 19
    //   193: astore_1
    //   194: aload_0
    //   195: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ...
          {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(aajx.a(this.jdField_d_of_type_Int));
          ...
          if (this.jdField_a_of_type_Aaka.getCount() == 0)
          {
            bool = true;
            b(bool);
          }
  ...
  private void r()
  {
    if ((this.jdField_b_of_type_AndroidViewView != null) && (!this.jdField_f_of_type_Boolean))
    {
      ...
      aaak.a().a(new CommentListShowStateEvent(false));
    }
  ...
  public void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    String str = b();
    if ((!bhsr.a(str)) && (a() != null) && (a().vecComment.size() == 0) && (a().commentCount.get() != 0))
    {
  ...
  public void a(aajc paramaajc)
  {
    this.jdField_a_of_type_Aajc = paramaajc;
  }
  
  public void a(aakc paramaakc)
  {
    this.jdField_a_of_type_Aakc = paramaakc;
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_Aakh != null) && (this.jdField_a_of_type_Aakh.isShowing());
  }
  
  protected void e()
  {
    wjj.a().unRegisterSubscriber(this.jdField_a_of_type_Aajb);
    a().a();
    this.jdField_a_of_type_Aaid = null;
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    if (paramAnimation == this.jdField_a_of_type_AndroidViewAnimationAnimation)
    {
      ...
      if (this.jdField_a_of_type_Aajc != null) {
        this.jdField_a_of_type_Aajc.l();
      }
    }
  ...
  public void onAnimationStart(Animation paramAnimation)
  {
    ...
    ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).mSystemBarComp.setStatusBarMask(new PorterDuffColorFilter(a().getColor(2131167174), PorterDuff.Mode.SRC_ATOP));
  }
