...
{
  bacv(bacn parambacn, bbms parambbms, String paramString1, String paramString2, String paramString3) {}
  ...
  public void onGetAppPathByName(int paramInt, String paramString, ArkAppMgr.AppPathInfo paramAppPathInfo, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramInt != 0)
        {
          alep.a(null, this.c, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
          if (this.jdField_a_of_type_Bacn.a != null) {
            ArkFullScreenAppActivity.a(this.jdField_a_of_type_Bacn.a, this.c, paramAppPathInfo, "0.0.0.1", paramObject, alem.a(), null, 1);
          }
        }
        do
        {
          ...
          } while (this.jdField_a_of_type_Bacn.a == null);
          this.jdField_a_of_type_Bacn.a.startActivity(paramObject);
          return;
          bbmy.a(this.jdField_a_of_type_Bacn.a, 2131624636, 0).a();
