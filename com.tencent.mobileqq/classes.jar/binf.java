...
public class binf
  implements bikb<bika>
{
  private final int jdField_a_of_type_Int = biqy.a(DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  private binf(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(bika parambika, MotionEvent paramMotionEvent)
  {
    boolean bool = true;
    if ((parambika instanceof biiy)) {
      localRect = new Rect();
    }
    for (Rect localRect = ((biiy)parambika).a(localRect);; localRect = null)
    {
      if (bjeh.b()) {}
      for (float f1 = bjeh.e;; f1 = 0.0F)
      {
        ...
        case 6: 
          do
          {
            ...
            parambika = this.jdField_a_of_type_AndroidGraphicsRect;
            parambika.top -= this.jdField_a_of_type_Int;
            parambika = this.jdField_a_of_type_AndroidGraphicsRect;
            parambika.bottom += this.jdField_a_of_type_Int;
        ...
        if ((this.jdField_a_of_type_AndroidGraphicsRect != null) && ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.e())))
        {
          ...
          {
            label710:
            if ((!DoodleLayout.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) || (DoodleLayout.c(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) || (!(parambika instanceof biiw))) {
              break label1149;
            }
            parambika = (biiw)parambika;
            paramMotionEvent = parambika.jdField_a_of_type_Bijc;
            if ((!parambika.jdField_a_of_type_Bira.a(paramMotionEvent, f1, f3, false)) || (parambika.jdField_a_of_type_Boolean) || (!paramMotionEvent.b) || (paramMotionEvent.c)) {
              break label1149;
            }
        ...
        for (i = 1;; i = 0)
        {
          ...
          for (;;)
          {
            ...
            if (!(parambika instanceof bijm)) {
              break;
            }
            paramMotionEvent = ((bijm)parambika).a();
            ...
            for (;;)
            {
              ...
              else if ((parambika instanceof bijm))
              {
                paramMotionEvent = ((bijm)parambika).a();
                DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout, paramMotionEvent);
                this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setTrackerState(((bijm)parambika).a(), 0);
                ((bijm)parambika).c();
              }
            }
