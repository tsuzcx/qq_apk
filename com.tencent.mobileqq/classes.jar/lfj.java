...
public class lfj
{
  ...
  private lfk jdField_a_of_type_Lfk;
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Lfk == null)
    {
      ...
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().registerReceiver(this.jdField_a_of_type_Lfk, (IntentFilter)localObject);
    }
    if (QLog.isColorLevel()) {
      QLog.d("GCameraAvailabilityMonitor", 2, "register camera availability change callback");
    }
    this.jdField_a_of_type_JavaLangObject = mqy.a(localDexClassLoader, "com.tencent.av.camera2.CameraManagerWrapper");
    ...
    mqy.a(localDexClassLoader, localObject, "registerAvailabilityCb", new Class[] { Context.class, String.class, Handler.class }, new Object[] { localContext, str, null });
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().unregisterReceiver(this.jdField_a_of_type_Lfk);
        ...
        mqy.a(mqy.a(), this.jdField_a_of_type_JavaLangObject, "unRegisterAvailabilityCb", null, null);
        return;
      }
