...
class aghn
  implements aldq
{
  aghn(aghm paramaghm, CustomizeStrategyFactory.RedPacketInfo paramRedPacketInfo) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      ...
      BitmapFactory.Options localOptions = bhmq.a(str1, paramInt);
    ...
    if (paramInt < j)
    {
      ...
      localObject2 = SafeBitmapFactory.decodeFile((String)localObject2, bhmq.a((String)localObject2, i));
