...
public class apdq
{
  ...
  public static Rect a(Context paramContext, Rect paramRect, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if ((bjeh.c) && (bjeh.a))
      {
        paramInt1 = bjeh.b((Activity)paramContext);
  ...
  public static SpannableString a(String paramString1, String paramString2, apcz paramapcz)
  {
    ...
    for (int i = Color.parseColor("#A3CCEF");; i = j)
    {
      ...
      paramString1.setSpan(new amwx(new apdr(paramapcz), paramString2), k, k + m, 33);
      return paramString1;
    }
  }
  
  public static ayqd a(QQAppInterface paramQQAppInterface, long paramLong, ayoq paramayoq)
  {
    ayqd localayqd2 = TroopFileTransferManager.a(paramQQAppInterface, paramLong).a(paramayoq.jdField_b_of_type_JavaLangString);
    ayqd localayqd1 = localayqd2;
    if (localayqd2 == null)
    {
      localayqd1 = azjg.a(paramQQAppInterface, paramLong, paramayoq.jdField_a_of_type_JavaUtilUUID.toString(), paramayoq.jdField_b_of_type_JavaLangString, paramayoq.jdField_c_of_type_JavaLangString, paramayoq.jdField_a_of_type_Long, paramayoq.jdField_a_of_type_Int);
      localayqd1.jdField_c_of_type_JavaLangString = paramayoq.j;
      localayqd1.d = paramayoq.k;
      localayqd1.jdField_b_of_type_JavaLangString = paramayoq.i;
    }
    return localayqd1;
  }
  
  public static bahx a(int paramInt, String paramString, View.OnClickListener paramOnClickListener)
  {
    bahx localbahx = new bahx();
    localbahx.jdField_a_of_type_JavaLangString = paramString;
    localbahx.jdField_b_of_type_Int = paramInt;
    localbahx.jdField_b_of_type_Boolean = true;
    localbahx.jdField_a_of_type_AndroidViewView$OnClickListener = paramOnClickListener;
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, TextView paramTextView1, TextView paramTextView2, String paramString1, String paramString2)
  {
    ...
    int i = aciy.a(7.0F, paramContext.getResources());
    int j = (int)paramTextView2.measureText(paramString2);
    int k = aciy.a(15.0F, paramContext.getResources());
    switch (paramInt1)
    {
    case 1: 
    default: 
  ...
  public static String a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      if (localStringBuilder.length() > 0) {
        localStringBuilder.append(paramContext.getString(2131626862));
      }
  ...
  private static String a(AppInterface paramAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (apck.b((String)localObject)))
      {
        if (QLog.isDebugVersion()) {
      ...
      str1 = str1 + bach.a(paramAppInterface.getBytes()) + ".tmp";
      if (apdh.a(str1) > 0L) {
        localObject = str1;
      }
      for (;;)
      {
        if (apck.b((String)localObject))
        {
          if (QLog.isDebugVersion()) {
        ...
        paramAppInterface = apbo.a().c() + becz.a(paramAppInterface);
        if (!apck.b(paramAppInterface)) {
          break;
        }
        if (QLog.isDebugVersion()) {
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      if (((azjh)localObject).a(String.valueOf(paramLong1), String.valueOf(paramLong2))) {
        return ajjy.a(2131643927);
      }
      localObject = ((azjh)localObject).a(String.valueOf(paramLong1));
      paramQQAppInterface = (TroopManager)paramQQAppInterface.getManager(52);
      if ((localObject != null) && (((azjo)localObject).jdField_a_of_type_Long != 0L))
      {
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(Context paramContext, Rect paramRect, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   194: iconst_1
    //   195: invokestatic 727	atdp:a	(Ljava/lang/String;I)Z
    //   198: istore 4
    //   200: aload 8
    //   202: ldc_w 729
    //   205: iload 4
    ...
    //   224: invokestatic 730	atdp:a	(Ljava/lang/String;)Ljava/lang/String;
    //   227: astore 7
    //   229: aload 7
    ...
    //   326: aload_2
    //   327: aload 7
    //   329: invokestatic 756	adwz:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   332: iconst_m1
    //   333: iload 6
    //   335: invokestatic 761	bfcq:a	(Landroid/content/Context;Landroid/os/Bundle;Ladye;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    //   338: return
    //   339: aload 8
    //   341: ldc_w 673
    //   344: iconst_1
    ...
    //   441: aload_2
    //   442: aload 7
    //   444: invokestatic 756	adwz:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   447: iconst_m1
    //   448: aload_3
    //   449: getfield 776	com/tencent/mobileqq/activity/aio/SessionInfo:c	I
    //   452: invokestatic 761	bfcq:a	(Landroid/content/Context;Landroid/os/Bundle;Ladye;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    //   455: return
    //   456: astore_0
    //   457: aload_0
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, apcz paramapcz)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramString2))) {
      if (paramTextView.getWidth() == 0) {
        paramTextView.post(new QFileUtils.2(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramapcz));
      }
    }
    while (TextUtils.isEmpty(str.replace(" ", "")))
    {
      return;
      b(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramapcz);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    int i = apir.a(paramFileManagerEntity);
    paramFileManagerEntity = apir.a(localFileManagerEntity);
    ...
    paramFileManagerEntity.putExtra("forward_text", ajjy.a(2131643926) + apck.d(localFileManagerEntity.fileName) + ajjy.a(2131643938) + apdh.a(localFileManagerEntity.fileSize) + "。");
    paramFileManagerEntity.putExtra("k_favorites", apck.c(localFileManagerEntity));
    if ((!apdh.b(localFileManagerEntity.getFilePath())) && ((localFileManagerEntity.getCloudType() == 6) || (localFileManagerEntity.getCloudType() == 7)) && (localFileManagerEntity.nFileType == 0)) {
      paramFileManagerEntity.putExtra("forward_type", 0);
    }
    ...
    {
      apbx.a(paramActivity, 2131627035, 2131627040, new apdv(paramActivity, paramFileManagerEntity));
      return;
    }
    aphp.a(paramActivity, paramFileManagerEntity, 103);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    {
      return;
      paramString2 = azjg.a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramString3, paramLong2, paramInt);
    } while (paramString2 == null);
    paramString1 = new Bundle();
    paramString1.putInt("dataline_forward_type", 100);
    if (bace.b(paramString2.jdField_a_of_type_JavaLangString)) {
      paramString1.putString("dataline_forward_path", paramString2.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      paramQQAppInterface = (ajgm)paramQQAppInterface.a(8);
      paramString2 = new apdy(paramContext);
      paramInt = paramQQAppInterface.a().b(ajed.z, paramString1, paramString2);
      if ((paramString2.a) && (paramInt != 0)) {
        break;
      }
      cv.b(paramContext, paramInt);
      return;
      paramString3 = apck.a(paramString2);
      paramString3.status = 2;
      paramString3.nOpType = 24;
      paramString3 = apir.a(paramString3);
      paramString3.d(1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, ayqd paramayqd, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      paramayqd = new aoww(paramQQAppInterface, paramContext, paramLong1, paramayqd, paramInt1);
      paramayqd.a(paramLong2);
      paramayqd.a(paramString);
      paramayqd.a(paramSessionInfo);
      paramayqd.a(paramChatMessage);
      paramayqd.a(paramBoolean1);
      ...
      paramContext = new aows(paramContext, paramayqd);
  ...
  {
    aojd.a(paramContext, new apds(paramQQAppInterface, paramContext, paramFileManagerEntity, paramInt2, paramSessionInfo, paramChatMessage, paramBoolean1, paramBoolean2, paramInt1, paramRect));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, FileManagerEntity paramFileManagerEntity)
  {
    ...
    do
    {
      ...
      localBundle.putParcelable("fileinfo", apir.a(paramFileManagerEntity));
      paramFileManagerEntity = (ajgm)paramQQAppInterface.a(8);
      localapdw = new apdw(paramContext);
      i = paramFileManagerEntity.a().b(ajed.z, localBundle, localapdw);
    } while ((localapdw.a) && (i != 0));
    cv.b(paramContext, i);
    awqx.b(paramQQAppInterface, "CliOper", "", "", "0X800644B", "0X800644B", 0, 0, "6", "", "", "");
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!apck.a(paramMessageRecord1))) {}
    int i;
    do
    {
      String str;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<ayoq> paramList, Activity paramActivity, long paramLong)
  {
    ...
    {
      ayqd localayqd = a(paramQQAppInterface, paramLong, (ayoq)paramList.next());
      FileManagerEntity localFileManagerEntity = apck.a(localayqd);
      ...
      {
        localForwardFileInfo.f(localayqd.jdField_c_of_type_JavaLangString);
        label209:
        localForwardFileInfo.d(1);
        localForwardFileInfo.a(3);
        if (!bace.b(localayqd.jdField_a_of_type_JavaLangString)) {
          break label295;
        }
        localArrayList2.add(Uri.parse(localayqd.jdField_a_of_type_JavaLangString));
      }
      for (;;)
      {
        long l2 = localayqd.jdField_c_of_type_Long;
        localArrayList1.add(localForwardFileInfo);
        l1 = l2 + l1;
        break;
        if (TextUtils.isEmpty(localayqd.d)) {
          break label209;
        }
        localForwardFileInfo.f(localayqd.d);
        break label209;
        label295:
    ...
    paramQQAppInterface = ajjy.a(2131643928);
    if (localArrayList1.size() == 1) {
      paramQQAppInterface = ajjy.a(2131643936) + apck.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + ajjy.a(2131643937) + apdh.a(((ForwardFileInfo)localArrayList1.get(0)).d()) + "。";
    }
    for (;;)
    {
      paramList.putExtra("forward_text", paramQQAppInterface);
      paramList.putExtra("k_favorites", false);
      aphp.a(paramActivity, paramList, 103);
      return;
      if (localArrayList1.size() > 1) {
        paramQQAppInterface = ajjy.a(2131643932) + apck.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + ajjy.a(2131643931) + localArrayList1.size() + ajjy.a(2131643934) + apdh.a(l1) + "。";
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    String str1 = apck.a(paramString);
    Uri localUri = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
    String str2 = axxf.a(paramContext, str1);
    int i = ey.a(paramString);
  ...
  public static boolean a(Context paramContext, boolean paramBoolean, apdk paramapdk)
  {
    int j = 2;
    boolean bool1;
    ...
    do
    {
      ...
      i = 3;
      bool2 = bati.a(localActivity, i, new apdt(paramapdk), "");
      bool1 = bool2;
    } while (!bool2);
    ...
    for (int i = j;; i = 1)
    {
      return bbrm.a(paramContext, i, new apdu(paramapdk));
      i = 2;
      break;
    }
  }
  ...
  {
    int i = bajr.a(paramQQAppInterface, null);
    paramQQAppInterface = (aofy)paramQQAppInterface.getManager(317);
    if (i >> 8 == 2)
    {
  ...
  public static String b(long paramLong)
  {
    ...
    if (paramLong > 1048576L)
    {
      ...
      return ajjy.a(2131643930) + str + "MB/s";
    }
    if (paramLong > 1024L)
    {
      f = (float)paramLong / 1024.0F;
      str = new DecimalFormat("0.00").format(f);
      return ajjy.a(2131643929) + str + "KB/s";
    }
    return ajjy.a(2131643935) + paramLong + "KB/s";
  }
  
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, apcz paramapcz)
  {
    String str = a(paramContext, paramString1, paramString2, paramString3, paramString4);
    Object localObject = null;
    str = apck.a(paramTextView, 2, paramString5 + str, paramString2);
    paramString2 = localObject;
    if (!TextUtils.isEmpty(str))
    {
      paramContext = a(paramContext, paramString1, str, paramString3, paramString4);
      paramContext = apck.a(paramTextView, paramString5 + paramContext);
      paramString1 = a(paramContext, str, ajjy.a(2131643933));
      if (!paramBoolean) {
        break label155;
      }
    }
    label155:
    for (paramString2 = a(paramContext, paramString1, paramapcz);; paramString2 = new SpannableString(paramContext))
    {
  ...
  {
    if ((paramMessageRecord1 == null) || (!apck.a(paramMessageRecord1))) {}
    while ((paramMessageRecord2 == null) || (!apck.a(paramMessageRecord2))) {
      return;
    }
