  ...
  implements Handler.Callback
{
  ...
  public audn(GestureFrameLayout paramGestureFrameLayout, List<audm> paramList, View.OnClickListener paramOnClickListener, audo paramaudo)
  {
    ...
    this.jdField_a_of_type_Audk = new audk();
    this.jdField_a_of_type_Audk.a(2131364824, this.jdField_a_of_type_AndroidContentContext.getString(2131691303), 2130838597);
    this.jdField_a_of_type_Audk.a(2131366632, this.jdField_a_of_type_AndroidContentContext.getString(2131692753), 2130838606);
    this.jdField_a_of_type_Audk.a(2131377659, this.jdField_a_of_type_AndroidContentContext.getString(2131699264), 2130838606);
    this.jdField_a_of_type_Audk.a(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    if (aued.a()) {}
    for (paramGestureFrameLayout = new aued();; paramGestureFrameLayout = null)
    {
      this.jdField_a_of_type_Aued = paramGestureFrameLayout;
      return;
    }
  }
  ...
  private void a(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        audm localaudm = (audm)paramMotionEvent1.next();
        k = this.jdField_a_of_type_JavaUtilList.indexOf(localaudm);
        if (a(new Point(i, j), localaudm)) {
          a(localaudm, k);
        }
      }
    }
    ...
    if (this.jdField_a_of_type_AndroidGraphicsPoint != null)
    {
      ...
      while (paramMotionEvent1.hasNext())
      {
        paramMotionEvent2 = (audm)paramMotionEvent1.next();
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, audm paramaudm)
  {
    Point localPoint1 = (Point)paramaudm.jdField_a_of_type_JavaUtilList.get(0);
    Point localPoint2 = (Point)paramaudm.jdField_a_of_type_JavaUtilList.get(1);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint1.x, localPoint1.y, localPoint2.x, localPoint2.y)) {
      return true;
    }
    Point localPoint3 = (Point)paramaudm.jdField_a_of_type_JavaUtilList.get(2);
    paramaudm = (Point)paramaudm.jdField_a_of_type_JavaUtilList.get(3);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint3.x, localPoint3.y, paramaudm.x, paramaudm.y)) {
      return true;
    }
    return (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint2.x, localPoint2.y, localPoint3.x, localPoint3.y)) || (a(paramInt1, paramInt2, paramInt3, paramInt4, paramaudm.x, paramaudm.y, localPoint1.x, localPoint1.y));
  }
  
  private static boolean a(Point paramPoint, audm paramaudm)
  {
    if ((paramPoint.y > paramaudm.e) || (paramPoint.y < paramaudm.g) || (paramPoint.x > paramaudm.d) || (paramPoint.x < paramaudm.f)) {}
    int i;
    do
    {
      Point localPoint1;
      ...
      {
        return false;
        if (paramaudm.jdField_a_of_type_Int % 90 < 1) {
          return true;
        }
        Point localPoint2 = (Point)paramaudm.jdField_a_of_type_JavaUtilList.get(0);
        localPoint1 = (Point)paramaudm.jdField_a_of_type_JavaUtilList.get(1);
        paramaudm = (Point)paramaudm.jdField_a_of_type_JavaUtilList.get(2);
        localPoint3 = a(localPoint2, localPoint1);
        i = a(localPoint3, a(localPoint2, paramPoint));
      } while ((i < 0) || (i > a(localPoint3, localPoint3)));
      paramaudm = a(localPoint1, paramaudm);
      i = a(paramaudm, a(localPoint1, paramPoint));
    } while (i < 0);
    if (i <= a(paramaudm, paramaudm)) {}
  ...
  private boolean a(MotionEvent paramMotionEvent, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      audm localaudm = (audm)paramMotionEvent.next();
      if (!a(new Point(j, k), localaudm)) {
        break label208;
      }
      if ((!paramBoolean1) && (!paramBoolean2))
      {
        ...
        {
          bool = true;
          localaudm.jdField_b_of_type_Boolean = bool;
      ...
      {
        if ((localaudm.jdField_b_of_type_Boolean) && (!paramBoolean2))
        {
          this.jdField_c_of_type_Int = 1;
          if (paramBoolean1) {
            this.jdField_a_of_type_Audm = localaudm;
          }
        }
        bool = true;
      }
  ...
  {
    int i = 2;
    this.jdField_a_of_type_Audo.a();
    if ((this.jdField_c_of_type_Int == 1) && (this.jdField_a_of_type_Audm != null))
    {
      Object localObject = (Point)this.jdField_a_of_type_Audm.jdField_a_of_type_JavaUtilList.get(0);
      paramMotionEvent = (Point)this.jdField_a_of_type_Audm.jdField_a_of_type_JavaUtilList.get(1);
      ...
      this.jdField_a_of_type_Audk.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout, j, k);
    }
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      axqy.b(null, "dc00898", "", "", "0X800AAEE", "0X800AAEE", i, 0, String.valueOf(this.jdField_a_of_type_Int), "0", "0", "");
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Audm = null;
  ...
  public void a(audm paramaudm, int paramInt)
  {
    boolean bool = true;
    if (this.jdField_c_of_type_Int == -1)
    {
      if (paramaudm.jdField_b_of_type_Boolean)
      {
        paramInt = 2;
    ...
    for (;;)
    {
      if (bool != paramaudm.jdField_b_of_type_Boolean)
      {
        this.jdField_a_of_type_Int += 1;
        paramaudm.jdField_b_of_type_Boolean = bool;
        this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout);
  ...
  {
    this.jdField_a_of_type_Aued.a(1);
    this.jdField_a_of_type_Audo.b();
    return super.a(paramScaleGestureDetector);
  }
  
  public void b(MotionEvent paramMotionEvent)
  {
    this.jdField_a_of_type_Audk.a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    axrn.a(BaseApplication.getContext()).a(null, "actOcrGestureType", true, 0L, 0L, paramMessage, null);
