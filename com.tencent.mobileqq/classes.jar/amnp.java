...
public class amnp
  extends BaseAdapter
{
  aeev jdField_a_of_type_Aeev;
  Context jdField_a_of_type_AndroidContentContext;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener;
  public ArrayList<Object> a;
  View.OnClickListener b;
  
  public amnp(Context paramContext, ArrayList<Object> paramArrayList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, aeev paramaeev)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof amnq)))
      {
        localObject1 = (amnq)paramView.getTag();
        ((amnq)localObject1).jdField_a_of_type_JavaLangObject = localObject2;
        ((amnq)localObject1).jdField_a_of_type_JavaLangString = ((aeet)this.jdField_a_of_type_Aeev).c;
        if (!(localObject2 instanceof MessageForStructing)) {
          break label336;
        }
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && ((((MessageForStructing)localObject2).structingMsg instanceof AbsShareMsg)))
        {
          ...
          a(((amnq)localObject1).jdField_a_of_type_ComTencentImageURLImageView, localAbsShareMsg);
          ((amnq)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(a(localAbsShareMsg, "title"));
          ((amnq)localObject1).b.setText(localAbsShareMsg.mSourceName);
        }
        label153:
        if (!this.jdField_a_of_type_Aeev.b()) {
          break label361;
        }
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Aeev.a.a((ChatMessage)localObject2));
      }
      for (;;)
      {
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localObject1 = new amnq(this);
        paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562948, null);
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376256));
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131378070));
        ((amnq)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131378068));
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363669));
        ((amnq)localObject1).b = ((TextView)paramView.findViewById(2131371504));
        paramView.setTag(localObject1);
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject1);
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        break;
        label336:
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("");
        ((amnq)localObject1).b.setText("");
        break label153;
        label361:
        ((amnq)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(8);
      }
    }
    ...
    for (;;)
    {
      ...
      break;
      label427:
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562949, null);
