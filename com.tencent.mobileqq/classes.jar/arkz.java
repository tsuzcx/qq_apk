...
{
  public arkz(HotChatFlashPicActivity paramHotChatFlashPicActivity) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      do
      {
        ...
        do
        {
          ...
          HotChatFlashPicActivity.a(this.a).setImageResource(2130842507);
          if (HotChatFlashPicActivity.b(this.a)) {
            HotChatFlashPicActivity.a(this.a).setText(2131692927);
          }
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            HotChatFlashPicActivity.a(this.a).setImageResource(2130842509);
            if (HotChatFlashPicActivity.b(this.a)) {
              HotChatFlashPicActivity.a(this.a).setText(2131692931);
            }
            while (HotChatFlashPicActivity.a(this.a).a())
            {
              HotChatFlashPicActivity.a(this.a).b();
    ...
    case 4: 
      if (HotChatFlashPicActivity.b(this.a)) {
        if (HotChatFlashPicActivity.a(this.a) >= 2) {
          paramMessage = this.a.getString(2131692930);
        }
      }
      break;
    }
    for (;;)
    {
      HotChatFlashPicActivity.a(this.a, bglp.a(this.a, paramMessage, 0, 2131718062, null, new arla(this)));
      ...
      return false;
      paramMessage = this.a.getString(2131692929);
      continue;
      if (HotChatFlashPicActivity.a(this.a) == 2)
      {
        ...
        if (!HotChatFlashPicActivity.e(this.a))
        {
          ...
          {
            bcst.b(this.a.app, "dc00898", "", "", "0X80069A3", "0X80069A3", 0, 0, "", "", "", "");
            continue;
          }
          if (HotChatFlashPicActivity.b(this.a) == 3000)
          {
            bcst.b(this.a.app, "dc00898", "", "", "0X80069A4", "0X80069A4", 0, 0, "", "", "", "");
            continue;
          }
          localObject = paramMessage;
          if (HotChatFlashPicActivity.b(this.a) == 1) {
            bcst.b(this.a.app, "dc00898", "", "", "0X80069A5", "0X80069A5", 0, 0, "", "", "", "");
          }
        }
      }
      else if (HotChatFlashPicActivity.a(this.a) < 2)
      {
        ...
        if (!HotChatFlashPicActivity.e(this.a))
        {
          if (HotChatFlashPicActivity.b(this.a) == 0)
          {
            bcst.b(this.a.app, "dc00898", "", "", "0X80069A0", "0X80069A0", 0, 0, "", "", "", "");
            continue;
          }
          if (HotChatFlashPicActivity.b(this.a) == 3000)
          {
            bcst.b(this.a.app, "dc00898", "", "", "0X80069A1", "0X80069A1", 0, 0, "", "", "", "");
            continue;
          }
          localObject = paramMessage;
          if (HotChatFlashPicActivity.b(this.a) == 1) {
            bcst.b(this.a.app, "dc00898", "", "", "0X80069A2", "0X80069A2", 0, 0, "", "", "", "");
          }
        }
      }
      else
