  ...
  implements yej
{
  ...
  public yei(int paramInt1, int paramInt2, float paramFloat, Map<String, Bitmap> paramMap, Bitmap paramBitmap)
  {
    ...
    this.jdField_a_of_type_JavaLangString = yey.a(new Object[] { "rounded", "r=", Integer.valueOf(paramInt1), "dm=", Integer.valueOf(paramInt2), "ds=", Float.valueOf(paramFloat) });
  }
  ...
  public Bitmap a(Bitmap paramBitmap)
  {
    for (;;)
    {
      try
      {
        ...
        yex.a(paramBitmap, localBitmap, i, j, k, m, null, false);
        continue;
        paramBitmap = this.jdField_a_of_type_AndroidGraphicsBitmap;
      }
      catch (Exception paramBitmap)
      {
        ykq.e("RoundedTransformation", "occur error:" + paramBitmap);
        return null;
      }
      label414:
      continue;
