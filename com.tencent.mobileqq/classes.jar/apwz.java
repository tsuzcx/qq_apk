...
public class apwz
{
  ...
  apwz(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a()
  {
    ...
    Iterator localIterator = ((aqzf)localObject1).a.iterator();
    while (localIterator.hasNext())
    {
      Object localObject2 = (aqzp)localIterator.next();
      if (localObject2 != null)
      {
        aqzo localaqzo = ((aqzp)localObject2).jdField_a_of_type_Aqzo;
        if (localaqzo != null)
        {
          localObject2 = ((aqzp)localObject2).jdField_a_of_type_Aqzr;
          if ((localObject2 != null) && (a(localaqzo)))
          {
            localObject2 = b((aqzr)localObject2);
            if (localObject2 != null)
            {
              ArkAppCenter.c("ArkApp.Dict.Update", String.format("getEffectDictIdentifier, use condition dict, dict-id=%s, condition=%s", new Object[] { localObject2, localaqzo.toString() }));
              return localObject2;
            }
          }
        }
    ...
    localObject1 = b((aqzr)localObject1);
  ...
  {
    return apww.a(paramString) + "/WordData";
  }
  ...
  private static Map<String, apxj> a(aqzr paramaqzr)
  {
    if (paramaqzr == null) {
      return new HashMap();
    }
    Object localObject = paramaqzr.jdField_b_of_type_JavaUtilArrayList;
    if (localObject == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "getDictInfoFromConfig, 'word_dict_list' field not found");
      return new HashMap();
    }
    paramaqzr = new HashMap();
    localObject = ((ArrayList)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      apxj localapxj = (apxj)((Iterator)localObject).next();
      if (localapxj != null) {
        paramaqzr.put(localapxj.a, localapxj);
      }
    }
    return paramaqzr;
  }
  
  private void a(aqzr paramaqzr1, aqzr paramaqzr2, apxl paramapxl)
  {
    if (paramaqzr2 == null)
    {
    ...
    for (;;)
    {
      ...
      Object localObject = a(paramaqzr2);
      ...
      paramaqzr2 = b(paramaqzr1);
      paramaqzr1 = a(paramaqzr1);
      apxn localapxn = new apxn(null);
      localapxn.jdField_a_of_type_Int = ((Map)localObject).size();
      localapxn.jdField_a_of_type_Boolean = true;
      localObject = ((Map)localObject).values().iterator();
      while (((Iterator)localObject).hasNext())
      {
        apxj localapxj = (apxj)((Iterator)localObject).next();
        a(str2, paramaqzr2, (apxj)paramaqzr1.get(localapxj.a), localapxj, new apxb(this, localapxn, localapxj, str2, paramapxl, str1));
      }
    }
  }
  
  private void a(String paramString, apxj paramapxj, apxl paramapxl)
  {
    a(paramapxj.a, paramapxj.jdField_b_of_type_JavaLangString, new apxg(this, paramapxj, paramString, paramapxl));
  }
  
  private void a(String paramString1, String paramString2, apxj paramapxj1, apxj paramapxj2, apxl paramapxl)
  {
    boolean bool = false;
    if (!a(paramString2, paramapxj1)) {
      paramapxj1 = null;
    }
    for (;;)
    {
      if (paramapxj1 == null)
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, local not exists, full update, name=%s", new Object[] { paramapxj2.a }));
        a(paramString1, paramapxj2, new apxc(this, paramapxj2, paramapxl));
        return;
      }
      if (paramapxj1.d.equals(paramapxj2.d))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, file not change, copy from origin, name=%s", new Object[] { paramapxj2.a }));
        paramString2 = b(paramString2, paramapxj1.a);
        paramString1 = String.format("%s/%s", new Object[] { paramString1, paramapxj2.a });
      ...
      for (;;)
      {
        paramapxl.a(bool);
        return;
        if ((paramapxj2.b()) && (paramapxj1.d.equals(paramapxj2.g)))
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, incremental update, name=%s", new Object[] { paramapxj2.a }));
          b(paramString1, paramString2, paramapxj1, paramapxj2, new apxd(this, paramapxj2, paramapxl, paramString1));
          return;
        }
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, full update, name=%s", new Object[] { paramapxj2.a }));
        a(paramString1, paramapxj2, new apxf(this, paramapxl));
        return;
        label281:
        bool = true;
      }
  ...
  private void a(String paramString1, String paramString2, apxk paramapxk)
  {
    apxm localapxm = new apxm(null);
    ...
    localapxm.jdField_a_of_type_JavaLangRefWeakReference = new java.lang.ref.WeakReference(localPreDownloadController);
    paramapxk = new ArkAiDictUpdateMgr.8(this, paramString2, localapxm, paramapxk);
    if (localQQAppInterface == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "downloadDictFile, qq app interface is null, return");
      return;
    }
    localapxm.jdField_a_of_type_Boolean = localPreDownloadController.isEnable();
    if (localapxm.jdField_a_of_type_Boolean)
    {
      localPreDownloadController.requestPreDownload(10022, "prd", paramString1, 0, paramString2, "", 1, 0, false, new RunnableTask(localQQAppInterface, paramString1, paramapxk, 10000L));
      return;
    }
    paramapxk.run();
  ...
  private static boolean a(aqzo paramaqzo)
  {
    if (paramaqzo == null) {}
    for (;;)
    {
      return false;
      paramaqzo = paramaqzo.a;
      String[] arrayOfString = paramaqzo.split("-");
      if (arrayOfString.length == 2) {
        ...
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "isDictConditionEffect, invalid date, date=%s", new Object[] { paramaqzo }));
        }
      }
    }
    return false;
  ...
  private boolean a(aqzr paramaqzr)
  {
    if (paramaqzr == null)
    {
    ...
    String str = b(paramaqzr);
    paramaqzr = a(paramaqzr);
    if (paramaqzr == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "checkLocalDictIntegrity, local dict list is empty");
      return true;
    }
    Iterator localIterator = paramaqzr.values().iterator();
    do
    {
      if (!localIterator.hasNext()) {
        break;
      }
    } while (a(str, (apxj)localIterator.next()));
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
      ...
      ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "checkLocalDictIntegrity, %d of %d files need update", new Object[] { Integer.valueOf(i), Integer.valueOf(paramaqzr.size()) }));
      return false;
    }
  }
  
  private static boolean a(String paramString, apxj paramapxj)
  {
    if (paramapxj == null) {}
    while (!b(b(paramString, paramapxj.a), paramapxj.d)) {
      return false;
    }
    return true;
  }
  ...
  public static boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   15: iload_2
    //   16: ireturn
    //   17: new 418	java/io/FileOutputStream
    //   20: dup
    //   21: aload_1
    //   22: invokespecial 421	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   25: astore 4
    //   27: aload 4
    //   29: astore_3
    //   30: aload 4
    //   32: aload_0
    //   33: invokevirtual 425	java/io/FileOutputStream:write	([B)V
    //   36: aload 4
    //   38: ifnull -23 -> 15
    //   41: aload 4
    //   43: invokevirtual 428	java/io/FileOutputStream:close	()V
    //   46: iconst_1
    //   47: ireturn
    //   48: astore_0
    //   49: ldc 127
    ...
    //   62: iconst_0
    //   63: aload_0
    //   64: invokevirtual 433	java/io/IOException:getMessage	()Ljava/lang/String;
    //   67: aastore
    //   68: dup
    //   69: iconst_1
    //   70: aload_1
    ...
    //   101: iconst_0
    //   102: aload 5
    //   104: invokevirtual 433	java/io/IOException:getMessage	()Ljava/lang/String;
    //   107: aastore
    //   108: dup
    //   109: iconst_1
    //   110: aload_0
    ...
    //   128: ifnull +8 -> 136
    //   131: aload 4
    //   133: invokevirtual 428	java/io/FileOutputStream:close	()V
    //   136: iconst_0
    //   137: ireturn
    //   138: astore_0
    //   139: ldc 127
    ...
    //   152: iconst_0
    //   153: aload_0
    //   154: invokevirtual 433	java/io/IOException:getMessage	()Ljava/lang/String;
    //   157: aastore
    //   158: dup
    //   159: iconst_1
    //   160: aload_1
    ...
    //   175: ifnull +7 -> 182
    //   178: aload_3
    //   179: invokevirtual 428	java/io/FileOutputStream:close	()V
    //   182: aload_0
    //   183: athrow
    //   184: astore_3
    //   185: ldc 127
    ...
    //   198: iconst_0
    //   199: aload_3
    //   200: invokevirtual 433	java/io/IOException:getMessage	()Ljava/lang/String;
    //   203: aastore
    //   204: dup
    //   205: iconst_1
    //   206: aload_1
  ...
  private static String b(aqzr paramaqzr)
  {
    if (paramaqzr == null) {}
    String str;
    do
    {
      return null;
      str = paramaqzr.c;
      paramaqzr = paramaqzr.jdField_b_of_type_JavaLangString;
    } while ((TextUtils.isEmpty(str)) || (TextUtils.isEmpty(paramaqzr)));
    return String.format("%s-%s", new Object[] { str, paramaqzr });
  }
  ...
  private static Map<String, aqzr> b(aqzf paramaqzf)
  {
    ...
    Object localObject1 = b(paramaqzf);
    if (localObject1 != null) {
      localHashMap.put(localObject1, paramaqzf);
    }
    paramaqzf = paramaqzf.a.iterator();
    while (paramaqzf.hasNext())
    {
      Object localObject2 = (aqzp)paramaqzf.next();
      if (localObject2 != null)
      {
        localObject1 = ((aqzp)localObject2).jdField_a_of_type_Aqzo;
        localObject2 = ((aqzp)localObject2).jdField_a_of_type_Aqzr;
        if ((localObject1 != null) && (localObject2 != null))
        {
          localObject1 = b((aqzr)localObject2);
          if (localObject1 != null) {
  ...
  private void b(String paramString1, String paramString2, apxj paramapxj1, apxj paramapxj2, apxl paramapxl)
  {
    a(paramapxj2.a, paramapxj2.e, new apxh(this, paramapxj2, paramString2, paramapxj1, paramString1, paramapxl));
  }
  
  private static boolean b(aqzr paramaqzr)
  {
    if (paramaqzr == null) {
      return false;
    }
    paramaqzr = paramaqzr.e;
    if ((TextUtils.isEmpty(paramaqzr)) || (paramaqzr.equalsIgnoreCase("wifi")))
    {
      if ((AppNetConnInfo.isNetSupport()) && (AppNetConnInfo.isWifiConn()))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("getNetType, invalid dict info, netType=%s", new Object[] { paramaqzr }));
        return true;
      }
  ...
  private static boolean b(String paramString1, String paramString2)
  {
    ...
    //   14: iconst_0
    //   15: ireturn
    //   16: new 458	java/io/File
    //   19: dup
    //   20: aload_0
    //   21: invokespecial 459	java/io/File:<init>	(Ljava/lang/String;)V
    //   24: astore_0
    //   25: aload_0
    //   26: invokevirtual 506	java/io/File:isFile	()Z
    //   29: ifeq -15 -> 14
    //   32: sipush 4096
    //   35: newarray byte
    //   37: astore 5
    //   39: ldc_w 508
    //   42: invokestatic 514	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   45: astore 6
    //   47: new 516	java/io/FileInputStream
    //   50: dup
    //   51: aload_0
    //   52: invokespecial 519	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   55: astore 4
    //   57: aload 4
    //   59: astore_0
    //   60: aload 4
    //   62: aload 5
    //   64: invokevirtual 523	java/io/FileInputStream:read	([B)I
    //   67: istore_2
    //   68: iload_2
    //   69: ifgt +50 -> 119
    //   72: aload 4
    //   74: astore_0
    //   75: aload 6
    //   77: invokevirtual 527	java/security/MessageDigest:digest	()[B
    //   80: invokestatic 529	apwz:a	([B)Ljava/lang/String;
    //   83: aload_1
    //   84: invokevirtual 487	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   87: istore_3
    //   88: iload_3
    //   89: ifeq +15 -> 104
    //   92: aload 4
    //   94: ifnull +8 -> 102
    //   97: aload 4
    //   99: invokevirtual 530	java/io/FileInputStream:close	()V
    //   102: iconst_1
    //   103: ireturn
    //   104: aload 4
    //   106: ifnull -92 -> 14
    //   109: aload 4
    //   111: invokevirtual 530	java/io/FileInputStream:close	()V
    //   114: iconst_0
    //   115: ireturn
    //   116: astore_0
    //   117: iconst_0
    ...
    //   126: iconst_0
    //   127: iload_2
    //   128: invokevirtual 534	java/security/MessageDigest:update	([BII)V
    //   131: goto -74 -> 57
    //   134: astore_0
    //   135: aload 4
    //   137: astore_1
    ...
    //   153: iconst_0
    //   154: aload 4
    //   156: invokevirtual 537	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   159: aastore
    ...
    //   167: ifnull -153 -> 14
    //   170: aload_1
    //   171: invokevirtual 530	java/io/FileInputStream:close	()V
    //   174: iconst_0
    //   175: ireturn
    //   176: astore_0
    //   177: iconst_0
    ...
    //   183: ifnull +7 -> 190
    //   186: aload_0
    //   187: invokevirtual 530	java/io/FileInputStream:close	()V
    //   190: aload_1
    //   191: athrow
    //   192: astore_0
    //   193: goto -91 -> 102
  ...
  private static aqzf c()
  {
    ...
    try
    {
      localObject = (aqzf)aqxo.a(localObject, aqzf.class);
      return localObject;
    }
  ...
  private static void c(aqzf paramaqzf)
  {
    if (paramaqzf == null)
    {
  ...
  private static aqzf d()
  {
    aqyo localaqyo = aqyt.b(170).a();
    if (localaqyo == null)
    {
  ...
  private static void d(aqzf paramaqzf)
  {
    if (paramaqzf == null) {
