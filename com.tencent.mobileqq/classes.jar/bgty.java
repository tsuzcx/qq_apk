...
public class bgty
{
  private static bgty jdField_a_of_type_Bgty;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  
  public static bgty a()
  {
    if (jdField_a_of_type_Bgty == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Bgty == null) {
        jdField_a_of_type_Bgty = new bgty();
      }
      return jdField_a_of_type_Bgty;
    }
  }
  ...
  public void a(String paramString, Bundle paramBundle, MiniCmdCallback paramMiniCmdCallback)
  {
    ...
    for (;;)
    {
      ...
      if ("cmd_update_baselib".equals(paramString))
      {
        ...
        bgvs.a().b(new bgtz(this, paramMiniCmdCallback, paramString));
      }
      ...
      else
      {
        ...
        if ("cmd_rebind_engine_channel".equals(paramString))
        {
          ...
          if ((i == 0) || (i == 1))
          {
            ...
            for (i = 2;; i = 3)
            {
              for (;;)
              {
                ((Bundle)localObject1).putParcelable("engineChannel", ((bgwe)localObject3).a(i));
        ...
        else if ("cmd_rebind_engine_channel_new".equals(paramString))
        {
          ...
          if ((i == 0) || (i == 1))
          {
            ...
            for (i = j;; i = 3)
            {
              for (;;)
              {
                localBundle.putParcelable("engineChannel", ((bgwe)localObject3).a(i));
                if (paramMiniCmdCallback == null) {
                  break;
                }
                try
        ...
        else
        {
          ...
          if ("launch_report".equals(paramString))
          {
            if (paramBundle != null) {
              try
              {
                ...
                bhcn.a(localMiniAppInfo1, paramBundle.getString("app_type"), str1, paramBundle.getString("action_type"), (String)localObject3, str2, str3, null, null, null, null);
              }
          ...
          else if ("launch_report2".equals(paramString))
          {
            if (paramBundle != null)
            {
              paramBundle.setClassLoader(bhbs.class.getClassLoader());
              MiniAppInfo localMiniAppInfo2 = (MiniAppInfo)paramBundle.getParcelable("app_config");
              localObject3 = paramBundle.getString("sub_action");
              str1 = paramBundle.getString("path");
              bhbs.a((String)localObject3, paramBundle.getString("reserves"), str1, localMiniAppInfo2);
            }
            else
            {
              QMLog.e("MiniAppCmdServlet", "onMiniAppCmd cmd = " + paramString + ", bundle is null");
          ...
          else if ("record_duration".equals(paramString))
          {
            if (paramBundle != null) {
              ...
              {
                paramBundle.setClassLoader(bhcn.class.getClassLoader());
                bhcn.a((MiniAppInfo)paramBundle.getParcelable("app_config"), paramBundle.getLong("add_duration_ms"));
              }
