...
public class bfgs
{
  ...
  public static int a(Activity paramActivity)
  {
    ...
    {
      if (betc.a()) {
        betc.b("LiuHaiUtils", "getNotchInScreenHeight_AndroidP decorView=null ");
      }
      i = j;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramActivity == null)
        {
          ...
          betc.b("LiuHaiUtils", "getNotchInScreenHeight_AndroidP getRootWindowInsets inserts=null ");
          return j;
        }
        paramActivity = paramActivity.getClass().getMethod("getDisplayCutout", new Class[0]).invoke(paramActivity, new Object[0]);
        if (betc.a()) {
          betc.b("LiuHaiUtils", "getNotchInScreenHeight_AndroidP getDisplayCutout cutOut=" + paramActivity);
        }
        if (paramActivity != null)
        {
          ...
          betc.b("LiuHaiUtils", "getNotchInScreenHeight_AndroidP top:" + k);
          return k;
        }
      }
      ...
      {
        if (betc.a()) {
          betc.d("LiuHaiUtils", "getNotchInScreenHeight_AndroidP Exception");
        }
      }
    }
    return j;
  ...
  private static int a(String paramString, int paramInt)
  {
    ...
    catch (Exception paramString)
    {
      ...
      betc.a("LiuHaiUtils", "getSystemPropertyForXiaomi() Exception=" + paramString.getMessage());
    }
    return i;
    return paramInt;
  }
  ...
  {
    if (betc.a()) {
      betc.b("LiuHaiUtils", "initLiuHaiProperty manufacturer:" + Build.MANUFACTURER + " hasInitHasNotch:" + jdField_c_of_type_Boolean + " sHasNotch:" + jdField_a_of_type_Boolean + " sEnableNotchOK:" + jdField_b_of_type_Boolean + " sNotchHeight:" + jdField_a_of_type_Int);
    }
    if (!jdField_c_of_type_Boolean)
    {
      jdField_b_of_type_Int = bfgl.a(paramActivity);
      jdField_c_of_type_Int = bfgl.a(paramActivity);
    ...
    try
    {
      ...
      if (betc.a()) {
        betc.d("LiuHaiUtils", "initLiuHaiProperty[after] manufacturer:" + Build.MANUFACTURER + " hasInitHasNotch:" + jdField_c_of_type_Boolean + " sHasNotch:" + jdField_a_of_type_Boolean + " sEnableNotchOK:" + jdField_b_of_type_Boolean + " sNotchHeight:" + jdField_a_of_type_Int);
      }
      return;
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        if (betc.a()) {
          betc.d("LiuHaiUtils", "initLiuHaiProperty manufacturer:" + Build.MANUFACTURER, localThrowable);
        }
      }
    }
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    if (paramActivity == null) {
      if (betc.a()) {
        betc.b("LiuHaiUtils", "hasNotchInScreen_AndroidP decorView=null");
      }
    }
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (betc.a())
          {
            betc.b("LiuHaiUtils", "hasNotchInScreen_AndroidP getRootWindowInsets inserts=null");
            return false;
          }
        }
        catch (Exception paramActivity) {}
    ...
    betc.d("LiuHaiUtils", "hasNotchInScreen_AndroidP Exception");
    return false;
    label84:
    ...
    {
      if (betc.a()) {
        betc.b("LiuHaiUtils", "hasNotchInScreen_AndroidP getDisplayCutout  exists:" + bool);
      }
      return bool;
    }
  }
  ...
  public static boolean a(Context paramContext)
  {
    do
    {
      ...
      catch (Exception paramContext)
      {
        try
        {
          if (betc.a())
          {
            betc.b("LiuHaiUtils", "vivoHasNotchInScreen ret=" + bool1);
            bool2 = bool1;
          }
          return bool2;
        }
    ...
    betc.d("LiuHaiUtils", "vivoHasNotchInScreen Exception", paramContext);
    return bool1;
  }
  ...
  public static int[] a(Context paramContext)
  {
    ...
    if (Build.VERSION.SDK_INT >= 17)
    {
      ...
      if (betc.a()) {
        betc.b("LiuHaiUtils", "getRealDisplay manufacturer:" + Build.MANUFACTURER + " version:" + Build.VERSION.SDK_INT + " width:" + paramContext.widthPixels + " height:" + paramContext.heightPixels);
      }
      return new int[] { paramContext.widthPixels, paramContext.heightPixels };
    }
    boolean bool = bfgl.a(paramContext);
    if (bool) {}
    for (int i = bfgl.c(paramContext);; i = 0)
    {
      if (betc.a()) {
        betc.b("LiuHaiUtils", "getRealDisplay[none] manufacturer:" + Build.MANUFACTURER + " width:" + localDisplayMetrics.widthPixels + " height:" + localDisplayMetrics.heightPixels + " mNavigationBarHeight:" + i + " hasNavBar:" + bool);
      }
  ...
  public static int b(Activity paramActivity)
  {
    ...
    if (betc.a()) {
      betc.b("LiuHaiUtils", "getNotchInScreenHeight apiVersion: " + k);
    }
    int j = a(paramActivity);
    int i = j;
    if (j <= 0)
  ...
  public static int b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (int i = localObject[0];; i = 0)
      {
        ...
        if (betc.a()) {
          betc.d("LiuHaiUtils", "getNotchInScreenHeight manufacturer:" + Build.MANUFACTURER + " height:" + j + " width:" + i + " status:" + k);
        }
        return Math.max(j, k);
  ...
  public static boolean b(Activity paramActivity)
  {
    ...
    if (betc.a()) {
      betc.b("LiuHaiUtils", "enableNotch apiVersion: " + i);
    }
    if (i > 27) {
  ...
  private static int[] b(Context paramContext)
  {
    ...
    //   81: invokestatic 75	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   84: aload_0
    //   85: astore_1
    //   86: aload_1
    //   87: areturn
    ...
    //   91: aload_0
    //   92: astore_1
    //   93: invokestatic 68	betc:a	()Z
    //   96: ifeq -10 -> 86
    //   99: ldc 70
    //   101: ldc_w 369
    //   104: invokestatic 129	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   107: aload_0
    //   108: areturn
    //   109: astore_0
    //   110: aload_1
    ...
    //   112: aload_0
    //   113: astore_1
    //   114: invokestatic 68	betc:a	()Z
    //   117: ifeq -31 -> 86
    //   120: ldc 70
    //   122: ldc_w 371
    //   125: invokestatic 129	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   128: aload_0
    //   129: areturn
    //   130: astore_0
    //   131: aload_1
    ...
    //   133: aload_0
    //   134: astore_1
    //   135: invokestatic 68	betc:a	()Z
    //   138: ifeq -52 -> 86
    //   141: ldc 70
    //   143: ldc_w 373
    //   146: invokestatic 129	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   149: aload_0
    //   150: areturn
    //   151: astore_1
    //   152: goto -19 -> 133
  ...
  private static boolean c(Activity paramActivity)
  {
    ...
    String str = "" + Build.MANUFACTURER;
    if (betc.a()) {
      betc.b("LiuHaiUtils", "hasNotchInScreen version: " + i + " " + str);
    }
    boolean bool1;
    boolean bool2;
    float f1;
    if (i > 27)
    {
      ...
      if (betc.a()) {
        betc.b("LiuHaiUtils", "hasNotchInScreen haveNotch: " + bool1);
      }
      bool2 = bool1;
      if (!bool1)
      {
        ...
        if (b())
        {
          i = bfgl.a(paramActivity);
          int j = bfgl.a(paramActivity);
          float f2 = j * 1.0F / i;
          ...
          if (betc.a()) {
            betc.b("LiuHaiUtils", "hasNotchInScreen srcWidth: " + i + " srcHeight:" + j + " ratio:" + f1);
          }
          if (f1 < 2.06F) {
            break label281;
          }
  ...
  private static boolean c(Context paramContext)
  {
    ...
    //   67: invokestatic 75	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   70: iload_1
    //   71: istore_2
    //   72: iload_2
    //   73: ireturn
    ...
    //   77: iload_1
    //   78: istore_2
    //   79: invokestatic 68	betc:a	()Z
    //   82: ifeq -10 -> 72
    //   85: ldc 70
    //   87: ldc_w 406
    //   90: invokestatic 129	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   93: iload_1
    //   94: ireturn
    //   95: astore_0
    //   96: iconst_0
    ...
    //   98: iload_1
    //   99: istore_2
    //   100: invokestatic 68	betc:a	()Z
    //   103: ifeq -31 -> 72
    //   106: ldc 70
    //   108: ldc_w 408
    //   111: invokestatic 129	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   114: iload_1
    //   115: ireturn
    //   116: astore_0
    //   117: iconst_0
    ...
    //   119: iload_1
    //   120: istore_2
    //   121: invokestatic 68	betc:a	()Z
    //   124: ifeq -52 -> 72
    //   127: ldc 70
    //   129: ldc_w 410
    //   132: invokestatic 129	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   135: iload_1
    //   136: ireturn
    //   137: astore_0
    //   138: goto -19 -> 119
  ...
  private static int[] c(Context paramContext)
  {
    try
    {
      paramContext = bfgl.a("ro.oppo.screen.heteromorphism", null);
      if (TextUtils.isEmpty(paramContext))
      {
        if (betc.a()) {
          betc.b("LiuHaiUtils", "oppoGetNotchSize mProperty empty");
        }
        return null;
      }
    }
    catch (Throwable paramContext)
    {
      do
      {
        ...
        {
          if (betc.a()) {
            betc.b("LiuHaiUtils", "oppoGetNotchSize mProperty exp ", paramContext);
          }
          paramContext = null;
          continue;
          paramContext = paramContext.split(":");
          if (betc.a()) {
            betc.b("LiuHaiUtils", "oppoGetNotchSize mProperty values=" + paramContext);
          }
          if (paramContext.length >= 2)
          {
            String[] arrayOfString = paramContext[0].split(",");
            if (betc.a()) {
              betc.b("LiuHaiUtils", "oppoGetNotchSize mProperty values[0] size=" + arrayOfString);
            }
            if (arrayOfString.length >= 2) {
              try
              {
                ...
                if (betc.a()) {
                  betc.b("LiuHaiUtils", "oppoGetNotchSize mProperty values[0] left=" + i + " top=" + j);
                }
                arrayOfString = paramContext[1].split(",");
                if (betc.a()) {
                  betc.b("LiuHaiUtils", "oppoGetNotchSize mProperty values[1] size=" + arrayOfString);
                }
                int k;
                int m;
                if ((arrayOfString.length >= 2) && (betc.a())) {
                  betc.b("LiuHaiUtils", "oppoGetNotchSize values[0]=" + paramContext[0], localNumberFormatException1);
                }
              }
              catch (NumberFormatException localNumberFormatException1)
              {
                try
                {
                  ...
                  if (betc.a()) {
                    betc.b("LiuHaiUtils", "oppoGetNotchSize mProperty values[1] right=" + k + " bottom=" + m);
                  }
      ...
      betc.b("LiuHaiUtils", "oppoGetNotchSize values[1]=" + paramContext[1], localNumberFormatException2);
    }
    return null;
  }
  ...
  private static boolean d(Activity paramActivity)
  {
    try
    {
      ...
      if (betc.a()) {
        betc.b("LiuHaiUtils", "enableXiaoMiNotch true");
      }
      return true;
    }
    catch (Exception paramActivity)
    {
      if (betc.a()) {
        betc.d("LiuHaiUtils", "enableXiaoMiNotch Exception", paramActivity);
      }
    }
    return false;
  }
  ...
  private static boolean d(Context paramContext)
  {
    ...
    betc.b("LiuHaiUtils", "oppoHasNotchInScreen exits:" + bool2);
    return bool2;
  }
  ...
  private static int[] d(Context paramContext)
  {
    ...
    if (betc.a()) {
      betc.b("LiuHaiUtils", "xiaomiGetNotchSize [notch_width]resourceId: " + i);
    }
    if (i > 0) {
    ...
    if (betc.a()) {
      betc.b("LiuHaiUtils", "xiaomiGetNotchSize [notch_height]resourceId: " + i);
    }
    if (i > 0) {
      arrayOfInt[1] = paramContext.getResources().getDimensionPixelSize(i);
    }
    if (betc.a()) {
      betc.b("LiuHaiUtils", "xiaomiGetNotchSize width: " + arrayOfInt[0] + " height:" + arrayOfInt[1]);
    }
    return arrayOfInt;
  }
  ...
  private static boolean e(Activity paramActivity)
  {
    try
    {
      ...
      if (betc.a()) {
        betc.b("LiuHaiUtils", "enableMeizuNotch true");
      }
      return true;
    }
    catch (Exception paramActivity)
    {
      if (betc.a()) {
        betc.d("LiuHaiUtils", "enableMeizuNotch Exception", paramActivity);
      }
    }
    return false;
  }
  ...
  private static boolean e(Context paramContext)
  {
    try
    {
      if (Build.VERSION.SDK_INT >= 17)
      {
        ...
        if (i == 1)
        {
          ...
          betc.b("LiuHaiUtils", "xiaomiHasNotchInScreen closed: " + i);
          return false;
        }
        i = a("ro.miui.notch", 0);
        if (betc.a()) {
          betc.b("LiuHaiUtils", "xiaomiHasNotchInScreen isNotch: " + i);
        }
        if (i != 1) {
          break label127;
        }
    ...
    catch (Throwable paramContext)
    {
      ...
      while (betc.a())
      {
        betc.b("LiuHaiUtils", "xiaomiHasNotchInScreen crash: ", paramContext);
        return false;
        i = 0;
      }
    }
  ...
  private static boolean g(Activity paramActivity)
  {
    ...
    {
      if (betc.a()) {
        betc.b("LiuHaiUtils", "enableHuaWeiNotch invalid param");
      }
      bool = false;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if (betc.a())
        {
          betc.b("LiuHaiUtils", "enableHuaWeiNotch true");
          return true;
        }
      }
      catch (Exception paramActivity)
      {
        if (betc.a()) {
          betc.d("LiuHaiUtils", "enableHuaWeiNotch Exception", paramActivity);
        }
      }
    }
    return false;
  ...
  private static boolean h(Activity paramActivity)
  {
    ...
    do
    {
      ...
      betc.b("LiuHaiUtils", "enableNotchInScreen_AndroidO OPPO=true");
      return true;
      if (!str.equalsIgnoreCase("VIVO")) {
        break;
      }
    } while (!betc.a());
    betc.b("LiuHaiUtils", "enableNotchInScreen_AndroidO VIVO=true");
    return true;
    if (str.equalsIgnoreCase("XIAOMI")) {
  ...
  private static boolean i(Activity paramActivity)
  {
    ...
    try
    {
      ...
      if (betc.a()) {
        betc.b("LiuHaiUtils", "enableNotchInScreen_AndroidP true");
      }
      return true;
    }
    catch (Exception paramActivity)
    {
      if (betc.a()) {
        betc.d("LiuHaiUtils", "enableNotchInScreen_AndroidP Exception");
      }
    }
    return false;
  }
  ...
  private static boolean j(Activity paramActivity)
  {
    int i = Build.VERSION.SDK_INT;
    if (betc.a()) {
      betc.b("LiuHaiUtils", "enableNotchInScreen apiVersion: " + i);
    }
    return true;
  }
}
