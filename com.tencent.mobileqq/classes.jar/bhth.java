...
{
  public int a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bhtl(this);
  public String a;
  ...
  private int a(int paramInt)
  {
    ...
    if ((localbcci instanceof bcdc)) {
      i = ((bcdc)localbcci).switchRequestCode(this, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(int paramInt)
  {
    ...
    do
    {
      ...
      for (int i = 1; i != 0; i = 0)
      {
        bcpw.a(this.mRuntime.a(), 2131718252, 0).b(j);
        return;
      }
      a();
      switch (paramInt)
      ...
      case 1: 
        ...
        localbgyf.jdField_a_of_type_JavaLangString = this.mRuntime.a().getCurrentAccountUin();
        BaseBusinessAlbumInfo localBaseBusinessAlbumInfo = new BaseBusinessAlbumInfo();
        localBaseBusinessAlbumInfo.jdField_a_of_type_JavaLangString = localbgyf.jdField_a_of_type_JavaLangString;
        ...
        localBaseBusinessAlbumInfo.jdField_b_of_type_JavaLangString = this.mRuntime.a().getString(2131717744);
        bgxy.b(this.mRuntime.a(), localbgyf, localBaseBusinessAlbumInfo, -1, "cover_mall_record_video");
        return;
      }
      QLog.i("CoverStore", 1, "VIDEO_COVER click select record video.");
    } while (!bhos.a(this.mRuntime.a(), new bhtj(this, j), 1));
    b(j);
  }
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            Object localObject = bhrl.a(str);
            if (localObject == null) {
              break;
            }
            double d1 = bhrl.a((bhro)localObject);
            if (d1 > 0.0D)
            {
            ...
            localObject = bhrl.a(str, ((bhro)localObject).jdField_a_of_type_Int, ((bhro)localObject).jdField_b_of_type_Int);
  ...
  private void a(String paramString)
  {
    ...
    ((bgyf)localObject).jdField_a_of_type_JavaLangString = this.mRuntime.a().getAccount();
    paramString.putString("keyAction", "actionSelectPicture");
    paramString.putBoolean("key_need_change_to_jpg", false);
    bgxy.a(this.mRuntime.a(), (bgyf)localObject, paramString, a(3));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          Object localObject2 = bhrl.a((String)localObject1);
          if (localObject2 == null) {
            break label335;
          }
          double d1 = bhrl.a((bhro)localObject2);
          if (d1 > 0.0D)
          {
            ((bhro)localObject2).jdField_a_of_type_Int = ((int)(((bhro)localObject2).jdField_a_of_type_Int / d1));
            ((bhro)localObject2).jdField_b_of_type_Int = ((int)(((bhro)localObject2).jdField_b_of_type_Int / d1));
          }
          localObject2 = bhrl.a((String)localObject1, ((bhro)localObject2).jdField_a_of_type_Int, ((bhro)localObject2).jdField_b_of_type_Int);
          ...
          axql.a(BaseApplication.getContext()).reportTimeKVEvent("Qzone.EventTransformPhotoBase64", (Properties)localObject1, (int)(l2 - l1));
        }
      }
  ...
  {
    bgzc.a(this.mRuntime.a().getLongAccountUin(), this.mRuntime.a(), "cover_mall_record_video", new bhtk(this, paramInt));
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("showStoreButton"))
    {
      ...
      if (paramJsBridgeListener != null)
      {
        ...
        paramJsBridgeListener.setText(ajyc.a(2131711629));
        paramJsBridgeListener.setOnClickListener(new bhti(this));
      }
    }
    label810:
    do
    {
      for (;;)
      {
        ...
        else if (paramString3.equals("openYellowDiamond"))
        {
          ...
          paramString2 = ajyc.a(2131711627);
