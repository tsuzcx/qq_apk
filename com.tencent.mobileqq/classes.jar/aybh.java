  ...
  implements bcwt
{
  ...
  public aybh(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView, int paramInt)
  {
  ...
  private void a(aybk paramaybk, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if (paramDrawable == null)
    {
      ...
      if (this.jdField_a_of_type_Ajfa != null) {
        paramDrawable = this.jdField_a_of_type_Ajfa.a(paramRecentBaseData);
      }
      ...
      int j = ((Integer)ajfa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.a()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      localRecentDynamicAvatarView = paramaybk.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      paramaybk.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData.b());
      return;
      break;
      label176:
      bool = false;
      break label143;
      label182:
      paramaybk.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  
  private void b(aybk paramaybk, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    if ((paramaybk == null) || (paramRecentBaseData == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      a(paramaybk, paramRecentBaseData, localDrawable);
      return;
    }
  }
  ...
  {
    if ((paramViewHolder instanceof aybk))
    {
      RecentBaseData localRecentBaseData = a(paramInt);
      a((aybk)paramViewHolder, localRecentBaseData, null);
    }
  }
  ...
  {
    if ((paramInt == 0) && (this.jdField_a_of_type_Boolean)) {
      return new aybj(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562562, paramViewGroup, false));
    }
    return new aybk(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561235, paramViewGroup, false), this.jdField_a_of_type_Aybi);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(paramBitmap instanceof aybk))
        {
          break label436;
          this.jdField_a_of_type_Long = l;
          break;
        }
        paramBitmap = (aybk)paramBitmap;
