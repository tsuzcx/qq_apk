  ...
  extends bhii
{
  ...
  public void a(Context paramContext, bhio parambhio, bhin parambhin)
  {
    try
    {
      a(parambhio.b, new bhje(this, parambhin, paramContext, parambhio), 0);
      return;
    }
  ...
  public void a(bhip parambhip, int paramInt)
  {
    try
    {
      this.a.a(parambhip, paramInt);
      return;
    }
    catch (NullPointerException parambhip)
    {
      QLog.e("QZonePluginClient", 1, parambhip, new Object[0]);
    }
  }
  ...
  public boolean a(String paramString, bhis parambhis, int paramInt)
  {
    try
    {
      boolean bool = this.a.a(paramString, parambhis, paramInt);
      return bool;
    }
    catch (NullPointerException paramString)
    {
