...
final class bhjd
{
  ...
  public bhjd(File paramFile, bhje parambhje)
  {
    this.jdField_a_of_type_JavaIoFile = paramFile;
    this.jdField_a_of_type_Bhje = parambhje;
  }
  
  private Pair<String, bhjx> a(XmlPullParser paramXmlPullParser)
  {
    try
    {
      ...
      localbhjx.jdField_a_of_type_Int = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "AttrType"));
      localbhjx.b = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "Category"));
      localbhjx.c = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "SubCategory"));
      localbhjx.d = Integer.parseInt(paramXmlPullParser.getAttributeValue(null, "Action"));
      localbhjx.jdField_a_of_type_Long = Long.parseLong(paramXmlPullParser.getAttributeValue(null, "ExpireTime"));
      paramXmlPullParser = paramXmlPullParser.getAttributeValue(null, "ExtraInfo");
      if (!TextUtils.isEmpty(paramXmlPullParser)) {
        localbhjx.jdField_a_of_type_ArrayOfByte = Base64.decode(paramXmlPullParser, 0);
      }
      paramXmlPullParser = new Pair(str, localbhjx);
  ...
  public void a()
  {
    ...
    //   54: dup
    //   55: aload_0
    //   56: getfield 14	bhjd:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   159: aload_0
    //   160: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   163: ifnull +10 -> 173
    //   166: aload_0
    //   167: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   170: invokevirtual 182	bhje:a	()V
    //   173: return
    //   174: iconst_1
    //   175: istore_1
    //   176: iload_1
    ...
    //   213: aload_0
    //   214: aload 8
    //   216: invokespecial 189	bhjd:a	(Lorg/xmlpull/v1/XmlPullParser;)Lcom/tencent/util/Pair;
    //   219: astore 5
    //   221: goto -45 -> 176
    //   224: aload 5
    //   226: astore 6
    ...
    //   264: ifnull -82 -> 182
    //   267: aload_0
    //   268: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   271: ifnull +33 -> 304
    //   274: aload_0
    //   275: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   278: aload 5
    ...
    //   291: checkcast 36	bhjx
    //   294: invokevirtual 199	bhje:a	(Ljava/lang/String;Lbhjx;)Z
    //   297: istore 4
    //   299: iload 4
    //   301: ifeq -152 -> 149
    //   304: aconst_null
    ...
    //   342: aload_0
    //   343: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   346: ifnull -173 -> 173
    //   349: aload_0
    //   350: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   353: invokevirtual 182	bhje:a	()V
    //   356: return
    //   357: astore 5
    //   359: aload 5
    ...
    //   382: aload_0
    //   383: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   386: ifnull +10 -> 396
    //   389: aload_0
    //   390: getfield 16	bhjd:jdField_a_of_type_Bhje	Lbhje;
    //   393: invokevirtual 182	bhje:a	()V
    //   396: aload 5
    //   398: athrow
    //   399: astore 6
    //   401: aload 6
