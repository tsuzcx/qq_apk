  ...
  implements bghi
{
  ...
  public void a(JSONObject paramJSONObject, int paramInt, Bundle paramBundle)
  {
        ...
        for (;;)
        {
          ...
          if ((localObject2 != null) && (((JSONObject)localObject2).optInt("retcode") == 0))
          {
            ...
            if (localObject2 != null)
            {
              ...
              ((nyx)localObject1).jdField_a_of_type_JavaUtilList = paramJSONObject;
              ((nyx)localObject1).b = str;
            }
    ...
    ((nyx)localObject1).jdField_a_of_type_Int = paramJSONObject.optInt("state");
    this.a.notifyObservers(new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(true), localObject1, paramBundle });
  }
}
