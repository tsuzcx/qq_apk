...
public class axeu
{
  private static volatile axeu jdField_a_of_type_Axeu;
  ...
  public static axeu a()
  {
    if (jdField_a_of_type_Axeu == null) {}
    try
    {
      if (jdField_a_of_type_Axeu == null) {
        jdField_a_of_type_Axeu = new axeu();
      }
      return jdField_a_of_type_Axeu;
    }
    finally {}
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        bool1 = bnce.a(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir + File.separator + "liteavsdk.jar", BaseApplicationImpl.getApplication().getApplicationContext(), getClass().getClassLoader(), "com.tencent.rtmp.ui.TXCloudVideoView", null, false);
        if (bool1)
        {
      ...
      catch (Exception localException)
      {
        ...
        if ((bool1) && (this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir)))
        {
          ...
          bnjq.a("com.tencent.rtmp.TXLiveBase", "setLibraryPath", false, bnjq.a(new Class[] { String.class }), new Object[] { this.jdField_a_of_type_ComTencentMobileqqMinigameManagerInstalledEngine.engineDir });
        }
        return bool1;
      }
      boolean bool3 = false;
