...
{
  private static volatile azly jdField_a_of_type_Azly;
  ...
  private azly(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext.getApplicationContext();
    this.jdField_a_of_type_Boolean = azlt.a(this.jdField_a_of_type_AndroidContentContext, true);
  }
  
  public static azly a(Context paramContext)
  {
    if (jdField_a_of_type_Azly == null) {}
    try
    {
      if (jdField_a_of_type_Azly == null) {
        jdField_a_of_type_Azly = new azly(paramContext);
      }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (Object localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      azmj.b((QQAppInterface)localObject, "dc00898", "", "", "0X80075F3", "0X80075F3", 0, 0, new SimpleDateFormat("yyyyMMdd", Locale.US).format(localDate), "", "", "");
      MTAReportManager.setMTAReporter(jdField_a_of_type_Azly);
