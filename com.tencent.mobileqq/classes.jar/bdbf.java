...
public class bdbf
  ...
  implements bday
{
  private bdbh jdField_a_of_type_Bdbh;
  private bdbi jdField_a_of_type_Bdbi;
  private bdbj jdField_a_of_type_Bdbj;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bdbf(QQAppInterface paramQQAppInterface)
  {
      ...
      for (;;)
      {
        ...
        if ((localObject != null) && (paramInt1 == 1001))
        {
          ...
          if ((localalri != null) && (localalri.a() != null)) {
            localalri.a().f(paramString);
          }
          if (this.jdField_a_of_type_Bdbh == null)
          {
            this.jdField_a_of_type_Bdbh = new bdbh(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bdbh);
          }
        }
        return localObject;
      }
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long paramLong)
  {
    ...
    do
    {
      ...
      for (byte b = 1;; b = 0)
      {
        ...
        if (this.jdField_a_of_type_Bdbi == null)
        {
          this.jdField_a_of_type_Bdbi = new bdbi(this, null);
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bdbi);
        }
        if (paramInt1 != 32) {
          break;
        }
  ...
  public void a(AppInterface paramAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    do
    {
      ...
      if (paramAppInterface != null)
      {
        ...
        bdbb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramAppInterface);
      }
  ...
  public void a(FaceInfo paramFaceInfo, Bitmap paramBitmap)
  {
    ...
    for (int i = FaceInfo.f;; i = FaceInfo.g)
    {
      ...
      this.jdField_a_of_type_Bdbe.onDecodeTaskCompleted(this.jdField_b_of_type_Int + this.jdField_a_of_type_JavaUtilLinkedList.size(), paramFaceInfo.jdField_a_of_type_Int, paramFaceInfo.jdField_a_of_type_JavaLangString, paramBitmap);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        this.jdField_a_of_type_Bdbe.onDecodeTaskCompleted(this.jdField_b_of_type_Int + this.jdField_a_of_type_JavaUtilLinkedList.size(), paramInt1, paramString, localBitmap);
        return;
  ...
  public void d()
  {
    ...
    bdbh localbdbh = this.jdField_a_of_type_Bdbh;
    bdbi localbdbi = this.jdField_a_of_type_Bdbi;
    bdbj localbdbj = this.jdField_a_of_type_Bdbj;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_Bdbh = null;
    this.jdField_a_of_type_Bdbj = null;
    this.jdField_a_of_type_Bdbi = null;
    if (localQQAppInterface != null)
    {
      if (localbdbh != null) {
        localQQAppInterface.removeObserver(localbdbh);
      }
      if (localbdbi != null) {
        localQQAppInterface.removeObserver(localbdbi);
      }
      if (localbdbj != null) {
        localQQAppInterface.removeObserver(localbdbj);
      }
    }
    super.d();
  }
  ...
  protected void e()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if (((((FaceInfo)localObject2).jdField_a_of_type_Int == 101) || (((FaceInfo)localObject2).jdField_a_of_type_Int == 1001)) && (this.jdField_a_of_type_Bdbh == null))
          {
            this.jdField_a_of_type_Bdbh = new bdbh(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bdbh);
          }
          if (((((FaceInfo)localObject2).jdField_a_of_type_Int == 4) || (((FaceInfo)localObject2).jdField_a_of_type_Int == 113)) && (!bcpx.a(((FaceInfo)localObject2).jdField_a_of_type_JavaLangString)))
          {
            if (this.jdField_a_of_type_Bdbj == null) {
              this.jdField_a_of_type_Bdbj = new bdbj(this, null);
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bdbj);
          }
          this.jdField_b_of_type_Int += 1;
    ...
    auwz.a("Q.qqhead.FaceDecoderImpl", new Object[] { "runNextTask", localObject2, localObject1 });
  }
}
