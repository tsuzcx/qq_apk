...
{
  private static final String jdField_a_of_type_JavaLangString = aocd.class.getSimpleName();
  ...
  public aocd(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Aoch = new aoch();
    this.jdField_a_of_type_Aoch.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Aoch.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Aoch.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aoch = null;
  ...
  {
    this.jdField_a_of_type_Aoch.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aoch.a("before updateTexImage");
