  ...
  extends woi
{
  ...
  private LruCache<String, wgg> c = new LruCache(200);
  ...
  private DownloadingUrlEntry a(String paramString, int paramInt)
  {
    ...
    localObject = wpj.a(QQStoryContext.a().a().createEntityManager(), DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
  ...
  public static String a(String paramString)
  {
    ...
    {
      yqp.d("Q.qqstory.DownloadUrlManager", "getIpOfDomain url: %s", new Object[] { paramString });
    }
    return null;
  }
  
  private void a(@NonNull String paramString, @NonNull wgh paramwgh)
  {
    yqp.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary , vid = %s", paramString);
    Bosses.get().postJob(new wgd(this, "Q.qqstory.DownloadUrlManager", paramString, paramwgh));
  }
  ...
  private boolean a(String paramString)
  {
    // Byte code:
    //   0: iconst_5
    //   1: invokestatic 164	wpm:a	(I)Lwou;
    //   4: checkcast 71	wpj
    //   7: aload_1
    //   8: invokevirtual 167	wpj:a	(Ljava/lang/String;)Lcom/tencent/biz/qqstory/model/item/StoryVideoItem;
    //   11: astore_3
    //   12: aload_3
    //   13: ifnonnull +11 -> 24
    //   16: ldc 169
    //   18: aload_1
    //   19: invokestatic 173	yqp:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   22: iconst_0
    //   23: ireturn
    //   24: aload_3
    ...
    //   83: invokestatic 208	yqp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   86: new 210	wzt
    //   89: dup
    //   90: invokespecial 211	wzt:<init>	()V
    //   93: astore 4
    //   95: aload 4
    ...
    //   105: putfield 217	wzt:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload 4
    //   110: getfield 217	wzt:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: aload_1
    //   114: invokeinterface 221 2 0
    //   119: pop
    //   120: aload 4
    //   122: ldc2_w 222
    //   125: putfield 225	wzt:jdField_a_of_type_Long	J
    ...
    //   163: aload 5
    //   165: aload 6
    //   167: invokespecial 236	wgf:<init>	(Lwfy;Ljava/lang/String;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    //   170: astore_1
    //   171: invokestatic 241	wlb:a	()Lwlb;
    //   174: aload 4
    //   176: aload_1
    //   177: invokevirtual 244	wlb:a	(Lwlf;Lwld;)V
    //   180: aload_3
    ...
    //   191: ldc 118
    //   193: ldc 246
    //   195: invokestatic 208	yqp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   198: iconst_0
    //   199: ireturn
    //   200: aload_2
    //   201: monitorenter
    //   202: ldc 118
    //   204: ldc 248
    //   206: invokestatic 208	yqp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   209: aload 5
  ...
  private wgg b(String paramString, int paramInt)
  {
    paramString = DownloadingUrlEntry.makeKey(paramString, paramInt);
    paramString = (wgg)this.c.get(paramString);
  ...
  @Deprecated
  private void b(@NonNull String paramString, @NonNull wgh paramwgh)
  {
    yqp.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessaryInner , vid = %s", paramString);
    ...
    yqp.d("Q.qqstory.DownloadUrlManager", ((StoryVideoItem)localObject).mVid + " request video url is expire :" + ((StoryVideoItem)localObject).videoUrlExpireTime);
    localObject = new wzt();
    ((wzt)localObject).jdField_a_of_type_JavaUtilList = new ArrayList(1);
    ((wzt)localObject).jdField_a_of_type_JavaUtilList.add(paramString);
    ((wzt)localObject).jdField_a_of_type_Long = 10000L;
    paramString = new wge(this, paramwgh, paramString);
    wlb.a().a((wlf)localObject, paramString);
  }
  ...
  public List<VideoUrlEntry> a(String paramString)
  {
    ...
    List localList = wpj.a(QQStoryContext.a().a().createEntityManager(), VideoUrlEntry.class, VideoUrlEntry.class.getSimpleName(), "vid=?", new String[] { paramString });
  ...
  public wgg a(String paramString, int paramInt)
  {
    zkb.b();
    wgg localwgg = new wgg();
    localwgg.jdField_a_of_type_JavaLangString = paramString;
    localwgg.jdField_a_of_type_Int = paramInt;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          i = 1;
          localwgg.jdField_a_of_type_Boolean = true;
          localObject2 = null;
            ...
            if (a())
            {
              ...
              if (localList != null)
              {
                ...
                if (localList.size() > 0)
                {
                  ...
                  localwgg.jdField_b_of_type_Int = 2;
                  localwgg.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
                  localwgg.c = ((VideoUrlEntry)localObject2).videoUrlLevel;
                }
              }
            }
          }
          if (localwgg.jdField_b_of_type_Int != -1) {
            break label644;
          }
          localObject2 = localwpj.a(paramString);
          ...
          if (paramInt == 0)
          {
            ...
            ((DownloadingUrlEntry)localObject1).key = DownloadingUrlEntry.makeKey(((DownloadingUrlEntry)localObject1).vid, ((DownloadingUrlEntry)localObject1).fileType);
            localwgg.jdField_b_of_type_Int = 3;
            localwgg.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
            if ((localObject1 != null) && (!TextUtils.isEmpty(((DownloadingUrlEntry)localObject1).url)))
            {
              localObject2 = wgw.a(paramString, paramInt, false, false);
            ...
            if (i != 0)
            {
              ...
              if ((paramString == null) || (!TextUtils.equals(paramString.url, localwgg.jdField_b_of_type_JavaLangString))) {
                break label598;
              }
              yqp.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan false,cache entry url=" + paramString.url + " result url=" + localwgg.jdField_b_of_type_JavaLangString);
              localwgg.jdField_a_of_type_Boolean = false;
            }
            return localwgg;
          }
        }
        else
        {
          ...
          localwgg.jdField_b_of_type_Int = 0;
          localwgg.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
          localwgg.c = ((DownloadingUrlEntry)localObject1).compressLevel;
          return localwgg;
        }
        if (paramInt == 1)
        {
      ...
      {
        yqp.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan true,cache entry url :" + paramString.url);
        continue;
        continue;
        i = 0;
      }
  ...
  public wgg a(String paramString, int paramInt, boolean paramBoolean)
  {
    zkb.b();
    ...
    for (;;)
    {
      ...
      {
        localwgg.a();
        localwgg.jdField_a_of_type_Long = System.currentTimeMillis();
        this.c.put(str, localwgg);
        this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
      }
      ((DownloadingUrlEntry)localObject1).url = ((StoryVideoItem)localObject2).getThumbUrl();
      continue;
  ...
  {
    if ((paramInt != 0) || (zjb.a(paramString))) {
      return;
    }
    Bosses.get().postJob(new wgb(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  
  public void a(String paramString, int paramInt, wgi paramwgi)
  {
    wgg localwgg = b(paramString, paramInt);
    if (localwgg != null)
    {
      paramwgi.a(localwgg);
      return;
    ...
    if (paramInt == 0)
    {
      a(paramString, new wfz(this, paramString, paramInt, paramwgi));
      return;
    }
    Bosses.get().postJob(new wga(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt, paramwgi));
  }
  ...
  public void a(List<List<VideoUrlEntry>> paramList)
  {
    ...
    yqp.a("Q.qqstory.DownloadUrlManager", "update video url:%s", paramList);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(localVideoUrlEntry2.videoUrl))
        {
          ...
          yqp.d("Q.qqstory.DownloadUrlManager", "%s url error!", new Object[] { localVideoUrlEntry2.vid });
          continue;
        }
  ...
  {
    yqp.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip domain - url: %s", paramString);
    ...
    for (;;)
    {
          ...
          if ((localObject != null) && (((List)localObject).size() > 0))
          {
            ...
            if (i < ((List)localObject).size())
            {
              ...
              else
              {
                ...
                yqp.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip ip - url: %s", str1);
                i += 1;
                continue;
              }
              str1 = str2 + "&txhost=" + str3;
      ...
      {
        yqp.b("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip MalformedURLException: %s", localMalformedURLException);
      }
  ...
  {
    Bosses.get().postJob(new wgc(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  ...
  public void c(String paramString, int paramInt)
  {
    try
    {
      ...
      paramString = wpj.a((EntityManager)localObject, DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
