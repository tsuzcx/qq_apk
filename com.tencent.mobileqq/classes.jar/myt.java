...
public final class myt
  implements Runnable
{
  public myt(QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      SharedPreferencesHandler.a((SharedPreferences.Editor)localObject, "big_data_share_channel_urls", PublicAccountConfigUtil.jdField_a_of_type_JavaUtilArrayList.toArray());
