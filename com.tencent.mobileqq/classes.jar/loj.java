...
public class loj
  extends Handler
{
  public loj(QQGAudioCtrl paramQQGAudioCtrl, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        m = paramMessage.what;
        paramMessage = (lok)paramMessage.obj;
        if (paramMessage == null)
        {
          if (QLog.isColorLevel()) {
                                    ...
                                    if ((paramMessage.jdField_a_of_type_ArrayOfByte != null) && (paramMessage.jdField_a_of_type_ArrayOfByte.length == 16))
                                    {
                                      ...
                                      if (k == 3)
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          localObject1 = lne.a((byte[])localObject1, i1);
                                          ...
                                          if (((j == 10) || (j == 1)) && (localObject1 != null))
                                          {
                                            ...
                                            while (((Iterator)localObject1).hasNext()) {
                                              paramMessage.add(new loh(((lne)((Iterator)localObject1).next()).jdField_a_of_type_Long, l3));
                                            }
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        axqy.b(null, "CliOper", "", "", "0X800A7A6", "0X800A7A6", 0, (int)l3, "", "", "", "");
        break;
        axqy.b(null, "CliOper", "", "", "0X800A7A7", "0X800A7A7", 0, (int)l3, "", "", "", "");
        break;
        this.a.mVideoController.g(l3);
        break;
        l1 = 0L;
        break label997;
        switch (m)
