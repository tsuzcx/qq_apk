...
public class bibh
  extends PopupWindow
{
  private static final Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = a(2130849679);
  ...
  private static final Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = a(2130849680);
  ...
  private View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new bibk(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new bibl(this);
  private ListView jdField_a_of_type_AndroidWidgetListView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private bibm jdField_a_of_type_Bibm;
  private Spring jdField_a_of_type_ComTencentComponentAnimationReboundSpring;
  public ArrayList<bibn> a;
  ...
  public bibh(Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void a(int paramInt)
  {
    ...
    bbll.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, jdField_c_of_type_AndroidGraphicsDrawableDrawable);
  ...
  private int c()
  {
    ...
    return bbll.b() - localRect.height();
  }
  ...
  private void f()
  {
    ...
    setWidth(-1);
    setHeight(-1);
    this.jdField_a_of_type_ComTencentComponentAnimationReboundSpring = SpringSystem.create().createSpring().setSpringConfig(jdField_a_of_type_ComTencentComponentAnimationReboundSpringConfig).addListener(new bibi(this));
    this.jdField_a_of_type_Bibm = new bibm(this, this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365412));
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Bibm);
    this.jdField_a_of_type_AndroidWidgetListView.setOnTouchListener(new bibj(this));
  }
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      bbll.b(this.jdField_a_of_type_AndroidWidgetListView, f3);
      bbll.c(this.jdField_a_of_type_AndroidWidgetListView, f3);
      if (this.jdField_c_of_type_Boolean)
      {
        bbll.e(this.jdField_a_of_type_AndroidWidgetListView, 0.0F);
        bbll.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      for (;;)
      {
        ...
        f3 = f2;
        break;
        bbll.e(this.jdField_a_of_type_AndroidWidgetListView, this.d);
        bbll.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      label221:
      break;
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bbll.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public void a(bibn parambibn)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (parambibn != null)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambibn);
    }
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = bbll.a() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingRight() * 2;
    ...
    localLayoutParams1.topMargin = (paramInt2 - i - bbll.b(5.0F));
  ...
  public int b()
  {
    ...
    {
      i = bbll.b() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight();
      if (i > bbll.b(25.0F)) {}
    }
    int j;
    do
  ...
  public void b()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bbll.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_AndroidWidgetListView != null) {
      this.jdField_a_of_type_AndroidWidgetListView.setPadding(this.jdField_a_of_type_AndroidWidgetListView.getPaddingLeft(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingTop() + bbll.b(9.0F), this.jdField_a_of_type_AndroidWidgetListView.getPaddingRight(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingBottom());
    }
    super.showAtLocation(a(), 17, 0, 0);
    c();
  }
  ...
  public void e()
  {
    int i = 0;
    int j = 0;
    while (i < this.jdField_a_of_type_Bibm.getCount())
    {
      View localView = this.jdField_a_of_type_Bibm.getView(i, null, this.jdField_a_of_type_AndroidWidgetListView);
      localView.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec(0, 0));
      j += localView.getMeasuredHeight();
      i += 1;
    }
    this.jdField_b_of_type_Int = (bbll.b(9.0F) + j);
  }
}
