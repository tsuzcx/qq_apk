...
public class agzb
{
  ...
  WeakReference<agyv> jdField_a_of_type_JavaLangRefWeakReference;
  LinkedList<WeakReference<agyv>> jdField_a_of_type_JavaUtilLinkedList;
  ...
  public agzb()
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new agzc(this, Looper.getMainLooper());
    MagnifierSDK.a().a().a(new agzd(this));
  }
  
  public static agzb a()
  {
    return agze.a;
  }
  ...
  public static void a(WeakReference<agyv> paramWeakReference)
  {
    if (!jdField_a_of_type_Boolean) {
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      agyv localagyv = (agyv)localWeakReference.get();
      if (localagyv != null)
      {
  ...
  public static void b(WeakReference<agyv> paramWeakReference)
  {
    if (!jdField_a_of_type_Boolean) {
      return;
    }
  ...
  public static void c(WeakReference<agyv> paramWeakReference)
  {
    if (!jdField_a_of_type_Boolean) {
      return;
    }
  ...
  private void d(WeakReference<agyv> paramWeakReference)
  {
  ...
  private void e(WeakReference<agyv> paramWeakReference)
  {
    if (paramWeakReference == null)
    {
  ...
  private void f(WeakReference<agyv> paramWeakReference)
  {
    if (paramWeakReference == null)
    {
  ...
  private void g(WeakReference<agyv> paramWeakReference)
  {
    if (paramWeakReference == null)
    {
