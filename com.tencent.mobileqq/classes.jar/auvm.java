...
public class auvm
  implements auvo
{
  public auvm(AppletsSettingFragment paramAppletsSettingFragment) {}
  ...
  public void a(CompoundButton paramCompoundButton, boolean paramBoolean, AppletItem paramAppletItem)
  {
    ...
    if (paramAppletItem != null)
    {
      ...
      paramCompoundButton = (apap)AppletsSettingFragment.a(this.a).getBusinessHandler(BusinessHandlerFactory.APPLET_PUSH_HANDLER);
