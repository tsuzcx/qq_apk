...
class wba
{
  static String a(InputStream paramInputStream)
  {
    ...
    {
      ved.c("Q.qqstory.ffmpeg.FFmpeg", "error converting input stream to string", paramInputStream);
      return null;
    }
  ...
  static void a(wai paramwai)
  {
    if ((paramwai != null) && (!paramwai.a()))
    {
      if (paramwai.jdField_a_of_type_JavaLangProcess != null)
      {
        paramwai.jdField_a_of_type_JavaLangProcess.destroy();
        paramwai.jdField_a_of_type_JavaLangProcess = null;
      }
      if (!paramwai.isCancelled()) {
        paramwai.cancel(true);
      }
      ved.e("Q.qqstory.ffmpeg.FFmpeg", "kill ffmpeg task", new Object[] { Arrays.toString(paramwai.jdField_a_of_type_ArrayOfJavaLangString) });
    }
  }
