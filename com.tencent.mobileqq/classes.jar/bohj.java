  ...
  implements Handler.Callback, IEventReceiver
{
  public static int a;
  public Handler a;
  private bohv jdField_a_of_type_Bohv;
  public bohz a;
  public boic a;
  public bpju a;
  public ArrayList<QIMTemplateItem> a;
  public HashMap<String, bohz> a;
  private boolean jdField_a_of_type_Boolean;
  public bohn[] a;
  int b;
  public Handler b;
  public ArrayList<QIMTemplateItem> b;
  public HashMap<String, boic> b;
  public Handler c;
  public ArrayList<QIMFilterCategoryItem> c;
  public HashMap<String, bohg> c;
  public ArrayList<QIMFilterCategoryItem> d;
  public HashMap<String, boij> d;
  ArrayList<bohm> e;
  public HashMap<String, ArrayList<boho>> e;
  ...
  public bohj()
  {
    ...
    this.jdField_b_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bohl(this));
    ...
    this.jdField_a_of_type_ArrayOfBohn = new bohn[5];
    int i = 0;
    while (i < this.jdField_a_of_type_ArrayOfBohn.length)
    {
      this.jdField_a_of_type_ArrayOfBohn[i] = new bohn(i);
      i += 1;
    }
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), new bohk(this));
    this.jdField_a_of_type_Bohv = new bohv();
  }
  
  private void a(Activity paramActivity, int paramInt)
  {
    bohz localbohz = bpjt.a().a[paramInt];
    if (localbohz != null) {
      localbohz.a(paramActivity, paramInt);
    }
    bpjt.a().a(null, paramActivity, paramInt);
  }
  ...
  {
    bohs localbohs = (bohs)bogd.a(15);
    boij localboij = localbohs.a();
    if (localboij != null)
    {
      localboij.a(paramActivity, paramInt);
      if (paramInt == 0) {
        localbohs.a(null);
      }
    }
  ...
  public bohg a(FilterDesc paramFilterDesc)
  {
    bohg localbohg2 = (bohg)this.jdField_c_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
    bohg localbohg1 = localbohg2;
    if (localbohg2 == null)
    {
      localbohg1 = new bohg(paramFilterDesc);
      this.jdField_c_of_type_JavaUtilHashMap.put(paramFilterDesc.name, localbohg1);
    }
    return localbohg1;
  }
  
  public bohn a(int paramInt)
  {
    return this.jdField_a_of_type_ArrayOfBohn[paramInt];
  }
  
  public bohv a()
  {
    return this.jdField_a_of_type_Bohv;
  }
  
  public bohz a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    bohz localbohz2 = (bohz)this.jdField_a_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    Object localObject1 = localbohz2;
    Object localObject2;
    Object localObject3;
    int j;
    int i;
    ...
    if (localbohz2 == null)
    {
      localbohz2 = new bohz(paramQIMFilterCategoryItem);
      localObject1 = paramQIMFilterCategoryItem.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (String)((Iterator)localObject1).next();
        localObject3 = bpjt.a().a((String)localObject2);
        if (localObject3 != null) {
          localbohz2.c(a((FilterDesc)localObject3));
        ...
        if (k < n)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              localObject3 = bojp.a(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, (String)localObject4, (String)localObject1, f1, f2, f3);
              if (localObject3 != null)
              {
                ((bohe)localObject3).a((SegmentKeeper)localObject2);
                localbohz2.c((bohe)localObject3);
                k += 1;
                break;
              }
              m = 1;
      ...
      if (paramQIMFilterCategoryItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = i;
            localObject3 = bojp.a((String)localObject2);
            if (localObject3 != null)
            {
              k = i;
              localbohz2.c((bohe)localObject3);
      ...
      if (paramQIMFilterCategoryItem.c != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = j;
            localObject3 = bojp.b((String)localObject2);
            if (localObject3 != null)
            {
              k = j;
              localbohz2.c((bohe)localObject3);
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            j = i;
            localObject2 = bojp.a(str3, (List)localObject3, f1, f2, f3);
            if (localObject2 != null)
            {
              j = i;
              ((bohe)localObject2).a((SegmentKeeper)localObject4);
              j = i;
              localbohz2.c((bohe)localObject2);
              k = i;
            }
            else
            {
          ...
          if (j == 0) {
            this.jdField_a_of_type_JavaUtilHashMap.put(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, localbohz2);
          }
          bohz localbohz1 = localbohz2;
          localbohz1.jdField_a_of_type_JavaLangObject = paramQIMFilterCategoryItem;
          return localbohz1;
          label1280:
          break;
          label1283:
  ...
  public bohz a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    bohj localbohj = (bohj)bogd.a(5);
    bohz localbohz = localbohj.a(paramQIMFilterCategoryItem);
    localbohz.b(paramActivity, paramBundle.getInt("capture_scene", -1));
    localbohz.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    localbohj.a(paramQIMFilterCategoryItem);
    switch (localbohz.jdField_a_of_type_Int)
    {
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("QCombo", 2, "applyCombo state = " + localbohz.jdField_a_of_type_Int);
      }
      return localbohz;
      a(new boho(localbohz, paramBundle, paramActivity));
      paramQIMFilterCategoryItem = Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, localbohz);
  ...
  public bohz a(String paramString)
  {
    Object localObject1 = null;
    bohz localbohz = null;
    Object localObject2 = this.jdField_a_of_type_Bpju;
    if (localObject2 != null)
    {
      localObject2 = ((bpju)localObject2).a.jdField_a_of_type_JavaUtilArrayList.iterator();
      localObject1 = localbohz;
      if (((Iterator)localObject2).hasNext())
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (TextUtils.equals(localQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, paramString)) {
            localbohz = a(localQIMFilterCategoryItem);
          }
        }
      }
    }
  ...
  public boic a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject2 = bpjt.a().a((String)localObject2);
      if (localObject2 != null) {
        localArrayList.add(localObject2);
      }
    }
    Object localObject2 = (boic)this.jdField_b_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new boic(paramQIMFilterCategoryItem);
      localObject2 = localArrayList.iterator();
      while (((Iterator)localObject2).hasNext()) {
        ((boic)localObject1).c(a((FilterDesc)((Iterator)localObject2).next()));
      }
  ...
  public boic a(String paramString)
  {
    Object localObject = this.jdField_a_of_type_Bpju;
    if (localObject != null)
    {
      localObject = ((bpju)localObject).a.jdField_c_of_type_JavaUtilArrayList.iterator();
  ...
  public boij a(QIMTemplateItem paramQIMTemplateItem)
  {
    Object localObject2 = (boij)this.jdField_d_of_type_JavaUtilHashMap.get(paramQIMTemplateItem.jdField_a_of_type_JavaLangString);
    ...
    if (localObject2 == null)
    {
      localObject1 = new boij(paramQIMTemplateItem);
      if (QLog.isColorLevel()) {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = bpjt.a().a((String)localObject3);
        if (localObject4 != null) {
          ((boij)localObject1).d(a((FilterDesc)localObject4));
        } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.jdField_a_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bojp.a(paramQIMTemplateItem.jdField_a_of_type_JavaLangString, (String)localObject5, (String)localObject2, f1, f2, f3);
            if (localObject4 != null)
            {
              ((bohe)localObject4).a((SegmentKeeper)localObject3);
              ((boij)localObject1).d((bohe)localObject4);
            }
            else if (QLog.isColorLevel())
            {
      ...
      if (paramQIMTemplateItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bojp.a((String)localObject3);
            if (localObject4 != null) {
              ((boij)localObject1).d((bohe)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.c != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = bojp.b((String)localObject3);
            if (localObject4 != null) {
              ((boij)localObject1).d((bohe)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            localObject3 = bojp.a(str3, (List)localObject4, f1, f2, f3);
            if (localObject3 != null)
            {
              ((bohe)localObject3).a((SegmentKeeper)localObject5);
              ((boij)localObject1).d((bohe)localObject3);
            }
            else if (QLog.isColorLevel())
            {
          ...
          ((boij)localObject1).jdField_a_of_type_JavaLangObject = paramQIMTemplateItem;
          return localObject1;
          label1086:
          i += 1;
          break;
  ...
  public boij a(QIMTemplateItem paramQIMTemplateItem, Activity paramActivity, Bundle paramBundle)
  {
    paramQIMTemplateItem = ((bohj)bogd.a(5)).a(paramQIMTemplateItem);
    ...
    for (;;)
    {
      ...
      a(new boho(paramQIMTemplateItem, paramBundle, paramActivity));
  ...
  public bpjv a()
  {
    if (this.jdField_a_of_type_Bpju != null) {
      return this.jdField_a_of_type_Bpju.a;
    }
    return null;
  }
  
  public QIMFilterCategoryItem a(bohz parambohz, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    ...
    if (parambohz != null)
    {
      ...
      if ((parambohz.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem))
      {
        localObject3 = (QIMFilterCategoryItem)parambohz.jdField_a_of_type_JavaLangObject;
    ...
    for (localObject1 = null;; localObject1 = parambohz)
    {
      if (localObject1 == null)
      {
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          {
            parambohz = (QIMFilterCategoryItem)paramArrayList.next();
            if ((parambohz.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (parambohz.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = parambohz;
              return localObject1;
              label176:
  ...
  public QIMFilterCategoryItem a(boij paramboij, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = localObject3;
    ...
    {
      localObject1 = localObject3;
      if ((paramboij.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem))
      {
        localObject3 = (QIMTemplateItem)paramboij.jdField_a_of_type_JavaLangObject;
    ...
    label280:
    label283:
    for (localObject1 = null;; localObject1 = paramboij)
    {
      if (localObject1 == null)
      {
        localObject3 = ((QIMTemplateItem)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
        paramboij = (boij)localObject2;
        do
        {
          localObject2 = paramboij;
          if (!((Iterator)localObject3).hasNext()) {
            break;
          }
          localObject2 = (String)((Iterator)localObject3).next();
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          while (paramArrayList.hasNext())
          {
            paramboij = (QIMFilterCategoryItem)paramArrayList.next();
            if ((paramboij.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (paramboij.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = paramboij;
              return localObject1;
              label176:
              Iterator localIterator1 = paramArrayList.iterator();
              paramboij = null;
  ...
  {
    Object localObject = bpjt.a().a(paramInt);
    if (localObject != null)
    {
      localObject = a((QIMFilterCategoryItem)localObject);
      if ((localObject != null) && (((bohz)localObject).jdField_a_of_type_Int == 1))
      {
        localObject = new Bundle();
        ((Bundle)localObject).putInt("capture_scene", paramInt);
        bohz localbohz = bpjt.a().a[paramInt];
        if (localbohz != null) {
          a((QIMFilterCategoryItem)localbohz.jdField_a_of_type_JavaLangObject, paramActivity, (Bundle)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  {
    bohn[] arrayOfbohn = this.jdField_a_of_type_ArrayOfBohn;
    int j = arrayOfbohn.length;
    int i = 0;
    while (i < j)
    {
      arrayOfbohn[i].c(paramActivity);
      i += 1;
    }
  }
  
  public void a(bohm parambohm)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_e_of_type_JavaUtilArrayList.contains(parambohm)) {
        this.jdField_e_of_type_JavaUtilArrayList.add(parambohm);
      }
      return;
    }
  }
  
  public void a(boho paramboho)
  {
    synchronized (this.jdField_e_of_type_JavaUtilHashMap)
    {
      String str = paramboho.jdField_a_of_type_Bohr.b();
      ...
      localArrayList1.add(paramboho);
      return;
    }
  }
  
  public void a(bohr parambohr)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboSuccess captureSet " + parambohr);
    }
    if ((parambohr.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambohr.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, parambohr).sendToTarget();
      return;
    }
  }
  
  public void a(bohr parambohr, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboFailed captureset " + parambohr);
    }
    if ((parambohr.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambohr.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, paramInt, 0, parambohr).sendToTarget();
      return;
    }
  }
  ...
  public void a(bohz parambohz)
  {
    ...
    while (localIterator.hasNext()) {
      ((bohm)localIterator.next()).a(parambohz);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateSuccess templateSet " + paramboij);
    }
    if ((paramboij.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)paramboij.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, paramboij).sendToTarget();
      return;
    }
  }
  
  public void a(boij paramboij, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateFailed templateSet " + paramboij + ", error " + paramInt);
    }
    if ((paramboij.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)paramboij.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, paramInt, 0, paramboij).sendToTarget();
      return;
    }
  }
  ...
  public void a(bpju parambpju)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (parambpju != null)
      {
        this.jdField_a_of_type_Bpju = parambpju;
        this.jdField_a_of_type_Bohv.a(parambpju);
        Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 9, parambpju).sendToTarget();
      }
      a(1);
      return;
    }
  ...
  public void a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    ...
    QIMFilterCategoryItem localQIMFilterCategoryItem = bpjt.a().b(i);
    boolean bool1;
    boolean bool2;
    ...
    for (;;)
    {
      ...
      break label58;
      label171:
      paramQIMFilterCategoryItem = ((bohj)bogd.a(5)).a(paramQIMFilterCategoryItem);
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        a(new boho(paramQIMFilterCategoryItem, paramBundle, paramActivity));
        ...
        else
        {
          ...
          continue;
          a(new boho(paramQIMFilterCategoryItem, paramBundle, paramActivity));
          boov.a(paramQIMFilterCategoryItem).a();
  ...
  public boolean a()
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaUtilArrayList)
      {
        ...
        if (((bohr)???).jdField_a_of_type_Int == 1)
        {
          int j = ((bohr)???).a();
          if (j != ((bohr)???).jdField_a_of_type_Int)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMFilterCategoryItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bohr)???).jdField_b_of_type_Int);
            }
            ((bohr)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bohr)???).a());
          if (j != ((bohr)???).jdField_b_of_type_Int)
          {
            ((bohr)???).jdField_b_of_type_Int = j;
            if (QLog.isColorLevel()) {
              QLog.i("QCombo", 2, "buildComboBatch progress: " + j + ", progress: " + ((bohr)???).jdField_b_of_type_Int);
            }
          }
          bool = true;
          i -= 1;
      ...
      if (((bohr)???).jdField_a_of_type_Int == 2)
      {
        ((bohr)???).a();
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bohr)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bohr)???).jdField_a_of_type_Int == 3)
      {
        ((bohr)???).a();
        ((bohr)???).jdField_b_of_type_Int = 10000;
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        boov.a(???).b();
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bohr)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label470:
  ...
  public boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      label411:
      int j;
      if ((paramMessage.obj instanceof boic))
      {
        paramMessage = (boic)paramMessage.obj;
        if (i == 0)
        {
        ...
        else
        {
          for (;;)
          {
            ...
            localObject3 = (boho)((Iterator)localObject2).next();
            i = ((boho)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
            ??? = bpjt.a().b(i);
            if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_Boolean))
            {
              ...
              ((bmuv)bogd.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
              ??? = (Activity)((boho)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get();
              if (??? != null)
              {
                ...
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bohm)((Iterator)???).next()).a(paramMessage, true, 0, ((boho)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
                boov.a(paramMessage).c();
                break;
              }
            }
          }
          this.jdField_a_of_type_Boic = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject2).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (boho)((Iterator)localObject2).next();
          j = ((boho)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = bpjt.a().b(j);
          if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)))
          {
            ...
            ((bmuv)bogd.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
            if ((Activity)((boho)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get() != null) {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ??? = this.jdField_e_of_type_JavaUtilArrayList.iterator();
                if (((Iterator)???).hasNext()) {
                  ((bohm)((Iterator)???).next()).a(paramMessage, false, i, ((boho)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
              }
            }
            QQToast.a(BaseApplicationImpl.sApplication, anvx.a(2131700852), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof bohz))
      {
        paramMessage = (bohz)paramMessage.obj;
        if (i == 0)
        {
          boov.a(paramMessage).b();
          localObject1 = (QIMFilterCategoryItem)paramMessage.jdField_a_of_type_JavaLangObject;
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            if (??? != null)
            {
              ...
              if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
              {
                ...
                ((bmuv)bogd.a(13)).b(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString);
                b((Activity)???, i);
                if (!bohg.a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
          ...
          label982:
          this.jdField_a_of_type_Bohz = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject3).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
          {
            ...
            if (??? != null)
            {
              ...
              ??? = (bohj)bogd.a(5);
              ??? = ((bohj)???).jdField_a_of_type_Bohz;
              if (??? != null) {
                ((bohj)???).a((QIMFilterCategoryItem)((bohz)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((boho)localObject3).jdField_a_of_type_AndroidOsBundle);
              }
            }
            QQToast.a(BaseApplicationImpl.sApplication, anvx.a(2131700854), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof boij))
      {
        localObject1 = (bohs)bogd.a(15);
        paramMessage = (boij)paramMessage.obj;
        if (i == 0)
        {
          boov.a(paramMessage).b();
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            ??? = (boho)((Iterator)localObject3).next();
            ??? = (Activity)((boho)???).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (??? != null)
            {
              i = ((boho)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
              ??? = ((bohs)localObject1).a(i);
              if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
              {
                ...
                a((Activity)???, i);
                if (!((bohs)localObject1).a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bohm)((Iterator)???).next()).a(paramMessage, true, 0, ((boho)???).jdField_a_of_type_AndroidOsBundle);
                }
                boov.a(paramMessage).c();
                break;
              }
          ...
          label1590:
          ((bohs)localObject1).a(paramMessage);
          continue;
        }
        localObject3 = ((ArrayList)???).iterator();
        ...
        {
          ??? = (boho)((Iterator)localObject3).next();
          j = ((boho)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = ((bohs)localObject1).a(j);
          if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
            ...
            if (??? != null)
            {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ...
                if (((Iterator)localObject7).hasNext()) {
                  ((bohm)((Iterator)localObject7).next()).a(paramMessage, false, i, ((boho)???).jdField_a_of_type_AndroidOsBundle);
                }
              }
              ??? = ((bohs)localObject1).a();
              Object localObject7 = (bohj)bogd.a(5);
              if (??? != null) {
                ((bohj)localObject7).a((QIMTemplateItem)((boij)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((boho)???).jdField_a_of_type_AndroidOsBundle);
              }
            }
            QQToast.a(BaseApplicationImpl.sApplication, anvx.a(2131700853), 0).a();
          }
        }
        paramMessage = (bpju)paramMessage.obj;
        try
        {
          localObject1 = this.jdField_e_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject1).hasNext()) {
            ((bohm)((Iterator)localObject1).next()).a(paramMessage);
          }
        }
        finally {}
      }
  ...
  public void b()
  {
    bpju localbpju = this.jdField_a_of_type_Bpju;
    if (QLog.isColorLevel()) {
      QLog.d("QCombo", 2, "randomliseData " + localbpju);
    }
    if (localbpju != null)
    {
      localbpju.a();
  ...
  public void b(bohm parambohm)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      this.jdField_e_of_type_JavaUtilArrayList.remove(parambohm);
      return;
    }
  }
  
  public void b(bohr parambohr)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadBegin combo " + parambohr);
    }
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambohr.jdField_a_of_type_JavaLangObject);
  ...
  public void b(boij paramboij)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadTemplateBegin templateSet " + paramboij);
    }
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)paramboij.jdField_a_of_type_JavaLangObject);
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilArrayList)
      {
        ...
        if (((bohr)???).jdField_a_of_type_Int == 1)
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMTemplateItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bohr)???).jdField_b_of_type_Int);
            }
            ((bohr)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bohr)???).a());
      ...
      if (((bohr)???).jdField_a_of_type_Int == 2)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bohr)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bohr)???).jdField_a_of_type_Int == 3)
      {
        ...
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bohr)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label458:
  ...
  {
    bpjt.a().a(BaseApplicationImpl.getContext(), null, false);
