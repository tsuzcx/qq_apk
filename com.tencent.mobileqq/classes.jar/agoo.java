...
public class agoo
{
  ...
  protected agoo(int paramInt1, long paramLong1, int paramInt2, String paramString1, long paramLong2, String paramString2)
  {
  ...
  protected static agoo a(Cursor paramCursor)
  {
    if (paramCursor == null) {
      return null;
    }
    ...
    return new agoo(i1, l1, m, str, l2, paramCursor);
  }
