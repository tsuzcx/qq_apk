...
public abstract class anqy
{
  ...
  protected abstract void addBusinessObserver(ToServiceMsg paramToServiceMsg, anil paramanil, boolean paramBoolean);
  ...
  public ToServiceMsg makeOIDBPkg(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte, long paramLong, anil paramanil, boolean paramBoolean)
  {
    ...
    addBusinessObserver(paramString, paramanil, paramBoolean);
    return paramString;
  }
}
