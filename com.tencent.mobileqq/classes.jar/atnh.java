...
import com.tencent.mobileqq.forward.ForwardAskAnonymouslyMsgOption;
...
public class atnh
{
  public static SparseArray<Class<? extends atky>> a = new SparseArray(30);
  ...
  public static atky a(Intent paramIntent)
  {
    ...
    if (localClass != null) {
      try
      {
        paramIntent = (atky)localClass.getDeclaredConstructor(new Class[] { Intent.class }).newInstance(new Object[] { paramIntent });
        return paramIntent;
      }
  ...
  public static atky a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
