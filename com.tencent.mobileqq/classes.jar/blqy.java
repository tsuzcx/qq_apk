...
public class blqy
{
  ...
  private static Map<String, blqz> b;
  ...
  public static List<blqz> a()
  {
    ...
    if ((localObject != null) && (!((Map)localObject).isEmpty()))
    {
      ...
      {
        blqz localblqz = (blqz)((Iterator)localObject).next();
        if (localblqz.jdField_a_of_type_Int >= 0) {
          localArrayList.add(localblqz);
        }
      }
  ...
  public static Map<String, blqz> a()
  {
    if (b == null) {
      a();
    }
      ...
      try
      {
        ...
        if (localJSONObject1 != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((localJSONObject2 == null) || (!biit.a(localJSONObject2, str))) {
              break label247;
            }
            localObject = new blqz();
            ((blqz)localObject).jdField_a_of_type_JavaLangString = localJSONObject2.optString("tabKey");
            if ((TextUtils.isEmpty(((blqz)localObject).jdField_a_of_type_JavaLangString)) && (jdField_a_of_type_JavaUtilMap.containsKey(str))) {
              ((blqz)localObject).jdField_a_of_type_JavaLangString = ((String)jdField_a_of_type_JavaUtilMap.get(str));
            }
            ((blqz)localObject).jdField_a_of_type_Int = localJSONObject2.optInt("sequence");
            ((blqz)localObject).b = localJSONObject2.optString("tabName");
            ((blqz)localObject).c = localJSONObject2.optString("tabUrl");
            ((blqz)localObject).d = localJSONObject2.optString("tabIcon");
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      if (!b()) {
        ((VasQuickUpdateManager)paramQQAppInterface.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).downloadItem(100L, "vipComic_nav_tabIcon.zip", "helper");
      }
      return;
      ((VasQuickUpdateManager)paramQQAppInterface.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).downloadItem(100L, "vipComic_nav_config.json", "helper");
    }
  }
    ...
    if ((localObject1 != null) && (!((Map)localObject1).isEmpty()))
    {
      ...
      if ((localObject2 != null) && (localObject2.length > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext()) {
          if (!((List)localObject2).contains(((blqz)((Iterator)localObject1).next()).d)) {
            return false;
          }
        }
        return true;
