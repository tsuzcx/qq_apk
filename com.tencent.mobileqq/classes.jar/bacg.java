  ...
  implements bacm
{
  ...
  public bacg(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
  ...
  public File a()
  {
    ...
    babw localbabw = new babw();
    localbabw.a(BaseApplicationImpl.getContext());
    localbabw.a(this.jdField_a_of_type_JavaLangString, new baci(this, localFile, arrayOfException, localCountDownLatch));
    localbabw.a(baby.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = amdp.a(192).submit(new bach(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
