...
public class oab
{
  ...
  public static int a()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localRecentUserBaseData != null) && (localRecentUserBaseData.mUser != null) && (localRecentUserBaseData.mUser.getType() == 1008) && (rol.b((QQAppInterface)obz.a(), localRecentUserBaseData.mUser.uin))) {
    ...
    if (i < ((List)localObject1).size())
    {
      ...
      while ((((RecentUserBaseData)localObject2).mUser == null) || (((RecentUserBaseData)localObject2).mUser.getType() != 1008) || (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, ajed.aQ)))
      {
        i += 1;
        break;
      }
  ...
  public static void a()
  {
    ...
    {
      return;
      localMessageRecord = localQQAppInterface.a().b(ajed.aQ, 1008);
  ...
  {
    String str3 = rtr.a(ajed.aQ) + "";
    Object localObject3 = null;
    String str1 = null;
    Object localObject4 = KandianRedDotInfo.createRedDotFromMessageRecord(paramMessageRecord, "kandian_daily_red_pnt");
    String str2;
    if (localObject4 != null) {
      if ((((KandianRedDotInfo)localObject4).articleIDList != null) && (!((KandianRedDotInfo)localObject4).articleIDList.isEmpty()))
      {
        localObject1 = ((KandianRedDotInfo)localObject4).articleIDList.get(0) + "";
        str1 = ((KandianRedDotInfo)localObject4).strategyID + "";
        str2 = ((KandianRedDotInfo)localObject4).forderStatus;
        localObject4 = ((KandianRedDotInfo)localObject4).algorithmID + "";
    ...
    label506:
    Object localObject2;
    for (Object localObject1 = str2;; localObject2 = null)
    {
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          {
            i = 1;
            str2 = KandianDailyManager.jdField_a_of_type_JavaLangString;
            if ((paramMessageRecord instanceof MessageForStructing)) {
              str2 = KandianDailyManager.a((MessageForStructing)paramMessageRecord);
            }
          ...
          try
          {
            ...
            localJSONObject.put("algorithm_id", localObject4);
            ...
            ndn.a(null, "CliOper", "", "", paramString, paramString, 0, 0, str3, localObject3, str1, localJSONObject.toString(), false);
            if (!paramMessageRecord.isread)
            {
              ...
              paramMessageRecord.mUin = obz.a();
            }
            try
            {
              paramMessageRecord.mSourceArticleId = Long.valueOf(localObject3).longValue();
              paramMessageRecord.mAlgorithmId = Integer.valueOf((String)localObject4).intValue();
            ...
            new oqv(null, null, pdc.a(), null).a(paramString);
            return;
            localObject1 = null;
            break;
            i = 0;
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    {
      return;
      Collections.sort(paramList, new oac());
      localStringBuilder = new StringBuilder(1024);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        ArticleInfo localArticleInfo = (ArticleInfo)paramList.next();
        if ((obz.a(localArticleInfo) > 0) && (paramList1.contains(Long.valueOf(localArticleInfo.mRecommendSeq))))
        {
  ...
  {
    return "" + bgmq.a("readinjoy_daily_mode_channel_id", Integer.valueOf(41505));
  }
  ...
  private static Map<String, String> b()
  {
    ...
    localObject = ((QQAppInterface)localObject).a().b(ajed.aQ, 1008);
    if (localObject == null) {
      return localHashMap;
    }
