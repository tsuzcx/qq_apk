...
{
  public oab(StoryDetailPresenter paramStoryDetailPresenter)
  {
  ...
  {
    if ((!paramGetFeedCommentEvent.jdField_a_of_type_JavaLangString.equals(StoryDetailPresenter.a(paramStoryDetailPresenter))) || (paramGetFeedCommentEvent.errorInfo.isFail()) || (StoryDetailPresenter.a(paramStoryDetailPresenter) == null)) {
    ...
    paramStoryDetailPresenter.b(paramGetFeedCommentEvent.errorInfo.isSuccess());
  }
