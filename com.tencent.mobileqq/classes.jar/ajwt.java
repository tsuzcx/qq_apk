  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  public Object b;
  protected List<ajyc> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = ajyd.class.getSimpleName();
  }
  
  public ajwt(Context paramContext, bkfv parambkfv, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  protected ChatHistorySearchData a(ChatHistorySearchData paramChatHistorySearchData, ArrayList<ajyc> paramArrayList)
  {
      ...
      do
      {
        ...
        while (i < paramChatHistorySearchData.mSearchData1.size())
        {
          ...
          if (a(localMessageRecord)) {
            paramArrayList.add(new ajyc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
          }
          i += 1;
        }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return false;
      str = bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageRecord.isSend(), paramMessageRecord.senderuin).toLowerCase(Locale.US);
      paramMessageRecord = ajyc.a(paramMessageRecord.msg).toLowerCase(Locale.US);
    } while ((!str.contains(ajyc.jdField_a_of_type_JavaLangString)) && (!paramMessageRecord.contains(ajyc.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public ChatHistorySearchData b(ChatHistorySearchData paramChatHistorySearchData, ArrayList<ajyc> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
