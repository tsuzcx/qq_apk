...
public class axvv
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, TextView paramTextView, @NonNull Friends paramFriends, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      paramQQAppInterface = apph.a(paramTextView.getPaint(), paramFriends, ViewUtils.dip2px(200.0F));
    }
  ...
  public static void a(axyy paramaxyy, View paramView)
  {
    ...
    if ((paramView instanceof Integer))
    {
      ...
      if (i == 2)
      {
        paramaxyy = paramaxyy.c().iterator();
        while (paramaxyy.hasNext()) {
          axvz.a("0X800AF40", ((Integer)paramaxyy.next()).intValue(), "2");
        }
      }
      if (i == 1)
      {
        paramaxyy = paramaxyy.c().iterator();
        while (paramaxyy.hasNext()) {
          axvz.a("0X800B00F", ((Integer)paramaxyy.next()).intValue(), "2");
        }
      }
    }
  }
  ...
  private static void a(Friends paramFriends1, byte[] paramArrayOfByte, @Nullable Friends paramFriends2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusUtil", 2, new Object[] { "parseExtOnlineBusinessInfo: invoked. ", axyi.a(paramFriends1) });
        }
        return;
      }
  ...
  public static boolean a()
  {
    ...
    return (localapzf != null) && (localapzf.a != null) && (a(localapzf.a.a));
  }
  ...
  public static boolean a(int paramInt, Resources paramResources)
  {
    ...
    if (paramInt < 7)
    {
      ...
      i = 2;
      label36:
      i = AIOUtils.dp2px(i * 64 + 62, paramResources);
      if (AIOUtils.dp2px(64.0F, paramResources) * paramInt <= j - i) {
        break label114;
      }
    }
    label109:
  ...
  public static boolean a(axvj paramaxvj)
  {
    if (paramaxvj == null) {}
    while ((paramaxvj.jdField_a_of_type_Long != 40001L) || (TextUtils.isEmpty(paramaxvj.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(paramaxvj.b))) {
      return false;
    }
    return true;
  }
  ...
  public static String b(Friends paramFriends)
  {
    ...
    if (i == 4)
    {
      ...
      if (paramFriends.uin.equals(((QQAppInterface)localObject1).getAccount()))
      {
        ...
        localObject1 = ContactUtils.getSelfNetWorkType();
      }
    }
    for (;;)
    {
      Object localObject2 = bgee.a().a();
      for (;;)
      {
        try
        {
        ...
        try
        {
          if (TextUtils.isEmpty(paramFriends)) {
            localObject2 = BaseApplicationImpl.getContext().getString(2131718588);
          }
        ...
        if (ContactUtils.isInvisibleFriendNetworkStatus(paramFriends)) {
          break label177;
        }
        localObject1 = ContactUtils.getStatusNamePlusNetWorkType(paramFriends.getNetWorkType());
        break;
        label166:
        return localObject2;
        label172:
  ...
  public static boolean b(axvj paramaxvj)
  {
    if (paramaxvj == null) {}
    while ((paramaxvj.jdField_a_of_type_Long != 40001L) || (TextUtils.isEmpty(paramaxvj.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(paramaxvj.b)) || (TextUtils.isEmpty(paramaxvj.c))) {
      return false;
    }
    return true;
  }
  ...
  {
    String str = axyi.b(paramFriends);
    if (QLog.isColorLevel()) {
