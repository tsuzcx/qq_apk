...
public class beei
  extends bedh
  implements DialogInterface.OnDismissListener, bhwb, ShareActionSheet.OnItemClickListener
{
  ...
  public Activity a;
  protected Bundle a;
  private beeo jdField_a_of_type_Beeo;
  ...
  {
    if (paramInt == 1) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720678, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131691359) });
    }
    if (paramInt == 3) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720678, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720048) });
    }
    if (paramInt == 10) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720678, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720043) });
    }
    if (paramInt == 12) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720678, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131696888) });
    }
    return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720678, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131721197) });
  }
  
  private void a(int paramInt, String paramString)
  {
    bdcd.a(this.jdField_a_of_type_AndroidAppActivity, a(paramInt), 2131691957, 2131721441, new beel(this, paramInt, paramString), new beem(this, paramInt, paramString)).show();
  }
  
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
      this.jdField_a_of_type_Zbj.a(paramString1, 3, true);
    }
    for (;;)
    {
      azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_40", "weixin_share", 0, 1, 0, "", "", "", "");
      ...
      bfdq.a().a("", "", "", "1000", "103", "0", false);
      return;
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.s))
      {
        this.jdField_a_of_type_Zbj.i();
        continue;
      }
      ...
      try
      {
        ...
        label159:
        abvm.b(this.jdField_a_of_type_Zbj.a, localJSONObject);
        this.jdField_a_of_type_Zbj.a(paramString1, 3, true);
      }
  ...
  private void b(String paramString)
  {
    ...
    xxb.a(2, 2131691362);
    if ((this.i) && (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p))) {
      this.jdField_a_of_type_Zbj.e();
    }
  }
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
      this.jdField_a_of_type_Zbj.a(paramString, 8, false);
    }
    for (;;)
    {
      String str = this.jdField_f_of_type_JavaLangString;
      if (this.jdField_a_of_type_Bedi.a() != null) {
        str = this.jdField_a_of_type_Bedi.a().getUrl();
      }
      paramString = "";
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
      this.jdField_a_of_type_Zbj.a(paramString, 4, true);
    }
    for (;;)
    {
      azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_42", "pengyouquan_share", 0, 1, 0, "", "", "", "");
      bfdq.a().a("", "", "", "1000", "104", "0", false);
      return;
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.t))
      {
        this.jdField_a_of_type_Zbj.j();
        continue;
      }
      JSONObject localJSONObject;
      if (this.jdField_a_of_type_Zbj.a != null) {
  ...
  private void e()
  {
    if (a(this.jdField_a_of_type_Zbj.a())) {
    ...
    this.jdField_a_of_type_Bedi.a().loadUrl("javascript:" + str + ";");
  }
  
  private void e(String paramString)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
      this.jdField_a_of_type_Zbj.a(paramString, 2, false);
    }
    for (;;)
    {
      bfdq.a().a("", "", "", "1000", "102", "0", false);
      azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_44", "qzone_share", 0, 1, 0, "", "", "", "");
      return;
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.r))
      {
        this.jdField_a_of_type_Zbj.h();
        continue;
      }
      if (this.jdField_a_of_type_Zbj.a != null) {
      ...
      try
      {
        ...
        label120:
        abvm.b(this.jdField_a_of_type_Zbj.a, paramString);
        this.jdField_a_of_type_Zbj.a();
      }
      catch (JSONException localJSONException)
      {
        break label120;
  ...
  public void a(int paramInt)
  {
    ...
    catch (Exception localException)
    {
      ...
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1001", "");
      return;
    }
    ...
    default: 
      return;
    case 1: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, (String)localObject3, (String)localObject2, "1011", "");
      return;
    case 2: 
    case 3: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1002", "");
      return;
    case 9: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1003", "");
      return;
    case 10: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1004", "");
      return;
    case 5: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1005", "");
      return;
    case 4: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1006", "");
      return;
    case 6: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1007", "");
      return;
    case 11: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1008", "");
      return;
    case 8: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1009", "");
      return;
    case 7: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1010", "");
      return;
    case 12: 
      azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1012", "");
      return;
    }
    azmj.b(null, "dc01160", "Pb_account_lifeservice", "", "0X8007C04", "0X8007C04", 0, 1, 0, localException, (String)localObject2, "1013", "");
  }
        ...
        catch (Exception localException)
        {
          ...
          try
          {
            ...
            if (m != 0)
            {
              ...
              localObject1 = bfhi.b(paramString + 200 + (String)localObject2 + "jubao@article@123");
              ...
              azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_67", "jvbao_click", 0, 1, 0, "", "", "", "");
          ...
          if (this.jdField_a_of_type_Beeo == null) {
            continue;
          }
          this.jdField_a_of_type_Beeo.a(paramString);
          continue;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
            continue;
          }
          throw new InvalidParameterException("ACTION_REFRESH_FREIEND_VIEW should be handled by QQBrowserActivity!");
          paramBundle = (beep)this.jdField_a_of_type_Bedi.a().a(-2);
          ...
          boolean bool = true;
          this.jdField_a_of_type_Zbj.g = bool;
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.d("SwiftBrowserShareMenuHandler", 2, new Object[] { "ShareArkFromH5 mShare.isShareArk=", Boolean.valueOf(this.jdField_a_of_type_Zbj.g), ",\n shareUrl=", ndq.b(paramString, new String[0]) });
          ...
          try
          {
            ...
            azmj.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, ndq.b(str3, new String[0]), null, null, null);
            azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_48", "browser_share", 0, 1, 0, "", "", "", "");
            if ((str4 == null) || ("".equals(str4))) {
              continue;
            }
          ...
          paramString = (beet)this.jdField_a_of_type_Bedi.a().a(16);
          if (paramString == null) {
            continue;
          }
          paramString.a("http://appchannel.html5.qq.com/directdown?app=qqbrowser&channel=10367", true);
          azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_46", "qqbrowser_share", 0, 1, 0, "", "", "", "");
          azmj.b(null, "P_CliOper", "VIPCOMIC", "", "0X80061A0", "0X80061A0", 1000, 0, ndq.b(str3, new String[0]), null, null, null);
          if ((str4 == null) || ("".equals(str4))) {
            continue;
          }
          ...
          if ((this.jdField_a_of_type_Zbj.a() == null) || (this.jdField_a_of_type_Zbj.a().jdField_a_of_type_Int != 0)) {
            continue;
          }
          ...
          if (!this.jdField_a_of_type_Zbj.a(paramString)) {
            continue;
          }
          this.jdField_a_of_type_Zbj.a(paramString, 9, false);
          if ((str4 == null) || ("".equals(str4))) {
            continue;
          }
          ...
          this.jdField_a_of_type_Zbj.a(paramString, 5, true);
          continue;
          if (paramInt != 15) {
            continue;
          }
          ...
          QQToast.a(BaseApplicationImpl.getContext(), 2, 2131720944, 0).b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.b());
          return;
          a().a(n, new beej(this));
          azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          if (paramInt != 16) {
            continue;
          }
          ...
          azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          if (paramInt != 17) {
            continue;
          }
          ...
          paramBundle.putExtra("hide_more_button", true);
          this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
          azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          if (paramInt != 18) {
            continue;
          }
          ...
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beep.h = false;
          ...
          azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "refresh_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          ...
          this.jdField_a_of_type_Zbj.a(paramString, m, false);
          continue;
          m = 7;
          continue;
          this.jdField_a_of_type_Zbj.a(paramString, m, true);
          continue;
          if (paramInt != 21) {
            continue;
          }
          paramString = (beed)this.jdField_a_of_type_Bedi.a().a(64);
          if (paramString == null) {
            continue;
          }
          ...
          {
            l1 = new JSONObject(paramBundle.jdField_b_of_type_JavaLangString).getLong("uin");
            paramString = aekt.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, SplashActivity.class), null);
          ...
          paramBundle = "";
          bacb.a(paramString, paramBundle);
          continue;
          m = 1;
          continue;
          paramBundle = this.jdField_a_of_type_Zbj.b();
          continue;
          if (paramInt != 70) {
            continue;
          }
          ...
          azmj.b(null, "dc00898", "", "", "0X800A9A4", "0X800A9A4", 0, 0, "1", "", "", "");
          bczk.a(this.jdField_a_of_type_Bedi.a(), new beek(this));
          continue;
          l1 = 0L;
          continue;
          l1 = 0L;
  ...
  {
    ((beep)this.jdField_a_of_type_Bedi.a().a(-2)).jdField_a_of_type_Long = paramLong;
  }
  
  public void a(beeo parambeeo)
  {
    this.jdField_a_of_type_Beeo = parambeeo;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p)) {
        this.jdField_a_of_type_Zbj.a(paramString1, 1, false);
      }
      for (;;)
      {
        bfdq.a().a("", "", "", "1000", "101", "0", false);
        azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_38", "qq_share", 0, 1, 0, "", "", "", "");
        return;
        if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.q))
        {
          this.jdField_a_of_type_Zbj.g();
        }
        else
        {
          if (this.jdField_a_of_type_Zbj.a != null) {
          ...
          try
          {
            ...
            label138:
            abvm.b(this.jdField_a_of_type_Zbj.a, paramString2);
            this.jdField_a_of_type_Zbj.a(paramString1, 1, false);
          }
  ...
  public void a(zbj paramzbj, long paramLong)
  {
    if (paramzbj == null) {}
    label296:
    do
    {
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()))
        {
          ...
          paramzbj = null;
          localObject1 = (beed)this.jdField_a_of_type_Bedi.a().a(64);
          if (localObject1 != null) {
            paramzbj = ((beed)localObject1).a();
          }
          localObject1 = (beep)this.jdField_a_of_type_Bedi.a().a(-2);
          if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (localObject1 != null))
          {
            if (((beep)localObject1).m)
            {
              paramzbj = "<font color='#777777'>应用由 </font><font color='#00a5e0'>" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.n + "</font><font color='#777777'> 提供</font>";
              this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(Html.fromHtml(paramzbj));
              azmj.b(null, "P_CliOper", "Grp_open", "", "third_app", "exp_menu", 0, 1, 0, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_j_of_type_Int, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_i_of_type_Int, "", "");
            }
          }
          else
          {
          ...
          try
          {
            ...
            else
            {
              ...
              if (this.jdField_f_of_type_Boolean)
              {
                ...
                return;
                if (!TextUtils.isEmpty(paramzbj))
                {
                  this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(paramzbj);
                  break label296;
                }
                this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getApplication().getString(2131720003));
              }
            }
          }
          catch (Exception paramzbj)
          {
            for (;;)
            {
              if (QLog.isColorLevel()) {
                QLog.d("SwiftBrowserShareMenuHandler", 2, "actionSheet.show exception=" + paramzbj);
              }
            }
          }
        }
  ...
  public boolean a()
  {
    ...
    if (((beey)this.jdField_a_of_type_Bedi.a().a(2)).a.jdField_e_of_type_Boolean) {
      return false;
    }
    if (this.jdField_a_of_type_Bedi.a() != null)
    {
  ...
  {
    boolean bool2 = false;
    String str = this.jdField_a_of_type_Zbj.a();
    boolean bool1 = bool2;
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.b()))
    {
      bool1 = bool2;
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.c()))
      {
        bool1 = bool2;
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    Object localObject1 = (beep)this.jdField_a_of_type_Bedi.a().a(-2);
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (localObject1 != null) && (((beep)localObject1).m))
    {
    ...
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (this.h) && (!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:diandian")) && (!TextUtils.isEmpty(this.jdField_a_of_type_Zbj.p))) {
      ...
      if (((this.jdField_a_of_type_Long & 0x8000000) != 0L) && (bjxj.a()) && (!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:kandian")) && (localObject1 != null))
      {
      ...
      if ((!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bfua.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList1);
      }
      ...
      if (this.k)
      {
        ...
        if ((localObject3 != null) && (((anxn)localObject3).a()) && (((anxn)localObject3).e()) && (!anyi.c((String)localObject2)))
        {
          boolean bool = ((anxn)localObject3).c();
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        for (;;)
        {
          ...
          case 1: 
            ...
            for (localActionSheetItem.label = BaseApplicationImpl.getApplication().getString(2131695704);; localActionSheetItem.label = ((nqz)localObject3).jdField_a_of_type_JavaLangString)
            {
      ...
      localObject2 = (beed)this.jdField_a_of_type_Bedi.a().a(64);
      if ((localObject2 != null) && (((beed)localObject2).a()) && (!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:screenShotShare"))) {
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!sxe.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:exportTencentDocs")) && ((((beey)this.jdField_a_of_type_Bedi.a().a(2)).a.jdField_b_of_type_Long & 0x4000) == 0L))
      {
        localObject2 = a();
        localObject1 = localObject2;
  ...
  {
    if ((this.jdField_a_of_type_Bedi.a() == null) || (this.jdField_d_of_type_Boolean)) {}
    int m;
    do
    {
      return;
      ...
      this.jdField_a_of_type_Bedi.a().getSettings().setTextZoom(m);
    } while (this.jdField_a_of_type_Zbj == null);
    this.jdField_a_of_type_Zbj.a(paramInt, m);
  }
  ...
  public void c()
  {
    this.jdField_a_of_type_Rpq = new rps(this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater()).a(this).a(this.jdField_b_of_type_Int).a().a(this.jdField_a_of_type_Bedi.a());
  }
