public class bbmd
{
  ...
  public static long a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, long paramLong1, java.io.RandomAccessFile paramRandomAccessFile, long paramLong2, int paramInt)
  {
    ...
    //   17: lconst_0
    //   18: lconst_0
    //   19: invokespecial 31	bbmh:<init>	([B[BJJJJJ)V
    //   22: astore_0
    //   23: new 33	bbmg
    //   26: dup
    //   27: iload 8
    ...
    //   32: iadd
    //   33: i2l
    //   34: invokespecial 36	bbmg:<init>	(J)V
    //   37: astore_1
    //   38: iload 8
    //   40: sipush 364
    //   43: iadd
    ...
    //   49: aload_1
    //   50: aload 12
    //   52: invokevirtual 45	bbmg:a	(Ljava/nio/ByteBuffer;)V
    //   55: aload_0
    //   56: aload 12
    //   58: invokevirtual 46	bbmh:a	(Ljava/nio/ByteBuffer;)V
    //   61: aload 5
    //   63: lload 6
    ...
    //   261: dup
    //   262: aload 12
    //   264: invokespecial 134	bbmg:<init>	(Ljava/nio/ByteBuffer;)V
    //   267: astore 5
    //   269: new 136	bbmi
    //   272: dup
    //   273: aload 12
    //   275: invokespecial 137	bbmi:<init>	(Ljava/nio/ByteBuffer;)V
    //   278: astore 12
    //   280: aload 5
    //   282: getfield 141	bbmg:b	J
    //   285: lconst_0
    //   286: lcmp
    //   287: ifne +189 -> 476
    //   290: aload 12
    //   292: getfield 144	bbmi:jdField_a_of_type_Int	I
    //   295: istore 9
    //   297: iload 9
    //   299: iconst_1
    ...
    //   402: lreturn
    //   403: aload 12
    //   405: getfield 181	bbmi:jdField_a_of_type_Long	J
    //   408: lstore_3
    //   409: goto -106 -> 303
    //   412: astore_0
    //   413: aconst_null
  ...
  /* Error */
  public static bbme a(android.os.Bundle paramBundle, String paramString1, String paramString2)
  {
    // Byte code:
    //   0: invokestatic 25	java/lang/System:currentTimeMillis	()J
    //   3: lstore 6
    ...
    //   114: aload 14
    //   116: invokestatic 225	bdcs:a	(Ljava/lang/String;)J
    ...
    //   133: ifne +11 -> 144
    //   136: aload 14
    //   138: invokestatic 234	bdcs:a	(Ljava/lang/String;)Z
    //   141: ifne +39 -> 180
    ...
    //   402: ldc_w 299
    //   405: aload 14
    //   407: invokestatic 225	bdcs:a	(Ljava/lang/String;)J
    ...
    //   428: ldc_w 305
    //   431: aload 14
    //   433: invokestatic 310	arni:a	(Ljava/lang/String;)[B
    //   436: invokestatic 315	bdcv:a	([B)Ljava/lang/String;
    ...
    //   454: ldc_w 317
    //   457: aload 14
    //   459: invokestatic 319	arni:d	(Ljava/lang/String;)[B
    //   462: invokestatic 315	bdcv:a	([B)Ljava/lang/String;
    ...
    //   538: ldc_w 327
    //   541: aload_2
    //   542: invokestatic 329	bbmd:a	(Ljava/lang/String;)I
    ...
    //   927: invokespecial 427	bbme:<init>	(Lorg/json/JSONObject;)V
    //   930: astore 10
    //   932: aload_0
    //   933: astore 9
    //   935: aload 10
