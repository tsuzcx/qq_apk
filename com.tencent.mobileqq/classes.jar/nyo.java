        ...
        if ((paramObject != null) && (localObject1 != null))
        {
          ...
          try
          {
            ...
            if (paramInt <= k)
            {
              ...
              m = oau.a((AdvertisementInfo)localObject3);
              String str = oau.b((AdvertisementInfo)localObject3);
              ...
              if ((localObject2 == null) || (!(localObject2 instanceof oce))) {
                break label717;
              }
              ((oce)localObject2).a(true, (AdvertisementInfo)localObject3, paramVarArgs);
            }
          }
