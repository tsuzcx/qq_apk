...
{
  public yhn(SelectMemberActivity paramSelectMemberActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      paramView = MessageFormat.format(this.a.getString(2131435986), new Object[] { Integer.valueOf(this.a.jdField_i_of_type_Int) });
      QQToast.a(this.a, paramView, 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
      return;
    }
    if (!NetworkUtil.d(this.a))
    {
      QQToast.a(this.a, this.a.getString(2131433023), 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
      return;
    }
    if ((this.a.y) && (this.a.jdField_i_of_type_JavaUtilArrayList.size() == 1) && (this.a.jdField_i_of_type_JavaUtilArrayList.get(0) != null))
    {
      ...
      {
        QQToast.a(this.a, this.a.getString(2131436034), 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
        return;
      }
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        DialogUtil.b(this.a, 230, this.a.getString(2131429041), this.a.getString(2131434005), 2131429048, 2131429053, new yho(this), new yhp(this)).show();
