  ...
  extends acnv
{
  ...
  public acon(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (acju)aciy.a((View)localObject1);
          if ((((acju)localObject2).jdField_a_of_type_Int != 0) && (((acju)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.jdField_g_of_type_Int > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((acju)aciy.a((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  int a(int paramInt, acju paramacju)
  {
    int k;
    int m;
    int n;
    if (paramacju.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramacju.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramacju.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.i - BaseChatItemLayout.n;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramacju.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.i + BaseChatItemLayout.n;
      m = paramacju.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.j;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localacju = (acju)aciy.a(localBaseChatItemLayout);
          if (localacju != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localacju.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localacju.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localacju.jdField_a_of_type_AndroidViewView.getLeft() + localacju.jdField_a_of_type_AndroidViewView.getRight()) / 2, localacju);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localacju != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localacju) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = aciy.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          acju localacju = (acju)aciy.a(aciy.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localacju != null)
          {
            k = localacju.jdField_a_of_type_AndroidViewView.getTop();
            k = localacju.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = aciy.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = aciy.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localacju = (acju)aciy.a(aciy.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localacju != null)
              {
                k = localacju.jdField_a_of_type_AndroidViewView.getTop();
                k = localacju.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localacju = (acju)aciy.a(aciy.a(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localacju != null)
              {
                k = localacju.jdField_a_of_type_AndroidViewView.getTop();
                k = localacju.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
