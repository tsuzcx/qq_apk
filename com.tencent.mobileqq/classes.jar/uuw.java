...
{
  public uuw(GivingHeartItemBuilder paramGivingHeartItemBuilder) {}
  ...
  public void onAnimationStart(Animator paramAnimator)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqDiniflyViewAnimation != null)
    {
      ...
      paramAnimator = ((ViewGroup)((Activity)this.a.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131363473);
