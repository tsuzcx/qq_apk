  ...
  implements Manager
{
  ...
  {
    return new asew(this, paramBaseChatPie, paramShort);
  }
  ...
  private void a(SessionInfo paramSessionInfo, short paramShort, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
    if (!a(a(paramShort)))
    {
      paramSessionInfo = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131720183), new Object[] { paramString, paramString });
      paramSessionInfo = bbdj.a(paramBaseChatPie.a, 230, ajya.a(2131714829), paramSessionInfo, 2131720181, 2131720182, a(paramBaseChatPie, paramShort), a(paramBaseChatPie, paramShort));
      paramSessionInfo.setOnCancelListener(new asev(this, paramBaseChatPie));
      paramSessionInfo.setCanceledOnTouchOutside(false);
      paramSessionInfo.show();
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009977", "0X8009977", a(paramShort), a(paramShort), "", "", "", "");
    }
  ...
  {
    this.jdField_a_of_type_Asex = paramasex;
  }
  ...
  public void a(SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
    ...
    default: 
      return;
    case 1000: 
      a(paramSessionInfo, (short)-23308, ajya.a(2131714828), i, paramBaseChatPie);
      return;
    case 1006: 
      a(paramSessionInfo, (short)-23310, ajya.a(2131714826), i, paramBaseChatPie);
      return;
    case 1001: 
    case 1003: 
      a(paramSessionInfo, (short)-23312, ajya.a(2131714825), i, paramBaseChatPie);
      return;
    case 10002: 
      a(paramSessionInfo, (short)-23311, ajya.a(2131714827), i, paramBaseChatPie);
      return;
    }
  ...
  public void a(SessionInfo paramSessionInfo, String paramString, int paramInt, short paramShort)
  {
    ...
    if (paramInt == 1000)
    {
      paramString = bbcz.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo.c);
      String str = bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo.c, true);
      if (QLog.isColorLevel()) {
        QLog.d("TempMsgManager", 2, "getTroopNickName:" + paramString + " new From:" + str);
      }
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131720188), new Object[] { str });
      localObject = new aqvb(paramSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.jdField_a_of_type_Int, -5023, 655381, awzy.a());
      ...
      ((aqvb)localObject).a(5, str.length() + 5, localBundle);
      ...
      ((aqvb)localObject).a(paramString.length() - 5, paramString.length() - 1, paramSessionInfo);
    ...
    for (;;)
    {
      ...
      return;
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131720187), new Object[] { paramString });
      paramSessionInfo = new aqvb(paramSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.jdField_a_of_type_Int, -5023, 655381, awzy.a());
  ...
  public void a(short paramShort, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      ((ajti)localObject).a(paramShort, paramBoolean1);
      return;
      this.jdField_a_of_type_JavaUtilMap.put(localObject, Boolean.valueOf(paramBoolean1));
      break;
    }
  ...
  public boolean a(String paramString, SessionInfo paramSessionInfo)
  {
    try
    {
      if ((this.jdField_a_of_type_Aukp.a(TempMsgInfo.class, paramString + paramSessionInfo.jdField_a_of_type_JavaLangString) instanceof TempMsgInfo)) {
        return false;
      }
      if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_Aukp.a(new TempMsgInfo(paramString + paramSessionInfo.jdField_a_of_type_JavaLangString, System.currentTimeMillis()));
      return true;
    }
    finally {}
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Asex = null;
