...
public class aseu
{
  ...
  public aseu(String paramString, int paramInt)
  {
  ...
  public static Drawable a(Context paramContext, asfa paramasfa)
  {
    Object localObject = paramasfa.a;
    ...
    for (paramContext = paramContext.a("fromAIO", true);; paramContext = null)
    {
      ...
      do
      {
        ...
        localURL = bdzx.a((MessageForPic)localObject, 1);
        ...
        localURL = ahdu.a((MessageForPic)localObject);
      ...
      QLog.d("EmotionDataManager", 2, new Object[] { "init view,big pic not exist:", bdsh.a(localURL.toString()) });
      return localObject;
      return null;
    }
  }
  
  public static asbq a(MessageForMarketFace paramMessageForMarketFace)
  {
    return ((awmr)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramMessageForMarketFace.mMarkFaceMessage);
  }
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = new arnj(paramInt1, paramInt2);
    return localURLDrawableOptions;
  }
  
  public static EmoticonPackage a(String paramString)
  {
    return ((awmr)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramString);
  }
  ...
  private List<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localObject1 instanceof MessageForPic))
      {
        ...
        if ((!a((MessageForPic)localObject2)) && (ahdu.a((MessageForPic)localObject2))) {
        ...
        if (((MessageForMixedMsg)localObject1).msgElemList != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForPic))
            {
              ...
              ((MessageForPic)localObject2).parse();
              if (ahdu.a((MessageForPic)localObject2)) {
  ...
  {
    return ains.a(paramMessageForPic);
  }
}
