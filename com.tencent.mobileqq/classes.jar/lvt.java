...
public class lvt
  implements mqo
{
  private static volatile lvt jdField_a_of_type_Lvt;
  public int a;
  ...
  private lvv jdField_a_of_type_Lvv = new lvv(this);
  ...
  public static lvt a()
  {
    if (jdField_a_of_type_Lvt == null) {}
    try
    {
      if (jdField_a_of_type_Lvt == null) {
        jdField_a_of_type_Lvt = new lvt();
      }
      return jdField_a_of_type_Lvt;
    }
    finally {}
  }
  ...
  {
    return mcl.a(mce.a().a()) == 1;
  }
  
  private boolean d()
  {
    VoiceRecognizer.shareInstance().setListener(this.jdField_a_of_type_Lvv);
    ...
    DownloadInfo localDownloadInfo = mce.a().a();
    if (localDownloadInfo == null)
    {
      QLog.i("AVVoiceRecog", 1, "initRecognizer. init failed. downloadInfo == null.");
      return false;
    }
    String str1 = mcl.b() + localDownloadInfo.filename_so_wxvoiceembedqqegg;
    String str2 = mcl.a() + localDownloadInfo.filename_model_wxvoiceembed;
    if (!mce.a().a())
    {
      mce.a().b();
  ...
  public void a(VideoAppInterface paramVideoAppInterface, lvu paramlvu)
  {
  ...
  public boolean c()
  {
    ...
    if (!b())
    {
      ...
      String str = mcl.b() + ((DownloadInfo)localObject).filename_so_wxvoiceembedqqegg;
      localObject = mcl.a() + ((DownloadInfo)localObject).filename_model_wxvoiceembed;
      if (!mce.a().a())
      {
        mce.a().b();
