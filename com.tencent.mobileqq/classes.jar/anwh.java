...
public class anwh
{
  public static String a(QQAppInterface paramQQAppInterface, bbwg parambbwg, boolean paramBoolean)
  {
    ArrayList localArrayList = null;
    if ((paramQQAppInterface == null) && (parambbwg == null)) {}
    EmoticonPackage localEmoticonPackage;
    do
    {
      return null;
      localObject = parambbwg.a();
      localEmoticonPackage = (EmoticonPackage)((Bundle)localObject).getSerializable("emoticonPackage");
    } while (localEmoticonPackage == null);
    int i = ((Bundle)localObject).getInt("jsonType", anvs.c);
    File localFile = (File)parambbwg.jdField_a_of_type_JavaUtilMap.get(parambbwg.jdField_a_of_type_JavaLangString);
    Object localObject = new anwq();
    parambbwg = localArrayList;
    if (localFile != null)
    {
      if (localFile.exists()) {
        parambbwg = bbdj.a(localFile);
      }
    }
    else
    {
    ...
    label162:
    for (paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambbwg, localArrayList);; paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambbwg, localArrayList, (anwq)localObject))
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList)
  {
    ...
    askd localaskd = (askd)paramQQAppInterface.getManager(14);
    Object localObject1;
    Object localObject2;
    String str1;
    try
    ...
    catch (JSONException paramQQAppInterface)
    {
      for (;;)
      {
        ...
        paramArrayOfByte = localaskd.b(paramEmoticonPackage.epId);
    ...
    localaskd.a(paramEmoticonPackage);
    if (QLog.isColorLevel()) {
    ...
    if (j < m)
    {
      ...
      paramQQAppInterface = localaskd.a(str1, (String)localObject1);
      if (paramQQAppInterface == null)
      {
        if (paramInt == anvs.d) {
          break label1013;
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, anwq paramanwq)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList == null) || (paramanwq == null))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramArrayOfByte.has("type")) && (1 == j))
    {
      ...
      if (paramEmoticonPackage.copywritingType != askc.a)
      {
      ...
      paramQQAppInterface = localaskd.b(str1);
      if (paramQQAppInterface != null)
      {
      ...
      if ((paramEmoticonPackage.mobileFeetype == 1) || ((str1 != null) && ("10278".equals(str1))) || (paramEmoticonPackage.jobType == 1))
      {
        ...
        localObject2 = localaskd.a(str1, str2);
