  ...
  extends BaseAdapter
{
  ...
  private auim jdField_a_of_type_Auim;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private ArrayList<AutoReplyText> jdField_a_of_type_JavaUtilArrayList;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public auid(QQAppInterface paramQQAppInterface, Context paramContext, Drawable paramDrawable)
  {
  ...
  private View a(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (TextView)paramLayoutInflater.findViewById(2131364691);
    ViewGroup.MarginLayoutParams localMarginLayoutParams = (ViewGroup.MarginLayoutParams)paramViewGroup.getLayoutParams();
    if (getItemViewType(paramInt) == 0)
    {
      localMarginLayoutParams.topMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298255);
      localMarginLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298252);
      paramViewGroup.setText(2131690300);
      paramViewGroup.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131690300));
    }
    for (;;)
    {
      paramViewGroup.setLayoutParams(localMarginLayoutParams);
      return paramLayoutInflater;
      localMarginLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298255);
      localMarginLayoutParams.topMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298252);
      paramViewGroup.setText(2131690306);
      paramViewGroup.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131690306));
    }
  }
  
  private auin a(LayoutInflater paramLayoutInflater, int paramInt, View paramView, ViewGroup paramViewGroup, AutoReplyText paramAutoReplyText)
  {
    if ((paramView == null) || (paramView.getTag() == null) || (paramView.getVisibility() == 8))
    {
      ...
      paramLayoutInflater = paramView.findViewById(2131365263);
      if (ThemeUtil.isDefaultTheme())
      {
        ...
        if ((!ThemeUtil.isDefaultTheme()) && (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))) {
          paramView.findViewById(2131375131).setBackgroundResource(2130839179);
        }
        paramView.findViewById(2131369113).setPadding(0, 0, 0, 0);
        paramView.findViewById(2131375302).setVisibility(8);
        paramViewGroup = (TextView)paramView.findViewById(2131369134);
        paramViewGroup.setEditableFactory(new auif(this, paramViewGroup));
        paramLayoutInflater = new auin(null);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375279));
        paramLayoutInflater.b = paramView.findViewById(2131365400);
        paramLayoutInflater.c = paramView.findViewById(2131365401);
        paramLayoutInflater.d = paramView.findViewById(2131377061);
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.setTag(paramLayoutInflater);
        label200:
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new auig(this, paramAutoReplyText));
        paramLayoutInflater.b.setOnClickListener(new auih(this, paramAutoReplyText));
        ...
        paramView = aylc.a(paramView, paramLayoutInflater.jdField_a_of_type_AndroidWidgetTextView.getPaint(), 3, i, axlk.a - axlk.a(67.0F), true);
        if (QLog.isColorLevel()) {
          QLog.d("AutoReplyAdapter", 2, "Truncate subText: " + paramView);
        }
        paramViewGroup = new aykk(paramView, 3, i);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(new aykk(ajya.a(2131700860) + paramView, 3, i));
        paramLayoutInflater.c.setOnClickListener(new auii(this, paramAutoReplyText, bool));
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.findViewById(2131375131).setOnClickListener(new auij(this, paramAutoReplyText));
    ...
    label562:
    label567:
    for (paramInt = 0;; paramInt = axlk.a(200.0F))
    {
      ...
      paramInt = 8;
      break;
      paramLayoutInflater = (auin)paramView.getTag();
      paramLayoutInflater.jdField_a_of_type_AndroidViewView = paramView;
      break label200;
      paramInt = 0;
      break label259;
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    auik localauik = new auik(this, paramView, paramView.getMeasuredHeight());
    localauik.setAnimationListener(new auil(this, paramInt));
    localauik.setDuration(150L);
    paramView.startAnimation(localauik);
  }
  ...
  private View b(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramLayoutInflater.setOnClickListener(new auie(this));
    return paramLayoutInflater;
  }
  ...
  private void b(int paramInt)
  {
    ...
    if (((Iterator)localObject).hasNext())
    {
      ...
      if (localAutoReplyText.getTextId() == paramInt)
      {
        ...
        if (this.jdField_a_of_type_Auim != null)
        {
          auim localauim = this.jdField_a_of_type_Auim;
          if (localAutoReplyText.getTextId() == 2147483647)
          {
            bool = true;
            localauim.a(localAutoReplyText, bool);
          }
        }
        else
        {
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.b = bool;
      if (this.jdField_a_of_type_Auim != null) {
        this.jdField_a_of_type_Auim.a(localObject2, localObject1);
      }
      notifyDataSetChanged();
      return;
    }
  ...
  public void a(@Nullable auim paramauim)
  {
    this.jdField_a_of_type_Auim = paramauim;
  }
  ...
  public void a(@Nullable AutoReplyText paramAutoReplyText)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Auim != null) {
        this.jdField_a_of_type_Auim.a(paramAutoReplyText);
      }
      a();
      this.b = true;
      notifyDataSetChanged();
