...
public class axzm
  extends axzy
{
  private axzm(SignatureHistoryFragment paramSignatureHistoryFragment) {}
  ...
  protected void a(boolean paramBoolean, List<byte[]> paramList, List<Integer> paramList1)
  {
    ...
    SignatureHistoryFragment.a(this.a).setText(2131720178);
    SignatureHistoryFragment.b(this.a, false);
