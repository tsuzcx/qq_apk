  ...
  implements rly
{
  ...
  private final ArrayList<rlv> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private final LinkedHashMap<String, String> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  private final rme jdField_a_of_type_Rme = new rme((rlx)new rmc());
  
  static
  {
    jdField_a_of_type_Rlu = new rlu(null);
  }
  
  public rlt()
  {
    this.jdField_a_of_type_Rme.a((rly)this);
  }
  
  private final String a()
  {
    String str = Aladdin.getConfig(296).getString("watch_word_public_topic_text", pkh.a(2131717970));
  ...
  {
    String str = Aladdin.getConfig(296).getString("watch_word_private_topic_text", pkh.a(2131717968));
  ...
  {
    String str = Aladdin.getConfig(296).getString("watch_word_public_video_text", pkh.a(2131717971));
  ...
  {
    String str = Aladdin.getConfig(296).getString("watch_word_private_video_text", pkh.a(2131717969));
  ...
  public final void a(@NotNull rlv paramrlv)
  {
    Intrinsics.checkParameterIsNotNull(paramrlv, "observer");
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramrlv)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramrlv);
    }
  }
}
