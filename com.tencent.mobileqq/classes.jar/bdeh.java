  ...
  implements Manager
{
  ...
  public bdeh(QQAppInterface paramQQAppInterface)
  {
  ...
  SubAccountMessage a(String paramString)
  {
    ...
    localSubAccountMessage.sendername = anni.a(2131718304);
  ...
  public List<SubAccountMessage> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (anhk.aD.equals(((SubAccountMessage)localObject2).senderuin))
            {
              localObject1 = localObject2;
              break label304;
            }
      ...
      for (localObject1 = null;; localObject1 = "containsKey=" + this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
      {
        ...
        label239:
        if ((localaqtu == null) || (localaqtu.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_Boolean)) {
          break;
        }
        localArrayList.add(0, a(paramString));
        break;
  ...
  public void a(bdei parambdei)
  {
    ...
    {
      if ((parambdei != null) && (parambdei.jdField_b_of_type_JavaLangString != null) && (parambdei.c())) {
        break label183;
      }
      if (QLog.isColorLevel())
      {
    ...
    label143:
    for (parambdei = "data == null";; parambdei = "data.mMainAccount=" + parambdei.jdField_b_of_type_JavaLangString + " data.mSubUin=" + parambdei.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, parambdei);
      return;
      localObject1 = "data.mMainAccount=" + parambdei.jdField_b_of_type_JavaLangString + " data.mSubUin=" + parambdei.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ArrayList localArrayList2 = parambdei.a();
    Object localObject1 = parambdei.c();
    ArrayList localArrayList3 = parambdei.b();
    if (QLog.isColorLevel())
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!parambdei.jdField_b_of_type_JavaLangString.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
          ...
          ((SubAccountInfo)localObject2).trunkuin = parambdei.jdField_b_of_type_JavaLangString;
          ((SubAccountInfo)localObject2).serverErrorType = parambdei.jdField_b_of_type_Int;
          ((SubAccountInfo)localObject2).serverErrorMsg = parambdei.jdField_a_of_type_JavaLangString;
      ...
      {
        parambdei = localArrayList3.iterator();
        while (parambdei.hasNext()) {
          a((String)parambdei.next());
        }
      }
      label575:
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      ...
      parambdei = localArrayList1.iterator();
      while (parambdei.hasNext()) {
        a((SubAccountInfo)parambdei.next());
      }
      break;
      label629:
      localObject1 = null;
          ...
          if (paramString2 != null)
          {
            ...
            if (bool)
            {
              ...
              if (localSubAccountMessage.istroop == 1)
              {
                ...
                bddy.a(paramQQAppInterface, paramString1, 6);
                paramQQAppInterface.a().d(paramString1, 7000, -i);
                paramQQAppInterface.a().a(new String[] { anhk.x, paramString1 });
                paramQQAppInterface.E();
                paramString2 = new bdei();
        ...
        if (localObject != null)
        {
          ...
          if (i4 != 0)
          {
            ...
            if ((((SubAccountMessage)localObject).mEmoRecentMsg == null) && (((SubAccountMessage)localObject).msg != null)) {
              ((SubAccountMessage)localObject).mEmoRecentMsg = new bdnt(((SubAccountMessage)localObject).msg, 3, 16);
            }
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramSubAccountMessage.subUin))
        {
          ...
          if (((Iterator)localObject).hasNext())
          {
            ...
            if ((anhk.aD.equals(paramSubAccountMessage.senderuin)) && (paramSubAccountMessage.time > localSubAccountMessage.time))
            {
              bool = true;
              continue;
            }
            if ((!anhk.aD.equals(paramSubAccountMessage.senderuin)) || (paramSubAccountMessage.unreadNum != 0)) {
              continue;
            }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((anhk.aD.equals(paramSubAccountMessage.senderuin)) && (paramSubAccountMessage.time == 0L) && (paramSubAccountMessage.unreadNum == 0))
          {
        ...
        if (!anhk.aD.equals(paramSubAccountMessage.senderuin)) {
          continue;
        }
      }
      finally
  ...
  public void c(String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      {
        localbded = bddy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSubAccountInfo.subuin);
        ...
        if ((localbded.jdField_a_of_type_Boolean) || (j == localbded.jdField_a_of_type_Int)) {
          break label429;
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(localSubAccountInfo.subuin, 7000, localbded.jdField_a_of_type_Int - j);
      }
    }
    label338:
    acvy localacvy;
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("SUB_ACCOUNT", 2, "updateAnotherSubAccountUnreadMsg" + " info.subuin=" + localSubAccountInfo.subuin + " anotherC2cUnread=" + j + " anotherTroopUnread=" + k + " item.showRedDot=" + localbded.jdField_a_of_type_Boolean + " item.unReadCount=" + localbded.jdField_a_of_type_Int);
        break label198;
        break;
        if ((localbded.jdField_a_of_type_Boolean) && (localbded.jdField_a_of_type_Int != k))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 != null) && (((ArrayList)localObject2).size() != 0))
            {
              ...
              if (((Iterator)localObject2).hasNext())
              {
                ...
                localSubAccountMessage.mTimeString = bgsu.a(localSubAccountMessage.time * 1000L, true, paramString);
                if (i == 0) {
                  break label332;
                }
                i = 0;
