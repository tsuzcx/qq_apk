...
public class acid
  ...
  implements achp
{
  private List<acic> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  protected void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new acib());
      this.jdField_a_of_type_JavaUtilList.add(new acig());
      this.jdField_a_of_type_JavaUtilList.add(new acif());
      return;
    }
