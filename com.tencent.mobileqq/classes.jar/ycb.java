  ...
  implements View.OnClickListener
{
  ...
  public ycb(TroopAddFrdsInnerFrame paramTroopAddFrdsInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970293, paramViewGroup, false);
      paramView = new TroopAddFrdsInnerFrame.AddFrdHolder();
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131363923);
      paramView.jdField_a_of_type_AndroidViewView.setId(2131362464);
      paramViewGroup = localView.findViewById(2131369980);
      localObject2 = (RelativeLayout.LayoutParams)paramViewGroup.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject2).addRule(0, 2131362464);
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131369982));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362894));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131369984));
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131368973));
      paramView.d = ((TextView)localView.findViewById(2131368974));
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131368492));
      paramView.e = ((TextView)localView.findViewById(2131363937));
      paramView.jdField_b_of_type_AndroidViewView = localView.findViewById(2131369972);
      ...
      {
        localView.findViewById(2131362464).setPadding(0, 0, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.b, 0);
    ...
    for (;;)
    {
      ...
      {
        localAddFrdHolder.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources().getString(2131435515, new Object[] { Integer.valueOf(((TroopMemberInfo)localObject2).commonFrdCnt) }));
      ...
      for (;;)
      {
        ...
        for (paramInt = i;; paramInt = 8)
        {
          ...
          return localView;
          localView.findViewById(2131362464).setPadding(0, 0, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.c, 0);
          break;
          label1039:
          localAddFrdHolder.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
          break label485;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.f == TroopAddFrdsInnerFrame.d)
        {
          ...
          localAddFrdHolder.e.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131435997), new Object[] { paramView.toLowerCase() }));
          return localView;
        }
        localAddFrdHolder.e.setVisibility(8);
  ...
  public void onClick(View paramView)
  {
    ...
    ((Bundle)localObject).putString("selfSet_leftViewText", this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131433109));
    ((Bundle)localObject).putString("custom_leftbackbutton_name", this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131433698));
