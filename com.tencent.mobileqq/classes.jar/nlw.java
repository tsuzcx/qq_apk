...
public class nlw
  implements bdko, bibq
{
  public Context a;
  protected Handler a;
  protected List<qjf> a;
  protected Handler b;
  protected List<qjf> b;
  
  public nlw(Context paramContext)
  {
  ...
  private void a(Activity paramActivity, qjf paramqjf)
  {
    ...
    if ((TextUtils.isEmpty(paramqjf.jdField_c_of_type_JavaLangString)) && (!TextUtils.isEmpty(paramqjf.jdField_b_of_type_JavaLangString))) {
      paramqjf.jdField_c_of_type_JavaLangString = a(paramqjf.jdField_b_of_type_JavaLangString, 0);
    }
    if (TextUtils.isEmpty(paramqjf.jdField_c_of_type_JavaLangString))
    {
      if (paramqjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
        i = paramqjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.progress;
      }
      for (;;)
      {
        a(paramqjf, 6, i);
        return;
        if (paramqjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData != null) {
          i = paramqjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData.j;
        } else if (paramqjf.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData != null) {
          i = paramqjf.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData.jdField_c_of_type_Int;
        }
      }
    }
    String str1 = paramqjf.d;
    String str2 = paramqjf.jdField_a_of_type_JavaLangString;
    String str3 = paramqjf.jdField_c_of_type_JavaLangString;
    String str4 = paramqjf.e;
    if ((TextUtils.isEmpty(str1)) || (TextUtils.isEmpty(str2)) || (TextUtils.isEmpty(str3)) || (TextUtils.isEmpty(str4)))
    {
      ...
      for (;;)
      {
        ...
        {
          i = j;
          if (paramqjf.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData != null) {
            i = paramqjf.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData.jdField_c_of_type_Int;
          }
        }
      }
    ...
    localBundle.putString(bdkm.l, str4);
    ...
    localBundle.putBoolean(bdkm.h, true);
    localBundle.putBoolean(bdkm.r, false);
    localBundle.putBoolean(bdkm.J, false);
    localBundle.putString("sendTime", "_" + GlobalUtil.calcMD5AsString(str3));
    if (!TextUtils.isEmpty(paramqjf.f)) {
      localBundle.putString(bdkm.i, paramqjf.f);
    }
    if (QLog.isColorLevel()) {
      QLog.d("ADBaseAppDownloadManager", 2, "startRealDownload pkg:" + str1 + ", appid:" + str2 + ", name:" + str4 + ", url:" + str3);
    }
    if (this.jdField_a_of_type_JavaUtilList.contains(paramqjf)) {
      this.jdField_a_of_type_JavaUtilList.remove(paramqjf);
    }
    this.jdField_a_of_type_JavaUtilList.add(paramqjf);
    bdgz.a().a(paramActivity, localBundle, "biz_src_feeds_kandianads", null, 0);
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      {
        return false;
        paramContext = bdgv.a().c(paramString);
  ...
  public static boolean a(Context paramContext, qjf paramqjf)
  {
    ...
    QLog.d("ADBaseAppDownloadManager", 2, "isPkgExist(" + bool1 + ") pkg:" + str1 + ", appid:" + str2 + ", path:" + paramqjf);
    return bool1;
  ...
  public static boolean a(qjf paramqjf, int paramInt)
  {
    do
    {
      try
      {
        if (!paramqjf.jdField_a_of_type_Boolean) {
          break;
        }
        if (!TextUtils.isEmpty(paramqjf.i)) {
          continue;
        }
        if (TextUtils.isEmpty(paramqjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData.Q)) {
          break;
        }
      }
      catch (Exception paramqjf)
      {
        return false;
      }
      if (TextUtils.isEmpty(paramqjf.i)) {}
      for (paramqjf = paramqjf.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData.Q; new File(paramqjf).exists(); paramqjf = paramqjf.i) {
        return true;
      }
  ...
  {
    if (paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams == null) {
      paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams = a(paramqjf);
    }
    a(paramqjf);
    biby.a().a(paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams);
    if (this.jdField_a_of_type_JavaUtilList.contains(paramqjf)) {
      this.jdField_a_of_type_JavaUtilList.remove(paramqjf);
    }
    this.jdField_a_of_type_JavaUtilList.add(paramqjf);
  ...
  protected WadlParams a(qjf paramqjf)
  {
    WadlParams localWadlParams = new WadlParams(paramqjf.jdField_a_of_type_JavaLangString, paramqjf.d);
    localWadlParams.jdField_c_of_type_Int = 7;
    localWadlParams.jdField_b_of_type_Int = 2;
    localWadlParams.o = (paramqjf.g + "@" + paramqjf.h);
    localWadlParams.jdField_b_of_type_JavaLangString = paramqjf.jdField_c_of_type_JavaLangString;
    localWadlParams.k = paramqjf.e;
  ...
  protected String a(String paramString, int paramInt)
  {
    ...
    //   171: invokevirtual 423	nlw:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   174: astore_1
    //   175: aload_1
    ...
    //   191: invokevirtual 429	nlw:a	(Lorg/json/JSONObject;)Ljava/lang/String;
    //   194: astore_1
    //   195: aload_1
    //   196: astore 4
    //   198: aload_3
  ...
  protected void a(qjf paramqjf) {}
  
  public void a(qjf paramqjf, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ADBaseAppDownloadManager", 2, "startDownload " + paramqjf.d + " progress " + paramInt);
    }
    paramqjf.jdField_a_of_type_Int = 3;
    bdgv.a().a(this);
    a((Activity)this.jdField_a_of_type_AndroidContentContext, paramqjf);
  }
  
  public void a(qjf paramqjf, int paramInt1, int paramInt2) {}
  
  public void a(qjf paramqjf, boolean paramBoolean)
  {
    if ((paramBoolean) && (paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams == null)) {
      paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams = a(paramqjf);
    }
    if ((paramqjf.jdField_a_of_type_Boolean) && (paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams != null)) {
      biby.a().a(0, paramqjf.jdField_a_of_type_JavaLangString);
    }
    do
    {
      return;
      d(paramqjf);
      paramqjf = paramqjf.jdField_c_of_type_JavaLangString;
    } while (TextUtils.isEmpty(paramqjf));
    bdgv.a().a(paramqjf);
  }
  ...
  {
    if (paramqjf != null) {
      ThreadManager.excute(new ADBaseAppDownloadManager.1(this, paramqjf), 128, null, true);
    }
    return false;
  }
  ...
  public void b(qjf paramqjf)
  {
    ...
    localArrayList.add(paramqjf.jdField_a_of_type_JavaLangString);
    if (!this.jdField_b_of_type_JavaUtilList.contains(paramqjf))
    {
      this.jdField_b_of_type_JavaUtilList.clear();
      this.jdField_b_of_type_JavaUtilList.add(paramqjf);
    }
  ...
  {
    ThreadManager.executeOnSubThread(new ADBaseAppDownloadManager.2(this, paramqjf, paramInt));
  }
  
  public boolean b(qjf paramqjf)
  {
    return true;
  }
  ...
  {
    if ((TextUtils.isEmpty(paramqjf.jdField_c_of_type_JavaLangString)) && (this.jdField_a_of_type_JavaUtilList.size() > 0) && (paramqjf.b()))
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        qjf localqjf = (qjf)localIterator.next();
        if ((localqjf.b()) && (!TextUtils.isEmpty(localqjf.jdField_c_of_type_JavaLangString)) && (paramqjf.a(localqjf))) {
          paramqjf.jdField_c_of_type_JavaLangString = localqjf.jdField_c_of_type_JavaLangString;
        }
      }
    }
  }
  
  public void e(qjf paramqjf)
  {
    if (paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams == null) {
      paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams = a(paramqjf);
    }
    biby.a().b(paramqjf.jdField_a_of_type_CooperationWadlIpcWadlParams);
  }
  ...
  public void onQueryCallback(ArrayList<WadlResult> paramArrayList)
  {
    ...
    {
      a(new WadlResult(((qjf)paramArrayList.next()).jdField_a_of_type_CooperationWadlIpcWadlParams), 8);
      continue;
