  ...
  implements Manager
{
  ...
  public ArrayList<azlg> a;
  protected Queue<String> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "<{text:'A',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + ajjy.a(2131650000) + "<{text:'B',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + ajjy.a(2131650001) + "<{icon:'/rose',url:'url.qq.com?rose.png',alt:'玫瑰'}>";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public azlf(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(GroupOpenSysMsg.SysMsgBody paramSysMsgBody, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    {
      MessageForArkApp localMessageForArkApp = (MessageForArkApp)awbi.a(-5008);
      ...
      if (paramSysMsgBody.sender.has())
      {
        ...
        localMessageForArkApp.saveExtInfoToExtStr("troop_msg_nick_color", String.valueOf(BaseApplication.getContext().getResources().getColor(2131101284)));
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    boolean bool = localatmp.a(TroopTipsEntity.class.getSimpleName(), localContentValues, "troopUin=? and msgSeq=?", new String[] { paramString1, paramString2 });
    localatmp.a();
    if (bool)
    {
  ...
  public MessageForGrayTips a(TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    do
    {
      ...
      } while (ajml.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForGrayTips, false));
  ...
  public MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2, akap paramakap)
  {
    ...
    do
    {
        ...
        try
        {
          ...
          case 1: 
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_redtips.has())
            {
              ...
              {
                a(new azlg(this, ((TroopTipsEntity)localObject2).troopUin, paramArrayOfByte));
                return null;
              }
              ((TroopTipsEntity)localObject2).currentUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              paramQQAppInterface = (MessageForQQWalletTips)awbi.a(-2029);
              ...
              paramQQAppInterface.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((TroopTipsEntity)localObject2).troopUin, "", "[QQWallet Tips]", awao.a(), -2029, 1, awao.a());
            ...
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint32_robot_group_opt.has())
            {
              ...
              paramArrayOfByte = (azks)paramQQAppInterface.getManager(203);
            }
            ...
            if (j == 3)
            {
              azgh.a(paramQQAppInterface, (TroopTipsEntity)localObject2);
              return null;
            }
            if ((j == 6) && (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint64_receiver_uin.has()))
            {
              ...
              {
                ayqn.a().a(String.valueOf(l1), paramQQAppInterface.getCurrentAccountUin(), true);
                ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1, paramLong);
              }
            }
            for (;;)
            {
              ...
              if ((paramBoolean1) || (!ajml.a(paramQQAppInterface, paramArrayOfByte, false))) {
                break label1216;
              }
              return null;
              if (j != 11) {
      ...
      azlj.a(l1, paramQQAppInterface, paramLong);
      return null;
    ...
    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_group_notify.has())
    {
      ...
      paramArrayOfByte = ((arom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(Long.valueOf(l1), true);
      if ((paramArrayOfByte != null) && (1 == paramQQAppInterface.opt_uint32_auto_pull_flag.get()))
      {
        ...
        ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(67, true, new Object[] { String.valueOf(l1), paramQQAppInterface.opt_bytes_feeds_id.get().toStringUtf8(), Integer.valueOf(paramQQAppInterface.opt_uint32_auto_pull_flag.get()) });
        break label3174;
        if (!paramBoolean2)
        {
          if (paramakap != null) {
          ...
          {
            paramakap = (TroopTips0x857.MessageRecallReminder)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_recall.get();
            paramLong = paramakap.uint64_uin.get();
            paramInt = paramakap.uint32_op_type.get();
            paramQQAppInterface = new HashMap();
            try
            {
              paramArrayOfByte = new msgrevoke_userdef.MsgInfoUserDef();
              paramArrayOfByte.mergeFrom(paramakap.bytes_userdef.get().toByteArray());
            ...
            paramakap = ((ArrayList)paramakap.uint32_recalled_msg_list.get()).iterator();
            while (paramakap.hasNext())
            {
              localObject2 = (TroopTips0x857.MessageRecallReminder.MessageMeta)paramakap.next();
            ...
            {
              paramakap = (TroopTips0x857.NotifyObjmsgUpdate)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_objmsg_update.get();
              if (paramakap.bytes_ext_msg.has())
              {
                paramArrayOfByte = new SubMsgType0xaa.MsgBody();
                try
                {
                  paramArrayOfByte.mergeFrom(paramakap.bytes_ext_msg.get().toByteArray());
                  ((aqae)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
                }
                catch (Exception paramakap)
                {
                  for (;;)
                  {
                    if (QLog.isColorLevel()) {
                ...
                if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.has())
                {
                  ...
                  ((bbfc)paramQQAppInterface.a(107)).a((TroopTips0x857.WereWolfPush)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.get(), paramArrayOfByte);
                  break label3174;
                  if (QLog.isColorLevel()) {
                  ...
                  if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_stcm_game_state.has())
                  {
                    ...
                    {
                      ((aifc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a(0, 1, Long.toString(l1), paramQQAppInterface);
                      break label3174;
                      if (QLog.isColorLevel()) {
                      ...
                      if (((TroopTips0x857.NotifyMsgBody)localObject1).apllo_msg_push.has())
                      {
                        ...
                        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
                        {
                          ((aiga)paramQQAppInterface.getManager(227)).a(1, paramArrayOfByte);
                          break label3174;
                          if (QLog.isColorLevel()) {
                          ...
                          if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.has())
                          {
                            ...
                            {
                              agop.a(1, (TroopTips0x857.GoldMsgTipsElem)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.get(), null);
                              break label3174;
                              if (QLog.isColorLevel()) {
                              ...
                              if (paramBoolean1)
                              {
                                ...
                                {
                                  ((ajtg)paramQQAppInterface.a(20)).a(String.valueOf(l1), false, "", false, true, false, true);
                                  break label3174;
                                  if (QLog.isColorLevel()) {
                                  ...
                                  {
                                    axfs.a(paramQQAppInterface, (TroopTips0x857.TroopFormGrayTipsInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_troopformtips_push.get(), ((TroopTipsEntity)localObject2).troopUin);
                                    break label3174;
                                    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.has())
                                    {
                                      aqvt.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.MediaChangePushInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.get());
                                    }
                                    else
                                    {
                                      ...
                                      if (paramBoolean1)
                                      {
                                        try
                                        {
                                          paramakap = (TroopTips0x857.GeneralGrayTipInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_general_gray_tip.get();
                                          if (paramakap.uint64_busi_type.has())
                                          {
                                            l1 = paramakap.uint64_busi_type.get();
                                            if (!paramakap.uint64_busi_id.has()) {
                                              break label2821;
                                            }
                                            l2 = paramakap.uint64_busi_id.get();
                                            if (!paramakap.uint32_ctrl_flag.has()) {
                                              break label2827;
                                            }
                                            paramInt = paramakap.uint32_ctrl_flag.get();
                                            if (paramakap.uint32_c2c_type.has()) {
                                              paramakap.uint32_c2c_type.get();
                                            }
                                            if (paramakap.uint32_service_type.has()) {
                                              paramakap.uint32_service_type.get();
                                            }
                                            if (!paramakap.bytes_pb_reserv.has()) {
                                              break label2832;
                                            }
                                            paramArrayOfByte = paramakap.bytes_pb_reserv.get().toByteArray();
                                            if (!paramakap.bytes_content.has()) {
                                              break label2837;
                                            }
                                            paramakap = paramakap.bytes_content.get().toByteArray();
                                            localObject1 = "";
                                            if ((paramakap == null) || (paramakap.length <= 0)) {
                                              break label2843;
                                            }
                                            paramakap = new String(paramakap, "utf-8");
                                            paramInt = aqay.a(paramInt);
                                            paramakap = aqay.a(paramakap);
                                            paramArrayOfByte = aqay.a(paramQQAppInterface, ((TroopTipsEntity)localObject2).troopUin, 1, paramInt, paramLong, paramakap, l1, l2, paramArrayOfByte);
                                            if (paramArrayOfByte == null) {
                                              break label3174;
                                            }
                                            ...
                                            awqx.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", 3, 0, "" + l2, "" + l1, "", "");
                                            aqay.a(paramQQAppInterface, paramArrayOfByte);
                                          }
                                        }
                                      ...
                                      else
                                      {
                                        ...
                                        {
                                          paramArrayOfByte = ((axmt)paramQQAppInterface.getManager(339)).a(2);
                                          if (paramArrayOfByte != null) {
                                        ...
                                        else
                                        {
                                          ...
                                          {
                                            paramArrayOfByte = ((axmt)paramQQAppInterface.getManager(339)).a(4);
                                            if (paramArrayOfByte != null) {
                                          ...
                                          else
                                          {
                                            ...
                                            if ((paramQQAppInterface != null) && (paramQQAppInterface.uint32_group_honor_switch.has()))
                                            {
                                              ...
                                              paramQQAppInterface = (azcd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346);
                                              if (paramInt != 0) {
                                                break label3178;
                                              }
                                            }
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      ...
      break label3174;
      aqzq.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.NotifyMsgBody)localObject1);
      break label3174;
      paramLong = 0L;
      break label1157;
      break;
  ...
  public List<TroopTipsEntity> a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = ((atmp)localObject).a(TroopTipsEntity.class, true, "troopUin=? and read=? and currentUin=?", new String[] { paramString, "0", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }, null, null, "time ASC", null);
      ((atmp)localObject).a();
  ...
  public void a(azlg paramazlg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopTipsMsgMgr", 2, "addWalletTipsCache");
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(paramazlg);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      azlg localazlg = (azlg)localIterator.next();
      TroopTips0x857.RedGrayTipsInfo localRedGrayTipsInfo = localazlg.jdField_a_of_type_TencentImOidbCmd0x857TroopTips0x857$RedGrayTipsInfo;
      String str = paramQQAppInterface.getCurrentAccountUin();
      MessageForQQWalletTips localMessageForQQWalletTips = (MessageForQQWalletTips)awbi.a(-2029);
      ...
      localMessageForQQWalletTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localazlg.jdField_a_of_type_JavaLangString, "", "[QQWallet Tips]", awao.a(), -2029, 1, awao.a());
  ...
  public void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    localatmp.a(paramTroopTipsEntity);
    localatmp.a();
  }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    atmp localatmp = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    Cursor localCursor = localatmp.a(true, TroopTipsEntity.class.getSimpleName(), new String[] { "troopUin" }, "read=?", new String[] { String.valueOf(0) }, "troopUin", null, null, null);
    if (localCursor != null) {}
    for (;;)
    {
      try
