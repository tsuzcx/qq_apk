  ...
  implements baxz
{
  ...
  public azlf(NewTroopContactView paramNewTroopContactView, Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.c != null) && (this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.c.size() > 0))
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.a(str))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.jdField_a_of_type_Azkm.notifyDataSetChanged();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localTextView = (TextView)paramViewGroup.findViewById(2131378215);
      if (localResultRecord.jdField_a_of_type_Int != 5) {
        break label179;
      }
      localImageView.setImageResource(2130841580);
      localTextView.setVisibility(0);
      localTextView.setText(bbcz.a(localResultRecord.b));
      if (AppSetting.d) {
    ...
    paramView = this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.jdField_a_of_type_Baxy.a(paramInt, str);
    if (paramView == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopContactView.jdField_a_of_type_Baxy.a(str, paramInt, true);
