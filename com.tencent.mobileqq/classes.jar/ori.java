  ...
  implements Runnable
{
  ...
  public ori(StoryMultiFragmentPart paramStoryMultiFragmentPart, @NonNull Bitmap paramBitmap1, @NonNull Bitmap paramBitmap2, Context paramContext)
  {
  ...
  private void a()
  {
    ...
    localValueAnimator.addUpdateListener(new orj(this, k, i, m, j, n, i1));
    localValueAnimator.addListener(new ork(this));
