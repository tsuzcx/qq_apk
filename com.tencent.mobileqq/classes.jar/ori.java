  ...
  extends pvq
{
  ...
  private void d(List<Long> paramList)
  {
    ...
    for (int i = 5;; i = paramList.size())
    {
      ...
      while (j < i)
      {
        ...
        ArticleInfo localArticleInfo = pvj.a().a(orh.a(this.a), l);
        if ((localArticleInfo != null) && (!pqw.a(localArticleInfo))) {
          ((ArrayList)localObject).add((ArticleInfo)localArticleInfo);
        }
        j += 1;
      }
    }
    pvj.a().a().a((List)localObject);
  }
  
  public void a(int paramInt, List<Long> paramList)
  {
    if (paramInt != orh.a(this.a)) {
      return;
    }
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      orh.a(this.a, pvj.a().a(Integer.valueOf(orh.a(this.a)), paramList), 1);
      Object localObject1 = (Long)paramList.get(0);
      Object localObject2 = pvj.a().a(orh.a(this.a), ((Long)localObject1).longValue());
      ...
      for (localObject1 = Long.valueOf(((ArticleInfo)localObject2).mArticleID);; localObject1 = "-1")
      {
        ...
        QLog.d("ReadInJoyChannelWaterFallViewController_" + orh.a(this.a), 1, (String)localObject1);
      ...
      QLog.d("ReadInJoyChannelWaterFallViewController_" + orh.a(this.a), 1, ((StringBuilder)localObject1).toString());
    }
    label326:
  ...
  public void a(int paramInt, boolean paramBoolean, List<ChannelCoverInfo> paramList)
  {
    ...
    if ((paramInt == orh.a(this.a)) && (paramBoolean) && (paramList != null) && (!paramList.isEmpty())) {
    ...
    for (;;)
    {
      ...
      if ((paramList != null) && (paramList.size() >= 5))
      {
        ...
        while (i < 5)
        {
          ...
          Object localObject = pvj.a().a(orh.a(this.a), l);
          if ((localObject != null) && (!pqw.a(((BaseArticleInfo)localObject).mArticleContentUrl, ((BaseArticleInfo)localObject).mChannelID, (ArticleInfo)localObject)) && (!pqw.a((BaseArticleInfo)localObject)) && (!pvj.a().a(((BaseArticleInfo)localObject).mArticleID)))
          {
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1) {
      if ((paramList != null) && (paramInt > 0) && (paramList.size() > 0))
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("ReadInJoyChannelWaterFallViewController_" + orh.a(this.a), 1, ((StringBuilder)localObject).toString());
        }
        orh.a(this.a, pvj.a().a(Integer.valueOf(orh.a(this.a)), paramList), 1);
        localObject = String.format(this.a.a().getResources().getString(2131717599), new Object[] { Integer.valueOf(paramInt) });
    ...
    for (;;)
    {
      ...
      {
        this.a.a.b(true);
        c(this.a.a().getResources().getString(2131717844));
      }
      else
      {
        localObject = this.a.a().getResources().getString(2131717598);
        this.a.a.a(true, (String)localObject);
        continue;
        if (this.a.a.a()) {
          c(this.a.a().getResources().getString(2131717803));
        }
  ...
  {
    if ((paramInt != orh.a(this.a)) || (paramList == null)) {
      return;
    }
    paramList = pvj.a().a(Integer.valueOf(orh.a(this.a)), paramList);
  ...
  public void b(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean1) && (paramList != null)) {
      orh.a(this.a, pvj.a().a(Integer.valueOf(orh.a(this.a)), paramList), 2);
    }
    pzb localpzb;
    if ((paramBoolean1) && (paramList == null))
    {
    ...
    for (;;)
    {
      localpzb.a(paramBoolean1, bool);
      if ((paramList != null) && (!paramList.isEmpty())) {
        orh.a(this.a, NetConnInfoCenter.getServerTime());
      }
      if (QLog.isColorLevel()) {
        QLog.d("ReadInJoyChannelWaterFallViewController", 2, "autoLoad:" + orh.b(this.a) + " noMoreData:" + paramBoolean2 + " fore:" + GesturePWDUtils.isAppOnForeground(this.a.a()));
      }
      if ((!orh.b(this.a)) && (paramBoolean2) && (GesturePWDUtils.isAppOnForeground(this.a.a())) && (orh.a(this.a) != 70))
      {
        paramList = this.a.a().getResources().getString(2131717598);
    ...
    do
    {
      ...
      if (paramList.size() > 0)
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("ReadInJoyChannelWaterFallViewController_" + orh.a(this.a), 1, localStringBuilder.toString());
        }
        orh.a(this.a, pvj.a().a(Integer.valueOf(orh.a(this.a)), paramList), 1);
        return;
      }
