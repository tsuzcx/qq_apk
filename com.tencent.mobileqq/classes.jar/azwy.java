...
public class azwy
  implements Handler.Callback, aptf, Manager
{
  public static final String a;
  private float jdField_a_of_type_Float = 7.0F;
  public int a;
  amsu jdField_a_of_type_Amsu = new azwz(this);
  private andd jdField_a_of_type_Andd = new azxa(this);
  private bjmp jdField_a_of_type_Bjmp = new bjmp(ThreadManager.getFileThreadLooper(), this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<azxc> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private WeakReference<azwx> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = amtj.a(2131704822);
  }
  
  public azwy(QQAppInterface paramQQAppInterface)
  {
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = bfyz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), "breaking_ice_config");
    }
    bool6 = bool7;
    i1 = i2;
    n = i3;
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).o(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((amsw)localObject1).b(str2))) {
          break label318;
        }
        i += 1;
      }
  ...
  {
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramazwx);
  }
  
  public void a(azxc paramazxc)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramazxc);
  }
  
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString, apte paramapte)
  {
    if ((paramapte != null) && ("breaking_ice_config".equals(paramString)))
    {
      if (!this.jdField_b_of_type_Boolean) {
        g();
      }
      paramQQAppInterface = a(true, paramapte.jdField_a_of_type_JavaLangString);
      ...
      if ((bool1 != this.jdField_c_of_type_Boolean) || (bool2 != this.jdField_d_of_type_Boolean))
      {
        ...
        if (a(this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean, paramQQAppInterface))
        {
          ...
          if (this.jdField_a_of_type_Bjmp.hasMessages(1)) {
            this.jdField_a_of_type_Bjmp.removeMessages(1);
          }
          this.jdField_a_of_type_Bjmp.sendEmptyMessage(1);
        }
      }
      if (QLog.isColorLevel())
      {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ((amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ahnz.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      Object localObject = ((amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
      boolean bool;
      int i;
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (azxc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
            ((azxc)localObject).a(paramString, false);
          }
        }
        if (this.jdField_a_of_type_Bjmp.hasMessages(1)) {
          this.jdField_a_of_type_Bjmp.removeMessages(1);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("IceBreak.HotPic", 2, bjna.a(paramArrayOfByte));
        return;
        ...
        while (i < paramArrayOfByte.size())
        {
          ...
          localahnm.a(localImgInfo.bytes_img_word.get().toStringUtf8());
          ...
          ((List)localObject).add(localahnm);
          i += 1;
        }
  ...
  public void b(azxc paramazxc)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == paramazxc)) {
  ...
  public boolean e(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        azxc localazxc = (azxc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localazxc != null) {
          localazxc.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_Bjmp.hasMessages(1)) {
        this.jdField_a_of_type_Bjmp.removeMessages(1);
  ...
  public boolean f(String paramString)
  {
    ...
    if (bool2)
    {
      paramString = ((amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
  ...
  public void j(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (((arhi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264)).e()) {
            break;
          }
      ...
      localazxc = (azxc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localazxc == null);
    localazxc.a(paramString, false);
  }
  ...
  {
    if (!ahns.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
