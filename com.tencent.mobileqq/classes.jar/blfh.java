...
public class blfh
{
  public static void a(Activity paramActivity)
  {
    ...
    {
      blfg.d("PicChooseJumpUtil", "activity is null.");
      return;
    }
    ...
    localIntent.putExtra("VIDEO_STORY_JUMP_TO_TYPE", bkwm.b(paramActivity.getIntent()));
    localIntent.putExtra("VIDEO_STORY_FROM_TYPE", bkwm.a(paramActivity.getIntent()));
  ...
  {
    blfg.b("PicChooseJumpUtil", "[jumpForAECircle] Start");
    blfg.a("PicChooseJumpUtil", "[AE Profiler] jumpForAECircle Start");
