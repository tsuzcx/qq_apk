...
public class bixr
{
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, biyc parambiyc, int paramInt)
  {
    paramActivity = new FreeWifiHelper.5(paramActivity, paramString1, paramString2, paramString3, paramString4, new bixv(paramInt, paramActivity, parambiyc), new bixw(parambiyc, paramInt), new bixx(parambiyc, paramInt), paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = biyh.a(localBaseApplication, str);
        if (QLog.isColorLevel()) {
      ...
      return;
      long l = biyh.c(localBaseApplication, str);
    ...
    Object localObject = new aoha(paramQQAppInterface);
    aohb localaohb = new aohb(paramQQAppInterface);
    localaohb.a(new bixt(paramQQAppInterface, localaohb));
    paramQQAppInterface.addObserver(localaohb);
    ((aoha)localObject).a(2);
    biyh.c(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bhhr.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str);
    if (QLog.isColorLevel()) {
    ...
    if (i != j)
    {
      bhhr.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str, i);
      paramConfig = arph.b(paramConfig, j, paramInt);
      if (!TextUtils.isEmpty(paramConfig))
      {
        ...
        try
        {
          ...
          {
            e = bool;
            bhhr.a(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentUin(), c, d, e);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      if (((d) || (e)) && (Conversation.b > 0L))
      {
        ...
        long l2 = biyh.a((Context)localObject, str);
        long l3 = biyh.b((Context)localObject, str) * 60 * 60 * 1000L;
        if (QLog.isColorLevel()) {
        ...
        biyh.a((Context)localObject, str, l1);
        aoha localaoha = new aoha(paramQQAppInterface);
        aohb localaohb = new aohb(paramQQAppInterface);
        localaohb.a(new bixs((Context)localObject, str, paramQQAppInterface, localaohb));
        paramQQAppInterface.addObserver(localaohb);
        localaoha.a(1);
      }
    }
  ...
  public static boolean a(Activity paramActivity, int paramInt, biyc parambiyc)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        str1 = paramActivity.getString(2131692524);
        str2 = paramActivity.getString(2131692527);
        i = 1;
      }
      while (i != 0)
      {
        String str5 = paramActivity.getString(2131692530);
        String str4 = biyh.a(paramActivity);
        String str3 = str4;
        if (TextUtils.isEmpty(str4)) {
          str3 = paramActivity.getString(2131692523);
        }
        QLog.i("WifiSdk", 2, "shouldOverrideDialog btn1Text: " + str3);
        a(paramActivity, str5, str1, str3, str2, parambiyc, paramInt);
        return false;
        if ((paramInt == 2) || (paramInt == 4))
        {
          str1 = paramActivity.getString(2131692526);
          str2 = paramActivity.getString(2131692529);
          i = 1;
        }
        else if (paramInt == 3)
        {
          str1 = paramActivity.getString(2131692525);
          str2 = paramActivity.getString(2131692528);
          i = 1;
        }
        else if (paramInt == 5)
        {
          str1 = paramActivity.getString(2131692479);
          str2 = paramActivity.getString(2131692529);
          i = 1;
        }
        else
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (!TMSDKWifiManager.init(paramContext.getApplicationContext(), new TMSDKCustomConfig().setCustomToast(new biyb()).setCustomInstaller(new biya()).setCustomThreadPool(new bixz()).setCustomReporter(new bixy()))) {
        bool = true;
      }
      b = bool;
      WifiSDKUIApi.init(new biye(), new biyf());
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      str = paramQQAppInterface.getCurrentAccountUin();
      localBaseApplication = paramQQAppInterface.getApp();
      long l = biyh.b(localBaseApplication, str);
      if ((l == -1L) || (System.currentTimeMillis() - l >= 86400000L)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    aoha localaoha = new aoha(paramQQAppInterface);
    aohb localaohb = new aohb(paramQQAppInterface);
    localaohb.a(new bixu(paramQQAppInterface, localaohb));
    paramQQAppInterface.addObserver(localaohb);
    localaoha.a(3);
    biyh.b(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void c(Context paramContext, int paramInt)
  {
    ...
    biyg localbiyg = biyg.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    if (QLog.isColorLevel()) {
      QLog.i("WifiSdk", 2, "dialog click, jumpType: " + localbiyg.jdField_a_of_type_Int + " jumpUrl: " + localbiyg.jdField_a_of_type_JavaLangString);
    }
    if (WifiSDKUIApi.isWiFiManagerExist())
    {
      if (localbiyg.jdField_a_of_type_Int == 4)
      {
    ...
    switch (localbiyg.jdField_a_of_type_Int)
    {
    case 4: 
    default: 
      a(paramContext, paramInt);
      ...
      return;
    case 1: 
      a(paramContext, localbiyg.jdField_a_of_type_JavaLangString);
