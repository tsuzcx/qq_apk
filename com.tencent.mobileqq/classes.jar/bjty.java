...
public class bjty
{
  ...
  public static String a(java.io.File paramFile)
  {
    ...
    //   50: astore_1
    //   51: aload_0
    //   52: invokestatic 60	bjty:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   55: astore_2
    //   56: aload_2
    //   57: astore_1
    //   58: aload_0
  ...
  public static byte[] a(String paramString)
  {
    ...
    catch (Exception paramString)
    {
      ...
      catch (UnsupportedEncodingException paramString)
      {
        ...
        bjtx.e("andygzyu-MD5", "toMD5Byte, source.getBytes crash!");
      }
      paramString = paramString;
      paramString.printStackTrace();
      bjtx.e("andygzyu-MD5", "toMD5Byte, MessageDigest.getInstance crash!");
      return null;
    }
