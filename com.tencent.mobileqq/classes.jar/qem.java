...
public class qem
  extends Handler
{
  public qem(VideoFeedsPlayManager paramVideoFeedsPlayManager, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void dispatchMessage(Message paramMessage)
  {
    ...
    {
      return;
      if (!(paramMessage.obj instanceof qeq)) {
        break;
      }
    } while (!VideoFeedsPlayManager.a(this.a, (qeq)paramMessage.obj));
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case -3: 
      ...
      if ((VideoFeedsPlayManager.a(this.a, VideoFeedsPlayManager.b(this.a)) != null) && (VideoFeedsPlayManager.a(this.a, VideoFeedsPlayManager.b(this.a)).d()) && (VideoFeedsPlayManager.a(this.a, VideoFeedsPlayManager.b(this.a)).a() == VideoFeedsPlayManager.b(this.a).jdField_a_of_type_ComTencentBizPubaccountVideoInfo))
      {
    ...
    qeq localqeq = VideoFeedsPlayManager.b(this.a);
    long l1;
    boolean bool;
    if ((paramMessage != null) && (paramMessage.b()) && ((localqeq.jdField_a_of_type_Pxw == null) || (!localqeq.jdField_a_of_type_Pxw.a(localqeq))) && (!paramMessage.g()))
    {
      l1 = paramMessage.a();
      long l2 = paramMessage.b();
      if (localqeq.jdField_a_of_type_Pxw != null) {
        localqeq.jdField_a_of_type_Pxw.a(localqeq, l1, l2);
      }
      if (l1 < l2 - 300L) {
        break label495;
      }
      ...
      if ((!VideoFeedsPlayManager.f(this.a)) && (VideoFeedsPlayManager.a(this.a) != null))
      {
        ...
        if ((localqeq.jdField_a_of_type_Pxw != null) && (!VideoFeedsPlayManager.g(this.a)))
        {
          if ((!VideoFeedsPlayManager.h(this.a)) && (!VideoFeedsPlayManager.i(this.a))) {
            break label489;
          }
          bool = true;
          localqeq.jdField_a_of_type_Pxw.a(VideoFeedsPlayManager.b(this.a), i, bool);
        }
      }
    }
    for (;;)
    {
      ...
      if ((l1 <= 500L) && (l1 >= 0L) && (VideoFeedsPlayManager.j(this.a)))
      {
        ...
        paramMessage.o();
        if ((VideoFeedsPlayManager.b(this.a).jdField_a_of_type_ComTencentBizPubaccountVideoInfo.c) && (npi.a(VideoFeedsPlayManager.b(this.a).jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a)))
        {
        ...
        else if (VideoFeedsPlayManager.a(this.a) != null)
        {
          ...
          while (paramMessage.hasNext()) {
            ((qes)paramMessage.next()).a(VideoFeedsPlayManager.b(this.a), VideoFeedsPlayManager.b(this.a));
          }
        }
      }
    }
