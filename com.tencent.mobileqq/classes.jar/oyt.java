  ...
  extends QIPCModule
{
  ...
  private oyt(String paramString)
  {
    super(paramString);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    if (oxw.a(localBaseActivity, paramBundle))
    {
      QLog.i("ReadInJoyIPCModule", 1, "[jumpToNativeChannel], jump to recommend channel, using floating window.");
      return;
    }
    if (bool) {}
    for (paramBundle = "1"; oxt.a(paramBundle, i); paramBundle = "0")
    {
      nuq.a(localBaseActivity, i, str, k, 4);
      return;
    }
    paramBundle = nuq.b(localBaseActivity, 0, i);
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if (oxt.a(Uri.parse(str).getQueryParameter("ispush"), paramInt)) {
      try
      {
        if (str.contains("v_url_base64")) {}
        for (paramString = bbeg.a(Uri.parse(str).getQueryParameter("v_url_base64"));; paramString = URLDecoder.decode(Uri.parse(str).getQueryParameter("v_url"), "utf-8"))
        {
          rvx.a(BaseActivity.sTopActivity, null, paramString, null);
          return null;
        }
      }
