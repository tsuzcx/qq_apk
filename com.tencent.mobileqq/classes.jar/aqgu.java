  ...
  extends LoadingLayoutBase
{
  ...
  public aqgu(Context paramContext, PullToRefreshBase.Mode paramMode, PullToRefreshBase.Orientation paramOrientation, TypedArray paramTypedArray)
  {
    super(paramContext);
    ...
    int i;
    switch (aqgv.a[paramOrientation.ordinal()])
    {
    default: 
      LayoutInflater.from(paramContext).inflate(2131559458, this);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131366438));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131372507));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131372505));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131372506));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131372502));
      localLayoutParams = (FrameLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetFrameLayout.getLayoutParams();
      switch (aqgv.b[paramMode.ordinal()])
      {
      default: 
        if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL)
        {
          ...
          this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131695789);
          this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131695790);
          this.c = paramContext.getString(2131695791);
          if (paramTypedArray.hasValue(7))
          {
            paramOrientation = paramTypedArray.getDrawable(7);
            if (paramOrientation != null) {
              aqgw.a(this, paramOrientation);
            }
          }
    ...
    for (;;)
    {
      ...
      g();
      return;
      LayoutInflater.from(paramContext).inflate(2131559457, this);
      break;
      if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL) {}
      for (i = 48;; i = 3)
      {
        localLayoutParams.gravity = i;
        this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131695786);
        this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131695787);
        this.c = paramContext.getString(2131695788);
        break;
      }
      i = 5;
      break label179;
  ...
  public final int a()
  {
    switch (aqgv.a[this.jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$Orientation.ordinal()])
    {
    default: 
