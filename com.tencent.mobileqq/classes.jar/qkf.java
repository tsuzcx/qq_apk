  ...
  implements Cloneable
{
  ...
  public static qkf a(articlesummary.ArkAppFeedsInfo paramArkAppFeedsInfo)
  {
    ...
    if (paramArkAppFeedsInfo.uint64_feeds_id.has())
    {
      ...
      label103:
      localqkf.jdField_a_of_type_JavaLangString = str;
    ...
    {
      localqkf.f = paramArkAppFeedsInfo;
      if (QLog.isColorLevel()) {
        QLog.d("ArkAppFeedsInfo", 2, new Object[] { "mFeedsId: ", Long.valueOf(localqkf.jdField_a_of_type_Long), ", mFeedsStyle: ", Integer.valueOf(localqkf.jdField_a_of_type_Int), ", appName: ", localqkf.jdField_a_of_type_JavaLangString, ", appView: ", localqkf.b, ", appMinVersion: ", localqkf.e, ", metaList: ", localqkf.f });
      }
      return localqkf;
      l = 0L;
      break;
