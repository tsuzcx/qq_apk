...
public class amts
{
  ...
  private static NativeMonitorConfig a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramSharedPreferences)) {
      try
      {
        ...
        return (NativeMonitorConfig)aqrg.a(paramSharedPreferences, NativeMonitorConfig.class);
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int i = baig.aE(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int k = baig.aF(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (k != m)
    {
      baig.X(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), m);
      i = 0;
    }
    String str;
    if (j != i)
    {
      str = amnh.b(paramConfig, i, paramInt);
    ...
    for (;;)
    {
      try
      {
        ...
        paramConfig = (NativeMonitorConfig)aqrg.a(paramConfig, NativeMonitorConfig.class);
        if (paramConfig == null)
        {
          a(new NativeMonitorConfig());
          baig.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
          baig.t(paramQQAppInterface.getApp(), 0);
      ...
      catch (JSONException paramConfig)
      {
        ...
        a(paramConfig);
        baig.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, str);
        baig.t(paramQQAppInterface.getApp(), paramConfig.soHook);
        continue;
      }
      a(new NativeMonitorConfig());
      baig.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (localNativeMonitorConfig != null)
      {
        ...
        ajtc.a(jdField_a_of_type_ComTencentMobileqqDataNativemonitorNativeMonitorConfig.getTmChance());
      }
  ...
  public static void b()
  {
    ...
    //   51: new 432	amtt
    //   54: dup
    //   55: invokespecial 433	amtt:<init>	()V
