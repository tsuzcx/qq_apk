...
public final class amts
  implements amuc, Handler.Callback, INetInfoHandler
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private amtt jdField_a_of_type_Amtt;
  ...
  {
    if (this.jdField_a_of_type_Amtt == null)
    {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.4.10");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Amtt.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Amtt.b);
    ...
    try
    {
      paramString = amwn.a(paramString, this.jdField_a_of_type_Amtt.jdField_a_of_type_JavaLangString);
  ...
  {
    ((amme)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Amtt.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Amtt.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    amue localamue = new amue();
    localamue.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Amtt.jdField_a_of_type_JavaUtilList;
    localamue.jdField_a_of_type_Int = this.jdField_a_of_type_Amtt.jdField_a_of_type_Int;
    localamue.b = 10000;
    localamue.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localamue);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localamue);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        {
          ((VasExtensionHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.VAS_EXTENSION_HANDLER)).e();
        }
      }
      finally {}
    }
  ...
  public void a(amtt paramamtt)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Amtt = paramamtt;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Bkys.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Bkys.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = amwn.b((byte[])localObject, this.jdField_a_of_type_Amtt.jdField_a_of_type_JavaLangString);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_a_of_type_Bkys.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Amtt });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Amtt != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Bkys.removeMessages(1);
        this.jdField_a_of_type_Bkys.removeMessages(2);
        this.jdField_a_of_type_Bkys.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 5: 
      ...
      if ((paramMessage.obj != null) && (((Boolean)paramMessage.obj).booleanValue()))
      {
        ...
        this.jdField_a_of_type_Amtt = null;
      }
      i();
      return false;
    case 7: 
