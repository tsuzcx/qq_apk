  ...
  implements amxf
{
  ...
  private void a(amqs paramamqs, int paramInt, long paramLong)
  {
    ApolloCmdChannel localApolloCmdChannel = amwn.a();
    if (localApolloCmdChannel != null) {
      localApolloCmdChannel.playMusicInner(paramamqs, paramInt, paramLong);
    }
  }
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!amwn.d()) || (paramamqs == null)))
    {
    ...
    for (Object localObject = null;; localObject = null)
    {
      try
      {
        if ((paramamqs instanceof ApolloSurfaceView)) {
          localObject = ((ApolloSurfaceView)paramamqs).getRender();
        }
        for (;;)
        {
          if (localObject == null) {
          ...
          if ((paramamqs instanceof ApolloTextureView)) {
            localObject = ((ApolloTextureView)paramamqs).getRender();
          }
        }
      ...
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramamqs, new Object[0]);
        return -1;
      }
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new amxe(this, paramFloat, paramInt2, paramString, paramamqs, paramLong));
        ...
        if (paramString != null) {
          if (-1.0F == paramFloat)
          {
            ...
            if (paramInt1 != 0) {
              a(paramamqs, paramInt1, paramLong);
            }
          }
        }
        for (;;)
      ...
      paramamqs = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!amwn.d())))
    {
      QLog.w("cmgame_process.CmGameSoudPoolPlayer", 1, "[playMusic], DO NOT play. switch:" + this.jdField_a_of_type_Int);
    ...
    if (paramJSONObject != null) {
      ...
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramamxv, new Object[0]);
      }
    } else {
      return null;
    }
    ...
    {
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new amxd(this, f, i, str2, paramamxv, localJSONObject));
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        if ((i == 0) || (paramamxv == null)) {
          break;
        }
        try
        {
          localJSONObject.put("id", i);
          paramamxv.a(localJSONObject);
        }
        catch (Throwable paramamxv)
        {
          QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramamxv, new Object[0]);
      ...
      break;
      paramamxv = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
      for (boolean bool = true;; bool = false)
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, bool);
