...
public class bpib
{
  private static bpib jdField_a_of_type_Bpib;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bpic(this));
  private bpid jdField_a_of_type_Bpid = new bpid(this, null);
  private bpif jdField_a_of_type_Bpif;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private bpib(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Bpid);
    }
  }
  
  public static bpib a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Bpib == null) {
      jdField_a_of_type_Bpib = new bpib(paramAppInterface);
    }
    return jdField_a_of_type_Bpib;
  }
  ...
  private void a(double paramDouble1, double paramDouble2, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), boqq.class);
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bpif != null)
    {
      ...
      this.jdField_a_of_type_Bpif.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.startLocation(new bpie(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Bpif != null) {
          this.jdField_a_of_type_Bpif.a(paramInt, bool2);
        }
        return;
      }
  ...
  public void a(bpif parambpif)
  {
    this.jdField_a_of_type_Bpif = parambpif;
  }
}
