...
public class bqlh
{
  ...
  public static bqmd a(RectF paramRectF1, RectF paramRectF2)
  {
    bqmd localbqmd = new bqmd(0.0F, 0.0F, 1.0F, 0.0F);
    if (paramRectF1.equals(paramRectF2)) {
      return localbqmd;
    }
    localbqmd.c = Math.max(paramRectF1.width() / paramRectF2.width(), paramRectF1.height() / paramRectF2.height());
    RectF localRectF = new RectF();
    a.setScale(localbqmd.c, localbqmd.c, paramRectF2.centerX(), paramRectF2.centerY());
    a.mapRect(localRectF, paramRectF2);
    localbqmd.a += paramRectF1.centerX() - localRectF.centerX();
    float f = localbqmd.b;
    localbqmd.b = (paramRectF1.centerY() - localRectF.centerY() + f);
    return localbqmd;
  }
  
  public static bqmd a(RectF paramRectF1, RectF paramRectF2, float paramFloat1, float paramFloat2)
  {
    bqmd localbqmd = new bqmd(0.0F, 0.0F, 1.0F, 0.0F);
    ...
    do
    {
      ...
      if ((paramRectF2.width() < paramRectF1.width()) && (paramRectF2.height() < paramRectF1.height())) {
        localbqmd.c = Math.min(paramRectF1.width() / paramRectF2.width(), paramRectF1.height() / paramRectF2.height());
      }
      localRectF = new RectF();
      a.setScale(localbqmd.c, localbqmd.c, paramFloat1, paramFloat2);
      a.mapRect(localRectF, paramRectF2);
      ...
      {
        paramFloat1 = localbqmd.b;
        localbqmd.b = (paramRectF1.centerY() - localRectF.centerY() + paramFloat1);
        return localbqmd;
        if (localRectF.left > paramRectF1.left) {
          localbqmd.a += paramRectF1.left - localRectF.left;
        } else if (localRectF.right < paramRectF1.right) {
          localbqmd.a += paramRectF1.right - localRectF.right;
        }
      }
      if (localRectF.top > paramRectF1.top)
      {
        paramFloat1 = localbqmd.b;
        localbqmd.b = (paramRectF1.top - localRectF.top + paramFloat1);
        return localbqmd;
      }
    } while (localRectF.bottom >= paramRectF1.bottom);
    paramFloat1 = localbqmd.b;
    localbqmd.b = (paramRectF1.bottom - localRectF.bottom + paramFloat1);
    return localbqmd;
  }
  ...
  public static bqmd b(RectF paramRectF1, RectF paramRectF2, float paramFloat1, float paramFloat2)
  {
    bqmd localbqmd = new bqmd(0.0F, 0.0F, 1.0F, 0.0F);
    if (paramRectF2.contains(paramRectF1)) {}
    RectF localRectF;
