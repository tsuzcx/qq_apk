  ...
  implements Manager
{
  ...
  public awxj(QQAppInterface paramQQAppInterface)
  {
  ...
  public static Bitmap a(String paramString)
  {
    ...
    localObject = new bhyo(paramString, (File)localObject);
    ((bhyo)localObject).n = true;
    ((bhyo)localObject).b = 2;
    ((bhyo)localObject).a = str;
    ((bhyo)localObject).b(512);
    int i = bhyq.a((bhyo)localObject, null, null);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
      QLog.i("NewMsgNotificationManager", 2, "download cost " + (l2 - l1) + " result " + i + " key " + ((bhyo)localObject).a + " iconUrl: " + paramString);
    }
    return SafeBitmapFactory.decodeFile(str);
  }
  
  public static awxj a(QQAppInterface paramQQAppInterface)
  {
    return (awxj)paramQQAppInterface.getManager(QQManagerFactory.NEW_MSG_NOTIFICATION_MANAGER);
  }
  ...
  {
    Intent localIntent = bhfb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
  ...
  {
    this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new awxk(this, paramNotifyPushSettingActivity, paramFormSwitchItem1, paramFormSwitchItem2);
  ...
  {
    awxm localawxm = new awxm(this);
    awxn localawxn = new awxn(this, paramBaseActivity);
    bhdj.a(paramBaseActivity, 230, null, paramBaseActivity.getString(2131693415), paramBaseActivity.getString(2131690697), paramBaseActivity.getString(2131693414), localawxn, localawxm).show();
  }
  ...
  public void a(BaseActivity paramBaseActivity, TextView paramTextView)
  {
    ...
    String str = ((Resources)localObject).getString(2131694750);
    localObject = new SpannableString(str + "允许QQ通知" + ((Resources)localObject).getString(2131694751));
    ((SpannableString)localObject).setSpan(new awxl(this, paramBaseActivity), str.length(), (str + "允许QQ通知").length(), 17);
