...
public class ajjf
{
  private SparseArray<aiuk> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private VasWebviewJsPlugin jdField_a_of_type_ComTencentMobileqqVaswebviewpluginVasWebviewJsPlugin;
  
  public ajjf(VasWebviewJsPlugin paramVasWebviewJsPlugin)
  {
  ...
  private void a(int[] paramArrayOfInt, String paramString, JSONArray paramJSONArray)
  {
    ...
    if (paramArrayOfInt != null)
    {
      ...
      {
        aiuc localaiuc = aiub.a().a(8, paramArrayOfInt[i]);
        if (localaiuc == null) {
          j = 1;
        }
        for (;;)
      ...
      if (j != 0)
      {
        ...
        paramArrayOfInt = new ajjk(this, i, paramArrayOfInt, localArrayList, localAppInterface, paramJSONArray, paramString);
        this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramArrayOfInt);
        aiug.a().a(i, paramArrayOfInt);
        aiug.a().a(localAppInterface, i, true);
      }
    }
    else
    {
    ...
    if (localArrayList.isEmpty())
    {
      ...
      a(paramString, ajyc.a(2131700488), paramJSONArray);
      return;
    }
    aiud.a(localAppInterface, "", new ajjm(this, paramArrayOfInt, paramJSONArray, paramString), localArrayList, false, null);
  }
  ...
  private byte[] a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        byte[] arrayOfByte = bbdj.a(((File)localObject3).getAbsolutePath());
        if (arrayOfByte != null)
        {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Uri)localObject7).isHierarchical())
        {
          ...
          {
            localObject3 = bdhv.d(URLDecoder.decode((String)localObject8));
            localObject3 = new File(ajmu.j + (String)localObject3 + File.separator + (String)localObject3 + ".zip");
            ...
            if (localObject6 != null)
            {
              ...
              if (((JSONArray)localObject6).length() > 0)
              {
                ...
                if (k < i1)
                {
                  ...
                  localObject4 = aiub.a().a(8, localObject2[k]);
                  if ((localObject4 == null) || (!((aiuc)localObject4).a())) {
                    break label1319;
                  }
                  m = 1;
          ...
          if (i3 != 0)
          {
            ...
            localObject3 = a(i, 1, ajmu.g + i + File.separator, false);
            if (localObject3 == null) {
              break label1325;
            }
            ((ByteArrayOutputStream)localObject2).write((byte[])localObject3);
            ...
            localObject3 = a(k, 2, ajmu.f + k + File.separator, false);
            if (localObject3 == null) {
              break label1335;
            }
            ((ByteArrayOutputStream)localObject2).write((byte[])localObject3);
            ...
            {
              localObject1 = (aiuc)((List)localObject7).get(i);
              localObject1 = a(((aiuc)localObject1).b, 8, ajmu.h + ((aiuc)localObject1).b + File.separator, false);
          ...
          if ((i > 0) || ((localObject1 != null) && (localObject1.length > 0))) {
            ajhw.b(localAppInterface, "", new ajjg(this, (JSONArray)localObject2, (File)localObject3, localAppInterface, (String)localObject8, (int[])localObject4, str1), i, (int[])localObject1, -1, -1, false);
          }
        }
        else
        {
          localObject1 = new WebResourceResponse("application/octet-stream", "utf-8", new ajki(null, null, null));
          a((WebResourceResponse)localObject1);
          return localObject1;
        }
      }
      catch (Exception localException)
      {
        ...
        localWebResourceResponse = new WebResourceResponse("application/octet-stream", "utf-8", new ajki(null, null, null));
        a(localWebResourceResponse);
        QLog.e("ApolloPluginRscLoader", 1, "getCombination url 解析失败:" + paramString);
        a(d(paramString), -1, ajyc.a(2131700498));
        return localWebResourceResponse;
      }
      if ((localObject3 != null) && (!((File)localObject3).exists()))
      {
        ajhw.a(localAppInterface, (String)localObject8, new ajjj(this, (String)localObject8, (File)localObject3, (JSONArray)localObject2, (int[])localObject4, str1));
      }
      else
      {
        if (!TextUtils.isEmpty((CharSequence)localObject8)) {
        ...
        {
          a(str1, ajyc.a(2131700484), (JSONArray)localObject2);
        }
        else
        {
  ...
  public WebResourceResponse a(String paramString)
  {
    ...
    do
    {
      ...
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Room/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Room/")))
      {
        ...
        localObject2 = ajmu.h + i + File.separator + (String)localObject1;
        ...
        localObject2 = aiub.a().a(8, i);
        if (localObject2 == null)
        {
          QLog.i("ApolloPluginRscLoader", 1, "idolRscItem == null ");
          int j = ((File)localObject1).hashCode();
          aiug.a().a(localAppInterface, j, true);
          aiug.a().a(j, new ajjn(this, i, paramString, localAppInterface, (File)localObject1));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajki(null, null, null));
          a(paramString);
          return paramString;
          if (((aiuc)localObject2).a())
          {
            if (((File)localObject1).exists())
            {
            ...
            a((String)localObject1, 1, i + ajyc.a(2131700483));
          }
          else
          {
            localObject3 = new ArrayList();
            ((List)localObject3).add(localObject2);
            aiud.a(localAppInterface, "", new ajjp(this, paramString, (File)localObject1, i), (List)localObject3, false, null);
          }
        }
      }
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Role/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Role/")))
      {
        ...
        localObject2 = ajmu.g + i + File.separator + (String)localObject1;
        localObject1 = new File((String)localObject2);
        if (QLog.isColorLevel()) {
          QLog.d("ApolloPluginRscLoader", 2, "getApolloRsc path:" + (String)localObject2);
        }
        ...
        if (ApolloUtil.d(i)) {
          a((String)localObject2, 1, i + ajyc.a(2131700492));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajki(null, null, null));
          ...
          ajhw.b(localAppInterface, null, new ajjq(this, (File)localObject1, (String)localObject2), i, null, -1, -1, false);
        }
      }
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Dress/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Dress/")))
      {
        ...
        localObject2 = ajmu.f + i + File.separator + (String)localObject1;
        localObject1 = new File((String)localObject2);
        if (QLog.isColorLevel()) {
          QLog.d("ApolloPluginRscLoader", 2, "getApolloRsc path:" + (String)localObject2);
        }
        ...
        if (ApolloUtil.c(i)) {
          a((String)localObject2, 1, i + ajyc.a(2131700504));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajki(null, null, null));
          ...
          ajhw.b(localAppInterface, null, new ajjr(this, i, (File)localObject1, (String)localObject2), -1, new int[] { i }, -1, -1, false);
        }
      }
      if ((paramString.startsWith("http://cmshow.qq.com/3dresource/Action/")) || (paramString.startsWith("https://cmshow.qq.com/3dresource/Action/")))
      {
        ...
        localObject2 = ajmu.d + i + File.separator + (String)localObject1;
        localObject1 = new File((String)localObject2);
        if (QLog.isColorLevel()) {
          QLog.d("ApolloPluginRscLoader", 2, "getApolloRsc path:" + (String)localObject2);
        }
        ...
        if (ApolloUtil.a(i, 0)) {
          a((String)localObject2, 1, i + ajyc.a(2131700493));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new ajki(null, null, null));
          ...
          ajhw.b(localAppInterface, null, new ajjs(this, (File)localObject1, (String)localObject2), -1, null, i, -1, false);
        }
      }
    ...
    try
    {
      ...
      paramString = (String)localObject3;
      localObject1 = localObject2;
      String str2 = bdhv.d((String)localObject3);
    ...
    catch (Exception localException)
    {
      ...
      new File(ajmu.f).mkdir();
      new File(ajmu.j).mkdir();
      paramString = ajmu.j + (String)localObject4 + File.separator + str3;
      localObject1 = new File(paramString);
      if (!QLog.isColorLevel()) {
        break label2612;
      }
    ...
    for (paramString = "application/json";; paramString = "application/octet-stream")
    {
      ...
      ajhw.a(localAppInterface, str1, new ajji(this, (File)localObject1, paramString));
      localObject1 = new ajki(null, null, null);
      if (str3.endsWith(".json")) {}
      for (paramString = "application/json";; paramString = "application/octet-stream")
      {
        paramString = new WebResourceResponse(paramString, "utf-8", (InputStream)localObject1);
