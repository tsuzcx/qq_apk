...
import com.tencent.mobileqq.activity.contacts.base.ContactsViewController.8;
  ...
  implements ajju, ajkh, ajmp, bdvp
{
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new ajjg(this));
  ...
  public ajjf(Activity paramActivity)
  {
    super(paramActivity);
    ...
    this.jdField_a_of_type_Ajjw = new ajjw(localanyb.b("sp_mayknow_entry_list_recommend"), bdvn.a());
    int i;
    if (localanyb.b())
    {
      i = 2;
    ...
    label192:
    for (paramActivity = new ajns(paramActivity);; paramActivity = new ajnl(paramActivity))
    {
      this.jdField_a_of_type_Ajmu = paramActivity;
      this.jdField_a_of_type_Ajmu.a(new ajjh(this));
  ...
  {
    int i = this.jdField_a_of_type_Ajjw.b(1);
    if (this.jdField_a_of_type_Ajjw.a())
    {
      int m = bhhr.ai(a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
      int j = 0;
      ...
      {
        i = this.jdField_a_of_type_Ajjw.b(1);
        k = i;
        if (QLog.isColorLevel()) {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      int i = this.jdField_a_of_type_Ajjw.a(this.jdField_b_of_type_Int);
      if (a())
      {
        i = this.jdField_a_of_type_Ajjw.b(i);
        if ((i == -1) || (paramBoolean2)) {
          i = a(paramBoolean1);
        }
        c(i);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Ajjw.jdField_a_of_type_JavaUtilArrayList.size());
      }
  ...
  private boolean a()
  {
    ...
    anyb localanyb = (anyb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MAYKNOW_RECOMMEND_MANAGER);
    if (localanyb != null) {
      bool1 = localanyb.b("sp_mayknow_entry_list_recommend");
    }
    for (boolean bool1 = this.jdField_a_of_type_Ajjw.a(bool1, bdvn.a());; bool1 = false)
    {
      if (bool1)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPagerAdapter.a(this.jdField_a_of_type_Ajjw.jdField_a_of_type_JavaUtilArrayList);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Ajjw.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Ajjw.jdField_a_of_type_ArrayOfInt);
      }
      bool2 = bool1;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("ContactsViewController", 2, "checkAndUpdateRecommendTabShow. mCurrentTabPos:" + this.jdField_b_of_type_Int + " isShowRecommendTab:" + this.jdField_a_of_type_Ajjw.a() + " changed:" + bool1);
      return bool1;
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Ajmu.d();
    this.jdField_d_of_type_Int = paramInt;
    if (this.jdField_d_of_type_Int == 2) {}
    for (Object localObject = new ajns(this.jdField_a_of_type_AndroidAppActivity);; localObject = new ajnl(this.jdField_a_of_type_AndroidAppActivity))
    {
      this.jdField_a_of_type_Ajmu = ((ajmu)localObject);
      this.jdField_a_of_type_Ajmu.a(new ajji(this));
      this.jdField_a_of_type_Ajmu.b();
      this.jdField_a_of_type_Ajmu.a(this.jdField_a_of_type_AndroidViewView);
      if (!this.jdField_c_of_type_Boolean) {
        break;
      }
      this.jdField_a_of_type_Ajmu.b(false);
      return;
    }
  }
  ...
  private static boolean b()
  {
    ...
    return (localarbv != null) && (localarbv.e());
  }
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      str = "";
      switch (this.jdField_a_of_type_Ajjw.a(paramInt))
      {
      }
    }
    for (;;)
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator = ((SimpleSlidingIndicator)paramView.findViewById(2131377844));
    k();
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView = ((HeaderScrollView)paramView.findViewById(2131365104));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager = ((ContactsViewPager)paramView.findViewById(2131365107));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPagerAdapter = new ContactsViewPagerAdapter(((SplashActivity)a()).getSupportFragmentManager(), ((SplashActivity)a()).app, (BaseActivity)a(), this.jdField_a_of_type_Ajjw.jdField_a_of_type_JavaUtilArrayList);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Ajjw.jdField_a_of_type_JavaUtilArrayList.size());
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager.setOnPageChangeListener(new ajjj(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Ajjw.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Ajjw.jdField_a_of_type_ArrayOfInt);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new ajjk(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_Ajmu.a(paramView);
    if (b()) {
      n();
    }
    c(a(false));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView.setOnScrollListener(new ajjl(this));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      anyb localanyb = (anyb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MAYKNOW_RECOMMEND_MANAGER);
      if ((localanyb == null) || (localanyb.b("sp_mayknow_entry_list_recommend") == this.jdField_a_of_type_Ajjw.a())) {
        break label251;
      }
    }
    label251:
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Ajmu.a(paramQQAppInterface);
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Ajmu.b(paramBoolean);
  ...
  public void f()
  {
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.a(2131365116, usu.a());
  ...
  public void g()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView != null)
    {
      View localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView.findViewById(2131371887);
  ...
  public void h()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPagerAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsContactsViewPager != null))
    {
      ...
      if ((i == this.jdField_a_of_type_Ajjw.b(1)) || (i == this.jdField_a_of_type_Ajjw.b(2)) || (i == this.jdField_a_of_type_Ajjw.b(0))) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseHeaderScrollView.scrollTo(0, 0);
      }
    }
    this.h = false;
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_Ajmu.a(bool);
    if (this.jdField_a_of_type_ComTencentMobileqqMiniEntryContactsMiniAppEntryManager != null) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setCurrentPosition(this.jdField_a_of_type_Ajjw.b(3), false);
    }
  }
