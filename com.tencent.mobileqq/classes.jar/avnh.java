  ...
  implements Handler.Callback, Manager
{
  ...
  private bjng jdField_a_of_type_Bjng = new bjng(ThreadManagerV2.getSubThreadLooper(), this);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    localbcea.e = paramString4;
    localbcea.d = paramString5;
    localbcea.f = paramString1;
    localbcea.i = paramString2;
    bcdz.a(paramString3, localbcea);
    bcdz.a(paramQQAppInterface, localbcea);
  }
  ...
  private boolean a(SubMsgType0x27.PushPlatform paramPushPlatform, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (airj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295);
      if (localObject != null)
      {
        bool2 = ((airj)localObject).b();
        bool1 = bool2;
        if (bool2)
        {
          bool1 = bool2;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bjng.sendEmptyMessageDelayed(1, 30000L);
  }
  ...
  public void a(long paramLong, String arg3, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        boolean bool = bfyg.a(paramString2);
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundPause) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop) || (bool))
        {
          ...
          synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
          {
            ...
            if (bool)
            {
              ??? = (avnj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(72);
              if (SettingCloneUtil.readValue(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString2.getString(2131693533), "qqsetting_lock_screen_whenexit_key", true))
              {
                if (QLog.isColorLevel()) {
  ...
  public void a(Context paramContext, Intent paramIntent)
  {
    ...
    if (j == 1041)
    {
      localIntent = AIOUtils.setOpenAIOIntent(new Intent(paramContext, SplashActivity.class), null);
  ...
  public void a(SubMsgType0x27.MsgBody paramMsgBody, short paramShort, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramMsgBody = new String(awfl.a(paramMsgBody), "UTF-8");
        localObject1 = null;
      ...
      catch (Exception paramMsgBody)
      {
        try
        {
          ...
          this.jdField_a_of_type_Bjng.removeMessages(1);
          localObject4 = new bcea();
          ((bcea)localObject4).e = "0X800923D";
          ((bcea)localObject4).d = "收到Push协议";
          ((bcea)localObject4).f = (((SubMsgType0x27.ClientReport)localObject3).uint32_service_id.get() + "");
          ((bcea)localObject4).i = ((SubMsgType0x27.ClientReport)localObject3).str_content_id.get();
          bcdz.a(paramMsgBody, (bcea)localObject4);
          bcdz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (bcea)localObject4);
          l = bbko.a();
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemNoticeData == null)
          {
            ...
            a(paramLong, str, paramMsgBody, (String)localObject2, i, j, ((bcea)localObject4).f, ((bcea)localObject4).i, (Bundle)localObject1);
            return;
