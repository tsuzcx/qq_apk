  ...
  extends bcvt
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      if (!((bcvs)((Iterator)localObject1).next() instanceof bcxp)) {
        break label944;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        paramView = (bcvs)this.jdField_a_of_type_JavaUtilArrayList.get(j);
      ...
      for (;;)
      {
        ...
        if ("button".equals(localObject2))
        {
          ...
          if (i == 0)
          {
            ...
            if (m < n)
            {
              localObject2 = (bcvs)this.jdField_a_of_type_JavaUtilArrayList.get(m);
              ((bcvs)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
              str = ((bcvs)localObject2).jdField_a_of_type_JavaLangString;
            ...
            ((bcvs)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject2 = ((bcvs)localObject2).a(paramContext, null, paramBundle);
            j = 0;
            if (m == 0)
            {
              j = 2131377922;
            ...
            for (;;)
            {
              ...
              if ("button".equals(str))
              {
                ...
                for (;;)
                {
                  ...
                  return paramView;
                  j = afur.a(5.0F, localResources);
                  break;
                  label888:
                  k = afur.a(5.0F, localResources);
                  m = i;
                  n = j;
                  j = k;
                  k = n;
