...
public class bfhc
{
  ...
  public static String a(int paramInt)
  {
    try
    {
      ...
      String str2 = bbct.e();
      String str3 = bbct.a(MobileQQ.sMobileQQ);
      String str4 = bfhb.a();
      String str5 = bfhb.b();
      ...
      localbfhf.a((byte[])localObject).a(str2).a(str3).a(str4).a(str5).a(str6).a(str7).a(str8);
      if (paramInt >= 2) {
        localbfhf.a(bfhb.c()).a(AppSetting.a()).a(bbct.f()).a("").a("");
      }
      localObject = localbfhf.toString();
    }
  ...
  private static void b(QQAppInterface paramQQAppInterface, SafeReport.ReqBody paramReqBody)
  {
    ...
    for (;;)
    {
      mxi.a(paramQQAppInterface, new bfhd(), paramReqBody.toByteArray(), "MqqSafeDataRpt.MQDun");
      return;
    }
  }
