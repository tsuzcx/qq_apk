  ...
  implements ozv
{
  ...
  public pak(FragmentActivity paramFragmentActivity, ReadInJoyCommentListView paramReadInJoyCommentListView, ReadInJoySecondCommentListFragment paramReadInJoySecondCommentListFragment, int paramInt)
  {
    ...
    this.jdField_a_of_type_Oze = new oze(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListView, this.jdField_a_of_type_JavaUtilList, this);
  ...
  private void a(List<pay> paramList)
  {
    ...
    for (;;)
    {
      ...
      {
        pay localpay = (pay)paramList.next();
        if ((localpay.a instanceof CommentData)) {
          localpay.a.isAnchor = false;
        }
      }
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Ozx != null) {
      this.jdField_a_of_type_Ozx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoySecondCommentListFragment.a());
    }
    ...
    this.jdField_a_of_type_Ozx = null;
    this.jdField_a_of_type_Pbe = null;
    this.jdField_a_of_type_Ozi = null;
  ...
  {
    if (this.jdField_a_of_type_Ozx != null) {
      this.jdField_a_of_type_Ozx.d();
    }
    if (this.jdField_a_of_type_Pbe != null) {
      this.jdField_a_of_type_Pbe.a(this.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void a(String paramString1, String paramString2, ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_Pbe = pbe.a(paramArticleInfo);
    this.jdField_a_of_type_Ozx = new ozx(this, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, paramInt);
    if (this.jdField_a_of_type_Pbe != null)
    {
      this.jdField_a_of_type_Pbe.a(this);
      this.jdField_a_of_type_JavaUtilList.clear();
      paramArticleInfo = this.jdField_a_of_type_Pbe.a(paramString1);
      a(paramArticleInfo);
      this.jdField_a_of_type_JavaUtilList.addAll(paramArticleInfo);
      this.jdField_a_of_type_Pbe.a(paramString1, paramString2);
  ...
  public void a(pay parampay)
  {
    super.a(parampay);
    if (this.jdField_a_of_type_Ozx != null) {
      this.jdField_a_of_type_Ozx.a(2, parampay);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    default: 
      ...
      if (this.jdField_a_of_type_Ozx != null) {
        this.jdField_a_of_type_Ozx.d(paramInt);
      }
      if (paramView == null)
      {
        ...
        if (a(paramInt) != null)
        {
          ...
          QLog.d("ReadInJoySecondCommentListAdapter", 1, (String)localObject1);
          paramView = a();
          afur.a("ReadInJoySecondCommentListAdapter", "sub comment convertview is null", new NullPointerException((String)localObject1));
    ...
    case 3: 
      ...
      {
        localObject2 = new pav();
        localObject1 = ((pav)localObject2).a(this, paramInt, (View)localObject1, paramViewGroup);
      }
      for (;;)
      {
        paramView = (View)localObject1;
        ...
        ((pav)localObject2).a(this, paramInt);
        paramView = (View)localObject1;
        break;
        localObject2 = (pav)((View)localObject1).getTag();
      }
    case 0: 
    case 4: 
    case 5: 
      ...
      if (oyo.a(a(paramInt)))
      {
        localObject2 = this.jdField_a_of_type_Oyo.a(a(paramInt));
    ...
    {
      oyo.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, (Container)paramView, (TemplateBean)localObject2, this, paramInt, i, true);
      break;
      localObject2 = oyk.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, a(paramInt), i, false, this);
      if ((localObject1 == null) || (!(localObject1 instanceof Container))) {}
      for (paramView = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getViewFactory().inflate(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, (TemplateBean)localObject2);; paramView = (View)localObject1)
      {
        oyk.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, (Container)paramView, (TemplateBean)localObject2, this, paramInt, i, false);
        break;
  ...
  public void onCommentDelete(int paramInt1, boolean paramBoolean, pay parampay, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while (this.jdField_a_of_type_Ozi != null)
      {
        this.jdField_a_of_type_Ozi.a(this.jdField_a_of_type_Pbe.a());
        return;
        if (this.jdField_a_of_type_Pbe != null)
        {
          parampay = this.jdField_a_of_type_Pbe.b(this.jdField_a_of_type_JavaLangString);
          if (!parampay.isEmpty())
          {
            this.jdField_a_of_type_JavaUtilList.clear();
  ...
  public void onCommentReply(boolean paramBoolean, pay parampay)
  {
    if (paramBoolean)
    {
      QQToast.a(BaseApplication.getContext(), 2, anni.a(2131711752), 0).a();
      if (this.jdField_a_of_type_Pbe != null) {}
      for (parampay = this.jdField_a_of_type_Pbe.b(this.jdField_a_of_type_JavaLangString);; parampay = new ArrayList())
      {
        if ((!parampay.isEmpty()) && (this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListView != null))
        {
          this.jdField_a_of_type_JavaUtilList.clear();
          this.jdField_a_of_type_JavaUtilList.addAll(parampay);
          notifyDataSetChanged();
        ...
        if ((this.jdField_a_of_type_Ozi != null) && (this.jdField_a_of_type_Pbe != null)) {
          this.jdField_a_of_type_Ozi.a(this.jdField_a_of_type_Pbe.a());
        }
        return;
      }
    }
    QQToast.a(BaseApplication.getContext(), 1, anni.a(2131711597), 0).a();
  }
