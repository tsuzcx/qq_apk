...
public class alfe
  extends alej
{
  public alfe(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = ("[" + anni.a(2131698416) + "]");
  ...
  {
    if ((paramObject instanceof alfe))
    {
      paramObject = (alfe)paramObject;
      paramObject.jdField_a_of_type_Beps.a(parambepr.jdField_a_of_type_Beps);
      return paramObject;
    }
    paramObject = new alfe(BaseApplication.getContext());
