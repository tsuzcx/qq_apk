...
public class bgmo
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new bgmp(this);
  
  public bgmo(Context paramContext, bglh parambglh, QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Bglh = parambglh;
  ...
  private List<String> a()
  {
    ...
    if (bbfj.a(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (i < k)
      {
        ...
        if ((str.equals("Photoplus.apk")) && (bfnz.d())) {}
        for (;;)
        {
          i += 1;
          break;
    ...
    if ((bbdh.e()) || (bbdx.a() <= 1.048576E+008F))
    {
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localEditor.commit();
    this.jdField_a_of_type_Bglh.a(paramString, this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener, true);
    if (("qqreaderplugin.apk".equals(paramString)) && (bguf.a(this.jdField_a_of_type_AndroidContentContext) == -1))
    {
    ...
    bghl.a(1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private void c()
  {
    if (!PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).getString("plugin_pre_install_qq_version", "").equals(bbdh.c()))
    {
      SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).edit();
  ...
  public void a()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          if (this.jdField_a_of_type_Bglh.isPlugininstalled(str)) {
            continue;
          }
          int i = a(str);
          if (i >= 10) {
