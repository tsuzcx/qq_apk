...
public class tlg
{
  ...
  static
  {
    jdField_b_of_type_JavaLangString = "QQ/8.4.1 Android/0.17 Android/" + Build.VERSION.RELEASE;
  }
  ...
  public static String a()
  {
    return "https://viola.qq.com/js/VShortVideo.js?_rij_violaUrl=1&v_tid=15&v_bundleName=VShortVideo&hideNav=1&v_nav_immer=1&statusColor=1&v_bid=3811&statusBarStyle=1&_cache_bunle=1&v_bg_color=000000&v_content_full=1&statusColor=1&supportNV=1";
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")))
      {
        ...
        {
          Object localObject2 = bhqz.a(paramString);
          if ((localObject2 != null) && (!TextUtils.isEmpty(((bhra)localObject2).jdField_b_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ViolaAccessHelper", 2, "load offline想 data cache on loadRes");
            }
            return ((bhra)localObject2).jdField_b_of_type_JavaLangString;
          }
          try
          {
            if (!TextUtils.isEmpty((CharSequence)localObject1))
            {
              localObject2 = nku.a((String)localObject1);
  ...
  public static void a()
  {
    ...
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_JavaLangString = pha.a();
    }
    HippyQQLibraryManager.getInstance().loadLibraryIfNeed(null);
    tsx.a().a();
    if ((System.currentTimeMillis() - jdField_a_of_type_Long >= 18000000L) || ((!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) && (!jdField_a_of_type_JavaLangString.equals(pha.a()))))
    {
      if (QLog.isColorLevel()) {
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    ...
    default: 
      ...
      else
      {
        ...
        sia.a(paramContext, (Intent)localObject2, (String)localObject1);
        return;
      }
      break;
    case 2: 
    ...
    for (;;)
    {
      try
      {
        ((JSONObject)localObject2).put("autoPlayDisable", bmqa.g());
        i = j;
      }
      catch (JSONException localJSONException)
      {
  ...
  @Deprecated
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, tlo paramtlo)
  {
    if (!a(paramContext)) {
      if (paramtlo != null) {
        paramtlo.a();
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        continue;
        label398:
        aevv.a(paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class);
      }
      label413:
      ...
      aevv.a((Activity)paramContext, localIntent, PublicTransFragmentActivity.class, ViolaFragment.class, paramBundle.getInt("requestCode", -1));
    ...
    if ((paramContext instanceof SplashActivity))
    {
      ...
      localIntent.putExtra(tmn.jdField_a_of_type_JavaLangString, paramString1);
      if (paramBundle != null) {
  ...
  public static void a(Context paramContext, String paramString, tlo paramtlo) {}
  ...
  public static void a(Context paramContext, JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      try
      {
        bool = piv.a(((Bundle)localObject2).getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(((Bundle)localObject2).getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(((Bundle)localObject2).getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(((Bundle)localObject2).getString("VIDEO_TIME")).intValue());
        k = bool;
      }
      ...
      sia.a(paramContext, (Intent)localObject1);
      return;
    ...
    for (str2 = paramJSONObject.optString("isAwesome", null);; str2 = paramJSONObject.optString("isawesome", null))
    {
      ...
      try
      {
        bool = piv.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
        k = bool;
      }
  ...
  /* Error */
  public static void a(com.tencent.common.app.AppInterface paramAppInterface, String paramString, tmf paramtmf, tlm paramtlm)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 286	com/tencent/viola/core/ViolaSDKEngine:isInitialized	()Z
    //   6: ifne +91 -> 97
    //   9: new 778	com/tencent/viola/core/InitConfig$Builder
    //   12: dup
    //   13: invokespecial 779	com/tencent/viola/core/InitConfig$Builder:<init>	()V
    //   16: iconst_1
    //   17: invokevirtual 783	com/tencent/viola/core/InitConfig$Builder:setBusinessId	(I)Lcom/tencent/viola/core/InitConfig$Builder;
    //   20: aload_1
    //   21: invokevirtual 787	com/tencent/viola/core/InitConfig$Builder:setFramework	(Ljava/lang/String;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   24: new 789	tly
    //   27: dup
    //   28: invokespecial 790	tly:<init>	()V
    //   31: invokevirtual 794	com/tencent/viola/core/InitConfig$Builder:setHttpAdapter	(Lcom/tencent/viola/adapter/IHttpAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   34: new 796	tmh
    //   37: dup
    //   38: invokespecial 797	tmh:<init>	()V
    //   41: invokevirtual 801	com/tencent/viola/core/InitConfig$Builder:setComponentAdapter	(Lcom/tencent/viola/adapter/VComponentAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   44: aload_2
    //   45: invokevirtual 805	com/tencent/viola/core/InitConfig$Builder:setReportDelegate	(Lcom/tencent/viola/commons/IReportDelegate;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   48: new 807	tme
    //   51: dup
    //   52: invokespecial 808	tme:<init>	()V
    //   55: invokevirtual 812	com/tencent/viola/core/InitConfig$Builder:setLogAdapter	(Lcom/tencent/viola/adapter/ILogAdapter;)Lcom/tencent/viola/core/InitConfig$Builder;
    //   58: astore_2
    //   59: aload_0
    //   60: ifnull +32 -> 92
    //   63: aload_0
    //   64: invokevirtual 818	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   67: astore_1
    //   68: aload_1
    //   69: aload_2
    //   70: invokevirtual 822	com/tencent/viola/core/InitConfig$Builder:build	()Lcom/tencent/viola/core/InitConfig;
    //   73: new 824	tlk
    //   76: dup
    //   77: aload_0
    //   78: aload_3
    //   79: invokespecial 827	tlk:<init>	(Lcom/tencent/common/app/AppInterface;Ltlm;)V
    //   82: invokestatic 828	trd:a	()Ljava/lang/String;
    //   85: invokestatic 832	com/tencent/viola/core/ViolaSDKEngine:initialize	(Landroid/app/Application;Lcom/tencent/viola/core/InitConfig;Lcom/tencent/viola/core/ViolaSDKEngine$InitCallback;Ljava/lang/String;)V
    //   88: ldc 2
    //   90: monitorexit
    //   91: return
    //   92: aconst_null
    ...
    //   100: ldc_w 836
    //   103: iconst_0
    //   104: invokestatic 840	com/tencent/viola/core/ViolaSDKEngine:registerModule	(Ljava/lang/String;Ljava/lang/Class;Z)Z
    //   107: pop
    //   108: aload_3
    //   109: ifnull -21 -> 88
    //   112: aload_0
    //   113: new 842	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$5
    //   116: dup
    //   117: aload_3
    //   118: invokespecial 845	com/tencent/biz/pubaccount/readinjoy/viola/ViolaAccessHelper$5:<init>	(Ltlm;)V
    //   121: invokevirtual 849	com/tencent/common/app/AppInterface:runOnUiThread	(Ljava/lang/Runnable;)V
    //   124: goto -36 -> 88
    //   127: astore_0
    //   128: invokestatic 127	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   131: ifeq -43 -> 88
    //   134: ldc 129
    //   136: iconst_2
    ...
    //   150: aload_0
    //   151: invokevirtual 493	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   154: invokevirtual 25	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   157: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   160: invokestatic 234	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   163: goto -75 -> 88
    //   166: astore_0
    //   167: ldc 2
    //   169: monitorexit
    ...
    //   0	172	2	paramtmf	tmf
    //   0	172	3	paramtlm	tlm
    // Exception table:
    //   from	to	target	type
  ...
  @Deprecated
  public static void a(String paramString, tlm paramtlm)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)pha.a();
    if ((localQQAppInterface == null) && (paramtlm != null))
    {
      paramtlm.a();
      return;
    }
    a(localQQAppInterface, paramString, null, paramtlm);
  }
  
  public static void a(String paramString, tln paramtln)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)pha.a();
    ...
    ThreadManager.post(new ViolaAccessHelper.3(paramString, localQQAppInterface, paramtln, System.currentTimeMillis()), 8, null, true);
  }
  
  public static void a(String paramString, tsq paramtsq)
  {
    ThreadManager.post(new ViolaAccessHelper.6(paramString, paramtsq), 8, null, false);
  }
  ...
  private static boolean a(Context paramContext)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            a(paramContext, anni.a(2131715136));
          } while (!QLog.isColorLevel());
          ...
          a(paramContext, anni.a(2131715138));
        } while (!QLog.isColorLevel());
        QLog.d("ViolaAccessHelper", 2, "isViolaPermit checkSO is false");
        return false;
        str = trd.b("https://kd.qpic.cn/viola/lib/viola.js?v_bid=3547");
        if (!TextUtils.isEmpty(str)) {
          break;
        }
      ...
      a(paramContext, anni.a(2131715137));
      if (QLog.isColorLevel()) {
  ...
  {
    a("https://sqimg.qq.com/qq_product_operations/kan/viola_config/viola_config.json?v_bid=3192", new tll());
  }
