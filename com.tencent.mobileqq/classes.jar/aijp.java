...
public class aijp
  extends ajxj
{
  public aijp(SpecailCareListActivity paramSpecailCareListActivity) {}
    ...
    for (boolean bool = Arrays.equals(SpecailCareListActivity.a(this.a), paramArrayOfObject);; bool = false)
    {
      if (bool) {
        if (paramArrayOfObject.length >= 1)
        {
          ...
          if (paramBoolean) {
            ...
            {
              this.a.d();
              bcql.a(BaseApplication.getContext(), 2, 2131689639, 0).b(this.a.getTitleBarHeight());
              this.a.a();
              this.a.jdField_a_of_type_Aijv.notifyDataSetChanged();
            }
          }
        }
      }
      while (!paramBoolean)
      {
        do
        {
          ...
          {
            return;
            bcql.a(BaseApplication.getContext(), 2, 2131699508, 0).b(this.a.getTitleBarHeight());
          }
          if (this.a.c != null)
          {
            bcql.a(BaseApplication.getContext(), 1, 2131699491, 0).b(this.a.getTitleBarHeight());
            return;
          }
          bcql.a(BaseApplication.getContext(), 1, 2131699507, 0).b(this.a.getTitleBarHeight());
          return;
        } while (!paramBoolean);
        this.a.a();
        this.a.jdField_a_of_type_Aijv.notifyDataSetChanged();
