...
public class awvm
  implements bjmd
{
  private static volatile awvm a;
  
  public static awvm a()
  {
    if (a == null) {}
    try
    {
  ...
  private void a(MobileQbossAdvRsp paramMobileQbossAdvRsp, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null) {
          ajea.a().a(((Long)localObject).longValue(), 2783);
        }
      }
      ...
      if ((paramMobileQbossAdvRsp != null) && (paramQQAppInterface != null))
      {
        ...
        awva.a().a(paramMobileQbossAdvRsp, paramQQAppInterface);
      }
      return;
    }
  ...
  private void a(MobileQbossAdvRsp paramMobileQbossAdvRsp, String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramMobileQbossAdvRsp != null)
    {
      ...
      if (paramString != null)
      {
        ...
        if (paramString != null) {
          ajea.a().a(paramString.longValue(), 2741);
        }
      }
      paramMobileQbossAdvRsp = paramMobileQbossAdvRsp.mapAdv;
      if (paramMobileQbossAdvRsp != null)
  ...
  private void a(ajdy paramajdy)
  {
    ...
    do
    {
      ...
      {
        return;
        localajdy = ajea.a().a(localQQAppInterface.getAccount());
      } while ((paramajdy == null) || (paramajdy.a == null) || (localajdy == null) || (localajdy.a == null) || (paramajdy.a.pattern_id == localajdy.a.pattern_id));
      paramajdy = localQQAppInterface.getHandler(Conversation.class);
    } while (paramajdy == null);
    QLog.e("QzoneQbossHelper", 1, "checkIfNeedRemoveBanner remove");
    paramajdy.sendEmptyMessage(1063);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    try
    {
      Object localObject1 = awvh.a(BaseApplicationImpl.getContext(), paramLong);
      localArrayList = new ArrayList();
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        if ((awvh.a == null) || (awvh.a.size() == 0))
        {
          localHashMap = awvh.a(BaseApplicationImpl.getApplication(), paramLong + "");
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            localObject2 = (awvi)localHashMap.get(localObject2);
            if (((awvi)localObject2).b())
            {
              localArrayList.add(localObject2);
              QLog.i("QSplash@QbossSplashNetService", 1, "checkNeedDowloadAndDowload aid =" + ((awvi)localObject2).jdField_b_of_type_JavaLangString + "UIN" + paramLong % 10000L);
            }
  ...
  private void a(ArrayList<tAdvDesc> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (paramArrayList != null)
      {
        ...
        paramArrayList = ajdy.a(paramArrayList);
        a(paramArrayList);
        ajea.a().a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramArrayList);
      }
    }
    else
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null) {
            ajea.a().a(((Long)localObject).longValue(), 2742);
          }
        }
        paramMobileQbossAdvRsp = paramMobileQbossAdvRsp.mapAdv;
        if ((paramMobileQbossAdvRsp != null) && (paramQQAppInterface != null))
        {
          ...
          if ((paramMobileQbossAdvRsp != null) && (paramMobileQbossAdvRsp.size() > 0))
          {
            ...
            awvd.a(paramMobileQbossAdvRsp, paramQQAppInterface, (String)localObject);
            i = 1;
            if ((i == 0) && (paramQQAppInterface != null))
            {
              ...
              awvh.a(BaseApplicationImpl.getContext(), awvh.a(paramMobileQbossAdvRsp), false);
              awvh.b(BaseApplicationImpl.getContext(), awvh.a(paramMobileQbossAdvRsp));
            }
            return;
          }
        }
  ...
  public void a(String paramString, ArrayList<Integer> paramArrayList)
  {
    ...
    bjmh.a().a(paramArrayList, this, paramString);
  }
        ...
        if ("qboss_banner_login".equals(paramString))
        {
          ...
          if (localObject != null)
          {
            if (!bool1)
            {
              ...
              a((QQAppInterface)localObject, awvh.a(((QQAppInterface)localObject).getAccount()));
            }
            if (!bool3)
            {
              QLog.i("QSplash@QbossSplashNetService", 1, "sendQbossRequest QbossPreDownloadManager.checkPreDownloadResStatus ");
              awva.a().a((QQAppInterface)localObject);
            }
          }
        }
