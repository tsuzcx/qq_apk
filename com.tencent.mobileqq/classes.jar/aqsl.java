...
public class aqsl
{
  public static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      paramMessageRecord = ahfa.a(paramQQAppInterface, paramMessageRecord);
      int i;
      if ((paramMessageRecord instanceof MessageForFile))
      {
        ...
        {
          i = auea.a(paramQQAppInterface.fileName);
          if (i == 0) {
            return 3;
          }
          if (i == 2) {
      ...
      {
        paramQQAppInterface = bgke.a(paramQQAppInterface, (MessageForTroopFile)paramMessageRecord);
        if (paramQQAppInterface != null)
        {
          i = auea.a(paramQQAppInterface.g);
          if (i == 0) {
            return 3;
          }
          if (i == 2) {
  ...
  public static final String a(Context paramContext, int paramInt)
  {
    ...
    if (i < 60) {
      return paramContext.getString(2131698781, new Object[] { Integer.valueOf(i) });
    }
    if (i < 3600) {
      return paramContext.getString(2131698782, new Object[] { Integer.valueOf(i / 60), Integer.valueOf(i % 60) });
    }
    paramInt = i / 60;
    return paramContext.getString(2131698783, new Object[] { Integer.valueOf(paramInt / 60), Integer.valueOf(paramInt % 60) });
  }
