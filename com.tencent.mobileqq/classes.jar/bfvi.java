  ...
  extends MSFServlet
{
  ...
  {
    bfvg.a().a(paramString, paramInt);
  }
  
  private void a(byte[] paramArrayOfByte)
  {
    bfvg.a().b(paramArrayOfByte);
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      bfvp.c("VideoChannelServlet", String.format("onReceive cmd=%s", new Object[] { paramIntent }));
    ...
    bfvp.c("VideoChannelServlet", String.format(">>> ip=%s", new Object[] { paramIntent }));
    a(paramIntent, 0);
    return;
    if ("VideoCCSvc.Adaptation".equalsIgnoreCase(paramIntent))
    {
      ...
      bfvp.a("VideoChannelServlet", String.format("onReceive get config fail, resultCode=%s", new Object[] { Integer.valueOf(paramFromServiceMsg.getResultCode()) }));
      return;
    }
    bfvp.b("VideoChannelServlet", "onReceive handle not process cmd.");
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bfvp.c("VideoChannelServlet", String.format("onSend reqType=%s", new Object[] { Integer.valueOf(i) }));
    switch (i)
    {
    default: 
      bfvp.b("VideoChannelServlet", "onSend handle not define reqType.");
      return;
    case 1: 
