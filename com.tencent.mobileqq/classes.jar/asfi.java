...
public class asfi
{
  private static asfi jdField_a_of_type_Asfi;
  ...
  public aopa a;
  private asfh jdField_a_of_type_Asfh = new asfh();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected Runnable a;
  private ArrayList<asfk> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private double jdField_b_of_type_Double;
  private long jdField_b_of_type_Long = 1800000L;
  
  private asfi(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new EnterpriseQQManager.1(this);
    this.jdField_a_of_type_Aopa = new asfj(this, 4, true, true, 0L, false, false, "EnterpriseQQManager");
    if (paramQQAppInterface != null) {
      a(paramQQAppInterface);
    }
  }
  
  public static asfi a(QQAppInterface paramQQAppInterface)
  {
    if (jdField_a_of_type_Asfi == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Asfi == null) {
        jdField_a_of_type_Asfi = new asfi(paramQQAppInterface);
      }
      return jdField_a_of_type_Asfi;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Asfh != null) {
      return this.jdField_a_of_type_Asfh.a(paramString);
    }
    return null;
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2)
  {
    ...
    {
      paramContext = (anld)paramQQAppInterface.a(21);
  ...
  {
    if (this.jdField_a_of_type_Asfh == null) {
      this.jdField_a_of_type_Asfh = new asfh();
    }
    if (paramQQAppInterface != null)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Asfh.a(localEnterpriseQQMenuEntity.uin, localGetCRMMenuResponse.button_info.get(), localEnterpriseQQMenuEntity.seqno, localEnterpriseQQMenuEntity.savedDateTime);
        continue;
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StructMsg.GetCRMMenuResponse paramGetCRMMenuResponse)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Asfh.a(paramString) != paramInt) && (paramGetCRMMenuResponse != null))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Asfh.a(paramString, localList, paramInt, l);
          return;
    ...
    this.jdField_a_of_type_Asfh.a(paramString, l);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    if ((paramQQAppInterface != null) && (!TextUtils.isEmpty(paramString)))
    {
      long l = 0L;
      if (this.jdField_a_of_type_Asfh != null) {
        l = this.jdField_a_of_type_Asfh.a(paramString);
      }
      if ((paramBoolean) || ((!paramBoolean) && (System.currentTimeMillis() - l > 43200000L)))
      {
        paramQQAppInterface = (anld)paramQQAppInterface.a(21);
        if (paramQQAppInterface != null) {
