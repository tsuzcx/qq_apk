  ...
  implements TouchWebView.OnScrollChangedListener
{
  ...
  public asfi(CommonTabFragment paramCommonTabFragment, Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
  ...
  public void a()
  {
    ...
    for (long l = System.currentTimeMillis();; l = 0L)
    {
      ...
      for (this.mUrl += "&";; this.mUrl += "?")
      {
        ...
        auwz.a("WebSpeedTrace", "mInitWebViewTime", new Object[] { Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqFragmentCommonTabFragment.jdField_a_of_type_ComTencentMobileqqActivityNearbyActivity.k) });
        return;
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqFragmentCommonTabFragment.jdField_a_of_type_Ashu != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqFragmentCommonTabFragment.jdField_a_of_type_Ashu.b(false).a(true);
      this.jdField_a_of_type_ComTencentMobileqqFragmentCommonTabFragment.jdField_a_of_type_Ashu.a();
    }
  }
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFragmentCommonTabFragment.jdField_a_of_type_Ashu != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqFragmentCommonTabFragment.jdField_a_of_type_Ashu.b(true).a(true);
      this.jdField_a_of_type_ComTencentMobileqqFragmentCommonTabFragment.jdField_a_of_type_Ashu.a();
    }
