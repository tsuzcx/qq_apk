...
public class anvq
{
  private static anvq jdField_a_of_type_Anvq;
  private int jdField_a_of_type_Int;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private anud jdField_a_of_type_Anud = new anvr(this);
  ...
  private Vector<anvs> jdField_a_of_type_JavaUtilVector = new Vector();
  private CopyOnWriteArrayList<anqq> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public static anvq a()
  {
    if (jdField_a_of_type_Anvq == null) {}
    try
    {
      if (jdField_a_of_type_Anvq == null) {
        jdField_a_of_type_Anvq = new anvq();
      }
      return jdField_a_of_type_Anvq;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    while (localIterator.hasNext()) {
      ((anqq)localIterator.next()).onBindedToClient();
    }
  }
  ...
  private void d()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext()) {
      ((anqq)localIterator.next()).onDisconnectWithService();
    }
  }
  ...
  private void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer = new EmojiIPCAlarmer(this.jdField_a_of_type_Anud);
  ...
  private void f(Bundle paramBundle)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext()) {
      ((anqq)localIterator.next()).onPushMsg(paramBundle);
    }
  }
  
  public anvs a(int paramInt)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      ...
      while (localIterator.hasNext())
      {
        anvs localanvs = (anvs)localIterator.next();
        if (localanvs.jdField_a_of_type_Int == paramInt)
        {
          if (QLog.isColorLevel()) {
            QLog.i("Q.emoji.web.EmoWebIPCOperator", 2, "remove req queue seq:" + paramInt);
          }
          this.jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer.a(localanvs.jdField_a_of_type_JavaLangRunnable);
          this.jdField_a_of_type_JavaUtilVector.remove(localanvs);
          if (QLog.isColorLevel()) {
  ...
  public anvs a(Bundle paramBundle)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      int i = this.jdField_a_of_type_Int;
      this.jdField_a_of_type_Int = (i + 1);
      paramBundle = new anvs(i, paramBundle);
      e();
      if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      } while ((localObject == null) || ((this.jdField_a_of_type_ComTencentMobileqqEmosmClient != null) && (this.jdField_a_of_type_ComTencentMobileqqEmosmClient.onReqToServer(((anvs)localObject).jdField_a_of_type_AndroidOsBundle))));
  ...
  public void a(anqq paramanqq)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.i("Q.emoji.web.EmoWebIPCOperator", 2, "RegisterObserver key:" + paramanqq.key);
      }
    } while (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramanqq));
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramanqq);
  }
  ...
  public void b(anqq paramanqq)
  {
    if (paramanqq != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i("Q.emoji.web.EmoWebIPCOperator", 2, "unRegisterObserver key:" + paramanqq.key);
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramanqq)) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramanqq);
      }
    }
  }
  ...
  public void e(Bundle paramBundle)
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      ((anqq)((Iterator)localObject).next()).onResponse(paramBundle);
    }
  }
}
