...
class bckb
  extends nab
{
  bckb(bcju parambcju, bcjt parambcjt, yqu paramyqu) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bcjt == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0xdad. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bcjt);
      }
      if (this.jdField_a_of_type_Bcjt != null)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_Bcjt.b(paramInt, paramArrayOfByte);
          return;
        }
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Bcjt.a(this.jdField_a_of_type_Yqu.a);
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
