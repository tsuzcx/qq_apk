  ...
  extends bcgx
{
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    localBubbleViewLayout.setId(2131364022);
    ...
    localLinearLayout.setId(2131362425);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    LinearLayout localLinearLayout2 = (LinearLayout)localRelativeLayout.findViewById(2131362425);
    ...
    if (localIterator.hasNext())
    {
      ...
      {
        localObject1 = ((bcgw)localObject2).a(paramContext, null, paramBundle);
        i = AIOUtils.dp2px(200.0F, localResources);
        if (!(localObject2 instanceof bciz)) {
          break label756;
        }
        localObject2 = (bciz)localObject2;
        if (((bciz)localObject2).p > 0)
        {
          i = ((bciz)localObject2).p;
          label175:
          if ((j & 0x2) == 0) {
            break label753;
          }
          ...
          ((ImageView)localObject1).setImageResource(2130841712);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localLinearLayout1 = (LinearLayout)((bcgw)localObject2).a(paramContext, null, paramBundle);
          ...
          ((BubbleViewLayout)localRelativeLayout.findViewById(2131364022)).mIsSend = bool;
          if (bool)
          {
            ...
            {
              if (!awhm.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message, "isFaceScoreSecondMember")) {
                break label730;
              }
              paramContext = "2";
              if ((j & 0x2) == 0) {
          ...
          {
            awhm.a("exp_obj", paramBundle, new String[] { paramContext, "", "", paramView });
