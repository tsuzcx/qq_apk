  ...
  extends bgix
{
  ...
  private static final String b = ajjy.a(2131646536);
  bgdf jdField_a_of_type_Bgdf = new bgid(this);
  ...
  private String a(byte[] paramArrayOfByte)
  {
    ...
    //   10: getstatic 76	bgde:b	Ljava/lang/String;
    ...
    //   37: dup
    //   38: getstatic 76	bgde:b	Ljava/lang/String;
  ...
  private void a(bbac parambbac, String... paramVarArgs)
  {
    QLog.i("QZoneSharePictureJsPlugin", 1, "saxon handleGenerateGif start");
    if ((parambbac == null) || (paramVarArgs == null) || (paramVarArgs.length < 1))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = PhotoUtils.a(ajed.ba, "IMG", ".gif");
        ...
        if (!bool1)
        {
          ...
          parambbac = a(new File((String)localObject1));
          if (!TextUtils.isEmpty(parambbac)) {
            break label415;
          }
      ...
      catch (Throwable parambbac)
      {
        QLog.e("QZoneSharePictureJsPlugin", 1, "handleGenerateGif fail, compressGIFTask exception.", parambbac);
        return;
      }
      boolean bool1 = false;
    }
    ...
    if (!bool3)
    {
      ...
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambbac, parambbac.length());
      return;
    }
    if (parambbac.length() <= k)
    {
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 不分片callback len=" + parambbac.length());
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambbac, parambbac.length());
      return;
    }
    int m = parambbac.length() / k;
    if (parambbac.length() % k == 0) {
      j = 0;
    }
    for (;;)
    {
      m += j;
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 分片callback pcount＝" + m + ",filelen=" + parambbac.length());
      j = 0;
      label575:
      if (j < m - 1)
      {
        a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, j, parambbac.substring(j * k, (j + 1) * k), parambbac.length());
    ...
    a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, m - 1, parambbac.substring((m - 1) * k), parambbac.length());
    ...
    paramVarArgs = bfpy.a();
    bfpr.a(parambbac.a(), paramVarArgs, (String)localObject1, ajjy.a(2131646549), localInterruptedException, -1);
  }
  ...
  private void a(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a() != null)) {
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getContext(), paramString, 0).a();
    }
  }
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        try
        {
          ...
          paramString2.put("msg", ajjy.a(2131646538));
  ...
  private void a(JSONObject paramJSONObject, String paramString, bbac parambbac)
  {
    ThreadManager.getSubThreadHandler().post(new QZoneSharePictureJsPlugin.7(this, paramJSONObject, paramString, parambbac));
  }
  
  private void a(String... paramVarArgs)
  {
    bget.a().a(new bgie(this, paramVarArgs));
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 503	java/io/BufferedWriter
    //   5: dup
    //   6: new 505	java/io/OutputStreamWriter
    //   9: dup
    //   10: new 113	java/io/FileOutputStream
    //   13: dup
    //   14: aload_0
    //   15: iconst_1
    //   16: invokespecial 508	java/io/FileOutputStream:<init>	(Ljava/lang/String;Z)V
    //   19: invokespecial 511	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   22: invokespecial 514	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   25: astore_2
    //   26: aload_2
    //   27: astore_0
    //   28: aload_2
    //   29: aload_1
    //   30: invokevirtual 516	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   33: aload_2
    //   34: invokestatic 522	cooperation/qzone/util/DataUtils:closeDataObject	(Ljava/lang/Object;)Z
    //   37: pop
    //   38: iconst_1
    //   39: ireturn
    //   40: astore_3
    ...
    //   48: aload_3
    //   49: iconst_0
    //   50: anewarray 524	java/lang/Object
    //   53: invokestatic 530	cooperation/qzone/util/QZLog:w	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   56: aload_1
    //   57: invokestatic 522	cooperation/qzone/util/DataUtils:closeDataObject	(Ljava/lang/Object;)Z
    //   60: pop
    //   61: iconst_0
    //   62: ireturn
    //   63: astore_0
    ...
    //   65: astore_1
    //   66: aload_1
    //   67: invokestatic 522	cooperation/qzone/util/DataUtils:closeDataObject	(Ljava/lang/Object;)Z
    //   70: pop
    //   71: aload_0
    //   72: athrow
    //   73: astore_2
  ...
  {
    // Byte code:
    //   0: new 533	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: sipush 8192
    //   7: invokespecial 536	java/io/ByteArrayOutputStream:<init>	(I)V
    //   10: astore_3
    //   11: aload_3
    //   12: astore_2
    //   13: aload_0
    //   14: invokevirtual 541	android/graphics/Bitmap:hasAlpha	()Z
    //   17: ifeq +32 -> 49
    //   20: aload_3
    //   21: astore_2
    //   22: aload_0
    //   23: getstatic 547	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   26: iload_1
    //   27: aload_3
    //   28: invokevirtual 551	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   31: pop
    //   32: aload_3
    //   33: astore_2
    //   34: aload_3
    //   35: invokevirtual 555	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   38: astore_0
    //   39: aload_3
    //   40: invokevirtual 556	java/io/ByteArrayOutputStream:flush	()V
    //   43: aload_3
    //   44: invokevirtual 557	java/io/ByteArrayOutputStream:close	()V
    //   47: aload_0
    //   48: areturn
    //   49: aload_3
    //   50: astore_2
    //   51: aload_0
    //   52: getstatic 560	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   55: iload_1
    //   56: aload_3
    //   57: invokevirtual 551	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   60: pop
    //   61: goto -29 -> 32
    //   64: astore_0
    //   65: aload_3
    ...
    //   69: iconst_1
    //   70: aload_0
    //   71: invokevirtual 561	java/lang/Exception:toString	()Ljava/lang/String;
    //   74: invokestatic 402	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   77: aload_3
    //   78: invokevirtual 556	java/io/ByteArrayOutputStream:flush	()V
    //   81: aload_3
    //   82: invokevirtual 557	java/io/ByteArrayOutputStream:close	()V
    //   85: aconst_null
    //   86: areturn
    //   87: astore_0
    //   88: ldc 131
    //   90: iconst_1
    //   91: aload_0
    //   92: invokevirtual 561	java/lang/Exception:toString	()Ljava/lang/String;
    //   95: invokestatic 402	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   98: aconst_null
    //   99: areturn
    //   100: astore_2
    //   101: ldc 131
    //   103: iconst_1
    //   104: aload_2
    //   105: invokevirtual 561	java/lang/Exception:toString	()Ljava/lang/String;
    //   108: invokestatic 402	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   111: aload_0
    //   112: areturn
    //   113: astore_0
    //   114: aconst_null
    ...
    //   120: iconst_1
    //   121: aload_0
    //   122: invokevirtual 562	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
    //   125: invokestatic 402	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   128: aload_3
    //   129: invokevirtual 556	java/io/ByteArrayOutputStream:flush	()V
    //   132: aload_3
    //   133: invokevirtual 557	java/io/ByteArrayOutputStream:close	()V
    //   136: aconst_null
    //   137: areturn
    //   138: astore_0
    //   139: ldc 131
    //   141: iconst_1
    //   142: aload_0
    //   143: invokevirtual 561	java/lang/Exception:toString	()Ljava/lang/String;
    //   146: invokestatic 402	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   149: aconst_null
    //   150: areturn
    //   151: astore_0
    //   152: aconst_null
    //   153: astore_2
    //   154: aload_2
    //   155: invokevirtual 556	java/io/ByteArrayOutputStream:flush	()V
    //   158: aload_2
    //   159: invokevirtual 557	java/io/ByteArrayOutputStream:close	()V
    //   162: aload_0
    //   163: athrow
    //   164: astore_2
    //   165: ldc 131
    //   167: iconst_1
    //   168: aload_2
    //   169: invokevirtual 561	java/lang/Exception:toString	()Ljava/lang/String;
    //   172: invokestatic 402	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   175: goto -13 -> 162
    //   178: astore_0
    //   179: goto -25 -> 154
    //   182: astore_0
  ...
  {
    Bitmap localBitmap1 = bcdo.a(paramString, 120, 120, false);
  ...
  private void b(bbac parambbac, String... paramVarArgs)
  {
    int i = 0;
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (parambbac != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      String str;
      try
      {
        ...
        {
          QLog.w("QZoneSharePictureJsPlugin", 1, "Base64.decode Exception: " + parambbac.toString());
          a(ajjy.a(2131646525));
          return;
        }
      ...
      {
        QLog.w("QZoneSharePictureJsPlugin", 1, "handleSharePicture catch an exception in disPatchMethod", parambbac);
        return;
      }
      QLog.d("QZoneSharePictureJsPlugin", 1, "the filePath is " + (String)localObject);
      label206:
      if ((!TextUtils.isEmpty(str)) && (parambbac != null) && (parambbac.a() != null)) {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        for (;;)
        {
          ...
          i = bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, parambbac, 21);
          aphp.a(parambbac.a(), localIntent, i);
          continue;
          a(paramVarArgs, (String)localObject, parambbac);
          continue;
          if (bgde.a().a())
          {
            bgde.a().a(this.jdField_a_of_type_Bgdf);
            parambbac = a((String)localObject);
            bgde.a().a((String)localObject, parambbac, 0);
          }
          else if (parambbac.a() != null)
          {
            parambbac.a().post(new QZoneSharePictureJsPlugin.5(this, parambbac));
            continue;
            if (bgde.a().a())
            {
              bgde.a().a(this.jdField_a_of_type_Bgdf);
              bgde.a().a((String)localObject, null, 1);
            }
            else if (parambbac.a() != null)
            {
              parambbac.a().post(new QZoneSharePictureJsPlugin.6(this, parambbac));
            }
          }
        }
      }
  ...
  private void b(String paramString)
  {
    ...
    localObject2 = localObject1;
    label113:
    paramString = bftg.b().a();
    if (TextUtils.isEmpty(paramString))
    {
      a(localObject2, -1, ajjy.a(2131646534));
      return;
    }
    try
    {
      localObject1 = new File(paramString);
      if ((!apdh.a(paramString)) && (!((File)localObject1).mkdirs()))
      {
    ...
    catch (Exception paramString)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = bftg.b().a(paramString);
        try
        {
        ...
        long l = azzz.a((File)localObject1);
      ...
      a(localObject2, -1, ajjy.a(2131646555));
      return;
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    a(paramString, -1, ajjy.a(2131646541));
  }
  ...
  String a(File paramFile)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 847	java/io/BufferedInputStream
    //   6: dup
    //   7: new 849	java/io/FileInputStream
    //   10: dup
    //   11: aload_1
    //   12: invokespecial 850	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   15: invokespecial 853	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_2
    //   22: invokevirtual 856	java/io/BufferedInputStream:available	()I
    //   25: newarray byte
    //   27: astore_3
    //   28: aload_2
    //   29: astore_1
    //   30: aload_2
    //   31: aload_3
    //   32: invokevirtual 860	java/io/BufferedInputStream:read	([B)I
    //   35: pop
    //   36: aload_2
    //   37: astore_1
    //   38: aload_3
    //   39: iconst_0
    //   40: invokestatic 864	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   43: astore_3
    //   44: aload_3
    //   45: astore_1
    //   46: aload_2
    //   47: ifnull +9 -> 56
    //   50: aload_2
    //   51: invokevirtual 865	java/io/BufferedInputStream:close	()V
    //   54: aload_3
    //   55: astore_1
    //   56: aload_1
    //   57: areturn
    //   58: astore_1
    //   59: aload_1
    //   60: invokevirtual 868	java/io/IOException:printStackTrace	()V
    //   63: aload_3
    //   64: areturn
    //   65: astore_3
    //   66: aconst_null
    ...
    //   73: ldc_w 774
    //   76: aload_3
    //   77: invokestatic 870	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   80: aload 4
    //   82: astore_1
    //   83: aload_2
    //   84: ifnull -28 -> 56
    //   87: aload_2
    //   88: invokevirtual 865	java/io/BufferedInputStream:close	()V
    //   91: aconst_null
    //   92: areturn
    //   93: astore_1
    //   94: aload_1
    //   95: invokevirtual 868	java/io/IOException:printStackTrace	()V
    //   98: aconst_null
    //   99: areturn
    //   100: astore_3
    //   101: aconst_null
    ...
    //   108: ldc_w 774
    //   111: aload_3
    //   112: invokestatic 870	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   115: aload 4
    //   117: astore_1
    //   118: aload_2
    //   119: ifnull -63 -> 56
    //   122: aload_2
    //   123: invokevirtual 865	java/io/BufferedInputStream:close	()V
    //   126: aconst_null
    //   127: areturn
    //   128: astore_1
    //   129: aload_1
    //   130: invokevirtual 868	java/io/IOException:printStackTrace	()V
    //   133: aconst_null
    //   134: areturn
    //   135: astore_3
    //   136: aconst_null
    ...
    //   143: ldc_w 774
    //   146: aload_3
    //   147: invokestatic 870	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   150: aload 4
    //   152: astore_1
    //   153: aload_2
    //   154: ifnull -98 -> 56
    //   157: aload_2
    //   158: invokevirtual 865	java/io/BufferedInputStream:close	()V
    //   161: aconst_null
    //   162: areturn
    //   163: astore_1
    //   164: aload_1
    //   165: invokevirtual 868	java/io/IOException:printStackTrace	()V
    //   168: aconst_null
    //   169: areturn
    //   170: astore_2
    //   171: aconst_null
    ...
    //   174: ifnull +7 -> 181
    //   177: aload_1
    //   178: invokevirtual 865	java/io/BufferedInputStream:close	()V
    //   181: aload_2
    //   182: athrow
    //   183: astore_1
    //   184: aload_1
    //   185: invokevirtual 868	java/io/IOException:printStackTrace	()V
    //   188: goto -7 -> 181
    //   191: astore_2
    //   192: goto -19 -> 173
    //   195: astore_3
  ...
  {
    super.a();
    if (this.jdField_a_of_type_Bgdf != null) {
      bgde.a().b(this.jdField_a_of_type_Bgdf);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    for (paramIntent = ajjy.a(2131646563);; paramIntent = ajjy.a(2131646529))
    {
