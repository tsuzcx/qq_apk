...
public class bhmz
{
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", paramActivity.getString(2131690845));
    localIntent.putExtra("leftViewText", paramActivity.getString(2131690845));
  ...
  private static void b()
  {
    ...
    ((aogw)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.VIPINFO_HANDLER)).a(localQQAppInterface.getLongAccountUin());
  }
}
