...
public class aspz
{
  ...
  public static aspq a(String paramString)
  {
        ...
        try
        {
          ...
          if (i < j)
          {
            ...
            if (((String)localObject1).equals("align")) {
              ((aspr)localObject3).a(1, localObject4);
            }
            i += 1;
            continue;
          }
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        break label1192;
                        localObject5 = localObject1;
                        bool = a(paramString, (aspr)localObject3, localXmlPullParser);
                        localObject4 = paramString;
                        localObject3 = paramString;
                        paramString = (String)localObject1;
                        localObject1 = localObject3;
                        ...
                        {
                          localObject5 = localObject1;
                          if (((aspr)localObject4).a())
                          {
                            localObject5 = localObject1;
                            if (!TextUtils.isEmpty((CharSequence)localObject3))
                            {
                              localObject5 = localObject1;
                              ((aspr)localObject4).a(2, localObject3);
                              localObject3 = paramString;
                              paramString = (String)localObject1;
                              localObject1 = localObject3;
                              break label1154;
  ...
  public static MessageForUniteGrayTip a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, long paramLong2, long paramLong3, byte[] paramArrayOfByte)
  {
    ...
    {
      return null;
      localaspy = new aspy(paramString1, paramQQAppInterface.getCurrentAccountUin(), "", paramInt1, paramInt2, 655397, paramLong1);
      localObject1 = paramString2.a();
    } while (localObject1 == null);
    paramString2 = "";
    HashMap localHashMap = ((aspr)localObject1).a();
    ...
    {
      break;
      a(paramQQAppInterface, localaspy, (aspr)localObject1, paramInt1, paramString1);
      localObject1 = new MessageForUniteGrayTip();
      ((MessageForUniteGrayTip)localObject1).initGrayTipMsg(paramQQAppInterface, localaspy);
  ...
  private static void a(QQAppInterface paramQQAppInterface, aspy paramaspy, aspr paramaspr, int paramInt, String paramString)
  {
    if (paramaspy.jdField_a_of_type_JavaUtilArrayList != null) {
      paramaspy.jdField_a_of_type_JavaUtilArrayList.clear();
    }
    StringBuilder localStringBuilder = new StringBuilder();
    Iterator localIterator = paramaspr.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      paramaspr = (aspr)localIterator.next();
      Object localObject1;
      Object localObject2;
      Object localObject3;
      int j;
      int i;
      switch (paramaspr.jdField_a_of_type_Int)
      {
      default: 
        break;
      case 2: 
        paramaspr = paramaspr.a();
        localObject1 = paramaspr.keySet().iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (Integer)((Iterator)localObject1).next();
          localObject3 = paramaspr.get(localObject2);
      ...
      case 3: 
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          {
            localObject3 = (String)paramaspr.get(localObject3);
        ...
        paramaspy.a(j, i, (Bundle)localObject1);
        break;
      case 4: 
        localObject3 = paramaspr.a();
        ...
        if (((Iterator)localObject4).hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              paramaspr = (String)((HashMap)localObject3).get(localObject5);
            }
            else
            {
        ...
        if (((String)localObject1).equals(paramQQAppInterface.getCurrentAccountUin())) {
          paramaspr = alud.a(2131716293);
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
            QLog.e(jdField_a_of_type_JavaLangString, 2, "parseUniteGrayTipsContent name : " + paramaspr);
          }
          localStringBuilder.append(paramaspr);
          paramaspy.a(i, paramaspr.length() + i, (Bundle)localObject2);
          break;
          if (abti.d(paramInt)) {
            paramaspr = bdgc.j(paramQQAppInterface, (String)localObject1);
          } else if (abti.a(paramInt)) {
            paramaspr = bdgc.h(paramQQAppInterface, paramString, (String)localObject1);
          }
        }
      case 5: 
        paramaspr = paramaspr.a();
    ...
    paramaspy.jdField_c_of_type_JavaLangString = localStringBuilder.toString();
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    aspy localaspy = paramMessageForUniteGrayTip.tipParam;
    String str = paramMessageForUniteGrayTip.getExtInfoFromExtStr("bytes_content");
    if ((localaspy != null) && (localaspy.jdField_b_of_type_Int == 655397) && (!TextUtils.isEmpty(str))) {}
    try
    {
      a(paramQQAppInterface, localaspy, a(str).a(), paramMessageForUniteGrayTip.istroop, paramMessageForUniteGrayTip.frienduin);
      paramMessageForUniteGrayTip.msg = localaspy.jdField_c_of_type_JavaLangString;
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip, List<MessageRecord> paramList, int paramInt, String paramString, aspy paramaspy)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((localMessageRecord.msgtype != -1000) && (localMessageRecord.msgtype != -1051)) || (!bdil.a(localMessageRecord.issend)))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (paramInt == 1)
          {
            paramList = localMessageRecord.getExtInfoFromExtStr(ayzs.i);
            label243:
          ...
          else
          {
            try
            {
              ...
              paramList = localMessageRecord.getExtInfoFromExtStr(ayzs.j);
            }
    ...
    for (;;)
    {
      try
      {
        ...
        paramList.put(ayzs.k, localObject);
        paramList.put(ayzs.l, paramInt);
      ...
      if ((localStringBuilder != null) && (localStringBuilder.length() > 0))
      {
        ...
        localObject = BaseApplicationImpl.getApplication().getString(2131694590);
        paramString = paramString.concat(" ");
        j = paramString.length();
        k = ((String)localObject).length() + j;
        paramString = paramString.concat((String)localObject);
        paramaspy.jdField_c_of_type_JavaLangString = paramString;
        ...
        paramaspy.a(j, k, (Bundle)localObject);
        if (QLog.isColorLevel())
        {
          if (paramMessageForUniteGrayTip.editMsgData != null)
          {
            ...
            paramaspy = jdField_a_of_type_JavaLangString;
            ...
            QLog.d(paramaspy, 2, new Object[] { "revoke msg beding edit,time=", Long.valueOf(l1), ",wording=", paramString, ",msguid=", Long.valueOf(l2), ",uniseq=", Long.valueOf(l3), ",start =", Integer.valueOf(j), ",end=", Integer.valueOf(k), ",msgDta[0-2]=", paramList, ",msgGray.editMsgData.length=", Integer.valueOf(paramMessageForUniteGrayTip.editMsgData.length()), ",atString=", localJSONArray.toString() });
          }
        }
        else {
          azqs.b(paramQQAppInterface, "dc00898", "", "", "0X8008E55", "0X8008E55", 0, 0, "", "", "", "");
        }
      }
      label873:
      while (!QLog.isColorLevel()) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2, byte[] paramArrayOfByte)
  {
    ...
    //   3: ifeq +46 -> 49
    //   6: getstatic 16	aspz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   9: iconst_2
    //   10: ldc_w 663
    //   13: iconst_4
    ...
    //   49: lload_3
    //   50: lload 5
    //   52: invokestatic 672	bcgg:a	(JJ)Z
    //   55: ifeq +30 -> 85
    //   58: aload 7
    //   60: ifnull +25 -> 85
    //   63: iload_2
    ...
    //   75: checkcast 674	bcgc
    //   78: aload_1
    //   79: aload 7
    //   81: iconst_1
    //   82: invokevirtual 677	bcgc:a	(Ljava/lang/String;[BI)V
    //   85: ldc2_w 678
    //   88: lload 5
    //   90: lcmp
    //   91: ifne +130 -> 221
    ...
    //   297: ldc 187
    //   299: ldc 187
    //   301: invokestatic 570	azqs:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   304: return
    //   305: astore_0
    //   306: aload_0
    //   307: invokevirtual 728	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   310: getstatic 16	aspz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   313: iconst_1
    //   314: ldc_w 730
    //   317: aload_0
    ...
    //   321: return
    //   322: astore_0
    //   323: getstatic 16	aspz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   326: iconst_1
    //   327: ldc_w 732
    //   330: aload_0
    ...
    //   342: getstatic 16	aspz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   345: iconst_1
    //   346: ldc_w 730
    //   349: aload_0
    ...
    //   353: goto -132 -> 221
    //   356: astore_0
    //   357: getstatic 16	aspz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   360: iconst_1
    //   361: ldc_w 736
    //   364: aload_0
    ...
    //   398: ldc 187
    //   400: ldc 187
    //   402: invokestatic 570	azqs:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   405: return
    //   406: lconst_0
    //   407: lstore_3
    //   408: goto -260 -> 148
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, boolean paramBoolean1, boolean paramBoolean2, Bundle paramBundle)
  {
    ...
    Object localObject = (amdu)paramQQAppInterface.a(20);
    if (QLog.isColorLevel()) {
      QLog.d(".troop.joinSplitMsg", 2, "addFriendTipsMr troopUin=" + paramString);
    }
    ((amdu)localObject).a(paramString, paramBundle);
    int j;
    if (paramBoolean1)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    if (paramArrayOfByte == null)
    {
      ...
      ((amdu)localObject).j(paramArrayOfByte.troopuin);
      ((amdu)localObject).a(1, aloz.a(paramArrayOfByte.troopuin), 0L, 2, 0, 0, true);
    }
    for (;;)
    {
      ((amdu)localObject).a(paramArrayOfByte.troopuin, Boolean.valueOf(false));
      if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramQQAppInterface)
      {
        ...
        awzc.a().a((submsgtype0x122.MsgBody)localObject1, paramMsgInfo, paramQQAppInterface);
        return;
      }
      ...
      azqs.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", i, 0, "" + l2, "" + l1, "", "");
  ...
  private static boolean a(aspr paramaspr1, aspr paramaspr2, XmlPullParser paramXmlPullParser)
  {
    paramaspr1.a(paramaspr2);
    int j = paramXmlPullParser.getAttributeCount();
    int i = 0;
    if (i < j)
    {
      paramaspr2 = paramXmlPullParser.getAttributeName(i);
      String str = paramXmlPullParser.getAttributeValue(i);
      if (paramaspr2.equals("txt")) {
        paramaspr1.a(2, str);
      }
      for (;;)
      {
        i += 1;
        break;
        if (paramaspr2.equals("jp"))
        {
          paramaspr1.a(4, str);
        }
        else if (paramaspr2.equals("uin"))
        {
          paramaspr1.a(6, str);
        }
        else if (paramaspr2.equals("nm"))
        {
          paramaspr1.a(7, str);
        }
        else if (paramaspr2.equals("si"))
        {
          paramaspr1.a(3, str);
        }
        else if (paramaspr2.equals("col"))
        {
          paramaspr1.a(5, str);
        }
        else if (paramaspr2.equals("jp"))
        {
          paramaspr1.a(4, str);
        }
        else if (paramaspr2.equals("src"))
        {
          paramaspr1.a(8, str);
        }
        else
        {
          if (!paramaspr2.equals("align")) {
            break label225;
          }
          paramaspr1.a(1, str);
        }
      ...
      label225:
      if (QLog.isColorLevel()) {
        QLog.i("handleC2COnlinePushMsgGrayTipResp", 2, "parseXML, illegel field: " + paramaspr2);
      }
      return false;
    }
    return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    do
    {
      ...
      {
        return false;
        if (((paramMessageForUniteGrayTip.tipParam.jdField_a_of_type_Boolean) || (abti.h(paramMessageForUniteGrayTip.msgtype))) && ((paramMessageForUniteGrayTip.tipParam.jdField_c_of_type_Boolean) || (abti.i(paramMessageForUniteGrayTip.msgtype)))) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    if (paramMessageForUniteGrayTip != null)
    {
      ...
      if (paramMessageForUniteGrayTip.editState == 1)
      {
        ...
        else
        {
          ...
          StringBuilder localStringBuilder = new StringBuilder();
          String str = " " + BaseApplicationImpl.getApplication().getString(2131694590);
          ...
          if ((b != null) && (paramMessageForUniteGrayTip.uniseq == b.uniseq)) {
            azqs.b(paramQQAppInterface, "dc00898", "", "", "0X8008E55", "0X8008E55", 1, 0, "", "", "", "");
          }
          if ((b != null) && (paramMessageForUniteGrayTip.uniseq == b.uniseq)) {
            b = null;
          }
    ...
    do
    {
      do
      {
        do
        {
          ...
          bool1 = bool2;
          if (bcgg.a(paramLong1, paramLong2)) {
            if (!azmk.b())
            {
              bool1 = bool2;
      ...
      paramQQAppInterface = (aevz)aoks.a().a(609);
      bool2 = bool1;
