  ...
  extends ImageBase
{
  ...
  private rfw jdField_a_of_type_Rfw = new rfw();
  
  public qta(VafContext paramVafContext)
  {
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Rfw.a.a() == null) || (this.jdField_a_of_type_Rfw.a.a().mSocialFeedInfo == null) || (this.jdField_a_of_type_Rfw.a.a().mSocialFeedInfo.a == null))
    {
    ...
    int j = localResources.getDisplayMetrics().widthPixels - AIOUtils.dp2px(24.0F, localResources);
    int k = (int)(j * 0.598F);
    float f1 = localResources.getDisplayMetrics().density;
    int i;
    float f2;
    ViewGroup.LayoutParams localLayoutParams;
    if (this.jdField_a_of_type_Rfw.a.a().mSocialFeedInfo.a.a.size() > 0)
    {
      i = ((rrr)this.jdField_a_of_type_Rfw.a.a().mSocialFeedInfo.a.a.get(0)).a;
      int m = ((rrr)this.jdField_a_of_type_Rfw.a.a().mSocialFeedInfo.a.a.get(0)).b;
      f2 = AIOUtils.dp2px(i / 2, localResources);
      f1 = AIOUtils.dp2px(m / 2, localResources);
      i = ((rrr)this.jdField_a_of_type_Rfw.a.a().mSocialFeedInfo.a.a.get(0)).c;
    ...
    for (;;)
    {
      if (i == 1)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717913);
      }
      ...
      if ((f2 < j) && (f1 > k))
      {
        ...
        {
          f1 = k;
          f2 = AIOUtils.dp2px(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717914);
        }
        else
        {
          f2 *= k / f1;
      ...
      else if ((f2 > j) && (f1 < k))
      {
        ...
        {
          f2 = j;
          f1 = AIOUtils.dp2px(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717915);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        else
        {
