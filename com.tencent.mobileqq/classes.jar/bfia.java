...
public class bfia
{
  private static bfia jdField_a_of_type_Bfia;
  private ArrayList<bfib> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  public static bfia a()
  {
    ...
    try
    {
      ...
      return jdField_a_of_type_Bfia;
    }
    finally {}
  }
  
  public bfib a(long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      {
        bfib localbfib = (bfib)localIterator.next();
        if (localbfib.jdField_a_of_type_Long == paramLong)
        {
          this.jdField_a_of_type_JavaUtilArrayList.remove(localbfib);
          if (QLog.isColorLevel()) {
  ...
  public byte[] a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        localArrayList1.add(((bfib)localIterator.next()).jdField_a_of_type_AndroidContentIntent.getExtras());
      }
    }
