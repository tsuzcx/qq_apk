...
public class aywc
{
  ...
  public aywc(Settings paramSettings)
  {
  ...
  private void a(Rect paramRect)
  {
    ...
    if (!aywg.a(this.jdField_a_of_type_Float, 0.0F))
    {
  ...
  public aywc a(aywg paramaywg)
  {
    Object localObject = jdField_a_of_type_AndroidGraphicsRectF;
    aywi.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings, jdField_a_of_type_AndroidGraphicsRect);
    ...
    {
      this.jdField_a_of_type_Float = paramaywg.d();
      ...
      aywi.a(jdField_a_of_type_AndroidGraphicsMatrix, this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings, localRect);
      switch (aywd.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
    ...
    for (;;)
    {
      ...
      {
        paramaywg.a(jdField_a_of_type_AndroidGraphicsMatrix);
        paramaywg = jdField_a_of_type_AndroidGraphicsRectF;
        paramaywg.set(0.0F, 0.0F, this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.e(), this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.f());
        jdField_a_of_type_AndroidGraphicsMatrix.mapRect(paramaywg);
        localObject = jdField_a_of_type_ArrayOfFloat;
        jdField_a_of_type_ArrayOfFloat[1] = 0.0F;
        localObject[0] = 0.0F;
        jdField_a_of_type_AndroidGraphicsMatrix.mapPoints(jdField_a_of_type_ArrayOfFloat);
        this.jdField_b_of_type_AndroidGraphicsRectF.offset(jdField_a_of_type_ArrayOfFloat[0] - paramaywg.left, jdField_a_of_type_ArrayOfFloat[1] - paramaywg.top);
      }
      return this;
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, PointF paramPointF)
  {
    ...
    jdField_a_of_type_ArrayOfFloat[0] = aywj.a(jdField_a_of_type_ArrayOfFloat[0], this.jdField_b_of_type_AndroidGraphicsRectF.left - paramFloat3, this.jdField_b_of_type_AndroidGraphicsRectF.right + paramFloat3);
    jdField_a_of_type_ArrayOfFloat[1] = aywj.a(jdField_a_of_type_ArrayOfFloat[1], this.jdField_b_of_type_AndroidGraphicsRectF.top - paramFloat4, this.jdField_b_of_type_AndroidGraphicsRectF.bottom + paramFloat4);
    if (this.jdField_a_of_type_Float != 0.0F)
    {
      jdField_a_of_type_AndroidGraphicsMatrix.setRotate(this.jdField_a_of_type_Float, this.jdField_b_of_type_Float, this.c);
      jdField_a_of_type_AndroidGraphicsMatrix.mapPoints(jdField_a_of_type_ArrayOfFloat);
