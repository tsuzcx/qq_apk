...
{
  private static final String jdField_a_of_type_JavaLangString = bnoj.class.getSimpleName();
  ...
  public bnoj(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Bnol = new bnol();
    this.jdField_a_of_type_Bnol.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Bnol.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bnol.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bnol = null;
  ...
  {
    this.jdField_a_of_type_Bnol.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bnol.a("before updateTexImage");
