  ...
  extends nit
{
  public qqstory_struct.ErrorInfo a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      ...
      yqu.b("story_net", wzt.a, 0, paramInt, new String[] { "", l + "", yqu.a(BaseApplication.getContext()) });
      return null;
    }
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 0)
        {
          ...
          if (paramBundle.mErrorCode == 0) {
            ((wpj)wpm.a(5)).a(paramBundle.mVid, paramBundle);
          }
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        a(-1, null, null);
        return null;
        ((wfy)wpm.a(28)).b((List)localObject1);
