  ...
  implements View.OnClickListener
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = afpa.class.getSimpleName();
  }
  
  public afpa(BaseActivity paramBaseActivity, int paramInt, View paramView)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramBaseActivity);
    this.jdField_a_of_type_Int = paramInt;
    paramBaseActivity = paramView.findViewById(2131375703);
    IphoneTitleBarActivity.setLayerType(paramBaseActivity);
    paramView = paramBaseActivity.findViewById(2131363479);
    if (paramView != null) {
      paramView.setVisibility(8);
    }
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramBaseActivity.findViewById(2131365763));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBaseActivity.findViewById(2131378337));
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(awin.b());
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      awsq.a(null, i, 0, "0X8009D15", 0, 0, null, null);
