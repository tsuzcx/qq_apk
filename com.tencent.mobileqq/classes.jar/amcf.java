...
public class amcf
  extends Handler
{
  public amcf(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity) {}
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              QQSpecialFriendSettingActivity.a(this.a, new bisl(this.a, this.a.getTitleBarHeight()));
