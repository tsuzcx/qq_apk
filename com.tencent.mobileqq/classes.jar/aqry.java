  ...
  extends apap
{
  ...
  ArrayList<aqsa> jdField_a_of_type_JavaUtilArrayList;
  private Comparator<ColorNote> jdField_a_of_type_JavaUtilComparator = new aqrz(this);
  ...
  public aqry(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  private void a(int paramInt, ColorNote paramColorNote)
  {
    ...
    if (i < j)
    {
      ...
      ((aqsa)localArrayList.get(i)).a(paramColorNote);
    }
    for (;;)
    {
      i += 1;
      ...
      label62:
      if (paramInt == 2) {
        ((aqsa)localArrayList.get(i)).b(paramColorNote);
      }
    }
  }
      ...
      try
      {
        ...
        if (!paramList.isEmpty())
        {
          ...
          if (i >= 0)
          {
            ...
            if ((localColorNote.isOpen()) && (!aqsd.d(localColorNote))) {
              break label96;
            }
  ...
  protected void a()
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      aquy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), false, false);
    }
    localObject = aqrc.a();
    if ((localObject != null) && (((aqrb)localObject).a() != -1))
    {
      jdField_a_of_type_Int = ((aqrb)localObject).a();
      if (QLog.isColorLevel()) {
        QLog.e("ColorNoteConfigProcessor", 2, "init MAX_COUNT " + jdField_a_of_type_Int);
      }
    }
    aquy.a(BaseApplicationImpl.getContext(), 3, true);
  }
  ...
  public void a(aqsa paramaqsa)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramaqsa)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramaqsa);
    }
  }
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (localColorNote.equals(paramColorNote))
        {
          ...
          a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localColorNote.getUniKey(), "mExtLong", Long.valueOf(localColorNote.mExtLong));
        }
      }
      return;
    }
  ...
  {
    boolean bool = false;
    if ((!a(paramColorNote)) && (aquy.a())) {
      if (paramColorNote.getServiceType() == 16973824) {
        bdll.b(null, "dc00898", "", "", "0X800A746", "0X800A746", 0, 0, "", "", "", "");
      }
    }
    do
    {
    ...
    QLog.e("ColorNoteProxy", 2, "addColorNote error! isAfterSyncMsg = " + aquy.a());
    return false;
  }
  ...
  public void b(aqsa paramaqsa)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null) {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaqsa);
    }
  }
