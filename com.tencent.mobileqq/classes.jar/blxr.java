  ...
  extends DynamicTextItem
{
  ...
  public blxr(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap)
  {
  ...
  private void a(Typeface paramTypeface, Bitmap paramBitmap)
  {
    ...
    this.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(alud.a(2131705100)));
    this.f = a(27.0F);
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(this.f);
    this.c = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(alud.a(2131705099)));
    this.g = a(18.0F);
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(this.g);
    this.d = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(alud.a(2131705101)));
    this.k = a(0.0F);
    this.l = a(0.0F);
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new blxt(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = super.a(paramInt, new blxs(this));
