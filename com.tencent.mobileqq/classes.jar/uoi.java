...
public class uoi
{
  ...
  public uoi(@NonNull QQAppInterface paramQQAppInterface)
  {
  ...
  public Intent a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, Intent paramIntent)
  {
    ...
    Object localObject1 = (avpq)this.a.getManager(36);
    Object localObject2 = ((avpq)localObject1).a("103100.103500.103501");
    ...
    for (;;)
    {
      ...
      {
        ((avpq)localObject1).b("103100.103500.103501");
      ...
      for (;;)
      {
        ...
        boolean bool2 = axlc.a(this.a, BaseApplicationImpl.getContext());
        localObject1 = acxv.a(ssi.e);
        localObject2 = new File(ajsf.bj);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        return sxr.a(paramContext, paramBoolean2, paramIntent, paramBoolean1, bool1, bool2, (String)localObject1, this.a.getAccount());
        paramBoolean1 = false;
        break;
      }
      paramBoolean1 = false;
