...
{
  private agkh jdField_a_of_type_Agkh;
  ...
  public agki(NewStyleCountryActivity paramNewStyleCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    paramContext = (Button)findViewById(2131363479);
    paramContext.setVisibility(0);
    paramContext.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131375189);
    ...
    findViewById(2131375713).setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)findViewById(2131375735));
    this.jdField_a_of_type_Agkh = new agkh(paramNewStyleCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Agkh);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Agkh.a(paramString);
    if (this.jdField_a_of_type_Agkh.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Agkh.notifyDataSetChanged();
      return;
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 206	zzp:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 206	zzp:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 206	zzp:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
