...
public class sfm
{
  ...
  public static Readinjoy.ArticleSummary a(BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramBaseVideoArticleInfo)
      {
        ...
        QLog.e("VideoProtoHelper", 0, "videoArticleinfoCovert2LocalPB error:" + pha.a(paramBaseVideoArticleInfo));
      }
  ...
  public static Readinjoy.VideoData a(riq paramriq)
  {
    Object localObject;
    if (paramriq == null) {
      localObject = null;
    ...
    do
    {
      ...
      localVideoData.uint32_busi_type.set(paramriq.jdField_a_of_type_Int);
      localVideoData.uint32_duration.set(paramriq.jdField_b_of_type_Int);
      localVideoData.uint32_width.set(paramriq.c);
      localVideoData.uint32_height.set(paramriq.d);
      if (!TextUtils.isEmpty(paramriq.jdField_a_of_type_JavaLangString)) {
        localVideoData.bytes_vid.set(ByteStringMicro.copyFromUtf8(paramriq.jdField_a_of_type_JavaLangString));
      }
      localVideoData.uint32_file_size.set(paramriq.e);
      localObject = localVideoData;
    } while (TextUtils.isEmpty(paramriq.jdField_b_of_type_JavaLangString));
    localVideoData.bytes_video_url.set(ByteStringMicro.copyFromUtf8(paramriq.jdField_b_of_type_JavaLangString));
    return localVideoData;
  }
  
  public static riq a(Readinjoy.VideoData paramVideoData)
  {
    ...
    do
    {
      ...
      if (paramVideoData.uint32_busi_type.has()) {
        localriq.jdField_a_of_type_Int = paramVideoData.uint32_busi_type.get();
      }
      if (paramVideoData.uint32_duration.has()) {
        localriq.jdField_b_of_type_Int = paramVideoData.uint32_duration.get();
      }
      if (paramVideoData.uint32_width.has()) {
        localriq.c = paramVideoData.uint32_width.get();
      }
      if (paramVideoData.uint32_height.has()) {
        localriq.d = paramVideoData.uint32_height.get();
      }
      if (paramVideoData.bytes_vid.has()) {
        localriq.jdField_a_of_type_JavaLangString = paramVideoData.bytes_vid.get().toStringUtf8();
      }
      if (paramVideoData.uint32_file_size.has()) {
        localriq.e = paramVideoData.uint32_file_size.get();
      }
      localObject = localriq;
    } while (!paramVideoData.bytes_video_url.has());
    localriq.jdField_b_of_type_JavaLangString = paramVideoData.bytes_video_url.get().toStringUtf8();
    return localriq;
  }
}
