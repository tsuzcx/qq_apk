  ...
  implements tgs, tgx
{
  ...
  private qfj jdField_a_of_type_Qfj = new ths(this);
  ...
  public tgr a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new tht(paramViewGroup, paramBaseData);
  }
  ...
  public void b()
  {
    if (jdField_a_of_type_Boolean)
    {
      ...
      if (localqfg != null) {
        localqfg.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, this.jdField_a_of_type_Qfj, false);
      }
    }
  }
  ...
  public void d()
  {
    qfg localqfg = pvj.a().a();
    if (localqfg != null) {
      localqfg.a(this.jdField_a_of_type_Qfj);
    }
  }
