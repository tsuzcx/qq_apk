  ...
  implements Handler.Callback, AdapterView.OnItemClickListener
{
  ...
  public sxb(Activity paramActivity)
  {
    ...
    this.jdField_b_of_type_Int = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299076);
  ...
  private void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        a(this.jdField_a_of_type_Zon, this.jdField_a_of_type_Boolean, paramBoolean);
        return;
      }
    }
  ...
  protected int a()
  {
    ...
    while (WXShareHelper.getInstance().isWXsupportApi()) {
      return i;
    }
    return 2131719723;
  }
  ...
  {
    paramString = sxa.a(paramString, this.jdField_d_of_type_Int, this.jdField_c_of_type_JavaLangString, "QRCode_");
  ...
  public bhht a()
  {
    ...
    {
      this.jdField_a_of_type_Bhht = new bhht(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int);
  ...
  public String a()
  {
    String str2 = BaseApplicationImpl.getApplication().getString(2131718364);
    String str1 = str2;
    try
    {
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      return;
      WXShareHelper.getInstance().shareImageToWX(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_AndroidGraphicsBitmap, paramInt2, false);
    }
  }
  ...
  protected void a(zon paramzon, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (!paramBoolean1)
    {
      paramzon.d(new sxc(this, paramBoolean2));
      return;
    }
    if (paramBoolean2) {}
    for (int i = 3;; i = 2)
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695878);
    ...
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695891);
    ...
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695898);
    localActionSheetItem.icon = 2130839130;
    localActionSheetItem.action = 9;
    localActionSheetItem.argus = "";
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695881);
    localActionSheetItem.icon = 2130839124;
    localActionSheetItem.action = 10;
    localActionSheetItem.argus = "";
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695895);
    localActionSheetItem.icon = 2130839129;
  ...
  public void b()
  {
    ...
    if ((ugf.b(this.jdField_c_of_type_JavaLangString)) && (!TextUtils.isEmpty(a()))) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        return;
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getContext().getString(2131718400));
      }
      catch (Exception localException)
      {
        for (;;)
  ...
  public void c()
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      QZoneHelper.forwardToPublishMood(this.jdField_a_of_type_AndroidAppActivity, localUserInfo, this.jdField_a_of_type_JavaLangString, BaseApplicationImpl.getContext().getString(2131719667), "", -1);
      return;
    }
  ...
  public void d(String paramString)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
    {
      ...
      str = BaseApplicationImpl.getContext().getResources().getString(2131694796);
      label115:
    ...
    for (paramString = paramString.concat("|1");; paramString = paramString.concat("|0"))
    {
      ...
      localIntent.putExtra("brief_key", amtj.a(2131712693));
  ...
  public void g()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = BaseApplicationImpl.getContext().getResources().getString(2131694796);
      ...
      catch (PackageManager.NameNotFoundException localNameNotFoundException)
      {
        ...
        this.jdField_a_of_type_Bhht.dismiss();
        QQToast.a(BaseApplicationImpl.getContext(), 0, 2131694802, 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299076));
        continue;
      }
      if (QLog.isColorLevel()) {
