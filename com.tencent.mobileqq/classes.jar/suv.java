...
public class suv
{
  ...
  private suv()
  {
    ...
    this.jdField_a_of_type_JavaUtilComparator = new suw(this);
  ...
  private List<TroopBarData> a(QQAppInterface paramQQAppInterface, List<TroopBarData> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (ssp.d(paramQQAppInterface, localTroopBarData.mUin)) {
  ...
  {
    if (!ssp.d(paramQQAppInterface, paramString)) {
      return;
    }
        ...
        if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue())
        {
          ...
          try
          {
            ...
            if (i < ((JSONArray)localObject).length())
            {
              ...
              if (!ssp.d(paramQQAppInterface, str)) {
                continue;
              }
  ...
  {
    return (paramInt == 1008) && (ssp.d(paramQQAppInterface, paramString));
  }
  ...
  public List<sut> b(QQAppInterface paramQQAppInterface)
  {
    a(paramQQAppInterface);
    Object localObject1 = new ArrayList();
    Object localObject3;
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = sut.a(paramQQAppInterface, paramQQAppInterface.getApplication().getApplicationContext(), (TroopBarData)localObject3);
  ...
  public List<PublicAccountInfo> c(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (ssp.d(paramQQAppInterface, localPublicAccountInfo.getUin())) {
