...
public class alol
  implements ajds
{
  public alol(FrameHelperActivity paramFrameHelperActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    ajds[] arrayOfajds = this.a.jdField_a_of_type_ArrayOfAjds;
    int j = arrayOfajds.length;
    while (i < j)
    {
      ajds localajds = arrayOfajds[i];
      if (localajds != null) {
        localajds.a(paramInt);
      }
      i += 1;
    }
    this.a.d(true);
  ...
  public void a(int paramInt, float paramFloat)
  {
    ...
    if ((!this.a.getActivity().isFinishing()) && (FrameHelperActivity.a(this.a) != null) && (bhnz.a()))
    {
      localObject1 = FrameHelperActivity.a(this.a).a(bhnz.a);
      if (localObject1 != null) {
        ((bhxu)localObject1).c();
      }
    }
    if (Build.VERSION.SDK_INT >= 11) {}
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAjds;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      if (Build.VERSION.SDK_INT < 11) {}
      localObject1 = this.a.jdField_a_of_type_ArrayOfAjds;
      int j = localObject1.length;
      int i = 0;
      while (i < j)
      {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      ajds localajds = arrayOfajds[i];
      if (localajds != null) {
        localajds.a(paramInt, paramBoolean);
      }
      i += 1;
    }
    if (paramBoolean) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.jdField_a_of_type_AndroidViewViewGroup != null) {
      ((ImageView)this.a.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379276)).setImageResource(0);
    }
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAjds;
    int j = localObject1.length;
    int i = 0;
