...
public abstract class blxp
  extends Binder
  implements blxo
{
  public static blxo a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qappcenter.remote.IActionListener");
    if ((localIInterface != null) && ((localIInterface instanceof blxo))) {
      return (blxo)localIInterface;
    }
    return new blxq(paramIBinder);
  }
