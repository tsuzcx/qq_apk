...
public class pkz
{
  ...
  static
  {
    Aladdin.registerConfigHandler(111, new plg());
    Aladdin.registerConfigHandler(112, new pmk());
    Aladdin.registerConfigHandler(116, new pml());
    Aladdin.registerConfigHandler(117, new plh());
    Aladdin.registerConfigHandler(119, new pmm());
    Aladdin.registerConfigHandler(156, new plx());
    Aladdin.registerConfigHandler(121, new KandianReportDataConfigHandler());
    Aladdin.registerConfigHandler(122, new pln());
    Aladdin.registerConfigHandler(123, new plu());
    Aladdin.registerConfigHandler(124, new pmj());
    Aladdin.registerConfigHandler(127, new pls());
    Aladdin.registerConfigHandler(131, new plr());
    Aladdin.registerConfigHandler(133, new pmg());
    Aladdin.registerConfigHandler(132, new ply());
    Aladdin.registerConfigHandler(134, new plq());
    Aladdin.registerConfigHandler(135, new plm());
    Aladdin.registerConfigHandler(138, new AwesomeCommentConfigHandler());
    Aladdin.registerConfigHandler(142, new plv());
    Aladdin.registerConfigHandler(147, new plc());
    Aladdin.registerConfigHandler(148, new pld());
    Aladdin.registerConfigHandler(149, new plt());
    Aladdin.registerConfigHandler(155, new plp());
    Aladdin.registerConfigHandler(162, new plj());
    Aladdin.registerConfigHandler(170, new pli());
    Aladdin.registerConfigHandler(181, new plk());
    Aladdin.registerConfigHandler(182, new SimpleConfigHandler());
    Aladdin.registerConfigHandler(185, new ugw());
    Aladdin.registerConfigHandler(187, new orm());
    Aladdin.registerConfigHandler(188, new ugw());
    Aladdin.registerConfigHandler(157, new pll());
    Aladdin.registerConfigHandler(191, new pmi());
    Aladdin.registerConfigHandler(200, new uhb());
    Aladdin.registerConfigHandler(202, new pmf());
    Aladdin.registerConfigHandler(211, new pmn());
    Aladdin.registerConfigHandler(219, new plw());
    Aladdin.registerConfigHandler(221, new plo());
    Aladdin.registerConfigHandler(197, new pmo());
    Aladdin.registerConfigHandler(247, new pms());
    Aladdin.registerConfigHandler(244, new pmb());
    Aladdin.registerConfigHandler(274, new SimpleConfigHandler());
    Aladdin.registerConfigHandler(280, new pme());
    Aladdin.registerConfigHandler(282, new pmp());
    Aladdin.registerConfigHandler(287, new pmt());
    Aladdin.registerConfigHandler(290, new pmh());
    Aladdin.registerConfigHandler(304, new pmd());
    Aladdin.registerConfigHandler(305, new pmc());
    Aladdin.registerConfigHandler(346, new pmq());
    Aladdin.registerConfigHandler(360, new plz());
    Aladdin.registerConfigHandler(369, new ple());
  }
  ...
  {
    Aladdin.initialize(Aladdin.InitParams.newBuilder().withUserId(pkh.a()).withAppVersion("8.4.10").withContext(BaseApplicationImpl.getContext()).withExecutor(plb.a).withRequestHandler(new pkx()).withAppFlavorId(AppSetting.a() + "").withLogger(new pkv()).build());
    d();
    e();
  ...
  {
    SpUtils.registerAladdinSharedPreferences(new pla());
  }
