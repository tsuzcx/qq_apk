...
public class pkz
{
  private static final Map<Integer, qft> a = new HashMap();
  ...
  {
    bkpj.a("ProteusSupportUtilDynamic.getView");
    ...
    {
      localContainer.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841683));
  ...
  private static TemplateBean a(int paramInt, BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    //   96: aload_2
    //   97: iconst_1
    //   98: invokestatic 150	teh:a	(Ljava/lang/String;Z)Lteh;
    //   101: astore_1
    //   102: aload_1
    //   103: ifnull +12 -> 115
    //   106: aload_1
    //   107: aload 4
    //   109: invokevirtual 154	teh:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   112: astore_1
    //   113: aload_1
    //   114: areturn
    //   115: aconst_null
  ...
  private static TemplateBean a(VafContext paramVafContext, String paramString1, String paramString2)
  {
    ...
    teh localteh = (teh)paramVafContext.getTemplateFactory();
    paramVafContext = localteh;
    if (localteh == null) {
      paramVafContext = teh.a(paramString2, true);
    }
    ...
    for (;;)
    {
      try
      {
        paramVafContext = paramVafContext.getTemplateBean(localqba.a(paramString1).a());
  ...
  private static void a(int paramInt, qft paramqft)
  {
    ...
    a.put(Integer.valueOf(paramInt), paramqft);
  }
  ...
  {
    bkpj.a("ProteusSupportUtilDynamic.bindData");
    ...
    paramProteusItemView.setTag(2131376063, paramString);
    bkpj.a("ProteusSupportUtilDynamic.bindDataImpl");
    if (paramString != null) {
      pfr.a(paramProteusItemView, localTemplateBean, paramString);
    }
    bkpj.a();
    pfr.a(paramProteusItemView, paramVafContext, paramString);
    bkpj.a();
  }
