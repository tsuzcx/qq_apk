  ...
  implements BusinessObserver
{
  ...
  private aknf jdField_a_of_type_Aknf = new aknf();
  private FrameLayout jdField_a_of_type_AndroidWidgetFrameLayout;
  private benb jdField_a_of_type_Benb = new benb();
  ...
  private void a(int paramInt)
  {
    try
    {
      azqs.b(null, "P_CliOper", "Safe_Antiphishing", "", "AlertDialog", "UserChoose", 0, paramInt, "", "", "", "");
      return;
    }
  ...
  private boolean a(Context paramContext, String paramString, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetFrameLayout == null) && (this.mRuntime != null) && (this.mRuntime.a() != null)) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.mRuntime.a().findViewById(2131362593));
    }
    if ((this.jdField_a_of_type_Benb != null) && (this.jdField_a_of_type_AndroidWidgetFrameLayout != null))
    {
      this.jdField_a_of_type_Benb.a(2131720884, 3000, this.jdField_a_of_type_AndroidWidgetFrameLayout);
      this.jdField_a_of_type_Benb.a(paramString);
      return true;
    }
    return false;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        a(this.jdField_a_of_type_JavaLangString, 2, " Is QQ Domain, input url  : " + ndq.b(paramString, new String[0]) + " Domain = " + str1);
      }
      if ((str1.endsWith("qq.com")) || (str1.endsWith("tencent.com")) || (str1.endsWith("imqq.com")) || (str1.endsWith("wanggou.com")) || (str1.endsWith("paipai.com")) || (str1.endsWith("tenpay.com")) || (str1.endsWith("yixun.com")) || (str1.endsWith("weiyun.com")) || (str1.endsWith("soso.com")) || (str1.endsWith("myapp.com")) || (str1.endsWith("wechat.com")) || (str1.endsWith("gaopeng.com")) || (str1.endsWith("pengyou.com")) || (str1.endsWith("51buy.com")) || (str1.endsWith("weishi.com")) || (str1.endsWith("qqumall.com")) || (str1.endsWith("vip.surex.cn")))
      {
        ...
        if (!a())
        {
          ...
          {
            bool2 = bool1;
            if (this.jdField_a_of_type_Aknf != null)
            {
              ArrayList localArrayList = this.jdField_a_of_type_Aknf.a();
              bool2 = bool1;
  ...
  private boolean a(String paramString, akne paramakne)
  {
    if (paramString == null) {
      return false;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      do
      {
        ...
        {
          paramakne.jdField_a_of_type_JavaLangString = ((String)localObject);
          paramakne.jdField_a_of_type_Int = 1;
          return true;
        }
      } while ((i != 1) || (!str.contains((CharSequence)localObject)));
      paramakne.jdField_a_of_type_JavaLangString = ((String)localObject);
      paramakne.jdField_a_of_type_Int = 2;
      return true;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, Long paramLong, int paramInt5)
  {
    ...
    for (;;)
    {
      ...
      {
        paramLong = new NewIntent(this.mRuntime.a().getApplicationContext(), mzx.class);
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    label121:
    for (Object localObject2 = null;; localObject2 = new aknd(this))
    {
      bdgm.a(localActivity, 230, paramString1, paramString2, paramString3, paramString4, (DialogInterface.OnClickListener)localObject1, (DialogInterface.OnClickListener)localObject2).show();
      return;
      localObject1 = new aknc(this);
      break;
    }
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    do
    {
      ...
      localakne = new akne(this);
      if (a(paramString1, localakne)) {
        break;
      }
    ...
    try
    {
      long l = Long.parseLong(localakne.jdField_a_of_type_JavaLangString);
      ...
      a(i, j, k, (int)f, paramString2, Long.valueOf(l), localakne.jdField_a_of_type_Int);
      return true;
    }
  ...
  {
    aknf localaknf = this.jdField_a_of_type_Aknf;
    String str = a();
    ...
    {
      localaknf.a(str, (Context)localObject);
      return;
    }
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      str = localContext.getString(2131719630);
      localObject1 = localContext.getString(2131719629);
      localObject3 = localContext.getString(2131719628);
      localObject2 = localContext.getString(2131719627);
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 2)
        {
          ...
          this.jdField_a_of_type_Aknf.a(paramInt, paramBundle, (String)localObject1, localContext);
          return;
        }
      }
