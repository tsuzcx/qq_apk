...
public final class aiyx
  implements aizh, Handler.Callback, INetInfoHandler
{
  ...
  public aiyx(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (this.jdField_a_of_type_Aiyy == null)
    {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.2.8");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Aiyy.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Aiyy.b);
    ...
    try
    {
      paramString = ajae.a(paramString, this.jdField_a_of_type_Aiyy.jdField_a_of_type_JavaLangString);
  ...
  {
    ((airz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Aiyy.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Aiyy.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    aizj localaizj = new aizj();
    localaizj.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Aiyy.jdField_a_of_type_JavaUtilList;
    localaizj.jdField_a_of_type_Int = this.jdField_a_of_type_Aiyy.jdField_a_of_type_Int;
    localaizj.b = 10000;
    localaizj.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localaizj);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localaizj);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        this.b = true;
        if (!bbev.e(BaseApplicationImpl.getApplication().getApplicationContext()))
        {
        ...
        {
          ((bbqp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).e();
        }
      }
      finally {}
    }
  ...
  public void a(aiyy paramaiyy)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Aiyy = paramaiyy;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Bfnk.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Bfnk.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = ajae.b((byte[])localObject, this.jdField_a_of_type_Aiyy.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = bbev.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.jdField_a_of_type_Bfnk.removeMessages(7);
      this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Aiyy });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aiyy != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Bfnk.removeMessages(1);
        this.jdField_a_of_type_Bfnk.removeMessages(2);
        this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int <= 2))
    {
      ...
      this.jdField_a_of_type_Bfnk.removeMessages(1);
      this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(1, 10000L);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 5: 
      ...
      if ((paramMessage.obj != null) && (((Boolean)paramMessage.obj).booleanValue()))
      {
        ...
        this.jdField_a_of_type_Aiyy = null;
      }
      i();
      return false;
    case 7: 
    ...
    bcpw.a(BaseApplicationImpl.getContext(), (String)paramMessage.obj, 0).a();
    return false;
  }
  ...
  public void onNetMobile2Wifi(String paramString)
  {
    ...
    this.jdField_a_of_type_Bfnk.removeMessages(5);
    this.jdField_a_of_type_Bfnk.sendEmptyMessage(5);
  }
