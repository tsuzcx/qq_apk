  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      if (SosoInterface.a() >= 12)
      {
        ...
        paramString = amyp.a();
        awrn.a(BaseApplicationImpl.getContext()).a(paramString, "actSoSoNoCityCodeTimeout", true, 0L, 0L, paramTencentLocation, "");
      }
    ...
    if (SosoInterface.a() > 0)
    {
      ...
      localObject2 = amyp.a();
      awrn.a(BaseApplicationImpl.getContext()).a((String)localObject2, "actSoSoNoCityCode", true, 0L, 0L, (HashMap)localObject1, "");
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool3)
        {
          ...
          localObject4 = (akgd)SosoInterface.a().get(j);
          if ((((akgd)localObject4).reqLocation == bool3) && ((!((akgd)localObject4).reqLocation) || (((akgd)localObject4).level <= k)))
          {
            if (!((akgd)localObject4).uiThread) {
              continue;
            }
            SosoInterface.a((akgd)localObject4, paramInt, (SosoInterface.SosoLbsInfo)localObject5);
            ...
            if (!((akgd)localObject4).goonListener) {
              break label1054;
            }
            if (QLog.isColorLevel()) {
              QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akgd)localObject4).tag + " goon...");
            }
          }
          if (akgd.access$1500((akgd)localObject4)) {
            break label1820;
          }
          if (!((akgd)localObject4).goonListener) {
            break label1135;
          ...
          label872:
          if (!akgd.access$1600((akgd)localObject4)) {
            break label1814;
          }
          ...
          ((akgd)localObject4).onConsecutiveFailure(paramInt, SosoInterface.d());
        ...
        continue;
        ((akgd)localObject4).onLocationFinish(paramInt, (SosoInterface.SosoLbsInfo)localObject5);
        continue;
        if (str.equals(((akgd)localObject4).tag)) {
          break label1833;
        }
      }
      finally {}
      ...
      akgd.access$1502((akgd)localObject4, true);
      if (QLog.isColorLevel())
      {
        QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akgd)localObject4).tag + " removed normally.");
        continue;
        label1115:
        if (((akgd)localObject3).level >= ((akgd)localObject4).level) {
          break label1817;
        }
        localObject3 = localObject4;
      }
    ...
    label1135:
    if (SystemClock.elapsedRealtime() - ((akgd)localObject4).sTime > 30000L)
    {
      SosoInterface.a().remove(j);
      akgd.access$1502((akgd)localObject4, true);
      if (((akgd)localObject4).reqLocation)
      {
        localObject6 = SosoInterface.a(((akgd)localObject4).level, true);
        break label1839;
        ((akgd)localObject4).onLocationFinish(i, (SosoInterface.SosoLbsInfo)localObject6);
        if (!QLog.isColorLevel()) {
          break label1852;
        }
        QLog.d("SOSO.LBS", 2, "lis=" + ((akgd)localObject4).tag + " err_timeout.reqRaw=" + ((akgd)localObject4).reqLocation + ". Force 2 remove it.");
        break label1852;
      }
      else
      {
    ...
    else if (((akgd)localObject4).reqLocation)
    {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akgd)localObject4).tag + " goon=" + ((akgd)localObject4).goonListener + " reqLocation=" + ((akgd)localObject4).reqLocation + " hasReqRaw=" + bool1);
        break label1871;
        if (((akgd)localObject1).level < ((akgd)localObject4).level)
        {
          ...
          if (m != 0)
          {
            ...
            for (paramTencentLocation = "";; paramTencentLocation = " goonLis been truncated:" + localObject7.tag)
            {
              ...
              if (localObject4 != null) {
                akgd.access$1602((akgd)localObject4, false);
              }
          ...
          if (localObject6 != null)
          {
            ...
            for (paramTencentLocation = "";; paramTencentLocation = " goonLis been truncated:" + localObject7.tag)
            {
              QLog.d("SOSO.LBS", 2, paramTencentLocation + " start:" + ((akgd)localObject6).tag);
              if (localObject4 != null) {
                akgd.access$1602((akgd)localObject4, false);
              }
              SosoInterface.d();
              ((akgd)localObject6).maxCacheInterval = 0L;
              SosoInterface.a((akgd)localObject6);
              return;
            }
          }
          if (localObject7 == null) {
          ...
          if ((akgd.access$1600(localObject7)) || (akgd.access$1500(localObject7))) {
            break;
          }
          SosoInterface.d();
  ...
  public void onStatusUpdate(String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      synchronized (SosoInterface.a())
      {
        ...
        localakgd = (akgd)SosoInterface.a().get(i);
        if (localakgd == null) {
          break label161;
        }
        if (localakgd.uiThread) {
          ThreadManager.getUIHandler().post(new SosoInterface.3.1(this, localakgd, paramString1, paramInt, paramString2));
        }
      }
      localakgd.onStatusUpdate(paramString1, paramInt, paramString2);
      break label161;
      label157:
      return;
      label161:
