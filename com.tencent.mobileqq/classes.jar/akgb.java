  ...
  implements Manager
{
  ...
  public akgb(QQAppInterface paramQQAppInterface)
  {
  ...
  public java.util.ArrayList<SearchHistory> a()
  {
    ...
    //   7: astore 7
    //   9: aload_0
    //   10: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: bipush 51
    //   15: invokevirtual 86	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   18: checkcast 88	ajxl
    //   21: astore 8
    //   23: aload_0
    //   24: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   27: bipush 52
    ...
    //   35: astore 9
    //   37: aload_0
    //   38: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: bipush 11
    ...
    //   49: astore 10
    //   51: aload_0
    //   52: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   55: iconst_0
    //   56: ldc 138
    ...
    //   66: ldc 145
    //   68: aconst_null
    //   69: invokevirtual 150	aukp:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   72: astore 6
    //   74: iconst_0
    //   75: istore_3
    //   76: aload 6
    ...
    //   409: ifeq +538 -> 947
    //   412: aload_0
    //   413: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   416: ldc 138
    //   418: aload 11
    //   420: getfield 167	com/tencent/mobileqq/data/SearchHistory:key	Ljava/lang/String;
    //   423: invokevirtual 213	aukp:a	(Ljava/lang/Class;Ljava/lang/String;)Lauko;
    //   426: checkcast 138	com/tencent/mobileqq/data/SearchHistory
    //   429: astore 11
    //   431: aload 11
    //   433: ifnull +13 -> 446
    //   436: aload_0
    //   437: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   440: aload 11
    //   442: invokevirtual 216	aukp:b	(Lauko;)Z
    //   445: pop
    //   446: iload_3
    //   447: iconst_1
    //   448: iadd
    ...
    //   486: invokevirtual 225	ajxl:b	(Ljava/lang/String;)Z
    //   489: ifne +524 -> 1013
    //   492: iconst_1
    //   493: istore_1
    //   494: goto +521 -> 1015
    ...
    //   504: invokevirtual 225	ajxl:b	(Ljava/lang/String;)Z
    //   507: ifeq +5 -> 512
    //   510: iconst_1
    //   511: istore_1
    //   512: aload 11
    ...
    //   523: aload_0
    //   524: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   527: bipush 52
    ...
    //   580: aload_0
    //   581: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   584: bipush 53
    //   586: invokevirtual 86	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   589: checkcast 233	ajvi
    //   592: aload 11
    //   594: getfield 179	com/tencent/mobileqq/data/SearchHistory:troopUin	Ljava/lang/String;
    //   597: invokevirtual 236	ajvi:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/DiscussionInfo;
    //   600: astore 12
    //   602: aload 12
    //   604: ifnull +421 -> 1025
    //   607: aload 12
    ...
    //   641: goto +374 -> 1015
    //   644: aload_0
    //   645: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   648: bipush 53
    //   650: invokevirtual 86	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   653: checkcast 233	ajvi
    //   656: aload 11
    //   658: getfield 175	com/tencent/mobileqq/data/SearchHistory:uin	Ljava/lang/String;
    //   661: invokevirtual 236	ajvi:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/DiscussionInfo;
    //   664: astore 12
    //   666: aload 12
    //   668: ifnull +362 -> 1030
    //   671: aload 12
    ...
    //   687: getstatic 252	ajsd:az	Ljava/lang/String;
    //   690: invokestatic 256	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   693: ifeq +347 -> 1040
    //   696: aload_0
    //   697: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   700: invokestatic 261	bhvy:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   703: ifeq +6 -> 709
    //   706: goto +334 -> 1040
    //   709: aload 11
    //   711: aload_0
    //   712: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   715: invokestatic 264	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   718: invokestatic 269	sfe:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Context;)Ljava/lang/String;
    //   721: putfield 171	com/tencent/mobileqq/data/SearchHistory:displayName	Ljava/lang/String;
    //   724: iconst_0
    //   725: istore_1
    //   726: goto +289 -> 1015
    //   729: aload_0
    //   730: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   733: invokestatic 261	bhvy:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   736: ifeq +309 -> 1045
    //   739: invokestatic 272	bhvy:k	()Z
    //   742: ifeq +6 -> 748
    //   745: goto +300 -> 1045
    //   748: aload 11
    //   750: aload_0
    //   751: getfield 23	akgb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   754: invokestatic 264	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   757: invokestatic 274	sfe:c	(Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Context;)Ljava/lang/String;
  ...
  public void a(SearchHistory paramSearchHistory)
  {
    ...
    //   147: invokespecial 304	akgb:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   160: aload_1
    //   161: ldc_w 305
    //   164: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   197: aload_0
    //   198: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   201: ldc 138
    //   203: aload_1
    //   204: getfield 167	com/tencent/mobileqq/data/SearchHistory:key	Ljava/lang/String;
    //   207: invokevirtual 213	aukp:a	(Ljava/lang/Class;Ljava/lang/String;)Lauko;
    ...
    //   279: aload_0
    //   280: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   283: aload_2
    //   284: invokevirtual 311	aukp:a	(Lauko;)Z
    //   287: pop
    //   288: return
    //   289: aload_1
    //   290: ldc_w 312
    //   293: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   329: aload_1
    //   330: ldc_w 313
    //   333: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   369: aload_1
    //   370: ldc_w 314
    //   373: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   409: aload_1
    //   410: ldc_w 315
    //   413: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   449: aload_1
    //   450: ldc_w 316
    //   453: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   489: aload_1
    //   490: ldc_w 317
    //   493: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   582: aload_1
    //   583: ldc_w 319
    //   586: invokestatic 309	ajya:a	(I)Ljava/lang/String;
    ...
    //   619: goto -422 -> 197
    //   622: aload_0
    //   623: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   626: iconst_0
    //   627: ldc 138
    ...
    //   637: ldc_w 321
    //   640: aconst_null
    //   641: invokevirtual 150	aukp:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   644: astore_3
    //   645: aload_3
    //   646: ifnull +173 -> 819
    //   649: aload_3
    ...
    //   691: astore_2
    //   692: aload_0
    //   693: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   696: ldc 138
    //   698: aload 4
    //   700: invokevirtual 213	aukp:a	(Ljava/lang/Class;Ljava/lang/String;)Lauko;
    ...
    //   797: astore_2
    //   798: aload_0
    //   799: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   802: aload 4
    //   804: invokevirtual 311	aukp:a	(Lauko;)Z
    //   807: pop
    //   808: aload_3
    //   809: ifnull -669 -> 140
    //   812: aload_3
    ...
    //   820: astore_2
    //   821: aload_0
    //   822: getfield 37	akgb:jdField_a_of_type_Aukp	Laukp;
    //   825: aload_1
    //   826: invokevirtual 328	aukp:a	(Lauko;)V
    //   829: goto -21 -> 808
    //   832: astore_1
    //   833: aload_3
    //   834: astore_2
  ...
  public boolean a(SearchHistory paramSearchHistory)
  {
    ...
    if (paramSearchHistory != null)
    {
      ...
      bool = this.jdField_a_of_type_Aukp.b(paramSearchHistory);
    }
    return bool;
  }
