...
public class barq
{
  ...
  public static java.lang.Boolean a(String paramString1, String paramString2)
  {
    ...
    //   6: astore 5
    //   8: aload_1
    //   9: invokestatic 14	com/tencent/mobileqq/filemanager/util/FileUtil:isFileExists	(Ljava/lang/String;)Z
    //   12: ifeq +8 -> 20
    //   15: aload_1
    //   16: invokestatic 17	com/tencent/mobileqq/filemanager/util/FileUtil:deleteFile	(Ljava/lang/String;)Z
    //   19: pop
    //   20: new 19	java/io/File
    //   23: dup
    //   24: aload_0
    //   25: invokespecial 23	java/io/File:<init>	(Ljava/lang/String;)V
    //   28: invokevirtual 27	java/io/File:exists	()Z
    //   31: ifeq +148 -> 179
    //   34: new 29	java/io/FileInputStream
    //   37: dup
    //   38: aload_0
    //   39: invokespecial 30	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   42: astore_0
    //   43: new 32	java/io/FileOutputStream
    //   46: dup
    //   47: aload_1
    //   48: invokespecial 33	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   51: astore 4
    //   53: sipush 1444
    //   56: newarray byte
    //   58: astore_1
    //   59: aload_0
    //   60: aload_1
    //   61: invokevirtual 39	java/io/InputStream:read	([B)I
    //   64: istore_3
    //   65: iload_3
    //   66: iconst_m1
    //   67: if_icmpeq +69 -> 136
    ...
    //   72: iadd
    //   73: istore_2
    //   74: getstatic 45	java/lang/System:out	Ljava/io/PrintStream;
    //   77: iload_2
    //   78: invokevirtual 51	java/io/PrintStream:println	(I)V
    //   81: aload 4
    //   83: aload_1
    //   84: iconst_0
    //   85: iload_3
    //   86: invokevirtual 55	java/io/FileOutputStream:write	([BII)V
    //   89: goto -30 -> 59
    //   92: astore 5
    //   94: aload_0
    //   95: astore_1
    ...
    //   101: iconst_1
    //   102: ldc 59
    //   104: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   107: aload_0
    //   108: invokevirtual 69	java/lang/Exception:printStackTrace	()V
    //   111: iconst_0
    //   112: invokestatic 75	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   115: astore_0
    //   116: aload_1
    //   117: ifnull +7 -> 124
    //   120: aload_1
    //   121: invokevirtual 78	java/io/InputStream:close	()V
    //   124: aload 4
    //   126: ifnull +8 -> 134
    //   129: aload 4
    //   131: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   134: aload_0
    //   135: areturn
    //   136: aload_0
    //   137: invokevirtual 78	java/io/InputStream:close	()V
    //   140: aload 4
    //   142: invokevirtual 82	java/io/FileOutputStream:flush	()V
    //   145: aload 4
    //   147: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   150: iconst_0
    //   151: ifeq +11 -> 162
    //   154: new 84	java/lang/NullPointerException
    //   157: dup
    //   158: invokespecial 86	java/lang/NullPointerException:<init>	()V
    //   161: athrow
    //   162: iconst_0
    //   163: ifeq +11 -> 174
    //   166: new 84	java/lang/NullPointerException
    //   169: dup
    //   170: invokespecial 86	java/lang/NullPointerException:<init>	()V
    //   173: athrow
    //   174: iconst_1
    //   175: invokestatic 75	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   178: areturn
    //   179: ldc 57
    //   181: iconst_1
    //   182: ldc 88
    //   184: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   187: goto -37 -> 150
    //   190: astore_0
    //   191: aconst_null
    //   192: astore 5
    ...
    //   211: ifnull +8 -> 219
    //   214: aload 4
    //   216: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   219: aload_0
    //   220: athrow
    //   221: astore_1
    //   222: goto -3 -> 219
  ...
  public static boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    //   12: dup
    //   13: aload_0
    //   14: invokespecial 23	java/io/File:<init>	(Ljava/lang/String;)V
    //   17: astore_0
    //   18: aload_0
    //   19: invokevirtual 27	java/io/File:exists	()Z
    //   22: ifeq +418 -> 440
    ...
    //   86: iconst_0
    //   87: ifeq +11 -> 98
    //   90: new 84	java/lang/NullPointerException
    //   93: dup
    //   94: invokespecial 86	java/lang/NullPointerException:<init>	()V
    //   97: athrow
    //   98: iconst_0
    //   99: ireturn
    //   100: astore_0
    ...
    //   202: iconst_0
    //   203: iload_1
    //   204: invokevirtual 55	java/io/FileOutputStream:write	([BII)V
    //   207: goto -19 -> 188
    //   210: astore 7
    //   212: aload_0
    //   213: astore_2
    ...
    //   223: iconst_1
    //   224: ldc 152
    //   226: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   229: aload 6
    //   231: invokevirtual 69	java/lang/Exception:printStackTrace	()V
    //   234: aload_0
    //   235: ifnull +7 -> 242
    //   238: aload_0
    ...
    //   243: ifnull +205 -> 448
    //   246: aload_2
    //   247: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   250: iconst_0
    //   251: istore 4
    //   253: iload 4
    //   255: ireturn
    //   256: aload_0
    //   257: invokevirtual 82	java/io/FileOutputStream:flush	()V
    //   260: aload 6
    //   262: ifnull +8 -> 270
    //   265: aload 6
    ...
    //   275: ifnull -22 -> 253
    //   278: aload_0
    //   279: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   282: iload 5
    //   284: istore 4
    //   286: goto -33 -> 253
    //   289: astore_0
    ...
    //   390: ifnull +7 -> 397
    //   393: aload_2
    //   394: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   397: aload_0
    //   398: athrow
    //   399: astore 6
    //   401: aload 6
    ...
    //   442: iconst_1
    //   443: ldc 154
    //   445: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   448: iconst_0
    //   449: istore 4
    //   451: goto -198 -> 253
    //   454: astore_0
  ...
  public static boolean a(byte[] paramArrayOfByte, String paramString1, String paramString2)
  {
    ...
    //   15: dup
    //   16: aload_2
    //   17: invokespecial 33	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   20: astore_2
    //   21: aload 7
    //   23: astore 5
    //   25: aload_2
    ...
    //   31: aload_0
    //   32: arraylength
    //   33: invokevirtual 55	java/io/FileOutputStream:write	([BII)V
    //   36: aload 7
    //   38: astore 5
    //   40: aload_2
    //   41: astore 4
    //   43: new 29	java/io/FileInputStream
    //   46: dup
    //   47: aload_1
    //   48: invokespecial 30	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   51: astore_0
    //   52: sipush 4096
    //   55: newarray byte
    //   57: astore_1
    ...
    //   71: iconst_0
    //   72: iload_3
    //   73: invokevirtual 55	java/io/FileOutputStream:write	([BII)V
    //   76: goto -18 -> 58
    //   79: astore 4
    //   81: aload_2
    //   82: astore_1
    ...
    //   110: ifnull +55 -> 165
    //   113: aload_1
    //   114: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   117: iconst_1
    //   118: ireturn
    //   119: aload_0
    //   120: ifnull +7 -> 127
    ...
    //   128: ifnull +9 -> 137
    //   131: aload_2
    //   132: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   135: iconst_1
    //   136: ireturn
    //   137: ldc 57
    //   139: iconst_1
    //   140: ldc 160
    //   142: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   145: iconst_0
    //   146: ireturn
    //   147: astore_0
    //   148: aload_0
    ...
    //   167: iconst_1
    //   168: ldc 160
    //   170: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   173: iconst_0
    //   174: ireturn
    //   175: astore_0
    //   176: aload_0
    ...
    //   235: ifnull +9 -> 244
    //   238: aload_2
    //   239: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   242: iconst_1
    //   243: ireturn
    //   244: ldc 57
    //   246: iconst_1
    //   247: ldc 160
    //   249: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   252: iconst_0
    //   253: ireturn
    //   254: astore_0
    //   255: aload_0
    ...
    //   287: ifnull +9 -> 296
    //   290: aload_2
    //   291: invokevirtual 79	java/io/FileOutputStream:close	()V
    //   294: iconst_1
    //   295: ireturn
    //   296: ldc 57
    //   298: iconst_1
    //   299: ldc 160
    //   301: invokestatic 65	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   304: iconst_0
    //   305: ireturn
    //   306: astore_0
    //   307: aload_0
