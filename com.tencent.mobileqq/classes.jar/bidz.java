...
public class bidz
  implements QwAdapter.IViewHolder<awdw>
{
  public KSongTextView a;
  
  public bidz(KSongView paramKSongView) {}
  
  public void a(int paramInt, View paramView, awdw paramawdw)
  {
    ...
    if (TextUtils.isEmpty(paramawdw.a)) {}
    for (paramView = "";; paramView = paramawdw.a)
    {
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetKsongKSongTextView = ((KSongTextView)paramView.findViewById(2131374644));
    return paramView;
  }
}
