...
public class alms
  extends ajfb
{
  public alms(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  public void a(List<String> paramList, ajfe paramajfe)
  {
    ...
    do
    {
      ...
      localBubble_Req_Comm.mqqver.set("8.2.6");
    ...
    paramajfe = super.createToServiceMsg("bubble.1", paramajfe);
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd_0x01.has()) && (paramFromServiceMsg.rspcmd_0x01.user_text_info.has()))
          {
            ...
            almr.a().a(this.app, true, paramFromServiceMsg);
