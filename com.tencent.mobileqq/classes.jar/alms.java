...
public class alms
  extends BaseAdapter
  implements alpt, alpv, View.OnClickListener, View.OnLongClickListener, aoog, blpr
{
  public int a;
  private long jdField_a_of_type_Long;
  private alml jdField_a_of_type_Alml;
  private almz jdField_a_of_type_Almz;
  protected alno a;
  protected alnw a;
  protected Context a;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new almy(this);
  ...
  public alms(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, alml paramalml, int paramInt)
  {
    this(paramContext, paramQQAppInterface, paramXListView, paramalml, paramInt, false);
  }
  
  public alms(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, alml paramalml, int paramInt, boolean paramBoolean)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentWidgetXListView = paramXListView;
    this.jdField_a_of_type_Alml = paramalml;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilList = new ArrayList(99);
    this.jdField_a_of_type_Alnw = new alnw(paramInt);
    this.jdField_a_of_type_Alnw.a(this);
    this.jdField_a_of_type_Alno = new alno(paramQQAppInterface, this, paramBoolean);
    this.jdField_a_of_type_Xax = new xax(paramQQAppInterface);
    this.jdField_a_of_type_Xax.a(new almu(this));
    if (paramInt == 0) {
  ...
  private void a(int paramInt, RecentItemServiceAccountFolderData paramRecentItemServiceAccountFolderData)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("RecentAdapter", 2, "clearServiceAccountFolderUnreadByFolderRed, red dot switch:" + tyi.b);
    }
    int j = paramRecentItemServiceAccountFolderData.mUnreadNum;
    if (!tyi.b)
    {
      paramRecentItemServiceAccountFolderData.clearUnReadNum();
      tug.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, NetConnInfoCenter.getServerTime());
      if (tyi.c) {
        tug.a().e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
    ...
    for (paramRecentItemServiceAccountFolderData = "0";; paramRecentItemServiceAccountFolderData = "1")
    {
      ...
      if ((paramRecentItemServiceAccountFolderData instanceof bbav)) {
        ((bbav)paramRecentItemServiceAccountFolderData).a(104000, "104000.104001");
      }
      return;
      i = 0;
      break;
  ...
  private void a(int paramInt, Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  alpb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject.getRecentUserUin(), paramObject.getRecentUserType());
              ...
              ((oek)localObject).a(paramObject.time);
              return;
              if ((paramObject instanceof RecentUserBaseData))
              {
                ...
                if (localRecentUser.getType() == 1008) {
                  bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "" + localRecentUser.uin, "0X80064CA", "0X80064CA", 0, 0, "" + ((RecentUserBaseData)localObject).mUnreadNum, "", "", "");
                }
                for (;;)
                {
                  ((RecentUserBaseData)localObject).clearUnReadNum();
                  blhw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(((RecentUserBaseData)localObject).getRecentUserUin());
                  alpb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser, true, false);
                  if (this.c == 0) {
                    alpb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser);
                  }
                  if ((paramObject instanceof SendBlessRecentItemData)) {
                    ((ajan)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(138)).b(true);
                  }
                  a(localRecentUser);
                  return;
                  if (localRecentUser.getType() == 6004) {
                    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80090EA", "0X80090EA", 0, 0, "", "", "", "");
                  }
                }
              }
            ...
            axan.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject.time);
            return;
            if (!(paramObject instanceof RecentItemEcShop)) {
              break;
            }
            paramObject = (RecentItemEcShop)paramObject;
            bdll.b(null, "dc00899", "Pb_account_lifeservice", paramObject.getRecentUserUin(), "0X80064D3", "0X80064D3", 0, 0, "" + paramObject.mUnreadNum, "", "", "");
            paramObject.clearUnReadNum();
            alpb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject.getRecentUserUin(), paramObject.getRecentUserType());
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramObject.getRecentUserUin(), paramObject.getRecentUserType());
            paramObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramObject.getRecentUserUin(), 1008);
      ...
      ((anzm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255)).a(paramObject.time);
      return;
      if ((paramObject instanceof RecentItemConfessMsg))
      {
        aqyt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentItemConfessMsg)paramObject, false);
        return;
      }
  ...
  private void a(RecentBaseData paramRecentBaseData, String paramString, int paramInt)
  {
    ...
    {
    default: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "999", paramString, "", "");
      return;
    case 0: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "0", "", paramString, "");
      return;
    case 1: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "1", "", paramString, "");
      return;
    case 3000: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "2", "", paramString, "");
      return;
    case 1008: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "3", "", paramString, "");
      if ((paramRecentBaseData instanceof RecentItemEcShop)) {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_DelMsghelper", "Clk_DelshopItem", 0, 0, paramRecentBaseData.getRecentUserUin(), "", paramRecentBaseData.mTitleName, "");
      }
      paramString = paramRecentBaseData.getRecentUserUin();
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", paramString, "0X80064C9", "0X80064C9", 0, 0, "" + paramRecentBaseData.mUnreadNum, "", "", "");
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "", "0X80067EE", "0X80067EE", 0, 0, "" + paramRecentBaseData.getRecentUserUin(), "", "", "");
      alol.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.getRecentUserUin(), paramRecentBaseData.mUnreadFlag, paramRecentBaseData.getUnreadNum(), 1, paramRecentBaseData.getTitleName());
      if (antf.aP.equals(paramString)) {
        pai.c();
      }
      ubg.a(paramString);
      return;
    case 5000: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "4", "", paramString, "");
      return;
    case 7000: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "5", "", paramString, "");
      return;
    case 4000: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "6", "", paramString, "");
      return;
    case 1022: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "7", "", paramString, "");
      return;
    case 6000: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "8", "", paramString, "");
      return;
    case 7200: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "9", "", paramString, "");
      return;
    case 1001: 
    case 10002: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80050FC", "0X80050FC", 0, 0, "", "", "", "");
      if ((paramRecentBaseData instanceof RecentMsgBoxItem))
      {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", ((RecentMsgBoxItem)paramRecentBaseData).a(), "msg_box", "delete_msg", 0, 0, "", "", "", "");
        return;
      }
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "swipe_msg", 0, 0, "", "", "", "");
      return;
    case 1010: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80050FE", "0X80050FE", 0, 0, "", "", "", "");
      return;
    case 9505: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006353", "0X8006353", 0, 0, "", "", "", "");
      return;
    case 7210: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "0", "0X80064C5", "0X80064C5", 0, 0, "" + paramRecentBaseData.mUnreadNum, "", "", "");
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "", "0X80067EE", "0X80067EE", 0, 0, "" + paramRecentBaseData.getRecentUserUin(), "", "", "");
      return;
    case 7120: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "1", "0X80064C5", "0X80064C5", 0, 0, "" + paramRecentBaseData.mUnreadNum, "", "", "");
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "", "0X80067EE", "0X80067EE", 0, 0, "" + paramRecentBaseData.getRecentUserUin(), "", "", "");
      return;
    case 7220: 
      ubg.a();
      ...
      return;
    case 6004: 
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80090EB", "0X80090EB", 0, 0, "", "", "", "");
      return;
    }
    ...
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.list.delete", 0, 0, "", "", "", "");
  }
  
  private void a(RecentMsgBoxItem paramRecentMsgBoxItem)
  {
    paramRecentMsgBoxItem.clearUnReadNum();
    if (adak.b(paramRecentMsgBoxItem.getRecentUserUin()))
    {
      ...
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005298", "0X8005298", 0, 0, "", "", "", "");
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "drag_hi", 0, 0, "", "", "", "");
    }
    do
    {
      return;
      alpb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentMsgBoxItem.getRecentUserUin(), paramRecentMsgBoxItem.getRecentUserType());
      ...
      if (adak.e(paramRecentMsgBoxItem.getRecentUserUin()))
      {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "drag_update", 0, 0, "", "", String.valueOf(paramRecentMsgBoxItem.mFromFlag), "");
        return;
      }
    } while (!adak.f(paramRecentMsgBoxItem.getRecentUserUin()));
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "drag_focus", 0, 0, "", "", "", "");
  }
  
  private void a(RecentUser paramRecentUser)
  {
    if ((paramRecentUser.getType() == 0) && (bhjx.b(paramRecentUser.uin)))
    {
      ...
      if (!paramRecentUser.getBoolean("babyQ_toast_flag", false))
      {
        ...
        if (j >= 3)
        {
          bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230, "babyQ提醒", "是否需要关闭babyQ的推送开关\n", anzj.a(2131712030), anzj.a(2131712029), new almw(this), new almx(this)).show();
  ...
  private void a(StringBuilder paramStringBuilder1, StringBuilder paramStringBuilder2, StringBuilder paramStringBuilder3)
  {
    if (this.c == 0)
    {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800419D", "0X800419D", 0, 0, "", "", "", "");
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80041A0", "0X80041A0", 0, 0, "", "", "", "");
      if (!TextUtils.isEmpty(paramStringBuilder1)) {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", String.valueOf(paramStringBuilder3), "0X8005C37", "0X8005C37", 0, 1, 0, String.valueOf(paramStringBuilder1), String.valueOf(NetConnInfoCenter.getServerTime() * 1000L), "", String.valueOf(paramStringBuilder2));
      }
    }
  }
  ...
  private boolean a(View paramView)
  {
    ...
    if (bhjx.a("tag_recent_item_icon", paramView.getTag()))
    {
      localObject = paramView.getTag(-22);
      if ((this.jdField_a_of_type_Alml != null) && (localObject != null)) {
        this.jdField_a_of_type_Alml.a(paramView, localObject);
      }
      return true;
    }
    return false;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    if ((paramRecentBaseData instanceof RecentItemChatMsgData))
    {
      ...
      if ((paramRecentBaseData == null) || (paramRecentBaseData.getType() != 1008) || (!tug.b(paramQQAppInterface, paramRecentBaseData.uin))) {
        break label132;
      }
    }
    label132:
  ...
  private void b(RecentBaseData paramRecentBaseData, String paramString1, String paramString2)
  {
    ...
    {
      ozs.a();
      ocd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80067CE", "0X80067CE", 0, 0, "", "", "", ozs.e(), false);
    }
    try
    {
    ...
    catch (Exception paramString1)
    {
      ...
      if (i == 8113)
      {
        ...
        paramString1 = paramRecentBaseData.getRecentUserUin();
        ((aobl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).d(paramString1);
      }
  ...
  private void c(RecentBaseData paramRecentBaseData)
  {
    if (paramRecentBaseData.getRecentUserType() == 1)
    {
      ...
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "right", 0, 0, paramRecentBaseData.getRecentUserUin(), String.valueOf(i - 1), "", "");
    }
    if ("9970".equals(paramRecentBaseData.getRecentUserUin())) {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Shop_lifeservice", "", "Shop_folder", "Press_Shopfolderlong", 0, 0, "", "", "", "");
    }
  }
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      k = ((Integer)alno.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, k, localRecentBaseData.getRecentUserUin()).first).intValue();
      if (k != -2147483648)
      {
        Object localObject1;
        ...
        else
        {
          ...
          if (localObject1 != null)
          {
            ...
            if (k == 103)
            {
              ...
              localObject4 = BaseApplication.getContext().getResources().getDrawable(2130840354);
  ...
  private void g()
  {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (((localObject8 instanceof RecentBaseData)) && ((localObject8 instanceof RecentUserBaseData)))
        {
          ...
          if (((RecentUserBaseData)localObject4).mUnreadNum > 0)
          {
            ...
            blhw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(((RecentUserBaseData)localObject4).getRecentUserUin());
    ...
    for (;;)
    {
      ...
      if ((localObject8 instanceof RecentItemTroopMsgData))
      {
        ...
        if ((i == 2) || (i == 4))
        {
          alpb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentUser)localObject7, true, false);
        ...
        {
          alpb.a((QQAppInterface)localObject1, (RecentUser)localObject7, bool, false);
          localObject3 = localObject6;
          localObject2 = localObject5;
          localObject1 = localObject4;
          break;
      ...
      if ((localObject8 instanceof RecentItemServiceAccountFolderData))
      {
        ...
        for (bool = true;; bool = false)
        {
          ...
          localObject2 = localObject5;
          localObject1 = localObject4;
          if (!(localObject7 instanceof bbav)) {
            break;
          }
          ((bbav)localObject7).a(104000, "104000.104001");
          localObject3 = localObject6;
          localObject2 = localObject5;
          localObject1 = localObject4;
          break;
  ...
  private void h()
  {
    Object localObject = (oek)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    if ((localObject != null) && (((oek)localObject).e))
    {
      ((oek)localObject).e = false;
  ...
  private void i()
  {
    try
    {
      ...
      {
        Object localObject = (avld)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358);
        if (localObject != null)
        {
          ((avld)localObject).a(0);
  ...
  public alno a()
  {
    return this.jdField_a_of_type_Alno;
  }
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (i < j)
      {
        ...
        if ((localObject instanceof RecentBaseData))
        {
          ...
          if (axkr.a(((RecentBaseData)localObject).getRecentUserType())) {
            return localObject;
          }
        }
        i += 1;
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    ...
    for (;;)
    {
      localDrawable = this.jdField_a_of_type_Alno.a(i, paramRecentBaseData.getRecentUserUin());
      paramDrawable = this.jdField_a_of_type_Alnw.a(paramRecentBaseData);
      if (paramDrawable == null) {
        break;
      }
      try
      ...
      if (!alok.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
        break;
      }
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, MessageRecord paramMessageRecord, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if (paramDrawable == null) {
        localDrawable = this.jdField_a_of_type_Alno.a(paramMessageRecord.istroop, paramMessageRecord.senderuin);
      }
      paramDrawable = this.jdField_a_of_type_Alnw.a(paramRecentBaseData);
    } while ((paramDrawable == null) || (!(paramDrawable instanceof alpc)));
    ((alpc)paramDrawable).a(paramView, paramRecentBaseData, paramMessageRecord, localDrawable);
  }
  ...
  {
    if (this.jdField_a_of_type_Alml != null) {
      this.jdField_a_of_type_Alml.a(paramRecentBaseData, paramString);
    }
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
  ...
  protected void a(RecentBaseData paramRecentBaseData, String paramString1, String paramString2)
  {
    ...
    if (bhjx.a(paramString1, localResources.getString(alnt.a[0])))
    {
      paramRecentBaseData.getRecentUserType();
      b(paramRecentBaseData, paramString1, paramString2);
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A360", "0X800A360", 0, 0, "1", "", paramString2, "");
    }
    while (this.jdField_a_of_type_Alml == null) {
      return;
    }
    this.jdField_a_of_type_Alml.a(paramString1, paramRecentBaseData, paramString2);
    ubg.a(paramRecentBaseData.getRecentUserType(), paramRecentBaseData.getRecentUserUin(), paramString1, localResources);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_a_of_type_Xax != null) {
      this.jdField_a_of_type_Xax.a();
    }
    if (this.jdField_a_of_type_Alnw != null) {
      this.jdField_a_of_type_Alnw.a(paramQQAppInterface);
    }
    this.jdField_a_of_type_Xax = new xax(paramQQAppInterface);
    this.jdField_a_of_type_Xax.a(new almt(this));
    if (QLog.isColorLevel()) {
      QLog.i("RecentTabHaloPresenter", 2, "onAccountChanged: invoked. Message: app: " + paramQQAppInterface + " recreate mRecentTabHaloPresenter: " + this.jdField_a_of_type_Xax);
    }
  }
  ...
  {
    bdll.b(null, "dc00899", "Grp_video", "", "notice", "call", 0, 0, paramString, "" + bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString), "", "");
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    label71:
    while (!bhjx.a(localRecentBaseData.getRecentUserUin(), paramString))
    {
      i += 1;
      break label26;
      break;
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      localView = this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(i);
      localRecentBaseData = a(localView);
      if ((localRecentBaseData != null) && (bhjx.a(paramString, localRecentBaseData.getRecentUserUin()))) {
        break label74;
      }
    }
    label74:
  ...
  {
    if (this.jdField_a_of_type_Alno.a == null) {
      return;
    }
    if (paramBoolean)
    {
      this.jdField_a_of_type_Alno.a.a();
      this.jdField_a_of_type_Alno.a.c();
      return;
    }
    if (this.jdField_a_of_type_Alno.a.a()) {
      this.jdField_a_of_type_Alno.a.b();
    }
    ...
    for (;;)
    {
      ...
      if (!(localRecentBaseData instanceof RecentItemImaxADData)) {
        this.jdField_a_of_type_Alno.a(localRecentBaseData.getRecentUserType(), localRecentBaseData.getRecentUserUin(), false);
      }
    }
  }
  ...
  public void b(RecentBaseData paramRecentBaseData)
  {
    ...
    for (Object localObject = ((axfr)localObject).c(paramRecentBaseData.mPhoneNumber);; localObject = null)
    {
      ...
      {
        return;
        localObject = ((baok)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(140)).a(paramRecentBaseData.getRecentUserUin());
      } while (localObject == null);
  ...
  {
    if (this.jdField_a_of_type_Alnw != null) {
      this.jdField_a_of_type_Alnw.b(paramQQAppInterface);
    }
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Alnw.a(localObject);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    for (;;)
    {
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_Alnw.a(localObject2);
        if (!(localObject2 instanceof RecentBaseData)) {
          continue;
        }
        localObject2 = (RecentBaseData)localObject2;
        b((RecentBaseData)localObject2);
        localObject1 = ((alnt)localObject1).a(paramInt, localObject2, this.jdField_a_of_type_Alno, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, this, this);
      ...
      catch (Throwable localThrowable)
      {
        Object localObject2;
        Object localObject1;
        alok.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), false, localThrowable);
        if (!alok.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
          continue;
        }
      ...
      {
        localObject1 = ((alnt)localObject1).a(paramInt, localObject2, null, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, this, this);
        paramView = (View)localObject1;
      }
      else if ((localObject2 instanceof String))
      {
        localObject1 = ((alnt)localObject1).a(paramInt, localObject2, null, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, null, null, null);
        paramView = (View)localObject1;
      }
      else
      {
  ...
  {
    return this.jdField_a_of_type_Alnw.b();
  }
  ...
  public void onChange(boolean paramBoolean, int paramInt, DragFrameLayout paramDragFrameLayout)
  {
    ...
    if (paramBoolean)
    {
        ...
        while (paramDragFrameLayout.hasNext())
        {
          ...
          if (((localObject instanceof RecentBaseData)) && ((localObject instanceof RecentUserBaseData)))
          {
            ...
            if (((RecentUserBaseData)localObject).mUnreadNum > 0)
            {
              ...
              aloy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentBaseData)localObject, localRecentUser, true);
            }
          }
        }
        i = 0;
      ...
      {
        paramDragFrameLayout = (baou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38);
        if (paramDragFrameLayout != null) {
    ...
    if ((i != 0) && ((paramDragFrameLayout instanceof RecentUserBaseData)))
    {
      ...
      aloy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentBaseData)localObject, localRecentUser, false);
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject1 = (wjk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(197);
      if (this.jdField_a_of_type_Alml != null)
      {
        Object localObject2 = paramView.getTag(-22);
        if (((wjk)localObject1).b(localObject2)) {
          this.jdField_a_of_type_Alml.a(paramView, localObject2);
        }
        ...
        else
        {
          ...
          {
            if (((paramView instanceof blml)) && ((localObject1 instanceof RecentItemEcShop)))
            {
              this.jdField_a_of_type_Alml.a(paramView, localObject1);
              label177:
            ...
            for (;;)
            {
              nqw.a.a(localObject1);
              break;
              localObject2 = (RecentBaseData)localObject1;
              ((RecentBaseData)localObject2).mPosition = i;
              this.jdField_a_of_type_Alml.a(paramView, (RecentBaseData)localObject2, ((RecentBaseData)localObject2).mTitleName, true);
              break label177;
              label255:
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Alnw != null)
    {
      i = this.jdField_a_of_type_Alnw.a();
    ...
    for (localObject1 = (RecentBaseData)localObject1;; localObject1 = null)
    {
      ...
      Object localObject2 = this.jdField_a_of_type_Alnw.a(localObject1);
      c((RecentBaseData)localObject1);
      if (localObject2 != null) {}
      for (List localList = ((alnt)localObject2).a((RecentBaseData)localObject1, this.jdField_a_of_type_AndroidContentContext);; localList = null)
      {
        if ((localList != null) && (localList.size() > 0) && (SystemClock.uptimeMillis() - this.jdField_b_of_type_Long > 100L))
        {
          localObject2 = new bhuk();
          i = 0;
          while (i < localList.size())
          {
            ((bhuk)localObject2).a(j, (String)localList.get(i));
            i += 1;
          }
          boolean bool1;
          if ((this.jdField_a_of_type_Boolean) && (axky.a(this.jdField_a_of_type_AndroidContentContext, ((RecentBaseData)localObject1).getRecentUserUin(), ((RecentBaseData)localObject1).getRecentUserType(), ((RecentBaseData)localObject1).getTitleName(), "conversation_tab_list")))
          {
            bool1 = bool2;
            if (QLog.isColorLevel())
            {
          ...
          for (;;)
          {
            ...
            try
            {
              this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = bhkx.a(paramView, (bhuk)localObject2, this.jdField_a_of_type_AndroidViewView$OnClickListener, new almv(this, paramView));
              bool1 = true;
            }
            catch (Throwable paramView)
            {
