  ...
  extends xfp
{
  ...
  public avzh(AppInterface paramAppInterface)
  {
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.MqVersion = "8.2.6";
    paramUniPacket.setServantName("CameraModuleSvc");
  ...
  {
    avzp localavzp = new avzp(true);
    try
    {
      localavzp.setEncodeName("utf-8");
      localavzp.decode(paramArrayOfByte);
      return localavzp.getByClass(paramString, paramT);
    }
