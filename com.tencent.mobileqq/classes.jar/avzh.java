...
public class avzh
{
  ...
  public avzh()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new avzi(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper(), this);
  }
  ...
  private void b(String paramString)
  {
    ...
    if (axim.o == 16)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaFormat.setInteger("bitrate", axim.n);
      ...
      if (!paramString.exists()) {
        bbdx.c(paramString.getAbsolutePath());
      }
  ...
  void a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Avzj != null) {
        this.jdField_a_of_type_Avzj.h();
      }
      return;
    }
  ...
  public void a(avzj paramavzj)
  {
    this.jdField_a_of_type_Avzj = paramavzj;
  }
