  ...
  extends Handler
{
  ...
  public azkr(Looper paramLooper, PresendPicMgr paramPresendPicMgr)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (localPresendPicMgr != null)
    {
      ...
      default: 
        ...
        return;
      case 1: 
        azjq.a("PresendPicMgr", "PresendHandler", "handleMessage MSG_REGISTER_CLIENT_HANDLER");
        ...
        while (((Iterator)localObject).hasNext()) {
          localArrayList.add(((azks)((Iterator)localObject).next()).a);
        }
      ...
      azjq.a("PresendPicMgr", "PresendHandler", "handleMessage MSG_UNREGISTER_CLIENT_HANDLER");
      localPresendPicMgr.a = null;
      return;
    }
    azjq.b("PresendPicMgr", "handleMessage", "PresendPicMgr == null!");
  }
}
