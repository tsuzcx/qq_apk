...
public final class abnu
{
  ...
  static
  {
    jdField_a_of_type_Abnv = new abnv(null);
  }
  
  public abnu(@NotNull RewardedVideoAdPlugin paramRewardedVideoAdPlugin, @NotNull String paramString1, @NotNull WeakReference<Activity> paramWeakReference, @NotNull String paramString2, @NotNull JsRuntime paramJsRuntime, int paramInt, boolean paramBoolean)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof abnu))
      {
        paramObject = (abnu)paramObject;
