  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  private int jdField_b_of_type_Int = 2131755837;
  ...
  public mkf(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewWindowManager = ((WindowManager)paramContext.getSystemService("window"));
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131559786, null);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(this);
  }
  
  public TextView a()
  {
    return (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371539);
  }
  ...
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366164)).setImageBitmap(paramBitmap);
  }
  
  public void a(Bitmap paramBitmap, String paramString)
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366164)).setImageBitmap(paramBitmap);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371539)).setText(paramString);
  }
  
  public void a(String paramString)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370665));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370665);
    Button localButton1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361814);
    Button localButton2 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376349);
    ...
    if (paramBoolean3) {
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131694701));
      }
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(localTextView.getResources().getString(2131694702));
      continue;
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131694700));
      } else {
        localTextView.setText(localTextView.getResources().getString(2131694703));
      }
    }
  }
  ...
  void b()
  {
    ...
    for (;;)
    {
      ...
      {
        lbc.e("VideoInviteFloatBar", "startHandler error : " + localException2);
      }
  ...
  {
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378723));
  ...
  public void c()
  {
    ...
    Button localButton = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376349);
    ((Button)localObject).setVisibility(4);
    localButton.setVisibility(4);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370665);
    this.jdField_a_of_type_AndroidViewView.invalidate();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131361814: 
      ...
      for (;;)
      {
        ...
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131376349)).setClickable(false);
