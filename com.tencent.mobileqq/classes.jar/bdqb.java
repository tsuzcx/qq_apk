  ...
  extends bdnv
{
  ...
  public bdqb(Collection<bdnu> paramCollection)
  {
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    int n = localResources.getDimensionPixelSize(2131298982);
    int i1 = localResources.getDimensionPixelSize(2131298983);
    ...
    for (int k = 6;; k = 10)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        if (j < k)
        {
          localObject2 = (bdnu)((ArrayList)localObject1).get(j);
          ...
          localView = ((bdnu)localObject2).a(paramContext, paramView.getChildAt(j), paramBundle);
          if (localView != null) {}
        }
        else
        {
      ...
      for (int j = a(paramContext, k) + i;; j = i)
      {
        ...
        if (j > 0) {
          localLayoutParams.topMargin = a(localResources, j, (bdnu)localObject2);
        }
