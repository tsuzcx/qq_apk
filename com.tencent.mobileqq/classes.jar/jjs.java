...
public class jjs
{
  ...
  public void a(String paramString)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramString))
    {
      ...
      localObject = VideoController.a().a().getResources().getDrawable(2130840228);
    }
    for (;;)
    {
      ...
      if (GestureFilterManager.jdField_a_of_type_JavaLangString.equals("palmup")) {
        localObject = VideoController.a().a().getResources().getDrawable(2130840229);
      } else if (GestureFilterManager.jdField_a_of_type_JavaLangString.equals("qheart")) {
        localObject = VideoController.a().a().getResources().getDrawable(2130840230);
      } else {
