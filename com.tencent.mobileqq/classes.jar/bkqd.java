...
public class bkqd
  extends QIPCModule
{
  private static volatile bkqd a;
  
  private bkqd(String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("getfavList".equals(paramString))
    {
      ...
      localQQAppInterface.getFileManagerEngine().a().a(l, paramString, paramBundle);
    ...
    for (;;)
    {
      ...
      if ("refreshFavList".equals(paramString))
      {
        ...
        localQQAppInterface.getFileManagerEngine().a().a(bool, paramBundle);
      ...
      else if ("ondownloadThumb".equals(paramString))
      {
        ...
        localQQAppInterface.getFileManagerEngine().a().a(l, paramString, paramInt);
      }
      else if ("ondownloadFile".equals(paramString))
      {
        l = paramBundle.getLong("download_fav_id");
        paramString = paramBundle.getString("fav_save_path");
        localQQAppInterface.getFileManagerEngine().a().a(l, paramString);
      }
