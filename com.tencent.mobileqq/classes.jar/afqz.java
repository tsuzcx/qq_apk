  ...
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  private static aijn jdField_a_of_type_Aijn = new aijl();
  private static SparseArrayCompat<aijn> jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat;
  ...
  public afqz(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
    this.jdField_a_of_type_AndroidSupportV4UtilArraySet = new ArraySet();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Agvm = new agvm(paramContext, paramQQAppInterface, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    ...
    for (long l = NetConnInfoCenter.getServerTime();; l = paramBaseChatPie.getCreateTime())
    {
      ...
      this.jdField_a_of_type_Alvv = new alvv(this, paramQQAppInterface);
      this.jdField_a_of_type_Alvx = new alvx(paramBaseChatPie);
      this.jdField_a_of_type_Afra = new afra(this);
      return;
    }
  }
  ...
  static ChatMessage a(List<ChatMessage> paramList, ArraySet<Long> paramArraySet, long paramLong)
  {
    ...
    if (i < paramList.size())
    {
      ...
      label86:
      Object localObject2;
      if ((bcsc.b(localChatMessage.msgtype)) && (localChatMessage.needShowTimeStamp()))
      {
        j = 1;
  ...
  protected static void a(MessageForStructing paramMessageForStructing, afqr paramafqr, View paramView, boolean paramBoolean)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return;
    }
    e();
    aijn localaijn2 = (aijn)jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramMessageForStructing.structingMsg.mMsgServiceID);
    aijn localaijn1 = localaijn2;
    if (localaijn2 == null) {
      localaijn1 = jdField_a_of_type_Aijn;
    }
    localaijn1.a(paramMessageForStructing, paramafqr, paramView, paramBoolean);
  }
    ...
    for (paramChatMessage1 = ((MessageForMarketFace)paramChatMessage1).mMarkFaceMessage;; paramChatMessage1 = (ChatMessage)localObject)
    {
      ...
      if (paramChatMessage1 != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            bool1 = bool2;
            if (asdi.a(paramChatMessage1.sbufID, paramChatMessage1.mediaType).equals(asdi.a(((MarkFaceMessage)localObject).sbufID, ((MarkFaceMessage)localObject).mediaType)))
            {
              bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Ep_show_follow", 0, 0, "", paramChatMessage1.dwTabID + "", "", "");
              bool1 = true;
            }
          }
        }
  ...
  {
    this.jdField_a_of_type_Agvm.a(paramChatMessage, this).a(paramView, paramChatMessage, paramInt);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      localChatMessage = (ChatMessage)localView.getTag(2131364535);
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      for (;;)
      {
        if ((bcsc.a(localChatMessage1.msgtype)) || (acnh.j(localChatMessage1.msgtype)))
        {
          i += 1;
          ...
          else
          {
            ...
            if (paramList.size() - k >= 0)
            {
              ...
              {
                if (!bcsc.a(localChatMessage3.msgtype))
                {
                  localChatMessage2 = localChatMessage3;
                  localChatMessage4 = localChatMessage1;
                  i = j;
                  if (!acnh.j(localChatMessage3.msgtype)) {
                    break label216;
                  }
                }
                k += 1;
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade() != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setChatMsgList(paramList);
    }
    ...
    paramCharSequence = (anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 1) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 0) && (paramCharSequence != null) && (paramCharSequence.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin)))) {
      ((asaa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DOUTU_MAGAGER)).a(paramList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie, paramInt);
    }
    if (BaseChatpieHelper.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)) {
      this.jdField_a_of_type_JavaUtilList = BaseChatpieHelper.a(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.debugFilterMsgTargetUin);
    }
    super.notifyDataSetChanged();
    this.jdField_a_of_type_Alvx.b();
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Agvm != null) {
      this.jdField_a_of_type_Agvm.a();
    }
    ...
    this.jdField_a_of_type_Alvx.c();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Afra.a != null)
    {
      alwi localalwi = this.jdField_a_of_type_Afra.a.a();
      if ((localalwi == null) || (!localalwi.c())) {
        break label41;
      }
      localalwi.d();
    }
    label41:
    while (!this.jdField_a_of_type_Afra.a.a()) {
      return;
    }
    this.jdField_a_of_type_Afra.a.a();
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return agvm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      bhhy.a(null, "AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName());
      Object localObject2 = this.jdField_a_of_type_Agvm.a(localChatMessage, this);
      if (paramInt != 0)
      {
      ...
      localObject1 = ((afrj)localObject2).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Afra);
      if (localObject1 != null)
      {
        ((View)localObject1).setTag(2131364535, localChatMessage);
        if (((localObject2 instanceof afor)) && ((localObject1 instanceof aked))) {
          localObject2 = (aked)localObject1;
        }
      }
      bhhy.a("AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName(), null);
    }
  }
