  ...
  extends BusinessHandler
{
  ...
  obx jdField_a_of_type_Obx;
  
  public obw(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_JavaLangString = "image_collection_article_id";
  }
  
  public obw(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!localGetArticleLikeCountRespond.ret.ret_code.has()) || (localGetArticleLikeCountRespond.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Obx.a(bool, paramToServiceMsg, i);
          return;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Obx.a(bool2, paramToServiceMsg, bool1);
          return;
        }
      }
      catch (Exception paramToServiceMsg)
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Obx.a(bool1, paramToServiceMsg);
        return;
      }
      catch (Exception paramToServiceMsg)
      {
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Obx != null) {
        this.jdField_a_of_type_Obx.a(bool1);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Obx != null) {
        this.jdField_a_of_type_Obx.a(bool1, i);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!paramToServiceMsg.ret.ret_code.has()) || (paramToServiceMsg.ret.ret_code.get() == 0))
        {
          ...
          if (this.jdField_a_of_type_Obx != null) {
            this.jdField_a_of_type_Obx.b(bool2, i);
          }
          return;
        }
      }
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        paramFromServiceMsg.mergeFrom((byte[])paramObject);
        localvfz.jdField_a_of_type_JavaLangString = ((String)paramToServiceMsg.extraData.get(this.jdField_a_of_type_JavaLangString));
        paramToServiceMsg = localvfz.jdField_a_of_type_JavaLangString;
        if (paramFromServiceMsg.ret.has()) {
          if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() == 0))
          {
            bool = true;
            if (paramFromServiceMsg.article_share_url.has()) {
              localvfz.jdField_b_of_type_JavaLangString = paramFromServiceMsg.article_share_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.puin.has()) {
              localvfz.c = (paramFromServiceMsg.puin.get() + "");
            }
            if (paramFromServiceMsg.article_img_url.has()) {
              localvfz.d = paramFromServiceMsg.article_img_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.article_title.has()) {
              localvfz.e = paramFromServiceMsg.article_title.get().toStringUtf8();
            }
            if (paramFromServiceMsg.enable_comment.has()) {
              localvfz.jdField_a_of_type_Int = paramFromServiceMsg.enable_comment.get();
            }
            if (paramFromServiceMsg.comment_url.has()) {
              localvfz.f = paramFromServiceMsg.comment_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.firstItem.has())
            {
              localvfz.jdField_a_of_type_Vga = new vga();
              localvfz.jdField_a_of_type_Vga.jdField_a_of_type_JavaLangString = paramFromServiceMsg.firstItem.url.get().toStringUtf8();
              localvfz.jdField_a_of_type_Vga.d = paramFromServiceMsg.firstItem.photo_author_name.get().toStringUtf8();
              localvfz.jdField_a_of_type_Vga.c = paramFromServiceMsg.firstItem.photo_time.get().toStringUtf8();
              localvfz.jdField_a_of_type_Vga.jdField_b_of_type_JavaLangString = paramFromServiceMsg.firstItem.publicaccount_name.get().toStringUtf8();
            }
            ...
            {
              localvgb = new vgb();
              localvgb.jdField_a_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).url.get().toStringUtf8();
              localvgb.jdField_b_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).content.get().toStringUtf8();
              localvgb.c = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).static_url.get().toStringUtf8();
              localvgb.jdField_a_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).width.get();
              localvgb.jdField_b_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).height.get();
    ...
    for (;;)
    {
      ...
      break;
      label628:
      while (this.jdField_a_of_type_Obx != null)
      {
        this.jdField_a_of_type_Obx.a(bool, localvfz, (byte[])paramObject, paramToServiceMsg);
        return;
        bool = false;
        continue;
        bool = false;
        paramToServiceMsg = localvgb;
      }
    }
  }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Obx.a(bool, paramToServiceMsg);
  }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_ret_code.has()) && (paramFromServiceMsg.uint32_ret_code.get() == 0))
        {
          if (paramFromServiceMsg.uint32_read_count.has())
          {
            ...
            if (this.jdField_a_of_type_Obx != null) {
              this.jdField_a_of_type_Obx.c(bool, i);
            }
            return;
            bool = false;
            break;
  ...
  public void a()
  {
    this.jdField_a_of_type_Obx = null;
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localGetPhotoCollectionInfoRequest.versionInfo.set("8.4.8,3,4810");
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, int paramInt3, ArrayList<vgc> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    paramString2 = ByteStringMicro.copyFromUtf8("8.4.8");
    localReportGalleryInfoRequest.mv.set(paramString2);
    paramString2 = ByteStringMicro.copyFromUtf8("4810");
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0) && (paramInt1 == 2))
    {
      ...
      {
        paramString3 = (vgc)paramString2.next();
  ...
  public void b(String paramString)
  {
    ...
    localGetRecommendInfoRequest.versionInfo.set("8.4.8,3,4810");
