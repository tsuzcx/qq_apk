  ...
  implements Handler.Callback
{
  ...
  private final bgvm jdField_a_of_type_Bgvm;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public bgvl(bgvm parambgvm, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Bgvm = parambgvm;
  ...
  private bgut a(Cursor paramCursor)
  {
    Object localObject = bgup.a(paramCursor.getInt(2), paramCursor.getString(6), paramCursor.getString(3), paramCursor.getString(7), paramCursor.getLong(8), paramCursor.getInt(9), paramCursor.getString(4), paramCursor.getString(5), null);
    ((bgup)localObject).f = paramCursor.getString(11);
    bguu localbguu = new bguu();
    localbguu.jdField_a_of_type_Int = paramCursor.getInt(12);
    localbguu.jdField_b_of_type_Int = paramCursor.getInt(13);
    localbguu.jdField_a_of_type_JavaLangString = paramCursor.getString(14);
    localbguu.jdField_a_of_type_Long = paramCursor.getLong(15);
    localbguu.jdField_b_of_type_Long = paramCursor.getLong(16);
    localbguu.jdField_b_of_type_JavaLangString = paramCursor.getString(17);
    localbguu.c = ((bgup)localObject).jdField_a_of_type_JavaLangString;
    localbguu.d = paramCursor.getString(10);
    localObject = bgut.a(paramCursor.getString(1), (bgup)localObject, paramCursor.getString(18), localbguu);
    ((bgut)localObject).a(paramCursor.getLong(0));
    return localObject;
  }
  
  private void a(ContentValues paramContentValues, bguu parambguu, boolean paramBoolean)
  {
    boolean bool = false;
    ...
    {
      i = 0;
      paramContentValues = this.jdField_a_of_type_Bgvm;
      if (i > 0) {
        bool = true;
      }
      paramContentValues.a(l, bool, parambguu, paramBoolean);
      return;
    }
    if (l >= 0L) {}
  ...
  /* Error */
  private void b(int paramInt, bgut parambgut)
  {
    // Byte code:
    //   0: aload_2
    //   1: ifnonnull +4 -> 5
    //   4: return
    //   5: aload_2
    //   6: invokevirtual 184	bgut:a	()Lbgup;
    //   9: astore 12
    //   11: aload_2
    //   12: invokevirtual 187	bgut:a	()Lbguu;
    //   15: astore 13
    ...
    //   28: ifnull -24 -> 4
    //   31: aload_2
    //   32: invokevirtual 190	bgut:a	()Ljava/lang/String;
    //   35: astore 8
    //   37: aload 12
    //   39: getfield 114	bgup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   42: astore 10
    //   44: aload_2
    //   45: invokevirtual 192	bgut:b	()Ljava/lang/String;
    //   48: astore 14
    ...
    //   92: aload 11
    //   94: ldc 162
    //   96: getstatic 23	bgvl:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   99: aload 15
    ...
    //   187: astore 8
    //   189: aload 12
    //   191: getfield 222	bgup:c	Ljava/lang/String;
    //   194: astore 10
    ...
    //   290: ldc 37
    //   292: aload 12
    //   294: getfield 243	bgup:jdField_a_of_type_Long	J
    ...
    //   305: ldc 39
    //   307: aload 12
    //   309: getfield 250	bgup:jdField_b_of_type_Int	I
    ...
    //   320: ldc 55
    //   322: aload_2
    //   323: invokevirtual 192	bgut:b	()Ljava/lang/String;
    ...
    //   379: aload 13
    //   381: getfield 113	bguu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   384: invokestatic 270	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   387: ifne +15 -> 402
    //   390: aload 14
    //   392: ldc 21
    //   394: aload 13
    //   396: getfield 113	bguu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   482: aload_2
    //   483: lload 6
    //   485: invokevirtual 128	bgut:a	(J)V
    //   488: aload_0
    //   489: getfield 64	bgvl:jdField_a_of_type_Bgvm	Lbgvm;
    //   492: iload_1
    //   493: aload_2
    //   494: aload 8
    ...
    //   548: ldc 45
    //   550: aload 13
    //   552: getfield 102	bguu:jdField_a_of_type_Int	I
    ...
    //   563: ldc 47
    //   565: aload 13
    //   567: getfield 104	bguu:jdField_b_of_type_Int	I
    ...
    //   578: ldc 49
    //   580: aload 13
    //   582: getfield 106	bguu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   585: invokevirtual 227	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   588: aload 14
    //   590: ldc 51
    //   592: aload 13
    //   594: getfield 109	bguu:jdField_a_of_type_Long	J
    ...
    //   605: ldc 53
    //   607: aload 13
    //   609: getfield 111	bguu:jdField_b_of_type_Long	J
    ...
    //   9	351	12	localbgup	bgup
    //   15	593	13	localbguu	bguu
  ...
  private void b(long paramLong, boolean paramBoolean)
  {
    ...
    //   34: astore 6
    //   36: aload_0
    //   37: getfield 64	bgvl:jdField_a_of_type_Bgvm	Lbgvm;
    //   40: astore 7
    //   42: iload 5
    //   44: istore_3
    //   45: iload 4
    ...
    //   70: aload 10
    //   72: ldc 162
    //   74: getstatic 57	bgvl:b	[Ljava/lang/String;
    //   77: ldc 164
    //   79: iconst_1
    ...
    //   113: aload_0
    //   114: aload 7
    //   116: invokespecial 296	bgvl:a	(Landroid/database/Cursor;)Lbgut;
    //   119: astore 6
    //   121: aload 7
  ...
  private void b(String paramString)
  {
    ...
    //   15: ifnonnull +15 -> 30
    //   18: aload_0
    //   19: getfield 64	bgvl:jdField_a_of_type_Bgvm	Lbgvm;
    //   22: aload_1
    //   23: aload_2
    ...
    //   77: aload 5
    //   79: ldc 162
    //   81: getstatic 57	bgvl:b	[Ljava/lang/String;
    //   84: aload 4
    ...
    //   143: aload_0
    //   144: aload_2
    //   145: invokespecial 296	bgvl:a	(Landroid/database/Cursor;)Lbgut;
  ...
  public void a(int paramInt, bgut parambgut)
  {
    if (parambgut == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 1, paramInt, 0, parambgut));
  }
  ...
  public void a(bgut parambgut, boolean paramBoolean)
  {
    if (parambgut == null) {
      return;
    }
    bguu localbguu = parambgut.b();
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("_id", Long.valueOf(parambgut.a()));
    localContentValues.put("state", Integer.valueOf(localbguu.jdField_a_of_type_Int));
    localContentValues.put("error_code", Integer.valueOf(localbguu.jdField_b_of_type_Int));
    localContentValues.put("error_msg", localbguu.jdField_a_of_type_JavaLangString);
    localContentValues.put("total_size", Long.valueOf(localbguu.jdField_a_of_type_Long));
    localContentValues.put("cur_size", Long.valueOf(localbguu.jdField_b_of_type_Long));
    if (!TextUtils.isEmpty(localbguu.jdField_b_of_type_JavaLangString)) {
      localContentValues.put("local_path", localbguu.jdField_b_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(parambgut.c())) {
      localContentValues.put("file_version", parambgut.c());
    }
    parambgut = this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      parambgut.sendMessage(Message.obtain(null, 2, i, 0, new Object[] { localContentValues, localbguu }));
      return;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      b(paramMessage.arg1, (bgut)paramMessage.obj);
      return true;
    case 2: 
      ContentValues localContentValues = (ContentValues)((Object[])(Object[])paramMessage.obj)[0];
      bguu localbguu = (bguu)((Object[])(Object[])paramMessage.obj)[1];
      if (paramMessage.arg1 == 1) {
        bool1 = true;
      }
      a(localContentValues, localbguu, bool1);
      return true;
    case 3: 
