...
public class aimj
  implements aimi, Handler.Callback
{
  int jdField_a_of_type_Int = zby.b(BaseApplicationImpl.getContext(), 50.0F);
  private aful jdField_a_of_type_Aful;
  private aimh jdField_a_of_type_Aimh;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aimk(this);
  ...
  private ArrayList<aiml> jdField_a_of_type_JavaUtilArrayList;
  public List<QQOperationViopTipTask> a;
  private Observer jdField_a_of_type_JavaUtilObserver;
  protected final MqqHandler a;
  int jdField_b_of_type_Int = zby.b(BaseApplicationImpl.getContext(), 30.0F);
  Animation jdField_b_of_type_AndroidViewAnimationAnimation;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  Animation c;
  
  public aimj(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aful paramaful, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList)
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new bkfv(Looper.getMainLooper(), this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    this.jdField_a_of_type_Aful = paramaful;
  ...
  private RelativeLayout a()
  {
    ...
    //   23: putfield 111	aimj:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    //   28: new 113	java/io/File
    //   31: dup
    //   32: getstatic 119	oda:h	Ljava/lang/String;
    ...
    //   74: getstatic 119	oda:h	Ljava/lang/String;
    ...
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 111	aimj:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
  ...
  private boolean a(aiml paramaiml)
  {
    boolean bool3 = false;
    Object localObject1 = a(paramaiml.b());
    int i = -1;
    int[] arrayOfInt = paramaiml.a();
    boolean bool1;
    if (arrayOfInt != null)
    {
      if (this.jdField_a_of_type_Aimh != null) {
        i = this.jdField_a_of_type_Aimh.b();
      }
      boolean bool2 = true;
      int j = 0;
    ...
    for (;;)
    {
      if ((bool1) && ((paramaiml instanceof aimh)) && (this.jdField_a_of_type_Aimh != null) && (this.jdField_a_of_type_Aimh.a() > ((aimh)paramaiml).a()))
      {
  ...
  {
    if (this.jdField_a_of_type_Aimh != null) {
      return this.jdField_a_of_type_Aimh.b();
    }
    return -1;
  }
  ...
  public aimh a()
  {
    return this.jdField_a_of_type_Aimh;
  }
  ...
  public void a()
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_Aful != null) {
        this.jdField_a_of_type_Aful.a(this.jdField_a_of_type_Aimh);
      }
      this.jdField_a_of_type_Aimh = null;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((aiml)localIterator.next()).a(paramInt, paramVarArgs);
      }
    }
  }
  
  public void a(aiml paramaiml)
  {
    if (paramaiml == null) {}
    do
    {
    ...
    } while (this.jdField_a_of_type_JavaUtilArrayList.contains(paramaiml));
    this.jdField_a_of_type_JavaUtilArrayList.add(paramaiml);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131368038);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(paramOnClickListener);
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131364345));
    }
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368038) == null) {
  ...
  public boolean a(ailn paramailn, Object... paramVarArgs)
  {
    if (paramailn != null)
    {
      if (a(paramailn)) {
    ...
    {
      return false;
      paramVarArgs = paramailn.a(paramVarArgs);
      if (paramVarArgs != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramVarArgs, paramVarArgs.selfuin);
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showGrayTips() success: from " + a(paramailn.b()));
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TipsManager", 2, "showGrayTips() failure: MessageRecord null, from " + a(paramailn.b()));
    return false;
  }
  
  public boolean a(aimh paramaimh, Object... paramVarArgs)
  {
    if (afur.l) {}
    label136:
    do
    {
      ...
      if (Thread.currentThread() == Looper.getMainLooper().getThread())
      {
        paramVarArgs = paramaimh.a(paramVarArgs);
        this.jdField_a_of_type_Aful.a(paramVarArgs, paramaimh);
        this.jdField_a_of_type_Aimh = paramaimh;
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showTipsBar() success: from " + a(paramaimh.b()));
        }
        return true;
        paramVarArgs = new TipsManager.1(this, paramaimh, paramVarArgs);
  ...
  public void c()
  {
    ...
    View localView1 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379168);
    View localView2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379162);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        int k = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298998);
        if (i == -1) {
        ...
        for (i = j + k;; i = j)
        {
          ...
          localLayoutParams.rightMargin = zby.b(BaseApplicationImpl.getContext(), 40.0F);
  ...
  public void d()
  {
    ...
    try
    {
      if ((this.jdField_b_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368038) != null))
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(null);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366873));
        this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366874));
