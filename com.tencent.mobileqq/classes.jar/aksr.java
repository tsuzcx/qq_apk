...
public class aksr
{
  ...
  private aksq jdField_a_of_type_Aksq;
  private aksu jdField_a_of_type_Aksu;
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    if (!new File(paramString).exists())
    {
      ...
      bbdj.a(paramContext, paramString, str);
    }
    try
    {
      nay.a(new File(str), a());
  ...
  private boolean a(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      Resources localResources = new Resources(localAssetManager, this.jdField_a_of_type_Aksu.b().getDisplayMetrics(), this.jdField_a_of_type_Aksu.b().getConfiguration());
      ...
      {
        this.jdField_a_of_type_Aksu.a(localResources, paramContext);
  ...
  private void e(Context paramContext)
  {
    try
    {
      ...
      ((Field)localObject2).set(paramContext, this.jdField_a_of_type_Aksq);
      QLog.d("MultiLanguageEngine", 1, new Object[] { "success in delegate ContextImpl resources:", this.jdField_a_of_type_Aksq.toString(), " ,old:", localObject3.toString() });
      ...
      ((Field)localObject1).set(paramContext, this.jdField_a_of_type_Aksq);
      QLog.d("MultiLanguageEngine", 1, new Object[] { "success in delegate LoadedApk resources:", this.jdField_a_of_type_Aksq.toString(), " ,old:", localObject2.toString(), " ,cost:", Long.valueOf(System.currentTimeMillis() - l) });
      return;
    }
    catch (Exception paramContext)
    {
  ...
  public void a(Activity paramActivity)
  {
    ...
    do
    {
      return;
      l = System.currentTimeMillis();
      LayoutInflater.from(paramActivity).setFactory2(new akst(paramActivity));
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Aksu = new aksu(paramContext);
    this.jdField_a_of_type_Aksq = new aksq(this.jdField_a_of_type_Aksu);
    e(paramContext);
  }
  ...
  public void b(Context paramContext)
  {
    ...
    while (this.jdField_a_of_type_Aksu == null) {
      return;
    }
    this.jdField_a_of_type_Aksu.a(null, null);
  }
