  ...
  extends anii
{
  ...
  public anie(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(int paramInt)
  {
    ...
    tmp6_5[0] = 2131695441;
    int[] tmp11_6 = tmp6_5;
    tmp11_6[1] = 2131695437;
    int[] tmp16_11 = tmp11_6;
    tmp16_11[2] = 2131695433;
    int[] tmp21_16 = tmp16_11;
    tmp21_16[3] = 2131695436;
    int[] tmp26_21 = tmp21_16;
    tmp26_21[4] = 2131695440;
    int[] tmp31_26 = tmp26_21;
    tmp31_26[5] = 2131695438;
    int[] tmp36_31 = tmp31_26;
    tmp36_31[6] = 2131695443;
    int[] tmp42_36 = tmp36_31;
    tmp42_36[7] = 2131695435;
    int[] tmp48_42 = tmp42_36;
    tmp48_42[8] = 2131695442;
    int[] tmp54_48 = tmp48_42;
    tmp54_48[9] = 2131695434;
    int[] tmp60_54 = tmp54_48;
    tmp60_54[10] = 2131695439;
    tmp60_54;
  ...
  private void a(cmd0x874.RspBody paramRspBody)
  {
    ...
    if ((TextUtils.isEmpty(paramRspBody)) || (TextUtils.equals("0", paramRspBody)))
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "handleTransferDiscussionToTroop, troopUin:" + paramRspBody + "  discussionUin:" + str);
      }
      return;
    }
    ...
    if (localObject2 != null) {
      ((anwd)localObject2).j(((TroopInfo)localObject1).troopuin);
    }
    localObject2 = (berf)this.app.getManager(32);
    if (localObject2 != null) {
      ((berf)localObject2).a(this.app, ((TroopInfo)localObject1).troopuin);
    }
    ...
    ((ankw)localObject1).jdField_a_of_type_JavaUtilMap.put(str, new String[] { paramRspBody, this.app.getCurrentAccountUin() });
    ((ankw)localObject1).jdField_a_of_type_JavaUtilSet.add(paramRspBody);
    notifyUI(41, true, new Object[] { Integer.valueOf(2131695441), str, paramRspBody, Boolean.valueOf(true) });
  }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      try
      {
        paramToServiceMsg = bfpq.a(l, paramFromServiceMsg.opt_msg_record.get().toByteArray(), paramFromServiceMsg.uint32_cur_cnt.get());
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (antq)this.app.getManager(22);
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
    ...
    if (bgnt.a(this.app.getApplication().getApplicationContext()) == 1)
    {
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (j == 1)
      {
        ...
        if (i == 1224)
        {
          bgsg.j(this.app.getApplication().getApplicationContext(), this.app.getCurrentAccountUin(), (String)localObject2);
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = bftr.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
      } while ((TextUtils.isEmpty(str)) || (paramToServiceMsg == null));
      short s = (short)paramToServiceMsg.length;
      if ("OidbSvc.0x852_35".equals(str))
      {
        bftr.a(this.app, i, l1, l2, s, paramToServiceMsg, l3, paramFromServiceMsg, j);
        return;
      }
      if ("OidbSvc.0x852_48".equals(str))
      {
        bftr.a(this.app, i, l1, l2, s, paramToServiceMsg, (short)k, bool);
        return;
      }
    } while (!"OidbSvc.0x8ca_2".equals(str));
    ((anwd)this.app.a(20)).a(this.app, "" + l1, paramToServiceMsg, i);
  }
  ...
  private void l(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (byte[])paramObject;
    bftr.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
  }
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = (byte[])paramObject;
        paramToServiceMsg = bftr.a(this.app, l1, l2, paramToServiceMsg, j, i, bool);
  ...
  {
    berq localberq = new berq();
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      notifyUI(28, false, localberq);
      return;
    }
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
  ...
  private void o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      notifyUI(41, false, new Object[] { Integer.valueOf(2131695434) });
      return;
    }
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
  ...
  private void p(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      if (i == 2)
      {
        ((bfsk)this.app.getManager(48)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      }
      if (i == 3)
      {
  ...
  private void r(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        if (i == 1328) {
          paramToServiceMsg[2] = anni.a(2131699961);
        }
  ...
  public void a(String paramString1, int paramInt, @Nullable String paramString2)
  {
    ...
    if (bgsg.a(this.app.getApplication(), this.app.getCurrentAccountUin()).contains(str))
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (i == 0)
    {
      QQToast.a(BaseApplication.getContext(), 2131695415, 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131298998));
      return false;
    }
