...
public class bcpx
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      do
      {
        ...
        localStringBuilder.append(abti.b());
  ...
  {
    return a(paramResources, paramInt, paramResources.getDrawable(2130849148));
  }
  ...
  public static Pair<String, ArrayList<MessageForText.AtTroopMemberInfo>> a(Editable paramEditable)
  {
    ...
    paramEditable = bciq.a(paramEditable, localArrayList);
  ...
  public static bcxl a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    if ((paramBaseActivity == null) || (paramBaseActivity.isFinishing()) || (paramTroopInfoData == null) || (paramQQAppInterface == null)) {
      return null;
    }
    paramBaseActivity = new bcxl(paramBaseActivity, paramTroopInfoData, new bcpy(paramTroopInfoData));
    paramBaseActivity.a(paramTroopInfoData);
    azqs.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_share", 0, 0, paramTroopInfoData.troopUin, "", "", "");
    if (paramTroopInfoData.isMember) {
      bdes.a("Grp_set_new", "grpData_admin", "clk_share", 0, 0, new String[] { paramTroopInfoData.troopUin, bdes.a(paramTroopInfoData) });
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l > 0L)
        {
          ...
          localTroopInfoData.mStrJoinQuestion = bdet.b(paramContext, localTroopInfoData.troopUin);
          localTroopInfoData.nTroopGrade = paramBundle.getInt("TROOP_INFO_TROOP_GRADE");
          localTroopInfoData.mStrJoinAnswer = bdet.c(paramContext, localTroopInfoData.troopUin);
  ...
  public static String a(Context paramContext, long paramLong)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      localObject = paramContext.getResources().getString(2131696604) + ((SimpleDateFormat)localObject).format(Long.valueOf(1000L * paramLong));
    }
    return localObject;
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      str = "0";
      paramQQAppInterface = paramString.replace("$GCODE$", paramTroopInfoData.troopUin).replace("$CLIENTVER$", "android8.3.5").replace("$UIN$", paramQQAppInterface.getCurrentAccountUin()).replace("$LANG$", "zh_CN").replace("$GROUPAPPID$", Long.toString(paramLong)).replace("$ROLE$", str);
      if (!paramBoolean) {
        break label169;
      }
    }
  ...
  public static void a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localObject = (amdu)localQQAppInterface.a(20);
      ((amdu)localObject).notifyUI(2, false, null);
      ((aloz)localQQAppInterface.a(22)).notifyUI(43, true, new Object[] { str, paramString, null });
      if (i != 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopUtils", 2, "TroopUtils handleModifyName :" + localTroopInfo.troopname);
        }
        ((amdu)localObject).b(str, String.valueOf(paramLong2), paramString);
      }
      return;
    }
  }
  ...
  {
    beuj localbeuj = new beuj(paramActivity);
    ...
    case 10: 
    default: 
      localbeuj.a(2131693805, i, 0, 1);
      return;
    case 2: 
      localbeuj.a(alud.a(2131716208), i, 0, 1);
      return;
    case 3: 
      localbeuj.a(alud.a(2131716197), i, 0, 1);
      return;
    case 4: 
      localbeuj.a(alud.a(2131716203), i, 0, 1);
      return;
    case 5: 
      localbeuj.a(alud.a(2131716198), i, 0, 1);
      return;
    }
    localbeuj.a(2131721056, i, 0, 1);
  }
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    VasWebviewUtil.openQQBrowserWithoutAD(paramActivity, bdtg.a(paramActivity, "background", ""), 33554432L, localIntent, true, paramInt);
    azqs.b(paramQQAppInterface, "CliOper", "", "", "0X8004E0E", "0X8004E0E", 0, 0, "", "", "", "");
  }
  ...
  {
    new beuj(paramContext).a(paramInt2, paramInt1, 0, paramInt3);
  }
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    paramContext = bdgc.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramString, false);
    Intent localIntent = aepi.a(new Intent((Context)localObject, SplashActivity.class), null);
    localIntent.putExtra("uin", paramString);
    localIntent.putExtra("uintype", 1);
  ...
  public static void a(View paramView, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, boolean paramBoolean, String paramString1, String paramString2, awrr paramawrr)
  {
    ...
    while (TextUtils.isEmpty(paramCharSequence2))
    {
      ...
      if (paramBoolean) {
        awrq.a(paramView, paramString1, paramString2, paramawrr);
      }
    }
  ...
  public static void a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      bdes.a("Grp_set_new", "grpData_admin", "clk_report", 0, 0, new String[] { paramTroopInfoData.troopUin, bdes.a(paramTroopInfoData) });
      paramTroopInfoData = zdv.a(str1, 1);
      zdv.a(paramBaseActivity, str1, null, null, str1, paramQQAppInterface.getAccount(), i, null, paramTroopInfoData);
      return;
      if (paramTroopInfoData.isMember) {
        i = 22000;
      } else {
    ...
    {
      bdes.a("Grp_set_new", "grpData_visitor", "clk_report", 0, 0, new String[] { str2, paramTroopInfoData });
  ...
  {
    if (bdgg.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString) != 0) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0) {
        bdgg.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString, 0);
      }
      Intent localIntent = new Intent();
      ...
      azqs.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp", "Clk_grpinfo_files", 0, 0, paramString, "0", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString2 = (bclu)paramQQAppInterface.getManager(109);
    ...
    for (int i = 32;; i = 0)
    {
      ...
      for (paramString2 = paramString2.url.replace("$GCODE$", paramString1);; paramString2 = null)
      {
        ...
        azqs.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, paramString1, "", "", "");
        return;
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      bool = true;
      localbjea = bjea.a();
      localbjea.jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
      localbjea.b = paramQQAppInterface.getCurrentNickname();
      amdu localamdu = (amdu)paramQQAppInterface.a(20);
      if (!TextUtils.isEmpty(paramString1)) {
        localamdu.e(paramString1, true);
      }
      if (bdgg.a(paramQQAppInterface.getCurrentAccountUin(), "troop_photo_message", paramString1) <= 0) {
        break label123;
      }
      bjdt.d(paramActivity, localbjea, paramString1, 7);
    }
    for (;;)
    {
      azqs.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_album", 0, 0, paramString1, "", "", "");
      nco.a(paramQQAppInterface, 66);
      return;
      bool = false;
      break;
      label123:
      bjdt.a(paramActivity, localbjea, paramString1, paramString2, bool, 7);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, bckx parambckx)
  {
    ...
    if (str1.length() < 10)
    {
      ...
      a(paramQQAppInterface, paramContext, str3, parambckx, 0, null);
    ...
    for (;;)
    {
      ...
      new bcky(localStringBuilder.toString(), "GET", parambckx, 1, null).a(paramQQAppInterface);
      return;
      ((StringBuilder)localObject1).append("0");
      ((StringBuilder)localObject1).append(str1);
      break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Bundle paramBundle)
  {
    ...
    localIntent.putExtras(paramBundle);
    paramContext.startActivity(localIntent);
    azqs.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, str, "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageRecord paramMessageRecord, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      ((amdu)paramQQAppInterface.a(20)).c(paramString1, 2, i);
      azqs.b(paramQQAppInterface, "dc00898", "", "", "0X800AD4F", "0X800AD4F", (int)l, 0, String.valueOf(j), "", "", "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    if (localTroopManager != null)
    {
      ...
      if (paramString != null)
      {
        ...
        {
          paramQQAppInterface = new bcxl((BaseActivity)paramContext, localTroopInfoData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    if (paramContext != null)
    {
      ...
      awrt.a(paramContext, paramQQAppInterface, localIntent, paramInt);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, bckx parambckx, int paramInt, Bundle paramBundle)
  {
    Bundle localBundle = new Bundle();
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    new bcky(localStringBuilder.toString(), "GET", parambckx, paramInt, paramBundle).a(paramQQAppInterface);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    try
    {
      ...
      if ((paramMessageForUniteGrayTip != null) && (paramMessageForUniteGrayTip.length > 1))
      {
        ...
        azqs.b(paramQQAppInterface, "dc00898", "", "", "0X800AD4E", "0X800AD4E", (int)Long.parseLong(paramMessageForUniteGrayTip[1]), 0, String.valueOf(i), "", "", "");
      }
      return;
    }
    catch (Exception paramQQAppInterface)
  ...
  {
    paramQQAppInterface = (auga)paramQQAppInterface.getManager(37);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, List<oidb_0xe3b.HighlightTitle> paramList, int paramInt2, long paramLong)
  {
    ...
    {
      localaspy = new aspy(paramString1, paramString1, paramString2, 1, -5020, 131088, ayzl.a());
      if (paramList != null)
      {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<ChatMessage> paramList)
  {
        ...
        if (i < paramList.size())
        {
          ...
          if ((!(localChatMessage instanceof MessageForGrayTips)) && ((!(localChatMessage instanceof MessageForUniteGrayTip)) || (localChatMessage.time == l)))
          {
            ...
            if ((localChatMessage instanceof MessageForSplitLineTips))
            {
              ...
              if (!alud.a(2131716200).equalsIgnoreCase(((MessageForSplitLineTips)localObject2).msgContent)) {
                break;
              }
            }
          }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (MessageForSplitLineTips)azaf.a(-4012);
        ((MessageForSplitLineTips)localObject2).init(paramQQAppInterface.getCurrentAccountUin(), paramString, paramQQAppInterface.getCurrentAccountUin(), alud.a(2131716205), l, -4012, 1, l);
        ...
        ((MessageForSplitLineTips)localObject2).msgContent = alud.a(2131716206);
  ...
  public static void a(TroopInfoData paramTroopInfoData, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      azqs.b(null, "P_CliOper", "Grp_nearby", "", "recom", "Clk_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 18)
    {
      azqs.b(null, "P_CliOper", "Grp_join", "", "join_page", "Clk_join", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 24)
    {
      azqs.b(null, "P_CliOper", "Grp_nearby", "", "search", "Clk_joingrp", 0, 0, "", "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 17)
    {
      azqs.b(null, "CliOper", "", "", "Grp_recommend", "viewinfor_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    int i = -1;
    int j;
    ...
    for (;;)
    {
      ...
      azqs.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", "" + i, paramInt2 + "");
      azqs.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp1", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", paramInt3 + "", "");
      return;
      i = 0;
      break;
      i = 1;
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      ...
      bdea.a(BaseApplicationImpl.getApplication(), paramString, paramString);
    } while (!QLog.isColorLevel());
  ...
  public static void a(List<String> paramList)
  {
    ...
    {
      bcpg localbcpg = (bcpg)((QQAppInterface)localObject).getManager(203);
      localObject = null;
      Iterator localIterator = paramList.iterator();
      if (localIterator.hasNext())
      {
  ...
  public static void a(AppRuntime paramAppRuntime, TroopInfo paramTroopInfo, Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity.setTitle(alud.a(2131716201)).setMessage(alud.a(2131716199)).setPositiveButton(alud.a(2131716207), paramOnClickListener);
    paramActivity.show();
    bdes.a("Grp_manage_new", "gainUin_msgBox", "exp", 0, 0, new String[] { String.valueOf(paramTroopInfo.troopuin), "", bdes.a(paramTroopInfo, paramAppRuntime) });
  }
  ...
  public static void a(boolean paramBoolean, TextView paramTextView)
  {
    if (paramBoolean)
    {
      ...
      paramTextView.setCompoundDrawablePadding(aepi.a(10.0F, BaseApplicationImpl.getApplication().getResources()));
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130841117, 0);
      return;
    }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        return false;
        if (!TextUtils.equals("4555", paramContext)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.i("TroopUtils", 2, String.format("isUpdateBeforeSomeVersion pre: %s, cur: %s", new Object[] { "4555", paramContext }));
      return false;
  ...
  {
    if ((paramTabInfo != null) && (paramTabInfo.appid.get() == 1106837471L) && ((paramView.getTag(2131377447) instanceof Integer))) {
      return ((Integer)paramView.getTag(2131377447)).intValue() == 1;
    }
    return false;
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    return (amdu.jdField_a_of_type_Boolean) && (localTroopManager.b());
  }
  ...
  {
    String str = bdea.a(BaseApplicationImpl.getApplication(), paramString);
    if (QLog.isColorLevel()) {
