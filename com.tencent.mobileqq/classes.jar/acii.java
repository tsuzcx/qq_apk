  ...
  extends BaseAdapter
{
  ...
  public acii(DragSortListView paramDragSortListView, ListAdapter paramListAdapter)
  {
    this.jdField_a_of_type_AndroidWidgetListAdapter = paramListAdapter;
    this.jdField_a_of_type_AndroidWidgetListAdapter.registerDataSetObserver(new acij(this, paramDragSortListView));
  }
