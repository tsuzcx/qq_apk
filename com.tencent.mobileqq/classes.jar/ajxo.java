...
public class ajxo
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = bbdx.a(new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), bboe.f.a));
      Object localObject2 = "";
      String str = "";
      j = 1;
      i = j;
  ...
  public static void a(boolean paramBoolean, Context paramContext, List<CustomEmotionData> paramList, AppInterface paramAppInterface, IPicDownloadListener paramIPicDownloadListener)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localbbwz = ((bbww)paramAppInterface.getManager(47)).a(1);
      } while (localbbwz == null);
      answ localansw = (answ)paramAppInterface.getManager(149);
      anua localanua = (anua)paramAppInterface.getManager(141);
      ...
      for (;;)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            if (localbbwz.a(localCustomEmotionData.url) != null)
            {
            ...
            boolean bool1 = false;
            File localFile;
            if ((localanua != null) && (localanua.a(localCustomEmotionData))) {
              if ((!TextUtils.isEmpty(localCustomEmotionData.emoPath)) && (localCustomEmotionData.emoPath.startsWith(ajsd.bh)))
              {
            ...
            for (;;)
            {
              ...
              {
                paramList = localanua.a(localCustomEmotionData.md5);
                break label234;
              }
              if (!TextUtils.isEmpty(localCustomEmotionData.resid))
              {
                paramList = paramList + akvt.a(localCustomEmotionData.resid);
                break label234;
              }
              ...
              localbbwz.a(localbbwu, new ajxp(paramList, localFile, localCustomEmotionData, bool1, paramBoolean, localansw, paramIPicDownloadListener, localArrayList1, localArrayList2, paramContext, localAtomicInteger2, localAtomicInteger1), null);
            }
            continue;
          }
          if (paramIPicDownloadListener != null) {
