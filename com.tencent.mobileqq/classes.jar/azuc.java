...
public class azuc
{
  ...
  private static volatile azuc jdField_a_of_type_Azuc;
  private static final RecyclablePool jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(azub.class, 50);
  public static final String[] a;
  public static final String[] b;
  private long jdField_a_of_type_Long;
  private azue jdField_a_of_type_Azue = new azue(null);
  private azuf jdField_a_of_type_Azuf = new azuf(null);
  private String jdField_a_of_type_JavaLangString = "";
  private Field jdField_a_of_type_JavaLangReflectField;
  private Method jdField_a_of_type_JavaLangReflectMethod;
  private ArrayList<azub> jdField_a_of_type_JavaUtilArrayList = new ArrayList(20);
  private boolean jdField_a_of_type_Boolean = true;
  private Field jdField_b_of_type_JavaLangReflectField;
  private ArrayList<azub> jdField_b_of_type_JavaUtilArrayList = new ArrayList(40);
  private boolean jdField_b_of_type_Boolean;
  private ArrayList<azub> c = new ArrayList(7);
  private ArrayList<azub> d = new ArrayList(7);
  ...
  private long a(String paramString1, String paramString2)
  {
    ...
    azub localazub = (azub)jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(azub.class);
    localazub.jdField_a_of_type_JavaLangString = paramString2;
    localazub.jdField_a_of_type_Boolean = true;
    localazub.jdField_a_of_type_Long = localFile.length();
    localazub.jdField_b_of_type_JavaLangString = (paramString1 + "/" + paramString2);
    localazub.jdField_b_of_type_Long = a(localFile);
    localazub.c = 1L;
    if (localazub.jdField_a_of_type_Long >= 524288.0D) {
      QLog.d("StorageReport", 1, "--scan qq-- file info: " + localazub.toString());
    }
    if (localazub.jdField_a_of_type_Long >= 2097152L) {
      a(localazub);
    }
    a(localazub, localazub.jdField_a_of_type_Long);
    if (this.jdField_a_of_type_JavaUtilArrayList.size() < 20)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(localazub);
      if (this.jdField_a_of_type_JavaUtilArrayList.size() == 20) {
        Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_Azue);
      }
      return localazub.jdField_a_of_type_Long;
    }
    paramString1 = (azub)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_JavaUtilArrayList.size() - 1);
    if ((this.jdField_a_of_type_JavaUtilArrayList.size() >= 20) && (localazub.jdField_b_of_type_Long > paramString1.jdField_b_of_type_Long))
    {
    ...
    jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.recycle(localazub);
    return localazub.jdField_a_of_type_Long;
  }
  ...
  public static azuc a()
  {
    if (jdField_a_of_type_Azuc == null) {}
    try
    {
      if (jdField_a_of_type_Azuc == null) {
        jdField_a_of_type_Azuc = new azuc();
      }
      return jdField_a_of_type_Azuc;
    }
    finally {}
  }
  
  private String a(ArrayList<azub> paramArrayList)
  {
    StringBuilder localStringBuilder = new StringBuilder(64);
    int i = 0;
    while (i < paramArrayList.size())
    {
      azub localazub = (azub)paramArrayList.get(i);
      localStringBuilder.append(localazub.c);
      localStringBuilder.append("-").append(localazub.jdField_a_of_type_Long);
  ...
  private void a(azub paramazub)
  {
    ...
    localHashMap.put("path", paramazub.jdField_b_of_type_JavaLangString);
    localHashMap.put("name", paramazub.jdField_a_of_type_JavaLangString);
    localHashMap.put("size", String.valueOf(paramazub.jdField_a_of_type_Long));
    localHashMap.put("accessTime", String.valueOf(paramazub.jdField_b_of_type_Long));
    localHashMap.put("isFile", String.valueOf(paramazub.jdField_a_of_type_Boolean));
    localHashMap.put("fileCount", String.valueOf(paramazub.c));
    localHashMap.put("dirCount", String.valueOf(paramazub.d));
    if (QLog.isColorLevel()) {
      QLog.d("StorageReport", 2, "--scan qq-- file report to tdw : report key = " + this.jdField_a_of_type_JavaLangString + ",item info=" + paramazub.toString());
    }
    azri.a(BaseApplicationImpl.getApplication()).a(null, "qqStorageReport", true, 0L, 0L, localHashMap, null);
  }
  
  private void a(azub paramazub, long paramLong)
  {
    int i = 0;
    if ((paramazub == null) || (TextUtils.isEmpty(paramazub.jdField_b_of_type_JavaLangString))) {
      return;
    }
    if (paramLong < 10240L) {
      if (!paramazub.jdField_b_of_type_JavaLangString.contains("data/data/com.tencent.mobileqq")) {
        break label197;
      }
    }
    label197:
    for (paramazub = (azub)this.d.get(i);; paramazub = (azub)this.c.get(i))
    {
      paramazub.jdField_a_of_type_Long += paramLong;
      paramazub.c += 1L;
      return;
  ...
  /* Error */
  public long a(adry paramadry, int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   20: ldc2_w 378
    //   23: ldiv
    //   24: putfield 380	azuc:jdField_a_of_type_Long	J
    ...
    //   49: putfield 98	azuc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   52: aload_0
    //   53: new 121	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   60: aload_0
    //   61: getfield 98	azuc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   73: aload_0
    //   74: getfield 380	azuc:jdField_a_of_type_Long	J
    ...
    //   86: putfield 98	azuc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   112: lstore 6
    //   114: aload_0
    //   115: getfield 94	azuc:jdField_a_of_type_Boolean	Z
    //   118: ifeq +41 -> 159
    //   121: lload 6
    //   123: lconst_0
    //   124: lcmp
    //   125: ifle +34 -> 159
    //   128: aload_0
    //   129: getfield 380	azuc:jdField_a_of_type_Long	J
    //   132: lload 6
    //   134: lsub
    ...
    //   145: aload_0
    //   146: iconst_0
    //   147: putfield 94	azuc:jdField_a_of_type_Boolean	Z
    //   150: ldc 164
    //   152: iconst_2
    //   153: ldc_w 413
    //   156: invokestatic 172	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   159: aload_0
    //   160: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   163: invokevirtual 416	java/util/ArrayList:clear	()V
    //   166: aload_0
    //   167: getfield 78	azuc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   170: invokevirtual 416	java/util/ArrayList:clear	()V
    //   173: aload_0
    //   174: getfield 100	azuc:c	Ljava/util/ArrayList;
    //   177: invokevirtual 416	java/util/ArrayList:clear	()V
    //   180: aload_0
    //   181: getfield 102	azuc:d	Ljava/util/ArrayList;
    ...
    //   195: getstatic 34	azuc:jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool	Lcom/tencent/commonsdk/pool/RecyclablePool;
    //   198: ldc 28
    ...
    //   203: checkcast 28	azub
    //   206: astore 65
    //   208: aload 65
    //   210: lconst_0
    //   211: putfield 151	azub:jdField_a_of_type_Long	J
    //   214: aload 65
    //   216: lconst_0
    //   217: putfield 160	azub:c	J
    //   220: aload_0
    //   221: getfield 100	azuc:c	Ljava/util/ArrayList;
    //   224: aload 65
    //   226: invokevirtual 188	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   229: pop
    //   230: getstatic 34	azuc:jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool	Lcom/tencent/commonsdk/pool/RecyclablePool;
    //   233: ldc 28
    ...
    //   238: checkcast 28	azub
    //   241: astore 65
    //   243: aload 65
    //   245: lconst_0
    //   246: putfield 151	azub:jdField_a_of_type_Long	J
    //   249: aload 65
    //   251: lconst_0
    //   252: putfield 160	azub:c	J
    //   255: aload_0
    //   256: getfield 102	azuc:d	Ljava/util/ArrayList;
    //   259: aload 65
    ...
    //   275: dup
    //   276: getstatic 62	azuc:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   279: iconst_0
    //   280: aaload
    ...
    //   334: getstatic 62	azuc:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   337: iconst_0
    //   338: aaload
    ...
    //   370: new 28	azub
    //   373: dup
    //   374: invokespecial 417	azub:<init>	()V
    //   377: astore 67
    //   379: aload 67
    //   381: iconst_0
    //   382: putfield 145	azub:jdField_a_of_type_Boolean	Z
    //   385: aload 67
    //   387: aload_0
    //   388: aload 66
    //   390: invokevirtual 156	azuc:a	(Ljava/io/File;)J
    //   393: putfield 158	azub:jdField_b_of_type_Long	J
    //   396: aload 67
    //   398: aload 65
    //   400: iload_2
    //   401: aaload
    //   402: putfield 144	azub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   405: aload 67
    //   407: new 121	java/lang/StringBuilder
    //   410: dup
    //   411: invokespecial 122	java/lang/StringBuilder:<init>	()V
    //   414: getstatic 62	azuc:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   417: iconst_0
    //   418: aaload
    ...
    //   437: putfield 153	azub:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   440: aload 67
    //   442: lconst_0
    //   443: putfield 160	azub:c	J
    //   446: aload 67
    //   448: lconst_0
    //   449: putfield 327	azub:d	J
    //   452: aload_0
    //   453: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   456: aload 67
    ...
    //   465: lload 12
    //   467: aload_0
    //   468: getstatic 62	azuc:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   471: iconst_0
    //   472: aaload
    //   473: aload 65
    //   475: iload_2
    //   476: aaload
    //   477: invokespecial 234	azuc:a	(Ljava/lang/String;Ljava/lang/String;)J
    //   480: ladd
    //   481: lstore 12
    //   483: lload 10
    //   485: lconst_1
    ...
    //   489: goto +2521 -> 3010
    //   492: iload_2
    //   493: getstatic 62	azuc:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   496: arraylength
    //   497: if_icmpge +2538 -> 3035
    //   500: getstatic 62	azuc:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   503: iload_2
    //   504: aaload
    //   505: astore 65
    ...
    //   526: new 28	azub
    //   529: dup
    //   530: invokespecial 417	azub:<init>	()V
    //   533: astore 67
    //   535: aload 67
    //   537: iconst_0
    //   538: putfield 145	azub:jdField_a_of_type_Boolean	Z
    //   541: aload 67
    //   543: aload_0
    //   544: aload 66
    //   546: invokevirtual 156	azuc:a	(Ljava/io/File;)J
    //   549: putfield 158	azub:jdField_b_of_type_Long	J
    //   552: aload 67
    //   554: aload 65
    //   556: ldc 128
    ...
    //   561: iconst_2
    //   562: aaload
    //   563: putfield 144	azub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   566: aload 67
    //   568: aload 65
    //   570: putfield 153	azub:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   573: aload 67
    //   575: lconst_0
    //   576: putfield 160	azub:c	J
    //   579: aload 67
    //   581: lconst_0
    //   582: putfield 327	azub:d	J
    //   585: aload_0
    //   586: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   589: aload 67
    //   591: invokevirtual 188	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   594: pop
    //   595: goto +2433 -> 3028
    //   598: iload_2
    //   599: getstatic 68	azuc:jdField_b_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   602: arraylength
    //   603: if_icmpge +274 -> 877
    //   606: getstatic 68	azuc:jdField_b_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   609: iload_2
    //   610: aaload
    //   611: astore 65
    ...
    //   763: new 28	azub
    //   766: dup
    //   767: invokespecial 417	azub:<init>	()V
    //   770: astore 68
    //   772: aload 68
    //   774: iconst_0
    //   775: putfield 145	azub:jdField_a_of_type_Boolean	Z
    //   778: aload 68
    //   780: aload_0
    //   781: aload 67
    //   783: invokevirtual 156	azuc:a	(Ljava/io/File;)J
    //   786: putfield 158	azub:jdField_b_of_type_Long	J
    //   789: aload 68
    //   791: aload 66
    //   793: iload 4
    //   795: aaload
    //   796: putfield 144	azub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   799: aload 68
    ...
    //   829: putfield 153	azub:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   832: aload 68
    //   834: lconst_0
    //   835: putfield 160	azub:c	J
    //   838: aload 68
    //   840: lconst_0
    //   841: putfield 327	azub:d	J
    //   844: aload_0
    //   845: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   848: aload 68
    ...
    //   867: iload 4
    //   869: aaload
    //   870: invokespecial 234	azuc:a	(Ljava/lang/String;Ljava/lang/String;)J
    //   873: pop2
    //   874: goto +2166 -> 3040
    //   877: ldc 164
    //   879: iconst_2
    ...
    //   893: aload_0
    //   894: getfield 380	azuc:jdField_a_of_type_Long	J
    ...
    //   943: lstore 6
    //   945: aload_0
    //   946: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   960: aload_0
    //   961: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   979: aload_0
    //   980: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   983: iload_2
    //   984: invokevirtual 198	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   987: checkcast 28	azub
    //   990: astore 65
    //   992: aload 65
    //   994: lconst_0
    //   995: putfield 151	azub:jdField_a_of_type_Long	J
    //   998: aload 65
    //   1000: lconst_0
    //   1001: putfield 160	azub:c	J
    //   1004: aload 65
    //   1006: lconst_0
    //   1007: putfield 327	azub:d	J
    //   1010: aload 65
    //   1012: getfield 153	azub:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   1015: astore 66
    //   1017: lload 6
    //   1019: lstore 62
    //   1021: lload 14
    ...
    //   1250: invokespecial 438	azuc:a	(Ljava/lang/String;)Landroid/os/Bundle;
    //   1253: astore 68
    //   1255: lload 6
    //   1257: lstore 62
    //   1259: lload 14
    ...
    //   1295: aload 65
    //   1297: aload 65
    //   1299: getfield 151	azub:jdField_a_of_type_Long	J
    //   1302: aload 68
    //   1304: ldc 242
    //   1306: lconst_0
    //   1307: invokevirtual 439	android/os/Bundle:getLong	(Ljava/lang/String;J)J
    //   1310: ladd
    //   1311: putfield 151	azub:jdField_a_of_type_Long	J
    //   1314: lload 6
    //   1316: lstore 62
    //   1318: lload 14
    //   1320: lstore 46
    ...
    //   1602: lload 20
    //   1604: aload 65
    //   1606: getfield 151	azub:jdField_a_of_type_Long	J
    //   1609: ladd
    //   1610: lstore 30
    //   1612: lload 6
    //   1614: lstore 62
    ...
    //   1776: lload 54
    //   1778: aload 65
    //   1780: getfield 151	azub:jdField_a_of_type_Long	J
    //   1783: ladd
    //   1784: lstore 54
    //   1786: lload 26
    //   1788: lstore 62
    ...
    //   1842: aload 65
    //   1844: invokevirtual 167	azub:toString	()Ljava/lang/String;
    ...
    //   1903: imul
    //   1904: aload_0
    //   1905: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   1968: lload 24
    //   1970: aload 65
    //   1972: getfield 151	azub:jdField_a_of_type_Long	J
    //   1975: ladd
    //   1976: lstore 52
    //   1978: lload 6
    //   1980: lstore 62
    ...
    //   2231: lload 32
    //   2233: aload 65
    //   2235: getfield 151	azub:jdField_a_of_type_Long	J
    //   2238: ladd
    //   2239: lstore 44
    //   2241: lload 6
    //   2243: lstore 62
    ...
    //   2445: goto -553 -> 1892
    //   2448: aload_0
    //   2449: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   2452: aload_0
    //   2453: getfield 92	azuc:jdField_a_of_type_Azuf	Lazuf;
    ...
    //   2470: iload_2
    //   2471: aload_0
    //   2472: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   2475: invokevirtual 184	java/util/ArrayList:size	()I
    //   2478: if_icmpge +25 -> 2503
    //   2481: aload_0
    //   2482: aload_0
    //   2483: getfield 80	azuc:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   2486: iload_2
    //   2487: invokevirtual 198	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   2490: checkcast 28	azub
    //   2493: invokespecial 177	azuc:a	(Lazub;)V
    //   2496: iload_2
    //   2497: iconst_1
    //   2498: iadd
    //   2499: istore_2
    ...
    //   2530: new 28	azub
    //   2533: dup
    //   2534: invokespecial 417	azub:<init>	()V
    //   2537: astore 65
    //   2539: aload 65
    //   2541: iconst_0
    //   2542: putfield 145	azub:jdField_a_of_type_Boolean	Z
    //   2545: aload 65
    //   2547: ldc_w 466
    //   2550: putfield 153	azub:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   2553: aload 65
    //   2555: lload 16
    //   2557: lload 22
    //   2559: ladd
    ...
    //   2573: lload 6
    //   2575: ladd
    //   2576: putfield 327	azub:d	J
    //   2579: aload 65
    //   2581: lconst_0
    //   2582: putfield 158	azub:jdField_b_of_type_Long	J
    //   2585: aload 65
    //   2587: lload 54
    //   2589: putfield 151	azub:jdField_a_of_type_Long	J
    //   2592: aload_0
    //   2593: aload 65
    //   2595: invokespecial 177	azuc:a	(Lazub;)V
    //   2598: ldc 164
    //   2600: iconst_1
    ...
    //   2614: aload 65
    //   2616: invokevirtual 167	azub:toString	()Ljava/lang/String;
    ...
    //   2628: new 28	azub
    //   2631: dup
    //   2632: invokespecial 417	azub:<init>	()V
    //   2635: astore 65
    //   2637: aload 65
    //   2639: iconst_0
    //   2640: putfield 145	azub:jdField_a_of_type_Boolean	Z
    //   2643: aload 65
    //   2645: ldc_w 470
    //   2648: putfield 153	azub:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   2651: aload 65
    //   2653: aload_0
    //   2654: aload_0
    //   2655: getfield 100	azuc:c	Ljava/util/ArrayList;
    //   2658: invokespecial 472	azuc:a	(Ljava/util/ArrayList;)Ljava/lang/String;
    //   2661: putfield 144	azub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   2664: aload 65
    //   2666: lload 14
    //   2668: lload 16
    //   2670: ladd
    //   2671: putfield 160	azub:c	J
    //   2674: aload 65
    //   2676: lload 6
    //   2678: lload 10
    //   2680: ladd
    //   2681: putfield 327	azub:d	J
    //   2684: aload 65
    //   2686: lconst_0
    //   2687: putfield 158	azub:jdField_b_of_type_Long	J
    //   2690: aload 65
    //   2692: lload 24
    //   2694: lload 20
    //   2696: ladd
    //   2697: putfield 151	azub:jdField_a_of_type_Long	J
    //   2700: aload_0
    //   2701: aload 65
    //   2703: invokespecial 177	azuc:a	(Lazub;)V
    //   2706: ldc 164
    //   2708: iconst_1
    ...
    //   2722: aload 65
    //   2724: invokevirtual 167	azub:toString	()Ljava/lang/String;
    ...
    //   2736: new 28	azub
    //   2739: dup
    //   2740: invokespecial 417	azub:<init>	()V
    //   2743: astore 65
    //   2745: aload 65
    //   2747: iconst_0
    //   2748: putfield 145	azub:jdField_a_of_type_Boolean	Z
    //   2751: aload 65
    //   2753: ldc_w 476
    //   2756: putfield 153	azub:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   2759: aload 65
    //   2761: aload_0
    //   2762: aload_0
    //   2763: getfield 102	azuc:d	Ljava/util/ArrayList;
    //   2766: invokespecial 472	azuc:a	(Ljava/util/ArrayList;)Ljava/lang/String;
    //   2769: putfield 144	azub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   2772: aload 65
    //   2774: lload 22
    //   2776: putfield 160	azub:c	J
    //   2779: aload 65
    //   2781: lload 8
    //   2783: putfield 327	azub:d	J
    //   2786: aload 65
    //   2788: lconst_0
    //   2789: putfield 158	azub:jdField_b_of_type_Long	J
    //   2792: aload 65
    //   2794: lload 32
    //   2796: putfield 151	azub:jdField_a_of_type_Long	J
    //   2799: aload_0
    //   2800: aload 65
    //   2802: invokespecial 177	azuc:a	(Lazub;)V
    //   2805: ldc 164
    //   2807: iconst_1
    ...
    //   2821: aload 65
    //   2823: invokevirtual 167	azub:toString	()Ljava/lang/String;
    ...
    //   2846: iload_2
    //   2847: aload_0
    //   2848: getfield 78	azuc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   2851: invokevirtual 184	java/util/ArrayList:size	()I
    //   2854: if_icmpge +58 -> 2912
    //   2857: aload_0
    //   2858: getfield 78	azuc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   2861: iload_2
    //   2862: invokevirtual 198	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   2865: checkcast 28	azub
    //   2868: astore 65
    //   2870: aload 65
    ...
    //   2885: aload 65
    //   2887: getfield 144	azub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   2896: putfield 144	azub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   2899: aload_0
    //   2900: aload 65
    //   2902: invokespecial 177	azuc:a	(Lazub;)V
    //   2905: iload_2
    //   2906: iconst_1
    //   2907: iadd
    //   2908: istore_2
    //   2909: goto -63 -> 2846
    //   2912: aload_0
    //   2913: getfield 94	azuc:jdField_a_of_type_Boolean	Z
    //   2916: ifeq +140 -> 3056
    //   2919: aload 64
    //   2921: invokeinterface 486 1 0
    //   2926: ldc_w 399
    //   2929: aload_0
    //   2930: getfield 380	azuc:jdField_a_of_type_Long	J
    ...
    //   2953: getstatic 34	azuc:jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool	Lcom/tencent/commonsdk/pool/RecyclablePool;
    //   2956: aload_0
    //   2957: getfield 100	azuc:c	Ljava/util/ArrayList;
    //   2960: iload_2
    ...
    //   2970: getstatic 34	azuc:jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool	Lcom/tencent/commonsdk/pool/RecyclablePool;
    //   2973: aload_0
    //   2974: getfield 102	azuc:d	Ljava/util/ArrayList;
    //   2977: iload_2
