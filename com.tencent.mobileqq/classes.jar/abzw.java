...
{
  public abzw(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
              ...
              do
              {
                do
                {
                  ...
                  for (i = 1;; i = 0)
                  {
                    ...
                    paramView = (acam)this.a.jdField_a_of_type_Acao.getItem(i);
                    this.a.a(paramView);
                    return;
                    i = 0;
                    break label93;
                  ...
                  {
                    if (this.a.jdField_a_of_type_Acao.jdField_b_of_type_JavaUtilList.contains(str)) {
                      this.a.jdField_a_of_type_Acao.jdField_b_of_type_JavaUtilList.remove(str);
                    }
                    for (;;)
                    {
                      TroopMemberListActivity.a(this.a);
                      this.a.jdField_a_of_type_Acao.notifyDataSetChanged();
                      return;
                      if (i != 0) {
                        this.a.jdField_a_of_type_Acao.jdField_b_of_type_JavaUtilList.add(str);
                      }
                    }
                  }
                  if (!bool1) {
        ...
        bbmy.a(this.a, this.a.getString(2131628948), 0).b(this.a.getTitleBarHeight());
        return;
