  ...
  implements Handler.Callback, Manager
{
  ...
  private bhtd jdField_a_of_type_Bhtd = new bhtd(ThreadManagerV2.getSubThreadLooper(), this);
  ...
  public atzz(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    localazqn.e = paramString4;
    localazqn.d = paramString5;
    localazqn.f = paramString1;
    localazqn.i = paramString2;
    azqm.a(paramString3, localazqn);
    azqm.a(paramQQAppInterface, localazqn);
  }
  ...
  private boolean a(SubMsgType0x27.PushPlatform paramPushPlatform, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (ahuf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295);
      if (localObject != null)
      {
        bool2 = ((ahuf)localObject).b();
        bool1 = bool2;
        if (bool2)
        {
          bool1 = bool2;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(1, 30000L);
  }
  ...
  public void a(long paramLong, String arg3, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        boolean bool = bdmh.a(paramString2);
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Pause) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop) || (bool))
        {
          ...
          synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
          {
            ...
            if (bool)
            {
              ??? = (auab)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(72);
              if (SettingCloneUtil.readValue(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString2.getString(2131694138), "qqsetting_lock_screen_whenexit_key", true))
              {
                if (QLog.isColorLevel()) {
  ...
  public void a(Context paramContext, Intent paramIntent)
  {
    ...
    if (j == 1041)
    {
      localIntent = aepi.a(new Intent(paramContext, SplashActivity.class), null);
  ...
  public void a(SubMsgType0x27.MsgBody paramMsgBody, short paramShort, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramMsgBody = new String(ausf.a(paramMsgBody), "UTF-8");
        localObject1 = null;
      ...
      catch (Exception paramMsgBody)
      {
        try
        {
          ...
          this.jdField_a_of_type_Bhtd.removeMessages(1);
          localObject4 = new azqn();
          ((azqn)localObject4).e = "0X800923D";
          ((azqn)localObject4).d = "收到Push协议";
          ((azqn)localObject4).f = (((SubMsgType0x27.ClientReport)localObject3).uint32_service_id.get() + "");
          ((azqn)localObject4).i = ((SubMsgType0x27.ClientReport)localObject3).str_content_id.get();
          azqm.a(paramMsgBody, (azqn)localObject4);
          azqm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (azqn)localObject4);
          l = ayzl.a();
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemNoticeData == null)
          {
            ...
            a(paramLong, str, paramMsgBody, (String)localObject2, i, j, ((azqn)localObject4).f, ((azqn)localObject4).i, (Bundle)localObject1);
            return;
