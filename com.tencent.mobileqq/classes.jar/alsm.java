  ...
  extends ajfb
{
  ...
  public alsm(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      try
      {
        ...
        ((ByteBuffer)localObject2).putInt(azzz.a(l)).put((byte)0).putShort((short)1).putShort(this.a).putShort((short)2).putShort(s);
