...
public class skc
{
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            this.jdField_a_of_type_Skb = ((skb)paramActivity.getBusinessHandler(BusinessHandlerFactory.VIDEO_FEEDS_LIKE_ANIMATION_CONFIG));
            this.jdField_a_of_type_Skd = new skd(this);
            paramActivity.addObserver(this.jdField_a_of_type_Skd);
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo = bmhv.a();
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo == null) {
            break label236;
          }
          if ((this.jdField_a_of_type_Skb == null) || (!bmhv.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo.jdField_a_of_type_Int))) {
            break;
          }
          this.jdField_a_of_type_Skb.a(paramInt);
          bmhv.a(System.currentTimeMillis());
      ...
      return;
    } while (this.jdField_a_of_type_Skb == null);
    this.jdField_a_of_type_Skb.a(paramInt);
    bmhv.a(System.currentTimeMillis());
  }
  ...
  public void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Skd);
    }
  }
