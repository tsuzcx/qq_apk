  ...
  extends BaseAdapter
{
  ...
  public aydx(TroopAdminList paramTroopAdminList, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramViewGroup = new aydy();
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131494716, null);
      paramViewGroup.c = ((ImageView)paramView.findViewById(2131302950));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131304981));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131302466));
    ...
    for (;;)
    {
      ...
      paramViewGroup.c.setBackgroundDrawable(bacm.b());
      azwp localazwp = azwp.a(this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopAdminList.app, localMap.get("uin").toString(), (byte)3);
      if (localazwp != null) {
        paramViewGroup.c.setBackgroundDrawable(localazwp);
      }
      ...
      return paramView;
      paramViewGroup = (aydy)paramView.getTag();
    }
