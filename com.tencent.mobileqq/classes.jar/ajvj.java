...
public class ajvj
  extends ajsm
{
  public ajvj(QQAppInterface paramQQAppInterface, Context paramContext, Entity paramEntity)
  {
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, View.OnClickListener paramOnClickListener)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof ajvk)))
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558956, paramViewGroup, false);
      paramOnClickListener = new ajvk();
      paramOnClickListener.d = ((ImageView)paramViewGroup.findViewById(2131368212));
      paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramViewGroup.findViewById(2131378604));
      paramOnClickListener.c = ((SingleLineTextView)paramViewGroup.findViewById(2131379979));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131369402));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131376575));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131376585));
      paramViewGroup.setTag(paramOnClickListener);
      a(paramViewGroup.findViewById(2131368212));
      ...
      paramInt2 = bhlg.a(localPhoneContact.detalStatusFlag, localPhoneContact.iTermType);
    ...
    default: 
      ...
      if (paramView == null) {
        paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718345);
      }
      break;
    case 1: 
    case 2: 
    ...
    case 8: 
      for (;;)
      {
        if ((paramInt2 == 0) || (paramInt2 == 6))
        {
          ...
          paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(a(this.jdField_a_of_type_AndroidContentContext, 2131166997));
          ...
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131700131));
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anzj.a(2131700134));
          label504:
          if (AppSetting.c)
          {
            ...
            paramOnClickListener.append(bhlg.b(paramInt1));
            paramViewGroup.setContentDescription(paramOnClickListener);
          }
          label533:
          return paramViewGroup;
          paramOnClickListener = (ajvk)paramView.getTag();
          paramViewGroup = paramView;
          break;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718336);
          continue;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718338);
          continue;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718342);
          continue;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718347);
          continue;
          paramView = "";
          continue;
    ...
    for (;;)
    {
      ...
      paramOnClickListener.c.setVisibility(8);
      break label381;
      if (((anyw)localObject).a(localPhoneContact.unifiedCode, true))
      {
        paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131700133));
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anzj.a(2131700135));
        break label504;
      }
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setText(anzj.a(2131689551));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setTag(localPhoneContact);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setContentDescription(anzj.a(2131689551));
