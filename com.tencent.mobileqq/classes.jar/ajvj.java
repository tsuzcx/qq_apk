    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          ...
          {
            localObject2 = (NewCommonConchArgs)bgfh.a(new NewCommonConchArgs(), ((Conch)localObject2).params);
            ...
            else
            {
              ...
              bbsc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), i, (String)localObject2);
              bbsc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
          else if (6142 == ((Conch)localObject2).cmdId)
          {
            ...
            else
            {
              ...
              bbsc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), (String)localObject2);
              bbsc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
        }
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Ajvk != null) {
        this.jdField_a_of_type_Ajvk.a(paramInt);
      }
      return;
      try
      {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bbsc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramObject);
          continue;
          paramObject = (bbse)paramObject;
          a(paramObject.jdField_a_of_type_MConchSCPullConchs);
          if (this.jdField_a_of_type_Ajvk != null) {
            this.jdField_a_of_type_Ajvk.a(paramObject.jdField_a_of_type_MWIFISCGet3rdCloudCheck);
          }
        }
      }
    }
