...
public final class biyg
{
  ...
  public static void a(Bitmap paramBitmap, biyk parambiyk)
  {
    a(paramBitmap, parambiyk, false);
  }
  
  public static void a(Bitmap paramBitmap, biyk parambiyk, boolean paramBoolean)
  {
    if (parambiyk == null) {
      return;
    }
    ...
    a(new FaceChangeUtils.5(paramBitmap, parambiyk), paramBoolean, "GLThread-cropFace");
  }
  
  public static void a(Bitmap paramBitmap, List<String> paramList, biyh parambiyh)
  {
    if ((paramBitmap == null) || (paramList == null) || (paramList.isEmpty()))
    {
      ...
      parambiyh.a(new ArrayList());
      return;
    }
    a(new FaceChangeUtils.2(paramList, paramBitmap, parambiyh), false, "GLThread-changeFaceBatch");
  }
  ...
  private static biyi b(Bitmap paramBitmap, String paramString)
  {
    ...
    {
      bizq.d("FaceChangeUtils", "changeFaceInternal---failed to parse CrazyFace: " + paramString);
      return biyi.a(-2, "failed to parse material, material=" + paramString);
    }
    ...
    if ((localObject1 == null) || (((PTFaceAttr)localObject1).getAllFacePoints() == null) || (((PTFaceAttr)localObject1).getAllFacePoints().isEmpty()))
    {
      ...
      return biyi.a(-3, "failed to detect face");
    }
    ...
    if (((List)localObject3).isEmpty())
    {
      ...
      return biyi.a(-4, "no face points");
    }
    ...
    return biyi.a(paramString);
  }
  
  private static void c(Bitmap paramBitmap, biyk parambiyk)
  {
    ...
    parambiyk.a((Bitmap)localObject2);
  }
}
