...
public class mha
{
  ...
  private mil jdField_a_of_type_Mil;
  ...
  public mha(View paramView, ViewStub paramViewStub, int paramInt, VideoController paramVideoController, AVActivity paramAVActivity)
  {
    ...
    this.jdField_a_of_type_Mil = new mil(paramVideoController, paramAVActivity);
    this.jdField_a_of_type_Mil.a();
  ...
  {
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372308);
    String str = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695874);
    Object localObject = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp();
    if (paramBoolean) {}
    for (int i = 2131695873;; i = 2131695872)
    {
  ...
  private void h()
  {
    Object localObject4 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372477);
    Object localObject3 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372480);
    Object localObject2 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372486);
    Object localObject1 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372482);
    int i = (int)muc.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 4.0F);
    int j = (int)muc.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 132.0F);
    int k = (int)muc.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 8.0F);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.width = j;
    ((RelativeLayout)localObject4).setLayoutParams(localLayoutParams);
    localObject4 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131372477);
    ...
    ((RelativeLayout.LayoutParams)localObject3).addRule(5, 2131372477);
    ((RelativeLayout.LayoutParams)localObject3).addRule(7, 2131372477);
    ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131372477);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(5, 2131372480);
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131372480);
    ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131372480);
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(8, 2131372488);
    ((RelativeLayout.LayoutParams)localObject1).addRule(14, -1);
    ((RelativeLayout.LayoutParams)localObject1).bottomMargin = k;
    ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372489)).setLayoutParams((ViewGroup.LayoutParams)localObject1);
    localObject1 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject1).addRule(8, 2131372484);
    ((RelativeLayout.LayoutParams)localObject1).addRule(14, -1);
    ((RelativeLayout.LayoutParams)localObject1).bottomMargin = k;
    ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372485)).setLayoutParams((ViewGroup.LayoutParams)localObject1);
  }
  ...
  private void i()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[0] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372478));
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[1] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372481));
      ...
      this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[2] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372488));
      ...
      ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372489)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
      if (lor.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372482).setVisibility(0);
        this.jdField_a_of_type_ArrayOfAndroidWidgetImageView[3] = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372484));
        ...
        ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372485)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
        h();
      }
  ...
  private void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController != null)
    {
      ...
      if (locallga != null) {
        this.jdField_a_of_type_ComTencentAvVideoController.a(Long.valueOf(locallga.jdField_d_of_type_JavaLangString).longValue(), this.jdField_b_of_type_Int);
      }
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((localObject == null) || (((lga)localObject).jdField_d_of_type_Int != 2) || ((this.jdField_b_of_type_Boolean) && (this.jdField_c_of_type_Boolean)) || ((this.jdField_a_of_type_ComTencentAvVideoController.a().v != 0) && (this.jdField_a_of_type_ComTencentAvVideoController.a().v != 2)) || (this.jdField_a_of_type_ComTencentAvUiAVActivity.b() != 2));
          localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131372388);
        } while (((localObject != null) && (((View)localObject).getVisibility() == 0)) || (this.jdField_a_of_type_AndroidViewView.findViewById(2131372515).getVisibility() != 0));
        if (paramInt < 2) {
          break;
        }
      } while ((!lor.jdField_c_of_type_Boolean) || (this.jdField_c_of_type_Boolean));
      ...
      localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131372307);
      a(true);
      ((RelativeLayout)localObject).setVisibility(0);
      this.jdField_c_of_type_Boolean = true;
      axqy.b(null, "CliOper", "", "", "0X800AA5D", "0X800AA5D", 4, 0, "", "", "", "");
      return;
    } while ((paramInt < 1) || (this.jdField_b_of_type_Boolean));
    QLog.i("QavDoubleVideoSharpnessMangaer", 1, "onNetworkQualityChanged. networkQuality = " + paramInt);
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.K();
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.z(AudioHelper.b());
    Object localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131372307);
    a(true);
    ((RelativeLayout)localObject).setVisibility(0);
    this.jdField_b_of_type_Boolean = true;
    axqy.b(null, "CliOper", "", "", "0X800AA5D", "0X800AA5D", 3, 0, "", "", "", "");
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        } while ((locallga == null) || (locallga.jdField_d_of_type_Int != 2));
      ...
      mao.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131696089));
      this.e = true;
      axqy.b(null, "CliOper", "", "", "0X800AA60", "0X800AA60", 4, 0, "", "", "", "");
      return;
    } while ((paramInt1 < 1280) || (paramInt2 < 720) || (this.d));
    QLog.i("QavDoubleVideoSharpnessMangaer", 1, "onRecvVideoResolutionChanged. w = " + paramInt1 + ", h = " + paramInt2);
    mao.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131696090));
    this.d = true;
    axqy.b(null, "CliOper", "", "", "0X800AA60", "0X800AA60", 3, 0, "", "", "", "");
  }
    ...
    for (;;)
    {
      ...
      if (paramLong1 >= 4L)
      {
        ...
        if (paramLong2 - this.jdField_a_of_type_Long > 10000L)
        {
          ...
          mao.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1057, ajya.a(2131708918));
          axqy.b(null, "CliOper", "", "", "0X800A346", "0X800A346", 0, 0, "", "", "", "");
        }
  ...
  public void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (!paramBoolean)
    {
      if ((paramInt1 != 0) && (!TextUtils.isEmpty(paramString))) {
        mao.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1057, paramString);
      }
      return;
    }
    int i;
    ...
    {
      if (paramInt1 == 10000) {
        axqy.b(null, "CliOper", "", "", "0X800AA5F", "0X800AA5F", 4, 0, "", "", "", "");
      }
  ...
  public void d()
  {
    ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131372307)).setVisibility(4);
    i();
    boolean bool = this.jdField_a_of_type_Mil.a();
    ...
    {
      i = 3;
      axqy.b(null, "CliOper", "", "", "0X800AA5E", "0X800AA5E", i + 1, 0, "", "", "", "");
    ...
    localObject = bbdj.a(this.jdField_a_of_type_ComTencentAvUiAVActivity, 0, ajya.a(2131708913), null, ajya.a(2131708914), ajya.a(2131708915), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
    if (localObject != null) {
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Mil != null)
    {
      this.jdField_a_of_type_Mil.e();
      this.jdField_a_of_type_Mil = null;
    }
