...
public class uqg
{
  ...
  public static stLinkStragegyArgs a()
  {
    ...
    localstLinkStragegyArgs.hasInstalledWeish = zqd.a(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  private static boolean a(String paramString1, String paramString2, int paramInt)
  {
    ...
    boolean bool = bnjk.a(System.currentTimeMillis(), l);
    if (!bool) {
  ...
  private static String h()
  {
    ...
    if (localAppRuntime != null)
    {
      ...
      if (!TextUtils.isEmpty(localAppRuntime.getAccount())) {
        str1 = bjty.a(localAppRuntime.getAccount());
      }
    }
    return str1 + "_" + str3;
  }
