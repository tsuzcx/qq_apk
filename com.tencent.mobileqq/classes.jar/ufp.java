...
{
  public ufp(UncommonlyUsedContactsActivity paramUncommonlyUsedContactsActivity, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, int paramInt, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramViewGroup = (ufq)paramView.getTag();
      localView = paramView;
    }
    Object localObject2;
    for (;;)
    {
      paramView = (TextView)localView.findViewById(2131369976);
      localObject2 = localView.findViewById(2131363200);
      ...
      return localView;
      localView = this.a.getLayoutInflater().inflate(2130970296, null);
      paramViewGroup = new ufq(this.a, null);
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131362719));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(16908308));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363204));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131369946));
      paramViewGroup.d = ((TextView)localView.findViewById(2131369977));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363939));
    ...
    if ((((UncommonlyUsedContactsActivity.ListItem)localObject1).jdField_a_of_type_ComTencentMobileqqPersistenceEntity instanceof Friends))
    {
      ...
      if (!TextUtils.isEmpty(((Friends)localObject1).remark))
      {
        ...
        {
        default: 
          paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setBackgroundResource(2130842895);
          i = 0;
          label416:
    ...
    for (;;)
    {
      ...
      break label416;
      i = 2130839243;
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setBackgroundResource(2130842886);
      break label416;
