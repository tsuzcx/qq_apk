...
public class azoe
{
  ...
  public void a()
  {
    ...
    if (i < localObject4.length)
    {
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject5).hasNext())
        {
          ...
          bool1 = azoj.a(((PrecoverResource)localObject6).businessId, ((PrecoverResource)localObject6).md5);
          if (QLog.isColorLevel()) {
    ...
    {
      bool1 = true;
      j = azoj.a(this.a.a().getApp(), this.a.a().getCurrentAccountUin());
    ...
    {
      localObject1 = "1";
      bdla.b((QQAppInterface)localObject4, "CliOper", "", "", "0X8007134", "0X8007134", 0, 0, String.valueOf(j), (String)localObject1, "id_all", "");
    ...
    {
      bdla.b((QQAppInterface)localObject5, "CliOper", "", "", "0X8007134", "0X8007134", 0, 0, String.valueOf(j), (String)localObject1, "id_" + (String)localObject4, "");
      break label471;
      localObject1 = "0";
      break;
    }
    for (;;)
    {
      ...
      {
        label578:
        localObject1 = (asbm)this.a.a().getManager(QQManagerFactory.EARLY_DOWNLOAD_MANAGER);
        if (localObject1 == null) {
          break;
        }
        localObject1 = (asce)((asbm)localObject1).a("qq.android.early.precover");
        if (localObject1 == null) {
          break;
        }
        bool1 = ((asce)localObject1).i();
        boolean bool2 = ((asce)localObject1).j();
  ...
  public void a(PrecoverResource paramPrecoverResource, int paramInt, String paramString1, String paramString2, long paramLong)
  {
    ...
    localHashMap.put("url", azoj.b(paramPrecoverResource.url));
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      return;
      int i = azoj.a(this.a.a().getApp(), this.a.a().getCurrentAccountUin());
      ...
      bdla.b(this.a.a(), "CliOper", "", "", "0X8007133 ", "0X8007133 ", 0, 0, String.valueOf(i), "", "id_all", "");
      if (localObject2 != null)
      {
        localObject1 = ((List)localObject2).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          ...
          bdla.b(this.a.a(), "CliOper", "", "", "0X8007133 ", "0X8007133 ", 0, 0, String.valueOf(i), "", "id_" + ((PrecoverConfig)localObject2).businessId, "");
        }
      }
    }
  }
