  ...
  extends MessageMicro<StDoReplyReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 34, 42, 48 }, new String[] { "extInfo", "replyType", "reply", "comment", "feed", "from" }, new Object[] { null, localInteger, null, null, null, localInteger }, StDoReplyReq.class);
  }
}
