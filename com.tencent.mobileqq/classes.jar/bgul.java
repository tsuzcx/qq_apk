  ...
  implements Manager
{
  ...
  public ArrayList<bgum> a;
  protected Queue<String> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "<{text:'A',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + anzj.a(2131714576) + "<{text:'B',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + anzj.a(2131714577) + "<{icon:'/rose',url:'url.qq.com?rose.png',alt:'玫瑰'}>";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public bgul(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(GroupOpenSysMsg.SysMsgBody paramSysMsgBody, TroopTipsEntity paramTroopTipsEntity)
  {
    if ((paramSysMsgBody.msg_type.get() == 2) && (paramSysMsgBody.light_app.has()))
    {
      ...
      if (paramSysMsgBody.sender.has())
      {
        ...
        localMessageForArkApp.saveExtInfoToExtStr("troop_msg_nick_color", String.valueOf(BaseApplication.getContext().getResources().getColor(2131167015)));
  ...
  public MessageForGrayTips a(TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    do
    {
      ...
      } while (aoci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForGrayTips, false));
  ...
  public MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2, bcsn parambcsn)
  {
    ...
    do
    {
        ...
        try
        {
          ...
          case 1: 
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_redtips.has())
            {
              ...
              {
                a(new bgum(this, ((TroopTipsEntity)localObject2).troopUin, paramArrayOfByte));
                return null;
              }
              ((TroopTipsEntity)localObject2).currentUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              paramQQAppInterface = (MessageForQQWalletTips)bcry.a(-2029);
              ...
              paramQQAppInterface.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((TroopTipsEntity)localObject2).troopUin, "", "[QQWallet Tips]", bcrg.a(), -2029, 1, bcrg.a());
            ...
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint32_robot_group_opt.has())
            {
              ...
              paramArrayOfByte = (bgty)paramQQAppInterface.getManager(203);
            }
            ...
            if (j == 3)
            {
              bgpk.a(paramQQAppInterface, (TroopTipsEntity)localObject2);
              return null;
            }
            if ((j == 6) && (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint64_receiver_uin.has()))
            {
              ...
              {
                bftp.a().a(String.valueOf(l1), paramQQAppInterface.getCurrentAccountUin(), true);
                ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1, paramLong);
              }
            }
            for (;;)
            {
              ...
              if ((paramBoolean1) || (!aoci.a(paramQQAppInterface, paramArrayOfByte, false))) {
                break label1257;
              }
              return null;
              if (j != 11) {
      ...
      bguq.a(l1, paramQQAppInterface, paramLong);
      return null;
    ...
    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_group_notify.has())
    {
      ...
      paramArrayOfByte = ((axfw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(Long.valueOf(l1), true);
      if ((paramArrayOfByte != null) && (1 == paramQQAppInterface.opt_uint32_auto_pull_flag.get()))
      {
        ...
        ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(67, true, new Object[] { String.valueOf(l1), paramQQAppInterface.opt_bytes_feeds_id.get().toStringUtf8(), Integer.valueOf(paramQQAppInterface.opt_uint32_auto_pull_flag.get()) });
        break label4588;
        if (!paramBoolean2)
        {
          if (parambcsn != null) {
          ...
          {
            parambcsn = (TroopTips0x857.MessageRecallReminder)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_recall.get();
            paramLong = parambcsn.uint64_uin.get();
            l2 = parambcsn.uint64_admin_uin.get();
            i = parambcsn.uint32_op_type.get();
            if (parambcsn.msg_wording_info.has())
            {
              paramInt = parambcsn.msg_wording_info.int32_item_id.get();
              paramQQAppInterface = parambcsn.msg_wording_info.string_item_name.get();
              label1543:
              paramArrayOfByte = new HashMap();
              try
              {
                localObject1 = new msgrevoke_userdef.MsgInfoUserDef();
                ((msgrevoke_userdef.MsgInfoUserDef)localObject1).mergeFrom(parambcsn.bytes_userdef.get().toByteArray());
              ...
              parambcsn = ((ArrayList)parambcsn.uint32_recalled_msg_list.get()).iterator();
              while (parambcsn.hasNext())
              {
                Object localObject3 = (TroopTips0x857.MessageRecallReminder.MessageMeta)parambcsn.next();
                localObject2 = new RevokeMsgInfo();
                ((RevokeMsgInfo)localObject2).jdField_b_of_type_JavaLangString = String.valueOf(paramLong);
                ((RevokeMsgInfo)localObject2).jdField_c_of_type_JavaLangString = String.valueOf(l2);
              ...
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a((ArrayList)localObject1, false);
              return null;
              if (QLog.isColorLevel()) {
              ...
              parambcsn = (TroopTips0x857.NotifyObjmsgUpdate)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_objmsg_update.get();
              if (!parambcsn.bytes_ext_msg.has()) {
                break label4588;
              }
              paramArrayOfByte = new SubMsgType0xaa.MsgBody();
              try
              {
                paramArrayOfByte.mergeFrom(parambcsn.bytes_ext_msg.get().toByteArray());
                ((avoj)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
              }
              catch (Exception parambcsn)
              {
                for (;;)
                {
                  if (QLog.isColorLevel()) {
              ...
              ((bitz)paramQQAppInterface.a(107)).a((TroopTips0x857.WereWolfPush)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.get(), paramArrayOfByte);
              break label4588;
              if (QLog.isColorLevel()) {
              ...
              ((amst)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a(0, 1, Long.toString(l1), paramQQAppInterface);
              break label4588;
              if (QLog.isColorLevel()) {
              ...
              ((amts)paramQQAppInterface.getManager(227)).a(1, paramArrayOfByte);
              break label4588;
              if (QLog.isColorLevel()) {
              ...
              alda.a(1, (TroopTips0x857.GoldMsgTipsElem)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.get(), null);
              break label4588;
              if (QLog.isColorLevel()) {
              ...
              ((aoip)paramQQAppInterface.a(20)).a(String.valueOf(l1), false, "", false, true, false, true);
              break label4588;
              if (QLog.isColorLevel()) {
              ...
              becb.a(paramQQAppInterface, (TroopTips0x857.TroopFormGrayTipsInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_troopformtips_push.get(), ((TroopTipsEntity)localObject2).troopUin);
              break label4588;
              if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.has())
              {
                awmj.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.MediaChangePushInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.get());
                break label4588;
              }
              QLog.d("ListenTogether", 1, "notifyMsgBody.opt_msg_media_push miss");
              break label4588;
              if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_qq_vedio_game_push_info.has())
              {
                paramQQAppInterface = (mxm)paramQQAppInterface.a(178);
                if (paramQQAppInterface == null) {
                  break label4588;
                }
                paramQQAppInterface.a((TroopTips0x857.QQVedioGamePushInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_qq_vedio_game_push_info.get());
                break label4588;
              }
              ...
              if (paramBoolean1)
              {
                try
                {
                  parambcsn = (TroopTips0x857.GeneralGrayTipInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_general_gray_tip.get();
                  if (parambcsn.uint64_busi_type.has())
                  {
                    l1 = parambcsn.uint64_busi_type.get();
                    if (!parambcsn.uint64_busi_id.has()) {
                      break label3046;
                    }
                    l2 = parambcsn.uint64_busi_id.get();
                    if (!parambcsn.uint64_templ_id.has()) {
                      break label3052;
                    }
                    l3 = parambcsn.uint64_templ_id.get();
                    if (!parambcsn.uint32_ctrl_flag.has()) {
                      break label3058;
                    }
                    paramInt = parambcsn.uint32_ctrl_flag.get();
                    if (parambcsn.uint32_c2c_type.has()) {
                      parambcsn.uint32_c2c_type.get();
                    }
                    if (parambcsn.uint32_service_type.has()) {
                      parambcsn.uint32_service_type.get();
                    }
                    if (!parambcsn.bytes_pb_reserv.has()) {
                      break label3063;
                    }
                    paramArrayOfByte = parambcsn.bytes_pb_reserv.get().toByteArray();
                    if (!parambcsn.bytes_content.has()) {
                      break label3068;
                    }
                    parambcsn = parambcsn.bytes_content.get().toByteArray();
                    localObject1 = "";
                    if ((parambcsn == null) || (parambcsn.length <= 0)) {
                      break label3074;
                    }
                    parambcsn = new String(parambcsn, "utf-8");
                    paramInt = avpe.a(paramInt);
                    paramArrayOfByte = avpe.a(paramQQAppInterface, ((TroopTipsEntity)localObject2).troopUin, 1, paramInt, paramLong, parambcsn, l1, l2, paramArrayOfByte);
                    if (paramArrayOfByte == null) {
                      break label4588;
                    }
                    ...
                    paramArrayOfByte.saveExtInfoToExtStr("bytes_content", parambcsn);
                    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", 3, 0, "" + l2, "" + l1, "", "");
                    avpe.a(paramQQAppInterface, paramArrayOfByte);
                  }
                }
              ...
              {
                paramArrayOfByte = ((bejx)paramQQAppInterface.getManager(339)).a(2);
                if (paramArrayOfByte == null) {
                  break label4588;
                }
              ...
              {
                paramArrayOfByte = ((bejx)paramQQAppInterface.getManager(339)).a(4);
                if (paramArrayOfByte == null) {
                  break label4588;
                }
              ...
              paramArrayOfByte = (TroopTips0x857.GroupInfoChange)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_group_info_change.get();
              if (paramArrayOfByte == null) {
                break label4588;
              }
              if (paramArrayOfByte.uint32_group_honor_switch.has())
              {
                ...
                parambcsn = (bggj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346);
                if (paramInt != 0) {
                  break label4592;
                }
                paramBoolean1 = true;
                parambcsn.a(String.valueOf(paramLong), paramBoolean1);
              }
              if (paramArrayOfByte.uint32_group_member_level_switch.has())
              {
                ...
                parambcsn = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                localObject1 = parambcsn.c(String.valueOf(paramLong));
                if (localObject1 != null)
                {
                  if (QLog.isColorLevel()) {
                  ...
                  parambcsn.b((TroopInfo)localObject1);
                  parambcsn = (aoip)paramQQAppInterface.a(20);
                  if (parambcsn != null)
                  {
                    if (paramInt != 0) {
                      break label4598;
                    ...
                    paramBoolean1 = true;
                    label3536:
                    parambcsn.notifyUI(152, true, new Object[] { String.valueOf(paramLong), Boolean.valueOf(paramBoolean1) });
                  }
                }
              }
              if (paramArrayOfByte.uint32_group_flagext4.has())
              {
                ...
                if (localObject1 != null)
                {
                  ...
                  ((TroopInfo)localObject1).dwGroupFlagExt4 = ((byte)paramInt);
                  parambcsn.b((TroopInfo)localObject1);
                  parambcsn = (aoip)paramQQAppInterface.a(20);
                  if (parambcsn != null) {
                    parambcsn.notifyUI(154, true, new Object[] { String.valueOf(paramLong), Integer.valueOf(paramInt) });
                  }
                }
              }
              if (paramArrayOfByte.uint32_group_class_ext.has())
              {
                ...
                if (localObject1 != null)
                {
                  ...
                  parambcsn = (aoip)paramQQAppInterface.a(20);
                  if (parambcsn != null) {
                    parambcsn.notifyUI(156, true, new Object[] { String.valueOf(paramLong), Integer.valueOf(paramInt) });
                  }
                }
              }
              if (paramArrayOfByte.uint32_group_flagext3.has())
              {
                ...
                parambcsn = ((TroopManager)localObject1).c(String.valueOf(paramLong));
                if (parambcsn != null)
                {
                  parambcsn.dwGroupFlagExt3 = paramArrayOfByte.uint32_group_flagext3.get();
                  ((TroopManager)localObject1).b(parambcsn);
                  paramQQAppInterface = (aoip)paramQQAppInterface.a(20);
                  if (paramQQAppInterface != null) {
                    paramQQAppInterface.notifyUI(157, true, new Object[] { String.valueOf(paramLong), Long.valueOf(parambcsn.dwGroupFlagExt3) });
                  }
                }
              }
              ...
              parambcsn = paramQQAppInterface.c(String.valueOf(paramLong));
              if (parambcsn != null)
              {
                ...
                paramBoolean1 = true;
                label4026:
                parambcsn.isTroopBlocked = paramBoolean1;
                if (QLog.isColorLevel()) {
                ...
                {
                  parambcsn.appealDeadline = paramArrayOfByte.uint32_appeal_deadline.get();
                  if (QLog.isColorLevel()) {
                    QLog.d("TroopTipsMsgMgr.push", 2, "groupInfoChange push, uint32_appeal_deadline = " + parambcsn.appealDeadline);
                  }
                }
                paramQQAppInterface.b(parambcsn);
                paramQQAppInterface = (aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
                if (paramQQAppInterface == null) {
                  break label4588;
                }
                paramQQAppInterface.notifyUI(158, true, new Object[] { String.valueOf(l1) });
                break label4588;
              }
              if (!QLog.isColorLevel()) {
                break label4588;
              ...
              break label4588;
              awqe.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.NotifyMsgBody)localObject1);
              break label4588;
              if (!((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.has()) {
                break label4588;
              }
              parambcsn = (TroopTips0x857.GroupAnnounceTBCInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.get();
              if (parambcsn == null) {
                break label4588;
              }
              if (!parambcsn.feeds_id.has()) {
                break label4613;
              }
            }
          }
    ...
    label4613:
    for (paramArrayOfByte = parambcsn.feeds_id.get().toStringUtf8();; paramArrayOfByte = null)
    {
      paramLong = parambcsn.group_id.get();
      paramInt = parambcsn.action.get();
      switch (paramInt)
      {
      case 0: 
        bgts.b(paramQQAppInterface, paramArrayOfByte, String.valueOf(paramLong), 1);
        break;
      case 1: 
      case 2: 
        ...
        if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_study_room_member_msg.has())
        {
          paramLong = ((TroopTips0x857.NotifyMsgBody)localObject1).opt_uint64_group_code.get();
          if (QLog.isColorLevel()) {
            QLog.i("TroopTipsMsgMgr", 2, "StudyRoomMemberChangePush received groupUin:" + paramLong);
          }
          ((bdvj)paramQQAppInterface.getManager(362)).a(((TroopTips0x857.StudyRoomMemberChangePush)((TroopTips0x857.NotifyMsgBody)localObject1).opt_study_room_member_msg.get()).toByteArray(), paramLong + "");
          break label4588;
          if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_qq_group_digest_msg.has())
          {
            if (QLog.isColorLevel()) {
              QLog.i("TroopTipsMsgMgr", 2, "recv Prompt_QQGroupDigestMsg");
            }
            ((bfuo)paramQQAppInterface.getManager(381)).a((TroopTips0x857.QQGroupDigestMsg)((TroopTips0x857.NotifyMsgBody)localObject1).opt_qq_group_digest_msg.get(), paramBoolean1);
            break label4588;
            paramInt = 0;
            paramQQAppInterface = "";
            break label1543;
  ...
  public void a(bgum parambgum)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopTipsMsgMgr", 2, "addWalletTipsCache");
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(parambgum);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bgum localbgum = (bgum)localIterator.next();
      TroopTips0x857.RedGrayTipsInfo localRedGrayTipsInfo = localbgum.jdField_a_of_type_TencentImOidbCmd0x857TroopTips0x857$RedGrayTipsInfo;
      ...
      localMessageForQQWalletTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localbgum.jdField_a_of_type_JavaLangString, "", "[QQWallet Tips]", bcrg.a(), -2029, 1, bcrg.a());
