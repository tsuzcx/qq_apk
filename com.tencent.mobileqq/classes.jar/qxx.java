  ...
  extends qxc
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = qxx.class.getSimpleName();
  }
  
  qxx(View paramView, Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    this.c = ((ImageView)paramView.findViewById(2131376017));
    ...
    if (rlz.a().b())
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363281));
    }
    for (;;)
    {
      try
      {
        ...
        paramView.addOnAttachStateChangeListener(new qxz(this, new qxy(this)));
        return;
      }
  ...
  private void a(RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    for (ScaleAnimation localScaleAnimation = new ScaleAnimation(0.0F, 1.0F, 0.0F, 1.0F, 1, 0.864F, 1, 0.0F);; localScaleAnimation = new ScaleAnimation(0.0F, 1.0F, 0.0F, 1.0F, 1, 0.864F, 1, 1.0F))
    {
      ...
      localScaleAnimation.setAnimationListener(new qyb(this, paramRelativeLayout));
  ...
  {
    ArticleInfo localArticleInfo = this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a;
    if ((this.jdField_a_of_type_AndroidWidgetImageView != null) && (localArticleInfo != null) && (rlz.a().b()) && (localArticleInfo.innerUniqueID != null) && (localArticleInfo.innerUniqueID.equals(paramString)))
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        {
          oqb localoqb = oqb.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.J);
          localoqb.setRepeatCount(0);
          this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImageDrawable(localoqb);
          if (this.jdField_b_of_type_Boolean)
          {
            localoqb.playAnimation();
  ...
  private void g()
  {
    ...
    {
      arrayOfInt = qxl.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo, this.jdField_a_of_type_Boolean);
  ...
  public void b()
  {
    ...
    if ((rlz.a().b()) && (this.jdField_a_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a.fusionBiuInfo != null))
    {
  ...
  public void d(boolean paramBoolean)
  {
    ...
    if (bbdh.l() - baxn.a(this.itemView.getContext(), 0.0F) > arrayOfInt[1] + baxn.a(this.itemView.getContext(), 100.0F)) {
      if (!bool) {
        break label89;
      }
    }
    label89:
    for (RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().findViewById(2131363284);; localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().findViewById(2131363285))
    {
  ...
  {
    super.e();
    if ((this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView != null) && ((this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.getDrawable() instanceof oqb)))
    {
      ((oqb)this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.getDrawable()).playAnimation();
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    qxx localqxx = (qxx)paramView.getTag();
    ...
    case 2131367436: 
    case 2131367438: 
      this.jdField_a_of_type_Qxr.d(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
      return;
    case 2131367432: 
      this.jdField_a_of_type_Qxr.c(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
      return;
    case 2131376017: 
      this.jdField_a_of_type_Qxr.b(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
      return;
    }
    this.jdField_a_of_type_Qxr.g(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
    try
    {
      rlz.a().a(localqxx.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a.fusionBiuInfo.jdField_b_of_type_Boolean);
      return;
    }
