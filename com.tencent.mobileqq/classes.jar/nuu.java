...
public abstract class nuu
{
  ...
  public nuu(Context paramContext, String paramString)
  {
  ...
  public boolean a(AppInterface paramAppInterface, String paramString)
  {
    try
    {
      ...
      paramAppInterface = ((bhyq)((QQAppInterface)paramAppInterface).getManager(QQManagerFactory.DOWNLOADER_FACTORY)).a(1);
      paramString = AppConstants.SDCARD_PATH + a() + ".tmp";
      localObject = new bhyo((String)localObject, new File(paramString));
      ((bhyo)localObject).b = 3;
      Bundle localBundle = new Bundle();
      localBundle.putString("file_path", paramString);
      paramAppInterface.a((bhyo)localObject, new nuv(this), localBundle);
      return true;
    }
