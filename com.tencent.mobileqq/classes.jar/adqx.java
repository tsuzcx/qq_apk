  ...
  implements DialogInterface.OnClickListener, QQPermissionCallback
{
  ...
  private static final String[] jdField_b_of_type_ArrayOfJavaLangString = { amtj.a(2131700922), "QQ使用电话权限确定本机号码和设备ID，以保证帐号登录的安全性。QQ不会拨打其他号码或终止通话。\n请在设置中开启电话权限或存储空间，以正常使用QQ功能。" };
  private adra jdField_a_of_type_Adra;
  ...
  private void a(AppActivity paramAppActivity, int paramInt)
  {
    ...
    bcef.a(null, "dc00898", "", "", str1, str1, paramInt, 0, "", "", str2, "");
  }
  ...
  public void a()
  {
    ...
    adqz localadqz = new adqz(this);
    QQCustomDialog localQQCustomDialog = bfur.a(this.jdField_a_of_type_MqqAppAppActivity, 230);
    String str1 = amtj.a(2131709315);
    if (i > 1) {}
    for (i = 2131693545;; i = 2131693544)
    {
      String str2 = amtj.a(i);
      localQQCustomDialog.setTitle(str1);
      localQQCustomDialog.setMessage(str2);
      localQQCustomDialog.setNegativeButton(amtj.a(2131693543), localadqz);
      localQQCustomDialog.setPositiveButton(amtj.a(2131693542), localadqz);
      localQQCustomDialog.show();
      return;
    }
  }
  
  public void a(adra paramadra)
  {
    this.jdField_a_of_type_Adra = paramadra;
  }
  ...
  public boolean a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (amxq.a(0)))
    {
      paramAppActivity = new adqy(this);
      amxq.a(this.jdField_a_of_type_MqqAppAppActivity, "", paramAppActivity, paramAppActivity).show();
      return false;
    }
