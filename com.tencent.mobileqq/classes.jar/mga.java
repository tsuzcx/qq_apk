...
public class mga
  extends lfg
{
  public mga(MultiVideoCtrlLayerUIBase paramMultiVideoCtrlLayerUIBase) {}
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, int paramInt2)
  {
    ...
    {
      this.a.jdField_b_of_type_Mck.update(null, new Object[] { Integer.valueOf(105), Boolean.valueOf(bool), Long.valueOf(paramLong1) });
      this.a.z(paramLong1);
      ...
      for (;;)
      {
        ...
        if (paramLong3 == 2L)
        {
          mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1029);
        }
        else if (paramLong3 == 4L)
        {
          if ((paramLong2 == this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().j))
          {
            ...
            mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1031);
          }
          for (;;)
          {
            ...
            axqw.b(null, "CliOper", "", "", "0X8004CFD", "0X8004CFD", 0, 0, "", "", "", "");
            break;
            paramInt1 = 0;
            break label475;
            if (QLog.isColorLevel()) {
        ...
        else if (paramLong3 == 8L)
        {
          ...
          {
            MultiVideoCtrlLayerUIBase.a(this.a, false);
            mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131696016));
          }
        }
        else if ((paramLong3 == 9L) && (MultiVideoCtrlLayerUIBase.a(this.a)))
        {
          MultiVideoCtrlLayerUIBase.a(this.a, false);
          mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131696017));
        }
      }
      this.a.t(paramLong3);
      return;
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.a.jdField_b_of_type_Mck.update(null, new Object[] { Integer.valueOf(104), localArrayList });
      if (paramInt == 2)
      {
        this.a.i(1036);
  ...
  protected void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    if (paramInt == 0)
    {
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034);
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035);
    ...
    {
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, 2131695842);
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131696176), new mgb(this));
      return;
    }
    Object localObject;
    long l;
    ...
    else
    {
      ...
      mrf.b((StringBuilder)localObject, paramArrayList, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
      if (paramInt != 1) {
        break label419;
      }
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695843));
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131696177), new mgc(this));
    }
    for (;;)
    {
      paramArrayList = ((StringBuilder)localObject).toString();
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, paramArrayList);
      return;
      l = this.a.jdField_a_of_type_ComTencentAvVideoController.jdField_c_of_type_Long;
      break;
      label419:
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695844)).append(paramInt);
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695845));
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131696178), new mgd(this));
    }
  }
  ...
  protected void b(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a() != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().G != 1))
      {
        ...
        str = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695858);
        float f = mrf.a(str, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint());
        ...
        mrf.b(localStringBuilder, (String)localObject, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
        localStringBuilder.append(str);
      }
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
    ...
    for (int i = 1;; i = 0)
    {
      ((lgf)localObject).c("setRoomMicOff", i);
      return;
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695855));
      break;
    }
  }
  ...
  protected void d(long paramLong, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      mrf.b(localStringBuilder, (String)localObject, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695860));
      mat.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
      localObject = this.a;
      if (paramInt != 1) {
        break label287;
