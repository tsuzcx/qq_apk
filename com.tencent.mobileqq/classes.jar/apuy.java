  ...
  extends apvx
{
  ...
  private apvl jdField_a_of_type_Apvl;
  private apvm jdField_a_of_type_Apvm;
  ...
  apuy(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    bnyp.a().c();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Bnym = new apvh(this);
    bnyp.a().a(this.jdField_a_of_type_Bnym);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new apvi(this);
  ...
  private int a(Context paramContext, double paramDouble, WadlParams paramWadlParams)
  {
    ...
    {
      if (paramDouble > bnyq.a())
      {
        ArkAppCenter.a().postToMainThread(new ArkAppDownloadModule.9(this, paramContext, paramWadlParams));
        return 2;
      }
      if ((bool) && (bhnv.g(paramContext)) && (bhnv.b(paramContext) != 1))
      {
        String str2 = String.format(paramContext.getString(2131690124), new Object[] { bhmh.a(paramDouble) });
        String str3 = paramContext.getString(2131690123);
  ...
  private String a(int paramInt)
  {
    ...
    case 2: 
    default: 
      str = localBaseActivity.getString(2131690121);
      return str;
    case 1: 
      return localBaseActivity.getString(2131690119);
    }
    return localBaseActivity.getString(2131690120);
  }
  ...
  private JSONObject a(WadlResult paramWadlResult, String paramString)
  {
    try
    {
      ...
      localJSONObject1.put("errCode", bkan.b(paramWadlResult.jdField_c_of_type_Int));
  ...
  {
    super.Destruct();
    bnyp.a().b(this.jdField_a_of_type_Bnym);
    this.jdField_a_of_type_Bnym = null;
    this.jdField_a_of_type_Apvl = null;
    this.jdField_a_of_type_Apvm = null;
  ...
  {
    if (!apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.DOWNLOAD"))
    {
    ...
    if (paramString.equals("QueryPackageState"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_Apvl = new apuz(this, l);
        if (paramArrayOfVariantWrapper.size() > 0) {
          bnyp.a().a(paramArrayOfVariantWrapper);
        }
        return true;
      }
      return false;
    ...
    if (paramString.equals("QueryPackageInfo"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsString())) {
        try
        {
          ...
          localObject2 = acik.a((String)localObject1);
          i = 0;
          ...
          if (localObject2 != null)
          {
            ...
            paramString = acik.d(acik.c((String)localObject1));
          }
    ...
    if (paramString.equals("QueryPackageStateVia"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_Apvm = new apvc(this, a(paramArrayOfVariantWrapper[1].Copy()));
    ...
    if (paramString.equals("DownloadInit"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
      {
        ...
        this.jdField_a_of_type_Apvk = new apvd(this);
    ...
    if (paramString.equals("StartDownload"))
    {
      ...
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        {
          bdll.a(null, "dc00898", "", "", "0X8009E12", "0X8009E12", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
          boolean bool2 = true;
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = ((arbz)localObject1).a();
              bool1 = bool2;
              if (((arct)localObject1).c != null)
              {
                bool1 = bool2;
                if (((arct)localObject1).c.contains(this.jdField_a_of_type_JavaLangString)) {
                  bool1 = false;
                }
              }
            }
          ...
          aqeg.a().a(this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper.j, paramArrayOfVariantWrapper.k, new apve(this, paramArrayOfVariantWrapper, paramString, d));
          i = 2;
        }
      }
      for (;;)
      {
        ...
        bdll.a(null, "dc00898", "", "", "0X8009E11", "0X8009E11", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
        break;
        label1007:
    ...
    if (paramString.equals("PauseDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        bnyp.a().a(i, paramString);
        paramVariantWrapper.SetBool(true);
        bdll.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "1", "", paramString, "");
        return true;
      }
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    if (paramString.equals("ContinueDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        if ((bool1) && (paramArrayOfVariantWrapper != null) && (bhnv.g(paramArrayOfVariantWrapper)) && (bhnv.b(paramArrayOfVariantWrapper) != 1))
        {
          String str1 = paramArrayOfVariantWrapper.getString(2131690116);
          String str2 = paramArrayOfVariantWrapper.getString(2131690123);
        ...
        bnyp.a().b(i, paramString);
        this.c = true;
        bdll.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "2", "", paramString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
    ...
    if (paramString.equals("InstallPackage"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        bnyp.a().b(paramString);
        bdll.a(null, "dc00898", "", "", "0X8009E16", "0X8009E16", 0, 0, "", "", paramString.jdField_a_of_type_JavaLangString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
