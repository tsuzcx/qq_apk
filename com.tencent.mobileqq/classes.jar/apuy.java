...
public class apuy
{
  ...
  public static apuz a(int paramInt1, int paramInt2, apva paramapva, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramapva.jdField_a_of_type_Int)
        {
        default: 
          paramapva = new apuz();
          paramapva.jdField_a_of_type_Int = paramInt1;
          paramapva.b = paramInt2;
          return paramapva;
        }
      }
      break;
  ...
  public static apuz a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    ...
    if (bbdx.b(paramString))
    {
      ...
      localapuz.jdField_a_of_type_Int = localOptions.outWidth;
      localapuz.b = localOptions.outHeight;
      paramString = localapuz;
  ...
  public static apuz a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      apva localapva = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localapva, false);
      i = paramInt1;
    }
  }
  
  public static apuz a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (bbdx.b(paramFileManagerEntity.strMiddleThumPath))
    {
      ...
      localapuz.jdField_a_of_type_Int = localOptions.outWidth;
      localapuz.b = localOptions.outHeight;
      paramFileManagerEntity = localapuz;
  ...
  private static apva a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      ...
      localapva.jdField_a_of_type_Int = paramInt2;
      localapva.b = paramInt1;
      return localapva;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = bflg.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = bflg.a(paramFileManagerEntity.Uuid);
      }
      else if (apvd.b(paramFileManagerEntity.getFilePath()))
      {
        localObject = apug.d(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = bbea.a((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = bflg.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = bbea.a(apug.d(paramString));
      a();
      str1 = aptm.a().d() + a(5, str1);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          {
            if (!bbdx.b(str2)) {
              aupa.a(paramString, str2, true, "", 1);
            }
            if ((!bbdx.b(str2)) || (bbdx.b(new File(str2), new File(str1)) != true)) {
              break;
            }
            return str1;
          }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        aupa.a(paramString1, str, true, "", paramInt);
        if (bbdx.b(str)) {
          break label220;
        }
      ...
      continue;
      label220:
      if (!bbdx.b(new File(str), new File(paramString2)))
      {
        bbdx.a(str, true);
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = bbea.a(apug.d(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = aptm.a().d() + a(5, bflg.a((String)localObject2));
    if ((bbdx.b(str)) && (!apvd.b(paramFileManagerEntity.strMiddleThumPath)) && (bbdx.b(new File(str), new File((String)localObject1)) == true)) {
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, aptm.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  public static boolean a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    while ((paramFileManagerEntity.cloudType == 1) && (apug.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
