...
public class bdcc
{
  ...
  public bdcc(int paramInt, String paramString1, String paramString2, Object paramObject, Bundle paramBundle)
  {
  ...
  {
    if ((paramObject instanceof bdcc))
    {
      paramObject = (bdcc)paramObject;
      if ((paramObject.jdField_a_of_type_Int == this.jdField_a_of_type_Int) && (bdeu.a(this.jdField_a_of_type_JavaLangString, paramObject.jdField_a_of_type_JavaLangString)) && ((3 != this.jdField_a_of_type_Int) || ((bdeu.a(this.b, paramObject.b)) && (bdeu.a(this.jdField_a_of_type_JavaLangObject, paramObject.jdField_a_of_type_JavaLangObject)) && (bdeu.a(this.jdField_a_of_type_AndroidOsBundle, paramObject.jdField_a_of_type_AndroidOsBundle))))) {
        return true;
      }
    }
    return false;
