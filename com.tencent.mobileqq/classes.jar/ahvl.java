...
{
  public ahvl(NewFlowCameraActivity paramNewFlowCameraActivity) {}
  ...
  public void onAnimationEnd(Animator paramAnimator)
  {
    ...
    {
      if (ahua.a == 2) {
        this.a.jdField_a_of_type_Axhx.e();
      }
      this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      if (NewFlowCameraActivity.i(this.a))
      {
        AVCodec.get().retake();
        veg.c("PTV.NewFlowCameraActivity", "AVCodec.get().retake() by mbRetake flag");
        NewFlowCameraActivity.i(this.a, false);
      }
      this.a.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Ahyb.y();
      ...
      for (;;)
      {
        ...
        return;
        label235:
        this.a.jdField_a_of_type_Axhx.c(true);
      }
    }
    if (this.a.g) {
    ...
    int i = actn.a(59.0F, this.a.getResources());
    ...
    i = actn.a(84.0F, this.a.getResources());
    paramAnimator.width = i;
    paramAnimator.height = i;
    paramAnimator.addRule(13);
