  ...
  extends zrx
{
  ...
  private static HashSet<WeakReference<ztq>> jdField_a_of_type_JavaUtilHashSet;
  private static boolean jdField_a_of_type_Boolean;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<ztq> jdField_a_of_type_JavaLangRefWeakReference;
  private HashMap<String, zrt> jdField_a_of_type_JavaUtilHashMap;
  ...
  private static void d()
  {
    ...
    jdField_a_of_type_AndroidContentBroadcastReceiver = new ztr();
  }
  
  protected String a()
  {
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = (this.jdField_a_of_type_Zrw.jdField_a_of_type_Int + "_" + this.jdField_a_of_type_Zrw.jdField_a_of_type_JavaLangString + ".virtual_host");
    }
  ...
  protected void a(android.content.Context paramContext, Intent paramIntent)
  {
    ...
    //   31: aload_1
    //   32: aload_0
    //   33: invokevirtual 81	ztq:b	()Ljava/lang/String;
    ...
    //   116: astore_2
    //   117: aload_0
    //   118: invokevirtual 112	ztq:a	()Ljava/lang/String;
    //   121: astore 8
    ...
    //   211: aload 8
    //   213: invokestatic 154	mkw:b	(Ljava/lang/String;Ljava/lang/String;)Z
    //   216: ifeq +19 -> 235
    //   219: aload_0
    //   220: aload 6
    //   222: aload_1
    //   223: aload_2
    //   224: invokevirtual 157	ztq:a	(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    //   227: return
    //   228: ldc 159
    //   230: astore 5
    //   232: goto -87 -> 145
  ...
  protected void a(String paramString, JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        zva.b(localzrt, localJSONObject);
        return;
        localzrt = (zrt)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      }
  ...
  public boolean a(int paramInt, String paramString, JSONObject paramJSONObject, @NonNull zrt paramzrt)
  {
    ...
    case 1: 
      ...
      if (TextUtils.isEmpty(paramString))
      {
        ...
        zva.a(paramzrt, -1, "event name is required");
      }
      break;
    }
    String str1;
    ...
    for (;;)
    {
      return true;
      c();
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramzrt);
      ...
      else
      {
        ...
        {
          QLog.e("DoraemonOpenAPI.event", 1, paramString.getMessage(), paramString);
          zva.a(paramzrt, -3, paramString.getMessage());
        }
        continue;
        ...
        zva.a(paramzrt, -2, "param data is over size");
      }
    }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        ((JSONObject)localObject).put("appid", this.jdField_a_of_type_Zrw.jdField_a_of_type_JavaLangString);
        ((JSONObject)localObject).put("appType", this.jdField_a_of_type_Zrw.jdField_a_of_type_Int);
