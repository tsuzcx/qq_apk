  ...
  extends LinearLayout
{
  ...
  public bqqb(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bqpk parambqpk)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      ...
      if (i == 0) {
        localLayoutParams.leftMargin = bqrh.b(getContext(), 7.0F);
      }
      if (i == this.b - 1) {
        localLayoutParams.rightMargin = bqrh.b(getContext(), 7.0F);
      }
  ...
  public void a(bqpg parambqpg, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject = parambqpg.a(paramInt2);
      localImageView.setTag(2131378440, localObject);
      localImageView.setTag(2131378427, Integer.valueOf(paramInt2));
      if (parambqpg.a(paramInt2) != 1) {
        break label252;
      }
      if (!(getContext() instanceof EditPicActivity)) {
        break label158;
      }
      localObject = parambqpg.b(paramInt2);
      localImageView.setTag(2131378440, localObject);
      bqku.a().a(localImageView, (String)localObject, this.d, this.d, paramBoolean);
    }
    for (;;)
    {
      paramInt2 += 1;
