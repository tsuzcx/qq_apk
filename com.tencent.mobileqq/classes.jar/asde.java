  ...
  public void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_Asda.jdField_b_of_type_ArrayOfByte;
      ...
      catch (Exception localException)
      {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_Asdd != null) {
            this.jdField_a_of_type_Asdd.a(arrayOfInt, this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
          }
      ...
      this.jdField_d_of_type_ArrayOfByte = this.jdField_a_of_type_Asda.jdField_a_of_type_ArrayOfByte;
