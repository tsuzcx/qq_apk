...
{
  private final bgvo jdField_a_of_type_Bgvo;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public bgvn(bgvo parambgvo, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Bgvo = parambgvo;
  ...
  private void b(bgut parambgut)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                this.jdField_a_of_type_Bgvo.a(parambgut.a(), true, false, false, str2);
                return;
              }
            } while (parambgut.d());
            if (!IOUtils.ensureStorageSpace(str4, l1 - l2))
            {
              this.jdField_a_of_type_Bgvo.a(parambgut.a(), false, false, true, "");
              return;
            }
          } while (parambgut.d());
          if (!IOUtils.ensureWritable(str4))
          {
            this.jdField_a_of_type_Bgvo.a(parambgut.a(), false, true, false, "");
            return;
          }
        } while (parambgut.d());
        localObject = IOUtils.ensureFilePath(str4, parambgut.a().b);
      } while (parambgut.d());
      String str1 = a(str3);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.equals(str2, str1)) && (TextUtils.equals(str3, IOUtils.getFileSha1(str1))))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Bgvo.a(parambgut.a(), bool, false, false, (String)localObject);
          return;
          bool = IOUtils.copyFileAndNotifyOS(WeiyunTransmissionGlobal.getInstance().getContext(), str1, (String)localObject);
        }
      }
    } while (parambgut.d());
    this.jdField_a_of_type_Bgvo.a(parambgut.a(), false, false, false, (String)localObject);
  }
  ...
  public void a(bgut parambgut)
  {
    ...
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 11, parambgut));
  }
