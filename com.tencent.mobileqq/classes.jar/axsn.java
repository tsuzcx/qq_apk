...
{
  private static axsn jdField_a_of_type_Axsn;
  ...
  private static String[] jdField_c_of_type_ArrayOfJavaLangString = { axsn.class.getName() };
  private int jdField_a_of_type_Int = -1;
  private long jdField_a_of_type_Long;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private axss jdField_a_of_type_Axss;
  private axst jdField_a_of_type_Axst;
  private List<axso> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "CPU", ajyc.a(2131701066), ajyc.a(2131701065), ajyc.a(2131701069), "WakeLock", "WIFI", "GPS" };
    jdField_a_of_type_JavaUtilSet = new BatteryStatsImpl.1();
  }
  
  public static axsn a()
  {
    if (jdField_a_of_type_Axsn != null) {
      return jdField_a_of_type_Axsn;
    }
    try
    {
      if (jdField_a_of_type_Axsn == null) {
        jdField_a_of_type_Axsn = new axsn();
      }
      axsn localaxsn = jdField_a_of_type_Axsn;
      return localaxsn;
    }
    finally {}
  }
  ...
  private final void a(long paramLong1, long paramLong2)
  {
    ...
    //   1: lload_3
    //   2: ldc2_w 194
    //   5: invokestatic 198	axsk:a	(JJJ)Ljava/util/List;
    //   8: astore 19
    //   10: aload 19
    //   12: ifnonnull +12 -> 24
    //   15: ldc 200
    ...
    //   552: invokestatic 364	axrl:a	(Landroid/content/Context;)Laxrl;
    //   555: aconst_null
    //   556: ldc_w 366
    //   559: iconst_1
    //   560: lconst_0
    ...
    //   562: aload 24
    //   564: aconst_null
    //   565: invokevirtual 369	axrl:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    //   568: return
    //   569: iload 7
    //   571: istore 18
    //   573: iload 6
    ...
    //   3198: iconst_2
    //   3199: isub
    //   3200: invokespecial 500	axsn:a	([Ljava/lang/String;II)Ljava/lang/String;
    //   3203: astore 29
    //   3205: iload 7
    //   3207: istore 16
    //   3209: iload 6
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Axst != null) {
      this.jdField_a_of_type_Axst.a(paramString);
    }
  }
  ...
  private void a(String... paramVarArgs)
  {
    if ((this.jdField_a_of_type_Int == 1) && (b())) {
      axsk.a(new Object[] { Long.valueOf(System.currentTimeMillis()), paramVarArgs });
    }
  }
  ...
  public void a()
  {
    if (b())
    {
      ...
      if ((BaseApplicationImpl.sProcessId == 4) || (BaseApplicationImpl.sProcessId == 1) || (!axbh.a(BaseApplicationImpl.sProcessId, BaseApplicationImpl.processName))) {
        break label146;
      }
    }
    for (;;)
  ...
  void a(int paramInt, String... paramVarArgs)
  {
    ...
    {
      axsk.b(new Object[] { localObject, Integer.valueOf(paramInt), Long.valueOf(l), paramVarArgs });
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext()) {
          ((axso)localIterator.next()).a(paramBundle);
        }
        if (!QLog.isColorLevel()) {}
      }
  ...
  public void a(String paramString, Object[] paramArrayOfObject)
  {
    if (this.jdField_a_of_type_Axss != null) {
      this.jdField_a_of_type_Axss.a(paramString, paramArrayOfObject);
    }
  }
    ...
    do
    {
      ...
      if (a() == 1)
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          ((axso)((Iterator)localObject).next()).b();
        }
  ...
  public void d()
  {
    ...
    if (a() == 1)
    {
      localObject = this.jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((axso)((Iterator)localObject).next()).c();
      }
        ...
        for (;;)
        {
          ...
          catch (Exception localException5)
          {
            try
            {
              ...
              bool2 = new File(bbuv.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/AutoTestFlag_01")).exists();
              if (!bool2) {
                continue;
              }
              bool1 = false;
              ...
              this.jdField_a_of_type_JavaUtilList.add(new axsq(this, paramMessage[1]));
              this.jdField_a_of_type_JavaUtilList.add(new axsu(this, paramMessage[3]));
              this.jdField_a_of_type_JavaUtilList.add(new axsp(this, paramMessage[4]));
              this.jdField_a_of_type_JavaUtilList.add(new axsw(this, paramMessage[5]));
              this.jdField_a_of_type_JavaUtilList.add(new axsz(this, paramMessage[6]));
              this.jdField_a_of_type_Axss = new axss(this, paramMessage[7]);
              this.jdField_a_of_type_JavaUtilList.add(this.jdField_a_of_type_Axss);
              if (!b()) {
                continue;
              }
              this.jdField_a_of_type_JavaUtilList.add(new axsv(this, paramMessage[2]));
              axsk.a(BaseApplicationImpl.sApplication.getQQProcessName(), this.jdField_a_of_type_Long);
              paramMessage = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramMessage.hasNext()) {
                continue;
              }
              localObject4 = (axso)paramMessage.next();
              ((axso)localObject4).a();
          ...
          if ((paramMessage.length >= 3) && (paramMessage[2].equals("1")))
          {
            ...
            if (Math.abs(System.currentTimeMillis() - l1) > 86400000L)
            {
              ...
              if (this.jdField_a_of_type_Long != 0L)
              {
                ...
                {
                  localObject5 = axsk.a(l1, l2, 10, 3000L);
              ...
              axrl.a(BaseApplication.getContext()).a(null, "batteryFileRpt", true, 0L, 0L, null, null);
              paramMessage.edit().putLong("battery_report_timestamp", l2).commit();
            }
          }
          for (;;)
          {
            axsk.a(this.jdField_a_of_type_Long - 172800000L);
            this.e = true;
            break;
