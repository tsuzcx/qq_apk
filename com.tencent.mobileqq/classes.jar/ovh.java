...
public class ovh
  extends pvq
{
  public ovh(ReadinjoyJumpActivity paramReadinjoyJumpActivity) {}
    ...
    if ((paramBoolean) && (paramList1 != null) && (!paramList1.isEmpty()))
    {
      ...
      while (i < paramList1.size())
      {
        ...
        if (paramList.mArticleID == ReadinjoyJumpActivity.a(this.a))
        {
          ...
          if ((pkj.a(ReadinjoyJumpActivity.a(this.a)) == 0) && (pqw.a(ReadinjoyJumpActivity.a(this.a).mArticleContentUrl, 0L, ReadinjoyJumpActivity.a(this.a))))
          {
            paramList = pvj.a().a();
            if (paramList != null)
            {
