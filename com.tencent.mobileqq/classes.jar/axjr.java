...
public class axjr
{
  public static int a;
  public static int b;
  private axjq jdField_a_of_type_Axjq;
  ...
  public axjr(String paramString, int paramInt, axjq paramaxjq)
  {
    this.jdField_b_of_type_JavaLangString = (FileUtils.genSeperateFileDir(paramString) + "audio_data_cache" + File.separator);
    this.jdField_a_of_type_Axjq = paramaxjq;
  }
  
  private boolean b()
  {
    return (c()) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_Axjq != null);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaLangString = (this.jdField_b_of_type_JavaLangString + azhd.a() + ".pcm");
  ...
  public void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Axjq.b(this.jdField_a_of_type_JavaLangString);
      return;
    }
    catch (IOException localIOException)
    {
