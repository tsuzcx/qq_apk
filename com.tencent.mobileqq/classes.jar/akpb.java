  ...
  extends akov
{
  ...
  public akpb(QQAppInterface paramQQAppInterface, DrawerPushItem paramDrawerPushItem)
  {
  ...
  public int a(akxc paramakxc, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    if ((this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem == null) || (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.show_sum >= this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.show_counts)) {
      return super.a(paramakxc, paramInt, paramAppInterface, paramContext);
    }
    int i;
    boolean bool;
    if (this.jdField_b_of_type_Int > alef.jdField_a_of_type_Int)
    {
      i = 3;
      ...
      paramInt = 6;
      akwt.a(paramakxc, 6, paramAppInterface);
    }
    for (;;)
    {
      ...
      break;
      label172:
      super.a(paramakxc, i, paramInt, paramAppInterface, paramContext);
      akzg.a(paramAppInterface, ApolloUtil.c(this.jdField_b_of_type_Int) + "/d.zip", ApolloUtil.d(this.jdField_b_of_type_Int));
      paramInt = 0;
      continue;
      label225:
      super.a(paramakxc, i, paramInt, paramAppInterface, paramContext);
  ...
  public void a(akxc paramakxc, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.is_reddot == 0)
    {
      ...
      if (!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
        akwt.a(paramakxc, jdField_a_of_type_JavaLangString, this.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.bubble_res_id);
      }
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      paramakxc = (akji)paramQQAppInterface.getManager(153);
      paramContext = jdField_d_of_type_JavaLangString;
      if (!paramakxc.jdField_d_of_type_Boolean) {
        break label249;
      }
    }
    label249:
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      paramakxc = (axho)paramQQAppInterface.getManager(36);
      paramakxc.b(paramakxc.a(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.reddotPath), "");
      return;
      bool = false;
      break label88;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.is_reddot != 1) {
        localakji.a(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem);
      }
    ...
    ((axho)paramQQAppInterface.getManager(36)).b(String.valueOf("103100.103200"));
  }
  
  public void a(QQAppInterface paramQQAppInterface, akxc paramakxc)
  {
    super.a(paramQQAppInterface, paramakxc);
    ...
    paramakxc = this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem;
    paramakxc.show_sum += 1;
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.reddotGameId > 0)
    {
      ...
      label89:
      paramContext = jdField_d_of_type_JavaLangString;
      if (!localakji.jdField_d_of_type_Boolean) {
        break label208;
      }
    }
    label208:
    for (int i = 0;; i = 1)
    {
      ...
      ((axho)paramQQAppInterface.getManager(36)).b(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.reddotPath);
      return;
      localakji.a(paramQQAppInterface, paramContext, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.scheme, this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.ext_url, "drawer");
      break label89;
    }
  }
