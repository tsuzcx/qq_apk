...
public class aafj
  extends ajxj
{
  public aafj(AccountManageActivity paramAccountManageActivity) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    Object localObject2 = (ayax)this.a.app.getManager(61);
    Object localObject1 = "";
    int i = ((ayax)localObject2).a();
    if (i == 0)
    {
      label43:
      ...
      if ((i > j) && (this.a.jdField_a_of_type_JavaUtilList.get(j) != null) && (paramString.equals(((SimpleAccount)this.a.jdField_a_of_type_JavaUtilList.get(j)).getUin())))
      {
        ...
        ((TextView)localObject1).setText(bbcz.h(this.a.app, paramString));
    ...
    {
      SubAccountInfo localSubAccountInfo = ((ayax)localObject2).a("sub.uin.default");
      if (localSubAccountInfo == null) {
        break label437;
      }
      localObject2 = bbcz.c(this.a.app, localSubAccountInfo.subuin, false);
    ...
    {
      break label43;
      localObject1 = i + ajya.a(2131699751);
      break label43;
      j += 1;
      break label112;
      i = 0;
