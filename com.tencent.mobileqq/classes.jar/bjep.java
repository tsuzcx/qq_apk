  ...
  implements MusicPlayerProxy
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new bjeq(this);
  private awdx jdField_a_of_type_Awdx = new bjes(this);
  ...
  private void b()
  {
    try
    {
      if (this.jdField_a_of_type_Awdz != null)
      {
        ...
        this.jdField_a_of_type_Awdz = null;
      }
      return;
    }
    catch (Throwable localThrowable)
  ...
  public com.tencent.qqmini.sdk.launcher.core.model.SongInfo getCurrentSong()
  {
    try
    {
      if (this.jdField_a_of_type_Awdz != null)
      {
        com.tencent.mobileqq.music.SongInfo localSongInfo = this.jdField_a_of_type_Awdz.a();
  ...
  public int getCurrentSongPosition()
  {
    if (this.jdField_a_of_type_Awdz != null) {
      try
      {
        int i = this.jdField_a_of_type_Awdz.d();
        return i;
      }
      catch (Exception localException)
      {
  ...
  public int getDuration()
  {
    if (this.jdField_a_of_type_Awdz != null) {
      try
      {
        int i = this.jdField_a_of_type_Awdz.c();
        return i;
      }
      catch (Exception localException)
      {
  ...
  {
    return this.jdField_a_of_type_Awdz != null;
  }
  ...
  public boolean isPlaying()
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Awdz == null) || (!this.jdField_a_of_type_Awdz.a(a())))
      {
  ...
  public void seekTo(int paramInt)
  {
    ...
    {
      if (this.jdField_a_of_type_Awdz != null) {
        this.jdField_a_of_type_Awdz.b(paramInt);
      }
      return;
    }
    catch (Exception localException)
  ...
  public void setPlayMode(int paramInt)
  {
    ...
    {
      if (this.jdField_a_of_type_Awdz != null) {
        this.jdField_a_of_type_Awdz.a(paramInt);
      }
      return;
    }
    catch (Exception localException)
  ...
  public void startPlay(com.tencent.qqmini.sdk.launcher.core.model.SongInfo[] paramArrayOfSongInfo, int paramInt)
  {
    ...
    while (this.jdField_a_of_type_Awdz == null) {
      return;
    }
    try
    {
      this.jdField_a_of_type_Awdz.a(new Intent(BaseApplication.getContext(), MusicPlayerActivity.class));
      Bundle localBundle = this.jdField_a_of_type_Awdz.a();
      Object localObject = localBundle;
      if (localBundle == null)
      {
        localObject = new Bundle();
        this.jdField_a_of_type_Awdz.a((Bundle)localObject);
      }
      ...
      this.jdField_a_of_type_Awdz.a(100);
      this.jdField_a_of_type_Awdz.a(a(), (com.tencent.mobileqq.music.SongInfo[])localObject, paramInt);
      return;
    }
