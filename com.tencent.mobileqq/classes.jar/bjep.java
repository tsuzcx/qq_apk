...
public class bjep
  implements bjex
{
  public bjep(QZoneMsgFragment paramQZoneMsgFragment) {}
    ...
    case 5: 
      ...
      do
      {
        ...
        if ((paramMQMsg != null) && (paramMQMsg.msgInteractData != null)) {
          ((bjer)this.a.a.getManager(293)).a(paramMQMsg.msgInteractData.likeCell, paramMQMsg.pushTime);
        }
        ...
        if ((paramMQMsg != null) && (paramMQMsg.msgInteractData != null))
        {
          ...
          bizm.b(this.a.getActivity(), bizt.a(), paramView);
        }
        for (;;)
        {
        ...
        for (;;)
        {
          ...
          if (paramMQMsg.msgInteractData.shareToQzone != null)
          {
            ...
            bjao.a(this.a.getActivity(), BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramView, null, 0);
          }
        }
        paramMQMsg = bdds.a(this.a.a, this.a.getActivity(), "mqqzone://arouse/activefeed");
