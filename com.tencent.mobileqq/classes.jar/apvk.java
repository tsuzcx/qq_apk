...
public class apvk
{
  ...
  public static Rect a(Context paramContext, Rect paramRect, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if ((bkur.c) && (bkur.a))
      {
        paramInt1 = bkur.b((Activity)paramContext);
  ...
  public static SpannableString a(String paramString1, String paramString2, aput paramaput)
  {
    ...
    for (int i = Color.parseColor("#A3CCEF");; i = j)
    {
      ...
      paramString1.setSpan(new annf(new apvl(paramaput), paramString2), k, k + m, 33);
      return paramString1;
    }
  }
  
  public static azqt a(QQAppInterface paramQQAppInterface, long paramLong, azpg paramazpg)
  {
    azqt localazqt2 = TroopFileTransferManager.a(paramQQAppInterface, paramLong).a(paramazpg.jdField_b_of_type_JavaLangString);
    azqt localazqt1 = localazqt2;
    if (localazqt2 == null)
    {
      localazqt1 = bakj.a(paramQQAppInterface, paramLong, paramazpg.jdField_a_of_type_JavaUtilUUID.toString(), paramazpg.jdField_b_of_type_JavaLangString, paramazpg.jdField_c_of_type_JavaLangString, paramazpg.jdField_a_of_type_Long, paramazpg.jdField_a_of_type_Int);
      localazqt1.jdField_c_of_type_JavaLangString = paramazpg.j;
      localazqt1.d = paramazpg.k;
      localazqt1.jdField_b_of_type_JavaLangString = paramazpg.i;
    }
    return localazqt1;
  }
  
  public static bbje a(int paramInt, String paramString, View.OnClickListener paramOnClickListener)
  {
    bbje localbbje = new bbje();
    localbbje.jdField_a_of_type_JavaLangString = paramString;
    localbbje.jdField_b_of_type_Int = paramInt;
    localbbje.jdField_b_of_type_Boolean = true;
    localbbje.jdField_a_of_type_AndroidViewView$OnClickListener = paramOnClickListener;
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, TextView paramTextView1, TextView paramTextView2, String paramString1, String paramString2)
  {
    ...
    int i = actn.a(7.0F, paramContext.getResources());
    int j = (int)paramTextView2.measureText(paramString2);
    int k = actn.a(15.0F, paramContext.getResources());
    switch (paramInt1)
    {
    case 1: 
    default: 
  ...
  public static String a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      if (localStringBuilder.length() > 0) {
        localStringBuilder.append(paramContext.getString(2131692475));
      }
  ...
  private static String a(AppInterface paramAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (apue.b((String)localObject)))
      {
        if (QLog.isDebugVersion()) {
      ...
      str1 = str1 + bbdm.a(paramAppInterface.getBytes()) + ".tmp";
      if (apvb.a(str1) > 0L) {
        localObject = str1;
      }
      for (;;)
      {
        if (apue.b((String)localObject))
        {
          if (QLog.isDebugVersion()) {
        ...
        paramAppInterface = apti.a().c() + bfkp.a(paramAppInterface);
        if (!apue.b(paramAppInterface)) {
          break;
        }
        if (QLog.isDebugVersion()) {
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      if (((bakk)localObject).a(String.valueOf(paramLong1), String.valueOf(paramLong2))) {
        return ajyc.a(2131709712);
      }
      localObject = ((bakk)localObject).a(String.valueOf(paramLong1));
      paramQQAppInterface = (TroopManager)paramQQAppInterface.getManager(52);
      if ((localObject != null) && (((bakr)localObject).jdField_a_of_type_Long != 0L))
      {
        if (paramQQAppInterface != null)
        {
  ...
  public static String a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        paramQQAppInterface = bakj.a(paramQQAppInterface, (MessageForTroopFile)paramMessageRecord);
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(Context paramContext, Rect paramRect, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   194: iconst_1
    //   195: invokestatic 727	atzt:a	(Ljava/lang/String;I)Z
    //   198: istore 4
    //   200: aload 8
    //   202: ldc_w 729
    //   205: iload 4
    ...
    //   224: invokestatic 730	atzt:a	(Ljava/lang/String;)Ljava/lang/String;
    //   227: astore 7
    //   229: aload 7
    ...
    //   326: aload_2
    //   327: aload 7
    //   329: invokestatic 756	aehy:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   332: iconst_m1
    //   333: iload 6
    //   335: invokestatic 761	bgkh:a	(Landroid/content/Context;Landroid/os/Bundle;Laejd;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    //   338: return
    //   339: aload 8
    //   341: ldc_w 673
    //   344: iconst_1
    ...
    //   441: aload_2
    //   442: aload 7
    //   444: invokestatic 756	aehy:a	(Lcom/tencent/mobileqq/data/ChatMessage;Lcom/tencent/mobileqq/app/QQAppInterface;)Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;
    //   447: iconst_m1
    //   448: aload_3
    //   449: getfield 776	com/tencent/mobileqq/activity/aio/SessionInfo:c	I
    //   452: invokestatic 761	bgkh:a	(Landroid/content/Context;Landroid/os/Bundle;Laejd;Lcom/tencent/mobileqq/activity/aio/photo/AIORichMediaData;II)V
    //   455: return
    //   456: astore_0
    //   457: aload_0
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, aput paramaput)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramString2))) {
      if (paramTextView.getWidth() == 0) {
        paramTextView.post(new QFileUtils.2(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramaput));
      }
    }
    while (TextUtils.isEmpty(str.replace(" ", "")))
    {
      return;
      b(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramaput);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      aptr.a(paramActivity, 2131692672, 2131692677, new apvp(paramActivity, paramFileManagerEntity));
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    {
      return;
      paramString2 = bakj.a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramString3, paramLong2, paramInt);
    } while (paramString2 == null);
    paramString1 = new Bundle();
    paramString1.putInt("dataline_forward_type", 100);
    if (bbdj.b(paramString2.jdField_a_of_type_JavaLangString)) {
      paramString1.putString("dataline_forward_path", paramString2.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      paramQQAppInterface = (ajuo)paramQQAppInterface.a(8);
      paramString2 = new apvs(paramContext);
      paramInt = paramQQAppInterface.a().b(ajsf.z, paramString1, paramString2);
      if ((paramString2.a) && (paramInt != 0)) {
        break;
      }
      eo.b(paramContext, paramInt);
      return;
      paramString3 = apue.a(paramString2);
      paramString3.status = 2;
      paramString3.nOpType = 24;
      paramString3 = aqce.a(paramString3);
      paramString3.d(1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, azqt paramazqt, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
  {
    a(paramQQAppInterface, paramContext, paramSessionInfo, paramChatMessage, paramLong1, paramazqt, paramString, paramLong2, paramInt1, paramInt2, paramRect, paramBoolean1, paramBoolean2, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, azqt paramazqt, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      paramazqt = new apok(paramQQAppInterface, paramContext, paramLong1, paramazqt, paramInt1);
      paramazqt.a(paramLong2);
      paramazqt.a(paramString);
      paramazqt.a(paramSessionInfo);
      paramazqt.a(paramChatMessage);
      paramazqt.a(paramBoolean1);
      paramazqt.b(paramBoolean3);
      ...
      paramContext = new apog(paramContext, paramazqt);
  ...
  {
    aozx.a(paramContext, new apvm(paramQQAppInterface, paramContext, paramFileManagerEntity, paramInt2, paramSessionInfo, paramChatMessage, paramBoolean1, paramBoolean2, paramInt1, paramRect));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, FileManagerEntity paramFileManagerEntity)
  {
    ...
    do
    {
      ...
      paramFileManagerEntity = (ajuo)paramQQAppInterface.a(8);
      localapvq = new apvq(paramContext);
      i = paramFileManagerEntity.a().b(ajsf.z, localBundle, localapvq);
    } while ((localapvq.a) && (i != 0));
    eo.b(paramContext, i);
    axqw.b(paramQQAppInterface, "CliOper", "", "", "0X800644B", "0X800644B", 0, 0, "6", "", "", "");
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!apue.a(paramMessageRecord1))) {}
    int i;
    do
    {
      String str;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<azpg> paramList, Activity paramActivity, long paramLong)
  {
    ...
    {
      azqt localazqt = a(paramQQAppInterface, paramLong, (azpg)paramList.next());
      FileManagerEntity localFileManagerEntity = apue.a(localazqt);
      ...
      {
        localForwardFileInfo.f(localazqt.jdField_c_of_type_JavaLangString);
        label209:
        localForwardFileInfo.d(1);
        localForwardFileInfo.a(3);
        if (!bbdj.b(localazqt.jdField_a_of_type_JavaLangString)) {
          break label295;
        }
        localArrayList2.add(Uri.parse(localazqt.jdField_a_of_type_JavaLangString));
      }
      for (;;)
      {
        long l2 = localazqt.jdField_c_of_type_Long;
        localArrayList1.add(localForwardFileInfo);
        l1 = l2 + l1;
        break;
        if (TextUtils.isEmpty(localazqt.d)) {
          break label209;
        }
        localForwardFileInfo.f(localazqt.d);
        break label209;
        label295:
    ...
    paramQQAppInterface = ajyc.a(2131709713);
    if (localArrayList1.size() == 1) {
      paramQQAppInterface = ajyc.a(2131709721) + apue.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + ajyc.a(2131709722) + apvb.a(((ForwardFileInfo)localArrayList1.get(0)).d()) + "。";
    }
    for (;;)
    {
      paramList.putExtra("forward_text", paramQQAppInterface);
      paramList.putExtra("k_favorites", false);
      aqbc.a(paramActivity, paramList, 103);
      return;
      if (localArrayList1.size() > 1) {
        paramQQAppInterface = ajyc.a(2131709717) + apue.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + ajyc.a(2131709716) + localArrayList1.size() + ajyc.a(2131709719) + apvb.a(l1) + "。";
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    String str2 = apue.a(paramString);
    int i = apue.a(str2);
    String str1 = "";
    if (i == 0) {
      str1 = ajsf.bc;
    ...
    bbdj.d(paramString, str1);
    paramString = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
    String str3 = ayxm.a(paramContext, str2);
    int j = gr.a(str1);
  ...
  public static boolean a(Context paramContext, boolean paramBoolean, apve paramapve)
  {
    int j = 2;
    boolean bool1;
    ...
    do
    {
      ...
      i = 3;
      bool2 = bbwc.a(localActivity, i, new apvn(paramapve), "");
      bool1 = bool2;
    } while (!bool2);
    ...
    for (int i = j;; i = 1)
    {
      return bcvm.a(paramContext, i, new apvo(paramapve));
      i = 2;
      break;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (aows)paramQQAppInterface.getManager(317);
    if (i >> 8 == 2)
    {
  ...
  public static String b(long paramLong)
  {
    ...
    if (paramLong > 1048576L)
    {
      ...
      return ajyc.a(2131709715) + str + "MB/s";
    }
    if (paramLong > 1024L)
    {
      f = (float)paramLong / 1024.0F;
      str = new DecimalFormat("0.00").format(f);
      return ajyc.a(2131709714) + str + "KB/s";
    }
    return ajyc.a(2131709720) + paramLong + "KB/s";
  }
  
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, aput paramaput)
  {
    String str = a(paramContext, paramString1, paramString2, paramString3, paramString4);
    Object localObject = null;
    str = apue.a(paramTextView, 2, paramString5 + str, paramString2);
    paramString2 = localObject;
    if (!TextUtils.isEmpty(str))
    {
      paramContext = a(paramContext, paramString1, str, paramString3, paramString4);
      paramContext = apue.a(paramTextView, paramString5 + paramContext);
      paramString1 = a(paramContext, str, ajyc.a(2131709718));
      if (!paramBoolean) {
        break label155;
      }
    }
    label155:
    for (paramString2 = a(paramContext, paramString1, paramaput);; paramString2 = new SpannableString(paramContext))
    {
  ...
  {
    if ((paramMessageRecord1 == null) || (!apue.a(paramMessageRecord1))) {}
    while ((paramMessageRecord2 == null) || (!apue.a(paramMessageRecord2))) {
      return;
    }
  ...
  {
    if (paramFileManagerEntity == null) {}
    while ((6 != paramFileManagerEntity.getCloudType()) || (apvb.b(paramFileManagerEntity.getFilePath()))) {
      return false;
    }
    return true;
  }
