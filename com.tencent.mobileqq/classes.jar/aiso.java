...
public class aiso
{
  ...
  anmu jdField_a_of_type_Anmu = new aisp(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aiso.class.getName();
  ...
  public aiso(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_c_of_type_JavaLangString = bgoc.a(paramQQAppInterface.getApplication());
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Aisq = null;
    this.jdField_a_of_type_Int = 0;
    b();
