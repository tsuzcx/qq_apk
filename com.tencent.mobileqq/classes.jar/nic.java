...
public class nic
{
  ...
  public Activity a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new nih(this);
  ...
  void a(npn paramnpn)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new nid(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new nie(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new nif(this));
    }
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ...
        if (paramnpn.a != null)
        {
          ...
          if (paramnpn.a.size() != 0) {
            localObject1 = ((npo)paramnpn.a.get(0)).j;
          }
        }
        if ((localObject1 != null) && (!TextUtils.isEmpty((CharSequence)localObject1)))
        {
          ...
          paramnpn = new HashMap();
          paramnpn.put("shouq_bus_type", "bus_type_account_detail");
          this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_PlayerVideoInfo.setReportInfoMap(paramnpn);
  ...
  public void a(npn paramnpn, FrameLayout paramFrameLayout)
  {
