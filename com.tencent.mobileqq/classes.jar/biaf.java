...
public class biaf
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new biag(this);
  public boolean a;
  ...
  public biaf(RegisterNewBaseActivity paramRegisterNewBaseActivity, View paramView, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity = paramRegisterNewBaseActivity;
    this.jdField_a_of_type_Biaj = new biaj(paramRegisterNewBaseActivity, this);
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentWidgetScrollView = ((ScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376967));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131381249));
  ...
  public static void a(Context paramContext, boolean paramBoolean, String paramString1, String paramString2, Intent paramIntent)
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      for (str = "1";; str = "2")
      {
        bdla.a(null, "new_reg", "setting_page_yes", "result", "", 1, "", "", str, "", "", "", "", "", "");
    ...
    {
      bdla.a(null, "new_reg", "setting_page_no", "result", "", 1, "", "", str, "", "", "", "", "", "");
      break;
    }
    label211:
    if (bool) {
  ...
  public static void a(String paramString, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (paramIntent.hasExtra("phonenum")) {
        localStringBuilder.append("phoneNum: ").append(bhft.a(paramIntent.getStringExtra("phonenum"))).append("\r\n");
      }
  ...
  private void e()
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364011));
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131716458);
      ...
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372460)).setVisibility(0);
      localClearableEditText1 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131371985);
      ClearableEditText localClearableEditText2 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131372459);
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Biaj.a(new bian(localIntent)));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363910));
      break;
      label375:
      if (jdField_a_of_type_Int != 2) {
        break label250;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bbbv = new bbbv(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Bbbv.a(localIntent);
      this.jdField_a_of_type_Bbbv.b();
      return;
    }
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      if (this.jdField_a_of_type_Biai != null) {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.removeOnLayoutChangeListener(this.jdField_a_of_type_Biai);
      }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((i == 0) && (paramBoolean))
      {
        this.jdField_a_of_type_Biaj.a().a(true);
        return;
      }
      if (i == 0)
      {
        this.jdField_a_of_type_Biaj.a().a(false);
        return;
      }
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131374785).getLocationOnScreen(arrayOfInt);
    j = arrayOfInt[1];
    this.jdField_a_of_type_AndroidViewView.findViewById(2131371985).getLocationOnScreen(arrayOfInt);
    int k = arrayOfInt[1];
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Biaj.a());
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, String.format(Locale.getDefault(), "miniHeight: %d", new Object[] { Integer.valueOf(i) }));
    }
    if (this.jdField_a_of_type_Biai == null) {
      this.jdField_a_of_type_Biai = new biai(this.jdField_a_of_type_ComTencentWidgetScrollView, this.jdField_b_of_type_Int, null);
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addOnLayoutChangeListener(this.jdField_a_of_type_Biai);
  }
  
  public void c()
  {
    if (jdField_a_of_type_Int == 1) {
      bdla.a(null, "new_reg", "setting_page_yes", "lianghao_clk", "", 1, "");
    }
    while (jdField_a_of_type_Int != 2) {
      return;
    }
    bdla.a(null, "new_reg", "setting_page_no", "lianghao_clk", "", 1, "");
  }
