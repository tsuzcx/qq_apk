...
{
  private bhdl jdField_a_of_type_Bhdl = new bhdl(a());
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = this.jdField_a_of_type_Bhdl.createEntityManager();
  ...
  {
    if (this.jdField_a_of_type_Bhdl == null) {
      this.jdField_a_of_type_Bhdl = new bhdl(a());
    }
    if (this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager == null) {
      this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = this.jdField_a_of_type_Bhdl.createEntityManager();
    }
