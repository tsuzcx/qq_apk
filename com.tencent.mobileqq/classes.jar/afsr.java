...
public class afsr
{
  ...
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new afss(this);
  ...
  public afsr(FragmentActivity paramFragmentActivity, QQAppInterface paramQQAppInterface, IntimateInfo paramIntimateInfo, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
    ...
    if ((this.c == null) || (this.c.isRecycled())) {
      this.c = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130846412);
    }
    if ((this.d == null) || (this.d.isRecycled())) {
      this.d = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130846412);
    }
    jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693360) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693361) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693362);
  }
  ...
  private void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Biyn = new afst(this);
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    QZoneHelper.forwardToPublishMood(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, localUserInfo, paramBitmap, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693364), "", 20001);
  }
  
  private void c()
  {
    this.jdField_a_of_type_Bhhp = new bhhp(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_ArrayOfJavaUtilList = a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_Bhhp.setActionSheetItems(this.jdField_a_of_type_ArrayOfJavaUtilList);
    this.jdField_a_of_type_Bhhp.setItemClickListener(this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener);
  }
  ...
  private void c(Bitmap paramBitmap)
  {
    try
    {
      ...
      aupt.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, (Intent)localObject, 21);
      return;
    }
  ...
  private void e(Bitmap paramBitmap)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.requestPermissions(new afsu(this, paramBitmap), 1, new String[] { "android.permission.WRITE_EXTERNAL_STORAGE" });
        return;
      }
      a(paramBitmap);
      return;
  ...
  public Bitmap a(Bitmap paramBitmap)
  {
    ...
    localCanvas.restore();
    localCanvas.drawBitmap(a(BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840524), 194, 40), 512.0F, 1185.0F, null);
    return paramBitmap;
  }
  ...
  public Bitmap a(IntimateInfo paramIntimateInfo)
  {
    ...
    {
    default: 
      localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693352);
      j = Color.parseColor("#03081A");
      i = Color.parseColor("#878B99");
      localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840520);
      ...
      a(localCanvas, localTextPaint, 8.0F + (f + 146.0F), 410.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693294, new Object[] { "" }));
      ...
      localStringBuilder.append(((Resources)localObject1).getString(2131693347));
      localStringBuilder.append("\r\n");
      localStringBuilder.append(((Resources)localObject1).getString(2131693348));
      localStringBuilder.append("\r\n");
      j = 2;
      if ((paramIntimateInfo.commonTroopInfoList != null) && (paramIntimateInfo.commonTroopInfoList.size() > 0))
      {
        localStringBuilder.append(((Resources)localObject1).getString(2131693326));
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.commonTroopInfoList.size());
        localStringBuilder.append(((Resources)localObject1).getString(2131693309));
        localStringBuilder.append("\r\n");
        label509:
    ...
    for (;;)
    {
      if ((paramIntimateInfo.dnaInfoList != null) && (paramIntimateInfo.dnaInfoList.size() > 0))
      {
        ...
        for (;;)
        {
          if (k < j)
          {
            ...
            k += 1;
            continue;
            localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693355);
            j = Color.parseColor("#FF6FA3");
            i = Color.parseColor("#FF8AB5");
            localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840523);
            break;
            localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693353);
            j = Color.parseColor("#FF8A2D");
            i = Color.parseColor("#FF9F40");
            localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840521);
            break;
            localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693359);
            j = Color.parseColor("#8173FF");
            i = Color.parseColor("#8173FF");
            localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840525);
            break;
            localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693354);
            j = Color.parseColor("#2493FF");
            i = Color.parseColor("#4DA7FF");
            localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840522);
            break;
            j = 3;
            break label509;
          }
      ...
      localStringBuilder.append(((Resources)localObject1).getString(2131693349));
      localStringBuilder.append("\r\n");
      localStringBuilder.append(((Resources)localObject1).getString(2131693350));
  ...
  public String a(Bitmap paramBitmap)
  {
    ...
    //   19: aload_0
    //   20: getfield 35	afsr:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   38: astore 4
    //   40: new 361	java/io/File
    //   43: dup
    //   44: new 361	java/io/File
    //   47: dup
    ...
    //   63: invokespecial 362	java/io/File:<init>	(Ljava/lang/String;)V
    //   66: astore_3
    //   67: aload_3
    ...
    //   75: ifnonnull +11 -> 86
    //   78: aload_0
    //   79: getfield 33	afsr:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    ...
    //   174: areturn
    //   175: astore_1
    //   176: invokestatic 328	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   179: ifeq -7 -> 172
    //   182: ldc_w 330
    //   185: iconst_2
    //   186: aload_1
    //   187: invokevirtual 767	java/io/IOException:getMessage	()Ljava/lang/String;
    //   190: invokestatic 335	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   193: aload 4
    //   195: areturn
    //   196: astore 4
    //   198: aconst_null
    ...
    //   200: aload_1
    //   201: astore_2
    //   202: invokestatic 328	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   205: ifeq +17 -> 222
    //   208: aload_1
    //   209: astore_2
    //   210: ldc_w 330
    ...
    //   219: invokestatic 335	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   222: aload_1
    //   223: ifnull +7 -> 230
    //   226: aload_1
    ...
    //   231: areturn
    //   232: astore_1
    //   233: invokestatic 328	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   236: ifeq -6 -> 230
    //   239: ldc_w 330
    //   242: iconst_2
    //   243: aload_1
    //   244: invokevirtual 767	java/io/IOException:getMessage	()Ljava/lang/String;
    //   247: invokestatic 335	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   250: goto -20 -> 230
    //   253: astore_1
    //   254: aconst_null
    //   255: astore_2
    ...
    //   265: athrow
    //   266: astore_2
    //   267: invokestatic 328	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   270: ifeq -6 -> 264
    //   273: ldc_w 330
    //   276: iconst_2
    //   277: aload_2
    //   278: invokevirtual 767	java/io/IOException:getMessage	()Ljava/lang/String;
    //   281: invokestatic 335	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   284: goto -20 -> 264
    //   287: astore_1
    //   288: goto -32 -> 256
    //   291: astore 4
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bhhp.a(this.jdField_a_of_type_AndroidGraphicsBitmap);
    this.jdField_a_of_type_Bhhp.show();
  }
  ...
  public void a(int paramInt, Bitmap paramBitmap)
  {
    if ((paramInt == 3) || (paramInt == 4))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693357), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
    for (;;)
    {
      d();
      ...
      if (!WXShareHelper.a().b()) {
        QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693365), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      }
    }
  }
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = paramContext.getString(2131693367);
    localActionSheetItem.icon = 2130840220;
    localActionSheetItem.iconNeedBg = true;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bhhp != null) {
      this.jdField_a_of_type_Bhhp.dismiss();
    }
  }
}
