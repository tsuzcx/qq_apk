  ...
  extends WebViewPlugin
{
  ...
  private static long a(bcdb parambcdb)
  {
    if (parambcdb == null) {
      return 0L;
    }
    try
    {
      long l = parambcdb.a().getIntent().getLongExtra("preAct_time", 0L);
      return l;
    }
    catch (Exception parambcdb)
    {
      QLog.w("QzoneWebViewOfflinePlugin", 2, "can not get click time", parambcdb);
    }
    return 0L;
  }
  ...
  private Object a(String paramString)
  {
    ...
    for (AppInterface localAppInterface = this.mRuntime.a();; localAppInterface = null)
    {
      ...
      return bhru.a(localAppInterface, localCustomWebView, paramString, (String)localObject);
      localObject = null;
      break;
      localObject = null;
      break label27;
  ...
  private void a(bcgs parambcgs, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambcgs == null) {
      return;
    }
    QLog.i("QzoneWebViewOfflinePlugin", 1, "state is " + parambcgs);
    for (;;)
    {
      ...
      try
      {
        ...
        switch (parambcgs.jdField_a_of_type_Int)
        {
        case 1: 
          if (!TextUtils.isEmpty(parambcgs.jdField_b_of_type_JavaLangString)) {
            localJSONObject.put("url", parambcgs.jdField_b_of_type_JavaLangString);
          }
          localJSONObject.put("code", parambcgs.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(parambcgs.f)) {
            localJSONObject.put("msg", parambcgs.f);
          }
          localJSONObject.put("dataIsBase64", parambcgs.jdField_a_of_type_Boolean);
          if (TextUtils.isEmpty(parambcgs.d)) {
            break label392;
          }
          if (!parambcgs.jdField_a_of_type_Boolean) {
            break label383;
          }
          str = bbca.encodeToString(parambcgs.d.getBytes(), 0);
          localJSONObject.put("data", str);
          if (parambcgs.jdField_b_of_type_Int > 0) {
            localJSONObject.put("httpStatusCode", parambcgs.jdField_b_of_type_Int);
          }
          if (!TextUtils.isEmpty(parambcgs.jdField_c_of_type_JavaLangString)) {
            localJSONObject.put("header", new JSONObject(parambcgs.jdField_c_of_type_JavaLangString));
          }
          if (parambcgs.jdField_a_of_type_JavaLangObject != null) {
            localJSONObject.put("userinfo", parambcgs.jdField_a_of_type_JavaLangObject);
          }
          callJs(paramString, new String[] { localJSONObject.toString() });
          long l1 = System.currentTimeMillis();
          long l2 = parambcgs.jdField_a_of_type_Long;
          QLog.i("QzoneWebViewOfflinePlugin", 1, "wnscgi@ status=" + parambcgs.jdField_a_of_type_Int + ",total cost " + (l1 - l2) + " ms");
          return;
        }
      }
      catch (Exception parambcgs)
      {
        parambcgs.printStackTrace();
        return;
      }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new xmk(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private static void b(String paramString, long paramLong, bcdb parambcdb)
  {
    int i;
    long l;
    try
    ...
    label205:
    String str1;
    if ((!TextUtils.isEmpty(paramString)) && (parambcdb != null) && ((8589934594L == paramLong) || (8589934593L == paramLong)) && (paramString.equals(QzoneConfig.getInstance().getConfig("H5Url", "GameBar", "https://h5.qzone.qq.com/h5plus/homeV2/index/alpha?_proxy=1&_wv=3&via=qqnavigation.2017"))))
    {
      l = a(parambcdb);
      if (l <= 0L)
      {
      ...
      if (QzoneOfflineCacheHelper.getSmallGameLastCacheTime(parambcdb.a().getLongAccountUin()) <= 0L) {
        break label367;
      }
      i = 1;
    ...
    for (;;)
    {
      ...
      axql.a(localBaseApplication).reportTimeKVEvent(str1, localProperties, (int)l);
      if (8589934594L == paramLong) {}
      for (paramString = ajyc.a(2131712619);; paramString = ajyc.a(2131712620))
      {
        QLog.i("QzoneWebViewOfflinePlugin", 2, paramString + l + "ms,mta key=" + str1);
        if (8589934594L != paramLong) {
          break;
        }
        QzoneOfflineCacheHelper.updataSmallGameLastCacheFinishTime(parambcdb.a().getLongAccountUin(), System.currentTimeMillis());
        return;
      }
      while (i == 0)
      {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      localbcgr.f = ((JSONObject)localObject2).optString("callback");
      localbcgr.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("url");
    ...
    catch (Exception localException)
    {
      ...
      paramVarArgs = new bcgs();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbcgr.jdField_a_of_type_JavaLangString;
      paramVarArgs.jdField_a_of_type_Int = 3;
      paramVarArgs.jdField_c_of_type_Int = 101;
      paramVarArgs.f = localException.getMessage();
      paramVarArgs.e = localbcgr.f;
      a(paramVarArgs, localbcgr.f);
      return;
    }
    if (!a(a(), localbcgr.jdField_a_of_type_JavaLangString))
    {
      localObject1 = a(a());
      localObject2 = a(localbcgr.jdField_a_of_type_JavaLangString);
      throw new Exception("not support for cross-domain request!!! current host=" + (String)localObject1 + ",req host=" + (String)localObject2);
    }
    localbcgr.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("method");
    if ((!"GET".equalsIgnoreCase(localbcgr.jdField_b_of_type_JavaLangString)) && (!"POST".equalsIgnoreCase(localbcgr.jdField_b_of_type_JavaLangString))) {
    ...
    for (localbcgr.d = a((JSONObject)localObject1);; localbcgr.d = localObject1.toString())
    {
    ...
    {
      localbcgr.jdField_c_of_type_JavaLangString = ((String)localObject1);
      localbcgr.jdField_a_of_type_Boolean = ((JSONObject)localObject2).optBoolean("dataNeedBase64", false);
      localbcgr.jdField_a_of_type_Int = ((int)(((JSONObject)localObject2).optDouble("timeout", 0.0D) * 1000.0D));
      localbcgr.jdField_a_of_type_JavaLangObject = ((JSONObject)localObject2).opt("userinfo");
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new xml(this, Looper.getMainLooper());
      }
      if (bcgq.a().a(localbcgr, this.jdField_b_of_type_AndroidOsHandler)) {
        break;
      }
      paramVarArgs = new bcgs();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbcgr.jdField_a_of_type_JavaLangString;
  ...
  protected void a(bcgs parambcgs)
  {
    a(parambcgs, parambcgs.e);
  }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if (paramLong == 8L)
    {
      if (this.mRuntime != null)
      {
        bhru.a = new WeakReference(this.mRuntime.a());
        bhru.b = new WeakReference(this.mRuntime.a());
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if ((bool) && (!TextUtils.isEmpty(bche.d(this.jdField_a_of_type_JavaLangString))))
        {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new xmj(this, Looper.getMainLooper());
        }
