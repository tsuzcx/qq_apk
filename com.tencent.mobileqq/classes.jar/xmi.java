  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  public boolean onDoubleTap(MotionEvent paramMotionEvent)
  {
    ...
    localObject = (xsw)((StoryPlayerGroupHolder)localObject).b(xsw.class);
    if ((localObject != null) && (((xsw)localObject).d()))
    {
      try
      {
        localObject = (AnimationDrawable)this.a.a().getResources().getDrawable(2130846919);
      ...
      {
        bcrp.a(paramMotionEvent);
        return false;
      }
      yqp.c(this.a.jdField_a_of_type_JavaLangString, "onDoubleTap handle");
    }
    for (;;)
    {
      return super.onDoubleTap(paramMotionEvent);
      yqp.c(this.a.jdField_a_of_type_JavaLangString, "onDoubleTap not handle");
    }
  }
  ...
  public boolean onSingleTapConfirmed(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      yqp.c(this.a.jdField_a_of_type_JavaLangString, "onSingleTapConfirmed");
      return true;
      paramMotionEvent.a(true, true);
      yqu.a("play_video", "clk_video", 0, 0, new String[] { "", "2", "", "" });
      continue;
      paramMotionEvent.a(false, true);
      yqu.a("play_video", "clk_video", 0, 0, new String[] { "", "1", "", "" });
    }
  }
}
