  ...
  implements bhpa<String>
{
  ...
  public bhqp(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
  ...
  public bhqp(String paramString1, int paramInt, String paramString2, long paramLong)
  {
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = jdField_b_of_type_AndroidGraphicsDrawableDrawable;
  ...
  public void a(String paramString, Object paramObject)
  {
    ...
    do
    {
      ...
      } while ((this.jdField_b_of_type_Int == -1) && (bhiw.a()));
      localObject = (VasAvatar)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while ((localObject == null) || (((VasAvatar)localObject).jdField_a_of_type_Bhqp != this));
    try
    {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((localObject1 == null) || (((VasAvatar)localObject1).jdField_a_of_type_Bhqp != this)) {}
    Object localObject2;
    do
    {
      do
      ...
      localObject1 = ((bhou)((QQAppInterface)localObject2).getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a;
