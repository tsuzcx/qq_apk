...
public class aigi
  implements acnb, anze
{
  private final aigm jdField_a_of_type_Aigm = new aigm(null);
  private Activity jdField_a_of_type_AndroidAppActivity;
  private anzc jdField_a_of_type_Anzc;
  private aodb jdField_a_of_type_Aodb = new aigj(this);
  ...
  private final aigm jdField_b_of_type_Aigm = new aigm(null);
  private boolean jdField_b_of_type_Boolean;
  private final aigm jdField_c_of_type_Aigm = new aigm(null);
  private boolean jdField_c_of_type_Boolean;
  private final aigm jdField_d_of_type_Aigm = new aigm(null);
  private boolean jdField_d_of_type_Boolean;
  private final aigm jdField_e_of_type_Aigm = new aigm(null);
  private boolean jdField_e_of_type_Boolean;
  private final aigm jdField_f_of_type_Aigm = new aigm(null);
  private boolean jdField_f_of_type_Boolean;
  private boolean g;
  
  public aigi(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
  ...
  private Calendar a()
  {
    return this.jdField_a_of_type_Anzc.a();
  }
  ...
  private void a(int paramInt)
  {
    ...
    RoamDate localRoamDate = this.jdField_a_of_type_Anzc.a().a(this.jdField_a_of_type_JavaLangString, localCalendar.get(1), localCalendar.get(2) + 1);
  ...
  {
    this.jdField_a_of_type_Anzc.a(paramCalendar.get(1), paramCalendar.get(2), paramCalendar.get(5));
    this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Anzc.a();
  }
  
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    int j = this.jdField_a_of_type_Anzc.b();
    ...
    {
      this.jdField_f_of_type_Aigm.a();
      ((AccountManager)localObject2).refreshDA2(((QQAppInterface)localObject1).getCurrentAccountUin(), new aigl(this));
      this.jdField_f_of_type_Aigm.a(30000L);
      return;
    }
    this.g = false;
    return;
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.jdField_b_of_type_Aigm.a();
    this.jdField_a_of_type_Anzc.a(paramBoolean);
    this.jdField_b_of_type_Aigm.a(30000L);
    a(3);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
      QLog.d("C2CMsgRoamProxy", 2, "getRoamMessageTimeLineSync cost: " + (l2 - l1) + ", result: " + this.jdField_a_of_type_Boolean);
    }
    this.jdField_a_of_type_Anzc.f();
    this.jdField_a_of_type_Anzc.c(this.jdField_a_of_type_Boolean);
  }
  
  private void c()
  {
    if (this.jdField_a_of_type_Anzc.i()) {}
    long l1;
    long l2;
    do
    {
      ...
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).addObserver(this.jdField_a_of_type_Aodb);
      VasExtensionHandler localVasExtensionHandler = (VasExtensionHandler)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.VAS_EXTENSION_HANDLER);
      this.jdField_c_of_type_Aigm.a();
  ...
  private void c(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Boolean = false;
        break;
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692817), 0).a();
      }
      this.jdField_a_of_type_Boolean = false;
      continue;
  ...
  private void c(boolean paramBoolean)
  {
    ...
    this.jdField_e_of_type_Aigm.a();
    int[] arrayOfInt = new int[1];
    DevlockInfo[] arrayOfDevlockInfo = new DevlockInfo[1];
    asll.a().a(localQQAppInterface, localQQAppInterface.getCurrentAccountUin(), new aigk(this, l, arrayOfInt, arrayOfDevlockInfo));
    this.jdField_e_of_type_Aigm.a(30000L);
  ...
  private void e(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    if (localObject == null)
    {
      ...
      this.jdField_a_of_type_Aigm.b();
      return;
    }
    localObject = (anzc)((QQAppInterface)localObject).getManager(QQManagerFactory.MESSAGE_ROAM_MANAGER);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (i == 0) {
        ((anzc)localObject).a(localCalendar, false);
      }
      switch (paramInt1)
      {
      case 3: 
    ...
    for (;;)
    {
      ((anzc)localObject).e();
      return;
      paramObject = ((anzc)localObject).a();
      if (paramObject != null) {
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692819, new Object[] { Integer.valueOf(paramObject.get(2) + 1), Integer.valueOf(paramObject.get(5)) }), 0).a();
      }
    }
    ((anzc)localObject).e();
  }
  ...
  private boolean e()
  {
    ...
    localObject = (apac)((QQAppInterface)localObject).getBusinessHandler(BusinessHandlerFactory.GET_ROAMMESSAGE_HANDLER);
    if (localObject != null)
    {
      long l1 = SystemClock.uptimeMillis();
      this.jdField_d_of_type_Aigm.a();
      ((apac)localObject).a();
      this.jdField_d_of_type_Aigm.a(30000L);
      long l2 = SystemClock.uptimeMillis();
      if (QLog.isColorLevel()) {
  ...
  List<ChatMessage> a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Anzc.a() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "current page date is null, show roam flag: " + this.jdField_a_of_type_Anzc.e());
      return null;
    }
    Object localObject = this.jdField_a_of_type_Anzc.a(paramInt);
    if ((localObject != null) && (((RoamMessagePreloadInfo)localObject).curday != null))
    {
      l1 = SystemClock.uptimeMillis();
      this.jdField_a_of_type_Aigm.a();
      this.jdField_a_of_type_Anzc.a(((RoamMessagePreloadInfo)localObject).curday, null, false, false);
      if (QLog.isColorLevel()) {
        QLog.d("C2CMsgRoamProxy", 2, "getHistorySig wait");
      }
      this.jdField_a_of_type_Aigm.a(30000L);
      long l2 = SystemClock.uptimeMillis();
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      while (localIterator1.hasNext())
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (acnh.a(localMessageRecord, localChatMessage, true)) {
            localArrayList.add(localChatMessage);
          }
        }
      }
      ((List)localObject).removeAll(localArrayList);
      if ((((List)localObject).size() > 0) && (paramMessageRecord != null) && (avia.a(paramMessageRecord)) && (((ChatMessage)((List)localObject).get(0)).time >= paramMessageRecord.time))
      {
        if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Anzc != null)
    {
      ...
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).removeObserver(this.jdField_a_of_type_Aodb);
    }
    ...
    if ((!this.jdField_b_of_type_Boolean) || (paramBoolean)) {
      try
      {
        if ((!this.jdField_b_of_type_Boolean) || (paramBoolean))
        {
          ...
          this.jdField_a_of_type_Anzc = ((anzc)((QQAppInterface)localObject1).getManager(QQManagerFactory.MESSAGE_ROAM_MANAGER));
          this.jdField_a_of_type_Anzc.a(this.jdField_a_of_type_JavaLangString, false);
          localObject1 = Calendar.getInstance();
          ((Calendar)localObject1).setTimeInMillis(NetConnInfoCenter.getServerTimeMillis());
          this.jdField_a_of_type_Anzc.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), ((Calendar)localObject1).get(5));
          this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Anzc.a();
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, QQMessageFacade.RefreshMessageContext paramRefreshMessageContext, ArrayList<MessageRecord> paramArrayList, MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    if (paramMessageRecord == null)
    {
      ...
      if ((paramMessageRecord != null) && ((this.jdField_a_of_type_Anzc == null) || (!this.jdField_a_of_type_Anzc.e()) || (this.jdField_a_of_type_Anzc.a() != null))) {
        break label116;
      }
    }
    label116:
    ...
    if (a() == null)
    {
      ...
      paramRefreshMessageContext = this.jdField_a_of_type_Anzc.d;
      a(true);
  ...
  boolean b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        b();
        l1 = SystemClock.uptimeMillis();
        bool3 = NetworkUtil.isNetSupport(BaseApplication.getContext());
        c();
        bool4 = this.jdField_a_of_type_Anzc.h();
        bool1 = bool2;
      } while (!bool3);
      bool1 = bool2;
    } while (!bool4);
  ...
  boolean c()
  {
    Object localObject2 = this.jdField_a_of_type_Anzc.c();
    ...
    if (this.jdField_a_of_type_Anzc.b() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "can not get first page date, roam flag: " + this.jdField_a_of_type_Anzc.e());
      return true;
    }
    long l = this.jdField_a_of_type_Anzc.b().getTimeInMillis();
    while (((Calendar)localObject1).getTimeInMillis() >= l)
    {
      int i = ((Calendar)localObject1).get(5);
      localObject2 = this.jdField_a_of_type_Anzc.a().a(this.jdField_a_of_type_JavaLangString, ((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2) + 1);
      if (localObject2 == null)
      {
        if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Anzc.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), i);
