  ...
  extends bciq
{
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.setComplete(new atct(this));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.a.setText(ajyc.a(2131705094));
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.c();
    ...
    this.a.jdField_a_of_type_Bcis.a();
  ...
  public void a(submsgtype0xdd.MsgBody paramMsgBody)
  {
    ...
    case 1: 
      do
      {
        ...
        if ((!paramMsgBody.uint64_invite_leader.has()) || (paramMsgBody.uint64_invite_leader.get() == this.a.app.getLongAccountUin()))
        {
          ...
          ((atdl)localObject).jdField_a_of_type_JavaLangString = (localPlayerState.uint64_uin.get() + "");
        ...
        {
          ((atdl)localObject).jdField_a_of_type_Boolean = bool;
    ...
    case 2: 
      ...
      atbg.a(this.a.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(awzw.a()));
      return;
    case 3: 
      label135:
      label250:
      bcpw.a(this.a, ajyc.a(2131705119), 0).a();
      this.a.finish();
      this.a.jdField_a_of_type_JavaUtilList = null;
      bbjn.a(this.a, this.a.app.getCurrentAccountUin(), false, System.currentTimeMillis());
      return;
    }
    this.a.a(null, ajyc.a(2131705096), true);
  }
}
