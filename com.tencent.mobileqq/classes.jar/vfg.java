  ...
  extends aabe
{
  ...
  private void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidAppDialog = new ReportDialog(a(), 2131755242);
      this.jdField_a_of_type_AndroidAppDialog.setCanceledOnTouchOutside(true);
      View localView = LayoutInflater.from(a()).inflate(2131560805, null);
      this.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgress = ((CircleProgress)localView.findViewById(2131373918));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131373917));
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_AndroidAppDialog != null) && (this.jdField_a_of_type_AndroidAppDialog.isShowing()))
    {
      ...
      localView = LayoutInflater.from(a()).inflate(2131560806, null);
      localToast.setDuration(0);
      localTextView = (TextView)localView.findViewById(2131365724);
      if (!paramBoolean) {
        break label120;
      }
    }
    label120:
    for (String str = a().getResources().getString(2131697202);; str = a().getResources().getString(2131697201))
    {
