...
public class azuy
{
  private static volatile azuy a;
  public static final String a;
  
  static
  {
    jdField_a_of_type_JavaLangString = anhk.ba + "qbdownres";
  }
  ...
  public static azuy a()
  {
    if (jdField_a_of_type_Azuy == null) {}
    try
    {
      if (jdField_a_of_type_Azuy == null) {
        jdField_a_of_type_Azuy = new azuy();
      }
      return jdField_a_of_type_Azuy;
    }
    finally {}
  }
  ...
  public static boolean a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if ((QzoneConfig.getInstance().getConfig("Schema", "jump_installapp_scheme_enable", 0) == 0) && (atwl.b((String)localObject)))
      {
  ...
  private boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (azvf.a(paramString2))
    {
      a(paramQQAppInterface.getAccount(), paramString1);
      atwl.c(str);
      return false;
    }
    bmev.a().c(paramString4, null);
    return false;
  }
  ...
  private static void b(String paramString1, SoftReference<QQAppInterface> paramSoftReference, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      if (paramSoftReference != null)
      {
        paramSoftReference = (beaw)paramSoftReference.getManager(193);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (localbeaw.a())
      {
        ...
        localbeaw.a(10088, "vas", paramString2, 0, paramString2, paramString3, 1, 2, true, new azuz(this, paramQQAppInterface, "qboss_pre_download_res", paramString1, paramString3, paramString2, paramString4));
        return;
      }
