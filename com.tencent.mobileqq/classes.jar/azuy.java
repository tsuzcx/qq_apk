  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    localBundle.putString("file_send_path", azux.a(this.a));
    ...
    do
    {
      ...
      paramView = "";
      if ((azux.b(this.a) == null) || (azux.b(this.a).equals(""))) {
        break label500;
      }
      localBundle.putString("struct_msg_video_info", azux.b(this.a));
      ...
      try
      {
        localObject2 = new JSONObject(azux.b(this.a));
      ...
      azmj.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005C9A", "0X8005C9A", 0, 1, 0, ((StructMsgForGeneralShare)localObject1).uin, ((StructMsgForGeneralShare)localObject1).currentAccountUin, azux.a(this.a), paramView);
    ...
    try
    {
      ...
      paramView.put("net", String.valueOf(ndd.a()));
      paramView.put("mobile_imei", bdcb.a());
      paramView.put("obj", "");
      ...
      swj.a((AppInterface)localObject2, ((StructMsgForGeneralShare)localObject1).message.selfuin, paramView.toString(), "" + ((StructMsgForGeneralShare)localObject1).msgId);
      return;
    }
