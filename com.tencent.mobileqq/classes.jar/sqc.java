...
public class sqc
{
  ...
  public LocalMediaInfo a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo == null)
    {
      ...
      int i = ayon.jdField_a_of_type_Int;
  ...
  {
    if ((paramObject instanceof sqc)) {
      return this.jdField_a_of_type_JavaLangString.equals(((sqc)paramObject).jdField_a_of_type_JavaLangString);
    }
    return false;
  }
