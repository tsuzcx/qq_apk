...
public class sqc
  extends sys<sqd>
{
  private static final String jdField_a_of_type_JavaLangString = sxm.a("StorySvc.batch_get_poi_list");
  ...
  public sqd a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new sqd(localRspBatchGetPOIList);
    }
