...
{
  private jmn(AVServiceForQQ paramAVServiceForQQ) {}
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      new Handler(Looper.getMainLooper()).post(new jmp(this, i));
    }
  }
  ...
  public void a(boolean paramBoolean, Notification paramNotification)
  {
    ...
    for (;;)
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().post(new jmo(this));
        return;
      }
    }
