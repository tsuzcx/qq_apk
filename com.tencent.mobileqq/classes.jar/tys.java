...
public class tys
{
  ...
  public static tys a(int paramInt)
  {
    return new tys(paramInt);
  }
  
  private void a(byte[] paramArrayOfByte)
  {
    tym.a().a(this.a, paramArrayOfByte);
  }
  
  public FeedCloudCommon.StCommonExt a(boolean paramBoolean)
  {
    byte[] arrayOfByte1 = null;
    byte[] arrayOfByte2 = tym.a().a();
    if (!paramBoolean) {
      arrayOfByte1 = tym.a().a(this.a);
    }
