...
public class lty
  implements Handler.Callback, lue
{
  public int a;
  public Handler a;
  ...
  public lty(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity)
  {
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365689);
    Object localObject1 = null;
    Object localObject2;
    View localView;
    if (localViewGroup != null)
    {
      localObject2 = (RedPacketGameView)localViewGroup.findViewById(2131373571);
      ...
      if (localObject2 == null)
      {
        ...
        localView = localViewGroup.findViewById(2131373539);
        if (localView == null) {
          break label128;
        }
      }
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365689);
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)localViewGroup.findViewById(2131373571);
  ...
  public void a(int paramInt)
  {
    ...
    c();
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373571);
  ...
  public void a(int paramInt, luf paramluf)
  {
    if (QLog.isColorLevel()) {
    ...
    catch (Exception paramluf)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AVRedPacketManager", 2, "AVRedPacketGameControl.preLoadRes  exception", paramluf);
      }
    }
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373571);
  ...
  public boolean a()
  {
    Object localObject = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373571);
  ...
  public void b()
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373571)).d();
  }
  ...
  public void b(AVRedPacketManager.LocalFrameSyncInfo paramLocalFrameSyncInfo)
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373571)).b(paramLocalFrameSyncInfo);
  }
