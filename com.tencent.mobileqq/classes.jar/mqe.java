  ...
  extends mpg
{
  ...
  void a(String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        this.jdField_a_of_type_Mqf.a(this);
  ...
  public boolean a(int paramInt, Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      AudioHelper.a(ajya.a(2131713836), paramIntent.getExtras());
  ...
  public boolean a(VideoAppInterface paramVideoAppInterface, int paramInt, Activity paramActivity, mqf parammqf)
  {
    this.b = 2;
    long l1 = mpv.a(paramVideoAppInterface);
    if (l1 == 0L) {
      return false;
    }
