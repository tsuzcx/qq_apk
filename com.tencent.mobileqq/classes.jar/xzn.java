  ...
  implements ycf, ydf
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = xzn.class.getSimpleName();
  }
  
  public xzn(Bundle paramBundle)
  {
    super(paramBundle);
  }
  ...
  private boolean a(long paramLong, CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    } while (!xxl.a(paramStFeed.poster.attr.get()));
    return false;
  }
  ...
  private void k()
  {
    ...
    if ((a() instanceof SubscribeBaseFragment)) {
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.setShareClickListener(new xzo(this));
    }
  ...
  public xzf a(int paramInt)
  {
    ...
    localxzf.jdField_a_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    localxzf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare = this.jdField_b_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare;
    if (paramInt == 1) {}
    for (;;)
    {
      localxzf.jdField_a_of_type_Boolean = bool;
      localxzf.jdField_a_of_type_Int = paramInt;
      return localxzf;
      bool = false;
    }
  }
  ...
  public yhg a()
  {
    return this.jdField_a_of_type_Yhg;
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    b("share_key_subscribe_feeds_update", new ydw(paramStFeed));
    if ((a() instanceof SubscribeBaseFragment)) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      b("share_key_subscribe_feeds_update", new ydw(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed));
      if (!this.d)
      {
        this.jdField_a_of_type_ComTencentBizSubscribeWidgetStatusView = a().a();
        paramBundle = xxl.a() + File.separator + a(a()) + ".png";
      ...
      k();
      this.jdField_a_of_type_Yhg = new yhg(a());
      return;
    }
  ...
  protected void c()
  {
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.a(a().getActivity(), this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed, new xzp(this), this.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo);
  ...
  public void c(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    if ((!xxl.a(paramStFeed.poster.attr.get())) && (a() != null))
    {
      yib.a().a(a(), "subscribe_freshman_interaction_guide", 5000, new xzu(this, paramStFeed));
      a().runOnUiThread(new DetailBaseAdapter.6(this));
      yib.a().a(a(), "subscribe_freshman_share_guide", 10000, new xzv(this));
    }
  }
  ...
  public void e()
  {
    ygq.a().a((String)xxe.b.get("follow_guide_pics"), 4000, new xzq(this), true);
  }
  
  public void f()
  {
    ygq.a().a((String)xxe.b.get("praise_guide_pics"), 4000, new xzs(this), true);
  }
