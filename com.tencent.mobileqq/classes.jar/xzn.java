...
public class xzn
  extends xzb
  implements ImageViewVideoPlayer.IMPFrameListener, ImageViewVideoPlayer.IMPlayerEndListener, xzp, yay
{
  public float a;
  public long a;
  protected Handler a;
  ...
  public xzn(@NonNull xzd paramxzd)
  {
    super(paramxzd);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    xvv.c("Q.qqstory.record.EditVideoPlayer", "updateVideoDrawablePlayerUI width" + paramInt1 + "heightRatio=" + f + "dst_height" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.d + "dst_width=" + this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.jdField_c_of_type_Int);
  ...
  private void b(boolean paramBoolean)
  {
    ...
    xvv.d("Q.qqstory.record.EditVideoPlayer", "pausePreview but the player has not started : " + this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.mPlayerState);
  }
  ...
  private void k()
  {
    ...
    xvv.d("Q.qqstory.record.EditVideoPlayer", "restartPreview but the player is not stopping : " + this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.mPlayerState);
  }
  ...
  public void Q_()
  {
    ...
    switch (this.jdField_a_of_type_Xzd.b)
    {
    case 0: 
    case 2: 
    case 5: 
  ...
  public long a(int paramInt)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        localObject = (yax)((List)localObject).get(paramInt);
        return ((yax)localObject).d - ((yax)localObject).jdField_c_of_type_Long;
      }
    }
    return -1L;
  }
  ...
  public Bitmap a(int paramInt)
  {
    ...
    if (Looper.myLooper() == this.jdField_a_of_type_AndroidOsHandler.getLooper())
    {
      ...
      if ((localObject != null) && (paramInt < ((List)localObject).size())) {}
      for (localObject = (yax)((List)localObject).get(paramInt); localObject == null; localObject = null) {
        return null;
      }
      return a((yax)localObject);
    }
  ...
  public Bitmap a(@NonNull yax paramyax)
  {
    Bitmap localBitmap = null;
    Object localObject = (xwk)a(xwk.class);
    int j;
    int i;
    if (localObject != null)
    {
      j = ((xwk)localObject).a(paramyax.jdField_c_of_type_Int);
      i = ((xwk)localObject).a(this.jdField_a_of_type_Xzd.a());
      xvv.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap for %d, playModeNeeded = %d, currentPlayMode = %d", Integer.valueOf(paramyax.jdField_c_of_type_Int), Integer.valueOf(j), Integer.valueOf(i));
    }
    for (;;)
    {
      ...
      {
        k = ((xwj)localObject).a();
        arrayOfByte = ((xwj)localObject).a(paramyax.jdField_c_of_type_Int);
      }
      for (localObject = ((xwj)localObject).a(this.jdField_a_of_type_Xzd.a());; localObject = null)
      {
        ...
        try
        {
          ...
          xvv.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap, playMode=%d, info=%s", Integer.valueOf(j), paramyax);
          if (j == 1)
          {
            localBitmap = ((MultiBlockVideoPlayer)this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(paramyax.b - 1L, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getWidth(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getHeight());
            return localBitmap;
          }
          paramyax = ((MultiBlockVideoPlayer)this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(paramyax.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getWidth(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource.getHeight());
          return paramyax;
        }
        finally
        {
  ...
  public List<? extends ybh> a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer instanceof MultiBlockVideoPlayer))
    {
      ...
      if (localList != null)
      {
        ...
        if (i > 1) {}
        for (yax localyax = (yax)localList.get(i - 1); (localyax != null) && (localyax.b - localyax.jdField_a_of_type_Long < 11L); localyax = null) {
  ...
  public void a()
  {
    ...
    xvv.d("Q.qqstory.record.EditVideoPlayer", "recordMultiVideoFragment = %s, supportMultiVideoFragment = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
    Object localObject;
    label272:
    label290:
    String str2;
    ...
    if ((bool1) && (bool2))
    {
      ...
      if (!(this.jdField_a_of_type_Xzd.a.mEditSource instanceof EditRecordVideoSource)) {
        break label459;
      }
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditRecordVideoSource = ((EditRecordVideoSource)this.jdField_a_of_type_Xzd.a.mEditSource);
      this.jdField_a_of_type_ComTencentMobileqqShortvideoWidgetImageViewVideoPlayer = ((ImageViewVideoPlayer)a(2131366865));
      ...
      localObject = null;
      str1 = null;
      Bundle localBundle = this.jdField_a_of_type_Xzd.a.mExtra;
      if (localBundle == null) {
        break label569;
      }
    ...
    for (;;)
    {
      if (bool1)
      {
        ...
        xvv.d("Q.qqstory.record.EditVideoPlayer", "onCreate init player, securityChecked=%s, afFilePath=%s, vfFilePath=%s", new Object[] { Boolean.valueOf(bool1), localObject, str1 });
      }
      for (;;)
      {
        a(xzp.class, this);
        ...
        break label272;
        label492:
        xwb.jdField_a_of_type_Long = this.jdField_a_of_type_Yan.getActivity().getIntent().getLongExtra("stop_record_time", 0L);
        xwb.b = System.currentTimeMillis();
        break label290;
  ...
  public void a(int paramInt, @NonNull yjh paramyjh)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (yax)((Iterator)localObject2).next();
        if (localObject1 == null)
        {
          xvv.e("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish error. RecordVideoBlockInfo is null.");
        }
        else if (((yax)localObject1).jdField_c_of_type_Int == paramInt)
        {
          paramyjh.a.hasFragments = true;
          localObject2 = new JSONObject();
        }
      }
      try
      {
        ((JSONObject)localObject2).put("vfFrameIndexStart", ((yax)localObject1).jdField_a_of_type_Long);
        ((JSONObject)localObject2).put("vfFrameIndexEnd", ((yax)localObject1).b);
        ((JSONObject)localObject2).put("afTimeStart", ((yax)localObject1).jdField_c_of_type_Long);
        ((JSONObject)localObject2).put("afTimeEnd", ((yax)localObject1).d);
        paramyjh.a.fragments = ((JSONObject)localObject2).toString();
        xvv.b("Q.qqstory.record.EditVideoPlayer", "fragments = %s.", paramyjh.a.fragments);
        xvv.b("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish : %s", paramyjh.a.fragments);
        if (paramyjh.a.hasFragments) {
          continue;
        }
  ...
  public void a(yax paramyax)
  {
    xvv.a("Q.qqstory.record.EditVideoPlayer", "updateVideoFrameBitmap info=%s", paramyax);
    Object localObject = a(paramyax);
    if (localObject != null)
    {
      Bitmap localBitmap = yoy.a((Bitmap)localObject, this.jdField_a_of_type_Float, false);
      a((Bitmap)localObject);
      if (localBitmap != null)
      {
        localObject = new ArrayList(this.jdField_a_of_type_JavaUtilList);
        yax localyax = (yax)((List)localObject).get(paramyax.jdField_c_of_type_Int);
        ((List)localObject).set(paramyax.jdField_c_of_type_Int, localyax.a(localBitmap));
  ...
  public void onCurrentFrame(int paramInt)
  {
    ...
    long l2;
    long l1;
    if ((paramInt == 1) && (this.jdField_a_of_type_Long == 0L) && (!this.jdField_a_of_type_Xzd.a()))
    {
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      localObject = QQStoryContext.a().a();
      xwb.a(this.jdField_a_of_type_Long, (String)localObject);
      xvv.b("Q.qqstory.record.EditVideoPlayer", "onCurrentFrame:" + paramInt + ", mPreivewContentTime:" + this.jdField_a_of_type_Long);
      if (0L != 0L) {
        break label229;
      }
      localObject = this.jdField_a_of_type_Xzd.a.mExtra;
      if (localObject == null) {
        break label229;
      }
    ...
    for (;;)
    {
      ...
      if (l3 != 0L) {
        xwa.b("video_edit", "startEditVideoTime", this.jdField_a_of_type_Xzd.b(), 0, new String[] { String.valueOf(l4 - l3) });
      }
      return;
      label229:
      l1 = 0L;
  ...
  public void onDrawLastFrameEnd()
  {
    ...
    if (localBitmap1 != null)
    {
      ...
      if (this.jdField_b_of_type_Boolean) {
        Stream.of(localBitmap1).map(new ThreadOffFunction("Q.qqstory.record.EditVideoPlayer", 2)).map(new ybq(0.2F, false)).map(new ybr(10)).map(new UIThreadOffFunction(this)).subscribe(new xzo(this));
      }
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
  }
