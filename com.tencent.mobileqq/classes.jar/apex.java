...
public class apex
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    a = apeu.a(paramQQAppInterface);
    int k = apew.a(localBaseApplication, str1);
    long l = apew.a(localBaseApplication, str1);
    ...
    if (AudioHelper.a(10) == 1)
    {
      ...
      if (i != 0)
      {
        AudioHelper.a(alpo.a(2131715203) + a.jdField_a_of_type_JavaLangString);
    ...
    for (int j = 1;; j = 0)
    {
      if (((a.jdField_a_of_type_Boolean) && (k < a.jdField_a_of_type_Int) && (paramLong1 - l > 30L) && (!paramString2.equals(str1))) || (j != 0))
      {
        ...
        paramString1 = new aslp(paramString1, paramString2, str3, paramInt, -5040, 3276801, paramLong1);
        ...
        if (aslq.a(paramQQAppInterface, paramString2))
        {
          apew.b(localBaseApplication, str1, k + 1);
          apew.b(localBaseApplication, str1, paramLong1);
          apfc.a("0X80094AA");
        }
      }
      return;
  ...
  {
    if (a == null) {
      a = apeu.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    }
