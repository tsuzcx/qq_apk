...
public class arje
{
  ...
  public arib a;
  private arjc jdField_a_of_type_Arjc;
  ActionCallback jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceActionCallback = new arjg(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public arje(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Arib = arjj.a().a();
  ...
  private void c(Bundle paramBundle)
  {
    ...
    {
      localObject2 = ayoi.a(str2);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = ayoi.a(str2 + "?busiType=3");
      }
      localObject2 = str1;
    ...
    paramBundle.putString("hostVersion", String.valueOf(aney.a(BaseApplicationImpl.getContext())));
  ...
  {
    this.jdField_a_of_type_Arjc = paramarjc;
    paramarjc = paramBundle.getString("mqqUrl", "");
    long l = System.currentTimeMillis();
    if ((l - this.jdField_a_of_type_Long < 1000L) && (!arie.c(paramBundle).equals("1")))
    {
      QLog.i("DynamicNow | NowEntry", 1, "开始处理mqq　scheme,time = " + System.currentTimeMillis() + " 点太快了");
      bcql.a(BaseApplicationImpl.getContext(), ajya.a(2131707675), 0).a();
      return;
    }
    this.jdField_a_of_type_Long = l;
    QLog.i("DynamicNow | NowEntry", 1, "开始进入now结合版,time = " + System.currentTimeMillis() + " mqqScheme = " + paramarjc);
  ...
  {
    Object localObject1 = arie.a(paramBundle);
    Object localObject2 = arie.b(paramBundle);
    long l = arie.a(paramBundle);
    this.jdField_a_of_type_Arib.a(false, (String)localObject2, String.valueOf(l), (String)localObject1, false, false, true);
    ...
    if ((a((String)localObject1)) || (ayoi.a((String)localObject1) != null) || (ayoi.a((String)localObject2) != null))
    {
      c(paramBundle);
      return;
    }
    ...
    ((URLDrawable)localObject1).setURLDrawableListener(new arjf(this, l, (AtomicBoolean)localObject2, paramBundle));
