...
public class ayrh
  extends akej
{
  public ayrh(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public List<TroopFileTansferItemEntity> a(long paramLong)
  {
    ...
    return localatmp.a(TroopFileTansferItemEntity.class, "select * from " + localTroopFileTansferItemEntity.getTableName() + " where troopuin = ?", new String[] { "" + paramLong });
  }
  ...
  public void a(long paramLong, UUID paramUUID)
  {
    ...
    aysb.c("TroopFileDataBaseProxy", aysb.a, "[" + paramUUID.toString() + "] deleteItem");
    ...
    paramUUID = new ayrk(this, paramUUID);
  ...
  public void a(TroopFileTansferItemEntity paramTroopFileTansferItemEntity)
  {
    ...
    aysb.c("TroopFileDataBaseProxy", aysb.a, "[" + paramTroopFileTansferItemEntity.Id.toString() + "] updateItem transStatus[" + paramTroopFileTansferItemEntity.Status + "] FilePath[" + paramTroopFileTansferItemEntity.FilePath + "]");
    ...
    for (;;)
    {
      ...
      localContentValues.put("_sStatus", ayor.a(i));
      String str1 = paramTroopFileTansferItemEntity.getTableName();
      String str2 = paramTroopFileTansferItemEntity.Id.toString();
      paramTroopFileTansferItemEntity = new ayrj(this, paramTroopFileTansferItemEntity);
  ...
  public void a(TroopFileTansferItemEntity paramTroopFileTansferItemEntity, akes paramakes)
  {
    aysb.c("TroopFileDataBaseProxy", aysb.a, "[" + paramTroopFileTansferItemEntity.Id.toString() + "] addItem status[" + paramTroopFileTansferItemEntity.getStatus() + "]");
    paramakes = new ayri(this, paramTroopFileTansferItemEntity);
    if (paramTroopFileTansferItemEntity.getStatus() == 1000)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, paramTroopFileTansferItemEntity.getTableName(), paramTroopFileTansferItemEntity, 0, paramakes);
      return;
    }
    if (paramTroopFileTansferItemEntity.getStatus() == 1001)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, paramTroopFileTansferItemEntity.getTableName(), paramTroopFileTansferItemEntity, 1, paramakes);
      return;
    }
    aysb.a("TroopFileDataBaseProxy", aysb.a, "Item status[" + String.valueOf(paramTroopFileTansferItemEntity.getStatus()) + "] is wrong");
  }
  
  protected void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, akes paramakes)
  {
