...
public class argj
{
  public static Map<String, argj> a;
  public int a;
  public int b;
  public int c;
  public int d;
  ...
  private static void a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localargj.jdField_a_of_type_Int = paramString2.optInt("startupId");
      localargj.b = paramString2.optInt("downloadSucId");
      localargj.c = paramString2.optInt("downloadFailId");
      localargj.d = paramString2.optInt("loadSucId");
      localargj.e = paramString2.optInt("loadFailId");
      localargj.f = paramString2.optInt("startSucId");
      localargj.g = paramString2.optInt("firstUserId");
      localargj.h = paramString2.optInt("exitId");
      jdField_a_of_type_JavaUtilMap.put(paramString1, localargj);
      if (QLog.isColorLevel()) {
        QLog.d("MonitorConfig", 2, paramString1 + localargj);
      }
      return;
    }
  ...
  public static void b(Context paramContext, String paramString)
  {
    if (jdField_a_of_type_JavaUtilMap.get(paramString) != null)
    {
      argi.b(String.valueOf(((argj)jdField_a_of_type_JavaUtilMap.get(paramString)).jdField_a_of_type_Int));
      return;
    }
    if (QLog.isColorLevel()) {
