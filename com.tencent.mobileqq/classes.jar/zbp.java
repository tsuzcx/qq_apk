  ...
  extends LinearLayout
{
  ...
  public zbp(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    setOrientation(0);
    setGravity(17);
    int j = zby.b(getContext(), 3.0F);
    int k = (int)((this.c - j * 2) * this.jdField_a_of_type_Float);
    int i = 0;
    while (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131561724, null);
  ...
  public void a(zbf paramzbf, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localURLImageView = (URLImageView)((View)localObject3).findViewById(2131370257);
      localTextView = (TextView)((View)localObject3).findViewById(2131370271);
      localObject2 = (ProgressBar)((View)localObject3).findViewById(2131370269);
      str = paramzbf.b(paramInt2);
      localObject1 = paramzbf.a(paramInt2);
      if (localObject1 != null) {
        break label137;
      }
      yqp.e("LocationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { paramzbf.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      localObject3 = (Boolean)localURLImageView.getTag(2131378248);
      if ((localObject3 != null) && (((Boolean)localObject3).booleanValue()) && (((String)localObject1).equals(localURLImageView.getTag(2131378283))))
      {
      ...
      else
      {
        ...
        localObject2 = new zbq((String)localObject1, localURLImageView, (ProgressBar)localObject2);
        ...
        if (((URLDrawable)localObject1).getStatus() == 1) {
          ((zbq)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
        }
