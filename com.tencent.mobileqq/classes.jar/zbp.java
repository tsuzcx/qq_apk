  ...
  implements BusinessObserver
{
  ...
  public zbp(ApolloWebStatistics paramApolloWebStatistics, String paramString1, String paramString2)
  {
  ...
  public void a()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      while (localIterator.hasNext()) {
        ((zbo)localIterator.next()).a(this, this.jdField_a_of_type_ComTencentMobileqqApolloStoreWebviewApolloWebStatistics);
      }
  ...
  {
    if (paramzbo != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramzbo);
    }
  }
