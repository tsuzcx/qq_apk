...
public class anyz
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = bhmi.a(new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), bhwl.f.a));
      Object localObject2 = "";
      String str = "";
      j = 1;
      i = j;
  ...
  private static void a(boolean paramBoolean, Context paramContext, IPicDownloadListener paramIPicDownloadListener, bihz parambihz, ashc paramashc, asig paramasig, List<CustomEmotionData> paramList1, List<CustomEmotionData> paramList2, AtomicInteger paramAtomicInteger1, AtomicInteger paramAtomicInteger2, CustomEmotionData paramCustomEmotionData)
  {
    ...
    {
      return;
      Object localObject = new anzb(paramasig, paramCustomEmotionData).a();
      paramasig = ((anzb)localObject).a();
      boolean bool = ((anzb)localObject).a();
      File localFile = new File(paramasig);
      if (localFile.exists())
      {
        if (QLog.isColorLevel()) {
          QLog.d("FunyPicHelper", 2, "download path is exsit->" + paramasig);
        }
        paramAtomicInteger1.decrementAndGet();
        ...
        if (paramBoolean) {
          paramashc.b(paramCustomEmotionData);
        }
      ...
      while ((paramAtomicInteger1.get() == 0) && (paramIPicDownloadListener != null))
      {
        ...
        return;
        bihu localbihu = new bihu(paramCustomEmotionData.url, localFile);
        localbihu.p = false;
        localbihu.f = "emotion_pic";
        localbihu.b = 1;
        paramasig = "";
        if (paramCustomEmotionData.url.contains("qto_"))
        {
          localObject = a(paramCustomEmotionData.url);
          paramasig = (asig)localObject;
          if (!TextUtils.isEmpty((CharSequence)localObject))
          {
            paramasig = (asig)localObject;
            if (((String)localObject).length() > "qto_".length() + 8)
            {
              paramasig = ((String)localObject).substring(0, "qto_".length() + 8);
              a.add(paramasig);
            }
          }
        }
        parambihz.a(localbihu, new anza(paramasig, localFile, paramCustomEmotionData, bool, paramBoolean, paramashc, paramIPicDownloadListener, paramList1, paramList2, paramContext, paramAtomicInteger2, paramAtomicInteger1), null);
      }
      continue;
      if (paramIPicDownloadListener != null) {
  ...
  public static void a(boolean paramBoolean, Context paramContext, List<CustomEmotionData> paramList, AppInterface paramAppInterface, IPicDownloadListener paramIPicDownloadListener)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        bihz localbihz = ((bihw)paramAppInterface.getManager(47)).a(1);
        if (localbihz != null)
        {
          ashc localashc = (ashc)paramAppInterface.getManager(149);
          paramAppInterface = (asig)paramAppInterface.getManager(141);
          ...
          while (paramList.hasNext()) {
            a(paramBoolean, paramContext, paramIPicDownloadListener, localbihz, localashc, paramAppInterface, localArrayList1, localArrayList2, localAtomicInteger1, localAtomicInteger2, (CustomEmotionData)paramList.next());
          }
        }
      }
  ...
  private static void b(bihu parambihu, String paramString, File paramFile, CustomEmotionData paramCustomEmotionData, boolean paramBoolean1, boolean paramBoolean2, ashc paramashc, IPicDownloadListener paramIPicDownloadListener, List<CustomEmotionData> paramList1, List<CustomEmotionData> paramList2, Context paramContext, AtomicInteger paramAtomicInteger1, AtomicInteger paramAtomicInteger2)
  {
    ...
    for (;;)
    {
      ...
      biah.a("emotionType", "emotionActionFav", "3", "", "", bhnv.b(paramContext) + "", parambihu.a + "", "", "", "");
    }
  }
}
