...
public class bjyw
{
  ...
  public static void a(Activity paramActivity, MiniAppInfo paramMiniAppInfo, bjzb parambjzb)
  {
    ...
    do
    {
      ...
      paramActivity = bjzc.a(paramActivity, anni.a(2131712771), anni.a(2131712784), anni.a(2131712786), new bjyx(paramActivity), new bjyy());
      paramActivity.a(false);
      paramActivity.show();
    } while (parambjzb == null);
    parambjzb.a(2, anni.a(2131712765));
    return;
    b(paramActivity, paramMiniAppInfo, parambjzb);
  }
  ...
  {
    paramMiniAppInfo = bgmo.b(URLDrawable.getDrawable(URLDecoder.decode(paramMiniAppInfo.iconUrl), null));
    ...
    for (;;)
    {
      return bgmo.a(a(paramMiniAppInfo, i, i), (int)(i * 0.15D));
    }
  }
  
  public static void b(Activity paramActivity, MiniAppInfo paramMiniAppInfo, bjzb parambjzb)
  {
    ThreadManagerV2.executeOnSubThread(new ShortcutUtils.3(paramActivity, paramMiniAppInfo, parambjzb));
  }
