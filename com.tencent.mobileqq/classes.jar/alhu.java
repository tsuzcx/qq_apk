...
public class alhu
{
  public static CopyOnWriteArrayList<alhz> a;
  ...
  public alhu(MqqHandler paramMqqHandler, Activity paramActivity)
  {
  ...
  {
    bhfm.a(null, " pubAcc_follow_cancel", paramRecentBaseData.getRecentUserUin());
    ...
    if (localObject != null) {}
    for (localObject = ((aoan)localObject).a(paramRecentBaseData.getRecentUserUin());; localObject = null)
    {
      if ((localObject != null) && (uuc.a(((AccountDetail)localObject).accountFlag) == -4))
      {
        localObject = new NewIntent(this.jdField_a_of_type_AndroidAppActivity, oln.class);
        ...
        ((NewIntent)localObject).setObserver(new alhv(this, paramRecentBaseData, paramQQAppInterface));
        paramQQAppInterface.startServlet((NewIntent)localObject);
      }
      for (;;)
      {
        uuc.a(paramQQAppInterface, paramRecentBaseData.getRecentUserUin());
        if (QLog.isColorLevel()) {
          QLog.d("RecentPubAccHelper", 2, "unfollow exit");
        }
        return;
        localObject = new apar(new alhw(this, paramRecentBaseData, paramQQAppInterface), paramQQAppInterface);
        ...
        apaw.a(paramQQAppInterface, false, paramRecentBaseData.getRecentUserUin(), 0);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      bdla.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A31", "0X8009A31", 0, 0, String.valueOf(i), String.valueOf(paramInt3), paramString2, "");
      return;
      i = 1;
      continue;
      i = 2;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    bdla.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A32", "0X8009A32", 0, 0, String.valueOf(paramLong), "", paramString2, "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    bdla.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A34", "0X8009A34", 0, 0, "", "", paramString2, "");
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject = (aoan)((QQAppInterface)localObject).getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
        } while (localObject == null);
        localAccountDetail = ((aoan)localObject).b(paramString);
      ...
      if (((aoan)localObject).c(paramString) != null) {
        return true;
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0)
    {
      ...
      {
        alhz localalhz = (alhz)localIterator.next();
        long l = System.currentTimeMillis() - localalhz.jdField_a_of_type_Long;
        if (l <= 3600000L) {
          a(paramQQAppInterface, localalhz.jdField_a_of_type_JavaLangString, l, localalhz.b);
        }
      }
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      bdla.b(paramQQAppInterface, "dc00898", "", paramString1, "0X8009A33", "0X8009A33", 0, 0, String.valueOf(i), String.valueOf(paramInt3), paramString2, "");
      return;
      i = 1;
      continue;
      i = 2;
  ...
  private void c(RecentBaseData paramRecentBaseData, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      alih.a(paramQQAppInterface, paramRecentBaseData, localRecentUser);
      alik.a(paramQQAppInterface, localRecentUser, i);
    }
  }
  ...
  {
    bkzi localbkzi = bkzi.a(paramActivity);
    localbkzi.a(String.format(paramActivity.getResources().getString(2131695021), new Object[] { paramRecentBaseData.mTitleName }));
    localbkzi.a(2131695020, 3);
    localbkzi.c(2131695019);
    localbkzi.setOnDismissListener(new alhx(this));
    localbkzi.a(new alhy(this, paramQQAppInterface, paramRecentBaseData, localbkzi));
