...
public class axmp
  extends ajtd
{
  aymm jdField_a_of_type_Aymm = new axmq(this);
  ...
  private boolean a(boolean paramBoolean1, String paramString1, boolean paramBoolean2, boolean paramBoolean3, String paramString2)
  {
    ...
    String str = ThemeUtil.getUserCurrentThemeId(this.app);
    Object localObject1 = ayml.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramBoolean1) {}
        for (paramString2 = this.jdField_b_of_type_Aymm;; paramString2 = this.jdField_a_of_type_Aymm) {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder(1024);; localStringBuilder = null)
    {
      ...
      if (i != 0)
      {
        ...
        if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()) && (paramToServiceMsg.uint32_result.get() == 0)) {
          if ((paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
          {
            l2 = bbbd.a(ByteBuffer.wrap(paramToServiceMsg.bytes_bodybuffer.get().toByteArray()).getInt());
            ...
            if (bool2)
            {
              axmt.a(this.app.getCurrentAccountUin(), bool3, 3);
              axmt.a(this.app.getCurrentAccountUin(), j, 3);
              bool1 = bool2;
            }
            if ((QLog.isColorLevel()) && (localStringBuilder != null)) {
            ...
            if (l1 == this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.get())
            {
              ...
              bool2 = a(false, "211", axmt.b(), true, axmo.jdField_b_of_type_ArrayOfJavaLangString[axmt.c()]);
              if (!bool2)
              {
  ...
  {
    short s = 0;
    paramInt = axmo.jdField_b_of_type_ArrayOfInt[paramInt];
    ...
    try
    {
      ...
      localByteBuffer.putInt(bbbd.a(l2)).put((byte)0).putShort((short)2).putShort((short)-23251).putShort((short)2).putShort(s).putShort((short)-23238).putShort((short)2).putShort((short)paramInt);
  ...
  public boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    boolean bool2 = a(paramBoolean, axmo.jdField_b_of_type_ArrayOfJavaLangString[paramInt]);
    if (bool2) {}
    for (boolean bool1 = a(false, "212", paramBoolean, true, axmo.jdField_b_of_type_ArrayOfJavaLangString[paramInt]);; bool1 = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean a(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    Object localObject = axmo.jdField_b_of_type_ArrayOfJavaLangString[paramInt];
    ...
    {
      return bool;
      long l = ((axmp)this.app.a(154)).a(paramBoolean1, paramInt, paramBoolean2);
