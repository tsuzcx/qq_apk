...
public class amqz
{
  ...
  public amra a(int paramInt1, int paramInt2)
  {
    if (this.jdField_f_of_type_Boolean)
    {
      ...
      localObject2 = new amra();
      ((amra)localObject2).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((amra)localObject2).a("CAMERA_MATRIX", arrayOfFloat2);
      ((amra)localObject2).a("CAMERA_POSITION", localObject1);
      ((amra)localObject2).a("POSE", arrayOfFloat1);
      return localObject2;
    }
    if (paramInt1 == 100)
    {
      ...
      ((amra)localObject2).a("CAMERA_POSITION", localObject1);
      ((amra)localObject2).a("POSE", arrayOfFloat1);
      ((amra)localObject2).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject2;
    }
    if (paramInt1 == 8)
    {
      ...
      Matrix.setIdentityM(arrayOfFloat1, 0);
      ((amra)localObject1).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((amra)localObject1).a("CAMERA_MATRIX", localObject2);
      ((amra)localObject1).a("CAMERA_POSITION", arrayOfFloat1);
      ((amra)localObject1).a("POSE", arrayOfFloat2);
      ((amra)localObject1).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject1;
    }
    ...
    if ((this.jdField_h_of_type_Boolean) && (((paramInt2 == 0) && (!this.jdField_c_of_type_Boolean)) || (paramInt2 == 2) || ((paramInt2 == 1) && (!this.jdField_d_of_type_Boolean))))
    {
      ...
      localamra = new amra();
      localamra.a("TARGET_SIZE", localObject1);
      localamra.a("CAMERA_MATRIX", localObject2);
      localamra.a("CAMERA_POSITION", arrayOfFloat1);
      localamra.a("POSE", arrayOfFloat2);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Amra.a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
    this.jdField_a_of_type_Amra.a("POSE", arrayOfFloat1);
    this.jdField_a_of_type_Amra.a("CAMERA_MATRIX", arrayOfFloat2);
    this.jdField_a_of_type_Amra.a("CAMERA_POSITION", arrayOfFloat3);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
  }
  
  public void a(int paramInt1, int paramInt2, amuo paramamuo)
  {
    ...
    float f3;
    if (paramInt2 == 0) {
      if ((paramamuo.jdField_a_of_type_Int == 0) || (paramamuo.jdField_b_of_type_Int == 0))
      {
        this.k[0] = anbw.jdField_a_of_type_Int;
        this.k[1] = anbw.jdField_b_of_type_Int;
        paramamuo = new float[jdField_a_of_type_Int];
        Matrix.setIdentityM(paramamuo, 0);
        Matrix.perspectiveM(paramamuo, 0, 45.0F, 1.0F * anbw.jdField_b_of_type_Int / anbw.jdField_a_of_type_Int, 100.0F, 8000.0F);
        float[] arrayOfFloat = new float[16];
        Matrix.setRotateM(arrayOfFloat, 0, 270.0F, 0.0F, 0.0F, 1.0F);
        Matrix.multiplyMM(this.l, 0, arrayOfFloat, 0, paramamuo, 0);
        if (paramInt2 != 0) {
          break label659;
        }
        f1 = 1.25F;
        if (this.k[0] <= anbw.jdField_a_of_type_Int) {
          break label665;
        }
        f2 = this.k[0];
        if (this.k[0] == 0.0F) {
        ...
        f3 = this.k[1] / this.k[0] / (1.0F * anbw.jdField_b_of_type_Int / anbw.jdField_a_of_type_Int);
        label233:
        if ((f3 <= 1.0F) || (this.k[1] <= anbw.jdField_b_of_type_Int)) {
          break label680;
        }
        f1 *= f3;
      }
    ...
    for (;;)
    {
      ...
      paramamuo = new float[jdField_a_of_type_Int];
      Matrix.setIdentityM(paramamuo, 0);
      Matrix.translateM(paramamuo, 0, this.k[1] / 2.0F, -this.k[0] / 2.0F, -f2 / 2.0F * 2.414214F * f1);
      Matrix.rotateM(paramamuo, 0, 90.0F, 0.0F, 0.0F, 1.0F);
      System.arraycopy(paramamuo, 0, this.m, 0, jdField_a_of_type_Int);
      ...
      System.arraycopy(this.n, 0, this.j, 0, jdField_a_of_type_Int);
      return;
      this.k[0] = paramamuo.jdField_a_of_type_Int;
      this.k[1] = paramamuo.jdField_b_of_type_Int;
      break;
  ...
  public void a(amqx paramamqx)
  {
    ...
    paramamqx = (amqv)paramamqx;
    this.jdField_c_of_type_Int = paramamqx.jdField_a_of_type_Int;
    this.jdField_g_of_type_ArrayOfFloat[0] = paramamqx.jdField_a_of_type_Float;
    this.jdField_g_of_type_ArrayOfFloat[1] = paramamqx.jdField_b_of_type_Float;
    System.arraycopy(paramamqx.jdField_b_of_type_ArrayOfFloat, 0, this.jdField_h_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    System.arraycopy(paramamqx.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_i_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
    System.arraycopy(paramamqx.jdField_a_of_type_ArrayOfFloat, 0, this.j, 0, jdField_a_of_type_Int);
  }
  
  public void a(boolean paramBoolean, amqw paramamqw)
  {
    QLog.i("AREngine_ARRenerArumentManager", 1, "start. trackMode = " + paramamqw.jdField_b_of_type_Int + ", arType = " + paramamqw.jdField_a_of_type_Int + ", isObjectAnim = " + paramBoolean);
    this.jdField_f_of_type_Boolean = paramBoolean;
    this.jdField_b_of_type_Int = paramamqw.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramamqw.jdField_c_of_type_Int;
    this.jdField_h_of_type_Boolean = false;
    if ((this.jdField_f_of_type_Boolean) || (paramamqw.jdField_a_of_type_Int == 100) || (paramamqw.jdField_a_of_type_Int == 8))
    {
      this.jdField_g_of_type_Boolean = true;
      return;
    }
    Object localObject;
    if (paramamqw.jdField_a_of_type_Int == 0)
    {
      localObject = (amri)paramamqw;
      a(this.jdField_b_of_type_Int, paramamqw.jdField_a_of_type_Int, ((amri)localObject).a);
    }
    for (;;)
    {
      this.jdField_g_of_type_Boolean = true;
      return;
      if ((paramamqw.jdField_a_of_type_Int == 2) || (paramamqw.jdField_a_of_type_Int == 3))
      {
        localObject = (amrr)paramamqw;
        a(this.jdField_b_of_type_Int, paramamqw.jdField_a_of_type_Int, ((amrr)localObject).a);
      }
      else if (paramamqw.jdField_a_of_type_Int == 4)
      {
        localObject = (amru)paramamqw;
        a(this.jdField_b_of_type_Int, paramamqw.jdField_a_of_type_Int, ((amru)localObject).a);
      }
    }
  }
