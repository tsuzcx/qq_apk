...
{
  amqz(amqy paramamqy, WeiyunTransmissionGlobal.UploadServerInfoCallback paramUploadServerInfoCallback, UploadFile paramUploadFile) {}
  ...
  public void a(WeiyunPB.DiskPicBackupRsp paramDiskPicBackupRsp)
  {
    ...
    PreferenceUtils.a(BaseApplicationImpl.getContext(), String.valueOf(this.jdField_a_of_type_Amqy.getCurrentUin()), "upload_coupon_count", String.valueOf(paramDiskPicBackupRsp.coupon_count.get()));
  }
}
