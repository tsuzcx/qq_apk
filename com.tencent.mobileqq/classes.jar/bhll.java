  ...
  implements Handler.Callback, bapw, bapx, Manager
{
  ...
  private bhlk jdField_a_of_type_Bhlk;
  ...
  public bhll(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bhlk = new bhlk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private String a(bhlp parambhlp)
  {
    parambhlp = a() + parambhlp.jdField_a_of_type_Long + File.separator;
    File localFile = new File(parambhlp);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return parambhlp;
  ...
  private void a(baqw parambaqw)
  {
    ...
    do
    {
      ...
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download error=%d", new Object[] { Integer.valueOf(parambaqw.jdField_a_of_type_Int) }));
      return;
      localbhlm = (bhlm)parambaqw.jdField_a_of_type_Baqv.a();
    } while (localbhlm == null);
    if (parambaqw.jdField_a_of_type_Int == 0) {}
    while (!bool)
    {
      try
      {
        if (localbhlm.jdField_d_of_type_Int >= 3) {
          break label146;
        }
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] retried to download, retry=%d, result=%b, url=%s", new Object[] { Integer.valueOf(localbhlm.jdField_d_of_type_Int), Boolean.valueOf(bool), localbhlm.jdField_c_of_type_JavaLangString }));
        }
        a(localbhlm);
        return;
      }
      ...
      continue;
      label146:
      File localFile = new File(parambaqw.jdField_a_of_type_Baqv.jdField_c_of_type_JavaLangString);
      if (localFile.exists()) {
        localFile.delete();
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(localbhlm.jdField_d_of_type_JavaLangString.toLowerCase());
    a(bool, parambaqw.jdField_a_of_type_Baqv);
  }
  
  private void a(bhlp parambhlp)
  {
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update complete: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      parambhlp.a();
      if (b())
      {
        this.jdField_a_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambhlp.jdField_b_of_type_Long) });
        this.jdField_b_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) });
      }
      a("0X80078B4", 0, "", "");
    }
  }
  ...
  private void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    {
      paramInt = (int)this.jdField_a_of_type_Bhlp.jdField_b_of_type_Long;
      if (this.jdField_a_of_type_Bhlp == null) {
        break label188;
      }
    }
    label188:
    for (paramString2 = String.format("%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Bhlp.jdField_a_of_type_Long) });; paramString2 = "")
    {
      if (QLog.isColorLevel()) {
      ...
      localbhiq.a(paramString1).a(paramString1).a(paramString3).a(paramString2).a(this.jdField_a_of_type_Int);
      bhin.a(localbhiq.toString(), 105, paramInt);
      return;
      paramInt = 0;
      break;
    }
  ...
  private void a(boolean paramBoolean, baqv parambaqv)
  {
    if ((!paramBoolean) || (parambaqv == null))
    {
      a(3);
      return;
    }
    File localFile = new File(parambaqv.jdField_c_of_type_JavaLangString);
    bhlm localbhlm = (bhlm)parambaqv.a();
    if ((!localFile.exists()) || (localbhlm == null))
    {
      a(3);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download complete: %s, %s", new Object[] { parambaqv.jdField_c_of_type_JavaLangString, localbhlm.jdField_c_of_type_JavaLangString }));
    }
    switch (localbhlm.jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      localFile = new File(b());
      new File(parambaqv.jdField_c_of_type_JavaLangString).renameTo(localFile);
      a("0X80078AC", localbhlm.jdField_c_of_type_Int, "", "");
      if (this.jdField_a_of_type_Bhlk.a(localFile.toString()))
      {
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("last_update_config_version", localbhlm.jdField_c_of_type_Int).commit();
        if (this.jdField_a_of_type_Bhlk.a().isEmpty())
        {
          if (QLog.isColorLevel()) {
      ...
      a("0X80078AC", localbhlm.jdField_c_of_type_Int, localbhlm.jdField_b_of_type_JavaLangString, localbhlm.jdField_c_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    a("0X80078AE", localbhlm.jdField_c_of_type_Int, "", "");
    d(7);
  }
  
  private boolean a()
  {
    Object localObject = this.jdField_a_of_type_Bhlk.a();
    int i = 0;
    if (i < ((List)localObject).size()) {
      if (((bhlp)((List)localObject).get(i)).a()) {}
    }
  ...
  private boolean a(bhlm parambhlm)
  {
    if (parambhlm == null) {}
    do
    {
      return false;
      if ((parambhlm.jdField_a_of_type_Int == 2) && (parambhlm.e != 1) && (!NetworkUtils.isWifiConnected(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication())))
      {
        if (QLog.isColorLevel()) {
    ...
    } while ((parambhlm.jdField_d_of_type_Int < 3) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.contains(parambhlm.jdField_d_of_type_JavaLangString.toLowerCase())));
    ...
    localbaps.jdField_a_of_type_JavaLangString = parambhlm.jdField_c_of_type_JavaLangString;
    localbaps.jdField_a_of_type_Int = 0;
    localbaps.jdField_c_of_type_JavaLangString = (parambhlm.jdField_a_of_type_JavaLangString + parambhlm.jdField_b_of_type_JavaLangString);
    parambhlm.jdField_d_of_type_Int += 1;
    parambhlm.jdField_a_of_type_Long = new Date().getTime();
    localbaps.a(parambhlm);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(parambhlm.jdField_d_of_type_JavaLangString.toLowerCase(), localbaps);
    localbapv.a(localbaps);
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] begin http download %s", new Object[] { parambhlm.jdField_c_of_type_JavaLangString }));
    }
    return true;
  }
  
  private boolean a(bhlp parambhlp)
  {
    boolean bool;
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] rollback: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      if (parambhlp.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        if (!QLog.isColorLevel()) {
          break label355;
        }
    ...
    for (;;)
    {
      ...
      return bool;
      String str = b(parambhlp);
      long l2 = 0L;
      int i = 0;
      while (i < parambhlp.jdField_b_of_type_JavaUtilList.size())
      {
        Object localObject = (bhlo)parambhlp.jdField_b_of_type_JavaUtilList.get(i);
        File localFile1 = new File(((bhlo)localObject).f);
        File localFile2 = new File(((bhlo)localObject).g);
        long l1 = l2;
        ...
        l2 = l1;
        if (((bhlo)localObject).jdField_a_of_type_Int == 2)
        {
          l2 = l1;
        ...
        localObject = new File(str, ((bhlo)localObject).jdField_c_of_type_JavaLangString);
        l1 = l2;
      ...
      if (l2 == parambhlp.jdField_b_of_type_JavaUtilList.size())
      {
        bool = true;
      }
      else
  ...
  private String b(bhlp parambhlp)
  {
    parambhlp = a(parambhlp) + "bak" + File.separator;
    File localFile = new File(parambhlp);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  private void b(bhlp parambhlp)
  {
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] cleanup: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      bdcs.a(a(parambhlp), false);
    }
  }
  ...
  private boolean b(bhlp parambhlp)
  {
    return true;
  }
  
  private String c(bhlp parambhlp)
  {
    return a(parambhlp) + parambhlp.jdField_a_of_type_JavaLangString;
  }
  ...
  private void c()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_Boolean = false;
      a("0X80078B5", 0, "", "");
      this.jdField_a_of_type_Bhlp = null;
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Bhlp = null;
    List localList = this.jdField_a_of_type_Bhlk.a();
    int i = 0;
    label150:
    boolean bool;
    if (i < localList.size())
    {
      bhlp localbhlp = (bhlp)localList.get(i);
      if (localbhlp.a()) {}
      for (;;)
      {
        i += 1;
        break;
        if ((localbhlp.jdField_b_of_type_Boolean) && (localbhlp.jdField_a_of_type_Boolean) && (localbhlp.jdField_c_of_type_Boolean)) {
          break label150;
        }
        if (QLog.isColorLevel()) {
          QLog.w("QQProtect.QPUpdate", 2, String.format("[SFU] not matched section: sid=%d, os: %b, qq:%b, cpu:%b", new Object[] { Long.valueOf(localbhlp.jdField_a_of_type_Long), Boolean.valueOf(localbhlp.jdField_b_of_type_Boolean), Boolean.valueOf(localbhlp.jdField_a_of_type_Boolean), Boolean.valueOf(localbhlp.jdField_c_of_type_Boolean) }));
        }
        localbhlp.a();
      }
      this.jdField_a_of_type_Bhlp = localbhlp;
      c(0);
      if (QLog.isColorLevel())
      {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] next update: sid=%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Bhlp.jdField_a_of_type_Long) }));
        bool = true;
      }
    }
    for (;;)
  ...
  private boolean c(bhlp parambhlp)
  {
    String str;
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify package: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      str = bhli.a(c(parambhlp));
      if (str == null) {
        return false;
      }
    }
    for (boolean bool = str.equalsIgnoreCase(parambhlp.jdField_b_of_type_JavaLangString);; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  private void d(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        d();
        return;
        if ((c()) && (this.jdField_a_of_type_Bhlp != null))
        {
          if (!i(this.jdField_a_of_type_Bhlp))
          {
            d(15);
            return;
          }
        ...
        d(16);
        return;
      } while ((this.jdField_a_of_type_Bhlp != null) && (h(this.jdField_a_of_type_Bhlp)));
      a(3);
      return;
    case 7: 
      if ((this.jdField_a_of_type_Bhlp != null) && (c(this.jdField_a_of_type_Bhlp)))
      {
        d(8);
        return;
      }
      ...
      return;
    case 8: 
      if ((this.jdField_a_of_type_Bhlp != null) && (g(this.jdField_a_of_type_Bhlp)))
      {
        d(9);
        return;
      }
      ...
      return;
    case 9: 
      if ((this.jdField_a_of_type_Bhlp != null) && (e(this.jdField_a_of_type_Bhlp)))
      {
        d(10);
        return;
      }
      ...
      return;
    case 10: 
      if ((this.jdField_a_of_type_Bhlp != null) && (f(this.jdField_a_of_type_Bhlp)))
      {
        d(11);
        return;
      }
      ...
      return;
    case 11: 
      if ((this.jdField_a_of_type_Bhlp != null) && (d(this.jdField_a_of_type_Bhlp)))
      {
        d(12);
        return;
      }
      ...
      return;
    case 12: 
      if ((this.jdField_a_of_type_Bhlp != null) && (b(this.jdField_a_of_type_Bhlp)))
      {
        a(0);
        return;
      }
      ...
      return;
    case 13: 
      if ((this.jdField_a_of_type_Bhlp != null) && (a(this.jdField_a_of_type_Bhlp)))
      {
        a(0);
        return;
      }
    ...
    case 14: 
      if (this.jdField_a_of_type_Bhlp != null) {
        b(this.jdField_a_of_type_Bhlp);
      }
      d(15);
      return;
    case 15: 
      a(this.jdField_a_of_type_Bhlp);
      this.jdField_a_of_type_Bhlp = null;
      if (a())
      {
        d(16);
  ...
  private boolean d(bhlp parambhlp)
  {
    boolean bool;
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      if (parambhlp.jdField_c_of_type_JavaUtilList.isEmpty())
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] no diff: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
        }
        bool = true;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < parambhlp.jdField_c_of_type_JavaUtilList.size())
        {
          bhlo localbhlo = (bhlo)parambhlp.jdField_c_of_type_JavaUtilList.get(i);
          if (TextUtils.isEmpty(localbhlo.g)) {}
          for (String str = localbhlo.f;; str = localbhlo.g)
          {
            str = bhli.a(str);
            if ((str != null) && (str.equalsIgnoreCase(localbhlo.jdField_b_of_type_JavaLangString))) {
              break label246;
            }
            if (!QLog.isColorLevel()) {
              break label253;
            }
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] not matched: %s!=%s, sid=%d", new Object[] { str, localbhlo.jdField_b_of_type_JavaLangString, Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
            bool = false;
            break;
          }
          label246:
  ...
  private boolean e(bhlp parambhlp)
  {
    boolean bool;
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      if (parambhlp.f == 0L)
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (parambhlp.f > 0L)
      {
        String str1 = b(parambhlp);
        long l1 = 0L;
        int i = 0;
        while (i < parambhlp.jdField_c_of_type_JavaUtilList.size())
        {
          bhlo localbhlo = (bhlo)parambhlp.jdField_c_of_type_JavaUtilList.get(i);
          long l2 = l1;
          if (1 == localbhlo.jdField_a_of_type_Int)
          {
            String str2 = str1 + localbhlo.jdField_c_of_type_JavaLangString;
            a(new File(localbhlo.f), new File(str2));
            l2 = l1 + 1L;
          }
          i += 1;
          l1 = l2;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup %d files of %d", new Object[] { Long.valueOf(l1), Integer.valueOf(parambhlp.jdField_c_of_type_JavaUtilList.size()) }));
        }
        if (parambhlp.f == l1) {
          bool = true;
        } else {
  ...
  private boolean f(bhlp parambhlp)
  {
    boolean bool1;
    if ((parambhlp != null) && (!parambhlp.jdField_c_of_type_JavaUtilList.isEmpty()))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] do update files: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      String str = a(parambhlp);
      int i = 0;
      if (i < parambhlp.jdField_c_of_type_JavaUtilList.size())
      {
        bhlo localbhlo = (bhlo)parambhlp.jdField_c_of_type_JavaUtilList.get(i);
        File localFile1 = new File(str, localbhlo.jdField_b_of_type_JavaLangString);
        Object localObject = new File(localbhlo.f);
        ...
        for (;;)
        {
          ...
          if (!bool2)
          {
            localObject = localbhlo.f + ".1";
            File localFile2 = new File((String)localObject);
            localbhlo.jdField_a_of_type_Int = 3;
            localbhlo.g = ((String)localObject);
            bool2 = a(localFile1, localFile2);
            if (QLog.isColorLevel()) {
              QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] copied failed, renamed to: %s", new Object[] { localbhlo.g }));
            }
            bool1 = bool2;
            if (bool2)
            {
              this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(localbhlo.f, localbhlo.g).commit();
              bool1 = bool2;
            }
          }
          if (!bool1) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] success copied: %s", new Object[] { localbhlo.f }));
          }
          parambhlp.jdField_b_of_type_JavaUtilList.add(localbhlo);
          parambhlp.g += 1L;
        }
        label376:
        a("0X80078B2", (int)localbhlo.jdField_b_of_type_Long, localbhlo.jdField_a_of_type_JavaLangString, localbhlo.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] failed copied: %s", new Object[] { localbhlo.f }));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update %d files of %d", new Object[] { Long.valueOf(parambhlp.g), Integer.valueOf(parambhlp.jdField_c_of_type_JavaUtilList.size()) }));
      }
      if (parambhlp.g == parambhlp.jdField_c_of_type_JavaUtilList.size()) {
        bool1 = true;
      }
    }
    for (;;)
  ...
  private boolean g(bhlp parambhlp)
  {
    boolean bool;
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] unzip package: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      String str = a(parambhlp);
      File localFile = new File(str);
      if (!localFile.exists()) {
  ...
  private boolean h(bhlp parambhlp)
  {
    boolean bool = false;
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] download package: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      bool = a(new bhlm(2, 0, a(parambhlp), parambhlp.jdField_a_of_type_JavaLangString, parambhlp.jdField_c_of_type_JavaLangString, parambhlp.jdField_b_of_type_JavaLangString, 0, true, 0, new Date().getTime(), parambhlp.jdField_b_of_type_Int));
    }
    return bool;
  }
  
  private boolean i(bhlp parambhlp)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (parambhlp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] get different: sid=%d", new Object[] { Long.valueOf(parambhlp.jdField_a_of_type_Long) }));
      }
      List localList = parambhlp.jdField_a_of_type_JavaUtilList;
      int i = 0;
      if (i < localList.size())
      {
        bhlo localbhlo = (bhlo)localList.get(i);
        if (!new File(localbhlo.f).exists())
        {
          localbhlo.jdField_a_of_type_Int = 2;
          parambhlp.jdField_c_of_type_JavaUtilList.add(localbhlo);
        }
        String str;
        do
        {
          i += 1;
          break;
          str = bhli.a(localbhlo.f);
        } while ((str != null) && (str.equalsIgnoreCase(localbhlo.jdField_b_of_type_JavaLangString)));
        localbhlo.jdField_a_of_type_Int = 1;
        if (str != null) {}
        for (;;)
        {
          localbhlo.jdField_c_of_type_JavaLangString = str;
          parambhlp.jdField_c_of_type_JavaUtilList.add(localbhlo);
          parambhlp.f += 1L;
          break;
          str = "";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] need to update %d files of %d", new Object[] { Integer.valueOf(parambhlp.jdField_c_of_type_JavaUtilList.size()), Integer.valueOf(parambhlp.jdField_a_of_type_JavaUtilList.size()) }));
      }
      bool1 = bool2;
      if (!parambhlp.jdField_c_of_type_JavaUtilList.isEmpty()) {
        bool1 = true;
      ...
      try
      {
        ...
        if (localUpdateQueryResponse != null)
        {
          ...
          if ((i1 == 0) && (k == 1))
          {
            ...
            bool1 = a(new bhlm(1, k, a(), "qp_sfu_config.dat", paramFromServiceMsg, paramToServiceMsg, m, bool1, 0, new Date().getTime(), 1));
          }
        }
        else
        {
        ...
        if (i1 == 1)
        {
          ...
          bool1 = bool2;
          if (!this.jdField_a_of_type_Bhlk.a(paramToServiceMsg.toString())) {
            continue;
          }
          if (this.jdField_a_of_type_Bhlk.a().isEmpty()) {
            d(16);
  ...
  {
    if (this.jdField_a_of_type_AndroidOsHandler != null) {
      this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052688, parambaqw).sendToTarget();
    }
  }
  
  public void onUpdateProgeress(baqv parambaqv, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052689, (int)paramLong1, (int)paramLong2, parambaqv).sendToTarget();
  }
}
