...
{
  public int a;
  private anvi jdField_a_of_type_Anvi = new anws(this);
  public bisl a;
  ...
  public anwr(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo)
  {
  ...
  private void d()
  {
    ...
    for (String str1 = this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.joinUrl.substring(i + 12);; str1 = null)
    {
      ...
      String str3 = anwf.a(str1, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.userCreate);
      if (this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.userCreate != 1)
      {
        anwf.a(2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.troopUin, str3, str1, anvx.a(2131705077) + this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name + anvx.a(2131705072), anvx.a(2131705074), null, null);
        return;
      }
      String str2 = anvx.a(2131705071);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        str2 = anvx.a(2131705075) + this.jdField_a_of_type_JavaLangString + anvx.a(2131705076);
      }
      ...
      anwf.a(2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.troopUin, str3, str1, anvx.a(2131705070) + this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name + anvx.a(2131705073), str2, this.b, str4);
      return;
    }
  }
