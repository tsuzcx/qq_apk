  ...
  implements otf
{
  ...
  private static void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      nol.a(null, "CliOper", "", "", "0X8009C0F", "0X8009C0F", 0, 0, "", "", paramString1, paramString2);
      return;
    }
  ...
  private boolean a(int paramInt, SneakyParams paramSneakyParams)
  {
    ...
    long l1 = ((Long)bhvy.a(str1, Long.valueOf(0L))).longValue();
    ...
    int j = ((Integer)bhvy.a(str2, Integer.valueOf(paramSneakyParams.getMaximumWakeUpTimes(paramInt)))).intValue();
    if ((l2 - l1) * 1.0D / 86400000.0D > 1.0D)
    {
      ...
      bhvy.a(str2, Integer.valueOf(paramSneakyParams.getMaximumWakeUpTimes(paramInt) - 1));
    }
    for (;;)
    {
      bhvy.a(str1, Long.valueOf(l2));
      return true;
      i = 0;
      break;
      label397:
      ...
      bhvy.a(str2, Integer.valueOf(j - 1));
    }
    label417:
    return false;
  }
  ...
  private boolean a(AladdinConfig paramAladdinConfig)
  {
    try
    {
      ...
      while (paramAladdinConfig.hasNext())
      {
        ...
        String str = TextUtils.join(".", qeb.a(localSneakyRule.getProps(), new sin(this)));
  ...
  private boolean a(SneakyParams paramSneakyParams)
  {
    try
    {
      boolean bool = aney.a(paramSneakyParams.getPackageName(), BaseApplicationImpl.getContext());
      if (bool) {
        return true;
      }
    }
