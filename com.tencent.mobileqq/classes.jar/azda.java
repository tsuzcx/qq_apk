...
public class azda
{
  ...
  static boolean a()
  {
    return azkt.b(VideoEnvironment.a());
  }
  ...
  static boolean a(AppInterface paramAppInterface, ShortVideoResourceManager.SVConfigItem paramSVConfigItem)
  {
    ...
    {
      return true;
      QmcfManager.getInstance().setQmcfMobileNotSupport(azjg.a);
      return false;
  ...
  static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (localFile.exists())
    {
      if ((a().equals(paramString1)) && (azcr.b(paramQQAppInterface, "artfilter_config_file")))
      {
    ...
    try
    {
      ...
      bool1 = azcr.b(paramQQAppInterface, "artfilter_config_file");
