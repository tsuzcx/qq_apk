  ...
  implements aqxy
{
  ...
  private arfd(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, arfe paramarfe, arfi paramarfi)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, 0, paramarfe, paramarfi);
  ...
  public static aqxy a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, arfe paramarfe, arfi paramarfi)
  {
    if (paramarfe == null) {
    ...
    return null;
    return new arfd(paramQQAppInterface, paramLong1, paramLong2, paramarfe, paramarfi);
  }
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Aqxg != null) {
      this.jdField_a_of_type_Aqxg.a(paramLong1);
    }
  }
  ...
  protected void a(ExcitingTransferUploadBizInfo paramExcitingTransferUploadBizInfo)
  {
    ...
    if ((this.jdField_a_of_type_Arff instanceof arfe))
    {
      arfe localarfe = (arfe)this.jdField_a_of_type_Arff;
      paramExcitingTransferUploadBizInfo.bufUuid = localarfe.a;
      paramExcitingTransferUploadBizInfo.bufUploadKey = localarfe.b;
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_Arff.a(paramArrayOfByte);
    b();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    e();
    b(null);
    if ((this.jdField_a_of_type_Arff.d() == null) || (this.jdField_a_of_type_Arff.d().length == 0))
    {
      if (this.jdField_a_of_type_Aqxg != null)
      {
        Bundle localBundle = new Bundle();
        byte[] arrayOfByte = this.jdField_a_of_type_Aqxg.a(localBundle);
        ...
        this.jdField_a_of_type_Arff.a(arrayOfByte);
      }
    }
    else {
      return b();
  ...
  protected void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    for (String str = paramExcitingTransferUploadResultRp.m_strFileUrl;; str = "")
    {
      ...
      paramInt = a(paramInt);
      if (this.jdField_a_of_type_Aqxg != null) {
        this.jdField_a_of_type_Aqxg.a(true, this.c, paramInt, "", "");
      }
      return;
    }
  }
