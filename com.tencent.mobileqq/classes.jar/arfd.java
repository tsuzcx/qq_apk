  ...
  extends arac<arfc>
{
  ...
  public static arfc a()
  {
    return (arfc)aran.a().a(425);
  }
  ...
  @Nullable
  public arfc a(araj[] paramArrayOfaraj)
  {
    if ((paramArrayOfaraj != null) && (paramArrayOfaraj.length > 0))
    {
      new arfc();
      return arfc.a(paramArrayOfaraj);
    }
    return null;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("MiniAppConfProcessor", 2, "onUpdate " + paramarfc.toString());
    }
    paramarfc = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramarfc instanceof QQAppInterface))
    {
      paramarfc = (MiniAppEntryHandler)((QQAppInterface)paramarfc).a(149);
      if (paramarfc != null) {
        paramarfc.notifyUI(0, true, null);
      }
    }
  }
