...
public class amwh
{
  ...
  {
    return atym.a(a(paramQQAppInterface, paramLong1, paramLong2, paramLong3), paramUinPairMsg, paramQQAppInterface);
  }
  ...
  {
    Object localObject2 = new amwi(paramQQAppInterface, paramMessageRecord, null, 0).a();
    Object localObject1 = ((amwi)localObject2).a();
    int i = ((amwi)localObject2).a();
    ...
    localObject2 = aquj.a(paramMessageRecord);
    ...
    a(paramQQAppInterface, paramMessageRecord, (amsw)paramQQAppInterface.getManager(51));
    localObject1 = bblf.a(paramQQAppInterface, paramMessageRecord, (im_msg_body.RichText)localObject1, i);
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, acvz paramacvz)
  {
    boolean bool4 = true;
    Object localObject1;
    int i;
    ...
    {
      localObject1 = bblf.a((MessageForText)paramMessageRecord);
    ...
    for (;;)
    {
      ...
      {
        localObject1 = bblf.a((MessageForShortVideo)paramMessageRecord);
        i = 0;
        break;
      }
      if (paramMessageRecord.msgtype == -2000)
      {
        localObject1 = bblf.a((MessageForPic)paramMessageRecord);
        i = 0;
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      a(paramacvz, (msg_svc.MultiMsgAssist)localObject1);
      int j = bblk.a(paramMessageRecord.msgUid);
      int k = (short)(int)paramMessageRecord.msgseq;
      paramArrayList = paramQQAppInterface.getMsgCache().a();
      paramacvz = new msg_svc.PbSendMsgReq();
      paramacvz.msg_body.set((MessageMicro)localObject2);
      paramacvz.msg_seq.set(k & 0xFFFF);
      paramacvz.msg_rand.set(j);
      paramacvz.msg_via.set(i);
      paramacvz.multi_msg_assist.set((MessageMicro)localObject1);
      if (paramArrayList != null) {
        paramacvz.sync_cookie.set(ByteStringMicro.copyFrom(paramArrayList));
      }
      paramArrayList = paramacvz;
      if (paramacvz == null) {
        break;
      }
      a(paramQQAppInterface, paramMessageRecord, paramacvz);
      return paramacvz;
  ...
  private static im_msg_body.GeneralFlags a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    boolean bool2 = a(false, localResvAttr, paramMessageRecord.getExtInfoFromExtStr(bbkv.jdField_c_of_type_JavaLangString));
    ...
    boolean bool4;
    int i;
    if (((paramMessageRecord instanceof MessageForFoldMsg)) && (ajul.a(paramQQAppInterface)))
    {
      bool3 = ajul.b(paramQQAppInterface);
      localObject = (ajul)paramQQAppInterface.getManager(125);
      MessageForFoldMsg localMessageForFoldMsg = (MessageForFoldMsg)paramMessageRecord;
      if ((localMessageForFoldMsg.redBagId != null) && (ajul.b(paramQQAppInterface))) {
        if ((bool3) && (!((ajul)localObject).e))
        {
          bool1 = true;
    ...
    for (;;)
    {
      ...
      localObject = ((amsw)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.getCurrentUin());
      if (localObject != null)
      {
  ...
  private static void a(acvz paramacvz, msg_svc.MultiMsgAssist paramMultiMsgAssist)
  {
    if (paramacvz != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandlerUtils", 2, String.format("getPbSendReqFromBlessMsg, hongbao param, temp_id: %d, video_len: %d, redbag_id: %s, redbag_amount: %d, has_readbag: %d, has_video: %d", new Object[] { Long.valueOf(paramacvz.jdField_a_of_type_Long), Long.valueOf(paramacvz.jdField_b_of_type_Long), paramacvz.jdField_a_of_type_ArrayOfByte, Long.valueOf(paramacvz.c), Integer.valueOf(paramacvz.jdField_a_of_type_Int), Integer.valueOf(paramacvz.jdField_b_of_type_Int) }));
      }
      paramMultiMsgAssist.uint64_temp_id.set(paramacvz.jdField_a_of_type_Long);
      paramMultiMsgAssist.uint64_vedio_len.set(paramacvz.jdField_b_of_type_Long);
      paramMultiMsgAssist.uint32_has_readbag.set(paramacvz.jdField_a_of_type_Int);
      if (paramacvz.jdField_a_of_type_Int == 1)
      {
        if (paramacvz.jdField_a_of_type_ArrayOfByte != null) {
          paramMultiMsgAssist.bytes_redbag_id.set(ByteStringMicro.copyFrom(paramacvz.jdField_a_of_type_ArrayOfByte));
        }
        paramMultiMsgAssist.uint64_redbag_amount.set(paramacvz.c);
      }
      paramMultiMsgAssist.uint32_has_vedio.set(paramacvz.jdField_b_of_type_Int);
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, amsw paramamsw, im_msg_body.PubGroup paramPubGroup)
  {
    for (;;)
    {
      try
      {
        String str = (String)awka.a(paramQQAppInterface.getCurrentAccountUin(), "self_nick", String.valueOf(""));
        int j = ((Integer)awka.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        int i = ((Integer)awka.a(paramQQAppInterface.getCurrentAccountUin(), "self_age", Integer.valueOf(-1))).intValue();
        if ((i < 0) || (j < 0))
        {
          Friends localFriends = paramamsw.e(paramQQAppInterface.getCurrentAccountUin());
          ...
          {
            paramQQAppInterface = paramamsw.b(paramQQAppInterface.getCurrentAccountUin());
            if (paramQQAppInterface != null)
            {
  ...
  private static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, amsw paramamsw)
  {
    if (paramamsw.a)
    {
      if (QLog.isColorLevel()) {
      ...
      paramamsw = paramMessageRecord.frienduin;
      int i = paramMessageRecord.istroop;
      long l = paramMessageRecord.uniseq;
      paramQQAppInterface.getMessageFacade().updateMsgFieldByUniseq(paramamsw, i, l, "extStr", paramMessageRecord.extStr);
      paramQQAppInterface.getMessageFacade().updateMsgFieldByUniseq(paramamsw, i, l, "extLong", Integer.valueOf(paramMessageRecord.extLong));
    }
  }
  ...
  protected static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject = (anaj)paramQQAppInterface.getBusinessHandler(13);
    int j = ((anaj)localObject).d();
    paramQQAppInterface = (BubbleManager)paramQQAppInterface.getManager(44);
    int k = ((anaj)localObject).b();
    boolean bool1;
    if (k > 0)
    {
  ...
  private static void a(MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq, QQAppInterface paramQQAppInterface)
  {
    ...
    while (localIterator.hasNext()) {
      ((abyd)localIterator.next()).a(paramMessageRecord, paramPbSendMsgReq, paramQQAppInterface);
    }
  }
  ...
  {
    paramQQAppInterface = (abyl)paramQQAppInterface.getMessageFacade().getRegistry().a().a(Integer.valueOf(paramInt));
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localMessageRecord != null) && (localMessageRecord.msgtype == paramMessageRecord.msgtype) && (bftf.a(localMessageRecord.msg, paramMessageRecord.msg)))
        {
  ...
  {
    if (((bfdm)paramQQAppInterface.getManager(203)).a(paramMessageRecord))
    {
      ...
      if ((paramMessageRecord instanceof MessageForPtt))
      {
        ...
        if ((paramQQAppInterface.atInfoList != null) && (!paramQQAppInterface.atInfoList.isEmpty()))
        {
          ...
          bblf.a(paramMessageRecord, paramQQAppInterface.mInputContent, paramQQAppInterface.atInfoList);
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq, boolean paramBoolean, im_msg_body.GeneralFlags paramGeneralFlags)
  {
    ...
    if (paramPbSendMsgReq != null)
    {
      ...
      paramQQAppInterface = (anaj)paramQQAppInterface.getBusinessHandler(13);
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean, long paramLong, StringBuilder paramStringBuilder, List<MessageRecord> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext()) {
        if (abwz.a((MessageRecord)paramList.next(), paramMessageRecord, paramBoolean))
        {
  ...
  private static boolean a(MessageRecord paramMessageRecord, im_msg_body.GeneralFlags paramGeneralFlags)
  {
    ...
    {
      byte[] arrayOfByte = bftf.a(paramMessageRecord.msg);
      if (arrayOfByte != null) {
  ...
  private static boolean a(MessageRecord paramMessageRecord, boolean paramBoolean, generalflags.ResvAttr paramResvAttr)
  {
    ...
    {
      bool = paramBoolean;
      if (ahtj.b((MessageForPic)paramMessageRecord))
      {
        paramBoolean = true;
  ...
  private static void b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            a(paramQQAppInterface, (amsw)localObject1, (im_msg_body.PubGroup)localObject2);
            ...
            paramQQAppInterface = new im_msg_body.Elem();
            apse.a(paramQQAppInterface, paramMessageRecord);
            paramRichText.elems.add(paramQQAppInterface);
          ...
          paramQQAppInterface = apse.a(paramMessageRecord);
          if (paramQQAppInterface != null) {
            paramRichText.elems.add(paramQQAppInterface);
          }
        } while (!QLog.isColorLevel());
      ...
      atym.a((im_msg_body.Elem)localObject1, paramMessageRecord, paramQQAppInterface);
      paramRichText.elems.add((MessageMicro)localObject1);
    } while (!QLog.isColorLevel());
  ...
  private static void b(MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    if ((paramPbSendMsgReq != null) && ((paramMessageRecord instanceof MessageForStructing)))
    {
      ...
      if ((paramMessageRecord.structingMsg != null) && (uih.a(paramMessageRecord.structingMsg)))
      {
  ...
  private static void b(MessageRecord paramMessageRecord, generalflags.ResvAttr paramResvAttr)
  {
    if ((paramMessageRecord instanceof MessageForPtt))
    {
      ...
      if (paramMessageRecord.waveformArray != null) {
        paramResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(bfxf.a(paramMessageRecord.waveformArray).toByteArray()));
      }
    }
  }
  ...
  private static void b(MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText)
  {
    ...
    {
      paramMessageRecord = apse.b(paramMessageRecord);
      if (paramMessageRecord != null) {
  ...
  private static boolean b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean, long paramLong, StringBuilder paramStringBuilder, List<MessageRecord> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        if (abwz.a((MessageRecord)paramList.next(), paramMessageRecord, false, paramBoolean))
        {
          if ((QLog.isColorLevel()) && (paramStringBuilder != null))
          {
  ...
  private static boolean b(MessageRecord paramMessageRecord, long paramLong, StringBuilder paramStringBuilder, List<MessageRecord> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        if (abwz.a((MessageRecord)paramList.next(), paramMessageRecord, true))
        {
          if ((QLog.isColorLevel()) && (paramStringBuilder != null))
          {
            paramStringBuilder.append(" filterType: other");
