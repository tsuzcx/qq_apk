...
@TargetApi(11)
public class amwh
  implements amvh, SurfaceTexture.OnFrameAvailableListener, angj, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnInfoListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long = -1L;
  private amvj jdField_a_of_type_Amvj;
  private amwj jdField_a_of_type_Amwj;
  private SurfaceTexture jdField_a_of_type_AndroidGraphicsSurfaceTexture;
  private anfc jdField_a_of_type_Anfc;
  private anfd jdField_a_of_type_Anfd = new amwi(this);
  private anff jdField_a_of_type_Anff;
  ...
  private anfc jdField_b_of_type_Anfc;
  ...
  public amwh(amvj paramamvj, amwj paramamwj)
  {
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_Amvj = paramamvj;
    this.jdField_a_of_type_Amwj = paramamwj;
    this.jdField_e_of_type_Int = paramamwj.jdField_e_of_type_Int;
    this.jdField_d_of_type_Int = paramamwj.jdField_d_of_type_Int;
    this.jdField_a_of_type_Anff = paramamwj.jdField_a_of_type_Anff;
    this.jdField_a_of_type_JavaLangString = paramamwj.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Long = paramamwj.jdField_b_of_type_Long;
    boolean bool2 = amwp.a();
    if ((bool2) || (this.jdField_a_of_type_Amwj.jdField_a_of_type_Boolean)) {
      bool1 = true;
    }
    this.k = bool1;
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "Construction mSoftwarePlayConfig:" + this.k + "  isRubbishDevice:" + bool2 + "  isSoftPlay:" + this.jdField_a_of_type_Amwj.jdField_a_of_type_Boolean);
    }
  }
  ...
  {
    if (paramBoolean) {
      if (this.jdField_b_of_type_Anfc == null)
      {
        this.jdField_b_of_type_Anfc = anfe.a(this.jdField_a_of_type_Anff, 3);
        this.jdField_b_of_type_Anfc.a(amwp.jdField_b_of_type_ArrayOfFloat, amwp.jdField_a_of_type_ArrayOfShort);
        this.jdField_b_of_type_Anfc.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Anfd);
        this.jdField_b_of_type_Anfc.a(this.jdField_a_of_type_Amwj.jdField_c_of_type_Int, this.jdField_a_of_type_Amwj.jdField_a_of_type_Float, this.jdField_a_of_type_Amwj.jdField_b_of_type_Float, this.jdField_a_of_type_Amwj.jdField_c_of_type_Float);
      }
    }
    while (this.jdField_a_of_type_Anfc != null) {
      return;
    }
    this.jdField_a_of_type_Anfc = anfe.a(this.jdField_a_of_type_Anff, 1);
    this.jdField_a_of_type_Anfc.a(amwp.jdField_a_of_type_ArrayOfFloat, amwp.jdField_a_of_type_ArrayOfShort);
    this.jdField_a_of_type_Anfc.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Anfd);
    this.jdField_a_of_type_Anfc.a(this.jdField_a_of_type_Amwj.jdField_c_of_type_Int, this.jdField_a_of_type_Amwj.jdField_a_of_type_Float, this.jdField_a_of_type_Amwj.jdField_b_of_type_Float, this.jdField_a_of_type_Amwj.jdField_c_of_type_Float);
  }
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Amvj.a(paramArrayOfByte1);
    } while (!this.l);
    this.l = false;
  }
  ...
  {
    if ((!this.jdField_d_of_type_Boolean) || (paramArrayOfFloat2 == null) || (this.jdField_a_of_type_Amwj == null)) {
      return;
    }
    ...
    label54:
    int m;
    if (this.jdField_a_of_type_Amwj.jdField_b_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_Anfc != null)
      {
        paramArrayOfFloat2 = this.jdField_a_of_type_Anfc;
        m = this.jdField_a_of_type_Int;
        paramArrayOfFloat3 = this.jdField_a_of_type_Anff;
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Anfc != null)
      {
        paramArrayOfFloat2 = this.jdField_b_of_type_Anfc;
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2) {
      if (this.jdField_a_of_type_Amwj.jdField_a_of_type_Amzd != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Amwj.jdField_a_of_type_Amzd.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Amwj.jdField_a_of_type_Amzd.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Amwj.jdField_a_of_type_Amzd.jdField_c_of_type_Float, this.jdField_a_of_type_Amwj.jdField_a_of_type_Amzd.d, this.jdField_a_of_type_Amwj.jdField_a_of_type_Amzd.e);
      }
    }
    for (;;)
    {
    ...
    if (this.jdField_a_of_type_Amwj.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Amwj != null) {
      return this.jdField_a_of_type_Amwj.jdField_a_of_type_Int;
    }
    return 4;
  }
  ...
  {
    if (this.jdField_a_of_type_Amwj != null) {
      return this.jdField_a_of_type_Amwj.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Amwj.jdField_a_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Angi = new angi(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture);
    this.jdField_a_of_type_Angi.a(this);
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Angi);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "start, arResourceInfo=" + this.jdField_a_of_type_Amwj);
    }
    ...
    String str2 = angh.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (String str1 = "true";; str1 = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bflr.d(this.jdField_a_of_type_JavaLangString));
  ...
  public void f()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Anfc != null)
      {
        this.jdField_a_of_type_Anfc.b();
        this.jdField_a_of_type_Anfc = null;
      }
      if (this.jdField_b_of_type_Anfc != null)
      {
        this.jdField_b_of_type_Anfc.b();
        this.jdField_b_of_type_Anfc = null;
      }
      HashMap localHashMap = new HashMap();
      localHashMap.put("decode_type", String.valueOf(this.jdField_f_of_type_Int));
      azri.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_decode_type", true, 0L, 0L, localHashMap, "", false);
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Amvj != null) {
          this.jdField_a_of_type_Amvj.a(this.jdField_a_of_type_Amwj.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Amvj != null) {
      this.jdField_a_of_type_Amvj.b(2, this.jdField_e_of_type_Int - this.jdField_c_of_type_Int);
    }
    ...
    this.jdField_a_of_type_Amvj.a(paramTVK_IMediaPlayer);
  }
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    ...
    this.jdField_a_of_type_Amvj.a(this.jdField_a_of_type_JavaLangRunnable);
    if (!this.j)
    {
      this.j = true;
  ...
  public void onVideoPrepared(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Amvj != null)
        {
          this.jdField_a_of_type_Amvj.b(0, this.jdField_e_of_type_Int);
          return;
        }
      }
