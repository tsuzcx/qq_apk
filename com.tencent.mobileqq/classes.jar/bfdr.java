...
public class bfdr
{
  ...
  public static void a(File paramFile)
  {
    ...
    //   4: aload_0
    //   5: ldc 49
    //   7: invokespecial 53	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   10: astore_0
    //   11: aload_0
    //   12: invokevirtual 37	java/io/File:exists	()Z
    //   15: ifeq +8 -> 23
    //   18: aload_0
    //   19: invokevirtual 40	java/io/File:delete	()Z
    //   22: pop
    //   23: aconst_null
    //   24: astore_1
    //   25: new 55	java/io/FileOutputStream
    //   28: dup
    //   29: aload_0
    //   30: invokespecial 57	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   33: astore_0
    //   34: aload_0
    //   35: invokestatic 63	com/tencent/common/config/AppSetting:g	()Ljava/lang/String;
    //   38: invokevirtual 69	java/lang/String:getBytes	()[B
    //   41: invokevirtual 73	java/io/FileOutputStream:write	([B)V
    //   44: aload_0
    //   45: invokestatic 79	com/tencent/mobileqq/pluginsdk/IOUtil:closeStream	(Ljava/io/Closeable;)V
    //   48: return
    //   49: astore_0
    //   50: aconst_null
    //   51: astore_0
    //   52: aload_0
    //   53: invokestatic 79	com/tencent/mobileqq/pluginsdk/IOUtil:closeStream	(Ljava/io/Closeable;)V
    //   56: return
    //   57: astore_2
    //   58: aload_1
    //   59: astore_0
    ...
    //   61: astore_1
    //   62: aload_0
    //   63: invokestatic 79	com/tencent/mobileqq/pluginsdk/IOUtil:closeStream	(Ljava/io/Closeable;)V
    //   66: aload_1
    //   67: athrow
    //   68: astore_1
    //   69: goto -7 -> 62
  ...
  {
    return !IOUtil.contentEquals(new File(paramFile, "PluginVersion.ini"), AppSetting.g());
  }
  ...
  private static boolean a(File paramFile, PluginInfo paramPluginInfo)
  {
    ...
    //   3: astore 4
    //   5: aload_1
    //   6: invokestatic 217	com/tencent/mobileqq/pluginsdk/PluginBaseInfoHelper$PluginInfoParser:pluginToXML	(Lcom/tencent/mobileqq/pluginsdk/PluginBaseInfo;)Ljava/lang/String;
    //   9: invokevirtual 69	java/lang/String:getBytes	()[B
    //   12: iconst_0
    //   13: invokestatic 223	baaw:encode	([BI)[B
    //   16: astore_1
    //   17: new 55	java/io/FileOutputStream
    //   20: dup
    //   21: aload_0
    //   22: invokespecial 57	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   25: astore_0
    //   26: aload_0
    //   27: aload_1
    //   28: invokevirtual 73	java/io/FileOutputStream:write	([B)V
    //   31: iconst_1
    //   32: istore_3
    //   33: iload_3
    //   34: istore_2
    ...
    //   36: ifnull +9 -> 45
    //   39: aload_0
    //   40: invokevirtual 226	java/io/FileOutputStream:close	()V
    //   43: iload_3
    //   44: istore_2
    //   45: iload_2
    //   46: ireturn
    ...
    //   51: ifnull -6 -> 45
    //   54: aload_0
    //   55: invokevirtual 226	java/io/FileOutputStream:close	()V
    //   58: iconst_0
    //   59: ireturn
    //   60: astore_0
    //   61: iconst_0
    ...
    //   68: ifnull +7 -> 75
    //   71: aload_1
    //   72: invokevirtual 226	java/io/FileOutputStream:close	()V
    //   75: aload_0
    //   76: athrow
    //   77: astore_0
    //   78: iconst_1
  ...
  {
    return paramFile.listFiles(new bfds());
  }
}
