  ...
  implements Animatable
{
  ...
  Property<bmyp, Float> jdField_a_of_type_AndroidUtilProperty = new bmyq(this, Float.class, "backHeight");
  private bmzn jdField_a_of_type_Bmzn = new bmzn();
  private bmzt jdField_a_of_type_Bmzt = new bmzt();
  private WeakReference<bmza> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float = 5.0F;
  private int jdField_b_of_type_Int = 255;
  private RectF jdField_b_of_type_AndroidGraphicsRectF = new RectF();
  private Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable;
  Property<bmyp, Integer> jdField_b_of_type_AndroidUtilProperty = new bmys(this, Integer.class, "backAlpha");
  private boolean jdField_b_of_type_Boolean;
  private float jdField_c_of_type_Float = 50.0F;
  private int jdField_c_of_type_Int;
  private RectF jdField_c_of_type_AndroidGraphicsRectF = new RectF();
  Property<bmyp, Integer> jdField_c_of_type_AndroidUtilProperty = new bmyt(this, Integer.class, "speedAlpha");
  private float jdField_d_of_type_Float = 50.0F;
  private int jdField_d_of_type_Int = 179;
  Property<bmyp, Integer> jdField_d_of_type_AndroidUtilProperty = new bmyu(this, Integer.class, "reverseAlpha");
  private float jdField_e_of_type_Float = 30.0F;
  private int jdField_e_of_type_Int;
  Property<bmyp, Float> jdField_e_of_type_AndroidUtilProperty = new bmyv(this, Float.class, "foreSpeed");
  private float jdField_f_of_type_Float = 22.0F;
  private int jdField_f_of_type_Int = 179;
  Property<bmyp, Float> jdField_f_of_type_AndroidUtilProperty = new bmyw(this, Float.class, "foreHeight");
  private int jdField_g_of_type_Int = -1;
  Property<bmyp, Float> jdField_g_of_type_AndroidUtilProperty = new bmyx(this, Float.class, "speedPos");
  private int jdField_h_of_type_Int = 0;
  Property<bmyp, Integer> jdField_h_of_type_AndroidUtilProperty = new bmyy(this, Integer.class, "markAlpha");
  ...
  private void a(float paramFloat)
  {
    if (this.jdField_h_of_type_Int == 4)
    {
      ...
      {
        bmza localbmza = (bmza)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localbmza != null) {
          localbmza.a(this.jdField_h_of_type_Int, this.jdField_b_of_type_AndroidGraphicsRectF);
        }
      }
    }
  }
  ...
  private void a(int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bmyr(this));
  ...
  {
    RectF localRectF = this.jdField_a_of_type_Bmzt.a(this.jdField_g_of_type_Int);
    if (localRectF != null)
    {
  ...
  {
    RectF localRectF = this.jdField_a_of_type_Bmzt.a(this.jdField_c_of_type_Int - 1);
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (this.jdField_a_of_type_Bmzn != null) {
            this.jdField_a_of_type_Bmzn.a(this.jdField_a_of_type_AndroidGraphicsRectF);
          }
          a(this.jdField_c_of_type_AndroidGraphicsRectF, paramRect.height() * 0.9F);
        } while (this.jdField_a_of_type_Bmzt == null);
        this.jdField_a_of_type_Bmzt.a(this.jdField_c_of_type_AndroidGraphicsRectF);
        return;
    ...
    if ((this.jdField_h_of_type_Int == 1) || (this.jdField_h_of_type_Int == 3))
    {
      ...
      if (this.jdField_a_of_type_Bmzt != null)
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          bmza localbmza = (bmza)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localbmza != null) {
            localbmza.a(this.jdField_h_of_type_Int, a());
          }
        }
      }
    }
  ...
  private void f(int paramInt)
  {
    ...
    {
      return;
      localbmza = (bmza)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbmza == null);
    localbmza.b(paramInt);
  }
  ...
  {
    if (this.jdField_a_of_type_Bmzt != null) {
      return this.jdField_a_of_type_Bmzt.a(paramFloat);
    }
    return 0;
  }
  ...
  {
    if (this.jdField_a_of_type_Bmzt != null) {
      return this.jdField_a_of_type_Bmzt.a(this.jdField_g_of_type_Int);
    }
    return null;
  }
  ...
  public RectF a(float paramFloat)
  {
    int i = a(paramFloat);
    if (this.jdField_a_of_type_Bmzt != null) {
      return this.jdField_a_of_type_Bmzt.a(i);
    }
    return null;
  }
  ...
  public RectF a(int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Bmzt != null)
    {
      localRectF = this.jdField_a_of_type_Bmzt.a(paramInt);
      if (localRectF != null)
      {
        if (paramBoolean2) {
          break label160;
        ...
        {
          localObject = (bmza)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null)
          {
            ((bmza)localObject).a(this.jdField_h_of_type_Int, this.jdField_g_of_type_Int, localRectF);
    ...
    for (;;)
    {
      ...
      label160:
      localObject = this.jdField_a_of_type_Bmzt.a(i);
      if (localObject != null)
      {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bmzt.a();
    this.jdField_a_of_type_Bmzn.a();
  ...
  public boolean a(Context paramContext, int paramInt, float paramFloat1, float paramFloat2, bmza parambmza)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambmza);
    if (paramInt > 0) {
      this.jdField_a_of_type_Float /= paramInt;
    }
    a(paramContext);
    this.jdField_c_of_type_Int = paramInt;
    this.jdField_a_of_type_Bmzt.a(-1, paramInt, this.jdField_b_of_type_Float, paramFloat1, paramFloat2);
    this.jdField_a_of_type_Bmzn.a(0, paramFloat1, paramFloat2);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841225);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841224);
    return true;
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    if (this.jdField_h_of_type_Int == 0)
    {
      this.jdField_a_of_type_Bmzt.a(paramCanvas, this.jdField_d_of_type_Int, this.jdField_g_of_type_Int, (int)(this.jdField_e_of_type_Int * 1.0F * 179.0F / 255.0F), this.jdField_f_of_type_Int);
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Bmzn.a(paramCanvas, this.jdField_a_of_type_Int);
        this.jdField_a_of_type_Bmzt.a(paramCanvas, this.jdField_d_of_type_Int, this.jdField_g_of_type_Int, (int)(this.jdField_e_of_type_Int * 1.0F * 127.0F / 255.0F), this.jdField_f_of_type_Int);
        a(paramCanvas, false);
        if ((this.jdField_h_of_type_Int == 3) || (this.jdField_h_of_type_Int == 1))
        {
      ...
      else if (this.jdField_h_of_type_Int == 4)
      {
        ...
        while ((this.jdField_g_of_type_Int >= 0) && (this.jdField_g_of_type_Int < this.jdField_c_of_type_Int))
        {
          ...
          return;
          label292:
          this.jdField_a_of_type_Bmzt.a(paramCanvas, this.jdField_d_of_type_Int, -1, (int)(this.jdField_e_of_type_Int * 1.0F * 179.0F / 255.0F), this.jdField_f_of_type_Int);
        }
      }
    }
  }
  ...
  protected void onBoundsChange(Rect paramRect)
  {
    ...
    if (this.jdField_g_of_type_Int >= 0)
    {
      ...
      {
        paramRect = (bmza)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (paramRect != null)
        {
