...
public class bfiu
{
  ...
  public static int a()
  {
    return bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).getInt("appTabVersionCode", -1);
  }
  ...
  public static String a(WebView paramWebView, HashMap<String, atgv> paramHashMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < localJSONArray2.length())
        {
          ...
          bflp.c("Common", "nameSpace:" + paramString + ",methodName=" + str1 + ",paramsStr=" + paramWebView);
      ...
      catch (UnsupportedEncodingException paramWebView)
      {
        try
        {
          ...
          {
            paramWebView = (Class)bfjc.jdField_a_of_type_JavaUtilHashMap.get(paramString);
            ...
            if (paramWebView != null)
            {
              ...
              if (j < k)
              {
                ...
                if ((paramWebView.getName().equals(str1)) && (paramWebView.getParameterTypes().length == ((List)localObject).size()))
                {
                  ...
                  try
                  {
                    bflp.c("Common", "callBatch <call> class : " + paramString.getClass().getName() + " , method : " + str1 + "\n , args : " + localObject.toString());
                  ...
                  {
                    bflp.c("Common", "callBatch error", paramWebView);
                  }
                  paramWebView = paramWebView;
                  bflp.b("Common", "callBatch decode params format err", paramWebView);
        ...
        {
          bflp.e("Common", "callBatch args error : " + paramWebView.toString());
        }
      }
      catch (JSONException paramWebView)
      {
        bflp.b("Common", "callBatch request params format err", paramWebView);
        continue;
        j += 1;
        continue;
        ...
        else if ((paramString instanceof Boolean))
        {
          ...
          localJSONObject.put("data", localJSONArray1);
          bflp.c("Common", "Response<callBatch> syncCallBatch result : " + localJSONObject);
        }
        else
        {
          paramWebView = "";
  ...
  public static void a()
  {
    try
    {
      bflp.b("Common", "<initSystemFolder> begin to init system file... ");
  ...
  {
    SharedPreferences.Editor localEditor = bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    bflp.c("Common", "setResourceMD5=" + paramString);
    SharedPreferences.Editor localEditor = bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  public static long[] a()
  {
    SharedPreferences localSharedPreferences = bfbm.a().a().getSharedPreferences("qzoneappcenter", 4);
  ...
  public static String[] a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      bflp.c("Common", "url params= " + str2 + " " + paramString);
  ...
  {
    bflp.c("Common", "setLastResourceZipMd5=" + paramString);
    SharedPreferences.Editor localEditor = bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    return bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).getBoolean("appstoreclearcache", false);
  }
  ...
  {
    String str = q();
    bflp.b("Common", "<getSDResDir> getSDResDir=" + str);
    if (TextUtils.isEmpty(str)) {
      return "";
    }
  ...
  {
    return bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("relastmd5", "");
  }
  
  public static String o()
  {
    return bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("lastresourcezipmd5", "");
  }
  
  public static String p()
  {
    return bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("appstoreagentversion", "");
  }
  
  public static String q()
  {
    return bfbm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("sdhtmldir", "");
  }
  ...
  public static String r()
  {
    ...
    {
      bflp.c("Common", "exception happened!");
      return "";
    }
    return "";
  }
