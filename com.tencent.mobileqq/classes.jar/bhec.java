  ...
  implements auux
{
  ...
  public long a;
  private bhgv jdField_a_of_type_Bhgv = new bhee(this);
  IBaseRecognizer jdField_a_of_type_ComTencentMobileqqActivityQwalletEmojIBaseRecognizer = new bhej(this);
  ...
  public bhec(bhzc parambhzc, bhzb parambhzb)
  {
    super(parambhzc, parambhzb);
    this.jdField_a_of_type_Bhyu = new bhyu(10022, 100, 13);
  }
  
  private String a(bhhh parambhhh)
  {
    ...
    for (;;)
    {
      try
      {
        parambhhh = parambhhh.b.iterator();
        if (!parambhhh.hasNext()) {
          break label76;
        }
        localObject = (bhgn)parambhhh.next();
        if (!(localObject instanceof bhjv)) {
          continue;
        }
        parambhhh = (bhjv)localObject;
        if (parambhhh != null)
        {
          parambhhh = Uri.parse(parambhhh.b()).getPath();
          localObject = parambhhh;
          return localObject;
        }
      }
      catch (Throwable parambhhh)
      {
        parambhhh.printStackTrace();
        return null;
      }
      parambhhh = null;
      continue;
  ...
  private void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, Camera paramCamera)
  {
    if (this.jdField_f_of_type_Int == 0) {
      HandRecognizer.getInstance().onPreviewFrameHandler(paramArrayOfByte, paramInt1, paramInt2, paramCamera, paramInt3, new bheh(this));
    }
    while (this.jdField_f_of_type_Int != 1) {
      return;
    }
    QWalletFaceTracker.getInstance().onPreviewFrameHandler(paramArrayOfByte, this.g, paramInt1, paramInt2, paramInt3, new bhei(this));
  }
  ...
  private void ag()
  {
    ...
    for (int k = 90;; k = 50)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout.b.setContentDescription(ajjy.a(2131644006));
      ...
      this.jdField_f_of_type_AndroidViewView.setOnTouchListener(new bhef(this));
      this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.setOnTouchListener(new bheg(this));
  ...
  public void H()
  {
    g();
    N();
    bbmy.a(BaseApplicationImpl.getContext(), ajjy.a(2131644008), 0).a();
  }
  ...
  {
    super.N();
    awqx.b(null, "P_CliOper", "Vip_pay_mywallet", "", "211", "phiz.video.short", 0, 0, "", "", "", "");
  }
  ...
  public void X()
  {
    int k = 100;
    super.X();
    this.jdField_a_of_type_Bhff.b(100);
    bhff localbhff = this.jdField_a_of_type_Bhff;
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (i())
    {
      ...
      awqx.b(null, "P_CliOper", "Vip_pay_mywallet", "", "211", "phiz.video.success", 0, 0, "", "", "", "");
      return;
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    this.jdField_a_of_type_Bhff.b(100);
    paramString = this.jdField_a_of_type_Bhff;
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView.k) {}
    for (;;)
    {
      paramString.c(k);
  ...
  public void ad()
  {
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312678));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312626));
    this.jdField_f_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131313323);
    this.jdField_d_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131297953));
    agwj.a(this.jdField_d_of_type_AndroidWidgetButton, 0.3F);
    this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(new bhed(this));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetButton.setVisibility(8);
    this.jdField_a_of_type_DovComQqImStoryViewAnimationQIMCircleProgress = ((AnimationQIMCircleProgress)this.jdField_a_of_type_AndroidViewView.findViewById(2131299259));
    Object localObject = (QIMCameraCountTimeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131298344);
    ((QIMCameraCountTimeLayout)localObject).setDotView(2130846168);
    ((QIMCameraCountTimeLayout)localObject).setTextColor(7829367);
    localObject = (AnimationQIMCircleProgress)this.jdField_a_of_type_AndroidViewView.findViewById(2131299259);
    ...
    this.jdField_a_of_type_JavaLangString = ajjy.a(2131644007);
  }
  ...
  public void d(int paramInt)
  {
    ...
    localbhgs.a(this.jdField_a_of_type_Bhgv);
    localbhgs.a().a(this.i);
    localbhgs.g();
    localbhgs.a(false);
    QIMFilterCategoryItem localQIMFilterCategoryItem = localbhgs.a(paramInt);
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (!localbhgs.a().a((String)localObject, a())) {
        break;
      }
    ...
    bhhh localbhhh = localbhgs.a(localQIMFilterCategoryItem);
    if (QLog.isColorLevel()) {
      QLog.i("QIMEmojiRedPacketCameraCapture", 2, "combo.outState=" + localbhhh.a);
    }
    if ((localbhhh.a == 1) || (localbhhh.a == 2)) {
      bhpu.a(localbhhh).a();
    }
    ThreadManager.getUIHandler().post(new QIMEmojiRedPacketCameraCaptureUnit.13(this, localbhgs, localQIMFilterCategoryItem, (Bundle)localObject));
  }
  ...
  public void e()
  {
    ...
    bhgs localbhgs = (bhgs)bhfm.a(5);
    if (localbhgs != null) {
      localbhgs.b(this.jdField_a_of_type_Bhgv);
    }
  }
  ...
  {
    super.g();
    this.jdField_a_of_type_Bhff.a(8);
  ...
  public void j()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644005));
    awqx.b(null, "P_CliOper", "Vip_pay_mywallet", "", "211", "phiz.video.click", 0, 0, "", "", "", "");
  }
