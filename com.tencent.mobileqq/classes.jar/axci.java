...
public class axci
{
  ...
  public static String a(MessageForStructing paramMessageForStructing)
  {
    ...
    if (paramMessageForStructing.getItemCount() > 0)
    {
      ...
      if ((paramMessageForStructing instanceof bcye))
      {
        Object localObject = (bcye)paramMessageForStructing;
        if (((bcye)localObject).a.size() > 0)
        {
          paramMessageForStructing = ((bcye)localObject).a.getString("sNick");
          String str = ((bcye)localObject).a.getString("rNick");
          localObject = ((bcye)localObject).a.getString("cMean");
  ...
  public static boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((paramMessageRecord.structingMsg != null) && ((paramMessageRecord.structingMsg instanceof AbsShareMsg)) && (paramMessageRecord.structingMsg.mMsgServiceID == 52))
      {
        ...
        if ((paramMessageRecord.getItemCount() <= 0) || (!(paramMessageRecord.getItemByIndex(0) instanceof bcye))) {}
      }
    }
  ...
  public static int[] a(Context paramContext)
  {
    ...
    paramContext = bgsg.k(paramContext);
  ...
  public static void b(String paramString)
  {
    ...
    //   22: newarray int
    //   24: putstatic 105	axci:jdField_a_of_type_ArrayOfInt	[I
    //   27: iconst_0
    //   28: istore_1
    //   29: iload_1
    //   30: aload_0
    ...
    //   47: istore_2
    //   48: getstatic 105	axci:jdField_a_of_type_ArrayOfInt	[I
    //   51: iload_1
    //   52: iload_2
    //   53: iastore
    //   54: iload_1
