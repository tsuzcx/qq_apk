  ...
  implements axbb<SpriteGLView>
{
  ...
  public axci()
  {
    ...
    this.jdField_a_of_type_Axbd = new axbd(0.0F, 0.0F);
    f();
  }
  
  public axci(SpriteGLView paramSpriteGLView)
  {
    this.jdField_c_of_type_ArrayOfFloat = new float[] { 1.0F, 1.0F, 0.0F, -1.0F, 1.0F, 0.0F, -1.0F, -1.0F, 0.0F, -1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, -1.0F, 0.0F };
    this.jdField_a_of_type_ArrayOfShort = new short[] { 0, 1, 2, 3, 4, 5 };
    this.jdField_a_of_type_ArrayOfFloat = new float[] { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, 1.0F };
  ...
  public axci(SpriteGLView paramSpriteGLView, Bitmap paramBitmap)
  {
    this.jdField_c_of_type_ArrayOfFloat = new float[] { 1.0F, 1.0F, 0.0F, -1.0F, 1.0F, 0.0F, -1.0F, -1.0F, 0.0F, -1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, -1.0F, 0.0F };
    this.jdField_a_of_type_ArrayOfShort = new short[] { 0, 1, 2, 3, 4, 5 };
    this.jdField_a_of_type_ArrayOfFloat = new float[] { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, 1.0F };
    ...
    this.jdField_a_of_type_Axbd = new axbd(0.0F, 0.0F);
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView = paramSpriteGLView;
    this.jdField_a_of_type_Axcl = new axcl(paramSpriteGLView, paramBitmap);
    g();
    f();
  }
  ...
  public axcl a()
  {
    return this.jdField_a_of_type_Axcl;
  }
  ...
  public void a(axcl paramaxcl)
  {
    this.jdField_a_of_type_Axcl = paramaxcl;
    g();
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView = paramSpriteGLView;
    this.jdField_a_of_type_Axcl = new axcl(this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView, paramBitmap);
    g();
  }
  ...
  protected void aR_()
  {
    super.aR_();
    if (this.jdField_a_of_type_Axcl != null) {
      this.jdField_a_of_type_Axcl.b = false;
    }
  }
  
  public int c()
  {
    this.jdField_a_of_type_Axcl.b();
    return this.jdField_a_of_type_Axcl.jdField_a_of_type_Int;
  }
  ...
  public void c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, float[] paramArrayOfFloat)
  {
    ...
    float f4 = (2.0F * this.jdField_a_of_type_Axbd.jdField_a_of_type_Float * b() - paramInt1) / paramInt2;
    ...
    for (float f1 = (-paramInt2 + 2.0F * this.jdField_a_of_type_Axbd.jdField_b_of_type_Float * b()) / paramInt2;; f1 = (paramInt2 - 2.0F * this.jdField_a_of_type_Axbd.jdField_b_of_type_Float * b()) / paramInt2)
    {
  ...
  public int d()
  {
    if ((this.jdField_a_of_type_Axcl == null) || (this.jdField_a_of_type_Axcl.jdField_a_of_type_AndroidGraphicsBitmap == null) || (this.jdField_a_of_type_Axcl.jdField_a_of_type_AndroidGraphicsBitmap.isRecycled())) {
      return (int)this.jdField_a_of_type_Float;
    }
    return this.jdField_a_of_type_Axcl.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
  }
  ...
  public int e()
  {
    ...
    return this.jdField_a_of_type_Axcl.jdField_a_of_type_AndroidGraphicsBitmap.getHeight();
  }
  ...
  protected void g()
  {
    if ((this.jdField_a_of_type_Axcl == null) || (this.jdField_a_of_type_Axcl.jdField_a_of_type_AndroidGraphicsBitmap == null)) {
      return;
    }
    this.jdField_a_of_type_Float = this.jdField_a_of_type_Axcl.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
    this.jdField_b_of_type_Float = this.jdField_a_of_type_Axcl.jdField_a_of_type_AndroidGraphicsBitmap.getHeight();
  }
}
