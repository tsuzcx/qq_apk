...
public class bdsq
{
  ...
  {
    String str = bdgt.a(MiniAppEnv.g().getContext());
    if (str == null) {
      return "unknown";
    }
  ...
  {
    return new ArrayList(Arrays.asList(new COMM.Entry[] { a("uin", String.valueOf(((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).getAccount())), a("touin", ""), a("timestamp", String.valueOf(System.currentTimeMillis())), a("qqversion", bdzd.b()), a("idfa", ""), a("idfv", ""), a("android_id", Settings.Secure.getString(MiniAppEnv.g().getContext().getContentResolver(), "android_id")) }));
  }
  ...
  {
    COMM.Entry localEntry1 = a("uid", String.valueOf(((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).getAccount()));
    ...
    if (paramString2 != null)
    {
      ...
      localEntry6 = a("qua", bdzd.b());
      localEntry7 = a("sdk_version", bdzd.a());
  ...
  public static void a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      bdnw.d("MiniProgramReportHelper", "[mini] assignAppLaunchId [appId= " + str1 + "] [launchId=" + str2);
    }
  ...
  {
    ArrayList localArrayList = new ArrayList(Arrays.asList(new COMM.Entry[] { a("device_platform", "Android"), a("device_maker", Build.MANUFACTURER), a("device_model", Build.MODEL), a("device_version", Build.VERSION.RELEASE), a("network_type", a()), a("network_gateway_ip", ""), a("network_ssid", bdgt.b(MiniAppEnv.g().getContext())) }));
    if (0 != 0) {
