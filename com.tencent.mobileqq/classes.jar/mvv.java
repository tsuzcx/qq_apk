  ...
  implements View.OnClickListener, ScaleGestureDetector.OnScaleGestureListener
{
  ...
  private PublicAccountImageCollectionListView.ListViewEventListener jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionListView$ListViewEventListener = new mvw(this);
  ...
  public mvv(Context paramContext, PublicAccountImageCollectionListView paramPublicAccountImageCollectionListView, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ZImageView paramZImageView, ImageRequest paramImageRequest, ImageProgressCircle paramImageProgressCircle, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        paramZImageView.a(localColorDrawable).a(paramImageRequest, new mwa(this, bool, l, paramImageProgressCircle));
        return;
  ...
  private void e()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131430046));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839692));
    }
  }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838487));
    this.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131430045));
  }
  ...
  private void g()
  {
    ...
    if (i <= j - k)
    {
      ...
      if ((((View)localObject).getTag() != null) && ((((View)localObject).getTag() instanceof mwc)))
      {
        localObject = (mwc)((View)localObject).getTag();
        if (((mwc)localObject).jdField_a_of_type_AndroidWidgetTextView.getVisibility() != 0) {
          break label97;
        }
        this.jdField_f_of_type_Boolean = false;
        ((mwc)localObject).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      }
      for (;;)
      {
        i += 1;
        ...
        ((mwc)localObject).jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      }
    }
  ...
  private void h()
  {
    if ((this.jdField_b_of_type_AndroidViewView == null) || (!(this.jdField_b_of_type_AndroidViewView.getTag() instanceof mwc))) {}
    Intent localIntent;
    Object localObject;
    float[] arrayOfFloat;
    String str;
  ...
  {
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(paramContext, new mwd(this, null));
  }
  ...
  void a(mwb parammwb)
  {
    if (this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo == null)
    {
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        parammwb.f.setVisibility(0);
        a(parammwb.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle);
        ((PublicAccountImageCollectionMainActivity)this.jdField_a_of_type_AndroidAppActivity).g();
        return;
      }
      parammwb.f.setVisibility(8);
      return;
    }
    ...
    parammwb.jdField_a_of_type_AndroidViewView.setVisibility(0);
    parammwb.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.e);
    Object localObject = "" + this.jdField_g_of_type_Int;
    if (this.jdField_g_of_type_Int > 1000000)
    {
      localObject = "100万+";
      parammwb.e.setText("阅读 " + (String)localObject);
      ...
      if (localObject != null)
      {
        parammwb.d.setText(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).jdField_b_of_type_JavaLangString);
        parammwb.b.setText(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).d);
        parammwb.c.setText(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).jdField_c_of_type_JavaLangString);
        if (TextUtils.isEmpty(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).jdField_b_of_type_JavaLangString)) {
          break label630;
        }
        parammwb.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        parammwb.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(FaceDrawable.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.jdField_c_of_type_JavaLangString));
      }
    }
    for (;;)
    {
      ...
      a(parammwb.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView, localImageRequest, parammwb.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, 0);
      if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.jdField_c_of_type_JavaLangString)) || (this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.jdField_c_of_type_JavaLangString.equals("0")))
      {
        ...
        parammwb.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        parammwb.e.setTextSize(2, 14.0F);
        parammwb.d.setVisibility(8);
        parammwb.b.setTextSize(2, 14.0F);
        parammwb.c.setTextSize(2, 14.0F);
  ...
  void a(mwc parammwc, int paramInt)
  {
    ...
    do
    {
      ...
      localObject = (RelativeLayout.LayoutParams)parammwc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView.getLayoutParams();
      localLayoutParams = (RelativeLayout.LayoutParams)parammwc.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
      localLayoutParams1 = parammwc.jdField_a_of_type_AndroidViewView.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject).width = this.jdField_f_of_type_Int;
      ((RelativeLayout.LayoutParams)localObject).height = i;
      parammwc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
    ...
    a(parammwc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView, localImageRequest, parammwc.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, parammwc.jdField_a_of_type_Int);
    int j;
    if ((localPhotoItemInfo.jdField_a_of_type_Int / localPhotoItemInfo.jdField_b_of_type_Int > 1.3D) && (!TextUtils.isEmpty(localPhotoItemInfo.jdField_b_of_type_JavaLangString)) && (!localPhotoItemInfo.jdField_b_of_type_JavaLangString.equals(" ")))
    {
      ...
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setMinHeight(AIOUtils.a(97.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setGravity(16);
      label348:
      if (i <= this.jdField_e_of_type_Int - (int)(88.0F * this.jdField_a_of_type_Float)) {
        break label616;
      }
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)(15.0F * this.jdField_a_of_type_Float), (int)(10.0F * this.jdField_a_of_type_Float), (int)(15.0F * this.jdField_a_of_type_Float), (int)(44.0F * this.jdField_a_of_type_Float));
      label409:
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams(localLayoutParams);
      parammwc.jdField_a_of_type_AndroidViewView.setLayoutParams(localLayoutParams1);
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setMaxLines(3);
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.valueOf("END"));
      localObject = paramInt + "/" + this.jdField_a_of_type_JavaUtilArrayList.size() + "  " + localPhotoItemInfo.jdField_b_of_type_JavaLangString;
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      ...
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setBackgroundColor(0);
      label536:
      if (this.jdField_f_of_type_Boolean) {
        break label678;
      }
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    }
    for (;;)
    {
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new mvy(this));
      return;
      ...
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setGravity(80);
      break label348;
      label616:
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)(15.0F * this.jdField_a_of_type_Float), (int)(10.0F * this.jdField_a_of_type_Float), (int)(15.0F * this.jdField_a_of_type_Float), (int)(10.0F * this.jdField_a_of_type_Float));
      break label409;
      label662:
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setBackgroundColor(Color.parseColor("#66000000"));
      break label536;
      label678:
      parammwc.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          bool1 = bool2;
        } while ((paramView.getTag() instanceof mwc));
        return false;
        bool1 = bool2;
      } while (paramInt != 0);
      if (paramView.getTag() == null) {
      ...
      bool1 = bool2;
    } while ((paramView.getTag() instanceof mwb));
    return false;
  }
  ...
  void d()
  {
    ...
    localNewIntent.setObserver(new mvz(this));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      paramView.setOnTouchListener(new mvx(this, paramInt));
      return paramView;
      localObject1 = (mwb)paramView.getTag();
      localObject2 = null;
      break;
      localObject2 = (mwc)paramView.getTag();
      ((mwc)localObject2).jdField_a_of_type_Int = paramInt;
      ...
      for (;;)
      {
        ...
        localObject1 = new mwb();
        ((mwb)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView = ((ZImageView)paramView.findViewById(2131365598));
        ((mwb)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle = ((ImageProgressCircle)paramView.findViewById(2131365599));
        ((mwb)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365601));
        ((mwb)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365603));
        ((mwb)localObject1).d = ((TextView)paramView.findViewById(2131365604));
        ((mwb)localObject1).c = ((TextView)paramView.findViewById(2131365605));
        ((mwb)localObject1).b = ((TextView)paramView.findViewById(2131365606));
        ((mwb)localObject1).b = ((TextView)paramView.findViewById(2131365606));
        ((mwb)localObject1).e = ((TextView)paramView.findViewById(2131365607));
        ((mwb)localObject1).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131365608));
        ((mwb)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramView.findViewById(2131365541));
        ((mwb)localObject1).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131365602);
        ((mwb)localObject1).f = ((TextView)paramView.findViewById(2131365600));
        ((mwb)localObject1).jdField_a_of_type_Int = paramInt;
        this.jdField_a_of_type_AndroidWidgetButton = ((mwb)localObject1).jdField_a_of_type_AndroidWidgetButton;
        this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
        this.jdField_a_of_type_AndroidViewView = ((mwb)localObject1).jdField_a_of_type_AndroidViewView;
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
        this.jdField_a_of_type_AndroidWidgetTextView = ((mwb)localObject1).e;
        paramView.setTag(localObject1);
        break;
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969214, paramViewGroup, false);
        localObject2 = new mwc();
        ((mwc)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle = ((ImageProgressCircle)paramView.findViewById(2131365612));
        ((mwc)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView = ((ZImageView)paramView.findViewById(2131365610));
        ((mwc)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365611));
        ((mwc)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramView.findViewById(2131365541));
        ((mwc)localObject2).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131365609);
        ((mwc)localObject2).jdField_a_of_type_Int = paramInt;
        paramView.setTag(localObject2);
      }
      if (i != 0) {
