...
public class bctg
  implements bcsi
{
  private adbd<Integer, bctr> a = new adbe();
    ...
    for (;;)
    {
      try
      {
        ...
        if (localMsgBody.uint32_anchor_status.get() == 1)
        {
          ...
          paramArrayOfByte.senderuin = String.valueOf(antf.g + l1);
          paramArrayOfByte.frienduin = String.valueOf(antf.g + l1);
          ...
          bdll.b(null, "dc00899", "grp_lbs", "", "msg_box", "view_live_message", 0, 0, "", "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Submsgtype0x8a.ReqBody paramReqBody, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        if (!paramBoolean)
        {
          paramQQAppInterface.a().a((ArrayList)localObject3, false);
          return;
        }
        if (QLog.isColorLevel()) {
    ...
    } while (localbdxc == null);
    List localList = localbdxc.a(str1);
    paramReqBody = null;
    localObject1 = null;
    localObject2 = "";
    ...
    for (;;)
    {
      ...
      localObject3 = anzj.a(2131705547);
      localObject4 = (SubAccountMessage)((SubAccountMessage)localObject1).deepCopyByReflect();
      ((SubAccountMessage)localObject4).msg = ((String)localObject3).concat(BaseApplicationImpl.getApplication().getString(2131693868));
      ...
      ((SubAccountMessage)localObject4).mTimeString = bhsw.a(((SubAccountMessage)localObject4).time * 1000L, true, bdwt.jdField_a_of_type_JavaLangString);
      ((SubAccountMessage)localObject4).mEmoRecentMsg = new begp(((SubAccountMessage)localObject4).msg, 0);
      if (localbdxc != null) {
        localbdxc.b((SubAccountMessage)localObject4);
      }
      bdwt.a(paramQQAppInterface, str1, 6);
  ...
  protected void a()
  {
    this.a.a(Integer.valueOf(0), bctd.class);
    this.a.a(Integer.valueOf(38), bctu.class);
    this.a.a(Integer.valueOf(48), bctp.class);
    this.a.a(Integer.valueOf(61), bctq.class);
    this.a.a(Integer.valueOf(63), bctk.class);
    this.a.a(Integer.valueOf(78), bcts.class);
    this.a.a(Integer.valueOf(81), bcte.class);
    this.a.a(Integer.valueOf(102), bctj.class);
    this.a.a(Integer.valueOf(103), bcth.class);
    this.a.a(Integer.valueOf(107), bcti.class);
    this.a.a(Integer.valueOf(110), bctm.class);
    this.a.a(Integer.valueOf(111), bctv.class);
    this.a.a(Integer.valueOf(114), bctl.class);
    this.a.a(Integer.valueOf(118), bctc.class);
    this.a.a(Integer.valueOf(124), bcto.class);
    this.a.a(Integer.valueOf(177), bctt.class);
    this.a.a(Integer.valueOf(296), bctf.class);
    this.a.a(Integer.valueOf(311), bctf.class);
    this.a.a(Integer.valueOf(314), bctn.class);
  }
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bcre parambcre)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          do
          {
            for (;;)
            {
              ...
              if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has()))
              {
                ...
                Object localObject2 = (bctr)this.a.a(Integer.valueOf(i));
                if (localObject2 != null)
                {
                  if (QLog.isColorLevel()) {
                    QLog.d("MsgType0x210Decoder", 2, "subType=" + i + ", decoder=" + localObject2);
                  }
                  ((bctr)localObject2).a((msg_comm.MsgType0x210)localObject1, paramMsg, paramList, parambcre, paramMessageHandler);
                }
                switch (i)
                {
                default: 
                ...
                case 141: 
                  try
                  {
                    ...
                    if (paramList.rpt_msg_msg_notify.has()) {
                      ajji.a(paramMessageHandler.app, paramList);
                    }
                ...
                case 170: 
                  ...
                  {
                    paramList.mergeFrom(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
                    ((avoj)paramMessageHandler.app.getManager(156)).a(paramList, true);
                    bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
                    return;
                  }
                ...
                case 179: 
                  ...
                  paramMsg = adfp.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
                  if (!TextUtils.isEmpty(paramMsg))
                  {
                    bool = ((anyw)paramMessageHandler.app.getManager(51)).b(paramMsg);
                    if (QLog.isColorLevel()) {
                ...
                case 197: 
                  ...
                  adfv.a((adan)paramMessageHandler.a("businessbase_processor"), ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
                  bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
                  return;
                case 238: 
                  if (QLog.isColorLevel()) {
                  ...
                  adgq.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
                  bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
                  return;
                case 249: 
                  paramList = (adan)paramMessageHandler.a("businessbase_processor");
                  ...
                  adgt.a(paramList.a(), ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray(), 2, parambcre);
                  bcrw.a(paramMessageHandler, parambcre.lFromUin, parambcre.shMsgSeq, parambcre.lMsgUid, parambcre.shMsgType);
                  return;
                case 258: 
                  if (QLog.isColorLevel()) {
                ...
                case 253: 
                  ...
                  parambcre.lMsgUid = paramMsg.msg_head.msg_uid.get();
                  parambcre.shMsgType = ((short)paramMsg.msg_head.msg_type.get());
                  adgv.a(paramList.a(), ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray(), 2);
                  bcrw.a(paramMessageHandler, parambcre.lFromUin, parambcre.shMsgSeq, parambcre.lMsgUid, parambcre.shMsgType);
                  return;
                case 199: 
                  if (QLog.isColorLevel()) {
                  ...
                  paramMsg = new aotc(l1, i, l2, j, k, false);
                  ((adan)paramMessageHandler.a("businessbase_processor")).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray(), paramMsg);
                  bcrw.a(paramMessageHandler, l1, i, l2, j);
                  return;
                case 203: 
                  if (QLog.isColorLevel()) {
                  ...
                  if ((paramList != null) && (!aoci.a(paramMessageHandler.app, paramList, true)) && (paramList.msgtype == -2053))
                  {
                    ...
                    else
                    {
                      ...
                      parambcre = paramMessageHandler.app.a().a(paramMsg.frienduin, paramMsg.istroop);
                      if (parambcre != null)
                      {
                        paramMessageHandler.app.a().a(paramMsg.frienduin, paramMsg.istroop, parambcre.uniseq, paramMsg.msgData);
                ...
                case 220: 
                  ...
                  paramList = (amsx)paramMessageHandler.app.getManager(153);
                  if (paramList != null) {
                ...
                case 232: 
                  ...
                  try
                  {
                    ...
                    if (paramMsg.msg_item.has())
                    {
                      ...
                      {
                        paramMessageHandler = (amts)paramMessageHandler.app.getManager(227);
            ...
            paramMessageHandler = (wiz)paramMessageHandler.app.getManager(253);
            ...
            try
            {
              ...
              while (paramList.hasNext())
              {
                ...
                if (paramMessageHandler.app != null) {
                  ((ayvj)paramMessageHandler.app.getManager(266)).b(parambcre);
                }
                if (QLog.isColorLevel()) {
            ...
            try
            {
              ...
              aobl.a(paramMessageHandler.app, paramList);
              bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
              return;
            }
            catch (Exception paramMessageHandler)
            ...
            {
              paramList = ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray();
              parambcre = (FriendListHandler)paramMessageHandler.app.a(1);
              if (parambcre != null) {
            ...
            paramList = ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray();
            awmj.a(paramMessageHandler.app, paramList, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
            bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
            return;
            if (QLog.isColorLevel()) {
            ...
            paramList = ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray();
            parambcre = ((bejx)paramMessageHandler.app.getManager(339)).a(4);
            if (parambcre != null) {
          ...
          paramList = asag.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray(), paramMsg);
          paramMessageHandler.app.a().a(paramList, paramMessageHandler.app.getCurrentAccountUin());
          bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
          if (QLog.isColorLevel()) {
      ...
      paramList = asbk.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a(paramList, paramMessageHandler.app.getCurrentAccountUin());
      bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
    } while (!QLog.isColorLevel());
    ...
    try
    {
      ...
      if (!becb.a(paramMsg.msg_head.msg_seq.get()))
      {
        becb.a(paramMessageHandler.app, parambcre);
    ...
    {
      avpe.a(paramMessageHandler, paramList, parambcre, bool);
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    {
      paramList = ((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray();
      parambcre = (ajfp)paramMessageHandler.app.a(169);
      if (parambcre != null) {
        parambcre.a(paramList);
      }
      bcrw.a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
