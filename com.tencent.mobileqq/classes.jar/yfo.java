  ...
  extends yfm
{
  ...
  public void a(Canvas paramCanvas, yfn paramyfn, float paramFloat)
  {
    if (paramyfn.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (paramyfn.jdField_a_of_type_Int == 104)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(45.0F);
        this.jdField_a_of_type_AndroidGraphicsPaint.setShader(this.jdField_a_of_type_AndroidGraphicsBitmapShader);
        paramCanvas.drawPath(paramyfn.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (paramyfn.jdField_a_of_type_Int != 105);
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(paramyfn.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
  ...
  public void a(ycm paramycm, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
  ...
  public void a(yfn paramyfn)
  {
    if (paramyfn.jdField_a_of_type_Int == 103)
    {
      DoodleLayout.a("delete_mosaics");
      xwb.a("0X80076C2");
      List localList = paramyfn.jdField_a_of_type_JavaUtilList;
      paramyfn = paramyfn.b;
      int k = 0;
      while ((k < localList.size()) && (k < paramyfn.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)paramyfn.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Yfn = new yfn(new Path(), this.g);
      if (this.jdField_a_of_type_Yfi != null) {
        this.jdField_a_of_type_Yfi.a(this.jdField_a_of_type_Yfn);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Yfn.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Yfn.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Yfn.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Yfn.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Yfn.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Yfn.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Yfn.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Yfn.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Yfn.b.get(this.jdField_a_of_type_Yfn.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Yfn.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Yfn.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        ...
        {
          this.jdField_a_of_type_Yfn.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, (this.jdField_d_of_type_Float + f1) / 2.0F, (this.jdField_e_of_type_Float + f2) / 2.0F);
          this.jdField_d_of_type_Float = f1;
          this.jdField_e_of_type_Float = f2;
        }
        else if (this.g == 105)
    ...
    for (int k = 2;; k = 8) {
      for (;;)
      {
        try
        {
          ...
          xvv.a("MosaicOperator", "init matrix. scale[%f, %f]. translate[%f, %f].", Float.valueOf(f1), Float.valueOf(f1), Float.valueOf(f2), Float.valueOf(f3));
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Ycm != null)
    {
      ...
      this.jdField_a_of_type_Ycm.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Ycm.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Yfn = null;
    if (this.g == 104) {
      return;
    }
    if (this.g == 105)
