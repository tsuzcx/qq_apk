...
public class beow
{
  ...
  public beow(QQAppInterface paramQQAppInterface, PinnedFooterExpandableListView paramPinnedFooterExpandableListView, beoy parambeoy)
  {
    ...
    this.jdField_a_of_type_Beos = new beos(paramQQAppInterface);
  }
  ...
  private void e()
  {
    ...
    if (localberf != null)
    {
      ArrayList localArrayList1 = this.jdField_a_of_type_Beoy.a();
      if (localArrayList1 != null)
      {
        ...
        localberf.a(localArrayList2, new beox(this));
      }
    }
  }
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramContext).inflate(2131560403, paramViewGroup, false);
      paramViewGroup = new beoa();
      paramViewGroup.c = ((ImageView)paramView.findViewById(2131368138));
    ...
    {
      paramContext = aoch.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramRelationTroopEntity.troopInfo.troopuin, 3, aoch.a(4, 3), aoch.a(4, 3));
  ...
  public void a()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_exp", a(), 0, "", "", "", "");
  }
  ...
  public void a(ArrayList<Groups> paramArrayList, SparseArray<ArrayList<Entity>> paramSparseArray)
  {
    ...
    if (!this.b.isEmpty())
    {
      ...
      ((Groups)localObject2).group_name = anni.a(2131717301);
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      ((Groups)localObject1).group_name = anni.a(2131717300);
  ...
  public View b(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    ...
    for (paramInt1 = 4;; paramInt1 = 113)
    {
      ...
      paramViewGroup.d.setText(paramContext);
      return paramView;
      paramViewGroup = (alto)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      break;
    }
  }
  ...
  public void b()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_clk", a(), 0, "", "", "", "");
  }
  
  public void c()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_exp", a(), 0, "", "", "", "");
  }
  
  public void d()
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_clk", a(), 0, "", "", "", "");
  }
}
