  ...
  extends amng
{
  ...
  public amnh(amni paramamni)
  {
    this.jdField_a_of_type_Amni = paramamni;
  }
  
  public amnh(amni paramamni, QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Amni = paramamni;
  ...
  private void a(boolean paramBoolean, Object paramObject)
  {
    ...
    while (4 != this.jdField_a_of_type_Amni.a()) {
      return;
    }
    this.jdField_a_of_type_Amni.a(paramBoolean, paramObject);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Amni.a(localRspBody);
        this.jdField_a_of_type_Amni.b(paramBoolean, paramObject);
        a();
        return;
      }
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        ...
        this.jdField_a_of_type_Amni.b(paramObject);
        continue;
      }
  ...
  private void b(boolean paramBoolean, Object paramObject)
  {
    ...
    while (5 != this.jdField_a_of_type_Amni.a()) {
      return;
    }
    this.jdField_a_of_type_Amni.a(paramBoolean, paramObject);
    if (QLog.isColorLevel()) {
  ...
  private void c(boolean paramBoolean, Object paramObject)
  {
    ...
    while (7 != this.jdField_a_of_type_Amni.a()) {
      return;
    }
    this.jdField_a_of_type_Amni.a(paramBoolean, paramObject);
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean) {
      this.jdField_a_of_type_Amni.a(paramObject);
    }
    for (;;)
    {
      this.jdField_a_of_type_Amni.b(paramBoolean, paramObject);
