  ...
  extends SSLSocketFactory
{
  ...
  public bean(SSLSocketFactory paramSSLSocketFactory)
  {
  ...
  private Socket a(Socket paramSocket)
  {
    ...
    {
      paramSocket = new beaq(this, (SSLSocket)paramSocket, null);
      ((beaq)paramSocket).setEnabledProtocols(new String[] { "TLSv1.1", "TLSv1.2" });
      return paramSocket;
    }
    return paramSocket;
  }
