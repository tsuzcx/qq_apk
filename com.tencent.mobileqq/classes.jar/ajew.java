  ...
  implements ajfj
{
  ...
  private CopyOnWriteArrayList<WeakReference<ajfl>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList;
  
  public ajew(ajez paramajez, ajfm paramajfm, ajfa paramajfa)
  {
  ...
  private String a()
  {
    ...
    return this.jdField_a_of_type_Ajfa.a(localSpriteTaskParam);
  }
  ...
  private String a(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_Ajfa.a(paramSpriteTaskParam);
      localObject = str;
  ...
  {
    boolean bool2;
    if ((this.jdField_a_of_type_Ajez == null) || (this.jdField_a_of_type_Ajez.b == null))
    {
      bool2 = false;
      return bool2;
    }
    Object localObject1 = (QQAppInterface)this.jdField_a_of_type_Ajez.b.get();
  ...
  private boolean a(int paramInt1, int paramInt2)
  {
    ...
    return ((ajfe)this.jdField_a_of_type_Ajez.a().getManager(249)).a().a(paramInt1, paramInt2) != null;
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ajfl localajfl = (ajfl)((WeakReference)localIterator.next()).get();
        if (localajfl != null) {
          localajfl.a(paramInt);
        }
      }
    }
  }
  ...
  public void a(int paramInt, MessageForApollo paramMessageForApollo)
  {
    ...
    if ((paramMessageForApollo == null) || (this.jdField_a_of_type_Ajez == null) || (this.jdField_a_of_type_Ajfm == null)) {
      break label48;
    }
    label48:
    while (!ajfh.b(this.jdField_a_of_type_Ajez.a(), paramMessageForApollo.istroop, paramMessageForApollo.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
    localSpriteTaskParam.f = ApolloUtil.a(this.jdField_a_of_type_Ajez.a(), paramMessageForApollo);
    localSpriteTaskParam.jdField_c_of_type_Int = ApolloUtil.b(this.jdField_a_of_type_Ajez.a(), paramMessageForApollo);
    ...
    for (;;)
    {
      ...
      ajfh.a(this.jdField_a_of_type_Ajez.a(), localSpriteTaskParam);
      return;
  ...
  public void a(ajez paramajez)
  {
    ...
    if ((this.jdField_a_of_type_Ajfa == null) || (paramajez == null) || (!paramajez.c())) {
      ajlo.a(i, 300, 160, new Object[] { "glview is not ready" });
    }
    String str;
    ajeq localajeq;
    do
    {
      ...
      while (TextUtils.isEmpty(str))
      {
        ajlo.a(i, 300, 301, new Object[] { "spriteJs is empty" });
        return;
        str = this.jdField_a_of_type_JavaLangString;
        QLog.d("CmShowStatUtil", 1, "spriteJs from cache");
        this.jdField_a_of_type_JavaLangString = null;
      }
      localajeq = ajfh.a(paramajez.a());
    ...
    ThreadManager.executeOnSubThread(new SpriteBridge.2(this, localajeq, paramajez));
  }
  ...
  public void a(ajfl paramajfl)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramajfl));
  }
  ...
  {
    if ((paramChatMessage == null) || (this.jdField_a_of_type_Ajez == null) || (this.jdField_a_of_type_Ajfm == null)) {}
    while (!ajfh.b(this.jdField_a_of_type_Ajez.a(), paramChatMessage.istroop, paramChatMessage.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
    localSpriteTaskParam.f = paramInt;
    ApolloActionData localApolloActionData = ajfh.a(this.jdField_a_of_type_Ajez.a(), paramInt);
  ...
  public void a(ChatMessage paramChatMessage, ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    if ((paramChatMessage == null) || (this.jdField_a_of_type_Ajez == null) || (this.jdField_a_of_type_Ajfm == null) || (paramArrayList1 == null) || (paramArrayList1.size() == 0)) {}
    while (!ajfh.b(this.jdField_a_of_type_Ajez.a(), paramChatMessage.istroop, paramChatMessage.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
  ...
  public void a(MessageForApollo paramMessageForApollo)
  {
    ...
    try
    {
      ...
      if (paramMessageForApollo.mApolloMessage.name != null) {
        ((JSONObject)localObject).put("name", ajfh.a(bbco.encodeToString(paramMessageForApollo.mApolloMessage.name, 0)));
      }
      if (paramMessageForApollo.mApolloMessage.text != null) {
        ((JSONObject)localObject).put("atText", ajfh.a(bbco.encodeToString(paramMessageForApollo.mApolloMessage.text, 0)));
      }
      ...
      paramMessageForApollo = ajfh.a(this.jdField_a_of_type_Ajez.a());
  ...
  {
    if ((paramList == null) || (paramList.size() == 0) || (this.jdField_a_of_type_Ajfa == null) || (this.jdField_a_of_type_Ajez == null) || (!this.jdField_a_of_type_Ajez.c())) {}
    do
    {
      return;
      localObject = ((ajfe)this.jdField_a_of_type_Ajez.a().getManager(249)).a();
    } while (localObject == null);
    Object localObject = ((ajfd)localObject).a(0);
    if (localObject == null)
    {
    ...
    while (paramList.hasNext())
    {
      ...
      try
      {
        ...
        ((ajer)localObject).a(localSpriteTaskParam.jdField_a_of_type_JavaLangString, false);
      }
    ...
    ((ajer)localObject).a(paramList.toString());
  }
  ...
  public void b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    {
      return;
      if ((paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList != null) && (paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList.size() > 0) && (!this.jdField_a_of_type_Ajez.e()))
      {
      ...
      localObject2 = this.jdField_a_of_type_Ajfa.a(paramSpriteTaskParam);
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        paramSpriteTaskParam.jdField_b_of_type_Int = 4;
        return;
      }
      localObject1 = (ajfe)this.jdField_a_of_type_Ajez.a().getManager(249);
      localObject3 = ((ajfe)localObject1).a();
    } while (localObject3 == null);
    Object localObject3 = ((ajfd)localObject3).a(paramSpriteTaskParam.jdField_c_of_type_Int);
    ...
    ((ajer)localObject3).a(localStringBuilder.toString());
    ((ajer)localObject3).a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, false);
    ((ajer)localObject3).a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, false);
    Object localObject2 = this.jdField_a_of_type_Ajez.a();
    if (!TextUtils.isEmpty(paramSpriteTaskParam.jdField_c_of_type_JavaLangString)) {}
    for (;;)
    {
      ajki.a((QQAppInterface)localObject2, paramSpriteTaskParam, bool, paramSpriteTaskParam.jdField_b_of_type_Boolean);
      localObject1 = ((ajfe)localObject1).a();
      if ((localObject1 == null) || (ajfh.a(this.jdField_a_of_type_Ajez.a()))) {
        break;
      }
      ...
      ((ajev)localObject1).a(paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList);
      return;
      bool = false;
    }
    label372:
