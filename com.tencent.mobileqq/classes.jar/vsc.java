  ...
  extends vrw
{
  ...
  private vzj a(RecyclerView.ViewHolder paramViewHolder)
  {
    if (paramViewHolder != null)
    {
      if (((paramViewHolder.itemView instanceof QCircleInsFeedItemView)) && (((QCircleInsFeedItemView)paramViewHolder.itemView).a() != null)) {
    ...
    if (paramFrameLayout != null) {
      while ((paramFrameLayout.getChildAt(0) instanceof QCircleFeedCleanPlayView))
      {
        ...
        if (((QCircleFeedCleanPlayView)localView).b())
        {
          ...
          vrc.a(8, 5, a(paramString), this.jdField_b_of_type_Int);
        }
  ...
  private void a(ImageView paramImageView)
  {
    ...
    label20:
    for (int i = 2130843923;; i = 2130843924)
    {
  ...
  private void a(vzj paramvzj, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView != null)
    {
      ...
      {
        a(paramString1, "vid");
        localObject = paramvzj.jdField_a_of_type_AndroidWidgetFrameLayout;
        FeedCloudMeta.StFeed localStFeed = paramvzj.a();
        if ((TextUtils.isEmpty(paramString1)) || (localObject == null) || (localStFeed == null)) {
          break;
        }
        a((FrameLayout)localObject, paramString2, a(paramString2));
        QCircleFeedCleanPlayView localQCircleFeedCleanPlayView = new QCircleFeedCleanPlayView(this.jdField_a_of_type_AndroidContentContext, paramvzj.a());
        localQCircleFeedCleanPlayView.setReportBean(new QCircleReportBean().setPageId(this.jdField_b_of_type_Int));
        localQCircleFeedCleanPlayView.setVideoCover(paramvzj.jdField_a_of_type_ComTencentImageURLImageView);
        ...
        localQCircleFeedCleanPlayView.setBaseVideoViewListenerSets(new vsd(this, paramvzj, localQCircleFeedCleanPlayView, paramString2, paramString1));
  ...
  private void a(vzj paramvzj, boolean paramBoolean)
  {
    int j = 8;
    if (paramvzj != null)
    {
      if (paramvzj.jdField_a_of_type_AndroidWidgetImageView != null)
      {
        if ((!paramBoolean) || (!a(paramvzj))) {
          break label85;
        }
        paramvzj.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramvzj.jdField_a_of_type_ComTencentImageURLImageView != null)
      {
        URLImageView localURLImageView = paramvzj.jdField_a_of_type_ComTencentImageURLImageView;
        if (!paramBoolean) {
          break label97;
        }
        i = 0;
        label54:
        localURLImageView.setVisibility(i);
      }
      if (paramvzj.b != null)
      {
        paramvzj = paramvzj.b;
    ...
    for (int i = j;; i = 0)
    {
      paramvzj.setVisibility(i);
      return;
      paramvzj.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break;
      i = 8;
      break label54;
    }
  ...
  private boolean a(String paramString)
  {
    ...
    {
      int i = uxc.a(paramString).intValue();
      if ((i == 2) || (i == 5))
      {
  ...
  private boolean a(vzj paramvzj)
  {
    if ((paramvzj instanceof waj)) {
      if (QzoneConfig.isQQCircleAutoPlay()) {}
    }
    while (!(paramvzj instanceof wam))
    {
      return true;
      return false;
    }
        ...
        if (a((View)localObject))
        {
          ...
          if ((localObject instanceof QCircleFeedCleanPlayView))
          {
            ...
            if (((QCircleFeedCleanPlayView)localObject).c())
            {
              ...
              vrc.a(8, 4, a(localStFeed.id.get()), this.jdField_b_of_type_Int);
            }
          }
          for (;;)
          {
  ...
  private void h()
  {
    zyj localzyj = (zyj)this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager();
    Object localObject = localzyj.findFirstVisibleItemPositions(null);
    int[] arrayOfInt = localzyj.findLastVisibleItemPositions(null);
    int i = localObject[0];
    int j = arrayOfInt[0];
    ...
    for (;;)
    {
      if (i <= j)
      {
        localObject = localzyj.findViewByPosition(i);
  ...
  {
    int j = 1;
    zyh localzyh = (zyh)this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager();
    if (localzyh.getSpanCount() > 1) {
      QLog.e("QCircleFeedPlayerHelper", 1, "unSupportSpanCount:" + localzyh.getSpanCount());
    }
    label277:
    for (;;)
    {
      return;
      int i = localzyh.findFirstCompletelyVisibleItemPosition();
      int k = localzyh.findLastCompletelyVisibleItemPosition();
      ...
      if (i <= k)
      {
        ...
        if (i <= k)
        {
          View localView = localzyh.findViewByPosition(i);
          if (d(localView))
          {
        ...
        for (i = j;; i = 0)
        {
          ...
          if ((i == 0) && (c(localzyh.findViewByPosition(i))))
          {
            this.jdField_d_of_type_Int = i;
            return;
            i += 1;
          ...
          if (!c(localzyh.findViewByPosition(i))) {
            break;
          }
          this.jdField_d_of_type_Int = i;
          return;
  ...
  private void j()
  {
    ...
    int i = localzyi.findFirstVisibleItemPosition();
    int j = localzyi.findLastVisibleItemPosition();
    QLog.d("QCircleFeedPlayerHelper", 4, i + "  " + j);
    if (i <= j) {}
    for (;;)
    {
      if (i <= j)
      {
        View localView = localzyi.findViewByPosition(i);
  ...
  public void a(FeedCloudMeta.StFeed paramStFeed, ImageView paramImageView, int paramInt)
  {
    ...
    if (paramStFeed != null)
    {
      ...
      if (localObject != null)
      {
        ...
        localArrayList.add(vri.a("ext2", paramStFeed.recomInfo.recomReason.get()));
        if (!a(1)) {
          break label164;
        }
        localObject = "1";
        label97:
        localArrayList.add(vri.a("ext4", (String)localObject));
    ...
    for (int i = 9;; i = 8)
    {
      vrc.a((String)localObject, 8, i, paramInt, paramStFeed, localArrayList, this.jdField_b_of_type_Int);
      a(paramImageView);
      return;
      bool = false;
      break;
  ...
  public void a(waj paramwaj, FeedCloudMeta.StFeed paramStFeed)
  {
    if (paramStFeed != null)
    {
      String str = paramStFeed.video.playUrl.get();
      if (!TextUtils.isEmpty(str)) {
        a(paramwaj, str, a(paramStFeed));
      }
    }
  }
  ...
  public void b()
  {
    ...
    for (localObject = (Long)this.jdField_a_of_type_JavaUtilHashMap.get(localObject);; localObject = null)
    {
      ...
      vrc.a(8, 4, a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_Int);
  ...
  public void c()
  {
    ...
    if (localObject != null)
    {
      ...
      if (((localObject instanceof QCircleFeedCleanPlayView)) && (((QCircleFeedCleanPlayView)localObject).b()))
      {
        ...
        vrc.a(8, 5, a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_Int);
        QLog.d("QCircleFeedPlayerHelper", 4, "onResume play video position:" + localViewHolder.getAdapterPosition());
      }
    }
  }
