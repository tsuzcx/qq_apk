  ...
  extends aafe
{
  ...
  public bbkj(AppInterface paramAppInterface)
  {
  ...
  public static ReqSummaryCard a(ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        localObject4 = new SSummaryCardQueryReq(1, Long.parseLong(paramToServiceMsg.getUin()), l2, "8.4.8", k, 109L);
        ...
        try
        {
          ...
          if ((l2 > 0L) || (bool))
          {
            ...
            if (((Iterator)localObject3).hasNext())
            {
              ...
              ((SummaryCardBusiEntry.comm)localObject8).qqver.set("8.4.8.4810");
  ...
  public static ArrayList<ahzl> a(ArrayList<byte[]> paramArrayList)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject2 = new ahzl();
            ((ahzl)localObject2).jdField_a_of_type_Int = n;
            ((ahzl)localObject2).jdField_b_of_type_Int = ((AccountSearchPb.search)localObject1).start.get();
            if (((AccountSearchPb.search)localObject1).end.get() != 1) {
              break label509;
            }
            bool = true;
            ((ahzl)localObject2).jdField_a_of_type_Boolean = bool;
            ((ahzl)localObject2).jdField_b_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).list.get();
            ((ahzl)localObject2).jdField_a_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).highlight.get();
            ((ahzl)localObject2).jdField_a_of_type_JavaLangString = ((AccountSearchPb.search)localObject1).article_more_url.get();
            ((ahzl)localObject2).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord = ((AccountSearchPb.hotwordrecord)((AccountSearchPb.search)localObject1).hotword_record.get());
            ((ahzl)localObject2).jdField_c_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).result_items.get();
            ((ahzl)localObject2).jdField_b_of_type_Boolean = ((AccountSearchPb.search)localObject1).bool_keyword_suicide.get();
            ((ahzl)localObject2).jdField_c_of_type_Boolean = ((AccountSearchPb.search)localObject1).bool_exact_search.get();
            if (((((ahzl)localObject2).jdField_b_of_type_JavaUtilList == null) || (((ahzl)localObject2).jdField_b_of_type_JavaUtilList.size() <= 0)) && ((((ahzl)localObject2).jdField_c_of_type_JavaUtilList == null) || (((ahzl)localObject2).jdField_c_of_type_JavaUtilList.size() <= 0)) && (!((ahzl)localObject2).jdField_b_of_type_Boolean)) {
              break;
            }
    ...
    for (int j = 1;; j = 2)
    {
      ((ahzl)localObject2).jdField_c_of_type_Int = j;
      break;
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.vClientVersion = "8.4.8".getBytes();
  ...
  private Object i(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.vUserList != null) && (!paramFromServiceMsg.vUserList.isEmpty()))
    {
      ...
      while (i < paramFromServiceMsg.vUserList.size())
      {
        ...
        String str1 = ampm.a(paramToServiceMsg.dwCountry);
        String str2 = ampm.a(paramToServiceMsg.dwProvince);
        String str3 = ampm.a(paramToServiceMsg.dwCity);
        paramToServiceMsg.locDesc = ((ampm)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(59)).b(new String[] { str1, str2, str3, "0" });
        i += 1;
      }
    }
    return paramFromServiceMsg;
  ...
  private boolean l(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localSSummaryCardSetLabel.version = "8.4.8";
  ...
  private boolean m(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    try
    {
      ...
      localSSummaryCardLikeIt.version = "8.4.8";
      paramUniPacket.setServantName("SummaryCard");
      ...
      if (m == 3)
      {
        ...
        try
        {
          ...
          for (;;)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject3).qqver.set("8.4.8.4810");
  ...
  private boolean u(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    {
      localByteBuffer.putInt(ampm.a(localObject3[0]));
      localByteBuffer.putInt(ampm.a(localObject3[1]));
      localByteBuffer.putInt(ampm.a(localObject3[2]));
      localByteBuffer.putInt(ampm.a(localObject3[3]));
      localObject3 = ByteBuffer.allocate(16);
      if ((localObject2 == null) || (localObject2.length != 4)) {
        break label485;
      }
      ((ByteBuffer)localObject3).putInt(ampm.a(localObject2[0]));
      ((ByteBuffer)localObject3).putInt(ampm.a(localObject2[1]));
      ((ByteBuffer)localObject3).putInt(ampm.a(localObject2[2]));
      ((ByteBuffer)localObject3).putInt(ampm.a(localObject2[3]));
    }
    for (;;)
    {
      short s2 = (short)k;
