...
public class bbkj
{
  private static bbkj a;
  private static final HashMap<String, Integer> b = new HashMap();
  protected HashMap<String, bbkk> a;
  protected JSONArray a;
  protected JSONObject a;
  
  static
  {
    b.put("10009", Integer.valueOf(2130843265));
    b.put("10010", Integer.valueOf(2130843266));
    b.put("10011", Integer.valueOf(2130843267));
    b.put("24", Integer.valueOf(2130843268));
    b.put("25", Integer.valueOf(2130843269));
    b.put("26", Integer.valueOf(2130843270));
    b.put("27", Integer.valueOf(2130843271));
    b.put("28", Integer.valueOf(2130843272));
    b.put("29", Integer.valueOf(2130843273));
    b.put("30", Integer.valueOf(2130843274));
    b.put("31", Integer.valueOf(2130843275));
    b.put("32", Integer.valueOf(2130843276));
    b.put("20001", Integer.valueOf(2130843185));
    b.put("20002", Integer.valueOf(2130843186));
    b.put("20003", Integer.valueOf(2130846413));
  }
  ...
  public static bbkj a()
  {
    if (jdField_a_of_type_Bbkj == null) {}
    try
    {
      if (jdField_a_of_type_Bbkj == null) {
        jdField_a_of_type_Bbkj = new bbkj();
      }
      return jdField_a_of_type_Bbkj;
    }
    finally {}
  }
  
  public bbkk a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (bbkk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if ((paramBoolean) && ((((bbkk)localObject2).jdField_a_of_type_JavaUtilArrayList == null) || (((bbkk)localObject2).jdField_a_of_type_JavaUtilArrayList.isEmpty()))) {
          break;
        }
        return localObject2;
      }
      Object localObject2 = this.jdField_a_of_type_OrgJsonJSONObject.optJSONArray(paramString);
      bbkk localbbkk = new bbkk();
      localbbkk.a(paramString);
      localbbkk.d = ((String)localObject1);
      localbbkk.jdField_b_of_type_Int = i;
      localbbkk.jdField_b_of_type_JavaLangString = ((JSONArray)localObject2).optString(0);
      int j = ((JSONArray)localObject2).length();
      if (j > 1)
      {
        localbbkk.jdField_a_of_type_Boolean = true;
        if (paramBoolean)
        {
          localbbkk.jdField_a_of_type_JavaUtilArrayList = new ArrayList(j);
          ...
          if (i < j)
          {
            ...
            for (;;)
            {
              i += 1;
              break;
              localObject3 = new bbkk((String)localObject3, localJSONArray.optString(0));
              ((bbkk)localObject3).d = paramString;
              localbbkk.jdField_a_of_type_JavaUtilArrayList.add(localObject3);
              if (i <= 2)
              {
                if (i != 1) {
                  ((StringBuilder)localObject1).append("、");
                }
                ((StringBuilder)localObject1).append(((bbkk)localObject3).jdField_b_of_type_JavaLangString);
              }
            }
          }
          localbbkk.c = ((StringBuilder)localObject1).toString();
        }
      }
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localbbkk);
      return localbbkk;
      localObject1 = null;
    }
  }
  ...
  public ArrayList<bbkk> a()
  {
    ...
    while (i < k)
    {
      ...
      bbkk localbbkk1 = new bbkk();
      localbbkk1.jdField_b_of_type_Int = 2;
      localbbkk1.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("title");
      localArrayList.add(localbbkk1);
      localbbkk1.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      localObject = ((JSONObject)localObject).optJSONArray("cates");
      int m = ((JSONArray)localObject).length();
      int j = 0;
      if (j < m)
      {
        bbkk localbbkk2 = a(((JSONArray)localObject).optString(j), true);
        if (localbbkk2 == null) {}
        for (;;)
        {
          j += 1;
          break;
          localbbkk1.jdField_a_of_type_JavaUtilArrayList.add(localbbkk2);
        }
      }
      i += 1;
    }
