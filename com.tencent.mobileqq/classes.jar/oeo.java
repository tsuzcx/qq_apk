...
class oeo
  implements swm
{
  oeo(oen paramoen, long paramLong, PublishVideoEntry paramPublishVideoEntry) {}
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    if (paramInt == 0)
    {
      oen.a(this.jdField_a_of_type_Oen, this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry, paramString2);
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    oen.a(this.jdField_a_of_type_Oen, this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry, paramInt, paramString1);
  }
}
