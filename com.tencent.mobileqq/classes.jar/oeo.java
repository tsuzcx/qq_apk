  ...
  implements Handler.Callback, awsb, Manager
{
  ...
  public oeo(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (baig.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramMessage = (ReadInJoyActivityDAUInfo)this.jdField_a_of_type_Atmp.a(ReadInJoyActivityDAUInfo.class, (String)localObject3);
        if (paramMessage != null) {
          continue;
        }
