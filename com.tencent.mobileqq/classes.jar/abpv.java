...
{
  public abpv(HotChatFlashPicActivity paramHotChatFlashPicActivity) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      do
      {
        ...
        do
        {
          ...
          HotChatFlashPicActivity.a(this.a).setImageResource(2130840583);
          if (HotChatFlashPicActivity.b(this.a)) {
            HotChatFlashPicActivity.a(this.a).setText(2131438054);
          }
          while (HotChatFlashPicActivity.a(this.a).a())
          {
            HotChatFlashPicActivity.a(this.a).b();
            return false;
            HotChatFlashPicActivity.a(this.a).setText(2131438065);
          }
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            HotChatFlashPicActivity.a(this.a).setImageResource(2130840585);
            if (HotChatFlashPicActivity.b(this.a)) {
              HotChatFlashPicActivity.a(this.a).setText(2131438052);
            }
            while (HotChatFlashPicActivity.a(this.a).a())
            {
              HotChatFlashPicActivity.a(this.a).b();
              return false;
              HotChatFlashPicActivity.a(this.a).setText(2131438063);
            }
          }
          HotChatFlashPicActivity.a(this.a).sendEmptyMessage(1);
          return false;
    ...
    case 4: 
      if (HotChatFlashPicActivity.b(this.a)) {
        if (HotChatFlashPicActivity.a(this.a) >= 2) {
          paramMessage = this.a.getString(2131438056);
        }
      }
      break;
    }
    for (;;)
    {
      HotChatFlashPicActivity.a(this.a, DialogUtil.a(this.a, paramMessage, 0, 2131435252, null, new abpw(this)));
      ...
      return false;
      paramMessage = this.a.getString(2131438055);
      continue;
      if (HotChatFlashPicActivity.a(this.a) == 2)
      {
      ...
      {
        paramMessage = this.a.getString(2131438066);
        localObject = paramMessage;
        if (!HotChatFlashPicActivity.e(this.a))
        {
          if (HotChatFlashPicActivity.b(this.a) == 0)
