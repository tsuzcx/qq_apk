...
public class awvv
{
  ...
  {
    Object localObject = (anap)ampm.a().a(456);
    if (localObject != null) {
      switch (paramInt)
      {
      }
    }
    for (localObject = null;; localObject = ((anap)localObject).a())
    {
  ...
  public static String a(String paramString)
  {
    ...
    return localBaseApplicationImpl.getSharedPreferences("SearchConfigUtils_Switch" + localBaseApplicationImpl.getRuntime().getAccount(), 4).getString(paramString + str, ajyc.a(2131713620));
  }
  ...
  {
    anai localanai = (anai)ampm.a().a(433);
    if (localanai != null) {}
    boolean bool;
    switch (paramInt)
    {
  ...
  {
    anag localanag = (anag)ampm.a().a(434);
    if (localanag != null) {}
    boolean bool;
    switch (paramInt)
    {
  ...
  {
    anap localanap = (anap)ampm.a().a(456);
    if (localanap != null) {
      switch (paramInt)
      {
      }
    }
    for (boolean bool = false;; bool = localanap.a())
    {
      if (QLog.isColorLevel()) {
