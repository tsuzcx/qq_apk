...
public class boha<K extends bogi>
  extends bogy<K>
  implements bogz
{
  protected bogf a;
  
  protected boha(K paramK)
  {
    super(paramK);
  ...
  {
    Resources localResources = ((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources();
    bogf localbogf = b();
    View localView;
    ...
    if (paramView == null)
    {
      localView = ((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getLayoutInflater().inflate(2131561074, null);
      localTextView = (TextView)localView;
      localQQAlbumInfo = localbogf.a(paramInt);
      ...
      if (localbogf.getItemViewType(paramInt) != 1) {
        break label398;
      }
    ...
    for (;;)
    {
      ...
      {
        localObject = beyq.a(paramView, bogf.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, bogf.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
        ((URLDrawable)localObject).setTag(localQQAlbumInfo.mCoverInfo);
        ((URLDrawable)localObject).setBounds(0, 0, localbogf.jdField_a_of_type_Int, localbogf.b);
      }
      ...
      {
        paramView = localbogf.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState.newDrawable(localResources);
  ...
  protected bogf a()
  {
    return new bogf((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get());
  }
  ...
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity() == null)) {
      return null;
    }
    Object localObject;
        ...
        for (i = j;; i = 0)
        {
          ...
          if (paramInt == -1)
          {
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter.showVideo()))
            {
              ...
              paramList1 = ((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getContentResolver().query(paramList1, new String[] { "_id" }, "_size>0 ", null, null);
              i = 0;
              if (paramList1 != null)
              {
              ...
              if (bool)
              {
                ...
                paramList1 = b().a(((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity());
              }
            }
          }
          for (;;)
          {
            ...
            label559:
            bhnn.a("PEAK", "compact.queryRecentBucket");
            return localObject;
  ...
  public void a(int paramInt)
  {
    ...
    {
      bhnn.a();
      localList1 = localbogf.a(((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt);
    ...
    for (;;)
    {
      ...
      {
        bhnn.a();
        localList2 = localbogf.a(((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt, localMediaFileFilter);
      ...
      {
        bhnn.a();
        localList1 = this.jdField_a_of_type_Bogz.a(localList1, localList2, paramInt);
        if (localList1 != null) {
        ...
        {
          return;
          bhnn.a("PEAK", "compact(" + (localList1.size() - 1) + "," + k + ")");
          localbogf.b(localList1);
        } while (paramInt == -1);
        if (i != 0)
        {
          ThreadManager.getFileThreadHandler().post(new AEAlbumListLogicBase.2(this, localbogf));
          return;
        }
        ThreadManager.getFileThreadHandler().post(new AEAlbumListLogicBase.3(this, localbogf, localMediaFileFilter));
        return;
        break;
        localList2 = null;
      }
  ...
  public void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bogf = a();
      ((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogf = this.jdField_a_of_type_Bogf;
  ...
  public boolean a(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    XListView localXListView = ((bogi)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentWidgetXListView;
  ...
  protected bogf b()
  {
    return this.jdField_a_of_type_Bogf;
  }
