...
public final class boha
  implements aaxg
{
  public boha(FrameVideoHelper paramFrameVideoHelper, aaxg paramaaxg) {}
  
  public void a(boolean paramBoolean, ArrayList<FrameVideoHelper.FrameBuffer> paramArrayList, long paramLong)
  {
    bnzb.b("AEEditorMusicHelper", "[extractFrameForSmartMusic], onResult(), isSuccess=" + paramBoolean + ", dataArray=" + paramArrayList + ", frameSize=" + paramLong);
    int i;
    if (this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper != null)
    {
      ...
      {
        i = 0;
        bnzb.a("AEEditorMusicHelper", i + ", size=" + this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper.b() + "KB");
      }
    }
    else if (this.jdField_a_of_type_Aaxg != null)
    {
      if (paramArrayList != null) {
        break label169;
      }
    ...
    {
      this.jdField_a_of_type_Aaxg.a(paramBoolean, paramArrayList, paramLong);
      if (this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper != null) {
