  ...
  extends arac<bpud>
{
  ...
  public bpud a(araj[] paramArrayOfaraj)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QIMDynamicTextConfigProcessor", 2, "handleQIMDynamicTextConfig onParsed, content:" + paramArrayOfaraj);
    }
    return new bpua().a(paramArrayOfaraj, DynamicTextConfigManager.a.getAbsolutePath(), "temp_dynamic_text_zip", new arhg(this));
  }
  ...
  public int migrateOldVersion()
  {
    ...
    return bhsi.a(BaseApplicationImpl.getContext());
  }
