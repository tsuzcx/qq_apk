...
public class azvi
  extends aogx
{
  public azvi(CustomCoverFragment paramCustomCoverFragment) {}
  ...
  public void e(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          QQToast.a(this.a.getActivity(), 1, 2131718978, 0).a();
          return;
        ...
        QQToast.a((Context)localObject, 0, 2131718981, 0).a();
    ...
    if ("profilelogic.readUserInfo".equals(paramObject))
    {
      ...
      this.a.stopTitleProgress();
      QQToast.a((Context)localObject, 1, 2131718695, 0).a();
      return;
    }
    QQToast.a((Context)localObject, 1, 2131718978, 0).a();
  }
}
