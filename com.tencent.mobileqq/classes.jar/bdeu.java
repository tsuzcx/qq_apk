...
public class bdeu
{
  ...
  private bdmk jdField_a_of_type_Bdmk;
  private Map<String, String> jdField_a_of_type_JavaUtilMap;
  
  public static bdeu a()
  {
    return bdev.a();
  }
  ...
  private String a()
  {
    ...
    if (localObject != null) {}
    for (localObject = ((MiniAppProxy)localObject).getAccount(); (this.jdField_a_of_type_Bdmk == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Bdmk.d)); localObject = "") {
      return c;
    }
    if (TextUtils.isEmpty((CharSequence)localObject)) {
      return c + bdyv.c(this.jdField_a_of_type_Bdmk.d) + "/" + bdyv.c((String)localObject);
    }
    return c + bdyv.c(this.jdField_a_of_type_Bdmk.d) + "/" + bdyv.c((String)localObject);
  }
  ...
  private void a()
  {
    bdew.b().post(new MiniAppFileManager.1(this));
  }
  ...
  private static void b()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 158	bdeu:jdField_b_of_type_Boolean	Z
    //   6: istore_0
    //   7: iload_0
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    //   13: monitorexit
    //   14: return
    //   15: new 31	java/io/File
    //   18: dup
    //   19: getstatic 50	bdeu:c	Ljava/lang/String;
    //   22: ldc 160
    //   24: invokespecial 163	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   27: astore_1
    //   28: aload_1
    //   29: invokevirtual 166	java/io/File:getParentFile	()Ljava/io/File;
    //   32: astore_2
    //   33: aload_2
    //   34: ifnull +15 -> 49
    //   37: aload_2
    //   38: invokevirtual 151	java/io/File:exists	()Z
    //   41: ifne +8 -> 49
    //   44: aload_2
    //   45: invokevirtual 154	java/io/File:mkdirs	()Z
    //   48: pop
    //   49: aload_1
    //   50: invokevirtual 151	java/io/File:exists	()Z
    //   53: ifne +8 -> 61
    //   56: aload_1
    //   57: invokevirtual 169	java/io/File:createNewFile	()Z
    //   60: pop
    //   61: iconst_1
    //   62: putstatic 158	bdeu:jdField_b_of_type_Boolean	Z
    //   65: goto -54 -> 11
    //   68: astore_1
    //   69: getstatic 18	bdeu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   72: ldc 171
    //   74: aload_1
    //   75: invokestatic 176	bdnw:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   78: goto -67 -> 11
    //   81: astore_1
    //   82: ldc 2
    //   84: monitorexit
  ...
  public String a(String paramString)
  {
    try
    {
      ...
      {
        paramString = new File(this.jdField_a_of_type_Bdmk.g(str1));
        if ((paramString.exists()) && (paramString.getCanonicalPath().startsWith(new File(this.jdField_a_of_type_Bdmk.e()).getCanonicalPath())))
        {
          paramString = this.jdField_a_of_type_Bdmk.g(str1);
          return paramString;
        }
      }
    }
    ...
    {
      bdnw.d(jdField_a_of_type_JavaLangString, "getAbsolutePath error.", paramString);
      return "";
    }
    label425:
    String str1 = "";
  ...
  public boolean a(String paramString)
  {
    ...
    try
    {
      paramString = new File(this.jdField_a_of_type_Bdmk.g(paramString));
      boolean bool1 = bool2;
      if (paramString.exists())
      {
        boolean bool3 = paramString.getCanonicalPath().startsWith(new File(this.jdField_a_of_type_Bdmk.e()).getCanonicalPath());
        bool1 = bool2;
        if (bool3) {
          bool1 = true;
        }
  ...
  public String b(String paramString)
  {
    ...
    {
      paramString = bdyv.c(new StringBuilder().append(System.nanoTime()).append("").toString()) + paramString;
  ...
  public void b(bdmk parambdmk)
  {
    this.jdField_a_of_type_Bdmk = parambdmk;
    if (this.jdField_a_of_type_JavaUtilMap == null) {
  ...
  public String c(String paramString)
  {
    ...
    {
      bdnw.d(jdField_a_of_type_JavaLangString, "getUsrPath error", paramString);
    }
    return null;
  }
  ...
  public String d(String paramString)
  {
    ...
    if (new File(str).exists())
    {
      ...
      if (bdgo.b(str, new File(a(1), paramString).getAbsolutePath())) {
  ...
  public String f(String paramString)
  {
    ...
    for (str = "";; str = "." + str)
    {
      str = bdyv.c(new StringBuilder().append(System.nanoTime()).append("").toString()) + str;
  ...
  public String h(String paramString)
  {
    ...
    //   6: dup
    //   7: aload_1
    //   8: invokespecial 147	java/io/File:<init>	(Ljava/lang/String;)V
    //   11: astore 4
    //   13: new 31	java/io/File
    //   16: dup
    //   17: aload_0
    //   18: iconst_0
    //   19: invokespecial 113	bdeu:a	(I)Ljava/lang/String;
    //   22: invokespecial 147	java/io/File:<init>	(Ljava/lang/String;)V
    //   25: astore 5
    //   27: aload 4
    //   29: invokevirtual 166	java/io/File:getParentFile	()Ljava/io/File;
    //   32: aload 5
    //   34: invokevirtual 308	java/io/File:equals	(Ljava/lang/Object;)Z
    //   37: ifeq +5 -> 42
    //   40: aload_1
    //   41: areturn
    //   42: new 31	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: aload 4
    //   49: invokestatic 310	bdeu:a	(Ljava/io/File;)Ljava/lang/String;
    //   52: invokevirtual 306	bdeu:b	(Ljava/lang/String;)Ljava/lang/String;
    //   55: invokespecial 147	java/io/File:<init>	(Ljava/lang/String;)V
    //   58: astore 9
    //   60: sipush 8192
    //   63: newarray byte
    //   65: astore 7
    //   67: new 312	java/io/BufferedInputStream
    //   70: dup
    //   71: new 314	java/io/FileInputStream
    //   74: dup
    //   75: aload 4
    //   77: invokespecial 317	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   80: invokespecial 320	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   83: astore 4
    //   85: new 322	java/io/BufferedOutputStream
    //   88: dup
    //   89: new 324	java/io/FileOutputStream
    //   92: dup
    //   93: aload 9
    //   95: invokespecial 325	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   98: invokespecial 328	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   101: astore_1
    //   102: aload_1
    //   103: astore 6
    //   105: aload 4
    ...
    //   109: aload 4
    //   111: aload 7
    //   113: invokevirtual 334	java/io/InputStream:read	([B)I
    //   116: istore_2
    //   117: iload_2
    //   118: iconst_m1
    ...
    //   132: iconst_0
    //   133: iload_2
    //   134: invokevirtual 340	java/io/OutputStream:write	([BII)V
    //   137: goto -35 -> 102
    //   140: astore 7
    //   142: aload_1
    //   143: astore 6
    //   145: aload 4
    //   147: astore 5
    //   149: getstatic 18	bdeu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   152: ldc_w 342
    //   155: aload 7
    //   157: invokestatic 347	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   160: pop
    //   161: aload_1
    //   162: ifnull +7 -> 169
    //   165: aload_1
    //   166: invokevirtual 350	java/io/OutputStream:close	()V
    //   169: aload 4
    //   171: ifnull +154 -> 325
    //   174: aload 4
    //   176: invokevirtual 351	java/io/InputStream:close	()V
    //   179: iconst_0
    //   180: istore_2
    //   181: aload 8
    //   183: astore_1
    ...
    //   185: ifeq +9 -> 194
    //   188: aload 9
    //   190: invokevirtual 226	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   193: astore_1
    //   194: aload_1
    //   195: areturn
    //   196: aload_1
    ...
    //   201: astore 5
    //   203: aload_1
    //   204: invokevirtual 354	java/io/OutputStream:flush	()V
    //   207: iconst_1
    //   208: istore_3
    //   209: aload_1
    //   210: ifnull +7 -> 217
    //   213: aload_1
    //   214: invokevirtual 350	java/io/OutputStream:close	()V
    //   217: iload_3
    //   218: istore_2
    //   219: aload 4
    //   221: ifnull -40 -> 181
    //   224: aload 4
    //   226: invokevirtual 351	java/io/InputStream:close	()V
    //   229: iload_3
    //   230: istore_2
    //   231: goto -50 -> 181
    //   234: astore_1
    ...
    //   255: ifnull +8 -> 263
    //   258: aload 6
    //   260: invokevirtual 350	java/io/OutputStream:close	()V
    //   263: aload 4
    //   265: ifnull +8 -> 273
    //   268: aload 4
    //   270: invokevirtual 351	java/io/InputStream:close	()V
    //   273: aload_1
    //   274: athrow
    //   275: astore_1
    //   276: goto -59 -> 217
