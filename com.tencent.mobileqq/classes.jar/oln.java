  ...
  extends MSFServlet
{
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    urw.a(arrayOfByte, (String)localObject);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramIntent.getBooleanExtra("useNewProtocol", false)) || (((super.getAppRuntime() instanceof QQAppInterface)) && (uuc.a((QQAppInterface)super.getAppRuntime(), l + "") != -4)))
        {
