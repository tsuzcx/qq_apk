...
{
  public mle(VideoLayerUI paramVideoLayerUI, View paramView)
  {
    super(paramView);
  }
  ...
  private Rect a(int paramInt)
  {
    ...
    if ((this.a.jdField_a_of_type_ArrayOfMee != null) && (this.a.jdField_a_of_type_ArrayOfMee[paramInt].a() == 0)) {
      localRect.set(this.a.jdField_a_of_type_ArrayOfMee[paramInt].b());
    }
    return localRect;
  }
  ...
  {
    if ((this.a.jdField_a_of_type_ArrayOfMee != null) && (paramInt >= 0) && (paramInt < this.a.jdField_a_of_type_ArrayOfMee.length))
    {
      int i = -1;
      ...
      for (;;)
      {
        ...
        str2 = this.a.jdField_a_of_type_ArrayOfMee[paramInt].b();
        if (str2 == null) {
          break label214;
        }
        if (!str2.equals(str1)) {
        ...
        return localResources.getString(2131694515) + localResources.getString(2131695870);
        if (j == 1) {
          i = 1000;
        } else if (j == 0) {
          i = 0;
      ...
      return this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getDisplayName(i, str2, String.valueOf(this.a.jdField_a_of_type_ComTencentAvVideoController.a().g)) + localResources.getString(2131695870);
    }
    label214:
    return "";
  }
  ...
  {
    if (this.a.jdField_a_of_type_ArrayOfMee != null)
    {
      int i = this.a.jdField_a_of_type_ArrayOfMee.length - 1;
      while (i >= 0)
      {
        if ((this.a.jdField_a_of_type_ArrayOfMee[i].a() == 0) && (this.a.jdField_a_of_type_ArrayOfMee[i].b().contains((int)paramFloat1, (int)paramFloat2))) {
          return i;
        }
        i -= 1;
      }
  ...
  public void getVisibleVirtualViews(List<Integer> paramList)
  {
    if (this.a.jdField_a_of_type_ArrayOfMee != null)
    {
      int j = this.a.jdField_a_of_type_ArrayOfMee.length;
      int i = 0;
      while (i < j)
      {
