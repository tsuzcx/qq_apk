...
public class ydc
{
  ...
  public static bcwd a(String paramString)
  {
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inPreferredConfig = bcwn.a;
    bcwd localbcwd = new bcwd();
    int i = 0;
    do
    {
      bcwc.a(paramString, localOptions, localbcwd);
      if (localbcwd.a == 1) {
        NearbyAppInterface.b();
      }
      i += 1;
    } while ((i < 2) && (localbcwd.a == 1));
    return localbcwd;
  }
