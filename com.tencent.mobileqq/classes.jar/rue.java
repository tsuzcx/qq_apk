...
public class rue
  extends AVObserver
{
  private rue(BaseChatPie paramBaseChatPie) {}
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == paramInt1) && (Long.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue() == paramLong1))
    {
      ...
      str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429195);
      if (paramLong2 != 2L) {
        break label234;
      }
      str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429196);
    }
    label233:
    label234:
    String str2;
    ...
    do
    {
      do
      {
        ...
        if ((paramLong2 == 41L) || (paramLong2 == 40L)) {
          str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429200);
        }
        for (;;)
        {
          DialogUtil.b(this.a.jdField_a_of_type_AndroidContentContext, 230, null, str1, 2131429048, 2131428674, new ruf(this), null).show();
          return;
          if (paramLong2 != 35L) {
            break;
          }
          str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429197);
          break;
          if (paramLong2 == 42L) {
            str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429198);
          } else if (paramLong2 == 43L) {
            str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429199);
          }
        }
        if (paramLong2 == 3L)
        {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.a.jdField_a_of_type_AndroidContentContext.getString(2131429120), 1).b(this.a.a());
          return;
        }
        if (paramLong2 == 4L)
        {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.a.jdField_a_of_type_AndroidContentContext.getString(2131429115), 1).b(this.a.a());
          return;
        }
      } while (paramLong2 != 7L);
  ...
  protected void a(long paramLong1, int paramInt, long paramLong2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == paramInt) && (Long.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue() == paramLong1)) {
      DialogUtil.b(this.a.jdField_a_of_type_AndroidContentContext, 230, null, paramString, 2131429048, 2131428674, new rug(this), null).show();
    }
  }
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    {
      TextView localTextView = (TextView)this.a.jdField_a_of_type_ComTencentMobileqqActivityAioTipsVideoStatusTipsBar.a(new Object[0]).findViewById(2131363017);
      ...
      if (localTextView != null)
      {
        ...
        String.format(this.a.jdField_a_of_type_AndroidContentContext.getString(2131433748), new Object[] { Long.valueOf(l) });
        if (i != 5) {
    ...
    label271:
    if (i == 2) {
      str = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429088);
    }
    for (;;)
    {
      j = this.a.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131494220);
      this.a.jdField_a_of_type_ComTencentMobileqqActivityAioTipsVideoStatusTipsBar.a(null, str, j, paramString1, 0);
      break;
      if (i == 1) {
        str = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429087);
      } else if (i == 5) {
        str = this.a.jdField_a_of_type_AndroidContentContext.getString(2131429562);
      }
    }
  }
