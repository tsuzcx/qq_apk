  ...
  extends aqzl
{
  ...
  public aqzk(QQAppInterface paramQQAppInterface, aqzc paramaqzc)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aqzc = paramaqzc;
  }
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (((Iterator)localObject3).hasNext())
    {
      ...
      aqyu localaqyu = new aqyu(str, new LatLng(((RoomOperate.UserData)localObject4).lat.get(), ((RoomOperate.UserData)localObject4).lon.get()), ((RoomOperate.UserData)localObject4).direction.get());
      if (QLog.isColorLevel()) {
        if (j != 1) {
          break label651;
        }
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aqzc.a(new aqyw(localInteger.intValue(), str), (LocationRoom.Venue)localObject, paramObject.intValue(), paramBoolean, i);
      if (paramBoolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("LocationObserver", 2, new Object[] { "[venue] onVenueOpt: invoked. success ", " uin: ", str, " uinType: ", localInteger, " optType: ", paramObject });
        }
        this.jdField_a_of_type_Aqzc.a.a(localInteger.intValue(), str);
        return;
      }
  ...
  protected void c(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new aqyw(paramObject.intValue(), str);
    this.jdField_a_of_type_Aqzc.a(paramObject, ((Integer)localObject).intValue());
  }
  ...
  protected void d(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new aqyw(paramObject.intValue(), (String)localObject);
    this.jdField_a_of_type_Aqzc.b(paramObject, -1);
  }
  ...
  protected void e(boolean paramBoolean, Object paramObject)
  {
    ...
    case 2: 
    case 3: 
      aqyz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
      return;
    }
    aqyz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
  }
  ...
  protected void f(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      aqzq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
    }
    label80:
    do
    {
      ...
      if (i == 101)
      {
        aqzq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
        return;
      }
      if (i == 102)
      {
  ...
  protected void g(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Aqzc.a.a(localInteger.intValue(), (String)localObject);
      this.jdField_a_of_type_Aqzc.a.b(localInteger.intValue(), (String)localObject);
      if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Aqzc.b(localInteger.intValue(), (String)localObject);
        awqx.b(null, "CliOper", "", "", "0X800A764", "0X800A764", 0, 0, "", "0", "0", "");
      }
      for (;;)
      {
        this.jdField_a_of_type_Aqzc.a(false);
        return;
        if (paramObject.intValue() == 2)
        {
          this.jdField_a_of_type_Aqzc.b(localInteger.intValue(), (String)localObject);
          if (this.jdField_a_of_type_Aqzc.a()) {
            awqx.b(null, "CliOper", "", "", "0X800A76B", "0X800A76B", aqzc.a(this.jdField_a_of_type_Aqzc.a()), 0, "", "0", "0", "");
          }
        }
      }
    }
    ...
    aqyw localaqyw = new aqyw(localInteger.intValue(), (String)localObject);
    this.jdField_a_of_type_Aqzc.a(localaqyw, j, paramObject.intValue());
    int i = 0;
    if (j == 10101) {}
    for (i = 3;; i = 2) {
      do
      {
        this.jdField_a_of_type_Aqzc.a(localInteger.intValue(), (String)localObject, this.jdField_a_of_type_Aqzc.a(), i);
        return;
