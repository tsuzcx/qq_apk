  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private ozi jdField_a_of_type_Ozi = new quz(this);
  ...
  public qur(Activity paramActivity)
  {
  ...
  {
    Object localObject = (StructMsgForGeneralShare)axuy.a(paramBundle.getByteArray("STRUCT_MSG_BYTES"));
    if ((!TextUtils.isEmpty(((StructMsgForGeneralShare)localObject).mMsgBrief)) && (((StructMsgForGeneralShare)localObject).mMsgBrief.indexOf(ajyc.a(2131716372)) == -1)) {
      ((StructMsgForGeneralShare)localObject).mMsgBrief = (ajyc.a(2131716367) + ((StructMsgForGeneralShare)localObject).mMsgBrief);
    }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    aqbc.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, 21);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localObject[1] = ajyc.a(2131716386);
    localObject[2] = ajyc.a(2131716384);
    localObject[3] = ajyc.a(2131716381);
    localObject[4] = ajyc.a(2131716357);
    localObject[5] = ajyc.a(2131716377);
    localObject[6] = ajyc.a(2131716385);
    localObject[7] = ajyc.a(2131716388);
    localObject[8] = ajyc.a(2131716392);
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Sgy == null) {
      this.jdField_a_of_type_Sgy = new sgy(this.jdField_a_of_type_AndroidAppActivity, a(), new qva(this), new qvb(this));
    }
    this.jdField_a_of_type_Sgy.a.a("biu出去让更多好友看到");
    this.jdField_a_of_type_Sgy.a.a(new qus(this));
    this.jdField_a_of_type_Sgy.a.a(new qut(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new quy(this));
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, Bundle paramBundle, qtu paramqtu, qvc paramqvc, int paramInt)
  {
    a(paramBaseArticleInfo, paramBundle, paramqtu, paramqvc, paramInt, true);
  }
  
  public void a(BaseArticleInfo paramBaseArticleInfo, Bundle paramBundle, qtu paramqtu, qvc paramqvc, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Nkw = ((nkw)a().a(136));
    this.jdField_a_of_type_Nkw.a();
  }
  
  public void a(rap paramrap)
  {
  ...
  public boolean a(int paramInt)
  {
    ...
    Object localObject3 = this.jdField_a_of_type_Nkw.a();
    ...
    if (paramInt == 1)
    {
      ...
      i = 3;
      localObject3 = new qze(null, localBaseArticleInfo.mSubscribeID, localBaseArticleInfo.mVideoVid, String.valueOf(localBaseArticleInfo.innerUniqueID), this.jdField_a_of_type_Qtu.a(), localBaseArticleInfo.mVideoDuration * 1000).e(localBaseArticleInfo.mAlgorithmID).d(localBaseArticleInfo.mStrategyId).a(this.jdField_b_of_type_Int).a().a();
      if ((paramInt != 14) && (paramInt != 20) && (paramInt != 12))
      {
        ...
        ((qcd)localObject1).d = ((int)this.jdField_a_of_type_Qtu.a());
        ((qcd)localObject1).e = (localBaseArticleInfo.getVideoDuration() * 1000);
        if (l != 0L) {
          break label2191;
        }
        paramInt = 1;
        ((qcd)localObject1).c = paramInt;
        npx.a(localBaseArticleInfo, this.jdField_b_of_type_Int, 26, -1L, (qcd)localObject1);
      }
    ...
    for (localObject1 = localBaseArticleInfo.innerUniqueID;; str1 = "0")
    {
      for (;;)
      {
        ...
        for (;;)
        {
          for (;;)
          {
            noo.a(null, (String)localObject5, "0X800740F", "0X800740F", 0, 0, "1", (String)localObject6, (String)localObject1, (String)localObject3, false);
            return true;
            if (paramInt == 13)
            {
              this.jdField_a_of_type_Sgy.d((String)localObject5 + "&sourcefrom=6");
              i = 3;
              break;
            }
            if (paramInt == 14)
            {
              this.jdField_a_of_type_Sgy.c((String)localObject5 + "&sourcefrom=6");
              i = 3;
              break;
            }
            if (paramInt == 20)
          ...
          if (paramInt == 7)
          {
            this.jdField_a_of_type_Sgy.a((String)localObject5 + "&sourcefrom=6");
            i = 3;
            break;
          }
          if (paramInt == 8)
          {
            ...
            ((Intent)localObject1).putExtra("big_brother_source_key", onk.f(0));
        ...
        if (paramInt == 3)
        {
          ...
          for (localObject2 = null;; localObject2 = localBaseArticleInfo.getVideoCoverURL().getFile())
          {
            ...
            bgyu.a(a(), this.jdField_a_of_type_AndroidAppActivity, (Bundle)localObject4, null);
            i = 1;
            break;
          }
        }
        ...
        if (paramInt == 12)
        {
          ...
          {
            bcpw.a(this.jdField_a_of_type_AndroidContentContext, 0, ajyc.a(2131716366), 0).a();
            return true;
          }
          qol.a(a(), this.jdField_a_of_type_AndroidAppActivity);
          int j = 6;
          localObject5 = (String)localObject5 + "&sourcefrom=6";
          localObject2 = qol.a(localBaseArticleInfo);
          localObject4 = qol.a(localBaseArticleInfo);
          ...
          {
            ((oze)localObject7).a(localActivity, (String)localObject2, 2, str2, str3, str4, (String)localObject4, (String)localObject5, (Bundle)localObject6);
        ...
        if ((paramInt == 4) || (paramInt == 5))
        {
          ...
          if (paramInt == 4)
          {
            ...
            if (localBaseArticleInfo.mVideoPlayCount > 0) {
              ((StringBuilder)localObject6).append(qol.b(localBaseArticleInfo.mVideoPlayCount)).append(" ");
            }
          ...
          {
            npy.a((BaseActivity)localObject4, (String)localObject5, (String)localObject6, (String)localObject2, (Bitmap)localObject7, bool, localBaseArticleInfo.innerUniqueID, null);
            break;
        ...
        if (paramInt == 15)
        {
          ...
          try
          {
            ...
            if ((localBaseArticleInfo.mDislikeInfos != null) && (localBaseArticleInfo.mDislikeInfos.size() > 0))
            {
              ...
              localObject4 = new quu(this);
              this.jdField_a_of_type_Bfol.a((bfot)localObject4);
              localObject4 = new ReadInJoyDisLikeDialogView(this.jdField_a_of_type_AndroidContentContext);
              ((ReadInJoyDisLikeDialogView)localObject4).setOnUninterestConfirmListener(new quv(this, localBaseArticleInfo, (JSONObject)localObject2));
              ((ReadInJoyDisLikeDialogView)localObject4).setUninterestData(localBaseArticleInfo.mDislikeInfos);
              this.jdField_a_of_type_Bfol.a((View)localObject4, null);
              try
              {
                if (!this.jdField_a_of_type_Bfol.isShowing())
                {
                  if ((bfni.g()) && (!ShortVideoUtils.c()))
                  {
                    ...
                    this.jdField_a_of_type_Bfol.setOnShowListener(new qux(this));
                  }
                  this.jdField_a_of_type_Bfol.show();
                  noo.b(null, null, "0X800913B", "0X800913B", 0, 0, null, null, null, new qze(npx.a(null, null, null, null, (JSONObject)localObject2)).h(localBaseArticleInfo.innerUniqueID).a().a(), false);
                }
              }
              catch (Exception localException)
              {
      ...
      if (paramInt == 24)
      {
        if (localBaseArticleInfo.busiType == 6)
        {
          ...
          str1 = omm.g + bbca.encodeToString(localBaseArticleInfo.getSubscribeUin().getBytes(), 2);
        ...
        str1 = omm.k + bbca.encodeToString(localBaseArticleInfo.getSubscribeUin().getBytes(), 2);
        onk.a(this.jdField_a_of_type_AndroidContentContext, str1);
        i = 3;
        break;
      }
      if (paramInt == 122)
      {
        qyz.a(this.jdField_a_of_type_AndroidAppActivity, localBaseArticleInfo, this.jdField_a_of_type_Qtu.a(localBaseArticleInfo.getInnerUniqueID()), 3, 1);
        qyz.a(localBaseArticleInfo.getInnerUniqueID(), 3, 1);
      }
      i = 3;
      break;
      paramInt = 2;
