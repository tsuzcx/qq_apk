...
public class aegu
  extends xpi
  implements aegt, agpd, agqw, agqy, View.OnClickListener, SeekBar.OnSeekBarChangeListener, bfot, INetInfoHandler
{
  ...
  MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new aehm(this);
  ImageButton jdField_a_of_type_AndroidWidgetImageButton;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  public LinearLayout a;
  public SeekBar a;
  TextView jdField_a_of_type_AndroidWidgetTextView;
  axjq jdField_a_of_type_Axjq;
  public bbjc a;
  bcpf jdField_a_of_type_Bcpf;
  bcub jdField_a_of_type_Bcub;
  ...
  public aegu(Activity paramActivity, xpm paramxpm, aejd paramaejd, String paramString)
  {
    ...
    this.jdField_a_of_type_Aehu = new aehu(this);
    ...
    this.jdField_a_of_type_MqqOsMqqHandler = new aehn(this);
    this.jdField_a_of_type_Aeie = ((aeie)paramxpm);
    this.jdField_a_of_type_Aejd = paramaejd;
    ((agqz)this.jdField_a_of_type_Agqx).a(paramaejd);
    this.jdField_b_of_type_JavaLangString = paramString;
    if ((paramString == null) && (PeakActivity.class.isInstance(paramActivity))) {
      this.jdField_b_of_type_JavaLangString = bizu.a().getCurrentAccountUin();
    }
    paramxpm = (PeakAppInterface)((PeakActivity)paramActivity).getAppRuntime();
    if (paramxpm != null) {
      ((akbb)paramxpm.a(2)).a(paramActivity);
    }
  }
  ...
  private void F()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetImageButton.setContentDescription(ajyc.a(2131700021));
    this.jdField_c_of_type_AndroidWidgetImageButton.setId(2131373019);
    this.jdField_c_of_type_AndroidWidgetImageButton.setImageResource(2130845342);
  ...
  private void H()
  {
    ...
    int i3 = this.jdField_a_of_type_Aeie.b();
    if ((i3 >= i1) && (i3 <= i2 + i1 - 1))
    {
  ...
  private int a()
  {
    Object localObject = this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    if (localObject != null)
    {
  ...
  private <T extends aeja> T a(long paramLong1, long paramLong2)
  {
    Iterator localIterator = this.jdField_a_of_type_Aeie.a().iterator();
    while (localIterator.hasNext())
    {
      aeja localaeja = (aeja)localIterator.next();
      if ((localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long == paramLong1) && (localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int == paramLong2)) {
        return localaeja;
      }
    }
    return null;
  ...
  private bcpf a(Context paramContext)
  {
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, String paramString, ArrayList<bbje> paramArrayList)
  {
    bbje localbbje = new bbje();
    localbbje.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(paramInt1);
    localbbje.jdField_b_of_type_Int = paramInt2;
    localbbje.jdField_c_of_type_Int = paramInt3;
    localbbje.jdField_b_of_type_JavaLangString = paramString;
    paramArrayList.add(localbbje);
  }
  
  private void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<bbje> paramArrayList)
  {
    bbje localbbje = new bbje();
    localbbje.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(paramInt1);
    localbbje.jdField_b_of_type_Int = paramInt2;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<bbje> paramArrayList, int paramInt4)
  {
    bbje localbbje = new bbje();
    localbbje.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(paramInt1);
    localbbje.jdField_b_of_type_Int = paramInt2;
    localbbje.jdField_c_of_type_Int = paramInt3;
    localbbje.jdField_b_of_type_JavaLangString = "";
    localbbje.jdField_e_of_type_Int = paramInt4;
    paramArrayList.add(localbbje);
  }
  ...
  private void a(int paramInt, File paramFile)
  {
    ...
    for (;;)
    {
      if (localObject1 != null) {
        axqw.b(null, "dc00898", "", "", (String)localObject1, (String)localObject1, 0, 0, "", "", "", "");
      }
      ...
      bcpw.a((Context)localObject1, 1, ajyc.a(2131700040), 0).a();
      return;
    ...
    int i2 = this.jdField_a_of_type_Aeie.b();
    ...
    a((Activity)localObject1, ajyc.a(2131700039), false, 0);
    if (vyi.a(BaseApplication.getContext(), paramFile.getAbsolutePath(), (String)localObject2)) {
  ...
  private void a(aeja paramaeja)
  {
    ...
    do
    {
      ...
      {
        AIOShortVideoData localAIOShortVideoData = (AIOShortVideoData)paramaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        if (localAIOShortVideoData.jdField_b_of_type_Int == 0)
        {
          paramaeja.jdField_a_of_type_Aejb.jdField_h_of_type_Boolean = false;
          paramaeja.jdField_a_of_type_Aejb.jdField_d_of_type_Boolean = false;
        }
        for (;;)
        {
          ...
          paramaeja.jdField_a_of_type_Aejb.jdField_g_of_type_Boolean = false;
          return;
          this.jdField_d_of_type_AndroidWidgetTextView.setText(ShortVideoUtils.a(localAIOShortVideoData.jdField_a_of_type_Int * 1000));
          paramaeja.jdField_a_of_type_Aejb.jdField_i_of_type_Boolean = false;
        }
      }
      if ((paramaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData))
      {
        this.jdField_b_of_type_AndroidWidgetSeekBar.setProgress(0);
        paramaeja.jdField_a_of_type_Aejb.jdField_g_of_type_Boolean = false;
        return;
  ...
  public static void a(Activity paramActivity, int paramInt1, String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt2, boolean paramBoolean)
  {
    ...
    return;
    label458:
    Object localObject = actn.a(localIntent, null);
  ...
  private void a(Uri paramUri, ArrayList<bbje> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i1 = whm.a((Bitmap)localObject1, true, 3, localSparseArray) | 0x0;
        if (QLog.isColorLevel()) {
          QLog.i("AIOGalleryScene", 2, String.format("checkQQCode bmp!=null result=%d", new Object[] { Integer.valueOf(i1) }));
        }
        if (localObject1 == null)
        {
          i2 = whm.a(paramUri, this.jdField_a_of_type_AndroidAppActivity, 3, localSparseArray);
          i1 = i2;
          if (QLog.isColorLevel())
          {
  ...
  private void a(AIOFileVideoData paramAIOFileVideoData, int paramInt)
  {
    ...
    this.jdField_a_of_type_Bbjc.a(paramAIOFileVideoData);
    this.jdField_a_of_type_Bbjc.a();
  }
  
  private void a(AIOImageData paramAIOImageData, aeja paramaeja)
  {
    if (paramAIOImageData != null)
    {
      this.jdField_a_of_type_Aeht = new aeht(this);
      this.jdField_a_of_type_Aeht.jdField_a_of_type_Long = paramAIOImageData.jdField_f_of_type_Long;
      this.jdField_a_of_type_Aeht.jdField_a_of_type_Int = paramAIOImageData.jdField_f_of_type_Int;
      if (QLog.isColorLevel()) {
        QLog.d("AIOGalleryScene", 2, "dealSaveOriginalImage");
      }
      this.jdField_a_of_type_Aejd.a(this.jdField_a_of_type_Aeht.jdField_a_of_type_Long, this.jdField_a_of_type_Aeht.jdField_a_of_type_Int, 24);
    }
  }
  
  private void a(AIOImageData paramAIOImageData, aeja paramaeja, File paramFile)
  {
    this.jdField_a_of_type_Bbjc.a(new aehq(this, paramAIOImageData, paramaeja, paramFile));
    this.jdField_a_of_type_Bbjc.a(new aegw(this));
  }
  ...
  private void a(AIORichMediaData paramAIORichMediaData, File paramFile, int paramInt)
  {
    ...
    if ((PicShareToWX.a().a()) && (PicShareToWX.a().a(paramFile))) {
      a(2131692916, 2130845900, 69, localArrayList1);
    }
    a(2131692915, 2130839647, 53, localArrayList1);
    axqw.b(null, "dc00898", "", "", "0X800A60D", "0X800A60D", 0, 0, "", "", "", "");
    a(2131692908, 2130843485, 67, localArrayList1);
    ...
    if (this.jdField_g_of_type_Boolean) {
      a(2131692911, 2130839642, 52, localArrayList2, 2);
    }
  ...
  private void a(AIOShortVideoData paramAIOShortVideoData, int paramInt)
  {
    ...
    for (i1 = 1;; i1 = 1)
    {
      ...
      if ((bfni.d()) && ((paramAIOShortVideoData.jdField_b_of_type_Int != 1) || (i1 == 0))) {
        a(2131692915, 2130839647, 61, localArrayList1);
      }
      if (i1 == 0)
      {
        a(2131692905, 2130839637, 63, localArrayList1);
        a(2131692909, 2130839640, 60, localArrayList1);
        a(2131692917, 2130839648, 58, localArrayList1);
      }
      if ((this.jdField_g_of_type_Int != -1) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.r)) {
        a(2131692919, 2130839649, 62, localArrayList2);
      }
      if (i1 == 0) {
        a(2131692912, 2130839643, 64, localArrayList2, 5);
      }
      a(paramAIOShortVideoData, localFile, paramInt, localaeja);
      paramAIOShortVideoData = (List[])new ArrayList[] { localArrayList1, localArrayList2 };
      this.jdField_a_of_type_Bbjc.a(paramAIOShortVideoData);
      this.jdField_a_of_type_Bbjc.a();
      return;
      if (QLog.isColorLevel()) {
  ...
  private void a(AIOShortVideoData paramAIOShortVideoData, aeja paramaeja)
  {
    if (paramAIOShortVideoData != null)
    {
      ...
      this.jdField_a_of_type_Aejd.a(paramAIOShortVideoData.jdField_f_of_type_Long, paramAIOShortVideoData.jdField_f_of_type_Int, 256);
    }
  }
  
  private void a(AIOShortVideoData paramAIOShortVideoData, File paramFile, int paramInt, aeja paramaeja)
  {
    this.jdField_a_of_type_Bbjc.a(new aeha(this, paramAIOShortVideoData, paramFile, paramInt, paramaeja));
    this.jdField_a_of_type_Bbjc.a(new aehb(this));
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    {
      aeja localaeja = this.jdField_a_of_type_Aeie.a();
      if ((localaeja != null) && ((localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)))
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a((AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData) != null))
        {
          this.jdField_c_of_type_AndroidWidgetImageButton.setVisibility(0);
          return true;
        }
      }
      else if ((localaeja != null) && ((localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData)) && (vyi.c(((AIOFileVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_c_of_type_JavaLangString)))
      {
        this.jdField_c_of_type_AndroidWidgetImageButton.setVisibility(0);
        return true;
      }
  ...
  private void b(aeja paramaeja)
  {
    AIOImageData localAIOImageData = (AIOImageData)paramaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    for (;;)
    {
      ...
      Object localObject = bfol.c(this.jdField_a_of_type_AndroidAppActivity);
      if ((!a((bfol)localObject, localAIOImageData)) && (akpy.a(this.jdField_g_of_type_Int) != 1032))
      {
        ...
        if (localFile != null) {
          if (!this.jdField_c_of_type_Boolean)
          {
            ...
            {
              a(2131692903, 2130839633, 48, (ArrayList)localObject);
            ...
            if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044)) {
              a(2131692906, 2130839638, 49, (ArrayList)localObject);
            }
            if ((PicShareToWX.a().a()) && (PicShareToWX.a().a(localFile))) {
              a(2131692916, 2130845900, 69, (ArrayList)localObject);
            }
            if (!aqwd.a().a()) {
              a(2131692915, 2130839647, 53, (ArrayList)localObject);
            }
            if (!this.jdField_h_of_type_Boolean) {
              a(2131692905, 2130839637, 57, (ArrayList)localObject);
            }
            if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044))
            {
              if (localAIOImageData.jdField_e_of_type_JavaLangString != null) {
                a(2131692910, 2130839641, 50, (ArrayList)localObject, 3);
              }
              if ((this.jdField_i_of_type_Boolean) && (localAIOImageData.jdField_e_of_type_JavaLangString != null)) {
                a(2131692907, 2130839639, 51, (ArrayList)localObject, 3);
              }
            }
            a(2131692917, 2130839648, 58, (ArrayList)localObject);
            if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044))
            {
              if ((this.jdField_g_of_type_Int != -1) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.r)) {
                a(2131692919, 2130839649, 54, localArrayList, 3);
              }
              if (this.jdField_g_of_type_Boolean) {
                a(2131692911, 2130839642, 52, localArrayList, 2);
              }
        ...
        for (;;)
        {
          if ((localAIOImageData.jdField_e_of_type_Int == 4) && (!localAIOImageData.jdField_i_of_type_Boolean)) {
            a(2131693392, 2130845762, 66, (ArrayList)localObject);
          }
          a(localAIOImageData, paramaeja, localFile);
          paramaeja = (List[])new ArrayList[] { localObject, localArrayList };
          this.jdField_a_of_type_Bbjc.a(paramaeja);
          this.jdField_a_of_type_Bbjc.a();
          return;
          a(2131693383, 2130839638, 49, (ArrayList)localObject);
          a(2131693393, 2130839647, 53, (ArrayList)localObject);
          continue;
      ...
      if ((akpy.a(this.jdField_g_of_type_Int) == 1032) && (localFile != null)) {
        ((bfol)localObject).b(2131693393);
      }
      ((bfol)localObject).c(2131690596);
      ((bfol)localObject).a(new aegz(this, (bfol)localObject, localAIOImageData, localFile));
      ((bfol)localObject).show();
      ((bfol)localObject).a(this);
      return;
    }
  }
  
  public static void b(aeja paramaeja, Activity paramActivity, int paramInt)
  {
    if (!AIOImageData.class.isInstance(paramaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
      return;
    }
    AIOImageData localAIOImageData = (AIOImageData)paramaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    File localFile = localAIOImageData.a(4);
    ...
    for (int i1 = 0;; i1 = 1)
    {
      ...
      paramaeja = paramaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      if (i1 != 0) {}
      for (int i2 = 4;; i2 = 2)
      {
        localBundle.putString("forward_urldrawable_big_url", paramaeja.a(i2));
        if (paramActivity.getIntent().getBooleanExtra("image_share_by_server", false))
        {
          paramaeja = Long.toString(paramActivity.getIntent().getLongExtra("appid", 0L));
          i2 = paramActivity.getIntent().getIntExtra("curType", 0);
          localBundle.putBoolean("key_forward_image_share", true);
          localBundle.putString("key_forward_image_share_appid", paramaeja);
        ...
        try
        {
          ...
          paramaeja = new Intent();
          paramaeja.putExtras(localBundle);
          aqbc.a(paramActivity, paramaeja, paramInt);
          return;
        }
        catch (NullPointerException paramaeja) {}
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      QLog.d("AIOGalleryScene", 2, "showFriendPickerForForward ,NullPointerException: " + paramaeja);
      return;
    }
  }
  ...
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131561104, null);
    Object localObject = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject).addRule(12, -1);
    if (paramBoolean) {
      ((RelativeLayout.LayoutParams)localObject).addRule(0, 2131373020);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(localRelativeLayout, (ViewGroup.LayoutParams)localObject);
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localRelativeLayout.findViewById(2131370891));
      this.jdField_b_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131375774));
      localObject = (ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131371129);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131372002));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131377624));
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localRelativeLayout.findViewById(2131378674));
      this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378676));
      this.jdField_a_of_type_AndroidWidgetSeekBar.setMax(10000);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378675));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131364260));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localRelativeLayout.findViewById(2131363722));
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)localRelativeLayout.findViewById(2131374696));
      return;
  ...
  void C()
  {
    for (;;)
    {
      ...
      try
      {
        localAIORichMediaData = this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        ...
        if (localObject2 == null)
        {
          ...
          default: 
            ...
            if ((localAIORichMediaData instanceof AIOFilePicData))
            {
              ...
              {
                localObject3 = this.jdField_a_of_type_Aejd.a(localAIORichMediaData.jdField_f_of_type_Long, localAIORichMediaData.jdField_f_of_type_Int, this.jdField_g_of_type_Int);
                if (localObject3 != null)
                {
          ...
          for (;;)
          {
            ...
            axqw.b(null, "dc00898", "", "", "0X8007ACE", "0X8007ACE", 0, 0, "", "", "", "");
            return;
            axqw.b(null, "dc00898", "", "", "0X800A187", "0X800A187", 0, 0, "", "", "", "");
            i2 = 0;
            bool = true;
            i1 = 125;
            i3 = 19002;
  ...
  public void E()
  {
    if ((this.jdField_a_of_type_Agqx != null) && (this.jdField_a_of_type_Agqx.a != null) && (this.jdField_a_of_type_Agqx.a.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Agqx.c()))
    {
      ...
      localObject = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, (String)localObject, 2131694647, 2131720918, new aehk(this), new aehl(this));
  ...
  protected AbstractImageAdapter a(Context paramContext)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter = new AIOGalleryAdapter(paramContext, this.jdField_a_of_type_Aejd, true, i1);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(this.jdField_a_of_type_Agqx);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.jdField_a_of_type_Aego = new aehf(this);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(this.jdField_a_of_type_Aeie);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(new aehg(this));
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter = new AIOGalleryAdapter(paramContext, this.jdField_a_of_type_Aejd, bool1, i1);
      break;
      bool1 = bool2;
    }
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aeie.a((aeja)localObject);
    this.q = localBundle.getBoolean("muate_play");
    if (QLog.isColorLevel()) {
      QLog.d("AIOGalleryScene", 2, "initData , mIsMute = " + this.q);
    }
    ((aeja)localObject).jdField_b_of_type_AndroidGraphicsRect = ((Rect)localBundle.getParcelable("KEY_THUMBNAL_BOUND"));
    ...
    {
      this.jdField_a_of_type_Aeie.a(true);
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131693389);
      }
      ...
      return;
      ((aeja)localObject).jdField_c_of_type_Boolean = false;
      break;
    }
  }
  ...
  {
    super.a(paramInt);
    this.jdField_a_of_type_Aehu.jdField_a_of_type_Boolean = true;
    u();
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      ...
      {
        bcpw.a(this.jdField_a_of_type_AndroidAppActivity, 2131719560, 0).a();
        return;
      }
    } while ((paramInt1 != 10002) || (this.jdField_a_of_type_Axjq == null));
    this.jdField_a_of_type_Axjq.a(paramInt2);
  }
  ...
  public void a(int paramInt1, View paramView, String paramString1, String[] paramArrayOfString, String paramString2, MessageForShortVideo paramMessageForShortVideo, int paramInt2)
  {
    ...
    aeja localaeja = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(paramInt1);
    if (localaeja == null) {}
    for (;;)
    {
      return;
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("AIOGalleryScene", 2, "carverW notifyVideoUrl setShortVideoDrawableWithUrls ,AIOShortVideoData id=" + localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long);
        }
        aejm.a().a(localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long, paramArrayOfString, System.currentTimeMillis(), paramMessageForShortVideo, paramInt2, paramString2);
        paramString1 = new agrc();
        ...
        paramString1.jdField_a_of_type_Long = localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
        paramString1.jdField_b_of_type_Int = localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int;
        paramArrayOfString = new File(((AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_JavaLangString);
        if (paramArrayOfString.exists())
        {
          ...
          this.jdField_a_of_type_Agqx.a(paramView, paramString1);
          paramView = (AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(((AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_a_of_type_Long)) {
            break label481;
          }
          this.jdField_a_of_type_Agqx.f();
          this.jdField_a_of_type_Agqx.a((AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData, false, false);
        }
        for (;;)
        {
          if ((this.jdField_a_of_type_Aejd == null) || (paramView.a(0) != null)) {
            break label499;
          }
          if (QLog.isColorLevel()) {
            QLog.d("AIOGalleryScene", 2, "setShortVideoDrawableWithUrls, get THUMB");
          }
          this.jdField_a_of_type_Aejd.a(paramView.jdField_f_of_type_Long, paramView.jdField_f_of_type_Int, 0);
          return;
          paramString1.d = 0L;
          break;
          label481:
          this.jdField_a_of_type_Agqx.a((AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData, false, true);
        }
      }
      else
      {
        label499:
        if (AIOFileVideoData.class.isInstance(localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          paramMessageForShortVideo = (AIOFileVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
          if (paramMessageForShortVideo.jdField_a_of_type_Boolean)
          {
            QLog.i("VideoPlayControllerForFile", 1, "filevideo is playing:" + localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long);
            return;
          }
          ...
          if ("I:E".equals(paramString1)) {
            try
            {
              ...
              if (paramMessageForShortVideo.jdField_b_of_type_Long == -134L)
              {
                ...
                if (paramInt1 != 0)
                {
                  paramString1 = bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, "", paramString1, null, ajyc.a(2131700034), new aehj(this), null);
  ...
  public void a(int paramInt, Object paramObject, aeja paramaeja)
  {
    a(bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getString(2131718826), this.jdField_a_of_type_AndroidAppActivity.getString(2131718825), new aegx(this, paramInt, paramObject, paramaeja), new aegy(this)));
  }
  ...
  public void a(long paramLong)
  {
    ...
    do
    {
      ...
      i1 = 0;
      break;
      localaeja = this.jdField_a_of_type_Aeie.a();
      if ((localaeja != null) && (localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null)) {
        break label88;
      }
    } while (!QLog.isColorLevel());
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("AIOGalleryScene", 2, "onRevokeMsg seq:" + paramLong + ", selectItem seq:" + localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long + ", isFromMultiMsg:" + this.jdField_c_of_type_Boolean + ", OriSeq:" + this.jdField_a_of_type_Long);
      }
      if ((this.jdField_a_of_type_Aejd != null) && (!bool)) {
        this.jdField_a_of_type_Aejd.a(paramLong);
      }
      this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new AIOGalleryScene.28(this, paramLong, localaeja, bool));
      return;
      bool = false;
    }
  }
  ...
  public void a(long paramLong1, int paramInt1, int paramInt2, int paramInt3, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramInt2 == 2)
    {
      localObject1 = this.jdField_a_of_type_Aeie.a();
      paramInt2 = 0;
      if (paramInt2 < ((List)localObject1).size())
      {
        localObject2 = (aeja)((List)localObject1).get(paramInt2);
        if ((((aeja)localObject2).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramLong1) || (((aeja)localObject2).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int != paramInt1)) {
          break label156;
        }
        ((aeja)localObject2).jdField_a_of_type_Int = paramInt3;
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            if (paramInt2 == 24)
            {
              localObject1 = this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
              if ((((AIORichMediaData)localObject1).jdField_f_of_type_Long == paramLong1) && (((AIORichMediaData)localObject1).jdField_f_of_type_Int == paramInt1))
              {
                ...
                {
                  this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700030) + paramInt3 / 100.0D + "%");
              ...
              else
              {
                ...
                if (localObject1 != null) {
                  ((aeja)localObject1).jdField_a_of_type_Aejb.jdField_a_of_type_Int = paramInt3;
                }
              }
            }
            else if (paramInt2 == 4)
            {
              ...
              if ((((AIORichMediaData)localObject1).jdField_f_of_type_Long == paramLong1) && (((AIORichMediaData)localObject1).jdField_f_of_type_Int == paramInt1))
              {
                this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Int = paramInt3;
                this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700024) + apvb.a((paramLong2 * (paramInt3 / 10000.0D))) + "/" + apvb.a(paramLong2) + ")");
                this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(paramInt3);
                return;
              }
              localObject1 = a(paramLong1, paramInt1);
              if (localObject1 != null) {
                ((aeja)localObject1).jdField_a_of_type_Int = paramInt3;
              }
            }
            else if (paramInt2 == 1)
            {
              ...
              {
                localObject2 = (aeja)((List)localObject1).get(paramInt1);
                if (((aeja)localObject2).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long == paramLong1)
                {
                  ((aeja)localObject2).jdField_a_of_type_Int = paramInt3;
            ...
            else if (paramInt2 == 256)
            {
              ...
              if ((((AIORichMediaData)localObject1).jdField_f_of_type_Long == paramLong1) && (((AIORichMediaData)localObject1).jdField_f_of_type_Int == paramInt1))
              {
                this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700055) + paramInt3 + "%");
      ...
      localObject2 = (AIOFilePicData)((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      ((AIOFilePicData)localObject2).jdField_f_of_type_Boolean = true;
      if (this.jdField_a_of_type_Aeht == null)
      {
        this.jdField_a_of_type_Aeht = new aeht(this);
        this.jdField_a_of_type_Aeht.jdField_a_of_type_Long = ((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
        this.jdField_a_of_type_Aeht.jdField_a_of_type_Int = ((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int;
      }
    } while ((((AIOFilePicData)localObject2).jdField_f_of_type_Long != paramLong1) || (this.jdField_a_of_type_AndroidWidgetSeekBar == null));
    a(true);
    this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Int = paramInt3;
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700057) + apvb.a((paramLong2 * (paramInt3 / 10000.0D))) + "/" + apvb.a(paramLong2) + ")");
    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(paramInt3);
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 == 2)
    {
      localObject1 = this.jdField_a_of_type_Aeie;
      if (paramInt3 == 1)
      {
        paramInt2 = ((aeie)localObject1).a(paramLong, paramInt1, paramInt2, paramString, false);
        ...
        paramInt2 = 0;
        label133:
        if (paramInt2 >= this.jdField_a_of_type_Aeie.a()) {
          break label460;
        }
        paramString = this.jdField_a_of_type_Aeie.a(paramInt2);
        if (paramString != null) {
          break label178;
        }
      }
    ...
    else
    {
      ...
      bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131718823), 0).a();
      u();
      label425:
      if ((this.jdField_a_of_type_Aeht != null) && (this.jdField_a_of_type_Aeht.jdField_a_of_type_Long == paramLong) && (this.jdField_a_of_type_Aeht.jdField_a_of_type_Int == paramInt1)) {
        this.jdField_a_of_type_Aeht = null;
      }
    }
    label460:
    label461:
    ...
    do
    {
      ...
      {
        return;
        bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131718819), 0).a();
        break;
        paramString = a(paramLong, paramInt1);
        if (paramString == null) {
          break label425;
        }
        paramString.jdField_a_of_type_Aejb.jdField_e_of_type_Boolean = false;
        break label425;
        if (paramInt2 != 4) {
          break label869;
        }
      } while ((this.jdField_a_of_type_Aeht == null) || (this.jdField_a_of_type_Aeht.jdField_a_of_type_Long != paramLong) || (this.jdField_a_of_type_Aeht.jdField_a_of_type_Int != paramInt1));
      localObject2 = this.jdField_a_of_type_Aeie;
      if (paramInt3 == 1)
      {
        localObject1 = paramString;
        ((aeie)localObject2).a(paramLong, paramInt1, paramInt2, (String)localObject1, false);
        if (paramInt3 != 1) {
          break label796;
        }
      ...
      for (;;)
      {
        try
        {
          paramString = URLDrawable.getDrawable(this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(4), paramString);
          if (paramString == null) {
            break;
          }
          ...
          default: 
            ...
            paramString.setURLDrawableListener(this.jdField_a_of_type_Aeht);
            paramString.startDownload();
            this.jdField_a_of_type_Aeht.jdField_a_of_type_ComTencentImageURLDrawable = paramString;
            paramString = this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
            if ((paramString.jdField_f_of_type_Long != paramLong) || (paramString.jdField_f_of_type_Int != paramInt1)) {
              break label837;
            }
            this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb.jdField_c_of_type_Boolean = false;
            u();
            return;
            localObject1 = "I:E";
          }
        ...
        catch (Throwable paramString)
        {
          ...
          paramString = null;
          continue;
          this.jdField_a_of_type_Aeht.onLoadSuccessed(paramString);
          continue;
          this.jdField_a_of_type_Aeht.onLoadFialed(paramString, null);
          continue;
          this.jdField_a_of_type_Aeht.onLoadCanceled(paramString);
          continue;
        }
        if (!"TroopFileError".equals(paramString)) {
          bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131695340), 0).a();
        }
        this.jdField_a_of_type_Aeht = null;
        continue;
        paramString = a(paramLong, paramInt1);
        if (paramString != null)
        {
          ...
          paramString.jdField_a_of_type_Aejb.jdField_c_of_type_Boolean = false;
        }
      }
      if (paramInt2 == 256)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Aehu.jdField_b_of_type_Boolean = false;
          u();
          return;
          bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131718819), 0).a();
        }
      ...
      if ((paramInt2 == 1) || (paramInt2 == 0))
      {
        ...
        for (;;)
        {
          paramInt1 = ((aeie)localObject1).a(paramLong, paramInt1, paramInt2, paramString, false);
          paramInt2 = this.jdField_a_of_type_ComTencentWidgetGallery.getFirstVisiblePosition();
          paramInt3 = this.jdField_a_of_type_ComTencentWidgetGallery.getChildCount();
          if ((paramInt1 >= paramInt2) && (paramInt1 <= paramInt3 + paramInt2 - 1))
          {
      ...
      if ((paramInt2 == 20) && (this.jdField_a_of_type_Aeht != null) && (this.jdField_a_of_type_Aeht.jdField_a_of_type_Long == paramLong))
      {
        localObject2 = this.jdField_a_of_type_Aeie;
        if (paramInt3 == 1) {}
        for (localObject1 = paramString;; localObject1 = "I:E")
        {
          ...
          paramString = this.jdField_a_of_type_Aeie.a();
          ...
          paramString.mPlayGifImage = true;
          paramString.mUseExifOrientation = false;
          localObject1 = this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(20);
        ...
        if (!"TroopFileError".equals(paramString))
        {
          if (!this.jdField_a_of_type_AndroidAppActivity.getString(2131692856).equals(paramString)) {
            break label1645;
          }
          bcpw.a(this.jdField_a_of_type_AndroidAppActivity, paramString, 0).a();
        }
        for (;;)
        {
          a(false);
    ...
    paramInt1 = 0;
    label1680:
    if (paramInt1 < this.jdField_a_of_type_Aeie.a())
    {
      localObject1 = this.jdField_a_of_type_Aeie.a(paramInt1);
      if ((localObject1 != null) && (((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null) && (AIOFileVideoData.class.isInstance(((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))) {
        break label1735;
      }
    }
    label1735:
    ...
    } while (((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramLong);
    if (paramInt3 == 1)
    {
    ...
    {
      u();
      if (this.jdField_a_of_type_Aeie.a() != localObject1) {
        break;
      }
  ...
  {
    paramInt1 = this.jdField_a_of_type_Aeie.a(paramLong, paramInt1, paramInt2, paramString1, false);
    paramInt2 = this.jdField_a_of_type_ComTencentWidgetGallery.getFirstVisiblePosition();
    int i1 = this.jdField_a_of_type_ComTencentWidgetGallery.getChildCount();
    if (QLog.isDevelopLevel()) {
  ...
  protected void a(aeja paramaeja, Activity paramActivity, int paramInt)
  {
    b(paramaeja, this.jdField_a_of_type_AndroidAppActivity, 0);
  }
  ...
  public void a(agrc paramagrc)
  {
    ...
    label78:
    for (String str = "null";; str = paramagrc.jdField_a_of_type_Long + "")
    {
      QLog.d("AIOGalleryScene", 2, str);
      if ((paramagrc == null) || (!paramagrc.jdField_b_of_type_Boolean) || (!paramagrc.jdField_a_of_type_Boolean)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb.jdField_g_of_type_Boolean = true;
    u();
  }
  ...
  public void a(agrc paramagrc, int paramInt)
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Aeie.a();
      if ((localObject1 != null) && (((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null) && (paramagrc != null)) {
        break label96;
      }
    }
    label96:
    ...
    {
      return;
      localObject1 = paramagrc.jdField_a_of_type_Long + "";
      break;
      localObject2 = a(paramagrc.jdField_a_of_type_Long, paramagrc.jdField_b_of_type_Int);
      if (localObject2 != null) {
        ((aeja)localObject2).jdField_a_of_type_Aejb.jdField_d_of_type_Boolean = false;
      }
    } while (((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramagrc.jdField_a_of_type_Long);
    u();
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
              localObject = paramagrc.jdField_a_of_type_Long + "";
              break;
              localObject = this.jdField_a_of_type_Aeie.a();
            } while (((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramagrc.jdField_a_of_type_Long);
            if (!paramagrc.jdField_b_of_type_Boolean) {
              break label231;
            }
          } while (!AIOFileVideoData.class.isInstance(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData));
          paramString = qua.a(paramInt1, paramInt2);
          localObject = (AIOFileVideoData)((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        ...
        if (agqz.class.isInstance(this.jdField_a_of_type_Agqx)) {
          f1 = ((agqz)this.jdField_a_of_type_Agqx).a(paramagrc.jdField_a_of_type_Long);
        }
        paramString.putFloat("progress", f1);
        this.jdField_a_of_type_Aejd.a(((AIOFileVideoData)localObject).jdField_f_of_type_Long, 10, paramString);
        u();
        return;
        paramagrc = a(paramagrc.jdField_a_of_type_Long, paramagrc.jdField_b_of_type_Int);
      } while (paramagrc == null);
      paramagrc.jdField_a_of_type_Aejb.jdField_k_of_type_Boolean = true;
    } while (!AIOShortVideoData.class.isInstance(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData));
    ((AIOShortVideoData)((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(paramString);
    u();
  }
  ...
  public void a(agrc paramagrc, long paramLong)
  {
    ...
    label57:
    for (paramagrc = "null";; paramagrc = paramagrc.jdField_a_of_type_Long + "")
    {
      QLog.d("AIOGalleryScene", 2, paramagrc);
  ...
  public void a(agrc paramagrc, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        str = paramagrc.jdField_a_of_type_Long + "";
        break;
        paramagrc = a(paramagrc.jdField_a_of_type_Long, paramagrc.jdField_b_of_type_Int);
      } while (paramagrc == null);
      paramagrc.jdField_a_of_type_Aejb.jdField_j_of_type_Boolean = paramBoolean;
    } while (paramagrc.jdField_a_of_type_Aejb.jdField_g_of_type_Boolean);
  ...
  public void a(Activity paramActivity, String paramString, boolean paramBoolean, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      this.jdField_a_of_type_Bcpf = a(paramActivity);
    ...
    if (!paramBoolean) {
      this.jdField_a_of_type_AndroidAppDialog.setOnKeyListener(new aehh(this));
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Axjq = axjq.a(bizu.a());
    if (this.jdField_a_of_type_Axjq != null) {
      this.jdField_b_of_type_AndroidWidgetImageView = this.jdField_a_of_type_Axjq.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_b_of_type_JavaLangString);
    }
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131373025);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131165300));
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(1, 14.0F);
    this.jdField_a_of_type_AndroidWidgetTextView.setShadowLayer(2.0F, 0.0F, 0.0F, this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131165375));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695338);
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131695338));
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(i1, i1, i1, i1);
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130843011));
    ...
    this.jdField_d_of_type_AndroidWidgetImageButton.setContentDescription(ajyc.a(2131700058));
    this.jdField_d_of_type_AndroidWidgetImageButton.setId(2131373020);
    this.jdField_d_of_type_AndroidWidgetImageButton.setImageResource(2130837741);
    ...
    if ((f()) && (!(this.jdField_a_of_type_AndroidAppActivity.getIntent().getExtras().getParcelable("extra.EXTRA_CURRENT_IMAGE") instanceof AIODevLittleVideoData)))
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageButton.setContentDescription(ajyc.a(2131700053));
      this.jdField_b_of_type_AndroidWidgetImageButton.setId(2131373021);
      this.jdField_b_of_type_AndroidWidgetImageButton.setImageResource(2130837739);
      ...
      i1 = 1;
      label799:
      if (((i1 != 0) || ((this.jdField_k_of_type_Int == 4) && (localBundle.getBoolean("key_allow_forward_photo_preview_edit", false)))) && (akpy.a(this.jdField_g_of_type_Int) != 1032) && (this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044))
      {
        this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajyc.a(2131700049));
        this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130837734);
        ...
        this.jdField_a_of_type_AndroidWidgetImageButton.setId(2131373022);
        ...
        localLayoutParams.addRule(0, 2131373020);
      }
    }
    for (;;)
    {
      ...
      if ((agpe.class.isInstance(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter)) && (ProGallery.class.isInstance(this.jdField_a_of_type_ComTencentWidgetGallery))) {
      ...
      this.jdField_a_of_type_Agqx.a(this);
      this.jdField_a_of_type_Agqx.e(this.jdField_k_of_type_Int);
      ((ProGallery)this.jdField_a_of_type_ComTencentWidgetGallery).setGestureListener(this);
      this.jdField_l_of_type_Int = (axnq.a(this.jdField_a_of_type_AndroidAppActivity) / 2);
      aegr.a().a(this);
      return;
      i1 = 0;
      break;
  ...
  public void a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      if (this.jdField_a_of_type_Aeie.a()) {
        z();
      }
    }
    else
    {
      ...
      if (AIOGalleryAdapter.GalleryImageStruct.class.isInstance(paramView))
      {
        ...
        {
          a((aeja)localObject);
          if ((((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(4)) || (((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(20)))
          {
            if (((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h <= 0L) {
              break label600;
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, this.jdField_a_of_type_AndroidAppActivity.getString(2131695341), new Object[] { apvb.a(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h) }));
            label196:
            c(true);
            if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter != null)
            {
              ...
              localObject = a().findViewById(2131366905);
              if (localObject != null)
              {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(paramAdapterView, paramView, paramInt, paramLong);
        paramAdapterView = a().findViewById(2131366905);
    ...
    for (;;)
    {
      a(paramAdapterView);
      u();
      if ((paramAdapterView != null) && (this.jdField_a_of_type_Axjq != null))
      {
        if (!(paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) {
          break label894;
        }
        this.jdField_a_of_type_Axjq.a((AIOShortVideoData)paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
      }
      return;
      int i2 = this.jdField_a_of_type_Aeie.a();
      int i1 = 0;
      ...
      for (;;)
      {
        ...
        this.jdField_n_of_type_Int = this.jdField_a_of_type_Aeie.a();
      ...
      localObject = this.jdField_a_of_type_Aeie.a(paramInt);
      if ((localObject != null) && ((((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFilePicData)))
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, this.jdField_a_of_type_AndroidAppActivity.getString(2131695341), new Object[] { apvb.a(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h) }));
        if (((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h <= apee.c()) {
          break label848;
        }
        c(true);
      ...
      for (;;)
      {
        if ((localObject == null) || (!(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) || (((AIOImageData)((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_g_of_type_Int != 1)) {
          break label854;
        }
        this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, this.jdField_a_of_type_AndroidAppActivity.getString(2131695341), new Object[] { apvb.a(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h) }));
        if (((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h <= apee.c()) {
    ...
    label894:
    this.jdField_a_of_type_Axjq.a(null);
  }
  
  void a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Aejd != null) {
      this.jdField_a_of_type_Aejd.a(paramString, paramInt);
    }
  }
  ...
  void a(String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, Intent paramIntent)
  {
    ...
    if (!TextUtils.isEmpty(str)) {
      if (i1 != 80) {
        ...
        for (;;)
        {
          localIntent.putExtra("report_params", whm.a(paramString3, paramString1, paramString5, paramString2, paramIntent, paramInt1));
  ...
  public boolean a(int paramInt, KeyEvent paramKeyEvent)
  {
    if (82 == paramKeyEvent.getKeyCode()) {
      try
      {
        if (!AIODevLittleVideoData.class.isInstance(this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
          c(3);
        }
        return true;
      }
  ...
  boolean a(bfol parambfol, AIOImageData paramAIOImageData)
  {
    return false;
  }
  ...
  {
    w();
    aeja localaeja = this.jdField_a_of_type_Aeie.b();
    if (localaeja != null) {
      localaeja.jdField_b_of_type_Boolean = true;
    }
    if (!g()) {
    ...
    this.jdField_a_of_type_Aehu.jdField_d_of_type_Boolean = false;
    u();
  ...
  {
    super.b(paramInt);
    this.jdField_a_of_type_Aehu.jdField_a_of_type_Boolean = false;
    u();
  }
  ...
  {
    this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb.jdField_g_of_type_Boolean = true;
    int i1 = this.jdField_a_of_type_Aeie.a(paramLong, 0, 0, "", false);
    aeja localaeja = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(i1);
    if (AIOFileVideoData.class.isInstance(localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
    {
      ((AIOFileVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a();
  ...
  public void b(agrc paramagrc, int paramInt)
  {
    ...
    do
    {
      ...
      paramagrc.jdField_a_of_type_Aejb.jdField_h_of_type_Boolean = true;
    } while (paramagrc.jdField_a_of_type_Aejb.jdField_g_of_type_Boolean);
    this.jdField_e_of_type_AndroidWidgetTextView.setText("");
    u();
  }
  ...
  public void c()
  {
    this.jdField_a_of_type_Aehu.jdField_d_of_type_Boolean = true;
    u();
    if (!h()) {
  ...
  void c(int paramInt)
  {
    if (this.jdField_a_of_type_Bbjc == null)
    {
      ...
      this.jdField_a_of_type_Bbjc.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131692918));
    }
    this.jdField_a_of_type_Bbjc.a(new aehc(this));
    aeja localaeja = this.jdField_a_of_type_Aeie.a();
    Object localObject3;
    Object localObject2;
    Object localObject1;
    ...
    {
      localObject3 = (AIOImageData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      ...
      for (i1 = 2;; i1 = 1)
      {
        i2 = localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_g_of_type_Int;
        if (i2 != 0) {
          break;
        }
        i3 = 1;
        ...
        paramInt = 1;
        label203:
        axqw.b(null, "dc00898", "", "", "0X8009EFB", "0X8009EFB", i1, 0, String.valueOf(i3), String.valueOf(i2), String.valueOf(paramInt), "");
        return;
        b(localaeja);
      }
    }
    if (AIOShortVideoData.class.isInstance(localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
    {
      localObject1 = (AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    for (;;)
    {
      ...
      if (((AIOShortVideoData)localObject1).jdField_b_of_type_Int == 1)
      {
        i1 = 3;
        continue;
        if (AIOFilePicData.class.isInstance(localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          localObject3 = (AIOFilePicData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        ...
        {
          i1 = 5;
          a((AIOFileVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData, paramInt);
          break label170;
          if (i2 == 1)
          {
            i3 = 2;
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Axjq != null) {
      this.jdField_a_of_type_Axjq.b();
    }
    this.jdField_a_of_type_Aehu.jdField_f_of_type_Boolean = true;
    u();
  }
  ...
  public void d(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("AIOGalleryScene", 2, "[setProgress] current:" + this.jdField_a_of_type_Bcpf.a() + ", progress:" + paramInt);
    }
  ...
  public void d(agrc paramagrc)
  {
    ...
    do
    {
      ...
      localObject2 = a(paramagrc.jdField_a_of_type_Long, paramagrc.jdField_b_of_type_Int);
      if (localObject2 != null) {
        ((aeja)localObject2).jdField_a_of_type_Aejb.jdField_d_of_type_Boolean = true;
      }
    } while ((((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramagrc.jdField_a_of_type_Long) || (((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int != paramagrc.jdField_b_of_type_Int));
    u();
  }
  ...
  public void e()
  {
    if (this.jdField_l_of_type_Boolean)
    {
      ...
      aeja localaeja = this.jdField_a_of_type_Aeie.a();
      if (localaeja != null) {
        localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
      }
      ...
      localIntent.putExtra("leftViewText", this.jdField_a_of_type_AndroidAppActivity.getString(2131690832));
      this.jdField_a_of_type_AndroidAppActivity.startActivity(localIntent);
  ...
  public boolean e()
  {
    ...
    {
      if (this.jdField_a_of_type_Aeie.a() != null) {
        break label25;
      }
      bool1 = bool2;
    }
    ...
    do
    {
      return bool1;
      Object localObject = this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      if ((localObject != null) && (AIOImageData.class.isInstance(localObject)) && (this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb != null) && (this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb.jdField_c_of_type_Boolean))
      {
        if (this.jdField_a_of_type_Aeht != null) {
          this.jdField_a_of_type_Aejd.b(this.jdField_a_of_type_Aeht.jdField_a_of_type_Long, this.jdField_a_of_type_Aeht.jdField_a_of_type_Int, 4);
        }
        this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb.jdField_c_of_type_Boolean = false;
        u();
        return true;
      ...
      if (this.jdField_j_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", ((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
  ...
  {
    aeja localaeja = this.jdField_a_of_type_Aeie.a();
    if ((localaeja != null) && (AIOShortVideoData.class.isInstance(localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) && (((AIOShortVideoData)localaeja.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int == 0) && (this.jdField_a_of_type_Agqx != null)) {
      this.jdField_a_of_type_Agqx.k();
    }
    AppNetConnInfo.unregisterNetInfoHandler(this);
    super.f();
    if (this.jdField_m_of_type_Int > 0) {
      axqw.b(null, "CliOper", "", "", "View_pic", "View_pic_spin", 0, 0, "" + this.jdField_m_of_type_Int, "", "", "");
    }
    aegr.a().b(this);
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.c();
    }
    this.jdField_a_of_type_Axjq = null;
    if (this.jdField_a_of_type_Bbjc != null)
    {
  ...
  public boolean f()
  {
    if (akpy.a(this.jdField_g_of_type_Int) == 1032) {}
    label228:
    label229:
    for (;;)
    {
      return false;
      if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044) && (!this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Aeie != null))
      {
        Object localObject = this.jdField_a_of_type_Aeie.a();
        if (AIOImageData.class.isInstance(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          AIOImageData localAIOImageData = (AIOImageData)((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        ...
        for (;;)
        {
          ...
          {
            return bool;
            if (AIOShortVideoData.class.isInstance(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
            {
              localObject = ((AIOShortVideoData)((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(1);
              if ((localObject == null) || (!((File)localObject).exists())) {
                break;
              }
              return true;
            }
            if (AIOFilePicData.class.isInstance(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
            {
              if (this.jdField_c_of_type_Boolean) {
                break;
              }
            ...
            if (!AIOFileVideoData.class.isInstance(((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
              break;
            }
            localObject = (AIOFileVideoData)((aeja)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
  ...
  public void l()
  {
    ...
    super.l();
    D();
    Object localObject1 = this.jdField_a_of_type_Aeie.a();
    if ((localObject1 == null) || (((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData == null)) {}
    do
    {
      do
      {
        ...
        {
          return;
          localObject2 = (ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131371129);
          if ((!(((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) || (((AIOShortVideoData)((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int != 1)) {
            break;
          }
          localObject1 = a();
        ...
        return;
        if ((!(((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) || (((AIOShortVideoData)((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int != 0)) {
          break;
        }
      } while (this.jdField_a_of_type_Agqx == null);
      this.jdField_a_of_type_Agqx.h();
      return;
    } while ((!AIOFileVideoData.class.isInstance(((aeja)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) || (this.jdField_a_of_type_Agqx == null) || (!this.jdField_a_of_type_Agqx.c()));
    this.jdField_a_of_type_Agqx.h();
  }
  ...
  public void m()
  {
    ...
    aeja localaeja = this.jdField_a_of_type_Aeie.b();
    if (localaeja != null) {
      localaeja.jdField_b_of_type_Boolean = false;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      return;
      paramView = this.jdField_a_of_type_Aeie.a();
      if ((paramView != null) && (this.jdField_a_of_type_Aejd.asBinder().pingBinder()))
      {
        this.jdField_a_of_type_Aeht = new aeht(this);
        this.jdField_a_of_type_Aeht.jdField_a_of_type_Long = paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
        this.jdField_a_of_type_Aeht.jdField_a_of_type_Int = paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int;
        if (AIOImageData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          paramView.jdField_a_of_type_Aejb.jdField_c_of_type_Boolean = true;
          u();
          this.jdField_a_of_type_Aejd.a(this.jdField_a_of_type_Aeht.jdField_a_of_type_Long, this.jdField_a_of_type_Aeht.jdField_a_of_type_Int, 4);
          return;
        }
        if (AIOFilePicData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          ...
          {
            bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131693944), 0).a();
            this.jdField_a_of_type_Aeht = null;
            u();
            return;
          }
          ...
          {
            bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692856), 0).a();
            u();
            this.jdField_a_of_type_Aeht = null;
            return;
          }
          ...
          long l1 = apee.a();
          if ((paramView.jdField_a_of_type_Long > l1) && (apue.a())) {
            try
            {
              apue.a(false, this.jdField_a_of_type_AndroidAppActivity, new aegv(this));
              return;
            }
          ...
          a(true);
          this.jdField_a_of_type_Aejd.a(this.jdField_a_of_type_Aeht.jdField_a_of_type_Long, this.jdField_a_of_type_Aeht.jdField_a_of_type_Int, 20);
          this.jdField_a_of_type_ComTencentWidgetGallery.b(true);
          this.jdField_a_of_type_ComTencentWidgetGallery.a(true);
          return;
          ...
          return;
          x();
          axqw.b(null, "dc00898", "", "", "0X8009EFD", "0X8009EFD", a(), b(), "" + a("0X8009EFD"), "", "", "");
          return;
          C();
          axqw.b(null, "dc00898", "", "", "0X8009EFC", "0X8009EFC", a(), b(), "" + a("0X8009EFC"), "", "", "");
          return;
          paramView = this.jdField_a_of_type_Aeie.a();
          ...
          else if ((paramView != null) && (paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null) && ((paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) && (((AIOImageData)paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int == 3) && (this.jdField_a_of_type_Aeht != null))
          {
            ...
            Object localObject;
            if ((this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData))
            {
              if (((AIOShortVideoData)this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int == 0)
              {
                if (this.jdField_a_of_type_Agqx != null)
                {
                  this.jdField_a_of_type_Agqx.f();
                  if (this.jdField_a_of_type_Agqx.c()) {
                    paramView.setImageResource(2130845266);
                  }
                  for (;;)
                  {
                    this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.jdField_b_of_type_JavaLangRunnable, 100L);
                    return;
                    paramView.setImageResource(2130845265);
                  }
                }
              }
              else
            ...
            else if (((this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData)) && (this.jdField_a_of_type_Agqx != null))
            {
              this.jdField_a_of_type_Agqx.f();
              if (this.jdField_a_of_type_Agqx.c()) {
                paramView.setImageResource(2130845266);
              ...
              paramView = this.jdField_a_of_type_Aeie.a();
              if (this.jdField_a_of_type_Agqx != null) {
                l1 = this.jdField_a_of_type_Agqx.a();
              }
              for (;;)
              {
                if ((paramView != null) && ((paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)))
                {
                  ...
                  if (localObject != null)
                  {
                    this.jdField_a_of_type_Bcub.a((agrc)localObject, paramView.jdField_a_of_type_Long, l1);
                    this.jdField_a_of_type_Bcub.a(paramView.jdField_a_of_type_JavaLangString, paramView.jdField_c_of_type_Int, paramView.jdField_d_of_type_Int);
                    bool1 = bool2;
                    if (paramView.jdField_c_of_type_Int > paramView.jdField_d_of_type_Int) {
                      bool1 = true;
                    }
                    if (!this.jdField_a_of_type_Bcub.a(bool1, paramView.jdField_g_of_type_Int)) {
                      break;
                    }
                    e();
                    return;
                    ...
                    if (AIOShortVideoData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
                    {
                      ...
                      {
                        if (this.jdField_a_of_type_Aejd != null) {
                          this.jdField_a_of_type_Aejd.b(paramView.jdField_f_of_type_Long, paramView.jdField_f_of_type_Int, 256);
                        }
                        u();
                        break label1084;
                      }
                      ...
                      this.jdField_a_of_type_Aehu.jdField_c_of_type_Boolean = false;
                      u();
                      break label1084;
                    }
                    if (AIOImageData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
                    {
                      ...
                      if (paramView.jdField_a_of_type_Aejb.jdField_c_of_type_Boolean)
                      {
                        if (this.jdField_a_of_type_Aejd != null) {
                          this.jdField_a_of_type_Aejd.b(this.jdField_a_of_type_Aeht.jdField_a_of_type_Long, this.jdField_a_of_type_Aeht.jdField_a_of_type_Int, 4);
                        }
                        paramView.jdField_a_of_type_Aejb.jdField_c_of_type_Boolean = false;
                      }
                      for (;;)
                      {
                        u();
                        break;
                        if (this.jdField_a_of_type_Aejd != null) {
                          this.jdField_a_of_type_Aejd.b(((AIOImageData)localObject).jdField_f_of_type_Long, ((AIOImageData)localObject).jdField_f_of_type_Int, 24);
                        }
                        paramView.jdField_a_of_type_Aejb.jdField_f_of_type_Boolean = true;
                      }
                    }
                    if (!AIOFilePicData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
                      break label1084;
                    ...
                    paramView = (AIOFilePicData)paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                    if (this.jdField_a_of_type_Aejd != null) {
                      this.jdField_a_of_type_Aejd.b(paramView.jdField_f_of_type_Long, paramView.jdField_f_of_type_Int, 24);
                    }
              ...
              if ((paramView != null) && ((paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData)))
              {
                ...
                if (vyi.c(paramView.jdField_c_of_type_JavaLangString))
                {
                  if (this.jdField_a_of_type_Bcub != null) {
                    this.jdField_a_of_type_Bcub.b();
                  }
                  this.jdField_a_of_type_Bcub = new bcub(this.jdField_a_of_type_AndroidAppActivity);
                  this.jdField_a_of_type_Bcub.a(paramView.jdField_c_of_type_JavaLangString, paramView.jdField_f_of_type_Long, l1);
                  if (bbdj.b(paramView.jdField_b_of_type_JavaLangString)) {
                    this.jdField_a_of_type_Bcub.a(paramView.jdField_b_of_type_JavaLangString, paramView.jdField_a_of_type_Int, paramView.jdField_b_of_type_Int);
                  }
                  if (paramView.jdField_a_of_type_Int > paramView.jdField_b_of_type_Int) {}
                  while (this.jdField_a_of_type_Bcub.a(bool1, paramView.jdField_g_of_type_Int))
                  {
                    e();
                    return;
                    bool1 = false;
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((!AIOFileVideoData.class.isInstance(paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) || (this.jdField_a_of_type_Agqx == null)) {
          break label312;
        }
        if ((localMotionEvent == null) || (this.jdField_a_of_type_Agqx == null) || (!this.jdField_a_of_type_Agqx.a(localMotionEvent))) {
          break label314;
        }
        paramAdapterView = (AIOFileVideoData)paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        paramAdapterView.a(paramView, this.jdField_a_of_type_Agqx);
        ...
        e();
        continue;
        if ((this.jdField_a_of_type_Agqx != null) && (localMotionEvent != null) && (this.jdField_a_of_type_Agqx.a(localMotionEvent)))
        {
          if (!this.jdField_a_of_type_Aehu.jdField_b_of_type_Boolean) {
            this.jdField_a_of_type_Agqx.f();
          }
        }
        else {
  ...
  public void onNetMobile2Wifi(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Agqx != null) {
      this.jdField_a_of_type_Agqx.d(1);
    }
    aejm.a().a();
  }
  ...
  public void onProgressChanged(SeekBar paramSeekBar, int paramInt, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      paramSeekBar = this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    label67:
    label127:
    while ((!AIOFileVideoData.class.isInstance(paramSeekBar)) || (this.jdField_a_of_type_Agqx == null))
    {
      Object localObject;
      do
      {
  ...
  public void u()
  {
    if ((this.jdField_a_of_type_Aehu.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Aehu.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Aehu.jdField_e_of_type_Boolean) || (this.jdField_a_of_type_Aehu.jdField_f_of_type_Boolean))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData))
    {
      ...
      {
        this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
        localObject2 = (AIOShortVideoData)this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        if (((AIOShortVideoData)localObject2).jdField_b_of_type_Int != 0) {
          break label683;
        }
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        i1 = this.jdField_a_of_type_Aejd.a(((AIOShortVideoData)localObject2).jdField_f_of_type_Long, ((AIOShortVideoData)localObject2).jdField_f_of_type_Int);
        this.jdField_a_of_type_Agqx.a(8, "");
        if (!((aeja)localObject1).jdField_a_of_type_Aejb.jdField_a_of_type_Boolean) {
          break label364;
        }
        if (QLog.isColorLevel()) {
          QLog.i("AIOGalleryScene", 2, "updateUI selectedItem.longVideoSaving");
        }
        ((aeja)localObject1).jdField_a_of_type_Aejb.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
        this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700056));
        this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
    ...
    {
      label1507:
      if ((this.jdField_k_of_type_Int == 4) || (akpy.a(this.jdField_g_of_type_Int) == 1032))
      {
        this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
        return;
        ...
        else if (((aeja)localObject1).jdField_a_of_type_Aejb.jdField_d_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
        ...
        else if (!((aeja)localObject1).jdField_a_of_type_Aejb.jdField_g_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
            QLog.i("AIOGalleryScene", 2, "updateUI selectedItem.hasEnterPlaying longVideoDownloading=" + ((aeja)localObject1).jdField_a_of_type_Aejb.jdField_h_of_type_Boolean + " selectedItem.state=" + ((aeja)localObject1).jdField_a_of_type_Aejb + " longVideoGetUrl=" + ((aeja)localObject1).jdField_a_of_type_Aejb.jdField_j_of_type_Boolean);
          }
          this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
          this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
          if (((aeja)localObject1).jdField_a_of_type_Aejb.jdField_h_of_type_Boolean) {
            this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          }
          if (((aeja)localObject1).jdField_a_of_type_Aejb.jdField_j_of_type_Boolean) {
            this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          }
        }
        else if (((aeja)localObject1).jdField_a_of_type_Aejb.jdField_k_of_type_Boolean)
        {
          this.jdField_a_of_type_Agqx.a(0, ((AIOShortVideoData)localObject2).a());
          this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
          ((aeja)localObject1).jdField_a_of_type_Aejb.jdField_k_of_type_Boolean = false;
        }
        else
        {
          if (QLog.isColorLevel()) {
          ...
          if (((AIOShortVideoData)localObject2).jdField_b_of_type_Int == 1) {
            if (this.jdField_a_of_type_Aehu.jdField_c_of_type_Boolean)
            {
              this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
              this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
            }
            else if (!((aeja)localObject1).jdField_a_of_type_Aejb.jdField_g_of_type_Boolean)
            {
              this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
              this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
              if (((aeja)localObject1).jdField_a_of_type_Aejb.jdField_i_of_type_Boolean) {
                this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
              }
            }
            else
            {
              ...
              this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
              continue;
              if ((this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData))
              {
                localObject1 = (AIOImageData)this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                localObject2 = this.jdField_a_of_type_Aeie.a();
                this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
                this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
                this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
                a(false);
                i1 = this.jdField_a_of_type_Aejd.a(((AIOImageData)localObject1).jdField_f_of_type_Long, ((AIOImageData)localObject1).jdField_f_of_type_Int);
                if (((aeja)localObject2).jdField_a_of_type_Aejb.jdField_c_of_type_Boolean)
                {
                  this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                  this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                  this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                  this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
                  this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700032) + ((aeja)localObject2).jdField_a_of_type_Aejb.jdField_a_of_type_Int + "%");
                  this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                }
                for (;;)
                {
                  ...
                  this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                  this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
                  this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700063) + ((aeja)localObject2).jdField_a_of_type_Aejb.jdField_a_of_type_Int + "%");
                  this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                  if (this.jdField_a_of_type_Aeht != null) {
                    break label322;
                  }
                  this.jdField_a_of_type_Aeht = new aeht(this);
                  this.jdField_a_of_type_Aeht.jdField_a_of_type_Long = ((AIOImageData)localObject1).jdField_f_of_type_Long;
                  this.jdField_a_of_type_Aeht.jdField_a_of_type_Int = ((AIOImageData)localObject1).jdField_f_of_type_Int;
                  this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb.jdField_c_of_type_Boolean = true;
                  ((AIOImageData)localObject1).jdField_f_of_type_Boolean = false;
                  break label322;
                  if (((aeja)localObject2).jdField_a_of_type_Aejb.jdField_e_of_type_Boolean)
                  {
                    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                    this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
                    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700020));
                    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                    ((aeja)localObject2).jdField_a_of_type_Aejb.jdField_e_of_type_Boolean = false;
                  }
                  else if ((i1 != -1) && (!((aeja)localObject2).jdField_a_of_type_Aejb.jdField_f_of_type_Boolean))
                  {
                    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                    this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress((int)(i1 / 100.0D * 10000.0D));
                    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131700033) + i1 + "%");
                    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                  }
                  else
                  {
              ...
              else if ((this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFilePicData))
              {
                localObject1 = (AIOFilePicData)this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
                if (((AIOFilePicData)localObject1).jdField_a_of_type_Long > 10485760)
                {
                  this.jdField_a_of_type_AndroidWidgetImageButton.setEnabled(false);
                  if (!apvb.b(((AIOFilePicData)localObject1).jdField_d_of_type_JavaLangString)) {
                    break label1615;
                  }
                  this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                  label1526:
              ...
              else if ((this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData))
              {
                localObject1 = (AIOFileVideoData)this.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                this.jdField_a_of_type_Agqx.a(8, "");
                this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                a(true);
                ...
                {
                  this.jdField_a_of_type_Agqx.a(0, ((AIOFileVideoData)localObject1).a());
                  this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
                }
    ...
    for (;;)
    {
      label683:
      label1615:
      if (!this.jdField_a_of_type_Aeie.a().jdField_a_of_type_Aejb.jdField_g_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      }
  ...
  public void w()
  {
    if ((this.t) || (this.jdField_a_of_type_Boolean) || (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_ComTencentWidgetGallery.setSelection(this.jdField_a_of_type_Aeie.b());
    }
  }
  ...
  protected void x()
  {
    ...
    localIntent.putExtra("uintype", this.jdField_g_of_type_Int);
    localIntent.putExtra("extra.IS_FROM_CHAT_AIO_GALLERY", true);
    localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", ((aeja)this.jdField_a_of_type_Xpm.a()).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
    localIntent.putExtra("leftViewText", this.jdField_a_of_type_AndroidAppActivity.getString(2131690832));
  ...
  public void y()
  {
    if ((this.jdField_a_of_type_ComTencentWidgetGallery == null) || (this.jdField_a_of_type_Aeie == null)) {}
    do
    {
      int i1;
      int i2;
      ...
      do
      {
        ...
        i3 = this.jdField_a_of_type_Aeie.b();
  ...
  public void z()
  {
    ...
    if (this.jdField_a_of_type_Aeie.c() == 0)
    {
      auns.b(false);
      bcpw.a(this.jdField_a_of_type_AndroidAppActivity, 2131693019, 0).a();
      this.jdField_a_of_type_AndroidAppActivity.finish();
    }
    for (;;)
    {
      ...
      int i1 = this.jdField_a_of_type_Aeie.b();
