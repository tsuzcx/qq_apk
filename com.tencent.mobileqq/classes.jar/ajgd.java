  ...
  implements akgq
{
  ...
  public ajgd(QQAppInterface paramQQAppInterface)
  {
  ...
  public static akgt a(UpgradeInfo paramUpgradeInfo)
  {
  ...
  private void a(atmp paramatmp, GetResourceRespInfo paramGetResourceRespInfo)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      return;
      localAppShareID = baak.a(paramGetResourceRespInfo);
    } while (localAppShareID == null);
    if (QLog.isColorLevel()) {
      QLog.d("share_appid", 2, "parser share appid from resp info, result:  " + localAppShareID);
    }
    paramGetResourceRespInfo = (AppShareID)paramatmp.a(AppShareID.class, "strPkgName=?", new String[] { paramGetResourceRespInfo.strPkgName });
    if (paramGetResourceRespInfo == null)
    {
      paramatmp.a(localAppShareID);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        paramatmp.b(paramGetResourceRespInfo);
        paramatmp.a(localAppShareID);
        if (QLog.isColorLevel()) {
  ...
  private boolean a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      if ("eggs_android_CI_4.7.1".equals(paramString))
      {
        ...
        {
          bace.d(new File(this.app.getApplication().getFilesDir(), "eggs_config.zip").getAbsolutePath());
          bace.d(acnz.b);
          bool1 = false;
          acnz.a().a(this.app.getApplication());
  ...
  private void b(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    do
    {
        ...
        for (;;)
        {
          ...
          if (localUpgradeInfo != null)
          {
            ...
            if ((localUpgradeInfo.iUpgradeType > 0) && (localUpgradeInfo.bNewSwitch == 1))
            {
              ...
              localObject = "1";
              awqx.b(localQQAppInterface, "CliOper", "", "", "0X8004DA5", "0X8004DA5", 0, 0, (String)localObject, "", akgo.a(), "");
            ...
            for (;;)
            {
              ...
              ((Intent)localObject).putExtra("StrTitle", ajjy.a(2131636631));
              ((Intent)localObject).putExtra("StrUpgradeDesc", ajjy.a(2131636634));
      ...
      if (paramUpgradeDetailWrapper.jdField_a_of_type_ComTencentMobileqqAppNewUpgradeConfig.dialog.jdField_a_of_type_Boolean)
      {
        ...
        bchb.a().a(BaseActivity.sTopActivity, "biz_src_yyb");
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   183: aload_0
    //   184: aload 12
    //   186: invokespecial 731	ajgd:a	(Landroid/content/Intent;)V
    //   189: aload_0
    //   190: bipush 11
    //   192: iload 8
    //   194: iload 6
    //   196: invokestatic 382	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   199: invokevirtual 273	ajgd:notifyUI	(IZLjava/lang/Object;)V
    //   202: return
    //   203: iconst_0
    //   204: istore 8
    //   206: goto -180 -> 26
    ...
    //   433: invokestatic 901	beda:a	(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)Z
    //   436: istore 6
    ...
    //   721: invokestatic 942	beda:a	(Landroid/content/Context;)Z
    //   724: pop
    //   725: iload 5
    //   727: istore 6
    //   729: goto -684 -> 45
  ...
  private void b(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localahye = (ahye)this.app.getManager(114);
    ...
    this.app.a(new ConfigHandler.3(this, paramGetResourceRespInfo, localahye, l1));
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        akgo.a().a(bool1, str2, paramToServiceMsg);
        return;
        i = 0;
        break;
  ...
  {
    aonk.jdField_a_of_type_Boolean = true;
  ...
  private void e(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      localavev = (avev)this.app.getManager(15);
    } while (localavev == null);
    if (!localavev.a(paramGetResourceRespInfo.uiNewVer))
    {
      notifyUI(7, true, Integer.valueOf(100));
      return;
    }
    ...
    this.app.a(new ConfigHandler.6(this, str, localavev, paramGetResourceRespInfo));
  }
  ...
  public int a(ArrayList<GetResourceReqInfo> paramArrayList, GetResourceReqInfo... paramVarArgs)
  {
    ...
    i = avyu.jdField_a_of_type_Int;
    avyu.jdField_a_of_type_Int = i + 1;
  ...
  public void a(int paramInt, UpgradeDetailWrapper paramUpgradeDetailWrapper, akgo paramakgo)
  {
    paramakgo = paramUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo;
    if ((paramInt == 0) && (paramakgo != null))
    {
      BaseApplicationImpl.sApplication.getPackageName();
      a(paramakgo);
      a(this.app, paramakgo.strNewTipsDescURL, paramakgo.iTipsWaitDay);
      b(this.app, paramakgo.strBannerPicUrl, paramakgo.iDisplayDay);
  ...
  public void a(String paramString, int paramInt, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    Object localObject2 = amnb.a(this.app);
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      QQOperationViopTipTask localQQOperationViopTipTask = ((amnb)localObject2).a(((QQOperationViopTipTask)paramArrayList.next()).taskid);
      ...
      ((amnb)localObject2).a(this.app, localQQOperationVoipTipsTaskExcuteRecord);
    }
    notifyUI(8, true, localObject1);
  }
  
  public void a(String paramString, int paramInt, ArrayList<amne> paramArrayList, boolean paramBoolean)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
      ...
      try
      {
        ...
        if (paramInt == 3000)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            if (paramArrayList.hasNext())
            {
              amne localamne = (amne)paramArrayList.next();
              MobileTips.TaskInfo localTaskInfo = new MobileTips.TaskInfo();
              localTaskInfo.task_id.set(localamne.jdField_a_of_type_Int);
              localTaskInfo.msgcnt.set(localamne.b);
              localTaskInfo.keywords.set(localamne.jdField_a_of_type_JavaUtilArrayList);
  ...
  public boolean a()
  {
    boolean bool = beda.b(BaseApplicationImpl.sApplication);
    if (QLog.isDevelopLevel()) {
    ...
    try
    {
      localObject2 = becv.a(new File(BaseApplicationImpl.sApplication.getPackageResourcePath()));
    ...
    ((ToServiceMsg)localObject2).extraData.putInt("mv", amom.a(this.app.getApp()));
    ((ToServiceMsg)localObject2).extraData.putInt("sv", babp.a());
  ...
  public boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    localToServiceMsg.extraData.putInt("mv", amom.a(this.app.getApp()));
    localToServiceMsg.extraData.putInt("sv", babp.a());
  ...
  {
    Object localObject = (avev)this.app.getManager(15);
    if (localObject == null) {
      return null;
    }
    long l = ((avev)localObject).a();
  ...
  public void d()
  {
    ...
    try
    {
      ...
      ((ByteBuffer)localObject).putInt(azzz.a(Long.parseLong(this.app.getAccount()))).putShort((short)16);
  ...
  {
    ajfw localajfw = (ajfw)this.app.getManager(59);
    if (localajfw == null) {
      return null;
    }
    GetResourceReqInfo localGetResourceReqInfo = new GetResourceReqInfo();
    ...
    localGetResourceReqInfo.uiCurVer = localajfw.a(true);
    localGetResourceReqInfo.sResType = 2;
    localGetResourceReqInfo.sLanType = 0;
    localGetResourceReqInfo.sReqType = 1;
    return localGetResourceReqInfo;
  ...
  public void e()
  {
    ...
    do
    {
      ...
      {
        return;
        if (anoc.a().a(this.app, BaseApplicationImpl.getApplication()) != 0) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    else
    {
      ...
      if (paramToServiceMsg.extraData.getBoolean("reqRegionConfig")) {
        ((ajfw)this.app.getManager(59)).a(null);
      }
    }
    label119:
    do
    ...
    for (;;)
    {
      ...
      else if (paramFromServiceMsg.sResType == 2)
      {
        ...
        {
          paramObject = (ajfw)this.app.getManager(59);
          if (paramObject != null) {
      ...
      {
        paramObject = (amyp)this.app.getManager(77);
        if (paramObject != null) {
          paramObject.a(paramFromServiceMsg);
        }
      }
