      ...
      else
      {
        ...
        else
        {
          ...
          if ((localObject1 instanceof MessageRecord))
          {
            ...
            {
              ajgr.a((structmsg.StructMsg)localObject2, ((MessageRecord)localObject1).uniseq, AppConstants.TROOP_SUSPICIOUS_MSG_UIN);
              this.a.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(107);
              ajgr.a((structmsg.StructMsg)localObject2, this.a.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
            }
          }
        }
      }
