  ...
  extends ajuc
{
  ...
  private lns(AVSchema paramAVSchema) {}
  ...
  protected void a(boolean paramBoolean, TroopInfo paramTroopInfo, String paramString)
  {
    ...
    do
    {
      ...
      QLog.w(this.jdField_a_of_type_ComTencentAvShareAVSchema.jdField_a_of_type_JavaLangString, 1, "onGetSimpleTroopInfoResult, isSuc[" + paramBoolean + "], enum_verify_status[" + this.jdField_a_of_type_ComTencentAvShareAVSchema.jdField_a_of_type_Lnq.a + "], seq[" + l + "]");
      this.jdField_a_of_type_ComTencentAvShareAVSchema.jdField_a_of_type_Lnq.b = paramTroopInfo.troopname;
    } while (this.jdField_a_of_type_ComTencentAvShareAVSchema.jdField_a_of_type_Lnq.a != 0);
    if (ChatActivityUtils.a(this.jdField_a_of_type_ComTencentAvShareAVSchema.getActivity(), true, new lnt(this, l)))
    {
