...
import com.tencent.biz.pubaccount.readinjoy.ad.video.strategy.VideoAdExposureManager.1;
...
public class orj
{
  ...
  private pxb jdField_a_of_type_Pxb;
  ...
  public orj(rwy paramrwy, List<VideoInfo> paramList, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, Handler paramHandler)
  {
    ...
    pha.a().getManager(163);
    this.jdField_a_of_type_Pxb = new ork(this);
  }
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    return Math.max(orl.h + paramInt2 + 1, paramInt1 + 1);
  }
  ...
  public static VideoInfo a(AdvertisementInfo paramAdvertisementInfo, boolean paramBoolean)
  {
    ...
    localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo = nxw.a(paramAdvertisementInfo);
    ...
    try
    {
      ...
      {
        localObject = pha.a(paramAdvertisementInfo.mJsonVideoList, paramAdvertisementInfo);
  ...
  private void a(int paramInt, ArrayList<VideoInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        oqh.a("VIDEO_LINK", "fetchChangePosAd : 当前广告位置后面没有广告");
  ...
  private void a(VideoInfo paramVideoInfo, ArrayList<VideoInfo> paramArrayList, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Rwy != null) {
        this.jdField_a_of_type_Rwy.b(paramVideoInfo);
      }
  ...
  private void a(AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localnwv.jdField_a_of_type_Int = paramAdvertisementInfo.mAdMaterialId;
      localnwv.jdField_b_of_type_Int = 1;
      localnwv.jdField_c_of_type_Int = paramAdvertisementInfo.mAdKdPos;
      localnwv.jdField_a_of_type_Long = paramAdvertisementInfo.mAdPosID;
      pmh.a().a().a(paramInt2, this.jdField_a_of_type_Pxb);
      ThreadManager.executeOnSubThread(new VideoAdExposureManager.1(this, paramInt3, paramInt2, localnwv));
      return;
  ...
  private void a(ArrayList<VideoInfo> paramArrayList, int paramInt)
  {
    ...
    } while ((localObject == null) || (!((VideoInfo)localObject).jdField_c_of_type_Boolean) || (((VideoInfo)localObject).jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo == null) || (this.jdField_a_of_type_Rwy == null) || (!this.jdField_a_of_type_Rwy.a(((VideoInfo)localObject).jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h)));
    ...
    oqh.a("VIDEO_LINK", "fetchChangePosAd : 下一个广告存在但是已经曝光过");
    a((VideoInfo)paramArrayList.get(paramInt), paramInt);
  }
  
  private boolean a(int paramInt1, int paramInt2)
  {
    return ((paramInt1 == -1) && (paramInt2 < orl.f) && (this.g >= orl.f)) || (this.g >= orl.g);
  }
    ...
    do
    {
      do
      {
        do
        {
          return false;
          paramsar = paramsar.a;
        } while ((paramsar == null) || (paramsar.jdField_c_of_type_Boolean));
        if ((orl.jdField_a_of_type_Boolean) && (!this.jdField_a_of_type_Boolean)) {
          break;
        }
      } while (!QLog.isColorLevel());
      if (!orl.jdField_a_of_type_Boolean) {
  ...
  private void b(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_Rwy.notifyItemChanged(paramInt);
  }
  ...
  private void b(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    do
    {
      ...
      } while ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecyclerView == null) || (this.jdField_a_of_type_Rwy == null) || ((this.e >= this.jdField_a_of_type_JavaUtilList.size()) && (this.e > 0)));
      ...
      if ((localVideoInfo != null) && (!localVideoInfo.jdField_c_of_type_Boolean) && (this.e > i))
      {
        ...
        oqh.a("AdVideoDataLink", "onAsyncDataReady add at =" + this.e + ", currentAdpaterPosition=" + i);
        this.jdField_a_of_type_Rwy.notifyItemInserted(this.e);
        this.e = 0;
      }
    } while ((localVideoInfo == null) || (!localVideoInfo.jdField_c_of_type_Boolean) || (localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo == null) || (!this.jdField_a_of_type_Rwy.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h)));
    this.jdField_b_of_type_JavaUtilArrayList.remove(paramAdvertisementInfo);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == this.jdField_b_of_type_Int)
        {
          i = this.f;
          this.f = 0;
          AdvertisementInfo localAdvertisementInfo1 = pmh.a().a(paramInt, i);
  ...
  public void a()
  {
    pvu localpvu = pmh.a().a();
    if (localpvu != null)
    {
      localpvu.a(this.jdField_a_of_type_Int);
      localpvu.a(this.jdField_b_of_type_Int);
    }
  }
  ...
  public void a(int paramInt, sar paramsar, ArrayList<VideoInfo> paramArrayList)
  {
    if (orl.a()) {}
    for (;;)
    {
      return;
      if ((paramsar != null) && (paramsar.a != null) && (orl.jdField_a_of_type_Boolean))
      {
        if (!paramsar.a.jdField_c_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoAdExposureManager", 2, "checkAndInsert , mPlayVmCount=" + this.g);
          }
          b(paramInt, paramsar, paramArrayList);
        }
        while (QLog.isColorLevel())
        {
  ...
  public void a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    a(nxw.a(paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo), paramInt, this.jdField_b_of_type_Int, 6);
  }
  ...
  public void a(rxq paramrxq)
  {
    ...
    //   11: monitorexit
    //   12: return
    //   13: getstatic 400	orl:jdField_a_of_type_Boolean	Z
    //   16: ifeq -6 -> 10
    //   19: aload_0
    //   20: iconst_0
    //   21: putfield 401	orj:jdField_a_of_type_Boolean	Z
    //   24: aload_1
    //   25: ifnull -15 -> 10
    //   28: aload_1
    //   29: getfield 495	rxq:a	Lsar;
    //   32: ifnull -22 -> 10
    //   35: aload_1
    //   36: getfield 495	rxq:a	Lsar;
    //   39: getfield 398	sar:a	Lcom/tencent/biz/pubaccount/VideoInfo;
    //   42: ifnull -32 -> 10
    //   45: aload_1
    //   46: getfield 495	rxq:a	Lsar;
    //   49: getfield 398	sar:a	Lcom/tencent/biz/pubaccount/VideoInfo;
    //   52: getfield 112	com/tencent/biz/pubaccount/VideoInfo:jdField_c_of_type_Boolean	Z
    //   55: ifeq -45 -> 10
    //   58: aload_1
    //   59: getfield 495	rxq:a	Lsar;
    //   62: getfield 398	sar:a	Lcom/tencent/biz/pubaccount/VideoInfo;
    ...
    //   71: aload_0
    //   72: aload_1
    //   73: getfield 496	rxq:jdField_b_of_type_Int	I
    //   76: invokevirtual 267	orj:d	(I)V
    ...
    //   101: aload_1
    //   102: getfield 496	rxq:jdField_b_of_type_Int	I
  ...
  public void a(boolean paramBoolean, int paramInt, ArrayList<VideoInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoAdExposureManager", 2, "checkAdPos , hasQueryParam= " + orl.jdField_b_of_type_Boolean + " ,needChangeAdPos =" + orl.jdField_a_of_type_Boolean);
        }
        if (orl.jdField_b_of_type_Boolean)
        {
          boolean bool2 = orl.jdField_a_of_type_Boolean;
          if (!bool2) {
            return;
          }
        }
      ...
      if (!orl.jdField_b_of_type_Boolean)
      {
        orl.jdField_b_of_type_Boolean = true;
        paramBoolean = bool1;
        if (oqi.f(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo))
        {
          paramBoolean = bool1;
        ...
        orl.jdField_a_of_type_Boolean = paramBoolean;
      ...
      try
      {
        ...
        for (orl.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("strategy", 0);; orl.jdField_a_of_type_Int = 2)
        {
          orl.f = ((JSONObject)localObject).optInt("ad_first_pos", 3);
          orl.g = ((JSONObject)localObject).optInt("ad_interval_pos", 3);
          orl.h = ((JSONObject)localObject).optInt("ad_protect_interval", 2);
          orl.jdField_b_of_type_Int = ((JSONObject)localObject).optInt("ad_first_time", 10);
          orl.jdField_c_of_type_Int = ((JSONObject)localObject).optInt("ad_interval_time", 25);
          orl.jdField_d_of_type_Int = ((JSONObject)localObject).optInt("ad_pre_req", 2);
          orl.e = ((JSONObject)localObject).optInt("ad_protect_gap", 2);
          oqh.a("VideoAdStrategy", "setAdStrategyFromServer: strategy = " + orl.jdField_a_of_type_Int + " adFirstTime = " + orl.jdField_b_of_type_Int + " adIntervalTime = " + orl.jdField_c_of_type_Int + " adPreReq = " + orl.jdField_d_of_type_Int + " adProtectGap = " + orl.e + " adFirstPos = " + orl.f + " adIntervalPos = " + orl.g + " adProtectInterval = " + orl.h);
          orl.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true);
          if (orl.jdField_a_of_type_Int == 1)
          {
            localObject = orm.a(paramArrayList);
            if (localObject != null) {
              paramArrayList.removeAll((Collection)localObject);
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("VideoAdExposureManager", 2, "checkAdPos needChangeAdPos = " + orl.jdField_a_of_type_Boolean);
          }
          if ((orl.a()) || (!orl.jdField_a_of_type_Boolean)) {
            break;
          }
      ...
      catch (JSONException localJSONException)
      {
        for (;;)
        {
          ...
          orl.jdField_a_of_type_Boolean = false;
        }
  ...
  public void b(int paramInt, sar paramsar, ArrayList<VideoInfo> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
  ...
  public void d(int paramInt)
  {
    ...
    //   12: return
    //   13: aload_0
    //   14: getfield 57	orj:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   17: iload_1
    ...
    //   59: aload_0
    //   60: getfield 57	orj:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   63: iload_1
