...
public class bfod
{
  ...
  public bfnz a;
  private bfof jdField_a_of_type_Bfof;
  ...
  public bfod(QQAppInterface paramQQAppInterface, PinnedFooterExpandableListView paramPinnedFooterExpandableListView, bfof parambfof)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentWidgetPinnedFooterExpandableListView = paramPinnedFooterExpandableListView;
    this.jdField_a_of_type_Bfof = parambfof;
    this.jdField_a_of_type_Bfnz = new bfnz(paramQQAppInterface);
  }
  ...
  private void e()
  {
    ...
    if (localbfqm != null)
    {
      ArrayList localArrayList1 = this.jdField_a_of_type_Bfof.a();
      if (localArrayList1 != null)
      {
        ...
        localbfqm.a(localArrayList2, new bfoe(this));
      }
    }
  }
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramContext).inflate(2131560418, paramViewGroup, false);
      paramViewGroup = new bfnh();
      paramViewGroup.c = ((ImageView)paramView.findViewById(2131368212));
    ...
    {
      paramContext = aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramRelationTroopEntity.troopInfo.troopuin, 3, aoot.a(4, 3), aoot.a(4, 3));
  ...
  public void a()
  {
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_exp", a(), 0, "", "", "", "");
  }
  ...
  public void a(ArrayList<Groups> paramArrayList, SparseArray<ArrayList<Entity>> paramSparseArray)
  {
    ...
    if (!this.b.isEmpty())
    {
      ...
      ((Groups)localObject2).group_name = anzj.a(2131717429);
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      ((Groups)localObject1).group_name = anzj.a(2131717428);
  ...
  public void b()
  {
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_clk", a(), 0, "", "", "", "");
  }
  
  public void c()
  {
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_exp", a(), 0, "", "", "", "");
  }
  
  public void d()
  {
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_clk", a(), 0, "", "", "", "");
  }
}
