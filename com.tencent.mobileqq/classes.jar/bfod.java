...
public class bfod
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bfof parambfof)
  {
    paramQQAppInterface = a(paramQQAppInterface, paramString, new bfoe(parambfof, paramString));
    if (!baip.a(paramQQAppInterface))
    {
      if (parambfof != null)
      {
        ...
        parambfof.a(0, new String[] { paramQQAppInterface });
      }
      return;
    }
