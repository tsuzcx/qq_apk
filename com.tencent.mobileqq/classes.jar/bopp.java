...
public class bopp
  extends bojn
  implements Handler.Callback, bopo
{
  static File jdField_a_of_type_JavaIoFile;
  public static final String[] a;
  public Handler a;
  public bopn a;
  bopq jdField_a_of_type_Bopq;
  ArrayList<bopr> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  LinkedList<bopn> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  public boolean a;
  ArrayList<bopr> b;
  public boolean b;
  ...
  private bopn a(int paramInt1, String paramString, int paramInt2)
  {
    bopn localbopn = new bopn();
    localbopn.jdField_a_of_type_Int = paramInt1;
    localbopn.jdField_a_of_type_JavaLangString = paramString;
    localbopn.b = paramInt2;
    localbopn.a(this);
    return localbopn;
  }
  ...
  private void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        bopq localbopq = bopq.a(paramString);
        ...
        bgmg.a(localFile.getAbsolutePath(), paramString);
        a(localbopq);
        d();
        return;
      }
  ...
  private void e()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("QIMPredownManager", 2, String.format("startPredown level:%d  queue:%d  left:%d", new Object[] { Integer.valueOf(this.jdField_a_of_type_Bopq.jdField_a_of_type_Int), Integer.valueOf(this.jdField_a_of_type_JavaUtilLinkedList.size()), Integer.valueOf(this.jdField_b_of_type_JavaUtilArrayList.size()) }));
    }
    ...
    bopr localbopr = (bopr)localArrayList.get(j);
    bopn localbopn;
    if (this.jdField_a_of_type_Bopq.jdField_a_of_type_Int >= localbopr.b)
    {
      localbopn = a(localbopr.jdField_a_of_type_Int, localbopr.jdField_a_of_type_JavaLangString, localbopr.c);
      switch (localbopn.a())
      {
      }
    }
    for (;;)
    {
      j += 1;
      break;
      this.jdField_b_of_type_JavaUtilArrayList.remove(localbopr);
      this.jdField_a_of_type_JavaUtilLinkedList.offer(localbopn);
      continue;
      this.jdField_a_of_type_JavaUtilArrayList.remove(localbopr);
      this.jdField_b_of_type_JavaUtilArrayList.remove(localbopr);
      i = 1;
    }
  }
  ...
  public void a(bopq parambopq)
  {
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_b_of_type_JavaUtilArrayList.clear();
    this.jdField_a_of_type_JavaUtilLinkedList.clear();
    this.jdField_a_of_type_Bopq = parambopq;
    ...
    {
      parambopq = parambopq.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (parambopq.hasNext())
      {
        localObject1 = (bopr)parambopq.next();
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        try
        {
          ...
          localObject2 = parambopq.jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            bopr localbopr = (bopr)((Iterator)localObject2).next();
            if (localbopr.jdField_a_of_type_Int == k)
            {
              this.jdField_a_of_type_JavaUtilArrayList.add(localbopr);
              this.jdField_b_of_type_JavaUtilArrayList.add(localbopr);
            }
          }
        }
  ...
  public void a(boolean paramBoolean, bopn parambopn)
  {
    Handler localHandler = this.jdField_a_of_type_AndroidOsHandler;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      parambopn = Message.obtain(localHandler, 2, i, 0, parambopn);
      this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(parambopn, 3000L);
      return;
    }
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Bopq != null) {
      return;
    }
    ...
    try
    {
      localObject4 = bgmg.a((File)localObject4);
      localObject1 = localObject2;
      localObject2 = bopq.a((String)localObject4);
      localObject1 = localObject2;
      if (QLog.isColorLevel())
      {
        localObject1 = localObject2;
    ...
    try
    {
      String str = bosu.a("predownload11111.cfg");
      localObject4 = localObject1;
      localObject1 = bopq.a(str);
      localObject2 = localObject1;
      localObject4 = localObject1;
      if (QLog.isColorLevel())
      {
  ...
  public void d()
  {
    ...
    {
      bopr localbopr = (bopr)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (i == 0) {
        ((StringBuilder)localObject).append(localbopr.jdField_a_of_type_Int);
      }
      for (;;)
      {
        i += 1;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          localObject1 = (bopn)paramMessage.obj;
          if (QLog.isColorLevel()) {
            QLog.i("QIMPredownManager", 2, "onJobFinish: " + ((bopn)localObject1).jdField_a_of_type_Int + ", " + ((bopn)localObject1).jdField_a_of_type_JavaLangString);
          }
          localObject2 = new QIMPredownHistory();
          ((QIMPredownHistory)localObject2).resId = ((bopn)localObject1).jdField_a_of_type_JavaLangString;
          ...
          if (paramMessage.arg1 == 1)
          {
            ...
            if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
            {
              paramMessage = (bopr)this.jdField_a_of_type_JavaUtilArrayList.get(i);
              if (paramMessage.jdField_a_of_type_Int != ((bopn)localObject1).jdField_a_of_type_Int) {
                break label366;
              }
              if (QLog.isColorLevel()) {
                QLog.i("QIMPredownManager", 2, "onJobFinish: remove " + ((bopn)localObject1).jdField_a_of_type_Int + ", " + ((bopn)localObject1).jdField_a_of_type_JavaLangString);
              }
        ...
        if (a())
        {
          ...
          if (i != 0)
          {
            paramMessage = (bopn)this.jdField_a_of_type_JavaUtilLinkedList.poll();
            if (paramMessage != null)
            {
              ...
              for (;;)
              {
                ...
                i += 1;
                break;
                this.jdField_a_of_type_Bopn = paramMessage;
                paramMessage.a();
                i = 0;
                continue;
                this.jdField_a_of_type_Bopn = paramMessage;
      ...
      localObject3 = this.jdField_a_of_type_Bopq;
    ...
    if ((localObject2 != null) && (!((List)localObject2).isEmpty()))
    {
      ...
      i = 1;
      label649:
      localObject2 = new bcva();
      ((bcva)localObject2).d = "0X80090DF";
      ((bcva)localObject2).f = String.valueOf(m);
      ((bcva)localObject2).h = ((String)localObject1);
      ((bcva)localObject2).i = String.valueOf(bgsg.A(BaseApplicationImpl.context));
      if (j == 0) {
        break label877;
      }
      paramMessage = "2";
      label705:
      ((bcva)localObject2).j = paramMessage;
      int k = -1;
      paramMessage = ((bopq)localObject3).jdField_b_of_type_JavaUtilArrayList.iterator();
      do
      {
        j = k;
        ...
        localObject3 = (bopr)paramMessage.next();
      } while ((!TextUtils.equals((CharSequence)localObject1, ((bopr)localObject3).jdField_a_of_type_JavaLangString)) || (m != ((bopr)localObject3).c));
      j = ((bopr)localObject3).b;
      if ((j == -1) && (i == 0)) {
        break label884;
      }
      paramMessage = "1";
      label788:
      ((bcva)localObject2).k = paramMessage;
      paramMessage = new bopn();
    ...
    {
      ((bcva)localObject2).l = paramMessage;
      ((bcva)localObject2).m = String.valueOf(j);
      bcsp.a(null, (bcva)localObject2);
      break;
      j = 0;
      break label548;
      label872:
