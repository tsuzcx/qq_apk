...
{
  public nzd(NowVideoView paramNowVideoView) {}
  ...
  public void onStateChange(String paramString, QQLiveDrawable.QQLiveDrawableParams paramQQLiveDrawableParams, int paramInt, Object paramObject)
  {
    ...
    if (paramInt == 3)
    {
      ...
      if (paramString != null)
      {
        ...
        paramString.setImageResource(2130843292);
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        ...
        {
          paramString.clearAnimation();
          paramString.setImageResource(2130843294);
          paramString.setVisibility(0);
        }
      }
      else if (paramInt == 4)
      ...
      else if (paramInt == 5)
      {
        if (paramString != null)
        {
          paramString.clearAnimation();
          paramString.setVisibility(0);
          paramString.setImageResource(2130843290);
        }
        if (!NetworkUtil.isNetworkAvailable(this.a.getContext()))
        {
          QQToast.a(this.a.getContext(), 1, 2131694256, 0).b(NowVideoView.g);
          return;
        }
        if (this.a.jdField_a_of_type_JavaUtilList.size() > 0)
        {
          ...
          this.a.jdField_a_of_type_Nze.a();
        }
