  ...
  implements SurfaceHolder.Callback
{
  ...
  public void surfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    {
      anie.a(amlh.a(this.a)).a().setRenderMgrAndHolder(GraphicRendererMgr.getInstance(), paramSurfaceHolder);
      anie.a(amlh.a(this.a)).a().getVideoCtrl().setLocalVideoPreviewCallback(new amlj(this));
      anie.a(amlh.a(this.a)).a().getVideoCtrl().setRemoteVideoPreviewCallback(new amlk(this));
    }
    for (;;)
    {
  ...
  public void surfaceDestroyed(SurfaceHolder paramSurfaceHolder)
  {
    ...
    paramSurfaceHolder.enableCamera(0, false, new amll(this));
