  ...
  extends awop
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = awou.class.getSimpleName();
  }
  
  public awou(String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
    this.jdField_b_of_type_JavaLangString = "itemList";
  }
  
  public awou(String paramString, long paramLong, List<String> paramList, DynamicSearch.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
    this.jdField_b_of_type_JavaLangString = "itemList";
  }
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      ...
      {
        paramString = new awox(this.g, this.jdField_a_of_type_Long, this.jdField_b_of_type_JavaUtilList, this.c, localJSONObject, n, (DynamicSearch.ResultItem)a());
      }
      else if ((a() instanceof UnifySearchCommon.ResultItem))
      {
        paramString = new awox(this.g, this.jdField_a_of_type_Long, this.jdField_b_of_type_JavaUtilList, this.c, localJSONObject, n, (UnifySearchCommon.ResultItem)a());
        continue;
        label273:
        i = 0;
        continue;
