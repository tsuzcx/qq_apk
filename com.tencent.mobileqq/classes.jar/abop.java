...
public class abop
{
  ...
  public abop(GdtMotiveVideoPageData paramGdtMotiveVideoPageData)
  {
    abrl.a("GdtMotiveVideoModel", "[GdtMotiveVideoModel]\n" + paramGdtMotiveVideoPageData.adsContent);
  ...
  private void b(GdtMotiveVideoPageData paramGdtMotiveVideoPageData)
  {
    ...
    {
      abrl.d("GdtMotiveVideoModel", "[adJson==null error]");
      return;
    }
    try
    {
      this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo = ((qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(abrk.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramGdtMotiveVideoPageData.adsContent))));
      return;
    }
    catch (Throwable paramGdtMotiveVideoPageData)
    {
      abrl.d("GdtMotiveVideoModel", "GdtMotiveVideoModel error]", paramGdtMotiveVideoPageData);
    }
  }
