  ...
  implements Cursor
{
  ...
  protected abop(abor paramabor, List<MessageRecord> paramList)
  {
    this.jdField_a_of_type_Abor = paramabor;
  ...
  private Object a(int paramInt)
  {
    ...
    case 14: 
      return bdbt.a(this.jdField_a_of_type_Abor.a(), localMessageRecord.senderuin, localMessageRecord.frienduin, 1, 0);
    case 15: 
      if (localMessageRecord.istroop == 3000) {
        return bdbt.d(this.jdField_a_of_type_Abor.a(), localMessageRecord.senderuin);
      }
      if (localMessageRecord.istroop == 1) {
        return ((TroopManager)this.jdField_a_of_type_Abor.a().getManager(52)).a(localMessageRecord.senderuin);
      }
      return bdbt.a(this.jdField_a_of_type_Abor.a(), localMessageRecord.senderuin);
    case 16: 
      return Integer.valueOf(((aloz)this.jdField_a_of_type_Abor.a().getManager(51)).b(localMessageRecord.frienduin));
    case 17: 
