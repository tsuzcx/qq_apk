  ...
  extends ImageBase
{
  ...
  private qva jdField_a_of_type_Qva = new qva();
  
  public qin(VafContext paramVafContext)
  {
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Qva.a.a() == null) || (this.jdField_a_of_type_Qva.a.a().mSocialFeedInfo == null) || (this.jdField_a_of_type_Qva.a.a().mSocialFeedInfo.a == null))
    {
    ...
    int j = localResources.getDisplayMetrics().widthPixels - afur.a(24.0F, localResources);
    int k = (int)(j * 0.598F);
    float f1 = localResources.getDisplayMetrics().density;
    int i;
    float f2;
    ViewGroup.LayoutParams localLayoutParams;
    if (this.jdField_a_of_type_Qva.a.a().mSocialFeedInfo.a.a.size() > 0)
    {
      i = ((rht)this.jdField_a_of_type_Qva.a.a().mSocialFeedInfo.a.a.get(0)).a;
      int m = ((rht)this.jdField_a_of_type_Qva.a.a().mSocialFeedInfo.a.a.get(0)).b;
      f2 = afur.a(i / 2, localResources);
      f1 = afur.a(m / 2, localResources);
      i = ((rht)this.jdField_a_of_type_Qva.a.a().mSocialFeedInfo.a.a.get(0)).c;
    ...
    for (;;)
    {
      if (i == 1)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717199);
      }
      ...
      if ((f2 < j) && (f1 > k))
      {
        ...
        {
          f1 = k;
          f2 = afur.a(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717200);
        }
        else
        {
          f2 *= k / f1;
      ...
      else if ((f2 > j) && (f1 < k))
      {
        ...
        {
          f2 = j;
          f1 = afur.a(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131717201);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        else
        {
