...
{
  public adbq(ArkAppView paramArkAppView) {}
  ...
  public void onFocusChanged(View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      Object localObject2 = this.a.getResources().getDrawable(2130838469);
      Object localObject1 = this.a.getResources().getDrawable(2130838468);
  ...
  public void onSelectChanged(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0) && ((paramInt1 < paramInt3) || (paramInt2 < paramInt4)))
    {
      ...
      int i = j;
      if (j <= 0) {
        i = this.a.getResources().getDrawable(2130838469).getIntrinsicWidth();
      }
    ...
    for (;;)
    {
      ...
      paramInt1 = paramInt2;
      if (paramInt2 <= 0) {
        paramInt1 = this.a.getResources().getDrawable(2130838468).getIntrinsicWidth();
      }
  ...
  public void onShowMenu(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      localbakh.a(0, ajjy.a(2131634855));
      localbakh.a(1, ajjy.a(2131634851));
      localbakh.a(2, ajjy.a(2131634852));
    }
    for (;;)
    {
      int i = this.a.getResources().getDrawable(2130838468).getIntrinsicHeight();
      ArkViewImplement.ArkViewInterface localArkViewInterface = (ArkViewImplement.ArkViewInterface)paramView;
      ArkAppView.a(this.a, baay.a(paramView, paramInt1, paramInt2, paramInt3 + i, localbakh, new adbr(this, paramInt4, localArkViewInterface)));
      return;
      if (paramInt4 == 1)
      {
        localbakh.a(0, ajjy.a(2131634854));
        localbakh.a(1, ajjy.a(2131634850));
        localbakh.a(2, ajjy.a(2131634853));
      }
      else
      {
        localbakh.a(0, ajjy.a(2131634856));
      }
    }
  }
}
