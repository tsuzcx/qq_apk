...
public class axwb
{
  ...
  private final axvu jdField_a_of_type_Axvu;
  private final bnnt jdField_a_of_type_Bnnt;
  private final String jdField_a_of_type_JavaLangString;
  private ByteBuffer jdField_a_of_type_JavaNioByteBuffer;
  private final List<axwd> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public axwb(bnnt parambnnt, String paramString, axvu paramaxvu)
  {
    this.jdField_a_of_type_Bnnt = parambnnt;
  ...
  private void b()
  {
    ...
    axwd localaxwd;
    for (int i = 0; localIterator.hasNext(); i = axwd.b(localaxwd) + i)
    {
      localaxwd = (axwd)localIterator.next();
      axwd.a(localaxwd, localBufferInfo, i);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(a(axwd.a(localaxwd)), this.jdField_a_of_type_JavaNioByteBuffer, localBufferInfo);
    }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bnnt.a())
      {
  ...
  public void a(int paramInt, ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new axwd(paramInt, paramBufferInfo.size, paramBufferInfo, null));
      return;
    }
