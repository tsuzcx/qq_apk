...
{
  protected WeakReference<agpq> a;
  
  public agps(WeakReference<agpq> paramWeakReference)
  {
  ...
  public void onGetAppPathByName(int paramInt, String paramString, ArkAppMgr.AppPathInfo paramAppPathInfo, Object paramObject)
  {
    ...
    for (paramString = paramAppPathInfo.path;; paramString = null)
    {
      ...
      if ((paramAppPathInfo != null) && (paramAppPathInfo.appTempInfo != null))
      {
        ...
        agpq.a(paramObject).view = str2;
      }
      agpq.a(paramAppPathInfo);
