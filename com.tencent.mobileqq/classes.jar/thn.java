  ...
  implements tgs, tgx
{
  ...
  private tjk jdField_a_of_type_Tjk = new tjk();
  ...
  private void a(Container paramContainer, RecommendAdData paramRecommendAdData)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        if (!ois.a(BaseApplicationImpl.getContext(), paramRecommendAdData.h)) {
          break label197;
        }
  ...
  public tgr a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    try
    {
      ...
      piv.a(((Container)paramViewGroup).getVirtualView(), localProteusItemData.a.getViewBean());
      paramBaseData = paramViewGroup;
    ...
    return new tho(this, paramViewGroup, localProteusItemData);
  }
