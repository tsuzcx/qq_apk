...
public class uye
  implements Handler.Callback, IEventReceiver, tjc, vce
{
  ...
  private tcw jdField_a_of_type_Tcw = (tcw)tcz.a(5);
  ...
  private tjb jdField_b_of_type_Tjb;
  
  public uye(Looper paramLooper)
  {
    this.jdField_a_of_type_Vca = new vca();
    this.jdField_a_of_type_Vca.a(this);
    this.jdField_a_of_type_Uyg = new uyg(this);
    this.jdField_a_of_type_Uyf = new uyf(this, this);
    stb.a().registerSubscriber(this.jdField_a_of_type_Uyg);
    stb.a().registerSubscriber(this.jdField_a_of_type_Uyf);
  }
  ...
  public StoryVideoItem a(String paramString)
  {
    ...
    {
      localStoryVideoItem1 = this.jdField_a_of_type_Tcw.a(paramString);
    }
  ...
  public void a()
  {
    ...
    stb.a().unRegisterSubscriber(this.jdField_a_of_type_Uyg);
    stb.a().unRegisterSubscriber(this.jdField_a_of_type_Uyf);
    this.jdField_a_of_type_Vca.a();
    if (this.jdField_a_of_type_Tjb != null) {
      this.jdField_a_of_type_Tjb.a();
    }
    if (this.jdField_b_of_type_Tjb != null) {
      this.jdField_b_of_type_Tjb.a();
    }
  }
  ...
  public void a(QQStoryAutoPlayView paramQQStoryAutoPlayView, List<uxm> paramList)
  {
    StoryVideoItem localStoryVideoItem = paramQQStoryAutoPlayView.a();
    if (localStoryVideoItem == null) {
      vei.b("story_home_dev", "feed_play_req", 0, 3, new String[0]);
    }
    boolean bool;
    do
    {
      return;
      this.jdField_a_of_type_Vca.a(this.jdField_a_of_type_Tcw.a(localStoryVideoItem.mVid), paramList);
      bool = StoryVideoItem.isPlayable(localStoryVideoItem.mVid, false);
      paramList = null;
      if (bool) {
        paramList = suj.a(localStoryVideoItem.mVid, 0, false, false);
      }
      if (a(localStoryVideoItem)) {
        break;
      }
      ved.a("Q.qqstory.home.AutoPlayManager", "AutoPlayManager that need to req the storyVideoItem vid=%s cover=%s", localStoryVideoItem.mVid, localStoryVideoItem.getThumbUrl());
    ...
    vei.b("story_home_dev", "feed_play_req", 0, 2, new String[] { localStoryVideoItem.mVid });
    return;
    if ((bool) && (paramList != null))
    {
      ved.b("Q.qqstory.home.AutoPlayManager", "AutoPlayManager that have the mp4 file,do play now vid+" + localStoryVideoItem.mVid + " cover=" + localStoryVideoItem.getThumbUrl());
      if (localStoryVideoItem.mErrorCode != 0) {
        ved.e("Q.qqstory.home.AutoPlayManager", "AutoPlayManager request the error video to auto play error code=" + localStoryVideoItem.mErrorCode);
      }
      File localFile = suj.a(localStoryVideoItem.mVid, 1, false, false);
      vxp.a(paramList);
      paramQQStoryAutoPlayView.a(paramList, localFile);
      vei.b("story_home_dev", "feed_play_req", 1, 0, new String[] { localStoryVideoItem.mVid });
      return;
    }
    vei.b("story_home_dev", "feed_play_req", 0, 1, new String[] { localStoryVideoItem.mVid });
  }
  
  public void a(String paramString1, String paramString2)
  {
    ved.b("Q.qqstory.home.AutoPlayManager", "AutoPlayManager onSuccess = " + paramString1);
    paramString2 = new vbw();
    paramString2.a = paramString1;
    stb.a().dispatch(paramString2);
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString1);
    vei.b("auto_play", "rsp_down", 0, 0, new String[] { paramString1 });
  }
  
  public void a(String paramString1, String paramString2, ErrorMessage paramErrorMessage)
  {
    ved.b("Q.qqstory.home.AutoPlayManager", "AutoPlayManager onError = " + paramString1);
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString1);
    vei.b("auto_play", "rsp_down", 1, 0, new String[] { paramString1 });
  }
  ...
  public void a(List<String> paramList)
  {
    ...
    ved.a("Q.qqstory.home.AutoPlayManager", "fetchStoryVideoItemByVid, request=%s, original=%s", new JSONArray(localArrayList), new JSONArray(paramList));
    if (localArrayList.size() > 0)
    {
      this.jdField_a_of_type_Tjb = tjb.a(localArrayList);
      this.jdField_a_of_type_Tjb.a("Q.qqstory.home.AutoPlayManager");
  ...
  {
    ved.b("Q.qqstory.home.AutoPlayManager", "AutoPlayManager onPause = " + paramString1);
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString1);
    vei.b("auto_play", "rsp_down", 2, 0, new String[] { paramString1 });
  }
    ...
    for (;;)
    {
      ...
      while (paramMessage.hasNext())
      {
        ...
        if ((localStoryVideoItem.mErrorCode == 0) && ((TextUtils.isEmpty(localStoryVideoItem.mVideoUrl)) || (localStoryVideoItem.mVideoDuration < 0L) || (localStoryVideoItem.mSourceType == -1))) {
          vxp.a("handleMessage is illegal debug info=%s", new Object[] { localStoryVideoItem });
        }
