...
public class bcql
{
  ...
  private static bcqq jdField_a_of_type_Bcqq = new bcqq(Looper.getMainLooper(), null);
  ...
  private static BlockingQueue<bcqp> jdField_a_of_type_JavaUtilConcurrentBlockingQueue = new LinkedBlockingQueue();
  ...
  public bcql(Context paramContext)
  {
  ...
  public static bcql a(Context paramContext, int paramInt1, int paramInt2)
  {
    return a(paramContext, 0, paramInt1, paramInt2);
  }
  
  public static bcql a(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    paramContext = new bcql(paramContext);
  ...
  public static bcql a(Context paramContext, int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    paramContext = new bcql(paramContext);
    paramContext.a(a(paramInt1));
    paramContext.b(paramInt1);
  ...
  public static bcql a(Context paramContext, CharSequence paramCharSequence, int paramInt)
  {
    ...
    do
    {
      ...
      if ((jdField_a_of_type_Int == -1) || (paramBoolean))
      {
        ...
        if ((i == 0) && (jdField_a_of_type_Int == 1))
        {
          ...
          axqy.b(null, "dc00898", "", "", "0X8009ACA", "0X8009ACA", 0, 0, "", "", "", "");
        }
      }
  ...
  {
    return a(paramInt, 2131561133, null);
  }
  
  public Toast a(int paramInt1, int paramInt2, View.OnTouchListener paramOnTouchListener)
  {
    bcqo localbcqo = new bcqo(this.jdField_a_of_type_AndroidContentContext);
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      localbcqo.setGravity(55, 0, 0);
    }
    for (;;)
    {
      localbcqo.setView(localView);
      localbcqo.setDuration(this.c);
      if (a()) {
        localView.setOnTouchListener(new bcqm(this, localbcqo, paramOnTouchListener));
      }
      return localbcqo;
      ...
      if (paramInt1 == 6316128) {
        localbcqo.setGravity(55, 0, b());
      } else {
        localbcqo.setGravity(55, 0, c());
      }
    }
  }
  ...
  public void a(bcqn parambcqn)
  {
    parambcqn = new bcqp(this, parambcqn);
    jdField_a_of_type_JavaUtilConcurrentBlockingQueue.add(parambcqn);
    jdField_a_of_type_Bcqq.sendEmptyMessage(1);
    if (QLog.isColorLevel()) {
