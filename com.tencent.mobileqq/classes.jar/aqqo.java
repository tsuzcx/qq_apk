  ...
  extends WebViewPlugin
{
  ...
  {
    paramString2 = (birg)super.getBrowserComponent(2);
    int i1;
    int k;
    int i;
    int j;
    ...
    if (paramString2 != null)
    {
      ...
      catch (Exception paramVarArgs)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            {
              paramJsBridgeListener = paramString3.getDrawable(2130844955);
            }
      ...
      {
        paramJsBridgeListener = paramString3.getDrawable(2130844956);
        if (j <= 3) {
          break label278;
        }
        k = 3;
