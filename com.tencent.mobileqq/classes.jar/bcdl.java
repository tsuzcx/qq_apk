  ...
  extends WebViewClient
{
  ...
  WebResourceResponse a(WebView paramWebView, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        if (ahhz.a(paramString1))
        {
          WebResourceResponse localWebResourceResponse = ahhz.a(paramString1);
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramWebView = new Bundle();
          paramWebView.putStringArrayList("recognised-text", bcfd.a());
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      actd.b(this.b.jdField_a_of_type_AndroidContentIntent, str);
      paramString = bcgc.b(str);
      if ((this.b.jdField_a_of_type_Bccj == null) || (!this.b.jdField_a_of_type_Bccj.c(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str))) {
        break label298;
      }
      ...
      break;
      label261:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + nax.b(str, new String[0]));
    }
    label298:
    if ((("http".equals(paramString)) || ("data".equals(paramString))) && (!str.contains("/cgi-bin/httpconn?htcmd=0x6ff0080"))) {
      CustomWebView.addContextLog(nax.b(str, new String[0]));
    }
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Bccj != null) && (this.b.jdField_a_of_type_Bccj.b(paramWebView, str))) {
        return true;
      }
      ...
      {
        boolean bool = this.b.jdField_a_of_type_Bccj.a(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str);
        if (bool) {
          return true;
        }
      }
