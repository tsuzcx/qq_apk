  ...
  implements alac, ARNativeBridge.ActionCallback
{
  ...
  public alar(alae paramalae, alas paramalas)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)this.jdField_a_of_type_Alae.a(paramalas.jdField_a_of_type_Int));
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 2: 
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge.nativeCreateEngine(this.jdField_b_of_type_Int, this.jdField_a_of_type_Alas.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getAssets(), this.jdField_a_of_type_Alas.c, this.d, this.e);
    ...
    case 7: 
      ...
      return;
    case 9: 
      this.jdField_a_of_type_Alae.a(new GeneralAR3DRenderable.1(this));
      return;
    case 8: 
  ...
  {
    if ((this.jdField_a_of_type_Alas != null) && (this.jdField_a_of_type_Alas.jdField_b_of_type_Int == 1))
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Alas != null) {
      return this.jdField_a_of_type_Alas.jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  {
    if (this.jdField_a_of_type_Alas != null) {
      return this.jdField_a_of_type_Alas.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Alas.jdField_a_of_type_JavaLangString;
  }
  ...
  public void callback(int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_Alae.b(3, 0);
      return;
    }
    this.jdField_a_of_type_Alae.b(2, 0);
  }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Akxp = new akxp(this.jdField_a_of_type_Alas.d, "");
      a(2);
    }
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Int == 9)
    {
      ...
      if (this.jdField_a_of_type_Alae != null)
      {
        this.jdField_a_of_type_Alae.a(this.jdField_a_of_type_Alas.jdField_a_of_type_JavaLangString);
