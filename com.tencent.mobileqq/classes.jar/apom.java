...
public class apom
{
  ...
  public static void a(List<String> paramList)
  {
    ...
    Object localObject1 = (QQAppInterface)blqh.a();
    apon localapon = (apon)((QQAppInterface)localObject1).getManager(149);
    alsb localalsb = (alsb)((QQAppInterface)localObject1).a(72);
    ...
    for (;;)
    {
      ...
      if (!a(localCustomEmotionData1.emoOriginalPath))
      {
        ...
        localapon.c(localCustomEmotionData1);
        localalsb.notifyUI(2, true, null);
        a(false, 1, 0);
        i = k + 1;
        k = i;
        break;
      ...
      localObject2 = alof.bi + amqy.a(str1) + str3 + (String)localObject2;
      boolean bool = bdhb.d((String)localObject1, (String)localObject2);
      if (QLog.isColorLevel()) {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localapon.a(localCustomEmotionData2, localList.indexOf(localCustomEmotionData2));
          i = 1;
        }
      }
      for (;;)
      {
        ...
        {
          localapon.a(localCustomEmotionData2);
        }
        else
        {
          n = 1;
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      ...
      azri.a(BaseApplication.getContext()).a(null, "FavEmoUploadLocal", false, 0L, 0L, localHashMap, null);
      if (!paramBoolean) {
        break label91;
      }
    }
  ...
  public static boolean a(String paramString)
  {
    try
    {
      aonm localaonm = (aonm)aoks.a().a(561);
      if (new File(paramString).length() >= localaonm.a) {
        return false;
      }
      if (!awkr.a(paramString))
      {
        ...
        if (localOptions.outWidth < localaonm.b)
        {
