...
public class affv
  extends antq
{
  public affv(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  protected void onKickoutDiscussionMember(boolean paramBoolean, Long paramLong1, Long paramLong2)
  {
    if (paramBoolean)
    {
      bdla.b(this.a.app, "CliOper", "", "", "0X80040F5", "0X80040F5", 0, 0, "", "", "", "");
      this.a.a(paramLong2 + "");
      ...
      {
        this.a.b(paramLong2 + "");
        if (this.a.jdField_a_of_type_Afgm != null) {
    ...
    for (;;)
    {
      ...
      return;
      QQToast.a(this.a, 1, this.a.getString(2131693426), 0).b(this.a.getTitleBarHeight());
    }
  }
