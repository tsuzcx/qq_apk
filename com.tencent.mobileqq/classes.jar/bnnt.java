...
public class bnnt
{
  public static int a(String paramString, bnnu parambnnu)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          parambnnu.a[0] = Integer.parseInt(str1);
          parambnnu.a[1] = Integer.parseInt(str2);
          parambnnu.a[3] = Integer.parseInt(str3);
          i = 0;
        }
        ...
        try
        {
          parambnnu.a[2] = Integer.parseInt(paramString);
          parambnnu.a[4] = 0;
          return i;
        }
