  ...
  extends PopupWindow
{
  ...
  public tbk(Activity paramActivity)
  {
    super(paramActivity);
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)localObject).inflate(2131560074, null);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365073));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379077));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379076));
    localObject = a((LayoutInflater)localObject);
    if (localObject != null) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout.addView((View)localObject);
    }
    setBackgroundDrawable(new ColorDrawable(0));
    this.jdField_a_of_type_Int = ((int)(this.c - this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298778) * 2.0F));
  ...
  protected final void a(View paramView)
  {
    ...
    int j = (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298778);
  ...
  public void b()
  {
    setOnDismissListener(new tbl(this));
  }
}
