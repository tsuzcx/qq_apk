...
public class benv
{
  ...
  public benv(Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  private void b()
  {
    betc.a("ToastView", "show mParentView=" + this.jdField_a_of_type_AndroidViewViewGroup + ",toastLayout=" + this.jdField_a_of_type_AndroidViewView);
  ...
  public void a()
  {
    ...
    betc.a("ToastView", "hide mParentView=" + this.jdField_a_of_type_AndroidViewViewGroup + ",toastLayout=" + this.jdField_a_of_type_AndroidViewView);
    if ((this.jdField_a_of_type_AndroidViewViewGroup != null) && (this.jdField_a_of_type_AndroidViewView != null)) {
  ...
  {
    betc.a("ToastView", "show iconType=" + paramString1 + ",localIconPath=" + paramString2 + ",msg=" + paramCharSequence + ",duration=" + paramInt2 + ",mask=" + paramBoolean);
    a();
