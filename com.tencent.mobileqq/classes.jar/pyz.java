  ...
  implements ViewBase.OnClickListener
{
  ...
  public pyz(ArticleInfo paramArticleInfo, Context paramContext, int paramInt)
  {
  ...
  private long a()
  {
    long l2 = 0L;
    long l1;
    if ((sel.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) || (this.jdField_a_of_type_Int == 77) || (this.jdField_a_of_type_Int == 78))
    {
      l1 = l2;
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  if ((!sel.g(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) && (this.jdField_a_of_type_Int != 72) && (this.jdField_a_of_type_Int != 74)) {
                    break;
                  }
                  l1 = l2;
                } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo == null);
                l1 = l2;
              } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl == null);
              return this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.jdField_a_of_type_Long;
            ...
            l1 = l2;
          } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt == null);
          return this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt.jdField_a_of_type_Long;
          if ((sel.f(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) || (this.jdField_a_of_type_Int == 73)) {
            break;
          }
          l1 = l2;
  ...
  private void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("feeds_type", ozs.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
        ...
        if (NetworkState.isWifiConn())
        {
          ...
          localJSONObject.put("feeds_source", ozs.d(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
  ...
  public void onClick(ViewBase paramViewBase)
  {
    ...
    if ((paramViewBase != null) && (!paramViewBase.isEmpty()))
    {
      ...
      localBundle.putString("feeds_source", ozs.d(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      ...
      afez.a(this.jdField_a_of_type_AndroidContentContext, localIntent, PublicTransFragmentActivity.class, ReadInjoyFriendsBiuComponentFragment.class);
    }
    a();
    if (QLog.isColorLevel()) {
