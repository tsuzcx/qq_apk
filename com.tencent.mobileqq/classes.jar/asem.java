...
public class asem
{
  private static asem a = new asem();
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2)
  {
    ...
    if ((paramString2 != null) && (paramString2.length() > 0) && (paramString1 != null) && (paramString1.length() > 0))
    {
      try
      {
        ...
        {
          paramInt = localauqh.a(paramString1, 0);
          paramInt = localauqh.a(paramString1, 1) + paramInt;
        }
        if (QLog.isColorLevel()) {
        ...
        paramString1 = (mmy)paramQQAppInterface.getManager(70);
        ...
        new awrb(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("nearby_push_red_tmp").a(new String[] { paramString2.uint32_appid.get() + "" }).a();
        if (paramString2.uint32_appid.get() == 59)
        {
          new awrb(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("like_exp_red").a();
          return;
        }
      }
      ...
      if (paramString2.uint32_appid.get() == 60)
      {
        ...
        {
          new awrb(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("assist_exp_red").a();
          return;
        }
        new awrb(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("c2c_exp_red").a();
        return;
      }
      if (paramString2.uint32_appid.get() == 61) {
        new awrb(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("paried_exp_red").a();
      }
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, List<BusinessInfoCheckUpdate.NumRedInfo> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      ((auqe)paramQQAppInterface.getManager(65)).a(localArrayList, "nearby_num_red_dot", new asen(this, paramQQAppInterface));
    }
  }
}
