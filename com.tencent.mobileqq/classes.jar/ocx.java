  ...
  extends qir
{
  ...
  private ocw jdField_a_of_type_Ocw = new ocy(this);
  ...
  public ocx(AppInterface paramAppInterface)
  {
  ...
  public static ocx a(QQAppInterface paramQQAppInterface)
  {
    return (ocx)paramQQAppInterface.getManager(337);
  }
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) && (this.jdField_a_of_type_Ocw != null))
    {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Ocw);
  ...
  {
    if (this.jdField_a_of_type_Ocw != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Ocw);
    }
    super.onDestroy();
  }
}
