...
public class ahtc
  extends Handler
{
  public ahtc(GroupSearchFragment paramGroupSearchFragment, Looper paramLooper)
  {
    super(paramLooper);
  }
                  ...
                  if (j != 0)
                  {
                    ...
                    if (SearchEntryConfigManager.a(GroupSearchFragment.a(this.a)) != 0)
                    {
                      if (this.a.jdField_a_of_type_ComTencentMobileqqSearchModelSearchResultModelForEntrance == null) {
                        this.a.jdField_a_of_type_ComTencentMobileqqSearchModelSearchResultModelForEntrance = new SearchResultModelForEntrance(this.a.jdField_b_of_type_JavaLangString, -1, 2130839208, true);
                      }
