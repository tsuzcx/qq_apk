...
public class ahtc
{
  ...
  private final acts jdField_a_of_type_Acts = new ahtd(this);
  private final ahxj jdField_a_of_type_Ahxj = new ahte(this);
  ...
  private ahtc(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, ImageButton paramImageButton, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo)
  {
  ...
  public static ahtc a(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo, ImageButton paramImageButton)
  {
    return new ahtc(paramActivity, paramFixedSizeVideoView, paramImageButton, paramQzoneVerticalVideoTopicInfo);
  }
  ...
  private vrk a()
  {
    ...
    {
      vrk localvrk = new vrk();
      localvrk.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.c();
      localvrk.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.d();
      localvrk.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.b();
      localvrk.jdField_b_of_type_Int = 3;
      return localvrk;
    }
    return null;
  }
  ...
  private boolean c()
  {
    return (this.jdField_a_of_type_Vrk != null) && (a() - this.jdField_a_of_type_Vrk.f > 0L);
  }
  ...
  private void f()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer = new AudioPlayer(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Acts);
    ...
    if (this.jdField_a_of_type_Vrk != null)
    {
      ...
      str = this.jdField_a_of_type_Vrk.g;
      if (this.jdField_a_of_type_Int == 0) {
        break label108;
      }
    }
    label108:
    for (int i = this.jdField_a_of_type_Int;; i = this.jdField_a_of_type_Vrk.jdField_d_of_type_Int)
    {
    ...
    label119:
    QZLog.e("EditLocalVideoMusicMixe", 2, new Object[] { "startAudioPlayback: music not downloaded " + this.jdField_a_of_type_Vrk.jdField_d_of_type_JavaLangString });
  }
  
  public void a()
  {
    P2VEditMusicDialog localP2VEditMusicDialog = new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ahxj, (int)a(), true);
  ...
  {
    if (this.jdField_a_of_type_Vrk != null) {
      new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ahxj, (int)paramLong, true);
    }
  }
  ...
  public void a(ahtg paramahtg)
  {
    QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new EditLocalVideoMusicMixRunnable(this.jdField_a_of_type_Long, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Vrk, new ahtf(this, paramahtg)));
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Vrk != null) && ((this.jdField_a_of_type_Vrk.jdField_b_of_type_Int == 0) || (this.jdField_a_of_type_Vrk.jdField_b_of_type_Int == 3) || (this.jdField_a_of_type_Vrk.jdField_b_of_type_Int == 2)) && (!this.jdField_a_of_type_Boolean);
  }
