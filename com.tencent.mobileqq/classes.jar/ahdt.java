  ...
  extends ahey
{
  ...
  public ahdt(String paramString1, String paramString2)
  {
  ...
  public boolean a(adcz paramadcz, String paramString, float paramFloat, int paramInt)
  {
    if ((paramadcz == null) || (TextUtils.isEmpty(paramString))) {}
    do
    {
      do
      {
        return false;
        paramadcz = ahel.a(paramadcz, 28, 28);
        localObject1 = a(paramadcz);
        ahel.a(paramadcz);
      } while (localObject1 == null);
      Object localObject1 = a((float[][][][])localObject1);
      paramadcz = new HashSet();
      ...
      if (localObject1 != null)
      {
        ...
        while (paramInt < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          {
            ((List)localObject2).add(new ahdv((String)this.jdField_a_of_type_JavaUtilList.get(paramInt), localObject1[paramInt]));
            if ((localObject1[paramInt] > paramFloat) && (this.jdField_a_of_type_JavaUtilList.size() > paramInt)) {
              paramadcz.add(this.jdField_a_of_type_JavaUtilList.get(paramInt));
            }
          }
          paramInt += 1;
        }
      }
      Collections.sort((List)localObject2, new ahdu(this));
      localObject1 = new StringBuilder();
      localObject2 = ((List)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
        ahdv localahdv = (ahdv)((Iterator)localObject2).next();
        ((StringBuilder)localObject1).append(localahdv.jdField_a_of_type_JavaLangString + ":" + localahdv.jdField_a_of_type_Float + "\n");
      }
      ...
      if (paramadcz.contains(paramString))
      {
        if (QLog.isColorLevel()) {
