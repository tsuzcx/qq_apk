  ...
  extends AsyncTask
{
  ...
  public ogu(Activity paramActivity, String paramString1, String paramString2, int paramInt1, WeakReference paramWeakReference, int paramInt2)
  {
  ...
  {
    if (!ShortVideoGuideUtil.e((AppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())) {
      return -1002;
    }
    ShortVideoGuideUtil.e(null);
    ...
    ((AudioEncoder.AudioData)localObject).jdField_b_of_type_JavaLangString = paramString1;
  ...
  protected void a(Integer paramInteger)
  {
    ...
    a("DanceSendTask: 合成失败 errcode=" + paramInteger, null);
  }
  
  protected void onPreExecute()
  {
    a(this.jdField_a_of_type_AndroidAppActivity, 2131436128);
  }
}
