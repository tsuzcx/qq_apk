...
public class set
  implements sdn
{
  private static final String jdField_a_of_type_JavaLangString = set.class.getSimpleName();
  ...
  private sew jdField_a_of_type_Sew;
  ...
  {
    if (paramInt1 == 2) {
      sjo.a().a(paramString1, new seu(this, paramString1, paramInt2, paramLong));
    }
    do
    {
      do
      ...
      } while (this.jdField_a_of_type_Sew == null);
      paramString2 = (String)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    } while (TextUtils.isEmpty(paramString2));
    this.jdField_a_of_type_Sew.a(paramString1, 1, paramString2);
  }
  ...
  private void a(String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    if (paramString1 != null) {
      ...
      {
        localObject = obb.a(paramString1);
      }
    }
    ...
    ((TVK_PlayerVideoInfo)localObject).setConfigMap("cache_servers_type", sdi.jdField_a_of_type_JavaLangString);
    if (paramLong > 0L) {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new sev(this));
  }
  ...
  {
    this.jdField_a_of_type_Sew = paramsew;
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_Sew = null;
