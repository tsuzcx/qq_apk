...
public class biey
{
  ...
  private static biex a(Cursor paramCursor)
  {
    biex localbiex = new biex();
    localbiex.jdField_a_of_type_Long = paramCursor.getLong(0);
    localbiex.jdField_a_of_type_JavaLangString = paramCursor.getString(1);
    localbiex.jdField_b_of_type_JavaLangString = paramCursor.getString(2);
    localbiex.jdField_c_of_type_JavaLangString = paramCursor.getString(3);
    localbiex.jdField_d_of_type_JavaLangString = paramCursor.getString(4);
    localbiex.jdField_e_of_type_JavaLangString = paramCursor.getString(5);
    localbiex.jdField_b_of_type_Long = paramCursor.getLong(6);
    localbiex.f = paramCursor.getString(7);
    localbiex.jdField_c_of_type_Long = paramCursor.getLong(8);
    localbiex.g = paramCursor.getString(9);
    localbiex.jdField_a_of_type_Int = paramCursor.getInt(10);
    localbiex.jdField_b_of_type_Int = paramCursor.getInt(11);
    localbiex.h = paramCursor.getString(12);
    localbiex.jdField_d_of_type_Long = paramCursor.getLong(13);
    localbiex.jdField_e_of_type_Long = paramCursor.getLong(14);
    localbiex.i = paramCursor.getString(15);
    localbiex.j = paramCursor.getString(16);
    localbiex.k = paramCursor.getString(17);
    localbiex.l = paramCursor.getString(18);
    return localbiex;
  }
  
  /* Error */
  public static java.util.ArrayList<biex> a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   53: aload_3
    //   54: ldc 36
    //   56: getstatic 145	biez:a	[Ljava/lang/String;
    //   59: aload 4
    ...
    //   93: aload_2
    //   94: aload_0
    //   95: invokestatic 161	biey:a	(Landroid/database/Cursor;)Lbiex;
