  ...
  implements View.OnClickListener
{
  ...
  public rks(View paramView, BaseData paramBaseData)
  {
  ...
  private static int a(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    return actj.a(paramInt1, paramContext.getResources());
  }
  
  private void a(URLDrawable paramURLDrawable)
  {
    int i = actj.a(this.d, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    int j = actj.a(this.c, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    ...
    paramURLDrawable = new LinearLayout.LayoutParams(a(this.jdField_a_of_type_AndroidViewView.getContext()) - i - i, actj.a(190.0F, this.jdField_a_of_type_AndroidViewView.getContext().getResources()));
    paramURLDrawable.leftMargin = i;
    paramURLDrawable.rightMargin = i;
    paramURLDrawable.topMargin = j;
    paramURLDrawable.bottomMargin = j;
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    int j = actj.a(this.d, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    int k = actj.a(this.c, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    ...
    for (;;)
    {
      ...
      paramBaseData1.mUseSharpPImage = bfkz.a(this.jdField_a_of_type_AndroidViewView.getContext());
      paramBaseData1.mMemoryCacheKeySuffix = "fast_web";
      paramBaseData1 = URLDrawable.getDrawable(sfa.a(rkr.a(paramBaseData2.jdField_a_of_type_JavaLangString, paramBaseData2), 4), paramBaseData1);
      if (i != 0) {
        a(paramBaseData1);
      }
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new rkt(this));
      return;
  ...
  {
    this.jdField_a_of_type_Rki.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData);
    ...
    for (paramView = "2";; paramView = "1")
    {
      ...
      rno.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8008996", paramView.toString());
      return;
    }
  }
}
