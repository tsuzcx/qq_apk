  ...
  extends SmallScreenVideoControlUI
{
  ...
  public lym(VideoAppInterface paramVideoAppInterface, SmallScreenService paramSmallScreenService, mbx parammbx)
  {
    super(paramVideoAppInterface, paramSmallScreenService, parammbx);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvVideoController.a().j == 1011) && (paramInt != 2131695209) && (paramInt != 2131719021) && (!this.jdField_a_of_type_ComTencentAvVideoController.f)) {}
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695323);
      return;
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("SmallScreenDoubleVideoControlUI", 1, "onCreate, matchStatus[" + localley.a.b + "], seq[" + l + "]");
    }
    if (this.jdField_a_of_type_ComTencentAvVideoController.f) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695208);
    }
    do
    {
      return;
      if ((localley.a.b > 0) && (localley.a.b != 5))
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695218);
        return;
      }
    } while (localley.l());
    if (localley.k())
    ...
    for (;;)
    {
      ...
      if (localley.j())
      {
        if ((localley.jdField_d_of_type_Int == 0) && (localley.e))
        {
          j = i;
          if (localley.f != 1) {
            if (localley.f != 2) {
      ...
      if (localley.j == 1011) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695225);
      }
