...
public final class lym
{
  ...
  private List<lgo> jdField_a_of_type_JavaUtilList = new ArrayList();
  private volatile lgl jdField_a_of_type_Lgl;
  private boolean jdField_a_of_type_Boolean;
  private float[] jdField_a_of_type_ArrayOfFloat;
  private ltp[] jdField_a_of_type_ArrayOfLtp = new ltp[16];
  ...
  public lym(VideoController paramVideoController)
  {
    this.jdField_a_of_type_ComTencentAvVideoController = paramVideoController;
    int i = 0;
    while (i < 16)
    {
      this.jdField_a_of_type_ArrayOfLtp[i] = new ltp();
      i += 1;
    }
  }
  
  private lgl a(int paramInt1, int paramInt2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if (this.jdField_a_of_type_Lgl == null)
      {
        this.d = paramInt1;
        this.e = paramInt2;
        this.jdField_a_of_type_Lgl = new lgl(paramInt1, paramInt2);
      ...
      if ((i != 0) || (!this.jdField_b_of_type_JavaLangString.equalsIgnoreCase(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        this.jdField_a_of_type_Lgl.a(this.jdField_a_of_type_JavaLangString);
  ...
  public Frame a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Int >= 2)
    {
      ...
      localObject = ((lgl)localObject).a(this.jdField_a_of_type_JavaUtilList, System.currentTimeMillis());
  ...
  {
    int i = 1;
    this.jdField_a_of_type_ArrayOfLtp[this.jdField_a_of_type_Int].jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_ArrayOfLtp[this.jdField_a_of_type_Int].jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_ArrayOfLtp[this.jdField_a_of_type_Int].jdField_c_of_type_Int = paramInt3;
    this.jdField_a_of_type_Int += 1;
    lgo locallgo = new lgo();
    locallgo.jdField_a_of_type_Int = paramInt1;
    locallgo.jdField_b_of_type_Int = paramInt2;
    locallgo.jdField_c_of_type_Int = paramInt3;
    locallgo.jdField_a_of_type_JavaUtilList = paramList;
    locallgo.d = paramInt4;
    locallgo.e = paramInt5;
    locallgo.jdField_a_of_type_Boolean = paramBoolean1;
    ...
    for (paramInt1 = i;; paramInt1 = 0)
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(0, locallgo);
      return;
      paramBoolean1 = false;
      break;
    }
    label187:
    this.jdField_a_of_type_JavaUtilList.add(locallgo);
  }
  
  public boolean a(lyf paramlyf)
  {
    int j = 1;
    this.jdField_a_of_type_JavaLangString = "";
    if (this.jdField_a_of_type_ComTencentAvVideoController.a.a(3))
    {
      paramlyf = ((kxi)this.jdField_a_of_type_ComTencentAvVideoController.a.a(3)).a();
      if (paramlyf != null) {
        this.jdField_a_of_type_JavaLangString = paramlyf.getDesc();
      }
    }
    for (int i = 1;; i = 0)
    {
      ...
      for (i = j;; i = 0)
      {
        ...
        return ley.c(VideoController.a().a());
      }
    }
  }
