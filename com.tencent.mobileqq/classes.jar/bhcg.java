...
public class bhcg
{
  ...
  {
    String str = bgpk.a(AppLoaderFactory.g().getMiniAppEnv().getContext());
    if (str == null) {
      return "unknown";
    }
  ...
  {
    return new ArrayList(Arrays.asList(new COMM.Entry[] { a("source_app", ((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).getPlatformId()), a("source_version", ((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).getAppVersion()), a("source_uin_platform", QUAUtil.getLoginType()), a("connect_openid", bgxl.a().c()), a("connect_type", String.valueOf(bgxl.a().a())) }));
  }
  ...
  {
    COMM.Entry localEntry1 = a("uid", bgxl.a().a());
  ...
  {
    return new ArrayList(Arrays.asList(new COMM.Entry[] { a("uin", String.valueOf(bgxl.a().a())), a("touin", ""), a("timestamp", String.valueOf(System.currentTimeMillis())), a("qqversion", QUAUtil.getPlatformQUA()), a("imei", ((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).getImei()), a("idfa", ""), a("idfv", ""), a("android_id", Settings.Secure.getString(AppLoaderFactory.g().getMiniAppEnv().getContext().getContentResolver(), "android_id")) }));
  }
  ...
  {
    ArrayList localArrayList = new ArrayList(Arrays.asList(new COMM.Entry[] { a("device_platform", "Android"), a("device_maker", Build.MANUFACTURER), a("device_model", Build.MODEL), a("device_version", Build.VERSION.RELEASE), a("network_type", a()), a("network_gateway_ip", ""), a("network_ssid", bgpk.b(AppLoaderFactory.g().getMiniAppEnv().getContext())) }));
    Object localObject = bgou.a();
    if (localObject != null)
    {
