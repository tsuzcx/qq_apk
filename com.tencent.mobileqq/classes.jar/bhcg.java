...
public class bhcg
{
  private static bhck jdField_a_of_type_Bhck;
  private static Object jdField_a_of_type_JavaLangObject;
  private static String jdField_a_of_type_JavaLangString = "";
  private static final HashMap<String, bhci> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static bhci a(String paramString, int paramInt1, int paramInt2)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      {
        bhci localbhci2 = (bhci)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        bhci localbhci1 = localbhci2;
        if (localbhci2 == null)
        {
          localbhci1 = new bhci(paramString, 1, paramInt1, paramInt2);
          localbhci1.a(a());
          jdField_a_of_type_JavaUtilHashMap.put(paramString, localbhci1);
        }
        return localbhci1;
      }
      bool = false;
  ...
  public static bhck a()
  {
    ...
    {
      if (jdField_a_of_type_Bhck == null) {
        jdField_a_of_type_Bhck = new bhck(new bhch());
      }
      return jdField_a_of_type_Bhck;
    }
  }
  ...
  static void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      jdField_b_of_type_JavaLangString = bhcq.jdField_b_of_type_JavaLangString;
    }
  }
  ...
  {
    Object localObject = bhcq.jdField_b_of_type_JavaLangString;
    if (localObject != null)
    {
  ...
  {
    return bbvj.a(ajsd.bc + UUID.randomUUID().toString() + ".jpg");
  }
