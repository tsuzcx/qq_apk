...
class tyu
  implements Runnable
{
  tyu(typ paramtyp, List paramList) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Typ.a.a.obtainMessage();
      ((Message)localObject1).what = 11;
      ((Message)localObject1).obj = localTroopInfo;
      this.jdField_a_of_type_Typ.a.a.sendMessage((Message)localObject1);
