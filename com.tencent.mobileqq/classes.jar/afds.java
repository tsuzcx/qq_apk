...
public class afds
  extends afdt
{
  private static final Set<WeakReference<afds>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public WeakReference<MessageForArkApp> a;
  public boolean a;
  protected WeakReference<afds> b = new WeakReference(this);
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return null;
              localObject = (afds)((WeakReference)localObject).get();
            } while (localObject == null);
            localObject = ((afds)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          } while (localObject == null);
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (afds)((WeakReference)localObject2).get();
      ((afds)localObject2).doOnEvent(paramInt);
      if (paramInt == 2) {
        b((afds)localObject2);
      }
    }
  ...
  public static void a(afds paramafds)
  {
    if (paramafds == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      jdField_a_of_type_JavaUtilSet.remove(paramafds.b);
      return;
    }
  }
  
  public static void b(afds paramafds)
  {
    WeakReference localWeakReference = paramafds.jdField_a_of_type_JavaLangRefWeakReference;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((MessageForArkApp)localWeakReference.get()).arkContainer = null;
    }
    localWeakReference = paramafds.f;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage)localWeakReference.get()).mOldAppInfo.mArkContainer = null;
    }
    localWeakReference = paramafds.g;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage.ArkMsgAppInfo)localWeakReference.get()).mArkContainer = null;
    }
    paramafds = paramafds.jdField_e_of_type_JavaLangRefWeakReference;
    if ((paramafds != null) && (paramafds.get() != null)) {
      ((ArkBabyqCardInfo)paramafds.get()).mArkBabyqContainer = null;
    }
  }
