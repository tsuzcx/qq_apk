...
public class ncp
  extends mwx
{
  public ncp(AVGameControlUIImpl paramAVGameControlUIImpl) {}
  
  public void a()
  {
    neq.a().b().post(new AVGameControlUIImpl.2.1(this));
  }
  ...
  {
    neq.a().b().post(new AVGameControlUIImpl.2.2(this, paramMultiUserInfo, paramBoolean));
  }
  ...
  {
    neq.a().b().post(new AVGameControlUIImpl.2.4(this, paramLong, paramBoolean, paramInt));
  }
  ...
  public void b(int paramInt)
  {
    ...
    neq.a().b().post(new AVGameControlUIImpl.2.3(this, paramInt));
  }
  ...
  {
    neq.a().b().post(new AVGameControlUIImpl.2.6(this, paramLong, paramBoolean, paramInt));
  }
