  ...
  implements adih
{
  ...
  public adin(BaseChatPie paramBaseChatPie)
  {
  ...
  private aukm a(aukm paramaukm)
  {
    ...
    //   0	214	0	this	adin
    //   0	214	1	paramaukm	aukm
    //   75	47	2	i	int
    //   73	10	3	j	int
    //   54	56	4	localaukm1	aukm
    //   125	47	4	localException	Exception
    //   177	35	4	localObject	Object
    //   50	58	5	localaukm2	aukm
  ...
  public static FileManagerEntity a(azqt paramazqt)
  {
    ...
    if (apvb.a(paramazqt.jdField_b_of_type_JavaLangString))
    {
      ...
      localFileManagerEntity.nFileType = apue.a(paramazqt.g);
    ...
    for (;;)
    {
      ...
      localFileManagerEntity.strTroopFilePath = paramazqt.e;
      ...
      QLog.i("MultiFavoriteHelper", 1, "=_= create new Entity[" + localFileManagerEntity.nSessionId + "] fileName[" + paramazqt.g + "] by troop size(" + localFileManagerEntity.imgHeight + ":" + localFileManagerEntity.imgWidth + ")");
      ...
      for (int i = Integer.parseInt((String)localObject); (i == 1) || (i == 2) || (i == 3); i = -1)
      {
        ...
        for (;;)
        {
          ...
          if (i == 1)
          {
            ...
            label148:
            ((FileManagerEntity)localObject).peerNick = apue.a(paramQQAppInterface, ((FileManagerEntity)localObject).peerUin, null, ((FileManagerEntity)localObject).peerType);
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      if (paramChatMessage.isMultiMsg)
      {
        ...
        if (!mye.a(paramChatMessage))
        {
          ...
          if (TextUtils.isEmpty(str2)) {
            str1 = asty.a().a(paramChatMessage.senderuin, paramChatMessage.msgseq, paramQQAppInterface);
          }
        }
      }
      if (str1 != null)
      ...
      {
        paramQQAppInterface = asuf.a(paramChatMessage.senderuin);
      }
  ...
  private ArrayList<ChatMessage> a(MessageForStructing paramMessageForStructing, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    //   100: aload_0
    //   101: aload 7
    //   103: invokespecial 457	adin:a	(Laukm;)Laukm;
    ...
    //   348: goto -279 -> 69
    //   351: aload 7
    //   353: invokevirtual 492	com/tencent/mobileqq/data/ChatMessage:deepCopyByReflect	()Laukm;
  ...
  private void a(acut paramacut, ChatMessage paramChatMessage)
  {
    if ((paramChatMessage == null) || (paramacut == null)) {}
    for (;;)
    {
      return;
      ...
      bgps.a().a = false;
      paramacut.a.a(paramChatMessage, paramacut).a(2131365928, this.jdField_a_of_type_AndroidContentContext, paramChatMessage);
      if (bgps.a().a) {
        bgps.a().a = false;
      }
      while (aibp.a().c())
  ...
  private void a(List<ChatMessage> paramList)
  {
    ...
    {
      return;
      adgb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, 4);
      asty.a().b(paramList);
      if (QLog.isColorLevel()) {
    ...
    asty.a().jdField_a_of_type_Int = 6;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aerb)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = asty.a().a();
    }
  ...
  private void a(List<ChatMessage> paramList, List<String> paramList1)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        String str = akpy.c((ChatMessage)paramList.next());
  ...
  private boolean a(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
        } while (!asuf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage));
        if (!(paramChatMessage instanceof MessageForStructing)) {
          break;
        }
      } while (((MessageForStructing)paramChatMessage).structingMsg.mMsgServiceID != 35);
      return true;
    } while (((paramChatMessage instanceof MessageForArkApp)) || (((paramChatMessage instanceof MessageForPic)) && (aezn.a((MessageForPic)paramChatMessage))));
    return true;
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, acut paramacut, MessageForStructing paramMessageForStructing)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiFavoriteHelper", 2, "onClickMultiFavoriteBtn");
    }
    int i = asty.a().c();
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C5B", "0X8009C5B", 0, i, "", "", "", "");
    if (paramMessageForStructing == null)
    {
      paramMessageForStructing = asty.a().a();
      if (paramMessageForStructing.size() == 1)
      {
        localArrayList = asuf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ArrayList)paramMessageForStructing);
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          paramMessageForStructing = (ChatMessage)localArrayList.get(0);
          a(paramacut, paramMessageForStructing);
          paramBaseChatPie.a(false, null, false);
        }
      }
    }
    while (!bgpv.a(paramMessageForStructing))
    {
      for (;;)
      {
      ...
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131698465, 0).b(paramBaseChatPie.a());
      return;
    }
    paramacut = new ArrayList();
    paramacut.add(paramMessageForStructing);
    for (;;)
    {
      bgps.a().a = true;
      if (!a(paramacut, asty.a().a()))
      {
        bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694082, 0).b(paramBaseChatPie.a());
        return;
      }
      i = a(paramacut);
      paramMessageForStructing = paramacut;
      if (i > 0)
      {
        if (paramacut.size() == i)
        {
          bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694434, 0).b(paramBaseChatPie.a());
          paramBaseChatPie.a(false, null, false);
          return;
        }
        ...
        {
          bgpv.b(paramMessageForStructing);
          a(this.jdField_a_of_type_AndroidContentContext.getString(2131693407), this.jdField_a_of_type_AndroidContentContext.getString(2131694435), new adio(this, paramacut, paramBaseChatPie));
          return;
        }
      ...
      return;
      label423:
      paramacut = paramMessageForStructing;
    }
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, LinearLayout paramLinearLayout, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setId(2131364157);
        if (AppSetting.d) {
          this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131706995));
        }
      }
  ...
  public void a(String paramString1, String paramString2, DialogInterface.OnClickListener paramOnClickListener)
  {
    try
    {
      bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, paramString1, "", paramString2, new adip(this, paramOnClickListener), null).show();
      return;
    }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject1 = bbcl.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if ((paramArrayList != null) && (paramArrayList.size() == 1) && (bgpv.a((ChatMessage)paramArrayList.get(0))))
      {
        localObject1 = (MessageForStructing)paramArrayList.get(0);
        localObject2 = null;
        label87:
        paramArrayList = bgpd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForStructing)localObject1, (List)localObject2, paramMap);
      ...
      {
        localObject1 = aaod.a((Context)localObject2, (String)localObject1, paramArrayList, paramMap, bool);
        if (localObject1 == null) {
          break;
        }
        MessageForStructing localMessageForStructing = asty.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_JavaLangString, (AbsStructMsg)localObject1);
      ...
      label399:
      bgpf.a(this.jdField_a_of_type_AndroidContentContext, paramMap, bool, null, false);
      return;
      label412:
