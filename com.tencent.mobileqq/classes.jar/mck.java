  ...
  implements TextWatcher
{
  ...
  public mck(ReadInJoyVideoSearchTagFragment paramReadInJoyVideoSearchTagFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (this.jdField_a_of_type_Int > 0)
    {
      ...
      if ((j ^ i) != 0)
      {
        ...
        arrayOfDrawable[2] = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyVideoSearchTagFragment.getResources().getDrawable(2130838712);
      }
    }
    for (;;)
    {
