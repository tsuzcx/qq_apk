  ...
  extends aeun
{
  ...
  public aeva(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3] = this.jdField_a_of_type_ComTencentWidgetListView.getResources().getDrawable(2130837744);
      ...
      this.jdField_a_of_type_AndroidViewView = new aevf(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new aevf(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new aevb(this));
    ...
    for (;;)
    {
      ...
      paramVarArgs.setAnimationListener(new aevd(this));
      paramVarArgs = new aeve(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
