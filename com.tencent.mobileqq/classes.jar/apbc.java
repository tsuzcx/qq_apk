...
public class apbc
{
  ...
  public apbc()
  {
    ...
    this.jdField_a_of_type_Apbb = new apbb();
  ...
  public void a()
  {
    this.jdField_a_of_type_Int = -2;
    this.jdField_b_of_type_Int = -2;
    this.jdField_a_of_type_Apbb.b = 0.0F;
    this.jdField_a_of_type_Apbb.c = 0.0F;
    this.jdField_a_of_type_Apbb.jdField_a_of_type_Float = 0.0F;
    this.c = 0;
    this.d = 0;
    this.f = 10;
    this.g = 0;
