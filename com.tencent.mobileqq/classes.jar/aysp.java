  ...
  extends aype
{
  ...
  private String jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Aywa.i;
  public boolean a;
  private int jdField_b_of_type_Int = this.jdField_a_of_type_Aywa.jdField_a_of_type_Int;
  private long jdField_b_of_type_Long = -1L;
  private bgam jdField_b_of_type_Bgam = new bgam();
  ...
  public aysp(ayvv paramayvv, aywa paramaywa)
  {
    super(paramayvv, paramaywa);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_d_of_type_ArrayOfByte = paramaywa.jdField_b_of_type_ArrayOfByte;
    this.jdField_a_of_type_Int = paramaywa.h;
    if (this.jdField_d_of_type_ArrayOfByte != null) {}
    for (this.q = paramaywa.jdField_b_of_type_ArrayOfByte.length;; this.q = 0L) {
      try
      {
        this.jdField_a_of_type_Long = Long.parseLong(this.jdField_a_of_type_Aywa.jdField_b_of_type_JavaLangString);
        return;
      }
      catch (Exception paramayvv)
      {
        paramayvv.printStackTrace();
  ...
  private boolean a()
  {
    ...
    ((LongMsg.MsgUpReq)localObject1).uint64_dst_uin.set(Long.valueOf(this.jdField_a_of_type_Aywa.jdField_c_of_type_JavaLangString).longValue());
    ...
    int j = 0;
    while (j < "8.2.8".length())
    {
      localObject2 = localObject1;
      if ("8.2.8".charAt(j) != '.') {
        localObject2 = ((String)localObject1).concat(Character.toString("8.2.8".charAt(j)));
      }
      j += 1;
  ...
  private void f()
  {
    ...
    localayyu.jdField_a_of_type_Long = this.q;
    localayyu.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
    localayyu.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    localayyu.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Aywa.jdField_b_of_type_JavaLangString;
    localayyu.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_Aywa.jdField_c_of_type_JavaLangString;
    localayyu.jdField_e_of_type_JavaLangString = this.jdField_a_of_type_Aywa.jdField_d_of_type_JavaLangString;
    localayyu.f = this.jdField_a_of_type_Aywa.jdField_a_of_type_Int;
    ayyn localayyn = new ayyn();
    localayyn.jdField_a_of_type_Ayzu = this;
    localayyn.jdField_a_of_type_JavaLangString = "multi_msg_up";
    localayyn.jdField_a_of_type_JavaUtilList.add(localayyu);
  ...
  protected String a(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte.append(localayuo.jdField_a_of_type_JavaLangString);
    if (localayuo.jdField_a_of_type_Int != 80)
    {
      paramArrayOfByte.append(":");
      paramArrayOfByte.append(localayuo.jdField_a_of_type_Int);
    }
  ...
  public void a(ayyn paramayyn, ayzc paramayzc)
  {
    ...
    if ((paramayzc == null) || (paramayzc.jdField_a_of_type_JavaUtilList == null) || (paramayzc.jdField_a_of_type_JavaUtilList.size() == 0))
    {
    ...
    {
      return;
      paramayyn = paramayzc.jdField_a_of_type_JavaUtilList.iterator();
      while (paramayyn.hasNext())
      {
        paramayzc = (ayzp)paramayyn.next();
        if (QLog.isColorLevel()) {
          b("procUrl", paramayzc.toString());
        }
        a(this.jdField_a_of_type_Aypb, paramayzc);
        paramayzc = (ayzm)paramayzc;
        if (paramayzc.jdField_c_of_type_Int != 0) {
          break label197;
        }
        this.f = paramayzc.jdField_a_of_type_ArrayOfByte;
        this.g = paramayzc.jdField_b_of_type_ArrayOfByte;
        this.jdField_a_of_type_JavaUtilArrayList = paramayzc.jdField_a_of_type_JavaUtilArrayList;
        this.jdField_h_of_type_ArrayOfByte = paramayzc.jdField_c_of_type_ArrayOfByte;
        this.i = paramayzc.jdField_d_of_type_ArrayOfByte;
        try
        {
        ...
        catch (UnsupportedEncodingException paramayzc)
        {
          for (;;)
          {
            paramayzc.printStackTrace();
          }
          d();
        }
      }
    ...
    label197:
    b(9007, "upResp.result=" + paramayzc.jdField_c_of_type_Int);
    d();
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Aywa.e == 1030) {}
    while (((!paramBoolean) && (ayua.b(this.jdField_j_of_type_Int))) || (this.jdField_h_of_type_Boolean) || ((paramBoolean) && ((this.jdField_m_of_type_Int & 0x2) > 0)) || ((!paramBoolean) && ((this.jdField_m_of_type_Int & 0x1) > 0))) {
      return;
    }
    ...
    if (paramBoolean)
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "actMultiMsgUpload", true, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      axrl.a(BaseApplication.getContext()).a(null, "actMultiMsgUpload", false, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  public void aP_()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject = ayog.d(this.jdField_b_of_type_JavaLangString);
        File localFile = new File((String)localObject);
        if (localFile.exists()) {
          localFile.delete();
        }
        bbdj.a(this.jdField_e_of_type_ArrayOfByte, (String)localObject);
        this.jdField_a_of_type_JavaLangString = ((String)localObject);
        this.jdField_a_of_type_Aywa.i = this.jdField_a_of_type_JavaLangString;
        super.j();
        localObject = new aysq(this);
  ...
  public int b()
  {
    if (this.jdField_k_of_type_Boolean)
    {
      ...
      this.jdField_b_of_type_Bgam.a();
      this.jdField_a_of_type_Ayox.a.post(new MultiMsgUpProcessor.2(this));
    }
    return 0;
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Aywa.jdField_a_of_type_Auoo != null)
    {
      ...
      localauop.jdField_a_of_type_JavaLangObject = Long.valueOf(this.jdField_a_of_type_Aywa.jdField_a_of_type_Long);
  ...
  public void e()
  {
    ...
    {
      localauop = new auop();
      localauop.jdField_b_of_type_Int = 0;
      localauop.jdField_a_of_type_Long = this.q;
      localauop.jdField_d_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
      localauop.jdField_a_of_type_JavaLangObject = Long.valueOf(this.jdField_a_of_type_Aywa.jdField_a_of_type_Long);
    }
    try
    {
      localauop.jdField_c_of_type_JavaLangString = new String(this.f, "UTF-8");
      this.jdField_a_of_type_Aywa.jdField_a_of_type_Auoo.b(localauop);
      d(1003);
      return;
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      for (;;)
      {
        localauop.jdField_b_of_type_Int = -1;
        localauop.jdField_a_of_type_JavaLangString = ("Failed. Convert ResID to UTF-8 string failed, resID = " + this.f.toString());
        b("onSuccess", localauop.jdField_a_of_type_JavaLangString);
      }
    }
  }
  ...
  public boolean j()
  {
    ...
    this.jdField_a_of_type_Ayqm.f = this.jdField_d_of_type_JavaLangString;
  ...
  protected void n()
  {
    ...
    {
      if (!akpy.c(this.jdField_b_of_type_Int)) {
        break label56;
      }
      str = "multimsgCu";
    }
  ...
  public void onResp(aysx paramaysx)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokespecial 843	aype:onResp	(Laysx;)V
    //   5: aload_0
    //   6: getfield 730	aysp:jdField_o_of_type_Boolean	Z
    //   9: ifne +10 -> 19
    //   12: aload_0
    //   13: getfield 728	aysp:jdField_k_of_type_Boolean	Z
    //   16: ifeq +4 -> 20
    //   19: return
    //   20: aload_0
    //   21: aconst_null
    //   22: putfield 706	aysp:jdField_a_of_type_Aysw	Laysw;
    //   25: aload_0
    //   26: ldc_w 844
    ...
    //   42: aload_1
    //   43: getfield 849	aysx:jdField_a_of_type_Int	I
    ...
    //   55: aload_1
    //   56: getfield 852	aysx:jdField_b_of_type_Int	I
    ...
    //   68: aload_1
    //   69: getfield 855	aysx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   78: invokevirtual 379	aysp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   81: aload_1
    //   82: getfield 849	aysx:jdField_a_of_type_Int	I
    //   85: ifne +209 -> 294
    //   88: aload_0
    //   89: iconst_0
    //   90: putfield 857	aysp:jdField_l_of_type_Int	I
    //   93: aload_1
    //   94: getfield 858	aysx:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   97: ldc_w 860
    ...
    //   107: ifnull +162 -> 269
    //   110: aload_1
    //   111: getfield 858	aysx:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   114: ldc_w 860
    ...
    //   140: aload_0
    //   141: aload_0
    //   142: getfield 484	aysp:jdField_b_of_type_Aypb	Laypb;
    //   145: aload_1
    //   146: iload_3
    //   147: invokevirtual 866	aysp:a	(Laypb;Laysx;Z)V
    //   150: invokestatic 625	android/os/SystemClock:uptimeMillis	()J
    //   153: lstore 4
    //   155: aload_0
    //   156: getfield 30	aysp:jdField_b_of_type_Long	J
    //   159: lstore 6
    //   161: iload_3
    //   162: ifeq +119 -> 281
    //   165: aload_0
    ...
    //   196: aload_0
    //   197: getfield 814	aysp:jdField_a_of_type_Ayqm	Layqm;
    //   200: getfield 871	ayqm:jdField_a_of_type_Long	J
    ...
    //   219: invokevirtual 379	aysp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   222: aload_0
    //   223: invokevirtual 874	aysp:e	()V
    //   226: return
    //   227: astore_1
    //   228: aload_0
    //   229: sipush 9343
    ...
    //   242: invokestatic 882	ayoh:a	(Ljava/lang/Exception;)Ljava/lang/String;
    //   245: ldc_w 585
    //   248: aload_0
    //   249: getfield 484	aysp:jdField_b_of_type_Aypb	Laypb;
    //   252: invokevirtual 370	aysp:a	(ILjava/lang/String;Ljava/lang/String;Laypb;)V
    //   255: aload_0
    //   256: invokevirtual 372	aysp:d	()V
    //   259: return
    //   260: astore 8
    //   262: ldc_w 883
    //   265: istore_2
    ...
    //   282: iload_2
    //   283: ldc_w 885
    //   286: invokevirtual 309	aysp:b	(ILjava/lang/String;)V
    //   289: aload_0
    //   290: invokevirtual 372	aysp:d	()V
    //   293: return
    //   294: aload_0
    //   295: aload_0
    //   296: getfield 484	aysp:jdField_b_of_type_Aypb	Laypb;
    //   299: aload_1
    //   300: iconst_0
    //   301: invokevirtual 866	aysp:a	(Laypb;Laysx;Z)V
    //   304: aload_0
    //   305: aload_1
    //   306: getfield 852	aysx:jdField_b_of_type_Int	I
    //   309: aload_1
    //   310: getfield 855	aysx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   313: invokevirtual 309	aysp:b	(ILjava/lang/String;)V
    //   316: aload_0
    //   317: invokevirtual 372	aysp:d	()V
    //   320: return
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	321	0	this	aysp
    //   0	321	1	paramaysx	aysx
    //   126	157	2	j	int
