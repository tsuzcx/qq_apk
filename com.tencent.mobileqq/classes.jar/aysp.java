...
public class aysp
{
  private ajuc jdField_a_of_type_Ajuc = new aysq(this);
  public Context a;
  public Handler a;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public String a;
  
  public aysp(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, Handler paramHandler)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(true, this.jdField_a_of_type_JavaLangString, str, 5);
      if (l1 == 0L)
      {
