  ...
  implements aysy
{
  ...
  WeakReference<aysq> jdField_a_of_type_MqqUtilWeakReference;
  
  public aysp(QQAppInterface paramQQAppInterface, aysq paramaysq)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramaysq);
  ...
  public aysq a()
  {
    ...
    return (aysq)this.jdField_a_of_type_MqqUtilWeakReference.get();
  }
  ...
  public void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 100601)
      {
        if (!aytb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {}
    ...
    for (;;)
    {
      ...
      if (bool2) {
        bhmi.a(a(-4), localObject3);
      }
      for (;;)
      {
        QLog.d("DefaultRedPointPrePostHandler", 1, new Object[] { "isQQSettingMeBubbleMsg show=", Boolean.valueOf(bool2), " uin=", bhsr.e((String)localObject2) });
        return;
  ...
  {
    aysq localaysq = a();
    if ((paramList == null) || (localaysq == null)) {
      return;
    }
    ...
    while (((Iterator)localObject3).hasNext())
    {
      ...
      {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", (String)localObject1, (String)localObject1, 0, 0, "", "", "", "");
        localObject2 = localObject1;
      }
    }
    localObject3 = localaysq.a(10015);
    ...
    if (localObject3 != null)
    {
      ...
      if (paramList.contains(localObject3))
      {
        ...
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007391", "0X8007391", 0, 0, "", "", "", "");
        ((MedalWallMng)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(250)).b();
      }
    }
    localObject2 = localaysq.a(10016);
    ...
    for (;;)
    {
      ...
      if (localObject2 != null) {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", (String)localObject2, (String)localObject2, 0, 0, "", "", "", "");
      }
      localObject1 = localaysq.a(10018);
      ...
      paramList = (aqyp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269);
      localObject2 = paramList.a();
      if ((localObject2 != null) && (((aqyl)localObject2).c())) {
        continue;
      }
