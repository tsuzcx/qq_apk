  ...
  extends azut
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      if (!((azus)((Iterator)localObject1).next() instanceof azwp)) {
        break label944;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        paramView = (azus)this.jdField_a_of_type_JavaUtilArrayList.get(j);
      ...
      for (;;)
      {
        ...
        if ("button".equals(localObject2))
        {
          ...
          if (i == 0)
          {
            ...
            if (m < n)
            {
              localObject2 = (azus)this.jdField_a_of_type_JavaUtilArrayList.get(m);
              ((azus)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
              str = ((azus)localObject2).jdField_a_of_type_JavaLangString;
            ...
            ((azus)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject2 = ((azus)localObject2).a(paramContext, null, paramBundle);
            j = 0;
            if (m == 0)
            {
              j = 2131377115;
            ...
            for (;;)
            {
              ...
              if ("button".equals(str))
              {
                ...
                for (;;)
                {
                  ...
                  return paramView;
                  j = aepi.a(5.0F, localResources);
                  break;
                  label888:
                  k = aepi.a(5.0F, localResources);
                  m = i;
                  n = j;
                  j = k;
                  k = n;
