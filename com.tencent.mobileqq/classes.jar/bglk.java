  ...
  extends raa
{
  ...
  public bglk(@NotNull ViewGroup paramViewGroup, @NotNull String paramString1, @NotNull String paramString2, @Nullable Function1<? super Integer, Unit> paramFunction1)
  {
  ...
  {
    ImageView localImageView = (ImageView)a(2131380629);
  ...
  {
    TextView localTextView = (TextView)a(2131380303);
  ...
  public final void a(int paramInt, @NotNull String paramString)
  {
    ...
    localObject = (ImageView)a(2131372629);
    if (localObject != null) {
  ...
  public final void a(@NotNull String paramString)
  {
    ...
    TextView localTextView = (TextView)a(2131378809);
    if (localTextView != null) {
  ...
  protected View b()
  {
    View localView = LayoutInflater.from(a().getContext()).inflate(2131561550, a(), false);
  ...
  public void onClick(@Nullable View paramView)
  {
    ...
    if (Intrinsics.areEqual(paramView, a(2131380629)))
    {
