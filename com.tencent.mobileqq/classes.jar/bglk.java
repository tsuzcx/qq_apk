  ...
  implements Handler.Callback
{
  ...
  public bglk(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(a().getLooper(), this);
    this.b = paramString;
    this.jdField_a_of_type_Bgkk = bgkk.a(this.jdField_a_of_type_AndroidContentContext);
    a();
  }
  ...
  {
    bgli.a(paramPluginInfo, a(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void a(String paramString)
  {
    bgli.a(paramString, a(this.jdField_a_of_type_AndroidContentContext));
  }
      ...
      if (paramPluginInfo.mInstalledPath != null)
      {
        ...
        if (localFile != null)
        {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              if (!bgli.a(paramPluginInfo, localFile)) {
                break label137;
              }
              bool1 = true;
  ...
  private static boolean a(File paramFile, QZipFile paramQZipFile, ZipEntry paramZipEntry)
  {
    ...
    //   116: invokestatic 200	bhpa:a	(Ljava/io/OutputStream;)Lbhpa;
    //   119: astore_0
    //   120: aload_0
    //   121: astore 5
    //   123: aload_0
  ...
  private void c(PluginInfo paramPluginInfo, bgln parambgln)
  {
    int i = 1;
    String str = paramPluginInfo.mID;
    QLog.d("plugin_tag", 1, "doSetupPlugin." + str);
    if (bgli.a(paramPluginInfo, this.jdField_a_of_type_AndroidContentContext))
    {
  ...
  private boolean c(String paramString)
  {
    ...
    {
      return false;
      paramString = new File(this.b).list(new bgll(this, paramString));
  ...
  private boolean d(String paramString)
  {
    ...
    if ((localPluginInfo != null) && (bgli.a(localPluginInfo, this.jdField_a_of_type_AndroidContentContext)))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    boolean bool = bgli.a(localFile1);
    File[] arrayOfFile = bgli.a(localFile1);
    int i;
    File localFile2;
    Object localObject;
    if (arrayOfFile != null)
  ...
  public void a(PluginInfo paramPluginInfo, bgln parambgln)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambgln);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(66816, paramPluginInfo).sendToTarget();
  }
  
  public void a(String paramString, File paramFile, bgln parambgln)
  {
    int i = 1;
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramFile);
    if ((PluginUtils.isOsNeedReleaseDex()) && (bglb.a(paramString) > 1)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramFile))
        {
          ...
          boolean bool = Dex2Oat.a(localArrayList, localFile, true, paramFile, new bglm(this));
          ...
          axqp.a(paramString, i, l2);
          l2 = System.currentTimeMillis();
          if (parambgln != null) {
            parambgln.a(paramString, "pluginOatCost", l2 - l1);
          }
          if (QLog.isColorLevel()) {
  ...
  public boolean a(PluginInfo paramPluginInfo, bgln parambgln)
  {
    if (paramPluginInfo == null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = a((PluginInfo)localObject);; bool = false)
    {
      ...
      if (!bgli.a(paramPluginInfo, (File)localObject))
      {
        if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString, bgln parambgln)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      if (parambgln != null) {
        parambgln.e(paramString);
      }
      return false;
    }
    if (!this.jdField_a_of_type_Bgkk.a(paramString))
    {
      if (QLog.isColorLevel()) {
    ...
    localObject1 = new File(PluginUtils.getPluginInstallDir(this.jdField_a_of_type_AndroidContentContext), paramString);
    localPluginInfo1 = (PluginInfo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    bool = false;
    localObject4 = this.jdField_a_of_type_Bgkk.a(paramString);
    if (localObject4 == null)
    {
      QLog.d("plugin_tag", 1, "plugin not builtin");
      if (parambgln != null) {
        parambgln.b(false, paramString);
      }
      return false;
    }
    if ((localObject4 != null) && (localPluginInfo1 != null) && (!((PluginInfo)localObject4).mMD5.equals(localPluginInfo1.mMD5))) {}
    for (i = 1;; i = 0)
    {
      if (((File)localObject1).exists()) {
      ...
      if (parambgln != null) {
        parambgln.b(true, paramString);
      }
      return true;
    }
    if (parambgln != null) {
      parambgln.f(paramString);
    }
    localPluginInfo2 = ((PluginInfo)localObject4).a();
    ...
    try
    {
      localObject5 = paramString.substring(0, paramString.indexOf(".apk"));
      localObject4 = SoLoadCore.getReleasedSoFilePath(this.jdField_a_of_type_AndroidContentContext, (String)localObject5);
      if (localObject4 != null) {
        break label915;
      }
      localObject4 = SoLoadCore.releaseSo(this.jdField_a_of_type_AndroidContentContext, (String)localObject5);
    }
    catch (Exception localException3)
    {
      for (;;)
      {
        try
        {
          localObject1 = localPluginInfo2.mMD5;
          ...
          try
          {
            ...
            localObject4 = localObject1;
            localObject1 = InstallPlugins.a(this.jdField_a_of_type_AndroidContentContext, paramString, (File)localObject5, true);
            localObject4 = localObject1;
            InstallPlugins.a(0);
            localObject4 = localObject1;
          }
          catch (Exception localException1)
          {
            long l2;
            f = bbdj.a();
            QLog.d("plugin_tag", 1, "extractPluginAndGetMd5Code failed installPath = " + localObject5 + ", leftSpace = " + f, localException1);
            continue;
            if (parambgln == null) {
              continue;
            }
          ...
          localObject1 = localPluginInfo2.mMD5;
          if (QLog.isColorLevel()) {
            QLog.d("plugin_tag", 2, "md5:" + (String)localObject1 + " vs " + (String)localObject4);
          }
          bool = ((String)localObject4).equals(localObject1);
          if ((0 == 0) && (bool))
          {
            l2 = System.currentTimeMillis();
            if (parambgln != null) {
              parambgln.a(paramString, "pluginApkCost", l2 - l1);
            }
            i = 0;
            try
            {
              localObject1 = PluginUtils.getPluginLibPath(this.jdField_a_of_type_AndroidContentContext, paramString).getCanonicalPath();
              l1 = System.currentTimeMillis();
              localObject1 = PluginUtils.extractLibs(((File)localObject5).getCanonicalPath(), (String)localObject1);
              l2 = System.currentTimeMillis();
              if (parambgln != null) {
                parambgln.a(paramString, "pluginLibCost", l2 - l1);
              }
              if (localObject1 != null)
              {
                QLog.d("plugin_tag", 1, "extractLibs " + (String)localObject1);
                i = 1;
              }
            }
            catch (Throwable localThrowable)
            ...
            if (i == 0)
            {
              if (!a(paramString, ((File)localObject5).getAbsolutePath())) {
                j = 1;
              }
            }
            else
          ...
          if (bglq.a()) {
            a(paramString, (File)localObject5, parambgln);
          }
          localPluginInfo2.mLength = ((File)localObject5).length();
          localPluginInfo2.mState = 4;
          localPluginInfo2.mInstalledPath = ((File)localObject5).getAbsolutePath();
          localPluginInfo2.mMD5 = ((String)localObject4);
  ...
  public void b(PluginInfo paramPluginInfo, bgln parambgln)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambgln);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(67072, paramPluginInfo).sendToTarget();
  }
  
  public boolean b(PluginInfo paramPluginInfo, bgln parambgln)
  {
    String str = paramPluginInfo.mID;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        a(str, new File(PluginUtils.getPluginInstallDir(this.jdField_a_of_type_AndroidContentContext), str), parambgln);
        paramPluginInfo.mState = 4;
        paramPluginInfo.mFingerPrint = a();
        a(paramPluginInfo);
        if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 66816: 
      ...
      c((PluginInfo)paramMessage.first, (bgln)paramMessage.second);
      return true;
    }
    paramMessage = (Pair)paramMessage.obj;
    b((PluginInfo)paramMessage.first, (bgln)paramMessage.second);
    return true;
  }
}
