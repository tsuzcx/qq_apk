...
public class yyi
{
  ...
  public static aqbx a(QQAppInterface paramQQAppInterface, aqbv paramaqbv, int paramInt)
  {
    if ((paramaqbv == null) || (paramaqbv.a == null) || (paramaqbv.a.size() <= 0)) {
      return null;
    }
    int k = 0;
    for (int j = (int)(Math.random() * paramaqbv.a.size()); (paramInt != -1) && (j == paramInt) && (k < 50); j = (int)(Math.random() * paramaqbv.a.size())) {
      k += 1;
    }
    return (aqbx)paramaqbv.a.get(j);
  }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    QQToast.a(localBaseApplication, paramInt1, paramInt2, 1).b(localBaseApplication.getResources().getDimensionPixelSize(2131299076));
  }
  ...
  private static void a(Context paramContext, String paramString, int paramInt1, int paramInt2, Canvas paramCanvas, int paramInt3)
  {
    ...
    try
    {
      ...
      paramCanvas.drawBitmap(BitmapFactory.decodeResource(paramContext.getResources(), 2130846861), null, localRect, localPaint);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, yva paramyva)
  {
    paramString1 = yuy.a(paramInt1, paramString1);
    ...
    paramString2 = new yyj(paramyva);
    paramContext = new NewIntent(paramContext, yvb.class);
