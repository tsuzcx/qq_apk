...
public class bhhv
{
  ...
  public bhhv(View paramView, int paramInt, bhhx parambhhx)
  {
  ...
  private static int b()
  {
    ...
    if (blhi.a(localBaseApplication)) {
      i = blhi.a(localBaseApplication);
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bhhw(this);
  }
  ...
  public int a()
  {
    ...
    if (localSharedPreferences.contains("key_height"))
    {
      ...
      this.jdField_a_of_type_Bhhx.onShowed(i, true);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
