  ...
  implements View.OnClickListener
{
  ...
  public bcpc(Context paramContext)
  {
  ...
  private void b(String paramString)
  {
    ...
    agbh.a(this.jdField_a_of_type_AndroidContentContext, localIntent, paramString);
  }
  ...
  void a(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368216));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363392));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371652));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365421));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370559));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[0] = ((TextView)paramView.findViewById(2131364031));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[1] = ((TextView)paramView.findViewById(2131364032));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[2] = ((TextView)paramView.findViewById(2131364033));
      this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131363393);
      this.jdField_a_of_type_ArrayOfAndroidViewView[0] = paramView.findViewById(2131363572);
      this.jdField_a_of_type_ArrayOfAndroidViewView[1] = paramView.findViewById(2131363574);
      this.jdField_a_of_type_ArrayOfAndroidViewView[2] = paramView.findViewById(2131363573);
      this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131364034);
      if ((this.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_a_of_type_AndroidWidgetImageView).setMaskShape(blqj.jdField_c_of_type_Int);
      }
      if ((this.jdField_b_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_b_of_type_AndroidWidgetImageView).setMaskShape(blqj.jdField_c_of_type_Int);
      }
      this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new bcpd(this));
      paramView.setOnClickListener(new bcpe(this));
    }
  }
  ...
  void b()
  {
    ...
    if (this.jdField_b_of_type_JavaLangString != null)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidViewView[i].setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166928));
    }
    for (;;)
    {
      i += 1;
    ...
    label363:
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bcpf(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      ...
      {
        bcjy.a(null, this.jdField_c_of_type_Int, 0, "0X8009D2D", this.jdField_b_of_type_Int, i, this.g);
        label81:
        if (str != null)
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      i = 3;
      break;
      bcjy.a(null, this.jdField_c_of_type_Int, 0, "0X8009D41", this.jdField_b_of_type_Int, i, this.g);
      break label81;
      label210:
      bhmr localbhmr = bhni.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, str);
      if (localbhmr != null)
      {
        localbhmr.a();
      }
