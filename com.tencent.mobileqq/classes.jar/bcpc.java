  ...
  implements Manager
{
  ...
  public bcpc(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForTroopReward a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    localMessageForTroopReward.msgUid = azah.a(paramInt1);
    localMessageForTroopReward.msg = bdil.a(null);
    ...
    localMessageForTroopReward.time = ayzl.a();
  ...
  {
    abtf localabtf = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a();
    Lock localLock = localabtf.a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = localabtf.a().get(a(paramString, paramInt));
      if (paramString != null)
      {
