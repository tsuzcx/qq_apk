...
public class auat
  implements bbzw, bcmc<auax>
{
  private int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  private Context jdField_a_of_type_AndroidContentContext;
  protected anua a;
  private auab jdField_a_of_type_Auab;
  private bbzr jdField_a_of_type_Bbzr;
  private bcmd<auax> jdField_a_of_type_Bcmd;
  ...
  private List<bbzf> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean;
  private List<bfwa> jdField_c_of_type_JavaUtilList;
  private boolean jdField_c_of_type_Boolean;
  private volatile boolean d = true;
  
  public auat(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, int paramInt, auab paramauab)
  {
    this.jdField_a_of_type_Anua = new auau(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_Auab = paramauab;
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong, List<Long> paramList, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      ((antz)paramQQAppInterface.a(22)).a("GroupFileAppSvr.GetFileSearch", paramList.toByteArray(), (Bundle)localObject);
  ...
  private void a(boolean paramBoolean, List<bfwa> paramList)
  {
  ...
  private void b(String paramString)
  {
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bbzr = new bbzr(paramString, paramString, this.jdField_b_of_type_JavaUtilList, this);
      this.jdField_a_of_type_Bbzr.a();
    }
  }
  ...
  public List<auax> a(bcmq parambcmq)
  {
    return null;
  }
  ...
  public void a(bcmq parambcmq, bcmd<auax> parambcmd)
  {
