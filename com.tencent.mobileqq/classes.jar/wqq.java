...
public class wqq
{
  ...
  {
    xvv.b("Q.qqstory.playernew.AnimationUtils", "doExitAnimation");
    View localView = paramViewGroup.findViewById(2131376679);
    ImageView localImageView2 = (ImageView)paramViewGroup.findViewById(2131362693);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131380771);
    ...
    paramViewGroup.addUpdateListener(new wqr(localViewGroup, localDrawable, localImageView1, localImageView2));
    paramViewGroup.addListener(new wqs(paramAnimatorListener));
  ...
  {
    xvv.b("Q.qqstory.playernew.AnimationUtils", "doEnterAnimation");
    Object localObject = paramViewGroup.findViewById(2131376679);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131362693);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131380771);
    ...
    ((ValueAnimator)localObject).addUpdateListener(new wqt(localViewGroup, paramViewGroup, localImageView));
    ((ValueAnimator)localObject).addListener(new wqu(paramAnimatorListener, localViewGroup, paramViewGroup));
