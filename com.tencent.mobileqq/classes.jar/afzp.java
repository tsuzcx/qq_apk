  ...
  extends BaseBubbleBuilder
{
  ...
  protected final int c = 2131378321;
  protected final int d = 2131378317;
  protected final int e = 2131378320;
  protected final int f = 2131378319;
  protected final int g = 2131378316;
  protected final int h = 2131378318;
  protected int i;
  protected int j;
  protected int k;
  protected int l;
  ...
  public afzp(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new afzq(this);
  ...
  {
    paramaelt = (afzr)paramaelt;
    paramBaseChatItemLayout = (MessageForTroopFee)paramChatMessage;
    if ((paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (paramaelt.jdField_a_of_type_Long == paramChatMessage.uniseq)) {
      return paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout;
    }
    ...
    {
      paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView);
      paramaelt.b = paramChatMessage.frienduin;
      paramaelt.jdField_a_of_type_Long = paramChatMessage.uniseq;
      paramView = (TextView)paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378320);
      TextView localTextView1 = (TextView)paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378319);
      ImageView localImageView = (ImageView)paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378317);
      TextView localTextView2 = (TextView)paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378318);
      localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378321);
      ...
      localImageView.setImageResource(2130846710);
    ...
    {
      localQQWalletTransferBubbleView.setBubbleBackground(2130846708, i1, bool);
      paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramBaseChatItemLayout.title + paramBaseChatItemLayout.summary + paramBaseChatItemLayout.source);
      ...
      return paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout;
      paramaelt.jdField_a_of_type_AndroidWidgetRelativeLayout = a(this.jdField_a_of_type_AndroidContentContext);
      break;
      label378:
      if (f1 <= this.m * 14) {
        break label210;
  ...
  protected RelativeLayout a(Context paramContext)
  {
    ...
    ((QQWalletTransferBubbleView)localObject1).setId(2131378321);
    ...
    ((ImageView)localObject2).setId(2131378317);
    ((QQWalletTransferBubbleView)localObject1).addView((View)localObject2);
    localObject2 = new LinearLayout(paramContext);
    localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject3).addRule(0, 2131378317);
    ...
    ((TextView)localObject3).setId(2131378320);
    ...
    ((TextView)localObject3).setId(2131378319);
    ((LinearLayout)localObject2).addView((View)localObject3);
    ((QQWalletTransferBubbleView)localObject1).addView((View)localObject2);
    localRelativeLayout.addView((View)localObject1);
    localObject1 = new RelativeLayout(paramContext);
    localObject2 = new RelativeLayout.LayoutParams(this.i, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131378321);
    ((RelativeLayout)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject2);
    ((RelativeLayout)localObject1).setBackgroundResource(2130846709);
    ((RelativeLayout)localObject1).setId(2131378316);
