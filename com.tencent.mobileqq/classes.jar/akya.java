...
public class akya
  implements akxl, Handler.Callback
{
  ...
  public akya(Activity paramActivity, QQAppInterface paramQQAppInterface, int paramInt)
  {
  ...
  public akrw a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    {
      alje.a(localQQAppInterface, paramString1, paramString2, paramInt1);
      return new akrw();
    }
    ...
    else
    {
      if ("cs.script_get_nickname.local".equals(paramString1))
      {
        ...
        return albi.a(paramString2, localQQAppInterface, paramInt1, paramString1);
      }
      if (!"cs.send_game_msg.local".equals(paramString1)) {
        break label403;
      }
      alje.a(localQQAppInterface, paramString2, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    for (;;)
    {
      return null;
      ...
      {
        paramString1 = (aknx)localQQAppInterface.getManager(153);
