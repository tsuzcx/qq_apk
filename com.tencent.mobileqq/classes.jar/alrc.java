...
public class alrc
{
  ...
  public static int a(alrb paramalrb)
  {
    if (paramalrb == null) {
      return 0;
    }
    return paramalrb.jdField_a_of_type_Int * 1000 + paramalrb.b;
  }
  ...
  /* Error */
  public static List<alrb> a(QQAppInterface paramQQAppInterface)
  {
    // Byte code:
    ...
    //   74: new 10	alrb
    //   77: dup
    //   78: invokespecial 103	alrb:<init>	()V
    //   81: astore 6
    //   83: iconst_0
    //   84: istore_2
    //   85: iload_2
    ...
    //   121: putfield 121	alrb:jdField_a_of_type_Long	J
    //   124: goto +104 -> 228
    //   127: ldc 123
    //   129: aload 7
    ...
    //   146: putfield 13	alrb:jdField_a_of_type_Int	I
    //   149: goto +79 -> 228
    //   152: ldc 128
    //   154: aload 7
  ...
  public static Map<Long, alrb> a(List<alrb> paramList)
  {
    if (paramList == null) {
      return null;
    }
    ...
    {
      alrb localalrb = (alrb)paramList.next();
      if (localalrb != null) {
        localHashMap.put(Long.valueOf(localalrb.jdField_a_of_type_Long), localalrb);
      }
    }
    return localHashMap;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.putString("sp_key_leba_upgrade_info", "4515");
    paramQQAppInterface.commit();
    if (QLog.isColorLevel()) {
      QLog.i("LebaHelper", 2, String.format("update version, buildNum[%s]", new Object[] { "4515" }));
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<alrb> paramList)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        if (paramList.hasNext())
        {
          ...
          try
          {
            ...
            localJSONObject.put("uiResId", localalrb.jdField_a_of_type_Long);
            localJSONObject.put("groudId", localalrb.jdField_a_of_type_Int);
            localJSONObject.put("index", localalrb.b);
            localJSONArray.put(localJSONObject);
            if (QLog.isColorLevel()) {
              QLog.i("LebaHelper", 2, "" + localalrb);
            }
          }
  ...
  public static void a(List<aovj> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  public static void a(List<aovj> paramList1, List<aovj> paramList2)
  {
    Collections.sort(paramList2, new alrd());
    paramList2 = paramList2.iterator();
    int i = 0;
    int j = -1;
    if (paramList2.hasNext())
    {
      aovj localaovj1 = (aovj)paramList2.next();
      aovj localaovj2;
      if (a(localaovj1.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.sPriority) != j)
      {
        localaovj2 = new aovj();
        if (paramList1.size() > 0) {
          if (i < 2)
          {
            ((aovj)paramList1.get(paramList1.size() - 1)).jdField_a_of_type_Int = 0;
            label101:
            localaovj2.jdField_a_of_type_JavaLangString = "empty_normal";
            label109:
            paramList1.add(localaovj2);
            j = a(localaovj1.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.sPriority);
            localaovj1.jdField_a_of_type_Int = 1;
            i = 1;
          }
        }
      }
      for (;;)
      {
        paramList1.add(localaovj1);
        break;
        ((aovj)paramList1.get(paramList1.size() - 1)).jdField_a_of_type_Int = 2;
        break label101;
        localaovj2.jdField_a_of_type_JavaLangString = "empty_normal";
        break label109;
        i += 1;
        localaovj1.jdField_a_of_type_Int = 3;
      }
    }
    if (paramList1.size() > 0)
    {
  ...
  public static boolean a(aovj paramaovj)
  {
    if ((paramaovj.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.cDataType == 1) && (!TextUtils.isEmpty(paramaovj.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strPkgName))) {
      return "qzone_feedlist".equals(paramaovj.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strPkgName);
    }
    return false;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = ((aoel)paramQQAppInterface.getManager(269)).a();
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean, Map<Long, LebaPluginInfo> paramMap)
  {
    ...
    for (;;)
    {
      ...
      return bool;
      if (!aiab.a().a(paramQQAppInterface, paramLong)) {
        bool = false;
      } else {
        label140:
        bool = true;
  ...
  public static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (!"4515".equals(paramQQAppInterface)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("LebaHelper", 2, String.format("update version isAppUpgrade[%b], preBuildNum[%s], cur[%s]", new Object[] { Boolean.valueOf(bool), paramQQAppInterface, "4515" }));
      }
      return bool;
    }
  }
