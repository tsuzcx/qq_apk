...
public class bkkj
{
  ...
  public static boolean a()
  {
    ...
    SharedPreferences localSharedPreferences = blev.a().a();
    ...
    AECoderFactory.setAEDecoder(new bkkk());
    AECoderFactory.setAEEncoder(new bkkl());
    ...
    CfConfig.setDecryptListener(new bkkm());
    a = true;
    return true;
  }
