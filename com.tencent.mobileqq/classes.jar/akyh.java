...
public class akyh
{
  private ArrayList<akyi> a = new ArrayList();
  
  /* Error */
  public static akyh a(String paramString)
  {
    // Byte code:
    ...
    //   103: aload_2
    //   104: invokestatic 100	akyh:b	(Ljava/lang/String;)Lakyh;
    //   107: astore_2
    //   108: aload_0
    //   109: ifnull +7 -> 116
    //   112: aload_0
  ...
  public static akyh b(String paramString)
  {
    try
    {
      Object localObject = new JSONObject(paramString);
      akyh localakyh = new akyh();
      JSONArray localJSONArray = ((JSONObject)localObject).getJSONArray("360senceinfo");
      paramString = localakyh;
      if (((JSONObject)localObject).has("360senceinfo"))
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject = new akyi();
            if (paramString.has("text")) {
              ((akyi)localObject).jdField_a_of_type_JavaLangString = paramString.optString("text");
            }
            if (paramString.has("starttime")) {
              ((akyi)localObject).jdField_a_of_type_Long = paramString.optLong("starttime");
            }
            if (paramString.has("endtime")) {
              ((akyi)localObject).b = paramString.optLong("endtime");
            }
            localakyh.a.add(localObject);
            if (QLog.isColorLevel()) {
              QLog.d("ARTransferDoorVideoInfo", 2, "ARTransferDoorVideoInfo parseJson index: " + i + "," + ((akyi)localObject).toString());
            }
            i += 1;
          }
        }
  ...
  public akyi a(long paramLong)
  {
    Iterator localIterator = this.a.iterator();
    while (localIterator.hasNext())
    {
      akyi localakyi = (akyi)localIterator.next();
      long l = localakyi.jdField_a_of_type_Long;
      if ((paramLong < localakyi.b * 1000L) && (paramLong >= l * 1000L)) {
        return localakyi;
      }
    }
    return null;
