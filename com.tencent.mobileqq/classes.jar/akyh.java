...
public class akyh
{
  ...
  public static ResourceInfo a(String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    String str = akxe.a(paramString, paramInt2);
  ...
  public static List<akyi> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (str.startsWith("url_last_use_time")) {
          localArrayList.add(new akyi(str.substring("url_last_use_time".length(), str.length()), ((Long)localEntry.getValue()).longValue(), paramInt));
        }
      }
    }
  ...
  public static void a(int paramInt, PreloadConfig paramPreloadConfig)
  {
    ...
    return;
    Object localObject = akxe.a(paramInt);
    ...
    if (l3 > 209715200L)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        akyi localakyi = (akyi)((Iterator)localObject).next();
        if ((localakyi != null) && (!TextUtils.isEmpty(localakyi.jdField_a_of_type_JavaLangString)) && (l1 - localakyi.jdField_a_of_type_Long > 2592000000L) && (!paramPreloadConfig.isUrlInConfig(localakyi.jdField_a_of_type_JavaLangString)))
        {
          ResourceInfo localResourceInfo = a(localakyi.jdField_a_of_type_JavaLangString, false, 0, localakyi.jdField_a_of_type_Int);
          if (localResourceInfo != null)
          {
            b(localakyi.jdField_a_of_type_JavaLangString, localakyi.jdField_a_of_type_Int);
            albw.a(localResourceInfo.filePath);
            albw.a(localResourceInfo.folderPath);
            akyg.a(localakyi.jdField_a_of_type_JavaLangString, 8, localakyi.jdField_a_of_type_Int);
          }
        }
      }
    }
