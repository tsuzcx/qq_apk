...
{
  private SparseArray<List<bmni>> a = new SparseArray();
  
  public bmnh(AppRuntime paramAppRuntime)
  {
    super("com.tencent.individuality.individualityremotecommand");
    a(0, new bmnj());
  }
  
  public boolean a(int paramInt, bmni parambmni)
  {
    ...
    if (!((List)localObject).contains(parambmni)) {
      return ((List)localObject).add(parambmni);
    }
    return false;
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    if (-1 != i)
    {
      ...
      } while (!((bmni)paramOnInvokeFinishLinstener.next()).a(i, paramBundle));
    }
    label100:
    do
    {
