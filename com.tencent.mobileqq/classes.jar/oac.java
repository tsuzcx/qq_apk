...
public class oac
{
  public static JSONObject a(JSONObject paramJSONObject, AdData paramAdData)
  {
    try
    {
      if (paramAdData.jdField_a_of_type_Nxw == null) {
      ...
      {
        Object localObject3 = sfa.a((String)paramAdData.jdField_a_of_type_JavaUtilArrayList.get(0), 4);
        Object localObject2 = sfa.a((String)paramAdData.jdField_a_of_type_JavaUtilArrayList.get(1), 4);
        localObject1 = sfa.a((String)paramAdData.jdField_a_of_type_JavaUtilArrayList.get(2), 4);
