...
public class biit
{
  ...
  {
    if ((biiv.jdField_a_of_type_Boolean) || (biiv.b))
    {
      StringBuilder localStringBuilder = new StringBuilder("_tcvassp_0_=");
      if ((biiv.jdField_a_of_type_Int != -1) && (biiv.jdField_a_of_type_JavaUtilArrayList.size() != 0))
      {
        localStringBuilder.append(biiv.jdField_a_of_type_Int);
        if (biiv.b) {}
        for (Object localObject = "shp";; localObject = "webp")
        {
          ...
          ((Bundle)localObject).putStringArrayList("domains", biiv.jdField_a_of_type_JavaUtilArrayList);
          if (QLog.isColorLevel())
          {
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, arg: " + localStringBuilder.toString());
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, domainList: " + TextUtils.join(", ", biiv.jdField_a_of_type_JavaUtilArrayList));
          }
          return localObject;
        }
      }
  ...
  public static Bundle a(WebViewFragment paramWebViewFragment, Intent paramIntent)
  {
    ...
    if (localObject != null)
    {
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        ...
        {
          paramWebViewFragment.webView.evaluateJavascript("document.querySelector(\"meta[itemprop='name']\").getAttribute('content')", new biiu(paramWebViewFragment));
          paramIntent = null;
        }
      }
    }
  ...
  {
    Object localObject = BaseApplicationImpl.getApplication().getSharedPreferences("QCirclePluginVersion", 4);
  ...
  public static String a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (WebpSoLoader.b())
      {
        ...
        if (!TextUtils.isEmpty(str2)) {
          biiv.jdField_a_of_type_Boolean = true;
        }
        biiv.b = paramBoolean;
    ...
    for (int k = 1;; k = 0)
    {
      ...
      localObject = localStringBuilder.append((String)localObject).append(" ").append(QZoneHelper.getQUA()).append(a());
      if (!TextUtils.isEmpty(paramString2)) {
        break label497;
      }
      paramString1 = "";
      return paramString1 + " QQ/" + "8.4.10" + "." + "4875" + str1 + str2 + " Pixel/" + n + " StatusBarHeight/" + i1 + " SimpleUISwitch/" + k + " QQTheme/" + ThemeUtil.getCurrentThemeId() + " InMagicWin/" + i;
  ...
  {
    int j = 0;
    if ((biiv.jdField_a_of_type_JavaUtilArrayList.size() != 0) && (biiv.jdField_a_of_type_Int != -1)) {}
    Object localObject1;
    do
    {
      return;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          biiv.jdField_a_of_type_JavaUtilArrayList.clear();
          k = localObject2.length;
          i = 0;
          if (i < k)
          {
            arrayOfString = localObject2[i];
            biiv.jdField_a_of_type_JavaUtilArrayList.add(arrayOfString.trim());
            i += 1;
            continue;
          }
        }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramString.equalsIgnoreCase(paramJSONObject.optString("business", ""))))
    {
      ...
      if (bool2)
      {
        ...
        if (paramJSONObject.has("minVersion"))
        {
          ...
          {
            bool1 = bool2;
            if (!bhnp.a(paramString, "8.4.10.4875")) {
              bool1 = false;
            }
          }
        }
      ...
      if (bool1)
      {
        ...
        if (paramJSONObject.has("maxVersion"))
        {
          ...
          {
            bool2 = bool1;
            if (!bhnp.a("8.4.10.4875", paramString)) {
              bool2 = false;
            }
          }
        }
  ...
  public static void b()
  {
    ...
    biiw.jdField_a_of_type_JavaLangString = localSharedPreferences.getString("http_proxy_address", "");
    biiw.jdField_a_of_type_Boolean = localSharedPreferences.contains("need_set_proxy");
