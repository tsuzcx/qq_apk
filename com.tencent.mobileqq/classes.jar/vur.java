...
{
  vur(AppActivity paramAppActivity, String paramString, QQAppInterface paramQQAppInterface, ScannerParams paramScannerParams, View paramView, vux paramvux) {}
    ...
    else
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramInt = j;
          paramBundle = new vsn(((JSONObject)localObject3).getString("d"));
          paramInt = j;
        ...
        paramInt = j;
        i = vsr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_MqqAppAppActivity, paramBundle, this.jdField_a_of_type_JavaLangString, localBundle);
        paramInt = i;
        ...
        paramInt = i;
        vup.a(i, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqAppAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramInt = i;
        ...
        label451:
        paramBundle = babr.a(this.jdField_a_of_type_MqqAppAppActivity, 230);
        paramBundle.setTitle(2131651441);
        paramBundle.setMessage((CharSequence)localObject1);
        localObject2 = new vus(this);
        paramBundle.setPositiveButton(2131629116, new vut(this, (String)localObject1));
        paramBundle.setNegativeButton(2131625035, (DialogInterface.OnClickListener)localObject2);
        paramBundle.setOnCancelListener((DialogInterface.OnCancelListener)localObject2);
        paramBundle.show();
        vup.a(paramInt, (String)localObject1, this.jdField_a_of_type_MqqAppAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
      ...
      if (((JSONObject)localObject3).has("a_a"))
      {
        ...
        paramInt = j;
        paramBundle = bade.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_MqqAppAppActivity, paramBundle);
        if (paramBundle == null) {
          break label837;
        }
        paramInt = j;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          for (;;)
          {
            vup.a(0, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqAppAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (!this.jdField_a_of_type_ComTencentBizQrcodeIpcScannerParams.b) {
              break;
            }
            this.jdField_a_of_type_MqqAppAppActivity.finish();
