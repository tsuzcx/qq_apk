  ...
  extends vuq
{
  ...
  private bjrh a(int paramInt1, int paramInt2)
  {
    boolean bool1;
    switch (paramInt1)
    {
    ...
    {
      return new bjrj().a(false).e(bool1).f(bool2).g(true).h(true).j(true).b(false).k(true).d(false).c(2).a();
      return new bjrj().a(true).f(false).g(true).h(true).j(true).b(true).k(false).d(false).c(2).a();
      bool1 = false;
      break;
    }
  }
  ...
  public void a(vus paramvus)
  {
    ...
    if (paramvus.jdField_a_of_type_JavaUtilList == null) {}
    for (;;)
    {
      return;
      Object localObject2 = new wav();
      Object localObject1 = new ArrayList(paramvus.jdField_a_of_type_JavaUtilList.size());
      Object localObject5 = new ArrayList(paramvus.jdField_a_of_type_JavaUtilList.size());
      Object localObject3 = (vug)QQStoryContext.a().getBusinessHandler(1);
      Object localObject6 = new ArrayList();
      Object localObject4 = paramvus.jdField_a_of_type_JavaUtilList.iterator();
      Object localObject7;
      Object localObject8;
      for (boolean bool1 = false; ((Iterator)localObject4).hasNext(); bool1 = bool2)
      {
        localObject7 = (SlideItemInfo)((Iterator)localObject4).next();
        localObject8 = ((vug)localObject3).a(((SlideItemInfo)localObject7).jdField_b_of_type_JavaLangString);
        bool2 = bool1;
      ...
      if (a(paramvus))
      {
        a(9, "", null, null, null, paramvus);
        return;
      }
      if (this.jdField_a_of_type_AndroidMediaMediaFormat == null) {
        if (((vug)localObject3).a() != null)
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = ((vug)localObject3).a();
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        if (paramvus.jdField_a_of_type_Vut != null) {
          paramvus.jdField_a_of_type_Vut.a(bool1);
        }
        localObject4 = vuc.a();
        ...
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = vuj.a((String)((List)localObject1).get(0));
          if (QLog.isColorLevel()) {
        ...
        if (this.jdField_a_of_type_AndroidMediaMediaFormat == null)
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = vuj.a();
          if (QLog.isColorLevel())
          {
      ...
      label770:
      for (boolean bool2 = ((wav)localObject2).a((List)localObject6, (String)localObject3);; bool2 = true)
      {
        label627:
      ...
      if (bool2)
      {
        ...
        bool2 = ((wav)localObject2).a((List)localObject1, (String)localObject4, 720, 1280, this.jdField_a_of_type_AndroidMediaMediaFormat);
        ...
        ((LocalMediaInfo)localObject5).mTransferPosList = ((wav)localObject2).b((List)localObject1, (String)localObject4);
        localObject2 = agmg.a(BaseApplicationImpl.getContext());
      }
      try
      {
        ((agmg)localObject2).b((LocalMediaInfo)localObject5);
        if (bool2)
        {
          l1 = System.currentTimeMillis();
          l2 = this.jdField_a_of_type_Long;
          vei.a("actAlbumTime", new String[] { l1 - l2 + "", paramvus.jdField_a_of_type_JavaUtilList.size() + "" });
          ...
          if (bool1)
          {
            ...
            localObject1 = null;
            localObject2 = paramvus.jdField_a_of_type_AndroidAppActivity.getIntent();
            if (localObject2 != null) {
              localObject1 = bjam.a((Intent)localObject2);
            }
            localObject2 = localObject1;
            if (localObject1 == null) {
              localObject2 = new Bundle();
            }
            localObject3 = paramvus.jdField_a_of_type_AndroidAppActivity.getIntent().getExtras();
            localObject1 = localObject3;
            if (localObject3 == null) {
              localObject1 = new Bundle();
            }
            localObject3 = paramvus.jdField_a_of_type_AndroidAppActivity.getIntent();
            ...
            localObject7 = a(vtz.a().a(), i);
            j = ((Bundle)localObject1).getInt("qq_sub_business_id", 1);
            localObject3 = new bjrd(((Bundle)localObject1).getInt("edit_video_type", 10002), i, j);
            ((bjrd)localObject3).a((bjrh)localObject7);
            ((bjrd)localObject3).a(2);
            ...
            ((Bundle)localObject1).putInt("extra_slide_entrance", paramvus.jdField_a_of_type_Int);
            ((Bundle)localObject1).putInt("extra_slide_sticker_id", paramvus.jdField_b_of_type_Int);
            ((Bundle)localObject1).putString("extra_slide_sticker_str", paramvus.jdField_a_of_type_JavaLangString);
            if (paramvus.jdField_a_of_type_JavaUtilList.size() > 0)
            {
              ((Bundle)localObject1).putString("extra_transiton_default", ((SlideItemInfo)paramvus.jdField_a_of_type_JavaUtilList.get(0)).e);
              if (QLog.isColorLevel()) {
                QLog.d("VideoMerger", 2, "doMerge mTransId=" + ((SlideItemInfo)paramvus.jdField_a_of_type_JavaUtilList.get(0)).e);
              }
              if (((SlideItemInfo)paramvus.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Spy != null)
              {
                ((Bundle)localObject1).putInt("extra_ablum_type", ((SlideItemInfo)paramvus.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Spy.jdField_a_of_type_Int);
                if (QLog.isColorLevel()) {
                  QLog.d("VideoMerger", 2, "doMerge mAlbumType=" + ((SlideItemInfo)paramvus.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Spy.jdField_a_of_type_Int);
                }
              }
              localObject7 = vtw.a(paramvus.jdField_a_of_type_AndroidAppActivity).a(((SlideItemInfo)paramvus.jdField_a_of_type_JavaUtilList.get(0)).e);
              if ((localObject7 != null) && (((List)localObject7).size() > 0))
              {
                localObject7 = ((QIMMusicConfigManager)bjav.a(2)).a(((vtx)((List)localObject7).get(0)).jdField_a_of_type_Int, ((vtx)((List)localObject7).get(0)).jdField_b_of_type_Int);
            ...
            paramvus.jdField_a_of_type_AndroidOsHandler.post(new VideoMerger.1(this, paramvus, (CameraCaptureView.VideoCaptureResult)localObject6, (LocalMediaInfo)localObject5, (bjrd)localObject3, (Bundle)localObject2, (Bundle)localObject1));
            localObject1 = paramvus.jdField_a_of_type_JavaUtilList.iterator();
            i = 0;
            ...
            break label917;
            label1934:
            ((LocalMediaInfo)localObject5).mTransferPosList = ((wav)localObject2).b((List)localObject1);
          }
        }
      }
      catch (Throwable localThrowable2)
      {
        ...
        for (;;)
        {
          ...
          continue;
          int k = paramvus.jdField_a_of_type_JavaUtilList.size();
          if (this.jdField_a_of_type_Boolean)
          {
            j = 0;
            vei.a("video_edit_slides", "suc_compose", j, 0, new String[] { "", paramvus.jdField_a_of_type_JavaUtilList.size() + "", k - i + "", i + "" });
            vei.a("actAlbumResult", new String[] { "0" });
            if (!bihx.z)
            {
              bihx.z = true;
              i = 0;
              if (bihx.jdField_a_of_type_Long != -1L) {
                i = (int)(System.currentTimeMillis() - bihx.jdField_a_of_type_Long);
              }
            }
          }
          for (;;)
          {
            try
            {
              l1 = awah.a((String)localObject4);
              vei.a("time_shoot", 10002, i, new String[] { String.valueOf(2), String.valueOf(l1), "", "" });
              if (paramvus.jdField_a_of_type_Vut != null) {
                paramvus.jdField_a_of_type_Vut.j();
              }
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            paramvus.jdField_a_of_type_AndroidOsHandler.post(new VideoMerger.2(this, paramvus));
          }
        }
      }
    }
