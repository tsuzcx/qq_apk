  ...
  extends bkhg
{
  ...
  private bkhs jdField_a_of_type_Bkhs;
  ...
  public bkhr(Context paramContext, String paramString)
  {
  ...
  private void d()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bkhs.sendEmptyMessageDelayed(0, 40L);
      localBitmap = null;
  ...
  public Bitmap a()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_Bkgu.a(this.jdField_a_of_type_Bkgu.a());
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bkhs != null) {
      this.jdField_a_of_type_Bkhs.removeCallbacksAndMessages(null);
    }
  }
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bkhs = new bkhs(new WeakReference(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder = new bjei(this.jdField_b_of_type_JavaLangString);
        ...
        this.k = this.jdField_a_of_type_Bkgu.a("offsetX", 0L, 650L, (int)(-i1 * 0.3D), 0, new bkhp());
        this.l = this.jdField_a_of_type_Bkgu.a("offsetX", 100L, 650L, (int)(-i1 * 0.3D), 0, new bkhp());
        this.m = this.jdField_a_of_type_Bkgu.a("offsetX", 200L, 650L, (int)(-i1 * 0.3D), 0, new bkhp());
        this.n = this.jdField_a_of_type_Bkgu.a("alpha", 0L, 370L, 0, 255, new vtl(0.33F, 0.0F, 0.67F, 1.0F));
        this.o = this.jdField_a_of_type_Bkgu.a("alpha", 100L, 370L, 0, 255, new vtl(0.33F, 0.0F, 0.67F, 1.0F));
        this.p = this.jdField_a_of_type_Bkgu.a("alpha", 200L, 370L, 0, 255, new vtl(0.33F, 0.0F, 0.67F, 1.0F));
        return;
      }
  ...
  protected void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) && (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_Bkhs.sendEmptyMessage(0);
    }
  }
