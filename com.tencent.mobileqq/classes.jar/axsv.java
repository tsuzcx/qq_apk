  ...
  implements Handler.Callback
{
  ...
  public axsv(axsn paramaxsn, String paramString)
  {
  ...
  {
    super.b();
    if ((axsn.a()) && (this.jdField_b_of_type_Int != 0) && (this.jdField_a_of_type_Int > 0))
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 0)
    {
      ...
      axsn.a(this.jdField_b_of_type_Axsn, paramMessage.toString());
      axsn.a(this.jdField_b_of_type_Axsn, new String[] { "nt|fg|", String.valueOf(n), "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
      if (n == 1800) {
        axsn.b(this.jdField_b_of_type_Axsn, new String[] { "fg30Trf", "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
      }
    }
    for (;;)
    {
      ...
      if (paramMessage.what == 3)
      {
        ...
        if (System.currentTimeMillis() - this.m < this.d + 2000L)
        {
          ...
          paramMessage.append(l2 / 1000L).append("/").append(l4 / 1000L);
          axsn.a(this.jdField_b_of_type_Axsn, paramMessage.toString());
          axsn.a(this.jdField_b_of_type_Axsn, new String[] { "nt|bg|", String.valueOf(n), "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
          if (n == 300) {
            axsn.b(this.jdField_b_of_type_Axsn, new String[] { "bg5Trf", "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
          }
        }
      }
    }
