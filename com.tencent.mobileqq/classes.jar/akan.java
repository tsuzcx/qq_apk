...
public class akan
  implements Runnable
{
  public akan(SwiftBrowserLongClickHandler paramSwiftBrowserLongClickHandler, String paramString) {}
  ...
  public void run()
  {
    ...
    if (localObject == null) {
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new akao(this));
    }
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_b_of_type_Int == 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new akap(this));
        return;
      }
    ...
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserLongClickHandler.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new akaq(this));
  }
}
