  ...
  extends auqf
{
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Auqf != null) {
      this.jdField_a_of_type_Auqf.i = ((int)(f1 * f2) + paramInt);
    }
    if (this.jdField_a_of_type_Aurc != null) {
      this.jdField_a_of_type_Aurc.d = paramInt;
    }
    if (this.jdField_b_of_type_Auqf != null) {
      this.jdField_b_of_type_Auqf.g = (this.i + paramInt + this.n);
    }
    if (this.jdField_a_of_type_Aurn != null) {
      this.jdField_a_of_type_Aurn.a(this.f + this.h / 2, this.g);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, View paramView)
  {
    ...
    paramInt2 = (int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298056);
    this.jdField_c_of_type_Int = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298055));
    paramInt3 = this.h / 2;
    paramInt4 = paramInt2 / 2;
    this.jdField_a_of_type_Auqf.a = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844456);
    this.jdField_a_of_type_Auqf.a(paramInt3 + paramInt1 - paramInt4, 0, paramInt2, this.jdField_c_of_type_Int, paramView);
  }
  ...
  public void a(boolean paramBoolean, android.graphics.Bitmap paramBitmap)
  {
    ...
    //   31: aload_0
    //   32: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   46: istore 8
    //   48: aload_0
    //   49: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   61: istore 13
    //   63: aload_0
    //   64: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   76: istore 10
    //   78: aload_0
    //   79: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   91: istore 9
    //   93: aload_0
    //   94: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   108: aload_0
    //   109: iload 9
    //   111: putfield 85	auqw:d	I
    //   114: aload_2
    //   115: astore 16
    //   117: aload_2
    //   118: ifnonnull +31 -> 149
    //   121: aload_0
    //   122: getfield 191	auqw:jdField_b_of_type_Int	I
    //   125: iconst_1
    //   126: if_icmpne +358 -> 484
    //   129: aload_0
    //   130: getfield 117	auqw:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   147: astore 16
    //   149: aload_0
    //   150: getfield 191	auqw:jdField_b_of_type_Int	I
    //   153: iconst_1
    //   154: if_icmpne +363 -> 517
    //   157: aload_0
    //   158: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   192: fstore 4
    //   194: aload_0
    //   195: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   206: fstore 7
    //   208: aload_0
    //   209: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   236: fstore_3
    //   237: aload_0
    //   238: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   241: ifnonnull +96 -> 337
    //   244: aload_0
    //   245: new 94	aurc
    //   248: dup
    //   249: aload_0
    //   250: getfield 117	auqw:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   253: iload 13
    //   255: iload 8
    //   257: iload 10
    //   259: iload 9
    ...
    //   269: fload 5
    //   271: f2i
    //   272: invokespecial 210	aurc:<init>	(Landroid/content/Context;IIIIIIII)V
    //   275: putfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   278: aload_0
    //   279: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   282: aload_0
    //   283: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   294: f2i
    //   295: putfield 212	aurc:i	I
    //   298: aload_0
    //   299: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   302: aload_0
    //   303: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   314: f2i
    //   315: putfield 216	aurc:j	I
    //   318: aload_0
    //   319: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   322: aload_0
    //   323: getfield 117	auqw:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   334: invokevirtual 220	aurc:c	(Landroid/graphics/Bitmap;)V
    //   337: aload_0
    //   338: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   341: fload 4
    //   343: f2i
    //   344: putfield 221	aurc:e	I
    //   347: aload_0
    //   348: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   351: fload_3
    //   352: f2i
    //   353: putfield 222	aurc:f	I
    //   356: aload_0
    //   357: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   360: fload 6
    //   362: f2i
    //   363: putfield 223	aurc:g	I
    //   366: aload_0
    //   367: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   370: fload 5
    //   372: f2i
    //   373: putfield 224	aurc:h	I
    //   376: aload_0
    //   377: getfield 191	auqw:jdField_b_of_type_Int	I
    //   380: iconst_1
    //   381: if_icmpne +206 -> 587
    //   384: aload_0
    //   385: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   388: aload_0
    //   389: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   400: f2i
    //   401: putfield 226	aurc:k	I
    //   404: aload_0
    //   405: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   408: aload_0
    //   409: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   420: f2i
    //   421: putfield 228	aurc:l	I
    //   424: aload_0
    //   425: getfield 191	auqw:jdField_b_of_type_Int	I
    //   428: iconst_3
    //   429: if_icmpne +189 -> 618
    //   432: aload_0
    //   433: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   436: aload 16
    //   438: invokevirtual 230	aurc:a	(Landroid/graphics/Bitmap;)V
    //   441: aload_0
    //   442: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   445: invokevirtual 232	aurc:a	()V
    //   448: aload_0
    //   449: iload 10
    //   451: iload 9
    //   453: iload 13
    //   455: iload 8
    //   457: aload_0
    //   458: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   461: invokevirtual 233	auqw:a	(IIIILandroid/view/View;)V
    //   464: iload_1
    //   465: ifeq +165 -> 630
    //   468: aload_0
    //   469: aconst_null
    //   470: putfield 97	auqw:jdField_b_of_type_Auqf	Lauqf;
    //   473: aload_0
    //   474: invokevirtual 234	auqw:a	()V
    //   477: return
    //   478: astore_2
    //   479: aload_2
    ...
    //   483: return
    //   484: aload_0
    //   485: getfield 117	auqw:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   514: goto -365 -> 149
    //   517: aload_0
    //   518: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   533: fstore 5
    //   535: aload_0
    //   536: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   584: goto -247 -> 337
    //   587: aload_0
    //   588: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   591: iconst_0
    //   592: putfield 226	aurc:k	I
    //   595: aload_0
    //   596: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   599: aload_0
    //   600: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    ...
    //   611: f2i
    //   612: putfield 228	aurc:l	I
    //   615: goto -191 -> 424
    //   618: aload_0
    //   619: getfield 92	auqw:jdField_a_of_type_Aurc	Laurc;
    //   622: aload 16
    //   624: invokevirtual 243	aurc:b	(Landroid/graphics/Bitmap;)V
    //   627: goto -179 -> 448
    //   630: aload_0
    //   631: new 4	auqf
    //   634: dup
    //   635: invokespecial 115	auqf:<init>	()V
    //   638: putfield 97	auqw:jdField_b_of_type_Auqf	Lauqf;
    //   641: aload_0
    //   642: aload_0
    //   643: getfield 117	auqw:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   654: f2i
    //   655: putfield 99	auqw:n	I
    //   658: aload_0
    //   659: getfield 117	auqw:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   671: istore 11
    //   673: aload_0
    //   674: getfield 117	auqw:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   698: istore 14
    //   700: aload_0
    //   701: getfield 99	auqw:n	I
    //   704: istore 15
    //   706: aload_0
    //   707: getfield 97	auqw:jdField_b_of_type_Auqf	Lauqf;
    //   710: iload 13
    //   712: iload 10
    //   714: iadd
    //   715: iload 14
    ...
    //   728: iload 12
    //   730: aload_0
    //   731: getfield 178	auqw:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   734: invokevirtual 110	auqf:a	(IIIILandroid/view/View;)V
    //   737: goto -264 -> 473
  ...
  {
    boolean bool2 = false;
    boolean bool3 = super.c();
    a();
    paramCanvas.save();
    paramCanvas.translate(0.0F, this.k);
    if ((this.jdField_a_of_type_Auqf != null) && (this.j != 0))
    {
      this.jdField_a_of_type_Auqf.j = this.j;
      this.jdField_a_of_type_Auqf.a(paramCanvas);
    }
    super.c(paramCanvas);
    if (this.jdField_a_of_type_Aurc != null) {}
    for (boolean bool1 = this.jdField_a_of_type_Aurc.a(paramCanvas);; bool1 = false)
    {
      if ((this.jdField_b_of_type_Auqf != null) && (this.j != 0))
      {
        this.jdField_b_of_type_Auqf.j = this.j;
        this.jdField_b_of_type_Auqf.a(paramCanvas);
      }
      this.jdField_a_of_type_Aurn.a(paramCanvas);
      paramCanvas.restore();
  ...
  public void b()
  {
    ...
    this.e = 3;
    this.jdField_a_of_type_AndroidViewAnimationInterpolator = new auqg();
    a(1500L);
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Aurc != null)
    {
      this.jdField_a_of_type_Aurc.jdField_b_of_type_Float = 1.0F;
      this.jdField_a_of_type_Aurc.a = 1.0F;
    }
  }
  
  public void d()
  {
    bbkk localbbkk = new bbkk(Float.valueOf(1.0F), Float.valueOf(1.1F), new auqx(this));
    localbbkk.setDuration(500L);
    localbbkk.setRepeatCount(-1);
    localbbkk.setRepeatMode(2);
    a(localbbkk);
    this.jdField_a_of_type_Aurn.b();
  }
