...
public class bhre
{
  ...
  {
    if ((bhrg.jdField_a_of_type_Boolean) || (bhrg.b))
    {
      StringBuilder localStringBuilder = new StringBuilder("_tcvassp_0_=");
      if ((bhrg.jdField_a_of_type_Int != -1) && (bhrg.jdField_a_of_type_JavaUtilArrayList.size() != 0))
      {
        localStringBuilder.append(bhrg.jdField_a_of_type_Int);
        if (bhrg.b) {}
        for (Object localObject = "shp";; localObject = "webp")
        {
          ...
          ((Bundle)localObject).putStringArrayList("domains", bhrg.jdField_a_of_type_JavaUtilArrayList);
          if (QLog.isColorLevel())
          {
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, arg: " + localStringBuilder.toString());
            QLog.i("SwiftWebViewUtils", 2, "getCDNExtensionData, domainList: " + TextUtils.join(", ", bhrg.jdField_a_of_type_JavaUtilArrayList));
          }
          return localObject;
        }
      }
  ...
  public static Bundle a(WebViewFragment paramWebViewFragment, Intent paramIntent)
  {
    ...
    if (localObject != null)
    {
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        ...
        {
          paramWebViewFragment.webView.evaluateJavascript("document.querySelector(\"meta[itemprop='name']\").getAttribute('content')", new bhrf(paramWebViewFragment));
          paramIntent = null;
        }
      }
    }
  ...
  public static String a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (WebpSoLoader.b())
      {
        ...
        if (!TextUtils.isEmpty(str2)) {
          bhrg.jdField_a_of_type_Boolean = true;
        }
        bhrg.b = paramBoolean;
        ...
        localObject = localStringBuilder.append((String)localObject).append(" ").append(blsb.a());
    ...
    {
      return paramString1 + " QQ/" + "8.4.1" + "." + "4680" + str1 + str2 + " Pixel/" + j + " StatusBarHeight/" + k + " SimpleUISwitch/" + i + " QQTheme/" + ThemeUtil.getCurrentThemeId();
  ...
  {
    int j = 0;
    if ((bhrg.jdField_a_of_type_JavaUtilArrayList.size() != 0) && (bhrg.jdField_a_of_type_Int != -1)) {}
    Object localObject1;
    do
    {
      return;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          bhrg.jdField_a_of_type_JavaUtilArrayList.clear();
          k = localObject2.length;
          i = 0;
          if (i < k)
          {
            arrayOfString = localObject2[i];
            bhrg.jdField_a_of_type_JavaUtilArrayList.add(arrayOfString.trim());
            i += 1;
            continue;
          }
        }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (paramString.equalsIgnoreCase(paramJSONObject.optString("business", ""))))
    {
      ...
      if (bool2)
      {
        ...
        if (paramJSONObject.has("minVersion"))
        {
          ...
          {
            bool1 = bool2;
            if (!bgyg.a(paramString, "8.4.1.4680")) {
              bool1 = false;
            }
          }
        }
      ...
      if (bool1)
      {
        ...
        if (paramJSONObject.has("maxVersion"))
        {
          ...
          {
            bool2 = bool1;
            if (!bgyg.a("8.4.1.4680", paramString)) {
              bool2 = false;
            }
          }
        }
  ...
  public static void b()
  {
    ...
    bhrh.jdField_a_of_type_JavaLangString = localSharedPreferences.getString("http_proxy_address", "");
    bhrh.jdField_a_of_type_Boolean = localSharedPreferences.contains("need_set_proxy");
