...
public class ambh
{
  ...
  public ambh(int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
  ...
  public ambh(int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, amcn paramamcn, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, double paramDouble, String[] paramArrayOfString, ambi paramambi1, int paramInt5, int paramInt6, ambi paramambi2, List<Pair<ambi, ambi>> paramList, HashMap<String, String> paramHashMap)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
    ...
    this.jdField_a_of_type_Ambi = paramambi1;
    this.jdField_b_of_type_Ambi = paramambi2;
  ...
  private Drawable a(Context paramContext, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      paramInt1 = bbak.a(localDrawable) + bbak.a(paramContext);
  ...
  private Pair<ambi, ambi> a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      } while (!paramString.equals(((ambi)localPair.first).jdField_b_of_type_JavaLangString));
    }
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, View paramView, String paramString, int paramInt)
  {
    ...
    if (paramBoolean2)
    {
      ...
      localObject2 = new amcz(paramQQAppInterface.getApp().getResources(), this.jdField_a_of_type_AndroidGraphicsNinePatch, this.jdField_b_of_type_AndroidGraphicsNinePatch, this.jdField_a_of_type_Int);
      if (paramBoolean1) {
        break label644;
      }
      bool = true;
      ((amcz)localObject2).a(bool, paramBoolean3);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      int j;
      if (((localObject2 instanceof amcz)) && (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)))
      {
        if ((this.jdField_a_of_type_Amcn == null) || (paramView == null)) {
          break label832;
        }
        j = paramView.getWidth();
        if (this.jdField_a_of_type_Amcn.jdField_c_of_type_Int == 0) {
          ((amcz)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Amcn.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Amcn.jdField_a_of_type_JavaLangString);
        }
      }
      else if (((localObject2 instanceof amcz)) && (paramBoolean2) && (!paramBoolean3) && (paramInt > 0))
      {
        paramString = paramString + "_" + paramInt;
        localObject1 = (amcz)localObject2;
        if (paramBoolean1) {
          break label855;
        }
      }
      ...
      {
        ((amcz)localObject1).a(paramQQAppInterface, paramString, paramBoolean1);
        ...
        if (i > this.jdField_a_of_type_Amcn.jdField_c_of_type_Int)
        {
          ((amcz)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Amcn.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Amcn.jdField_a_of_type_JavaLangString);
          break label562;
        }
        ((amcz)localObject2).a(false, null, null, null);
        break label562;
        if (!(localObject2 instanceof amcz)) {
          break label562;
        }
        ((amcz)localObject2).a(false, null, null, null);
        break label562;
  ...
  {
    amcn localamcn = this.jdField_a_of_type_Amcn;
    if (!paramBoolean4) {
    ...
    this.jdField_a_of_type_Amcn = localamcn;
    return paramQQAppInterface;
  }
  
  public Pair<ambi, ambi> a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (paramQQAppInterface = "null";; paramQQAppInterface = "first:" + ((Pair)localObject1).first + ",second:" + ((Pair)localObject1).second)
    {
      ...
      return localObject1;
      if (((ambe)localObject2).a == null) {
        break;
      }
      paramQQAppInterface = ((ambe)localObject2).a.jdField_b_of_type_JavaLangString;
      break label102;
      if (((ambe)localObject2).b == null) {
        break;
      }
      paramQQAppInterface = ((ambe)localObject2).b.jdField_b_of_type_JavaLangString;
      break label102;
      paramQQAppInterface = "width";
      if (((ambe)localObject2).c == null) {
        break label102;
      }
      paramQQAppInterface = ((ambe)localObject2).c.jdField_b_of_type_JavaLangString;
      break label102;
      ...
      break label102;
      if (((ambe)localObject2).d == null) {
        break;
      }
      paramQQAppInterface = ((ambe)localObject2).d.jdField_b_of_type_JavaLangString;
      break label102;
      if (((ambe)localObject2).e == null) {
        break;
      }
      paramQQAppInterface = ((ambe)localObject2).e.jdField_b_of_type_JavaLangString;
      break label102;
    }
  }
