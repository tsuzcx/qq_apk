  ...
  implements View.OnClickListener
{
  ...
  public spz(View paramView, BaseData paramBaseData)
  {
  ...
  private static int a(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    return agej.a(paramInt1, paramContext.getResources());
  }
  
  private void a(URLDrawable paramURLDrawable)
  {
    int i = agej.a(this.d, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    int j = agej.a(this.c, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    ...
    paramURLDrawable = new LinearLayout.LayoutParams(a(this.jdField_a_of_type_AndroidViewView.getContext()) - i - i, agej.a(190.0F, this.jdField_a_of_type_AndroidViewView.getContext().getResources()));
    paramURLDrawable.leftMargin = i;
    paramURLDrawable.rightMargin = i;
    paramURLDrawable.topMargin = j;
    paramURLDrawable.bottomMargin = j;
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    int j = agej.a(this.d, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    int k = agej.a(this.c, this.jdField_a_of_type_AndroidViewView.getContext().getResources());
    ...
    for (;;)
    {
      ...
      paramBaseData1.mUseSharpPImage = blem.a(this.jdField_a_of_type_AndroidViewView.getContext());
      paramBaseData1.mMemoryCacheKeySuffix = "fast_web";
      paramBaseData1 = URLDrawable.getDrawable(tye.a(spy.a(paramBaseData2.jdField_a_of_type_JavaLangString, paramBaseData2), 4), paramBaseData1);
      if (i != 0) {
        a(paramBaseData1);
      }
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new sqa(this));
      return;
  ...
  {
    this.jdField_a_of_type_Spn.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData);
    ...
    for (Object localObject = "2";; localObject = "1")
    {
      ...
      ssy.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8008996", ((JSONObject)localObject).toString());
