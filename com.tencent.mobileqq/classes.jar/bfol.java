...
public abstract class bfol
  implements DownloadParams.DecodeHandler
{
  public static final DownloadParams.DecodeHandler A = new bfpc();
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentImageDownloadParams$DecodeHandler = new bfom();
    b = new bfox();
    c = new bfpd();
    d = new bfpe();
    e = new bfpf();
