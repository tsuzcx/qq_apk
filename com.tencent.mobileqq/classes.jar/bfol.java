  ...
  extends Dialog
{
  ...
  private bfor jdField_a_of_type_Bfor;
  private bfos jdField_a_of_type_Bfos;
  private bfot jdField_a_of_type_Bfot;
  ...
  private HashMap<CharSequence, bfok> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new bfoo(this);
  ...
  protected bfol(Context paramContext)
  {
    this(paramContext, false, false);
  }
  
  protected bfol(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true, -1, null);
  }
  
  @TargetApi(14)
  protected bfol(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    super(paramContext, 2131755221);
    this.jdField_d_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bfop(this);
  ...
  public static bfol a(Context paramContext)
  {
    paramContext = new bfol(paramContext, false, false);
  ...
  public static bfol a(Context paramContext, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    paramContext = new bfol(paramContext, false, false, true, paramInt, paramLayoutParams);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  public static bfol a(Context paramContext, boolean paramBoolean)
  {
    paramContext = new bfol(paramContext, false, true, paramBoolean, -1, null);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  public static bfol b(Context paramContext)
  {
    paramContext = new bfol(paramContext, false, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  public static bfol c(Context paramContext)
  {
    paramContext = new bfol(paramContext, true, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  public static bfol d(Context paramContext)
  {
    paramContext = new bfol(paramContext, true, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755010);
    }
    return paramContext;
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_JavaLangCharSequence != null)
    {
      ...
      ((View)localObject1).setOnClickListener(new bfom(this));
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          ...
          if (((Integer)((Pair)localObject1).second).intValue() == 65537)
          {
            ...
            localObject2 = (TextView)localView.findViewById(2131361914);
            localObject3 = (TextView)localView.findViewById(2131376701);
            ...
            if ((m >= 0) && (m < ((CharSequence)((Pair)localObject1).first).length()))
            {
              ...
              localView.findViewById(2131363758).setContentDescription(((TextView)localObject2).getText());
              label408:
              bawi.b(localView.findViewById(2131363758), LinearLayout.class.getName());
              label424:
              if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
              {
                localObject3 = (bfok)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
                if ((localObject3 != null) && (((bfok)localObject3).jdField_b_of_type_Int != 0)) {
                  ((TextView)localObject2).setId(((bfok)localObject3).jdField_b_of_type_Int);
                }
              }
              ...
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
              ...
              {
                ((RelativeLayout.LayoutParams)localObject4).width = bawz.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).height = bawz.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).addRule(15);
              }
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
              ((ImageView)localObject3).setLayoutParams((ViewGroup.LayoutParams)localObject4);
              ...
              if (this.jdField_a_of_type_Boolean)
              {
                ...
                localView.findViewById(2131361915).setVisibility(0);
          ...
          for (;;)
          {
            ...
            localObject2 = (TextView)localView.findViewById(2131361914);
            ((TextView)localObject2).setText((CharSequence)((Pair)localObject1).first);
            bawi.b((View)localObject2, Button.class.getName());
            break label424;
            label1002:
  ...
  public bfok a(int paramInt)
  {
    return a(a(paramInt));
  }
  
  public bfok a(CharSequence paramCharSequence)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      return null;
    }
    return (bfok)this.jdField_a_of_type_JavaUtilHashMap.get(paramCharSequence);
  }
  ...
  public void a(int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    if ((paramInt1 >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (localObject != null)
      {
        localObject = ((View)localObject).findViewById(2131361914);
  ...
  public void a(bfok parambfok, int paramInt)
  {
    if (parambfok == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(parambfok.a, parambfok);
    a(parambfok.a, paramInt);
  }
  
  public void a(bfoq parambfoq)
  {
    this.jdField_a_of_type_Bfoq = parambfoq;
  }
  
  public void a(bfor parambfor)
  {
    this.jdField_a_of_type_Bfor = parambfor;
  }
  ...
  public void a(bfot parambfot)
  {
    this.jdField_a_of_type_Bfot = parambfot;
  }
  
  public void a(bfou parambfou)
  {
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      ((VerticalCenterImageSpan)localObject).setPadding(actn.a(10.0F, this.jdField_a_of_type_AndroidContentResResources), 0);
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        if (localView != null)
        {
          localView.findViewById(2131361915).setVisibility(8);
          a((TextView)localView.findViewById(2131361914), false);
        }
        i += 1;
      }
    }
  ...
  public void d(int paramInt)
  {
    if ((paramInt >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (this.jdField_a_of_type_AndroidUtilSparseArray != null)
      {
        ...
        {
          localView.findViewById(2131361915).setVisibility(0);
          a((TextView)localView.findViewById(2131361914), true);
        }
      }
    }
  }
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Bfot != null) {
      this.jdField_a_of_type_Bfot.ak_();
    }
    if (this.g)
    {
      this.g = false;
  ...
  public void e()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 701	zzs:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 701	zzs:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 701	zzs:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
