...
public class bkac
{
  ...
  public static String a(int paramInt)
  {
    try
    {
      ...
      String str2 = bgln.e();
      String str3 = bgln.a(MobileQQ.sMobileQQ);
      String str4 = bkab.a();
      String str5 = bkab.b();
      ...
      localbkaf.a((byte[])localObject).a(str2).a(str3).a(str4).a(str5).a(str6).a(str7).a(str8);
      if (paramInt >= 2) {
        localbkaf.a(bkab.c()).a(AppSetting.a()).a(bgln.f()).a("").a("");
      }
      localObject = localbkaf.toString();
    }
  ...
  private static void b(QQAppInterface paramQQAppInterface, SafeReport.ReqBody paramReqBody)
  {
    ...
    for (;;)
    {
      nir.a(paramQQAppInterface, new bkad(), paramReqBody.toByteArray(), "MqqSafeDataRpt.MQDun");
      return;
    }
  }
