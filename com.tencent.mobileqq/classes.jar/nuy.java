  ...
  implements Manager
{
  ...
  public nuy(QQAppInterface paramQQAppInterface)
  {
  ...
  private ofg a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      return (ofg)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(237);
    }
    return null;
  }
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new nvc(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new nvd(this, null));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(b(), "");
    this.jdField_a_of_type_Nvb = new nvb(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nvb);
  ...
  public void a(nuk paramnuk)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        c("handlePreloadTaskFromMessage msgid:" + paramnuk.c + ", vid:" + localnum.b);
        if (!TextUtils.isEmpty(localnum.b))
        {
          ...
          localPAAdPreloadTask.mMsgId = paramnuk.c;
          ...
          if (paramnuk.jdField_a_of_type_Long > 0L)
          {
            ...
            c("handlePreloadTaskFromMessage msgid:" + paramnuk.c + ", vid:" + localnum.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label309:
      c("handlePreloadTaskFromMessage msgid:" + paramnuk.c + ", vid:" + localnum.b + ", exist in queue, ignore");
    }
  }
  
  public void a(nuk paramnuk, int paramInt)
  {
    Object localObject = this.jdField_a_of_type_JavaLangObject;
    if (paramnuk != null) {}
    for (;;)
    {
      ...
      try
      {
        if ((paramnuk.jdField_a_of_type_Nun == null) || (paramnuk.jdField_a_of_type_JavaUtilArrayList == null) || (paramnuk.jdField_a_of_type_JavaUtilArrayList.size() <= paramInt))
        {
          c("handlePreloadTaskFromPlay invalid item");
          return;
        }
        str = ((num)paramnuk.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).b;
        c("handlePreloadTaskFromPlay msgid:" + paramnuk.c + ", index:" + paramInt + ", vid:" + str);
        if (!TextUtils.isEmpty(str))
        {
          PAAdPreloadTask localPAAdPreloadTask = new PAAdPreloadTask();
          localPAAdPreloadTask.mUserUin = b();
          ...
          if (paramnuk.jdField_a_of_type_Long > 0L)
          {
            ...
            localPAAdPreloadTask.mExpireTime = (localPAAdPreloadTask.mReceiveTime + jdField_a_of_type_JavaLangLong.longValue());
            localPAAdPreloadTask.mPreloadState = 1;
            localPAAdPreloadTask.mNetworkType = paramnuk.jdField_a_of_type_Nun.e;
            this.c.add(localPAAdPreloadTask);
            ThreadManager.executeOnNetWorkThread(new AdvertisementVideoPreloadManager.9(this));
            c("handlePreloadTaskFromPlay msgid:" + paramnuk.c + ", index:" + paramInt + ", vid:" + str + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label317:
      c("handlePreloadTaskFromPlay msgid:" + paramnuk.c + ", index:" + paramInt + ", vid:" + str + ", exist in queue, ignore");
    }
  }
  ...
  public void onDestroy()
  {
    ...
    {
      this.jdField_a_of_type_Nvb.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Nvb);
