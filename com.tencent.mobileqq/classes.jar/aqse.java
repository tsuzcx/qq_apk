...
public class aqse
  ...
  implements aqsm
{
  private static volatile aqse jdField_a_of_type_Aqse;
  public static boolean a;
  private List<aqsg> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public static aqse a()
  {
    if (jdField_a_of_type_Aqse == null) {}
    try
    {
      if (jdField_a_of_type_Aqse == null) {
        jdField_a_of_type_Aqse = new aqse();
      }
      return jdField_a_of_type_Aqse;
    }
    finally {}
  }
  ...
  public static void a()
  {
    ...
    {
      QIPCClientHelper.getInstance().register(localaqse);
  ...
  public Bundle a(String paramString, Bundle paramBundle)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = aqsc.a().a(l2, l1);
      localObject = aqsc.a().a((String)localObject);
      if (localObject == null) {
        break label243;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (bool) {
        QLog.d("DanmuDataIPCClient", 2, new Object[] { "peak listSize:", Integer.valueOf(((aqsd)localObject).d.size()), ", fullList:", ((aqsd)localObject).d.toString() });
      }
      paramBundle.putBoolean("key_barrage_is_update", bool);
      paramBundle.putLong("key_barrage_req_time", System.currentTimeMillis());
      QIPCClientHelper.getInstance().getClient().callServer("DanmuDataIPCServer", "qipc_action_get_barrage", paramBundle, new aqsf(this));
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty()))
    {
      ...
      j = 1;
      localObject3 = aqsc.a().a(l2, l1);
      paramBundle = aqsc.a().a((String)localObject3);
      if (paramBundle != null) {
        break label649;
      }
      paramBundle = aqsc.a().b((String)localObject3);
    }
    label516:
    label649:
    for (;;)
    {
      if ((bool) && ((i != 0) || (j != 0)))
      {
        ...
        localObject2 = new aqsb(l2, l1, k, true);
        paramBundle.a((List)localObject1).b((List)localObject3).a((aqsb)localObject2).a(null).a();
      }
      if ((bool) && (paramBundle != null) && (!paramBundle.d.isEmpty()))
      {
        localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject1).hasNext()) {
          ((aqsg)((Iterator)localObject1).next()).a(l1, String.valueOf(l2), m, paramBundle.d);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  {
    if ((paramaqsg != null) && (!this.jdField_a_of_type_JavaUtilList.contains(paramaqsg))) {
      this.jdField_a_of_type_JavaUtilList.add(paramaqsg);
    }
  }
  ...
  public void b(aqsg paramaqsg)
  {
    if ((paramaqsg != null) && (this.jdField_a_of_type_JavaUtilList.contains(paramaqsg))) {
      this.jdField_a_of_type_JavaUtilList.remove(paramaqsg);
    }
  }
    ...
    for (;;)
    {
      ...
      if ("qipc_action_send_barrage".equals(paramString))
      {
        ...
        while (localIterator.hasNext()) {
          ((aqsg)localIterator.next()).a(l, paramBundle, paramString);
        }
      }
    }
  }
