  ...
  implements View.OnClickListener
{
  ...
  public vvn(QQWalletHbItemUtils paramQQWalletHbItemUtils) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramView = VoiceRedPacketHelper.a(localMessageForQQWalletMsg);
        ((PasswdRedBagManager)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioQwalletQQWalletHbItemUtils.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (PasswdRedBagInfo)localObject2, l, 65536, paramView, localMessageForQQWalletMsg.fromHBList);
      } while (!QLog.isColorLevel());
