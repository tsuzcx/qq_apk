...
public class akit
  extends akhu
{
  akit(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  private void a(LocalMediaInfo paramLocalMediaInfo, Bundle paramBundle)
  {
    ...
    bpwu.a(this.mActivity, paramLocalMediaInfo.path, paramLocalMediaInfo, 0, (int)paramLocalMediaInfo.mDuration, i, 10023, 0, null, null, false, 11, 14, paramBundle);
  }
  ...
  private void g(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if ((paramLocalMediaInfo == null) || (TextUtils.isEmpty(paramLocalMediaInfo.path)) || (this.mActivity == null) || (this.mActivity == null) || (((NewPhotoListActivity)this.mActivity).getIntent() == null))
    {
      ...
      {
        paramLocalMediaInfo = "";
        bnzb.d("PhotoListLogicAECamera", paramLocalMediaInfo);
      }
    }
    do
    {
      ...
      break;
      f();
      if (!bnqb.a(((NewPhotoListActivity)this.mActivity).getIntent()))
      {
      ...
      localObject = aaxc.a().a(paramLocalMediaInfo.path, "2");
    } while (TextUtils.isEmpty((CharSequence)localObject));
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    bggl.a(paramLocalMediaInfo.path, localOptions);
    int i = bclx.a;
    ...
    aaxc.a().a(paramLocalMediaInfo.path, (String)localObject, "2", j, i, false, 0, new akix(this, (String)localObject, paramLocalMediaInfo));
  }
  ...
  public void caseSingleModeImage(View paramView, int paramInt)
  {
    ...
    MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new akiu(this), paramView);
  }
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    ((NewPhotoListActivity)this.mActivity).showProgressDialog();
    f();
    MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new akiv(this, localIntent, localArrayList), paramView);
  }
