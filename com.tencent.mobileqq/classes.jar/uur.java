...
public class uur
  implements Runnable
{
  public uur(GivingHeartItemBuilder paramGivingHeartItemBuilder, Activity paramActivity, boolean paramBoolean1, boolean paramBoolean2) {}
  ...
  public void run()
  {
    ...
    View localView = ((ViewGroup)this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView()).getChildAt(0).findViewById(2131363473);
    ...
    {
      localAnimationSet.setAnimationListener(new uus(this));
      if (localView == null) {
        break;
      }
