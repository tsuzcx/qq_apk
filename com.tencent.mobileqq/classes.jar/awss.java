...
public class awss
  extends alpc
{
  private WeakReference<awst> a;
  
  public awss(ark.Application paramApplication, long paramLong)
  {
  ...
  public void a(awst paramawst)
  {
    this.a = new WeakReference(paramawst);
  }
  ...
  protected boolean a(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      else if (k == 7)
      {
        ...
        continue;
        axqy.b(localQQAppInterface, "CliOper", "", str, paramVariantWrapper, (String)localObject1, i, j, String.valueOf(l1), String.valueOf(l2), (String)localObject3, (String)localObject2);
        return true;
      }
      else
      {
