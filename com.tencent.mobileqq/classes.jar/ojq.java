  ...
  implements pln
{
  ...
  private ojt jdField_a_of_type_Ojt = new ojt();
  private Map<Integer, List<ojs>> b = new HashMap();
  private Map<String, List<Double>> c = new HashMap();
  
  private ojq()
  {
    pli.a(this);
    bkwv.a().a(this.jdField_a_of_type_Ojt);
  }
  ...
  private JSONObject a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localJSONObject.put("package_name", "8.4.8.4810");
  ...
  {
    boolean bool = ((Boolean)bkwm.a("sp_key_readinjoy_feeds_drop_frame_switch", Boolean.valueOf(true))).booleanValue();
    QLog.d("ReadInJoyDropFrameHelper", 1, "ReadInJoyDropFrameHelper | Report enable :" + bool);
    return bool;
  }
  
  public void a(int paramInt, ojs paramojs)
  {
    if (this.b != null) {
    ...
    {
      if (!((List)localObject).contains(paramojs)) {
        ((List)localObject).add(paramojs);
      }
  ...
  public void b(int paramInt, ojs paramojs)
  {
    if ((this.b != null) && (this.b.get(Integer.valueOf(paramInt)) != null)) {
      ((List)this.b.get(Integer.valueOf(paramInt))).remove(paramojs);
    }
  }
