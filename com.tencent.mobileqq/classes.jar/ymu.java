...
public class ymu
{
  public static String a(DeviceInfo paramDeviceInfo)
  {
    ...
    {
      localObject = ((yah)((QQAppInterface)localObject).a(51)).a(paramDeviceInfo.productId);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, DeviceInfo paramDeviceInfo, String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = bfnx.a(paramString);
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            bhwm.a().a((Activity)paramContext, paramQQAppInterface, paramQQAppInterface.getAccount(), paramDeviceInfo, "com.tencent.device.activities.DeviceSquareActivity", 0, null, SmartDevicePluginProxyActivity.class);
            ymt.a(null, "Usr_NewDevice_Aio", 2, 0, 0);
            return;
          }
        }
        catch (Exception paramQQAppInterface)
        {
          bdii.c("SmartDeviceUtil", "jumpLightApp, Exception >>>", paramQQAppInterface);
          return;
        }
      ...
      ((yah)paramQQAppInterface.a(51)).a(paramString);
    ...
    paramBundle = (yah)paramQQAppInterface.a(51);
  ...
  public static void a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, String paramString)
  {
    if (AppSetting.b)
    {
      bdii.e("SmartDeviceUtil", "AppSetting.IS_CPU_64_BIT, disable device model");
      return;
    }
    ...
    try
    {
      ...
      paramJSONObject = (StructMsgForGeneralShare)axva.a((Bundle)localObject);
      localObject = (MessageForStructing)axas.a(-2011);
  ...
  public static void a(String paramString1, Bundle paramBundle, int paramInt, String paramString2, AppRuntime paramAppRuntime, BusinessObserver paramBusinessObserver)
  {
    ...
    paramBundle.putString("version", "8.3.0");
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), xqk.class);
