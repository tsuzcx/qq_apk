  ...
  implements Manager, vpk
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = vpl.a("StorySvc.video_config_get");
    jdField_b_of_type_JavaLangString = vpl.a("StorySvc.video_config_set");
    jdField_c_of_type_JavaLangString = vpl.a("StorySvc.video_get_user_mask_list");
    jdField_d_of_type_JavaLangString = vpl.a("StorySvc.video_set_user_mask");
    jdField_e_of_type_JavaLangString = vpl.a("StorySvc.video_get_user_mask_states");
    jdField_f_of_type_JavaLangString = vpl.a("StorySvc.video_show_video_list");
  }
  
  public vla(AppInterface paramAppInterface)
  {
  ...
  public List<QQStoryUserInfo> a(boolean paramBoolean)
  {
    ...
    {
      Bosses.get().postJob(new vlb(this, "QQStoryManager", paramBoolean));
      return localList;
  ...
  public void a()
  {
    ...
    b(bfyz.h(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()));
    this.jdField_a_of_type_Vtj = new vtj(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  }
