  ...
  extends Handler
{
  ...
  public awom(QQMusicPlayService paramQQMusicPlayService, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        do
        {
                    ...
                    do
                    {
                          ...
                          do
                          {
                            do
                            {
                              ...
                              do
                              {
                                ...
                                localawop = (awop)paramMessage.obj;
                              } while (localawop == null);
                              ...
                              for (paramMessage = "null";; paramMessage = QQMusicPlayService.b().a())
                              {
                                ...
                                {
                                  localawop.a.release();
                                  if (QQMusicPlayService.a() == localawop.a) {
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.b())) && ((QQMusicPlayService.f() == 2) || (QQMusicPlayService.f() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          awok.a(i, bhnv.b((Context)localObject));
                          return;
                        }
                      }
                      if (QQMusicPlayService.a().isPlaying())
                      {
                        ...
                        awok.b(QQMusicPlayService.b(), QQMusicPlayService.e());
                      }
          ...
          } while (!bhnv.g(((QQMusicPlayService)localObject).getApplicationContext()));
          if (QLog.isColorLevel()) {
