...
public class awom
  implements View.OnClickListener, awop
{
  ...
  public awom(boolean paramBoolean)
  {
    this.c = paramBoolean;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramCommTaskInfo.getAccount().equalsIgnoreCase(paramCard.uin))
        {
          ...
          azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A7D6", i, 0, "", "", "", "");
          return;
        }
        ...
        {
          i = k;
          azmj.b(null, "dc00898", "", paramCommTaskInfo, "qq_vip", "0X800A7DC", i, 0, "", "", "", "");
          return;
        }
      }
  ...
  public static boolean a(awmk paramawmk)
  {
    int i;
    if (paramawmk.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) {
      if (paramawmk.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox == 0)
      {
        i = 1;
        azmj.b(null, "dc00898", "", "", "0X800A7DB", "qq_vip", i, 0, "", "", "", "");
        if (paramawmk.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox != 0) {
          break label63;
        }
      }
    ...
    do
    {
      ...
      break;
      return false;
      bool1 = paramawmk.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_SUPERVIP);
      bool2 = paramawmk.jdField_a_of_type_ComTencentMobileqqDataCard.isVipOpen(EVIPSPEC.E_SP_BIGCLUB);
    } while ((paramawmk.jdField_a_of_type_ComTencentMobileqqDataCard.switch_musicbox == 0) && (!TextUtils.isEmpty(paramawmk.jdField_a_of_type_ComTencentMobileqqDataCard.songId)) && ((bool1) || (bool2)));
    return false;
  }
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    paramString = bhos.a(aore.a().jdField_b_of_type_JavaLangString, "uin", paramString);
  ...
  public View a(Context paramContext, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131561811, null);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    if (this.c)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131368247).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376960).setOnClickListener(this);
      this.jdField_a_of_type_ComTencentWidgetAlphaClickableImageView = ((AlphaClickableImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376960));
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376825).setVisibility(8);
    }
    for (;;)
    {
      a(2);
      this.jdField_a_of_type_Int = aekt.a(35.0F, paramContext.getResources());
      if (this.jdField_a_of_type_Awon == null) {
        this.jdField_a_of_type_Awon = ListenTogetherManager.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a();
      }
      this.jdField_a_of_type_Awon.a(this);
      return this.jdField_a_of_type_AndroidViewView;
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376825).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131368247).setVisibility(8);
    }
  }
  ...
  public void a()
  {
    ...
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377706)).setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    if ((this.d) && (!this.c)) {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376825).setVisibility(8);
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376825);
    localTextView.setCompoundDrawablePadding(bdkf.b(4.0F));
    if (paramInt == 1)
    {
      localTextView.setCompoundDrawablesWithIntrinsicBounds(2130849611, 0, 0, 0);
      return;
    }
    localTextView.setCompoundDrawablesWithIntrinsicBounds(2130849612, 0, 0, 0);
  }
  
  public void a(Context paramContext, String paramString)
  {
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    localIntent.putExtra("url", bhos.a(aore.a().jdField_a_of_type_JavaLangString, "uin", paramString));
    paramContext.startActivity(localIntent);
    int i = 2;
    if (a()) {
      if (!this.d) {}
    ...
    for (;;)
    {
      azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A7D7", i, 0, "", "", "", "");
      return;
      i = 1;
      continue;
      i = 3;
  ...
  {
    Object localObject = paramawmk.jdField_a_of_type_ComTencentMobileqqDataCard;
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      a(true);
      localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377706);
      if (paramawmk.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int != 0)
      {
        this.f = false;
        ((TextView)localObject).setText(ProfileCardMoreInfoView.a(paramawmk) + ((TextView)localObject).getContext().getResources().getString(2131695651));
      }
    ...
    for (;;)
    {
      a(this.jdField_a_of_type_ComTencentMobileqqMusicSongInfo, awon.a(Long.parseLong(this.jdField_a_of_type_JavaLangString)));
      break;
  ...
  public void a(SongInfo paramSongInfo, boolean paramBoolean)
  {
    ...
    if (this.c)
    {
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376824)).setText(paramSongInfo.c);
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376823)).setText(paramSongInfo.h);
      a(paramSongInfo.e);
      return;
    }
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376825)).setText(paramSongInfo.c + "-" + paramSongInfo.h);
  ...
  public void a(String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130844334);
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130844334);
    paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
    paramString.setTag(new int[] { this.jdField_a_of_type_Int / 2 });
    paramString.setDecodeHandler(bcuq.z);
    paramString.startDownload();
    this.jdField_a_of_type_AndroidViewView.findViewById(2131376960).setBackgroundDrawable(paramString);
    if (this.jdField_a_of_type_Boolean) {}
    for (;;)
    {
      a(i);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (!this.c)
    {
      ...
      if (paramBoolean)
      {
        if (this.e)
        {
          localTextView.setText(2131695571);
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131365753).setVisibility(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131376960).setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131370860).setVisibility(8);
      return;
    }
    this.jdField_a_of_type_AndroidViewView.findViewById(2131365753).setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131376960).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131370860).setVisibility(0);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.f)
    {
      azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A7D8", 0, 0, "", "", "", "");
    ...
    else
    {
      ...
      for (int i = 1;; i = 2)
      {
        azmj.b(null, "dc00898", "", str, "qq_vip", "0X800A7DD", i, 0, "", "", "", "");
        break;
      }
    }
    if (awon.a(Long.parseLong(this.jdField_a_of_type_JavaLangString)))
    {
      this.jdField_a_of_type_Awon.k();
      a(2);
      return;
    }
    this.jdField_a_of_type_Awon.a(Long.parseLong(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_ComTencentMobileqqMusicSongInfo);
  }
}
