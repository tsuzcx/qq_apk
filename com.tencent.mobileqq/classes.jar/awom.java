...
{
  public awom(Integer paramInteger)
  {
  ...
  protected int a(String paramString, Object paramObject)
  {
    ...
    else if ((paramObject instanceof rcs))
    {
      paramObject = ((rcs)paramObject).a();
      if (paramObject != null) {
        return rdc.a(paramObject);
      }
    }
  ...
  public Object a(String paramString, Object paramObject)
  {
    ...
    if ((paramObject instanceof rcs)) {
      localObject = ((rcs)paramObject).a();
    }
  ...
  {
    if ((paramObject1 instanceof rcs)) {
      ((rcs)paramObject1).a();
    }
  }
}
