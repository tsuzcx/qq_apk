...
public class auor
{
  ...
  private static String a(HttpURLConnection paramHttpURLConnection)
  {
    if (paramHttpURLConnection.getResponseCode() != 200) {
      throw new IOException(amtj.a(2131703701));
    }
  ...
  private static void a(DataOutputStream paramDataOutputStream, java.io.File paramFile)
  {
    ...
    //   23: getstatic 59	auor:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  private static String b(String paramString, Map<String, String> paramMap, java.io.File paramFile)
  {
    ...
    //   1: astore_3
    //   2: aload_0
    //   3: invokestatic 267	auor:a	(Ljava/lang/String;)Ljava/net/HttpURLConnection;
    //   6: astore_0
    ...
    //   19: aload_3
    //   20: aload_1
    //   21: invokestatic 276	auor:a	(Ljava/io/DataOutputStream;Ljava/util/Map;)V
    //   24: aload_3
    //   25: aload_2
    //   26: invokestatic 278	auor:a	(Ljava/io/DataOutputStream;Ljava/io/File;)V
    //   29: aload_3
    //   30: ldc 142
    //   32: invokevirtual 140	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   35: aload_3
    ...
    //   48: getstatic 59	auor:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   51: invokevirtual 116	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   54: ldc 135
    ...
    //   75: aload_0
    //   76: invokestatic 281	auor:a	(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    //   79: astore_1
    //   80: ldc 215
    //   82: aload_1
