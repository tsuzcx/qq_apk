  ...
  implements BusinessObserver
{
  ...
  public akbo(TroopMoreDetailView paramTroopMoreDetailView)
  {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localStringBuffer = new StringBuffer(((TroopMoreDetailView)localObject2).getResources().getString(2131433124));
    } while ((localView == null) || (((List)localObject1).size() < 4));
    localView.setVisibility(0);
    if (localObject2.a[4] != null) {
      localObject2.a[4].setBackgroundResource(2130838641);
    }
    localStringBuffer.append(",本群共").append(j).append("人");
    paramBundle = localView.findViewById(2131366546);
    int i = 0;
    ...
    for (;;)
    {
      ...
      Object localObject3 = (RoundProgressBar)paramBundle.findViewById(2131368509);
      ((RoundProgressBar)localObject3).setTextColor(localContext.getResources().getColor(2131494221));
      ...
      localObject3 = (TextView)paramBundle.findViewById(2131363397);
      ...
      continue;
      paramBundle = localView.findViewById(2131366547);
