  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public akie(CountryActivity paramCountryActivity, Context paramContext)
  {
    super(paramContext);
    requestWindowFeature(1);
    getWindow().setSoftInputMode(36);
    getWindow().setBackgroundDrawable(new ColorDrawable());
    setContentView(2131558992);
    ...
    this.jdField_a_of_type_Akid = new akid(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Akid);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Akid.a(paramString);
    if (this.jdField_a_of_type_Akid.getCount() == 0) {
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 205	acxo:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 205	acxo:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 205	acxo:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
