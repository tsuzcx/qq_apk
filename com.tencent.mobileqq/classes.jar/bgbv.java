  ...
  extends BaseAdapter
{
  ...
  public bgbv(ReciteDisplayView paramReciteDisplayView, Context paramContext, List<ParagraphInfo> paramList, int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView = paramReciteDisplayView;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.b = mvd.b(paramContext);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localbgbu = new bgbu();
      localbgbu.a = new PinyinTextView(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteUiReciteDisplayView, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
      paramView = localbgbu.a;
      paramView.setTag(localbgbu);
    }
    for (;;)
    {
      localbgbu = (bgbu)paramView.getTag();
      ParagraphInfo localParagraphInfo = (ParagraphInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      if (this.e == d) {
        if (paramInt == getCount() - 1) {
          localbgbu.a.setWordInfos(localParagraphInfo, this.g, true);
        }
      }
      for (;;)
      {
        ...
        return paramView;
        localbgbu.a.setWordInfos(localParagraphInfo, this.g, false);
        continue;
        localbgbu.a.setWordInfos(localParagraphInfo, this.g, false);
      }
    }
