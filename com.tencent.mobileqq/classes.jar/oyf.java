...
public class oyf
{
  ...
  public static void a()
  {
    ...
    {
      return;
      localObject = ((QQAppInterface)localObject).a().b(antf.aQ, 1008);
  ...
  private static void a(String paramString, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (int j = 0;; j = 1)
      {
        ...
        ocd.a(null, "CliOper", "", str3, paramString, paramString, 0, 0, str4, (String)localObject3, str1, paramMessageRecord.toString(), false);
        return;
        localObject1 = null;
        break;
        i = 0;
  ...
  private static Map<String, String> b()
  {
    ...
    localObject = ((QQMessageFacade)localObject).b(antf.aQ, 1008);
    if (localObject == null) {
      return localHashMap;
    }
  ...
  public static void b()
  {
    ...
    {
      a = localMap;
      QLog.d(oyf.class.getSimpleName(), 2, "update kandian subscribe red pnt info success ");
    }
  }
}
