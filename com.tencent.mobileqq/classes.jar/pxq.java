  ...
  implements rfp
{
  ...
  public pxq(ComponentHeaderTopicRecommend paramComponentHeaderTopicRecommend, String paramString, int paramInt)
  {
  ...
  {
    paramView = omj.k + bbco.encodeToString(this.jdField_a_of_type_JavaLangString.getBytes(), 0);
