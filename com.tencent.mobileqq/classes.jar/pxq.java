  ...
  extends pxz
{
  ...
  public pxq(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
  ...
  private ToServiceMsg a(long paramLong)
  {
    ...
    return qnf.a("OidbSvc.0xb57", 2903, 16, localReqBody.toByteArray());
  }
  ...
  public void a(long paramLong, pxr parampxr)
  {
    ...
    if ((localReadInJoyUserInfo != null) && (localReadInJoyUserInfo.isApproved != -1)) {
      if (parampxr != null) {
        parampxr.a(localReadInJoyUserInfo.isApproved);
      }
    }
    do
    {
      return;
      parampxr = a(paramLong);
    } while (parampxr == null);
    parampxr.addAttribute("KEY_USER_APPROVE_UIN", Long.valueOf(paramLong));
    a(parampxr);
  }
