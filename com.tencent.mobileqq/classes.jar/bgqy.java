...
public abstract class bgqy
{
  int jdField_a_of_type_Int;
  bgqv jdField_a_of_type_Bgqv;
  ...
  public bgqy(bgqv parambgqv, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new bgqz(this);
