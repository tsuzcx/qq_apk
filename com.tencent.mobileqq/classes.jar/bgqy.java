  ...
  implements bgqx
{
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    case 1: 
      ...
      apdc.a().b(paramBundle, (Bundle)localObject2);
      return true;
    case 2: 
      ...
      ((QQAppInterface)localObject1).a().a(new apcu(paramBundle));
    ...
    case 4: 
      ...
      paramBundle.putString("configInfo", apei.a(((QQAppInterface)localObject1).getApp().getBaseContext(), str));
      return true;
    }
