...
public class amky
  ...
  implements amlg
{
  private static volatile amky jdField_a_of_type_Amky;
  public static boolean a;
  private List<amla> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public static amky a()
  {
    if (jdField_a_of_type_Amky == null) {}
    try
    {
      if (jdField_a_of_type_Amky == null) {
        jdField_a_of_type_Amky = new amky();
      }
      return jdField_a_of_type_Amky;
    }
    finally {}
  }
  ...
  public static void a()
  {
    ...
    {
      QIPCClientHelper.getInstance().register(localamky);
  ...
  public Bundle a(String paramString, Bundle paramBundle)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = amkw.a().a(l2, l1);
      localObject = amkw.a().a((String)localObject);
      if (localObject == null) {
        break label243;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (bool) {
        QLog.d("DanmuDataIPCClient", 2, new Object[] { "peak listSize:", Integer.valueOf(((amkx)localObject).d.size()), ", fullList:", ((amkx)localObject).d.toString() });
      }
      paramBundle.putBoolean("key_barrage_is_update", bool);
      paramBundle.putLong("key_barrage_req_time", System.currentTimeMillis());
      QIPCClientHelper.getInstance().getClient().callServer("DanmuDataIPCServer", "qipc_action_get_barrage", paramBundle, new amkz(this));
  ...
  {
    if ((paramamla != null) && (!this.jdField_a_of_type_JavaUtilList.contains(paramamla))) {
      this.jdField_a_of_type_JavaUtilList.add(paramamla);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("key_barrage_req_time"))
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "DanmuPullCost", false, 0L, 0L, (HashMap)localObject1, null);
      if (QLog.isColorLevel()) {
    ...
    if ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty()))
    {
      ...
      j = 1;
      localObject3 = amkw.a().a(l2, l1);
      paramBundle = amkw.a().a((String)localObject3);
      if (paramBundle != null) {
        break label649;
      }
      paramBundle = amkw.a().b((String)localObject3);
    }
    label516:
    label649:
    for (;;)
    {
      if ((bool) && ((i != 0) || (j != 0)))
      {
        ...
        localObject2 = new amkv(l2, l1, k, true);
        paramBundle.a((List)localObject1).b((List)localObject3).a((amkv)localObject2).a(null).a();
      }
      if ((bool) && (paramBundle != null) && (!paramBundle.d.isEmpty()))
      {
        localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject1).hasNext()) {
          ((amla)((Iterator)localObject1).next()).a(l1, String.valueOf(l2), m, paramBundle.d);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  public void b(amla paramamla)
  {
    if ((paramamla != null) && (this.jdField_a_of_type_JavaUtilList.contains(paramamla))) {
      this.jdField_a_of_type_JavaUtilList.remove(paramamla);
    }
  }
    ...
    for (;;)
    {
      ...
      if ("qipc_action_send_barrage".equals(paramString))
      {
        ...
        while (localIterator.hasNext()) {
          ((amla)localIterator.next()).a(l, paramBundle, paramString);
        }
      }
    }
  }
