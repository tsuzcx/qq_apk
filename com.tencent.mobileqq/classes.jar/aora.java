  ...
  extends aopw
{
  ...
  {
    return apvb.a(paramWeiYunFileInfo.jdField_a_of_type_Long);
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        localObject2 = new aorb(this);
        localObject1 = paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560450, paramViewGroup, false);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131374866));
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.b);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnLongClickListener(this.jdField_a_of_type_AndroidViewView$OnLongClickListener);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject2);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView = ((CircleFileStateView)paramView.findViewById(2131361890));
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131366225));
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131366211));
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.b);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localObject2);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366223));
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetTextView.setGravity(48);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_AndroidWidgetTextView.setMaxLines(2);
        localObject1 = paramView;
        ((aorb)localObject2).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366209));
        localObject1 = paramView;
        ((aorb)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131368885));
        localObject1 = paramView;
        ((aorb)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncClipSize(actn.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        localObject1 = paramView;
      ...
      try
      {
        i = apue.a(localWeiYunFileInfo.c);
        apue.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localWeiYunFileInfo.h, i);
        ...
        if ((apue.a(localWeiYunFileInfo.c) == 0) && (bbdj.b(localWeiYunFileInfo.h))) {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692499);
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692475);
        localObject1 = apvu.b(localWeiYunFileInfo.b) + a((String)localObject2, (String)localObject1);
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(apeh.a(localWeiYunFileInfo));
      localObject1 = (LinearLayout.LayoutParams)paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
      ((LinearLayout.LayoutParams)localObject1).topMargin = actn.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      return paramView;
      localObject1 = paramView;
      paramViewGroup = (aorb)paramView.getTag();
      continue;
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView.setVisibility(0);
