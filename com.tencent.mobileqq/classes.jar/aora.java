  ...
  extends ReportDialog
{
  ...
  static
  {
    ...
    jdField_g_of_type_JavaLangString = anvx.a(2131706426);
    h = anvx.a(2131706420);
    i = anvx.a(2131706423);
  ...
  @TargetApi(14)
  public aora(Context paramContext)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString == null) {
      jdField_a_of_type_AndroidContentIntent = bhfb.a(paramQQAppInterface.getApp());
    }
    do
    {
      for (;;)
  ...
  private static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      if ((jdField_a_of_type_Bhyo.a() == 2) || (jdField_a_of_type_Bhyo.a() == 3))
      {
        QLog.d(jdField_a_of_type_JavaLangString, 1, "res download duplicated, " + str);
        return false;
      }
      QLog.d(jdField_a_of_type_JavaLangString, 1, "res download task status error, cancel it, status: " + jdField_a_of_type_Bhyo.a());
      jdField_a_of_type_Bhyo.a(true);
    }
    jdField_a_of_type_Bhyo = new bhyo(jdField_f_of_type_JavaLangString, localFile);
    jdField_a_of_type_Bhyo.n = true;
    paramQQAppInterface = ((bhyq)paramQQAppInterface.getManager(QQManagerFactory.DOWNLOADER_FACTORY)).a(1);
    QLog.d(jdField_a_of_type_JavaLangString, 1, "start download ");
    paramQQAppInterface.a(jdField_a_of_type_Bhyo, new aore(str), null);
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localButton.setText(anvx.a(2131706421));
      localButton.setOnClickListener(new aorb(this));
      localImageView.setOnClickListener(new aorc(this));
      localImageView.setOnTouchListener(new aord(this, localImageView));
      return;
    }
