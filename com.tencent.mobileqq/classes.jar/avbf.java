  ...
  implements Handler.Callback
{
  ...
  private avbg jdField_a_of_type_Avbg;
  ...
  public avbf(avbg paramavbg)
  {
    this.jdField_a_of_type_Avbg = paramavbg;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      return false;
      if ((paramMessage.obj != null) && (this.jdField_a_of_type_Avbg != null))
      {
        this.jdField_a_of_type_Avbg.a(paramMessage.obj);
        continue;
        if (paramMessage.obj != null) {
          l = ((Long)paramMessage.obj).longValue();
        }
        if (this.jdField_a_of_type_Avbg != null)
        {
          this.jdField_a_of_type_Avbg.a(l);
          continue;
          if (paramMessage.obj != null) {
            l = ((Long)paramMessage.obj).longValue();
          }
          if (this.jdField_a_of_type_Avbg != null) {
            this.jdField_a_of_type_Avbg.a(l, paramMessage.arg1, paramMessage.arg2);
          }
        }
      }
    }
