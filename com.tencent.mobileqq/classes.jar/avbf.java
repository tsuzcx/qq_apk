  ...
  extends Animation
{
  ...
  public avbf(View paramView, int paramInt1, int paramInt2, avbh paramavbh)
  {
  ...
  public void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener != null) && ((this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener instanceof avbg))) {
      ((avbg)this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener).a(this, paramFloat);
    }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Avbh != null) {
        this.jdField_a_of_type_Avbh.jdField_a_of_type_Int = i;
      }
