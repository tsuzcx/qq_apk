  ...
  extends MSFServlet
{
  public static NewIntent a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject = (bdeh)paramQQAppInterface.getManager(61);
    if (localObject != null) {}
    for (localObject = ((bdeh)localObject).a(paramString);; localObject = null)
    {
      if ((!TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), bdeg.class);
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool3)
    {
      try
      {
        ...
        bddy.a = ((cmd0xe34.RspBody)localObject2).ReqInterval.get();
      ...
      for (j = 1;; j = 0)
      {
        ...
        localObject3 = (bdeh)getAppRuntime().getManager(61);
        if (localObject3 != null)
        {
          ((bdeh)localObject3).a((SubAccountMessage)localObject2);
          ((bdeh)localObject3).b((SubAccountMessage)localObject2);
          ((bdeh)localObject3).c(((SubAccountMessage)localObject2).subUin);
        }
        localObject2 = new bdei();
        ((bdei)localObject2).b = paramFromServiceMsg.getUin();
        ((bdei)localObject2).jdField_c_of_type_JavaLangString = String.valueOf(l);
        ((bdei)localObject2).jdField_c_of_type_Boolean = true;
        ((bdei)localObject2).d = true;
        ((bdei)localObject2).a = 0;
  ...
  public void a(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
        ...
        if (i < ((ArrayList)localObject1).size())
        {
          ...
          try
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localArrayList.get(i))) {
              ((cmd0xe34.LoginSig)localObject2).bytes_sig.set(ByteStringMicro.copyFrom(bgva.a((String)localArrayList.get(i))));
            }
      ...
      paramPacket.putSendData(bguc.a(((oidb_sso.OIDBSSOPkg)localObject1).toByteArray()));
