  ...
  extends AdProxy.AbsBannerAdView
{
  ...
  acaq jdField_a_of_type_Acaq;
  acbl jdField_a_of_type_Acbl;
  ...
  private acbl a(Activity paramActivity, qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, String paramString, int paramInt1, int paramInt2, IMiniAppContext paramIMiniAppContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        acbk localacbk = new acbk();
        localacbk.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = AdProxyImpl.a(this.jdField_a_of_type_ComTencentQqminiProxyimplAdProxyImpl, paramActivity, paramAdInfo, paramIMiniAppContext, paramString);
        localacbk.jdField_a_of_type_Int = 0;
        localacbk.jdField_b_of_type_Int = paramInt1;
        localacbk.jdField_c_of_type_Int = paramInt2;
        this.jdField_a_of_type_ComTencentGdtadApiBannerGdtBannerAd = new GdtBannerAd(localacbk);
  ...
  private void a(Activity paramActivity)
  {
    if (this.jdField_a_of_type_Acaq == null) {
      this.jdField_a_of_type_Acaq = new bkmz(this, paramActivity);
    }
  }
  ...
  private void a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback == null) {
      this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback = new bknb(this);
    }
  ...
  public void destroy(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Acbl = null;
  ...
  public View getView()
  {
    if (this.jdField_a_of_type_Acbl != null) {
      return this.jdField_a_of_type_Acbl.a();
    }
    return null;
  }
  ...
  public void onExposure()
  {
    ...
    for (;;)
    {
      ...
      return;
      a(this.i);
      bkpa.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreIMiniAppContext, this.i, System.currentTimeMillis(), this.jdField_b_of_type_JavaLangString, 2);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Acbl != null) {
      this.jdField_a_of_type_Acbl.setSize(paramInt1, paramInt2);
    }
  }
}
