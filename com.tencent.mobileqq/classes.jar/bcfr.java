  ...
  implements Manager
{
  ...
  baaa jdField_a_of_type_Baaa = new bcfv(this);
  public bcgg a;
  public bcqi a;
  bcqt jdField_a_of_type_Bcqt = new bcfu(this);
  protected bcrf a;
  bcsl jdField_a_of_type_Bcsl;
  bdvu jdField_a_of_type_Bdvu = new bcfy(this);
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface = null;
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  public Comparator<bcgf> a;
  HashMap<String, Integer> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  String jdField_b_of_type_JavaLangString;
  HashMap<String, List<bcgf>> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  ...
  public bcfr(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_Int = 1;
    this.jdField_c_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_JavaUtilComparator = new bcfx(this);
  ...
  {
    int i = 0;
    Object localObject = (List)this.jdField_b_of_type_JavaUtilHashMap.get(parambcgf.getFriendUin());
    if (localObject == null)
    {
      localObject = new ArrayList();
      this.jdField_b_of_type_JavaUtilHashMap.put(parambcgf.getFriendUin(), localObject);
    }
    for (;;)
    {
      int j;
      try
      {
        ((List)localObject).add(parambcgf);
        int m = parambcgf.getLimitType();
        int k = -1;
        j = 0;
        if (i < ((List)localObject).size())
        {
          parambcgf = (bcgf)((List)localObject).get(i);
          if ((parambcgf == null) || (parambcgf.getLimitType() != m)) {
            break label158;
          }
          if (k == -1)
          {
  ...
  private void a(String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    ...
    {
      Object localObject = new File(bckh.a(paramString, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()));
      ...
      localObject = new bdvv(bckh.c(paramMessageForDeliverGiftTips), (File)localObject);
      ((bdvv)localObject).jdField_b_of_type_Int = 2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOAnimationControlManager", 2, "start Download PackageId:" + bckh.b(paramMessageForDeliverGiftTips));
      }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if (i < localList.size())
    {
      paramString1 = (bcgf)localList.get(i);
      if (!(paramString1 instanceof MessageForDeliverGiftTips)) {
        break label87;
      }
      paramString1 = bckh.b((MessageForDeliverGiftTips)paramString1);
    }
    for (;;)
    {
  ...
  public static boolean a(BaseChatPie paramBaseChatPie, QQAppInterface paramQQAppInterface, Object paramObject)
  {
    ...
    for (;;)
    {
      if (aizl.a(paramObject, paramQQAppInterface)) {
        paramBaseChatPie.o(false);
      }
      return false;
      label37:
      ...
      ((bcfr)paramQQAppInterface.getManager(223)).a(paramBaseChatPie);
    }
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramString2.equals(bckh.b((MessageForDeliverGiftTips)paramString1.get(i)))) {
  ...
  private void h()
  {
    Object localObject = new File(aljq.cu);
    ...
    {
      label111:
      if (bckh.a((String)localObject, i, bool))
      {
      ...
      for (;;)
      {
        ...
        bool = true;
        break label111;
        bdcs.a(arrayOfFile[j].getAbsolutePath());
      }
      return;
      label270:
      i = 0;
  ...
  public bdwa a()
  {
    return ((bdvx)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(47)).a(1);
  }
  
  public void a()
  {
    int i = 0;
    Object localObject = new File(bckh.a(0)).getParentFile();
    if (((File)localObject).exists())
    {
      ...
      if (i < localObject.length)
      {
        if (localObject[i].exists())
        {
          ...
          try
          {
            ...
            if (bckh.a(Integer.parseInt(str))) {
  ...
  public void a(Activity paramActivity)
  {
    if (this.jdField_a_of_type_Bcqi == null) {
      this.jdField_a_of_type_Bcqi = new bcqi(null, paramActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    this.jdField_a_of_type_Bcqi.a(4);
    this.jdField_a_of_type_AndroidAppActivity = this.jdField_a_of_type_Bcqi.a();
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != paramBaseChatPie)
    {
      ...
      this.jdField_a_of_type_Bcqi = paramBaseChatPie.a();
      if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof TroopChatPie)) {
        break label114;
      }
      this.jdField_a_of_type_Bcqi.a(1);
      this.jdField_a_of_type_Bcrf = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
      this.jdField_a_of_type_Bcsl = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
    }
    label114:
    do
    {
    ...
    } while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agoj));
    ...
    {
      this.jdField_a_of_type_Bcqi.a(8);
      return;
    }
    this.jdField_a_of_type_Bcqi.a(6);
  }
  ...
  {
    bcge.a().addObserver(paramObserver);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                } while ((!b()) && (bckh.a((List)localObject3)));
                if ((this.jdField_a_of_type_Bcrf == null) || (bckh.a((List)localObject3))) {
                  break label397;
                }
              } while ((this.jdField_a_of_type_Bcrf.b()) && (this.jdField_a_of_type_Bcrf.a()));
              this.jdField_a_of_type_Int = 2;
              localObject5 = (MessageForDeliverGiftTips)((List)localObject3).get(0);
              localObject6 = bckh.b((MessageForDeliverGiftTips)localObject5);
            ...
            ((bcju)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(((MessageForDeliverGiftTips)localObject5).frienduin, ((MessageForDeliverGiftTips)localObject5).interactId, ((MessageForDeliverGiftTips)localObject5).giftId, new bcfz(this, (MessageForDeliverGiftTips)localObject5, (List)localObject3, paramBoolean, (List)localObject4, (String)localObject6));
            return;
            ...
            return;
          } while ((this.jdField_a_of_type_Bcqi == null) || (bckh.a((List)localObject4)));
          this.jdField_a_of_type_Int = 2;
          localObject3 = (bcgf)((List)localObject4).get(0);
          ...
          {
            localObject3 = ((bcju)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a((String)localObject1, ((MessageForDeliverGiftTips)localObject5).bagId, new bcgb(this, (MessageForDeliverGiftTips)localObject5, (String)localObject1, paramBoolean));
          ...
          for (;;)
          {
            if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
              ((MessageForDeliverGiftTips)localObject5).senderName = bdbt.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, (String)localObject1, "" + ((MessageForDeliverGiftTips)localObject5).senderUin);
            }
            localObject6 = bckh.b((MessageForDeliverGiftTips)localObject5);
            if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() != 3)) {
              break label1241;
            }
            this.jdField_a_of_type_Bcqi.a(this.jdField_a_of_type_Baaa);
            if (QLog.isColorLevel()) {
              QLog.d("AIOAnimationControlManager", 2, "Playing! playMaigface id:" + bckh.b((MessageForDeliverGiftTips)localObject5));
            }
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a() == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a.a())) {
              break;
            }
        ...
        } while (this.jdField_a_of_type_Bcrf == null);
        this.jdField_a_of_type_Bcrf.a((MessageForDeliverGiftTips)localObject5, (String)localObject6, false, new bcgc(this, paramBoolean));
        return;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
        {
          localObject3 = "0";
          ...
          azmj.b((QQAppInterface)localObject4, "P_CliOper", "Grp_flower", "", "cartoon", "show", 0, 0, (String)localObject1, (String)localObject6, (String)localObject3, "" + mwu.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), (String)localObject1));
          if (QLog.isColorLevel())
          {
        ...
        this.jdField_a_of_type_Bcqi.a((MessageForDeliverGiftTips)localObject5);
        this.jdField_a_of_type_Bcqi.jdField_a_of_type_Bcqt = this.jdField_a_of_type_Bcqt;
        return;
        if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() == 4))
        {
        ...
        this.jdField_a_of_type_Int = 3;
        return;
        if ((localObject3 instanceof aizl))
        {
          localObject1 = (aizl)localObject3;
          this.jdField_a_of_type_Bcqi.a((aizl)localObject1);
          ((aizl)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new bcfs(this, paramBoolean));
          ((List)localObject4).remove(localObject3);
          return;
        }
      } while ((!(localObject3 instanceof MessageForTroopEffectPic)) || (this.jdField_a_of_type_Bcsl == null));
      ...
      if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject3)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject3)).intValue() != 3) || (!bckh.a(((MessageForTroopEffectPic)localObject5).effectId))) {
        break;
      }
      Object localObject1 = ((MessageForTroopEffectPic)localObject5).getPicDownloadInfo();
      ((aweu)localObject1).e = "chatimg";
      Object localObject6 = ((aweu)localObject1).c();
      ...
      for (;;)
      {
        ...
        try
        {
          if (localFile.exists())
          {
            ...
            localOptions.inSampleSize = ((int)bdda.a((InputStream)localObject1, 720, 1080));
            ((BufferedInputStream)localObject1).close();
            localObject6 = bdda.a((String)localObject6, localOptions);
            localObject1 = localObject3;
        ...
        this.jdField_a_of_type_Bcsl.a(((MessageForTroopEffectPic)localObject5).effectId, (Bitmap)localObject1, ((TroopChatPie)localObject3).s, new bcft(this, paramBoolean));
        ((List)localObject4).remove(localObject5);
        return;
        i = 90;
        continue;
    ...
    label1297:
    label1829:
    this.jdField_a_of_type_Bcsl.a((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, (MessageForTroopEffectPic)localObject5, false);
    return;
  ...
  public boolean a(bcgf parambcgf, boolean paramBoolean)
  {
    if (parambcgf == null) {
      return false;
    }
    if (((parambcgf instanceof MessageForDeliverGiftTips)) && (!bckh.a((MessageForDeliverGiftTips)parambcgf))) {
      return false;
    }
    a(parambcgf);
    if (paramBoolean)
  ...
  public boolean a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean)
  {
    ...
    while (!bckh.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    ...
    {
      return true;
      ((bcju)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.giftId, new bcfw(this, paramMessageForDeliverGiftTips, paramBoolean));
    }
  }
  ...
  public boolean a(MessageForTroopEffectPic paramMessageForTroopEffectPic, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!bckh.a(paramMessageForTroopEffectPic.effectId))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bdcs.d(bckh.a(paramMessageForTroopEffectPic.effectId));
  ...
  public long[] a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        bcgf localbcgf = (bcgf)((Iterator)localObject).next();
        if ((localbcgf instanceof MessageForDeliverGiftTips)) {
          paramString.add(Long.valueOf(((MessageForDeliverGiftTips)localbcgf).getId()));
        }
      }
    }
  ...
  public void b()
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;; localObject = this.jdField_b_of_type_JavaLangString)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) || (bckh.a((List)localObject))) {
        break label135;
      }
      int j;
      for (int i = 0; i < ((List)localObject).size(); i = j + 1)
      {
        bcgf localbcgf = (bcgf)((List)localObject).get(i);
        j = i;
        if (localbcgf.isReaded())
        {
          j = i;
          if (localbcgf.getSenderUin() != this.jdField_a_of_type_ComTencentCommonAppAppInterface.getLongAccountUin())
          {
  ...
  {
    bcge.a().deleteObserver(paramObserver);
  }
  ...
  {
    if (!bckh.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    String str = bckh.b(paramMessageForDeliverGiftTips);
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!bckh.a(str, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bdcs.a(bckh.a(paramMessageForDeliverGiftTips));
        a(str, paramMessageForDeliverGiftTips);
        i = 2;
        if (QLog.isColorLevel()) {
          QLog.d("AIOAnimationControlManager", 2, "giftRealAnimationId:" + bckh.b(paramMessageForDeliverGiftTips) + ",state:" + i);
        }
        if ((a()) && (i != 3)) {
          break label188;
        }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_Bcrf = null;
  }
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_Bcrf != null) && (!this.jdField_a_of_type_Bcrf.a())) {
