  ...
  extends SQLiteOpenHelper
{
  ...
  protected bcfr(Context paramContext)
  {
  ...
  public static bcfr a(Context paramContext)
  {
    try
    {
      if (jdField_a_of_type_Bcfr == null) {
        jdField_a_of_type_Bcfr = new bcfr(paramContext);
      }
      paramContext = jdField_a_of_type_Bcfr;
      return paramContext;
    }
    finally {}
  }
  ...
  {
    bcds.b("opensdk", "sql1:" + this.jdField_a_of_type_JavaLangString);
    bcds.b("opensdk", "sql2:" + this.b);
