...
public class aztr
{
  private static volatile aztr jdField_a_of_type_Aztr;
  IInspectorListener jdField_a_of_type_ComTencentQapmsdkBaseListenerIInspectorListener = new azto();
  IMemoryCellingListener jdField_a_of_type_ComTencentQapmsdkBaseListenerIMemoryCellingListener = new aztt();
  IMonitorListener jdField_a_of_type_ComTencentQapmsdkBaseListenerIMonitorListener = new aztu();
  public boolean a;
  ...
  public static aztr a()
  {
    ...
    {
      if (jdField_a_of_type_Aztr == null) {
        jdField_a_of_type_Aztr = new aztr();
      }
      ...
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if ((2 != BaseApplicationImpl.sProcessId) && (8 != BaseApplicationImpl.sProcessId))
          {
            ...
            Logger.INSTANCE.setLogProxy(new aztp(i));
            ReporterMachine.INSTANCE.setUploadProxy(new azts(this));
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      return;
      PluginCombination.leakPlugin.eventSampleRatio = abuz.a;
    }
  }
