...
{
  public auai(OCRResultActivity paramOCRResultActivity, EditText paramEditText) {}
  ...
  public boolean onActionItemClicked(ActionMode paramActionMode, MenuItem paramMenuItem)
  {
    if (paramMenuItem.getItemId() == 2131371005)
    {
      ...
      if (TextUtils.isEmpty(paramActionMode)) {
        bcpw.a(this.jdField_a_of_type_ComTencentMobileqqOcrOCRResultActivity, 1, ajyc.a(2131707817), 0).a();
      }
    }
    else
    {
