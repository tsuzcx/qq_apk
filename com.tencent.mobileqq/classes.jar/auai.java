  ...
  implements EngineChannel.Receiver
{
  ...
  public auai(Context paramContext)
  {
    super(paramContext);
  }
  ...
  private void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (this.b >= 2)
    {
      ...
      onTaskFailed(103, alpo.a(2131707188));
    }
    do
    {
      return;
  ...
  public void executeAsync()
  {
    ...
    {
      onTaskFailed(1, alpo.a(2131707183));
      return;
    }
  ...
  public void onReceiveData(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      {
        return;
        onTaskFailed(101, alpo.a(2131707185));
        return;
