  ...
  implements IEventReceiver
{
  ...
  private xeo jdField_a_of_type_Xeo;
  private boolean jdField_a_of_type_Boolean;
  private View jdField_b_of_type_AndroidViewView;
  private TextView jdField_b_of_type_AndroidWidgetTextView;
  private String jdField_b_of_type_JavaLangString;
  
  public xij(BaseActivity paramBaseActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Xeo = new xeo(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
  }
  ...
  private void d()
  {
    ...
    {
      snd.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "biz_src_jc_gxl", str);
      return;
    }
  }
  ...
  private void e()
  {
    snd.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "biz_src_jc_gxl", "weishi://camera?logsour=2020020030");
  }
  ...
  public void a()
  {
    ...
    if (!nao.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getApplication().getApplicationContext())) {
      return;
    }
    ...
    VSNetworkHelper.a().a(this.jdField_a_of_type_ComTencentBizVideostoryNetworkRequestGetMineWSPersonalRequest, new xin(this));
  }
  ...
  public void a(WEISHI.stGetPersonalPageRsp paramstGetPersonalPageRsp, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (j > 0) {
        if (!paramBoolean)
        {
          ...
          {
            i = 1;
            xhb.a("weishi_share_prof", "entry_exp", i, 0, new String[0]);
          }
        }
        else
        {
          ...
          if (this.jdField_b_of_type_AndroidWidgetTextView != null) {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(j + ajya.a(2131706777));
          }
        }
      }
      for (;;)
    ...
    this.jdField_a_of_type_Xeo.a(paramstGetPersonalPageRsp, this.jdField_a_of_type_Boolean);
  }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131370161));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131367679);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370162));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370163));
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)paramView.findViewById(2131379520));
    ...
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Xeo);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370402));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(new xik(this));
    this.jdField_a_of_type_Xeo.a(new xil(this));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      i = 1;
      xhb.a("weishi_share_prof", "entry_clk", i, 0, new String[0]);
      if (vzw.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity)) {
        break label112;
      }
      xhb.a("weishi_share_prof", "dl_clk", 0, 0, new String[0]);
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, ajya.a(2131706776), 0).a();
      if (!this.jdField_a_of_type_Boolean) {
        break label105;
      }
    }
    ...
    for (int i = 201;; i = 200)
    {
      ...
      skn.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localWSDownloadParams, false);
      return;
      i = 2;
      break;
    }
    ...
    {
      e();
      xhb.a("weishi_share_prof", "clk_ws", 1, 0, new String[0]);
      return;
    }
    d();
    xhb.a("weishi_share_prof", "clk_ws", 2, 0, new String[0]);
  }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130849182);
      return;
    }
    this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130844933);
  }
