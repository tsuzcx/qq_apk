...
public class psi
  extends psh
{
  public psi(Context paramContext, baxk parambaxk, rap paramrap)
  {
  ...
  public pqt a()
  {
    ...
    return a(this.jdField_a_of_type_Rap, this.jdField_a_of_type_Baxk).f().h().q().l().n().j();
  }
  ...
  public pqt d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null)
    {
      ...
      Object localObject = new LinearLayout.LayoutParams(-1, actn.a(79.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localRelativeLayout.setOnClickListener(new psj(this));
      localRelativeLayout.setDuplicateParentStateEnabled(true);
      localRelativeLayout.setOnTouchListener(new psk(this, localRelativeLayout));
      localLinearLayout2.setOnTouchListener(new psl(this, localRelativeLayout));
      olb.a(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842321));
      localLinearLayout2.addView(localRelativeLayout);
      localLinearLayout2.setDuplicateParentStateEnabled(true);
      localLinearLayout2.setOnTouchListener(new psm(this, localLinearLayout2));
      localLinearLayout1.setOnTouchListener(new psn(this, localLinearLayout2, localRelativeLayout));
    }
    ...
    localLinearLayout2.setOnClickListener(new pso(this));
