  ...
  extends ReportFragment
{
  ...
  private bmad jdField_a_of_type_Bmad;
  ...
  public static Fragment a(String paramString1, Boolean paramBoolean, String paramString2, String paramString3, SessionWrap paramSessionWrap, boolean paramBoolean1, String paramString4)
  {
    ...
    localblyk.setArguments(localBundle);
    return localblyk;
  }
  
  private void a()
  {
    this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131367582).setOnClickListener(new blyl(this));
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362664);
    this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131367583).setOnClickListener(new blym(this));
    this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379745).setOnClickListener(new blyn(this));
  }
  ...
  private void a(String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new blyq(this));
      return;
    }
  ...
  private void a(ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<String> paramArrayList3)
  {
    ...
    QIPCClientHelper.getInstance().callServer("CameraEmoIpcServer", "qipc_action_camera_emo_create_gif_and_upload", localBundle, new blyp(this));
  }
  
  private void a(boolean paramBoolean)
  {
    bmbx.b("AEGIFSinglePreviewFragment", "saveAndSend---onlySave=" + paramBoolean);
    e();
    this.jdField_a_of_type_Bmad = new bmad(this.jdField_a_of_type_JavaLangString);
    g();
    this.jdField_a_of_type_Bmad.a(new blyo(this, paramBoolean));
  }
  
  private void b()
  {
    a(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayView = ((VideoPlayView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131380455));
  ...
  private void c()
  {
    this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView = ((AEGIFOutlineTextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131372144));
    this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView.setVisibility(0);
    this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView.setOnClickListener(new blyr(this));
    this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView.setFontId(this.jdField_b_of_type_JavaLangString);
    RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131373924);
    localRelativeLayout.setVisibility(0);
    this.jdField_a_of_type_Blxg = new blxg((BaseVMPeakActivity)this.jdField_a_of_type_AndroidAppActivity, localRelativeLayout, this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView);
    this.jdField_a_of_type_Blxg.a();
  }
  
  private void d()
  {
    blys localblys = blys.a(null, false, this.jdField_b_of_type_JavaLangString);
    localblys.a(this.jdField_a_of_type_Blxg);
    getFragmentManager().beginTransaction().add(2131367134, localblys).addToBackStack(null).commit();
  }
  
  private void e()
  {
    if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
      bjne.a(new AEGIFSinglePreviewFragment.8(this));
    }
  }
  
  private void f()
  {
    bjne.a(new AEGIFSinglePreviewFragment.9(this));
  }
  
  private void g()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131373898);
    ...
    if (this.jdField_a_of_type_Blxg.a().indexOf('\n') > 0) {}
    ...
    {
      if (this.jdField_a_of_type_Blxg.a().length() > 0) {
        this.jdField_a_of_type_Bmad.a(this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView.a(), f2, f3, 1.0F, f1);
      }
      return;
    }
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    if (i < j)
    {
      ...
      {
        paramLayoutInflater = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131373898);
    ...
    for (paramViewGroup.topMargin = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidAppActivity, 58.799999F);; paramViewGroup.topMargin = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidAppActivity, 147.0F - f * 88.199997F))
    {
      ...
      bmbx.b("AEGIFSinglePreviewFragment", "receive materialId=" + this.jdField_c_of_type_JavaLangString + ", materialApplied=" + this.jdField_b_of_type_Boolean);
