...
public class nac
  extends mxl
{
  public nac(AppInterface paramAppInterface)
  {
  ...
  private String a()
  {
    return BaseApplicationImpl.getContext().getResources().getString(2131690244);
  }
  ...
  private void a(long paramLong1, long paramLong2, String paramString, AvGameNotify.NotifyActorGiveOutAnswerS2CReq paramNotifyActorGiveOutAnswerS2CReq, long paramLong3)
  {
    ...
    paramNotifyActorGiveOutAnswerS2CReq = myn.b((AvGameCommon.GameQuestionInfo)paramNotifyActorGiveOutAnswerS2CReq.question_info.get(), false);
    mxt.a().b(nal.class, 9, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, str, paramNotifyActorGiveOutAnswerS2CReq, Long.valueOf(paramLong3) });
  }
  ...
  {
    myp localmyp = myn.b((AvGameCommon.GameQuestionInfo)paramNotifyAnswerRightS2CReq.question_info.get(), false);
    ...
    mxt.a().b(nal.class, 7, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, Integer.valueOf(i), Integer.valueOf(j), localmyp, localPlayer, Long.valueOf(l), Long.valueOf(paramLong3) });
  }
  ...
  {
    myp localmyp = myn.b((AvGameCommon.GameQuestionInfo)paramNotifyChangeActorS2CReq.question_info.get(), false);
    paramNotifyChangeActorS2CReq = paramNotifyChangeActorS2CReq.actor_info;
    Player localPlayer = new Player();
    localPlayer.parseFrom(paramNotifyChangeActorS2CReq);
    mxt.a().b(nal.class, 4, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, localmyp, localPlayer, Long.valueOf(paramLong3) });
  }
  ...
  {
    myp localmyp = myn.b((AvGameCommon.GameQuestionInfo)paramNotifyChangeQuestionS2CReq.question_info.get(), false);
    ...
    try
    {
      ...
      mxt.a().b(nal.class, 5, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, localmyp, paramNotifyChangeQuestionS2CReq, Long.valueOf(paramLong3) });
      return;
    }
  ...
  {
    mxt.a().b(nal.class, 3, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, Long.valueOf(paramLong3) });
  }
  ...
  private void a(long paramLong1, long paramLong2, String paramString, AvGameNotify.NotifyNextActorTipsS2CReq paramNotifyNextActorTipsS2CReq, long paramLong3)
  {
    ...
    mxt.a().b(nal.class, 6, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, str, localPlayer, Long.valueOf(paramLong3) });
  }
  ...
  {
    paramNotifyQuestionTimeoutS2CReq = myn.b((AvGameCommon.GameQuestionInfo)paramNotifyQuestionTimeoutS2CReq.question_info.get(), false);
    mxt.a().b(nal.class, 8, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, paramNotifyQuestionTimeoutS2CReq, Long.valueOf(paramLong3) });
  }
  ...
  private void a(long paramLong1, long paramLong2, String paramString, AvGameNotify.NotifyTranslateInfoS2CReq paramNotifyTranslateInfoS2CReq, long paramLong3)
  {
    ...
    mxt.a().a(nal.class, 12, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, Long.valueOf(l), Integer.valueOf(i), str, paramNotifyTranslateInfoS2CReq, Long.valueOf(paramLong3) });
  }
  ...
  private void a(long paramLong1, long paramLong2, String paramString, AvGameNotify.RoomOwnerStartGameS2CReq paramRoomOwnerStartGameS2CReq, long paramLong3)
  {
    ...
    localObject2 = myn.b((AvGameCommon.GameQuestionInfo)localObject2, false);
    ...
    localObject1 = new mzi();
    ((mzi)localObject1).a(localGameInfo);
    if (paramRoomOwnerStartGameS2CReq.question_class.has()) {
      ((mzi)localObject1).a = paramRoomOwnerStartGameS2CReq.question_class.get();
    }
    mxt.a().b(nal.class, 2, true, new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), paramString, localObject1, localPlayer, localObject2, Long.valueOf(paramLong3) });
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   285: aload 16
    //   287: aastore
    //   288: invokestatic 353	myn:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   291: iload 4
    //   293: ifne +270 -> 563
    //   296: aload_0
    //   297: aload 13
    ...
    //   303: aload 15
    //   305: aload 16
    //   307: invokespecial 356	nac:a	(Ljava/lang/String;JILjava/lang/String;Ltrpc/qq_vgame/playgame/AvGamePlay$StartGameRsp;)Z
    //   310: istore 9
    //   312: iload 9
    //   314: istore 10
    //   316: iload 4
    ...
    //   332: ifeq +9 -> 341
    //   335: aload_0
    //   336: invokespecial 364	nac:a	()Ljava/lang/String;
    //   339: astore 11
    //   341: invokestatic 64	mxt:a	()Lmxt;
    //   344: ldc 66
    //   346: iconst_0
    //   347: iconst_0
    //   348: bipush 7
    ...
    //   395: aload_3
    //   396: aastore
    //   397: invokevirtual 77	mxt:b	(Ljava/lang/Class;IZLjava/lang/Object;)V
    //   400: iload 4
    //   402: istore 5
    //   404: iload 9
    //   406: istore 10
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte, String paramString, int paramInt)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        for (;;)
        {
          ...
          bool = false;
          continue;
          paramToServiceMsg = a(2131690348);
          continue;
          bool = false;
        }
      }
      myn.a("avgame_logic.GamePlayHandler", paramString, new String[] { "rsp" }, new MessageMicro[] { localCmdGetQuestionRsp });
      ...
      if (i == 0) {
        ...
        {
          bool = true;
          paramArrayOfByte = myn.b((AvGameCommon.GameQuestionInfo)localCmdGetQuestionRsp.question_info.get(), bool);
          l2 = localCmdGetQuestionRsp.seq.get();
          if (paramArrayOfByte == null) {
            break label496;
          }
          bool = true;
          mxt.a().b(nal.class, paramInt, true, new Object[] { Long.valueOf(l1), str, Long.valueOf(l2), paramArrayOfByte });
    ...
    for (;;)
    {
      if (!bool)
      {
        ...
        {
          if (i == 202) {
            paramToServiceMsg = a(2131690349);
          }
        }
        else {
          mxt.a().b(nal.class, paramInt, false, new Object[] { Long.valueOf(l1), str, paramToServiceMsg });
        }
      }
      else
      {
  ...
  private boolean a(String paramString1, long paramLong, int paramInt, String paramString2, AvGamePlay.StartGameRsp paramStartGameRsp)
  {
    ...
    localObject = new mzi();
    ((mzi)localObject).a(localGameInfo);
    ((mzi)localObject).a = paramString2;
    paramString2 = myn.b(localGameQuestionInfo, false);
    if (paramString2 == null)
    {
      QLog.d("avgame_logic.GamePlayHandler", 1, "onHandleStartGameReq topic=null return");
      return false;
    }
    mxt.a().b(nal.class, 0, true, new Object[] { paramString1, Long.valueOf(paramLong), Integer.valueOf(paramInt), Long.valueOf(l), str, localObject, paramStartGameRsp, paramString2 });
    return true;
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      myn.a("avgame_logic.GamePlayHandler", "handleGetRankingListReq", new String[] { "rsp" }, new MessageMicro[] { localGetRankingListRsp });
      if (i == 0)
      {
        bool = true;
        paramObject = myn.a(localGetRankingListRsp);
        mxt.a().b(nal.class, 10, true, new Object[] { str2, str1, paramObject });
      }
    }
    for (;;)
    {
      if (!bool)
      {
        ...
        mxt.a().b(nal.class, 10, false, new Object[] { str2, str1, paramObject });
      }
  ...
  public void a(AvGameNotify.NotifyMsg paramNotifyMsg)
  {
    ...
    QLog.d("avgame_logic.GamePlayHandler", 1, String.format("handleOnlinePush type=%d [%s] seq=%d roomId=%d gameId=%s", new Object[] { Integer.valueOf(i), myn.a(i), Long.valueOf(l1), Long.valueOf(l2), str }));
    switch (i)
    {
    default: 
      return;
    case 102: 
      ...
      myn.a("avgame_logic.GamePlayHandler", "NT_GAME_START", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    case 110: 
      paramNotifyMsg = (AvGameNotify.NotifyGameOverS2CReq)paramNotifyMsg.game_over_req.get();
      myn.a("avgame_logic.GamePlayHandler", "NT_GAME_OVER", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    case 105: 
      paramNotifyMsg = (AvGameNotify.NotifyChangeQuestionS2CReq)paramNotifyMsg.change_question_req.get();
      myn.a("avgame_logic.GamePlayHandler", "NT_TOPIC_CHANGE", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    case 106: 
      paramNotifyMsg = (AvGameNotify.NotifyNextActorTipsS2CReq)paramNotifyMsg.next_actor_tips_req.get();
      myn.a("avgame_logic.GamePlayHandler", "NT_NEXT_ACTOR_TIPS", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    case 107: 
      paramNotifyMsg = (AvGameNotify.NotifyChangeActorS2CReq)paramNotifyMsg.change_actor_req.get();
      myn.a("avgame_logic.GamePlayHandler", "NT_ACTOR_CHANGE", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    case 103: 
      paramNotifyMsg = (AvGameNotify.NotifyAnswerRightS2CReq)paramNotifyMsg.answer_right_req.get();
      myn.a("avgame_logic.GamePlayHandler", "NT_ANSWER_RIGHT", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    case 104: 
      paramNotifyMsg = (AvGameNotify.NotifyQuestionTimeoutS2CReq)paramNotifyMsg.question_timeout_req.get();
      myn.a("avgame_logic.GamePlayHandler", "NT_TOPIC_TIMEOUT", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    case 108: 
      paramNotifyMsg = (AvGameNotify.NotifyActorGiveOutAnswerS2CReq)paramNotifyMsg.actor_giveout_answer_req.get();
      myn.a("avgame_logic.GamePlayHandler", "NT_ACTOR_GIVEOUT_ANSWER", null, new MessageMicro[] { paramNotifyMsg });
      a(l1, l2, str, paramNotifyMsg, l3);
      return;
    }
    paramNotifyMsg = (AvGameNotify.NotifyTranslateInfoS2CReq)paramNotifyMsg.translate_info_req.get();
    myn.a("avgame_logic.GamePlayHandler", "NT_TRANSLATE_INFO", null, new MessageMicro[] { paramNotifyMsg });
    a(l1, l2, str, paramNotifyMsg, l3);
  }
