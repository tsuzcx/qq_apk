...
public class qjx
{
  ...
  private volatile qka jdField_a_of_type_Qka;
  private boolean jdField_a_of_type_Boolean;
  
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.video." + qjx.class.getSimpleName();
  }
  
  public qjx(Activity paramActivity, qjz paramqjz)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_AndroidViewOrientationEventListener = new qjy(this, paramActivity, new WeakReference(paramqjz));
  ...
  public void a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_Qka != null)
      {
        this.jdField_a_of_type_Qka.b();
        this.jdField_a_of_type_Qka = null;
      }
      return;
    }
  }
