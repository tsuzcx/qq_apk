...
public class awda
  extends akgo
{
  private awda(SignTextEditFragment paramSignTextEditFragment) {}
  ...
  protected void e(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      while (this.a.jdField_a_of_type_Aipo.a(paramObject, true))
      {
        this.a.jdField_a_of_type_Aipo.notifyDataSetChanged();
        return;
        SignTextEditFragment.a(this.a, 2);
        continue;
  ...
  protected void f(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      if (this.a.jdField_a_of_type_Aipo.a((List)localObject, false)) {
        this.a.jdField_a_of_type_Aipo.notifyDataSetChanged();
      }
