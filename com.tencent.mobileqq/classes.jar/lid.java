  ...
  extends lhy
{
  ...
  public lia a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_Lic != null) && (locallia != null) && (locallia.a != null))
    {
      boolean bool = lhw.a().b();
      if ((!a(locallia.a)) || (bool)) {
        this.jdField_a_of_type_Lic.c(0);
      }
    }
    return locallia;
  }
  ...
  public boolean a(long paramLong, PendantItem paramPendantItem)
  {
    ...
    if ((bool) && (paramPendantItem != null) && (!TextUtils.equals("0", paramPendantItem.getId())))
    {
      ...
      if (localObject != null) {
        ((lgz)localObject).a(3002, paramPendantItem.getId());
      }
    }
  ...
  protected boolean a(PendantItem paramPendantItem)
  {
    ...
    {
      lbd.h(this.jdField_a_of_type_JavaLangString, "isTemplateUsable:" + a() + "|");
      return false;
    }
    ...
    if (!bool)
    {
      localObject1 = lbh.b() + paramPendantItem.getName();
      ...
      if (localFile.exists())
      {
        ...
        lbd.f(this.jdField_a_of_type_JavaLangString, "isTemplateUsable :" + (String)localObject1 + "|" + (String)localObject2 + "|" + (l2 - l1));
