  ...
  extends azpz
{
  ...
  public int a()
  {
    ...
    if (this.jdField_g_of_type_JavaLangString != null)
    {
      ...
      azpw.b("PIC_TAG_ERROR", "PicUploadInfo.getProtocolType", "localPath == null");
    }
  ...
  public boolean a()
  {
    ...
    if (this.i)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.rawMd5)) || (!bhmi.b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.thumbPath)))
      {
    ...
    if (!bhmi.b(this.jdField_g_of_type_JavaLangString))
    {
    ...
    Object localObject = akwl.a(this.jdField_g_of_type_JavaLangString);
    if (localObject != null)
    {
      if (this.jdField_g_of_type_Int == 1)
      {
        localObject = ((akwl)localObject).a();
        if (localObject != null) {
  ...
  String b()
  {
    ...
    {
      azpw.b("PIC_TAG_ERROR", "PicUploadInfo.getUrlString", "protocol == null");
      return null;
    }
    if ("chatthumb".equals(this.jdField_e_of_type_JavaLangString)) {}
    for (;;)
    {
      URL localURL = beyq.a(this, i1, null);
      if (localURL == null) {
        break;
      }
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Azqs != null) && (this.jdField_a_of_type_Azqs.a);
  }
