...
public class azqt
{
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteVideoView == null) || (this.jdField_a_of_type_Aejb == null)) {}
    do
    {
      return;
      ...
      this.jdField_a_of_type_Aejb.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new TroopInteractGiftAnimationController.5(this));
  ...
  public void a(aejb paramaejb)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_Aejb.c.findViewById(2131298518));
  }
  
  public void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    if (this.jdField_a_of_type_Aejb != null) {
      ((azjq)this.jdField_a_of_type_Aejb.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(113)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.animationPackageId, new azrh(this, paramMessageForDeliverGiftTips));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aejb != null) {
      ((azjq)this.jdField_a_of_type_Aejb.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(113)).a(paramString1, paramString2, paramInt1, paramInt2, new azrg(this, paramInt2, paramString2, paramMessageForDeliverGiftTips, paramBoolean));
    }
    this.jdField_a_of_type_Int = 0;
  }
  
  public void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, String paramString, boolean paramBoolean, axbz paramaxbz)
  {
    if (this.jdField_a_of_type_Aejb == null) {
      return;
    }
    ...
    if (this.jdField_a_of_type_AndroidMediaSoundPool != null) {
      this.b = this.jdField_a_of_type_AndroidMediaSoundPool.load(azkd.a(paramString) + "sound.wav", 1);
    }
    ThreadManager.post(new TroopInteractGiftAnimationController.1(this, paramString, paramMessageForDeliverGiftTips, paramBoolean, paramaxbz, (azjq)this.jdField_a_of_type_Aejb.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(113)), 8, null, true);
  }
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_AndroidMediaSoundPool != null)
    {
      AudioManager localAudioManager = (AudioManager)this.jdField_a_of_type_Aejb.jdField_a_of_type_AndroidContentContext.getSystemService("audio");
