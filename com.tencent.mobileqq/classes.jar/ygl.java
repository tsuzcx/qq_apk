...
public class ygl
  implements View.OnClickListener, ygs, ygz
{
  ...
  private yey jdField_a_of_type_Yey;
  ...
  public ygl(Context paramContext, View paramView, yfw paramyfw, boolean paramBoolean, int paramInt, ygp paramygp)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem = paramyfw.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem;
  ...
  public static CommentEntry a(int paramInt)
  {
    ...
    localCommentEntry.content = (anzj.a(2131702030) + zps.a(paramInt) + anzj.a(2131702029));
  ...
  private CommentEntry a(String paramString)
  {
    ...
    localCommentEntry.authorUin = xiz.a().c();
    ...
    if (this.jdField_a_of_type_Ygq.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry != null)
    {
      localCommentEntry.replierUnionId = this.jdField_a_of_type_Ygq.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry.authorUnionId;
      localCommentEntry.replierName = this.jdField_a_of_type_Ygq.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry.authorName;
      localCommentEntry.replierRole = this.jdField_a_of_type_Ygq.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry.authorRole;
    }
    if (((Integer)((wta)wth.a(10)).b("qqstory_i_am_vip", Integer.valueOf(-1))).intValue() == 1) {
      localCommentEntry.authorRole = 2;
    }
    yuk.a("Q.qqstory.detail.DetailCommentHelper", "create comment entry: %s.", localCommentEntry.toString());
    return localCommentEntry;
  }
  ...
  public static CommentEntry a(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    yuk.a("Q.qqstory.detail.DetailCommentHelper", "create fake vote comment entry: %s.", localCommentEntry.toString());
    return localCommentEntry;
  }
  ...
  public static CommentEntry a(String paramString1, int paramInt, long paramLong, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    {
      yuk.e("Q.qqstory.detail.DetailCommentHelper", "createGamePKCommentEntry styles error. styles=%s", new Object[] { paramString6 });
    }
    return paramString1;
  }
  ...
  {
    boolean bool = true;
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnEditorActionListener(new ygm(this));
    if (this.jdField_a_of_type_Boolean) {
      if ((this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId)))
      {
        ...
        this.jdField_a_of_type_Yey = new yey(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId, "2_", 10000, bool);
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.addTextChangedListener(this.jdField_a_of_type_Yey);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnTouchListener(new ygn(this));
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnFocusChangeListener(new ygo(this));
      return;
      label136:
      bool = false;
      break;
      ...
      this.jdField_a_of_type_Yey.jdField_a_of_type_Boolean = bool;
    }
  }
  
  private void b(CommentEntry paramCommentEntry, int paramInt)
  {
    if (this.jdField_a_of_type_Ygq.a(paramCommentEntry))
    {
      this.jdField_a_of_type_Ygq.a(paramCommentEntry, paramInt);
      d(false);
    }
    a(2, new String[] { paramCommentEntry.authorName, paramCommentEntry.authorUnionId, String.valueOf(paramCommentEntry.authorUin) });
    this.jdField_a_of_type_Ygw.a(true);
    wrc.a().a = "4";
  }
  ...
  private void f()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365008);
    ...
    this.jdField_a_of_type_Ygw = new ygw(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidViewView, this);
    ...
    for (this.jdField_a_of_type_Ygv = new ygu(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem, this);; this.jdField_a_of_type_Ygv = new ygr(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem, this))
    {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Ygv.a())
    {
      wrc.a().a = "1";
      a(true);
    }
    int i = yup.b(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    ...
    {
      yup.a("home_page", "clk_reply", yup.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem), 0, new String[] { String.valueOf(i), yup.a(this.jdField_b_of_type_Int), this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId, str });
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Ygp.b(paramInt);
    paramInt = yup.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.getOwner().isMe()) {}
    for (String str = "1";; str = "2")
    {
      yup.a("play_video", "del_reply", paramInt, 0, new String[] { str, yup.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
      return;
    }
  }
  ...
  public void a(int paramInt, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(anzj.a(2131702027));
      ...
      continue;
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(anzj.a(2131702031));
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setEnabled(true);
      ...
      if ((paramVarArgs != null) && (paramVarArgs.length >= 3))
      {
        ...
        if (TextUtils.isEmpty(str2))
        {
          ...
          str1 = ygd.a(paramVarArgs[1], paramVarArgs[2], bool1, str1);
        }
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(anzj.a(2131702028) + str1 + "：");
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setEnabled(true);
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setFocusable(true);
        this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setFocusableInTouchMode(true);
      }
  ...
  {
    xiz.a(this.jdField_a_of_type_AndroidContentContext, paramCommentEntry);
    yup.a("play_video", "report_reply", yup.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem), 0, new String[] { "", yup.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
  }
  ...
  {
    if (this.jdField_a_of_type_Ygv.a(paramCommentEntry, paramInt1, paramInt2)) {
  ...
  {
    this.jdField_a_of_type_Ygw.a(paramBoolean);
  }
  
  public boolean a()
  {
    return this.jdField_a_of_type_Ygw.a();
  }
  ...
  public void b(CommentEntry paramCommentEntry)
  {
    ...
    this.jdField_a_of_type_Ygp.b(paramCommentEntry);
    paramCommentEntry = "";
    ...
    int i = yup.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.getOwner().isMe()) {}
    for (String str = "1";; str = "2")
    {
      yup.a("play_video", "retry_reply", i, 0, new String[] { str, yup.a(this.jdField_b_of_type_Int), paramCommentEntry, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
      return;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Ygv.b(paramCommentEntry, paramInt1, paramInt2)) {
      b(paramCommentEntry, paramInt1);
    }
  }
  ...
  {
    this.jdField_a_of_type_Ygp.c();
    if (!paramBoolean)
    {
      wrc.a().a = "2";
      this.jdField_a_of_type_Ygp.P_();
      return;
    }
    if (this.jdField_a_of_type_Ygq.jdField_a_of_type_Int != -1)
    {
      this.jdField_a_of_type_Ygp.g_(this.jdField_a_of_type_Ygq.jdField_a_of_type_Int);
      return;
    }
    this.jdField_a_of_type_Ygp.P_();
  }
  ...
  public boolean b()
  {
    yuk.c("Q.qqstory.detail.DetailCommentHelper", "on emoji button click.");
    wrc.a().a = "2";
    int i = yup.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem);
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.getOwner().isMe()) {}
    for (String str = "1";; str = "2")
    {
      yup.a("home_page", "switch_face", i, 0, new String[] { str, yup.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
  ...
  public void c(CommentEntry paramCommentEntry)
  {
    try
    {
      ...
      if (behh.a(paramCommentEntry))
      {
        paramCommentEntry = bcsa.b(paramCommentEntry);
        ...
        {
          yup.a("home_page", "copy_reply", i, 0, new String[] { paramCommentEntry, yup.a(this.jdField_b_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
          return;
        }
      }
    }
  ...
  public void c(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      ygq.a(this.jdField_a_of_type_Ygq);
      a(1, new String[0]);
    }
  }
  ...
  public void d()
  {
    if (!bhnv.d(this.jdField_a_of_type_AndroidContentContext)) {
      QQToast.a(BaseApplication.getContext(), 1, anzj.a(2131702032), 0).a();
    }
    String str;
    do
    {
    ...
    yuk.a("Q.qqstory.detail.DetailCommentHelper", "comment content is %s when click send button.", str);
    Object localObject = str;
    if (behh.a(str)) {
      localObject = bcsa.a(str);
    }
    localObject = a((String)localObject);
    this.jdField_a_of_type_Ygp.a((CommentEntry)localObject);
    d(true);
    c();
    ygq.a(this.jdField_a_of_type_Ygq);
    a(1, new String[0]);
