  ...
  extends LinearLayout
{
  ...
  public ygl(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    while (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131561643, null);
  ...
  public void a(ygb paramygb, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localURLImageView = (URLImageView)((View)localObject3).findViewById(2131370326);
      localTextView = (TextView)((View)localObject3).findViewById(2131370340);
      localObject2 = (ProgressBar)((View)localObject3).findViewById(2131370338);
      str = paramygb.b(paramInt2);
      localObject1 = paramygb.a(paramInt2);
      if (localObject1 != null) {
        break label137;
      }
      xvv.e("LocationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { paramygb.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      localObject3 = (Boolean)localURLImageView.getTag(2131378172);
      if ((localObject3 != null) && (((Boolean)localObject3).booleanValue()) && (((String)localObject1).equals(localURLImageView.getTag(2131378207))))
      {
      ...
      else
      {
        ...
        localObject2 = new ygm((String)localObject1, localURLImageView, (ProgressBar)localObject2);
        ...
        if (((URLDrawable)localObject1).getStatus() == 1) {
          ((ygm)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
        }
