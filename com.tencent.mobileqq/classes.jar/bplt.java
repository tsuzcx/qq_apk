...
public class bplt
  implements bpip<bpio>
{
  private final int jdField_a_of_type_Int = bppm.b(DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  private bplt(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(bpio parambpio, MotionEvent paramMotionEvent)
  {
    boolean bool = true;
    if ((parambpio instanceof bphm)) {
      localRect = new Rect();
    }
    for (Rect localRect = ((bphm)parambpio).a(localRect);; localRect = null)
    {
      if (bqcd.b()) {}
      for (float f1 = bqcd.e;; f1 = 0.0F)
      {
        float f2 = f1;
        if (bkqv.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext())) {
          f2 = f1 + bkqv.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext());
        }
        ...
        case 6: 
          do
          {
            ...
            if (DoodleLayout.d(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) {
              bpgz.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
            }
            ...
            parambpio = this.jdField_a_of_type_AndroidGraphicsRect;
            parambpio.top -= this.jdField_a_of_type_Int;
            parambpio = this.jdField_a_of_type_AndroidGraphicsRect;
            parambpio.bottom += this.jdField_a_of_type_Int;
        ...
        if ((this.jdField_a_of_type_AndroidGraphicsRect != null) && ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.e())))
        {
          ...
          {
            label710:
            if ((!DoodleLayout.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) || (DoodleLayout.c(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) || (!(parambpio instanceof bphk))) {
              break label1149;
            }
            parambpio = (bphk)parambpio;
            paramMotionEvent = parambpio.jdField_a_of_type_Bphq;
            if ((!parambpio.jdField_a_of_type_Bppo.a(paramMotionEvent, f1, f3, false)) || (parambpio.jdField_a_of_type_Boolean) || (!paramMotionEvent.b) || (paramMotionEvent.c)) {
              break label1149;
            }
        ...
        for (i = 1;; i = 0)
        {
          ...
          for (;;)
          {
            ...
            if (!(parambpio instanceof bpia)) {
              break;
            }
            paramMotionEvent = ((bpia)parambpio).a();
            ...
            for (;;)
            {
              ...
              else if ((parambpio instanceof bpia))
              {
                paramMotionEvent = ((bpia)parambpio).a();
                DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout, paramMotionEvent);
                this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setTrackerState(((bpia)parambpio).a(), 0);
                ((bpia)parambpio).c();
              }
            }
            DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout).a.a(Message.obtain(null, 17, 0, 0, new bpei(false, false, false, false, true)));
            break label854;
            bool = false;
          }
        }
