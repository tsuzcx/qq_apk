  ...
  implements bjqe
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bjlo(this, Looper.getMainLooper());
  private bjlh jdField_a_of_type_Bjlh;
  private bjlp jdField_a_of_type_Bjlp;
  
  bjln(bjlh parambjlh, bjlp parambjlp)
  {
    this.jdField_a_of_type_Bjlp = parambjlp;
  ...
  void a()
  {
    if ((bjlh.b()) && (this.jdField_a_of_type_Bjlp.a() != null)) {
      try
      {
        ...
        while (i < j)
        {
          ...
          this.jdField_a_of_type_Bjlh.a(str, this, 0);
          i += 1;
        }
        return;
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if ((jdField_a_of_type_Int < paramInt) && (this.jdField_a_of_type_Bjlh != null))
    {
