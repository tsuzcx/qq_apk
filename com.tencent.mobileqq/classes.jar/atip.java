  ...
  extends WebViewPlugin
{
  ...
  private void a(String paramString)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        atiq localatiq = new atiq(this, (String)localObject);
        i = anwc.a().a(localatiq);
        ...
        try
        {
          ...
          {
            anwh.a(this.jdField_a_of_type_AndroidAppActivity, str1, paramString, i);
            return;
          }
          if (TextUtils.isEmpty(str2)) {
            break label183;
          }
          bdiv.a(this.jdField_a_of_type_AndroidAppActivity, str2, null, paramString, i);
          return;
        }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if ((paramLong == 8L) && (paramString != null)) {
      try
      {
        if (((anwe)aoks.a().a(416)).a(paramString))
        {
