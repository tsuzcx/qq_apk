  ...
  extends AutoCompleteTextView
{
  ...
  public bcnv(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public bcnv(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public bcnv(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          if ((localObject2 instanceof PopupWindow)) {
            ((PopupWindow)localObject2).setAnimationStyle(2130772279);
          }
          ...
          try
          {
            ((ListView)localObject2).setPadding(actj.a(13.0F, getResources()), 0, actj.a(13.0F, getResources()), 0);
      ...
      if ((localThrowable.getChildAt(j) != null) && ((localThrowable.getChildAt(j) instanceof LoginPopupRightMaskView)))
      {
        ...
        if (i == 0)
        {
          ...
          FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(actj.a(20.0F, getResources()), -1);
        ...
        localObject4 = new FrameLayout.LayoutParams(-1, actj.a(14.0F, getResources()));
