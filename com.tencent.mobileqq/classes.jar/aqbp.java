  ...
  extends aqbc
{
  ...
  public aqbp(Intent paramIntent)
  {
    super(paramIntent);
    ...
    for (paramInt = paramBundle.wMemberNum;; paramInt = 0)
    {
      ...
      for (;;)
      {
        ...
        if (j == 3000)
        {
          ...
          paramBundle = (ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
          paramInt = i;
          if (paramBundle != null)
          {
            i = paramBundle.a(str);
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && ((localRecentUser.getType() != 1006) || (a(aqas.jdField_h_of_type_JavaLangInteger))) && (localRecentUser.getType() != 9501) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 7000)) {
        if ((localRecentUser.getType() == 0) && (!bbbd.a(localRecentUser.uin)) && (!bbbd.c(localRecentUser.uin)) && (!nbc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType())) && (a(jdField_b_of_type_JavaLangInteger)))
        {
          if ((localajxn != null) && (localajxn.b(localRecentUser.uin))) {
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    if (d())
    {
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerselectpage.list", 0, 0, "", "", "", "");
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerconfirmpage.show", 0, 0, "", "", "", "");
    }
    label280:
    label307:
    do
    {
      do
      {
        ...
        if ((this.jdField_c_of_type_Int == 1) && (this.jdField_d_of_type_Int == 2)) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.payerselectpage.list", 0, 0, "", "", "", "");
        }
      } while ((this.jdField_a_of_type_Bbgg != null) && (this.jdField_a_of_type_Bbgg.isShowing()));
      boolean bool;
      String str3;
      String str2;
      String str1;
      ...
      for (;;)
      {
        bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, str3, str1, ajyc.a(2131704740), ajyc.a(2131704738), new aqbq(this, paramInt, paramBundle), new aqbr(this)).show();
        return;
        bool = false;
        break;
        str1 = str2;
  ...
  protected void d()
  {
    String str = this.jdField_a_of_type_Bbgg.getEditString();
    ...
    do
    {
      ...
      {
        return;
        Object localObject = a(aqas.a.intValue(), this.jdField_a_of_type_AndroidOsBundle);
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "editsay.button", 0, 0, "", "", "", "");
    } while ((TextUtils.isEmpty(str)) || (str.equals(this.jdField_h_of_type_JavaLangString)));
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerconfirmpage.send", 0, 0, "", "", "", "");
  }
}
