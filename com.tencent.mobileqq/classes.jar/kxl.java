...
public class kxl
{
  ...
  {
    krx.c("MagicDataReport", "DOUBLE SCREEN DataReport onStateReport: |" + paramString + "|" + paramLong);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        krx.e("MagicDataReport", localException.getMessage());
        continue;
        paramInt = 3;
        continue;
        paramInt = 4;
  ...
  {
    krx.c("MagicDataReport", "reportClickEvent key = " + paramString2 + ", fromType = " + paramInt + ", value = " + paramString3 + ", mRoomId = " + c);
    awqx.b(null, paramString1, "", "", paramString2, paramString2, paramInt, 0, "", "", c, paramString3);
  }
  
  public static void b(int paramInt, String paramString)
  {
    krx.c("MagicDataReport", "WL_DEBUG reportChangeFace fromType = " + paramInt + ", id = " + paramString);
