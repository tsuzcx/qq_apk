  ...
  implements pca
{
  ...
  private nox jdField_a_of_type_Nox;
  
  public now(QQAppInterface paramQQAppInterface, String paramString, Context paramContext)
  {
    this(paramQQAppInterface, paramString, paramContext, null);
  }
  
  public now(QQAppInterface paramQQAppInterface, String paramString, Context paramContext, nox paramnox)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Nox = paramnox;
  ...
  public void a(int paramInt, PublicAccountInfo paramPublicAccountInfo)
  {
    ...
    while (this.jdField_a_of_type_Nox == null) {
      return;
    }
    this.jdField_a_of_type_Nox.a(false, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    if (paramBoolean)
    {
      ...
      paramInt = sgj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      ahpf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, paramInt);
      ...
      if (this.jdField_a_of_type_Nox != null) {
        this.jdField_a_of_type_Nox.a(true, paramString);
      }
      return;
    }
    a(-1, null);
