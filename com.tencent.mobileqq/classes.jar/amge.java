...
public class amge
{
  ...
  public static int a(int paramInt, String paramString)
  {
    ...
    paramString = new File(amip.g, paramInt + "/" + paramString + "/");
    ...
    for (;;)
    {
      ...
      int i = avlc.a(localObject.length);
      ...
      try
      {
        ...
        if (paramInt >= amip.jdField_a_of_type_Int) {
          if (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/action/" + amip.R)) {
            continue;
          }
        }
        for (;;)
        {
          return j;
          if ((!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + amip.x)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + amip.w)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + amip.y))) {
            break;
          }
          if (QLog.isColorLevel()) {
  ...
  public static int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((alnr)paramQQAppInterface.getManager(153)).a(paramString);
    if (paramString == null)
    {
      if (QLog.isColorLevel()) {
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append(amip.F);
      localStringBuilder.append("/");
      localStringBuilder.append(paramInt2);
      localStringBuilder.append("/dress");
      return localStringBuilder.toString();
  ...
  public static String a(String paramString)
  {
    ...
    int i = avlc.a(paramString.countTokens());
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (alnr.a(paramQQAppInterface, paramString) == 2) {
      return "3D";
    }
    return "2D";
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      localObject = ((amir)paramQQAppInterface.getManager(155)).a(paramSpriteTaskParam.f);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (i < j)
    {
      ...
      localObject = new File(amip.c + (String)localObject);
      if (!((File)localObject).exists())
      {
        QLog.d("ApolloActionHelper", 1, new Object[] { "[checkBasicActionExit] rsc file not exist:", ((File)localObject).toString() });
        amdp.a(paramQQAppInterface, paramQQAppInterface.getCurrentUin(), null, 0, null, -1, -1, true);
        return false;
      }
      i += 1;
    }
  ...
  public static boolean a(String paramString, int paramInt, int[] paramArrayOfInt, QQAppInterface paramQQAppInterface, amdy paramamdy)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (!bool)
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            paramamdy = ((alnr)paramQQAppInterface.getManager(153)).a();
          }
        }
        for (;;)
        {
          amdp.a(paramQQAppInterface, paramString, paramamdy, paramInt, paramArrayOfInt, -1, -1, false);
          if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString1, QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, String paramString2)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((alnr)paramQQAppInterface.getManager(153)).b(paramString1);
  ...
  public static Object[] a(String paramString, int paramInt, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject = ((alnr)paramQQAppInterface.getManager(153)).b(paramString);
    if (localObject != null)
    {
      localObject = ((ApolloBaseInfo)localObject).getApolloDress3D();
      if (localObject != null)
      {
        paramInt = ((alsg)localObject).jdField_a_of_type_Int;
        localObject = ((alsg)localObject).a();
        if ((paramInt > amip.jdField_a_of_type_Int) && (localObject != null) && (localObject.length > 0) && ((!paramBoolean) || (a(paramString, paramInt, (int[])localObject, paramQQAppInterface))))
        {
          if (QLog.isColorLevel()) {
  ...
  public static Object[] a(String paramString, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localObject2 = ((alnr)paramQQAppInterface.getManager(153)).b(paramString);
      ...
      if (alnr.a((ApolloBaseInfo)localObject2)) {
        break label301;
      }
      return new Object[] { Integer.valueOf(i), localObject1 };
      if (amav.b(paramQQAppInterface, paramString))
      {
        localObject1 = "-2";
        break;
      }
    ...
    if ((paramBoolean) && (((ApolloBaseInfo)localObject2).apolloLocalTS != ((ApolloBaseInfo)localObject2).apolloServerTS))
    {
      ...
      alnr.a(paramQQAppInterface, paramString, "getRoleDressIdByUin");
    }
    ...
    for (int j = 1;; j = 0)
    {
      if (j == 0)
      {
        localObject2 = amdp.a(localObject3[0].jdField_a_of_type_Int);
        ...
        if (QLog.isColorLevel())
        {
          ...
          for (;;)
          {
            if (i < paramQQAppInterface.length)
            {
              ...
              j += 1;
              break;
              ambc.a(110, new Object[] { "basicDresses is not vaild" });
  ...
  public static String[] a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      ...
      default: 
        ...
        if ((paramBoolean) || (paramInt2 < 21)) {
          if (localStringBuilder.indexOf(amip.u) > -1) {
            localStringBuilder.append("/action");
          }
        }
        break;
    ...
    for (;;)
    {
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(amip.u);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      ...
      break label177;
      if (paramInt4 != 0) {
        localStringBuilder.append(amip.u).append(amip.G);
      }
      for (;;)
      {
        paramInt3 = 1;
        paramInt4 = 1;
        break;
        localStringBuilder.append("def/basic/").append(amip.G);
      }
      localStringBuilder.append(amip.u).append(amip.G);
      paramInt3 = 1;
      paramInt4 = 1;
      break label177;
      int i = a(paramInt3, amip.G);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(amip.G);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(amip.u).append(amip.I);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(amip.I);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      if (paramInt4 != 0)
      {
        localStringBuilder.append(amip.u).append(amip.K);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(amip.K);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      i = a(paramInt3, amip.H);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(amip.H);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
  ...
  public static String b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((alnr)paramQQAppInterface.getManager(153)).b(paramString);
    if (paramString != null)
    {
