  ...
  implements agpe
{
  ...
  public aoaq(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Int = actn.a(207.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (TextUtils.isEmpty(paramView.a)))
    {
      ...
      localURLImageView.setImageDrawable(aywk.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    ...
    for (;;)
    {
      ...
      if (((File)localObject).exists())
      {
        ...
        paramViewGroup.mLoadingDrawable = aywk.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
