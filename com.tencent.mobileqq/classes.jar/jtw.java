...
{
  public jtw(ConferenceFlyTicketActivity paramConferenceFlyTicketActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.a.jdField_a_of_type_Jtx = new jtx(this.a);
        ...
        this.a.jdField_a_of_type_Jtx.execute(new ArrayList[] { paramString1 });
      }
      return;
    }
