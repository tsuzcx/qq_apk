  ...
  implements Handler.Callback, axrs, axrt, Manager
{
  ...
  private becj jdField_a_of_type_Becj;
  private beco jdField_a_of_type_Beco;
  ...
  public beck(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Becj = new becj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private String a(beco parambeco)
  {
    parambeco = a() + parambeco.jdField_a_of_type_Long + File.separator;
    File localFile = new File(parambeco);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return parambeco;
  ...
  private void a(axsq paramaxsq)
  {
    ...
    do
    {
      ...
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download error=%d", new Object[] { Integer.valueOf(paramaxsq.jdField_a_of_type_Int) }));
      return;
      localbecl = (becl)paramaxsq.jdField_a_of_type_Axsp.a();
    } while (localbecl == null);
    if (paramaxsq.jdField_a_of_type_Int == 0) {}
    while (!bool)
    {
      try
      {
        if (localbecl.jdField_d_of_type_Int >= 3) {
          break label146;
        }
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] retried to download, retry=%d, result=%b, url=%s", new Object[] { Integer.valueOf(localbecl.jdField_d_of_type_Int), Boolean.valueOf(bool), localbecl.jdField_c_of_type_JavaLangString }));
        }
        a(localbecl);
        return;
      }
      ...
      continue;
      label146:
      File localFile = new File(paramaxsq.jdField_a_of_type_Axsp.jdField_c_of_type_JavaLangString);
      if (localFile.exists()) {
        localFile.delete();
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(localbecl.jdField_d_of_type_JavaLangString.toLowerCase());
    a(bool, paramaxsq.jdField_a_of_type_Axsp);
  }
  
  private void a(beco parambeco)
  {
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update complete: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      parambeco.a();
      if (b())
      {
        this.jdField_a_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambeco.jdField_b_of_type_Long) });
        this.jdField_b_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) });
      }
      a("0X80078B4", 0, "", "");
    }
  }
  ...
  private void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (this.jdField_a_of_type_Beco != null)
    {
      paramInt = (int)this.jdField_a_of_type_Beco.jdField_b_of_type_Long;
      if (this.jdField_a_of_type_Beco == null) {
        break label188;
      }
    }
    label188:
    for (paramString2 = String.format("%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Beco.jdField_a_of_type_Long) });; paramString2 = "")
    {
      if (QLog.isColorLevel()) {
      ...
      localbdzp.a(paramString1).a(paramString1).a(paramString3).a(paramString2).a(this.jdField_a_of_type_Int);
      bdzm.a(localbdzp.toString(), 105, paramInt);
      return;
      paramInt = 0;
      break;
    }
  ...
  private void a(boolean paramBoolean, axsp paramaxsp)
  {
    if ((!paramBoolean) || (paramaxsp == null))
    {
      a(3);
      return;
    }
    File localFile = new File(paramaxsp.jdField_c_of_type_JavaLangString);
    becl localbecl = (becl)paramaxsp.a();
    if ((!localFile.exists()) || (localbecl == null))
    {
      a(3);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download complete: %s, %s", new Object[] { paramaxsp.jdField_c_of_type_JavaLangString, localbecl.jdField_c_of_type_JavaLangString }));
    }
    switch (localbecl.jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      localFile = new File(b());
      new File(paramaxsp.jdField_c_of_type_JavaLangString).renameTo(localFile);
      a("0X80078AC", localbecl.jdField_c_of_type_Int, "", "");
      if (this.jdField_a_of_type_Becj.a(localFile.toString()))
      {
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("last_update_config_version", localbecl.jdField_c_of_type_Int).commit();
        if (this.jdField_a_of_type_Becj.a().isEmpty())
        {
          if (QLog.isColorLevel()) {
      ...
      a("0X80078AC", localbecl.jdField_c_of_type_Int, localbecl.jdField_b_of_type_JavaLangString, localbecl.jdField_c_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    a("0X80078AE", localbecl.jdField_c_of_type_Int, "", "");
    d(7);
  }
  
  private boolean a()
  {
    Object localObject = this.jdField_a_of_type_Becj.a();
    int i = 0;
    if (i < ((List)localObject).size()) {
      if (((beco)((List)localObject).get(i)).a()) {}
    }
  ...
  private boolean a(becl parambecl)
  {
    if (parambecl == null) {}
    do
    {
      return false;
      if ((parambecl.jdField_a_of_type_Int == 2) && (parambecl.e != 1) && (!NetworkUtils.isWifiConnected(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication())))
      {
        if (QLog.isColorLevel()) {
    ...
    } while ((parambecl.jdField_d_of_type_Int < 3) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.contains(parambecl.jdField_d_of_type_JavaLangString.toLowerCase())));
    ...
    localaxro.jdField_a_of_type_JavaLangString = parambecl.jdField_c_of_type_JavaLangString;
    localaxro.jdField_a_of_type_Int = 0;
    localaxro.jdField_c_of_type_JavaLangString = (parambecl.jdField_a_of_type_JavaLangString + parambecl.jdField_b_of_type_JavaLangString);
    parambecl.jdField_d_of_type_Int += 1;
    parambecl.jdField_a_of_type_Long = new Date().getTime();
    localaxro.a(parambecl);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(parambecl.jdField_d_of_type_JavaLangString.toLowerCase(), localaxro);
    localaxrr.a(localaxro);
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] begin http download %s", new Object[] { parambecl.jdField_c_of_type_JavaLangString }));
    }
    return true;
  }
  
  private boolean a(beco parambeco)
  {
    boolean bool;
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] rollback: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      if (parambeco.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        if (!QLog.isColorLevel()) {
          break label355;
        }
    ...
    for (;;)
    {
      ...
      return bool;
      String str = b(parambeco);
      long l2 = 0L;
      int i = 0;
      while (i < parambeco.jdField_b_of_type_JavaUtilList.size())
      {
        Object localObject = (becn)parambeco.jdField_b_of_type_JavaUtilList.get(i);
        File localFile1 = new File(((becn)localObject).f);
        File localFile2 = new File(((becn)localObject).g);
        long l1 = l2;
        ...
        l2 = l1;
        if (((becn)localObject).jdField_a_of_type_Int == 2)
        {
          l2 = l1;
        ...
        localObject = new File(str, ((becn)localObject).jdField_c_of_type_JavaLangString);
        l1 = l2;
      ...
      if (l2 == parambeco.jdField_b_of_type_JavaUtilList.size())
      {
        bool = true;
      }
      else
  ...
  private String b(beco parambeco)
  {
    parambeco = a(parambeco) + "bak" + File.separator;
    File localFile = new File(parambeco);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  private void b(beco parambeco)
  {
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] cleanup: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      bace.a(a(parambeco), false);
    }
  }
  ...
  private boolean b(beco parambeco)
  {
    return true;
  }
  
  private String c(beco parambeco)
  {
    return a(parambeco) + parambeco.jdField_a_of_type_JavaLangString;
  }
  ...
  private void c()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_Boolean = false;
      a("0X80078B5", 0, "", "");
      this.jdField_a_of_type_Beco = null;
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Beco = null;
    List localList = this.jdField_a_of_type_Becj.a();
    int i = 0;
    label150:
    boolean bool;
    if (i < localList.size())
    {
      beco localbeco = (beco)localList.get(i);
      if (localbeco.a()) {}
      for (;;)
      {
        i += 1;
        break;
        if ((localbeco.jdField_b_of_type_Boolean) && (localbeco.jdField_a_of_type_Boolean) && (localbeco.jdField_c_of_type_Boolean)) {
          break label150;
        }
        if (QLog.isColorLevel()) {
          QLog.w("QQProtect.QPUpdate", 2, String.format("[SFU] not matched section: sid=%d, os: %b, qq:%b, cpu:%b", new Object[] { Long.valueOf(localbeco.jdField_a_of_type_Long), Boolean.valueOf(localbeco.jdField_b_of_type_Boolean), Boolean.valueOf(localbeco.jdField_a_of_type_Boolean), Boolean.valueOf(localbeco.jdField_c_of_type_Boolean) }));
        }
        localbeco.a();
      }
      this.jdField_a_of_type_Beco = localbeco;
      c(0);
      if (QLog.isColorLevel())
      {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] next update: sid=%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Beco.jdField_a_of_type_Long) }));
        bool = true;
      }
    }
    for (;;)
  ...
  private boolean c(beco parambeco)
  {
    String str;
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify package: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      str = bech.a(c(parambeco));
      if (str == null) {
        return false;
      }
    }
    for (boolean bool = str.equalsIgnoreCase(parambeco.jdField_b_of_type_JavaLangString);; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  private void d(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        d();
        return;
        if ((c()) && (this.jdField_a_of_type_Beco != null))
        {
          if (!i(this.jdField_a_of_type_Beco))
          {
            d(15);
            return;
          }
        ...
        d(16);
        return;
      } while ((this.jdField_a_of_type_Beco != null) && (h(this.jdField_a_of_type_Beco)));
      a(3);
      return;
    case 7: 
      if ((this.jdField_a_of_type_Beco != null) && (c(this.jdField_a_of_type_Beco)))
      {
        d(8);
        return;
      }
      ...
      return;
    case 8: 
      if ((this.jdField_a_of_type_Beco != null) && (g(this.jdField_a_of_type_Beco)))
      {
        d(9);
        return;
      }
      ...
      return;
    case 9: 
      if ((this.jdField_a_of_type_Beco != null) && (e(this.jdField_a_of_type_Beco)))
      {
        d(10);
        return;
      }
      ...
      return;
    case 10: 
      if ((this.jdField_a_of_type_Beco != null) && (f(this.jdField_a_of_type_Beco)))
      {
        d(11);
        return;
      }
      ...
      return;
    case 11: 
      if ((this.jdField_a_of_type_Beco != null) && (d(this.jdField_a_of_type_Beco)))
      {
        d(12);
        return;
      }
      ...
      return;
    case 12: 
      if ((this.jdField_a_of_type_Beco != null) && (b(this.jdField_a_of_type_Beco)))
      {
        a(0);
        return;
      }
      ...
      return;
    case 13: 
      if ((this.jdField_a_of_type_Beco != null) && (a(this.jdField_a_of_type_Beco)))
      {
        a(0);
        return;
      }
    ...
    case 14: 
      if (this.jdField_a_of_type_Beco != null) {
        b(this.jdField_a_of_type_Beco);
      }
      d(15);
      return;
    case 15: 
      a(this.jdField_a_of_type_Beco);
      this.jdField_a_of_type_Beco = null;
      if (a())
      {
        d(16);
  ...
  private boolean d(beco parambeco)
  {
    boolean bool;
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      if (parambeco.jdField_c_of_type_JavaUtilList.isEmpty())
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] no diff: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
        }
        bool = true;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < parambeco.jdField_c_of_type_JavaUtilList.size())
        {
          becn localbecn = (becn)parambeco.jdField_c_of_type_JavaUtilList.get(i);
          if (TextUtils.isEmpty(localbecn.g)) {}
          for (String str = localbecn.f;; str = localbecn.g)
          {
            str = bech.a(str);
            if ((str != null) && (str.equalsIgnoreCase(localbecn.jdField_b_of_type_JavaLangString))) {
              break label246;
            }
            if (!QLog.isColorLevel()) {
              break label253;
            }
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] not matched: %s!=%s, sid=%d", new Object[] { str, localbecn.jdField_b_of_type_JavaLangString, Long.valueOf(parambeco.jdField_a_of_type_Long) }));
            bool = false;
            break;
          }
          label246:
  ...
  private boolean e(beco parambeco)
  {
    boolean bool;
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      if (parambeco.f == 0L)
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (parambeco.f > 0L)
      {
        String str1 = b(parambeco);
        long l1 = 0L;
        int i = 0;
        while (i < parambeco.jdField_c_of_type_JavaUtilList.size())
        {
          becn localbecn = (becn)parambeco.jdField_c_of_type_JavaUtilList.get(i);
          long l2 = l1;
          if (1 == localbecn.jdField_a_of_type_Int)
          {
            String str2 = str1 + localbecn.jdField_c_of_type_JavaLangString;
            a(new File(localbecn.f), new File(str2));
            l2 = l1 + 1L;
          }
          i += 1;
          l1 = l2;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup %d files of %d", new Object[] { Long.valueOf(l1), Integer.valueOf(parambeco.jdField_c_of_type_JavaUtilList.size()) }));
        }
        if (parambeco.f == l1) {
          bool = true;
        } else {
  ...
  private boolean f(beco parambeco)
  {
    boolean bool1;
    if ((parambeco != null) && (!parambeco.jdField_c_of_type_JavaUtilList.isEmpty()))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] do update files: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      String str = a(parambeco);
      int i = 0;
      if (i < parambeco.jdField_c_of_type_JavaUtilList.size())
      {
        becn localbecn = (becn)parambeco.jdField_c_of_type_JavaUtilList.get(i);
        File localFile1 = new File(str, localbecn.jdField_b_of_type_JavaLangString);
        Object localObject = new File(localbecn.f);
        ...
        for (;;)
        {
          ...
          if (!bool2)
          {
            localObject = localbecn.f + ".1";
            File localFile2 = new File((String)localObject);
            localbecn.jdField_a_of_type_Int = 3;
            localbecn.g = ((String)localObject);
            bool2 = a(localFile1, localFile2);
            if (QLog.isColorLevel()) {
              QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] copied failed, renamed to: %s", new Object[] { localbecn.g }));
            }
            bool1 = bool2;
            if (bool2)
            {
              this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(localbecn.f, localbecn.g).commit();
              bool1 = bool2;
            }
          }
          if (!bool1) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] success copied: %s", new Object[] { localbecn.f }));
          }
          parambeco.jdField_b_of_type_JavaUtilList.add(localbecn);
          parambeco.g += 1L;
        }
        label376:
        a("0X80078B2", (int)localbecn.jdField_b_of_type_Long, localbecn.jdField_a_of_type_JavaLangString, localbecn.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] failed copied: %s", new Object[] { localbecn.f }));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update %d files of %d", new Object[] { Long.valueOf(parambeco.g), Integer.valueOf(parambeco.jdField_c_of_type_JavaUtilList.size()) }));
      }
      if (parambeco.g == parambeco.jdField_c_of_type_JavaUtilList.size()) {
        bool1 = true;
      }
    }
    for (;;)
  ...
  private boolean g(beco parambeco)
  {
    boolean bool;
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] unzip package: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      String str = a(parambeco);
      File localFile = new File(str);
      if (!localFile.exists()) {
  ...
  private boolean h(beco parambeco)
  {
    boolean bool = false;
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] download package: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      bool = a(new becl(2, 0, a(parambeco), parambeco.jdField_a_of_type_JavaLangString, parambeco.jdField_c_of_type_JavaLangString, parambeco.jdField_b_of_type_JavaLangString, 0, true, 0, new Date().getTime(), parambeco.jdField_b_of_type_Int));
    }
    return bool;
  }
  
  private boolean i(beco parambeco)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (parambeco != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] get different: sid=%d", new Object[] { Long.valueOf(parambeco.jdField_a_of_type_Long) }));
      }
      List localList = parambeco.jdField_a_of_type_JavaUtilList;
      int i = 0;
      if (i < localList.size())
      {
        becn localbecn = (becn)localList.get(i);
        if (!new File(localbecn.f).exists())
        {
          localbecn.jdField_a_of_type_Int = 2;
          parambeco.jdField_c_of_type_JavaUtilList.add(localbecn);
        }
        String str;
        do
        {
          i += 1;
          break;
          str = bech.a(localbecn.f);
        } while ((str != null) && (str.equalsIgnoreCase(localbecn.jdField_b_of_type_JavaLangString)));
        localbecn.jdField_a_of_type_Int = 1;
        if (str != null) {}
        for (;;)
        {
          localbecn.jdField_c_of_type_JavaLangString = str;
          parambeco.jdField_c_of_type_JavaUtilList.add(localbecn);
          parambeco.f += 1L;
          break;
          str = "";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] need to update %d files of %d", new Object[] { Integer.valueOf(parambeco.jdField_c_of_type_JavaUtilList.size()), Integer.valueOf(parambeco.jdField_a_of_type_JavaUtilList.size()) }));
      }
      bool1 = bool2;
      if (!parambeco.jdField_c_of_type_JavaUtilList.isEmpty()) {
        bool1 = true;
      ...
      try
      {
        ...
        if (localUpdateQueryResponse != null)
        {
          ...
          if ((i1 == 0) && (k == 1))
          {
            ...
            bool1 = a(new becl(1, k, a(), "qp_sfu_config.dat", paramFromServiceMsg, paramToServiceMsg, m, bool1, 0, new Date().getTime(), 1));
          }
        }
        else
        {
        ...
        if (i1 == 1)
        {
          ...
          bool1 = bool2;
          if (!this.jdField_a_of_type_Becj.a(paramToServiceMsg.toString())) {
            continue;
          }
          if (this.jdField_a_of_type_Becj.a().isEmpty()) {
            d(16);
  ...
  {
    if (this.jdField_a_of_type_AndroidOsHandler != null) {
      this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052688, paramaxsq).sendToTarget();
    }
  }
  
  public void onUpdateProgeress(axsp paramaxsp, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052689, (int)paramLong1, (int)paramLong2, paramaxsp).sendToTarget();
  }
}
