...
public class bhfe
{
  private static bhfe jdField_a_of_type_Bhfe;
  private MediaPlayer jdField_a_of_type_AndroidMediaMediaPlayer;
  
  public static bhfe a()
  {
    if (jdField_a_of_type_Bhfe == null) {
      jdField_a_of_type_Bhfe = new bhfe();
    }
    return jdField_a_of_type_Bhfe;
  }
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnonnull +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   18: invokevirtual 23	android/media/MediaPlayer:stop	()V
    //   21: aload_0
    //   22: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   25: invokevirtual 26	android/media/MediaPlayer:reset	()V
    //   28: aload_0
    //   29: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   32: invokevirtual 29	android/media/MediaPlayer:release	()V
    //   35: aload_0
    //   36: aconst_null
    //   37: putfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   40: goto -29 -> 11
    //   43: astore_1
    //   44: aload_0
    //   45: monitorexit
  ...
  public boolean a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnonnull +7 -> 17
    //   13: aload_0
    ...
    //   16: ireturn
    //   17: aload_0
    //   18: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
  ...
  /* Error */
  public boolean a(Context paramContext, java.lang.String paramString, amdp paramamdp)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 5
    ...
    //   4: monitorenter
    //   5: aload_0
    //   6: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   9: ifnonnull +63 -> 72
    //   12: aload_0
    //   13: new 20	android/media/MediaPlayer
    //   16: dup
    //   17: invokespecial 31	android/media/MediaPlayer:<init>	()V
    //   20: putfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   23: aload_0
    //   24: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   27: iconst_3
    ...
    //   71: ireturn
    //   72: aload_0
    //   73: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   100: astore_1
    //   101: aload_0
    //   102: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   105: aload_2
    ...
    //   113: astore_1
    //   114: aload_0
    //   115: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   118: aload_3
    //   119: invokevirtual 94	android/media/MediaPlayer:setOnPreparedListener	(Landroid/media/MediaPlayer$OnPreparedListener;)V
    //   122: aload_2
    //   123: astore_1
    //   124: aload_0
    //   125: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   163: astore_1
    //   164: aload_3
    //   165: invokevirtual 104	amdp:a	()V
    //   168: iload 5
    //   170: istore 4
    //   172: aload_2
    //   173: ifnull -106 -> 67
    ...
    //   207: astore_1
    //   208: aload_3
    //   209: invokevirtual 104	amdp:a	()V
    //   212: iload 5
    //   214: istore 4
    //   216: aload_2
    //   217: ifnull -150 -> 67
    ...
    //   251: astore_1
    //   252: aload_3
    //   253: invokevirtual 104	amdp:a	()V
    //   256: iload 5
    //   258: istore 4
    //   260: aload_2
    //   261: ifnull -194 -> 67
    ...
    //   295: astore_1
    //   296: aload_3
    //   297: invokevirtual 104	amdp:a	()V
    //   300: iload 5
    //   302: istore 4
    //   304: aload_2
    //   305: ifnull -238 -> 67
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    //   18: ireturn
    //   19: aload_0
    //   20: getfield 18	bhfe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   23: iload_1
