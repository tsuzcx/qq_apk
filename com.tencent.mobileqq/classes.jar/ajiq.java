  ...
  implements View.OnClickListener
{
  ...
  public boolean a;
  protected ArrayList<ajhd> b;
  protected boolean b;
  private boolean c;
  private boolean d;
  
  public ajiq(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (bmqo.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        break label134;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool)
        {
          accz.a(null, "Usr_NewDevice_Click", i, 0, 0);
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          try
          {
            ...
            bmqo.a().a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), localIntent2, str1, 0, null, SmartDevicePluginProxyActivity.class);
            accz.a(null, "Usr_NewDevice_Click", i, 0, 0);
          }
  ...
  private void a(View paramView, Friends paramFriends)
  {
    ...
    paramFriends = localabqn.a(paramFriends.signature, paramFriends.iTermType);
    localabqn.a((Activity)this.jdField_a_of_type_AndroidContentContext, paramFriends, false);
    ...
    if (paramFriends == null)
    {
      ...
      i = 1;
      accz.a(null, l, "Usr_LiteApp_Open", i, 0, paramFriends.productId);
      l = paramFriends.din;
    ...
    for (int i = 1;; i = 2)
    {
      accz.a(null, l, "Usr_LiteApp_Open_Online", i, 0, paramFriends.productId);
      return;
      i = 2;
      break;
    }
  ...
  {
    antz localantz = (antz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10);
    int i;
    if (paramString.equals(anhk.z)) {
      i = localantz.a();
    }
    for (;;)
    {
  ...
  private void f()
  {
    ...
    localFriends.uin = anhk.z;
    localFriends.remark = anni.a(2131693904);
    localFriends.name = anni.a(2131693904);
    if (a(anhk.z))
    {
      i = 10;
      localFriends.status = ((byte)i);
      localFriends.groupid = 1001;
      localArrayList.add(ajhc.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      ...
      if ((a(anhk.A)) || (this.c))
      {
        ...
        localFriends.uin = anhk.A;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131693380);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131693380);
        if (!a(anhk.A)) {
          break label523;
        }
        i = 10;
        ...
        if (!this.d)
        {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005D18", "0X8005D18", 0, 0, "", "", "", "");
          this.d = true;
      ...
      if (((anrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a())
      {
        localFriends = new Friends();
        localFriends.uin = anhk.B;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691213);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691213);
        if (!a(anhk.A)) {
          break label528;
        }
      }
    ...
    for (int i = 10;; i = 0)
    {
      ...
      {
        localFriends = new Friends();
        localFriends.uin = anhk.y;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691211);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691211);
  ...
  public int a()
  {
    ...
    while (i < getCount())
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof ajio)))
      {
        localObject1 = (Friends)((ajio)localObject1).a;
        Object localObject2 = (abqn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
        if (localObject2 != null)
        {
          localObject2 = ((abqn)localObject2).b();
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    {
      Friends localFriends = (Friends)((ajhd)((Iterator)localObject).next()).a;
      if (((localFriends.uin.equals(anhk.z)) || (localFriends.uin.equals(anhk.B))) && ((paramString.equals(anhk.z)) || (paramString.equals(anhk.B))))
      {
        if (paramBoolean)
        {
          j = 10;
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localFriends.remark = acda.a(localDeviceInfo);
        ...
        localArrayList1.add(ajhc.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        this.jdField_a_of_type_Int += 1;
        break;
        i = 0;
        break label170;
        ...
        {
          localObject = localabqn.a(localDeviceInfo.productId);
      ...
      label479:
      localArrayList2.add(ajhc.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      break;
  ...
  public void d()
  {
    ...
    if (i < localArrayList.size()) {
      if (!((Friends)((ajhd)localArrayList.get(i)).a).uin.equals(anhk.B)) {}
    }
    for (;;)
    {
      if (((anrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a()) {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      int i = 0;
      if (i < localArrayList.size()) {
        if (!((Friends)((ajhd)localArrayList.get(i)).a).uin.equals(anhk.A)) {}
      }
      for (;;)
      {
        if (i != -1) {
        ...
        for (i = 1;; i = 0)
        {
          ...
          ((antz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10)).d(1);
          return;
          i += 1;
          break;
          i = 0;
  ...
  public Object getItem(int paramInt)
  {
    ...
    return (ajhd)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  {
    View localView = ((ajhd)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, null);
    if (localView != null)
    {
      a((ajhg)localView.getTag(), null);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localajhg != null)
    {
      ...
      if ((localajhg.a instanceof Friends)) {
        localObject = (Friends)localajhg.a;
      }
    }
    if (localObject == null) {}
    for (;;)
    {
      ...
      return;
      if (anhk.y.equals(((Friends)localObject).uin)) {
        if (QLog.isColorLevel()) {
      ...
      try
      {
        ((baif)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).b("100701.100702");
        label118:
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          if (aoqb.a(localBaseActivity)) {
            break label262;
          }
          localBaseActivity.requestPermissions(new ajir(this, paramView, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
        }
        for (;;)
        {
          if (!anhk.z.equals(((Friends)localObject).uin)) {
            break label278;
          }
          localObject = new Intent(this.jdField_a_of_type_AndroidContentContext, LiteActivity.class);
          ((Intent)localObject).putExtra("targetUin", anhk.z);
          this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800603C", "0X800603C", 0, 0, "", "", "", "");
          break;
          label262:
          a(paramView);
          continue;
        ...
        label278:
        if (anhk.A.equals(((Friends)localObject).uin))
        {
          localObject = new Intent(this.jdField_a_of_type_AndroidContentContext, LiteActivity.class);
          ((Intent)localObject).putExtra("targetUin", anhk.A);
          this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006041", "0X8006041", 0, 0, "", "", "", "");
          continue;
        }
        if (anhk.B.equals(((Friends)localObject).uin))
        {
          localObject = new Intent(this.jdField_a_of_type_AndroidContentContext, PrinterActivity.class);
          this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
          continue;
        }
        if ((!anhk.aa.equals(((Friends)localObject).uin)) || (!this.jdField_a_of_type_Boolean)) {
          continue;
        }
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          if (!aoqb.a(localBaseActivity))
          {
            localBaseActivity.requestPermissions(new ajis(this, paramView, (Friends)localObject, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
            continue;
          }
