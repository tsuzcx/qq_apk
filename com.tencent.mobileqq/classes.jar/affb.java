...
{
  public affb(ClassificationSearchActivity paramClassificationSearchActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.a.f == ClassificationSearchActivity.jdField_a_of_type_Int) && (!TextUtils.isEmpty(paramView.trim())))
    {
      ...
      noo.a(null, "dc00899", "Pb_account_lifeservice", "", "0X80067C4", "0X80067C4", 0, 0, "", "", paramView, "", true);
      return;
    }
    if (this.a.f == ClassificationSearchActivity.d)
    {
      noo.a(null, "", "0X800742D", "0X800742D", 0, 0, paramView, "", "", "");
      ClassificationSearchActivity.a(this.a, paramView);
      return;
    }
