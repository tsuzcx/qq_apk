...
public class wmp
{
  ...
  public static wmq a(JSONObject paramJSONObject)
  {
    int i = 0;
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramJSONObject.length())
        {
          ...
          wmr localwmr = new wmr();
          localwmr.jdField_a_of_type_JavaLangString = localJSONObject.optString("img");
          localwmr.jdField_b_of_type_JavaLangString = localJSONObject.optString("jumpUrl");
          if ((TextUtils.isEmpty(localwmr.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localwmr.jdField_b_of_type_JavaLangString))) {
            break label215;
          }
          localArrayList.add(localwmr);
        }
      }
      ...
      for (;;)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          paramJSONObject = ajjy.a(2131639477);
        }
        ...
        {
          localObject = new wmq();
          ((wmq)localObject).jdField_a_of_type_JavaLangString = paramJSONObject;
          ((wmq)localObject).jdField_a_of_type_JavaUtilList = localArrayList;
          return localObject;
        }
      }
      label215:
  ...
  public static wmr a(JSONObject paramJSONObject)
  {
    try
    {
  ...
  public static wms a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      {
        wms localwms = new wms();
        localwms.jdField_a_of_type_JavaLangString = str;
        localwms.jdField_b_of_type_JavaLangString = paramJSONObject;
        return localwms;
      }
    }
    catch (Exception paramJSONObject)
  ...
  public static void a(com.tencent.mobileqq.app.QQAppInterface paramQQAppInterface, com.tencent.mobileqq.config.struct.splashproto.ConfigurationService.Config paramConfig)
  {
    ...
    //   4: astore 5
    //   6: aload 5
    //   8: invokestatic 172	wmp:a	(Ljava/lang/String;)I
    //   11: istore 4
    //   13: aload_1
    ...
    //   217: invokestatic 241	atiu:a	([B)[B
    //   220: astore_0
    //   221: aload_0
    //   222: ifnull +291 -> 513
    ...
    //   298: ldc_w 264
    //   301: aload_0
    //   302: invokestatic 267	wmp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   305: aload_1
    //   306: ldc_w 269
    ...
    //   335: ldc_w 273
    //   338: aload_0
    //   339: invokestatic 267	wmp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   342: aload_1
    //   343: ldc_w 275
    ...
    //   363: invokestatic 267	wmp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   366: aload 5
    //   368: iload_3
    //   369: invokestatic 279	wmp:a	(Ljava/lang/String;I)V
    //   372: return
    //   373: astore_0
    //   374: ldc 110
    //   376: iconst_1
    ...
    //   437: ldc_w 273
    //   440: ldc_w 262
    //   443: invokestatic 267	wmp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   446: goto -104 -> 342
    //   449: astore_0
    //   450: ldc 110
    //   452: iconst_1
    ...
    //   491: ldc_w 275
    //   494: ldc_w 262
    //   497: invokestatic 267	wmp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   500: goto -134 -> 366
    //   503: ldc 110
    //   505: iconst_1
    //   506: ldc_w 296
