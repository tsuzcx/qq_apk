  ...
  extends actq
{
  ...
  public advk(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new advl(this);
  }
  ...
  {
    if (seq.a(paramString1, paramContext)) {
      return;
    }
    ...
    paramString1.putExtra("big_brother_source_key", sgj.b(paramString4));
    sgj.a(paramString1, paramString3);
    paramContext.startActivity(paramString1);
    axqw.b(null, "P_CliOper", "Pb_account_lifeservice", paramString4, "aio_msg_url", "aio_url_clickqq", 0, 1, 0, paramString3, "", "", "");
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, long paramLong, String paramString2)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (bdiw.a(paramString1)))
    {
      awzj localawzj = new awzj();
      if (awzj.a(paramString2) == 0) {}
      Bundle localBundle;
      int j;
      for (;;)
      {
        localBundle = awzj.a(paramString2);
        j = localBundle.getInt("a_launch_mode", 268435456);
        if (i == 0) {
          break;
        }
        localawzj.a(paramQQAppInterface, paramContext, String.valueOf(paramLong), paramString2, paramString1, j);
        return true;
        i = 1;
      }
      return bdiw.a(paramContext, paramString1, localBundle, j);
    }
    return false;
  }
  ...
  protected View a(MessageRecord paramMessageRecord, actr paramactr, View paramView, LinearLayout paramLinearLayout, acxn paramacxn)
  {
    ...
    if (((PAMessage)localObject6).grayTips != null)
    {
      ...
      paramactr.jdField_c_of_type_JavaLangString = ((PAMessage.Item)localObject5).url;
      paramactr.jdField_b_of_type_JavaLangString = ((PAMessage.Item)localObject5).actionUrl;
      paramactr.jdField_a_of_type_JavaLangString = ((PAMessage.Item)localObject5).nativeJumpString;
      paramactr.jdField_c_of_type_Int = ((PAMessage)localObject6).type;
      paramactr.jdField_b_of_type_Int = 5;
      paramactr.jdField_a_of_type_JavaLangObject = Long.valueOf(paramView.uniseq);
      paramactr.d = ((PAMessage)localObject6).moreText;
      paramactr.jdField_a_of_type_Long = ((PAMessage.Item)localObject5).appId;
      paramactr.e = ((PAMessage.Item)localObject5).actionData;
      paramactr.f = ((PAMessage.Item)localObject5).a_actionData;
      paramactr.g = ((PAMessage.Item)localObject5).i_actionData;
      if (TextUtils.isEmpty(((PAMessage)localObject6).moreText)) {
        break label817;
      }
      ((TextView)localObject4).setText(((PAMessage)localObject6).moreText);
      localObject4 = nax.c(((PAMessage.Item)localObject5).title);
      ((TextView)localObject2).setText((CharSequence)localObject4);
      if (((PAMessage.Item)localObject5).mVideoFlag == 1)
      {
        localObject7 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842137);
        i = bawz.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
        ((Drawable)localObject7).setBounds(i, 0, bawz.a(this.jdField_a_of_type_AndroidContentContext, 17.0F) + i, bawz.a(this.jdField_a_of_type_AndroidContentContext, 20.0F));
      ...
      ((TextView)localObject3).setText(bbkb.a(this.jdField_a_of_type_AndroidContentContext, l * 1000L));
    ...
    for (;;)
    {
      try
      {
        localObject2 = sfd.a(((PAMessage.Item)localObject5).cover, 0);
        ...
        int k = actn.a(150.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ...
        if (paramMessageRecord != null)
        {
          ...
          if (j < localArrayList.size())
          {
            ...
            if (i > j)
            {
              ...
              break;
              label817:
              ((TextView)localObject4).setText(2131694945);
              break label392;
              label828:
      ...
      catch (Exception paramMessageRecord)
      {
        ...
        continue;
        localView.setTag(paramactr);
        localView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        localView.setOnTouchListener(paramacxn);
        localView.setOnLongClickListener(paramacxn);
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56) != null) && (((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)) && (paramView.mPAMessage.items != null) && (paramView.mPAMessage.items.size() > 0)) {
          xhe.a(paramView.frienduin, "auth_aio", "exp", 0, 0, new String[] { "", "1", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, localObject4 });
        }
