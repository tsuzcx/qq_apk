  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceUnBindRst"))
    {
      ...
      if (paramContext.getInt("deviceoprstcode", 0) == 0) {
        this.a.app.getMessageFacade().clearHistory(Long.valueOf(l1).toString(), 9501);
      }
    }
    label1146:
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                    ...
                    for (;;)
                    {
                      ...
                      if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StartVideoChat"))
                      {
                        ...
                        for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                        {
                          ...
                          abkw.a(this.a).add(paramContext);
                          return;
                        }
                      }
                      int i;
                      if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceAdminUnbind"))
                      {
                        ...
                        if (abkw.a(this.a).contains(paramContext) != true)
                        {
                          this.a.app.getMessageFacade().clearHistory(paramContext.toString(), 9501);
                          return;
                        }
                        if (paramContext.longValue() != 0L) {
                          abkw.b(this.a).add(paramContext);
                        }
                      }
                      else if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StopVideoChat"))
                      {
                        ...
                        for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                        {
                          ...
                          if ((i != 0) || (paramContext != null) || (paramIntent.longValue() == 0L) || (!abkw.b(this.a).contains(paramIntent))) {
                            break;
                          }
                          this.a.app.getMessageFacade().clearHistory(paramIntent.toString(), 9501);
                          abkw.b(this.a).remove(paramIntent);
                          return;
                        }
                        if (paramIntent.longValue() != 0L) {
                          abkw.a(this.a).remove(paramIntent);
                        }
                      }
                      else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_receiveDPMsg"))
                      {
                        ...
                        if (localObject1 == null)
                        {
                          ...
                          QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "dp is null in DeviceMsgHandler::onreceive");
                          return;
                        }
                        paramIntent = ((abgm)this.a.app.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(((DataPoint)localObject1).mDin);
                        i = 0;
                        if (paramIntent != null) {
                        ...
                        if ((11015 == ((DataPoint)localObject1).mProperityId) || (((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012)) {
                          if (QLog.isColorLevel()) {
                            QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "device info pid is 0; dp.mDin = " + ((DataPoint)localObject1).mDin);
                          }
                        }
                        for (;;)
                        {
                          ...
                          {
                            this.a.jdField_a_of_type_Abkq.a((DataPoint)localObject1);
                            if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                              break;
                            }
                            abkw.a(this.a);
                            return;
                          ...
                          for (;;)
                          {
                            try
                            {
                              ...
                              if (paramContext.optInt("flag") == 0)
                              {
                                ...
                                QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "PID_MSG_PROXY JSON :" + ((DataPoint)localObject1).mValue);
                                return;
                              }
                            }
                        ...
                        {
                          this.a.jdField_a_of_type_Abhu.a((DataPoint)localObject1);
                          absy.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 2, 0, i);
                          if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abkw.a(this.a);
                        ...
                        if (10007 == ((DataPoint)localObject1).mProperityId)
                        {
                          for (;;)
                          {
                            ...
                            catch (Exception paramIntent)
                            {
                              try
                              {
                                ...
                                {
                                  paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                                  paramContext.optLong("msg_time", bcrg.a());
                                  paramContext = paramContext.optString("text", " ");
                                  this.a.a(String.valueOf(((DataPoint)localObject1).mDin), paramContext, bcrg.a(), true, false, true);
                                  return;
                                }
                                catch (Exception paramContext) {}
                                if (!QLog.isColorLevel()) {
                                ...
                                QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "onRecvRawTextMsg parse from json error:" + paramContext.getMessage());
                                return;
                              }
                              catch (Exception paramIntent)
                              {
                          ...
                          absy.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 1, 0, i);
                          if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abkw.a(this.a);
                        ...
                        {
                          this.a.jdField_a_of_type_Abkv.a((DataPoint)localObject1);
                          if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abkw.a(this.a);
                        ...
                        if (10009 == ((DataPoint)localObject1).mProperityId)
                        {
                          try
                          {
                            ...
                            localObject4 = (MessageForDevLittleVideo)bcsa.a(-4509);
                            ...
                            ((MessageForDevLittleVideo)localObject4).time = bcrg.a();
                            ((MessageForDevLittleVideo)localObject4).msg = (ContactUtils.getBuddyName(this.a.app, ((MessageForDevLittleVideo)localObject4).senderuin, true) + anvx.a(2131702661));
                            ...
                            this.a.app.getMessageFacade().addMessage((MessageRecord)localObject4, this.a.app.getCurrentAccountUin());
                            if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                              continue;
                            }
                            abkw.a(this.a);
                          ...
                          QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "getString from json error:" + paramContext.getMessage());
                          return;
                        }
                        if (((DataPoint)localObject1).mProperityId == 10008)
                        {
                          try
                          {
                            ...
                            l1 = paramIntent.optLong("msg_time", bcrg.a());
                            paramIntent = paramIntent.optString("text", " ");
                            l2 = ((DataPoint)localObject1).mDin;
                            abkw.a(this.a, l2, paramContext, paramIntent, l1, true);
                            if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                              continue;
                            }
                            abkw.a(this.a);
                      ...
                      try
                      {
                        if (!DeviceTipActivity.a)
                        {
                          ...
                          l2 = ((JSONObject)localObject2).optLong("appear_time", bcrg.a());
                          ...
                          if (QLog.isColorLevel())
                          {
                            QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "ReceiveDoorTip appear_time= " + l2 + " : serverTime = " + bcrg.a() + " loginTimeStr= " + (String)localObject2);
                            i = (int)(bcrg.a() - l2);
                            QQToast.a(this.a.app.getApp(), anvx.a(2131702658) + i + anvx.a(2131702660), 1).a();
                          }
                          if (l1 - l2 > 1L)
                          {
                            if (QLog.isColorLevel()) {
                              QQToast.a(this.a.app.getApp(), "该消息是手Q登录前" + (l1 - l2) + anvx.a(2131702669), 1).a();
                            }
                            this.a.a(paramContext, anvx.a(2131702663), l2, "");
                            return;
                          }
                          if (bcrg.a() - l2 <= 30L)
                          {
                      ...
                      if (((DataPoint)localObject1).mProperityId == 1600006)
                      {
                        try
                        {
                          ...
                          l1 = paramContext.optLong("msg_time", bcrg.a());
                      ...
                      if (((DataPoint)localObject1).mProperityId == 10004)
                      {
                        try
                        {
                          ...
                          l1 = paramIntent.optLong("msg_time", bcrg.a());
                          abkw.a(this.a, paramContext, Long.toString(((DataPoint)localObject1).mDin), (String)localObject2, (String)localObject3, (String)localObject4, str1, str2, l1);
                          if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abkw.a(this.a);
                      ...
                      else if (((DataPoint)localObject1).mProperityId == 11010)
                      {
                        try
                        {
                          ...
                          ((SessionInfo)localObject5).curFriendUin = Long.toString(((DataPoint)localObject1).mDin);
                          ((SessionInfo)localObject5).troopUin = "";
                          ((SessionInfo)localObject5).curType = 9501;
                          ...
                          paramContext = bcsa.a(this.a.app, ((SessionInfo)localObject5).curFriendUin, ((SessionInfo)localObject5).troopUin, ((SessionInfo)localObject5).curType, paramContext);
                          ...
                          this.a.app.getMessageFacade().addMessage(paramContext, this.a.app.getCurrentAccountUin());
                          if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abkw.a(this.a);
                      ...
                      else if ((((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012))
                      {
                        ...
                        {
                          paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                          absz.a(this.a.app, paramContext, String.valueOf(((DataPoint)localObject1).mDin));
                          if (abkw.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abkw.a(this.a);
                        ...
                        if (QLog.isColorLevel()) {
                          QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "auth_request_structmsg:" + paramContext.getMessage());
                        }
                      }
                      else if (((DataPoint)localObject1).mProperityId == 700154)
                      {
                        try
                        {
                          ...
                          if (QLog.isColorLevel()) {
                            QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "openav roomId:" + i + ",sessionId:" + paramContext + ", cTime: " + j + ", cmd:" + k);
                          }
                          if (k != 1) {
                            continue;
                          }
                        ...
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_sendCCDataPointMsgResult"))
                        {
                          ...
                          if (bool)
                          {
                            abkw.a(this.a, String.valueOf(l1), i);
                            return;
                          }
                          abkw.b(this.a, String.valueOf(l1), i);
                          return;
                        }
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferProgress"))
                        {
                          ...
                          for (;;)
                          {
                            ...
                            paramContext.serial();
                            this.a.app.getMessageFacade().updateMsgContentByUniseq(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                        ...
                        else
                        {
                          if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferComplete"))
                          {
                            ...
                            if ((l1 != 0L) && (this.a.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l1))))
                            {
                              ...
                              paramIntent = AppConstants.SDCARD_PATH + "/smart_device/" + paramIntent.getName();
                              ...
                              paramContext.srcFileName = auea.a(paramIntent);
                              paramContext.fileSize = auea.a(paramIntent);
                              paramContext.msg = (ContactUtils.getBuddyName(this.a.app, paramContext.senderuin, true) + ": " + this.a.app.getApp().getString(2131691528));
                              paramContext.serial();
                              this.a.app.getMessageFacade().updateMsgContentByUniseq(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                          ...
                          if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceVasFlagChange"))
                          {
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              localObject2 = ((abgm)localObject1).a(l1);
                              if (localObject2 != null)
                              {
                                ...
                                {
                                  paramIntent = this.a.app.getApp().getString(2131694471).split(":")[0];
                                  paramContext = paramIntent;
                                  if (((DeviceInfo)localObject2).isAdmin != 1)
                                  {
                                    ((abgm)localObject1).a(((DeviceInfo)localObject2).productId, ((DeviceInfo)localObject2).serialNum);
                                    paramContext = paramIntent;
                                  }
                                }
                                ...
                                {
                                  ahzx.f = true;
                                  paramContext = paramContext + this.a.app.getApp().getString(2131691501);
                                  this.a.a(l1 + "", paramContext, bcrg.a(), true, false, 1);
                                  return;
                                }
                                if ((i == 0) && (((DeviceInfo)localObject2).isAdmin != 1))
                                {
                                  ahzx.f = false;
                                  paramContext = paramContext + this.a.app.getApp().getString(2131691500);
                                  this.a.a(l1 + "", paramContext, bcrg.a(), true, false, true);
                                }
                              }
                            }
                          }
                          else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_QueryIsDeviceBinded"))
                          {
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              localObject1 = ContactUtils.getBuddyName(this.a.app, l1 + "", true);
                          ...
                          else
                          {
                            ...
                            paramContext = (abgm)this.a.app.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER);
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              if (localObject1 != null)
                              {
                                ...
                                for (paramContext = anvx.a(2131702671); !TextUtils.isEmpty(paramContext); paramContext = anvx.a(2131702668) + ((ProductInfo)localObject1).deviceName)
                                {
                                  localObject1 = ContactUtils.getBuddyName(this.a.app, Long.toString(((Long)localObject3).longValue()), true);
                                  paramIntent = (Intent)localObject1;
                                  if (TextUtils.isEmpty((CharSequence)localObject1)) {
                                    paramIntent = String.valueOf(localObject3);
                                  }
                                  paramContext = paramIntent + paramContext;
                                  this.a.a(localObject2 + "", paramContext, bcrg.a(), true, false, true);
                                  return;
                  ...
                  paramContext = anvx.a(2131702659);
            ...
            } while ((localObject1 != null) && (((abgm)localObject1).a(l1, 13)));
            if (asll.a().a(this.a.app, paramContext) != 0) {
              this.a.a(l1 + "", "【重要！设备安全提醒】\n\n为防止QQ号被盗/丢失手机，导致设备被人恶意控制\n请点这里开启QQ设备锁\n\n\n查看QQ设备锁介绍", bcrg.a(), "device_lock_msg");
            }
        ...
        } while ((localObject2 == null) || (((DeviceInfo)localObject2).isAdmin == 1) || (!((abgm)localObject1).a(l1).booleanValue()));
        paramContext = paramContext + this.a.app.getApp().getString(2131691501);
        this.a.a(l1 + "", paramContext, bcrg.a(), true, false, 1);
        return;
        ...
        if (QLog.isColorLevel()) {
          QLog.d(abkw.jdField_a_of_type_JavaLangString, 2, "DeviceMsghandle intent.getExtras() : " + paramIntent.getExtras());
        }
        paramContext = paramIntent.getExtras();
      ...
      localObject1 = ContactUtils.getBuddyName(this.a.app, paramContext, true);
      if ((TextUtils.isEmpty((CharSequence)localObject1)) || (paramContext.equals(localObject1))) {}
      for (paramContext = anvx.a(2131702678);; paramContext = (String)localObject1 + anvx.a(2131702667))
      {
        this.a.a(String.valueOf(paramIntent), paramContext, bcrg.a(), "");
        abkw.a(this.a);
        return;
      }
      if ("SmartDevice_sendToAIO_Capture".equals(paramIntent.getAction()))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("msg_time", bcrg.a());
          ((JSONObject)localObject2).put("guidewords", anvx.a(2131702665));
          ((JSONObject)localObject2).put("appear_time", bcrg.a());
          ((JSONObject)localObject2).put("digest", anvx.a(2131702674));
          ((JSONObject)localObject2).put("title", anvx.a(2131702677));
          paramIntent = (MessageForDeviceSingleStruct)bcsa.a(-4502);
          ...
          paramIntent.strMediaFileName = auea.a((String)localObject1);
    ...
    try
    {
      ...
      ((JSONObject)localObject3).put("msg_time", bcrg.a());
      ((JSONObject)localObject3).put("guidewords", anvx.a(2131702676));
      ((JSONObject)localObject3).put("appear_time", bcrg.a());
      ...
      localObject2 = (MessageForDeviceSingleStruct)bcsa.a(-4502);
      ...
      ((MessageForDeviceSingleStruct)localObject2).strMediaFileName = auea.a(paramIntent);
