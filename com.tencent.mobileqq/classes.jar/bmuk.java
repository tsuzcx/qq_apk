...
public class bmuk
{
  ...
  public bmuk(Activity paramActivity, View paramView, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_a_of_type_Bmvh = new bmul(this);
  ...
  public void a(TianShuAccess.AdItem paramAdItem, int paramInt)
  {
    ...
    localbmvj.jdField_e_of_type_JavaLangString = "tianshu.99";
    localbmvj.jdField_f_of_type_JavaLangString = "tianshu.99";
    localbmvj.g = (i + "");
    localbmvj.h = "";
  ...
  public void b()
  {
    if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      try
      {
        ...
        localURLDrawable.setURLDrawableListener(new bmum(this));
