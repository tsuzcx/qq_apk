  ...
  implements Cloneable
{
  ...
  public static rch a(articlesummary.ArkAppFeedsInfo paramArkAppFeedsInfo)
  {
    ...
    if (paramArkAppFeedsInfo.uint64_feeds_id.has())
    {
      ...
      label103:
      localrch.jdField_a_of_type_JavaLangString = str;
    ...
    {
      localrch.f = paramArkAppFeedsInfo;
      if (QLog.isColorLevel()) {
        QLog.d("ArkAppFeedsInfo", 2, new Object[] { "mFeedsId: ", Long.valueOf(localrch.jdField_a_of_type_Long), ", mFeedsStyle: ", Integer.valueOf(localrch.jdField_a_of_type_Int), ", appName: ", localrch.jdField_a_of_type_JavaLangString, ", appView: ", localrch.b, ", appMinVersion: ", localrch.e, ", metaList: ", localrch.f });
      }
      return localrch;
      l = 0L;
      break;
