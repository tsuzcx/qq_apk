...
class antm
{
  ...
  private HashMap<String, anto> jdField_a_of_type_JavaUtilHashMap;
  private List<cmd0x58b.GetConfInfoRsp> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  private byte[] jdField_a_of_type_ArrayOfByte;
  
  public antm(byte[] paramArrayOfByte, ArrayList<Object> paramArrayList, HashMap<String, anto> paramHashMap)
  {
  ...
  public antm a()
  {
    ...
    try
    {
      ...
      if ((!localOIDBSSOPkg.uint32_result.has()) || (localOIDBSSOPkg.uint32_result.get() != 0) || (!localOIDBSSOPkg.bytes_bodybuffer.has()) || (localOIDBSSOPkg.bytes_bodybuffer.get() == null))
      {
        ...
        this.jdField_a_of_type_Antl.notifyUI(1001, false, this.jdField_a_of_type_JavaUtilArrayList);
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Antl.a(this.jdField_a_of_type_JavaUtilHashMap.values());
        this.jdField_a_of_type_Antl.notifyUI(1001, false, this.jdField_a_of_type_JavaUtilArrayList);
        this.jdField_a_of_type_Boolean = true;
        return this;
      }
