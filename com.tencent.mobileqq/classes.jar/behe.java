...
public class behe
{
  ...
  {
    bmad.a(null, a(paramString)).b(paramQQAppInterface, null).a(paramActivity, paramQQAppInterface.getAccount());
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      if (localClipboardManager != null)
      {
        ...
        if (paramBoolean) {
          QQToast.a(BaseApplicationImpl.getContext(), 2, anvx.a(2131706023), 0).a();
        }
      }
    }
  }
