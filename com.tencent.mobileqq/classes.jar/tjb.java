    ...
    while (localIterator.hasNext())
    {
      ...
      if (tjj.a(localJSONObject))
      {
        if (!rad.a().a()) {
          ...
          paramList1 = tjj.a(localJSONObject);
        }
      }
      else {
        for (;;)
        {
          paramList1.b = tjf.a(paramSparseArray);
          ...
          break;
          paramList1 = tjf.a(localJSONObject, paramArticleInfo, paramFastWebArticleInfo);
          paramList1.v = 1;
          paramList1.u = -1;
        }
      }
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, List<BaseData> paramList, List<oidb_cmd0xe7e.ModuleInfo> paramList1, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      while (paramList1.hasNext())
      {
        ...
        try
        {
          ProteusItemData localProteusItemData = tjf.a(new JSONObject(paramSparseArray.bytes_json.get().toStringUtf8()), paramArticleInfo, paramFastWebArticleInfo);
          localProteusItemData.v = -99;
          localProteusItemData.b = paramSparseArray.bytes_weight.get();
          tke.a(paramList, localProteusItemData, paramItemShowDispatcher);
        }
