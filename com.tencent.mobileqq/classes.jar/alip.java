...
public class alip
{
  private static alip jdField_a_of_type_Alip;
  private static final FileFilter jdField_a_of_type_JavaIoFileFilter = new aliq();
  ...
  {
    if (jdField_a_of_type_Alip == null) {
      jdField_a_of_type_Alip = new alip();
    }
    return jdField_a_of_type_Alip;
  }
