...
public class auzn
{
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (paramInt3 == 3) {
        return amtj.a(2131693353);
      }
      if (paramInt3 == 2) {
        return amtj.a(2131693364);
      }
      if (paramInt3 == 1) {
        return amtj.a(2131693380);
      }
      return amtj.a(2131693374);
    }
    if (paramInt2 > 1) {
      return paramInt2 + amtj.a(2131693372);
    }
    if (paramInt2 == 1) {
      return paramInt2 + amtj.a(2131693390);
    }
    return amtj.a(2131693374);
  }
  ...
  public static void a(Activity paramActivity, int paramInt, String paramString)
  {
    ...
    localIntent.putExtra("url", bjnd.a(bjnd.a(bjnd.a(bjnd.a(QzoneConfig.getInstance().getConfig("H5Url", "YQHMusicPersonalPlayerUrl", "https://zb.vip.qq.com/v2/musicTheme"), "uin", paramString), "uinType", String.valueOf(paramInt)), "type", "2"), "_wv", "5123"));
    paramActivity.startActivity(localIntent);
    bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A5C2", 1, 0, "", "", VipUtils.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()), "");
  }
  ...
  public static void a(Context paramContext, int paramInt1, String paramString1, int paramInt2, boolean paramBoolean, String paramString2)
  {
    ...
    do
    {
      ...
      localObject = bfur.a(paramContext, 230);
      paramString2 = new auzo(paramInt1, paramString1, paramString2, paramInt2);
      ((QQCustomDialog)localObject).setTitle(2131693366);
      ((QQCustomDialog)localObject).setTitleMutiLine();
      ((QQCustomDialog)localObject).setMessage(null);
      ((QQCustomDialog)localObject).setNegativeButton(amtj.a(2131705310), paramString2);
      ((QQCustomDialog)localObject).setPositiveButton(amtj.a(2131693354), paramString2);
  ...
  public static void a(BaseChatPie paramBaseChatPie, int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      localQQCustomDialog = bfur.a(paramBaseChatPie.getActivity(), 230);
      auzp localauzp = new auzp(paramBaseChatPie, paramInt, paramString);
      localQQCustomDialog.setTitle(2131693365);
      localQQCustomDialog.setMessage(null);
      localQQCustomDialog.setNegativeButton(amtj.a(2131705310), localauzp);
      localQQCustomDialog.setPositiveButton(amtj.a(2131706149), localauzp);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, String paramString)
  {
    ...
    paramQQAppInterface.putExtra("url", bjnd.a(bjnd.a(bjnd.a(bjnd.a("https://web.qun.qq.com/qunmusic/listener", "uin", paramString), "uinType", String.valueOf(paramInt)), "_wwv", "128"), "_wv", "2"));
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString, int paramInt2)
  {
    ...
    for (boolean bool = ((TroopInfo)localObject).isAdmin();; bool = false)
    {
      if (!bool)
      {
        ...
        {
          QQToast.a(BaseApplication.getContext(), 2131693369, 0).a();
          return;
        }
  ...
  public static void a(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      bcef.b(null, "dc00899", str, "", "music_tab", paramString1, 0, 0, paramString2, "0", "", "");
      return;
      str = "c2c_AIO";
      break;
      label43:
  ...
  {
    if (bdct.a(paramQQAppInterface).a(paramContext, 1, paramString, paramInt2)) {
      return;
    }
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    String str2 = bjnd.a("https://web.qun.qq.com/qunmusic/index", "uin", paramString);
    ...
    if (!TextUtils.isEmpty(str3)) {
      str1 = bjnd.a(str2, "themeId", str3);
    }
    str2 = bjnd.a(str1, "uinType", String.valueOf(paramInt1));
    if (bool)
    {
      str1 = "1";
      str2 = bjnd.a(bjnd.a(bjnd.a(str2, "showlrc", str1), "_wv", "2"), "_wwv", "128");
      if (!localListenTogetherManager.b(paramInt1, paramString)) {
        break label260;
      }
      str1 = "1";
      label160:
      str2 = bjnd.a(bjnd.a(str2, "isJoin", str1), "from", String.valueOf(paramInt2));
    ...
    for (str1 = "1";; str1 = "0")
    {
      localIntent.putExtra("url", bjnd.a(str2, "isNew", str1));
  ...
  private static boolean b(BaseChatPie paramBaseChatPie, int paramInt, String paramString)
  {
    ...
    if (!bool) {
      QQToast.a(BaseApplicationImpl.getContext(), 2131693369, 1).b(paramBaseChatPie.getTitleBarHeight());
    }
    return bool;
  }
}
