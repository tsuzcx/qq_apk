...
public class xkf
  implements Runnable
{
  public xkf(GoldMsgChatHelper paramGoldMsgChatHelper, MessageRecord paramMessageRecord, String paramString1, String paramString2, String paramString3) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      QWalletCommonServlet.a(new GroupGoldMsgGrabReq(this.jdField_a_of_type_JavaLangString, this.b, str3, this.c, "8192", str4, str5, (String)localObject, str1, str2, "2", Build.MODEL, String.valueOf(43), str6, str7, str8), this.jdField_a_of_type_ComTencentMobileqqActivityQwalletGoldmsgGoldMsgChatHelper.a);
      return;
