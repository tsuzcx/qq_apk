  ...
  extends pto<BaseArticleInfo>
{
  ...
  public int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      AIOUtils.catchedExceptionInReleaseV2("DynamicItemViewHelperCompat", "", new IllegalArgumentException(anvx.a(2131703055)));
      return b;
    }
  ...
  protected TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      JSONObject localJSONObject = this.jdField_a_of_type_Qoc.a(i, paramBaseArticleInfo);
      localTemplateBean1 = localTemplateBean2;
      localTemplateBean2 = this.jdField_a_of_type_Qoc.a(i, localJSONObject);
      localTemplateBean1 = localTemplateBean2;
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localTemplateBean1 != null)
    {
      ...
      if (localTemplateBean2 != null)
      {
        ...
        if (!localTemplateBean2.equals(localTemplateBean1))
        {
          ...
          if (localObject != null)
          {
            ((Container)localObject).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841743));
    ...
    if (localTemplateBean2 != null) {
      piv.a(paramBaseArticleInfo, (TemplateBean)localObject, localTemplateBean2);
    }
    piv.a(paramBaseArticleInfo, paramVafContext, localTemplateBean2);
    blfz.a();
  }
  ...
  public void a(VafContext paramVafContext, int paramInt)
  {
    ...
    this.jdField_a_of_type_Qoc = new qoc(paramVafContext);
  }
