  ...
  implements Manager
{
  ...
  private ConcurrentHashMap<String, amqx> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          ((StringBuilder)localObject1).append(((amqx)localEntry.getValue()).jdField_a_of_type_Int);
          ((StringBuilder)localObject1).append(",type=");
          ((StringBuilder)localObject1).append(((amqx)localEntry.getValue()).b);
          ((StringBuilder)localObject1).append(",isRequest=");
          ((StringBuilder)localObject1).append(((amqx)localEntry.getValue()).jdField_a_of_type_Boolean);
          ((StringBuilder)localObject1).append(",saveTime=");
          ((StringBuilder)localObject1).append(((amqx)localEntry.getValue()).jdField_a_of_type_Long);
      ...
      {
        localObject1 = (amqx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        if (localObject1 != null)
        {
          int k = ((amqx)localObject1).jdField_a_of_type_Int;
          int m = ((amqx)localObject1).b;
          if (((m == 0) && (k != j)) || ((m != i) && (!((amqx)localObject1).jdField_a_of_type_Boolean)))
          {
            ((amqx)localObject1).jdField_a_of_type_Boolean = true;
            if (QLog.isColorLevel())
            {
          ...
          if ((k == j) && (m == i) && (((amqx)localObject1).jdField_a_of_type_Boolean))
          {
            if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    Object localObject = bdne.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = ((String)localObject).split("\\|");
      if ((localObject != null) && (localObject.length == 2))
      {
        this.jdField_a_of_type_Long = ansd.a(localObject[0]);
        this.jdField_b_of_type_Long = ansd.a(localObject[1]);
        if (QLog.isColorLevel()) {
  ...
  public void a(amqw paramamqw)
  {
    ...
    if ((a()) && (paramamqw != null))
    {
      ...
      localStringBuilder.append(" uin=").append(bdnn.e(paramamqw.jdField_a_of_type_JavaLangString));
      localStringBuilder.append(" sysId=").append(paramamqw.jdField_b_of_type_Long);
      localStringBuilder.append(" headType=").append(paramamqw.c);
      localStringBuilder.append(" qq18Switch=").append(paramamqw.jdField_a_of_type_Long);
      if ((!TextUtils.isEmpty(paramamqw.jdField_a_of_type_JavaLangString)) && (paramamqw.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (paramamqw.jdField_a_of_type_Long != -1L)) {
        a(paramamqw.jdField_a_of_type_Long);
      }
      localFriendListHandler = (FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1);
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1, paramamqw.jdField_a_of_type_JavaLangString, 0);
      if ((localObject == null) || (!((Boolean)((Pair)localObject).first).booleanValue())) {
        break label221;
      }
      localFriendListHandler.c(paramamqw.jdField_a_of_type_JavaLangString);
      localFriendListHandler.notifyUI(3, true, paramamqw.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((localObject != null) && (((Pair)localObject).second != null))
      {
        ...
        if (((paramamqw.jdField_a_of_type_Long == 1L) && (paramamqw.c != -1L) && (paramamqw.c != l2)) || ((paramamqw.jdField_b_of_type_Long != -1L) && (paramamqw.jdField_b_of_type_Long != l1) && (l2 == 0L)))
        {
          localStringBuilder.append(" fetch userHead");
          localFriendListHandler.c(paramamqw.jdField_a_of_type_JavaLangString);
          localFriendListHandler.notifyUI(3, true, paramamqw.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString)
  {
    ...
    {
      amqx localamqx = (amqx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if ((localamqx != null) && (localamqx.jdField_a_of_type_Boolean))
      {
        QLog.d("ClassicHeadActivityManager", 2, " QQ 18 handle handleGetHeadError uin=" + paramString + ",HeadID=" + localamqx.jdField_a_of_type_Int + ",Type=" + localamqx.b + ",IsRequest=" + localamqx.jdField_a_of_type_Boolean);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
      }
    }
  }
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            {
              return;
              localObject = new amqx(paramString, paramInt1, paramInt2);
              if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramString)) {
                break;
              }
            ...
            return;
            localamqx = (amqx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
          } while (localamqx == null);
          i = localamqx.jdField_a_of_type_Int;
          j = localamqx.b;
