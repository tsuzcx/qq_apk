...
public class avke
  extends auxl
{
  public avke(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, String paramString)
  {
    ...
    do
    {
      ...
      str = bdnn.a(paramString, "<head>", "</head>");
      paramString = bdnn.a(paramString, "<body>", "</body>");
    } while (!this.a.isResume());
    bdmh.a(this.a, str, paramString, paramInt3 - paramInt1).show();
  }
  ...
  public void a(boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3, byte[] paramArrayOfByte, String paramString)
  {
    ...
    apib.c("profileCard", new Object[] { ((StringBuilder)localObject).toString() });
    localObject = this.a;
    ...
    if (paramBoolean1) {
      if (paramBoolean2)
      {
        apib.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "onGetShowLoveLimit , can chat, someting is wrong" });
    ...
    for (;;)
    {
      ...
      if (paramBoolean3)
      {
        if (NearbyPeopleProfileActivity.a(this.a) != null)
        {
          ...
          bddf.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne);
          QLog.d("Q.nearby_people_card.", 1, "ShowLoveEditorActivity 已在725下架");
        }
      }
      else
      {
        apib.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "cant show love, wording is " + paramString });
        paramArrayOfByte = paramString;
        if (TextUtils.isEmpty(paramString)) {
          paramArrayOfByte = ((Activity)localObject).getResources().getString(2131699703);
        }
        apib.a(this.a, paramArrayOfByte);
        continue;
        apib.a((Activity)localObject, ((Activity)localObject).getString(2131699702));
      }
    }
  }
  ...
  protected void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        ((auvr)this.a.app.getManager(207)).a(paramNearbyPeopleCard.uin, false);
  ...
  public void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2, String paramString)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (this.a.t)
      {
        this.a.jdField_a_of_type_Auxh.a(true);
        this.a.t = false;
      }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      paramString = (auvr)this.a.app.getManager(207);
      if (NearbyPeopleProfileActivity.a(this.a) != null) {
    ...
    return;
    label157:
    this.a.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new avkf(this, paramString));
  ...
  {
    if ((NearbyPeopleProfileActivity.a(this.a) == null) || (TextUtils.isEmpty(NearbyPeopleProfileActivity.a(this.a).uin)) || (TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1)) || (bdeu.a(paramString2, paramString1))) {}
    do
    {
      do
      {
        return;
      } while ((!bdeu.a(paramString2, NearbyPeopleProfileActivity.a(this.a).uin)) || (!bdeu.a(paramString1, this.a.app.getCurrentAccountUin())));
      if (!paramBoolean)
      {
        this.a.b(this.a.getResources().getString(2131693646));
  ...
  public void a(boolean paramBoolean, String paramString1, List<avau> paramList, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    {
      this.a.a();
      this.a.a(2, alud.a(2131707634));
      return;
    }
    this.a.a();
    this.a.a(1, alud.a(2131707625) + paramString2);
  }
  ...
  protected void a(boolean paramBoolean, UpdatePhotoList.HeadInfo paramHeadInfo)
  {
    ...
    if (this.a.jdField_a_of_type_Long > 0L) {
      bdda.a(this.a.jdField_a_of_type_Auxh, this.a.app, this.a.jdField_a_of_type_Long, null, this.a.jdField_d_of_type_Int, arrayOfByte, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return;
      if (!bdnn.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)) {
        bdda.a(this.a.jdField_a_of_type_Auxh, this.a.app, 0L, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, this.a.jdField_d_of_type_Int, arrayOfByte, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
      }
    }
  }
}
