...
public class bebe
{
  ...
  private List<bebf> jdField_a_of_type_JavaUtilList;
  ...
  private Pair<Integer, List<bebf>> a(String paramString, int paramInt)
  {
    Object localObject = null;
    byte[] arrayOfByte = new bebz().a(paramString, null, 1);
  ...
  /* Error */
  private Pair<Integer, List<bebf>> a(byte[] paramArrayOfByte, int paramInt)
  {
    // Byte code:
    ...
    //   42: aload_0
    //   43: aload 7
    //   45: invokespecial 155	bebe:a	(Lorg/w3c/dom/Element;)I
    //   48: istore_3
    //   49: iload_3
    //   50: ifeq +8 -> 58
    //   53: iload_3
    ...
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 172	bebe:a	(Lorg/w3c/dom/Node;)Lbebf;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
  ...
  private bebf a(Node paramNode)
  {
    ...
    do
    {
      for (;;)
      {
          ...
          else
          {
            ...
            if (str != null)
            {
              ...
              if (localObject != null) {
                ...
                {
                  localbebf.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("type"))
                {
                  localbebf.jdField_b_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("flags"))
                {
                  localbebf.c = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("path"))
                {
                  localbebf.jdField_b_of_type_JavaLangString = ((String)localObject);
                  i = k + 1;
                }
                else
                {
                  ...
                  {
                    localbebf.jdField_a_of_type_JavaLangString = ((String)localObject);
                    i = k + 1;
                  }
                }
              }
        ...
        localbebf.jdField_a_of_type_AndroidOsBundle = a(paramNode);
        return localbebf;
        j += 1;
        k = i;
      }
  ...
  private String a()
  {
    return bdzk.a() + File.separator + "QSec.dat";
  }
  ...
  private boolean a(String paramString, int paramInt, List<bebf> paramList)
  {
    paramList = a(paramInt, paramList);
    if (paramList == null) {
      return false;
    }
    return new bebz().a(paramString, paramList, null, 1);
  }
  
  /* Error */
  private byte[] a(int paramInt, List<bebf> paramList)
  {
    // Byte code:
    ...
    //   132: ldc 182
    //   134: aload 6
    //   136: getfield 183	bebf:jdField_a_of_type_Int	I
    ...
    //   154: ldc 185
    //   156: aload 6
    //   158: getfield 188	bebf:jdField_b_of_type_Int	I
    ...
    //   198: ldc 200
    //   200: aload 6
    //   202: getfield 202	bebf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   217: ldc 195
    //   219: aload 6
    //   221: getfield 198	bebf:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private bebf b(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      bebf localbebf = (bebf)localIterator.next();
      if (localbebf.jdField_a_of_type_Int == paramInt) {
        return localbebf;
      }
    }
    return null;
  ...
  {
    bebf localbebf = b(paramInt);
    if (localbebf == null) {}
    do
    {
      return;
      this.jdField_a_of_type_JavaUtilList.remove(localbebf);
    } while (!paramBoolean);
  ...
  public boolean a(bebf parambebf, boolean paramBoolean)
  {
    if (a(parambebf.jdField_a_of_type_Int)) {
      return false;
    }
    this.jdField_a_of_type_JavaUtilList.add(parambebf);
    if (paramBoolean) {
      return a();
    }
    return true;
