...
public class axdm
{
  ...
  public View a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localLinearLayout.setBackgroundResource(2130845447);
    ...
    localLinearLayout.setOnClickListener(new axdn(this));
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131378807);
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer = ((LabelContainer)paramView.findViewById(2131369770));
    this.b = paramView.findViewById(2131369969);
