  ...
  implements Manager
{
  ...
  anjl jdField_a_of_type_Anjl;
  anqd jdField_a_of_type_Anqd = new axdo(this);
  anuw jdField_a_of_type_Anuw = new axdn(this);
  protected aobu a;
  axcb jdField_a_of_type_Axcb;
  bghf jdField_a_of_type_Bghf;
  bghg jdField_a_of_type_Bghg;
  public QQAppInterface a;
  public ArrayList<String> a;
  protected HashSet<String> a;
  List<axiy> jdField_a_of_type_JavaUtilList = new ArrayList();
  MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  int jdField_b_of_type_Int = -2147483648;
  List<axiy> jdField_b_of_type_JavaUtilList = new ArrayList();
  MqqHandler jdField_b_of_type_MqqOsMqqHandler;
  
  public axdm(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(String paramString)
  {
    if (QLog.isColorLevel()) {
      axei.a("delAccountRecord", new Object[] { paramString });
    }
    ...
    axdz.a(paramString, "history_valid", Boolean.valueOf(false));
  }
  ...
  public Message a(Context arg1, Message paramMessage)
  {
    ...
    case 4143: 
      ...
      localObject = ((apul)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(180)).b(i, (String)localObject);
      if (localObject == null) {
        return null;
      }
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Aobu == null)
      {
        ...
        this.jdField_a_of_type_Aobu.a(new axdq(this));
      }
      localObject = this.jdField_a_of_type_Aobu.a(i, paramMessage, 200);
      if (localObject == null) {
        synchronized (this.jdField_a_of_type_JavaUtilHashSet)
        {
          this.jdField_a_of_type_JavaUtilHashSet.add(paramMessage);
          this.jdField_a_of_type_Aobu.a(paramMessage, i, true);
          return null;
        }
      }
  ...
  public axcb a()
  {
    try
    {
      if (this.jdField_a_of_type_Axcb == null) {
        this.jdField_a_of_type_Axcb = new axcb();
      }
      axcb localaxcb = this.jdField_a_of_type_Axcb;
      return localaxcb;
    }
    finally {}
  }
  
  public bghf a(boolean paramBoolean)
  {
    try
    {
      if ((this.jdField_a_of_type_Bghf == null) && (paramBoolean)) {
        this.jdField_a_of_type_Bghf = new bghf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      bghf localbghf = this.jdField_a_of_type_Bghf;
      return localbghf;
    }
    finally {}
  }
  ...
  public bghg a()
  {
    try
    {
      if (this.jdField_a_of_type_Bghg == null) {
        this.jdField_a_of_type_Bghg = new bghg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      bghg localbghg = this.jdField_a_of_type_Bghg;
      return localbghg;
    }
    finally {}
  }
  ...
  public String a()
  {
    ...
    if (TextUtils.isEmpty(str)) {
      localObject = BaseApplication.getContext().getResources().getString(2131697871);
    }
    return localObject;
  }
  ...
  public String a(String paramString)
  {
    ...
    for (;;)
    {
      localObject = str;
      if (str == null) {
        localObject = BaseApplication.getContext().getResources().getString(2131697859);
      }
      return ((String)localObject).replace("%", paramString);
      arkw.b("getFirstAIOTips", new Object[] { "datingConfig is null" });
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        axei.a("realHasUnreadMsg", new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(ConnectNearbyProcService.a()) });
      }
      return;
      axdl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 3);
      axdr localaxdr = new axdr(this, paramInt);
      localaxdr.a = true;
      a(localaxdr);
    }
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        localObject = (axiy)this.jdField_a_of_type_JavaUtilList.get(i);
        this.jdField_a_of_type_MqqOsMqqHandler.post(new NearbyProxy.5(this, (axiy)localObject, paramInt, paramVarArgs));
        i += 1;
      }
      if (paramInt == 4124)
      {
        ...
        {
          axiy localaxiy = (axiy)((Iterator)localObject).next();
          if ((localaxiy != null) && (localaxiy.a)) {
    ...
    try
    {
      ...
      {
        localObject = (axiy)this.jdField_b_of_type_JavaUtilList.get(i);
        this.jdField_b_of_type_MqqOsMqqHandler.post(new NearbyProxy.6(this, (axiy)localObject, paramInt, paramVarArgs));
        i += 1;
      }
      if (paramInt == 4124)
      {
        ...
        {
          localObject = (axiy)paramVarArgs.next();
          if ((localObject != null) && (((axiy)localObject).a)) {
            paramVarArgs.remove();
          }
        }
      }
  ...
  public void a(axiy paramaxiy)
  {
    a(paramaxiy, false);
  }
  
  public void a(axiy paramaxiy, boolean paramBoolean)
  {
    if (paramaxiy == null) {
      return;
    }
    if (paramBoolean) {
      ...
      {
        if (!this.jdField_b_of_type_JavaUtilList.contains(paramaxiy)) {
          this.jdField_b_of_type_JavaUtilList.add(paramaxiy);
        }
        return;
      }
    }
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilList.contains(paramaxiy)) {
        this.jdField_a_of_type_JavaUtilList.add(paramaxiy);
      }
      return;
    }
  }
  ...
  public void a(String paramString, Oidb_0x686.NearbyRankConfig paramNearbyRankConfig, Oidb_0x686.NearbyFeedConfig paramNearbyFeedConfig, Oidb_0x686.CharmEvent paramCharmEvent, Oidb_0x686.NearbyCharmNotify paramNearbyCharmNotify)
  {
    ...
    axby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramCharmEvent, paramNearbyCharmNotify);
    int i;
  ...
  {
    axei.a("Q.nearby", "updateNearbyCard", new Object[] { paramRspBody });
    ...
    do
    {
      ...
      for (paramRspBody = paramRspBody.rpt_msg_tags.get();; paramRspBody = null)
      {
        ...
        {
          localObject2 = axid.a((appoint_define.InterestTag)paramRspBody.get(i));
  ...
  public void a(SubMsgType0x27.AppointmentNotify paramAppointmentNotify)
  {
    ...
    for (boolean bool = b();; bool = true)
    {
      ...
      {
        axei.a("hasOnLinePush", new Object[] { Boolean.valueOf(bool), Integer.valueOf(paramAppointmentNotify.uint32_notifytype.get()), Boolean.valueOf(ConnectNearbyProcService.a()) });
        return;
        label97:
        axdl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 4);
        axds localaxds = new axds(this, paramAppointmentNotify);
        localaxds.a = true;
        a(localaxds);
      }
      break;
  ...
  public void a(boolean paramBoolean)
  {
    boolean bool = false;
    int i = 1;
    arkw.b("setNearbyDatingMsg", new Object[] { Boolean.valueOf(paramBoolean), Integer.valueOf(this.jdField_a_of_type_Int) });
    if ((this.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_Int == 3)) {
      bool = true;
    }
    if ((this.jdField_a_of_type_Int == 0) || (bool != paramBoolean)) {
      axdz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "dating_recv_msg", Boolean.valueOf(paramBoolean));
    }
    if (paramBoolean) {}
    for (;;)
    {
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Int == 0) {
      if (!axdz.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
        break label45;
      }
    }
    label45:
  ...
  public Object[] a(Context paramContext, int paramInt, Object... paramVarArgs)
  {
    ...
    //   317: iconst_0
    //   318: aload_0
    //   319: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   322: bipush 71
    //   324: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   327: checkcast 665	arku
    //   330: invokevirtual 668	arku:a	()Larls;
    //   333: aload_3
    //   334: iconst_0
    //   335: aaload
    ...
    //   357: invokevirtual 676	arls:a	(Ljava/lang/String;IZ)Ljava/lang/String;
    //   360: aastore
    //   361: areturn
    //   362: aload_0
    //   363: iconst_0
    //   364: aload_3
    //   365: invokevirtual 678	axdm:a	(Z[Ljava/lang/Object;)V
    //   368: aconst_null
    //   369: areturn
    //   370: aload_0
    //   371: iconst_1
    //   372: aload_3
    //   373: invokevirtual 678	axdm:a	(Z[Ljava/lang/Object;)V
    //   376: aconst_null
    //   377: areturn
    //   378: new 680	com/tencent/mobileqq/nearby/NearbyProxy$1
    //   381: dup
    //   382: aload_0
    //   383: invokespecial 681	com/tencent/mobileqq/nearby/NearbyProxy$1:<init>	(Laxdm;)V
    //   386: aconst_null
    //   387: iconst_1
    ...
    //   402: iconst_0
    //   403: aload_0
    //   404: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   407: bipush 36
    //   409: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   412: checkcast 687	baif
    //   415: aload_3
    //   416: iconst_0
    //   417: aaload
    //   418: checkcast 403	java/lang/String
    //   421: invokevirtual 690	baif:a	(Ljava/lang/String;)Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    ...
    //   488: istore 4
    //   490: aload_0
    //   491: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   494: aload_3
    //   495: iconst_0
    //   496: aaload
    ...
    //   533: invokestatic 701	aybu:a	(Lcom/tencent/common/app/AppInterface;IILjava/lang/String;Ljava/lang/String;Z)Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   536: astore_1
    //   537: iload 4
    //   539: ifeq -239 -> 300
    //   542: iconst_1
    ...
    //   570: iconst_0
    //   571: aload_0
    //   572: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   575: aload_1
    //   576: invokestatic 706	aldk:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Z
    ...
    //   633: istore 5
    //   635: aload_0
    //   636: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   639: aload_1
    //   640: aload 6
    //   642: iload_2
    //   643: iload 4
    //   645: iload 5
    //   647: invokestatic 711	aoey:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;IZZ)V
    //   650: aconst_null
    //   651: areturn
    //   652: aload_3
    //   653: ifnull -353 -> 300
    ...
    //   680: istore_2
    //   681: aload_0
    //   682: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   685: aload_1
    //   686: aload 6
    //   688: iload_2
    //   689: invokestatic 714	aoey:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;I)V
    //   692: aconst_null
    //   693: areturn
    //   694: aload_3
    //   695: ifnull +9 -> 704
    ...
    //   715: areturn
    //   716: aload_0
    //   717: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   720: aload_0
    //   721: getfield 59	axdm:jdField_a_of_type_Anqd	Lanqd;
    //   724: invokevirtual 718	com/tencent/mobileqq/app/QQAppInterface:addObserver	(Lanil;)V
    //   727: aload_0
    //   728: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   731: iconst_0
    //   732: invokevirtual 721	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lanii;
    ...
    //   793: areturn
    //   794: aload_0
    //   795: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   798: aload_0
    //   799: getfield 59	axdm:jdField_a_of_type_Anqd	Lanqd;
    //   802: invokevirtual 718	com/tencent/mobileqq/app/QQAppInterface:addObserver	(Lanil;)V
    //   805: aload_0
    //   806: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   809: iconst_0
    //   810: invokevirtual 721	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lanii;
    ...
    //   853: iconst_0
    //   854: aload_0
    //   855: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   858: bipush 16
    //   860: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   863: checkcast 734	awhl
    //   866: aload_3
    //   867: iconst_0
    //   868: aaload
    //   869: checkcast 403	java/lang/String
    //   872: invokevirtual 736	awhl:a	(Ljava/lang/String;)Z
    ...
    //   959: pop
    //   960: aload_0
    //   961: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   964: aload 7
    //   966: aload 6
    //   968: aload_1
    //   969: invokestatic 530	axby:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ltencent/im/oidb/cmd0x686/Oidb_0x686$CharmEvent;Ltencent/im/oidb/cmd0x686/Oidb_0x686$NearbyCharmNotify;)V
    //   972: aconst_null
    //   973: areturn
    //   974: astore_1
    //   975: aconst_null
    ...
    //   1017: aload_0
    //   1018: aload_1
    //   1019: invokevirtual 749	axdm:a	(Ltencent/im/oidb/cmd0x9c7/cmd0x9c7$RspBody;)V
    //   1022: aconst_null
    //   1023: areturn
    //   1024: astore_3
    //   1025: aconst_null
    ...
    //   1068: aload_0
    //   1069: iload 4
    //   1071: invokevirtual 760	axdm:a	(Z)V
    //   1074: aconst_null
    //   1075: areturn
    //   1076: aload_0
    //   1077: getfield 358	axdm:jdField_a_of_type_Axcb	Laxcb;
    //   1080: ifnull -780 -> 300
    //   1083: aload_0
    //   1084: getfield 358	axdm:jdField_a_of_type_Axcb	Laxcb;
    //   1087: invokevirtual 762	axcb:a	()V
    //   1090: aconst_null
    //   1091: areturn
    //   1092: aload_3
    //   1093: ifnull -793 -> 300
    ...
    //   1143: pop
    //   1144: aload_0
    //   1145: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1148: bipush 106
    //   1150: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1153: checkcast 527	axby
    //   1156: astore_3
    //   1157: aload_3
    //   1158: ifnull -858 -> 300
    //   1161: aload_3
    //   1162: aload_1
    //   1163: invokevirtual 769	axby:a	(Ltencent/im/oidb/cmd0x8dd/oidb_0x8dd$SelfInfo;)V
    //   1166: aconst_null
    //   1167: areturn
    //   1168: astore_1
    //   1169: aload_1
    ...
    //   1174: areturn
    //   1175: aload_0
    //   1176: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1179: ifnonnull +19 -> 1198
    //   1182: aload_0
    //   1183: aload_0
    //   1184: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1187: bipush 59
    //   1189: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1192: checkcast 773	anjh
    //   1195: putfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1198: aload_0
    //   1199: new 775	axdp
    //   1202: dup
    //   1203: aload_0
    //   1204: invokespecial 776	axdp:<init>	(Laxdm;)V
    //   1207: putfield 778	axdm:jdField_a_of_type_Anjl	Lanjl;
    //   1210: aload_0
    //   1211: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1214: aload_0
    //   1215: invokevirtual 781	anjh:a	(Ljava/lang/Object;)V
    //   1218: aload_0
    //   1219: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1222: aload_0
    //   1223: getfield 778	axdm:jdField_a_of_type_Anjl	Lanjl;
    //   1226: invokevirtual 783	anjh:c	(Ljava/lang/Object;)V
    //   1229: aconst_null
    //   1230: areturn
    //   1231: aload_3
    //   1232: ifnull -932 -> 300
    ...
    //   1247: astore_1
    //   1248: aload_0
    //   1249: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1252: ifnull +25 -> 1277
    //   1255: iconst_1
    ...
    //   1260: iconst_0
    //   1261: aload_0
    //   1262: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1265: aload_1
    //   1266: ldc_w 785
    //   1269: invokevirtual 789	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1272: invokevirtual 792	anjh:a	([Ljava/lang/String;)[Ljava/lang/String;
    //   1275: aastore
    //   1276: areturn
    //   1277: aload_0
    //   1278: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1281: ifnull -981 -> 300
    //   1284: aload_0
    //   1285: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1288: aload_0
    //   1289: invokevirtual 794	anjh:b	(Ljava/lang/Object;)V
    //   1292: aload_0
    //   1293: getfield 778	axdm:jdField_a_of_type_Anjl	Lanjl;
    //   1296: ifnull -996 -> 300
    //   1299: aload_0
    //   1300: getfield 771	axdm:jdField_a_of_type_Anjh	Lanjh;
    //   1303: aload_0
    //   1304: getfield 778	axdm:jdField_a_of_type_Anjl	Lanjl;
    //   1307: invokevirtual 796	anjh:d	(Ljava/lang/Object;)V
    //   1310: aconst_null
    //   1311: areturn
    //   1312: aload_0
    //   1313: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1316: bipush 106
    //   1318: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1321: checkcast 527	axby
    //   1324: iconst_1
    //   1325: putfield 797	axby:a	Z
    //   1328: aconst_null
    //   1329: areturn
    //   1330: aload_3
    ...
    //   1340: aload_0
    //   1341: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1344: sipush 160
    //   1347: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1350: checkcast 799	axzw
    //   1353: aload_3
    //   1354: iconst_0
    //   1355: aaload
    //   1356: checkcast 424	java/lang/Integer
    //   1359: invokevirtual 651	java/lang/Integer:intValue	()I
    //   1362: invokevirtual 802	axzw:a	(I)Lcom/tencent/mobileqq/nearby/redtouch/RedTouchItem;
    //   1365: astore_1
    //   1366: aload_1
    ...
    //   1512: astore_1
    //   1513: aload_0
    //   1514: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1517: sipush 180
    //   1520: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1523: checkcast 303	apul
    //   1526: aload_1
    //   1527: invokevirtual 843	apul:a	([B)V
    ...
    //   1558: astore_1
    //   1559: aload_0
    //   1560: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1563: bipush 106
    //   1565: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1568: checkcast 527	axby
    //   1571: getfield 848	axby:d	Ljava/util/concurrent/ConcurrentHashMap;
    //   1574: aload_1
    //   1575: iconst_1
    ...
    //   1647: dup
    //   1648: aload_0
    //   1649: invokespecial 874	com/tencent/mobileqq/nearby/NearbyProxy$3:<init>	(Laxdm;)V
    ...
    //   1674: aload_0
    //   1675: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1678: bipush 51
    //   1680: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1683: checkcast 879	anmw
    //   1686: astore_1
    //   1687: aload_1
    ...
    //   1712: aload_1
    //   1713: aload_0
    //   1714: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1717: invokevirtual 598	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   1720: invokevirtual 893	anmw:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Card;
    //   1723: astore_1
    //   1724: goto -31 -> 1693
    //   1727: aload_3
    //   1728: iconst_0
    ...
    //   1733: astore_1
    //   1734: aload_0
    //   1735: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1738: bipush 70
    //   1740: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1743: checkcast 895	njg
    //   1746: astore_3
    //   1747: aload_1
    ...
    //   1832: goto -18 -> 1814
    //   1835: aload_3
    //   1836: invokevirtual 901	njg:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1839: astore_1
    //   1840: goto -26 -> 1814
    //   1843: aload_3
    //   1844: invokevirtual 903	njg:b	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1847: astore_1
    //   1848: goto -34 -> 1814
    //   1851: aconst_null
    //   1852: astore_1
    ...
    //   1858: goto -44 -> 1814
    //   1861: aload_3
    //   1862: invokevirtual 905	njg:c	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1865: astore_1
    //   1866: goto -52 -> 1814
    //   1869: aload_3
    //   1870: invokevirtual 906	njg:a	()Z
    //   1873: ifeq +14 -> 1887
    ...
    //   1889: goto -75 -> 1814
    //   1892: aload_3
    //   1893: invokevirtual 910	njg:j	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1896: astore_1
    //   1897: goto -83 -> 1814
    //   1900: aload_3
    //   1901: invokevirtual 912	njg:i	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1904: astore_1
    //   1905: goto -91 -> 1814
    //   1908: aconst_null
    //   1909: astore_1
    //   1910: goto -96 -> 1814
    //   1913: aload_3
    //   1914: invokevirtual 914	njg:e	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1917: astore_1
    //   1918: goto -104 -> 1814
    //   1921: aload_0
    //   1922: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1925: bipush 70
    //   1927: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1930: checkcast 895	njg
    //   1933: invokevirtual 917	njg:a	()Layab;
    //   1936: astore_1
    //   1937: aload_1
    ...
    //   1992: astore_1
    //   1993: aload_0
    //   1994: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1997: bipush 70
    //   1999: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   2002: checkcast 895	njg
    //   2005: aload_1
    //   2006: invokevirtual 651	java/lang/Integer:intValue	()I
    //   2009: invokevirtual 927	njg:b	(I)V
    //   2012: aconst_null
    //   2013: areturn
    //   2014: aload_3
    //   2015: iconst_0
    ...
    //   2026: iconst_0
    //   2027: aload_0
    //   2028: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2031: aload_1
    //   2032: iconst_0
    ...
    //   2040: areturn
    //   2041: aload_0
    //   2042: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2045: bipush 70
    //   2047: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   2050: checkcast 895	njg
    //   2053: astore_1
    //   2054: aload_1
    //   2055: bipush 70
    //   2057: invokevirtual 935	njg:a	(I)Layab;
    //   2060: astore_3
    //   2061: aload_3
    //   2062: aload_1
    //   2063: bipush 70
    //   2065: invokevirtual 937	njg:a	(I)Ljava/lang/String;
    //   2068: putfield 939	ayab:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   2071: aload_3
    ...
    //   2080: iconst_0
    //   2081: aload_3
    //   2082: getfield 920	ayab:jdField_a_of_type_Int	I
    //   2085: invokestatic 427	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   2088: aastore
    //   2089: dup
    //   2090: iconst_1
    //   2091: aload_3
    //   2092: getfield 921	ayab:jdField_b_of_type_Int	I
    //   2095: invokestatic 427	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   2098: aastore
    //   2099: dup
    //   2100: iconst_2
    //   2101: aload_3
    //   2102: getfield 923	ayab:c	I
    //   2105: invokestatic 427	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   2108: aastore
    //   2109: dup
    //   2110: iconst_3
    //   2111: aload_3
    //   2112: getfield 925	ayab:d	I
    //   2115: invokestatic 427	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   2118: aastore
    //   2119: dup
    //   2120: iconst_4
    //   2121: aload_3
    //   2122: getfield 939	ayab:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   2125: aastore
    //   2126: areturn
    //   2127: aload_0
    //   2128: getfield 61	axdm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2131: bipush 70
    //   2133: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   2136: checkcast 895	njg
    //   2139: bipush 70
    //   2141: invokevirtual 941	njg:a	(I)V
    //   2144: aconst_null
    //   2145: areturn
    //   2146: astore_3
    //   2147: goto -1120 -> 1027
    ...
    //   0	2184	0	this	axdm
    //   0	2184	1	paramContext	Context
    //   0	2184	2	paramInt	int
    //   0	2184	3	paramVarArgs	Object[]
    //   1	2179	4	bool1	boolean
    //   633	13	5	bool2	boolean
    //   601	1573	6	localObject	Object
    //   896	69	7	str	String
    // Exception table:
    //   from	to	target	type
    ...
    //   1011	1017	2146	java/lang/Exception
    //   936	954	2150	java/lang/Throwable
    //   954	960	2156	java/lang/Throwable
    //   923	930	2160	java/lang/Throwable
  }
  ...
  public void b()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        axei.a("hasUnreadMsg", new Object[] { Boolean.valueOf(ConnectNearbyProcService.a()) });
      }
      return;
  ...
  public boolean b()
  {
    if (this.jdField_b_of_type_Int == -2147483648) {
      if (!axdz.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
        break label39;
      }
    }
    label39:
