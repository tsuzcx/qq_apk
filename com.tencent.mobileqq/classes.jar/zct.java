...
public class zct
{
  ...
  public zct(TroopStoryMemoriesListAdapter paramTroopStoryMemoriesListAdapter, View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379187));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365419));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371520));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380857));
    ...
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131370126);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131370124);
  }
  
  public void a(TroopStoryItemInfo paramTroopStoryItemInfo, int paramInt)
  {
    Object localObject = zdu.a(paramTroopStoryItemInfo.publishTime);
    if (TextUtils.isEmpty(localObject[0]))
    {
      ...
      {
        this.jdField_d_of_type_AndroidWidgetTextView.setText(anvx.a(2131715152));
        return;
