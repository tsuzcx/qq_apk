...
public class sia
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = sia.class.getSimpleName();
  }
  ...
  public static Bundle a(Intent paramIntent)
  {
    ...
    try
    {
      ...
      localJSONObject3.put("stickySpeed", piv.a());
      localJSONObject3.put("maskLighteness", piv.a());
      localJSONObject3.put("topBarTitle", piv.a());
      ...
      localJSONObject4.put("kandian_mode_new", och.a());
      localJSONObject4.put("kandian_mode", pha.e());
      ...
      localJSONObject1.put("dynamicAladdinConfig", pje.b());
      localJSONObject1.put("xgAladdinConfig", pje.a());
      localJSONObject1.put("protocolExtralParam", paramIntent);
      localJSONObject1.put("autoPlayDisable", bmqa.g());
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    {
      return paramBundle;
      localVideoInfo = ryx.a(paramBundle);
      ryx.a(localVideoInfo);
      paramBundle = localVideoInfo;
  ...
  private static String a()
  {
    try
    {
      String str = ReadInJoyUserInfoModule.a(ReadInJoyUserInfoModule.a(pha.a(), null));
      return str;
    }
  ...
  private static String a(int paramInt)
  {
    ...
    return "https://viola.qq.com/js/VideoFeeds.js?_rij_violaUrl=1&v_tid=15&v_bundleName=VideoFeeds&hideNav=1&v_nav_immer=1&statusColor=1&v_bid=3811&statusBarStyle=1&v_bg_color=000000&v_present_titleHeight=44&v_old_modal=1&_ckey=rij_video_feeds_cache_key";
  }
  ...
  private static JSONObject a()
  {
    ...
    localJSONObject.put("uint32_youngster_status", bmqa.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0)));
    localJSONObject.put("uint32_req_recommend_flag", ocf.a());
    localJSONObject.put("bytes_req_recommend_json", pha.k());
  ...
  private static JSONObject a(Intent paramIntent)
  {
    ...
    if (k == 11)
    {
      ...
      {
        localJSONObject1.put("videoType", piv.a(localVideoInfo.jdField_b_of_type_Int, localVideoInfo.jdField_c_of_type_Int, localVideoInfo.jdField_d_of_type_Int));
  ...
  public static JSONObject a(VideoInfo paramVideoInfo, Intent paramIntent)
  {
    int j = 0;
    JSONObject localJSONObject1 = new JSONObject();
    paramIntent = localJSONObject1.put("article_title", paramVideoInfo.jdField_c_of_type_JavaLangString).put("busiType", paramVideoInfo.jdField_a_of_type_Int).put("first_page_url", a(paramIntent, paramVideoInfo)).put("innerUniqueID", paramVideoInfo.g);
    int i;
    label92:
    ...
    {
      i = 1;
      paramIntent = paramIntent.put("is_ugc", i).put("like_count", paramVideoInfo.jdField_r_of_type_Int);
      if (!paramVideoInfo.jdField_r_of_type_Boolean) {
        break label386;
      }
      i = 1;
      localJSONObject2 = paramIntent.put("myself_like_status", i).put("thirdIcon", paramVideoInfo.jdField_p_of_type_JavaLangString).put("thirdName", paramVideoInfo.jdField_q_of_type_JavaLangString).put("third_uin", paramVideoInfo.j).put("third_uin_name", paramVideoInfo.k);
      if (paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructVideoColumnInfo == null) {
        break label391;
      }
      paramIntent = Integer.valueOf(paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructVideoColumnInfo.jdField_a_of_type_Int);
      label160:
      localJSONObject2 = localJSONObject2.put("topic_id", paramIntent).put("videoInfo_duration", paramVideoInfo.a()).put("videoInfo_fileSize", paramVideoInfo.jdField_b_of_type_Long).put("videoInfo_height", paramVideoInfo.c()).put("videoInfo_vid", paramVideoInfo.jdField_a_of_type_JavaLangString).put("videoInfo_width", paramVideoInfo.b()).put("video_comment_count", paramVideoInfo.e).put("video_json", paramVideoInfo.l).put("video_logo_url", paramVideoInfo.u).put("video_play_count", paramVideoInfo.jdField_q_of_type_Int).put("algorithm_id", paramVideoInfo.f).put("strategy_id", paramVideoInfo.jdField_p_of_type_Int).put("video_report_info", paramVideoInfo.B).put("video_url", paramVideoInfo.jdField_r_of_type_JavaLangString);
    ...
    label391:
    label396:
    for (paramIntent = String.valueOf(paramVideoInfo.jdField_d_of_type_Long);; paramIntent = "")
    {
      localJSONObject2.put("feedsID", paramIntent).put("feedsType", paramVideoInfo.h);
      if (!TextUtils.isEmpty(paramVideoInfo.j)) {
        i = j;
      }
      try
      {
        if (ryx.a(pha.a(), Long.parseLong(paramVideoInfo.j))) {
          i = 1;
        }
  ...
  public static void a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    String str = a(localIntent.getIntExtra("VIDEO_FROM_TYPE", -1));
    paramIntent = str;
    ...
    tlg.a(paramActivity, null, paramIntent, localBundle, true);
  }
  ...
  public static void a(Context paramContext, Intent paramIntent)
  {
    ...
    tlg.a(paramContext, null, paramIntent, localBundle, true);
  }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, Context paramContext)
  {
    ...
    try
    {
      paramContext = ryx.a((Activity)paramContext, paramBaseArticleInfo.mVideoJsonWidth, paramBaseArticleInfo.mVideoJsonHeight);
      ...
      localtdw.jdField_a_of_type_JavaNetURL = paramContext;
      localtdw.jdField_b_of_type_Int = paramBaseArticleInfo.getFirstFrameHeight();
      localtdw.jdField_a_of_type_Int = paramBaseArticleInfo.getFirstFrameWidth();
      localtdw.jdField_b_of_type_Boolean = true;
      tdv.a().a(localtdw, new sib(paramBaseArticleInfo, paramContext));
      return;
    }
