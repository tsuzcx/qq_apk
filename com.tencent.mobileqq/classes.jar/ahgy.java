  ...
  implements View.OnClickListener
{
  ...
  public ahgy(@NonNull Context paramContext)
  {
  ...
  public ahgy a(String paramString, long paramLong1, long paramLong2)
  {
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    try
    {
      ...
      a();
      this.jdField_a_of_type_AndroidOsCountDownTimer = new ahhb(this, l, 1000L);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = View.inflate(getContext(), 2131561575, null);
    setContentView(paramBundle, new ViewGroup.LayoutParams(bbkx.a() - bbkx.b(20.0F), -2));
    setCanceledOnTouchOutside(true);
    findViewById(2131368551).setOnClickListener(this);
    int i = bbkx.a();
    int j = bbkx.a(20.0F);
    Drawable localDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130846438);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131378127));
    ImageView localImageView = (ImageView)findViewById(2131368550);
    RelativeLayout localRelativeLayout = (RelativeLayout)findViewById(2131375349);
    ...
    setOnCancelListener(new ahgz(this));
    PreloadManager.a().a(localDownloadParam, new ahha(this, localDrawable, i - j * 2, localRelativeLayout, localImageView, paramBundle));
  }
