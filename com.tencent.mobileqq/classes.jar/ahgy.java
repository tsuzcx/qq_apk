  ...
  implements bbaa, bbdl, bbdp
{
  ...
  HashSet<ahgz> jdField_a_of_type_JavaUtilHashSet = new HashSet();
  long b;
  long c;
  
  ahgy(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState = null;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Ahha.a = new WeakReference(this);
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState = null;
    ...
    if (this.jdField_a_of_type_Bbck != null) {
      this.jdField_a_of_type_Bbck.a(this.jdField_a_of_type_Ahha);
    }
  }
  ...
  private void b()
  {
    ...
    aevv.a(this.jdField_a_of_type_AndroidContentContext, localIntent, PublicFragmentActivity.class, SignatureHistoryFragment.class);
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_clk_his", 0, 0, "", "", "", "");
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0x8009434", "0x8009434", 0, 0, "", "1", "", "");
  ...
  private void c()
  {
    if (System.currentTimeMillis() - this.b > 2000L)
    {
      ...
      bcst.b(null, "dc00898", "", "", "0X800A4EB", "0X800A4EB", 0, 0, "0", "0", "", "");
    }
  }
  
  protected afuv a()
  {
    ahgz localahgz = new ahgz();
    this.jdField_a_of_type_JavaUtilHashSet.add(localahgz);
    return localahgz;
  }
  ...
  protected View a(MessageRecord paramMessageRecord, afuv paramafuv, View paramView, LinearLayout paramLinearLayout, afzq paramafzq)
  {
    ...
    paramLinearLayout = (ahgz)paramafuv;
    ...
    if (paramView == null)
    {
      ...
      paramafuv = new ViewGroup.MarginLayoutParams(-1, -2);
      int i = afur.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramafuv.leftMargin = i;
      paramafuv.rightMargin = i;
      paramMessageRecord.setLayoutParams(paramafuv);
      paramLinearLayout.a = new bbdf(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.frienduin);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Afxa.a != null) {
      paramLinearLayout.a.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Afxa.a.getDefaultColor();
    }
    paramafuv = this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.ver;
    if ((paramafuv != null) && (paramafuv.equals("1.0"))) {
    ...
    label576:
    label608:
    for (paramafuv = bgsu.a(this.jdField_a_of_type_AndroidContentContext, 3, this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.time * 1000L);; paramafuv = null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d != null)
      {
        ...
        paramView = bdro.a(20, paramView);
        paramafzq = paramView + anni.a(2131712219);
        paramLinearLayout.a.jdField_a_of_type_JavaLangString = paramafzq;
        if (e)
        {
          paramafzq = jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.getPlainText();
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.time > 0L) {
          paramLinearLayout.b.append("于").append(paramafuv);
        }
        paramLinearLayout.b.append("更新了签名，内容是：").append(paramafzq);
  ...
  public void a()
  {
    ...
    {
      ahgz localahgz = (ahgz)((Iterator)localObject).next();
      if (localahgz.a != null) {
        localahgz.a.k();
      }
    }
    if (this.jdField_a_of_type_Bbck != null) {
      this.jdField_a_of_type_Bbck.b(this.jdField_a_of_type_Ahha);
    }
    localObject = (VasQuickUpdateManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(184);
    this.jdField_a_of_type_Bbck = null;
  ...
  public void a(View paramView, int paramInt, bbdk parambbdk)
  {
    ...
    for (;;)
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A98E", "0X800A98E", paramInt, 0, "0", "0", "", "");
      return;
      if (paramInt == 4)
      {
        a(parambbdk);
  ...
  public void a(bbdk parambbdk)
  {
    ...
    if (!TextUtils.isEmpty(jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.feedsId))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, localResources.getString(2131691985), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
    }
    label62:
    int i;
    int j;
    do
    {
      ...
      try
      {
        parambbdk = (bbdf)parambbdk;
        i = parambbdk.d;
        if (parambbdk.f != 0) {
          break;
        }
        parambbdk.f = 1;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_act_on", 0, 0, "", "", "", "");
        i += 1;
        j = 1;
        parambbdk.d = i;
        parambbdk.j();
        ((SignatureHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(41)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, parambbdk.jdField_b_of_type_JavaLangString, 255, j);
        return;
      }
      catch (Exception parambbdk) {}
    } while (!QLog.isColorLevel());
    QLog.i("ChatItemBuilder", 2, parambbdk.getMessage(), parambbdk);
    return;
    parambbdk.f = 0;
    i -= 1;
    if (i > 0) {}
    for (;;)
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_act_off", 0, 0, "", "", "", "");
      j = 0;
      break;
      i = 0;
    }
  ...
  {
    QLog.d("ChatItemBuilder", 1, new Object[] { "onClick topic=", parambbdo });
    parambbdo = parambbdo.a();
    if ((parambbdo instanceof Pair))
    {
      parambbdo = (Pair)parambbdo;
      if (QLog.isColorLevel()) {
        QLog.i("ChatItemBuilder", 2, String.format("aio onTopicClick [%d,%s]", new Object[] { parambbdo.first, parambbdo.second }));
      }
      bbdu.a(this.jdField_a_of_type_AndroidContentContext, bbdu.a(((Integer)parambbdo.first).intValue(), (String)parambbdo.second), -1);
    }
  }
