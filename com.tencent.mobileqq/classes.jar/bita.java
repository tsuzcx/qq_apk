...
public class bita
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bitc();
    jdField_b_of_type_JavaUtilComparator = new bitb();
  ...
  {
    return bgmj.a(a(paramString));
  }
  
  public static String a(byte[] paramArrayOfByte)
  {
    return bgmj.a(a(paramArrayOfByte));
  }
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bgmj.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String d(String paramString)
  {
    ...
    paramString = new bita().b(paramString);
