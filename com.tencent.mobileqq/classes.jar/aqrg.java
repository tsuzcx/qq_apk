      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (aqrf)localField.getAnnotation(aqrf.class);
            if (localObject4 != null) {
              paramClass = ((aqrf)localObject4).a();
            }
  ...
  public static <T> JSONObject a(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (aqrf)((Field)localObject1).getAnnotation(aqrf.class);
        if (localObject2 != null)
        {
          localObject2 = ((aqrf)localObject2).a();
