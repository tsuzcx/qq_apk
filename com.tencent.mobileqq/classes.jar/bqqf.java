...
public class bqqf
  implements bpsi
{
  public bqqf(EditTextPanel paramEditTextPanel) {}
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        localObject = (bqqe)this.a.a.getChildViewHolder((View)localObject);
        if (((bqqe)localObject).a.isContainsResUrl(paramString)) {
          ThreadManager.getUIHandler().post(new EditTextPanel.2.2(this, paramBoolean, (bqqe)localObject, localDynamicTextConfigManager));
        }
        i += 1;
      }
    }
