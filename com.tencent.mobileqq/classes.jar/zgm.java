...
public class zgm
{
  private static final String jdField_a_of_type_JavaLangString = zgm.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131719729);
      localObject2 = BaseApplicationImpl.getContext().getString(2131719730);
      localObject1 = BaseApplicationImpl.getContext().getString(2131719728);
