...
public class amwd
{
  ...
  public amwd()
  {
    this.jdField_a_of_type_Amle = new amwh(this, 0, true, true, 3000L, true, false, "QQARScan");
  }
  ...
  private void a(int paramInt, amxd paramamxd)
  {
    QLog.i("AREngine_ARCloudControl", 1, "requestToCheckLBSLocation.");
    this.jdField_a_of_type_Amxd = paramamxd;
    ...
    this.jdField_a_of_type_ComTencentMobileqqArModelArLBSActivity = amxd.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions, paramamxd);
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new amwi(this), 1, new String[] { "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
  ...
  private void a(amxi paramamxi)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Amvj.a(paramamxi, new amwg(this, l1, paramamxi));
      return;
    }
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Amvj != null)
    {
      ...
      this.jdField_a_of_type_Amvj.a(paramString, paramInt1, paramInt2, new amwe(this));
    }
  }
  
  private void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList)
  {
    if (this.jdField_a_of_type_Amww != null)
    {
      amxi localamxi = new amxi();
      this.jdField_a_of_type_Amww.a(paramArrayOfByte, paramArrayList, new amwf(this, localamxi), this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    long l1;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Amwk != null))
    {
      l1 = System.currentTimeMillis();
      bool1 = this.jdField_a_of_type_Amwk.a(paramArrayOfByte);
      this.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_Amwj.c(bool1);
      QLog.i("AREngine_ARCloudControl", 1, "isSameSceneWithBestImg = " + bool1 + " cost time:" + (System.currentTimeMillis() - l1) + "ms");
    }
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Amwk == null)) {
      return;
    }
    ...
    if (this.jdField_a_of_type_Amwj != null) {
      this.jdField_a_of_type_Amwj.b();
    }
    this.jdField_c_of_type_Long = System.currentTimeMillis();
    boolean bool1 = this.jdField_a_of_type_Amwk.a(paramArrayOfByte, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    ...
    if (this.jdField_a_of_type_Amwj != null)
    {
      boolean bool2 = this.jdField_a_of_type_Amwj.a();
      l1 = this.jdField_a_of_type_Amwj.a();
      if ((bool1) && (!this.jdField_m_of_type_Boolean) && (bool2))
      {
        ...
        i1 = 0;
        bool1 = false;
        this.jdField_a_of_type_Amwj.a(bool1);
      }
    }
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Amwj != null) {
          this.jdField_a_of_type_Amwj.b(true);
        }
        if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Amwj != null))
        {
          l1 = this.jdField_a_of_type_Amwj.b();
          amud.a().a(l1, this.jdField_l_of_type_Long, this.jdField_m_of_type_Long, this.jdField_a_of_type_Amwk.jdField_c_of_type_Int);
          amnq.a().a(l1, this.jdField_m_of_type_Long);
  ...
  public boolean a(amwj paramamwj, AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2, int paramInt3, ARCommonConfigInfo paramARCommonConfigInfo)
  {
    long l2 = System.currentTimeMillis();
    jdField_k_of_type_Boolean = a();
    amzf.a().b(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
    if (!jdField_k_of_type_Boolean) {
      return false;
    }
    this.jdField_a_of_type_Amwk = new amwk(amwk.jdField_b_of_type_Int);
    this.jdField_a_of_type_Amww = new amww();
    this.jdField_a_of_type_Amwk.a(BaseApplicationImpl.getContext().getApplicationContext());
    this.jdField_a_of_type_Amww.a();
    ...
    this.jdField_a_of_type_Amvj = new amvj(paramAppInterface, true);
    this.jdField_a_of_type_Amvj.a();
    ...
    for (long l1 = ARRecognition.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions);; l1 = 0L)
    {
      ...
      amzf.a().c(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
      return true;
    }
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Amww != null)
    {
      this.jdField_a_of_type_Amww.b();
      this.jdField_a_of_type_Amww = null;
    }
    this.jdField_a_of_type_Amwj = null;
