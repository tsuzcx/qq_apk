  ...
  extends blrs
{
  ...
  public blru(FilterDesc paramFilterDesc)
  {
    super(paramFilterDesc);
    this.jdField_a_of_type_Float = -1.0F;
    this.jdField_a_of_type_Blrw = new blrw(this);
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc = paramFilterDesc;
  }
  
  public static int a(Context paramContext, List<FilterDesc> paramList, blsf paramblsf, int paramInt)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    if (paramInt == 0) {
  ...
  public static void a(Context paramContext, List<FilterDesc> paramList)
  {
    ...
    QQFilterRenderManager localQQFilterRenderManager = bkoh.a(bkoh.b);
    if ((localQQFilterRenderManager == null) && (bktb.a() == null))
    {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((bktb.a() == null) || (paramContext == null) || (paramContext.size() <= 0)) {
          break;
        }
  ...
  public static boolean a(blsn paramblsn, int paramInt)
  {
    if (paramblsn != null)
    {
      blsn localblsn = bnhb.a().a[paramInt];
      if ((paramblsn != null) && (localblsn != null) && (paramblsn.b().equals(localblsn.b()))) {}
      for (boolean bool = true;; bool = false)
      {
        if (QLog.isColorLevel()) {
          QLog.d("QCombo", 2, new Object[] { "isApplying :" + paramblsn + " ", Boolean.valueOf(bool) });
        }
        return bool;
      }
    }
  ...
  public static void b(List<FilterDesc> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      new blrv(bool2, bool1, localArrayList, paramBoolean).execute(new Void[0]);
      return;
      if (localFilterDesc.id == 9)
      {
        localArrayList.clear();
  ...
  public int a()
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.getResFold(bnkr.b);
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.resurl)) && (!TextUtils.isEmpty(str)) && (bngx.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc)))
    {
      b(2);
      return 2;
    }
  ...
  public int b()
  {
    ...
    bngx.a().a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, this.jdField_a_of_type_Blrw);
    a();
    return super.b();
  }
