  ...
  extends ajtb
{
  ...
  public lgv(AppInterface paramAppInterface)
  {
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.jdField_a_of_type_Lgu.jdField_a_of_type_Long));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(muc.b());
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Lgq;
    localObject1 = lgq.a(paramArrayOfByte);
    paramArrayOfByte = ((lgr)localObject1).a;
    localObject1 = ((lgr)localObject1).b;
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      lgq locallgq = this.jdField_a_of_type_Lgq;
      localToServiceMsg.putWupBuffer(lgq.a(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
      if (bbfj.g(this.mApp.getApplication().getApplicationContext())) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      paramObject = this.jdField_a_of_type_Lgq;
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          this.jdField_a_of_type_Lgu.jdField_a_of_type_Int = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.e())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_Lgu.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              lgq locallgq = this.jdField_a_of_type_Lgq;
              QLog.d("AudioTransClientInterfaceHandler", 2, lgq.a(paramObject.fixed32_IP.get()));
              ...
              locallgq = this.jdField_a_of_type_Lgq;
              QLog.d("AudioTransClientInterfaceHandler", 2, lgq.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
