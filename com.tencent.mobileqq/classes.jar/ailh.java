  ...
  implements Observer
{
  ...
  amab jdField_a_of_type_Amab = new aill(this);
  ...
  WeakReference<ailo> jdField_a_of_type_JavaLangRefWeakReference;
  public ArrayList<TroopClipPic> a;
  public List<aiiy> a;
  protected int[] a;
  protected String[] a;
  int jdField_b_of_type_Int = -1;
  WeakReference<ailn> jdField_b_of_type_JavaLangRefWeakReference;
  List<ailm> jdField_b_of_type_JavaUtilList = new ArrayList();
  AccountObserver jdField_b_of_type_MqqObserverAccountObserver = new ailk(this);
  int c;
  ...
  public ailh(Context paramContext, Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    e();
    paramContext = (alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
    this.jdField_a_of_type_Bchs = new bchs(this.jdField_a_of_type_JavaLangString, bclm.class, paramContext);
    this.jdField_a_of_type_Bchs.a(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Amab, true);
  }
  
  private aiiy a(long paramLong)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      aiiy localaiiy = (aiiy)localIterator.next();
      if (localaiiy.jdField_a_of_type_Long == paramLong) {
        return localaiiy;
      }
    }
    return null;
  ...
  private void h()
  {
    ...
    label86:
    for (((aiiy)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_d_of_type_Boolean = true;; ((aiiy)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_d_of_type_Boolean = false)
    {
      i += 1;
      break label41;
      break;
  ...
  protected void a(int paramInt)
  {
    ...
    while (localIterator.hasNext()) {
      ((ailm)localIterator.next()).a(paramInt);
    }
  }
  ...
  protected void a(aiiy paramaiiy)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((ailm)localIterator.next()).a(paramaiiy);
    }
  }
  ...
  public void a(aiiy paramaiiy, bcln parambcln)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((ailm)localIterator.next()).a(paramaiiy, parambcln);
    }
  }
  
  public void a(ailm paramailm)
  {
    if (!this.jdField_b_of_type_JavaUtilList.contains(paramailm)) {
      this.jdField_b_of_type_JavaUtilList.add(paramailm);
    }
  }
  
  public void a(ailn paramailn)
  {
    if (paramailn != null) {
      this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramailn);
    }
  }
  
  public void a(ailo paramailo)
  {
    if (paramailo != null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramailo);
    }
  }
  ...
  public void a(TroopClipPic paramTroopClipPic, String paramString1, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Bchs.a(TroopUploadingThread.class, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList, paramString1, paramString2, paramString3, null);
  }
  ...
  public void a(ArrayList<TroopClipPic> paramArrayList, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        aiiy localaiiy = a(localTroopClipPic.ts);
        if ((localaiiy != null) && (!localaiiy.jdField_b_of_type_Boolean))
        {
          localaiiy.jdField_b_of_type_Boolean = true;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null)
      {
        ...
        ailp.a((List)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo);
        Object localObject2 = this.jdField_a_of_type_Bchs.a();
        if (localObject2 != null)
        {
          localObject2 = ((List)localObject2).iterator();
          while (((Iterator)localObject2).hasNext())
          {
            bcls localbcls = (bcls)((Iterator)localObject2).next();
            if ((localbcls != null) && (localbcls.jdField_b_of_type_Int != 1)) {
              ...
              else
              {
                ...
                localaiiy.jdField_b_of_type_JavaLangString = localbcls.jdField_a_of_type_JavaLangString;
                localaiiy.jdField_c_of_type_Int = localbcls.jdField_a_of_type_Int;
                localaiiy.jdField_d_of_type_Int = localbcls.jdField_b_of_type_Int;
                localaiiy.jdField_b_of_type_Int = 2;
                localaiiy.jdField_a_of_type_Boolean = true;
                localaiiy.jdField_a_of_type_Long = localbcls.jdField_a_of_type_Long;
                localaiiy.jdField_d_of_type_JavaLangString = localbcls.jdField_b_of_type_JavaLangString;
                ((List)localObject1).add(localaiiy);
              }
            }
          }
        }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("TroopPhotoController", 2, String.format("update2DB picId=%d info=%s", new Object[] { Integer.valueOf(paramInt), paramaiiy }));
    }
    ...
    {
      localaiiy = (aiiy)((Iterator)localObject).next();
      if (localaiiy != null) {
        str = localaiiy.jdField_c_of_type_JavaLangString;
      }
    }
    label439:
    for (;;)
    {
      try
      {
        ...
        if (localaiiy.jdField_b_of_type_Int == 1)
        {
          TroopClipPic localTroopClipPic = new TroopClipPic();
          localTroopClipPic.id = str;
          localTroopClipPic.clipInfo = localaiiy.jdField_d_of_type_JavaLangString;
          localTroopClipPic.type = localaiiy.jdField_d_of_type_Int;
          localArrayList.add(localTroopClipPic);
      ...
      if (i != 0)
      {
        this.jdField_a_of_type_JavaUtilList.remove(paramaiiy);
        b(paramaiiy);
        return false;
      }
      paramaiiy.jdField_c_of_type_JavaLangString = String.valueOf(paramInt);
      paramaiiy.jdField_b_of_type_Int = 1;
      paramaiiy.jdField_a_of_type_Boolean = false;
      localObject = new TroopClipPic();
      ((TroopClipPic)localObject).id = paramaiiy.jdField_c_of_type_JavaLangString;
      ((TroopClipPic)localObject).type = paramaiiy.jdField_d_of_type_Int;
      ((TroopClipPic)localObject).clipInfo = paramaiiy.jdField_d_of_type_JavaLangString;
      localArrayList.add(localObject);
      if (paramaiiy.jdField_c_of_type_Boolean) {
        localHashSet.add(paramaiiy.jdField_c_of_type_JavaLangString);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        if (paramaiiy != null)
        {
          localObject = paramaiiy.b(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin));
          if ((localObject != null) && (localArrayList.size() > 0))
          {
            ...
            ThreadManager.post(new TroopPhotoController.4(this, paramaiiy, (TroopInfo)localObject), 8, null, false);
          }
        }
      }
      return true;
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      return true;
      paramString1 = (ailo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      break;
    }
  }
  ...
  public void b(aiiy paramaiiy)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((ailm)localIterator.next()).b(paramaiiy);
    }
    if (this.jdField_b_of_type_Int >= this.jdField_a_of_type_JavaUtilList.size())
    {
      h();
  ...
  public void b(boolean paramBoolean)
  {
    ...
    bdfq localbdfq = bdcd.a(localActivity, 230);
    localbdfq.setTitle(null);
    if (paramBoolean) {
      localbdfq.setMessage(localActivity.getResources().getString(2131693548));
    }
    for (;;)
    {
      localbdfq.setPositiveButton(localActivity.getResources().getString(2131693572), new bdco());
      localbdfq.setPositiveButtonContentDescription(localActivity.getResources().getString(2131693572));
      localbdfq.show();
      return;
      localbdfq.setMessage(localActivity.getResources().getString(2131693547));
    }
  }
  ...
  protected boolean b(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopTypeExt == 2) || (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopTypeExt == 3) || (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopTypeExt == 4))
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 2131697683, 1).a();
        return true;
      }
    }
    return false;
  ...
  protected boolean b(String paramString1, String paramString2)
  {
    if (!(this.jdField_a_of_type_AndroidAppActivity instanceof TroopAvatarWallEditActivity))
    {
      ...
      {
        localailn = (ailn)this.jdField_b_of_type_JavaLangRefWeakReference.get();
        if (localailn != null)
        {
  ...
  public void c()
  {
    ...
    if (((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwGroupFlagExt & 0x800) != 0L) || (this.jdField_a_of_type_Int > 0))
    {
      ...
      {
        b(bool);
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_certified", "", "data", "exp_edit_head", 3, 0, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, "", "", "");
        return;
      }
    }
    ...
    if (i < this.jdField_a_of_type_ArrayOfInt.length)
    {
      if (this.jdField_a_of_type_ArrayOfInt[i] == 16) {
        localbhpy.d(this.jdField_a_of_type_ArrayOfJavaLangString[this.jdField_a_of_type_ArrayOfInt[i]]);
      }
      for (;;)
      {
        i += 1;
        ...
        if ((this.jdField_a_of_type_ArrayOfInt[i] >= 0) && (this.jdField_a_of_type_ArrayOfInt[i] < this.jdField_a_of_type_ArrayOfJavaLangString.length)) {
          localbhpy.a(this.jdField_a_of_type_ArrayOfJavaLangString[this.jdField_a_of_type_ArrayOfInt[i]], 1);
        }
      }
    }
    localbhpy.a(new aili(this, localbhpy));
    localbhpy.show();
  }
  
  public void c(int paramInt)
  {
    Object localObject = (aiiy)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    ArrayList localArrayList;
    if (bcgh.b(((aiiy)localObject).jdField_c_of_type_JavaLangString))
    {
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "del_head", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, "", "", "");
      localArrayList = new ArrayList();
      localArrayList.add(Integer.valueOf(((aiiy)localObject).jdField_c_of_type_JavaLangString));
      this.jdField_a_of_type_Bchs.a(this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, 2, localArrayList);
    }
    this.jdField_a_of_type_JavaUtilList.remove(localObject);
    b((aiiy)localObject);
    if ((((aiiy)localObject).jdField_b_of_type_Int == 1) && (!TextUtils.isEmpty(((aiiy)localObject).jdField_c_of_type_JavaLangString)) && (bcgh.b(((aiiy)localObject).jdField_c_of_type_JavaLangString)))
    {
      localArrayList = new ArrayList();
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if (((aiiy)localObject).jdField_c_of_type_JavaLangString.equals(localTroopClipPic.id))
          {
            ...
            if (paramInt != 0)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.mTroopVerifyingPics.remove(((aiiy)localObject).jdField_c_of_type_JavaLangString);
            }
          }
        }
      }
  ...
  public void c(aiiy paramaiiy)
  {
    ...
    {
      paramaiiy.jdField_c_of_type_Boolean = true;
      ...
      {
        bdcd.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, this.jdField_a_of_type_AndroidAppActivity.getString(2131696556), null, this.jdField_a_of_type_AndroidAppActivity.getString(2131696546), new bdco(), null).show();
  ...
  public void d()
  {
    if (jdField_a_of_type_AndroidNetUri != null)
    {
      ...
      localObject = bdda.b(this.jdField_a_of_type_AndroidAppActivity, (Uri)localObject);
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        ailp.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject, ailp.d(this.jdField_c_of_type_Int));
      }
    }
  }
  ...
  public void d(int paramInt)
  {
    ...
    a(ailp.a(BaseApplicationImpl.getContext(), -1));
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      aiiy localaiiy = (aiiy)localIterator.next();
      if ((localaiiy.jdField_b_of_type_Int == 2) || (localaiiy.jdField_a_of_type_Boolean))
      {
  ...
  public void f()
  {
    this.jdField_a_of_type_Bchs.b(this);
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "upload_head_cancel", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, String.valueOf(paramObservable.jdField_b_of_type_Int), "", "");
    if (TextUtils.isEmpty(paramObservable.jdField_a_of_type_JavaLangString)) {}
    for (paramObservable = ailp.a(this.jdField_a_of_type_AndroidAppActivity, paramObservable.jdField_b_of_type_Int);; paramObservable = paramObservable.jdField_a_of_type_JavaLangString)
    {
      if (QLog.isColorLevel()) {
