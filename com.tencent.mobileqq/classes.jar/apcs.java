...
{
  apcs(WeakReference paramWeakReference, Activity paramActivity) {}
  ...
  public void a(String paramString)
  {
    ...
    if ((localActivity != null) && (paramString != null) && (paramString.startsWith("http")))
    {
      if (aome.a().a() == null)
      {
        ...
        paramString.putString("_filename_from_dlg", this.jdField_a_of_type_AndroidAppActivity.getString(2131629108));
    ...
    apck.c(localActivity, "http://appchannel.html5.qq.com/directdown?app=qqbrowser&channel=10386");
  }
}
