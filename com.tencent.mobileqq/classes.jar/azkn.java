  ...
  extends azjt
{
  ...
  public int a()
  {
    ...
    if (this.jdField_g_of_type_JavaLangString != null)
    {
      ...
      azjq.b("PIC_TAG_ERROR", "PicUploadInfo.getProtocolType", "localPath == null");
    }
  ...
  public boolean a()
  {
    ...
    if (this.i)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.rawMd5)) || (!FileUtils.fileExistsAndNotEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.thumbPath)))
      {
    ...
    Object localObject = akpu.a(this.jdField_g_of_type_JavaLangString);
    if (localObject != null)
    {
      if (this.jdField_g_of_type_Int == 1)
      {
        localObject = ((akpu)localObject).a();
        if (localObject != null) {
  ...
  String b()
  {
    ...
    {
      azjq.b("PIC_TAG_ERROR", "PicUploadInfo.getUrlString", "protocol == null");
      return null;
    }
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Azkm != null) && (this.jdField_a_of_type_Azkm.a);
  }
  
  public boolean d()
  {
    return (this.jdField_a_of_type_Azkm != null) && (this.jdField_a_of_type_Azkm.jdField_b_of_type_Boolean);
  }
  
  public boolean e()
  {
    return (this.jdField_a_of_type_Azkm != null) && (this.jdField_a_of_type_Azkm.c);
  }
