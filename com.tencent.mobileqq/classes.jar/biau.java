  ...
  extends ReportDialog
{
  ...
  public biau(Context paramContext)
  {
    this(paramContext, 0);
  }
  
  public biau(Context paramContext, int paramInt)
  {
    this(paramContext, paramInt, 2131561459, 48);
  }
  
  public biau(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363520));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371343));
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt3;
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378771));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378772));
  ...
  {
    this.jdField_a_of_type_Biaw = parambiaw;
  }
  ...
  {
    setOnKeyListener(new biav(this, paramBoolean));
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 159	adbo:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 159	adbo:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 159	adbo:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
  ...
  {
    super.onBackPressed();
    if (this.jdField_a_of_type_Biaw != null) {
      this.jdField_a_of_type_Biaw.a();
    }
  }
