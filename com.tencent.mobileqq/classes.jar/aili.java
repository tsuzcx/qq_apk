  ...
  implements ailp
{
  ...
  public aili(QQAppInterface paramQQAppInterface, ailr paramailr, Context paramContext, Intent paramIntent)
  {
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558668, null);
    paramVarArgs.setOnClickListener(new ailj(this));
    ((TextView)paramVarArgs.findViewById(2131362545)).setText(this.jdField_a_of_type_JavaLangString);
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_JavaLangString = String.format(anvx.a(2131712162), new Object[] { str });
