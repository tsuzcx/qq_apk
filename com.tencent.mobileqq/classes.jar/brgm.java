  ...
  extends GPUBaseFilter
{
  ...
  private brgd jdField_a_of_type_Brgd;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Brgd != null) || (this.b != null);
  }
  
  public void destroy()
  {
    if (this.jdField_a_of_type_Brgd != null) {
      this.jdField_a_of_type_Brgd.destroy();
    }
    if (this.b != null) {
      this.b.destroy();
    }
  ...
  public void drawTexture(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    if (!a())
    {
      yuk.e("Q.qqstory.publish.edit GpuImagePartsFilterGroup", "must set filters before draw texture");
      return;
    }
    if (this.jdField_a_of_type_Brgd != null) {
      this.jdField_a_of_type_Brgd.drawTexture(paramInt, paramArrayOfFloat1, paramArrayOfFloat2);
    }
  ...
  public void init()
  {
    if ((this.jdField_a_of_type_Brgd != null) && (!this.jdField_a_of_type_Brgd.isInitialized())) {
      this.jdField_a_of_type_Brgd.init();
    }
  ...
  {
    if (this.jdField_a_of_type_Brgd != null) {
      this.jdField_a_of_type_Brgd.onOutputSizeChanged(paramInt1, paramInt2);
    }
    if (this.b != null) {
