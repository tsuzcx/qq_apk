  ...
  extends aigo
{
  ...
  public aigj(MessageForSystemMsg paramMessageForSystemMsg)
  {
  ...
  public aigj(String paramString, long paramLong)
  {
  ...
  {
    if ((paramContext == null) || (paramStructMsg == null)) {}
    label205:
    for (;;)
    {
      return null;
      ...
      if (!TextUtils.isEmpty(paramStructMsg.msg.msg_additional.get())) {
        ...
        {
          str = paramStructMsg.msg.msg_qna.get();
          paramStructMsg = str;
          if (bool)
          {
            paramStructMsg = str;
            if (!TextUtils.isEmpty(str)) {
              paramStructMsg = paramContext.getString(2131693111) + paramContext.getString(2131693110) + str;
            }
          }
        }
      }
      for (;;)
      {
        ...
        return paramStructMsg.trim();
        str = paramStructMsg.msg.msg_additional.get();
        break;
        str = paramStructMsg.msg.msg_describe.get();
        paramStructMsg = str;
        if (bool)
        {
          paramStructMsg = str;
          if (!TextUtils.isEmpty(str)) {
            paramStructMsg = paramContext.getString(2131693109) + paramContext.getString(2131693110) + str;
          }
        }
      }
    }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqSystemmsgMessageForSystemMsg != null) {
      return a(paramContext, this.jdField_a_of_type_ComTencentMobileqqSystemmsgMessageForSystemMsg.structMsg);
    }
    return null;
  }
