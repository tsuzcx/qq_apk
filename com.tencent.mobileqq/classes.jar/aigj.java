...
public class aigj
  extends aimb
{
  public aigj(TroopMemberListInnerFrame paramTroopMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562408, paramViewGroup, false);
      paramView = new aigk(this.a, null);
      localView.setTag(paramView);
      paramView.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131375396));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378220));
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131364193));
      paramView.c = ((ImageView)localView.findViewById(2131367679));
      paramView.b = ((TextView)localView.findViewById(2131370647));
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131378329);
    }
    paramViewGroup = (aigk)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localTroopMemberInfo.memberuin))
      {
        ...
        str = bbcl.h(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTroopMemberInfo.troopuin, localTroopMemberInfo.memberuin);
        ...
        {
          if (!bahx.b(this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app, localTroopMemberInfo.memberuin)) {
            break label737;
          }
        ...
        localView.setContentDescription(str + ajyc.a(2131715546));
      }
      for (;;)
      {
        ...
        break label430;
        label707:
        paramViewGroup.b.setText(bbcl.h(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTroopMemberInfo.troopuin, localTroopMemberInfo.memberuin));
        break label438;
        label737:
        ...
        break label525;
        label760:
        localView.setContentDescription(str + ajyc.a(2131715570));
        continue;
        label792:
        if ((this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.d == 14) && (!paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled())) {
          localView.setContentDescription(str + ajyc.a(2131715559));
        }
      }
    }
