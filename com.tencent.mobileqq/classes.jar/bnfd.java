...
public class bnfd
{
  ...
  public bnfd()
  {
    this.jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(bnff.class, 4);
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_MqqUtilAbstractUnifiedMonitor$ThreadMonitorCallback = new bnfe(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    //   26: ifeq -11 -> 15
    //   29: aload_0
    //   30: getfield 89	bnfd:jdField_a_of_type_Boolean	Z
    //   33: ifeq -18 -> 15
    //   36: aload_0
    //   37: getfield 65	bnfd:jdField_a_of_type_Bnff	Lbnff;
    //   40: ifnull +17 -> 57
    //   43: aload_0
    //   44: getfield 65	bnfd:jdField_a_of_type_Bnff	Lbnff;
    //   47: getfield 92	bnff:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   50: aload_1
    //   51: invokevirtual 98	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   54: ifne -39 -> 15
    //   57: aload_0
    //   58: aload_0
    //   59: getfield 31	bnfd:jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool	Lcom/tencent/commonsdk/pool/RecyclablePool;
    //   62: ldc 26
    ...
    //   67: checkcast 26	bnff
    //   70: putfield 65	bnfd:jdField_a_of_type_Bnff	Lbnff;
    //   73: aload_0
    //   74: getfield 65	bnfd:jdField_a_of_type_Bnff	Lbnff;
    //   77: aload_1
    //   78: putfield 92	bnff:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   81: aload_0
    //   82: getfield 63	bnfd:d	Z
    //   85: ifne +32 -> 117
    //   88: aload_0
    //   89: getfield 33	bnfd:jdField_b_of_type_Boolean	Z
    //   92: ifeq +25 -> 117
    //   95: aload_0
    //   96: getfield 67	bnfd:jdField_a_of_type_AndroidViewChoreographer	Landroid/view/Choreographer;
    //   99: aload_0
    //   100: getfield 69	bnfd:jdField_a_of_type_AndroidViewChoreographer$FrameCallback	Landroid/view/Choreographer$FrameCallback;
    //   103: invokevirtual 75	android/view/Choreographer:removeFrameCallback	(Landroid/view/Choreographer$FrameCallback;)V
    //   106: aload_0
    //   107: getfield 67	bnfd:jdField_a_of_type_AndroidViewChoreographer	Landroid/view/Choreographer;
    //   110: aload_0
    //   111: getfield 69	bnfd:jdField_a_of_type_AndroidViewChoreographer$FrameCallback	Landroid/view/Choreographer$FrameCallback;
    //   114: invokevirtual 105	android/view/Choreographer:postFrameCallback	(Landroid/view/Choreographer$FrameCallback;)V
    //   117: aload_0
    //   118: iconst_1
    //   119: putfield 79	bnfd:jdField_c_of_type_Boolean	Z
    //   122: goto -107 -> 15
    //   125: astore_1
    //   126: aload_0
    //   127: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Bnff != null)
        {
          if (!paramBoolean)
          {
            l1 = a(this.jdField_a_of_type_Bnff.jdField_c_of_type_Long - this.jdField_a_of_type_Bnff.jdField_b_of_type_Long);
            if ((this.jdField_a_of_type_Bnff.jdField_a_of_type_Long > 0L) && (l1 > a()))
            {
              long l2 = (this.jdField_a_of_type_Bnff.jdField_c_of_type_Long - this.jdField_a_of_type_Bnff.jdField_b_of_type_Long) / this.jdField_b_of_type_Long;
