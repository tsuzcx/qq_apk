...
public class annd
{
  ...
  private static void a(anne paramanne)
  {
    if (paramanne == null) {}
    do
    {
      ...
      {
        return;
        paramanne = paramanne.toString();
        if (QLog.isColorLevel()) {
          QLog.d("ArkApp.ArkSecurityReporter", 2, new Object[] { "ArkSafe.report reportRealTime content=", paramanne });
        }
    ...
    ((anit)localObject).a(paramanne);
    return;
    Object localObject = new Bundle();
    ((Bundle)localObject).putString("reportContent", paramanne);
    anmg.a().a("callReportUrlCheck", (Bundle)localObject, null);
  }
  ...
  public static void a(String paramString)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      if (localInteger != null)
      {
        ...
        azmj.b(null, "dc00898", "", "", "0X8009BCF", "0X8009BCF", 0, localInteger.intValue(), 0, b(), "", paramString, "");
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localInteger != null)
        {
          ...
          azmj.b(null, "dc00898", "", "", "0X8009BD0", "0X8009BD0", 0, localInteger.intValue(), 0, b(), "1", paramString, "");
  ...
  public static void a(String paramString1, String arg1, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    azmj.a(null, "dc00898", "", paramString3, "0X8009BCF", "0X8009BCF", paramInt1, paramInt2, b(), "0", paramString1, ???);
    paramString3 = new anne();
  ...
  public static void b(String paramString1, String arg1, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    azmj.a(null, "dc00898", "", paramString3, "0X8009BD0", "0X8009BD0", paramInt1, paramInt2, b(), "1", paramString1, ???);
    paramString3 = new anne();
    paramString3.jdField_b_of_type_JavaLangString = paramString1;
    paramString3.jdField_c_of_type_JavaLangString = ???;
  ...
  public static void c(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      azmj.a(null, "dc00898", "", "", "0X8009BD0", "0X8009BD0", 0, 0, b(), "2", paramString1, "");
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    azmj.a(null, "dc00898", "", paramString3, "0X8009BD0", "0X8009BD0", paramInt1, paramInt2, b(), "2", paramString1, paramString2);
    paramString3 = new anne();
    paramString3.jdField_b_of_type_JavaLangString = paramString1;
