...
public class vcp
  extends wcr<oidb_0x791.RedDotInfo>
  implements View.OnClickListener
{
  ...
  public vcp(Context paramContext)
  {
    super(paramContext);
  }
  ...
  public View a(int paramInt, vas paramvas, ViewGroup paramViewGroup)
  {
    ...
    {
      paramvas.a(2131377315).setVisibility(8);
      paramvas.a().setLayoutParams(new AbsListView.LayoutParams(-1, 0));
      return paramvas.a();
    }
    paramInt = vzo.a(paramvas.a().getContext(), 52.0F);
    paramvas.a(2131377315).setVisibility(0);
    paramvas.a().setLayoutParams(new AbsListView.LayoutParams(-1, paramInt));
    paramvas.a().setVisibility(0);
    ImageView localImageView = (ImageView)paramvas.a(2131367679);
    ...
    for (;;)
    {
      ...
      localImageView.setImageDrawable(localDrawable);
      TextView localTextView = (TextView)paramvas.a(2131364692);
      StringBuilder localStringBuilder = new StringBuilder();
      if (this.jdField_a_of_type_Int > 99) {}
      for (paramViewGroup = "99+";; paramViewGroup = Integer.valueOf(this.jdField_a_of_type_Int))
      {
        localTextView.setText(paramViewGroup + ajyc.a(2131706639));
  ...
  {
    paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561300, paramViewGroup, false);
    paramViewGroup.findViewById(2131377315).setOnClickListener(this);
  ...
  public void a(ImageView paramImageView)
  {
    ...
    QQStoryContext.a();
    mxi.a(QQStoryContext.a(), new vcq(this, paramImageView), localReqStoryMessageList.toByteArray(), sxp.a("StorySvc.get_710_message_list"));
  }
  ...
  protected void c()
  {
    ...
    {
      a(((mxx)localQQAppInterface.getManager(70)).a(52));
      return;
    }
    veg.e("Q.qqstory.home.MessageNotifySegment", "Get the QQAppInterface is null,we dont know the red point state");
  }
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = ((tdo)tdc.a(2)).b(QQStoryContext.a().b());
    ...
    for (int i = 1;; i = 2)
    {
      vel.a("play_video", "clk_grey", i, 0, new String[] { "", "", "", "" });
      return;
      i = 0;
      break;
    }
