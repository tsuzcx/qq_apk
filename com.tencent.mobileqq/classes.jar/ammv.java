  ...
  extends ammq
{
  ...
  public ammv(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(amux paramamux, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    if (this.jdField_b_of_type_Int > 0)
    {
      if (ApolloUtil.c(5, this.jdField_b_of_type_Int))
      {
        ...
        amuo.a(paramamux, 6, paramContext);
        this.d = true;
      ...
      super.a(paramamux, paramInt, paramAppInterface, paramContext);
  ...
  {
    paramamux = new Intent();
    paramamux.putExtra("extra_key_url_append", "&tab=interactive&suin=" + paramQQAppInterface.getCurrentAccountUin());
    ApolloUtil.a(paramContext, paramamux, "drawer", ancb.ai, null);
  ...
  public void a(amux paramamux, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    amuo.a(paramamux, this.jdField_a_of_type_JavaLangString, 7, 0);
