...
public class bant
  extends BaseAdapter
  implements alys, URLDrawableDownListener
{
  ...
  public bant(Context paramContext, Gallery paramGallery)
  {
    ...
    paramContext = (alyz)((AppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(180);
    if (paramContext == null) {}
    this.jdField_a_of_type_Alyq = paramContext.a();
  ...
  public Drawable a(String paramString)
  {
    ...
    localURLDrawableOptions.mFailedDrawable = aywk.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
    localURLDrawableOptions.mLoadingDrawable = aywk.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Alyq != null) {
      this.jdField_a_of_type_Alyq.b(this);
    }
  }
  ...
  protected void a(int paramInt, MediaPreviewInfo paramMediaPreviewInfo, banv parambanv)
  {
    long l = System.currentTimeMillis();
    if ((parambanv == null) || (paramMediaPreviewInfo == null)) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i("MediaPreviewAdapter", 2, "loadVideo() mediaInfo = " + paramMediaPreviewInfo);
    }
    parambanv.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    File localFile;
    boolean bool2;
    if (!TextUtils.isEmpty(paramMediaPreviewInfo.c))
    {
      ...
      if (bool2) {
        a(paramInt, parambanv.jdField_a_of_type_ComTencentImageURLImageView, localFile, paramMediaPreviewInfo.jdField_a_of_type_JavaLangString);
      }
      bool1 = bool2;
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          bool1 = alyq.b(paramMediaPreviewInfo.b);
          if (bool1)
          {
            localFile = alyq.a(paramMediaPreviewInfo.b);
            a(paramInt, parambanv.jdField_a_of_type_ComTencentImageURLImageView, localFile, paramMediaPreviewInfo.jdField_a_of_type_JavaLangString);
          }
          bool2 = bool1;
          if (QLog.isColorLevel())
      ...
      if (!bool2)
      {
        ...
        parambanv.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(a(paramMediaPreviewInfo.jdField_a_of_type_JavaLangString));
        if (bbev.a(this.jdField_a_of_type_AndroidContentContext)) {
          break label401;
        }
        parambanv.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        parambanv.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new banu(this, parambanv, paramMediaPreviewInfo));
      }
      while (QLog.isColorLevel())
      {
        ...
        label401:
        parambanv.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        b(paramMediaPreviewInfo, parambanv);
        continue;
        label419:
        parambanv.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        if (QLog.isColorLevel()) {
  ...
  public void a(MediaPreviewInfo paramMediaPreviewInfo, banv parambanv)
  {
    if ((parambanv == null) || (paramMediaPreviewInfo == null)) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (paramMediaPreviewInfo = new File(paramMediaPreviewInfo).toURL();; paramMediaPreviewInfo = new URL(paramMediaPreviewInfo))
        {
          ...
          a(parambanv.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle);
          parambanv.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
          paramMediaPreviewInfo = URLDrawable.getDrawable(paramMediaPreviewInfo, (URLDrawable.URLDrawableOptions)localObject);
          parambanv.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramMediaPreviewInfo);
          parambanv.jdField_a_of_type_ComTencentImageURLImageView.setTag(parambanv);
          parambanv.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(this);
          return;
        }
        if (!QLog.isColorLevel()) {}
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if ((localMediaPreviewInfo != null) && (paramString.equals(localMediaPreviewInfo.b)) && ((localObject instanceof banv)))
    {
      a(((banv)localObject).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, paramInt);
      if (QLog.isColorLevel()) {
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((localMediaPreviewInfo != null) && (paramString.equals(localMediaPreviewInfo.b)) && ((localObject instanceof banv)))
    {
      localObject = (banv)localObject;
      boolean bool = false;
      paramBoolean2 = bool;
      if (paramBoolean1)
      {
        paramBoolean2 = bool;
        if (alyq.b(localMediaPreviewInfo.b))
        {
          File localFile = alyq.a(localMediaPreviewInfo.b);
          ((banv)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.3(this, (banv)localObject, i, localFile, localMediaPreviewInfo));
          paramBoolean2 = true;
        }
      }
      if (!paramBoolean2)
      {
        ...
        ((banv)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.4(this, (banv)localObject));
      }
    }
  }
  ...
  protected void b(MediaPreviewInfo paramMediaPreviewInfo, banv parambanv)
  {
    long l = System.currentTimeMillis();
    if (this.jdField_a_of_type_Alyq != null) {
      this.jdField_a_of_type_Alyq.a(paramMediaPreviewInfo.b);
    }
    a(parambanv.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, 0);
    if (QLog.isColorLevel()) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376433));
    ...
    {
      return paramView;
      paramViewGroup = (banv)paramView.getTag();
      break;
    }
  ...
  {
    a(((banv)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, paramInt);
  }
  
  public void onLoadSuccessed(View paramView, URLDrawable paramURLDrawable)
  {
    paramView = (banv)paramView.getTag();
