...
public class akcy
{
  ...
  public akcy(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public static String a(CharSequence paramCharSequence)
  {
    ...
    if (i < paramCharSequence.length())
    {
      ...
      {
        j = i;
        if (paramCharSequence.charAt(i + 1) < EmotcationConstants.VALID_SYS_EMOTCATION_COUNT)
        {
  ...
  {
    return bhid.a(1000L * paramLong, true, "yyyy-MM-dd");
  }
