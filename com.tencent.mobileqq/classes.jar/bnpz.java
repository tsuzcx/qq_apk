...
public class bnpz
  ...
  implements bine
{
  public static final WebAccelerateHelper.CommonJsPluginFactory QZONE_SHOW_COMMON_JS = new bnqa();
  protected Intent mIntent;
  private boolean mIsSmallWebview = true;
  protected int mWebViewResId;
  private bnqb mWebviewStatusListener;
  
  public bnpz(Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface, boolean paramBoolean)
  {
  ...
  public void setWebviewStatusListener(bnqb parambnqb)
  {
    this.mWebviewStatusListener = parambnqb;
  }
