...
public class bgjx
{
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    bgbz.a().a().a(paramString1, paramString2);
    return true;
  }
  ...
  protected static boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   24: dup
    //   25: aload_1
    //   26: invokespecial 71	java/io/File:<init>	(Ljava/lang/String;)V
    //   29: astore_1
    //   30: aload 6
    //   32: astore 4
    //   34: aload_1
    ...
    //   43: astore 4
    //   45: aload_1
    //   46: invokevirtual 220	java/io/File:createNewFile	()Z
    //   49: pop
    //   50: aload 6
    //   52: astore 4
    //   54: new 222	java/io/FileOutputStream
    //   57: dup
    //   58: aload_1
    //   59: invokespecial 225	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   62: astore_1
    //   63: aload_1
    //   64: aload_0
    //   65: invokevirtual 229	java/io/FileOutputStream:write	([B)V
    //   68: iload_3
    //   69: istore_2
    //   70: aload_1
    //   71: ifnull +9 -> 80
    //   74: aload_1
    //   75: invokevirtual 232	java/io/FileOutputStream:close	()V
    //   78: iload_3
    //   79: istore_2
    //   80: iload_2
    //   81: ireturn
    ...
    //   98: aload_0
    //   99: invokevirtual 237	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   102: invokevirtual 70	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   105: invokestatic 144	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   108: iload_3
    //   109: istore_2
    //   110: goto -30 -> 80
    //   113: astore_1
    ...
    //   120: ldc 112
    //   122: iconst_1
    //   123: new 40	java/lang/StringBuilder
    //   126: dup
    ...
    //   135: aload_1
    //   136: invokevirtual 237	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   146: ifnull +102 -> 248
    //   149: aload_0
    //   150: invokevirtual 232	java/io/FileOutputStream:close	()V
    //   153: iconst_0
    //   154: istore_2
    //   155: goto -75 -> 80
    //   158: astore_0
    ...
    //   165: dup
    //   166: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   169: ldc 234
    //   171: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   174: aload_0
    //   175: invokevirtual 237	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   178: invokevirtual 70	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   181: invokestatic 144	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   184: iconst_0
    //   185: istore_2
    //   186: goto -106 -> 80
    //   189: astore_0
    ...
    //   192: ifnull +8 -> 200
    //   195: aload 4
    //   197: invokevirtual 232	java/io/FileOutputStream:close	()V
    //   200: aload_0
    //   201: athrow
    //   202: astore_1
    //   203: ldc 112
    //   205: iconst_1
    //   206: new 40	java/lang/StringBuilder
    //   209: dup
    //   210: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   213: ldc 234
    //   215: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   218: aload_1
    //   219: invokevirtual 237	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   222: invokevirtual 70	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   225: invokestatic 144	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   228: goto -28 -> 200
    //   231: astore_0
    //   232: aload_1
    //   233: astore 4
