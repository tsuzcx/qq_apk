  ...
  implements Handler.Callback
{
  ...
  public bhqg(Activity paramActivity)
  {
  ...
  private static Pair<Integer, Integer> a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramString.isHierarchical())
      {
        ...
        if ((!TextUtils.isEmpty(paramString)) && (nhe.a().l(paramString)))
        {
          ...
          if (!paramString.contains("cmshow")) {
            i = m - (int)mue.a(BaseApplicationImpl.getApplication(), 54.0F);
          }
        }
      }
    }
  ...
  private String a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a.size() > 1))
    {
      ...
      {
        localObject = (blby)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(213);
        ArrayList localArrayList = new ArrayList();
        localArrayList.add("1113.100803");
        this.jdField_a_of_type_JavaUtilMap = ((blby)localObject).a(localArrayList);
      }
      if (this.jdField_a_of_type_JavaUtilMap == null) {
        break label244;
      }
  ...
  public static void a(WebView paramWebView, String paramString1, String paramString2)
  {
    ...
    for (localObject = "";; localObject = bhrr.a(paramString2))
    {
  ...
  private void c()
  {
    ...
    {
      String str = a();
      if ((!TextUtils.isEmpty(str)) && (bhre.a(str)) && (!str.contains("asyncMode=3")) && (!str.contains("sonic=1"))) {
  ...
  public Object a(String paramString, Bundle paramBundle)
  {
    ...
    paramString = bivr.a().a(paramBundle);
    if (paramString != null)
    {
      paramString = paramString.d;
      Bundle localBundle = new Bundle();
      localBundle.putString(bivp.b, paramBundle);
      localBundle.putString(bivp.j, paramString);
      localBundle.putInt(bivp.k, 2);
      localBundle.putString(bivp.l, str);
      localBundle.putBoolean(bivp.r, false);
      localBundle.putBoolean(bivp.x, false);
      localBundle.putString(bivp.m, "_" + paramBundle);
      bivl.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localBundle, "biz_src_yyb", null, 0);
      return paramBundle;
    }
    ...
    if ("cancelDownloadTask".equals(paramString))
    {
      ...
      if (!bivl.a(paramString)) {
        return Boolean.valueOf(false);
      }
      bivl.a(paramString, "_" + paramString, true);
    ...
    {
      paramString = paramBundle.getString("download_id");
      paramBundle = bivr.a().a(paramString);
      if ((paramBundle == null) || (paramBundle.a() != 4)) {
        return Boolean.valueOf(false);
      }
      paramBundle = new Bundle();
      paramBundle.putString(bivp.b, paramString);
      paramBundle.putInt(bivp.k, 5);
      paramBundle.putBoolean(bivp.r, false);
      paramBundle.putBoolean(bivp.x, false);
      bivl.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, paramBundle, "biz_src_yyb", null, 0);
      return Boolean.valueOf(true);
    }
    if ("notifyQBiconShine".equals(paramString))
    {
      paramString = (bhql)this.jdField_a_of_type_Bhov.a().a(2);
      if (paramString != null)
      {
        paramString.jdField_a_of_type_Bhqo.z = true;
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.browserApp != null) && (i != 0)) {
        if ("CN".equals(Locale.getDefault().getCountry())) {
          if (TbsDownloader.needDownload(BaseApplication.getContext(), false, false, new bhqh(this)))
          {
            if (QLog.isColorLevel()) {
            ...
            i = 1;
            label160:
            if (this.jdField_a_of_type_Bhov == null) {
              break label445;
            }
          }
        }
      ...
      label438:
      label445:
      for (localObject1 = (bhqc)this.jdField_a_of_type_Bhov.a().a(-2);; localObject1 = null)
      {
        if (((localObject1 == null) || (!((bhqc)localObject1).i)) && (!QLog.isColorLevel())) {
          break label448;
        }
        ...
        {
          if ((localObject1 == null) || (!((bhqc)localObject1).i)) {
            break;
          }
        ...
        for (;;)
        {
          bcst.b(null, "P_CliOper", "BizTechReport", "", "web", (String)localObject1, 0, 1, j, "", "", "", "");
          return;
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (avqz)paramBundle.getPluginEngine().a("x5");
    } while (paramBundle == null);
    paramBundle.a();
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getWebView();; localObject = null)
    {
      if (localObject != null)
      {
        localObject = (avqz)((CustomWebView)localObject).getPluginEngine().a("x5");
        if (localObject != null) {
          ((avqz)localObject).a(paramInt, paramString);
        }
      }
      return;
    }
      ...
      for (;;)
      {
        ...
        catch (Throwable paramBundle)
        {
          try
          {
            ...
            QLog.d("SwiftBrowserTBSHandler", 1, "handle stgw time, requestTime: " + localObject4 + "s, responseTime: " + (String)localObject3 + "s, url: " + nmj.b(localObject5, new String[0]));
            return;
          }
          catch (Throwable paramBundle)
          {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = bivr.a().a("801097412");
        if ((localObject == null) || (!bgnt.h(BaseApplicationImpl.getApplication()))) {
          break;
        }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.isFinishing())
    {
      ...
      paramString = new bhqi(this);
      localObject = new bhqj(this);
      if (!bgnt.h(BaseApplicationImpl.getApplication())) {
        break label351;
      }
      this.jdField_a_of_type_MqqOsMqqHandler.sendMessage(this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(102));
      if (!paramBoolean) {
    ...
    if (paramBoolean)
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844372);
      this.jdField_a_of_type_AndroidAppDialog = bglp.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localDrawable, BaseApplicationImpl.getApplication().getResources().getString(2131689479), " ", BaseApplicationImpl.getApplication().getResources().getString(2131690564), BaseApplicationImpl.getApplication().getResources().getString(2131689478), paramString, (View.OnClickListener)localObject);
    ...
    for (paramString = paramString.getString("icon_url", null);; paramString = null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_AndroidAppDialog = bglp.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, BaseApplicationImpl.getApplication().getResources().getString(2131689484), 2131690564, 2131689478, paramString, (View.OnClickListener)localObject);
      this.jdField_a_of_type_AndroidAppDialog.show();
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if (paramMessage != null)
        {
          ...
          if ((localObject1 != null) && (((String)localObject1).length() != 0))
          {
            ...
            atzd.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, (String)localObject1, paramMessage);
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
        return true;
      ...
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131380223);
      ((ImageView)localObject1).setImageDrawable(null);
      ((ImageView)localObject1).setImageDrawable(paramMessage);
      return true;
      paramMessage = (String)paramMessage.obj;
    } while ((this.jdField_a_of_type_AndroidAppDialog == null) || (!this.jdField_a_of_type_AndroidAppDialog.isShowing()) || (paramMessage == null));
    ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131380225)).setText(paramMessage);
    return true;
  }
}
