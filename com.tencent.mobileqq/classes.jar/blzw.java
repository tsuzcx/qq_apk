...
public class blzw
{
  private static String jdField_a_of_type_JavaLangString = blzw.class.getSimpleName();
  private double jdField_a_of_type_Double = 1.0D;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private SurfaceTexture jdField_a_of_type_AndroidGraphicsSurfaceTexture;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private blwy jdField_a_of_type_Blwy = new blwy();
  private blzx jdField_a_of_type_Blzx;
  ...
  public blzw(String paramString, List<List<List<PointF>>> paramList, List<List<float[]>> paramList1, double paramDouble)
  {
  ...
  public void a(blzx paramblzx)
  {
    this.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_b_of_type_JavaLangString = (bljp.jdField_b_of_type_JavaLangString + File.separator + System.currentTimeMillis());
    try
    {
      ...
      this.jdField_a_of_type_Blzx = paramblzx;
