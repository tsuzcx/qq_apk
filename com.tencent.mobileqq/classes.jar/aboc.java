...
public class aboc
{
  ...
  public void a(abop paramabop, View paramView, Activity paramActivity, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131381032));
    ...
    try
    {
      paramabop = (AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web");
      ...
      this.jdField_a_of_type_Abup = new abod(this, paramActivity, paramActivity, null, paramabop);
      this.jdField_a_of_type_Abup.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
      this.jdField_a_of_type_Abup.a(null);
      new bgtj(this.jdField_a_of_type_Abup).a(null, paramabop, null);
    ...
    catch (Exception paramabop)
    {
      QLog.i("EndCardWebGdtMVEndcardWebController", 1, "initWebView", paramabop);
    }
  }
  
  public void a(Activity paramActivity, abop paramabop, boolean paramBoolean)
  {
    if ((paramActivity == null) || (paramabop == null) || (paramabop.a() == null)) {
    ...
    {
      return;
      j = paramabop.a().getEndcardDirection();
      if (!paramBoolean) {
        break;
      }
      i = 1;
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131367475);
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      QLog.i("EndCardWebGdtMVEndcardWebController", 1, "initLoadingContainer container == null");
      return;
    }
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367476);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367477);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_JavaLangString = bjnd.a(str2, "direction", str1);
      return;
    }
  }
  ...
  public boolean a(Activity paramActivity, abop paramabop, boolean paramBoolean)
  {
    if (!this.jdField_c_of_type_Boolean)
    {
    ...
    a(paramActivity, paramabop, paramBoolean);
    return true;
  }
