...
public class acyg
  extends bbqu
{
  public acyg(PokePanel paramPokePanel) {}
  ...
  protected void onPokeAuth(boolean paramBoolean, Object paramObject)
  {
    ...
    if (i == 4)
    {
      ...
      aaod.a(PokePanel.a(this.a), BaseApplicationImpl.getContext(), PokePanel.a(this.a), 126, j, paramObject, (String)localObject);
      if (true == adwl.a) {
        adwl.a = false;
      }
      label106:
    ...
    for (i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        ...
        adwl.a(PokePanel.a(this.a), (Activity)this.a.getContext(), paramObject, (String)localObject, this.a.a, this.a.b);
        VasWebviewUtil.reportCommercialDrainage("", "poke", "vipTip", "", 0, 0, 0, "", String.valueOf(j), str1, "", "", "", "", 0, 0, 0, 0);
        break;
        if (l == 5002L)
        {
          this.a.b = 4;
          paramObject = ajyc.a(2131708325);
          localObject = str2;
        }
        else
        {
          this.a.b = 1;
          str2 = ajyc.a(2131708324);
