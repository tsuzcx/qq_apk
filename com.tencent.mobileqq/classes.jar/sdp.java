...
public class sdp
{
  private static final String jdField_a_of_type_JavaLangString = sdp.class.getSimpleName();
  ...
  public sdp(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_b_of_type_JavaLangString = pha.a();
  }
  ...
  public boolean a(VideoInfo.ECommerceEntranceInfo paramECommerceEntranceInfo)
  {
    ...
    try
    {
      boolean bool = bmqa.x(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (!bool) {
        bmqa.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0));
      }
      if (bool) {}
      for (int i = ((Integer)bmqa.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0))).intValue();; i = 0)
      {
