...
public class nlf
  implements nlc
{
  private static HashMap<String, nla> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new nlg(this);
  ...
  public void a(Context paramContext, String paramString1, String paramString2, String paramString3, nkl paramnkl, Map<String, String> paramMap)
  {
    if (paramnkl == null) {
      return;
    }
    if (paramContext == null)
    {
      paramnkl.loaded(paramString1, 11);
      return;
    }
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      paramnkl.loaded(paramString1, 12);
      return;
    }
    if (AppNetConnInfo.getRecentNetworkInfo() == null)
    {
      paramnkl.loaded(paramString1, 10);
      return;
    }
    Object localObject = new File(paramString3.substring(0, paramString3.lastIndexOf("/")));
    if ((!((File)localObject).exists()) && (!((File)localObject).mkdirs()))
    {
      paramnkl.loaded(paramString1, 13);
      return;
    }
    localObject = Md5Utils.getMD5(paramString1);
    paramString2 = new nla((String)localObject, paramString3, paramString2, paramnkl);
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          try
          {
            ...
            birz.a(paramContext, paramString3);
            return;
          }
  ...
  public void a(Context paramContext, String paramString1, String paramString2, nkl paramnkl)
  {
    a(paramContext, paramString1, "0", paramString2, paramnkl, null);
  }
  
  public void a(TMAssistantDownloadClient paramTMAssistantDownloadClient, nla paramnla, String paramString)
  {
    ...
    try
    {
      ...
      for (paramTMAssistantDownloadClient = localObject;; paramTMAssistantDownloadClient = paramTMAssistantDownloadClient.mSavePath)
      {
        ...
        a(paramnla.jdField_a_of_type_Nkl, paramString, paramnla.c, 14, "get current download path fail after download");
        return;
      }
    ...
    {
      a(paramnla.jdField_a_of_type_Nkl, paramString, paramnla.c, 15, "cannot get current file after download");
      return;
    }
    if (!bgmg.d(localTMAssistantDownloadClient, paramnla.b))
    {
      a(paramnla.jdField_a_of_type_Nkl, paramString, paramnla.c, 16, "rename file fail after download");
      paramTMAssistantDownloadClient.delete();
      return;
    }
    a(paramnla.jdField_a_of_type_Nkl, paramString, paramnla.c, 0, "offline zip download success");
  }
  ...
  public void a(nkl paramnkl, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    if (QLog.isColorLevel()) {
      QLog.d("OfflineDownload", 2, paramString3 + ", bid: " + paramString2 + ", errCode: " + paramInt);
    }
    if ((paramnkl != null) && (paramInt >= 0)) {
      paramnkl.loaded(paramString1, paramInt);
    }
