  ...
  extends MSFServlet
{
  ...
  private static final String jdField_a_of_type_JavaLangString = acib.class.getSimpleName();
  
  private static AcsHead a()
  {
    AcsHead localAcsHead = new AcsHead();
    localAcsHead.model = babp.i();
    localAcsHead.platform = "Android";
    localAcsHead.version = babp.c();
    return localAcsHead;
  }
  ...
  public static void a(int paramInt1, int paramInt2, BusinessObserver paramBusinessObserver)
  {
    ...
    NewIntent localNewIntent = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acib.class);
  ...
  public static void a(String paramString1, String paramString2, BusinessObserver paramBusinessObserver)
  {
    ...
    paramString1 = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acib.class);
  ...
  public static void a(String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    paramString = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acib.class);
  ...
  public static void a(ArrayList<String> paramArrayList, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayList = new NewIntent(jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), acib.class);
