  ...
  extends zve
{
  ...
  public zxy(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private long a(MessageForDeviceFile paramMessageForDeviceFile, View paramView, apen paramapen)
  {
    long l1;
  ...
  private MessageRecord a(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)azaf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(paramLong2), null, 9501);
    ...
    localMessageForDevPtt.time = ayzl.a();
    localMessageForDevPtt.msg = (bdgc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDevPtt.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691352));
  ...
  private MessageRecord b(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    localMessageForDeviceFile.msg = (bdgc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDeviceFile.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691651));
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((localView != null) && (localObject != null))
      {
        ...
        if ((paramMessageRecord instanceof MessageForDeviceFile)) {
          ((apen)localObject).a(localView, (MessageForDeviceFile)paramMessageRecord);
        }
      }
      for (int j = i;; j = i - 1)
      {
  ...
  public long a(MessageRecord paramMessageRecord, View paramView, apen paramapen)
  {
    if ((paramMessageRecord instanceof MessageForDeviceFile)) {
      return a((MessageForDeviceFile)paramMessageRecord, paramView, paramapen);
    }
    return 0L;
  }
  ...
  {
    Object localObject1 = (zvg)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
    ...
    do
    {
      ...
      localObject2 = ((QQAppInterface)localObject2).a().a(((zvg)localObject1).jdField_a_of_type_JavaLangString, ((zvg)localObject1).jdField_a_of_type_Int, ((zvg)localObject1).jdField_a_of_type_Long);
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        this.b.put(Long.valueOf(localMessageRecord.uniseq), Long.valueOf(ayzl.a()));
      }
    } while (!QLog.isColorLevel());
