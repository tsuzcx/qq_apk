...
public class aftz
{
  ...
  public aftz(aftx paramaftx, Context paramContext)
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131559280, null);
  }
  ...
  public void a(IntimateInfo.MemoryDayInfo paramMemoryDayInfo)
  {
    ...
    URLThemeImageView localURLThemeImageView = (URLThemeImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368236);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131381153);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369988);
    RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131370673);
    Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363268);
    ...
    Object localObject1 = this.jdField_a_of_type_Aftx.jdField_a_of_type_JavaLangString;
    if (localURLThemeImageView != null)
    {
      if (localURLThemeImageView.a != null) {
        localURLThemeImageView.a.a(bjuk.c);
      }
    ...
    if ((localRelativeLayout != null) && (ThemeUtil.isNowThemeIsNight(null, false, null))) {
      localObject1 = this.jdField_a_of_type_Aftx.b;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if ((localTextView2 != null) && (paramMemoryDayInfo.wording != null))
        {
          ...
          int i = AIOUtils.dp2px(95.0F, this.jdField_a_of_type_Aftx.jdField_a_of_type_AndroidContentContext.getResources());
          i = aftx.a(this.jdField_a_of_type_Aftx, (String)localObject1, 14.0F, i + 80);
          if (i > 200) {
        ...
        try
        {
          ...
          localTextView1.setOnClickListener(new afua(this));
          return;
