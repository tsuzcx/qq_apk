  ...
  extends bozv
{
  protected double a;
  public int a;
  bozr jdField_a_of_type_Bozr;
  bpap jdField_a_of_type_Bpap = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (paramVideoMaterial != null)
    {
      ...
      if (localDoodleItem != null) {
        localObject1 = new bpao(localDoodleItem, paramVideoMaterial.getDataPath());
      }
    }
    return localObject1;
  }
  ...
  {
    return new bpan(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bpap.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Bpap.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bozr != null) {
      this.jdField_a_of_type_Bozr.a();
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, bpap parambpap)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap == null) || (this.jdField_a_of_type_JavaUtilHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(parambpap.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    parambpap.jdField_a_of_type_Boolean = true;
  }
  
  public void a(bpap parambpap)
  {
    if ((parambpap.jdField_d_of_type_Boolean) && (parambpap.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!parambpap.jdField_a_of_type_Boolean) && (parambpap.jdField_b_of_type_Boolean))
      {
        if (parambpap.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, parambpap);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (parambpap.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, parambpap);
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, bpap parambpap)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap == null) || (this.jdField_a_of_type_JavaUtilHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = parambpap.jdField_d_of_type_Boolean;
    localArrayList.addAll(parambpap.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilHashMap.get(parambpap.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof bpao))
    {
      localObject = (bpao)localObject;
      ((bpao)localObject).a(localArrayList);
      ((bpao)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((bpao)localObject).a(parambpap.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((bpao)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        parambpap.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!parambpap.jdField_d_of_type_Boolean) || (!parambpap.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = parambpap.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof bpam))
      {
        localObject = (bpam)localObject;
        ((bpam)localObject).a();
        ((bpam)localObject).a(localArrayList, bool, parambpap);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((bpam)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((bpam)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          parambpap.b();
        }
      }
      else if ((localObject instanceof bpan))
      {
        localObject = (bpan)localObject;
        ((bpan)localObject).a(localArrayList);
        bpar.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((bpan)localObject).a();
        bpar.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((bpan)localObject).a(parambpap.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          bpar.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          parambpap.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Bozr != null) {
        this.jdField_a_of_type_Bozr.a(paramVideoMaterial);
      }
      return;
    }
    ykq.b("PersonalityOperator", "material is null!");
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Bpap == null) || (!this.jdField_a_of_type_Bpap.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    QQToast.a(QQStoryContext.a().getApp(), anvx.a(2131707412), 0).a();
    return true;
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        if ((this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId())))
        {
          ...
          if (this.jdField_a_of_type_Bozr != null) {}
          for (i = this.jdField_a_of_type_Bozr.a();; i = 0)
          {
            this.jdField_a_of_type_Bpap = new bpap(102, paramMotionEvent, i);
            this.jdField_f_of_type_Int += 1;
            this.jdField_a_of_type_Bpap.jdField_c_of_type_Boolean = true;
            if (this.jdField_a_of_type_Bozr != null) {
              this.jdField_a_of_type_Bozr.a(this.jdField_a_of_type_Bpap);
            }
            a(f1, f2, false);
      ...
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Bpap != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 86	bpaq:jdField_f_of_type_Boolean	Z
    //   4: ifeq +29 -> 33
    //   7: aload_0
    //   8: aload_0
    //   9: getfield 70	bpaq:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   12: invokevirtual 284	com/tencent/aekit/openrender/internal/Frame:getFBO	()I
    //   15: aload_0
    //   16: getfield 70	bpaq:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   19: invokevirtual 276	com/tencent/aekit/openrender/internal/Frame:getTextureId	()I
    //   22: aload_0
    //   23: getfield 88	bpaq:jdField_a_of_type_Int	I
    //   26: aload_0
    //   27: getfield 166	bpaq:jdField_b_of_type_Int	I
    //   30: invokevirtual 325	bpaq:a	(IIII)V
    //   33: aload_0
    //   34: getfield 66	bpaq:jdField_b_of_type_ComTencentFilterBaseFilter	Lcom/tencent/filter/BaseFilter;
    //   37: aload_0
    //   38: getfield 70	bpaq:jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   41: invokevirtual 276	com/tencent/aekit/openrender/internal/Frame:getTextureId	()I
    //   44: aload_0
    //   45: getfield 29	bpaq:jdField_c_of_type_Int	I
    //   48: aload_0
    //   49: getfield 31	bpaq:jdField_d_of_type_Int	I
    //   52: iconst_0
    //   53: aload_0
    //   54: getfield 35	bpaq:jdField_a_of_type_Double	D
    //   57: aload_0
    //   58: getfield 68	bpaq:jdField_c_of_type_ComTencentAekitOpenrenderInternalFrame	Lcom/tencent/aekit/openrender/internal/Frame;
    //   61: invokevirtual 280	com/tencent/filter/BaseFilter:RenderProcess	(IIIIDLcom/tencent/aekit/openrender/internal/Frame;)V
    //   64: aload_0
    //   65: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   68: ifnull +23 -> 91
    //   71: aload_0
    //   72: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   75: instanceof 491
    //   78: ifeq +13 -> 91
    //   81: aload_0
    //   82: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   85: checkcast 491	bozt
    //   88: invokevirtual 493	bozt:f	()V
    //   91: aload_0
    //   92: getfield 182	bpaq:jdField_g_of_type_Boolean	Z
    //   95: ifeq +285 -> 380
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 182	bpaq:jdField_g_of_type_Boolean	Z
    //   103: aconst_null
    //   104: astore 8
    //   106: aconst_null
    //   107: astore 7
    ...
    //   130: astore 6
    //   132: aload_0
    //   133: getfield 29	bpaq:jdField_c_of_type_Int	I
    //   136: aload_0
    //   137: getfield 31	bpaq:jdField_d_of_type_Int	I
    //   140: imul
    ...
    //   151: iconst_0
    //   152: aload_0
    //   153: getfield 29	bpaq:jdField_c_of_type_Int	I
    //   156: aload_0
    //   157: getfield 31	bpaq:jdField_d_of_type_Int	I
    //   160: sipush 6408
    //   163: sipush 5121
    //   166: aload 9
    ...
    //   184: astore 6
    //   186: aload_0
    //   187: getfield 29	bpaq:jdField_c_of_type_Int	I
    //   190: aload_0
    //   191: getfield 31	bpaq:jdField_d_of_type_Int	I
    ...
    //   223: astore 6
    //   225: aload_0
    //   226: getfield 90	bpaq:jdField_g_of_type_Int	I
    //   229: i2f
    //   230: fconst_1
    //   231: fmul
    //   232: aload_0
    //   233: getfield 29	bpaq:jdField_c_of_type_Int	I
    //   236: i2f
    //   237: fdiv
    //   238: fstore_1
    //   239: aload 8
    ...
    //   317: aload_0
    //   318: iconst_0
    //   319: putfield 426	bpaq:jdField_d_of_type_Boolean	Z
    //   322: aload_0
    //   323: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   326: ifnull +14 -> 340
    //   329: aload_0
    //   330: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   333: aload 6
    ...
    //   413: aload_0
    //   414: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   417: ifnull -77 -> 340
    //   420: aload_0
    //   421: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   424: aload 6
    ...
    //   478: aload_0
    //   479: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   482: ifnull -142 -> 340
    //   485: aload_0
    //   486: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   489: aload 7
    ...
    //   507: astore 6
    //   509: aload_0
    //   510: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   513: ifnull +14 -> 527
    //   516: aload_0
    //   517: getfield 92	bpaq:jdField_a_of_type_Bozr	Lbozr;
    //   520: aload 7
