  ...
  implements ShareProxy
{
  ...
  {
    a(paramMiniAppInfo, paramInt, paramString1, paramString2, ImageUtil.drawableToBitmap(paramActivity.getResources().getDrawable(2130848422)), paramString3);
  }
  ...
  private void a(String paramString, URLDrawable.URLDrawableListener paramURLDrawableListener)
  {
    ...
    if (paramURLDrawableListener != null)
    {
      ...
      yuk.b("ShareProxyImpl", "URLDrawable's status is SUCCESSED.");
    ...
    for (;;)
    {
      ...
      return;
      label44:
      yuk.b("ShareProxyImpl", "start load URLDrawable.");
    }
  }
  ...
  public void a(InnerShareData paramInnerShareData)
  {
    ...
    bkzt localbkzt = new bkzt(this, paramInnerShareData);
    Object localObject;
    ...
    if (paramInnerShareData.entryModel != null)
    {
      ...
      int j = 0;
      i = j;
      if (!bhsr.a(((MiniArkShareModel)localObject).getTemplateId()))
      {
        i = j;
        if (!bhsr.a(((MiniArkShareModel)localObject).getTemplateData())) {
          i = 2;
        }
      }
  ...
  public void b(InnerShareData paramInnerShareData)
  {
    ...
    String str;
    Intent localIntent;
    if (bhsr.a(paramInnerShareData.summary))
    {
