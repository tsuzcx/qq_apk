...
public class bkzs
{
  private static bkzs jdField_a_of_type_Bkzs;
  ...
  static
  {
    jdField_a_of_type_JavaIoFile = a(new File(ahvy.d), "qqstroy_follow_capture");
    d();
  }
  
  public static bkzs a()
  {
    if (jdField_a_of_type_Bkzs == null) {}
    try
    {
      if (jdField_a_of_type_Bkzs == null) {
        jdField_a_of_type_Bkzs = new bkzs();
      }
      return jdField_a_of_type_Bkzs;
    }
    finally {}
  }
  ...
  public static void a(String paramString, bkzu parambkzu)
  {
    ...
    for (;;)
    {
      ...
      if (!b(str2, str1))
      {
        ...
        localayrx.jdField_a_of_type_Aysc = new bkzt(str2, str1, parambkzu);
        localayrx.jdField_a_of_type_JavaLangString = paramString;
        localayrx.jdField_a_of_type_Int = 0;
        localayrx.jdField_c_of_type_JavaLangString = str2;
        localayrx.jdField_c_of_type_Int = bbfj.a(ayta.a().a());
        try
        {
          parambkzu = BaseApplicationImpl.getApplication().getRuntime();
          if (QQAppInterface.class.isInstance(parambkzu))
          {
            ((QQAppInterface)parambkzu).getNetEngine(0).a(localayrx);
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(tcs.d());
  }
