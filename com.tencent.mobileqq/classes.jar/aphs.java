...
public class aphs
{
  ...
  {
    paramQQAppInterface = (apgi)paramQQAppInterface.getManager(112);
  ...
  public static BusinessCard a(QQAppInterface paramQQAppInterface, aymg paramaymg)
  {
    apgi localapgi = (apgi)paramQQAppInterface.getManager(112);
    if (paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) {
      paramQQAppInterface = localapgi.a();
    }
    for (;;)
    {
      paramaymg = paramQQAppInterface;
      if (paramQQAppInterface == null) {
        paramaymg = new BusinessCard();
      }
      return paramaymg;
      if (paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard != null)
      {
        paramQQAppInterface = paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard.getCardInfo();
        if ((paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard.hasCardInfo()) && (!TextUtils.isEmpty(paramQQAppInterface.cardId))) {
          localapgi.a(paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, paramQQAppInterface);
        } else {
          paramQQAppInterface = localapgi.b(paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString);
        }
      }
      else
      {
  ...
  public static void a(String paramString, URLImageView paramURLImageView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localURLDrawableOptions.mLoadingDrawable = paramURLImageView.getContext().getResources().getDrawable(2130844833);
        paramURLImageView.setImageDrawable(URLDrawable.getDrawable(paramString, localURLDrawableOptions));
        paramURLImageView.setURLDrawableDownListener(new apht(paramURLImageView));
        return;
      }
      catch (Exception paramString) {}
