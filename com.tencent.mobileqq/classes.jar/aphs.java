  ...
  implements apan
{
  ...
  private aphs(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, apht paramapht, aphx paramaphx)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, 0, paramapht, paramaphx);
  ...
  public static apan a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, apht paramapht, aphx paramaphx)
  {
    if (paramapht == null) {
    ...
    return null;
    return new aphs(paramQQAppInterface, paramLong1, paramLong2, paramapht, paramaphx);
  }
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Aozv != null) {
      this.jdField_a_of_type_Aozv.a(paramLong1);
    }
  }
  ...
  protected void a(ExcitingTransferUploadBizInfo paramExcitingTransferUploadBizInfo)
  {
    ...
    if ((this.jdField_a_of_type_Aphu instanceof apht))
    {
      apht localapht = (apht)this.jdField_a_of_type_Aphu;
      paramExcitingTransferUploadBizInfo.bufUuid = localapht.a;
      paramExcitingTransferUploadBizInfo.bufUploadKey = localapht.b;
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_Aphu.a(paramArrayOfByte);
    b();
  }
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferUploadResultRp != null)
    {
      ...
      {
        bool1 = bool2;
        if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferUploadResultRp.m_u64StartSize == this.jdField_a_of_type_Aphu.a()) {
          bool1 = true;
        }
      }
    }
  ...
  public boolean a(long paramLong)
  {
    ...
    e();
    b(null);
    if ((this.jdField_a_of_type_Aphu.d() == null) || (this.jdField_a_of_type_Aphu.d().length == 0))
    {
      if (this.jdField_a_of_type_Aozv != null)
      {
        Bundle localBundle = new Bundle();
        byte[] arrayOfByte = this.jdField_a_of_type_Aozv.a(localBundle);
        ...
        this.jdField_a_of_type_Aphu.a(arrayOfByte);
      }
    }
    else {
      return b();
  ...
  protected void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    for (String str = paramExcitingTransferUploadResultRp.m_strFileUrl;; str = "")
    {
      ...
      paramInt = a(paramInt);
      if (this.jdField_a_of_type_Aozv != null) {
        this.jdField_a_of_type_Aozv.a(true, this.c, paramInt, "", "");
      }
      return;
    }
  }
