...
public class apzb<T extends apwk>
  extends BaseAdapter
  implements agoa
{
  public int a;
  ...
  public apzb(Context paramContext, SessionInfo paramSessionInfo, ArkHorizontalListView paramArkHorizontalListView, aftk paramaftk)
  {
  ...
  public T a(int paramInt)
  {
    ...
    return (apwk)this.jdField_a_of_type_JavaUtilLinkedList.get(paramInt - 1);
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      apwk localapwk = (apwk)this.jdField_a_of_type_JavaUtilLinkedList.removeLast();
      if (localapwk != null) {
        localapwk.destroyContainerByRemove();
      }
      i += 1;
    }
  ...
  public void a(agnw paramagnw, int paramInt)
  {
    int i;
    if ((paramInt == 1) || (paramInt == this.jdField_a_of_type_JavaUtilLinkedList.size()))
    {
      ...
      int n = MessageForArkApp.dp2px(paramagnw.getWidth());
      ...
      if (this.jdField_a_of_type_Int != i)
      {
        ...
        paramagnw = this.jdField_a_of_type_ComTencentMobileqqArkArkHorizontalListView.getChild(0);
        if ((paramagnw != null) && (!(paramagnw instanceof LinearLayout)))
        {
          paramagnw.setLayoutParams(new ViewGroup.LayoutParams(this.jdField_a_of_type_Int, -1));
          paramagnw.requestLayout();
        }
      }
    }
    for (;;)
    {
      ...
      {
        this.b = i;
        paramagnw = this.jdField_a_of_type_ComTencentMobileqqArkArkHorizontalListView.getChild(paramInt + 1);
        if ((paramagnw != null) && (!(paramagnw instanceof LinearLayout)))
        {
          paramagnw.setLayoutParams(new ViewGroup.LayoutParams(this.b, -1));
          paramagnw.requestLayout();
        }
      }
    }
  ...
  public void a(apzf paramapzf, T paramT)
  {
    Object localObject2 = paramT.getArkAppNameAndPath();
    String str = localObject2[0];
    Object localObject1 = localObject2[1];
    localObject2 = localObject2[2];
    paramT.clickTail(paramapzf, null, this.jdField_a_of_type_AndroidContentContext);
    if (localObject1 != null)
    {
      ArkAppCacheMgr.getAppIcon(str, new apzc(this, paramapzf));
      paramT = ArkAppCacheMgr.getApplicationDesc(str);
      if (paramT != null)
      {
        paramapzf.b.setVisibility(0);
        paramapzf.jdField_a_of_type_AndroidWidgetTextView.setText(paramT);
      }
    }
    while ((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime() == null) {
      return;
    }
    ArkAppMgr.getInstance().getAppPathByName(str, (String)localObject2, "0.0.0.1", null, new apzd(this, str, paramapzf));
  }
  ...
  public T b(int paramInt)
  {
    ...
    return (apwk)this.jdField_a_of_type_JavaUtilLinkedList.get(paramInt);
  }
  ...
  public void b(int paramInt, T paramT)
  {
    ...
    do
    {
      ...
      localObject = (apzf)((View)localObject).getTag();
    } while (localObject == null);
    paramT.attachArkView(this, (apzf)localObject, paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      apwk localapwk = a(paramInt);
      if (paramView == null)
      {
        localObject1 = new apzf();
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558713, paramViewGroup, false);
        ((apzf)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131362968));
        ((apzf)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout = ((ArkAppRootLayout)paramView.findViewById(2131362970));
        ((apzf)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131362983));
        ((apzf)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout = ((ArkAppLoadLayout)paramView.findViewById(2131370436));
        ((apzf)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)paramView.findViewById(2131362957));
        ((apzf)localObject1).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131362974);
        ((apzf)localObject1).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131362969));
        ((apzf)localObject1).b = ((LinearLayout)paramView.findViewById(2131362966));
        ((apzf)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362965));
        ((apzf)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362967));
        ...
        if ((localObject2 instanceof BaseChatItemLayout)) {
          ((apzf)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout = ((BaseChatItemLayout)localObject2);
        }
  ...
  {
    QLog.d("ArkOpenView", 1, "ArkHorizontalListViewAdapter OpenCardView containerWrapper=" + paramagnx + ", view=" + paramString1 + ", meta=" + paramString2);
    int i = 0;
    for (;;)
    {
      if (i < this.jdField_a_of_type_JavaUtilLinkedList.size())
      {
        apwk localapwk = ((apwk)this.jdField_a_of_type_JavaUtilLinkedList.get(i)).extendArkCardByOpen(paramagnx, paramString1, paramString2);
        if (localapwk != null) {
          a(i + 1, localapwk);
        }
      }
