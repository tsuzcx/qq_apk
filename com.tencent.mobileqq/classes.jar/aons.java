  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  public View a;
  ansb jdField_a_of_type_Ansb;
  aonv jdField_a_of_type_Aonv;
  ...
  public aons(@NonNull BaseActivity paramBaseActivity, @NonNull ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    super(paramBaseActivity, 2131755173);
    if ((paramArrayList == null) || (paramArrayList.size() < 1)) {
      throw new RuntimeException("empty data");
    }
    getWindow().setDimAmount(0.5F);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Ansb = ((ansb)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface().getManager(257));
    ...
    {
      paramArrayList = b();
      bcst.b(null, "dc00898", "", "", "0X8008A9E", "0X8008A9E", 0, 0, "", "", "", "");
      ...
      {
        paramArrayList = (ImageView)paramArrayList.findViewById(2131374011);
    ...
    for (;;)
    {
      ...
      return;
      paramArrayList = a();
      bcst.b(null, "dc00898", "", "", "0X8008AA1", "0X8008AA1", 0, 0, "", "", "", "");
  ...
  private View a()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560929, null, false);
    localView.findViewById(2131369584).setOnClickListener(this);
    localView.findViewById(2131364539).setOnClickListener(this);
    TextView localTextView = (TextView)localView.findViewById(2131371671);
    String str = this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.c();
    if (!TextUtils.isEmpty(str)) {
      localTextView.setText(str);
    }
    this.jdField_a_of_type_ComTencentWidgetListView = ((XListView)localView.findViewById(2131369914));
    this.jdField_a_of_type_ComTencentWidgetListView.setSelector(new ColorDrawable(0));
    this.jdField_a_of_type_Aonv = new aonv(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
    this.jdField_a_of_type_Aonv.a(localList);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Aonv);
    ((Button)localView.findViewById(2131364909)).setOnClickListener(this);
    return localView;
  }
  ...
  private View b()
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560971, null, false);
    localRelativeLayout.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = localRelativeLayout;
    Object localObject2 = localRelativeLayout.findViewById(2131365495);
    ((View)localObject2).setOnClickListener(this);
    Object localObject3 = (RelativeLayout.LayoutParams)((View)localObject2).getLayoutParams();
    ((RelativeLayout.LayoutParams)localObject3).width = afur.a(286.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    ((PressDarkImageView)localObject3).setId(2131364539);
    ((PressDarkImageView)localObject3).setImageResource(2130846527);
    Object localObject4 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject4).addRule(3, 2131365495);
    ((RelativeLayout.LayoutParams)localObject4).addRule(14);
    ((RelativeLayout.LayoutParams)localObject4).topMargin = afur.a(28.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    localObject3 = (TextView)((View)localObject2).findViewById(2131365513);
    ...
    localObject4 = (ImageView)((View)localObject2).findViewById(2131366184);
    Object localObject5 = (TextView)((View)localObject2).findViewById(2131371705);
    localObject3 = (TextView)((View)localObject2).findViewById(2131364831);
    ((View)localObject2).findViewById(2131364909).setOnClickListener(this);
    Object localObject6 = (TextView)((View)localObject2).findViewById(2131376141);
    ((TextView)localObject6).setTag(Long.valueOf(((QIMNotifyAddFriend)localObject1).uin));
    Object localObject7 = this.jdField_a_of_type_Ansb.a(((QIMNotifyAddFriend)localObject1).uin, ((QIMNotifyAddFriend)localObject1).qqUin);
    label410:
    int i;
    int j;
    int k;
    if (TextUtils.isEmpty((CharSequence)localObject7))
    {
      ...
      ((ImageView)localObject4).setImageDrawable(aoch.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, String.valueOf(((QIMNotifyAddFriend)localObject1).uin), (byte)2));
      ...
      if (i > 0)
      {
        localObject2 = (LinearLayout)((View)localObject2).findViewById(2131377880);
        ((LinearLayout)localObject2).setVisibility(0);
        if (i != 1) {
          break label685;
        }
        localObject3 = new ImageView(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
        i = afur.a(128.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        j = afur.a(188.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = afur.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839551);
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject3).setOnClickListener(new aont(this, ((QIMNotifyAddFriend.VideoInfo)((QIMNotifyAddFriend)localObject1).videoInfos.get(0)).videoVid));
    ...
    for (;;)
    {
      ...
      if (i < ((List)localObject1).size())
      {
        ...
        j = afur.a(76.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = afur.a(122.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        int m = afur.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839551);
      ...
      for (;;)
      {
        ...
        ((URLImageView)localObject5).setOnClickListener(new aonu(this, (ArrayList)localObject3, (QIMNotifyAddFriend.VideoInfo)localObject4));
  ...
  public void a()
  {
    Button localButton = (Button)getWindow().findViewById(2131364909);
  ...
  public boolean a(List<QIMNotifyAddFriend> paramList)
  {
    ...
    if (this.jdField_a_of_type_Aonv != null)
    {
      ...
      this.jdField_a_of_type_Aonv.a(this.jdField_a_of_type_JavaUtilList);
      a();
      bool = true;
    }
    return bool;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      dismiss();
      ((FriendListHandler)((QQAppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null)).a(1)).b(this.b);
      this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.a(getContext(), null);
      this.jdField_a_of_type_Ansb.a(this.b);
      if (this.jdField_a_of_type_Int == 1)
      {
        bcst.b(null, "dc00898", "", "", "0X8008A9F", "0X8008A9F", 0, 0, "", "", "", "");
      }
      else if (this.jdField_a_of_type_Int == 2)
      {
        bcst.b(null, "dc00898", "", "", "0X8008AA2", "0X8008AA2", 0, 0, "", "", "", "");
        continue;
        if (this.jdField_a_of_type_Int == 1) {
          bcst.b(null, "dc00898", "", "", "0X8008AA0", "0X8008AA0", 0, 0, "", "", "", "");
        }
        for (;;)
        {
          dismiss();
          ...
          if (this.jdField_a_of_type_Int == 2) {
            bcst.b(null, "dc00898", "", "", "0X8008AA3", "0X8008AA3", 0, 0, "", "", "", "");
          }
        }
        dismiss();
      }
