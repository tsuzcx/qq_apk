  ...
  implements Runnable
{
  ...
  public aons(String paramString, Surface paramSurface, TrackingDecoderListener paramTrackingDecoderListener)
  {
  ...
  public void run()
  {
    ...
    //   3: lstore_1
    //   4: aload_0
    //   5: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   8: aload_0
    //   9: getfield 110	aons:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   15: aload_0
    //   16: invokespecial 509	aons:a	()Z
    //   19: ifne +4 -> 23
    //   22: return
    //   23: aload_0
    //   24: invokespecial 511	aons:b	()Z
    //   27: ifeq -5 -> 22
    ...
    //   50: aload_0
    //   51: getfield 36	aons:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   86: ifne +416 -> 502
    //   89: aload_0
    //   90: getfield 38	aons:jdField_a_of_type_Boolean	Z
    //   93: ifne +409 -> 502
    //   96: aload_0
    //   97: getfield 110	aons:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   100: getfield 410	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_a_of_type_Int	I
    //   103: aload_0
    //   104: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   113: aload_0
    //   114: getfield 110	aons:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   124: aload_0
    //   125: aload_0
    //   126: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   129: getfield 411	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_b_of_type_Long	J
    //   132: ldc2_w 142
    //   135: lmul
    //   136: putfield 153	aons:jdField_c_of_type_Long	J
    //   139: aload_0
    //   140: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   143: aload_0
    //   144: getfield 110	aons:jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   150: aload_0
    //   151: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   154: getfield 440	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_a_of_type_Long	J
    //   157: ldc2_w 142
    //   160: lmul
    //   161: lstore_1
    //   162: aload_0
    //   163: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   166: getfield 411	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_b_of_type_Long	J
    //   169: ldc2_w 142
    //   172: lmul
    //   173: lstore_3
    //   174: aload_0
    //   175: getfield 55	aons:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    ...
    //   204: aload_0
    //   205: lload 5
    //   207: invokespecial 521	aons:a	(J)J
    //   210: pop2
    //   211: aload_0
    //   212: getfield 55	aons:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong	Ljava/util/concurrent/atomic/AtomicLong;
    //   215: lload 5
    //   217: ldc2_w 49
    ...
    //   229: aload_0
    //   230: iconst_1
    //   231: invokespecial 527	aons:d	(Z)V
    //   234: invokestatic 159	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   237: ifeq +36 -> 273
    //   240: aload_0
    //   241: getfield 36	aons:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   244: iconst_2
    ...
    //   273: aload_0
    //   274: getfield 151	aons:jdField_c_of_type_Boolean	Z
    //   277: ifeq +72 -> 349
    //   280: aload_0
    //   281: getfield 60	aons:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   284: ifnull +10 -> 294
    //   287: aload_0
    //   288: getfield 60	aons:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   291: invokevirtual 530	java/util/ArrayList:clear	()V
    //   294: invokestatic 159	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   297: ifeq +14 -> 311
    //   300: aload_0
    //   301: getfield 36	aons:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   304: iconst_2
    //   305: ldc_w 532
    //   308: invokestatic 172	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   311: aload_0
    //   312: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    //   315: getfield 498	com/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig:jdField_b_of_type_Boolean	Z
    //   318: ifeq +184 -> 502
    //   321: aload_0
    //   322: getfield 112	aons:jdField_b_of_type_ComTencentMobileqqRichmediaMediacodecVideodecoderDecodeConfig	Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;
    ...
    //   334: aload_0
    //   335: lload_1
    //   336: invokespecial 521	aons:a	(J)J
    //   339: pop2
    //   340: aload_0
    //   341: getfield 94	aons:jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecTrackerTrackingDecoderListener	Ldov/com/tencent/mobileqq/richmedia/mediacodec/tracker/TrackingDecoderListener;
    //   344: invokeinterface 534 1 0
    //   349: aload_0
    //   350: getfield 536	aons:jdField_d_of_type_Boolean	Z
    //   353: ifeq -270 -> 83
    //   356: aload_0
    //   357: getfield 62	aons:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   360: astore 7
    //   362: aload 7
    //   364: monitorenter
    //   365: aload_0
    //   366: getfield 38	aons:jdField_a_of_type_Boolean	Z
    //   369: ifne +10 -> 379
    //   372: aload_0
    //   373: getfield 62	aons:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   386: aload_0
    //   387: getfield 280	aons:jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo	Landroid/media/MediaCodec$BufferInfo;
    //   390: getfield 297	android/media/MediaCodec$BufferInfo:presentationTimeUs	J
    //   393: ldc2_w 142
    //   396: ldiv
    //   397: lsub
    //   398: putfield 46	aons:jdField_a_of_type_Long	J
    //   401: goto -318 -> 83
    //   404: astore 7
    //   406: aload 7
    ...
    //   411: aload_0
    //   412: iconst_1
    //   413: putfield 38	aons:jdField_a_of_type_Boolean	Z
    //   416: goto -333 -> 83
    //   419: astore 7
    ...
    //   430: ifeq -196 -> 234
    //   433: aload_0
    //   434: getfield 36	aons:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   437: iconst_2
    //   438: ldc 255
    //   440: aload 7
    ...
    //   457: astore 8
    //   459: aload_0
    //   460: getfield 94	aons:jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecTrackerTrackingDecoderListener	Ldov/com/tencent/mobileqq/richmedia/mediacodec/tracker/TrackingDecoderListener;
    //   463: iconst_3
    //   464: aload 8
    ...
    //   474: ifeq -452 -> 22
    //   477: aload_0
    //   478: getfield 36	aons:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   481: iconst_2
    //   482: ldc_w 275
    //   485: aload 7
    ...
    //   501: athrow
    //   502: aload_0
    //   503: getfield 125	aons:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   506: invokevirtual 542	android/media/MediaCodec:stop	()V
    //   509: aload_0
    //   510: getfield 125	aons:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   513: invokevirtual 545	android/media/MediaCodec:release	()V
    //   516: aload_0
    //   517: getfield 132	aons:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   520: invokevirtual 546	android/media/MediaExtractor:release	()V
    //   523: aload_0
    //   524: getfield 151	aons:jdField_c_of_type_Boolean	Z
    //   527: ifeq +56 -> 583
    //   530: aload_0
    //   531: getfield 94	aons:jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecTrackerTrackingDecoderListener	Ldov/com/tencent/mobileqq/richmedia/mediacodec/tracker/TrackingDecoderListener;
    ...
    //   545: ifeq -22 -> 523
    //   548: aload_0
    //   549: getfield 36	aons:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   552: iconst_2
    ...
    //   580: goto -57 -> 523
    //   583: aload_0
    //   584: getfield 94	aons:jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecTrackerTrackingDecoderListener	Ldov/com/tencent/mobileqq/richmedia/mediacodec/tracker/TrackingDecoderListener;
