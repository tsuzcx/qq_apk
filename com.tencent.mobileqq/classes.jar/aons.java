...
{
  public aons(FMActivity paramFMActivity) {}
  ...
  public void onCheckedChanged(RadioGroup paramRadioGroup, int paramInt)
  {
    ...
    if ((paramInt == 2131374872) && (this.a.jdField_b_of_type_AndroidWidgetRadioButton.isChecked()))
    {
      this.a.a().f();
      FMActivity.d(this.a);
    ...
    for (;;)
    {
      ...
      return;
      if ((paramInt == 2131369521) && (this.a.jdField_a_of_type_AndroidWidgetRadioButton.isChecked()))
      {
        this.a.a().e();
        FMActivity.e(this.a);
      ...
      else if ((paramInt == 2131364305) && (this.a.jdField_c_of_type_AndroidWidgetRadioButton.isChecked()))
      {
        this.a.a().d();
