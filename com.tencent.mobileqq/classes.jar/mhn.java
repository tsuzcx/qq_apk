...
public class mhn
  extends Handler
{
  public mhn(VideoFeedsPlayManager paramVideoFeedsPlayManager, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if ((f < 5.0F) && (VideoFeedsPlayManager.d(this.a)))
      {
        ...
        localObject = new mhy(this.a, null);
        ((mhy)localObject).a = paramMessage.a(true);
        ((mhy)localObject).b = paramMessage.b();
        if (QLog.isColorLevel()) {
          QLog.d("Q.pubaccount.video.feeds.VideoFeedsPlayManager", 2, "mPlayInfoListForReport add detailInfo.totalPlayTime = " + ((mhy)localObject).a + ", detailInfo.currentPlayTime = " + ((mhy)localObject).b);
        }
