  ...
  extends MessageMicro<QAPPHead>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 42, 48, 58, 66, 72, 82, 90, 96, 104, 114, 122, 130, 138 }, new String[] { "str_userip", "str_module", "str_cmdname", "uint64_seq", "str_qua", "uint64_loglevel", "str_logdepth", "auth_info", "retcode", "retmsg", "extinfo", "reqFrm", "logSeq", "colorLink", "deviceInfo", "trace", "all_trace" }, new Object[] { "", "", "", localLong, "", localLong, "", null, localLong, "", null, Integer.valueOf(1), localLong, null, "", null, null }, QAPPHead.class);
  }
}
