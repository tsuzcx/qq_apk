  ...
  extends PopupWindow
{
  ...
  public benw(Context paramContext)
  {
    super(paramContext, null, 2131755887);
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      localValueAnimator.addUpdateListener(new benz(this));
      localValueAnimator.addListener(new beoa(this));
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setOnKeyListener(new benx(this));
    ...
    paramIBinder.addUpdateListener(new beny(this));
    paramIBinder.start();
  }
