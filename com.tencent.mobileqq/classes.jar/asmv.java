...
public class asmv
{
  ...
  asmx jdField_a_of_type_Asmx = asmx.jdField_a_of_type_Asmx;
  String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = false;
  asmx jdField_b_of_type_Asmx = asmx.jdField_a_of_type_Asmx;
  String jdField_b_of_type_JavaLangString = "";
  boolean jdField_b_of_type_Boolean = false;
  asmx jdField_c_of_type_Asmx = asmx.jdField_a_of_type_Asmx;
  boolean jdField_c_of_type_Boolean = false;
  asmx d = asmx.jdField_a_of_type_Asmx;
  asmx e = asmx.jdField_a_of_type_Asmx;
  asmx f = asmx.jdField_a_of_type_Asmx;
  asmx g = asmx.jdField_a_of_type_Asmx;
  asmx h = asmx.jdField_a_of_type_Asmx;
  asmx i = asmx.jdField_a_of_type_Asmx;
  asmx j = asmx.jdField_a_of_type_Asmx;
  ...
  private asmx a(JSONObject paramJSONObject)
  {
    boolean bool = true;
    if (paramJSONObject == null) {
      return asmx.jdField_a_of_type_Asmx;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        paramJSONObject = new asmx(bool, localSimpleDateFormat.parse(str), localSimpleDateFormat.parse(paramJSONObject));
  ...
  private void b()
  {
    this.jdField_a_of_type_Asmx = asmx.jdField_a_of_type_Asmx;
    this.jdField_b_of_type_Asmx = asmx.jdField_a_of_type_Asmx;
    this.jdField_c_of_type_Asmx = asmx.jdField_a_of_type_Asmx;
    this.d = asmx.jdField_a_of_type_Asmx;
    this.e = asmx.jdField_a_of_type_Asmx;
    this.f = asmx.jdField_a_of_type_Asmx;
    this.g = asmx.jdField_a_of_type_Asmx;
    this.h = asmx.jdField_a_of_type_Asmx;
    this.i = asmx.jdField_a_of_type_Asmx;
    this.j = asmx.jdField_a_of_type_Asmx;
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    if (m != k)
    {
      paramConfig = aova.b(paramConfig, m, paramConfig.type.get());
      a(paramConfig);
      b(paramConfig);
    }
  ...
  void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Asmx = a(paramString.optJSONObject("webview_menu"));
        this.jdField_b_of_type_Asmx = a(paramString.optJSONObject("webview_launch_app"));
        this.jdField_c_of_type_Asmx = a(paramString.optJSONObject("scan_qrcode"));
        ...
        if (paramString.optInt("need_report_system_share_info_new") == 1)
        {
          ...
          JefsClass.getInstance().a(this.jdField_b_of_type_Asmx.a(), paramString);
        }
      }
  ...
  void b(String paramString)
  {
    ...
    try
    {
      paramString = asms.a(paramString);
