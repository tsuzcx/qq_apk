  ...
  extends BaseAdapter
{
  ...
  public asmv(Context paramContext, Comments paramComments, VideoData paramVideoData, aspl paramaspl, Paint paramPaint, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a != null) && (this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.size() > 0)) {
      if ((paramView == null) || (!(paramView.getTag() instanceof asmz)))
      {
        paramView = new asmz();
        localObject = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495300, paramViewGroup, false);
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131302917));
        paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131312436));
        paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131312289));
        paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131312466));
        paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131301978));
        paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131300309));
        paramView.d = ((ImageView)((View)localObject).findViewById(2131311753));
        ((View)localObject).setTag(2131298923, paramView);
        ...
        localObject = azwp.a((AppInterface)localObject, 32, str2, 3, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844502), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844502));
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new asmw(this, l1, l2, l3));
        ...
        paramView.setTag(2131298914, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt));
        paramView.setTag(2131298964, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments);
    ...
    {
      return localObject;
      paramViewGroup = (asmz)paramView.getTag();
      break;
      ...
      break label318;
      asmq.a().a(paramViewGroup.jdField_a_of_type_AndroidWidgetImageView, ((Comments.Comment)this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments.a.get(paramInt)).jdField_c_of_type_JavaLangString, paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844502), paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130844502), null, true);
      break label469;
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          paramView.findViewById(2131303760).setOnClickListener(new asmx(this));
          paramView.setTag("badnet");
          return paramView;
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495290, paramViewGroup, false);
        }
      }
    ...
    label910:
    paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495291, paramViewGroup, false);
