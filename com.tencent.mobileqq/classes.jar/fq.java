...
public class fq
{
  ...
  public fq(CharacterStyle paramCharacterStyle, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
  ...
  public fq(String paramString, int paramInt1, int paramInt2, ETFont paramETFont, boolean paramBoolean)
  {
  ...
  private void a(CharacterStyle paramCharacterStyle, int paramInt)
  {
    ...
    if ((paramCharacterStyle instanceof QQText.EmoticonSpan)) {
      i = ((QQText.EmoticonSpan)paramCharacterStyle).getDrawable().getBounds().width();
    }
    for (;;)
    {
      label26:
