...
public class rhq
  extends amng
  implements View.OnClickListener, View.OnLongClickListener, axfs, rek<ObservableArrayList<ResultRecord>>
{
  private static final rhw jdField_a_of_type_Rhw = new rhw(null);
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new rhr(this);
  private ExpandableListView jdField_b_of_type_ComTencentWidgetExpandableListView;
  private final boolean jdField_b_of_type_Boolean;
  private final View.OnClickListener c = new rht(this);
  
  public rhq(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, boolean paramBoolean)
  {
  ...
  private void a(List<rhu> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Rhw);
      return;
    }
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (rhx)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
      ...
      if (localObject3 != null)
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              if ((((RecentUser)localObject4).getType() == 0) && (Long.parseLong(((RecentUser)localObject4).uin) >= 10000L) && (!((RecentUser)localObject4).uin.equals(localObject2)) && (!bhjx.b(((RecentUser)localObject4).uin)))
              {
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new rhu((Friends)((Iterator)localObject5).next(), -1));
          }
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((rhu)((Iterator)localObject4).next()).a);
        }
      ...
      for (;;)
      {
        ...
        while (i < ((List)localObject2).size())
        {
          ...
          if ((!((Friends)localObject5).uin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (!bhjx.b(((Friends)localObject5).uin)) && (!bkgt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject5).uin))) {
  ...
  protected View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(null);
      localObject = bhlg.a(localFriends);
      ...
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject + anzj.a(2131712601));
      }
      return paramView;
      paramViewGroup = (rhy)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    ...
    label355:
    paramView.setContentDescription((String)localObject + anzj.a(2131712606));
    return paramView;
  }
  ...
  {
    rhv localrhv = (rhv)paramView.getTag();
    if (localrhv == null)
    {
      localrhv = new rhv();
      paramView.findViewById(2131369210).setVisibility(0);
      localrhv.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367726));
      paramView.setTag(localrhv);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localrhv.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (rhv)paramView.getTag();
      ...
      if (AppSetting.c)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + anzj.a(2131712633));
      }
    }
    for (;;)
    {
      ...
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + anzj.a(2131712595));
    }
  }
  ...
  {
    rhv localrhv = (rhv)paramView.getTag();
    if (this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(localrhv.jdField_a_of_type_Int)) {
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.b(localrhv.jdField_a_of_type_Int);
    }
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.a(localrhv.jdField_a_of_type_Int);
    }
  }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    bhkx.a(paramView, localbhuk, this.c, new rhs(this));
    return true;
  }
