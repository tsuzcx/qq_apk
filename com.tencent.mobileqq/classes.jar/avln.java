  ...
  extends anud
{
  ...
  public avln(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private avlc a(GameUserInfo paramGameUserInfo)
  {
    if (paramGameUserInfo == null) {
      return null;
    }
    avld localavld = (avld)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358);
    if (GameUserInfo.isUsrInfoUpdate(localavld.a(paramGameUserInfo.mRoleId), paramGameUserInfo))
    {
      QLog.i(b, 1, "[notifyGameUsrInfoChanged], roleId:" + paramGameUserInfo.mRoleId);
      return avlc.a(localavld.a(paramGameUserInfo.mAppId), paramGameUserInfo);
    }
    return null;
  }
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (paramIntent != null)
          {
            ...
            if (paramFromServiceMsg != null)
            {
              ...
              paramIntent = paramFromServiceMsg.optString("err_msg");
              paramFromServiceMsg = paramFromServiceMsg.optJSONObject("popinfo");
              if (i != 0)
              {
                QLog.w(b, 1, "errMsg:" + paramIntent);
                return;
              }
              if (QLog.isColorLevel()) {
      ...
      try
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (paramIntent != null)
          {
            ...
            ((avld)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358)).c(paramFromServiceMsg);
          }
        }
      }
      catch (Throwable paramIntent)
  ...
  private void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      paramIntent = (avld)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(358);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.app.getApp(), avlp.class);
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    } while (!"GameCenterMsg.GetAioPop".equals(str));
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = new NewIntent(this.app.getApp(), avlp.class);
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    try
    {
      ...
      ((WebSSOAgent.UniSsoServerReqComm)localObject1).mqqver.set("8.4.5");
    ...
    paramArrayList = new NewIntent(this.app.getApp(), avlp.class);
