...
public class atcu
  extends bcje
{
  public atcu(GameRoomInviteActivity paramGameRoomInviteActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.setComplete(new atcv(this));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.a.setText(ajya.a(2131705105));
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.c();
    ...
    this.a.jdField_a_of_type_Bcjg.a();
  ...
  public void a(submsgtype0xdd.MsgBody paramMsgBody)
  {
    ...
    case 1: 
      do
      {
        ...
        if ((!paramMsgBody.uint64_invite_leader.has()) || (paramMsgBody.uint64_invite_leader.get() == this.a.app.getLongAccountUin()))
        {
          ...
          ((atdn)localObject).jdField_a_of_type_JavaLangString = (localPlayerState.uint64_uin.get() + "");
        ...
        {
          ((atdn)localObject).jdField_a_of_type_Boolean = bool;
    ...
    case 2: 
      ...
      atbi.a(this.a.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(awzy.a()));
      return;
    case 3: 
      label135:
      label250:
      bcql.a(this.a, ajya.a(2131705130), 0).a();
      this.a.finish();
      this.a.jdField_a_of_type_JavaUtilList = null;
      bbkb.a(this.a, this.a.app.getCurrentAccountUin(), false, System.currentTimeMillis());
      return;
    }
    this.a.a(null, ajya.a(2131705107), true);
  }
}
