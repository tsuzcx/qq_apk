  ...
  implements akij
{
  ...
  public aktm(QQAppInterface paramQQAppInterface, aktl paramaktl)
  {
  ...
  protected List<FTSOptSync> a(SQLiteDatabase paramSQLiteDatabase, aukp paramaukp)
  {
    try
    {
      ...
      paramSQLiteDatabase = paramaukp.a(FTSTroopSync.class, FTSTroopSync.class.getSimpleName(), false, "_id>?", new String[] { String.valueOf(this.jdField_a_of_type_Int) }, null, null, null, "300");
    ...
    catch (Throwable paramSQLiteDatabase)
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication().getApplicationContext()).a(null, "actGetOptFailed", true, 0L, 0L, paramSQLiteDatabase, null);
    }
    return null;
  }
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> a(String paramString)
  {
    ...
    aqkx localaqkx = new aqkx().a(TroopIndex.class).a(new aqky[] { new aqky("TroopIndex", paramString, true) }).a(true);
    if (((awwa.a(paramString)) || (awwa.b(paramString))) && (!awwa.c(paramString))) {
      localaqkx.a(200);
    }
    return this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.a(localaqkx.a());
  }
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Akto = new aktn(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
    this.jdField_e_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
      QLog.d("Q.fts.troop.operator", 2, "init success");
    }
    this.jdField_e_of_type_Int = aqkv.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, "TroopIndex");
    return true;
  }
  ...
  public boolean a(ArrayList<FTSOptSync> paramArrayList)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 28	aktm:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: invokevirtual 152	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   7: invokevirtual 158	aukq:createEntityManager	()Laukp;
    //   10: astore 5
    //   12: aconst_null
    //   13: astore_3
    //   14: aconst_null
    //   15: astore_2
    //   16: aload 5
    //   18: invokevirtual 403	aukp:a	()Laukr;
    //   21: astore 4
    //   23: aload 4
    //   25: astore_2
    //   26: aload 4
    ...
    //   77: invokevirtual 425	aukp:b	(Lauko;)V
    //   80: goto -35 -> 45
    //   83: astore_1
    //   84: aload_2
    //   85: astore_3
    ...
    //   124: ifnull +7 -> 131
    //   127: aload_2
    //   128: invokevirtual 435	aukr:b	()V
    //   131: iconst_0
    //   132: ireturn
    //   133: aload 4
    //   135: astore_2
    ...
    //   138: astore_3
    //   139: aload 4
    //   141: invokevirtual 437	aukr:c	()V
    //   144: aload 4
    //   146: ifnull +8 -> 154
    //   149: aload 4
    //   151: invokevirtual 435	aukr:b	()V
    //   154: iconst_1
    //   155: ireturn
    //   156: astore_1
    //   157: aload_3
    //   158: ifnull +7 -> 165
    //   161: aload_3
    //   162: invokevirtual 435	aukr:b	()V
    //   165: aload_1
    //   166: athrow
    ...
    //   21	129	4	localaukr	aukr
    //   10	57	5	localaukp	aukp
    // Exception table:
    //   from	to	target	type
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> b(String paramString)
  {
    ...
    paramString = new aqkx().a(TroopIndex.class).a(new aqky[] { new aqky("ext1", paramString, true) }).a(true);
  ...
  public void b(ArrayList<FTSOptSync> paramArrayList)
  {
    ...
    this.jdField_a_of_type_Aktl.post(new FTSTroopOperator.2(this, paramArrayList));
  }
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      do
      {
        for (;;)
        {
          try
          {
            bool1 = aqkv.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, b());
            bool2 = bool1;
            bool2 = bool1;
          }
          catch (Throwable localThrowable1)
          {
            try
            {
              ...
              bool1 = aqkv.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, b());
              if (QLog.isColorLevel()) {
        ...
        i = aqkv.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, b());
        if (QLog.isColorLevel()) {
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase != null) && (this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.d()))
    {
      ...
      localObject1 = a((SQLiteDatabase)localObject1, localaukp);
      if (QLog.isColorLevel())
      {
      ...
      if (localFTSTroopSync.mOpt == 3)
      {
        ...
        localObject3 = this.jdField_a_of_type_Ajxl.b(String.valueOf(localFTSTroopSync.mMemberUin));
      ...
      for (;;)
      {
        ...
        n = aqkv.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, localArrayList, b(), 1);
        if (n != -1) {
        ...
        if (localObject4 != null)
        {
          localObject5 = localaukp.a(FTSTroopTime.class, FTSTroopTime.class.getSimpleName(), false, "mTroopUin=? ", new String[] { String.valueOf(localFTSTroopSync.mTroopUin) }, null, null, null, null);
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (((Iterator)localObject4).hasNext())
          {
            ...
            i3 = i;
            i1 = j;
            if (!bbbr.d(((TroopMemberInfo)localObject5).memberuin)) {
              break label1690;
            }
            i3 = i;
            i1 = j;
            localObject3 = this.jdField_a_of_type_Ajxl.b(String.valueOf(((TroopMemberInfo)localObject5).memberuin));
            if (localObject3 == null) {
              break label1702;
            }
            i3 = i;
      ...
      for (;;)
      {
        ...
        if ((QLog.isColorLevel()) || (l1 > 60000L))
        {
          ...
          axrn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).a(null, "actFTSTroopCost", true, l1, 0L, (HashMap)localObject2, null, false);
  ...
  public void f()
  {
    this.jdField_a_of_type_Aktl.post(new FTSTroopOperator.1(this));
  }
