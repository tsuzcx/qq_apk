  ...
  extends aktk
{
  ...
  public aktm(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, QQSettingMe paramQQSettingMe)
  {
  ...
  public void a(albr paramalbr, Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    ((aknx)paramQQAppInterface.getManager(153)).a(paramQQAppInterface, paramContext, this.jdField_d_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, "drawer");
  }
    ...
    do
    {
      do
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
          albi.a(paramalbr, this.jdField_a_of_type_JavaLangString, 9, this.e);
        }
      } while ((TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) || (this.jdField_a_of_type_JavaLangRefWeakReference == null));
      paramalbr = (QQSettingMe)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramalbr == null);
    paramalbr.a(this.jdField_c_of_type_JavaLangString);
  }
}
