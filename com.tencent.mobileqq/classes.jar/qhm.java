  ...
  implements ViewBase.OnClickListener
{
  ...
  public qhm(ArticleInfo paramArticleInfo, Context paramContext, int paramInt, String paramString)
  {
  ...
  private void a()
  {
    bgmp localbgmp = bgng.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString);
    if (localbgmp != null) {
      localbgmp.a();
    }
  }
  ...
  public void onClick(ViewBase paramViewBase)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rhw != null) && ((this.jdField_a_of_type_Int == 72) || (this.jdField_a_of_type_Int == 73)))
      {
        a("4");
        return;
      }
