...
public class ajfq
{
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    int j;
    if ((localaqxv == null) || (!localaqxv.a(paramQQAppInterface.getCurrentAccountUin())))
    {
      i = bdzy.a().a(paramQQAppInterface) + 0;
      if (QLog.isDevelopLevel()) {
        QLog.d("TroopNotificationUtils", 4, "getTroopNotificationUnreadNum notification count:" + i);
      }
      j = i + aoce.b(paramQQAppInterface);
      i = j;
      if (QLog.isDevelopLevel()) {
  ...
  public static Drawable a(FaceDecoder paramFaceDecoder, String paramString, int paramInt)
  {
    ...
    label68:
    for (localBitmap1 = bheg.f();; localBitmap1 = bheg.a()) {
