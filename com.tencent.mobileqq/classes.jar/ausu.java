...
public class ausu
{
  ...
  private ausw jdField_a_of_type_Ausw;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajed.aU + "capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    f = ajed.aU + "qav" + File.separator + "beauty" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      krx.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      krx.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  ...
  private static autb a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      krx.c("CaptureVideoFilterManager", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localautb = new autb(i, str1, str2);
        try
        {
          krx.c("CaptureVideoFilterManager", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localautb;
        }
      ...
      try
      {
        ...
        krx.c("CaptureVideoFilterManager", "parseConfig failed. info = " + localJSONObject);
        return localautb;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        krx.c("CaptureVideoFilterManager", "parseConfig|parse failed.context = " + paramString);
        return localautb;
      }
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      krx.c("CaptureVideoFilterManager", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  public static void a(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        krx.c("CaptureVideoFilterManager", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new axro();
          ((axro)localObject).jdField_a_of_type_Axrt = new ausy();
          ...
          ((axro)localObject).jdField_c_of_type_JavaLangString = (f + "skin_color.zip");
  ...
  {
    krx.c("CaptureVideoFilterManager", "setQQShortVideoFilterConfigVersion:" + paramInt);
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if ((paramString2 != null) && (!paramString2.equals("")))
      {
        ...
        krx.c("CaptureVideoFilterManager", "compareContent newList.size=0");
        bace.a(jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        long l2 = System.currentTimeMillis();
        krx.c("CaptureVideoFilterManager", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                krx.c("CaptureVideoFilterManager", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                krx.c("CaptureVideoFilterManager", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  private boolean a()
  {
    String str = bace.d("filter_template.cfg");
    boolean bool = b(str);
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      krx.c("CaptureVideoFilterManager", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = lbk.e();
    if (paramInt2 < paramInt1)
    {
      krx.c("CaptureVideoFilterManager", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = lbk.c();
    if (l < paramLong1)
    {
      krx.c("CaptureVideoFilterManager", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = babp.d();
    if (paramLong1 < paramLong2)
    {
      krx.c("CaptureVideoFilterManager", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      krx.c("CaptureVideoFilterManager", "getVideoEffectBeautyConfig:" + f + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return bace.b(localFile);
      }
      b(paramContext, 0);
  ...
  {
    krx.c("CaptureVideoFilterManager", "setVideoEffectBeautyConfigVersion:" + paramInt);
  ...
  private static boolean b(Context paramContext)
  {
    ...
    krx.c("CaptureVideoFilterManager", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  private boolean b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Ausw != null) {
  ...
  public void a()
  {
    this.jdField_a_of_type_Ausw = null;
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      krx.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig error ");
      return;
    }
    ...
    c();
    a(paramString);
    krx.c("CaptureVideoFilterManager", "updateQQShortVideoFilterConfig sendBroadcast");
    paramContext.sendBroadcast(new Intent("action_brocassreceiver_for_filter"));
  }
  
  public void a(ausw paramausw)
  {
    this.jdField_a_of_type_Ausw = paramausw;
  }
  
  public void a(auta paramauta)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() == 0)) {
      krx.c("CaptureVideoFilterManager", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      this.jdField_a_of_type_Auta = paramauta;
      krx.c("CaptureVideoFilterManager", "preDownloadResource list size: " + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      paramauta = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (paramauta.hasNext())
      {
        Object localObject1 = (FilterCategory)paramauta.next();
        if (((FilterCategory)localObject1).a != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            {
              krx.c("CaptureVideoFilterManager", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  krx.c("CaptureVideoFilterManager", "preDownloadResource icon " + (String)localObject2 + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject3 = new axro();
                    ((axro)localObject3).jdField_a_of_type_Axrt = new ausz(this);
                    ((axro)localObject3).jdField_a_of_type_JavaLangString = localFilterDesc.iconurl;
                    ((axro)localObject3).jdField_a_of_type_Int = 0;
                    ((axro)localObject3).jdField_c_of_type_JavaLangString = ((String)localObject2);
                    ((axro)localObject3).a(localFilterDesc);
                    kry.a().a((axsp)localObject3);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  krx.c("CaptureVideoFilterManager", "preDownloadResource file " + (String)localObject2 + "params.json" + " exist: " + ((File)localObject3).exists());
                  if (!((File)localObject3).exists())
                  {
                    localObject2 = new axro();
                    ((axro)localObject2).jdField_a_of_type_Axrt = new ausx(this);
                    ((axro)localObject2).jdField_a_of_type_JavaLangString = localFilterDesc.resurl;
                    ((axro)localObject2).jdField_a_of_type_Int = 0;
                    ((axro)localObject2).jdField_c_of_type_JavaLangString = (jdField_b_of_type_JavaLangString + localFilterDesc.name + ".zip");
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Auta == null));
    this.jdField_a_of_type_Auta.a(false);
  }
  ...
  public void b()
  {
    ...
    krx.c("CaptureVideoFilterManager", "init mFilterCategoryRaw size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size());
  }
  ...
  public void b(Context paramContext)
  {
    if (new File(f + "beauty_config.json").exists())
    {
      ...
      {
        krx.c("CaptureVideoFilterManager", "!JasonFile.exists()");
        a(paramContext);
      }
      return;
    }
    krx.c("CaptureVideoFilterManager", "BEAUTY_CONFIG  is not exsit");
  }
