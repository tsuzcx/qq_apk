...
class akog
  implements akoq
{
  akog(akof paramakof, byte[] paramArrayOfByte, int paramInt) {}
  
  public ToServiceMsg a()
  {
    ToServiceMsg localToServiceMsg = this.jdField_a_of_type_Akof.a.createToServiceMsg("MessageSvc.GetMsgV4");
