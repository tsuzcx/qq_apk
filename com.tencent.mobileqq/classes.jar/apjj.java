...
public class apjj
{
  public static int a(String paramString)
  {
    try
    {
      int i = apjl.a("arfeature", "v8.0.0", apjl.b("arfeature", "v8.0.0", "arfeature"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        apjl.a("arfeature", "v8.0.0", "arfeature", paramString2);
        try
        {
          apjh.a(paramString1, apjl.a("arfeature", "v8.0.0", apjl.b("arfeature", "v8.0.0", "arfeature")));
          paramString2 = apjl.a("arfeature", "v8.0.0", apjl.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bhmi.a(apjl.a("arfeature", "v8.0.0", apjl.b("arfeature", "v8.0.0", "arfeature")), false);
      ...
      try
      {
        ...
        {
          paramString1 = apjl.a("arfeature", "v8.0.0", apjl.b("arfeature", "v8.0.0", "arfeature")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          apjl.a("arfeature", "v8.0.0", "libARFeature", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(apjl.a("arfeature", "v8.0.0", apjl.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "libARFeature" + ".so").exists();
  }
}
