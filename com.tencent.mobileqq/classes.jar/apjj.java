  ...
  implements Handler.Callback
{
  ...
  private oidb_cmd0xb77.ImageInfo a(atqr paramatqr)
  {
    if (paramatqr == null) {
      return null;
    }
    ...
    localImageInfo.md5.set(paramatqr.d);
    localImageInfo.uuid.set(paramatqr.c);
    ...
    localImageInfo.file_id.set((int)paramatqr.b);
    return localImageInfo;
  }
  
  private oidb_cmd0xdc2.ReqBody a(String paramString1, String paramString2, Map<ResultRecord, atqr> paramMap)
  {
    oidb_cmd0xdc2.ReqBody localReqBody = new oidb_cmd0xdc2.ReqBody();
    localReqBody.msg_body.set(apmf.a(this.jdField_a_of_type_AndroidOsBundle, paramString1, paramString2, null));
    ...
    if (paramList.size() == 1)
    {
      ...
      if (((oidb_cmd0xdc2.BatchSendRsp)localObject1).err_code.get() == 901503)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          paramList = apmf.jdField_a_of_type_JavaLangString;
        }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    apmf.a(this.jdField_a_of_type_ComTencentMobileqqMiniShareOpensdkOpenSdkShareModel, this.jdField_a_of_type_AndroidOsBundle, paramString1.msg_body);
    ...
    apmt.a("KEY_STAGE_2_NORMAL_DC2");
    mmj.a(paramString2, new apjn(this), paramString1.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, atqr> paramMap)
  {
    ...
    apmt.a("KEY_STAGE_2_IMAGE_DC2");
    mmj.a(localAppRuntime, new apjm(this), paramMap.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, atqr> paramMap, ResultRecord paramResultRecord, oidb_cmd0xdc2.BatchSendReq paramBatchSendReq)
  {
    if (paramMap != null)
    {
      paramMap = a((atqr)paramMap.get(paramResultRecord));
      if (paramMap != null) {
  ...
  private boolean a(atqr paramatqr)
  {
  ...
  private void b()
  {
    ...
    WeakReference localWeakReference = new WeakReference(new apjk(this));
    ...
    apmt.a("KEY_STAGE_2_SEND_MSG_BY_SERVER");
    AbsShareMsg.sendSdkShareMessageByServer(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, str1, i, str2, (atqq)localWeakReference.get());
  }
  ...
  private void b(List<oidb_cmd0xdc2.BatchSendRsp> paramList)
  {
    ...
    {
      paramList = aciy.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Apik.b(this.jdField_a_of_type_AndroidAppActivity);
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity);
      return;
      paramList = aciy.a(localIntent, null);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(93);
    this.jdField_a_of_type_Apik.b(this.jdField_a_of_type_AndroidAppActivity);
    ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, apmf.jdField_a_of_type_JavaLangString);
  }
  ...
  private void d()
  {
    ...
    apmt.a("KEY_STAGE_2_UPLOAD_IMAGE_MULT");
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
  ...
  void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Apik = new apik();
  }
  ...
  void a(List<ResultRecord> paramList)
  {
    ...
    paramList = awuw.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    if (!badq.d(this.jdField_a_of_type_AndroidAppActivity))
    {
      ...
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, ajjy.a(2131639006));
      return;
    }
    a();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      return false;
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "MSG_SDK_SHARE_REQUEST_LOADING_STATUS");
      }
      this.jdField_a_of_type_Apik.a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_MqqOsMqqHandler.sendMessageDelayed(this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(94), 10000L);
      continue;
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "MSG_SDK_SHARE_REQUEST_TIMEOUT_STATUS");
      }
      this.jdField_a_of_type_Boolean = true;
      if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())
      {
        this.jdField_a_of_type_Apik.b(this.jdField_a_of_type_AndroidAppActivity);
        ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, ajjy.a(2131639005));
      }
      else
      {
        e();
