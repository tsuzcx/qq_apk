...
{
  public ahgv(ShortVideoRealItemBuilder paramShortVideoRealItemBuilder) {}
  ...
  public void onStateChange(long paramLong, int paramInt)
  {
    ...
    if (paramInt == 4)
    {
      ...
      if ((localObject != null) && (!bhbz.a().a(Long.valueOf(paramLong))))
      {
        ...
        do
        {
          do
          {
            do
            {
              ...
              ((ahha)localObject).a.setVisibility(0);
              this.a.a((ahha)localObject);
            } while (paramInt != 8);
            localObject = bhbz.a().a(Long.valueOf(paramLong));
          ...
          ShortVideoRealItemBuilder.a(this.a).removeCallbacksAndMessages(null);
          this.a.b((ahha)localObject);
          localObject = bhbz.a().a(Long.valueOf(paramLong));
        } while (localObject == null);
        this.a.a((MessageForShortVideo)localObject, 0L);
        return;
      } while (paramInt != 1);
      localMessageForShortVideo = bhbz.a().a(Long.valueOf(paramLong));
    } while (localMessageForShortVideo == null);
    ((ahha)localObject).a.setVisibility(0);
    this.a.c(localMessageForShortVideo, (ahha)localObject);
  }
}
