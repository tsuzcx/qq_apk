  ...
  extends alan
{
  ...
  public akzi(String paramString1, String paramString2)
  {
  ...
  public boolean a(agcb paramagcb, String paramString, float paramFloat1, int paramInt, float paramFloat2)
  {
    if ((paramagcb == null) || (TextUtils.isEmpty(paramString))) {}
    do
    {
      do
      {
        return false;
        paramagcb = alaa.a(paramagcb, 28, 28, paramFloat2);
        localObject1 = a(paramagcb);
        alaa.a(paramagcb);
      } while (localObject1 == null);
      Object localObject2 = a((float[][][][])localObject1);
      paramagcb = new HashSet();
      ...
      if (localObject2 != null)
      {
        ...
        while (paramInt < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          {
            ((List)localObject1).add(new akzk((String)this.jdField_a_of_type_JavaUtilList.get(paramInt), localObject2[paramInt]));
            if ((localObject2[paramInt] > paramFloat1) && (this.jdField_a_of_type_JavaUtilList.size() > paramInt)) {
              paramagcb.add(this.jdField_a_of_type_JavaUtilList.get(paramInt));
            }
          }
          paramInt += 1;
        }
      }
      Collections.sort((List)localObject1, new akzj(this));
      localObject2 = new StringBuilder();
      paramInt = 0;
      while ((paramInt < 20) && (paramInt < ((List)localObject1).size()))
      {
        akzk localakzk = (akzk)((List)localObject1).get(paramInt);
        ((StringBuilder)localObject2).append(localakzk.jdField_a_of_type_JavaLangString + ":" + localakzk.jdField_a_of_type_Float + "\n");
        paramInt += 1;
      }
      ...
      if (paramagcb.contains(paramString))
      {
        if (QLog.isColorLevel()) {
