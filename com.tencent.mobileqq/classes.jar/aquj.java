...
class aquj
  implements aquk
{
  aquj(aqug paramaqug, long paramLong1, SubMsgType0xaa.GameTeam_StartGameMessage paramGameTeam_StartGameMessage, long paramLong2, boolean paramBoolean) {}
  
  public void a(String paramString)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)aqug.a(this.jdField_a_of_type_Aqug).get();
    ...
    for (;;)
    {
      ...
      catch (JSONException paramString)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_Long < j)
          {
            ...
            if ((i > 0) && (i < 5))
            {
              ...
              bded.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2044", "0", false);
              return;
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            bded.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2044", "1", false);
            return;
          }
        }
        catch (JSONException localJSONException)
        {
          ...
          bded.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2043", "0", false);
          return;
        }
        bded.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2043", "1", false);
      }
    }
  }
}
