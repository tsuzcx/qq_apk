...
public class aqdj
{
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new aqdk(this);
  private AudioManager jdField_a_of_type_AndroidMediaAudioManager;
  private aqdl jdField_a_of_type_Aqdl;
  private bdks jdField_a_of_type_Bdks;
  private BaseActivity jdField_a_of_type_ComTencentMobileqqAppBaseActivity;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public aqdj(aqdl paramaqdl, BaseActivity paramBaseActivity)
  {
  ...
  public boolean a(String arg1)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (!arof.a(???))
        {
          str = banc.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getCurrentAccountUin(), MD5.toMD5(???), 23, null);
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Bdks = new bdks(str, new Handler(), 1);
      this.jdField_a_of_type_Bdks.b();
      this.jdField_a_of_type_Bdks.a(this.jdField_a_of_type_Aqdl);
