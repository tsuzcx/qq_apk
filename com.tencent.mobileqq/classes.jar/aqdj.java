  ...
  implements aqdf
{
  ...
  private void a(Context paramContext, int paramInt)
  {
    String str = "";
    if (paramInt == 1) {
      str = paramContext.getString(2131692192);
    }
  ...
  private void b(Context paramContext, ColorNote paramColorNote)
  {
    ...
    paramColorNote = new atpw((QQAppInterface)localObject, paramContext, paramColorNote, 10001);
    localObject = new Bundle();
    ((Bundle)localObject).putBoolean("from_qlink_enter_recent", false);
    paramColorNote.a((Bundle)localObject);
    paramContext = new atpy(paramContext, paramColorNote);
    paramContext.a(14);
  ...
  private void c(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      paramColorNote = bfsj.a(localQQAppInterface, l, paramColorNote.getString("file_color_note_file_uuid"), paramColorNote.getString("file_color_note_file_url"), paramColorNote.getString("file_color_note_fileName"), paramColorNote.getLong("file_color_note_fileSize"), paramColorNote.getInt("file_color_note_busId"));
      if (paramColorNote == null)
      {
        a(paramContext, 1);
        return;
    ...
    paramContext = new atpy(paramContext, new atqc(localQQAppInterface, paramContext, l, paramColorNote, -1));
    paramContext.a(14);
  ...
  private void d(Context paramContext, ColorNote paramColorNote)
  {
    ...
    int i = atwt.a(paramColorNote.getSubType());
    paramColorNote = new atpw((QQAppInterface)localObject, paramContext, atvo.a(FileInfo.a(str)), 10000);
    localObject = new Bundle();
  ...
  private void e(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      if (paramColorNote != null)
      {
        paramContext = new atpy(paramContext, new atpx(paramContext, atvo.a(paramColorNote)));
        paramContext.a(14);
        paramContext.b(268435456);
        paramContext.a();
        return;
  ...
  private void f(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      localObject = new atqd((QQAppInterface)localObject, paramContext, localWeiYunFileInfo);
      ((atqd)localObject).a(paramColorNote);
      paramContext = new atpy(paramContext, (atqb)localObject);
      paramContext.a(14);
      paramContext.b(268435456);
      paramContext.a();
      return;
  ...
  public void a(Context paramContext, ColorNote paramColorNote)
  {
    ...
    do
    {
      ...
      i = atwt.a(paramColorNote.getSubType());
      if (i == -1)
      {
