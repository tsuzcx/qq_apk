  ...
  extends WebViewPlugin
{
  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      localTextView4.setOnClickListener(new aqdk(this));
      localTextView3.setOnClickListener(new aqdl(this));
      ...
      for (;;)
      {
        ...
        for (i = j;; i = 1)
        {
          ...
          if (((String)localObject1).equals("ask"))
          {
            ...
            a(paramString.getString(2131690127));
  ...
  protected void b()
  {
    ...
    QQToast.a(localActivity, anzj.a(2131699631), 0).a();
  }
