...
public class mvs
{
  ...
  public mvs(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoEffectCoreQqavimageQQAVImageFilter = new mvu();
  ...
  mvt a(QQAVImageFilter paramQQAVImageFilter, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramQQAVImageFilter != null)
    {
      ...
      return new mvt(this, paramInt3, paramInt4);
    }
    return new mvt(this, paramInt1, paramInt2);
  }
