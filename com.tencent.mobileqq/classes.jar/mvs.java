...
public class mvs
{
  ...
  private mvs(Context paramContext)
  {
    ...
    this.jdField_a_of_type_OicqWlogin_sdkRequestWtTicketPromise = new mvu(this);
    ...
    this.jdField_a_of_type_Myp = new myp(this.jdField_a_of_type_AndroidContentSharedPreferences);
    this.jdField_a_of_type_Myq = new myq(this.jdField_a_of_type_AndroidContentSharedPreferences, this.jdField_a_of_type_Myp);
    this.jdField_a_of_type_Myp.a(this.jdField_a_of_type_Myq);
    FlatBuffersParser.f();
    k();
  ...
  public static mvs a()
  {
    if (jdField_a_of_type_Mvs == null) {}
    try
    {
      if (jdField_a_of_type_Mvs == null) {
        jdField_a_of_type_Mvs = new mvs(BaseApplication.getContext());
      }
      jdField_a_of_type_Mvs.a();
      if (!jdField_a_of_type_Mvs.a(true)) {
        jdField_a_of_type_Mvs.i();
      }
      return jdField_a_of_type_Mvs;
    }
    finally {}
  }
  
  public static mvs a(boolean paramBoolean)
  {
    if (jdField_a_of_type_Mvs == null) {}
    try
    {
      ...
      jdField_a_of_type_Mvs.a();
      jdField_a_of_type_Mvs.a(paramBoolean);
      return jdField_a_of_type_Mvs;
    }
    finally {}
  }
  ...
  private JSONArray a(String paramString)
  {
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 139	mvs:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   25: aload_1
    ...
    //   40: ifnonnull -22 -> 18
    //   43: aload_0
    //   44: getfield 139	mvs:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   47: astore 8
    //   49: aload 8
    //   51: monitorenter
    //   52: aload_0
    //   53: getfield 139	mvs:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   56: aload_1
    ...
    //   74: aload_0
    //   75: getfield 192	mvs:jdField_a_of_type_Myq	Lmyq;
    //   78: aload_1
    //   79: invokevirtual 359	myq:a	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   82: astore 6
    //   84: aload 6
    //   86: ifnonnull +195 -> 281
    //   89: new 80	org/json/JSONArray
    //   92: dup
    //   93: getstatic 62	mvs:jdField_a_of_type_AndroidSupportV4UtilArrayMap	Landroid/support/v4/util/ArrayMap;
    //   96: aload_1
    ...
    //   188: astore 6
    //   190: aload_0
    //   191: getfield 139	mvs:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   194: aload_1
    //   195: aload 6
    //   197: invokevirtual 370	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   200: pop
    //   201: aload_0
    //   202: getfield 141	mvs:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   205: aload_1
    ...
    //   297: dup
    //   298: getstatic 62	mvs:jdField_a_of_type_AndroidSupportV4UtilArrayMap	Landroid/support/v4/util/ArrayMap;
    //   301: ldc 44
  ...
  private JSONObject a()
  {
    ...
    {
      localObject = this.jdField_a_of_type_Myq.a();
  ...
  private JSONObject b()
  {
    ...
    {
      str = this.jdField_a_of_type_Myq.b();
  ...
  public java.lang.Boolean a(String paramString1, String paramString2)
  {
    ...
    //   61: ldc 239
    //   63: ldc 239
    //   65: invokestatic 500	bamv:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   68: ldc 161
    //   70: iconst_1
    //   71: ldc_w 502
    ...
    //   130: astore 5
    //   132: aload_0
    //   133: getfield 504	mvs:jdField_c_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   136: astore_1
    ...
    //   145: aload_0
    //   146: getfield 192	mvs:jdField_a_of_type_Myq	Lmyq;
    //   149: invokevirtual 506	myq:c	()Ljava/lang/String;
    //   152: astore 6
    //   154: aload 6
    //   156: ifnull +101 -> 257
    ...
    //   192: aload_0
    //   193: aload_1
    //   194: putfield 504	mvs:jdField_c_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   197: aload_1
    //   198: ldc_w 510
    ...
    //   227: aload 5
    //   229: invokestatic 515	mvs:b	(Ljava/lang/String;Ljava/lang/String;)Z
    //   232: ifeq +33 -> 265
    //   235: iconst_1
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (paramString1 = this.jdField_a_of_type_Myp.a(localEditor, paramString1); paramString1 == null; paramString1 = this.jdField_a_of_type_Myq.a(localEditor, paramString1)) {
      return;
    }
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      ...
      localEditor.putString("qqVersion", "2013 8.3.0");
      ...
      axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_ok", 0, 1, 0, "", "", "", "");
    }
    for (;;)
    {
      localEditor.commit();
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    if ("file".equals(str))
    {
      ...
      for (;;)
      {
        bamv.a("webview", "file_js", paramString1, "", "", "");
    ...
    System.currentTimeMillis();
    int j = this.jdField_a_of_type_Myq.a(localUri.getHost(), paramString2);
    if (myo.a(j)) {
      return true;
    }
    if (myo.b(j)) {
    ...
    if (sfk.a(paramString1)) {
      return (!TextUtils.isEmpty(paramString2)) && (sfk.a(paramString1, paramString2));
    }
    return false;
  }
  ...
  {
    return bcgq.a(paramJSONObject, "sonicWhiteList");
  }
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_b_of_type_OrgJsonJSONArray == null) && (!a()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "CgiConfig loadfromsp fail , url: " + nau.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((this.jdField_b_of_type_OrgJsonJSONArray.length() != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "CgiConfig hit , url: " + nau.b(paramString, new String[0]) + " domain: " + str2);
                break label247;
              }
            }
          }
    ...
    if ((localObject2 != null) && (localObject1 != null) && (((AppRuntime)localObject1).isLogin()))
    {
      ...
      if ((localObject2 != null) && (((JSONArray)localObject2).length() > 0))
      {
        ...
        if (j < ((JSONArray)localObject2).length())
        {
          ...
          {
            if (bcgq.a(localJSONObject, "X5Config"))
            {
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_c_of_type_OrgJsonJSONArray == null) && (!b()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "AsyncCheckConfig loadfromsp fail , url: " + nau.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "AsyncCheckConfig hit , url: " + nau.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    if ("file".equals(paramString1))
    {
      ...
      {
        bamv.a("webview", "file_scheme", paramString1, "", "", "");
        QLog.e("AuthorizeConfig", 1, "action deprecated with file protocol");
        return false;
      }
    }
    ...
    for (;;)
    {
      try
      {
        paramString1 = this.jdField_a_of_type_Myq.a();
        if (paramString1 == null)
        {
          try
          {
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_d_of_type_OrgJsonJSONArray == null) && (!c()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "SkipInputWarningConfig loadfromsp fail , url: " + nau.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "SkipInputWarningConfig hit , url: " + nau.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
  ...
  public boolean e()
  {
    ...
    //   11: aload_0
    //   12: iload_1
    //   13: putfield 132	mvs:jdField_a_of_type_Int	I
    //   16: invokestatic 888	mxv:d	()Ljava/lang/String;
    //   19: astore_3
    //   20: aload_3
    ...
    //   68: putfield 892	mvs:jdField_e_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   71: invokestatic 894	mxv:e	()Ljava/lang/String;
    //   74: astore_3
    //   75: aload_3
    ...
    //   123: putfield 898	mvs:jdField_f_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   126: iload_2
    //   127: iconst_m1
    //   128: if_icmpeq +138 -> 266
    //   131: aload_0
    //   132: getfield 892	mvs:jdField_e_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   135: ifnull +131 -> 266
    //   138: aload_0
    //   139: getfield 898	mvs:jdField_f_of_type_OrgJsonJSONArray	Lorg/json/JSONArray;
    //   142: ifnull +124 -> 266
    //   145: iconst_1
    //   146: ireturn
    //   147: iconst_0
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_e_of_type_OrgJsonJSONArray == null) && (!e()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "forceHttpsConfig loadfromsp fail , url: " + nau.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "forceHttpsConfig hit , url: " + nau.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
      ...
      try
      {
        if (!TextUtils.isEmpty(paramString))
        {
          if ((this.jdField_f_of_type_OrgJsonJSONArray == null) && (!e()))
          {
            if (QLog.isColorLevel())
            {
              QLog.d("AuthorizeConfig", 2, "forceHttpsExcludeConfig loadfromsp fail , url: " + nau.b(paramString, new String[0]));
              return false;
            }
          }
          else
          {
            ...
            if ((k != 0) && (!TextUtils.isEmpty(str1)))
            {
              ...
              if (j < k)
              {
                ...
                QLog.d("AuthorizeConfig", 2, "forceHttpsExcludeConfig hit , url: " + nau.b(paramString, new String[0]) + " domain: " + str2);
                break label253;
              }
            }
          }
  ...
  public void g()
  {
    ...
    if (((amws)ampl.a().a(585)).jdField_a_of_type_Int == 1)
    {
  ...
  public boolean g(String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("AuthorizeConfig", 2, "isInSonicWhiteList: " + bool + ", url: " + nau.b(paramString, new String[0]));
      }
      return bool;
  ...
  public boolean i(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramString = this.jdField_a_of_type_Myq.a();
        if (paramString == null)
        {
          try
          {
  ...
  public void j()
  {
    ...
    while (localObject1 != null)
    {
      ...
      if (localObject2 == null)
      {
        ...
        localObject1 = anqu.a("download_FuncDev_webview", "", 0, null);
        anvq.a().b((Bundle)localObject1);
        localObject1 = localObject2;
      }
    }
