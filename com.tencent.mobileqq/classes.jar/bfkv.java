...
public class bfkv
  extends bfch
{
  public bfkv(TroopPicEffectsEditActivity paramTroopPicEffectsEditActivity) {}
  
  public void a(SparseArray<bfcu> paramSparseArray)
  {
    int j = 0;
    this.a.jdField_a_of_type_AndroidUtilSparseArray = paramSparseArray;
    Object localObject = (bfcu)this.a.jdField_a_of_type_AndroidUtilSparseArray.get(this.a.jdField_a_of_type_Int);
    if (localObject != null)
    {
      paramSparseArray = ((bfcu)localObject).a;
      if (localObject == null) {
        break label120;
      }
      localObject = ((bfcu)localObject).b;
      label55:
