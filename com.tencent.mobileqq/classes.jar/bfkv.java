  ...
  implements BluetoothProfile.ServiceListener
{
  ...
  public bfkv(TraeAudioManager paramTraeAudioManager)
  {
  ...
  void a(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          else
          {
            ...
            this.jdField_a_of_type_Bfkz.a("DEVICE_BLUETOOTHHEADSET", true);
            localObject = this.jdField_a_of_type_Bfkz;
            if (paramIntent == null) {
              break label525;
            }
          }
          ...
          {
            ((bfkz)localObject).a(paramContext);
            return;
            paramContext = " ";
            break;
            paramContext = "null";
      ...
      if (QLog.isColorLevel()) {
        QLog.w("BluetoohHeadsetCheck", 2, "   EXTRA_SCO_AUDIO_STATE " + b(i) + "  Bluetooth visible:" + this.jdField_a_of_type_Bfkz.b("DEVICE_BLUETOOTHHEADSET"));
      }
    } while (!QLog.isColorLevel());
    label519:
    label525:
  ...
  public boolean a(Context paramContext, bfkz parambfkz)
  {
    ...
    if ((paramContext == null) || (parambfkz == null)) {
      if (QLog.isColorLevel()) {
