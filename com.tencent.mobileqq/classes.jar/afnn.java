...
public class afnn
  extends anuw
{
  public afnn(ShowReactiveActivity paramShowReactiveActivity) {}
  ...
  protected void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      ...
      {
        localObject = ((anyw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  protected void onSetCalReactiveDays(boolean paramBoolean)
  {
    ...
    {
      localObject1 = ((anyw)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
      localObject2 = this.a;
      localSwitch = this.a.a.a();
