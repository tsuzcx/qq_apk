  ...
  implements aobr
{
  ...
  private aocb jdField_a_of_type_Aocb;
  private aocc jdField_a_of_type_Aocc;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public aoby(QQAppInterface paramQQAppInterface)
  {
  ...
  public Bitmap a(int paramInt1, String paramString, int paramInt2, byte paramByte)
  {
    ...
    for (Object localObject = GroupIconHelper.a(paramString);; localObject = paramString)
    {
      ...
      for (;;)
      {
        ...
        {
          anks localanks = (anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
          if ((localanks != null) && (localanks.a() != null)) {
            localanks.a().f(paramString);
          }
          if (this.jdField_a_of_type_Aoca == null)
          {
            this.jdField_a_of_type_Aoca = new aoca(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aoca);
          }
        }
        return localObject;
      }
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long paramLong)
  {
    ...
    do
    {
      ...
      for (byte b = 1;; b = 0)
      {
        ...
        if (this.jdField_a_of_type_Aocb == null)
        {
          this.jdField_a_of_type_Aocb = new aocb(this, null);
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aocb);
        }
        if (paramInt1 != 32) {
          break;
        }
  ...
  public void a(AppInterface paramAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    do
    {
      ...
      if (paramAppInterface != null)
      {
        ...
        aobu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramAppInterface);
      }
  ...
  public void a(FaceInfo paramFaceInfo, Bitmap paramBitmap)
  {
    ...
    {
      localFaceInfo.a(j, i);
      if ((this.jdField_a_of_type_Aobx == null) || (paramBitmap == null)) {
        break;
      }
      this.jdField_a_of_type_Aobx.onDecodeTaskCompleted(this.jdField_b_of_type_Int + this.jdField_a_of_type_JavaUtilLinkedList.size(), paramFaceInfo.jdField_a_of_type_Int, paramFaceInfo.jdField_a_of_type_JavaLangString, paramBitmap);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        } while (this.jdField_a_of_type_Aobx == null);
        this.jdField_a_of_type_Aobx.onDecodeTaskCompleted(this.jdField_b_of_type_Int + this.jdField_a_of_type_JavaUtilLinkedList.size(), paramInt1, paramString, localBitmap);
        return;
  ...
  public void d()
  {
    ...
    aoca localaoca = this.jdField_a_of_type_Aoca;
    aocb localaocb = this.jdField_a_of_type_Aocb;
    aocc localaocc = this.jdField_a_of_type_Aocc;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_Aoca = null;
    this.jdField_a_of_type_Aocc = null;
    this.jdField_a_of_type_Aocb = null;
    if (localQQAppInterface != null)
    {
      if (localaoca != null) {
        localQQAppInterface.removeObserver(localaoca);
      }
      if (localaocb != null) {
        localQQAppInterface.removeObserver(localaocb);
      }
      if (localaocc != null) {
        localQQAppInterface.removeObserver(localaocc);
      }
    }
    super.d();
  }
  ...
  protected void e()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if (((((FaceInfo)localObject2).jdField_a_of_type_Int == 101) || (((FaceInfo)localObject2).jdField_a_of_type_Int == 1001)) && (this.jdField_a_of_type_Aoca == null))
          {
            this.jdField_a_of_type_Aoca = new aoca(this, null);
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aoca);
          }
          if (((((FaceInfo)localObject2).jdField_a_of_type_Int == 4) || (((FaceInfo)localObject2).jdField_a_of_type_Int == 113)) && (!bfup.a(((FaceInfo)localObject2).jdField_a_of_type_JavaLangString)))
          {
            if (this.jdField_a_of_type_Aocc == null) {
              this.jdField_a_of_type_Aocc = new aocc(this, null);
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aocc);
          }
          this.jdField_b_of_type_Int += 1;
    ...
    axei.a("Q.qqhead.FaceDecoderImpl", new Object[] { "runNextTask", localObject2, localObject1 });
  }
}
