...
public class aoby
{
  ...
  public aoby(MessageHandler paramMessageHandler, StringBuilder paramStringBuilder, int paramInt)
  {
  ...
  public aoby a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        if (((!this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.a().a(false)) && (!((Boolean)MessageHandler.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler).get(str)).booleanValue())) || (l2 >= l1)) {
          break label232;
        }
