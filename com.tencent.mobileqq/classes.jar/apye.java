...
public class apye
  implements apzf
{
  public apye(QQGamePubAccountFragment paramQQGamePubAccountFragment) {}
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt < QQGamePubAccountFragment.a(this.a).size())
    {
      ...
      for (;;)
      {
        ...
        yez.a(aing.a(), "769", "205017", this.a.a(paramInt), "76901", "1", "160", new String[] { apyr.a((MessageRecord)QQGamePubAccountFragment.a(this.a).get(paramInt)), "" + paramInt, "8" });
        ((baot)QQGamePubAccountFragment.a(this.a).a(71)).a(2, ((MessageRecord)QQGamePubAccountFragment.a(this.a).get(0)).getExtInfoFromExtStr("pa_msgId"), "");
        return;
        this.a.b(false);
      }
    }
