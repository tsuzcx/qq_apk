  ...
  extends Toast
{
  ...
  public bdiv(Context paramContext)
  {
    super(paramContext);
  ...
  public void cancel()
  {
    try
    {
      bdnw.a("QQToast", "cancel!");
      bdew.c().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
      if (!bdit.a(getView().getContext(), false))
      {
        super.cancel();
        return;
      }
  ...
  public void show()
  {
    ...
    if (bdit.a())
    {
      ...
      jdField_a_of_type_AndroidViewWindowManager$LayoutParams.windowAnimations = 2131690151;
    }
    for (;;)
    {
      try
      {
        ...
        localObject2 = (TextView)getView().findViewById(2131311708);
        if ((localObject2 != null) && (((TextView)localObject2).getText().length() < 6))
        {
          l = 900L;
          bdew.c().postDelayed(this.jdField_a_of_type_JavaLangRunnable, l);
          bdnw.a("QQToast", "show");
          if (!bdit.a(getView().getContext(), false))
          {
            super.show();
      ...
      {
        bdnw.d("QQToast", localException.getMessage(), localException);
        continue;
