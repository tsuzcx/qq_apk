  ...
  implements Manager
{
  ...
  public bjxa(AppInterface paramAppInterface)
  {
  ...
  {
    String str = ContactUtils.getFriendShowName(paramQQAppInterface, paramString);
    if ((TextUtils.isEmpty(str)) || (str.equals(paramString)))
    {
      paramQQAppInterface = ((bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER)).a(String.valueOf(paramString));
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          ...
          localbjxa.a(localBmqqAccountType);
          if (!bool1) {
            continue;
          }
          QidianExternalInfo localQidianExternalInfo = localbjxa.a(paramString);
          paramString = localbjxa.a(paramString);
          if ((localQidianExternalInfo != null) && (paramString != null)) {
            continue;
          }
          if (bkyq.a()) {
            ThreadManager.post(new QidianManager.10(localbjxa, paramQQAppInterface, localBmqqAccountType), 5, null, true);
          }
        }
        else
        {
        ...
        localbjxa.b(paramQQAppInterface.getApp().getBaseContext(), localBmqqAccountType);
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    try
    {
      ...
      if (!nut.a(paramString1)) {
        return;
      }
      ((bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER)).h.put(paramString1, paramString2);
      return;
    }
    catch (Exception paramQQAppInterface) {}
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    {
      localbjxa = (bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER);
      if (bkyq.a()) {
        ThreadManager.postImmediately(new QidianManager.9(localbjxa, paramQQAppInterface, paramArrayOfFriends), null, false);
      }
    }
    else
    {
    ...
    localbjxa.b(paramQQAppInterface, paramArrayOfFriends);
  }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.contains("isNeedReply=")) && (paramString1.contains("QidianKfUin=")))
    {
      ...
      if (bool2)
      {
        ...
        SosoInterface.startLocation(new bjxb(this, 1, true, true, 0L, true, false, "QidianManager", paramString1, paramInt1, str3, paramInt2, str2, str1, paramString2));
      }
    }
    label364:
    while (!QLog.isColorLevel())
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return ((((bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER)).a(paramMessageRecord.frienduin)) || (paramMessageRecord.istroop == 1024)) && (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("is_eman_sc_message")));
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    return ((bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER)).e(paramString);
  }
  
  private boolean a(String paramString, int paramInt)
  {
    Object localObject = (anvk)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
    if (localObject != null)
    {
      localObject = ((anvk)localObject).b(paramString);
  ...
  private void b(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    //   15: astore 9
    //   17: aload 9
    //   19: getfield 403	com/tencent/mobileqq/data/Friends:uin	Ljava/lang/String;
    //   22: astore 10
    //   24: aload 9
    //   26: getfield 400	com/tencent/mobileqq/data/Friends:cSpecialFlag	B
    //   29: istore 5
    //   31: aload 10
    //   33: invokestatic 339	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   36: pop2
    //   37: aload 10
    //   39: invokestatic 344	nut:a	(Ljava/lang/String;)Z
    //   42: ifne +4 -> 46
    //   45: return
    //   46: iload 5
    //   48: invokestatic 347	bjxa:b	(I)Z
    //   51: istore 6
    //   53: iload 5
    //   55: invokestatic 349	bjxa:a	(I)Z
    //   58: istore 7
    //   60: iload 5
    //   62: invokestatic 351	bjxa:c	(I)Z
    //   65: istore 8
    //   67: iload 6
    //   69: ifne +60 -> 129
    //   72: iload 7
    ...
    //   132: iload 6
    //   134: ifeq +109 -> 243
    //   137: new 361	com/tencent/qidian/data/BmqqAccountType
    //   140: dup
    //   141: aload 10
    //   143: bipush 6
    //   145: invokespecial 364	com/tencent/qidian/data/BmqqAccountType:<init>	(Ljava/lang/String;I)V
    //   148: astore 9
    //   150: aload 9
    //   152: ifnull +133 -> 285
    //   155: aload_0
    //   156: aload 10
    //   158: invokevirtual 600	bjxa:a	(Ljava/lang/String;)I
    //   161: aload 9
    //   163: invokevirtual 604	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   166: if_icmpeq +119 -> 285
    //   169: aload_0
    //   170: getfield 50	bjxa:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   173: aload 10
    //   175: aload 9
    //   177: invokevirtual 604	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   180: invokestatic 609	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   183: invokeinterface 412 3 0
    //   188: pop
    //   189: iload 6
    //   191: ifeq +94 -> 285
    //   194: aload_0
    //   195: aload 10
    //   197: invokevirtual 132	bjxa:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianExternalInfo;
    //   200: astore 11
    //   202: aload_0
    //   203: aload 10
    //   205: invokevirtual 370	bjxa:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianProfileUiInfo;
    //   208: astore 10
    //   210: aload 11
    //   212: ifnull +8 -> 220
    //   215: aload 10
    ...
    //   220: aload_0
    //   221: aload_1
    //   222: invokevirtual 382	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   225: invokevirtual 388	com/tencent/qphone/base/util/BaseApplication:getBaseContext	()Landroid/content/Context;
    //   228: aload 9
    //   230: invokevirtual 391	bjxa:b	(Landroid/content/Context;Lcom/tencent/qidian/data/BmqqAccountType;)Z
    //   233: pop
    //   234: goto +51 -> 285
    //   237: astore_1
    //   238: aload_1
    ...
    //   243: iload 7
    //   245: ifeq +18 -> 263
    //   248: new 361	com/tencent/qidian/data/BmqqAccountType
    //   251: dup
    //   252: aload 10
    //   254: iconst_1
    //   255: invokespecial 364	com/tencent/qidian/data/BmqqAccountType:<init>	(Ljava/lang/String;I)V
    //   258: astore 9
    //   260: goto -110 -> 150
    //   263: iload 8
    //   265: ifeq -115 -> 150
    //   268: new 361	com/tencent/qidian/data/BmqqAccountType
    //   271: dup
    //   272: aload 10
    //   274: iconst_3
    //   275: invokespecial 364	com/tencent/qidian/data/BmqqAccountType:<init>	(Ljava/lang/String;I)V
    //   278: astore 9
    //   280: goto -130 -> 150
    //   283: astore_1
    //   284: return
  ...
  {
    return ((bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER)).f(paramString);
  }
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (nwu.b(paramQQAppInterface, paramString, 0)) {
        return 3;
      }
    } while (a(paramString));
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      return String.format(paramContext.getString(2131698273), new Object[] { paramString });
    }
    return paramContext.getString(2131698272);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = bdof.a(paramString.getBytes(), 0);
    ...
    } while ((localFragmentActivity.getChatFragment() == null) || (!localFragmentActivity.getChatFragment().a.sessionInfo.curFriendUin.equals(localObject1)));
    paramString = (MessageForStructing)bcsa.a(-2011);
    paramString.msgtype = -2011;
    paramString.istroop = localFragmentActivity.getChatFragment().a.sessionInfo.curType;
    ...
    for (;;)
    {
      ...
      if (anyv.a(paramQQAppInterface, paramString, false)) {
        break;
      }
      ((ArrayList)localObject1).add(paramString);
      paramQQAppInterface.getMessageFacade().addMessageCacheOnly((List)localObject1, String.valueOf(paramQQAppInterface.getCurrentAccountUin()));
      return;
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localMessageRecord != null) && (paramInt == localMessageRecord.istroop)) {
          ((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).getMessageFacade().removeMsgByUniseq(paramString, localMessageRecord.istroop, localMessageRecord.uniseq);
        }
      }
    }
  }
  ...
  {
    ((bjyi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).a(paramString1, paramInt1, paramBoolean, 0.0D, 0.0D, paramString2, paramInt2, paramString3, paramString4, paramString5);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ((bjyi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).a(paramString1, paramString2, paramString3);
      return;
  ...
  {
    if ((!nut.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (nut.a(null, paramString))) {
      ((anri)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER)).a(paramString, paramBoolean);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext()) {
      ((bjxc)localIterator.next()).a(paramBoolean);
    }
  }
      ...
      try
      {
        ...
        if (nut.a(paramContext))
        {
          ...
          default: 
            return false;
          case 1: 
            ((bjyi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).b(l);
            return true;
          }
          ((bjyi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).d(l);
          return true;
        }
      }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      Long.parseLong(paramString);
      if (!nut.a(paramString)) {}
      while ((nut.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!nut.a(null, paramString))) {
        return false;
      }
  ...
  {
    ((anri)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER)).d(paramString);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (nut.a(paramContext))
        {
          ...
          case 0: 
          case 2: 
            ((nuq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.BMQQ_BUSINESS_HANDLER)).a(paramContext);
            return true;
          case 1: 
            ((bjyi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).a(l);
            return true;
          }
          ((bjyi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).c(l);
          return true;
        }
      }
      catch (Exception paramContext) {}
