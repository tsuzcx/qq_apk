...
public class asbt
  extends asbv
{
  private LinkedList<asbu> a = new LinkedList();
  private QQAppInterface b;
  private boolean d;
  
  public asbt(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(asbu paramasbu)
  {
    synchronized (this.a)
    {
      if (!this.a.contains(paramasbu)) {
        this.a.add(paramasbu);
      }
      return;
    }
  }
  ...
  public void b(asbu paramasbu)
  {
    synchronized (this.a)
    {
      this.a.remove(paramasbu);
      return;
    }
  }
