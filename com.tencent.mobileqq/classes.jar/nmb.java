...
public final class nmb
  implements Runnable
{
  public nmb(ShareSinaData paramShareSinaData, ApplicationInfo paramApplicationInfo, Context paramContext, StoryShareCallback paramStoryShareCallback) {}
  ...
  public void run()
  {
    ...
    ThreadManager.getUIHandler().post(new nmc(this));
  }
}
