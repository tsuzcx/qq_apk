...
public class lpr
{
  ...
  public BeautyRender a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender == null) {
      this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender = new BeautyRender(VideoController.a().a(), lco.h());
    }
    if (paramInt == this.jdField_a_of_type_Int) {
      return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
    }
    this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender.setBeautyLevel(paramInt * 1.0F / 100.0F * lpv.a());
    this.jdField_a_of_type_Int = paramInt;
    return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
  }
  
  public lqj a(int paramInt1, int paramInt2, lqj paramlqj, FilterDesc paramFilterDesc, int paramInt3)
  {
    if (!lpv.a()) {}
    ...
    for (;;)
    {
      paramlqj = localBeautyRender.process(paramlqj.b, paramlqj.jdField_a_of_type_Int, paramInt1, paramInt2);
      return lqj.a(paramlqj.getFbo(), paramlqj.getTextureId());
  ...
  public byte[] a(int paramInt1, int paramInt2, byte[] paramArrayOfByte, FilterDesc paramFilterDesc, int paramInt3)
  {
    ...
    {
      lcl.e("AVSDKBeautyRender", "(mHeight * mWidth * 3 / 2) != yuvData.length");
      return paramArrayOfByte;
    }
    ...
    for (;;)
    {
      ...
      {
        lcl.e("AVSDKBeautyRender", "convertI420ToNV21 or convertI420ToNV12 e = " + paramArrayOfByte.getMessage());
