...
public class auvt
  implements View.OnClickListener, View.OnLongClickListener, bfps
{
  private BackgroundColorSpan jdField_a_of_type_AndroidTextStyleBackgroundColorSpan;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private ausf jdField_a_of_type_Ausf;
  private auvu jdField_a_of_type_Auvu;
  
  private auvt(TextView paramTextView, ausf paramausf)
  {
  ...
  public static void a(TextView paramTextView, String paramString)
  {
    if (paramTextView != null)
    {
      ...
      localausf.a(paramString, str);
      paramTextView.setOnLongClickListener(new auvt(paramTextView, localausf));
      paramTextView.setText(paramTextView.getText(), TextView.BufferType.SPANNABLE);
    }
  }
  
  public static void a(TextView paramTextView, String paramString1, String paramString2, auvu paramauvu)
  {
    if (paramTextView != null)
    {
      ausf localausf = new ausf(paramString1);
      localausf.a(paramString2, paramString1);
      paramString1 = new auvt(paramTextView, localausf);
      paramString1.a(paramauvu);
      paramTextView.setOnLongClickListener(paramString1);
      paramTextView.setText(paramTextView.getText(), TextView.BufferType.SPANNABLE);
    }
  }
  
  private void a(auvu paramauvu)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    label93:
    for (str = this.jdField_a_of_type_Ausf.a(paramView);; str = this.jdField_a_of_type_Ausf.a)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (this.jdField_a_of_type_Auvu != null) {
          this.jdField_a_of_type_Auvu.a(str);
        }
      }
      return;
    }
  ...
  public boolean onLongClick(View paramView)
  {
    if (this.jdField_a_of_type_Ausf != null)
    {
      ...
      this.jdField_a_of_type_Ausf.a(localbblr);
      b();
      bbcc.a(paramView, localbblr, this, this);
    }
    return true;
  }
}
