...
public class pxf
  extends osm
{
  public pxf(ComponentHeaderPolymeric paramComponentHeaderPolymeric) {}
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((localArticleInfo.mTopicRecommendFeedsInfo != null) && (localArticleInfo.mTopicRecommendFeedsInfo.a != null)) {
        ((qds)localArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c = 1;
      }
    ...
    if ((localArticleInfo.mTopicRecommendFeedsInfo != null) && (localArticleInfo.mTopicRecommendFeedsInfo.a != null)) {
      ((qds)localArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c = 0;
    }
    if (localArticleInfo.mPolymericInfo != null)
    {
