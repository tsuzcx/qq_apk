  ...
  extends aqkn
{
  ...
  protected void a(boolean paramBoolean, long paramLong, ArrayList<Long> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if ((paramLong == assi.a(this.a)) && (assi.d(this.a) != null)) {
        if (paramArrayList != null) {
          synchronized (assi.a(this.a))
          {
            assi.a(this.a).put(Long.valueOf(paramLong), (ArrayList)paramArrayList.clone());
          }
        }
      }
      synchronized (assi.d(this.a))
      {
        localObject2 = (WeakReference)assi.d(this.a).get(Long.valueOf(paramLong));
        if (localObject2 != null)
        {
          ??? = (assl)((WeakReference)localObject2).get();
          if (??? != null)
          {
            if (paramBoolean) {
              break;
            }
            assi.a(this.a, paramLong, (assl)???);
          }
        }
        return;
        label200:
    ...
    ((assl)???).a(paramLong, paramArrayList);
  }
  ...
  protected void a(boolean paramBoolean, HashMap<Long, IntimateInfo> paramHashMap, Object arg3)
  {
    ...
    for (paramHashMap = paramHashMap.size() + paramHashMap.toString();; paramHashMap = "null")
    {
      ...
      synchronized (assi.e(this.a))
      {
        ...
        assi.e(this.a).remove(localObject2);
      }
    }
    label387:
    label393:
    ...
    {
      label297:
      if ((l2 == assi.a(this.a)) && (assi.f(this.a) != null)) {}
      synchronized (assi.f(this.a))
      {
        ??? = (WeakReference)assi.f(this.a).get(Long.valueOf(l2));
        if (??? != null)
        {
          ??? = (assj)((WeakReference)???).get();
          if (??? != null) {
            assi.a(this.a, l2, paramHashMap, ???);
          }
        }
        return;
      }
