      ...
      try
      {
        ...
        if (paramFromServiceMsg.uint32_result.get() == 0)
        {
          ...
          if (bool)
          {
            ...
            paramFromServiceMsg.get(arrayOfByte);
            int k = bbbd.a(arrayOfByte, 0);
            int i = 0;
            if (i < k)
            {
              arrayOfByte = new byte[4];
              paramFromServiceMsg.get(arrayOfByte);
              localArrayList2.add(String.valueOf(bbbd.a(arrayOfByte, 0)));
              arrayOfByte = new byte[2];
              paramFromServiceMsg.get(arrayOfByte);
              long l = bbbd.a(arrayOfByte, 0);
              arrayOfByte = new byte[2];
              paramFromServiceMsg.get(arrayOfByte);
              l = bbbd.a(arrayOfByte, 0);
              arrayOfByte = new byte[2];
              paramFromServiceMsg.get(arrayOfByte);
              arrayOfByte = new byte[bbbd.a(arrayOfByte, 0)];
              paramFromServiceMsg.get(arrayOfByte);
          ...
          notifyObserver(paramIntent, j, bool, localBundle, wgn.class);
          return;
        }
      }
