  ...
  implements yrb
{
  ...
  private void g(String paramString)
  {
    ...
    a();
    localObject = new bety((Context)localObject, ((BaseActivity)localObject).getTitleBarHeight());
    ((bety)localObject).a(paramString);
    ((bety)localObject).setCancelable(false);
    ((bety)localObject).setOnDismissListener(new bbmu(this));
    this.jdField_a_of_type_Bety = ((bety)localObject);
  ...
  private void h(String paramString)
  {
    ...
    {
      QQToast.a((Context)localObject, 2131694766, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131721144));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131693788));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131694953));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131694954));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131696591));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131721149));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  {
    c();
    bhuf localbhuf = (bhuf)bhus.a(this.mRuntime.a(), null);
    localbhuf.a(2131721142);
    localbhuf.a(2131721143, 3);
    localbhuf.c(2131690648);
    localbhuf.setOnDismissListener(new bbmv(this));
    localbhuf.a(new bbmw(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!bdin.d(localBaseActivity)) {
      QQToast.a(localBaseActivity, 2131694766, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  public void d(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	bbms:mRuntime	Lbegz;
    //   4: invokevirtual 70	begz:a	()Landroid/app/Activity;
    //   7: astore_3
    ...
    catch (JSONException paramString)
    {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          bbmr.a(localActivity, localActivity.getIntent().getExtras(), paramString);
        }
        return;
      }
      catch (JSONException paramString) {}
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString3 = this.jdField_a_of_type_Yqz;
      if (j == -1) {}
      ...
      if (paramString3.equals("insertCreateGroupSuccessMsg")) {
        try
        {
          ...
          this.jdField_a_of_type_Yqz.a(paramJsBridgeListener, paramString1, i, paramString2, this);
        }
      ...
      {
        paramJsBridgeListener.a("8.3.5.4555");
        break label2264;
      }
      if (paramString3.equals("isNetworkConnected"))
      {
        paramJsBridgeListener.a(Boolean.valueOf(bflk.d(bfbm.a().a())));
        break label2264;
      }
    ...
    else
    {
      ...
      if ("updateTroopBindedPubAccount".equals(paramString3))
      {
        try
        {
          ...
          if (j > 0)
          {
            ...
            this.jdField_a_of_type_Yqz.a(l, paramString1);
          }
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("getLastSpeakMessage".equals(paramString3))
      {
        try
        {
          ...
          paramString2 = paramString2.optString("callback");
          this.jdField_a_of_type_Yqz.a(paramJsBridgeListener, paramString1, new bbmt(this, paramString2));
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("notifyTroopEnterEffectStatus".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Yqz.a(i, j, k, paramString1);
      ...
      else if ("returnToTroopAIO".equals(paramString3))
      {
        ...
        SensorAPIJavaScript.returnToAio(this.jdField_a_of_type_Yqz, this.mRuntime.a(), paramJsBridgeListener, true);
        break label2264;
      }
      else
      {
        if ("notifyCreateTroops".equals(paramString3))
        {
          try
          {
            ...
            paramString2 = paramString2.optString("callback");
            this.jdField_a_of_type_Yqz.b(paramJsBridgeListener, paramString1, paramString2, this);
          }
          catch (JSONException paramJsBridgeListener)
          {
            if (!QLog.isColorLevel()) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramString2 != null) && (paramString2.length() > 0))
              {
                ...
                this.jdField_a_of_type_Yqz.a(paramString3);
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      if (bool) {
        QQToast.a((Context)localObject2, 2131721141, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        QQToast.a((Context)localObject2, 2131721146, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131721154);
    }
    for (;;)
    {
      ...
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131721140);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131721145);
      }
    }
  }
