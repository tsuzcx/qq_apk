  ...
  extends aypg
{
  ...
  public aysv(ayoz paramayoz, aywc paramaywc)
  {
    ...
    this.jdField_a_of_type_Ayqo.jdField_a_of_type_JavaLangString = paramaywc.a();
  }
  
  private boolean a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "personality_label start uniseq:" + this.jdField_a_of_type_Aywc.jdField_a_of_type_Long + " src:" + this.jdField_a_of_type_Aywc.i);
    }
    Object localObject = new CompressInfo(this.jdField_a_of_type_Aywc.i, 0);
    ...
    do
    {
      ...
      aywc localaywc = this.jdField_a_of_type_Aywc;
      localObject = ((CompressInfo)localObject).e;
      localaywc.i = ((String)localObject);
      localayqo.jdField_c_of_type_JavaLangString = ((String)localObject);
    } while (c() != 0);
    return false;
  }
  ...
  private void g()
  {
    ...
    localayyx.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin();
    ayyp localayyp = new ayyp();
    localayyp.jdField_a_of_type_Ayzw = this;
    if (this.jdField_a_of_type_Aywc.b == 22)
    {
      localayyp.jdField_a_of_type_JavaLangString = "friend_avatar_up";
      localayyp.jdField_a_of_type_JavaUtilList.add(localayyx);
    ...
    {
      return;
      localayyp.jdField_a_of_type_JavaLangString = "nearby_people_pic_up";
      break;
      if (QLog.isColorLevel()) {
  ...
  public void a(ayyp paramayyp, ayze paramayze)
  {
    if (paramayze != null)
    {
      ...
      {
        paramayyp = (ayzp)paramayze.jdField_a_of_type_JavaUtilList.get(i);
        if (QLog.isColorLevel()) {
          b("procUrl", paramayyp.toString());
        }
        a(this.jdField_a_of_type_Aypd, paramayyp);
        if (QLog.isColorLevel()) {
          QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "onBusiProtoResp()------response.result = " + paramayyp.jdField_c_of_type_Int);
        }
        if (paramayyp.jdField_c_of_type_Int == 0)
        {
          this.jdField_d_of_type_ArrayOfByte = paramayyp.jdField_a_of_type_ArrayOfByte;
          if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.m = (i | j);
      str1 = "";
      if ((this.jdField_a_of_type_Ayqo.b != 8) && (this.jdField_a_of_type_Ayqo.b != 64)) {
        break label190;
      }
      ...
      axrn.a(BaseApplication.getContext()).a(null, str1, true, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      break;
      label190:
      if (this.jdField_a_of_type_Ayqo.b == 21)
      {
        str1 = "actFreshNewsPicUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Ayqo.b == 22)
      {
        str1 = "actFriendAvatarUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Ayqo.b == 34)
      {
        str1 = "C2BUploadFile";
        break label100;
      }
      if (this.jdField_a_of_type_Ayqo.b == 35)
      {
        str1 = "actProfileCoverPicUpload";
        break label100;
      }
      if ((this.jdField_a_of_type_Ayqo.b == 36) || (this.jdField_a_of_type_Ayqo.b == 37) || (this.jdField_a_of_type_Ayqo.b == 38) || (this.jdField_a_of_type_Ayqo.b == 48))
      {
        str1 = "actBaseDynamicAvatarUpload";
        break label100;
      }
      if ((this.jdField_a_of_type_Ayqo.b == 39) || (this.jdField_a_of_type_Ayqo.b == 40) || (this.jdField_a_of_type_Ayqo.b == 41))
      {
        str1 = "actNearbyDynamicAvatarUpload";
        break label100;
      }
      if ((this.jdField_a_of_type_Ayqo.b == 50) || (this.jdField_a_of_type_Ayqo.b == 51))
      {
        str1 = "actHongbaoStarPhotoUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Ayqo.b == 56)
      {
        str1 = "actPersonalityLabelPhotoUpload";
        break label100;
      }
      if (this.jdField_a_of_type_Ayqo.b != 23) {
        break label100;
      }
      str1 = "actExtendFriendSoundUpload";
      break label100;
      label442:
      str2 = bbmx.a(this.jdField_d_of_type_ArrayOfByte);
      break label139;
      label454:
      ...
      axrn.a(BaseApplication.getContext()).a(null, str1, false, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  public void aP_()
  {
    ...
    this.b.a();
    aysw localaysw = new aysw(this, SystemClock.uptimeMillis());
    if ((this.jdField_a_of_type_Ayqo.b == 8) || (this.jdField_a_of_type_Ayqo.b == 64)) {
      i = 3;
    }
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + j + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Aywc.jdField_a_of_type_Long + " MD5:" + this.jdField_c_of_type_JavaLangString + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + i);
      }
      if (j != 0)
      {
      ...
      if (this.jdField_a_of_type_Ayqo.b == 21) {
        i = 6;
      } else if (this.jdField_a_of_type_Ayqo.b == 22) {
        i = 5;
      } else if (this.jdField_a_of_type_Ayqo.b == 34) {
        i = 13;
      } else if (this.jdField_a_of_type_Ayqo.b != 35) {
        if ((this.jdField_a_of_type_Ayqo.b == 36) || (this.jdField_a_of_type_Ayqo.b == 37) || (this.jdField_a_of_type_Ayqo.b == 38))
        {
          i = 23;
        }
        else if ((this.jdField_a_of_type_Ayqo.b == 39) || (this.jdField_a_of_type_Ayqo.b == 40) || (this.jdField_a_of_type_Ayqo.b == 41))
        {
          i = 22;
        }
        else if (this.jdField_a_of_type_Ayqo.b == 48)
        {
          i = 24;
        }
        else if (this.jdField_a_of_type_Ayqo.b == 23)
        {
          i = 59;
          ...
          this.jdField_a_of_type_Ayqo.jdField_a_of_type_ArrayOfByte = localCommFileExtReq.toByteArray();
        }
        else if ((this.jdField_a_of_type_Ayqo.b == 50) || (this.jdField_a_of_type_Ayqo.b == 51))
        {
          i = 35;
        }
        else if (this.jdField_a_of_type_Ayqo.b == 56)
        {
          i = 39;
        }
        else
  ...
  public void aR_()
  {
    ...
    if ((this.jdField_a_of_type_Ayqo.b == 56) && (a())) {
      return;
    }
