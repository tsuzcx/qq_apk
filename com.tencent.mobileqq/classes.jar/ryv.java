  ...
  extends PopupWindow
{
  ...
  public ryv(Context paramContext)
  {
    super(-2, -2);
  ...
  private void a()
  {
    ...
    ryw localryw = new ryw(this, this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    this.jdField_a_of_type_Ryw = localryw;
  ...
  private void b()
  {
    ...
    ryw.a(this.jdField_a_of_type_Ryw).setColor(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Ryw, this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    ...
    for (;;)
    {
      ...
      return;
      localLayoutParams.rightMargin = ryw.a(this.jdField_a_of_type_Ryw);
      this.jdField_a_of_type_Ryw.setRotation(90.0F);
      continue;
      localLayoutParams.bottomMargin = ryw.b(this.jdField_a_of_type_Ryw);
      this.jdField_a_of_type_Ryw.setRotation(180.0F);
      continue;
      localLayoutParams.leftMargin = ryw.a(this.jdField_a_of_type_Ryw);
      this.jdField_a_of_type_Ryw.setRotation(270.0F);
      continue;
      localLayoutParams.topMargin = ryw.b(this.jdField_a_of_type_Ryw);
      this.jdField_a_of_type_Ryw.setRotation(0.0F);
    }
  }
  ...
  {
    ryw.c(this.jdField_a_of_type_Ryw, paramInt);
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    ryw.a(this.jdField_a_of_type_Ryw, paramInt1);
    ryw.b(this.jdField_a_of_type_Ryw, paramInt2);
  }
  ...
  public int c()
  {
    return ryw.b(this.jdField_a_of_type_Ryw);
  }
