...
public class asnm
{
  ...
  static
  {
    jdField_a_of_type_Ajal = new asnn();
  ...
  public static void a(int paramInt1, QQGameMsgInfo paramQQGameMsgInfo, int paramInt2)
  {
    ...
    do
    {
      return;
      if (paramInt1 == 117) {
        amrz.a(paramQQGameMsgInfo.frienduin, paramQQGameMsgInfo.uniseq);
      }
      str = "";
    ...
    amrz.a(paramInt1, paramInt2, str);
  }
  ...
  public static void a(AppInterface paramAppInterface, String paramString, ajal paramajal, boolean paramBoolean)
  {
    int i = bdin.a(paramAppInterface.getApplication());
    if (((i == 1) || (i == 4)) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      PreloadManager.a().a(paramAppInterface, paramajal);
    }
  }
