  ...
  implements Animatable
{
  ...
  public aptm(int paramInt1, int[] paramArrayOfInt, ImageView paramImageView, int paramInt2)
  {
  ...
  public aptm(int[] paramArrayOfInt, ImageView paramImageView, int paramInt)
  {
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new aptn(this);
    this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new apto(this);
  }
