  ...
  extends anud
{
  ...
  public lgb(AppInterface paramAppInterface)
  {
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.jdField_a_of_type_Lga.jdField_a_of_type_Long));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(mvd.b());
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Lfw;
    localObject1 = lfw.a(paramArrayOfByte);
    paramArrayOfByte = ((lfx)localObject1).a;
    localObject1 = ((lfx)localObject1).b;
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      lfw locallfw = this.jdField_a_of_type_Lfw;
      localToServiceMsg.putWupBuffer(lfw.a(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
      if (bhnv.g(this.mApp.getApplication().getApplicationContext())) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      paramObject = this.jdField_a_of_type_Lfw;
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          this.jdField_a_of_type_Lga.jdField_a_of_type_Int = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.f())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_Lga.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              lfw locallfw = this.jdField_a_of_type_Lfw;
              QLog.d("AudioTransClientInterfaceHandler", 2, lfw.a(paramObject.fixed32_IP.get()));
              ...
              locallfw = this.jdField_a_of_type_Lfw;
              QLog.d("AudioTransClientInterfaceHandler", 2, lfw.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
