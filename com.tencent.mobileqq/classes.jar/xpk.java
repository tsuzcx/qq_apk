  ...
  implements xps
{
  ...
  protected xpd a;
  protected xpj a;
  xps jdField_a_of_type_Xps = new xpq(this);
  protected boolean a;
  private int b;
  ...
  public xpk(Activity paramActivity, xpj paramxpj)
  {
  ...
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131560628, null));
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131364268));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131375792));
      ...
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131375564));
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131379427));
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131362413);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131364083));
      this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView = ((GestureSelectGridView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131362324));
  ...
  private void n()
  {
    ...
    this.jdField_a_of_type_Int = ((bbll.a() - this.jdField_d_of_type_Int * 2 - this.jdField_b_of_type_Int * 3) / 4);
  }
  ...
  private void o()
  {
    ...
    {
      if ((this.jdField_a_of_type_Xpw == null) || (!this.jdField_a_of_type_Xpw.jdField_b_of_type_Boolean)) {
        break label129;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_d_of_type_AndroidWidgetTextView.setText("");
      ((ViewGroup.MarginLayoutParams)this.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams()).setMargins(actj.a(16.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, 0, 0);
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new xpl(this));
    }
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new xpm(this));
    }
  }
  ...
  private void q()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new xpn(this));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new xpo(this));
      if (this.jdField_c_of_type_AndroidWidgetImageView != null) {
        this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new xpp(this));
      }
      return;
  ...
  protected abstract bfpt a();
  
  protected abstract bfsh a();
  ...
  {
    this.jdField_a_of_type_Xpd = this.jdField_a_of_type_Xpw.a();
    n();
    c(paramViewGroup);
  }
  ...
  public void k()
  {
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AIOGalleryActivity))
    {
      ...
      if ((ImmersiveUtils.isSupporImmersive() == 1) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null))
      {
        ...
        if ((this.jdField_a_of_type_Xpw != null) && (this.jdField_a_of_type_Xpw.jdField_a_of_type_AndroidViewViewGroup != null) && (Build.VERSION.SDK_INT >= 16)) {
          this.jdField_a_of_type_Xpw.jdField_a_of_type_AndroidViewViewGroup.setSystemUiVisibility(0);
        }
      }
