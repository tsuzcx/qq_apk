  ...
  implements Manager
{
  ...
  private final azia jdField_a_of_type_Azia;
  private bdfq jdField_a_of_type_Bdfq;
  private final QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final String jdField_a_of_type_JavaLangString;
  private final List<azwm> jdField_a_of_type_JavaUtilList;
  ...
  public azwl(@NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Azia = ((azia)new azwr(this));
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver((alkr)this.jdField_a_of_type_Azia);
  }
  ...
  private final void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (((azhx)localObject).a(bool1, paramInt1, paramBoolean, bool2)) {
        break label165;
      }
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "doChangeMode switching");
      }
      QQToast.a((Context)BaseApplication.getContext(), 0, 2131719896, 0).a();
      localObject = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
      while (((Iterator)localObject).hasNext()) {
        ((azwm)((Iterator)localObject).next()).d(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      }
      bool1 = false;
      break;
      label159:
    ...
    localObject = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
    while (((Iterator)localObject).hasNext()) {
      ((azwm)((Iterator)localObject).next()).b(paramInt2, paramInt3);
    }
  }
  ...
  private final void a(boolean paramBoolean, String paramString)
  {
    ...
    while (localIterator.hasNext()) {
      ((azwm)localIterator.next()).a(paramBoolean, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramString);
    }
    if ((paramBoolean) && ((this.jdField_a_of_type_Int == 2) || (this.jdField_b_of_type_Int == 2))) {
      bdiv.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_has_change", Boolean.valueOf(true));
    }
  }
  ...
  private final void b()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      bdiv.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_last_report_time", localSimpleDateFormat.format(new Date()));
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AD6C", "0X800AD6C", 0, i, "", "", "", "");
      return;
    }
  }
  ...
  {
    Object localObject1 = (String)bdiv.b((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_last_report_time", "");
  ...
  private final void d(boolean paramBoolean)
  {
    ...
    for (String str = BaseApplicationImpl.getContext().getString(2131694446, new Object[] { str });; str = BaseApplicationImpl.getContext().getString(2131694448, new Object[] { str }))
    {
  ...
  private final void e(boolean paramBoolean)
  {
    if (!paramBoolean)
    {
      String str = BaseApplicationImpl.getContext().getString(2131694447);
  ...
  @NotNull
  public final azwo a(@NotNull Activity paramActivity, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && ((i != paramInt1) || (paramInt2 != this.c)))
    {
      ...
      {
        QQToast.a((Context)BaseApplication.getContext(), 1, 2131694829, 0).a();
        paramActivity = ((Iterable)this.jdField_a_of_type_JavaUtilList).iterator();
        while (paramActivity.hasNext()) {
          ((azwm)paramActivity.next()).c(paramInt1, i);
        }
        return new azwo(false, paramInt1, i);
      }
      if (paramInt1 == 1)
      {
        ...
        if (((SharedPreferences)localObject).getBoolean("key_simple_should_show_switch_dialog", true))
        {
          ...
          localObject = (DialogInterface.OnClickListener)new azwq(this, paramInt2, paramInt1, i, paramBoolean);
          bdfq localbdfq = this.jdField_a_of_type_Bdfq;
          if (localbdfq != null) {
            localbdfq.dismiss();
          }
          this.jdField_a_of_type_Bdfq = bdcd.a(paramActivity, BaseApplicationImpl.getContext().getString(2131719891), 0, 2131719889, (DialogInterface.OnClickListener)localObject, null);
          paramActivity = this.jdField_a_of_type_Bdfq;
          if (paramActivity == null) {
            Intrinsics.throwNpe();
          }
          paramActivity.setOnDismissListener((DialogInterface.OnDismissListener)new azwp(this, paramInt1, i));
          paramActivity = this.jdField_a_of_type_Bdfq;
          if (paramActivity == null) {
            Intrinsics.throwNpe();
          }
      ...
      for (;;)
      {
        return new azwo(true, paramInt1, i);
        a(paramInt2, paramInt1, i, paramBoolean);
        continue;
        a(paramInt2, paramInt1, i, paramBoolean);
      }
    }
    return new azwo(this.jdField_a_of_type_Boolean, paramInt1, i);
  }
  ...
  public final void a()
  {
    ...
    this.jdField_a_of_type_Bdfq = ((bdfq)null);
  }
  
  public final void a(@Nullable azwm paramazwm)
  {
    if (paramazwm != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramazwm);
    }
  }
  ...
  public final void a(@NotNull BaseActivity paramBaseActivity)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.d == 2) && (this.e == 1) && (azwu.c()) && (!((Boolean)bdiv.b((Context)paramBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_has_change", Boolean.valueOf(false))).booleanValue()) && (!((Boolean)bdiv.b((Context)paramBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "study_mode_change_dialog_has_show", Boolean.valueOf(false))).booleanValue()))
      {
        new azwy(paramBaseActivity).show();
        bdiv.a((Context)BaseApplicationImpl.context, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, "study_mode_change_dialog_has_show", Boolean.valueOf(true));
      }
      return;
    }
  }
  ...
  public final void b(@Nullable azwm paramazwm)
  {
    if ((paramazwm != null) && (this.jdField_a_of_type_JavaUtilList.contains(paramazwm))) {
      this.jdField_a_of_type_JavaUtilList.remove(paramazwm);
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver((alkr)this.jdField_a_of_type_Azia);
    bdfq localbdfq = this.jdField_a_of_type_Bdfq;
    if (localbdfq != null) {
      localbdfq.dismiss();
    }
