...
{
  private static acrh jdField_a_of_type_Acrh = new acrh();
  ...
  public static acrh a()
  {
    try
    {
      acrh localacrh = jdField_a_of_type_Acrh;
      return localacrh;
    }
    finally
    {
  ...
  {
    acqy.a("GdtImpressionPolicy", "report view: " + paramView.hashCode());
    GdtAd localGdtAd = a(paramView);
    if (localGdtAd == null)
    {
      acqy.a("GdtImpressionPolicy", "break: statistics == null");
      return;
    }
    if (localGdtAd.reportState == 2)
    {
      acqy.a("GdtImpressionPolicy", "break: already report " + localGdtAd.getTraceId());
      return;
    }
    if (!a(paramView))
    {
      acqy.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not");
      return;
    }
    ...
    if (!b(paramView))
    {
      acqy.a("GdtImpressionPolicy", "inCountingMap not " + localGdtAd.getTraceId());
  ...
  {
    acqy.a("GdtImpressionPolicy", "handleMessage : ");
    ...
    for (;;)
    {
      ...
      if (paramMessage.get() != null)
      {
        ...
        {
          acqy.a("GdtImpressionPolicy", "break: statistics.reportState != 1 " + localGdtAd.getTraceId());
        }
        else if (!a(paramMessage))
        {
          acqy.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not " + localGdtAd.getTraceId());
          localGdtAd.reportState = -1;
        }
        else if (!b(paramMessage))
        {
          acqy.a("GdtImpressionPolicy", "break: inCountingMap not " + localGdtAd.getTraceId());
        }
        else
        {
          localObject = paramMessage.getTag(2131380926);
          if (localObject == null)
          {
            acqy.a("GdtImpressionPolicy", "break: o2 == null " + localGdtAd.getTraceId());
          }
          else if (!(localObject instanceof acri))
          {
            acqy.a("GdtImpressionPolicy", "break: o2 instanceof ReportListener not " + localGdtAd.getTraceId());
          }
          else
          {
            ...
            acqy.a("GdtImpressionPolicy", "break: already reported " + localGdtAd.getTraceId());
          }
        }
      }
    }
    ((acri)localObject).reportImpression(paramMessage);
    localGdtAd.reportState = 2;
    a(localGdtAd.getTraceId(), true);
    acqy.a("GdtImpressionPolicy", "report " + localGdtAd.getTraceId());
