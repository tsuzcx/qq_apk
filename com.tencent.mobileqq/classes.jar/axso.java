...
public class axso
  implements axsv, Manager
{
  private alsi jdField_a_of_type_Alsi;
  private axsm jdField_a_of_type_Axsm;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<String, axss> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  public axso(QQAppInterface paramQQAppInterface)
  {
  ...
  private axsm a()
  {
    if (this.jdField_a_of_type_Axsm == null) {
      this.jdField_a_of_type_Axsm = new axsm(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    return this.jdField_a_of_type_Axsm;
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ((axso)paramQQAppInterface.getManager(326)).b(paramString, paramLong);
  }
  
  public axss a(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        {
          paramString = (axss)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
          return paramString;
        }
      }
      axss localaxss = new axss(paramString, a());
      localaxss.a(this);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localaxss);
      paramString = localaxss;
    }
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Alsi = new axsp(this);
  ...
  {
    a(paramMessageRecord, paramalsi, null);
  }
  
  public void a(MessageRecord paramMessageRecord, alsi paramalsi, axsq paramaxsq)
  {
    axss localaxss = a(paramMessageRecord.frienduin);
    String str = null;
    if ((paramMessageRecord instanceof MessageForShortVideo)) {
      str = ((MessageForShortVideo)paramMessageRecord).videoFileName;
    }
    while (localaxss.a(paramMessageRecord.uniseq, str))
    {
      localaxss.a(paramMessageRecord, paramalsi, paramaxsq);
      return;
    ...
    a().a(paramMessageRecord, paramalsi, paramaxsq);
  }
  
  public void a(MessageRecord paramMessageRecord, String paramString)
  {
    Object localObject = a(paramMessageRecord.frienduin);
    if (((axss)localObject).a(paramMessageRecord.uniseq, paramString))
    {
      ((axss)localObject).a(paramMessageRecord, paramMessageRecord.uniseq, paramString, true);
      return;
    }
    if (QLog.isColorLevel())
    {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        localaxss = (axss)this.jdField_a_of_type_JavaUtilHashMap.remove(paramString);
        if (QLog.isColorLevel())
        {
          ??? = new StringBuilder();
          ...
          if (localaxss != null)
          {
            paramString = localaxss.toString();
  ...
  {
    axss localaxss = a(paramMessageRecord.frienduin);
    if (!localaxss.a(paramMessageRecord.uniseq, paramString2)) {
      a(paramString1, paramMessageRecord.uniseq);
    }
    localaxss.a(paramMessageRecord, paramMessageRecord.uniseq, paramString2, false);
  }
  ...
  public void a(String paramString, ArrayList<ChatMessage> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      for (int j = 0; paramArrayList.hasNext(); j = k)
      {
        ...
        k = j + 1;
        j = i;
        if (axsm.a(localChatMessage.msgtype))
        {
          j = i + 1;
  ...
  public boolean a(String paramString, long paramLong, View paramView, aenl paramaenl)
  {
    if ((TextUtils.isEmpty(paramString)) || (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))) {
      return false;
    }
    return a(paramString).a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong, paramView, paramaenl);
  }
