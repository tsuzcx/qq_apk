...
public class ajqv
  extends PhotoListLogicBase<NewPhotoListActivity, ajrc>
  implements PhotoListLogic.IadapterCallback, PhotoListLogic.IcheckBoxCallback, PhotoListLogic.IitemClickCallback, ylm
{
  public ajqu a;
  
  public ajqv(NewPhotoListActivity paramNewPhotoListActivity)
  {
    super(paramNewPhotoListActivity);
    this.mPhotoListData = new ajqu();
    this.a = ((ajqu)this.mPhotoListData);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 >= 0) && (paramInt1 < localArrayList.size()) && (paramInt2 >= 0) && (paramInt2 < localArrayList.size()))
    {
      ...
      ylg.a().b(localArrayList, this.mPhotoCommonData.allMediaInfoHashMap);
    }
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        localObject1 = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131718111);
        ...
        if (bhnb.a(this.mActivity, 4, new ajqx(this, paramIntent))) {
          bfur.a(this.mActivity, 232, null, (String)localObject1, new ajqy(this, paramIntent), new ajqz(this)).show();
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(SlideItemInfo paramSlideItemInfo)
  {
    ...
    for (;;)
    {
      if ((i >= 0) && (i < ((List)localObject2).size()))
      {
        ...
        ajpv.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
  ...
  protected void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    if ((100 == paramInt) || (102 == paramInt) || (103 == paramInt)) {
      if (100 == paramInt)
      {
        ...
        localIntent.putExtra("PhotoConst.EDIT_MASK_SHAPE_TYPE", ajpz.c(paramInt));
      }
    }
    for (;;)
    {
      AlbumUtil.putRecordLastPosData(localIntent, this.mPhotoCommonData.albumId, str, this.a.isRecodeLastAlbumPath);
  ...
  boolean a(LocalMediaInfo paramLocalMediaInfo, CheckBox paramCheckBox)
  {
    ...
    if ((this.a.jdField_a_of_type_Int == 9501) && (((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false)) && (paramLocalMediaInfo.selectStatus != 1))
    {
      ...
      for (l = 0L; localIterator.hasNext(); l = FileUtils.getFileSizes((String)localIterator.next()) + l) {}
      if (FileUtils.getFileSizes(paramLocalMediaInfo.path) + l > 52428800L)
      {
    ...
    if ((((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (((NewPhotoListActivity)this.mActivity).isGif(paramLocalMediaInfo)) && (FileUtils.getFileSizes(paramLocalMediaInfo.path) > 3145728L))
    {
      QQToast.a(this.mActivity, "图片文件过大", 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
      paramCheckBox.setChecked(false);
      return false;
    }
    return (!((ajrc)this.mOtherCommonData).a()) || (bnsr.a(this.mActivity, paramLocalMediaInfo));
  }
  ...
  protected void b()
  {
    ...
    {
      ajpv.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size());
      ajpv.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoListActivity)this.mActivity).getIntent();
  ...
  public Intent caseNoSingModeImage(View paramView, int paramInt)
  {
    ...
    paramView.putExtra("PhotoConst.editPathMap", ajpc.a(this.a.jdField_c_of_type_JavaUtilHashMap));
  ...
  public void d()
  {
    ...
    AlbumUtil.setQualityTvRawPhotoText(((NewPhotoListActivity)this.mActivity).b, localPhotoCommonBaseData.selectedPhotoList, localPhotoCommonBaseData.allMediaInfoHashMap, this.a.j, this.mActivity, this.a.jdField_a_of_type_JavaUtilHashMap, localPhotoCommonBaseData.selectedMediaInfoHashMap);
  ...
  public void doOnDestroy()
  {
    if (this.mPhotoCommonData.isShowQzoneAlbum) {
      BaseApplicationImpl.getApplication().getRuntime().unRegistObserver(((NewPhotoListActivity)this.mActivity).jdField_a_of_type_Ajqr);
    }
    if (((ajrc)this.mOtherCommonData).a()) {
      ylg.a().f();
    }
  ...
  public void doOnResume()
  {
    ...
    } while (!((ajrc)this.mOtherCommonData).a());
    ylg.a().c();
    ylg.a().a(this.a.jdField_a_of_type_Ylk);
  }
  
  void e()
  {
    Object localObject = ylg.a().a();
    if (this.a.k) {
      ylg.a().b((List)localObject);
    }
    ...
    if (this.mPhotoCommonData.selectedPhotoList.size() > 0) {
      ylg.a().a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap, false);
    }
  }
  ...
  protected void e(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    ajpv.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_totalSelNum");
  ...
  public void enterAlbumListFragment(Intent paramIntent)
  {
    ...
    paramIntent.putExtra("PhotoConst.PHOTO_INFOS", ((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap);
  ...
  public void enterPhotoPreviewActivity(boolean paramBoolean, Intent paramIntent)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if ((localArrayList != null) && (localArrayList.size() > 0)) {
        bcef.b(null, "CliOper", "", this.mPhotoCommonData.myUin, "0X8004072", "0X8004072", 0, localArrayList.size(), 0, "", "", "", "");
      }
      if ((((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap == null) || (((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.size() <= 0)) {
        break label355;
      }
      paramIntent.putExtra("PhotoConst.PHOTO_INFOS", ((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap);
  ...
  public String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo != null)
    {
      ...
      if ((((ajrc)this.mOtherCommonData).a()) && (!this.a.isSupportVideoCheckbox)) {
        return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694432, new Object[] { Integer.valueOf(i) });
      }
      if ((this.a.isSupportVideoCheckbox) && (paramLocalMediaInfo != null) && ("video".equals(paramLocalMediaInfo[0])))
      {
        if (((ajrc)this.mOtherCommonData).a()) {
          return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694433, new Object[] { Integer.valueOf(i) });
        }
        return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694431, new Object[] { Integer.valueOf(i) });
      }
    }
    return str;
  }
  ...
  public void handleVideoCapture(Intent paramIntent)
  {
    ...
    localVideoCompositeHelper.setAdjustBitrate(true);
    localObject = VideoCompositeHelper.getPublishVideoEntry((String)localObject);
    String str = EncodeVideoUtil.getVideoOutputPath(((PublishVideoEntry)localObject).mLocalRawVideoDir);
    if (TextUtils.isEmpty(str))
    {
      QZLog.i("PhotoListActivity", 1, "get target path fail");
      return;
    }
    localVideoCompositeHelper.composite((PublishVideoEntry)localObject, str, false, true, new ajrb(this, l, str, (PublishVideoEntry)localObject, paramIntent));
  }
  ...
  public void handleVideoEncodeSucceed(Message paramMessage)
  {
    ...
    if ((paramMessage.obj instanceof String))
    {
      ...
      QQToast.a(this.mActivity, String.format(((NewPhotoListActivity)this.mActivity).getResources().getString(2131694431), new Object[] { Integer.valueOf(PhotoCommonBaseData.getInstance().maxSelectNum) }), 0).a();
    }
    for (;;)
    {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    ajpc.a(this.mActivity, paramIntent, false, this.a.jdField_c_of_type_JavaUtilHashMap);
    ...
    ((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_INFOS"));
    ...
    try
    {
      ...
      if (this.mPhotoCommonData.isShowQzoneAlbum)
      {
        ...
        BaseApplicationImpl.getApplication().getRuntime().registObserver(((NewPhotoListActivity)this.mActivity).jdField_a_of_type_Ajqr);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (ylg.a().a().isEmpty())
      {
        ...
        if ((paramView != null) && (((NewPhotoListActivity)this.mActivity).mGridView.getHeight() - paramView.getY() < ((NewPhotoListActivity)this.mActivity).mImageHeight)) {
          ((NewPhotoListActivity)this.mActivity).mGridView.smoothScrollBy(ylg.jdField_a_of_type_Int, 500);
        }
      }
      ...
      if (i < this.mPhotoCommonData.selectedPhotoList.size())
      {
        ...
        for (;;)
        {
          ...
          if (!new File(str).exists()) {
            if ((str.startsWith("http")) && (((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap != null))
            {
              j = i;
              if (((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.containsKey(str)) {}
            }
            else
            {
  ...
  public void onSendBtnClick(View paramView)
  {
    ...
    if (((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false))
    {
      ...
      if (aszt.a())
      {
        aszg.a(this.mActivity, 2131692374, 2131692379, new ajra(this));
        return;
      }
    }
    b();
  ...
  public void postInitUI()
  {
    ...
    int i;
    if ((this.a.isSingleMode) || (this.mPhotoCommonData.showMediaType == 2) || (((ajrc)this.mOtherCommonData).a()))
    {
      i = 8;
  ...
  {
    if (ajpc.a(paramLocalMediaInfo.path, this.a.jdField_c_of_type_JavaUtilHashMap))
    {
      if (Build.VERSION.SDK_INT >= 21) {
        paramHolder.mPhotoFlagView.setImageDrawable(((NewPhotoListActivity)this.mActivity).getDrawable(2130839396));
      }
      for (;;)
      {
        paramHolder.mPhotoFlagView.setVisibility(0);
        return;
        paramHolder.mPhotoFlagView.setImageResource(2130839396);
      }
    }
  ...
  {
    if (paramList != null) {
      ajpc.a(paramList, paramInt, null, this.a.jdField_c_of_type_JavaUtilHashMap);
    }
  ...
  public void updateButton()
  {
    ...
    if (localArrayList.size() > 0)
    {
      ...
      if ((localArrayList.size() != 1) || ((((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap != null) && (((ajrc)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.size() > 0)) || (((NewPhotoListActivity)this.mActivity).a((String)localArrayList.get(0)) != 0)) {
        break label363;
      }
