  ...
  extends azak
{
  ...
  public String a;
  public URL a;
  public ConcurrentHashMap<String, bgny> a;
  public int b;
  protected String b;
  public String c;
  public int d;
  ...
  public azaf(String paramString)
  {
    b(paramString);
    a();
  ...
  public azaf(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
    this.jdField_d_of_type_JavaLangString = String.valueOf(hashCode());
  }
  ...
  public static String b()
  {
    ...
    {
      localFile.mkdirs();
      bace.c(TroopHWJsPlugin.jdField_a_of_type_JavaLangString + ".nomedia");
    }
  ...
  public bgny a(String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = new bgny(tfy.a(), paramString1, paramString2);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString1, paramString2);
      return paramString2;
    }
    return (bgny)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
  }
  ...
  public Stream<azaf> a(XMediaEditor paramXMediaEditor)
  {
    ...
    if (!apdh.b(this.jdField_c_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject2).map(new azag(this.jdField_d_of_type_Int));
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject1).map(new azah(0, paramXMediaEditor, paramXMediaEditor.a("troopuin")));
    }
    for (;;)
    {
      localObject2 = paramXMediaEditor.findViewHolderForLayoutPosition(this.jdField_c_of_type_Int);
      if ((localObject2 instanceof azbg))
      {
        localObject2 = (azbg)localObject2;
        if (this.jdField_d_of_type_JavaLangString.equals(((azbg)localObject2).a.getTag())) {
          ((azbc)((ayzw)paramXMediaEditor.getAdapter()).a.a(1)).a((azbg)localObject2, this, 0);
        }
      }
