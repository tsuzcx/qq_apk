...
public class azaf
{
  private static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    if (paramQQAppInterface != null)
    {
      i = j;
      if (localakpb != null) {
        i = localakpb.a(paramQQAppInterface.frienduin, paramQQAppInterface.istroop);
      }
    }
    return i;
  }
  ...
  {
    Object localObject = paramQQAppInterface.a(1001).a(ajsd.aj, 1001);
    if (localObject == null)
    {
  ...
  {
    Object localObject1 = paramQQAppInterface.a(1001).a(ajsd.aj, 1001);
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == ((ArrayList)localObject2).size())
      {
        ...
        paramQQAppInterface.a().a(ajsd.H, 1001, ajsd.aj, paramQQAppInterface.getCurrentAccountUin());
        return;
      }
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramQQAppInterface.a().a(ajsd.aj, 1001, (String)localObject2, paramQQAppInterface.getCurrentAccountUin());
      }
    }
  }
  ...
  {
    int i = 0;
    Object localObject = paramQQAppInterface.a(1001).a(ajsd.H, 1001);
    if (localObject == null)
    {
    ...
    try
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if (ajsd.aj.equals(localMessageRecord.senderuin))
        {
          a(paramQQAppInterface, localJSONObject2);
          break label402;
        }
        if ((!ajsd.al.equals(localMessageRecord.senderuin)) && (!ajsd.am.equals(localMessageRecord.senderuin)) && (!ajsd.an.equals(localMessageRecord.senderuin)) && (!ajsd.ao.equals(localMessageRecord.senderuin)) && (!ajsd.ap.equals(localMessageRecord.senderuin)))
        {
          localArrayList.add(localMessageRecord);
  ...
  public static final void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      default: 
        return;
      case 1: 
        a(paramQQAppInterface, paramString, ajsd.H);
        return;
      }
      a(paramQQAppInterface, paramString, ajsd.aj);
      return;
    }
