  ...
  implements View.OnClickListener, bjoi, IBrowserItemEventListener
{
  ...
  public bakl(Activity paramActivity, bajm parambajm)
  {
    super(paramActivity, parambajm);
    this.jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new bako(this);
  ...
  private void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bajm.a(paramLong, paramInt1, 1);
  }
  ...
  private void a(Uri paramUri, ArrayList<ShareActionSheetBuilder.ActionSheetItem> paramArrayList)
  {
    ...
    label110:
    Matrix localMatrix;
    if ((localObject3 != null) && ((((View)localObject3).getTag() instanceof bakq)))
    {
      localObject1 = ((bakq)((View)localObject3).getTag()).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, AIOFilePictureData paramAIOFilePictureData, baje parambaje, File paramFile, int paramInt)
  {
    ...
    if (parambaje.a(paramAIOFilePictureData, 16) != null)
    {
      parambaje = URLDrawable.getFileDrawable(paramAIOFilePictureData.jdField_b_of_type_JavaLangString, null);
      parambaje.downloadImediatly();
      localURLDrawableOptions.mLoadingDrawable = parambaje;
    }
    for (;;)
    {
      ...
      try
      {
        parambaje = URLDrawable.getFileDrawable(paramFile.getAbsolutePath(), localURLDrawableOptions);
        if (parambaje != null)
        {
          parambaje.setTag(Integer.valueOf(1));
          this.jdField_a_of_type_Bajm.mActiveDrawable.put(Integer.valueOf(paramInt), parambaje);
          paramFile = paramFile.getAbsolutePath();
          this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setGalleryImageListener(new bakp(this, paramRichMediaBrowserInfo, paramFile, parambaje, paramAIOFilePictureData));
          this.jdField_a_of_type_JavaLangRunnable = AIOUtils.showDelayView(this.jdField_b_of_type_AndroidWidgetImageView, parambaje);
          if ((this.jdField_a_of_type_JavaLangRunnable == null) && (parambaje.getStatus() == 1))
          {
            a(paramRichMediaBrowserInfo, paramFile, parambaje, paramInt);
            this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setImageDrawable(parambaje);
          }
        }
        else
        {
      ...
      catch (Throwable parambaje)
      {
        for (;;)
        {
          BrowserLogHelper.getInstance().getGalleryLog().d("AIOGalleryFilePicView", 4, "[getView] URLDrawable.getDrawable failed.");
          parambaje = localObject;
          continue;
          this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(parambaje, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bajm.getRotation(paramRichMediaBrowserInfo.orientation));
        }
      }
    }
  }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, AIOFilePictureData paramAIOFilePictureData, File paramFile, int paramInt)
  {
    ...
    catch (Throwable localThrowable)
    {
      try
      {
        ...
        this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(localObject1, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bajm.getRotation(paramRichMediaBrowserInfo.orientation));
        this.jdField_a_of_type_Bajm.onLoadFinish(paramInt, true);
        return;
    ...
    if (localObject1 != null) {
      this.jdField_a_of_type_Bajm.mActiveDrawable.put(Integer.valueOf(paramInt), localObject1);
    }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, String paramString, URLDrawable paramURLDrawable, int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bajm.mActiveDrawable.put(Integer.valueOf(paramInt), paramURLDrawable);
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(paramURLDrawable, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bajm.getRotation(paramRichMediaBrowserInfo.orientation));
      this.jdField_a_of_type_Bajm.onLoadFinish(paramInt, true);
      return;
    }
  ...
  private void a(File paramFile, AIOFilePictureData paramAIOFilePictureData)
  {
    ...
    if (paramFile == null) {
      localFile = new baje().a(paramAIOFilePictureData, 20);
    }
    if (localFile == null)
    {
    ...
    aszt.a(this.mContext, localFile.getAbsolutePath());
  }
  ...
  private boolean a(AIOFilePictureData paramAIOFilePictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    Object localObject2 = new baje();
    if (((baje)localObject2).a(paramAIOFilePictureData, 16) != null)
    {
      ...
      localObject2 = ((baje)localObject2).a(paramAIOFilePictureData, 16);
  ...
  private boolean b(AIOFilePictureData paramAIOFilePictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    {
      paramAIOFilePictureData = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838097);
      paramGalleryUrlImageView.setImageDrawable(paramAIOFilePictureData);
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(paramAIOFilePictureData, this.mScreenWidthPx, this.mScreenHeightPx, 0);
      bool = true;
    }
  ...
  private void l()
  {
    AIOFilePictureData localAIOFilePictureData = this.jdField_a_of_type_Bajm.a();
    if ((localAIOFilePictureData != null) && (new baje().a(localAIOFilePictureData, 20)))
    {
      if (localAIOFilePictureData.jdField_c_of_type_Long > 0L) {
        a(String.format(Locale.CHINA, this.mContext.getString(2131694570), new Object[] { FileUtil.filesizeToString(localAIOFilePictureData.jdField_c_of_type_Long) }));
      }
    }
    else {
      return;
  ...
  public void a(int paramInt)
  {
    ...
    if (localAIOFilePictureData != null)
    {
      ...
      localObject2 = localbaje.a(localAIOFilePictureData, 20);
      Object localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = localbaje.a(localAIOFilePictureData, 18);
      }
      localObject2 = localObject1;
      if (localObject1 == null) {
        localObject2 = localbaje.a(localAIOFilePictureData, 16);
      }
      if ((localObject2 != null) || (!bais.a().a())) {}
    }
    else
    {
      return;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new bakn(this, paramAIOFilePictureData, paramFile));
  }
  ...
  public void a(AIOFilePictureData paramAIOFilePictureData, File paramFile, int paramInt)
  {
    ...
    if (paramFile != null)
    {
      bfyp.a(2, localArrayList1);
      if ((PicShareToWX.a().a()) && (PicShareToWX.a().a(paramFile))) {
        bfyp.a(9, localArrayList1);
      }
      bfyp.a(27, localArrayList1);
      bfyp.a(39, localArrayList2);
      bfyp.a(6, localArrayList2);
      if ((bais.a().g()) && (!TextUtils.isEmpty(bais.a().c()))) {
        bfyp.a(54, localArrayList2);
      }
      if (this.jdField_a_of_type_Boolean) {
        bfyp.a(52, localArrayList2);
      }
    ...
    for (;;)
    {
      ...
      paramAIOFilePictureData = this.jdField_a_of_type_Bajm.a(paramAIOFilePictureData, this.mContext);
  ...
  public void ab_()
  {
    this.jdField_a_of_type_Bajm.updateSystemUIVisablity();
  }
  ...
  public boolean b()
  {
    if (super.b())
    {
      ...
      {
        baje localbaje = new baje();
        File localFile2 = localbaje.a(localAIOFilePictureData, 20);
        File localFile1 = localFile2;
        if (localFile2 == null) {
          localFile1 = localbaje.a(localAIOFilePictureData, 18);
        }
        if ((localFile1 != null) || (!bais.a().a())) {
          break label67;
        }
      }
    }
    label67:
    while ((bais.a().a()) || (bais.a().c())) {
      return false;
    }
    return true;
  }
  ...
  public void bindView(int paramInt)
  {
    ...
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bajm.getItem(paramInt);
    ...
    {
      a(this.jdField_a_of_type_Bajm.a(), localRichMediaBrowserInfo);
      ...
      URLDrawable localURLDrawable = (URLDrawable)this.jdField_a_of_type_Bajm.mActiveDrawable.get(Integer.valueOf(paramInt));
      String str2 = localbaje.a(localAIOFilePictureData, 20);
      String str3 = localbaje.a(localAIOFilePictureData, 18);
      String str4 = localbaje.a(localAIOFilePictureData, 16);
      String str1 = "";
      localObject = str1;
      ...
      localObject = localbaje.a(localAIOFilePictureData, 20);
      ...
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(localURLDrawable, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bajm.getRotation(localRichMediaBrowserInfo.orientation));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setMainBrowserPresenter(this.jdField_a_of_type_Bajm.mainBrowserPresenter);
      localObject = new bakq(this);
      ((bakq)localObject).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView = this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
      ((bakq)localObject).jdField_a_of_type_AndroidWidgetTextView = this.jdField_c_of_type_AndroidWidgetTextView;
      ((bakq)localObject).jdField_a_of_type_AndroidWidgetImageView = this.jdField_c_of_type_AndroidWidgetImageView;
      ...
      if (localObject != null)
      {
        a(localRichMediaBrowserInfo, localAIOFilePictureData, localbaje, (File)localObject, paramInt);
      }
      else
      {
        localObject = localbaje.a(localAIOFilePictureData, 18);
        if (localObject != null)
        {
          a(localRichMediaBrowserInfo, localAIOFilePictureData, (File)localObject, paramInt);
        }
        else if (localbaje.a(localAIOFilePictureData, 16) != null)
        {
          ...
          BrowserLogHelper.getInstance().getGalleryLog().d("AIOGalleryFilePicView", 4, "getView(): url is " + localbaje.a(localAIOFilePictureData, 16) + ", file type is " + 16);
        }
        else
        {
          if ((!ataw.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) && (localAIOFilePictureData.jdField_g_of_type_Int != 1))
          {
          ...
          localObject = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844167);
          this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
          this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
          this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_c_of_type_AndroidWidgetTextView.setText(2131692243);
          this.jdField_a_of_type_Bajm.a().b();
        }
      }
    }
  }
  ...
  public boolean c()
  {
    if ((this.mContext.getIntent().getBooleanExtra("extra.FROM_AIO", false)) || (bais.a().c() == 3) || (bais.a().c() == 2)) {}
    for (int i = 1;; i = 0)
    {
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Bajm.a() != null) && (this.jdField_a_of_type_Bajm.a().b()))
    {
      this.jdField_a_of_type_Bajm.a().jdField_a_of_type_Boolean = false;
      return;
    }
    showContentView(false);
    b(false);
    this.jdField_a_of_type_Bajm.a().g();
  }
  ...
  {
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bakq)))
    {
      this.mBrowserItemView = ((RelativeLayout)paramView);
      paramView = (bakq)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramView.addRule(3, 2131366305);
      paramView.addRule(14);
      paramView.topMargin = AIOUtils.dp2px(4.0F, this.mContext.getResources());
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setId(2131366305);
  ...
  public void i()
  {
    ...
    if ((localAIOFilePictureData != null) && (RichMediaBrowserManager.getInstance().getProvider() != null) && (RichMediaBrowserManager.getInstance().getProvider().isPingBinder()))
    {
      ...
      {
        QQToast.a(this.mContext, this.mContext.getString(2131693466), 0).a();
        updateUI();
      }
    }
    else {
    ...
    {
      QQToast.a(this.mContext, this.mContext.getString(2131692520), 0).a();
      updateUI();
      return;
    }
    ...
    long l = asld.a();
    if ((localAIOFilePictureData.jdField_e_of_type_Long > l) && (aszt.a())) {
      try
      {
        aszt.a(false, this.mContext, new bakm(this, localAIOFilePictureData));
        return;
      }
      catch (Throwable localThrowable)
      {
    ...
    this.jdField_a_of_type_Bajm.a(localThrowable.jdField_a_of_type_Long, localThrowable.jdField_a_of_type_Int, 2);
  ...
  void j()
  {
    ...
    default: 
      ...
      if (d())
      {
        localObject2 = RichMediaBrowserManager.getInstance().getProvider().getForwardData(localAIOFilePictureData.jdField_a_of_type_Long, localAIOFilePictureData.jdField_a_of_type_Int, bais.a().a());
        if (localObject2 != null)
        {
  ...
  public void k()
  {
    if (this.mBrowserItemView != null)
    {
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.mBrowserItemView.findViewById(2131374127));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject = this.jdField_a_of_type_Bajm.getSelectedItem();
      if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 102))
      {
        this.jdField_a_of_type_Bajm.back();
        continue;
        localObject = this.jdField_a_of_type_Bajm.a();
        if (localObject != null)
        {
          if (RichMediaBrowserManager.getInstance().getProvider() != null) {
          ...
          this.jdField_a_of_type_Bajm.a(((AIOFilePictureData)localObject).jdField_a_of_type_Long, ((AIOFilePictureData)localObject).jdField_a_of_type_Int, 0);
          updateUI();
          continue;
          d();
          continue;
          ...
          localObject = this.jdField_a_of_type_Bajm.a();
          if (localObject != null) {
            MiniChatActivity.a(this.mContext, bais.a().a(), bais.a().a(), false, 26, ((AIOFilePictureData)localObject).jdField_d_of_type_Long, 0L);
          }
          this.jdField_a_of_type_Bajm.l();
        }
      }
    }
  }
  ...
  public void onItemSelected(int paramInt)
  {
    ...
    AIOFilePictureData localAIOFilePictureData = this.jdField_a_of_type_Bajm.a();
    if ((localAIOFilePictureData != null) && (!this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.isOriginalImage()) && ((localObject instanceof SkinnableBitmapDrawable)) && (localAIOFilePictureData.jdField_b_of_type_Int == 1) && (localAIOFilePictureData.jdField_c_of_type_Long > asld.c()))
    {
    ...
    if (localAIOFilePictureData != null)
    {
      localObject = new baje();
      if ((((baje)localObject).a(localAIOFilePictureData, 20) == null) && (((baje)localObject).a(localAIOFilePictureData, 18) == null) && (((baje)localObject).a(localAIOFilePictureData, 16) == null) && ((ataw.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) || (localAIOFilePictureData.jdField_g_of_type_Int == 1))) {
        this.jdField_a_of_type_Bajm.a().b();
      }
    }
    updateUI();
  ...
  public void updateUI()
  {
    ...
    case 1: 
      ...
      g(false);
      d(false);
      this.jdField_a_of_type_Bajm.onLoadStart(this.jdField_a_of_type_Bajm.getSelectedIndex(), localAIOFilePictureData.progress);
      return;
    case 2: 
      this.jdField_a_of_type_Bajm.onLoadFinish(this.jdField_a_of_type_Bajm.getSelectedIndex(), true);
      f(false);
      c(false);
      g(false);
      d(false);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131699210) + localAIOFilePictureData.progress / 100 + "%");
    ...
    c(b());
    d(a(this.jdField_a_of_type_Bajm.getSelectedItem()));
    boolean bool;
    baje localbaje;
    if (!FileUtil.fileExistsAndNotEmpty(localAIOFilePictureData.jdField_d_of_type_JavaLangString))
    {
      bool = true;
      f(bool);
      g(true);
    ...
    for (;;)
    {
      ...
      break;
      label324:
      if ((localbaje.a(localAIOFilePictureData, 18) != null) || (localbaje.a(localAIOFilePictureData, 20) != null)) {
        h(true);
      } else {
        h(false);
      }
  ...
  {
    paramString1 = null;
    paramString2 = this.jdField_a_of_type_Bajm.getItem(paramInt);
    Object localObject;
    ImageView localImageView;
    AIOFilePictureData localAIOFilePictureData;
    if ((paramString2 != null) && (paramString2.baseData != null) && (paramString2.baseData.getType() == 102) && (this.mBrowserItemView != null) && ((paramView.getTag() instanceof bakq)))
    {
      localObject = (bakq)paramView.getTag();
      paramView = ((bakq)localObject).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
      localImageView = ((bakq)localObject).jdField_a_of_type_AndroidWidgetImageView;
      localObject = ((bakq)localObject).jdField_a_of_type_AndroidWidgetTextView;
      localAIOFilePictureData = (AIOFilePictureData)paramString2.baseData;
      paramString2 = new baje();
    ...
    {
      if ((paramString2 == null) && (FileUtil.fileExistsAndNotEmpty(localAIOFilePictureData.jdField_b_of_type_JavaLangString)))
      {
      ...
      do
      {
        ...
        if ((ataw.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) || (localAIOFilePictureData.jdField_g_of_type_Int == 1))
        {
          paramString1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844167);
          localImageView.setVisibility(0);
          localImageView.setImageDrawable(paramString1);
          ((TextView)localObject).setVisibility(0);
          ((TextView)localObject).setText(2131692243);
          this.jdField_a_of_type_Bajm.a().b();
        }
        for (;;)
        {
          this.jdField_a_of_type_Bajm.onLoadFinish(paramInt, false);
          this.jdField_a_of_type_Bajm.a().d();
          return;
          paramString1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838097);
          paramView.setImageDrawable(paramString1);
      ...
      bindView(paramInt);
      paramString2 = FileUtils.estimateFileType(localAIOFilePictureData.jdField_c_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Bajm.a().c();
      return;
    }
  }
}
