...
public class bakl
{
  public static bakx a()
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface != null) {
      return (bakx)localQQAppInterface.getManager(QQManagerFactory.VOICE_ASSISTANT_MANAGER);
    }
    return null;
  }
  ...
  public static void a(Activity paramActivity, balb parambalb)
  {
    if ((paramActivity == null) || (parambalb == null) || (parambalb.a == null)) {
      if (QLog.isColorLevel()) {
        QLog.d("AssistantUtils", 2, "executeJumpAction jump params is null activity = " + paramActivity + ", commandInformation = " + parambalb);
      }
    }
    do
    {
      return;
      if (parambalb.a.jdField_a_of_type_Int == 115)
      {
        a(paramActivity, parambalb.a.jdField_a_of_type_JavaLangString, parambalb.a.jdField_b_of_type_JavaLangString, parambalb.a.jdField_b_of_type_Int);
        return;
      }
      parambalb = bake.a(parambalb.a.jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(parambalb)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("AssistantUtils", 2, "executeJumpAction openAction is null");
    return;
    a(paramActivity, parambalb);
  }
  ...
  {
    ((bakx)a().getManager(QQManagerFactory.VOICE_ASSISTANT_MANAGER)).b(paramString);
  }
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    localHashMap.put("echo_android_id", DeviceInfoUtil.getAndroidID());
