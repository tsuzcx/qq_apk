  ...
  implements Handler.Callback, Manager, BusinessObserver
{
  ...
  private ConcurrentHashMap<Long, bduk> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private int b = -1;
  ...
  public bduh(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageForPtt paramMessageForPtt, int paramInt)
  {
    if (paramMessageForPtt != null)
    {
      ...
      paramMessageForPtt.sttText = anzj.a(2131713423);
      ...
      bdmc.a(BaseApplication.getContext()).a(null, "ptttotextSuc", false, 0L, 0L, localHashMap, null);
    }
    try
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    return ((bduh)paramQQAppInterface.getManager(17)).a();
  }
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      localHashMap.put("appversion", "8.4.5");
      localbdmc.a("", "PttSttEntryChange", false, 0L, 0L, localHashMap, "");
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfByte != null)
      {
        ...
        localObject = (bduk)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localLong);
        paramArrayOfByte = (byte[])localObject;
        if (localObject == null)
        {
          paramArrayOfByte = new bduk(null);
  ...
  public Long b(MessageForPtt paramMessageForPtt, int paramInt)
  {
    ...
    {
      if (!bhsr.a(paramMessageForPtt.urlAtServer)) {
        break label160;
      }
      QLog.e("", 1, new Object[] { "stt err, c2c no fileID ", paramMessageForPtt });
      a(paramMessageForPtt, 2003);
      if (this.jdField_a_of_type_Bduj != null) {
        this.jdField_a_of_type_Bduj.a(false, paramMessageForPtt);
      }
    }
    for (;;)
    {
      return localLong;
      if (bhsr.a(paramMessageForPtt.md5))
      {
      ...
      else
      {
        ...
        boolean bool = biik.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", false);
        if ((((armr)localObject).jdField_a_of_type_Int == 2) && (!bool) && (VipUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (ahod.d))
        {
          localObject = new avpd(paramMessageForPtt.frienduin, paramMessageForPtt.selfuin, anzj.a(2131713424), paramMessageForPtt.istroop, -5020, 655392, paramMessageForPtt.time);
          ...
          biik.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", true);
        ...
        while (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localLong))
        {
          ...
          bdul.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPtt, localLong, paramInt);
          return localLong;
          if (QLog.isColorLevel()) {
            QLog.d("Q.stt", 1, "stage2 first translate It is need add gray msg and insert falied:conf.stage == " + ((armr)localObject).jdField_a_of_type_Int + " && " + bool);
          }
        }
      }
    }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return true;
      bhoi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (QLog.isColorLevel()) {
        QLog.d("Q.stt", 2, "needAuotoChange AutoChangeFlag=" + ahod.d + " AutoChangeSetTime=" + ahod.jdField_a_of_type_Long + " isTranslating=" + a(paramMessageForPtt) + "mPtt.msgTime=" + paramMessageForPtt.msgTime + " mPtt.time=" + paramMessageForPtt.time + " mPtt.sttAbility=" + paramMessageForPtt.sttAbility + " isRedPackPTT=" + aljb.a(paramMessageForPtt));
      }
    } while ((!a(paramMessageForPtt)) && (!aljb.a(paramMessageForPtt)) && (ahod.d) && ((ahod.jdField_a_of_type_Long < paramMessageForPtt.msgTime) || (ahod.jdField_a_of_type_Long < paramMessageForPtt.time)) && (paramMessageForPtt.voiceChangeFlag != 1) && ((paramMessageForPtt.sttAbility == 1) || (paramMessageForPtt.sttAbility == 3)));
    return false;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (MessageForPtt localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(paramMessage.obj);; localMessageForPtt = null)
    {
      ...
      if ((localMessageForPtt != null) && (this.jdField_a_of_type_Bduj != null))
      {
        a(localMessageForPtt, 2002);
        this.jdField_a_of_type_Bduj.a(false, localMessageForPtt);
      }
      return true;
      ...
      for (localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(Long.valueOf(l));; localMessageForPtt = null)
      {
        ...
        bdmc.a(BaseApplication.getContext()).a(null, "ptttotextSuc", true, 0L, 0L, localHashMap, null);
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PttItemBuilder", 2, "ptt convert to text success,seq is:" + localMessageForPtt.uniseq + ",sttAbility is:" + localMessageForPtt.sttAbility + ",sttText is:" + bhjx.a(localMessageForPtt.sttText));
        }
        if (this.jdField_a_of_type_Bduj == null) {
          break;
        }
        this.jdField_a_of_type_Bduj.a(true, localMessageForPtt);
        return true;
      }
    }
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Bduj == null);
      this.jdField_a_of_type_Bduj.a(false, paramBundle);
      return;
    } while (!QLog.isColorLevel());
