  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject = new NewIntent(BaseApplicationImpl.getApplication(), bduo.class);
          ...
          ((NewIntent)localObject).putExtra("has_report_yes", new Boolean(bdug.jdField_a_of_type_Boolean));
          BaseApplicationImpl.getApplication().getRuntime().startServlet((NewIntent)localObject);
          bdug.jdField_a_of_type_Float = bdug.jdField_a_of_type_Int - bdug.b + bdug.c;
          localObject = BaseApplicationImpl.getApplication().getRuntime().getAccount();
          if (!TextUtils.isEmpty((CharSequence)localObject)) {
            bdug.jdField_a_of_type_JavaLangString = (String)localObject;
          }
          bdug.jdField_a_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
          QLog.i("SSOHttpUtils", 1, "SSOHttpUtils do report success steps:" + bdug.jdField_a_of_type_Float);
        }
        ...
        if (((JSONObject)localObject).has("svr_steps"))
        {
          ...
          paramBundle = new NewIntent(BaseApplicationImpl.getApplication(), bduo.class);
