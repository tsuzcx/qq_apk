...
public class xob
  implements Runnable
{
  public xob(NewFlowCameraActivity paramNewFlowCameraActivity, Bitmap paramBitmap) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaNewFlowCameraActivity.a.post(new xoz(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaNewFlowCameraActivity, localBitmap1, localBitmap2));
  }
}
