...
public class xob
{
  ...
  public xob(BaseActivity paramBaseActivity, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = xee.b(paramBaseActivity, paramInt);
      return;
      bool = false;
    }
  }
  ...
  private void a(float paramFloat)
  {
    ...
    if (paramFloat > 0.5D)
    {
      ...
      this.b.setBackgroundResource(2130849987);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840101);
    this.b.setBackgroundResource(2130849987);
    this.b.setTextColor(this.b.getContext().getResources().getColorStateList(2131166898));
    this.c.setTextColor(this.c.getContext().getResources().getColorStateList(2131166898));
  }
  
  public void a(View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131377935));
    ...
    this.c = ((TextView)paramView.findViewById(2131368644));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368627));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      ...
      localValueAnimator.addUpdateListener(new xoc(this));
