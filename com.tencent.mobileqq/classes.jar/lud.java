  ...
  extends ltz
{
  ...
  public lud(luh paramluh)
  {
    ...
    this.jdField_a_of_type_Luz = new luz(localBitmap);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 > 2)
    {
      ...
      if (this.jdField_a_of_type_ArrayOfLuz != null)
      {
        ...
        if (this.jdField_a_of_type_ArrayOfLuz[(paramInt1 / 10)] != null) {
          this.jdField_a_of_type_ArrayOfLuz[(paramInt1 / 10)].a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
        }
    ...
    for (;;)
    {
      if (this.jdField_b_of_type_Luz != null) {
        this.jdField_b_of_type_Luz.a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
      this.jdField_b_of_type_AndroidGraphicsRect.set(0, 59, 252, 148);
      paramInt1 = (paramInt2 - 80) / 10;
      if ((paramInt1 >= 0) && (paramInt1 < this.jdField_b_of_type_ArrayOfLuz.length) && (this.jdField_b_of_type_ArrayOfLuz[paramInt1] != null)) {
        this.jdField_b_of_type_ArrayOfLuz[paramInt1].a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
      return;
      label239:
      if (this.jdField_a_of_type_ArrayOfLuz[paramInt1] != null) {
        this.jdField_a_of_type_ArrayOfLuz[paramInt1].a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
  ...
  {
    this.jdField_b_of_type_ArrayOfLuz[0] = new luz(paramAVRedPacketManager.a("qav_redpacket_score_80.png"));
    this.jdField_b_of_type_ArrayOfLuz[1] = new luz(paramAVRedPacketManager.a("qav_redpacket_score_90.png"));
    this.jdField_b_of_type_ArrayOfLuz[2] = new luz(paramAVRedPacketManager.a("qav_redpacket_score_100.png"));
    this.jdField_b_of_type_ArrayOfLuz[3] = new luz(paramAVRedPacketManager.a("qav_redpacket_score_110.png"));
    this.jdField_b_of_type_Luz = new luz(paramAVRedPacketManager.a("qav_redpacket_score_combo.png"));
  ...
  {
    super.b();
    luz[] arrayOfluz = this.jdField_b_of_type_ArrayOfLuz;
