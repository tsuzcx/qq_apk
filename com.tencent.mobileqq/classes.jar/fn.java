...
public class fn
{
  ...
  private ArrayList<fq> jdField_a_of_type_JavaUtilArrayList = new ArrayList(16);
  public AtomicBoolean a;
  public boolean a;
  private fr[] jdField_a_of_type_ArrayOfFr;
  public int b;
  public ETFont b;
  private ArrayList<CharacterStyle> b;
  public boolean b;
  public int c;
  private ArrayList<fs> jdField_c_of_type_JavaUtilArrayList = new ArrayList(16);
  ...
  private String a()
  {
    ...
    if ((this.jdField_a_of_type_ArrayOfFr == null) || (this.jdField_a_of_type_ArrayOfFr.length == 0)) {
      return null;
    }
    ...
    {
      Object localObject = ((fq)localIterator.next()).a();
      if (localObject == null) {
        return null;
      }
  ...
  private void a(CharacterStyle paramCharacterStyle, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    paramCharacterStyle = new fq(paramCharacterStyle, paramInt1, paramInt2, paramInt3, paramBoolean);
  ...
  private void a(ETEngine paramETEngine, int paramInt)
  {
    if (this.jdField_a_of_type_ArrayOfFr != null) {
      this.jdField_a_of_type_ArrayOfFr = null;
    }
    ...
    while (i < m)
    {
      localObject1 = (fq)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      k = ((fq)localObject1).a(paramETEngine, paramInt, j, k);
      j = ((fq)localObject1).a();
      i += 1;
    }
    k += 1;
    this.jdField_a_of_type_ArrayOfFr = new fr[k];
    paramInt = 0;
    while (paramInt < k)
    {
      this.jdField_a_of_type_ArrayOfFr[paramInt] = new fr();
      paramInt += 1;
    }
    paramInt = 0;
    Object localObject2;
    while (paramInt < m)
    {
      localObject1 = ((fq)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).a();
      i = 0;
      while (i < ((ArrayList)localObject1).size())
      {
        ...
        j = ((fm)localObject2).e();
        if ((j >= 0) && (j < k)) {
          this.jdField_a_of_type_ArrayOfFr[j].a((fm)localObject2);
        }
        i += 1;
      }
      paramInt += 1;
    ...
    while (paramInt < k)
    {
      localObject1 = this.jdField_a_of_type_ArrayOfFr[paramInt];
      ((fr)localObject1).a(paramETEngine, 0, i, this.jdField_a_of_type_Int);
      localObject2 = ((fr)localObject1).a().iterator();
      j = 0;
      while (((Iterator)localObject2).hasNext())
      {
        fm localfm = (fm)((Iterator)localObject2).next();
        fs[] arrayOffs = localfm.a(paramETEngine, j, i, ((fr)localObject1).a(), paramInt);
        if ((arrayOffs != null) && (arrayOffs.length > 0)) {
          Collections.addAll(this.jdField_c_of_type_JavaUtilArrayList, arrayOffs);
        }
        j += localfm.c();
      }
      i += ((fr)localObject1).a();
  ...
  private void a(String paramString, int paramInt1, int paramInt2, ETFont paramETFont, boolean paramBoolean)
  {
    ...
    paramString = new fq(paramString, paramInt1, paramInt2, paramETFont, paramBoolean);
  ...
  private void a(String paramString, int paramInt1, int paramInt2, ETFont paramETFont, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    paramString = new fq(paramString, paramInt1, paramInt2, paramETFont, paramBoolean1);
    paramString.a(this.g);
  ...
  private int b()
  {
    ...
    int i = this.jdField_a_of_type_ArrayOfFr.length;
    return this.jdField_a_of_type_ArrayOfFr[(i - 1)].b();
  }
  ...
  private void b()
  {
    ...
    fp[] arrayOffp = new fp[arrayOfCharacterStyle.length];
    if ((arrayOffp == null) || (arrayOffp.length == 0))
    {
      a(this.jdField_a_of_type_JavaLangCharSequence.toString(), 0, this.jdField_a_of_type_JavaLangCharSequence.length(), this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      return;
    }
    ...
    {
      arrayOffp[i] = new fp();
      arrayOffp[i].jdField_a_of_type_Int = ((Spanned)localObject).getSpanStart(arrayOfCharacterStyle[i]);
      arrayOffp[i].jdField_b_of_type_Int = ((Spanned)localObject).getSpanEnd(arrayOfCharacterStyle[i]);
      arrayOffp[i].jdField_a_of_type_AndroidTextStyleCharacterStyle = arrayOfCharacterStyle[i];
      i += 1;
    }
    Arrays.sort(arrayOffp, new fo());
    i = 0;
    int j = 0;
    label176:
    int m;
    ...
    {
      m = arrayOffp[i].jdField_a_of_type_Int;
      k = arrayOffp[i].jdField_b_of_type_Int;
      if (m - j > 0) {
        a(a(this.jdField_a_of_type_JavaLangCharSequence, j, m).toString(), j, m, this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      }
      if (k - m > 0)
      {
        if (!(arrayOffp[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof ClickableSpan)) {
          break label379;
        }
    ...
    for (j = m + 1;; j = m)
    {
      ...
      for (;;)
      {
        ...
        break;
        label379:
        if ((arrayOffp[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof QQText.EmoticonSpan))
        {
          localObject = (QQText.EmoticonSpan)arrayOffp[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
          this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
          a((CharacterStyle)localObject, this.jdField_b_of_type_JavaUtilArrayList.indexOf(localObject), m, k, false);
        }
        else if ((arrayOffp[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof RelativeSizeSpan))
        {
          localObject = a(this.jdField_a_of_type_JavaLangCharSequence, m, k);
          RelativeSizeSpan localRelativeSizeSpan = (RelativeSizeSpan)arrayOffp[i].jdField_a_of_type_AndroidTextStyleCharacterStyle;
  ...
  {
    if (this.jdField_a_of_type_ArrayOfFr != null) {
      return this.jdField_a_of_type_ArrayOfFr.length;
    }
    return 0;
  }
  ...
  int a(int paramInt)
  {
    int j = this.jdField_a_of_type_ArrayOfFr.length;
    int i = 0;
    while (i < j)
    {
      fr localfr = this.jdField_a_of_type_ArrayOfFr[i];
      int k = localfr.d();
      if (paramInt < localfr.a() + k) {
        return i;
      }
      i += 1;
    }
  ...
  int a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 < k)
    {
      fs localfs = (fs)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt2);
      if (localfs.jdField_a_of_type_Int == j)
      {
        if (paramInt1 > localfs.jdField_a_of_type_AndroidGraphicsRect.right) {
          break label87;
        }
        return paramInt2;
      }
  ...
  Rect a(int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_ArrayOfFr.length)) {
      return null;
    }
    fr localfr = this.jdField_a_of_type_ArrayOfFr[paramInt];
    paramInt = localfr.c();
    int i = localfr.d();
    return new Rect(paramInt, i, this.jdField_b_of_type_Int + paramInt, i + localfr.a());
  }
  ...
  public QQText.EmoticonSpan a(int paramInt1, int paramInt2)
  {
    ...
    fr[] arrayOffr = this.jdField_a_of_type_ArrayOfFr;
    int j = arrayOffr.length;
    if (i < j)
    {
      Object localObject = arrayOffr[i];
      localRect.left = ((fr)localObject).c();
      localRect.top = ((fr)localObject).d();
      localRect.right = (localRect.left + ((fr)localObject).b());
      localRect.bottom = (localRect.top + ((fr)localObject).a());
      if (!localRect.contains(paramInt1, paramInt2)) {}
      do
      {
        i += 1;
        break;
        localObject = ((fr)localObject).a(paramInt1);
  ...
  fs a(int paramInt)
  {
    ...
    return (fs)this.jdField_c_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  public final void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      return;
      fr[] arrayOffr = this.jdField_a_of_type_ArrayOfFr;
      int k = arrayOffr.length;
      int j = 0;
      int i = paramInt2;
      paramInt2 = j;
      while (paramInt2 < k)
      {
        fr localfr = arrayOffr[paramInt2];
        localfr.a(paramCanvas, paramInt1, i);
        i += localfr.a();
        paramInt2 += 1;
      }
    }
  ...
  public final void a(ETEngine paramETEngine, Bitmap paramBitmap, ETDecoration paramETDecoration, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_b_of_type_Int > 0) && (this.jdField_c_of_type_Int > 0))
      {
        ...
        paramETDecoration = this.jdField_a_of_type_ArrayOfFr;
        ...
        for (;;)
        {
          ...
          ((fr)localObject1).a(paramETEngine, paramBitmap, null, j, k);
          k += ((fr)localObject1).a();
          if (k >= n) {
            break;
          }
    ...
    for (;;)
    {
      ...
      {
        j = 0;
        localObject1 = this.jdField_a_of_type_ArrayOfFr;
  ...
  public boolean a(ETEngine paramETEngine, int paramInt1, CharSequence paramCharSequence, ETFont paramETFont, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    if (paramInt2 < j)
    {
      int i = this.jdField_a_of_type_ArrayOfFr[paramInt2].b();
      k = this.jdField_a_of_type_ArrayOfFr[paramInt2].a();
      if (i <= paramInt1) {
        break label254;
      }
      paramInt1 = i;
  ...
  {
    if ((this.jdField_a_of_type_ArrayOfFr == null) || (paramInt >= this.jdField_a_of_type_ArrayOfFr.length)) {
      return null;
    }
    ArrayList localArrayList = new ArrayList();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localfs.jdField_a_of_type_Int == paramInt) {
        localArrayList.add(localfs);
      }
    }
    return (fs[])localArrayList.toArray(new fs[0]);
  }
