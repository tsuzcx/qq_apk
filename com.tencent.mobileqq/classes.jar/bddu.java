...
public class bddu
{
  ...
  bddb jdField_a_of_type_Bddb = null;
  ...
  public void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      azmz.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_system_report", true, 0L, 0L, paramIntent, null);
    ...
    return;
    String str;
    if (this.jdField_a_of_type_Bddb != null)
    {
      str = this.jdField_a_of_type_Bddb.jdField_b_of_type_JavaLangString;
      paramIntent = this.jdField_a_of_type_Bddb.jdField_c_of_type_JavaLangString;
    }
    for (;;)
    {
      ...
      azmz.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_business_report", true, 0L, 0L, (HashMap)localObject, null);
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              Object localObject = bddr.a(paramActivity);
    ...
    this.jdField_a_of_type_Bddb = bdds.a(paramQQAppInterface, paramActivity, this.g);
  }
