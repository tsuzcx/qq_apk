  ...
  extends atlj<atln>
{
  ...
  public atlx(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt, long paramLong, atlf paramatlf)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", "uinType = [" + paramInt + "], sessionUin = [" + paramLong + "], locationItem = [" + paramatlf + "]" });
    }
    RoomOperate.ReqReportLocation localReqReportLocation = new RoomOperate.ReqReportLocation();
    qq_lbs_share.RoomKey localRoomKey = atpv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, paramLong);
    localReqReportLocation.room_key.set(localRoomKey);
    localReqReportLocation.room_key.setHasFlag(true);
    localReqReportLocation.direction.set(paramatlf.a());
    paramatlf = paramatlf.a();
    if (paramatlf == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", " latLng: ", paramatlf });
      }
      return;
    }
    localReqReportLocation.lat.set(paramatlf.latitude);
    localReqReportLocation.lon.set(paramatlf.longitude);
    paramatlf = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "QQLBSShareSvc.report_location");
    paramatlf.putWupBuffer(localReqReportLocation.toByteArray());
    a().sendPbReq(paramatlf);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (a(paramToServiceMsg, paramFromServiceMsg, paramObject))
    {
      try
      {
        ...
        if (atpv.a((qq_lbs_share.ResultInfo)paramToServiceMsg.msg_result.get()))
        {
  ...
  public void a(String paramString, atly paramatly)
  {
  ...
  public boolean a(atlh paramatlh)
  {
    ...
    return new atlh(this.b, "" + this.jdField_a_of_type_JavaLangLong).equals(paramatlh);
  }
