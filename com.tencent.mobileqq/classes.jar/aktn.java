...
public class aktn
  implements akto
{
  aktl jdField_a_of_type_Aktl;
  aktm jdField_a_of_type_Aktm;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  aktn(QQAppInterface paramQQAppInterface, aktm paramaktm)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aktm = paramaktm;
    this.jdField_a_of_type_Aktl = this.jdField_a_of_type_Aktm.jdField_a_of_type_Aktl;
  }
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Aktm.a(localArrayList))
    {
