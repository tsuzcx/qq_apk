  ...
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bhqd
{
  ...
  public aktn(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = akro.a(this.jdField_a_of_type_Int);
      if (paramString != null)
      {
  ...
  private String a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      localStringBuilder.append(alef.s);
  ...
  {
    return alef.s + paramInt + "/" + "shareQRCode_default_v2.png";
  }
  ...
  private boolean a(long paramLong)
  {
    try
    {
      ...
      CmGameStartChecker.StartCheckParam localStartCheckParam = localaktr.a();
  ...
  {
    return alef.s + paramInt + "/" + "shareQRCode_no_icon_default_v2.png";
  }
  ...
  private void b()
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        bjao.a(a(), (Context)localObject, localBundle, this, 255);
        return;
      }
      a(1, 4);
      return;
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      ...
      if ((this.jdField_a_of_type_Bhpy == null) && (paramString != null))
      {
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(bhqi.a(0));
        localArrayList.add(bhqi.a(1));
        localArrayList.add(bhqi.a(2));
        localArrayList.add(bhqi.a(3));
        if (paramString != null)
        {
          localbhqi = new bhqi(paramString);
          localbhqi.a(localArrayList);
        }
        this.jdField_a_of_type_Bhpy = bhqi.a(paramString, localbhqi, this, this, this, false);
      }
      if ((this.jdField_a_of_type_Bhpy == null) || (this.jdField_a_of_type_Bhpy.isShowing())) {
        break;
      }
      this.jdField_a_of_type_Bhpy.setOnDismissListener(this);
      this.jdField_a_of_type_Bhpy.a(new akto(this));
  ...
  {
    if (new File(alef.s + paramInt + "/" + "shareQRCode_default_v2.png").exists()) {}
    while (new File(alef.s + paramInt + "/" + "shareQRCode_no_icon_default_v2.png").exists()) {
      return true;
    }
    return false;
  }
