...
import com.tencent.mobileqq.activity.aio.rebuild.FriendChatPie.13.1;
  ...
  extends ajmm
{
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      if ((paramSendMessageHandler != null) && (paramSendMessageHandler.msgtype == -2058) && ((paramSendMessageHandler.extraflag == 32768) || (paramSendMessageHandler.sendFailCode == 41)))
      {
        ...
        paramString1 = akbm.a(paramString1, paramInt1);
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        ...
        ThreadManager.getUIHandler().post(new FriendChatPie.13.1(this, paramSendMessageHandler));
      }
      this.a.e(196608);
      return;
      label463:
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong, ajmj paramajmj)
  {
    ...
    ((arin)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(308)).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, arin.jdField_a_of_type_Int);
  }
