  ...
  extends pxz
{
  ...
  private SparseArray<WeakReference<pys>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  
  public pyq(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
    super(paramAppInterface, paramEntityManager, paramExecutorService, paramqnd, paramHandler);
  }
  
  public pyq(EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
    super(null, paramEntityManager, paramExecutorService, paramqnd, paramHandler);
  }
  ...
  private ToServiceMsg a(List<ReportInfo> paramList)
  {
    ...
    return qnf.a("OidbSvc.0x64e", 1614, 0, localReqBody.toByteArray());
  }
  ...
  private void a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    {
      qps.a.a().a(paramInt1, paramString1, paramString2, paramInt2);
      return;
    }
    ThreadManager.getUIHandler().post(new UserOperationModule.6(this, paramInt1, paramString1, paramString2, paramInt2));
  }
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localReportInfo.mFolderStatus == 0) {
          localReportInfo.mFolderStatus = pha.d;
        }
        ...
        localReportInfo1.bytes_device_id.set(ByteStringMicro.copyFromUtf8(pha.j()));
  ...
  private void b(oidb_cmd0x64e.ReportInfo paramReportInfo, ReportInfo paramReportInfo1)
  {
    ...
    if (localObject != null)
    {
      ...
      paramReportInfo1.uint64_feeds_id.set(((rgh)localObject).jdField_a_of_type_Long);
      paramReportInfo1.uint64_publish_uin.set(((rgh)localObject).jdField_b_of_type_Long);
      paramReportInfo1.uint32_like_total_count.set(((rgh)localObject).jdField_a_of_type_Int);
      paramReportInfo1.uint32_comment_total_count.set(((rgh)localObject).jdField_b_of_type_Int);
      ArrayList localArrayList2 = new ArrayList();
      if ((((rgh)localObject).jdField_a_of_type_JavaUtilList != null) && (!((rgh)localObject).jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        localObject = ((rgh)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext()) {
  ...
  {
    rgi localrgi = paramReportInfo1.mVideoExtraRepoerData;
    if (localrgi != null)
    {
      paramReportInfo.enum_network_type.set(b());
      paramReportInfo.operator_platform.set(3);
      if (localrgi.jdField_b_of_type_Boolean) {
        paramReportInfo.whether_click_in.set(localrgi.jdField_a_of_type_Boolean);
      }
      if (localrgi.jdField_a_of_type_Int != -1) {
        paramReportInfo.enum_jumpway_which.set(localrgi.jdField_a_of_type_Int);
      }
      if (localrgi.jdField_b_of_type_Int != -1) {
        paramReportInfo.enum_in_onetree_source.set(localrgi.jdField_b_of_type_Int);
      }
      if (localrgi.c != -1) {
        paramReportInfo.enum_in_videochannel_source.set(localrgi.c);
      }
      if (localrgi.d != -1) {
        paramReportInfo.uint32_current_video_time.set(localrgi.d);
      }
      if (localrgi.e != -1) {
        paramReportInfo.uint32_video_duration.set(localrgi.e);
      }
      if ((paramReportInfo1.mOpSource == 5) && (localrgi.f != -1)) {
        paramReportInfo.uint32_onetree_video_from_type.set(localrgi.f);
      }
    }
  }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (long l1 = paramToServiceMsg.uint64_uin.get();; l1 = 0L)
    {
      ...
      if ((paramToServiceMsg.AIOPulseMaxCnt.has()) && (paramToServiceMsg.firstScnRedPntPulseMaxCnt.has()) && (paramToServiceMsg.leftBtmRedPntPulseMaxCnt.has()))
      {
        ...
        bmqa.a(pha.a(), l1, l2, l3);
      }
      if ((paramToServiceMsg.lastRecvMsgDuration.has()) && (paramToServiceMsg.lastSendMsgDuration.has())) {
        bmqa.a((int)paramToServiceMsg.lastRecvMsgDuration.get(), (int)paramToServiceMsg.lastSendMsgDuration.get());
      }
      if ((paramToServiceMsg.pulseTimerDuration.has()) && (paramToServiceMsg.pulseTimerDuration.get() != 12345678L)) {
        pmy.a().b((int)paramToServiceMsg.pulseTimerDuration.get());
      }
      if (paramToServiceMsg.leftBtmRedCntMaxForExitAIO.has()) {
        bmqa.e((int)paramToServiceMsg.leftBtmRedCntMaxForExitAIO.get());
      }
      if ((paramToServiceMsg.uint64_main_video_tab_red.has()) && (paramToServiceMsg.uint64_main_video_tab_red.get() > 0L)) {
        ((KandianMergeManager)pha.a().getManager(162)).a(new KandianRedDotInfo("kandian_video_tab_reddot_info"));
      }
      if (paramToServiceMsg.uint64_scroll_interval_time.has()) {
        pnl.jdField_a_of_type_Long = paramToServiceMsg.uint64_scroll_interval_time.get();
      }
      if (paramToServiceMsg.uint64_scroll_all_time.has()) {
        pnl.jdField_b_of_type_Long = paramToServiceMsg.uint64_scroll_all_time.get();
      }
      if (paramToServiceMsg.uint64_chat_aio_time.has()) {
        pmy.c = paramToServiceMsg.uint64_chat_aio_time.get();
      }
      ...
      if (paramToServiceMsg.idle_push_wake_param.has()) {
        ubw.a(paramToServiceMsg.idle_push_wake_param.get());
      }
      if (paramToServiceMsg.msg_srt_rule_list.has()) {
        pgw.a().a(paramToServiceMsg.msg_srt_rule_list.get());
      }
      ...
      {
        bmqa.a("sp_msg_box_80a_enable_receive", Boolean.valueOf(bool));
  ...
  {
    int i = qnf.a(paramFromServiceMsg, paramObject, new oidb_cmd0x64e.RspBody());
    if (QLog.isColorLevel()) {
  ...
  {
    int i = qnf.a(paramFromServiceMsg, paramObject, new oidb_cmd0xde0.RspBody());
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, List<oidb_cmd0x80a.AttributeList> paramList, String paramString2, int paramInt3)
  {
    ...
    if (bcnj.b())
    {
      ...
      localReqBody.uint32_privacy_status.set(uaq.b());
      if (!bmqa.i()) {
        break label223;
      }
    ...
    for (;;)
    {
      ...
      a(qnf.a(paramString2, paramInt3, 0, localReqBody.toByteArray()));
      return;
      i = 0;
      break;
      label223:
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      bgva.a(paramString, 0, l);
      paramString[4] = 0;
      bgva.a(paramString, 5, (short)1);
      bgva.a(paramString, 7, jdField_a_of_type_Int);
      paramString = qnf.a("OidbSvc.0x480_9", 1152, 9, paramString);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      bgva.a(paramString, 5, (short)1);
      bgva.a(paramString, 7, jdField_a_of_type_Int);
      bgva.a(paramString, 9, (short)2);
      bgva.a(paramString, 11, (short)paramInt);
      paramString = qnf.a("OidbSvc.0x4ff_9", 1279, 9, paramString);
      paramString.extraData.putBoolean("reqFromReadinjoyHandler", true);
      a(paramString);
      return;
    }
  ...
  public void a(String paramString1, long paramLong, boolean paramBoolean, String paramString2, pyu parampyu, int paramInt)
  {
    a(paramString1, String.valueOf(paramLong), paramBoolean, paramString2, parampyu, paramInt, true);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, pyu parampyu)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, parampyu, 2, true);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, pyu parampyu, int paramInt)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, parampyu, paramInt, true);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean1, String paramString3, pyu parampyu, int paramInt, boolean paramBoolean2)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        ...
        Object localObject1 = qnf.a("OidbSvc.0x978", 2424, 0, ((oidb_cmd0x978.ReqBody)localObject2).toByteArray());
        paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(parampyu));
        ...
        ((ToServiceMsg)localObject1).addAttribute("needShowPushNotifyDialog", Boolean.valueOf(paramBoolean2));
  ...
  public void a(ArrayList<pwk> paramArrayList, pyt parampyt, int paramInt)
  {
    a(paramArrayList, true, parampyt, paramInt);
  }
  
  protected void a(ArrayList<pwk> paramArrayList, boolean paramBoolean, pys parampys, int paramInt)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
      QLog.d("UserOperationModule", 2, "batch0x978, followList = " + paramArrayList + ", isFollow = " + paramBoolean + ", callback = " + parampys + ", refer = " + paramInt);
    }
    ...
    {
      localObject = (pwk)paramArrayList.get(i);
      oidb_cmd0x978.OneFollowOperationInfo localOneFollowOperationInfo = new oidb_cmd0x978.OneFollowOperationInfo();
      localOneFollowOperationInfo.uint64_dst_uin.set(Long.valueOf(((pwk)localObject).jdField_a_of_type_Long).longValue());
      localOneFollowOperationInfo.uint32_op_account_type.set(((pwk)localObject).jdField_a_of_type_Int);
    ...
    paramArrayList = qnf.a("OidbSvc.0x978", 2424, 0, paramArrayList.toByteArray());
    paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(parampys));
  ...
  public void a(rat paramrat, Context paramContext)
  {
    ThreadManager.executeOnSubThread(new UserOperationModule.7(this, paramrat, paramContext));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg.getAttribute("distUin") != null)
    {
      ...
      if (paramToServiceMsg.getAttribute("needShowPushNotifyDialog") == null) {
        break label207;
      }
      bool2 = ((Boolean)paramToServiceMsg.getAttribute("needShowPushNotifyDialog")).booleanValue();
      paramToServiceMsg = (pys)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
      this.jdField_a_of_type_AndroidUtilSparseArray.remove(i);
      localRspBody = new oidb_cmd0x978.RspBody();
      i = qnf.a(paramFromServiceMsg, paramObject, localRspBody);
    ...
    do
    {
      ...
      QLog.i("UserOperationModule", 1, "handle 978resp  guideType : " + j + ", needShowPushNotifyDialog=" + bool2);
      if ((j != 0) && (bool2)) {
        ThreadManager.getUIHandler().post(new UserOperationModule.1(this, (String)localObject2, (String)localObject1, j));
      }
    ...
    if (bool1)
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          paramObject.add(new pwk(l, i, bool1));
          break;
        }
      }
    ...
    while (paramFromServiceMsg.hasNext())
    {
      ...
      {
        pmh.a().a(Long.valueOf((String)localObject1).longValue(), paramObject.enum_follow_status.get());
  ...
  public void b(ArrayList<pwk> paramArrayList, pyt parampyt, int paramInt)
  {
    a(paramArrayList, false, parampyt, paramInt);
  }
