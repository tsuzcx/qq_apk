...
public class pyq
{
  ...
  private static volatile pyq jdField_a_of_type_Pyq;
  public static int b;
  ...
  private pyq()
  {
    this.jdField_a_of_type_Pyu = new pyu(this);
    ...
    try
    {
      String str = (String)bhvh.a(jdField_a_of_type_JavaLangString, "");
      Object localObject2;
      ...
      Object localObject1 = (String)bhvh.a(jdField_b_of_type_JavaLangString, "");
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      bhvh.a(jdField_a_of_type_JavaLangString, "");
      bhvh.a(jdField_b_of_type_JavaLangString, "");
    }
  }
  ...
  public static pyq a()
  {
    if (jdField_a_of_type_Pyq == null) {}
    try
    {
      if (jdField_a_of_type_Pyq == null) {
        jdField_a_of_type_Pyq = new pyq();
      }
      return jdField_a_of_type_Pyq;
    }
    finally {}
  }
  ...
  private void a(AbsListView paramAbsListView, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (pyr)this.jdField_a_of_type_JavaUtilList.get(((Integer)this.jdField_b_of_type_JavaUtilHashMap.get(str)).intValue());
      l3 = ((pyr)localObject1).jdField_b_of_type_Long;
      if (i1 <= 0) {
        break label521;
      }
    }
    ...
    {
      ((pyr)localObject1).jdField_b_of_type_Long = (l2 + l3);
      localObject2 = a(localView);
      if ((localObject2 != null) && (localObject2[1] - localObject2[0] >= localView.getHeight() * jdField_a_of_type_Double)) {
        ((pyr)localObject1).jdField_c_of_type_Long += l1;
      }
      ((pyr)localObject1).jdField_c_of_type_Boolean = this.jdField_a_of_type_JavaUtilHashMap.containsKey(str);
      if (!paramBoolean) {
        break;
      }
      ((pyr)localObject1).jdField_b_of_type_Boolean = true;
      break;
      localObject1 = new pyr(this);
      ((pyr)localObject1).jdField_a_of_type_JavaLangString = str;
      ((pyr)localObject1).jdField_a_of_type_Int = onk.a((BaseArticleInfo)localObject2);
      int m;
      label305:
      boolean bool;
      ...
      {
        m = 0;
        ((pyr)localObject1).jdField_b_of_type_Int = m;
        if (this.jdField_g_of_type_Long != -1L) {
          break label504;
        }
        bool = true;
        label326:
        ((pyr)localObject1).jdField_a_of_type_Boolean = bool;
        ((pyr)localObject1).jdField_c_of_type_Int = localView.getHeight();
        ((pyr)localObject1).jdField_b_of_type_JavaLangString = ((BaseArticleInfo)localObject2).mRecommentdReason;
        m = this.j;
        this.j = (m + 1);
        ((pyr)localObject1).jdField_d_of_type_Int = m;
        localObject2 = onu.a().a();
      ...
      label504:
      label510:
      for (((pyr)localObject1).jdField_c_of_type_JavaLangString = (localObject2[0] + "_" + localObject2[1] + "_" + localObject2[2] + "_" + localObject2[3]);; ((pyr)localObject1).jdField_c_of_type_JavaLangString = "NULL")
      {
  ...
  private void e()
  {
    ...
    if (this.jdField_b_of_type_ArrayOfInt != null)
    {
      ...
      bhvh.a(jdField_b_of_type_JavaLangString, str);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      bhvh.a(jdField_a_of_type_JavaLangString, str);
    }
  }
  
  public long a()
  {
    if (this.jdField_a_of_type_Pyu.jdField_a_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_a_of_type_Pyu.jdField_a_of_type_Long - this.jdField_a_of_type_Long;
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_d_of_type_Long != 0L) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(this.jdField_c_of_type_JavaLangString)))
    {
      ...
      pyr localpyr = (pyr)this.jdField_a_of_type_JavaUtilList.get(k);
      localpyr.jdField_a_of_type_Long = (l + localpyr.jdField_a_of_type_Long);
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    this.i = axli.a(paramAbsListView.getContext());
    ((ReadInJoyXListView)paramAbsListView).a(this.jdField_a_of_type_Pyu);
  ...
  public long b()
  {
    if (this.jdField_a_of_type_Pyu.jdField_b_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_c_of_type_Long - this.jdField_a_of_type_Pyu.jdField_b_of_type_Long;
  }
  ...
  public void c()
  {
    ...
    new pbx(null, null, null, pou.a(), null).a(this, BaseApplication.getContext());
    e();
    this.jdField_a_of_type_MqqUtilWeakReference = null;
    jdField_a_of_type_Pyq = null;
  }
