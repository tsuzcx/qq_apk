...
public class blee
  implements Handler.Callback, beup, beuq, Manager
{
  private int jdField_a_of_type_Int = 0;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bled jdField_a_of_type_Bled;
  ...
  public blee(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bled = new bled(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private String a(blei paramblei)
  {
    paramblei = a() + paramblei.jdField_a_of_type_Long + File.separator;
    File localFile = new File(paramblei);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return paramblei;
  ...
  private void a(bevm parambevm)
  {
    ...
    do
    {
      ...
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download error=%d", new Object[] { Integer.valueOf(parambevm.jdField_a_of_type_Int) }));
      return;
      localblef = (blef)parambevm.jdField_a_of_type_Bevl.a();
    } while (localblef == null);
    if (parambevm.jdField_a_of_type_Int == 0) {}
    while (!bool)
    {
      try
      {
        if (localblef.jdField_d_of_type_Int >= 3) {
          break label146;
        }
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] retried to download, retry=%d, result=%b, url=%s", new Object[] { Integer.valueOf(localblef.jdField_d_of_type_Int), Boolean.valueOf(bool), localblef.jdField_c_of_type_JavaLangString }));
        }
        a(localblef);
        return;
      }
      ...
      continue;
      label146:
      File localFile = new File(parambevm.jdField_a_of_type_Bevl.jdField_c_of_type_JavaLangString);
      if (localFile.exists()) {
        localFile.delete();
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(localblef.jdField_d_of_type_JavaLangString.toLowerCase());
    a(bool, parambevm.jdField_a_of_type_Bevl);
  }
  
  private void a(blei paramblei)
  {
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update complete: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      paramblei.a();
      if (b())
      {
        this.jdField_a_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(paramblei.jdField_b_of_type_Long) });
        this.jdField_b_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) });
      }
      a("0X80078B4", 0, "", "");
    }
  }
  ...
  private void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    {
      paramInt = (int)this.jdField_a_of_type_Blei.jdField_b_of_type_Long;
      if (this.jdField_a_of_type_Blei == null) {
        break label188;
      }
    }
    label188:
    for (paramString2 = String.format("%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Blei.jdField_a_of_type_Long) });; paramString2 = "")
    {
      if (QLog.isColorLevel()) {
      ...
      localblbj.a(paramString1).a(paramString1).a(paramString3).a(paramString2).a(this.jdField_a_of_type_Int);
      blbg.a(localblbj.toString(), 105, paramInt);
      return;
      paramInt = 0;
      break;
    }
  ...
  private void a(boolean paramBoolean, bevl parambevl)
  {
    if ((!paramBoolean) || (parambevl == null))
    {
      a(3);
      return;
    }
    File localFile = new File(parambevl.jdField_c_of_type_JavaLangString);
    blef localblef = (blef)parambevl.a();
    if ((!localFile.exists()) || (localblef == null))
    {
      a(3);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download complete: %s, %s", new Object[] { parambevl.jdField_c_of_type_JavaLangString, localblef.jdField_c_of_type_JavaLangString }));
    }
    switch (localblef.jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      localFile = new File(b());
      new File(parambevl.jdField_c_of_type_JavaLangString).renameTo(localFile);
      a("0X80078AC", localblef.jdField_c_of_type_Int, "", "");
      if (this.jdField_a_of_type_Bled.a(localFile.toString()))
      {
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("last_update_config_version", localblef.jdField_c_of_type_Int).commit();
        if (this.jdField_a_of_type_Bled.a().isEmpty())
        {
          if (QLog.isColorLevel()) {
      ...
      a("0X80078AC", localblef.jdField_c_of_type_Int, localblef.jdField_b_of_type_JavaLangString, localblef.jdField_c_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    a("0X80078AE", localblef.jdField_c_of_type_Int, "", "");
    d(7);
  }
  
  private boolean a()
  {
    Object localObject = this.jdField_a_of_type_Bled.a();
    int i = 0;
    if (i < ((List)localObject).size()) {
      if (((blei)((List)localObject).get(i)).a()) {}
    }
  ...
  private boolean a(blef paramblef)
  {
    if (paramblef == null) {}
    do
    {
      return false;
      if ((paramblef.jdField_a_of_type_Int == 2) && (paramblef.e != 1) && (!NetworkUtils.isWifiConnected(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication())))
      {
        if (QLog.isColorLevel()) {
    ...
    } while ((paramblef.jdField_d_of_type_Int < 3) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.contains(paramblef.jdField_d_of_type_JavaLangString.toLowerCase())));
    ...
    localbeum.jdField_a_of_type_JavaLangString = paramblef.jdField_c_of_type_JavaLangString;
    localbeum.jdField_a_of_type_Int = 0;
    localbeum.jdField_c_of_type_JavaLangString = (paramblef.jdField_a_of_type_JavaLangString + paramblef.jdField_b_of_type_JavaLangString);
    paramblef.jdField_d_of_type_Int += 1;
    paramblef.jdField_a_of_type_Long = new Date().getTime();
    localbeum.a(paramblef);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramblef.jdField_d_of_type_JavaLangString.toLowerCase(), localbeum);
    localbeuo.a(localbeum);
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] begin http download %s", new Object[] { paramblef.jdField_c_of_type_JavaLangString }));
    }
    return true;
  }
  
  private boolean a(blei paramblei)
  {
    boolean bool;
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] rollback: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      if (paramblei.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        if (!QLog.isColorLevel()) {
          break label355;
        }
    ...
    for (;;)
    {
      ...
      return bool;
      String str = b(paramblei);
      long l2 = 0L;
      int i = 0;
      while (i < paramblei.jdField_b_of_type_JavaUtilList.size())
      {
        Object localObject = (bleh)paramblei.jdField_b_of_type_JavaUtilList.get(i);
        File localFile1 = new File(((bleh)localObject).f);
        File localFile2 = new File(((bleh)localObject).g);
        long l1 = l2;
        ...
        l2 = l1;
        if (((bleh)localObject).jdField_a_of_type_Int == 2)
        {
          l2 = l1;
        ...
        localObject = new File(str, ((bleh)localObject).jdField_c_of_type_JavaLangString);
        l1 = l2;
      ...
      if (l2 == paramblei.jdField_b_of_type_JavaUtilList.size())
      {
        bool = true;
      }
      else
  ...
  private String b(blei paramblei)
  {
    paramblei = a(paramblei) + "bak" + File.separator;
    File localFile = new File(paramblei);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  private void b(blei paramblei)
  {
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] cleanup: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      bhmi.a(a(paramblei), false);
    }
  }
  ...
  private boolean b(blei paramblei)
  {
    return true;
  }
  
  private String c(blei paramblei)
  {
    return a(paramblei) + paramblei.jdField_a_of_type_JavaLangString;
  }
  ...
  private void c()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_Boolean = false;
      a("0X80078B5", 0, "", "");
      this.jdField_a_of_type_Blei = null;
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Blei = null;
    List localList = this.jdField_a_of_type_Bled.a();
    int i = 0;
    label150:
    boolean bool;
    if (i < localList.size())
    {
      blei localblei = (blei)localList.get(i);
      if (localblei.a()) {}
      for (;;)
      {
        i += 1;
        break;
        if ((localblei.jdField_b_of_type_Boolean) && (localblei.jdField_a_of_type_Boolean) && (localblei.jdField_c_of_type_Boolean)) {
          break label150;
        }
        if (QLog.isColorLevel()) {
          QLog.w("QQProtect.QPUpdate", 2, String.format("[SFU] not matched section: sid=%d, os: %b, qq:%b, cpu:%b", new Object[] { Long.valueOf(localblei.jdField_a_of_type_Long), Boolean.valueOf(localblei.jdField_b_of_type_Boolean), Boolean.valueOf(localblei.jdField_a_of_type_Boolean), Boolean.valueOf(localblei.jdField_c_of_type_Boolean) }));
        }
        localblei.a();
      }
      this.jdField_a_of_type_Blei = localblei;
      c(0);
      if (QLog.isColorLevel())
      {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] next update: sid=%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Blei.jdField_a_of_type_Long) }));
        bool = true;
      }
    }
    for (;;)
  ...
  private boolean c(blei paramblei)
  {
    String str;
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify package: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      str = bleb.a(c(paramblei));
      if (str == null) {
        return false;
      }
    }
    for (boolean bool = str.equalsIgnoreCase(paramblei.jdField_b_of_type_JavaLangString);; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  private void d(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        d();
        return;
        if ((c()) && (this.jdField_a_of_type_Blei != null))
        {
          if (!i(this.jdField_a_of_type_Blei))
          {
            d(15);
            return;
          }
        ...
        d(16);
        return;
      } while ((this.jdField_a_of_type_Blei != null) && (h(this.jdField_a_of_type_Blei)));
      a(3);
      return;
    case 7: 
      if ((this.jdField_a_of_type_Blei != null) && (c(this.jdField_a_of_type_Blei)))
      {
        d(8);
        return;
      }
      ...
      return;
    case 8: 
      if ((this.jdField_a_of_type_Blei != null) && (g(this.jdField_a_of_type_Blei)))
      {
        d(9);
        return;
      }
      ...
      return;
    case 9: 
      if ((this.jdField_a_of_type_Blei != null) && (e(this.jdField_a_of_type_Blei)))
      {
        d(10);
        return;
      }
      ...
      return;
    case 10: 
      if ((this.jdField_a_of_type_Blei != null) && (f(this.jdField_a_of_type_Blei)))
      {
        d(11);
        return;
      }
      ...
      return;
    case 11: 
      if ((this.jdField_a_of_type_Blei != null) && (d(this.jdField_a_of_type_Blei)))
      {
        d(12);
        return;
      }
      ...
      return;
    case 12: 
      if ((this.jdField_a_of_type_Blei != null) && (b(this.jdField_a_of_type_Blei)))
      {
        a(0);
        return;
      }
      ...
      return;
    case 13: 
      if ((this.jdField_a_of_type_Blei != null) && (a(this.jdField_a_of_type_Blei)))
      {
        a(0);
        return;
      }
    ...
    case 14: 
      if (this.jdField_a_of_type_Blei != null) {
        b(this.jdField_a_of_type_Blei);
      }
      d(15);
      return;
    case 15: 
      a(this.jdField_a_of_type_Blei);
      this.jdField_a_of_type_Blei = null;
      if (a())
      {
        d(16);
  ...
  private boolean d(blei paramblei)
  {
    boolean bool;
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      if (paramblei.jdField_c_of_type_JavaUtilList.isEmpty())
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] no diff: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
        }
        bool = true;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < paramblei.jdField_c_of_type_JavaUtilList.size())
        {
          bleh localbleh = (bleh)paramblei.jdField_c_of_type_JavaUtilList.get(i);
          if (TextUtils.isEmpty(localbleh.g)) {}
          for (String str = localbleh.f;; str = localbleh.g)
          {
            str = bleb.a(str);
            if ((str != null) && (str.equalsIgnoreCase(localbleh.jdField_b_of_type_JavaLangString))) {
              break label246;
            }
            if (!QLog.isColorLevel()) {
              break label253;
            }
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] not matched: %s!=%s, sid=%d", new Object[] { str, localbleh.jdField_b_of_type_JavaLangString, Long.valueOf(paramblei.jdField_a_of_type_Long) }));
            bool = false;
            break;
          }
          label246:
  ...
  private boolean e(blei paramblei)
  {
    boolean bool;
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      if (paramblei.f == 0L)
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramblei.f > 0L)
      {
        String str1 = b(paramblei);
        long l1 = 0L;
        int i = 0;
        while (i < paramblei.jdField_c_of_type_JavaUtilList.size())
        {
          bleh localbleh = (bleh)paramblei.jdField_c_of_type_JavaUtilList.get(i);
          long l2 = l1;
          if (1 == localbleh.jdField_a_of_type_Int)
          {
            String str2 = str1 + localbleh.jdField_c_of_type_JavaLangString;
            a(new File(localbleh.f), new File(str2));
            l2 = l1 + 1L;
          }
          i += 1;
          l1 = l2;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup %d files of %d", new Object[] { Long.valueOf(l1), Integer.valueOf(paramblei.jdField_c_of_type_JavaUtilList.size()) }));
        }
        if (paramblei.f == l1) {
          bool = true;
        } else {
  ...
  private boolean f(blei paramblei)
  {
    boolean bool1;
    if ((paramblei != null) && (!paramblei.jdField_c_of_type_JavaUtilList.isEmpty()))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] do update files: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      String str = a(paramblei);
      int i = 0;
      if (i < paramblei.jdField_c_of_type_JavaUtilList.size())
      {
        bleh localbleh = (bleh)paramblei.jdField_c_of_type_JavaUtilList.get(i);
        File localFile1 = new File(str, localbleh.jdField_b_of_type_JavaLangString);
        Object localObject = new File(localbleh.f);
        ...
        for (;;)
        {
          ...
          if (!bool2)
          {
            localObject = localbleh.f + ".1";
            File localFile2 = new File((String)localObject);
            localbleh.jdField_a_of_type_Int = 3;
            localbleh.g = ((String)localObject);
            bool2 = a(localFile1, localFile2);
            if (QLog.isColorLevel()) {
              QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] copied failed, renamed to: %s", new Object[] { localbleh.g }));
            }
            bool1 = bool2;
            if (bool2)
            {
              this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(localbleh.f, localbleh.g).commit();
              bool1 = bool2;
            }
          }
          if (!bool1) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] success copied: %s", new Object[] { localbleh.f }));
          }
          paramblei.jdField_b_of_type_JavaUtilList.add(localbleh);
          paramblei.g += 1L;
        }
        label376:
        a("0X80078B2", (int)localbleh.jdField_b_of_type_Long, localbleh.jdField_a_of_type_JavaLangString, localbleh.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] failed copied: %s", new Object[] { localbleh.f }));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update %d files of %d", new Object[] { Long.valueOf(paramblei.g), Integer.valueOf(paramblei.jdField_c_of_type_JavaUtilList.size()) }));
      }
      if (paramblei.g == paramblei.jdField_c_of_type_JavaUtilList.size()) {
        bool1 = true;
      }
    }
    for (;;)
  ...
  private boolean g(blei paramblei)
  {
    boolean bool;
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] unzip package: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      String str = a(paramblei);
      File localFile = new File(str);
      if (!localFile.exists()) {
  ...
  private boolean h(blei paramblei)
  {
    boolean bool = false;
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] download package: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      bool = a(new blef(2, 0, a(paramblei), paramblei.jdField_a_of_type_JavaLangString, paramblei.jdField_c_of_type_JavaLangString, paramblei.jdField_b_of_type_JavaLangString, 0, true, 0, new Date().getTime(), paramblei.jdField_b_of_type_Int));
    }
    return bool;
  }
  
  private boolean i(blei paramblei)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (paramblei != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] get different: sid=%d", new Object[] { Long.valueOf(paramblei.jdField_a_of_type_Long) }));
      }
      List localList = paramblei.jdField_a_of_type_JavaUtilList;
      int i = 0;
      if (i < localList.size())
      {
        bleh localbleh = (bleh)localList.get(i);
        if (!new File(localbleh.f).exists())
        {
          localbleh.jdField_a_of_type_Int = 2;
          paramblei.jdField_c_of_type_JavaUtilList.add(localbleh);
        }
        String str;
        do
        {
          i += 1;
          break;
          str = bleb.a(localbleh.f);
        } while ((str != null) && (str.equalsIgnoreCase(localbleh.jdField_b_of_type_JavaLangString)));
        localbleh.jdField_a_of_type_Int = 1;
        if (str != null) {}
        for (;;)
        {
          localbleh.jdField_c_of_type_JavaLangString = str;
          paramblei.jdField_c_of_type_JavaUtilList.add(localbleh);
          paramblei.f += 1L;
          break;
          str = "";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] need to update %d files of %d", new Object[] { Integer.valueOf(paramblei.jdField_c_of_type_JavaUtilList.size()), Integer.valueOf(paramblei.jdField_a_of_type_JavaUtilList.size()) }));
      }
      bool1 = bool2;
      if (!paramblei.jdField_c_of_type_JavaUtilList.isEmpty()) {
        bool1 = true;
      ...
      try
      {
        ...
        if (localUpdateQueryResponse != null)
        {
          ...
          if ((i1 == 0) && (k == 1))
          {
            ...
            bool1 = a(new blef(1, k, a(), "qp_sfu_config.dat", paramFromServiceMsg, paramToServiceMsg, m, bool1, 0, new Date().getTime(), 1));
          }
        }
        else
        {
        ...
        if (i1 == 1)
        {
          ...
          bool1 = bool2;
          if (!this.jdField_a_of_type_Bled.a(paramToServiceMsg.toString())) {
            continue;
          }
          if (this.jdField_a_of_type_Bled.a().isEmpty()) {
            d(16);
  ...
  {
    if (this.jdField_a_of_type_AndroidOsHandler != null) {
      this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052688, parambevm).sendToTarget();
    }
  }
  
  public void onUpdateProgeress(bevl parambevl, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052689, (int)paramLong1, (int)paramLong2, parambevl).sendToTarget();
  }
}
