...
public class bixg
  extends BaseAdapter
{
  public bixg(DraggableGridView paramDraggableGridView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (getItemViewType(paramInt) == DraggableGridView.a())
    {
      if (paramView == null)
      {
        localObject = (MeasureGridView)LayoutInflater.from(this.a.getContext()).inflate(2131560578, paramViewGroup, false);
        ((MeasureGridView)localObject).setClickable(false);
        ((MeasureGridView)localObject).setNumColumns(DraggableGridView.a(this.a));
        ((MeasureGridView)localObject).setAdapter(new bixh(this.a, paramInt / 2));
      ...
      for (;;)
      {
        ...
        ((bixh)((MeasureGridView)localObject).getAdapter()).a(paramInt / 2);
      }
    }
    if (paramView == null) {
