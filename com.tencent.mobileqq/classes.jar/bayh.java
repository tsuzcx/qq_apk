  ...
  extends WebViewPlugin
{
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Mmo == null)
    {
      ...
      if (localCustomWebView != null) {
        this.jdField_a_of_type_Mmo = new mmo(localCustomWebView, new bayj(this));
      }
    }
  }
  ...
  void a(long paramLong)
  {
    ...
    try
    {
      localObject3 = bbca.a((String)localObject1);
      ...
      this.jdField_a_of_type_Wis.a(1, str, (String)localObject1, (Bundle)localObject3);
      return;
    }
    ...
    if (("UrlSaveVerifyV2".equals(paramString2)) && ("continueVisit".equals(paramString3)) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramJsBridgeListener))
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("WebSecurityPluginV2", 2, "continueVisit url=" + mpw.b(paramJsBridgeListener, new String[0]));
            }
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!baip.a(paramString2)) && (paramString1.startsWith(paramString2)))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
    ...
    if (!b(paramString1))
    {
      ...
      QLog.i("UrlCheckLog", 1, "now check url=" + mpw.b(paramString1, new String[0]) + ", async=" + bool2);
      ...
      j = k;
      label561:
      this.jdField_a_of_type_Wis.a(paramString1, j, i, str2, str3, str1, paramString2, new bayi(this, paramString1, bool2));
      if (QLog.isColorLevel()) {
