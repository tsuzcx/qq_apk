...
public class bfvp
{
  ...
  public static bfvq a(String paramString)
  {
    int i = 1;
    bfvq localbfvq = new bfvq();
    if (TextUtils.isEmpty(paramString)) {
      return localbfvq;
    }
    for (;;)
      ...
      try
      {
        ...
        if (j == -1)
        {
          ...
          if (-1 == m)
          {
            ...
            localbfvq.jdField_a_of_type_JavaLangString = paramString;
            localbfvq.jdField_a_of_type_Int = Integer.valueOf(str1).intValue();
            if (i == 0) {
              break;
            }
            localbfvq.b = 1;
          ...
          str1 = str1 + ":" + str2;
          continue;
          localbfvq.jdField_a_of_type_JavaLangString = str2;
          localbfvq.jdField_a_of_type_Int = 0;
          continue;
        }
        j += 3;
      }
  ...
  public static bgrn a(long paramLong)
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
      return null;
    }
    return bgrn.a(localQQAppInterface, paramLong);
  }
