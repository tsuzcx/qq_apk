  ...
  implements arba
{
  ...
  protected aram(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bbtj parambbtj)
  {
    super(paramLong, paramItem, paramBundle, parambbtj);
  }
  
  public static bbtm a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bbtj parambbtj)
  {
    if (paramLong == 0L)
    {
      bbrc.a("ExcitingTransfer.TroopFileUploadWorker", bbrc.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      bbrc.a("ExcitingTransfer.TroopFileUploadWorker", bbrc.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null) {
      bbrc.a("ExcitingTransfer.TroopFileUploadWorker", bbrc.jdField_a_of_type_Int, "getWoker. item.id=null");
    }
    return new aram(paramLong, paramItem, paramBundle, parambbtj);
  }
  ...
  private ExcitingTransferUploadResultRp a()
  {
    ...
    if (this.jdField_a_of_type_Bbsx != null)
    {
      ...
      if ((this.jdField_a_of_type_Bbsx instanceof arax)) {
        localObject1 = ((arax)this.jdField_a_of_type_Bbsx).a();
      }
    }
    return localObject1;
  }
  ...
  private void c(int paramInt)
  {
    ...
    aral localaral = new aral(bbra.a());
    localaral.a(paramInt);
    if (localObject != null) {
      if (((ExcitingTransferUploadResultRp)localObject).m_nResult == 0L)
      {
        bool1 = bool2;
        localaral.a((ExcitingTransferUploadResultRp)localObject);
        localaral.c(this.jdField_a_of_type_Long);
        localObject = arni.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
        localaral.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
        localaral.c(this.jdField_a_of_type_Bbqo.jdField_a_of_type_Boolean);
        long l = System.currentTimeMillis() - this.jdField_a_of_type_Bbqo.jdField_d_of_type_Long;
        if (l <= 0L) {
          break label339;
        }
        localaral.b(l);
        label143:
        l = this.jdField_a_of_type_Bbqo.g;
        if (l <= 0L) {
          break label348;
        }
        localaral.a(l);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bbqo.jdField_a_of_type_Long > 0L) {
        ((ExcitingTransferUploadResultRp)localObject).m_u64StartSize = this.jdField_a_of_type_Bbqo.jdField_a_of_type_Long;
      }
      if (this.jdField_a_of_type_Bbqo.jdField_b_of_type_Long > 0L) {
        ((ExcitingTransferUploadResultRp)localObject).m_u64TransferSize = this.jdField_a_of_type_Bbqo.jdField_b_of_type_Long;
      }
      float f;
  ...
  private void o()
  {
    ...
    localaral.a(33);
    localaral.c(this.jdField_a_of_type_Long);
    Object localObject = arni.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
    localaral.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
    localaral.c(false);
    long l = System.currentTimeMillis() - this.jdField_a_of_type_Bbqo.jdField_d_of_type_Long;
    label119:
  ...
  protected bbsx a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    paramString = new araz(localArrayList1, localArrayList2, paramBoolean2, paramString, null);
    paramQQAppInterface = arax.a(paramQQAppInterface, paramLong, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, localaray, paramString);
    if (paramQQAppInterface != null)
    {
      ((arax)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    if (paramInt != 0)
    {
      ...
      this.jdField_a_of_type_Bbqo.e = 0;
      this.jdField_a_of_type_Bbqo.f = 0;
      n();
      this.jdField_a_of_type_Bbqo.c = 0;
      this.jdField_a_of_type_Bbqo.jdField_d_of_type_Int = 0;
    }
    if (paramExcitingTransferUploaderRp != null)
    {
      aran localaran = new aran(bbra.a());
      localaran.c(this.jdField_a_of_type_Long);
      String str = arni.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
      localaran.a(paramInt);
      localaran.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, str, this.jdField_c_of_type_Long);
      localaran.a(paramExcitingTransferUploaderRp);
      if (paramInt == 0) {}
      for (;;)
      {
        localaran.a(bool);
  ...
  protected void c()
  {
    ...
    if (b())
    {
      if ((this.jdField_a_of_type_Bbqo.c == 8) || (this.jdField_a_of_type_Bbqo.c == 11) || (this.jdField_a_of_type_Bbqo.c == 12)) {
        o();
      }
    }
    else {
    ...
    for (;;)
    {
      c(j);
      return;
      j = this.jdField_a_of_type_Bbqo.jdField_d_of_type_Int;
      int i = j;
      if (j == 0) {
        i = this.jdField_a_of_type_Bbqo.c;
      }
      j = i;
      if (this.g != 0L) {
        j = d(i);
