...
public class aqzo
  extends aqpg
  implements aqzt, aqzu
{
  final int jdField_a_of_type_Int = 1000;
  long jdField_a_of_type_Long = 0L;
  aqpg jdField_a_of_type_Aqpg = null;
  aqzp jdField_a_of_type_Aqzp = null;
  public aqzq a;
  public aqzs a;
  ...
  public aqzo(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    this.jdField_a_of_type_Aqzq = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = paramFileManagerEntity;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    this.jdField_a_of_type_Aqzs = new aqzs(paramQQAppInterface.getCurrentAccountUin(), "actDiscussFileUp");
  }
  ...
  private boolean a(long paramLong, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((paramString1 == null) || (paramString1.length() == 0))
    {
      ...
      if (paramLong == 0L)
      {
        this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = 9048L;
        this.jdField_a_of_type_Aqzs.c = "onSendDiscFile Host null";
        this.jdField_a_of_type_Aqzs.c();
        a(false);
        bool = false;
      }
    }
    while ((paramString2 != null) && (paramString2.length() != 0) && (paramString3 != null) && (paramString3.length() != 0)) {
      ...
      {
        return bool;
        this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = ((int)paramLong);
      }
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    if (paramLong == 0L) {}
    for (this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = 9005L;; this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = ((int)paramLong))
    {
      this.jdField_a_of_type_Aqzs.c = "onSendDiscFile param error";
      this.jdField_a_of_type_Aqzs.c();
      a(false);
      return false;
    }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 - this.jdField_a_of_type_Long >= 1000L)
    {
      ...
      {
        String str = this.jdField_a_of_type_Aqzs.a();
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, String paramString5, String paramString6, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Aqzs.jdField_d_of_type_Long = System.currentTimeMillis();
    if (!paramBoolean)
    {
      ...
      for (this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = 9043L;; this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = 9045L)
      {
        this.jdField_a_of_type_Aqzs.c = "server retError";
        if (paramString6 != null) {
          this.jdField_a_of_type_Aqzs.c = paramString6;
        }
        this.jdField_a_of_type_Aqzs.c();
        a(false);
        return;
    ...
    paramBoolean = false;
    int i;
    if ((aqxg.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (paramBundle != null))
    {
    ...
    {
      paramString5 = "";
      if (aroo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
      this.jdField_a_of_type_Aqzp = new aqzp();
      this.jdField_a_of_type_Aqzp.a(paramString3, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSHA, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this);
      this.jdField_a_of_type_Aqzq = new aqzq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aqzs, paramString4, paramInt, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_Aqzp, paramBoolean, paramString2, paramString5);
  ...
  {
    this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = paramLong.longValue();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = 9004L;
    this.jdField_a_of_type_Aqzs.g = System.currentTimeMillis();
    this.jdField_a_of_type_Aqzs.c();
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Aqzs.jdField_a_of_type_Long = 9037L;
    this.jdField_a_of_type_Aqzs.g = System.currentTimeMillis();
    this.jdField_a_of_type_Aqzs.c();
  ...
  public void f()
  {
    this.jdField_a_of_type_Aqzs.jdField_a_of_type_Int = 3000;
    this.jdField_a_of_type_Aqzs.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName;
    this.jdField_a_of_type_Aqzs.j = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize;
    this.jdField_a_of_type_Aqzs.h = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    if (QLog.isColorLevel()) {
      QLog.i("DiscFileOperator<FileAssistant>", 1, "start sendFile:" + ayvc.a());
    }
    arnu.a().execute(new DiscFileOperator.2(this));
  }
}
