...
public class upw
{
  public static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy)
  {
    if (paramCommentEntry.commentType == 1) {
      return c(paramCommentLikeFeedItem, paramCommentEntry, paramupy);
    }
    if (paramCommentEntry.commentType == 2) {
      return d(paramCommentLikeFeedItem, paramCommentEntry, paramupy);
    }
    if (paramCommentEntry.commentType == 5) {
      return c(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramupy);
    }
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramupy, true);
    }
    return a(paramCommentLikeFeedItem, paramCommentEntry, paramupy);
  }
  
  private static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy, boolean paramBoolean)
  {
    paramContext = ((tdl)tcz.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str5))
    {
      ...
      if (!aylc.a(paramCommentEntry.content)) {
        break label511;
      }
    }
    label84:
    ...
    label125:
    label511:
    for (paramCommentLikeFeedItem = axau.b(paramCommentEntry.content);; paramCommentLikeFeedItem = null)
    {
      String str1;
      String str2;
      if (paramBoolean)
      {
        paramContext = ajya.a(2131714252);
        if (i == 0) {
          break label403;
        }
        str1 = "V";
      ...
      for (paramCommentLikeFeedItem = new ayku(str2 + paramContext + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + paramContext + ": " + str6))
      {
        for (;;)
        {
          i = 0;
          if (paramBoolean)
          {
            ...
            a(paramCommentLikeFeedItem, 0, k, paramupy, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
            j = str4.length() + k;
            i = j;
            if (k != j)
            {
          ...
          catch (Exception paramContext)
          {
            ...
            a(paramCommentLikeFeedItem, paramCommentLikeFeedItem.length() - "I".length(), paramCommentLikeFeedItem.length(), 2130845556, 15, 15, 3);
            return paramCommentLikeFeedItem;
          }
        }
        paramContext = ajya.a(2131714255);
        break label84;
        str1 = "";
        break label93;
        str2 = "";
  ...
  private static SpannableStringBuilder a(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    String str1 = null;
    if (aylc.a(paramCommentEntry.content)) {
      str1 = axau.b(paramCommentEntry.content);
    }
    String str3 = ajya.a(2131714253);
    if (str1 != null) {}
    for (paramCommentEntry = new ayku(str3 + ": " + str1, 3, 16);; paramCommentEntry = new SpannableStringBuilder(str3 + ": " + str2))
    {
  ...
  private static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy)
  {
    Object localObject1 = (tdl)tcz.a(2);
    Object localObject3 = ((tdl)localObject1).c(paramCommentEntry.authorUnionId);
    ...
    {
      localObject2 = ((tdl)localObject1).c(paramCommentEntry.replierUnionId);
    ...
    for (paramCommentLikeFeedItem = (CommentLikeFeedItem)localObject2;; paramCommentLikeFeedItem = null)
    {
      ...
      if (!TextUtils.isEmpty(str4))
      {
        ...
        if (aylc.a(paramCommentEntry.content)) {
          paramCommentLikeFeedItem = axau.b(paramCommentEntry.content);
        }
        str6 = ajya.a(2131714258);
        if (i == 0) {
          break label415;
        }
        localObject2 = "V";
      ...
      label422:
      label429:
      for (paramCommentLikeFeedItem = new ayku(str2 + (String)localObject2 + str3 + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + ": " + str7))
      {
        j = str2.length();
        ...
        a(paramCommentLikeFeedItem, 0, i, paramupy, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
        j = str3.length() + i;
        paramupy = paramCommentLikeFeedItem;
        if (i != j)
        {
          b(paramCommentLikeFeedItem, i, j, -4473925);
          paramupy = paramCommentLikeFeedItem;
        ...
        {
          paramupy.append(" ");
          paramCommentLikeFeedItem = ajya.a(2131714257);
          i = paramupy.length();
          j = paramCommentLikeFeedItem.length();
          paramupy.append(paramCommentLikeFeedItem);
          b(paramupy, i, j + i, -48606);
          i = paramupy.length();
          j = "[icon]  ".length();
          paramupy.append("[icon]  ");
          a(paramupy, i, j + i, 2130847707);
        }
        return paramupy;
        i = 0;
        break;
      ...
      label475:
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new ayku(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + str7))
      {
        j = str2.length();
        a(paramCommentLikeFeedItem, 0, j);
        if (sxn.a()) {
        ...
        a(paramCommentLikeFeedItem, i - str1.length(), j, paramupy, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  public static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, List<LikeEntry> paramList, upy paramupy)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    String str1 = paramCommentLikeFeedItem.feedId + "_" + paramList.hashCode();
    Object localObject = tau.a().a(str1);
    ...
    for (paramCommentLikeFeedItem = paramCommentLikeFeedItem.qq;; paramCommentLikeFeedItem = null)
    {
      ...
      for (;;)
      {
        if (j < paramList.size())
        {
          ...
          localObject = ((tdl)tcz.a(2)).c(localLikeEntry.unionId);
          ...
          for (localObject = "";; localObject = ", ")
          {
            ...
            a(localSpannableStringBuilder, m, n, paramupy, localLikeEntry.unionId);
            break;
            k = 0;
            break label220;
            localObject = "";
      ...
      if (i != 0) {
        tau.a().a(str1, localSpannableStringBuilder);
      }
  ...
  private static String a(CommentLikeFeedItem paramCommentLikeFeedItem, QQUserUIItem paramQQUserUIItem)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        return ((tdh)tcz.a(23)).a(paramQQUserUIItem, paramCommentLikeFeedItem, false, false);
        i = 0;
        break;
      }
      return tsr.a(paramQQUserUIItem);
      label93:
      paramCommentLikeFeedItem = null;
      continue;
      paramCommentLikeFeedItem = null;
  ...
  {
    paramString1 = ((tdl)tcz.a(2)).c(paramString1);
    if (paramBoolean) {
      return ((tdh)tcz.a(23)).a(paramString1, paramString3, false, false);
    }
    return tsr.a(paramString1);
  }
  ...
  {
    paramInt4 = vzl.a(BaseApplicationImpl.getContext(), paramInt4);
    paramInt5 = vzl.a(BaseApplicationImpl.getContext(), paramInt5);
    ...
    for (;;)
    {
      ...
      if (paramInt6 == 0) {
        ...
        localObject = new wcq((Drawable)localObject);
      } else {
        localObject = new wdv((Drawable)localObject);
      }
    }
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, upy paramupy, String paramString)
  {
    a(paramSpannableStringBuilder, paramInt1, paramInt2, paramupy, paramString, 0);
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, upy paramupy, String paramString, int paramInt3)
  {
    paramSpannableStringBuilder.setSpan(new upx(paramupy, paramString, paramInt3), paramInt1, paramInt2, 33);
  }
  ...
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString, int paramInt1, int paramInt2)
  {
    ...
    int i = vzl.a(BaseApplicationImpl.getContext(), 13.0F);
    paramString.setBounds(0, 0, i, i);
    paramSpannableStringBuilder.setSpan(new wdv(paramString), paramInt1, paramInt2, 33);
  }
  
  public static SpannableStringBuilder b(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy)
  {
    if (paramCommentEntry.commentType == 1) {
    ...
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramupy, false);
    }
    return b(paramCommentLikeFeedItem, paramCommentEntry, paramupy);
  }
  
  private static SpannableStringBuilder b(@NonNull CommentEntry paramCommentEntry)
  {
    String str = ajya.a(2131714254);
    ...
    default: 
      return paramCommentEntry;
    case 1: 
      a(paramCommentEntry, j, k, 2130843779, 37, 16);
      return paramCommentEntry;
    case 2: 
      a(paramCommentEntry, j, k, 2130843781, 37, 16);
      return paramCommentEntry;
    case 3: 
      a(paramCommentEntry, j, k, 2130843780, 37, 16);
      return paramCommentEntry;
    case 4: 
      a(paramCommentEntry, j, k, 2130843778, 37, 16);
      return paramCommentEntry;
    }
    a(paramCommentEntry, j, k, 2130843777, 37, 16);
    return paramCommentEntry;
  }
  
  private static SpannableStringBuilder b(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy)
  {
    String str1 = null;
    Object localObject1 = (tdl)tcz.a(2);
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          if (paramCommentLikeFeedItem != null)
          {
            paramCommentEntry = new ayku(paramCommentLikeFeedItem, 3, 16);
            return paramCommentEntry;
            i = 0;
            break;
            label153:
      ...
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new ayku(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + str4))
      {
        int j = str3.length();
        i = ((String)localObject1).length() + j;
        a(paramCommentLikeFeedItem, j, i);
        ...
        a(paramCommentLikeFeedItem, i - ((String)localObject1).length(), j, paramupy, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  private static SpannableStringBuilder c(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy)
  {
    paramContext = ((tdl)tcz.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      paramContext = ajya.a(2131714247);
      label100:
      if (i == 0) {
        break label370;
      }
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, i, paramupy, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = i + str2.length();
      if (i != j) {
      ...
      j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130845556, 15, 15, 3);
      }
      return localSpannableStringBuilder;
      i = 0;
      break;
      paramContext = " @" + paramContext + ajya.a(2131714247);
      break label100;
    }
  }
  ...
  private static SpannableStringBuilder c(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    for (paramCommentEntry = ajya.a(2131714251);; paramCommentEntry = "@" + paramCommentEntry + ajya.a(2131714249))
    {
      ...
      int j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130845556, 15, 15);
      }
      return localSpannableStringBuilder;
    }
  }
  
  private static SpannableStringBuilder c(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy)
  {
    Object localObject = ((tdl)tcz.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      localObject = null;
      if (aylc.a(paramCommentEntry.content)) {
        localObject = axau.b(paramCommentEntry.content);
      }
      str4 = ajya.a(2131714250);
      if (i == 0) {
        break label272;
      }
    ...
    label272:
    label278:
    for (localObject = new ayku(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + (String)localObject, 3, 16);; localObject = new SpannableStringBuilder(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + str5))
    {
      int j = str1.length();
      ...
      a((SpannableStringBuilder)localObject, 0, i, paramupy, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = str2.length() + i;
      if (i != j) {
  ...
  private static SpannableStringBuilder d(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, upy paramupy)
  {
    Object localObject = ((tdl)tcz.a(2)).c(paramCommentEntry.authorUnionId);
    String str1 = a(paramCommentLikeFeedItem, (QQUserUIItem)localObject);
    String str2 = a(paramCommentEntry.authorRole, (QQUserUIItem)localObject);
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, j, paramupy, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      k = str2.length() + j;
      if (j != k) {
    ...
    a(localSpannableStringBuilder, j, k, 2130843779, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843781, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843780, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843778, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843777, 37, 16, 3);
    return localSpannableStringBuilder;
  }
}
