  ...
  extends WebViewPlugin
{
  private aybj a()
  {
    ...
    {
      return localObject;
      localaybj = ((NearbyAppInterface)localObject).a();
      localObject = localaybj;
    } while (localaybj.a());
    return null;
  }
  ...
  private String a()
  {
    ...
    try
    {
      ...
      aysv localaysv = a();
      if ((localaysv == null) || (TextUtils.isEmpty(localaysv.a)))
      {
        localJSONObject.put("data", new JSONObject());
        return localJSONObject.toString();
      }
      localJSONObject.put("data", new JSONObject(localaysv.a));
    }
