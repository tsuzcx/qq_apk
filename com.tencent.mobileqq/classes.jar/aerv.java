  ...
  extends BaseChatPie
{
  ...
  boolean Y = false;
  public boolean Z;
  private aeto jdField_a_of_type_Aeto;
  ...
  private bfwv jdField_a_of_type_Bfwv = new aetg(this);
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new aesi(this);
  public nnx a;
  public nqc a;
  nqv jdField_a_of_type_Nqv = new aetd(this);
  public int[] a;
  private boolean aA;
  private boolean aB;
  public boolean aa;
  ...
  private boolean ay;
  private boolean az;
  private akws jdField_b_of_type_Akws;
  ...
  public aerv(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_a_of_type_Aqyd = new aqyd("web_public_account", "com.tencent.mobileqq:tool");
    this.jdField_a_of_type_AndroidOsHandler = new aerw(this);
    this.jdField_a_of_type_Akav = new aetn(this);
    this.jdField_a_of_type_Akdo = new aetc(this);
    this.jdField_a_of_type_Bduv = new aeth(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aetk(this);
  }
  ...
  private void a(View paramView, int paramInt1, int paramInt2, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    localValueAnimator.addUpdateListener(new aery(this, paramView, paramInt1, paramInt2));
  ...
  public static boolean a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null) {}
    for (localObject = ((akdi)localObject).b(paramString);; localObject = null)
    {
      if (localObject == null)
      {
  ...
  private void bJ()
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(str);; localObject = null)
    {
      ...
      new bahp("https://buluo.qq.com/cgi-bin/bar/extra/clean_temp_follow_state", "", new aesk(this), 1000, null).a(localHashMap);
      bq();
      return;
    }
  }
  ...
  private void bK()
  {
    ...
    PublicAccountInfo localPublicAccountInfo = ((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if ((localPublicAccountInfo != null) && ((localPublicAccountInfo.accountFlag & 0x10000) != 0)) {
      this.jdField_a_of_type_Nnx.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0x9e370001hd", false, 0.0D, 0.0D, null);
    }
  ...
  private void bL()
  {
    ...
    localHashMap.put("net_type", "" + aysy.a().a());
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "actPublicAccountWebviewPreload", bool, l1, 0L, localHashMap, "");
  ...
  private void bM()
  {
    ...
    Object localObject = new NewIntent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext(), nou.class);
    ...
    try
    {
      ...
      ((NewIntent)localObject).setObserver(new aesr(this));
  ...
  private void bN()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo == null)
    {
      ...
      if (localakdi != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = localakdi.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  private void bO()
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.requestPermissions(new aesz(this), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      bP();
      return;
  ...
  private void bP()
  {
    SosoInterface.a(new aeta(this, 1, true, true, 0L, false, false, "PublicAccountChatPie"));
  }
  ...
  private void bR()
  {
    ...
    if (localObject != null)
    {
      localObject = ((akdi)localObject).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (sgj.a(((PublicAccountInfo)localObject).accountFlag2) == -10L))
      {
        this.aA = true;
        localObject = baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 115, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        if (localObject != null)
        {
  ...
  private void bS()
  {
    ...
    if (localPublicAccountInfo != null) {
      ahoq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localPublicAccountInfo.uin + "", l1 - l2, localPublicAccountInfo.name + "");
    }
  ...
  private void c(AccountDetail paramAccountDetail)
  {
    ...
    Object localObject1 = (TextView)this.jdField_o_of_type_AndroidViewView.findViewById(2131378591);
    Object localObject2 = (TextView)this.jdField_o_of_type_AndroidViewView.findViewById(2131378590);
    ImageView localImageView = (ImageView)this.jdField_o_of_type_AndroidViewView.findViewById(2131367679);
    if (this.ay) {
      if ((this.jdField_a_of_type_Azon != null) && (this.jdField_a_of_type_Azon.b > 0) && (this.jdField_a_of_type_Azon.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        TroopInfo localTroopInfo = (TroopInfo)this.jdField_a_of_type_Azon.jdField_a_of_type_JavaUtilList.get(0);
        ((TextView)localObject1).setText(localTroopInfo.troopname);
        ((TextView)localObject2).setText(String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131695544), new Object[] { paramAccountDetail.name }));
        localImageView.setImageDrawable(baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, localTroopInfo.troopuin));
        localObject1 = "";
        if (this.jdField_a_of_type_Azon.jdField_a_of_type_JavaUtilList.size() > 0) {
          localObject1 = ((TroopInfo)this.jdField_a_of_type_Azon.jdField_a_of_type_JavaUtilList.get(0)).troopuin;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) {
          break label318;
        }
        localObject2 = "";
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_public", "", "oper", "exp_temp", 0, 0, (String)localObject1, "" + (String)localObject2, "", "");
      }
    }
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Ajxl = new aesv(this, localImageView);
        this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.addObserver(this.jdField_a_of_type_Ajxl);
      }
      localObject1 = (ImageView)this.jdField_o_of_type_AndroidViewView.findViewById(2131364023);
      ...
      localImageView.setImageDrawable(baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a().jdField_a_of_type_JavaLangString, (byte)3));
    }
    label375:
  ...
  private void g(String paramString)
  {
    ...
    if (localObject != null)
    {
      localObject = ((akdi)localObject).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (sgj.a(((AccountDetail)localObject).accountFlag) != -4)) {
        break label191;
      }
      localObject = new NewIntent(BaseApplicationImpl.getContext(), nou.class);
      ...
      this.jdField_b_of_type_MqqObserverBusinessObserver = new aesl(this, paramString);
    ...
    {
      this.I += 1;
      sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_Akws = new akws(new aesm(this, paramString));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_b_of_type_Akws);
      akwx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 0);
    }
  }
  
  public void A(int paramInt)
  {
    if (this.jdField_d_of_type_Bcpq == null) {
      this.jdField_d_of_type_Bcpq = new bcpq(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
    if ((!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing()) && (this.jdField_d_of_type_Bcpq != null))
    {
      this.jdField_d_of_type_Bcpq.c(paramInt);
      if (!this.jdField_d_of_type_Bcpq.isShowing()) {
        this.jdField_d_of_type_Bcpq.show();
      }
    }
  }
  ...
  public void D(int paramInt)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        return;
        this.jdField_m_of_type_AndroidWidgetTextView.setText(2131719794);
        continue;
        this.jdField_m_of_type_AndroidWidgetTextView.setText(2131719788);
        continue;
        this.jdField_m_of_type_AndroidWidgetTextView.setText(2131695570);
      }
      return;
    }
    catch (Exception localException) {}
  ...
  public boolean D()
  {
    Object localObject = (akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
    if (localObject != null) {}
    for (localObject = ((akdi)localObject).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);; localObject = null)
    {
      if ((localObject == null) && (sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) == null))
      {
        sgj.a();
        sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplication.getContext(), this.jdField_a_of_type_MqqOsMqqHandler, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        return true;
      }
      return false;
    }
  ...
  public void E(int paramInt)
  {
    if (this.jdField_h_of_type_AndroidAppDialog == null)
    {
      ...
      this.jdField_h_of_type_AndroidAppDialog.setContentView(2131560528);
    }
    TextView localTextView1 = (TextView)this.jdField_h_of_type_AndroidAppDialog.findViewById(2131377350);
    TextView localTextView2 = (TextView)this.jdField_h_of_type_AndroidAppDialog.findViewById(2131361887);
    switch (paramInt)
    {
    }
    for (;;)
    {
      this.jdField_h_of_type_AndroidAppDialog.setOnCancelListener(new aeti(this));
      this.jdField_h_of_type_AndroidAppDialog.show();
      return;
      localTextView1.setText(2131698251);
      localTextView2.setText(2131698257);
      continue;
      localTextView1.setText(2131698252);
      localTextView2.setText(2131698253);
      continue;
      localTextView1.setText(2131698255);
      localTextView2.setText(2131698253);
    }
  }
  ...
  public void G()
  {
    ota.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_l_of_type_Long, this.ac, this.jdField_a_of_type_Acut.a());
    ...
    for (;;)
    {
      return;
      sgj.a();
      if (this.jdField_a_of_type_Aeto != null) {}
      try
      {
        this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Aeto);
        label89:
        this.jdField_a_of_type_Aeto = null;
        if (this.jdField_b_of_type_MqqAppNewIntent != null) {
          nnx.a().a(this.jdField_b_of_type_MqqAppNewIntent);
        }
        ...
        if (this.jdField_a_of_type_Ajxl != null)
        {
          this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.removeObserver(this.jdField_a_of_type_Ajxl);
          this.jdField_a_of_type_Ajxl = null;
        }
        super.G();
        if (this.jdField_a_of_type_Nnx != null)
        {
          this.jdField_a_of_type_Nnx.a(a());
          this.jdField_a_of_type_Nnx.a(this.jdField_a_of_type_AndroidContentContext);
        }
        Iterator localIterator = this.jdField_a_of_type_Acut.a().iterator();
        ...
        if (this.jdField_a_of_type_Azon != null) {
          this.jdField_a_of_type_Azon.a();
        }
        ...
        if (this.jdField_l_of_type_Long != 0L)
        {
          ...
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "" + this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X80064D5", "0X80064D5", 0, 0, "", "" + this.jdField_l_of_type_Long, "" + this.J, "");
        ...
        bB();
        sgj.jdField_a_of_type_Boolean = false;
        try
        {
  ...
  public void K()
  {
    ...
    {
      if (this.aa) {
        noo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005D16", "0X8005D16", 0, 0, "new", String.valueOf(l1 - this.jdField_i_of_type_Long), "", "", false);
      }
    }
    else {
      return;
    }
    noo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005D16", "0X8005D16", 0, 0, "old", String.valueOf(l1 - this.jdField_i_of_type_Long), "", "", false);
  }
  ...
  public void L()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)) {
      ((nqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88)).jdField_i_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
    }
    super.L();
    this.jdField_a_of_type_Aqyd.d();
    PublicAccountInfo localPublicAccountInfo = ((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if (localPublicAccountInfo != null) {
      switch (sgj.a(localPublicAccountInfo.accountFlag))
      {
      }
    }
    for (;;)
    {
      if (I())
      {
        ...
        nrk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "gouwu.aio.stay", "1", NetConnInfoCenter.getServerTimeMillis() + "", NetConnInfoCenter.getServerTimeMillis() - this.jdField_n_of_type_Long + "");
      }
      return;
      akwv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_G_of_type_Int, 2, System.currentTimeMillis() - this.jdField_n_of_type_Long);
      continue;
      akwv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_G_of_type_Int, 3, System.currentTimeMillis() - this.jdField_n_of_type_Long);
      continue;
      akwv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_G_of_type_Int, 4, System.currentTimeMillis() - this.jdField_n_of_type_Long);
    }
  }
  ...
  public void M()
  {
    ...
    if (this.jdField_a_of_type_Azon.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Azon.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_Azon.c();
    }
    if ((advq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)) {
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(ajyc.a(2131708743));
    }
    if ((!this.au) && (this.av))
    {
      this.av = false;
    ...
    for (;;)
    {
      nqu localnqu = (nqu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(68);
      if (sbc.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
      {
        long l1 = 0L;
        if (nqq.b.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) != null) {
          l1 = ((Long)nqq.b.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)).longValue();
        }
        if ((!TextUtils.isEmpty((String)nqq.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) && (System.currentTimeMillis() - l1 <= nqq.jdField_a_of_type_Int)) {
          break;
        }
        nqq.b.put(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, Long.valueOf(System.currentTimeMillis()));
        localnqu.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
      return;
    ...
    if (maz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight2Icon(2130846174);
      return;
    }
    this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
  }
  ...
  public void O()
  {
    ...
    axqw.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "auth_aio", "exp", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, "");
  }
    ...
    if (paramAbsStructMsg != null) {
      try
      {
        if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
        {
          ...
          {
            paramAbsStructMsg = bfng.b(paramAbsStructMsg.substring(paramAbsStructMsg.indexOf("?") + 1));
  ...
  {
    ajvr localajvr = (ajvr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(21);
    if (localajvr != null) {
      localajvr.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 3, paramInt, 1, paramBusinessObserver);
    }
  }
  ...
  public void a(Intent paramIntent)
  {
    ...
    if (advq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
  ...
  public void a(QQMessageFacade.Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Azon != null)
      {
        Iterator localIterator = this.jdField_a_of_type_Azon.jdField_a_of_type_JavaUtilList.iterator();
        do
        {
  ...
  public void a(ChatMessage paramChatMessage)
  {
    ...
    if (sdf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, i1))
    {
  ...
  public void a(PublicAccountInfo paramPublicAccountInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramPublicAccountInfo.isSyncLbs) && (!paramPublicAccountInfo.mIsSyncLbsSelected) && (!paramPublicAccountInfo.mIsAgreeSyncLbs) && (!this.aw))
      {
        ...
        this.jdField_g_of_type_AndroidAppDialog = bbcv.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, str1, str2, 2131692181, 2131692183, new aess(this, paramPublicAccountInfo, localakdi), new aest(this, paramPublicAccountInfo, localakdi));
        this.jdField_g_of_type_AndroidAppDialog.setOnDismissListener(new aesu(this));
  ...
  void a(AbsListView paramAbsListView)
  {
    ...
    {
      localChatMessage = (ChatMessage)this.jdField_a_of_type_Acut.getItem(i1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Nnx.a(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0L, 0L, l1, l2, 2, localArrayList4);
        ...
        while (paramAbsListView.hasNext()) {
          if ("1".equals(((ChatMessage)paramAbsListView.next()).getExtInfoFromExtStr("is_AdArrive_Msg")))
          {
            ...
            ses.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localArrayList2, localArrayList1, localArrayList3);
          }
        }
        return;
      }
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence)
  {
    ...
    for (;;)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "" + this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X80064D4", "0X80064D4", 0, 0, "", "" + i1, "" + l1, "");
      return;
      label174:
      continue;
      label177:
  ...
  {
    if ((I()) && (nrw.a()) && (paramList.size() > 0))
    {
      Iterator localIterator = paramList.iterator();
      while (localIterator.hasNext())
      {
        Object localObject = (ChatMessage)localIterator.next();
        axun localaxun = nrk.a((MessageRecord)localObject);
        if ((localaxun != null) && (localaxun.h == 1))
        {
          localIterator.remove();
        }
        else
        {
          localObject = nrk.a((MessageRecord)localObject);
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Nnx.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramMap, (String)localObject, null, new aetj(this));
      return;
      localObject = null;
      paramMap = null;
    }
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if ((this.jdField_a_of_type_Acut != null) && (this.jdField_a_of_type_Acut.getCount() > 0))
    {
      ...
      this.jdField_a_of_type_Akqs.jdField_f_of_type_Boolean = true;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 21, this.jdField_a_of_type_Akqs);
    }
    return true;
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Aeto = new aeto(this, null);
    Object localObject = new IntentFilter();
    ((IntentFilter)localObject).addAction("android.intent.action.CLOSE_SYSTEM_DIALOGS");
    ((IntentFilter)localObject).addAction("android.intent.action.SCREEN_OFF");
    this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_Aeto, (IntentFilter)localObject);
    this.N = false;
    this.jdField_G_of_type_Boolean = false;
    bI();
    this.jdField_a_of_type_Nnx = nnx.a();
    bA();
    ...
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setDrawFinishedListener(this.jdField_a_of_type_Bfwv);
    this.jdField_a_of_type_Azon = new azon();
    this.jdField_a_of_type_Azon.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a(), this, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_Acut, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    this.jdField_a_of_type_Azon.addObserver(this);
    ...
    this.y = 0;
    this.E = this.D;
    sgj.jdField_a_of_type_Boolean = ((Intent)localObject).getBooleanExtra("is_come_from_readinjoy", false);
    this.jdField_G_of_type_Int = ((Intent)localObject).getIntExtra("INTENT_KEY_FROM", 1);
    if (!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing())
    {
      PublicAccountInfo localPublicAccountInfo = ((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if ((localPublicAccountInfo == null) || (sgj.a(localPublicAccountInfo.accountFlag) != -2)) {
        break label601;
      }
      this.ax = true;
      bs();
      this.jdField_a_of_type_Azon.f();
      if (this.jdField_a_of_type_Azon.b > 0) {
        break label483;
      }
      this.jdField_a_of_type_Azon.a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue(), 1);
    }
    for (;;)
    {
      ...
      nnx.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Intent)localObject).getStringExtra("starhomeurl"), ((Intent)localObject).getStringExtra("uin"), str);
      return true;
      label483:
      int i2 = ((baja)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if (i2 == -1)
      {
        this.jdField_a_of_type_Azon.a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue(), 2);
      }
      else
      {
        int i1;
        ...
        for (;;)
        {
          ...
          break label554;
          label584:
          this.jdField_a_of_type_Azon.e();
          this.jdField_a_of_type_Azon.b();
        }
        label601:
        bH();
      }
    ...
    if ((bbev.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext()) == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals("2632129500"))) {
      mze.b("108", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, new aete(this));
    }
    if ("3105932915".equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      localObject = (bggp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(142);
      if (localObject != null) {
        bggm.a(((bggp)localObject).a(5));
      }
    }
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.setCustomHeight(0);
    }
    this.Z = sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    if (sgj.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
    ...
    if (this.Z) {
      if (this.aa) {
        noo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005A22", "0X8005A22", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "new", "", "", false);
      }
    }
    for (;;)
    {
      ota.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if (((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        this.V = true;
      }
      if ((H()) && (this.E > 0)) {
      ...
      if (I())
      {
        ArkAppNotifyCenter.setNotify("com.tencent.gouwu.video", new WeakReference(new alpw()));
        ArkAppNotifyCenter.registVolumnReceiver();
      }
      if (advq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        aikw.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 5);
      }
      return true;
      noo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005A22", "0X8005A22", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "old", "", "", false);
      continue;
      noo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005A22", "0X8005A22", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "", false);
      if ("2290230341".equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
      {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80090E2", "0X80090E2", 0, 0, "", "", "", "");
        axqt.a(2);
      }
    }
  }
  ...
  public void ag()
  {
    if ((this.ax) && (sdf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) > 0)) {
      sdf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
    super.ag();
    if (advq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
    ...
    for (;;)
    {
      nqq localnqq = (nqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
      if ((localnqq != null) && (localnqq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      ...
      if (("3026775809".equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (Build.VERSION.SDK_INT >= 19) && (((SensorManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getSystemService("sensor")).getDefaultSensor(19) != null)) {
        ((bbui)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(260)).a("public account");
      }
    }
  }
  ...
  public void an()
  {
    ...
    nqq localnqq = (nqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    if (sbc.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Nqv);
    }
  ...
  public void ao()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Nqv);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bduv);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Akws);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_b_of_type_Akws);
  }
  ...
  {
    super.b(paramIntent);
    if (sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1008) && (sbc.b(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (sbc.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      sbc.a().a(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
  }
  
  public void b(ChatMessage paramChatMessage)
  {
    int i1 = this.jdField_a_of_type_Acut.a(paramChatMessage) + 1;
    if ((i1 >= 0) && (i1 <= this.jdField_a_of_type_Acut.getCount() - 1))
    {
      ChatMessage localChatMessage = (ChatMessage)this.jdField_a_of_type_Acut.getItem(i1);
  ...
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004EF8", "0X8004EF8", 0, 0, Integer.toString(paramInt), "", "", "");
    if (this.jdField_b_of_type_MqqAppNewIntent != null)
    {
      nnx.a().a(this.jdField_b_of_type_MqqAppNewIntent);
      this.jdField_b_of_type_MqqAppNewIntent = null;
    }
    this.jdField_b_of_type_MqqAppNewIntent = nnx.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramInt, paramBoolean, BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new aesw(this));
  }
  ...
  public boolean b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      localObject = ((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if (localObject != null) {
  ...
  void bA()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString))
    {
      ...
      this.jdField_a_of_type_Bdto.a(str, this.jdField_j_of_type_JavaLangString);
      return;
    }
    this.jdField_j_of_type_JavaLangString = this.jdField_a_of_type_Bdto.b(str);
  ...
  public void bE()
  {
    ...
    if (this.ao) {
      if (((akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) == null) {
        break label292;
      }
    }
    label292:
    for (int i1 = 1;; i1 = 0)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_s_of_type_AndroidWidgetImageView == null) {
          this.jdField_s_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131365817));
        }
  ...
  public void bF()
  {
    ...
    do
    {
      ...
      {
        akoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131698254), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false, true);
        return;
      }
  ...
  public void bo()
  {
    ChatMessage localChatMessage;
    String str1;
    if (this.jdField_a_of_type_Acut.getCount() >= 1)
    {
      localChatMessage = (ChatMessage)this.jdField_a_of_type_Acut.a().get(this.jdField_a_of_type_Acut.getCount() - 1);
      str1 = "0";
      if (localChatMessage != null)
      {
    ...
    catch (Exception localException)
    {
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005D17", "0X8005D17", 0, 1, 0, "old", String.valueOf(l1 - this.jdField_h_of_type_Long), "", "");
    }
    Object localObject = localChatMessage.getExtInfoFromExtStr("pa_msgId");
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "" + localChatMessage.frienduin, "0X8005C38", "0X8005C38", 0, 1, 0, (String)localObject, String.valueOf(NetConnInfoCenter.getServerTime() * 1000L), "", str1);
    if (this.Z)
    {
      l1 = NetConnInfoCenter.getServerTime() * 1000L;
      if (this.aa) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005D17", "0X8005D17", 0, 1, 0, "new", String.valueOf(l1 - this.jdField_h_of_type_Long), "", "");
      }
    }
    else
    {
  ...
  public void bp()
  {
    if ((!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing()) && (this.jdField_d_of_type_Bcpq != null) && (this.jdField_d_of_type_Bcpq.isShowing())) {
      this.jdField_d_of_type_Bcpq.dismiss();
    }
  }
  ...
  void bq()
  {
    ...
    a(this.jdField_u_of_type_AndroidViewView, this.jdField_u_of_type_AndroidViewView.getHeight(), 0, new aerz(this));
    ...
    localTranslateAnimation.setAnimationListener(new aesa(this));
  ...
  void br()
  {
    ...
    do
    {
      ...
      this.jdField_o_of_type_AndroidViewView.findViewById(2131367679).setOnClickListener(new aesd(this));
    ...
    if (this.jdField_q_of_type_Int == 2)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.setOnMenuItemClickListener(new aese(this));
      ...
      i1 = 2131691906;
      localObject = new xee("DO_NOT_FOLLOW", ((FragmentActivity)localObject).getString(i1), a().getResources().getDrawable(2130841293), 0);
      localxee1 = new xee("DO_FOLLOW", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691903), a().getResources().getDrawable(2130841193), 1);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a((xee)localObject, 2131559780);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localxee1, 2131559780);
    }
    for (;;)
    {
      ...
      break label380;
      label613:
      localObject = new xee("DO_CANCEL", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131690601), a().getResources().getDrawable(2130841293), 0);
      localxee1 = new xee("DO_FOLLOW", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691903), a().getResources().getDrawable(2130841193), 1);
      xee localxee2 = new xee("DO_NOT_FOLLOW", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691906), a().getResources().getDrawable(2130841293), 0);
      this.jdField_r_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a((xee)localObject, 2131559780);
      this.jdField_q_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localxee2, 2131559780);
      this.jdField_s_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localxee1, 2131559780);
    }
    label768:
  ...
  void bt()
  {
    ...
    {
      this.jdField_a_of_type_Bfol = ((bfol)bfoy.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, null));
      this.jdField_a_of_type_Bfol.a(ajyc.a(2131708790));
      this.jdField_a_of_type_Bfol.a(ajyc.a(2131708786), 3);
      this.jdField_a_of_type_Bfol.c(2131690596);
      this.jdField_a_of_type_Bfol.setOnDismissListener(new aesh(this));
      this.jdField_a_of_type_Bfol.a(new aesj(this));
    }
  ...
  void bu()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        this.jdField_s_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131365817));
        if (this.jdField_s_of_type_AndroidWidgetImageView != null) {
          this.jdField_s_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getText(2131696728));
        }
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setMenuType(this.jdField_a_of_type_Nnx.b(a()));
          if (CustomMenuBar.a())
          {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null)
          {
            ...
            if ((localObject3 != null) && (localObject2 != null) && ((localObject3 instanceof RelativeLayout.LayoutParams)) && ((localObject2 instanceof RelativeLayout.LayoutParams)))
            {
              ...
              {
                ((RelativeLayout.LayoutParams)localObject3).addRule(2, 2131365816);
          ...
          if (this.Y)
          {
            localObject1 = new TranslateAnimation(0.0F, 0.0F, actn.a(34.0F, (Resources)localObject1), 0.0F);
            ((TranslateAnimation)localObject1).setDuration(250L);
            ((TranslateAnimation)localObject1).setFillAfter(true);
            ((TranslateAnimation)localObject1).setAnimationListener(new aesn(this));
            this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.startAnimation((Animation)localObject1);
          }
          localObject1 = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365815);
          ((View)localObject1).setOnClickListener(new aeso(this));
          ...
          this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnMenuItemClickListener(new aesp(this));
          this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnBackClickListner(new aesq(this));
          localObject1 = this.jdField_a_of_type_Nnx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a());
          c((List)localObject1);
          this.jdField_a_of_type_MqqAppNewIntent = this.jdField_a_of_type_Nnx.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a(), this.jdField_a_of_type_MqqObserverBusinessObserver, false);
          if ((localObject1 != null) && (!((List)localObject1).isEmpty())) {
            t(true);
          }
          this.au = true;
          if (this.jdField_a_of_type_Nqc == null) {
            this.jdField_a_of_type_Nqc = new nqc(this.jdField_a_of_type_AndroidContentContext);
          }
          ...
          if ((((Intent)localObject1).hasExtra("pub_account_type")) && ("type_ecshop_account".equals(((Intent)localObject1).getStringExtra("pub_account_type"))))
          {
            ...
            localObject1 = this.jdField_a_of_type_Nqc.a((String)localObject1, this);
            this.jdField_a_of_type_Nqc.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, (View)localObject1);
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_nearbyiconPv", "Pv_shopnearbyicon", 0, 0, "", "", "", "");
          }
          if ((H()) && (aqss.a()))
          {
            az();
          ...
          localObject1 = (nqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(139);
          if (!nrw.a()) {
            break label982;
          }
          ...
          ((CustomTabView)localObject2).a(nrv.a());
          ...
          ((nqx)localObject1).a(null, null, false, null);
          return;
          this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setVisibility(8);
        }
      }
  ...
  void bw()
  {
    ...
    if (localObject != null)
    {
      ...
      this.jdField_c_of_type_MqqAppNewIntent = new NewIntent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext(), nou.class);
    ...
    for (;;)
    {
      noo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 4);
      if (QLog.isColorLevel()) {
      ...
      label224:
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Akws);
      this.jdField_a_of_type_Akws = new akws(new aesy(this));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Akws);
      akwx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 0);
    }
  }
  ...
  protected void by()
  {
    ...
    do
    {
      ...
      this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130844022);
    ...
    if (this.jdField_f_of_type_Int == 2)
    {
      ...
      {
        if (CustomMenuBar.a()) {
          this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130848809);
        }
        for (;;)
        {
          this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131698460));
          return;
          this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130849202);
        }
      }
      if (CustomMenuBar.a()) {
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130848808);
      }
      for (;;)
      {
        this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131698459));
        return;
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130849203);
      }
    }
    this.jdField_p_of_type_AndroidWidgetImageView.setEnabled(true);
    if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 3)
  ...
  public void bz()
  {
    ...
    this.jdField_l_of_type_AndroidWidgetTextView = ((TextView)this.jdField_v_of_type_AndroidViewView.findViewById(2131375060));
    if (!this.aa) {
      this.jdField_l_of_type_AndroidWidgetTextView.setVisibility(8);
    }
    this.jdField_m_of_type_AndroidWidgetTextView = ((TextView)this.jdField_v_of_type_AndroidViewView.findViewById(2131375053));
    this.jdField_t_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_v_of_type_AndroidViewView.findViewById(2131375051));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_v_of_type_AndroidViewView.findViewById(2131375054));
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 8) {
      if (this.jdField_q_of_type_AndroidWidgetImageView != null)
      {
        ...
        this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130848858);
      }
    }
    for (;;)
    {
      if (!this.jdField_f_of_type_Boolean)
      {
        ...
        if (this.jdField_a_of_type_AndroidTextSpannableString == null)
        {
          ...
          localSpannableString = new SpannableString(ajyc.a(2131708796));
        ...
        if (this.jdField_b_of_type_AndroidTextSpannableString == null)
        {
          ...
          localSpannableString = new SpannableString(ajyc.a(2131708792));
          localSpannableString.setSpan(localObject, 0, localSpannableString.length(), 33);
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelAudioPanel != null) && (paramInt1 != 2) && (actc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
          this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelAudioPanel.a(false);
        }
      }
      return;
      label295:
      this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130848780);
      continue;
      if (this.jdField_q_of_type_AndroidWidgetImageView != null) {
        if (CustomMenuBar.a()) {
          this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130848857);
        } else {
          this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130848779);
        }
      }
    }
  ...
  public void c(View paramView)
  {
    ...
    ((adjw)this.jdField_a_of_type_Adic.a(22)).a(paramView);
  }
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_ComTencentBizUiCustomMenuBar != null)
      {
        ...
        else
        {
          ...
          Object localObject1;
          if ((paramList != null) && (advq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
          {
            localObject1 = new mobileqq_mp.ButtonInfo();
            ((mobileqq_mp.ButtonInfo)localObject1).id.set(0);
            ((mobileqq_mp.ButtonInfo)localObject1).name.set(ajyc.a(2131713836));
          ...
          while ((i1 < i3) && (i1 <= 2))
          {
            ...
            if (((mobileqq_mp.ButtonInfo)localObject2).key.has())
            {
              ...
              localxee = new xee((String)localObject1, str, null, i2);
              localxee.a((mobileqq_mp.ButtonInfo)localObject2);
            ...
            {
              localObject1 = new xee((String)localObject1, str, null, i2);
              ((xee)localObject1).a(localButtonInfo);
              localxee.a((xee)localObject1);
              break label431;
              localObject1 = "";
              break;
              str = "";
  ...
  {
    int i1 = this.jdField_a_of_type_Acut.a(paramChatMessage);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Acut.a(paramChatMessage);
  }
  ...
  public void f()
  {
    ...
    this.jdField_c_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajyc.a(2131708802));
    ...
    for (;;)
    {
      this.jdField_r_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetLinearLayout.findViewById(2131362849));
      ...
      this.jdField_p_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetLinearLayout.findViewById(2131365561));
      this.jdField_p_of_type_AndroidWidgetImageView.setOnClickListener(this);
      if (!CustomMenuBar.a())
      {
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130846982);
        this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130837728);
      }
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        int i1 = actn.a(3.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        if (CustomMenuBar.a())
        {
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130848912);
  ...
  {
    boolean bool = true;
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Nqc != null) && (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity != null)) {
      if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aeyx.a(1000, new Object[0]);
      continue;
  ...
  public void j()
  {
    aeyo localaeyo = new aeyo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Aeyx, this, this.jdField_a_of_type_MqqOsMqqHandler);
    this.jdField_a_of_type_Aeyx.a(localaeyo);
  }
  ...
  public void o(int paramInt)
  {
    ...
    if (paramInt != this.jdField_f_of_type_Int)
    {
      ...
      if (this.jdField_a_of_type_AndroidTextSpannableString == null)
      {
        ...
        localSpannableString = new SpannableString(ajyc.a(2131708808));
    ...
    for (;;)
    {
      ...
      if (paramInt == 2)
      {
        if (this.jdField_b_of_type_AndroidTextSpannableString == null)
        {
          ...
          localSpannableString = new SpannableString(ajyc.a(2131708737));
          localSpannableString.setSpan(localImageSpan, 0, localSpannableString.length(), 33);
          this.jdField_b_of_type_AndroidTextSpannableString = localSpannableString;
        }
      ...
      else
      {
        ...
        {
          localImageSpan = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130838191);
          localSpannableString = new SpannableString(ajyc.a(2131708783));
          localSpannableString.setSpan(localImageSpan, 0, localSpannableString.length(), 33);
          this.jdField_b_of_type_AndroidTextSpannableString = localSpannableString;
        }
        if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().length() > 0) {
  ...
  public void onClick(View paramView)
  {
    ...
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004EFD", "0X8004EFD", 0, 0, "", "", "", "");
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8004F08", "0X8004F08", 0, 0, "", "", "", "");
      bbfc.a(null, "pubAcc_profile_display", "");
    }
    if (paramView.getId() == 2131366883)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().length() > 0) && (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() != 2) && (this.jdField_r_of_type_AndroidWidgetImageView != null) && (this.jdField_r_of_type_AndroidWidgetImageView.getVisibility() != 0))
      {
        ...
        if (advq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
        {
          ...
          aikw.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 6);
        }
      }
      if (QLog.isColorLevel())
      {
        ...
        noo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X800584F", "0X800584F", 0, 0, "", "", "", "", false);
      }
    }
    if ((paramView.getId() == 2131365561) && (this.jdField_f_of_type_Int != 1))
    {
      if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() != 3) {
        break label892;
      }
    ...
    else
    {
      ...
      default: 
        ...
        if ((this.Z) && (paramView.getId() == 2131366883)) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005C9C", "0X8005C9C", 0, 1, 0, "", "", "", "");
        }
        if (((paramView.getTag() instanceof String)) && (nqc.jdField_a_of_type_JavaLangString.equals((String)paramView.getTag())) && (this.jdField_a_of_type_AndroidContentContext != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
    ...
    do
    {
      ...
      break label709;
      axqw.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "auth_aio", "clk_return", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, "");
      break label776;
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_nearbyiconClk", "Clk_shopnearbyicon", 0, 0, "", "", "", "");
      ...
      localObject2 = (String)nqq.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    ...
    if (((ajxn)localObject1).b((String)localObject2)) {
      localIntent.putExtra("uintype", 0);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Shop_customservice", "Clk_shopcustomservice", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      label1409:
      super.onClick(paramView);
      return;
      localIntent.putExtra("uintype", 1005);
      localIntent.putExtra("uinname", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d + ajyc.a(2131708778));
  ...
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    ((adjw)this.jdField_a_of_type_Adic.a(22)).a(paramAbsListView, paramInt1, paramInt2, paramInt3);
    b(paramAbsListView);
    if ((this.an) || (this.as)) {}
    label273:
    label275:
    ...
    do
    {
      ...
      paramAbsListView.setAnimationListener(new aesb(this));
    ...
    paramAbsListView.setFillAfter(true);
    paramAbsListView.setDuration(250L);
    paramAbsListView.setAnimationListener(new aesc(this));
    this.jdField_o_of_type_AndroidViewView.startAnimation(paramAbsListView);
  }
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    ((adjw)this.jdField_a_of_type_Adic.a(22)).a(paramAbsListView, paramInt);
  }
  ...
  protected void u(boolean paramBoolean)
  {
    ...
    for (int i1 = 4;; i1 = 0)
    {
      ...
      {
        localObject = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130837922);
        SpannableString localSpannableString = new SpannableString(ajyc.a(2131708769));
        localSpannableString.setSpan(localObject, 0, localSpannableString.length(), 33);
        this.jdField_a_of_type_AndroidTextSpannableString = localSpannableString;
      }
      this.jdField_c_of_type_ComTencentWidgetPatchedButton.setText(this.jdField_a_of_type_AndroidTextSpannableString);
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    if ((bhvh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && ((paramObject instanceof MessageRecord))) {
    ...
    int i1;
    if ((paramObservable instanceof azon)) {
  ...
  public void x()
  {
    if (this.aA)
    {
      ...
      wiv.a(a(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      axqw.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "auth_aio", "clk_head", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, "");
      return;
    }
    ...
    sgj.a(localIntent, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, -1, 2000, 1, sgj.jdField_a_of_type_Boolean);
  }
  ...
  public boolean y()
  {
    ...
    {
      this.aj = true;
      this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setSelection(this.jdField_a_of_type_Acut.getCount() - 1);
    }
  ...
  public void z()
  {
    if (this.jdField_a_of_type_AndroidWidgetImageView != null)
    {
      if ("2277373213".equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight1Icon(2130846415);
      }
    }
    else {
      return;
