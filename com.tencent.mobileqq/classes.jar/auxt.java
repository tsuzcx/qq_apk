...
public class auxt
{
  ...
  public WeakReference<auyo> a;
  public HashSet<String> a;
  
  public auxt(BaseActivity paramBaseActivity, auyo paramauyo)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_JavaUtilHashSet = bgnf.a(paramBaseActivity);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramauyo);
  }
  ...
  public ArrayList<String> a(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && ((paramBundle instanceof ArrayList)))
    {
      ...
      auxw localauxw = new auxw(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, null);
      int i = 0;
      while (i < paramBundle.size())
      {
        String str = localauxw.a((Uri)paramBundle.get(i), false);
  ...
  public void a(String paramString)
  {
    ...
    auyl localauyl = (auyl)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
    ...
    paramString = (auyo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
      localauyl.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, "android.intent.action.SEND", paramString);
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localauyl = (auyl)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
      ...
      if ((!TextUtils.isEmpty(paramString1)) && (new File(paramString1).exists()))
      {
        ...
        String str = bgmj.a(atvo.e(paramString1));
        ...
        localVideoInfo.sha1.set(auxv.a(paramString1));
        localVideoInfo.play_duration.set((int)l);
        localCheckShareExtensionReq.videos.add(localVideoInfo);
      }
      paramString1 = (auyo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramString1 == null);
    localauyl.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString2, paramString1);
  }
  ...
  public void a(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            String str = bgmj.a(atvo.e((String)localObject2));
            if (QLog.isColorLevel()) {
              QLog.d("CheckForward.Security", 2, "sendCheckImgShareReq md5= " + str);
            }
            localImgInfo.md5.set(str);
            localImgInfo.sha1.set(auxv.a((String)localObject2));
            localObject2 = auxv.a((String)localObject2);
            ...
            localObject1 = auxv.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (File)localObject1);
      ...
      paramArrayList = (auyo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramArrayList == null);
    localauyl.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString, paramArrayList);
  }
  ...
  {
    if (this.jdField_a_of_type_Auxw == null) {
      this.jdField_a_of_type_Auxw = new auxw(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, new auxu(this, paramInt, paramString));
    }
    String str = this.jdField_a_of_type_Auxw.a(paramUri);
    ...
    {
      return false;
      if ((this.jdField_a_of_type_Auxw.b) || (this.jdField_a_of_type_Auxw.a)) {
        return true;
      }
      paramUri = new File(str);
      l = paramUri.length();
    } while ((!this.jdField_a_of_type_Auxw.b) && (!this.jdField_a_of_type_Auxw.a) && (l == 0L));
