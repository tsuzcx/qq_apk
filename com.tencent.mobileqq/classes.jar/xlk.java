...
public class xlk
{
  ...
  {
    yqp.b("Q.qqstory.playernew.AnimationUtils", "doExitAnimation");
    View localView = paramViewGroup.findViewById(2131376788);
    ImageView localImageView2 = (ImageView)paramViewGroup.findViewById(2131362672);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131380867);
    ...
    paramViewGroup.addUpdateListener(new xll(localViewGroup, localDrawable, localImageView1, localImageView2));
    paramViewGroup.addListener(new xlm(paramAnimatorListener));
  ...
  {
    yqp.b("Q.qqstory.playernew.AnimationUtils", "doEnterAnimation");
    Object localObject = paramViewGroup.findViewById(2131376788);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131362672);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131380867);
    ...
    ((ValueAnimator)localObject).addUpdateListener(new xln(localViewGroup, paramViewGroup, localImageView));
    ((ValueAnimator)localObject).addListener(new xlo(paramAnimatorListener, localViewGroup, paramViewGroup));
