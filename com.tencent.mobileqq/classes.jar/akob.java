...
public class akob
{
  private static akob jdField_a_of_type_Akob;
  ...
  private akob()
  {
    ...
    for (;;)
    {
      ...
      if ((Math.abs(l2 - l1) > 86400000L) && (this.b > 2))
      {
        ...
        axrn.a(BaseApplicationImpl.getApplication()).a(null, "ProcReporter", true, 0L, this.b, (HashMap)localObject2, null);
        this.b = 0;
  ...
  public static akob a()
  {
    if (jdField_a_of_type_Akob == null) {}
    try
    {
      if (jdField_a_of_type_Akob == null) {
        jdField_a_of_type_Akob = new akob();
      }
      return jdField_a_of_type_Akob;
    }
    finally {}
  }
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "ProcKillFailed", true, 0L, 0L, localHashMap, null);
