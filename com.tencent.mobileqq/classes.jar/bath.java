  ...
  implements View.OnClickListener
{
  ...
  public bath(Activity paramActivity, batk parambatk, int paramInt1, String paramString, int paramInt2)
  {
    super(paramActivity, 2131690181);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Batk = parambatk;
  ...
  public bath(Activity paramActivity, CustomWebView paramCustomWebView, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    super(paramActivity, 2131690181);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131297496));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131304261));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131299297));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131299165));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131298297));
    ...
    Object localObject2 = new ColorDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131101529));
    Object localObject3;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Batk != null) {
      this.jdField_a_of_type_Batk.callback(3);
    }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131299165: 
      ...
      {
        return;
        paramView = bati.a(this.jdField_b_of_type_JavaLangString);
        Object localObject;
        ...
        {
          if (this.jdField_a_of_type_Batk != null) {
            this.jdField_a_of_type_Batk.callback(4);
          }
          dismiss();
          if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView == null) {
            break;
        ...
        if (this.jdField_a_of_type_Batk != null) {
          this.jdField_a_of_type_Batk.callback(1);
        }
        dismiss();
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {}
        try
