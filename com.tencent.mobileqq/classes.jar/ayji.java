...
public class ayji
  implements ayjh, Manager
{
  private static Set<Integer> jdField_a_of_type_JavaUtilSet = new HashSet();
  private ayjg jdField_a_of_type_Ayjg;
  private ayjj jdField_a_of_type_Ayjj;
  ...
  private ayje[] jdField_a_of_type_ArrayOfAyje = new ayje[jdField_a_of_type_JavaUtilSet.size()];
  ...
  public ayji(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Ayjk = new ayjk(paramQQAppInterface, this);
    this.jdField_a_of_type_Ayjg = ayjg.a();
    this.jdField_a_of_type_Ayjj = new ayjj(this);
  ...
  private boolean a(String paramString, Class<? extends Entity> paramClass)
  {
    ...
    //   83: goto -70 -> 13
    //   86: aload_0
    //   87: getfield 82	ayji:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   154: aload_0
    //   155: getfield 82	ayji:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   158: aload_1
  ...
  private boolean b()
  {
    ...
    int i = this.jdField_a_of_type_Ayjg.a;
    if (i == 2)
    {
      if (QLog.isColorLevel()) {
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Ayjg != null) {
      return this.jdField_a_of_type_Ayjg.a;
    }
    return 0;
  }
  ...
  public ayjg a()
  {
    return this.jdField_a_of_type_Ayjg;
  }
  
  public ayjj a()
  {
    return this.jdField_a_of_type_Ayjj;
  }
  ...
  public void a(int paramInt, String paramString, PrecoverResource paramPrecoverResource, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Ayjk.b(this);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (???.hasNext())
        {
          ...
          localObject5 = ayjo.a((String)((Pair)localObject4).second);
          if ((localObject5 == null) || (((Pair)localObject5).first == null) || (((Pair)localObject5).second == null)) {
            continue;
          }
          if (QLog.isColorLevel()) {
            QLog.d("PrecoverManager", 2, new Object[] { "onHandleConfigs, businessid=", ((ayjf)((Pair)localObject5).first).a, ", name=", ((ayjf)((Pair)localObject5).first).b, ", list.size=", Integer.valueOf(((List)((Pair)localObject5).second).size()) });
          }
          if (TextUtils.isEmpty(((ayjf)((Pair)localObject5).first).a)) {
            continue;
          }
          String str = ((ayjf)((Pair)localObject5).first).a;
  ...
  {
    boolean bool = ayjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "checkReportConfigCover, succ=", Boolean.valueOf(paramBoolean), ", need=", Boolean.valueOf(bool) });
    }
    if (bool)
    {
      ayjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
      this.jdField_a_of_type_Ayjj.a(paramBoolean);
    }
  }
  
  public boolean a()
  {
    boolean bool = ayjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
    int j = ayjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 0);
    if (bool)
    {
      ayjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
      ayjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 1);
      return true;
    }
    if (a() != null) {}
    ...
    ayjo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", j + 1);
    return true;
  }
  ...
  protected boolean a(PrecoverResource paramPrecoverResource)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (localPrecoverRetryInfo.totalRetryCount <= this.jdField_a_of_type_Ayjg.c) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      if (localPrecoverRetryInfo.itemRetryCount < this.jdField_a_of_type_Ayjg.b)
      {
        localPrecoverRetryInfo.itemRetryCount += 1;
        localPrecoverRetryInfo.totalRetryCount += 1;
        localPrecoverRetryInfo.retryUpdateTime = l;
