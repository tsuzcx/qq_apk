  ...
  extends axyp
{
  ...
  public static void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, Activity paramActivity, int paramInt)
  {
    ...
    File localFile = localaxyn.a(localAIOPictureData, 4);
    if (localFile == null) {
      localFile = localaxyn.a(localAIOPictureData, 2);
    }
    for (int i = 0;; i = 1)
    {
      ...
      localBundle.putString("forward_urldrawable_thumb_url", localaxyn.a(localAIOPictureData, 1));
      ...
      for (int j = 4;; j = 2)
      {
        localBundle.putString("forward_urldrawable_big_url", localaxyn.a(paramRichMediaBrowserInfo, j));
        if (localFile == null) {
          break;
        }
        try
        {
          ...
          localBundle.putParcelable("FORWARD_MSG_FOR_PIC", axzf.a(localAIOPictureData));
          ...
          aryv.a(paramActivity, paramRichMediaBrowserInfo, paramInt);
          return;
        }
  ...
  public static Intent b(RichMediaBrowserInfo paramRichMediaBrowserInfo, Activity paramActivity, int paramInt)
  {
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (int i = 4;; i = 2)
      {
        localBundle.putString("forward_urldrawable_big_url", localaxyn.a(paramRichMediaBrowserInfo, i));
        if (localFile == null) {
          break;
        }
        try
      ...
      if ((localAIOPictureData.jdField_b_of_type_Int == 1) && (localAIOPictureData.k))
      {
        if ((RichMediaBrowserManager.getInstance().getProvider() != null) && (RichMediaBrowserManager.getInstance().getProvider().isPingBinder()))
        {
          ...
          for (boolean bool = true;; bool = false) {
            return axzg.a(paramActivity, paramRichMediaBrowserInfo, bool);
          }
        }
      }
      else {
  ...
  public Intent a(RichMediaBrowserInfo paramRichMediaBrowserInfo, Activity paramActivity, int paramInt)
  {
    ...
    if ((i == 1) || (i == 2) || (i == 3) || (i == 5) || (i == 6))
    {
      ...
      localaxyn = new axyn();
      paramRichMediaBrowserInfo = localaxyn.a(localAIOPictureData, 4);
      if (paramRichMediaBrowserInfo != null) {
        break label375;
      }
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (i = 4;; i = 2)
      {
        localBundle.putString("forward_urldrawable_big_url", localaxyn.a(localAIOPictureData, i));
        if (paramRichMediaBrowserInfo == null) {
          break;
        }
        try
  ...
  public void a(int paramInt, View paramView, boolean paramBoolean)
  {
    if ((paramView instanceof BrowserBaseAdapter.URLImageView2))
    {
      ...
      if ((localObject1 != null) && (((RichMediaBrowserInfo)localObject1).baseData.getType() == 100) && ((((RichMediaBrowserInfo)localObject1).baseData instanceof AIOPictureData)))
      {
        ...
        Object localObject3 = new axyn();
        if ((paramBoolean) && (((axyn)localObject3).a((AIOPictureData)localObject2, 8) != null))
        {
          localObject1 = paramView.getDrawable();
          localObject2 = ((axyn)localObject3).a((AIOPictureData)localObject2, 8);
  ...
  public void a(long paramLong1, int paramInt1, int paramInt2, int paramInt3, long paramLong2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && ((((RichMediaBrowserInfo)localObject).baseData instanceof AIOPictureData)))
      {
        ...
        if ((((AIOPictureData)localObject).jdField_a_of_type_Long == paramLong1) && (((AIOPictureData)localObject).jdField_a_of_type_Int == paramInt1) && (this.jdField_a_of_type_Ayaa != null))
        {
          this.jdField_a_of_type_Ayaa.updateUI();
          if ((paramBoolean) && (paramInt2 == 2) && (this.jdField_a_of_type_Ayaa.galleryView != null)) {
            a(getSelectedIndex(), this.jdField_a_of_type_Ayaa.galleryView, true);
          }
        }
      }
      return;
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Ayaa != null) && (localObject2 != null) && ((((RichMediaBrowserInfo)localObject2).baseData instanceof AIOPictureData)) && (((AIOPictureData)((RichMediaBrowserInfo)localObject2).baseData).jdField_a_of_type_Long == paramLong) && (((AIOPictureData)((RichMediaBrowserInfo)localObject2).baseData).jdField_a_of_type_Int == paramInt1))
    {
      if (paramInt2 != 2) {
        break label351;
      }
      ...
      this.jdField_a_of_type_Ayaa.a(paramInt2, paramBoolean);
    }
    for (;;)
    {
      this.jdField_a_of_type_Ayaa.updateUI();
      ...
      if (paramInt2 == 24)
      {
        ...
        if (paramInt3 == 1) {
          QQToast.a(this.jdField_a_of_type_Ayaa.mContext, this.jdField_a_of_type_Ayaa.mContext.getString(2131719321), 0).a();
        } else {
          QQToast.a(this.jdField_a_of_type_Ayaa.mContext, this.jdField_a_of_type_Ayaa.mContext.getString(2131719317), 0).a();
        }
      }
      else if (paramInt2 == 4)
      {
        ...
        else
        {
          for (;;)
          {
            try
            {
              ...
              localObject1 = URLDrawable.getDrawable(new axyn().a((AIOPictureData)((RichMediaBrowserInfo)localObject2).baseData, 4), (URLDrawable.URLDrawableOptions)localObject1);
            ...
            catch (Throwable localThrowable)
            {
              ...
              continue;
              localGalleryUrlImageView = (GalleryUrlImageView)this.jdField_a_of_type_Ayaa.galleryView.findViewById(2131367921);
            }
            if (paramString != null) {
              continue;
            }
            QQToast.a(this.jdField_a_of_type_Ayaa.mContext, this.jdField_a_of_type_Ayaa.mContext.getString(2131695501), 0).a();
            return;
            localObject1 = "I:E";
            break;
          ...
          localGalleryUrlImageView.setGalleryImageListener(new axyw(this, paramString, (RichMediaBrowserInfo)localObject2));
          localGalleryUrlImageView.setImageDrawable(paramString);
          this.jdField_a_of_type_Ayaa.a = aepi.a(this.jdField_a_of_type_Ayaa.b, paramString);
          continue;
        }
  ...
  {
    if ((paramURLDrawable != null) && (this.jdField_a_of_type_Ayaa != null))
    {
      if (getGallery() != null) {
        this.jdField_a_of_type_Ayaa.a(paramURLDrawable, getGallery().getSelectedItemPosition());
      }
  ...
  protected void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, Activity paramActivity, int paramInt1, axyx paramaxyx, int paramInt2, String paramString)
  {
    int i = axyd.a().c();
    if ((i == 1) || (i == 2) || (i == 3) || (i == 5) || (i == 6))
    {
      ...
      axyn localaxyn = new axyn();
      paramInt1 = 1;
      Object localObject = localaxyn.a(localAIOPictureData, 4);
      ...
      ((Bundle)localObject).putString("forward_urldrawable_thumb_url", localaxyn.a(localAIOPictureData, 1));
      if (paramInt1 != 0) {}
      for (i = 4;; i = 2)
      {
        ((Bundle)localObject).putString("forward_urldrawable_big_url", localaxyn.a(localAIOPictureData, i));
        if (paramRichMediaBrowserInfo == null) {
          break;
        }
        try
        {
          ...
          if ((paramaxyx == null) || (paramaxyx.jdField_a_of_type_Int != 72)) {
            break label438;
          }
          paramRichMediaBrowserInfo.putExtra("key_req", ForwardRecentActivity.f);
          paramRichMediaBrowserInfo.putExtra("key_direct_show_uin_type", paramaxyx.jdField_b_of_type_Int);
          paramRichMediaBrowserInfo.putExtra("key_direct_show_uin", paramaxyx.jdField_a_of_type_JavaLangString);
          aryv.a(paramActivity, paramRichMediaBrowserInfo, ForwardRecentTranslucentActivity.class, 19005, paramInt2, paramString);
          return;
        }
        catch (NullPointerException paramRichMediaBrowserInfo)
        {
      ...
      return;
      label438:
      aryv.a(paramActivity, paramRichMediaBrowserInfo, 19005, paramInt2, paramString);
      return;
    }
    a(paramRichMediaBrowserInfo, paramActivity, paramInt1);
  }
  
  public void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, Activity paramActivity, axyx paramaxyx, int paramInt, String paramString)
  {
    boolean bool = false;
    AIOPictureData localAIOPictureData;
    if ((paramRichMediaBrowserInfo != null) && (paramRichMediaBrowserInfo.baseData != null) && (AIOPictureData.class.isInstance(paramRichMediaBrowserInfo.baseData)))
    ...
    axzg.a(paramActivity, paramRichMediaBrowserInfo, bool, paramInt, paramString);
    return;
    label152:
    a(paramRichMediaBrowserInfo, paramActivity, 0, paramaxyx, paramInt, paramString);
  }
  
  public void b()
  {
    if ((this.jdField_a_of_type_Ayaa != null) && (this.jdField_a_of_type_Axyq != null) && (this.jdField_a_of_type_Axyq.a != null) && (this.jdField_a_of_type_Axyq.a() != null))
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
      if (!bnle.b()) {
        break label108;
      }
      this.jdField_a_of_type_Axyq.a().a((int)aepi.a(bnle.jdField_a_of_type_Int, this.jdField_a_of_type_Ayaa.mContext.getResources()) + 40);
    }
    for (;;)
    {
  ...
  {
    super.onDestroy();
    if (this.jdField_a_of_type_Ayaa.a != null) {
      this.jdField_a_of_type_Ayaa.b.removeCallbacks(this.jdField_a_of_type_Ayaa.a);
    }
  }
  ...
  public void setGalleryView(BaseView paramBaseView)
  {
    ...
    if ((paramBaseView instanceof ayaa)) {
      this.jdField_a_of_type_Ayaa = ((ayaa)paramBaseView);
    }
  }
}
