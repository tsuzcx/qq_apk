...
public class bmic
{
  private static bmic jdField_a_of_type_Bmic;
  ...
  public static bmic a()
  {
    try
    {
      if (jdField_a_of_type_Bmic == null) {
        jdField_a_of_type_Bmic = new bmic();
      }
      bmic localbmic = jdField_a_of_type_Bmic;
      return localbmic;
    }
    finally {}
  }
  ...
  {
    if (this.jdField_a_of_type_Blum == null) {
    ...
    paramDownloadListener = new bmid(this, paramString2, paramDownloadListener, paramString1);
    paramString2 = jdField_a_of_type_JavaIoFile.getAbsolutePath() + "/tmp" + paramString2;
    this.jdField_a_of_type_Blum.a(paramString1, paramString2, paramDownloadListener);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localFile.length() == a(paramString)) {
      if (paramBoolean)
      {
        String str1 = bita.a(b(paramString));
  ...
  public void b()
  {
    QzoneModuleManager.getInstance().downloadModule("pictureMarkerSo.zip", new bmie(this));
  }
  ...
  public void c()
  {
    QzoneModuleManager.getInstance().downloadModule("libandroidndkbeauty.so", new bmif(this));
  }
}
