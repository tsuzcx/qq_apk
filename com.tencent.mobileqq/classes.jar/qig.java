...
public final class qig
{
  ...
  static
  {
    jdField_a_of_type_Qih = new qih(null);
  }
  ...
  private final qim a(int paramInt, Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2, Function3<? super Boolean, ? super Boolean, ? super Integer, Unit> paramFunction3)
  {
    boolean bool2 = false;
    int j = 1;
    int i;
    ...
    {
      i = bhgr.a((Context)paramActivity, 72.0F);
      bool1 = bool2;
    ...
    {
      return new qim(paramInt, paramBoolean1, paramString1, paramString2, i, bool1, paramFunction3);
      i = bhgr.a((Context)paramActivity, 16.0F);
      break;
    }
  }
  ...
  private final void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      ocd.a(localQQAppInterface, "", "0X800AFFC", "0X800AFFC", 0, 0, str, paramString, String.valueOf(paramInt2), "", false);
      return;
    }
  }
  ...
  private final void a(int paramInt1, String paramString, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (paramInt2 == 1)
    {
      paramInt3 = 1;
      localpaa = new paa();
      localpaa.a("click_type", Integer.valueOf(paramInt3));
      if (!paramBoolean) {
        break label113;
      }
      paramInt3 = 1;
      localpaa.a("is_ticked", Integer.valueOf(paramInt3));
    ...
    for (String str = "2";; str = "1")
    {
      ocd.a(localQQAppInterface, "", "0X800AFFE", "0X800AFFE", 0, 0, str, paramString, String.valueOf(paramInt2), localpaa.a(), false);
      return;
      if (paramInt3 == 1)
      {
        paramInt3 = 0;
  ...
  private final void a(boolean paramBoolean1, boolean paramBoolean2, Activity paramActivity)
  {
    ...
    if (paramBoolean1) {
      localStringBuilder.append(ozs.g(2131717215));
    }
    for (;;)
    {
      if (paramBoolean2) {
        localStringBuilder.append(ozs.g(2131717077));
      }
      QQToast.a((Context)paramActivity, 2, (CharSequence)localStringBuilder, 0).a();
      return;
      localStringBuilder.append(ozs.g(2131717013));
    }
  }
  ...
  private final void b(int paramInt1, String paramString, int paramInt2)
  {
    ...
    for (String str = "2";; str = "1")
    {
      ocd.a(localQQAppInterface, "", "0X800AFFD", "0X800AFFD", 0, 0, str, paramString, String.valueOf(paramInt2), "", false);
      return;
    }
  }
  ...
  public final void a(int paramInt1, @NotNull String paramString1, @NotNull String paramString2, int paramInt2, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      pfd.a().b(false, "MATCH_ALL_UIN");
      new qio((ViewGroup)localObject, paramString1).a(true);
  ...
  public final void a(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, @NotNull String paramString1, int paramInt2, @NotNull String paramString2, @NotNull qii paramqii)
  {
    Intrinsics.checkParameterIsNotNull(paramString1, "avatarUrl");
    Intrinsics.checkParameterIsNotNull(paramString2, "uniqueId");
    Intrinsics.checkParameterIsNotNull(paramqii, "callback");
    ...
    for (Object localObject = ((Window)localObject).getDecorView();; localObject = null)
    {
      if ((localObject instanceof ViewGroup))
      {
        paramString1 = a(paramInt1, (Activity)localBaseActivity, paramString1, paramString2, paramBoolean1, paramBoolean2, (Function3)new RIJPushNotifyManager.showPushNotifyDialogForWeb.param.1(this, localBaseActivity, paramString2, paramInt2, paramqii, paramInt1));
        pfd.a().b(false, "MATCH_ALL_UIN");
        new qio((ViewGroup)localObject, paramString1).a(true);
        a(paramInt2, paramString2, paramInt1);
      }
  ...
  public final void a(boolean paramBoolean, @NotNull String paramString)
  {
    ...
    pfd.a().b(paramBoolean, paramString);
  }
