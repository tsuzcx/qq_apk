...
public class ayxz
  extends ayyb
{
  private aohc jdField_a_of_type_Aohc = new ayya(this);
  ...
  public ayxz(QQAppInterface paramQQAppInterface)
  {
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2)
  {
    ...
    NotificationCompat.Builder localBuilder = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_HIDE_BADGE").setSmallIcon(2130841131).setAutoCancel(true).setOngoing(true).setWhen(System.currentTimeMillis());
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((i >= 512) && (i <= 522))
    {
      ...
      if (alof.u.equals(paramIntent.getStringExtra("uin"))) {
        break label857;
      }
    ...
    for (;;)
    {
      ...
      if ((bool2) && ((k == 1001) || (k == 10002)))
      {
        ...
        if (bddc.a(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
        {
      ...
      for (;;)
      {
        ...
        if (k == 1030)
        {
          ...
          paramBitmap = bdal.a(BaseApplication.getContext().getResources(), 2130840158);
        ...
        Bitmap localBitmap = bdal.a(paramBitmap.getResources(), 2130840158);
  ...
  private void c(ToServiceMsg paramToServiceMsg)
  {
    ...
    if (!bdqi.e)
    {
      paramToServiceMsg = bdqf.a().a(localIntent, localBitmap, arrayOfString[0], arrayOfString[1], arrayOfString[2], this.c, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      label155:
      if (!SettingCloneUtil.readValue(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), BaseApplication.getContext().getString(2131719358), "qqsetting_notify_showcontent_key", true)) {
        break label1245;
      }
      if (j != 1008) {
        break label394;
    ...
    for (;;)
    {
      ...
      else if (j == 1030)
      {
        ...
        Object localObject2 = new azqn();
        ((azqn)localObject2).e = "0X800923F";
        ((azqn)localObject2).d = "Android系统通知曝光";
        if (QLog.isColorLevel()) {
          QLog.d("CampusNoticeManager", 2, new Object[] { "notification url :", localIntent.getStringExtra("url") });
        }
        azqm.a(localIntent.getStringExtra("url"), (azqn)localObject2);
        azqm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (azqn)localObject2);
        localObject2 = (aobj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(240);
      ...
      else if ((j == 1035) || (j == 1041) || (j == 1042))
      {
        ...
        atzz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localIntent.getStringExtra("push_notice_service_id"), localIntent.getStringExtra("push_notice_content_id"), localIntent.getStringExtra("url"), "0X800923F", "Android系统通知曝光");
        if (QLog.isColorLevel()) {
      ...
      else
      {
        if ((j == 0) && (localIntent.getBooleanExtra("key_reactive_push_tip", false))) {
          azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A1BE", "0X800A1BE", 2, 0, "", "", "", "");
        }
        if ((bhtk.a(j)) && (bhtk.a(str)))
        {
          j = localIntent.getIntExtra("param_notifyid", 0);
          a(275);
  ...
  protected void a()
  {
    ...
    {
      super.a();
      a(new bkzo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new azan(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new ayyt(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new azag(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new ayzg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new azau());
      azap localazap = new azap();
      a(localazap);
      localazap.a(this.jdField_a_of_type_Aohc);
      a(new ayyn());
      a(new azaz());
      a(new ayys());
      a(new ayyf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new ayyk());
      a(new ayym());
      ...
      a(new ayyj());
      a(new azaq());
      a(new azbd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      super.d();
      return;
    }
    finally
  ...
  {
    atzu.a().a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  
  public void a(ToServiceMsg paramToServiceMsg)
  {
    b(paramToServiceMsg, this.jdField_a_of_type_Aohc, aohe.class);
  }
  ...
  protected void a(ToServiceMsg paramToServiceMsg, aohc paramaohc, Class<? extends MSFServlet> paramClass)
  {
    ...
    super.a(paramToServiceMsg, paramaohc, aohe.class);
  }
  ...
  void a(String paramString1, int paramInt1, Notification paramNotification, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        axap localaxap = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localaxap == null) {
          break label305;
        }
        i = localaxap.a();
      ...
      if (bhsc.a(BaseApplicationImpl.getApplication().getApplicationContext())) {
        bhsc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), i, paramNotification);
      }
      if (!TextUtils.isEmpty(paramString1))
      {
