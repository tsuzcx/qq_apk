...
public class mrn
  implements moq
{
  private static volatile mrn jdField_a_of_type_Mrn;
  ...
  public static mrn a()
  {
    if (jdField_a_of_type_Mrn == null) {}
    try
    {
      if (jdField_a_of_type_Mrn == null) {
        jdField_a_of_type_Mrn = new mrn();
      }
      return jdField_a_of_type_Mrn;
    }
    finally {}
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Mrn != null) {
      ...
      {
        if (jdField_a_of_type_Mrn != null) {
          jdField_a_of_type_Mrn.b();
        }
        jdField_a_of_type_Mrn = null;
        bkdp.c("AudioDump", "destroyInstance.", new Throwable("打印调用栈"));
        return;
      }
      finally {}
    }
  ...
  private static void a(byte[] paramArrayOfByte, int paramInt, String paramString)
  {
    ...
    //   32: ldc 43
    //   34: ldc 76
    //   36: invokestatic 80	bkdp:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   39: aload_3
    //   40: ifnull -36 -> 4
    //   43: aload_3
    ...
    //   58: ldc 85
    //   60: aload 4
    //   62: invokestatic 87	bkdp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   65: aload_0
    //   66: ifnull -62 -> 4
    //   69: aload_0
  ...
  private boolean a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        bkdp.a("AudioDump", "registerAudioDataCallback failed. srcType = " + paramInt + ", ret1 = " + j + ", ret2 = " + i);
        paramBoolean = false;
      }
      return paramBoolean;
  ...
  private boolean c()
  {
    ...
    bkdp.d("AudioDump", "init successfully.");
    return true;
  }
  ...
  {
    if (!this.jdField_a_of_type_Boolean) {
      bkdp.a("AudioDump", "startSave failed. !mIsInited.");
    }
    for (;;)
    {
      return false;
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        for (;;)
        {
          ...
          bkdp.d("AudioDump", "startSave successfully. ");
          return true;
          if (a(36))
          {
            a(true);
  ...
  public void b()
  {
    ...
    bkdp.d("AudioDump", "uninit successfully.");
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      try
      {
        ...
        b(0);
        b(2);
        bkdp.d("AudioDump", "stopSave sucessfully.");
        return;
      }
      catch (Exception localException)
      {
        bkdp.a("AudioDump", "stopSave failed.", localException);
        return;
      }
    }
  }
