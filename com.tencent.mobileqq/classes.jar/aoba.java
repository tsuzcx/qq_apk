  ...
  extends BaseAdapter
{
  ...
  public aoba(EditVideoArtFilter paramEditVideoArtFilter, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = new aobb(this);
      localView1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969058, null);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView1.findViewById(2131364905));
      paramViewGroup.jdField_a_of_type_AndroidViewView = localView1.findViewById(2131364904);
    ...
    for (;;)
    {
      ...
      return localView1;
      paramViewGroup = (aobb)paramView.getTag();
    ...
    if (paramView == null)
    {
      ...
      paramView = BitmapManager.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_a_of_type_AndroidContentContext.getResources(), 2130839575, this.b, this.jdField_a_of_type_Int);
