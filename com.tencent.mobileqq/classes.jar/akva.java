...
public final class akva
  implements akux, Handler.Callback, bdko, bdkw, bdlw
{
  private static akva jdField_a_of_type_Akva;
  ...
  private WeakReference<akvc> jdField_a_of_type_JavaLangRefWeakReference;
  private final ArrayList<akvd> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    String str;
    Bundle localBundle;
    if ((this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf.jdField_a_of_type_JavaLangString != null))
    {
      str = this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf.jdField_a_of_type_JavaLangString;
      localBundle = new Bundle();
      localBundle.putString(bdkm.b, "100686848");
      localBundle.putString(bdkm.j, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.strNewSoftwareURL);
      localBundle.putString(bdkm.f, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName());
      localBundle.putInt(bdkm.k, paramInt1);
      if (paramInt1 == 12) {
        localBundle.putBoolean(bdkm.o, true);
      }
      localBundle.putString(bdkm.i, "ANDROIDQQ.QQUPDATE");
      localBundle.putString(bdkm.l, str);
      if (paramInt2 == 0) {
        break label319;
      }
      localBundle.putString(bdkm.m, "_100686848");
    ...
    {
      localBundle.putString(bdkm.jdField_c_of_type_JavaLangString, "6633");
      localBundle.putInt(bdkm.e, this.jdField_a_of_type_Int);
      localBundle.putBoolean(bdkm.g, true);
      localBundle.putBoolean(bdkm.h, true);
      localBundle.putInt(bdkm.n, 1);
      localBundle.putInt(bdkm.A, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bGray);
      bdki.a(BaseActivity.sTopActivity, localBundle, "biz_src_jc_update", this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i);
      return 0;
      str = "新版手Q";
      break;
      label319:
  ...
  {
    if (jdField_a_of_type_Akva == null) {
      jdField_a_of_type_Akva = new akva();
    }
    return jdField_a_of_type_Akva;
  }
  ...
  public static String a()
  {
    ...
    if (localObject != null)
    {
      localObject = ((akva)localObject).jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper;
      str1 = str2;
      if (localObject != null)
      {
        str1 = str2;
  ...
  {
    return bfng.a(paramString, "nt", akuz.a());
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null)) {
        if ((((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType > 0) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bNewSwitch == 1))
        {
          ...
          if (ajuf.a(paramQQAppInterface, ((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iNewTimeStamp)) {
            break label96;
          }
          bool1 = bool2;
        }
    ...
    for (;;)
    {
      bool2 = bool1;
      if (!bool1) {
        bool2 = ((asfa)paramQQAppInterface.getManager(244)).a();
      }
      return bool2;
      bool1 = false;
      break;
  ...
  private void b(int paramInt)
  {
    try
    {
      ajuf localajuf = (ajuf)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getRuntime()).a(4);
      ...
      localajuf.a(str, paramInt, this.jdField_a_of_type_JavaLangString);
      return;
    }
    finally
    {
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localakvc = (akvc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localakvc == null);
    if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null) {
      localakvc.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper, this);
    }
  ...
  private void d(int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((akvd)localIterator.next()).a(paramInt, this);
      }
    }
  }
  ...
  private void i()
  {
    ...
    axqw.b((QQAppInterface)localObject, "CliOper", "", "", "0X800716C", "0X800716C", 0, 0, "", "", "", "");
    int i = 0;
    this.jdField_a_of_type_Boolean = false;
    if (bbev.h(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl)) {
      i = 1;
    }
    ...
    axrl.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", true, 0L, 0L, (HashMap)localObject, "", true);
  }
  ...
  private void k()
  {
    try
    {
      ...
      if (this.d)
      {
        ...
        {
          bdki.b(this.jdField_a_of_type_Akuw);
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo != null) && (this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_c_of_type_Int == 1))
      {
        ...
        ajuf.b(localQQAppInterface, false);
        d(false);
        return;
      }
    } while (this.b);
    b(ajuf.a(localQQAppInterface, false));
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      axrl.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeWritten", bool, 0L, 0L, localHashMap, "", true);
      return;
    }
  }
  ...
  public void a(akvd paramakvd)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramakvd)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramakvd);
      }
      return;
    }
  }
  ...
  {
    String str = ajuf.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
  ...
  public void a(String paramString)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf.jdField_a_of_type_Int);
  }
  ...
  public void a(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf.jdField_a_of_type_Int == paramArrayList.versioncode) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Akuw == null)
        {
          ...
          this.jdField_a_of_type_Akuw = new akuw(paramString2, this);
          bdki.a(this.jdField_a_of_type_Akuw);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf = null;
        c(-1);
      }
    }
  }
  ...
  boolean a()
  {
    return this.jdField_a_of_type_Akvb != null;
  }
  ...
  public boolean a(UpgradeInfo paramUpgradeInfo, akvc paramakvc)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf = ajuf.a(paramUpgradeInfo);
    if ((paramakvc == null) || (paramUpgradeInfo == null)) {
      return false;
    }
    ...
    j();
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakvc);
    if (QLog.isColorLevel()) {
      QLog.d("UpgradeController", 2, "handleUpgradeInfo packageName = " + this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName() + ", bGray = " + paramUpgradeInfo.bGray + ", versioncode = " + this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf.jdField_a_of_type_Int);
    }
    paramUpgradeInfo = new ApkUpdateParam(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName(), paramUpgradeInfo.bGray, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akvf.jdField_a_of_type_Int);
    paramakvc = new ArrayList();
    paramakvc.add(paramUpgradeInfo);
    bdlv.a().b(paramakvc);
    return true;
  }
  ...
  public void b(akvd paramakvd)
  {
    ...
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramakvd)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(paramakvd);
      }
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    ajuf.b(localQQAppInterface, paramBoolean);
    if (paramBoolean)
    {
      g();
      return;
  ...
  public void c()
  {
    ...
    //   18: aload_0
    //   19: getfield 243	akva:b	Z
    //   22: ifeq +21 -> 43
    //   25: aload_0
    //   26: iconst_0
    //   27: putfield 243	akva:b	Z
    //   30: aload_0
    //   31: invokevirtual 760	akva:e	()V
    //   34: aload_0
    //   35: invokespecial 762	akva:h	()V
    //   38: ldc 138
    //   40: invokestatic 764	bdki:a	(Ljava/lang/String;)V
    //   43: aload_0
    //   44: monitorexit
    //   45: return
    //   46: astore_1
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    axrl.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, paramDownloadInfo, "", true);
  }
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      {
        paramDownloadInfo = bdkp.a().a(paramDownloadInfo);
        localObject1 = localObject2;
    ...
    for (;;)
    {
      int k = anet.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
      ...
      for (i = 101;; i = 9527)
      {
        ...
        axrl.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, (HashMap)localObject1, "", true);
        if (bool) {
          break;
        }
