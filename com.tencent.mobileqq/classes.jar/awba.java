  ...
  implements Handler.Callback
{
  ...
  private awbb jdField_a_of_type_Awbb;
  ...
  public awba(awbb paramawbb)
  {
    this.jdField_a_of_type_Awbb = paramawbb;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      return false;
      if ((paramMessage.obj != null) && (this.jdField_a_of_type_Awbb != null))
      {
        this.jdField_a_of_type_Awbb.a(paramMessage.obj);
        continue;
        if (paramMessage.obj != null) {
          l = ((Long)paramMessage.obj).longValue();
        }
        if (this.jdField_a_of_type_Awbb != null)
        {
          this.jdField_a_of_type_Awbb.a(l);
          continue;
          if (paramMessage.obj != null) {
            l = ((Long)paramMessage.obj).longValue();
          }
          if (this.jdField_a_of_type_Awbb != null) {
            this.jdField_a_of_type_Awbb.a(l, paramMessage.arg1, paramMessage.arg2);
          }
        }
      }
    }
