  ...
  implements aimh, View.OnClickListener
{
  ...
  public ails(QQAppInterface paramQQAppInterface, aimj paramaimj, SessionInfo paramSessionInfo, Activity paramActivity)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558616, null);
      paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369812);
      if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null)
      {
        paramVarArgs.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
        paramVarArgs = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369815);
        ...
        paramVarArgs.setContentDescription(this.jdField_a_of_type_JavaLangString + anni.a(2131704824));
        paramVarArgs.setOnClickListener(this);
        paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369814);
        if (AppSetting.c) {
          paramVarArgs.setContentDescription(anni.a(2131704823));
        }
        paramVarArgs.setOnClickListener(this);
      }
    }
    for (;;)
    {
      for (;;)
      {
        ...
        File localFile = new File(ailt.c);
        if ((localFile != null) && (localFile.exists())) {}
        try
        {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources(), bggl.a(ailt.c));
        ...
        catch (Throwable localThrowable)
        {
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130844837));
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        } while (!(this.jdField_a_of_type_Aimj.a() instanceof ails));
        this.jdField_a_of_type_Aimj.a();
        return;
      } while (!this.jdField_a_of_type_Aimj.a(this, new Object[0]));
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800510F", "0X800510F", 0, 0, "" + (paramInt + 1), "", "", "");
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005111", "0X8005111", 0, 0, "", "", "", "");
      continue;
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005110", "0X8005110", 0, 0, "", "", "", "");
    }
  }
}
