...
public class sir
{
  ...
  public static DownloadInfo a(String paramString)
  {
    ...
    try
    {
      ...
      for (int i = TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE;; i = TMAssistantDownloadConst.SHOW_NOTIFICATION_FALSE)
      {
        ...
        localDownloadInfo.m = onh.f(40677);
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    if (a != null)
    {
      ...
      paramContext.setMessage(ajya.a(2131716230));
      paramContext.setNegativeButton(ajya.a(2131716218), new sit()).setPositiveButton(ajya.a(2131716174), new sis());
      paramContext.show();
      return;
    }
