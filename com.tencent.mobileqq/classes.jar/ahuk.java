  ...
  implements ArkViewImplement.InputCallback
{
  ...
  public ahuk(ArkAppView paramArkAppView)
  {
  ...
  public void onFocusChanged(View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      Object localObject2 = localArkAppView.getResources().getDrawable(2130838689);
      Object localObject1 = localArkAppView.getResources().getDrawable(2130838688);
  ...
  public void onSelectChanged(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0) && ((paramInt1 < paramInt3) || (paramInt2 < paramInt4)))
    {
      ...
      int i = j;
      if (j <= 0) {
        i = localArkAppView.getResources().getDrawable(2130838689).getIntrinsicWidth();
      }
    ...
    for (;;)
    {
      ...
      paramInt1 = paramInt2;
      if (paramInt2 <= 0) {
        paramInt1 = localArkAppView.getResources().getDrawable(2130838688).getIntrinsicWidth();
      }
  ...
  public void onShowMenu(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      localbgaz.a(0, amtj.a(2131699798));
      localbgaz.a(1, amtj.a(2131699794));
      localbgaz.a(2, amtj.a(2131699795));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = bfue.a(paramView, paramInt1, paramInt2, paramInt3 + localArkAppView.getResources().getDrawable(2130838688).getIntrinsicHeight(), localbgaz, new ahul(this, paramInt4, (ArkViewImplement.ArkViewInterface)paramView));
      return;
      if (paramInt4 == 1)
      {
        localbgaz.a(0, amtj.a(2131699797));
        localbgaz.a(1, amtj.a(2131699793));
        localbgaz.a(2, amtj.a(2131699796));
      }
      else
      {
        localbgaz.a(0, amtj.a(2131699799));
      }
    }
  }
}
