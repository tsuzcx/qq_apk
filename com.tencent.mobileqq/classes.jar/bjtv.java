  ...
  extends MSFServlet
{
  ...
  {
    bjts.a().a(paramString, paramInt);
  }
  
  private void a(byte[] paramArrayOfByte)
  {
    bjts.a().a(paramArrayOfByte);
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      bjuc.c("VideoChannelServlet", String.format("onReceive cmd=%s", new Object[] { paramIntent }));
    ...
    bjuc.c("VideoChannelServlet", String.format(">>> ip=%s", new Object[] { paramIntent }));
    a(paramIntent, 0);
    return;
    if ("VideoCCSvc.Adaptation".equalsIgnoreCase(paramIntent))
    {
      ...
      bjuc.a("VideoChannelServlet", String.format("onReceive get config fail, resultCode=%s", new Object[] { Integer.valueOf(paramFromServiceMsg.getResultCode()) }));
      return;
    }
    bjuc.b("VideoChannelServlet", "onReceive handle not process cmd.");
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bjuc.c("VideoChannelServlet", String.format("onSend reqType=%s", new Object[] { Integer.valueOf(i) }));
    switch (i)
    {
    default: 
      bjuc.b("VideoChannelServlet", "onSend handle not define reqType.");
      return;
    case 1: 
