  ...
  implements Handler.Callback, View.OnClickListener
{
    ...
    if (tcv.f())
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (tcv.h())
        {
          ...
          tcv.d();
          vel.a("video_edit", "exp_qztip", 0, 0, new String[0]);
        }
      }
    }
    for (;;)
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageButton = ((PressDarkImageButton)a(2131376772));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131376768));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131376769));
  ...
  public void a(int paramInt, @NonNull bkkm parambkkm)
  {
    ...
    veg.d("Q.qqstory.publish.edit.EditSyncQzonePart", "story_sync_qzone : %s", new Object[] { Boolean.valueOf(bool) });
    parambkkm.a.putExtra("story_sync_qzone", Boolean.valueOf(bool));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131376772: 
      if (this.jdField_a_of_type_Bjww.a() != null) {
        this.jdField_a_of_type_Bjww.a().a.add(Integer.valueOf(11));
      }
      bjke.a(paramView, 200L, new bjtw(this));
      if (this.jdField_a_of_type_Boolean) {}
      for (paramView = "1";; paramView = "2")
      {
        vel.a("video_edit", "clk_qzone", 0, 0, new String[] { paramView });
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
        return;
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(0);
    vel.a("video_edit", "clk_qztip", 0, 0, new String[0]);
  }
}
