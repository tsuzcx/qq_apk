  ...
  extends WebViewPlugin
{
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Nad == null)
    {
      ...
      if (localCustomWebView != null) {
        this.jdField_a_of_type_Nad = new nad(localCustomWebView, new befb(this));
      }
    }
  }
  ...
  void a(long paramLong)
  {
    ...
    try
    {
      localObject3 = beiy.a((String)localObject1);
      ...
      this.jdField_a_of_type_Yqz.a(1, str, (String)localObject1, (Bundle)localObject3);
      return;
    }
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (!b(paramString1))
      {
        ...
        j = k;
        label392:
        this.jdField_a_of_type_Yqz.a(paramString1, j, i, str2, str3, str1, paramString2, new befa(this, paramString1, bool2));
        if (QLog.isColorLevel()) {
