...
public class bcpq
{
  ...
  public int a;
  public long a;
  private bcpr jdField_a_of_type_Bcpr;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131713905);
    jdField_b_of_type_JavaLangString = alpo.a(2131713909);
  }
  
  public bcpq(QQAppInterface paramQQAppInterface, String paramString, int paramInt, bcpr parambcpr, List<String> paramList)
  {
    ...
    this.jdField_a_of_type_Bcpr = parambcpr;
  ...
  public static List<TroopMemberInfo> a(QQAppInterface paramQQAppInterface, String paramString, List<String> paramList, boolean paramBoolean)
  {
    ...
    //   63: lstore 7
    //   65: aload_0
    //   66: invokevirtual 163	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   69: invokevirtual 169	awbx:createEntityManager	()Lawbw;
    //   72: astore 13
    //   74: ldc 83
    ...
    //   284: aload 9
    //   286: aconst_null
    //   287: invokevirtual 242	awbw:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   290: astore_1
    //   291: aload_1
    //   292: ifnull +690 -> 982
    //   295: aload_1
    ...
    //   509: invokevirtual 267	aloz:b	(Ljava/lang/String;)Z
    ...
    //   537: invokevirtual 267	aloz:b	(Ljava/lang/String;)Z
    //   540: ifne +85 -> 625
    //   543: aload_1
    //   544: astore_2
    //   545: iload 4
    ...
    //   557: invokestatic 274	bdal:d	(Ljava/lang/String;)Z
    //   560: ifeq +65 -> 625
    //   563: aload_1
    //   564: astore_2
    //   565: iload 4
    ...
    //   600: invokestatic 283	bcgx:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Z
    //   603: ifne +22 -> 625
    //   606: aload_1
    //   607: astore_2
    //   608: iload 4
    ...
    //   681: astore 9
    //   683: aload 13
    //   685: invokevirtual 295	awbw:a	()V
    //   688: aload_1
    //   689: astore_2
    //   690: iload 4
    //   692: istore 5
    ...
    //   821: aload 9
    //   823: aconst_null
    //   824: invokevirtual 242	awbw:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   827: astore_1
    //   828: goto -537 -> 291
    //   831: astore_0
    ...
    //   18	513	12	localaloz	aloz
    //   72	730	13	localawbw	awbw
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, bcpq parambcpq)
  {
    Object localObject = a(paramQQAppInterface, parambcpq.jdField_c_of_type_JavaLangString);
    if (localObject == null) {}
    int j;
    int k;
    do
    {
      ...
      amme localamme = ((TroopManager)paramQQAppInterface.getManager(52)).a();
      int n = (int)(localamme.jdField_a_of_type_Float * i);
      k = (int)(localamme.jdField_b_of_type_Float * i);
      if ((m >= n) && (j >= k) && (j > 0)) {}
      for (boolean bool = true;; bool = false)
      {
        QLog.d("troopBatchAddFrd.Scene", 1, String.format("doInsertGrayTip_V1 check nComFrdCnt_limit_nNonFrdCnt_limit_check=%d_%d_%d_%d_%b_%s", new Object[] { Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(j), Integer.valueOf(k), Boolean.valueOf(bool), parambcpq.jdField_c_of_type_JavaLangString }));
        if (!bool) {
          break;
        }
        ammc.a(paramQQAppInterface, parambcpq.jdField_c_of_type_JavaLangString, m, j, paramTroopInfo, (String)localObject);
        return;
      }
      if ((m < n) && (i != 0))
      {
        ...
        azmj.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "commonFrd", 0, 0, parambcpq.jdField_c_of_type_JavaLangString, "", paramTroopInfo.substring(0, m - 1), "");
      }
    } while ((j >= k) || (i == 0));
    paramTroopInfo = String.format(Locale.getDefault(), "%.2f", new Object[] { Float.valueOf(j / i) });
    int i = paramTroopInfo.length();
    azmj.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "nonFrd", 0, 0, parambcpq.jdField_c_of_type_JavaLangString, "", paramTroopInfo.substring(0, i - 1), "");
  }
  ...
  public static Object[] a(com.tencent.common.app.AppInterface paramAppInterface, String paramString)
  {
    ...
    //   75: checkcast 475	bckx
    //   78: astore 21
    //   80: invokestatic 159	android/os/SystemClock:elapsedRealtime	()J
    //   83: lstore 9
    //   85: aload_0
    //   86: invokevirtual 476	com/tencent/common/app/AppInterface:getEntityManagerFactory	()Lawbx;
    //   89: invokevirtual 169	awbx:createEntityManager	()Lawbw;
    //   92: astore 18
    //   94: aload 18
    //   96: iconst_1
    //   97: ldc 83
    ...
    //   144: ldc 150
    //   146: aconst_null
    //   147: invokevirtual 242	awbw:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   150: astore 12
    //   152: aload 12
    ...
    //   316: invokestatic 274	bdal:d	(Ljava/lang/String;)Z
    //   319: ifeq +70 -> 389
    //   322: iload_3
    //   323: istore 7
    //   325: iload 5
    ...
    //   334: invokestatic 478	bdal:c	(Ljava/lang/String;)Z
    //   337: ifne +52 -> 389
    //   340: iload_3
    //   341: istore 7
    //   343: iload 5
    ...
    //   379: invokevirtual 479	bckx:b	(Ljava/lang/String;)Z
    //   382: istore 11
    //   384: iload 11
    //   386: ifeq +266 -> 652
    //   389: aload_1
    ...
    //   446: astore 17
    //   448: aload 18
    //   450: invokevirtual 295	awbw:a	()V
    //   453: aload_0
    //   454: astore 17
    ...
    //   666: invokevirtual 267	aloz:b	(Ljava/lang/String;)Z
    //   669: ifeq +26 -> 695
    //   672: aload_1
    //   673: astore 13
    //   675: aload_0
  ...
  public static void b(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, bcpq parambcpq)
  {
    int j = parambcpq.jdField_e_of_type_Int;
    int i = parambcpq.jdField_d_of_type_Int;
    Object localObject1 = parambcpq.jdField_e_of_type_JavaLangString;
    ...
    QLog.i("troopBatchAddFrd.Scene", 1, String.format("doInsertGrayTip_V2 troopUin_type_nonFrdCnt_cmnFrdCnt=%s_%d_%d_%d", new Object[] { paramTroopInfo.troopuin, Integer.valueOf(parambcpq.jdField_a_of_type_Int), Integer.valueOf(j), Integer.valueOf(i) }));
    ...
    label594:
    label617:
    for (localObject1 = (String)localObject1 + alpo.a(2131713906);; localObject1 = (String)localObject1 + alpo.a(2131713908))
    {
      localObject2 = alpo.a(2131713907);
      j = ((String)localObject1).indexOf((String)localObject2);
      int k = ((String)localObject2).length();
      localObject2 = new aslp(paramTroopInfo.troopuin, paramTroopInfo.troopuin, (String)localObject1, 1, -5020, 135178, l2);
      ((aslp)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
      ...
      ((aslp)localObject2).a(j, j + k, (Bundle)localObject1);
      ((aslp)localObject2).jdField_d_of_type_JavaLangString = (a(parambcpq.jdField_a_of_type_Int) + "-" + parambcpq.jdField_d_of_type_JavaLangString);
      localObject1 = new MessageForUniteGrayTip();
      ((MessageForUniteGrayTip)localObject1).initGrayTipMsg(paramQQAppInterface, (aslp)localObject2);
      ...
      localObject1 = ((alzf)paramQQAppInterface.a(20)).a();
      ((TroopBatchAddFriendMgr)localObject1).b(parambcpq.jdField_d_of_type_JavaLangString, parambcpq.jdField_c_of_type_JavaLangString);
      if (parambcpq.jdField_a_of_type_Int == 4) {
        ((TroopBatchAddFriendMgr)localObject1).b(parambcpq.jdField_c_of_type_JavaLangString);
      }
      localObject1 = "1";
      if (i > 0) {
        localObject1 = "0";
      }
      bclo.c(paramQQAppInterface, paramTroopInfo.troopuin, l2);
      azmj.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", a(true, parambcpq.jdField_a_of_type_Int), 0, 0, paramTroopInfo.troopuin, Integer.toString(parambcpq.f), Integer.toString(paramTroopInfo.wMemberNum), (String)localObject1);
      return;
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    amme localamme = ((TroopManager)localObject).a();
    if (localamme.jdField_a_of_type_Int != 1) {
      return false;
    }
    ...
    if (!localamme.a((TroopInfo)localObject, amme.jdField_a_of_type_ArrayOfLong)) {
      return false;
    }
    if (((TroopInfo)localObject).dwCmdUinJoinTime < localamme.jdField_a_of_type_Long)
    {
    ...
    long l1 = localamme.jdField_c_of_type_Int * 86400;
    long l2 = NetConnInfoCenter.getServerTime();
    long l3 = l2 - ((TroopInfo)localObject).dwCmdUinJoinTime;
    if ((l3 > l1) || (l3 < 0L))
    {
      azmj.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "joinDate", 0, 0, paramString, "", String.valueOf(l3 / 86400L), "");
      return false;
    }
    if (((TroopInfo)localObject).wMemberNum > localamme.jdField_b_of_type_Int)
    {
      azmj.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "mberNum", 0, 0, paramString, "", String.valueOf(((TroopInfo)localObject).wMemberNum), "");
      return false;
    }
    if (((TroopInfo)localObject).wClickBAFTipCount != 0) {
      return false;
    }
    if (((TroopInfo)localObject).wInsertBAFTipCount >= localamme.jdField_d_of_type_Int) {
      return false;
    }
    ...
    return ammc.a(((TroopInfo)localObject).dwLastInsertBAFTipTime, l2);
  }
  ...
  private boolean c()
  {
    ...
    int n = (int)(((amme)localObject).jdField_a_of_type_Float * i);
    int k = (int)(((amme)localObject).jdField_b_of_type_Float * i);
    if ((m >= n) && (j >= k) && (j > 0)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((m < n) && (i != 0))
    {
      ...
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "commonFrd", 0, 0, this.jdField_c_of_type_JavaLangString, "", ((String)localObject).substring(0, m - 1), "");
    }
    if ((j < k) && (i != 0))
    {
      localObject = String.format(Locale.getDefault(), "%.2f", new Object[] { Float.valueOf(j / i) });
      i = ((String)localObject).length();
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "nonFrd", 0, 0, this.jdField_c_of_type_JavaLangString, "", ((String)localObject).substring(0, i - 1), "");
    }
    return false;
  }
  ...
  public static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    TroopBatchAddFriendMgr localTroopBatchAddFriendMgr = ((alzf)paramQQAppInterface.a(20)).a();
    ...
    if (!((amme)localObject).a(localTroopInfo, ((amme)localObject).jdField_b_of_type_ArrayOfLong))
    {
    ...
    if (localTroopInfo.wMemberNum > ((amme)localObject).s)
    {
      azmj.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "mberNum", 0, 0, localTroopInfo.troopuin, Integer.toString(a(paramInt)), Integer.toString(localTroopInfo.wMemberNum), "");
      localStringBuilder.append(" ").append("err:").append("member count").append(localTroopInfo.wMemberNum).append(">").append(((amme)localObject).s);
      if (QLog.isColorLevel()) {
        QLog.i("troopBatchAddFrd.Scene", 2, localStringBuilder.toString());
      }
      return false;
    ...
    {
      azmj.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "grpNum", 0, 0, localTroopInfo.troopuin, Integer.toString(a(paramInt)), Integer.toString(localTroopInfo.wMemberNum), "");
  ...
  public int a()
  {
    ...
    if (i == 0)
    {
      ...
      ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(localTroopInfo.troopuin, localTroopInfo.troopcode, this.jdField_a_of_type_Long, this.jdField_a_of_type_Int);
      return 0;
    }
    if (i != 1)
    {
  ...
  List<TroopMemberInfo> a()
  {
    ...
    int k = ((amme)localObject2).a(this.jdField_a_of_type_Int);
    int j;
    int i;
    ...
    for (;;)
    {
      ...
      if (i < k)
      {
        ...
        {
          azmj.b((QQAppInterface)localObject2, "dc00899", "Grp_addFrd", "", "nonGreyTip", "actvie-res", 0, 0, (String)localObject3, str, Integer.toString(i), "");
          return null;
        }
        ...
        for (;;)
        {
          ...
          {
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "discus-res", 0, 0, this.jdField_c_of_type_JavaLangString, Integer.toString(i), Integer.toString(((List)localObject2).size()), "");
            return localObject1;
            localObject1 = new ArrayList();
            ...
            if (((List)localObject1).size() == 0)
            {
              ...
              {
                azmj.b((QQAppInterface)localObject3, "dc00899", "Grp_addFrd", "", "nonGreyTip", "new_res", 0, 0, str, Integer.toString(i), "", "");
                return localObject1;
              }
              localObject1 = new ArrayList();
              localObject2 = a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilList, false);
              ...
              if (((List)localObject1).size() == 0)
              {
                ...
                for (i = 0;; i = ((TroopMemberInfo)((List)localObject2).get(0)).commonFrdCnt)
                {
                  azmj.b((QQAppInterface)localObject3, "dc00899", "Grp_addFrd", "", "nonGreyTip", "@_res", 0, 0, str, Integer.toString(i), "", "");
                  return localObject1;
                }
              }
              return localObject1;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Bcpr != null) {
      this.jdField_a_of_type_Bcpr.b(this);
    }
  }
  ...
  void a(List<TroopMemberInfo> paramList)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "UinNum_total", 0, 0, this.jdField_c_of_type_JavaLangString, Integer.toString(a(this.jdField_a_of_type_Int)), Integer.toString(i), "");
        return;
      }
    }
  }
  ...
  public int b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      switch (((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.jdField_c_of_type_JavaLangString, l, this.jdField_a_of_type_Int))
      {
      default: 
        i = -1;
      case 1: 
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bcpr != null) {
      this.jdField_a_of_type_Bcpr.a(this);
    }
  }
  ...
  public int c()
  {
    ...
    String str;
    int k;
    if ((l == 0L) || (System.currentTimeMillis() - l > ((amme)localObject).t * 60 * 60 * 1000))
    {
      bool = true;
      ...
      {
        localObject = ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a();
        str = this.jdField_c_of_type_JavaLangString;
  ...
  public int d()
  {
    ...
    String str;
    int k;
    if ((l == 0L) || (System.currentTimeMillis() - l > ((amme)localObject).u * 60 * 60 * 1000))
    {
      bool = true;
