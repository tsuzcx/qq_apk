  ...
  extends aktq
{
  ...
  protected akvy(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  protected void d()
  {
    if ("FromFastImage".equals(this.jdField_a_of_type_Aktn.from))
    {
      bdll.b(null, "CliOper", "", "", "0X8004D93", "0X8004D93", 0, 0, "", "", "", "");
      akrx.d();
    }
    if ("FromCamera".equals(this.jdField_a_of_type_Aktn.from)) {
      akrx.b();
    }
    super.d();
  ...
  public void initData(Intent paramIntent)
  {
    ...
    label236:
    for (this.jdField_a_of_type_Aktn.f = 1037;; this.jdField_a_of_type_Aktn.f = 1008)
    {
      ...
      {
        ((PresendPicMgr)localObject).a(str, this.jdField_a_of_type_Aktn.f);
        if (QLog.isColorLevel()) {
          QLog.d("PhotoPreviewActivity", 2, "  initData , presendMgr = " + localObject + ",picpath = " + str + ",from = " + this.jdField_a_of_type_Aktn.from + ",mBusiType = " + this.jdField_a_of_type_Aktn.f);
        }
      }
  ...
  {
    super.initUI();
    ((NewPhotoPreviewActivity)this.mActivity).backToPhotoListBtn.setText(2131694335);
