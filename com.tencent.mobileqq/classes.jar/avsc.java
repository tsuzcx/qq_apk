...
public class avsc
{
  public static avsd a(String paramString)
  {
    ...
    localavsd.jdField_a_of_type_Int = paramString.getInt("type");
    localavsd.jdField_a_of_type_JavaLangString = paramString.getString("appid");
    localavsd.jdField_b_of_type_JavaLangString = paramString.optString("pageName");
    localavsd.jdField_b_of_type_Int = paramString.optInt("from");
    localavsd.jdField_a_of_type_OrgJsonJSONObject = paramString.optJSONObject("param");
    return localavsd;
  }
  
  public static boolean a(Activity paramActivity, avsd paramavsd, Bundle paramBundle)
  {
    if (paramavsd == null) {}
    while ((paramavsd.jdField_a_of_type_Int == 4) || (paramavsd.jdField_a_of_type_Int != 3)) {
      return false;
    }
    avrt.a(paramActivity, paramavsd.jdField_a_of_type_JavaLangString, paramavsd.jdField_a_of_type_Int, null);
    return true;
  }
  ...
  public static boolean a(BaseActivity paramBaseActivity, String paramString, MessageRecord paramMessageRecord)
  {
    ...
    else
    {
      ...
      if ((paramString != null) && (bool) && ((paramMessageRecord instanceof MessageForGrayTips)) && (paramString.jdField_a_of_type_Int == 4) && (paramString.jdField_a_of_type_JavaLangString.equals("101474665")))
      {
        ...
        bcef.b(localQQAppInterface, "dc00899", "Grp_idol", "", "idol_follow", "follow_suc_clk", 0, 0, paramMessageRecord.frienduin, "", "", "");
      }
    }
    for (;;)
    {
      ...
      if (paramString.jdField_b_of_type_Int == 2) {
        bftc.a("Grp_idol", "Grp_AIO", "clk_renwu", 0, 0, new String[] { paramMessageRecord.frienduin });
      }
    }
  }
}
