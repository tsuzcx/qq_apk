  ...
  implements vnq
{
  ...
  public ahua(PublishVideoEntry paramPublishVideoEntry, String paramString1, String paramString2, ahtw paramahtw)
  {
  ...
  {
    this.jdField_a_of_type_Ahtw.a(-12);
  ...
  public void onFinish(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      this.jdField_a_of_type_Ahtw.b(this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry, this.b);
    }
  }
  ...
  {
    vlm.b(BaseApplication.getContext(), new File(this.b));
    bace.d(this.jdField_a_of_type_JavaLangString);
    ahtt.a(System.currentTimeMillis() - this.jdField_a_of_type_Long, 3);
  }
}
