...
public class aufg
  extends QIPCModule
{
  private static volatile aufg a;
  
  private aufg(String paramString)
  {
    super(paramString);
  }
  ...
  public static aufg a()
  {
    ...
    {
      if (a == null) {
        a = new aufg("FlutterMainQIPCModule");
      }
      return a;
    }
    finally {}
  ...
  {
    auez.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), new aufh(this, paramString1, paramString2));
  }
