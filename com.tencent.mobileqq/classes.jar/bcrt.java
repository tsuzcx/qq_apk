...
public class bcrt
{
  ...
  public static MessageForVIPDonate a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        MessageForVIPDonate localMessageForVIPDonate = (MessageForVIPDonate)bcry.a(-2047);
        ...
        if (localJSONObject.has("title"))
        {
          ...
          localMessageForVIPDonate.msgData = apdm.a(localVIPDonateMsg);
    ...
    for (;;)
    {
      ...
      if (paramList != null)
      {
        ...
        if (paramList.str.has())
        {
          ...
          if (paramBoolean)
          {
            str = bcsa.a(paramList, false);
            localObject = paramList;
            if (str.length() > 0)
            {
              localObject = (MessageForText)bcry.a(-1000);
  ...
  private void a(List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder, MessageForText.AtTroopMemberInfo paramAtTroopMemberInfo, List<MessageRecord> paramList1, bcrv parambcrv, bfoy parambfoy)
  {
    paramList = a(paramList, paramStringBuilder);
    if (paramList != null) {
      paramStringBuilder = (MessageForReplyText)bcry.a(-1049);
    }
    try
    {
      ...
      if (paramList.getSourceMsg() != null)
      {
        ...
        if ((paramStringBuilder.getSourceMessage() != null) && (aunj.a(paramStringBuilder.getSourceMessage())))
        {
          localObject = paramStringBuilder.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
          ChatMessage localChatMessage = aunj.a((ChatMessage)paramStringBuilder.getSourceMessage());
          auoo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, paramStringBuilder.getSourceMessage());
          if ((!TextUtils.isEmpty((CharSequence)localObject)) && (localChatMessage != null))
          {
            ...
            if ((i == 1) || (i == 2))
            {
              ...
              aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)paramStringBuilder.getSourceMessage());
            }
          }
        }
      }
      paramStringBuilder.saveExtInfoToExtStr("sens_msg_source_msg_info", bhml.a(apdm.a(paramList)));
    }
    ...
    if (TextUtils.isEmpty(paramStringBuilder.mSourceMsgInfo.mAnonymousNickName))
    {
      ...
      if (paramAtTroopMemberInfo != null)
      {
        ...
        localObject = (MessageForReplyText)bcry.a(-1049);
        ...
        if ((!TextUtils.isEmpty(((MessageForReplyText)localObject).msg)) && (((MessageForReplyText)localObject).msg.length() >= paramAtTroopMemberInfo.textLen + paramAtTroopMemberInfo.startPos))
        {
          ...
          if ((paramAtTroopMemberInfo.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (parambcrv.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
            parambfoy.jdField_a_of_type_Bfoz.b(24, -1L);
          }
        }
        paramList1.remove(0);
  ...
  private void a(List<MessageRecord> paramList1, msg_comm.Msg paramMsg, List<MessageRecord> paramList2, byte[] paramArrayOfByte, bfoy parambfoy, MessageForText.AtTroopMemberInfo paramAtTroopMemberInfo)
  {
        ...
        if (i != 0)
        {
          ...
          for (;;)
          {
            ...
            if ((localMessageRecord.msgtype != -1000) && (localMessageRecord.msgtype != -1049) && (localMessageRecord.msgtype != -2000))
            {
              ...
              {
                paramList2.add(bcrw.a(paramMsg, paramList1, parambfoy));
                paramMsg.clear();
          ...
          if (paramMsg.size() > 0)
          {
            ...
            paramList1 = bcrw.a(paramMsg, paramArrayOfByte, parambfoy);
        ...
        for (;;)
        {
          ...
          while (paramList1.hasNext())
          {
            ...
            if (((paramMsg instanceof MessageForText)) && (j == 0)) {
              paramMsg.saveExtInfoToExtStr("sens_msg_ctrl_info", bhml.a(paramArrayOfByte));
            }
  ...
  {
    BaseApplication.getContext().getString(2131694120);
    boolean bool;
          ...
          for (int k = paramNotOnlineImage.uint32_file_id.get();; k = 0)
          {
            ...
            for (;;)
            {
                ...
                if (paramNotOnlineImage.pic_md5.has())
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    if (localObject2.length > 0) {
                      paramMsg = bhml.a((byte[])localObject2);
                    }
                  }
                }
                Object localObject2 = beyo.a(paramElem, j, 1, false, paramElem, paramMsg, "picplatform", str1, str2, str3, str4, i5, 0);
              ...
              for (;;)
              {
                ...
                paramElem = (MessageForPic)bcry.a(-2000);
                if (bool) {
                  anxg.a(paramElem, false);
                }
                ...
                bdmc.a(BaseApplication.getContext()).a(paramNotOnlineImage, "actMessageEvent", false, 0L, 0L, paramElem, "");
                return;
                label1192:
                j = n;
                k = m;
  ...
  private void a(im_msg_body.GeneralFlags paramGeneralFlags, List<MessageRecord> paramList)
  {
    ...
    try
    {
      if (paramList.size() > 0)
      {
        ...
        ((antk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a(arrayOfByte);
      }
      return;
    }
  ...
  private void a(im_msg_body.GeneralFlags paramGeneralFlags, boolean paramBoolean, String paramString, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    ...
    if ((!TextUtils.isEmpty(localMessageForArkApp.ark_app_message.appName)) && (!TextUtils.isEmpty(localMessageForArkApp.ark_app_message.appView)))
    {
      ...
      paramBoolean = true;
      if (!paramBoolean) {
        f(paramList, paramList1, paramStringBuilder, paramMsg, parambfoy);
      }
      return;
    }
  }
  ...
  public bcru a(List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder, long paramLong, bfoy parambfoy)
  {
    ...
    bcrv localbcrv = new bcrv();
    Object localObject = localbcrv.jdField_a_of_type_JavaUtilArrayList;
    StringBuilder localStringBuilder = a(null, paramList, paramStringBuilder, paramLong, parambfoy, localbcrv, null);
    ...
    for (paramStringBuilder = paramList;; paramStringBuilder = null)
    {
      ...
      for (localbcru.jdField_a_of_type_JavaLangString += ((String)localObject).substring(i + 1);; localbcru.jdField_a_of_type_JavaLangString += ((String)localObject).substring(i))
      {
        ...
        if ((paramStringBuilder.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (localbcrv.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
          parambfoy.jdField_a_of_type_Bfoz.b(24, -1L);
        }
        return localbcru;
      }
    ...
    if (localMarketFace != null)
    {
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        try
        {
          for (;;)
          {
            paramStringBuilder.msgData = apdm.a(paramElem);
      ...
      if (localResvAttr.uint32_has_ip_product.get() == 1)
      {
        ...
        paramStringBuilder = (MessageForMarketFace)bcry.a(-2007);
        ...
        if ((paramElem.mobileparam != null) && (paramElem.mobileparam.length > 0)) {
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "MbJieshou", "MbXiaoxi", 0, 0, "", "", "", "");
        }
      }
    }
    label593:
  ...
  public MessageForDeliverGiftTips a(String paramString1, String paramString2, im_msg_body.DeliverGiftMsg paramDeliverGiftMsg, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    {
      paramStringBuilder = (MessageForDeliverGiftTips)bcry.a(-2035);
    ...
    for (;;)
    {
      ...
      paramString1 = (bgul)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(81);
      if (paramString1 != null)
      {
        ...
        if (paramStringBuilder.grayTipsEntity.highlightNum != 0) {
          bgul.a(paramStringBuilder, paramStringBuilder.grayTipsEntity.highlightItems);
        }
        if ((paramStringBuilder instanceof MessageForTroopGift)) {
      ...
      {
        paramDeliverGiftMsg = Pattern.compile(anzj.a(2131705539));
      ...
      paramStringBuilder = (MessageForTroopGift)bcry.a(-2038);
    ...
    if (j < k)
    {
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Text)localObject).str.has()) {
          localStringBuilder1.append(bcsa.a(((im_msg_body.Text)localObject).str.get().toStringUtf8(), false));
        }
        continue;
        int m;
        if (((im_msg_body.Elem)localObject).face.has())
        {
          ...
          {
            m = asle.b(((im_msg_body.Face)((im_msg_body.Elem)localObject).face.get()).index.get());
            if (m >= 0)
            {
  ...
  public String a(im_msg_body.CommonElem paramCommonElem)
  {
    ...
    try
    {
      ...
      int i = asle.b(((hummer_commelem.MsgElemInfo_servtype33)localObject).uint32_index.get());
      localObject = str;
      if (i >= 0) {
        localObject = asle.b(i);
      }
      return localObject;
    }
  ...
  public StringBuilder a(StringBuilder paramStringBuilder1, List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder2, long paramLong, bfoy parambfoy, bcrv parambcrv, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    bcrv localbcrv = parambcrv;
    if (parambcrv == null) {
      localbcrv = new bcrv();
    }
    Object localObject2 = null;
    Object localObject1 = localbcrv.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo;
    parambcrv = null;
    ...
    if (((im_msg_body.Text)localObject1).str.has()) {
      localStringBuilder.append(bcsa.a(((im_msg_body.Text)localObject1).str.get().toStringUtf8(), false));
    }
    label219:
    int k;
    int j;
    ...
    if (((im_msg_body.Text)localObject1).attr_6_buf.has())
    {
      ...
      if (localObject1 != null)
      {
        ...
        if ((parambfoy != null) && ((parambfoy.jdField_a_of_type_Int == 3000) || (parambfoy.jdField_a_of_type_Int == 1)) && (paramArrayList != null) && (localObject2 != null) && (localObject2.length != 0))
        {
          n = bhvd.a((byte[])localObject2, 0);
          k = 2;
          j = 0;
          if ((j < n) && (k < 2048))
          {
        ...
        if ((parambfoy == null) || ((!parambfoy.jdField_a_of_type_Bfoz.a(24, paramLong)) && (!parambfoy.jdField_a_of_type_Bfoz.a(13, paramLong)) && (paramList != null)) || (localObject2 == null) || (localObject2.length == 0)) {
          break label1406;
        }
        int n = bhvd.a((byte[])localObject2, 0);
        k = 2;
        j = 0;
    ...
    for (;;)
    {
      localObject1 = parambcrv;
      parambcrv = paramList;
      paramList = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      label452:
      localObject1 = parambcrv;
      parambcrv = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      break;
      localObject2 = null;
      break label219;
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject1).face.has())
        {
          ...
          j = asle.b(((im_msg_body.Face)((im_msg_body.Elem)localObject1).face.get()).index.get());
          if (j >= 0)
          {
          ...
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = parambcrv;
          parambcrv = (bcrv)localObject1;
          break label452;
        }
        ...
        if (((im_msg_body.Elem)localObject1).online_image.has())
        {
          ...
          localStringBuilder.append(BaseApplication.getContext().getString(2131694120));
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = parambcrv;
          parambcrv = (bcrv)localObject1;
          break label452;
        ...
        break label452;
        label1268:
        localbcrv.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramList;
        paramList = localbcrv.jdField_a_of_type_JavaUtilArrayList;
        if ((paramList != null) && ((paramStringBuilder1 != null) || (parambcrv != null)))
        {
          if (!paramList.isEmpty()) {
            break label1316;
          }
          paramList.add(paramStringBuilder1);
          paramList.add(parambcrv);
        }
        label1316:
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = bdow.a(((im_msg_body.MarketTrans)localObject1).bytes_xml.get().toByteArray(), i);
      if (localObject1 == null)
      {
        if (QLog.isColorLevel()) {
      ...
      paramList = (MessageForStructing)bcry.a(-2011);
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
        ...
        do
        {
          do
          {
            ...
            default: 
              return;
            case 3: 
              paramList = BaseApplication.getContext().getString(2131694120);
              paramStringBuilder = (MessageForText)bcry.a(-1000);
          ...
          i = bhvd.a((byte[])localObject3, 1);
          j = localObject3[3];
          localObject2 = new byte[i - 1];
          bhvd.a((byte[])localObject2, 0, (byte[])localObject3, 4, i - 1);
      ...
      paramMsg = (MessageForPubAccount)bcry.a(-3006);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            paramMsg.msgData = txr.a(paramStringBuilder);
          ...
          for (;;)
          {
            ...
            int i1 = bhvd.a(localStringBuilder, i + 1);
            j = k - (i1 + 3);
            k = i1 + 3 + i;
            if (n != 1)
            {
            ...
            else
            {
              ...
              bhvd.a(paramList, 0, localStringBuilder, i + 3, i1);
          ...
          try
          {
            for (;;)
            {
              ...
              paramStringBuilder.dspFileName = aunj.a(paramStringBuilder.dspFileName);
              paramStringBuilder.dspFileSize = new String(((ByteStringMicro)paramList.rpt_bytes_abstact.get(0)).toByteArray());
              bgrh.a(paramMsg.msg_head.group_info.group_code.get()).a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramStringBuilder.fileUrl, paramStringBuilder);
              ...
              if (paramList != null)
              {
                ...
                label1380:
                localObject2 = (MessageForTroopFile)bcry.a(-2017);
                ((MessageForTroopFile)localObject2).msgtype = -2017;
                ((MessageForTroopFile)localObject2).msg = anzj.a(2131705542);
                try
                {
                  ((MessageForTroopFile)localObject2).msgData = apdm.a(paramStringBuilder);
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    ...
    for (;;)
    {
      ...
      for (int i = ((im_msg_body.CommonElem)localObject1).uint32_business_type.get();; i = 0)
      {
        ...
        localObject1 = null;
        localObject2 = bdqf.a((byte[])localObject2, -1);
        if (localObject2 != null)
        {
          ...
          if (i > 0)
          {
            ...
            localObject3 = (MessageForArkFlashChat)bcry.a(-5013);
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy, boolean paramBoolean)
  {
    int i = 0;
    im_msg_body.Elem localElem = null;
    ...
    if (localIterator.hasNext())
    {
      ...
      if (localElem.market_face.has())
      {
        ...
        {
          b(localArrayList, paramList1, paramStringBuilder, paramMsg, parambfoy, paramBoolean);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          if ((i != 0) && (localElem.text.has()) && (paramList != null))
          {
            ...
            try
            {
              ((MessageRecord)paramList1.get(paramList1.size() - 1)).msgData = apdm.a(paramList);
              if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((paramStringBuilder.uint32_sys_head_id.has()) && (paramStringBuilder.uint32_head_flag.has()))
          {
            ...
            paramList = (apdc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(199);
  ...
  public void a(im_msg_body.Elem paramElem, im_msg_body.CustomFace paramCustomFace, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bfoy parambfoy)
  {
    if (paramElem != null) {}
    for (boolean bool1 = paramElem.hc_flash_pic.has();; bool1 = false)
    {
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        if (paramBoolean)
        {
          ...
          bdmc.a(BaseApplication.getContext()).a(paramCustomFace, "actMessageEvent", false, 0L, 0L, paramElem, "");
          if (QLog.isColorLevel()) {
        ...
        localObject2 = bhml.a((byte[])localObject2);
        bhml.a((byte[])localObject1);
        bhml.a((byte[])localObject3);
        int i3 = paramCustomFace.uint32_origin.get();
        localObject3 = beya.a(paramElem, 0L, 1, false, paramElem, (String)localObject2, "picplatform", str3, str4, str1, str2, i3, 0);
        localObject1 = new RichMsg.PicRec();
        ((RichMsg.PicRec)localObject1).localPath.set(paramElem);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              {
                paramElem = (MessageForPic)bcry.a(-5015);
                ...
                paramElem.istroop = 1;
                paramCustomFace = (bgot)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
                if (paramCustomFace != null) {
                  paramCustomFace.a((bgph)paramElem, false);
                }
                i = 1;
                if (i == 0)
                {
                ...
                if (bool1) {
                  anzr.a(paramElem, false);
                }
                if (bool2) {
                  anxg.a(paramElem, false);
                }
                if (parambfoy != null) {
                  paramElem.istroop = parambfoy.jdField_a_of_type_Int;
                }
                paramElem.msgData = ((RichMsg.PicRec)localObject1).toByteArray();
                paramElem.parse();
                paramList.add(paramElem);
  ...
  public boolean a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bfoy parambfoy)
  {
    Object localObject2;
    String str1;
    Object localObject1;
    ...
    if (paramBoolean) {
      ...
      {
        parambfoy = paramMsg.msg_head.from_uin.get() + "";
        localObject2 = null;
        str1 = null;
        localObject1 = null;
        Iterator localIterator = paramList.iterator();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        localObject1 = localObject2;
        break label81;
        parambfoy = paramMsg.msg_head.to_uin.get() + "";
        break;
        if (parambfoy != null) {}
        for (parambfoy = parambfoy.jdField_a_of_type_JavaLangString;; parambfoy = paramMsg.msg_head.to_uin.get() + "") {
          break;
        }
        label306:
        if (paramList == null) {
        ...
        try
        {
          ...
          paramList.frienduin = parambfoy;
          paramList.isFromNearby = true;
          paramList1 = (bgot)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
          if (paramList1 != null) {
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      ...
      localMessageForIncompatibleGrayTips = (MessageForIncompatibleGrayTips)bcry.a(-5002);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    Object localObject1 = null;
    Object localObject2 = paramList.iterator();
    Object localObject3;
    ...
    if (((hummer_commelem.MsgElemInfo_servtype19)localObject2).bytes_data.has())
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (i > 0)
        {
          ...
          localObject3 = (MessageForArkBabyqReply)bcry.a(-5016);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if (localElem.custom_face.has())
        {
          ...
          {
            localMessageForText = (MessageForText)bcry.a(-1000);
          ...
          a(localElem, null, localArrayList, paramStringBuilder, paramMsg, paramBoolean, parambfoy);
        }
        ...
        label299:
        if (adie.a(localElem).booleanValue())
        {
          if (i != 0)
          {
            i = 0;
    ...
    for (;;)
    {
      ...
      localObject1 = a((StringBuilder)localObject1, (List)localObject3, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambfoy, localbcrv, (ArrayList)localObject2);
      break;
      if (localElem.general_flags.has())
      {
        ...
        if (((StringBuilder)localObject1).length() > 0)
        {
          ...
          if (parambfoy != null) {
            bgme.a(parambfoy.jdField_a_of_type_Int, (ArrayList)localObject2, (ChatMessage)localObject3);
          }
          localArrayList.add(localObject3);
          ((StringBuilder)localObject1).delete(0, ((StringBuilder)localObject1).length());
        }
        localObject2 = localbcrv.jdField_a_of_type_JavaUtilArrayList;
        ...
        for (;;)
        {
          a(paramList, paramStringBuilder, (MessageForText.AtTroopMemberInfo)localObject2, localArrayList, localbcrv, parambfoy);
          a(localGeneralFlags, localArrayList);
          b(localGeneralFlags, localArrayList);
          a(localArrayList, paramMsg, paramList1, (byte[])localObject1, parambfoy, (MessageForText.AtTroopMemberInfo)localObject2);
          return;
          localObject3 = null;
          localObject2 = localObject1;
          localObject1 = localObject3;
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)localElem.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForQQStoryComment)bcry.a(-2052);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (!ArkUtil.isDeviceSupportArkMsg())
        {
          ...
          paramList = (MessageForText)bcry.a(-1000);
          paramList.msgtype = -1000;
          paramList.msg = BaseApplication.getContext().getString(2131693254);
          paramList1.add(paramList);
          return;
        }
        if (ArkAppCenter.b())
        ...
        for (;;)
        {
          ...
          {
            localObject1 = bdqf.a((byte[])localObject1, -1);
            if ((localObject1 != null) && (localObject1.length > 0)) {}
            for (;;)
            {
              try
            ...
            a(localGeneralFlags, false, localObject2, paramList, paramList1, paramStringBuilder, paramMsg, parambfoy);
            return;
          }
          Object localObject2 = null;
        }
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    Object localObject2 = null;
    Object localObject3 = paramList.iterator();
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject3 = bdqf.a((byte[])localObject3, -1);
        if (localObject3 != null)
        {
          ...
          if (i > 0)
          {
            ...
            localObject3 = (MessageForArkApp)bcry.a(-5017);
    ...
    for (;;)
    {
      ...
      for (paramList = new hummer_commelem.MsgElemInfo_servtype16();; paramList = ((im_msg_body.Text)localObject).str.get().toStringUtf8()) {
        try
        {
          ...
          paramStringBuilder = (MessageForTroopStory)bcry.a(-2057);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    MessageForQQWalletMsg.decodePBMsgElemWalletMsg(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramList, paramList1, paramStringBuilder, paramMsg, parambfoy);
  }
  ...
  public void f(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    if (QLog.isColorLevel()) {
        ...
        for (localObject3 = (im_msg_body.Text)((im_msg_body.Elem)localObject5).text.get();; localObject3 = localObject4)
        {
          ...
          for (localObject1 = ((im_msg_body.RichMsg)localObject2).bytes_template_1.get().toByteArray();; localObject1 = null)
          {
            ...
            for (localObject6 = ((ByteStringMicro)localObject2).toStringUtf8();; localObject6 = "")
            {
              ...
              {
                if ((!bhsr.a((String)localObject5)) && (!bhsr.a((String)localObject2)) && (!bhsr.a((String)localObject6)))
                {
                ...
                for (boolean bool = true;; bool = false) {
                  for (;;)
                  {
                    localObject2 = bcss.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                    if ((((bcsc)localObject2).jdField_a_of_type_Int == 1008) && (QLog.isColorLevel()))
                    {
                      localObject5 = new StringBuilder().append("msgId=uniseq:").append(localMessageForStructing.uniseq).append(", serviceType(Pa-129,140,142):").append(((msg_comm.C2CTmpMsgHead)((msg_comm.MsgHead)paramMsg.msg_head.get()).c2c_tmp_msg_head.get()).service_type.get()).append(", xmlContentLength:");
                      if (localObject1 == null)
                      {
                        i = 0;
                    ...
                    try
                    {
                      ...
                      localObject7 = bhjx.a((byte[])localObject5);
                      if (QLog.isColorLevel()) {
                      ...
                      ((antk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a((byte[])localObject5);
                      if (bool)
                      {
                        if (QLog.isColorLevel()) {
                          QLog.d("DecodeMsg", 2, "begin getEmptyGeneralStructMsg");
                        }
                        localMessageForStructing.structingMsg = ((StructMsgForGeneralShare)bdow.a());
                    ...
                    catch (Exception localException)
                    {
                      for (;;)
                      {
                        if (QLog.isColorLevel())
                        {
                          ...
                          if ((localObject1 == null) || (localObject1.length == 0))
                          {
                            if ((((bcsc)localObject2).jdField_a_of_type_Int == 1008) && (!TextUtils.isEmpty((CharSequence)localObject6)))
                            {
                              if (QLog.isColorLevel()) {
                                QLog.d("PaOldLongMsg", 2, "msgId=uniseq:" + localMessageForStructing.uniseq + ", begin getEmptyGeneralStructMsg for PA oldLongMsg!");
                              }
                              localMessageForStructing.structingMsg = ((StructMsgForGeneralShare)bdow.a());
                          ...
                          else
                          {
                            ...
                            localObject2 = bhto.a((byte[])localObject1, (im_msg_body.GeneralFlags)localObject3, -1);
                            if (localObject2 != null) {
                              i = 0;
                            }
                            for (;;)
                            {
                              localMessageForStructing.structingMsg = bdow.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, m, l2, (byte[])localObject2, i);
                              localObject1 = localObject2;
                              if (!QLog.isColorLevel()) {
                                break label917;
                              }
                              ...
                              if ((i != 0) || (localMessageForStructing.structingMsg.sourceAccoutType != 0))
                              {
                                ...
                                akxs.a((im_msg_body.GeneralFlags)localObject3, localMessageForStructing);
                              }
                              ...
                              {
                                paramList = (MessageForTroopFee)bcry.a(-2036);
                              ...
                              {
                                if (QLog.isColorLevel()) {
                                  QLog.d(aocz.class.getSimpleName(), 2, "Received flower message");
                                }
                              ...
                              {
                                if (QLog.isColorLevel()) {
                                  QLog.i(aocz.class.getSimpleName(), 2, "decodePBMsgElems, groupCode:" + l2);
                                }
                                l3 = l1;
                                if (l2 <= 0L)
                                {
                                  ...
                                  paramList1.add(((aocz)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(124)).a(Long.toString(l1), Long.toString(l2), localMessageForStructing.istroop, localMessageForStructing.structingMsg));
                                  l3 = l1;
                                }
                                label2290:
                                do
                                {
                                  for (;;)
                                  {
                                    ...
                                    {
                                      if (2171946401L == l3) {
                                        tzq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForStructing, 11);
                                      }
                                    ...
                                    i(paramList, paramList1, paramStringBuilder, paramMsg, parambfoy);
                                    return;
                                    l1 = 0L;
                                    break;
                                    l2 = 0L;
                                    ...
                                    if ((localMessageForStructing.structingMsg.mMsgServiceID == 80) && ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare)))
                                    {
                                      if (wjb.i())
                                      {
                                        paramList = (MessageForQQStory)bcry.a(-2051);
                                      ...
                                      if (localObject4 != null)
                                      {
                                        localObject4.str.set(ByteStringMicro.copyFromUtf8(wjb.a()));
                                        return;
                                      }
                                      l3 = l1;
                                      if (QLog.isColorLevel())
                                    ...
                                    else
                                    {
                                      ...
                                      {
                                        paramList = (MessageForTribeShortVideo)bcry.a(-7002);
                                      ...
                                      {
                                        paramList = (MessageForTroopPobing)bcry.a(-2059);
                                        ...
                                        try
                                        {
                                          ...
                                          paramList1.add(paramList);
                                          localMessageForStructing.structingMsg = null;
                                          new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_obj").a(new String[] { l2 + "" }).a();
                                          new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_welcome").a(new String[] { l2 + "", "", "" + bguq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2)) }).a();
                                          return;
                                        }
                                      ...
                                      {
                                        paramList = (MessageForTroopSign)bcry.a(-2054);
                                      ...
                                      if (localMessageForStructing.structingMsg.mMsgServiceID != 43) {
                                        if (((localMessageForStructing.structingMsg.mMsgServiceID == 83) || (localMessageForStructing.structingMsg.mMsgServiceID == 108) || (localMessageForStructing.structingMsg.mMsgServiceID == 114) || (localMessageForStructing.structingMsg.mMsgServiceID == 116)) && (!TextUtils.isEmpty(localMessageForStructing.structingMsg.mMsgActionData)))
                                        {
                                          ...
                                          ocd.a(null, "", "0X8007238", "0X8007238", 0, 0, (String)localObject1, "", "", "");
                                          ocd.a("0X8007238", "", (String)localObject1, "", "", "");
                                        ...
                                        else
                                        {
                                          ...
                                          if ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare))
                                          {
                                            ...
                                            bgkf.a().a((String)localObject2, null);
                                            bgkf.a().a(((StructMsgForGeneralShare)localObject1).atMembers);
                                            l3 = l1;
                                          }
                                        }
                                      }
                                ...
                                try
                                {
                                  ...
                                  parambfoy.mergeFrom(((im_msg_body.GeneralFlags)localObject3).bytes_pb_reserve.get().toByteArray());
                                  paramStringBuilder = paramMsg;
                                  j = m;
                                  if (parambfoy.bytes_kpl_info.has())
                                  {
                                    paramStringBuilder = paramMsg;
                                    j = m;
                                    if (parambfoy.bytes_kpl_info.has())
                                    {
                                      j = 1;
                                      paramStringBuilder = parambfoy.bytes_kpl_info.get().toStringUtf8();
                                    }
                                  }
                                  paramList = paramStringBuilder;
                                  i = j;
                                  if (parambfoy.bytes_oac_msg_extend.has())
                                  {
                                    localMessageForStructing.saveExtInfoToExtStr("report_key_bytes_oac_msg_extend", parambfoy.bytes_oac_msg_extend.get().toStringUtf8());
                                    i = j;
                                    paramList = paramStringBuilder;
                                  }
                                }
                                ...
                                if (k != 0)
                                {
                                  ...
                                  try
                                  {
                                    ...
                                    {
                                      paramList = (ChatMessage)bcry.a(-1051);
                                      ...
                                      if (paramStringBuilder != null)
                                      {
                                        ...
                                        for (;;)
                                        {
                                          ...
                                          {
                                            paramMsg = (bdol)paramStringBuilder.next();
                                            if ((paramMsg instanceof bdom))
                                            {
                                              paramMsg = ((bdom)paramMsg).jdField_a_of_type_JavaUtilArrayList;
                                              if (paramMsg != null)
                                              {
                                                paramMsg = paramMsg.iterator();
                                                if (paramMsg.hasNext())
                                                {
                                                  parambfoy = (bdol)paramMsg.next();
                                                  if (!(parambfoy instanceof StructMsgItemTitle)) {
                                                    break;
                                                  }
                                                  paramList.msg = ((StructMsgItemTitle)parambfoy).b();
                                                  if (QLog.isDevelopLevel())
                                                  {
  ...
  public void g(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    Object localObject2 = null;
    Object localObject6 = paramList.iterator();
    Object localObject1 = null;
    ...
    for (localObject1 = (im_msg_body.GeneralFlags)((im_msg_body.Elem)localObject7).general_flags.get();; localObject1 = localObject2)
    {
      ...
      localObject1 = null;
      int i = 0;
      localObject7 = (MessageForPubAccount)bcry.a(-3006);
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((((im_msg_body.Elem)localObject3).text.has()) && (((im_msg_body.Elem)localObject3).text.str.has()))
        {
          ...
          ((MessageForPubAccount)localObject7).msgData = txr.a((PAMessage)localObject3);
        }
      }
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject3).trans_elem_info.has())
        {
          ...
          if (localObject3[0] == 1)
          {
            ...
            bhvd.a((byte[])localObject6, 0, (byte[])localObject3, 4, i - 1);
          ...
          for (;;)
          {
            ...
            if (localObject1 != null)
            {
              ...
              ((MessageForPubAccount)localObject7).msgData = txr.a((PAMessage)localObject1);
            }
            if (i != 0)
            {
  ...
  public void h(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    paramList = a(paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambfoy);
    ...
    {
      paramStringBuilder = (ChatMessage)bcry.a(-1049);
      paramStringBuilder.msg = paramList.jdField_a_of_type_JavaLangString;
      parambfoy = (MessageForReplyText)paramStringBuilder;
    }
    try
    {
      ...
      {
        parambfoy.setSourceMessageRecord(paramMsg.unPackSourceMsg(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app));
        if ((parambfoy.getSourceMessage() != null) && (aunj.a(parambfoy.getSourceMessage())))
        {
          str = parambfoy.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
          ChatMessage localChatMessage = aunj.a((ChatMessage)parambfoy.getSourceMessage());
          auoo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, parambfoy.getSourceMessage());
          if ((!TextUtils.isEmpty(str)) && (localChatMessage != null))
          {
            ...
            if ((i == 1) || (i == 2))
            {
              ...
              aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)parambfoy.getSourceMessage());
            }
          }
        }
      }
      String str = bhml.a(apdm.a(paramMsg));
      parambfoy.mSourceMsgInfo = paramMsg;
      parambfoy.saveExtInfoToExtStr("sens_msg_source_msg_info", str);
      if (QLog.isColorLevel()) {
        QLog.d("SendMsgBtn", 2, "reply:" + parambfoy + " sourceMsg=" + parambfoy.getSourceMessage());
      }
    }
    ...
    if (paramList.jdField_a_of_type_ArrayOfByte != null) {
      paramStringBuilder.saveExtInfoToExtStr("sens_msg_ctrl_info", bhml.a(paramList.jdField_a_of_type_ArrayOfByte));
    }
    paramList1.add(paramStringBuilder);
    if (QLog.isColorLevel()) {
      QLog.d("DecodeMsg", 2, "reply msgRand = " + bcsa.a(paramStringBuilder.msgUid) + ", msgUid = " + paramStringBuilder.msgUid);
    }
  }
  
  public void i(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bfoy parambfoy)
  {
    String str1 = null;
    int k = 0;
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      {
        str1 = bhml.a(localElem.text.str.get().toByteArray());
        label264:
        n = k;
        if (localElem.text.has())
        {
    ...
    for (;;)
    {
      ...
      break label264;
      localObject1 = null;
      Object localObject2 = new bcrv();
      ArrayList localArrayList1 = ((bcrv)localObject2).jdField_a_of_type_JavaUtilArrayList;
      ArrayList localArrayList2 = new ArrayList(2);
      StringBuilder localStringBuilder = a(null, paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambfoy, (bcrv)localObject2, localArrayList2);
      localObject2 = localObject1;
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localGeneralFlags.uint32_prp_fold.get() == 1)
          {
            ...
            bool4 = akwu.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            bool1 = bool3;
            if (j != 0)
            {
              bool1 = bool3;
              if (akwu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app))
              {
                if (TextUtils.isEmpty((CharSequence)localObject1)) {
                  break label1698;
                }
            ...
            if (QLog.isColorLevel()) {
              QLog.d("msgFold", 2, String.format("Recv, recv foldMsg, redBagSender: %s, foldFlag: %s, redBagId: %s, index: %s, foldSwitch: %s, isValidFoldMsg: %s", new Object[] { Long.valueOf(l1), Boolean.valueOf(bool2), localObject1, str2, Boolean.valueOf(akwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), Boolean.valueOf(bool1) }));
            }
            ...
            if ((localObject2 != null) && (i == 0)) {
              paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bhml.a((byte[])localObject2));
            }
        ...
        try
        {
          ...
          paramMsg = bhjx.a(paramStringBuilder);
          if (QLog.isColorLevel()) {
          ...
          ((antk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a(paramStringBuilder);
        }
        catch (Exception paramStringBuilder)
        {
          if (!QLog.isColorLevel()) {
        ...
        {
          parambfoy = new generalflags.ResvAttr();
          parambfoy.mergeFrom(localGeneralFlags.bytes_pb_reserve.get().toByteArray());
          paramStringBuilder = paramMsg;
          i = j;
          if (parambfoy.bytes_kpl_info.has())
          {
        ...
        if (!TextUtils.isEmpty(str2))
        {
          ...
          if (bool4)
          {
            ...
            {
              paramList = (ChatMessage)bcry.a(-1000);
              if ((parambfoy != null) && (localArrayList2 != null)) {
                bgme.a(parambfoy.jdField_a_of_type_Int, localArrayList2, paramList);
              }
              if (paramStringBuilder != null) {
              ...
              if (localArrayList1.size() > 0)
              {
                ...
                parambfoy = localArrayList1.iterator();
                while (parambfoy.hasNext())
                {
                  localObject1 = parambfoy.next();
