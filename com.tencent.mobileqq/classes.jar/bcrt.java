...
public class bcrt
{
  ...
  private long a(List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong, MessageForStructing paramMessageForStructing)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(anzp.class.getSimpleName(), 2, "Received flower message");
    }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i(anzp.class.getSimpleName(), 2, "decodePBMsgElems, groupCode:" + l1);
      }
      l2 = paramLong;
      if (l1 <= 0L) {
      ...
      for (paramLong = paramMsg.msg_head.from_uin.get();; paramLong = 0L)
      {
        ...
        paramList.add(((anzp)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(QQManagerFactory.NEARBY_FLOWER_MANAGER)).a(Long.toString(paramLong), Long.toString(l1), paramMessageForStructing.istroop, paramMessageForStructing.structingMsg));
        l2 = paramLong;
        return l2;
      }
    }
  ...
  private ChatMessage a(bffl parambffl, ArrayList<Object> paramArrayList, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList1, long paramLong1, boolean paramBoolean1, String paramString1, String paramString2, boolean paramBoolean2, long paramLong2, String paramString3, boolean paramBoolean3)
  {
    if (paramBoolean2)
    {
      parambffl = new MessageForFoldMsg();
      ((MessageForFoldMsg)parambffl).init(paramBoolean1, paramString1, paramString2, paramLong1, true);
    }
    do
    {
      return parambffl;
      if (paramBoolean3)
      {
        parambffl = (ChatMessage)bcsa.a(-1051);
        parambffl.saveExtInfoToExtStr("long_text_recv_state", "1");
        parambffl.removeExtInfoToExtStr("long_text_msg_resid");
        return parambffl;
      }
      if (paramLong2 != 0L)
      {
        parambffl = new MessageForWantGiftMsg();
        ((MessageForWantGiftMsg)parambffl).wantGiftSenderUin = paramLong2;
        ((MessageForWantGiftMsg)parambffl).saveExtInfoToExtStr(MessageForWantGiftMsg.GIFT_SENDER_UIN, paramLong2 + "");
        ((MessageForWantGiftMsg)parambffl).msgtype = -2056;
        return parambffl;
      }
      paramString1 = (ChatMessage)bcsa.a(-1000);
      if ((parambffl != null) && (paramArrayList1 != null)) {
        bgcz.a(parambffl.jdField_a_of_type_Int, paramArrayList1, paramString1);
      }
      if (paramString3 != null) {
        paramString1.saveExtInfoToExtStr("report_key_bytes_oac_msg_extend", paramString3);
      }
      parambffl = paramString1;
    } while (paramArrayList.size() <= 0);
    parambffl = new ArrayList(paramArrayList.size());
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      paramArrayList1 = paramArrayList.next();
      if ((paramArrayList1 instanceof MessageForText.AtTroopMemberInfo)) {
        parambffl.add((MessageForText.AtTroopMemberInfo)paramArrayList1);
      }
    }
    paramString1.atInfoTempList = parambffl;
    return paramString1;
  }
  ...
  private MessageForDeliverGiftTips a(im_msg_body.DeliverGiftMsg paramDeliverGiftMsg)
  {
    ...
    {
      paramDeliverGiftMsg = (MessageForDeliverGiftTips)bcsa.a(-2035);
      paramDeliverGiftMsg.msgtype = -2035;
      return paramDeliverGiftMsg;
    }
    paramDeliverGiftMsg = (MessageForTroopGift)bcsa.a(-2038);
  ...
  private MessageForPic a(msg_comm.Msg paramMsg, boolean paramBoolean, CustomFaceExtPb.ResvAttr paramResvAttr)
  {
    if (paramBoolean)
    {
      MessageForPic localMessageForPic = (MessageForPic)bcsa.a(-5015);
      ...
      paramMsg = (bggl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.AIO_ANIMATION_MANAGER);
      if (paramMsg != null) {
        paramMsg.a((bggz)localMessageForPic, false);
      }
  ...
  {
    MessageForPubAccount localMessageForPubAccount = (MessageForPubAccount)bcsa.a(-3006);
    ...
    try
    {
      localMessageForPubAccount.msgData = usd.a(paramPAMessage);
  ...
  @Nullable
  private MessageForReplyText a(MessageForText.AtTroopMemberInfo paramAtTroopMemberInfo, List<MessageRecord> paramList, bcrw parambcrw, bffl parambffl, MessageForReplyText paramMessageForReplyText)
  {
    ...
    return paramMessageForReplyText;
    MessageForReplyText localMessageForReplyText = (MessageForReplyText)bcsa.a(-1049);
    ...
    {
      if ((paramAtTroopMemberInfo.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (parambcrw.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
        parambffl.jdField_a_of_type_Bffm.b(24, -1L);
      }
      paramList.remove(0);
  ...
  public static MessageForVIPDonate a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        MessageForVIPDonate localMessageForVIPDonate = (MessageForVIPDonate)bcsa.a(-2047);
        ...
        if (localJSONObject.has("title"))
        {
          ...
          localMessageForVIPDonate.msgData = apab.a(localVIPDonateMsg);
  ...
  private StringBuilder a(StringBuilder paramStringBuilder1, List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder2, long paramLong, bffl parambffl, bcrw parambcrw, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    bcrw localbcrw = parambcrw;
    if (parambcrw == null) {
      localbcrw = new bcrw();
    }
    bcrv localbcrv = null;
    MessageForText.AtTroopMemberInfo localAtTroopMemberInfo = localbcrw.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo;
    parambcrw = null;
    StringBuilder localStringBuilder = a(paramStringBuilder1);
    boolean bool = false;
    Iterator localIterator = paramList.iterator();
    paramList = localAtTroopMemberInfo;
    paramStringBuilder1 = localbcrv;
    while (localIterator.hasNext())
    {
      localbcrv = new bcrv(this, paramStringBuilder2, paramLong, parambffl, paramArrayList, paramStringBuilder1, paramList, parambcrw, localStringBuilder, bool, (im_msg_body.Elem)localIterator.next()).a();
      paramStringBuilder1 = localbcrv.a();
      paramList = localbcrv.b();
      parambcrw = localbcrv.a();
      bool = localbcrv.a();
    }
    localbcrw.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramList;
    a(localbcrw, paramStringBuilder1, parambcrw);
  ...
  private void a(long paramLong, MessageForStructing paramMessageForStructing)
  {
    if (((2171946401L == paramLong) || (2173223560L == paramLong) || (2062433139L == paramLong) || (3434959637L == paramLong)) && ((paramMessageForStructing.structingMsg instanceof AbsShareMsg)))
    {
      if (2171946401L == paramLong) {
        uuc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForStructing, 11);
      }
  ...
  private void a(bcrw parambcrw, MessageForText.AtTroopMemberInfo paramAtTroopMemberInfo, byte[] paramArrayOfByte)
  {
    parambcrw = parambcrw.jdField_a_of_type_JavaUtilArrayList;
    if ((parambcrw == null) || ((paramAtTroopMemberInfo == null) && (paramArrayOfByte == null))) {}
    do
    {
      return;
      if (parambcrw.isEmpty())
      {
        parambcrw.add(paramAtTroopMemberInfo);
        parambcrw.add(paramArrayOfByte);
        return;
      }
    } while ((parambcrw.size() != 2) || ((parambcrw.get(0) != null) && (parambcrw.get(1) != null)));
    if (parambcrw.get(0) == null) {
      if (parambcrw.get(1) != null) {
        break label104;
      }
    }
    for (;;)
    {
      ...
      parambcrw.add(paramArrayOfByte);
      return;
      paramAtTroopMemberInfo = parambcrw.get(0);
      break;
      label104:
      paramArrayOfByte = parambcrw.get(1);
    }
  }
  ...
  private void a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    ...
    do
    {
      ...
      {
        return;
        Pattern localPattern = Pattern.compile(anvx.a(2131706120));
  ...
  private void a(MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, MessageForReplyText paramMessageForReplyText)
  {
    try
    {
      ...
      if (paramSourceMsgInfo.getSourceMsg() != null)
      {
        ...
        if ((paramMessageForReplyText.getSourceMessage() != null) && (auea.a(paramMessageForReplyText.getSourceMessage())))
        {
          String str = paramMessageForReplyText.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
          ChatMessage localChatMessage = auea.a((ChatMessage)paramMessageForReplyText.getSourceMessage());
          aufd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, paramMessageForReplyText.getSourceMessage());
          if ((!TextUtils.isEmpty(str)) && (localChatMessage != null))
          {
            ...
            if ((i == 1) || (i == 2))
            {
              ...
              auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)paramMessageForReplyText.getSourceMessage());
            }
          }
        }
      }
      paramMessageForReplyText.saveExtInfoToExtStr("sens_msg_source_msg_info", HexUtil.bytes2HexStr(apab.a(paramSourceMsgInfo)));
      return;
    }
  ...
  private void a(MessageForStructing paramMessageForStructing)
  {
    if ((paramMessageForStructing.structingMsg instanceof StructMsgForGeneralShare))
    {
      ...
      bgat.a().a(str, null);
      bgat.a().a(paramMessageForStructing.atMembers);
    }
  }
  ...
  {
    String str = BaseApplication.getContext().getString(2131694421);
  ...
  private void a(List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder, MessageForText.AtTroopMemberInfo paramAtTroopMemberInfo, List<MessageRecord> paramList1, bcrw parambcrw, bffl parambffl)
  {
    ...
    {
      return;
      paramStringBuilder = (MessageForReplyText)bcsa.a(-1049);
      a(paramList, paramStringBuilder);
      paramList = a(paramAtTroopMemberInfo, paramList1, parambcrw, parambffl, paramStringBuilder);
      if (QLog.isColorLevel()) {
  ...
  private void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl, String paramString, int paramInt, hummer_commelem.MsgElemInfo_servtype14 paramMsgElemInfo_servtype14)
  {
    if (paramInt == 0) {
      a(paramList, paramList1, paramStringBuilder, paramMsg, parambffl, paramString, paramMsgElemInfo_servtype14);
    }
    while (paramInt != 1) {
      return;
    }
  ...
  private void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl, String paramString, hummer_commelem.MsgElemInfo_servtype14 paramMsgElemInfo_servtype14)
  {
    if (!((FlashChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FLASH_CHAT_MANAGER)).a()) {
      f(paramList, paramList1, paramStringBuilder, paramMsg, parambffl);
    }
    do
    {
      return;
    ...
    localObject = bdpo.a((byte[])localObject, -1);
    if ((localObject != null) && (localObject.length > 0))
    {
      ...
      paramString = (MessageForArkFlashChat)bcsa.a(-5013);
  ...
  private void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl, im_msg_body.GeneralFlags paramGeneralFlags, boolean paramBoolean, MessageForStructing paramMessageForStructing)
  {
    if (paramMessageForStructing.structingMsg == null)
    {
      ...
      i(paramList, paramList1, paramStringBuilder, paramMsg, parambffl);
      return;
    }
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        try
        {
          ...
          paramList = (ChatMessage)bcsa.a(-1051);
          ...
          paramMsg = (bdnu)paramStringBuilder.next();
          if (!(paramMsg instanceof bdnv)) {
            continue;
          }
          paramMsg = ((bdnv)paramMsg).jdField_a_of_type_JavaUtilArrayList;
          if (paramMsg == null) {
            continue;
          }
          ...
          parambffl = (bdnu)paramMsg.next();
          if (!(parambffl instanceof StructMsgItemTitle)) {
            continue;
          }
          paramList.msg = ((StructMsgItemTitle)parambffl).b();
  ...
  private void a(List<MessageRecord> paramList1, msg_comm.Msg paramMsg, List<MessageRecord> paramList2, byte[] paramArrayOfByte, bffl parambffl, MessageForText.AtTroopMemberInfo paramAtTroopMemberInfo)
  {
        ...
        if (i != 0)
        {
          ...
          for (;;)
          {
            ...
            if ((localMessageRecord.msgtype != -1000) && (localMessageRecord.msgtype != -1049) && (localMessageRecord.msgtype != -2000))
            {
              ...
              {
                paramList2.add(bcrx.a(paramMsg, paramList1, parambffl));
                paramMsg.clear();
          ...
          if (paramMsg.size() > 0)
          {
            ...
            paramList1 = bcrx.a(paramMsg, paramArrayOfByte, parambffl);
  ...
  private void a(List<MessageRecord> paramList, msg_comm.Msg paramMsg, im_msg_body.TransElem paramTransElem, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramArrayOfByte.dspFileName = auea.a(paramArrayOfByte.dspFileName);
        paramArrayOfByte.dspFileSize = new String(((ByteStringMicro)paramTransElem.rpt_bytes_abstact.get(0)).toByteArray());
        bgjb.a(paramMsg.msg_head.group_info.group_code.get()).a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramArrayOfByte.fileUrl, paramArrayOfByte);
        ...
        if (paramTransElem != null)
        {
          ...
          MessageForTroopFile localMessageForTroopFile = (MessageForTroopFile)bcsa.a(-2017);
          localMessageForTroopFile.msgtype = -2017;
          localMessageForTroopFile.msg = anvx.a(2131706123);
          try
          {
            localMessageForTroopFile.msgData = apab.a(paramArrayOfByte);
  ...
  private void a(msg_comm.Msg paramMsg, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        localTroopManager = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(QQManagerFactory.TROOP_MANAGER);
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER).notifyUI(79, true, new Object[] { Long.valueOf(l) });
  }
  ...
  private void a(msg_comm.Msg paramMsg, byte[] paramArrayOfByte, MessageForStructing paramMessageForStructing, String paramString, boolean paramBoolean, bcse parambcse)
  {
    if ((parambcse.jdField_a_of_type_Int == 1008) && (QLog.isColorLevel()))
    {
  ...
  {
    bgmf localbgmf = (bgmf)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(QQManagerFactory.TROOP_TIPS_MSG_MANAGER);
    if (localbgmf == null) {
      return;
    }
    ...
    localbgmf.a(paramMessageForDeliverGiftTips.grayTipsEntity);
    ...
    if (paramMessageForDeliverGiftTips.grayTipsEntity.highlightNum != 0) {
      bgmf.a(paramMessageForDeliverGiftTips, paramMessageForDeliverGiftTips.grayTipsEntity.highlightItems);
    }
    if ((paramMessageForDeliverGiftTips instanceof MessageForTroopGift)) {
      ((MessageForTroopGift)paramMessageForDeliverGiftTips).prewrite();
    }
  ...
  {
    BaseApplication.getContext().getString(2131694421);
    boolean bool;
          ...
          for (int k = paramNotOnlineImage.uint32_file_id.get();; k = 0)
          {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                paramElem = (MessageForPic)bcsa.a(-2000);
                if (bool) {
                  anud.a(paramElem, false);
                }
  ...
  private void a(im_msg_body.GeneralFlags paramGeneralFlags, MessageForStructing paramMessageForStructing)
  {
    ...
    try
    {
      ...
      ((anqn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.BABY_Q_HANDLER)).a(arrayOfByte);
      return;
    }
    catch (Exception paramGeneralFlags)
    {
  ...
  private void a(im_msg_body.GeneralFlags paramGeneralFlags, MessageForStructing paramMessageForStructing, boolean paramBoolean)
  {
    if ((paramBoolean) || (paramMessageForStructing.structingMsg.sourceAccoutType != 0))
    {
      ...
      akrc.a(paramGeneralFlags, paramMessageForStructing);
      onq.a(paramMessageForStructing);
    }
  }
  ...
  private void a(im_msg_body.GeneralFlags paramGeneralFlags, boolean paramBoolean, String paramString, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
  ...
  {
    MessageForTroopSign localMessageForTroopSign = (MessageForTroopSign)bcsa.a(-2054);
  ...
  {
    MessageForTroopPobing localMessageForTroopPobing = (MessageForTroopPobing)bcsa.a(-2059);
    ...
    try
    {
      ...
      paramMessageForStructing.structingMsg = null;
      new bdlf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_obj").a(new String[] { paramLong + "" }).a();
      new bdlf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_welcome").a(new String[] { paramLong + "", "", "" + TroopUtils.convSfToReportParam(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong)) }).a();
      return true;
    }
  ...
  {
    MessageForTribeShortVideo localMessageForTribeShortVideo = (MessageForTribeShortVideo)bcsa.a(-7002);
  ...
  {
    MessageForTroopFee localMessageForTroopFee = (MessageForTroopFee)bcsa.a(-2036);
  ...
  private boolean a(msg_comm.Msg paramMsg, boolean paramBoolean, StringBuilder paramStringBuilder)
  {
    ...
    paramStringBuilder.append(BaseApplication.getContext().getString(2131694421));
  ...
  private byte[] a(im_msg_body.GeneralFlags paramGeneralFlags, byte[] paramArrayOfByte, MessageForStructing paramMessageForStructing, long paramLong, int paramInt, String paramString, boolean paramBoolean, bcse parambcse)
  {
    if (paramBoolean)
    {
      if (QLog.isColorLevel()) {
      ...
      paramMessageForStructing.structingMsg = ((StructMsgForGeneralShare)bdof.a());
    }
    do
    {
    ...
    } while ((parambcse.jdField_a_of_type_Int != 1008) || (TextUtils.isEmpty(paramString)));
    if (QLog.isColorLevel()) {
    ...
    int i = -1;
    paramGeneralFlags = bhiw.a(paramArrayOfByte, paramGeneralFlags, -1);
    if (paramGeneralFlags != null) {
      i = 0;
    }
    for (;;)
    {
      paramMessageForStructing.structingMsg = bdof.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramInt, paramLong, paramGeneralFlags, i);
      if (QLog.isColorLevel()) {
  ...
  private void b(MessageForStructing paramMessageForStructing)
  {
    ...
    olh.a(null, "", "0X8007238", "0X8007238", 0, 0, str, "", "", "");
    olh.a("0X8007238", "", str, "", "", "");
  ...
  private boolean b(List<MessageRecord> paramList, im_msg_body.Text paramText, MessageForStructing paramMessageForStructing)
  {
    if (vzv.i())
    {
      MessageForQQStory localMessageForQQStory = (MessageForQQStory)bcsa.a(-2051);
    ...
    if (paramText != null)
    {
      paramText.str.set(ByteStringMicro.copyFromUtf8(vzv.a()));
      return true;
    }
    if (QLog.isColorLevel()) {
  ...
  public bcru a(List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder, long paramLong, bffl parambffl)
  {
    bcru localbcru = new bcru(this);
    localbcru.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo = a(paramList, paramStringBuilder);
    bcrw localbcrw = new bcrw();
    Object localObject = localbcrw.jdField_a_of_type_JavaUtilArrayList;
    StringBuilder localStringBuilder = a(null, paramList, paramStringBuilder, paramLong, parambffl, localbcrw, null);
    if ((localObject != null) && (((ArrayList)localObject).size() == 2)) {
      if (((ArrayList)localObject).get(0) != null)
      {
        ...
        if (((ArrayList)localObject).get(1) != null) {
          localbcru.jdField_a_of_type_ArrayOfByte = ((byte[])((ArrayList)localObject).get(1));
        }
      }
    }
    ...
    {
      int i;
      if ((localStringBuilder.length() > 0) && (localbcru.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo != null))
      {
        localbcru.jdField_a_of_type_JavaLangString = localStringBuilder.toString();
        if ((TextUtils.isEmpty(localbcru.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mAnonymousNickName)) && (paramStringBuilder != null) && (!TextUtils.isEmpty(localbcru.jdField_a_of_type_JavaLangString)) && (localbcru.jdField_a_of_type_JavaLangString.length() >= paramStringBuilder.textLen + paramStringBuilder.startPos))
        {
          localbcru.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramStringBuilder;
          localObject = localbcru.jdField_a_of_type_JavaLangString;
          localbcru.jdField_a_of_type_JavaLangString = "";
          if (paramStringBuilder.startPos > 0) {
            localbcru.jdField_a_of_type_JavaLangString = ((String)localObject).substring(0, paramStringBuilder.startPos);
          }
          paramList = "";
      ...
      label381:
      for (localbcru.jdField_a_of_type_JavaLangString += ((String)localObject).substring(i + 1);; localbcru.jdField_a_of_type_JavaLangString += ((String)localObject).substring(i))
      {
        localbcru.b = ((String)localObject).substring(paramStringBuilder.startPos, paramStringBuilder.startPos + paramStringBuilder.textLen);
        if ((paramStringBuilder.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (localbcrw.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
          parambffl.jdField_a_of_type_Bffm.b(24, -1L);
        }
        return localbcru;
      }
    ...
    if (localMarketFace != null)
    {
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        try
        {
          for (;;)
          {
            paramStringBuilder.msgData = apab.a(paramElem);
      ...
      if (localResvAttr.uint32_has_ip_product.get() == 1)
      {
        ...
        paramStringBuilder = (MessageForMarketFace)bcsa.a(-2007);
        ...
        if ((paramElem.mobileparam != null) && (paramElem.mobileparam.length > 0)) {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "MbJieshou", "MbXiaoxi", 0, 0, "", "", "", "");
        }
      }
    }
    label599:
    ...
    if (j < k)
    {
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Text)localObject).str.has()) {
          localStringBuilder1.append(bcsc.a(((im_msg_body.Text)localObject).str.get().toStringUtf8(), false));
        }
        continue;
        int m;
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = bdof.a(((im_msg_body.MarketTrans)localObject1).bytes_xml.get().toByteArray(), i);
      if (localObject1 == null)
      {
        if (QLog.isColorLevel()) {
          paramStringBuilder.append("c2cMsgContent.data:null;\n");
      ...
      paramList = (MessageForStructing)bcsa.a(-2011);
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    ...
    try
    {
      ...
      a(paramList, paramList1, paramStringBuilder, paramMsg, parambffl, str, i, localMsgElemInfo_servtype14);
      return;
    }
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl, boolean paramBoolean)
  {
    int i = 0;
    im_msg_body.Elem localElem = null;
    ...
    if (localIterator.hasNext())
    {
      ...
      if (localElem.market_face.has())
      {
        ...
        {
          b(localArrayList, paramList1, paramStringBuilder, paramMsg, parambffl, paramBoolean);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          if ((i != 0) && (localElem.text.has()) && (paramList != null))
          {
            ...
            try
            {
              ((MessageRecord)paramList1.get(paramList1.size() - 1)).msgData = apab.a(paramList);
              if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((paramStringBuilder.uint32_sys_head_id.has()) && (paramStringBuilder.uint32_head_flag.has()))
          {
            ...
            paramList = (aozr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CLASSIC_HEAD_ACIVITY_MANAGER);
  ...
  public void a(im_msg_body.Elem paramElem, im_msg_body.CustomFace paramCustomFace, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bffl parambffl)
  {
    ...
    for (;;)
    {
      ...
      if (parambffl != null) {
        paramElem.istroop = parambffl.jdField_a_of_type_Int;
      }
      paramElem.msgData = ((RichMsg.PicRec)localObject1).toByteArray();
      paramElem.parse();
      paramList.add(paramElem);
  ...
  public boolean a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bffl parambffl)
  {
    Object localObject2;
    String str1;
    Object localObject1;
    ...
    if (paramBoolean) {
      ...
      {
        parambffl = paramMsg.msg_head.from_uin.get() + "";
        localObject2 = null;
        str1 = null;
        localObject1 = null;
        Iterator localIterator = paramList.iterator();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        localObject1 = localObject2;
        break label82;
        parambffl = paramMsg.msg_head.to_uin.get() + "";
        break;
        if (parambffl != null) {}
        for (parambffl = parambffl.jdField_a_of_type_JavaLangString;; parambffl = paramMsg.msg_head.to_uin.get() + "") {
          break;
        }
        label309:
        if (paramList == null) {
        ...
        try
        {
          ...
          paramList.frienduin = parambffl;
          paramList.isFromNearby = true;
          paramList1 = (bggl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.AIO_ANIMATION_MANAGER);
          if (paramList1 != null) {
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      ...
      localMessageForIncompatibleGrayTips = (MessageForIncompatibleGrayTips)bcsa.a(-5002);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    Object localObject1 = null;
    Object localObject2 = paramList.iterator();
    Object localObject3;
    ...
    if (((hummer_commelem.MsgElemInfo_servtype19)localObject2).bytes_data.has())
    {
      ...
      localObject2 = bdpo.a((byte[])localObject2, -1);
      if (localObject2 != null)
      {
        ...
        if (i > 0)
        {
          ...
          localObject3 = (MessageForArkBabyqReply)bcsa.a(-5016);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if (localElem.custom_face.has())
        {
          ...
          {
            localMessageForText = (MessageForText)bcsa.a(-1000);
            localMessageForText.msgtype = -1000;
          ...
          a(localElem, null, localArrayList, paramStringBuilder, paramMsg, paramBoolean, parambffl);
        }
        ...
        label300:
        if (acvg.a(localElem).booleanValue())
        {
          if (i != 0)
          {
            i = 0;
    ...
    for (;;)
    {
      ...
      localObject1 = a((StringBuilder)localObject1, (List)localObject3, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambffl, localbcrw, (ArrayList)localObject2);
      break;
      if (localElem.general_flags.has())
      {
        ...
        if (((StringBuilder)localObject1).length() > 0)
        {
          ...
          if (parambffl != null) {
            bgcz.a(parambffl.jdField_a_of_type_Int, (ArrayList)localObject2, (ChatMessage)localObject3);
          }
          localArrayList.add(localObject3);
          ((StringBuilder)localObject1).delete(0, ((StringBuilder)localObject1).length());
        }
        localObject2 = localbcrw.jdField_a_of_type_JavaUtilArrayList;
        ...
        for (;;)
        {
          a(paramList, paramStringBuilder, (MessageForText.AtTroopMemberInfo)localObject2, localArrayList, localbcrw, parambffl);
          a(localGeneralFlags, localArrayList);
          b(localGeneralFlags, localArrayList);
          a(localArrayList, paramMsg, paramList1, (byte[])localObject1, parambffl, (MessageForText.AtTroopMemberInfo)localObject2);
          return;
          localObject3 = null;
          localObject2 = localObject1;
          localObject1 = localObject3;
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)localElem.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForQQStoryComment)bcsa.a(-2052);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (!ArkUtil.isDeviceSupportArkMsg())
        {
          ...
          paramList = (MessageForText)bcsa.a(-1000);
          paramList.msgtype = -1000;
          paramList.msg = BaseApplication.getContext().getString(2131693523);
          paramList1.add(paramList);
          return;
        }
        if (ArkAppCenter.b())
        ...
        for (;;)
        {
          ...
          {
            localObject1 = bdpo.a((byte[])localObject1, -1);
            if ((localObject1 != null) && (localObject1.length > 0)) {}
            for (;;)
            {
              try
            ...
            a(localGeneralFlags, false, localObject2, paramList, paramList1, paramStringBuilder, paramMsg, parambffl);
            return;
          }
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    Object localObject2 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject3 = bdpo.a((byte[])localObject3, -1);
    ...
    for (;;)
    {
      ...
      for (paramList = new hummer_commelem.MsgElemInfo_servtype16();; paramList = ((im_msg_body.Text)localObject).str.get().toStringUtf8()) {
        try
        {
          ...
          paramStringBuilder = (MessageForTroopStory)bcsa.a(-2057);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    MessageForQQWalletMsg.decodePBMsgElemWalletMsg(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramList, paramList1, paramStringBuilder, paramMsg, parambffl);
  }
  ...
  public void f(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    if (QLog.isColorLevel()) {
    ...
    for (long l1 = paramMsg.msg_head.from_uin.get();; l1 = 0L)
    {
      ...
      bcse localbcse = bcsu.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      a(paramMsg, arrayOfByte, localMessageForStructing, (String)localObject, bool2, localbcse);
      a(localGeneralFlags, localMessageForStructing);
      if (a(paramList, paramList1, paramMsg, localGeneralFlags, localText, a(localGeneralFlags, arrayOfByte, localMessageForStructing, l2, i, (String)localObject, bool2, localbcse), l1, localMessageForStructing, l2, i)) {
        break;
      }
      localMessageForStructing.msg = "richMsg";
      a(paramList, paramList1, paramStringBuilder, paramMsg, parambffl, localGeneralFlags, bool1, localMessageForStructing);
      return;
    }
  }
  
  public void g(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if ((((im_msg_body.Elem)localObject2).text.has()) && (((im_msg_body.Elem)localObject2).text.str.has()))
        {
          ...
          localMessageForPubAccount.msgData = usd.a((PAMessage)localObject1);
        }
  ...
  public void h(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    paramList = a(paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambffl);
    ...
    {
      paramStringBuilder = (ChatMessage)bcsa.a(-1049);
      paramStringBuilder.msg = paramList.jdField_a_of_type_JavaLangString;
      parambffl = (MessageForReplyText)paramStringBuilder;
    }
    try
    {
      parambffl.extLong |= 0x1;
      if (paramMsg.getSourceMsg() != null)
      {
        parambffl.setSourceMessageRecord(paramMsg.unPackSourceMsg(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app));
        if ((parambffl.getSourceMessage() != null) && (auea.a(parambffl.getSourceMessage())))
        {
          str = parambffl.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
          ChatMessage localChatMessage = auea.a((ChatMessage)parambffl.getSourceMessage());
          aufd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, parambffl.getSourceMessage());
          if ((!TextUtils.isEmpty(str)) && (localChatMessage != null))
          {
            int i = Integer.parseInt(str);
            if ((i == 1) || (i == 2))
            {
              ...
              auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)parambffl.getSourceMessage());
            }
          }
        }
      }
      String str = HexUtil.bytes2HexStr(apab.a(paramMsg));
      parambffl.mSourceMsgInfo = paramMsg;
      parambffl.saveExtInfoToExtStr("sens_msg_source_msg_info", str);
      if (QLog.isColorLevel()) {
        QLog.d("SendMsgBtn", 2, "reply:" + parambffl + " sourceMsg=" + parambffl.getSourceMessage());
      }
    }
    ...
    paramList1.add(paramStringBuilder);
    if (QLog.isColorLevel()) {
      QLog.d("DecodeMsg", 2, "reply msgRand = " + bcsc.a(paramStringBuilder.msgUid) + ", msgUid = " + paramStringBuilder.msgUid);
    }
  }
  
  public void i(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, bffl parambffl)
  {
    ...
    int i1 = a(paramList);
    Object localObject = new bcrw();
    ArrayList localArrayList1 = ((bcrw)localObject).jdField_a_of_type_JavaUtilArrayList;
    ArrayList localArrayList2 = new ArrayList(2);
    StringBuilder localStringBuilder = a(null, paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), parambffl, (bcrw)localObject, localArrayList2);
    ...
    for (paramStringBuilder = (byte[])localArrayList1.get(1);; paramStringBuilder = null)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          bool5 = akqe.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          bool1 = bool3;
          if (akqe.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app))
          {
            if (TextUtils.isEmpty((CharSequence)localObject)) {
              break label795;
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d("msgFold", 2, String.format("Recv, recv foldMsg, redBagSender: %s, foldFlag: %s, redBagId: %s, index: %s, foldSwitch: %s, isValidFoldMsg: %s", new Object[] { Long.valueOf(l1), Boolean.valueOf(bool2), localObject, str1, Boolean.valueOf(akqe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), Boolean.valueOf(bool1) }));
          }
          ...
          bool2 = false;
          l2 = l1;
          paramList = a(parambffl, localArrayList1, localArrayList2, l2, bool2, (String)localObject, str1, bool1, l3, paramList, b(localGeneralFlags));
