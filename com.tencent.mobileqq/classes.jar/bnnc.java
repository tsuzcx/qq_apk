  ...
  extends bnnn
{
  ...
  public bnnc()
  {
    this.jdField_a_of_type_JavaLangString = bnnc.class.getSimpleName();
  }
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      paramString1 = paramJsBridgeListener.getTag(2131368266);
      if ((paramString1 != null) && ((paramString1 instanceof bnnd)))
      {
        paramString1 = (bnnd)paramString1;
    ...
    for (;;)
    {
      ...
      if (i == 1) {
        ...
        paramString1.setBannerHeight((int)bhtq.a((float)d));
      } else if (i == 3) {
        paramString1.setBannerHeight((int)(d * bhtq.a()));
      } else {
