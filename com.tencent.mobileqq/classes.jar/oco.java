...
{
  oco(ocm paramocm, long paramLong, NewIntent paramNewIntent, ocq paramocq, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      if (this.jdField_a_of_type_Ocq != null) {
        this.jdField_a_of_type_Ocq.a(this.jdField_a_of_type_JavaLangString, "error");
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Ocq != null)
        {
          ...
          this.jdField_a_of_type_Ocq.a(this.jdField_a_of_type_JavaLangString, paramBundle);
        }
      } while (!QLog.isColorLevel());
