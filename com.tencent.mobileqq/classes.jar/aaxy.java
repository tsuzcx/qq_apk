...
{
  public aaxy(DevlockQuickLoginActivity paramDevlockQuickLoginActivity) {}
  ...
  public void OnCloseCode(String paramString, byte[] paramArrayOfByte1, long paramLong, WUserSigInfo paramWUserSigInfo, byte[] paramArrayOfByte2, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    catch (Exception paramString)
    {
      ...
      if (paramInt == 0)
      {
        bcql.a(this.a.getApplicationContext(), 2, 2131692162, 0).b(DevlockQuickLoginActivity.a(this.a));
      ...
      if (paramInt == 21)
      {
        ...
        paramArrayOfByte1 = this.a.getString(2131719878);
        this.a.a(null, paramString, paramArrayOfByte1, new aaxz(this));
        return;
      }
      paramString = DevlockQuickLoginActivity.a(this.a, 2131692160);
      bcql.a(this.a.getApplicationContext(), 1, paramString, 0).b(DevlockQuickLoginActivity.b(this.a));
    }
  }
  ...
  public void OnException(String paramString, int paramInt)
  {
    ...
    this.a.c();
    bcql.a(DevlockQuickLoginActivity.b(this.a), 1, this.a.getString(2131692161), 0).b(DevlockQuickLoginActivity.d(this.a));
  }
  ...
  public void OnVerifyCode(String paramString, byte[] paramArrayOfByte1, long paramLong, ArrayList<String> paramArrayList, byte[] paramArrayOfByte2, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 21)
    {
      paramString = this.a.getString(2131692159);
      paramArrayOfByte1 = this.a.getString(2131719878);
      this.a.a(null, paramString, paramArrayOfByte1, new aaya(this));
      return;
    }
    paramString = this.a.getString(2131692160);
    bcql.a(DevlockQuickLoginActivity.a(this.a), 1, paramString, 0).b(DevlockQuickLoginActivity.c(this.a));
  }
}
