  ...
  implements Manager
{
  ...
  private static final String[] b = { "", anni.a(2131712341), anni.a(2131712337) };
  protected SparseArray<String[]> a;
  protected final QQAppInterface a;
  protected LinkedHashMap<String, bfqd> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = ".troop.school_troop." + bfqc.class.getSimpleName();
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "", anni.a(2131712338), anni.a(2131712340) };
  }
  
  public bfqc(QQAppInterface paramQQAppInterface)
  {
  ...
  public bfqd a(SessionInfo paramSessionInfo, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      str1 = l2 + "_" + i;
      localbfqd = (bfqd)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(str1);
      if (localbfqd == null) {
        break;
      }
      paramSessionInfo = localbfqd;
    ...
    bfqd localbfqd = new bfqd();
    localbfqd.jdField_a_of_type_Long = l2;
    localbfqd.jdField_a_of_type_Int = i;
    localbfqd.jdField_a_of_type_JavaLangString = paramSessionInfo.jdField_a_of_type_JavaLangString;
    localbfqd.a(paramMessageRecord);
    ...
    while (i < k)
    {
      ...
      while (j < n)
      {
        ...
        if (i1 != -1)
        {
          localbfqd.jdField_b_of_type_Int = m;
          localbfqd.jdField_b_of_type_JavaLangString = str2;
          localbfqd.c = i1;
          localbfqd.d = (str2.length() + i1);
          this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localbfqd);
          return localbfqd;
        }
        j += 1;
      }
    ...
    localbfqd.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localbfqd);
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, "detectKeyword time cost: " + (System.currentTimeMillis() - l1) + ", result = " + localbfqd.jdField_b_of_type_Int);
    }
    return localbfqd;
  }
