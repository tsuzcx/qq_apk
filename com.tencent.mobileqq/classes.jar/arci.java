  ...
  extends arcj
{
  ...
  public arci(QQAppInterface paramQQAppInterface, aupm paramaupm, HashMap<String, ArrayList<MessageRecord>> paramHashMap, auoz paramauoz)
  {
    ...
    if (this.b == null)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (i < ((ArrayList)localObject).size())
        {
          ...
          if ((localMessageRecord2 == null) || (!arrr.a(localMessageRecord2))) {
            break label165;
          }
  ...
  public void a(String paramString, List<MessageRecord> paramList, MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      paramList = alud.a(2131707407) + paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName");
