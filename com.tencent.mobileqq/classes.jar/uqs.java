  ...
  implements View.OnClickListener
{
  ...
  anyb jdField_a_of_type_Anyb = new uqu(this);
  ...
  public uqs(Context paramContext, View paramView, uqv paramuqv)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Uqv = paramuqv;
    d();
    e();
  }
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new uqt(this);
  ...
  private void f()
  {
    veg.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard up. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    if (this.jdField_a_of_type_Uqv != null) {
      this.jdField_a_of_type_Uqv.b(this.d);
    }
    this.d = false;
  }
  ...
  private void g()
  {
    veg.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard down. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    {
      if (this.jdField_a_of_type_Uqv != null) {
        this.jdField_a_of_type_Uqv.c(bool);
      }
      this.c = false;
      this.d = false;
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      veg.b("Q.qqstory.detail.KeyboardAndEmojiManager", "setKeyBoardState: %s." + paramBoolean);
      return;
      label79:
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      } while ((this.jdField_a_of_type_Uqv != null) && (this.jdField_a_of_type_Uqv.b()));
      this.c = true;
      ...
      return;
    } while (this.jdField_a_of_type_Uqv == null);
    this.jdField_a_of_type_Uqv.d();
  }
}
