...
{
  private avnv(QQGameFeedWebFragment paramQQGameFeedWebFragment) {}
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (QQGameFeedWebFragment.jdField_a_of_type_ArrayOfByte)
      {
        ...
        localavmq = (avmq)this.a.jdField_a_of_type_JavaUtilList.get(paramInt);
        if (localavmq == null)
        {
        ...
        if (((localavmq instanceof MoreMsgHeaderView)) && (paramInt != QQGameFeedWebFragment.a(this.a).size())) {
          return null;
        }
        if (QLog.isColorLevel()) {
          QLog.d("GameWebPage", 2, "headerView = " + localavmq.getClass().getSimpleName());
        }
        ...
        localTextView.setText(bhsw.a(this.a.getActivity(), 3, localQQGameMsgInfo.msgTime * 1000L));
        ...
        localObject1 = new RelativeLayout.LayoutParams(-2, agej.a(15.0F, this.a.getResources()));
        ...
        if (localQQGameMsgInfo != null)
        {
          localavmq.a(localQQGameMsgInfo, this.a.getActivity(), paramInt);
          if (paramInt == QQGameFeedWebFragment.a(this.a).getCurrentItem())
          {
            QQGameFeedWebFragment.a(this.a, localavmq);
            if ((localavmq instanceof GameArkView))
            {
              ((GameArkView)localavmq).setPrePause(false);
              avlb.a().a((GameArkView)localavmq);
            }
          }
          else
          {
      ...
      localavmq.a(new QQGameMsgInfo(), this.a.getActivity(), paramInt);
      continue;
      label587:
      continue;
      label590:
