  ...
  extends arpd
{
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    //   13: aload_0
    //   14: getfield 10	avnv:a	Lavnu;
    //   17: getfield 38	avnu:a	Larpd;
    //   20: getfield 42	arpd:key	I
    ...
    //   218: invokevirtual 129	avnu:callJs	(Ljava/lang/String;)V
    //   221: return
    //   222: ldc 131
    //   224: aload 4
    ...
    //   273: aload_1
    //   274: sipush 200
    //   277: invokestatic 148	bgmo:a	(Landroid/graphics/BitmapFactory$Options;Ljava/lang/String;I)Landroid/graphics/BitmapFactory$Options;
    //   280: astore 4
    //   282: aload_1
    //   283: aload 4
    ...
    //   302: iload_2
    //   303: iload_3
    //   304: invokestatic 166	bgmo:a	(Landroid/graphics/Bitmap;FII)Landroid/graphics/Bitmap;
    //   307: astore 4
    //   309: aload 4
    //   311: astore_1
    //   312: aload 4
    ...
    //   331: aload 4
    //   333: sipush 200
    //   336: invokestatic 169	bgmo:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   339: astore_1
    //   340: aload_1
    ...
    //   400: invokevirtual 129	avnu:callJs	(Ljava/lang/String;)V
    //   403: return
    //   404: astore_1
    ...
    //   442: astore_1
    //   443: goto -103 -> 340
    //   446: invokestatic 177	bgmo:a	()Landroid/graphics/Bitmap;
    //   449: astore_1
    //   450: goto -110 -> 340
    ...
    //   479: iconst_2
    //   480: invokestatic 200	bgku:encodeToString	([BI)Ljava/lang/String;
    //   483: astore 7
    //   485: aload 6
    //   487: ldc 99
    //   489: iconst_0
    ...
    //   647: aastore
    //   648: invokevirtual 220	avnu:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   651: return
    //   652: astore_1
    //   653: aload_1
