  ...
  extends aype
{
  ...
  public ayoo(ayox paramayox, aywa paramaywa, String paramString)
  {
    super(paramayox, paramaywa);
    this.jdField_c_of_type_Long = 0L;
    this.jdField_d_of_type_Long = 0L;
    this.jdField_a_of_type_Vka = vka.a();
    this.m = paramString;
  }
  ...
  public int a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "cancelTask taskId:" + this.jdField_c_of_type_Int + " mRichProtoReq:" + this.jdField_a_of_type_Ayyn + " mTrans:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction + " mNetReq:" + this.jdField_a_of_type_Aysw);
    }
  ...
  public void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localayyn.jdField_a_of_type_JavaLangString = "art_filter_up";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "sendTransferRequest:" + localayyn);
      }
  ...
  public void a(int paramInt1, int paramInt2, String paramString, int paramInt3, vkc paramvkc, boolean paramBoolean)
  {
    this.x = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_b_of_type_JavaLangString = paramString;
    this.jdField_c_of_type_Int = paramInt3;
    this.jdField_a_of_type_Vkc = paramvkc;
    this.jdField_b_of_type_Boolean = paramBoolean;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "FilterUploadInfo:" + paramvkc);
    }
    if (paramvkc == null) {
      return;
    }
    this.jdField_q_of_type_Long = paramvkc.jdField_a_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = paramvkc.jdField_a_of_type_ArrayOfByte;
    this.jdField_d_of_type_JavaLangString = paramvkc.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = (EditVideoArtFilter.jdField_a_of_type_JavaLangString + paramvkc.jdField_b_of_type_Long + "_" + paramInt2 + ".png");
    this.jdField_q_of_type_Int = paramvkc.jdField_a_of_type_Int;
    this.p = paramvkc.jdField_b_of_type_Int;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      ...
      ((Bundle)localObject).putString("param_art_filter_resource_path", this.jdField_a_of_type_Vkc.jdField_a_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Vka.callbackResult(this.x, EIPCResult.createSuccessResult((Bundle)localObject));
      this.jdField_a_of_type_Vka.jdField_a_of_type_AndroidUtilSparseArray.remove(this.jdField_b_of_type_Int);
    ...
    label604:
    axrl.a(BaseApplication.getContext()).a(null, "afCosttimeAndFlowReport", bool, this.j - this.i, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
  }
  ...
  public void a(ayyn paramayyn, ayzc paramayzc)
  {
    ...
    } while (paramayzc == null);
    int k = 0;
    label26:
    if (k < paramayzc.jdField_a_of_type_JavaUtilList.size())
    {
      paramayyn = (ayze)paramayzc.jdField_a_of_type_JavaUtilList.get(k);
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "getTransferResp:" + paramayyn);
      }
      if (paramayyn.jdField_c_of_type_Int != 0) {
        break label142;
      }
      this.m = paramayyn.jdField_c_of_type_JavaLangString;
      if (this.jdField_a_of_type_Vka.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_Vkc.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_Vka.jdField_a_of_type_JavaLangString = paramayyn.jdField_c_of_type_JavaLangString;
        aP_();
      }
    }
    for (;;)
    {
      ...
      break;
      label142:
      a(paramayyn.jdField_c_of_type_Int, "getTransferError");
    }
  }
  ...
  public final void aP_()
  {
    ...
    do
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), 1, this.jdField_a_of_type_Vkc.jdField_a_of_type_JavaLangString, (int)this.r, arrayOfByte, this.jdField_a_of_type_ArrayOfByte, localayop, (byte[])localObject);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + k + " T_ID:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " MD5:" + this.jdField_a_of_type_Vkc.jdField_a_of_type_ArrayOfByte + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath);
      }
    } while (k == 0);
  ...
  void aQ_()
  {
    ...
    Object localObject1 = new ayoq(this);
    ...
    localFilterStyle.style_name.set(ByteStringMicro.copyFrom(bbdm.a(this.jdField_b_of_type_JavaLangString)));
  ...
  public void b(String paramString)
  {
    ...
    localayrv.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localayrv.e = 0;
    localayrv.jdField_a_of_type_Ayrz = jdField_a_of_type_Ayrz;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "sendDownLoadRequest req:" + localayrv);
    }
  ...
  public void onResp(aysx paramaysx)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "getDownLoadResponse: " + paramaysx);
    }
    this.jdField_a_of_type_JavaUtilHashMap.put("downloadFileSize", String.valueOf(paramaysx.jdField_a_of_type_Long));
    ...
    if (paramaysx.jdField_a_of_type_JavaLangString != null) {
      QLog.d("ArtFilterUploadProcessor", 1, "download dailed, mErrCode" + paramaysx.jdField_b_of_type_Int + "mErrDesc:" + paramaysx.jdField_a_of_type_JavaLangString);
    }
    a(paramaysx.jdField_b_of_type_Int, paramaysx.jdField_a_of_type_JavaLangString);
  }
}
