...
public class bffl
  extends Handler
{
  public bffl(AbsPublishActivity paramAbsPublishActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              this.a.requestPermissions(new bffm(this), 1, new String[] { "android.permission.RECORD_AUDIO" });
              return;
            }
            ...
            if (this.a.q != null)
            {
              ...
              bgqv.a(this.a.o, this.a.p, "Clk_record", this.a.q, this.a.jdField_b_of_type_JavaLangString, "", "");
            }
            afez.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramMessage, PublicTransFragmentActivity.class, AudioRecordFragment.class, 1003);
            return;
          } while (!this.a.a(4));
          return;
          ...
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130843538);
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(this.a.getString(2131695588));
          this.a.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
          blgx.b(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
    ...
    if (this.a.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      paramMessage = this.a.jdField_a_of_type_Bfig;
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() < 9) {
        bool = true;
      }
    ...
    this.a.jdField_a_of_type_Bfig.a(false, true);
    this.a.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo = null;
    this.a.a(0);
