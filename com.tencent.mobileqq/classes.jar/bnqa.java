  ...
  implements Manager
{
  ...
  private CopyOnWriteArrayList<bnpz> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  private String a(RecentUser paramRecentUser)
  {
    ...
    for (;;)
    {
      ...
      continue;
      str1 = this.jdField_a_of_type_Annr.a(paramRecentUser.uin);
      continue;
      bnal.a(paramRecentUser.troopUin, paramRecentUser.uin);
      continue;
      str1 = this.jdField_a_of_type_Annr.a(paramRecentUser.troopUin, paramRecentUser.uin);
    }
  }
  
  private void a()
  {
    this.jdField_a_of_type_Annr = new annr();
    this.jdField_a_of_type_Annr.a();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    bnar.a();
  }
  
  private void a(bnpz parambnpz, int paramInt1, int paramInt2)
  {
    int i = parambnpz.jdField_b_of_type_Int;
    if (i == 1) {
      if ((paramInt1 == 1003) || (paramInt1 == 1007))
      {
        parambnpz.jdField_b_of_type_Int = 3;
        parambnpz.jdField_c_of_type_Int = 100;
      }
    }
    while ((i != 0) || ((paramInt1 != 1003) && (paramInt1 != 1007)))
    {
      ...
      {
        parambnpz.jdField_b_of_type_Int = 2;
        return;
      }
      parambnpz.jdField_c_of_type_Int = paramInt2;
      return;
    }
    parambnpz.jdField_b_of_type_Int = 3;
    parambnpz.jdField_c_of_type_Int = 100;
  ...
  private void e()
  {
    a(this.jdField_a_of_type_Annr.a(RecentUser.class, "select * from recent order by lastmsgtime desc", null));
    f();
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      ...
      {
        Collections.sort((List)localObject2, new bnps());
      ...
      {
        Collections.sort((List)localObject1, new bnps());
  ...
  private void g()
  {
    this.jdField_a_of_type_Annr.a(0, this.jdField_a_of_type_JavaUtilHashMap);
    this.jdField_a_of_type_Annr.b(1, this.jdField_a_of_type_JavaUtilHashMap);
  ...
  private void h()
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_c_of_type_Boolean))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localbnpz = new bnpz();
        localbnpz.jdField_a_of_type_JavaLangString = localRecentUser.uin;
        localbnpz.jdField_b_of_type_JavaLangString = localRecentUser.troopUin;
        if (localRecentUser.getType() == 1000)
        {
          localbnpz.jdField_c_of_type_JavaLangString = localRecentUser.displayName;
        ...
        for (;;)
        {
          ...
          {
            localPair = bnal.a(localRecentUser.uin);
            if (localPair != null)
            {
              if (((Boolean)localPair.first).booleanValue())
              {
                ...
                break;
                localbnpz.jdField_c_of_type_JavaLangString = a(localRecentUser);
                continue;
              }
              localbnpz.jdField_c_of_type_Boolean = ((Boolean)localPair.second).booleanValue();
            }
          }
        }
        localbnpz.jdField_a_of_type_Int = localRecentUser.getType();
        if ((localRecentUser.getType() == 0) && (!TextUtils.isEmpty(localbnpz.jdField_a_of_type_JavaLangString)) && ((TextUtils.isEmpty(localbnpz.jdField_c_of_type_JavaLangString)) || (localbnpz.jdField_a_of_type_JavaLangString.equals(localbnpz.jdField_c_of_type_JavaLangString)))) {
          localbnpz.jdField_c_of_type_JavaLangString = bnal.a(localbnpz.jdField_a_of_type_JavaLangString);
        }
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localbnpz);
      }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, long paramLong)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bnpq != null) && (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null) && (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0))
      {
        int j = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
        int i = 0;
        while (i < j)
        {
          bnpz localbnpz = (bnpz)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if ((!TextUtils.isEmpty(localbnpz.jdField_a_of_type_JavaLangString)) && (localbnpz.jdField_a_of_type_JavaLangString.equals(paramString)) && (localbnpz.jdField_a_of_type_Int == paramInt1) && (localbnpz.jdField_b_of_type_Boolean))
          {
            a(localbnpz, paramInt2, paramInt3);
            if (localbnpz.jdField_a_of_type_Long <= 0L) {
              localbnpz.jdField_a_of_type_Long = paramLong;
            }
            if (QLog.isColorLevel()) {
              QLog.i("SendPanelManager", 2, "updateOperateStatus operateStatus = " + localbnpz.jdField_b_of_type_Int + " ,progress = " + localbnpz.jdField_c_of_type_Int + " ,position = " + i + ", uinseq:" + localbnpz.jdField_a_of_type_Long);
            }
            this.jdField_a_of_type_AndroidOsHandler.post(new SendPanelManager.6(this, i, localbnpz));
            return;
          }
          i += 1;
        }
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null) && (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0))
      {
        ...
        while (paramString1.hasNext()) {
          ((bnpz)paramString1.next()).g = paramString2;
        }
      }
    }
  }
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() > 0)
      {
        ...
        if (j < m)
        {
          localObject2 = (bnpz)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(j);
          ((bnpz)localObject2).e = paramString2;
          ((bnpz)localObject2).f = paramString3;
          ((bnpz)localObject2).jdField_a_of_type_Boolean = paramBoolean;
          if ((TextUtils.isEmpty(((bnpz)localObject2).jdField_a_of_type_JavaLangString)) || (!((bnpz)localObject2).jdField_a_of_type_JavaLangString.equals(paramString1)) || (paramInt != ((bnpz)localObject2).jdField_a_of_type_Int)) {
            break label389;
          }
    ...
    for (;;)
    {
      ...
      {
        ((bnpz)localObject2).jdField_b_of_type_Int = 1;
        if (this.jdField_a_of_type_Bnpq != null) {
          this.jdField_a_of_type_AndroidOsHandler.post(new SendPanelManager.7(this, k, (bnpz)localObject2));
        }
        if (paramBoolean) {
          bnal.a(((bnpz)localObject2).e, paramString3, (bnpz)localObject2, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
        }
        for (;;)
        {
          ((bnpz)localObject2).jdField_b_of_type_Boolean = true;
          babc.a((bnpz)localObject2);
          bmbc.a().a(((bnpz)localObject2).g, ((bnpz)localObject2).jdField_a_of_type_Int);
          bmbx.b("SendPanelManager", "【updateFilePath】messageType:" + ((bnpz)localObject2).jdField_a_of_type_Int);
          a(paramString1, paramInt, ((bnpz)localObject2).g);
          return;
          bnal.a(paramString2, (bnpz)localObject2, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
        }
      }
      if (!QLog.isColorLevel()) {
        break;
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          bnpz localbnpz = (bnpz)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if ((!TextUtils.isEmpty(localbnpz.jdField_a_of_type_JavaLangString)) && (localbnpz.jdField_a_of_type_JavaLangString.equals(paramString1)) && (localbnpz.jdField_a_of_type_Int == 1000))
          {
            localbnpz.jdField_c_of_type_JavaLangString = paramString2;
            if (QLog.isColorLevel()) {
              QLog.e("SendPanelManager", 2, "updateTroopMemberName");
            }
            this.jdField_a_of_type_AndroidOsHandler.post(new SendPanelManager.5(this, i, localbnpz));
            return;
          }
          i += 1;
        }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Bnpq != null)
    {
      this.jdField_a_of_type_Bnpq.d();
      this.jdField_a_of_type_Bnpq = null;
    }
  }
}
