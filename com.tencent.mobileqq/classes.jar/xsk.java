...
public class xsk
{
  ...
  public xsk(BaseActivity paramBaseActivity, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = xin.b(paramBaseActivity, paramInt);
      return;
      bool = false;
    }
  }
  ...
  private void a(float paramFloat)
  {
    ...
    if (paramFloat > 0.5D)
    {
      ...
      this.b.setBackgroundResource(2130850060);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840102);
    this.b.setBackgroundResource(2130850060);
    this.b.setTextColor(this.b.getContext().getResources().getColorStateList(2131166900));
    this.c.setTextColor(this.c.getContext().getResources().getColorStateList(2131166900));
  }
  
  public void a(View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131377989));
    ...
    this.c = ((TextView)paramView.findViewById(2131368655));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368638));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      ...
      localValueAnimator.addUpdateListener(new xsl(this));
