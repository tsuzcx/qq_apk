  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public mpk(EffectCycleViewPager paramEffectCycleViewPager, ViewPager.OnPageChangeListener paramOnPageChangeListener, int paramInt)
  {
  ...
  public void onPageScrollStateChanged(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        lek.c("EffectCycleViewPager", "onPageScrollStateChanged 11:" + (this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectCycleViewPager.a.getCount() - 2));
