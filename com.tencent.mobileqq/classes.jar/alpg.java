...
public class alpg
  implements ambi, Manager
{
  int jdField_a_of_type_Int = 0;
  alpk jdField_a_of_type_Alpk;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new alph(this);
  ...
  Comparator<ApolloActionData> jdField_a_of_type_JavaUtilComparator = new alpi(this);
  
  public alpg(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetListView != null)
    {
      ...
      this.jdField_a_of_type_Alpk = null;
    }
  ...
  {
    if ((paramBaseChatPie == null) || (paramBaseChatPie.getActivity() == null) || (paramApolloActionData == null)) {
      return;
    }
    if (alnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      if (alnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()) == 1) {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (paramBaseChatPie.sessionInfo != null)) {
        this.jdField_a_of_type_Int = paramBaseChatPie.sessionInfo.curType;
      }
      BaseActivity localBaseActivity = paramBaseChatPie.getActivity();
      paramBaseChatPie = (RelativeLayout)paramBaseChatPie.getActivity().findViewById(2131364407);
      int i;
      if (this.jdField_a_of_type_ComTencentWidgetListView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetListView.setSelector(localBaseActivity.getResources().getDrawable(2130850605));
        this.jdField_a_of_type_ComTencentWidgetListView.setCacheColorHint(2131165492);
        ...
        i = AIOUtils.dp2px(9.0F, localBaseActivity.getResources());
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, i);
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(localBaseActivity.getResources().getColor(2131167019));
        ...
        this.jdField_a_of_type_Alpk = new alpk(this, localBaseActivity);
        this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Alpk);
        localObject = new RelativeLayout.LayoutParams(AIOUtils.dp2px(99.0F, localBaseActivity.getResources()), -2);
        ((RelativeLayout.LayoutParams)localObject).addRule(11);
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131368751);
        ((RelativeLayout.LayoutParams)localObject).rightMargin = AIOUtils.dp2px(10.0F, localBaseActivity.getResources());
      ...
      try
      {
        for (;;)
        {
          ...
          if (paramBaseChatPie.getBoolean("first_show_resp", true))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131699665));
            this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130838471, 0);
          }
          else
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
            continue;
            paramBaseChatPie = ContactUtils.getBuddyName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
            paramBaseChatPie = String.format(amtj.a(2131699667), new Object[] { paramBaseChatPie });
        ...
        this.jdField_a_of_type_Alpk.a(paramBaseChatPie, paramInt);
        return;
      }
  ...
  public void a(SpriteTaskParam paramSpriteTaskParam, long paramLong)
  {
    ...
    do
    {
      do
      {
        ...
        localApolloActionData = ((amir)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).b(i);
