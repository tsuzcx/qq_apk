...
import com.tencent.mobileqq.wbapi.WBShareHelper.1;
...
public class bilw
{
  private List<bilx> a = new ArrayList();
  ...
  public static Bitmap a(String paramString)
  {
    ...
    //   15: astore_2
    //   16: aload_1
    //   17: invokestatic 95	avce:a	(Ljava/io/Closeable;)V
    //   20: aload_2
    //   21: areturn
    //   22: astore_2
    //   23: aconst_null
    ...
    //   36: aload_1
    //   37: invokestatic 95	avce:a	(Ljava/io/Closeable;)V
    //   40: aconst_null
    //   41: areturn
    //   42: astore_2
    //   43: aconst_null
    ...
    //   56: aload_1
    //   57: invokestatic 95	avce:a	(Ljava/io/Closeable;)V
    //   60: aconst_null
    //   61: areturn
    //   62: astore_0
    //   63: aconst_null
    ...
    //   66: astore_1
    //   67: aload_2
    //   68: invokestatic 95	avce:a	(Ljava/io/Closeable;)V
    //   71: aload_1
    //   72: athrow
    //   73: astore_1
    //   74: aload_0
  ...
  public static bilw a(int paramInt)
  {
  ...
  private IWBAPI a(Activity paramActivity)
  {
    ...
    {
      bilx localbilx = (bilx)((Iterator)localObject).next();
      if (localbilx.a.get() == null) {
        ((Iterator)localObject).remove();
      }
      if ((localbilx.a.get() == paramActivity) && (localbilx.b.get() != null)) {
        return (IWBAPI)localbilx.b.get();
      }
    }
    localObject = WBAPIFactory.createWBAPI(paramActivity);
    ((IWBAPI)localObject).setLoggerEnable(false);
    this.a.add(new bilx(paramActivity, (IWBAPI)localObject));
    return localObject;
  }
  ...
  {
    if ("com.tencent.mobileqq".equals(bjrc.r())) {
      a(paramActivity, paramWeiboMultiMessage);
    }
    for (;;)
    {
      return true;
      bilt.a(new WBShareHelper.1(this, paramActivity, paramWeiboMultiMessage));
    }
  }
  ...
  private boolean c(Activity paramActivity, String paramString)
  {
    ...
    //   7: astore_3
    //   8: aload_2
    //   9: invokestatic 284	bilw:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   12: astore_2
    //   13: aload_2
    //   14: ifnonnull +21 -> 35
    //   17: ldc 18
    ...
    //   26: aload_1
    //   27: ldc_w 288
    //   30: invokestatic 277	avce:a	(Landroid/content/Context;Ljava/lang/String;)V
    //   33: iconst_0
    //   34: ireturn
    //   35: aload_3
    //   36: aload_2
    ...
    //   58: aload_1
    //   59: ldc_w 299
    //   62: invokestatic 277	avce:a	(Landroid/content/Context;Ljava/lang/String;)V
    //   65: ldc 18
    //   67: iconst_1
    //   68: iconst_4
    ...
    //   79: iconst_1
    //   80: aload_2
    //   81: invokestatic 303	bilw:a	(Landroid/graphics/Bitmap;)I
    ...
    //   108: aload_0
    //   109: aload_2
    //   110: invokevirtual 308	bilw:a	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   113: astore_2
    //   114: aload_3
    //   115: aload_2
    ...
    //   177: aload_1
    //   178: aload_2
    //   179: invokespecial 321	bilw:a	(Landroid/app/Activity;Lcom/sina/weibo/sdk/api/WeiboMultiMessage;)Z
    //   182: ireturn
    //   183: astore_2
    //   184: ldc 18
    //   186: iconst_1
  ...
  public boolean a(Activity paramActivity, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      avce.a(paramActivity, "文本为空，禁止分享");
      return false;
    }
  ...
  public boolean a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap)
  {
    ...
    if (paramBitmap != null) {
      ...
      {
        avce.a(paramActivity, "图片太大，请业务压缩");
  ...
  public boolean a(Activity paramActivity, String paramString, ArrayList<Uri> paramArrayList)
  {
    ...
    if (!a(paramActivity).isWBAppSupportMultipleImage())
    {
      ...
      avce.a(paramActivity, "版本较低，不支持多图分享");
      return false;
    }
  ...
  public boolean b(Activity paramActivity, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      avce.a(paramActivity, "图片为空，禁止分享");
      return false;
    }
