  ...
  extends uqd
{
  ...
  public String a;
  public uxp a;
  private uxr jdField_a_of_type_Uxr;
  public long b;
  public String b;
  public List<vgw> b;
  public long c;
  ...
  public uqf(PublishVideoEntry paramPublishVideoEntry)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Uxp = a().getLinkInfo();
  ...
  public uqf(StoryVideoItem paramStoryVideoItem)
  {
    ...
    this.jdField_a_of_type_Uxp = uxp.a(paramStoryVideoItem.mLinkInfoJson);
    this.n = paramStoryVideoItem.originalAuthorUnionId;
    this.o = paramStoryVideoItem.originalAuthorName;
  }
  
  public uqf(String paramString)
  {
    this.p = paramString;
    xqq.a(paramString);
  }
  ...
  private int a()
  {
    ...
    if ((arrayOfByte != null) && (arrayOfByte.length > 0))
    {
      ...
      try
      {
        ...
        int i1 = new ulr(localAppInterface, localVideoReaderConf).jdField_a_of_type_Int;
        return i1;
      }
  ...
  private xof a()
  {
    ...
    if ((localObject != null) && (localObject.length > 0))
    {
      ...
      try
      {
        ...
        localObject = new xof(localTagInfoBase);
        return localObject;
      }
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
  ...
  public StoryVideoItem a()
  {
    ...
    if (TextUtils.isEmpty(localStoryVideoItem.mPublishDate)) {
      localStoryVideoItem.mPublishDate = woy.a().format(new Date(this.jdField_d_of_type_Long));
    }
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      if (this.jdField_a_of_type_Uxp != null) {
        localStoryVideoItem.mLinkInfoJson = this.jdField_a_of_type_Uxp.a(false);
      }
      localStoryVideoItem.mGameInfoJson = a().getStringExtra("game", null);
      localStoryVideoItem.mGameInfo = uxn.a(localStoryVideoItem.mGameInfoJson);
  ...
  public GeneralFeedItem a()
  {
    ...
    String str2 = localwoy.a(QQStoryContext.a().b(), str3);
    wxe.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "find true feedId:%s", str2);
    String str1 = str2;
    if (TextUtils.isEmpty(str2))
    {
      str1 = VideoListFeedItem.makeFakeFeedId(QQStoryContext.a().b(), str3);
      wxe.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "make fake feedId:%s", str1);
    }
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = ((GeneralFeedItem)localwoy.a(str1));
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem == null)
    {
      this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = GeneralFeedItem.createFakeFeedItem(str3);
      localwoy.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
      wxe.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "save fake item %s", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem.feedId);
    }
    return this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem;
  }
  ...
  public uxr a()
  {
    ...
    if ((this.jdField_a_of_type_Uxr == null) && (a().spreadGroupBytes != null) && (a().spreadGroupBytes.length > 0)) {
      localVideoSpreadGroupList = new qqstory_struct.VideoSpreadGroupList();
    }
    try
    {
      localVideoSpreadGroupList.mergeFrom(a().spreadGroupBytes);
      this.jdField_a_of_type_Uxr = new uxr(localVideoSpreadGroupList);
      return this.jdField_a_of_type_Uxr;
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      for (;;)
      {
        wxe.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "decode spread group fail", localInvalidProtocolBufferMicroException);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    ((woy)uwa.a(11)).a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
  }
