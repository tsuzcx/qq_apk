  ...
  implements WeiyunTransmissionGlobal.HostInterface
{
  ...
  public void fetchUploadServerInfo(UploadFile paramUploadFile, UploadType paramUploadType, WeiyunTransmissionGlobal.UploadServerInfoCallback paramUploadServerInfoCallback)
  {
    if (paramUploadFile.cmdType == 1)
    {
      ...
      if ((paramUploadFile.isCompress) && (!TextUtils.isEmpty(paramUploadFile.compressedPath)))
      {
        if (paramUploadFile.compressedSha != null) {
          ((WeiyunPB.DiskPicBackupReq)localObject).file_sha.set(bifn.a(paramUploadFile.compressedSha));
        }
        ((WeiyunPB.DiskPicBackupReq)localObject).file_size.set(paramUploadFile.compressedSize);
        ((WeiyunPB.DiskPicBackupReq)localObject).first_256k_crc.set((int)bifg.a(paramUploadFile.compressedPath, 262144L));
        ...
        bidq.a((WeiyunPB.DiskPicBackupReq)localObject, new bicr(this, paramUploadServerInfoCallback, paramUploadFile));
      }
    }
    label311:
    while (paramUploadFile.cmdType != 0) {
      for (;;)
      {
        ...
        if (paramUploadFile.sha != null) {
          ((WeiyunPB.DiskPicBackupReq)localObject).file_sha.set(bifn.a(paramUploadFile.sha));
        }
        ((WeiyunPB.DiskPicBackupReq)localObject).file_size.set(paramUploadFile.fileSize);
        ((WeiyunPB.DiskPicBackupReq)localObject).first_256k_crc.set((int)bifg.a(paramUploadFile.localPath, 262144L));
        continue;
    ...
    ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).pdir_key.set(bifn.a(paramUploadFile.pDirKey));
    ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).ppdir_key.set(bifn.a(paramUploadFile.pPDirKey));
    ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).use_mutil_channel.set(WeiyunTransmissionGlobal.getInstance().isNativeUpload());
    if ((paramUploadFile.isCompress) && (!TextUtils.isEmpty(paramUploadFile.compressedPath)))
    {
      if (paramUploadFile.compressedSha != null) {
        ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).file_sha.set(bifn.a(paramUploadFile.compressedSha));
      }
    ...
    for (;;)
    {
      ...
      bidq.a((WeiyunPB.QqSdkFileUploadMsgReq)localObject, new bics(this, paramUploadServerInfoCallback, paramUploadFile));
      return;
      if (paramUploadFile.sha != null) {
        ((WeiyunPB.QqSdkFileUploadMsgReq)localObject).file_sha.set(bifn.a(paramUploadFile.sha));
      }
