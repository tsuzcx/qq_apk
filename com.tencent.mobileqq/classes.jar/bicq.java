  ...
  implements bicx
{
  ...
  public bicq()
  {
    bdot.b("WadlProxyServiceWrap", "##@WadlProxyServiceWrap()");
    this.a = new bici();
    bicy.a().a(this);
  }
  ...
  public void a()
  {
    bdot.b("WadlProxyServiceWrap", "##@launchService");
    this.a.a();
  }
  
  public void a(int paramInt, String paramString)
  {
    bdot.b("WadlProxyServiceWrap", "doPauseAction from=" + paramInt + ",appId=" + paramString);
  ...
  {
    bdot.b("WadlProxyServiceWrap", "doDownloadAction wadlParams=" + paramWadlParams);
    Bundle localBundle = new Bundle();
    ...
    bicy.a().a(paramWadlParams, localBundle);
  }
  
  public void a(String paramString)
  {
    bdot.b("WadlProxyServiceWrap", "doQueryActionByVia via=" + paramString);
    Bundle localBundle = new Bundle();
  ...
  {
    bdot.b("WadlProxyServiceWrap", "receive system receiver cmd=" + paramString1 + ",packageName=" + paramString2);
    Bundle localBundle = new Bundle();
  ...
  {
    bdot.b("WadlProxyServiceWrap", "doQueryAction:" + paramArrayList.toString());
    Bundle localBundle = new Bundle();
  ...
  public void b()
  {
    bdot.b("WadlProxyServiceWrap", "doQueryAllTask");
    Bundle localBundle = new Bundle();
  ...
  {
    bdot.b("WadlProxyServiceWrap", "doResumeAction from=" + paramInt + ",appId=" + paramString);
    Bundle localBundle = new Bundle();
  ...
  {
    bdot.b("WadlProxyServiceWrap", "doInstallAction：" + paramWadlParams);
    Bundle localBundle = new Bundle();
    ...
    try
    {
      bdpe.a(paramWadlParams.j, paramWadlParams.a);
      return;
    }
    catch (Exception paramWadlParams)
    {
      bdot.a("WadlProxyServiceWrap", "savePackageInfo", paramWadlParams);
    }
  }
  
  public void c()
  {
    bdot.b("WadlProxyServiceWrap", "initWadlTaskManager:");
    Bundle localBundle = new Bundle();
  ...
  {
    bdot.b("WadlProxyServiceWrap", "##@deleteDownload from=" + paramInt + ",appID=" + paramString);
    Bundle localBundle = new Bundle();
  ...
  public void onCmdRsp(android.content.Intent paramIntent, String paramString, long paramLong, org.json.JSONObject paramJSONObject)
  {
    ...
    //   30: invokestatic 22	bdot:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   33: ldc 196
    //   35: aload_2
    ...
    //   278: aload_0
    //   279: getfield 27	bicq:a	Lbici;
    //   282: aload 12
    //   284: invokevirtual 92	bici:a	(Landroid/os/Bundle;)V
    //   287: aload 13
    ...
    //   297: invokestatic 169	bdpe:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   300: pop
    //   301: return
    //   302: astore_1
    //   303: ldc 14
    //   305: ldc 171
    //   307: aload_1
    //   308: invokestatic 174	bdot:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   311: return
    //   312: aload 13
    ...
    //   360: ldc_w 280
    //   363: aload_1
    //   364: invokestatic 174	bdot:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   367: goto -98 -> 269
    //   370: astore 14
    //   372: iload 7
    //   374: istore 6
