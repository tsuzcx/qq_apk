  ...
  extends BusinessHandler
{
  ...
  {
    paramObject = (amwo)this.app.getManager(92);
    Object localObject;
  ...
  private void a(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg, int paramInt, amwo paramamwo)
  {
    int i = 0;
  ...
  private void a(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg, ToServiceMsg paramToServiceMsg, amwo paramamwo)
  {
    paramOIDBSSOPkg = paramOIDBSSOPkg.bytes_bodybuffer.get().toByteArray();
    ...
    for (int m = PkgTools.getShortData(paramOIDBSSOPkg, 4);; m = 0)
    {
      ...
      for (int n = PkgTools.getShortData(paramOIDBSSOPkg, 6);; n = 0)
      {
        ...
        for (;;)
        {
          ...
          paramamwo.a().a(l, k, i2, (int)arrayOfLong[i1], i3);
          if (i2 - 1 > 0)
          {
            i3 = i2 - 1;
            i2 = k;
          ...
          while ((i2 < m) || ((i2 == m) && (k < n)))
          {
            paramamwo.b(i6, i7, i4);
            paramamwo.a().a(String.valueOf(l), m, n, i, j);
            paramamwo.m();
            paramamwo.c();
            paramamwo.a(2003);
            paramamwo.a(18, null);
    ...
    if (1000 == i)
    {
      ...
      if (paramToServiceMsg != null)
      {
        ...
        if (paramToServiceMsg.uint32_result.has())
        {
          ...
          if (j == 0)
          {
            paramToServiceMsg = (amwo)this.app.getManager(92);
            i = j;
            if (paramToServiceMsg != null) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ((amwo)this.app.getManager(92)).a(34, null);
      return;
      bool = false;
      break;
      bool = false;
  ...
  public amwl a(int paramInt)
  {
    ...
    {
      anxb localanxb = new anxb(this, paramInt);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localanxb);
    }
    return (amwl)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
  }
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean, int paramInt)
  {
    ...
    paramString = (amwo)this.app.getManager(92);
    if (paramBoolean) {}
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    paramCalendar = localamwo.a((Calendar)paramCalendar.clone());
    long l1 = ((Long)paramCalendar.first).longValue();
    long l2 = ((Long)paramCalendar.second).longValue();
    this.app.getMsgHandler().a(paramString, l1, 0L, l2, (short)0, 0L, 1, localamwo.a(), localamwo.b(), paramBoolean1, paramInt, paramBoolean2, paramBoolean3);
  }
  ...
  {
    amwo localamwo = (amwo)this.app.getManager(92);
    Object localObject = localamwo.a(paramCalendar);
    if (localObject == null)
    {
      if (QLog.isColorLevel()) {
    ...
    {
      localamwo.a((Calendar)localObject);
    ...
    {
      localamwo.a((Calendar)localObject);
      paramCalendar = localamwo.a((Calendar)((Calendar)localObject).clone());
      int m = localamwo.a(paramString, ((Long)paramCalendar.first).longValue(), ((Long)paramCalendar.second).longValue());
      if (QLog.isColorLevel()) {
  ...
  public amwl b(int paramInt)
  {
    amwl localamwl = (amwl)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
