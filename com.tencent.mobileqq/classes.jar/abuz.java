  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                  ...
                  for (;;)
                  {
                    ...
                    if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StartVideoChat"))
                    {
                      ...
                      for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                      {
                        ...
                        abux.a(this.a).add(paramContext);
                        return;
                      }
                    }
                    int i;
                    if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceAdminUnbind"))
                    {
                      ...
                      if (abux.a(this.a).contains(paramContext) != true)
                      {
                        this.a.app.a().a(paramContext.toString(), 9501);
                        return;
                      }
                      if (paramContext.longValue() != 0L) {
                        abux.b(this.a).add(paramContext);
                      }
                    }
                    else if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StopVideoChat"))
                    {
                      ...
                      for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                      {
                        ...
                        if ((i != 0) || (paramContext != null) || (paramIntent.longValue() == 0L) || (!abux.b(this.a).contains(paramIntent))) {
                          break;
                        }
                        this.a.app.a().a(paramIntent.toString(), 9501);
                        abux.b(this.a).remove(paramIntent);
                        return;
                      }
                      if (paramIntent.longValue() != 0L) {
                        abux.a(this.a).remove(paramIntent);
                      }
                    }
                    else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_receiveDPMsg"))
                    {
                      ...
                      if (localObject1 == null)
                      {
                        ...
                        QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "dp is null in DeviceMsgHandler::onreceive");
                        return;
                      }
                      paramIntent = ((abqn)this.a.app.a(51)).a(((DataPoint)localObject1).mDin);
                      i = 0;
                      if (paramIntent != null) {
                      ...
                      if ((11015 == ((DataPoint)localObject1).mProperityId) || (((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012)) {
                        if (QLog.isColorLevel()) {
                          QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "device info pid is 0; dp.mDin = " + ((DataPoint)localObject1).mDin);
                        }
                      }
                      for (;;)
                      {
                        ...
                        {
                          this.a.jdField_a_of_type_Abur.a((DataPoint)localObject1);
                          if (abux.a(this.a, ((DataPoint)localObject1).mValue)) {
                            break;
                          }
                          abux.a(this.a);
                          return;
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            if (paramContext.optInt("flag") == 0)
                            {
                              ...
                              QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "PID_MSG_PROXY JSON :" + ((DataPoint)localObject1).mValue);
                              return;
                            }
                          }
                      ...
                      {
                        this.a.jdField_a_of_type_Abrv.a((DataPoint)localObject1);
                        accz.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 2, 0, i);
                        if (abux.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abux.a(this.a);
                      ...
                      if (10007 == ((DataPoint)localObject1).mProperityId)
                      {
                        for (;;)
                        {
                          ...
                          catch (Exception paramIntent)
                          {
                            try
                            {
                              ...
                              {
                                paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                                paramContext.optLong("msg_time", bbyp.a());
                                paramContext = paramContext.optString("text", " ");
                                this.a.a(String.valueOf(((DataPoint)localObject1).mDin), paramContext, bbyp.a(), true, false, true);
                                return;
                              }
                              catch (Exception paramContext) {}
                              if (!QLog.isColorLevel()) {
                              ...
                              QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "onRecvRawTextMsg parse from json error:" + paramContext.getMessage());
                              return;
                            }
                            catch (Exception paramIntent)
                            {
                        ...
                        accz.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 1, 0, i);
                        if (abux.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abux.a(this.a);
                      ...
                      {
                        this.a.jdField_a_of_type_Abuw.a((DataPoint)localObject1);
                        if (abux.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abux.a(this.a);
                      ...
                      if (10009 == ((DataPoint)localObject1).mProperityId)
                      {
                        try
                        {
                          ...
                          localObject4 = (MessageForDevLittleVideo)bbzh.a(-4509);
                          ...
                          ((MessageForDevLittleVideo)localObject4).time = bbyp.a();
                          ((MessageForDevLittleVideo)localObject4).msg = (bglf.b(this.a.app, ((MessageForDevLittleVideo)localObject4).senderuin, true) + anni.a(2131701968));
                        ...
                        QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "getString from json error:" + paramContext.getMessage());
                        return;
                      }
                      if (((DataPoint)localObject1).mProperityId == 10008)
                      {
                        try
                        {
                          ...
                          l1 = paramIntent.optLong("msg_time", bbyp.a());
                          paramIntent = paramIntent.optString("text", " ");
                          l2 = ((DataPoint)localObject1).mDin;
                          abux.a(this.a, l2, paramContext, paramIntent, l1, true);
                          if (abux.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          abux.a(this.a);
                    ...
                    try
                    {
                      if (!DeviceTipActivity.a)
                      {
                        ...
                        l2 = ((JSONObject)localObject2).optLong("appear_time", bbyp.a());
                        ...
                        if (QLog.isColorLevel())
                        {
                          QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "ReceiveDoorTip appear_time= " + l2 + " : serverTime = " + bbyp.a() + " loginTimeStr= " + (String)localObject2);
                          i = (int)(bbyp.a() - l2);
                          QQToast.a(this.a.app.getApp(), anni.a(2131701965) + i + anni.a(2131701967), 1).a();
                        }
                        if (l1 - l2 > 1L)
                        {
                          if (QLog.isColorLevel()) {
                            QQToast.a(this.a.app.getApp(), "该消息是手Q登录前" + (l1 - l2) + anni.a(2131701976), 1).a();
                          }
                          this.a.a(paramContext, anni.a(2131701970), l2, "");
                          return;
                        }
                        if (bbyp.a() - l2 <= 30L)
                        {
                    ...
                    if (((DataPoint)localObject1).mProperityId == 1600006)
                    {
                      try
                      {
                        ...
                        l1 = paramContext.optLong("msg_time", bbyp.a());
                    ...
                    if (((DataPoint)localObject1).mProperityId == 10004)
                    {
                      try
                      {
                        ...
                        l1 = paramIntent.optLong("msg_time", bbyp.a());
                        abux.a(this.a, paramContext, Long.toString(((DataPoint)localObject1).mDin), (String)localObject2, (String)localObject3, (String)localObject4, str1, str2, l1);
                        if (abux.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abux.a(this.a);
                    ...
                    else if (((DataPoint)localObject1).mProperityId == 11010)
                    {
                      try
                      {
                        ...
                        paramContext = bbzh.a(this.a.app, ((SessionInfo)localObject5).jdField_a_of_type_JavaLangString, ((SessionInfo)localObject5).b, ((SessionInfo)localObject5).jdField_a_of_type_Int, paramContext);
                    ...
                    else if ((((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012))
                    {
                      ...
                      {
                        paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                        acda.a(this.a.app, paramContext, String.valueOf(((DataPoint)localObject1).mDin));
                        if (abux.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        abux.a(this.a);
                      ...
                      if (QLog.isColorLevel()) {
                        QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "auth_request_structmsg:" + paramContext.getMessage());
                      }
                    }
                    else if (((DataPoint)localObject1).mProperityId == 700154)
                    {
                      try
                      {
                        ...
                        if (QLog.isColorLevel()) {
                          QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "openav roomId:" + i + ",sessionId:" + paramContext + ", cTime: " + j + ", cmd:" + k);
                        }
                        if (k != 1) {
                          continue;
                        }
                      ...
                      if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_sendCCDataPointMsgResult"))
                      {
                        ...
                        if (bool)
                        {
                          abux.a(this.a, String.valueOf(l1), i);
                          return;
                        }
                        abux.b(this.a, String.valueOf(l1), i);
                        return;
                      }
                      ...
                      else
                      {
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferComplete"))
                        {
                          ...
                          if ((l1 != 0L) && (this.a.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l1))))
                          {
                            ...
                            paramIntent = anhk.ba + "/smart_device/" + paramIntent.getName();
                            bgmg.b((String)localObject1, paramIntent);
                            ...
                            paramContext.srcFileName = atvo.a(paramIntent);
                            paramContext.fileSize = atvo.a(paramIntent);
                            paramContext.msg = (bglf.b(this.a.app, paramContext.senderuin, true) + ": " + this.a.app.getApp().getString(2131691400));
                            paramContext.serial();
                            this.a.app.a().a(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                        ...
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceVasFlagChange"))
                        {
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            localObject1 = (abqn)this.a.app.a(51);
                            localObject2 = ((abqn)localObject1).a(l1);
                            paramIntent = "";
                            ...
                            {
                              paramIntent = this.a.app.getApp().getString(2131694152).split(":")[0];
                              paramContext = paramIntent;
                              if (((DeviceInfo)localObject2).isAdmin != 1)
                              {
                                ((abqn)localObject1).a(((DeviceInfo)localObject2).productId, ((DeviceInfo)localObject2).serialNum);
                                paramContext = paramIntent;
                              }
                            }
                            ...
                            {
                              ahzf.W = true;
                              paramContext = paramContext + this.a.app.getApp().getString(2131691373);
                              this.a.a(l1 + "", paramContext, bbyp.a(), true, false, 1);
                              return;
                            }
                            if ((i == 0) && (((DeviceInfo)localObject2).isAdmin != 1))
                            {
                              ahzf.W = false;
                              paramContext = paramContext + this.a.app.getApp().getString(2131691372);
                              this.a.a(l1 + "", paramContext, bbyp.a(), true, false, true);
                            }
                          }
                        }
                        else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_QueryIsDeviceBinded"))
                        {
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            localObject1 = bglf.b(this.a.app, l1 + "", true);
                        ...
                        else
                        {
                          ...
                          paramContext = (abqn)this.a.app.a(51);
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            if (localObject1 != null)
                            {
                              ...
                              for (paramContext = anni.a(2131701978); !TextUtils.isEmpty(paramContext); paramContext = anni.a(2131701975) + ((ProductInfo)localObject1).deviceName)
                              {
                                localObject1 = bglf.b(this.a.app, Long.toString(((Long)localObject3).longValue()), true);
                                paramIntent = (Intent)localObject1;
                                if (TextUtils.isEmpty((CharSequence)localObject1)) {
                                  paramIntent = String.valueOf(localObject3);
                                }
                                paramContext = paramIntent + paramContext;
                                this.a.a(localObject2 + "", paramContext, bbyp.a(), true, false, true);
                                return;
                ...
                paramContext = anni.a(2131701966);
          ...
          } while ((localObject1 != null) && (((abqn)localObject1).a(l1, 13)));
          if (asfr.a().a(this.a.app, paramContext) != 0) {
            this.a.a(l1 + "", "【重要！设备安全提醒】\n\n为防止QQ号被盗/丢失手机，导致设备被人恶意控制\n请点这里开启QQ设备锁\n\n\n查看QQ设备锁介绍", bbyp.a(), "device_lock_msg");
          }
          localObject2 = ((abqn)localObject1).a(l1);
          paramIntent = "";
          if (localObject2 != null) {
        ...
        } while ((localObject2 == null) || (((DeviceInfo)localObject2).isAdmin == 1) || (!((abqn)localObject1).a(l1).booleanValue()));
        paramContext = paramContext + this.a.app.getApp().getString(2131691373);
        this.a.a(l1 + "", paramContext, bbyp.a(), true, false, 1);
        return;
        ...
        if (QLog.isColorLevel()) {
          QLog.d(abux.jdField_a_of_type_JavaLangString, 2, "DeviceMsghandle intent.getExtras() : " + paramIntent.getExtras());
        }
        paramContext = paramIntent.getExtras();
      ...
      localObject1 = bglf.b(this.a.app, paramContext, true);
      if ((TextUtils.isEmpty((CharSequence)localObject1)) || (paramContext.equals(localObject1))) {}
      for (paramContext = anni.a(2131701985);; paramContext = (String)localObject1 + anni.a(2131701974))
      {
        this.a.a(String.valueOf(paramIntent), paramContext, bbyp.a(), "");
        abux.a(this.a);
        return;
      }
      if ("SmartDevice_sendToAIO_Capture".equals(paramIntent.getAction()))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("msg_time", bbyp.a());
          ((JSONObject)localObject2).put("guidewords", anni.a(2131701972));
          ((JSONObject)localObject2).put("appear_time", bbyp.a());
          ((JSONObject)localObject2).put("digest", anni.a(2131701981));
          ((JSONObject)localObject2).put("title", anni.a(2131701984));
          paramIntent = (MessageForDeviceSingleStruct)bbzh.a(-4502);
          ...
          paramIntent.strMediaFileName = atvo.a((String)localObject1);
    ...
    try
    {
      ...
      ((JSONObject)localObject3).put("msg_time", bbyp.a());
      ((JSONObject)localObject3).put("guidewords", anni.a(2131701983));
      ((JSONObject)localObject3).put("appear_time", bbyp.a());
      ...
      localObject2 = (MessageForDeviceSingleStruct)bbzh.a(-4502);
      ...
      ((MessageForDeviceSingleStruct)localObject2).strMediaFileName = atvo.a(paramIntent);
      ((MessageForDeviceSingleStruct)localObject2).nMediaFileSize = bgmg.a(paramIntent);
