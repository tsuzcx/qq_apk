  ...
  implements pgd
{
  ...
  public pgq(Context paramContext, ArticleInfo paramArticleInfo1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean, int paramInt5, ArticleInfo paramArticleInfo2, rqj paramrqj)
  {
  ...
  public int b()
  {
    ...
    return this.jdField_a_of_type_Rqj.getItemViewType(this.jdField_b_of_type_Int + 1);
  }
  ...
  public int c()
  {
    return qfg.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
  }
