...
{
  public rxl(BaseChatPie paramBaseChatPie) {}
  ...
  protected void onAddFriend(String paramString)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new rxm(this));
        return;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (MultiMsgManager.a().b.size() == 0) {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131433438, 0).b(this.a.a());
        }
        while (QLog.isDevelopLevel())
        {
  ...
  protected void onGetSigZanInfo(boolean paramBoolean, Object paramObject)
  {
    ...
    ThreadManager.post(new rxo(this, (RichStatus.SigZanInfo)paramObject), 5, null, false);
  }
  ...
  protected void onQueryUinSafetyFlag(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new rxn(this, paramLong));
  }
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map paramMap)
  {
    if ((!paramBoolean) && (this.a.q())) {
      QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2130838748, this.a.jdField_a_of_type_AndroidContentContext.getString(2131434530), 0).b(this.a.a());
    }
  }
