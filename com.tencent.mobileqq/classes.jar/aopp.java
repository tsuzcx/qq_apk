  ...
  implements aopv
{
  ...
  protected aopp(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, aytb paramaytb)
  {
  ...
  private aopq a()
  {
    aopq localaopq = new aopq(this);
    if ((this.jdField_a_of_type_Ayst != null) && ((this.jdField_a_of_type_Ayst instanceof aopu)))
    {
      aopu localaopu = (aopu)this.jdField_a_of_type_Ayst;
      localaopq.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo = localaopu.a();
      localaopq.jdField_a_of_type_Int = localaopu.a();
    }
    return localaopq;
  }
  
  public static aysz a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, aytb paramaytb)
  {
    if (paramLong == 0L)
    {
      aysb.a("ExcitingTransfer.ExtfGroupDownloadWorker", aysb.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      aysb.a("ExcitingTransfer.ExtfGroupDownloadWorker", aysb.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null)
    {
      aysb.a("ExcitingTransfer.ExtfGroupDownloadWorker", aysb.jdField_a_of_type_Int, "getWoker. item.id=null");
      return null;
    }
    return new aopp(paramLong, paramItem, paramBundle, paramaytb);
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt1 == 0)
    {
      bool = true;
      localObject = a();
      localaopo = new aopo(ayrz.a());
      String str = apck.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
      localaopo.a(paramInt1, paramInt2, str, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
      ...
      localaopo.c(this.g);
      label100:
      if ((localObject == null) || (((aopq)localObject).jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo == null)) {
        break label161;
      }
      localaopo.a(((aopq)localObject).jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo);
    }
    for (;;)
    {
      localaopo.a(this.jdField_a_of_type_Long);
      localaopo.a(bool);
      return;
      bool = false;
      break;
      ...
      if (this.jdField_a_of_type_Ayrn.jdField_a_of_type_Long > 0L) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_uStartSize = this.jdField_a_of_type_Ayrn.jdField_a_of_type_Long;
      }
      if (this.jdField_a_of_type_Ayrn.jdField_b_of_type_Long > 0L) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_uDownloadedSize = this.jdField_a_of_type_Ayrn.jdField_b_of_type_Long;
      }
      if (paramInt3 != 0) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_nSrvReturnCode = paramInt3;
      }
      localaopo.a((ExcitingTransferDownloadCompletedInfo)localObject);
    }
  }
  ...
  private int b(int paramInt)
  {
    ...
    if (azzu.a()) {}
    for (long l1 = azzu.a() * 1024L;; l1 = azzu.b() * 1024L)
    {
  ...
  private void l()
  {
    ...
    aopo localaopo = new aopo(ayrz.a());
    Object localObject = apck.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
    localaopo.a(1, i, (String)localObject, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
    if ((this.f > 0L) && (this.g >= this.f))
    {
      localaopo.b(this.f);
      localaopo.c(this.g);
  ...
  protected ayst a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    if (apck.b(paramString1)) {
      this.jdField_a_of_type_Boolean = true;
    }
    aopt localaopt = new aopt();
    localaopt.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal);
    localaopt.b(paramString2);
    localaopt.c(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.cookieValue);
    ...
    localaopt.a(paramString3);
    paramString2 = new ArrayList();
    paramString2.add(new ExcitingTransferHostInfo(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadIp, 80));
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS))
    {
      paramString3 = new ExcitingTransferHostInfo(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS, 80);
      if (!apdq.b(paramQQAppInterface)) {
        break label342;
      }
    ...
    for (;;)
    {
      localaopt.a(paramString2);
      paramQQAppInterface = aopu.a(paramQQAppInterface, paramLong, this.jdField_b_of_type_Long, paramString1, localaopt);
      if (paramQQAppInterface == null) {
        break;
      }
      ((aopu)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (int i = paramExcitingTransferOneSlotComplete.m_SrvRetCode;; i = 0)
    {
      ...
      this.jdField_a_of_type_Ayrn.d = 0;
      if (paramExcitingTransferOneSlotComplete != null)
      {
        aopr localaopr = new aopr(ayrz.a());
        localaopr.a(this.jdField_a_of_type_Long);
        String str = apck.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
        i = b(paramInt);
        if (i == 3) {
          paramInt = 5;
        ...
        for (;;)
        {
          localaopr.a(paramInt, i, str, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
          localaopr.a(paramExcitingTransferOneSlotComplete);
          localaopr.a();
          return;
          paramInt = j;
          if (i != 506) {
  ...
  public void a(String paramString)
  {
    if (b())
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal >= this.jdField_a_of_type_Ayrn.jdField_a_of_type_Long) {
        this.d = (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal - this.jdField_a_of_type_Ayrn.jdField_a_of_type_Long);
      }
      if (!bace.a(paramString))
      {
        aysb.a("ExcitingTransfer.ExtfGroupDownloadWorker", aysb.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "]  onDownloadSuccess but file is not exsited." + paramString);
        a(7, 706);
        a(true, azle.b, azle.o, 307);
      }
      do
      {
        return;
        long l = apck.a(paramString);
        ...
        {
          aysb.a("ExcitingTransfer.ExtfGroupDownloadWorker", aysb.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "]  file size check fail. filesize:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal + " transSize:" + l);
          a(7, 704);
          a(true, azle.b, azle.q, 305);
          new File(paramString).delete();
          this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressValue = 0L;
          return;
        }
        aysb.c("ExcitingTransfer.ExtfGroupDownloadWorker", aysb.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onDownlaodSuc  mFilePath:" + paramString);
  ...
  protected void b()
  {
    ...
    if (b())
    {
      if ((this.jdField_a_of_type_Ayrn.jdField_c_of_type_Int == 8) || (this.jdField_a_of_type_Ayrn.jdField_c_of_type_Int == 11) || (this.jdField_a_of_type_Ayrn.jdField_c_of_type_Int == 12)) {
        l();
      }
    }
    else {
    ...
    int j;
    int i;
    if ((localaopq != null) && (localaopq.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null))
    {
      j = b(localaopq.jdField_a_of_type_Int);
      i = 4;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        a(m, j, n);
        return;
        j = this.jdField_a_of_type_Ayrn.d;
        i = j;
        if (j == 0) {
          i = this.jdField_a_of_type_Ayrn.jdField_c_of_type_Int;
        }
        if (this.jdField_c_of_type_Long == 0L)
        {
          k = c(this.jdField_a_of_type_Ayrn.jdField_c_of_type_Int, this.jdField_a_of_type_Ayrn.d);
          if (!this.jdField_c_of_type_Boolean) {
            break label220;
          }
          n = this.jdField_a_of_type_Ayrn.d;
          i = 2;
          j = 7;
          k = 0;
          break;
  ...
  protected void c()
  {
    ...
    if (b())
    {
      ...
      if ((localaopq != null) && (localaopq.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null))
      {
        this.jdField_a_of_type_Ayrn.jdField_a_of_type_Long = localaopq.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uStartSize;
        this.jdField_a_of_type_Ayrn.jdField_b_of_type_Long = localaopq.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uDownloadedSize;
        this.jdField_a_of_type_Ayrn.jdField_c_of_type_Long = localaopq.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uTotalTimes;
        if ((this.jdField_a_of_type_Ayrn.jdField_b_of_type_Long <= 0L) || (this.jdField_a_of_type_Ayrn.jdField_c_of_type_Long <= 0L)) {
          break label139;
        }
        f = (float)this.jdField_a_of_type_Ayrn.jdField_c_of_type_Long / 1000.0F;
      }
    }
    label139:
    for (this.jdField_a_of_type_Ayrn.jdField_e_of_type_Long = (((float)this.jdField_a_of_type_Ayrn.jdField_b_of_type_Long / f));; this.jdField_a_of_type_Ayrn.jdField_e_of_type_Long = 0L)
    {
      super.c();
      if (b()) {
        a(0, 0, 0);
