...
public class boze
  implements boxy
{
  private boze(DoodleLayout paramDoodleLayout) {}
  ...
  public void a(DynamicTextItem paramDynamicTextItem, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("DoodleLayout", 2, "raymondguo count " + localbowf.b() + ", items:" + localbowf.jdField_a_of_type_JavaUtilArrayList.size());
      }
      return;
      localbowf.b(paramDynamicTextItem);
      paramInt = 1;
      continue;
      if (paramInt == 0)
      {
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      this.a.setTrackerState(this.a.a().jdField_a_of_type_Bowi, 0);
      return;
      DoodleLayout.a(this.a, new bozf(this, paramBoolean));
    }
  }
}
