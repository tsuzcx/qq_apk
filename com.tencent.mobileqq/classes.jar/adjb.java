...
public class adjb
  ...
  implements acjt
{
  public adjb(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  public View a(ChatMessage paramChatMessage, acju paramacju, View paramView, BaseChatItemLayout paramBaseChatItemLayout, acmv paramacmv)
  {
    ...
    if ((localMessageForLongTextMsg.getExtInfoFromExtStr("long_text_recv_state").equals("0")) || (localMessageForLongTextMsg.getExtInfoFromExtStr("long_text_recv_state").equals("1")))
    {
      if ((paramView != null) && ((paramView instanceof TextView))) {
        return super.a(paramChatMessage, paramacju, paramView, paramBaseChatItemLayout, paramacmv);
      }
      return super.a(paramChatMessage, paramacju, null, paramBaseChatItemLayout, paramacmv);
    }
    ...
    else
    {
      ...
      paramacju.setPadding(paramView.getDimensionPixelSize(2131165216), paramView.getDimensionPixelSize(2131165218), paramView.getDimensionPixelSize(2131165215), paramView.getDimensionPixelSize(2131165217));
      localObject2 = new RelativeLayout.LayoutParams(BaseChatItemLayout.d, -2);
      int i = paramView.getDimensionPixelSize(2131167688);
      ((RelativeLayout.LayoutParams)localObject2).setMargins(i, 0, i, 0);
      paramacju.setLayoutParams((ViewGroup.LayoutParams)localObject2);
      i = aciy.a(6.0F, ((Context)localObject1).getResources());
      int j = aciy.a(7.0F, ((Context)localObject1).getResources());
      int k = aciy.a(13.0F, ((Context)localObject1).getResources());
      int m = aciy.a(15.0F, ((Context)localObject1).getResources());
      ...
      ((View)localObject2).setBackgroundColor(((Context)localObject1).getResources().getColor(2131100636));
      ...
      ((ETTextView)localObject1).setId(2131298554);
    ...
    paramView = (TextView)paramacju.findViewById(2131298555);
    Object localObject2 = paramacju.findViewById(2131298553);
    localObject1 = (TextView)paramacju.findViewById(2131298554);
    ...
    if (!TextUtils.isEmpty(localMessageForLongTextMsg.sb)) {
      if (!TextUtils.isEmpty(localMessageForLongTextMsg.sb2))
      {
        ...
        ((View)localObject2).setOnTouchListener(paramacmv);
        ...
        ((TextView)localObject1).setText(ajjy.a(2131640595));
        ((View)localObject2).setTag(null);
        paramacju.setClickable(false);
        ((View)localObject2).setVisibility(0);
      }
    }
    for (;;)
    {
      paramChatMessage = gh.a(paramChatMessage);
      ...
      {
        ((TextView)localObject1).setText(ajjy.a(2131640596));
