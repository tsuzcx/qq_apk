...
public class ahwh
  extends ajjh
{
  public ahwh(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity) {}
  ...
  protected void onSetSpecialCareSwitchesOfAPerson(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    label233:
    for (int i = 2131626629;; i = 2131633710)
    {
      paramArrayOfObject.arg2 = i;
      this.a.a.sendMessage(paramArrayOfObject);
      if ((!paramBoolean) || (j != 0)) {
      ...
      paramArrayOfObject.putExtra("selfSet_leftViewText", this.a.getString(2131629851));
