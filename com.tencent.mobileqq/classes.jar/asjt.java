...
class asjt
  extends auon
{
  asjt(asjs paramasjs, MessageForMixedMsg paramMessageForMixedMsg, QQAppInterface paramQQAppInterface, String paramString, int paramInt) {}
  ...
  private boolean a(MessageForPic paramMessageForPic, aunu paramaunu)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = bbdj.c(asjs.a());
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("MixedMsgManager", 2, "WTF, picResult.mExtraObj is " + paramaunu.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
        }
        i = 0;
        break label227;
        if (QLog.isColorLevel())
  ...
  private boolean a(ArrayList<aunu> paramArrayList)
  {
    ...
    if (localMessageForMixedMsg.msgElemList != null)
    {
      ...
      if (!a((MessageForPic)localObject, (aunu)paramArrayList.get(i))) {
        bool1 = false;
      }
      i += 1;
    }
  ...
  public void a(int paramInt, ArrayList<aunu> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (!bool)
      {
        ...
        asjs.a(this.jdField_a_of_type_Asjs, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail");
        return;
      }
          ...
          for (;;)
          {
            ...
            else if ((localInvalidProtocolBufferMicroException instanceof MessageForReplyText))
            {
              try
              {
                ...
                localObject2 = akwb.a(localMessageForReplyText.mSourceMsgInfo);
                localElem.sourceMsgInfo.set(bbdm.a((byte[])localObject2));
      ...
      asjs.a(this.jdField_a_of_type_Asjs, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, bool);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.e("MixedMsgManager", 2, "onForwardMultiMsgPicsUpload failed");
    }
    asjs.a(this.jdField_a_of_type_Asjs, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "picUpload fail : result = " + paramInt);
  }
}
