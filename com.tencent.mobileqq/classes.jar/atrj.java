...
public class atrj
  implements bbzp, bclw<atrn>
{
  private int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  private Context jdField_a_of_type_AndroidContentContext;
  protected anrc a;
  private atqr jdField_a_of_type_Atqr;
  private bbzk jdField_a_of_type_Bbzk;
  private bclx<atrn> jdField_a_of_type_Bclx;
  ...
  private List<bbzc> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean;
  private List<bfmo> jdField_c_of_type_JavaUtilList;
  private boolean jdField_c_of_type_Boolean;
  private volatile boolean d = true;
  
  public atrj(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, int paramInt, atqr paramatqr)
  {
    this.jdField_a_of_type_Anrc = new atrk(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_Atqr = paramatqr;
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong, List<Long> paramList, String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      ((anrb)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.BIZ_TROOP_HANDLER)).a("GroupFileAppSvr.GetFileSearch", paramList.toByteArray(), (Bundle)localObject);
  ...
  private void a(boolean paramBoolean, List<bfmo> paramList)
  {
  ...
  private void b(String paramString)
  {
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bbzk = new bbzk(paramString, paramString, this.jdField_b_of_type_JavaUtilList, this);
  ...
  public List<atrn> a(bcmk parambcmk)
  {
    return null;
  }
  ...
  public void a(bcmk parambcmk, bclx<atrn> parambclx)
  {
