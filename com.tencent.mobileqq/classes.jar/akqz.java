...
public class akqz
{
  private static final String jdField_a_of_type_JavaLangString = anni.a(2131704227);
  private int jdField_a_of_type_Int = -1;
  private akqw jdField_a_of_type_Akqw = akqy.a(jdField_a_of_type_JavaLangString);
  private AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new akrc(this);
  ...
  private IRedPacket.OnGetSkinListener jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketIRedPacket$OnGetSkinListener = new akrb(this);
  private QwAdapter jdField_a_of_type_CooperationQwalletPluginQwAdapter;
  List<akrg> jdField_a_of_type_JavaUtilList = new ArrayList();
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new akra(this);
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  private List<akqw> jdField_b_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_b_of_type_Boolean;
  private List<LinearLayout> c = new ArrayList();
  
  public akqz(SendHbActivity paramSendHbActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity = paramSendHbActivity;
    d();
  }
  
  private void a(List<akqw> paramList)
  {
    paramList.add(akqy.b(jdField_a_of_type_JavaLangString));
    if ((b()) && (!paramList.contains(this.jdField_a_of_type_Akqw)))
    {
      QLog.d("HbSkinLogic", 2, "add vip info to list!");
      paramList.add(this.jdField_a_of_type_Akqw);
    }
  }
  
  private void b(List<akqw> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      SkinInfo localSkinInfo = ((akqw)paramList.next()).jdField_a_of_type_WalletSkinInfo;
      ...
      localRedPacketInfoBase.isCache = akqw.jdField_a_of_type_Boolean;
  ...
  private boolean b()
  {
    if (this.jdField_a_of_type_Anom != null) {
      return this.jdField_a_of_type_Anom.a();
    }
    return false;
  }
  ...
  private void d()
  {
    ...
    a(localArrayList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter = new QwAdapter(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity, localArrayList, 2131560471, new akrf(this));
    this.jdField_a_of_type_Anom = ((anom)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getAppRuntime().getManager(131));
  ...
  public int a()
  {
    return akqw.a(this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.getList());
  }
  ...
  public void a(akrg paramakrg)
  {
    this.jdField_a_of_type_JavaUtilList.add(paramakrg);
  }
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, afur.a(226.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getResources()));
    ...
    localHorizontalListView.setDividerWidth(afur.a(12.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getResources()));
  ...
  public void b()
  {
    ...
    if (-2 != i)
    {
      ...
      if (this.jdField_a_of_type_Anom != null) {
        this.jdField_a_of_type_Anom.a(0, 0, true);
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (b()) {
      if (!localList.contains(this.jdField_a_of_type_Akqw))
      {
        QLog.d("HbSkinLogic", 2, "add vip info to list!");
        localList.add(this.jdField_a_of_type_Akqw);
        akqw.c = this.jdField_a_of_type_Akqw.jdField_a_of_type_WalletSkinInfo.skin_id;
        akqw.a(localList);
        this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
      }
    }
    while (!localList.contains(this.jdField_a_of_type_Akqw)) {
      return;
    }
    QLog.d("HbSkinLogic", 2, "remove vip info to list!");
    localList.remove(this.jdField_a_of_type_Akqw);
    akqw.c = 0;
    akqw.a(localList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
  }
