...
public class balf
{
  ...
  public static balf a(boolean paramBoolean, TianShuAccess.GetAdsRsp paramGetAdsRsp)
  {
    ...
    localObject1 = new balf();
    ((balf)localObject1).jdField_a_of_type_JavaLangString = ((String)localHashMap.get("type"));
    ((balf)localObject1).c = ((String)localHashMap.get("pic"));
    ((balf)localObject1).b = ((String)localHashMap.get("url"));
    ((balf)localObject1).jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem = ((TianShuAccess.AdItem)paramGetAdsRsp.value.lst.get(0));
    if (TextUtils.isEmpty(((balf)localObject1).c)) {
      return null;
    }
    return localObject1;
  }
