...
public class yrr
  extends Handler
{
  public yrr(TroopMemberApiService paramTroopMemberApiService) {}
  
  private void a(Bundle paramBundle)
  {
    Object localObject1 = (QQAppInterface)TroopMemberApiService.d(this.a);
    Object localObject3 = ((aufv)TroopMemberApiService.e(this.a).getManager(11)).a();
    String str1 = "";
    Object localObject2 = "";
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      localObject5 = (aloz)((QQAppInterface)localObject8).a(22);
      localObject6 = (alvm)((QQAppInterface)localObject8).a(3);
      localObject1 = (amdu)((QQAppInterface)localObject8).a(20);
    }
          ...
          if (localObject1 != null)
          {
            ...
            if (paramMessage.obj != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                continue;
                this.a.jdField_a_of_type_Amau = new amau(((AppRuntime)localObject8).getAccount());
                continue;
                ...
                if ((!TextUtils.isEmpty((CharSequence)localObject6)) && (!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject5)))
                {
                  ...
                  if (QLog.isDevelopLevel())
                  {
                    ...
                    if (localObject1 != null)
                    {
                      ((amdu)localObject1).b((String)localObject5);
                      continue;
                      localObject5 = ((Bundle)localObject7).getString("troopUin");
                      localObject6 = ((Bundle)localObject7).getString("troopCode");
                      if (localObject1 != null) {
                        ((amdu)localObject1).a(true, (String)localObject5, (String)localObject6, 0);
                      }
                      if (QLog.isColorLevel())
                      {
                        ...
                        auxb.a((QQAppInterface)localObject8, (String)localObject1, this.a.jdField_a_of_type_Bayj);
                        continue;
                        ...
                        if ((localObject8 instanceof QQAppInterface))
                        {
                          ...
                          if (!auuc.a((AppInterface)localObject6, (String)localObject1))
                          {
                            l1 = ayzl.a();
                            localObject7 = ((QQAppInterface)localObject6).getCurrentAccountUin();
                            localObject5 = azvd.a((byte[])localObject5, -1);
                            if (localObject5 != null)
                            {
                              ((AbsStructMsg)localObject5).mMsgServiceID = 98;
                              localObject8 = (MessageForStructing)azaf.a(-2011);
                              ...
                              auuc.a((AppInterface)localObject6, (String)localObject1);
                              auuc.a((MessageRecord)localObject8, "isFaceScoreBubbleMsg", true);
                              auuc.a((MessageRecord)localObject8, "isFaceScoreSecondMember", true);
                              auuc.a.add(localObject1);
                              if (i == 1) {}
                              for (bool = true;; bool = false)
                              {
                                abti.a((MessageRecord)localObject8, bool);
                              ...
                              localObject6 = (aluj)((QQAppInterface)localObject8).a(35);
                              if (localObject6 != null)
                              {
                                localObject7 = new ArrayList();
                                ((List)localObject7).add(Long.valueOf(Long.parseLong((String)localObject5)));
                                ((aluj)localObject6).a((QQAppInterface)localObject8, (String)localObject1, (List)localObject7, i);
                                continue;
                                ...
                                if (localObject1 != null)
                                {
                                  ((amdu)localObject1).a(l1, l2, l3, (String)localObject5, i, (String)localObject6, (String)localObject8, j);
                                  continue;
                                  localObject5 = ((Bundle)localObject7).getString("troopUin");
                                  if (localObject1 != null)
                                  {
                                    ((amdu)localObject1).n((String)localObject5);
                                    continue;
                                    localObject1 = ((Bundle)localObject7).getString("troopUin");
                                    bool = ((Bundle)localObject7).getBoolean("isChecked");
                                    if (localObject5 != null)
                                    {
                                      ((aloz)localObject5).b((String)localObject1, bool);
                                      continue;
                                      localObject1 = ((Bundle)localObject7).getString("troopUin");
                                      bool = ((Bundle)localObject7).getBoolean("isChecked");
                                      if (localObject5 != null) {
                                        ((aloz)localObject5).a((String)localObject1, bool);
                                      }
                                    }
                                  }
                                }
    ...
    case 122: 
      ...
      localObject5 = (alqo)((QQAppInterface)localObject8).a(8);
      if (localObject5 != null) {
        if (((alqo)localObject5).a((String)localObject1, 0).longValue() > 0L) {
          bool = true;
        }
      }
      break;
    ...
    for (;;)
    {
      ...
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      if (localObject1 != null) {
        ((amdu)localObject1).j((String)localObject5);
      }
      if (!QLog.isDevelopLevel()) {
        break label720;
      }
      ...
      {
        ((alvm)localObject6).a(((Bundle)localObject7).getString("areaName"), ((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"), ((Bundle)localObject7).getInt("startIndex"), ((Bundle)localObject7).getInt("count"), ((Bundle)localObject7).getInt("iFilterId"));
        break label720;
      }
      if ("getNearbyTroops".equals(localObject1))
      {
        ((alvm)localObject6).a(((Bundle)localObject7).getBoolean("isFirst"), ((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"), ((Bundle)localObject7).getInt("sortType"), ((Bundle)localObject7).getString("strGroupArea"), ((Bundle)localObject7).getInt("iFilterId"));
        break label720;
      }
      if ("getAreaList".equals(localObject1))
      {
        ((alvm)localObject6).a(((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"), ((Bundle)localObject7).getInt("radius"), ((Bundle)localObject7).getBoolean("isClickable"));
        break label720;
      }
      if (!"getNewNearbyTroop".equals(localObject1)) {
        break label720;
      }
      ((alvm)localObject6).a(((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"));
      break label720;
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      ...
      ((amdu)localObject1).notifyUI(144, true, new Object[] { localObject5, localObject6, Integer.valueOf(i) });
      break label720;
      localObject1 = new Bundle();
      ...
      {
        localObject6 = (axlx)((AppRuntime)localObject8).getManager(36);
        if (localObject6 != null)
        {
          ...
          {
            localObject9 = ((axlx)localObject6).a(localObject5[i]);
      ...
      localObject5 = (axlx)((AppRuntime)localObject8).getManager(36);
      if (localObject5 == null) {
        break label720;
      }
      ((axlx)localObject5).b((String)localObject1);
      break label720;
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      ...
      ((amdu)localObject1).b((String)localObject5, (String)localObject6);
      break label720;
      localObject1 = new Bundle();
      ...
      ((amdu)localObject1).a(i, ((Bundle)localObject7).getString("openGroupId"), (String)localObject5, ((Bundle)localObject7).getString("url"), ((Bundle)localObject7).getInt("seq"));
      break label720;
      i = ((Bundle)localObject7).getInt("seq");
      if (this.a.jdField_a_of_type_Abxa == null) {
        this.a.jdField_a_of_type_Abxa = new abxa((AppRuntime)localObject8, this.a);
      }
      this.a.jdField_a_of_type_Abxa.a(118, (Bundle)localObject7, i);
      break label720;
      i = ((Bundle)localObject7).getInt("appid");
      localObject5 = ((Bundle)localObject7).getString("token");
      ((amdu)localObject1).a(i, ((Bundle)localObject7).getString("openId"), (String)localObject5, ((Bundle)localObject7).getInt("seq"));
      break label720;
      bool = ((Bundle)localObject7).getBoolean("isTroopAppListChanged");
      localObject1 = (bclu)((AppRuntime)localObject8).getManager(109);
      if (localObject1 == null) {
        break label720;
      }
      ((bclu)localObject1).a(bool);
      break label720;
      ...
      localObject5 = (bclu)((AppRuntime)localObject8).getManager(109);
      if (localObject5 == null) {
        break label720;
      }
      ((bclu)localObject5).a(bool, (String)localObject1);
      break label720;
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      ...
      if (((String)localObject1).equals("g_homework"))
      {
        ...
        localObject1 = "";
        if (bcnt.a((QQAppInterface)localObject8, l1)) {
      ...
      bcpc.a((QQAppInterface)localObject8, this.a, (String)localObject5, true);
      break label720;
      ...
      break label720;
      if (TroopMemberApiService.a((AppRuntime)localObject8, new yrs(this, (Bundle)localObject7))) {
        break label720;
      }
      this.a.a(16, (Bundle)localObject7);
      break label720;
      l1 = ((Bundle)localObject7).getLong("uiResId");
      localObject1 = aieq.a().a(l1);
      if ((localObject1 != null) && (((aozs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo != null))
      {
        ((Bundle)localObject7).putString("packageName", ((aozs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strPkgName);
        ((Bundle)localObject7).putString("imageUrl", ((aozs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strResURL);
        ((Bundle)localObject7).putString("name", ((aozs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strResName);
        if (((aozs)localObject1).jdField_a_of_type_Byte == 0)
        {
          bool = true;
          label3229:
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          localObject9 = (amdu)((QQAppInterface)localObject8).a(20);
          if (localObject9 != null) {
            ((amdu)localObject9).j((String)localObject5);
          }
          ...
          localObject1 = bcnt.a((QQAppInterface)localObject8, l1, null, (String)localObject1, (String)localObject5, l2, i);
          ...
          TroopMemberApiService.a(this.a, (QQAppInterface)localObject8, l1, HWTroopFileStatusInfo.parse((bbtn)localObject1), (Bundle)localObject5);
          break;
          if ((!(localObject8 instanceof QQAppInterface)) || (localObject7 == null)) {
            break;
          }
          ...
          if ((((bclu)localObject1).a(0)) && (!((bclu)localObject1).b(0)))
          {
            localObject6 = ((bclu)localObject1).a(false, 0);
            ...
            ((bclu)localObject1).a((ArrayList)localObject5, (ArrayList)localObject6);
            break;
          }
          this.a.jdField_a_of_type_Boolean = true;
          ((bclu)localObject1).a(true, 0);
          break;
          ...
          ((atet)((QQAppInterface)localObject8).getManager(108)).a(this.a, l1, (String)localObject1, (String)localObject6, (String)localObject5, i);
          break;
          ...
          atba.a((QQAppInterface)localObject8, (String)localObject1, (String)localObject5, (String)localObject6, "web", (String)localObject9, str2, (String)localObject7);
          break;
          localObject1 = ((Bundle)localObject7).getString("pluginPackageName");
          localObject5 = ((Bundle)localObject7).getString("appType");
          atar.a(((QQAppInterface)localObject8).getApp(), (String)localObject1, (String)localObject5).a();
          break;
          try
          {
          ...
          for (;;)
          {
            for (;;)
            {
              for (;;)
              {
                ...
                bckt.a(this.a, (String)localObject2, (String)localObject5);
                break label720;
                localObject2 = ((Bundle)localObject7).getString("troopUin");
                ...
                bcpc.jdField_a_of_type_Int = ((Bundle)localObject7).getInt("imageMaxWidthPixels", 1080);
                bcpc.b = ((Bundle)localObject7).getInt("imageMaxHeightPixels", 1920);
                ((bcpc)((AppRuntime)localObject8).getManager(152)).a((String)localObject2, i, (String)localObject5, (String)localObject6, j);
                break label720;
                ((amdu)localObject2).a(((Bundle)localObject7).getLong("troopUin"), ((Bundle)localObject7).getInt("flag"));
                break label720;
                ...
                localObject5 = ((bcpc)((AppRuntime)localObject8).getManager(152)).a((String)localObject2, (String)localObject5);
                localObject2 = "";
                if (localObject5 != null) {
                ...
                ((TroopPluginManager)localObject5).a("troop_manage_plugin.apk", new yrv(this, (amdu)localObject2, (String)localObject6, i, (String)localObject7));
                break label720;
                ...
                break label720;
                ((amdu)localObject2).a(((Bundle)localObject7).getString("troopUin"), "", ((Bundle)localObject7).getInt("statOption"), ((Bundle)localObject7).getString("authKey"), null, null, null);
                break label720;
                ...
                localObject5 = ((beag)((AppRuntime)localObject8).getManager(47)).a(1);
                localObject6 = new File(auup.jdField_a_of_type_JavaLangString + File.separator + "nearby_heart.mp4");
                if (!((File)localObject6).exists()) {
                  ((File)localObject6).mkdirs();
                }
                for (;;)
                {
                  ((beaj)localObject5).a(new beae("http://pub.idqqimg.com/pc/misc/nearby/nearby_heart.gif", (File)localObject6), new yrw(this, (Bundle)localObject2), new Bundle());
                  break;
                ...
                if ((localObject8 instanceof QQAppInterface))
                {
                  localObject6 = (bclb)((AppRuntime)localObject8).getManager(224);
                  if (localObject6 != null)
                  {
                    localObject5 = ((bclb)localObject6).a();
                    localObject6 = ((bclb)localObject6).b();
                ...
                bool = azkt.a((QQAppInterface)localObject8, BaseApplicationImpl.getContext());
                if (!QLog.isColorLevel()) {
                  break label720;
                }
                ...
                nff.a().a((String)localObject2, i, (String)localObject5, new yrx(this, (Bundle)localObject7, i));
                break label720;
                ...
                localObject2 = (bbuq)((QQAppInterface)localObject8).getManager(231);
                switch (i)
                {
                }
                for (;;)
                {
                  ...
                  break;
                  ((bbuq)localObject2).a(((Bundle)localObject7).getInt("effectId"), ((Bundle)localObject7).getString("effectName"), ((Bundle)localObject7).getInt("svipLevel"), ((Bundle)localObject7).getInt("svipType"));
                  continue;
                  localObject5 = ((Bundle)localObject7).getStringArrayList("statusList");
                  if (localObject5 != null) {
                    ((bbuq)localObject2).a((ArrayList)localObject5);
                  }
                }
                localObject2 = ((Bundle)localObject7).getString("troopUin");
                ...
                new akcx((Intent)localObject6).execute(new Void[0]);
                this.a.a(87, (Bundle)localObject7);
                break label720;
                ...
                ((atdh)((AppRuntime)localObject8).getManager(306)).a((Bundle)localObject2);
                break label720;
                ((atdh)((AppRuntime)localObject8).getManager(306)).a();
                break label720;
                ...
                if (bool)
                {
                  VideoEnvironment.a("TroopMemberApiService", alud.a(2131716036), null);
                  ShortVideoResourceManager.b((QQAppInterface)localObject8, new yry(this, (AppRuntime)localObject8, (Bundle)localObject7));
                  break label720;
                }
                ...
                ((atad)((AppRuntime)localObject8).getManager(236)).a(this.a, (String)localObject2, ((QQAppInterface)localObject8).getCurrentAccountUin(), i, (String)localObject5, (String)localObject6, (String)localObject9, str2, (String)localObject7);
                break label720;
                ((Bundle)localObject7).getString("fromId");
                ((atad)((AppRuntime)localObject8).getManager(236)).a(null, 10L);
                break label720;
                ...
                localObject7 = (aluj)((QQAppInterface)localObject8).a(35);
                if (localObject7 == null) {
                  break label720;
                }
                ((aluj)localObject7).a((String)localObject2, (String)localObject5, (String)localObject6);
                break label720;
                localObject2 = ((Bundle)localObject7).getString("troopCode");
                localObject5 = ((Bundle)localObject7).getString("uin");
                localObject6 = (aluj)((QQAppInterface)localObject8).a(35);
                ...
                ((aluj)localObject6).a((String)localObject2, (String)localObject5);
                break label720;
                localObject2 = ((Bundle)localObject7).getString("troopCode");
                localObject5 = (aluj)((QQAppInterface)localObject8).a(35);
                if (localObject5 == null) {
                  break label720;
                }
                ((aluj)localObject5).a((String)localObject2);
                break label720;
                localObject2 = ((Bundle)localObject7).getString("troopCode");
                localObject5 = ((Bundle)localObject7).getString("uin");
                localObject6 = ((Bundle)localObject7).getString("nick");
                ...
                ((aluj)localObject7).b((String)localObject2, (String)localObject5, (String)localObject6);
                break label720;
                localObject2 = ((Bundle)localObject7).getString("troopCode");
                localObject5 = ((Bundle)localObject7).getString("uin");
                localObject6 = (aluj)((QQAppInterface)localObject8).a(35);
                ...
                ((aluj)localObject6).b((String)localObject2, (String)localObject5);
                break label720;
                ((Bundle)localObject7).getString("troopCode");
                localObject2 = ((Bundle)localObject7).getString("rid");
                localObject5 = new ysa(this, (Bundle)localObject7);
                this.a.jdField_a_of_type_Aluy = new aluy((QQAppInterface)localObject8, (aluz)localObject5, (String)localObject2);
                this.a.jdField_a_of_type_Aluy.b(10000L);
                break label720;
                ...
                ((aluj)localObject5).a((ArrayList)localObject2);
                break label720;
                localObject2 = ((Bundle)localObject7).getString("schoolName");
                i = ((Bundle)localObject7).getInt("isValid");
                localObject5 = (auxh)((QQAppInterface)localObject8).a(60);
                if (localObject5 == null) {
                  break label720;
                }
                ((auxh)localObject5).a((String)localObject2, i);
                break label720;
                ...
                owy.a().d(i, j);
                break label720;
                ((Bundle)localObject7).putInt("readinjoy_to_wx_config", bkbq.t((AppRuntime)localObject8));
                ...
                break label720;
                ((ult)((QQAppInterface)localObject8).a(98)).c(((Bundle)localObject7).getInt("reqUserSetEnableAlbumScan"));
                break label720;
                if (this.a.jdField_a_of_type_Pif == null) {
                  this.a.jdField_a_of_type_Pif = new pif((AppRuntime)localObject8, this.a);
                }
                ...
                if ((!TextUtils.isEmpty((CharSequence)localObject5)) && ("group".equals(localObject6)))
                {
                  ...
                  ((amdu)localObject2).a((String)localObject5, false, "TroopMemberApiService111", true, true, false, false);
                  break label720;
                }
                if (QLog.isColorLevel()) {
                ...
                localObject2 = aepi.a((Intent)localObject2, null);
                ...
                bacq.a(((Bundle)localObject7).getBundle("reportData"));
                break label720;
                if (QLog.isColorLevel()) {
                ...
                ((babo)((AppRuntime)localObject8).getManager(362)).a(BaseApplicationImpl.getContext());
                break label720;
                if (QLog.isColorLevel()) {
                ...
                if ((TextUtils.isEmpty((CharSequence)localObject2)) || (!String.valueOf(1104445552).equals(localObject5)) || (bckt.a((QQAppInterface)localObject8, (String)localObject2) == 0)) {
                  break label720;
                }
                bckt.a((QQAppInterface)localObject8, (String)localObject2);
                break label720;
                ...
                localObject8 = (beer)((AppRuntime)localObject8).getManager(290);
                if (localObject8 != null)
                {
                  ((beer)localObject8).a((String)localObject5, i, j, (String)localObject6, (String)localObject9, str2, (String)localObject7, new yrt(this, k, (String)localObject2));
                  break label720;
                }
                localObject5 = new Bundle();
                ...
                try
                {
                  localObject2 = (beer)((AppRuntime)localObject8).getManager(290);
                  if (localObject2 == null) {
                    break label8160;
                  }
                  ((beer)localObject2).a((Bundle)localObject7);
                }
              ...
              break label720;
              Object localObject3 = (beer)((AppRuntime)localObject8).getManager(290);
              ...
              if (localObject3 != null)
              {
                ((beer)localObject3).a((String)localObject5, (String)localObject6, (String)localObject8, new yru(this, i, (String)localObject7));
                break label720;
              }
              ...
              label8568:
              localObject5 = (QQAppInterface)localObject8;
              if (bkbq.a((QQAppInterface)localObject5))
              {
              ...
              localObject5 = ((alto)((AppRuntime)localObject8).getManager(51)).b(((QQAppInterface)localObject4).c());
              if (localObject5 != null)
              {
                if (QLog.isColorLevel()) {
              ...
              localObject4 = bbcn.a(this.a.getApplicationContext(), (QQAppInterface)localObject8, i, j, k);
              ...
              bbcn.a((QQAppInterface)localObject8, (String)localObject4, i, j);
              break label720;
              i = ((Bundle)localObject7).getInt("deleteType");
              localObject4 = ((Bundle)localObject7).getString("uin");
              j = ((Bundle)localObject7).getInt("msgType");
              bbcn.b((QQAppInterface)localObject8, (String)localObject4, i, j);
              break label720;
              ...
              break label720;
              localObject4 = ((Bundle)localObject7).getString("uin");
              ymg.c(BaseApplicationImpl.getContext(), (String)localObject4, null);
              break label720;
              ...
              try
              {
                ...
                if (this.a.jdField_a_of_type_Alpy == null)
                {
                  this.a.jdField_a_of_type_Alpy = ((alpy)((AppRuntime)localObject8).getManager(59));
                  this.a.jdField_a_of_type_Alpy.a(this);
                }
                ...
                ((Intent)localObject5).putExtra("param_location_param", this.a.jdField_a_of_type_Alpy.b((String[])localObject4));
            ...
            ((bcgc)((AppRuntime)localObject8).getManager(346)).a((String)localObject4, bool);
            break label720;
            ...
            localObject6 = new bbhh();
            try
            {
              ((bbhh)localObject6).jdField_a_of_type_Long = Long.parseLong(str1);
              label9513:
              ((bbhh)localObject6).jdField_c_of_type_JavaLangString = ((String)localObject4);
              bclz.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), BaseApplicationImpl.getContext(), (SessionInfo)localObject7, (bbhh)localObject6);
            }
