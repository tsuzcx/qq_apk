...
public class uvr
{
  ...
  public static String a(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    if (paramWSRedDotPushMsg != null)
    {
      ...
      bool = uyo.a(paramWSRedDotPushMsg);
  ...
  {
    a("weishi_share_officialacc", "start_dl_ws_fin", paramInt, 0, umu.a().b(), 0L, "", "");
  }
  ...
  public static void a(WSDownloadParams paramWSDownloadParams, int paramInt)
  {
    ...
    a("weishi_share_officialacc", "start_dl_ws", paramInt, 0, umu.a().b(), 0L, "", paramWSDownloadParams.mTestId);
  }
  ...
  public static void a(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    for (;;)
    {
      ...
      long l1;
      long l2;
      if (yqu.a(BaseApplicationImpl.getApplication().getApplicationContext()))
      {
        l1 = 1L;
        l2 = j;
  ...
  {
    bcef.b(null, "dc00898", "", "", paramString1, paramString2, paramInt1, paramInt2, String.valueOf(paramLong1), String.valueOf(paramLong2), paramString3, paramString4);
  }
  ...
  {
    if ((paramurt == null) || (paramurt.a == null)) {
      return;
    }
    paramurt = uwc.a(paramurt, paramBoolean);
    a("officialacc_weishi", "focus_video_play", 0, 0, 0L, 0L, new Gson().toJson(paramurt), uyo.a(9));
  }
  ...
  public static void a(boolean paramBoolean, WSDownloadParams paramWSDownloadParams)
  {
    ...
    a(str, "dl_clk_officialdownloader", umu.a().b(), 0, 0L, 0L, "", paramWSDownloadParams.mTestId);
  }
  ...
  {
    a("officialacc_weishi", "focus_exp", 0, 0, 0L, 0L, UserAction.getQIMEI(), uyo.a(9));
  }
