...
public class ofm
  extends ofg<String, DynamicChannelDataModel>
{
  private ofl a;
  public final String b = "ReadInJoyCGIDynamicChannelAdapter";
  
  public ofm(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    super(paramActivity, paramRecyclerViewWithHeaderFooter, paramInt);
    this.jdField_a_of_type_Ofl = new ofl();
    this.jdField_a_of_type_Ofl.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, 0);
  }
  ...
  public bequ a(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_Ofl.a(paramInt))
    {
      Object localObject = (String)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        paramViewGroup = off.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, a(), (String)localObject);
        if ((paramInt == ofd.b) && (paramViewGroup != null)) {
        ...
        return new ofn(this, (View)localObject);
      }
  ...
  public void a(bequ parambequ, int paramInt)
  {
    DynamicChannelDataModel localDynamicChannelDataModel = (DynamicChannelDataModel)a(paramInt);
    int i = parambequ.getItemViewType();
    parambequ = (ProteusItemView)parambequ.itemView;
    if (localDynamicChannelDataModel != null)
    {
      if (!this.jdField_a_of_type_Ofl.a(i)) {
        break label139;
      }
      if (i != ofd.b) {
        break label120;
      }
      parambequ.setVisibility(8);
    }
    for (;;)
    {
      a(localDynamicChannelDataModel.uniqueID, localDynamicChannelDataModel);
      QLog.d("ReadInJoyCGIDynamicChannelAdapter", 2, new Object[] { "onBindViewHolder, dataModel = ", localDynamicChannelDataModel, ", proteusItemView = ", parambequ, " , position = ", Integer.valueOf(paramInt), ", type = ", Integer.valueOf(i) });
      return;
      label120:
      this.jdField_a_of_type_Ofl.a(parambequ, i, localDynamicChannelDataModel, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt);
      continue;
      label139:
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    {
      paramInt = i;
      if (this.jdField_a_of_type_Ofl.a((DynamicChannelDataModel)localObject))
      {
        i = this.jdField_a_of_type_Ofl.a((DynamicChannelDataModel)localObject);
