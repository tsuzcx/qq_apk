  ...
  extends ajfb
{
  ...
  public mmr(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Ajfe = new mmu(this);
    this.jdField_a_of_type_Mmx = new mmx(this);
    AppNetConnInfo.registerConnectionChangeReceiver(paramQQAppInterface.getApplication(), this.jdField_a_of_type_Mmx);
  ...
  public static oidb_0x791.RedDotInfo a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramQQAppInterface != null))
    {
      ...
      try
      {
        ...
        if (bool != awcw.a)
        {
          urk.a("TroopRedTouchHandler", "parsePushRedPointInfo env not match!! isTestEnvFromPush = %b, sIsTestEnv = %b", Boolean.valueOf(bool), Boolean.valueOf(awcw.a));
          if (bool != ulw.a())
          {
            urk.a("TroopRedTouchHandler", "parsePushRedPointInfo env not match!! isTestEnvFromPush = %b, QQStoryNetReqUtils.isDevEnv() = %b", Boolean.valueOf(bool), Boolean.valueOf(ulw.a()));
            return null;
          }
        }
        ...
        if (QLog.isColorLevel()) {
          QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "parsePushRedPointInfo:" + mmy.a(paramArrayOfByte));
        }
        localObject2 = (mmy)paramQQAppInterface.getManager(70);
        if (!mmq.b(paramArrayOfByte.uint32_appid.get())) {
          break label674;
        }
        if (!paramArrayOfByte.bool_display_reddot.get()) {
          break label564;
        }
        paramQQAppInterface = (spz)sqg.a(10);
        ...
        QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "故事红点下发到达时间：" + l1 + "小于最近更新刷新时间：" + l2 + mmy.a(paramArrayOfByte));
        return null;
      }
      ...
      urk.a("TroopRedTouchHandler", "parsePushRedPointInfo() return %s", paramQQAppInterface);
      return paramQQAppInterface;
      label431:
      paramQQAppInterface = ((mmy)localObject2).a();
      int i = mmq.a(paramArrayOfByte, paramQQAppInterface);
      if (i < 0)
      {
        if (QLog.isColorLevel())
        {
          QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "comparePriority:比上一个红点优先级低，current：" + mmy.a(paramArrayOfByte) + "|lastRedPoint:" + mmy.a(paramQQAppInterface));
          return null;
        }
      }
      else
      {
        if ((i == 0) && (paramArrayOfByte.uint32_last_time.get() < paramQQAppInterface.uint32_last_time.get()))
        {
          ...
          QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "当前红点比上一个红点旧，current：" + mmy.a(paramArrayOfByte) + "|lastRedPoint:" + mmy.a(paramQQAppInterface));
          return null;
          label564:
          paramQQAppInterface = ((mmy)localObject2).a();
          if ((paramQQAppInterface == null) || (paramQQAppInterface.uint64_cmd_uin.get() != paramArrayOfByte.uint64_cmd_uin.get()) || (paramQQAppInterface.uint32_cmd_uin_type.get() != paramArrayOfByte.uint32_cmd_uin_type.get()) || (paramQQAppInterface.uint32_last_time.get() != paramArrayOfByte.uint32_last_time.get()))
          {
            ...
            QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "故事的撤回红点需要判断uin和lasttime，强校验，和上一个不一致的话直接返回，不处理，current：" + mmy.a(paramArrayOfByte) + "|lastRedPoint:" + mmy.a(paramQQAppInterface));
            return null;
            label674:
            if (46 == paramArrayOfByte.uint32_appid.get())
            {
              if (!axfs.a(paramQQAppInterface)) {
                break label822;
              }
              oidb_0x791.RedDotInfo localRedDotInfo = ((mmy)localObject2).a(46, false);
              i = j;
              ...
              ((mmy)localObject2).a(localRedDotInfo, paramArrayOfByte);
              ((mmy)localObject2).a(paramArrayOfByte);
              a(paramQQAppInterface, paramArrayOfByte, i, false);
              return null;
            }
          }
        }
        if (!mmq.c(paramArrayOfByte.uint32_appid.get())) {
          ((mmy)localObject2).a(paramArrayOfByte);
        }
      }
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x791.RedDotInfo paramRedDotInfo, int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramQQAppInterface != null) && (paramRedDotInfo != null) && (paramRedDotInfo.uint32_appid.has()))
    {
      ...
      if (j == 46)
      {
        ...
        if (localakeu.b(ajed.aN, 6004) == null) {
          break label192;
        }
      }
    }
    ...
    label198:
    RecentUser localRecentUser = localakeu.a(ajed.aN, 6004);
    ...
    for (long l = paramRedDotInfo.uint32_last_time.get();; l = NetConnInfoCenter.getServerTimeMillis() / 1000L)
    {
      ...
      localRecentUser.displayName = paramQQAppInterface.getApp().getString(2131654288);
      if (paramInt != 0) {
  ...
  private static boolean b(QQAppInterface paramQQAppInterface, List<Integer> paramList, byte[] paramArrayOfByte)
  {
    try
    {
      ...
      if (paramArrayOfByte != null)
      {
        ...
        boolean bool = ((mmy)paramQQAppInterface.getManager(70)).a(paramList, paramArrayOfByte);
        return bool;
      }
    }
    catch (Exception paramQQAppInterface)
  ...
  private void c()
  {
    ...
    localObject2 = new NewIntent(this.app.getApplication(), mmi.class);
    ...
    ((NewIntent)localObject2).setObserver(new mms(this, (List)localObject1));
    this.app.startServlet((NewIntent)localObject2);
  }
  
  public void a()
  {
    this.app.addObserver(this.jdField_a_of_type_Ajfe);
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        localauqh.b(str);
      } while (localauqh.a(7719) == null);
      localauqh.a(7719, str);
      return;
      label93:
      str = "";
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), mmi.class);
    localNewIntent.putExtra("cmd", skt.a("StorySvc.clr_710_message_list"));
    localNewIntent.putExtra("data", localReqClearMessage.toByteArray());
    localNewIntent.setObserver(new mmv(this));
  ...
  public void a(int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2, oidb_0x791.RedDotInfo paramRedDotInfo, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    for (paramInt2 = 2887;; paramInt2 = 1937)
    {
      ...
      paramRedDotInfo = new NewIntent(this.app.getApplication(), mmi.class);
      ...
      paramRedDotInfo.setObserver(new mmw(this));
      this.app.startServlet(paramRedDotInfo);
      return;
    }
  }
  
  public void a(mmy parammmy, int paramInt)
  {
    parammmy = parammmy.a(paramInt);
    a(this.app, parammmy);
  }
  ...
  public void a(oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    for (;;)
    {
      ...
      ((NewIntent)localObject2).setObserver(new mmt(this));
      this.app.startServlet((NewIntent)localObject2);
      return;
  ...
  public void b()
  {
    this.app.removeObserver(this.jdField_a_of_type_Ajfe);
  }
  
  public void b(int paramInt)
  {
    Object localObject = (mmy)this.app.getManager(70);
    if (localObject != null)
    {
      oidb_0x791.RedDotInfo localRedDotInfo = ((mmy)localObject).a(paramInt, false);
      if ((localRedDotInfo != null) && (localRedDotInfo.uint32_number.has()) && (localRedDotInfo.uint32_number.get() > 0))
      {
        ...
        ((mmy)localObject).a(localRedDotInfo);
  ...
  {
    if (this.jdField_a_of_type_Mmx != null) {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Mmx);
    }
    this.jdField_a_of_type_Int = 0;
    super.onDestroy();
  }
