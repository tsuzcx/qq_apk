...
public class mmr
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, View paramView, Message paramMessage, boolean paramBoolean)
  {
    ...
    View localView = paramView.findViewById(2131371686);
    TextView localTextView = (TextView)paramView.findViewById(2131371665);
    ImageView localImageView = (ImageView)paramView.findViewById(2131371664);
    int i;
    int j;
    boolean bool;
    if ((paramMessage != null) && (paramMessage.obj != null))
    {
      ...
      localObject = (LinearLayout)paramView.findViewById(2131371661);
      if (i == 2)
      {
        paramMessage = paramQQAppInterface.getAVNotifyCenter().a(l);
        ((LinearLayout)localObject).setVisibility(0);
        localObject = new ImageView[3];
        localObject[0] = ((ImageView)paramView.findViewById(2131363147));
        localObject[1] = ((ImageView)paramView.findViewById(2131363149));
        localObject[2] = ((ImageView)paramView.findViewById(2131363151));
        ...
        while (i < j)
        {
          ...
          localObject[0].setImageBitmap(a(String.valueOf(((lnd)paramMessage.get(0)).a), paramQQAppInterface));
        }
      }
    }
    else
    {
      ...
      localTextView.setText(2131689956);
      lzr.a(localView, bool, paramBoolean);
    }
    label401:
    label925:
    for (;;)
    {
      bdla.a(paramQQAppInterface, "dc00898", "", "", "0X8009EE1", "0X8009EE1", 1, 0, "", "", "", "");
      return;
      label426:
      if (paramMessage.size() == 2)
      {
        ...
        localObject[2].setVisibility(8);
        localObject[0].setImageBitmap(a(String.valueOf(((lnd)paramMessage.get(0)).a), paramQQAppInterface));
        localObject[1].setImageBitmap(a(String.valueOf(((lnd)paramMessage.get(1)).a), paramQQAppInterface));
        break;
      }
      i = 0;
      while (i < localObject.length)
      {
        ...
        localObject[i].setImageBitmap(a(String.valueOf(((lnd)paramMessage.get(i)).a), paramQQAppInterface));
        i += 1;
      }
      break;
      ((LinearLayout)localObject).setVisibility(0);
      ...
      if (j == 6)
      {
        localTextView.setText(paramQQAppInterface.getApp().getString(2131695441));
        lzr.a(localView, bool, paramBoolean);
      }
      else if (j >= 5)
      {
        paramView = paramQQAppInterface.getApp().getString(2131695439);
        paramView = paramView + " ";
      ...
      {
        localTextView.setText(paramQQAppInterface.getApp().getString(2131695127));
        lzr.a(localView, bool, paramBoolean);
      }
      else
      {
        ...
        paramMessage = paramQQAppInterface.getApp().getString(2131692741);
        paramView = paramMessage;
        if (i == 2) {
          paramView = paramMessage.replace(paramQQAppInterface.getApp().getString(2131719439), paramQQAppInterface.getApp().getString(2131719440));
        }
        mvk.a(localView, paramView);
        label978:
        lzr.a(localView, bool, paramBoolean);
      }
    }
    ...
    if (j == 3000)
    {
      paramMessage = paramQQAppInterface.getApp().getString(2131689948);
      paramView = paramMessage;
      if (i == 2) {
        paramView = paramMessage.replace(paramQQAppInterface.getApp().getString(2131719439), paramQQAppInterface.getApp().getString(2131719440));
      }
    ...
    for (;;)
    {
      ...
      {
        lzr.a(localView, false, paramBoolean);
        return;
        if (j == 1)
        {
          paramView = paramQQAppInterface.getApp().getString(2131689941);
          if (i != 2) {
            break label1533;
          }
          paramView = paramView.replace(paramQQAppInterface.getApp().getString(2131719439), paramQQAppInterface.getApp().getString(2131719440));
          localImageView.setImageDrawable(null);
          continue;
        }
        if (!QLog.isColorLevel()) {
      ...
      paramMessage = paramQQAppInterface.getApp().getString(2131692740);
      paramView = paramMessage;
      if (i == 2) {
        paramView = paramMessage.replace(paramQQAppInterface.getApp().getString(2131719439), paramQQAppInterface.getApp().getString(2131719440));
      }
      ...
      {
        if (paramQQAppInterface.getAVNotifyCenter().f()) {
          localTextView.setText(2131695723);
        }
        for (;;)
        {
          mvk.a(localView, paramQQAppInterface.getApp().getString(2131690227));
          lzr.a(localView, bool, paramBoolean);
          break;
          paramView = paramQQAppInterface.getAVNotifyCenter().e();
          paramMessage = paramQQAppInterface.getApp().getString(2131695118);
          localTextView.setText(paramMessage + " " + paramView);
        }
      }
      if ((i == 2) && (!paramQQAppInterface.getAVNotifyCenter().k()))
      {
        ...
        for (;;)
        {
          ...
          break;
          paramView = paramQQAppInterface.getAVNotifyCenter().e();
          paramMessage = paramQQAppInterface.getApp().getString(2131695696);
          localTextView.setText(paramMessage + " " + paramView);
        }
      }
      lzr.a(localView, false, paramBoolean);
