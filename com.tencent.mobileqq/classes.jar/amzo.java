  ...
  implements amzt
{
  ...
  private Map<String, amzs> jdField_a_of_type_JavaUtilMap = Collections.synchronizedMap(new LinkedHashMap());
  
  public amzo(int paramInt)
  {
  ...
  private int a(String paramString1, String paramString2)
  {
    try
    {
      ...
      paramString1 = (amzs)this.jdField_a_of_type_JavaUtilMap.get(paramString1);
  ...
  public String a(String paramString)
  {
    ...
    Object localObject = (amzs)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localObject == null)
    {
      localObject = "";
      return localObject;
    }
    String str = ((amzs)localObject).jdField_b_of_type_JavaLangString;
    if (TextUtils.isEmpty(str))
    {
      a();
      str = ((amzs)localObject).jdField_b_of_type_JavaLangString;
    }
    for (;;)
    {
      localObject = str;
      ...
      for (;;)
      {
        ...
        if (localJSONArray != null)
        {
          ...
          while (i < localJSONArray.length())
          {
            ...
            amzs localamzs = (amzs)this.jdField_a_of_type_JavaUtilMap.get(str1);
            localObject1 = localamzs;
            if (localamzs == null) {
              localObject1 = new amzs();
            }
            ((amzs)localObject1).jdField_a_of_type_JavaLangString = str1;
            ((amzs)localObject1).jdField_b_of_type_JavaLangString = str2;
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    amzf localamzf = new amzf();
    localamzf.jdField_a_of_type_Int = 10001;
    localamzf.jdField_a_of_type_JavaLangString = (this.jdField_a_of_type_Int + "_" + str);
    paramString = (amzs)this.jdField_a_of_type_JavaUtilMap.get(str);
    if (paramString != null)
    {
      if ((paramString.jdField_a_of_type_Amzk != null) && (paramString.jdField_a_of_type_Amzk.a() == 1))
      {
        c(-1004, str);
        return;
      }
      localamzf.jdField_b_of_type_Int = paramString.jdField_a_of_type_Int;
      paramString.jdField_a_of_type_JavaLangString = str;
    }
    while ((paramString.jdField_a_of_type_Boolean) && (!BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 4).getBoolean("apollo_sp_game_rsc_verify_" + localamzf.jdField_a_of_type_JavaLangString, false)))
    {
      QLog.i("cmgame_process.CmGameSubRscHandler", 1, "each pack requst only once in game.");
      b(this.jdField_a_of_type_Int, str);
      return;
      paramString = new amzs();
      paramString.jdField_a_of_type_JavaLangString = str;
      localamzf.jdField_b_of_type_Int = 0;
      this.jdField_a_of_type_JavaUtilMap.put(str, paramString);
    }
    QLog.i("cmgame_process.CmGameSubRscHandler", 1, "[cmgame_pack_sub], request, packname:" + str + ",ver:" + localamzf.jdField_b_of_type_Int);
    paramString = new ArrayList();
    paramString.add(localamzf);
    localamzx.a(this.jdField_a_of_type_Int, str, paramString);
  }
  
  public void a(amre paramamre, long paramLong)
  {
    if ((this.jdField_a_of_type_AndroidContentContext == null) && (paramamre != null))
    {
      QLog.w("cmgame_process.CmGameSubRscHandler", 1, "[onDownloadConfirm], ctx:" + this.jdField_a_of_type_AndroidContentContext);
      paramamre.a(null);
      return;
    }
    ThreadManager.getUIHandler().post(new CmGameSubRscHandler.2(this, paramLong, paramamre));
  }
  
  public void a(amzn paramamzn)
  {
    if (paramamzn == null) {}
    amzk localamzk = new amzk(paramamzn, this);
    amzs localamzs = (amzs)this.jdField_a_of_type_JavaUtilMap.get(paramamzn.jdField_b_of_type_JavaLangString);
    if (localamzs != null) {
      localamzs.jdField_a_of_type_Amzk = localamzk;
    }
    QLog.i("cmgame_process.CmGameSubRscHandler", 1, "[cmgame_pack_sub], response, isUpdate:" + paramamzn.jdField_a_of_type_Boolean + ",svrVer:" + paramamzn.jdField_a_of_type_Int + ",isPatch:" + paramamzn.jdField_b_of_type_Boolean);
    if (!localamzk.a()) {
      b(paramamzn.jdField_b_of_type_Int, paramamzn.jdField_b_of_type_JavaLangString);
    }
  }
  ...
  {
    c(0, paramString);
    amzs localamzs = (amzs)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localamzs != null)
    {
      localamzs.jdField_a_of_type_Boolean = true;
      paramInt = a(paramString, localamzs.jdField_b_of_type_JavaLangString);
  ...
  public void b(long paramLong, String paramString)
  {
    try
    {
      ...
      if (TextUtils.isEmpty(((amzs)localObject).jdField_b_of_type_JavaLangString)) {
        a();
      }
      localObject = new ankv(this.jdField_a_of_type_Int, 1, paramString, ((amzs)localObject).jdField_b_of_type_JavaLangString);
      ((ankv)localObject).a(new amzr(this, paramString));
      ((ankv)localObject).a();
      return;
    }
    catch (Throwable paramString)
