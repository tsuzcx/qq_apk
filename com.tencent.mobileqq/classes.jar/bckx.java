  ...
  implements Manager
{
  ...
  protected Handler a;
  protected ArrayMap<Long, ArrayList<bckw>> a;
  protected AppInterface a;
  protected String a;
  public WeakReference<bclg> a;
  protected ArrayList<String> a;
  protected HashMap<Long, MessageForUniteGrayTip> a;
  protected List<bclh> a;
  public boolean a;
  protected ArrayMap<Long, ArrayList<bckw>> b;
  public String b;
  ...
  public bckx(AppInterface paramAppInterface)
  {
    ...
    this.jdField_c_of_type_JavaUtilList.add(alpo.a(2131716141));
    this.jdField_d_of_type_JavaUtilList.add(alpo.a(2131716127));
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilArrayList = bcgx.a(paramQQAppInterface);
        if (this.jdField_a_of_type_JavaUtilArrayList == null) {
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      Object localObject = bdeo.d.matcher(paramMessageRecord.msg);
  ...
  private void a(MessageRecord paramMessageRecord, String paramString1, String paramString2, String paramString3)
  {
    ...
    b(Long.parseLong(paramMessageRecord.frienduin), Long.parseLong(paramString1), paramString3, new bclc(this, paramString3));
  }
  ...
  private void a(String paramString)
  {
    ...
    bdiv.c(localQQAppInterface.getApplication(), localQQAppInterface.c(), paramString, false);
  }
  ...
  {
    azmj.b(null, "dc00899", "Grp_robot", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public static boolean a(TextView paramTextView, MessageRecord paramMessageRecord)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      String str2 = alpo.a(2131716129);
      SpannableString localSpannableString = new SpannableString(str2);
      localSpannableString.setSpan(new bckz(str1, paramMessageRecord), 0, str2.length(), 33);
  ...
  public static String b(MessageRecord paramMessageRecord)
  {
    if (b(paramMessageRecord))
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramMessageRecord))) {
        return paramMessageRecord + alpo.a(2131716137);
      }
    }
    return null;
  }
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Alox != null) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))) {
      return;
    }
    this.jdField_a_of_type_Alox = new bcla(this);
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Alox);
  }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Alox != null) && (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null))
    {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Alox);
  ...
  private void d()
  {
    Object localObject1 = bdiv.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      try
      {
        ...
        localObject2 = bdiv.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
      }
    ...
    try
    {
      ...
      if (localObject2 != null) {
        a(((aors)localObject2).a(), ((aors)localObject2).a());
      }
      return;
    }
  ...
  public bckv a(long paramLong)
  {
    bckv localbckv = new bckv();
    localbckv.jdField_a_of_type_JavaUtilArrayList = a(paramLong);
    localbckv.b = b(paramLong);
    localbckv.jdField_a_of_type_Int = a(paramLong);
    return localbckv;
  }
  ...
  public ArrayList<bckw> a(long paramLong)
  {
    ...
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
      {
        if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong)))
        {
          ...
          while (localIterator.hasNext())
          {
            bckw localbckw = (bckw)localIterator.next();
            if (localbckw.a()) {
              localArrayList.add(localbckw);
            }
          }
        }
      }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, bclf parambclf)
  {
    ...
    mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcld(this, parambclf), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(int paramInt, long paramLong1, long paramLong2, String paramString, bclf parambclf)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    ...
    localReqBody.robot_uin.set(paramLong2);
    mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcle(this, parambclf), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(long paramLong, int paramInt, bclf parambclf)
  {
    a(4, 0L, paramLong, paramInt, parambclf);
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (localMessageForUniteGrayTip != null)
    {
      ...
      aslq.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, localMessageForUniteGrayTip);
    }
  }
      ...
      for (;;)
      {
        synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
        {
          if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong1)))
          {
            ...
            bckw localbckw = (bckw)((Iterator)localObject1).next();
            if (localbckw.a() != paramLong2) {
              continue;
            }
            ...
            if (!localbckw.a())
            {
              localObject1 = localObject4;
              if (paramInt == 1) {
                localObject1 = localbckw;
              }
            }
            localbckw.a(paramInt);
            if (localObject1 != null)
            {
              localArrayList.remove(localObject1);
              localArrayList.add(0, localObject1);
              if (QLog.isColorLevel()) {
                QLog.d("TroopRobotManager", 2, "onSetTroopRobot move position " + ((bckw)localObject1).a());
              }
            }
          }
          return;
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, bclf parambclf)
  {
    a(1, paramLong1, paramLong2, paramInt, parambclf);
  }
  
  public void a(long paramLong1, long paramLong2, String paramString, bclf parambclf)
  {
    a(3, paramLong1, paramLong2, paramString, parambclf);
  }
  
  public void a(long paramLong, String paramString, bclf parambclf)
  {
    a(Long.valueOf("1").longValue(), paramLong, paramString, parambclf);
  }
  
  public void a(long paramLong, ArrayList<bckw> paramArrayList)
  {
  ...
  public void a(long paramLong, ArrayList<bckw> arg3, int paramInt)
  {
    StringBuilder localStringBuilder;
    if (QLog.isColorLevel())
    {
  ...
  {
    String str = bdbt.h(paramQQAppInterface, paramChatMessage.frienduin, paramChatMessage.senderuin);
    paramEditText = bceh.a(paramQQAppInterface, paramContext, paramSessionInfo.jdField_a_of_type_JavaLangString, paramChatMessage.senderuin, str, false, paramEditText, true, true);
    paramContext = new ArrayList();
    paramEditText = bceh.a(paramEditText, paramContext);
    ...
    try
    {
      ...
      new azmo(paramQQAppInterface).a("dc00899").b("Grp_robot").c("sub_page").d("next_msg_clk").a(new String[] { paramChatMessage.frienduin, paramSessionInfo }).a();
      return;
    }
  ...
  public void a(bclg parambclg)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambclg);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localArrayList = bcgx.b(paramQQAppInterface);
      if (localArrayList == null)
      {
        ...
        if ((paramArrayList == null) || (paramArrayList.size() == 0))
        {
          ...
          bcgx.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
          bcgx.a(paramQQAppInterface, false);
    ...
    for (;;)
    {
      ...
      {
        bcgx.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
        bcgx.b(paramQQAppInterface, localArrayList);
        if (paramArrayList.size() <= 0) {
          break label392;
        }
        bcgx.a(paramQQAppInterface, true);
        bcgx.c(paramQQAppInterface, true);
        break label392;
        break;
        i -= 1;
        break label182;
    ...
    try
    {
      ...
      if (paramRobot.uin_range.has())
      {
        ...
        while ((i < paramRobot.uin_range.size()) && (i < 5))
        {
          ...
          localbclh.a = localUinRange.start_uin.get();
          localbclh.b = localUinRange.end_uin.get();
          this.jdField_a_of_type_JavaUtilList.add(localbclh);
          i += 1;
        }
      }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      b(Long.parseLong(paramString1), Long.parseLong(paramString2), paramString3, new bclb(this, paramString3));
      a();
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (localJSONArray != null) {
      bdiv.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localJSONArray.toString());
    }
    paramJSONObject = paramJSONObject.optJSONObject("robot_voice_tail");
    if (paramJSONObject != null) {
      bdiv.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramJSONObject.toString());
    }
    d();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        bclh localbclh = (bclh)this.jdField_a_of_type_JavaUtilList.get(i);
        if ((localbclh != null) && (paramLong >= localbclh.a) && (paramLong <= localbclh.b)) {
          bool1 = true;
        }
      }
      else
  ...
  public boolean a(Context paramContext, String paramString, long paramLong)
  {
    if (a(paramLong))
    {
      bcgx.a(paramContext, paramString, String.valueOf(paramLong));
      return true;
    }
    return false;
  }
  ...
  {
    boolean bool2 = false;
    if (!bcgx.d(paramQQAppInterface, paramString2))
    {
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord.atInfoList != null) && (paramMessageRecord.atInfoList.size() > 0))
    {
      ...
      for (;;)
      {
        ...
        if (a(((MessageForText.AtTroopMemberInfo)localObject).uin))
        {
          ...
          str1 = bdbt.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramMessageRecord.frienduin, "" + ((MessageForText.AtTroopMemberInfo)localObject).uin);
          ...
          for (;;)
          {
            ...
            if (str2.equals(((String)this.jdField_c_of_type_JavaUtilList.get(j)).replace("$ROBOTNICK$", str1)))
            {
              ...
              azmj.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "conti_dialog_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_c_of_type_JavaUtilList.get(i), "");
              return true;
            }
            j += 1;
          }
    ...
    while (i < this.jdField_b_of_type_JavaUtilList.size())
    {
      ...
      for (localObject = "";; localObject = ((String)localObject).toUpperCase().replaceAll(" ", ""))
      {
        ...
        azmj.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "keyword_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_b_of_type_JavaUtilList.get(i), "");
        return true;
      }
      i += 1;
    }
  ...
  {
    boolean bool2 = false;
    paramString2 = bdbt.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramString3, "" + paramString2);
  ...
  public byte[] a()
  {
    return bdcs.a(BaseApplication.getContext().getFileStreamPath("troop_robot_config"));
  }
  
  public byte[] a(String paramString1, String paramString2)
  {
    return bdcs.a(BaseApplication.getContext().getFileStreamPath("troop_robot_panel_data_" + paramString1 + "_" + paramString2));
  }
  
  public ArrayList<bckw> b(long paramLong)
  {
    ArrayList localArrayList = new ArrayList(0);
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
  ...
  public void b(int paramInt, long paramLong1, long paramLong2, String paramString, bclf parambclf)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    localReqBody.cmd.set(paramInt, true);
    localReqBody.group_id.set(paramLong1, true);
    localReqBody.keyword.set(paramString, true);
    localReqBody.robot_uin.set(paramLong2);
    mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcky(this, parambclf), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void b(long paramLong1, long paramLong2, String paramString, bclf parambclf)
  {
    b(2, paramLong1, paramLong2, paramString, parambclf);
  }
  
  public void b(long paramLong, String paramString, bclf parambclf)
  {
    b(2, Long.valueOf("1").longValue(), paramLong, paramString, parambclf);
  }
