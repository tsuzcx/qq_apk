  ...
  extends osp
{
  ...
  private WeakReference<paq> jdField_b_of_type_JavaLangRefWeakReference;
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  
  public osi(AppInterface paramAppInterface, paq parampaq)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramAppInterface);
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(parampaq);
  ...
  private void a(aukn paramaukn, long paramLong, int paramInt)
  {
    if (paramaukn == null)
    {
    ...
    {
      ReadinjoyFollowingUserBriefInfo localReadinjoyFollowingUserBriefInfo = (ReadinjoyFollowingUserBriefInfo)paramaukn.a(ReadinjoyFollowingUserBriefInfo.class, String.valueOf(paramLong));
      if (localReadinjoyFollowingUserBriefInfo != null) {
        paramaukn.b(localReadinjoyFollowingUserBriefInfo);
      }
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(paramLong));
      return;
    }
    paramaukn.b(new ReadinjoyFollowingUserBriefInfo(paramLong, paramInt));
    this.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(paramLong));
  }
  
  private void a(List<qbc> paramList, int paramInt)
  {
    if (paramList == null) {}
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        while (paramList.hasNext()) {
          a((aukn)localObject, ((qbc)paramList.next()).a().longValue(), paramInt);
        }
      }
    }
  }
  
  private void a(List<qbc> paramList, boolean paramBoolean)
  {
    ...
    {
      return;
      paramList = (paq)this.jdField_b_of_type_JavaLangRefWeakReference.get();
