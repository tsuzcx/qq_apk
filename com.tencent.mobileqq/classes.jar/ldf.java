...
public class ldf
  implements Runnable
{
  public ldf(ReadInJoyNaviController paramReadInJoyNaviController, ChannelCoverInfo paramChannelCoverInfo) {}
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (ReadInJoyNaviController.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyReadInJoyNaviController)))
    {
      ...
      localTranslateAnimation.setAnimationListener(new ldg(this));
