...
public class ldf
{
  ...
  private List<ldg> jdField_a_of_type_JavaUtilList;
  private ldh jdField_a_of_type_Ldh;
  ...
  public ldf(@NonNull VideoAppInterface paramVideoAppInterface, String paramString)
  {
    ...
    this.d = 0L;
    this.jdField_a_of_type_Ldh = new ldh(this);
  ...
  private void a(int paramInt)
  {
    ...
    Map localMap = bbct.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp());
  ...
  private void a(long paramLong, Map<String, Integer> paramMap)
  {
    ...
    this.jdField_a_of_type_JavaUtilList.add(new ldg(a(), a(paramMap, "summary.total-pss"), a(paramMap, "summary.java-heap"), a(paramMap, "summary.native-heap"), a(paramMap, "summary.code"), a(paramMap, "summary.graphics"), paramLong));
  }
  ...
  private void c()
  {
    ...
    if (j >= 4)
    {
      l1 = ((ldg)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_a_of_type_Long;
      l2 = ((ldg)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_a_of_type_Long;
      l3 = ((ldg)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_b_of_type_Long;
      l4 = ((ldg)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_b_of_type_Long;
      l5 = ((ldg)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_c_of_type_Long;
      l6 = ((ldg)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_c_of_type_Long;
      i = 1;
      if (i >= j - 1 - 1) {
        break label1067;
      }
      localObject3 = (ldg)this.jdField_a_of_type_JavaUtilList.get(i);
      localldg = (ldg)this.jdField_a_of_type_JavaUtilList.get(i + 1);
      if ((((ldg)localObject3).jdField_a_of_type_Int != 0) && (((ldg)localObject3).jdField_a_of_type_Int != localldg.jdField_a_of_type_Int))
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject3).hasNext())
          {
            ...
            continue;
            this.jdField_c_of_type_Int = localldg.jdField_a_of_type_Int;
            if ((!((ldg)localObject3).a()) || (!localldg.a())) {
              if (QLog.isColorLevel()) {
      ...
      do
      {
        ...
        {
          return;
          d1 = localldg.f - ((ldg)localObject3).f;
          d2 = localldg.jdField_a_of_type_Long - ((ldg)localObject3).jdField_a_of_type_Long;
          d3 = localldg.jdField_b_of_type_Long - ((ldg)localObject3).jdField_b_of_type_Long;
          double d4 = localldg.jdField_c_of_type_Long - ((ldg)localObject3).jdField_c_of_type_Long;
          if (d1 <= 0.0D)
          {
            if (QLog.isColorLevel()) {
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            ...
            ((HashMap)localObject2).put("device_memory", String.valueOf(bbct.d() / 1024L));
