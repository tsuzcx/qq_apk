...
public class ldf
{
  ...
  public ldf(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().bindService(localIntent, this.jdField_a_of_type_Ldg, 1);
      return;
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        lbd.h(jdField_a_of_type_JavaLangString, "bindService " + localThrowable.getMessage());
      }
    }
  }
  ...
  {
    QLog.d(jdField_a_of_type_JavaLangString, 1, String.format("setAVServiceForegroud start=%s mAvService=%s", new Object[] { Boolean.valueOf(paramBoolean), this.jdField_a_of_type_Lws }));
    if (this.jdField_a_of_type_Lws != null) {}
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Lws.a(paramBoolean, paramNotification);
  ...
  public void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().unbindService(this.jdField_a_of_type_Ldg);
      return;
    }
    catch (Exception localException)
    {
      lbd.h(jdField_a_of_type_JavaLangString, "disconnect msg = " + localException.getMessage());
    }
  }
}
