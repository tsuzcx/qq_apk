  ...
  extends pgp
{
  ...
  pgg jdField_a_of_type_Pgg = new pgg(this);
  ...
  {
    int j = pvb.a(paramFromServiceMsg, paramObject, paramMessageMicro);
  ...
  private ToServiceMsg a(pve parampve)
  {
    if (parampve == null) {
      return null;
    }
    if (parampve.jdField_b_of_type_Int == -1) {
      return null;
    }
    parampve.jdField_a_of_type_Int = 5;
    parampve.jdField_a_of_type_Boolean = true;
    oidb_cmd0x68b.ReqBody localReqBody = new oidb_cmd0x68b.ReqBody();
    long l1 = ork.a();
    long l2 = Long.valueOf(ors.a()).longValue();
    ...
    localReqChannelPara.uint64_channel_id.set(parampve.jdField_b_of_type_Int);
    localReqChannelPara.uint32_req_channel_list.set(1);
    a(localReqChannelPara);
    qjz.a(localReqChannelPara, String.valueOf(parampve.jdField_b_of_type_Int));
    localReqChannelPara.uint32_residence_time.set((int)qjz.a(parampve.jdField_b_of_type_Int));
    if (parampve.jdField_a_of_type_Long != -1L) {
      localReqChannelPara.uint64_begin_recommend_seq.set(parampve.jdField_a_of_type_Long);
    }
    if (parampve.jdField_b_of_type_Long != -1L) {
      localReqChannelPara.uint64_end_recommend_seq.set(parampve.jdField_b_of_type_Long);
    }
    if (parampve.jdField_a_of_type_Boolean) {
      localReqChannelPara.uint32_req_article_list.set(1);
    }
    if (parampve.jdField_b_of_type_Boolean) {
    ...
    localReqChannelPara.uint32_req_recommend_flag.set(parampve.jdField_i_of_type_Int);
    label325:
    label341:
    Object localObject1;
    label459:
    ...
    label951:
    Object localObject4;
    if (parampve.jdField_d_of_type_Boolean)
    {
      localReqChannelPara.uint32_req_video_list.set(1);
      if (!parampve.jdField_e_of_type_Boolean) {
        break label1127;
      }
      localReqChannelPara.uint32_req_picture_list.set(1);
      if (!parampve.jdField_f_of_type_Boolean) {
        break label1139;
      }
      localReqChannelPara.uint32_need_force_set_top.set(1);
      if (parampve.jdField_a_of_type_ArrayOfByte != null) {
        localReqChannelPara.bytes_set_top_cookie.set(ByteStringMicro.copyFrom(parampve.jdField_a_of_type_ArrayOfByte));
      }
      if (parampve.jdField_b_of_type_ArrayOfByte != null) {
        localReqChannelPara.bytes_device_id.set(ByteStringMicro.copyFrom(parampve.jdField_b_of_type_ArrayOfByte));
      }
      ...
      localReqChannelPara.uint32_privacy_status.set(syz.b());
      ...
      if (parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData != null)
      {
        localObject3 = new oidb_cmd0x68b.ChannelLocationInfo();
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).city.set(ByteStringMicro.copyFromUtf8(parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.city));
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).province.set(ByteStringMicro.copyFromUtf8(parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.province));
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).nation.set(ByteStringMicro.copyFromUtf8(parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.country));
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).city_code.set(ByteStringMicro.copyFromUtf8(parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.cityCode));
        localReqChannelPara.msg_channel_location_info.set((MessageMicro)localObject3);
        if (QLog.isColorLevel()) {
          QLog.i("ArticleInfoModule", 1, "0x68b request positionInfo = " + parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData);
        }
      }
      QLog.i("ArticleInfoModule", 1, "0x68b request brand = " + (String)localObject1 + ", model = " + (String)localObject2);
      localObject1 = new ArrayList();
      if ((parampve.jdField_i_of_type_Boolean) && (parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo != null))
      {
        localObject2 = new oidb_cmd0x68b.InnerMsg();
        ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(4);
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.articleID)));
        ((oidb_cmd0x68b.InnerMsg)localObject2).template_id.set(parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.templateID);
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampve.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.extraInfo));
        ((List)localObject1).add(localObject2);
      }
      if (TextUtils.isEmpty(parampve.jdField_a_of_type_JavaLangString)) {
        break label1219;
      }
      localObject2 = new oidb_cmd0x68b.InnerMsg();
      if (parampve.jdField_h_of_type_Int != 5) {
        break label1167;
      }
      ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(5);
      ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(parampve.jdField_a_of_type_JavaLangString));
      if (!TextUtils.isEmpty(parampve.jdField_b_of_type_JavaLangString)) {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(parampve.jdField_b_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(parampve.jdField_c_of_type_JavaLangString))
      {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampve.jdField_c_of_type_JavaLangString));
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "add push contenxt:" + parampve.jdField_c_of_type_JavaLangString);
        }
      }
      ((List)localObject1).add(localObject2);
      if ((parampve.jdField_b_of_type_JavaUtilList == null) || (parampve.jdField_b_of_type_JavaUtilList.size() <= 0)) {
        break label1391;
      }
      localObject2 = parampve.jdField_b_of_type_JavaUtilList.iterator();
      if (!((Iterator)localObject2).hasNext()) {
        break label1499;
      }
      localObject3 = (Long)((Iterator)localObject2).next();
      localObject4 = new oidb_cmd0x68b.InnerMsg();
      if (parampve.jdField_h_of_type_Int <= 0) {
        break label1379;
      }
      ((oidb_cmd0x68b.InnerMsg)localObject4).uint32_jump_src_type.set(parampve.jdField_h_of_type_Int);
    }
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(parampve.jdField_c_of_type_JavaLangString))
      {
        ((oidb_cmd0x68b.InnerMsg)localObject4).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampve.jdField_c_of_type_JavaLangString));
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "add push contenxt:" + parampve.jdField_c_of_type_JavaLangString);
        }
      }
      ((oidb_cmd0x68b.InnerMsg)localObject4).uint64_algorithm_id.set(parampve.jdField_d_of_type_Long);
      ((oidb_cmd0x68b.InnerMsg)localObject4).uint32_strategy_id.set((int)parampve.jdField_e_of_type_Long);
      ...
      break label911;
      label1219:
      if (parampve.jdField_c_of_type_Long == -1L) {
        break label921;
      }
      localObject2 = new ArrayList();
      localObject3 = new oidb_cmd0x68b.SubscribeMsg();
      ((oidb_cmd0x68b.SubscribeMsg)localObject3).uint64_source_article_id.set(parampve.jdField_c_of_type_Long);
      if (!TextUtils.isEmpty(parampve.jdField_b_of_type_JavaLangString)) {
        ((oidb_cmd0x68b.SubscribeMsg)localObject3).bytes_title.set(ByteStringMicro.copyFromUtf8(parampve.jdField_b_of_type_JavaLangString));
      }
      ...
      ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(parampve.jdField_c_of_type_Long)));
      if (!TextUtils.isEmpty(parampve.jdField_b_of_type_JavaLangString)) {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(parampve.jdField_b_of_type_JavaLangString));
      }
      ((List)localObject1).add(localObject2);
    ...
    label1391:
    if (parampve.jdField_b_of_type_Int == 40830)
    {
      localObject2 = new oidb_cmd0x68b.InnerMsg();
      if (parampve.jdField_h_of_type_Int <= 0) {
        break label1718;
      }
      ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(parampve.jdField_h_of_type_Int);
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(parampve.jdField_c_of_type_JavaLangString))
      {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampve.jdField_c_of_type_JavaLangString));
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "troop subscribe add push contenxt:" + parampve.jdField_c_of_type_JavaLangString);
        }
      }
      ((List)localObject1).add(localObject2);
      label1499:
      if ((parampve.jdField_c_of_type_JavaUtilList == null) || (parampve.jdField_c_of_type_JavaUtilList.isEmpty())) {
        break;
      }
      localObject2 = parampve.jdField_c_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject3 = (owo)((Iterator)localObject2).next();
        QLog.d("ArticleInfoModule", 2, "InsertArticleInfo :" + localObject3);
        localObject4 = new oidb_cmd0x68b.InnerMsg();
        ((oidb_cmd0x68b.InnerMsg)localObject4).uint32_jump_src_type.set(pve.a((owo)localObject3));
        ((oidb_cmd0x68b.InnerMsg)localObject4).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(((owo)localObject3).jdField_a_of_type_Long)));
        if (!TextUtils.isEmpty(parampve.jdField_c_of_type_JavaLangString)) {
          ((oidb_cmd0x68b.InnerMsg)localObject4).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampve.jdField_c_of_type_JavaLangString));
        }
        ((oidb_cmd0x68b.InnerMsg)localObject4).uint64_algorithm_id.set(parampve.jdField_d_of_type_Long);
        ...
        if (parampve.jdField_b_of_type_JavaUtilList == null) {
          parampve.jdField_b_of_type_JavaUtilList = new ArrayList();
        }
        parampve.jdField_b_of_type_JavaUtilList.add(0, Long.valueOf(((owo)localObject3).jdField_a_of_type_Long));
      }
      label1718:
      ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(1);
    }
    pcz.a(parampve, (List)localObject1);
    if (parampve.jdField_b_of_type_JavaUtilList != null) {
      localReqChannelPara.rpt_subscription_article_list.set(parampve.jdField_b_of_type_JavaUtilList);
    }
    if (parampve.jdField_a_of_type_Pxh != null)
    {
      localObject2 = new oidb_cmd0x68b.UserReadArticle();
      ((oidb_cmd0x68b.UserReadArticle)localObject2).uint64_source.set(1L);
      localObject3 = new ArrayList();
      localObject4 = parampve.jdField_a_of_type_Pxh.a.iterator();
      ...
      localObject3 = new ArrayList();
      localObject4 = parampve.jdField_a_of_type_Pxh.b.iterator();
      while (((Iterator)localObject4).hasNext()) {
        ((List)localObject3).add(ByteStringMicro.copyFromUtf8((String)((Iterator)localObject4).next()));
      }
    ...
    if ((parampve.jdField_d_of_type_JavaUtilList != null) && (parampve.jdField_d_of_type_JavaUtilList.size() > 0))
    {
      localObject1 = new ArrayList();
      localObject2 = parampve.jdField_d_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject2).hasNext()) {
        ((List)localObject1).add(((pvd)((Iterator)localObject2).next()).a());
      }
      localReqChannelPara.rpt_pkg_install_info.set((List)localObject1);
    }
    if (ors.q())
    {
      localObject1 = a(parampve.jdField_b_of_type_Int);
    ...
    localReqBody.uint32_req_dislike_type.set(parampve.jdField_e_of_type_Int);
    if (ork.b(l1)) {
      ork.a(parampve);
    }
    localReqBody.uint64_client_swithes.set(parampve.jdField_f_of_type_Int);
    localReqBody.enum_refresh_type.set(parampve.jdField_g_of_type_Int);
    if ((parampve.jdField_b_of_type_Int == 0) && (ors.a()))
    {
      localObject1 = new oidb_cmd0x68b.RefreshHistory();
      ((oidb_cmd0x68b.RefreshHistory)localObject1).bytes_session_id.set(ByteStringMicro.copyFromUtf8(ors.i()));
      ((oidb_cmd0x68b.RefreshHistory)localObject1).rpt_refresh_history.set(ors.a());
      if (QLog.isColorLevel()) {
        QLog.d("ArticleInfoModule", 2, "session_id = " + ors.i() + ", history = " + ors.a().toString());
      }
      localReqBody.msg_refresh_history.set((MessageMicro)localObject1);
    }
    int j;
    if (parampve.jdField_h_of_type_Boolean)
    {
      localObject1 = (oxd)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(163);
      if (localObject1 != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "AdvertisementInfoModule reqAdvertisementList params.beginRecommendSeq = " + parampve.jdField_a_of_type_Long);
        }
        i = 0;
        j = 30;
        owy.a().a(parampve.jdField_b_of_type_Int, true);
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "AdvertisementInfoModule reqAdvertisementList  adStartPos = " + i + " adEndPos" + j);
        }
        if (owy.a().a(parampve.jdField_b_of_type_Int))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ArticleInfoModule", 2, "AdvertisementInfoModule reqAdvertisementList needRequestAdvertisement channelID= " + parampve.jdField_b_of_type_Int);
          }
          int k = 1;
          if ((parampve.jdField_g_of_type_Int == 2) || (parampve.jdField_g_of_type_Int == 4)) {
            k = 2;
          }
          localObject2 = ((oxd)localObject1).a().a(parampve, parampve.jdField_b_of_type_Int, k, i, j);
          ((oxd)localObject1).a().a(parampve.jdField_b_of_type_Int, i, j);
    ...
    if (parampve.jdField_b_of_type_Int == 41403)
    {
      localObject1 = pvb.a("OidbSvc.0xbf7", 3063, parampve.j, localReqBody.toByteArray());
      QLog.d("ArticleInfoModule", 1, new Object[] { "make 0xbf7 OIDB Pkg, beginSeq = ", Long.valueOf(parampve.jdField_a_of_type_Long), ", endSeq = ", Long.valueOf(parampve.jdField_b_of_type_Long) });
      label2860:
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_c_of_type_JavaLangString, Integer.valueOf(parampve.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_d_of_type_JavaLangString, Long.valueOf(parampve.jdField_a_of_type_Long));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_e_of_type_JavaLangString, Long.valueOf(parampve.jdField_b_of_type_Long));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_f_of_type_JavaLangString, Integer.valueOf(1));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_b_of_type_JavaLangString, Integer.valueOf(parampve.jdField_g_of_type_Int));
      ((ToServiceMsg)localObject1).getAttributes().put("recommendFlag", Integer.valueOf(parampve.jdField_i_of_type_Int));
      if (parampve.jdField_b_of_type_JavaUtilList != null) {
        ((ToServiceMsg)localObject1).getAttributes().put("SubscriptionArticles", parampve.jdField_b_of_type_JavaUtilList);
      }
      a(localReqBody, (ToServiceMsg)localObject1, l1);
      ork.a((ToServiceMsg)localObject1, l1);
      ((ToServiceMsg)localObject1).getAttributes().put("channelID", new Integer(parampve.jdField_b_of_type_Int));
      ((ToServiceMsg)localObject1).getAttributes().put("isSingleHighLight", Boolean.valueOf(parampve.jdField_g_of_type_Boolean));
      ((ToServiceMsg)localObject1).getAttributes().put("clientSwithes", Integer.valueOf(parampve.jdField_f_of_type_Int));
      localObject2 = ((ToServiceMsg)localObject1).getAttributes();
      if ((parampve.jdField_b_of_type_JavaUtilList == null) || (parampve.jdField_b_of_type_JavaUtilList.isEmpty())) {
        break label3489;
      }
      bool = true;
      label3100:
      ...
      localObject2 = ((ToServiceMsg)localObject1).getAttributes();
      if ((parampve.jdField_i_of_type_Int & 0x100) == 0) {
        break label3495;
      }
    }
    label3489:
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      return localObject1;
      label3152:
      localObject2 = owy.a().a(parampve.jdField_b_of_type_Int);
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
      ...
      localObject2 = (ConcurrentHashMap)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(parampve.jdField_b_of_type_Int));
      if (localObject2 == null) {
        break;
      }
      if (QLog.isColorLevel()) {
      ...
      if ((otf.c(parampve.jdField_b_of_type_Int)) || (bjxj.a(parampve.jdField_b_of_type_Int)))
      {
        ...
        if (bjxj.w())
        {
          ...
          localObject1 = pvb.a("OidbSvc.0xcba", 3258, 0, localReqBody.toByteArray());
          ((ToServiceMsg)localObject1).getAttributes().put("realTimeServiceKey", "default_feeds");
          QLog.d("ArticleInfoModule", 1, new Object[] { "make 0xcba OIDB Pkg, beginSeq = ", Long.valueOf(parampve.jdField_a_of_type_Long), ", endSeq = ", Long.valueOf(parampve.jdField_b_of_type_Long) });
          break label2860;
        }
      }
      localObject1 = pvb.a("OidbSvc.0x68b", 1675, parampve.j, localReqBody.toByteArray());
      break label2860;
      bool = false;
      break label3100;
    }
  ...
  private oidb_cmd0x46f.DislikeParam a(qkq paramqkq)
  {
    oidb_cmd0x46f.DislikeParam localDislikeParam = new oidb_cmd0x46f.DislikeParam();
    localDislikeParam.uint64_articleid.set(paramqkq.jdField_a_of_type_Long);
    localDislikeParam.uint32_reasonid.set(paramqkq.jdField_a_of_type_Int);
    localDislikeParam.uint64_feeds_id.set(paramqkq.jdField_b_of_type_Long);
    localDislikeParam.uint64_biu_uin.set(paramqkq.jdField_c_of_type_Long);
    localDislikeParam.uint64_topic_id.set(paramqkq.jdField_d_of_type_Long);
    if ((paramqkq.jdField_a_of_type_JavaLangString != null) && (paramqkq.jdField_a_of_type_JavaLangString.length() > 0)) {
      localDislikeParam.bytes_rowkey.set(ByteStringMicro.copyFromUtf8(paramqkq.jdField_a_of_type_JavaLangString));
    }
    Object localObject1;
    Object localObject2;
    if ((paramqkq.jdField_a_of_type_JavaUtilList != null) && (paramqkq.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      localObject1 = paramqkq.jdField_a_of_type_JavaUtilList.iterator();
    ...
    if ((paramqkq.jdField_a_of_type_JavaUtilArrayList != null) && (paramqkq.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      paramqkq = paramqkq.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramqkq.hasNext())
      {
        localObject1 = (DislikeInfo)paramqkq.next();
  ...
  private void a(int paramInt, List<Long> paramList, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        localObject = syb.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramList);
        String str = syb.a(paramList);
        syb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, str, String.valueOf(l), (String)localObject, paramBoolean);
      }
      ...
      {
        localObject = (oye)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(274);
        if (localObject != null) {
          ((oye)localObject).a(syb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramList), l);
        }
      }
    ...
    } while ((!otf.c(paramInt)) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) || (paramList == null));
  ...
  private void a(long paramLong, int paramInt, oidb_cmd0x8c8.SocializeFeedsInfo paramSocializeFeedsInfo)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        qnm localqnm = localArticleInfo.mTopicRecommendFeedsInfo;
        if ((paramSocializeFeedsInfo.msg_topic_recommend_feeds_info.has()) && (localqnm != null) && (localqnm.jdField_a_of_type_JavaUtilArrayList != null))
        {
          ...
          if (((oidb_cmd0x8c8.TopicRecommendFeedsInfo)localObject).msg_topic_recommend_info.has())
          {
            ...
            paramInt = 0;
            while ((paramInt < ((List)localObject).size()) && (paramInt < localqnm.jdField_a_of_type_JavaUtilArrayList.size()))
            {
              oidb_cmd0x8c8.TopicRecommendInfo localTopicRecommendInfo = (oidb_cmd0x8c8.TopicRecommendInfo)((List)localObject).get(paramInt);
              qno localqno = (qno)localqnm.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
  ...
  private void a(ToServiceMsg paramToServiceMsg, Object paramObject, int paramInt, Integer paramInteger)
  {
    ...
    {
      ors.a(paramObject, bool, System.currentTimeMillis() - paramToServiceMsg.extraData.getLong("sendtimekey"), localHashMap);
      return;
    }
  }
    ...
    for (int k = ((Bundle)localObject9).getInt("FeedsRefreshType");; k = 0)
    {
          ...
          if (((l >> 9 & 1L) == 1L) && (paramRspBody.msg_rsp_get_follow_tab_data.has()))
          {
            ...
            if ((((oidb_cmd0x68b.RspGetFollowTabData)localObject6).bytes_set_top_cookie.has()) && (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).bytes_set_top_cookie.get() != null))
            {
              ...
              for (bool1 = true;; bool1 = false)
              {
                ...
                localObject5 = puy.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject6).rpt_article_list.get());
                if (localObject5 != null) {
                  a((List)localObject5, ((Integer)localObject2).intValue());
                }
                if (orf.a()) {
                  orf.a().a(((Integer)localObject2).intValue(), ((oidb_cmd0x68b.RspGetFollowTabData)localObject6).rpt_article_list.get(), (List)localObject5);
                }
                ...
                for (;;)
                {
                  ...
                  if ((((ArticleInfo)localObject3).mSocialFeedInfo != null) && (((ArticleInfo)localObject3).mSocialFeedInfo.jdField_a_of_type_Qna != null)) {
                    QLog.d("ArticleInfoModule", 2, "0x68b rpt article articleID = " + ((ArticleInfo)localObject3).mArticleID + " mRecommendSeq = " + ((ArticleInfo)localObject3).mRecommendSeq + " ChannelID = " + ((ArticleInfo)localObject3).mChannelID + " wendainfo = " + ((ArticleInfo)localObject3).mSocialFeedInfo.jdField_a_of_type_Qna.toString() + " followStatus = " + ((ArticleInfo)localObject3).mSocialFeedInfo.jdField_h_of_type_Int);
                  }
              ...
              if (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_has_followed_topic.has())
              {
                ...
                {
                  bool2 = true;
                  ((owy)localObject5).d(bool2);
                }
              }
              else
              {
                if (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_topic_reddot_update_num.has()) {
                  owy.a().f(((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_topic_reddot_update_num.get());
                }
                if ((((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_refresh_topic_update_info.has()) && (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_refresh_topic_update_info.get() == 1))
                {
                  ...
                  localObject5 = qnm.a((articlesummary.TopicRecommendFeedsInfo)((oidb_cmd0x68b.RspGetFollowTabData)localObject6).topic_update_info.get());
                  owy.a().a((qnm)localObject5);
                  owy.a().p();
                }
                ...
                if ((paramRspBody.bytes_new_style_params.has()) && (paramRspBody.bytes_new_style_params.get() != null))
                {
                  ...
                  if (localObject5 != null) {
                    sgc.a((String)localObject5, (String)localObject6);
                  }
                }
              ...
              for (bool1 = true;; bool1 = false)
              {
                ...
                localObject2 = puy.a(((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_article_list.get(), ((Integer)localObject5).intValue(), k, i);
                if (orf.a()) {
                  orf.a().a(((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_article_list.get(), (List)localObject2, ((Integer)localObject5).intValue());
                }
                ...
                while (((Iterator)localObject3).hasNext())
                {
                  ...
                  if ((((ArticleInfo)localObject6).mSocialFeedInfo != null) && (((ArticleInfo)localObject6).mSocialFeedInfo.jdField_a_of_type_Qna != null)) {
                    QLog.d("ArticleInfoModule", 2, "0x68b rspChannelArticle article articleID = " + ((ArticleInfo)localObject6).mArticleID + " mRecommendSeq = " + ((ArticleInfo)localObject6).mRecommendSeq + " ChannelID = " + ((ArticleInfo)localObject6).mChannelID + " wendainfo = " + ((ArticleInfo)localObject6).mSocialFeedInfo.jdField_a_of_type_Qna.toString() + " followStatus = " + ((ArticleInfo)localObject6).mSocialFeedInfo.jdField_h_of_type_Int);
                  }
                }
                bool2 = false;
                break;
              ...
              for (;;)
              {
                try
                {
                  ...
                  nrt.a(null, "0X8009650", "0X8009650", "", 0, 0, "", "", "", ((JSONObject)localObject6).toString(), false);
                  label1561:
                  ...
                  localObject3 = puy.a(((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_deleted_article_list.get(), ((Integer)localObject5).intValue(), k, i);
                  label1605:
                  ...
                  localObject1 = (oxd)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(163);
                  if (localObject1 != null) {
                    ((oxd)localObject1).a().a(paramToServiceMsg, (oidb_cmd0x68b.RspChannelArticle)localObject7);
                  }
                  ...
                  {
                    localObject8 = new qkb();
                    ((qkb)localObject8).jdField_b_of_type_JavaUtilList = ((List)localObject2);
                    ((qkb)localObject8).jdField_a_of_type_JavaUtilList = ((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_back_off_group_info.get();
                    qjv.a().a(localObject8, qjv.jdField_a_of_type_Int);
                  }
              ...
              if (paramRspBody.msg_rsp_trace.has()) {
                ors.a(ors.a(), paramRspBody.msg_rsp_trace.rpt_trace_record_list.get());
              }
              bool3 = true;
              bool2 = bool1;
              bool1 = bool3;
      ...
      for (;;)
      {
        if (piy.a(paramToServiceMsg))
        {
          ...
          localObject5 = new pit();
          paramToServiceMsg = ((pit)localObject5).a(paramToServiceMsg).a(((Integer)localObject2).intValue()).b(paramInt).a((List)localObject1).b(paramRspBody).a(bool1).b(bool2).a(localJSONException);
          if (!TextUtils.isEmpty((CharSequence)localObject6)) {}
          for (;;)
          {
            paramToServiceMsg.a((String)localObject6);
            piu.a().a((pit)localObject5);
            return;
            localObject6 = "";
          }
        }
        ...
        for (paramInt = 1;; paramInt = 0)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              paramRspBody.put("zhitiao_num_daily", pid.a(BaseApplicationImpl.getApplication(), BaseApplicationImpl.getApplication().getRuntime().getAccount()));
            }
            ...
            nrt.a(null, "", "0X800A6EC", "0X800A6EC", 0, 1, "", "", "", paramRspBody.toString(), false);
            return;
            i = 0;
            continue;
            i = 2;
  ...
  private void a(ArrayList<ArticleInfo> paramArrayList, qks paramqks)
  {
    paramqks = paramqks.jdField_a_of_type_JavaUtilArrayList;
    ...
    for (;;)
    {
      ...
      Iterator localIterator = paramqks.iterator();
      if (localIterator.hasNext())
      {
        qkt localqkt = (qkt)localIterator.next();
        if (localArticleInfo.mFeedId != localqkt.jdField_a_of_type_Long) {
          break;
        }
        localArticleInfo.mRecommendSeq = localqkt.jdField_c_of_type_Long;
        localArticleInfo.mFeedType = localqkt.jdField_a_of_type_Int;
        localArticleInfo.mAlgorithmID = localqkt.jdField_b_of_type_Long;
        localArticleInfo.mStrategyId = localqkt.jdField_b_of_type_Int;
      }
    }
  }
  ...
  private void a(List<ArticleInfo> paramList, int paramInt)
  {
    ...
    //   35: astore_3
    //   36: aload_3
    //   37: getfield 1699	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lqks;
    //   40: ifnull -23 -> 17
    //   43: aload_3
    //   44: getfield 1699	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lqks;
    //   47: getfield 1669	qks:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   50: ifnull -33 -> 17
    //   53: aload_3
    //   54: getfield 1699	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lqks;
    //   57: getfield 1669	qks:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   60: invokevirtual 992	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   63: astore_3
    //   64: aload_3
    //   65: invokeinterface 496 1 0
    //   70: ifeq -53 -> 17
    //   73: aload_3
    //   74: invokeinterface 500 1 0
    ...
    //   138: astore_1
    //   139: aload_1
    //   140: invokevirtual 1707	java/lang/Exception:printStackTrace	()V
    //   143: ldc 106
    //   145: iconst_2
    ...
    //   159: aload_1
    //   160: invokevirtual 1712	java/lang/Exception:getMessage	()Ljava/lang/String;
  ...
  private void a(List<Long> paramList, oidb_cmd0x68b.RspBody paramRspBody, long paramLong)
  {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        nrt.a(null, "", "0X8009483", "0X8009483", 0, 0, paramRspBody.toString(), "", "", "", false);
        return;
      }
  ...
  private void a(oidb_cmd0x68b.ReqBody paramReqBody, ToServiceMsg paramToServiceMsg, long paramLong)
  {
    ...
    paramToServiceMsg.getAttributes().put("compressFlag", Boolean.valueOf(ork.b(paramLong)));
  }
  ...
  private void a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<ArticleInfo> paramList, long paramLong1, long paramLong2)
  {
    ...
    if (this.jdField_a_of_type_Pez != null) {
      localList1 = this.jdField_a_of_type_Pez.a(paramInt, localList2, paramList);
    }
    ...
    for (;;)
    {
      ...
      if (paramInt == 0) {
        szp.a(paramList, localList1, false);
      }
      for (;;)
      {
        oxb.a().b(true, paramInt, localList1, paramBoolean1);
        return;
        paramBoolean1 = false;
        break;
        paramBoolean1 = false;
        break label134;
        if (otf.c(paramInt)) {
          opt.a(paramList, localList1, false);
        }
      }
    }
  }
  ...
  private void a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<ArticleInfo> paramList1, long paramLong1, long paramLong2, List<ArticleInfo> paramList2, ToServiceMsg paramToServiceMsg)
  {
    ...
    for (boolean bool = ((Boolean)localObject).booleanValue();; bool = false)
    {
      if (paramInt == 0)
      {
        szp.a(paramList1, paramList2, bool);
        szp.a(paramList1);
        localObject = (List)paramToServiceMsg.getAttributes().get("SubscriptionArticles");
        if ((localObject != null) && (((List)localObject).size() > 0)) {
          oxb.a().a(paramBoolean1, (List)localObject, paramList1);
        }
        oxb.a().a(paramBoolean1, paramInt, paramList2, paramBoolean2);
        pvi.a().a(paramInt, paramList2, paramBoolean1, paramBoolean2, paramToServiceMsg);
        if (paramBoolean1) {
          if (paramList1 == null) {
            break label554;
          }
      ...
      for (int i = paramList1.size();; i = 0)
      {
        ...
        opt.a(paramList1, paramList2, bool);
        break label296;
      }
    }
  }
      ...
      for (;;)
      {
        if (localConcurrentHashMap2.get(paramArticleInfo.mVideoVid) != null)
        {
          ...
          if (localArticleInfo.mArticleID != paramArticleInfo.mArticleID)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.e("ArticleInfoModule", 2, "saveArticleInfo, find article vid duplicated! old article: channelID=" + paramInteger + ", id=" + localArticleInfo.mArticleID + "，seq: " + localArticleInfo.mRecommendSeq + ", title: " + ors.c(localArticleInfo.mTitle) + "，vid =" + localArticleInfo.mVideoVid + "\n new article  id : " + paramArticleInfo.mArticleID + " seq : " + paramArticleInfo.mRecommendSeq + " title : " + ors.c(paramArticleInfo.mTitle) + "，vid =" + paramArticleInfo.mVideoVid);
            }
          }
        }
  ...
  private boolean a(pve parampve, long paramLong)
  {
    if ((piy.a(parampve)) && (!piy.b(parampve)))
    {
      parampve = piu.a().a(parampve);
      if (parampve != null)
      {
  ...
  private List<Long> b(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Pgg.a(Integer.valueOf(paramInt1), localArrayList);
    return localArrayList;
  }
  ...
  private void b(List<ArticleInfo> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((((ArticleInfo)localObject).mSocialFeedInfo != null) && (((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qmr != null) && (((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qmr.jdField_a_of_type_JavaUtilArrayList != null) && (((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qmr.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          localObject = ((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qmr.jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject).hasNext())
          {
            qmt localqmt = ((qms)((Iterator)localObject).next()).jdField_a_of_type_Qmt;
            if ((localqmt != null) && (!TextUtils.isEmpty(localqmt.jdField_e_of_type_JavaLangString)))
            {
              osl localosl = osf.a(localqmt.jdField_e_of_type_JavaLangString);
              if ((localosl == null) || (!localosl.a(System.currentTimeMillis() / 1000L, 3600L))) {
                localArrayList.add(localqmt.jdField_e_of_type_JavaLangString);
              }
            }
          }
        }
    ...
    if (localArrayList.size() > 0) {
      pcs.a().a((String[])localArrayList.toArray(new String[localArrayList.size()]), null);
    }
  }
  
  private void b(ohu paramohu)
  {
    if (paramohu == null) {
    ...
    do
    {
      ...
      {
        return;
        if (paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null)
        {
          QLog.d("ArticleInfoModule", 2, "transformNormalToNewBiuCard | originArticleInfo is null!");
          return;
        }
        long l1 = paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mFeedId;
        long l2 = paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mFeedType;
        localArticleInfo = paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo;
        localArticleInfo.mCardJumpUrl = paramohu.jdField_d_of_type_JavaLangString;
        localArticleInfo.commentBtnJumpUrl = paramohu.jdField_c_of_type_JavaLangString;
        localArticleInfo.isCardJumpUrlAvailable = paramohu.jdField_b_of_type_Int;
        ...
        if (localObject1 != null)
        {
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qme.jdField_a_of_type_Int = ((SocializeFeedsInfo)localObject1).jdField_a_of_type_Qme.jdField_a_of_type_Int;
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmr = ((SocializeFeedsInfo)localObject1).jdField_a_of_type_Qmr;
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw = ((SocializeFeedsInfo)localObject1).jdField_a_of_type_Qmw;
        }
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qme.jdField_a_of_type_Long = ors.a();
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmc = new qmc();
        localArticleInfo.mFeedId = paramohu.jdField_a_of_type_Long;
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Long = paramohu.jdField_a_of_type_Long;
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmc.jdField_b_of_type_JavaLangLong = Long.valueOf(l2);
        ...
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmc.jdField_a_of_type_JavaUtilList.add(localObject1);
        localArticleInfo.articleViewModel = slx.a(localArticleInfo);
      ...
      paramohu = (ConcurrentHashMap)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(0));
      localObject1 = new ArrayList();
    } while (paramohu == null);
    if (paramohu.containsKey(Long.valueOf(localArticleInfo.mRecommendSeq)))
    {
      paramohu.put(Long.valueOf(localArticleInfo.mRecommendSeq), localArticleInfo);
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(Integer.valueOf(0), paramohu);
    }
    for (int i = 1;; i = 0)
    {
      localObject2 = paramohu.values().iterator();
      while (((Iterator)localObject2).hasNext()) {
      ...
      oxb.a().b(0, (List)localObject1);
      QLog.d("ArticleInfoModule", 2, "transformNormalToNewBiuCard | update DB , cached biuCardArticleInfo: " + paramohu.get(Long.valueOf(localArticleInfo.mRecommendSeq)));
      return;
    }
  }
  ...
  private void c(int paramInt, List<qkr> paramList)
  {
  ...
  private static void c(List<ArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      if (paramList.hasNext())
      {
        ...
        else
        {
          ...
          pgg.a(localArticleInfo2);
          if (opy.a(rqj.c(localArticleInfo2)))
          {
    ...
    for (;;)
    {
      localArticleInfo1.articleViewModel = slx.a(localArticleInfo1);
      break label12;
      break;
      label110:
      opy.a(localArticleInfo2);
    }
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    int j = 5;
    boolean bool = true;
    int k = pvb.a(paramFromServiceMsg, paramObject, new oidb_cmd0xb83.RspBody());
    int i;
    ...
    {
      if (i == 4) {
        szp.a(k, paramToServiceMsg, 1, null);
      }
      if (i == 0) {
        szp.a(k, paramToServiceMsg, 3, null);
      }
      paramFromServiceMsg = ors.a();
      if (k == 0) {}
      for (;;)
      {
        ors.a(paramFromServiceMsg, bool, System.currentTimeMillis() - paramToServiceMsg.extraData.getLong("sendtimekey"), k, i);
        return;
  ...
  private void d(List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      {
        ArticleInfo localArticleInfo = (ArticleInfo)localIterator.next();
        if ((localArticleInfo != null) && (!oui.a(localArticleInfo))) {
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int i = pvb.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject1);
    if (i == 0)
    {
      if (((oidb_cmd0xbbd.RspBody)localObject1).msg_rsp_feeds_data.rpt_feeds_info_list.has())
      {
        ...
        while (paramObject.hasNext())
        {
          ...
          {
            localObject2 = puy.a((articlesummary.ArticleSummary)((oidb_cmd0xbbd.RspFeedsInfo)localObject1).msg_article_summary.get(), 70, 0, null);
  ...
  private void f(int paramInt)
  {
    if (this.jdField_a_of_type_Pfa != null) {
      this.jdField_a_of_type_Pfa.a(paramInt);
    }
  }
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool = ((Boolean)localObject).booleanValue();; bool = false)
    {
      ...
      int i = ork.a(paramToServiceMsg, paramFromServiceMsg, paramObject, localRspBody, bool);
      ...
      try
      {
        ...
        nrt.a(null, "", "0X8009483", "0X8009483", 0, 0, paramFromServiceMsg.toString(), "", "", "", false);
        srs.a().b(paramToServiceMsg);
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = puy.c(paramToServiceMsg.rpt_result_list.get());; paramToServiceMsg = null)
    {
  ...
  private void q(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if ((localRspBody.rpt_social_feeds_info.has()) && (localRspBody.rpt_social_feeds_info.get() != null))
      {
        ...
        this.jdField_a_of_type_JavaUtilConcurrentExecutorService.execute(new ArticleInfoModule.39(this, paramToServiceMsg, paramFromServiceMsg, bool));
      }
      if ((localRspBody.rpt_del_feeds_info_list.has()) && (localRspBody.rpt_del_feeds_info_list.get() != null))
      {
        ...
        this.jdField_a_of_type_JavaUtilConcurrentExecutorService.execute(new ArticleInfoModule.40(this, paramToServiceMsg, paramFromServiceMsg));
      }
      return;
    }
  ...
  private void r(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (pvb.a(paramFromServiceMsg, paramObject, localRspBody) == 0)
    {
  ...
  private void s(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = localRspBody.rpt_insert_module_info.get();; paramToServiceMsg = null)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ArticleInfoModule.49(this, paramObject, paramToServiceMsg, paramFromServiceMsg));
  ...
  {
    int i = pvb.a(paramFromServiceMsg, paramObject, new oidb_cmd0xbd4.RspBody());
  ...
  private void v(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramObject = puy.d(paramToServiceMsg.msg_rsp_search_tag_info.rpt_msg_tag_info_list.get());
      paramToServiceMsg = puy.d(paramToServiceMsg.msg_rsp_recommend_tag_info.rpt_msg_tag_info_list.get());
  ...
  private void w(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramFromServiceMsg.addAll(puy.e(paramToServiceMsg.msg_rsp_search_tag_info.rpt_msg_tag_info_list.get()));
    }
    for (;;)
    {
    ...
    for (;;)
    {
      ...
      if (localArticleInfo != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          } while ((((ArticleInfo)localObject1).mFeedId != paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Long) || (((ArticleInfo)localObject1).mFeedType != paramArticleInfo.mFeedType));
  ...
  {
    if (ors.c(paramInteger.intValue()))
    {
      paramInteger = null;
      return paramInteger;
    }
  ...
  public List<Long> a(Integer paramInteger)
  {
    ...
    this.jdField_a_of_type_Pgg.a(paramInteger, localArrayList);
    return localArrayList;
  }
    ...
    for (;;)
    {
      for (;;)
      {
        if ((((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
          ((qno)((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
        }
        int k;
        Object localObject2;
        ...
        try
        {
          ...
          if (localObject1 != null)
          {
            if ((((ArticleInfo)localObject1).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList != null) && (((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
              ((qno)((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
            }
  ...
  public void a(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    {
      pxc.a().a(paramInt1, localList);
      if ((Looper.myLooper() == Looper.getMainLooper()) && (ors.l()))
      {
        oxb.a().a(paramInt1, localList);
        return;
      }
  ...
  public void a(int paramInt1, int paramInt2, long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      if ((Looper.myLooper() == Looper.getMainLooper()) && (ors.l()))
      {
        pvi.a().a(paramInt1, localList, paramLong2);
        return;
      }
      if (this.jdField_a_of_type_AndroidOsHandler != null)
      {
  ...
  public void a(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if (j < paramInt2)
    {
      Collections.sort((List)localObject1, new pex(this));
      int i = 0;
      for (;;)
      {
        if (i >= paramInt2 - j) {
  ...
  public void a(int paramInt, List<ArticleInfo> paramList)
  {
        ...
        if (localIterator2.hasNext())
        {
          ...
          if (((ArticleInfo)localEntry.getValue()).mNewPolymericInfo != null)
          {
            ...
            do
            {
              ...
              localqlk = (qlk)localIterator3.next();
            } while (localqlk.jdField_a_of_type_Long != localArticleInfo.mArticleID);
            paramList = (ArticleInfo)localEntry.getValue();
            paramList.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.remove(localqlk);
          }
          else
          {
            label306:
    ...
    for (;;)
    {
      ...
      if ((paramList.mNewPolymericInfo != null) && (((ors.m(paramList)) && (paramList.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() >= 3)) || ((!ors.m(paramList)) && (paramList.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() >= 2))))
      {
  ...
  public void a(long paramLong)
  {
    ...
    a(pvb.a("OidbSvc.0xb83", 2947, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    a(pvb.a("OidbSvc.0x75e", 1886, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    a(pvb.a("OidbSvc.0xc32", 3122, 2, localReqBody.toByteArray()));
  }
  ...
  {
    oidb_cmd0x68b.ReqBody localReqBody = new oidb_cmd0x68b.ReqBody();
    long l1 = Long.valueOf(ors.a()).longValue();
    ...
    paramHashMap = pvb.a("OidbSvc.0x68b", 1675, 0, localReqBody.toByteArray());
    ...
    ork.a(paramHashMap, l2);
    a(paramHashMap);
    jdField_c_of_type_Boolean = true;
    srs.a().a(paramHashMap);
  }
  ...
  public void a(long paramLong1, long paramLong2, qmc paramqmc, long paramLong3, String paramString1, long paramLong4, long paramLong5, int paramInt1, String paramString2, int paramInt2, ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
    ...
    Object localObject3;
    if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmv != null))
    {
      localObject2 = new feeds_info.ShareWebPageInfo();
      localObject3 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmv;
      if (!TextUtils.isEmpty(((qmv)localObject3).jdField_d_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_source.set(ByteStringMicro.copyFromUtf8(((qmv)localObject3).jdField_d_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(((qmv)localObject3).jdField_b_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(((qmv)localObject3).jdField_b_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(((qmv)localObject3).jdField_c_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qmv)localObject3).jdField_c_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(((qmv)localObject3).jdField_a_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_web_url.set(ByteStringMicro.copyFromUtf8(((qmv)localObject3).jdField_a_of_type_JavaLangString));
      }
      localSocializeFeedsInfo.share_web_page_info.set((MessageMicro)localObject2);
    }
    if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qml != null)) {
      localSocializeFeedsInfo.now_live_info.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qml.a());
    }
    localObject2 = new feeds_info.BiuMultiLevel();
    if (paramqmc.jdField_a_of_type_JavaLangLong != null) {
      ((feeds_info.BiuMultiLevel)localObject2).uint64_origin_feeds_id.set(paramqmc.jdField_a_of_type_JavaLangLong.longValue());
    }
    if (paramqmc.jdField_b_of_type_JavaLangLong != null) {
      ((feeds_info.BiuMultiLevel)localObject2).uint64_origin_feeds_type.set(paramqmc.jdField_b_of_type_JavaLangLong.longValue());
    }
    if (QLog.isColorLevel()) {
      QLog.d("ArticleInfoModule", 1, "request0x83eDeliver feedID=" + paramLong2 + ", feeds_type=" + paramInt2 + ", articleId=" + paramLong4 + ", masterUin=" + paramLong3 + ", comment=" + paramString1 + ",mOriFeedId=" + paramqmc.jdField_a_of_type_JavaLangLong + ",mOriFeedType" + paramqmc.jdField_b_of_type_JavaLangLong + ",bussinessId = " + paramArticleInfo.businessId);
    }
    paramqmc = paramqmc.jdField_a_of_type_JavaUtilList.iterator();
    while (paramqmc.hasNext())
    {
      paramString1 = (SocializeFeedsInfo.BiuCommentInfo)paramqmc.next();
    ...
    {
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw != null) && (rqj.b(paramArticleInfo)))
      {
        paramString1 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmw;
        paramqmc = new feeds_info.UGCFeedsInfo();
        if (!TextUtils.isEmpty(paramString1.jdField_a_of_type_JavaLangString)) {
          paramqmc.bytes_ugc_comments.set(ByteStringMicro.copyFromUtf8(paramString1.jdField_a_of_type_JavaLangString));
        }
        paramqmc.enum_ugc_feeds_card_type.set(paramString1.jdField_a_of_type_Int);
        paramqmc.uint64_cuin.set(paramString1.jdField_a_of_type_Long);
        localObject1 = paramString1.jdField_a_of_type_JavaUtilArrayList.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (qmx)((Iterator)localObject1).next();
          localObject3 = new feeds_info.UGCPicInfo();
          ((feeds_info.UGCPicInfo)localObject3).is_animation.set(((qmx)localObject2).jdField_c_of_type_Int);
          ((feeds_info.UGCPicInfo)localObject3).uint32_pic_height.set(((qmx)localObject2).jdField_b_of_type_Int);
          ((feeds_info.UGCPicInfo)localObject3).uint32_pic_width.set(((qmx)localObject2).jdField_a_of_type_Int);
          if (!TextUtils.isEmpty(((qmx)localObject2).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.UGCPicInfo)localObject3).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qmx)localObject2).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmx)localObject2).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.UGCPicInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qmx)localObject2).jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmx)localObject2).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.UGCPicInfo)localObject3).bytes_thumbnail_url.set(ByteStringMicro.copyFromUtf8(((qmx)localObject2).jdField_c_of_type_JavaLangString));
          }
          paramqmc.msg_ugc_pic_info_list.add((MessageMicro)localObject3);
        }
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          paramqmc.msg_ugc_voice_info_list.add((MessageMicro)localObject3);
        }
        paramString1 = paramString1.b.iterator();
        while (paramString1.hasNext())
        {
          localObject1 = (qmy)paramString1.next();
          localObject2 = new feeds_info.UGCVideoInfo();
          ((feeds_info.UGCVideoInfo)localObject2).uint32_pic_height.set(((qmy)localObject1).jdField_d_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_pic_width.set(((qmy)localObject1).jdField_c_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_video_height.set(((qmy)localObject1).jdField_b_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_video_width.set(((qmy)localObject1).jdField_a_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint64_duration.set(((qmy)localObject1).jdField_a_of_type_Long);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_create_time.set(((qmy)localObject1).jdField_e_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_busi_type.set(((qmy)localObject1).jdField_f_of_type_Int);
          if (!TextUtils.isEmpty(((qmy)localObject1).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).jdField_c_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).jdField_d_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).jdField_d_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_video_md5.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_video_url.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).jdField_e_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).jdField_e_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).jdField_f_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_uuid.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).jdField_f_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).i)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_vid.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).i));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).h)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_share_url.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).h));
          }
          if (!TextUtils.isEmpty(((qmy)localObject1).g)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_uniq_id.set(ByteStringMicro.copyFromUtf8(((qmy)localObject1).g));
          }
          paramqmc.msg_ugc_video_info_list.add((MessageMicro)localObject2);
        }
        localSocializeFeedsInfo.msg_ugc_topic_feeds_info.set(paramqmc);
      }
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmr != null) && (rqj.a(paramArticleInfo)))
      {
        paramqmc = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qmr;
        paramString1 = new feeds_info.PGCFeedsInfo();
        localObject1 = paramqmc.jdField_a_of_type_JavaUtilArrayList.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (qms)((Iterator)localObject1).next();
          localObject3 = new feeds_info.PGCPicInfo();
          if (!TextUtils.isEmpty(((qms)localObject2).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.PGCPicInfo)localObject3).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qms)localObject2).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qms)localObject2).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.PGCPicInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qms)localObject2).jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qms)localObject2).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.PGCPicInfo)localObject3).bytes_thumbnail_url.set(ByteStringMicro.copyFromUtf8(((qms)localObject2).jdField_c_of_type_JavaLangString));
          }
          ((feeds_info.PGCPicInfo)localObject3).is_animation.set(((qms)localObject2).jdField_c_of_type_Int);
          ((feeds_info.PGCPicInfo)localObject3).uint32_pic_height.set(((qms)localObject2).jdField_b_of_type_Int);
          ((feeds_info.PGCPicInfo)localObject3).uint32_pic_width.set(((qms)localObject2).jdField_a_of_type_Int);
          paramString1.msg_pgc_pic_info_list.add((MessageMicro)localObject3);
        }
        localObject1 = paramqmc.b.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (qmt)((Iterator)localObject1).next();
          localObject3 = new feeds_info.PGCVideoInfo();
          if (!TextUtils.isEmpty(((qmt)localObject2).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qmt)localObject2).jdField_c_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmt)localObject2).jdField_d_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qmt)localObject2).jdField_d_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmt)localObject2).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_video_md5.set(ByteStringMicro.copyFromUtf8(((qmt)localObject2).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qmt)localObject2).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_video_url.set(ByteStringMicro.copyFromUtf8(((qmt)localObject2).jdField_b_of_type_JavaLangString));
          }
          paramString1.msg_pgc_video_info_list.add((MessageMicro)localObject3);
        }
        if (!TextUtils.isEmpty(paramqmc.jdField_a_of_type_JavaLangString)) {
          paramString1.bytes_pgc_comments.set(ByteStringMicro.copyFromUtf8(paramqmc.jdField_a_of_type_JavaLangString));
        }
        localSocializeFeedsInfo.msg_pgc_topic_feeds_info.set(paramString1);
      }
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm != null) && (rqj.c(paramArticleInfo)))
      {
        paramqmc = new feeds_info.TopicRecommendFeedsInfo();
        paramqmc.uint32_feeds_style.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_Int);
        paramqmc.uint64_feeds_id.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_Long);
        paramString1 = new ArrayList();
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_JavaUtilArrayList != null)
        {
          localObject1 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (qno)((Iterator)localObject1).next();
            localObject3 = new feeds_info.TopicRecommendInfo();
            ((feeds_info.TopicRecommendInfo)localObject3).uint32_number_of_participants.set(((qno)localObject2).jdField_b_of_type_Int);
            if (!TextUtils.isEmpty(((qno)localObject2).jdField_a_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_business_name.set(ByteStringMicro.copyFromUtf8(((qno)localObject2).jdField_a_of_type_JavaLangString));
            }
            if (!TextUtils.isEmpty(((qno)localObject2).jdField_c_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_business_name_prefix.set(ByteStringMicro.copyFromUtf8(((qno)localObject2).jdField_c_of_type_JavaLangString));
            }
            if (!TextUtils.isEmpty(((qno)localObject2).jdField_b_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_business_url.set(ByteStringMicro.copyFromUtf8(((qno)localObject2).jdField_b_of_type_JavaLangString));
            }
            if (!TextUtils.isEmpty(((qno)localObject2).jdField_d_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qno)localObject2).jdField_d_of_type_JavaLangString));
            }
            ((feeds_info.TopicRecommendInfo)localObject3).uint32_business_id.set(((qno)localObject2).jdField_a_of_type_Int);
            paramString1.add(localObject3);
          }
        }
        paramqmc.msg_topic_recommend_info.set(paramString1);
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_Qnn != null)
        {
          paramString1 = new feeds_info.TopicRecommendFeedsTitle();
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_Qnn.jdField_b_of_type_JavaLangString)) {
            paramString1.bytes_url.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_Qnn.jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_Qnn.jdField_a_of_type_JavaLangString)) {
            paramString1.bytes_title_content.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_Qnn.jdField_a_of_type_JavaLangString));
          }
          paramqmc.msg_left_title.set(paramString1);
        }
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_Qnn != null)
        {
          paramString1 = new feeds_info.TopicRecommendFeedsTitle();
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_Qnn.jdField_b_of_type_JavaLangString)) {
            paramString1.bytes_url.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_Qnn.jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_Qnn.jdField_a_of_type_JavaLangString)) {
            paramString1.bytes_title_content.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_Qnn.jdField_a_of_type_JavaLangString));
          }
          paramqmc.msg_right_title.set(paramString1);
        }
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_JavaLangString != null) {
          paramqmc.bytes_subscribe_id.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_a_of_type_JavaLangString));
        }
        paramqmc.uint64_uin.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_Long);
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_JavaLangString != null) {
          paramqmc.bytes_comments.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qnm.jdField_b_of_type_JavaLangString));
        }
        localSocializeFeedsInfo.msg_topic_recommend_feeds_info.set(paramqmc);
      }
    }
    if ((ors.b(paramArticleInfo)) || (ors.c(paramArticleInfo)) || (ors.e(paramArticleInfo)) || (ors.f(paramArticleInfo)))
    {
      if ((paramArticleInfo.mTopicRecommendFeedsInfo != null) && (paramArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
        localFeedsInfo.uint32_business_id.set(((qno)paramArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Int);
      }
      ...
      {
        paramqmc = ByteStringMicro.copyFromUtf8(paramString2);
        localReqBody.bytes_inner_uniq_id.set(paramqmc);
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 1, "request0x83eDeliver innerUniqueIDc=" + paramString2);
        }
      }
      localReqBody.msg_feeds_info.set(localFeedsInfo);
      paramqmc = localReqBody.uint32_is_one_touch_biu;
      if (!paramBoolean) {
        break label3090;
      }
    }
    ...
    {
      paramqmc.set(paramInt1);
      paramqmc = String.valueOf(ors.a()) + String.valueOf(System.currentTimeMillis());
      localReqBody.bytes_req_seq.set(ByteStringMicro.copyFromUtf8(paramqmc));
      paramqmc = pvb.a("OidbSvc.0x83e", 2110, 0, localReqBody.toByteArray());
      paramqmc.addAttribute("biu_deliver", Integer.valueOf(1));
      paramqmc.addAttribute("BaseArticleSeq", Long.valueOf(paramLong5));
      b(paramqmc);
      return;
  ...
  public void a(long paramLong1, long paramLong2, qmc paramqmc, String paramString)
  {
    ...
    if (paramqmc.jdField_a_of_type_JavaLangLong != null) {
      localBiuMultiLevel.uint64_origin_feeds_id.set(paramqmc.jdField_a_of_type_JavaLangLong.longValue());
    }
    if (paramqmc.jdField_b_of_type_JavaLangLong != null) {
      localBiuMultiLevel.uint64_origin_feeds_type.set(paramqmc.jdField_b_of_type_JavaLangLong.longValue());
    }
    paramqmc = paramqmc.jdField_a_of_type_JavaUtilList.iterator();
    while (paramqmc.hasNext())
    {
      SocializeFeedsInfo.BiuCommentInfo localBiuCommentInfo = (SocializeFeedsInfo.BiuCommentInfo)paramqmc.next();
    ...
    paramqmc = new feeds_info.BiuOneLevelItem();
    paramqmc.bytes_biu_comments.set(ByteStringMicro.copyFromUtf8(paramString));
    paramqmc.op_type.set(0);
    paramqmc.feeds_type.set(1);
    paramqmc.uint64_feeds_id.set(paramLong2);
    paramqmc.uint64_uin.set(paramLong1);
    localBiuMultiLevel.rpt_biu_mutli_level.add(paramqmc);
    paramqmc = new feeds_info.FeedsInfo();
    paramString = new feeds_info.SocializeFeedsInfo();
    paramString.msg_biu_mutli_level.set(localBiuMultiLevel);
    paramString.msg_biu_mutli_level.set(localBiuMultiLevel);
    paramqmc.msg_social_feeds_info.set(paramString);
    localReqBody.msg_feeds_info.set(paramqmc);
    b(pvb.a("OidbSvc.0xc5b_2", 3163, 2, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean, ArticleInfo paramArticleInfo)
  {
    ...
    for (int i = 2;; i = 3)
    {
      ...
      localObject2 = String.valueOf(ors.a()) + String.valueOf(System.currentTimeMillis());
      ((oidb_cmd0x83e.ReqBody)localObject1).bytes_req_seq.set(ByteStringMicro.copyFromUtf8((String)localObject2));
      localObject1 = pvb.a("OidbSvc.0x83e", 2110, 0, ((oidb_cmd0x83e.ReqBody)localObject1).toByteArray());
  ...
  public void a(long paramLong, String paramString1, int paramInt, String paramString2, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean)
  {
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString1 = pvb.a("OidbSvc.0x83e", 2110, 0, localReqBody.toByteArray());
  ...
  public void a(long paramLong, List<qkq> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      oidb_cmd0x46f.DislikeParam localDislikeParam = a((qkq)paramList.next());
      localReqBody.rpt_param_list.add(localDislikeParam);
    }
    a(pvb.a("OidbSvc.0x46f", 1135, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong, boolean paramBoolean, FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    for (Object localObject = paramFastWebArticleInfo.j;; localObject = "")
    {
      ...
      localObject = pvb.a("OidbSvc.0x83e", 2110, 0, localReqBody.toByteArray());
  ...
  public void a(ArticleInfo paramArticleInfo, String paramString)
  {
    ...
    str = String.valueOf(ors.a()) + String.valueOf(System.currentTimeMillis());
    ...
    localObject1 = pvb.a("OidbSvc.0x83e", 2110, 0, ((oidb_cmd0x83e.ReqBody)localObject3).toByteArray());
  ...
  public void a(TopicInfo paramTopicInfo)
  {
    ...
    a(pvb.a("OidbSvc.0xc16", 3094, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      b(pvb.a("OidbSvc.0xc6d", 3181, 1, localReqBody.toByteArray()));
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean1, boolean paramBoolean2, TroopBarPOI paramTroopBarPOI, VisibleSetParam paramVisibleSetParam)
  {
    ...
    for (;;)
    {
      ...
      localFeedsInfo.msg_social_feeds_info.set(localSocializeFeedsInfo);
      localReqBody.msg_feeds_info.set(localFeedsInfo);
      paramString1 = String.valueOf(ors.a()) + String.valueOf(System.currentTimeMillis());
  ...
  public void a(String paramString1, String paramString2, String paramString3, List<Integer> paramList, String paramString4, String paramString5, String[] paramArrayOfString1, int[] paramArrayOfInt1, int[] paramArrayOfInt2, String[] paramArrayOfString2, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean, int paramInt1, int paramInt2, qlz paramqlz, TroopBarPOI paramTroopBarPOI, VisibleSetParam paramVisibleSetParam, int paramInt3)
  {
    Object localObject;
    if (QLog.isColorLevel())
    {
    ...
    if ((paramInt1 == 21) && (paramqlz != null))
    {
      paramList = new feeds_info.AccountProfile();
      paramList.bytes_desc.set(ByteStringMicro.copyFromUtf8(paramqlz.jdField_c_of_type_JavaLangString));
      paramList.bytes_nick.set(ByteStringMicro.copyFromUtf8(paramqlz.jdField_a_of_type_JavaLangString));
      paramList.bytes_profile_photo_url.set(ByteStringMicro.copyFromUtf8(paramqlz.jdField_b_of_type_JavaLangString));
      paramList.uint64_uin.set(paramqlz.jdField_a_of_type_Long);
      paramList.uint32_account_type.set(paramqlz.jdField_a_of_type_Int);
    ...
    paramString1 = pvb.a("OidbSvc.0x83e", 2110, 0, paramString2.toByteArray());
    paramString1.addAttribute("ugc_deliver", Integer.valueOf(1));
    b(paramString1);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, List<Integer> paramList, String paramString4, String[] paramArrayOfString1, int[] paramArrayOfInt1, int[] paramArrayOfInt2, String[] paramArrayOfString2, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean, int paramInt1, int paramInt2, qlz paramqlz, int paramInt3)
  {
    a(paramString1, paramString2, paramString3, paramList, paramString4, "", paramArrayOfString1, paramArrayOfInt1, paramArrayOfInt2, paramArrayOfString2, paramArrayList, paramBoolean, paramInt1, paramInt2, paramqlz, null, VisibleSetParam.a, paramInt3);
  }
  ...
  public void a(ArrayList<ResultRecord> paramArrayList, int paramInt, long paramLong, String paramString)
  {
    if ((paramInt == 1) && (paramArrayList != null) && (paramString != null))
    {
      ...
      catch (NumberFormatException paramArrayList)
      {
        ...
        a(pvb.a("OidbSvc.0xbd4_1", 3028, 1, localReqBody.toByteArray()));
      }
    }
  }
  ...
  public void a(ohu paramohu)
  {
    ...
    boolean bool = paramohu.jdField_a_of_type_Boolean;
    if ((!paramohu.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilLinkedHashMap != null))
    {
      Object localObject = (ConcurrentHashMap)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(0));
      if (localObject != null)
      {
        if (((ConcurrentHashMap)localObject).containsKey(Long.valueOf(paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mRecommendSeq))) {
          bool = true;
        }
        if (!bool)
        {
          ...
          {
            ArticleInfo localArticleInfo = (ArticleInfo)((Iterator)localObject).next();
            if ((localArticleInfo != null) && ((localArticleInfo.mArticleID == paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mArticleID) || ((!TextUtils.isEmpty(localArticleInfo.innerUniqueID)) && (localArticleInfo.innerUniqueID.equalsIgnoreCase(paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID)))))
            {
              paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo = localArticleInfo;
              bool = true;
            }
          }
        }
    ...
    for (;;)
    {
      if ((paramohu != null) && (paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null))
      {
        paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.invalidateProteusTemplateBean();
        paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.showBreathAnimation = true;
      }
      QLog.d("ArticleInfoModule", 2, "transformNewBiuCard | fromRecommendFeeds:" + bool);
      if (bool) {
        if ((paramohu != null) && (ohs.a(paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo))) {
          b(paramohu);
        }
      }
      for (;;)
      {
        ...
        continue;
        owy.a().a(paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mArticleID, paramohu.jdField_a_of_type_Long, paramohu.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID);
      }
    }
  }
  
  public void a(pez parampez)
  {
    this.jdField_a_of_type_Pez = parampez;
  }
  
  public void a(pfa parampfa)
  {
    this.jdField_a_of_type_Pfa = parampfa;
  }
  
  public void a(pve parampve)
  {
    if (parampve == null) {
    ...
    long l2 = piy.a(parampve);
    jdField_c_of_type_Boolean = true;
    jdField_c_of_type_Int = parampve.jdField_g_of_type_Int;
    this.jdField_a_of_type_JavaUtilConcurrentExecutorService.execute(new ArticleInfoModule.1(this, parampve, l1, l2));
  }
  
  public void a(qks paramqks, ArticleInfo paramArticleInfo)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    Iterator localIterator = paramqks.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      qkt localqkt = (qkt)localIterator.next();
      oidb_cmd0xbbd.ReqFeedsInfo localReqFeedsInfo = new oidb_cmd0xbbd.ReqFeedsInfo();
      localReqFeedsInfo.uint64_feeds_id.set(localqkt.jdField_a_of_type_Long);
      localReqFeedsInfo.uint32_feeds_type.set(localqkt.jdField_a_of_type_Int);
    ...
    localObject = pvb.a("OidbSvc.0xbbd", 3005, 0, ((oidb_cmd0xbbd.ReqBody)localObject).toByteArray());
    ...
    ((ToServiceMsg)localObject).getAttributes().put(jdField_d_of_type_JavaLangString, Long.valueOf(((qkt)paramqks.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Long));
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
        ((qno)((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
      }
      ...
      if (localObject != null)
      {
        if ((((ArticleInfo)localObject).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localObject).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList != null) && (((ArticleInfo)localObject).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
          ((qno)((ArticleInfo)localObject).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
        }
  ...
  public boolean a(Integer paramInteger, List<ArticleInfo> paramList, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Pgg.a(paramInteger, paramList, paramBoolean);
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      else if (((ArticleInfo)localObject2).mNewPolymericInfo != null)
      {
        ...
        if (localObject2 != null)
        {
          ...
          while (((Iterator)localObject2).hasNext()) {
            localArrayList.add(Long.valueOf(((qlk)((Iterator)localObject2).next()).jdField_a_of_type_Long));
          }
        }
      }
      else
  ...
  public void b(int paramInt, List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          return;
        } while ((paramList == null) || (paramList.isEmpty()) || ((paramInt != 0) && (!otf.c(paramInt))));
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int m = pvb.a(paramFromServiceMsg, paramObject, localRspBody);
  ...
  public List<ArticleInfo> c(Integer paramInteger)
  {
    ...
    Collections.sort(localArrayList, new pey(this));
    return localArrayList;
  }
  ...
  public void c(String paramString)
  {
    ...
    a(pvb.a("OidbSvc.0xbde", 3038, 0, localReqBody.toByteArray()));
  }
  ...
  {
    if (!ors.q()) {}
    while ((paramInt != 0) && (!otf.c(paramInt))) {
      return;
    }
