...
public class acop
{
  ...
  public acop(Conversation paramConversation)
  {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Alqf != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a.removeObserver(this.jdField_a_of_type_Alqf);
    }
  }
  ...
  public void a(RecentUser paramRecentUser)
  {
    ...
    if ((localHotChatManager != null) && (localHotChatManager.b(paramRecentUser.uin)))
    {
      ...
      if (localHotChatInfo != null)
      {
        ...
        i = 1;
        azmj.b(localQQAppInterface, "CliOper", "", "", "0X8004D2A", "0X8004D2A", i, 0, "", "", "", "");
      }
    }
    label109:
    label114:
    ...
    for (int i = 1;; i = 2)
    {
      azmj.b(localQQAppInterface, "CliOper", "", "", "0X8004D29", "0X8004D29", i, 0, "", "", "", "");
      if (this.jdField_a_of_type_Alqf == null) {
        this.jdField_a_of_type_Alqf = new acoq(this, localBaseActivity);
      }
      this.jdField_a_of_type_Bdfq = alpw.a(localHotChatManager.a(paramRecentUser.uin), new acor(this, localHotChatInfo, localQQAppInterface, localBaseActivity));
      return;
    }
  }
