  ...
  extends zhc
{
  ...
  private void a(DecodeConfig paramDecodeConfig, batj parambatj, int paramInt)
  {
    if (paramInt != 0)
    {
      parambatj.h = paramInt;
      parambatj.g = 0;
    }
    paramInt = Math.min(parambatj.jdField_a_of_type_Int, parambatj.b);
    int i = Math.max(parambatj.jdField_a_of_type_Int, parambatj.b);
    parambatj.jdField_a_of_type_Int = paramInt;
    parambatj.b = i;
    paramDecodeConfig.width = parambatj.jdField_a_of_type_Int;
    paramDecodeConfig.height = parambatj.b;
  }
  
  private boolean a(zgz paramzgz)
  {
    if (paramzgz.jdField_b_of_type_Boolean) {}
    while (!paramzgz.c) {
      return false;
    }
    return true;
  ...
  public void a(zgz paramzgz)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("VideoToVideo", 2, "[runLocalVideo2Video]run begin, taskid:" + paramzgz.jdField_b_of_type_Long + " run:" + paramzgz.d);
    }
    if (a(paramzgz))
    {
      yqu.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramzgz.jdField_a_of_type_JavaLangString, null, null, paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramzgz);
      return;
    }
    ...
    localObject1 = null;
    Object localObject2 = new File(paramzgz.jdField_a_of_type_JavaLangString);
    ...
    if (zkr.e((String)localObject1))
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "before,getPCMFromFile[Have audio File]:  " + paramzgz.jdField_b_of_type_Long + " audioPath: " + (String)localObject1 + " audioFileSize=" + atwl.a((String)localObject1));
      }
      localObject2 = new zko();
      l1 = System.currentTimeMillis();
      ((zko)localObject2).a(paramzgz.jdField_a_of_type_JavaLangString, paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getMetaDataFromFile:  " + paramzgz.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " mSampleRate: " + paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_Int);
      }
    }
    for (;;)
    {
      ...
      localLocalMediaInfo.path = paramzgz.jdField_a_of_type_JavaLangString;
      localLocalMediaInfo.mDuration = paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long;
      l1 = System.currentTimeMillis();
      bool = ((zko)localObject2).a(localLocalMediaInfo, 0, (int)paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long, (String)localObject1, paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo);
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "run,getPCMFromFile:  " + paramzgz.jdField_b_of_type_Long + " cost=" + (l2 - l1) + " ms audioTrack: " + paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean);
      }
      if (paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean)
      {
        if ((!bool) || (!zkr.e((String)localObject1)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run,getPCMFromFile: failed " + paramzgz.jdField_b_of_type_Long + " path=" + (String)localObject1 + " success=" + bool);
          }
          zkr.g((String)localObject1);
          yqu.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramzgz.jdField_a_of_type_JavaLangString, null, null, paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramzgz);
        }
      }
      else
      {
        zkr.g((String)localObject1);
        zko.a((String)localObject1, (int)paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Long);
        if (!zkr.e((String)localObject1))
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoToVideo", 2, "run[video convert],createSilentPCMFile: failed " + paramzgz.jdField_b_of_type_Long + " path=" + (String)localObject1);
          }
          yqu.a("actVideo2VideoResult", new String[] { "8" });
          a(8, paramzgz.jdField_a_of_type_JavaLangString, null, null, paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramzgz);
          return;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "After,getPCMFromFile: hasAudioTrack= " + paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_a_of_type_Boolean + " path=" + (String)localObject1 + " success=" + bool + " audioFileSize=" + atwl.a((String)localObject1));
      }
    }
    paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    if (a(paramzgz))
    {
      yqu.a("actVideo2VideoResult", new String[] { "9" });
      a(9, paramzgz.jdField_a_of_type_JavaLangString, null, null, paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramzgz);
    ...
    boolean bool = a(paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramzgz);
    ...
    yqu.a("actVideo2VideoTime", new String[] { l3 - l4 + "" });
    if ((bool) && (atwl.a(this.jdField_a_of_type_JavaLangString)))
    {
      l3 = atwl.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, file exist, size:" + l3 + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 0;
      yqu.a("actVideo2VideoResult", new String[] { "0" });
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, taskid:" + paramzgz.jdField_b_of_type_Long + " run:" + paramzgz.d + " cost:" + (l2 - l1) + " ms successVideo:" + bool);
      }
      if (!paramzgz.d) {
        break;
      }
      a(this.jdField_a_of_type_Int, paramzgz.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, null, paramzgz.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideItemInfo, paramzgz);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoToVideo", 2, "runLocalVideo2Video, [failed]file not exist:" + paramzgz.jdField_b_of_type_Long + " file:" + this.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Int = 7;
      yqu.a("actVideo2VideoResult", new String[] { "7" });
      zkr.g(this.jdField_a_of_type_JavaLangString);
    }
  }
  
  /* Error */
  public boolean a(SlideItemInfo arg1, zgz paramzgz)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +10 -> 11
    ...
    //   33: new 291	bqen
    //   36: dup
    //   37: invokespecial 292	bqen:<init>	()V
    //   40: putfield 294	zhg:jdField_a_of_type_Bqen	Lbqen;
    ...
    //   165: invokevirtual 325	zhg:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)I
    //   168: istore 5
    //   170: new 22	batj
    //   173: dup
    //   174: aload 13
    ...
    //   194: invokespecial 333	batj:<init>	(Ljava/lang/String;IIIIZI)V
    //   197: astore 14
    //   199: aload 14
    //   201: sipush 720
    //   204: putfield 31	batj:jdField_a_of_type_Int	I
    //   207: aload 14
    //   209: sipush 1280
    //   212: putfield 34	batj:b	I
    //   215: aload_1
    ...
    //   292: sipush 720
    //   295: sipush 1280
    //   298: invokestatic 339	zmg:a	(IIII)Z
    //   301: ifeq +9 -> 310
    //   304: aload 14
    //   306: iconst_1
    //   307: putfield 340	batj:c	Z
    ...
    //   340: aload 14
    //   342: iload 5
    //   344: invokespecial 345	zhg:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lbatj;I)V
    //   347: aload 15
    //   349: iconst_1
    ...
    //   372: invokevirtual 64	zhg:a	(Lcom/tencent/mobileqq/activity/photo/LocalMediaInfo;)Z
    ...
    //   488: aload_0
    //   489: getfield 294	zhg:jdField_a_of_type_Bqen	Lbqen;
    //   492: aload 15
    //   494: aload 14
    //   496: new 370	zhh
    //   499: dup
    //   500: aload_0
    //   501: aload_2
    //   502: invokespecial 373	zhh:<init>	(Lzhg;Lzgz;)V
    //   505: aconst_null
    //   506: invokevirtual 376	bqen:a	(Lcom/tencent/mobileqq/richmedia/mediacodec/videodecoder/DecodeConfig;Lbatj;Lbatv;Lbqeo;)V
    //   509: aload_0
    //   510: getfield 17	zhg:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   513: astore_1
    //   514: aload_1
    //   515: monitorenter
    ...
    //   538: aload_2
    //   539: getfield 57	zgz:jdField_b_of_type_Boolean	Z
    ...
    //   564: aload_2
    //   565: getfield 383	zgz:jdField_a_of_type_Boolean	Z
    ...
    //   577: aload_2
    //   578: getfield 57	zgz:jdField_b_of_type_Boolean	Z
    //   581: ifne +84 -> 665
    //   584: aload_2
    //   585: getfield 60	zgz:c	Z
    //   588: ifne +77 -> 665
    //   591: aload_2
    //   592: getfield 383	zgz:jdField_a_of_type_Boolean	Z
    //   595: istore 6
    //   597: iload 6
    //   599: ifne +66 -> 665
    //   602: aload_0
    //   603: getfield 17	zhg:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    ...
    //   667: aload_0
    //   668: aload_2
    //   669: invokespecial 391	zhg:a	(Lzgz;)Z
    //   672: istore 7
    //   674: iload 7
    //   676: istore 6
  ...
  public void b(zgz paramzgz)
  {
    ...
    {
      paramzgz.jdField_b_of_type_Boolean = true;
