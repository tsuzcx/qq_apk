  ...
  implements ahqq
{
  ...
  public ahpb(ahqs paramahqs, Context paramContext)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558587, null);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362500));
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new ahpc(this));
    }
  ...
  public void a(Drawable paramDrawable)
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ImageView localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362498);
