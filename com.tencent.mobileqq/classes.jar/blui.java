...
{
  public blui(IliveLaunchFragment paramIliveLaunchFragment, long paramLong) {}
  
  public void onLoad(boolean paramBoolean)
  {
    QLog.e("IliveLaunchActivity", 1, "initVideoSDK loadSo = " + paramBoolean);
    blvl.b("IliveLaunch initVideoSDK");
    if (paramBoolean)
    {
      blvl.a("IliveLaunch initSDKAsync");
      bapt.a(BaseApplicationImpl.getApplication(), new bluj(this));
      return;
    }
