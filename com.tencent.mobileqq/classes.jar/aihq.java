...
public class aihq
{
  ...
  {
    if (100 == paramInt) {
      return new File(aiys.jdField_b_of_type_JavaLangString + paramInt + "_" + paramLong + "_" + paramString1 + File.separator + paramString2).exists();
    }
    return false;
  }
  ...
  public String b()
  {
    if (100 == this.jdField_a_of_type_Int) {
      return aiys.jdField_b_of_type_JavaLangString + a() + File.separator;
    }
    return "";
  }
