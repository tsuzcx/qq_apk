  ...
  implements bhqd
{
  ...
  public zcg(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.tencent.map", alpo.a(2131710829));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.google.android.apps.maps", "Google地图");
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.autonavi.minimap", alpo.a(2131710827));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.baidu.BaiduMap", alpo.a(2131710828));
  ...
  public static String a(double paramDouble)
  {
    if (paramDouble < 1000.0D) {
      return String.format(alpo.a(2131710835), new Object[] { Double.valueOf(paramDouble) });
    }
    return String.format(alpo.a(2131710834), new Object[] { Double.valueOf(paramDouble / 1000.0D) });
  }
  ...
  {
    azmj.b(null, "dc00899", "Pb_account_lifeservice", "", "rec_locate_android", paramString1, 0, 0, paramString2, paramString3, "", "");
    if (QLog.isColorLevel()) {
  ...
  {
    azmj.b(null, "P_CliOper", "Pb_account_lifeservice", "", "rec_locate", paramString1, 0, 0, paramString2, "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (this.jdField_a_of_type_Zci != null) {
        if (!this.jdField_a_of_type_Zci.b())
        {
  ...
  protected void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (bhpe.a(this.jdField_a_of_type_AndroidContentContext, str)) {
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2)
  {
    if (!bdee.g(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, paramGeoPoint1.getString(2131694766), 1).b(paramGeoPoint1.getDimensionPixelSize(2131298914));
      return;
    }
    ...
    for (;;)
    {
      ...
      new bcgn(str, "GET", new zch(this), 1000, localBundle2, true).execute(new HashMap[] { paramGeoPoint1 });
      return;
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 0, alpo.a(2131710832), 1).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298914));
      return;
    }
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = alpo.a(2131710830);
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = alpo.a(2131710826);
    }
    ...
    if (d > 1000.0D)
    {
      ...
      if ((this.jdField_a_of_type_Zci == null) || (this.jdField_a_of_type_Zci.b())) {
        break label469;
      }
      this.jdField_a_of_type_Bhpy.c(alpo.a(2131710833));
      label295:
      this.jdField_a_of_type_ArrayOfInt[0] = 0;
      this.jdField_a_of_type_Bhpy.c(alpo.a(2131710831));
      this.jdField_a_of_type_ArrayOfInt[1] = 1;
      this.jdField_a_of_type_Bhpy.c((CharSequence)this.jdField_a_of_type_JavaUtilLinkedHashMap.get("com.tencent.map"));
      ...
      this.jdField_a_of_type_Bhpy.c(paramString1);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 0;
      break;
      this.jdField_a_of_type_Bhpy.c(alpo.a(2131710825));
      break label295;
  ...
  public void a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Zci != null) {
        this.jdField_a_of_type_Zci.a(paramJSONObject, paramInt);
      }
      return;
      if (paramInt == 1)
      {
  ...
  public void a(zci paramzci)
  {
    this.jdField_a_of_type_Zci = paramzci;
  }
