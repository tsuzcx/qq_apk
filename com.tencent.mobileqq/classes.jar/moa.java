...
public class moa
  implements Runnable
{
  public moa(FastWebVideoFeedsPlayManager paramFastWebVideoFeedsPlayManager, boolean paramBoolean, FastWebVideoFeedsPlayManager.VideoPlayParam paramVideoPlayParam) {}
  ...
  public void run()
  {
    ...
    return;
    label128:
    FastWebVideoFeedsPlayManager.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebVideoFastWebVideoFeedsPlayManager).post(new mob(this, localVideoPlayerWrapper));
  }
}
