...
public class aqgx
  extends aqbc
{
  public aqgx(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  {
    int i = bawz.a(this.jdField_a_of_type_AndroidAppActivity, 164.0F);
    int j = bawz.a(this.jdField_a_of_type_AndroidAppActivity, 265.0F);
    ...
    int m = bawz.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F);
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      ...
      ((LinearLayout.LayoutParams)localObject5).topMargin = bawz.a(this.jdField_a_of_type_AndroidAppActivity, 5.0F);
    ...
    parambbgg = this.jdField_a_of_type_AndroidOsBundle.getString("key_thumb_url");
    try
    {
      ...
      parambbgg = URLDrawable.getDrawable(parambbgg, (URLDrawable.URLDrawableOptions)localObject2);
      if (parambbgg.getStatus() == 2) {
        parambbgg.restartDownload();
      }
      localURLImageView.setImageDrawable(parambbgg);
    }
    catch (Exception parambbgg)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.w("Q.qqstory.troopstory.share", 2, "addStructView:", parambbgg);
        }
      }
    }
    return true;
