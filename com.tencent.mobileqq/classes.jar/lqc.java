...
public class lqc
  implements lqb
{
  private static final lqe jdField_a_of_type_Lqe = new lqd();
  ...
  private lsc jdField_a_of_type_Lsc = new lsc();
  ...
  private final lsc jdField_b_of_type_Lsc = new lsc();
  private float jdField_c_of_type_Float;
  private volatile int jdField_c_of_type_Int;
  private final lsc jdField_c_of_type_Lsc = new lsc();
  ...
  {
    jdField_a_of_type_Lqe.a(1, this.jdField_a_of_type_ArrayOfInt, 0);
    lsd.a();
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, lqf paramlqf)
  {
    a(paramInt1, paramInt2, paramInt3, paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramlqf.a(), paramlqf.a());
  }
  ...
  private static void a(RectF paramRectF, lre paramlre)
  {
    int j = paramlre.e();
    int k = paramlre.f();
    paramRectF.left /= j;
  ...
  private void a(lre paramlre, RectF paramRectF1, RectF paramRectF2)
  {
    a(paramRectF1);
    a(paramlre, this.jdField_i_of_type_ArrayOfFloat, paramRectF2);
  }
  
  private void a(lre paramlre, float[] paramArrayOfFloat, RectF paramRectF)
  {
    lrc[] arrayOflrc = paramlre.a(this);
    a(arrayOflrc, 0);
    GLES20.glUniformMatrix4fv(arrayOflrc[3].jdField_a_of_type_Int, 1, false, paramArrayOfFloat, 0);
    lsd.a();
    if (paramlre.a())
    {
      a(2);
    ...
    a(arrayOflrc, 5, 4, paramRectF.left, paramRectF.top, paramRectF.width(), paramRectF.height());
    if (paramlre.a()) {
      c();
    }
  ...
  private void a(lrc[] paramArrayOflrc, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    f();
    a(paramFloat1, paramFloat2, 0.0F);
    b(paramFloat3, paramFloat4, 1.0F);
    GLES20.glUniformMatrix4fv(paramArrayOflrc[1].jdField_a_of_type_Int, 1, false, a(), 0);
    g();
    lsd.a();
  }
  
  private void a(lrc[] paramArrayOflrc, int paramInt)
  {
    GLES20.glBindBuffer(34962, this.jdField_e_of_type_Int);
    lsd.a();
    GLES20.glVertexAttribPointer(paramArrayOflrc[0].jdField_a_of_type_Int, 2, 5126, false, 8, paramInt * 8);
    lsd.a();
    GLES20.glBindBuffer(34962, 0);
    lsd.a();
  }
  
  private void a(lrc[] paramArrayOflrc, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    a(paramArrayOflrc, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
    int j = paramArrayOflrc[0].jdField_a_of_type_Int;
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, lqf paramlqf)
  {
    a(3, 4, 2, paramFloat1, paramFloat2, paramFloat3 - paramFloat1, paramFloat4 - paramFloat2, paramlqf);
  ...
  public void a(int paramInt)
  {
    ...
    for (this.jdField_c_of_type_ArrayOfFloat = Arrays.copyOf(this.jdField_c_of_type_ArrayOfFloat, this.jdField_c_of_type_ArrayOfFloat.length * 2);; this.jdField_c_of_type_ArrayOfFloat = arrayOfFloat)
    {
      ...
      this.jdField_a_of_type_Lsc.a(paramInt);
      return;
      j = 0;
      break;
  ...
  public void a(lre paramlre)
  {
    int k = paramlre.g();
    int[] arrayOfInt = paramlre.a();
    int j = 0;
    while (j < arrayOfInt.length)
    {
      GLES20.glBindTexture(k, paramlre.a()[j]);
      j += 1;
    }
    lsd.a();
  ...
  public void a(lre paramlre, int paramInt1, int paramInt2)
  {
    int k = paramlre.g();
    int[] arrayOfInt = paramlre.a();
    int j = 0;
    ...
    lsd.a();
    GLES20.glTexImage2D(k, 0, paramInt1, paramlre.e(), paramlre.f(), 0, paramInt1, paramInt2, null);
  }
  
  public void a(lre paramlre, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt3 <= 0) || (paramInt4 <= 0)) {
      return;
    }
    Rect localRect = paramlre.a();
    ...
    a(this.jdField_a_of_type_AndroidGraphicsRectF, paramlre);
    a(paramlre, this.jdField_a_of_type_AndroidGraphicsRectF, this.jdField_b_of_type_AndroidGraphicsRectF);
  }
  
  public void a(lre paramlre, int paramInt1, int paramInt2, Bitmap paramBitmap, int paramInt3, int paramInt4)
  {
    int k = paramlre.g();
    int[] arrayOfInt = paramlre.a();
    int j = 0;
  ...
  public void a(lre paramlre, Bitmap paramBitmap)
  {
    int k = paramlre.g();
    int[] arrayOfInt = paramlre.a();
    int j = 0;
  ...
  public boolean a(lre paramlre)
  {
    boolean bool = paramlre.c();
    if (bool) {}
    for (;;)
    {
      synchronized (this.jdField_b_of_type_Lsc)
      {
        paramlre = paramlre.a();
        if (paramlre != null) {
          break label68;
        ...
        return bool;
        if (j < paramlre.length)
        {
          this.jdField_b_of_type_Lsc.a(paramlre[j]);
          j += 1;
          continue;
        }
        return bool;
  ...
  {
    int k = 1;
    int m = this.jdField_a_of_type_Lsc.a();
    if ((m & 0x1) == 1)
    {
      j = 1;
      if (j != 0) {
  ...
  public void d()
  {
    synchronized (this.jdField_b_of_type_Lsc)
    {
      lsc locallsc2 = this.jdField_b_of_type_Lsc;
      if (this.jdField_b_of_type_Lsc.b() > 0)
      {
        jdField_a_of_type_Lqe.a(null, locallsc2.b(), locallsc2.a(), 0);
        locallsc2.a();
      }
      locallsc2 = this.jdField_c_of_type_Lsc;
      if (locallsc2.b() > 0)
      {
        jdField_a_of_type_Lqe.b(null, locallsc2.b(), locallsc2.a(), 0);
        locallsc2.a();
      }
      return;
    }
