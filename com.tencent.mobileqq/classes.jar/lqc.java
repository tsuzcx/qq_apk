  ...
  extends lql
{
  ...
  private Frame a(List<lqq> paramList, Frame paramFrame)
  {
    ArrayList localArrayList1 = new ArrayList();
    int i = 0;
    while (i < paramList.size())
    {
      float[][] arrayOfFloat = ((TTFaceOriginDataModel)((lqq)paramList.get(i)).jdField_a_of_type_JavaUtilList.get(0)).facePoint;
  ...
  {
    Object localObject2 = (lqp)paramList.get(0);
    Object localObject1 = ((lqp)paramList.get(0)).jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame;
    ...
    if (((lqp)localObject2).a())
    {
      int i = 0;
      while (i < ((lqp)localObject2).jdField_a_of_type_JavaUtilList.size())
      {
        localArrayList.addAll(((lqq)((lqp)localObject2).jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaUtilList);
        i += 1;
      }
    }
    ...
    if ((this.d) && (((lqp)localObject2).a()))
    {
      localObject2 = a(((lqp)localObject2).jdField_a_of_type_JavaUtilList, (Frame)localObject1);
      paramList = (List<lqp>)localObject2;
    ...
    for (paramList = (List<lqp>)localObject2;; paramList = (List<lqp>)localObject1)
    {
