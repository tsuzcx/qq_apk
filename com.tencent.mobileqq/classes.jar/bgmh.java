...
public class bgmh
{
  ...
  private bgmn jdField_a_of_type_Bgmn;
  private bgmo jdField_a_of_type_Bgmo;
  private QzoneZipCacheHelperCallBack jdField_a_of_type_CooperationQzoneWebviewpluginQzoneZipCacheHelperCallBack = new bgmi(this);
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<Context> jdField_a_of_type_JavaLangRefWeakReference;
  private Set<WeakReference<Bitmap>> jdField_a_of_type_JavaUtilSet;
  private CopyOnWriteArrayList<bgmk> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  public boolean a;
  ...
  public bgmh(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramArrayOfString.length)
        {
          ...
          localbgmk.jdField_a_of_type_JavaLangString = (paramString + File.separator + paramArrayOfString[i]);
          if ((!localbgmk.jdField_a_of_type_JavaLangString.endsWith(".jpg")) && (!localbgmk.jdField_a_of_type_JavaLangString.endsWith(".png"))) {
            break label158;
          }
          this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localbgmk);
          break label158;
        }
        bool = true;
        if (this.jdField_c_of_type_Boolean) {
          a(0, this.jdField_a_of_type_Bgmn);
        }
        if (this.jdField_a_of_type_Bgmo != null) {
          this.jdField_a_of_type_Bgmo.onZipLoaded(bool);
        }
        return;
      }
      finally {}
  ...
  private boolean a(int paramInt)
  {
    try
    {
      bgmk localbgmk = (bgmk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt);
      if (localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null) {
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable;
      }
  ...
  private void b()
  {
    ...
    {
      bgmk localbgmk = (bgmk)localIterator.next();
      if (localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null) {
        localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = null;
      }
    }
  }
  
  private void b(int paramInt, bgmn parambgmn)
  {
    ...
    do
    {
      ...
      {
        return;
        if (((bgmk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt)).jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null)
        {
          QzoneHandlerThreadFactory.getHandlerThread("YellowVip_HandlerThread").post(new ZipDrawableLoader.3(this, paramInt, parambgmn));
          return;
        }
        if (parambgmn != null) {
          parambgmn.a(paramInt, ((bgmk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt)).jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
        }
      } while (this.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_Boolean = true;
    } while (this.jdField_a_of_type_Bgmm == null);
    this.jdField_a_of_type_Bgmm.a(((bgmk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt)).jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    while (this.jdField_a_of_type_Bgmo == null) {
      return;
    }
    this.jdField_a_of_type_Bgmo.onZipLoaded(paramBoolean);
  }
  ...
  private void d(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (k >= m)
      {
        ...
        while (i < paramInt)
        {
          localbgmk = (bgmk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if (localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != this.jdField_a_of_type_AndroidGraphicsDrawableDrawable)
          {
            if (this.jdField_b_of_type_Boolean) {
              a(localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
            }
            localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = null;
          }
          i += 1;
      ...
      else
      {
        ...
        while (j < m)
        {
          localbgmk = (bgmk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(j);
          if (localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != this.jdField_a_of_type_AndroidGraphicsDrawableDrawable)
          {
            if (this.jdField_b_of_type_Boolean) {
              a(localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
  ...
  public CopyOnWriteArrayList<bgmk> a()
  {
  ...
  public void a(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 45	bgmh:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   18: aload_0
    //   19: iload_1
    //   20: putfield 47	bgmh:jdField_b_of_type_Int	I
    //   23: aload_0
    //   24: iload_1
    //   25: invokespecial 412	bgmh:a	(I)Z
    //   28: pop
    //   29: goto -14 -> 15
    //   32: astore_3
    //   33: aload_0
  ...
  /* Error */
  public void a(int paramInt, bgmn parambgmn)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   19: iload_1
    //   20: aload_2
    //   21: invokespecial 415	bgmh:b	(ILbgmn;)V
    //   24: aload_0
    //   25: iload_1
    //   26: invokevirtual 417	bgmh:a	(I)V
    //   29: goto -14 -> 15
    //   32: astore_2
    //   33: aload_0
    //   34: monitorexit
  ...
  {
    this.jdField_a_of_type_Bgmn = parambgmn;
  }
  
  public void a(bgmo parambgmo)
  {
    this.jdField_a_of_type_Bgmo = parambgmo;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, boolean paramBoolean)
  {
    ...
    //   15: return
    //   16: aload_0
    //   17: getfield 36	bgmh:jdField_a_of_type_Int	I
    //   20: ifgt +8 -> 28
    //   23: aload_0
    //   24: iconst_1
    //   25: putfield 36	bgmh:jdField_a_of_type_Int	I
    //   28: aload_0
    //   29: aload_1
    //   30: putfield 226	bgmh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   33: aload_0
    //   34: aload_3
    //   35: putfield 365	bgmh:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   38: aload_0
    //   39: aload_2
    //   40: putfield 320	bgmh:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   43: aload_0
    //   44: iload 5
    //   46: putfield 291	bgmh:jdField_c_of_type_Boolean	Z
    //   49: ldc_w 435
    ...
    //   59: aload_0
    //   60: iload 4
    //   62: invokespecial 440	cooperation/qzone/zipanimate/ZipDrawableLoader$1:<init>	(Lbgmh;I)V
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 36	bgmh:jdField_a_of_type_Int	I
    //   25: ifgt +8 -> 33
    //   28: aload_0
    //   29: iconst_1
    //   30: putfield 36	bgmh:jdField_a_of_type_Int	I
    //   33: aload_0
    //   34: iload_2
    //   35: putfield 291	bgmh:jdField_c_of_type_Boolean	Z
    //   38: aload_0
    //   39: aload_1
    //   40: invokestatic 445	cooperation/qzone/webviewplugin/QzoneZipCacheHelper:getFileList	(Ljava/lang/String;)[Ljava/lang/String;
    //   43: aload_1
    //   44: invokespecial 377	bgmh:a	([Ljava/lang/String;Ljava/lang/String;)V
    //   47: goto -29 -> 18
    //   50: astore_1
    //   51: aload_0
    //   52: monitorexit
  ...
  /* Error */
  void a(java.util.List<bgmk> paramList, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   21: iload_3
    //   22: aload_0
    //   23: getfield 36	bgmh:jdField_a_of_type_Int	I
    //   26: if_icmpge -10 -> 16
    //   29: aload_0
    //   30: iload_2
    //   31: iload_3
    ...
    //   39: irem
    //   40: aload_0
    //   41: getfield 293	bgmh:jdField_a_of_type_Bgmn	Lbgmn;
    //   44: invokespecial 415	bgmh:b	(ILbgmn;)V
    //   47: iload_3
    //   48: iconst_1
    //   49: iadd
    //   50: istore_3
    ...
    //   start	length	slot	name	signature
    //   0	59	0	this	bgmh
    //   0	59	1	paramList	java.util.List<bgmk>
    //   0	59	2	paramInt	int
    //   20	31	3	i	int
    //   9	3	4	bool	boolean
    // Exception table:
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      localbgmk = (bgmk)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt);
    } while (localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localbgmk.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable;
  }
