  ...
  implements View.OnClickListener
{
  ...
  public rwi(Context paramContext)
  {
    this(paramContext, -1, -1);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  private rwi(Context paramContext, int paramInt1, int paramInt2)
  {
    this(paramContext, 2131690290, paramInt1, paramInt2);
  }
  
  private rwi(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      sai.b("RichBlockDialog", 2, "ScrollMoreDialog() window == null.");
      return;
    }
    paramContext = paramContext.getAttributes();
    if (paramContext == null)
    {
      sai.b("RichBlockDialog", 2, "ScrollMoreDialog() params == null.");
      return;
    }
  ...
  private void a(int paramInt)
  {
    ...
    {
      sai.a("RichBlockDialog", 1, "点击时间小于1.5秒，不做响应");
      return;
    }
    ...
    {
      rzw.c(112, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      rzu.a(112, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      ...
      sam.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject2, str, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, new rwj(this, (Context)localObject1));
    }
    e();
  }
  ...
  private void a(URLDrawable paramURLDrawable, String paramString, ImageView paramImageView)
  {
    ...
    for (;;)
    {
      ...
      show();
      rzw.c(6, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      rzu.a(6, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      WSPublicAccReport.getInstance().reportExposeRichBlockPop(this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      a();
      sai.a("813", "onLoadSuccessed - " + paramString);
      return;
      label275:
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131496608, null, false);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308911));
    this.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308915));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308912));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308914));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308913));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308909));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308908));
    this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131308916));
  ...
  private void d()
  {
    if ((this.jdField_a_of_type_UserGrowthStPopWindowsConfig != null) && (this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type != 1))
    {
      ...
      sai.a("weishi-813", "展示图片");
      return;
    }
    sai.a("weishi-813", "展示红包");
  }
  ...
  public void a(stGlobalConfig paramstGlobalConfig)
  {
    ...
    if (paramstGlobalConfig != null)
    {
      ...
      sai.a("weishi-813", "阻断页rich化 type是：" + paramstGlobalConfig.type);
    }
    for (;;)
    {
      d();
      ...
      break;
      label117:
      sai.a("weishi-813", "阻断页rich化 windowsConfig为null");
      continue;
      label129:
      sai.c("weishi-813", "瀑布流阻断页rich化 windowsConfig size为0");
    }
  }
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    {
      sai.a("RichBlockDialog", "813不支持瀑布流红包和动图弹窗");
      return;
    }
    if (!TextUtils.isEmpty(this.jdField_a_of_type_UserGrowthStPopWindowsConfig.bg_img_url))
    {
      paramContext = getContext().getResources().getDrawable(2130841183);
      a(this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.bg_img_url, paramContext, paramContext, ajjy.a(2131647656));
      return;
    }
    e();
  }
  ...
  public void a(ImageView paramImageView, String paramString1, Drawable paramDrawable1, Drawable paramDrawable2, String paramString2)
  {
    ...
    paramString1.setURLDrawableListener(new rwk(this, paramString2, paramImageView));
  ...
  public void dismiss()
  {
    sai.b("RichBlockDialog", 2, "dismiss()");
    try
    {
      this.jdField_a_of_type_Boolean = false;
      super.dismiss();
    ...
    {
      sai.d("RichBlockDialog", 2, localException.getLocalizedMessage());
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    rzw.c(117, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
    rzu.a(117, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
    ...
    return;
    sai.a("weishi-813", "点击了图片 背景图");
    a(2);
  }
  
  public void show()
  {
    sai.b("RichBlockDialog", 2, "show()");
    try
    {
      super.show();
