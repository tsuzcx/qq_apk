...
{
  public anfx(ApolloCardWindow paramApolloCardWindow, TextView paramTextView) {}
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anfu.c(((Integer)paramValueAnimator.getAnimatedValue()).intValue()));
    }
    label42:
    do
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(anfu.b(((Integer)paramValueAnimator.getAnimatedValue()).intValue()));
        return;
      }
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anfu.a(((Integer)paramValueAnimator.getAnimatedValue()).intValue()));
  }
}
