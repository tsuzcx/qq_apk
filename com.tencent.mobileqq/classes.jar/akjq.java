  ...
  extends ajtd
{
  ...
  public akjq(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt1, int paramInt2, ListenChangeVoicePanel paramListenChangeVoicePanel)
  {
    ...
    localvoiceChangeReq.str_qq_version.set("8.2.8");
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QLog.e("VoiceChangeHandler", 1, "onReceive~ isSuccess=false ,data=" + bbmj.a((byte[])paramObject));
        bded.a().a("voiceChange.Auth", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 0, ajyc.a(2131716841), true);
