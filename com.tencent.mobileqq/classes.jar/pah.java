...
{
  public pah(EditUniqueTitleActivity paramEditUniqueTitleActivity) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (paramEditable = this.a.getResources().getColorStateList(2131494308);; paramEditable = this.a.getResources().getColorStateList(2131494275))
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.getString(2131430416), new Object[] { Integer.valueOf(i) }));
      return;
