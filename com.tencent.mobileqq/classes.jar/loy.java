  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  private final loz jdField_a_of_type_Loz = new loz();
  ...
  private final nbs jdField_b_of_type_Nbs = new nbs();
  ...
  private void e()
  {
    ...
    {
      this.jdField_a_of_type_Lpz.c();
      this.jdField_a_of_type_Lpz = null;
    }
  ...
  private void g()
  {
    ...
    if ((this.jdField_b_of_type_Nbs.a()) || (this.jdField_a_of_type_Nbs.a())) {
      i();
    }
    for (;;)
    {
  ...
  private void h()
  {
    boolean bool = this.jdField_a_of_type_Nbs.a(this.jdField_b_of_type_Nbs);
    if ((this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer == null) || (bool))
    {
      if (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer != null) {
        this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.destroy();
      }
      this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer = new RenderBuffer(this.jdField_a_of_type_Nbs.jdField_a_of_type_Int, this.jdField_a_of_type_Nbs.jdField_b_of_type_Int, 33984);
    }
    if (this.jdField_b_of_type_Boolean)
    {
      if ((this.jdField_b_of_type_ComTencentTtpicOpenapiFilterRenderBuffer == null) || (bool))
      {
        ...
        this.jdField_b_of_type_ComTencentTtpicOpenapiFilterRenderBuffer = new RenderBuffer(this.jdField_a_of_type_Nbs.jdField_a_of_type_Int, this.jdField_a_of_type_Nbs.jdField_b_of_type_Int, 33985);
      }
      if (this.jdField_a_of_type_Lpz == null)
      {
        this.jdField_a_of_type_Lpz = new lpz();
        this.jdField_a_of_type_Lpz.b();
      }
      if (bool) {
        this.jdField_a_of_type_Lpz.a(this.jdField_a_of_type_Nbs.jdField_a_of_type_Int, this.jdField_a_of_type_Nbs.jdField_b_of_type_Int);
      }
      if ((this.jdField_a_of_type_JavaNioByteBuffer == null) || (bool)) {
        this.jdField_a_of_type_JavaNioByteBuffer = ByteBuffer.allocate(this.jdField_a_of_type_Nbs.jdField_a_of_type_Int * this.jdField_a_of_type_Nbs.jdField_b_of_type_Int * 3 / 2);
      }
    }
    if ((this.jdField_a_of_type_ArrayOfByte == null) || (bool)) {
      this.jdField_a_of_type_ArrayOfByte = new byte[this.jdField_a_of_type_Nbs.jdField_a_of_type_Int * this.jdField_a_of_type_Nbs.jdField_b_of_type_Int * 3 / 2];
    }
  }
  ...
  private void i()
  {
    ...
    {
      this.jdField_b_of_type_ArrayOfFloat = GPUBaseFilter.caculateCenterCropMvpMatrix(this.e, this.f, this.jdField_a_of_type_Nbs.jdField_a_of_type_Int, this.jdField_a_of_type_Nbs.jdField_b_of_type_Int);
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Lpz.a(this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId());
      l3 = Math.abs(SystemClock.elapsedRealtime() - l1);
      l1 = SystemClock.elapsedRealtime();
      GLES20.glReadPixels(0, 0, this.jdField_a_of_type_Nbs.jdField_a_of_type_Int, this.jdField_a_of_type_Nbs.jdField_b_of_type_Int * 3 / 8, 6408, 5121, this.jdField_a_of_type_JavaNioByteBuffer);
      this.jdField_b_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.unbind();
      l2 = Math.abs(SystemClock.elapsedRealtime() - l1);
      this.jdField_a_of_type_JavaNioByteBuffer.get(this.jdField_a_of_type_ArrayOfByte, 0, this.jdField_a_of_type_Nbs.jdField_a_of_type_Int * this.jdField_a_of_type_Nbs.jdField_b_of_type_Int * 3 / 2);
      this.jdField_a_of_type_JavaNioByteBuffer.clear();
      localObject = this.jdField_a_of_type_Lpa;
      if (localObject == null) {
        break label398;
      }
      l1 = SystemClock.elapsedRealtime();
      ((lpa)localObject).a(this.jdField_a_of_type_ArrayOfByte, this.g, 2, this.jdField_a_of_type_Nbs);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Loz.a(l7, l3, l2, l1, l4 - l6);
      return;
      localObject = GlUtil.captureFrame(this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId(), this.jdField_a_of_type_Nbs.jdField_a_of_type_Int, this.jdField_a_of_type_Nbs.jdField_b_of_type_Int, 0);
      lpa locallpa = this.jdField_a_of_type_Lpa;
      l3 = l4;
      l2 = l5;
      if (locallpa != null)
      {
        l1 = SystemClock.elapsedRealtime();
        locallpa.a((Bitmap)localObject, this.jdField_a_of_type_Nbs);
        l1 = SystemClock.elapsedRealtime() - l1;
        l3 = l4;
        l2 = l5;
        continue;
  ...
  public void a(nbs paramnbs)
  {
    ...
    if (QLog.isDevelopLevel()) {
      QLog.i("EGLScreenCaptureThread", 4, "updateRecordParam cur[" + this.jdField_b_of_type_Nbs + "], come[" + paramnbs + "]");
    }
    this.jdField_b_of_type_Nbs.a(paramnbs);
  }
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    ...
    if (this.jdField_c_of_type_Long != 0L) {
      if (l >= this.jdField_a_of_type_Nbs.jdField_a_of_type_Long) {}
    }
    for (i = 1;; i = 0)
    {
      if (i != 0) {}
      for (l = Math.min(this.jdField_a_of_type_Nbs.jdField_a_of_type_Long - l, 2000L);; l = 2000L)
      {
        this.jdField_a_of_type_AndroidOsHandler.removeMessages(3);
        this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(3, l);
        if ((i != 0) || ((!this.jdField_b_of_type_Nbs.a()) && (!this.jdField_a_of_type_Nbs.a()))) {
          break;
        }
        i();
        return;
