...
public class avxj
{
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong, TroopTips0x857.NotifyMsgBody paramNotifyMsgBody)
  {
    ...
    if (i == 4)
    {
      awbh.b(paramQQAppInterface, String.valueOf(l));
      localavwv.notifyUI(5, true, new Object[] { Integer.valueOf(1), String.valueOf(l) });
      awbi.a(paramQQAppInterface);
    }
    for (;;)
    {
      localavwv.notifyUI(3, true, new Object[] { paramNotifyMsgBody });
      return;
      if ((i == 1) || (i == 2))
      {
        awbi.a(paramQQAppInterface, 1, String.valueOf(l), true);
      }
      else
      {
        if (i == 5)
        {
          ...
          awbh.b(paramQQAppInterface, String.valueOf(l));
          localavwv.notifyUI(6, true, new Object[] { Integer.valueOf(1), String.valueOf(l), Integer.valueOf(paramInt) });
          awbi.a(paramQQAppInterface);
          continue;
        }
        if (i == 3) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 == paramQQAppInterface.getLongAccountUin()) {
      avwv.a(paramQQAppInterface).a(new avwp(1, String.valueOf(paramLong2)), false);
    }
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, TroopTips0x857.LbsShareChangePushInfo paramLbsShareChangePushInfo, int paramInt)
  {
    ...
    paramLbsShareChangePushInfo = new avwp(1, String.valueOf(l1));
