...
{
  public static final String a = abcl.class.getSimpleName();
  private static final String b = abcl.class.getName();
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    if ((paramLong == 32L) && (a()))
    {
      ...
      if ((paramString != null) && ((paramString instanceof bhsx))) {
        ((bhsx)paramString).hideQQBrowserButton();
      }
