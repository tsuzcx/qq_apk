  ...
  implements ARMapHongBaoListView.ConversationActiveListViewListener
{
  ...
  public abcl(ConversationARMap paramConversationARMap) {}
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (float f1 = 0.0F;; f1 = 1.0F)
      {
        ...
        View localView = this.jdField_a_of_type_ComTencentMobileqqArmapConversationARMap.jdField_a_of_type_ComTencentMobileqqActivityConversation.a();
