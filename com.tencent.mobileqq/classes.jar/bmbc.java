...
public class bmbc
  extends bcfk
{
  private static ForegroundColorSpan jdField_a_of_type_AndroidTextStyleForegroundColorSpan = new ForegroundColorSpan(bcnc.b());
  public int a;
  public long a;
  ...
  public void a(View paramView)
  {
    ...
    bmaf.a(localBaseActivity, localBaseActivity.getAppRuntime().getAccount(), this.jdField_a_of_type_Long);
    bcnc.a(this.jdField_a_of_type_JavaLangString, 60, 0, paramView);
    if ((localBaseActivity instanceof UniteSearchActivity)) {
      bcnc.a("all_result", "clk_collect", new String[] { "" + this.jdField_a_of_type_JavaLangString });
    }
  }
  ...
  public CharSequence c()
  {
    ...
    return localSpannableStringBuilder.append("来自: ").append(bcnc.a(this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, 30));
  }
