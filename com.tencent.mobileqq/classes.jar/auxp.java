...
public class auxp
  extends anvi
{
  public auxp(QQSettingChatOperationFragment paramQQSettingChatOperationFragment) {}
  ...
  protected void onSetGeneralSettingsC2CRoaming(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    if (paramBoolean)
    {
      QQToast.a(paramMap.getApplicationContext(), 2, 2131694775, 0).b(this.a.getActivity().getTitleBarHeight());
      return;
    }
    ...
    for (paramBoolean = bool;; paramBoolean = false)
    {
      ...
      QQToast.a(paramMap.getApplicationContext(), 2131694774, 0).b(paramMap.getTitleBarHeight());
      return;
    }
  }
