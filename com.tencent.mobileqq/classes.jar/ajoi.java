...
public class ajoi
{
  public static SSLContext a()
  {
    ...
    try
    {
      ...
      localSSLContext.init(null, new TrustManager[] { new ajol() }, null);
  ...
  /* Error */
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String[] paramArrayOfString, ajof paramajof)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   37: instanceof 56
    //   40: ifeq +29 -> 69
    //   43: invokestatic 58	ajoi:a	()Ljavax/net/ssl/SSLContext;
    //   46: astore 12
    //   48: aload 12
    //   50: ifnull +19 -> 69
    //   53: aload 12
    ...
    //   168: iconst_m1
    //   169: aconst_null
    //   170: invokevirtual 92	ajof:a	(I[B)V
    //   173: aload_3
    //   174: ifnull +7 -> 181
    //   177: aload_3
    ...
    //   302: invokevirtual 92	ajof:a	(I[B)V
    //   305: aload_0
    //   306: ifnull +7 -> 313
    //   309: aload_0
  ...
  /* Error */
  public static void a(String paramString1, String paramString2, byte[] paramArrayOfByte, String[] paramArrayOfString, ajof paramajof)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   36: instanceof 56
    //   39: ifeq +24 -> 63
    //   42: invokestatic 58	ajoi:a	()Ljavax/net/ssl/SSLContext;
    //   45: astore_0
    //   46: aload_0
    //   47: ifnull +16 -> 63
    //   50: aload_0
    ...
    //   136: iconst_m1
    //   137: aconst_null
    //   138: invokevirtual 92	ajof:a	(I[B)V
    //   141: aload_3
    //   142: ifnull +7 -> 149
    //   145: aload_3
    ...
    //   267: invokevirtual 92	ajof:a	(I[B)V
    //   270: aload_1
    //   271: ifnull +7 -> 278
    //   274: aload_1
  ...
  /* Error */
  public static void a(String paramString1, String paramString2, String[] paramArrayOfString, ajof paramajof)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   28: instanceof 56
    //   31: ifeq +29 -> 60
    //   34: invokestatic 58	ajoi:a	()Ljavax/net/ssl/SSLContext;
    //   37: astore 6
    //   39: aload 6
    //   41: ifnull +19 -> 60
    //   44: aload 6
    ...
    //   137: iconst_m1
    //   138: aconst_null
    //   139: invokevirtual 92	ajof:a	(I[B)V
    //   142: aload_2
    //   143: ifnull +7 -> 150
    //   146: aload_2
    ...
    //   255: invokevirtual 92	ajof:a	(I[B)V
    //   258: aload_0
    //   259: ifnull +7 -> 266
    //   262: aload_0
  ...
  public static void a(@NonNull String paramString1, @NonNull String paramString2, @Nullable String[] paramArrayOfString, @Nullable byte[] paramArrayOfByte, @NonNull ajoh paramajoh, @Nullable ajog paramajog1, @Nullable ajog paramajog2)
  {
    if (paramajoh == null) {
      return;
    }
    ...
    for (paramString2 = paramString1.substring(i + "http://stubcmshow.qq.com/cm3d/".length());; paramString2 = paramString1)
    {
      ...
      paramString1 = ajmu.g + j + File.separator + paramString1;
      ...
      if (paramString2.exists())
      {
        ...
        if (a(paramString1))
        {
          ...
          paramajoh.a(0, paramArrayOfString, paramString1);
          if (QLog.isColorLevel()) {
        ...
        while (QLog.isColorLevel())
        {
          ...
          return;
          paramajoh.a(0, paramArrayOfString, ApolloRender.readStream(new FileInputStream(paramString2)));
        }
        break;
      }
      QLog.d("ApolloHttpUtil", 1, "fakeResource3DUrlRequest start download id:" + j);
      ajhw.b(ajae.a(), null, new ajoj(paramString1, paramArrayOfString, paramajoh), j, null, -1, -1, false);
      return;
      label473:
      if (paramString2.startsWith("Dress:"))
      {
        ...
        paramString1 = ajmu.f + j + File.separator + paramString1;
        paramString2 = new File(paramString1);
        if (paramString2.exists())
        {
          if (QLog.isColorLevel()) {
          ...
          paramArrayOfString = b(paramArrayOfString);
          if (a(paramString1)) {
            paramajoh.a(0, paramArrayOfString, b(paramString2, paramArrayOfString));
          }
          while (QLog.isColorLevel())
          {
            QLog.d("ApolloHttpUtil", 2, new Object[] { "fakeResource3DUrlRequest retHeader:", paramArrayOfString });
        ...
        QLog.d("ApolloHttpUtil", 1, "fakeResource3DUrlRequest start download id:" + j);
        ajhw.b(ajae.a(), null, new ajok(paramString1, paramArrayOfString, paramajoh, j), -1, new int[] { j }, -1, -1, true);
        return;
      }
      if (!paramString2.startsWith("def/role/0/3D/")) {
        break;
      }
      paramString1 = ajmu.c + File.separator + paramString2;
      paramString2 = new File(paramString1);
      if (paramString2.exists())
      {
        if (QLog.isColorLevel()) {
  ...
  /* Error */
  public static void a(String paramString, String[] paramArrayOfString, ajof paramajof)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   29: instanceof 56
    //   32: ifeq +29 -> 61
    //   35: invokestatic 58	ajoi:a	()Ljavax/net/ssl/SSLContext;
    //   38: astore 5
    //   40: aload 5
    //   42: ifnull +19 -> 61
    //   45: aload 5
    ...
    //   134: iconst_m1
    //   135: aconst_null
    //   136: invokevirtual 92	ajof:a	(I[B)V
    //   139: aload_1
    //   140: ifnull +7 -> 147
    //   143: aload_1
    ...
    //   229: invokevirtual 92	ajof:a	(I[B)V
    //   232: aload_0
    //   233: ifnull +7 -> 240
    //   236: aload_0
  ...
  private static byte[] a(@NonNull HttpURLConnection paramHttpURLConnection, @Nullable ajog paramajog)
  {
    localObject3 = null;
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject2 = paramHttpURLConnection;
            paramajog.a(((ByteArrayOutputStream)localObject3).size(), i);
          }
        }
        try
        {
          ...
          localObject2 = paramHttpURLConnection;
          paramajog = ((ByteArrayOutputStream)localObject3).toByteArray();
          localObject2 = paramajog;
          paramajog = (ajog)localObject2;
          if (paramHttpURLConnection == null) {
            continue;
          }
          try
        ...
        catch (IOException paramajog)
        {
          for (;;)
          {
            paramajog.printStackTrace();
          }
        }
      }
    }
  ...
  /* Error */
  public static void b(@NonNull String paramString1, @NonNull String paramString2, @Nullable String[] paramArrayOfString, @Nullable byte[] paramArrayOfByte, @NonNull ajoh paramajoh, @Nullable ajog paramajog1, @Nullable ajog paramajog2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   61: aload 14
    //   63: astore 12
    //   65: invokestatic 58	ajoi:a	()Ljavax/net/ssl/SSLContext;
    //   68: astore 15
    //   70: aload 15
    //   72: ifnull +35 -> 107
    //   75: aload 13
    ...
    //   525: aload_0
    //   526: aload 6
    //   528: invokestatic 405	ajoi:a	(Ljava/net/HttpURLConnection;Lajog;)[B
    ...
    //   0	782	4	paramajoh	ajoh
    //   0	782	5	paramajog1	ajog
    //   0	782	6	paramajog2	ajog
    //   181	581	7	i	int
    //   16	690	8	j	int
    //   361	51	9	k	int
    //   332	73	10	m	int
