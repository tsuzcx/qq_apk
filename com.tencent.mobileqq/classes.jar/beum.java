  ...
  implements APIProxy
{
  ...
  {
    beyr.a(bevi.a().a(), 1027, null, null, null, paramInt, "1", paramLong, null);
  }
  ...
  {
    QQFriendJsPlugin.doAddFriend(paramContext, bevi.a().a(), paramString, new beuo(this, paramAPICallback));
  }
  
  public void gotoPermissionSetting(Activity paramActivity)
  {
    ((MiniAppProxy)ProxyManager.get(MiniAppProxy.class)).openPermissionSettingsActivity(paramActivity, bevi.a().a(), bevi.a().c());
  }
  ...
  public void httpRequestForImage(long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String[] paramArrayOfString, boolean paramBoolean)
  {
    ...
    {
      paramString4.request(paramString1, paramString3, localHashMap, paramString2, 60, new beun(this, l, paramLong, paramString1));
      return;
    }
  }
}
