  ...
  implements TextWatcher
{
  ...
  public auys(BlockableEditTextView paramBlockableEditTextView)
  {
  ...
  public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        arrayOfauyt = (auyt[])localEditable.getSpans(paramInt1, paramInt1, auyt.class);
      } while ((arrayOfauyt == null) || (arrayOfauyt.length <= 0));
      this.b = localEditable.getSpanStart(arrayOfauyt[0]);
      this.c = localEditable.getSpanEnd(arrayOfauyt[0]);
