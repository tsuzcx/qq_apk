...
public class adci
  extends allb
{
  public adci(LikeRankingListActivity paramLikeRankingListActivity) {}
  ...
  protected void onReqLikeRankingListResult(boolean paramBoolean1, String paramString, List<LikeRankingInfo> paramList, int paramInt, boolean paramBoolean2)
  {
    ...
    else
    {
      ...
      this.a.jdField_a_of_type_Alre.a(paramList, paramInt, paramBoolean2);
      if ((!paramBoolean2) || (paramList.size() != 0)) {
        break label258;
      }
      this.a.e.setVisibility(0);
      label165:
      this.a.jdField_a_of_type_Adcj.a(paramList, true);
    ...
    for (;;)
    {
      ...
      label284:
      this.a.a(null);
      this.a.jdField_a_of_type_Adcj.a = false;
      this.a.jdField_a_of_type_Adcj.notifyDataSetChanged();
      if (this.a.jdField_a_of_type_Adcj.getCount() <= 1) {
        this.a.e.setVisibility(0);
      }
    }
    label341:
    this.a.jdField_a_of_type_Adcj.a = false;
    this.a.jdField_a_of_type_Adcj.notifyDataSetChanged();
    QQToast.a(BaseApplication.getContext(), 1, alpo.a(2131706482), 0).a();
  }
}
