...
public class adnn
  implements amjx, amjy
{
  private int jdField_a_of_type_Int;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<JumpActivity> jdField_a_of_type_JavaLangRefWeakReference;
  
  public adnn(JumpActivity paramJumpActivity, int paramInt, String paramString)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      alnr localalnr = (alnr)localJumpActivity.app.getManager(153);
      ...
      localStartCheckParam.version = localalnr.a(this.jdField_a_of_type_Int);
      ApolloGameUtil.a(localJumpActivity, localStartCheckParam);
      JumpActivity.a(localJumpActivity, true);
      localJumpActivity.b();
      return;
    }
    QQToast.a(BaseApplicationImpl.getApplication(), amtj.a(2131705042), 0).a();
  ...
  public void b(boolean paramBoolean)
  {
    ...
    localWebProcessManager.a(100, new adno(this, localJumpActivity));
    return;
    QQToast.a(BaseApplicationImpl.getApplication(), amtj.a(2131705041), 0).a();
  ...
  {
    if ((paramObject instanceof adnn))
    {
      paramObject = (adnn)paramObject;
