...
public class adnn
{
  private static adnn jdField_a_of_type_Adnn = new adnn();
  public long a;
  public final Object a;
  public Map<String, adnh> a;
  public JSONObject a;
  ...
  static
  {
    Bosses.initWithBoss(BaseApplicationImpl.getApplication(), new wjf(BaseApplicationImpl.getApplication()));
  }
  ...
  private boolean a(String paramString)
  {
    ...
    if ((adnh)this.jdField_a_of_type_JavaUtilMap.get(paramString) != null) {
      return true;
    }
  ...
  public adnh a(String paramString)
  {
    ...
    {
      return localObject;
      localadnh = (adnh)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      localObject = localadnh;
    } while (localadnh != null);
      ...
      if (localJSONObject2 != null)
      {
        ...
        if (localJSONArray != null)
        {
          ...
          for (i = 1;; i = 0)
          {
            ...
            paramString = new adnh((String)localObject, localJSONObject2.optString("name"));
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 43	adnn:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   70: aload_0
    //   71: aload 4
    //   73: invokespecial 222	adnn:b	(Ljava/lang/String;)Z
    //   76: istore_2
    //   77: iload_2
    //   78: istore_1
    //   79: iload_2
    ...
    //   113: ldc 200
    //   115: invokestatic 235	adnn:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   118: astore_3
    //   119: aload_3
    ...
    //   126: aload_0
    //   127: aload_3
    //   128: invokespecial 222	adnn:b	(Ljava/lang/String;)Z
    //   131: istore_1
    //   132: iload_1
    //   133: ifne +11 -> 144
    //   136: ldc 177
    ...
    //   144: aload_0
    //   145: iconst_1
    //   146: putfield 43	adnn:jdField_a_of_type_Boolean	Z
    //   149: goto -138 -> 11
    //   152: astore_3
    //   153: aload_0
    //   154: monitorexit
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, adnx paramadnx)
  {
    axeh localaxeh = axem.a().a(paramString2, paramInt, 1, false, null, 1);
    paramString1 = localaxeh;
    if (localaxeh == null) {
      paramString1 = new axeh(paramString2, paramInt);
    }
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new adnu(null)).map(new VerifyUrlJobSegment(paramString3)).map(new adnv(null)).map(new adns(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new adnr(this, paramadnx));
  }
  
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, adnx paramadnx)
  {
    paramString1 = axem.a().a(paramString2, paramInt, 1, false, null, 1);
    if (paramString1 != null)
    {
      ThreadManager.getUIHandler().post(new DefaultDoraemonAppInfoHelper.2(this, paramadnx, paramString1));
      return;
    }
    paramString1 = new axeh(paramString2, paramInt);
    ...
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new adnu(null)).map(new adnv(null)).map(new adnp(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new adno(this, paramadnx));
  }
