  ...
  private void a(Object paramObject)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileCome uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + apue.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        localObject1 = (String)paramObject[3];
        i = ((Integer)paramObject[4]).intValue();
        QLog.i("FMObserver<FileAssistant>", 1, "OnFileTransferStart uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "], strUin[" + apue.e((String)localObject1) + "], peerType[" + String.valueOf(i) + "]");
        ...
        {
          paramObject = (Object[])paramObject[2];
          localObject1 = new apev();
          ((apev)localObject1).jdField_a_of_type_JavaLangString = ((String)paramObject[0]);
          ((apev)localObject1).jdField_a_of_type_Int = ((Integer)paramObject[1]).intValue();
          ((apev)localObject1).jdField_b_of_type_JavaLangString = ((String)paramObject[2]);
          ((apev)localObject1).jdField_a_of_type_JavaLangObject = paramObject[3];
          QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess,fileId[" + ((apev)localObject1).jdField_a_of_type_JavaLangString + "],filePath[" + ((apev)localObject1).jdField_b_of_type_JavaLangString + "]");
          if ((((apev)localObject1).jdField_a_of_type_JavaLangObject != null) && (((apev)localObject1).jdField_b_of_type_JavaLangString != null) && (((apev)localObject1).jdField_b_of_type_JavaLangString.length() > 0))
          {
            if (!(((apev)localObject1).jdField_a_of_type_JavaLangObject instanceof WeiYunFileInfo)) {
              break label3135;
            }
            ((WeiYunFileInfo)((apev)localObject1).jdField_a_of_type_JavaLangObject).h = ((apev)localObject1).jdField_b_of_type_JavaLangString;
          }
          for (;;)
          {
            a((apev)localObject1);
            return;
            if ((((apev)localObject1).jdField_a_of_type_JavaLangObject instanceof OfflineFileInfo)) {
              ((OfflineFileInfo)((apev)localObject1).jdField_a_of_type_JavaLangObject).c = ((apev)localObject1).jdField_b_of_type_JavaLangString;
            } else if ((((apev)localObject1).jdField_a_of_type_JavaLangObject instanceof FileManagerEntity)) {
              ((FileManagerEntity)((apev)localObject1).jdField_a_of_type_JavaLangObject).strThumbPath = ((apev)localObject1).jdField_b_of_type_JavaLangString;
            }
          }
        }
        localObject1 = (Object[])paramObject[2];
        localObject2 = (String)localObject1[0];
        paramObject = new apev();
    ...
    for (i = ((Integer)localObject1[1]).intValue();; i = 0)
    {
      ...
      {
        localObject1 = new apev();
        ((apev)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
        ((apev)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
        ((apev)localObject1).jdField_b_of_type_Int = i;
        if (i == 7) {
          ((apev)localObject1).jdField_b_of_type_JavaLangString = paramObject.strLargeThumPath;
        }
        for (;;)
        {
          ((apev)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
          a((apev)localObject1);
          return;
          if (i == 5) {
            ((apev)localObject1).jdField_b_of_type_JavaLangString = paramObject.strMiddleThumPath;
          } else {
            ((apev)localObject1).jdField_b_of_type_JavaLangString = paramObject.strThumbPath;
          }
        }
      }
      localObject1 = new apev();
      ((apev)localObject1).jdField_a_of_type_JavaLangObject = paramObject;
      ((apev)localObject1).jdField_a_of_type_JavaLangString = paramObject.Uuid;
      ((apev)localObject1).jdField_b_of_type_JavaLangString = null;
      ((apev)localObject1).jdField_b_of_type_Int = i;
      ((apev)localObject1).jdField_a_of_type_Long = paramObject.nSessionId;
      a((apev)localObject1);
      return;
