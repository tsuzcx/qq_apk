...
public class ahea
{
  private static volatile ahea jdField_a_of_type_Ahea;
  public float a;
  ...
  public static ahea a()
  {
    ...
    {
      if (jdField_a_of_type_Ahea == null) {
        jdField_a_of_type_Ahea = new ahea();
      }
      return jdField_a_of_type_Ahea;
    }
    finally {}
  }
  
  private void a(String paramString, ahed paramahed, boolean paramBoolean)
  {
    ...
    PreloadManager.a().a(localDownloadParam, new ahec(this, paramBoolean, paramahed));
  }
  
  private void b(adcz paramadcz, ahee paramahee)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DrawClassifier", 2, "recognize called");
    }
    if ((!this.jdField_a_of_type_Boolean) || (paramadcz == null))
    {
      if (paramahee != null) {
        paramahee.a(false);
      }
    ...
    ThreadManager.excute(new DrawClassifier.3(this, paramahee, paramadcz), 16, null, true);
  }
  
  public String a()
  {
    if (this.jdField_a_of_type_Ahey == null) {
      return null;
    }
    return this.jdField_a_of_type_Ahey.a();
  }
  ...
  public void a()
  {
    ...
    //   23: aload_0
    //   24: getfield 97	ahea:jdField_a_of_type_Boolean	Z
    ...
    //   36: aload_0
    //   37: getfield 97	ahea:jdField_a_of_type_Boolean	Z
    //   40: istore_1
    //   41: iload_1
    //   42: ifne +6 -> 48
    //   45: aload_0
    ...
    //   48: aload_0
    //   49: iconst_0
    //   50: putfield 97	ahea:jdField_a_of_type_Boolean	Z
    //   53: aload_0
    //   54: getfield 34	ahea:jdField_a_of_type_Ahey	Lahey;
    //   57: ifnull -12 -> 45
    //   60: aload_0
    //   61: getfield 34	ahea:jdField_a_of_type_Ahey	Lahey;
    //   64: invokevirtual 132	ahey:a	()V
    //   67: goto -22 -> 45
    //   70: astore_2
    //   71: aload_0
    //   72: monitorexit
  ...
  public void a(adcz paramadcz, ahee paramahee)
  {
    b(paramadcz, paramahee);
  }
  
  public void a(Context paramContext, String paramString, ahed paramahed)
  {
    for (;;)
    {
      try
      ...
      ahfc.a().a(new aheb(this, paramahed));
    }
  }
}
