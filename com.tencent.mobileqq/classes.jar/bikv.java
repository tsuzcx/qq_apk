...
public class bikv
{
  private static bikv jdField_a_of_type_Bikv;
  private static String b = "LimixiuAVManager";
  private Context jdField_a_of_type_AndroidContentContext;
  bikx jdField_a_of_type_Bikx = null;
  biky jdField_a_of_type_Biky = null;
  bikz jdField_a_of_type_Bikz = null;
  AVContext jdField_a_of_type_ComTencentTMGSdkAVContext = null;
  private AVRoomMulti.EventListener jdField_a_of_type_ComTencentTMGSdkAVRoomMulti$EventListener = new bikw(this);
  String jdField_a_of_type_JavaLangString = null;
  
  private bikv(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = "user";
  }
  
  public static bikv a(Context paramContext)
  {
    if (jdField_a_of_type_Bikv == null) {}
    try
    {
      if (jdField_a_of_type_Bikv == null) {
        jdField_a_of_type_Bikv = new bikv(paramContext);
      }
      return jdField_a_of_type_Bikv;
    }
    finally {}
  }
  ...
  {
    bikn localbikn = new bikn();
    localbikn.sdkAppId = Integer.parseInt(this.jdField_a_of_type_Bikx.jdField_a_of_type_JavaLangString);
    localbikn.accountType = this.jdField_a_of_type_Bikx.b;
    localbikn.appIdAt3rd = this.jdField_a_of_type_Bikx.jdField_a_of_type_JavaLangString;
    localbikn.identifier = this.jdField_a_of_type_Bikx.c;
    localbikn.engineCtrlType = 2;
    localbikn.jdField_a_of_type_Int = Integer.valueOf(this.jdField_a_of_type_Bikx.f).intValue();
    localbikn.jdField_a_of_type_Long = Long.valueOf(this.jdField_a_of_type_Bikx.g).longValue();
    QLog.i("AVManager", 1, "getStartParams|param.sdkAppId=" + localbikn.sdkAppId + ", param.accountType=" + localbikn.accountType + ", param.appIdAt3rd=" + localbikn.appIdAt3rd + ", param.identifier=" + localbikn.identifier + ", param.engineCtrlType=" + localbikn.engineCtrlType + ", param.nGameID=" + localbikn.jdField_a_of_type_Int + ", param.lGameRoomID=" + localbikn.jdField_a_of_type_Long);
    return localbikn;
  }
  
  private AVRoomMulti.EnterParam a(String paramString, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    byte[] arrayOfByte = QAVAuthBuffer.a().genAuthBuffer(Integer.parseInt(this.jdField_a_of_type_Bikx.jdField_a_of_type_JavaLangString), Integer.parseInt(paramString), this.jdField_a_of_type_Bikx.c, Integer.parseInt(this.jdField_a_of_type_Bikx.b), this.jdField_a_of_type_Bikx.d, 1800, -1);
  ...
  public void a(bikx parambikx)
  {
    this.jdField_a_of_type_Bikx = parambikx;
  }
  
  public void a(bikz parambikz)
  {
    this.jdField_a_of_type_Bikz = parambikz;
  }
  ...
  public void a(AVCallback paramAVCallback)
  {
    ...
    com.tencent.TMG.utils.SoUtil.customLibPath = bilc.a();
    ...
    for (;;)
    {
      ...
      i = 1101;
      continue;
      this.jdField_a_of_type_ComTencentTMGSdkAVContext.setAppVersion(this.jdField_a_of_type_Bikx.e);
      this.jdField_a_of_type_ComTencentTMGSdkAVContext.start(a(), null, paramAVCallback);
    }
  }
  
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, int paramInt, biky parambiky)
  {
    QLog.i("AVManager", 1, "enterRoom.");
    this.jdField_a_of_type_Biky = parambiky;
    if (this.jdField_a_of_type_ComTencentTMGSdkAVContext == null)
    {
      Log.e("AVManager", "enterRoom| enter room faild, because of context not started.");
      if (this.jdField_a_of_type_Biky != null) {
        this.jdField_a_of_type_Biky.a(1101, "context not started.");
      }
      return;
    }
