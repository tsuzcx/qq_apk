...
public class bifj
{
  ...
  public static void a(Context paramContext, bifm parambifm)
  {
    ...
    {
      if (parambifm != null) {
        parambifm.a(localFile1.getAbsolutePath(), localFile2.getAbsolutePath());
      }
      return;
    }
    String str2 = bifo.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    bidy.a().a(b, str1, "SoHelper", new bifk(str2, str1, parambifm, paramContext, localFile1, localFile2));
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    paramContext = bifi.a(paramContext, "0", "key_local_so_version");
