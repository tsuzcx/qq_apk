...
public class pwa
{
  ...
  {
    SharedPreferences localSharedPreferences = bmhv.a(pkh.a(), true, true);
  ...
  public static boolean a(pvw parampvw)
  {
    if (a()) {
      return true;
    }
    ThreadManager.post(new ReadInjoyWebRenderSoLoader.1(parampvw), 8, null, true);
    return false;
  }
