...
class bims
  extends nkq
{
  bims(bimo parambimo, bimu parambimu, int paramInt) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfByte == null)
        {
          ...
          if (this.jdField_a_of_type_Bimu != null)
          {
            ...
            this.jdField_a_of_type_Bimu.a(paramBundle);
          }
          return;
        }
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramBundle = paramArrayOfByte;
          localObject = new bimt(null);
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).jdField_a_of_type_Long = (l2 * 1000L + l1);
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).jdField_a_of_type_Int = localUrlCheckResult.result.get();
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).jdField_b_of_type_Int = localUrlCheckResult.jump_result.get();
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).jdField_a_of_type_JavaLangString = localUrlCheckResult.jump_url.get();
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).c = localUrlCheckResult.uint32_level.get();
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).d = localUrlCheckResult.uint32_sub_level.get();
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).e = localUrlCheckResult.uint32_umrtype.get();
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).f = localUrlCheckResult.ret_from.get();
          paramBundle = paramArrayOfByte;
          ((bimt)localObject).jdField_b_of_type_Long = localUrlCheckResult.operation_bit.get();
          if (paramInt == 0) {
            paramArrayOfByte = (byte[])localObject;
          }
          paramBundle = paramArrayOfByte;
          this.jdField_a_of_type_Bimo.a.put(str, localObject);
          paramInt += 1;
        }
