...
public class zrc
{
  public ArrayList<Long> a(List<String> paramList)
  {
    ...
    {
      l = bbnj.a((String)paramList.next()) + l;
  ...
  public ArrayList<Long> a(List<String> paramList, String paramString)
  {
    ...
    long l2 = bbnj.a(paramString);
    paramString = new ArrayList();
    Iterator localIterator = paramList.iterator();
    long l1 = 0L;
    while (localIterator.hasNext())
    {
      l1 = bbnj.a((String)localIterator.next()) + l1;
  ...
  public boolean a(List<String> paramList, String paramString, int paramInt1, int paramInt2, MediaFormat paramMediaFormat)
  {
    ...
    {
      localObject4 = new brkg();
      try
      {
        i = brkf.a((String)paramList.get(0), (brkg)localObject4);
      ...
      paramInt1 = j;
      if (AudioHelper.g()) {
        return brka.a(paramList, paramString, i);
      }
      ...
      localObject5 = new bbmc(paramString, paramInt1, paramInt2, bdbt.r, 1, false, i);
      ((bbmc)localObject5).b = true;
    }
    for (;;)
    {
      Object localObject3;
      try
      {
        ...
        localObject3 = new File(((bbmc)localObject5).a);
        if (!((File)localObject3).exists()) {
          bhmi.c(((File)localObject3).getAbsolutePath());
        }
        localObject3 = new MediaMuxer(((bbmc)localObject5).a, 0);
        ((MediaMuxer)localObject3).setOrientationHint(((bbmc)localObject5).g);
  ...
  public ArrayList<Long> b(List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localLinkedHashMap.put(localObject, Long.valueOf(bbnj.a((String)localObject)));
      }
    }
  ...
  public ArrayList<Long> b(List<String> paramList, String paramString)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        paramString.put(localObject, Long.valueOf(bbnj.a((String)localObject)));
      }
    }
    paramList = new ArrayList();
