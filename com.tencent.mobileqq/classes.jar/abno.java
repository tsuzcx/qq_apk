  ...
  extends ViewModel
{
  ...
  @NotNull
  private final MutableLiveData<abns> jdField_a_of_type_AndroidArchLifecycleMutableLiveData = new MutableLiveData();
  ...
  static
  {
    jdField_a_of_type_Abnp = new abnp(null);
  }
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)paramString))
        {
          ...
          paramString.setValue(new abns(0, (String)localObject1, 0, 4, null));
          return;
        }
      }
    }
  ...
  @NotNull
  public final MutableLiveData<abns> a()
  {
  ...
  public final void a(int paramInt)
  {
    ...
    this.jdField_b_of_type_RxSubscription = Observable.timer(5L, TimeUnit.SECONDS, AndroidSchedulers.mainThread()).subscribe((Action1)new abnq(this));
  }
  
  public final boolean a(@NotNull String paramString, @Nullable abop paramabop)
  {
    ...
    if (paramabop != null)
    {
      ...
      Intrinsics.checkExpressionValueIsNotNull(paramabop, "model.adInfo");
      a(0, (String)localObject, paramabop);
      a(paramString);
    }
    for (;;)
    {
      ...
      if (StringsKt.startsWith$default(paramString, "gdtmsg://e.qq.com/reportClickRewardAd/rewardAD/", false, 2, null))
      {
        ...
        paramabop = paramabop.a();
        Intrinsics.checkExpressionValueIsNotNull(paramabop, "model.adInfo");
        a(1, (String)localObject, paramabop);
        a(paramString);
      }
      else
      {
  ...
  public final void b()
  {
    ...
    {
      this.jdField_a_of_type_AndroidArchLifecycleMutableLiveData.setValue(new abns(1, null, this.jdField_b_of_type_Int, 2, null));
      this.jdField_a_of_type_RxSubscription = Observable.interval(1L, TimeUnit.SECONDS, AndroidSchedulers.mainThread()).subscribe((Action1)new abnr(this));
    }
  }
