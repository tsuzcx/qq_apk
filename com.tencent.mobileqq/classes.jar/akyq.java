...
public class akyq
  implements Manager
{
  akyk jdField_a_of_type_Akyk = null;
  akyu jdField_a_of_type_Akyu = null;
  ...
  public akyq(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Akyu = new akyu(l);
  }
  ...
  public PromotionConfigInfo a()
  {
    ...
    {
      QLog.w(akyx.jdField_a_of_type_JavaLangString, 1, "getConfigInfo, AR配置还未初始化", new Throwable("打印调用栈"));
  ...
  {
    if (this.jdField_a_of_type_Akyu != null) {
      this.jdField_a_of_type_Akyu.a(paramakyw);
    }
  }
  ...
  public void a(AppInterface paramAppInterface, String paramString)
  {
    if (this.jdField_a_of_type_Akyu != null) {
      if (a())
      {
        ...
        this.jdField_a_of_type_Akyu.a(localPromotionConfigInfo);
        this.jdField_a_of_type_Akyu.a(paramAppInterface, false, paramString, 0);
      }
    }
    do
    {
    ...
    throw new IllegalArgumentException(ajya.a(2131708524));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, PromotionConfigInfo paramPromotionConfigInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramPromotionConfigInfo != null)
      {
        ...
        {
          this.jdField_a_of_type_Akyy.clean();
  ...
  boolean a(String paramString, AppInterface paramAppInterface, akys paramakys)
  {
    if ((a()) && (akyp.a != -1)) {
      return false;
    }
    Object localObject2 = this.jdField_a_of_type_Akyy;
    ...
    if (localObject2 == null)
    {
      ...
      localObject1 = new akyy(this.jdField_a_of_type_JavaLangString, this.b, paramAppInterface);
      this.jdField_a_of_type_Akyy = ((akyy)localObject1);
    }
    if (((akyy)localObject1).isNeedRunTask())
    {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "异步加载config[" + paramString + "]");
      localObject2 = new ArrayList();
      ((ArrayList)localObject2).add(localObject1);
      bbkl.requestSyncTask(null, (ArrayList)localObject2, new akyr(this, paramAppInterface, paramString, paramakys));
    }
    for (;;)
    {
      return true;
  ...
  {
    if (this.jdField_a_of_type_Akyu != null) {
      this.jdField_a_of_type_Akyu.b(paramakyw);
    }
  }
  ...
  void b(AppInterface paramAppInterface)
  {
    ...
    if (AudioHelper.e()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "requestPreDownload, PromotionConfigInfo[" + localPromotionConfigInfo1 + "], isDevicesSupport[" + akyp.a() + "]");
    }
    if (!akyp.a()) {}
    ...
    this.jdField_a_of_type_Akyu.a(localPromotionConfigInfo2);
    this.jdField_a_of_type_Akyu.a(paramAppInterface, true, localPromotionConfigInfo1.activityid, 0);
  }
  ...
  void c(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Akyk.a(paramAppInterface);
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Akyu != null)
    {
      ...
      this.jdField_a_of_type_Akyu = null;
    }
    if (this.jdField_a_of_type_Akyk != null)
    {
      this.jdField_a_of_type_Akyk.a();
