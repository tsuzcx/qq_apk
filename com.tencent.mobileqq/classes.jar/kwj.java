  ...
  extends kwi
{
  ...
  public kwj(AppInterface paramAppInterface)
  {
  ...
  public static void a(VideoAppInterface paramVideoAppInterface, String paramString1, long paramLong, String paramString2, boolean paramBoolean)
  {
    int i;
    long l1;
    if (((kyo)paramVideoAppInterface.a(5)).a(0, "750") == 1)
    {
      i = 1;
      l1 = AudioHelper.a();
      if (i == 0) {
      ...
      i = 12;
      localObject = (kwi)paramVideoAppInterface.a(1);
    }
    for (Object localObject = paramString2 + "|" + ((kwi)localObject).a() + "|" + paramLong + "|" + l1;; localObject = paramString2)
    {
      long l2 = b;
      b = l1;
  ...
  void a(long paramLong1, long paramLong2)
  {
    ...
    ZimuItem localZimuItem = (ZimuItem)((kze)localVideoAppInterface.a(0)).a();
  ...
  boolean b()
  {
    return ((kze)((VideoAppInterface)this.mApp).a(0)).b();
  }
  
  boolean c()
  {
    return ((kwl)this.mApp.getBusinessHandler(0)).a();
  }
}
