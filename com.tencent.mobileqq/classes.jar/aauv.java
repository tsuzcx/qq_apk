...
{
  public aauv(DeviceMsgSettingActivity paramDeviceMsgSettingActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      ...
      bhzt.a().a(this.a.getString(2131718178));
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = (aauw)paramBundle.next();
        if (((aauw)localObject).a == j) {
          if (this.a.jdField_a_of_type_AndroidWidgetCompoundButton.isChecked())
          {
            paramInt = 1;
            ((aauw)localObject).b = paramInt;
          }
          else
          {
            paramInt = 0;
    ...
    abdm.a(paramBundle, l, "Usr_MsgMgr_Setting", paramInt, 0, Integer.parseInt(this.a.b));
    return;
    label280:
    ...
    for (paramBoolean = bool2;; paramBoolean = false)
    {
      ...
      bhzm.a("DeviceMsgSettingActivity", "msg:" + paramBundle.optString("msg"));
      bhzt.a().a(this.a.getString(2131718178));
      return;
    }
  }
