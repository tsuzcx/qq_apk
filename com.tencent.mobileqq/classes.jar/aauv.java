  ...
  implements IThirdAppOpenReport
{
  ...
  {
    Object localObject = afoc.a;
    if ((localObject != null) && (((afob)localObject).d == 1) && (!AppInterface.isAppOnForeground(BaseApplicationImpl.getContext())))
    {
  ...
  public void startActivityForResult(Activity paramActivity, Intent paramIntent, int paramInt, Bundle paramBundle)
  {
    ...
    avic.a(paramActivity, paramIntent, paramInt, paramBundle);
  }
}
