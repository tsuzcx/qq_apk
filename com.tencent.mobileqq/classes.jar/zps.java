...
public class zps
{
  ...
  public zps(SharedPreferences paramSharedPreferences, String paramString)
  {
  ...
  public static zps a(JSONObject paramJSONObject)
  {
    zps localzps = new zps();
    try
    {
      localzps.a = paramJSONObject.getString("name").trim();
      localzps.b = paramJSONObject.getString("ver").trim();
      localzps.c = paramJSONObject.getString("system").trim();
      localzps.d = paramJSONObject.getString("driver").trim();
      localzps.e = paramJSONObject.getString("url").trim();
      localzps.f = paramJSONObject.getString("type").trim();
      localzps.h = paramJSONObject.getString("enabled").trim();
      localzps.k = paramJSONObject.optString("previousPatch", "").trim();
      return localzps;
    }
    catch (Exception paramJSONObject)
    {
      zph.a("PatchInfo", "Parse PatchInfo from JSON exception " + paramJSONObject);
    }
    return null;
  }
  ...
  public JSONObject a()
  {
    ...
    {
      zph.a("PatchInfo", "Get JSON String failed " + localJSONException);
    }
