...
{
  public float a;
  bohi jdField_a_of_type_Bohi = new bohi(this);
  FilterDesc jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc;
  
  public bohg(FilterDesc paramFilterDesc)
  {
  ...
  public static int a(Context paramContext, List<FilterDesc> paramList, bohr parambohr, int paramInt)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    if (paramInt == 0) {
  ...
  public static void a(Context paramContext, List<FilterDesc> paramList)
  {
    ...
    QQFilterRenderManager localQQFilterRenderManager = bmvb.a(bmvb.b);
  ...
  public static boolean a(bohz parambohz, int paramInt)
  {
    if (parambohz != null)
    {
      bohz localbohz = bpjt.a().a[paramInt];
      if ((parambohz != null) && (localbohz != null) && (parambohz.b().equals(localbohz.b()))) {}
      for (boolean bool = true;; bool = false)
      {
        if (QLog.isColorLevel()) {
          QLog.d("QCombo", 2, new Object[] { "isApplying :" + parambohz + " ", Boolean.valueOf(bool) });
        }
        return bool;
      }
    }
  ...
  public static void b(List<FilterDesc> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      new bohh(bool2, bool1, localArrayList, paramBoolean).execute(new Void[0]);
      return;
      if (localFilterDesc.id == 9)
      {
        localArrayList.clear();
  ...
  public int a()
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.getResFold(bpnd.b);
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.resurl)) && (!TextUtils.isEmpty(str)) && (bpjp.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc)))
    {
      b(2);
      return 2;
    }
  ...
  public int b()
  {
    ...
    bpjp.a().a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, this.jdField_a_of_type_Bohi);
    a();
    return super.b();
  }
