...
public class albb
{
  ...
  public albb(alba paramalba)
  {
    this.jdField_a_of_type_Alba = paramalba;
  }
  
  private albd a(QQAppInterface paramQQAppInterface, String paramString)
  {
    int j = 0;
    ...
    {
      localObject1 = (aknx)paramQQAppInterface.getManager(153);
      localObject2 = ((aknx)localObject1).a(paramQQAppInterface, paramString);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          i = j;
          localObject2 = new albd();
          localObject3 = ((JSONArray)localObject3).getJSONObject(i);
          ((albd)localObject2).jdField_b_of_type_Int = ((JSONObject)localObject3).getInt("type");
          ((albd)localObject2).jdField_a_of_type_Int = ((JSONObject)localObject3).getInt("id");
          localObject3 = ((aknx)localObject1).b(paramString);
          if (localObject3 == null) {
            return null;
          }
          if ((((albd)localObject2).jdField_b_of_type_Int == 4) && (!((ApolloBaseInfo)localObject3).hasPet))
          {
            ((ApolloBaseInfo)localObject3).appearAction = null;
            ((aknx)localObject1).a((ApolloBaseInfo)localObject3);
            return null;
          }
          if (QLog.isColorLevel()) {
            QLog.d("cmshow_scripted_SpriteRscBuilder", 2, new Object[] { "[hasAppearAction] index:", Integer.valueOf(i), ",id:", Integer.valueOf(((albd)localObject2).jdField_a_of_type_Int), ",standType:", Integer.valueOf(((albd)localObject2).jdField_b_of_type_Int) });
          }
          if (((albd)localObject2).jdField_a_of_type_Int <= 0)
          {
            QLog.e("cmshow_scripted_SpriteRscBuilder", 1, new Object[] { "appearAction not correct,actionId:", Integer.valueOf(((albd)localObject2).jdField_a_of_type_Int) });
            return null;
          }
          if (!ApolloUtil.a(((albd)localObject2).jdField_a_of_type_Int, 0))
          {
            if (QLog.isColorLevel()) {
              QLog.i("cmshow_scripted_SpriteRscBuilder", 2, "hasAppearAction isActionResDone is false.");
            }
            paramString = new ApolloActionData();
            paramString.actionId = ((albd)localObject2).jdField_a_of_type_Int;
            localObject1 = ApolloUtil.a(paramString, 5);
            aldv.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), (String)localObject1);
            return null;
          }
  ...
  private SpriteTaskParam a(albd paramalbd)
  {
    ...
    do
    {
      ...
      localSpriteTaskParam.f = paramalbd.jdField_a_of_type_Int;
      localSpriteTaskParam.k = 12;
      localSpriteTaskParam.g = 5;
      localSpriteTaskParam.jdField_a_of_type_Long = 1000000L;
    } while (paramalbd.jdField_b_of_type_Int != 4);
  ...
  private String a(int paramInt)
  {
    ...
    paramInt = ((aknx)this.jdField_a_of_type_Alba.a().getManager(153)).a(paramInt);
    if ((paramInt != -1) && (!ApolloUtil.a(paramInt, 0)))
    {
      ...
      aldv.a(this.jdField_a_of_type_Alba.a(), (String)localObject, str);
    }
    for (;;)
    {
  ...
  public static String a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    return algj.a(paramInt1, paramInt2, paramInt3);
  }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Alba == null)) {
      return null;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        JSONObject localJSONObject2 = a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Alba, paramSpriteTaskParam, true, false);
        if ((this.jdField_a_of_type_Alba.jdField_a_of_type_Int == 0) || (paramSpriteTaskParam.e == 1))
        {
          localJSONObject1 = a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Alba, paramSpriteTaskParam, false, false);
          if (localJSONObject2 != null)
          {
            localJSONArray.put(localJSONObject2);
            JSONObject localJSONObject3 = a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Alba, true);
          ...
          if (localJSONObject1 != null)
          {
            ...
            paramSpriteTaskParam = a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Alba, false);
  ...
  public static JSONArray a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        aliw localaliw = (aliw)paramQQAppInterface.getManager(155);
        int i = 0;
        j = 0;
        if (j < localJSONArray2.length())
        {
          ...
          else
          {
            ...
            bool1 = ((aknx)localObject).a(paramJSONObject, 4, null);
            if (!QLog.isColorLevel()) {
              break label514;
            }
            ...
            String[] arrayOfString = algj.a(1, k, 0, true);
            ((JSONObject)localObject).put("actionId", k);
            ((JSONObject)localObject).put("actionPath", algj.a(arrayOfString[0], 3));
            if (paramJSONObject.personNum == 1) {
              ((JSONObject)localObject).put("peerPath", algj.a(algj.a(1, k, 0, false)[0], 3));
            }
  ...
  private JSONObject a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      ((SpriteTaskParam)localObject).h = this.jdField_a_of_type_Alba.jdField_a_of_type_Int;
      ((SpriteTaskParam)localObject).jdField_c_of_type_Int = 1;
      if (!a((SpriteTaskParam)localObject)) {
        return null;
      }
      localObject = ((aliw)this.jdField_a_of_type_Alba.a().getManager(155)).a(paramInt1);
      if (localObject == null) {
        return null;
      }
      localJSONObject.put("actionId", paramInt1);
      localJSONObject.put("action", algj.a(paramInt1, paramInt2, true, this.jdField_a_of_type_Alba.a())[0]);
      if (((ApolloActionData)localObject).personNum == 1) {
        localJSONObject.put("actionPeer", algj.a(paramInt1, paramInt2, false, this.jdField_a_of_type_Alba.a())[0]);
      }
      if (this.jdField_a_of_type_Alba.jdField_a_of_type_Int == 0)
      {
  ...
  private JSONObject a(String paramString, alba paramalba, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localJSONObject = b(paramString, paramalba, albi.a(paramString, paramSpriteTaskParam, paramalba, paramBoolean1));
        if (!a(paramSpriteTaskParam)) {
          return localJSONObject;
        }
        j = aknx.a(paramalba.a(), paramString);
        int k = ((Integer)algj.a(paramString, j, paramalba.a(), true)[0]).intValue();
        paramString = algj.a(paramString, paramalba.a(), true);
        ...
        if ((paramBoolean1) && (!TextUtils.isEmpty(paramSpriteTaskParam.jdField_c_of_type_JavaLangString)))
        {
          ...
          if ((j == 1) && (paramSpriteTaskParam.f > aliu.jdField_a_of_type_Int) && (aknx.a(paramalba.a())))
          {
            i = 2;
        ...
        else
        {
          ...
          paramString = algj.a(n, i1, i, paramBoolean1, j);
          if (paramString == null) {
            break label442;
          }
        ...
        if ((j != 2) || (paramSpriteTaskParam.f >= aliu.jdField_a_of_type_Int)) {
          break label433;
        }
        i = 1;
        continue;
      ...
      label323:
      if ((paramalba.jdField_a_of_type_Int == 0) && (!paramBoolean1) && (!paramBoolean2)) {
        break;
      }
      label350:
      paramalba = paramString[0];
      paramString = paramalba;
      if (8 == paramSpriteTaskParam.jdField_c_of_type_Int)
      {
        ...
        if (!TextUtils.isEmpty(paramSpriteTaskParam.jdField_d_of_type_JavaLangString))
        {
          ...
          if (!TextUtils.isEmpty(paramSpriteTaskParam)) {
            paramString = paramalba + paramSpriteTaskParam;
          }
        }
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, aljj paramaljj)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        alje.a(-1L, paramQQAppInterface, paramString, "", 0, "", paramaljj);
        return;
        i = 0;
        for (;;)
        {
      ...
      paramaljj.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 10);
      return;
      label156:
      i = 0;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, aleg paramaleg)
  {
    int i;
    if (!ApolloUtil.d(paramString))
    {
      ...
      aldv.a(paramQQAppInterface, paramString, paramaleg);
    }
    label25:
    while (paramaleg == null)
    {
      return;
      i = 0;
      break;
  ...
  private JSONArray b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localaliw = (aliw)this.jdField_a_of_type_Alba.a().getManager(155);
        i = 0;
        k = 0;
        j = -1;
      ...
      catch (Throwable paramSpriteTaskParam)
      {
        ...
        if (i != 0) {
          amqn.a(this.jdField_a_of_type_Alba.a(), 1);
        }
        return localJSONArray;
      }
      finally
  ...
  private JSONObject b(String paramString, alba paramalba, boolean paramBoolean)
  {
    try
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("uin", paramString);
      algj.a(paramString, paramalba.a(), localJSONObject);
      Object localObject = algj.a(paramString, paramalba.a(), true);
      ...
      if (((paramalba.jdField_a_of_type_Int == 1) || (paramalba.jdField_a_of_type_Int == 3000)) && (!"-1".equals(paramString)) && (!"-2".equals(paramString)))
      {
        localJSONObject.put("nameplate", a(paramalba.a(), paramString, j, paramBoolean));
        localObject = paramalba.jdField_b_of_type_JavaLangString;
        if ((TextUtils.isEmpty((CharSequence)localObject)) || (!((String)localObject).equals(paramString))) {
          break label395;
        }
      }
      label395:
      for (paramString = alud.a(2131714702);; paramString = albi.a(paramalba.a(), paramalba.jdField_a_of_type_Int, paramString, paramalba.jdField_a_of_type_JavaLangString, true))
      {
        if (!TextUtils.isEmpty(paramString)) {
          localJSONObject.put("nickname", albi.a(bdfr.encodeToString(paramString.getBytes("utf-8"), 0)));
        }
        if (this.jdField_a_of_type_Alba.jdField_a_of_type_Aksq == null) {
          break;
        }
        localJSONObject.put("scale", this.jdField_a_of_type_Alba.jdField_a_of_type_Aksq.jdField_a_of_type_Float);
        localJSONObject.put("xPos", this.jdField_a_of_type_Alba.jdField_a_of_type_Aksq.b);
        localJSONObject.put("yPos", this.jdField_a_of_type_Alba.jdField_a_of_type_Aksq.c);
        break;
      }
      return localJSONObject;
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, aljj paramaljj)
  {
    int k = 0;
    if (paramArrayOfInt == null) {}
    do
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          c(paramQQAppInterface, paramString, paramInt, paramArrayOfInt, paramaljj);
          return;
        }
        i += 1;
      }
    } while (paramaljj == null);
    paramaljj.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 10);
  }
  ...
  private JSONArray c(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_0
    //   5: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   8: ifnonnull +7 -> 15
    //   11: aconst_null
    //   12: astore_1
    //   13: aload_1
    ...
    //   26: astore 6
    //   28: aload_0
    //   29: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   32: getfield 373	alba:jdField_a_of_type_Int	I
    //   35: ifne +163 -> 198
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   43: getfield 658	alba:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   46: aload_0
    //   47: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   50: iconst_1
    //   51: invokespecial 502	albb:b	(Ljava/lang/String;Lalba;Z)Lorg/json/JSONObject;
    //   54: astore_1
    //   55: aload_0
    //   56: aload_0
    //   57: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   60: getfield 683	alba:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   63: aload_0
    //   64: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   67: iconst_0
    //   68: invokespecial 502	albb:b	(Ljava/lang/String;Lalba;Z)Lorg/json/JSONObject;
    //   71: astore 7
    //   73: aload_0
    //   74: aload_0
    //   75: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   78: getfield 658	alba:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   81: aload_0
    //   82: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   85: iconst_1
    //   86: invokevirtual 383	albb:a	(Ljava/lang/String;Lalba;Z)Lorg/json/JSONObject;
    //   89: astore 8
    //   91: aload_0
    //   92: aload_0
    //   93: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   96: getfield 683	alba:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   99: aload_0
    //   100: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   103: iconst_0
    //   104: invokevirtual 383	albb:a	(Ljava/lang/String;Lalba;Z)Lorg/json/JSONObject;
    //   107: astore 9
    //   109: aload 8
    //   111: ifnull +13 -> 124
    //   114: aload_1
    ...
    //   203: aload_0
    //   204: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   207: iconst_1
    //   208: invokespecial 502	albb:b	(Ljava/lang/String;Lalba;Z)Lorg/json/JSONObject;
    //   211: astore_1
    //   212: aload_0
    //   213: aload_0
    //   214: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   217: getfield 658	alba:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   220: aload_0
    //   221: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   224: iconst_1
    //   225: invokevirtual 383	albb:a	(Ljava/lang/String;Lalba;Z)Lorg/json/JSONObject;
    //   228: astore 7
    //   230: aload 7
    //   232: ifnull +13 -> 245
    //   235: aload_1
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, aljj paramaljj)
  {
    if ((algj.a(paramString, paramInt, paramArrayOfInt, paramQQAppInterface, new albc(paramaljj, paramQQAppInterface, paramInt, paramArrayOfInt))) && (paramaljj != null)) {
      paramaljj.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 22);
    }
  }
  ...
  public Pair<String, Integer> a(String paramString)
  {
    ...
    if ((aknx.a(this.jdField_a_of_type_Alba.a(), paramString) != 2) && (a(this.jdField_a_of_type_Alba.a(), paramString)))
    {
      localStringBuilder = new StringBuilder();
      localStringBuilder.append(this.jdField_b_of_type_Int).append("/action/action");
      SharedPreferences localSharedPreferences = this.jdField_a_of_type_Alba.a().getApp().getSharedPreferences("apollo_sp", 0);
      if (!localSharedPreferences.getBoolean("stand_type_" + this.jdField_a_of_type_Int, false)) {}
      switch (this.jdField_a_of_type_Int)
      {
      default: 
        localObject = null;
        alar localalar = albi.a(this.jdField_a_of_type_Alba.a());
        ...
        if (this.jdField_a_of_type_Alba.jdField_a_of_type_Int == 3000)
        {
          label297:
    ...
    for (i = 7;; i = 0)
    {
      ...
      break;
      i = this.jdField_a_of_type_Alba.jdField_a_of_type_Int;
      break label297;
      return localObject;
    }
  }
  ...
  public String a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Alba.jdField_a_of_type_Int == 0)
      {
        localJSONObject2 = b(this.jdField_a_of_type_Alba.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Alba, true);
        localJSONObject3 = b(this.jdField_a_of_type_Alba.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Alba, false);
        JSONObject localJSONObject4;
        if (aknx.a(this.jdField_a_of_type_Alba.a(), this.jdField_a_of_type_Alba.jdField_b_of_type_JavaLangString) != 2)
        {
          localJSONObject4 = a(this.jdField_a_of_type_Alba.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Alba, true);
          if (localJSONObject4 != null) {
            localJSONObject2.put("pet", localJSONObject4);
          }
        }
        if (aknx.a(this.jdField_a_of_type_Alba.a(), this.jdField_a_of_type_Alba.jdField_a_of_type_JavaLangString) != 2)
        {
          localJSONObject4 = a(this.jdField_a_of_type_Alba.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Alba, false);
          if (localJSONObject4 != null) {
      ...
      for (;;)
      {
        ...
        if (aknx.a(this.jdField_a_of_type_Alba.a(), this.jdField_a_of_type_Alba.jdField_b_of_type_JavaLangString) != 2)
        {
          localJSONObject3 = a(this.jdField_a_of_type_Alba.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Alba, true);
          if (localJSONObject3 != null) {
            localJSONObject2.put("pet", localJSONObject3);
          }
        }
  ...
  {
    int i = 0;
    if ((this.jdField_a_of_type_Alba == null) || (this.jdField_a_of_type_Alba.a() == null) || (TextUtils.isEmpty(paramString))) {
      return null;
    }
    ...
    localObject = (aknx)this.jdField_a_of_type_Alba.a().getManager(153);
    if (TextUtils.isEmpty(((aknx)localObject).j)) {
      return null;
    }
    for (;;)
    {
      try
      {
        JSONArray localJSONArray = new JSONArray(((aknx)localObject).j);
        ...
        if (i < j)
        {
          ...
          ((aknx)localObject).a(paramString, 4);
        }
      }
      catch (Exception paramString)
      {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Alba.e == 0)
        {
          ...
          if (!albi.a(this.jdField_a_of_type_Alba.a())) {
            break label349;
          }
          i = 1;
        ...
        else
        {
          ...
          localObject = algj.a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Alba.a());
          continue;
        }
  ...
  {
    JSONArray localJSONArray = new JSONArray();
    if ((this.jdField_a_of_type_Alba == null) || (this.jdField_a_of_type_Alba.a() == null) || (paramJSONArray == null)) {
      return localJSONArray;
    }
    StringBuilder localStringBuilder = new StringBuilder();
  ...
  public JSONObject a(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject2 = (aknx)this.jdField_a_of_type_Alba.a().getManager(153);
          ApolloActionData localApolloActionData = ((aliw)this.jdField_a_of_type_Alba.a().getManager(155)).a(paramSpriteTaskParam.f);
          ...
          if (paramSpriteTaskParam.i > 0)
          {
            ...
            aldv.a(this.jdField_a_of_type_Alba.a(), null, paramSpriteTaskParam.i, false);
            localObject1 = localObject2;
            continue;
          }
          return null;
  ...
  /* Error */
  public JSONObject a(String paramString, alba paramalba, boolean paramBoolean)
  {
    // Byte code:
    ...
    //   61: aload 13
    //   63: aload_1
    //   64: invokevirtual 109	aknx:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   67: astore 16
    //   69: aload 16
    //   71: ifnonnull +5 -> 76
    //   74: aconst_null
    ...
    //   90: istore 8
    //   92: aload 16
    //   94: invokevirtual 877	com/tencent/mobileqq/data/ApolloBaseInfo:getApolloPetDress	()Laksm;
    //   97: astore 17
    //   99: aload 17
    //   101: ifnull +988 -> 1089
    //   104: iload 5
    ...
    //   142: istore 8
    //   144: aload 17
    //   146: getfield 882	aksm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   149: ifnull +940 -> 1089
    //   152: iload 5
    //   154: istore 9
    //   156: iload 11
    ...
    //   166: istore 8
    //   168: aload 17
    //   170: getfield 882	aksm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   200: iconst_0
    //   201: aload 17
    //   203: getfield 885	aksm:jdField_a_of_type_Int	I
    //   206: invokestatic 645	algj:a	(II)Ljava/lang/String;
    ...
    //   233: iconst_1
    //   234: aload 17
    //   236: getfield 885	aksm:jdField_a_of_type_Int	I
    ...
    //   260: istore 10
    //   262: aload 17
    //   264: getfield 885	aksm:jdField_a_of_type_Int	I
    //   267: istore 4
    //   269: iload 4
    //   271: istore 9
    //   273: iload 6
    ...
    //   283: istore 8
    //   285: aload 17
    //   287: getfield 882	aksm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   311: istore 8
    //   313: aload 17
    //   315: getfield 882	aksm:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   485: iconst_1
    //   486: iload 9
    //   488: invokestatic 645	algj:a	(II)Ljava/lang/String;
    ...
    //   566: ldc_w 308
    //   569: aload 17
    //   571: getfield 885	aksm:jdField_a_of_type_Int	I
    ...
    //   586: aload_0
    //   587: aload 17
    //   589: getfield 885	aksm:jdField_a_of_type_Int	I
    //   592: ldc_w 919
    //   595: invokevirtual 921	albb:a	(ILjava/lang/String;)Ljava/lang/String;
    //   598: astore 18
    //   600: iload 5
    //   602: istore 6
    //   604: iload 5
    ...
    //   608: aload_0
    //   609: aload 17
    //   611: getfield 885	aksm:jdField_a_of_type_Int	I
    //   614: ldc_w 923
    //   617: invokevirtual 921	albb:a	(ILjava/lang/String;)Ljava/lang/String;
    //   620: astore 19
    //   622: iload 5
    //   624: istore 6
    //   626: iload 5
    ...
    //   700: aload_0
    //   701: aload 17
    //   703: getfield 885	aksm:jdField_a_of_type_Int	I
    //   706: invokespecial 928	albb:a	(I)Ljava/lang/String;
    //   709: astore 18
    //   711: iload 5
    //   713: istore 6
    //   715: iload 5
    ...
    //   804: iconst_0
    //   805: invokestatic 526	bdfr:encodeToString	([BI)Ljava/lang/String;
    //   808: invokestatic 528	albi:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   825: ldc_w 655
    //   828: aload 13
    //   830: getfield 772	aknx:j	Ljava/lang/String;
    //   833: aload 17
    //   835: getfield 885	aksm:jdField_a_of_type_Int	I
    //   838: iload_3
    //   839: invokestatic 935	albb:a	(Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    //   852: istore 7
    //   854: aload_0
    //   855: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   858: getfield 668	alba:jdField_a_of_type_Aksq	Laksq;
    //   861: ifnull +87 -> 948
    //   864: iload 5
    //   866: istore 6
    //   868: iload 5
    ...
    //   874: ldc_w 670
    //   877: aload_0
    //   878: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   881: getfield 668	alba:jdField_a_of_type_Aksq	Laksq;
    //   884: getfield 674	aksq:jdField_a_of_type_Float	F
    //   887: f2d
    ...
    //   902: ldc_w 676
    //   905: aload_0
    //   906: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   909: getfield 668	alba:jdField_a_of_type_Aksq	Laksq;
    //   912: getfield 678	aksq:b	F
    //   915: f2d
    ...
    //   930: ldc_w 680
    //   933: aload_0
    //   934: getfield 43	albb:jdField_a_of_type_Alba	Lalba;
    //   937: getfield 668	alba:jdField_a_of_type_Aksq	Laksq;
    //   940: getfield 682	aksq:c	F
    //   943: f2d
    ...
    //   959: ifnull +484 -> 1443
    //   962: aload_2
    //   963: invokevirtual 234	alba:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   966: ifnull +477 -> 1443
    //   969: ldc 242
    //   971: iconst_1
    ...
    //   1063: goto -110 -> 953
    //   1066: aload_2
    //   1067: invokevirtual 234	alba:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1070: aload_1
    //   1071: aload 13
    //   1073: invokevirtual 942	aknx:a	()Laled;
    //   1076: iload 4
    //   1078: aload 16
    //   1080: iconst_m1
    //   1081: iconst_m1
    //   1082: iconst_1
    //   1083: invokestatic 945	aldv:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Laled;I[IIIZ)V
    //   1086: aload 14
    //   1088: areturn
    //   1089: aconst_null
    //   1090: areturn
    ...
    //   1128: aload_2
    //   1129: invokevirtual 234	alba:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1223: goto -34 -> 1189
    //   1226: aload_2
    //   1227: invokevirtual 234	alba:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1230: aload_1
    //   1231: aload 13
    //   1233: invokevirtual 942	aknx:a	()Laled;
    //   1236: iload 4
    //   1238: aload 14
    //   1240: iconst_m1
    //   1241: iconst_m1
    //   1242: iconst_1
    //   1243: invokestatic 945	aldv:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Laled;I[IIIZ)V
    //   1246: aconst_null
    //   1247: areturn
    //   1248: astore 14
    //   1250: aconst_null
    ...
    //   1273: aload_2
    //   1274: invokevirtual 234	alba:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1368: goto -34 -> 1334
    //   1371: aload_2
    //   1372: invokevirtual 234	alba:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1375: aload_1
    //   1376: aload 13
    //   1378: invokevirtual 942	aknx:a	()Laled;
    //   1381: iload 4
    //   1383: aload 16
    //   1385: iconst_m1
    //   1386: iconst_m1
    //   1387: iconst_1
    //   1388: invokestatic 945	aldv:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Laled;I[IIIZ)V
    //   1391: aload 14
    //   1393: athrow
    //   1394: astore 14
    //   1396: iload 7
  ...
  public void a(List<String> paramList)
  {
    ...
    do
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        paramList = a(this.jdField_a_of_type_Alba.a(), str);
        if (str.equals(this.jdField_a_of_type_Alba.jdField_b_of_type_JavaLangString)) {}
      ...
      albi.a(this.jdField_a_of_type_Alba, (List)localObject3);
    } while (localObject1 == null);
    Object localObject2 = this.jdField_a_of_type_Alba.a().getApp().getSharedPreferences("apollo_sp", 0);
    if (!((SharedPreferences)localObject2).getBoolean("stand_type_" + ((albd)localObject1).jdField_b_of_type_Int, false)) {}
    switch (((albd)localObject1).jdField_b_of_type_Int)
    {
    default: 
      paramList = null;
      localObject3 = albi.a(this.jdField_a_of_type_Alba.a());
      if ((!TextUtils.isEmpty(paramList)) && (localObject3 != null)) {
        ((alar)localObject3).a(this.jdField_a_of_type_Alba.jdField_b_of_type_JavaLangString, paramList);
      }
      ((SharedPreferences)localObject2).edit().putBoolean("stand_type_" + ((albd)localObject1).jdField_b_of_type_Int, true).commit();
      if (this.jdField_a_of_type_Alba.jdField_a_of_type_Int != 3000) {
        break;
      }
    }
    for (int i = 2;; i = this.jdField_a_of_type_Alba.jdField_a_of_type_Int)
    {
      VipUtils.a(null, "cmshow", "Apollo", "appearanceaction", i, ((albd)localObject1).jdField_b_of_type_Int, new String[] { String.valueOf(((albd)localObject1).jdField_a_of_type_Int) });
      return;
      paramList = alud.a(2131714705);
      break;
      paramList = alud.a(2131714701);
      break;
      paramList = alud.a(2131714708);
      break;
    }
  }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Alba == null) || (this.jdField_a_of_type_Alba.a() == null)) {
      return false;
    }
    ...
    if (paramSpriteTaskParam.k == 6)
    {
      ...
      {
        aldv.a(this.jdField_a_of_type_Alba.a(), ApolloUtil.c(paramSpriteTaskParam.f) + "/d.zip", ApolloUtil.d(paramSpriteTaskParam.f));
        return false;
      }
    }
    else if (paramSpriteTaskParam.k == 12)
    {
      if (!ApolloUtil.a(paramSpriteTaskParam.f, 0))
      {
        ...
        localObject = ApolloUtil.a((ApolloActionData)localObject, 4);
        aldv.a(this.jdField_a_of_type_Alba.a(), (String)localObject, paramSpriteTaskParam);
        return false;
      }
    }
    else if ((paramSpriteTaskParam.k == 11) || (paramSpriteTaskParam.k == 7))
    {
      ...
      {
        aldv.a(this.jdField_a_of_type_Alba.a(), this.jdField_a_of_type_Alba.a().getCurrentAccountUin(), null, 0, null, -1, -1, true);
        return false;
      }
    }
    return true;
  ...
  public boolean b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    {
      Object localObject = ((albf)this.jdField_a_of_type_Alba.a().getManager(249)).a();
      if (!bool1)
      {
        if (localObject != null) {
