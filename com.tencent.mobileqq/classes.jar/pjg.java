...
public class pjg
  extends piu<Long, BaseArticleInfo>
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new pjh(this);
  private pje jdField_a_of_type_Pje = new pje();
  private int b = -1;
  
  public pjg(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    super(paramActivity, paramRecyclerViewWithHeaderFooter, paramInt);
    this.jdField_a_of_type_Pje.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, 3);
  }
  ...
  private void a(ArticleInfo paramArticleInfo)
  {
    ...
    if (localpum != null) {
      this.b = localpum.a(localArticleInfo.mArticleContentUrl, String.valueOf(localArticleInfo.innerUniqueID), localArticleInfo.mSubscribeID, 1, null);
    }
    b(localArticleInfo);
  }
  ...
  {
    if (this.jdField_a_of_type_Pje.a(paramInt))
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        return new pji(this, (View)localObject);
      }
    ...
    for (;;)
    {
      ...
      if (pjf.a(paramInt))
      {
        paramViewGroup = pjf.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt, a());
        break;
      }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    while (!pay.a(paramView.mArticleContentUrl, paramView.mChannelID, paramView)) {
      return;
    }
    a(paramView);
  }
  ...
  public void a(bjwy parambjwy, int paramInt)
  {
    ...
    {
      if (!this.jdField_a_of_type_Pje.a(i)) {
        break label160;
      }
      if (i != pir.b) {
        break label140;
    ...
    for (;;)
    {
      ...
      return;
      label140:
      this.jdField_a_of_type_Pje.a(localProteusItemView, i, localBaseArticleInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt);
      continue;
      label160:
      if (pjf.a(i)) {
        pjf.a(localProteusItemView, i, localBaseArticleInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt, a());
      } else {
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    if (localBaseArticleInfo != null)
    {
      if (!this.jdField_a_of_type_Pje.a(localBaseArticleInfo)) {
        break label42;
      }
      paramInt = this.jdField_a_of_type_Pje.a(localBaseArticleInfo);
