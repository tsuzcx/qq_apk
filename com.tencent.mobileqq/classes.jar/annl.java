  ...
  implements Manager
{
  ...
  public annl(QQAppInterface paramQQAppInterface)
  {
  ...
  private HotChatItemData a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localObject2 == null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        {
          ApolloGameData localApolloGameData = ((ancd)paramQQAppInterface.getManager(155)).a(((HotChatInfo)localObject2).name);
  ...
  private void d()
  {
    ...
    do
    {
      ...
      {
        localaong = localQQAppInterface.a().a();
        localObject2 = localaong.getRecentList(false);
  ...
  private void d(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = ((ancd)((QQAppInterface)localObject).getManager(155)).a(localHotChatItemData.mHotChatCode);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentSharedPreferences != null)
      {
        localObject1 = bgsh.a(this.jdField_a_of_type_AndroidContentSharedPreferences, "hotchat_new_unread_list", null);
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      Collections.sort((List)localObject2, new annm(this));
      Collections.sort((List)localObject1, new annn(this));
  ...
  private void g()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   4: invokevirtual 255	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   7: ifne +4 -> 11
    //   10: return
    //   11: aload_0
    //   12: invokevirtual 327	annl:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15: astore_3
    //   16: aload_3
    //   17: ifnull -7 -> 10
    //   20: aload_3
    ...
    //   29: astore 4
    //   31: aload_0
    //   32: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   56: iflt +107 -> 163
    //   59: aload_0
    //   60: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: iload_1
    ...
    //   76: invokespecial 484	annl:d	(Ljava/lang/String;)V
    //   79: aload 4
    //   81: aload_3
    ...
    //   127: aload_0
    //   128: getfield 56	annl:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   131: aload_3
    //   132: getfield 119	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   135: invokeinterface 491 2 0
    //   140: pop
    //   141: aload_0
    //   142: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   145: iload_1
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    while ((!TextUtils.isEmpty(paramMessageRecord.frienduin)) && (arkw.b((QQAppInterface)localObject, paramMessageRecord.frienduin))) {
      return;
    }
    for (;;)
    {
  ...
  public boolean a(long paramLong)
  {
    ...
    Object localObject3;
    int i;
    if (!((aong)localObject1).isRecentUserInCache(anhk.aK, 5001))
    {
    ...
    Object localObject2 = (RecentUser)((aong)localObject1).findRecentUserByUin(anhk.aK, 5001);
    ((RecentUser)localObject2).uin = anhk.aK;
  ...
  public boolean b(String paramString)
  {
    ...
    //   3: istore 4
    //   5: aload_0
    //   6: invokevirtual 327	annl:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnull +10 -> 23
    //   16: aload_1
    ...
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 56	annl:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   43: aload_1
    ...
    //   97: iload_2
    //   98: aload_0
    //   99: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   102: invokevirtual 255	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   105: if_icmpge +36 -> 141
    //   108: aload_1
    //   109: aload_0
    //   110: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   113: iload_2
    ...
    //   126: ifeq +195 -> 321
    //   129: aload_0
    //   130: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   133: iload_2
    ...
    //   151: aload 5
    //   153: aload 7
    //   155: invokespecial 698	com/tencent/mobileqq/app/HotChatCenterManager$2:<init>	(Lannl;Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/data/HotChatItemData;)V
    //   158: bipush 8
    //   160: aconst_null
    //   161: iconst_0
    ...
    //   166: aload_1
    //   167: aload 6
    //   169: invokespecial 700	annl:a	(Ljava/lang/String;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   172: iload 4
    //   174: istore_3
    //   175: aload_0
    //   176: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   179: invokevirtual 255	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   182: ifne +39 -> 221
    //   185: iload 4
    //   187: istore_3
    //   188: aload_0
    //   189: getstatic 607	anhk:aK	Ljava/lang/String;
    //   192: sipush 5001
    //   195: invokespecial 554	annl:b	(Ljava/lang/String;I)V
    //   198: iload 4
    //   200: istore_3
    //   201: aload_0
    //   202: invokevirtual 327	annl:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   205: ldc 173
    //   207: ldc 175
    //   209: ldc_w 702
    //   212: iconst_1
  ...
  public void c()
  {
    ...
    //   3: astore 4
    //   5: aload_0
    //   6: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   50: aload_0
    //   51: invokevirtual 327	annl:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: astore_2
    //   55: aload_2
    //   56: ifnull -41 -> 15
    //   59: aload_2
    ...
    //   124: astore 4
    //   126: aload_0
    //   127: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   130: aload 4
    ...
    //   161: return
    //   162: aload_0
    //   163: invokespecial 691	annl:f	()V
    //   166: aload_0
    //   167: getfield 56	annl:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   198: astore_3
    //   199: aload_0
    //   200: getfield 56	annl:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   203: aload_3
    ...
    //   231: athrow
    //   232: aload_0
    //   233: invokespecial 716	annl:g	()V
    ...
    //   258: aload_0
    //   259: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   274: aload_0
    //   275: getfield 45	annl:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
