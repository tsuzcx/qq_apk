...
public class axtn
{
  ...
  public axtn(AppInterface paramAppInterface, axtp paramaxtp, String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2)
  {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_JavaIoRandomAccessFile == null) {
      try
      {
        ...
        if (this.jdField_a_of_type_JavaIoRandomAccessFile == null)
        {
          ...
          this.jdField_a_of_type_Axtp.b(this.jdField_b_of_type_Int, this.d);
          return false;
        }
      }
    ...
    axto localaxto = new axto(this);
    this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_b_of_type_JavaLangString, 53, this.jdField_a_of_type_JavaLangString, 0, this.jdField_a_of_type_ArrayOfByte, localaxto, (byte[])localObject, false);
