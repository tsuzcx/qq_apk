...
{
  private static axtn jdField_a_of_type_Axtn;
  private ConcurrentLinkedQueue<axtp> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue;
  ...
  public static axtn a()
  {
    if (jdField_a_of_type_Axtn != null) {
      return jdField_a_of_type_Axtn;
    }
    try
    {
      if (jdField_a_of_type_Axtn == null) {
        jdField_a_of_type_Axtn = new axtn();
      }
      axtn localaxtn = jdField_a_of_type_Axtn;
      return localaxtn;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext, MonitorHttpInfo paramMonitorHttpInfo, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      axrl.a(paramContext).a(null, "MonitorApkDownload", true, 0L, 0L, localHashMap, "");
      label231:
      if (!QLog.isColorLevel()) {
        break label348;
      }
    ...
    for (paramContext = "MonitorApkDownload{";; paramContext = "UnMonitorApkDownload{")
    {
      ...
      axrl.a(paramContext).a(null, "UnMonitorApkDownload", true, 0L, 0L, localHashMap, "");
      break label231;
      break;
    }
  ...
  private void b(MonitorHttpInfo paramMonitorHttpInfo, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue != null)
    {
      ...
      while (i < m)
      {
        ...
        if ((localObject instanceof axtp))
        {
          localObject = (axtp)localObject;
          int k = 0;
          try
          {
            j = a(str, ((axtp)localObject).a());
            if (QLog.isColorLevel()) {
              QLog.d("NetworkMonitor", 2, new Object[] { "url=", str, " bean's url=", ((axtp)localObject).a(), " lcs length=", Integer.valueOf(j) });
            }
            if (j < 10) {
              break label258;
            }
  ...
  public void a(String paramString)
  {
    ...
    axtp localaxtp = new axtp(this, paramString);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(localaxtp);
    if (QLog.isColorLevel()) {
    ...
    {
      paramString = (axtp)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.peek();
      if ((paramString == null) || (paramString.a - localaxtp.a <= 600000L)) {
        break;
      }
  ...
  public void addDownloadURL(String paramString)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      QIPCClientHelper.getInstance().callServer("NetworkMonitorIPCModule", "ACTION_REPORT_DOWNLOAD_URL", localBundle, new axto(this));
      return;
    }
    a(paramString);
  }
