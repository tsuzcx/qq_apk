...
{
  public jpo(SmallScreenVideoController paramSmallScreenVideoController) {}
  ...
  public void h()
  {
    ...
    {
      return;
      localView = this.a.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.b.findViewById(2131366231);
      if (localView == null)
      {
      ...
      localView.findViewById(2131366232).startAnimation((Animation)localObject);
      int i;
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().y) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().z))
      {
        ((TextView)localView.findViewById(2131366233)).setText(2131429662);
        i = 1;
      }
      for (;;)
      {
        ...
        ((TextView)localView.findViewById(2131366233)).setTextSize(1, 8.0F);
        return;
        if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().y)
        {
          ((TextView)localView.findViewById(2131366233)).setText(2131429660);
          i = 0;
        }
        else
        {
          ((TextView)localView.findViewById(2131366233)).setText(2131429661);
          i = 1;
        }
      }
    }
