  ...
  implements aovi
{
  ...
  public aovm(short paramShort, byte paramByte)
  {
  ...
  public long a(int paramInt)
  {
    ...
    return ((aovn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Long;
  }
  ...
  public android.graphics.Bitmap a(int paramInt)
  {
    ...
    //   17: iload_1
    //   18: aload_0
    //   19: getfield 166	aovm:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 166	aovm:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   43: iload_1
    //   44: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   47: checkcast 178	aovn
    //   50: astore 8
    //   52: aload 7
    //   54: astore 5
    //   56: aload 8
    //   58: getfield 189	aovn:jdField_a_of_type_Byte	B
    //   61: istore_2
    //   62: aload 4
    //   64: astore 5
    //   66: iload_2
    ...
    //   96: astore 5
    //   98: aload 8
    //   100: getfield 192	aovn:b	Ljava/lang/String;
    //   103: invokestatic 197	bcwc:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   106: astore 4
    //   108: aload 4
    //   110: areturn
    //   111: aload 7
    //   113: astore 5
    //   115: aload_0
    //   116: getfield 166	aovm:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   119: iload_1
    //   120: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   123: checkcast 178	aovn
    //   126: getfield 200	aovn:jdField_a_of_type_ArrayOfByte	[B
    //   129: astore 9
    //   131: aload 7
    //   133: astore 5
    //   135: aload_0
    //   136: getfield 166	aovm:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   139: iload_1
    //   140: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   143: checkcast 178	aovn
    //   146: getfield 203	aovn:c	Ljava/lang/String;
    //   149: astore 10
    //   151: aload 10
    //   153: ifnull +47 -> 200
    //   156: aload 7
    //   158: astore 5
    //   160: aload_0
    //   161: getfield 204	aovm:jdField_a_of_type_Byte	B
    //   164: iconst_1
    //   165: if_icmpne +35 -> 200
    //   168: aload 7
    //   170: astore 5
    //   172: aload_0
    //   173: invokevirtual 206	aovm:a	()Z
    //   176: ifne +24 -> 200
    //   179: aload 7
    //   181: astore 5
    //   183: aload_0
    //   184: invokevirtual 208	aovm:b	()Z
    //   187: ifne +13 -> 200
    //   190: aload 7
    //   192: astore 5
    //   194: aload 10
    //   196: invokestatic 197	bcwc:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   199: areturn
    //   200: aload 10
    //   202: ifnull +94 -> 296
    //   205: aload 7
    //   207: astore 5
    //   209: aload_0
    //   210: getfield 204	aovm:jdField_a_of_type_Byte	B
    //   213: ifne +83 -> 296
    //   216: aload 7
    //   218: astore 5
    ...
    //   237: astore 5
    //   239: aload 10
    //   241: invokestatic 197	bcwc:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   244: astore 4
    //   246: aload 4
    //   248: ifnonnull +261 -> 509
    //   251: aload 8
    //   253: getfield 209	aovn:jdField_a_of_type_Boolean	Z
    //   256: ifeq +253 -> 509
    //   259: aload 8
    //   261: iconst_0
    //   262: putfield 209	aovn:jdField_a_of_type_Boolean	Z
    //   265: aload_0
    //   266: aload 8
    //   268: getfield 192	aovn:b	Ljava/lang/String;
    //   271: invokevirtual 211	aovm:c	(Ljava/lang/String;)V
    //   274: aload 4
    //   276: areturn
    //   277: aload 7
    //   279: astore 5
    //   281: aload_0
    //   282: aload 8
    //   284: getfield 192	aovn:b	Ljava/lang/String;
    //   287: invokevirtual 211	aovm:c	(Ljava/lang/String;)V
    //   290: aconst_null
    //   291: astore 4
    //   293: goto -19 -> 274
    //   296: aload 7
    ...
    //   310: astore 5
    //   312: aload_0
    //   313: getfield 204	aovm:jdField_a_of_type_Byte	B
    //   316: iconst_2
    ...
    //   347: astore 5
    //   349: aload 10
    //   351: invokestatic 197	bcwc:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   354: astore 4
    //   356: aload 4
    //   358: astore 5
    //   360: aload 4
    ...
    //   369: aload_0
    //   370: aload 8
    //   372: getfield 192	aovn:b	Ljava/lang/String;
    //   375: invokevirtual 211	aovm:c	(Ljava/lang/String;)V
    //   378: aload 4
    //   380: areturn
    //   381: astore 6
    //   383: aload 5
  ...
  public aovn a(long paramLong, String paramString1, byte paramByte, String paramString2, String paramString3, String paramString4, String paramString5, short paramShort, String paramString6)
  {
    aovn localaovn = new aovn(this);
    localaovn.jdField_a_of_type_Long = paramLong;
    localaovn.jdField_a_of_type_JavaLangString = paramString1;
    localaovn.b = paramString2;
    localaovn.d = paramString3;
    localaovn.jdField_a_of_type_Byte = paramByte;
    localaovn.c = paramString4;
    localaovn.e = paramString5;
    localaovn.jdField_a_of_type_Short = paramShort;
    localaovn.f = paramString6;
    localaovn.jdField_a_of_type_Int = 0;
    return localaovn;
  }
  
  public aovn a(long paramLong, String paramString1, byte paramByte, String paramString2, byte[] paramArrayOfByte, String paramString3)
  {
    aovn localaovn = new aovn(this);
    localaovn.jdField_a_of_type_Long = paramLong;
    localaovn.jdField_a_of_type_JavaLangString = paramString1;
    localaovn.b = paramString2;
    localaovn.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    localaovn.d = paramString3;
    localaovn.jdField_a_of_type_Byte = paramByte;
    localaovn.jdField_a_of_type_Int = 0;
    return localaovn;
  ...
  public aovn a(long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, short paramShort)
  {
    return a(paramLong, paramString1, (byte)3, paramString2, paramString3, paramString4, paramString5, paramShort, "");
  }
  
  public aovn a(long paramLong, String paramString1, String paramString2, byte[] paramArrayOfByte, String paramString3)
  {
  ...
  public String a(int paramInt)
  {
    ...
    return ((aovn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).e;
  }
      ...
      if (!paramString.startsWith("/"))
      {
        ...
        if ((paramString.startsWith("http://")) && (!paramString.endsWith(".png")))
        {
          if (this.jdField_a_of_type_Byte == 6) {
            str = paramString + "_" + aofs.b + "_" + aofs.jdField_a_of_type_Byte + ".png";
          } else if (this.jdField_a_of_type_Byte == 0) {
            str = paramString + "_" + (aofs.jdField_a_of_type_Byte - 2) + ".png";
          } else if ((this.jdField_a_of_type_Byte == 1) && (paramString.contains("[]"))) {
            str = paramString.replace("[]", bdcb.g() + "x" + bdcb.h());
          } else {
            str = paramString + "_" + aofs.jdField_a_of_type_Byte + ".png";
          }
        }
        else
        {
  ...
  public short a(int paramInt)
  {
    ...
    return ((aovn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Short;
  }
    ...
    if (j > 0)
    {
      ...
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Byte == 2) {
          localaovn.b(paramDataInputStream);
        }
        for (;;)
        {
          a(localaovn);
          i += 1;
          break;
          localaovn.a(paramDataInputStream);
        }
      }
    }
  }
  ...
  public void a(DataOutputStream paramDataOutputStream)
  {
    ...
    if (i < j)
    {
      localaovn = (aovn)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Byte != 2) {
        break label117;
      }
      localaovn.b(paramDataOutputStream);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label117:
      localaovn.a(paramDataOutputStream);
    }
  }
  ...
  public void a(String paramString, byte[] arg2)
  {
    ...
    {
      ArrayList localArrayList = aofs.a();
      int i = 0;
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        aovn localaovn = (aovn)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (paramString.startsWith(localaovn.b))
        {
          if (this.jdField_a_of_type_Byte == 1)
          {
            localaovn.c = (BaseApplication.getContext().getFilesDir().getAbsolutePath() + "/" + "flashlogo.png");
            a(???, localaovn.c, this.b);
            if (localArrayList == null) {
              break;
            }
            ??? = localArrayList.iterator();
            while (???.hasNext()) {
              ((aoft)???.next()).a(true, this.jdField_a_of_type_Short, i, paramString);
            }
          }
          if (this.jdField_a_of_type_Byte == 0)
          {
            a(???, String.valueOf(localaovn.f));
            try
            {
              ??? = new File(localaovn.c);
              if (!MD5.getFileMD5(???).equalsIgnoreCase(localaovn.f))
              {
                ???.delete();
                if (localaovn.jdField_a_of_type_Int < 1)
                {
                  localaovn.jdField_a_of_type_Int += 1;
                  c(localaovn.b);
                }
              }
              if (localArrayList == null) {
          ...
          for (;;)
          {
            try
            {
              ...
              if (!paramString.equalsIgnoreCase(localaovn.f))
              {
                ???.delete();
                if (localaovn.jdField_a_of_type_Int >= 1) {
                  break label517;
              ...
              QLog.d("PicAndAdConf", 2, "handle download NearbyBanner image, cid = " + localaovn.jdField_a_of_type_Long + ", md5 is " + paramString.equalsIgnoreCase(localaovn.f));
              return;
            }
            ...
            QLog.d("PicAndAdConf", 2, "handleImgData exception, item md5 = " + localaovn.f, paramString);
            return;
            label517:
            synchronized (this.jdField_a_of_type_JavaUtilHashMap)
            {
              this.jdField_a_of_type_JavaUtilHashMap.put(localaovn.b, Long.valueOf(System.currentTimeMillis()));
            }
          }
        }
        i += 1;
  ...
  public boolean a(bdlo parambdlo1, bdlo parambdlo2, int paramInt)
  {
    if (paramInt == 3)
    {
      parambdlo2 = parambdlo2.a("Content-Type");
      parambdlo1 = null;
      if (parambdlo2 != null) {
        parambdlo1 = parambdlo2.toLowerCase();
      }
      if ((parambdlo1 != null) && (parambdlo1.indexOf("image") != -1)) {
        return true;
      }
    }
    return false;
  ...
  public String b(int paramInt)
  {
    ...
    return ((aovn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).f;
  }
  ...
  public void b(bdlo parambdlo1, bdlo parambdlo2)
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      parambdlo2 = (aovn)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (parambdlo1.a().startsWith(parambdlo2.b))
      {
        parambdlo2 = aofs.a();
        if (parambdlo2 == null) {
          break;
        }
        parambdlo2 = parambdlo2.iterator();
        while (parambdlo2.hasNext()) {
          ((aoft)parambdlo2.next()).a(false, this.jdField_a_of_type_Short, i, parambdlo1.a());
        }
      }
      i += 1;
    }
  ...
  public String c(int paramInt)
  {
    ...
    return ((aovn)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).d;
  }
  ...
  public void c(String paramString)
  {
    ...
    ((HttpCommunicator)???).a(new bdlo(paramString, null, this, true));
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Byte == 2)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if (localaovn.c != null)
        {
          File localFile = new File(localaovn.c);
        ...
        for (;;)
        {
          ...
          break;
          label92:
          localStringBuilder.append(" | ").append(localaovn.jdField_a_of_type_Long);
          ThreadManager.post(new PicAndAdConf.1(this, localaovn), 5, null, false);
        }
      }
      if (QLog.isColorLevel()) {
