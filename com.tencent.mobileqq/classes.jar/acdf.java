...
{
  public acdf(SoundAndVibrateActivity paramSoundAndVibrateActivity) {}
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (k == 2131230720)
      {
        SoundAndVibrateActivity.b(this.a).setRightIcon(this.a.getResources().getDrawable(2130849562));
        ...
        if (AppSetting.d)
        {
          SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131719694) + this.a.getString(2131690799));
          SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131719695) + this.a.getString(2131720637));
          SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131719696) + this.a.getString(2131720637));
          SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131719697) + this.a.getString(2131720637));
        }
        if (this.a.app.a() != 0) {
          break label1288;
        }
    ...
    for (int i = 1;; i = 0)
    {
      axqw.b(paramCompoundButton, "CliOper", "", "", "Setting_tab", "Clk_notice_sound", 0, i, "", "", "", "");
      return;
      if (k == 2131230721)
      {
        SoundAndVibrateActivity.b(this.a).setRightIcon(null);
        SoundAndVibrateActivity.c(this.a).setRightIcon(this.a.getResources().getDrawable(2130849562));
        SoundAndVibrateActivity.d(this.a).setRightIcon(null);
        SoundAndVibrateActivity.e(this.a).setRightIcon(null);
        ...
        SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131719694) + this.a.getString(2131720637));
        SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131719695) + this.a.getString(2131690799));
        SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131719696) + this.a.getString(2131720637));
        SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131719697) + this.a.getString(2131720637));
        break;
      }
      if (k == SoundAndVibrateActivity.jdField_a_of_type_Int)
      {
        SoundAndVibrateActivity.b(this.a).setRightIcon(null);
        SoundAndVibrateActivity.c(this.a).setRightIcon(null);
        SoundAndVibrateActivity.d(this.a).setRightIcon(this.a.getResources().getDrawable(2130849562));
        SoundAndVibrateActivity.e(this.a).setRightIcon(null);
        ...
        SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131719694) + this.a.getString(2131720637));
        SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131719695) + this.a.getString(2131720637));
        SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131719696) + this.a.getString(2131690799));
        SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131719697) + this.a.getString(2131720637));
        break;
      }
      ...
      SoundAndVibrateActivity.c(this.a).setRightIcon(null);
      SoundAndVibrateActivity.d(this.a).setRightIcon(null);
      SoundAndVibrateActivity.e(this.a).setRightIcon(this.a.getResources().getDrawable(2130849562));
      ...
      SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131719695) + this.a.getString(2131720637));
      SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131719696) + this.a.getString(2131720637));
      SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131719697) + this.a.getString(2131690799));
      break;
