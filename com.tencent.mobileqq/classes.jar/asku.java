...
public class asku
  extends ajtb
{
  public asku(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (paramOIDBSSOPkg.get_decrypt_key_rsp.has())
        {
          ...
          if (((oidb_cmd0xcde.GetDecryptKeyRsp)localObject).dncrypt_key.has())
          {
            ...
            aslg.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localObject);
    ...
    try
    {
      ...
      if (paramOIDBSSOPkg.query_state_rsp.has())
      {
        ...
        if (paramOIDBSSOPkg.state.has())
        {
          ...
          ((asmb)localObject).a(i);
          if (i == 2)
          {
            if (paramOIDBSSOPkg.token.has()) {
              ((asmb)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.encrypt_key.has()) {
              ((asmb)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.user_data.has()) {
              ((asmb)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
            }
            if (paramOIDBSSOPkg.biz_type.has()) {
              ((asmb)localObject).b(paramOIDBSSOPkg.biz_type.get());
            }
          }
        }
        notifyUI(4, true, ((asmb)localObject).a());
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      ...
      try
      {
        ...
        if (paramOIDBSSOPkg.get_encrypt_key_rsp.has())
        {
          ...
          if (paramOIDBSSOPkg.file_meta.has())
          {
            ...
            aslg.jdField_a_of_type_JavaLangString = paramOIDBSSOPkg;
            if (QLog.isDevelopLevel()) {
  ...
  private void e(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if ((i == 0) && (paramOIDBSSOPkg.bytes_bodybuffer.has()) && (paramOIDBSSOPkg.bytes_bodybuffer.get() != null))
    {
      ...
      try
      {
        ...
        {
          localObject = new aslr();
          paramOIDBSSOPkg = (oidb_cmd0xcdd.ConfirmQrRsp)paramOIDBSSOPkg.confirm_qr_rsp.get();
          if (paramOIDBSSOPkg.token.has()) {
            ((aslr)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((aslr)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((aslr)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((aslr)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((aslr)localObject).a();
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (paramOIDBSSOPkg.get_qr_rsp.has())
        {
          ...
          if (paramOIDBSSOPkg.qr_sig.has()) {
            ((aslv)localObject).a(paramOIDBSSOPkg.qr_sig.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.token.has()) {
            ((aslv)localObject).b(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((aslv)localObject).c(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((aslv)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((aslv)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((aslv)localObject).a();
          if (QLog.isColorLevel()) {
            QLog.d("MsgBackup.MsgBackupAuthHandler", 2, "processGetQrRsp getQrResponse= " + paramOIDBSSOPkg);
          }
          asog.a();
  ...
  public MsgBackupUserData a(oidb_cmd0xcdd.UserData paramUserData)
  {
    ...
    if (paramUserData.ip.has()) {
      localasmf.a(paramUserData.ip.get().toStringUtf8());
    }
    if (paramUserData.port.has()) {
      localasmf.a(paramUserData.port.get());
    }
    if (paramUserData.ssid.has()) {
      localasmf.b(paramUserData.ssid.get().toStringUtf8());
    }
    if (paramUserData.bssid.has()) {
      localasmf.c(paramUserData.bssid.get().toStringUtf8());
    }
    return localasmf.a();
  }
