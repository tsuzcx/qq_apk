...
public class axms
{
  ...
  public void a(axmt paramaxmt)
  {
    this.jdField_a_of_type_Long = paramaxmt.jdField_a_of_type_Long;
    this.jdField_b_of_type_Long = paramaxmt.jdField_b_of_type_Long;
    this.jdField_a_of_type_Float = paramaxmt.jdField_a_of_type_Float;
    this.jdField_c_of_type_Long = paramaxmt.jdField_c_of_type_Long;
    this.jdField_d_of_type_Long = paramaxmt.jdField_d_of_type_Long;
    this.e = paramaxmt.e;
    this.f = paramaxmt.f;
    this.g = paramaxmt.g;
    this.h = paramaxmt.h;
    this.jdField_a_of_type_Boolean = paramaxmt.jdField_b_of_type_Boolean;
    this.i = paramaxmt.i;
    this.jdField_c_of_type_JavaLangString = paramaxmt.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramaxmt.jdField_b_of_type_JavaLangString;
    this.jdField_d_of_type_JavaLangString = paramaxmt.jdField_c_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = paramaxmt.jdField_a_of_type_Boolean;
  }
  ...
  public boolean a()
  {
    ...
    {
      return bool;
      if ((!axma.c(this.jdField_a_of_type_Long)) && (this.jdField_a_of_type_Long != 7L)) {
        break;
      }
    ...
    while (!axma.a(this.jdField_d_of_type_Long * 1000L)) {
      return false;
    }
    return true;
  }
