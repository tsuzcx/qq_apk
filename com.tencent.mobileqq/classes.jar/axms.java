  ...
  implements befm
{
  ...
  public void a(String paramString)
  {
    ...
    boolean bool1 = axmp.a(axmp.a(paramString, "isNew"));
    boolean bool2 = axmp.a(axmp.a(paramString, "isInsert"));
    axmp.a(paramString, "title");
    axmp.a(axmp.a(paramString, "startDate")).longValue();
    axmp.a(axmp.a(paramString, "endDate")).longValue();
    if (bool1)
    {
      paramString = "0";
      if (!bool2) {
    ...
    for (String str = "0";; str = "1")
    {
      ...
      azqs.b(null, "CliOper", "", "", "Time_reminder", "Updata_clock", 0, 0, str, paramString, "", "");
      return;
      paramString = "1";
      break;
    }
  ...
  {
    long l = axmp.a(axmp.a(paramString, "currentDate")).longValue();
    axmp.a(this.jdField_a_of_type_AndroidAppActivity, l * 1000L, new axmt(this), paramJsBridgeListener);
  }
  ...
  public void b(String paramString)
  {
    ...
    catch (Exception localException1)
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "startTime : " + axmu.a(1000L * l2) + " endTime : " + axmu.a(1000L * l3));
        }
        i = axmp.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject2, 1000L * l2, 1000L * l3, str1, str2, paramString);
      ...
      azqs.b(null, "CliOper", "", "", "Time_reminder", "Rec_ckl_add", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (("calendar".equals(paramString2)) && ("remindDelete".equals(paramString3)))
    {
      ...
      azqs.b(null, "CliOper", "", "", "Time_reminder", "Delete_clock", 0, 0, "", "", "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindMsgReport".equals(paramString3)))
    {
      ...
      azqs.b(null, "CliOper", "", "", "Time_reminder", "Obj_clock", 0, 0, axmp.a(paramVarArgs[0], "entranceType"), axmp.a(paramVarArgs[0], "role"), "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindAioReport".equals(paramString3)))
    {
      ...
      azqs.b(null, "CliOper", "", "", "Time_reminder", "Clock_card_clk", 0, 0, "", "", "", "");
      return true;
    }
    return false;
  }
