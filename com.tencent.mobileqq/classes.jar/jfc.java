  ...
  extends BroadcastReceiver
{
  ...
  jfc(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
            ...
            do
            {
              do
              {
                do
                {
                        ...
                        do
                        {
                          do
                          {
                            ...
                            do
                            {
                                  ...
                                  do
                                  {
                                    do
                                    {
                                      ...
                                      do
                                      {
                                        do
                                        {
                                          do
                                          {
                                            do
                                            {
                                              ...
                                              QLog.d(jfb.a, 2, " onReceive: " + paramIntent.getAction());
                                              return;
                                              if (QLog.isColorLevel()) {
                                                QLog.w(jfb.a, 1, "GAudioMsgReceiver_onReceive[" + paramIntent.getAction() + "]");
                                              }
                                              ...
                                              if (QLog.isColorLevel()) {
                                                QLog.d(jfb.a, 2, "GAudioMsgReceiver type: " + i);
                                              }
                                              if (i != 26) {
                                                break;
                                              }
                                          ...
                                          QLog.d(jfb.a, 2, "GAudioMsgReceiver TYPE_GAUDIO_AUDIO_C2S_ACK UnsatisfiedLinkError!");
                                          return;
                                          if (i == 24)
                                          {
                                        ...
                                        QLog.e(jfb.a, 2, "GAudioMsgReceiver-->uinlist is null");
                                        return;
                                        str1 = paramIntent[0];
                                        str2 = this.a.getCurrentAccountUin();
                                        if (QLog.isColorLevel()) {
                                          QLog.d(jfb.a, 2, "TYPE_GAUDIO_MEMBER_KICKOUT-->discuss id = " + l1 + ", cmdUin = " + (String)localObject + ", outUin = " + str1 + ", selfUin = " + str2 + ", uinList.size = " + paramIntent.length);
                                        }
                              ...
                              if (QLog.isColorLevel()) {
                                QLog.w(jfb.a, 1, "GAudioMsgReceiver_onReceive[tencent.video.q2v.GroupSystemMsg], type[" + i + "], relationType[" + j + "], relationId[" + l1 + "], userUin[" + l2 + "], needSendCmd[" + bool + "]");
                              }
                              if (i != 7) {
                                break label1557;
                              }
                            ...
                            {
                              if (QLog.isColorLevel()) {
                                QLog.d(jfb.a, 2, "ACTION_SELECT_MEMBER");
                              }
                              localObject = (ArrayList)paramIntent.getExtras().getSerializable("SelectMemberList");
                              if ((localObject == null) || (((ArrayList)localObject).size() == 0)) {
                                if (QLog.isColorLevel()) {
                                  QLog.d(jfb.a, 2, "VideoConstants.ACTION_SELECT_MEMBER --> no pstn member");
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (QLog.isColorLevel()) {
                                  QLog.d(jfb.a, 2, "ACTION_SELECT_MEMBER --> InviteCount = " + i + " , FirstName = " + paramIntent);
                                }
                  ...
                  QLog.d(jfb.a, 2, "[random room owner] ACTION_RANDOM_MULTI_OWNER_ONLINE_PUSH");
                  return;
                } while (paramContext.a() != null);
                AVLog.e(jfb.a, "ACTION_RANDOM_MULTI_OWNER_ONLINE_PUSH videoController.getSessionInfo() == null");
                return;
              ...
              AVLog.e(jfb.a, "ACTION_RANDOM_1V1_ONLINE_PUSH videoController.getSessionInfo() == null");
              return;
              ...
              if ((paramContext != null) && (paramContext.a() != null))
              {
                ...
                QLog.d(jfb.a, 2, "ACTION_AUDIO_TRANS_PUSH rsptype=" + i + "|" + paramContext.length);
                ((AudioTransClientInterfaceHandler)this.a.a(0)).a(i, paramContext);
                return;
              }
            } while (paramContext.a() != null);
            AVLog.e(jfb.a, " ACTION_AUDIO_TRANS_PUSH videoController.getSessionInfo() == null");
            return;
        ...
        AVLog.e(jfb.a, "ACTION_AV_REPORT_PUSH videoController.getSessionInfo() == null");
        return;
      ...
      QLog.d(jfb.a, 1, "ACTION_OPPOSITE_AUDIO_ENGINE_READY:" + l1 + "|" + l2);
    } while ((l1 == 0L) || (l2 == 0L));
    label1557:
    label1571:
    label2224:
