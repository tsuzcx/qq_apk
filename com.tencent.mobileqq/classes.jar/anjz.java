  ...
  extends ankh
{
  ...
  public static TipsBar a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    String str = (String)bfyz.a(paramContext, paramQQAppInterface.getAccount(), "phone_unity_banner_tips", "");
    ...
    localTipsBar.setOriginalOnClickListener(new anka(paramContext, paramQQAppInterface));
    bcef.b(paramQQAppInterface, "dc00898", "", "", "0X800B3E9", "0X800B3E9", 0, 0, "", "", "", "");
    return localTipsBar;
  }
  ...
  private void b(Context paramContext)
  {
    ...
    //   19: astore_2
    //   20: aload_0
    //   21: getfield 122	anjz:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   24: astore_1
    //   25: aload_1
    //   26: ifnull +24 -> 50
    //   29: ldc 30
    ...
    //   37: aload_2
    //   38: aload_0
    //   39: getfield 122	anjz:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   42: invokevirtual 127	android/content/Context:unregisterReceiver	(Landroid/content/BroadcastReceiver;)V
    //   45: aload_0
    //   46: aconst_null
    //   47: putfield 122	anjz:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   50: aload_0
    //   51: monitorexit
    //   52: return
    //   53: astore_1
  ...
  {
    if ((ankj.a(this.jdField_a_of_type_AndroidAppDialog)) && (!(paramActivity instanceof PhoneUnityBindInfoActivity)))
    {
      boolean bool = ankj.a(this.jdField_a_of_type_AndroidAppDialog, paramActivity);
  ...
  void a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null)
      {
        ...
        this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ankg(null);
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    //   60: invokevirtual 272	anjz:a	(Landroid/content/Context;)V
    //   63: goto -39 -> 24
    //   66: astore_1
    //   67: aload_0
    //   68: monitorexit
  ...
  void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    try
    {
      ...
      bfyz.a(paramContext, paramQQAppInterface, true, "phone_unity_banner_tips", "");
      bfyz.a(paramContext, paramQQAppInterface, true, "phone_unity_banner_tips_need_show", Boolean.valueOf(false));
      return;
    }
    finally
    {
  ...
  void a(QQAppInterface paramQQAppInterface, cmd0x9ae.RspBody paramRspBody)
  {
    ...
    bfyz.a((Context)localObject2, str6, true, "phone_unity_jwt", str4);
    boolean bool2 = ankj.a(this.jdField_a_of_type_AndroidAppDialog);
    if (!bool1)
    {
    ...
    if (bool2)
    {
      if ((ankj.a(this.jdField_a_of_type_AndroidAppDialog, (Activity)localObject2)) || (c())) {}
      for (int i = 1; i != 0; i = 0)
      {
    ...
    bfyz.a((Context)localObject2, str6, true, "phone_unity_banner_tips", paramRspBody);
    bfyz.a((Context)localObject2, str6, true, "phone_unity_banner_tips_need_show", Boolean.valueOf(true));
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    try
    {
      if (ankj.a(this.jdField_a_of_type_AndroidAppDialog)) {
      ...
      bool = ankj.a(paramString1);
    }
    finally {}
    boolean bool;
    this.jdField_a_of_type_AndroidAppDialog = ankj.a(localBaseActivity, paramString2, paramString3, paramString4, paramString5, false, new ankc(this, bool, localBaseActivity, paramQQAppInterface), new ankd(this, paramActivity, bool, paramQQAppInterface));
    this.jdField_a_of_type_AndroidAppDialog.show();
    this.jdField_a_of_type_AndroidAppDialog.setOnDismissListener(new anke(this));
    this.jdField_a_of_type_AndroidAppDialog.setOnCancelListener(new ankf(this));
    if (bool) {}
  ...
  boolean a()
  {
    ...
    if (ankj.a(this.jdField_a_of_type_AndroidAppDialog))
    {
      ...
      bool1 = ankj.a(this.jdField_a_of_type_AndroidAppDialog, BaseActivity.sTopActivity);
    ...
    boolean bool2 = ankj.a((String)bfyz.a(BaseApplicationImpl.getContext(), (String)localObject, "phone_unity_jwt", ""), NetConnInfoCenter.getServerTime());
    if (bool2) {
  ...
  boolean b()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: invokevirtual 150	anjz:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnonnull +7 -> 17
    //   13: aload_0
    ...
    //   33: invokestatic 51	bfyz:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
  ...
  void d()
  {
    ...
    bbon.c(localQQAppInterface, new ankb(this, localQQAppInterface));
  }
}
