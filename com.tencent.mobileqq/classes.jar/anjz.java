  ...
  implements anka
{
  ...
  {
    bgyk localbgyk = paramQzoneCommonIntent.getRequest();
    Object localObject2 = localbgyk.uniKey();
    int i = localbgyk.a();
    ...
    if (!paramFromServiceMsg.isSuccess())
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("QzoneCommonIntent", 2, String.format("cmd :%s, success:%b,code:%d, msg:%s", new Object[] { localbgyk.getCmdString(), Boolean.valueOf(QzoneCommonIntent.succeeded(arrayOfInt[0])), Integer.valueOf(arrayOfInt[0]), arrayOfString[0] }));
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (arrayOfInt[0] != 1000006) {
        QzoneCommonIntent.access$000(localbgyk, arrayOfInt[0], arrayOfString[0]);
      }
      return;
      paramFromServiceMsg = bhoz.a(paramFromServiceMsg.getWupBuffer(), (String)localObject2, arrayOfInt, arrayOfString);
      break;
    }
  }
}
