...
public class sli
{
  public static final String a = anhk.cD;
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    {
      String str = bisz.a(paramString1 + System.currentTimeMillis());
      StringBuilder localStringBuilder = new StringBuilder(a());
  ...
  public static boolean a(slj paramslj)
  {
    if (paramslj == null) {}
    long l;
    do
    {
      do
      {
        ...
        {
          return false;
          if (a(paramslj.a, paramslj.jdField_b_of_type_Int))
          {
            if (QLog.isColorLevel()) {
          ...
          if ((paramslj.d >= a()) && (paramslj.d <= b())) {
            break;
          }
        } while (!QLog.isColorLevel());
        QLog.d("VideoConvertUtils", 2, "needCompress(): false! fileSize not match, size=" + paramslj.d);
        return false;
        if (a()) {
          break;
        }
      ...
      return false;
      l = a(paramslj.a, paramslj.jdField_b_of_type_Int);
      if ((l > 0L) && (paramslj.jdField_b_of_type_Long > 3L * l))
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoConvertUtils", 2, "needCompress(): true! sourceBitRate:" + paramslj.jdField_b_of_type_Long + ", targetBitRate:" + l);
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("VideoConvertUtils", 2, "needCompress(): false, bitrate not match, sourceBitRate:" + paramslj.jdField_b_of_type_Long + ", targetBitRate:" + l);
    return false;
  }
