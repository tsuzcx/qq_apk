...
public class bjfw
{
  private final bjgc a = new bjgc(null);
  
  public static bjfw a()
  {
    return bjgd.a();
  }
  ...
  public static String a(@Nullable BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    {
      paramAppInfo = bjgb.a(paramAppInfo);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = "&trace_detail=base64-" + aunw.a(localJSONObject.toString());
      return paramString1;
    }
  ...
  {
    if (paramAppInfo != null) {
      return String.format("&trace_detail=base64-%s", new Object[] { aunw.a(bjga.a(paramAppInfo).a()) });
    }
    return null;
  }
  ...
  public void a(@Nullable BusinessInfoCheckUpdate.AppInfo paramAppInfo, int paramInt)
  {
    ...
    bjgb localbjgb = bjgb.a(paramAppInfo);
    ItemInfo localItemInfo = new bjfz(null).a(localbjgb.b).b(paramAppInfo.buffer.get()).a(new bjfy(System.currentTimeMillis(), paramInt).a()).a();
    ...
    for (;;)
    {
      QLog.d("MobileReport.Manager", 2, "report " + localbjgb.toString() + " actionId = " + paramAppInfo);
      bjgc.a(this.a, localbjgb, localItemInfo);
      return;
      label120:
      if (101 == paramInt) {
  ...
  public void a(String paramString1, int paramInt1, long paramLong, String paramString2, int paramInt2, String paramString3)
  {
    ...
    {
      localbjgb = new bjgb("", 0, "", 0, "H5CostReport", paramString1, null);
    ...
    try
    {
      ...
      paramString3 = new bjfz(null).a("").b(localJSONObject.toString()).a(new bjfy(System.currentTimeMillis(), paramInt1, paramLong).a()).a();
      if (QLog.isColorLevel()) {
        QLog.d("MobileReport.Manager", 2, "report " + localbjgb.toString() + " opType = " + paramInt1 + " url = " + paramString1 + " timecost " + paramLong + " errorcode " + paramString2);
      }
      bjgc.a(this.a, localbjgb, paramString3);
      return;
    }
