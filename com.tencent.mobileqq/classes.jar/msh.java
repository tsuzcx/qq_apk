...
public class msh
{
  ...
  public msh(msh parammsh, long paramLong)
  {
    this.o = paramLong;
    this.jdField_a_of_type_Msh = parammsh;
  }
  ...
  {
    float f2 = 0.0F;
    for (msh localmsh = this.jdField_a_of_type_Msh; (localmsh != null) && (!localmsh.jdField_a_of_type_Boolean); localmsh = localmsh.jdField_a_of_type_Msh) {
      localmsh.jdField_b_of_type_Boolean = true;
    }
    this.jdField_a_of_type_Msh = localmsh;
    if (localmsh != null)
    {
      if (localmsh.jdField_a_of_type_Long != 0L) {
        this.jdField_b_of_type_Long = (this.jdField_a_of_type_Long - localmsh.jdField_a_of_type_Long);
      }
      if (localmsh.k != 0L) {
        this.l = (this.k - localmsh.k);
      }
    }
    if (localmsh == null)
    {
    ...
    label137:
    for (float f1 = f2;; f1 = localmsh.jdField_b_of_type_Float)
    {
      this.jdField_b_of_type_Float = a(f1, this.l / 1000L);
      return;
      f1 = localmsh.jdField_a_of_type_Float;
      break;
    }
  }
  ...
  boolean c()
  {
    ...
    msh localmsh = this.jdField_a_of_type_Msh;
    if (localmsh != null)
    {
      if ((localmsh.jdField_b_of_type_Int != this.jdField_b_of_type_Int) || (localmsh.jdField_c_of_type_Int != this.jdField_c_of_type_Int) || (localmsh.jdField_d_of_type_Int != this.jdField_d_of_type_Int) || (localmsh.jdField_e_of_type_Int != this.jdField_e_of_type_Int) || (localmsh.jdField_f_of_type_Int != this.jdField_f_of_type_Int) || (localmsh.jdField_g_of_type_Int != this.jdField_g_of_type_Int) || (localmsh.n != this.n) || (localmsh.jdField_c_of_type_Boolean != this.jdField_c_of_type_Boolean) || (localmsh.jdField_d_of_type_Boolean != this.jdField_d_of_type_Boolean) || (localmsh.jdField_h_of_type_Int != this.jdField_h_of_type_Int) || (localmsh.jdField_a_of_type_Int != this.jdField_a_of_type_Int) || (localmsh.o + 1L != this.o))
      {
        m = System.currentTimeMillis();
        return true;
      }
