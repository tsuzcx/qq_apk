  ...
  extends QIPCModule
{
  ...
  public amoz(String paramString)
  {
    super(paramString);
  }
  
  public static amoz a()
  {
    return ampa.a();
  }
  ...
  public static void a()
  {
    ...
    if (!a)
    {
      QIPCClientHelper.getInstance().register(localamoz);
      a = true;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      ...
      {
        ampj.a(paramBundle.getInt("gameId"));
      }
    ...
    else if ("action_set_sso_rule".equals(paramString))
    {
      ...
      amrt localamrt = ampj.a();
      if (localamrt != null) {
        localamrt.a(paramString.gameId, paramBundle);
      }
    }
    else
    {
      ...
      if (bool)
      {
        try
        {
          ...
          if (l >= 0L)
          {
            ...
            bctj.a(BaseApplicationImpl.getApplication()).a(null, "cmgame_ipc_start_receive", true, l, 0L, paramBundle, "", false);
          }
          ampj.a(paramString);
        }
        catch (Exception paramString)
      ...
      else if ("action_check_game_data".equals(paramString))
      {
        ...
        paramString = ampj.a(paramString.gameId);
        if (paramString != null) {
