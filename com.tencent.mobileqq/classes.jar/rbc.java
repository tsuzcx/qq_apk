  ...
  implements Handler.Callback, AdapterView.OnItemClickListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new befq(Looper.getMainLooper(), this);
  ...
  public rbc(Activity paramActivity)
  {
    ...
    this.jdField_b_of_type_Int = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131167766);
  ...
  {
    paramString = rbb.a(paramString, this.jdField_d_of_type_Int, this.jdField_c_of_type_JavaLangString, "QRCode_");
  ...
  public bbms a()
  {
    ...
    {
      this.jdField_a_of_type_Bbms = new bbms(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int);
  ...
  public List<bahx>[] a()
  {
    ...
    localbahx.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131630983);
    ...
    localbahx = new bahx();
    localbahx.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131630996);
    ...
    localArrayList.add(localbahx);
    localbahx = new bahx();
    localbahx.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131631003);
    localbahx.jdField_b_of_type_Int = 2130838736;
    localbahx.jdField_c_of_type_Int = 9;
    localbahx.jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localbahx);
    localbahx = new bahx();
    localbahx.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131630986);
    localbahx.jdField_b_of_type_Int = 2130838730;
    localbahx.jdField_c_of_type_Int = 10;
    localbahx.jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localbahx);
    localbahx = new bahx();
    localbahx.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131631000);
    localbahx.jdField_b_of_type_Int = 2130838735;
    localbahx.jdField_c_of_type_Int = 12;
    localbahx.jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localbahx);
  ...
  public void b()
  {
    ...
    if ((rtr.b(this.jdField_c_of_type_JavaLangString)) && (!TextUtils.isEmpty(a()))) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        return;
        this.jdField_a_of_type_Bahv.a(BaseApplicationImpl.getContext().getString(2131653614));
      }
      catch (Exception localException)
      {
        for (;;)
  ...
  public void c()
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      bfpr.a(this.jdField_a_of_type_AndroidAppActivity, localbfpy, this.jdField_a_of_type_JavaLangString, BaseApplicationImpl.getContext().getString(2131655006), "", -1);
      return;
    }
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          if ((!this.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
          {
            this.jdField_a_of_type_Wis.d(new rbd(this));
            return;
          }
        }
        catch (Exception localException)
  ...
  public void d(String paramString)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
    {
      ...
      str = BaseApplicationImpl.getContext().getResources().getString(2131629907);
      label115:
    ...
    for (paramString = paramString.concat("|1");; paramString = paramString.concat("|0"))
    {
      ...
      localIntent.putExtra("brief_key", ajjy.a(2131647791));
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          if ((!this.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
          {
            this.jdField_a_of_type_Wis.d(new rbe(this));
            return;
          }
        }
        catch (Exception localException)
  ...
  public void f()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = BaseApplicationImpl.getContext().getResources().getString(2131629907);
      ...
      catch (PackageManager.NameNotFoundException localNameNotFoundException)
      {
        ...
        this.jdField_a_of_type_Bbms.dismiss();
        bbmy.a(BaseApplicationImpl.getContext(), 0, 2131629917, 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131167766));
        continue;
      }
      if (QLog.isColorLevel()) {
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      switch (((baia)localObject).a.jdField_c_of_type_Int)
      {
      }
