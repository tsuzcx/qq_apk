  ...
  implements Handler.Callback, AdapterView.OnItemClickListener, szy
{
  ...
  View a()
  {
    Object localObject = (beey)this.jdField_a_of_type_Bedi.a().a(2);
    if ((((beey)localObject).a.jdField_a_of_type_Boolean) || (((beey)localObject).a.jdField_b_of_type_Boolean)) {}
    for (int i = 2131363457;; i = 2131377989)
    {
      ...
      {
        localObject = localView;
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey != null)
        {
          localObject = localView;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey.d != null) {
  ...
  public void a(Uri paramUri, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        azmj.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A69", "0X8006A69", 0, 0, "", paramString, "", "");
  ...
  void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if ((this.jdField_a_of_type_AndroidWidgetLinearLayout != null) && ((this.jdField_a_of_type_AndroidWidgetLinearLayout.getTag() instanceof Integer)))
          {
            ...
            if (i != paramInt)
            {
              ...
              if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey.d != null)) {
                this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey.d.findViewById(2131363457);
              }
          ...
          if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559499, null));
            localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363457);
            if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey.d != null)) {
              this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Beey.d.findViewById(2131363457);
            }
            ...
            localLayoutParams.setMargins(0, 0, aekt.a(10.0F, BaseApplicationImpl.getContext().getResources()), aekt.a(65.0F, BaseApplicationImpl.getContext().getResources()));
            ...
            if (paramInt == 2)
            {
              localObject = (LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376135).getLayoutParams();
            ...
            this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376135).setOnClickListener(new beef(this));
          }
          ...
          ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376135)).setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      ...
      ((AlphaAnimation)localObject).setAnimationListener(new beeg(this));
  ...
  public void b(String paramString)
  {
    if ((this.jdField_a_of_type_Szw == null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      if (localObject != null)
      {
        ...
        ((View)localObject).getViewTreeObserver().addOnGlobalLayoutListener(new beee(this, (View)localObject));
      }
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Sdq.c(BaseApplicationImpl.getContext().getResources().getString(2131695747));
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      catch (Exception paramView)
      {
        ...
        azmj.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1001", paramView, "", "");
        ...
        continue;
        azmj.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1002", paramView, "", "");
        ...
        continue;
        azmj.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1003", paramView, "", "");
        ...
        continue;
        azmj.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1004", paramView, "", "");
        ...
        azmj.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1005", paramView, "", "");
