...
public class aans
{
  private static volatile aans jdField_a_of_type_Aans;
  private Map<String, Timer> jdField_a_of_type_JavaUtilMap = new HashMap();
  
  public static aans a()
  {
    if (jdField_a_of_type_Aans == null) {}
    try
    {
      if (jdField_a_of_type_Aans == null) {
        jdField_a_of_type_Aans = new aans();
      }
      return jdField_a_of_type_Aans;
    }
    finally {}
  }
  ...
  private void a(Context paramContext, String paramString, aant paramaant)
  {
    paramContext = aanr.a(paramContext);
  ...
  {
    return aanr.a(paramContext).getInt(a(paramString), 0);
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt, aant paramaant)
  {
    if (paramInt > 0)
    {
      a(paramString);
      Timer localTimer = new Timer();
      localTimer.schedule(new TimeAndCountHelper.1(this, paramContext, paramString, paramaant), paramInt);
      this.jdField_a_of_type_JavaUtilMap.put(paramString, localTimer);
      return;
    }
    a(paramContext, paramString, paramaant);
  }
