...
public class ajga
{
  public static void a(acvh paramacvh, MessageRecord paramMessageRecord, QQMessageFacade paramQQMessageFacade, QQAppInterface paramQQAppInterface)
  {
    if ((paramacvh == null) || (paramMessageRecord == null) || (paramQQMessageFacade == null) || (paramQQAppInterface == null)) {}
    Object localObject;
    int k;
    int i;
    do
    {
      ...
      k = bdgn.a().b(paramQQAppInterface);
      if (k <= 0) {
        break;
      }
      int j = 0;
    ...
    try
    {
      paramacvh.a((QQMessageFacade.Message)localObject);
      paramQQMessageFacade.a().unReadNum = k;
      return;
    }
    catch (Throwable paramacvh)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopSuspiciousHelper", 2, "add GroupSuspiciousMsg ERROR", paramacvh);
        }
      }
    }
  ...
  public static void a(aogd paramaogd, QQAppInterface paramQQAppInterface, structmsg.RspNextSystemMsg paramRspNextSystemMsg, String paramString)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        localMessageRecord.frienduin = anhk.O;
    ...
    localObject = (awne)paramQQAppInterface.getManager(37);
    boolean bool;
    if (localArrayList.size() > 0)
    {
      if ((localArrayList.size() < 100) && (localObject != null)) {
        ((awne)localObject).b(true);
      }
      ...
      if ((anqc.a(localArrayList)) && (paramQQAppInterface.isBackground_Stop))
      {
        bool = true;
    ...
    for (;;)
    {
      paramaogd.a(4019, true, localArrayList);
      return;
      bool = false;
      break;
      if (localObject != null) {
  ...
  public static void a(aogd paramaogd, QQAppInterface paramQQAppInterface, structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt, String paramString)
  {
    ...
    bdgn.a().b(paramQQAppInterface, paramInt);
    paramRspSystemMsgNew = new ArrayList();
    int i = paramList.size();
    Object localObject = (awne)paramQQAppInterface.getManager(37);
    if (localObject != null) {
      ((awne)localObject).b(false);
    }
    Collections.sort(paramList, new ajgb());
    paramInt = 0;
    if (paramInt < i)
    {
      localObject = bbzh.a(-2018);
      ((MessageRecord)localObject).msgtype = -2018;
      ((MessageRecord)localObject).selfuin = paramString;
      ((MessageRecord)localObject).frienduin = anhk.O;
    ...
    paramQQAppInterface.a().a(anhk.O, 0);
    if (paramRspSystemMsgNew.size() > 0)
    {
      paramList = paramQQAppInterface.a();
      paramString = String.valueOf(paramString);
      if ((!anqc.a(paramRspSystemMsgNew)) || (!paramQQAppInterface.isBackground_Stop)) {
        break label568;
      }
    }
    label568:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramaogd.a(4019, true, paramRspSystemMsgNew);
      return;
    }
  }
  ...
  public static void a(structmsg.StructMsg paramStructMsg, String paramString)
  {
    ...
    {
      bgjt.a("Grp_contacts_news", "notice", paramString, 0, 0, new String[] { str1, str2, paramStructMsg });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = paramQQAppInterface.a().b(anhk.O, 0);
