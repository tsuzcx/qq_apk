...
public class kje
  implements Runnable
{
  public kje(AuthorizeConfig paramAuthorizeConfig, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ("2013 7.6.0".equals(str3)))
      {
      ...
      {
        ((mobileqq_mp.WebviewWhiteListRequset)localObject4).qqversion.set("7.6.0");
    ...
    catch (InterruptedException localInterruptedException)
    {
      try
      {
        ...
        ((NewIntent)localObject1).setObserver(new kjf(this));
