...
public class qcq
{
  public static boolean a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = ((pvp)localObject).a().b();
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    if (("2".equals(str1)) && (!TextUtils.isEmpty(str2))) {
      if (qct.a(paramContext, paramString))
      {
  ...
  private static boolean b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (i < localList.size())
      {
        localrov = (rov)localList.get(i);
        j = 0;
      }
      while (j < localrov.a.size())
      {
        if (paramInt == ((TabChannelCoverInfo)localrov.a.get(j)).mChannelCoverId)
        {
          bool1 = true;
          return bool1;
        }
  ...
  private static boolean c(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = (rov)((List)localObject).get(0);
        i = 0;
      }
    }
    for (;;)
    {
      bool1 = bool2;
      if (i < ((rov)localObject).a.size())
      {
        if (paramInt == ((TabChannelCoverInfo)((rov)localObject).a.get(i)).mChannelCoverId) {
          bool1 = true;
        }
      }
      else {
