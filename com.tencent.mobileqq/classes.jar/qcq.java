  ...
  implements pxt, qdy
{
  ...
  private void a(Activity paramActivity)
  {
    try
    {
      new aycg(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getPackageName()).a();
      mum.a(paramActivity);
      return;
    }
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localrea = paramBaseArticleInfo.scripCmsInfo;
        if (localrea == null) {
          break;
        }
        if ((localrea.jdField_a_of_type_Int == 1) || ((TextUtils.isEmpty(localrea.g)) && (TextUtils.isEmpty(localrea.h))))
        {
          paramBaseArticleInfo = new JSONObject(localrea.jdField_a_of_type_JavaLangString).getJSONArray("S");
          Object localObject = new JSONObject(localrea.b).getJSONArray("S");
          localJSONObject.put("main_title_rich", a(paramBaseArticleInfo));
          localJSONObject.put("sub_title_rich", a((JSONArray)localObject));
          localJSONObject.put("privacy_text", localrea.jdField_d_of_type_JavaLangString);
          paramBaseArticleInfo = pxs.c();
          ...
          if ((paramInt == 0) && (pxs.a() == 1))
          {
            localJSONObject.put("tips_text", ((Context)localObject).getString(2131717445));
            localJSONObject.put("icon_image_url", localrea.e);
            localJSONObject.put("bg_image_url", localrea.c);
            localJSONObject.put("animation_url", localrea.f);
            return localJSONObject;
          }
          localJSONObject.put("tips_text", paramBaseArticleInfo);
          continue;
        }
        localJSONObject.put("main_title_rich", localrea.g.replace("#$%", pxs.a()));
      }
      ...
      {
        if ((paramInt == 0) && (pxs.a() == 1)) {}
        for (paramBaseArticleInfo = localrea.h.replace("#$%", paramBaseArticleInfo.getString(2131717444));; paramBaseArticleInfo = localrea.h.replace("#$%", pxs.b()))
        {
          localJSONObject.put("sub_title_rich", paramBaseArticleInfo);
          localJSONObject.put("bg_image_url", localrea.i);
          return localJSONObject;
        }
      }
      label408:
  ...
  public void a(int paramInt1, Container paramContainer, pvc parampvc, int paramInt2)
  {
    ...
    if ((parampvc != null) && (parampvc.a() != null))
    {
      ...
      if ((((Map)localObject).get("id_lottie_view") == null) || (!(((Map)localObject).get("id_lottie_view") instanceof qhw))) {
        break label102;
      }
    }
    label102:
    for (Object localObject = (qhw)((Map)localObject).get("id_lottie_view");; localObject = null)
    {
      localslt.a(new qcr(this, (qhw)localObject, parampvc, paramContainer));
      return;
    }
  }
  ...
  public boolean a(int paramInt, Container paramContainer, pvc parampvc, ViewBase paramViewBase)
  {
    ...
    default: 
      return false;
    case 1165: 
      paramViewBase.setOnClickListener(new qcs(this, parampvc, paramContainer));
      return true;
    case 1166: 
      paramViewBase.setOnClickListener(new qct(this, paramContainer));
      return true;
    }
    paramViewBase.setOnClickListener(new qcu(this, paramContainer));
    return true;
  }
  ...
  public void x_()
  {
    if (this.jdField_a_of_type_AndroidContentContext != null)
    {
      ...
      if (pxs.a(this.jdField_a_of_type_AndroidContentContext, str) >= rea.jdField_d_of_type_Int) {
        break label51;
      }
      if (this.jdField_a_of_type_Pvc != null) {
        this.jdField_a_of_type_Pvc.a().h();
      }
    }
    return;
    label51:
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 0, this.jdField_a_of_type_AndroidContentContext.getString(2131717546), 0).a();
  }
}
