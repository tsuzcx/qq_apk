  ...
  extends apsl
{
  ...
  private apsa jdField_a_of_type_Apsa;
  ...
  aprm(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    bmqk.a().c();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Bmqi = new aprv(this);
    bmqk.a().a(this.jdField_a_of_type_Bmqi);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new aprw(this);
  ...
  private int a(Context paramContext, double paramDouble, WadlParams paramWadlParams)
  {
    ...
    for (boolean bool = localSharedPreferences.getBoolean(str1, true);; bool = true)
    {
      ...
      {
        String str2 = String.format(paramContext.getString(2131690181), new Object[] { bhea.a(paramDouble) });
        String str3 = paramContext.getString(2131690180);
  ...
  private String a(int paramInt)
  {
    ...
    case 2: 
    default: 
      str = localBaseActivity.getString(2131690178);
      return str;
    case 1: 
      return localBaseActivity.getString(2131690176);
    }
    return localBaseActivity.getString(2131690177);
  }
  ...
  private JSONObject a(WadlResult paramWadlResult, String paramString)
  {
    try
    {
      ...
      localJSONObject1.put("errCode", bjqz.b(paramWadlResult.jdField_c_of_type_Int));
  ...
  {
    super.Destruct();
    bmqk.a().b(this.jdField_a_of_type_Bmqi);
    this.jdField_a_of_type_Bmqi = null;
    this.jdField_a_of_type_Aprz = null;
    this.jdField_a_of_type_Apsa = null;
  ...
  {
    if (!apqx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.DOWNLOAD"))
    {
      QLog.i("ark.download.module", 1, "ark.dctrl.ArkAppDownloadModule.invokeFunc permission denied");
      paramString = BaseActivity.sTopActivity;
      if (paramString != null) {
        b(paramString.getString(2131690182));
      }
      return false;
    }
    ...
    if (paramString.equals("QueryPackageState"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_Aprz = new aprn(this, l);
        if (paramArrayOfVariantWrapper.size() > 0) {
          bmqk.a().a(paramArrayOfVariantWrapper);
        }
        return true;
      }
      return false;
    ...
    if (paramString.equals("QueryPackageInfo"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsString())) {
        try
        {
          ...
          localObject2 = abuf.a((String)localObject1);
          i = 0;
          ...
          if (localObject2 != null)
          {
            ...
            paramString = abuf.d(abuf.c((String)localObject1));
          }
    ...
    if (paramString.equals("QueryPackageStateVia"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        this.jdField_a_of_type_Apsa = new aprq(this, a(paramArrayOfVariantWrapper[1].Copy()));
    ...
    if (paramString.equals("DownloadInit"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
      {
        ...
        this.jdField_a_of_type_Apry = new aprr(this);
    ...
    if (paramString.equals("StartDownload"))
    {
      ...
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        {
          bdla.a(null, "dc00898", "", "", "0X8009E12", "0X8009E12", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
          boolean bool2 = true;
          localObject1 = aqyt.b(380).a();
          bool1 = bool2;
          if (localObject1 != null)
          {
            bool1 = bool2;
            if (((aqys)localObject1).a() != null)
            {
              localObject1 = ((aqys)localObject1).a();
              bool1 = bool2;
              if (((aqzm)localObject1).c != null)
              {
                bool1 = bool2;
                if (((aqzm)localObject1).c.contains(this.jdField_a_of_type_JavaLangString)) {
                  bool1 = false;
                }
              }
            }
          ...
          aqav.a().a(this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper.j, paramArrayOfVariantWrapper.k, new aprs(this, paramArrayOfVariantWrapper, paramString, d));
          i = 2;
        }
      }
      for (;;)
      {
        ...
        bdla.a(null, "dc00898", "", "", "0X8009E11", "0X8009E11", 0, 0, "", "", paramArrayOfVariantWrapper.jdField_a_of_type_JavaLangString, "");
        break;
        label1007:
    ...
    if (paramString.equals("PauseDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        bmqk.a().a(i, paramString);
        paramVariantWrapper.SetBool(true);
        bdla.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "1", "", paramString, "");
        return true;
      }
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    if (paramString.equals("ContinueDownload"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[1].IsString()))
      {
        ...
        {
          String str1 = paramArrayOfVariantWrapper.getString(2131690173);
          String str2 = paramArrayOfVariantWrapper.getString(2131690180);
        ...
        bmqk.a().b(i, paramString);
        this.c = true;
        bdla.a(null, "dc00898", "", "", "0X8009E13", "0X8009E13", 0, 0, "2", "", paramString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
    ...
    if (paramString.equals("InstallPackage"))
    {
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsString()))
      {
        ...
        bmqk.a().b(paramString);
        bdla.a(null, "dc00898", "", "", "0X8009E16", "0X8009E16", 0, 0, "", "", paramString.jdField_a_of_type_JavaLangString, "");
        paramVariantWrapper.SetBool(true);
        return true;
      }
      paramVariantWrapper.SetBool(false);
