  ...
  extends AsyncTask<Void, Void, Void>
{
  ...
  public bqzq(PeakActivity paramPeakActivity, AppInterface paramAppInterface)
  {
  ...
  private String a(PublishVideoEntry paramPublishVideoEntry, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = BitmapFactory.decodeResource(((Context)localObject1).getResources(), 2130846011);
        ...
        if (i != 0)
        {
          ...
          if (zoc.a(paramPublishVideoEntry, Bitmap.CompressFormat.PNG, 100, localFile.getAbsolutePath())) {
            continue;
          }
          zoc.a(paramPublishVideoEntry);
  ...
  private void a()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject3 != null) {
        zom.a((String)localObject3);
      }
    }
    new wmk().a((PublishVideoEntry)localObject2, (String)localObject1, false, true, new bqzr(this, localPeakActivity, (String)localObject1, null, (PublishVideoEntry)localObject2));
  }
  ...
  private void a(PeakActivity paramPeakActivity, String paramString1, String paramString2, PublishVideoEntry paramPublishVideoEntry)
  {
    ...
    if (SaveVideoActivity.a() == null) {
      SaveVideoActivity.a(zqi.a(paramPeakActivity.getApplicationContext()));
    }
    ...
    do
    {
      ...
      try
      {
        if (born.e(paramPeakActivity.getIntent()))
        {
          ...
          bhmi.d(paramPublishVideoEntry.thumbPath, paramPeakActivity);
        }
        paramPeakActivity = new bqzt(this, paramPublishVideoEntry, paramString1, this.jdField_b_of_type_JavaLangString);
  ...
  private void b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 36	bqzq:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   4: invokevirtual 73	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   7: ifnull +13 -> 20
    //   10: aload_0
    //   11: getfield 38	bqzq:jdField_b_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   14: invokevirtual 73	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   17: ifnonnull +4 -> 21
    //   20: return
    //   21: aload_0
    //   22: invokespecial 193	bqzq:a	()Z
    //   25: ifne -5 -> 20
    //   28: aload_0
    //   29: getfield 36	bqzq:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   38: astore 13
    //   40: aload_0
    //   41: getfield 38	bqzq:jdField_b_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   72: putfield 210	bqzq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   75: aload 12
    //   77: aload_0
    //   78: getfield 210	bqzq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   125: astore 11
    //   127: aload_0
    //   128: getfield 376	bqzq:jdField_b_of_type_Boolean	Z
    //   131: ifeq +62 -> 193
    //   134: aload 14
    ...
    //   157: iload_3
    //   158: iload 4
    //   160: invokespecial 378	bqzq:a	(Lcom/tencent/biz/qqstory/database/PublishVideoEntry;IIZ)Ljava/lang/String;
    //   163: astore 12
    //   165: aload 12
    //   167: astore 11
    //   169: aload 12
    ...
    //   175: iconst_1
    //   176: aload 14
    //   178: invokespecial 273	bqzq:a	(ILcom/tencent/biz/qqstory/database/PublishVideoEntry;)V
    //   181: return
    //   182: iconst_0
    //   183: istore_1
    //   184: goto -60 -> 124
    ...
    //   190: goto -37 -> 153
    //   193: aload_0
    //   194: invokespecial 193	bqzq:a	()Z
    //   197: ifne -177 -> 20
    ...
    //   203: astore 12
    //   205: invokestatic 388	brji:a	()Lbrji;
    //   208: invokevirtual 391	brji:a	()Lcom/tencent/maxvideo/mediadevice/AVCodec;
    //   211: invokevirtual 396	com/tencent/maxvideo/mediadevice/AVCodec:recordSubmit	()I
    //   214: pop
    //   215: ldc 183
    //   217: ldc_w 398
    //   220: invokestatic 403	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   223: aload_0
    //   224: invokespecial 193	bqzq:a	()Z
    //   227: ifne -207 -> 20
    ...
    //   272: ldc 183
    //   274: ldc_w 410
    //   277: invokestatic 403	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   280: lload 7
    //   282: lstore 5
    ...
    //   343: invokestatic 403	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   346: lload 7
    //   348: lstore 5
    //   350: aload 15
    //   352: monitorexit
    //   353: ldc 183
    //   355: ldc_w 429
    //   358: invokestatic 403	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   361: lload 5
    //   363: ldc2_w 430
    //   366: lcmp
    //   367: ifge +42 -> 409
    ...
    //   397: invokestatic 442	yuk:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   400: iload_1
    //   401: i2l
    //   402: lstore 5
    //   404: lload 5
    ...
    //   409: aload_0
    //   410: invokespecial 193	bqzq:a	()Z
    //   413: ifne -393 -> 20
    //   416: aload 14
    ...
    //   448: invokestatic 459	bhmi:a	(Ljava/lang/String;)Z
    //   451: ifeq +336 -> 787
    //   454: iconst_1
    //   455: istore_1
    ...
    //   498: ifnull +9 -> 507
    //   501: aload 16
    //   503: invokestatic 236	zom:a	(Ljava/lang/String;)Z
    //   506: pop
    ...
    //   595: ldc2_w 493
    //   598: ddiv
    //   599: putfield 496	bqzq:jdField_a_of_type_Double	D
    ...
    //   654: aload_0
    //   655: invokespecial 193	bqzq:a	()Z
    //   658: ifne -638 -> 20
    //   661: iload_2
    //   662: ifeq +130 -> 792
    //   665: aload 13
    ...
    //   679: iconst_1
    //   680: aload 14
    //   682: invokespecial 273	bqzq:a	(ILcom/tencent/biz/qqstory/database/PublishVideoEntry;)V
    //   685: return
    //   686: astore 15
    //   688: ldc 183
    //   690: ldc_w 514
    //   693: aload 15
    //   695: invokestatic 517	yuk:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    //   773: invokestatic 403	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   776: goto -426 -> 350
    //   779: astore 11
    //   781: aload 15
    //   783: monitorexit
    ...
    //   841: aload 11
    //   843: aload 14
    //   845: invokespecial 541	bqzs:<init>	(Lbqzq;Ljava/lang/String;Lcom/tencent/mobileqq/activity/aio/photo/PeakActivity;Ljava/lang/String;Ljava/lang/String;Lcom/tencent/biz/qqstory/database/PublishVideoEntry;)V
    //   848: invokestatic 546	zqr:a	(ZLandroid/content/Context;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Lzqh;)V
    //   851: return
    //   852: astore 11
    //   854: aload 11
    ...
    //   860: iconst_1
    //   861: aload 14
    //   863: invokespecial 273	bqzq:a	(ILcom/tencent/biz/qqstory/database/PublishVideoEntry;)V
    //   866: return
    //   867: aload_0
    //   868: aload 13
    //   870: aload 12
    //   872: aload 11
    //   874: aload 14
    //   876: invokespecial 276	bqzq:a	(Lcom/tencent/mobileqq/activity/aio/photo/PeakActivity;Ljava/lang/String;Ljava/lang/String;Lcom/tencent/biz/qqstory/database/PublishVideoEntry;)V
    //   879: return
    //   880: astore 12
    //   882: goto -473 -> 409
