  ...
  extends JobSegment<List<String>, List<Bitmap>>
{
  ...
  public vzu(@Nullable Bitmap paramBitmap, String paramString, int paramInt, vzs paramvzs)
  {
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_JavaLangString = (this.jdField_a_of_type_JavaLangString + "[" + paramString + "]");
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Vzs = paramvzs;
  }
  ...
  protected void a(JobContext paramJobContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      vzb.b(this.jdField_a_of_type_JavaLangString, "bitmapListSize = %d, stubBitmap = %s", Integer.valueOf(i), this.jdField_a_of_type_AndroidGraphicsBitmap);
      Handler localHandler = new Handler(ThreadManager.getSubThreadLooper(), new vzw(this, null));
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!"stub_url".equals(str)) {
          this.jdField_a_of_type_Vzs.a(str, i, i, new vzv(this, paramJobContext, paramList, localHandler));
        }
      }
    }
  }
