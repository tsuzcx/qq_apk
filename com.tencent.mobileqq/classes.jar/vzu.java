...
{
  public static final String a = weg.a("StorySvc.video_config_get");
  public static final String b = weg.a("StorySvc.video_config_set");
  public static final String c = weg.a("StorySvc.video_get_user_mask_list");
  public static final String d = weg.a("StorySvc.video_set_user_mask");
  public static final String e = weg.a("StorySvc.video_get_user_mask_states");
  public static final String f = weg.a("StorySvc.video_show_video_list");
  public static final String g = weg.a("StorySvc.get_official_recommend");
  public static final String h = weg.a("StorySvc.pgc_subscribe_operation");
  public static final String i = weg.a("StorySvc.pgc_person_page");
  public static final String j = weg.a("StorySvc.pgc_search_feedlist_get");
  public static final String k = weg.a("StorySvc.pgc_client_report");
  public static final String l = weg.a("StorySvc.video_aio_sync_publish");
  public static final String m = weg.a("StorySvc.get_video_reader_config");
  public static final String n = weg.a("StorySvc.msgtab_node_feedback");
  
  public vzu(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    ykq.b("QQStoryHandler", "handleGetForbidList");
    boolean bool2;
    int i1;
    Object localObject;
    if (paramObject != null)
      ...
      try
      {
        ...
        if (((qqstory_service.RspGetForbiddenList)localObject).result.error_code.get() == 0)
        {
          if (((qqstory_service.RspGetForbiddenList)localObject).is_end.get() != 0)
          {
            ...
            localQQStoryUserInfo.setNick(ContactUtils.getFriendShowName(this.app, localQQStoryUserInfo.uin));
            if (!bool2) {
              break label290;
            }
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      localvzv = (vzv)this.app.getManager(QQManagerFactory.QQSTORY_MANAGER);
    ...
    try
    {
      ...
      {
        paramFromServiceMsg = localvzv.a(str);
        ...
        if (paramToServiceMsg.size() > 0)
        {
          ...
          if (paramFromServiceMsg == null)
          {
            ...
            paramToServiceMsg.setNick(ContactUtils.getFriendShowName(this.app, str));
            localvzv.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, paramToServiceMsg);
            paramToServiceMsg.isAllowed = i2;
            paramToServiceMsg.isInterested = i1;
            if (paramToServiceMsg.getStatus() == 1000)
            {
              localvzv.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.persist(paramToServiceMsg);
    ...
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
    {
      for (;;)
      {
        ...
        continue;
        localvzv.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.update(paramToServiceMsg);
        continue;
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
        ...
        try
        {
          if ((paramObject.error_code.get() == 0) && (localRspGetInfoCard.user.has()))
          {
            ...
            else
            {
              ...
              vzv.c("QQStoryHandler handleGetPGCUserInfoCard user=" + null);
            }
            if (i2 != 0)
            {
              ykv.b("story_check", "pgc_check", 0, 1, new String[] { i });
      ...
      break label35;
      ykv.b("story_check", "pgc_check", 0, 0, new String[] { i });
      continue;
  ...
  private void l(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          if (((qqstory_pgc.RspGetSearchFeedList)localObject1).result_type.has())
          {
            ...
            i2 = 1;
            vzv.c("QQStoryHandler handleGetPGCSearchFeedList user=" + localObject2);
            continue;
            i4 = 0;
            break;
            l1 = System.currentTimeMillis() - paramToServiceMsg.extraData.getLong("extra_start_time");
          ...
          ykv.b("story_check", "pgc_check", 0, 1, new String[] { j });
      ...
      return;
      ykv.b("story_check", "pgc_check", 0, 0, new String[] { j });
    }
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   12: astore 12
    //   14: iconst_3
    //   15: anewarray 271	java/lang/Object
    //   18: astore 13
    //   20: aload 13
    //   22: iconst_0
    //   23: iload 4
    //   25: invokestatic 491	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   28: aastore
    //   29: aload 13
    //   31: iconst_1
    //   32: aload 12
    ...
    //   80: istore 4
    //   82: aload_3
    //   83: invokestatic 366	vzu:a	(Ljava/lang/Object;)Z
    //   86: ifeq +334 -> 420
    //   89: new 503	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspSubscription
    //   92: dup
    //   93: invokespecial 504	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspSubscription:<init>	()V
    //   96: astore 12
    //   98: aload 12
    //   100: aload_3
    //   101: checkcast 90	[B
    //   104: checkcast 90	[B
    //   107: invokevirtual 505	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspSubscription:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   110: pop
    //   111: aload 12
    //   113: getfield 506	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspSubscription:result	Lcom/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo;
    //   116: invokevirtual 376	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   119: checkcast 375	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo
    //   122: astore_3
    //   123: aload_3
    //   124: getfield 377	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:error_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   127: invokevirtual 117	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   130: istore 4
    //   132: aload_3
    //   133: getfield 380	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:error_desc	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   136: invokevirtual 175	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   139: invokevirtual 360	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    //   142: astore_2
    //   143: aload_2
    //   144: astore_1
    //   145: iload 4
    //   147: ifne +209 -> 356
    //   150: aload 12
    //   152: getfield 509	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspSubscription:is_subscribe	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    ...
    //   167: iconst_2
    //   168: iload 11
    //   170: invokestatic 277	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   173: aastore
    //   174: aload_0
    //   175: sipush 1011
    //   178: iconst_1
    //   179: aload 13
    //   181: invokevirtual 121	vzu:notifyUI	(IZLjava/lang/Object;)V
    //   184: iconst_1
    //   185: istore 6
    //   187: iload 6
    //   189: istore 5
    //   191: invokestatic 422	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   194: ifeq +45 -> 239
    //   197: ldc_w 424
    //   200: iconst_2
    ...
    //   214: iconst_1
    //   215: invokevirtual 429	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   218: ldc_w 513
    //   221: invokevirtual 238	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   224: iload 11
    //   226: invokevirtual 429	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   229: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   232: invokestatic 434	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   235: iload 6
    //   237: istore 5
    //   239: iload 5
    //   241: ifne +18 -> 259
    ...
    //   253: iconst_0
    //   254: aload 13
    //   256: invokevirtual 121	vzu:notifyUI	(IZLjava/lang/Object;)V
    //   259: iload 7
    //   261: ifne +15 -> 276
    //   264: aload_0
    //   265: getstatic 58	vzu:h	Ljava/lang/String;
    //   268: lload 9
    //   270: iload 4
    //   272: aload_1
    //   273: invokevirtual 437	vzu:a	(Ljava/lang/String;JILjava/lang/String;)V
    //   276: return
    //   277: aload_1
    //   278: getfield 139	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   281: ldc_w 515
    //   284: iconst_0
    //   285: invokevirtual 518	android/os/Bundle:getInt	(Ljava/lang/String;I)I
    //   288: istore 4
    //   290: goto -283 -> 7
    //   293: aload_1
    ...
    //   309: istore 7
    //   311: goto -265 -> 46
    //   314: invokestatic 442	java/lang/System:currentTimeMillis	()J
    //   317: aload_1
    //   318: getfield 139	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   321: ldc_w 444
    //   324: invokevirtual 448	android/os/Bundle:getLong	(Ljava/lang/String;)J
    //   327: lsub
    //   328: lstore 9
    //   330: goto -275 -> 55
    //   333: aload_2
    //   334: invokevirtual 453	com/tencent/qphone/base/remote/FromServiceMsg:getBusinessFailCode	()I
    //   337: istore 5
    //   339: goto -277 -> 62
    //   342: aload_2
    //   343: invokevirtual 456	com/tencent/qphone/base/remote/FromServiceMsg:getBusinessFailMsg	()Ljava/lang/String;
    //   346: astore_1
    //   347: goto -277 -> 70
    //   350: iconst_0
    //   351: istore 11
    //   353: goto -188 -> 165
    //   356: invokestatic 422	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   359: ifeq +36 -> 395
    //   362: ldc_w 424
    //   365: iconst_2
    ...
    //   379: aload_3
    //   380: getfield 377	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:error_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   383: invokevirtual 117	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   386: invokevirtual 461	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   389: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   392: invokestatic 434	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   395: iconst_0
    //   396: istore 5
    //   398: goto -159 -> 239
    //   401: astore_2
  ...
  public byte a(FromServiceMsg paramFromServiceMsg, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
      {
        ...
        if (7 <= i4) {
          i2 = PkgTools.getShortData(paramFromServiceMsg, 5);
        }
        i1 = 7;
        i3 = 0;
      }
      if (i3 < i2)
      {
        ...
        int i5 = PkgTools.getShortData(paramFromServiceMsg, i1);
        int i6 = i1 + 2;
        i1 = PkgTools.getShortData(paramFromServiceMsg, i6);
        i6 += 2;
        byte b2 = b1;
        ...
        label373:
        for (b1 = 0;; b1 = (byte)PkgTools.getShortData(paramFromServiceMsg, i6))
        {
          b2 = b1;
          if (QLog.isColorLevel())
          {
  ...
  public void a()
  {
    ...
    try
    {
      ...
      PkgTools.DWord2Byte((byte[])localObject, 0, l1);
      localObject[4] = 0;
      PkgTools.Word2Byte((byte[])localObject, 5, (short)1);
      PkgTools.DWordTo2Bytes((byte[])localObject, 7, 42060);
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      PkgTools.DWordTo2Bytes((byte[])localObject, 13, 40319);
      PkgTools.Word2Byte((byte[])localObject, 15, (short)2);
      PkgTools.Word2Byte((byte[])localObject, 17, (short)1);
  ...
  public void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      ...
      localObject[4] = 0;
      PkgTools.Word2Byte((byte[])localObject, 5, (short)1);
      PkgTools.DWordTo2Bytes((byte[])localObject, 7, paramInt2);
      PkgTools.Word2Byte((byte[])localObject, 9, (short)2);
      PkgTools.Word2Byte((byte[])localObject, 11, s);
      localOIDBSSOPkg.bytes_bodybuffer.set(ByteStringMicro.copyFrom((byte[])localObject));
      localObject = createToServiceMsg("OidbSvc.0x4ff_9");
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      localObject[4] = 0;
      PkgTools.Word2Byte((byte[])localObject, 5, (short)1);
      PkgTools.DWordTo2Bytes((byte[])localObject, 7, paramInt);
      localObject = makeOIDBPkg("OidbSvc.0x480_9", 1152, 9, (byte[])localObject);
      ((ToServiceMsg)localObject).extraData.putBoolean(paramString, true);
      a((ToServiceMsg)localObject);
      return;
  ...
  public void a(StoryPushMsg paramStoryPushMsg)
  {
    ...
    wyw.a().a(this.app, 2, paramStoryPushMsg);
  }
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject, String paramString)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
    {
      ...
      ykv.b("handleSetTlvRsp", paramString, 0, i1, new String[] { "" });
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        this.app.getNowLiveManager().a(paramToServiceMsg, true);
        return;
      }
      catch (Exception paramToServiceMsg)
      {
  ...
  public void a(String paramString1, long paramLong, int paramInt, String paramString2)
  {
    ...
    ykv.b("story_net", paramString1, 0, paramInt, new String[] { paramString2, String.valueOf(paramLong), ykv.a(null) });
  }
  ...
  {
    boolean bool = true;
    ykq.a("QQStoryHandler", "getForbidList, cookie:%s, count:%s, isNotAllowed:%s, tag:%s", paramArrayOfByte, Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean), paramString);
  ...
  public void b(FromServiceMsg paramFromServiceMsg)
  {
    ...
    ((wjl)wjs.a(10)).b("sp_key_user_enable_album_scan", Integer.valueOf(i1));
    if (QLog.isColorLevel()) {
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      try
      {
        ...
        if (paramToServiceMsg != null)
        {
          ...
          if (paramToServiceMsg.result.error_code.get() == 0) {
            ...
            {
              paramFromServiceMsg = (wjl)wjs.a(10);
              paramFromServiceMsg.a(System.currentTimeMillis());
              localObject1 = paramToServiceMsg.user_config.get();
              paramObject = (vzv)this.app.getManager(QQManagerFactory.QQSTORY_MANAGER);
      ...
      catch (InvalidProtocolBufferMicroException paramToServiceMsg)
      {
          ...
          else
          {
            ...
            if ("pub_allow_stranger".equals(localObject3))
            {
              ...
              for (;;)
              {
                ...
                ykq.a("QQStoryHandler", "get default permission from server. type is %d.", Integer.valueOf(i3));
                i3 = i1;
                i1 = i2;
                i2 = i3;
                break;
            ...
            if ("mainpage_auto_reqdata_interval".equals(localObject3))
            {
              ...
              ykq.a("Q.qqstory.home.position", "set disable autorefresh time:%d", Long.valueOf(l1));
        ...
        {
          ((wjl)wjs.a(10)).b(System.currentTimeMillis());
          ...
          while (paramObject.hasNext())
          {
            ...
            ykq.b("Q.qqstory.protocol", "find specs in response " + ((qqstory_struct.PicSpecs)localObject2).pic_bid.get().toStringUtf8() + ", specs " + ((qqstory_struct.PicSpecs)localObject2).pic_spec.get());
            ...
            {
              ykq.d("QQStoryHandler", "Invalid json format in " + (String)localObject1 + ", " + localObject2);
            }
          }
          wjl.i(paramFromServiceMsg.toString());
          ykq.b("Q.qqstory.protocol", "get thumbnail config formatted in json " + paramFromServiceMsg.toString());
        }
        while (paramToServiceMsg.video_source_tag_list.has())
        {
          ...
          for (;;)
          {
            if (paramFromServiceMsg.hasNext())
            {
              ...
              {
                ykq.d("QQStoryHandler", "Invalid json format, tagType: " + i1 + ", jumpUrl: " + paramObject + ", wording: " + (String)localObject1);
              }
              continue;
              ykq.b("Q.qqstory.protocol", "no thumbnail pic_specs_list found, check for day limitation");
              break;
            }
          }
          paramFromServiceMsg = (wjl)wjs.a(10);
          ...
          zfj.a();
          ykq.a("QQStoryHandler", "video_source_tag_list format json : %s", paramToServiceMsg.toString());
        }
        i1 = i3;
      }
    }
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      paramFromServiceMsg = (vzv)this.app.getManager(QQManagerFactory.QQSTORY_MANAGER);
    ...
    for (;;)
    {
      try
      {
        ...
        if (((qqstory_service.RspForbidStory)localObject).result.error_code.get() == 0)
        {
          ...
          paramToServiceMsg.setNick(ContactUtils.getFriendShowName(this.app, (String)localObject));
          ...
          if (bool2)
          {
            ...
            paramFromServiceMsg.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.persist(paramToServiceMsg);
            continue;
          }
        }
        else
      ...
      for (;;)
      {
        ...
        break label201;
        label296:
        paramFromServiceMsg.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.update(paramToServiceMsg);
        break;
        label308:
        paramToServiceMsg = paramFromServiceMsg.a((String)localObject);
        if (paramToServiceMsg == null) {
  ...
  public void c(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      {
        label440:
        ykq.b("Q.qqstory.protocol", "decode json fail", paramArrayOfByte);
  ...
  public void d()
  {
    ...
    long l2 = ((wjl)localObject).c();
    long l1 = ((wjl)localObject).d();
    long l3 = TimeUnit.DAYS.toMillis(1L);
    ykq.b("Q.qqstory.protocol", "lastGetConfigTime " + l2 + ", " + System.currentTimeMillis());
  ...
  public void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   45: istore 4
    //   47: aload_3
    //   48: invokestatic 366	vzu:a	(Ljava/lang/Object;)Z
    //   51: ifeq +267 -> 318
    //   54: new 1333	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspReport
    //   57: dup
    //   58: invokespecial 1334	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspReport:<init>	()V
    //   61: astore_2
    //   62: aload_2
    //   63: aload_3
    //   64: checkcast 90	[B
    //   67: checkcast 90	[B
    //   70: invokevirtual 1335	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspReport:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   73: pop
    //   74: aload_2
    //   75: getfield 1336	com/tencent/biz/qqstory/network/pb/qqstory_pgc$RspReport:result	Lcom/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo;
    //   78: invokevirtual 376	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   81: checkcast 375	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo
    //   84: astore_3
    //   85: aload_3
    //   86: getfield 377	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:error_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   89: invokevirtual 117	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   92: istore 4
    //   94: aload_3
    //   95: getfield 380	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:error_desc	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   98: invokevirtual 175	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   101: invokevirtual 360	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    //   104: astore_2
    //   105: aload_2
    //   106: astore_1
    //   107: iload 4
    ...
    //   116: iconst_1
    //   117: iconst_2
    //   118: anewarray 271	java/lang/Object
    //   121: dup
    //   122: iconst_0
    //   123: iload 4
    //   125: invokestatic 491	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   128: aastore
    //   129: dup
    //   130: iconst_1
    //   131: aload_1
    //   132: aastore
    //   133: invokevirtual 121	vzu:notifyUI	(IZLjava/lang/Object;)V
    //   136: iconst_1
    //   137: istore 6
    //   139: iload 6
    //   141: istore 5
    //   143: invokestatic 422	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   146: ifeq +34 -> 180
    //   149: ldc_w 424
    //   152: iconst_2
    ...
    //   166: iconst_1
    //   167: invokevirtual 429	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   170: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   173: invokestatic 434	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   176: iload 6
    //   178: istore 5
    //   180: iload 5
    //   182: ifne +12 -> 194
    ...
    //   189: iconst_0
    //   190: aconst_null
    //   191: invokevirtual 121	vzu:notifyUI	(IZLjava/lang/Object;)V
    //   194: iload 7
    //   196: ifne +15 -> 211
    //   199: aload_0
    //   200: getstatic 70	vzu:k	Ljava/lang/String;
    //   203: lload 9
    //   205: iload 4
    //   207: aload_1
    //   208: invokevirtual 437	vzu:a	(Ljava/lang/String;JILjava/lang/String;)V
    //   211: return
    //   212: iconst_0
    //   213: istore 7
    //   215: goto -204 -> 11
    //   218: invokestatic 442	java/lang/System:currentTimeMillis	()J
    //   221: aload_1
    //   222: getfield 139	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   225: ldc_w 444
    //   228: invokevirtual 448	android/os/Bundle:getLong	(Ljava/lang/String;)J
    //   231: lsub
    //   232: lstore 9
    //   234: goto -214 -> 20
    //   237: aload_2
    //   238: invokevirtual 453	com/tencent/qphone/base/remote/FromServiceMsg:getBusinessFailCode	()I
    //   241: istore 5
    //   243: goto -216 -> 27
    //   246: aload_2
    //   247: invokevirtual 456	com/tencent/qphone/base/remote/FromServiceMsg:getBusinessFailMsg	()Ljava/lang/String;
    //   250: astore_1
    //   251: goto -216 -> 35
    //   254: invokestatic 422	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   257: ifeq +36 -> 293
    //   260: ldc_w 424
    //   263: iconst_2
    ...
    //   277: aload_3
    //   278: getfield 377	com/tencent/biz/qqstory/network/pb/qqstory_pgc$ErrorInfo:error_code	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   281: invokevirtual 117	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   284: invokevirtual 461	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   287: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   290: invokestatic 434	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   293: iconst_0
    //   294: istore 5
    //   296: goto -116 -> 180
    //   299: astore_2
  ...
  public void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = "local data";; paramToServiceMsg = paramFromServiceMsg.getBusinessFailMsg())
    {
      ...
      try
      {
        ...
        paramFromServiceMsg = paramToServiceMsg;
        i2 = i1;
        notifyUI(1017, true, new vzs(this.app, (qqstory_struct.VideoReaderConf)localRspVideoReaderConf.reader_conf.get()));
        paramFromServiceMsg = paramToServiceMsg;
        i2 = i1;
        if (QLog.isColorLevel())
        {
