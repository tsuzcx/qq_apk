...
public abstract class lho
{
  ...
  public lho(String paramString1, String paramString2, String paramString3)
  {
    lbd.f("AVMagicfaceData", "init|config=" + paramString2 + "|" + paramString3 + "|" + paramString1);
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason = ((MagicfaceDataVideoJason)bgzr.a(paramString2, MagicfaceDataVideoJason.class));
      int i;
      ...
      if (paramString1.has("audio")) {
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataAudioJason = ((MagicfaceDataAudioJason)bgzr.a(paramString1.getJSONObject("audio"), MagicfaceDataAudioJason.class));
      }
      ...
      if (paramString1.has("pendant"))
      {
        ...
        {
          paramString2 = (MagicfaceDataPendantJason)bgzr.a((JSONObject)paramString1.get(i), MagicfaceDataPendantJason.class);
          if ((paramString2 != null) && (!TextUtils.isEmpty(paramString2.name)))
          {
            lbd.h("AVMagicfaceData", "Pendant: " + paramString2.toString());
    ...
    catch (JSONException paramString1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason == null)
      {
        lbd.h("AVMagicfaceData", "MagicfaceData error!");
      ...
      lbd.h("AVMagicfaceData", "MagicfaceData:: " + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicfaceDataVideoJason.toString());
  ...
  public boolean a(lho paramlho)
  {
    ...
    if (paramlho != null)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        if ((!TextUtils.isEmpty(paramlho.jdField_b_of_type_JavaLangString)) && (!paramlho.jdField_b_of_type_JavaLangString.equalsIgnoreCase("face")))
        {
          bool1 = bool2;
          if (!paramlho.jdField_b_of_type_JavaLangString.equalsIgnoreCase("voicesticker")) {}
        }
        else
        {
          bool1 = bool2;
