  ...
  implements ValueAnimator.AnimatorUpdateListener
{
  ...
  public afdm(Context paramContext, ListView paramListView, BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131362429);
  ...
  public afdm a(int paramInt1, int paramInt2)
  {
    int j = 0;
    int k = 0;
  ...
  public void a(int paramInt1, boolean paramBoolean, String paramString, int paramInt2)
  {
    ...
    if ((localListAdapter instanceof bjqx)) {
      localObject = ((bjqx)localListAdapter).getWrappedAdapter();
    }
    if (QLog.isColorLevel()) {
