  ...
  extends afdf
{
  ...
  public afdm(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, afdi paramafdi, int paramInt, String paramString)
  {
  ...
  protected afda a()
  {
    return new affz(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (bool2 = bool1;; bool2 = true)
    {
      if (bool2)
      {
        SosoInterface.SosoLbsInfo localSosoLbsInfo = akug.a("recommend_troop");
        if (QLog.isColorLevel()) {
          QLog.i("ac_ft.AddContactFindTroopRTLW", 2, "getRecommendTroopList  >= M, info = " + localSosoLbsInfo);
        }
        if (localSosoLbsInfo == null) {
          akug.a(new afdn(this, "recommend_troop", localakhq, paramBoolean));
        }
      }
      else
      {
      ...
      localakhq.a(1, this.jdField_b_of_type_Int, 25, paramBoolean, a());
      return;
      localakhq.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, 25, paramBoolean);
      return;
      bool1 = true;
      break;
    }
  ...
  protected void a(boolean paramBoolean1, int paramInt1, int paramInt2, boolean paramBoolean2, ArrayList<RecommendTroopItem> paramArrayList, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Afdo != null) {
        this.jdField_a_of_type_Afdo.a(paramBoolean1, i);
      }
      return;
      label358:
