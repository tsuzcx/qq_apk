  ...
  implements Handler.Callback
{
  ...
  public avre a;
  private awbc jdField_a_of_type_Awbc;
  SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public CameraCaptureView a;
  private ArrayList<awbc> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public awbd(CameraCaptureView paramCameraCaptureView, long paramLong)
  {
    super(paramLong);
  ...
  private void c()
  {
    try
    {
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_c_of_type_JavaLangString != null) && (this.jdField_f_of_type_Boolean) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        this.jdField_a_of_type_Avre.a(201, -1, localBundle);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      Bundle localBundle = a();
      this.jdField_a_of_type_Avre.a(208, -1, localBundle);
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_JavaLangString != null)
    {
      ...
      localaxkf = new axkf();
      localaxkf.jdField_a_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
      localaxkf.jdField_b_of_type_JavaLangString = c();
      localaxkf.jdField_a_of_type_Int = 0;
      localaxkf.d = paramInt;
      localaxkf.c = axik.n;
      if (axik.p != 2) {
        break label178;
      }
      localaxkf.jdField_b_of_type_Int = 16;
      if (axik.o != 16) {
        break label188;
      }
      localaxkf.e = 1;
    ...
    for (;;)
    {
      ...
      return;
      label178:
      localaxkf.jdField_b_of_type_Int = 8;
      break;
      label188:
      localaxkf.e = 2;
      break label101;
      label197:
      paramInt = AudioEncoder.a(localaxkf);
      if (paramInt == 0) {
        break label256;
      }
      this.jdField_a_of_type_JavaUtilHashMap.put("param_audio_error", String.valueOf(paramInt));
  ...
  public void a(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_Avre.a(207, -1, localBundle);
    arql.c();
    if (QLog.isColorLevel()) {
  ...
  public void a(awbc paramawbc, boolean paramBoolean, MediaFormat paramMediaFormat)
  {
    int i = paramawbc.a();
    long l = paramawbc.a();
    String str = paramawbc.a();
    if (QLog.isColorLevel()) {
      QLog.d("SegmentManager", 2, "onEncodeVideoSegment:" + paramawbc);
    }
    int j = paramMediaFormat.getInteger("width");
    int k = paramMediaFormat.getInteger("height");
    paramawbc = a();
    paramawbc.putString("video_slice_path", str);
    paramawbc.putInt("video_slice_index", i);
    paramawbc.putInt("video_slice_width", j);
    paramawbc.putInt("video_slice_height", k);
    paramawbc.putLong("video_slice_timestamp", l);
    this.jdField_a_of_type_Avre.a(200, -1, paramawbc);
    if (i == 0) {
    ...
    if (paramBoolean)
    {
      ...
      paramawbc = a();
      this.jdField_a_of_type_Avre.a(204, -1, paramawbc);
      c();
    }
  }
  ...
  public void b()
  {
    ...
    Bundle localBundle = a();
    this.jdField_a_of_type_Avre.a(206, -1, localBundle);
    a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    try
    {
      ...
      case 1: 
        ...
        this.jdField_a_of_type_Awbc = new awbc(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Awbc);
        if (QLog.isColorLevel()) {
          QLog.d("SegmentManager", 2, "Muxer_Start :" + this.jdField_a_of_type_Awbc);
        }
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Awbc.a(), 0);
    ...
    paramMessage = (avzb)paramMessage.obj;
    ...
    for (;;)
    {
      ...
      if (a(l, bool))
      {
        ...
        this.jdField_b_of_type_Long = 0L;
        this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
        a(this.jdField_a_of_type_Awbc, false, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
        i = this.jdField_a_of_type_JavaUtilArrayList.size();
        this.jdField_a_of_type_Awbc = new awbc(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Awbc);
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Awbc.a(), 0);
      ...
      this.jdField_a_of_type_Awbc.a(paramMessage);
      ...
      return true;
      if (QLog.isColorLevel()) {
        QLog.d("SegmentManager", 2, "Muxer_Stop :" + this.jdField_a_of_type_Awbc);
      }
      this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
      a(this.jdField_a_of_type_Awbc, true, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
      return true;
      return true;
      boolean bool = true;
      continue;
