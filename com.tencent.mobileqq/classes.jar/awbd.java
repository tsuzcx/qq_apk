...
public class awbd
{
  private static Map<String, awbd> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new awbe(this);
  ...
  private final List<awbf> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private awbd(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.4.5");
      return localIntent;
    }
  }
  
  public static awbd a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      awbd localawbd2 = (awbd)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      awbd localawbd1 = localawbd2;
      if (localawbd2 == null)
      {
        localawbd1 = new awbd(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localawbd1);
      }
      return localawbd1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", anzj.a(2131704534));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", anzj.a(2131704544) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", anzj.a(2131704548) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anzj.a(2131704543) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", anzj.a(2131704542) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", anzj.a(2131704532) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!awax.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        awbj.a("2691707");
      ...
      a("HuayangPluginLauncher", anzj.a(2131704547) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anzj.a(2131704540) + (System.currentTimeMillis() - l));
      return;
      if (awax.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        awbj.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", anzj.a(2131704538) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", anzj.a(2131704536) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anzj.a(2131704533) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
  ...
  {
    if (paramawbf != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramawbf);
    }
  }
  ...
  public void b(awbf paramawbf)
  {
    if (paramawbf != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramawbf);
    }
  }
}
