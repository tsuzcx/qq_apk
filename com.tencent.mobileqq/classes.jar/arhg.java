  ...
  extends BusinessHandler
{
  ...
  public arhg(QQAppInterface paramQQAppInterface)
  {
  ...
  private Card a(String paramString1, String paramString2, String paramString3, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Card localCard = localamsw.c(paramString1);
  ...
  private void a(List<Long> paramList1, int paramInt1, int paramInt2, List<Long> paramList2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localbbko = this.app.getMsgCache();
      ...
      if (localIterator.hasNext())
      {
        ...
        localObject3 = localbbko.c(String.valueOf(localLong), (String)localObject1);
        localObject2 = localObject3;
        if (localObject3 == null) {
          localObject2 = localbbko.a(String.valueOf(localLong), (String)localObject1, false);
        }
  ...
  private void a(oidb_0xe03.MatchUinData paramMatchUinData, arie paramarie)
  {
    int j = -1;
    int k = 0;
    if ((paramMatchUinData == null) || (paramarie == null))
    {
    ...
    if (paramMatchUinData.uint32_age.has())
    {
      ...
      if (localObject1 != null) {
        paramarie.i = RichStatus.parseStatus((byte[])localObject1).getPlainText();
      }
      if (!paramMatchUinData.uint32_sex.has()) {
        break label569;
      }
      paramarie.jdField_a_of_type_Int = paramMatchUinData.uint32_sex.get();
      label319:
    ...
    {
      paramarie.jdField_a_of_type_Long = l;
      ...
      while (i < paramMatchUinData.rpt_school_info.size())
      {
        ...
        {
          localObject2 = new arjj(((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).str_school_id.get(), ((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).str_school_name.get(), ((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).uint64_state.get());
          ((ArrayList)localObject1).add(localObject2);
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "schoolInfo. " + ((arjj)localObject2).toString());
          }
        }
        i += 1;
      }
      ...
      localObject1 = null;
      break label281;
      paramarie.jdField_a_of_type_Int = 0;
      QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 2, "mGender  is null. set 0  ");
      break label319;
    }
    label593:
    paramarie.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
    ...
    if (paramMatchUinData.rpt_tag.has())
    {
      ...
      while (i < paramMatchUinData.rpt_tag.size())
      {
        if (((oidb_0xe03.ProfileTagInfo)paramMatchUinData.rpt_tag.get(i)).bytes_tag.has())
        {
          ...
          localarji.jdField_a_of_type_Int = k;
          localarji.jdField_a_of_type_JavaLangString = ((String)localObject2);
          ((ArrayList)localObject1).add(localarji);
        }
        i += 1;
      }
    }
    paramarie.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
    if (paramMatchUinData.uint32_distance.has())
    {
      i = paramMatchUinData.uint32_distance.get();
      label755:
      paramarie.jdField_c_of_type_Int = i;
      i = j;
      if (paramMatchUinData.uint32_match_pool.has()) {
        i = paramMatchUinData.uint32_match_pool.get();
      }
      paramarie.jdField_d_of_type_Int = i;
      if (!paramMatchUinData.str_from_city_name.has()) {
        break label876;
      }
      localObject1 = paramMatchUinData.str_from_city_name.get();
      label805:
      paramarie.j = ((String)localObject1);
    ...
    {
      paramarie.k = paramMatchUinData;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "ChatFriendInfo. " + paramarie.toString());
      return;
      i = -1;
      break label755;
      localObject1 = "";
  ...
  private void a(Object[] paramArrayOfObject, String paramString)
  {
    if (((paramArrayOfObject instanceof Object[])) && (paramArrayOfObject.length == 9))
    {
      ...
      paramArrayOfObject = arom.a(this.app);
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramFromServiceMsg = (arhi)this.mApp.getManager(264);
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramObject = (arhi)this.mApp.getManager(264);
      if (paramObject != null) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.uint32_flare_switch.has())
        {
          ...
          if ((k == 1) && (i == 1))
          {
            if (((arhi)this.app.getManager(264)).c())
            {
              paramToServiceMsg = "1";
              bcef.b(null, "dc00898", "", "", "0X800AE9B", "0X800AE9B", 0, 0, "", paramToServiceMsg, "", "");
            }
          }
          else
          {
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((j == 0) || (j == 33))
    {
      ...
      {
        bool1 = true;
        arom localarom = arom.a(this.app);
        localarom.a(1, paramObject);
        localarom.a(2, str2);
        localarom.a(0, paramToServiceMsg);
        localarom.a(k);
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord != null) && ((paramMessageRecord instanceof MessageForLimitChatConfirm)))
    {
      ...
      {
        localObject1 = new ariz();
        ((ariz)localObject1).jdField_a_of_type_Boolean = paramMessageRecord.bEnterMsg;
        ((ariz)localObject1).jdField_a_of_type_Int = paramMessageRecord.leaveChatType;
        ((ariz)localObject1).jdField_a_of_type_Long = paramMessageRecord.timeStamp;
        ((ariz)localObject1).jdField_a_of_type_JavaLangString = paramMessageRecord.frienduin;
        ((ariz)localObject1).jdField_b_of_type_JavaLangString = paramMessageRecord.SenderNickName;
        ((ariz)localObject1).jdField_d_of_type_Int = paramMessageRecord.c2cExpiredTime;
        ((ariz)localObject1).jdField_b_of_type_Int = paramMessageRecord.leftChatTime;
        ((ariz)localObject1).jdField_c_of_type_JavaLangString = paramMessageRecord.tipsWording;
        ((ariz)localObject1).jdField_c_of_type_Int = paramMessageRecord.matchExpiredTime;
        ((ariz)localObject1).jdField_b_of_type_Long = paramMessageRecord.readyTs;
        QLog.i("ExtendFriendHandlerExtendFriendLimitChat", 2, "HandleC2CConfirmOrCancelMsg  info：" + ((ariz)localObject1).toString());
        i = 1;
        j = i;
        if (!bfwr.b(paramMessageRecord.issend)) {
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      QQToast.a(this.app.getApp(), 1, 2131694062, 0).a();
    ...
    new bgol("QC.UniBusinessLogicServer.UniBusinessLogicObj", "QCUniBusinessLogic.UniSetExtFriend").a("UniSetExtFriend", new UniSetExtFriendReq(bgol.a(), new UniBusinessItem(304, paramInt4), new ExtendFriend(paramInt2)), new UniSetExtFriendRsp(), new arhh(this, paramString1, paramInt4, paramInt2), true);
    try
    {
  ...
  public void a(String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2, long paramLong, String paramString3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localReqBody.bytes_req_buff.set(ByteStringMicro.copyFrom(blbc.a().a()));
      ...
      if ((!TextUtils.isEmpty(paramString3)) && (paramString3.equals(paramString1)))
      {
        ...
        {
          paramInt = 1;
          bcef.b(paramString1, "dc00898", "", "", "0X8009423", "0X8009423", paramInt, 0, "", "", paramString2, "");
          return;
  ...
  public void a(submsgtype0x128.MsgBody paramMsgBody, boolean paramBoolean)
  {
    if (paramMsgBody != null)
    {
      ...
      localariy.jdField_a_of_type_JavaLangString = this.app.getCurrentUin();
      localariy.jdField_a_of_type_ArrayOfByte = paramMsgBody.bytes_sig.get().toByteArray();
      String str;
      label91:
      long l;
      label117:
      ...
      if (paramMsgBody.uint64_match_uin.has())
      {
        ...
        localariy.jdField_a_of_type_Arie.jdField_a_of_type_JavaLangString = localariy.jdField_b_of_type_JavaLangString;
        a(paramMsgBody.msg_match_uin_data, localariy.jdField_a_of_type_Arie);
      }
      for (;;)
      {
        str = "";
        ...
        localariy.e = paramMsgBody;
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleGetUnlimitMatchOfflinePush push matchInfo = ", localariy + "bUnlimitMatchPush：" + paramBoolean });
        }
        paramMsgBody = (armn)this.app.getManager(292);
        if (paramMsgBody != null) {
          paramMsgBody.a();
        }
        if (!paramBoolean) {
        ...
        notifyUI(16, true, new Object[] { localariy });
        return;
        str = "0";
        break;
        label472:
        ...
        break label243;
        label504:
        localariy.jdField_b_of_type_Int = 1;
      ...
      label570:
      ((arhi)this.mApp.getManager(264)).a(localariy);
      notifyUI(23, true, new Object[] { localariy.jdField_b_of_type_JavaLangString });
      return;
    }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((PBUInt32Field)localObject2).set(i);
        localObject2 = (arhi)this.mApp.getManager(264);
        if (localObject2 != null)
        {
          localObject2 = ((arhi)localObject2).a();
          if (localObject2 != null)
          {
            oidb_0xdb1.LBSInfo localLBSInfo = new oidb_0xdb1.LBSInfo();
            oidb_0xdb1.GPS localGPS = new oidb_0xdb1.GPS();
            localGPS.int32_lon.set(((arii)localObject2).jdField_b_of_type_Int);
            localGPS.int32_lat.set(((arii)localObject2).jdField_a_of_type_Int);
            localGPS.int32_alt.set(((arii)localObject2).jdField_c_of_type_Int);
            localGPS.int32_type.set(((arii)localObject2).jdField_d_of_type_Int);
            localLBSInfo.msg_gps.set(localGPS);
  ...
  public boolean a(int paramInt, arii paramarii)
  {
    arii localarii = paramarii;
    if (paramarii == null) {
      localarii = ((arhi)this.mApp.getManager(264)).a();
    }
    ...
    try
    {
      ...
      paramarii = new oidb_0xe03.ReqBody();
      paramarii.uint64_uin.set(a((String)localObject, "openSignalBomb"));
      paramarii.enum_matchopcode.set(6);
      paramarii.uint32_tag_id.set(0);
      paramarii.uint32_sex.set(paramInt);
      if (((arhi)this.mApp.getManager(264) != null) && (localarii != null))
      {
        localObject = new oidb_0xe03.LBSInfo();
        oidb_0xe03.GPS localGPS = new oidb_0xe03.GPS();
        localGPS.int32_lon.set(localarii.jdField_b_of_type_Int);
        localGPS.int32_lat.set(localarii.jdField_a_of_type_Int);
        localGPS.int32_alt.set(localarii.jdField_c_of_type_Int);
        localGPS.int32_type.set(localarii.jdField_d_of_type_Int);
        ((oidb_0xe03.LBSInfo)localObject).msg_gps.set(localGPS);
        paramarii.msg_lbs_info.set((MessageMicro)localObject);
        QLog.d("ExtendFriendHandler", 1, "openSignalBomb. with msg_lbs_info info ");
      }
      paramarii = makeOIDBPkg("OidbSvc.0xe03", 3587, 0, paramarii.toByteArray());
      paramarii.extraData.putInt("match_op", 6);
      sendPbReq(paramarii);
      return true;
    }
    catch (NumberFormatException paramarii)
    {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "openSignalBomb. error = " + paramarii);
    }
    return false;
  }
  
  public boolean a(arii paramarii)
  {
    try
    {
      ...
      if (paramarii != null)
      {
        ...
        localGPS.int32_lon.set(paramarii.jdField_b_of_type_Int);
        localGPS.int32_lat.set(paramarii.jdField_a_of_type_Int);
        localGPS.int32_alt.set(paramarii.jdField_c_of_type_Int);
        localGPS.int32_type.set(paramarii.jdField_d_of_type_Int);
        localLBSInfo.msg_gps.set(localGPS);
        localReqBody.msg_lbs_info.set(localLBSInfo);
        QLog.i("ExtendFriendHandler", 1, "EnterExtendFriend. with msg_lbs_info info ");
      }
      paramarii = makeOIDBPkg("OidbSvc.0xe67", 3687, 1, localReqBody.toByteArray());
      paramarii.extraData.putInt("uint32_action", 1);
      sendPbReq(paramarii);
      return true;
    }
    catch (NumberFormatException paramarii)
    {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "EnterExtendFriend. error = " + paramarii);
    }
    return false;
  }
  ...
  public void b()
  {
    notifyUI(17, true, Integer.valueOf(avod.a(this.app)));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localarjk = new arjk();
          localarjk.mUin = String.valueOf(localStrangerInfo.uint64_uin.get());
          localarjk.mNickName = localStrangerInfo.bytes_nick.get().toStringUtf8();
          localarjk.mGender = localStrangerInfo.uint32_gender.get();
          if (localStrangerInfo.uint32_is_my_like.get() != 1) {
            break label1731;
          }
          bool4 = true;
          localarjk.mLiked = bool4;
          localarjk.mAvailLikeCount = localStrangerInfo.uint32_my_left_like_count.get();
          if (localStrangerInfo.uint32_addfri_status.get() != 1) {
            break label1737;
          }
          bool4 = true;
          localarjk.mAddFriendVerified = bool4;
          localarjk.mPopularity = localStrangerInfo.uint32_popularity.get();
          localarjk.mDeclaration = localStrangerInfo.bytes_declaration.get().toStringUtf8();
          localarjk.mVoiceUrl = localStrangerInfo.bytes_voice_url.get().toStringUtf8();
          localarjk.mVoiceDuration = localStrangerInfo.uint32_voice_duration.get();
          if (localStrangerInfo.uint32_vote_switch.get() != 0) {
            break label1743;
          }
          bool4 = true;
          localarjk.mbAllowStrangerVote = bool4;
          localarjk.mStrRecomTrace = localStrangerInfo.str_recom_trace.get();
          localarjk.voiceCode = localStrangerInfo.bytes_voice_code.get().toByteArray();
          ...
          localarjk.fontId = paramToServiceMsg.fontid.get();
          localarjk.fontType = paramToServiceMsg.fonttype.get();
          localarjk.clothesId = paramToServiceMsg.itemid.get();
          if (!TextUtils.isEmpty(localarjk.mDeclaration))
          {
            localarjk.mDeclaration = localarjk.mDeclaration.replace('\n', ' ');
            localarjk.mDeclaration = localarjk.mDeclaration.trim();
          }
          if (localStrangerInfo.uint32_show_vip_info_flag.get() != 0) {
            break label1749;
          }
          bool4 = true;
          localarjk.mVipHide = bool4;
          if (localStrangerInfo.uint32_bigvip_open.get() != 0) {
            break label1755;
          }
          bool4 = true;
          localarjk.mBigVipHide = bool4;
          localarjk.mBigVipLevel = localStrangerInfo.uint32_bigvip_level.get();
          localarjk.mVipType = localStrangerInfo.uint32_vip_flag.get();
          localarjk.mVipLevel = localStrangerInfo.uint32_svip_level.get();
          localarjk.mTemplateId = localStrangerInfo.uint32_vipicon_id.get();
          ...
          label659:
          localarjk.mAlumbasicdata = paramToServiceMsg;
          localarjk.mAge = localStrangerInfo.uint32_age.get();
          localarjk.mLabelInfos = new ArrayList();
          Object localObject3;
          if (localStrangerInfo.rpt_label_info.has())
          {
            ...
            {
              localObject3 = new arjl();
              ((arjl)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.labelInfo)localStrangerInfo.rpt_label_info.get().get(i)).uint64_label_id.get();
              ...
              label812:
              ((arjl)localObject3).jdField_a_of_type_JavaLangString = paramToServiceMsg;
              localarjk.mLabelInfos.add(localObject3);
              i += 1;
              continue;
            }
          }
          localarjk.mSchoolInfos = new ArrayList();
          if (localStrangerInfo.rpt_school_info.has())
          {
            i = 0;
            if (i < localStrangerInfo.rpt_school_info.get().size())
            {
              localObject3 = new arjm();
              ((arjm)localObject3).jdField_a_of_type_JavaLangString = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).str_school_id.get();
              ((arjm)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).uint64_state.get();
              ...
              ((arjm)localObject3).jdField_b_of_type_JavaLangString = paramToServiceMsg;
              if (QLog.isColorLevel()) {
                QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: schoolId " + ((arjm)localObject3).jdField_a_of_type_JavaLangString + " schoolName " + ((arjm)localObject3).jdField_b_of_type_JavaLangString + " authState " + ((arjm)localObject3).jdField_a_of_type_Long);
              }
              localarjk.mSchoolInfos.add(localObject3);
              i += 1;
              continue;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: " + localarjk.mUin + " " + localStrangerInfo.uint32_vip_flag.get() + " " + localStrangerInfo.uint32_svip_level.get());
          }
          if ((TextUtils.isEmpty(localarjk.mNickName)) && (localarjk.mAlumbasicdata == null)) {
            break label1252;
          }
          localArrayList.add(localarjk);
          continue;
          aroq.a().c(paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode());
        }
        catch (Exception paramToServiceMsg)
        {
          if (QLog.isColorLevel()) {
        ...
        return;
        if (QLog.isColorLevel()) {
          QLog.w("ExtendFriendHandler", 2, String.format("handleGetSquareStrangerList nick name is empty, uin=%s", new Object[] { localarjk.mUin }));
        }
      }
      paramToServiceMsg = new arix();
      ...
      if (n <= 12)
      {
        ...
        {
          paramToServiceMsg.jdField_a_of_type_JavaUtilList.add(((arjk)((List)localObject1).get(i)).mUin);
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      if (i < n)
      {
        ...
        break label1782;
        if (this.app != null) {
          ((armn)this.app.getManager(292)).a(true, paramToServiceMsg);
        }
        if (QLog.isColorLevel()) {
  ...
  public boolean b()
  {
    try
    {
      ...
      Object localObject2 = (arhi)this.mApp.getManager(264);
      if (localObject2 != null)
      {
        localObject2 = ((arhi)localObject2).a();
        if (localObject2 != null)
  ...
  public boolean b(String paramString)
  {
    ...
    try
    {
      ...
      paramString = (arhi)this.mApp.getManager(264);
      if (paramString != null)
      {
      ...
      catch (InvalidProtocolBufferMicroException paramObject)
      {
        try
        {
          ...
          if (localRspBody.rpt_label_info.has())
          {
            ...
            {
              localObject1 = new arjl();
              ((arjl)localObject1).jdField_a_of_type_Long = ((GetExtendFriendInfo.labelInfo)localRspBody.rpt_label_info.get().get(i)).uint64_label_id.get();
              ...
              ((arjl)localObject1).jdField_a_of_type_JavaLangString = paramFromServiceMsg;
      ...
      if (i == 0) {
        if (localRspBody.uint64_allow_kuolie.has())
        {
          ...
          if (this.app != null)
          {
            ...
            arnn.a(this.app, bool2, j, i, paramToServiceMsg, l2);
            if (bool2) {
          ...
          bool3 = true;
          label257:
          armn.b(this.app, Boolean.valueOf(bool3));
          if (QLog.isColorLevel()) {
  ...
  public void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (localRspBody.enum_matchopcode.has())
    {
      ...
      paramToServiceMsg = (arhi)this.mApp.getManager(264);
      if (paramToServiceMsg != null) {
      ...
      localObject2 = new ariy();
      ((ariy)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(localRspBody.uint64_uin.get());
      ((ariy)localObject2).jdField_a_of_type_ArrayOfByte = ((oidb_0xe03.MatchInfo)localObject1).bytes_sig.get().toByteArray();
      ...
      ((ariy)localObject2).jdField_b_of_type_JavaLangString = paramToServiceMsg;
      ...
      label456:
      ((ariy)localObject2).jdField_a_of_type_Int = k;
      ...
      label486:
      ((ariy)localObject2).jdField_d_of_type_JavaLangString = paramToServiceMsg;
    ...
    for (paramToServiceMsg = ((oidb_0xe03.MatchInfo)localObject1).string_report_id.get();; paramToServiceMsg = "")
    {
      ...
      ((ariy)localObject2).e = ((String)localObject1);
      if (localRspBody.msg_match_info.msg_tag.has()) {
        if (localRspBody.msg_match_info.msg_tag.uint32_tag_id.has())
        {
          ((ariy)localObject2).jdField_b_of_type_Int = localRspBody.msg_match_info.msg_tag.uint32_tag_id.get();
          label594:
          if (localRspBody.msg_match_info.msg_tag.bytes_tag.has()) {
            ((ariy)localObject2).f = localRspBody.msg_match_info.msg_tag.bytes_tag.get().toStringUtf8();
          }
          label633:
          if (!localRspBody.msg_match_info.msg_match_uin_data.has()) {
            break label942;
          }
          if (((ariy)localObject2).jdField_a_of_type_Arie == null)
          {
            ((ariy)localObject2).jdField_a_of_type_Arie = new arie();
            ((ariy)localObject2).jdField_a_of_type_Arie.jdField_a_of_type_JavaLangString = ((ariy)localObject2).jdField_b_of_type_JavaLangString;
          }
          a(localRspBody.msg_match_info.msg_match_uin_data, ((ariy)localObject2).jdField_a_of_type_Arie);
          label697:
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleMatchResponse type =" + m, " uin = ", str, ", match_op = ", Integer.valueOf(i), " retCode = ", Integer.valueOf(j), " matchInfo = ", ((ariy)localObject2).toString(), " errMsg = ", paramObject });
          }
      ...
      for (;;)
      {
        ...
        if (m == 13)
        {
          if (localRspBody.uint32_switch.has())
          {
            ...
            localObject1 = new arjn();
            localObject2 = (oidb_0xe03.TagInfo)localRspBody.rpt_tag.get(k);
            ((arjn)localObject1).jdField_a_of_type_Int = ((oidb_0xe03.TagInfo)localObject2).uint32_tag_id.get();
            ...
            label1326:
            ((arjn)localObject1).jdField_a_of_type_JavaLangString = paramToServiceMsg;
          ...
          {
            ((arjn)localObject1).jdField_b_of_type_Int = m;
          ...
          for (boolean bool3 = true;; bool3 = false)
          {
            ...
            armn.a(this.app, Boolean.valueOf(bool1));
            armn.b(this.app, Boolean.valueOf(bool2));
            armn.a(this.app, paramObject);
            if (!QLog.isColorLevel()) {
              break;
            }
        ...
        {
          ((arhi)this.mApp.getManager(264)).h();
          if (QLog.isColorLevel()) {
