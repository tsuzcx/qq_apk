  ...
  implements UpCallBack
{
  ...
  public adwg(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString, int paramInt, ArrayList paramArrayList, HashMap paramHashMap)
  {
  ...
  public void b(UpCallBack.SendResult paramSendResult)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          str1 = String.format(((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getApplication().getString(2131438917), new Object[] { ContactUtils.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int) });
          continue;
        }
