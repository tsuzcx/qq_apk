...
public class tga
{
  ...
  public static tga a(List<tga> paramList, long paramLong)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramLong == localtga.jdField_a_of_type_Long) {
        return localtga;
      }
    }
    return null;
  ...
  public void a(@NonNull JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem = ((tcz)tdc.a(5)).a(this.jdField_a_of_type_JavaLangString);
      }
      return;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof tga)) {
        return false;
      }
      paramObject = (tga)paramObject;
