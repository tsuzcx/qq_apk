  ...
  implements Manager
{
  ...
  public atvt(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean a(awbw paramawbw, awbv paramawbv)
  {
    boolean bool = false;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          List localList = localawbw.a(ShieldListInfo.class);
          int i;
          if (localList == null)
          {
            i = 0;
  ...
  {
    alxw localalxw = (alxw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(18);
    ...
    localalxw.a(paramInt1, arrayOfLong, paramInt2);
  }
  ...
  public boolean a(List<ShieldListInfo> paramList)
  {
    ...
    for (;;)
    {
        ...
        try
        {
          ...
          if ((localShieldListInfo2 != null) && ((localShieldListInfo2.getStatus() == 1001) || (localShieldListInfo2.getStatus() == 1002))) {
            if (localShieldListInfo1.flags != localShieldListInfo2.flags)
            {
              ...
              a(localawbw, localShieldListInfo2);
            }
          }
        }
      ...
      a(localawbw, localShieldListInfo1);
  ...
  public void b(int paramInt1, List<Long> paramList, int paramInt2)
  {
    ...
    localalxw.b(paramInt1, arrayOfLong, paramInt2);
  }
