  ...
  extends BusinessHandler
{
  ...
  public abhu a;
  private abib jdField_a_of_type_Abib = new abkx(this);
  public abkq a;
  private abku jdField_a_of_type_Abku;
  public abkv a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new abky(this);
  aodj jdField_a_of_type_Aodj = new abkz(this);
  public HashMap<String, List<abib>> a;
  ...
  public abkw(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Abib);
    this.jdField_a_of_type_Abku = new abku(paramQQAppInterface);
    this.jdField_a_of_type_Abkq = new abkq(paramQQAppInterface);
    this.jdField_a_of_type_Abhu = new abhu();
    this.jdField_a_of_type_Abkv = new abkv(paramQQAppInterface);
    a(f, this.jdField_a_of_type_Abhu);
    a(e, this.jdField_a_of_type_Abhu);
    a(g, this.jdField_a_of_type_Abhu);
    a(g, this.jdField_a_of_type_Abkq);
    a(g, this.jdField_a_of_type_Abkv);
    a(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Abku);
    a(c, this.jdField_a_of_type_Abku);
    a(d, this.jdField_a_of_type_Abku);
    a(h, this.jdField_a_of_type_Abku);
    a("8000-NASDevMusicFile", this.jdField_a_of_type_Abku);
    a("8001-NASDevVideoFile", this.jdField_a_of_type_Abku);
    a("8002-NASDevDocumentFile", this.jdField_a_of_type_Abku);
    a("8003-NASDevCommonFile", this.jdField_a_of_type_Abku);
    a("", this.jdField_a_of_type_Abku);
    a("", this.jdField_a_of_type_Abhu);
  ...
  private void a()
  {
    DeviceInfo[] arrayOfDeviceInfo = ((abgm)this.app.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a();
  ...
  {
    MessageForDeviceText localMessageForDeviceText = (MessageForDeviceText)bcsa.a(-4508);
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong)
  {
    ...
    String str = admg.jdField_a_of_type_JavaLangString + "http://maps.google.com/maps?q=" + paramString2 + "," + paramString3 + "&iwloc=A&hl=zh-CN (" + paramString5 + ")";
    if (!paramContext.getResources().getString(2131695829).equals(paramString4)) {}
    for (paramContext = paramContext.getResources().getString(2131691256) + " " + paramString4;; paramContext = paramContext.getResources().getString(2131691256))
    {
      ...
      paramContext = new bdnr(StructMsgForGeneralShare.class).c(32).a(paramContext).d(str).a("plugin", paramString2, paramString2, paramString2, paramString2).a();
      ...
      paramContext = bcsa.a(this.app, this.app.getCurrentAccountUin(), paramString1, this.app.getCurrentAccountUin(), 9501, 100L, paramContext);
  ...
  private void b(String paramString, long paramLong)
  {
    ...
    ((MessageHandler)this.app.getBusinessHandler(BusinessHandlerFactory.MESSAGE_HANDLER)).notifyUI(MessageHandler.a(paramString.istroop), false, new Object[] { str, Integer.valueOf(i), Integer.valueOf(-1), null, Long.valueOf(0L), Long.valueOf(paramLong) });
  }
  
  public abhu a()
  {
    return this.jdField_a_of_type_Abhu;
  }
  
  public abkq a()
  {
    return this.jdField_a_of_type_Abkq;
  }
  
  public abku a()
  {
    return this.jdField_a_of_type_Abku;
  }
  
  public abkv a()
  {
    return this.jdField_a_of_type_Abkv;
  }
  ...
  public void a(DataPoint paramDataPoint)
  {
    try
    {
      ...
      long l = ((JSONObject)localObject).optLong("msg_time", bcrg.a());
  ...
  {
    ArrayList localArrayList = bhbx.a(paramString, 560, 20, null, new ArrayList());
    int i = 0;
    if (i < localArrayList.size())
    {
      ...
      paramString = "";
      if (str1 != null) {
        paramString = bcsc.a(str1, true, null);
      }
      int j = (int)bcrg.a();
      ...
      localMessageForDeviceText.shmsgseq = bcsc.a(i, paramSessionInfo.curType);
      ...
      for (;;)
      {
        if (localMessageForDeviceText.extraflag != 32768)
        {
          ...
          ((abgm)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(localMessageForDeviceText.msg, Long.parseLong(localMessageForDeviceText.frienduin), l, localMessageForDeviceText.msgseq);
        }
        i += 1;
        break;
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    default: 
      paramInt = i;
      localMessageForGrayTips = (MessageForGrayTips)bcsa.a(paramInt);
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      i = -5001;
      localMessageForNewGrayTips = (MessageForNewGrayTips)bcsa.a(i);
  ...
  public boolean a(String paramString, abib paramabib)
  {
    ...
    if (!((List)localObject).contains(paramabib)) {
      ((List)localObject).add(paramabib);
    }
    return true;
  }
  
  public boolean b(String paramString, abib paramabib)
  {
    paramString = (List)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {
      paramString.remove(paramabib);
    }
    return true;
  }
  ...
  {
    super.onDestroy();
    b(f, this.jdField_a_of_type_Abhu);
    b(e, this.jdField_a_of_type_Abhu);
    b(g, this.jdField_a_of_type_Abhu);
    b(g, this.jdField_a_of_type_Abkq);
    b(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Abku);
    b(c, this.jdField_a_of_type_Abku);
    b(d, this.jdField_a_of_type_Abku);
    b(h, this.jdField_a_of_type_Abku);
    b("8000-NASDevMusicFile", this.jdField_a_of_type_Abku);
    b("8001-NASDevVideoFile", this.jdField_a_of_type_Abku);
    b("8002-NASDevDocumentFile", this.jdField_a_of_type_Abku);
    b("8003-NASDevCommonFile", this.jdField_a_of_type_Abku);
    b("", this.jdField_a_of_type_Abku);
    b("", this.jdField_a_of_type_Abhu);
    this.app.removeObserver(this.jdField_a_of_type_Abib);
    this.app.getApp().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
    this.app.removeObserver(this.jdField_a_of_type_Aodj);
    this.jdField_a_of_type_Abku = null;
    this.jdField_a_of_type_Abkq = null;
    this.jdField_a_of_type_Abhu = null;
    this.jdField_a_of_type_Abkv = null;
  }
