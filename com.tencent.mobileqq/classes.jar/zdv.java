...
public class zdv
{
  ...
  public static String a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, Bundle paramBundle)
  {
    ...
    localStringBuilder.append("&version=").append("8.3.5");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramBaseActivity.append("android").append("_").append("8.3.5").append("_").append(paramInt).append("_").append(paramString2);
        paramString2 = paramBaseActivity.toString();
        paramString11 = bflr.d(paramString2).toUpperCase();
        if (QLog.isColorLevel()) {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramList != null)
      {
        ...
        for (;;)
        {
          ...
          {
            paramList = new bamp(paramList.msg, 3).a();
            localObject2 = "1";
            i = 0;
            break label391;
          }
  ...
  public static void a(BaseActivity paramBaseActivity, long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, Bundle paramBundle)
  {
    ...
    bety localbety = new bety(paramBaseActivity, paramBaseActivity.getTitleBarHeight());
    try
    {
      localbety.show();
      if (paramLong <= 0L)
      {
        ...
        ((auur)paramBaseActivity.getAppInterface().getManager(204)).a(Long.parseLong(paramString1), new zdw(paramBaseActivity, paramString1, paramString2, paramInt, paramString3, localbety, paramBundle, paramLong));
        return;
      }
    }
    catch (Exception localException)
    {
      ...
      b(paramBaseActivity, String.valueOf(paramLong), paramString1, paramString2, c(paramInt), b(paramInt, paramString3), localbety, paramBundle);
    }
  }
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, String paramString6, Bundle paramBundle)
  {
    ...
    {
      localbety.show();
      ThreadManager.excute(new NewReportPlugin.3(paramInt, paramBaseActivity, paramString1, paramString4, paramBundle, paramString2, paramString3, paramString5, paramString6, localbety), 16, null, false);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static String b(String paramString1, String paramString2)
  {
    ...
    try
    {
      str = bdeu.a(a(paramString1.getBytes("utf-8"), paramString2, 1));
      return str;
    }
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, bety parambety, Bundle paramBundle)
  {
    ThreadManager.excute(new NewReportPlugin.2(paramBundle, paramString4, paramInt, paramBaseActivity, paramString2, paramString3, paramString1, parambety), 16, null, false);
  }
  ...
  public static String c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        paramString1 = bdeu.a(paramString1);
