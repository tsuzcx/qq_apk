...
public class zdv
{
  ...
  public static final String a(String paramString)
  {
    ...
    File localFile = new File(wes.f);
    if ((!localFile.exists()) || (!localFile.isDirectory())) {
      localFile.mkdirs();
    }
    paramString = wes.f + bkdr.a(paramString) + "." + zkr.c(paramString);
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt)
  {
    ...
    localIntent.putExtra("url", String.format("https://ti.qq.com/music/index.html?_wv=5&_bid=2831&device_id=%s&client_ip=%s&bustype=%s", new Object[] { bgln.a(), "", Integer.valueOf(paramInt) }));
