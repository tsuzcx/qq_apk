  ...
  extends BusinessHandler
{
  ...
  private lfq jdField_a_of_type_Lfq = lfq.a();
  private lfu jdField_a_of_type_Lfu = lfu.a();
  private boolean jdField_a_of_type_Boolean;
  
  public lfs(AppInterface paramAppInterface)
  {
  ...
  public String a()
  {
    return String.valueOf(this.jdField_a_of_type_Lfu.jdField_a_of_type_Long);
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong, String paramString3)
  {
    ...
    for (Object localObject1 = "0";; localObject1 = paramString3)
    {
      ...
      localObject2 = this.jdField_a_of_type_Lfq;
      localToServiceMsg.putWupBuffer(lfq.a(localInfoHead.toByteArray(), ((AudioTransClientTransInfo.InfoReqBody)localObject1).toByteArray()));
      boolean bool = NetworkUtil.isNetworkAvailable(this.mApp.getApplication().getApplicationContext());
      if (bool) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   4: ifeq +641 -> 645
    //   7: aload_0
    //   8: getfield 28	lfs:jdField_a_of_type_Lfq	Llfq;
    //   11: astore_1
    //   12: aload_2
    //   13: invokevirtual 266	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   16: invokestatic 269	lfq:a	([B)Llfr;
    //   19: astore_2
    //   20: aload_2
    //   21: getfield 274	lfr:a	[B
    //   24: astore_1
    //   25: aload_2
    //   26: getfield 276	lfr:b	[B
    //   29: astore_2
    ...
    //   101: astore_2
    //   102: aload_0
    //   103: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   106: aload_2
    ...
    //   113: putfield 308	lfu:jdField_a_of_type_Int	I
    //   116: aload_0
    //   117: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   120: aload_2
    ...
    //   127: putfield 313	lfu:b	I
    //   130: aload_0
    //   131: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   134: aload_1
    ...
    //   147: putfield 40	lfu:jdField_a_of_type_Long	J
    //   150: aload_2
    ...
    //   157: astore_1
    //   158: aload_0
    //   159: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   162: new 332	java/util/ArrayList
    //   165: dup
    //   166: invokespecial 333	java/util/ArrayList:<init>	()V
    //   169: putfield 336	lfu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   172: aload_0
    //   173: invokevirtual 338	lfs:b	()Z
    //   176: istore 5
    //   178: ldc 212
    //   180: iconst_1
    ...
    //   205: aload_0
    //   206: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    ...
    //   229: aload_0
    //   230: getfield 48	lfs:jdField_a_of_type_Boolean	Z
    ...
    //   272: astore_2
    //   273: new 371	com/tencent/avcore/jni/data/NetAddr
    //   276: dup
    //   277: invokespecial 372	com/tencent/avcore/jni/data/NetAddr:<init>	()V
    //   280: astore_3
    //   281: aload_3
    //   282: aload_2
    ...
    //   289: putfield 381	com/tencent/avcore/jni/data/NetAddr:fixed32_IP	I
    //   292: aload_3
    //   293: aload_2
    ...
    //   300: putfield 386	com/tencent/avcore/jni/data/NetAddr:uint32_port	I
    //   303: aload_3
    //   304: aload_2
    ...
    //   311: putfield 391	com/tencent/avcore/jni/data/NetAddr:enum_proto_type	I
    //   314: aload_3
    //   315: aload_2
    ...
    //   322: putfield 396	com/tencent/avcore/jni/data/NetAddr:fixed32_inner_IP	I
    //   325: aload_0
    //   326: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   329: getfield 336	lfu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   332: aload_3
    ...
    //   352: astore_3
    //   353: aload_0
    //   354: getfield 28	lfs:jdField_a_of_type_Lfq	Llfq;
    //   357: astore 6
    //   359: aload_3
    //   360: aload_2
    ...
    //   367: invokestatic 405	lfq:a	(I)Ljava/lang/String;
    ...
    //   411: astore_3
    //   412: aload_0
    //   413: getfield 28	lfs:jdField_a_of_type_Lfq	Llfq;
    //   416: astore 6
    //   418: ldc 212
    //   420: iconst_2
    //   421: aload_3
    ...
    //   429: invokestatic 405	lfq:a	(I)Ljava/lang/String;
    ...
    //   490: goto -340 -> 150
    //   493: aload_0
    //   494: getfield 82	lfs:mApp	Lcom/tencent/common/app/AppInterface;
    //   497: iconst_0
    //   498: invokevirtual 430	com/tencent/common/app/AppInterface:getBusinessHandler	(I)Ljava/lang/Object;
    //   501: checkcast 432	lfv
    //   504: iload 4
    //   506: i2l
    //   507: iconst_1
    //   508: aload_0
    //   509: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   512: getfield 336	lfu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   515: aload_0
    //   516: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   519: getfield 40	lfu:jdField_a_of_type_Long	J
    //   522: invokevirtual 435	lfv:a	(JZLjava/util/List;J)V
    //   525: aload_0
    //   526: iconst_1
    //   527: putfield 48	lfs:jdField_a_of_type_Boolean	Z
    //   530: iload 5
    //   532: ifeq -54 -> 478
    //   535: aload_0
    //   536: iload 4
    //   538: i2l
    //   539: aload_0
    //   540: getfield 35	lfs:jdField_a_of_type_Lfu	Llfu;
    //   543: getfield 40	lfu:jdField_a_of_type_Long	J
    //   546: invokevirtual 437	lfs:a	(JJ)V
    //   549: return
    //   550: aload_2
