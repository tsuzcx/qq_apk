...
public class rsk
{
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    if (3 == paramInt)
    {
      if (((Boolean)bgmq.a(paramString, Boolean.valueOf(false))).booleanValue()) {
        return;
      }
      bgmq.a(paramString, Boolean.valueOf(true));
    }
    rtr.a(200, localArrayList);
  }
    ...
    try
    {
      ...
      if ((paramMap != null) && (paramMap.entrySet() != null))
      {
        ...
        while ((paramMap != null) && (paramMap.hasNext()))
        {
          ...
          continue;
          ndn.a(null, obz.c(paramArticleInfo), paramString1, paramString2, 0, 0, qoe.a(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), paramMap, false);
        }
      }
    }
    catch (Exception paramMap)
    {
      aciy.a("ProteusReportUtil", "reportClickEvent", new IllegalArgumentException(paramMap));
      paramMap = null;
    }
    for (;;)
    {
  ...
  {
    paramBaseArticleInfo = pol.a(paramBaseArticleInfo);
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    awrn.a(BaseApplicationImpl.getApplication()).a(null, "actKandianProteusShowFail", false, 0L, 0L, localHashMap, null);
  }
  ...
  {
    return bady.a(BaseApplicationImpl.getContext(), "com.tencent.weishi");
  }
}
