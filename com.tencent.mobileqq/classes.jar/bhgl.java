  ...
  extends PopupWindow
{
  ...
  public bhgl(Context paramContext)
  {
    super(paramContext, null, 2131755910);
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      localValueAnimator.addUpdateListener(new bhgo(this));
      localValueAnimator.addListener(new bhgp(this));
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setOnKeyListener(new bhgm(this));
    ...
    paramIBinder.addUpdateListener(new bhgn(this));
    paramIBinder.start();
  }
