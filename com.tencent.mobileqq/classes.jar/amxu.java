    ...
    case 1: 
      ...
      if ((localObject2 != null) && (localObject2.length > 0) && (!this.a.jdField_c_of_type_Boolean))
      {
        ...
        try
        {
          ...
          localObject5 = new amxw();
          ((amxw)localObject5).jdField_a_of_type_Boolean = true;
          ((amxw)localObject5).jdField_b_of_type_Int = this.a.jdField_f_of_type_Int;
          localObject6 = this.a;
          ((amxt)localObject6).jdField_f_of_type_Int += 1;
          ((amxw)localObject5).jdField_a_of_type_ComTencentYTFaceModelFaceStatus = localObject2[i];
          this.a.jdField_b_of_type_JavaUtilList.add(localObject5);
          localObject3[i] = localObject2[i].xys;
          if (!QLog.isColorLevel()) {
            break;
          }
          QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_DETECT_AND_RECOVER_FACE  add a tempFace ,faceInfo.faceID = " + ((amxw)localObject5).jdField_b_of_type_Int);
        }
        finally {}
    ...
    case 3: 
      ...
      synchronized (this.a.jdField_a_of_type_JavaLangObject)
      {
        ...
        do
        {
          ...
          localObject4 = (amxw)((Iterator)localObject3).next();
          if (!((amxw)localObject4).jdField_a_of_type_Boolean) {
            break label1243;
          }
          if ((QLog.isColorLevel()) && (amxt.jdField_a_of_type_Boolean)) {
          ...
          l2 = SystemClock.uptimeMillis();
          i = this.a.jdField_a_of_type_ComTencentYTFaceClusterFaceCluster.trackSingleFace2((byte[])localObject2, this.a.jdField_a_of_type_Int, this.a.jdField_b_of_type_Int, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus, this.a.jdField_c_of_type_Int);
          l2 = SystemClock.uptimeMillis() - l2;
          if ((QLog.isColorLevel()) && (amxt.jdField_a_of_type_Boolean))
          {
          ...
          if (QLog.isColorLevel()) {
            QLog.i("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Lost realFace  faceInfo.lostCount = " + ((amxw)localObject4).jdField_c_of_type_Int);
          }
          ((amxw)localObject4).jdField_c_of_type_Int += 1;
        } while (((amxw)localObject4).jdField_c_of_type_Int <= 0);
        ((amxw)localObject4).jdField_a_of_type_Boolean = false;
        ((amxw)localObject4).jdField_c_of_type_Int = 0;
        localObject4 = this.a;
        ((amxt)localObject4).d += 1;
      }
      ((amxw)localObject4).jdField_c_of_type_Int = 0;
      if ((QLog.isColorLevel()) && (amxt.jdField_a_of_type_Boolean)) {
        QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Track realFace success,update");
      }
      localObject5 = new amta();
      ((amta)localObject5).jdField_a_of_type_ArrayOfFloat = ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys;
      ((amta)localObject5).jdField_a_of_type_JavaLangString = ((amxw)localObject4).jdField_a_of_type_JavaLangString;
      ((amta)localObject5).jdField_a_of_type_AndroidGraphicsRect = new Rect(((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x + ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.width, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y + ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.height);
      ((amta)localObject5).jdField_a_of_type_AndroidGraphicsRectF = amta.a(((amta)localObject5).jdField_a_of_type_AndroidGraphicsRect, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys);
      ((amta)localObject5).jdField_a_of_type_Int = ((amxw)localObject4).jdField_b_of_type_Int;
      ((amta)localObject5).jdField_c_of_type_JavaLangString = ((amxw)localObject4).jdField_b_of_type_JavaLangString;
      ((amta)localObject5).jdField_b_of_type_JavaLangString = ((amxw)localObject4).jdField_c_of_type_JavaLangString;
      ((amta)localObject5).g = ((amxw)localObject4).f;
      if (((amxw)localObject4).jdField_a_of_type_Int != 2) {}
      break;
    }
    for (boolean bool = true;; bool = false)
    {
      ((amta)localObject5).jdField_b_of_type_Boolean = bool;
      if (((amta)localObject5).jdField_b_of_type_Boolean)
      {
        ((amta)localObject5).jdField_c_of_type_Boolean = this.a.a(((amta)localObject5).jdField_b_of_type_JavaLangString);
        if (((amta)localObject5).jdField_c_of_type_Boolean)
        {
          localObject6 = this.a.a(((amta)localObject5).jdField_b_of_type_JavaLangString);
          if (localObject6 != null)
          {
            ((amta)localObject5).h = ((ARScanStarFaceActInfo)localObject6).f;
            ((amta)localObject5).f = ((ARScanStarFaceActInfo)localObject6).jdField_e_of_type_JavaLangString;
          }
        }
        ((amta)localObject5).d = ((amxw)localObject4).jdField_e_of_type_JavaLangString;
        ((amta)localObject5).jdField_e_of_type_JavaLangString = ((amxw)localObject4).d;
      }
      ((amta)localObject5).jdField_a_of_type_Float = ((amxw)localObject4).jdField_a_of_type_Float;
      ...
      if (amxt.jdField_a_of_type_AndroidOsHandler.hasMessages(1)) {
      ...
      amxt.jdField_a_of_type_AndroidOsHandler.sendMessage((Message)localObject4);
      break label685;
      label1363:
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (((amxw)localObject4).jdField_a_of_type_Boolean)
        {
          ...
          {
            if ((QLog.isColorLevel()) && (amxt.jdField_a_of_type_Boolean)) {
              QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Track tmpFace success,update ,faceInfo.faceID = " + ((amxw)localObject4).jdField_b_of_type_Int);
            }
            localObject5 = new amta();
            ((amta)localObject5).jdField_a_of_type_ArrayOfFloat = ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys;
            ((amta)localObject5).jdField_a_of_type_JavaLangString = ((amxw)localObject4).jdField_a_of_type_JavaLangString;
            ...
            ((amta)localObject5).jdField_a_of_type_AndroidGraphicsRect = new Rect(((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x + ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.width, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y + ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.height);
            ((amta)localObject5).jdField_a_of_type_AndroidGraphicsRectF = amta.a(((amta)localObject5).jdField_a_of_type_AndroidGraphicsRect, ((amxw)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys);
            ((amta)localObject5).jdField_e_of_type_Boolean = true;
            paramMessage.add(localObject5);
          }
        }
      ...
      l2 = System.currentTimeMillis();
      if ((!this.a.jdField_c_of_type_Boolean) && (this.a.jdField_a_of_type_Amxv != null))
      {
        ??? = new amxx();
        ((amxx)???).jdField_a_of_type_JavaUtilArrayList = paramMessage;
        ((amxx)???).jdField_a_of_type_Long = this.a.jdField_b_of_type_Long;
        this.a.jdField_a_of_type_Amxv.a((amxx)???);
