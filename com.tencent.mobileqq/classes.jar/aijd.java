  ...
  extends alpd
{
  ...
  Comparator<RecentBaseData> jdField_a_of_type_JavaUtilComparator = new aije(this);
  ...
  public aijd(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<RecentBaseData> a(List<RecentUser> paramList, List<RecentBaseData> paramList1)
  {
    ...
    if (paramList == null)
    {
      ...
      Object localObject3 = ajjj.a(localRecentUser.uin, localRecentUser.getType());
      localObject2 = ajjj.a().a((String)localObject3);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        localObject1 = ajie.a(localRecentUser, this.app, BaseApplicationImpl.getContext());
        if (localObject1 != null) {
          ajjj.a().a((RecentBaseData)localObject1, (String)localObject3);
        }
      }
      if (localObject1 != null)
      {
        ...
        localObject3 = ((bema)this.app.a(107)).a("");
        if ((!((HotChatInfo)localObject2).isGameRoom) && (!((HotChatInfo)localObject2).troopUin.equals(((bemq)localObject3).a))) {
          break label241;
        }
      }
    }
  ...
  private void a(List<RecentUser> paramList)
  {
    ...
    for (Object localObject2 = this.app.a(true);; localObject2 = localObject1)
    {
      ...
      {
        localObject2 = ((alrk)this.app.getManager(53)).a(str);
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    if (((paramInt1 == 1) || (paramInt1 == 0) || (paramInt1 == 3000)) && (!a(paramInt2)))
    {
      ...
      if (!TextUtils.isEmpty(paramString)) {
        aijf.a().a(paramString, paramInt1);
      }
    }
  }
