  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      notifyObserver(paramIntent, i, bool1, localBundle, ameq.class);
      return;
      try
      {
        ...
        if (bool1)
        {
          ...
          paramFromServiceMsg.get((byte[])localObject1);
          localObject1 = String.valueOf(bdeu.a((byte[])localObject1, 0));
          Object localObject2 = new byte[4];
          paramFromServiceMsg.get((byte[])localObject2);
          localObject2 = String.valueOf(bdeu.a((byte[])localObject2, 0));
