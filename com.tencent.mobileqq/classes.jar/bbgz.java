  ...
  implements View.OnClickListener
{
  ...
  public bbgz(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new bbhd(this);
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131559717, null);
      paramQQAppInterface = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131376053);
      boolean bool = ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null);
      if (bool) {
        paramQQAppInterface.setBackgroundDrawable(paramFragmentActivity.getResources().getDrawable(2130840250));
      }
      paramQQAppInterface = this.jdField_a_of_type_AndroidViewView.findViewById(2131378035);
      paramFragmentActivity = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363024);
      paramSessionInfo = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379051);
      if (bool) {
        paramSessionInfo.setTextColor(Color.parseColor("#ffffff"));
      }
      paramFragmentActivity.setOnClickListener(this);
      paramFragmentActivity.setOnTouchListener(new bbha(this));
      paramSessionInfo = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370228);
      paramSessionInfo.setOnClickListener(this);
      paramSessionInfo.setOnTouchListener(new bbhb(this));
      if (AppSetting.c)
      {
        paramFragmentActivity.setContentDescription(alud.a(2131707389));
        paramSessionInfo.setContentDescription(paramContext.getString(2131699998));
      }
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        ...
        int i = j;
        if (c()) {
          i = j - aepi.a(10.0F, paramQQAppInterface.getResources());
        }
      ...
      if (!bool)
      {
        ...
        paramQQAppInterface.mRequestWidth = bdoo.a();
        paramQQAppInterface.mRequestHeight = bdoo.b();
        ...
        paramQQAppInterface.setDecodeHandler(bcyz.y);
  ...
  private void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 2) {
        azqs.b(null, "dc00898", "", "", "0X800AD0B", "0X800AD0B", 0, 0, Integer.toString(i), Long.toString(this.jdField_a_of_type_Long), Long.toString(l1), "");
      }
      label223:
      while (paramInt != 1)
      {
      ...
      azqs.b(null, "dc00898", "", "", "0X800AD0A", "0X800AD0A", 0, 0, Integer.toString(i), Long.toString(this.jdField_a_of_type_Long), Long.toString(l1), "");
      return;
      label294:
      i = 0;
    }
  ...
  private void a(boolean paramBoolean, long paramLong, List paramList, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      if ((paramList instanceof ArrayList))
      {
        ...
        if (paramInt < ((ArrayList)localObject).size())
        {
          ...
          {
            bbhh localbbhh = new bbhh();
            localbbhh.jdField_a_of_type_Long = localApp.appid.get();
            localbbhh.jdField_a_of_type_JavaLangString = localApp.name.get();
            localbbhh.jdField_c_of_type_JavaLangString = localApp.url.get();
            localbbhh.jdField_b_of_type_JavaLangString = localApp.icon.get();
            if (localApp.removable.has()) {
              localbbhh.jdField_b_of_type_Int = localApp.removable.get();
            }
            if (localApp.source.has()) {
              localbbhh.jdField_c_of_type_Int = localApp.source.get();
            }
            localbbhh.jdField_a_of_type_Int = 0;
            paramList.add(localbbhh);
          }
          for (;;)
          {
        ...
        localObject = (bbhi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(357);
        if (localObject != null) {
          ((bbhi)localObject).a(this.jdField_a_of_type_Long, paramList);
        }
        e();
      }
      paramList = (bbhi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(357);
      if (paramList == null) {
        break label585;
      }
    }
    ...
    for (paramList = paramList.a(this.jdField_a_of_type_Long);; paramList = null)
    {
      ...
      for (paramInt = paramList.size();; paramInt = 0)
      {
        ...
        {
          azqs.b(null, "dc00898", "", "", "0X800AD08", "0X800AD08", 0, 0, "", Long.toString(this.jdField_a_of_type_Long), Long.toString(paramLong), Integer.toString(paramInt));
          return;
          QLog.e("TroopAppShortcutContainer", 2, "reqGetShortcutTroopApps faild troopUin:" + this.jdField_a_of_type_Long + " errCode:" + paramInt);
          if (paramInt == 1002)
          {
            QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidContentContext.getString(2131699999), 0).a();
            break;
          }
          QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidContentContext.getString(2131700000), 0).a();
          break;
        }
      }
    }
  ...
  private boolean b()
  {
    return (bcpx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(this.jdField_a_of_type_Long), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c())) || (bcpx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(this.jdField_a_of_type_Long), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()));
  }
  ...
  private void e()
  {
    ...
    {
      localObject = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370228);
      if (b()) {
    ...
    label137:
    for (Object localObject = ((bbhi)localObject).a(this.jdField_a_of_type_Long);; localObject = null)
    {
      if ((localObject != null) && (this.jdField_a_of_type_Bbhe != null))
      {
        ArrayList localArrayList = new ArrayList();
        localArrayList.addAll((Collection)localObject);
        if ((localArrayList.size() < 16) && (b()))
        {
          localObject = new bbhh();
          ((bbhh)localObject).jdField_a_of_type_Int = 1;
          localArrayList.add(localObject);
        }
        this.jdField_a_of_type_Bbhe.a(localArrayList);
      }
      return;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378330));
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt1 == 20006)
    {
      ...
      if (paramIntent != null)
      {
        ...
        if ((paramIntent != null) && (this.jdField_a_of_type_Amdu != null)) {
          this.jdField_a_of_type_Amdu.b(this.jdField_a_of_type_Long, (int)paramIntent.dwGroupClassExt);
        }
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (localObject != null)
    {
      ...
      this.jdField_a_of_type_Amdu.b(this.jdField_a_of_type_Long, (int)((TroopInfo)localObject).dwGroupClassExt);
      if (this.jdField_a_of_type_Ameq == null)
      {
        this.jdField_a_of_type_Ameq = new bbhc(this);
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Bbhe = null;
    this.jdField_a_of_type_Long = 0L;
  }
