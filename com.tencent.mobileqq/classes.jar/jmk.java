...
public class jmk
  implements Runnable
{
  public jmk(RandomController paramRandomController) {}
  ...
  private void a()
  {
    if (!this.a.c)
    {
      ...
      PopupDialog.b(localContext, 230, localContext.getString(2131429324), localContext.getString(2131429323), 0, 2131429056, new jml(this), null);
      this.a.c = true;
    }
  }
