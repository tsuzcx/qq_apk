  ...
  implements Observer
{
  ...
  akim jdField_a_of_type_Akim = new agqo(this);
  ...
  WeakReference<agqr> jdField_a_of_type_JavaLangRefWeakReference;
  public ArrayList<TroopClipPic> a;
  public List<aglg> a;
  protected int[] a;
  protected String[] a;
  int jdField_b_of_type_Int = -1;
  WeakReference<agqq> jdField_b_of_type_JavaLangRefWeakReference;
  List<agqp> jdField_b_of_type_JavaUtilList = new ArrayList();
  AccountObserver jdField_b_of_type_MqqObserverAccountObserver = new agqn(this);
  int c;
  ...
  public agqk(Context paramContext, Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    e();
    paramContext = (akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
    this.jdField_a_of_type_Baiq = new baiq(this.jdField_a_of_type_JavaLangString, baml.class, paramContext);
    this.jdField_a_of_type_Baiq.a(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Akim, true);
  }
  
  private aglg a(long paramLong)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      aglg localaglg = (aglg)localIterator.next();
      if (localaglg.jdField_a_of_type_Long == paramLong) {
        return localaglg;
      }
    }
    return null;
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    bcpw.a(BaseApplicationImpl.getContext(), paramInt, paramString, 1).b(i);
  }
  ...
  private void h()
  {
    ...
    label86:
    for (((aglg)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_d_of_type_Boolean = true;; ((aglg)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_d_of_type_Boolean = false)
    {
      i += 1;
      break label41;
      break;
  ...
  protected void a(int paramInt)
  {
    ...
    while (localIterator.hasNext()) {
      ((agqp)localIterator.next()).a(paramInt);
    }
  }
  ...
  protected void a(aglg paramaglg)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((agqp)localIterator.next()).a(paramaglg);
    }
  }
  ...
  public void a(aglg paramaglg, bamm parambamm)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((agqp)localIterator.next()).a(paramaglg, parambamm);
    }
  }
  
  public void a(agqp paramagqp)
  {
    if (!this.jdField_b_of_type_JavaUtilList.contains(paramagqp)) {
      this.jdField_b_of_type_JavaUtilList.add(paramagqp);
    }
  }
  ...
  {
    if (paramagqq != null) {
      this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramagqq);
    }
  }
  
  public void a(agqr paramagqr)
  {
    if (paramagqr != null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramagqr);
    }
  }
  ...
  public void a(TroopClipPic paramTroopClipPic, String paramString1, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Baiq.a(TroopUploadingThread.class, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList, paramString1, paramString2, paramString3, null);
  }
  ...
  public void a(ArrayList<TroopClipPic> paramArrayList, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        aglg localaglg = a(localTroopClipPic.ts);
        if ((localaglg != null) && (!localaglg.jdField_b_of_type_Boolean))
        {
          localaglg.jdField_b_of_type_Boolean = true;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null)
      {
        ...
        agqs.a((List)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo);
        Object localObject2 = this.jdField_a_of_type_Baiq.a();
        if (localObject2 != null)
        {
          localObject2 = ((List)localObject2).iterator();
          while (((Iterator)localObject2).hasNext())
          {
            bamr localbamr = (bamr)((Iterator)localObject2).next();
            if ((localbamr != null) && (localbamr.jdField_b_of_type_Int != 1)) {
              ...
              else
              {
                ...
                localaglg.jdField_b_of_type_JavaLangString = localbamr.jdField_a_of_type_JavaLangString;
                localaglg.jdField_c_of_type_Int = localbamr.jdField_a_of_type_Int;
                localaglg.jdField_d_of_type_Int = localbamr.jdField_b_of_type_Int;
                localaglg.jdField_b_of_type_Int = 2;
                localaglg.jdField_a_of_type_Boolean = true;
                localaglg.jdField_a_of_type_Long = localbamr.jdField_a_of_type_Long;
                localaglg.jdField_d_of_type_JavaLangString = localbamr.jdField_b_of_type_JavaLangString;
                ((List)localObject1).add(localaglg);
              }
            }
          }
        }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("TroopPhotoController", 2, String.format("update2DB picId=%d info=%s", new Object[] { Integer.valueOf(paramInt), paramaglg }));
    }
    ...
    {
      localaglg = (aglg)((Iterator)localObject).next();
      if (localaglg != null) {
        str = localaglg.jdField_c_of_type_JavaLangString;
      }
    }
    label439:
    for (;;)
    {
      try
      {
        ...
        if (localaglg.jdField_b_of_type_Int == 1)
        {
          TroopClipPic localTroopClipPic = new TroopClipPic();
          localTroopClipPic.id = str;
          localTroopClipPic.clipInfo = localaglg.jdField_d_of_type_JavaLangString;
          localTroopClipPic.type = localaglg.jdField_d_of_type_Int;
          localArrayList.add(localTroopClipPic);
      ...
      if (i != 0)
      {
        this.jdField_a_of_type_JavaUtilList.remove(paramaglg);
        b(paramaglg);
        return false;
      }
      paramaglg.jdField_c_of_type_JavaLangString = String.valueOf(paramInt);
      paramaglg.jdField_b_of_type_Int = 1;
      paramaglg.jdField_a_of_type_Boolean = false;
      localObject = new TroopClipPic();
      ((TroopClipPic)localObject).id = paramaglg.jdField_c_of_type_JavaLangString;
      ((TroopClipPic)localObject).type = paramaglg.jdField_d_of_type_Int;
      ((TroopClipPic)localObject).clipInfo = paramaglg.jdField_d_of_type_JavaLangString;
      localArrayList.add(localObject);
      if (paramaglg.jdField_c_of_type_Boolean) {
        localHashSet.add(paramaglg.jdField_c_of_type_JavaLangString);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        if (paramaglg != null)
        {
          localObject = paramaglg.b(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin));
          if ((localObject != null) && (localArrayList.size() > 0))
          {
            ...
            ThreadManager.post(new TroopPhotoController.4(this, paramaglg, (TroopInfo)localObject), 8, null, false);
          }
        }
      }
      return true;
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      return true;
      paramString1 = (agqr)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      break;
    }
  }
  ...
  public void b(aglg paramaglg)
  {
    Iterator localIterator = this.jdField_b_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((agqp)localIterator.next()).b(paramaglg);
    }
    if (this.jdField_b_of_type_Int >= this.jdField_a_of_type_JavaUtilList.size())
    {
      h();
  ...
  public void b(boolean paramBoolean)
  {
    ...
    bbgg localbbgg = bbcv.a(localActivity, 230);
    localbbgg.setTitle(null);
    if (paramBoolean) {
      localbbgg.setMessage(localActivity.getResources().getString(2131693446));
    }
    for (;;)
    {
      localbbgg.setPositiveButton(localActivity.getResources().getString(2131693470), new bbdf());
      localbbgg.setPositiveButtonContentDescription(localActivity.getResources().getString(2131693470));
      localbbgg.show();
      return;
      localbbgg.setMessage(localActivity.getResources().getString(2131693445));
    }
  }
  ...
  protected boolean b(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopTypeExt == 2) || (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopTypeExt == 3) || (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopTypeExt == 4))
    {
      ...
      {
        bcpw.a(this.jdField_a_of_type_AndroidAppActivity, 2131697507, 1).a();
        return true;
      }
    }
    return false;
  ...
  protected boolean b(String paramString1, String paramString2)
  {
    if (!(this.jdField_a_of_type_AndroidAppActivity instanceof TroopAvatarWallEditActivity))
    {
      ...
      {
        localagqq = (agqq)this.jdField_b_of_type_JavaLangRefWeakReference.get();
        if (localagqq != null)
        {
  ...
  public void c()
  {
    ...
    if (((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.dwGroupFlagExt & 0x800) != 0L) || (this.jdField_a_of_type_Int > 0))
    {
      ...
      {
        b(bool);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_certified", "", "data", "exp_edit_head", 3, 0, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, "", "", "");
        return;
      }
    }
    ...
    if (i < this.jdField_a_of_type_ArrayOfInt.length)
    {
      if (this.jdField_a_of_type_ArrayOfInt[i] == 16) {
        localbfol.d(this.jdField_a_of_type_ArrayOfJavaLangString[this.jdField_a_of_type_ArrayOfInt[i]]);
      }
      for (;;)
      {
        i += 1;
        ...
        if ((this.jdField_a_of_type_ArrayOfInt[i] >= 0) && (this.jdField_a_of_type_ArrayOfInt[i] < this.jdField_a_of_type_ArrayOfJavaLangString.length)) {
          localbfol.a(this.jdField_a_of_type_ArrayOfJavaLangString[this.jdField_a_of_type_ArrayOfInt[i]], 1);
        }
      }
    }
    localbfol.a(new agql(this, localbfol));
    localbfol.show();
  }
  
  public void c(int paramInt)
  {
    Object localObject = (aglg)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    ArrayList localArrayList;
    if (bahh.b(((aglg)localObject).jdField_c_of_type_JavaLangString))
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "del_head", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, "", "", "");
      localArrayList = new ArrayList();
      localArrayList.add(Integer.valueOf(((aglg)localObject).jdField_c_of_type_JavaLangString));
      this.jdField_a_of_type_Baiq.a(this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, 2, localArrayList);
    }
    this.jdField_a_of_type_JavaUtilList.remove(localObject);
    b((aglg)localObject);
    if ((((aglg)localObject).jdField_b_of_type_Int == 1) && (!TextUtils.isEmpty(((aglg)localObject).jdField_c_of_type_JavaLangString)) && (bahh.b(((aglg)localObject).jdField_c_of_type_JavaLangString)))
    {
      localArrayList = new ArrayList();
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if (((aglg)localObject).jdField_c_of_type_JavaLangString.equals(localTroopClipPic.id))
          {
            ...
            if (paramInt != 0)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.mTroopVerifyingPics.remove(((aglg)localObject).jdField_c_of_type_JavaLangString);
            }
          }
        }
      }
  ...
  public void c(aglg paramaglg)
  {
    ...
    {
      paramaglg.jdField_c_of_type_Boolean = true;
      ...
      {
        bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, this.jdField_a_of_type_AndroidAppActivity.getString(2131696383), null, this.jdField_a_of_type_AndroidAppActivity.getString(2131696373), new bbdf(), null).show();
  ...
  public void d()
  {
    if (jdField_a_of_type_AndroidNetUri != null)
    {
      ...
      localObject = bbdr.b(this.jdField_a_of_type_AndroidAppActivity, (Uri)localObject);
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        agqs.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject, agqs.d(this.jdField_c_of_type_Int));
      }
    }
  }
  ...
  public void d(int paramInt)
  {
    ...
    a(agqs.a(BaseApplicationImpl.getContext(), -1));
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      aglg localaglg = (aglg)localIterator.next();
      if ((localaglg.jdField_b_of_type_Int == 2) || (localaglg.jdField_a_of_type_Boolean))
      {
  ...
  public void f()
  {
    this.jdField_a_of_type_Baiq.b(this);
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "upload_head_cancel", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, String.valueOf(paramObservable.jdField_b_of_type_Int), "", "");
    if (TextUtils.isEmpty(paramObservable.jdField_a_of_type_JavaLangString)) {}
    for (paramObservable = agqs.a(this.jdField_a_of_type_AndroidAppActivity, paramObservable.jdField_b_of_type_Int);; paramObservable = paramObservable.jdField_a_of_type_JavaLangString)
    {
      if (QLog.isColorLevel()) {
