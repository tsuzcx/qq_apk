...
public class asjp
{
  ...
  public asjp(asjq paramasjq)
  {
    this.jdField_a_of_type_Asjq = paramasjq;
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterTextureRender = new TextureRender();
    this.jdField_a_of_type_Int = asjk.a(paramasjq.jdField_c_of_type_Int, paramasjq.jdField_b_of_type_Int);
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer = new RenderBuffer(paramasjq.jdField_c_of_type_Int, paramasjq.jdField_b_of_type_Int);
    asjl.a(false);
    this.jdField_a_of_type_Long = RecogProxy.QCodeInit(this.jdField_a_of_type_Asjq.jdField_a_of_type_Int, this.jdField_a_of_type_Asjq.jdField_b_of_type_Int, this.jdField_a_of_type_Asjq.jdField_c_of_type_Int, this.jdField_a_of_type_Asjq.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Asjq.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Asjq.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Asjq.d, 0.35F);
  ...
  public List<aljf> a(int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
        ...
        if (this.jdField_a_of_type_Long != 0L)
        {
          ...
          if (j < i)
          {
            ...
            if (QLog.isDevelopLevel()) {
              QLog.i("MiniRecog.recog", 2, String.format("debug_minicode_point=[%f,%f,%f,%f,%f]", new Object[] { Float.valueOf(localObject2[0]), Float.valueOf(localObject2[1]), Float.valueOf(localObject2[2]), Float.valueOf(localObject2[3]), Float.valueOf(localObject2[4]) }));
            }
            ...
            localaljf.jdField_a_of_type_Int = m;
            localaljf.jdField_a_of_type_Float = localObject2[4];
      ...
      for (;;)
      {
        ...
        try
        {
          ??? = asjk.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_Asjq.jdField_c_of_type_Int, this.jdField_a_of_type_Asjq.jdField_b_of_type_Int);
          ...
          asjl.a((Bitmap)???, (String)localObject2);
