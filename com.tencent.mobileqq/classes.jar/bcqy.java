  ...
  extends Animation
{
  ...
  private bcqz jdField_a_of_type_Bcqz;
  private final boolean jdField_a_of_type_Boolean;
  private final float b;
  private final float c;
  
  public bcqy(float paramFloat1, float paramFloat2, boolean paramBoolean, int paramInt)
  {
  ...
  public void a(bcqz parambcqz)
  {
    this.jdField_a_of_type_Bcqz = parambcqz;
  }
  
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    int i = 1;
    if (this.jdField_a_of_type_Bcqz != null) {
      this.jdField_a_of_type_Bcqz.a(paramFloat);
    }
    float f1;
    float f2;
