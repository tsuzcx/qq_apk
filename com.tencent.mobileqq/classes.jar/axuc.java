  ...
  extends Handler
{
  ...
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences = axnv.a();
  private Thread jdField_a_of_type_JavaLangThread;
  private boolean jdField_a_of_type_Boolean;
  private Thread jdField_b_of_type_JavaLangThread;
  private boolean jdField_b_of_type_Boolean;
  
  public axuc(SuspendThreadManager paramSuspendThreadManager, Looper paramLooper)
  {
    super(paramLooper);
  ...
  private void a()
  {
    try
    {
      ...
      for (;;)
      {
        ...
        int j = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("notResumeCount", 0);
        i = j;
        if (this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("suspend_check_flag", 0) != 0)
        {
          i = j + 1;
          this.jdField_a_of_type_AndroidContentSharedPreferences$Editor.putInt("notResumeCount", i);
        ...
        QLog.d("TSManager", 1, "currentNotResumeCount = " + i);
        if (i > SuspendThreadManager.a()) {
          SuspendThreadManager.a(false);
        }
        ...
        return;
        if ((Build.VERSION.SDK_INT <= 23) && (axnv.h)) {
  ...
  private void a(int paramInt)
  {
    ...
    if (l - this.jdField_a_of_type_AndroidContentSharedPreferences.getLong("last_report_time", 0L) > 86400000L)
    {
      ...
      axrl.a(BaseApplicationImpl.getApplication()).a(null, "suspendThreadMonitor", true, paramInt, 0L, localHashMap, null);
  ...
  private void a(Thread paramThread, String paramString)
  {
    if (paramThread != null)
    {
      ...
      int i = 0;
      while ((i < paramThread.length) && (i < 8))
      {
