...
public class axuc
  extends axqx
{
  public axuc(ChooseInterestTagActivity paramChooseInterestTagActivity) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, List<InterestTagInfo> paramList1, List<InterestTagInfo> paramList2, String paramString1, int paramInt3, int paramInt4, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        if (ChooseInterestTagActivity.a(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.a(this.a).setText(anvx.a(2131701311));
          ChooseInterestTagActivity.a(this.a).setOnClickListener(null);
          return;
        }
      } while (ChooseInterestTagActivity.b(this.a).getVisibility() != 0);
      ChooseInterestTagActivity.b(this.a).setText(anvx.a(2131701275));
      ChooseInterestTagActivity.c(this.a).setVisibility(8);
      return;
      if ((paramList1 == null) || (paramList1.isEmpty()))
      {
        if (ChooseInterestTagActivity.a(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.a(this.a).setText(anvx.a(2131701289));
          ChooseInterestTagActivity.a(this.a).setOnClickListener(null);
          return;
        }
        if (ChooseInterestTagActivity.b(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.b(this.a).setText(anvx.a(2131701297));
    ...
    if (paramInt3 == 0)
    {
      ...
      ChooseInterestTagActivity.a(this.a, new axuh(this.a, ChooseInterestTagActivity.a(this.a), ChooseInterestTagActivity.b(this.a), ChooseInterestTagActivity.a(this.a)));
      ChooseInterestTagActivity.a(this.a).setAdapter(ChooseInterestTagActivity.a(this.a));
      label765:
  ...
  public void a(boolean paramBoolean, String paramString1, List<axug> paramList, String paramString2, int paramInt1, int paramInt2)
  {
    if (!paramBoolean)
    {
      if (TextUtils.isEmpty(paramString2))
      {
        ChooseInterestTagActivity.a(this.a, 2, anvx.a(2131701301), 500);
        return;
      }
      ChooseInterestTagActivity.a(this.a, 0, anvx.a(2131701274) + paramString2, 500);
      return;
    }
    if ((paramInt2 == 1) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      paramList.putExtra("selfSet_leftViewText", anvx.a(2131701290));
      paramList.putExtra("title", anvx.a(2131701312));
    ...
    ChooseInterestTagActivity.a(this.a, 1, anvx.a(2131701291), 500);
  }
}
