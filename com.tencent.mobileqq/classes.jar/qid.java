...
public final class qid
{
  ...
  public qid(@NotNull String paramString1, @NotNull String paramString2, @NotNull String paramString3, @NotNull String paramString4, @NotNull String paramString5, @NotNull byte[] paramArrayOfByte)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    localObject = (qid)paramObject;
    if ((Intrinsics.areEqual(this.jdField_a_of_type_JavaLangString, ((qid)paramObject).jdField_a_of_type_JavaLangString) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.b, ((qid)paramObject).b) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.c, ((qid)paramObject).c) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.d, ((qid)paramObject).d) ^ true)) {
      return false;
    }
    if ((Intrinsics.areEqual(this.e, ((qid)paramObject).e) ^ true)) {
      return false;
    }
    return Arrays.equals(this.jdField_a_of_type_ArrayOfByte, ((qid)paramObject).jdField_a_of_type_ArrayOfByte);
  }
