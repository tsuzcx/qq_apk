...
class avif
  implements avii
{
  avif(avic paramavic, HotWordSearchEntryDataModel.GIFInfo paramGIFInfo) {}
  ...
  public void a()
  {
    ...
    ajuq localajuq = new ajuq(localQQAppInterface);
    if (!TextUtils.equals(str, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID))
    {
      ...
      localajuq.a(localQQAppInterface, "gif_sta_first", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
      return;
    }
    localSharedPreferences.edit().putInt("HotWordSearchEntryModel.psk_hot_search_try_time", i + 1).apply();
    localajuq.a(localQQAppInterface, "gif_sta_second", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
  }
  ...
  public void b()
  {
    ...
    ajuq localajuq = new ajuq(localQQAppInterface);
    if (i == 1) {
      localajuq.a(localQQAppInterface, "gif_suc_first", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
    }
    for (;;)
    {
      ...
      return;
      localajuq.a(localQQAppInterface, "gif_suc_second", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
    }
  }
}
