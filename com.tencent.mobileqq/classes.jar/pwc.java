...
public class pwc
{
  ...
  public static boolean a(String paramString)
  {
    ...
    try
    {
      ...
      bool1 = sgi.a(((JSONObject)localObject).optString("min_version", null), ((JSONObject)localObject).optString("max_version", null), ((JSONObject)localObject).optString("min_android_build", null), ((JSONObject)localObject).optString("max_android_build", null));
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    try
    {
      boolean bool2 = ndl.a(paramString1, paramString2);
      bool1 = bool2;
    }
    catch (Throwable localThrowable)
    {
