...
public class bijc
  extends QIPCModule
{
  private static bijc jdField_a_of_type_Bijc;
  bijd jdField_a_of_type_Bijd;
  
  public bijc(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Bijc == null) {}
    try
    {
      if (jdField_a_of_type_Bijc == null) {
        jdField_a_of_type_Bijc = new bijc("QQComicIPCModule");
      }
      return jdField_a_of_type_Bijc;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("isLebaItemOpen".equals(paramString))
    {
      ...
      paramString = ((axho)((QQAppInterface)localObject).getManager(36)).a().iterator();
      do
      {
      ...
      for (;;)
      {
        ...
        else
        {
          if ("getComicConfig".equals(paramString))
          {
            ...
            if ((paramInt > 0) && (paramString != null))
            {
              if (this.jdField_a_of_type_Bijd == null) {
                this.jdField_a_of_type_Bijd = new bijd(this, paramInt);
              }
              paramString.addCallBacker(this.jdField_a_of_type_Bijd);
            }
          ...
          if ("getPlayerSo".equals(paramString)) {
            biix.a((QQAppInterface)localObject);
          }
        }
      }
    }
