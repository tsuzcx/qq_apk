...
public class almr
{
  ...
  public final ConcurrentHashMap<Integer, HashMap<String, alnx>> a;
  public final CopyOnWriteArrayList<alok> a;
  ...
  public Bitmap a(alok paramalok, alny paramalny)
  {
    if ((paramalok == null) || (paramalny == null)) {
      return null;
    }
    paramalok = "BubbleDiyFetcher_" + paramalny.jdField_a_of_type_Int + "_" + paramalny.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + "chartlet";
    paramalny = (Bitmap)BaseApplicationImpl.sImageCache.get(paramalok);
    if (paramalny != null)
    {
      this.c.remove(paramalok);
      return paramalny;
    }
    this.c.add(paramalok);
    paramalok = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramalok instanceof QQAppInterface)) {
      a((QQAppInterface)paramalok, 500);
    }
    return null;
  }
  
  public String a(alok paramalok, String paramString)
  {
    Object localObject;
    if ((paramalok == null) || (TextUtils.isEmpty(paramString))) {
      localObject = "";
    }
    String str;
    do
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramalok);
    paramalok = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramalok instanceof QQAppInterface)) {
      a((QQAppInterface)paramalok, 500);
    }
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localalok != null) && (localalok.getCallback() != null) && (a(localalok.jdField_a_of_type_JavaLangString))) {
        localHashSet.add(localalok.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, ajfe paramajfe)
  {
    ...
    ((alms)paramQQAppInterface.a(70)).a((List)localObject, paramajfe);
  }
  ...
  public Bitmap b(alok paramalok, alny paramalny)
  {
    if ((paramalok == null) || (paramalny == null) || (TextUtils.isEmpty(paramalok.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramalok.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (HashMap)this.jdField_b_of_type_JavaUtilMap.get(paramalok.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (((HashMap)localObject).containsKey(paramalny.jdField_a_of_type_JavaLangString.toUpperCase())))
      {
        localObject = (String)((HashMap)localObject).get(paramalny.jdField_a_of_type_JavaLangString.toUpperCase());
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          if (QLog.isColorLevel()) {
            QLog.i("BubbleDiyFetcher", 2, "diy id " + paramalok.jdField_a_of_type_JavaLangString + " has no pasterId for align: " + paramalny.jdField_a_of_type_JavaLangString.toUpperCase());
          }
          return null;
        }
      }
      ...
      paramalny = "BubbleDiyFetcher_" + paramalny.jdField_a_of_type_Int + "_" + paramalny.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + (String)localObject;
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramalny);
      if (localObject != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.remove(paramalny);
        return localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found bitmap cache in BaseApplicationImpl.sImageCache! " + paramalny);
      }
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramalny);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found cache in diyPasterCache! " + paramalok.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramalok.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        BubbleDiyEntity localBubbleDiyEntity = (BubbleDiyEntity)((atmp)localObject2).a(BubbleDiyEntity.class, (String)((ArrayList)localObject1).get(i));
  ...
  public void c(String paramString)
  {
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((File)localObject6).exists())
          {
            ...
            localObject2 = azvq.a(((File)localObject6).getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
    ...
    try
    {
      ...
      {
        localObject2 = (alnx)((HashMap)localObject2).get(localObject4);
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localFile.exists())
          {
            ...
            localObject2 = azvq.a(localFile.getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
