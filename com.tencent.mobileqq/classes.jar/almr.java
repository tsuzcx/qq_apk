...
public class almr
{
  ...
  public final CopyOnWriteArrayList<alms> a;
  public final CopyOnWriteArraySet<String> a;
  AtomicBoolean a;
  public final LRULinkedHashMap<Integer, ga> b;
  ...
  public static almr a()
  {
    if (jdField_a_of_type_Almr == null) {}
    try
    {
      if (jdField_a_of_type_Almr == null) {
        jdField_a_of_type_Almr = new almr();
      }
      return jdField_a_of_type_Almr;
    }
    finally {}
  }
  ...
  private void c(String paramString)
  {
    ...
    if (localObject2.length == 3)
    {
      ...
      {
        localObject1 = new File(bfua.c((String)localObject1));
        if (((File)localObject1).exists())
        {
          ...
          localObject1 = bfpx.a(((File)localObject1).getAbsolutePath());
  ...
  public Bitmap a(almo paramalmo, int paramInt)
  {
    if ((paramalmo == null) || (TextUtils.isEmpty(paramalmo.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramalmo.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramalmo.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramalmo);
      paramalmo = BaseApplicationImpl.getApplication().getRuntime();
      if ((paramalmo instanceof QQAppInterface)) {
        a((QQAppInterface)paramalmo, 500);
      }
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramalmo.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramalmo.jdField_a_of_type_JavaLangString);
    }
  }
  
  public Bitmap a(alms paramalms, String paramString, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    ...
    Object localObject = bfua.a(String.valueOf(paramInt1));
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isFontLoaded(paramInt1))
    {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramalms);
      if (bfua.a(String.valueOf(paramInt1)))
      {
        if (QLog.isColorLevel()) {
    ...
    paramalms = new ETFont(paramInt1, (String)localObject, paramFloat);
    paramalms.setColor(paramInt3);
    try
    {
      localObject = Bitmap.createBitmap(paramInt4, paramInt5, Bitmap.Config.ARGB_8888);
      if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isPaintableChar(paramString.charAt(0), paramalms)) {
        break label590;
      }
      for (paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramalms, paramPaint); paramInt1 > paramInt4; paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramalms, paramPaint)) {
        paramalms.mFontSize -= 1;
      }
      paramInt2 = (paramInt4 - paramInt1) / 2;
    }
    catch (OutOfMemoryError paramalms)
    {
      QLog.d("DiyPendantFetcher", 1, "fetchTextWithFont Bitmap.createBitmap OutOfMemoryError: " + paramalms.getMessage());
      return null;
    }
    paramInt1 = 0;
    paramPaint = new Paint.FontMetrics();
    if (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_getFontMetrics(paramPaint, paramalms))
    {
      paramFloat = paramPaint.bottom;
      float f = paramPaint.top;
      paramInt1 = (int)((paramInt5 - (paramFloat - f)) / 2.0F);
    }
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_drawText(paramString, (Bitmap)localObject, paramInt2, paramInt1, paramalms))
    {
  ...
  public Typeface a(alms paramalms, int paramInt1, int paramInt2)
  {
    if ((paramalms == null) || (paramInt1 <= 0)) {
      return null;
    }
    ga localga = (ga)this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(Integer.valueOf(paramInt1));
    if ((localga != null) && (localga.jdField_a_of_type_AndroidGraphicsTypeface != null)) {
      return localga.jdField_a_of_type_AndroidGraphicsTypeface;
    }
    if (QLog.isColorLevel()) {
  ...
  public DiyPendantEntity a(QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    ((almt)paramQQAppInterface.getBusinessHandler(114)).a((List)localObject, paramBusinessObserver);
    return null;
  }
  ...
  public List<DiyPendantSticker> a(almo paramalmo)
  {
    if ((paramalmo == null) || (TextUtils.isEmpty(paramalmo.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramalmo.jdField_a_of_type_JavaLangString)) {
      return ((DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramalmo.jdField_a_of_type_JavaLangString)).getStickerInfoList();
    }
    if (QLog.isColorLevel()) {
      QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramalmo.jdField_a_of_type_JavaLangString);
    }
  ...
  {
    String str = bfua.a(String.valueOf(paramInt1));
    if (!this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.containsKey(Integer.valueOf(paramInt1)))
    {
      ga localga = new ga(paramInt1, str);
      localga.b = paramInt2;
      this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.put(Integer.valueOf(paramInt1), localga);
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, List<DiyPendantEntity> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramBoolean)
      {
        ...
        ExtensionInfo localExtensionInfo = localamsw.a(localDiyPendantEntity.uinAndDiyId.split("_")[0]);
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localga = (ga)this.jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(Integer.valueOf(Integer.parseInt(paramString)));
      if (localga != null)
      {
        if (localga.b != 1) {
          break label128;
        ...
        if ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_loadFont(localga.jdField_a_of_type_JavaLangString, Integer.parseInt(paramString), true))) {
          d();
        }
      }
    }
    label128:
    while (!new File(localga.jdField_a_of_type_JavaLangString).exists()) {
      return;
    }
    localga.jdField_a_of_type_AndroidGraphicsTypeface = Typeface.createFromFile(localga.jdField_a_of_type_JavaLangString);
  }
