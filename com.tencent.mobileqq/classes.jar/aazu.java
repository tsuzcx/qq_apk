...
{
  private static aazu jdField_a_of_type_Aazu;
  ...
  public static final void b()
  {
    ...
    if (!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_Aazu.callJs(jdField_a_of_type_JavaLangString, new String[] { String.valueOf(true) });
    }
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_AndroidHardwareSensorManager != null) && (this.jdField_a_of_type_Aazv != null))
    {
      this.jdField_a_of_type_AndroidHardwareSensorManager.unregisterListener(this.jdField_a_of_type_Aazv);
      this.jdField_a_of_type_Aazv = null;
    }
  ...
  public final boolean a(String paramString)
  {
    ...
    if (aovb.a())
    {
      ...
      if (this.jdField_a_of_type_Aazv != null) {
        a();
      }
      this.jdField_a_of_type_Aazv = new aazv(this, (byte)3, paramString);
      if (!Build.MODEL.equalsIgnoreCase("Nexus 5X")) {
        break label194;
      }
      this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Aazv, (Sensor)localObject, 3);
      label141:
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      break;
      label194:
      this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Aazv, (Sensor)localObject, 1);
      break label141;
      label211:
