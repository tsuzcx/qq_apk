...
public final class bewn
  implements View.OnClickListener
{
  public bewn(Dialog paramDialog, Context paramContext, String paramString1, MiniAppProxy paramMiniAppProxy, TianShuAccess.AdItem paramAdItem, String paramString2) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      if (!bfgg.a(this.jdField_a_of_type_JavaLangString)) {
        break label69;
      }
      begs.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, 2094, null);
    }
    for (;;)
    {
