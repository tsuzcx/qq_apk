...
public class bair
{
  ...
  public static final HashMap<String, bait> a;
  public static Hashtable<String, TroopBarPublishActivity.Pic_list> a;
  protected static final String b;
  public static final HashMap<String, bait> b;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajyc.a(2131715227);
    jdField_b_of_type_JavaLangString = ajyc.a(2131715237);
    jdField_c_of_type_JavaLangString = ajyc.a(2131715218);
    d = ajyc.a(2131715214);
  ...
  public static final Uri a(BaseActivity paramBaseActivity, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      for (boolean bool = true; (bool) && (paramString.canWrite()); bool = paramString.mkdirs()) {
        try
        {
          ...
          Uri localUri = FileProvider7Helper.setSystemCapture(paramBaseActivity, new File(ajsf.bc + System.currentTimeMillis() + ".jpg"), paramString);
    ...
    bcpw.a(paramBaseActivity, 2131696570, 1).b(paramBaseActivity.getTitleBarHeight());
    return null;
  }
  ...
  public static final String a(EditText paramEditText)
  {
    ...
    if ((paramEditText.getEditableText() instanceof ayks))
    {
      ayks localayks = (ayks)paramEditText.getEditableText();
      if (localayks != null)
      {
        int i = localayks.length();
        Object localObject1 = new char[i];
        localayks.getChars(0, i, (char[])localObject1, 0);
        paramEditText = new StringBuffer();
        paramEditText.append((char[])localObject1);
        localObject1 = (aykp[])localayks.getSpans(0, i, aykp.class);
        if (((localayks instanceof Spanned)) && (Build.VERSION.SDK_INT >= 24)) {
          Arrays.sort((Object[])localObject1, new bais(localayks));
        }
        int k = 0;
        if (j < localObject1.length)
        {
          ...
          int m;
          if (((aykp)localObject2).c == 1)
          {
            i = localayks.getSpanStart(localObject2);
            m = localayks.getSpanEnd(localObject2);
            localObject2 = ayjw.a[(localObject2.a & 0x7FFFFFFF)];
          ...
          for (;;)
          {
            ...
            break;
            i = k;
            if (((aykp)localObject2).c == 2)
            {
              i = localayks.getSpanStart(localObject2);
              m = localayks.getSpanEnd(localObject2);
              localObject2 = ((aykp)localObject2).a();
              paramEditText.replace(i + k, m + k, (String)localObject2);
              i = k + (((String)localObject2).length() - (m - i));
            }
          }
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          str = paramString;
          if (paramString.indexOf(ayjw.a[i]) != -1) {
            str = paramString.replace(ayjw.a[i], "\024" + (char)i);
          }
          i += 1;
          paramString = str;
        }
  ...
  public static final JSONObject a(String paramString1, Context paramContext, String paramString2, String paramString3, String paramString4, Map<String, String> paramMap)
  {
    ...
    for (paramContext = new HashMap();; paramContext = paramMap)
    {
      ...
      paramString1 = nam.a(paramString1, paramString3, paramString4, paramContext, localHashMap2, localHashMap1);
      if (QLog.isColorLevel())
      {
        QLog.d("TroopBar", 2, "singleUploadImage t = " + (System.currentTimeMillis() - l) + ", path = " + paramString2 + ", size = " + apvb.a(paramString2));
  ...
  {
    int i = bbev.b(paramContext);
    axqw.b(null, "P_CliOper", "BizTechReport", "", paramString1, paramString2, 0, paramInt, "" + i, paramString3, paramString4, paramString5);
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle1, String paramString3, int paramInt, Bundle paramBundle2, baho parambaho, String paramString4)
  {
    if ((paramBundle1 != null) && (!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      paramBundle1.putString("version", "8.2.8");
      ...
      new bahn(paramString3, paramString4, parambaho, paramInt, paramBundle2).execute(new HashMap[] { paramString1 });
    }
  ...
  public static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, baho parambaho)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, parambaho, "GET");
  }
  
  protected static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString1, int paramInt, Bundle paramBundle2, baho parambaho, String paramString2)
  {
    AppRuntime localAppRuntime = paramBaseActivity.getAppRuntime();
    String str = localAppRuntime.getAccount();
    a(paramBaseActivity, str, ((TicketManager)localAppRuntime.getManager(2)).getSkey(str), paramBundle1, paramString1, paramInt, paramBundle2, parambaho, paramString2);
  }
  ...
  {
    axqw.b(null, "P_CliOper", paramString1, "", paramString2, paramString3, 0, 0, paramString4, paramString5, paramString6, paramString7);
  }
  ...
  public static void b(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, baho parambaho)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, parambaho, "POST");
  }
  ...
  {
    axqw.b(null, "dc00899", "Grp_tribe", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
}
