  ...
  extends WebViewClient
{
  ...
  public void onDetectedBlankScreen(String paramString, int paramInt)
  {
    ...
    if (this.b.jdField_a_of_type_Begh != null) {
      this.b.jdField_a_of_type_Begh.c(paramString, paramInt);
    }
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    ...
    if (this.b.jdField_a_of_type_Begh != null) {
      this.b.jdField_a_of_type_Begh.a(paramWebView, paramString);
    }
    paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
    if (paramWebView != null) {
      paramWebView.a(paramString, 8589934594L, null);
    }
    aeoy.b(this.b.jdField_a_of_type_AndroidContentIntent);
  }
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    do
    {
      ...
      if (this.b.jdField_a_of_type_Begh != null)
      {
        this.b.jdField_a_of_type_Begh.a(paramWebView, paramString, paramBitmap);
        this.b.jdField_a_of_type_Begh.b(paramWebView, paramString, paramBitmap);
      }
      paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
  ...
  public void onReceivedError(WebView paramWebView, int paramInt, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (this.b.jdField_a_of_type_Begh != null) {
        this.b.jdField_a_of_type_Begh.a(paramWebView, paramInt, paramString1, paramString2);
      }
      paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
    } while (paramWebView == null);
  ...
  public void onReceivedSslError(WebView paramWebView, SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    ...
    for (localObject = "null";; localObject = ((SslCertificate)localObject).toString())
    {
      ...
      if (this.b.jdField_a_of_type_Begh != null) {
        this.b.jdField_a_of_type_Begh.a(paramWebView, paramSslError);
      }
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    if ((paramString.startsWith("mqqapi:")) && (paramString.contains("getTcntDocData")) && (((aoyg)localObject).a()))
    {
      paramWebView = Uri.parse(paramString).getQueryParameter("id");
      baij.a(paramWebView, this.b.jdField_a_of_type_ComTencentBizUiTouchWebView);
      if ((this.b.jdField_a_of_type_Begh instanceof TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment)) {
        baij.a(paramWebView, this.b.jdField_a_of_type_ComTencentBizUiTouchWebView);
      }
      for (;;)
      {
    ...
    for (;;)
    {
      aeoy.b(this.b.jdField_a_of_type_AndroidContentIntent, (String)localObject);
      paramString = beka.b((String)localObject);
      if ((this.b.jdField_a_of_type_Begh == null) || (!this.b.jdField_a_of_type_Begh.c(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, (String)localObject))) {
        break label398;
      }
      ...
      break;
      label361:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + ndq.b((String)localObject, new String[0]));
    }
    label398:
    if ((("http".equals(paramString)) || ("data".equals(paramString))) && (!((String)localObject).contains("/cgi-bin/httpconn?htcmd=0x6ff0080"))) {
      CustomWebView.addContextLog(ndq.b((String)localObject, new String[0]));
    }
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Begh != null) && (this.b.jdField_a_of_type_Begh.b(paramWebView, (String)localObject))) {
        return true;
      }
      ...
      else if (this.b.jdField_a_of_type_Begh != null)
      {
        boolean bool = this.b.jdField_a_of_type_Begh.a(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, (String)localObject);
        if (bool) {
          return true;
        }
      }
