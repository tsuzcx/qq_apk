  ...
  extends blas
{
  ...
  public blao(String paramString, View paramView)
  {
  ...
  {
    paramContext = new DIYLottieLoader(null, paramContext);
    paramContext.setMemoryCacheSize((int)(MemoryManager.getAvailClassSize() / 2L));
    return paramContext;
  }
  ...
  protected void b()
  {
    ...
    localApolloLottieAnim1.fromNetworkWithCacheBitmap(localDiniFlyAnimationView, str, ApolloLottieAnim.makeApolloZipPath(this.jdField_a_of_type_JavaLangString), this.b);
  }
