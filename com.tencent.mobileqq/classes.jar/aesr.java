...
public class aesr
  extends aodj
{
  public aesr(QQSettingSettingActivity paramQQSettingSettingActivity) {}
  ...
  protected void a(Object paramObject)
  {
    ...
    if (paramObject == null)
    {
      ...
      {
        bool2 = bool1;
        if ((paramObject instanceof ajcn)) {
          bool2 = ((ajcn)paramObject).b;
        }
      }
      paramObject = this.a.findViewById(2131374542);
      if (paramObject != null)
      {
        if (!bool2) {
          break label191;
    ...
    for (;;)
    {
      ...
      {
        paramObject = (ajco)this.a.app.getManager(QQManagerFactory.PHONE_UNITY_MANAGER);
  ...
  public void a(boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    paramString = this.a.getString(2131691984);
