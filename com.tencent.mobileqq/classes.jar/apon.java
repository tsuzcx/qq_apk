  ...
  extends anii
{
  ...
  private void a(String paramString, boolean paramBoolean, byte[] paramArrayOfByte, int paramInt1, int paramInt2, anil paramanil)
  {
    paramanil = super.createToServiceMsg(paramString, paramanil);
    paramanil.addAttribute("SendTime", Long.valueOf(System.currentTimeMillis()));
    paramanil.addAttribute("IsGenericCmd", Boolean.valueOf(paramBoolean));
    paramanil.addAttribute("IsPanelRequest", Boolean.valueOf(false));
    paramanil.addAttribute("NotifyType", Integer.valueOf(paramInt2));
    paramanil.putWupBuffer(paramArrayOfByte);
    if (paramInt1 > 0) {
      paramanil.setTimeout(paramInt1);
    }
    if (!anjf.a().containsKey(paramString)) {
      anjf.a(paramString, a);
    }
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (paramanil == null)) {
      return false;
    }
    paramanil = super.createToServiceMsg(paramString, paramanil);
    paramanil.addAttribute("SendTime", Long.valueOf(System.currentTimeMillis()));
    paramanil.addAttribute("IsGenericCmd", Boolean.valueOf(true));
    paramanil.addAttribute("IsPanelRequest", Boolean.valueOf(true));
    paramanil.addAttribute("NotifyType", Integer.valueOf(paramInt2));
    if (paramInt1 > 0) {
      paramanil.setTimeout(paramInt1);
    }
  ...
  {
    if ((TextUtils.isEmpty(paramString1)) || (paramanil == null)) {
      return false;
    }
    ...
    try
    {
      ...
      a(paramString1, true, paramString2, paramInt1, paramInt2, paramanil);
      return true;
    }
