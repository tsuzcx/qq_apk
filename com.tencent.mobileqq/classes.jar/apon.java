...
public class apon
  extends apmi<CustomEmotionData>
{
  private boolean a;
  
  public apon(QQAppInterface paramQQAppInterface)
  {
  ...
  private CustomEmotionData a(String paramString1, String paramString2, String paramString3, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localapov = new apov(paramString1);
          localObject = localCustomEmotionData;
        } while (TextUtils.isEmpty(localapov.jdField_a_of_type_JavaLangString));
        str2 = localapov.c;
        localObject = localCustomEmotionData;
      } while (str2 == null);
      localObject = localCustomEmotionData;
    ...
    if (str2.equals("1"))
    {
      ...
      localCustomEmotionData.emoPath = localapov.e;
      localCustomEmotionData.eId = localapov.f;
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.url = apol.a(paramString1, paramString2, str1);
    ...
    for (;;)
    {
      ...
      localCustomEmotionData.uin = str1;
      localCustomEmotionData.emoPath = apol.a(paramString1);
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.md5 = localapov.jdField_d_of_type_JavaLangString;
      localCustomEmotionData.url = apol.a(paramString1, paramString2, str1);
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.emoId = paramInt;
      break;
      ...
      {
        localCustomEmotionData.eId = localapov.e;
        if (QLog.isColorLevel()) {
  ...
  public apmk<CustomEmotionData> a()
  {
    return (apoo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(103);
  }
  
  public apuf a(CustomEmotionData paramCustomEmotionData)
  {
    if (paramCustomEmotionData.isMarkFace)
    {
      ...
      ((apxv)localObject1).jdField_c_of_type_Boolean = paramCustomEmotionData.isAPNG;
      ((apxv)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((aufn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str, (String)localObject2);
      ((apxv)localObject1).jdField_d_of_type_Int = 2;
      ((apxv)localObject1).jdField_a_of_type_JavaLangString = paramCustomEmotionData.RomaingType;
      ((apxv)localObject1).jdField_g_of_type_Int = paramCustomEmotionData.emoId;
      return localObject1;
    }
    Object localObject1 = ((appr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
    Object localObject2 = new apxf();
    ((apxf)localObject2).jdField_c_of_type_Int = 4;
    ((apxf)localObject2).e = a(paramCustomEmotionData);
    ((apxf)localObject2).jdField_d_of_type_Int = 2;
    ((apxf)localObject2).jdField_d_of_type_JavaLangString = paramCustomEmotionData.eId;
    ((apxf)localObject2).f = paramCustomEmotionData.url;
    if (localObject1 != null) {
      ((apxf)localObject2).jdField_a_of_type_JavaLangString = apxf.a((Map)localObject1, paramCustomEmotionData.md5);
    }
    ((apxf)localObject2).h = paramCustomEmotionData.RomaingType;
    ((apxf)localObject2).jdField_g_of_type_Int = paramCustomEmotionData.emoId;
    ((apxf)localObject2).jdField_g_of_type_JavaLangString = paramCustomEmotionData.resid;
    return localObject2;
  }
  ...
  public CustomEmotionData a(List<CustomEmotionData> paramList, String paramString)
  {
    ...
    for (;;)
    {
      label131:
      return paramList;
      Object localObject = new apov(paramString);
      if (!((apov)localObject).a())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      {
        str = ((apov)localObject).e;
        localObject = ((apov)localObject).f;
      ...
      localObject = ((apov)localObject).jdField_d_of_type_JavaLangString;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        break label98;
      }
  ...
  public String a(CustomEmotionData paramCustomEmotionData)
  {
    ...
    do
    {
      ...
      localObject1 = alof.bi;
      localObject2 = (appr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141);
      if ((localObject2 != null) && (((appr)localObject2).a(paramCustomEmotionData)))
      {
        if ((!TextUtils.isEmpty(paramCustomEmotionData.emoPath)) && (paramCustomEmotionData.emoPath.startsWith(alof.bi))) {
          return paramCustomEmotionData.emoPath;
        }
        if (!TextUtils.isEmpty(paramCustomEmotionData.md5)) {
          return ((appr)localObject2).a(paramCustomEmotionData.md5);
        }
        if (!TextUtils.isEmpty(paramCustomEmotionData.resid)) {
          return (String)localObject1 + amqy.a(paramCustomEmotionData.resid);
        }
      ...
      if ((paramCustomEmotionData.url != null) && (paramCustomEmotionData.url.contains("qto_"))) {
        return (String)localObject1 + altr.a(paramCustomEmotionData.url);
      }
      if (TextUtils.isEmpty(altr.a(paramCustomEmotionData.eId))) {
        break;
      }
  ...
  public List<CustomEmotionData> a()
  {
    ...
    //   15: astore 8
    //   17: aload_0
    //   18: getfield 303	apon:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   21: invokeinterface 239 1 0
    //   26: ifle +104 -> 130
    //   29: aload_0
    //   30: getfield 303	apon:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   129: areturn
    //   130: aload_0
    //   131: getfield 22	apon:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   134: ifnonnull +6 -> 140
    //   137: goto -12 -> 125
    //   140: aload_0
    //   141: getfield 22	apon:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   144: invokevirtual 328	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawgg;
    //   147: invokevirtual 334	awgg:createEntityManager	()Lawgf;
    //   150: astore 11
    //   152: aload 11
    //   154: ifnull +379 -> 533
    //   157: aload 11
    //   159: aload_0
    //   160: invokevirtual 336	apon:a	()Ljava/lang/Class;
    //   163: iconst_0
    //   164: aconst_null
    //   165: aconst_null
    //   166: aconst_null
    ...
    //   168: aconst_null
    //   169: aconst_null
    //   170: invokevirtual 341	awgf:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   173: astore 9
    //   175: ldc_w 343
    //   178: aload_0
    //   179: getfield 22	apon:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   182: invokevirtual 345	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   185: invokestatic 348	amqy:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   188: iconst_1
    //   189: if_icmpge +335 -> 524
    //   192: aload 11
    //   194: invokevirtual 351	awgf:a	()Lawgh;
    //   197: astore 10
    //   199: aload 9
    ...
    //   255: getstatic 270	alof:bi	Ljava/lang/String;
    ...
    //   292: getstatic 270	alof:bi	Ljava/lang/String;
    ...
    //   303: invokestatic 280	amqy:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   324: istore 4
    //   326: aload 10
    //   328: invokevirtual 355	awgh:a	()V
    //   331: iconst_1
    //   332: istore_3
    //   333: iload_3
    //   334: istore_2
    ...
    //   338: aload 11
    //   340: aload 8
    //   342: invokevirtual 358	awgf:a	(Lawge;)Z
    //   345: pop
    //   346: iload_3
    //   347: istore_1
    //   348: iload 5
    ...
    //   385: getstatic 270	alof:bi	Ljava/lang/String;
    ...
    //   438: aload 12
    //   440: aload 12
    //   442: invokestatic 280	amqy:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   460: istore 4
    //   462: aload 10
    //   464: invokevirtual 355	awgh:a	()V
    //   467: iconst_1
    //   468: istore_3
    //   469: iload_3
    //   470: istore_2
    ...
    //   474: aload 11
    //   476: aload 8
    //   478: invokevirtual 358	awgf:a	(Lawge;)Z
    //   481: pop
    //   482: iload_3
    //   483: istore_1
    //   484: goto -136 -> 348
    ...
    //   494: istore 4
    //   496: aload 10
    //   498: invokevirtual 365	awgh:c	()V
    //   501: iload_1
    //   502: ifeq +8 -> 510
    //   505: aload 10
    //   507: invokevirtual 367	awgh:b	()V
    //   510: ldc_w 343
    //   513: aload_0
    //   514: getfield 22	apon:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   517: invokevirtual 345	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   520: iconst_1
    //   521: invokestatic 370	amqy:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   524: aload 11
    //   526: invokevirtual 371	awgf:a	()V
    //   529: aload 9
    //   531: astore 8
    //   533: iload 7
    //   535: istore_2
    ...
    //   631: aload 11
    //   633: iconst_1
    //   634: invokevirtual 376	apon:b	(Lcom/tencent/mobileqq/data/CustomEmotionBase;I)V
    //   637: goto -62 -> 575
    //   640: astore 8
    //   642: iconst_0
    //   643: istore 4
    ...
    //   655: ifeq -145 -> 510
    //   658: aload 10
    //   660: invokevirtual 367	awgh:b	()V
    //   663: goto -153 -> 510
    //   666: iload_2
    //   667: ifeq +8 -> 675
    //   670: aload 10
    //   672: invokevirtual 367	awgh:b	()V
    //   675: aload 8
    //   677: athrow
    //   678: aload 11
    ...
    //   707: pop
    //   708: aload_0
    //   709: invokevirtual 380	apon:b	()V
    //   712: iconst_1
    //   713: istore_1
    //   714: goto -84 -> 630
    //   717: aload_0
    //   718: invokevirtual 381	apon:a	()V
    //   721: iload_2
    //   722: ifeq +10 -> 732
    //   725: aload_0
    //   726: aload 8
    //   728: iconst_2
    //   729: invokevirtual 384	apon:a	(Ljava/util/List;I)V
    //   732: aload 8
  ...
  public List<CustomEmotionData> a(List<String> paramList1, List<String> paramList2, String paramString, List<Integer> paramList)
  {
    ...
    for (;;)
    {
          ...
          for (;;)
          {
            ...
            if (localList != null)
            {
              ...
              if ((TextUtils.isEmpty(paramList1.url)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
              {
                ...
                paramList1.url = apol.a(str, paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
              }
      ...
      if (((List)localObject1).size() > apol.b) {}
      for (paramList1 = ((List)localObject1).subList(0, apol.b);; paramList1 = (List<String>)localObject1)
      {
        i = 0;
        ...
        paramList2 = (alsb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(72);
  ...
  public boolean a(CustomEmotionData paramCustomEmotionData, int paramInt)
  {
    ...
    for (Object localObject = "isUpdate";; localObject = "overflow_downloaded")
    {
      ...
      localObject = (apoo)a();
      if (localObject != null) {
        ((apoo)localObject).d(paramCustomEmotionData);
      }
      return true;
    }
  }
  ...
  public List<apuf> b()
  {
    bdnm.a("AIO_EmoticonPanel_Refresh", null);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
        ...
        if (i >= 0)
        {
          ...
          else
          {
            ...
            if ((localObject2 instanceof apxv))
            {
              ...
              if (((apxv)localObject2).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) {
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        ...
        bdnm.a(null, "AIO_EmoticonPanel_Refresh");
      }
      if (QLog.isColorLevel()) {
      ...
      break label322;
      if ((localObject2 instanceof apxf))
      {
        localObject1 = (apxf)localObject2;
        if ((TextUtils.isEmpty(((apxf)localObject1).e)) && (TextUtils.isEmpty(((apxf)localObject1).f))) {
          QLog.e("FavroamingDBManager", 1, "path and url is null! " + ((apxf)localObject1).toString());
        } else {
  ...
  protected List<apuf> c()
  {
    Map localMap = ((appr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          {
            localObject = new apxv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
            ((apxv)localObject).jdField_c_of_type_Int = 6;
            String str1 = localCustomEmotionData.eId;
            String str2 = localCustomEmotionData.emoPath;
            ((apxv)localObject).jdField_c_of_type_Boolean = localCustomEmotionData.isAPNG;
            ((apxv)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((aufn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str2, str1);
            ((apxv)localObject).jdField_d_of_type_Int = 2;
            if (((apxv)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) {
      ...
      break label471;
      Object localObject = new apxf();
      ((apxf)localObject).jdField_c_of_type_Int = 4;
      ((apxf)localObject).e = a(localCustomEmotionData);
      ((apxf)localObject).jdField_d_of_type_Int = 2;
      ((apxf)localObject).jdField_d_of_type_JavaLangString = localCustomEmotionData.eId;
      ((apxf)localObject).f = localCustomEmotionData.url;
      ((apxf)localObject).jdField_a_of_type_JavaLangString = apxf.a(localOutOfMemoryError, localCustomEmotionData.md5);
      ((apxf)localObject).h = localCustomEmotionData.RomaingType;
      ((apxf)localObject).jdField_g_of_type_Int = localCustomEmotionData.emoId;
      ((apxf)localObject).jdField_g_of_type_JavaLangString = localCustomEmotionData.resid;
      if ((TextUtils.isEmpty(((apxf)localObject).e)) && (TextUtils.isEmpty(((apxf)localObject).f))) {
        QLog.e("FavroamingDBManager", 1, "path and url is null! " + ((apxf)localObject).toString());
      } else {
        localArrayList.add(localObject);
      }
      label471:
