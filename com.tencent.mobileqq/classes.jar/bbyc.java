...
public class bbyc
{
  ...
  {
    localbbyg = new bbyg(this, System.currentTimeMillis(), paramString3, paramContext, paramInt);
    if (this.jdField_a_of_type_MqqAppNewIntent == null) {
      this.jdField_a_of_type_MqqAppNewIntent = new NewIntent(paramContext, niq.class);
    }
    ...
    paramString1 = biub.a(paramContext);
    ...
    if (i == 0)
    {
      biub.a(paramContext, paramString3, a(this.jdField_a_of_type_JavaLangString), paramInt);
    ...
    for (;;)
    {
      ...
      catch (Exception paramString2)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_MqqAppNewIntent.setObserver(localbbyg);
      ...
      try
      {
        ...
        paramString4 = paramString2;
        paramString1 = paramString2;
        paramString2 = bgmj.a(localMessageDigest.digest());
      }
  ...
  public boolean a(AppInterface paramAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new bbyf(this, Looper.getMainLooper(), paramContext, paramString3, paramInt, paramAppInterface, paramString1, paramString2);
    }
  ...
  public boolean a(String paramString1, Context paramContext, String paramString2, AppInterface paramAppInterface, String paramString3, String paramString4, int paramInt, String paramString5)
  {
    ...
    if ((TextUtils.isEmpty(paramString2)) || (!nhe.a().h(paramString2))) {
      return false;
    }
    jdField_a_of_type_Boolean = true;
    if (this.jdField_b_of_type_AndroidOsHandler == null) {
      this.jdField_b_of_type_AndroidOsHandler = new bbyd(this);
    }
    ...
    try
    {
      ...
      paramString3.SetListener(new bbye(this, paramString1, paramString3, paramInt, paramContext));
