  ...
  implements Animatable
{
  ...
  public anhi(int paramInt1, int[] paramArrayOfInt, ImageView paramImageView, int paramInt2)
  {
  ...
  public anhi(int[] paramArrayOfInt, ImageView paramImageView, int paramInt)
  {
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new anhj(this);
    this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new anhk(this);
  }
