...
public class blbu
{
  ...
  public static blbf a;
  public static blbs a;
  public static blcb a;
  ...
  public static blbg a(bhod parambhod, blbc paramblbc)
  {
    if (jdField_a_of_type_Blbf == null) {
      return null;
    }
    return jdField_a_of_type_Blbf.a(parambhod, paramblbc);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localblfq.b = "comic_plugin.apk";
    localblfq.d = "comic_plugin";
  ...
  public static void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (DeviceProfileManager.a(str, arrayOfInteger, new ankp()) >= arrayOfInteger.length)
        {
  ...
  {
    if (jdField_a_of_type_Blbs == null) {
      jdField_a_of_type_Blbs = new blbs();
    }
    for (;;)
    {
      jdField_a_of_type_Blbs.addObserver(paramObserver);
      return;
      jdField_a_of_type_Blbs.deleteObservers();
    }
  }
  
  public static boolean a(Activity paramActivity, Intent paramIntent, String paramString, avaj paramavaj)
  {
    ...
    localblfq.jdField_a_of_type_JavaLangClass = VipComicProxyActivity.a(paramString);
    localblfq.jdField_a_of_type_AndroidContentIntent = paramIntent;
    localblfq.c = 10000;
    localblfq.jdField_a_of_type_Avaj = paramavaj;
  ...
  public static boolean a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      do
      {
        ...
        paramAppRuntime = (blfh)paramAppRuntime.getManager(27);
  ...
  public static boolean a(AppRuntime paramAppRuntime, boolean paramBoolean, blbx arg2)
  {
    boolean bool = false;
  ...
  {
    if (jdField_a_of_type_Blcb == null) {
      jdField_a_of_type_Blcb = new blcb();
    }
    for (;;)
    {
      jdField_a_of_type_Blcb.addObserver(paramObserver);
      return;
      jdField_a_of_type_Blcb.deleteObservers();
    }
  }
}
