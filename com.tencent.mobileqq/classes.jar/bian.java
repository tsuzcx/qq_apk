...
public class bian
{
  ...
  private void e()
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidViewView.getWidth() > 0) && (this.jdField_b_of_type_AndroidViewView.getHeight() > 0))
    {
      ...
      if (this.jdField_a_of_type_Biap != null) {
        this.jdField_a_of_type_Biap.a((Bundle)localObject3);
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Biap != null) {
        this.jdField_a_of_type_Biap.b((Bundle)localObject3);
      }
  ...
  public bian a(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    return this;
  }
  
  public bian a(biap parambiap)
  {
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Biao != null) {
      bool = this.jdField_a_of_type_Biao.a();
    }
    for (;;)
    {
  ...
  public void c()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Biap = null;
