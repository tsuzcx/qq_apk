  ...
  extends ljn
{
  ...
  public ljw(lhh paramlhh, boolean paramBoolean)
  {
    super(paramlhh, paramBoolean);
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    lcl.c("ARZimuTask_SpitZimuItemTask", "onDraw width = " + paramInt1);
    float f = -this.jdField_a_of_type_AndroidGraphicsPaint.getFontMetrics().ascent;
    String str2 = this.jdField_a_of_type_Lhh.a.toString();
    String str1 = str2;
    if (str2.length() > 10) {
    ...
    int j = str1.length();
    str1 = str1 + str2;
    lcl.c("ARZimuTask_SpitZimuItemTask", "onDraw showText = " + str1);
    ...
    while (paramInt2 < paramInt1)
    {
      ...
      ljt.a(this.jdField_a_of_type_AndroidGraphicsPaint, this.jdField_a_of_type_AndroidTextTextPaint);
    ...
    lcl.c("ARZimuTask_SpitZimuItemTask", "onDraw offsetX = " + i);
  }
  
  public void a(Typeface paramTypeface, int paramInt, mnz parammnz)
  {
    super.a(paramTypeface, paramInt, parammnz);
