  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      if (SosoInterface.a() >= 12)
      {
        ...
        paramString = anox.a();
        axrl.a(BaseApplicationImpl.getContext()).a(paramString, "actSoSoNoCityCodeTimeout", true, 0L, 0L, paramTencentLocation, "");
      }
    ...
    if (SosoInterface.a() > 0)
    {
      ...
      localObject2 = anox.a();
      axrl.a(BaseApplicationImpl.getContext()).a((String)localObject2, "actSoSoNoCityCode", true, 0L, 0L, (HashMap)localObject1, "");
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool3)
        {
          ...
          localObject4 = (akup)SosoInterface.a().get(j);
          if ((((akup)localObject4).reqLocation == bool3) && ((!((akup)localObject4).reqLocation) || (((akup)localObject4).level <= k)))
          {
            if (!((akup)localObject4).uiThread) {
              continue;
            }
            SosoInterface.a((akup)localObject4, paramInt, (SosoInterface.SosoLbsInfo)localObject5);
            ...
            if (!((akup)localObject4).goonListener) {
              break label1054;
            }
            if (QLog.isColorLevel()) {
              QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akup)localObject4).tag + " goon...");
            }
          }
          if (akup.access$1500((akup)localObject4)) {
            break label1820;
          }
          if (!((akup)localObject4).goonListener) {
            break label1135;
          ...
          label872:
          if (!akup.access$1600((akup)localObject4)) {
            break label1814;
          }
          ...
          ((akup)localObject4).onConsecutiveFailure(paramInt, SosoInterface.d());
        ...
        continue;
        ((akup)localObject4).onLocationFinish(paramInt, (SosoInterface.SosoLbsInfo)localObject5);
        continue;
        if (str.equals(((akup)localObject4).tag)) {
          break label1833;
        }
      }
      finally {}
      ...
      akup.access$1502((akup)localObject4, true);
      if (QLog.isColorLevel())
      {
        QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akup)localObject4).tag + " removed normally.");
        continue;
        label1115:
        if (((akup)localObject3).level >= ((akup)localObject4).level) {
          break label1817;
        }
        localObject3 = localObject4;
      }
    ...
    label1135:
    if (SystemClock.elapsedRealtime() - ((akup)localObject4).sTime > 30000L)
    {
      SosoInterface.a().remove(j);
      akup.access$1502((akup)localObject4, true);
      if (((akup)localObject4).reqLocation)
      {
        localObject6 = SosoInterface.a(((akup)localObject4).level, true);
        break label1839;
        ((akup)localObject4).onLocationFinish(i, (SosoInterface.SosoLbsInfo)localObject6);
        if (!QLog.isColorLevel()) {
          break label1852;
        }
        QLog.d("SOSO.LBS", 2, "lis=" + ((akup)localObject4).tag + " err_timeout.reqRaw=" + ((akup)localObject4).reqLocation + ". Force 2 remove it.");
        break label1852;
      }
      else
      {
    ...
    else if (((akup)localObject4).reqLocation)
    {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("SOSO.LBS", 2, "onLocationChanged() lis=" + ((akup)localObject4).tag + " goon=" + ((akup)localObject4).goonListener + " reqLocation=" + ((akup)localObject4).reqLocation + " hasReqRaw=" + bool1);
        break label1871;
        if (((akup)localObject1).level < ((akup)localObject4).level)
        {
          ...
          if (m != 0)
          {
            ...
            for (paramTencentLocation = "";; paramTencentLocation = " goonLis been truncated:" + localObject7.tag)
            {
              ...
              if (localObject4 != null) {
                akup.access$1602((akup)localObject4, false);
              }
          ...
          if (localObject6 != null)
          {
            ...
            for (paramTencentLocation = "";; paramTencentLocation = " goonLis been truncated:" + localObject7.tag)
            {
              QLog.d("SOSO.LBS", 2, paramTencentLocation + " start:" + ((akup)localObject6).tag);
              if (localObject4 != null) {
                akup.access$1602((akup)localObject4, false);
              }
              SosoInterface.d();
              ((akup)localObject6).maxCacheInterval = 0L;
              SosoInterface.a((akup)localObject6);
              return;
            }
          }
          if (localObject7 == null) {
          ...
          if ((akup.access$1600(localObject7)) || (akup.access$1500(localObject7))) {
            break;
          }
          SosoInterface.d();
  ...
  public void onStatusUpdate(String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      synchronized (SosoInterface.a())
      {
        ...
        localakup = (akup)SosoInterface.a().get(i);
        if (localakup == null) {
          break label161;
        }
        if (localakup.uiThread) {
          ThreadManager.getUIHandler().post(new SosoInterface.3.1(this, localakup, paramString1, paramInt, paramString2));
        }
      }
      localakup.onStatusUpdate(paramString1, paramInt, paramString2);
      break label161;
      label157:
      return;
      label161:
