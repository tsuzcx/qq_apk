...
class rvg
{
  ...
  private final rve[] jdField_a_of_type_ArrayOfRve;
  ...
  rvg(rve[] paramArrayOfrve, rvi paramrvi)
  {
    this.jdField_a_of_type_ArrayOfRve = paramArrayOfrve;
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    int i = 0;
    Object localObject;
    while (i < this.jdField_a_of_type_ArrayOfRve.length)
    {
      localObject = this.jdField_a_of_type_ArrayOfRve[i].a(this.jdField_a_of_type_Char, c1, this.jdField_a_of_type_Rvi.a());
      if (localObject != null)
      {
        this.jdField_a_of_type_ArrayOfChar = this.jdField_a_of_type_ArrayOfRve[i].a();
        this.jdField_a_of_type_Int = ((rvf)localObject).jdField_a_of_type_Int;
        this.jdField_b_of_type_Int = ((rvf)localObject).jdField_b_of_type_Int;
        str2 = this.jdField_a_of_type_ArrayOfRve[i].a();
      }
      i += 1;
    }
    if ((this.jdField_a_of_type_ArrayOfChar != null) && (paramInt > 1) && (!TextUtils.isEmpty(str2)))
    {
      ...
      if (this.jdField_a_of_type_Rvi.a() == 1)
      {
        paramInt = 0;
        for (;;)
        {
      ...
      localObject = str1;
      if (this.jdField_a_of_type_Rvi.a() == 2)
      {
        paramInt = 0;
        for (;;)
        {
  ...
  private void b()
  {
    float f1 = this.jdField_a_of_type_Rvi.a(this.jdField_b_of_type_Char);
  ...
  void a(float paramFloat, boolean paramBoolean)
  {
    ...
    float f1 = this.jdField_a_of_type_Rvi.a();
  ...
  void a(int paramInt, char paramChar, boolean paramBoolean)
  {
    ...
    this.e = this.jdField_a_of_type_Rvi.a(paramChar);
