...
public class nxm
  extends SimpleJob
{
  public nxm(StoryPickerFragment paramStoryPickerFragment, String paramString, int paramInt, View paramView, VideoCollectionItem.FakeVideoUIItem paramFakeVideoUIItem) {}
  ...
  protected Object a(@NonNull JobContext paramJobContext, Void... paramVarArgs)
  {
    ...
    for (;;)
    {
      ThreadManager.getUIHandler().post(new nxn(this, paramJobContext, localArrayList1, i, paramVarArgs, bool));
      return null;
      bool = false;
    }
  }
