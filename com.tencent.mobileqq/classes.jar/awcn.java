...
class awcn
  extends ayen
{
  awcn(awcm paramawcm, int paramInt1, MessageRecord paramMessageRecord, ArrayList paramArrayList, QQAppInterface paramQQAppInterface, String paramString, int paramInt2, HashMap paramHashMap) {}
  ...
  private boolean a(MessageForPic paramMessageForPic, aydt paramaydt)
  {
    ...
    if (paramaydt.jdField_a_of_type_JavaLangObject != null) {
      if ((paramaydt.jdField_a_of_type_JavaLangObject instanceof im_msg_body.NotOnlineImage))
      {
        ...
        if ((paramaydt.b) || (this.jdField_a_of_type_Int == 5))
        {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int != 5)
      {
        ...
        paramMessageForPic.md5 = FileUtils.calcMd5(awcm.jdField_a_of_type_JavaLangString);
      }
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("MultiMsg_TAG", 2, "WTF, picResult.mExtraObj is " + paramaydt.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
        }
        label612:
        i = 0;
        break label285;
  ...
  private boolean a(ArrayList<aydt> paramArrayList)
  {
    ...
    if (m < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((i >= paramArrayList.size()) || ((!((aydt)paramArrayList.get(i)).b) && (this.jdField_a_of_type_Int != 5))) {
        break label989;
      }
      j = 1;
    }
    ...
    for (;;)
    {
      if ((localObject1 instanceof MessageForPic))
      {
        ...
        if (!a((MessageForPic)localObject1, (aydt)paramArrayList.get(i))) {
          bool1 = false;
        }
        i += 1;
        m += 1;
      ...
      if ((localObject1 instanceof MessageForMixedMsg))
      {
        ...
        if (((MessageForMixedMsg)localObject1).msgElemList != null)
        {
          ...
          if (!a((MessageForPic)localObject2, (aydt)paramArrayList.get(i))) {
            bool1 = false;
          }
          i += 1;
        }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (!a((MessageForPic)localObject3, (aydt)paramArrayList.get(i))) {
              bool1 = false;
            }
            i += 1;
          }
          for (;;)
          {
            ...
            if ((localObject1 instanceof MessageForStructing))
            {
              ...
              if ((localObject2 != null) && ((localObject2 instanceof StructMsgForImageShare)))
              {
                ...
                if ((localObject3 != null) && (((bcjc)localObject3).a != null))
                {
                  MessageForPic localMessageForPic = ((bcjc)localObject3).a;
                  if (QLog.isColorLevel()) {
                    QLog.d("MultiMsg_TAG", 2, "updateMessageForPic for MessageForPic, MsgIndex[" + m + "], resultIndex[" + i + "]");
                  }
                  ...
                  if (!a(localMessageForPic, (aydt)paramArrayList.get(i))) {
                    bool1 = false;
                  }
                  for (;;)
                  {
                    i += 1;
                    break;
                    ((bcjc)localObject3).ad = localMessageForPic.uuid;
                    ((bcjc)localObject3).ae = localMessageForPic.md5;
                    ((bcjc)localObject3).ac = localMessageForPic.path;
                  ...
                  if (j != 0)
                  {
                    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800662B", "0X800662B", 0, 1, 0, "", "", "", "");
                    }
                    if (QLog.isColorLevel()) {
                  ...
                  if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800662A", "0X800662A", 0, 1, 0, "", "", "", "");
                  }
                  return bool1;
                }
              }
  ...
  public void a(int paramInt, ArrayList<aydt> paramArrayList)
  {
    ...
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      awcm.a(this.jdField_a_of_type_Awcm, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq, 1);
      label110:
      if ((this.jdField_a_of_type_Int == 5) || (awcm.c(this.jdField_a_of_type_Awcm) != 0)) {
        break label201;
      }
      awcm.a(this.jdField_a_of_type_Awcm, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b, this.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, null, this.jdField_a_of_type_JavaUtilArrayList, bool1, this.jdField_a_of_type_Int);
    }
    label190:
    label201:
    while ((this.jdField_a_of_type_Int != 5) || (!awcm.a(this.jdField_a_of_type_Awcm, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq)))
    {
      return;
      bool1 = bool2;
      if (!QLog.isColorLevel()) {
      ...
      bool1 = bool2;
      break;
      awcm.a(this.jdField_a_of_type_Awcm, 1);
      break label110;
    }
    if (bool1)
    {
    ...
    awcm.a(this.jdField_a_of_type_Awcm, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b);
  }
}
