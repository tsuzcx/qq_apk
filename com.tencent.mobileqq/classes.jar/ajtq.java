  ...
  implements ajrp
{
  ...
  protected ajtq(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  public void a_(SlideItemInfo paramSlideItemInfo)
  {
    ...
    if (i < this.jdField_a_of_type_Ajrd.paths.size()) {
      if (!((String)this.jdField_a_of_type_Ajrd.paths.get(i)).equals(paramSlideItemInfo.b)) {}
    }
    for (;;)
    {
      if ((i >= 0) && (i < this.jdField_a_of_type_Ajrd.paths.size()) && (this.jdField_a_of_type_JavaUtilHashMap != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Ajrd.paths.get(i));
      }
      return;
      i += 1;
      break;
  ...
  public void ai_()
  {
    ...
    if (i != -1)
    {
      String str = (String)this.jdField_a_of_type_Ajrd.paths.get(i);
      if (this.c)
      {
  ...
  protected void d()
  {
    ...
    if ((this.c) && (this.mPhotoCommonData.selectedPhotoList != null) && (this.mPhotoCommonData.selectedPhotoList.isEmpty()) && (((ArrayList)localObject1).size() == 1))
    {
      ...
      if ((((NewPhotoPreviewActivity)this.mActivity).getMediaType((String)localObject2) == 1) && (!AlbumUtil.checkVideoForQzoneUploadPhoto(this.mActivity, b(), (LocalMediaInfo)localObject3, this.e)))
      {
    ...
    {
      ajpv.a(((ArrayList)localObject1).size(), this.jdField_a_of_type_Ajrd.totalPicCount);
      ajpv.a(((NewPhotoPreviewActivity)this.mActivity).getIntent(), ((ArrayList)localObject1).size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoPreviewActivity)this.mActivity).getIntent();
    if (localObject1 != null) {
      aktv.a((List)localObject1);
    }
    if ((this.c) || (((ajrc)this.mOtherCommonData).a()))
    {
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    label594:
    for (paramView = (LocalMediaInfo)this.mPhotoCommonData.selectedMediaInfoHashMap.get(this.jdField_a_of_type_Ajrd.a);; paramView = null)
    {
      if ((this.jdField_a_of_type_Boolean) && (AlbumUtil.getMediaType(paramView) == 1) && (this.c) && (this.jdField_a_of_type_Ajrd.c))
      {
        ...
        paramBundle.putExtra("file_send_path", this.jdField_a_of_type_Ajrd.a);
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Ajrd.c)
        {
          ...
          if (this.c) {
            paramView = QzoneEditPictureActivity.a(this.mActivity, this.jdField_a_of_type_Ajrd.a);
          } else {
            paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Ajrd.a, true, true, true, true, true, 3, 99, 4, paramView);
          }
        }
        else
        {
  ...
  public void onSelectClick(View paramView)
  {
    ...
    if (i != -1) {}
    for (String str = (String)this.jdField_a_of_type_Ajrd.paths.get(i);; str = "")
    {
      LocalMediaInfo localLocalMediaInfo = ((NewPhotoPreviewActivity)this.mActivity).getMediaInfo(str);
      if ((this.c) && (this.jdField_a_of_type_Ajrd.paths != null) && (((NewPhotoPreviewActivity)this.mActivity).getMediaType(str) == 1) && (!AlbumUtil.checkVideoForQzoneUploadPhoto(this.mActivity, b(), localLocalMediaInfo, ((ajrc)this.mOtherCommonData).a())))
      {
      ...
      str = (String)this.jdField_a_of_type_Ajrd.paths.get(i);
      if ((!this.c) && (!((ajrc)this.mOtherCommonData).a())) {
        break;
      }
      if (this.mPhotoCommonData.selectedMediaInfoHashMap == null) {
  ...
  public void updateButton()
  {
    ...
    {
      localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131698627);
      if (this.jdField_a_of_type_Int == 1) {
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694437);
      }
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((this.c) && (this.jdField_a_of_type_Ajrd.paths != null)) {
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        c();
        return;
        localObject = ((NewPhotoPreviewActivity)this.mActivity).getString(2131694416);
        break;
        bool1 = false;
        break label132;
      }
