...
public class qno
  implements View.OnClickListener, View.OnLongClickListener, qnl, qqq, qvs
{
  ...
  private qng jdField_a_of_type_Qng;
  private qnr jdField_a_of_type_Qnr;
  ...
  private qqo jdField_c_of_type_Qqo;
  ...
  private qno()
  {
    jdField_a_of_type_Int = bbkx.a(100.0F);
    jdField_b_of_type_Int = bbkx.a(128.0F);
    this.jdField_c_of_type_Int = bbkx.a(54.0F);
    this.jdField_d_of_type_Int = bbkx.a(6.0F);
  ...
  private VideoFeedsFloatWindowDragLayout a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842526);
    int j = bawz.a(paramContext, 24.0F);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(j, j);
    localLayoutParams.gravity = 5;
    j = bawz.a(paramContext, 3.0F);
    localLayoutParams.topMargin = j;
    localLayoutParams.rightMargin = j;
    this.jdField_a_of_type_AndroidWidgetImageView.setLayoutParams(localLayoutParams);
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130842365);
    }
    ...
    this.jdField_a_of_type_Qng = new qng(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    this.jdField_a_of_type_Qng.a(paramContext, this.jdField_a_of_type_AndroidWidgetFrameLayout);
    this.jdField_a_of_type_AndroidViewViewGroup = this.jdField_a_of_type_Qng.jdField_a_of_type_AndroidWidgetFrameLayout;
  ...
  private qqo a(VideoInfo paramVideoInfo)
  {
    boolean bool = true;
    if (this.jdField_a_of_type_Qqo != null)
    {
      qqo localqqo2 = this.jdField_a_of_type_Qqo;
    ...
    qqo localqqo1 = new qqo();
    localqqo1.jdField_a_of_type_Qjv = this.jdField_a_of_type_Qng;
    localqqo1.jdField_a_of_type_AndroidViewViewGroup = this.jdField_a_of_type_AndroidViewViewGroup;
    if (this.f == 1) {}
    for (;;)
    {
      localqqo1.jdField_b_of_type_Boolean = bool;
      if (QLog.isColorLevel()) {
  ...
  {
    long l2 = 0L;
    if ((this.jdField_b_of_type_Qqo != null) && (this.jdField_b_of_type_Qqo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null))
    {
      qze localqze1 = new qze(this.jdField_b_of_type_Qqo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
      qub localqub = this.jdField_b_of_type_Qqo.jdField_a_of_type_Qub;
      qze localqze2 = localqze1.h(this.jdField_b_of_type_Qqo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.g);
      if (localqub != null)
      {
        l1 = localqub.a(this.jdField_c_of_type_Boolean);
        localqze2 = localqze2.d(l1);
        if (localqub == null) {
          break label131;
        }
      }
      label131:
      for (long l1 = localqub.a();; l1 = 0L)
      {
        localqze2 = localqze2.a(l1);
        l1 = l2;
        if (localqub != null) {
          l1 = localqub.b();
        }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Qng.a(localLayoutParams.width, localLayoutParams.height);
  }
  ...
  private void a(VideoInfo paramVideoInfo)
  {
    ...
    this.jdField_c_of_type_Qqo = paramVideoInfo;
  ...
  private void a(VideoInfo paramVideoInfo, long paramLong)
  {
    ...
    qqo localqqo2 = this.jdField_b_of_type_Qqo;
    if (localqqo2 != null) {
    ...
    if ((this.jdField_c_of_type_Qqo != null) && (this.jdField_c_of_type_Qqo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo == paramVideoInfo))
    {
      qqo localqqo1 = this.jdField_c_of_type_Qqo;
      paramVideoInfo = localqqo1;
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      this.jdField_b_of_type_Qqo = paramVideoInfo;
      this.jdField_a_of_type_Qqo = localqqo2;
      this.jdField_c_of_type_Boolean = false;
      if ((onk.a() == null) || (onk.a().c())) {
        break;
      }
  ...
  private void a(VideoInfo paramVideoInfo1, VideoInfo paramVideoInfo2, List<qzc> paramList, qbx paramqbx, long paramLong, int paramInt)
  {
    if (paramVideoInfo1 != null)
    {
      ...
      if (k < i1)
      {
        Object localObject1 = (qzc)paramList.get(k);
        if (QLog.isColorLevel()) {
          QLog.d("VideoFeedsFloatWindowManager", 2, "播放VV上报 totalPlayTime = " + ((qzc)localObject1).jdField_a_of_type_Long + ", currentPlayTime = " + ((qzc)localObject1).b);
        }
        int j;
        label135:
        Object localObject2;
        if ((((qzc)localObject1).b != 0L) || (((qzc)localObject1).jdField_a_of_type_Long != 0L))
        {
          if (k != 0) {
            break label618;
          }
          j = 0;
          localObject2 = new qze(paramVideoInfo1).d(((qzc)localObject1).jdField_a_of_type_Long).a(((qzc)localObject1).b).z(j).A(i1 - 1).C(paramqbx.l).B(paramqbx.k).E(paramqbx.j).D(paramqbx.i).c(paramLong).m(paramInt).a(409409).a(Boolean.valueOf(paramVideoInfo1.jdField_b_of_type_Boolean));
          if (paramVideoInfo1.N == null) {
            break label638;
          }
          localObject1 = paramVideoInfo1.N;
          label244:
          localObject1 = ((qze)localObject2).a((String)localObject1).d(paramVideoInfo1.jdField_c_of_type_Boolean).q(n).r(m).e(paramVideoInfo1.f).d(paramVideoInfo1.r).L(paramVideoInfo1.o).g(paramVideoInfo2.g).i(true).w(this.i);
          if (!paramVideoInfo1.e()) {
            break label646;
          }
          j = 2;
          label319:
          localObject1 = ((qze)localObject1).Z(j);
          if (!paramVideoInfo1.e()) {
            break label652;
          }
          j = paramVideoInfo1.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructVideoColumnInfo.jdField_a_of_type_Int;
          label344:
          localObject1 = ((qze)localObject1).u(j);
          ...
          j = 1;
          label389:
          localObject2 = ((qze)localObject1).aa(j);
          ...
          label465:
          localObject1 = ((qze)localObject2).p((String)localObject1).h(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.f).O(0);
          if (QLog.isColorLevel()) {
            QLog.d("Q.readinjoy.video", 2, "play video [video_from_type : " + this.i + ", first_video_row_key : " + paramVideoInfo2.g + "]");
          }
          localObject2 = ((qze)localObject1).a().a();
        ...
        {
          noo.b(null, str2, "0X8007409", "0X8007409", 0, 0, "", "", (String)localObject1, (String)localObject2, false);
          noo.a("0X8007409", str2, "", "", "", (String)localObject2);
          k += 1;
          break;
          label618:
          if (this.f == 2)
  ...
  {
    if ((this.jdField_a_of_type_Qnv != null) && (!this.jdField_a_of_type_Qnv.hasMessages(paramInt))) {
      this.jdField_a_of_type_Qnv.sendEmptyMessageDelayed(paramInt, 3500L);
    }
  }
  ...
  private void b(List<VideoInfo> paramList, @Nullable Bundle paramBundle)
  {
    ...
    this.f = bhvh.a();
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager = new VideoFeedsPlayManager(BaseApplicationImpl.getContext(), onk.a());
  ...
  {
    if ((this.jdField_a_of_type_Qnv != null) && (this.jdField_a_of_type_Qnv.hasMessages(paramInt))) {
      this.jdField_a_of_type_Qnv.removeMessages(paramInt);
    }
  }
  ...
  private void i()
  {
    noo.a(null, null, "0X8009A28", "0X8009A28", 0, 0, "", "", null, a().a().a(), false);
  }
  ...
  private void j()
  {
    if (this.f == 0)
    {
      ...
      if (localObject != null)
      {
        this.jdField_a_of_type_Npv = ((npv)((QQAppInterface)localObject).a(90));
        if (this.jdField_a_of_type_Npw == null) {
          this.jdField_a_of_type_Npw = new qnt(this, null);
        }
        ((QQAppInterface)localObject).addObserver(this.jdField_a_of_type_Npw);
      }
    }
    if (this.jdField_a_of_type_Osp == null) {
      this.jdField_a_of_type_Osp = new qnu(this, null);
    }
    osm.a().a(this.jdField_a_of_type_Osp);
    qvr.a().a(Integer.toHexString(System.identityHashCode(this)));
    qvr.a().a(this);
    qvr.a().a(true, "float window video");
    Object localObject = BaseApplicationImpl.getApplication();
    if (localObject != null)
    {
      if (this.jdField_a_of_type_Qnr == null) {
        this.jdField_a_of_type_Qnr = new qnr(this, null);
      }
      ((BaseApplicationImpl)localObject).registerActivityLifecycleCallbacks(this.jdField_a_of_type_Qnr);
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null) {
        this.jdField_a_of_type_AndroidContentBroadcastReceiver = new qns(this, null);
      }
  ...
  private void k()
  {
    ...
    qvr.a().b(Integer.toHexString(System.identityHashCode(this)));
    qvr.a().b(this);
    qvr.a().a(false, "float window video");
    if (this.jdField_a_of_type_Osp != null) {
      osm.a().b(this.jdField_a_of_type_Osp);
    }
    Object localObject = onk.a();
    if ((localObject != null) && (this.jdField_a_of_type_Npw != null)) {
      ((QQAppInterface)localObject).removeObserver(this.jdField_a_of_type_Npw);
    }
    localObject = BaseApplicationImpl.getApplication();
    if (localObject != null)
    {
      if (this.jdField_a_of_type_Qnr != null) {
        ((BaseApplicationImpl)localObject).unregisterActivityLifecycleCallbacks(this.jdField_a_of_type_Qnr);
      }
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver != null) {
        ((BaseApplicationImpl)localObject).unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
      }
    }
    this.jdField_a_of_type_Qnr = null;
    this.jdField_a_of_type_Osp = null;
  ...
  private void m()
  {
    ...
    if (this.jdField_c_of_type_Qqo != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager.c(this.jdField_c_of_type_Qqo);
      if (this.jdField_c_of_type_Qqo.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_AndroidViewViewGroup.removeView(this.jdField_c_of_type_Qqo.jdField_a_of_type_AndroidViewView);
      }
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundColor(-16777216);
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    o();
    this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams.width = ((int)bbct.i());
    this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams.height = ((int)bbct.j());
  ...
  private void n()
  {
    qol.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsFloatWindowDragLayout, this.jdField_a_of_type_AndroidWidgetFrameLayout, this.jdField_a_of_type_AndroidViewWindowManager, this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams, new qnq(this));
  }
  ...
  public void a(List<VideoInfo> paramList, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Qnv = new qnv(this, null);
      b(0);
      return;
    }
    catch (Exception localException)
  ...
  public void a(qqo paramqqo, int paramInt)
  {
    if ((paramqqo != null) && (paramqqo.jdField_a_of_type_Qub != null))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoFeedsFloatWindowManager", 2, "mPlayInfoListForReport add detailInfo.totalPlayTime = " + localqzc.jdField_a_of_type_Long + ", detailInfo.currentPlayTime = " + localqzc.b);
      }
  ...
  {
    VideoInfo localVideoInfo1 = paramqqo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo;
    ...
    for (long l1 = paramqqo.jdField_a_of_type_Qub.b();; l1 = paramqqo.jdField_a_of_type_Qub.a())
    {
      ...
      ThreadManager.excute(new VideoFeedsFloatWindowManager.3(this, localVideoInfo1, localVideoInfo2, (List)localObject, paramqqo.jdField_a_of_type_Qbx, l2, this.g), 16, null, true);
      return;
    }
  }
  ...
  {
    if ((this.f == 0) && (b())) {
      this.jdField_a_of_type_Npv.a(this.jdField_a_of_type_Npw, this.i, (VideoInfo)this.jdField_a_of_type_JavaUtilList.get(0), this.jdField_a_of_type_JavaLangString, this.h);
    }
    if ((this.g + 1 < this.jdField_a_of_type_JavaUtilList.size()) && (bbev.h(BaseApplicationImpl.getContext())) && (bhvh.t(BaseApplicationImpl.getApplication().getRuntime()))) {
  ...
  public void c()
  {
    noo.a(null, null, "0X8009A2C", "0X8009A2C", 0, 0, "", "", null, a().a().a(), false);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      return;
      noo.a(null, null, "0X8009A2A", "0X8009A2A", 0, 0, "", "", null, a().a().a(), false);
      f();
      return;
      if ((onk.a() != null) && (onk.a().c()))
      {
    ...
    } while ((this.jdField_b_of_type_Qqo == null) || (this.jdField_b_of_type_Qqo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo == null));
    paramView = a();
    m();
    noo.a(null, null, "0X8009A29", "0X8009A29", 0, 0, "", "", null, paramView.a().a(), false);
  }
