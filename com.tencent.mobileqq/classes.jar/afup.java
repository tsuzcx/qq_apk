  ...
  implements Handler.Callback
{
  ...
  private afvg jdField_a_of_type_Afvg;
  ...
  public afup(Activity paramActivity)
  {
  ...
  private void a(int paramInt, float paramFloat)
  {
    ...
    while ((this.jdField_a_of_type_Afvg == null) || (!this.jdField_a_of_type_Afvg.isShowing())) {
      return;
    }
  ...
  private void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      axqy.b(null, "dc00898", "", "", "0X8009DC9", "0X8009DC9", 0, 0, this.jdField_c_of_type_JavaLangString, paramInt1 + paramInt2 + "", paramInt1 + "", paramInt2 + "");
      if (paramInt2 <= 0) {
        break;
      }
      axqy.b(null, "dc00898", "", "", "0X8009DCC", "0X8009DCC", 0, 0, "" + paramInt2, "", "", "");
      return;
      if ((paramInt1 > 0) && (paramInt2 > 0))
      {
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    for (str = "0";; str = "1")
    {
      axqy.b(null, "dc00898", "", "", "0X8009DC9", "0X8009DC9", 0, 0, this.jdField_c_of_type_JavaLangString, "1", paramString + "", str + "");
      return;
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    for (String str = ajya.a(2131713608);; str = ajya.a(2131713608) + this.jdField_a_of_type_JavaLangString)
    {
      bbgu localbbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230);
      localbbgu.setTitle(paramString1);
      localbbgu.setMessage(paramString2);
      localbbgu.setPositiveButton("留在QQ", new afvb(this, paramBoolean, paramString3)).setNegativeButton(str, new afva(this, paramBoolean, paramString3)).show();
      return;
    }
  }
  ...
  private void a(List<Uri> paramList)
  {
    ...
    ((ansx)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).b();
    this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.jdField_c_of_type_JavaLangRunnable, 2000L);
    new afuq(this, paramList).execute(new Void[0]);
  }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    ((ansx)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).a(paramArrayList, new afuy(this, i));
  }
  ...
  private void h()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131719421) + this.jdField_a_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          ((bbgu)localObject1).setMessage(ajya.a(2131713613));
          ((bbgu)localObject1).setNegativeButton(2131690596, new afuz(this));
    ...
    aabq.a(this.jdField_a_of_type_AndroidAppActivity, 1, this.jdField_c_of_type_JavaLangString, (Bundle)localObject3).a("sdk_face_collection", null, new afvc(this, str));
  }
  ...
  private void i()
  {
    ...
    if (localOpenID == null)
    {
      ...
      try
      {
        ...
        localQQAppInterface.a().a(l, this.jdField_d_of_type_JavaLangString, Long.valueOf(this.jdField_c_of_type_JavaLangString).longValue(), new afvd(this));
        return;
      }
  ...
  private void j()
  {
    ((ansx)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).e();
  }
  ...
  public ArrayList<String> a(List<Uri> paramList)
  {
    ...
    aqvv localaqvv = new aqvv(this.jdField_a_of_type_AndroidAppActivity, false, null);
    int i = 0;
    while (i < localArrayList.size())
    {
      String str = localaqvv.a((Uri)localArrayList.get(i), false);
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    paramString1 = new afve(this);
    this.jdField_b_of_type_Bbgu.setNegativeButton(paramString2, paramString1);
    this.jdField_b_of_type_Bbgu.setOnKeyListener(new afvf(this));
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    int i = paramArrayList.size();
    this.jdField_a_of_type_Afvg = new afvg(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Afvg.a("收藏为QQ表情");
    this.jdField_a_of_type_Afvg.a(2131690596, new afus(this));
    this.jdField_a_of_type_Afvg.c(2131691329, new afut(this, paramArrayList, i));
    this.jdField_a_of_type_Afvg.b(2131691330, new afuu(this, i));
    this.jdField_a_of_type_Afvg.a(paramArrayList, new afuv(this, i, paramArrayList));
    if (i > 1)
    {
      ...
      this.jdField_a_of_type_Afvg.b(paramArrayList);
    }
    this.jdField_a_of_type_Afvg.setOnDismissListener(new afuw(this));
    this.jdField_a_of_type_Afvg.setOnKeyListener(new afux(this, i));
    this.jdField_a_of_type_Afvg.setCanceledOnTouchOutside(false);
    this.jdField_a_of_type_Afvg.show();
  ...
  {
    if ((this.jdField_a_of_type_Afvg != null) && (this.jdField_a_of_type_Afvg.isShowing()))
    {
      if (QLog.isColorLevel()) {
  ...
  protected void d()
  {
    ...
    this.jdField_b_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_Bbgu.setMessage(ajya.a(2131713609));
    this.jdField_b_of_type_Bbgu.setTitle(2131692234);
    afur localafur = new afur(this);
    this.jdField_b_of_type_Bbgu.setNegativeButton(2131690596, localafur);
    this.jdField_b_of_type_Bbgu.setPositiveButton(2131719431, localafur);
    this.jdField_b_of_type_Bbgu.show();
  }
  ...
  {
    this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(11);
    if (this.jdField_a_of_type_Afvg != null) {
