  ...
  implements aizr
{
  ...
  private boolean Y;
  private boolean Z;
  private aenm jdField_a_of_type_Aenm;
  private aenn jdField_a_of_type_Aenn;
  private aizd jdField_a_of_type_Aizd;
  protected akav a;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aeng(this);
  private Handler jdField_a_of_type_AndroidOsHandler = new bfnk(ThreadManager.getSubThreadLooper(), this.jdField_a_of_type_AndroidOsHandler$Callback);
  ...
  public aena(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aenb(this);
    this.jdField_a_of_type_Akav = new aend(this);
    ((airz)paramQQAppInterface.getManager(153)).a().a(this);
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      if (paramInt2 > 86400)
      {
        paramString = (int)Math.ceil(paramInt2 / 86400.0D) + ajyc.a(2131702042);
    ...
    for (;;)
    {
      ...
      if (paramInt2 > 3600)
      {
        paramString = (int)Math.ceil(paramInt2 / 3600.0D) + ajyc.a(2131702046);
        break;
      }
      paramString = (int)Math.ceil(paramInt2 / 60.0D) + ajyc.a(2131702040);
      break;
      this.ac = true;
      this.jdField_f_of_type_AndroidWidgetTextView.setText(ajyc.a(2131719765));
      if (this.jdField_a_of_type_MqqOsMqqHandler != null)
      {
        this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(16777215);
  ...
  private void a(String paramString, aenn paramaenn, int paramInt)
  {
    boolean bool;
    if (paramInt == 4)
    {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "[updateFriendAndShield] friUin:" + paramString + ", " + paramaenn.toString());
      }
      ...
      if ((!TextUtils.isEmpty(paramaenn.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity != null) && (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent() != null))
      {
    ...
    } while (paramaenn.jdField_c_of_type_Int == 4);
    label204:
    ...
    this.o = ((TextView)this.h.findViewById(2131378262));
    this.jdField_p_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131363456));
    this.jdField_q_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131378416));
    this.jdField_a_of_type_ComTencentMobileqqApolloLightGameDotPollingView = ((DotPollingView)this.h.findViewById(2131365379));
    this.jdField_r_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131363455));
    this.jdField_s_of_type_AndroidWidgetTextView = ((TextView)this.h.findViewById(2131378324));
    this.jdField_p_of_type_AndroidWidgetImageView = ((ImageView)this.h.findViewById(2131368685));
    this.l = ((TextView)this.h.findViewById(2131378045));
    this.i = ((RelativeLayout)this.h.findViewById(2131375384));
    this.m = ((TextView)this.h.findViewById(2131378091));
    this.n = ((TextView)this.h.findViewById(2131378064));
    if ((paramaenn.jdField_a_of_type_Int <= 0) && (TextUtils.isEmpty(paramaenn.jdField_c_of_type_JavaLangString)) && (paramaenn.jdField_b_of_type_Int <= 0))
    {
      this.n.setVisibility(0);
      label743:
      this.l.setText(paramaenn.jdField_a_of_type_Int + ajyc.a(2131702044));
      this.m.setText(paramaenn.jdField_c_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setRadius(actn.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setImageURL(paramaenn.d);
      if (!TextUtils.isEmpty(paramaenn.jdField_a_of_type_JavaLangString)) {
        break label1253;
      }
      this.o.setText(paramaenn.e);
      label840:
      this.jdField_p_of_type_AndroidWidgetTextView.setBackgroundDrawable(aizg.a(this.jdField_a_of_type_AndroidContentContext, actn.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), "#000000"));
      this.jdField_p_of_type_AndroidWidgetTextView.setTextColor(aizg.a(Color.parseColor("#ffec00"), Color.parseColor("#80ffec00")));
      this.jdField_r_of_type_AndroidWidgetTextView.setBackgroundDrawable(aizg.a(this.jdField_a_of_type_AndroidContentContext, actn.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(23.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), "#000000"));
      this.jdField_r_of_type_AndroidWidgetTextView.setTextColor(aizg.a(Color.parseColor("#ffec00"), Color.parseColor("#80ffec00")));
      ...
      if (paramaenn.jdField_c_of_type_Int != 1) {
        break label1267;
      }
      this.jdField_p_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameDotPollingView.setVisibility(0);
      ...
      this.jdField_s_of_type_AndroidWidgetTextView.setVisibility(8);
      label1043:
      paramString = new RelativeLayout.LayoutParams(-1, actn.a(66.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      paramString.addRule(3, 2131375327);
      if (!this.I) {
        break label1368;
      }
    }
    label1368:
    for (paramString.topMargin -= actn.a(3.0F, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources());; paramString.topMargin = 0)
    {
      this.m.getViewTreeObserver().addOnPreDrawListener(new aenl(this, paramaenn));
      this.jdField_d_of_type_AndroidViewViewGroup.addView(this.h, paramString);
      if (((this.jdField_a_of_type_Acut.a().size() != 0) && (!(this.jdField_a_of_type_Acut.a().get(0) instanceof MessageForCmGameTips))) || (this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips == null)) {
        break;
      }
      ...
      return;
      if (paramaenn.jdField_a_of_type_Int > 0) {
        this.l.setVisibility(0);
      }
      if (!TextUtils.isEmpty(paramaenn.jdField_c_of_type_JavaLangString)) {
        this.i.setVisibility(0);
      }
      if ((paramaenn.jdField_b_of_type_Int != 1) && (paramaenn.jdField_b_of_type_Int != 2)) {
        break label743;
      }
      this.jdField_p_of_type_AndroidWidgetImageView.setVisibility(0);
      break label743;
      label1253:
      this.o.setText(paramaenn.jdField_a_of_type_JavaLangString);
      break label840;
      label1267:
      if (paramaenn.jdField_c_of_type_Int == 2)
      {
        this.jdField_p_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_q_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_ComTencentMobileqqApolloLightGameDotPollingView.setVisibility(8);
  ...
  private void a(List<aizs> paramList, int paramInt)
  {
    if (paramList == null) {
      return;
    }
    int j = actn.a(7.0F, a().getResources());
    if (bbct.a() <= 2.0F) {
      j = actn.a(9.0F, a().getResources());
    }
    aizs localaizs = aizk.a(paramInt);
    if (localaizs != null)
    {
      paramList.add(localaizs);
      return;
    }
    switch (paramInt)
    {
    ...
    case 0: 
      localaizs = new aizs();
      localaizs.jdField_a_of_type_Int = 1;
      localaizs.jdField_a_of_type_JavaLangCharSequence = ajyc.a(2131702035);
      paramList.add(localaizs);
      return;
    case 7: 
      localaizs = new aizs();
      localaizs.jdField_a_of_type_Int = 7;
      localaizs.jdField_a_of_type_JavaLangCharSequence = new ayki(ayla.c(193), 3, j);
      paramList.add(localaizs);
      return;
    case 6: 
      localaizs = new aizs();
      localaizs.jdField_a_of_type_Int = 6;
      localaizs.jdField_a_of_type_JavaLangCharSequence = ajyc.a(2131702050);
      paramList.add(localaizs);
      return;
    case 5: 
      localaizs = new aizs();
      localaizs.jdField_a_of_type_Int = 5;
      localaizs.jdField_a_of_type_JavaLangCharSequence = ajyc.a(2131702045);
      paramList.add(localaizs);
      return;
    case 4: 
      localaizs = new aizs();
      localaizs.jdField_a_of_type_Int = 4;
      localaizs.jdField_a_of_type_JavaLangCharSequence = new ayki(ayla.c(209), 3, j);
      paramList.add(localaizs);
      return;
    case 3: 
      localaizs = new aizs();
      localaizs.jdField_a_of_type_Int = 3;
      localaizs.jdField_a_of_type_JavaLangCharSequence = ajyc.a(2131702043);
      paramList.add(localaizs);
      return;
    case 2: 
      localaizs = new aizs();
      localaizs.jdField_a_of_type_Int = 2;
      localaizs.jdField_a_of_type_JavaLangCharSequence = new ayki(ayla.c(192), 3, j);
      paramList.add(localaizs);
      return;
    }
    localaizs = new aizs();
    localaizs.jdField_a_of_type_Int = 1;
    localaizs.jdField_a_of_type_JavaLangCharSequence = ajyc.a(2131702034);
    paramList.add(localaizs);
  }
  ...
  private void br()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (new Random().nextBoolean()) && (aizt.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      aizk localaizk = ((airz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a();
      int j = (int)(System.currentTimeMillis() / 1000L);
      this.jdField_r_of_type_Int = j;
      this.jdField_s_of_type_Int = j;
      localaizk.a(this.jdField_a_of_type_Aizd.jdField_a_of_type_Int, this.jdField_r_of_type_Int);
    }
  }
  ...
  private void bs()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar == null)
    {
      ...
      localObject = new RelativeLayout.LayoutParams(-1, actn.a(48.0F, a().getResources()));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Acyq.a(actn.a(48.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), false, "cmGame_addFooter", 0);
      this.Z = true;
      return;
  ...
  public void G()
  {
    ...
    localairz.a().a();
    localairz.a().b(this.jdField_a_of_type_Aenm);
    localairz.a().b("page_tag_aio");
    if (this.V)
    {
      localairz.a().d(a());
      this.V = false;
    }
    this.jdField_a_of_type_Aenm = null;
    if (this.jdField_a_of_type_Aizd != null)
    {
      this.jdField_a_of_type_Aizd.dismiss();
      this.jdField_a_of_type_Aizd = null;
    }
    super.G();
    this.W = false;
    ...
    if (this.jdField_d_of_type_Bbgg != null) {
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    Object localObject = (ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    String str = ajyc.a(2131702047);
    ApolloGameData localApolloGameData = ((ajmw)localObject).a(paramInt);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localajrf.jdField_b_of_type_Int = j;
        localajrf.jdField_a_of_type_Long = paramLong;
        localajrf.jdField_a_of_type_Int = paramInt;
        localajrf.d = 3;
        localajrf.e = 0;
        aizg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localajrf);
        return;
        localajrf.jdField_b_of_type_JavaLangString = ajyc.a(2131702041);
        j = 0;
      }
    }
  }
  ...
  public void a(int paramInt, long paramLong, String paramString)
  {
    ...
    U = true;
    aizg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramInt, paramLong);
  }
  ...
  public void a(aizo paramaizo)
  {
    ...
    if ((paramaizo.jdField_b_of_type_JavaUtilList.size() < 3) || (paramaizo.jdField_b_of_type_JavaUtilList.size() % 3 != 0))
    {
    ...
    if (!this.T)
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips = ((MessageForCmGameTips)axaq.a(-7004));
      ...
      axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", 1036);
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips.gameInfo = paramaizo;
  ...
  public void a(aizs paramaizs)
  {
    if ((paramaizs != null) && (paramaizs.jdField_a_of_type_JavaLangCharSequence != null) && (!this.ad))
    {
      aaod.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramaizs.jdField_a_of_type_JavaLangCharSequence.toString());
      if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar != null) {
      ...
      VipUtils.a(null, "cmshow", "Apollo", "quickMessage", 0, 0, new String[] { String.valueOf(paramaizs.jdField_a_of_type_Int) });
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    if (paramInt == 3)
    {
      paramString1 = new aquz(paramString1, paramString2, ajyc.a(2131702038), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, -5040, 2359297, awzw.a());
      paramString2 = new MessageForUniteGrayTip();
      paramString2.initGrayTipMsg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
      aqva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2);
    }
    String str2;
    ...
    } while ((this.jdField_a_of_type_Aenn != null) && (this.jdField_a_of_type_Aenn.jdField_c_of_type_Int == 4));
    String str1 = ajyc.a(2131702051);
    for (;;)
    {
      paramString1 = new aquz(paramString1, paramString2, str1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, -5040, 2359297, l1);
      paramString2 = new MessageForUniteGrayTip();
      paramString2.initGrayTipMsg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
      aqva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2);
      ...
      return;
      if (paramInt == 1) {
        str1 = ajyc.a(2131702049) + paramString3 + ajyc.a(2131702039);
      } else if (paramInt == 2) {
        str1 = ajyc.a(2131702036) + paramString3 + ajyc.a(2131702037);
      }
    }
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    this.G = false;
    this.V = true;
    Object localObject = (airz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    ((airz)localObject).a().a("page_tag_aio");
    ((airz)localObject).a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "join");
  ...
  public void aX()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setOnClickListener(new aenc(this));
      localObject = new RelativeLayout.LayoutParams(actn.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    if (this.jdField_b_of_type_ComTencentMobileqqApolloViewFrameGifView == null)
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloViewFrameGifView.setGifData(100, null, "https://cmshow.gtimg.cn/client/img/apollo_game_audio_micSmall.zip", ajru.a("https://cmshow.gtimg.cn/client/img/apollo_game_audio_micSmall.zip"), false);
      localObject = new LinearLayout.LayoutParams(actn.a(18.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(18.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
  ...
  public void bo()
  {
    ...
    if (localSharedPreferences.getBoolean("apollo_audio_intro", true))
    {
      ...
      localImageView.setId(2131362597);
      Object localObject1 = URLDrawable.URLDrawableOptions.obtain();
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = actn.a(200.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = actn.a(100.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      localObject2 = new RelativeLayout.LayoutParams(actn.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      ((RelativeLayout.LayoutParams)localObject2).addRule(10);
      ((RelativeLayout.LayoutParams)localObject2).setMargins(0, ImmersiveUtils.getStatusBarHeight(BaseApplicationImpl.getApplication()) + actn.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      this.g.addView(localImageView, (ViewGroup.LayoutParams)localObject2);
      localImageView = new ImageView(a());
      localObject2 = new RelativeLayout.LayoutParams(actn.a(210.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131362597);
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      ((RelativeLayout.LayoutParams)localObject2).setMargins(0, 0, actn.a(40.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      this.g.addView(localImageView, (ViewGroup.LayoutParams)localObject2);
      this.ah = true;
      this.g.setOnClickListener(new aene(this));
  ...
  public void bp()
  {
    ...
    do
    {
      ...
      localSharedPreferences = SharedPreferencesProxyManager.getInstance().getProxy("apollo_sp", 0);
    } while ((!localSharedPreferences.getBoolean("apollo_add_playMate_intro", true)) || (this.jdField_a_of_type_Aenn.jdField_c_of_type_Int != 0));
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mRequestWidth = actn.a(200.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((URLDrawable.URLDrawableOptions)localObject).mRequestHeight = actn.a(100.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    localImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
    RelativeLayout.LayoutParams localLayoutParams1 = new RelativeLayout.LayoutParams(actn.a(91.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(41.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    localLayoutParams1.addRule(11);
    localLayoutParams1.addRule(10);
    localLayoutParams1.setMargins(0, ImmersiveUtils.getStatusBarHeight(BaseApplicationImpl.getApplication()) + actn.a(57.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
    this.jdField_f_of_type_AndroidWidgetRelativeLayout.addView(localImageView, localLayoutParams1);
    localImageView = new ImageView(a());
    localLayoutParams1 = new RelativeLayout.LayoutParams(actn.a(210.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    localLayoutParams1.addRule(3, 2131362596);
    localLayoutParams1.addRule(11);
    localLayoutParams1.setMargins(0, 0, actn.a(40.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
    ...
    this.jdField_f_of_type_AndroidWidgetRelativeLayout.addView(localImageView, localLayoutParams1);
    this.jdField_f_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new aenf(this));
  ...
  public void d(Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_Aenm == null) {
      this.jdField_a_of_type_Aenm = new aenm(this);
    }
    ((airz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(this.jdField_a_of_type_Aenm);
  ...
  public void f(String paramString)
  {
    if (this.h != null)
    {
      ...
      a(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Aenn.jdField_a_of_type_JavaLangString, 2);
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForCmGameTips != null)
      {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar != null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameQuickInputTipsBar != null)
        {
          ...
          if ("dialog_type_permission".equals(localObject))
          {
            if (this.jdField_d_of_type_Bbgg == null)
            {
              localObject = bbcv.a(a(), 230).setMessage(a().getString(2131695960)).setTitle(a().getString(2131695961)).setNegativeButton(2131690596, new aeni(this));
              if (!muf.a(a())) {
                break label218;
              }
            }
            label218:
            for (int j = 2131695962;; j = 2131695963)
            {
              this.jdField_d_of_type_Bbgg = ((bbgg)localObject).setPositiveButton(j, new aenh(this));
              this.jdField_d_of_type_Bbgg.show();
              break;
            }
          }
          ...
          {
            if (this.c == null) {
              this.c = bbcv.a(a(), 230).setMessage(ajyc.a(2131702048)).setPositiveButton(a().getString(2131694793), new aenk(this)).setNegativeButton(a().getString(2131690596), new aenj(this));
            }
            this.c.show();
          }
        }
  ...
  public void k()
  {
    ...
    localaizk.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1);
    localaizk.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    localObject = ((airz)localObject).a();
    if ((aiyr.jdField_a_of_type_Boolean) && (!((aiyr)localObject).b())) {
      ((aiyr)localObject).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 319);
    }
    if ((!TextUtils.isEmpty(((aiyr)localObject).a())) && (((aiyr)localObject).a().equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      this.jdField_a_of_type_ComTencentMobileqqApolloViewFrameGifView.setImageResource(2130838956);
    }
    localaizk.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 319);
    localaizk.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
