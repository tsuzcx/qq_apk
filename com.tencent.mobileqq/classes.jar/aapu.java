...
{
  private static aapu jdField_a_of_type_Aapu;
  ...
  public static final void b()
  {
    ...
    if (!TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {
      jdField_a_of_type_Aapu.callJs(jdField_a_of_type_JavaLangString, new String[] { String.valueOf(true) });
    }
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_AndroidHardwareSensorManager != null) && (this.jdField_a_of_type_Aapv != null))
    {
      this.jdField_a_of_type_AndroidHardwareSensorManager.unregisterListener(this.jdField_a_of_type_Aapv);
      this.jdField_a_of_type_Aapv = null;
    }
  ...
  public final boolean a(String paramString)
  {
    ...
    if (apfg.a())
    {
      ...
      if (this.jdField_a_of_type_Aapv != null) {
        a();
      }
      this.jdField_a_of_type_Aapv = new aapv(this, (byte)3, paramString);
      if (!Build.MODEL.equalsIgnoreCase("Nexus 5X")) {
        break label194;
      }
      this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Aapv, (Sensor)localObject, 3);
      label141:
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      break;
      label194:
      this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Aapv, (Sensor)localObject, 1);
      break label141;
      label211:
