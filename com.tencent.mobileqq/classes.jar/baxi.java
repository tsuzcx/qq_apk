...
public class baxi
{
  ...
  private static Map<String, baxk<Bitmap>> jdField_a_of_type_JavaUtilMap = Collections.synchronizedMap(new HashMap());
  ...
  public static Bitmap a(Resources paramResources, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localbaxj.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(paramResources, paramInt, (BitmapFactory.Options)localObject);
      }
      catch (OutOfMemoryError paramResources)
      {
        Object localObject;
        localbaxj.jdField_a_of_type_Int = 1;
        continue;
      }
      catch (Throwable paramResources)
      {
        localbaxj.jdField_a_of_type_Int = 3;
        continue;
      }
      if (localbaxj.jdField_a_of_type_AndroidGraphicsBitmap != null)
      {
        localbaxj.jdField_a_of_type_Int = 0;
        paramResources = String.valueOf(localbaxj.jdField_a_of_type_AndroidGraphicsBitmap.hashCode());
        localObject = new baxk(paramResources, localbaxj.jdField_a_of_type_AndroidGraphicsBitmap, jdField_a_of_type_JavaLangRefReferenceQueue);
        jdField_a_of_type_JavaUtilMap.put(paramResources, localObject);
      }
      return localbaxj.jdField_a_of_type_AndroidGraphicsBitmap;
  ...
  public static Bitmap a(Resources paramResources, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramResources != null)
    {
      ...
      baxk localbaxk = new baxk((String)localObject, paramResources, jdField_a_of_type_JavaLangRefReferenceQueue);
      jdField_a_of_type_JavaUtilMap.put(localObject, localbaxk);
    }
  ...
  public static Bitmap a(InputStream paramInputStream, Rect paramRect, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      if (paramInputStream != null)
      {
        ...
        localObject = new baxk(paramRect, paramInputStream, jdField_a_of_type_JavaLangRefReferenceQueue);
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramString != null)
    {
      ...
      baxk localbaxk = new baxk((String)localObject, paramString, jdField_a_of_type_JavaLangRefReferenceQueue);
      jdField_a_of_type_JavaUtilMap.put(localObject, localbaxk);
    }
    return paramString;
  }
  ...
  public static Bitmap a(String paramString, BitmapFactory.Options paramOptions)
  {
    ...
    a(paramString, paramOptions, localbaxj);
    return localbaxj.jdField_a_of_type_AndroidGraphicsBitmap;
  }
  ...
  public static Bitmap a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localbaxj.jdField_a_of_type_AndroidGraphicsBitmap = SafeBitmapFactory.decodeByteArray(paramArrayOfByte, paramInt1, paramInt2, localOptions);
      }
      ...
      {
        localbaxj.jdField_a_of_type_Int = 0;
        paramArrayOfByte = String.valueOf(localbaxj.jdField_a_of_type_AndroidGraphicsBitmap.hashCode());
        localObject = new baxk(paramArrayOfByte, localbaxj.jdField_a_of_type_AndroidGraphicsBitmap, jdField_a_of_type_JavaLangRefReferenceQueue);
  ...
  public static baxj a(String paramString, BitmapFactory.Options paramOptions)
  {
    baxj localbaxj = new baxj();
    a(paramString, paramOptions, localbaxj);
    return localbaxj;
  ...
  private static void a()
  {
    for (;;)
    {
      baxk localbaxk = (baxk)jdField_a_of_type_JavaLangRefReferenceQueue.poll();
      if (localbaxk == null) {
        break;
      }
      jdField_a_of_type_JavaUtilMap.remove(baxk.a(localbaxk));
    }
  }
  
  /* Error */
  public static void a(String paramString, BitmapFactory.Options paramOptions, baxj parambaxj)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 8
    ...
    //   44: aload_2
    //   45: iconst_2
    //   46: putfield 107	baxj:jdField_a_of_type_Int	I
    //   49: iconst_0
    //   50: ifeq +11 -> 61
    ...
    //   182: aload_2
    //   183: iconst_3
    //   184: putfield 107	baxj:jdField_a_of_type_Int	I
    //   187: aload 4
    //   189: ifnull +8 -> 197
    //   192: aload 4
    ...
    //   242: putfield 105	baxj:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   245: aload 4
    //   247: ifnull +8 -> 255
    //   250: aload 4
    ...
    //   268: aload_2
    //   269: getfield 105	baxj:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   272: ifnull -200 -> 72
    //   275: aload_2
    //   276: iconst_0
    //   277: putfield 107	baxj:jdField_a_of_type_Int	I
    //   280: new 117	baxk
    //   283: dup
    //   284: aload_0
    //   285: aload_2
    //   286: getfield 105	baxj:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   289: getstatic 29	baxi:jdField_a_of_type_JavaLangRefReferenceQueue	Ljava/lang/ref/ReferenceQueue;
    //   292: invokespecial 120	baxk:<init>	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/ref/ReferenceQueue;)V
    //   295: astore_1
    //   296: getstatic 24	baxi:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   299: aload_0
    //   300: aload_1
    ...
    //   320: aload_2
    //   321: iconst_2
    //   322: putfield 107	baxj:jdField_a_of_type_Int	I
    //   325: aload 4
    //   327: ifnull +8 -> 335
    //   330: aload 4
    ...
    //   363: aload_2
    //   364: iconst_1
    //   365: putfield 107	baxj:jdField_a_of_type_Int	I
    //   368: aload 4
    //   370: ifnull +8 -> 378
    //   373: aload 4
    ...
    //   406: aload_2
    //   407: iconst_3
    //   408: putfield 107	baxj:jdField_a_of_type_Int	I
    //   411: aload 4
    //   413: ifnull +8 -> 421
    //   416: aload 4
    ...
    //   0	522	2	parambaxj	baxj
    //   109	51	3	i	int
    //   89	404	4	localBufferedInputStream	java.io.BufferedInputStream
    //   10	495	5	localObject1	Object
    //   7	495	6	localObject2	Object
    //   13	251	7	arrayOfByte1	byte[]
    //   1	386	8	localObject3	Object
    //   16	328	9	arrayOfByte2	byte[]
    //   4	426	10	localObject4	Object
  ...
  public static Bitmap b(Resources paramResources, int paramInt)
  {
    ...
    try
    {
      localbaxj.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(paramResources, paramInt, new BitmapFactory.Options());
      if (localbaxj.jdField_a_of_type_AndroidGraphicsBitmap != null)
      {
        localbaxj.jdField_a_of_type_Int = 0;
        paramResources = String.valueOf(localbaxj.jdField_a_of_type_AndroidGraphicsBitmap.hashCode());
        baxk localbaxk = new baxk(paramResources, localbaxj.jdField_a_of_type_AndroidGraphicsBitmap, jdField_a_of_type_JavaLangRefReferenceQueue);
        jdField_a_of_type_JavaUtilMap.put(paramResources, localbaxk);
      }
      return localbaxj.jdField_a_of_type_AndroidGraphicsBitmap;
    }
    catch (OutOfMemoryError paramResources)
