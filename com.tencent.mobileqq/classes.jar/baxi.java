...
public class baxi
{
  ...
  public static void a(Activity paramActivity, File paramFile, String paramString, baxm parambaxm)
  {
    ...
    {
      str = bgmg.b(paramFile.getAbsolutePath());
      str = paramString + "." + str;
    }
    paramString = new File(anhk.bg, str);
    if (!paramString.exists())
    {
      b(paramActivity, paramFile, paramString, parambaxm);
      return;
    }
    bglp.a(paramActivity, 230).setTitle(paramActivity.getString(2131717422)).setMessage(paramActivity.getString(2131694323)).setPositiveButton(paramActivity.getString(2131717317), new baxk(paramActivity, paramFile, paramString, parambaxm)).setNegativeButton(paramActivity.getString(2131693977), new baxj()).show();
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, RichMediaBrowserInfo paramRichMediaBrowserInfo, boolean paramBoolean, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      blsb.a(paramActivity, localblsi, paramBoolean, paramString3, paramString2, paramInt, paramString1, paramRichMediaBrowserInfo, l2, l1, -1);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt1, List<MessageForPic> paramList, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      i = 1;
      label145:
      paramString1 = bdzx.a(localMessageForPic, i, "chatthumb");
      if (paramString1 == null) {
        break label383;
      }
      paramString1 = bdsh.d(paramString1.toString());
      if (paramString1 == null) {
        break label365;
      }
    ...
    for (;;)
    {
      ...
      break label112;
      blsb.a(paramActivity, localblsi, bool, paramString3, paramString2, paramInt1, localArrayList1, localArrayList2, localArrayList3, localArrayList4, paramInt2);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    blsb.a(paramActivity, paramString, 0, 0, paramArrayList, paramActivity.getResources().getString(2131716781), paramInt);
  }
  
  private static void b(Activity paramActivity, File paramFile1, File paramFile2, baxm parambaxm)
  {
    new baxl(paramFile1, paramFile2, paramActivity, parambaxm).execute(new Void[0]);
  }
}
