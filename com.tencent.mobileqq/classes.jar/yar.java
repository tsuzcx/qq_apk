...
public class yar
{
  ...
  public yar(@NonNull QQAppInterface paramQQAppInterface)
  {
  ...
  public Intent a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, Intent paramIntent)
  {
    ...
    Object localObject1 = (baif)this.a.getManager(36);
    Object localObject2 = ((baif)localObject1).a("103100.103500.103501");
    ...
    for (;;)
    {
      ...
      {
        ((baif)localObject1).b("103100.103500.103501");
      ...
      for (;;)
      {
        ...
        boolean bool2 = bcls.a(this.a, BaseApplicationImpl.getContext());
        localObject1 = agaa.a(wes.e);
        localObject2 = new File(anhk.bn);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        return wkb.a(paramContext, paramBoolean2, paramIntent, paramBoolean1, bool1, bool2, (String)localObject1, this.a.getAccount());
        paramBoolean1 = false;
        break;
      }
      paramBoolean1 = false;
