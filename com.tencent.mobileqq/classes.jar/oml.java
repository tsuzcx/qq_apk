...
public class oml
  extends amyh
{
  public oml(ReadInJoySettingActivity paramReadInJoySettingActivity) {}
  ...
  public void onSetPublicAccountSubscribeStatus(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    if ((this.a.jdField_a_of_type_Int == 0) && (this.a.jdField_a_of_type_Bhht != null) && (this.a.jdField_a_of_type_Bhht.isShowing())) {
    ...
    if (paramInt == this.a.b)
    {
      ...
      odq.a(null, "CliOper", "", "", "0X80067D5", "0X80067D5", 0, 0, "", "", "", pay.f(), false);
      label147:
    ...
    for (;;)
    {
      ...
      break;
      label173:
      odq.a(null, "CliOper", "", "", "0X800676D", "0X800676D", 0, 0, "", "", "", pay.f(), false);
      break label147;
      label202:
      QQToast.a(this.a.getApplicationContext(), 2131698813, 0).a();
      this.a.c = true;
