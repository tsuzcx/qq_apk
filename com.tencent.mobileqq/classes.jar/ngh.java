  ...
  extends ajfb
{
  ...
  public ngh(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_Ajmm = new ngi(this);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        nfp.b = localArrayList;
        if ((localJSONArray2 != null) && (localJSONArray2.length() > 0))
        {
          i = 0;
          if (i < localJSONArray2.length())
          {
            nfp.c.add(String.valueOf(localJSONArray2.getLong(i)));
            i += 1;
            continue;
          }
        }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return;
      nfp localnfp = (nfp)this.app.getManager(88);
      ...
      localObject = localnfp.a(paramMessageRecord.senderuin);
      ...
      localnfp.a((EcShopData)localObject);
  ...
  public void a(boolean paramBoolean, MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    try
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        paramString = new nfz();
        paramString.a = 3;
        paramMessageRecord = nfw.a(paramString, paramMessageRecord);
        paramMessageRecord.f = paramInt;
        ((nfw)this.app.a(139)).a(paramMessageRecord, null);
        return;
      }
      if (paramBoolean)
      {
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        ...
        ((nfz)localObject1).a = 1;
        localObject1 = nfw.a((nfz)localObject1, paramMessageRecord);
        ((nfw)this.app.a(139)).a((nfz)localObject1, null);
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          ...
          yof.a(0, 2, nfp.a((awul)paramMessageRecord.mStructMsgItemLists.get(0)));
          return;
        }
        ...
        yof.a(0, 2, (qq_ad_get.QQAdGetRsp.AdInfo)localObject1);
        return;
      }
    }
    catch (Throwable paramMessageRecord)
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramToServiceMsg = (nfp)this.app.getManager(88);
