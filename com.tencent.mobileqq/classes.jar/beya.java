  ...
  implements View.OnClickListener
{
  ...
  public beya(Context paramContext, ExtendGridView paramExtendGridView)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 9;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = paramExtendGridView;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130847846);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131695970);
    this.jdField_b_of_type_JavaLangCharSequence = BaseApplication.getContext().getResources().getText(2131717561);
  ...
  {
    int i = (int)bhdz.a(paramContext, 60.0F);
    int j = (int)bhdz.a(paramContext, 5.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559968, null);
      localbeyb = new beyb();
      localbeyb.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131380565));
      localbeyb.b = ((ImageView)localView.findViewById(2131368705));
      localbeyb.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131376982));
      localView.setTag(localbeyb);
      ...
      localbeyb.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      localbeyb.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130842553);
      localbeyb.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_JavaLangCharSequence);
      localbeyb.b.setVisibility(8);
    }
    label260:
    label275:
    String str;
    do
    {
      ...
      return localView;
      localbeyb = (beyb)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
    ...
    if (i < 0)
    {
      ...
      label321:
      i = Math.min(100, i);
      localbeyb.jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
    ...
    for (;;)
    {
      ...
      localbeyb.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramView);
      localbeyb.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_b_of_type_JavaLangCharSequence);
      localbeyb.b.setVisibility(0);
      localbeyb.b.setTag(Integer.valueOf(paramInt));
      localbeyb.b.setOnClickListener(this);
      localbeyb.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      break;
      j = i;
      break label303;
      label484:
