...
public class bqjr
  extends bqkf
{
  public bqjr(DoodleView paramDoodleView)
  {
  ...
  public void a(@NonNull Bitmap paramBitmap, @NonNull Rect[] paramArrayOfRect, String[] paramArrayOfString, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    {
      this.jdField_a_of_type_Bqkh = new bqjs(this, paramArrayOfString, paramBitmap, new PointF(zps.a(this.jdField_a_of_type_AndroidContentContext) / 2, zps.d(this.jdField_a_of_type_AndroidContentContext) / 2), paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramBitmap.getWidth(), paramBitmap.getHeight(), true);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bqkh.jdField_a_of_type_ArrayOfJavaLangString = paramArrayOfString;
    }
  }
}
