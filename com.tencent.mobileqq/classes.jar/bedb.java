...
public class bedb
{
  ...
  public bedb(AppInterface paramAppInterface, Activity paramActivity, bifc parambifc, Intent paramIntent, boolean paramBoolean)
  {
  ...
  {
    bedc localbedc = new bedc(this);
    paramTouchWebView.setWebChromeClient(localbedc);
    this.jdField_a_of_type_Ofz = localbedc;
  }
  ...
  public TouchWebView a(AppInterface paramAppInterface, Activity paramActivity, Intent paramIntent, boolean paramBoolean)
  {
    ...
    Object localObject2;
    if (becx.a(paramActivity, paramIntent.getStringExtra("url")))
    {
      localObject2 = becx.a(paramActivity);
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        ...
        String str2 = a(this.jdField_a_of_type_Bifc);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label891;
        }
        paramBoolean = true;
        QLog.i("WebLog_WebViewWrapper", 1, biit.a(str1, str2, paramBoolean));
        localObject3 = new StringBuilder();
        str1 = localWebSettings.getUserAgentString();
        str2 = a(this.jdField_a_of_type_Bifc);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label897;
        }
        paramBoolean = true;
        localWebSettings.setUserAgentString(biit.a(str1, str2, paramBoolean) + (String)localObject2);
      ...
      try
      {
        ...
        this.jdField_a_of_type_Auhp = new auhp(paramAppInterface, paramActivity, (TouchWebView)localObject1);
        this.jdField_a_of_type_Auhp.a(paramBoolean);
        ((TouchWebView)localObject1).setDownloadListener(this.jdField_a_of_type_Auhp);
        CookieSyncManager.createInstance(paramAppInterface.getApplication().getApplicationContext());
        if (((TouchWebView)localObject1).getX5WebViewExtension() != null)
        {
          ((TouchWebView)localObject1).getX5WebViewExtension().setWebViewClientExtension(new bedf(this, (TouchWebView)localObject1, this.jdField_a_of_type_Bifc));
          afoe.b(paramIntent, "use_x5", "1");
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(bihv.x), " cost:", Long.valueOf(biis.a) });
          }
          return localObject1;
          ...
          paramAppInterface.put("coreInit", String.valueOf(biis.a));
          paramAppInterface.put("coldStart", String.valueOf(bihv.s));
  ...
  String a(bifc parambifc)
  {
    if (parambifc != null) {
      return parambifc.getUAMark();
    }
    return null;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bifc != null) {
      this.jdField_a_of_type_Bifc = null;
    }
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean) {
          becy.a().a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
        }
        for (;;)
        {
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new bedd(this);; localObject = new bede(this))
    {
