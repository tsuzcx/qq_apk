  ...
  implements Cloneable
{
  ...
  public bedb(long paramLong)
  {
    this.a = paramLong;
  }
  
  public bedb(byte[] paramArrayOfByte)
  {
    this(paramArrayOfByte, 0);
  }
  
  public bedb(byte[] paramArrayOfByte, int paramInt)
  {
  ...
  {
    if ((paramObject == null) || (!(paramObject instanceof bedb))) {}
    while (this.a != ((bedb)paramObject).a()) {
      return false;
    }
    return true;
  }
