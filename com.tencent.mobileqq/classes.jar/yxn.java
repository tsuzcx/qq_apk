  ...
  extends RelativeLayout
{
  ...
  public yxn(ApolloGameInfoFragment paramApolloGameInfoFragment, Context paramContext, String paramString)
  {
    super(paramContext);
    a(paramString);
  }
  ...
  public void a(Bitmap paramBitmap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      setOnClickListener(new yxp(this));
      return;
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130838068);
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845465);
