...
public class avbv
  implements avbu
{
  static INetEngine.IBreakDownFix jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new avby();
  private static File jdField_a_of_type_JavaIoFile;
  private static Comparator<File> jdField_a_of_type_JavaUtilComparator = new avbw();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private INetEngine.INetEngineListener jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new avbx(this);
  private INetEngine jdField_a_of_type_ComTencentMobileqqTransfileINetEngine;
  private ConcurrentHashMap<String, List<avbz>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  public static String a(String paramString)
  {
    ...
    {
      jdField_a_of_type_JavaIoFile = new File(auyr.a);
    ...
    return new File(auyr.a, MD5Utils.toMD5(paramString)).getAbsolutePath();
  }
  ...
  private void a(MusicInfo paramMusicInfo)
  {
          ...
          if (paramMusicInfo.b.size() > 0)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str)) {
                ((List)localObject1).add(new avbz(paramMusicInfo.a, str));
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (avbz)localIterator.next();
        if (((avbz)localObject2).a == 1)
        {
          bool = true;
          break label583;
        }
      ...
      for (;;)
      {
        ...
        break;
        if ((((avbz)localObject2).a == 0) && (localObject1 == null))
        {
          localObject1 = localObject2;
          break label595;
        }
        do
        {
          ...
          ((HttpNetReq)localObject2).mReqUrl = ((avbz)localObject1).b;
          ((HttpNetReq)localObject2).mHttpMethod = 0;
          ((HttpNetReq)localObject2).mOutPath = ((avbz)localObject1).d;
  ...
  {
    int i = bhov.a(BaseApplicationImpl.getContext());
    boolean bool;
    if (paramInt == 0) {
      bool = true;
    }
  ...
  public static void b()
  {
    ...
    Object localObject1 = new File(auyr.a);
  ...
  private boolean b(int paramInt)
  {
    ...
    File localFile1 = new File(auyr.a);
    Object localObject;
    int i;
  ...
  public void a(String paramString)
  {
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 59	avbv:b	Ljava/util/concurrent/ConcurrentHashMap;
    //   25: aload_1
    ...
    //   34: ifnull +13 -> 47
    //   37: aload_0
    //   38: getfield 52	avbv:jdField_a_of_type_ComTencentMobileqqTransfileINetEngine	Lcom/tencent/mobileqq/transfile/INetEngine;
    //   41: aload_2
    //   42: invokeinterface 359 2 0
    //   47: aload_0
    //   48: getfield 57	avbv:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   51: aload_1
