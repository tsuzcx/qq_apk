  ...
  implements Manager
{
  ...
  private String jdField_b_of_type_JavaLangString = anzj.a(2131712329);
  private boolean jdField_b_of_type_Boolean;
  private String jdField_c_of_type_JavaLangString = anzj.a(2131712330);
  private boolean jdField_c_of_type_Boolean;
  
  public auvv(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_b_of_type_Boolean = bhsi.A(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
  }
  
  public static auvv a(QQAppInterface paramQQAppInterface)
  {
    return (auvv)paramQQAppInterface.getManager(286);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (avrl)paramQQAppInterface.getManager(219);
  ...
  {
    int j = bhsi.aK(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    if (QLog.isColorLevel()) {
      QLog.d("RichTextChatManager", 2, "last Memoried Tab:" + j);
    }
    int i;
    if (j == -1) {
      if (!bhsi.z(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin()))
      {
        i = paramArrayList.indexOf(Integer.valueOf(a(paramQQAppInterface)));
        bhsi.r(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), true);
        if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Integer paramInteger, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bhsi.aI(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = bhsi.aJ(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int n = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (m != n) {
      bhsi.Z(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), n);
    }
    for (;;)
    {
      if (k != i)
      {
        paramInteger = arry.b(paramConfig, i, paramInteger.intValue());
        if (QLog.isColorLevel()) {
        ...
        bhsi.f(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), k, paramInteger);
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface)
  {
    ...
    bhsi.s(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin(), paramBoolean);
  }
