  ...
  implements Manager
{
  ...
  private CopyOnWriteArrayList<akyg> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public akyp(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    QLog.i("cmgame_process.CmGameManager", 1, "[CmGameManager] created.");
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = new ApolloCmdChannel(akwd.a());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new akyr();
  ...
  public akst a()
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 379	akyp:jdField_a_of_type_Akst	Lakst;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 381	akst
    //   28: dup
    //   29: invokespecial 382	akst:<init>	()V
    //   32: putfield 379	akyp:jdField_a_of_type_Akst	Lakst;
    ...
    //   50: aload_0
    //   51: getfield 379	akyp:jdField_a_of_type_Akst	Lakst;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
  ...
  public akyg a()
  {
    ...
    {
      akyg localakyg = (akyg)localIterator.next();
      if ((localakyg != null) && (!akwd.a(localakyg.a())) && (!akwd.b(localakyg.a()))) {
        return localakyg;
      }
    }
    return null;
  ...
  public akyg a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      akyg localakyg = (akyg)localIterator.next();
      if ((localakyg != null) && (paramInt == localakyg.a())) {
        return localakyg;
      }
    }
    return null;
  ...
  public akyg a(int paramInt1, int paramInt2)
  {
    if (paramInt1 <= 0) {}
    for (;;)
    {
      ...
      akyg localakyg = new akyg(paramInt1);
      localakyg.d = paramInt2;
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, localakyg);
  ...
  /* Error */
  public akyg a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	akyp:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   28: checkcast 390	akyg
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 423	akyg:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
  ...
  public List<akys> a()
  {
    ...
    Collections.sort(localArrayList, new akyq(this));
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      akys localakys = (akys)localIterator.next();
      if (localakys != null) {
        if (localakys.jdField_a_of_type_JavaLangRefWeakReference == null)
        {
          localArrayList.add(localakys);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localakys.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localakys.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localakys);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localakys.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localakys = (akys)localIterator.next();
        if ((localakys != null) && (localakys.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localakys.jdField_a_of_type_Int = 1;
          localakys.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localakys);
        }
      }
      for (;;)
      {
        ...
        localakys = new akys();
        localakys.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localakys.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localakys.jdField_a_of_type_Int = 1;
        localakys.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localakys);
        return;
        localakys = null;
      }
    }
  ...
  /* Error */
  public akyg b(int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 392	akyg:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 406	akyg:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 47	akyp:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    ...
    //   89: aload_0
    //   90: getfield 47	akyp:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localakys != null) && (localakys.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localakys.jdField_a_of_type_Int = 2;
          localakys.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localakys.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localakys);
        }
      }
      for (paramActivity = localakys; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (akys)localIterator.next();
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      akue.a();
      if (this.jdField_a_of_type_Akst != null) {
        this.jdField_a_of_type_Akst.a();
      }
      this.c = false;
      return;
    }
