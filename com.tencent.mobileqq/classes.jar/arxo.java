...
{
  public arxo(MessageForQQWalletTips paramMessageForQQWalletTips, SoftReference paramSoftReference1, SoftReference paramSoftReference2, QQAppInterface paramQQAppInterface, Context paramContext, agvx paramagvx, akwu paramakwu, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl))
      {
        ...
        paramView = bmrq.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl, MessageForQQWalletTips.access$100(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), true);
        alik.a(this.jdField_a_of_type_AndroidContentContext, paramView);
        return;
      }
      if ((MessageForQQWalletTips.access$200(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips) != 524288) || (this.jdField_a_of_type_Agvx == null) || (this.jdField_a_of_type_Akwu == null)) {
        break;
      }
      localObject2 = this.jdField_a_of_type_Akwu.a(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips));
      if ((localObject2 == null) || (((akwt)localObject2).a) || (((akwt)localObject2).b) || (((akwt)localObject2).a())) {
        break;
      }
      paramView = this.jdField_a_of_type_Akwu;
    } while (bhsr.a(akwu.a(((akwt)localObject2).e)));
    this.jdField_a_of_type_Agvx.a(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips), ((akwt)localObject2).e, this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.subChannel);
    return;
