  ...
  extends abib
{
  ...
  private ArrayList<abkr> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, abks> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  private ConcurrentHashMap<Long, Long> b = new ConcurrentHashMap(10);
  
  public abkq(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new abks(this, paramString, paramInt, paramLong2);
  ...
  private void a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    {
      Object localObject = (abkr)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((abkr)localObject).a();
      localObject = ((abkr)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((arui)localObject).a(localView, paramMessageForDeviceSingleStruct);
      }
      for (;;)
      {
        i += 1;
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, View paramView, arui paramarui)
  {
    long l1;
    ...
    if (paramView != null)
    {
      ...
      {
        abkr localabkr = (abkr)localIterator.next();
        if (localabkr.a() == paramView) {
          localabkr.b = new WeakReference(paramarui);
        }
      }
    }
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(new abkr(this, paramView, paramarui));
      }
  ...
  {
    paramLong = (abks)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  {
    int i = 3;
    MessageForDeviceSingleStruct localMessageForDeviceSingleStruct = (MessageForDeviceSingleStruct)bcsa.a(-4502);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = ((abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(paramDataPoint.mDin);
        if (localObject == null) {
          break label638;
        }
        j = ((DeviceInfo)localObject).productId;
        absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "Usr_AIO_ReceiveMsg", i, 0, j);
        if ((localObject != null) && (((DeviceInfo)localObject).isAdmin == 1) && (!TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect))) {
          absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "FR_StrangerComming", 0, 0, 0);
        }
