  ...
  implements QQTextEjectaFilter.EjectaTextureCallBack
{
  ...
  public int[] onDrawFrame()
  {
    ...
    arrayOfInt1[0] = bmdi.a(this.a).getCanvasTexture("offscreen_richard");
    if (((bmdi.a(this.a) != null) || (bmdi.a(this.a).f)) && (!bmdi.a(this.a)))
    {
      if (bmdi.a(this.a) == 0) {
        bmdi.a(this.a, GlUtil.createTexture(3553, bmdi.a(this.a)));
      }
      arrayOfInt1[1] = bmdi.a(this.a);
      arrayOfInt2[1] = 1;
    }
    bmdi.a(this.a).setIsNeedReverseTexture(arrayOfInt2);
    return arrayOfInt1;
  }
}
