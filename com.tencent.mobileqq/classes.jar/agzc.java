...
public class agzc
{
  private static agzc jdField_a_of_type_Agzc;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = alof.cS + "icons/";
  private static final String jdField_c_of_type_JavaLangString = alof.cS + "zip/";
  private static final String jdField_d_of_type_JavaLangString = alud.a(2131715380);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new beae(paramString1, new File(jdField_c_of_type_JavaLangString + "android_tim_theme_icons.zip"));
  ...
  public static agzc a()
  {
    if (jdField_a_of_type_Agzc == null) {
      jdField_a_of_type_Agzc = new agzc();
    }
    return jdField_a_of_type_Agzc;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	agzc:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	agzc:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 143	bdhb:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	agzc:jdField_b_of_type_JavaLangString	Ljava/lang/String;
        ...
        if (localBitmap != null)
        {
          ...
          if (localObject2 == null)
          {
            ...
            if (localBitmap != null)
            {
              ...
              {
                localObject2 = bdhj.a(jdField_b_of_type_JavaLangString + "tim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bdhj.a(jdField_b_of_type_JavaLangString + "aio_tim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
