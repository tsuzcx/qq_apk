  ...
  extends aelz
{
  ...
  public agzc(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Agzf = new agzf(this, null);
  ...
  public void a(agze paramagze)
  {
    this.jdField_a_of_type_Agze = paramagze;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    aemj localaemj = this.jdField_a_of_type_Aflj.a(localChatMessage, this);
    if ((localaemj instanceof BaseBubbleBuilder)) {
      ((BaseBubbleBuilder)localaemj).c = true;
    }
    paramView = localaemj.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Agzf);
    if (paramView != null) {
      paramView.setTag(2131364184, localChatMessage);
    }
    ...
    for (;;)
    {
      ...
      {
        if ((localaemj instanceof afqf)) {
          ((afqf)localaemj).a(false);
        }
      }
      else if ((localChatMessage.msgtype == -2039) && ((localaemj instanceof ApolloItemBuilder)))
      {
        ((ApolloItemBuilder)localaemj).a(false);
        paramViewGroup = (afdm)aekt.a(paramView);
      ...
      {
        ((LightVideoItemBuilder)localaemj).a((ListView)paramViewGroup);
      }
    }
  }
}
