  ...
  extends ajtd
{
  ...
  public atbc(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()))
      {
        ...
        if ((i == 0) && (paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
        {
          ...
          if (4 <= n)
          {
            paramFromServiceMsg = String.valueOf(bbmj.a(paramToServiceMsg, 0));
          ...
          if (j < i)
          {
            ...
            if (k + 4 <= n)
            {
              m = bbmj.a(paramToServiceMsg, k);
              i1 = k + 2;
              k = bbmj.a(paramToServiceMsg, i1);
              i1 += 2;
              if ((m & 0xFFFF) == 40493) {
                if (k == 0)
                {
    ...
    for (;;)
    {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
        ...
        return;
        i = (byte)bbmj.a(paramToServiceMsg, i1);
        bool1 = true;
        break label291;
        m = i1 + k;
        j += 1;
  ...
  {
    akbi.d(this, 7, paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (m == 0)
    {
      ...
      if (localRspBody.rpt_msg_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          atbp.a("handleGetNearbyUneadMsg", new Object[] { "dating", Long.valueOf(localRspBody.uint64_max_event_id.get()), Integer.valueOf(j), Long.valueOf(paramToServiceMsg.extraData.getLong("dating_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("dating_readEventId")) });
          i = j;
        }
      }
      j = i;
      if (localRspBody.rpt_msg_nearby_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          atbp.a("handleGetNearbyUneadMsg", new Object[] { "rank", Integer.valueOf(k), Long.valueOf(paramToServiceMsg.extraData.getLong("rank_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("rank_readEventId")) });
          j = k;
        }
      }
      i = j;
      if (localRspBody.rpt_msg_feed_event_list.has())
      {
        ...
        if (QLog.isColorLevel())
        {
          atbp.a("handleGetNearbyUneadMsg", new Object[] { "feed", Long.valueOf(localRspBody.uint64_max_fresh_event_id.get()), Integer.valueOf(k), Long.valueOf(paramToServiceMsg.extraData.getLong("feed_lastEventId")), Long.valueOf(paramToServiceMsg.extraData.getLong("feed_readEventId")) });
          i = k;
        }
      }
    }
    if (QLog.isColorLevel()) {
      atbp.a("handleGetNearbyUneadMsg", new Object[] { Integer.valueOf(m), Integer.valueOf(i) });
    }
    if (i != 0) {
      this.app.a().a(i);
    }
    atas.b(this.app.getCurrentAccountUin(), i);
  }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      paramFromServiceMsg = (asyy)this.app.getManager(161);
      ...
      try
      {
        ...
        if (paramObject != null)
        {
          ...
          if (paramObject.uint32_result.get() == 0)
          {
            ...
            bool4 = bool1;
            bool3 = bool1;
            l = bbbd.a(ByteBuffer.wrap(paramObject.bytes_bodybuffer.get().toByteArray()).getInt());
            bool4 = bool1;
            bool3 = bool1;
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramToServiceMsg = (asyy)this.app.getManager(161);
        if (i == 0)
        {
          bool2 = true;
          label321:
  ...
  public void a()
  {
    long l1 = ((Long)atbg.a(this.app.getAccount(), "nearby_event_file", 4, "dating_last_event_id", Long.valueOf(0L))).longValue();
    long l2 = ((Long)atbg.a(this.app.getAccount(), "nearby_event_file", 4, "dating_read_event_id", Long.valueOf(0L))).longValue();
    long l3 = ((Long)atbg.a(this.app.getAccount(), "nearby_event_file", 4, "rank_last_event_seq", Long.valueOf(0L))).longValue();
    long l4 = ((Long)atbg.a(this.app.getAccount(), "nearby_event_file", 4, "rank_read_event_seq", Long.valueOf(0L))).longValue();
    long l5 = ((Long)atbg.a(this.app.getAccount(), "nearby_event_file", 4, "freshfeed_last_event_seq", Long.valueOf(0L))).longValue();
    long l6 = ((Long)atbg.a(this.app.getAccount(), "nearby_event_file", 4, "freshfeed_red_event_seq", Long.valueOf(0L))).longValue();
    ...
    if (QLog.isColorLevel()) {
      atbp.a("getNearbyUnreadMsg", new Object[] { Long.valueOf(l1), Long.valueOf(l2), Long.valueOf(l3), Long.valueOf(l4), Long.valueOf(l5), Long.valueOf(l6) });
    }
  }
  
  public void a(byte paramByte)
  {
    akbi.a(this, paramByte);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean == true)
        {
          ...
          bbmj.a((byte[])localObject, 7, 42049);
          bbmj.a((byte[])localObject, 9, (short)2);
          bbmj.a((byte[])localObject, 11, s);
  ...
  public void b()
  {
    try
    {
      ...
      sendPbReq((ToServiceMsg)localObject);
      anmg.a("getNotifyOnLikeSwitch...", new Object[0]);
      return;
    }
    catch (Exception localException)
    {
