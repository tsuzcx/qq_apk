  ...
  extends alar
{
  ...
  public alat(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_Adbc = new adbc(this.jdField_a_of_type_JavaLangString, 30000L);
  }
  ...
  private void a(long paramLong, String paramString, int paramInt)
  {
    ...
    QQAppInterface localQQAppInterface = alan.a();
    Object localObject;
    String str2;
    String str1;
    if ((localQQAppInterface != null) && (1 == paramInt))
    {
      localObject = ((ajjj)localQQAppInterface.getManager(51)).b(paramString);
      if (localObject != null)
      {
        str2 = ((Card)localObject).strNick;
        if (((Card)localObject).shGender == 0) {
          str1 = BaseActivity.sTopActivity.getString(2131628431);
        }
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        str1 = BaseActivity.sTopActivity.getString(2131626792);
        break;
  ...
  private void a(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_MqqObserverWtloginObserver == null) {
        this.jdField_a_of_type_MqqObserverWtloginObserver = new alax(this, paramLong1);
      }
  ...
  public boolean HasMenthod(String paramString)
  {
    ...
    } while ((paramString.equals("Notify")) || (paramString.equals("GetAppID")) || (paramString.equals("GetAudioOutputMode")) || (paramString.equals("IsMute")) || (paramString.equals("GetNickNameByView")));
    return false;
  }
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    {
      paramString = "";
      paramArrayOfVariantWrapper = alan.a();
    ...
    if (paramString.equals("NavigateTo"))
    {
      ...
      if ((paramString != null) && (paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1)) {
        alan.a(paramString, paramArrayOfVariantWrapper[0].GetString(), true, 0L, null, null, 3, this.jdField_a_of_type_JavaLangString, null);
      }
      return true;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfVariantWrapper != null)
        {
          ...
          if ((!(localObject4 instanceof aegy)) || (!"biz_src_ads".equals(localObject2))) {
            break label8097;
          }
          localObject3 = rtr.b(((BaseChatPie)localObject4).a.jdField_a_of_type_JavaLangString);
          ...
          localObject4 = (adaj)adaj.a((ark.Container)localObject4).get();
          if ((localObject4 == null) || (!(localObject4 instanceof adai))) {
            break label8091;
          }
          localObject4 = (MessageForArkApp)((adai)localObject4).jdField_a_of_type_JavaLangRefWeakReference.get();
          if (!albn.a(paramString, (String)localObject1, paramArrayOfVariantWrapper, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString)) {
            continue;
          }
          alep.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
          ...
          else
          {
            ...
            if (localObject4 != null)
            {
              l1 = nbj.a(((MessageForArkApp)localObject4).ark_app_message.getAppIdFromMeta(), 0L);
              if (l1 != 0L) {
                continue;
              }
              paramArrayOfVariantWrapper = "";
              awqx.b(null, "dc00898", "", "", "0X800A86C", "0X800A86C", 0, 0, paramArrayOfVariantWrapper, "", "", "");
              paramArrayOfVariantWrapper = paramString;
            }
          }
          Log.d("ark.OpenUrl ", paramArrayOfVariantWrapper);
          alep.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
          return true;
        ...
        {
          if (!alan.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.BROWSER"))
          {
          ...
          if (paramArrayOfVariantWrapper != null)
          {
            ...
            if (k == 0)
            {
              ...
              QLog.e("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", this.jdField_a_of_type_JavaLangString, ",url=", mpw.b(paramString, new String[0]), ", isValid set=true" });
              i = 1;
              j = 2;
              alht.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, adaj.jdField_c_of_type_JavaLangString);
            }
          }
          else
          {
            ...
            QLog.d("ArkApp", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", mpw.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
            return false;
          }
          i = 0;
          continue;
          ...
          catch (JSONException paramArrayOfVariantWrapper)
          {
            ...
            paramArrayOfVariantWrapper = String.valueOf(l1);
            continue;
            alan.a(localBaseActivity, paramString, true, 0L, null, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject3);
            continue;
          }
          ...
          if (paramArrayOfVariantWrapper.getChatFragment() != null)
          {
            ...
            if ((paramArrayOfVariantWrapper instanceof aegy)) {
              ((aegy)paramArrayOfVariantWrapper).a.b();
            }
          }
          else
          {
            ...
            l1 = nbj.a(((MessageForArkApp)localObject4).ark_app_message.getAppIdFromMeta(), 0L);
            alan.a(localBaseActivity, paramString, true, l1, (MessageForArkApp)localObject4, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject3);
            ...
            if (((MessageForArkApp)localObject4).buildTypeAndTitle().isSdkShare)
            {
              ...
              paramArrayOfVariantWrapper = "";
              awqx.b(null, "dc00898", "", "", "0X800A869", "0X800A869", 0, 0, paramArrayOfVariantWrapper, "", "", "");
            }
            paramArrayOfVariantWrapper = paramString;
            continue;
            paramVariantWrapper = paramString + "&" + paramArrayOfVariantWrapper;
        ...
        paramVariantWrapper = bade.a(alan.a(), localBaseActivity, paramString);
        paramArrayOfVariantWrapper = paramString;
        ...
        if (paramArrayOfVariantWrapper != null)
        {
          ...
          if (k == 0)
          {
            ...
            QLog.e("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", this.jdField_a_of_type_JavaLangString, ",url=", mpw.b(paramString, new String[0]), ", isValid set=true" });
            i = 1;
            j = 2;
            alht.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, adaj.jdField_c_of_type_JavaLangString);
          }
        ...
        bool1 = false;
        continue;
        QLog.e("ArkApp", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", mpw.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
        paramArrayOfVariantWrapper = paramString;
        continue;
        if (paramString.equals("OpenVideo"))
        {
          ...
          try
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ((((String)localObject1).equalsIgnoreCase("http")) || (((String)localObject1).equalsIgnoreCase("https"))))
            {
              ...
              paramVariantWrapper.SetBool(true);
              alan.a(paramString, paramArrayOfVariantWrapper);
              alep.a((QQAppInterface)localObject1, this.jdField_a_of_type_JavaLangString, "AIOArkOpenVideo", 1, 0, 0L, 0L, 0L, paramArrayOfVariantWrapper, "");
            }
            return true;
          }
        ...
        if (paramString.equals("Report"))
        {
          ...
          try
          {
            ...
            awqx.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), paramVariantWrapper, paramArrayOfVariantWrapper, "");
            alep.a(paramString, this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper, i);
            return true;
          }
          catch (Exception paramVariantWrapper)
          {
            awqx.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
            continue;
          }
          awqx.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
          continue;
        ...
        if (paramString.equals("ReportEx"))
        {
          ...
          if (paramVariantWrapper.equals("898")) {
            try
            {
              ...
              awqx.b(null, "dc00898", "", (String)localObject1, paramArrayOfVariantWrapper, paramVariantWrapper, i, j, k, Integer.toString(m), Integer.toString(n), (String)localObject2, (String)localObject3);
              return true;
            }
            catch (JSONException paramArrayOfVariantWrapper)
            {
        ...
        {
          paramArrayOfVariantWrapper = babp.c();
        ...
        if (paramString.equals("Log"))
        {
          ...
          j = alan.a(paramArrayOfVariantWrapper, l1);
          if (i == 0)
          {
        ...
        if (paramString.equals("GetNickName"))
        {
          ...
          if (paramArrayOfVariantWrapper != null)
          {
            ...
            if (l1 == 1L)
            {
              ...
              {
                localObject1 = null;
                if (!TextUtils.isEmpty(adaj.jdField_a_of_type_JavaLangString)) {
                  localObject1 = babh.h((QQAppInterface)localObject2, adaj.jdField_a_of_type_JavaLangString, paramString);
                }
                if (localObject1 != null)
                {
                ...
                localObject1 = babh.q((QQAppInterface)localObject2, paramString);
                paramArrayOfVariantWrapper = (ark.VariantWrapper[])localObject1;
                if (!TextUtils.isEmpty((CharSequence)localObject1)) {
                  continue;
                }
                paramString = babh.a((QQAppInterface)localObject2, paramString, 0);
                paramVariantWrapper.SetString(paramString);
                if (paramString != null) {
        ...
        else if (paramString.equals("GetContainerInfo"))
        {
          ...
          if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsView()))
          {
            ...
            paramString = (adaj)adaj.a(paramString).get();
            if ((paramString == null) || (!(paramString instanceof adai))) {
              continue;
            }
            paramArrayOfVariantWrapper = ((adai)paramString).a();
            paramString = paramArrayOfVariantWrapper;
            if (paramArrayOfVariantWrapper == null) {
              paramString = alan.a();
            }
            if (QLog.isColorLevel()) {
              QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg GetContainerInfo Extra ViewID viewHandle=", Long.valueOf(l1), alan.a(paramString) });
            }
            if (paramString != null)
            {
          ...
          default: 
            ...
            paramString = alan.a();
            if (QLog.isColorLevel()) {
              QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg GetContainerInfo old activity=", BaseActivity.sTopActivity, alan.a(paramString) });
            }
            break;
          case 1008: 
        ...
        else
        {
          if (paramString.equals("DataRequest"))
          {
            ...
            paramVariantWrapper.CreateObject("DataRequest", new adbv(paramString, this.jdField_a_of_type_JavaLangString));
            return true;
          }
          if (paramString.equals("GetPerformance"))
          {
            ...
            paramArrayOfVariantWrapper = adai.a(paramString);
          ...
          {
            if ((this.jdField_a_of_type_Adbc == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1) || (paramArrayOfVariantWrapper[0] == null) || (!paramArrayOfVariantWrapper[0].IsFunction())) {
              return false;
            }
            if (QLog.isColorLevel()) {
            ...
            this.jdField_a_of_type_Adbc.b(new alau(this, l1));
            return true;
          }
          if (paramString.equals("WatchPosition"))
          {
            ...
            l1 = a(paramArrayOfVariantWrapper[0].Copy());
            this.jdField_a_of_type_Adbc.a(new alaw(this, l1));
            return true;
          }
          ...
          if (paramString.equals("GetCurrentAddress"))
          {
            ...
            l1 = a(paramArrayOfVariantWrapper[0].Copy());
            this.jdField_a_of_type_Adbc.a(new alay(this, l1), true);
            return true;
          }
          if (paramString.equals("SendMessage"))
          {
            ...
            try
            {
              ...
              if ((paramArrayOfVariantWrapper.length >= 3) && (paramArrayOfVariantWrapper[2].IsView()))
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg SendMessage Extra viewid viewHandle=", Long.valueOf(l1), alan.a(paramString) });
                break label8120;
              ...
              else
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg SendMessage old,sessionInfo=", alan.a(paramString) });
                break label8123;
              }
              ...
              if (TextUtils.isEmpty(((ArkAppMessage)localObject2).promptText)) {
                ((ArkAppMessage)localObject2).promptText = String.format(ajjy.a(2131634849), new Object[] { ((ArkAppMessage)localObject2).appDesc });
              }
              ...
              if (bool1)
              {
                if (paramString != null)
                {
                  aael.b(alan.a(), paramString, (ArkAppMessage)localObject2);
                  if (QLog.isColorLevel()) {
            ...
            if (bool1)
            {
              ...
              paramString = awbi.a(alan.a(), alan.a().c(), paramString.jdField_a_of_type_JavaLangString, paramString.b, paramString.jdField_a_of_type_Int, (byte)1, (byte)0, (short)0, paramVariantWrapper);
          ...
          else
          {
            if (paramString.equals("GetPskeyAsync"))
            {
              ...
              if (paramVariantWrapper != null)
              {
                ...
                if (TextUtils.isEmpty((CharSequence)localObject1))
                {
                  ...
                  paramVariantWrapper = new alaz(this, paramArrayOfVariantWrapper, paramVariantWrapper, paramString, l1);
            ...
            {
              if (!alan.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.LOGIN"))
              {
            ...
            {
              if (!alan.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.USER_INFORMATION"))
              {
            ...
            {
              if (!alan.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.OPENVIEW")) {
                return false;
              }
            ...
            {
              if (!alan.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.SHARE")) {
                return false;
              }
              if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()) && ((paramArrayOfVariantWrapper[1].IsArray()) || (paramArrayOfVariantWrapper[1].IsTable())))
              {
                ...
                paramArrayOfVariantWrapper = alan.a(paramArrayOfVariantWrapper);
            ...
            {
              if (!alan.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.STATUSBAR")) {
                return false;
              }
            ...
            {
              if (kvx.a(BaseApplicationImpl.getContext()))
              {
                i = 1;
              ...
              if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length == 1))
              {
                ...
                if ((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime() != null)
                {
                  ...
                  if (paramString != null)
                  {
                    ...
                    localObject1 = amay.b(380).a();
                    paramArrayOfVariantWrapper = "";
                    paramString = paramArrayOfVariantWrapper;
                    if (localObject1 != null)
                    {
                      paramString = paramArrayOfVariantWrapper;
                      if (((amax)localObject1).a() != null) {
                        paramString = ((amax)localObject1).a().b;
                      }
                    }
                    paramArrayOfVariantWrapper = paramString;
                    if (TextUtils.isEmpty(paramString))
                    {
                      ...
                      if (BaseActivity.sTopActivity != null) {
                        paramArrayOfVariantWrapper = BaseActivity.sTopActivity.getString(2131624688);
                      }
                    }
            ...
            else if (paramString.equals("GetNickNameByView"))
            {
              ...
              if (l2 != 0L)
              {
                ...
                paramString = (adaj)adaj.a(paramString).get();
                if (!(paramString instanceof adai)) {
                  continue;
                }
                paramArrayOfVariantWrapper = ((adai)paramString).a();
                paramString = paramArrayOfVariantWrapper;
                ...
                if (QLog.isColorLevel())
                {
                  QLog.d("ArkApp", 2, new Object[] { "ark.GetNickNameByView Extra ViewID viewHandle=", Long.valueOf(l2), alan.a(paramString) });
                  paramArrayOfVariantWrapper = paramString;
                }
                if (!TextUtils.isEmpty((CharSequence)localObject1))
                {
                  ...
                  paramArrayOfVariantWrapper = babh.a((QQAppInterface)localObject2, paramArrayOfVariantWrapper, ((String)localObject1).equals(((QQAppInterface)localObject2).c()), (String)localObject1);
                  if (paramArrayOfVariantWrapper != null)
                  {
                    paramString = paramArrayOfVariantWrapper;
                  ...
                  {
                    paramArrayOfVariantWrapper = babh.q((QQAppInterface)localObject2, (String)localObject1);
                    paramString = paramArrayOfVariantWrapper;
                    if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
                      paramString = babh.a((QQAppInterface)localObject2, (String)localObject1, 0);
                    }
                  }
                  paramVariantWrapper.SetString(paramString);
                  if ((paramString != null) && (QLog.isColorLevel())) {
              ...
              else
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "ark.GetNickNameByView old activity=", BaseActivity.sTopActivity, alan.a(paramString) });
                paramArrayOfVariantWrapper = paramString;
                continue;
              }
              return false;
            ...
            else
            {
              if (paramString.equals("GetAppInfo"))
              {
                ...
                try
                {
                  ...
                  ((JSONObject)localObject1).put("name", BaseApplicationImpl.getApplication().getString(2131624591));
                  paramArrayOfVariantWrapper = babp.c();
                  paramString = paramArrayOfVariantWrapper;
                  if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
                    paramString = "8.2.6";
