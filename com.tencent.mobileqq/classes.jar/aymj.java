...
public class aymj
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aymk(this);
  private Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new ayml(this);
  ...
  public aymj(Activity paramActivity, QQAppInterface paramQQAppInterface, int paramInt, aymm paramaymm)
  {
  ...
  private void a(String paramString1, String paramString2, Bitmap paramBitmap)
  {
    ...
    WXShareHelper.getInstance().shareWebPageToWXFriend(String.valueOf(l), paramString2, paramBitmap, "来自QQ的推荐好友", paramString1);
  }
  ...
  private List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    localActionSheetItem.label = this.jdField_a_of_type_AndroidAppActivity.getString(2131695878);
    ...
    localActionSheetItem.label = this.jdField_a_of_type_AndroidAppActivity.getString(2131695898);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      String str3 = amtj.a(2131707548);
      String str4 = amtj.a(2131707594) + this.jdField_a_of_type_JavaLangString;
      String str5 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717617);
      localObject1 = ((bcgt)localObject1).c(14).a(amtj.a(2131707577) + this.b).a(2).a(1).a("plugin", "", str2, str1, str1).d(str5).a();
      Object localObject2 = new bcla();
      ((bcgx)localObject2).b(1);
      ((bcgx)localObject2).a(str3);
      bcjp localbcjp = new bcjp();
      localbcjp.b(1);
      localbcjp.a(new bciz(str1));
      localbcjp.a(new StructMsgItemTitle(this.b));
      localbcjp.a(new bclv(str4));
      ((AbsShareMsg)localObject1).addItem((bcgw)localObject2);
      ((AbsShareMsg)localObject1).addItem(localbcjp);
      ...
      while (QLog.isColorLevel())
      {
        ...
        ((Intent)localObject1).putExtras((Bundle)localObject2);
        atky.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject1, 21);
      }
    }
  }
  ...
  protected void b()
  {
    if ((this.jdField_a_of_type_AndroidAppActivity != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()))
    {
      ...
      this.jdField_a_of_type_Bhht.a(amtj.a(2131707578));
