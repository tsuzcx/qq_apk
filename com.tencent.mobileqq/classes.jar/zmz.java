  ...
  implements Runnable
{
  ...
  public zmz(CleanCache paramCleanCache) {}
  ...
  private int a(File paramFile)
  {
    ...
    //   92: dup
    //   93: aload_0
    //   94: invokespecial 72	znc:<init>	(Lzmz;)V
    ...
    //   398: ifle +86 -> 484
    //   401: aload_0
    //   402: getfield 13	zmz:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
    ...
    //   466: aload_0
    //   467: getfield 13	zmz:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
  ...
  private void a()
  {
    ...
    Object localObject1 = new File(AppConstants.aJ + "shortvideo");
    int m;
    int k;
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (n > 2000)
        {
          Arrays.sort((Object[])localObject1, new znd(this));
  ...
  private File[] a(File[] paramArrayOfFile)
  {
    ...
    //   10: istore 5
    //   12: aload_0
    //   13: getfield 13	zmz:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
    ...
    //   129: istore_2
    //   130: aload_0
    //   131: getfield 13	zmz:jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache	Lcom/tencent/mobileqq/app/automator/step/CleanCache;
  ...
  public void run()
  {
    ...
    try
    {
      ...
      arrayOfString[0] = AppConstants.bm;
      ...
      Arrays.sort((Object[])localObject2, new zna(this));
    ...
    localObject1[0] = AppConstants.bo;
    ...
    if (i < n)
    {
      ...
      Arrays.sort((Object[])localObject2, new znb(this));
      i1 = localObject2.length;
      j = 0;
      k = 0;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject1[1] = new File(AppConstants.aJ + "photo");
        localObject1[2] = new File(AppConstants.aJ + this.jdField_a_of_type_ComTencentMobileqqAppAutomatorStepCleanCache.a() + "/ptt/");
        localObject1[3] = new File(AppConstants.aJ + "shortvideo/thumbs");
        localObject1[4] = new File(AppConstants.aJ + "ptv_template");
        localObject1[5] = new File(AppConstants.aJ + "head/" + File.separator + "_dynamic");
        localObject1[6] = new File(AppConstants.aJ + "AR_MAP");
