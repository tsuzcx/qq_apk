  ...
  implements apav, apaz, apbf
{
  ...
  public void a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Apat != null)) {
      this.jdField_a_of_type_Apat.c();
    }
  ...
  public void a(long paramLong, apbj paramapbj)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Apas != null)) {
        this.jdField_a_of_type_Apas.a(paramLong, paramapbj);
      }
      return;
    }
  }
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    } while (this.jdField_a_of_type_Apat == null);
    this.jdField_a_of_type_Apat.a(paramLong, paramArrayOfByte);
  }
  
  public void a(apax paramapax)
  {
    a(4L, paramapax);
  }
  
  public void a(apba paramapba)
  {
    a(4096L, paramapba);
  }
  
  public void a(apbh paramapbh)
  {
    a(1L, paramapbh);
  }
  ...
  public boolean a()
  {
    ...
    if ((this.jdField_a_of_type_Apat != null) && (!this.jdField_a_of_type_Apat.b()))
    {
      this.jdField_b_of_type_Boolean = false;
  ...
  public boolean a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Apat != null)) {
      return this.jdField_a_of_type_Apat.c();
    }
    if (((0x1000 & paramLong) != 0L) && (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {
  ...
  public boolean a(Context arg1, long paramLong, int paramInt1, int paramInt2, ArConfigInfo paramArConfigInfo, ArrayList<ArCloudConfigInfo> paramArrayList, ARScanStarFaceConfigInfo paramARScanStarFaceConfigInfo, apas paramapas)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalMarkerRecog != null) || (this.jdField_a_of_type_Apat != null) || (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {}
      for (this.jdField_a_of_type_Boolean = true;; this.jdField_a_of_type_Boolean = false)
      {
        ...
        apcf.a().a(System.currentTimeMillis() - l, this.jdField_a_of_type_Boolean);
  ...
  public boolean a(apaf paramapaf)
  {
    if (!this.jdField_b_of_type_Boolean) {}
    while (this.jdField_a_of_type_Apat == null) {
      return false;
    }
    return this.jdField_a_of_type_Apat.a(paramapaf);
  }
  ...
  {
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Apat != null)) {
      return this.jdField_a_of_type_Apat.d();
    }
    return true;
  }
