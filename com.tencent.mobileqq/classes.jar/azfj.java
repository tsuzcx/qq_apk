...
public class azfj
  extends azfk
{
  private ArrayList<azbu> jdField_a_of_type_JavaUtilArrayList;
  private boolean jdField_a_of_type_Boolean = true;
  private OnlineStatusPermissionChecker.OnlineStatusPermissionItem b;
  
  public azfj(@NonNull BaseActivity paramBaseActivity, azbe paramazbe)
  {
    super(paramBaseActivity, paramazbe);
  }
  
  private void a(ArrayList<azbu> paramArrayList)
  {
  ...
  private boolean d()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList.size() != this.jdField_a_of_type_Azcj.a().size()) {
      return true;
    }
    Iterator localIterator1 = this.jdField_a_of_type_Azcj.a().iterator();
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        azbu localazbu1 = (azbu)localIterator1.next();
        ...
        do
        {
          ...
          localazbu2 = (azbu)localIterator2.next();
        } while (localazbu1.a != localazbu2.a);
      }
      for (int i = 1; i == 0; i = 0)
      {
        return true;
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131694399);
    if (paramBoolean2)
    {
  ...
  protected boolean a(boolean paramBoolean)
  {
    ...
    if ((this.b == null) && (localazcb.a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusPermissionChecker$OnlineStatusPermissionItem, this))) {
      return true;
    }
    if ((this.b != null) && (c())) {
      return true;
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_Azcj.a(this.jdField_a_of_type_JavaUtilArrayList);
  }
  ...
  public ArrayList<Integer> c()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList.add(Integer.valueOf((int)((azbu)((Iterator)localObject).next()).a));
    }
    return localArrayList;
  }
  ...
  public void c()
  {
    ...
    a(this.jdField_a_of_type_Azcj.a());
  }
