...
public class airf
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new airg(this, Looper.getMainLooper());
  ...
  public boolean a()
  {
    ...
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localairj);
      this.jdField_a_of_type_Int = localairj.a();
      this.jdField_a_of_type_JavaUtilArrayList = localairj.a();
      return true;
    }
