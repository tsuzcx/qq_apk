...
public class abaq
{
  ...
  {
    return ImageLoader.getInstance().loadImage(paramString, new abar(this, paramView));
  }
  ...
  private AnimationSet a()
  {
    ...
    localScaleAnimation.setAnimationListener(new abas(this));
  ...
  private AnimationSet b()
  {
    ...
    localScaleAnimation.setAnimationListener(new abat(this));
    localAnimationSet.addAnimation(localScaleAnimation);
    return localAnimationSet;
  }
  ...
  private AnimationSet c()
  {
    if (this.b != null)
    {
      ...
      localScaleAnimation.setAnimationListener(new abau(this));
      localAnimationSet.addAnimation(localScaleAnimation);
  ...
  public void a(FrameLayout paramFrameLayout, View paramView, String paramString)
  {
    ...
    paramFrameLayout = abay.a().a(paramString);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131364145));
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131381373));
