  ...
  implements Runnable
{
  ...
  public akrn(PathTraceManager paramPathTraceManager, long paramLong, String paramString)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        ((NewIntent)localObject2).setObserver(new akro(this, localJSONObject, localList, localThrowable, localSharedPreferences, localOrbitReq));
