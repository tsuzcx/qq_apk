  ...
  extends PopupWindow
{
  ...
  public rez(Activity paramActivity)
  {
    super(paramActivity);
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)localObject).inflate(2131494244, null);
  ...
  protected final void a(View paramView)
  {
    ...
    int j = (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131167498);
    ...
    if (i - (m + n) > this.c)
    {
      ...
      for (;;)
      {
        i = arrayOfInt[1] + paramView.getHeight() + bajq.a(4.0F);
    ...
    for (;;)
    {
      i = arrayOfInt[1] - this.c - bajq.a(4.0F);
