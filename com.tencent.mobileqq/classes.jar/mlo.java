  ...
  implements View.OnClickListener
{
  ...
  void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695503);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().U == 0)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695502);
      return;
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695501);
  }
  ...
  public void b()
  {
    ...
    {
      lba.h("VoiceChangeChooseDialog", "updateDialogStyle mVideoController is null!!");
      return;
    }
    boolean bool;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        mak.a((VideoAppInterface)BaseApplicationImpl.getApplication().getRuntime(), 1017);
        mlr.a("0X8007EF4", "");
        break;
        bool = false;
        break label99;
