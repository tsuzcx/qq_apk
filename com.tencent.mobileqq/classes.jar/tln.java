...
public class tln
  extends Drawable
  implements Sizeable, URLDrawable.URLDrawableListener, qhl
{
  ...
  public tln(Bitmap paramBitmap, int paramInt1, Resources paramResources, String paramString, int paramInt2)
  {
  ...
  public tln(Bitmap paramBitmap, String paramString, int paramInt1, Resources paramResources, int paramInt2)
  {
    a(paramBitmap, paramInt1, paramResources, paramInt2);
    a(paramString);
  }
  ...
  private void a()
  {
    ...
    try
    {
      localBitmap3 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentResResources, 2130844915);
    ...
    {
      this.jdField_b_of_type_AndroidGraphicsBitmap = bhac.a(localBitmap2, localBitmap3, 0.0F, 1.0F);
  ...
  private void a(String paramString)
  {
    try
    {
      ...
      for (float f1 = 0.52F;; f1 = 0.48F)
      {
        ...
        this.jdField_a_of_type_ComTencentImageURLDrawable.setDecodeHandler(bgxc.a);
        ...
        {
          this.d = bheg.a(this.jdField_a_of_type_ComTencentImageURLDrawable.getCurrDrawable());
          a();
        }
        return;
      }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    this.d = bheg.a(paramURLDrawable.getCurrDrawable());
    a();
    invalidateSelf();
  }
