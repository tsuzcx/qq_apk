...
public class bgoe
{
  ...
  public String a;
  ArrayList<bgoe> jdField_a_of_type_JavaUtilArrayList;
  ...
  public bgoe(String paramString, File paramFile)
  {
    ...
    this.jdField_a_of_type_Bgof = new bgof();
  ...
  public bgoe(List<String> paramList, Map<String, File> paramMap, String paramString)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 3;
    this.jdField_a_of_type_Float = 0.0F;
  ...
  public void a(bgoe parambgoe)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DownloadTask", 2, "DownloadTask.addDuplicateListenerTask,task.key=" + parambgoe.jdField_a_of_type_JavaLangString);
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList.size() < 5) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambgoe);
      }
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            bgoe localbgoe = (bgoe)this.jdField_a_of_type_JavaUtilArrayList.get(i1);
            if ((localbgoe == null) || (localbgoe.a() == null)) {
              break label135;
            }
            localbgoe.a(a());
            localbgoe.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbgoe.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbgoe.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
            localbgoe.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
            localbgoe.a().onProgress(localbgoe);
          }
        }
      }
      return;
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            ...
            localbgoe.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbgoe.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbgoe.a().onCancel(localbgoe);
          }
        }
      }
      return;
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            ...
            localbgoe.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbgoe.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbgoe.a().onDoneFile(localbgoe);
          }
        }
      }
      return;
  ...
  {
    return ((paramObject instanceof bgoe)) && (((bgoe)paramObject).jdField_a_of_type_JavaUtilList.equals(this.jdField_a_of_type_JavaUtilList));
  }
