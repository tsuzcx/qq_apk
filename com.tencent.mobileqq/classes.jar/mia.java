...
public class mia
{
  ...
  mie jdField_a_of_type_Mie = null;
  ...
  public mia(Context paramContext, VideoController paramVideoController, int paramInt, QavPanel paramQavPanel, View paramView1, View paramView2, View paramView3, View paramView4, View paramView5, View paramView6)
  {
    ...
    paramInt = mvd.a(paramContext);
    if (paramInt <= 320) {
      paramInt = paramContext.getResources().getDimensionPixelSize(2131297680) + paramContext.getResources().getDimensionPixelSize(2131297676);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new mib(this);
      this.jdField_b_of_type_AndroidViewAnimationAnimation$AnimationListener = new mic(this);
      this.jdField_c_of_type_AndroidViewAnimationAnimation$AnimationListener = new mid(this);
      return;
      if (paramInt <= 480) {
        paramInt = paramContext.getResources().getDimensionPixelSize(2131297681) + paramContext.getResources().getDimensionPixelSize(2131297677);
      } else {
        paramInt = paramContext.getResources().getDimensionPixelSize(2131297683) + paramContext.getResources().getDimensionPixelSize(2131297679);
      }
    }
  }
  ...
  public void a(mie parammie)
  {
    this.jdField_a_of_type_Mie = parammie;
    if ((this.jdField_a_of_type_ComTencentAvVideoController == null) || (this.jdField_a_of_type_ComTencentAvVideoController.a() == null) || (this.jdField_a_of_type_ComTencentAvVideoController.a().as) || (this.jdField_a_of_type_ComTencentAvUiQavPanel == null) || (this.jdField_f_of_type_AndroidViewAnimationAnimation == null) || (this.jdField_a_of_type_AndroidViewAnimationAnimation == null)) {
      if (this.jdField_a_of_type_Mie != null)
      {
        this.jdField_a_of_type_Mie.a();
        this.jdField_a_of_type_Mie.b();
      }
    }
    do
    {
  ...
  public void a(mif parammif)
  {
    ...
    parammif.setAnimationListener(this.jdField_c_of_type_AndroidViewAnimationAnimation$AnimationListener);
    this.jdField_a_of_type_ComTencentAvUiQavPanel.startAnimation(parammif);
  ...
  public void b()
  {
    ...
    this.l = null;
    this.m = null;
    this.jdField_a_of_type_Mie = null;
