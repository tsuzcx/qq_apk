...
public class bdew
{
  ...
  public static void a(int paramInt)
  {
    if (!b)
    {
      ...
      azmz.a(BaseApplication.getContext()).a("", "actRPPttPlayerType", true, 0L, 0L, localHashMap, "");
      b = true;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (!TextUtils.equals(aftg.jdField_a_of_type_JavaLangString, str1))
      {
        aftg.jdField_a_of_type_JavaLangString = str1;
        aftg.g = false;
    ...
    aoli localaoli = (aoli)aogj.a().a(442);
    aoqi localaoqi = aoqj.c();
    ...
    if (localaoqi.a > 1)
    {
      bool1 = bool2;
      label159:
      QLog.e("vip_ptt.PttUtils", 1, "ignore initAutoToTextSwitch is svip=" + bool2 + " stage=" + localaoqi.a);
      if (((localaoli == null) || (localaoli.a())) && (!bool1)) {
        break label334;
      }
    ...
    for (;;)
    {
      aftg.jdField_a_of_type_Long = localSharedPreferences.getLong(str2, 9223372036854775807L);
      aftg.e = localSharedPreferences.getBoolean(str3, false);
      aftg.g = true;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("PttUtils", 2, "initAutoToTextSwitch switch:" + aftg.d + ", time:" + aftg.jdField_a_of_type_Long + ", hasAddTips:" + aftg.e);
      return;
      bool1 = false;
      break label159;
      label334:
      aftg.d = localSharedPreferences.getBoolean(str1, false);
      QLog.e("vip_ptt.PttUtils", 1, "initAutoToTextSwitch enable=" + aftg.d);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (;;)
    {
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8004603", "0X8004603", 0, 0, i + "", "", "", "");
      if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt1 == 0)
    {
      ...
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8006189", "0X8006189", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((paramInt2 == 1) || (paramInt2 == 2))
      {
        ...
        for (int i = 1;; i = 2)
        {
          azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8004600", "0X8004600", 0, 0, i + "", paramInt1 + "", paramInt3 + "", "");
          break;
        }
      }
      if (paramInt2 == 4) {
        azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005C1E", "0X8005C1E", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
      } else {
        azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8004601", "0X8004601", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
      }
    }
  }
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("param_version", Build.VERSION.SDK_INT + "");
      localHashMap.put("param_deviceName", Build.MANUFACTURER + "_" + Build.MODEL);
      azmz.a(BaseApplication.getContext()).a("", "actRPSonicSoLoadStatus", true, 0L, 0L, localHashMap, "");
  ...
  public static final boolean a(String paramString, int[] paramArrayOfInt)
  {
    ...
    //   36: dup
    //   37: aload_0
    //   38: invokestatic 334	bdcs:a	(Ljava/io/File;)[B
    ...
    //   49: aload 4
    //   51: aload_1
    //   52: invokestatic 339	bdew:a	(Ljava/io/ByteArrayInputStream;[I)Z
    //   55: istore_2
    //   56: iload_2
    //   57: istore_3
    //   58: iload_3
