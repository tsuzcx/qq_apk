  ...
  implements aobv
{
  ...
  public bbdy(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView, int paramInt)
  {
  ...
  private void a(bbeb parambbeb, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if (paramDrawable == null)
    {
      ...
      if (this.jdField_a_of_type_Alby != null) {
        paramDrawable = this.jdField_a_of_type_Alby.a(paramRecentBaseData);
      }
      ...
      int j = ((Integer)alby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.getRecentUserType(), paramRecentBaseData.getRecentUserUin()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      localRecentDynamicAvatarView = parambbeb.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      parambbeb.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData.getTitleName());
      return;
      break;
      label176:
      bool = false;
      break label143;
      label182:
      parambbeb.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  
  private void b(bbeb parambbeb, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    if ((parambbeb == null) || (paramRecentBaseData == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      a(parambbeb, paramRecentBaseData, localDrawable);
      return;
    }
  }
  ...
  {
    if ((paramViewHolder instanceof bbeb))
    {
      RecentBaseData localRecentBaseData = a(paramInt);
      a((bbeb)paramViewHolder, localRecentBaseData, null);
    }
  ...
  {
    if ((paramInt == 0) && (this.jdField_a_of_type_Boolean)) {
      return new bbea(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562818, paramViewGroup, false));
    }
    return new bbeb(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561477, paramViewGroup, false), this.jdField_a_of_type_Bbdz);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(paramBitmap instanceof bbeb))
        {
          break label437;
          this.jdField_a_of_type_Long = l;
          break;
        }
        paramBitmap = (bbeb)paramBitmap;
        RecentBaseData localRecentBaseData = a(paramBitmap.getAdapterPosition());
        if (localRecentBaseData == null) {
          break label437;
        }
        int i = localRecentBaseData.getRecentUserType();
        i = ((Integer)alby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, localRecentBaseData.getRecentUserUin()).first).intValue();
        if (i == -2147483648) {
          break label437;
        }
