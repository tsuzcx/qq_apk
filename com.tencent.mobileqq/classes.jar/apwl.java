...
public class apwl
{
  ...
  public static Map<String, List<apwm>> a;
  ...
  private apwz jdField_a_of_type_Apwz;
  ...
  public apwl(ArkAppCenter paramArkAppCenter)
  {
    this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter = paramArkAppCenter;
    Object localObject = aqyt.b(159).a();
    if ((localObject != null) && (((aqyr)localObject).a() != null))
    {
      localObject = ((aqyr)localObject).a();
      jdField_a_of_type_Boolean = ((aqzl)localObject).jdField_a_of_type_Boolean;
      f = ((aqzl)localObject).jdField_b_of_type_Boolean;
    }
    this.jdField_a_of_type_Apww = new apww(paramArkAppCenter.b());
    this.jdField_a_of_type_Apwz = new apwz(paramArkAppCenter.b());
    d();
    a();
    paramArkAppCenter = aqyt.b(186).a();
  ...
  private void d()
  {
    apww.a(this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter.b());
  }
  
  public void a()
  {
    this.jdField_a_of_type_Apwz.a();
  }
  
  public void a(aqzq paramaqzq)
  {
    if (paramaqzq == null)
    {
    ...
    e = paramaqzq.jdField_a_of_type_Boolean;
    d = this.jdField_a_of_type_Apwz.a(paramaqzq.jdField_b_of_type_JavaLangString);
    g = paramaqzq.jdField_b_of_type_Boolean;
    a(g);
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_JavaLangString = paramaqzq.jdField_a_of_type_JavaLangString;
      boolean bool;
      if (ArkAppCenter.jdField_b_of_type_Boolean)
      {
  ...
  public void b()
  {
    ...
    apww.b(this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter.a());
  }
  
  public void c()
  {
    this.jdField_a_of_type_Apww.b();
  }
}
