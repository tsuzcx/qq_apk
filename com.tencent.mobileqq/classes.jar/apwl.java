...
public class apwl
{
  ...
  private apwk jdField_a_of_type_Apwk = new apwk();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected Runnable a;
  private ArrayList<apwn> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private double jdField_b_of_type_Double;
  private long jdField_b_of_type_Long = 1800000L;
  
  private apwl(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new EnterpriseQQManager.1(this);
    this.jdField_a_of_type_Amle = new apwm(this, 4, true, true, 0L, false, false, "EnterpriseQQManager");
    if (paramQQAppInterface != null) {
      a(paramQQAppInterface);
    }
  }
  
  public static apwl a(QQAppInterface paramQQAppInterface)
  {
    if (jdField_a_of_type_Apwl == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Apwl == null) {
        jdField_a_of_type_Apwl = new apwl(paramQQAppInterface);
      }
  ...
  public List<StructMsg.ButtonInfo> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (this.jdField_a_of_type_Apwk != null) {
      return this.jdField_a_of_type_Apwk.a(paramString);
    }
    return null;
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2)
  {
    ...
    {
      paramContext = (alnc)paramQQAppInterface.a(21);
  ...
  {
    if (this.jdField_a_of_type_Apwk == null) {
      this.jdField_a_of_type_Apwk = new apwk();
    }
    if (paramQQAppInterface != null)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Apwk.a(localEnterpriseQQMenuEntity.uin, localGetCRMMenuResponse.button_info.get(), localEnterpriseQQMenuEntity.seqno, localEnterpriseQQMenuEntity.savedDateTime);
        continue;
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StructMsg.GetCRMMenuResponse paramGetCRMMenuResponse)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Apwk.a(paramString) != paramInt) && (paramGetCRMMenuResponse != null))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Apwk.a(paramString, localList, paramInt, l);
          return;
    ...
    this.jdField_a_of_type_Apwk.a(paramString, l);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    if ((paramQQAppInterface != null) && (!TextUtils.isEmpty(paramString)))
    {
      long l = 0L;
      if (this.jdField_a_of_type_Apwk != null) {
        l = this.jdField_a_of_type_Apwk.a(paramString);
      }
      if ((paramBoolean) || ((!paramBoolean) && (System.currentTimeMillis() - l > 43200000L)))
      {
        paramQQAppInterface = (alnc)paramQQAppInterface.a(21);
        if (paramQQAppInterface != null) {
