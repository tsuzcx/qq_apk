  ...
  implements URLDrawableDownListener
{
  ...
  public agbx(PhotoListActivity paramPhotoListActivity)
  {
  ...
  public void a(List<LocalMediaInfo> paramList)
  {
    ...
    if ((PhotoListActivity.d(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity)) && (!PhotoListActivity.a) && (baaf.a((LocalMediaInfo)paramList.get(0)) == 2)) {
      paramList.remove(0);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      if (paramView == null)
      {
        ...
        paramViewGroup = new agby(this);
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131305863));
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131305824));
        paramViewGroup.c = ((ImageView)paramView.findViewById(2131305867));
        paramViewGroup.d = ((ImageView)paramView.findViewById(2131305868));
        paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131305865);
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox = ((NumberCheckBox)paramView.findViewById(2131305866));
        ...
        paramViewGroup.jdField_a_of_type_Agbv = new agbv(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity);
        if (paramViewGroup.jdField_a_of_type_AndroidViewView != null) {
          paramViewGroup.jdField_a_of_type_AndroidViewView.setOnClickListener(paramViewGroup.jdField_a_of_type_Agbv);
        }
    ...
    for (;;)
    {
      paramViewGroup.jdField_a_of_type_Agbv.a(paramInt);
      paramViewGroup.jdField_a_of_type_Agbv.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
      ...
      else
      {
        ...
        {
          localObject3 = baaf.a((LocalMediaInfo)localObject1);
          if (QLog.isColorLevel()) {
            QLog.d("PhotoListActivity", 2, "PhotoListAdapter,getView(),image url :" + ((URL)localObject3).toString());
          }
          localObject3 = axwd.a((URL)localObject3, this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (agby)paramView.getTag();
        break;
      ...
      if (paramView == null)
      {
        localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495597, null);
        ...
        localObject2 = new agby(this);
        ((agby)localObject2).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject1).findViewById(2131305863));
        ((agby)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131305869));
        ((agby)localObject2).c = ((ImageView)((View)localObject1).findViewById(2131305867));
        ((agby)localObject2).d = ((ImageView)((View)localObject1).findViewById(2131305868));
        ((agby)localObject2).jdField_a_of_type_AndroidViewView = ((View)localObject1).findViewById(2131305865);
        ((agby)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox = ((NumberCheckBox)((View)localObject1).findViewById(2131305866));
        if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.i > 100) {
          ((agby)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setTextSize(10.0F);
        }
        ((agby)localObject2).jdField_a_of_type_Agbv = new agbv(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity);
        if (((agby)localObject2).jdField_a_of_type_AndroidViewView != null) {
          ((agby)localObject2).jdField_a_of_type_AndroidViewView.setOnClickListener(((agby)localObject2).jdField_a_of_type_Agbv);
        }
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.j)
        {
          ...
          {
            ((agby)localObject2).jdField_a_of_type_AndroidViewView.setVisibility(0);
            paramView = (View)localObject1;
            paramViewGroup = (ViewGroup)localObject2;
          }
        }
        ...
        localObject1 = baaf.a((LocalMediaInfo)localObject2, "VIDEO");
        label1116:
        i = axoh.a;
        ...
        {
          URLDrawable localURLDrawable = axwd.a((URL)localObject1, this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
          if (QLog.isColorLevel()) {
        ...
        localObject1 = agak.a(BaseApplicationImpl.getContext());
        if (localObject1 != null) {
          ((agak)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, (LocalMediaInfo)localObject2, paramInt);
        }
      ...
      for (;;)
      {
        ...
        break;
        label1394:
        localObject1 = baaf.a((LocalMediaInfo)localObject2, "APP_VIDEO");
        break label1116;
        label1407:
      ...
      if ((PhotoListActivity.d(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity)) || (PhotoListActivity.e(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity)))
      {
        ...
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131496455, null);
        paramView.setLayoutParams(new AbsListView.LayoutParams(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.b, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_c_of_type_Int));
