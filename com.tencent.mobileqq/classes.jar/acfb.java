...
public class acfb
  implements Runnable
{
  public acfb(MsgBoxListActivity paramMsgBoxListActivity) {}
  ...
  public void run()
  {
    if (MsgBoxListActivity.a(this.a) != null)
    {
      ...
      this.a.runOnUiThread(new acfc(this));
      ...
      if (NearbyRecommenderUtils.b(this.a.app))
      {
        ...
        this.a.runOnUiThread(new acfd(this, (List)localObject));
    ...
    this.a.runOnUiThread(new acfe(this));
    this.a.d = false;
  }
}
