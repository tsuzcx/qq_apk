...
public class aczz
  extends MqqHandler
{
  public aczz(ChatSettingActivity paramChatSettingActivity) {}
        ...
        do
        {
          do
          {
            ...
            if ((ChatSettingActivity.a(this.a) != 1001) && (ChatSettingActivity.a(this.a) != 10002)) {
              ...
              {
                paramMessage = (avnk)this.a.app.getManager(16);
            ...
            for (;;)
            {
              ...
              return;
              paramMessage = ContactUtils.getUinByPhoneNum(this.a.app, ChatSettingActivity.c(this.a));
              ...
              bool1 = false;
              break label308;
              paramMessage = (amsw)this.a.app.getManager(51);
              if (paramMessage != null)
              {
