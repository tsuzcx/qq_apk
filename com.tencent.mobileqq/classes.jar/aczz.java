...
public class aczz
  extends QIPCModule
{
  private static aczz a;
  
  public aczz(String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if (paramString.equals("start"))
    {
      ...
      localEIPCResult = EIPCResult.createResult(aczu.a().a(paramInt, i, j, k, m, n, l, Process.myTid(), paramString), null);
    }
