...
{
  amzm(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (!paramFromServiceMsg.isSuccess()) {
      bhvw.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, amtj.a(2131710504), true);
    }
  }
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if ((localRemindItem.uint64_uin.has()) && (localRemindItem.uint32_id.has()))
          {
            ...
            paramRspBody.add(str);
            alem.a(str, localRemindItem.uint32_id.get(), this.app);
          }
        }
        alem.a(paramRspBody, this.app);
      }
    }
  }
  ...
  private void c(RemindPB.RspBody paramRspBody)
  {
    if (paramRspBody.msg_quota.has())
    {
      ...
      if (paramRspBody.uint32_comm_quota.has()) {
        alem.a(paramRspBody.uint32_comm_quota.get(), this.app);
      }
      if (paramRspBody.uint32_svip_quota.has()) {
        alem.b(paramRspBody.uint32_svip_quota.get(), this.app);
      }
      alem.b(this.app);
    }
  }
