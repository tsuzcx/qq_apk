  ...
  extends DynamicTextItem
{
  ...
  public bjgb(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
    ...
    this.jdField_b_of_type_Int = actn.a(this.jdField_b_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
    this.jdField_d_of_type_Int = actn.a(this.jdField_d_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
    this.jdField_c_of_type_Int = actn.a(this.jdField_c_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
    this.e = actn.a(this.e, this.jdField_a_of_type_AndroidContentResResources);
    this.f = actn.a(this.f, this.jdField_a_of_type_AndroidContentResResources);
    this.g = actn.a(this.g, this.jdField_a_of_type_AndroidContentResResources);
  ...
  private void a(Typeface paramTypeface)
  {
    ...
    this.jdField_b_of_type_AndroidTextTextPaint.setStrokeWidth(actn.a(2.0F, this.jdField_a_of_type_AndroidContentResResources));
    if (Build.VERSION.SDK_INT >= 21) {
      this.jdField_b_of_type_AndroidTextTextPaint.setShadowLayer(actn.a(1.0F, this.jdField_a_of_type_AndroidContentResResources), actn.a(1.0F, this.jdField_a_of_type_AndroidContentResResources), actn.a(1.0F, this.jdField_a_of_type_AndroidContentResResources), Color.parseColor("#33000000"));
    }
  }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bjgd(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = bakj.b(super.a(paramInt, new bjgc(this))).replaceAll("\n", "");
