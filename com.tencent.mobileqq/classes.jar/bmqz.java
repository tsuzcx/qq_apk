...
public final class bmqz
{
  ...
  public static bmse a(String paramString1, String paramString2, String paramString3, long paramLong, int paramInt, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      return bmse.a(10, paramString1, paramString2, paramString3, paramLong, paramInt, BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramString4, paramString5);
    }
  }
  ...
  public static void a(Application paramApplication, boolean paramBoolean)
  {
    ...
    {
      localWeiyunTransmissionGlobal.initTransmission(localAppInfo, paramApplication, new bmrf(str), bmuc.a());
      ...
      AppNetConnInfo.registerNetChangeReceiver(null, new bmra());
      bmsl.a().a(new bmrb(), paramApplication);
      bmsl.a().a(new bmrd());
      WeiyunTransmissionGlobal.getInstance().getUploadManager().addGlobalObserver(new bmre());
