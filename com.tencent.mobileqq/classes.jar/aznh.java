...
public class aznh
{
  ...
  static
  {
    jdField_a_of_type_Aznh = new aznh("qzone");
  }
  
  public aznh(String paramString)
  {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if ((localBoolean == null) || (!localBoolean.booleanValue()))
    {
      ...
      if ((localBoolean != null) && (localBoolean.booleanValue()))
      {
        ...
        azmz.a(BaseApplicationImpl.getContext()).a(paramString1, paramString2, true, 0L, 0L, null, null);
    ...
    if (paramString2 != null)
    {
      ...
      if ((localBoolean == null) || (!localBoolean.booleanValue()))
      {
        ...
        if ((localBoolean != null) && (localBoolean.booleanValue()))
        {
          ...
          azmz.a(BaseApplicationImpl.getContext()).a(paramString1, paramString2, false, 0L, 0L, null, null);
          this.jdField_a_of_type_JavaUtilMap.remove(paramString2);
          this.b.remove(paramString2);
        }
      }
