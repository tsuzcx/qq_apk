...
public class aepn
  implements Runnable
{
  public aepn(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity, ProfilePerformanceReport paramProfilePerformanceReport) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.runOnUiThread(new aepo(this));
        return;
        bool2 = false;
        break label539;
      }
