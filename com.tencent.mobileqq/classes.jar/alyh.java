  ...
  implements BusinessObserver
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new alyi(this, Looper.getMainLooper());
  ...
  Queue<alyl> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  public boolean a;
  final int jdField_b_of_type_Int = 2;
  private Handler jdField_b_of_type_AndroidOsHandler = new alyj(this, Looper.getMainLooper());
  final int c = 3;
  
  public alyh(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    azmz.a(BaseApplication.getContext()).a(null, "AppOpenUrl", true, 0L, 0L, localHashMap, null);
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_Alyk.jdField_b_of_type_Long = Long.valueOf(l).longValue();
      if (((signature.SignatureResult)localObject2).u32_timeout.has()) {
        this.jdField_a_of_type_Alyk.jdField_a_of_type_Long = ((signature.SignatureResult)localObject2).u32_timeout.get();
      }
      if (((signature.SignatureResult)localObject2).u32_check_result.has()) {
        this.jdField_a_of_type_Alyk.jdField_a_of_type_Int = ((signature.SignatureResult)localObject2).u32_check_result.get();
      }
      if (((signature.SignatureResult)localObject2).str_title.has()) {
        this.jdField_a_of_type_Alyk.jdField_c_of_type_JavaLangString = ((signature.SignatureResult)localObject2).str_title.get();
      }
      if (((signature.SignatureResult)localObject2).str_content.has()) {
        this.jdField_a_of_type_Alyk.d = ((signature.SignatureResult)localObject2).str_content.get();
      }
      if (((signature.SignatureResult)localObject2).str_left_button.has()) {
        this.jdField_a_of_type_Alyk.e = ((signature.SignatureResult)localObject2).str_left_button.get();
      }
      if (((signature.SignatureResult)localObject2).str_right_button.has()) {
        this.jdField_a_of_type_Alyk.f = ((signature.SignatureResult)localObject2).str_right_button.get();
      }
      if (((signature.SignatureResult)localObject2).str_url.has()) {
        this.jdField_a_of_type_Alyk.g = ((signature.SignatureResult)localObject2).str_url.get();
      }
      this.jdField_a_of_type_Alyk.b();
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (alyl)paramArrayOfByte.next();
      ...
      {
        localObject3 = (alyl)((Iterator)localObject2).next();
        if (((alyl)localObject3).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
      ...
      {
        localObject4 = (alyl)((Iterator)localObject3).next();
        if (((alyl)localObject4).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
  ...
  public void b(String paramString, Context paramContext, Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Alym = new alym(this, paramString);
    this.jdField_a_of_type_Alyk = new alyk(this, paramString);
    long l;
    if (Long.valueOf(System.currentTimeMillis()).longValue() < this.jdField_a_of_type_Alyk.jdField_b_of_type_Long + 86400000L)
    {
      PackageInfo localPackageInfo = a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_Alym.jdField_a_of_type_JavaLangString);
      if (localPackageInfo != null)
      {
        ...
        if ((this.jdField_a_of_type_Alyk.jdField_c_of_type_Long == l) && (this.jdField_a_of_type_Alyk.jdField_a_of_type_JavaLangString.equalsIgnoreCase(str)))
        {
          if (this.jdField_a_of_type_Alyk.jdField_a_of_type_Int != 2)
          {
            paramContext.startActivity(paramIntent);
            return;
          }
          ...
          paramContext.putString("dlg_title", this.jdField_a_of_type_Alyk.jdField_c_of_type_JavaLangString);
          paramContext.putString("dlg_content", this.jdField_a_of_type_Alyk.d);
          paramContext.putString("dlg_lbutton", this.jdField_a_of_type_Alyk.e);
          paramContext.putString("dlg_rbutton", this.jdField_a_of_type_Alyk.f);
          paramContext.putString("dlg_url", this.jdField_a_of_type_Alyk.g);
          ...
          try
          {
            azmj.b(null, "P_CliOper", "Safe_StartAppCheck", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), "startAppByCheckValid", this.jdField_a_of_type_Alyk.jdField_b_of_type_JavaLangString, 0, 0, "", "", "", "");
            return;
          }
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Alym.jdField_a_of_type_Long = Long.valueOf(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount()).longValue();
        this.jdField_a_of_type_Alym.jdField_a_of_type_Int = 1;
        this.jdField_a_of_type_Alym.jdField_a_of_type_JavaLangString = paramString;
        paramString = new alyl(this, paramString, paramContext, paramIntent);
        ...
        if (this.jdField_a_of_type_Alyk.jdField_a_of_type_Long <= 0L) {
          break label581;
        }
        l = this.jdField_a_of_type_Alyk.jdField_a_of_type_Long;
