  ...
  implements Manager
{
  ...
  private CopyOnWriteArrayList<alxy> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public alyh(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    QLog.i("cmgame_process.CmGameManager", 1, "[CmGameManager] created.");
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = new ApolloCmdChannel(alvx.a());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new alyj();
  ...
  public alsn a()
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 379	alyh:jdField_a_of_type_Alsn	Lalsn;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 381	alsn
    //   28: dup
    //   29: invokespecial 382	alsn:<init>	()V
    //   32: putfield 379	alyh:jdField_a_of_type_Alsn	Lalsn;
    ...
    //   50: aload_0
    //   51: getfield 379	alyh:jdField_a_of_type_Alsn	Lalsn;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
  ...
  public alxy a()
  {
    ...
    {
      alxy localalxy = (alxy)localIterator.next();
      if ((localalxy != null) && (!alvx.a(localalxy.a())) && (!alvx.b(localalxy.a()))) {
        return localalxy;
      }
    }
    return null;
  ...
  public alxy a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      alxy localalxy = (alxy)localIterator.next();
      if ((localalxy != null) && (paramInt == localalxy.a())) {
        return localalxy;
      }
    }
    return null;
  ...
  public alxy a(int paramInt1, int paramInt2)
  {
    if (paramInt1 <= 0) {}
    for (;;)
    {
      ...
      alxy localalxy = new alxy(paramInt1);
      localalxy.d = paramInt2;
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, localalxy);
  ...
  /* Error */
  public alxy a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	alyh:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   28: checkcast 390	alxy
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 423	alxy:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      alyk localalyk = (alyk)localIterator.next();
      if (localalyk != null) {
        if (localalyk.jdField_a_of_type_JavaLangRefWeakReference == null)
        {
          localArrayList.add(localalyk);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localalyk.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localalyk);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localalyk = (alyk)localIterator.next();
        if ((localalyk != null) && (localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localalyk.jdField_a_of_type_Int = 1;
          localalyk.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localalyk);
        }
      }
      for (;;)
      {
        ...
        localalyk = new alyk();
        localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localalyk.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localalyk.jdField_a_of_type_Int = 1;
        localalyk.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localalyk);
        return;
        localalyk = null;
      }
    }
  ...
  /* Error */
  public alxy b(int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 392	alxy:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 406	alxy:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 47	alyh:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    ...
    //   89: aload_0
    //   90: getfield 47	alyh:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localalyk != null) && (localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localalyk.jdField_a_of_type_Int = 2;
          localalyk.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localalyk.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localalyk);
        }
      }
      for (paramActivity = localalyk; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (alyk)localIterator.next();
