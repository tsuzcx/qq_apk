...
public class bmvv
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, bmvz parambmvz)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return bmvw.a().a("https://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/qzone_yellow_icon_v6.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), parambmvz);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130849299);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bmvz parambmvz)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, parambmvz, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bmvz parambmvz, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      bmvw.a().a(paramString, paramInt1, "border", parambmvz);
      continue;
      switch (paramInt3)
      {
      }
    }
    return bmvw.a().a(paramString, paramInt1, "head", parambmvz);
    return bmvw.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, parambmvz);
    return bmvw.a().a(paramString, paramInt1, "right", parambmvz);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, bmvz parambmvz)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return bmvw.a().a(paramString, paramInt2, str, true, parambmvz);
    }
    return null;
  }
