  ...
  implements View.OnClickListener
{
  ...
  {
    if (paramView != null) {
      paramContext = (bcly)paramView.getTag();
    }
    for (;;)
    {
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    this.ad = bblk.a(paramObjectInput.readUTF(), false);
    this.ae = bblk.a(paramObjectInput.readUTF(), false);
    this.b = bblk.a(paramObjectInput.readUTF(), false);
  }
  ...
  public boolean a(bcin parambcin)
  {
    ...
    this.ad = parambcin.a("leftImage");
    this.ae = parambcin.a("rightImage");
    this.ac = bblk.a(parambcin.a("text"), false);
    return true;
  }
