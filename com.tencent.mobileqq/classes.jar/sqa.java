...
{
  public sqa(FriendProfileMoreInfoActivity paramFriendProfileMoreInfoActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, Card paramCard)
  {
    ...
    if ((this.a.jdField_b_of_type_Int & 0x1) == 1)
    {
      if (paramBoolean)
      {
        ...
        String str;
        if (this.a.jdField_a_of_type_Sqo.b)
        {
        ...
        if (this.a.jdField_b_of_type_Sqo.b) {
        ...
        if (this.a.jdField_c_of_type_Sqo.b)
        {
