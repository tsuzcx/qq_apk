...
public class attc
  extends atta
{
  public attc(QQAppInterface paramQQAppInterface)
  {
  ...
  private String a(long paramLong, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      return paramString1;
      paramString2 = anhk.bs + atwt.a(paramLong, paramInt, paramString2);
  ...
  private boolean a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    for (Object localObject1 = (MessageForTroopFile)atvo.a((ChatMessage)paramMessageRecord); localObject1 == null; localObject1 = (MessageForTroopFile)paramMessageRecord)
    {
    ...
    TroopFileTransferManager.Item localItem = localTroopFileTransferManager.a(((bety)localObject1).jdField_a_of_type_JavaUtilUUID);
    Object localObject2;
    String str;
    if (localItem != null) {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
            {
              ...
              {
                if (bgmg.b(localItem.largeThumbnailFile)) {
                  continue;
                }
  ...
  private void c(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    besl localbesl = bfrm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).b(((MessageForTroopFile)localObject1).url, ((MessageForTroopFile)localObject1).fileName, ((MessageForTroopFile)localObject1).fileSize, ((MessageForTroopFile)localObject1).bisID);
    Object localObject2;
    String str;
    if ((localbesl != null) && (paramList != null) && (!paramList.isEmpty()))
    {
      localObject1 = "";
      localObject2 = "";
      Iterator localIterator = paramList.iterator();
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if ((a((MsgBackupResEntity)localObject2)) && (b(paramMessageRecord, (MsgBackupResEntity)localObject2)))
          {
            ...
            if (((MsgBackupResEntity)localObject2).msgSubType == 12) {
              localObject1 = a(l, str, UUID.nameUUIDFromBytes(localbesl.b.getBytes()).toString(), 640);
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      if (((MsgBackupResEntity)localObject2).msgSubType == 11)
      {
        paramList = a(str, localbesl.c);
        continue;
        if (bgmg.b(paramList))
        {
          localbesl.h = paramList;
          localbesl.e = 11;
        ...
        if (bgmg.b((String)localObject1))
        {
          localbesl.j = ((String)localObject1);
        ...
        TroopFileTransferManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l).a(localbesl);
        return;
      }
    }
  }
  ...
  protected String a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    try
    {
      ...
      localObject = bfsj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
      if ((localObject != null) && (((bety)localObject).e > 0) && (((bety)localObject).f > 0))
      {
        localJSONObject.put("uint32_img_width", ((bety)localObject).e);
        localJSONObject.put("uint32_img_height", ((bety)localObject).f);
      }
  ...
  public void a(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      localObject1 = (MessageForTroopFile)atvo.a((ChatMessage)paramMessageRecord);
      localObject1 = bfsj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject1);
    ...
    for (;;)
    {
      ...
      break;
      label145:
      int i = atvo.a(((bety)localObject1).g);
      if ((i == 0) || (i == 2))
      {
        Object localObject2 = ((bety)localObject1).c;
      ...
      localObject1 = ((bety)localObject1).jdField_a_of_type_JavaLangString;
      if (bgmg.b((String)localObject1))
      {
  ...
  public boolean a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    do
    {
      ...
      if (paramMsgBackupResEntity.msgSubType == 12)
      {
        bool1 = bgmg.b(paramMessageRecord.c);
    ...
    boolean bool2 = bgmg.b(paramMessageRecord.jdField_a_of_type_JavaLangString);
