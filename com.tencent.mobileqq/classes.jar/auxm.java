...
{
  private static auxm jdField_a_of_type_Auxm;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private Map<String, Integer> jdField_a_of_type_JavaUtilMap;
  
  public static auxm a()
  {
    if (jdField_a_of_type_Auxm == null) {}
    try
    {
      if (jdField_a_of_type_Auxm == null) {
        jdField_a_of_type_Auxm = new auxm();
      }
      return jdField_a_of_type_Auxm;
    }
    finally {}
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_JavaUtilMap = bhlo.a(BaseApplicationImpl.getContext());
        return false;
      } while (this.jdField_a_of_type_JavaUtilMap == null);
      if (paramMessage.arg1 == 1) {}
      for (boolean bool = true;; bool = false)
      {
        auxn.a(bool, true, this.jdField_a_of_type_JavaUtilMap);
        if (bool) {
          break;
        }
    ...
    auxn.a(true, false, this.jdField_a_of_type_JavaUtilMap);
    this.jdField_a_of_type_JavaUtilMap = null;
    return false;
  }
}
