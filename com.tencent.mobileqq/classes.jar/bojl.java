  ...
  extends bojo
{
  ...
  private static final String jdField_a_of_type_JavaLangString = bojl.class.getSimpleName();
  private static String jdField_b_of_type_JavaLangString;
  private static boolean jdField_c_of_type_Boolean;
  private static int o;
  private static int p;
  private boqy jdField_a_of_type_Boqy = new boqy();
  private boso jdField_a_of_type_Boso;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    for (;;)
    {
      ...
      {
        Bitmap localBitmap;
        if (this.jdField_a_of_type_Bojn == null) {
          continue;
        }
        this.jdField_a_of_type_Bojn.b(103);
        return;
      }
      ...
      if (this.jdField_a_of_type_Bojn != null) {
        this.jdField_a_of_type_Bojn.a(localBitmap);
      }
      m();
      return;
      label130:
  ...
  {
    if (this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager == null) {}
    while ((!brdw.a().b()) || (!f()) || (!this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.canUseLargeImage())) {
      return false;
    }
    return true;
  }
  ...
  private void i()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Boso == null) {
        this.jdField_a_of_type_Boso = new boso();
      }
      return;
    }
    finally {}
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_Boso != null) {
      this.jdField_a_of_type_Boso.a();
    }
    this.jdField_a_of_type_Boqy.a();
  }
  ...
  private void l()
  {
    ...
    int j = 100;
    Object localObject = bozz.a().a("app_alg_filter_timeout_id", "", 4);
    int i = j;
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.setOnMaterialLoadFinishListener(new bojm(this));
  ...
  public int a(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Boso.a(localFrame).getTextureId();
  }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    ...
    for (;;)
    {
      ...
      {
        bpam.d(jdField_a_of_type_JavaLangString, "[setVideoMaterial] material is same");
  ...
  public int[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (boqy.jdField_a_of_type_Boolean)
    {
      if (!this.jdField_a_of_type_Boqy.a())
      {
        this.jdField_a_of_type_Boqy.c();
        this.g = this.jdField_a_of_type_Boqy.a();
        this.h = this.jdField_a_of_type_Boqy.b();
      }
      localObject = this.jdField_b_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Boqy.c(), this.e, this.f);
    }
    for (;;)
    {
      int i;
      ...
      if ((bool) && (g()))
      {
        bomz.a.jdField_a_of_type_Boolean = true;
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Boso != null)
    {
      this.jdField_a_of_type_Boso.b();
      this.jdField_a_of_type_Boso = null;
    }
    this.jdField_a_of_type_Boqy.b();
  }
