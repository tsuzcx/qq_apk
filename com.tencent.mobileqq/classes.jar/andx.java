  ...
  extends MSFServlet
{
  ...
  private void a(long paramLong, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bhvy.a((JSONObject)localObject);
        nol.a(null, paramQQAppInterface.getAccount(), "0X800965D", "0X800965D", 0, 0, String.valueOf(b), String.valueOf(c), String.valueOf(d), ((JSONObject)localObject).toString(), false);
        return;
      }
  ...
  private void a(QQAppInterface paramQQAppInterface, Intent paramIntent, int[] paramArrayOfInt, Packet paramPacket)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        k = bbkb.M(paramQQAppInterface.getApp(), str);
  ...
  {
    long l = System.currentTimeMillis();
    paramQQAppInterface = (Boolean)bhvy.a("local_kd_tab_has_set");
  ...
  public static boolean a(AppRuntime paramAppRuntime, Class<?> paramClass, long paramLong, boolean paramBoolean)
  {
    ...
    if (paramAppRuntime != null)
    {
      ...
      if ((paramAppRuntime instanceof AppInterface))
      {
        ...
        if (localBaseApplication != null)
        {
          ...
          {
            i = bbkb.M(localBaseApplication, str);
            if (i != 0) {
              break label251;
            }
            jdField_a_of_type_JavaLangClass = paramClass;
            paramClass = new NewIntent(localBaseApplication, andx.class);
    ...
    {
      QLog.d("KandianConfigServlet", 1, onh.a() + " getKandianTabConfig executed:" + bool1 + "  startTime:" + paramLong);
      return bool1;
      label251:
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    QLog.d("KandianConfigServlet", 1, onh.a() + " onReceive   nowTime:" + l + "   requestCost:" + c + " success:" + bool + "  code" + paramFromServiceMsg.getResultCode());
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    try
    {
      ...
      QLog.d("KandianConfigServlet", 1, onh.a() + " onSend   mRequestStartTime:" + this.jdField_a_of_type_Long + "  cmds:" + arrayOfInt);
      return;
    }
    catch (Exception paramIntent)
    {
