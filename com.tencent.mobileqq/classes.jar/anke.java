  ...
  extends ankc
{
  ...
  protected afjb a;
  private WeakReference<bdjz> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public anke(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_Afjb = new afjb(this.jdField_a_of_type_JavaLangString, 30000L);
  }
  ...
  private void a(long paramLong, String paramString, int paramInt)
  {
    ...
    QQAppInterface localQQAppInterface = anjy.a();
    Object localObject;
    String str2;
    String str1;
    if ((localQQAppInterface != null) && (1 == paramInt))
    {
      localObject = ((alto)localQQAppInterface.getManager(51)).b(paramString);
      if (localObject != null)
      {
        str2 = ((Card)localObject).strNick;
        if (((Card)localObject).shGender == 0) {
          str1 = BaseActivity.sTopActivity.getString(2131694192);
        }
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        str1 = BaseActivity.sTopActivity.getString(2131692471);
        break;
  ...
  private void a(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_MqqObserverWtloginObserver == null) {
        this.jdField_a_of_type_MqqObserverWtloginObserver = new ankk(this, paramLong1);
      }
  ...
  {
    if (this.jdField_a_of_type_Afjb != null) {
      this.jdField_a_of_type_Afjb.a();
    }
    if (this.jdField_a_of_type_MqqObserverWtloginObserver != null) {
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    {
      paramString = "";
      paramArrayOfVariantWrapper = anjy.a();
    ...
    if (paramString.equals("NavigateTo"))
    {
      ...
      if ((paramString != null) && (paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1)) {
        anjy.a(paramString, paramArrayOfVariantWrapper[0].GetString(), true, 0L, null, null, 3, this.jdField_a_of_type_JavaLangString, null);
      }
      return true;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfVariantWrapper != null)
        {
          ...
          if ((!(localObject4 instanceof agti)) || (!"biz_src_ads".equals(localObject2))) {
            break label8220;
          }
          ...
          localObject4 = (afii)afii.a((ark.Container)localObject4).get();
          if ((localObject4 == null) || (!(localObject4 instanceof afih))) {
            break label8214;
          }
          localObject4 = (MessageForArkApp)((afih)localObject4).jdField_a_of_type_JavaLangRefWeakReference.get();
          if (!anla.a(paramString, (String)localObject1, paramArrayOfVariantWrapper, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString)) {
            continue;
          }
          anoe.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
          ...
          else
          {
            ...
            if (localObject4 != null)
            {
              ...
              azqs.b(null, "dc00898", "", "", "0X800A86C", "0X800A86C", 0, 0, paramArrayOfVariantWrapper, "", "", "");
              paramArrayOfVariantWrapper = paramString;
            }
          }
          Log.d("ark.OpenUrl ", paramArrayOfVariantWrapper);
          anoe.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
          return true;
        ...
        {
          if (!anjy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.BROWSER"))
          {
          ...
          if (paramArrayOfVariantWrapper != null)
          {
            ...
            if (k == 0)
            {
              ...
              i = 1;
              j = 2;
              anrm.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, afii.jdField_c_of_type_JavaLangString);
            }
          }
          else
          {
          ...
          catch (JSONException paramArrayOfVariantWrapper)
          {
            ...
            paramArrayOfVariantWrapper = String.valueOf(l1);
            continue;
            anjy.a(localBaseActivity, paramString, true, 0L, null, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject3);
            continue;
          }
          ...
          if (paramArrayOfVariantWrapper.getChatFragment() != null)
          {
            ...
            if ((paramArrayOfVariantWrapper instanceof agti)) {
              ((agti)paramArrayOfVariantWrapper).a.b();
            }
          }
          else
          {
            ...
            l1 = npd.a(((MessageForArkApp)localObject4).ark_app_message.getAppIdFromMeta(), 0L);
            anjy.a(localBaseActivity, paramString, true, l1, (MessageForArkApp)localObject4, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject3);
            ...
            if (((MessageForArkApp)localObject4).buildTypeAndTitle().isSdkShare)
            {
              ...
              paramArrayOfVariantWrapper = "";
              azqs.b(null, "dc00898", "", "", "0X800A869", "0X800A869", 0, 0, paramArrayOfVariantWrapper, "", "", "");
            }
            paramArrayOfVariantWrapper = paramString;
            continue;
            paramVariantWrapper = paramString + "&" + paramArrayOfVariantWrapper;
        ...
        paramVariantWrapper = bdib.a(anjy.a(), localBaseActivity, paramString);
        paramArrayOfVariantWrapper = paramString;
        ...
        if (paramString.equals("OpenVideo"))
        {
          ...
          try
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ((((String)localObject1).equalsIgnoreCase("http")) || (((String)localObject1).equalsIgnoreCase("https"))))
            {
              ...
              paramVariantWrapper.SetBool(true);
              anjy.a(paramString, paramArrayOfVariantWrapper);
              anoe.a((QQAppInterface)localObject1, this.jdField_a_of_type_JavaLangString, "AIOArkOpenVideo", 1, 0, 0L, 0L, 0L, paramArrayOfVariantWrapper, "");
            }
            return true;
          }
        ...
        if (paramString.equals("Report"))
        {
          ...
          try
          {
            ...
            azqs.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), paramVariantWrapper, paramArrayOfVariantWrapper, "");
            anoe.a(paramString, this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper, i);
            return true;
          }
          catch (Exception paramVariantWrapper)
          {
            azqs.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
            continue;
          }
          azqs.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
          continue;
        ...
        if (paramString.equals("ReportEx"))
        {
          ...
          if (paramVariantWrapper.equals("898")) {
            try
            {
              ...
              azqs.b(null, "dc00898", "", (String)localObject1, paramArrayOfVariantWrapper, paramVariantWrapper, i, j, k, Integer.toString(m), Integer.toString(n), (String)localObject2, (String)localObject3);
              return true;
            }
            catch (JSONException paramArrayOfVariantWrapper)
            {
        ...
        {
          paramArrayOfVariantWrapper = bdgk.c();
        ...
        if (paramString.equals("Log"))
        {
          ...
          j = anjy.a(paramArrayOfVariantWrapper, l1);
          if (i == 0)
          {
        ...
        if (paramString.equals("GetNickName"))
        {
          ...
          if (paramArrayOfVariantWrapper != null)
          {
            ...
            if (l1 == 1L)
            {
              ...
              {
                localObject1 = null;
                if (!TextUtils.isEmpty(afii.jdField_a_of_type_JavaLangString)) {
                  localObject1 = bdgc.h((QQAppInterface)localObject2, afii.jdField_a_of_type_JavaLangString, paramString);
                }
                if (localObject1 != null)
                {
                ...
                localObject1 = bdgc.q((QQAppInterface)localObject2, paramString);
                paramArrayOfVariantWrapper = (ark.VariantWrapper[])localObject1;
                if (!TextUtils.isEmpty((CharSequence)localObject1)) {
                  continue;
                }
                paramString = bdgc.a((QQAppInterface)localObject2, paramString, 0);
                paramVariantWrapper.SetString(paramString);
                if (paramString != null) {
        ...
        else if (paramString.equals("GetContainerInfo"))
        {
          ...
          if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsView()))
          {
            ...
            paramString = (afii)afii.a(paramString).get();
            if ((paramString == null) || (!(paramString instanceof afih))) {
              continue;
            }
            paramArrayOfVariantWrapper = ((afih)paramString).a();
            paramString = paramArrayOfVariantWrapper;
            if (paramArrayOfVariantWrapper == null) {
              paramString = anjy.a();
            }
            if (QLog.isColorLevel()) {
              QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg GetContainerInfo Extra ViewID viewHandle=", Long.valueOf(l1), anjy.a(paramString) });
            }
            if (paramString != null)
            {
          ...
          default: 
            ...
            paramString = anjy.a();
            if (QLog.isColorLevel()) {
              QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg GetContainerInfo old activity=", BaseActivity.sTopActivity, anjy.a(paramString) });
            }
            break;
          case 1008: 
        ...
        else
        {
          if (paramString.equals("DataRequest"))
          {
            ...
            paramVariantWrapper.CreateObject("DataRequest", new afju(paramString, this.jdField_a_of_type_JavaLangString));
            return true;
          }
          if (paramString.equals("GetPerformance"))
          {
            ...
            paramArrayOfVariantWrapper = afih.a(paramString);
          ...
          {
            if ((this.jdField_a_of_type_Afjb == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1) || (paramArrayOfVariantWrapper[0] == null) || (!paramArrayOfVariantWrapper[0].IsFunction())) {
              return false;
            }
            if (QLog.isColorLevel()) {
            ...
            this.jdField_a_of_type_Afjb.b(new ankf(this, l1));
            return true;
          }
          if (paramString.equals("WatchPosition"))
          {
            ...
            l1 = a(paramArrayOfVariantWrapper[0].Copy());
            this.jdField_a_of_type_Afjb.a(new ankh(this, l1));
            return true;
          }
          ...
          if (paramString.equals("GetCurrentAddress"))
          {
            ...
            l1 = a(paramArrayOfVariantWrapper[0].Copy());
            this.jdField_a_of_type_Afjb.a(new ankl(this, l1), true);
            return true;
          }
          if (paramString.equals("SendMessage"))
          {
            ...
            try
            {
              ...
              if ((paramArrayOfVariantWrapper.length >= 3) && (paramArrayOfVariantWrapper[2].IsView()))
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg SendMessage Extra viewid viewHandle=", Long.valueOf(l1), anjy.a(paramString) });
                break label8243;
              ...
              else
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg SendMessage old,sessionInfo=", anjy.a(paramString) });
                break label8246;
              }
              ...
              if (TextUtils.isEmpty(((ArkAppMessage)localObject2).promptText)) {
                ((ArkAppMessage)localObject2).promptText = String.format(alud.a(2131701025), new Object[] { ((ArkAppMessage)localObject2).appDesc });
              }
              ...
              if (bool1)
              {
                if (paramString != null)
                {
                  acjm.b(anjy.a(), paramString, (ArkAppMessage)localObject2);
                  if (QLog.isColorLevel()) {
            ...
            if (bool1)
            {
              ...
              paramString = azaf.a(anjy.a(), anjy.a().c(), paramString.jdField_a_of_type_JavaLangString, paramString.b, paramString.jdField_a_of_type_Int, (byte)1, (byte)0, (short)0, paramVariantWrapper);
          ...
          else
          {
            if (paramString.equals("GetPskeyAsync"))
            {
              ...
              if (paramVariantWrapper != null)
              {
                ...
                if (TextUtils.isEmpty((CharSequence)localObject1))
                {
                  ...
                  paramVariantWrapper = new ankm(this, paramArrayOfVariantWrapper, paramVariantWrapper, paramString, l1);
            ...
            {
              if (!anjy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.LOGIN"))
              {
            ...
            {
              if (!anjy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.USER_INFORMATION"))
              {
            ...
            {
              if (!anjy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.OPENVIEW")) {
                return false;
              }
            ...
            {
              if (!anjy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.SHARE")) {
                return false;
              }
              if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()) && ((paramArrayOfVariantWrapper[1].IsArray()) || (paramArrayOfVariantWrapper[1].IsTable())))
              {
                ...
                paramArrayOfVariantWrapper = anjy.a(paramArrayOfVariantWrapper);
            ...
            {
              if (!anjy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.STATUSBAR")) {
                return false;
              }
              ...
              if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length == 1))
              {
                ...
                if ((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime() != null)
                {
                  ...
                  if (paramString != null)
                  {
                    ...
                    localObject1 = aolx.b(380).a();
                    paramArrayOfVariantWrapper = "";
                    paramString = paramArrayOfVariantWrapper;
                    if (localObject1 != null)
                    {
                      paramString = paramArrayOfVariantWrapper;
                      if (((aolw)localObject1).a() != null) {
                        paramString = ((aolw)localObject1).a().b;
                      }
                    }
                    paramArrayOfVariantWrapper = paramString;
                    if (TextUtils.isEmpty(paramString))
            ...
            else if (paramString.equals("GetNickNameByView"))
            {
              ...
              if (l2 != 0L)
              {
                ...
                paramString = (afii)afii.a(paramString).get();
                if (!(paramString instanceof afih)) {
                  continue;
                }
                paramArrayOfVariantWrapper = ((afih)paramString).a();
                paramString = paramArrayOfVariantWrapper;
                ...
                if (QLog.isColorLevel())
                {
                  QLog.d("ArkApp", 2, new Object[] { "ark.GetNickNameByView Extra ViewID viewHandle=", Long.valueOf(l2), anjy.a(paramString) });
                  paramArrayOfVariantWrapper = paramString;
                }
                if (!TextUtils.isEmpty((CharSequence)localObject1))
                {
                  ...
                  paramArrayOfVariantWrapper = bdgc.a((QQAppInterface)localObject2, paramArrayOfVariantWrapper, ((String)localObject1).equals(((QQAppInterface)localObject2).c()), (String)localObject1);
                  if (paramArrayOfVariantWrapper != null)
                  {
                    paramString = paramArrayOfVariantWrapper;
                  ...
                  {
                    paramArrayOfVariantWrapper = bdgc.q((QQAppInterface)localObject2, (String)localObject1);
                    paramString = paramArrayOfVariantWrapper;
                    if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
                      paramString = bdgc.a((QQAppInterface)localObject2, (String)localObject1, 0);
                    }
                  }
                  paramVariantWrapper.SetString(paramString);
                  if ((paramString != null) && (QLog.isColorLevel())) {
              ...
              else
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "ark.GetNickNameByView old activity=", BaseActivity.sTopActivity, anjy.a(paramString) });
                paramArrayOfVariantWrapper = paramString;
                continue;
              }
              return false;
              ...
              if (paramString.equals("SubscribePublicAccount"))
              {
                ...
                try
                {
                  ...
                  if ((int)paramArrayOfVariantWrapper[1].GetDouble() == 0) {
                    ymg.a(BaseApplicationImpl.getContext(), paramString, new anki(this, l1));
                  } else {
                    ymg.c(BaseApplicationImpl.getContext(), paramString, new ankj(this, l1));
                  }
                }
                catch (Exception paramString)
                {
