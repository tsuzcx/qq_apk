...
public final class bkex
{
  private static String jdField_a_of_type_JavaLangString;
  private static volatile boolean jdField_a_of_type_Boolean;
  
  public static bkge a(String paramString1, String paramString2, String paramString3, long paramLong, int paramInt, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      return bkge.a(10, paramString1, paramString2, paramString3, paramLong, paramInt, BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramString4, paramString5);
    }
  }
  ...
  private static String a()
  {
    if (jdField_a_of_type_JavaLangString == null) {
      jdField_a_of_type_JavaLangString = "V1_AND_WY_VersionName_" + basj.a() + "_ChannelId_" + "B";
    }
  ...
  public static void a(Application paramApplication, boolean paramBoolean)
  {
    ...
    WeiyunTransmissionGlobal.AppInfo localAppInfo = new WeiyunTransmissionGlobal.AppInfo(a(), 1000269, "mobileqq", basj.a(), 0, "unknown");
    ...
    {
      localWeiyunTransmissionGlobal.initTransmission(localAppInfo, paramApplication, new bkfd(str), bkic.a());
      ...
      AppNetConnInfo.registerNetChangeReceiver(null, new bkey());
      bkgl.a().a(new bkez(), paramApplication);
      bkgl.a().a(new bkfb());
      WeiyunTransmissionGlobal.getInstance().getUploadManager().addGlobalObserver(new bkfc());
