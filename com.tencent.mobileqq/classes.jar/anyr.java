  ...
  implements Manager
{
  ...
  public anyr(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Aftv = new aftv(paramQQAppInterface);
    aftu.a(paramQQAppInterface);
  }
  ...
  public static String a(Context paramContext)
  {
    ...
    tmp6_5[0] = 2131689789;
    int[] tmp11_6 = tmp6_5;
    tmp11_6[1] = 2131689794;
    int[] tmp16_11 = tmp11_6;
    tmp16_11[2] = 2131689793;
    int[] tmp21_16 = tmp16_11;
    tmp21_16[3] = 2131689787;
    int[] tmp26_21 = tmp21_16;
    tmp26_21[4] = 2131689786;
    int[] tmp31_26 = tmp26_21;
    tmp31_26[5] = 2131689791;
    int[] tmp36_31 = tmp31_26;
    tmp36_31[6] = 2131689790;
    int[] tmp42_36 = tmp36_31;
    tmp42_36[7] = 2131689785;
    int[] tmp48_42 = tmp42_36;
    tmp48_42[8] = 2131689788;
    int[] tmp54_48 = tmp48_42;
    tmp54_48[9] = 2131689792;
    tmp54_48;
  ...
  public static String a(Context paramContext, SubMsgType0x76.MsgBody paramMsgBody)
  {
    ...
    if (TextUtils.isEmpty(str2))
    {
      ...
      str1 = String.format(paramContext.getString(2131689782), new Object[] { paramMsgBody.msg_geographic_notify.bytes_local_city.get().toStringUtf8() });
    }
    label63:
    do
    {
      ...
      if (paramMsgBody.uint32_msg_type.get() == 2) {
        return paramContext.getString(2131689780);
      }
      str1 = str2;
    } while (paramMsgBody.uint32_msg_type.get() != 3);
    return paramContext.getString(2131689784);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, submsgtype0xeb.MsgBody paramMsgBody)
  {
    ...
    int j = 0;
    Object localObject1 = paramQQAppInterface.a().b(anhk.ad, 9002);
    ...
    {
      if (i != 0) {
        paramQQAppInterface.a().c(anhk.ad, 9002);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if ((paramInt == 2) || (paramInt == 3))
      {
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007210", "0X8007211", 0, 0, "", "", "", "");
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putLong("key_last_birth_msg_stamp", bbyp.a()).commit();
  ...
  public void a(String paramString1, String paramString2)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(paramString2 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false))
      {
        if (QLog.isColorLevel()) {
          QLog.d("ActivateFriends.Manager", 2, new Object[] { "msgId: ", paramString2, " have Reminded!" });
        }
      }
      else
      {
        ...
        localMessageForText.frienduin = anhk.ad;
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.list.show", 0, 0, "", "", paramString2, "");
        blyl.a().a("qqremind", "2", "1", 100, paramString2, "15", 1);
        return;
      }
    }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    if (paramLong > NetConnInfoCenter.getServerTime())
    {
      ...
      afts localafts = (afts)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(321);
      if (localafts != null)
      {
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean2)
    {
      ((anip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).l(paramBoolean1);
      return;
    }
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694363) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBoolean1).commit();
  }
  ...
  {
    if (paramBoolean) {
      ((anip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).u();
    }
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694363) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
  }
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694363) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
  ...
  public void c()
  {
    ...
    anyq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, true, false, true);
  }
  ...
  public void e()
  {
    ...
    try
    {
      str1 = afsx.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd");
      if (QLog.isColorLevel()) {
    ...
    l1 += afsx.a(NetConnInfoCenter.getServerTimeMillis());
    if (QLog.isColorLevel()) {
      QLog.i("ActivateFriends.Manager", 2, "do login currentDelayTs: " + afsx.a(l1, "yyyy-MM-dd HH:mm:ss"));
    }
    ...
    {
      this.jdField_a_of_type_Aftv.a(str1, new anys(this, str1));
      return;
    }
  }
