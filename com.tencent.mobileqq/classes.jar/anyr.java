...
public class anyr
  implements Runnable
{
  public anyr(QIMPtvTemplateManager paramQIMPtvTemplateManager, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localHttpNetReq.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new anys(this);
