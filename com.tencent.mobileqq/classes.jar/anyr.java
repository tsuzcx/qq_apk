  ...
  implements anyn
{
  ...
  private void a(Context paramContext, int paramInt)
  {
    String str = "";
    if (paramInt == 1) {
      str = paramContext.getString(2131692602);
    }
  ...
  private void b(Context paramContext, ColorNote paramColorNote)
  {
    ...
    paramColorNote = new arhh((QQAppInterface)localObject, paramContext, paramColorNote, 10001);
    localObject = new Bundle();
    ((Bundle)localObject).putBoolean("from_qlink_enter_recent", false);
    paramColorNote.a((Bundle)localObject);
    paramContext = new arhj(paramContext, paramColorNote);
    paramContext.a(14);
  ...
  private void c(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      paramColorNote = bcjk.a(localQQAppInterface, l, paramColorNote.getString("file_color_note_file_uuid"), paramColorNote.getString("file_color_note_file_url"), paramColorNote.getString("file_color_note_fileName"), paramColorNote.getLong("file_color_note_fileSize"), paramColorNote.getInt("file_color_note_busId"));
      if (paramColorNote == null)
      {
        a(paramContext, 1);
        return;
    ...
    paramContext = new arhj(paramContext, new arhn(localQQAppInterface, paramContext, l, paramColorNote, -1));
    paramContext.a(14);
  ...
  private void d(Context paramContext, ColorNote paramColorNote)
  {
    ...
    int i = aroo.a(paramColorNote.getSubType());
    paramColorNote = new arhh((QQAppInterface)localObject, paramContext, arni.a(FileInfo.a(str)), 10000);
    localObject = new Bundle();
  ...
  private void e(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      if (paramColorNote != null)
      {
        paramContext = new arhj(paramContext, new arhi(paramContext, arni.a(paramColorNote)));
        paramContext.a(14);
        paramContext.b(268435456);
        paramContext.a();
        return;
  ...
  private void f(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      localObject = new arho((QQAppInterface)localObject, paramContext, localWeiYunFileInfo);
      ((arho)localObject).a(paramColorNote);
      paramContext = new arhj(paramContext, (arhm)localObject);
      paramContext.a(14);
      paramContext.b(268435456);
      paramContext.a();
      return;
  ...
  public void a(Context paramContext, ColorNote paramColorNote)
  {
    ...
    do
    {
      ...
      i = aroo.a(paramColorNote.getSubType());
      if (i == -1)
      {
