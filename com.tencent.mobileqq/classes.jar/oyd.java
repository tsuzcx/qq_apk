  ...
  implements owp
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull pan parampan, @NotNull pay parampay, @NotNull ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener((ViewBase.OnClickListener)new oye(parampan, parampay));
    parampay = paramViewBase.findViewBaseByName("id_comment_expose_subcomment_two");
    if ((parampay instanceof ped)) {
      ((ped)parampay).a(parampan, (View)paramContainer, 1);
    }
  }
}
