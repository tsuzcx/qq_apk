...
public class bljb<T extends RecyclerView.Adapter>
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public bljb(T paramT)
  {
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter = paramT;
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter.registerAdapterDataObserver(new bljc(this));
  }
  ...
  protected void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    if (this.jdField_a_of_type_Bljg != null) {
      this.jdField_a_of_type_Bljg.a(paramViewHolder, paramInt);
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (c(paramInt))
    {
      ...
      return new bljd(this, (View)this.jdField_a_of_type_JavaUtilList.get(paramInt));
    }
    if (d(paramInt))
    {
      paramInt = Math.abs(paramInt + 2000);
      return new blje(this, (View)this.b.get(paramInt));
    }
  ...
  public void onViewAttachedToWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter != null) && ((paramViewHolder instanceof blij))) {
