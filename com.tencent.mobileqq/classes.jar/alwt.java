  ...
  implements alrk
{
  ...
  public alng a;
  public biyn a;
  private AVVideoCtrl.EnableCameraCompleteCallback jdField_a_of_type_ComTencentTMGSdkAVVideoCtrl$EnableCameraCompleteCallback = new alwx(this);
  ...
  public alwt(int paramInt)
  {
    this.jdField_a_of_type_Biyn = new alww(this);
  ...
  private void a(String[] paramArrayOfString, String paramString)
  {
    ...
    paramArrayOfString = new alwz(this);
    if (QLog.isColorLevel())
    {
      i = j;
      while (i < localArrayList1.size())
    ...
    if ((amgw.a(BaseApplicationImpl.getContext()).a() != null) && (amgw.a(BaseApplicationImpl.getContext()).a().getRoom() != null) && (localArrayList1.size() > 0)) {
      amgw.a(BaseApplicationImpl.getContext()).a().getRoom().requestViewList((String[])localArrayList1.toArray(new String[localArrayList1.size()]), (AVView[])localArrayList2.toArray(new AVView[localArrayList2.size()]), localArrayList1.size(), paramArrayOfString);
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.f = paramBoolean;
    if ((alvx.b(this.jdField_a_of_type_Long) != null) && (alvx.b(this.jdField_a_of_type_Long).a != null))
    {
      AppActivity localAppActivity = (AppActivity)alvx.b(this.jdField_a_of_type_Long).a.get();
      localAppActivity.requestPermissions(new alwy(this, localAppActivity), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = amgw.a(BaseApplicationImpl.getContext()).a();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        amgo.a().b(paramBoolean);
        break label60;
      } while ((amgw.a(BaseApplicationImpl.getContext()).a() == null) || (amgw.a(BaseApplicationImpl.getContext()).a().getRoom() == null));
      label130:
      label140:
      amgw.a(BaseApplicationImpl.getContext()).a().getRoom().cancelAllView(new alxa(this));
    }
  }
  ...
  public void d()
  {
    ...
    {
      amgo.a().a("" + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_Alng != null) {
        this.jdField_a_of_type_Alng.b();
      }
      b(false);
  ...
  public void grant()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        alvx.a().callbackFromRequest(this.jdField_a_of_type_Long, 0, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
        return;
      }
      ...
      try
      {
        ...
        alvx.a().callbackFromRequest(this.jdField_a_of_type_Long, i, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
