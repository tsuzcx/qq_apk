...
{
  aojz(aojy paramaojy, biau parambiau, String paramString1, String paramString2, String paramString3) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramInt != 0)
        {
          ...
          if (this.jdField_a_of_type_Aojy.a != null) {
            ArkFullScreenAppActivity.a(this.jdField_a_of_type_Aojy.a, this.c, paramAppPathInfo, "0.0.0.1", paramObject, apoh.a(), null, 1);
          }
        }
        do
        {
          ...
          } while (this.jdField_a_of_type_Aojy.a == null);
          this.jdField_a_of_type_Aojy.a.startActivity(paramObject);
          return;
          QQToast.a(this.jdField_a_of_type_Aojy.a, 2131690086, 0).a();
