...
public class usw
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((qq_ad_get.QQAdGetRsp.AdInfo)localObject2).product_type.get() == 12)
        {
          ...
          localstSimpleMetaGdtAdInfo.bottomButton.text = anzj.a(2131715129);
        ...
        {
          localstSimpleMetaGdtAdInfo.bottomButton.text = anzj.a(2131715131);
          continue;
        }
      ...
      ((s_droplist_option)localObject3).optext = anzj.a(2131715134);
      ...
      ((s_droplist_option)localObject4).optext = anzj.a(2131715132);
  ...
  /* Error */
  private static String a(Context paramContext, usv paramusv)
  {
    // Byte code:
    //   0: ldc_w 417
    //   3: astore_3
    ...
    //   5: ifnull +260 -> 265
    //   8: aload_1
    //   9: invokevirtual 451	usv:a	()Ljava/lang/Object;
    //   12: instanceof 75
    //   15: ifeq +250 -> 265
    //   18: aload_1
    //   19: invokevirtual 451	usv:a	()Ljava/lang/Object;
    //   22: checkcast 75	UserGrowth/stSimpleMetaFeed
    //   25: astore 6
    //   27: aload 6
    //   29: invokestatic 69	usw:a	(LUserGrowth/stSimpleMetaFeed;)Ltencent/gdt/qq_ad_get$QQAdGetRsp$AdInfo;
    //   32: astore 5
    //   34: aload 5
    ...
    //   155: invokestatic 437	usw:a	(Landroid/content/Context;Ljava/lang/String;)Z
    //   158: ifeq +55 -> 213
    //   161: iconst_2
    //   162: istore_2
    //   163: aload_1
    ...
    //   256: invokestatic 519	uqf:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   259: aload_1
    //   260: areturn
    //   261: astore_0
    //   262: goto -29 -> 233
  ...
  public static qq_ad_get.QQAdGetRsp.AdInfo a(stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    try
    {
      ...
      paramstSimpleMetaFeed = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(acvb.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramstSimpleMetaFeed));
  ...
  public static void a(stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    try
    {
      ...
      if (paramstSimpleMetaFeed != null)
      {
        ...
        acoo.a().a(paramstSimpleMetaFeed);
      }
      return;
    }
    catch (Throwable paramstSimpleMetaFeed)
    {
      uqf.d("GdtAdUtil", "adPreLoad error" + paramstSimpleMetaFeed);
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    {
      bmtd.a(((BasePluginActivity)paramActivity).getOutActivity(), paramString, paramInt, paramBundle, null);
      return;
    }
    bmtd.a(paramActivity, paramString, paramInt, paramBundle, null);
  }
  
  public static void a(Context paramContext, int paramInt1, stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt2)
  {
    uqf.b("GdtAdUtil", 2, "[onItemClick] action=" + paramInt1);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramstSimpleMetaFeed.optext = anzj.a(2131715134);
        ...
        locals_droplist_option.optext = anzj.a(2131715132);
        ...
        {
        case 131072: 
          uqf.b("GdtAdUtil", "invalid action, " + paramInt1);
          return;
        }
      }
  ...
  public static void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed, GdtAppReceiver paramGdtAppReceiver, ukz paramukz)
  {
    ...
    try
    {
      paramukz = new GdtHandler.Params();
      paramukz.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((Activity)paramContext);
      paramukz.jdField_a_of_type_ComTencentGdtadAditemGdtAd = new GdtAd(paramstSimpleMetaFeed);
      paramukz.jdField_a_of_type_Boolean = true;
      paramukz.jdField_a_of_type_Int = 8;
      paramukz.jdField_b_of_type_Int = 6;
      paramukz.jdField_b_of_type_Boolean = true;
      paramukz.jdField_c_of_type_Int = 7;
      paramukz.jdField_c_of_type_Boolean = false;
      paramukz.d = false;
      paramukz.e = false;
      paramukz.f = true;
      paramukz.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramGdtAppReceiver);
      paramukz.jdField_a_of_type_JavaLangClass = GdtVideoCeilingFragmentForJS.class;
      paramukz.jdField_b_of_type_JavaLangClass = GdtCanvasFragmentForArk.class;
      paramukz.jdField_a_of_type_AndroidOsBundle = new Bundle();
      paramukz.jdField_a_of_type_AndroidOsBundle.putString("big_brother_ref_source_key", "biz_src_gzh_weishi");
      GdtHandler.a(paramukz);
      return;
    }
  ...
  public static void a(Context paramContext, usv paramusv)
  {
    if ((paramusv != null) && ((paramusv.a() instanceof stSimpleMetaFeed)))
    {
      stSimpleMetaFeed localstSimpleMetaFeed = (stSimpleMetaFeed)paramusv.a();
      stSimpleMetaGdtAdInfo localstSimpleMetaGdtAdInfo = paramusv.a();
  ...
  public static boolean a(stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    for (;;)
    {
      ...
      {
        uqf.d("GdtAdUtil", "adInfo error" + paramstSimpleMetaFeed);
        bool3 = bool2;
      }
    }
  }
  ...
  private static void b(Context paramContext, usv paramusv)
  {
    paramContext = a(paramContext, paramusv);
