...
{
  public usw(DeviceSingleStructBuilder paramDeviceSingleStructBuilder) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      catch (JSONException paramView)
      {
        ...
        FMDialogUtil.a(this.a.jdField_a_of_type_AndroidContentContext, paramView, (CharSequence)localObject, new usx(this, localMessageForDeviceSingleStruct));
        continue;
