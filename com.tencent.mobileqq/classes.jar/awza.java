  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    localBundle.putString("file_send_path", awyz.a(this.a));
    ...
    do
    {
      ...
      paramView = "";
      if ((awyz.b(this.a) == null) || (awyz.b(this.a).equals(""))) {
        break label500;
      }
      localBundle.putString("struct_msg_video_info", awyz.b(this.a));
      ...
      try
      {
        localObject2 = new JSONObject(awyz.b(this.a));
      ...
      awqx.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005C9A", "0X8005C9A", 0, 1, 0, ((StructMsgForGeneralShare)localObject1).uin, ((StructMsgForGeneralShare)localObject1).currentAccountUin, awyz.a(this.a), paramView);
    ...
    try
    {
      ...
      paramView.put("net", String.valueOf(mpl.a()));
      paramView.put("mobile_imei", babp.a());
      paramView.put("obj", "");
      ...
      rsa.a((AppInterface)localObject2, ((StructMsgForGeneralShare)localObject1).message.selfuin, paramView.toString(), "" + ((StructMsgForGeneralShare)localObject1).msgId);
      return;
    }
