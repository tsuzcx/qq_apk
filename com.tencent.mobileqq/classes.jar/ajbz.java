  ...
  implements Comparator<PhoneContact>
{
  ...
  public ajbz(int[] paramArrayOfInt, Set<String> paramSet, anvk paramanvk)
  {
    this.jdField_a_of_type_ArrayOfInt = paramArrayOfInt;
    this.jdField_a_of_type_JavaUtilSet = paramSet;
    this.jdField_a_of_type_Anvk = paramanvk;
  }
  ...
  private int c(PhoneContact paramPhoneContact1, PhoneContact paramPhoneContact2)
  {
    ...
    boolean bool1 = this.jdField_a_of_type_Anvk.a(paramPhoneContact1.unifiedCode, true);
    boolean bool2 = this.jdField_a_of_type_Anvk.a(paramPhoneContact2.unifiedCode, true);
    if (bool1) {}
    for (;;)
    {
      return i;
