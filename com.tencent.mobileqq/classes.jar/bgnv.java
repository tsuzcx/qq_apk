...
public class bgnv
{
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (ShortVideoTrimmer.a(paramContext, 0, 0))
    {
      ...
      {
        i = j;
        if (((awmi)localObject).jdField_a_of_type_Boolean)
        {
          ...
          localObject = new bgnw(paramString2, (int)(((awmi)localObject).b * 1024L), (int)((awmi)localObject).jdField_a_of_type_Long);
          if ((!new awmx().a(localFile, (awmy)localObject, true)) || (((bgnw)localObject).a != null)) {
            break label339;
          }
          if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 293	bgnv:b	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 6
  ...
  public static JSONObject a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(paramAppRuntime.getAccount());; localObject = null)
    {
      ...
      localBundle.putString("bkn", String.valueOf(azlj.b((String)localObject)));
      try
      {
        paramString1 = new Bundle();
        paramString1.putString("Cookie", "uin=" + str + ";skey=" + (String)localObject);
        paramAppRuntime = new JSONObject(mpl.a(paramAppRuntime.getApplication().getApplicationContext(), "https://qun.qq.com/cgi-bin/grouphw/upload_auth/put", "GET", localBundle, paramString1));
  ...
  public static JSONObject b(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(paramAppRuntime.getAccount());; localObject = null)
    {
      ...
      try
      {
        paramString1 = new Bundle();
        paramString1.putString("Cookie", "uin=" + str + ";skey=" + (String)localObject);
        paramAppRuntime = new JSONObject(mpl.a(paramAppRuntime.getApplication().getApplicationContext(), "https://qun.qq.com/cgi-bin/grouphw/upload_append", "GET", localBundle, paramString1));
        return paramAppRuntime;
      }
      catch (IOException paramAppRuntime)
      {
