...
public class binh
  implements bikb<bijw>
{
  private final int jdField_a_of_type_Int = biqy.a(DoodleLayout.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  
  private binh(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(bijw parambijw, MotionEvent paramMotionEvent)
  {
    float f3 = paramMotionEvent.getX();
    float f4 = paramMotionEvent.getY();
    if (bjeh.b()) {}
    for (float f1 = bjeh.e;; f1 = 0.0F)
    {
      ...
      float f2 = f1;
      if (bepu.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext())) {
        f2 = f1 + bepu.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext());
      }
      ...
      case 6: 
        do
        {
          ...
          if (DoodleLayout.d(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) {
            biil.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
          }
          ...
          parambijw = this.jdField_a_of_type_AndroidGraphicsRect;
          parambijw.top -= this.jdField_a_of_type_Int;
          parambijw = this.jdField_a_of_type_AndroidGraphicsRect;
          parambijw.bottom += this.jdField_a_of_type_Int;
      ...
      DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout).a.a(Message.obtain(null, 17, 0, 0, new bifu(false, false, false, false, true)));
      return false;
    }
  }
}
