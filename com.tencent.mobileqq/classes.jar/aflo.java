  ...
  extends akat
{
  ...
  {
    if (this.a.jdField_a_of_type_Afji.a())
    {
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131720004);
      bcql.a(SystemMsgListView.a(this.a), 1, paramString, 0).b(this.a.a());
    }
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          bcql.a(SystemMsgListView.a(this.a), 1, paramString3, 0).b(this.a.a());
          ayde.a(localStructMsg, paramInt3, paramString2, paramString4);
          return;
          paramString3 = SystemMsgListView.a(this.a).getResources().getString(2131719262);
        }
      }
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131692782);
      bcql.a(SystemMsgListView.a(this.a), 2, paramString1, 0).b(this.a.a());
      long l2 = aydc.a().a();
      ayde.a(localStructMsg, paramInt1, paramString2, paramInt2);
      if ((l2 != 0L) && (localStructMsg != null)) {}
      try
      {
        this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsd.M, 0, l2, localStructMsg.toByteArray());
        ...
        if (atyv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(localStructMsg.req_uin.get()), localStructMsg, false))
        {
        ...
        AutoRemarkActivity.a(this.a.jdField_a_of_type_Afji.getActivity(), 0, String.valueOf(localStructMsg.req_uin.get()), l1, paramString3);
        return;
      }
      catch (Exception paramString1)
      {
