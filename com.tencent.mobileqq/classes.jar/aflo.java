...
{
  public aflo(NearbyProfileEditPanel paramNearbyProfileEditPanel) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(this.a.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131434827));
        return;
      }
    ...
    for (int i = ((cmd0xac5.MasterState)((cmd0xac5.NearbyNowData)this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nearbyNowData.get()).master_state.get()).uint32_state.get();; i = 0)
    {
      ...
      for (i = 1; (this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (bool3) && (i != 0); i = 0)
      {
        ...
        paramView.setPositiveButton("保存并重审", new aflp(this, paramView));
        paramView.setNegativeButton("取消", new aflq(this, paramView));
        paramView.show();
        return;
      }
      ...
      {
        paramView = this.a.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131437467, new Object[] { this.a.jdField_a_of_type_JavaLangString });
        ...
        paramView.setPositiveButton("完成编辑", new aflr(this, paramView));
        paramView.setNegativeButton("放弃编辑", new afls(this, paramView));
        paramView.show();
        return;
      }
      if ((bool1) && (bool2))
      {
        ...
        paramView.setPositiveButton("发布资料", new aflt(this, paramView));
        paramView.setNegativeButton("返回修改", new aflu(this, paramView));
        paramView.show();
