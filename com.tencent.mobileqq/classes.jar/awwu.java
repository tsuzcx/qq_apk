...
{
  public awwu(int paramInt, Resources paramResources)
  {
    super(awwv.a(paramInt, paramResources, a(paramResources)));
  }
  
  public static Bitmap a(Resources paramResources)
  {
    Paint localPaint = new Paint();
    localPaint.setColor(paramResources.getColor(2131166489));
