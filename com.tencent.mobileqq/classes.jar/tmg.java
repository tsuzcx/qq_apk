...
{
  public tmg(PublicAccountListActivity paramPublicAccountListActivity) {}
  
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = null;
    paramView = paramView.getTag();
    if ((paramView instanceof tms)) {}
    String str;
    do
    {
      paramAdapterView = ((tms)paramView).a;
      while (paramAdapterView == null)
      {
        ...
        return;
        if ((paramView instanceof tmt)) {
          paramAdapterView = ((tmt)paramView).a;
        }
      }
    ...
    paramView.putExtra("selfSet_leftViewText", this.a.getString(2131437791));
