...
public class adav
  implements alfm, alfn
{
  private int jdField_a_of_type_Int;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<JumpActivity> jdField_a_of_type_JavaLangRefWeakReference;
  
  public adav(JumpActivity paramJumpActivity, int paramInt, String paramString)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      akji localakji = (akji)localJumpActivity.app.getManager(153);
      ...
      localStartCheckParam.version = localakji.a(this.jdField_a_of_type_Int);
      ApolloGameUtil.a(localJumpActivity, localStartCheckParam);
      JumpActivity.a(localJumpActivity, true);
      localJumpActivity.a();
      return;
    }
    QQToast.a(BaseApplicationImpl.getApplication(), alpo.a(2131706292), 0).a();
  ...
  public void b(boolean paramBoolean)
  {
    ...
    localWebProcessManager.a(100, new adaw(this, localJumpActivity));
    return;
    QQToast.a(BaseApplicationImpl.getApplication(), alpo.a(2131706291), 0).a();
