...
public class woi
{
  ...
  public static <I> I a(Class<I> paramClass)
  {
    ...
    {
      ClassLoader localClassLoader = woi.class.getClassLoader();
      woj localwoj = new woj();
      return Proxy.newProxyInstance(localClassLoader, new Class[] { paramClass }, localwoj);
    }
  ...
  public static <T> T a(Class<T> paramClass, Object[] paramArrayOfObject)
  {
    ...
    for (int j = 0;; j = arrayOfClass1.length)
    {
      ...
      catch (InstantiationException paramArrayOfObject)
      {
        int k;
        Class[] arrayOfClass2;
        throw new IllegalStateException(paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + anzj.a(2131706555), paramArrayOfObject);
      }
      catch (IllegalAccessException paramArrayOfObject)
      {
        throw new IllegalStateException(paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + anzj.a(2131706556), paramArrayOfObject);
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        throw new IllegalStateException(anzj.a(2131706554) + paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + anzj.a(2131706557), localNoSuchMethodException);
        if (arrayOfClass2[i].isPrimitive()) {
          if (arrayOfClass1[i] == null)
          {
            i = 0;
      ...
      break label107;
      label300:
      yuk.e("NullableObjectFactoryImplement", "虽然不是直接匹配, 但是还是找到了" + paramClass.getName() + "(" + Arrays.toString(arrayOfClass1) + ")的构造函数");
      break;
      i = 1;
      break label131;
      label492:
