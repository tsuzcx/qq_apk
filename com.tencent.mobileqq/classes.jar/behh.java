...
public class behh
{
  ...
  public static void a(Activity paramActivity, String paramString, behm parambehm)
  {
    ...
    paramActivity = bhdj.a(paramActivity, 0, null, paramActivity.getString(2131718586), paramActivity.getString(2131690697), paramActivity.getString(2131691037), new behk(parambehm), new behl(parambehm));
    paramActivity.show();
    paramActivity.setCancelable(false);
    a("0X800A5C9");
  }
  
  public static void a(beip parambeip)
  {
    if (b()) {
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    String str = localBaseActivity.getString(2131718589);
    if (!paramBoolean1) {
      str = localBaseActivity.getString(2131718585);
    }
    paramString1 = bhdj.a(localBaseActivity, 0, null, str, localBaseActivity.getString(2131690697), localBaseActivity.getString(2131691037), new behi(paramBoolean1, paramBoolean2), new behj(paramString1, paramString2));
    paramString1.show();
  ...
  public static boolean a(Activity paramActivity, String paramString, behm parambehm)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing())) {}
    while (!b()) {
      return false;
    ...
    if ((paramActivity.getResources().getConfiguration().uiMode & 0x30) == 32)
    {
      ...
      a(paramActivity, paramString, parambehm);
    }
    for (;;)
    {
      return true;
      ...
      break;
      label141:
      ThreadManager.getUIHandler().post(new DarkModeManager.6(paramActivity, paramString, parambehm));
    }
  }
  ...
  private static void b(beip parambeip)
  {
    Object localObject;
    if (bdfk.b()) {
    ...
    for (;;)
    {
      ...
      ThemeSwitcher.a((String)localObject, "202", parambeip);
      return;
      localObject = beio.a(b());
  ...
  private static void b(boolean paramBoolean1, boolean paramBoolean2, beip parambeip)
  {
