...
public class behh
{
  public static final int a = begd.jdField_b_of_type_ArrayOfJavaLangString.length;
  ...
  public static final Drawable a(int paramInt, behi parambehi)
  {
    if (paramInt < 0) {
      throw new IllegalArgumentException("invaid emoji index: " + paramInt);
    }
    ...
    if (paramInt >= 1000)
    {
      ...
      ThreadManager.executeOnFileThread(new TextUtils.1(paramInt, parambehi));
      return null;
    }
    if ((paramInt >= 0) && (paramInt < begd.jdField_b_of_type_Int)) {}
    for (paramInt = 2130839808 + paramInt;; paramInt = 2130839942)
    {
      if (BaseApplicationImpl.sImageCache != null)
      {
        ...
        ThreadManager.executeOnFileThread(new TextUtils.2(paramInt, parambehi));
        return null;
      }
  ...
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramInt = bhjd.a((Drawable)localObject);
  ...
  public static final String a(int paramInt)
  {
    ...
    return String.valueOf(Character.toChars(begd.d[paramInt]));
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramString)
      {
        ...
        paramString[j] = 13;
        continue;
        paramString = asfa.a(paramString);
        if (paramString == null) {
          continue;
        }
      }
  ...
  public static final Drawable b(Resources paramResources, int paramInt)
  {
    ...
    //   58: aload_0
    //   59: areturn
    //   60: invokestatic 495	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   63: getstatic 499	befz:b	Ljava/lang/String;
    //   66: invokevirtual 502	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)Ljava/io/RandomAccessFile;
    //   69: astore 5
    //   71: iload_1
    //   72: sipush 1000
    //   75: isub
    ...
    //   81: aload 5
    //   83: lload_3
    //   84: invokevirtual 508	java/io/RandomAccessFile:seek	(J)V
    //   87: aload 5
    //   89: astore_0
    //   90: invokestatic 514	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   93: iconst_4
    //   94: invokevirtual 518	com/tencent/commonsdk/pool/ByteArrayPool:getBuf	(I)[B
    //   97: astore 6
    //   99: aload 5
    //   101: astore_0
    //   102: aload 5
    ...
    //   106: iconst_0
    //   107: iconst_4
    //   108: invokevirtual 522	java/io/RandomAccessFile:read	([BII)I
    //   111: pop
    //   112: aload 5
    //   114: astore_0
    //   115: aload 6
    //   117: invokestatic 525	befz:a	([B)I
    //   120: istore_2
    //   121: aload 5
    //   123: astore_0
    //   124: invokestatic 514	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   127: aload 6
    //   129: invokevirtual 529	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   132: aload 5
    //   134: astore_0
    //   135: invokestatic 321	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   138: ifeq +456 -> 594
    //   141: aload 5
    //   143: astore_0
    //   144: ldc_w 531
    ...
    //   168: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   171: goto +423 -> 594
    //   174: aload 5
    //   176: astore_0
    //   177: ldc_w 531
    ...
    //   201: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   204: aload 5
    //   206: ifnull +12 -> 218
    //   209: invokestatic 495	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   212: getstatic 499	befz:b	Ljava/lang/String;
    //   215: invokevirtual 540	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   218: aconst_null
    //   219: areturn
    //   220: aload 5
    //   222: astore_0
    //   223: invokestatic 514	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   226: sipush 4096
    //   229: invokevirtual 518	com/tencent/commonsdk/pool/ByteArrayPool:getBuf	(I)[B
    //   232: astore 6
    //   234: aload 5
    //   236: astore_0
    //   237: aload 6
    ...
    //   244: iconst_0
    //   245: iload_2
    //   246: invokevirtual 522	java/io/RandomAccessFile:read	([BII)I
    //   249: invokestatic 546	android/graphics/BitmapFactory:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   252: astore 6
    //   254: aload 5
    //   256: astore_0
    //   257: aload 6
    //   259: invokestatic 551	bhjx:a	(Landroid/graphics/Bitmap;)I
    //   262: istore_2
    //   263: aload 5
    //   265: astore_0
    //   266: invokestatic 321	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   269: ifeq +33 -> 302
    //   272: aload 5
    //   274: astore_0
    //   275: ldc_w 531
    ...
    //   299: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   302: iload_2
    //   303: ifle +154 -> 457
    //   306: aload 5
    //   308: astore_0
    //   309: new 555	android/graphics/drawable/BitmapDrawable
    //   312: dup
    //   313: aload 6
    //   315: invokespecial 558	android/graphics/drawable/BitmapDrawable:<init>	(Landroid/graphics/Bitmap;)V
    //   318: astore 6
    //   320: aload 5
    //   322: astore_0
    ...
    //   357: aload 5
    //   359: astore_0
    //   360: invokestatic 321	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   363: ifeq +33 -> 396
    //   366: aload 5
    //   368: astore_0
    //   369: ldc_w 531
    ...
    //   393: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   396: aload 5
    //   398: astore_0
    //   399: invokestatic 321	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   402: ifeq +35 -> 437
    //   405: aload 5
    //   407: astore_0
    //   408: ldc_w 531
    //   411: iconst_2
    //   412: invokestatic 565	agej:a	()Ljava/lang/StringBuilder;
    //   415: ldc_w 567
    ...
    //   434: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   437: aload 6
    //   439: astore_0
    //   440: aload 5
    //   442: ifnull -384 -> 58
    //   445: invokestatic 495	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   448: getstatic 499	befz:b	Ljava/lang/String;
    //   451: invokevirtual 540	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   454: aload 6
    //   456: areturn
    //   457: aload 5
    //   459: ifnull +12 -> 471
    //   462: invokestatic 495	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   465: getstatic 499	befz:b	Ljava/lang/String;
    //   468: invokevirtual 540	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   471: aconst_null
    //   472: areturn
    //   473: astore 6
    //   475: aconst_null
    ...
    //   478: aload 5
    //   480: astore_0
    //   481: invokestatic 321	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   484: ifeq +18 -> 502
    //   487: aload 5
    //   489: astore_0
    //   490: ldc_w 531
    ...
    //   494: ldc_w 571
    //   497: aload 6
    //   499: invokestatic 574	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   502: aload 5
    //   504: ifnonnull +9 -> 513
    //   507: aload 5
    //   509: astore_0
    //   510: invokestatic 576	begd:b	()V
    //   513: aload 5
    //   515: ifnull +12 -> 527
    //   518: invokestatic 495	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   521: getstatic 499	befz:b	Ljava/lang/String;
    //   524: invokevirtual 540	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   527: invokestatic 321	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   530: ifeq +32 -> 562
    //   533: ldc_w 531
    //   536: iconst_2
    //   537: invokestatic 565	agej:a	()Ljava/lang/StringBuilder;
    //   540: ldc_w 567
    ...
    //   559: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   562: aconst_null
    //   563: areturn
    //   564: astore 5
    //   566: aconst_null
    ...
    //   568: aload_0
    //   569: ifnull +12 -> 581
    //   572: invokestatic 495	com/tencent/mobileqq/utils/RandomAccessFileManager:a	()Lcom/tencent/mobileqq/utils/RandomAccessFileManager;
    //   575: getstatic 499	befz:b	Ljava/lang/String;
    //   578: invokevirtual 540	com/tencent/mobileqq/utils/RandomAccessFileManager:a	(Ljava/lang/String;)V
    //   581: aload 5
    //   583: athrow
    //   584: astore 5
    //   586: goto -18 -> 568
  ...
  public static String b(String paramString)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        k = paramString.indexOf(askx.a(i), 0);
        str1 = paramString;
        if (k != -1)
        {
          str1 = paramString;
          if (k + 2 <= paramString.length()) {
            str1 = paramString.replace(paramString.substring(k, k + 2), askx.a(i));
          }
        }
        i += 1;
        paramString = str1;
  ...
  {
    return String.valueOf(new char[] { '<', '$', (char)asle.a(paramInt), '>' });
  }
      ...
      catch (AccountNotMatchException localAccountNotMatchException)
      {
        for (;;)
        {
          try
          {
            ...
            localObject1 = (axfj)((AppInterface)localObject1).getManager(14);
            localStringBuilder = new StringBuilder(paramString);
            i = 0;
            if (i >= localStringBuilder.length()) {
              break label465;
  ...
  public static String e(String paramString)
  {
    ...
    while (i < a)
    {
      k = paramString.indexOf(begd.d[i], 0);
      localObject = paramString;
      if (k != -1)
      {
        ...
        catch (AccountNotMatchException paramString)
        {
          for (;;)
          {
            try
            {
              ...
              localObject = asle.a(m);
              if (k != 0) {
                break label647;
              }
              localObject = anzj.a(2131713686) + (String)localObject;
