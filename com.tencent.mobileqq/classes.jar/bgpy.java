...
public class bgpy
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramString2.putExtra("selfSet_leftViewText", anzj.a(2131712365));
    if (bipb.a.containsKey("robotsummary")) {
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt)
  {
    ...
    paramString5 = agej.a(new Intent(paramContext, SplashActivity.class), null);
    if (paramInt == 1)
    {
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", anzj.a(2131712367));
    if (bipb.a.containsKey("robotsummary")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    do
    {
      ...
      paramString1 = anzj.a(2131712366) + paramString2;
      localObject2 = new bdoi(StructMsgForGeneralShare.class).c(14).a(anzj.a(2131712369) + paramString3).a(2).a(1).a("web", paramQQAppInterface, (String)localObject2, (String)localObject1, (String)localObject1).d(paramActivity.getResources().getString(2131717391)).a();
      bdso localbdso = new bdso();
      localbdso.b(1);
      localbdso.a(anzj.a(2131712368));
      bdre localbdre = new bdre();
      localbdre.b(1);
      localbdre.a(new bdqo((String)localObject1));
      localbdre.a(new StructMsgItemTitle(paramString3));
      localbdre.a(new bdtj(paramString1));
      ((AbsShareMsg)localObject2).addItem(localbdso);
      ...
      auxu.a(paramActivity, (Intent)localObject2, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      bdll.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", paramString3, "");
      return;
    }
    catch (Exception paramString2)
    {
      bdll.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, "0", "", paramString3, "");
    }
  }
  ...
  public static void a(boolean paramBoolean, String paramString)
  {
    ...
    for (localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      ((bgty)localObject).a(paramBoolean, paramString);
      return;
    }
  }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    ((aoip)localQQAppInterface.a(20)).a(paramString1, paramString2, paramString3, Boolean.valueOf(paramBoolean));
    return true;
  }
  ...
  public static String b(String paramString)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return bhlg.a((QQAppInterface)localAppRuntime, paramString, false);
    }
    return null;
  }
