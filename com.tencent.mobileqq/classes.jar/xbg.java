  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject3 = (xbh)paramView.getTag();
    if (((xbh)localObject3).a.jdField_a_of_type_Boolean)
    {
      ...
      paramView.putExtra("filepath", this.a.e + ((xbh)localObject3).a.jdField_a_of_type_JavaLangString);
      paramView.putExtra("filename", "" + ((xbh)localObject3).a.jdField_a_of_type_JavaLangString);
      paramView.putExtra("nSessionId", this.a.jdField_b_of_type_Long);
      paramView.putExtra("isHttps", xbf.a(this.a));
      if (!TextUtils.isEmpty(xbf.a(this.a))) {
        paramView.putExtra("httpsDomain", xbf.a(this.a));
      }
      paramView.putExtra("httpsPort", xbf.a(this.a));
    ...
    localForwardFileInfo.b(((xbh)localObject3).a.jdField_b_of_type_Long);
    localForwardFileInfo.d(((xbh)localObject3).a.jdField_a_of_type_JavaLangString);
    localForwardFileInfo.d(((xbh)localObject3).a.jdField_a_of_type_Long);
    localForwardFileInfo.b("");
    Object localObject2;
    if (this.a.jdField_a_of_type_Long == 0L)
    {
      localObject2 = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      Object localObject4 = ((QQAppInterface)localObject2).a().b(((xbh)localObject3).a.jdField_b_of_type_Long);
      ...
      if (paramView != null)
      {
        ((xbh)localObject3).a.jdField_b_of_type_Long = paramView.nSessionId;
        paramView.isZipInnerFile = true;
      }
      localForwardFileInfo.b(((xbh)localObject3).a.jdField_b_of_type_Long);
      if (localForwardFileInfo.d() == 0L)
      {
        aptx.a(ajya.a(2131717055));
        return;
      }
      ...
      {
        apqk localapqk = (apqk)((Iterator)localObject4).next();
        if ((apug.a(localapqk.jdField_a_of_type_JavaLangString) == 0) && (localapqk.jdField_a_of_type_Long != 0L))
        {
          FileManagerEntity localFileManagerEntity = ((QQAppInterface)localObject2).a().b(localapqk.jdField_b_of_type_Long);
          ...
          if (paramView != null)
          {
            ...
            localapqk.jdField_b_of_type_Long = paramView.nSessionId;
          }
          ((ArrayList)localObject3).add(Long.valueOf(localapqk.jdField_b_of_type_Long));
        }
      }
    ...
    {
      localObject2 = (apqk)((Iterator)localObject1).next();
      if (apug.a(((apqk)localObject2).jdField_a_of_type_JavaLangString) == 0) {
        paramView.add(Long.valueOf(((apqk)localObject2).jdField_b_of_type_Long));
      }
    }
