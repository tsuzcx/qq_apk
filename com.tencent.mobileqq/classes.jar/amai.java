...
{
  static ArrayList<amar> jdField_a_of_type_JavaUtilArrayList;
  ...
  public amai(QQAppInterface paramQQAppInterface)
  {
  ...
  public static amat a(byte[] paramArrayOfByte)
  {
    ...
    localamat.jdField_a_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    System.arraycopy(paramArrayOfByte, 2, arrayOfByte3, 0, 8);
    localamat.jdField_a_of_type_Long = lfx.b(arrayOfByte3, 8);
    localamat.jdField_b_of_type_Int = lfx.a(paramArrayOfByte[10]);
    int j = localamat.jdField_b_of_type_Int + 11;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localamat.jdField_b_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localamat.jdField_c_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte3, 0, 8);
    localamat.jdField_d_of_type_Long = lfx.b(arrayOfByte3, 8);
    j += 8;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localamat.jdField_c_of_type_Int = lfx.a(arrayOfByte2, 4);
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localamat.jdField_d_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    j += 2;
    localamat.jdField_e_of_type_Int = lfx.a(paramArrayOfByte[j]);
    j += 1;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localamat.jdField_e_of_type_Long = lfx.a(arrayOfByte2, 4);
    j += localamat.jdField_e_of_type_Int;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localamat.jdField_f_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    j = j + 2 + localamat.jdField_f_of_type_Int * 8;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localamat.jdField_f_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localamat.jdField_g_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    j += 2;
    if ((localamat.jdField_g_of_type_Int >= 16) && (localamat.jdField_g_of_type_Int + j <= i))
    {
      System.arraycopy(paramArrayOfByte, j + 9, arrayOfByte1, 0, 2);
      i = lfx.a(lfx.a(arrayOfByte1, 2)) + 11;
      if (localamat.jdField_d_of_type_Int != 3) {
        break label414;
      }
    }
    for (;;)
    {
      i = localamat.jdField_g_of_type_Int;
      return localamat;
      label414:
      localamat.h = lfx.a(paramArrayOfByte[(j + i)]);
      i += 1;
      if (i + 4 <= localamat.jdField_g_of_type_Int)
      {
        System.arraycopy(paramArrayOfByte, j + i, arrayOfByte2, 0, 4);
        localamat.jdField_g_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
      }
    }
  }
  ...
  private void j(byte[] paramArrayOfByte)
  {
    ...
    if ((j == 1) && (i == 2))
    {
      new bipv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new amap(this, paramArrayOfByte));
      return;
    }
    new maf((Context)localObject).a(new amaq(this, paramArrayOfByte));
  }
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long[] paramArrayOfLong, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 2) && (paramInt1 == 1) && (((bcqa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(164)).a(paramString) == 1)) {
  ...
  void a(long paramLong, int paramInt, byte paramByte)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), azcj.class);
  ...
  public void a(byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    ...
    do
    {
      ...
      amat localamat = a(paramArrayOfByte);
      i = localamat.jdField_d_of_type_Int;
      l1 = localamat.jdField_d_of_type_Long;
      l2 = localamat.jdField_e_of_type_Long;
      j = localamat.jdField_c_of_type_Int;
      l3 = localamat.jdField_f_of_type_Long;
      l4 = localamat.jdField_g_of_type_Long;
      str = Long.toString(l2);
      localObject = Long.toString(l1);
      if (QLog.isColorLevel()) {
        QLog.d("QQGAudioMsgHandler", 2, "GAudioOfflineMsg relationShip[" + i + "], groupUin[" + str + "], inviteUin[" + l1 + "], subCmd0x8DMsg[" + localamat + "]");
      }
      if (1 == i)
      {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      jdField_a_of_type_JavaUtilArrayList.add(new amar(paramMsg, Long.valueOf(paramArrayOfByte).longValue(), l2));
      ...
      return;
      label470:
      paramMsg = (axap)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38);
      ...
      ((bcqa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(164)).a(l2);
  ...
  void b(long paramLong)
  {
    ...
    ((alri)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(paramLong);
  ...
  public void b(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      if ((jdField_a_of_type_JavaUtilArrayList != null) && (!jdField_a_of_type_JavaUtilArrayList.isEmpty()))
      {
        ...
        {
          paramArrayOfByte = (amar)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    ...
    do
    {
      do
      {
        do
        {
          ...
          while (paramInt < jdField_a_of_type_JavaUtilArrayList.size())
          {
            localObject = (amar)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
            if ((localObject != null) && (((amar)localObject).jdField_a_of_type_Long == l1) && (((amar)localObject).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))) {
              paramArrayOfByte.add(localObject);
            }
            paramInt += 1;
          }
          Collections.sort(paramArrayOfByte, new amas());
          paramInt = 0;
          while (paramInt < paramArrayOfByte.size() - 1)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QQGAudioMsgHandler", 2, "onRecvMultiVideoC2SACK_0x31-retCode->list =" + ((amar)paramArrayOfByte.get(paramInt)).jdField_b_of_type_Long);
            }
            localObject = (amar)paramArrayOfByte.get(paramInt);
            arrayOfByte1 = new byte[8];
            arrayOfByte2 = ((im_msg_body.MsgBody)((amar)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
            System.arraycopy(arrayOfByte2, (arrayOfByte2[10] & 0xFF) + 19, arrayOfByte1, 0, 8);
            l2 = lfx.b(arrayOfByte1, 8);
            VideoMsgTools.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, 6, true, Long.toString(l1), Long.toString(l2), false, null, false, new Object[] { ((amar)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg });
            paramInt += 1;
          }
        } while (paramArrayOfByte.size() <= 0);
        paramArrayOfByte = ((im_msg_body.MsgBody)((amar)paramArrayOfByte.get(paramArrayOfByte.size() - 1)).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
      } while (this.jdField_a_of_type_ArrayOfByte == null);
    ...
    do
    {
      ...
      if (n > 0)
      {
        ...
        while (j < n)
        {
          ...
          mtz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l), new amaj(this, l, i));
          j += 1;
        }
      }
  ...
  void f(byte[] paramArrayOfByte)
  {
    ...
    if (k == 2)
    {
      ...
      ((alri)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).b(l2);
      if (this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter != null) {
        this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter.a(7, 2, l2, new long[] { l1 }, 1L);
      }
      paramArrayOfByte = Long.toString(l2);
      localObject = Long.toString(l1);
      ((axap)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38)).a(0, l2, (String)localObject, "");
    ...
    while ((k == 1) && (i == 2))
    {
      new bipv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new amak(this));
      return;
      if ((k == 1) && (i == 10))
      {
        localObject = new byte[4];
    ...
    new maf(BaseApplication.getContext()).a(new amal(this));
  }
  ...
  void g(byte[] paramArrayOfByte)
  {
    ...
    mtz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), new amam(this, l2, j, l1));
  }
  ...
  void h(byte[] paramArrayOfByte)
  {
    ...
    ((alri)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).b(l);
