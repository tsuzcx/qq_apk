  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.tencent.device.ble.ACTION_GATT_CONNECTED".equals(paramContext)) {
      aabm.a().a(null, "Net_Bind_BLE_Connect", 0);
    }
    do
    {
      int i;
        ...
        do
        {
          do
          {
            ...
            if (paramContext != null)
            {
              ...
              zok.b(this.a).remove(paramContext);
              if (this.a.jdField_a_of_type_Zuy == paramContext) {
                this.a.jdField_a_of_type_Zuy = null;
              }
              zok.a(this.a).remove(paramContext);
              zok.a(this.a, i);
