...
public class afut
{
  private static volatile afut jdField_a_of_type_Afut;
  public static final String a;
  public static final String b;
  public static final String c = jdField_a_of_type_JavaLangString + "eggs_wrapper.xml";
  private ArrayList<afuw> jdField_a_of_type_JavaUtilArrayList;
  ...
  {
    if (jdField_a_of_type_Afut == null) {}
    try
    {
      if (jdField_a_of_type_Afut == null) {
        jdField_a_of_type_Afut = new afut();
      }
      return jdField_a_of_type_Afut;
    }
    finally {}
  }
  
  @Nullable
  private afuw a(ArrayList<afuw> paramArrayList, int paramInt)
  {
    if ((paramInt < 0) || (bhfc.a(paramArrayList))) {
      return null;
    }
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (localafuw.jdField_b_of_type_Int == paramInt) {
        return localafuw;
      }
    }
    return null;
  ...
  private ArrayList<afuw> a(XmlPullParser paramXmlPullParser)
  {
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        if (str1.equalsIgnoreCase("Item"))
        {
          ...
          localObject1 = new afuw();
          ((afuw)localObject1).jdField_b_of_type_Int = Integer.valueOf((String)localObject3).intValue();
        ...
        for (;;)
        {
          ...
          if (str1.equalsIgnoreCase("BusinessItem"))
          {
            localObject3 = paramXmlPullParser.getAttributeValue(null, "id");
            localObject1 = new afuw();
            ((afuw)localObject1).jdField_b_of_type_Int = Integer.parseInt((String)localObject3);
            ((afuw)localObject1).jdField_a_of_type_Int = 1;
            localObject3 = localObject2;
          }
    ...
    for (;;)
    {
      ...
      localObject1 = new afuy();
      if (str1 != null) {
        ((afuy)localObject1).c = afuy.a(str1);
      }
      ((afuy)localObject1).jdField_a_of_type_JavaLangString = str2;
      if (localObject4 != null)
      {
      ...
      localObject4.jdField_a_of_type_Afux = new afux();
      ...
      localObject4.jdField_a_of_type_Afux.jdField_a_of_type_Int = Integer.parseInt((String)localObject1);
      localObject4.jdField_a_of_type_Afux.jdField_b_of_type_Int = Integer.parseInt((String)localObject3);
      localObject4.jdField_a_of_type_Afux.c = Integer.parseInt(str1);
      localObject4.jdField_a_of_type_Afux.e = Integer.parseInt(str3);
      localObject4.jdField_a_of_type_Afux.d = Integer.parseInt(str2);
      localObject1 = localObject4;
      localObject3 = localObject2;
      break;
      localObject1 = localObject4;
  ...
  private void a(XmlPullParser paramXmlPullParser, ArrayList<afuw> paramArrayList)
  {
    if (paramXmlPullParser == null) {}
    long l1;
    long l2;
            ...
            if (((String)localObject5).equalsIgnoreCase("JumpType"))
            {
              ...
              if (k == 3)
              {
                ...
                if (paramXmlPullParser.getName().equalsIgnoreCase("Item"))
                {
                  ...
                  {
                    ((afuw)localObject5).jdField_a_of_type_JavaLangString = ((String)localObject3);
                    ((afuw)localObject5).a(n);
                    ((afuw)localObject5).jdField_b_of_type_JavaLangString = ((String)localObject4);
                    localObject1 = localObject4;
                    i = n;
                    localObject2 = localObject3;
                    m = j;
  ...
  private boolean a(String paramString)
  {
    ...
    //   165: aload_0
    //   166: aload_2
    //   167: invokespecial 329	afut:a	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/ArrayList;
    //   170: astore_2
    //   171: aload_1
    //   172: ifnull +7 -> 179
    //   175: aload_1
    ...
    //   183: aload_0
    //   184: aload_2
    //   185: putfield 333	afut:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   188: aload_0
    //   189: getstatic 61	afut:c	Ljava/lang/String;
    //   192: aload_0
    //   193: getfield 333	afut:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   196: invokespecial 336	afut:a	(Ljava/lang/String;Ljava/util/ArrayList;)Z
    //   199: pop
    //   200: iconst_1
    //   201: ireturn
    //   202: astore_3
    ...
    //   206: aload_1
    //   207: astore_2
    //   208: invokestatic 229	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   211: ifeq +15 -> 226
    //   214: aload_1
    //   215: astore_2
    //   216: ldc 231
    ...
    //   219: ldc_w 338
    //   222: aload_3
    //   223: invokestatic 341	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   226: aload_1
    //   227: ifnull -134 -> 93
    //   230: aload_1
    //   231: invokevirtual 332	java/io/FileInputStream:close	()V
    //   234: iconst_0
    //   235: ireturn
    //   236: astore_1
    //   237: iconst_0
  ...
  /* Error */
  private boolean a(String paramString, ArrayList<afuw> paramArrayList)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   159: aload_3
    //   160: aload_2
    //   161: invokespecial 352	afut:a	(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/ArrayList;)V
    //   164: aload_1
    ...
    //   0	253	2	paramArrayList	ArrayList<afuw>
