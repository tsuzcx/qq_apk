  ...
  extends aopw<aorl>
{
  ...
  @NonNull
  public aorl a(aogf[] paramArrayOfaogf)
  {
    int j = -1;
    ...
    if (i < m)
    {
      ...
      int k = localaogf.jdField_a_of_type_Int;
      if (k < j) {
        wsv.e("QVipStickerProcessor", "received old task id " + k + ", latest task id: " + j);
      }
      for (;;)
      {
        i += 1;
        ...
        try
        {
          JSONObject localJSONObject = new JSONObject(new String(localaogf.jdField_a_of_type_JavaLangString.getBytes("utf-8")));
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          ...
          wsv.e("QVipStickerProcessor", "item.content=" + localaogf.jdField_a_of_type_JavaLangString + " e=" + localUnsupportedEncodingException);
        }
        catch (JSONException localJSONException)
        {
          localJSONException.printStackTrace();
          wsv.e("QVipStickerProcessor", "item.content=" + localaogf.jdField_a_of_type_JavaLangString + " e=" + localJSONException);
        }
      }
    }
    return new aorl();
