...
public class aorm
{
  ...
  private aorp jdField_a_of_type_Aorp;
  ...
  private boolean a(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      Resources localResources = new Resources(localAssetManager, this.jdField_a_of_type_Aorp.b().getDisplayMetrics(), this.jdField_a_of_type_Aorp.b().getConfiguration());
      ...
      {
        this.jdField_a_of_type_Aorp.a(localResources, paramContext);
  ...
  private void e(Context paramContext)
  {
    try
    {
      ...
      ((Field)localObject2).set(paramContext, this.jdField_a_of_type_Aorl);
      QLog.d("MultiLanguageEngine", 1, new Object[] { "success in delegate ContextImpl resources:", this.jdField_a_of_type_Aorl.toString(), " ,old:", localObject3.toString() });
      ...
      ((Field)localObject1).set(paramContext, this.jdField_a_of_type_Aorl);
      QLog.d("MultiLanguageEngine", 1, new Object[] { "success in delegate LoadedApk resources:", this.jdField_a_of_type_Aorl.toString(), " ,old:", localObject2.toString(), " ,cost:", Long.valueOf(System.currentTimeMillis() - l) });
      return;
    }
    catch (Exception paramContext)
    {
  ...
  public void a(Activity paramActivity)
  {
    ...
    do
    {
      return;
      l = System.currentTimeMillis();
      LayoutInflater.from(paramActivity).setFactory2(new aoro(paramActivity));
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Aorp = new aorp(paramContext);
    this.jdField_a_of_type_Aorl = new aorl(this.jdField_a_of_type_Aorp);
    e(paramContext);
  }
  ...
  public void b(Context paramContext)
  {
    ...
    while (this.jdField_a_of_type_Aorp == null) {
      return;
    }
    this.jdField_a_of_type_Aorp.a(null, null);
  }
