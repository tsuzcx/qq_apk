  ...
  extends bcvt
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    float f;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bcyd)))
    {
      localObject1 = (bcyd)paramView.getTag();
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = ((bcvs)localObject3).jdField_a_of_type_JavaLangString;
        if ("title".equals(localObject4))
        {
          ...
          for (;;)
          {
            ((StructMsgItemTitle)localObject3).a(paramContext, ((bcyd)localObject1).b, paramBundle);
            break;
            ((StructMsgItemTitle)localObject3).c(String.valueOf(36));
          }
        }
        if ("pavideo".equals(localObject4)) {
          ((bcvs)localObject3).a(paramContext, ((bcyd)localObject1).a, paramBundle);
        }
      }
      if ((localObject1 != null) && (((bcyd)localObject1).b != null)) {
        ((TextView)((bcyd)localObject1).b).setMaxLines(2);
      }
      return paramView;
    }
    Object localObject2 = new RelativeLayout(paramContext);
    int i = (int)((BaseChatItemLayout.b - afur.a(46.0F, (Resources)localObject4)) / 1.8D) + afur.a(30.0F, (Resources)localObject4);
    ((RelativeLayout)localObject2).setLayoutParams(new RelativeLayout.LayoutParams(-1, i));
    int j = afur.a(15.0F, (Resources)localObject4);
    ((RelativeLayout)localObject2).setPadding(j, j, j, j);
    Object localObject3 = new bcyd();
    ...
    {
      localbcvs = (bcvs)((Iterator)localObject5).next();
      localbcvs.jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      str = localbcvs.jdField_a_of_type_JavaLangString;
      if ("title".equals(str))
      {
        localObject1 = (StructMsgItemTitle)localbcvs;
    ...
    for (;;)
    {
      ...
      {
        paramView = localbcvs.a(paramContext, null, paramBundle);
        ...
        i = (int)(i * 0.32D);
        paramBundle.setBackgroundResource(2130841739);
        ...
        if (localObject1 != null)
        {
          ...
          paramBundle.bottomMargin = afur.a(11.5F, (Resources)localObject4);
          paramBundle.leftMargin = afur.a(20.0F, (Resources)localObject4);
          paramBundle.rightMargin = afur.a(20.0F, (Resources)localObject4);
          ((RelativeLayout)localObject2).addView((View)localObject1, paramBundle);
        }
        paramBundle = new RelativeLayout.LayoutParams(afur.a(52.5F, (Resources)localObject4), afur.a(52.5F, (Resources)localObject4));
        paramBundle.addRule(15, -1);
        paramContext = new ImageView(paramContext);
        paramContext.setImageResource(2130841666);
        ...
        if (paramView != null) {
          ((bcyd)localObject3).a = paramView;
        }
        if (localObject1 != null)
        {
          ((bcyd)localObject3).b = ((View)localObject1);
          ((TextView)((bcyd)localObject3).b).setMaxLines(1);
        }
