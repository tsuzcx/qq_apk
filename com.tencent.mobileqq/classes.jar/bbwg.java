...
public class bbwg
{
  ...
  public String a;
  ArrayList<bbwg> jdField_a_of_type_JavaUtilArrayList;
  ...
  public bbwg(String paramString, File paramFile)
  {
    ...
    this.jdField_a_of_type_Bbwh = new bbwh();
  ...
  public bbwg(List<String> paramList, Map<String, File> paramMap, String paramString)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 3;
    this.jdField_a_of_type_Float = 0.0F;
  ...
  public bbwf a()
  {
    return this.jdField_a_of_type_Bbwf;
  }
  ...
  public void a(bbwg parambbwg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DownloadTask", 2, "DownloadTask.addDuplicateListenerTask,task.key=" + parambbwg.jdField_a_of_type_JavaLangString);
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList.size() < 5) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambbwg);
      }
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            bbwg localbbwg = (bbwg)this.jdField_a_of_type_JavaUtilArrayList.get(i1);
            if ((localbbwg == null) || (localbbwg.a() == null)) {
              break label135;
            }
            localbbwg.a(a());
            localbbwg.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbbwg.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbbwg.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
            localbbwg.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
            localbbwg.a().onProgress(localbbwg);
          }
        }
      }
      return;
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            ...
            localbbwg.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbbwg.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbbwg.a().onCancel(localbbwg);
          }
        }
      }
      return;
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            ...
            localbbwg.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbbwg.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbbwg.a().onDoneFile(localbbwg);
          }
        }
      }
      return;
  ...
  {
    return ((paramObject instanceof bbwg)) && (((bbwg)paramObject).jdField_a_of_type_JavaUtilList.equals(this.jdField_a_of_type_JavaUtilList));
  }
