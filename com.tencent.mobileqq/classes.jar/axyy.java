  ...
  implements acwb
{
  ...
  String V;
  public String W;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new axyz(this);
  public ViewGroup a;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axza(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    Object localObject;
    if ((paramView != null) && ((paramView.getTag() instanceof axzc)))
    {
      localObject = (axzc)paramView.getTag();
      ((axzc)localObject).c.clearAnimation();
      ((TextView)((axzc)localObject).d).setText(String.valueOf(this.l) + "''");
    }
    for (;;)
    {
      int i;
      ...
      try
      {
        paramBundle = localResources.getDrawable(2130841293);
        if (TextUtils.isEmpty(this.S))
        {
          ((AnyScaleTypeImageView)((axzc)localObject).jdField_a_of_type_AndroidViewView).setBackgroundDrawable(paramBundle);
          if (TextUtils.isEmpty(this.S)) {
            continue;
          }
          if (paramView.findViewById(97) == null)
          {
            ...
            paramContext.setBackgroundResource(2130841308);
          ...
          paramView.jdField_a_of_type_JavaLangString = aytd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.V);
      ...
      catch (OutOfMemoryError paramBundle)
      {
        ...
        if ((ayoi.b(this.S)) || (!aywm.a(paramContext)))
        {
          ...
          {
            ((AnyScaleTypeImageView)((axzc)localObject).jdField_a_of_type_AndroidViewView).setBackgroundDrawable(null);
            ((AnyScaleTypeImageView)((axzc)localObject).jdField_a_of_type_AndroidViewView).setBackgroundDrawable(paramBundle);
          }
        }
        else
        ...
        ((AnyScaleTypeImageView)((axzc)localObject).jdField_a_of_type_AndroidViewView).setURLDrawableDownListener(this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter);
        ((axzc)localObject).jdField_a_of_type_AndroidViewView.setBackgroundColor(15790320);
        continue;
      ...
      paramBundle.jdField_a_of_type_AndroidViewView.setContentDescription(localResources.getString(2131694747));
      ((AnyScaleTypeImageView)paramBundle.jdField_a_of_type_AndroidViewView).setDisplayRuleDef(bclf.a);
      ((AnyScaleTypeImageView)paramBundle.jdField_a_of_type_AndroidViewView).setScaleType(ImageView.ScaleType.CENTER_INSIDE);
      try
      {
        paramView = localResources.getDrawable(2130841293);
        if (TextUtils.isEmpty(this.S))
        {
          ...
          paramBundle.b.setBackgroundResource(2130841299);
          paramBundle.c = new ImageView(paramContext);
          paramBundle.c.setId(98);
          paramBundle.c.setBackgroundResource(2130841342);
          ...
          paramContext = new RelativeLayout.LayoutParams(actj.a(12.0F, localResources), actj.a(20.0F, localResources));
          paramContext.addRule(9, -1);
          paramContext.setMargins(actj.a(20.0F, localResources), 0, 0, 0);
          paramContext.addRule(15, -1);
          ((RelativeLayout)localObject).addView(paramBundle.b, paramContext);
          paramContext = new RelativeLayout.LayoutParams(actj.a(14.0F, localResources), actj.a(20.0F, localResources));
          paramContext.setMargins(actj.a(5.0F, localResources), 0, 0, 0);
          paramContext.addRule(15, -1);
          paramContext.addRule(1, paramBundle.b.getId());
          ((RelativeLayout)localObject).addView(paramBundle.c, paramContext);
          paramContext = new RelativeLayout.LayoutParams(-2, -2);
          paramContext.setMargins(actj.a(15.0F, localResources), 0, 0, 0);
          paramContext.addRule(15, -1);
  ...
  {
    if ((paramayqo.jdField_b_of_type_Int != 33) || (paramInt1 == 2002) || (paramInt1 == 2001)) {}
  ...
  void a(String paramString, View paramView)
  {
    if (asel.a().d())
    {
      ...
      bbdj.a(paramString, 232, null, paramString.getString(2131692321), new axzb(this), null).show();
      b();
      return;
    }
    acvz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramView, this);
    ...
    for (;;)
    {
      try
      {
        ...
        ((aywc)localObject).jdField_c_of_type_JavaLangString = paramString;
        ((aywc)localObject).jdField_a_of_type_Int = 1008;
        ((aywc)localObject).jdField_b_of_type_Int = 33;
        ((aywc)localObject).jdField_a_of_type_Long = paramView.uniseq;
        ((aywc)localObject).jdField_a_of_type_Boolean = false;
        ((aywc)localObject).e = ((MessageForPtt)paramView).urlAtServer;
        ((aywc)localObject).h = ((MessageForPtt)paramView).getLocalFilePath();
      ...
      ((aywc)localObject).jdField_b_of_type_Boolean = bool;
      ((aywc)localObject).f = ((MessageForPtt)paramView).md5;
      ((aywc)localObject).jdField_c_of_type_Long = ((MessageForPtt)paramView).groupFileID;
      ((aywc)localObject).g = ((MessageForPtt)paramView).groupFileKeyStr;
      ((aywc)localObject).d = ((MessageForPtt)paramView).subVersion;
      ((aywc)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramView;
      ((aywc)localObject).jdField_a_of_type_JavaLangObject = new aywh(1, 0);
  ...
  public boolean a(axwg paramaxwg)
  {
    ...
    this.k = Integer.parseInt(paramaxwg.a("busitype"));
    this.l = Integer.parseInt(paramaxwg.a("duration"));
    this.T = paramaxwg.a("md5");
    this.U = paramaxwg.a("filename");
    this.m = Integer.parseInt(paramaxwg.a("filesize"));
    this.V = paramaxwg.a("uuid");
    return true;
  }
  ...
  void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130841299);
    ...
    this.b.setBackgroundResource(2130841342);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager.a(((acva)actj.a(this.jdField_a_of_type_AndroidViewViewGroup)).a);
    this.b.clearAnimation();
    this.b.setBackgroundResource(2130772117);
    ((AnimationDrawable)this.b.getBackground()).start();
  }
  ...
  public void d()
  {
    ...
    if (((acva)actj.a(this.jdField_a_of_type_AndroidViewViewGroup)).a.equals(localMediaPlayerManager.a())) {
