...
{
  public axyy(ShortVideoCommentsView paramShortVideoCommentsView) {}
  
  public void afterTextChanged(Editable paramEditable)
  {
    if (ShortVideoCommentsView.a(this.a) == null) {}
    while (axxr.a(paramEditable.toString()) <= 140) {
      return;
    }
    int j = Selection.getSelectionEnd(paramEditable);
    paramEditable = axxr.a(paramEditable.toString(), 0, 140).toString();
