...
public class pap
{
  ...
  {
    long l = ((Long)bmhv.a("family_comment_card_hide_timestamp", Long.valueOf(-1L))).longValue();
    if (l == -1L)
    {
  ...
  public ReadInJoyCommentListFragment a(String paramString, pbg parampbg, pat parampat)
  {
    ...
    try
    {
      ...
      localReadInJoyCommentListFragment.a(parampbg);
      localReadInJoyCommentListFragment.a(parampat);
