...
public class biak
{
  ...
  protected static HttpURLConnection a(bial parambial)
  {
    for (;;)
    {
      try
      {
        localObject1 = MsfSdkUtils.insertMtype("yingyongbao", parambial.jdField_b_of_type_JavaLangString);
        if (bhzh.a(bhpc.a().a()))
        {
          i = "http://".length();
          localObject3 = bhzh.c(bhpc.a().a());
          String str = bhzh.d(bhpc.a().a());
          j = ((String)localObject1).indexOf('/', i);
          if (j < 0)
          {
            localObject2 = ((String)localObject1).substring(i);
            localObject1 = "";
            bhzm.c(jdField_a_of_type_JavaLangString, "https://" + (String)localObject3 + ":" + str + (String)localObject1);
            localObject3 = (HttpURLConnection)new URL("http://" + (String)localObject3 + ":" + str + (String)localObject1).openConnection();
            localObject1 = localObject3;
          }
        }
      }
      catch (Exception parambial)
      {
        int j;
        Object localObject2;
        localObject3 = null;
        bhzm.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- Exception!!!", parambial);
      ...
      try
      {
        ...
        if (parambial.jdField_c_of_type_Long > 0L)
        {
          ...
          localObject3 = localObject1;
          ((HttpURLConnection)localObject1).setRequestProperty("If-Modified-Since", ((SimpleDateFormat)localObject2).format(new Date(parambial.jdField_c_of_type_Long)));
        }
        localObject3 = localObject1;
        i = ((HttpURLConnection)localObject1).getResponseCode();
        localObject3 = localObject1;
        bhzm.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- reponseCode=" + i);
        if ((i == 302) || (i == 301))
        {
          localObject3 = localObject1;
          parambial = ((HttpURLConnection)localObject1).getHeaderField("Location");
          localObject3 = localObject1;
          bhzm.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- loc=" + parambial);
          localObject3 = localObject1;
          a((HttpURLConnection)localObject1);
          parambial = null;
          localObject1 = parambial;
          bhzm.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- uc=" + parambial);
          return parambial;
      ...
      if (localObject2 != null)
      {
        ...
        parambial.jdField_a_of_type_Long = (a((HttpURLConnection)localObject2) * 1000L);
        localObject3 = localObject2;
      ...
      {
        localObject3 = localObject1;
        bhzm.c(jdField_a_of_type_JavaLangString, "--getimg-- " + parambial.jdField_b_of_type_JavaLangString + " not modified");
        localObject3 = localObject1;
        parambial.jdField_a_of_type_Long = (a((HttpURLConnection)localObject1) * 1000L);
        localObject3 = localObject1;
        parambial.jdField_b_of_type_Long = System.currentTimeMillis();
        localObject3 = localObject1;
        a((HttpURLConnection)localObject1);
  ...
  /* Error */
  public static boolean a(bial parambial)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   7: istore 4
    //   9: aload_0
    //   10: invokestatic 276	biak:a	(Lbial;)Ljava/net/HttpURLConnection;
    //   13: astore 7
    //   15: aload 7
    //   17: ifnonnull +88 -> 105
    //   20: getstatic 14	biak:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   36: aload_0
    //   37: getfield 72	bial:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   52: invokestatic 133	bhzm:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   55: iconst_0
    //   56: ifeq +11 -> 67
    ...
    //   110: i2l
    //   111: lstore 5
    //   113: invokestatic 293	bhwr:a	()J
    //   116: lload 5
    //   118: lcmp
    //   119: ifge +85 -> 204
    //   122: getstatic 14	biak:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 72	bial:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: invokestatic 133	bhzm:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   157: iconst_0
    //   158: ifeq +11 -> 169
    ...
    //   211: lconst_0
    //   212: lstore 5
    //   214: getstatic 16	biak:jdField_a_of_type_Int	I
    //   217: newarray byte
    //   219: astore 9
    ...
    //   232: aload 9
    //   234: iconst_0
    //   235: getstatic 16	biak:jdField_a_of_type_Int	I
    //   238: invokevirtual 308	java/io/InputStream:read	([BII)I
    //   241: istore_1
    //   242: iload_1
    //   243: ifle +79 -> 322
    //   246: getstatic 19	biak:b	I
    //   249: istore_2
    //   250: lload 5
    //   252: iload_2
    //   253: i2l
    ...
    //   329: invokestatic 318	bhwr:e	()Ljava/lang/String;
    ...
    //   341: aload_0
    //   342: getfield 323	bial:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   354: aload_0
    //   355: getfield 72	bial:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   358: invokestatic 332	bhzj:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   525: ldc_w 374
    //   528: aload_0
    //   529: getfield 375	bial:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   532: invokestatic 133	bhzm:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   535: aload_0
    //   536: aload 7
    //   538: invokevirtual 378	java/net/HttpURLConnection:getLastModified	()J
    //   541: putfield 171	bial:jdField_c_of_type_Long	J
    //   544: iconst_1
    //   545: istore_3
    //   546: aload 9
    //   548: ifnull +8 -> 556
    ...
    //   596: aconst_null
    //   597: astore 8
    //   599: getstatic 14	biak:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   602: ldc_w 381
    //   605: aload 9
    //   607: invokestatic 270	bhzm:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   610: aload 10
    //   612: ifnull +17 -> 629
    //   615: aload 10
