  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              this.a.jdField_a_of_type_Vrk.a(this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoMusic.a);
    ...
    case 3: 
      this.a.d();
      this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoMusic.a(vrn.jdField_a_of_type_Vrn);
      ...
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131703712));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.a.a(true);
      return;
    case 6: 
      if ((this.a.c) && (this.a.jdField_a_of_type_Vqx != null)) {
        this.a.jdField_a_of_type_Vqx.b();
      }
      this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoMusic.a(vrn.jdField_b_of_type_Vrn);
      this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoMusic.a(1);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131703838));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.a.a(true);
      return;
    ...
    case 10: 
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131703750) + paramMessage.jdField_b_of_type_JavaLangString);
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.a.a(true);
      return;
