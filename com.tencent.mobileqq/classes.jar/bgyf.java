...
public class bgyf
{
  ...
  public bgyf(Activity paramActivity, CustomWebView paramCustomWebView, ViewGroup paramViewGroup)
  {
  ...
  void a()
  {
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365057));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365067));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365065));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369115));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369111));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369082));
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bfzt localbfzt = new bfzt(Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), new bgyh(this, paramInt2));
    localbfzt.setDuration(paramInt3);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidViewView.startAnimation(localbfzt);
  }
  ...
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131562995, paramViewGroup, true);
  }
