  ...
  extends LinearLayout
{
  ...
  public tdw(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while ((i != k) || (j != m))
      {
        ...
        ((ValueAnimator)localObject).addUpdateListener(new tdx(this, i, k, j, m));
        ((ValueAnimator)localObject).addListener(new tdy(this, paramInt1));
