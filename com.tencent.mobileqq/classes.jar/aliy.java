  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  public aliy(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean)
  {
  ...
  protected Bitmap a(int paramInt, String paramString)
  {
    ...
    try
    {
      paramString = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130847348);
      return paramString;
    }
  ...
  protected void a(ainm paramainm, Bitmap paramBitmap)
  {
    if (paramainm.d == null) {}
    do
    {
      do
      {
        ...
        {
          return;
          if (AppConstants.DATALINE_PC_UIN.equals(paramainm.a))
          {
            paramainm.d.setBackgroundResource(2130844119);
            return;
          }
          if (AppConstants.DATALINE_IPAD_UIN.equals(paramainm.a))
          {
            paramainm.d.setBackgroundResource(2130844117);
            return;
          }
          if (AppConstants.DATALINE_PRINTER_UIN.equals(paramainm.a))
          {
            paramainm.d.setBackgroundResource(2130844122);
            return;
          }
          if (AppConstants.SMARTDEVICE_SEARCH_UIN.equals(paramainm.a))
          {
            paramainm.d.setBackgroundResource(2130839608);
            return;
          }
          if ((!AppConstants.SMARTDEVICE_UIN.equals(paramainm.a)) || (!(paramainm instanceof aipm))) {
            break;
          }
          paramBitmap = (aipm)paramainm;
    ...
    paramainm.d.setBackgroundDrawable(paramBitmap);
    return;
    paramainm.d.setBackgroundDrawable(new BitmapDrawable(DeviceHeadMgr.getInstance().getDeviceHeadByDin(paramBitmap.name)));
    return;
    if (paramBitmap != null)
    {
      paramainm.d.setBackgroundDrawable(new BitmapDrawable(paramBitmap));
      return;
    }
    paramainm.d.setBackgroundDrawable(new BitmapDrawable(a(paramainm.jdField_b_of_type_Int, paramainm.a)));
  }
  ...
  protected void a(String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        aliz localaliz = (aliz)this.jdField_a_of_type_ComTencentWidgetListView.getChildAt(i).getTag();
        if ((localaliz != null) && (localaliz.a != null) && (localaliz.a.length() > 0) && (localaliz.a.equals(paramString))) {
          localaliz.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(paramBitmap);
        }
      }
      else
      {
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == 1))
    {
      ...
      if (paramInt1 < paramInt2)
      {
        ...
        if ((paramBitmap != null) && ((paramBitmap instanceof aliz)))
        {
          paramString = (aliz)paramBitmap;
        ...
        for (;;)
        {
          ...
          else if ((paramBitmap != null) && ((paramBitmap instanceof ainm)))
          {
            paramString = (ainm)paramBitmap;
      ...
      if (this.jdField_a_of_type_ComTencentWidgetListView != null)
      {
        ...
        if (i < j)
        {
          ...
          if ((localObject != null) && ((localObject instanceof aliz)))
          {
            ...
            if ((localObject != null) && (((aliz)localObject).a != null) && (((aliz)localObject).a.length() > 0)) {
              ((aliz)localObject).jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(a(((aliz)localObject).jdField_c_of_type_Int, ((aliz)localObject).a));
            }
          }
          for (;;)
          {
            i += 1;
            break;
            if ((localObject != null) && ((localObject instanceof ainm)))
            {
              localObject = (ainm)localObject;
              a((ainm)localObject, (Bitmap)this.jdField_a_of_type_JavaUtilHashtable.get(((ainm)localObject).a));
            }
          }
        }
      }
