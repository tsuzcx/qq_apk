...
public final class uju
{
  ...
  public static final uju a;
  
  static
  {
    jdField_a_of_type_Uju = new uju();
  ...
  public final Bitmap a(@Nullable Bitmap paramBitmap, @NotNull Context paramContext, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBitmap != null)
    {
      ukq.a(jdField_a_of_type_JavaLangString, "1:originWidth = " + paramInt1 + "  originHeight = " + paramInt2 + "  blurWidth = " + paramInt3 + "  blurHeight = " + paramInt4);
      paramBitmap = zdr.a(paramBitmap, paramInt1, paramInt2, false);
      ...
      ukq.a((String)localObject1, paramBitmap.getWidth() + "  originBPHeight = " + paramBitmap.getHeight());
      paramContext = bheg.a(paramContext, paramBitmap, paramInt3 / paramInt1, 20.0F);
      ...
      ukq.a((String)localObject1, paramContext.getWidth() + "  blurBitmapHeight = " + paramContext.getHeight());
      paramContext = jdField_a_of_type_Uju.a(paramContext, paramInt3, paramInt4);
      localObject1 = jdField_a_of_type_JavaLangString;
      ...
      ukq.a((String)localObject2, ((Bitmap)localObject1).getWidth() + "  mergeBitmapHeight = " + ((Bitmap)localObject1).getHeight());
      paramBitmap.recycle();
