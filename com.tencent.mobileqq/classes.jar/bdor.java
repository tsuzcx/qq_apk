  ...
  extends bdob
{
  ...
  public bdor(QQAppInterface paramQQAppInterface, View paramView, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof ahin)))
    {
      paramQQAppInterface = (ahin)paramQQAppInterface;
    ...
    {
      return;
      if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof amgk)))
      {
        paramQQAppInterface = (amgk)paramQQAppInterface;
  ...
  public boolean a(View paramView, String paramString)
  {
    ...
    {
      return false;
      paramView = paramView.findViewById(2131371839);
      if (paramView == null)
      {
        int i;
        ...
        for (paramView = ((bdnu)this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mStructMsgItemLists.get(0)).h;; paramView = "")
        {
      ...
      paramView = (bdqj)paramView.getTag();
    ...
    if ((paramView != null) && (paramView.size() > 0))
    {
      ...
      if ((!bool1) && (!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals(paramString)) && (!bool2))
      {
        ...
        {
          if (paramView != null) {
            axnp.a(paramView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext, 1);
          }
          return true;
        }
      }
      ...
      anzp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006390");
    }
    for (;;)
    {
      return true;
      label274:
      anzp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B3");
      continue;
      label287:
      if (bool2) {
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          anzp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006391");
        } else {
          anzp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B4");
        }
      }
    }
  }
  ...
  public boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        return true;
        if ((!becr.a(paramString)) && (localStructMsgForGeneralShare.mSourceAppid != becr.a)) {
          continue;
        }
        ...
        return true;
        if ((!(localContext instanceof BaseActivity)) || (!awyd.a((BaseActivity)localContext, (String)localObject2, localStructMsgForGeneralShare.message))) {
          continue;
        }
        return true;
        ...
        paramString = nuz.a(paramString, "platformId=qq_m");
        ...
        if ((TextUtils.isEmpty(str2)) || (!bhbx.b(localStructMsgForGeneralShare.uin))) {
          continue;
        }
        ...
        paramString = bhey.a(localNumberFormatException, localContext, Uri.parse("mqqapi://card/show_pslcard?" + HttpUtil.encodeUrl(paramString)).toString());
        if (paramString == null) {
          continue;
        }
        paramString.a();
        ...
        if (!bmic.a(this.jdField_a_of_type_AndroidContentContext, str2)) {
          continue;
        }
        return true;
        if ((TextUtils.isEmpty(str2)) || (!uuc.c(str2)) || (!tto.b(str2))) {
          continue;
        }
        tto.a(localContext, null, tto.b(str2), null);
        return true;
        if ((this.jdField_a_of_type_ComTencentMobileqqDataChatMessage == null) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.istroop != 0) || (!bhbx.b(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin)) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie")))) {
          continue;
        }
        paramString = bhbx.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie"));
        if (paramString == null) {
          continue;
        }
        ...
        try
        {
          ...
          if (localStructMsgForGeneralShare.uinType == 0)
          {
            ...
            afoe.a((Intent)localObject4, localNumberFormatException, localStructMsgForGeneralShare.message);
            if ((uuc.a(localNumberFormatException, localStructMsgForGeneralShare.uin) != -1) || (str2.startsWith("http://browserApp.p.qq.com/")))
            {
              ...
              paramString.putBoolean("switch_msg_btn", uuc.a());
            ...
            bool = aqwc.a(localNumberFormatException, localStructMsgForGeneralShare.uin, false);
            ...
            {
              paramString = "https://ti.qq.com/honest-say/group.html?_bid=3104&_qStyle=1&_wv=9191&_nav_alpha=0&_nav_txtclr=FFFFFF&_nav_titleclr=FFFFFF&_nav_anim=true&_wwv=128&gc=$GCODE$&src_type=share&from=appstore_aio&adtag=qq_to_qq".replace("$GCODE$", axqj.a(localStructMsgForGeneralShare.uin));
              ...
              if ((localContext instanceof FragmentActivity))
              {
                ...
                if (localObject2 != null)
                {
                  ...
                  if ((paramString != null) && ((paramString instanceof TroopChatPie))) {
                    aqwc.a((TroopChatPie)paramString);
                  }
                }
              }
            }
            ...
            QQToast.a(BaseApplicationImpl.getContext(), aqwc.jdField_a_of_type_JavaLangString, 0).a();
            return false;
          }
        }
        catch (InvalidProtocolBufferMicroException paramString)
        {
          ...
          ((Intent)localObject4).putExtra("big_brother_source_key", uuc.b(localStructMsgForGeneralShare.source_puin));
          continue;
        ...
        paramString = bghs.a(localStructMsgForGeneralShare, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
        if (TextUtils.isEmpty(paramString)) {
          continue;
        }
        ((Intent)localObject4).removeExtra("url");
        ...
        i = 1;
        olh.a(null, "", "0X8007555", "0X8007555", 0, 0, paramString, "", "" + i, "");
        olh.a("0X8007555", "", paramString, "", "" + i, "");
        ...
        uuc.a(localStructMsgForGeneralShare.message, (Intent)localObject4, str2);
        ...
        aflm.a(localContext, (Intent)localObject4, str2);
        bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, str2, "", "", "");
        if (!bool) {
          continue;
        }
        ...
        bdla.b(localNumberFormatException, "CliOper", "", "", "0X80052BB", "0X80052BB", 0, 0, "", "", "", "");
        continue;
        bdla.b(localNumberFormatException, "CliOper", "", "", "0X80052BC", "0X80052BC", 0, 0, "", "", "", "");
        continue;
        i = 2;
        continue;
        continue;
      ...
      bdla.b(null, "CliOper", "", (String)localObject3, "0X80061B0", "0X80061B0", i, 0, str1, (String)localObject4, (String)localObject1, str2);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mMsgServiceID == 107)
      {
        ...
        {
          StructMsgForGeneralShare.receiptServer = new bdos(this, "receipt_msg");
      ...
      l = bhch.a(localStructMsgForGeneralShare.mSourceAppid);
      ...
      if ((localContext instanceof FragmentActivity))
      {
        ...
        if (localObject3 != null)
        {
          ...
          {
            localObject4 = (aido)localObject3;
            ((aido)localObject4).j += 1;
            localObject3 = (aido)localObject3;
            ((aido)localObject3).h += 1;
          }
        }
      }
      if (!c(paramString)) {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message.istroop == 1008)) {
        okn.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.uin);
      }
      return false;
      i = 1;
    }
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      paramString1 = bhey.a(localQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
      if (paramString1 == null) {
        break;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message != null) && (bhbx.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message.senderuin))) {
