...
public class bhwy
{
  ...
  public static void a(Resources paramResources, String paramString)
  {
    ...
    {
      return;
      paramResources = paramResources.getDrawable(2130848614);
  ...
  {
    ThreadManager.post(new AIOBusinessOperation.1((ImageView)paramViewGroup.findViewById(2131313105), paramBoolean), 5, null, false);
  }
  ...
  public static void a(PatchedButton paramPatchedButton, AIOLongCaptureCtrl paramAIOLongCaptureCtrl)
  {
    if (AppSetting.c)
    {
      ...
      paramPatchedButton.setOnClickListener(new bhwz(paramAIOLongCaptureCtrl));
      return;
    }
  ...
  private static void d(ImageView paramImageView, String paramString)
  {
    ...
    Object localObject = paramImageView.getResources().getDrawable(2130843537);
    int i;
