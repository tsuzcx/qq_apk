  ...
  extends wov
{
  ...
  public wuj(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((qqstory_service.RspGetFilterList)localObject1).is_end.get() != 0)
        {
          ...
          wub localwub = new wub();
          localwub.jdField_a_of_type_Long = ((qqstory_struct.FilterListPack)localObject2).filter_id.get();
          localwub.jdField_a_of_type_JavaLangString = ((qqstory_struct.FilterListPack)localObject2).filter_name.get().toStringUtf8();
          localwub.jdField_a_of_type_Int = ((qqstory_struct.FilterListPack)localObject2).filter_type.get();
          localwub.jdField_b_of_type_JavaLangString = ((qqstory_struct.FilterListPack)localObject2).filter_config_file.get().toStringUtf8();
          localwub.c = ((qqstory_struct.FilterListPack)localObject2).filter_config_md5.get().toStringUtf8();
          try
          {
            localObject2 = localwub.a();
            paramArrayOfByte.add(localObject2);
            yuk.d("VideoFilterManager", "GET Filter : id=%d, name=%s, type=%d, url=%s, md5=%s", new Object[] { Long.valueOf(((FilterItem)localObject2).filterId), ((FilterItem)localObject2).filterName, Integer.valueOf(((FilterItem)localObject2).filterType), ((FilterItem)localObject2).filterConfigUrl, ((FilterItem)localObject2).filterConfigMd5 });
          }
          catch (FilterItem.FilterItemIllegalException localFilterItemIllegalException)
          {
            yuk.c("VideoFilterManager", "GET Filter error : ", localFilterItemIllegalException);
          }
          continue;
        }
        bool = false;
      ...
      {
        yuk.e("VideoFilterManager", "GetEmojiPackInfoListRequest error : " + paramArrayOfByte);
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_JavaLangString = anzj.a(2131715042);
