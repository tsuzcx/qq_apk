  ...
  extends wfm<wvs>
{
  ...
  public ArrayList<wjj> a;
  public int c;
  
  static
  {
    jdField_a_of_type_JavaLangString = weg.a("StorySvc.video_watch_batch");
  }
  ...
  public wfh a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wvs(localRspWatchVideoBatch);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        ykq.d("Q.qqstory:WatchVideoBatchRequest", paramArrayOfByte.toString());
      }
    }
  }
  ...
  protected byte[] a()
  {
    ...
    {
      wjj localwjj = (wjj)localIterator.next();
      qqstory_service.VideoItem localVideoItem = new qqstory_service.VideoItem();
      localVideoItem.vid.set(ByteStringMicro.copyFromUtf8(localwjj.jdField_a_of_type_JavaLangString));
      Object localObject = a(localwjj.b);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        localVideoItem.create_time.set(localwjj.jdField_a_of_type_Long / 1000L);
        localVideoItem.source.set(localwjj.jdField_a_of_type_Int);
