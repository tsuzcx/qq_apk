...
{
  public static final qif a = new qif(null);
  
  @NonNull
  private final qid a(PushComponentExtPB.MsgBody paramMsgBody)
  {
    qid localqid = new qid(null, null, null, null, null, null, 63, null);
    String str;
    if (paramMsgBody.articleIds.has())
    {
      ...
      localqid.jdField_a_of_type_JavaLangString = str;
    }
    ...
    if (paramMsgBody.pushExtData.has())
    {
      ...
      localqid.jdField_a_of_type_ArrayOfByte = paramMsgBody;
    }
    return localqid;
  }
  ...
  @NonNull
  @NotNull
  public final qid a(@NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramString, "base64PbBuffer");
    byte[] arrayOfByte = bhkv.decode(paramString, 0);
