...
public class bivz
{
  ...
  private String jdField_b_of_type_JavaLangString = biix.jdField_b_of_type_JavaLangString;
  private int jdField_c_of_type_Int;
  private String jdField_c_of_type_JavaLangString;
  private int d;
  
  public bivz(String paramString)
  {
  ...
  public void a(biwa parambiwa)
  {
    this.jdField_a_of_type_Biwa = parambiwa;
    QLog.d(jdField_a_of_type_JavaLangString, 4, "start add text to png");
    this.jdField_a_of_type_AndroidOsHandler.post(new PngsTextDrawer.2(this, parambiwa));
  }
