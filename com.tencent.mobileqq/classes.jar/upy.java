...
{
  public upy(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if ((((oidb_cmd0x439.RspBody)localObject1).rpt_msg_subscribe_info.has()) && (((oidb_cmd0x439.RspBody)localObject1).rpt_msg_subscribe_info.get() != null))
      {
        ...
        if (paramObject.hasNext())
        {
          ...
          localObject1 = new uqe();
          if (((oidb_cmd0x439.SubscribeInfo)localObject2).uint64_subscribe_id.has())
          {
            ((uqe)localObject1).jdField_a_of_type_Long = ((oidb_cmd0x439.SubscribeInfo)localObject2).uint64_subscribe_id.get();
            if ((((uqe)localObject1).jdField_a_of_type_Long > 0L) && (!TextUtils.isEmpty(paramToServiceMsg))) {
              ((uqe)localObject1).b = (paramToServiceMsg + ((uqe)localObject1).jdField_a_of_type_Long);
            }
          }
          if ((((oidb_cmd0x439.SubscribeInfo)localObject2).bytes_subscribe_name.has()) && (((oidb_cmd0x439.SubscribeInfo)localObject2).bytes_subscribe_name.get() != null)) {
            ((uqe)localObject1).jdField_a_of_type_JavaLangString = ((oidb_cmd0x439.SubscribeInfo)localObject2).bytes_subscribe_name.get().toStringUtf8();
          }
          if ((((oidb_cmd0x439.SubscribeInfo)localObject2).rpt_article_list.has()) && (((oidb_cmd0x439.SubscribeInfo)localObject2).rpt_article_list.get() != null))
          {
            ...
            if (!((List)localObject3).isEmpty())
            {
              ...
              ((uqe)localObject1).jdField_a_of_type_ComTencentBizPubaccountSubscriptReadInJoyArticle = ((ReadInJoyArticle)localObject2);
            }
          }
          if (QLog.isColorLevel()) {
            QLog.i("SubscriptHandler", 2, "handleGetRecommendList create SubscriptRecommendAccountInfo id: " + ((uqe)localObject1).jdField_a_of_type_Long + " | name: " + ((uqe)localObject1).jdField_a_of_type_JavaLangString + " | article: " + ((uqe)localObject1).jdField_a_of_type_ComTencentBizPubaccountSubscriptReadInJoyArticle.mTitle);
          }
