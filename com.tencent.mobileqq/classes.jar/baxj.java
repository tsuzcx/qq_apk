  ...
  extends FaceDecodeTask
{
  ...
  public baxj(QQAppInterface paramQQAppInterface, FaceInfo paramFaceInfo, baxh parambaxh)
  {
    super(paramQQAppInterface, paramFaceInfo, parambaxh);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localajvi = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      if (this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int != 1001) {
        break label119;
      }
      this.jdField_a_of_type_AndroidGraphicsBitmap = localajvi.a(GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString), false);
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int == 4) || (this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int == 113))
          {
            if (((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString))
            {
              ...
              if (this.jdField_a_of_type_AndroidGraphicsBitmap == null)
              {
                ...
                this.jdField_a_of_type_AndroidGraphicsBitmap = bbdr.a(BaseApplicationImpl.sApplication.getResources(), i);
            ...
            if (!bamn.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString))
            {
              this.jdField_a_of_type_AndroidGraphicsBitmap = ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString, false);
      ...
      baxk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo);
      for (;;)
      {
        for (;;)
        {
        ...
        {
          localalyz = (alyz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(180);
          if (localalyz.a(localalyz.b(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString), (Setting)localException7.second, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int))
          {
            if (QLog.isColorLevel()) {
