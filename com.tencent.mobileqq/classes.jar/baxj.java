  ...
  extends baxf
{
  ...
  public baxj(QQAppInterface paramQQAppInterface, int paramInt, String paramString, List<baxh> paramList)
  {
    ...
    if (bbgk.a(this.jdField_b_of_type_Int))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(bbgk.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          i += 1;
      ...
      {
        this.jdField_c_of_type_JavaLangCharSequence = (this.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.wMemberNum + amtj.a(2131701693));
        return;
      }
    }
    this.jdField_a_of_type_JavaLangCharSequence = amtj.a(2131701702);
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_a_of_type_JavaUtilSet.isEmpty()) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          ((SpannableStringBuilder)localObject).append(bbgk.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          if (j > 0) {
