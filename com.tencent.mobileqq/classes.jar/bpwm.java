...
public class bpwm
{
  private static bpwm jdField_a_of_type_Bpwm;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bpwn(this));
  private bpwo jdField_a_of_type_Bpwo = new bpwo(this, null);
  private bpwq jdField_a_of_type_Bpwq;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private bpwm(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Bpwo);
    }
  }
  
  public static bpwm a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Bpwm == null) {
      jdField_a_of_type_Bpwm = new bpwm(paramAppInterface);
    }
    return jdField_a_of_type_Bpwm;
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Bpwm != null)
    {
      jdField_a_of_type_Bpwm.b();
      jdField_a_of_type_Bpwm = null;
    }
  }
  ...
  private void a(double paramDouble1, double paramDouble2, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), bowg.class);
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bpwq != null)
    {
      Object localObject = paramArrayList;
      if (paramArrayList == null) {
        localObject = new ArrayList(1);
      }
      this.jdField_a_of_type_Bpwq.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Bpwo);
      this.jdField_a_of_type_ComTencentCommonAppAppInterface = null;
    }
    this.jdField_a_of_type_Bpwq = null;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new bpwp(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Bpwq != null) {
          this.jdField_a_of_type_Bpwq.a(paramInt, bool2);
        }
        return;
      }
  ...
  public void a(bpwq parambpwq)
  {
    this.jdField_a_of_type_Bpwq = parambpwq;
  }
}
