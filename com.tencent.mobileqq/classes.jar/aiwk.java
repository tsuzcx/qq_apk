  ...
  implements TroopHomeworkHelper.UploadCallback
{
  ...
  public aiwk(ArithmeticViewHolder paramArithmeticViewHolder, ArithmeticInfo.ArithmeticImageInfo paramArithmeticImageInfo)
  {
  ...
  {
    ThreadManager.getUIHandler().post(new aiwl(this, paramArithmeticImageInfo));
  }
