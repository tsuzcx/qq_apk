...
public class aiwk
{
  ...
  public boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    do
    {
      ...
      localairu = aisl.a(paramQQAppInterface);
    } while (localairu == null);
    localairu.a("", this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.content);
    this.jdField_a_of_type_Boolean = true;
    b(paramQQAppInterface);
    bajr.a(paramQQAppInterface, "cmshow", "Apollo", "aio_msg_display", ApolloUtil.b(paramInt), 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.msg_id });
    return true;
  }
