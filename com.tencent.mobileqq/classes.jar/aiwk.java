  ...
  extends QIPCModule
{
  ...
  public static aiwk a()
  {
    if (jdField_a_of_type_Aiwk == null) {}
    try
    {
      if (jdField_a_of_type_Aiwk == null) {
        jdField_a_of_type_Aiwk = new aiwk();
      }
      return jdField_a_of_type_Aiwk;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (ambl)paramQQAppInterface.getManager(85);
    ...
    case 11: 
      ...
      paramQQAppInterface = (aeju)paramQQAppInterface.getManager(321);
    ...
    case 13: 
      ...
      if ((paramQQAppInterface != null) && (paramBundle != null))
      {
        paramQQAppInterface.a().b(aljq.ad, 9002, paramBundle.msg_id.hashCode());
        paramQQAppInterface.D();
      }
      return null;
    case 0: 
      paramQQAppInterface = bdbt.b(paramQQAppInterface, paramBundle.getString("uin"), true);
      paramBundle = new Bundle();
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new aiwp(this, paramInt));
      return null;
    case 8: 
    ...
    case 14: 
      ...
      int i = paramBundle.getInt("call_type", azij.a);
      if (i == azij.b)
      {
        paramBundle = new Bundle();
        paramBundle.putSerializable("res", azit.a().a(paramQQAppInterface, null, i));
        return EIPCResult.createSuccessResult(paramBundle);
      }
      azit.a().a(paramQQAppInterface, new aiwq(this, paramInt), i);
      return null;
    case 1: 
    ...
    case 16: 
      ...
      {
        paramBundle = (aith)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    ...
    case 15: 
      localObject = paramBundle.getString("key");
      paramInt = paramBundle.getInt("code");
      paramBundle = new aiwr(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
      paramQQAppInterface = (aitd)paramQQAppInterface.getManager(245);
      if (paramQQAppInterface != null)
      {
        if ((this.jdField_a_of_type_JavaUtilMap != null) && (!this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt)))) {
    ...
    paramBundle = new aiws(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject1;
    if (((i != 5) && ((i & 0x10) == 0)) || ((((aloz)localObject2).b(str)) && (!paramQQAppInterface.getCurrentAccountUin().equals(str)))) {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramBundle)) {
        localObject1 = bdbt.b(paramQQAppInterface, str, true);
      }
      for (;;)
      {
        ...
        localObject1 = bdbt.b(paramQQAppInterface, str, true);
        continue;
        paramBundle = bdbt.q(paramQQAppInterface, str);
        localObject1 = paramBundle;
        if (TextUtils.isEmpty(paramBundle)) {
          localObject1 = str;
        }
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (aitd)((QQAppInterface)paramAppRuntime).getManager(245);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new aiwu(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new aiwt(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
    ...
    ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new aiwl(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new aiwm(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
      ...
      else
      {
        ...
        else
        {
          if ("getConditionSearchManager".equals(paramString))
          {
            ...
            paramBundle = (allj)((QQAppInterface)localObject).getManager(59);
            ...
            if (paramInt != 0)
            {
              ...
              if (i == 0) {
                paramBundle.c(new aiwo(this, (Bundle)localObject, i, paramString, paramBundle));
              }
