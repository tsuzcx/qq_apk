...
public class bfkl
{
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_Bfkb == null) && (!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaLangRefWeakReference != null))
    {
  ...
  private boolean a(bfkn parambfkn)
  {
    return this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(parambfkn);
  }
  
  private boolean b()
  {
    if ((this.jdField_a_of_type_Bfkb != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null))
    {
      AppRuntime localAppRuntime = (AppRuntime)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localAppRuntime != null)
      {
        QQIndividualityPluginProxyService.a(localAppRuntime, this.jdField_a_of_type_AndroidContentServiceConnection);
        this.jdField_a_of_type_Bfkb = null;
  ...
  {
    if ((this.jdField_a_of_type_Bfkb != null) && (parambfkn != null))
    {
      Looper localLooper = Looper.getMainLooper();
      if (Thread.currentThread() != localLooper.getThread()) {
        new Handler(localLooper).post(new QQIndividualityRemoteProxy.1(this, parambfkn));
      }
    }
    else
    {
    ...
    try
    {
      this.jdField_a_of_type_Bfkb.a(parambfkn.jdField_a_of_type_Int, parambfkn.jdField_a_of_type_AndroidOsBundle);
      return;
    }
    catch (RemoteException parambfkn) {}
  }
  ...
  public boolean a(String paramString, int paramInt, Bundle paramBundle)
  {
    if (this.jdField_a_of_type_JavaUtilHashSet.contains(paramString))
    {
      paramString = new bfkn(this, paramInt, paramBundle);
      if (this.jdField_a_of_type_Bfkb != null) {
        a(paramString);
      }
      for (;;)
      {
