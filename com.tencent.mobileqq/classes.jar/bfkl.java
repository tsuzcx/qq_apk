...
public final class bfkl
{
  private static int jdField_a_of_type_Int;
  private static final bfkr jdField_a_of_type_Bfkr = new bfkr(84298576L);
  private static final bfkr b = new bfkr(50613072L);
  private static final bfkr c = new bfkr(101010256L);
  ...
  public static String a(File paramFile)
  {
    ...
    //   56: ldc 188
    //   58: invokestatic 191	bfkl:a	(Ljava/lang/String;I)[B
    //   61: astore_1
    //   62: aload_1
    ...
    //   80: astore_2
    //   81: aload_1
    //   82: invokestatic 201	bfkl:a	(Ljava/io/RandomAccessFile;)[B
    //   85: astore_3
    //   86: aload_3
    //   87: ifnonnull +45 -> 132
    //   90: aload_1
    ...
    //   139: dup
    //   140: aconst_null
    //   141: invokespecial 215	bfkn:<init>	(Lbfkm;)V
    //   144: astore 4
    //   146: aload_1
    //   147: astore_0
    //   148: aload_1
    ...
    //   150: aload 4
    //   152: aload_3
    //   153: invokevirtual 218	bfkn:a	([B)V
    //   156: aload_1
    //   157: astore_0
    //   158: aload_1
    //   159: astore_2
    //   160: aload 4
    //   162: getfield 221	bfkn:a	Ljava/util/Properties;
    //   165: ldc 223
  ...
  private static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        ...
        arrayOfByte = new byte[jdField_a_of_type_Bfkr.a().length];
        ((ByteBuffer)localObject).get(arrayOfByte);
        localObject = paramArrayOfByte;
      } while (jdField_a_of_type_Bfkr.equals(new bfkr(arrayOfByte)));
      localObject = paramArrayOfByte;
    } while (b.equals(new bfkr(arrayOfByte)));
    Object localObject = new ByteArrayOutputStream();
    ((ByteArrayOutputStream)localObject).write(b.a());
    ((ByteArrayOutputStream)localObject).write(new bfks(paramArrayOfByte.length).a());
  ...
  private static void b(File paramFile, String paramString)
  {
    ...
    finally
    {
      try
      {
        ...
        localbfkn = new bfkn(null);
        localbfkn.a(paramFile);
        localbfkn.a.setProperty("apkSecurityCode", paramString);
        paramFile = localbfkn.a();
        localRandomAccessFile.seek(jdField_a_of_type_Int);
        localRandomAccessFile.write(new bfks(paramFile.length).a());
  ...
  private static void c(File paramFile, String paramString)
  {
    try
    {
      ...
      bfkn localbfkn = new bfkn(null);
      localbfkn.a(arrayOfByte);
      localbfkn.a.setProperty("apkSecurityCode", paramString);
      paramString = localbfkn.a();
