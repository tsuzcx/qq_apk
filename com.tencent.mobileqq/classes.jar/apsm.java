  ...
  implements aphq, apsl
{
  ...
  public volatile apho a;
  aphp jdField_a_of_type_Aphp;
  public aphv a;
  private apib jdField_a_of_type_Apib = new apib(this);
  private apts jdField_a_of_type_Apts;
  ...
  public apsm()
  {
    this.jdField_a_of_type_Aphv = new aphv();
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  }
  
  private apho a(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramString)) {
      return (apho)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    }
    return null;
  }
  ...
  private void b(GL10 paramGL10)
  {
    ...
    this.jdField_a_of_type_Apib.onDrawFrame(paramGL10);
    ...
    paramGL10 = this.jdField_a_of_type_Apho;
    if ((paramGL10 != null) && (paramGL10.d()))
    {
      System.currentTimeMillis();
      GLES20.glEnable(2929);
      aphw localaphw = this.jdField_a_of_type_Aphv.a(paramGL10.b(), paramGL10.c());
      if (localaphw != null) {
        paramGL10.a(localaphw);
      }
      GLES20.glDisable(2929);
      System.currentTimeMillis();
    }
  ...
  public int a()
  {
    return this.jdField_a_of_type_Apib.a();
  }
  
  public long a()
  {
    return this.jdField_a_of_type_Aphv.jdField_a_of_type_Long;
  }
  ...
  public aphv a()
  {
    return this.jdField_a_of_type_Aphv;
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Apib.b(paramInt);
  }
  ...
  public void a(int paramInt1, SurfaceTexture paramSurfaceTexture, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    this.jdField_a_of_type_Apib.a(paramInt1, paramSurfaceTexture);
    this.jdField_a_of_type_Apib.a(paramInt2, paramInt3, paramInt4, paramInt5);
  ...
  {
    this.jdField_a_of_type_Aphv.a(paramArrayOfFloat);
  }
  
  public void a(long paramLong)
  {
    this.jdField_a_of_type_Aphv.jdField_a_of_type_Long = paramLong;
  }
  
  public void a(apho paramapho, ArCloudConfigInfo paramArCloudConfigInfo, int paramInt1, int paramInt2, Object paramObject)
  {
    if ((paramArCloudConfigInfo != null) && (paramArCloudConfigInfo.a()) && (this.jdField_a_of_type_Aphp != null)) {
      this.jdField_a_of_type_Aphp.a(paramArCloudConfigInfo, paramInt1, paramInt2, paramObject);
    }
  }
  
  public void a(aphp paramaphp)
  {
    this.jdField_a_of_type_Aphp = paramaphp;
  }
  
  public void a(apht paramapht)
  {
    this.jdField_a_of_type_Aphv.a(paramapht);
  }
  
  public void a(apts paramapts)
  {
    this.jdField_a_of_type_Apts = paramapts;
  }
  ...
  public void a(ArVideoResourceInfo paramArVideoResourceInfo, aphq paramaphq)
  {
    ...
    this.jdField_a_of_type_Aphp.a(paramArVideoResourceInfo, paramaphq);
  }
  ...
  {
    this.jdField_a_of_type_Apib.a(paramFloatBuffer, paramSize);
  }
  ...
  public boolean a(aphs paramaphs)
  {
    QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. resourceInfo.key = " + paramaphs.jdField_a_of_type_JavaLangString + ", resourceInfo.arType = " + paramaphs.jdField_a_of_type_Int + ", resourceInfo.trackMode = " + paramaphs.jdField_b_of_type_Int);
    if (!this.e)
    {
      QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. fail because of render not ready");
      return false;
    }
    apho localapho2 = a(paramaphs.jdField_a_of_type_JavaLangString);
    apho localapho1 = localapho2;
    if (localapho2 == null)
    {
      localapho1 = aphu.a(this, paramaphs, this.jdField_a_of_type_AndroidOpenglGLSurfaceView);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here 1" + localapho1);
      this.jdField_a_of_type_JavaUtilMap.put(paramaphs.jdField_a_of_type_JavaLangString, localapho1);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here " + localapho1);
    }
    if (localapho1 == null)
    {
      ...
      paramaphs = this.jdField_a_of_type_Apho;
      this.jdField_a_of_type_Apho = null;
      this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.1(this, paramaphs));
      return false;
    }
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.2(this, localapho1, paramaphs));
    return true;
  }
  ...
  public boolean a(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    if (this.jdField_a_of_type_Apib != null)
    {
      this.jdField_a_of_type_Apib.a(paramBoolean);
      this.jdField_a_of_type_Apib.a(paramFloat2);
      return true;
    }
    return false;
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        ((apho)localIterator.next()).f();
      }
      this.jdField_a_of_type_JavaUtilMap.clear();
      this.jdField_a_of_type_Apho = null;
      this.jdField_a_of_type_Apib.g();
      this.jdField_a_of_type_Aphv.a();
      this.e = false;
  ...
  {
    if ((this.jdField_a_of_type_Aphp == null) || (this.jdField_a_of_type_Apho == null))
    {
    ...
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_Aphp.a(this.jdField_a_of_type_Apho.c(), paramInt2);
      return;
    case 1: 
      this.jdField_a_of_type_Aphp.c(this.jdField_a_of_type_Apho.c(), paramInt2);
      return;
    case 2: 
      this.jdField_a_of_type_Aphp.b(this.jdField_a_of_type_Apho.c(), paramInt2);
      return;
    }
    this.jdField_a_of_type_Aphp.d(this.jdField_a_of_type_Apho.c(), paramInt2);
  }
  
  public void b(long paramLong)
  {
    this.jdField_a_of_type_Aphv.c = paramLong;
  }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    while (i != 0)
    {
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoRecordController.a(this.jdField_a_of_type_Bbma, i, j);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aphp != null) {
        this.jdField_a_of_type_Aphp.a(null, 1001, 0, localBitmap);
      }
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Apts != null) {
      this.jdField_a_of_type_Apts.a(paramGL10, paramInt1, paramInt2);
    }
    this.jdField_a_of_type_Apib.onSurfaceChanged(paramGL10, paramInt1, paramInt2);
    if (this.jdField_a_of_type_Aphp != null) {
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    if (aphh.a()) {
      this.jdField_a_of_type_Bbma = new bbma(EGL14.eglGetCurrentContext(), 1);
    }
    apen.a().a(paramGL10.glGetString(7937));
    this.jdField_a_of_type_Apib.onSurfaceCreated(paramGL10, paramEGLConfig);
    if (this.jdField_a_of_type_Apts != null) {
      this.jdField_a_of_type_Apts.a(paramGL10);
    }
    ...
    apkx.a(paramGL10.glGetString(7937), paramGL10.glGetString(7936), paramGL10.glGetString(7938), paramEGLConfig.toString());
  }
}
