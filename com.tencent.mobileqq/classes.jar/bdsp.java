  ...
  extends bdnu
{
  ...
  public bdsp()
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bdsq(this);
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdsr(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBundle = paramBundle.getDrawable(2130841781);
        if (TextUtils.isEmpty(this.ac))
        {
          ...
          paramView.setId(2131368676);
          paramView.setContentDescription(paramBundle.getString(2131694367));
          paramView.setDisplayRuleDef(binl.a);
          paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
          paramView.setContentDescription(paramBundle.getText(2131719004));
        }
      }
  ...
  public boolean a(bdpl parambdpl)
  {
    ...
    do
    {
      ...
      this.ad = parambdpl.a("src");
    } while (this.jdField_a_of_type_Int <= 5);
    this.ae = parambdpl.a("video_info");
