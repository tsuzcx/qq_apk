  ...
  extends bdtc
{
  ...
  public bdsp(bdzi parambdzi, bdzn parambdzn)
  {
    super(parambdzi, parambdzn);
    this.jdField_a_of_type_Int = parambdzn.jdField_c_of_type_Int;
    this.jdField_a_of_type_Bduk.jdField_c_of_type_Int = parambdzn.jdField_c_of_type_Int;
    this.jdField_b_of_type_JavaLangString = parambdzn.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_ArrayOfByte = parambdzn.jdField_a_of_type_ArrayOfByte;
  }
  ...
  protected final long a(long paramLong)
  {
    ...
    for (paramLong = Math.min(paramLong, this.jdField_a_of_type_Bktt.a(BaseApplication.getContext(), this.jdField_q_of_type_Long, this.s, -1));; paramLong = Math.min(paramLong, 14600L)) {
  ...
  protected bebv a()
  {
    ...
    localbece.b = this.n;
    localbece.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    ...
    localbebv.jdField_a_of_type_JavaLangString = "bdh_common_up";
    ...
    localbebv.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    localbebv.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
    return localbebv;
  }
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 1, this.jdField_a_of_type_Bdzn.jdField_b_of_type_Int, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 1, this.jdField_a_of_type_Bdzn.jdField_b_of_type_Int, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 0, this.jdField_a_of_type_Bdzn.jdField_b_of_type_Int, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 0, this.jdField_a_of_type_Bdzn.jdField_b_of_type_Int, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  public final void a(bebv parambebv, beck parambeck)
  {
    if (parambeck != null)
    {
      ...
      {
        parambebv = (becl)parambeck.jdField_a_of_type_JavaUtilList.get(i);
        if (QLog.isColorLevel()) {
          b("procUrl", parambebv.toString());
        }
        a(this.jdField_a_of_type_Bdsz, parambebv);
        if (QLog.isColorLevel()) {
          QLog.d("BDHCommonUploadProcessor", 2, "onBusiProtoResp()------response.result = " + parambebv.jdField_c_of_type_Int);
        }
        if (parambebv.jdField_c_of_type_Int == 0)
        {
          ...
          this.jdField_a_of_type_Bduk.jdField_l_of_type_JavaLangString = parambebv.jdField_b_of_type_JavaLangString;
          this.jdField_a_of_type_Bduk.jdField_m_of_type_JavaLangString = parambebv.e;
          this.jdField_a_of_type_Bduk.n = parambebv.jdField_c_of_type_JavaLangString;
          this.jdField_a_of_type_Bduk.o = parambebv.jdField_d_of_type_JavaLangString;
          this.jdField_a_of_type_Bduk.i = ("http://" + parambebv.jdField_b_of_type_JavaLangString + parambebv.e);
          this.jdField_a_of_type_Bduk.jdField_j_of_type_JavaLangString = ("http://" + parambebv.jdField_b_of_type_JavaLangString + parambebv.jdField_c_of_type_JavaLangString);
          this.jdField_a_of_type_Bduk.k = ("http://" + parambebv.jdField_b_of_type_JavaLangString + parambebv.jdField_d_of_type_JavaLangString);
          this.jdField_a_of_type_Bduk.g = parambebv.f;
          if (parambebv.jdField_a_of_type_Boolean)
          {
            this.jdField_a_of_type_Bduk.a();
            e();
            if (QLog.isColorLevel()) {
              QLog.d("BDHCommonUploadProcessor", 2, "onBusiProtoResp()---- file is Exsit! " + this.jdField_a_of_type_Bdzn.i);
            }
            label374:
            this.jdField_a_of_type_Long = parambebv.jdField_a_of_type_Long;
            this.jdField_a_of_type_Bduk.d = this.jdField_a_of_type_Long;
            if (QLog.isColorLevel()) {
              QLog.d("BDHCommonUploadProcessor", 2, "mFileID->" + this.jdField_a_of_type_Long + " groupUin->" + this.jdField_a_of_type_Bdzn.jdField_c_of_type_JavaLangString);
            }
          }
        }
        for (;;)
        {
          i += 1;
          break;
          if ((this.jdField_a_of_type_Int == 9) && (parambebv.f != null)) {
            this.jdField_a_of_type_TencentImCsCmd0x388Cmd0x388$ExpRoamExtendInfo.bytes_resid.set(ByteStringMicro.copyFrom(parambebv.f.getBytes()));
          }
          if ((this.jdField_a_of_type_Int == 20) && (parambebv.f != null)) {
            this.jdField_a_of_type_ComTencentMobileqqHighwayProtocolBdh_extinfo$UploadPicExtInfo.bytes_file_resid.set(ByteStringMicro.copyFrom(parambebv.f.getBytes()));
          }
          this.jdField_m_of_type_JavaLangString = parambebv.jdField_a_of_type_JavaLangString;
          this.s = parambebv.jdField_b_of_type_Int;
          this.r = parambebv.jdField_b_of_type_Long;
          aL_();
          break label374;
          d();
        }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, this.jdField_b_of_type_JavaLangString, true, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      m();
      ...
      bctj.a(BaseApplication.getContext()).a(null, this.jdField_b_of_type_JavaLangString, false, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  byte[] a()
  {
    ...
    localApplyUploadReq.bytes_10m_md5.set(ByteStringMicro.copyFrom(this.jdField_b_of_type_ArrayOfByte));
    ...
    ((cmd0x346.ExtensionReq)localObject).uint32_ptt_time.set(this.jdField_a_of_type_Bdzn.jdField_j_of_type_Int);
    i = bebf.a();
  ...
  public final void aL_()
  {
    ...
    bdsq localbdsq = new bdsq(this, SystemClock.uptimeMillis());
    if (this.jdField_a_of_type_Int == 9) {
      this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.i, (int)this.r, bgva.a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_ArrayOfByte, localbdsq, this.jdField_a_of_type_TencentImCsCmd0x388Cmd0x388$ExpRoamExtendInfo.toByteArray());
    }
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("BDHCommonUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + i + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long + " MD5:" + this.jdField_c_of_type_JavaLangString + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + 3);
      }
      if (i != 0)
      {
      ...
      if (this.jdField_a_of_type_Int == 20) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.i, (int)this.r, bgva.a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_ArrayOfByte, localbdsq, this.jdField_a_of_type_ComTencentMobileqqHighwayProtocolBdh_extinfo$UploadPicExtInfo.toByteArray());
      } else if (this.jdField_a_of_type_Int == 36) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.i, (int)this.r, this.jdField_b_of_type_ArrayOfByte, localbdsq, a(), false);
      } else if (this.jdField_a_of_type_Int == 40) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.i, (int)this.r, this.jdField_b_of_type_ArrayOfByte, localbdsq, this.jdField_a_of_type_Bdzn.jdField_a_of_type_ArrayOfByte, true);
      } else if (this.jdField_a_of_type_Int == 54) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.i, (int)this.r, this.jdField_b_of_type_ArrayOfByte, localbdsq, this.jdField_a_of_type_Bdzn.jdField_a_of_type_ArrayOfByte, false);
      } else if ((this.jdField_a_of_type_Int == 51) || (this.jdField_a_of_type_Int == 58) || (this.jdField_a_of_type_Int == 62) || (this.jdField_a_of_type_Int == 65) || (this.jdField_a_of_type_Int == 70) || (this.jdField_a_of_type_Int == 76) || (this.jdField_a_of_type_Int == 78)) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.i, (int)this.r, this.jdField_b_of_type_ArrayOfByte, localbdsq, this.jdField_a_of_type_Bdzn.jdField_a_of_type_ArrayOfByte, false);
      } else {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.i, (int)this.r, bgva.a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_ArrayOfByte, localbdsq);
      }
    }
  }
  ...
  public final void aN_()
  {
    ...
    if (36 == this.jdField_a_of_type_Int)
    {
      ...
      this.jdField_a_of_type_Bduk.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bdzn.i;
      aL_();
    }
    for (;;)
    {
      ...
      else if (78 == this.jdField_a_of_type_Int)
      {
        this.jdField_a_of_type_Bduk.k = ((String)this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangObject);
        aL_();
      }
      else
      {
  ...
  public final int c()
  {
    ...
    if ((this.jdField_a_of_type_Int != 54) && (l >= beao.a()))
    {
  ...
  final void d()
  {
    ...
    if (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null)
    {
      ...
      if ((this.jdField_a_of_type_Int == 20) && (bdsx.a(120509L).equals(this.jdField_a_of_type_JavaUtilHashMap.get("param_reason")))) {
        localayyu.jdField_b_of_type_Int = 120509;
      }
      if (this.jdField_a_of_type_Int == 9)
      {
        str = (String)this.jdField_a_of_type_JavaUtilHashMap.get("param_reason");
        if (!bdsx.a(400010L).equals(str)) {
          break label208;
        }
        localayyu.jdField_b_of_type_Int = 400010;
      }
    }
    for (;;)
    {
      ...
      return;
      label208:
      if (bdsx.a(400011L).equals(str)) {
        localayyu.jdField_b_of_type_Int = 400011;
      }
    }
  }
  ...
  final void e()
  {
    ...
    if (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null)
    {
      ...
      if (this.jdField_a_of_type_Int == 20) {
        localayyu.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bduk.g;
      }
      this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt.b(localayyu);
    }
  ...
  public final void onResp(bdwt parambdwt)
  {
