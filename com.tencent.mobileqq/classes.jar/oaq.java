...
public class oaq
{
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, ProteusBannerVideoItemData paramProteusBannerVideoItemData, Context paramContext, int paramInt)
  {
    ...
    return false;
    label109:
    if (onh.b.equals(paramAdvertisementInfo))
    {
      if (paramInt == 0) {
        return false;
      }
      if ((paramInt == 1) && (paramContext != null) && (qkr.a(paramContext))) {
        return true;
      }
      if ((paramInt == 2) && (paramContext != null) && (bbfj.g(paramContext))) {
        return true;
      }
    }
    if (onh.c.equals(paramAdvertisementInfo))
    {
      if (paramInt == 0) {
        return false;
      }
      ...
      if ((paramInt == 2) && (paramContext != null) && (qkr.a(paramContext))) {
        return true;
      }
    }
    return false;
