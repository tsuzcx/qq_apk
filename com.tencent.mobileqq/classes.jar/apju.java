...
public class apju
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new apjv(this);
  ...
  public apju(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Apjs = ((apjs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(259));
  }
  ...
  private String b(String paramString)
  {
    if ((paramString != null) && (!"".equals(paramString)))
    {
      ...
      return aljq.bi + ammj.a(str) + paramString + ".jpg";
    }
    return "";
  }
  ...
  public int a()
  {
    return (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - azgq.a(11.0F) * 2 - azgq.a(2.0F) * 2) / 3;
  }
  ...
  public int a(URLDrawable paramURLDrawable)
  {
        ...
        if (bame.b(str))
        {
          ...
          if (str != null)
          {
            ...
            if (!"".equals(str))
            {
              ...
              str = aljq.bi + ammj.a((String)localObject) + str + ".jpg";
            }
          }
        }
      }
    ...
    try
    {
      ...
      i = agem.a(this.jdField_a_of_type_AndroidContentContext, str);
      return i;
    }
  ...
  public Drawable a(Drawable paramDrawable, int paramInt)
  {
    ...
    for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
    {
      ...
      return new BitmapDrawable(bdda.a((Bitmap)localObject, ((Bitmap)localObject).getWidth(), ((Bitmap)localObject).getHeight()));
    }
  }
  ...
  public EmoticonFromGroupEntity a(MessageRecord paramMessageRecord)
  {
    ...
    if ((localMessageForPic.imageType == 3) || (localMessageForPic.imageType == 2000))
    {
      ...
      paramMessageRecord = baul.a(localMessageForPic, 65537);
      ...
      paramMessageRecord = baul.a(localMessageForPic, 1);
      if (paramMessageRecord != null) {
        break label162;
      }
    }
    ...
    if (l >= paramLong)
    {
      ...
      if (7 > i)
      {
        ...
        default: 
          return null;
        case 0: 
          return alpo.a(2131704439);
        case 1: 
          return alpo.a(2131704463);
        case 2: 
          return alpo.a(2131704426);
        case 3: 
          return alpo.a(2131704440);
        case 4: 
          return alpo.a(2131704422);
        case 5: 
          return alpo.a(2131704446);
        }
        return alpo.a(2131704454);
      }
  ...
  {
    if ((paramString != null) && (!paramString.isEmpty()) && (bame.b(paramString)))
    {
      paramString = bame.a(paramString);
      if (paramString != null) {
  ...
  {
    return this.jdField_a_of_type_Apjs.c();
  }
  ...
  public Map<String, List<EmoticonFromGroupEntity>> a(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      {
        localObject = new TreeMap(new apjw(this));
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonFromGroup_Manager", 2, "init mEmoManager.mCountOfSpare:" + this.jdField_a_of_type_Apjs.b);
    }
  }
  ...
  public void a(Context paramContext, MessageForPic paramMessageForPic, View paramView)
  {
    ...
    bilx.a(paramContext, localBundle, new AIOImageProviderService(paramMessageForPic.selfuin, null, -1, paramMessageForPic), agem.a(paramMessageForPic), -1, -1);
  }
  
  public void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Apjs.a(paramEmoticonFromGroupEntity, 2);
  }
  
  public void a(MessageRecord paramMessageRecord)
  {
    if (a(paramMessageRecord)) {
      this.jdField_a_of_type_Apjs.b(paramMessageRecord);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (paramString = (String)localObject;; paramString = null)
    {
      if (paramString != null)
      {
        ...
        {
          if ((alpw.a(paramString.msg)) || (alnp.a(paramString.msg))) {
            armz.a(2131692748);
          }
        }
        else
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString.msg, new apka(localMqqHandler));
  ...
  public void a(List<MessageRecord> paramList)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Apjs.a() >= 600) || (this.jdField_a_of_type_Apjs.b() >= 300))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((this.jdField_a_of_type_JavaUtilList.contains(localInteger)) && (!alnp.a(localMessageRecord)) && (!aupu.a(localMessageRecord)))
          {
            if (QLog.isColorLevel()) {
              QLog.i("EmoticonFromGroup_Manager", 2, "filterMessageByType type: " + localInteger);
            }
            this.jdField_a_of_type_Apjs.a(localMessageRecord);
          }
        }
      }
    }
  ...
  public boolean a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    if (this.jdField_a_of_type_Apjs.b < 1)
    {
      if (300 == apkc.a) {
      ...
      do
      {
        do
        {
          ...
          paramEmoticonFromGroupEntity = new apjx(this, (BaseActivity)localObject);
        } while (localObject == null);
        paramEmoticonFromGroupEntity = bdcd.a((Context)localObject, 0, alpo.a(2131704443), ((BaseActivity)localObject).getString(2131689689), alpo.a(2131704441), alpo.a(2131704465), paramEmoticonFromGroupEntity, paramEmoticonFromGroupEntity);
      } while (paramEmoticonFromGroupEntity == null);
      paramEmoticonFromGroupEntity.show();
      return false;
    }
    localObject = this.jdField_a_of_type_Apjs;
    ((apjs)localObject).b -= 1;
    c(paramEmoticonFromGroupEntity);
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2, 2131692082, 0).b(2131298914);
    return true;
  }
  ...
  {
    return this.jdField_a_of_type_Apjs.b();
  }
  
  public void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Apjs.a(paramEmoticonFromGroupEntity);
  }
  ...
  {
    this.jdField_a_of_type_Apjs.a(paramList, 2);
  }
  ...
  public void c(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    {
      this.jdField_a_of_type_Apjs.jdField_a_of_type_JavaUtilList.add(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new apjz(this, localURLDrawable));
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Apjs.jdField_a_of_type_JavaUtilList.remove(localURLDrawable);
  ...
  {
    this.jdField_a_of_type_Apjs.a(paramList);
  }
