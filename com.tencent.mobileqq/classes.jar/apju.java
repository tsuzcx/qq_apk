...
public class apju
{
  ...
  public static int a(apiy paramapiy, int paramInt1, int paramInt2)
  {
    int i = paramInt2;
    if (paramInt2 == -1) {
      i = 0;
    }
    Camera.CameraInfo localCameraInfo = paramapiy.a()[paramInt1];
    if (localCameraInfo.facing == 1) {
      return (paramapiy.a().a(paramInt1, localCameraInfo.orientation) - i + 360) % 360;
    }
    return (paramapiy.a().a(paramInt1, localCameraInfo.orientation) + i) % 360;
  }
  ...
  private static boolean a(SharedPreferences paramSharedPreferences, String paramString, int paramInt)
  {
    ...
    //   2: iconst_4
    //   3: ldc_w 381
    //   6: invokestatic 112	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   9: aload_1
    //   10: invokestatic 387	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   13: ifeq +14 -> 27
    //   16: ldc 76
    //   18: iconst_4
    //   19: ldc_w 389
    //   22: invokestatic 392	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   25: iconst_0
    //   26: ireturn
    //   27: iconst_0
    //   28: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   31: astore 6
    //   33: aload 6
    //   35: astore 5
    //   37: invokestatic 402	org/xmlpull/v1/XmlPullParserFactory:newInstance	()Lorg/xmlpull/v1/XmlPullParserFactory;
    //   40: invokevirtual 406	org/xmlpull/v1/XmlPullParserFactory:newPullParser	()Lorg/xmlpull/v1/XmlPullParser;
    //   43: astore 7
    //   45: aload 6
    //   47: astore 5
    //   49: aload 7
    //   51: new 408	java/io/StringReader
    //   54: dup
    //   55: aload_1
    //   56: invokespecial 411	java/io/StringReader:<init>	(Ljava/lang/String;)V
    //   59: invokeinterface 417 2 0
    //   64: aload 6
    //   66: astore 5
    //   68: aload 7
    //   70: invokeinterface 420 1 0
    //   75: istore_3
    //   76: aload 6
    //   78: astore 5
    //   80: aload_0
    //   81: invokeinterface 240 1 0
    //   86: astore 8
    //   88: aload 6
    //   90: astore 5
    //   92: aload 8
    //   94: invokeinterface 423 1 0
    //   99: pop
    //   100: aload 6
    //   102: astore 5
    //   104: aload 8
    //   106: ldc 21
    //   108: iload_2
    //   109: invokeinterface 246 3 0
    //   114: pop
    //   115: aload 6
    //   117: astore 5
    //   119: invokestatic 284	apjt:a	()Lapjt;
    //   122: invokevirtual 286	apjt:a	()Ljava/lang/String;
    //   125: astore 9
    //   127: aload 6
    //   129: astore 5
    ...
    //   149: getstatic 430	android/os/Build:DISPLAY	Ljava/lang/String;
    //   152: ldc_w 432
    //   155: ldc_w 425
    //   158: invokevirtual 436	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   161: invokevirtual 439	java/lang/String:toUpperCase	()Ljava/lang/String;
    ...
    //   221: invokestatic 112	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   224: goto +688 -> 912
    //   227: aload_0
    //   228: astore 5
    //   230: aload 7
    //   232: invokeinterface 446 1 0
    //   237: istore_2
    //   238: goto +682 -> 920
    //   241: goto -14 -> 227
    //   244: aload 7
    //   246: invokeinterface 449 1 0
    //   251: astore_1
    //   252: aload_1
    //   253: aload 9
    //   255: invokevirtual 453	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   258: ifeq +341 -> 599
    ...
    //   312: invokestatic 460	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   315: aload 7
    //   317: invokeinterface 463 1 0
    //   322: istore_3
    //   323: iconst_0
    //   324: istore_2
    //   325: iload_2
    ...
    //   330: aload 7
    //   332: iload_2
    //   333: invokeinterface 466 2 0
    //   338: astore_1
    //   339: aload 7
    //   341: iload_2
    //   342: invokeinterface 469 2 0
    //   347: astore 5
    //   349: aload_1
    //   350: ldc 252
    //   352: invokevirtual 453	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   355: ifeq +74 -> 429
    //   358: aload 5
    //   360: invokestatic 472	java/lang/Boolean:parseBoolean	(Ljava/lang/String;)Z
    //   363: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   366: invokevirtual 475	java/lang/Boolean:booleanValue	()Z
    //   369: istore 4
    ...
    //   423: invokestatic 112	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   426: goto +533 -> 959
    //   429: aload_1
    //   430: ldc_w 483
    //   433: invokevirtual 486	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   436: ifeq +40 -> 476
    //   439: aload 8
    //   441: aload_1
    //   442: aload 5
    //   444: invokestatic 492	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   447: invokestatic 495	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   450: invokevirtual 498	java/lang/Integer:intValue	()I
    //   453: invokeinterface 246 3 0
    //   458: pop
    //   459: goto -88 -> 371
    //   462: astore_0
    //   463: ldc 76
    ...
    //   471: invokestatic 501	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   474: aload_0
    //   475: athrow
    //   476: aload_1
    //   477: ldc_w 503
    //   480: invokevirtual 486	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   483: ifeq +34 -> 517
    //   486: aload 8
    //   488: aload_1
    //   489: aload 5
    //   491: invokestatic 506	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   494: invokeinterface 510 3 0
    //   499: pop
    //   500: goto -129 -> 371
    //   503: astore_0
    //   504: ldc 76
    ...
    //   512: invokestatic 501	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   515: aload_0
    //   516: athrow
    //   517: aload 8
    //   519: aload_1
    //   520: aload 5
    //   522: invokestatic 472	java/lang/Boolean:parseBoolean	(Ljava/lang/String;)Z
    //   525: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   528: invokevirtual 475	java/lang/Boolean:booleanValue	()Z
    //   531: invokeinterface 256 3 0
    //   536: pop
    //   537: goto -166 -> 371
    //   540: astore_1
    //   541: ldc 76
    ...
    //   549: invokestatic 501	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    ...
    //   574: aload_0
    //   575: invokevirtual 515	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   578: invokevirtual 108	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   581: invokestatic 112	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   584: aload_0
    //   585: invokevirtual 475	java/lang/Boolean:booleanValue	()Z
    //   588: ireturn
    //   589: iconst_1
    //   590: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   593: astore_1
    //   594: aload_1
    //   595: astore_0
    //   596: goto -369 -> 227
    //   599: ldc_w 517
    //   602: aload_1
    //   603: invokevirtual 453	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   606: ifeq +350 -> 956
    //   609: aload 7
    //   611: invokeinterface 463 1 0
    //   616: istore_3
    //   617: iconst_0
    //   618: istore_2
    //   619: iload_2
    ...
    //   624: aload 7
    //   626: iload_2
    //   627: invokeinterface 466 2 0
    //   632: astore_1
    //   633: aload 7
    //   635: iload_2
    //   636: invokeinterface 469 2 0
    //   641: astore 5
    //   643: aload_1
    //   644: ldc 252
    //   646: invokevirtual 453	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   649: ifeq +74 -> 723
    //   652: aload 5
    //   654: invokestatic 472	java/lang/Boolean:parseBoolean	(Ljava/lang/String;)Z
    //   657: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   660: invokevirtual 475	java/lang/Boolean:booleanValue	()Z
    //   663: istore 4
    ...
    //   714: invokevirtual 108	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   717: invokestatic 112	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   720: goto +246 -> 966
    //   723: aload_1
    //   724: ldc_w 483
    //   727: invokevirtual 486	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   730: ifeq +26 -> 756
    //   733: aload 8
    //   735: aload_1
    //   736: aload 5
    //   738: invokestatic 492	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   741: invokestatic 495	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   744: invokevirtual 498	java/lang/Integer:intValue	()I
    //   747: invokeinterface 246 3 0
    //   752: pop
    //   753: goto -88 -> 665
    //   756: aload_1
    //   757: ldc_w 503
    //   760: invokevirtual 486	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   763: ifeq +20 -> 783
    //   766: aload 8
    //   768: aload_1
    //   769: aload 5
    //   771: invokestatic 506	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   774: invokeinterface 510 3 0
    //   779: pop
    //   780: goto -115 -> 665
    //   783: aload 8
    //   785: aload_1
    //   786: aload 5
    //   788: invokestatic 472	java/lang/Boolean:parseBoolean	(Ljava/lang/String;)Z
    //   791: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   794: invokevirtual 475	java/lang/Boolean:booleanValue	()Z
    //   797: invokeinterface 256 3 0
    //   802: pop
    //   803: goto -138 -> 665
    //   806: aload_0
    //   807: invokevirtual 475	java/lang/Boolean:booleanValue	()Z
    //   810: ifeq +53 -> 863
    //   813: aload 8
    //   815: ldc 252
    //   817: iload 4
    //   819: invokeinterface 256 3 0
    //   824: pop
    //   825: ldc 76
    //   827: iconst_1
    ...
    //   841: iload 4
    //   843: invokevirtual 303	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   846: invokevirtual 108	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   849: invokestatic 112	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   852: aload 8
    ...
    //   891: iload 4
    //   893: invokevirtual 303	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   896: invokevirtual 108	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   899: invokestatic 112	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   902: goto -50 -> 852
    //   905: astore_1
    //   906: aload 5
    //   908: astore_0
  ...
  {
    return Build.VERSION.SDK_INT >= apjs.a().a();
  }
