      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (ausx)localField.getAnnotation(ausx.class);
            if (localObject4 != null) {
              paramClass = ((ausx)localObject4).a();
            }
  ...
  public static <T> JSONObject a(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (ausx)((Field)localObject1).getAnnotation(ausx.class);
        if (localObject2 != null)
        {
          localObject2 = ((ausx)localObject2).a();
