  ...
  extends oqg
{
  ...
  public oqf(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
  ...
  {
    List localList = this.jdField_a_of_type_Atmp.a(ReadInJoyDraftboxItem.class);
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localReadInJoyDraftboxItem.firstPicData = ((ReadInJoyDraftboxItem.PicData)badz.a(localReadInJoyDraftboxItem.firstPic, ReadInJoyDraftboxItem.PicData.CREATOR));
      }
    }
    return localList;
  }
    ...
    do
    {
      ...
      if (paramLong == -1L)
      {
        ...
        if (TextUtils.isEmpty(localReadInJoyDraftboxItem.title))
        {
          ...
          localReadInJoyDraftboxItem.title = ajjy.a(2131646957);
        }
        localReadInJoyDraftboxItem.content = badz.a(paramReadInJoyDraftboxContent);
        ...
        if ((paramReadInJoyDraftboxContent != null) && (paramReadInJoyDraftboxContent.size() > 0)) {
          localReadInJoyDraftboxItem.firstPic = badz.a((ReadInJoyDraftboxItem.PicData)paramReadInJoyDraftboxContent.get(0));
        }
        if (!a(localReadInJoyDraftboxItem)) {
          continue;
        }
        localReadInJoyDraftboxItem = (ReadInJoyDraftboxItem)this.jdField_a_of_type_Atmp.a(ReadInJoyDraftboxItem.class, "time = ?", new String[] { paramLong + "" });
  ...
  public SpannableStringBuilder a(List<SocializeFeedsInfo.BiuCommentInfo> paramList, Context paramContext, EditText paramEditText, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
      {
        ...
        localArrayList.add(new ret(j, j + ((String)localObject).length(), new BiuNicknameSpan(localBiuCommentInfo.jdField_a_of_type_JavaLangLong.toString(), localBiuCommentInfo.b.longValue(), (CharSequence)localObject, paramContext, paramEditText.getPaint(), paramInt)));
        j = localStringBuilder.length();
        i += 1;
        break;
        ...
        if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
        {
          ...
          localArrayList.add(new ret(j, str2.length() + j, new rer(str3, 13421772)));
          continue;
        }
        ...
        if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
        {
          ...
          localArrayList.add(new ret(j, str2.length() + j, new TopicSpan((TopicInfo)localObject)));
          continue;
        }
        localObject = localBiuCommentInfo.jdField_a_of_type_JavaLangString;
        continue;
      ...
      str2 = awbk.b(localBiuCommentInfo.jdField_a_of_type_JavaLangString);
      continue;
      if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null) {}
      for (String str1 = "";; str1 = awbk.b(localBiuCommentInfo.jdField_a_of_type_JavaLangString))
      {
        localStringBuilder.append(str1);
        break;
      }
      paramList = new SpannableStringBuilder(new axkd(localStringBuilder, 7, 20));
      paramContext = localArrayList.iterator();
      while (paramContext.hasNext())
      {
        paramEditText = (ret)paramContext.next();
  ...
  public ReadInJoyDraftboxItem.ReadInJoyDraftboxContent a(long paramLong)
  {
    ...
    if (localReadInJoyDraftboxItem != null)
    {
      ...
      if (localReadInJoyDraftboxItem.content != null)
      {
        ...
        {
          localReadInJoyDraftboxContent2 = (ReadInJoyDraftboxItem.ReadInJoyDraftboxContent)badz.a(localReadInJoyDraftboxItem.content, ReadInJoyDraftboxItem.ReadInJoyDraftboxContent.CREATOR);
          localReadInJoyDraftboxContent1 = localReadInJoyDraftboxContent2;
          if (QLog.isColorLevel())
          {
  ...
  {
    ReadInJoyDraftboxItem localReadInJoyDraftboxItem = (ReadInJoyDraftboxItem)this.jdField_a_of_type_Atmp.a(ReadInJoyDraftboxItem.class, paramLong);
    String str2;
    StringBuilder localStringBuilder;
    if (QLog.isColorLevel())
    {
  ...
  public void a(ptl paramptl)
  {
    ...
    paramptl.a(localList);
  }
  
  public boolean a()
  {
    boolean bool = this.jdField_a_of_type_Atmp.a(ReadInJoyDraftboxItem.class);
    if (QLog.isColorLevel()) {
  ...
  public boolean a(long paramLong)
  {
    ...
    localObject = Boolean.valueOf(this.jdField_a_of_type_Atmp.b((atmo)localObject));
    if (QLog.isColorLevel()) {
