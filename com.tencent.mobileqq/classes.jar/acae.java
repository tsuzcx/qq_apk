...
{
  public acae(ScoreQAVFragment paramScoreQAVFragment) {}
  ...
  protected HashMap<Integer, Integer> a(String... paramVarArgs)
  {
    ...
    paramVarArgs = bbjn.e(this.a.jdField_d_of_type_JavaLangString);
    this.a.b = paramVarArgs.getString(ldi.h, "");
    paramVarArgs = mtb.a();
    this.a.b(paramVarArgs);
    paramVarArgs = lcy.b(270).a;
    this.a.a(paramVarArgs);
    if (this.a.e.isEmpty())
    {
      this.a.e = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131696144);
      if (QLog.isColorLevel()) {
    ...
    if (this.a.f.isEmpty())
    {
      this.a.f = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131696142);
      if (QLog.isColorLevel()) {
    ...
    if (this.a.g.isEmpty())
    {
      this.a.g = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131696143);
      if (QLog.isColorLevel()) {
    ...
    catch (Exception paramVarArgs)
    {
      ...
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713576));
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713569));
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713572));
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713575));
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713570));
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713574));
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713571));
      this.a.jdField_a_of_type_JavaUtilList.add(ajyc.a(2131713573));
