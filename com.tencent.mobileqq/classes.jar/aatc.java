...
public class aatc
{
  public static int a(Context paramContext, AdAppBtnData paramAdAppBtnData)
  {
    ...
    do
    {
      ...
      paramContext = bfkr.a().b(paramAdAppBtnData);
  ...
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      {
        return -1;
        paramContext = bfkr.a().b(paramString2);
  ...
  {
    amcw.a("scheme", paramString1, paramString2, "4", "gdtAppAd", paramContext.getClass().getName());
  }
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject5 = bfiu.a(str);
        localObject4 = (String)((HashMap)localObject5).get("appid");
        localObject1 = localObject4;
        localObject3 = str;
        if (TextUtils.isEmpty((CharSequence)localObject4))
        {
          localObject1 = (String)((HashMap)localObject5).get(bfoh.b);
          localObject3 = str;
        }
        str = bfiu.g() + File.separator + "qapp_center_detail.htm";
        ...
        if ("1".equals((String)bfiu.a(paramBundle.getString("schemaUrl")).get("auto_download")))
        {
          localObject3 = localObject1;
        ...
        ((Intent)localObject5).setClass(bfbm.a().a(), QZoneAppListActivity.class);
        ...
        bfbm.a().a().startActivity((Intent)localObject5);
        return;
      }
  ...
  public static void a(GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    {
      ((aasf)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(110)).a(BaseApplicationImpl.getContext(), paramGdtBaseAdItem);
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      localDownloadInfo = bfkr.a().c(paramString);
  ...
  public static boolean b(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    try
    {
      ...
      bool2 = true;
      bool1 = bool3;
      aass.a(138, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
      bool1 = bool3;
      a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
      bool1 = bool3;
      aase.a("GdtAppOpenUtil", "launchAPPMain report " + paramGdtBaseAdItem.toString());
      bool1 = bool2;
      return bool1;
    }
    catch (Exception paramContext)
    {
      aase.d("GdtAppOpenUtil", "launchApp failed", paramContext);
    }
    return bool1;
  }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localDownloadInfo = bfkr.a().b(paramString);
        bool2 = bool1;
  ...
  private static boolean c(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (a(paramContext, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramGdtBaseAdItem.c))
    {
      ...
      try
      {
        ...
        bool2 = true;
        bool1 = bool3;
        aass.a(137, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
        bool1 = bool3;
        a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
        bool1 = bool3;
        aase.a("GdtAppOpenUtil", "launchAPPDeepLink report " + paramGdtBaseAdItem.toString());
        bool1 = bool2;
        return bool1;
      }
      catch (Exception paramContext)
      {
        aase.d("GdtAppOpenUtil", "launchAPPDeepLink failed", paramContext);
        return bool1;
      }
    }
