  ...
  extends WebViewPlugin
{
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Ntg == null) {
      this.jdField_a_of_type_Ntg = new ntg(this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView, new aatd(this));
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getLayoutInflater().inflate(2131559067, null));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379183));
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379178));
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new aate(this));
        }
