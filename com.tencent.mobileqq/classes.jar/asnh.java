...
public class asnh
{
  ...
  public asnh(Context paramContext, MessageRecord paramMessageRecord)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = asnl.a(paramMessageRecord);
    this.jdField_b_of_type_JavaLangString = asnl.a(paramMessageRecord, 0);
    a();
  }
  
  public asnh(Context paramContext, QQGameMsgInfo paramQQGameMsgInfo)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  ...
  public static Bitmap a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if (arso.b(paramString1)) {
      return asnk.a(paramString1 + "/" + paramString2, paramInt1, paramInt2);
    }
    return null;
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      ...
      aahi.a(localHashMap, paramString1);
      ...
      aahi.a(akwd.a(), "769", paramString3, paramString2, "76906", "1", "160", localHashMap);
    }
  }
  
  public void a(View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131366988));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131366989));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366986));
    ...
    this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView = ((FullPopVideoView)paramView.findViewById(2131379727));
    this.d = ((ImageView)paramView.findViewById(2131368111));
  }
  ...
  public void a(AppInterface paramAppInterface, MessageRecord paramMessageRecord, QQGameMsgInfo paramQQGameMsgInfo)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramMessageRecord != null) {
          paramMessageRecord = asnm.a(paramMessageRecord);
        }
        for (;;)
        {
          if (paramMessageRecord == null) {
    ...
    asnm.a(paramAppInterface, paramMessageRecord.resUrl, new asni(this, paramMessageRecord), false);
    return;
    label355:
    if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (!QLog.isColorLevel()) {
      ...
      {
        return;
        this.jdField_a_of_type_Asll = new askz(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramBoolean);
      }
    }
