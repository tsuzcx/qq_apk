...
public class pvl
{
  ...
  private pwh jdField_a_of_type_Pwh = new pwh();
  
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.atlas.." + pvl.class.getSimpleName();
    b = anni.a(2131711672);
    c = anni.a(2131711583);
    d = anni.a(2131711743);
  ...
  public static pvl a()
  {
    if (jdField_a_of_type_Pvl == null) {}
    try
    {
      if (jdField_a_of_type_Pvl == null) {
        jdField_a_of_type_Pvl = new pvl();
      }
      return jdField_a_of_type_Pvl;
    }
    finally {}
  }
  ...
  {
    new bljl(6).a("nLinkType", 0).b("sTitle", paramString2).b("sUrl", paramString6).a("bAppShare", false).a("lAppId", 0L).b("sPublisher", paramString4).b("sBrief", paramString3).b("sPath", paramString5).b("sResUrl", paramString6).a("lCategory", 8L).b("sBizDataList", paramArrayList).b(paramActivity, paramString1, -1, null);
  }
  
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    boolean bool = false;
    if (pha.a(BaseApplicationImpl.getApplication().getRuntime(), "Key_First_ReadInJoy_Favorite", true) == null)
    {
      pha.a("Key_First_ReadInJoy_Favorite", Integer.valueOf(1), true);
      if (!paramBoolean) {
        bglp.a(paramContext, 230, paramContext.getString(2131692028), "你可在看点内点击“我的”找到“我的收藏”。\n收藏的内容将会上传保存，在其他手机上登录QQ，也可以在看点内找到你收藏的内容。\n", 2131690582, 2131692026, new pvn(), null).setMessageCount(null).show();
      }
      bool = true;
    }
    return bool;
  ...
  public void a(Activity paramActivity, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        new bljl(6).a("nLinkType", 0).b("sTitle", paramString3).b("sUrl", paramString6).a("bAppShare", false).a("lAppId", 0L).b("sPublisher", paramString2).b("sBrief", paramString4).b("sPath", paramString5).b("sResUrl", paramString6).a("lCategory", 8L).b("sBizDataList", localArrayList).a(paramActivity, paramString1);
        return;
      }
  ...
  public void a(Activity paramActivity, String paramString1, int paramInt, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    new bljl(6).a("sCIDListToBeDelete", paramArrayList).b("sBizDataList", paramString2).a(paramActivity, paramString1, -1, null);
  }
  
  public void a(List<String> paramList, pvo parampvo)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "getAtlasFavoriteStatus, rowKeyList = " + paramList + ", callback = " + parampvo);
    }
    ...
    nir.a((AppInterface)BaseApplicationImpl.getApplication().getRuntime(), new pvm(this, parampvo), localReqBody.toByteArray(), "OidbSvc.0xb40", 2880, 1, paramList, 0L);
  }
}
