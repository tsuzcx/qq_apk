...
public class aeid
  extends xpk
  implements aegr, DialogInterface.OnCancelListener, bfos
{
  long jdField_a_of_type_Long;
  public aeic a;
  aeil jdField_a_of_type_Aeil;
  ...
  public aeid(Activity paramActivity, xpj paramxpj, aejb paramaejb, String paramString)
  {
  ...
  public int a()
  {
    ...
    AIORichMediaData localAIORichMediaData = ((aeiy)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
  ...
  {
    this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter = new aeis(this.jdField_a_of_type_AndroidAppActivity, paramInt, this.jdField_a_of_type_Aeic, this.jdField_a_of_type_Aejb, this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView);
    this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Aeic);
  ...
  void a(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bbgu.setOnDismissListener(new aeig(this));
    Object localObject;
    switch (paramInt1)
    {
    case 2: 
    default: 
      ...
      return;
    case 1: 
      this.jdField_a_of_type_Bbgu.setTitle(String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689933), new Object[] { Integer.valueOf(paramInt2) }));
      this.jdField_a_of_type_Bbgu.setPositiveButton(2131694794, new bbdt());
      this.jdField_a_of_type_Bbgu.show();
      return;
    case 0: 
      this.jdField_a_of_type_Bbgu.setTitle(2131689901);
      localObject = new aeih(this, paramInt2);
      this.jdField_a_of_type_Bbgu.setNegativeButton(2131690596, (DialogInterface.OnClickListener)localObject);
      this.jdField_a_of_type_Bbgu.setPositiveButton(2131719431, (DialogInterface.OnClickListener)localObject);
      this.jdField_a_of_type_Bbgu.show();
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    if (paramInt2 == 22)
    {
      localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131719062);
      str = this.jdField_a_of_type_AndroidAppActivity.getString(2131719061);
    }
    for (;;)
    {
      this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, (String)localObject, str, null, null);
      this.jdField_a_of_type_Bbgu.setTitle((String)localObject);
      ...
      if (paramInt2 == 24)
      {
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131719067);
        str = this.jdField_a_of_type_AndroidAppActivity.getString(2131719066);
      }
      else if (paramInt2 == 23)
      {
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131719064);
        str = this.jdField_a_of_type_AndroidAppActivity.getString(2131719063);
      }
      else
      {
        localObject = null;
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String arg6)
  {
    ...
    {
      return;
      localObject4 = this.jdField_a_of_type_Aeic;
      if (paramInt3 != 1) {
        break;
      }
      localObject1 = ???;
      i = ((aeic)localObject4).a(paramLong, paramInt1, paramInt2, (String)localObject1, true);
      if (paramInt2 != 1) {
        break label240;
      }
      ...
      if ((i >= j) && (i <= k + j - 1))
      {
        ...
        ((aeis)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).a(i, (View)localObject1);
      }
      if ((paramInt2 != 2) || (this.jdField_a_of_type_Aeil == null)) {
        break label313;
      }
      localObject1 = this.jdField_a_of_type_Aeil;
    } while ((((aeil)localObject1).jdField_a_of_type_Aeiy == null) || (((aeil)localObject1).jdField_a_of_type_Aeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramLong) || (((aeil)localObject1).jdField_a_of_type_Aeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int != paramInt1));
    Object localObject4 = (AIOImageData)((aeil)localObject1).jdField_a_of_type_Aeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    if (paramInt3 == 1) {}
    for (;;)
    {
      ((AIOImageData)localObject4).jdField_b_of_type_JavaLangString = ???;
      ((aeil)localObject1).jdField_a_of_type_Aeiy.jdField_a_of_type_Boolean = false;
      synchronized (((aeil)localObject1).jdField_a_of_type_Aeiy)
      {
        ((aeil)localObject1).jdField_a_of_type_Aeiy.notifyAll();
        return;
      }
      ...
      ((aeis)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).a(i, (View)localObject3);
      break label109;
      label313:
      break;
      ??? = "I:E";
  ...
  void a(Integer... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Aeil = new aeil(this, this.jdField_a_of_type_JavaUtilArrayList);
    this.jdField_a_of_type_Aeil.execute(paramVarArgs);
  }
  ...
  boolean a(aeiy paramaeiy, boolean paramBoolean1, boolean paramBoolean2)
  {
    int i = a();
    if (paramBoolean2)
    {
    ...
    if ((j == 2) && (paramBoolean1) && (this.jdField_a_of_type_JavaUtilArrayList.size() >= 20))
    {
      ...
      if (l - this.jdField_a_of_type_Long >= 700L)
      {
        ...
        bcql.a(this.jdField_a_of_type_AndroidAppActivity, 1, ajya.a(2131700098) + 20 + ajya.a(2131700093), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      }
      for (;;)
      {
        ...
        return false;
        label174:
        bcql.a(this.jdField_a_of_type_AndroidAppActivity, 1, ajya.a(2131700088) + 20 + ajya.a(2131700092), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      }
    }
    if ((AIOFilePicData.class.isInstance(paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) && (paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(20) == null) && (paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(18) == null) && (paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(16) == null))
    {
      if (QLog.isColorLevel()) {
  ...
  boolean a(View paramView, xpv paramxpv)
  {
    ...
    if (localObject != null)
    {
      paramView = ((aeit)localObject).jdField_a_of_type_AndroidWidgetImageView;
      localObject = ((aeit)localObject).jdField_b_of_type_AndroidWidgetImageView;
      switch (paramxpv.b())
      {
      default: 
  ...
  void b(int paramInt1, int paramInt2)
  {
    ...
    default: 
      return;
    case 20: 
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, 2, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689931) + ajsd.bc, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      return;
    case 21: 
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, 1, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689930) + ajsd.bc, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      return;
    case 22: 
    case 23: 
    case 24: 
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_Aeic = null;
    aegp.a().b(this);
  }
  ...
  protected void i()
  {
    ...
    for (;;)
    {
      ...
      {
        if (((((aeiy)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) && (((AIOImageData)((aeiy)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).e == null)) {
          j = 1;
        }
      }
      else
      {
        ...
        localbfpc.a(new aeie(this, localbfpc));
        localbfpc.show();
  ...
  protected void j()
  {
    ...
    do
    {
      ...
      localaeiy = (aeiy)((Iterator)localObject).next();
      if (!AIOImageData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
        break;
      }
    } while (((AIOImageData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(2) != null);
    label213:
    for (int i = 0;; i = 1)
    {
      if (i != 0) {
      ...
      for (;;)
      {
        ...
        boolean bool = SettingCloneUtil.readValue((Context)localObject, null, ((Context)localObject).getString(2131695322), "qqsetting_auto_receive_pic_key", true);
        i = bbfj.b((Context)localObject);
        if (i == -1) {
  ...
  public void k()
  {
    ...
    if (this.jdField_a_of_type_Aeic != null)
    {
      j = this.jdField_a_of_type_Aeic.f();
      k = this.jdField_a_of_type_Aeic.e();
      i = this.jdField_a_of_type_Aeic.d();
      if (QLog.isColorLevel()) {
      ...
      {
        i = this.jdField_a_of_type_Aeic.b();
        j = this.jdField_a_of_type_Aeic.e();
        k = this.jdField_a_of_type_Aeic.d();
  ...
  protected void m()
  {
    ...
    {
      if ((this.jdField_a_of_type_JavaUtilArrayList.get(i) != null) && (((aeiy)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null)) {
        arrayOfLong[i] = ((aeiy)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
      }
      i += 1;
    }
    if (this.jdField_a_of_type_Aejb.asBinder().pingBinder())
    {
      this.jdField_a_of_type_Aejb.a(arrayOfLong);
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692830), 0).a();
    }
  }
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = null;
    paramDialogInterface = this.jdField_a_of_type_Aeil;
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      if (((paramInt >= i - 28) || (paramInt == i)) && (this.jdField_d_of_type_Int != i))
      {
        ...
        ((aeis)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).a(true);
        this.jdField_a_of_type_Aejb.a(0);
      }
    }
  }
  ...
  void q()
  {
    ...
    if (bbfj.b(BaseApplication.getContext()) == 1)
    {
      ...
      do
      {
        ...
        localaeiy = (aeiy)((Iterator)localObject).next();
      } while ((!AIOImageData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) || (localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(2) != null));
    }
    for (int k = 0;; k = 1)
    {
      if (k != 0)
  ...
  void r()
  {
    ...
    {
      Object localObject = (aeiy)localIterator.next();
    ...
    aehw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, localArrayList1, localArrayList2, localArrayList3, 2, null, null);
  }
  ...
  void u()
  {
    ...
    aehw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_Int, (List)this.jdField_a_of_type_JavaUtilArrayList.clone(), this.jdField_c_of_type_Boolean, this.jdField_b_of_type_JavaLangString);
  }
  ...
  void v()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.get(0) != null))
    {
      ...
      if (AIOImageData.class.isInstance(((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
      {
        ...
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 1) {
          ((Bundle)localObject1).putString("forward_text", this.jdField_a_of_type_JavaUtilArrayList.size() + ajya.a(2131700090));
        }
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (AIOImageData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
            ((ArrayList)localObject2).add(((AIOImageData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_JavaLangString);
          } else if (AIOFilePicData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
            if (((AIOFilePicData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(20) != null) {
              ((ArrayList)localObject2).add(((AIOFilePicData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_d_of_type_JavaLangString);
            } else if (((AIOFilePicData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(18) != null) {
              ((ArrayList)localObject2).add(((AIOFilePicData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_c_of_type_JavaLangString);
            } else if (((AIOFilePicData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(16) != null) {
              ((ArrayList)localObject2).add(((AIOFilePicData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_JavaLangString);
            }
          }
        }
    ...
    while (!QLog.isColorLevel())
    {
      ...
      ((Bundle)localObject1).putBoolean("forward_urldrawable", true);
      if (this.jdField_a_of_type_JavaUtilArrayList.size() > 1) {
        ((Bundle)localObject1).putString("forward_text", this.jdField_a_of_type_JavaUtilArrayList.size() + ajya.a(2131700091));
      }
      ((Bundle)localObject1).putBoolean("sendMultiple", true);
      localObject2 = new ArrayList();
      localObject3 = this.jdField_a_of_type_JavaUtilArrayList.iterator();
  ...
  void w()
  {
    ((aeis)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    int i;
    if (this.jdField_b_of_type_Boolean)
    {
