  ...
  implements Manager
{
  ...
  private HotChatItemData a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localObject2 == null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        {
          ApolloGameData localApolloGameData = ((amir)paramQQAppInterface.getManager(155)).a(((HotChatInfo)localObject2).name);
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    {
      return;
      localanuz = localQQAppInterface.getProxyManager().a();
  ...
  private void d()
  {
    ...
    do
    {
      ...
      {
        localanuz = localQQAppInterface.getProxyManager().a();
        localObject2 = localanuz.getRecentList(false);
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          for (((HotChatItemData)localObject3).mLatestMsgSec = localMessage.time;; ((HotChatItemData)localObject3).mLatestMsgSec = ((RecentUser)localObject2).lastmsgtime)
          {
            ...
            localanuz.delRecentUser((BaseRecentUser)localObject2);
  ...
  private void d(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = ((amir)((QQAppInterface)localObject).getManager(155)).a(localHotChatItemData.mHotChatCode);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentSharedPreferences != null)
      {
        localObject1 = bfza.a(this.jdField_a_of_type_AndroidContentSharedPreferences, "hotchat_new_unread_list", null);
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      Collections.sort((List)localObject2, new amtn(this));
      Collections.sort((List)localObject1, new amto(this));
  ...
  private void g()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   4: invokevirtual 256	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   7: ifne +4 -> 11
    //   10: return
    //   11: aload_0
    //   12: invokevirtual 329	amtm:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15: astore_3
    //   16: aload_3
    //   17: ifnull -7 -> 10
    //   20: aload_3
    ...
    //   29: astore 4
    //   31: aload_0
    //   32: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   35: invokevirtual 256	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   38: istore_1
    //   39: aconst_null
    //   40: astore_2
    //   41: aload_3
    //   42: invokevirtual 481	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   45: invokevirtual 487	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   48: astore_3
    //   49: aload_3
    //   50: astore_2
    //   51: iload_1
    ...
    //   56: iflt +107 -> 163
    //   59: aload_0
    //   60: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: iload_1
    //   64: invokevirtual 259	java/util/concurrent/CopyOnWriteArrayList:get	(I)Ljava/lang/Object;
    ...
    //   76: invokespecial 489	amtm:d	(Ljava/lang/String;)V
    //   79: aload 4
    //   81: aload_3
    //   82: getfield 119	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   85: invokevirtual 492	com/tencent/mobileqq/app/HotChatManager:b	(Ljava/lang/String;)Z
    //   88: ifne +68 -> 156
    //   91: aload_3
    ...
    //   127: aload_0
    //   128: getfield 56	amtm:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   131: aload_3
    //   132: getfield 119	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   135: invokeinterface 496 2 0
    //   140: pop
    //   141: aload_0
    //   142: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   145: iload_1
    //   146: invokevirtual 498	java/util/concurrent/CopyOnWriteArrayList:remove	(I)Ljava/lang/Object;
    //   149: pop
    //   150: aload_2
    //   151: aload_3
    //   152: invokevirtual 503	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   155: pop
    //   156: iload_1
    //   157: iconst_1
    //   158: isub
    ...
    //   164: ifnull -154 -> 10
    //   167: aload_2
    //   168: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   171: return
    //   172: astore_3
    //   173: ldc 25
    //   175: iconst_1
    ...
    //   181: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   184: aload_2
    //   185: ifnull -175 -> 10
    //   188: aload_2
    //   189: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   192: return
    //   193: astore_3
    //   194: aconst_null
    //   195: astore_2
    ...
    //   197: ifnull +7 -> 204
    //   200: aload_2
    //   201: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   204: aload_3
    //   205: athrow
    //   206: astore_3
    //   207: goto -11 -> 196
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    while ((!TextUtils.isEmpty(paramMessageRecord.frienduin)) && (aquj.b((QQAppInterface)localObject, paramMessageRecord.frienduin))) {
      return;
    }
    for (;;)
    {
  ...
  public boolean a(long paramLong)
  {
    ...
    Object localObject3;
    int i;
    if (!((anuz)localObject1).isRecentUserInCache(AppConstants.HOTCHAT_CENTER_UIN, 5001))
    {
    ...
    Object localObject2 = (RecentUser)((anuz)localObject1).findRecentUserByUin(AppConstants.HOTCHAT_CENTER_UIN, 5001);
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        ((VasExtensionHandler)localQQAppInterface.getBusinessHandler(71)).a(localHotChatItemData.mGameId, "android.aio", false, 2, localHotChatItemData.mHotChatCode);
  ...
  public boolean b(String paramString)
  {
    ...
    //   3: istore 4
    //   5: aload_0
    //   6: invokevirtual 329	amtm:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnull +10 -> 23
    //   16: aload_1
    //   17: invokestatic 225	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   20: ifeq +9 -> 29
    //   23: iconst_0
    //   24: istore 4
    //   26: iload 4
    //   28: ireturn
    //   29: aload 6
    //   31: invokevirtual 481	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   34: invokevirtual 487	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 56	amtm:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   43: aload_1
    //   44: invokeinterface 496 2 0
    ...
    //   97: iload_2
    //   98: aload_0
    //   99: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   102: invokevirtual 256	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   105: if_icmpge +36 -> 141
    //   108: aload_1
    //   109: aload_0
    //   110: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   113: iload_2
    //   114: invokevirtual 259	java/util/concurrent/CopyOnWriteArrayList:get	(I)Ljava/lang/Object;
    ...
    //   123: invokevirtual 249	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   126: ifeq +195 -> 321
    //   129: aload_0
    //   130: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   133: iload_2
    //   134: invokevirtual 498	java/util/concurrent/CopyOnWriteArrayList:remove	(I)Ljava/lang/Object;
    //   137: pop
    //   138: goto +183 -> 321
    //   141: aload 7
    //   143: ifnull +167 -> 310
    ...
    //   151: aload 5
    //   153: aload 7
    //   155: invokespecial 704	com/tencent/mobileqq/app/HotChatCenterManager$2:<init>	(Lamtm;Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/data/HotChatItemData;)V
    //   158: bipush 8
    //   160: aconst_null
    //   161: iconst_0
    //   162: invokestatic 512	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   165: aload_0
    //   166: aload_1
    //   167: aload 6
    //   169: invokespecial 706	amtm:a	(Ljava/lang/String;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   172: iload 4
    //   174: istore_3
    //   175: aload_0
    //   176: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   179: invokevirtual 256	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   182: ifne +39 -> 221
    //   185: iload 4
    //   187: istore_3
    //   188: aload_0
    //   189: getstatic 612	com/tencent/mobileqq/app/AppConstants:HOTCHAT_CENTER_UIN	Ljava/lang/String;
    //   192: sipush 5001
    //   195: invokespecial 559	amtm:b	(Ljava/lang/String;I)V
    //   198: iload 4
    //   200: istore_3
    //   201: aload_0
    //   202: invokevirtual 329	amtm:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   205: ldc 173
    //   207: ldc 175
    //   209: ldc_w 708
    //   212: iconst_1
    ...
    //   223: ifnull +84 -> 307
    //   226: aload 5
    //   228: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   231: iload 4
    //   233: ireturn
    //   234: astore_1
    //   235: aconst_null
    ...
    //   251: ifnull -225 -> 26
    //   254: aload_1
    //   255: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   258: iload_3
    //   259: ireturn
    //   260: astore_1
    //   261: aconst_null
    ...
    //   266: ifnull +8 -> 274
    //   269: aload 5
    //   271: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   274: aload_1
    //   275: athrow
    //   276: astore_1
    //   277: goto -13 -> 264
  ...
  public void c()
  {
    ...
    //   3: astore 4
    //   5: aload_0
    //   6: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   9: invokevirtual 256	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   12: ifle +4 -> 16
    //   15: return
    ...
    //   35: dup
    //   36: iconst_1
    //   37: invokestatic 529	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   40: invokevirtual 532	java/lang/Thread:getId	()J
    //   43: invokestatic 476	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   46: aastore
    //   47: invokestatic 171	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   50: aload_0
    //   51: invokevirtual 329	amtm:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: astore_2
    //   55: aload_2
    //   56: ifnull -41 -> 15
    //   59: aload_2
    //   60: invokevirtual 481	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   63: invokevirtual 487	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   66: astore_2
    //   67: aload_2
    //   68: ldc 114
    //   70: iconst_0
    ...
    //   84: ifnull +276 -> 360
    //   87: aload_1
    //   88: invokeinterface 367 1 0
    //   93: ifle +267 -> 360
    //   96: aload_1
    //   97: checkcast 363	java/util/ArrayList
    //   100: astore_1
    //   101: aload_1
    ...
    //   124: astore 4
    //   126: aload_0
    //   127: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   130: aload 4
    //   132: invokevirtual 457	java/util/concurrent/CopyOnWriteArrayList:add	(Ljava/lang/Object;)Z
    //   135: pop
    //   136: goto -30 -> 106
    //   139: astore_3
    //   140: aload_2
    ...
    //   150: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   153: aload_2
    //   154: ifnull -139 -> 15
    //   157: aload_2
    //   158: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   161: return
    //   162: aload_0
    //   163: invokespecial 697	amtm:f	()V
    //   166: aload_0
    //   167: getfield 56	amtm:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   170: invokeinterface 720 1 0
    //   175: aload_1
    //   176: invokevirtual 719	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   179: astore_1
    //   180: aload_1
    //   181: invokeinterface 241 1 0
    //   186: ifeq +46 -> 232
    //   189: aload_1
    ...
    //   198: astore_3
    //   199: aload_0
    //   200: getfield 56	amtm:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   203: aload_3
    //   204: getfield 119	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   207: aload_3
    //   208: invokeinterface 229 3 0
    //   213: pop
    //   214: goto -34 -> 180
    //   217: astore_1
    //   218: aload_2
    ...
    //   223: ifnull +7 -> 230
    //   226: aload_3
    //   227: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   230: aload_2
    //   231: athrow
    //   232: aload_0
    //   233: invokespecial 722	amtm:g	()V
    ...
    //   258: aload_0
    //   259: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   262: invokevirtual 256	java/util/concurrent/CopyOnWriteArrayList:size	()I
    ...
    //   271: invokestatic 279	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   274: aload_0
    //   275: getfield 45	amtm:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   278: invokevirtual 236	java/util/concurrent/CopyOnWriteArrayList:iterator	()Ljava/util/Iterator;
    //   281: astore_1
    //   282: aload_1
    //   283: invokeinterface 241 1 0
    //   288: ifeq +72 -> 360
    //   291: aload_1
    ...
    //   361: ifnull -346 -> 15
    //   364: aload_2
    //   365: invokevirtual 506	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   368: return
    //   369: astore_2
    //   370: aload_1
    //   371: astore_3
