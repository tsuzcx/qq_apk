  ...
  implements Handler.Callback
{
  ...
  private ArrayList<avbj> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public avbk(CameraCaptureView paramCameraCaptureView, long paramLong)
  {
    super(paramLong);
  ...
  private void c()
  {
    try
    {
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_c_of_type_JavaLangString != null) && (this.jdField_f_of_type_Boolean) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        this.jdField_a_of_type_Aurv.a(201, -1, localBundle);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      Bundle localBundle = a();
      this.jdField_a_of_type_Aurv.a(208, -1, localBundle);
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_JavaLangString != null)
    {
      ...
      localawkz = new awkz();
      localawkz.jdField_a_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
      localawkz.jdField_b_of_type_JavaLangString = c();
      localawkz.jdField_a_of_type_Int = 0;
      localawkz.d = paramInt;
      localawkz.c = awje.n;
      if (awje.p != 2) {
        break label178;
      }
      localawkz.jdField_b_of_type_Int = 16;
      if (awje.o != 16) {
        break label188;
      }
      localawkz.e = 1;
    ...
    for (;;)
    {
      ...
      return;
      label178:
      localawkz.jdField_b_of_type_Int = 8;
      break;
      label188:
      localawkz.e = 2;
      break label101;
      label197:
      paramInt = AudioEncoder.a(localawkz);
      if (paramInt == 0) {
        break label256;
      }
      this.jdField_a_of_type_JavaUtilHashMap.put("param_audio_error", String.valueOf(paramInt));
  ...
  public void a(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_Aurv.a(207, -1, localBundle);
    aquv.c();
    if (QLog.isColorLevel()) {
  ...
  public void a(avbj paramavbj, boolean paramBoolean, MediaFormat paramMediaFormat)
  {
    int i = paramavbj.a();
    long l = paramavbj.a();
    String str = paramavbj.a();
    if (QLog.isColorLevel()) {
      QLog.d("SegmentManager", 2, "onEncodeVideoSegment:" + paramavbj);
    }
    int j = paramMediaFormat.getInteger("width");
    int k = paramMediaFormat.getInteger("height");
    paramavbj = a();
    paramavbj.putString("video_slice_path", str);
    paramavbj.putInt("video_slice_index", i);
    paramavbj.putInt("video_slice_width", j);
    paramavbj.putInt("video_slice_height", k);
    paramavbj.putLong("video_slice_timestamp", l);
    this.jdField_a_of_type_Aurv.a(200, -1, paramavbj);
    if (i == 0) {
    ...
    if (paramBoolean)
    {
      ...
      paramavbj = a();
      this.jdField_a_of_type_Aurv.a(204, -1, paramavbj);
      c();
    }
  }
  ...
  public void b()
  {
    ...
    Bundle localBundle = a();
    this.jdField_a_of_type_Aurv.a(206, -1, localBundle);
    a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    try
    {
      ...
      case 1: 
        ...
        this.jdField_a_of_type_Avbj = new avbj(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Avbj);
        if (QLog.isColorLevel()) {
          QLog.d("SegmentManager", 2, "Muxer_Start :" + this.jdField_a_of_type_Avbj);
        }
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Avbj.a(), 0);
    ...
    paramMessage = (auzi)paramMessage.obj;
    ...
    for (;;)
    {
      ...
      if (a(l, bool))
      {
        ...
        this.jdField_b_of_type_Long = 0L;
        this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
        a(this.jdField_a_of_type_Avbj, false, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
        i = this.jdField_a_of_type_JavaUtilArrayList.size();
        this.jdField_a_of_type_Avbj = new avbj(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Avbj);
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Avbj.a(), 0);
      ...
      this.jdField_a_of_type_Avbj.a(paramMessage);
      ...
      return true;
      if (QLog.isColorLevel()) {
        QLog.d("SegmentManager", 2, "Muxer_Stop :" + this.jdField_a_of_type_Avbj);
      }
      this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
      a(this.jdField_a_of_type_Avbj, true, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
      return true;
      return true;
      boolean bool = true;
      continue;
