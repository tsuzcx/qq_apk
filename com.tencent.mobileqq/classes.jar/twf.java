...
public class twf
{
  ...
  private static JSONObject a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      localJSONObject1.put("statistics_data_report", twr.a(paramContext, paramAdvertisementInfo, localJSONObject2).toString());
  ...
  private static void a(Activity paramActivity, int paramInt, VideoAdInfo paramVideoAdInfo)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = obb.a(paramVideoAdInfo);
    ...
    {
      a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, obb.R, 0, paramInt);
      return;
    }
    a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, obb.P, 0, paramInt);
  }
  ...
  public static void a(Activity paramActivity, int paramInt, boolean paramBoolean)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = obb.a(localVideoAdInfo);
    if (QLog.isColorLevel()) {
  ...
  public static void a(Activity paramActivity, RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        paramViewHolder = (rvv)paramViewHolder;
  ...
  private static void a(Activity paramActivity, VideoAdInfo paramVideoAdInfo, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    obb.a(new trn().a(paramActivity).a(obb.B).b(paramInt1).a(paramAdvertisementInfo).a(paramVideoAdInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  private void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    obb.a(new trn().a(paramActivity).a(obb.B).b(paramInt1).a(paramAdvertisementInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  {
    boolean bool = "1".equals(bkwm.a("readinjjoy_ad_supplement_config"));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 != null) && (((Long)localObject1).longValue() != 0L))
        {
          ...
          AdvertisementInfo localAdvertisementInfo = obb.a((VideoAdInfo)localObject2);
          if (((VideoAdInfo)localObject2).jdField_c_of_type_Boolean) {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, obb.R, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          } else {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, obb.P, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          }
        }
      }
    }
  ...
  public void a(slt paramslt, Activity paramActivity)
  {
    if ((paramslt == null) || (paramActivity == null) || (this.jdField_c_of_type_Boolean)) {}
    ...
    do
    {
      ...
      i = paramslt.a();
    } while ((localReadInJoyXListView == null) || (localList == null) || (!twr.a(i)));
    c();
    ...
    if (i <= m)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        paramslt = (BaseArticleInfo)localList.get(i - k);
        if (AdvertisementInfo.isAdvertisementInfo(paramslt)) {
          a(localReadInJoyXListView, j, m, i, (AdvertisementInfo)paramslt, paramActivity);
        }
      }
    }
    a(paramActivity);
