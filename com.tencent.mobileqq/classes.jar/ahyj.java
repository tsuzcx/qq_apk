  ...
  extends BaseChatPie
{
  ...
  public ahyj(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  {
    paramSessionInfo = bcsa.a(paramQQAppInterface, paramSessionInfo.curFriendUin, paramSessionInfo.troopUin, paramSessionInfo.curType, paramArkAppMessage);
  ...
  private void c()
  {
    ...
    RecentUser localRecentUser = (RecentUser)localaoxz.findRecentUserByUin(AppConstants.ARK_DEBUG_UIN, 1031);
    if (localRecentUser.lastmsgtime < l) {
      localRecentUser.lastmsgtime = l;
    }
    localaoxz.saveRecentUser(localRecentUser);
    localaoxz.updateCache(localRecentUser);
  }
