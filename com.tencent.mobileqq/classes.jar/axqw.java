...
public class axqw
{
  private static String a()
  {
    ...
    str2 = String.format("%.2f", new Object[] { Double.valueOf(bbct.a()) });
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(i).append(";").append(l).append(";").append(arrayOfLong[0]).append(";").append(arrayOfLong[1]).append(";").append(str1.replaceAll(";", "")).append(";").append(str2).append(";").append(blbz.a).append(";").append(blbz.b).append(";");
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, int paramInt3, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    if (localQQAppInterface == null)
    {
      ...
      if (!"CliOper".equals(paramString1)) {
        bhvq.a().a(paramString4, paramQQAppInterface);
      }
      return;
    }
  ...
  {
    paramPluginRuntime.setClickEventReportor(new axqx());
  }
