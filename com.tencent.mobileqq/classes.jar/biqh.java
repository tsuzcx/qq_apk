...
public class biqh
{
  private static biqh jdField_a_of_type_Biqh;
  ...
  private biqh(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a();
  }
  
  public static final biqh a(Context paramContext)
  {
    if (jdField_a_of_type_Biqh == null) {}
    try
    {
      if (jdField_a_of_type_Biqh == null) {
        jdField_a_of_type_Biqh = new biqh(paramContext);
      }
      return jdField_a_of_type_Biqh;
    }
    finally {}
  }
  ...
  void b()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 36	biqh:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   150: aload_0
    //   151: getfield 34	biqh:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   154: aload_3
    //   155: aload 4
