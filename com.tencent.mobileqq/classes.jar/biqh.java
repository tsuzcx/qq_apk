...
public class biqh
{
  public static final LruCache<String, biqh> a;
  public static final AtomicInteger c = new AtomicInteger(1);
  public String a;
  public final CopyOnWriteArrayList<biqk> a;
  ...
  /* Error */
  public static biqh a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   60: astore_0
    //   61: aload_0
    //   62: invokestatic 90	biqh:b	(Ljava/lang/String;)Lbiqh;
    //   65: astore_2
    //   66: goto -52 -> 14
    //   69: astore_0
    //   70: aload_0
  ...
  public static biqh b(String paramString)
  {
    ...
    try
    {
      ...
      {
        biqh localbiqh = (biqh)jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
        localObject = localbiqh;
        if (localbiqh == null)
        {
          localObject = new biqh(paramString);
  ...
  public void a(biqk parambiqk, String paramString)
  {
    if ((this.b.get() == 3) && (parambiqk != null))
    {
      ...
      parambiqk.onCheckOfflineFinish(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
    }
    do
    {
      return;
      if ((parambiqk != null) && (!this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(parambiqk))) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambiqk);
      }
      parambiqk = new SwiftBrowserOfflineHandler.1(this, paramString);
    ...
    ThreadManager.postImmediately(parambiqk, new biqj(this), false);
  }
  ...
  public void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Niz.a("ex_offline", "");
