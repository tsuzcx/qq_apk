...
public class afzv
  implements bfph
{
  public afzv(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (this.a.jdField_d_of_type_Int == 9) {
            ...
            case 0: 
              ...
              axqy.b(this.a.getActivity().app, "P_CliOper", "Grp_pay", "", "un_pay_list", "Clk_del", 0, 0, this.a.c, this.a.o, "", "");
              break;
            }
          } else {
            switch (i)
            ...
            case 1: 
              if (!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString))
              {
                ...
                axqy.b(this.a.getActivity().app, "dc00899", "Grp_mber", "", "mber_list", "clk_Add", 0, 0, this.a.c, "", "", "");
              }
              break;
            case 2: 
            ...
            case 3: 
              ...
              this.a.jdField_d_of_type_AndroidWidgetTextView.setText(ajya.a(2131701614));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new afzw(this));
              if (this.a.jdField_a_of_type_Agau != null) {
                this.a.jdField_a_of_type_Agau.a();
              }
              paramView = this.a.o;
