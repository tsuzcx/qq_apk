  ...
  implements TdsReaderView.OpenCallback
{
  ...
  private final ausr jdField_a_of_type_Ausr;
  private final WeakReference<Activity> jdField_a_of_type_JavaLangRefWeakReference;
  private final boolean jdField_a_of_type_Boolean;
  
  private auss(Activity paramActivity, boolean paramBoolean, ausr paramausr)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_Ausr = paramausr;
    if ((paramActivity != null) && (!paramActivity.isFinishing())) {}
    for (int i = (int)paramActivity.getResources().getDimension(2131299011);; i = 0)
    {
