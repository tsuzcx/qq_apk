...
{
  public auss(CustomCoverFragment paramCustomCoverFragment) {}
  
  private void a(ausq paramausq)
  {
    if (CustomCoverFragment.c(this.a))
    {
      paramausq.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130848972);
      paramausq.jdField_a_of_type_AndroidWidgetButton.setTextColor(-8947849);
      paramausq.jdField_a_of_type_AndroidWidgetButton.setText(2131695244);
      return;
    }
    if ((paramausq.jdField_a_of_type_Int == CustomCoverFragment.a(this.a)) && (CustomCoverFragment.a(this.a)))
    {
      paramausq.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130848972);
      paramausq.jdField_a_of_type_AndroidWidgetButton.setTextColor(-8947849);
      paramausq.jdField_a_of_type_AndroidWidgetButton.setText(2131719356);
      return;
    }
    paramausq.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130848992);
    paramausq.jdField_a_of_type_AndroidWidgetButton.setTextColor(-16777216);
    paramausq.jdField_a_of_type_AndroidWidgetButton.setText(2131695244);
  }
  
  public auuy a(int paramInt)
  {
  ...
  {
    auuy localauuy;
    if ((paramViewHolder instanceof ausq))
    {
      paramViewHolder = (ausq)paramViewHolder;
      localauuy = a(paramInt);
      if (localauuy != null)
      {
        paramViewHolder.jdField_a_of_type_Int = localauuy.jdField_a_of_type_Int;
        paramViewHolder.jdField_a_of_type_AndroidWidgetTextView.setText(localauuy.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(localauuy.b))
        {
          paramViewHolder.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(CustomCoverFragment.a(this.a));
          paramViewHolder.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(localauuy.jdField_a_of_type_Int));
          paramViewHolder.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(localauuy.jdField_a_of_type_Int));
          label93:
          a(paramViewHolder);
        }
      }
    ...
    do
    {
      do
      {
        ...
        localObject = URLDrawable.getDrawable(localauuy.b, (URLDrawable.URLDrawableOptions)localObject);
        ...
        break label93;
      } while (!(paramViewHolder instanceof ausr));
      paramViewHolder = (ausr)paramViewHolder;
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localausp = new ausp(this.a, paramViewGroup);
    }
    do
    {
      return localausp;
      if (paramInt == 1)
      {
        paramViewGroup = this.a.getActivity().getLayoutInflater().inflate(2131561606, paramViewGroup, false);
        paramViewGroup = new ausq(this.a, paramViewGroup);
        ((ausq)paramViewGroup).jdField_a_of_type_AndroidWidgetImageView.getLayoutParams().height = CustomCoverFragment.e(this.a);
        return paramViewGroup;
      }
    } while (paramInt != 2);
    paramViewGroup = this.a.getActivity().getLayoutInflater().inflate(2131561487, paramViewGroup, false);
    return new ausr(this.a, paramViewGroup);
  }
