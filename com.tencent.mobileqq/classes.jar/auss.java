  ...
  extends RecyclerView.ViewHolder
{
  ...
  public auss(CustomCoverFragment paramCustomCoverFragment, View paramView)
  {
    super(paramView);
    paramView.setTag(this);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367799));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377045));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131363740));
