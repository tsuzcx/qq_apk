...
public class akjn
  implements akwz, SurfaceTexture.OnFrameAvailableListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnSeekCompleteListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private akjo jdField_a_of_type_Akjo;
  private akmj jdField_a_of_type_Akmj = new akmj(0);
  ...
  public akjn(akjo paramakjo, int paramInt)
  {
  ...
  private void e()
  {
    ...
    if ((localTVK_IProxyFactory != null) && (this.jdField_a_of_type_AndroidGraphicsSurfaceTexture == null))
    {
      ...
      if (this.jdField_a_of_type_Akwy != null) {
        this.jdField_a_of_type_Akwy.a(null);
      }
      if (this.jdField_a_of_type_Akwy == null) {
      ...
      {
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = localTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Akwy);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    label197:
    localTVK_PlayerVideoInfo.setConfigMap("file_dir", akwx.a(paramString));
    if (this.jdField_b_of_type_Boolean) {}
    for (localObject = "true";; localObject = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bcdu.d(paramString));
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Akjo != null) {
      this.jdField_a_of_type_Akjo.a(paramArrayOfByte1);
    }
  }
  ...
  public void d()
  {
    ...
    {
      this.f = true;
      this.jdField_a_of_type_Akjo = null;
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
      {
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Akjo != null) {
      this.jdField_a_of_type_Akjo.a(paramTVK_IMediaPlayer);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Akjo != null) {
      this.jdField_a_of_type_Akjo.a(this.jdField_a_of_type_JavaLangRunnable);
    }
  }
