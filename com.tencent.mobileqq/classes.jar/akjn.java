  ...
  extends MqqHandler
{
  ...
  public akjn(Looper paramLooper, VideoBroadcastReceiver paramVideoBroadcastReceiver)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          case 0: 
            ...
            if (i == 1006)
            {
              ...
              localObject1 = ((askl)localQQAppInterface.getManager(11)).a();
            ...
            for (;;)
            {
              aaod.b(localQQAppInterface, paramMessage, (SessionInfo)localObject3, (String)localObject2);
              return;
              if (i == 1000)
              {
          ...
          case 1: 
            ...
            localObject1 = (bbgg)paramMessage[0];
      ...
      mqz.e(localQQAppInterface.isBackground_Pause);
      return;
      paramMessage = (bbgg)((Object[])(Object[])paramMessage.obj)[0];
    } while (!paramMessage.isShowing());
    paramMessage.dismiss();
    return;
