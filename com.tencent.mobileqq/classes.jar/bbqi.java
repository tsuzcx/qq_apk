...
public class bbqi
  extends amiz
{
  public bbqi(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public List<TroopFileTansferItemEntity> a(long paramLong)
  {
    ...
    return localawbw.a(TroopFileTansferItemEntity.class, "select * from " + localTroopFileTansferItemEntity.getTableName() + " where troopuin = ?", new String[] { "" + paramLong });
  }
  ...
  public void a(long paramLong, UUID paramUUID)
  {
    ...
    bbrc.c("TroopFileDataBaseProxy", bbrc.a, "[" + paramUUID.toString() + "] deleteItem");
    ...
    paramUUID = new bbql(this, paramUUID);
  ...
  public void a(TroopFileTansferItemEntity paramTroopFileTansferItemEntity)
  {
    ...
    bbrc.c("TroopFileDataBaseProxy", bbrc.a, "[" + paramTroopFileTansferItemEntity.Id.toString() + "] updateItem transStatus[" + paramTroopFileTansferItemEntity.Status + "] FilePath[" + paramTroopFileTansferItemEntity.FilePath + "]");
    ...
    for (;;)
    {
      ...
      localContentValues.put("_sStatus", bbns.a(i));
      String str1 = paramTroopFileTansferItemEntity.getTableName();
      String str2 = paramTroopFileTansferItemEntity.Id.toString();
      paramTroopFileTansferItemEntity = new bbqk(this, paramTroopFileTansferItemEntity);
  ...
  public void a(TroopFileTansferItemEntity paramTroopFileTansferItemEntity, amji paramamji)
  {
    bbrc.c("TroopFileDataBaseProxy", bbrc.a, "[" + paramTroopFileTansferItemEntity.Id.toString() + "] addItem status[" + paramTroopFileTansferItemEntity.getStatus() + "]");
    paramamji = new bbqj(this, paramTroopFileTansferItemEntity);
    if (paramTroopFileTansferItemEntity.getStatus() == 1000)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, paramTroopFileTansferItemEntity.getTableName(), paramTroopFileTansferItemEntity, 0, paramamji);
      return;
    }
    if (paramTroopFileTansferItemEntity.getStatus() == 1001)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, paramTroopFileTansferItemEntity.getTableName(), paramTroopFileTansferItemEntity, 1, paramamji);
      return;
    }
    bbrc.a("TroopFileDataBaseProxy", bbrc.a, "Item status[" + String.valueOf(paramTroopFileTansferItemEntity.getStatus()) + "] is wrong");
  }
  
  protected void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, amji paramamji)
  {
