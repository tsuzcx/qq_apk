  ...
  implements INetInfoHandler
{
  ...
  public bbqi()
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new bbqj(this);
  }
  ...
  public long a()
  {
    if ((this.jdField_a_of_type_Bbrz != null) && (this.jdField_a_of_type_Bbrz.a != null)) {
      return this.jdField_a_of_type_Bbrz.a.getCurPlayingPos();
    }
    return 0L;
  }
  ...
  public aklw a(AIOVideoData paramAIOVideoData)
  {
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        localObject = bbqt.a().a(paramAIOVideoData.jdField_a_of_type_Long);
        if ((localObject != null) && (((bbqw)localObject).a()))
        {
          aklw localaklw = new aklw();
          localaklw.jdField_a_of_type_Boolean = true;
          localaklw.jdField_a_of_type_ArrayOfJavaLangString = ((bbqw)localObject).jdField_a_of_type_ArrayOfJavaLangString;
          localaklw.jdField_a_of_type_JavaLangString = paramAIOVideoData.b;
          localaklw.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo = ((bbqw)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
          localaklw.jdField_a_of_type_Int = ((bbqw)localObject).jdField_a_of_type_Int;
          localaklw.jdField_a_of_type_Long = paramAIOVideoData.jdField_a_of_type_Long;
          localaklw.b = paramAIOVideoData.jdField_a_of_type_Int;
          return localaklw;
      ...
      else
      {
        ...
        ((aklw)localObject).jdField_a_of_type_Long = paramAIOVideoData.jdField_a_of_type_Long;
        ((aklw)localObject).b = paramAIOVideoData.jdField_a_of_type_Int;
        ((aklw)localObject).jdField_a_of_type_JavaLangString = paramAIOVideoData.b;
        ((aklw)localObject).d = l;
        return localObject;
      }
      bool = false;
    }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    if (localObject != null) {
      localMessageForShortVideo = ((aklw)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
    }
    for (int j = ((aklw)localObject).jdField_a_of_type_Int;; j = -1)
    {
      ...
      } while (this.jdField_a_of_type_Bbqa.a() == null);
      this.jdField_a_of_type_Bbqa.a().a(localMessageForShortVideo);
      return;
  ...
  public void a(int paramInt, File paramFile)
  {
    ...
    default: 
      ...
      if (zeb.a(BaseApplication.getContext(), paramFile.getAbsolutePath(), str)) {
        QQToast.a(this.jdField_a_of_type_Bbrz.mContext, 2, anvx.a(2131699641), 0).a();
      }
      break;
    }
    for (;;)
    {
      ...
      str = "0X8007A25";
      break;
      QQToast.a(this.jdField_a_of_type_Bbrz.mContext, 1, anvx.a(2131699642), 0).a();
    }
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    if ((localRichMediaBrowserInfo != null) && ((localRichMediaBrowserInfo.baseData instanceof AIOVideoData)) && (((AIOVideoData)localRichMediaBrowserInfo.baseData).jdField_a_of_type_Long == paramLong))
    {
      ...
      QQToast.a(this.jdField_a_of_type_Bbrz.mContext, 2, this.jdField_a_of_type_Bbrz.mContext.getString(2131718157), 0).a();
    }
    label195:
    label225:
    ...
    {
      return;
      QQToast.a(this.jdField_a_of_type_Bbrz.mContext, 1, this.jdField_a_of_type_Bbrz.mContext.getString(2131718172), 0).a();
      return;
    }
    if (paramInt3 == 1) {}
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bbrz.updateView(getSelectedIndex(), this.jdField_a_of_type_Bbrz.mBrowserItemView, paramBoolean);
      return;
      paramString = "I:E";
    }
  }
  ...
  {
    this.jdField_a_of_type_Bbrz.a(paramLong, paramInt1, paramInt2, paramString1, paramArrayOfString, paramString2, paramMessageForShortVideo, paramInt3);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bbqa != null) && (this.jdField_a_of_type_Bbqa.a != null) && (this.jdField_a_of_type_Bbqa.a() != null))
    {
      if (!LiuHaiUtils.b()) {
        break label94;
      }
      this.jdField_a_of_type_Bbqa.a().a((int)AIOUtils.px2dp(LiuHaiUtils.jdField_a_of_type_Int, this.jdField_a_of_type_Bbrz.mContext.getResources()) + 46);
    }
    for (;;)
    {
      this.jdField_a_of_type_Bbqa.a().d();
      this.jdField_a_of_type_Bbqa.a().c();
      this.jdField_a_of_type_Bbqa.a.a();
      return;
      label94:
      this.jdField_a_of_type_Bbqa.a().a(46);
    }
  }
  ...
  {
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_Bbrz.mContext, this);
  }
  ...
  public void setGalleryView(BrowserBaseView paramBrowserBaseView)
  {
    ...
    if ((paramBrowserBaseView instanceof bbrz)) {
      this.jdField_a_of_type_Bbrz = ((bbrz)paramBrowserBaseView);
    }
  }
}
