  ...
  extends abtg
{
  ...
  public bbqi(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, abtf paramabtf)
  {
    super(paramQQAppInterface, paramProxyManager, paramabtf);
    this.jdField_a_of_type_JavaUtilComparator = new bbqj(this);
  }
  ...
  private List<MessageRecord> b(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((localObject1 == null) || (((List)localObject1).isEmpty())) {
      if (paramBoolean1)
      {
        localObject1 = new azro();
        if (Looper.myLooper() == Looper.getMainLooper()) {}
        for (int i = 1;; i = 0)
        {
          ((azro)localObject1).jdField_a_of_type_Int = i;
          ((azro)localObject1).jdField_a_of_type_JavaLangString = "select";
          ((azro)localObject1).jdField_b_of_type_JavaLangString = "AIO";
          localList = a(paramString, paramInt, (azro)localObject1);
          if ((((azro)localObject1).jdField_b_of_type_Int != 0) && (azri.a()) && (azri.a(1)))
          {
            localObject2 = new HashMap();
            ((HashMap)localObject2).put("param_IsMainThread", String.valueOf(((azro)localObject1).jdField_a_of_type_Int));
            ((HashMap)localObject2).put("param_OptType", ((azro)localObject1).jdField_a_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_OptTotalCost", String.valueOf(((azro)localObject1).jdField_a_of_type_Long));
            ((HashMap)localObject2).put("param_OptCount", String.valueOf(((azro)localObject1).jdField_b_of_type_Int));
            ((HashMap)localObject2).put("param_OptMsgCount", String.valueOf(((azro)localObject1).c));
            ((HashMap)localObject2).put("param_OptOneCost", String.valueOf(((azro)localObject1).jdField_b_of_type_Long));
            ((HashMap)localObject2).put("param_OptScene", ((azro)localObject1).jdField_b_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_WalSwitch", String.valueOf(ambz.a));
            azri.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, ((azro)localObject1).c, 0L, (HashMap)localObject2, null, false);
          }
        ...
        label423:
        new ArrayList();
        localObject2 = abti.a(localList, false);
        ...
        if ((!abti.a(paramString, paramInt, (List)localObject2)) && (abti.b((List)localObject2)))
        {
          localObject1 = localObject2;
          if (!abti.c((List)localObject2)) {}
        }
        else
        {
          ...
          localObject1 = abti.a(localList, false, 30);
        }
        if ((abti.a((List)localObject1)) || (localObject1 == null) || (((List)localObject1).isEmpty())) {
          break label1070;
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = abti.a(localList, true);
        break label730;
        label980:
  ...
  protected int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    awgn localawgn = a();
    String str = "( msgtype " + abti.b() + " and isValid=1 ) and shmsgseq <= ?";
    long l = paramMessageRecord.shmsgseq;
    paramString = localawgn.a(false, paramString, new String[] { "_id" }, str, new String[] { String.valueOf(l) }, null, null, null, null);
    paramInt = i;
    if (paramString != null)
    {
  ...
  public MessageRecord a(String paramString, int paramInt, MessageRecord paramMessageRecord, List<MessageRecord> paramList)
  {
    ...
    label43:
    if (paramInt >= 0) {
      if (abti.a((MessageRecord)paramList.get(paramInt), paramMessageRecord, true, true)) {
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, int[] paramArrayOfInt)
  {
    ...
    paramString = bdih.a(MessageRecord.getOldTableName(paramString, paramInt1), MessageRecord.getTableName(paramString, paramInt1), paramLong1, paramInt2, paramLong2, (String)localObject1, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b());
    if (paramString == null) {
  ...
  public List<MessageRecord> a(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    if (bdih.a(MessageRecord.getTableName(paramString1, paramInt1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b()))
    {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localMessageRecord.shmsgseq == paramLong1) && ((!localMessageRecord.isSendFromLocal()) || (localMessageRecord.extraflag == 0)) && (!abti.a(localMessageRecord))) {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, azro paramazro)
  {
    ...
    try
    {
      paramString = super.a(paramString, paramInt, paramazro);
      if (paramString != null) {
        Collections.sort(paramString, this.jdField_a_of_type_JavaUtilComparator);
      }
      return paramString;
  ...
  protected void a(SessionInfo paramSessionInfo, String paramString, int paramInt, Set<String> paramSet)
  {
    ...
    paramSessionInfo = ((alrk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    paramString = paramSessionInfo.iterator();
    while (paramString.hasNext()) {
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    {
      a(paramString, paramInt, str2, localContentValues, String.format("isread=? and %s<=? and " + abti.d(), new Object[] { "shmsgseq" }), new String[] { "0", str1 }, null);
      return;
    }
  ...
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramMessageRecord.isSendFromLocal()) || ((abti.a(paramMessageRecord)) && (paramMessageRecord.msgtype != -4012) && (paramMessageRecord.msgtype != -4009) && (paramMessageRecord.msgtype != -5001) && (paramMessageRecord.msgtype != -5021)) || (abti.f(paramMessageRecord)))
        {
          if ((localObject2 == null) || (((List)localObject2).isEmpty()) || (((MessageRecord)((List)localObject2).get(((List)localObject2).size() - 1)).shmsgseq <= 0L)) {
            break label661;
          }
          if ((!abti.j(paramMessageRecord.msgtype)) || (paramMessageRecord.shmsgseq <= 0L)) {}
        }
        else
        {
          ...
          if ((a().a().containsKey(localObject1)) && (paramBoolean))
          {
            ...
            if ((paramMessageRecord.msgtype == -2006) && (aiul.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) && ((paramMessageRecord instanceof MessageForFoldMsg)) && (!paramMessageRecord.isSend()))
            {
              if (this.jdField_a_of_type_Aiul == null) {
                this.jdField_a_of_type_Aiul = ((aiul)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(125));
              }
              this.jdField_a_of_type_Aiul.a((List)localObject1, (MessageForFoldMsg)paramMessageRecord);
            }
          }
          return;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.TroopMsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + arrr.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    paramString = localawgn.a(paramString, new String[] { String.valueOf(paramLong1) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
