  ...
  implements zrt
{
  ...
  public aizv(int paramInt1, int paramInt2, String paramString1, String paramString2) {}
  ...
  public void onFailure(int paramInt, String paramString)
  {
    ...
    ThreadManager.post(new ApolloGameUtil.6.6(this, paramString, a(paramString.length()), new aizy(this)), 8, null, false);
  }
  
  public void onPermission(int paramInt)
  {
    String str = "openID=&&accesstoken=&&token=" + this.jdField_a_of_type_Int + "&&gameid=" + this.jdField_b_of_type_Int + "&&subcode=0";
    ThreadManager.post(new ApolloGameUtil.6.2(this, str, a(str.length()), new aizw(this)), 8, null, false);
  }
  ...
  public void onSuccess(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ThreadManager.post(new ApolloGameUtil.6.4(this, paramJSONObject, a(paramJSONObject.length()), new aizx(this)), 8, null, false);
      return;
    }
