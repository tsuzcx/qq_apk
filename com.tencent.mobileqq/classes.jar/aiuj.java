...
{
  public aiuj(MediaPreviewActivity paramMediaPreviewActivity, ActionSheet paramActionSheet, URLDrawable paramURLDrawable) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqTroopActivityMediaPreviewActivity.getString(2131435871).equals(str)) && (paramView != null)) {
    ...
    for (;;)
    {
      ...
      return;
      if (this.jdField_a_of_type_ComTencentMobileqqTroopActivityMediaPreviewActivity.getString(2131435877).equals(str)) {
