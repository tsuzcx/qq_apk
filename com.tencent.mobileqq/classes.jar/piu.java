...
public abstract class piu<K, D>
  extends RecyclerView.Adapter<bjwy>
{
  protected int a;
  protected Context a;
  ...
  public piu(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    ...
    ozp.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, a());
