...
public class una
  implements Runnable
{
  public una(PressToChangeVoicePanel paramPressToChangeVoicePanel) {}
  ...
  public void run()
  {
    ...
    {
      QQToast.a(BaseApplication.getContext(), 2131437995, 0).a();
      return;
    }
    ...
    if (!FileUtils.a())
    {
      QQToast.a(BaseApplication.getContext(), 2131433420, 0).b(i);
      label173:
    ...
    for (i = 1;; i = 2)
    {
      ReportController.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005472", "0X8005472", i, 0, "", "", "", "7.6.0");
      ...
      if (!QQRecorder.d())
      {
        QQToast.a(BaseApplication.getContext(), 2131433421, 0).b(i);
        break label173;
      }
      if (!QQRecorder.a(((QQRecorder.RecorderParam)localObject).c))
      {
        QQToast.a(BaseApplication.getContext(), 2131433424, 0).b(i);
        break label173;
      }
