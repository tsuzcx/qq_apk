...
{
  private autv(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity) {}
  
  private void a(autu paramautu, PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    if (this.a.jdField_b_of_type_Boolean)
    {
      if (paramautu.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramautu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramautu.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramautu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramautu.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramautu.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramautu.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramautu.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      paramautu.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramautu.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramautu.jdField_b_of_type_AndroidViewView.setTag(2131362112, Integer.valueOf(4));
      paramautu.jdField_b_of_type_AndroidViewView.setTag(2131364978, paramautu);
      paramautu = paramautu.jdField_b_of_type_AndroidWidgetImageView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label384;
      }
    }
    label384:
    for (int i = 2130844825;; i = 2130844817)
    {
      paramautu.setImageResource(i);
      return;
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        if (paramautu.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramautu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        if (paramautu.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramautu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        ...
        if (paramautu.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
          paramautu.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        }
        paramautu.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
        paramautu.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        paramautu.jdField_b_of_type_AndroidViewView.setTag(2131362112, Integer.valueOf(1));
        break;
      }
      if (paramautu.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramautu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramautu.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramautu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramautu.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramautu.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramautu.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramautu.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      paramautu.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramautu.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramautu.jdField_b_of_type_AndroidViewView.setTag(2131362112, Integer.valueOf(3));
      break;
    }
  }
  ...
  private void b(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    ...
    bbbx.a(this.a, false, true);
  }
  
  public void a(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    bgyw localbgyw = bgyw.a();
    localbgyw.a = this.a.app.getCurrentAccountUin();
    localbgyw.b = this.a.app.getCurrentNickname();
    Bundle localBundle = new Bundle();
    localBundle.putString("key_title", this.a.getString(2131718044));
    ...
    bgyp.a(this.a, localbgyw, localBundle, 1);
  }
  
  void a(PersonalityLabelInfo paramPersonalityLabelInfo, autu paramautu)
  {
    String str = paramautu.jdField_b_of_type_AndroidWidgetTextView.getText().toString();
    if (paramPersonalityLabelInfo.praiseCount > 0L)
    {
      ...
      if (!TextUtils.equals(paramPersonalityLabelInfo, str)) {
        paramautu.jdField_b_of_type_AndroidWidgetTextView.setText(paramPersonalityLabelInfo);
      }
      paramPersonalityLabelInfo = paramautu.jdField_b_of_type_AndroidWidgetTextView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label375;
      }
    }
    ...
    for (float f = 0.5F;; f = 1.0F)
    {
      ...
      return;
      paramPersonalityLabelInfo = this.a.getResources().getString(2131699304);
      break;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.a.getLayoutInflater().inflate(2131560938, paramViewGroup, false);
      paramViewGroup = new autu(null);
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131367271);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131368877));
      paramViewGroup.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362830);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362112));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362113));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364978));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131379588));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView = ((GlowCountRecyclerView)paramView.findViewById(2131375022));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379590));
      paramViewGroup.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131377337);
      paramViewGroup.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131364656);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setTag(2131362112, Integer.valueOf(5));
      if (!PersonalityLabelGalleryActivity.a(this.a)) {
      ...
      localObject1 = new autt(this.a, null);
      ...
      localObject2 = (Integer)paramViewGroup.jdField_a_of_type_AndroidViewView.getTag(2131368877);
      if ((localObject2 == null) || (((Integer)localObject2).intValue() != ((PersonalityLabelInfo)localObject1).bgColor))
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131368877, Integer.valueOf(((PersonalityLabelInfo)localObject1).bgColor));
      }
      ...
      paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(2131379590, paramViewGroup);
      if (!PersonalityLabelGalleryActivity.a(this.a))
      {
        if (((PersonalityLabelInfo)localObject1).praiseFlag <= 0) {
          break label830;
        }
        paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130844846);
      }
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setTag(2131362112, Integer.valueOf(2));
      }
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setAdapter(new auua(this.a, ((PersonalityLabelInfo)localObject1).id));
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setOnScrollListener(new autw(this, (PersonalityLabelInfo)localObject1));
      label694:
    ...
    for (paramInt = i;; paramInt = -2)
    {
      ...
      return paramView;
      paramViewGroup = (autu)paramView.getTag();
      break;
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130844834);
      break label435;
      bool1 = false;
      break label524;
      paramInt = 8;
  ...
  {
    Object localObject1 = paramView.getTag(2131362112);
    int i;
    if ((localObject1 != null) && ((localObject1 instanceof Integer)))
    {
      ...
      {
        paramView = bfpc.a(paramView.getContext());
        paramView.c("从手机相册选择");
        paramView.c("从空间相册选择");
        paramView.d("取消");
        paramView.a(new autx(this, (PersonalityLabelInfo)localObject1, paramView));
        paramView.show();
        axqy.b(this.a.app, "dc00898", "", "", "0X8007FD2", "0X8007FD2", 0, 0, "", "", "", "");
      }
    }
    label192:
    do
    ...
    if (i == 3)
    {
      ...
      {
        ((auud)this.a.app.a(112)).a(PersonalityLabelGalleryActivity.a(this.a), localPersonalityLabelInfo.id);
    ...
    for (;;)
    {
      ...
      if (localObject2 != null) {}
      for (localObject1 = ((PersonalityLabelZan)localObject2).nick;; localObject1 = bbcz.a(this.a.app, this.a.app.getCurrentAccountUin()))
      {
        localPersonalityLabelZan.nick = ((String)localObject1);
        localPersonalityLabelInfo.zanUins.add(0, localPersonalityLabelZan);
        a(localPersonalityLabelInfo, (autu)paramView.getTag(2131379590));
        ((ImageView)paramView.findViewById(2131379588)).setImageResource(2130844846);
        ...
        axqy.b(this.a.app, "dc00898", "", "", "0X8007FD0", "0X8007FD0", 0, 0, "", "", "", "");
        return;
      }
      if (this.a.jdField_a_of_type_Bcql == null) {
        this.a.jdField_a_of_type_Bcql = bcql.a(this.a, "每个标签每天只能点一个赞哦。", 0);
      }
      if (this.a.jdField_a_of_type_Bcql.c()) {
        break;
      }
      this.a.jdField_a_of_type_Bcql.b(this.a.getTitleBarHeight());
      return;
      if (i == 4)
      {
        ...
        {
          bbdj.a(this.a, (String)localObject1, 2131690596, 2131692738, new auty(this, paramView, (PersonalityLabelInfo)localObject2), new autz(this)).show();
          return;
        }
      }
      if (i != 5) {
