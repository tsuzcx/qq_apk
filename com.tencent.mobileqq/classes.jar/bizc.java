...
public class bizc
{
  ...
  private ConcurrentLinkedQueue<bizd> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static bizc a()
  {
    try
    {
      ...
      bizc localbizc = jdField_a_of_type_Bizc;
      return localbizc;
    }
    finally {}
  }
  ...
  private String a(String paramString)
  {
    try
    {
      ...
      if (localFile.exists())
      {
        ...
        paramString = bkxn.a(paramString);
        return paramString;
      }
    }
  ...
  private String b(PackageInfo paramPackageInfo)
  {
    ...
    return bkvq.a(paramPackageInfo);
  }
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.4.10"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.4.10", Integer.valueOf(a("8.4.10")) }));
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
        break label561;
      }
      localSendInfo = new SecSharedInfo.SendInfo();
      localObject1 = (bizd)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      i = ((bizd)localObject1).a();
      localObject3 = ((bizd)localObject1).a();
      str3 = ((bizd)localObject1).b();
      j = ((bizd)localObject1).b();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = bkwk.a((String)localObject3);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.offer(new bizd(paramInt1, paramString1, paramInt2, paramString2));
  }
