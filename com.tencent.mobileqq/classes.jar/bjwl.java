  ...
  implements IEventReceiver
{
  ...
  public bjwl(MiniAppActivity paramMiniAppActivity, String paramString, int paramInt)
  {
  ...
  private void a(int paramInt)
  {
    ...
    localawxs.jdField_a_of_type_Int = 4;
    localawxs.jdField_a_of_type_Awxt = this.jdField_a_of_type_Awxt;
  ...
  private String[] a()
  {
    String str3 = this.jdField_a_of_type_Awxt.a.getString("unzipped_path");
    String str2 = a(this.jdField_a_of_type_ComTencentMobileqqMiniappUiMiniAppActivity, "qgamelibs", "ejecta.js");
    String str1 = null;
    if (!TextUtils.isEmpty(str3)) {
      str1 = a(str3, this.jdField_a_of_type_Awxt.h, "index.js");
    }
  ...
  private boolean b()
  {
    ...
    if (!jdField_a_of_type_Boolean)
    {
      ...
      {
        return false;
        localObject = ((File)localObject).listFiles(new bjwm(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Bjwn = new bjwn(this);
      wad.a().registerSubscriber(this.jdField_a_of_type_Bjwn);
      awxr localawxr = awxy.a().a("ak:3214");
      if (localawxr != null) {
        localawxr.a("ak:3214", "QGameApp", this.jdField_a_of_type_Awxt.h);
      }
    }
  }
  ...
  {
    super.c();
    if (this.jdField_a_of_type_Bjwn != null) {
      wad.a().unRegisterSubscriber(this.jdField_a_of_type_Bjwn);
    }
  }
