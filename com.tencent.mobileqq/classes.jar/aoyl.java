  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  public View a;
  aoay jdField_a_of_type_Aoay;
  aoyo jdField_a_of_type_Aoyo;
  ...
  public aoyl(@NonNull BaseActivity paramBaseActivity, @NonNull ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    super(paramBaseActivity, 2131755174);
    if ((paramArrayList == null) || (paramArrayList.size() < 1)) {
      throw new RuntimeException("empty data");
    }
    getWindow().setDimAmount(0.5F);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Aoay = ((aoay)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface().getManager(QQManagerFactory.QIM_NEW_FRIEND_MANAGER));
    this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager = ((FlashChatManager)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface().getManager(QQManagerFactory.FLASH_CHAT_MANAGER));
    this.jdField_a_of_type_JavaUtilList.addAll(paramArrayList);
    this.b.addAll(this.jdField_a_of_type_JavaUtilList);
    if (this.jdField_a_of_type_JavaUtilList.size() == 1)
    {
      paramArrayList = b();
      bdla.b(null, "dc00898", "", "", "0X8008A9E", "0X8008A9E", 0, 0, "", "", "", "");
      this.jdField_a_of_type_Int = 1;
      getWindow().getDecorView().setOnClickListener(this);
      setContentView(paramArrayList);
      paramBaseActivity = ((FlashChatManager)paramBaseActivity.app.getManager(QQManagerFactory.FLASH_CHAT_MANAGER)).a.e;
      if (!TextUtils.isEmpty(paramBaseActivity))
      {
        paramArrayList = (ImageView)paramArrayList.findViewById(2131374122);
    ...
    for (;;)
    {
      ...
      return;
      paramArrayList = a();
      bdla.b(null, "dc00898", "", "", "0X8008AA1", "0X8008AA1", 0, 0, "", "", "", "");
  ...
  private View a()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560900, null, false);
    localView.findViewById(2131369837).setOnClickListener(this);
    localView.findViewById(2131364699).setOnClickListener(this);
    TextView localTextView = (TextView)localView.findViewById(2131371931);
    String str = this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.c();
    if (!TextUtils.isEmpty(str)) {
      localTextView.setText(str);
    }
    this.jdField_a_of_type_ComTencentWidgetListView = ((XListView)localView.findViewById(2131370180));
    this.jdField_a_of_type_ComTencentWidgetListView.setSelector(new ColorDrawable(0));
    this.jdField_a_of_type_Aoyo = new aoyo(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
    this.jdField_a_of_type_Aoyo.a(localList);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Aoyo);
    ((Button)localView.findViewById(2131365067)).setOnClickListener(this);
    return localView;
  }
  ...
  private View b()
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560932, null, false);
    ...
    ((RelativeLayout.LayoutParams)localObject3).width = AIOUtils.dp2px(286.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    ((PressDarkImageView)localObject3).setId(2131364699);
    ((PressDarkImageView)localObject3).setImageResource(2130846548);
    ...
    ((RelativeLayout.LayoutParams)localObject4).topMargin = AIOUtils.dp2px(28.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    localObject3 = (TextView)((View)localObject2).findViewById(2131365681);
    ...
    localObject4 = (ImageView)((View)localObject2).findViewById(2131366364);
    Object localObject5 = (TextView)((View)localObject2).findViewById(2131371966);
    localObject3 = (TextView)((View)localObject2).findViewById(2131364993);
    ((View)localObject2).findViewById(2131365067).setOnClickListener(this);
    Object localObject6 = (TextView)((View)localObject2).findViewById(2131376294);
    ((TextView)localObject6).setTag(Long.valueOf(((QIMNotifyAddFriend)localObject1).uin));
    Object localObject7 = this.jdField_a_of_type_Aoay.a(((QIMNotifyAddFriend)localObject1).uin, ((QIMNotifyAddFriend)localObject1).qqUin);
    label410:
    int i;
    int j;
    int k;
    if (TextUtils.isEmpty((CharSequence)localObject7))
    {
      ...
      ((ImageView)localObject4).setImageDrawable(FaceDrawable.getUserFaceDrawable(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, String.valueOf(((QIMNotifyAddFriend)localObject1).uin), (byte)2));
      ...
      if (i > 0)
      {
        localObject2 = (LinearLayout)((View)localObject2).findViewById(2131378085);
        ((LinearLayout)localObject2).setVisibility(0);
        if (i != 1) {
          break label685;
        }
        localObject3 = new ImageView(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
        i = AIOUtils.dp2px(128.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        j = AIOUtils.dp2px(188.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = AIOUtils.dp2px(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839616);
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject3).setOnClickListener(new aoym(this, ((QIMNotifyAddFriend.VideoInfo)((QIMNotifyAddFriend)localObject1).videoInfos.get(0)).videoVid));
    ...
    for (;;)
    {
      ...
      if (i < ((List)localObject1).size())
      {
        ...
        j = AIOUtils.dp2px(76.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = AIOUtils.dp2px(122.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        int m = AIOUtils.dp2px(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839616);
      ...
      for (;;)
      {
        ...
        ((URLImageView)localObject5).setOnClickListener(new aoyn(this, (ArrayList)localObject3, (QIMNotifyAddFriend.VideoInfo)localObject4));
  ...
  public void a()
  {
    Button localButton = (Button)getWindow().findViewById(2131365067);
  ...
  public boolean a(List<QIMNotifyAddFriend> paramList)
  {
    ...
    if (this.jdField_a_of_type_Aoyo != null)
    {
      ...
      this.jdField_a_of_type_Aoyo.a(this.jdField_a_of_type_JavaUtilList);
      a();
      bool = true;
    }
    return bool;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aoay.a(this.b);
      if (this.jdField_a_of_type_Int == 1)
      {
        bdla.b(null, "dc00898", "", "", "0X8008A9F", "0X8008A9F", 0, 0, "", "", "", "");
      }
      else if (this.jdField_a_of_type_Int == 2)
      {
        bdla.b(null, "dc00898", "", "", "0X8008AA2", "0X8008AA2", 0, 0, "", "", "", "");
        continue;
        if (this.jdField_a_of_type_Int == 1) {
          bdla.b(null, "dc00898", "", "", "0X8008AA0", "0X8008AA0", 0, 0, "", "", "", "");
        }
        for (;;)
        {
          dismiss();
          ...
          if (this.jdField_a_of_type_Int == 2) {
            bdla.b(null, "dc00898", "", "", "0X8008AA3", "0X8008AA3", 0, 0, "", "", "", "");
          }
        }
        dismiss();
      }
