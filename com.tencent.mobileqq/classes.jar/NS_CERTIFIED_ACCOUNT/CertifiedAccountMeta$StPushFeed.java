  ...
  extends MessageMicro<StPushFeed>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48 }, new String[] { "feedId", "cover", "userId", "title", "type", "feedCreateTime" }, new Object[] { "", null, "", "", localInteger, localInteger }, StPushFeed.class);
  }
}
