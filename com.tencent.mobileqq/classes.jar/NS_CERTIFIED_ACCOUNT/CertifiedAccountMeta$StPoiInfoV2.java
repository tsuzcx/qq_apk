  ...
  extends MessageMicro<StPoiInfoV2>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 42, 48, 58, 64, 72, 82, 90, 98, 106, 112, 120, 130, 138, 146 }, new String[] { "poiId", "name", "poiType", "typeName", "address", "districtCode", "gps", "distance", "hotValue", "phone", "country", "province", "city", "poiNum", "poiOrderType", "defaultName", "district", "dianPingId" }, new Object[] { "", "", localInteger, "", "", localInteger, null, localInteger, localInteger, "", "", "", "", localInteger, localInteger, "", "", "" }, StPoiInfoV2.class);
  }
}
