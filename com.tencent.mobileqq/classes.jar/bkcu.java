...
public class bkcu
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, bkcy parambkcy)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return bkcv.a().a("http://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/qzone_yellow_icon_v6.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), parambkcy);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130848748);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bkcy parambkcy)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, parambkcy, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bkcy parambkcy, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      bkcv.a().a(paramString, paramInt1, "border", parambkcy);
      continue;
      switch (paramInt3)
      {
      }
    }
    return bkcv.a().a(paramString, paramInt1, "head", parambkcy);
    return bkcv.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, parambkcy);
    return bkcv.a().a(paramString, paramInt1, "right", parambkcy);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, bkcy parambkcy)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return bkcv.a().a(paramString, paramInt2, str, true, parambkcy);
    }
    return null;
  }
