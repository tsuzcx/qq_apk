...
public class auie
{
  ...
  public auie(QQAppInterface paramQQAppInterface)
  {
  ...
  private WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq a(FileManagerEntity paramFileManagerEntity, long paramLong)
  {
    ...
    if (paramFileManagerEntity.strFileSHA != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_sha.set(bmua.a(paramFileManagerEntity.strFileSHA));
    }
    if (paramFileManagerEntity.strFileMd5 != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bmua.a(paramFileManagerEntity.strFileMd5));
    }
    ...
    if (paramFileManagerEntity.WeiYunDirKey != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_pdir_key.set(bmua.a(paramFileManagerEntity.WeiYunDirKey));
    }
    ...
    if (paramFileManagerEntity.tmpSessionType > 0L)
    {
      ...
      paramFileManagerEntity.tmpSessionSig = auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.peerUin, (int)paramFileManagerEntity.tmpSessionType);
  ...
  private String a(String paramString1, String paramString2, int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 39, new Object[] { paramString1, paramObject });
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localPair = bmrn.a(paramString2, paramInt, paramBoolean);
      localFile = new File(bmrn.b(), Long.toString(((Long)localPair.second).longValue()));
    ...
    paramString1 = new auio(this, paramString1, paramInt, paramObject);
    bmsl.a().a((String)((Pair)localPair.first).first, paramString2, (String)((Pair)localPair.first).second, paramString1);
    return null;
  }
  
  private void a(FileManagerEntity paramFileManagerEntity, bfjs parambfjs, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      return;
      long l1 = 0L;
      int i = auea.a(parambfjs.jdField_a_of_type_JavaLangString);
      Object localObject;
      long l2;
      if ((FileUtil.isFileExists(parambfjs.jdField_a_of_type_JavaLangString)) && ((i == 0) || (i == 2))) {
        if (i == 0)
        {
          localObject = new BitmapFactory.Options();
          ((BitmapFactory.Options)localObject).inJustDecodeBounds = true;
          BitmapFactory.decodeFile(parambfjs.jdField_a_of_type_JavaLangString, (BitmapFactory.Options)localObject);
          l2 = bgke.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, parambfjs.g, parambfjs.c, parambfjs.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, Long.toString(parambfjs.b), paramFileManagerEntity.nSessionId, ((BitmapFactory.Options)localObject).outWidth, ((BitmapFactory.Options)localObject).outHeight);
          paramFileManagerEntity = localTroopFileTransferManager.a(parambfjs.jdField_a_of_type_JavaUtilUUID);
          l1 = l2;
      ...
      {
        agfe.a().a(l1, 0L, paramInt1);
        return;
        if (i == 2)
        {
          localObject = ShortVideoUtils.getVideoFileRtAndTime(parambfjs.jdField_a_of_type_JavaLangString);
          l2 = bgke.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, parambfjs.g, parambfjs.c, parambfjs.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, Long.toString(parambfjs.b), paramFileManagerEntity.nSessionId, localObject[0], localObject[1], localObject[2]);
          paramFileManagerEntity = localTroopFileTransferManager.a(parambfjs.jdField_a_of_type_JavaUtilUUID);
          l1 = l2;
          if (paramFileManagerEntity != null)
          {
            ...
            l1 = l2;
            continue;
            l1 = bgke.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramFileManagerEntity.fileName, paramFileManagerEntity.fileSize, parambfjs.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, Long.toString(8888L), paramFileManagerEntity.nSessionId);
          }
        }
      }
    }
  ...
  private void a(WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq paramAioPicAndVideoCopyToWeiyunMsgReq, auir paramauir)
  {
    bmqx.a();
    bmsd.a(paramAioPicAndVideoCopyToWeiyunMsgReq, new auin(this, paramauir));
  }
  ...
  {
    boolean bool = false;
    int i = auea.a(paramFileManagerEntity);
    if (i == 2)
    {
      ...
      if (!TextUtils.isEmpty(paramFileManagerEntity.WeiYunDirKey)) {
        paramWeiyunShareAddFromMobileQQMsgReq.file.pdir_key.set(bmua.a(paramFileManagerEntity.WeiYunDirKey));
      }
      bool = true;
    }
    label111:
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramFileManagerEntity = bgke.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
  ...
  private void b()
  {
    if (!bmtw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
    {
      if (NetworkUtils.isWifiAvailable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
      {
        this.c = true;
        bmtw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), new auip(this));
      }
      return;
    }
    this.b = true;
    bmqz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), true);
    WeiyunTransmissionGlobal.getInstance().getUploadManager().loadLibFromPath(bmtw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()).getAbsolutePath());
  }
  
  public auiw a(FileManagerEntity paramFileManagerEntity, Object paramObject, bmsy parambmsy)
  {
    if (paramFileManagerEntity == null) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localPair = atht.a(paramFileManagerEntity.WeiYunFileId);
      if (localPair != null) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    if (paramFileManagerEntity.nWeiYunSrcType == 2) {
      paramFileManagerEntity = bmsl.a().a(paramFileManagerEntity.strLargeThumPath, paramFileManagerEntity.strThumbPath, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.WeiYunFileId, parambmsy);
    }
    label290:
    for (;;)
    {
      return new auiw(paramFileManagerEntity, paramObject, false, null, parambmsy);
      paramFileManagerEntity = bmqz.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.strFileSHA, paramFileManagerEntity.fileSize, 0, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.strLargeThumPath);
      if (paramFileManagerEntity == null) {}
      for (paramFileManagerEntity = null;; paramFileManagerEntity = bmsl.a().a(paramFileManagerEntity, bmrn.a(), true, parambmsy))
      {
  ...
  public auiw a(String paramString, Object paramObject, UploadManager.IUploadStatusListener paramIUploadStatusListener)
  {
    if ((!this.b) && (!this.c)) {
      b();
    }
    ...
    paramString = bmqz.b(paramString, UploadFile.createUploadBatch(1, null), 1);
    if (paramString == null) {}
    ...
    label138:
    return new auiw(paramString, paramObject, true, paramIUploadStatusListener, null);
  }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    localFileManagerEntity.peerNick = auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, null, paramFileManagerEntity.peerType);
    ...
    for (localFileManagerEntity.selfUin = paramFileManagerEntity.peerUin;; localFileManagerEntity.selfUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity FileManagerEntity:" + auea.a(localFileManagerEntity));
      }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity : entity is null, peerUin[" + auea.e(paramString2) + "], peerType[" + paramInt1 + "]");
      }
      paramFileManagerEntity = null;
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(paramString2, paramFileManagerEntity, true, localFileManagerEntity.fileName, localFileManagerEntity.fileSize, true, paramInt1, str, localFileManagerEntity.msgSeq, localFileManagerEntity.msgSeq, null, 2, l, localFileManagerEntity.msgUid, -1L, bcrg.a());
      paramFileManagerEntity = localFileManagerEntity;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity peerType[" + paramInt1 + "],FileManagerEntity:" + auea.a(localFileManagerEntity));
      return localFileManagerEntity;
      if (paramInt1 == 1006)
      {
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 31, new Object[] { Integer.valueOf(0), "network error", paramString1 });
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      bmsd.a(localLibInfoListGetMsgReq, new auif(this, paramString1));
      return;
      if (this.jdField_a_of_type_JavaUtilLinkedHashMap != null) {
        break label168;
      }
  ...
  public void a(ChatMessage paramChatMessage, auir paramauir)
  {
    ...
    for (;;)
    {
      ...
      a(localAioPicAndVideoCopyToWeiyunMsgReq, paramauir);
      return;
  ...
  public void a(FileManagerEntity paramFileManagerEntity, int paramInt, boolean paramBoolean)
  {
    if (paramFileManagerEntity == null)
    {
      ...
      auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0L, "actFileWy2Of", 0L, "", "", "", "", 9006L, "entity is null", 0L, 0L, 0L, "", "", 0, "", null);
      auea.a();
      return;
    }
    ...
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 3, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 33, new Object[] { Integer.valueOf(2), "", Long.valueOf(paramFileManagerEntity.nSessionId) });
      ...
      auea.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileWy2Of", 0L, "", paramFileManagerEntity.peerUin, "", "", 9004L, "Error_No_Network", 0L, 0L, 0L, "", "", 0, "", null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().c(paramFileManagerEntity);
      return;
    }
    QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "=_= ^ [CS Send]sendWyFile2QqOffline, peerUin[" + auea.e(paramFileManagerEntity.peerUin) + "peerType[" + paramInt + "]], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    paramFileManagerEntity.fProgress = 0.0F;
    long l;
    try
    {
      l = Long.parseLong(paramFileManagerEntity.peerUin.replace("+", ""));
      awtp localawtp = (awtp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.SHIELD_LIST_MANAGER);
      if ((localawtp != null) && (localawtp.a(paramFileManagerEntity.peerUin)))
      {
        auea.c(anvx.a(2131716285));
        paramFileManagerEntity.status = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 3, null);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 33, new Object[] { Integer.valueOf(10), "", Long.valueOf(paramFileManagerEntity.nSessionId) });
        if (QLog.isColorLevel()) {
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      if ((TextUtils.isEmpty(paramFileManagerEntity.WeiYunFileId)) || (TextUtils.isEmpty(paramFileManagerEntity.fileName)))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().c(paramFileManagerEntity);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(paramFileManagerEntity.nSessionId, 1005);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 33, new Object[] { Integer.valueOf(1), "", Long.valueOf(paramFileManagerEntity.nSessionId) });
        return;
      }
      i = 3;
      if (paramInt != 3000) {
    ...
    for (;;)
    {
      ...
      bmsd.a(localCrossBidProxyCopyFileToOtherBidMsgReq, new auik(this, paramFileManagerEntity, paramInt));
      ...
      break;
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bmua.a(""));
    }
  }
  
  public void a(FileManagerEntity paramFileManagerEntity, long paramLong, String paramString, boolean paramBoolean1, boolean paramBoolean2, auir paramauir)
  {
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      if (paramauir != null) {
    ...
    } while (paramauir == null);
    paramauir.a(13, "");
    return;
    bmsd.a(localWeiyunShareAddFromMobileQQMsgReq, new auih(this, paramauir));
  }
  ...
  public void a(FileManagerEntity paramFileManagerEntity, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localbfjs = localTroopFileTransferManager.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.getFilePath(), paramFileManagerEntity.fileSize, 25, i, 8888L);
      } while (localbfjs == null);
      a(paramFileManagerEntity, localbfjs, paramString, paramInt, i);
      paramFileManagerEntity.status = 2;
      if (NetworkUtil.isNetSupport(BaseApplication.getContext())) {
        break;
      }
      paramFileManagerEntity.status = 0;
      paramFileManagerEntity.isReaded = false;
      localTroopFileTransferManager.a(localbfjs.jdField_a_of_type_JavaUtilUUID, -1, null, anvx.a(2131716283));
    } while (!QLog.isColorLevel());
    QLog.i("WeiYunLogicCenter<FileAssistant>", 2, "sendWeiYun2Troop : network error");
    return;
    if (QLog.isColorLevel()) {
      QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "sendWeiYun2Troop, peerUin[" + auea.e(paramFileManagerEntity.peerUin) + "], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    }
    paramFileManagerEntity.fProgress = 0.0F;
    long l2 = 0L;
    try
    {
      ...
      bmsd.a(a(paramFileManagerEntity, l1), new auil(this, localTroopFileTransferManager, localbfjs, paramFileManagerEntity));
      return;
    }
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    atpm.a(paramWeiYunFileInfo.jdField_a_of_type_JavaLangString, paramWeiYunFileInfo);
    ...
    if (paramWeiYunFileInfo.b != null) {
      ((WeiyunPB.DiskSimpleFileItem)localObject).pdir_key.set(bmua.a(paramWeiYunFileInfo.b));
    }
    ...
    bmsd.a((WeiyunPB.DiskDirFileBatchDeleteExMsgReq)localObject, new auiq(this, paramWeiYunFileInfo));
  }
  
  public void a(WeiYunFileInfo paramWeiYunFileInfo, auir paramauir)
  {
    ...
    paramauir.a(-2, "no_weiyunid_or_filename");
    return;
    WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq localCrossBidProxyCopyFileToOtherBidMsgReq = new WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq();
    ...
    if (paramWeiYunFileInfo.j != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_sha.set(bmua.a(paramWeiYunFileInfo.j));
    }
    if (paramWeiYunFileInfo.i != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bmua.a(paramWeiYunFileInfo.i));
    }
    for (;;)
    {
      ...
      if (paramWeiYunFileInfo.b != null) {
        localCrossBidProxyCopyFileToOtherBidMsgReq.src_pdir_key.set(bmua.a(paramWeiYunFileInfo.b));
      }
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_bid.set(25);
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_uin.set(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_group.set(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
      ...
      localCrossBidProxyCopyFileToOtherBidMsgReq.user_type.set(0);
      bmsd.a(localCrossBidProxyCopyFileToOtherBidMsgReq, new auim(this, paramauir));
      return;
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bmua.a(""));
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 45, new Object[] { Integer.valueOf(0), BaseApplication.getContext().getString(2131694253) });
      return;
    }
    ...
    bmsd.a(localPwdVerifyMsgReq, new auij(this, paramString));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 278, new Object[] { Integer.valueOf(1810001), anvx.a(2131716286), "", "", "", "", Integer.valueOf(0) });
      return;
    }
    ...
    localDiskFileDocDownloadAbsMsgReq.pdir_key.set(bmua.a(paramString2));
    bmsd.a(localDiskFileDocDownloadAbsMsgReq, new auig(this));
  }
  
  public void a(List<MessageForPic> paramList, List<MessageForShortVideo> paramList1, auir paramauir)
  {
    WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq localAioPicAndVideoCopyToWeiyunMsgReq = new WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq();
