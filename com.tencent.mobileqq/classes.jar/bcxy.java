  ...
  extends bcvs
{
  ...
  public bcxy(String paramString)
  {
    this();
    this.aa = paramString;
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      paramBundle = bdzx.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic, 65537);
      if ((this.jdField_a_of_type_JavaNetURL != null) && (this.jdField_a_of_type_JavaNetURL.equals(paramBundle))) {}
    }
    for (paramBundle = ahdu.a(paramContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic);; paramBundle = null)
    {
      ...
      if (paramBundle == null)
      {
        ...
        ((MessageForPic)localObject).path = this.aa;
        ((MessageForPic)localObject).uuid = this.ab;
        ((MessageForPic)localObject).md5 = this.ac;
      ...
      for (paramBundle = this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare.currentAccountUin;; paramBundle = this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare.uin)
      {
        ...
        paramBundle = bdsh.a(bdzx.a((ayye)localObject, 1, null).toString());
        ...
        localObject = ahdu.a(paramContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPic);
        ...
        autv.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare, paramContext);
        return paramContext;
      }
      paramView = new BubbleImageView(paramContext);
      paramView.setId(2131368450);
      paramView.setAdjustViewBounds(true);
      if (this.q != 0)
      {
        i = afur.a(this.q, paramContext.getResources());
        label522:
      ...
      label634:
      for (int i = afur.a(this.r, paramContext.getResources());; i = bdzx.a(false))
      {
        paramView.setMaxHeight(i);
        if (this.o != 0) {
          paramView.setMinimumWidth(afur.a(this.o, paramContext.getResources()));
        }
        if (this.p != 0) {
          paramView.setMinimumHeight(afur.a(this.p, paramContext.getResources()));
        }
        paramView.setAdjustViewBounds(true);
  ...
  public MessageForPic a()
  {
    ...
    localMessageForPic.path = this.aa;
    localMessageForPic.uuid = this.ab;
    localMessageForPic.md5 = this.ac;
  ...
  public boolean a(bcxj parambcxj)
  {
    ...
    {
      return true;
      String str4 = parambcxj.a("uuid");
      String str3 = parambcxj.a("md5");
      String str6 = parambcxj.a("md5");
      String str5 = parambcxj.a("filesize");
      String str2 = parambcxj.a("local_path");
      String str1 = str4;
      if (str4 == null) {
        str1 = "";
      }
      ...
      if (str3 == null)
      {
        ...
        str1 = "";
        this.aa = str1;
        this.o = afur.a(parambcxj, "minWidth");
        this.p = afur.a(parambcxj, "minHeight");
        this.q = afur.a(parambcxj, "maxWidth");
        this.r = afur.a(parambcxj, "maxHeight");
        if (str6 == null) {}
      }
      try
      {
        ...
        QLog.d("StructMsg", 2, parambcxj.getMessage());
        return true;
        str1 = str3;
        break label76;
        label193:
