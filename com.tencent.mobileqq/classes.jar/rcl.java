...
public class rcl
{
  private static Pattern a = Pattern.compile(bhoa.c.pattern() + "|" + bhoa.d.pattern(), 2);
  ...
  private static int a(Spannable paramSpannable, int paramInt1, int paramInt2)
  {
    ...
    while (localMatcher.find())
    {
      ...
      paramInt2 += 1;
      paramSpannable.setSpan(new swm(str), i, j, 0);
    }
    return paramInt2;
  }
  ...
  public static boolean a(Spannable paramSpannable)
  {
    ...
    {
      return false;
      if (bhoa.b.matcher(paramSpannable).find())
      {
        Object localObject = (swm[])paramSpannable.getSpans(0, m, swm.class);
        int j;
        int n;
        int i;
        ...
        int k = 0;
        localObject = (swk[])paramSpannable.getSpans(0, m, swk.class);
        if ((localObject != null) && (localObject.length > 0))
        {
          Arrays.sort((Object[])localObject, new rcm(paramSpannable));
  ...
  public static boolean a(EditText paramEditText, String paramString, boolean paramBoolean1, boolean paramBoolean2, List<SocializeFeedsInfo.BiuCommentInfo> paramList)
  {
    ...
    paramEditText = ozq.b(a(localEditable.toString(), str));
    if (TextUtils.isEmpty(paramEditText))
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), ""));
      return true;
    }
    swk[] arrayOfswk = (swk[])localEditable.getSpans(0, localEditable.length(), swk.class);
    if ((arrayOfswk == null) || (arrayOfswk.length <= 0))
    {
      if (paramBoolean1) {
        break label650;
      }
    ...
    for (;;)
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), bcsa.a(b((String)localObject + paramEditText, str))));
      return true;
      int m = arrayOfswk.length;
      Arrays.sort(arrayOfswk, new rcm(localEditable));
      paramEditText = bcsa.a(b(localEditable.subSequence(0, localEditable.getSpanStart(arrayOfswk[0])).toString(), str));
      ...
      if (i < m)
      {
        ...
        if (i == m - 1)
        {
          ...
          paramEditText = "";
          if (j - n > 0) {
            paramEditText = bcsa.a(b(localEditable.subSequence(n, j).toString(), str));
          }
        ...
        for (;;)
        {
          i += 1;
          break;
          j = localEditable.getSpanStart(arrayOfswk[(i + 1)]);
          break label372;
          label481:
          ...
          else if ((localObject instanceof swl))
          {
            paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), paramEditText, 3, new SocializeFeedsInfo.JumpInfo(0L, anzj.a(2131714799), ((swl)localObject).a())));
          }
        }
      }
      return false;
