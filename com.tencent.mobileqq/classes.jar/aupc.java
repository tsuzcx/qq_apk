...
public class aupc
{
  ...
  public static aupc a(mutualmark.MutualMark paramMutualMark)
  {
    aupc localaupc = new aupc();
    localaupc.jdField_a_of_type_Long = paramMutualMark.uint64_type.get();
    localaupc.jdField_b_of_type_Long = paramMutualMark.uint64_level.get();
    localaupc.jdField_a_of_type_Float = paramMutualMark.float_count.get();
    localaupc.jdField_c_of_type_Long = paramMutualMark.uint64_day.get();
    localaupc.jdField_d_of_type_Long = paramMutualMark.uint64_time.get();
    localaupc.f = paramMutualMark.uint64_icon_status.get();
    if (localaupc.f != 2L)
    {
      localaupc.g = 0L;
    ...
    {
      localaupc.jdField_a_of_type_Boolean = bool;
      ...
      if (paramMutualMark != null)
      {
        if (paramMutualMark.bytes_static_url.has()) {
          localaupc.jdField_a_of_type_JavaLangString = paramMutualMark.bytes_static_url.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_dynamic_url.has()) {
          localaupc.jdField_b_of_type_JavaLangString = paramMutualMark.bytes_dynamic_url.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_cartoon_url.has()) {
          localaupc.jdField_c_of_type_JavaLangString = paramMutualMark.bytes_cartoon_url.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_cartoon_md5.has()) {
          localaupc.jdField_d_of_type_JavaLangString = paramMutualMark.bytes_cartoon_md5.get().toStringUtf8();
        }
        if (paramMutualMark.bytes_word.has()) {
          localaupc.jdField_e_of_type_JavaLangString = paramMutualMark.bytes_word.get().toStringUtf8();
        }
      }
      return localaupc;
      ...
      localaupc.g = paramMutualMark.uint64_icon_status_end_time.get();
      break;
    }
  }
