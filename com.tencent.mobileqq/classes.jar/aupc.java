...
{
  public static int a;
  static apcu jdField_a_of_type_Apcu = new aupl();
  private final long jdField_a_of_type_Long = 1800000L;
  private acju jdField_a_of_type_Acju;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aupq(this);
  public aupz a;
  auqc jdField_a_of_type_Auqc;
  aurg jdField_a_of_type_Aurg = new aupm(this);
  ...
  public aupc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedLog = new aupt(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedChannel = new aupu(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedLoading = new aupv(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedReport = new aupe(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedDownloader = new aupf(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedRecord = new aupg(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyQqshareCustomizedShareForQQ = new auph(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyQQKandianInterface = new aupi(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedWebView = new aupj(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedDns = new aupk(this);
    try
    {
      ...
      e();
      f();
      this.jdField_a_of_type_Aupz = new aupz(paramQQAppInterface);
  ...
  private static void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    for (str = "https://now.qq.com/qq/play.html?_bid=2374&_wv=16778245&from=50320";; str = "https://now.qq.com/h5/index.html?_bid=2336&_wv=16778245&from=50320&roomid=" + paramLong)
    {
      ...
      auqe.a().a().a("", String.valueOf(paramLong), paramString2, paramString1);
      ...
      aeub.a(BaseApplicationImpl.getContext(), paramString2, paramString1);
      return;
    }
  }
  ...
  {
    return bfwv.a(BaseApplicationImpl.getContext(), "com.tencent.now");
  }
  ...
  {
    jdField_a_of_type_Int = apdi.a().a(jdField_a_of_type_Apcu);
  }
  
  private void e()
  {
    this.jdField_a_of_type_Auqc = new auqc();
    InitData localInitData = new InitData();
    localInitData.mAppID = "2";
    localInitData.mSourceVersion = String.valueOf(aqmy.a(BaseApplicationImpl.getContext()));
    ...
    NowLive.setShadowImp(this.jdField_a_of_type_Auqc);
  ...
  private void g()
  {
    ...
    if (l >= 1800000L)
    {
      ...
      a(str, new aupr(this, localLoginData, localTicketManager, str));
    }
  }
  
  public aurg a()
  {
    return this.jdField_a_of_type_Aurg;
  }
  ...
  public void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    long l2 = ((Long)awka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "key_nearby_now_qq_connect_auth_time", Long.valueOf(0L))).longValue();
    QLog.d("XProxy|NowProxy", 1, "now qq connect auth time diff = " + (l1 - l2) / 1000L);
    if ((this.jdField_a_of_type_Acju == null) || (l1 - l2 > 1728000000L))
    {
      awka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "key_nearby_now_qq_connect_auth_time", Long.valueOf(l1));
      acjz.a();
      this.jdField_a_of_type_Acju = acjz.a(paramActivity, 6, "101490787");
    }
    paramActivity = new WeakReference(paramActivity);
    this.jdField_a_of_type_Acju.a("loginSilent", null, new aupp(this, paramActivity, paramBundle));
  }
  ...
  public void a(Bundle paramBundle, aupx paramaupx)
  {
    paramBundle.putInt("jumpCallbackId", jdField_a_of_type_Int);
    paramaupx = new Intent();
    paramaupx.putExtras(paramBundle);
    paramaupx.putExtra("public_fragment_window_feature", 1);
    adxr.a(paramaupx, PublicTransFragmentActivity.class, NowQQConnectFragment.class);
  }
  ...
  public void a(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, aurf paramaurf)
  {
    ...
    a(localBundle, new aupd(this, paramaurf));
  }
  
  public void a(String paramString, @NonNull aupw paramaupw)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) {
      paramaupw.a(2, null);
    }
    do
    {
      ...
      paramString = localTicketManager.getSkey(paramString, 16L, new aups(this, paramaupw));
    } while ((paramString == null) || (paramString._sig == null) || (paramString._sig.length == 0));
    paramaupw.a(0, new String(paramString._sig));
  }
  ...
  public void b(Bundle paramBundle, aupx paramaupx)
  {
    paramBundle.putInt("ctrl_cmd", 1);
    NowLive.closeRoom(paramBundle, new aupn(this, paramaupx));
  }
  
  public void b(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, aurf paramaurf)
  {
    b(a(paramBundle, paramNewTogetherRoomMessageData), new aupo(this, paramaurf));
  }
  
  public void c()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      auos.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    }
  }
  ...
  public void onDestroy()
  {
    ...
    ((ausa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(338)).a(1);
    this.jdField_a_of_type_Aupz.b();
