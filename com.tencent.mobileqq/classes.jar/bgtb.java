...
class bgtb
  extends nkp
{
  bgtb(bgsu parambgsu, bgst parambgst, aawl paramaawl) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bgst == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0xdad. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bgst);
      }
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Bgst.a(this.jdField_a_of_type_Aawl.a);
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
