...
public class bcjs
{
  public static final String a = bcjs.class.getSimpleName();
  ...
  public static void a(int paramInt1, int paramInt2, bceq parambceq)
  {
    if ((parambceq == null) || (parambceq.a() == null)) {}
    do
    {
      do
      {
      ...
      if (parambceq.a().equals(bcew.a)) {
        a(null, 0, paramInt2, "0X8009D4E", 0, 0, null, null);
      }
      if (parambceq.a().equals(bcet.a)) {
        a(null, 0, paramInt2, "0X8009D38", 0, 0, null, null);
      }
      if (parambceq.a().equals(bcev.a)) {
        a(null, 0, paramInt2, "0X8009D3C", 0, 0, null, null);
      }
    } while (!parambceq.a().equals(anvx.a(2131715266)));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          bdla.b(paramQQAppInterface, "dc00898", "", "", "qqsearch", paramString1, paramInt1, 0, str2, str1, paramString2, "");
          return;
        }
        catch (Exception localException)
        {
          bdla.b(paramQQAppInterface, "dc00898", "", "", "qqsearch", paramString1, paramInt1, 0, "0", str1, paramString2, "");
          return;
        }
        paramInt1 = 1;
        continue;
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString1, int paramInt3, int paramInt4, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        bdla.b(paramQQAppInterface, "dc00898", "", "", "qqsearch", paramString1, i, 0, paramInt3 + "", paramInt4 + "", paramString2, paramString3);
  ...
  {
    if ((paramObject instanceof bceq)) {
      a(0, paramInt, (bceq)paramObject);
    }
    if ((paramObject instanceof bcez)) {
    ...
    {
      localObject = (bcet)paramObject;
      if (((bcet)localObject).a() == null) {
        break label611;
      }
      i = ((bcet)localObject).a().size();
      if (i > ((bcet)localObject).a())
      {
        i = ((bcet)localObject).a();
        bcnc.a("all_result", "exp_contact", new String[] { "" + paramString, "" + i });
    ...
    else
    {
      ...
      if ((paramObject instanceof bcdb))
      {
        localObject = (bcdb)paramObject;
        if (((bcdb)localObject).a() == null) {
          break label655;
        }
        i = ((bcdb)localObject).a().size();
        if (i <= ((bcdb)localObject).a()) {
          break label652;
        }
        i = ((bcdb)localObject).a();
        label215:
        bcnc.a("all_result", "exp_talk", new String[] { "" + paramString, "" + i });
        a(null, 0, paramInt, "0X8009D4C", 0, 0, null, null);
      }
      if ((paramObject instanceof bmbe))
      {
        localObject = (bmbe)paramObject;
        if (((bmbe)localObject).a() == null) {
          break label699;
        }
        i = ((bmbe)localObject).a().size();
        if (i <= ((bmbe)localObject).a()) {
          break label696;
        }
        i = ((bmbe)localObject).a();
        label329:
        bcnc.a("all_result", "exp_collect", new String[] { "" + paramString, "" + i });
      }
      if ((paramObject instanceof atqq))
      {
        localObject = (atqq)paramObject;
        if (((atqq)localObject).a() == null) {
          break label743;
        }
        i = ((atqq)localObject).a().size();
        if (i <= ((atqq)localObject).a()) {
          break label740;
        }
        i = ((atqq)localObject).a();
        label431:
        bcnc.a("all_result", "exp_file", new String[] { "" + paramString, "" + i });
      }
      label486:
      if ((paramObject instanceof bcfa))
      {
        localObject = (bcfa)paramObject;
        if (((bcfa)localObject).a() == null) {
          break label787;
        }
        i = ((bcfa)localObject).a().size();
        if (i <= ((bcfa)localObject).a()) {
          break label784;
        }
        i = ((bcfa)localObject).a();
        bcnc.a("all_result", "exp_discuss", new String[] { "" + paramString, "" + i });
      }
    }
    for (;;)
    {
      ...
      break;
      label611:
      bcnc.a("all_result", "exp_contact", new String[] { "" + paramString, "0" });
      break label137;
      label652:
      break label215;
      label655:
      bcnc.a("all_result", "exp_talk", new String[] { "" + paramString, "0" });
      break label270;
      label696:
      break label329;
      label699:
      bcnc.a("all_result", "exp_collect", new String[] { "" + paramString, "0" });
      break label384;
      label740:
      break label431;
      label743:
      bcnc.a("all_result", "exp_file", new String[] { "" + paramString, "0" });
      break label486;
      label784:
      break label533;
      label787:
      bcnc.a("all_result", "exp_discuss", new String[] { "" + paramString, "0" });
    }
  }
  ...
  protected static void b(String paramString, QQAppInterface paramQQAppInterface, ReportModel paramReportModel)
  {
    ...
    do
    {
      ...
      paramReportModel.version = "8.4.10";
      NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), bcwd.class);
