...
public class aqab
  extends adcg
{
  private adaa jdField_a_of_type_Adaa;
  private Dialog jdField_a_of_type_AndroidAppDialog;
  private aqaf jdField_a_of_type_Aqaf = new aqaf(null);
  ...
  private adaa jdField_b_of_type_Adaa;
  ...
  private bihn a(int paramInt)
  {
    if (this.jdField_a_of_type_Adch != null)
    {
      WebViewFragment localWebViewFragment = this.jdField_a_of_type_Adch.a();
      if (localWebViewFragment != null) {
        return (bihn)localWebViewFragment.getComponentProvider().a(paramInt);
      }
      if ((this.jdField_a_of_type_Adch.a() instanceof bigr)) {
        return (bihn)((bigr)this.jdField_a_of_type_Adch.a()).getComponentProvider().a(paramInt);
      }
    }
    return null;
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    AppInterface localAppInterface = this.jdField_a_of_type_Adch.a();
    ...
    localActivity = this.jdField_a_of_type_Adch.a();
    ...
    {
      paramString4 = "";
      if (this.jdField_a_of_type_Adch.a() != null)
      {
        paramString2 = this.jdField_a_of_type_Adch.a().getUrl();
  ...
  private void a(JSONObject paramJSONObject, @NonNull adaa paramadaa)
  {
    ...
    {
      addh.a(this.jdField_a_of_type_Adaa, -1, "no auth");
      return;
    }
    ...
    try
    {
      ...
      addh.a(paramadaa, paramJSONObject);
      return;
    }
  ...
  private void b(JSONObject paramJSONObject, @NonNull adaa paramadaa)
  {
    ...
    {
      addh.a(this.jdField_a_of_type_Adaa, -5, "other");
      return;
    }
    try
    {
      this.jdField_a_of_type_Aqaf.jdField_a_of_type_JavaLangString = paramJSONObject.optString("appID");
      this.jdField_a_of_type_Aqaf.jdField_b_of_type_JavaLangString = paramJSONObject.optString("paramsStr");
      this.jdField_a_of_type_Aqaf.c = paramJSONObject.optString("packageName");
      this.jdField_a_of_type_Aqaf.d = paramJSONObject.optString("flags");
      this.jdField_a_of_type_Aqaf.g = paramJSONObject.optString("url");
      if (TextUtils.isEmpty(this.jdField_a_of_type_Aqaf.jdField_a_of_type_JavaLangString))
      {
        QLog.e("ArkWebModule", 1, "mOpenAppinfo.appId is null");
        addh.a(this.jdField_a_of_type_Adaa, -2, "param error");
        return;
      }
    }
    catch (Exception paramJSONObject)
    {
      ...
      if (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(this.jdField_a_of_type_Aqaf.jdField_a_of_type_JavaLangString))
      {
        paramJSONObject = (Integer)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(this.jdField_a_of_type_Aqaf.jdField_a_of_type_JavaLangString);
        if (paramJSONObject != null)
        {
          if (paramJSONObject.intValue() == 1)
          {
            paramJSONObject = this.jdField_a_of_type_Adch.a();
            if (!bhfn.a(paramJSONObject, this.jdField_a_of_type_Aqaf.c))
            {
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Aqaf.g))
              {
                paramadaa = new Intent(paramJSONObject, QQBrowserActivity.class);
                paramadaa.putExtra("url", this.jdField_a_of_type_Aqaf.g);
                paramadaa.putExtra("fromArkAppDownload", true);
                paramJSONObject.startActivity(paramadaa);
              }
              addh.a(this.jdField_a_of_type_Adaa, -4, "need to download");
              return;
            }
            a(this.jdField_a_of_type_Aqaf.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Aqaf.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Aqaf.c, this.jdField_a_of_type_Aqaf.d, this.jdField_a_of_type_Aqaf.e, this.jdField_a_of_type_Aqaf.f);
            addh.a(this.jdField_a_of_type_Adaa, adac.a);
            return;
          }
          if (paramJSONObject.intValue() == 0)
          {
            d();
            addh.a(this.jdField_a_of_type_Adaa, -3, "user canceled");
            return;
          }
        }
      }
    ...
    do
    {
      ...
      paramadaa = (String)paramJSONObject.next();
    } while ((TextUtils.isEmpty(this.c)) || (!paramadaa.equals(this.c)));
    label802:
    for (paramJSONObject = (String)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramadaa);; paramJSONObject = "ask")
    {
      ...
      if (paramJSONObject.equals("ask"))
      {
        ...
        paramadaa = this.jdField_a_of_type_Adch.a();
        if (paramadaa == null) {
          break;
        }
        try
        {
          long l = Long.parseLong(this.jdField_a_of_type_Aqaf.jdField_a_of_type_JavaLangString);
          aasr.a(paramadaa, this.jdField_a_of_type_Adch.a(), paramadaa.getAccount(), l, 2000L, new aqac(this, paramJSONObject));
          return;
        }
        catch (NumberFormatException paramadaa)
        {
          QLog.e("ArkWebModule", 1, String.format("mOpenAppinfo appid to Long error, err=%s", new Object[] { paramadaa.getMessage() }));
          paramadaa = paramJSONObject.getString(2131690185);
          a(String.format(paramJSONObject.getString(2131690186), new Object[] { paramadaa }));
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      {
        ArkAppCenter.b(true);
        Object localObject = this.jdField_a_of_type_Adch.a();
        if (localObject == null) {
          continue;
        }
  ...
  private void c(JSONObject paramJSONObject, @NonNull adaa paramadaa)
  {
    if (!this.jdField_b_of_type_Boolean)
    {
      addh.a(this.jdField_a_of_type_Adaa, -1, "no auth");
    ...
    if (localObject == null)
    {
      addh.a(paramadaa, -3, "other");
      return;
    }
    biho localbiho = (biho)((WebViewFragment)localObject).mComponentsProvider.a(4);
    if (localbiho == null)
    {
      addh.a(paramadaa, -3, "other");
      return;
    ...
    try
    {
      ...
      {
        addh.a(this.jdField_b_of_type_Adaa, -2, "param error");
        return;
      }
    }
    catch (Exception paramJSONObject)
    ...
    paramJSONObject.setClass(localbiho.a, ForwardRecentActivity.class);
    ...
    if (paramJSONObject != null) {
      aupt.a(localbiho.a, paramJSONObject);
    }
    if (QLog.isColorLevel()) {
      QLog.i("ArkWebModule", 2, "buildForwardIntent: " + localObject);
    }
    bjgx.a().a("", "", "", "1000", "101", "0", false);
    bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_38", "qq_ark_share", 0, 1, 0, "", "", "", "");
  ...
  private void d()
  {
    ...
    QQToast.a(localActivity, anvx.a(2131700225), 0).a();
  }
  
  private void d(JSONObject paramJSONObject, @NonNull adaa paramadaa)
  {
    if (!this.jdField_b_of_type_Boolean)
    {
      addh.a(this.jdField_a_of_type_Adaa, -1, "no auth");
    ...
    this.jdField_b_of_type_Adaa = paramadaa;
    Object localObject;
    String str1;
    String str2;
    String str3;
    ...
    for (;;)
    {
      try
      {
        localObject = this.jdField_a_of_type_Adch.a();
        paramadaa = new Intent();
        str1 = paramJSONObject.optString("appName");
        ...
        {
          paramadaa.setClass((Context)localObject, DirectForwardActivity.class);
          paramadaa.putExtra("toUin", str2);
          paramadaa.putExtra("uinType", i);
          paramadaa.putExtra("nickName", str3);
          paramadaa.putExtra("shareQQType", paramJSONObject.optInt("shareQQType", 13));
          paramadaa.putExtra("forward_type", 27);
          paramadaa.putExtra("openerProc", MobileQQ.getMobileQQ().getQQProcessName());
          paramadaa.putExtra("k_back", paramJSONObject.optBoolean("k_back", paramJSONObject.optBoolean("back", false)));
      ...
      {
        addh.a(this.jdField_b_of_type_Adaa, -4, "other");
        QLog.e("ArkWebModule", 1, "shareArkMsg error: " + paramJSONObject.toString());
        return;
      }
      paramadaa.putExtra("isWebCompShare", true);
      paramadaa.setClass((Context)localObject, ForwardRecentActivity.class);
    }
    String str7 = a();
    paramadaa.putExtra("forward_ark_app_name", str1);
    paramadaa.putExtra("forward_ark_app_view", str3);
    paramadaa.putExtra("forward_ark_app_desc", (String)localObject);
    paramadaa.putExtra("forward_ark_app_ver", str2);
    paramadaa.putExtra("forward_ark_app_prompt", str6);
    paramadaa.putExtra("forward_ark_app_meta", str5);
    paramadaa.putExtra("forward_ark_app_config", str4);
    paramadaa.putExtra("forward_ark_app_compat", paramJSONObject);
    paramadaa.putExtra("is_ark_display_share", true);
    paramadaa.putExtra("appName", str1);
    paramadaa.putExtra("appView", str3);
    paramadaa.putExtra("appMinVersion", str2);
    paramadaa.putExtra("metaData", str5);
    paramadaa.putExtra("scale", ArkAppCenterUtil.getDensity());
    if (!TextUtils.isEmpty(str7)) {
      paramadaa.putExtra("forward_ark_h5_from_js", str7);
    }
    a(paramadaa, (byte)0);
  }
  
  private void e(JSONObject paramJSONObject, @NonNull adaa paramadaa)
  {
    boolean bool1 = true;
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      for (;;)
      {
        try
        {
          if (paramJSONObject.has("enable"))
          {
            ...
            paramJSONObject = this.jdField_a_of_type_Adch.a();
            if ((paramJSONObject == null) || (!(paramJSONObject instanceof bikf))) {
              break;
            }
            paramJSONObject = (bikf)paramJSONObject;
            if (bool2) {
              break label94;
            }
        ...
        {
          addh.a(paramadaa, -2, "param error");
          return;
        }
        bool1 = false;
      }
  ...
  private void f(JSONObject paramJSONObject, @NonNull adaa paramadaa)
  {
    boolean bool1 = true;
    if (!this.jdField_b_of_type_Boolean)
    {
  ...
  {
    super.a();
    if ((this.jdField_a_of_type_Adch.a() instanceof ArkBrowserFragment)) {
  ...
  {
    if ((paramByte == 0) && (this.jdField_b_of_type_Adaa != null))
    {
      if (paramInt == -1) {
        addh.a(this.jdField_b_of_type_Adaa, adac.a);
      }
    }
    else {
      return;
    }
    addh.a(this.jdField_b_of_type_Adaa, -3, "user cancel");
  }
  ...
  protected void a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidAppDialog = new ReportDialog(BaseActivity.sTopActivity, 2131755829);
      ...
      localTextView1.setText(2131719342);
      if (!TextUtils.isEmpty(paramString)) {
        localTextView2.setText(paramString);
      }
      localTextView4.setText(2131720094);
      localTextView4.setOnClickListener(new aqad(this));
      localTextView3.setOnClickListener(new aqae(this));
      localTextView3.setText(2131690697);
    }
    do
    {
      return;
      localTextView1 = (TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131365644);
  ...
  public boolean a(int paramInt, String paramString, JSONObject paramJSONObject, @NonNull adaa paramadaa)
  {
    ...
    {
      return true;
      c(paramJSONObject, paramadaa);
      continue;
      d(paramJSONObject, paramadaa);
      continue;
      b(paramJSONObject, paramadaa);
      continue;
      e(paramJSONObject, paramadaa);
      continue;
      f(paramJSONObject, paramadaa);
    }
  }
}
