  ...
  extends asmu
{
  ...
  public static List<asmu> a(int[] paramArrayOfInt)
  {
    ...
    {
      assp localassp = new assp();
      localassp.jdField_a_of_type_Int = paramArrayOfInt[i];
      localassp.jdField_c_of_type_Int = 1;
      localArrayList.add(localassp);
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < m)
        {
          ...
          if ((n < 0) || (n >= begd.jdField_a_of_type_Int)) {
            break label218;
          }
          int k = i + 1;
          paramAppRuntime[i] = n;
  ...
  {
    return behh.a(this.jdField_a_of_type_Int, false);
  }
  
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    if (this.d == 1) {
      bdll.b(null, "CliOper", "", "", "0X8005507", "0X8005507", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      int i = paramEditText.getSelectionStart();
      int j = paramEditText.getSelectionEnd();
      paramEditText.getEditableText().replace(i, j, behh.b(this.jdField_a_of_type_Int));
      paramEditText.requestFocus();
      return;
      if (this.d == 2) {
        bdll.b(null, "CliOper", "", "", "0X8005508", "0X8005508", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  {
    return behh.a(this.jdField_a_of_type_Int, true);
  }
}
