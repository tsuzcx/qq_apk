...
public class assp
{
  ...
  public static void a(Activity paramActivity, aslm paramaslm, String paramString, EditExtendFriendInfo.SchoolInfo paramSchoolInfo)
  {
    ...
    paramString = String.format(paramActivity.getString(2131698418), new Object[] { paramString });
    bhdj.a(paramActivity, 230).setMessage(paramString).setPositiveButton(paramActivity.getString(2131698419), new assr(paramaslm, paramSchoolInfo)).setNegativeButton(paramActivity.getString(2131690701), new assq()).show();
  }
