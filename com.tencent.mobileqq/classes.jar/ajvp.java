  ...
  extends ajtb
{
  ...
  private void a(long paramLong1, long paramLong2, long paramLong3, long paramLong4)
  {
    ...
    localGetUserEqqListRequest.begin.set(bbbr.a(paramLong1));
    localGetUserEqqListRequest.limit.set(bbbr.a(paramLong2));
    localGetUserEqqListRequest.seqno.set(bbbr.a(paramLong3));
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      notifyUI(100, bool, localakdp);
      ((PublicAccountHandler)this.app.a(11)).notifyUI(100, true, localakdp);
      return;
      i = 0;
      continue;
      if (paramToServiceMsg.seqno.has())
      {
        ...
        bool = true;
        localakdp.jdField_a_of_type_Boolean = bool;
        paramObject = ((akdh)this.app.getManager(56)).a(paramFromServiceMsg, l2);
        i = 0;
          ...
          if (paramToServiceMsg.ret_info.has())
          {
            ...
            if (i != 0)
            {
              ...
              if (paramFromServiceMsg.err_info.has())
              {
                ...
                i = paramToServiceMsg.seqno.get();
                aoej.a(this.app).a(this.app, paramFromServiceMsg, i, paramToServiceMsg);
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      long l = Long.valueOf(paramString).longValue();
      paramString = new NewIntent(this.app.getApplication().getApplicationContext(), nor.class);
