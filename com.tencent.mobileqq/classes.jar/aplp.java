    ...
    do
    {
      do
      {
        do
        {
          ...
          aplo.a(this.a, paramIntent.getBooleanExtra("extra_can_add_colornote", true));
          ...
          if ((aplo.a(this.a) != null) && (??? != null) && (paramIntent != null) && (???.length == paramIntent.length))
          {
            i = 0;
            for (;;)
            {
              if ((paramIntent != null) && (i < paramIntent.length)) {
                try
                {
                  ...
                  if (j != -1)
                  {
                    apkq localapkq = (apkq)aplo.a(this.a).get();
                    if (localapkq != null) {
                      localapkq.onDeleteColorNote(j, paramIntent[i], false);
                    }
                  }
                  i += 1;
                }
        ...
        aplm.a("ColorNoteQIPCModule", "[onReceive->ACTION_DELETE_ITEM_CALL]\n[mCanAddColorNote]: " + aplo.a(this.a) + "\n");
        return;
      } while ((!???.equals("key_after_sync_msg")) || (aplo.b(this.a) == null));
      ??? = (apoj)aplo.b(this.a).get();
    } while (??? == null);
