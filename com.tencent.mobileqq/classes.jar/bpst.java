  ...
  extends DynamicTextItem
{
  ...
  private static final String jdField_a_of_type_JavaLangString = bpst.class.getSimpleName();
  ...
  public bpst(int paramInt, List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    QLog.i(bqjx.jdField_a_of_type_JavaLangString, 1, "setLetterSpacing" + bool);
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramInt = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(anzj.a(2131703844));
