...
public class bdwj
  extends alia
  implements View.OnClickListener, View.OnLongClickListener, avsz
{
  private static final bdwp jdField_a_of_type_Bdwp = new bdwp(null);
  private final Context jdField_a_of_type_AndroidContentContext;
  private final SparseArray<ArrayList<Entity>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bdwk(this);
  bdxn jdField_a_of_type_Bdxn;
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new bdwl(this);
  private ExpandableListView jdField_b_of_type_ComTencentWidgetExpandableListView;
  
  public bdwj(NewTroopContactView paramNewTroopContactView, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, boolean paramBoolean)
  {
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject + amtj.a(2131701643));
      }
      return paramView;
    ...
    label412:
    paramView.setContentDescription((String)localObject + amtj.a(2131701629));
    return paramView;
  }
  
  private void a(List<bdwn> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Bdwp);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + amtj.a(2131701637));
      }
      return paramView;
      paramViewGroup = (bdwr)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (bdwq)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Bdxn.a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_AndroidUtilSparseArray);
    c();
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new bdwn((Friends)((Iterator)localObject5).next(), -1));
          }
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((bdwn)((Iterator)localObject4).next()).a);
        }
  ...
  {
    bdwo localbdwo = (bdwo)paramView.getTag();
    if (localbdwo == null)
    {
      localbdwo = new bdwo();
      paramView.findViewById(2131369232).setVisibility(0);
      localbdwo.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367758));
      paramView.setTag(localbdwo);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localbdwo.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else if (a(paramInt1, paramInt2) == 2)
      {
        ...
        paramView = this.jdField_a_of_type_Bdxn.a(paramInt1, paramInt2, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, localRelationTroopEntity);
      }
      else
      {
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (bdwo)paramView.getTag();
    ...
    for (;;)
    {
      ...
      if (AppSetting.c)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + amtj.a(2131701631));
      }
    ...
    paramViewGroup.setContentDescription(((Groups)localObject).group_name + amtj.a(2131701648));
    return paramViewGroup;
  }
  ...
  {
    bdwo localbdwo = (bdwo)paramView.getTag();
    if (this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(localbdwo.jdField_a_of_type_Int)) {
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.b(localbdwo.jdField_a_of_type_Int);
    }
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentWidgetExpandableListView.a(localbdwo.jdField_a_of_type_Int);
      }
      catch (Throwable localThrowable) {}
    }
  }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    bfue.a(paramView, localbgaz, this.jdField_a_of_type_AndroidViewView$OnClickListener, new bdwm(this));
    return true;
  }
