  ...
  implements ArkAppMgr.IGetAppPathByNameCallback
{
  ...
  public boolean a(awst paramawst, String paramString, float paramFloat)
  {
    ...
    return super.init(this.jdField_a_of_type_Awst.b(), this.jdField_a_of_type_Awst.d(), this.jdField_a_of_type_Awst.c(), paramString, alta.a(), paramFloat);
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Awst.a();
    ...
    ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new awsv(this));
    return false;
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      altd.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131719092);
    }
    label90:
    for (this.mErrorInfo.msg = String.format((String)localObject, new Object[] { this.jdField_a_of_type_Awst.b() });; this.mErrorInfo.msg = "")
    {
