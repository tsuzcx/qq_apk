...
public class noy
{
  ...
  private void a(Activity paramActivity)
  {
    ...
    {
      a();
      QQToast.a(paramActivity, 1, paramActivity.getString(2131690629), 0).a();
      return;
    }
    ...
    a(paramActivity, localIntent, 2131690616);
  }
  ...
  private void a(Activity paramActivity, String paramString)
  {
    ...
    a(paramActivity, localIntent, 2131690630);
  }
  ...
  private void b(Activity paramActivity)
  {
    ...
    a(paramActivity, (Intent)localObject, 2131690616);
  }
  
  private void c(Activity paramActivity)
  {
    a(paramActivity, new Intent("android.provider.MediaStore.RECORD_SOUND"), 2131690631);
  }
  ...
  public void a(Activity paramActivity, int paramInt, ValueCallback<Uri> paramValueCallback, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (paramInt != 0)
      {
        paramString2 = bjnw.a(paramActivity);
        paramString2.a(new noz(this));
        paramString2.setOnCancelListener(new npa(this));
        if (paramValueCallback.equals("camera"))
        {
          paramString2.a(paramActivity.getString(2131718783), 0);
          paramString2.a(paramActivity.getString(2131692233), 0);
          paramString2.a(new npb(this, paramActivity, paramString1, paramString2));
        }
        for (;;)
        {
          paramString2.show();
          ...
          {
            paramString2.a(paramActivity.getString(2131718139), 0);
            paramString2.a(paramActivity.getString(2131692233), 0);
            paramString2.a(new npc(this, paramActivity, paramString1, paramString2));
          }
          else if (paramValueCallback.equals("microphone"))
          {
            paramString2.a(paramActivity.getString(2131717632), 0);
            paramString2.a(paramActivity.getString(2131692233), 0);
            paramString2.a(new npd(this, paramActivity, paramString1, paramString2));
          }
        }
      }
      a(paramActivity, paramString1);
