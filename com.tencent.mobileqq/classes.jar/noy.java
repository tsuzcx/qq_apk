...
public class noy
{
  ...
  public static int a(Context paramContext, nnw paramnnw)
  {
    if ((paramContext == null) || (paramnnw == null)) {}
    do
    {
      ...
      do
      {
        ...
        {
          return -1;
          paramContext = paramnnw.jdField_f_of_type_JavaLangString;
          paramnnw = paramnnw.jdField_d_of_type_JavaLangString;
          if ((!TextUtils.isEmpty(paramContext)) && (!TextUtils.isEmpty(paramnnw))) {
            break;
          }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("NativeAdUtils", 2, "isPkgDownloading pkg:" + paramContext + ", appid:" + paramnnw + " true");
        }
  ...
  public static JSONObject a(Context paramContext)
  {
    ...
    //   7: astore 6
    //   9: invokestatic 844	ods:a	()Ljava/lang/String;
    //   12: astore 5
    //   14: invokestatic 846	ods:c	()Ljava/lang/String;
    //   17: astore 4
    //   19: aload 5
    ...
    //   231: aload 6
    //   233: ldc_w 936
    //   236: invokestatic 941	dr:a	()J
    //   239: invokestatic 944	dr:a	(J)Ljava/lang/String;
    //   242: invokevirtual 860	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   245: pop
    //   246: aload 6
    //   248: ldc_w 946
    //   251: aload_0
    //   252: invokestatic 949	ors:c	(Landroid/content/Context;)Ljava/lang/String;
  ...
  public static JSONObject a(AdData paramAdData, HashMap<String, Object> paramHashMap)
  {
    try
    {
      ...
      if (paramAdData != null)
      {
        ...
        if (odv.a(paramAdData))
        {
          localJSONObject.put("game_component_type", paramAdData.jdField_a_of_type_Obd.x);
          localJSONObject.put("game_pkg", paramAdData.jdField_a_of_type_Obd.jdField_b_of_type_JavaLangString);
        }
  ...
  public static void a(Activity paramActivity, nnw paramnnw, bfka parambfka)
  {
    ...
    {
      return;
      str1 = paramnnw.jdField_f_of_type_JavaLangString;
      str2 = paramnnw.jdField_d_of_type_JavaLangString;
      str3 = paramnnw.jdField_j_of_type_JavaLangString;
      paramnnw = paramnnw.i;
  ...
  {
    if (oed.a(paramAdData))
    {
      a(new obk().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_b_of_type_Int).b(a(paramAdData)).a(oef.a(paramAdData)).d(a(paramAdData)).a());
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AdData paramAdData, float paramFloat, long paramLong)
  {
    ...
    try
    {
      ...
      if (oed.a(paramAdData))
      {
        a(new obk().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_b_of_type_Int).b(a(paramAdData)).a(oef.a(paramAdData)).c(localJSONObject).d(a(paramAdData)).a());
        return;
      }
    }
    catch (JSONException localJSONException)
  ...
  {
    if (oed.a(paramAdData, false))
    {
      a(new obk().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_a_of_type_Int).b(K).a(oef.a(paramAdData)).d(a(paramAdData)).d(paramInt).a());
      return;
    }
  ...
  public static void a(obi paramobi)
  {
    if (paramobi == null) {}
    ...
    {
      return;
      AppInterface localAppInterface = paramobi.a();
      localContext = paramobi.a();
      i1 = paramobi.a();
      i2 = paramobi.b();
      localAdvertisementInfo = paramobi.a();
      localVideoAdInfo = paramobi.a();
      l1 = paramobi.a();
      str = paramobi.a();
      localJSONObject1 = paramobi.a();
      i3 = paramobi.d();
      localJSONObject2 = paramobi.b();
      localBundle = paramobi.a();
      localJSONObject3 = paramobi.c();
      localJSONObject4 = paramobi.d();
      localJSONObject5 = paramobi.f();
      localJSONObject6 = paramobi.e();
      i4 = paramobi.c();
      bool = paramobi.a();
      paramobi = localAppInterface;
        ...
        if (BaseApplicationImpl.sProcessId == 1)
        {
          ...
          if (localAppRuntime != null)
          {
            ...
            if ((localAppRuntime instanceof QQAppInterface)) {
              paramobi = (QQAppInterface)localAppRuntime;
            }
          }
        }
      }
    } while (paramobi == null);
    ThreadManager.post(new NativeAdUtils.3(localJSONObject3, paramobi.getAccount(), i1, i2, i4, localContext, localAdvertisementInfo, localVideoAdInfo, i3, localJSONObject1, localJSONObject2, localBundle, str, l1, localJSONObject4, localJSONObject6, localJSONObject5, paramobi, bool), 5, null, true);
  }
  ...
  public static boolean a(Context paramContext, nnw paramnnw)
  {
    ...
    do
    {
      ...
      paramnnw = localDownloadInfo.jdField_l_of_type_JavaLangString;
      bool1 = bool3;
      if (!TextUtils.isEmpty(paramnnw))
      {
        bool1 = bool3;
        if (new File(paramnnw).exists()) {
          bool1 = true;
        }
      }
      bool2 = bool1;
    } while (!QLog.isColorLevel());
    QLog.d("NativeAdUtils", 2, "isPkgExist(" + bool1 + ") pkg:" + str1 + ", appid:" + str2 + ", path:" + paramnnw);
    return bool1;
  ...
  public static boolean a(nnw paramnnw)
  {
    String str1 = paramnnw.jdField_f_of_type_JavaLangString;
    String str2 = paramnnw.jdField_d_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      if (paramBaseArticleInfo.mLocalInfo != null) {
        try
        {
          ...
          double d1 = npd.a(paramBaseArticleInfo.mLocalInfo.jdField_e_of_type_JavaLangString, 0.0D);
          double d2 = npd.a(str, 0.0D);
          if ((d2 != 0.0D) || (d1 != 0.0D)) {
    ...
    for (;;)
    {
      try
      {
        ...
        case 1: 
          ...
          localJSONObject.put("rma", ors.c(paramContext));
          return localJSONObject;
        }
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface, AdData paramAdData)
  {
    if (oed.a(paramAdData))
    {
      a(new obk().a(paramQQAppInterface).a(BaseApplication.getContext()).a(jdField_l_of_type_Int).b(a(paramAdData)).a(oef.a(paramAdData)).d(a(paramAdData)).a());
      return;
    }
