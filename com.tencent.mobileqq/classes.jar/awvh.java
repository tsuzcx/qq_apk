...
public class awvh
{
  public static awvi a;
  public static final String a;
  public static HashMap<String, awvi> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aljq.aX + "qbosssplahAD/";
    b = aljq.aX + "qbdownres";
  ...
  public static HashMap<String, awvi> a(Context paramContext, String paramString)
  {
    try
    {
      ...
      while (paramContext.hasNext())
      {
        ...
        awvj localawvj = new awvj();
        localawvj.g(paramString).a(str1).b(str2).c(str3).c(i).d(str4).e(k).f(str6).e(str5).d(j).b(bool1).a(bool2).b(m).h(str7).i(str8).a(n);
        QLog.i("QSplash@QbossSplashUtil", 1, "buildADEntryFromSP  adid =" + str1);
        jdField_a_of_type_JavaUtilHashMap.put(str1, localawvj.a());
      }
  ...
  public static void a(String paramString1, String paramString2, int paramInt)
  {
    try
    {
      ...
      AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
      NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), ayxu.class);
      try
      {
        localNewIntent.putExtra("uin", Long.parseLong(localAppRuntime.getAccount()));
        localNewIntent.putExtra("qua", bizf.a());
  ...
  public static boolean a(long paramLong)
  {
    ...
    //   9: lload_0
    //   10: invokestatic 473	awvh:a	(Landroid/content/Context;J)Ljava/util/List;
    //   13: astore 7
    //   15: iload 4
    //   17: istore_3
    //   18: aload 7
    ...
    //   90: invokestatic 480	awvh:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/HashMap;
    //   93: astore 9
    //   95: aconst_null
    //   96: astore 6
    //   98: aload 7
    ...
    //   167: aload 8
    //   169: invokevirtual 492	awvi:toString	()Ljava/lang/String;
    ...
    //   181: aload 8
    //   183: invokevirtual 494	awvi:a	()Z
    //   186: ifeq +95 -> 281
    //   189: aload 6
    ...
    //   203: astore 7
    //   205: aload 8
    //   207: getfield 497	awvi:d	I
    //   210: aload 6
    //   212: getfield 497	awvi:d	I
    //   215: if_icmpgt +59 -> 274
    //   218: goto +63 -> 281
    //   221: aload 6
    //   223: putstatic 499	awvh:jdField_a_of_type_Awvi	Lawvi;
    //   226: iconst_1
    //   227: istore_3
    //   228: iload_3
    //   229: ireturn
