  ...
  implements Handler.Callback, HookMethodCallback
{
  ...
  public ahss(BatteryStatsImpl paramBatteryStatsImpl, String paramString)
  {
  ...
  private final void a(ahsu paramahsu, int paramInt)
  {
    Bundle localBundle = new Bundle();
    localBundle.putInt("key_action", paramInt);
    localBundle.putString("key_stack", paramahsu.b);
    localBundle.putString("key_tag", paramahsu.jdField_a_of_type_JavaLangString);
    localBundle.putInt("key_flag", paramahsu.jdField_a_of_type_Int);
    localBundle.putLong("key_time", paramahsu.a());
  ...
  private final void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject3 = (ahst)((Iterator)localObject2).next();
          k = ((ahst)localObject3).jdField_a_of_type_JavaUtilHashSet.size();
          if ((((ahst)localObject3).jdField_a_of_type_Int & 0x1) <= 0) {
            break label506;
          }
          j = 1;
          localObject3 = ((ahst)localObject3).jdField_a_of_type_JavaUtilHashSet.iterator();
        ...
        localObject3 = (ahst)localHashMap1.get(str1);
        StringBuilder localStringBuilder = BatteryLog.a();
        localObject2 = ((ahst)localObject3).jdField_a_of_type_JavaUtilHashSet.iterator();
        i = 0;
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i += 1;
          if (i >= ((ahst)localObject3).jdField_a_of_type_JavaUtilHashSet.size()) {
            break label519;
          }
        ...
        if (paramBoolean)
        {
          ...
          String str2 = ((ahst)localObject3).jdField_a_of_type_JavaLangString.replace("|", "_");
          if ((((ahst)localObject3).jdField_a_of_type_Int & 0x1) <= 0) {
            break label529;
          }
          localObject3 = "1";
    ...
    if ((this.jdField_a_of_type_Boolean) && ((i == 3) || (i == 4) || (i == 5)))
    {
      ...
      if (i == 3) {
        synchronized (this.jdField_b_of_type_JavaUtilHashMap)
        {
          ...
          {
            localahst2 = (ahst)this.jdField_b_of_type_JavaUtilHashMap.get(str);
            localahst1 = localahst2;
            if (localahst2 == null)
            {
              localahst1 = new ahst(this, null);
              localahst1.jdField_a_of_type_Int = paramBundle.getInt("key_flag");
              localahst1.jdField_a_of_type_JavaLangString = paramBundle.getString("key_tag");
              this.jdField_b_of_type_JavaUtilHashMap.put(str, localahst1);
            }
            localahst1.jdField_a_of_type_JavaUtilHashSet.add(new Pair(Long.valueOf(System.currentTimeMillis()), Long.valueOf(paramBundle.getLong("key_time"))));
          }
          if ((this.jdField_c_of_type_Boolean) && (this.d))
          {
            localahst2 = (ahst)this.jdField_c_of_type_JavaUtilHashMap.get(str);
            localahst1 = localahst2;
            if (localahst2 == null)
            {
              localahst1 = new ahst(this, null);
              localahst1.jdField_a_of_type_Int = paramBundle.getInt("key_flag");
              localahst1.jdField_a_of_type_JavaLangString = paramBundle.getString("key_tag");
              this.jdField_c_of_type_JavaUtilHashMap.put(str, localahst1);
            }
            localahst1.jdField_a_of_type_JavaUtilHashSet.add(new Pair(Long.valueOf(System.currentTimeMillis()), Long.valueOf(paramBundle.getLong("key_time"))));
          }
          return;
  ...
  public void a(String paramString, Object paramObject1, Object[] paramArrayOfObject, Object paramObject2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          localObject3 = (ahsu)this.jdField_a_of_type_JavaUtilHashMap.get(localObject2);
          if (((WeakReference)localObject2).get() == paramObject1)
          {
            ...
            if (paramArrayOfObject.length == 0)
            {
              ...
              paramString = ((ahsu)localObject3).a((PowerManager.WakeLock)paramObject1, paramObject2, localObject1);
            ...
            for (;;)
            {
              ...
              BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, 4, 0, 0, "Acquire " + ((ahsu)localObject3).jdField_a_of_type_JavaLangString + " too frequently", HighFrequencyDetector.a((List)paramString.second));
              break;
              l = ((Long)paramArrayOfObject[0]).longValue();
              break label291;
              if (l >= this.jdField_a_of_type_Long)
              {
                BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wl_alm", "|", ((ahsu)localObject3).c, "|0|", String.valueOf(((Pair)localObject4).second) });
                BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, 4, 1, 0, "Acquire " + ((ahsu)localObject3).jdField_a_of_type_JavaLangString + " too long time", "CallStack: " + ((ahsu)localObject3).b);
              }
            }
          }
          else if (((WeakReference)localObject2).get() == null)
          {
            if (((ahsu)localObject3).a())
            {
              BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, 4, 2, 1, "WakeLock " + ((ahsu)localObject3).jdField_a_of_type_JavaLangString + " not release", "CreateStack: " + ((ahsu)localObject3).b);
              BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wl_alm", "|", ((ahsu)localObject3).c, "|1" });
              a((ahsu)localObject3, 4);
            }
            ((ahsu)localObject3).a();
    ...
    {
      localObject2 = (WeakReference)localIterator.next();
      paramString = (ahsu)this.jdField_a_of_type_JavaUtilHashMap.get(localObject2);
      if (((WeakReference)localObject2).get() == paramObject1)
      {
        if (paramArrayOfObject == null) {
          break label1236;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 1) {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        paramMessage = (ahsu)this.jdField_a_of_type_JavaUtilHashMap.get(paramMessage);
