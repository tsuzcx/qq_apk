...
{
  ajjj jdField_a_of_type_Ajjj = (ajjj)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  public List<ResultRecord> a;
  boolean jdField_a_of_type_Boolean = false;
  
  public ahss(TroopAddFrdsInnerFrame paramTroopAddFrdsInnerFrame)
  {
    ...
    paramTroopAddFrdsInnerFrame.b = paramTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getResources().getDimensionPixelOffset(2131166872);
    paramTroopAddFrdsInnerFrame.c = paramTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getResources().getDimensionPixelOffset(2131166873);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131495130, paramViewGroup, false);
      paramView = new ahsr();
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131309439);
      paramView.jdField_a_of_type_AndroidViewView.setId(2131311927);
      paramViewGroup = localView.findViewById(2131310966);
      localObject2 = (RelativeLayout.LayoutParams)paramViewGroup.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject2).addRule(0, 2131311927);
      ((RelativeLayout.LayoutParams)localObject2).rightMargin = aciy.a(10.0F, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources());
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131309446));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131305159));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131310547));
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131309433));
      paramView.d = ((TextView)localView.findViewById(2131309443));
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131298633));
      paramView.e = ((TextView)localView.findViewById(2131312394));
      paramView.jdField_b_of_type_AndroidViewView = localView.findViewById(2131307294);
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView.setPadding(0, aciy.a(2.0F, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources()), 0, 0);
      ...
      {
        localView.findViewById(2131311927).setPadding(0, 0, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.b, 0);
        localView.setTag(paramView);
      }
    }
    else
    {
      localahsr = (ahsr)localView.getTag();
      if (j >= 0) {
        break label1325;
      }
      j = -(j + 1) - 1;
      ...
      localahsr.jdField_a_of_type_ComTencentMobileqqDataTroopMemberInfo = ((TroopMemberInfo)localObject2);
      ...
      localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
      label485:
      if (!AppSetting.c) {
        break label1442;
      }
    ...
    for (;;)
    {
      localahsr.jdField_b_of_type_AndroidViewView.setVisibility(0);
      localahsr.e.setVisibility(8);
      localahsr.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(a(((TroopMemberInfo)localObject2).memberuin));
      Object localObject3 = babh.h(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TroopMemberInfo)localObject2).troopuin, ((TroopMemberInfo)localObject2).memberuin);
      ...
      if (!TextUtils.isEmpty(((TroopMemberInfo)localObject2).recommendRemark))
      {
        ...
        if (!TextUtils.equals(((TroopMemberInfo)localObject2).recommendRemark, ((TroopMemberInfo)localObject2).memberuin))
        {
          ...
          {
            paramViewGroup = (ViewGroup)localObject3;
            if (!this.jdField_a_of_type_Ajjj.b(((TroopMemberInfo)localObject2).memberuin)) {
              paramViewGroup = (String)localObject3 + " (" + ((TroopMemberInfo)localObject2).recommendRemark + ")";
            }
          }
        }
      }
      localahsr.jdField_a_of_type_AndroidWidgetTextView.setText(paramViewGroup);
      localahsr.jdField_a_of_type_JavaLangString = ((TroopMemberInfo)localObject2).memberuin;
      localahsr.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      if (AppSetting.c) {
        paramView.append(paramViewGroup);
      }
      if (((TroopMemberInfo)localObject2).commonFrdCnt > 0)
      {
        localahsr.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources().getString(2131624218, new Object[] { Integer.valueOf(((TroopMemberInfo)localObject2).commonFrdCnt) }));
        localahsr.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        if (AppSetting.c) {
          paramView.append(localahsr.jdField_b_of_type_AndroidWidgetTextView.getText());
        }
        label784:
        if (!this.jdField_a_of_type_Boolean) {
          localahsr.jdField_b_of_type_AndroidViewView.setEnabled(true);
        }
        ...
        localahsr.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        localahsr.d.setVisibility(0);
        localahsr.d.setText(ajjy.a(2131649361));
        if (this.jdField_a_of_type_Boolean)
        {
          localahsr.jdField_b_of_type_AndroidViewView.setEnabled(false);
          localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        }
        if (!AppSetting.c) {
          break label1437;
        }
        localahsr.d.setContentDescription(ajjy.a(2131649363));
        paramInt = 0;
      }
      for (;;)
      {
        label916:
        localObject3 = localahsr.jdField_a_of_type_AndroidViewView;
        if (paramInt != 0)
        {
          paramViewGroup = (ViewGroup)localObject2;
          label930:
          ((View)localObject3).setTag(paramViewGroup);
          localObject2 = localahsr.jdField_a_of_type_AndroidViewView;
          paramViewGroup = localObject1;
          if (paramInt != 0) {
            paramViewGroup = this;
          }
          ((View)localObject2).setOnClickListener(paramViewGroup);
          paramViewGroup = localahsr.jdField_a_of_type_AndroidViewView;
          if (paramInt == 0) {
            break label1313;
          }
          label968:
          paramViewGroup.setClickable(bool);
          paramViewGroup = localahsr.jdField_a_of_type_AndroidWidgetCheckBox;
          if (!this.jdField_a_of_type_Boolean) {
            break label1319;
          }
        }
        ...
        for (paramInt = i;; paramInt = 8)
        {
          ...
          localahsr.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
          localahsr.jdField_b_of_type_AndroidViewView.setTag(localahsr);
          if (AppSetting.c) {
            localView.setContentDescription(paramView.toString());
          }
          return localView;
          localView.findViewById(2131311927).setPadding(0, 0, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.c, 0);
          break;
          localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
          break label485;
          localahsr.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
          break label784;
          label1080:
          ...
          if (paramInt == 3)
          {
            localahsr.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
            localahsr.d.setVisibility(0);
            localahsr.d.setText(ajjy.a(2131649359));
            if (this.jdField_a_of_type_Boolean)
            {
              localahsr.jdField_b_of_type_AndroidViewView.setEnabled(false);
              localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
            ...
            localahsr.d.setContentDescription(ajjy.a(2131649358));
            paramInt = 0;
            break label916;
          }
          if (this.jdField_a_of_type_Boolean)
          {
            localahsr.jdField_b_of_type_AndroidViewView.setEnabled(true);
            localahsr.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
            localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
            localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(a((TroopMemberInfo)localObject2));
            localahsr.jdField_a_of_type_AndroidWidgetCheckBox.setTag(localahsr);
          }
          for (paramInt = 0;; paramInt = 1)
          {
            localahsr.d.setVisibility(8);
            break;
            localahsr.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
            localahsr.jdField_a_of_type_AndroidWidgetButton.setText(ajjy.a(2131624088));
            if (AppSetting.c) {
              localahsr.jdField_a_of_type_AndroidWidgetButton.setContentDescription(ajjy.a(2131624088));
            }
          }
          paramViewGroup = null;
          break label930;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.f == TroopAddFrdsInnerFrame.d)
        {
          ...
          localahsr.e.setText(paramView);
          localahsr.e.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131626315), new Object[] { paramView.toLowerCase() }));
          return localView;
        }
        localahsr.e.setVisibility(8);
  ...
  public void onClick(View paramView)
  {
    ...
    label204:
    paramView = ((ahsr)localObject).jdField_a_of_type_ComTencentMobileqqDataTroopMemberInfo;
    ...
    ((Intent)localObject).putExtra("selfSet_leftViewText", this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131654617));
    ((Intent)localObject).putExtra("custom_leftbackbutton_name", this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131625011));
    atxx.a(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Intent)localObject, 9);
  }
}
