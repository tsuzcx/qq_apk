...
public class oqm
{
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ThreadManager.executeOnSubThread(new ReadInJoyPatchAdUtils.2(localnwv));
      return;
      localnwv.f = 3;
      localnwv.e = 0;
    }
  ...
  public static void a(Activity paramActivity, sfq paramsfq, seu paramseu, seo paramseo, sfw paramsfw, oqo paramoqo)
  {
    ReadInJoyPatchAdView localReadInJoyPatchAdView = paramsfq.a();
    if (localReadInJoyPatchAdView == null) {
      return;
    }
    localReadInJoyPatchAdView.setOnPatchAdListener(new oqn(localReadInJoyPatchAdView, paramActivity, paramsfq, paramseu, paramsfw, paramseo, paramoqo));
  }
  
  public static void a(sey paramsey, int paramInt1, int paramInt2)
  {
    if (paramInt1 == 1)
    {
      paramsey.a.patchStatus.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(paramInt2);
      return;
    }
    paramsey.a.patchStatus.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(paramInt2);
  }
  
  public static void a(sey paramsey, sfq paramsfq, boolean paramBoolean, oqo paramoqo)
  {
    int j = 0;
    sfq localsfq = null;
    if (!b(paramsey, paramsfq)) {}
    for (int i = 0;; i = 1)
    {
      if (i != 0) {
        if (paramBoolean)
        {
          paramsfq = paramsfq.a().a;
          localsfq = paramsfq;
          if (paramsfq != null) {
            break label71;
          }
      ...
      for (;;)
      {
        if ((i != 0) && (paramoqo != null)) {
          paramoqo.a(paramsey, paramsfq);
        }
        return;
        paramsfq = a(1);
        break;
  ...
  public static void a(sey paramsey, sfq paramsfq, boolean paramBoolean1, boolean paramBoolean2, sfw paramsfw, seo paramseo, oqo paramoqo)
  {
    int j = 1;
    Object localObject = null;
    if (!a(paramsey, paramsfq)) {
      j = 0;
    }
    int i = j;
    if (paramBoolean1)
    ...
    if (i != 0)
    {
      ...
      localAdvertisementInfo = paramsfq.a().a;
    ...
    if (j != 0) {
      paramoqo.b(paramsey, localObject);
    }
    label116:
    while (paramsfw == null)
    {
    ...
    paramsfw.a(paramsfq.a());
    paramseo.c();
  }
  
  public static void a(sfq paramsfq)
  {
    if (paramsfq.a() != null)
    {
      paramsfq.a().setVisibility(8);
      paramsfq.a().a();
    }
  }
  ...
  public static boolean a(sey paramsey)
  {
    if ((paramsey == null) || (paramsey.a == null)) {}
    while (paramsey.jdField_b_of_type_Long != 56L) {
      return false;
    }
    return true;
  }
  
  public static boolean a(sey paramsey, sfq paramsfq)
  {
    int i = paramsey.a.patchStatus.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get();
    if ((i != 0) && (i != 2)) {
      return false;
    }
    return c(paramsey, paramsfq);
  }
  
  public static boolean a(sfq paramsfq)
  {
    if ((paramsfq == null) || (paramsfq.a() == null)) {}
    while ((paramsfq.a() == null) || (paramsfq.a().getVisibility() != 0)) {
      return false;
    }
    return true;
  }
  ...
  public static boolean b(sey paramsey, sfq paramsfq)
  {
    int i = paramsey.a.patchStatus.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get();
    if ((i != 0) && (i != 2)) {
      return false;
    }
    return c(paramsey, paramsfq);
  ...
  private static boolean c(sey paramsey, sfq paramsfq)
  {
    if (paramsey.jdField_b_of_type_Int <= 30) {}
    while ((paramsey.a.mChannelID != 56L) || (paramsey.jdField_b_of_type_Boolean) || ((paramsfq != null) && (paramsfq.a()))) {
      return false;
    }
    return true;
  }
  ...
  public static void d()
  {
    ...
    if ((((ArrayBlockingQueue)localObject).size() <= 2) || (localArrayBlockingQueue.size() <= 2))
    {
      ...
      ((nwv)localObject).e = 3;
      ((nwv)localObject).f = 3;
      ThreadManager.executeOnSubThread(new ReadInJoyPatchAdUtils.1((nwv)localObject));
    }
  }
