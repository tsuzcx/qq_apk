  ...
  extends oqg
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = oqm.class.getSimpleName();
  }
  
  public oqm(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    a(pde.a("OidbSvc.0xbbe", 3006, 1, localReqBody.toByteArray()));
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (pde.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject) != 0) {
          break label525;
        }
