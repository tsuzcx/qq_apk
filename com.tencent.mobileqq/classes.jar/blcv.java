...
public class blcv
{
  ...
  private CopyOnWriteArrayList<blcx> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public blcv()
  {
    bldx.a("MobileQQprotect.QSecCb", new blcw(this));
    a();
  }
  ...
  private String a()
  {
    return blbe.a() + File.separator + "QSecCb.dat";
  }
  
  private void a()
  {
    byte[] arrayOfByte = new bldt().a(a(), null, 1);
    if (arrayOfByte != null) {
      a(arrayOfByte);
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        ((blcx)paramString.next()).a(localLinkedList);
        continue;
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	blcv:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   42: iload_3
  ...
  private byte[] a()
  {
    ...
    //   16: astore 4
    //   18: aload_0
    //   19: getfield 18	blcv:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
  ...
  private void b()
  {
    byte[] arrayOfByte = a();
    if (arrayOfByte != null) {
      new bldt().a(a(), arrayOfByte, null, 1);
    }
  }
  ...
  public void a(blcx paramblcx)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramblcx);
  }
  ...
  public void a(boolean paramBoolean)
  {
    try
    {
      ...
      bldx.a("MobileQQprotect.QSecCb", localQSecCbQuery.toByteArray());
      return;
    }
