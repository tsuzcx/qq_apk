  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  public akfg(@NonNull BaseActivity paramBaseActivity, @NonNull ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    super(paramBaseActivity, 2131689632);
    if ((paramArrayList == null) || (paramArrayList.size() < 1)) {
      throw new RuntimeException("empty data");
    }
    getWindow().setDimAmount(0.5F);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Ajph = ((ajph)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface().getManager(257));
    ...
    {
      paramArrayList = b();
      awqx.b(null, "dc00898", "", "", "0X8008A9E", "0X8008A9E", 0, 0, "", "", "", "");
      ...
      {
        paramArrayList = (ImageView)paramArrayList.findViewById(2131307107);
    ...
    for (;;)
    {
      ...
      return;
      paramArrayList = a();
      awqx.b(null, "dc00898", "", "", "0X8008AA1", "0X8008AA1", 0, 0, "", "", "", "");
  ...
  private View a()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131494957, null, false);
    localView.findViewById(2131303279).setOnClickListener(this);
    localView.findViewById(2131298701).setOnClickListener(this);
    TextView localTextView = (TextView)localView.findViewById(2131305115);
    String str = this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.c();
    if (!TextUtils.isEmpty(str)) {
      localTextView.setText(str);
    }
    this.jdField_a_of_type_ComTencentWidgetListView = ((XListView)localView.findViewById(2131303596));
    this.jdField_a_of_type_ComTencentWidgetListView.setSelector(new ColorDrawable(0));
    this.jdField_a_of_type_Akfj = new akfj(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
    this.jdField_a_of_type_Akfj.a(localList);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Akfj);
    ((Button)localView.findViewById(2131299051)).setOnClickListener(this);
    return localView;
  }
  ...
  private View b()
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131495000, null, false);
    localRelativeLayout.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = localRelativeLayout;
    Object localObject2 = localRelativeLayout.findViewById(2131299599);
    ((View)localObject2).setOnClickListener(this);
    Object localObject3 = (RelativeLayout.LayoutParams)((View)localObject2).getLayoutParams();
    ((RelativeLayout.LayoutParams)localObject3).width = aciy.a(286.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    ((PressDarkImageView)localObject3).setId(2131298701);
    ((PressDarkImageView)localObject3).setImageResource(2130845446);
    Object localObject4 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject4).addRule(3, 2131299599);
    ((RelativeLayout.LayoutParams)localObject4).addRule(14);
    ((RelativeLayout.LayoutParams)localObject4).topMargin = aciy.a(28.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    localObject3 = (TextView)((View)localObject2).findViewById(2131299616);
    ...
    localObject4 = (ImageView)((View)localObject2).findViewById(2131300246);
    Object localObject5 = (TextView)((View)localObject2).findViewById(2131305143);
    localObject3 = (TextView)((View)localObject2).findViewById(2131298979);
    ((View)localObject2).findViewById(2131299051).setOnClickListener(this);
    Object localObject6 = (TextView)((View)localObject2).findViewById(2131309148);
    ((TextView)localObject6).setTag(Long.valueOf(((QIMNotifyAddFriend)localObject1).uin));
    Object localObject7 = this.jdField_a_of_type_Ajph.a(((QIMNotifyAddFriend)localObject1).uin, ((QIMNotifyAddFriend)localObject1).qqUin);
    label410:
    int i;
    int j;
    int k;
    if (TextUtils.isEmpty((CharSequence)localObject7))
    {
      ...
      ((ImageView)localObject4).setImageDrawable(azwp.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, String.valueOf(((QIMNotifyAddFriend)localObject1).uin), (byte)2));
      ...
      if (i > 0)
      {
        localObject2 = (LinearLayout)((View)localObject2).findViewById(2131310724);
        ((LinearLayout)localObject2).setVisibility(0);
        if (i != 1) {
          break label685;
        }
        localObject3 = new ImageView(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
        i = aciy.a(128.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        j = aciy.a(188.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = aciy.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839258);
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject3).setOnClickListener(new akfh(this, ((QIMNotifyAddFriend.VideoInfo)((QIMNotifyAddFriend)localObject1).videoInfos.get(0)).videoVid));
    ...
    for (;;)
    {
      ...
      if (i < ((List)localObject1).size())
      {
        ...
        j = aciy.a(76.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = aciy.a(122.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        int m = aciy.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839258);
      ...
      for (;;)
      {
        ...
        ((URLImageView)localObject5).setOnClickListener(new akfi(this, (ArrayList)localObject3, (QIMNotifyAddFriend.VideoInfo)localObject4));
  ...
  public void a()
  {
    Button localButton = (Button)getWindow().findViewById(2131299051);
  ...
  public boolean a(List<QIMNotifyAddFriend> paramList)
  {
    ...
    if (this.jdField_a_of_type_Akfj != null)
    {
      ...
      this.jdField_a_of_type_Akfj.a(this.jdField_a_of_type_JavaUtilList);
      a();
      bool = true;
    }
    return bool;
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131299051: 
      do
      {
        ...
        this.jdField_a_of_type_Ajph.a(this.b);
        if (this.jdField_a_of_type_Int == 1)
        {
          awqx.b(null, "dc00898", "", "", "0X8008A9F", "0X8008A9F", 0, 0, "", "", "", "");
          return;
        }
      } while (this.jdField_a_of_type_Int != 2);
      awqx.b(null, "dc00898", "", "", "0X8008AA2", "0X8008AA2", 0, 0, "", "", "", "");
      return;
    case 2131298701: 
      if (this.jdField_a_of_type_Int == 1) {
        awqx.b(null, "dc00898", "", "", "0X8008AA0", "0X8008AA0", 0, 0, "", "", "", "");
      }
      for (;;)
      {
        dismiss();
        ...
        if (this.jdField_a_of_type_Int == 2) {
          awqx.b(null, "dc00898", "", "", "0X8008AA3", "0X8008AA3", 0, 0, "", "", "", "");
        }
      }
    }
    dismiss();
