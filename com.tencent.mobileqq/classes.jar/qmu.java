  ...
  implements qrn
{
  ...
  public qmu(FragmentActivity paramFragmentActivity, FragmentManager paramFragmentManager, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, qwy paramqwy, VideoFeedsPlayManager paramVideoFeedsPlayManager, ViewGroup paramViewGroup)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new qmv(this));
  ...
  private void i()
  {
    try
    {
      this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new qmx(this));
      return;
    }
  ...
  public void a(AnchorData paramAnchorData)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null))
    {
      ...
      qoi.a(this.jdField_a_of_type_AndroidViewViewGroup, 0, 100);
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager != null) && (bbfj.h(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity))) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager.h(true);
      }
      this.jdField_a_of_type_Boolean = true;
      if (this.jdField_a_of_type_Qmy != null) {
        this.jdField_a_of_type_Qmy.a(true);
      }
      return;
    }
  }
  
  public void a(qmy paramqmy)
  {
    this.jdField_a_of_type_Qmy = paramqmy;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = (qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity) - this.jdField_a_of_type_Int);
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(qro.a());
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a(2);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a((Bundle)localObject, new qmw(this), this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  public void f()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Qmy != null) {
        this.jdField_a_of_type_Qmy.a(false);
      }
    }
  }
