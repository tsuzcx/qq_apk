  ...
  extends aqvc
{
  ...
  aqur(aque paramaque, MessageRecord paramMessageRecord)
  {
    super(paramaque);
  ...
  void a(String paramString, int paramInt, aqva paramaqva)
  {
    ...
    aque.a(this.jdField_a_of_type_Aque).a().a().a(paramString, paramInt, this.d, 106, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.c, new aqus(this, paramString, paramaqva));
  }
}
