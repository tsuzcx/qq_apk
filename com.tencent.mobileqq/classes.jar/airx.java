  ...
  implements Manager
{
  ...
  aisp jdField_a_of_type_Aisp;
  private aiwe jdField_a_of_type_Aiwe = new aiwe();
  private aiyp jdField_a_of_type_Aiyp;
  private aiyv jdField_a_of_type_Aiyv;
  private aizi jdField_a_of_type_Aizi;
  ajic jdField_a_of_type_Ajic;
  ajok jdField_a_of_type_Ajok;
  Handler jdField_a_of_type_AndroidOsHandler = new aisa(this, ThreadManager.getSubThreadLooper());
  private aukp jdField_a_of_type_Aukp;
  bbwt jdField_a_of_type_Bbwt = new aise(this);
  private QQLruCache<String, ApolloBaseInfo> jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new airy(this, 2009, 1024, ApolloBaseInfo.calcSelfMemorySize());
  ...
  Comparator<DrawerPushItem> jdField_a_of_type_JavaUtilComparator = new aisb(this);
  ...
  private List<aisg> jdField_b_of_type_JavaUtilList;
  private AtomicBoolean jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private bbwt jdField_c_of_type_Bbwt = new aisc(this);
  private Runnable jdField_c_of_type_JavaLangRunnable = new ApolloManager.5(this);
  private List<WeakReference<aisi>> jdField_c_of_type_JavaUtilList = new ArrayList();
  public boolean c;
  public boolean d;
  ...
  public airx(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_OrgJsonJSONObject = new JSONObject();
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = true;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Bbwt = new aisf(this);
    ...
    {
      this.jdField_a_of_type_Ajok = new ajok();
      p();
      aizu.b();
    ...
    this.jdField_a_of_type_Aisp = new aisp(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
    this.jdField_a_of_type_Airv = new airv(paramQQAppInterface);
    n();
  }
    ...
    for (;;)
    {
      try
      {
        if (jdField_c_of_type_Int == -1)
        {
          ...
          {
            i1 = bbkb.q(paramAppInterface.getApplication());
            if (i1 != 0) {
              continue;
            }
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((airx)paramQQAppInterface.getManager(153)).a(paramQQAppInterface.c());
    int i1;
  ...
  {
    if ((paramQQAppInterface == null) || (!b(paramQQAppInterface.getApplication())) || (TextUtils.isEmpty(paramString1)) || (ajmr.jdField_a_of_type_OrgJsonJSONObject == null)) {
      return -1;
    }
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      {
        paramString2 = (airx)paramQQAppInterface.getManager(153);
    ...
    if ((ajmr.jdField_a_of_type_OrgJsonJSONObject != null) && (str != null))
    {
      paramQQAppInterface = ajmr.jdField_a_of_type_OrgJsonJSONObject.optJSONObject(str);
      if (paramQQAppInterface == null) {}
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return 0;
          paramQQAppInterface = ((airx)paramQQAppInterface.getManager(153)).a(paramString);
      ...
      o();
    } while (((!s) && (!u)) || (paramQQAppInterface.apolloStatus != 1));
    int i1;
    if ((u) && ((paramQQAppInterface.cmshow3dFlag & 0x2) == 2) && ((paramQQAppInterface.cmshow3dFlag & 0x1) == 1)) {
      i1 = 2;
    }
    for (;;)
    {
      return i1;
      if ((s) && ((paramQQAppInterface.cmshow3dFlag & 0x1) == 0))
      {
        i1 = 1;
      }
      else
  ...
  {
    if ((paramList == null) || (paramList.size() == 0) || (this.jdField_a_of_type_Aukp == null)) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_Aukp.a(localDrawerPushItem);
        }
        localaukr.c();
        return;
      }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   52: dup
    //   53: getstatic 707	ajms:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    Object localObject = (airx)paramQQAppInterface.getManager(153);
    bbrd localbbrd = (bbrd)paramQQAppInterface.a(71);
    ApolloBaseInfo localApolloBaseInfo = ((airx)localObject).b(paramString1 + "");
    if ((localApolloBaseInfo == null) || (localApolloBaseInfo.apolloUpdateTime == 0L))
    {
      localbbrd.b(paramString1 + "");
      if (QLog.isColorLevel()) {
    ...
    for (paramQQAppInterface = paramString1.substring(0, 4);; paramQQAppInterface = paramString1)
    {
      ...
      do
      {
        ...
        localObject = ((airx)localObject).b(paramQQAppInterface.c());
        ...
        localbbrd.a(localArrayList, paramString2);
  ...
  private void a(ApolloActionPackage paramApolloActionPackage, JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject = ((ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionPackage.packageId);
  ...
  public static boolean a()
  {
    ...
    bbdx.a(new File(ajms.c, "/def/basic").getAbsolutePath());
    do
    {
      try
      {
        long l2 = System.currentTimeMillis();
        a(BaseApplicationImpl.getApplication().getApplicationContext(), "apollo_def_rsc", ajms.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        long l3 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, "copy file to sdcard cost:" + (l3 - l2));
        }
        new File(ajms.c, "def").mkdirs();
        int i1 = LzmaUtils.a(BaseApplicationImpl.getApplication().getApplicationContext(), ajms.jdField_a_of_type_JavaLangString + "/apollo_def_rsc", ajms.c + "/def/");
        bbdx.d(ajms.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        if (i1 != 0) {
          continue;
        }
        boolean bool2 = true;
  ...
  {
    String str = ajms.s + paramString1 + ".zip";
    localObject1 = ajms.s + paramString1 + ".patch";
    localObject2 = ajms.s + paramString1 + ".patched";
    ...
    for (;;)
    {
      try
      {
        if (jdField_d_of_type_Int == -1)
        {
          ...
          if (paramAppInterface != null)
          {
            i1 = bbkb.r(paramAppInterface.getApplication());
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return 0;
            localObject = (airx)paramQQAppInterface.getManager(153);
            paramString = ((airx)localObject).a(paramString);
      ...
      localObject = ((airx)localObject).a(paramQQAppInterface.c());
  ...
  public static void b(boolean paramBoolean)
  {
    ...
    akvi.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  ...
  public static int c(String paramString)
  {
    ...
    do
    {
      ...
      i2 = ajmr.b.optInt(paramString);
      i1 = i2;
    } while (i2 != 2);
    return jdField_e_of_type_Int;
    return ajmr.b.optInt(paramString);
  }
  ...
  public static boolean d()
  {
    ...
    do
    {
      ...
      {
        return false;
        if (!ajmr.b.has("autoOpenBox")) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, new Object[] { "openBoxByH5 autoOpenBox:", Integer.valueOf(ajmr.b.optInt("autoOpenBox")) });
        }
      } while (ajmr.b.optInt("autoOpenBox") != 0);
      return true;
    } while (!QLog.isColorLevel());
  ...
  public static boolean f()
  {
    ...
    try
    {
      String str = ajms.av + "cmshow_script_engine.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
        if (new ajov(str + ".sig", str).a(1)) {
          break label181;
        }
    ...
    if (bool1)
    {
      jdField_d_of_type_JavaLangString = bbdx.b(localFile);
      return bool1;
    }
  ...
  public static boolean g()
  {
    ...
    try
    {
      String str = ajms.av + "cmshow_script_0.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
    ...
    if (bool1)
    {
      jdField_e_of_type_JavaLangString = bbdx.b(localFile);
      return bool1;
    }
  ...
  private void n()
  {
    this.jdField_a_of_type_Aish = new aish(this);
    IntentFilter localIntentFilter = new IntentFilter();
    localIntentFilter.addAction("com.tencent.mobileqq.action.ACTION_APOLLO_STORE_CRASH_EVENT");
    try
    {
      BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Aish, localIntentFilter, "com.tencent.msg.permission.pushnotify", null);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void q()
  {
    ...
    //   18: aload_0
    //   19: getfield 1671	airx:v	Z
    //   22: ifne +550 -> 572
    //   25: aload_0
    //   26: getfield 1671	airx:v	Z
    //   29: ifeq +4 -> 33
    //   32: return
    //   33: aload_0
    //   34: getfield 235	airx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   37: ifnull +293 -> 330
    //   40: aload_0
    //   41: getfield 235	airx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   52: lstore_3
    //   53: aload_0
    //   54: getfield 252	airx:jdField_a_of_type_Aukp	Laukp;
    //   57: ldc 146
    //   59: invokevirtual 1674	aukp:a	(Ljava/lang/Class;)Ljava/util/List;
    //   62: checkcast 101	java/util/ArrayList
    //   65: astore 6
    //   67: aload 6
    //   69: ifnull +498 -> 567
    //   72: aload 6
    //   74: invokevirtual 1675	java/util/ArrayList:size	()I
    //   77: istore_1
    //   78: aload 6
    //   80: invokevirtual 1676	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   83: astore 7
    //   85: aload 7
    ...
    //   102: checkcast 1678	auko
    //   105: checkcast 146	com/tencent/mobileqq/data/ApolloBaseInfo
    //   108: astore 8
    //   110: aload 8
    //   112: ifnull -27 -> 85
    //   115: aload 8
    //   117: getfield 1681	com/tencent/mobileqq/data/ApolloBaseInfo:uin	Ljava/lang/String;
    ...
    //   146: aload 8
    //   148: aconst_null
    //   149: putfield 1684	com/tencent/mobileqq/data/ApolloBaseInfo:apolloSignStr	Ljava/lang/String;
    //   152: aload_0
    //   153: getfield 155	airx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   156: astore 6
    //   158: aload 6
    //   160: monitorenter
    //   161: aload_0
    //   162: getfield 155	airx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   165: aload 8
    //   167: getfield 1681	com/tencent/mobileqq/data/ApolloBaseInfo:uin	Ljava/lang/String;
    //   170: aload 8
    //   172: invokevirtual 1689	com/tencent/commonsdk/cache/QQLruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   175: pop
    //   176: aload 6
    //   178: monitorexit
    //   179: aload 8
    //   181: getfield 1681	com/tencent/mobileqq/data/ApolloBaseInfo:uin	Ljava/lang/String;
    //   184: aload 5
    //   186: invokevirtual 1364	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   189: ifeq -104 -> 85
    //   192: aload_0
    //   193: aload 8
    //   195: putfield 413	airx:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   198: aload_0
    //   199: aload_0
    //   200: getfield 413	airx:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   203: getfield 1692	com/tencent/mobileqq/data/ApolloBaseInfo:apolloAISwitch	I
    //   206: iconst_0
    //   207: invokevirtual 1695	airx:a	(II)V
    //   210: goto -125 -> 85
    //   213: astore 5
    ...
    //   236: ifeq -204 -> 32
    //   239: aload_0
    //   240: getfield 235	airx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   243: ifnull -211 -> 32
    //   246: aload_0
    //   247: getfield 155	airx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   250: aload_0
    //   251: getfield 235	airx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   254: invokevirtual 411	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   257: invokevirtual 1698	com/tencent/commonsdk/cache/QQLruCache:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   293: aload_0
    //   294: getfield 155	airx:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   297: invokevirtual 1701	com/tencent/commonsdk/cache/QQLruCache:size	()I
    ...
    //   345: athrow
    //   346: aload_0
    //   347: getfield 252	airx:jdField_a_of_type_Aukp	Laukp;
    //   350: ldc_w 550
    //   353: invokevirtual 1674	aukp:a	(Ljava/lang/Class;)Ljava/util/List;
    //   356: checkcast 101	java/util/ArrayList
    //   359: astore 6
    //   361: aload 6
    //   363: ifnull +124 -> 487
    //   366: aload_0
    //   367: getfield 132	airx:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   370: astore 5
    //   372: aload 5
    //   374: monitorenter
    //   375: aload_0
    //   376: getfield 135	airx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   379: invokeinterface 1706 1 0
    ...
    //   434: aload_0
    //   435: aload 7
    //   437: invokevirtual 683	airx:a	(Lcom/tencent/mobileqq/DrawerPushItem;)Z
    //   440: ifne +31 -> 471
    //   443: aload_0
    //   444: getfield 135	airx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   447: aload 7
    ...
    //   468: goto -253 -> 215
    //   471: aload_0
    //   472: getfield 252	airx:jdField_a_of_type_Aukp	Laukp;
    //   475: aload 7
    //   477: invokevirtual 1709	aukp:b	(Lauko;)Z
    //   480: pop
    //   481: goto -80 -> 401
    //   484: aload 5
    //   486: monitorexit
    //   487: aload_0
    //   488: getfield 235	airx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   491: ifnull +61 -> 552
    //   494: aload_0
    //   495: getfield 235	airx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   541: ldc_w 765
    //   544: invokeinterface 1717 3 0
    //   549: putfield 1719	airx:k	Ljava/lang/String;
    //   552: aload_0
    //   553: iconst_1
    //   554: putfield 1671	airx:v	Z
    //   557: goto -324 -> 233
    //   560: astore 5
    //   562: iconst_0
    //   563: istore_1
  ...
  private void r()
  {
    ...
    try
    {
      ??? = (ArrayList)this.jdField_a_of_type_Aukp.a(ApolloPandora.class);
      if (??? != null)
      {
  ...
  public airv a()
  {
    return this.jdField_a_of_type_Airv;
  }
  
  public aisk a()
  {
    if (this.jdField_a_of_type_Aisk == null) {}
    try
    {
      if (this.jdField_a_of_type_Aisk == null) {
        this.jdField_a_of_type_Aisk = new aisk(this, null);
      }
      return this.jdField_a_of_type_Aisk;
    }
    finally {}
  }
  ...
  public aisp a()
  {
    return this.jdField_a_of_type_Aisp;
  }
  
  public aiwe a()
  {
    return this.jdField_a_of_type_Aiwe;
  }
  ...
  public aiyp a()
  {
    try
    {
      if (this.jdField_a_of_type_Aiyp == null) {
        this.jdField_a_of_type_Aiyp = new aiyp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      aiyp localaiyp = this.jdField_a_of_type_Aiyp;
      return localaiyp;
    }
    finally {}
  }
  ...
  public aiyv a()
  {
    try
    {
      ...
      aiyv localaiyv = this.jdField_a_of_type_Aiyv;
      return localaiyv;
    }
    finally {}
  }
  ...
  public aizi a()
  {
    if (this.jdField_a_of_type_Aizi == null) {
      this.jdField_a_of_type_Aizi = new aizi(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    return this.jdField_a_of_type_Aizi;
  }
  
  public ajic a()
  {
    if (this.jdField_a_of_type_Ajic == null) {
      this.jdField_a_of_type_Ajic = new airz(this);
    }
    return this.jdField_a_of_type_Ajic;
  }
  ...
  public bbwz a()
  {
    ...
    return ((bbww)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(3);
  }
  ...
  public DrawerPushItem a(String paramString1, String paramString2, JSONObject paramJSONObject, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label496:
      if (paramInt == 1) {
        localDrawerPushItem.ext_url = ajms.T;
      } else if (paramInt == 2) {
  ...
  public ApolloActionData a(QQAppInterface paramQQAppInterface, String paramString, int... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ajhu.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), paramVarArgs);
  ...
  public ApolloPandora a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localApolloPandora = (ApolloPandora)this.jdField_a_of_type_Aukp.a(ApolloPandora.class, paramString);
      ??? = localApolloPandora;
  ...
  public String a()
  {
    if ((!this.f) && (!this.jdField_l_of_type_Boolean)) {
      return ajya.a(2131700467);
    }
    return ajya.a(2131700464);
  }
  ...
  public String a(int paramInt)
  {
    ...
    Object localObject1 = (ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    if (((ajmu)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() == 0) {
      ((ajmu)localObject1).a();
    }
    for (;;)
    {
      localObject2 = (String)((ajmu)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      ...
      return localObject1;
      if (TextUtils.isEmpty((CharSequence)((ajmu)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt)))) {
        ((ajmu)localObject1).a(paramInt);
      }
    }
  }
  ...
  public String a(int paramInt, String paramString)
  {
    ...
    for (paramInt = 2;; paramInt = 1)
    {
      ...
      for (;;)
      {
        ...
        if (bool)
        {
          ...
          if (i2 == 1)
          {
            ...
            if (a() != null)
            {
              ...
              {
                localObject2 = localObject1;
                if (!TextUtils.isEmpty(ajms.ao))
                {
                  localObject2 = ajms.ao;
        ...
        {
          paramString = (String)localObject2;
          if (ajms.ao.equals(localObject2)) {
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      for (long l1 = 0L; (localApolloBaseInfo.appearAction == null) && (NetConnInfoCenter.getServerTime() - l1 > 180L); l1 = ((Long)this.jdField_a_of_type_JavaUtilMap.get(paramString)).longValue())
      {
        ...
        ((bbrd)paramQQAppInterface.a(71)).a(new long[] { Long.parseLong(paramString) });
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (paramString2.jdField_a_of_type_JavaLangString != null) {
      paramQQAppInterface = bfnx.a(paramString1, "facedata", paramString2.jdField_a_of_type_JavaLangString);
    }
    paramString1 = paramQQAppInterface;
    if (paramString2.a() != null) {
      paramString1 = bfnx.a(paramQQAppInterface, "dressids", Arrays.toString(paramString2.a()).replaceAll(" ", ""));
    }
    return bfnx.a(paramString1, "roleid", String.valueOf(paramString2.jdField_a_of_type_Int));
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    return a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ajms.ao, paramString);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (a() != null)
    {
      localObject = new bbwu((List)localObject, localHashMap, "apollo_json_task" + System.currentTimeMillis());
      ((bbwu)localObject).p = true;
      ((bbwu)localObject).j = false;
      ((bbwu)localObject).n = true;
      ((bbwu)localObject).s = false;
      ((bbwu)localObject).f = "apollo_res";
      ((bbwu)localObject).r = true;
      ((bbwu)localObject).q = true;
      a().a((bbwu)localObject, this.jdField_a_of_type_Bbwt, localBundle);
      if ((paramInt & 0x1) == 1) {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    ajmu localajmu = (ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    if (localajmu.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      localajmu.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), paramString);
    }
  ...
  public void a(aisg paramaisg)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 2148	airx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnonnull +17 -> 23
    //   9: aload_0
    //   10: new 101	java/util/ArrayList
    //   13: dup
    //   14: invokespecial 133	java/util/ArrayList:<init>	()V
    //   17: invokestatic 2152	java/util/Collections:synchronizedList	(Ljava/util/List;)Ljava/util/List;
    //   20: putfield 2148	airx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   23: aload_0
    //   24: getfield 2148	airx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   27: astore_2
    //   28: aload_2
    //   29: monitorenter
    //   30: aload_0
    //   31: getfield 2148	airx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   34: aload_1
  ...
  public void a(aisi paramaisi)
  {
    if (paramaisi == null) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, new Object[] { "[setApolloStatusUpdateListener] listener=", paramaisi });
    }
    this.jdField_c_of_type_JavaUtilList.add(new WeakReference(paramaisi));
  }
  ...
  public void a(ajot paramajot)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Ajok != null) {
        this.jdField_a_of_type_Ajok.a(paramajot);
      }
      return;
    }
    finally
  ...
  public void a(DrawerPushItem paramDrawerPushItem, boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!a(paramDrawerPushItem)))
      {
        ...
        if ((this.jdField_a_of_type_Aukp != null) && (paramBoolean)) {
          this.jdField_a_of_type_Aukp.a(paramDrawerPushItem);
        }
        if (QLog.isColorLevel()) {
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 0) && (paramSessionInfo.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (bbfj.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))) {}
    do
    {
      do
      {
  ...
  public void a(ApolloPreDownloadData paramApolloPreDownloadData, String paramString1, String paramString2)
  {
    ...
    paramString2 = (ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
  ...
  {
    if ((paramApolloActionData == null) && (!bbdx.a(ApolloUtil.a(paramApolloActionData, 7)))) {}
    while ((!a(bbdx.a(new File(ApolloUtil.a(paramApolloActionData, 7))), paramApolloActionData)) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ((ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionData);
  }
  ...
  public void a(String paramString1, String paramString2, aism paramaism)
  {
    ...
    do
    {
      return;
      localbbwz = a();
    } while ((localbbwz == null) || (localbbwz.a(paramString1) != null));
    File localFile = new File(paramString2);
    paramString2 = new bbwu(paramString1, localFile);
    if (localFile.exists())
    {
    ...
    localbbwz.a(paramString2, new aisn(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaism), paramString1);
  }
  ...
  public void a(List<ApolloActionData> paramList, String paramString)
  {
    ...
    do
    {
      ...
      paramList = new bbwu(localArrayList, localHashMap, paramString);
      paramList.n = true;
    ...
    a().a(paramList, this.jdField_b_of_type_Bbwt, localBundle);
  }
  ...
  public void a(List<String> paramList, Map<String, File> paramMap, List<ApolloActionData> paramList1, Bundle paramBundle)
  {
    ...
    if (i1 < paramList1.size())
    {
      ...
      if (!apvd.a((String)localObject)) {
        break label216;
      }
      localObject = new bbwu(str1, new File((String)localObject));
      Bundle localBundle = new Bundle();
      localBundle.putSerializable(str1, localApolloActionData);
      ((bbwu)localObject).c = str1;
      ((bbwu)localObject).a(localBundle);
      this.jdField_b_of_type_Bbwt.onDoneFile((bbwu)localObject);
    }
    for (;;)
    {
  ...
  public void a(Map<String, ApolloPreDownloadData> paramMap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ((localObject == null) || (((ApolloPreDownloadData)localObject).status == 0) || (localApolloPreDownloadData.version > ((ApolloPreDownloadData)localObject).version))
          {
            ...
            for (localObject = ApolloUtil.e(localApolloPreDownloadData.dirType) + localApolloPreDownloadData.zipDir;; localObject = ajms.t + localApolloPreDownloadData.resId + ".zip")
            {
      ...
      paramMap = new bbwu(localArrayList, localHashMap, "apollo_preDownload");
      paramMap.n = true;
    ...
    a().a(paramMap, this.jdField_c_of_type_Bbwt, localBundle);
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) || (((paramInt & 0x1) == 1) && (!apvd.a(ApolloUtil.jdField_a_of_type_JavaLangString))))
    {
      a(paramInt);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((TextUtils.isEmpty(paramArrayOfByte)) || (ajmr.a("8.3.0", paramArrayOfByte) >= 0)) {
          break label334;
        }
  ...
  protected boolean a(auko paramauko)
  {
    ...
    QLog.e("ApolloManager", 2, "updateEntity em closed e=" + paramauko.getTableName());
    return false;
  }
  ...
  public boolean a(ApolloActionData paramApolloActionData, int paramInt, ajot paramajot)
  {
    if (paramApolloActionData == null) {}
    for (;;)
    {
      ...
      if ((paramInt & 0x1) == 1)
      {
        ...
        {
          localObject1 = new bbwu((String)localObject1, new File((String)localObject2));
          ((bbwu)localObject1).f = "apollo_res";
          ((bbwu)localObject1).jdField_b_of_type_Int = 1;
          ((bbwu)localObject1).n = true;
          ((bbwu)localObject1).q = true;
          ((bbwu)localObject1).r = true;
          i1 = bbww.a((bbwu)localObject1, a());
          if (i1 != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      if ((paramInt & 0x4) == 4)
      {
        ...
        {
          localObject2 = new bbwu((String)localObject2, new File((String)localObject1));
          ((bbwu)localObject2).f = "apollo_res";
          ((bbwu)localObject2).jdField_b_of_type_Int = 1;
          ((bbwu)localObject2).n = true;
          ((bbwu)localObject2).q = true;
          ((bbwu)localObject2).r = true;
          paramInt = bbww.a((bbwu)localObject2, a());
          if (paramInt != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        bbdx.a((String)localObject1, ApolloUtil.a(paramApolloActionData, 6), false);
      ...
      catch (Exception localException)
      {
        ...
        paramajot.b(paramApolloActionData);
      }
    }
    return true;
  }
  ...
  public boolean a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    do
    {
      ...
      paramApolloActionPackage = new bbwu(ApolloUtil.b(paramApolloActionPackage), new File(ApolloUtil.a(paramApolloActionPackage)));
      ...
      i1 = bbww.a(paramApolloActionPackage, a());
    } while (i1 != 0);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, "ret:" + i1);
    }
  ...
  public ApolloBaseInfo b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((0 == 0) && (!this.v))
      {
        ??? = (ApolloBaseInfo)this.jdField_a_of_type_Aukp.a(ApolloBaseInfo.class, paramString);
        if (bool) {
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bbkb.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label139;
      }
  ...
  void b(int paramInt1, int paramInt2)
  {
    if ((!ApolloUtil.a(paramInt1, paramInt2)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      ajhu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, str);
    }
  }
  
  public void b(ajot paramajot)
  {
    if ((paramajot != null) && (this.jdField_a_of_type_Ajok != null)) {
      this.jdField_a_of_type_Ajok.b(paramajot);
    }
  }
    ...
    if (paramApolloActionData != null)
    {
      ...
      if (((File)localObject).exists()) {
        try
        {
          ...
          {
            boolean bool = apvd.c(ApolloUtil.a(paramApolloActionData, 6));
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localDrawerPushItem.msg_id != null) && (localDrawerPushItem.msg_id.equals(paramString)))
        {
          ...
          this.jdField_a_of_type_Aukp.b(localDrawerPushItem);
          if (QLog.isColorLevel()) {
  ...
  public boolean b()
  {
    ...
    try
    {
      localObject1 = bbdx.b(new File(ApolloUtil.jdField_a_of_type_JavaLangString));
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          localObject3 = (ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
          ((ajmu)localObject3).a(false, localArrayList4);
          ((ajmu)localObject3).b();
          ((ajmu)localObject3).a(localArrayList1);
          ((ajmu)localObject3).b(1);
          ((ajmu)localObject3).c(localArrayList2);
          ((ajmu)localObject3).d();
          ((ajmu)localObject3).d(localArrayList3);
          ...
          this.jdField_a_of_type_Ajok.a(Boolean.valueOf(true));
          m();
        }
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          ...
          if (!((SharedPreferences)localObject3).getBoolean("8.3.0" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false)) {
            ((SharedPreferences)localObject3).edit().putBoolean("8.3.0" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true).commit();
          }
          if (localObject1 != null)
          {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((airx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).l();
        }
      }
      catch (Exception localException)
      {
  ...
  public boolean b(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    return apvd.a(ApolloUtil.a(paramApolloActionPackage));
  }
  
  public boolean b(String paramString)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
      return bgzx.a().a();
    }
    return false;
  }
  ...
  public void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bbkb.r(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label137;
      }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt1 & 0x1) != (paramInt2 & 0x1)) || ((paramInt1 & 0x2) != (paramInt2 & 0x2)))
    {
      ...
      if (this.jdField_c_of_type_JavaUtilList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          aisi localaisi = (aisi)((WeakReference)localIterator.next()).get();
          if (localaisi != null) {
            localaisi.a(paramInt1, bool);
          }
        }
      }
    }
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (ajmr.a("8.3.0", str1, (String)localObject2))
      {
  ...
  public void h()
  {
    ...
    {
      return;
      localakvi = (akvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(115);
    } while ((localakvi == null) || (!localakvi.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()));
    QLog.w("ApolloManager", 1, "config is done, then request update");
    ArrayList localArrayList = new ArrayList();
    localakvi.b(localArrayList);
    localakvi.a(localArrayList);
    localakvi.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
  }
  
  public boolean h()
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_new_user_bar_showed" + ajac.a().getCurrentAccountUin(), false)) || (this.i)) {
      bool = true;
    }
    return bool;
  }
  ...
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_780_guide_showed" + ajac.a().getCurrentAccountUin(), false)) || (this.m)) {
      bool = true;
    }
    return bool;
  }
  ...
  public boolean k()
  {
    return this.jdField_a_of_type_Aiyp != null;
  }
  ...
  public void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      ApolloActionData localApolloActionData = ((ajmu)localObject).a(1450);
      if (localApolloActionData != null) {
        b(localApolloActionData.actionId, localApolloActionData.personNum);
      }
      localObject = ((ajmu)localObject).a(1454);
      if (localObject != null) {
  ...
  public void m()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      Object localObject2 = (ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      localObject1 = ((ajmu)localObject2).d(400);
      if (((ajmu)localObject2).c(3000059) == null) {
        break label99;
      }
      if (localObject1 != null) {
        break label96;
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Aish != null) {}
    try
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Aish);
      this.jdField_a_of_type_Aish = null;
      if (QLog.isColorLevel()) {
      ...
      jdField_d_of_type_Int = -1;
      this.jdField_a_of_type_Aukp.a();
      ajhu.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Aisp != null)
        {
          this.jdField_a_of_type_Aisp.c();
          this.jdField_a_of_type_Aisp = null;
        }
        ApolloGameStateMachine.d();
        ApolloGameUtil.a();
        this.jdField_a_of_type_Airv.b();
        aiye.a();
        ajmo.a();
        if (this.jdField_a_of_type_Aizi != null) {
          this.jdField_a_of_type_Aizi.b();
        }
        if (this.jdField_a_of_type_Aiyv != null)
        {
          this.jdField_a_of_type_Aiyv.e();
          this.jdField_a_of_type_Aiyv = null;
        }
        if (this.jdField_a_of_type_Aiyp != null)
        {
          this.jdField_a_of_type_Aiyp.c();
          this.jdField_a_of_type_Aiyp = null;
        }
        j();
        aizu.a().a();
        ajcl localajcl = aizu.a().a();
        if (localajcl != null) {
          localajcl.a();
        }
        ajls.a().a();
