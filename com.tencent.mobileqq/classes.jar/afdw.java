...
public class afdw
  implements bacc
{
  public afdw(ProfileLabelEditorActivity paramProfileLabelEditorActivity) {}
  ...
  public void a(ProfileLabelInfo paramProfileLabelInfo, ToggleButton paramToggleButton, Boolean paramBoolean)
  {
    if (paramBoolean.booleanValue())
    {
      ...
      bdll.b(this.a.app, "CliOper", "", "", "card_mall", "0X80066C7", 0, 0, "1", "", "", "");
      this.a.jdField_a_of_type_JavaUtilList.add(paramProfileLabelInfo);
    }
    for (;;)
    {
      this.a.jdField_a_of_type_Bacd.c(paramProfileLabelInfo, paramToggleButton);
      this.a.a(this.a.jdField_a_of_type_JavaUtilList.size());
      if (this.a.jdField_a_of_type_Afea == null) {
        break;
      }
      this.a.jdField_a_of_type_Afea.notifyDataSetChanged();
      return;
