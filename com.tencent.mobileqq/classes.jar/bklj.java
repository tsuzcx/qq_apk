...
public class bklj
{
  ...
  public bklj(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bklk(this, Looper.getMainLooper());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bkll(this);
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    return bbdr.a(paramBitmap, i, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  }
  ...
  public Drawable a(String paramString, int paramInt1, int paramInt2)
  {
    if (TextUtils.isEmpty(paramString))
    {
      veg.e("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable uin is null!");
      return null;
    }
    ...
    {
      localwbt = (wbt)this.jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
      if (localwbt != null)
      {
        veg.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, hit cache:" + paramString);
        return localwbt;
      }
    }
    veg.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, not in cache:" + paramString);
    wbt localwbt = new wbt(paramInt1, paramInt2);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache.put(paramString, localwbt);
  ...
  public void a()
  {
    veg.c("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory");
    try
    {
    ...
    {
      veg.e("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory:" + localException.toString());
    }
  }
  
  public void a(bklm parambklm)
  {
    this.jdField_a_of_type_Bklm = parambklm;
  }
  
  protected void a(String paramString)
  {
    veg.b("Q.qqstory.record.StoryFaceDrawableFactory", "sendQQHeadRequest uin:%s.", paramString);
