...
{
  private static WeakReference<atuo> jdField_a_of_type_JavaLangRefWeakReference;
  private int jdField_a_of_type_Int;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  private MediaPlayer jdField_a_of_type_AndroidMediaMediaPlayer;
  SurfaceHolder jdField_a_of_type_AndroidViewSurfaceHolder = null;
  atuy jdField_a_of_type_Atuy;
  ...
  public static atuo a()
  {
    atuo localatuo1 = null;
    if (jdField_a_of_type_JavaLangRefWeakReference != null) {
      localatuo1 = (atuo)jdField_a_of_type_JavaLangRefWeakReference.get();
    }
    atuo localatuo2 = localatuo1;
    if (localatuo1 == null)
    {
      localatuo2 = new atuo();
      jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localatuo2);
    }
    return localatuo2;
  }
      ...
      do
      {
        do
        {
          ...
          try
          {
            ...
            throw new NullPointerException(anvx.a(2131704075));
          }
  ...
  public String a()
  {
    return auea.a(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a(String paramString, atur paramatur)
  {
    ThreadManager.executeOnSubThread(new FileViewMusicService.1(this, paramString, paramatur));
  }
  ...
  public boolean a(String paramString)
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   6: ifnull +22 -> 28
    //   9: aload_0
    //   10: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   13: invokevirtual 219	android/media/MediaPlayer:stop	()V
    //   16: aload_0
    //   17: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   20: invokevirtual 222	android/media/MediaPlayer:release	()V
    //   23: aload_0
    //   24: aconst_null
    //   25: putfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   28: aload_0
    //   29: new 130	android/media/MediaPlayer
    //   32: dup
    //   33: invokespecial 223	android/media/MediaPlayer:<init>	()V
    //   36: putfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   39: aload_0
    //   40: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   43: aload_0
    //   44: invokevirtual 227	android/media/MediaPlayer:setOnCompletionListener	(Landroid/media/MediaPlayer$OnCompletionListener;)V
    //   47: aload_0
    //   48: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   51: aload_0
    //   52: invokevirtual 231	android/media/MediaPlayer:setOnErrorListener	(Landroid/media/MediaPlayer$OnErrorListener;)V
    //   55: aload_0
    //   56: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   59: aload_0
    //   60: invokevirtual 235	android/media/MediaPlayer:setOnPreparedListener	(Landroid/media/MediaPlayer$OnPreparedListener;)V
    //   63: aload_0
    //   64: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   67: iconst_0
    //   68: invokevirtual 239	android/media/MediaPlayer:setLooping	(Z)V
    //   71: aload_0
    //   72: aconst_null
    //   73: putfield 54	atuo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   76: new 241	java/io/FileInputStream
    //   79: dup
    //   80: new 243	java/io/File
    //   83: dup
    //   84: aload_1
    //   85: invokespecial 244	java/io/File:<init>	(Ljava/lang/String;)V
    //   88: invokespecial 247	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   91: astore 4
    //   93: aload 4
    //   95: astore_3
    //   96: aload_0
    //   97: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   100: iconst_3
    //   101: invokevirtual 250	android/media/MediaPlayer:setAudioStreamType	(I)V
    //   104: aload 4
    //   106: astore_3
    //   107: aload_0
    //   108: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   111: aload 4
    //   113: invokevirtual 254	java/io/FileInputStream:getFD	()Ljava/io/FileDescriptor;
    //   116: invokevirtual 258	android/media/MediaPlayer:setDataSource	(Ljava/io/FileDescriptor;)V
    //   119: aload 4
    //   121: astore_3
    //   122: aload_0
    //   123: iconst_0
    //   124: putfield 52	atuo:c	Z
    //   127: aload 4
    //   129: astore_3
    //   130: aload_0
    //   131: iconst_0
    //   132: putfield 50	atuo:b	Z
    //   135: aload 4
    //   137: astore_3
    //   138: aload_0
    //   139: iconst_0
    //   140: putfield 187	atuo:jdField_a_of_type_Int	I
    //   143: aload 4
    //   145: astore_3
    //   146: aload_0
    //   147: iconst_0
    //   148: putfield 189	atuo:d	Z
    //   151: aload 4
    //   153: astore_3
    //   154: aload_0
    //   155: getfield 176	atuo:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   168: dup
    //   169: aload_0
    //   170: invokespecial 263	atuq:<init>	(Latuo;)V
    //   173: putfield 176	atuo:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   176: aload 4
    //   178: astore_3
    //   179: new 265	android/content/IntentFilter
    //   182: dup
    //   183: invokespecial 266	android/content/IntentFilter:<init>	()V
    //   186: astore 5
    //   188: aload 4
    //   190: astore_3
    //   191: aload 5
    //   193: ldc_w 268
    //   196: invokevirtual 271	android/content/IntentFilter:addAction	(Ljava/lang/String;)V
    //   199: aload 4
    //   201: astore_3
    //   202: invokestatic 108	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   205: aload_0
    //   206: getfield 176	atuo:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   209: aload 5
    //   211: invokevirtual 275	com/tencent/qphone/base/util/BaseApplication:registerReceiver	(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    //   214: pop
    //   215: aload 4
    //   217: astore_3
    //   218: aload_0
    //   219: getfield 126	atuo:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   222: invokevirtual 278	android/media/MediaPlayer:prepareAsync	()V
    //   225: aload 4
    //   227: ifnull +8 -> 235
    //   230: aload 4
    //   232: invokevirtual 281	java/io/FileInputStream:close	()V
    //   235: aload_0
    //   236: aload_1
    //   237: putfield 54	atuo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   240: iconst_1
    //   241: istore_2
    //   242: iload_2
    //   243: ireturn
    //   244: astore_3
    //   245: aload_3
    //   246: invokevirtual 284	java/io/IOException:printStackTrace	()V
    //   249: goto -14 -> 235
    //   252: astore_1
    //   253: aconst_null
    //   254: astore 4
    ...
    //   258: astore_3
    //   259: aload_0
    //   260: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   263: ifnull +16 -> 279
    //   266: aload 4
    //   268: astore_3
    //   269: aload_0
    //   270: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   273: aconst_null
    //   274: invokeinterface 288 2 0
    //   279: aload 4
    //   281: astore_3
    //   282: invokestatic 80	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   285: ifeq +35 -> 320
    //   288: aload 4
    //   290: astore_3
    //   291: ldc 82
    ...
    //   307: aload_1
    //   308: invokevirtual 291	java/lang/IllegalArgumentException:toString	()Ljava/lang/String;
    ...
    //   322: ifnull -80 -> 242
    //   325: aload 4
    //   327: invokevirtual 281	java/io/FileInputStream:close	()V
    //   330: iconst_0
    //   331: ireturn
    //   332: astore_1
    //   333: aload_1
    //   334: invokevirtual 284	java/io/IOException:printStackTrace	()V
    //   337: iconst_0
    //   338: ireturn
    //   339: astore_1
    //   340: aconst_null
    ...
    //   345: astore_3
    //   346: aload_0
    //   347: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   350: ifnull +16 -> 366
    //   353: aload 4
    //   355: astore_3
    //   356: aload_0
    //   357: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   360: aconst_null
    //   361: invokeinterface 288 2 0
    //   366: aload 4
    //   368: astore_3
    //   369: invokestatic 80	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   372: ifeq +35 -> 407
    //   375: aload 4
    //   377: astore_3
    //   378: ldc 82
    ...
    //   394: aload_1
    //   395: invokevirtual 294	java/lang/SecurityException:toString	()Ljava/lang/String;
    ...
    //   409: ifnull -167 -> 242
    //   412: aload 4
    //   414: invokevirtual 281	java/io/FileInputStream:close	()V
    //   417: iconst_0
    //   418: ireturn
    //   419: astore_1
    //   420: aload_1
    //   421: invokevirtual 284	java/io/IOException:printStackTrace	()V
    //   424: iconst_0
    //   425: ireturn
    //   426: astore_1
    //   427: aconst_null
    ...
    //   432: astore_3
    //   433: aload_0
    //   434: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   437: ifnull +16 -> 453
    //   440: aload 4
    //   442: astore_3
    //   443: aload_0
    //   444: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   447: aconst_null
    //   448: invokeinterface 288 2 0
    //   453: aload 4
    //   455: astore_3
    ...
    //   481: aload_1
    //   482: invokevirtual 297	java/lang/IllegalStateException:toString	()Ljava/lang/String;
    ...
    //   496: astore_3
    //   497: aload_1
    //   498: invokevirtual 298	java/lang/IllegalStateException:printStackTrace	()V
    //   501: aload 4
    //   503: ifnull -261 -> 242
    //   506: aload 4
    //   508: invokevirtual 281	java/io/FileInputStream:close	()V
    //   511: iconst_0
    //   512: ireturn
    //   513: astore_1
    //   514: aload_1
    //   515: invokevirtual 284	java/io/IOException:printStackTrace	()V
    //   518: iconst_0
    //   519: ireturn
    //   520: astore_1
    //   521: aconst_null
    ...
    //   526: astore_3
    //   527: aload_0
    //   528: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   531: ifnull +21 -> 552
    //   534: aload 4
    //   536: astore_3
    //   537: aload_0
    //   538: getfield 195	atuo:jdField_a_of_type_Atuy	Latuy;
    //   541: ldc_w 299
    //   544: invokestatic 74	anvx:a	(I)Ljava/lang/String;
    //   547: invokeinterface 288 2 0
    //   552: aload 4
    //   554: astore_3
    //   555: invokestatic 80	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   558: ifeq +35 -> 593
    //   561: aload 4
    //   563: astore_3
    //   564: ldc 82
    ...
    //   580: aload_1
    //   581: invokevirtual 302	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   595: ifnull -353 -> 242
    //   598: aload 4
    //   600: invokevirtual 281	java/io/FileInputStream:close	()V
    //   603: iconst_0
    //   604: ireturn
    //   605: astore_1
    //   606: aload_1
    //   607: invokevirtual 284	java/io/IOException:printStackTrace	()V
    //   610: iconst_0
    //   611: ireturn
    //   612: astore_1
    //   613: aconst_null
    ...
    //   616: ifnull +7 -> 623
    //   619: aload_3
    //   620: invokevirtual 281	java/io/FileInputStream:close	()V
    //   623: aload_1
    //   624: athrow
    //   625: astore_3
    //   626: aload_3
    //   627: invokevirtual 284	java/io/IOException:printStackTrace	()V
    //   630: goto -7 -> 623
    //   633: astore_1
    //   634: goto -19 -> 615
    //   637: astore_1
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Atuy != null) {
      this.jdField_a_of_type_Atuy.as_();
    }
    if (this.jdField_a_of_type_AndroidContentBroadcastReceiver != null)
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Atuy != null) {
      this.jdField_a_of_type_Atuy.a(anvx.a(2131704073));
    }
    this.jdField_a_of_type_AndroidMediaMediaPlayer.release();
    this.jdField_a_of_type_AndroidMediaMediaPlayer = null;
    this.jdField_a_of_type_JavaLangString = null;
