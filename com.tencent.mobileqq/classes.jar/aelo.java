  ...
  extends aekr
{
  ...
  public aelo(QQAppInterface paramQQAppInterface, aelj paramaelj, QQWalletTransferMsgElem paramQQWalletTransferMsgElem, int paramInt, acvf paramacvf)
  {
    super(paramQQAppInterface, paramaelj, paramQQWalletTransferMsgElem, paramInt, paramacvf);
    this.jdField_a_of_type_Ahdl = null;
    this.h = 0;
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Ahdl = ((RedPacketManager)RedPacketManager.getInstance()).getThemeRedPkgConfById(this.m);
      if ((this.jdField_a_of_type_Ahdl != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Ahdl.c)))
      {
        str = this.jdField_a_of_type_Ahdl.c;
  ...
  public boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Ahdl != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Ahdl.e)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Ahdl.d)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Ahdl.f))) {}
    try
    {
      int i = Color.parseColor(this.jdField_a_of_type_Ahdl.e);
      this.jdField_a_of_type_Aelj.b.setTextColor(i);
      label91:
      this.jdField_a_of_type_Aelj.b.setText(this.jdField_a_of_type_Ahdl.d);
      this.jdField_a_of_type_Aelj.b.setTag(this.jdField_a_of_type_Ahdl.f);
      for (;;)
      {
        return true;
        this.jdField_a_of_type_Aelj.b.setText("QQ主题红包");
      }
    }
  ...
  public void f()
  {
    if (this.l > 0)
    {
      this.jdField_a_of_type_Aelj.a.setVisibility(8);
      return;
    }
    super.f();
  }
