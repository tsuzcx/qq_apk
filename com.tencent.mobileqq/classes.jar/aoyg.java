  ...
  implements aoft
{
  ...
  public aoyg(QQAppInterface paramQQAppInterface, aoyf paramaoyf)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (paramHashMap.containsKey(str))
        {
          ...
          {
            bhbx.a("Q.fts.troop.operator", new Object[] { "checkTroopTimeStamp troop ignore troopuin:" + str + " wMemberNum:" + localTroopInfo.wMemberNum + " mMemberNumSeq:" + localTroopInfo.mMemberNumSeq });
          ...
          else
          {
            ...
            try
            {
              ...
              bhbx.a("Q.fts.troop.operator", new Object[] { "checkTroopTimeStamp add troop:" + localTroopInfo.troopname + " mMemberNumSeq:" + localTroopInfo.mMemberNumSeq + " troopTime:" + localFTSTroopTime.toString() });
              paramHashMap.remove(str);
            }
        ...
        else
        {
          try
          {
            ...
            bhbx.a("Q.fts.troop.operator", new Object[] { "checkTroopTimeStamp delete troop=" + str });
          }
    ...
    if (paramList != null)
    {
      ...
      if (bcrg.a != null)
      {
        ...
        if (bcrg.a.a != null)
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache();
            paramList1 = bcrg.a.a.entrySet().iterator();
            if (paramList1.hasNext())
            {
              ...
              while (i < ((ArrayList)((Map.Entry)localObject).getValue()).size()) {
                try
                {
                  ...
                  bhbx.a("Q.fts.troop.operator", new Object[] { "checkTroopMemberCache modify troop=" + str1 + " member=" + str2 });
                  i += 1;
                }
                catch (Exception localException2)
                {
      ...
      int i = auzr.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, "TroopIndex");
      bhbx.a("Q.fts.troop.operator", new Object[] { "FTSDatabaseHelper.queryItemCount = " + i });
      if (i > 0)
      {
  ...
  public int a()
  {
    ...
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager().query(FTSTroopSync.class, FTSTroopSync.class.getSimpleName(), false, "_id>?", new String[] { String.valueOf(this.jdField_a_of_type_Int) }, null, null, null, null);
    if (localList != null) {
      i = localList.size();
    }
    return i;
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> a(String paramString)
  {
    ...
    auzt localauzt = new auzt().a(TroopIndex.class).a(new auzu[] { new auzu("TroopIndex", paramString, true) }).a(true);
    if (((bcnc.a(paramString)) || (bcnc.b(paramString))) && (!bcnc.c(paramString))) {
      localauzt.a(200);
    }
    return this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.a(localauzt.a());
  }
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Aoyi = new aoyh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
    this.jdField_e_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
      QLog.d("Q.fts.troop.operator", 2, "init success");
    }
    this.jdField_e_of_type_Int = auzr.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, "TroopIndex");
    return true;
  }
  ...
  public boolean a(ArrayList<FTSOptSync> paramArrayList)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 28	aoyg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: invokevirtual 474	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   7: invokevirtual 480	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   10: astore 5
    //   12: aconst_null
    //   13: astore_3
    //   14: aconst_null
    //   15: astore_2
    //   16: aload 5
    //   18: invokevirtual 619	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   21: astore 4
    //   23: aload 4
    //   25: astore_2
    //   26: aload 4
    //   28: astore_3
    //   29: aload 4
    //   31: invokevirtual 624	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   34: aload 4
    //   36: astore_2
    //   37: aload 4
    //   39: astore_3
    //   40: aload_1
    //   41: invokevirtual 63	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   44: astore_1
    //   45: aload 4
    //   47: astore_2
    //   48: aload 4
    ...
    //   74: checkcast 626	com/tencent/mobileqq/persistence/fts/FTSOptSync
    //   77: invokevirtual 334	com/tencent/mobileqq/persistence/EntityManager:persistOrReplace	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   80: goto -35 -> 45
    //   83: astore_1
    //   84: aload_2
    //   85: astore_3
    //   86: invokestatic 148	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   89: ifeq +35 -> 124
    //   92: aload_2
    //   93: astore_3
    //   94: ldc_w 285
    //   97: iconst_2
    //   98: new 95	java/lang/StringBuilder
    //   101: dup
    //   102: invokespecial 97	java/lang/StringBuilder:<init>	()V
    //   105: ldc_w 628
    //   108: invokevirtual 103	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   111: aload_1
    //   112: invokevirtual 631	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   115: invokevirtual 103	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   118: invokevirtual 112	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   121: invokestatic 634	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   124: aload_2
    //   125: ifnull +7 -> 132
    //   128: aload_2
    //   129: invokevirtual 637	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   132: iconst_0
    //   133: ireturn
    //   134: aload 4
    //   136: astore_2
    ...
    //   139: astore_3
    //   140: aload 4
    //   142: invokevirtual 639	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   145: aload 4
    //   147: ifnull +8 -> 155
    //   150: aload 4
    //   152: invokevirtual 637	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   155: iconst_1
    //   156: ireturn
    //   157: astore_1
    //   158: aload_3
    //   159: ifnull +7 -> 166
    //   162: aload_3
    //   163: invokevirtual 637	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   166: aload_1
    //   167: athrow
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> b(String paramString)
  {
    ...
    paramString = new auzt().a(TroopIndex.class).a(new auzu[] { new auzu("ext1", paramString, true) }).a(true);
  ...
  protected void b(ArrayList<FTSOptSync> paramArrayList)
  {
    ...
    this.jdField_a_of_type_Aoyf.post(new FTSTroopOperator.2(this, paramArrayList));
  }
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      do
      {
        for (;;)
        {
          try
          {
            bool1 = auzr.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, c());
            bool2 = bool1;
            bool2 = bool1;
          }
          catch (Throwable localThrowable1)
          {
            try
            {
              ...
              bool1 = auzr.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, c());
              if (QLog.isColorLevel()) {
        ...
        i = auzr.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, c());
        if (QLog.isColorLevel()) {
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase != null) && (this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.d()))
    {
      ...
      {
        bhbx.a("Q.fts.troop.operator", new Object[] { i });
        if (localObject1 == null) {
          break label628;
        }
        ...
        for (;;)
        {
          ...
          bhbx.a("Q.fts.troop.operator", new Object[] { "transToDatabase, ignore troopSync , it's a QidianPrivateTroop, troopSync = " + localFTSTroopSync.toString() });
        }
      }
      ...
      localObject2 = this.jdField_a_of_type_Anvk.b(String.valueOf(localFTSTroopSync.mMemberUin));
    ...
    for (;;)
    {
      ...
      {
        label389:
        bhbx.a("Q.fts.troop.operator", new Object[] { "transToDatabase start troopUin:" + localFTSTroopSync.mTroopUin + " entityList size:" + localArrayList.size() + " opt:" + localFTSTroopSync.mOpt });
        n = auzr.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, localArrayList, c(), 1);
        if (n != -1) {
        ...
        bhbx.a("Q.fts.troop.operator", new Object[] { "transToDatabase end troopUin=%s totalTime=%s curSegmentTotal:%s", String.valueOf(localFTSTroopSync.mTroopUin), String.valueOf(l3 - l2), String.valueOf(n) });
        ...
        break label350;
        label652:
        bhbx.a("Q.fts.troop.operator", new Object[] { "transToDatabase modify member can't find memberuin:" + localFTSTroopSync.mMemberUin + " troopuin:" + localFTSTroopSync.mTroopUin });
        break label385;
        label706:
        ...
        else
        {
          ...
          try
          {
            ...
            i1 = i;
            n = j;
            bhbx.a("Q.fts.troop.operator", new Object[] { "transToDatabase memberList is null" });
          }
    ...
    if (((Iterator)localObject3).hasNext())
    {
      ...
      i1 = i;
      n = j;
      localObject2 = this.jdField_a_of_type_Anvk.b(String.valueOf(localTroopMemberInfo.memberuin));
      if (localObject2 == null) {
        break label1161;
      }
      i1 = i;
  ...
  public void g()
  {
    this.jdField_a_of_type_Aoyf.post(new FTSTroopOperator.1(this));
  }
}
