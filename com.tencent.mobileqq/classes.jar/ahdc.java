...
public class ahdc
  extends ahdg
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahdd(this);
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie;
  private FaceDecoder jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder;
  
  public ahdc(QQAppInterface paramQQAppInterface, ahcz paramahcz, QQWalletBaseMsgElem paramQQWalletBaseMsgElem, int paramInt, afaf paramafaf)
  {
  ...
  public boolean b()
  {
    ...
    this.jdField_a_of_type_Ahcz.b.setText(ahck.d);
    return false;
  }
  ...
  public void c()
  {
    ...
    {
      return;
      if (this.jdField_a_of_type_Ahcz.g.getVisibility() != 0) {
        this.jdField_a_of_type_Ahcz.g.setVisibility(0);
      }
      LinearLayout localLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
      localLinearLayout.setOrientation(0);
      this.jdField_a_of_type_Ahcz.g.addView(localLinearLayout);
      ...
      while ((j < 5) && (j < this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.specifyUinList.size()))
      {
        ...
        ((ImageView)localObject).setBackgroundResource(2130847277);
  ...
  {
    super.h();
    if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg == null) || (this.jdField_a_of_type_ComTencentMobileqqDataQQWalletRedPacketMsg == null) || (this.jdField_a_of_type_Ahcz == null) || (this.jdField_a_of_type_Ahcz.f == null)) {}
    while ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.isSender()) || (akfd.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg))) {
      return;
    }
    View localView = new View(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Ahcz.f.setVisibility(0);
    this.jdField_a_of_type_Ahcz.f.addView(localView);
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        localView.setBackgroundResource(2130847280);
      ...
      for (;;)
      {
        ...
        akgd.a(localView, 0.6F);
        return;
        localView.setBackgroundResource(2130847279);
