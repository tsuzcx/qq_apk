...
public class aioa
{
  ...
  public void a(VoiceTextPanel paramVoiceTextPanel)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramVoiceTextPanel.findViewById(2131368115));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramVoiceTextPanel.findViewById(2131370784));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnTouchListener(new aiob(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextEditScrollerView = ((VoiceTextEditScrollerView)paramVoiceTextPanel.findViewById(2131365157));
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextEditScrollerView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextPanel.getContext().getResources().getDrawable(2130839538));
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextEditScrollerView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextPanel.getContext().getResources().getDrawable(2130850034));
  }
