  ...
  extends aksv
{
  ...
  public aktc(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public List<MpfileTaskRecord> a()
  {
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      ...
      localaukn.b("create index if not exists " + (String)localObject + "_index ON " + (String)localObject + "(fileId, msgId)");
      List localList = localaukn.a(MpfileTaskRecord.class, a(-1L, 15), null);
  ...
  public void a(aukm paramaukm, akte paramakte)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      paramaukm = ((MpfileTaskRecord)paramaukm).clone();
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, MpfileTaskRecord.tableName(), paramaukm, 0, paramakte);
      return;
    }
    new Handler(localLooper).post(new MpfileTaskProxy.1(this, paramaukm, paramakte, localgn));
    localgn.a(-1L);
  }
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, akte paramakte)
  {
    ...
    new Handler(localLooper).post(new MpfileTaskProxy.2(this, paramString1, paramContentValues, paramString2, paramArrayOfString, paramakte));
  }
  ...
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, akte paramakte)
  {
    ...
    new Handler(localLooper).post(new MpfileTaskProxy.3(this, paramString1, paramString2, paramArrayOfString, paramakte));
  }
