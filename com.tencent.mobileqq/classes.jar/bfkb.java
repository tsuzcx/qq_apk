...
public class bfkb
  extends acmh
{
  public Comparator b = new bfkc(this);
  
  public bfkb(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private long a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1, ArrayList<MessageRecord> paramArrayList2, String paramString1, String paramString2)
  {
    ...
    long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(paramString1);
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        try
        {
          paramArrayList = a(paramArrayList, (ArrayList)localObject, localbcsd, true, localbffl);
          if (paramArrayList != null) {
          ...
          if (QLog.isColorLevel())
          {
            ...
            QLog.d("Q.msg.TroopMessageProcessor", 2, "<---groupMsgRecordHandle_PB decodeSinglePbMsg_GroupDis: troopUin: " + paramString1 + ", costTime = [" + (l4 - l3) + "]");
          }
    ...
    ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).a(paramString2);
    if (QLog.isColorLevel())
    {
      l3 = System.currentTimeMillis();
      QLog.d("Q.msg.TroopMessageProcessor", 2, "<---groupMsgRecordHandle_PB  saveTroopMemberNickAndLevelAndExtraInfo: troopUin: " + paramString1 + ", costTime=[" + (l3 - l2) + "]");
      l2 = l3;
    }
    for (;;)
    {
      ...
      {
        l3 = System.currentTimeMillis();
        QLog.d("Q.msg.TroopMessageProcessor", 2, "<---groupMsgRecordHandle_PB  msgListFilter: troopUin: " + paramString1 + ", costTime=[" + (l3 - l2) + "]");
      }
      return l1;
    }
  }
  ...
  private void a(long paramLong1, long paramLong2, String paramString, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if ((i != 2) || (paramMessageRecord == null)) {
        ((aoep)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).c(Long.parseLong(paramString));
      }
      return;
      label147:
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetGroupMsgResp paramPbGetGroupMsgResp, String paramString)
  {
    ...
    long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b((String)localObject1);
    if (paramArrayList != null) {
      l1 = a(paramArrayList, (ArrayList)localObject2, (ArrayList)localObject3, (String)localObject1, paramString);
    }
    for (;;)
    {
      ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).e((String)localObject1);
      boolean bool1 = false;
      long l2;
      if ((paramPbGetGroupMsgResp.result.get() == 104) && (((ArrayList)localObject2).size() == 0))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b((String)localObject1, l2);
      }
      for (int j = 1;; j = 0)
      {
        ...
        if (((ArrayList)localObject2).size() > 0)
        {
          ...
          if (i >= 0)
          {
            ...
            if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((nty.a((MessageRecord)localObject3)) && (nty.b((MessageRecord)localObject3))))
            {
              if (nty.a((MessageRecord)localObject3))
              {
                ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                localObject4 = nty.a((MessageRecord)localObject3);
                nty.a().a(((MessageRecord)localObject3).frienduin, ((MessageRecord)localObject3).vipBubbleID, ((ntz)localObject4).jdField_b_of_type_Int, ((ntz)localObject4).jdField_b_of_type_JavaLangString, ((ntz)localObject4).jdField_c_of_type_Int, ((ntz)localObject4).a, ((ntz)localObject4).jdField_c_of_type_JavaLangString);
              }
              Object localObject4 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getSendingTroopMsgItem(((MessageRecord)localObject3).frienduin, 1, (MessageRecord)localObject3);
              ...
              if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().d()) {
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(((MessageRecord)localObject4).frienduin, ((MessageRecord)localObject4).istroop, ((MessageRecord)localObject4).uniseq);
              }
              ...
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a((String)localObject1, ((MessageRecord)localObject3).shmsgseq);
            }
            for (;;)
            {
              i -= 1;
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (paramPbGetGroupMsgResp != null) && (paramPbGetGroupMsgResp.size() > 0))
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache();
              bcrg.a.a = new ConcurrentHashMap();
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache();
            bcrg.a.a.put(localObject1, paramPbGetGroupMsgResp);
          }
          if (paramToServiceMsg.size() > 0)
          {
            paramPbGetGroupMsgResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b((String)localObject1);
            if (paramPbGetGroupMsgResp == null) {
              break label1342;
            }
            paramArrayList = (acmd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(1);
            ...
            while (i < k)
            {
              ...
              if ((paramPbGetGroupMsgResp instanceof MessageForMarketFace)) {
                awyq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramPbGetGroupMsgResp);
              }
            ...
            paramPbGetGroupMsgResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade();
            if ((bool2) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop))
            {
              bool1 = true;
              paramPbGetGroupMsgResp.addMessage(paramToServiceMsg, paramString, bool1, false);
        ...
        for (;;)
        {
          if ((j != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a((String)localObject1) == 1))
          {
            paramArrayList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b((String)localObject1);
            if (paramArrayList != null)
            {
              l2 = ((Long)paramArrayList[0]).longValue();
              ((acmd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(1)).b((String)localObject1, 1, l2);
            }
          }
          if (l1 >= 0L)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a((String)localObject1, l1);
          }
          bool2 = anyv.b(paramToServiceMsg);
          ...
          ((bhou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a(paramToServiceMsg);
          if (paramToServiceMsg.size() > 0) {
            aooe.a((MessageRecord)paramToServiceMsg.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          return;
          bool1 = false;
          break;
  ...
  private void a(ToServiceMsg paramToServiceMsg, msg_svc.PbGetGroupMsgResp paramPbGetGroupMsgResp, ArrayList<msg_comm.Msg> paramArrayList, String paramString)
  {
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.TroopMessageProcessor", 2, "<---refreshTroopHead_PB : fromUin:" + l4 + ",toUin:" + l3 + ",msgTime:" + l5 + ",msgSeq:" + l1 + ",msgUid:" + l2 + ",userActive:" + i + ",fromInstid:" + j + ",groupCode:" + l6 + ",groupType:" + k + ",groupSeq:" + l7 + ",Hascard:" + ((msg_comm.GroupInfo)localObject2).group_card.has() + ",cardName:" + bhbx.a((String)localObject3) + ",hasAppShare:" + paramArrayList.appshare_info.has() + ",hasMsgBody:" + paramArrayList.msg_body.has());
          }
          localObject2 = new ArrayList();
          localObject3 = new bcsd();
          ((bcsd)localObject3).jdField_e_of_type_Long = paramPbGetGroupMsgResp.group_code.get();
          ((bcsd)localObject3).jdField_e_of_type_Int = 1;
          ((bcsd)localObject3).f = k;
          if (paramArrayList.content_head.has())
          {
            msg_comm.ContentHead localContentHead = (msg_comm.ContentHead)paramArrayList.content_head.get();
            i = localContentHead.div_seq.get();
          ...
          try
          {
            paramArrayList = a(paramArrayList, (ArrayList)localObject2, (bcsd)localObject3, true, localbffl);
            if (paramArrayList != null)
            {
      ...
      ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).a((List)localObject1);
    }
    ...
    ((awzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOPINFO_MANAGER)).a(paramArrayList, localbffl);
    ...
    if (paramToServiceMsg != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().handleRefreshMessagelistHeadResult(String.valueOf(paramPbGetGroupMsgResp.group_code.get()), 1, paramString, paramArrayList, paramToServiceMsg);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(paramArrayList);
    ((bhou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a(paramString);
  }
  ...
  private void a(String paramString, MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageProxy(1);
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMessageRecord(paramMessageRecord1.frienduin, 1, paramMessageRecord1.shmsgseq, -5020);
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().deleteSingleMsgFromPoolByUniseq(paramMessageRecord1.frienduin, 1, ((MessageRecord)localObject1).uniseq);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().insertSingleMsgToPool(paramMessageRecord1.frienduin, 1, (MessageRecord)localObject1);
        QLog.i("Q.msg.TroopMessageProcessor" + beay.i, 1, "updateGroupMsgSeqAndTime. docs gray msg. shmsgseq = " + paramMessageRecord1.shmsgseq + ", grayMsgType = " + -5020 + ", grayUniSeq = " + ((MessageRecord)localObject1).uniseq);
      }
    }
    label356:
    label375:
    while (paramMessageRecord1.msgtype != -2000)
    {
      ...
      localObject1 = acnh.a(paramMessageRecord2, paramMessageRecord1);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageRecord1.frienduin, 1, paramMessageRecord2.uniseq, (byte[])localObject1);
      agfe.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord2.uniseq);
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(paramMessageRecord2)) {
        break label915;
      }
      a(paramMessageRecord2);
      TianShuManager.getInstance().cacheTraceInfo(paramMessageRecord2.getExtInfoFromExtStr("report_key_bytes_oac_msg_extend"));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(paramString, paramMessageRecord1.shmsgseq);
      return;
    }
    label915:
    label927:
    ...
    for (;;)
    {
      try
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMessageRecords(paramMessageRecord1.frienduin, 1, l, -5040);
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateGroupMsgSeqAndTimeByUniseq(paramMessageRecord1.frienduin, 1, ((MessageRecord)localObject1).uniseq, paramMessageRecord1.shmsgseq, paramMessageRecord1.time);
      break;
      break;
      if ((bdpc.a(paramMessageRecord2)) || (paramMessageRecord2.msgtype == -2048))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(paramMessageRecord1.frienduin, 1, paramMessageRecord2.uniseq);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageRecord1.frienduin, 1, paramMessageRecord2.uniseq, paramMessageRecord1.msgData);
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(paramMessageRecord1.frienduin, 1, paramMessageRecord2.uniseq);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgFieldByUniseq(paramMessageRecord1.frienduin, 1, paramMessageRecord2.uniseq, "extStr", paramMessageRecord1.extStr);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgFieldByUniseq(paramMessageRecord1.frienduin, 1, paramMessageRecord2.uniseq, "extLong", Integer.valueOf(paramMessageRecord1.extLong));
      break label356;
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.userActiveStatus = i1;
        str = String.valueOf(l8);
        localObject2 = new ArrayList();
        bcsd localbcsd = new bcsd();
        localbcsd.jdField_e_of_type_Long = l8;
        localbcsd.jdField_e_of_type_Int = 1;
        localbcsd.f = n;
        Object localObject4;
        if (QLog.isColorLevel())
        ...
        else
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(str) != 2) {
            break label467;
          }
        }
        label467:
        ...
        label473:
        paramPbPushMsg = (awzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOPINFO_MANAGER);
        if (!MessageHandler.b)
        {
          if (paramBoolean) {
            break label609;
          }
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(str, new Object[] { paramMsg, paramFromServiceMsg });
          if (!QLog.isColorLevel()) {
            break;
          }
        ...
        ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).e(str);
        paramFromServiceMsg = new bffl();
        try
        {
          a(paramMsg, (ArrayList)localObject1, localbcsd, true, paramFromServiceMsg);
          ...
          if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0))
          {
            ...
            if (i < j)
            {
              ...
              if ((localObject3 instanceof MessageForMarketFace)) {
                awyq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)localObject3);
              }
              if (QLog.isColorLevel())
              {
              ...
              if (((((MessageRecord)localObject3).senderuin != null) && (((MessageRecord)localObject3).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || ((nty.a((MessageRecord)localObject3)) && (nty.b((MessageRecord)localObject3))))
              {
                if (nty.a((MessageRecord)localObject3))
                {
                  ((MessageRecord)localObject3).senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
                  localObject4 = nty.a((MessageRecord)localObject3);
                  nty.a().a(String.valueOf(localbcsd.jdField_e_of_type_Long), ((MessageRecord)localObject3).vipBubbleID, ((ntz)localObject4).jdField_b_of_type_Int, ((ntz)localObject4).jdField_b_of_type_JavaLangString, ((ntz)localObject4).jdField_c_of_type_Int, ((ntz)localObject4).a, ((ntz)localObject4).jdField_c_of_type_JavaLangString);
                }
                localObject4 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getSendingTroopMsgItem(((MessageRecord)localObject3).frienduin, 1, (MessageRecord)localObject3);
                if (localObject4 != null) {
              ...
              for (;;)
              {
                ...
                this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setReadFrom(((MessageRecord)localObject3).frienduin, 1, ((MessageRecord)localObject3).shmsgseq);
                paramMsg.add(localObject3);
                if ((localObject3 instanceof MessageForTroopFile)) {
                  ((bedr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TEAMWORK_SPREAD_MANAGER)).a((ChatMessage)localObject3);
                }
              }
            }
          }
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(paramMsg);
          bool1 = anyv.a(paramMsg);
          bool2 = anyv.b(paramMsg);
          i = acnh.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        paramFromServiceMsg.addMessage(paramMsg, String.valueOf(l5), paramBoolean);
        bdkh.a(0, 1, 1, paramMsg.size());
        if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
        {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(str, l3);
          paramFromServiceMsg = (MessageRecord)((ArrayList)localObject1).get(0);
          ((bgls)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_ROBOT_MANAGER)).c(paramFromServiceMsg);
        }
        if (n == 127) {
          break;
        }
        ...
        ((bhou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a((List)localObject2);
        l1 = System.currentTimeMillis() - l1;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.TroopMessageProcessor", 2, "decodecMsg costTime = [" + l1 + "]");
        }
        aooe.a("actGroupDecodeCost", l1);
        if (((ArrayList)localObject2).size() <= 0) {
          break;
        }
        aooe.a((MessageRecord)((ArrayList)localObject2).get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
      }
      label1702:
      i = 0;
  ...
  public void a(GroupMsgReadedNotify paramGroupMsgReadedNotify)
  {
    ...
    Object[] arrayOfObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().b(str);
    if ((arrayOfObject != null) && (arrayOfObject.length >= 2))
    {
      ...
      if (l < paramGroupMsgReadedNotify.lMemberSeq) {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().c(str, new Object[] { Long.valueOf(paramGroupMsgReadedNotify.lMemberSeq), Long.valueOf(paramGroupMsgReadedNotify.lGroupMsgSeq) });
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setReadFrom(str, 1, paramGroupMsgReadedNotify.lMemberSeq);
    if (paramGroupMsgReadedNotify.lMemberSeq >= 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().msgNotifyManager.a(str, 1);
    }
    paramGroupMsgReadedNotify = (bgiy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_BIND_PUBACCOUNT_MANAGER);
  ...
  public void a(String paramString, msg_svc.PbGetGroupMsgResp paramPbGetGroupMsgResp, int paramInt)
  {
    ...
    ((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.HOT_CHAT_MANAGER)).a(paramString, paramPbGetGroupMsgResp, paramInt);
  }
