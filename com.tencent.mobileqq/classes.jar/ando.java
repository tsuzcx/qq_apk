...
public class ando
{
  private static ando jdField_a_of_type_Ando;
  private static final FileFilter jdField_a_of_type_JavaIoFileFilter = new andp();
  ...
  {
    if (jdField_a_of_type_Ando == null) {
      jdField_a_of_type_Ando = new ando();
    }
    return jdField_a_of_type_Ando;
  }
