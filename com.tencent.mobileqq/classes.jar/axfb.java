  ...
  extends ajfb
{
  ...
  public axfb(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Boolean = baig.b(paramQQAppInterface.getApp(), paramQQAppInterface.c(), "tencent_docs_config_enable_assistant", false);
    this.jdField_b_of_type_Boolean = baig.b(paramQQAppInterface.getApp(), paramQQAppInterface.c(), "tencent_docs_config_preload_tool_process", false);
  }
  
  private static File a(String paramString)
  {
    return new File(a(), bcdu.b(paramString));
  }
  ...
  private String a(ReSendCmd paramReSendCmd)
  {
    ...
    {
      paramReSendCmd = localTicketManager.GetSkey(this.mApp.getCurrentAccountUin(), 16L, new axfd(this, localTicketManager, paramReSendCmd));
  ...
  private String a(ReSendCmd paramReSendCmd, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      ...
      axfc localaxfc = new axfc(this, (TicketManager)localObject, paramReSendCmd);
      localObject = ((TicketManager)localObject).GetPskey(str, 16L, new String[] { "docs.qq.com" }, localaxfc);
  ...
  public static String a(String paramString, axdv paramaxdv)
  {
    int j = 1;
    localObject2 = null;
    try
    {
      i = paramaxdv.jdField_a_of_type_Int;
      if (i != 0) {
        break label453;
      }
      i = 1;
    }
    catch (JSONException paramaxdv)
    {
      for (;;)
      {
        int i;
        ...
        if (QLog.isColorLevel()) {
          QLog.e("TeamWorkHandler", 2, paramaxdv, new Object[0]);
        }
        continue;
        paramString = null;
      }
    ...
    localJSONObject.put("url", URLEncoder.encode(paramaxdv.e));
    if (paramaxdv.j != null) {
      localJSONObject.put("title", URLEncoder.encode(paramaxdv.j));
    }
    ...
    if (paramaxdv.k == null)
    {
      ...
      localObject1 = new StringBuilder("https://docs.qq.com/cgi-bin/online_docs/wxqrcode").append('?').append("domainId=").append(paramaxdv.i).append("&padId=").append(paramaxdv.h).append("&dataType=");
      if (paramaxdv.jdField_b_of_type_Int != 3) {
        break label382;
      }
    }
    for (;;)
    {
      localObject1 = axfe.a(paramString, j + "&page=" + "pages/shareFriend/shareFriend" + "&ac=" + "share" + "&t=" + "0" + "&policy=" + String.valueOf(i) + "&right_flag=" + "1" + "&param=" + localJSONObject.toString() + "&type=" + "1", "docs.qq.com");
      if (localObject1 == null) {
        break label448;
      }
      paramaxdv = new JSONObject((String)localObject1);
      paramString = paramaxdv;
      for (;;)
      {
        try
        {
          if (paramaxdv.optInt("retcode", -1) != 0)
          {
            paramaxdv.put("retcode", -1);
            paramString = paramaxdv;
            if (QLog.isColorLevel())
            {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("TeamWorkHandler", 2, paramaxdv.toString());
      }
      return (String)paramaxdv.opt("key");
      localObject1 = paramaxdv.k;
      break;
      j = 0;
    }
  }
    ...
    if (paramString1 != null)
    {
      ...
      if (localObject.length == 2)
      {
        ...
        try
        {
          ...
          paramString1 = axfe.a(localStringBuilder2.toString(), paramString2, "https://docs.qq.com/cgi-bin/online_docs/doc_delete", "docs.qq.com", localStringBuilder1.toString(), (Map)localObject, false);
          return paramString1;
        }
  ...
  public static JSONObject a(String paramString1, int paramInt, String paramString2)
  {
    ...
    //   26: iload_1
    //   27: invokevirtual 252	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   30: invokevirtual 87	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   33: ldc 153
    //   35: invokestatic 282	axfe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   38: astore 4
    //   40: aload 4
    //   42: ifnull +155 -> 197
    //   45: new 197	org/json/JSONObject
    //   48: dup
    //   49: aload 4
    //   51: invokespecial 283	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   54: astore_2
    //   55: aload_2
    //   56: astore_0
    //   57: aload_2
    //   58: ldc_w 285
    //   61: iconst_m1
    //   62: invokevirtual 289	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   65: ifeq +50 -> 115
    //   68: aload_2
    //   69: ldc_w 285
    //   72: iconst_m1
    //   73: invokevirtual 221	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   76: pop
    //   77: aload_2
    //   78: astore_0
    ...
    //   107: invokevirtual 87	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   110: invokestatic 142	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   113: aload_2
    //   114: astore_0
    //   115: aload_0
    //   116: astore_2
    ...
    //   121: new 197	org/json/JSONObject
    //   124: dup
    //   125: invokespecial 198	org/json/JSONObject:<init>	()V
    //   128: astore_2
    //   129: aload_2
    //   130: ldc_w 285
    //   133: iconst_m1
    //   134: invokevirtual 221	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   137: pop
    ...
    //   147: iconst_2
    //   148: aload_2
    //   149: invokevirtual 275	org/json/JSONObject:toString	()Ljava/lang/String;
    //   152: invokestatic 298	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   155: aload_2
    //   156: areturn
    //   157: astore_2
    //   158: aload_3
    //   159: astore_0
    //   160: invokestatic 293	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   163: ifeq +15 -> 178
    //   166: ldc_w 365
    //   169: iconst_2
    //   170: aload_2
    //   171: iconst_0
    //   172: anewarray 306	java/lang/Object
    //   175: invokestatic 309	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   178: goto -63 -> 115
    //   181: astore_0
    //   182: aload_0
    //   183: invokevirtual 366	org/json/JSONException:printStackTrace	()V
    //   186: goto -48 -> 138
    //   189: astore_3
    //   190: aload_2
    //   191: astore_0
  ...
  public static JSONObject a(String paramString1, String paramString2)
  {
    ...
    //   23: ldc 153
    //   25: invokestatic 282	axfe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnull +150 -> 180
    ...
    //   164: astore_0
    //   165: aload_0
    //   166: invokevirtual 366	org/json/JSONException:printStackTrace	()V
    //   169: goto -46 -> 123
    //   172: astore_2
    //   173: aload_1
    //   174: astore_0
  ...
  public static JSONObject a(String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   31: aload_1
    //   32: ldc_w 387
    //   35: invokestatic 389	java/net/URLEncoder:encode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   75: ldc 153
    //   77: invokestatic 282	axfe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   80: astore_3
    //   81: aload_3
    //   82: ifnull +187 -> 269
    ...
    //   245: astore_0
    //   246: aload_0
    //   247: invokevirtual 366	org/json/JSONException:printStackTrace	()V
    //   250: goto -74 -> 176
    //   253: astore_3
    //   254: aload_1
    //   255: astore_0
  ...
  {
    paramString1 = axfe.b("doc_url=" + URLEncoder.encode(paramString3), paramString1, "https://docs.qq.com/cgi-bin/online_docs/doc_content", "docs.qq.com");
    if (!TextUtils.isEmpty(paramString1)) {
      bace.a(a(), bcdu.b(paramString2), paramString1);
    }
  }
  ...
  public static boolean a(String paramString, axdv paramaxdv)
  {
    Object localObject = UUID.randomUUID().toString().replaceAll("-", "");
    paramaxdv = new StringBuilder("https://docs.qq.com/cgi-bin/api/wechatshare/shareTips").append('?').append("domainId=").append(paramaxdv.i).append("&padId=").append(paramaxdv.h).append("&xsrf=").append((String)localObject);
    localObject = new StringBuilder().append("TOK=").append((String)localObject);
    try
    {
      paramString = axfe.a(paramString, paramaxdv.toString(), "docs.qq.com", ((StringBuilder)localObject).toString());
      if (paramString != null)
      {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, boolean paramBoolean2, int paramInt, List<String> paramList1, List<String> paramList2, List<String> paramList3)
  {
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString1 = axfe.a(paramString1, paramString2.toString(), "docs.qq.com", paramString3.toString());
      if (paramString1 == null) {
        break;
      }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (j == 0)
      {
        ...
        QLog.i("TeamWorkHandler" + axdz.i, 2, " handleGetUserAuthDocsGrayTips  | policy=" + k + " privilege =" + m + " memberNum = " + n + " remainTime = " + i1 + " setTime= " + i);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          QLog.i("TeamWorkHandler" + axdz.i, 2, " handleGetUserAuthDocsGrayTips ,result: " + j);
          return;
          bool = false;
          paramToServiceMsg = this.app.getApp().getString(2131654249);
          continue;
          bool = false;
    ...
    {
      QLog.e("TeamWorkHandler" + axdz.i, 1, " handleGetUserAuthDocsGrayTips exception = " + paramToServiceMsg.toString());
      return;
    }
    label425:
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          {
            awqx.b(null, "CliOper", "", "", "0X8009550", "0X8009550", 0, 0, "", "", "", "");
            break label309;
            notifyUI(9, bool, new Object[] { localDocsGrayTipsInfo, paramToServiceMsg, Long.valueOf(l) });
            if (!QLog.isColorLevel()) {
              break;
            }
            QLog.i("TeamWorkHandler" + axdz.i, 2, " handleSetUserAuthDocsGrayTips ,result: " + i);
          }
          else if ("2".equals(localDocsGrayTipsInfo.d))
          {
            awqx.b(null, "CliOper", "", "", "0X8009552", "0X8009552", 0, 0, "", "", "", "");
          }
        }
      }
      catch (Exception paramToServiceMsg)
      {
        QLog.e("TeamWorkHandler" + axdz.i, 1, " handleSetUserAuthDocsGrayTips  exception = " + paramToServiceMsg.toString());
        return;
      }
      boolean bool = false;
      paramToServiceMsg = localDocsGrayTipsInfo.k;
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (k == 0)
      {
        ...
        QLog.i("TeamWorkHandler" + axdz.i, 1, " handleGetGroupAuthDocsGrayTips  | policy = " + i + " userInfoList.size() = " + paramFromServiceMsg.size() + " totalMembers = " + n + " privilegeMembers = " + i1 + " privilege = " + i2 + " memberNum = " + i3 + " remainTime = " + m + " setTime = " + j + " docsGrayTipsInfo.policy = " + localDocsGrayTipsInfo.m + " docsGrayTipsInfo.privilege = " + localDocsGrayTipsInfo.n);
      ...
      for (;;)
      {
        QLog.i("TeamWorkHandler" + axdz.i, 1, " handleGetGroupAuthDocsGrayTips. result = " + k + ", isSuccess = " + bool);
        if (bool) {
          break;
        }
    ...
    {
      QLog.e("TeamWorkHandler" + axdz.i, 1, " handleGetGroupAuthDocsGrayTips exception = " + paramToServiceMsg.toString());
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          if ("1".equals(localDocsGrayTipsInfo.d))
          {
            awqx.b(null, "CliOper", "", "", "0X8009550", "0X8009550", 1, 0, "", "", "", "");
            break label303;
            QLog.i("TeamWorkHandler" + axdz.i, 1, " handleSetGroupAuthDocsGrayTips. result = " + i);
            notifyUI(11, bool, new Object[] { localDocsGrayTipsInfo, paramToServiceMsg, Long.valueOf(l) });
          }
          else if ("2".equals(localDocsGrayTipsInfo.d))
          {
            awqx.b(null, "CliOper", "", "", "0X8009552", "0X8009552", 1, 0, "", "", "", "");
          }
        }
      }
      catch (Exception paramToServiceMsg)
      {
        QLog.e("TeamWorkHandler" + axdz.i, 1, " handleSetGroupAuthDocsGrayTips  exception = " + paramToServiceMsg.toString());
        return;
      }
      boolean bool = false;
      paramToServiceMsg = localDocsGrayTipsInfo.k;
  ...
  public String a(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      paramString1 = axfe.a(paramString1, this.app.getCurrentAccountUin(), "https://docs.qq.com/cgi-bin/online_docs/tool_decryptuin", "docs.qq.com", paramString2, null, false);
      if (TextUtils.isEmpty(paramString1)) {
        return null;
      }
  ...
  public JSONObject a()
  {
    ...
    //   1: astore_1
    //   2: aload_0
    //   3: getfield 147	axfb:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 148	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   9: ldc_w 838
    //   12: ldc 153
    //   14: invokestatic 282	axfe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   17: astore_3
    //   18: aload_3
    //   19: ifnull +148 -> 167
    ...
    //   151: astore_1
    //   152: aload_1
    //   153: invokevirtual 366	org/json/JSONException:printStackTrace	()V
    //   156: goto -44 -> 112
    //   159: astore_3
    //   160: aload_2
    //   161: astore_1
  ...
  public JSONObject a(String paramString)
  {
    ...
    //   40: invokestatic 409	java/lang/System:currentTimeMillis	()J
    //   43: invokevirtual 846	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   46: ldc_w 342
    ...
    //   57: astore_2
    //   58: aload_1
    //   59: invokestatic 445	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   62: ifne +15 -> 77
    //   65: aload_2
    //   66: ldc_w 848
    //   69: invokevirtual 78	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   95: astore_1
    //   96: aload_0
    //   97: getfield 147	axfb:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   113: invokestatic 475	axfe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   116: astore 4
    //   118: aload 4
    //   120: invokestatic 445	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   123: ifne +143 -> 266
    ...
    //   250: astore_1
    //   251: aload_1
    //   252: invokevirtual 366	org/json/JSONException:printStackTrace	()V
    //   255: goto -46 -> 209
    //   258: astore_3
    //   259: aload_2
    //   260: astore_1
  ...
  public JSONObject a(JSONObject paramJSONObject)
  {
    ...
    //   46: invokestatic 409	java/lang/System:currentTimeMillis	()J
    //   49: invokevirtual 846	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   52: ldc_w 342
    ...
    //   84: aload_1
    //   85: aload_0
    //   86: getfield 147	axfb:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   103: invokestatic 856	axfe:a	(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   106: astore 4
    //   108: aload 4
    //   110: ifnull +143 -> 253
    ...
    //   237: astore_1
    //   238: aload_1
    //   239: invokevirtual 366	org/json/JSONException:printStackTrace	()V
    //   242: goto -46 -> 196
    //   245: astore_3
    //   246: aload_2
    //   247: astore_1
  ...
  public void a(DocsGrayTipsInfo paramDocsGrayTipsInfo, int paramInt, long paramLong)
  {
    ...
    try
    {
      if (!badq.d(BaseApplicationImpl.getContext()))
      {
        ...
        for (paramDocsGrayTipsInfo = this.app.getApp().getString(2131628948);; paramDocsGrayTipsInfo = paramDocsGrayTipsInfo.l)
        {
          bbmy.a((Context)localObject1, paramDocsGrayTipsInfo, 0).a();
          return;
        }
      }
  ...
  public void a(DocsGrayTipsInfo paramDocsGrayTipsInfo, long paramLong)
  {
    try
    {
      if (!badq.d(BaseApplicationImpl.getContext()))
      {
        ...
        for (paramDocsGrayTipsInfo = this.app.getApp().getString(2131628948);; paramDocsGrayTipsInfo = paramDocsGrayTipsInfo.l)
        {
          bbmy.a((Context)localObject, paramDocsGrayTipsInfo, 0).a();
          return;
        }
      }
      ...
      QLog.i("TeamWorkHandler" + axdz.i, 2, "get user auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + axdz.i, 1, "get user auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
  ...
  public void b(DocsGrayTipsInfo paramDocsGrayTipsInfo, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      ((ToServiceMsg)localObject1).addAttribute("seq", Long.valueOf(paramLong));
      sendPbReq((ToServiceMsg)localObject1);
      QLog.i("TeamWorkHandler" + axdz.i, 1, "set group auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString + " setploicy = " + paramDocsGrayTipsInfo.h + " setonly= " + paramDocsGrayTipsInfo.i + " setprivilege=" + paramDocsGrayTipsInfo.g + " bNeedtime = " + paramDocsGrayTipsInfo.r + " settime=" + paramInt);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + axdz.i, 1, "set group auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
  ...
  public void b(DocsGrayTipsInfo paramDocsGrayTipsInfo, long paramLong)
  {
    try
    {
      ...
      ((ToServiceMsg)localObject).addAttribute("seq", Long.valueOf(paramLong));
      sendPbReq((ToServiceMsg)localObject);
      QLog.i("TeamWorkHandler" + axdz.i, 1, "get group auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString + ", msgSeq = " + paramLong);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + axdz.i, 1, "get group auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
