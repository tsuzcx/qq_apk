...
public class blec
{
  private static volatile blec jdField_a_of_type_Blec;
  ...
  private CopyOnWriteArrayList<WeakReference<bleb>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public static blec a()
  {
    if (jdField_a_of_type_Blec == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Blec == null) {
        jdField_a_of_type_Blec = new blec();
      }
      return jdField_a_of_type_Blec;
    }
  }
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = Long.valueOf(0L);; paramString1 = Long.valueOf(Long.parseLong(paramString1)))
    {
      ...
      paramString1 = new NewIntent(BaseApplicationImpl.getApplication(), blea.class);
  ...
  private void a(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bleb localbleb = (bleb)((WeakReference)localObject).get();
      if (localbleb != null)
      {
        localObject = localbleb.getFilterCmds();
        if ((localObject == null) || (((HashSet)localObject).contains(paramString)))
        {
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "notifyListeners cmd=" + paramString + ",ret=" + paramLong + ",listener=" + localbleb);
          }
          localbleb.onCmdRsp(paramIntent, paramString, paramLong, paramJSONObject);
        }
      }
      else
      {
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject4.put("left", abep.jdField_a_of_type_Int);
        ...
        if (bgoa.a() == 1)
        {
          ...
          localJSONObject4 = new JSONObject();
          localJSONObject4.put("status", bfrw.a(BaseApplicationImpl.getContext()));
  ...
  public void a(bleb parambleb)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "addListener listener=" + parambleb);
    }
    if (parambleb == null) {
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      bleb localbleb = (bleb)((WeakReference)localIterator.next()).get();
      if ((localbleb != null) && (localbleb == parambleb)) {
        return;
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "addListener listener=" + parambleb + " succ");
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(parambleb));
  }
  
  public void a(bled parambled)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "reportDC appRuntime=" + localAppRuntime + ",reportBuilder=" + parambled);
    }
    if (parambled == null) {
      return;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject3.put("ret_id", String.valueOf(parambled.jdField_b_of_type_Int));
        if (!TextUtils.isEmpty(parambled.jdField_c_of_type_JavaLangString)) {
          localJSONObject3.put("oper_moudle", parambled.jdField_c_of_type_JavaLangString);
        }
        if (!TextUtils.isEmpty(parambled.jdField_b_of_type_JavaLangString)) {
          localJSONObject3.put("oper_id", parambled.jdField_b_of_type_JavaLangString);
        }
        if (!TextUtils.isEmpty(parambled.d)) {
          localJSONObject3.put("gameappid", parambled.d);
        }
        if (!TextUtils.isEmpty(parambled.jdField_e_of_type_JavaLangString)) {
          localJSONObject3.put("tianji_report_str", parambled.jdField_e_of_type_JavaLangString);
        }
        if (!TextUtils.isEmpty(parambled.f)) {
          localJSONObject3.put("apk_volume", parambled.f);
        }
        Iterator localIterator = parambled.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
      ...
      catch (Exception parambled)
      {
        parambled.printStackTrace();
        return;
      }
      localJSONObject2.put("dc_id", parambled.jdField_a_of_type_JavaLangString);
  ...
  public void a(WadlParams paramWadlParams, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("clientver", "8.4.8");
  ...
  public void a(String paramString1, String paramString2, bigb parambigb, String paramString3)
  {
    if (parambigb != null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        localWadlParams = parambigb.jdField_a_of_type_CooperationWadlIpcWadlParams;
        if (TextUtils.isEmpty(jdField_b_of_type_JavaLangString)) {
          jdField_b_of_type_JavaLangString = String.valueOf(DeviceInfoUtil.getCarrier());
        }
        bled localbled = new bled();
        localbled.a(paramString3).c(paramString1).d("558").f(String.valueOf(parambigb.jdField_a_of_type_Long)).a(parambigb.jdField_a_of_type_Int).a(1, "55801").a(3, "1").a(4, paramString2).a(11, "4").a(12, "430").a(14, Build.MODEL).a(15, Build.VERSION.RELEASE).a(16, jdField_b_of_type_JavaLangString).a(31, parambigb.jdField_b_of_type_JavaLangString).a(32, parambigb.d).a(36, parambigb.a()).a(37, bigb.jdField_a_of_type_JavaLangString).a(42, parambigb.g).a(43, parambigb.h).a(45, parambigb.f).a(48, parambigb.jdField_c_of_type_JavaLangString).a(49, String.valueOf(parambigb.jdField_b_of_type_Long)).a(50, parambigb.i);
        if (localWadlParams != null)
        {
          ...
          {
            i = 2;
            localbled.b(localWadlParams.jdField_a_of_type_JavaLangString);
            paramString2 = localbled.a(2, String.valueOf(localWadlParams.d)).a(5, String.valueOf(i));
  ...
  public void a(String paramString, JSONObject paramJSONObject, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(BaseApplicationImpl.getApplication(), blea.class);
  ...
  public void b(bleb parambleb)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "removeListener listener=" + parambleb);
    }
    if (parambleb == null) {
      return;
    }
    ...
    do
    {
      ...
      bleb localbleb = (bleb)localWeakReference.get();
      if ((localbleb == null) || (localbleb != parambleb)) {
        break;
      }
      bool = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localWeakReference);
    } while (!QLog.isColorLevel());
    QLog.d(jdField_a_of_type_JavaLangString, 1, "removeListener listener=" + parambleb + " " + bool);
  }
