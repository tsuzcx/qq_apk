  ...
  extends axxs
{
  ...
  void a(int paramInt, axyr paramaxyr, cmd0x352.ReqBody paramReqBody)
  {
    ...
    //   30: aload 8
    //   32: getfield 32	axyh:d	Ljava/lang/String;
    ...
    //   49: aload 8
    //   51: getfield 56	axyh:jdField_b_of_type_Int	I
    //   54: invokevirtual 61	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   57: aload 8
    //   59: getfield 64	axyh:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   62: astore 7
    //   64: aload 7
    //   66: astore_2
    //   67: aload 7
    ...
    //   103: aload 8
    //   105: getfield 81	axyh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   108: ldc 83
    ...
    //   131: aload 8
    //   133: getfield 109	axyh:jdField_a_of_type_Boolean	Z
    //   136: invokevirtual 113	com/tencent/mobileqq/pb/PBBoolField:set	(Z)V
    //   139: ldc 115
    //   141: aload 8
    //   143: getfield 117	axyh:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   175: aload 8
    //   177: getfield 109	axyh:jdField_a_of_type_Boolean	Z
    ...
    //   202: aload 8
    //   204: getfield 135	axyh:jdField_a_of_type_Int	I
    //   207: istore_1
    //   208: iload_1
    //   209: ldc 136
    //   211: if_icmpne +136 -> 347
    //   214: invokestatic 141	awqg:a	()Z
    //   217: ifeq +122 -> 339
    //   220: bipush 16
    //   222: istore_1
    //   223: iconst_4
    ...
    //   250: invokestatic 155	axub:a	()Ljava/lang/String;
    ...
    //   264: aload 8
    //   266: getfield 164	axyh:jdField_c_of_type_Int	I
    ...
    //   300: ldc 182
    //   302: aload 8
    //   304: getfield 117	axyh:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   0	381	2	paramaxyr	axyr
    //   0	381	3	paramReqBody	cmd0x352.ReqBody
    //   2	375	4	i	int
    //   91	8	5	l	long
    //   62	16	7	str	String
    //   8	295	8	localaxyh	axyh
  ...
  public void a(axtc paramaxtc, axtb paramaxtb)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramaxtc = ((cmd0x352.RspBody)new cmd0x352.RspBody().mergeFrom(arrayOfByte)).rpt_msg_getimg_url_rsp.get();
    ...
    while (localIterator.hasNext())
    {
      ...
      try
      {
        localaxzh = (axzh)localaxyv.jdField_a_of_type_JavaUtilList.get(0);
      }
      catch (Exception paramaxtc)
      {
        for (;;)
      ...
      try
      {
        localaxyh = (axyh)localaxyg.jdField_a_of_type_JavaUtilList.get(0);
        if (localaxzh == null) {
          continue;
        }
        if (localFromServiceMsg.getAttributes().containsKey("_attr_send_by_quickHttp")) {
          localaxzh.d = ((Boolean)localFromServiceMsg.getAttribute("_attr_send_by_quickHttp", Boolean.valueOf(false))).booleanValue();
        }
        ...
        if (awqg.a())
        {
          paramaxtc = localGetImgUrlRsp.bytes_big_thumb_down_para.get();
          ...
          if (paramaxtc == null)
          {
            paramaxtc = null;
            break label1050;
            if (localaxyh.jdField_a_of_type_Int != 65537) {
              break label628;
            }
            localaxzh.jdField_a_of_type_JavaLangString = paramaxtc;
            ...
            while (i < paramaxtc.size())
            {
              ...
              ((axuh)localObject2).jdField_a_of_type_JavaLangString = bakz.a(((Integer)paramaxtc.get(i)).intValue() & 0xFFFFFFFF);
              ((axuh)localObject2).jdField_a_of_type_Int = ((Integer)((List)localObject1).get(i)).intValue();
              localaxzh.jdField_a_of_type_JavaUtilArrayList.add(i, localObject2);
              i += 1;
            }
          }
        }
        ...
        {
          paramaxtc = localGetImgUrlRsp.bytes_thumb_down_para.get();
          break label396;
        }
        paramaxtc = paramaxtc.toStringUtf8();
        break label1050;
        localObject1 = ((ByteStringMicro)localObject1).toStringUtf8();
        break label1058;
        localObject2 = ((ByteStringMicro)localObject2).toStringUtf8();
        break label425;
        if (localaxyh.jdField_a_of_type_Int == 1)
        {
          paramaxtc = (axtc)localObject2;
          break label435;
        }
        if (localaxyh.jdField_a_of_type_Int != 131075) {
          break label1045;
        }
        ...
        if ((localGetImgUrlRsp.rpt_msg_down_ip6.has()) && (localGetImgUrlRsp.rpt_msg_down_ip6.size() > 0))
        {
          ...
          while (i < paramaxtc.size())
          {
            localObject1 = new axuh();
            ((axuh)localObject1).jdField_a_of_type_JavaLangString = Inet6Address.getByAddress(((cmd0x352.IPv6Info)paramaxtc.get(i)).bytes_ip6.get().toByteArray()).getHostAddress();
            ((axuh)localObject1).jdField_a_of_type_Int = ((cmd0x352.IPv6Info)paramaxtc.get(i)).uint32_port.get();
            ((axuh)localObject1).jdField_a_of_type_Boolean = true;
            localaxzh.jdField_b_of_type_JavaUtilArrayList.add(i, localObject1);
            i += 1;
          }
        }
        if (localGetImgUrlRsp.bytes_down_domain.has())
        {
          ...
          localaxzh.jdField_a_of_type_JavaUtilArrayList.add(paramaxtc);
          localaxzh.jdField_b_of_type_JavaLangString = paramaxtc.jdField_a_of_type_JavaLangString;
        }
        if (localGetImgUrlRsp.uint32_https_url_flag.has()) {
          localaxzh.jdField_a_of_type_Int = localGetImgUrlRsp.uint32_https_url_flag.get();
        }
        a(0, 0, "", "", localajmn, localaxzh);
      }
      catch (Exception paramaxtc)
      {
        localObject1 = localaxzh;
      }
      if (localObject1 != null)
      {
    ...
    {
      label396:
      a(-1, -9527, axou.a(i), axou.a(i), localajmn, localaxzh);
      break label272;
      break;
      label1024:
      awrc.a("Download_C2C_Pic_Request_Error_Param_Check", localaxyh.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void a(axyg paramaxyg)
  {
    if ((paramaxyg != null) && (paramaxyg.jdField_a_of_type_JavaUtilList != null) && (paramaxyg.jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager != null))
    {
      ...
      localaxtb.jdField_a_of_type_JavaLangString = "LongConn.OffPicDown";
