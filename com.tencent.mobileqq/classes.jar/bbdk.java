...
public class bbdk
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (b(i))
      {
        if (((bbdh)paramQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG)).a(paramSessionInfo.curFriendUin, paramSessionInfo.curType) == 1) {
          return 2;
        }
        return 1;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForPoke paramMessageForPoke)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramString);
        if (localObject != null) {
          break;
        }
      ...
      Object localObject = String.format(Locale.getDefault(), anvx.a(2131705172), new Object[] { ((Friends)localObject).getFriendNickWithAlias() });
      paramMessageForPoke = new avhz(paramString, paramQQAppInterface.getCurrentUin(), (String)localObject, paramInt, -5040, 655379, l);
      ...
      bdla.b(paramQQAppInterface, "dc00898", "", "", "0X8009891", "0X8009891", 0, 0, "", "", "", "");
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramString.length() < 5) || (bcsc.a(paramMessageRecord.msgtype)) || (acnh.j(paramMessageRecord.msgtype)) || (a(paramMessageRecord.msgtype)));
        paramQQAppInterface = (bbdh)paramQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG);
        if (paramInt == 1)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      localObject = (bbdh)paramQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG);
      localFriends = localanvk.b(paramString);
    } while ((localFriends == null) || (!localFriends.isFriend()));
    if (aiin.a(paramQQAppInterface).b()) {
      if (((bbdh)localObject).a(true))
      {
        if (!((bbdh)localObject).c(paramString)) {
          break label230;
        }
        ((bbdh)localObject).a(paramString);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = localanvk.a(paramString, true);
      ...
      return;
      label230:
      ((bbdh)localObject).a(paramString, true);
      break;
      if (QLog.isColorLevel()) {
  ...
  {
    if (((b(paramInt)) || (c(paramInt)) || (d(paramInt)) || (e(paramInt))) && (!bhbx.b(paramString)) && (!bghs.b(paramQQAppInterface, paramString))) {}
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        bbdh localbbdh = (bbdh)paramQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG);
        if (!localbbdh.a(false))
        {
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          Object localObject1 = localanvk.b(paramString);
          ...
          else if (localbbdh.f(paramString))
          {
            if (QLog.isColorLevel()) {
          ...
          {
            float f = localbbdh.a();
            Object localObject2 = localanvk.a(paramString, true);
  ...
  {
    return aweo.b(paramInt);
  }
  
  private static void e(QQAppInterface paramQQAppInterface, String paramString)
  {
    ((bbdh)paramQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG)).j(paramString);
  }
  ...
  {
    ((bbdh)paramQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG)).k(paramString);
  }
  
  private static void g(QQAppInterface paramQQAppInterface, String paramString)
  {
    ((bbdh)paramQQAppInterface.getManager(QQManagerFactory.ICE_BREAKING_MNG)).l(paramString);
  }
}
