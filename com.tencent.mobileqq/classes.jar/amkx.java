...
public class amkx
  ...
  implements amlf
{
  private static volatile amkx jdField_a_of_type_Amkx;
  public static boolean a;
  private List<amkz> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  {
    if (jdField_a_of_type_Amkx == null) {}
    try
    {
      if (jdField_a_of_type_Amkx == null) {
        jdField_a_of_type_Amkx = new amkx();
      }
      return jdField_a_of_type_Amkx;
    }
    finally {}
  }
  ...
  public static void a()
  {
    ...
    {
      QIPCClientHelper.getInstance().register(localamkx);
  ...
  public Bundle a(String paramString, Bundle paramBundle)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = amkv.a().a(l2, l1);
      localObject = amkv.a().a((String)localObject);
      if (localObject == null) {
        break label243;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (bool) {
        QLog.d("DanmuDataIPCClient", 2, new Object[] { "peak listSize:", Integer.valueOf(((amkw)localObject).d.size()), ", fullList:", ((amkw)localObject).d.toString() });
      }
      paramBundle.putBoolean("key_barrage_is_update", bool);
      paramBundle.putLong("key_barrage_req_time", System.currentTimeMillis());
      QIPCClientHelper.getInstance().getClient().callServer("DanmuDataIPCServer", "qipc_action_get_barrage", paramBundle, new amky(this));
  ...
  public void a(amkz paramamkz)
  {
    if ((paramamkz != null) && (!this.jdField_a_of_type_JavaUtilList.contains(paramamkz))) {
      this.jdField_a_of_type_JavaUtilList.add(paramamkz);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("key_barrage_req_time"))
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "DanmuPullCost", false, 0L, 0L, (HashMap)localObject1, null);
      if (QLog.isColorLevel()) {
    ...
    if ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty()))
    {
      ...
      j = 1;
      localObject3 = amkv.a().a(l2, l1);
      paramBundle = amkv.a().a((String)localObject3);
      if (paramBundle != null) {
        break label649;
      }
      paramBundle = amkv.a().b((String)localObject3);
    }
    label516:
    label649:
    for (;;)
    {
      if ((bool) && ((i != 0) || (j != 0)))
      {
        ...
        localObject2 = new amku(l2, l1, k, true);
        paramBundle.a((List)localObject1).b((List)localObject3).a((amku)localObject2).a(null).a();
      }
      if ((bool) && (paramBundle != null) && (!paramBundle.d.isEmpty()))
      {
        localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject1).hasNext()) {
          ((amkz)((Iterator)localObject1).next()).a(l1, String.valueOf(l2), m, paramBundle.d);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  public void b(amkz paramamkz)
  {
    if ((paramamkz != null) && (this.jdField_a_of_type_JavaUtilList.contains(paramamkz))) {
      this.jdField_a_of_type_JavaUtilList.remove(paramamkz);
    }
  }
    ...
    for (;;)
    {
      ...
      if ("qipc_action_send_barrage".equals(paramString))
      {
        ...
        while (localIterator.hasNext()) {
          ((amkz)localIterator.next()).a(l, paramBundle, paramString);
        }
      }
    }
  }
