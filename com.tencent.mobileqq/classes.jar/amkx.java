...
public class amkx
{
  ...
  amkv jdField_a_of_type_Amkv;
  amlb jdField_a_of_type_Amlb;
  ...
  public amkx(amkw paramamkw) {}
  
  public amkx a()
  {
    amkw.a().a(amkw.a().a(this.jdField_a_of_type_Amkv.b, this.jdField_a_of_type_Amkv.jdField_a_of_type_Long), this);
    return this;
  }
  
  public amkx a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    return this;
  }
  
  public amkx a(amkv paramamkv)
  {
    this.jdField_a_of_type_Amkv = paramamkv;
    return this;
  }
  
  public amkx a(amlb paramamlb)
  {
    this.jdField_a_of_type_Amlb = paramamlb;
    return this;
  }
  
  public amkx a(List<DanmuItemBean> paramList)
  {
    this.jdField_c_of_type_JavaUtilList = paramList;
    return this;
  }
  
  public amkx a(boolean paramBoolean)
  {
  ...
  public String a()
  {
    return String.format("CacheHolder - topicUin:%s, groupUin:%s, msgType:%s, peakCached:%s, videoStartTime:%s, videoEndTime:%s, nextStartIdx:%s, count:%s", new Object[] { Long.valueOf(this.jdField_a_of_type_Amkv.jdField_a_of_type_Long), Long.valueOf(this.jdField_a_of_type_Amkv.b), Integer.valueOf(this.jdField_a_of_type_Amkv.jdField_a_of_type_Int), Boolean.valueOf(this.jdField_a_of_type_Amkv.jdField_a_of_type_Boolean), Integer.valueOf(this.jdField_c_of_type_Int), Integer.valueOf(this.jdField_d_of_type_Int), Integer.valueOf(this.e), Integer.valueOf(this.f) });
  }
  ...
  public amkx b(List<Long> paramList)
  {
    this.jdField_a_of_type_JavaUtilList = paramList;
    return this;
  }
  
  public amkx c(int paramInt)
  {
    this.e = paramInt;
    return this;
  }
  
  public amkx d(int paramInt)
  {
    this.jdField_c_of_type_Int = paramInt;
    return this;
  }
  
  public amkx e(int paramInt)
  {
