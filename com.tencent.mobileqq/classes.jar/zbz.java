  ...
  implements wsp
{
  ...
  private LocationListener jdField_a_of_type_AndroidLocationLocationListener = new zcd(this);
  public final Object a;
  public final List<zby> a;
  public final Queue<zby> a;
  public final ConcurrentHashMap<String, zby> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = win.g + "emoji";
  ...
  public static String a(zbz paramzbz, String paramString)
  {
    return paramzbz.a("emoji_pack_url_" + paramString, "");
  }
  
  private static xel a()
  {
    int i = 0;
    try
    {
      byte[] arrayOfByte = zom.b(new File(jdField_a_of_type_JavaLangString + "/" + "list.pb"));
      if (arrayOfByte != null) {
        i = arrayOfByte.length;
      }
      yuk.a("DoodleEmojiManager", "restoreFilterItemListLocked file length = %d", Integer.valueOf(i));
      if (arrayOfByte == null) {
        return null;
      }
      ...
      if (i == 18)
      {
        ...
        try
        {
          ...
          return new xel((qqstory_service.RspGetEmoticonPackList)localObject, arrayOfByte, l);
        }
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        {
          yuk.e("DoodleEmojiManager", "restoreResponseFromFile error : " + localInvalidProtocolBufferMicroException);
          return null;
        }
      }
      return null;
    ...
    {
      yuk.d("DoodleEmojiManager", "restoreResponseFromFile failed FileNotFoundException");
      return null;
      yuk.d("DoodleEmojiManager", "restoreResponseFromFile find illegal file with magic code %d", new Object[] { Integer.valueOf(i) });
      return null;
    }
    catch (Exception localException)
    {
      yuk.c("DoodleEmojiManager", "restoreResponseFromFile failed", localException);
    }
  }
  ...
  /* Error */
  public static void a(xel paramxel)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   12: getstatic 51	zbz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   31: invokestatic 273	zom:d	(Ljava/lang/String;)Z
    //   34: pop
    //   35: getstatic 51	zbz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   38: invokestatic 54	zbz:a	(Ljava/lang/String;)V
    ...
    //   67: aload_2
    //   68: aload_0
    //   69: getfield 286	xel:jdField_a_of_type_Long	J
    //   72: invokevirtual 290	java/io/ObjectOutputStream:writeLong	(J)V
    //   75: aload_2
    //   76: aload_0
    //   77: getfield 293	xel:jdField_a_of_type_ArrayOfByte	[B
    //   80: arraylength
    //   81: invokevirtual 284	java/io/ObjectOutputStream:writeInt	(I)V
    //   84: aload_2
    //   85: aload_0
    //   86: getfield 293	xel:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   111: getstatic 51	zbz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   153: ldc_w 313
    //   156: aload_0
    //   157: getfield 293	xel:jdField_a_of_type_ArrayOfByte	[B
    //   160: arraylength
    //   161: invokestatic 187	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   164: invokestatic 192	yuk:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   167: aload_1
    //   168: ifnull +7 -> 175
    //   171: aload_1
    ...
    //   205: ldc_w 318
    //   208: aload_2
    //   209: invokestatic 249	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   212: aload_0
    //   213: ifnull +7 -> 220
    //   216: aload_0
  ...
  public static void a(zbz paramzbz, String paramString1, String paramString2)
  {
    paramzbz.a("emoji_pack_md5_" + paramString1, paramString2);
  }
  ...
  private static boolean a(File paramFile)
  {
    ...
    {
      return false;
      paramFile = paramFile.listFiles(new zch());
  ...
  public static String b(zbz paramzbz, String paramString)
  {
    return paramzbz.a("emoji_pack_name_" + paramString, "");
  }
  
  private static void b(zbz paramzbz, String paramString1, String paramString2)
  {
    paramzbz.a("emoji_pack_url_" + paramString1, paramString2);
  }
  
  public static String c(zbz paramzbz, String paramString)
  {
    return paramzbz.a("emoji_pack_config_" + paramString, "");
  }
  
  private static void c(zbz paramzbz, String paramString1, String paramString2)
  {
    paramzbz.a("emoji_pack_name_" + paramString1, paramString2);
  }
  
  public static String d(zbz paramzbz, String paramString)
  {
    return paramzbz.a("emoji_pack_md5_" + paramString, "");
  }
  
  private static void d(zbz paramzbz, String paramString1, String paramString2)
  {
    paramzbz.a("emoji_pack_config_" + paramString1, paramString2);
  }
  
  private void e()
  {
    long l = 0L;
    yuk.b("DoodleEmojiManager", "fireRequestEmojiPackList, cookie = " + this.jdField_b_of_type_JavaLangString);
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(true))
    {
      ...
      if (l > 5000L) {
        yuk.d("DoodleEmojiManager", "fireRequestEmojiPackList previous requesting is time out, fire another request, past time = %d", new Object[] { Long.valueOf(l) });
      }
    }
    else
    {
      this.jdField_a_of_type_Long = SystemClock.elapsedRealtime();
      wow.a().a(new xcn(this.jdField_b_of_type_JavaLangString, 50), new zcg(this));
      return;
    }
    yuk.d("DoodleEmojiManager", "fireRequestEmojiPackList now is already requesting, just waiting is ok, requesting past time = %d", new Object[] { Long.valueOf(l) });
  }
  ...
  public String a(@NonNull String paramString1, @NonNull String paramString2)
  {
    ...
    yuk.b("DoodleEmojiManager", "getStringValue, key : %s, value : %s", paramString1, paramString2);
    return paramString2;
  }
  ...
  public List<zby> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        yuk.d("DoodleEmojiManager", "current emoji packages is null.");
    ...
    yuk.c("DoodleEmojiManager", "current emoji packages's size=" + localArrayList.size());
    return localArrayList;
  }
  
  @NonNull
  public List<zby> a(boolean paramBoolean)
  {
    if (!a()) {
      return Collections.EMPTY_LIST;
    }
  ...
  public void a(int paramInt1, int paramInt2, zcm paramzcm)
  {
    paramzcm = new WeakReference(paramzcm);
    wow.a().a(new xcx(paramInt1, paramInt2), new zcf(this, paramzcm));
  }
  ...
  public void a(Context paramContext)
  {
    ...
    {
      paramContext = (zbz)wth.a(8);
      Object localObject1 = new File(jdField_a_of_type_JavaLangString);
      if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
      {
        localObject1 = ((File)localObject1).listFiles(new zca(this));
        if (localObject1 != null)
        {
          ...
          if (i < j)
          {
            ...
            Object localObject2 = localFile.listFiles(new zcb(this));
            if ((localObject2 != null) && (localObject2.length > 0))
            {
              localObject2 = a(localFile);
              Object localObject3 = b(paramContext, (String)localObject2);
              localObject3 = new zby((String)localObject2, a(paramContext, (String)localObject2), (String)localObject3, null, c(paramContext, (String)localObject2), d(paramContext, (String)localObject2));
              ((zby)localObject3).a(localFile.getPath());
      ...
      {
        yuk.c("DoodleEmojiManager", "has valid emoji packages cache. startTime=" + paramContext.jdField_a_of_type_Long + " currentTime=" + System.currentTimeMillis());
  ...
  {
    yuk.b("DoodleEmojiManager", "saveStringValue, key : %s, value : %s", paramString1, paramString2);
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(paramString1, paramString2).apply();
  }
  
  public void a(wuz paramwuz, zcm paramzcm)
  {
    yuk.b("DoodleEmojiManager", "requestPoiFaces " + paramzcm);
    ...
    if (localwuz != null)
    {
      a(localwuz.b, localwuz.jdField_a_of_type_Int, paramzcm);
      return;
    }
    localwva.a(new zce(this, paramzcm));
    localwva.c();
  }
  
  protected void a(boolean paramBoolean1, @NonNull xel paramxel, boolean paramBoolean2)
  {
    zbz localzbz = (zbz)wth.a(8);
    ...
    Iterator localIterator = paramxel.jdField_a_of_type_JavaUtilList.iterator();
    xem localxem;
    zby localzby;
    if (localIterator.hasNext())
    {
      localxem = (xem)localIterator.next();
      if (localxem.b != 1) {
        break label476;
      }
      localzby = (zby)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localxem.jdField_a_of_type_JavaLangString);
      if (localzby == null) {
        break label476;
      }
      ??? = localzby.a();
      if (TextUtils.equals(localzby.g, localxem.f)) {
        break label473;
      }
      yuk.a("DoodleEmojiManager", "EmojiPack md5 has changed. old : %s, new : %s", localzby.g, localxem.f);
    }
    for (;;)
    {
      try
      {
        zom.d((String)???);
        ??? = null;
        localzby = new zby(localxem);
        localzby.a((String)???);
        b(localzbz, localzby.jdField_a_of_type_JavaLangString, localzby.jdField_b_of_type_JavaLangString);
        c(localzbz, localzby.jdField_a_of_type_JavaLangString, localzby.d);
        d(localzbz, localzby.jdField_a_of_type_JavaLangString, localzby.f);
        a(localzbz, localzby.jdField_a_of_type_JavaLangString, localzby.g);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localxem.jdField_a_of_type_JavaLangString, localzby);
        if (paramBoolean2)
        {
          yuk.a("DoodleEmojiManager", "from local get doodle item : %s", localzby);
          localArrayList.remove(localzby);
          localArrayList.add(localzby);
        }
      }
      catch (Exception localException)
      {
        ...
        continue;
        yuk.a("DoodleEmojiManager", "from network get doodle item : %s", localException);
        continue;
      }
      do
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          wjj.a().dispatch(new zcj());
          this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
          if ((!paramBoolean2) && (!paramxel.jdField_a_of_type_Boolean))
          {
            e();
            return;
          }
      ...
      yuk.b("DoodleEmojiManager", "start download the first emoji pack if needed : " + ((zby)localArrayList.get(0)).jdField_a_of_type_JavaLangString);
      a(((zby)localArrayList.get(0)).jdField_a_of_type_JavaLangString, false);
      return;
      label473:
      continue;
      label476:
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    zby localzby = (zby)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localzby == null)
    {
      yuk.d("DoodleEmojiManager", "can not find pack item by id " + paramString);
      return false;
    }
    ??? = new File(b(localzby.jdField_a_of_type_JavaLangString));
    if ((a((File)???)) && (!paramBoolean))
    {
      yuk.d("DoodleEmojiManager", "already has local emoji folder, notify download success directly");
      localzby.a(((File)???).getPath());
      wjj.a().dispatch(new zci(localzby, 0, true, 0L, 0L));
      return true;
    }
    if (!TextUtils.isEmpty(localzby.a()))
    {
      yuk.d("DoodleEmojiManager", "local emoji folder is missing");
      localzby.a(null);
    }
    if (TextUtils.isEmpty(localzby.e))
    {
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilQueue.contains(localzby))
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(localzby);
  ...
  protected void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        this.jdField_a_of_type_Zby = ((zby)this.jdField_a_of_type_JavaUtilQueue.poll());
        if (this.jdField_a_of_type_Zby != null)
        {
          yuk.b("DoodleEmojiManager", "downloader startDownload : " + this.jdField_a_of_type_Zby);
          Bosses.get().postJob(new zcc(this, this.jdField_a_of_type_Zby));
        }
        return;
      }
      yuk.b("DoodleEmojiManager", "can not start download because find one is still downloading : " + this.jdField_a_of_type_Zby);
    }
  }
  
  public void d()
  {
    yuk.b("DoodleEmojiManager", "stopRequestSpeed.");
