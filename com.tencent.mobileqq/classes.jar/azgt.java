...
{
  public azgt(TroopBarPublishActivity paramTroopBarPublishActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBoolean)
    {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          paramBundle = this.a.getString(2131696570, new Object[] { Integer.valueOf(paramInt) });
        }
      }
      catch (Exception paramBundle)
      {
        for (;;)
        {
          ...
          paramBundle = this.a.getString(2131696570, new Object[] { Integer.valueOf(9992) });
          continue;
      ...
      bcql.a(localTroopBarPublishActivity, 1, paramBundle, 0).b(this.a.getTitleBarHeight());
      if (this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar != null) {
        break label800;
      }
      paramBundle = "0";
      bajf.a("pub_page", "fail", paramBundle, "4", TroopBarPublishActivity.b(this.a), "");
      ...
      if (!TextUtils.isEmpty(bajf.a(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText))) {
      ...
      if (this.a.h) {
        if (!TextUtils.isEmpty(bajf.a(this.a.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText)))
        {
    ...
    {
      axqy.b(null, "P_CliOper", "Grp_tribe", "", "pub_page", "suc", paramInt, 0, paramBundle, this.a.jdField_b_of_type_JavaLangString, localStringBuffer.toString(), "");
      this.a.e = true;
      ...
      for (;;)
      {
        bbku.a(this.a.app, "share_suc", paramBundle);
        if (this.a.jdField_a_of_type_Azal != null) {
          this.a.u();
        }
        if ((this.a.jdField_a_of_type_Azcs != null) && (!TroopBarPublishActivity.a(this.a).equals("###...^_^###"))) {
          axqy.b(null, "dc00899", "Grp_tribe", "", "pub_page", "sus_prefixpub", 0, 0, this.a.q, "", "", "");
        }
        ...
        if (this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar != null)
        {
          ...
          continue;
          label748:
          paramBundle = this.a.getString(2131696570, new Object[] { Integer.valueOf(9991) });
          break;
          paramBundle = this.a.getString(2131696570, new Object[] { Integer.valueOf(9992) });
          break;
          paramBundle = this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarMyBar.c;
