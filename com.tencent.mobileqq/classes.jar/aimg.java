...
public class aimg
{
  ...
  public static void a(anmf paramanmf, QQAppInterface paramQQAppInterface, structmsg.RspNextSystemMsg paramRspNextSystemMsg, String paramString)
  {
    ...
    localObject = (avtd)paramQQAppInterface.getManager(37);
    boolean bool;
    if (localArrayList.size() > 0)
    {
      if ((localArrayList.size() < 100) && (localObject != null)) {
        ((avtd)localObject).b(true);
      }
      ...
      if ((amwh.a(localArrayList)) && (paramQQAppInterface.isBackgroundStop))
      {
        bool = true;
    ...
    for (;;)
    {
      paramanmf.a(4019, true, localArrayList);
      return;
      bool = false;
      break;
      if (localObject != null) {
  ...
  public static void a(anmf paramanmf, QQAppInterface paramQQAppInterface, structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt, String paramString)
  {
    ...
    bcsz.a().b(paramQQAppInterface, paramInt);
    paramRspSystemMsgNew = new ArrayList();
    int i = paramList.size();
    Object localObject = (avtd)paramQQAppInterface.getManager(37);
    if (localObject != null) {
      ((avtd)localObject).b(false);
    }
    Collections.sort(paramList, new aimh());
    paramInt = 0;
    if (paramInt < i)
    {
      localObject = bbli.a(-2018);
    ...
    if (paramRspSystemMsgNew.size() > 0)
    {
      ...
      paramString = String.valueOf(paramString);
      if ((!amwh.a(paramRspSystemMsgNew)) || (!paramQQAppInterface.isBackgroundStop)) {
        break label568;
      }
    }
    label568:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramanmf.a(4019, true, paramRspSystemMsgNew);
      return;
    }
  }
  ...
  public static void a(BaseMessageManager paramBaseMessageManager, MessageRecord paramMessageRecord, QQMessageFacade paramQQMessageFacade, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      k = bcsz.a().b(paramQQAppInterface);
      if (k <= 0) {
        break;
      }
      int j = 0;
  ...
  public static void a(structmsg.StructMsg paramStructMsg, String paramString)
  {
    ...
    {
      bftc.a("Grp_contacts_news", "notice", paramString, 0, 0, new String[] { str1, str2, paramStructMsg });
      return;
    }
  }
