...
{
  private akat jdField_a_of_type_Akat = new aqws(this);
  private Handler jdField_a_of_type_AndroidOsHandler;
  private aqyb jdField_a_of_type_Aqyb;
  ...
  public static aqwp a(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    bcql.a(paramContext, 0, ajya.a(2131704682), 2000).a();
    int j;
    if (this.b != null)
    {
    ...
    for (int i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.fontId;; i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.bubbleId)
    {
      ...
      this.b = null;
      this.jdField_a_of_type_Aqyb = null;
      return;
    }
  }
  ...
  private void a(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      paramBaseChatPie.a(localaaog);
      localaaog.i = paramBaseChatPie.J;
      paramBaseChatPie.J = false;
      this.jdField_a_of_type_ArrayOfLong = aanz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.a(), paramBaseChatPie.a(), str, new ArrayList(), localaaog);
  ...
  private void a(BaseChatPie paramBaseChatPie, long paramLong, int paramInt)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = ajya.a(2131704683);
    }
    ...
    bbdj.a(paramBaseChatPie.a(), 230, (String)localObject1, (CharSequence)localObject2, ajya.a(2131704684), (String)localObject3, new aqwq(this, paramBaseChatPie, str), new aqwr(this)).show();
  }
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Aqyb != null) {
          this.jdField_a_of_type_Aqyb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
      }
      return;
      label59:
  ...
  public void a(BaseChatPie paramBaseChatPie, Bundle paramBundle)
  {
    ...
    if (this.b != null)
    {
      ...
      this.b = new aqyb(this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
  ...
  public void a(BaseChatPie paramBaseChatPie, boolean paramBoolean, SetFontBubbleRsp paramSetFontBubbleRsp, int paramInt)
  {
    if ((paramBoolean) && (paramSetFontBubbleRsp.stRet != null) && (paramSetFontBubbleRsp.stRet.ret == 0))
    {
      ...
      if ((this.jdField_a_of_type_Aqyb != null) && (this.jdField_a_of_type_Aqyb.jdField_a_of_type_Int == paramInt))
      {
        if ((paramSetFontBubbleRsp.stFontRsp.authRet != 0) || (paramSetFontBubbleRsp.stBubbleRsp.authRet != 0)) {
          QLog.e("FontBubbleManager", 1, "onSetFontBubble failed," + " fontAuth:" + paramSetFontBubbleRsp.stFontRsp.authRet + " bubbleAuth:" + paramSetFontBubbleRsp.stBubbleRsp.authRet + this.jdField_a_of_type_Aqyb.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
        }
        for (;;)
        {
          this.jdField_a_of_type_Aqyb = null;
          return;
          if (QLog.isColorLevel()) {
            QLog.d("FontBubbleManager", 2, "onSetFontBubble mRestore success: " + this.jdField_a_of_type_Aqyb.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
          }
        }
      }
    ...
    StringBuilder localStringBuilder = actj.a().append("onSetFontBubble failed,");
    ...
    if ((this.jdField_a_of_type_Aqyb != null) && (this.jdField_a_of_type_Aqyb.jdField_a_of_type_Int == paramInt)) {
      QLog.e("FontBubbleManager", 1, "restore failed: " + this.jdField_a_of_type_Aqyb.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
    }
    a(paramBaseChatPie.a());
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1000: 
      ...
      this.jdField_a_of_type_Aqyb = new aqyb((FontBubble)paramMessage[0]);
      this.b = new aqyb((FontBubble)paramMessage[1]);
      this.b.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return true;
    }
