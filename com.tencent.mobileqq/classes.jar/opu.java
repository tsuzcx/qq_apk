...
public class opu
{
  ...
  public static int a(ReadInJoyCommentListView paramReadInJoyCommentListView)
  {
    ...
    int i = 0;
    int j = k;
    if ((paramReadInJoyCommentListView instanceof bkky))
    {
      paramReadInJoyCommentListView = ((bkky)paramReadInJoyCommentListView).getWrappedAdapter();
      j = k;
      if ((paramReadInJoyCommentListView instanceof sxp))
      {
        paramReadInJoyCommentListView = ((sxp)paramReadInJoyCommentListView).a().iterator();
        j = i;
        if (paramReadInJoyCommentListView.hasNext())
        {
          BaseAdapter localBaseAdapter = (BaseAdapter)paramReadInJoyCommentListView.next();
          if (!(localBaseAdapter instanceof sxt)) {
            break label89;
          }
          ...
          if (!((oidb_0x885.RspBody)localObject3).rpt_msg_pos_ad_info.get().isEmpty())
          {
            ...
            if (((List)localObject3).size() > 0)
            {
              ...
              try
              {
                ...
                localObject3 = ola.a((oidb_0x885.AdInfo)localObject3);
  ...
  public static JSONObject a(VafContext paramVafContext, pay parampay, boolean paramBoolean)
  {
    ...
    if ((localBaseCommentData == null) || (localBaseCommentData.commentContent == null) || (parampay.jdField_a_of_type_JavaLangCharSequence == null) || (localBaseCommentData.advertisementInfo == null)) {}
    ...
    do
    {
      ...
      localoms = localAdvertisementInfo.mCommentAdParams;
    } while (localoms == null);
    ...
    if (TextUtils.isEmpty(localAdvertisementInfo.mAdCorporateLogo))
    {
      ...
      if (localBaseCommentData.isAuthorReply()) {
        localJSONObject.put("author_header_flag_one", anni.a(2131701007));
      }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramVafContext = paa.a(localBaseCommentData.nickName, 10);
      }
      localObject = paramVafContext;
      if (paramVafContext == null) {
        localObject = anni.a(2131708060);
      }
      ...
      if ((parampay.a()) && (paramBoolean)) {
        localJSONObject.put("comment_model", parampay);
      }
      long l2 = localoms.jdField_a_of_type_Long;
      long l1 = l2;
      if (l2 == 0L) {
        l1 = System.currentTimeMillis() / 1000L;
      }
      localJSONObject.put("time", pgz.a(l1, true));
      if (localBaseCommentData.medalInfo != null) {
        pha.a(localJSONObject, localBaseCommentData.medalInfo);
      }
      int j = 0;
      ...
      if (localoms.jdField_a_of_type_Int != 1) {
        break label691;
      }
      if (i == 0) {
        break label677;
    ...
    for (;;)
    {
      ...
      if (localoms.b) {
        localJSONObject.put("like_commentModel", parampay);
      }
  ...
  public static oidb_cmd0xc46.ReqAdvertisePara a(int paramInt1, int paramInt2, int paramInt3, nwv paramnwv)
  {
    int i = 0;
    ...
    for (localObject1 = ((acrz)localObject2).a;; localObject1 = null)
    {
      ...
      localPhoneInfo.bytes_wx_ver.set(ByteStringMicro.copyFrom(opp.a(BaseApplication.getContext()).getBytes()));
      ...
      try
      {
        ...
        if ((paramnwv != null) && (paramnwv.a()))
        {
          ...
          ((JSONObject)localObject1).put("RepeatedReqFlag", paramnwv.b);
          ((JSONObject)localObject1).put("KdPos", paramnwv.c);
      ...
      catch (JSONException paramnwv)
      {
        for (;;)
        {
          paramnwv.printStackTrace();
        }
      }
      paramnwv = new oidb_cmd0xc46.AdReqInfo();
      paramnwv.uint64_ad_channel_id.set(95555552);
      localReqAdvertisePara.msg_ad_req_info.set(paramnwv);
  ...
  public static void a(int paramInt, AdvertisementInfo paramAdvertisementInfo, ReadInJoyArticleBottomVideoView paramReadInJoyArticleBottomVideoView)
  {
    ...
    jdField_a_of_type_JavaUtilHashSet.add(new opw(paramAdvertisementInfo, paramInt, paramReadInJoyArticleBottomVideoView));
  }
  ...
  public static void a(Context paramContext, long paramLong, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    {
      return;
      if (oqt.a(paramAdvertisementInfo))
      {
        oqt.a(paramContext, paramAdvertisementInfo);
        return;
      }
    } while (oqj.a(paramAdvertisementInfo) == 1);
    if (oqj.d(paramAdvertisementInfo))
    {
      ubb.a(paramContext, paramAdvertisementInfo.mPopFormH5Url, paramAdvertisementInfo.mAdRl, paramAdvertisementInfo.mAdTraceId);
      nxw.a(new omp().a(paramContext).a(nxw.L).b(nxw.aq).a(paramAdvertisementInfo).a());
      return;
    }
    ...
    localoml.jdField_a_of_type_Long = paramLong;
    ubb.a((Activity)paramContext, paramAdvertisementInfo, null, (int)paramAdvertisementInfo.mChannelID, true, localoml);
  }
  
  public static void a(Context paramContext, Container paramContainer, pay parampay, int paramInt)
  {
    if ((parampay == null) || (parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData == null) || (parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.advertisementInfo == null)) {
      return;
    }
    parampay = parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.advertisementInfo;
    parampay.setClickPos(paramInt);
    a(paramContext, a(paramContainer, parampay), parampay);
    a(paramContainer, parampay);
  }
  ...
  public static void a(ReadInJoyArticleBottomVideoView paramReadInJoyArticleBottomVideoView, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    localnxm.e = paramAdvertisementInfo.mAdImg;
    localnxm.d = paramAdvertisementInfo.mAdVideoUrl;
    ProteusBannerVideoItemData localProteusBannerVideoItemData = new ProteusBannerVideoItemData();
    localProteusBannerVideoItemData.jdField_a_of_type_Boolean = false;
    localProteusBannerVideoItemData.jdField_a_of_type_Long = paramAdvertisementInfo.mAdVideoFileSize;
    localProteusBannerVideoItemData.b = true;
    paramReadInJoyArticleBottomVideoView.a(localnxm, paramAdvertisementInfo, localProteusBannerVideoItemData, null);
  }
  
  public static void a(ReadInJoyCommentListView paramReadInJoyCommentListView, syi paramsyi)
  {
    paramReadInJoyCommentListView.setOnScrollListener(new opv(paramReadInJoyCommentListView, paramsyi));
  }
  ...
  {
    nxw.a(new omp().a(BaseApplication.getContext()).a(nxw.j).b(nxw.M).a(paramAdvertisementInfo).d(4000).a());
  }
  ...
  public static void a(pan parampan, pay parampay, int paramInt, View paramView)
  {
    if ((parampan != null) && (parampay != null) && (paramView != null) && (parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData != null) && (parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAd) && (parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.advertisementInfo != null))
    {
      parampay = parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.advertisementInfo;
      ViewBase localViewBase = ((Container)paramView).getVirtualView().findViewBaseByName(a(parampay));
      if ((localViewBase instanceof ReadInJoyArticleBottomVideoView))
      {
        a((ReadInJoyArticleBottomVideoView)localViewBase, parampay);
        a(paramInt, parampay, (ReadInJoyArticleBottomVideoView)localViewBase);
      }
      localViewBase = ((Container)paramView).getVirtualView().findViewBaseByName("id_view_AdDownloadView");
      if ((localViewBase instanceof osm))
      {
        ((osm)localViewBase).a(parampan);
        if ((!b()) && (parampan.a() != null) && (parampan.a().getContext() != null)) {
          localViewBase.getComLayoutParams().mLayoutMarginRight = afur.a(16.0F, parampan.a().getContext().getResources());
        }
      }
      paramView.setTag(2131380929, parampay);
    }
  }
  
  public static void a(syi paramsyi, int paramInt, List<pay> paramList)
  {
    if ((paramInt == 0) && (paramsyi != null)) {
      paramsyi.a();
    }
    ...
    if (paramList != null)
    {
      ...
      {
        pay localpay = (pay)paramList.get(i);
        if ((localpay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData != null) && (localpay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAd))
        {
          syh localsyh = new syh();
          localsyh.jdField_a_of_type_Int = (i + paramInt);
          localsyh.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo = localpay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.advertisementInfo;
          localArrayList.add(localsyh);
        }
        i += 1;
      }
    }
    if (localArrayList.size() > 0) {
      paramsyi.a(localArrayList);
    }
  }
  ...
  {
    return (parampay != null) && (parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData != null) && (parampay.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAd);
  }
