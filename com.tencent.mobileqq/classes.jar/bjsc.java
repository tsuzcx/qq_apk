...
public class bjsc
  extends bjwu
{
  public bjsc(@NonNull bjww parambjww)
  {
    super(parambjww);
  }
  ...
  public void a(int paramInt, @NonNull bkkm parambkkm)
  {
    ...
    //   1: iload_1
    //   2: aload_2
    //   3: invokespecial 17	bjwu:a	(ILbkkm;)V
    //   6: invokestatic 22	bkqo:a	()Lbkqo;
    //   9: invokestatic 22	bkqo:a	()Lbkqo;
    //   12: invokevirtual 26	bkqo:c	()I
    //   15: invokevirtual 29	bkqo:a	(I)Ldov/com/qq/im/capture/data/QIMFilterCategoryItem;
    //   18: astore 5
    //   20: invokestatic 22	bkqo:a	()Lbkqo;
    //   23: invokestatic 22	bkqo:a	()Lbkqo;
    //   26: invokevirtual 26	bkqo:c	()I
    //   29: invokevirtual 32	bkqo:b	(I)Ldov/com/qq/im/capture/data/QIMFilterCategoryItem;
    //   32: astore 6
    //   34: invokestatic 37	bjae:a	()Lbjae;
    //   37: bipush 8
    //   39: invokevirtual 40	bjae:c	(I)Lbizw;
    //   42: checkcast 42	bjdm
    //   45: invokevirtual 45	bjdm:a	()Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;
    //   48: astore 4
    ...
    //   60: ifnull +96 -> 156
    //   63: aload_2
    //   64: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   70: ifnonnull +17 -> 87
    //   73: aload_2
    //   74: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   87: aload_2
    //   88: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   102: aload_2
    //   103: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   125: ifne +207 -> 332
    //   128: aload_3
    //   129: getstatic 91	tnm:B	Ljava/lang/String;
    //   132: aload 5
    ...
    //   140: pop
    //   141: aload_2
    //   142: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   177: ifne +85 -> 262
    //   180: aload_2
    //   181: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   190: aload_2
    //   191: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   204: aload_2
    //   205: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   219: aload_2
    //   220: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   234: aload_2
    //   235: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   249: aload_3
    //   250: getstatic 116	tnm:z	Ljava/lang/String;
    //   253: aload 6
    ...
    //   275: ifne +16 -> 291
    //   278: aload_3
    //   279: getstatic 124	tnm:A	Ljava/lang/String;
    //   282: aload 4
    ...
    //   291: aload_0
    //   292: ldc 126
    //   294: invokevirtual 129	bjsc:a	(Ljava/lang/Class;)Lbjwv;
    //   297: checkcast 126	bjsd
    //   300: astore 4
    //   302: aload 4
    //   304: ifnull +13 -> 317
    //   307: aload 4
    ...
    //   340: ifne -184 -> 156
    //   343: aload_3
    //   344: getstatic 91	tnm:B	Ljava/lang/String;
    //   347: aload 5
    ...
    //   355: pop
    //   356: aload_2
    //   357: getfield 55	bkkm:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   381: invokevirtual 153	dov/com/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout:a	()Lbjzt;
    //   384: astore 5
    //   386: ldc 155
    //   388: getstatic 158	bjan:b	Ljava/lang/String;
    //   391: invokevirtual 164	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   394: ifeq +16 -> 410
    //   397: aload 5
    //   399: ifnull +24 -> 423
    //   402: aload 5
    //   404: invokevirtual 168	bjzt:a	()Z
    //   407: ifne +16 -> 423
    //   410: aload_3
    //   411: getstatic 171	tnm:y	Ljava/lang/String;
    //   414: ldc 172
    //   416: invokestatic 177	ajyc:a	(I)Ljava/lang/String;
    ...
    //   441: ifne +13 -> 454
    //   444: aload_3
    //   445: getstatic 181	tnm:x	Ljava/lang/String;
    //   448: aload 4
    ...
    //   461: ldc 187
    //   463: aload_3
    //   464: invokestatic 192	veg:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   467: aload_2
    //   468: getfield 195	bkkm:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   471: ldc 197
    //   473: aload_3
