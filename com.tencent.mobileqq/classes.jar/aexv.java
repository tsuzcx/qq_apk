  ...
  implements DialogInterface.OnClickListener, QQPermissionCallback
{
  ...
  private static final String[] jdField_b_of_type_ArrayOfJavaLangString = { anzj.a(2131700687), "QQ使用电话权限确定本机号码和设备ID，以保证帐号登录的安全性。QQ不会拨打其他号码或终止通话。\n请在设置中开启电话权限或存储空间，以正常使用QQ功能。" };
  ...
  private void a(AppActivity paramAppActivity, int paramInt)
  {
    ...
    bdll.a(null, "dc00898", "", "", str1, str1, paramInt, 0, "", "", str2, "");
  }
  ...
  public void a()
  {
    ...
    aexx localaexx = new aexx(this);
    bhpc localbhpc = bhlq.a(this.jdField_a_of_type_MqqAppAppActivity, 230);
    String str1 = anzj.a(2131709083);
    if (i > 1) {}
    for (i = 2131693450;; i = 2131693449)
    {
      String str2 = anzj.a(i);
      localbhpc.setTitle(str1);
      localbhpc.setMessage(str2);
      localbhpc.setNegativeButton(anzj.a(2131693448), localaexx);
      localbhpc.setPositiveButton(anzj.a(2131693447), localaexx);
      localbhpc.show();
      return;
    }
  }
  
  public void a(aexy paramaexy)
  {
    this.jdField_a_of_type_Aexy = paramaexy;
  }
  ...
  public boolean a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (aodp.a(0)))
    {
      paramAppActivity = new aexw(this);
      aodp.a(this.jdField_a_of_type_MqqAppAppActivity, "", paramAppActivity, paramAppActivity).show();
      return false;
    }
