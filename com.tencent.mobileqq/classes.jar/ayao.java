  ...
  implements Manager
{
  ...
  private ArrayList<bbgg> jdField_a_of_type_JavaUtilArrayList;
  ...
  private ArrayList<ayas> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public ayao(QQAppInterface paramQQAppInterface)
  {
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    ayao localayao = (ayao)paramQQAppInterface.getManager(62);
    if (localayao != null) {}
    for (int i = localayao.a(paramQQAppInterface.c() + "_all_third_last_msg_time");; i = 0)
    {
      if (QLog.isColorLevel()) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, akpc paramakpc)
  {
    int i;
    if ((paramQQAppInterface == null) || (!paramQQAppInterface.isRunning()) || (paramakpc == null))
    {
      i = 0;
      return i;
    }
    ayav localayav = (ayav)paramQQAppInterface.getManager(61);
    Object localObject;
    if (localayav != null)
    {
      Iterator localIterator = localayav.b().iterator();
      i = 0;
      j = i;
      ...
      if ((localObject == null) || (TextUtils.isEmpty(((SubAccountInfo)localObject).subuin)) || (localayav.a(((SubAccountInfo)localObject).subuin) != 1)) {
        break label238;
      }
    }
    label179:
    label191:
    label238:
    for (int j = paramakpc.a(((SubAccountInfo)localObject).subuin, 7000);; j = 0)
    {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      j = localayao.a(paramQQAppInterface.c() + "_" + paramString + "_msgNum");
      i = j;
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    paramQQAppInterface = (ayao)paramQQAppInterface.getManager(62);
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        i = ((Integer)((ayas)localObject).jdField_a_of_type_JavaLangObject).intValue();
        return i;
      }
      ...
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new ayas(paramString, Integer.valueOf(i)));
        }
        return i;
      }
      return 0;
  ...
  private ayas a(String paramString)
  {
    if (this.jdField_c_of_type_JavaUtilArrayList != null) {
      try
      {
        ...
        while (i < j)
        {
          ...
          for (ayas localayas = (ayas)this.jdField_c_of_type_JavaUtilArrayList.get(i); localayas != null; localayas = null)
          {
            boolean bool = TextUtils.equals(localayas.jdField_a_of_type_JavaLangString, paramString);
            if (!bool) {
              break;
            }
            return localayas;
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      paramQQAppInterface = bbcl.b(paramQQAppInterface, paramString2, true);
      ...
      return paramString1;
      paramString1 = localBaseApplication.getString(2131689663);
      continue;
      paramString1 = localBaseApplication.getString(2131689542);
      continue;
      paramString1 = localBaseApplication.getString(2131689541);
      continue;
      paramString1 = localBaseApplication.getString(2131718679);
      continue;
      paramString1 = localBaseApplication.getString(2131689702);
    }
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        paramString = (String)((ayas)localObject).jdField_a_of_type_JavaLangObject;
        return paramString;
      }
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("qq_subaccount_associated_cache", 0);
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new ayas(paramString, localObject));
        }
        return localObject;
      }
      return "";
  ...
  public static ArrayList<String> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localayao != null)
    {
      ...
      localayao.jdField_b_of_type_JavaUtilConcurrentLocksLock.lock();
    }
    for (;;)
    {
      try
      {
        ayas localayas = localayao.a(paramString);
        if (localayas != null)
        {
          localArrayList.addAll((ArrayList)localayas.jdField_a_of_type_JavaLangObject);
          localayao.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          if (QLog.isColorLevel()) {
        ...
        {
          localayao.jdField_c_of_type_JavaUtilArrayList.add(new ayas(paramString, localArrayList));
          continue;
        }
        i += 1;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject2 = (ayav)paramQQAppInterface.getManager(61);
      } while (localObject2 == null);
      long l1 = bbcp.a().a(paramQQAppInterface.getApp());
      long l2 = anet.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (l1 < l2)
      {
        if (l1 == 0L)
        {
          ...
          bool = bbcp.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
          localObject1 = ((ayav)localObject2).a("sub.uin.default");
          if ((localObject1 != null) && (((SubAccountInfo)localObject1).subuin != null))
          {
            ((ayav)localObject2).g(((SubAccountInfo)localObject1).subuin);
            i = ((ayav)localObject2).c(((SubAccountInfo)localObject1).subuin) - paramQQAppInterface.a().a(((SubAccountInfo)localObject1).subuin, 7000);
            if (i != 0)
            {
              paramQQAppInterface.a().c(((SubAccountInfo)localObject1).subuin, 7000, i);
              paramQQAppInterface.a().a(new String[] { ajsf.x, ((SubAccountInfo)localObject1).subuin });
            }
            if (bool)
            {
              if (QLog.isColorLevel()) {
          ...
          bbcp.a().a(paramQQAppInterface.getApp());
        }
      }
      else
      {
        if (!bbcp.a().b(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("SUB_ACCOUNT", 2, "initAllData() showedBefore:false, isFirstTime to user SubAccount.");
          }
          bbcp.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), true);
          a(paramQQAppInterface, 7);
        }
        localObject1 = paramQQAppInterface.a().a();
        localObject3 = ((aktg)localObject1).b(ajsf.x, 7000);
        if (((ayav)localObject2).a() <= 0) {
          break label788;
        }
        if (QLog.isColorLevel()) {
          QLog.d("SUB_ACCOUNT", 2, "initAllData() getBindedNumber > 0, go to initAllData");
        }
        localObject4 = ((ayav)localObject2).b();
      ...
      for (;;)
      {
        ...
        if ((localObject3 != null) && (l1 == 0L))
        {
          ...
          if (localObject2 != null) {
            j = ((ayav)localObject2).c(localSubAccountInfo.subuin);
          }
          int n = j - m;
          if (QLog.isColorLevel()) {
          ...
          if (n != 0)
          {
            ...
            paramQQAppInterface.a().a(new String[] { ajsf.x, localSubAccountInfo.subuin });
          }
        }
        bool = false;
        ...
        if (bool) {
          paramQQAppInterface.getSubAccountKey(paramQQAppInterface.getAccount(), localSubAccountInfo.subuin, new ayap(paramQQAppInterface));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "initAllData() delete subaccount recentuser, add default subaccount box");
      }
      Object localObject2 = ((ayav)localObject2).b();
      int j = ((ArrayList)localObject2).size();
      int i = 0;
      if (i < j)
      {
        localObject3 = (SubAccountInfo)((ArrayList)localObject2).get(i);
        if ((localObject3 == null) || (ajsf.x.equals(((SubAccountInfo)localObject3).subuin))) {}
        for (;;)
        {
          i += 1;
          break;
          localObject3 = ((aktg)localObject1).b(((SubAccountInfo)localObject3).subuin, 7000);
          if (localObject3 != null) {
            ((aktg)localObject1).b((RecentUser)localObject3);
          }
        }
      }
      localObject2 = ((aktg)localObject1).b(ajsf.x, 7000);
      ...
      {
        a(paramQQAppInterface, (aktg)localObject1, ajsf.x, 7);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte paramByte, ArrayList<String> paramArrayList)
  {
    ...
    for (paramArrayList = (String)localIterator.next();; paramArrayList = null)
    {
      try
      {
        ...
        Object localObject2 = (ayav)paramQQAppInterface.getManager(61);
        if (localObject2 == null) {
          continue;
        }
        paramArrayList = ((ayav)localObject2).a(paramArrayList);
        if (paramArrayList == null)
        {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          long l1 = 0L;
          continue;
          paramArrayList = bbdm.a(paramArrayList);
          continue;
          label377:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject = localaktg.a(false);
    int i = paramInt;
    if (localObject != null)
    {
      ...
      for (;;)
      {
        ...
        if ((localRecentUser != null) && (localRecentUser.getType() == 7000) && (!ajsf.x.equals(localRecentUser.uin)))
        {
          if (QLog.isColorLevel()) {
    ...
    a(paramQQAppInterface, localaktg, ajsf.x, i);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, aktg paramaktg, String paramString, int paramInt)
  {
    int i = 1;
    if (QLog.isColorLevel()) {
    ...
    if ((paramString == null) || (paramString.length() == 0) || (paramInt == 0)) {
      if (QLog.isColorLevel())
      {
        paramaktg = new StringBuilder().append("updateRecentUser() return,");
        if (paramString != null) {
          break label103;
        }
    ...
    do
    {
      ...
      {
        localRecentUser = paramaktg.b(paramString, 7000);
        if (localRecentUser != null) {
          paramaktg.b(localRecentUser);
        }
      }
      localRecentUser = paramaktg.b(ajsf.x, 7000);
      if (localRecentUser != null) {
        break label693;
      }
    ...
    for (;;)
    {
      localRecentUser.uin = ajsf.x;
      Object localObject;
      long l1;
      long l2;
      if (ajsf.x.equals(paramString))
      {
        paramString = (ayav)paramQQAppInterface.getManager(61);
      ...
      for (;;)
      {
        ...
        while (paramInt != 0)
        {
          ...
          paramInt = 1;
          continue;
          paramQQAppInterface = (ayav)paramQQAppInterface.getManager(61);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, RecentItemSubAccount paramRecentItemSubAccount, MsgSummary paramMsgSummary)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject5 = (ayav)paramQQAppInterface.getManager(61);
      ...
      return;
      localArrayList = ((ayav)localObject5).b();
      ...
      paramMsgSummary.strContent = paramContext.getString(2131719880);
    } while (!QLog.isColorLevel());
    ...
    int j = a(paramQQAppInterface, localakpc);
    label281:
    Object localObject3;
    if ((i < l) || (j > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject3 != null) && (!TextUtils.isEmpty(((SubAccountInfo)localObject3).subuin)) && (((ayav)localObject5).a(((SubAccountInfo)localObject3).subuin) == 1))
        {
          List localList = ((ayav)localObject5).a(((SubAccountInfo)localObject3).subuin);
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (localObject2 != null))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject3))
        {
          ...
          paramRecentItemSubAccount.mMsgExtroInfo = ("[" + paramContext.getString(2131717474) + "]");
          paramMsgSummary.strContent = ((CharSequence)localObject5);
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
          ...
          paramRecentItemSubAccount.mUnreadNum = j;
          ...
          {
            paramRecentItemSubAccount.mMsgExtroInfo = ((CharSequence)localObject5);
          }
          else
          {
            paramMsgSummary.strContent = ((CharSequence)localObject5);
      ...
      if ((j > 0) && (localakpc != null))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            i = localakpc.a(((SubAccountInfo)localObject2).subuin, 7000);
            if (i > 0)
            {
      ...
      localObject2 = ((ayav)localObject5).a();
      ...
      for (;;)
      {
        ...
        if (i > 0)
        {
          paramMsgSummary.strContent = paramContext.getString(2131719825, new Object[] { String.valueOf(i) });
          if (QLog.isColorLevel()) {
            QLog.d("SUB_ACCOUNT", 2, "setRecentItemSubAccountDescription() unread third account size=" + i);
          }
          paramRecentItemSubAccount.mUnreadNum = j;
          paramRecentItemSubAccount.mUnreadFlag = 3;
          return;
        }
        paramMsgSummary.strContent = paramContext.getString(2131719819);
        return;
        k = i;
        i = j;
        j = k;
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
    ...
    localObject1 = paramBaseActivity.getString(2131719885);
    Object localObject2 = paramBaseActivity.getString(2131719847, new Object[] { Integer.valueOf(2) });
    localObject1 = bbcv.a(paramBaseActivity, 230).setTitle((String)localObject1).setMessage((CharSequence)localObject2);
    ((bbgg)localObject1).setOwnerActivity(paramBaseActivity);
    ((bbgg)localObject1).setPositiveButton(paramBaseActivity.getString(2131719867), new ayar(paramQQAppInterface, paramBaseActivity));
      ...
      if (paramString != null)
      {
        ...
        while (paramString.hasNext())
        {
          ...
          if (!"sub.uin.all".equals(localObject))
          {
            ...
            if (paramQQAppInterface != null)
            {
              localObject = (ayav)paramQQAppInterface.getManager(61);
              if (localObject != null)
              {
                ((ayav)localObject).a(paramString);
                ((ayav)localObject).c(paramString);
                if (bbcl.c(paramQQAppInterface, paramString, false) != null) {
                  break;
                }
              }
            }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((!ajsf.x.equals(paramString)) && ((paramString == null) || (paramString.length() < 5))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      return;
      aktg localaktg = paramQQAppInterface.a().a();
      if ((localaktg.b(ajsf.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      a(paramQQAppInterface, localaktg, paramString, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localayao = (ayao)paramQQAppInterface.getManager(62);
    } while (localayao == null);
    ...
    for (;;)
    {
      try
      {
        paramString2 = localayao.a(paramString1);
        ...
        if (paramString2 != null) {
          ...
          localayao.jdField_c_of_type_JavaUtilArrayList.add(new ayas(paramString1, localArrayList));
        }
      }
      finally
      {
    ...
    localayao.a(paramString1 + "_sysTime", Integer.valueOf(paramInt1));
    localayao.jdField_a_of_type_Long = paramInt2;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    do
    {
      do
      {
        ...
        paramString1 = (ayao)paramQQAppInterface.getManager(62);
      } while (paramString1 == null);
      paramQQAppInterface = paramQQAppInterface.c() + "_" + paramString2;
      paramString2 = bbmj.a(paramArrayOfByte);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (ajsf.x.equals(paramString)) {
      if (paramBoolean) {
        a(paramQQAppInterface, paramQQAppInterface.a().a(), ajsf.x, 7);
      }
    }
    for (;;)
    {
      ...
      paramQQAppInterface.sendEmptyMessage(1009);
      return;
      ((ayav)paramQQAppInterface.getManager(61)).a(paramString, paramBoolean);
      aktg localaktg = paramQQAppInterface.a().a();
      if (paramBoolean) {
        a(paramQQAppInterface, localaktg, paramString, 4);
      } else {
        a(paramQQAppInterface, localaktg, paramString, 5);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((((aktg)localObject).b(ajsf.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      ...
      while (paramArrayList.hasNext())
      {
        ...
        a(paramQQAppInterface, (aktg)localObject, str, paramInt);
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    localayao.a(paramQQAppInterface.c() + "_display_third_qq_checked", String.valueOf(paramBoolean));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localayav != null) && (paramQQAppInterface != null))
      {
        Iterator localIterator = localayav.a().iterator();
        while (localIterator.hasNext())
        {
          String str = (String)localIterator.next();
          if (!TextUtils.isEmpty(str))
          {
            int i = localayav.c(str);
            localayav.b(str);
            if ((paramBoolean) || (i > 0))
            {
              if (QLog.isColorLevel()) {
              ...
              akqt localakqt = paramQQAppInterface.a();
              if (localakqt != null) {
                localakqt.a(str, paramString);
              }
            }
          }
        }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    ayao localayao = (ayao)paramQQAppInterface.getManager(62);
    if (localayao != null) {
      return localayao.a(paramQQAppInterface.c() + "_all_third_last_msg_time", Integer.valueOf(paramInt));
    }
    return false;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      localObject = ((ayav)localObject).a();
      label45:
      paramQQAppInterface = (ayao)paramQQAppInterface.getManager(62);
      bool1 = bool2;
      if (paramQQAppInterface != null) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    label381:
    for (Object localObject = ((ayav)localObject).a(paramString);; localObject = null)
    {
      ayat localayat = (ayat)paramQQAppInterface.getManager(28);
      if (localayat != null)
      {
        paramBoolean = localayat.a();
        if (!paramBoolean)
        {
          localObject = new ayaw();
          ((ayaw)localObject).jdField_a_of_type_JavaLangString = "";
          ((ayaw)localObject).b = paramQQAppInterface.getAccount();
          ((ayaw)localObject).c = paramString;
          ((ayaw)localObject).jdField_a_of_type_Int = 1009;
      ...
      if ((paramString == null) || (paramString.length() == 0) || (localObject == null) || (((String)localObject).length() == 0) || (((String)localObject).trim().equals("")))
      {
        ...
        ((ayaw)localObject).b = paramQQAppInterface.getAccount();
        ((ayaw)localObject).c = paramString;
        ((ayaw)localObject).jdField_a_of_type_Int = 1010;
        paramQQAppInterface.a().notifyUI(8003, false, localObject);
        return false;
      }
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (localayao != null)
    {
      if (!localayao.jdField_b_of_type_Boolean) {
        return false;
      }
      if (BaseActivity.mAppForground)
      {
        bool = localayao.d(paramQQAppInterface, paramBoolean);
        paramBoolean = bool;
        if (bool) {
          localayao.d(paramQQAppInterface);
        }
      }
      for (paramBoolean = bool;; paramBoolean = bool)
      {
        if ((!paramBoolean) && (localayao.jdField_b_of_type_JavaLangRunnable != null)) {
          ThreadManager.getSubThreadHandler().removeCallbacks(localayao.jdField_b_of_type_JavaLangRunnable);
        }
        return paramBoolean;
        localayao.jdField_a_of_type_Boolean = true;
      }
    }
    return false;
  }
  ...
  private boolean a(String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject == null)
        {
          this.jdField_c_of_type_JavaUtilArrayList.add(new ayas(paramString, paramObject));
          bool1 = true;
          this.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          bool2 = bool1;
          if (!bool1) {
        ...
        if (((paramObject instanceof Integer)) && ((((ayas)localObject).jdField_a_of_type_JavaLangObject instanceof Integer)))
        {
          if ((Integer)((ayas)localObject).jdField_a_of_type_JavaLangObject == (Integer)paramObject) {
            break label346;
          }
          bool2 = true;
          bool1 = bool2;
          ...
          ((ayas)localObject).jdField_a_of_type_JavaLangObject = paramObject;
          bool1 = bool2;
          continue;
        }
      ...
      if ((((ayas)localObject).jdField_a_of_type_JavaLangObject instanceof String))
      {
        bool1 = TextUtils.equals((String)((ayas)localObject).jdField_a_of_type_JavaLangObject, (String)paramObject);
        if (!bool1)
        {
          bool2 = true;
          continue;
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localayao != null)
    {
      paramQQAppInterface = localayao.a(paramQQAppInterface.c() + "_" + paramString + "_cookie");
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        return bbmj.a(paramQQAppInterface);
      }
    }
    return null;
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      paramString = (ayao)paramQQAppInterface.getManager(62);
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject1 = (ayao)paramQQAppInterface.getManager(62);
        if (localObject1 == null) {
          break label110;
        }
        l1 = System.currentTimeMillis();
        l2 = (l1 - ((ayao)localObject1).jdField_b_of_type_Long) / 1000L;
        if (l2 >= ((ayao)localObject1).jdField_a_of_type_Long) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("SUB_ACCOUNT", 2, "getSubAccountSpecialCareListFromService skip adviseGap=" + ((ayao)localObject1).jdField_a_of_type_Long + "  realGap=" + l2);
      return;
      ((ayao)localObject1).jdField_b_of_type_Long = l1;
      localObject1 = (ayav)paramQQAppInterface.getManager(61);
    } while (localObject1 == null);
    Object localObject2 = new ArrayList();
    if (paramBoolean) {
      ((List)localObject2).addAll(((ayav)localObject1).b());
    }
    for (;;)
    {
      ...
      break;
      ((List)localObject2).add(((ayav)localObject1).a(paramString));
    }
  }
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramString = localaktg.b(paramString, 7000);
        if (paramString != null)
        {
      ...
      } while (((ayav)paramQQAppInterface.getManager(61)).a() != 0);
      a(paramQQAppInterface, localaktg, ajsf.x, 7);
    } while (!QLog.isColorLevel());
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1 = (ayav)paramQQAppInterface.getManager(61);
    ayao localayao = (ayao)paramQQAppInterface.getManager(62);
    if ((localObject1 == null) || (localayao == null)) {
      return false;
    }
    localObject1 = ((ayav)localObject1).a();
    Object localObject2 = new ArrayList();
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localObject3 != null) && (!TextUtils.isEmpty(((SimpleAccount)localObject3).getUin())) && (!((SimpleAccount)localObject3).getUin().equals(paramQQAppInterface)) && (!((List)localObject1).contains(((SimpleAccount)localObject3).getUin())))
      {
        ...
        String str = localayao.a((String)localObject3 + "_last_cookie");
        if (!TextUtils.isEmpty(str)) {
          localayao.a((String)localObject3 + "_cookie", str);
        }
        localayao.a((String)localObject3 + "_msgNum", Integer.valueOf(0));
        localayao.a((String)localObject3 + "_msgFlag", Integer.valueOf(0));
        localayao.a((String)localObject3 + "_redBagTime", Integer.valueOf(0));
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    ...
    ayao localayao = (ayao)paramQQAppInterface.getManager(62);
    return (localayao == null) || (!TextUtils.equals(localayao.a(paramQQAppInterface.c() + "_display_third_qq_checked"), String.valueOf(false)));
  }
  ...
  private boolean d(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject3 = (ayav)paramQQAppInterface.getManager(61);
    if ((((List)localObject2).size() >= 1) && (localObject3 != null))
    {
      localObject1 = new ArrayList();
      String str = paramQQAppInterface.c();
      localObject3 = ((ayav)localObject3).a();
      localObject2 = ((List)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
  ...
  public ArrayList<Pair<String, Integer>> a(String paramString)
  {
    ...
    //   6: ldc 122
    //   8: iconst_2
    //   9: new 124	java/lang/StringBuilder
    //   12: dup
    //   13: invokespecial 125	java/lang/StringBuilder:<init>	()V
    //   16: ldc_w 1183
    //   19: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   22: aload_1
    //   23: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   26: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   29: invokestatic 141	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   32: new 54	java/util/ArrayList
    //   35: dup
    //   36: invokespecial 55	java/util/ArrayList:<init>	()V
    //   39: astore_3
    //   40: aload_1
    //   41: ifnonnull +5 -> 46
    //   44: aload_3
    //   45: areturn
    //   46: aload_0
    //   47: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   50: invokeinterface 256 1 0
    //   55: aload_0
    //   56: getfield 1020	ayao:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   59: ifnull +29 -> 88
    //   62: ldc_w 912
    //   65: aload_1
    //   66: invokevirtual 369	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   69: ifeq +30 -> 99
    //   72: aload_3
    //   73: aload_0
    //   74: getfield 1020	ayao:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   77: invokevirtual 432	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   80: pop
    //   81: aload_0
    //   82: getfield 1020	ayao:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 71	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   92: invokeinterface 271 1 0
    //   97: aload_3
    //   98: areturn
    //   99: aload_0
    //   100: getfield 1020	ayao:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   103: invokevirtual 292	java/util/ArrayList:size	()I
    //   106: iconst_1
    //   107: isub
    //   108: istore_2
    //   109: iload_2
    //   110: iflt -22 -> 88
    //   113: aload_0
    //   114: getfield 1020	ayao:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   117: iload_2
    //   118: invokevirtual 296	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   121: checkcast 315	com/tencent/util/Pair
    //   124: astore 4
    //   126: aload_1
    //   127: aload 4
    //   129: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   132: invokevirtual 369	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   135: ifeq +19 -> 154
    //   138: aload_3
    //   139: aload 4
    //   141: invokevirtual 289	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   144: pop
    //   145: aload_0
    //   146: getfield 1020	ayao:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   149: iload_2
    //   150: invokevirtual 1027	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   153: pop
    //   154: iload_2
    //   155: iconst_1
    //   156: isub
    ...
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   166: invokeinterface 271 1 0
    //   171: aload_1
    //   172: athrow
  ...
  public void a(SubAccountBaseActivity paramSubAccountBaseActivity)
  {
    ...
    while (i >= 0)
    {
      localObject = (bbgg)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if ((localObject == null) || (((bbgg)localObject).getOwnerActivity() != paramSubAccountBaseActivity) || (((bbgg)localObject).isShowing())) {}
      try
      {
        ((bbgg)localObject).dismiss();
        label116:
  ...
  public void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, Pair<String, Integer> paramPair, android.content.DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    //   116: invokestatic 141	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   119: aload_1
    //   120: ifnull +16 -> 136
    //   123: aload_2
    //   124: ifnull +12 -> 136
    ...
    //   140: dup
    //   141: invokespecial 125	java/lang/StringBuilder:<init>	()V
    //   144: aload_3
    //   145: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   148: checkcast 348	java/lang/String
    ...
    //   160: aload_3
    //   161: getfield 567	com/tencent/util/Pair:second	Ljava/lang/Object;
    //   164: invokevirtual 220	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   167: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   170: astore 8
    //   172: goto -142 -> 30
    //   175: aload_2
    //   176: invokevirtual 861	java/lang/Object:getClass	()Ljava/lang/Class;
    //   179: invokevirtual 866	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   182: astore 8
    //   184: goto -130 -> 54
    //   187: ldc_w 1212
    //   190: astore 8
    ...
    //   200: goto -97 -> 103
    //   203: aload_3
    //   204: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   207: checkcast 348	java/lang/String
    //   210: astore 8
    //   212: aload_3
    //   213: getfield 567	com/tencent/util/Pair:second	Ljava/lang/Object;
    //   216: checkcast 213	java/lang/Integer
    //   219: invokevirtual 268	java/lang/Integer:intValue	()I
    //   222: istore 6
    //   224: aload_0
    //   225: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   228: invokeinterface 256 1 0
    //   233: aload_0
    //   234: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   237: ifnull +141 -> 378
    //   240: aload_0
    //   241: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   244: invokevirtual 292	java/util/ArrayList:size	()I
    //   247: iconst_1
    //   248: isub
    //   249: istore 5
    //   251: iload 5
    //   253: iflt +125 -> 378
    //   256: aload_0
    //   257: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   260: iload 5
    //   262: invokevirtual 296	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   265: checkcast 879	bbgg
    //   268: astore 10
    //   270: aload 10
    //   272: ifnull +298 -> 570
    //   275: aload 10
    //   277: invokevirtual 1215	bbgg:getTag	()Ljava/lang/Object;
    //   280: instanceof 315
    //   283: ifeq +287 -> 570
    //   286: aload 10
    //   288: invokevirtual 1215	bbgg:getTag	()Ljava/lang/Object;
    //   291: checkcast 315	com/tencent/util/Pair
    //   294: astore 9
    //   296: aload 8
    //   298: aload 9
    //   300: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   303: invokevirtual 369	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   306: ifeq +264 -> 570
    //   309: aload 10
    //   311: invokevirtual 1196	bbgg:isShowing	()Z
    //   314: istore 7
    //   316: iload 7
    //   318: ifeq +8 -> 326
    //   321: aload 10
    //   323: invokevirtual 1199	bbgg:dismiss	()V
    //   326: aload_0
    //   327: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   330: iload 5
    //   332: invokevirtual 1027	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   335: pop
    ...
    //   358: aload 9
    //   360: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   363: checkcast 348	java/lang/String
    //   366: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   369: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   372: invokestatic 141	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   375: goto +195 -> 570
    //   378: aload_2
    //   379: ldc_w 867
    //   382: invokevirtual 870	com/tencent/mobileqq/app/BaseActivity:getString	(I)Ljava/lang/String;
    //   385: astore 10
    //   387: aload_1
    //   388: aload 8
    //   390: iconst_0
    //   391: invokestatic 922	bbcl:c	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Z)Ljava/lang/String;
    //   394: astore 9
    //   396: aload 9
    //   398: ifnull +181 -> 579
    //   401: aload 9
    //   403: astore_1
    //   404: aload 9
    //   406: invokevirtual 412	java/lang/String:length	()I
    //   409: ifne +6 -> 415
    //   412: goto +167 -> 579
    //   415: iload 6
    //   417: ifne +117 -> 534
    ...
    //   430: aload_1
    //   431: aastore
    //   432: invokevirtual 872	com/tencent/mobileqq/app/BaseActivity:getString	(I[Ljava/lang/Object;)Ljava/lang/String;
    //   435: astore_1
    //   436: aload_2
    //   437: sipush 230
    //   440: invokestatic 877	bbcv:a	(Landroid/content/Context;I)Lbbgg;
    //   443: aload 10
    //   445: invokevirtual 883	bbgg:setTitle	(Ljava/lang/String;)Lbbgg;
    //   448: aload_1
    //   449: invokevirtual 887	bbgg:setMessage	(Ljava/lang/CharSequence;)Lbbgg;
    //   452: astore_1
    //   453: aload_1
    //   454: aload_3
    //   455: invokevirtual 1221	bbgg:setTag	(Ljava/lang/Object;)V
    //   458: aload_1
    //   459: aload_2
    //   460: invokevirtual 891	bbgg:setOwnerActivity	(Landroid/app/Activity;)V
    //   463: aload_1
    //   464: aload_2
    //   465: ldc_w 892
    //   468: invokevirtual 870	com/tencent/mobileqq/app/BaseActivity:getString	(I)Ljava/lang/String;
    //   471: aload 4
    //   473: invokevirtual 900	bbgg:setPositiveButton	(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lbbgg;
    //   476: pop
    //   477: aload_1
    //   478: new 1223	ayaq
    //   481: dup
    ...
    //   483: aload 8
    //   485: iload 6
    //   487: invokespecial 1226	ayaq:<init>	(Layao;Ljava/lang/String;I)V
    //   490: invokevirtual 1230	bbgg:setOnCancelListener	(Landroid/content/DialogInterface$OnCancelListener;)V
    //   493: aload_1
    //   494: invokevirtual 907	bbgg:show	()V
    //   497: aload_0
    //   498: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   501: ifnonnull +14 -> 515
    //   504: aload_0
    //   505: new 54	java/util/ArrayList
    //   508: dup
    //   509: invokespecial 55	java/util/ArrayList:<init>	()V
    //   512: putfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   515: aload_0
    //   516: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   519: aload_1
    //   520: invokevirtual 289	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   523: pop
    //   524: aload_0
    //   525: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   528: invokeinterface 271 1 0
    //   533: return
    //   534: aload_2
    //   535: ldc_w 1231
    //   538: iconst_1
    ...
    //   544: aload_1
    //   545: aastore
    //   546: invokevirtual 872	com/tencent/mobileqq/app/BaseActivity:getString	(I[Ljava/lang/Object;)Ljava/lang/String;
    //   549: astore_1
    //   550: goto -114 -> 436
    //   553: astore_1
    //   554: aload_0
    //   555: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   558: invokeinterface 271 1 0
    //   563: aload_1
    //   564: athrow
    //   565: astore 10
    //   567: goto -241 -> 326
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   23: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   26: ldc_w 548
    //   29: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   32: iload_2
    //   33: invokevirtual 169	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   36: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   39: invokestatic 141	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   42: aload_1
    //   43: ifnull +11 -> 54
    //   46: aload_1
    //   47: invokevirtual 412	java/lang/String:length	()I
    //   50: iconst_5
    //   51: if_icmpge +4 -> 55
    //   54: return
    //   55: aload_0
    //   56: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   59: invokeinterface 256 1 0
    //   64: aload_0
    //   65: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: ifnull +253 -> 321
    //   71: aload_0
    //   72: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   75: invokevirtual 292	java/util/ArrayList:size	()I
    //   78: iconst_1
    //   79: isub
    //   80: istore 5
    //   82: iload 5
    //   84: iflt +237 -> 321
    //   87: aload_0
    //   88: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: iload 5
    //   93: invokevirtual 296	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   96: checkcast 879	bbgg
    //   99: astore 7
    //   101: aload 7
    //   103: ifnull +162 -> 265
    //   106: aload 7
    //   108: invokevirtual 1215	bbgg:getTag	()Ljava/lang/Object;
    //   111: astore 8
    //   113: aload 8
    //   115: ifnull +193 -> 308
    //   118: aload 8
    ...
    //   123: ifeq +185 -> 308
    //   126: aload 8
    //   128: checkcast 315	com/tencent/util/Pair
    //   131: astore 8
    //   133: iload_3
    //   134: ifeq +156 -> 290
    //   137: aload_1
    //   138: aload 8
    //   140: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   143: invokevirtual 369	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   146: ifeq +190 -> 336
    //   149: iload_2
    //   150: aload 8
    //   152: getfield 567	com/tencent/util/Pair:second	Ljava/lang/Object;
    //   155: checkcast 213	java/lang/Integer
    //   158: invokevirtual 268	java/lang/Integer:intValue	()I
    ...
    //   169: ifeq +173 -> 342
    //   172: aload 7
    //   174: invokevirtual 1196	bbgg:isShowing	()Z
    //   177: istore 6
    //   179: iload 6
    //   181: ifeq +8 -> 189
    //   184: aload 7
    //   186: invokevirtual 1199	bbgg:dismiss	()V
    //   189: aload_0
    //   190: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   193: iload 5
    //   195: invokevirtual 1027	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   198: pop
    //   199: invokestatic 120	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   202: ifeq +140 -> 342
    //   205: ldc 122
    //   207: iconst_2
    ...
    //   221: aload 8
    //   223: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   226: checkcast 348	java/lang/String
    //   229: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   232: ldc_w 548
    //   235: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   238: aload 8
    //   240: getfield 567	com/tencent/util/Pair:second	Ljava/lang/Object;
    //   243: invokevirtual 220	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   246: ldc_w 1239
    //   249: invokevirtual 131	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   252: iload_3
    //   253: invokevirtual 311	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   256: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   259: invokestatic 141	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   262: goto +80 -> 342
    //   265: aload_0
    //   266: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   269: iload 5
    //   271: invokevirtual 1027	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   274: pop
    //   275: goto +67 -> 342
    //   278: astore_1
    //   279: aload_0
    //   280: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   283: invokeinterface 271 1 0
    //   288: aload_1
    //   289: athrow
    //   290: aload_1
    //   291: aload 8
    //   293: getfield 1023	com/tencent/util/Pair:first	Ljava/lang/Object;
    //   296: invokevirtual 369	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   299: ifeq +37 -> 336
    //   302: iconst_1
    //   303: istore 4
    //   305: goto -138 -> 167
    //   308: aload_0
    //   309: getfield 1189	ayao:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   312: iload 5
    //   314: invokevirtual 1027	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   317: pop
    //   318: goto +24 -> 342
    //   321: aload_0
    //   322: getfield 38	ayao:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   325: invokeinterface 271 1 0
    //   330: return
    //   331: astore 7
    //   333: goto -144 -> 189
    //   336: iconst_0
  ...
  public void d(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (this.jdField_b_of_type_JavaLangRunnable == null) {
        this.jdField_b_of_type_JavaLangRunnable = new SubAccountControll.5(this, paramQQAppInterface);
      }
  ...
  public void onDestroy()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          bbgg localbbgg = (bbgg)localIterator.next();
          try
          {
            if (localbbgg.isShowing()) {
              localbbgg.dismiss();
            }
          }
          catch (Exception localException) {}
