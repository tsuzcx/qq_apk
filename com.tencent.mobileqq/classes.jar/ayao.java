  ...
  extends ayap
{
  ...
  public ayao(Context paramContext, AppInterface paramAppInterface, View paramView, String paramString)
  {
  ...
  protected void a()
  {
    this.h = aekt.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    super.a();
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166369);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(1, 12.0F);
    this.jdField_a_of_type_AndroidWidgetTextView.setGravity(17);
    int i = aekt.a(36.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.setYOffset(i + aekt.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    i = (int)(azgq.jdField_a_of_type_Int * 0.11F);
    ...
    ((ViewGroup.MarginLayoutParams)localObject).bottomMargin = aekt.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((ViewGroup.MarginLayoutParams)localObject).topMargin = aekt.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
