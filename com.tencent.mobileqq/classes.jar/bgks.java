...
public final class bgks
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = anhk.ba + "avatarPendantIcons";
  ...
  public static String a(File paramFile)
  {
    ...
    try
    {
      paramFile = new String(bgmg.a(paramFile));
  ...
  {
    return anhk.bT + "font_info/" + paramString + File.separator + paramString + ".ttf";
  }
  
  public static void a()
  {
    File localFile = new File(anhk.ba + "avatarPendantDefaultHead");
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    localFile = new File(anhk.bT);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, aval paramaval)
  {
    if ((paramContext == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramQQAppInterface.a(-1, new bgkt(paramaval));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean, ProfileActivity.AllInOne paramAllInOne)
  {
    ...
    if (paramAllInOne != null)
    {
      ...
      if ((i == 1) || (i == 0))
      {
        ...
        localbaif = (baif)paramQQAppInterface.getManager(36);
        localbaif.b("100005.100006");
    ...
    for (;;)
    {
      ...
      if (paramAllInOne == null)
      {
        ...
        localIntent.putExtra("url", bgyg.a(paramContext, "pendant", ""));
      ...
      for (i = 40202;; i = 40201)
      {
        ...
        bcst.b(paramQQAppInterface, "CliOper", "", "", "PendantMarket", "OtherEntrance", 0, 0, "", "", "", "");
        return;
  ...
  public static String b(long paramLong, int paramInt)
  {
    ...
    localStringBuilder.append(anhk.bT).append(paramLong).append(File.separator);
    switch (paramInt)
    {
    }
    for (;;)
  ...
  {
    return anhk.bT + "font_info/" + paramString + "/";
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    return new File(anhk.bT + "sticker_info", paramString).exists();
  }
  ...
  public static String c(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      return arpm.a("VIP_avatar", localStringBuilder.toString());
      localStringBuilder.append("aio_50.png");
      continue;
      localStringBuilder.append("aio_file.zip");
      continue;
  ...
  {
    return anhk.bT + "sticker_info/" + paramString + ".png";
  }
}
