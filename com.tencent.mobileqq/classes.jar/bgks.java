...
class bgks
  extends nte
{
  bgks(bgko parambgko, bgkn parambgkn, String paramString1, String paramString2) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bgkn == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0x6b5. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bgkn);
      }
    ...
    try
    {
      ...
      if ((paramInt == 0) && (localRspBody.msg_grab_result.has()))
      {
        ...
        paramBundle = (TroopGiftBagInfo)this.jdField_a_of_type_Bgko.a.get(paramBundle);
        if (paramBundle != null)
        {
          paramBundle.myGrabResult = new bfjv(paramArrayOfByte.uint64_uin.get(), paramArrayOfByte.uint64_time.get(), paramArrayOfByte.int32_amount.get(), paramArrayOfByte.int32_index.get(), paramArrayOfByte.bytes_tips.get().toStringUtf8());
          this.jdField_a_of_type_Bgko.a(paramBundle);
        }
        this.jdField_a_of_type_Bgkn.a(paramArrayOfByte.uint64_uin.get(), paramArrayOfByte.uint64_time.get(), paramArrayOfByte.int32_amount.get(), paramArrayOfByte.int32_index.get(), paramArrayOfByte.bytes_tips.get().toStringUtf8());
        return;
      }
    }
