...
public class azfy
{
  ...
  public CharSequence a(aqzp paramaqzp)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    Object localObject = paramaqzp.a().jdField_a_of_type_JavaUtilArrayList;
    localSpannableStringBuilder.append(paramaqzp.a().jdField_a_of_type_JavaLangString);
    int i = 0;
    while (i < ((ArrayList)localObject).size()) {
      if (TextUtils.isEmpty(((aqzr)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        ...
        paramaqzp = ((aqzr)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString;
        localObject = new ForegroundColorSpan(Color.parseColor("#4D94FF"));
        localSpannableStringBuilder.append(paramaqzp);
        localSpannableStringBuilder.setSpan(localObject, j, paramaqzp.length() + j, 33);
      }
    }
  ...
  {
    long l = aqlk.a().a(529, paramQQAppInterface.getCurrentAccountUin());
  ...
  {
    boolean bool = false;
    if (aqlk.a().a(529, paramQQAppInterface.getCurrentAccountUin()) > paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).getLong("recommend_topic_version", -1L)) {
      bool = true;
    }
    return bool;
  }
