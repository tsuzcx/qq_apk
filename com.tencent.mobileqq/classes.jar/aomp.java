...
public class aomp
{
  ...
  public aomp(QQAppInterface paramQQAppInterface)
  {
  ...
  private String a(String paramString1, String paramString2, int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      localPair = bgtw.a(paramString2, paramInt, paramBoolean);
      localFile = new File(bgtw.b(), Long.toString(((Long)localPair.second).longValue()));
    ...
    paramString1 = new aomy(this, paramString1, paramInt, paramObject);
    bguw.a().a((String)((Pair)localPair.first).first, paramString2, (String)((Pair)localPair.first).second, paramString1);
    return null;
  }
  
  private void a(WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq paramAioPicAndVideoCopyToWeiyunMsgReq, aonc paramaonc)
  {
    bgtg.a();
    bguo.a(paramAioPicAndVideoCopyToWeiyunMsgReq, new aomx(this, paramaonc));
  }
  
  private void b()
  {
    if (!bgwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
    {
      if (NetworkUtils.isWifiAvailable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
      {
        this.c = true;
        bgwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), new aomz(this));
      }
      return;
    }
    this.b = true;
    bgti.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), true);
    WeiyunTransmissionGlobal.getInstance().getUploadManager().loadLibFromPath(bgwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()).getAbsolutePath());
  }
  
  public aonh a(FileManagerEntity paramFileManagerEntity, Object paramObject, bgvj parambgvj)
  {
    ...
    do
    {
      ...
      localPair = aofe.a(paramFileManagerEntity.WeiYunFileId);
      if (localPair != null) {
        break;
      }
    ...
    if (paramFileManagerEntity.nWeiYunSrcType == 2) {
      paramFileManagerEntity = bguw.a().a(paramFileManagerEntity.strLargeThumPath, paramFileManagerEntity.strThumbPath, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.WeiYunFileId, parambgvj);
    }
    label285:
    for (;;)
    {
      return new aonh(paramFileManagerEntity, paramObject, false, null, parambgvj);
      paramFileManagerEntity = bgti.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.strFileSHA, paramFileManagerEntity.fileSize, 0, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.strLargeThumPath);
      if (paramFileManagerEntity == null) {}
      for (paramFileManagerEntity = null;; paramFileManagerEntity = bguw.a().a(paramFileManagerEntity, bgtw.a(), true, parambgvj))
      {
  ...
  public aonh a(String paramString, Object paramObject, UploadManager.IUploadStatusListener paramIUploadStatusListener)
  {
    if ((!this.b) && (!this.c)) {
      b();
    }
    ...
    paramString = bgti.b(paramString, UploadFile.createUploadBatch(1, null), 1);
    if (paramString == null) {}
    ...
    label134:
    return new aonh(paramString, paramObject, true, paramIUploadStatusListener, null);
  }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    localFileManagerEntity.peerNick = apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, null, paramFileManagerEntity.peerType);
    ...
    for (localFileManagerEntity.selfUin = paramFileManagerEntity.peerUin;; localFileManagerEntity.selfUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity FileManagerEntity:" + apck.a(localFileManagerEntity));
      }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity : entity is null, peerUin[" + apck.e(paramString2) + "], peerType[" + paramInt + "]");
      }
      return null;
    }
    FileManagerEntity localFileManagerEntity = new FileManagerEntity();
    ...
    localFileManagerEntity.peerNick = apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, null, paramInt);
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString2, paramFileManagerEntity, true, localFileManagerEntity.fileName, localFileManagerEntity.fileSize, true, paramInt, str, localFileManagerEntity.msgSeq, localFileManagerEntity.msgSeq, null, 2, l, localFileManagerEntity.msgUid, -1L, awao.a());
      if (QLog.isColorLevel()) {
        QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity peerType[" + paramInt + "],FileManagerEntity:" + apck.a(localFileManagerEntity));
      }
      return localFileManagerEntity;
      if (paramInt == 1006)
      {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bguo.a(localCrossBidProxyOfflineFileGetListMsgReq, new aomu(this, paramInt1));
  }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      bguo.a(localLibInfoListGetMsgReq, new aomq(this, paramString1));
      return;
      if (this.jdField_a_of_type_JavaUtilLinkedHashMap != null) {
        break label165;
      }
  ...
  public void a(ChatMessage paramChatMessage, aonc paramaonc)
  {
    ...
    for (;;)
    {
      ...
      a(localAioPicAndVideoCopyToWeiyunMsgReq, paramaonc);
      return;
  ...
  public void a(FileManagerEntity paramFileManagerEntity, int paramInt, boolean paramBoolean)
  {
    if (paramFileManagerEntity == null)
    {
      ...
      apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0L, "actFileWy2Of", 0L, "", "", "", "", 9006L, "entity is null", 0L, 0L, 0L, "", "", 0, "", null);
      apck.a();
      return;
    }
    ...
    if (!badq.d(BaseApplication.getContext()))
    {
      ...
      apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileWy2Of", 0L, "", paramFileManagerEntity.peerUin, "", "", 9004L, "Error_No_Network", 0L, 0L, 0L, "", "", 0, "", null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramFileManagerEntity);
      return;
    }
    QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "=_= ^ [CS Send]sendWyFile2QqOffline, peerUin[" + apck.e(paramFileManagerEntity.peerUin) + "peerType[" + paramInt + "]], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    ...
    try
    {
      ...
      if ((localarip != null) && (localarip.a(paramFileManagerEntity.peerUin)))
      {
        apck.a(ajjy.a(2131651131));
        paramFileManagerEntity.status = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(false, 3, null);
    ...
    if (paramFileManagerEntity.strFileSHA != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_sha.set(bgwl.a(paramFileManagerEntity.strFileSHA));
    }
    if (paramFileManagerEntity.strFileMd5 != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bgwl.a(paramFileManagerEntity.strFileMd5));
    }
    for (;;)
    {
      ...
      if (paramFileManagerEntity.WeiYunDirKey != null) {
        localCrossBidProxyCopyFileToOtherBidMsgReq.src_pdir_key.set(bgwl.a(paramFileManagerEntity.WeiYunDirKey));
      }
      ...
      if (paramFileManagerEntity.tmpSessionType > 0L)
      {
        ...
        paramFileManagerEntity.tmpSessionSig = apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.peerUin, (int)paramFileManagerEntity.tmpSessionType);
      ...
      bguo.a(localCrossBidProxyCopyFileToOtherBidMsgReq, new aomv(this, paramFileManagerEntity, paramInt));
      ...
      break;
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bgwl.a(""));
    }
  }
  
  public void a(FileManagerEntity paramFileManagerEntity, long paramLong, String paramString, boolean paramBoolean1, boolean paramBoolean2, aonc paramaonc)
  {
    if (!badq.d(BaseApplication.getContext()))
    {
      if (paramaonc != null) {
    ...
    do
    {
      ...
      if (paramBoolean2)
      {
        i = 1;
        paramString.set(i);
        i = apck.a(paramFileManagerEntity);
        if (i != 2) {
          break label249;
        }
        ...
        if (!TextUtils.isEmpty(paramFileManagerEntity.WeiYunDirKey)) {
          localWeiyunShareAddFromMobileQQMsgReq.file.pdir_key.set(bgwl.a(paramFileManagerEntity.WeiYunDirKey));
        }
      }
      for (;;)
      {
        for (;;)
        {
          bguo.a(localWeiyunShareAddFromMobileQQMsgReq, new aomr(this, paramaonc));
          return;
          i = 0;
          break label147;
          if (i == 1)
          ...
          try
          {
            paramFileManagerEntity = azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
  ...
  public void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    do
    {
      ...
      localayqd = localTroopFileTransferManager.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.getFilePath(), paramFileManagerEntity.fileSize, 25, i, 8888L);
    } while (localayqd == null);
    int j = apck.a(localayqd.jdField_a_of_type_JavaLangString);
    Object localObject;
    TroopFileTransferManager.Item localItem;
    if ((apdh.a(localayqd.jdField_a_of_type_JavaLangString)) && ((j == 0) || (j == 2))) {
      if (j == 0)
      {
        localObject = new BitmapFactory.Options();
        ((BitmapFactory.Options)localObject).inJustDecodeBounds = true;
        BitmapFactory.decodeFile(localayqd.jdField_a_of_type_JavaLangString, (BitmapFactory.Options)localObject);
        azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localayqd.g, localayqd.c, localayqd.jdField_a_of_type_JavaUtilUUID.toString(), i, Long.toString(localayqd.b), paramFileManagerEntity.nSessionId, ((BitmapFactory.Options)localObject).outWidth, ((BitmapFactory.Options)localObject).outHeight);
        localItem = localTroopFileTransferManager.a(localayqd.jdField_a_of_type_JavaUtilUUID);
        if (localItem != null)
        {
    ...
    for (;;)
    {
      ...
      paramFileManagerEntity.status = 0;
      paramFileManagerEntity.isReaded = false;
      localTroopFileTransferManager.a(localayqd.jdField_a_of_type_JavaUtilUUID, -1, null, ajjy.a(2131651129));
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      if (j == 2)
      {
        localObject = ShortVideoUtils.a(localayqd.jdField_a_of_type_JavaLangString);
        azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localayqd.g, localayqd.c, localayqd.jdField_a_of_type_JavaUtilUUID.toString(), i, Long.toString(localayqd.b), paramFileManagerEntity.nSessionId, localObject[0], localObject[1], localObject[2]);
        localItem = localTroopFileTransferManager.a(localayqd.jdField_a_of_type_JavaUtilUUID);
        if (localItem != null)
        {
          ...
          continue;
          azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramFileManagerEntity.fileName, paramFileManagerEntity.fileSize, localayqd.jdField_a_of_type_JavaUtilUUID.toString(), i, Long.toString(8888L), paramFileManagerEntity.nSessionId);
        }
      }
    }
    label443:
    if (QLog.isColorLevel()) {
      QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "sendWeiYun2Troop, peerUin[" + apck.e(paramFileManagerEntity.peerUin) + "], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    }
    paramFileManagerEntity.fProgress = 0.0F;
    long l2 = 0L;
    try
    {
      ...
      if (paramFileManagerEntity.strFileSHA != null) {
        paramString.file_sha.set(bgwl.a(paramFileManagerEntity.strFileSHA));
      }
      if (paramFileManagerEntity.strFileMd5 != null) {
        paramString.file_md5.set(bgwl.a(paramFileManagerEntity.strFileMd5));
      }
      if (paramFileManagerEntity.WeiYunFileId != null) {
        paramString.src_file_id.set(paramFileManagerEntity.WeiYunFileId);
      }
      if (paramFileManagerEntity.WeiYunDirKey != null) {
        paramString.src_pdir_key.set(bgwl.a(paramFileManagerEntity.WeiYunDirKey));
      }
      ...
      bguo.a(paramString, new aomw(this, localTroopFileTransferManager, localayqd, paramFileManagerEntity));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramFileManagerEntity.nSessionId);
      return;
    }
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    aonm.a(paramWeiYunFileInfo.jdField_a_of_type_JavaLangString, paramWeiYunFileInfo);
    ...
    if (paramWeiYunFileInfo.b != null) {
      ((WeiyunPB.DiskSimpleFileItem)localObject).pdir_key.set(bgwl.a(paramWeiYunFileInfo.b));
    }
    ...
    bguo.a((WeiyunPB.DiskDirFileBatchDeleteExMsgReq)localObject, new aona(this, paramWeiYunFileInfo));
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!badq.d(BaseApplication.getContext()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(false, 45, new Object[] { Integer.valueOf(0), BaseApplication.getContext().getString(2131628946) });
      return;
    }
    ...
    bguo.a(localPwdVerifyMsgReq, new aomt(this));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(false, 278, new Object[] { Integer.valueOf(1810001), ajjy.a(2131651132), "", "", "", "", Integer.valueOf(0) });
      return;
    }
    ...
    localDiskFileDocDownloadAbsMsgReq.pdir_key.set(bgwl.a(paramString2));
    bguo.a(localDiskFileDocDownloadAbsMsgReq, new aonb(this));
  }
  
  public void a(List<MessageForPic> paramList, List<MessageForShortVideo> paramList1, aonc paramaonc)
  {
    WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq localAioPicAndVideoCopyToWeiyunMsgReq = new WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq();
