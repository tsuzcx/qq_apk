...
public class aoqe
{
  static aoqe jdField_a_of_type_Aoqe;
  private bdnd jdField_a_of_type_Bdnd = new aoqf(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  aoqe(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static aoqe a(QQAppInterface paramQQAppInterface)
  {
    jdField_a_of_type_Aoqe = new aoqe(paramQQAppInterface);
    return jdField_a_of_type_Aoqe;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Bdnd);
