...
public class bklx
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new bkly(this);
  
  public bklx(Context paramContext, bkkq parambkkq, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localEditor.commit();
    this.jdField_a_of_type_Bkkq.a(paramString, this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener, true);
    ...
    bkfe.a(1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  public void a()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          if (this.jdField_a_of_type_Bkkq.isPlugininstalled(str)) {
            continue;
          }
          int i = a(str);
          if (i >= 10) {
