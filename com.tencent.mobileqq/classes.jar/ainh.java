...
{
  public ainh(StructMsgItemButton paramStructMsgItemButton) {}
                ...
                catch (JSONException localJSONException)
                {
                  for (;;)
                  {
                    try
                    {
                      ...
                      ((PublicQuickPayManager)localObject2).a(localStructMsgForGeneralShare.message.frienduin, paramView, new aini(this, localStructMsgForGeneralShare, localContext));
                      ...
                      ThreadManager.getSubThreadHandler().postDelayed(new ainj(this, localStructMsgItemButton, localStructMsgForGeneralShare, (QQAppInterface)localObject1, bool), 0L);
                      return;
