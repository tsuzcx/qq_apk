  ...
  implements bcwp
{
  ...
  bcxc jdField_a_of_type_Bcxc;
  FaceInfo jdField_a_of_type_ComTencentMobileqqUtilFaceInfo;
  boolean b;
  boolean c;
  
  protected bcxb(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, byte paramByte, int paramInt3, int paramInt4, boolean paramBoolean1, Drawable paramDrawable1, Drawable paramDrawable2, bcxc parambcxc, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo = new FaceInfo(paramInt1, paramString, false, paramByte, bcxl.a((byte)paramInt3), paramBoolean1, paramInt2, paramBoolean2, paramInt4);
    if ((paramInt1 == 4) && (!bclo.a(paramString))) {
      this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int = 113;
    }
    if ((this instanceof bcyo))
    {
      paramAppInterface = b();
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Bcxc != null) {
        this.jdField_a_of_type_Bcxc.onLoadingStateChanged(-1, this.jdField_a_of_type_Int);
      }
  ...
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString)
  {
  ...
  public static bcxb a(AppInterface paramAppInterface, int paramInt, String paramString)
  {
    int i = a(paramInt);
  ...
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    int i = a(paramInt1);
  ...
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, null);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, int paramInt3)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, null);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, bcxc parambcxc)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, parambcxc, false);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, bcxc parambcxc, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bcxd(paramAppInterface, paramInt1, 200, paramString, (byte)0, paramInt2, 100, false, paramDrawable1, paramDrawable2, parambcxc, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bcyo(paramAppInterface, paramInt1, 200, paramString, (byte)1, paramInt2, false, paramDrawable1, paramDrawable2, parambcxc, paramBoolean);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, bcxc parambcxc)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, parambcxc, false);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, bcxc parambcxc, boolean paramBoolean)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bcxd(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, 100, true, localDrawable, localDrawable, parambcxc, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bcyo(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, true, localDrawable, localDrawable, parambcxc, paramBoolean);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, boolean paramBoolean)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
        QLog.i("Q.qqhead.FaceDrawable", 2, "getFaceDrawable fail, uin=" + paramString + ", idType=" + paramInt1 + ",appIntf=" + paramAppInterface + ",shape=" + paramInt2);
    ...
    do
    {
      ...
      localDrawable = a(32, paramInt2);
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bcxd(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, 100, true, localDrawable, localDrawable, null, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bcyo(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, true, localDrawable, localDrawable, null, paramBoolean);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt, String paramString, boolean paramBoolean)
  {
    return a(paramAppInterface, paramInt, paramString, paramBoolean, false);
  }
  
  public static bcxb a(AppInterface paramAppInterface, int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bcxd(paramAppInterface, 32, paramInt, paramString, (byte)1, 3, 100, paramBoolean1, localDrawable, localDrawable, null, paramBoolean2);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bcyo(paramAppInterface, 32, paramInt, paramString, (byte)1, 3, paramBoolean1, localDrawable, localDrawable, null, paramBoolean2);
  }
  
  public static bcxb a(AppInterface paramAppInterface, String paramString, byte paramByte)
  {
  ...
  public static bcxb b(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, false);
  }
  
  public static bcxb b(AppInterface paramAppInterface, String paramString, byte paramByte)
  {
  ...
  public void a()
  {
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      setCallback(null);
      this.jdField_a_of_type_Bcxc = null;
      a(null);
    }
    super.a();
  }
  ...
  public void a(FaceInfo paramFaceInfo, Bitmap paramBitmap)
  {
    ...
    {
      invalidateSelf();
      if ((i == this.jdField_a_of_type_Int) || (this.jdField_a_of_type_Bcxc == null)) {
        break;
      }
      this.jdField_a_of_type_Bcxc.onLoadingStateChanged(i, this.jdField_a_of_type_Int);
      return;
      i = j;
      if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) {
        break label107;
  ...
  {
    if ((this.jdField_c_of_type_Boolean) && (bhxo.a()))
    {
