...
public class yag
  extends MqqHandler
{
  public yag(ShortVideoPlayActivity paramShortVideoPlayActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          QQToast.a(this.a, 2131437344, 0).a();
          return;
          String str = this.a.getString(2131437345);
          paramMessage = (String)paramMessage.obj;
          QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, 2, str + paramMessage, 0).a();
          ImageUtil.a(this.a, paramMessage);
          return;
          paramMessage = DialogUtil.b(this.a.jdField_a_of_type_AndroidContentContext, 232, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131437372), this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131437373), 2131437374, 2131434570, new yah(this), new yai(this));
