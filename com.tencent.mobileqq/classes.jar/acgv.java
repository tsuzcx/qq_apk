...
public class acgv
  extends akim
{
  public acgv(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        localObject = bbcv.a(this.a, 230);
        ((bbgg)localObject).setTitle(this.a.getString(2131696429));
        ((bbgg)localObject).setMessage(this.a.getString(2131696430));
        ((bbgg)localObject).setNegativeButton(this.a.getString(2131696461), new acgw(this, (bbgg)localObject));
        ((bbgg)localObject).setPositiveButton(this.a.getString(2131719540), new acgx(this, (bbgg)localObject));
    ...
    if (this.a.jdField_a_of_type_Bcpt == null) {
      this.a.jdField_a_of_type_Bcpt = new bcpt(this.a);
    }
    this.a.jdField_a_of_type_Bcpt.b(2, 2131692212, 1500);
  }
  
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if (!bbbd.a(paramString, this.a.jdField_a_of_type_JavaLangString)) {}
    while (paramInt1 != 9) {
      return;
    }
    paramString = this.a;
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131692215));
  ...
  {
    if (!bbbd.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_JavaLangString)) {}
    Object localObject;
    label132:
    label190:
    label320:
    ...
    do
    {
      do
      {
        ...
        case 4: 
          if (paramBoolean)
          {
            ...
            } while ((this.a.jdField_a_of_type_JavaUtilArrayList.contains(localObject)) || (localObject == null) || ("".equals(((String)localObject).trim())) || (bbbd.a(this.a.d, localObject)));
          ...
          paramList = (akhq)this.a.app.a(20);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131717269));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Bcpt.b(2, 2131720439, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_Bcpt.b(2, 2131720434, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
    ...
    for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      this.a.jdField_a_of_type_Acgz.b(paramList);
      return;
      paramInt1 = paramList.size();
      break;
    }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (bbbd.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
      paramString = (TroopManager)this.a.app.getManager(52);
  ...
  protected void b(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    label56:
    while (!bbbd.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString))
    {
      i += 1;
      break label21;
      break;
