...
public class akwi
{
  static akwi jdField_a_of_type_Akwi;
  private ayju jdField_a_of_type_Ayju = new akwj(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  akwi(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    jdField_a_of_type_Akwi = new akwi(paramQQAppInterface);
    return jdField_a_of_type_Akwi;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Ayju);
