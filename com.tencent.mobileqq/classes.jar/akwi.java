  ...
  implements akwv
{
  ...
  private CopyOnWriteArrayList<WeakReference<akwx>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList;
  
  public akwi(akwl paramakwl, akwy paramakwy, akwm paramakwm)
  {
  ...
  private String a()
  {
    ...
    return this.jdField_a_of_type_Akwm.a(localSpriteTaskParam);
  }
  ...
  private String a(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_Akwm.a(paramSpriteTaskParam);
      localObject = str;
  ...
  {
    boolean bool2;
    if ((this.jdField_a_of_type_Akwl == null) || (this.jdField_a_of_type_Akwl.b == null))
    {
      bool2 = false;
      return bool2;
    }
    Object localObject1 = (QQAppInterface)this.jdField_a_of_type_Akwl.b.get();
  ...
  private boolean a(int paramInt1, int paramInt2)
  {
    ...
    return ((akwq)this.jdField_a_of_type_Akwl.a().getManager(249)).a().a(paramInt1, paramInt2) != null;
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        akwx localakwx = (akwx)((WeakReference)localIterator.next()).get();
        if (localakwx != null) {
          localakwx.a(paramInt);
        }
      }
    }
  }
  ...
  public void a(int paramInt, MessageForApollo paramMessageForApollo)
  {
    ...
    if ((paramMessageForApollo == null) || (this.jdField_a_of_type_Akwl == null) || (this.jdField_a_of_type_Akwy == null)) {
      break label48;
    }
    label48:
    while (!akwt.b(this.jdField_a_of_type_Akwl.a(), paramMessageForApollo.istroop, paramMessageForApollo.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
    localSpriteTaskParam.f = ApolloUtil.a(this.jdField_a_of_type_Akwl.a(), paramMessageForApollo);
    localSpriteTaskParam.jdField_c_of_type_Int = ApolloUtil.b(this.jdField_a_of_type_Akwl.a(), paramMessageForApollo);
    ...
    for (;;)
    {
      ...
      akwt.a(this.jdField_a_of_type_Akwl.a(), localSpriteTaskParam);
      return;
  ...
  public void a(akwl paramakwl)
  {
    ...
    if ((this.jdField_a_of_type_Akwm == null) || (paramakwl == null) || (!paramakwl.c())) {
      alda.a(i, 300, 160, new Object[] { "glview is not ready" });
    }
    String str;
    akwc localakwc;
    do
    {
      ...
      while (TextUtils.isEmpty(str))
      {
        alda.a(i, 300, 301, new Object[] { "spriteJs is empty" });
        return;
        str = this.jdField_a_of_type_JavaLangString;
        QLog.d("CmShowStatUtil", 1, "spriteJs from cache");
        this.jdField_a_of_type_JavaLangString = null;
      }
      localakwc = akwt.a(paramakwl.a());
    ...
    ThreadManager.executeOnSubThread(new SpriteBridge.2(this, localakwc, paramakwl));
  }
  
  public void a(akwx paramakwx)
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramakwx));
  }
  ...
  {
    if ((paramChatMessage == null) || (this.jdField_a_of_type_Akwl == null) || (this.jdField_a_of_type_Akwy == null)) {}
    while (!akwt.b(this.jdField_a_of_type_Akwl.a(), paramChatMessage.istroop, paramChatMessage.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
    localSpriteTaskParam.f = paramInt;
    ApolloActionData localApolloActionData = akwt.a(this.jdField_a_of_type_Akwl.a(), paramInt);
  ...
  public void a(ChatMessage paramChatMessage, ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    if ((paramChatMessage == null) || (this.jdField_a_of_type_Akwl == null) || (this.jdField_a_of_type_Akwy == null) || (paramArrayList1 == null) || (paramArrayList1.size() == 0)) {}
    while (!akwt.b(this.jdField_a_of_type_Akwl.a(), paramChatMessage.istroop, paramChatMessage.frienduin)) {
      return;
    }
    SpriteTaskParam localSpriteTaskParam = new SpriteTaskParam();
  ...
  public void a(MessageForApollo paramMessageForApollo)
  {
    ...
    try
    {
      ...
      if (paramMessageForApollo.mApolloMessage.name != null) {
        ((JSONObject)localObject).put("name", akwt.a(bdbi.encodeToString(paramMessageForApollo.mApolloMessage.name, 0)));
      }
      if (paramMessageForApollo.mApolloMessage.text != null) {
        ((JSONObject)localObject).put("atText", akwt.a(bdbi.encodeToString(paramMessageForApollo.mApolloMessage.text, 0)));
      }
      ...
      paramMessageForApollo = akwt.a(this.jdField_a_of_type_Akwl.a());
  ...
  {
    if ((paramList == null) || (paramList.size() == 0) || (this.jdField_a_of_type_Akwm == null) || (this.jdField_a_of_type_Akwl == null) || (!this.jdField_a_of_type_Akwl.c())) {}
    do
    {
      return;
      localObject = ((akwq)this.jdField_a_of_type_Akwl.a().getManager(249)).a();
    } while (localObject == null);
    Object localObject = ((akwp)localObject).a(0);
    if (localObject == null)
    {
    ...
    while (paramList.hasNext())
    {
      ...
      try
      {
        ...
        ((akwd)localObject).a(localSpriteTaskParam.jdField_a_of_type_JavaLangString, false);
      }
    ...
    ((akwd)localObject).a(paramList.toString());
  }
  ...
  public void b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    {
      return;
      if ((paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList != null) && (paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList.size() > 0) && (!this.jdField_a_of_type_Akwl.e()))
      {
      ...
      localObject2 = this.jdField_a_of_type_Akwm.a(paramSpriteTaskParam);
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        paramSpriteTaskParam.jdField_b_of_type_Int = 4;
        return;
      }
      localObject1 = (akwq)this.jdField_a_of_type_Akwl.a().getManager(249);
      localObject3 = ((akwq)localObject1).a();
    } while (localObject3 == null);
    Object localObject3 = ((akwp)localObject3).a(paramSpriteTaskParam.jdField_c_of_type_Int);
    ...
    ((akwd)localObject3).a(localStringBuilder.toString());
    ((akwd)localObject3).a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, false);
    ((akwd)localObject3).a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, false);
    ...
    for (;;)
    {
      albu.a((QQAppInterface)localObject2, paramSpriteTaskParam, bool, paramSpriteTaskParam.jdField_b_of_type_Boolean);
      localObject1 = ((akwq)localObject1).a();
      if ((localObject1 == null) || (akwt.a(this.jdField_a_of_type_Akwl.a()))) {
        break;
      }
      ...
      ((akwh)localObject1).a(paramSpriteTaskParam.jdField_b_of_type_JavaUtilArrayList);
      return;
      bool = false;
    }
    label372:
