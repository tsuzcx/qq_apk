...
public class lzj
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    //   191: aload_0
    //   192: iload_1
    //   193: invokestatic 164	lzj:b	(Landroid/content/Context;I)I
    //   196: istore_2
    //   197: iload_2
    //   198: istore_1
    //   199: aload 5
  ...
  public static void a(long paramLong, Context paramContext, boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (AudioHelper.e()) {
        QLog.w("SmallScreenUtils", 1, "actionOn isFloatWindowOpAllowed, isFloatWindowOpAllowed[" + c(paramContext) + "], isCalling[" + msi.d(paramContext) + "], isHome[" + a(paramContext) + "], isNeedStartDialog[" + paramBoolean1 + "], seq[" + paramLong + "]");
      }
      if (a(paramContext, paramBoolean1, paramString, paramBoolean2)) {
        axqw.b(null, "CliOper", "", "", "0X80057D8", "0X80057D8", 0, 0, "", "", "", "");
      }
      return;
    }
  ...
  public static void a(Context paramContext, lgf paramlgf)
  {
    int i = paramlgf.jdField_d_of_type_Int;
    int j = paramlgf.E;
    int k = paramlgf.jdField_g_of_type_Int;
    if (QLog.isColorLevel())
    {
    ...
    if (paramlgf.jdField_a_of_type_Lgg.jdField_b_of_type_Int > 0) {
      if (paramlgf.jdField_a_of_type_Lgh.a > 0L) {
        paramlgf = "0X8005A49";
      }
    }
    for (;;)
    {
      if ((paramlgf != null) && (c(paramContext))) {
        axqw.b(null, "CliOper", "", "", paramlgf, paramlgf, 0, 0, "", "", "", "");
      }
      return;
      if (paramlgf.jdField_a_of_type_Lgg.jdField_b_of_type_Int == 5)
      {
        paramlgf = "0X8005A48";
      }
      else
  ...
  public static void a(View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramView != null)
    {
      localObject = paramView.getTag(2131372186);
      if (localObject != null) {
        break label190;
      }
      bool = false;
      ...
      localObject = paramView.getTag(2131372187);
      if (localObject != null) {
        break label203;
      }
      bool = false;
    ...
    for (Object localObject = new AlphaAnimation(0.0F, 1.0F);; localObject = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener(new lzk(paramView, paramBoolean1));
      paramView.startAnimation(localAnimationSet);
      paramView.setVisibility(0);
      paramView.setTag(2131372187, Boolean.valueOf(paramBoolean1));
      paramView.setTag(2131372186, Boolean.valueOf(paramBoolean2));
      return;
        ...
        if (paramVideoAppInterface.getApp() != null)
        {
          ...
          if (paramVideoAppInterface.a() != null)
          {
            ...
            if (paramVideoAppInterface.a().a() != null)
            {
              ...
              if ((((lgf)localObject).jdField_d_of_type_Int == 3) || (((lgf)localObject).jdField_d_of_type_Int == 4)) {
                str = String.valueOf(((lgf)localObject).jdField_g_of_type_Long);
              }
              ...
              mtm.a((Intent)localObject, paramLong);
  ...
  public static boolean a(Context paramContext)
  {
    ...
    {
      lcl.e("SmallScreenUtils", paramContext.getMessage());
      return bool2;
    }
    return bool3;
  }
  ...
  public static boolean e(Context paramContext)
  {
    ...
    do
    {
      ...
      bool2 = mqs.a(jdField_b_of_type_ArrayOfJavaLangString, paramContext.getClassName());
      bool1 = bool2;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  public static boolean f()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallzt.jdField_b_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
  ...
  public static boolean g()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallzt.jdField_d_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
