  ...
  extends SmallScreenVideoControlUI
{
  ...
  mxa jdField_a_of_type_Mxa = null;
  boolean jdField_a_of_type_Boolean = false;
  
  public lzj(VideoAppInterface paramVideoAppInterface, SmallScreenService paramSmallScreenService, mcx parammcx)
  {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView != null) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695608);
    }
  ...
  public void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvVideoController.a().j == 1011) && (paramInt != 2131695608) && (paramInt != 2131719928) && (!this.jdField_a_of_type_ComTencentAvVideoController.f)) {}
  ...
  public void a(long paramLong)
  {
    ...
    if ((this.jdField_a_of_type_Mxa != null) && (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null))
    {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.removeObserver(this.jdField_a_of_type_Mxa);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695723);
      return;
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Mxa == null)
    {
      this.jdField_a_of_type_Mxa = new mxa(this);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.addObserver(this.jdField_a_of_type_Mxa);
    }
    if (QLog.isColorLevel()) {
      QLog.w("SmallScreenDoubleVideoControlUI", 1, "onCreate, matchStatus[" + locallfe.a.b + "], seq[" + l + "]");
    }
    if (this.jdField_a_of_type_ComTencentAvVideoController.f) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695607);
    }
    do
    {
      return;
      if ((locallfe.a.b > 0) && (locallfe.a.b != 5))
      {
    ...
    for (;;)
    {
      ...
      if (locallfe.j())
      {
        if ((locallfe.jdField_d_of_type_Int == 0) && (locallfe.e))
        {
          j = i;
          if (locallfe.f != 1) {
            if (locallfe.f != 2) {
      ...
      if (locallfe.j == 1011) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131695624);
      }
