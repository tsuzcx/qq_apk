  ...
  implements bfpt
{
  ...
  public void onItemClick(com.tencent.widget.AdapterView<?> paramAdapterView, android.view.View paramView, int paramInt, long paramLong)
  {
    ...
    //   13: astore_2
    //   14: aload_0
    //   15: getfield 12	agtf:a	Lagta;
    //   18: getfield 42	agta:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   32: if_icmpne +93 -> 125
    //   35: aload_0
    //   36: getfield 12	agtf:a	Lagta;
    //   39: getfield 56	agta:jdField_a_of_type_Agrz	Lagrz;
    //   42: invokevirtual 61	agrz:a	()Z
    //   45: ifeq +41 -> 86
    ...
    //   85: athrow
    //   86: aload_0
    //   87: getfield 12	agtf:a	Lagta;
    //   90: getfield 42	agta:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   99: getfield 78	com/tencent/mobileqq/activity/photo/album/NewPhotoPreviewActivity:a	Lagqs;
    //   102: ifnull -30 -> 72
    //   105: aload_0
    //   106: getfield 12	agtf:a	Lagta;
    //   109: getfield 42	agta:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   118: getfield 78	com/tencent/mobileqq/activity/photo/album/NewPhotoPreviewActivity:a	Lagqs;
    //   121: invokevirtual 83	agqs:f	()V
    //   124: return
    //   125: aload_0
    //   126: getfield 12	agtf:a	Lagta;
    //   129: getfield 86	agta:jdField_a_of_type_Agsp	Lagsp;
    //   132: getfield 91	agsp:a	Z
    //   135: ifeq +20 -> 155
    //   138: aload_0
    //   139: getfield 12	agtf:a	Lagta;
    //   142: getfield 42	agta:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   154: return
    //   155: aload_0
    //   156: getfield 12	agtf:a	Lagta;
    //   159: getfield 42	agta:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
