...
public class avhm
{
  ...
  public static java.lang.Boolean a(String paramString1, String paramString2)
  {
    ...
    //   6: astore 5
    //   8: aload_1
    //   9: invokestatic 13	apdh:a	(Ljava/lang/String;)Z
    //   12: ifeq +8 -> 20
    //   15: aload_1
    //   16: invokestatic 16	apdh:c	(Ljava/lang/String;)Z
    //   19: pop
    ...
    //   59: aload_0
    //   60: aload_1
    //   61: invokevirtual 38	java/io/InputStream:read	([B)I
    //   64: istore_3
    //   65: iload_3
    //   66: iconst_m1
    //   67: if_icmpeq +69 -> 136
    ...
    //   72: iadd
    //   73: istore_2
    //   74: getstatic 44	java/lang/System:out	Ljava/io/PrintStream;
    //   77: iload_2
    //   78: invokevirtual 50	java/io/PrintStream:println	(I)V
    //   81: aload 4
    //   83: aload_1
    //   84: iconst_0
    //   85: iload_3
    //   86: invokevirtual 54	java/io/FileOutputStream:write	([BII)V
    //   89: goto -30 -> 59
    //   92: astore 5
    //   94: aload_0
    //   95: astore_1
    ...
    //   101: iconst_1
    //   102: ldc 58
    //   104: invokestatic 64	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   107: aload_0
    //   108: invokevirtual 68	java/lang/Exception:printStackTrace	()V
    //   111: iconst_0
    //   112: invokestatic 74	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   115: astore_0
    //   116: aload_1
    //   117: ifnull +7 -> 124
    //   120: aload_1
    ...
    //   126: ifnull +8 -> 134
    //   129: aload 4
    //   131: invokevirtual 78	java/io/FileOutputStream:close	()V
    //   134: aload_0
    //   135: areturn
    //   136: aload_0
    //   137: invokevirtual 77	java/io/InputStream:close	()V
    //   140: aload 4
    //   142: invokevirtual 81	java/io/FileOutputStream:flush	()V
    //   145: aload 4
    ...
    //   202: ifnull +7 -> 209
    //   205: aload_1
    //   206: invokevirtual 77	java/io/InputStream:close	()V
    //   209: aload 4
    //   211: ifnull +8 -> 219
    //   214: aload 4
    //   216: invokevirtual 78	java/io/FileOutputStream:close	()V
    //   219: aload_0
    //   220: athrow
    //   221: astore_1
    //   222: goto -3 -> 219
