...
public class bqgs
  extends bqgi
  implements bqgu, bqio, brli, brlj
{
  public float a;
  public long a;
  protected Handler a;
  ...
  public bqgs(@NonNull bqgk parambqgk)
  {
    super(parambqgk);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    yuk.c("Q.qqstory.record.EditVideoPlayer", "updateVideoDrawablePlayerUI width" + paramInt1 + "heightRatio=" + f + "dst_height" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.d + "dst_width=" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.jdField_c_of_type_Int);
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.a(paramInt1, paramInt2, f, false, brkm.a(5.0F));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    yuk.d("Q.qqstory.record.EditVideoPlayer", "pausePreview but the player has not started : " + this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_Int);
  }
  ...
  private void o()
  {
    ...
    yuk.d("Q.qqstory.record.EditVideoPlayer", "restartPreview but the player is not stopping : " + this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_Int);
  }
  ...
  public long a(int paramInt)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        localObject = (bqin)((List)localObject).get(paramInt);
        return ((bqin)localObject).d - ((bqin)localObject).jdField_c_of_type_Long;
      }
    }
    return -1L;
  }
  ...
  public Bitmap a(int paramInt)
  {
    ...
    if (Looper.myLooper() == this.jdField_a_of_type_AndroidOsHandler.getLooper())
    {
      ...
      if ((localObject != null) && (paramInt < ((List)localObject).size())) {}
      for (localObject = (bqin)((List)localObject).get(paramInt); localObject == null; localObject = null) {
        return null;
      }
      return a((bqin)localObject);
    }
  ...
  public Bitmap a(@NonNull bqin parambqin)
  {
    Bitmap localBitmap = null;
    Object localObject = (bqbs)a(bqbs.class);
    int j;
    int i;
    if (localObject != null)
    {
      j = ((bqbs)localObject).a(parambqin.jdField_c_of_type_Int);
      i = ((bqbs)localObject).a(this.jdField_a_of_type_Bqgk.a());
      yuk.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap for %d, playModeNeeded = %d, currentPlayMode = %d", Integer.valueOf(parambqin.jdField_c_of_type_Int), Integer.valueOf(j), Integer.valueOf(i));
    }
    for (;;)
    {
      ...
      if (localObject != null)
      {
        k = ((bqbr)localObject).a();
        arrayOfByte = ((bqbr)localObject).a(parambqin.jdField_c_of_type_Int);
      }
      for (localObject = ((bqbr)localObject).a(this.jdField_a_of_type_Bqgk.a());; localObject = null)
      {
        ...
        try
        {
          ...
          yuk.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap, playMode=%d, info=%s", Integer.valueOf(j), parambqin);
          if (j == 1)
          {
            localBitmap = ((MultiBlockVideoPlayer)this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(parambqin.b - 1L, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.a(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.b());
            return localBitmap;
          }
          parambqin = ((MultiBlockVideoPlayer)this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(parambqin.jdField_a_of_type_Long, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.a(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.b());
          return parambqin;
        }
        finally
        {
  ...
  public List<? extends bqix> a()
  {
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer instanceof MultiBlockVideoPlayer))
    {
      ...
      if (localList != null)
      {
        ...
        if (i > 1) {}
        for (bqin localbqin = (bqin)localList.get(i - 1); (localbqin != null) && (localbqin.b - localbqin.jdField_a_of_type_Long < 3L); localbqin = null) {
  ...
  public void a()
  {
    ...
    boolean bool1 = bqgk.a(this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Long, 262144);
    ...
    if ((bool1) && (bool2))
    {
      ...
      if (!(this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditRecordVideoSource)) {
        break label459;
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource = ((EditRecordVideoSource)this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer = ((ImageViewVideoPlayer)a(2131366841));
      ...
      localObject = null;
      str1 = null;
      Bundle localBundle = this.jdField_a_of_type_Bqgk.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_AndroidOsBundle;
      if (localBundle == null) {
        break label569;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label272;
        label492:
        yuq.jdField_a_of_type_Long = this.jdField_a_of_type_Bqhs.getActivity().getIntent().getLongExtra("stop_record_time", 0L);
  ...
  public void a(int paramInt)
  {
    ...
    long l2;
    long l1;
    if ((paramInt == 1) && (this.jdField_a_of_type_Long == 0L) && (!this.jdField_a_of_type_Bqgk.a()))
    {
    ...
    for (;;)
    {
      ...
      if (l3 != 0L) {
        yup.b("video_edit", "startEditVideoTime", this.jdField_a_of_type_Bqgk.b(), 0, new String[] { String.valueOf(l4 - l3) });
      }
      return;
      label229:
      l1 = 0L;
  ...
  public void a(int paramInt, @NonNull bqua parambqua)
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      parambqua.a.hasFragments = false;
    }
    for (;;)
    {
      return;
      ...
      {
        localObject1 = (bqin)((Iterator)localObject2).next();
        if (localObject1 == null)
        {
          yuk.e("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish error. RecordVideoBlockInfo is null.");
        }
        else if (((bqin)localObject1).jdField_c_of_type_Int == paramInt)
        {
      ...
      try
      {
        ((JSONObject)localObject2).put("vfFrameIndexStart", ((bqin)localObject1).jdField_a_of_type_Long);
        ((JSONObject)localObject2).put("vfFrameIndexEnd", ((bqin)localObject1).b);
        ((JSONObject)localObject2).put("afTimeStart", ((bqin)localObject1).jdField_c_of_type_Long);
        ((JSONObject)localObject2).put("afTimeEnd", ((bqin)localObject1).d);
        parambqua.a.fragments = ((JSONObject)localObject2).toString();
        yuk.b("Q.qqstory.record.EditVideoPlayer", "fragments = %s.", parambqua.a.fragments);
        yuk.b("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish : %s", parambqua.a.fragments);
        if (parambqua.a.hasFragments) {
          continue;
        }
  ...
  public void a(bqin parambqin)
  {
    yuk.a("Q.qqstory.record.EditVideoPlayer", "updateVideoFrameBitmap info=%s", parambqin);
    Object localObject = a(parambqin);
    if (localObject != null)
    {
      ...
      if (localBitmap != null)
      {
        ...
        bqin localbqin = (bqin)((List)localObject).get(parambqin.jdField_c_of_type_Int);
        ((List)localObject).set(parambqin.jdField_c_of_type_Int, localbqin.a(localBitmap));
  ...
  public void f()
  {
    ...
    switch (this.jdField_a_of_type_Bqgk.jdField_a_of_type_Int)
    {
    case 0: 
    case 2: 
    case 5: 
  ...
  public void i()
  {
    ...
    if (localBitmap1 != null)
    {
      ...
      if (this.jdField_b_of_type_Boolean) {
        Stream.of(localBitmap1).map(new ThreadOffFunction("Q.qqstory.record.EditVideoPlayer", 2)).map(new bqiz(0.2F, false)).map(new bqja(10)).map(new UIThreadOffFunction(this)).subscribe(new bqgt(this));
      }
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
  }
