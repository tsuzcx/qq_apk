  ...
  implements qxt, qxu
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new qxf(this);
  private azwg jdField_a_of_type_Azwg;
  private List<BaseData> jdField_a_of_type_JavaUtilList;
  private qxs[] jdField_a_of_type_ArrayOfQxs;
  private float jdField_b_of_type_Float = 14.0F;
  private int jdField_b_of_type_Int = 16;
  private int c = 18;
  private int d = -1;
  
  public qxe(Context paramContext, List<BaseData> paramList, azwg paramazwg)
  {
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_ArrayOfQxs = new qxs[] { new qxv(), new qya(), new qyp(), new nnh(), new qyl(), new nnl(), new nnp(), new nnt(), localqzd };
    localqzd.a(this);
    localqzd.a(this.jdField_a_of_type_AndroidContentContext);
  }
  ...
  private void g()
  {
    for (;;)
    {
      try
      {
        localJSONObject = new JSONObject(String.valueOf(bgmq.a("local_kd_native_main_text_style")));
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup, boolean paramBoolean)
  {
    ...
    {
      aciy.a("Q.readinjoy.fast_web", "", new NullPointerException());
        ...
        do
        {
          ...
          catch (Exception paramView)
          {
            for (;;)
            {
              ...
              continue;
              paramViewGroup = (qxr)paramView.getTag();
              Object localObject = paramViewGroup;
            }
          }
          ((qxr)localObject).jdField_a_of_type_Float = this.jdField_a_of_type_Float;
          ((qxr)localObject).jdField_b_of_type_Float = this.jdField_b_of_type_Float;
          ((qxr)localObject).c = this.jdField_b_of_type_Int;
          ((qxr)localObject).d = this.c;
          ((qxr)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
          ((qxr)localObject).b(((qxr)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData, localBaseData, paramBoolean);
  ...
  public qxs a(BaseData paramBaseData)
  {
    int i = 0;
    while (i < this.jdField_a_of_type_ArrayOfQxs.length)
    {
      if (this.jdField_a_of_type_ArrayOfQxs[i].a(paramBaseData)) {
        return this.jdField_a_of_type_ArrayOfQxs[i];
      }
      i += 1;
    }
  ...
  public void a()
  {
    ...
    while (i < this.jdField_a_of_type_ArrayOfQxs.length)
    {
      if ((this.jdField_a_of_type_ArrayOfQxs[i] instanceof qxu)) {
        ((qxu)this.jdField_a_of_type_ArrayOfQxs[i]).a();
      }
      i += 1;
    }
  }
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfQxs[i] instanceof qxu)) {
        ((qxu)this.jdField_a_of_type_ArrayOfQxs[i]).a(paramAbsListView, paramInt);
      }
      i += 1;
    }
  }
  ...
  public void b()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfQxs[i] instanceof qxu)) {
        ((qxu)this.jdField_a_of_type_ArrayOfQxs[i]).b();
      }
      i += 1;
    }
  }
  ...
  public void c()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfQxs[i] instanceof qxu)) {
        ((qxu)this.jdField_a_of_type_ArrayOfQxs[i]).c();
      }
      i += 1;
    }
  }
  ...
  public void d()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfQxs[i] instanceof qxu)) {
        ((qxu)this.jdField_a_of_type_ArrayOfQxs[i]).d();
      }
      i += 1;
    }
  }
  ...
  public void e()
  {
    ...
    {
      if ((this.jdField_a_of_type_ArrayOfQxs[i] instanceof qxu)) {
        ((qxu)this.jdField_a_of_type_ArrayOfQxs[i]).e();
      }
      i += 1;
    }
  }
  ...
  {
    return qxr.jdField_a_of_type_Int;
  }
}
