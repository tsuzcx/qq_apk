...
public class oko
  extends pmn
{
  public oko(ReadInJoyVideoSubChannelActivity paramReadInJoyVideoSubChannelActivity) {}
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      Object localObject2 = pmh.a().a(ReadInJoyVideoSubChannelActivity.c(this.a), ((Long)localObject1).longValue());
    ...
    label270:
    this.a.jdField_a_of_type_Pgm.b = 0L;
    paramList = this.a;
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        ReadInJoyVideoSubChannelActivity.a(this.a, this.a.getResources().getString(2131717128));
        continue;
        if (ReadInJoyVideoSubChannelActivity.a(this.a).isEmpty()) {
          ReadInJoyVideoSubChannelActivity.a(this.a, this.a.getResources().getString(2131717087));
        }
      }
    }
  }
  ...
  public void b(int paramInt, List<Long> paramList)
  {
    ...
    ReadInJoyVideoSubChannelActivity.a(this.a).b(pmh.a().a(Integer.valueOf(ReadInJoyVideoSubChannelActivity.c(this.a)), paramList));
  ...
  public void b(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = bool;; paramBoolean1 = false)
    {
      ...
      {
        paramList = this.a.getResources().getString(2131716883);
  ...
  public void d(int paramInt)
  {
    if (paramInt == 97)
    {
      QQToast.a(ReadInJoyVideoSubChannelActivity.a(this.a), anni.a(2131711540), 0).a();
      ReadInJoyVideoSubChannelActivity.b(this.a, true);
    }
    while (paramInt != 98) {
      return;
    }
    QQToast.a(ReadInJoyVideoSubChannelActivity.a(this.a), anni.a(2131711610), 0).a();
