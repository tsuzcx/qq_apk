...
{
  public abpf(RegisterVerifyCodeActivity paramRegisterVerifyCodeActivity) {}
    ...
    do
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(this.a.c))
        {
          ...
          localObject = "";
          awqx.a(localQQAppInterface, "new_reg", "msg_page", "next_clk", "", 1, "", str2, str1, (String)localObject, "", "", "", "", "");
          if ((paramBoolean) && (paramInt == 0)) {
            break label241;
          }
          paramString1 = paramArrayOfByte;
          if (TextUtils.isEmpty(paramArrayOfByte)) {
            paramString1 = this.a.getString(2131651340);
          }
          if (QLog.isColorLevel()) {
  ...
  public void onRegisterSendResendSmsreqResp(boolean paramBoolean, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    ...
    if (!paramBoolean) {
      try
      {
        ...
        if (TextUtils.isEmpty(paramArrayOfByte)) {
          localObject = this.a.getString(2131651340);
        }
