...
public abstract class ajdc
{
  ...
  protected aoce a;
  private aofu jdField_a_of_type_Aofu = new ajde(this);
  protected QQAppInterface a;
  private AbsListView.OnScrollListener jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener = new ajdd(this);
  ...
  public ajdc(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, ajdf paramajdf)
  {
  ...
  {
    g();
    this.jdField_a_of_type_Ajcw = a();
    this.jdField_a_of_type_Ajcw.a(null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajcw);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131712720));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167110));
  ...
  private void h()
  {
    ...
    if (a()) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131712721));
    }
  }
  
  protected abstract ajcw a();
  ...
  protected oidb_0x935.GPS a()
  {
    ...
    ((oidb_0x935.GPS)localObject).bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.4.10"));
  ...
  protected boolean a()
  {
    return this.jdField_a_of_type_Aoce.a == 1;
  }
  
  protected void b()
  {
    this.jdField_a_of_type_Ajcw.a(this.jdField_a_of_type_Aoce.b);
    this.jdField_a_of_type_Ajcw.notifyDataSetChanged();
  }
  
  protected void b(boolean paramBoolean)
  {
    this.jdField_a_of_type_Aoce.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), a(), 21);
  }
