  ...
  extends asbv
{
  ...
  public ascp(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void f()
  {
    ...
    do
    {
      ...
      if ((localObject instanceof QQAppInterface))
      {
        ...
        if (localObject != null)
        {
          localObject = (ascp)((asbm)localObject).a("android.qq.readinjoy.viola_795");
          if (localObject != null)
          {
            ((ascp)localObject).a(true);
