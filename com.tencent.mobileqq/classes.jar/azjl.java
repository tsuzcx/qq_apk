...
public class azjl
{
  ...
  private void a()
  {
    this.jdField_a_of_type_Long = (azkc.a("gifWifiPreDownloadLimit", 1000L) * 1024L * 1024L);
    this.jdField_b_of_type_Long = (azkc.a("gifXgPreDownloadLimit", 32L) * 1024L * 1024L);
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        if (paramBoolean1)
        {
          ...
          azkc.a(str, 1L);
          bdla.b(null, "dc00898", "", "", "0X800B3BA", "0X800B3BA", i, 0, "", "", "", "");
        }
      }
      else
      {
        if (j > 0)
        {
          ...
          str = "gifWifiOverFlag";
          azkc.a(str, 1L);
          bdla.b(null, "dc00898", "", "", "0X800B3BA", "0X800B3BA", j, 0, "", "", "", "");
        }
  ...
  public static boolean a(MessageForPic paramMessageForPic, boolean paramBoolean, int paramInt)
  {
    ...
    while ((blvp.a(paramMessageForPic.imageType)) && (paramInt == 5))
    {
      return true;
      return false;
    }
  ...
  public void a(boolean paramBoolean, long paramLong)
  {
    ...
    for (;;)
    {
      azkc.a("gifWifiPreDownloadFlow", this.jdField_c_of_type_Long);
      azkc.a("gifXgPreDownloadFlow", this.jdField_d_of_type_Long);
      azkc.a("gifPreDownloadTimestamp", this.e);
      return;
  ...
  public boolean a(boolean paramBoolean, long paramLong)
  {
    ...
    {
      this.jdField_c_of_type_Long = azkc.a("gifWifiPreDownloadFlow", 0L);
      this.jdField_d_of_type_Long = azkc.a("gifXgPreDownloadFlow", 0L);
      this.e = azkc.a("gifPreDownloadTimestamp", 0L);
      if (this.e == 0L) {
        this.e = System.currentTimeMillis();
      }
      if (azkc.a("gifWifiOverFlag", 0L) == 1L)
      {
        bool1 = true;
        this.jdField_a_of_type_Boolean = bool1;
        if (azkc.a("gifXgOverFlag", 0L) != 1L) {
          break label254;
        }
        bool1 = true;
        label110:
        this.jdField_b_of_type_Boolean = bool1;
        if (azkc.a("gifWifiFirstFlag", 0L) != 1L) {
          break label260;
        }
        bool1 = true;
        label130:
        this.jdField_c_of_type_Boolean = bool1;
        if (azkc.a("gifXgFirstFlag", 0L) != 1L) {
          break label266;
        }
        bool1 = true;
        label150:
