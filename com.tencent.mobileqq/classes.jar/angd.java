...
public class angd
  implements angp
{
  public angd(ApolloPanel paramApolloPanel) {}
  ...
  public angy a(int paramInt)
  {
    ...
    {
    default: 
      return new anfm(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 0: 
      return new anfm(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 2: 
      return new anek(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 100: 
  ...
  public void a(List<angy> paramList, List<ApolloActionPackage> paramList1, boolean paramBoolean)
  {
    ...
    int m;
    int k;
    if ((localObject1 != null) && (((amlv)localObject1).jdField_a_of_type_Int > 0) && (!paramList.isEmpty()))
    {
      i = 0;
      if (i < paramList.size())
      {
        localObject2 = (angy)paramList.get(i);
        if ((localObject2 instanceof anet))
        {
          ApolloPanel.jdField_a_of_type_Int = i;
          if (QLog.isColorLevel()) {
            QLog.d("ApolloPanel", 2, new Object[] { "[initPanelData] checkGameTab jumpGameId:", Integer.valueOf(((amlv)localObject1).jdField_a_of_type_Int), ",gameTabIndex:" + ApolloPanel.jdField_a_of_type_Int });
          }
          ((anet)localObject2).a((amlv)localObject1);
    ...
    for (;;)
    {
      ...
      if (k == 0)
      {
        ...
        if (!paramBoolean)
        {
          ...
          if (((amhd)this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).o)
          {
