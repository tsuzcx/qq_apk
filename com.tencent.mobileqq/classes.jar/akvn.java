...
public class akvn
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, List<cmd0x777.AddFrdInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (k > 0)
        {
          bcpw.a(BaseApplication.getContext(), 0, ajyc.a(2131701055), 0).a();
        ...
        for (;;)
        {
          ...
          bcpw.a(BaseApplication.getContext(), 0, ajyc.a(2131701058), 0).a();
          break label353;
          label465:
          break;
          label467:
        ...
        for (;;)
        {
          paramList = bbcv.a(paramActivity, String.format(Locale.getDefault(), ajyc.a(2131701062), new Object[] { paramList }), 0, 0, null, null);
          paramList.setPositiveButton(2131694793, new akvo());
          if ((paramActivity != null) && (!paramActivity.isFinishing())) {
            paramList.show();
          }
          axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "frd_select", "notAdd_exp", 0, 0, paramString, String.valueOf(j), "", "");
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    baqn.a(paramQQAppInterface, true, localTroopInfo);
    ...
    if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      i = 1;
      localObject1 = String.format(Locale.getDefault(), ajyc.a(2131701056), new Object[] { paramString3, Integer.valueOf(paramInt2) });
      if (paramInt2 != 1) {
        break label745;
      }
      paramString3 = String.format(Locale.getDefault(), ajyc.a(2131701059), new Object[] { paramString3 });
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      if (paramInt1 == 0)
      {
        paramString3 = paramString3 + ajyc.a(2131701063);
        localObject1 = ajyc.a(2131701060);
        i = paramString3.indexOf((String)localObject1);
        j = ((String)localObject1).length();
        localObject1 = new aquz(paramString1, paramString1, paramString3, 1, -5020, 135178, l2);
        ((aquz)localObject1).jdField_c_of_type_JavaLangString = paramString3;
        ...
        ((aquz)localObject1).a(i, i + j, paramString3);
        ...
        label348:
        ((aquz)localObject1).d = paramString3;
      ...
      {
        axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", (String)localObject2, 0, 0, paramString1, (String)localObject1, "", paramString3);
        if (!QLog.isDevelopLevel()) {
          break;
        }
        ...
        break label108;
        label618:
        paramString3 = String.format(Locale.getDefault(), ajyc.a(2131701061), new Object[] { Integer.valueOf(paramInt2) });
        i = j;
        ...
        paramString3 = String.format(Locale.getDefault(), ajyc.a(2131701057), new Object[] { paramString2 });
        paramInt2 = 0;
        break label187;
        paramString3 = paramString3 + ajyc.a(2131701054);
        break label217;
        paramString3 = "";
        break label348;
      }
  ...
  private void b(FriendListHandler paramFriendListHandler)
  {
    ...
    ajxn localajxn = (ajxn)paramFriendListHandler.app.getManager(51);
    ...
    for (boolean bool2 = true;; bool2 = bool1)
    {
      if (localAddFrdInfo.uint32_send_req_flag.get() == 1)
      {
        ...
        localajxn.a(Long.toString(localAddFrdInfo.uint64_uin.get()), false);
        bool1 = bool2;
        break label90;
  ...
  public void a(FriendListHandler paramFriendListHandler)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (ajxn)paramFriendListHandler.app.getManager(51);
      ...
      if (i > 0)
      {
        ...
        if (i >= 0)
        {
          ...
          ((ajxn)localObject).a(Long.toString(l1), true);
          i -= 1;
        }
        else
        {
