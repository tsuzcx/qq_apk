...
public class axal
{
  ...
  public static MessageForQQWalletMsg a(String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        MessageForQQWalletMsg localMessageForQQWalletMsg = (MessageForQQWalletMsg)axaq.a(-2025);
  ...
  public static MessageForVIPDonate a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        MessageForVIPDonate localMessageForVIPDonate = (MessageForVIPDonate)axaq.a(-2047);
        ...
        if (localJSONObject.has("title"))
        {
          ...
          localMessageForVIPDonate.msgData = akwb.a(localVIPDonateMsg);
    ...
    for (;;)
    {
      ...
      if (paramList != null)
      {
        ...
        if (paramList.str.has())
        {
          ...
          if (paramBoolean)
          {
            str = axas.a(paramList, false);
            localObject = paramList;
            if (str.length() > 0)
            {
              localObject = (MessageForText)axaq.a(-1000);
  ...
  private void a(im_msg_body.Elem paramElem, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, axau paramaxau)
  {
    ...
    if (localObject != null)
    {
      ...
      if (i == 1)
      {
        ...
        {
          paramStringBuilder = (bdto)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(165);
          if (!paramStringBuilder.a.containsKey(paramElem)) {
            paramStringBuilder.a(new BmqqAccountType(paramElem, 1));
          }
        }
        if ((paramaxau != null) && (paramaxau.jdField_a_of_type_Int == 1024)) {
          paramaxau.jdField_a_of_type_Int = 1025;
        }
      }
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        if ((i == 8) && (paramElem.qidian_group_msg.has()))
        {
          ...
          axao.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, l1, k, l2, m);
          if (j != 0)
          {
            paramStringBuilder = (bduw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85);
        ...
        if ((i == 11) && (paramElem.msg_gray_msg.has()))
        {
          ...
          bdvj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), paramStringBuilder, 1024, ((StringBuilder)localObject).toString());
        }
        if (paramElem.str_check_id.has()) {
          bdvj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, paramMsg, paramaxau, paramElem);
        }
        if ((paramaxau != null) && (paramaxau.jdField_a_of_type_Int == 1024) && (paramElem.str_ext_nick_name.has()))
        {
  ...
  {
    BaseApplication.getContext().getString(2131694855);
    boolean bool;
          ...
          for (int k = paramNotOnlineImage.uint32_file_id.get();; k = 0)
          {
            ...
            for (;;)
            {
                ...
                if (paramNotOnlineImage.pic_md5.has())
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    if (localObject2.length > 0) {
                      paramMsg = bbdm.a((byte[])localObject2);
                    }
                  }
                }
                Object localObject2 = aywi.a(paramElem, j, 1, false, paramElem, paramMsg, "picplatform", str1, str2, str3, str4, i5, 0);
              ...
              for (;;)
              {
                ...
                paramElem = (MessageForPic)axaq.a(-2000);
                if (bool) {
                  ajwd.a(paramElem, false);
                }
                ...
                axrl.a(BaseApplication.getContext()).a(paramNotOnlineImage, "actMessageEvent", false, 0L, 0L, paramElem, "");
                return;
                label1192:
                j = n;
                k = m;
  ...
  public axam a(List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder, long paramLong, azmj paramazmj)
  {
    axam localaxam = new axam(this);
    localaxam.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo = a(paramList, paramStringBuilder);
    axan localaxan = new axan();
    ArrayList localArrayList = localaxan.jdField_a_of_type_JavaUtilArrayList;
    StringBuilder localStringBuilder = a(null, paramList, paramStringBuilder, paramLong, paramazmj, localaxan, null);
    if ((localArrayList != null) && (localArrayList.size() == 2)) {
      if (localArrayList.get(0) != null)
      {
        ...
        if (localArrayList.get(1) != null) {
          localaxam.jdField_a_of_type_ArrayOfByte = ((byte[])localArrayList.get(1));
        }
      }
    }
    for (paramStringBuilder = paramList;; paramStringBuilder = null)
    {
      if ((localStringBuilder.length() > 0) && (localaxam.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo != null))
      {
        localaxam.jdField_a_of_type_JavaLangString = localStringBuilder.toString();
        if ((TextUtils.isEmpty(localaxam.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mAnonymousNickName)) && (paramStringBuilder != null) && (!TextUtils.isEmpty(localaxam.jdField_a_of_type_JavaLangString)) && (localaxam.jdField_a_of_type_JavaLangString.length() > paramStringBuilder.textLen + 1))
        {
          localaxam.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramStringBuilder;
          localaxam.b = localaxam.jdField_a_of_type_JavaLangString.substring(0, paramStringBuilder.textLen + 1);
          localaxam.jdField_a_of_type_JavaLangString = localaxam.jdField_a_of_type_JavaLangString.substring(paramStringBuilder.textLen + 1);
          if ((paramStringBuilder.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (localaxan.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
            paramazmj.jdField_a_of_type_Azmk.a = -1L;
          }
        }
      }
      return localaxam;
    ...
    if (localMarketFace != null)
    {
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        try
        {
          for (;;)
          {
            paramStringBuilder.msgData = akwb.a(paramElem);
      ...
      if (localResvAttr.uint32_has_ip_product.get() == 1)
      {
        ...
        paramStringBuilder = (MessageForMarketFace)axaq.a(-2007);
        ...
        if ((paramElem.mobileparam != null) && (paramElem.mobileparam.length > 0)) {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "MbJieshou", "MbXiaoxi", 0, 0, "", "", "", "");
        }
      }
    }
    label593:
  ...
  public MessageForDeliverGiftTips a(String paramString1, String paramString2, im_msg_body.DeliverGiftMsg paramDeliverGiftMsg, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    {
      paramStringBuilder = (MessageForDeliverGiftTips)axaq.a(-2035);
    ...
    for (;;)
    {
      ...
      paramString1 = (bamj)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(81);
      if (paramString1 != null)
      {
        ...
        if (paramStringBuilder.grayTipsEntity.highlightNum != 0) {
          bamj.a(paramStringBuilder, paramStringBuilder.grayTipsEntity.highlightItems);
        }
        if ((paramStringBuilder instanceof MessageForTroopGift)) {
      ...
      {
        paramDeliverGiftMsg = Pattern.compile(ajyc.a(2131706646));
      ...
      paramStringBuilder = (MessageForTroopGift)axaq.a(-2038);
  ...
  public String a(List<im_msg_body.Elem> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (((im_msg_body.Text)localObject).str.has()) {
        localStringBuilder1.append(axas.a(((im_msg_body.Text)localObject).str.get().toStringUtf8(), false));
      }
      continue;
      int m;
  ...
  public StringBuilder a(StringBuilder paramStringBuilder1, List<im_msg_body.Elem> paramList, StringBuilder paramStringBuilder2, long paramLong, azmj paramazmj, axan paramaxan, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    axan localaxan = paramaxan;
    if (paramaxan == null) {
      localaxan = new axan();
    }
    Object localObject2 = null;
    Object localObject1 = localaxan.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo;
    paramaxan = null;
    ...
    if (((im_msg_body.Text)localObject1).str.has()) {
      localStringBuilder.append(axas.a(((im_msg_body.Text)localObject1).str.get().toStringUtf8(), false));
    }
    label219:
    int k;
    int j;
    ...
    if (((im_msg_body.Text)localObject1).attr_6_buf.has())
    {
      ...
      if (localObject1 != null)
      {
        ...
        if ((paramazmj != null) && ((paramazmj.jdField_a_of_type_Int == 3000) || (paramazmj.jdField_a_of_type_Int == 1)) && (paramArrayList != null) && (localObject2 != null) && (localObject2.length != 0))
        {
          n = bbmj.a((byte[])localObject2, 0);
          k = 2;
          j = 0;
          if ((j < n) && (k < 2048))
          {
        ...
        if ((paramazmj == null) || ((!paramazmj.jdField_a_of_type_Azmk.a(paramLong)) && (!paramazmj.f.a(paramLong)) && (paramList != null)) || (localObject2 == null) || (localObject2.length == 0)) {
          break label1358;
        }
        int n = bbmj.a((byte[])localObject2, 0);
        k = 2;
        j = 0;
    ...
    for (;;)
    {
      localObject1 = paramaxan;
      paramaxan = paramList;
      paramList = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      label448:
      localObject1 = paramaxan;
      paramaxan = paramStringBuilder1;
      paramStringBuilder1 = (StringBuilder)localObject1;
      break;
      localObject2 = null;
      break label219;
      ...
      if (localAtTroopMemberInfo.isIncludingAll()) {
        paramazmj.f.a = paramLong;
      }
      if ((localAtTroopMemberInfo.isIncludingMe(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getLongAccountUin())) && (paramazmj.jdField_a_of_type_Azmk != null))
      {
        paramazmj.jdField_a_of_type_Azmk.a = paramLong;
      ...
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject1).face.has())
        {
          ...
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = paramaxan;
          paramaxan = (axan)localObject1;
          break label448;
        }
        ...
        if (((im_msg_body.Elem)localObject1).online_image.has())
        {
          ...
          localStringBuilder.append(BaseApplication.getContext().getString(2131694855));
          localObject1 = paramStringBuilder1;
          paramStringBuilder1 = paramaxan;
          paramaxan = (axan)localObject1;
          break label448;
        ...
        if (((im_msg_body.Elem)localObject1).bankcode_ctrl_info.has())
        {
          ...
          break label448;
          label1207:
          localaxan.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo = paramList;
          paramList = localaxan.jdField_a_of_type_JavaUtilArrayList;
          if ((paramList != null) && ((paramStringBuilder1 != null) || (paramaxan != null)))
          {
            if (!paramList.isEmpty()) {
              break label1255;
            }
            paramList.add(paramStringBuilder1);
            paramList.add(paramaxan);
          }
          label1255:
  ...
  public void a(MessageHandler paramMessageHandler, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    paramList = a(paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), paramazmj);
    ...
    {
      paramStringBuilder = (ChatMessage)axaq.a(-1049);
      paramStringBuilder.msg = paramList.jdField_a_of_type_JavaLangString;
      paramazmj = (MessageForReplyText)paramStringBuilder;
    }
    try
    {
      paramazmj.extLong |= 0x1;
      if (paramMsg.getSourceMsg() != null)
      {
        paramazmj.setSourceMessageRecord(paramMsg.unPackSourceMsg(paramMessageHandler.app));
        if ((paramazmj.getSourceMessage() != null) && (apue.a(paramazmj.getSourceMessage())))
        {
          paramMessageHandler = paramazmj.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
          ChatMessage localChatMessage = apue.a((ChatMessage)paramazmj.getSourceMessage());
          apvk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, paramazmj.getSourceMessage());
          if ((!TextUtils.isEmpty(paramMessageHandler)) && (localChatMessage != null))
          {
            ...
            if ((i == 1) || (i == 2))
            {
              ...
              apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)paramazmj.getSourceMessage());
            }
          }
        }
      }
      paramMessageHandler = bbdm.a(akwb.a(paramMsg));
      paramazmj.mSourceMsgInfo = paramMsg;
      paramazmj.saveExtInfoToExtStr("sens_msg_source_msg_info", paramMessageHandler);
      if (QLog.isColorLevel()) {
        QLog.d("SendMsgBtn", 2, "reply:" + paramazmj + " sourceMsg=" + paramazmj.getSourceMessage());
      }
    }
    ...
    if (paramList.jdField_a_of_type_ArrayOfByte != null) {
      paramStringBuilder.saveExtInfoToExtStr("sens_msg_ctrl_info", bbdm.a(paramList.jdField_a_of_type_ArrayOfByte));
    }
    paramList1.add(paramStringBuilder);
    if (QLog.isColorLevel()) {
      QLog.d("DecodeMsg", 2, "reply msgRand = " + axas.a(paramStringBuilder.msgUid) + ", msgUid = " + paramStringBuilder.msgUid);
    }
  }
  
  public void a(MessageHandler paramMessageHandler, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        if (localElem.custom_face.has())
        {
          ...
          {
            localMessageForText = (MessageForText)axaq.a(-1000);
          ...
          a(localElem, null, localArrayList, paramStringBuilder, paramMsg, paramBoolean, paramazmj);
        }
    ...
    for (;;)
    {
      ...
      localObject1 = a((StringBuilder)localObject1, (List)localObject3, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), paramazmj, localaxan, (ArrayList)localObject2);
      break;
      if (localElem.general_flags.has())
      {
        ...
        if (((StringBuilder)localObject1).length() > 0)
        {
          ...
          if (paramazmj != null) {
            bafh.a(paramazmj.jdField_a_of_type_Int, (ArrayList)localObject2, (ChatMessage)localObject3);
          }
          localArrayList.add(localObject3);
          ((StringBuilder)localObject1).delete(0, ((StringBuilder)localObject1).length());
        }
        localObject2 = localaxan.jdField_a_of_type_JavaUtilArrayList;
        ...
        for (;;)
        {
          ...
          if (paramList != null) {
            paramStringBuilder = (MessageForReplyText)axaq.a(-1049);
          }
          try
          {
            ...
            if (paramList.getSourceMsg() != null)
            {
              ...
              if ((paramStringBuilder.getSourceMessage() != null) && (apue.a(paramStringBuilder.getSourceMessage())))
              {
                localObject3 = paramStringBuilder.getSourceMessage().getExtInfoFromExtStr("_m_ForwardFileType");
                localChatMessage = apue.a((ChatMessage)paramStringBuilder.getSourceMessage());
                apvk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage, paramStringBuilder.getSourceMessage());
                if ((!TextUtils.isEmpty((CharSequence)localObject3)) && (localChatMessage != null))
                {
                  ...
                  if ((i == 1) || (i == 2))
                  {
                    ...
                    apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage.uniseq, localChatMessage.frienduin, localChatMessage.istroop, (ChatMessage)paramStringBuilder.getSourceMessage());
                  }
                }
              }
            }
            paramStringBuilder.saveExtInfoToExtStr("sens_msg_source_msg_info", bbdm.a(akwb.a(paramList)));
          }
          ...
          if (TextUtils.isEmpty(paramStringBuilder.mSourceMsgInfo.mAnonymousNickName))
          {
            ...
            if (localObject2 != null)
            {
              ...
              localObject3 = (MessageForReplyText)axaq.a(-1049);
              ...
              if ((!TextUtils.isEmpty(((MessageForReplyText)localObject3).msg)) && (((MessageForReplyText)localObject3).msg.length() >= ((MessageForText.AtTroopMemberInfo)localObject2).textLen + 1))
              {
                ...
                if ((((MessageForText.AtTroopMemberInfo)localObject2).isIncludingMe(paramMessageHandler.app.getLongAccountUin())) && (localaxan.jdField_a_of_type_ComTencentMobileqqDataMessageForText$AtTroopMemberInfo == null)) {
                  paramazmj.jdField_a_of_type_Azmk.a = -1L;
                }
              }
          ...
          try
          {
            if (localArrayList.size() > 0)
            {
              ...
              localObject3 = bbbd.a(paramStringBuilder);
              if (QLog.isColorLevel()) {
              ...
              ((ajsk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a(paramStringBuilder);
            }
          }
          catch (Exception paramList)
          {
                  ...
                  if (j != 0)
                  {
                    ...
                    while (paramStringBuilder.hasNext())
                    {
                      ...
                      if ((paramMsg.msgtype != -1000) && (paramMsg.msgtype != -1049) && (paramMsg.msgtype != -2000))
                      {
                        ...
                        {
                          paramList1.add(axao.a(paramList, paramMessageHandler, paramazmj));
                          paramList.clear();
                    ...
                    if (paramList.size() > 0)
                    {
                      ...
                      paramMessageHandler = axao.a(paramList, (byte[])localObject1, paramazmj);
                  ...
                  for (;;)
                  {
                    ...
                    while (paramMessageHandler.hasNext())
                    {
                      ...
                      if (((paramList instanceof MessageForText)) && (k == 0)) {
                        paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bbdm.a((byte[])localObject1));
                      }
  ...
  public void a(ArrayList<String> paramArrayList, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj, axau paramaxau)
  {
    if (paramArrayList.contains("lifeOnline")) {
      a(paramList, paramList1, paramStringBuilder, paramMsg, paramazmj);
    }
    ...
    if (paramArrayList.hasNext())
    {
      ...
      if (paramList.crm_elem.has()) {
        a(paramList, paramList1, paramStringBuilder, paramMsg, paramaxau);
      }
      ...
      try
      {
        paramazmj.mergeFrom(paramList.general_flags.bytes_pb_reserve.get().toByteArray());
        j = n;
        if (paramazmj.float_sticker_x.has())
        {
          j = n;
          localObject1 = new EmojiStickerManager.StickerInfo();
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).x = paramazmj.float_sticker_x.get();
          j = n;
          if (!paramazmj.float_sticker_y.has()) {
            break label2550;
          }
          j = n;
          f = paramazmj.float_sticker_y.get();
          label519:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).y = f;
          j = n;
          if (!paramazmj.float_sticker_width.has()) {
            break label2556;
          }
          j = n;
          f = paramazmj.float_sticker_width.get();
          label559:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).width = f;
          j = n;
          if (!paramazmj.float_sticker_height.has()) {
            break label2562;
          }
          j = n;
          f = paramazmj.float_sticker_height.get();
          label599:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).height = f;
          j = n;
          if (!paramazmj.uint32_sticker_rotate.has()) {
            break label2568;
          }
          j = n;
          i = paramazmj.uint32_sticker_rotate.get();
          label639:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).rotate = i;
          j = n;
          if (!paramazmj.uint64_sticker_host_msgseq.has()) {
            break label2574;
          }
          j = n;
          l = paramazmj.uint64_sticker_host_msgseq.get();
          label679:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).hostMsgSeq = l;
          j = n;
          if (!paramazmj.uint64_sticker_host_msguid.has()) {
            break label2580;
          }
          j = n;
          l = paramazmj.uint64_sticker_host_msguid.get();
          label719:
          j = n;
          ((EmojiStickerManager.StickerInfo)localObject1).hostMsgUid = l;
          j = n;
          if (!paramazmj.uint64_sticker_host_time.has()) {
            break label2586;
          }
          j = n;
          l = paramazmj.uint64_sticker_host_time.get();
          label759:
          j = n;
        ...
        j = n;
        if (!paramazmj.uint32_mobile_custom_font.has()) {
          break label2592;
        }
        j = n;
        l = paramazmj.uint32_mobile_custom_font.get() & 0xFFFFFFFF;
        j = n;
        if (!paramList1.isEmpty())
        {
          j = n;
      ...
      catch (InvalidProtocolBufferMicroException paramazmj)
      {
        for (;;)
        {
          Object localObject1;
      ...
      j = i;
      if (paramazmj.uint64_subfont_id.has())
      {
        j = i;
        l = paramazmj.uint64_subfont_id.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
      ...
      j = i;
      if (paramazmj.uint32_diy_font_timestamp.has())
      {
        j = i;
        l = paramazmj.uint32_diy_font_timestamp.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
        ...
        j = i;
        if (paramazmj.uint32_tail_key.has())
        {
          j = i;
          if (2 == paramazmj.uint32_tail_key.get())
          {
            j = i;
            if (paramazmj.uint32_show_tail_flag.has())
            {
              j = i;
              if (1 != paramazmj.uint32_show_tail_flag.get())
              {
                j = i;
                paramazmj.uint32_tail_key.clear();
                j = i;
                if (QLog.isColorLevel())
                {
                  j = i;
        ...
        {
          j = i;
          k = paramazmj.uint32_tail_key.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
        ...
        j = i;
        if (paramazmj.uint32_bot_message_class_id.has())
        {
          j = i;
          k = paramazmj.uint32_bot_message_class_id.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
        ...
        j = i;
        if (paramazmj.uint32_holiday_flag.has())
        {
          j = i;
          k = paramazmj.uint32_holiday_flag.get();
          if (k == 1)
          {
            j = i;
            if (!paramList1.isEmpty())
            {
              j = i;
              ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axad.c, String.valueOf(k));
            }
          }
          j = i;
          if (QLog.isColorLevel())
        ...
        j = i;
        if (paramazmj.uint32_service_msg_type.has())
        {
          j = i;
          k = paramazmj.uint32_service_msg_type.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axad.w, String.valueOf(k));
          }
          j = i;
          ((StringBuilder)localObject1).append("---uint32_service_msg_type = ").append(k).append("---");
        }
        j = i;
        if (paramazmj.uint32_service_msg_remind_type.has())
        {
          j = i;
          k = paramazmj.uint32_service_msg_remind_type.get();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axad.x, String.valueOf(k));
          }
          j = i;
          ((StringBuilder)localObject1).append("---uint32_service_msg_remind_type = ").append(k).append("---");
        }
        j = i;
        if (paramazmj.bytes_service_msg_name.has())
        {
          j = i;
          localObject2 = paramazmj.bytes_service_msg_name.get().toStringUtf8();
          j = i;
          if (!paramList1.isEmpty())
          {
            j = i;
            ((MessageRecord)paramList1.get(0)).saveExtInfoToExtStr(axad.y, (String)localObject2);
          }
          j = i;
    ...
    try
    {
      if (paramazmj.uint32_msg_info_flag.has())
      {
        j = i;
        k = paramazmj.uint32_msg_info_flag.get();
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
    ...
    int k = i;
    int j = i;
    if (paramazmj.uint32_comment_flag.has())
    {
      k = i;
      j = i;
      if (paramazmj.uint64_comment_location.has())
      {
        k = i;
        j = i;
        if (!paramList1.isEmpty())
        {
          j = i;
          if (paramazmj.uint32_comment_flag.get() != 1) {
            break label2715;
          }
        }
      }
    ...
    {
      j = i;
      l = paramazmj.uint64_comment_location.get();
      j = i;
      ...
      try
      {
        ...
        j = i;
        ((oidb_0xdea.PassThrough)localObject2).mergeFrom(paramazmj.bytes_pass_through.get().toByteArray());
        j = i;
        ((MessageForReplyText)localObject1).barrageSourceMsgType = ((oidb_0xdea.PassThrough)localObject2).entrance.get();
      }
      catch (Exception paramazmj)
      {
        for (;;)
        {
          j = i;
          QLog.i("DecodeMsg", 1, "handleGeneralSettingFlags fail, " + paramazmj);
        }
      }
      k = i;
      j = i;
      ...
      amns.a(paramMsg, paramList, paramList1, this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app);
      break;
      label2550:
      f = 0.0F;
      break label519;
            ...
            catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
            {
              try
              {
                do
                {
                  ...
                  localObject1 = (MessageForShortVideo)axaq.a(-2022);
                  ...
                  ((MessageForShortVideo)localObject1).msg = axdq.b;
                  ...
                  try
                  {
                    ...
                    {
                      String str = bbbd.a((byte[])localObject3);
                      if (QLog.isColorLevel()) {
                    ...
                    ((ajsk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a((byte[])localObject3);
                  }
                  catch (Exception paramList)
                  {
                    for (;;)
                  ...
                  if (((MessageForShortVideo)localObject1).redBagType == LocalMediaInfo.REDBAG_TYPE_GET)
                  {
                    ...
                    axjq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
              ...
              catch (Exception localException)
              {
                for (;;)
                {
                  if (QLog.isColorLevel())
                  {
                    ...
                    continue;
                    label1277:
                    localException.msg = axdq.jdField_a_of_type_JavaLangString;
                  }
                }
              }
            }
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
      ...
      if (akau.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, 3000, String.valueOf(l1), String.valueOf(l4), l6, l7)) {
        continue;
      }
      paramStringBuilder = "";
      try
      {
        ...
        if (paramMsg.msg_body.has())
        {
          ...
          if (paramMsg.rich_text.attr.has()) {
            l2 = axas.a(((im_msg_body.Attr)paramMsg.rich_text.attr.get()).random.get());
          }
        }
      ...
      catch (UnsupportedEncodingException localInvalidProtocolBufferMicroException)
      {
        try
        {
          ...
          {
            bool = true;
            paramMsg.msg = aywi.a(paramStringBuilder, l1, 0, bool);
            paramMsg.doParse();
          }
        }
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        {
          try
          {
            for (;;)
            {
              paramMsg.fileName = apue.a(new String(paramList.bytes_filename.get().toByteArray(), "UTF-8"));
              paramList1.add(paramMsg);
              ((aygv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(272)).a(paramMsg);
              if (!QLog.isColorLevel()) {
                break;
              }
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    ...
    for (;;)
    {
      ...
      if ((localElem.life_online.has()) && (localElem.life_online.uint32_ack.has()) && (localElem.life_online.uint32_ack.get() == 1))
      {
        if (localElem.life_online.uint64_unique_id.has())
        {
          ...
          nnx.a().a(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, l1, l2, l3, l4, 1, null);
        }
      }
      else
      {
        ...
        paramazmj = localElem.life_online.gdt_cli_data.get().toStringUtf8();
        ...
        if (paramazmj.length() <= 100) {
          break label1714;
        }
        paramStringBuilder = paramazmj.substring(0, 100);
        i2 = j;
      }
      for (;;)
      {
          ...
          if ((localElem.life_online.uint64_bitmap.get() & 0x1000) == 4096L)
          {
            ...
            if (i1 != 0)
            {
              ...
              if (QLog.isColorLevel())
              {
                ...
                paramazmj = Long.valueOf(localElem.life_online.uint64_bitmap.get());
                QLog.d("DecodeMsg", 2, paramazmj);
              }
              ThreadManager.getSubThreadHandler().postDelayed(new MessagePBElemDecoder.1(this), 1000L);
            }
            if (!paramList1.isEmpty())
            {
              paramazmj = (MessageRecord)paramList1.get(0);
              paramazmj.extLong |= 0x1;
              ...
              if (m != 0)
              {
                ...
                label1132:
                paramazmj.saveExtInfoToExtStr("gdt_singleAd", paramStringBuilder);
                paramazmj = (MessageRecord)paramList1.get(0);
                if (i2 == 0) {
                  break label1591;
                }
                paramStringBuilder = "1";
                paramazmj.saveExtInfoToExtStr("gdt_mulAd", paramStringBuilder);
                paramazmj = (MessageRecord)paramList1.get(0);
                if (k == 0) {
                  break label1598;
                }
                paramStringBuilder = "1";
                paramazmj.saveExtInfoToExtStr("gdt_followAd", paramStringBuilder);
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj, boolean paramBoolean)
  {
    int i = 0;
    im_msg_body.Elem localElem = null;
    ArrayList localArrayList = new ArrayList();
    ...
    if (localIterator.hasNext())
    {
      ...
      if (localElem.market_face.has())
      {
        ...
        {
          a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, localArrayList, paramList1, paramStringBuilder, paramMsg, paramazmj, paramBoolean);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          if ((i != 0) && (localElem.text.has()) && (paramList != null))
          {
            ...
            try
            {
              ((MessageRecord)paramList1.get(paramList1.size() - 1)).msgData = akwb.a(paramList);
              if (QLog.isColorLevel()) {
  ...
  public void a(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localObject = (MessageForShakeWindow)axaq.a(-2020);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((paramStringBuilder.uint32_sys_head_id.has()) && (paramStringBuilder.uint32_head_flag.has()))
          {
            ...
            paramList = (akvr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(199);
  ...
  public void a(im_msg_body.Elem paramElem, im_msg_body.CustomFace paramCustomFace, List<MessageRecord> paramList, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, azmj paramazmj)
  {
    if (paramElem != null) {}
    for (boolean bool1 = paramElem.hc_flash_pic.has();; bool1 = false)
    {
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        if (paramBoolean)
        {
          ...
          axrl.a(BaseApplication.getContext()).a(paramCustomFace, "actMessageEvent", false, 0L, 0L, paramElem, "");
          if (QLog.isColorLevel()) {
        ...
        bbdm.a((byte[])localObject1);
        bbdm.a((byte[])localObject3);
        int i3 = paramCustomFace.uint32_origin.get();
        localObject3 = ayvu.a(paramElem, 0L, 1, false, paramElem, (String)localObject2, "picplatform", str3, str4, str1, str2, i3, 0);
        localObject1 = new RichMsg.PicRec();
        ((RichMsg.PicRec)localObject1).localPath.set(paramElem);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              {
                paramElem = (MessageForPic)axaq.a(-5015);
                ...
                paramElem.istroop = 1;
                paramCustomFace = (bagr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
                if (paramCustomFace != null) {
                  paramCustomFace.a((bahf)paramElem, false);
                }
                i = 1;
                if (i == 0)
                {
                ...
                if (bool1) {
                  ajyk.a(paramElem, false);
                }
                if (bool2) {
                  ajwd.a(paramElem, false);
                }
                if (paramazmj != null) {
                  paramElem.istroop = paramazmj.jdField_a_of_type_Int;
                }
                paramElem.msgData = ((RichMsg.PicRec)localObject1).toByteArray();
                paramElem.parse();
                paramList.add(paramElem);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramList1 = (bagr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
          if (paramList1 != null) {
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      paramList = (MessageForLightVideo)axaq.a(-2071);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
        ...
        do
        {
          do
          {
            ...
            default: 
              return;
            case 3: 
              paramList = BaseApplication.getContext().getString(2131694855);
              paramStringBuilder = (MessageForText)axaq.a(-1000);
          ...
          i = bbmj.a((byte[])localObject3, 1);
          j = localObject3[3];
          localObject2 = new byte[i - 1];
          bbmj.a((byte[])localObject2, 0, (byte[])localObject3, 4, i - 1);
      ...
      paramMsg = (MessageForPubAccount)axaq.a(-3006);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            paramMsg.msgData = seq.a(paramStringBuilder);
          ...
          for (;;)
          {
            ...
            int i1 = bbmj.a(localStringBuilder, i + 1);
            j = k - (i1 + 3);
            k = i1 + 3 + i;
            if (n != 1)
            {
            ...
            else
            {
              ...
              bbmj.a(paramList, 0, localStringBuilder, i + 3, i1);
          ...
          try
          {
            ...
            paramStringBuilder.dspFileName = apue.a(paramStringBuilder.dspFileName);
            paramStringBuilder.dspFileSize = new String(((ByteStringMicro)paramList.rpt_bytes_abstact.get(0)).toByteArray());
            baje.a(paramMsg.msg_head.group_info.group_code.get()).a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramStringBuilder.fileUrl, paramStringBuilder);
            ...
            if (paramList != null)
            {
              ...
              localObject2 = (MessageForTroopFile)axaq.a(-2017);
              ((MessageForTroopFile)localObject2).msgtype = -2017;
              ((MessageForTroopFile)localObject2).msg = ajyc.a(2131706649);
            }
          }
          catch (Exception localException1)
          {
            try
            {
              ((MessageForTroopFile)localObject2).msgData = akwb.a(paramStringBuilder);
  ...
  public void b(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    int j = 0;
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (int i = ((im_msg_body.CommonElem)localObject1).uint32_business_type.get();; i = 0)
      {
        ...
        try
        {
          ...
          {
            g(paramList, paramList1, paramStringBuilder, paramMsg, paramazmj);
            return;
          }
        }
        catch (InvalidProtocolBufferMicroException paramList)
        ...
        localObject1 = null;
        localObject2 = axwh.a((byte[])localObject2, -1);
        if (localObject2 != null)
        {
          ...
          if (i > 0)
          {
            ...
            localObject3 = (MessageForArkFlashChat)axaq.a(-5013);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          try
          {
            ...
            f1 = f2;
            i2 = i5;
            localArrayList.add(Long.valueOf(bbbd.a(((Integer)localIterator.next()).intValue())));
            continue;
          ...
          localApolloMessage.peer_uin = bbbd.a(localApolloActMsg.uint32_peer_uin.get());
          localApolloMessage.sender_ts = bbbd.a(localApolloActMsg.uint32_sender_ts.get());
          localApolloMessage.peer_ts = bbbd.a(localApolloActMsg.uint32_peer_ts.get());
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = axuy.a(((im_msg_body.MarketTrans)localObject1).bytes_xml.get().toByteArray(), i);
      if (localObject1 == null)
      {
        if (QLog.isColorLevel()) {
          paramStringBuilder.append("c2cMsgContent.data:null;\n");
      ...
      paramList = (MessageForStructing)axaq.a(-2011);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)paramMsg.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForScribble)axaq.a(-7001);
  ...
  public void c(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    Object localObject1 = null;
    Object localObject2 = paramList.iterator();
    Object localObject3;
    ...
    if (((hummer_commelem.MsgElemInfo_servtype19)localObject2).bytes_data.has())
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (i > 0)
        {
          ...
          localObject3 = (MessageForArkBabyqReply)axaq.a(-5016);
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      ...
      localMessageForIncompatibleGrayTips = (MessageForIncompatibleGrayTips)axaq.a(-5002);
  ...
  public void d(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            return;
            paramList = (MessageForText)axaq.a(-1000);
            paramList.msgtype = -1000;
            paramList.msg = BaseApplication.getContext().getString(2131693795);
            paramList1.add(paramList);
            return;
            if (ArkAppCenter.b())
            {
            ...
            localObject4 = (MessageForArkApp)axaq.a(-5008);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (paramList = (im_msg_body.CommonElem)localElem.common_elem.get();; paramList = null)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        paramList = (MessageForQQStoryComment)axaq.a(-2052);
  ...
  public void e(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    Object localObject2 = null;
    Object localObject3 = paramList.iterator();
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject3 = axwh.a((byte[])localObject3, -1);
        if (localObject3 != null)
        {
  ...
  public void f(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    ...
    for (localObject1 = (im_msg_body.QQWalletMsg)((im_msg_body.Elem)localObject2).qqwallet_msg.get();; localObject1 = null)
    {
      ...
      if (n > 2000)
      {
        ...
        localMessageForQQWalletMsg = (MessageForQQWalletMsg)axaq.a(-2025);
        localMessageForQQWalletMsg.msgtype = -2025;
      ...
      for (int i = 1;; i = 0)
      {
        if ((i != 0) && (paramazmj != null) && (paramazmj.c != null))
        {
          paramazmj.c.a(paramMsg.msg_head.msg_seq.get(), localMessageForQQWalletMsg.msgseq);
          localMessageForQQWalletMsg.mMessageInfo = paramazmj;
        }
        ...
        for (;;)
        {
          ...
          localObject2 = (agvz)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(125);
          if (localObject2 != null) {
            ((agvz)localObject2).a((im_msg_body.QQWalletAioBody)((im_msg_body.QQWalletMsg)localObject1).aio_body.get(), j, l, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_time.get(), i, str1);
          }
          label766:
          localMessageForQQWalletMsg.msg = localMessageForQQWalletMsg.getMsgSummary();
          localMessageForQQWalletMsg.msgData = localMessageForQQWalletMsg.getBytes();
        ...
        for (localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getCurrentAccountUin();; localObject2 = "")
        {
          if ((n == 10) && (localMessageForQQWalletMsg.mQQWalletTransferMsg.elem != null) && (!TextUtils.isEmpty(localMessageForQQWalletMsg.mQQWalletTransferMsg.elem.nativeAndroid)))
          {
            ...
            {
              agwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)((HashMap)localObject3).get("tokenid"), ((im_msg_body.QQWalletMsg)localObject1).aio_body.uint64_senduin.get());
              if ((l == 0L) || (TextUtils.isEmpty((CharSequence)localObject2)) || (((String)localObject2).compareTo("" + l) == 0)) {
                break;
              }
              axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.payaio.buyershow", 0, 0, "", "", "", "");
              break;
            }
          }
          ...
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.askaio.payershow", 0, 0, "", "", "", "");
          break label766;
          label1423:
          ...
          if (paramList1.isEmpty())
          {
            i(paramList, paramList1, paramStringBuilder, paramMsg, paramazmj);
            return;
          }
          paramList1.add(localMessageForQQWalletMsg);
          return;
    ...
    for (;;)
    {
      ...
      for (paramList = new hummer_commelem.MsgElemInfo_servtype16();; paramList = ((im_msg_body.Text)localObject).str.get().toStringUtf8()) {
        try
        {
          ...
          paramStringBuilder = (MessageForTroopStory)axaq.a(-2057);
  ...
  public void g(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (String str = ((ByteStringMicro)localObject1).toStringUtf8();; str = "")
          {
            ...
            {
              if ((!bbjw.a((String)localObject4)) && (!bbjw.a((String)localObject1)) && (!bbjw.a(str)))
              {
              ...
              for (boolean bool = true;; bool = false)
              {
                ...
                if ((((axau)localObject1).jdField_a_of_type_Int == 1008) && (QLog.isColorLevel()))
                {
                ...
                for (i = 0;; i = localObject6.length)
                {
                  ...
                  try
                  {
                    ...
                    localObject7 = bbbd.a((byte[])localObject4);
                    if (QLog.isColorLevel()) {
                    ...
                    ((ajsk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53)).a((byte[])localObject4);
                  }
                  catch (Exception localException2)
                  {
                    for (;;)
                    {
                      if (QLog.isColorLevel())
                      {
                        ...
                        {
                          if ((((axau)localObject1).jdField_a_of_type_Int == 1008) && (!TextUtils.isEmpty(str)))
                          {
                            if (QLog.isColorLevel()) {
                              QLog.d("PaOldLongMsg", 2, "msgId=" + localMessageForStructing.uniseq + ", begin getEmptyGeneralStructMsg for PA oldLongMsg!");
                            }
                            localMessageForStructing.structingMsg = ((StructMsgForGeneralShare)axuy.a());
                        ...
                        else
                        {
                          ...
                          localMessageForStructing.structingMsg = axuy.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, m, l2, (byte[])localObject6, -1);
                          if (QLog.isColorLevel()) {
                ...
                {
                  paramList = (MessageForTroopFee)axaq.a(-2036);
                ...
                {
                  if (QLog.isColorLevel()) {
                    QLog.d(akbk.class.getSimpleName(), 2, "Received flower message");
                  }
                ...
                {
                  if (QLog.isColorLevel()) {
                    QLog.i(akbk.class.getSimpleName(), 2, "decodePBMsgElems, groupCode:" + l2);
                  }
                  l3 = l1;
                  if (l2 <= 0L)
                  {
                    ...
                    paramList1.add(((akbk)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getManager(124)).a(Long.toString(l1), Long.toString(l2), localMessageForStructing.istroop, localMessageForStructing.structingMsg));
                    l3 = l1;
                  }
                  label2239:
                  label2281:
                  do
                  {
                    for (;;)
                    {
                      ...
                      {
                        if (2171946401L == l3) {
                          sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForStructing, 11);
                        }
                      ...
                      if ((localMessageForStructing.structingMsg.mMsgServiceID == 80) && ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare)))
                      {
                        if (ssw.i())
                        {
                          paramList = (MessageForQQStory)axaq.a(-2051);
                        ...
                        if (localObject3 != null)
                        {
                          ((im_msg_body.Text)localObject3).str.set(ByteStringMicro.copyFromUtf8(ssw.a()));
                          return;
                        }
                        l3 = l1;
                        if (QLog.isColorLevel())
                      ...
                      else
                      {
                        ...
                        {
                          paramList = (MessageForTribeShortVideo)axaq.a(-7002);
                        ...
                        {
                          paramList = (MessageForTroopPobing)axaq.a(-2059);
                          ...
                          try
                          {
                            ...
                            paramList1.add(paramList);
                            localMessageForStructing.structingMsg = null;
                            new axra(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_obj").a(new String[] { l2 + "" }).a();
                            new axra(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_welcome").a(new String[] { l2 + "", "", "" + bamn.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2)) }).a();
                            return;
                          }
                        ...
                        {
                          paramList = (MessageForTroopSign)axaq.a(-2054);
                        ...
                        if (localMessageForStructing.structingMsg.mMsgServiceID != 43)
                        {
                          if (((localMessageForStructing.structingMsg.mMsgServiceID == 83) || (localMessageForStructing.structingMsg.mMsgServiceID == 108) || (localMessageForStructing.structingMsg.mMsgServiceID == 114) || (localMessageForStructing.structingMsg.mMsgServiceID == 116)) && (!TextUtils.isEmpty(localMessageForStructing.structingMsg.mMsgActionData)))
                          {
                            ...
                            noo.a(null, "", "0X8007238", "0X8007238", 0, 0, (String)localObject1, "", "", "");
                            noo.a("0X8007238", "", (String)localObject1, "", "", "");
                          ...
                          else
                          {
                            ...
                            if ((localMessageForStructing.structingMsg instanceof StructMsgForGeneralShare))
                            {
                              ...
                              baey.a().a((String)localObject3, null);
                              baey.a().a(((StructMsgForGeneralShare)localObject2).atMembers);
                              l3 = l1;
                            }
                          }
                        }
                  ...
                  {
                    paramazmj = new generalflags.ResvAttr();
                    paramazmj.mergeFrom(localGeneralFlags.bytes_pb_reserve.get().toByteArray());
                    paramStringBuilder = paramMsg;
                    j = m;
                    if (paramazmj.bytes_kpl_info.has())
                    {
                      paramStringBuilder = paramMsg;
                      j = m;
                      if (paramazmj.bytes_kpl_info.has())
                      {
                        j = 1;
                        paramStringBuilder = paramazmj.bytes_kpl_info.get().toStringUtf8();
                      }
                    }
                    paramList = paramStringBuilder;
                    i = j;
                    if (paramazmj.bytes_oac_msg_extend.has())
                    {
                      localMessageForStructing.saveExtInfoToExtStr("report_key_bytes_oac_msg_extend", paramazmj.bytes_oac_msg_extend.get().toStringUtf8());
                      i = j;
                      paramList = paramStringBuilder;
                    }
                  }
                  ...
                  if (k != 0)
                  {
                    ...
                    try
                    {
                      ...
                      {
                        paramList = (ChatMessage)axaq.a(-1051);
                        ...
                        if (paramStringBuilder != null)
                        {
                          ...
                          for (;;)
                          {
                            if (paramStringBuilder.hasNext())
                            {
                              paramMsg = (axun)paramStringBuilder.next();
                              if ((paramMsg instanceof axuo))
                              {
                                paramMsg = ((axuo)paramMsg).jdField_a_of_type_JavaUtilArrayList;
                                if (paramMsg != null)
                                {
                                  paramMsg = paramMsg.iterator();
                                  if (paramMsg.hasNext())
                                  {
                                    paramazmj = (axun)paramMsg.next();
                                    if (!(paramazmj instanceof StructMsgItemTitle)) {
                                      break;
                                    }
                                    paramList.msg = ((StructMsgItemTitle)paramazmj).b();
                                    if (QLog.isDevelopLevel())
                                    {
  ...
  public void h(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    Object localObject2 = null;
    ...
    for (localObject1 = (im_msg_body.GeneralFlags)((im_msg_body.Elem)localObject7).general_flags.get();; localObject1 = localObject2)
    {
      ...
      localObject1 = null;
      int i = 0;
      localObject7 = (MessageForPubAccount)axaq.a(-3006);
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((((im_msg_body.Elem)localObject3).text.has()) && (((im_msg_body.Elem)localObject3).text.str.has()))
        {
          ...
          ((MessageForPubAccount)localObject7).msgData = seq.a((PAMessage)localObject3);
        }
      }
      for (;;)
      {
        ...
        if (((im_msg_body.Elem)localObject3).trans_elem_info.has())
        {
          ...
          if (localObject3[0] == 1)
          {
            ...
            bbmj.a((byte[])localObject6, 0, (byte[])localObject3, 4, i - 1);
          ...
          for (;;)
          {
            ...
            if (localObject1 != null)
            {
              ...
              ((MessageForPubAccount)localObject7).msgData = seq.a((PAMessage)localObject1);
            }
            if (i != 0)
            {
  ...
  public void i(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, azmj paramazmj)
  {
    String str = null;
    int k = 0;
    Object localObject1 = paramList.iterator();
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      {
        str = bbdm.a(localElem.text.str.get().toByteArray());
        label264:
        n = k;
        if (localElem.text.has())
        {
    ...
    for (;;)
    {
      ...
      break label264;
      Object localObject2 = null;
      localObject1 = new axan();
      ArrayList localArrayList1 = ((axan)localObject1).jdField_a_of_type_JavaUtilArrayList;
      ArrayList localArrayList2 = new ArrayList(2);
      Object localObject3 = a(null, paramList, paramStringBuilder, paramMsg.msg_head.msg_seq.get(), paramazmj, (axan)localObject1, localArrayList2);
      localObject1 = localObject2;
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localGeneralFlags.uint32_prp_fold.get() == 1)
          {
            ...
            bool1 = agvz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if ((j == 0) || (!agvz.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app))) {
              break label1894;
            }
            ...
            bool1 = true;
            if (QLog.isColorLevel()) {
              QLog.d("msgFold", 2, String.format("Recv, recv foldMsg, redBagSender: %s, foldFlag: %s, redBagId: %s, index: %s, foldSwitch: %s, isValidFoldMsg: %s", new Object[] { Long.valueOf(l1), Boolean.valueOf(bool2), paramList, paramStringBuilder, Boolean.valueOf(agvz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), Boolean.valueOf(bool1) }));
            }
            ...
            paramazmj = new MessageForFoldMsg();
            ((MessageForFoldMsg)paramazmj).init(bool1, paramList, paramStringBuilder, l1, true);
            paramList = paramazmj;
        ...
        {
          paramStringBuilder = localGeneralFlags.babyq_guide_msg_cookie.get().toByteArray();
          paramMsg = bbbd.a(paramStringBuilder);
          if (QLog.isColorLevel()) {
        ...
        if ((!TextUtils.isEmpty(paramStringBuilder)) && (bool1))
        {
          ...
          {
            paramList = (ChatMessage)axaq.a(-1000);
            if ((paramazmj != null) && (localArrayList2 != null)) {
              bafh.a(paramazmj.jdField_a_of_type_Int, localArrayList2, paramList);
            }
            if (localArrayList1.size() > 0)
            {
              paramStringBuilder = new ArrayList(localArrayList1.size());
              paramazmj = localArrayList1.iterator();
              while (paramazmj.hasNext())
              {
                localObject2 = paramazmj.next();
  ...
  public void j(List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder)
  {
    ...
    for (;;)
    {
      ...
      {
        paramStringBuilder.mergeFrom(paramList.bytes_pb_elem.get().toByteArray());
        localMessageForLimitChatConfirm = (MessageForLimitChatConfirm)axaq.a(-7005);
