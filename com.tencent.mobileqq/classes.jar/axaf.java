...
{
  public axaf(String paramString)
  {
    super(paramString);
  }
  ...
  public int a(String paramString)
  {
    ...
    //   4: istore_2
    //   5: aload_0
    //   6: getfield 19	axaf:mInnerDbHelper	Lcom/tencent/mobileqq/persistence/EntityManagerFactory$SQLiteOpenHelperImpl;
    ...
    //   27: invokestatic 36	axcw:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   30: iconst_0
    //   31: ireturn
    //   32: iload 4
    //   34: istore_3
  ...
  public List<MsgBackupExtraEntity> a()
  {
    ...
    {
      axcw.a("MsgBackup_db", "db is null queryExtraInfo ...", new Object[0]);
  ...
  public List<MsgBackupMsgEntity> a(long paramLong, int paramInt)
  {
    ...
    if (localObject2 == null)
    {
      axcw.a("MsgBackup_db", "db is null queryMsg ..125.", new Object[0]);
      return new ArrayList();
    }
    localObject1 = ((SQLiteDatabase)localObject2).rawQuery((String)localObject1, null);
  ...
  public List<MsgBackupResEntity> a(long paramLong1, long paramLong2)
  {
    ...
    if (localObject2 == null)
    {
      axcw.a("MsgBackup_db", "db is null queryRes ...", new Object[0]);
      return new ArrayList();
    }
    localObject1 = ((SQLiteDatabase)localObject2).rawQuery((String)localObject1, null);
  ...
  public int b(String paramString)
  {
    ...
    //   28: invokestatic 36	axcw:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   31: iconst_0
    //   32: ireturn
    //   33: iload 4
    //   35: istore_3
  ...
  public List<MsgBackupResEntity> b(long paramLong, int paramInt)
  {
    ...
    if (localObject2 == null)
    {
      axcw.a("MsgBackup_db", "db is null queryRes ...135", new Object[0]);
      return new ArrayList();
    }
    localObject1 = ((SQLiteDatabase)localObject2).rawQuery((String)localObject1, null);
    localObject2 = a(MsgBackupResEntity.class, "res", (Cursor)localObject1, null);
  ...
  public void createDatabase(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    {
      axcw.b("MsgBackup_db", "db create is null", new Object[0]);
      return;
    }
