...
public class alhm
{
  ...
  public alhm()
  {
    ...
    this.jdField_a_of_type_Alhl = new alhl();
  ...
  public void a()
  {
    this.jdField_a_of_type_Int = -2;
    this.jdField_b_of_type_Int = -2;
    this.jdField_a_of_type_Alhl.b = 0.0F;
    this.jdField_a_of_type_Alhl.c = 0.0F;
    this.jdField_a_of_type_Alhl.jdField_a_of_type_Float = 0.0F;
    this.c = 0;
    this.d = 0;
    this.f = 10;
    this.g = 0;
