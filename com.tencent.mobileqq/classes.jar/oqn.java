...
public class oqn
{
  public static ProteusItemView a(VafContext paramVafContext, String paramString1, String paramString2)
  {
    ...
    {
      paramString2.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841262));
  ...
  public static ProteusItemView a(VafContext paramVafContext, String paramString, JSONObject paramJSONObject)
  {
    ...
    {
      paramJSONObject.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841262));
  ...
  public static TemplateBean a(VafContext paramVafContext, String paramString1, String paramString2)
  {
    ...
    rpr localrpr = (rpr)paramVafContext.getTemplateFactory();
    paramVafContext = localrpr;
    if (localrpr == null) {
      paramVafContext = rpr.a(paramString2, true);
    }
    if (paramVafContext != null) {}
    try
    {
      paramVafContext = paramVafContext.getTemplateBean(new pdm().a(paramString1).a());
  ...
  public static TemplateBean a(VafContext paramVafContext, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramVafContext = localrpr;
    if (localrpr == null) {
      paramVafContext = rpr.a(paramString, true);
    }
    if (paramVafContext != null) {}
    try
    {
  ...
  public static void a(ProteusItemView paramProteusItemView, VafContext paramVafContext, String paramString1, String paramString2)
  {
    ...
    paramProteusItemView.setTag(2131374825, paramString1);
    if (paramString1 != null) {
      olo.a(paramProteusItemView, localTemplateBean, paramString1);
    }
    olo.a(paramProteusItemView, paramVafContext, paramString1);
  }
}
