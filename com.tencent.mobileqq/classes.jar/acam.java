...
{
  private static volatile acam a;
  
  public static acam a()
  {
    if (a == null) {}
    try
    {
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    {
      acho.d("GdtPreLoader", "dealAdReltargetMatch error params error");
      return;
    }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    {
      acho.d("GdtPreLoader", "preloadCanvasJsonAfterAdLoaded error", paramGdtAd);
      return;
    }
    acho.d("GdtPreLoader", "preloadCanvasJsonAfterAdLoaded error");
  }
  ...
  {
    acho.a("GdtPreLoader", "preloadVideoAfterAdLoaded() called with: ad = [" + paramGdtAd + "]");
  ...
  {
    acim.a().a(BaseApplicationImpl.getContext(), null);
    if ((paramGdtAd != null) && (paramGdtAd.isInterstitial())) {}
    for (boolean bool = true;; bool = false)
    {
      acho.b("GdtPreLoader", String.format("preDownloadInterstitialAfterAdLoaded isInterstitial:%b", new Object[] { Boolean.valueOf(bool) }));
      if (bool) {
        accf.a().b(BaseApplicationImpl.getContext());
      }
      return;
    }
  }
