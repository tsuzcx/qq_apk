...
public class akqk
  extends aknt
{
  public akqk(CmGameLoadingFragment paramCmGameLoadingFragment, AppInterface paramAppInterface)
  {
  ...
  public void onDownloadConfirm(CmGameStartChecker.StartCheckParam paramStartCheckParam, aknu paramaknu, long paramLong)
  {
    ...
    CmGameLoadingFragment.a(this.a).a(paramStartCheckParam, paramaknu, paramLong);
  }
  ...
  {
    akrg.a().a(paramStartCheckParam, paramLong, null);
    if (CmGameLoadingFragment.a(this.a) != null) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          akrg.a().a(paramStartCheckParam, paramLong, paramCmGameInitParams);
