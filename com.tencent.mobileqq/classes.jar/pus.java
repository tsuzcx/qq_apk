...
public class pus
{
  static void a(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo)
  {
    if (paramRspBody.bytes_proteus_json_data.has())
    {
      ...
      if (!TextUtils.isEmpty(paramRspBody))
      {
        ...
        svu.a(paramRspBody, paramFastWebArticleInfo.jdField_a_of_type_AndroidUtilSparseArray);
      }
    }
  }
  
  static void a(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, pup parampup)
  {
    if (paramRspBody.rpt_msg_style_card.has())
    {
      ...
      if (parampup != null) {
        parampup.a(paramFastWebArticleInfo.j);
      }
    }
  }
  
  static void a(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, pup parampup, String paramString)
  {
    if (paramRspBody.msg_rsp_biu_count.has())
    {
      ...
      if (parampup != null) {
        parampup.a(paramFastWebArticleInfo.c, paramString);
      }
    }
  }
  
  static void b(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, pup parampup)
  {
    Object localObject;
    int i;
    ...
    for (paramRspBody = ((oidb_cmd0xb54.ArticleBusiness)localObject).bytes_business_cash_info.get().toStringUtf8();; paramRspBody = "")
    {
      ...
      if (parampup != null) {
        parampup.a(paramFastWebArticleInfo, i, paramRspBody);
      }
      return;
      if (parampup != null) {
        parampup.a(paramFastWebArticleInfo, 0, "");
      }
  ...
  static void b(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, pup parampup, String paramString)
  {
    if (paramRspBody.uint32_like_count.has())
    {
      paramFastWebArticleInfo.jdField_a_of_type_Int = paramRspBody.uint32_like_count.get();
      if (parampup != null) {
        parampup.a(paramFastWebArticleInfo.jdField_a_of_type_Int, paramString);
      }
      QLog.d("FastWebModuleUtils", 2, "0xb54 resp like count is : " + paramFastWebArticleInfo.jdField_a_of_type_Int);
    }
  }
  
  static void c(oidb_cmd0xb54.RspBody paramRspBody, FastWebArticleInfo paramFastWebArticleInfo, pup parampup, String paramString)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      if (parampup != null) {
        parampup.a(paramFastWebArticleInfo.jdField_a_of_type_Boolean, paramString);
      }
