...
public class uku
{
  ...
  public static Object a(GdtAd paramGdtAd)
  {
    ...
    return achn.a((qq_ad_get.QQAdGetRsp.AdInfo)((qq_ad_get.QQAdGetRsp.PosAdInfo)paramGdtAd.getGdtAdLoader().a().a.pos_ads_info.get(0)).ads_info.get(0));
  }
  ...
  public qq_ad_get.QQAdGet a(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt1, int paramInt2)
  {
    ...
    ((qq_ad_get.QQAdGet.PositionInfo.PositionExt.ShareInfo)localObject1).share_check.set(acai.a(paramLong2, paramLong3, paramInt2));
  ...
  public void a(Activity paramActivity, int paramInt1, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    try
    {
      paramString1 = (qq_ad_get.QQAdGetRsp.AdInfo)achn.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramString1));
      GdtMotiveVideoPageData localGdtMotiveVideoPageData = achl.a(paramString1, achl.a(paramInt1));
  ...
  public void a(Activity paramActivity, String paramString, long paramLong1, long paramLong2, int paramInt1, int paramInt2, acaq paramacaq)
  {
    try
    {
      Object localObject = new acee();
      ((acee)localObject).jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet = a(Long.parseLong(amwn.a().getCurrentAccountUin()), paramString, paramLong1, paramLong2, paramInt1, paramInt2);
      ((acee)localObject).jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = a(true, paramActivity);
      localObject = new GdtMotiveVideoAd((acee)localObject);
      ((GdtMotiveVideoAd)localObject).setListener(new WeakReference(paramacaq));
