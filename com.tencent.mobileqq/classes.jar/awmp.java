...
public class awmp
{
  ...
  static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, LatLng paramLatLng1, LatLng paramLatLng2)
  {
    if (a())
    {
      ...
      catch (Exception localException)
      {
        ...
        bdla.b(null, "CliOper", "", "", "0X800A972", "0X800A972", 1, 0, "0", "0", "0", "");
      }
    }
    for (;;)
    {
      ...
      return;
      bdla.b(null, "CliOper", "", "", "0X800A972", "0X800A972", 2, 0, "0", "0", "0", "");
    }
  }
  ...
  {
    if (a == null) {
      a = Boolean.valueOf(bkyz.a(MobileQQ.sMobileQQ, "com.tencent.map"));
    }
