  ...
  extends aomz
{
  ...
  ayvj jdField_a_of_type_Ayvj = null;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public aofo(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
  }
  
  private long a(@NonNull HashMap<String, String> paramHashMap, bepr parambepr, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong1, long paramLong2, int paramInt, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if ((bbzj.c(paramInt)) || (paramInt == 208)) {
      a(paramHashMap, parambepr, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
    }
    do
    {
      return paramLong2;
      if ((paramInt == 82) || (paramInt == 43))
      {
        ...
        c(paramHashMap, parambepr, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
        return paramLong2;
      }
    } while ((paramInt != 83) && (paramInt != 42));
    paramLong2 = paramMsgHead.discuss_info.discuss_uin.get();
    b(paramHashMap, parambepr, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
    return paramLong2;
  }
  ...
  private MessageRecord a(MessageRecord paramMessageRecord1, msg_comm.MsgHead paramMsgHead, ArrayList<MessageRecord> paramArrayList, int paramInt, MessageRecord paramMessageRecord2)
  {
    ...
    if (!bahv.a(paramMessageRecord1))
    {
      localMessageRecord = paramMessageRecord2;
      if (!awwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)paramMessageRecord2))
      {
        localMessageRecord = paramMessageRecord2;
        if (!(paramMessageRecord2 instanceof MessageForArkApp))
        {
          ...
          localMessageRecord = bbzh.a(-1000);
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, bepr parambepr, msg_comm.MsgHead paramMsgHead, long paramLong, int paramInt, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, MessageRecord paramMessageRecord)
  {
    int i = paramMsgHead.c2c_cmd.get();
    if ((paramInt == 529) && (i == 4)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramArrayList, ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.get());
    }
    for (;;)
    {
      parambepr = paramString;
      if (paramMsgHead.from_nick.has())
      {
        parambepr = paramString;
        if (paramHashMap != null)
        {
          parambepr = paramMsgHead.from_nick.get();
      ...
      return parambepr;
      if ((i == 175) || (i == 11)) {
        bbzf.a(paramMessageHandler, paramArrayList, paramMsg, true, false, parambepr);
      }
    }
  }
  
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bepr parambepr, msg_comm.MsgHead paramMsgHead, long paramLong, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    paramMsgHead.discuss_info.discuss_uin.get();
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(paramArrayList, paramMsg)) {
      bbzf.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambepr);
    }
    parambepr = paramString;
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, msg_comm.MsgHead paramMsgHead, long paramLong, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, bepr parambepr)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramArrayList, paramMsg)) {
      bbzf.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambepr);
    }
    parambepr = paramString;
            ...
            if (paramHashMap.anon_group_msg.has())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  paramHashMap = "";
                  paramMessageHandler.saveExtInfoToExtStr("anonymous", njo.a(i, paramMsg, paramHashMap, j, k, paramMsgHead));
  ...
  @Nullable
  private im_msg_body.RichText a(MessageForMixedMsg paramMessageForMixedMsg)
  {
    ...
    if (i < k)
    {
      ...
      {
        localObject = bbzf.a((MessageForText)localObject);
        if (localObject == null) {
          return null;
        }
        j = 0;
      ...
      for (;;)
      {
        ...
        {
          localObject = bbzf.a((MessageForReplyText)localObject);
          if (localObject != null)
          {
            j = 0;
            while (j < ((im_msg_body.RichText)localObject).elems.size())
  ...
  {
    im_msg_body.RichText localRichText = bbzf.a(paramMessageForStructing);
    try
    {
      ...
      else
      {
        ...
        for (Object localObject = localArrayList;; localObject = null)
        {
          ...
          while (paramMessageForStructing.hasNext())
          {
            ...
            if (awwt.a((ChatMessage)localObject))
            {
              if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, msg_comm.Msg paramMsg, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107))
    {
      if ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 3000)) {
        new bbzt().a(paramMessageHandler, paramMsg, paramArrayList, null);
      }
    }
    else {
      return;
    }
    new bbzy().a(paramMessageHandler, paramMsg, paramArrayList, null);
  }
  ...
  private void a(MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText)
  {
    if (njo.a(paramMessageRecord))
    {
      ...
      localAnonymousGroupMsg.uint32_flags.set(localnjp.jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(localnjp.jdField_a_of_type_JavaLangString)) {
        localAnonymousGroupMsg.str_anon_id.set(ByteStringMicro.copyFrom(localnjp.jdField_a_of_type_JavaLangString.getBytes()));
      }
      if (!TextUtils.isEmpty(localnjp.jdField_b_of_type_JavaLangString)) {
        localAnonymousGroupMsg.str_anon_nick.set(ByteStringMicro.copyFrom(localnjp.jdField_b_of_type_JavaLangString.getBytes()));
      }
      localAnonymousGroupMsg.uint32_head_portrait.set(localnjp.jdField_b_of_type_Int);
      localAnonymousGroupMsg.uint32_expire_time.set(localnjp.jdField_c_of_type_Int);
      if (!TextUtils.isEmpty(localnjp.jdField_c_of_type_JavaLangString)) {
        localAnonymousGroupMsg.str_rank_color.set(ByteStringMicro.copyFrom(localnjp.jdField_c_of_type_JavaLangString.getBytes()));
      }
  ...
  private void a(@NonNull HashMap<String, String> paramHashMap, bepr parambepr, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    int i = paramMsgHead.c2c_cmd.get();
    if ((i == 175) || (i == 11))
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    } while (!atvo.a(paramQQAppInterface, (MessageForFile)paramChatMessage).sendCloudUnsuccessful());
    return false;
    return false;
  }
  ...
  public static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    //   22: aload_0
    //   23: arraylength
    //   24: invokevirtual 377	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   33: new 646	java/io/ByteArrayInputStream
    //   36: dup
    //   37: aload_0
    //   38: invokespecial 647	java/io/ByteArrayInputStream:<init>	([B)V
    //   41: astore_3
    //   42: new 649	java/io/ByteArrayOutputStream
    //   45: dup
    //   46: invokespecial 650	java/io/ByteArrayOutputStream:<init>	()V
    //   49: astore 4
    //   51: sipush 1024
    //   54: newarray byte
    //   56: astore_0
    //   57: new 652	java/util/zip/GZIPOutputStream
    //   60: dup
    //   61: aload 4
    //   63: invokespecial 655	java/util/zip/GZIPOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   66: astore_2
    //   67: aload_3
    //   68: aload_0
    //   69: iconst_0
    //   70: sipush 1024
    //   73: invokevirtual 659	java/io/ByteArrayInputStream:read	([BII)I
    //   76: istore_1
    //   77: iload_1
    //   78: iconst_m1
    //   79: if_icmpeq +64 -> 143
    ...
    //   84: iconst_0
    //   85: iload_1
    //   86: invokevirtual 663	java/util/zip/GZIPOutputStream:write	([BII)V
    //   89: goto -22 -> 67
    //   92: astore_2
    //   93: aconst_null
    //   94: astore_0
    //   95: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   98: ifeq +32 -> 130
    //   101: ldc 134
    //   103: iconst_2
    ...
    //   117: aload_2
    //   118: invokevirtual 668	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   121: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   124: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   127: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   130: aload 4
    //   132: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   135: aload_3
    //   136: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   139: aload_0
    //   140: astore_2
    //   141: aload_2
    //   142: areturn
    //   143: aload_2
    //   144: invokevirtual 675	java/util/zip/GZIPOutputStream:flush	()V
    //   147: aload_2
    //   148: invokevirtual 676	java/util/zip/GZIPOutputStream:close	()V
    //   151: aload 4
    //   153: invokevirtual 677	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   156: astore_0
    //   157: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   160: ifeq +30 -> 190
    //   163: ldc 134
    //   165: iconst_2
    //   166: new 136	java/lang/StringBuilder
    //   169: dup
    //   170: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   173: ldc_w 679
    //   176: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: aload_0
    //   180: arraylength
    //   181: invokevirtual 377	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   184: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   187: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   190: aload 4
    //   192: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   195: aload_3
    //   196: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   199: aload_0
    //   200: areturn
    //   201: astore_3
    //   202: aload_0
    //   203: astore_2
    //   204: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   207: ifeq -66 -> 141
    //   210: ldc 134
    //   212: iconst_2
    ...
    //   226: aload_3
    //   227: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   236: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   239: aload_0
    //   240: areturn
    //   241: astore_3
    //   242: aload_0
    //   243: astore_2
    //   244: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   247: ifeq -106 -> 141
    //   250: ldc 134
    //   252: iconst_2
    //   253: new 136	java/lang/StringBuilder
    //   256: dup
    //   257: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   260: ldc_w 681
    //   263: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   266: aload_3
    //   267: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   276: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   279: aload_0
    //   280: areturn
    //   281: astore_2
    //   282: aconst_null
    //   283: astore_0
    //   284: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   287: ifeq +32 -> 319
    //   290: ldc 134
    //   292: iconst_2
    //   293: new 136	java/lang/StringBuilder
    //   296: dup
    ...
    //   306: aload_2
    //   307: invokevirtual 685	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   310: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   313: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   316: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   319: aload 4
    //   321: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   324: aload_3
    //   325: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   328: aload_0
    //   329: areturn
    //   330: astore_3
    //   331: aload_0
    //   332: astore_2
    //   333: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   336: ifeq -195 -> 141
    //   339: ldc 134
    //   341: iconst_2
    //   342: new 136	java/lang/StringBuilder
    //   345: dup
    //   346: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   349: ldc_w 681
    //   352: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   355: aload_3
    //   356: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    //   359: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   362: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   365: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   368: aload_0
    //   369: areturn
    //   370: astore_0
    //   371: aload 4
    //   373: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   376: aload_3
    //   377: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   380: aload_0
    //   381: athrow
    //   382: astore_2
    //   383: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   386: ifeq -6 -> 380
    //   389: ldc 134
    //   391: iconst_2
    //   392: new 136	java/lang/StringBuilder
    //   395: dup
    //   396: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   399: ldc_w 681
    //   402: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   405: aload_2
    //   406: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    //   409: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   412: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   415: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   418: goto -38 -> 380
    //   421: astore_2
    //   422: goto -138 -> 284
    //   425: astore_2
  ...
  private void b(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessageForStructing.hasNext())
      {
        ...
        if (!awwt.a((ChatMessage)localMessageRecord1)) {
          continue;
        }
        if (paramInt != 2) {
          break label214;
        }
        MessageRecord localMessageRecord2 = a(localMessageRecord1, awwk.jdField_a_of_type_JavaLangString, false);
  ...
  private void b(@NonNull HashMap<String, String> paramHashMap, bepr parambepr, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(paramArrayList, paramMsg)) {
      bbzf.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambepr);
    }
  ...
  public static byte[] b(byte[] paramArrayOfByte)
  {
    ...
    //   36: aconst_null
    //   37: astore 4
    //   39: new 646	java/io/ByteArrayInputStream
    //   42: dup
    //   43: aload_0
    //   44: invokespecial 647	java/io/ByteArrayInputStream:<init>	([B)V
    //   47: astore 6
    //   49: new 649	java/io/ByteArrayOutputStream
    //   52: dup
    //   53: invokespecial 650	java/io/ByteArrayOutputStream:<init>	()V
    //   56: astore 7
    //   58: aload 4
    //   60: astore_2
    //   61: aload 5
    ...
    //   74: aload 5
    //   76: astore_3
    //   77: new 735	java/util/zip/GZIPInputStream
    //   80: dup
    //   81: aload 6
    //   83: invokespecial 738	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   86: astore 9
    //   88: aload 4
    //   90: astore_2
    //   91: aload 5
    ...
    //   98: iconst_0
    //   99: sipush 1024
    //   102: invokevirtual 739	java/util/zip/GZIPInputStream:read	([BII)I
    //   105: istore_1
    //   106: iload_1
    //   107: iconst_m1
    ...
    //   121: iconst_0
    //   122: iload_1
    //   123: invokevirtual 740	java/io/ByteArrayOutputStream:write	([BII)V
    //   126: goto -38 -> 88
    //   129: astore_3
    //   130: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   133: ifeq +32 -> 165
    //   136: ldc 134
    //   138: iconst_2
    ...
    //   152: aload_3
    //   153: invokevirtual 668	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   162: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   165: aload 7
    //   167: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   170: aload 6
    //   172: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   175: aload_2
    ...
    //   186: astore_3
    //   187: aload 9
    //   189: invokevirtual 743	java/util/zip/GZIPInputStream:close	()V
    //   192: aload 4
    //   194: astore_2
    //   195: aload 5
    //   197: astore_3
    //   198: aload 7
    //   200: invokevirtual 677	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   203: astore 4
    //   205: aload 4
    //   207: astore_2
    //   208: aload 4
    //   210: astore_3
    //   211: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   214: ifeq +37 -> 251
    //   217: aload 4
    //   219: astore_2
    //   220: aload 4
    ...
    //   223: ldc 134
    //   225: iconst_2
    //   226: new 136	java/lang/StringBuilder
    //   229: dup
    //   230: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   233: ldc_w 745
    //   236: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   239: aload 4
    //   241: arraylength
    //   242: invokevirtual 377	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   245: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   248: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   251: aload 7
    //   253: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   256: aload 6
    //   258: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   261: aload 4
    //   263: astore_2
    //   264: goto -89 -> 175
    //   267: astore_2
    //   268: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   271: ifeq +32 -> 303
    //   274: ldc 134
    //   276: iconst_2
    //   277: new 136	java/lang/StringBuilder
    //   280: dup
    //   281: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   284: ldc_w 747
    //   287: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   290: aload_2
    //   291: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   300: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   303: aload 4
    //   305: astore_2
    //   306: goto -131 -> 175
    //   309: astore_3
    //   310: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   313: ifeq +32 -> 345
    //   316: ldc 134
    //   318: iconst_2
    //   319: new 136	java/lang/StringBuilder
    //   322: dup
    //   323: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   326: ldc_w 747
    //   329: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   332: aload_3
    //   333: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    //   336: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   339: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   342: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   345: goto -170 -> 175
    //   348: astore_2
    //   349: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   352: ifeq +32 -> 384
    //   355: ldc 134
    //   357: iconst_2
    ...
    //   371: aload_2
    //   372: invokevirtual 685	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   375: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   378: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   381: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   384: aload 7
    //   386: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   389: aload 6
    //   391: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   394: aload_3
    //   395: astore_2
    //   396: goto -221 -> 175
    //   399: astore_2
    //   400: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   403: ifeq +32 -> 435
    //   406: ldc 134
    //   408: iconst_2
    //   409: new 136	java/lang/StringBuilder
    //   412: dup
    //   413: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   416: ldc_w 747
    //   419: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   422: aload_2
    //   423: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    //   426: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   429: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   432: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   435: aload_3
    //   436: astore_2
    //   437: goto -262 -> 175
    //   440: astore_0
    //   441: aload 7
    //   443: invokevirtual 671	java/io/ByteArrayOutputStream:close	()V
    //   446: aload 6
    //   448: invokevirtual 672	java/io/ByteArrayInputStream:close	()V
    //   451: aload_0
    //   452: athrow
    //   453: astore_2
    //   454: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   457: ifeq -6 -> 451
    //   460: ldc 134
    //   462: iconst_2
    //   463: new 136	java/lang/StringBuilder
    //   466: dup
    //   467: invokespecial 137	java/lang/StringBuilder:<init>	()V
    //   470: ldc_w 747
    //   473: invokevirtual 143	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   476: aload_2
    //   477: invokevirtual 682	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   486: invokestatic 154	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   489: goto -38 -> 451
    //   492: aload_2
    //   493: areturn
    // Local variable table:
  ...
  private im_msg_body.RichText c(MessageRecord paramMessageRecord)
  {
    if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
      return bbzf.a(paramMessageRecord);
    }
    return bbzf.a((MessageForText)paramMessageRecord);
  }
  
  private void c(@NonNull HashMap<String, String> paramHashMap, bepr parambepr, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramArrayList, paramMsg)) {
      bbzf.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambepr);
    }
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, ProxyListener paramProxyListener, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramBoolean2)
      {
          ...
          else if (localMessageRecord.msgtype == -1035)
          {
            ...
            if (((MessageForMixedMsg)localObject1).getReplyMessage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != null)
            {
              ...
              if ((localObject1 != null) && (localObject2 != null)) {
                atwt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForReplyText)localObject1).getSourceMessage(), ((MessageForReplyText)localObject2).getSourceMessage());
              }
            }
          }
        ...
        if ((njo.a(paramArrayList)) && (njo.b(paramArrayList))) {
      ...
      atwt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramArrayList);
  ...
  public ArrayList<MessageRecord> a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bepr parambepr)
  {
    ...
    long l6 = bbzf.a(localMessageHandler, paramMsg, String.valueOf(l2), String.valueOf(l2));
    ArrayList localArrayList = new ArrayList();
    long l1;
    if (((bbzj.c(j)) || (j == 208) || (j == 529)) && (localMsgHead.c2c_cmd.has()))
    {
      paramHashMap = a(paramMsg, paramHashMap, parambepr, localMsgHead, l2, j, str, localMessageHandler, localArrayList, paramMessageRecord);
      l1 = l2;
    }
    for (;;)
    {
      int i = 0;
      int k = bbzf.a(paramMsg);
      ...
      for (;;)
      {
        ...
        parambepr = a(paramMessageRecord, localMsgHead, localArrayList, i, (MessageRecord)paramMsg.next());
        i += 1;
        parambepr.time = l4;
        parambepr.shmsgseq = l3;
        parambepr.msgUid = l5;
        parambepr.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        parambepr.senderuin = String.valueOf(l2);
        parambepr.frienduin = String.valueOf(l1);
        parambepr.vipBubbleDiyTextId = k;
        parambepr.vipBubbleID = anuk.a((int)l6, k);
        awwt.a(parambepr, paramHashMap, paramMessageRecord);
        if ((j == 82) || (j == 43))
        {
          parambepr.istroop = 1;
          continue;
          if (((j == 82) || (j == 43)) && (localMsgHead.group_info.has()))
          {
            ...
            paramHashMap = a(paramMsg, paramHashMap, paramMessageRecord, localMsgHead, l2, str, localMessageHandler, localArrayList, parambepr);
            break;
          }
          ...
          paramHashMap = a(paramMsg, paramHashMap, paramMessageRecord, parambepr, localMsgHead, l2, str, localMessageHandler, localArrayList);
          break;
        }
        if ((j == 83) || (j == 42)) {
          parambepr.istroop = 3000;
        } else {
          parambepr.istroop = 0;
        }
      }
  ...
  public ArrayList<MessageRecord> a(@NonNull byte[] paramArrayOfByte, @NonNull HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bepr parambepr)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          MessageHandler localMessageHandler = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
          long l5 = bbzf.a(localMessageHandler, (msg_comm.Msg)localObject3, String.valueOf(l1), String.valueOf(l1));
          localObject2 = new ArrayList();
          long l6 = a(paramHashMap, parambepr, (msg_comm.Msg)localObject3, (msg_comm.MsgHead)localObject4, l1, l1, j, localMessageHandler, (ArrayList)localObject2);
          a(paramMessageRecord, (msg_comm.Msg)localObject3, localMessageHandler, (ArrayList)localObject2);
          int k = bbzf.a((msg_comm.Msg)localObject3);
          ...
          ((MessageRecord)localObject4).vipBubbleID = anuk.a((int)l5, k);
          if ((j == 82) || (j == 43))
          {
        ...
        else
        {
          ...
          continue;
          anqc.a((List)localObject2);
          paramArrayOfByte.addAll((Collection)localObject2);
          i += 1;
        }
      }
    } while ((paramMessageRecord == null) && (paramArrayOfByte.size() == 1));
    label391:
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, ProxyListener paramProxyListener, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      {
        return localHashMap;
        if (awwt.a((ChatMessage)paramMessageRecord)) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bepr parambepr)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.msg.has())
      {
        ...
        {
          localObject3 = a((msg_comm.Msg)paramArrayOfByte.msg.get(i), paramHashMap, paramMessageRecord, parambepr);
    ...
    if (!a(paramMessageRecord, (HashMap)localObject1, null))
    {
      ...
      if (i < paramArrayOfByte.pbItemList.size())
      {
        ...
        try
        {
          ...
          {
            ArrayList localArrayList = a((msg_comm.Msg)((msg_transmit.PbMultiMsgNew)localObject3).msg.get(j), paramHashMap, paramMessageRecord, parambepr);
  ...
  public msg_comm.MsgHead a(MessageRecord paramMessageRecord, HashMap<String, String> paramHashMap, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    localMsgHead.from_uin.set(Long.valueOf(acwh.c(paramMessageRecord)).longValue());
    ...
    if (paramBoolean1)
    {
      ...
      String str = acwh.c(paramMessageRecord);
      ...
      awwt.a("step:packPb.getMsgHead.nickName = %s", new Object[] { localObject1 });
  ...
  public im_msg_body.MsgBody a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localRichText = bbzf.a((MessageForReplyText)paramMessageRecord);
      }
      else if (paramMessageRecord.msgtype == -2005)
      {
        ...
        {
          localMsgBody = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(1, paramMessageRecord);
          localRichText = null;
        }
      }
      ...
      {
        localRichText = bbzf.a((MessageForPic)paramMessageRecord);
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localRichText = bbzf.a((MessageForArkApp)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localRichText = bbzf.c((MessageForArkBabyqReply)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localRichText = bbzf.b((MessageForArkApp)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localRichText = bbzf.d((MessageForHiBoom)paramMessageRecord);
      }
      ...
      {
        localRichText = a((MessageForMixedMsg)paramMessageRecord);
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localRichText = bbzf.a((MessageForLongTextMsg)paramMessageRecord, false);
      }
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if (!awwt.a((ChatMessage)paramHashMap)) {
            break label610;
          }
          paramHashMap = a(paramHashMap, awwk.jdField_b_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
