...
public abstract class baiq
{
  public final String TAG;
  int mTaskStatus = 1;
  
  public baiq(String paramString)
  {
    this.TAG = (paramString + "_" + AudioHelper.b());
  }
  
  public static void requestSyncTask(Resources paramResources, ArrayList<baiq> paramArrayList, bair parambair)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localbaiq.isNeedRunTask()) {
        localArrayList.add(localbaiq);
      }
    }
    localIterator = localArrayList.iterator();
    while (localIterator.hasNext()) {
      ((baiq)localIterator.next()).setRunning();
    }
    ThreadManager.post(new SyncLoadTask.1(localArrayList, paramResources, parambair, paramArrayList), 8, null, true);
  }
