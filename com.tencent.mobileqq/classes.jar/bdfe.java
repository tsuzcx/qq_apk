  ...
  extends BusinessHandler
{
  ...
  public bdfe(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    bhyv localbhyv = new bhyv("QC.UniBusinessLogicServer.UniBusinessLogicObj", "QCUniBusinessLogic.uniSet", "stReq", "rsp");
    UniSetReq localUniSetReq = new UniSetReq();
    localUniSetReq.stLogin = bhyv.a();
    localUniSetReq.stUniBusinessItem = new UniBusinessItem();
    localUniSetReq.stUniBusinessItem.appid = 307;
    localUniSetReq.stUniBusinessItem.itemid = Integer.decode(bdfk.a(paramInt)).intValue();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      localbhyv.a("uniSet", localUniSetReq, new UniSetRsp(), paramBusinessObserver, false);
      return;
    }
  }
  ...
  public static void a(boolean paramBoolean1, int paramInt, QQAppInterface paramQQAppInterface, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    bdvn.a(paramBoolean3, paramQQAppInterface);
    ((bdve)paramQQAppInterface.getManager(QQManagerFactory.STUDY_MODE_SWITCHER_MANAGER)).b(paramBoolean3);
    paramBoolean2 = paramBoolean1;
    if (bdvn.a(paramQQAppInterface, paramBoolean3, paramBoolean1)) {
      paramBoolean2 = false;
    }
    int i = bdfk.a(String.valueOf(paramInt));
    if (i != -1)
    {
      bdfk.a(paramQQAppInterface.getCurrentAccountUin(), paramBoolean2, 1);
      bdfk.a(paramQQAppInterface.getCurrentAccountUin(), i, 1);
      return;
    }
    bdfk.a(paramQQAppInterface, paramBoolean2, String.valueOf(paramInt));
  }
      ...
      if (bool2)
      {
        ...
        if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()) && (paramToServiceMsg.uint32_result.get() == 0)) {
          if ((paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
          {
            ...
            if (bool2)
            {
              bdvn.a(bool5, this.app);
              bdfk.a(this.app.getCurrentAccountUin(), bool3, 3);
              bdfk.a(this.app.getCurrentAccountUin(), i, 3);
              bool1 = bool2;
            }
            if ((QLog.isColorLevel()) && (localStringBuilder != null)) {
            ...
            if (l == this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.get())
            {
              ...
              bool2 = a(false, "211", bdfk.b(), true, bdfk.a(bdfk.c()));
              if (!bool2) {
  ...
  public long a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    a(paramBoolean1, paramInt, new bdfg(this, paramBoolean1, paramInt, paramBoolean2, paramBoolean3, l));
    return l;
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5)
  {
    ...
    if (paramBoolean5) {
      if (localBaseActivity != null)
      {
        ...
        bhoy.a(localBaseActivity, arlj.a(), 1);
      }
    }
    label72:
    label78:
    do
    {
      ...
      paramInt = 0;
      break label56;
      ((bdve)this.app.getManager(QQManagerFactory.STUDY_MODE_SWITCHER_MANAGER)).a(this.b.get(), 1);
      a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger, -2147483648, this.b, -2147483648, this.c, -2147483648);
      ...
      if ((localBaseActivity != null) && ((localBaseActivity instanceof GeneralSettingActivity))) {
        ((GeneralSettingActivity)localBaseActivity).a(1, bdfk.c(), false, true);
      }
  ...
  public boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    boolean bool2 = a(paramBoolean, bdfk.a(paramInt));
    if (bool2) {}
    for (boolean bool1 = a(false, "212", paramBoolean, true, bdfk.a(paramInt));; bool1 = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    Object localObject = bdfk.a(paramInt);
    ...
    {
      return bool;
      long l = ((bdfe)this.app.getBusinessHandler(BusinessHandlerFactory.SIMPLE_UI_HANDLER)).a(paramBoolean1, paramInt, paramBoolean2, paramBoolean3, System.currentTimeMillis());
  ...
  protected boolean a(boolean paramBoolean1, String paramString1, boolean paramBoolean2, boolean paramBoolean3, String paramString2)
  {
    ...
    String str = ThemeUtil.getUserCurrentThemeId(this.app);
    Object localObject1 = beio.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramBoolean1) {}
        for (paramString2 = new bdfi(this);; paramString2 = new bdfh(this)) {
  ...
  public void b()
  {
    ...
    for (;;)
    {
      a(bool, this.b.get(), new bdff(this, l));
      return;
      bool = false;
    }
  }
