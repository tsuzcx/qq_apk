...
public class adsz
  extends aojs
{
  public adsz(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    default: 
      AddFriendVerifyActivity.b(this.a, 1002);
      this.a.jdField_a_of_type_Bjbs.dismiss();
      QQToast.a(this.a, 1, 2131717456, 1).b(this.a.getTitleBarHeight());
    case -2: 
      do
      {
        return;
      ...
      ((aoip)this.a.app.a(20)).b(Long.parseLong(this.a.jdField_a_of_type_JavaLangString), Long.parseLong(this.a.app.getAccount()));
    ...
    case 1: 
      ...
      for (;;)
      {
        try
        {
          ...
          awgm.a("closeJoinWebView", null, paramString, null);
          return;
        }
    ...
    AddFriendVerifyActivity.b(this.a, 1002);
    this.a.jdField_a_of_type_Bjbs.dismiss();
    QQToast.a(this.a, 1, 2131718941, 1).b(this.a.getTitleBarHeight());
  }
  ...
  protected void a(boolean paramBoolean, TroopInfo paramTroopInfo, String paramString)
  {
    if (paramBoolean)
    {
      ...
      if (i == 4) {
        ...
        {
          paramString = agej.a(new Intent(this.a, SplashActivity.class), null);
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt, long paramLong)
  {
    ...
    bggy.a(this.a.app, paramInt, paramLong, this.a.getActivity());
  }
  ...
  {
    if (!bhjx.a(String.valueOf(paramLong), this.a.jdField_a_of_type_JavaLangString)) {}
    label262:
    do
    {
      do
      ...
      paramTroopInfo = this.a.getString(2131696870, new Object[] { this.a.app.getCurrentNickname() }) + paramTroopInfo;
