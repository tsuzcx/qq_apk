  ...
  implements bgul
{
  ...
  private String jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131720036);
  private TicketManager jdField_a_of_type_MqqManagerTicketManager;
  private String b = BaseApplicationImpl.getContext().getString(2131720033);
  private String c = BaseApplicationImpl.getContext().getString(2131720034);
  private String d = BaseApplicationImpl.getContext().getString(2131720049);
  ...
  private void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    //   22: aload_1
    //   23: iload_3
    //   24: invokespecial 77	bamp:b	(Ljava/lang/String;I)V
    //   27: aload_0
    //   28: invokespecial 79	bamp:d	()V
    //   31: return
    //   32: aconst_null
    //   33: astore 6
    //   35: aconst_null
    ...
    //   40: astore 4
    //   42: aload_0
    //   43: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   46: ifnonnull +18 -> 64
    //   49: aload 6
    //   51: astore 4
    //   53: aload_0
    ...
    //   61: putfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   64: aload 6
    //   66: astore 4
    //   68: aload_0
    //   69: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   72: invokevirtual 85	android/media/MediaPlayer:isPlaying	()Z
    //   75: ifeq +14 -> 89
    //   78: aload 6
    //   80: astore 4
    //   82: aload_0
    //   83: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   86: invokevirtual 88	android/media/MediaPlayer:stop	()V
    //   89: aload 6
    //   91: astore 4
    //   93: aload_0
    //   94: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   106: astore 4
    //   108: aload_0
    //   109: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   112: iload_3
    ...
    //   128: astore_2
    //   129: aload_0
    //   130: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   133: aload_2
    ...
    //   140: aload_0
    //   141: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   144: iconst_3
    ...
    //   151: iconst_1
    //   152: invokestatic 116	bhcl:a	(Landroid/content/Context;Z)Z
    //   155: pop
    //   156: aload_0
    //   157: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   160: invokevirtual 119	android/media/MediaPlayer:prepare	()V
    //   163: aload_0
    //   164: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   167: new 121	bamq
    //   170: dup
    //   171: aload_0
    //   172: aload_1
    //   173: invokespecial 124	bamq:<init>	(Lbamp;Ljava/lang/String;)V
    ...
    //   179: aload_0
    //   180: getfield 47	bamp:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   183: invokevirtual 131	android/media/MediaPlayer:start	()V
    //   186: aload_0
    //   187: getfield 50	bamp:jdField_a_of_type_Bamo	Lbamo;
    //   190: ifnull +13 -> 203
    //   193: aload_0
    //   194: getfield 50	bamp:jdField_a_of_type_Bamo	Lbamo;
    //   197: aload_1
  ...
  private void d()
  {
    bakt.a(bakt.a, "TTSPlayerManager", null);
  }
  ...
  {
    this.jdField_a_of_type_Bamo = parambamo;
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Bamo != null) {
      this.jdField_a_of_type_Bamo.a(paramString);
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            a(paramString, bakt.a("network_tip.mp3"), paramInt);
            return;
          }
        }
    ...
    if (paramString.equals(this.d))
    {
      if (a("wake_default_tip.mp3")) {
        a(paramString, bakt.a("wake_default_tip.mp3"), paramInt);
      }
    }
    else if (paramString.equals(this.jdField_a_of_type_JavaLangString))
    {
      if (a("quit_voice_panel_tip.mp3")) {
        a(paramString, bakt.a("quit_voice_panel_tip.mp3"), paramInt);
      }
    }
    else if (paramString.equals(this.c))
    {
      if (a("voice_not_understant_tip.mp3")) {
        a(paramString, bakt.a("voice_not_understant_tip.mp3"), paramInt);
      }
    }
    else
    {
      ...
      {
        a(paramString, bakt.a("voice_not_support_tip.mp3"), paramInt);
        return;
      }
    }
    for (;;)
  ...
  {
    if (this.jdField_a_of_type_Bamo != null) {
      this.jdField_a_of_type_Bamo.b(paramString);
    }
  }
