...
public class moh
{
  ...
  private LruCache<String, moj> jdField_a_of_type_AndroidUtilLruCache = new moi(this, 4194304);
  private LinkedList<mok> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private mok jdField_a_of_type_Mok;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private byte[] b;
  
  public moh(int paramInt)
  {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        moj localmoj = (moj)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localmoj != null)
        {
          this.jdField_a_of_type_Mok = new mok(localmoj, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (moj)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_Mok = new mok(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      mok localmok = this.jdField_a_of_type_Mok;
      if (localmok != null) {
        localmok.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localmok = (mok)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localmok != null)
        {
          int j = i + localmok.a(this.b, i, paramInt);
          i = j;
          if (!localmok.a()) {
            break label229;
          }
      ...
      {
        mol.a(paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte, this.b, paramInt);
        return;
      }
    }
    finally {}
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new moj(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localmoj != null)
        {
          paramString = new mok(localmoj, false);
      ...
      if (paramString != null)
      {
        paramString = new mok(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
