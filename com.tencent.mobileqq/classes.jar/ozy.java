  ...
  extends paa
{
  ...
  public ozy(AppInterface paramAppInterface, aukp paramaukp, ExecutorService paramExecutorService, por parampor, Handler paramHandler)
  {
  ...
  private void a(List<qaq> paramList1, List<qaq> paramList2)
  {
    ...
    {
      localObject1 = ((qaq)paramList2.next()).jdField_a_of_type_JavaUtilList.iterator();
    ...
    {
      localObject1 = (qaq)paramList2.next();
      localObject2 = ((qaq)localObject1).jdField_a_of_type_JavaUtilList.iterator();
      label272:
      label285:
      label291:
      label296:
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i = 11;
          label214:
          if ((paramList1.indexOf(localObject1) != 0) || (((qaq)localObject1).jdField_a_of_type_JavaUtilList.indexOf(localTabChannelCoverInfo1) >= i)) {
            break label291;
          }
          i = 1;
          label243:
  ...
  private boolean a()
  {
    ...
    this.d = 0;
    bhvy.a("UPDATE_CHANNEL_LIST_KEY_0xbbc", Boolean.valueOf(false));
    return false;
  }
  
  public static boolean a(int paramInt)
  {
    if (!((Boolean)bhvy.a("sp_key_channel_list_dynamic_order_switch", Boolean.valueOf(false))).booleanValue())
    {
      QLog.d("ChannelCoverInfoModule", 1, "isSupportChannelDynamicOrder, switch is off.");
      return false;
    }
    Object localObject1 = (QQAppInterface)onh.a();
    if (localObject1 != null)
    {
      localObject1 = (osl)((QQAppInterface)localObject1).getManager(163);
      if (localObject1 != null)
      {
        localObject1 = ((osl)localObject1).a().a();
          ...
          do
          {
            ...
            while (!((Iterator)localObject2).hasNext())
            {
              do
              {
                ...
                localObject2 = ((qaq)((Iterator)localObject1).next()).jdField_a_of_type_JavaUtilList;
  ...
  private List<TabChannelCoverInfo> b(List<qaq> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    int i = 0;
    ...
    {
      qaq localqaq = (qaq)paramList.next();
      if ((localqaq.jdField_a_of_type_JavaUtilList == null) || (localqaq.jdField_a_of_type_JavaUtilList.isEmpty())) {
        break label129;
      }
      Iterator localIterator = localqaq.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        TabChannelCoverInfo localTabChannelCoverInfo = (TabChannelCoverInfo)localIterator.next();
        localTabChannelCoverInfo.channelConfigType = localqaq.jdField_a_of_type_Long;
        localTabChannelCoverInfo.seq = i;
        localArrayList.add(localTabChannelCoverInfo);
        i += 1;
      }
  ...
  private void b(boolean paramBoolean, List<TabChannelCoverInfo> paramList)
  {
    if (Looper.getMainLooper() == Looper.myLooper()) {
      osj.a().e(paramBoolean, paramList);
    }
  ...
  private List<qaq> c(List<qaq> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        Object localObject = (qaq)paramList.next();
        qaq localqaq = new qaq(((qaq)localObject).jdField_a_of_type_Long, ((qaq)localObject).jdField_a_of_type_JavaLangString, ((qaq)localObject).b);
        localObject = ((qaq)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          ...
          localqaq.jdField_a_of_type_JavaUtilList.add(localTabChannelCoverInfo2);
          i += 1;
        }
  ...
  private List<TabChannelCoverInfo> d(List<TabChannelCoverInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      label275:
      for (paramList = a();; paramList = ajya.a(2131701512))
      {
        if (!bool2) {
        ...
        ((List)localObject2).add(0, new TabChannelCoverInfo(70, ajya.a(2131701535), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
  ...
  private List<ChannelCoverInfo> e(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Aukp.a(ChannelCoverInfo.class, true, "mChannelID = ?", new String[] { String.valueOf(paramInt) }, null, null, null, null);
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        {
          str = bdik.d(str.toLowerCase()).toLowerCase();
      ...
      catch (Throwable localThrowable)
      {
        ...
        int i;
        int j;
        QLog.e("ChannelCoverInfoModule", 2, "requestWeiShiChannelCoverListFromServer failed for param error:" + onh.a(localThrowable));
        return;
      }
      try
      {
      ...
      a(pot.a("OidbSvc.0xbe6", 3046, 1, localReqBody.toByteArray()));
      return;
      str = bbdh.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty(str))
      {
        str = bdik.d(str.replaceAll(":", "").toUpperCase()).toLowerCase();
        localPhoneInfo.bytes_muid.set(ByteStringMicro.copyFromUtf8(str));
  ...
  private void g(List<qaq> paramList)
  {
    if (paramList != null)
    {
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        ...
        if (localObject != null)
        {
          localObject = ((qaq)localObject).jdField_a_of_type_JavaUtilList;
          if (localObject != null)
          {
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(51, ajya.a(2131701541)));
    localArrayList.add(new TabChannelCoverInfo(58, ajya.a(2131701528)));
    localArrayList.add(new TabChannelCoverInfo(59, ajya.a(2131701527)));
    localArrayList.add(new TabChannelCoverInfo(10, ajya.a(2131701530)));
    localArrayList.add(new TabChannelCoverInfo(52, ajya.a(2131701543)));
    localArrayList.add(new TabChannelCoverInfo(53, ajya.a(2131701524)));
    localArrayList.add(new TabChannelCoverInfo(9, ajya.a(2131701534)));
    localArrayList.add(new TabChannelCoverInfo(54, ajya.a(2131701519)));
    localArrayList.add(new TabChannelCoverInfo(55, ajya.a(2131701521)));
    localArrayList.add(new TabChannelCoverInfo(40007, ajya.a(2131701523)));
    return localArrayList;
  }
  ...
  private List<TabChannelCoverInfo> l()
  {
    ...
    return this.jdField_a_of_type_Aukp.a(TabChannelCoverInfo.class);
  }
  ...
  public List<TabChannelCoverInfo> a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 413	ozy:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnull +36 -> 42
    //   9: aload_0
    //   10: getfield 413	ozy:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   13: invokeinterface 406 1 0
    //   18: ifne +24 -> 42
    //   21: aload_0
    //   22: getfield 413	ozy:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: iconst_0
    //   26: invokeinterface 255 2 0
    //   31: checkcast 268	qaq
    //   34: getfield 270	qaq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   37: astore_1
    //   38: aload_0
    //   39: monitorexit
    //   40: aload_1
  ...
  public List<TabChannelCoverInfo> a(int paramInt)
  {
    ...
    //   19: checkcast 268	qaq
    //   22: getfield 270	qaq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: astore_2
    //   26: aload_0
    //   27: monitorexit
    //   28: aload_2
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    for (Object localObject = paramTabChannelCoverInfo.toString();; localObject = "null")
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if (a(paramTabChannelCoverInfo, ((qaq)((Iterator)localObject).next()).jdField_a_of_type_JavaUtilList)) {
  ...
  public void a(List<channel_button.Section> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        qaq localqaq = new qaq(localSection);
        localJSONArray.put(localqaq.a());
        localqaq.jdField_a_of_type_JavaUtilList = poq.b(localSection.rpt_msg_channel.get());
        this.jdField_a_of_type_JavaUtilList.add(localqaq);
      }
  ...
  public void a(List<qaq> paramList, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (qaq)((Iterator)localObject1).next();
        a(((qaq)localObject2).jdField_a_of_type_JavaUtilList, "0xbbc update sectionId=" + ((qaq)localObject2).jdField_a_of_type_Long);
      }
    }
    ...
    {
      qaq localqaq = (qaq)localIterator1.next();
      channel_button.Section localSection = new channel_button.Section();
      ArrayList localArrayList = new ArrayList();
      if (localqaq.jdField_a_of_type_JavaUtilList != null)
      {
        Iterator localIterator2 = localqaq.jdField_a_of_type_JavaUtilList.iterator();
      ...
      {
        localSection.uint64_section_id.set(localqaq.jdField_a_of_type_Long);
        localSection.str_section_name.set(localqaq.jdField_a_of_type_JavaLangString);
        localSection.str_note_text.set(localqaq.b);
    ...
    {
      localObject2 = bdik.d(((String)localObject2).toLowerCase()).toLowerCase();
    ...
    for (;;)
    {
      ...
      a(pot.a("OidbSvc.0xbbc", 3004, 1, ((oidb_cmd0xbbc.ReqBody)localObject1).toByteArray()));
      bhvy.a("UPDATE_CHANNEL_LIST_KEY_0xbbc", Boolean.valueOf(true));
      return;
      localObject2 = bbdh.c(BaseApplication.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        localObject2 = bdik.d(((String)localObject2).replaceAll(":", "").toUpperCase()).toLowerCase();
        paramList.bytes_muid.set(ByteStringMicro.copyFromUtf8((String)localObject2));
  ...
  public void a(List<qaq> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((qaq)paramList.get(0)).jdField_a_of_type_JavaUtilList = d(((qaq)paramList.get(0)).jdField_a_of_type_JavaUtilList);
      this.jdField_a_of_type_JavaUtilList = c(paramList);
      paramList = b(this.jdField_a_of_type_JavaUtilList);
      if (paramBoolean) {
        b(true, ((qaq)this.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_JavaUtilList);
      }
      if (!QLog.isColorLevel()) {
        break label193;
      }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new TabChannelCoverInfo(70, ajya.a(2131701526), 4, "https://p.qpic.cn/kandianac/0/993c416b9d2b9.png/0"));
    localArrayList.add(new TabChannelCoverInfo(0, ajya.a(2131701525), 4, "https://p.qpic.cn/kandianac/0/9558fc75932c5.png/0"));
    TabChannelCoverInfo localTabChannelCoverInfo = new TabChannelCoverInfo(56, ajya.a(2131701536));
    localTabChannelCoverInfo.reason = 4;
    localTabChannelCoverInfo.mChannelType = 3;
    localArrayList.add(localTabChannelCoverInfo);
    localArrayList.add(new TabChannelCoverInfo(40531, ajya.a(2131701538)));
    localArrayList.add(new TabChannelCoverInfo(14, ajya.a(2131701522)));
    localArrayList.add(new TabChannelCoverInfo(8, ajya.a(2131701540)));
    localArrayList.add(new TabChannelCoverInfo(1, ajya.a(2131701529)));
    localArrayList.add(new TabChannelCoverInfo(13, ajya.a(2131701515)));
    localArrayList.add(new TabChannelCoverInfo(5, ajya.a(2131701545)));
    localArrayList.add(new TabChannelCoverInfo(11, ajya.a(2131701514)));
    localArrayList.add(new TabChannelCoverInfo(40466, ajya.a(2131701539)));
    localArrayList.add(new TabChannelCoverInfo(40013, ajya.a(2131701537)));
    localArrayList.add(new TabChannelCoverInfo(16, ajya.a(2131701532)));
    localArrayList.add(new TabChannelCoverInfo(15, ajya.a(2131701518)));
    return localArrayList;
  }
  ...
  public void b()
  {
    ...
    //   21: invokestatic 328	bhvy:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    //   24: checkcast 314	java/lang/Boolean
    //   27: invokevirtual 331	java/lang/Boolean:booleanValue	()Z
    //   30: ifeq +29 -> 59
    //   33: aload_0
    //   34: invokespecial 951	ozy:a	()Z
    //   37: ifeq +22 -> 59
    //   40: ldc 60
    //   42: iconst_2
    //   43: ldc_w 953
    ...
    //   49: aload_0
    //   50: aload_0
    //   51: getfield 413	ozy:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   54: iconst_3
    //   55: invokevirtual 955	ozy:a	(Ljava/util/List;I)V
    //   58: return
    //   59: getstatic 958	nth:a	Z
    //   62: ifeq +13 -> 75
    //   65: ldc 60
    //   67: iconst_2
    //   68: ldc_w 960
    ...
    //   81: ldiv
    //   82: aload_0
    //   83: getfield 968	ozy:jdField_a_of_type_Long	J
    //   86: lcmp
    //   87: iflt -29 -> 58
    ...
    //   102: invokestatic 977	akuf:a	()Ljava/lang/String;
    ...
    //   115: invokestatic 982	akuf:b	()Ljava/lang/String;
    //   118: invokevirtual 633	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   121: aload_0
    //   122: getfield 621	ozy:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   146: invokevirtual 988	ajxl:c	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   149: astore_3
    //   150: aload_3
    //   151: ifnull +25 -> 176
    //   154: aload_2
    ...
    //   183: astore_3
    //   184: invokestatic 536	onh:f	()Ljava/lang/String;
    //   187: astore 4
    //   189: aload 4
    ...
    //   202: astore 4
    //   204: aload 4
    //   206: invokestatic 544	bdik:d	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   258: invokestatic 583	bbdh:e	()Ljava/lang/String;
    //   261: astore 4
    //   263: aload_3
    ...
    //   275: invokestatic 588	bbdh:c	()Ljava/lang/String;
    //   278: astore 4
    //   280: aload_3
    ...
    //   347: invokestatic 1020	osg:a	()Losg;
    //   350: invokevirtual 1023	osg:a	()Lcom/tencent/biz/pubaccount/readinjoy/model/SelectPositionModule;
    //   353: astore_3
    //   354: aload_3
    //   355: ifnull +132 -> 487
    //   358: aload_3
    ...
    //   499: invokestatic 644	pot:a	(Ljava/lang/String;II[B)Lcom/tencent/qphone/base/remote/ToServiceMsg;
    //   502: invokevirtual 647	ozy:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    //   505: return
    //   506: astore 4
    //   508: aload_3
    ...
    //   526: invokestatic 656	bbdh:c	(Landroid/content/Context;)Ljava/lang/String;
    //   529: astore 4
    //   531: aload 4
    ...
    //   552: invokestatic 544	bdik:d	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      localObject = pot.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      if (paramInt != 0) {
        break label247;
      }
  ...
  public void b(List<oidb_cmd0x69f.ChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo1 = poq.a((oidb_cmd0x69f.ChannelInfo)paramList.next(), paramInt);
  ...
  public List<qaq> c()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      Object localObject2 = bbdx.a(new File(BaseApplicationImpl.getApplication().getDir("readinjoy", 0).getAbsolutePath() + "/channel_section_data"));
        ...
        try
        {
          ...
          while (i < ((JSONArray)localObject2).length())
          {
            ...
            if (localJSONObject != null) {
              localArrayList.add(new qaq(localJSONObject));
            }
            i += 1;
          }
        }
  ...
  public void c()
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(new qaq(TabChannelCoverInfo.TYPE_CHANNEL_MY_CONFIG, ajya.a(2131701513), ajya.a(2131701517)));
        this.jdField_a_of_type_JavaUtilList.add(new qaq(TabChannelCoverInfo.TYPE_CHANNEL_RECOMMEND_CONFIG, ajya.a(2131701520), ajya.a(2131701531)));
      }
  ...
  {
    int i = pot.a(paramFromServiceMsg, paramObject, new oidb_cmd0xbbc.RspBody());
  ...
  public void c(List<oidb_cmd0xbe6.MsgChannelInfo> paramList, int paramInt)
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("saveChannelCoverList channelID=" + paramInt + "\n");; localStringBuilder = null)
    {
      ...
      while (paramList.hasNext())
      {
        ChannelCoverInfo localChannelCoverInfo = poq.a((oidb_cmd0xbe6.MsgChannelInfo)paramList.next(), paramInt);
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = pot.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    if (QLog.isColorLevel()) {
