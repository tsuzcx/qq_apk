  ...
  implements IMediaPlayer
{
  ...
  private bdua jdField_a_of_type_Bdua = new bdtr(this);
  ...
  private void e()
  {
    ved.b("DefaultMediaPlayer", "onVideoPlayEnded");
  ...
  private void f()
  {
    ved.b("DefaultMediaPlayer", "onVideoPlayRepeated");
  ...
  {
    boolean bool2 = true;
    bdts.a(hashCode(), "[Player] handle play cmd from qg");
    ved.a("DefaultMediaPlayer", "handleStartPlay , src = %s", this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder = new MediaDecoder(this.jdField_a_of_type_JavaLangString, this.jdField_d_of_type_Int, this.jdField_a_of_type_Bdua, false, hashCode());
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      this.jdField_d_of_type_Boolean = false;
      this.g = 0;
      bdts.a(hashCode(), "[Player] handle play cmd from qg finish");
      return;
      bool1 = false;
      break;
    }
  ...
  private void h()
  {
    ved.a("DefaultMediaPlayer", "handleResumePlay , src = %s", this.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    ...
    if (this.g == 1)
    {
      ...
      bdts.a(hashCode(), "[Player] render first frame to qg");
    }
  }
  
  public void a()
  {
    ved.b("DefaultMediaPlayer", "onResume");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.d();
    }
  }
  ...
  public void b()
  {
    ved.b("DefaultMediaPlayer", "onPause");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
  ...
  public void c()
  {
    ved.b("DefaultMediaPlayer", "onStop");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.b();
    }
  }
  ...
  {
    ved.b("DefaultMediaPlayer", "qg -> create");
  ...
  public void destroy()
  {
    ved.b("DefaultMediaPlayer", "qg -> destroy");
    c();
    if (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer != null) {
  ...
  {
    return (int)swc.a(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void pause()
  {
    ved.b("DefaultMediaPlayer", "qg -> pause");
    b();
  }
  
  public void play(int paramInt1, int paramInt2, int paramInt3)
  {
    ved.a("DefaultMediaPlayer", "qg -> play , texture id = %d , width = %d , height = %d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3));
    bdts.a(hashCode(), "[Player] receive play cmd from qg");
  ...
  public void setSrc(String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ved.a("DefaultMediaPlayer", "qg -> set Src , src = %s , isSrcChanged :%s", str, Boolean.valueOf(this.jdField_c_of_type_Boolean));
      return;
    }
  }
  ...
  {
    ved.b("DefaultMediaPlayer", "qg -> setVolume , not support yet");
  }
  
  public void stop()
  {
    ved.b("DefaultMediaPlayer", "qg -> stop");
    c();
  }
}
