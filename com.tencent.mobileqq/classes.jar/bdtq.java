...
public class bdtq
  extends bdol
{
  public final ArrayList<bdol> a;
  public boolean a;
  public int o = agej.a(2.5F, BaseApplicationImpl.getContext().getResources());
  public int p = this.o;
  private int q;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      if ((paramView != null) && ((paramView instanceof ViewGroup)))
      {
        ...
        localObject = (bdol)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localObject instanceof bdtk))
        {
          localbdtk = (bdtk)localObject;
          localView = localbdtk.a(paramContext, null, paramBundle);
      ...
      {
        ((TextView)localView).setGravity(localbdtk.p);
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    while (i < j)
    {
      ...
      {
        localObject = bdov.a((String)localObject);
        if (localObject != null)
        {
  ...
  {
    boolean bool2 = false;
    Object localObject1 = parambdqc.a("mode");
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
    boolean bool1;
    try
    {
      this.q = Integer.valueOf((String)localObject1).intValue();
      localObject1 = parambdqc.a("margin");
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        do
        {
          ...
          this.o = agej.a(Float.valueOf(localObject1[0]).floatValue(), (Resources)localObject2);
          this.p = agej.a(Float.valueOf(localObject1[1]).floatValue(), (Resources)localObject2);
          localObject1 = parambdqc.a("hidden");
          ...
          while (i < parambdqc.a())
          {
            localObject1 = parambdqc.a(i);
            if ((localObject1 != null) && ("td".equals(((bdqc)localObject1).b)))
            {
              localObject2 = bdov.a(((bdqc)localObject1).b);
              bool1 = bool2;
              if (localObject2 == null) {
                return bool1;
              }
              bool1 = bool2;
              if (!((bdol)localObject2).a((bdqc)localObject1)) {
                return bool1;
              }
              a((bdol)localObject2);
            }
