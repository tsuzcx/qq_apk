...
public class awnh
  extends QIPCModule
{
  private ArrayList<awnk> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      ...
      try
      {
        ...
        if (paramBundle != null) {
          synchronized (this.jdField_a_of_type_JavaUtilArrayList)
          {
            ...
            {
              awnk localawnk = (awnk)localIterator.next();
              if (localawnk != null) {
                localawnk.a(paramBundle);
              }
            }
          }
        }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ListenTogetherIPCModuleWebClient", 2, "register callback:" + paramawnk);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramawnk)) {}
    for (;;)
    {
      return;
      ...
      catch (Exception localException)
      {
        synchronized (this.jdField_a_of_type_JavaUtilArrayList)
        {
          this.jdField_a_of_type_JavaUtilArrayList.add(paramawnk);
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  public void b(awnk paramawnk)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ListenTogetherIPCModuleWebClient", 2, "unregister callback:" + paramawnk + " mHasRegistered:" + this.jdField_a_of_type_Boolean);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramawnk)) {}
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramawnk);
      if (QLog.isColorLevel()) {
    ...
    catch (Exception paramawnk)
    {
      QLog.e("ListenTogetherIPCModuleWebClient", 1, "unregister ipc module error.", paramawnk);
    }
    paramawnk = finally;
    throw paramawnk;
  }
