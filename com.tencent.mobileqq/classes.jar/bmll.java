...
public class bmll
{
  ...
  public static void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    try
    {
      ...
      localTianShuReportData.mTraceId = (paramString1 + l);
      localTianShuReportData.mActionId = paramInt;
      localTianShuReportData.mActionValue = 1;
      localTianShuReportData.mItemId = String.valueOf(paramString2);
      localTianShuReportData.mOperTime = l;
      localTianShuReportData.mTraceNum = 1;
      localTianShuReportData.mAppId = "tianshu.150";
      localTianShuReportData.mModuleId = "";
      localTianShuReportData.mTriggerInfo = paramString3;
