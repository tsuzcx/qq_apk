...
public final class bbnc
{
  ...
  private final List<bbng> jdField_b_of_type_JavaUtilList = new ArrayList();
  private int jdField_c_of_type_Int = -1;
  private final List<bbnd> jdField_c_of_type_JavaUtilList = new ArrayList();
  
  public bbnc(@NonNull Bitmap paramBitmap)
  {
    if ((paramBitmap == null) || (paramBitmap.isRecycled())) {
      throw new IllegalArgumentException("Bitmap is not valid");
    }
    this.jdField_c_of_type_JavaUtilList.add(bbna.a);
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_JavaUtilList = null;
    this.jdField_b_of_type_JavaUtilList.add(bbng.a);
    this.jdField_b_of_type_JavaUtilList.add(bbng.b);
    this.jdField_b_of_type_JavaUtilList.add(bbng.c);
    this.jdField_b_of_type_JavaUtilList.add(bbng.d);
    this.jdField_b_of_type_JavaUtilList.add(bbng.e);
    this.jdField_b_of_type_JavaUtilList.add(bbng.f);
  }
  ...
  public bbna a()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      ...
      {
        localObject = null;
        localObject = new bbmv(arrayOfInt, i, (bbnd[])localObject);
        if (localBitmap != this.jdField_a_of_type_AndroidGraphicsBitmap) {
          localBitmap.recycle();
        }
        localObject = ((bbmv)localObject).a();
        if (0 != 0) {
          throw new NullPointerException();
        }
      }
    ...
    for (;;)
    {
      localObject = new bbna((List)localObject, this.jdField_b_of_type_JavaUtilList);
      ((bbna)localObject).a();
      if (0 != 0) {
        throw new NullPointerException();
      }
      return localObject;
      localObject = (bbnd[])this.jdField_c_of_type_JavaUtilList.toArray(new bbnd[this.jdField_c_of_type_JavaUtilList.size()]);
      break;
