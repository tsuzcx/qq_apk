...
{
  public ucf(TroopGagActivity paramTroopGagActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramInt > 0)
    {
      ...
      {
        paramView = ((LayoutInflater)this.a.getSystemService("layout_inflater")).inflate(2130969446, paramViewGroup, false);
        paramViewGroup = new ucg(this, null);
        paramViewGroup.c = ((ImageView)paramView.findViewById(2131366543));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362899));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131366544));
        paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131366545));
