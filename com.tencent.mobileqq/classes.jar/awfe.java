  ...
  implements awer
{
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Awff.jdField_a_of_type_ArrayOfJavaLangString == null)
    {
      this.jdField_a_of_type_Boolean = true;
      return this.jdField_a_of_type_Awff.jdField_a_of_type_JavaLangString;
    }
    int i = this.jdField_a_of_type_Int + 1;
    if (i >= this.jdField_a_of_type_Awff.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      awff localawff = this.jdField_a_of_type_Awff;
      localawff.jdField_a_of_type_Int -= 1;
      if (this.jdField_a_of_type_Awff.jdField_a_of_type_Int <= 0)
      {
        this.jdField_a_of_type_Boolean = true;
        return this.jdField_a_of_type_Awff.jdField_a_of_type_JavaLangString;
      }
      ...
      return this.jdField_a_of_type_Awff.jdField_a_of_type_ArrayOfJavaLangString[(i + 1)];
    }
    return this.jdField_a_of_type_Awff.jdField_a_of_type_ArrayOfJavaLangString[i];
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Awff == null) {
  ...
  public void a(Message paramMessage)
  {
    ...
    if (this.jdField_a_of_type_Awff.jdField_a_of_type_Awes != null) {
      this.jdField_a_of_type_Awff.jdField_a_of_type_Awes.a((Bitmap)paramMessage.obj);
    }
    this.jdField_a_of_type_Int += 1;
    ThreadManager.post(this.jdField_a_of_type_JavaLangRunnable, 5, null, true);
  }
  
  public void a(awff paramawff)
  {
  ...
  {
    if (this.jdField_a_of_type_Awff != null) {
      this.jdField_a_of_type_Awff.jdField_a_of_type_JavaLangString = paramString;
    }
  }
