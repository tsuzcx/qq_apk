...
{
  awgx(awgw paramawgw, String paramString) {}
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    ...
    if ((localPluginBaseInfo != null) && (localPluginBaseInfo.mState == 4))
    {
      ...
      this.jdField_a_of_type_Awgw.callJs(this.jdField_a_of_type_JavaLangString, new String[] { "{\"result\":0\"version\":\"" + localPluginBaseInfo.mCurVersion + "\"}" });
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      this.jdField_a_of_type_Awgw.callJs(this.jdField_a_of_type_JavaLangString, new String[] { "{\"result\":-1}" });
