...
import com.tencent.mobileqq.listentogether.lyrics.LyricsController.15;
...
public class awgx
  implements awgu, beic
{
  public int a;
  ValueAnimator jdField_a_of_type_AndroidAnimationValueAnimator;
  Application.ActivityLifecycleCallbacks jdField_a_of_type_AndroidAppApplication$ActivityLifecycleCallbacks = new awhd(this);
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new awhe(this);
  protected awfk a;
  awfu jdField_a_of_type_Awfu;
  public awgv a;
  protected QQAppInterface a;
  public FloatIconLayout a;
  ...
  public awgx(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilSet = new ArraySet();
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Awgv = new awgv();
    this.jdField_b_of_type_Boolean = false;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_Int = -1;
    this.jdField_d_of_type_Int = 0;
    this.jdField_e_of_type_Int = 0;
    this.jdField_a_of_type_Awfk = new awhc(this);
    this.jdField_h_of_type_Int = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Awfk);
    m();
    this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean = true;
    paramQQAppInterface = BaseApplicationImpl.getContext();
    this.jdField_f_of_type_Int = ViewUtils.getScreenWidth();
    this.jdField_g_of_type_Int = ViewUtils.getScreenHeight();
    int j = AIOUtils.dp2px(12.0F, paramQQAppInterface.getResources());
    this.jdField_d_of_type_Int = j;
    this.jdField_b_of_type_Int = j;
    j = AIOUtils.dp2px(12.0F, paramQQAppInterface.getResources());
    this.jdField_e_of_type_Int = j;
    this.jdField_c_of_type_Int = j;
    this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = -1000;
    this.jdField_a_of_type_Awgv.jdField_b_of_type_Int = -1000;
    f();
  ...
  private void a(String paramString)
  {
    ...
    if (!bhbx.a(paramString, this.jdField_b_of_type_JavaLangString))
    {
    ...
    awgw localawgw = a();
    if ((localawgw != null) && (!bhbx.a(localawgw.a(), paramString)))
    {
      localawgw.setSongId(paramString);
      localawgw.setLyric(null, 1);
    }
  }
  ...
  private boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    do
    {
      return false;
      localawgw = a();
    } while ((localawgw == null) || (!paramString1.equals(localawgw.a())) || (localawgw.a() == 2));
    paramString1 = paramString2;
    if (!TextUtils.isEmpty(paramString2)) {
      paramString1 = paramString2.replace("&apos;", "'").replace("&quot;", "\"").replace("&nbsp;", " ").replace("&lt;", "<").replace("&gt;", ">").replace("&amp;", "&");
    }
    awpy localawpy = awqg.a(paramString1, true);
    paramString2 = localawpy;
    if (localawpy == null) {
      paramString2 = awqg.a(paramString1, false);
    }
    boolean bool;
    int j;
    if (QLog.isColorLevel())
    ...
    {
      localawgw.c();
      localawgw.setLyric(paramString2, j);
      return true;
      bool = false;
      break;
      label225:
  ...
  private void b(String paramString, int paramInt)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, String.format("updateLyricState [%s, %s]", new Object[] { awhi.a(paramInt), paramString }));
    }
    awgw localawgw = a();
    if (localawgw == null) {
      return;
  ...
  {
    boolean bool2 = false;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Awgv.a(paramInt, paramString))) {
      return true;
    }
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Awgv.jdField_b_of_type_Boolean = this.jdField_a_of_type_JavaUtilSet.contains(paramInt + "_" + paramString);
        if (this.jdField_a_of_type_Awgv.b(paramInt, paramString))
        {
          bool1 = false;
          if (bool1 != this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean)
          {
            this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean = bool1;
            this.jdField_a_of_type_Awgv.jdField_d_of_type_Boolean = true;
          }
          if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout == null)
          {
            ...
            behx.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout);
            l();
          }
          if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout == null)
          {
          ...
          if (this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean) {
            break;
          }
          if (!this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean) {
            break label482;
          }
          this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2);
          if (this.jdField_a_of_type_Awgv.jdField_b_of_type_Int == -1000) {
            this.jdField_a_of_type_Awgv.jdField_b_of_type_Int = (this.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2 - AIOUtils.dp2px(110.0F, BaseApplicationImpl.getContext().getResources()));
          }
          this.jdField_a_of_type_Awgv.jdField_e_of_type_Boolean = true;
          if (QLog.isColorLevel()) {
            QLog.d("LyricsController", 2, "showLyricsInner mFloatParams: " + this.jdField_a_of_type_Awgv);
          }
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Awgv);
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv);
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Awgv), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Awgv));
          this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Awgv));
          boolean bool3 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv);
          bool1 = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Awgv);
          this.jdField_a_of_type_Awgv.jdField_d_of_type_Boolean = false;
          if (bool1)
          {
            bool1 = bool2;
            if (bool3) {}
    ...
    if (this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = (this.jdField_d_of_type_Int + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2);; this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = (this.jdField_f_of_type_Int - this.jdField_b_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2))
    {
      if (this.jdField_a_of_type_Awgv.jdField_b_of_type_Int == -1000) {
        this.jdField_a_of_type_Awgv.jdField_b_of_type_Int = (AIOUtils.dp2px(70.0F, BaseApplicationImpl.getContext().getResources()) + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.e() / 2);
      }
      this.jdField_a_of_type_Awgv.jdField_e_of_type_Boolean = false;
      break;
    }
  }
  ...
  private void c(String paramString, int paramInt)
  {
    awgw localawgw = a();
    if (localawgw == null) {}
    while (!bhbx.a(localawgw.a(), paramString)) {
      return;
    }
    localawgw.a(paramInt);
  }
  ...
  private void q()
  {
    ...
    this.jdField_a_of_type_Awgv.jdField_h_of_type_Boolean = false;
    boolean bool1;
    if (this.jdField_b_of_type_Boolean) {
      if ((this.jdField_a_of_type_Awgv.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_Awgv.jdField_g_of_type_Boolean))
      {
        j = this.jdField_a_of_type_Awgv.jdField_a_of_type_Int;
        k = this.jdField_a_of_type_Awgv.jdField_b_of_type_Int;
        bool1 = this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean;
        if (!this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean) {
          break label473;
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean = bool1;
        this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = j;
        this.jdField_a_of_type_Awgv.jdField_b_of_type_Int = k;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Awgv);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv);
        if ((this.jdField_a_of_type_Awgv.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_Awgv.jdField_g_of_type_Boolean)) {
          i();
        ...
        break label251;
        label473:
        if (this.jdField_a_of_type_Awgv.jdField_d_of_type_Boolean)
        {
          if (bool1) {}
  ...
  private void r()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilSet)
    {
      if (!this.jdField_a_of_type_JavaUtilSet.isEmpty())
      {
        ...
        localEditor.putInt("listen_together_float_loc_icon_cx", this.jdField_a_of_type_Awgv.jdField_a_of_type_Int);
        localEditor.putInt("listen_together_float_loc_icon_cy", this.jdField_a_of_type_Awgv.jdField_b_of_type_Int);
        localEditor.putBoolean("listen_together_float_align_right", this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean);
        localEditor.apply();
        return;
      }
  ...
  public awgv a()
  {
    return this.jdField_a_of_type_Awgv;
  }
  
  public void a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onPositionChangeEnd mFloatParams:" + this.jdField_a_of_type_Awgv + " mScreenWidth:" + this.jdField_f_of_type_Int + " mScreenHeight:" + this.jdField_g_of_type_Int);
    }
    q();
    r();
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      j = this.jdField_a_of_type_Awgv.jdField_a_of_type_Int;
      m = this.jdField_a_of_type_Awgv.jdField_b_of_type_Int;
      k = j - paramInt1;
      j = this.jdField_f_of_type_Int;
      if (!this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean) {
        break label231;
      }
      if ((!this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean) || (this.jdField_a_of_type_Awgv.jdField_b_of_type_Boolean)) {
        break label198;
      }
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Awgv.jdField_e_of_type_Boolean = false;
        this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Awgv.jdField_b_of_type_Int = paramInt2;
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Awgv), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Awgv));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Awgv));
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Awgv);
        this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv);
        return;
        label198:
        if (this.jdField_a_of_type_Awgv.jdField_b_of_type_Boolean) {
          break label331;
        }
        paramInt1 = 0 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d();
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_Awgv.a(paramInt, paramString);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onExitAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_Awgv);
    }
    int k;
    int m;
    int j;
    if (this.jdField_a_of_type_Awgv.b(paramInt, paramString))
    {
      this.jdField_a_of_type_Awgv.b(0, null);
      if (!this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean = true;
        this.jdField_a_of_type_Awgv.jdField_d_of_type_Boolean = true;
        this.jdField_a_of_type_Awgv.jdField_h_of_type_Boolean = false;
    ...
    for (paramInt = -this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d();; paramInt = this.jdField_f_of_type_Int)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b();
      this.jdField_a_of_type_Awgv.jdField_h_of_type_Boolean = true;
      this.jdField_a_of_type_Awgv.jdField_h_of_type_Int = k;
      this.jdField_a_of_type_Awgv.i = m;
      this.jdField_a_of_type_Awgv.jdField_a_of_type_AndroidGraphicsPaint$Align = Paint.Align.CENTER;
      ThreadManager.getUIHandlerV2().removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
      paramInt = 300;
      if (paramBoolean) {
        paramInt = 500;
      ...
      behx.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout, this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Awgv.jdField_e_of_type_Int);
      return;
      label360:
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Awgv.jdField_f_of_type_Boolean = paramBoolean;
    } while (!this.jdField_b_of_type_Boolean);
    q();
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Awgv.a()) && (BaseActivity.sTopActivity != null))
    {
      localObject = bkzi.a(BaseActivity.sTopActivity);
      boolean bool = awfq.a();
      if (bool) {
        ((bkzi)localObject).b(2131693562);
      }
      ((bkzi)localObject).b(2131693537);
      ((bkzi)localObject).c(2131690697);
      ((bkzi)localObject).a(new awhf(this));
      ((bkzi)localObject).setOnCancelListener(new awhg(this));
      ((bkzi)localObject).a(new awgy(this, (bkzi)localObject, bool));
    ...
    aeow.a(BaseApplicationImpl.getContext(), (Intent)localObject, PublicTransFragmentActivity.class, ListenTogetherOverlayFragment.class);
  }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout != null))
    {
      ...
      if ((this.jdField_a_of_type_Awgv.jdField_e_of_type_Boolean) && (!this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean)) {
        if (!this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean) {
          break label172;
        }
      }
    ...
    label172:
    for (this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 - this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2);; this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = (this.jdField_f_of_type_Int / 2 + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.d() / 2 + this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.d() / 2))
    {
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv), this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Awgv));
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "hideLyrics,  type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_Awgv);
    }
    if (!this.jdField_a_of_type_Awgv.a(paramInt, paramString)) {
      return;
    }
    ThreadManager.getUIHandlerV2().removeCallbacks(this.jdField_b_of_type_JavaLangRunnable);
    ...
    p();
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Awgv.a(0, null);
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_JavaLangString = null;
    this.jdField_c_of_type_Boolean = false;
    this.jdField_h_of_type_Int = 0;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Awgv.jdField_g_of_type_Boolean != paramBoolean)
    {
      this.jdField_a_of_type_Awgv.jdField_g_of_type_Boolean = paramBoolean;
      if (this.jdField_b_of_type_Boolean) {
        q();
      }
    }
  ...
  {
    int k = 1;
    if ((!this.jdField_b_of_type_Boolean) || (TextUtils.isEmpty(this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString)) || ((this.jdField_a_of_type_Awgv.jdField_e_of_type_Int != 2) && (this.jdField_a_of_type_Awgv.jdField_e_of_type_Int != 1)) || (this.jdField_a_of_type_Awgv.a())) {
      return;
    }
    BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
    Object localObject = this.jdField_a_of_type_Awgv.jdField_e_of_type_Int + "_" + this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString;
    if (((BaseActivity.sTopActivity instanceof SplashActivity)) && (SplashActivity.jdField_a_of_type_Int == 1))
    {
      ...
      j = 1;
      label166:
      localObject = AIOUtils.setOpenAIOIntent((Intent)localObject, new int[] { j });
      label178:
      ((Intent)localObject).putExtra("uin", this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString);
      if (this.jdField_a_of_type_Awgv.jdField_e_of_type_Int != 2) {
        break label328;
      }
    ...
    for (int j = k;; j = 2)
    {
      bdla.b((QQAppInterface)localObject, "dc00898", "", "", "qq_vip", "0X800A5C0", j, 0, "", "", VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), "");
      return;
      j = 0;
      break;
      j = 2;
      break label166;
      localObject = AIOUtils.setOpenAIOIntent(new Intent(localBaseApplication, ChatActivity.class), new int[] { 2 });
      ((Intent)localObject).putExtra("leftViewText", "");
      break label178;
      ((Intent)localObject).putExtra("uintype", 1);
      ((Intent)localObject).putExtra("troop_uin", this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString);
      break label213;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onEnterAIO, type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.jdField_a_of_type_Awgv + " mIsForeground:" + this.jdField_a_of_type_Boolean);
    }
    this.jdField_a_of_type_Awgv.b(paramInt, paramString);
    if (this.jdField_a_of_type_Awgv.a(paramInt, paramString)) {}
    for (boolean bool = false;; bool = true)
    {
      if (bool != this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_Awgv.jdField_c_of_type_Boolean = bool;
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      int j = this.jdField_a_of_type_Awgv.jdField_e_of_type_Int;
      String str = this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString;
      this.jdField_a_of_type_Awfu = new awgz(this);
      ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(j, str, this.jdField_a_of_type_Awfu);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("LyricsController", 2, "onDestroyAIO, type:" + paramInt + " uin:" + paramString + ", isForeground: " + this.jdField_a_of_type_Boolean + " mFloatParams:" + this.jdField_a_of_type_Awgv);
    }
  ...
  public void e()
  {
    b(this.jdField_a_of_type_Awgv.jdField_e_of_type_Int, this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString);
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout != null) {
      this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout != null) {
  ...
  public void g()
  {
    ...
    if (!bool)
    {
      ...
      if (!this.jdField_d_of_type_Boolean)
      {
        ...
        aeow.a(BaseApplicationImpl.getContext(), localIntent, PublicTransFragmentActivity.class, ListenTogetherOverlayFragment.class);
  ...
  public void h()
  {
    ...
    this.jdField_a_of_type_Awgv.jdField_g_of_type_Boolean = false;
    q();
    int j = this.jdField_a_of_type_Awgv.jdField_e_of_type_Int;
    String str3 = this.jdField_a_of_type_Awgv.jdField_b_of_type_JavaLangString;
    b(j, str3, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ((awev)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.LISTEN_TOGETHER_HANDLER)).notifyUI(14, true, new Object[] { Integer.valueOf(j), str3 });
      ((ListenTogetherManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.LISTEN_TOGETHER_MANAGER)).a(j, str3, "closeLyric", 0);
      if ((j != 2) || (TextUtils.isEmpty(str3))) {
        break label156;
      }
      bdla.b(null, "dc00899", "c2c_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", "", "");
    }
    label156:
    ...
    String str2 = "2";
    TroopInfo localTroopInfo = ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).b(str3);
    String str1 = str2;
    ...
    for (;;)
    {
      bdla.b(null, "dc00899", "Grp_AIO", "", "music_tab", "clk_close", 0, 0, str3, "", str1, "");
      return;
      label250:
      str1 = str2;
  ...
  public void i()
  {
    ...
    int j = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.a(this.jdField_a_of_type_Awgv);
    int k = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.b(this.jdField_a_of_type_Awgv);
    int m = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.a(this.jdField_a_of_type_Awgv);
    int n = this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatTextLayout.b(this.jdField_a_of_type_Awgv);
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new awha(this, i1, j, i2, k, i3, m, i4, n));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new awhb(this, j, k, m, n));
  ...
  public void j()
  {
    ...
    this.jdField_a_of_type_Awgv.jdField_a_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cx", this.jdField_a_of_type_Awgv.jdField_a_of_type_Int);
    this.jdField_a_of_type_Awgv.jdField_b_of_type_Int = ((SharedPreferences)localObject2).getInt("listen_together_float_loc_icon_cy", this.jdField_a_of_type_Awgv.jdField_b_of_type_Int);
    this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean = ((SharedPreferences)localObject2).getBoolean("listen_together_float_align_right", this.jdField_a_of_type_Awgv.jdField_a_of_type_Boolean);
