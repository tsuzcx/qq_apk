...
public class whh
{
  ...
  public whh(@NonNull Activity paramActivity, @NonNull RMVideoStateMgr paramRMVideoStateMgr, @NonNull Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("extra_now_tab", uqn.a(2131099651).booleanValue());
    ...
    if ((paramIntent.getIntExtra("edit_video_type", 0) == 10002) && (this.jdField_a_of_type_Long > 0L)) {
      wxj.b("take_video", "video_startup", 0, 0, new String[] { "", String.valueOf(SystemClock.uptimeMillis() - this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Int) });
    }
    wxe.a("QQStoryTakeVideoHelper", "default label:%s", this.jdField_a_of_type_JavaLangString);
  }
  ...
  private void a(PublishParam paramPublishParam, String paramString, int paramInt)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (uqo.a())
      {
        StoryTransitionActivity.a(this.jdField_a_of_type_AndroidAppActivity, wgq.class.getName(), null);
  ...
  private boolean a()
  {
    ...
    {
      wxe.e("QQStoryTakeVideoHelper", "check manifest's existance error. directory is null.");
      return false;
    }
    return bdhb.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString + File.separator + "manifest.ini");
  }
  
  public String a()
  {
    return (String)((uvt)uwa.a(10)).b("StorySvc.get_photography_guide.word", alud.a(2131711446));
  }
  
  public String a(String paramString)
  {
    Object localObject = (uvt)uwa.a(10);
    int i = ((Integer)((uvt)localObject).b("StoryVideoWidth", Integer.valueOf(-1))).intValue();
    int j = ((Integer)((uvt)localObject).b("StoryVideoHeight", Integer.valueOf(-1))).intValue();
    int k = ((Integer)((uvt)localObject).b("StoryVideoMaxrate", Integer.valueOf(-1))).intValue();
    int m = ((Integer)((uvt)localObject).b("StoryVideoMinrate", Integer.valueOf(-1))).intValue();
    String str = (String)((uvt)localObject).b("StoryVideoKey", "960*720#600#1000;640*480#450#750");
    wxe.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : key = " + str + " width = " + i + " height = " + j + " maxrate = " + k + " minrate = " + m);
    if ((i == -1) && (j == -1) && (k == -1) && (m == -1) && ((str == null) || (str.isEmpty()) || (str.equals("-1")))) {
      wxe.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : no configs");
    }
    label390:
    ...
    wxe.d("QQStoryTakeVideoHelper", "setupStoryVideoConfig(): newConfig = " + paramString);
    return paramString;
  }
  
  public void a()
  {
    wrq.a(new whk(this, (uvt)uwa.a(10)));
  }
  
  public void a(Intent paramIntent, @NonNull ImageView paramImageView)
  {
    wxe.b("QQStoryTakeVideoHelper", "preview confirm");
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        wxe.b("QQStoryTakeVideoHelper", "preview confirm takephoto ");
      ...
      if (!a())
      {
        wxe.d("QQStoryTakeVideoHelper", "manifest file doesn't exist. generate again before publishing.");
        a(new whi(this, localPublishParam, str, i));
        return;
      }
      wxe.c("QQStoryTakeVideoHelper", "manifest file already exists. start publishing.");
      a(localPublishParam, str, i);
      return;
    }
  ...
  public void a(whl paramwhl)
  {
    this.jdField_a_of_type_Int = 1;
    Stream.of(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr).map(new ThreadOffFunction("QQStoryTakeVideoHelper", 2)).map(new xlk()).subscribe(new whj(this, paramwhl));
  }
