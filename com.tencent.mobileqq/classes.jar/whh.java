...
public class whh
  implements Runnable
{
  public whh(AddContactsView paramAddContactsView, StringBuilder paramStringBuilder) {}
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactAddContactsView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new whi(this));
          return;
