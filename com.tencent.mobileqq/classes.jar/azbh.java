  ...
  extends ScaleAnimation
{
  ...
  public azbh(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt1, float paramFloat5, int paramInt2, float paramFloat6, azbk paramazbk)
  {
  ...
  public void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    ...
    this.jdField_a_of_type_Azbk.jdField_a_of_type_Float = (this.jdField_a_of_type_Float + this.jdField_b_of_type_Float * paramFloat);
    if (QLog.isDevelopLevel()) {
      QLog.d("LsRecord", 4, "LS applyTransformation: " + paramFloat + " F: " + this.jdField_a_of_type_Azbk.jdField_a_of_type_Float);
    }
    int i;
    ...
    for (;;)
    {
      ...
      if (QLog.isDevelopLevel()) {
        QLog.d("LsRecord", 4, "LS applyTransformation: " + paramFloat + " CLR: " + this.jdField_a_of_type_Azbk.jdField_a_of_type_Int);
      }
      return;
      label296:
      this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable.setColor(i);
