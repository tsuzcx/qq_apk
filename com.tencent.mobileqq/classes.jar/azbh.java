...
public class azbh
{
  ...
  public azbh(boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(Activity paramActivity)
  {
    ...
    for (int i = 9;; i = 0)
    {
      ...
      paramActivity = (ImageView)localView.findViewById(2131370012);
      paramActivity.setImageDrawable(paramActivity.getResources().getDrawable(2130837544));
      paramActivity = (TextView)localView.findViewById(2131370039);
      paramActivity.setText(2131691288);
  ...
  public void a(Context paramContext, ViewGroup paramViewGroup, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = paramContext.findViewById(2131365361);
    this.jdField_b_of_type_AndroidViewView = paramContext.findViewById(2131365359);
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)this.jdField_b_of_type_AndroidViewView.findViewById(2131370014));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131370012));
    ...
    this.jdField_b_of_type_AndroidViewView.setOnTouchListener(new mvl());
    if (this.jdField_b_of_type_Boolean) {
      nhu.a(BaseApplicationImpl.getContext(), "online_status_smart/data.json", "online_status_smart/images/", 24, 34, -1, new azbi(this));
    }
  }
  ...
  public void a(BaseActivity paramBaseActivity, AppRuntime.Status paramStatus, long paramLong)
  {
    ...
    azbu localazbu = ((arci)aqxe.a().a(652)).a.a;
    localView.setVisibility(0);
    TextView localTextView = (TextView)localView.findViewById(2131370039);
    if (localazbu.b == null)
    {
      paramBaseActivity = "";
      ...
      paramBaseActivity = azbj.a().a(AppRuntime.Status.online, 40001L);
      if ((!azbu.a(paramStatus, paramLong)) || (!azch.b(paramBaseActivity))) {
        break label162;
      }
    }
    label162:
