  ...
  extends LoadingLayoutBase
{
  ...
  public assk(Context paramContext, PullToRefreshBase.Mode paramMode, PullToRefreshBase.Orientation paramOrientation, TypedArray paramTypedArray)
  {
    super(paramContext);
    ...
    int i;
    switch (assl.a[paramOrientation.ordinal()])
    {
    default: 
      LayoutInflater.from(paramContext).inflate(2131559631, this);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)findViewById(2131366889));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373398));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373396));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373397));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131373393));
      localLayoutParams = (FrameLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetFrameLayout.getLayoutParams();
      switch (assl.b[paramMode.ordinal()])
      {
      default: 
        if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL)
        {
          ...
          this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131695042);
          this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131695043);
          this.c = paramContext.getString(2131695044);
          if (paramTypedArray.hasValue(7))
          {
            paramOrientation = paramTypedArray.getDrawable(7);
            if (paramOrientation != null) {
              assm.a(this, paramOrientation);
            }
          }
    ...
    for (;;)
    {
      ...
      g();
      return;
      LayoutInflater.from(paramContext).inflate(2131559630, this);
      break;
      if (paramOrientation == PullToRefreshBase.Orientation.VERTICAL) {}
      for (i = 48;; i = 3)
      {
        localLayoutParams.gravity = i;
        this.jdField_a_of_type_JavaLangCharSequence = paramContext.getString(2131695039);
        this.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131695040);
        this.c = paramContext.getString(2131695041);
        break;
      }
      i = 5;
      break label179;
  ...
  public final int a()
  {
    switch (assl.a[this.jdField_a_of_type_ComTencentMobileqqExtendfriendPulltorefreshPullToRefreshBase$Orientation.ordinal()])
    {
    default: 
