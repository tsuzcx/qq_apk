  ...
  extends bgix
{
  ...
  public bghx()
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bghy(this);
  }
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      if (paramString3.equalsIgnoreCase("updateFeedsAndPopup"))
      {
        ...
        if ((paramJsBridgeListener instanceof bgjf)) {
          ((bgjf)paramJsBridgeListener).aJ();
        }
        return true;
      }
      ...
      if (paramString3.equalsIgnoreCase("getMoodVoiceRecordTime"))
      {
        ...
        bfsh.a().a(paramJsBridgeListener, this);
        return true;
      }
      int i;
      if (paramString3.equalsIgnoreCase("playMoodVoice"))
      {
        ...
        bfsh.a().a(paramJsBridgeListener, i, this);
        return true;
      }
      if (paramString3.equalsIgnoreCase("getMoodVoiceData"))
      {
        ...
        bfsh.a().b(paramJsBridgeListener, i, this);
        return true;
      }
    ...
    paramJsBridgeListener = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a();
    if ((paramJsBridgeListener instanceof bgia)) {
      ((bgia)paramJsBridgeListener).b();
    }
    return true;
  }
