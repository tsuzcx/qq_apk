...
public class afyl
  extends Handler
{
  public afyl(ListenChangeVoicePanel paramListenChangeVoicePanel, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 106: 
          ...
          do
          {
            do
            {
              do
              {
                ...
                this.a.jdField_a_of_type_Afyi.b = 0;
                this.a.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelChangeVoiceView = null;
                synchronized (this.a.b)
                {
                  this.a.jdField_a_of_type_Afyi.a = this.a.b;
                  this.a.jdField_a_of_type_Afyi.notifyDataSetChanged();
                  return;
                }
      ...
      bicd.a(((QQAppInterface)ListenChangeVoicePanel.a(this.a).get()).getApp(), ListenChangeVoicePanel.a(this.a), PressToChangeVoicePanel.a, this.a);
      int k = (int)ListenChangeVoicePanel.a(this.a);
      String str;
      QQRecorder.RecorderParam localRecorderParam;
      if (!baif.a((QQAppInterface)ListenChangeVoicePanel.a(this.a).get()).a((BaseChatPie)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), ListenChangeVoicePanel.a(this.a)))
      {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        {
          ListenChangeVoicePanel.jdField_a_of_type_Bahr.a((QQAppInterface)ListenChangeVoicePanel.a(this.a).get(), ListenChangeVoicePanel.a(this.a));
          if (ListenChangeVoicePanel.a(this.a) > 0) {
            bdla.b((QQAppInterface)ListenChangeVoicePanel.a(this.a).get(), "CliOper", "", "", "changevoice", "0X8006F7C", 0, 0, "" + ((BaseChatPie)this.a.jdField_a_of_type_JavaLangRefWeakReference.get()).sessionInfo.curType, "" + ListenChangeVoicePanel.a(this.a), "", "");
          }
        }
        this.a.f();
