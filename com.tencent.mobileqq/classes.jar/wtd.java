...
public class wtd
  extends baua
{
  public wtd(CommonPicUploadFragment paramCommonPicUploadFragment) {}
  
  public void handleMessage(Message paramMessage)
  {
    baoj localbaoj = (baoj)paramMessage.obj;
    if ((localbaoj == null) || (localbaoj.b != 24) || (localbaoj.c != CommonPicUploadFragment.a(this.a, CommonPicUploadFragment.a(this.a)))) {}
    do
    {
      do
      {
        return;
      } while (localbaoj.f.equals(CommonPicUploadFragment.b(this.a)));
    ...
    try
    {
      ...
      CommonPicUploadFragment.b(this.a, localbaoj.f);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("CommonPicUploadFragment", 2, "mPicTransProcessorHandler send error:" + localbaoj.g);
    }
