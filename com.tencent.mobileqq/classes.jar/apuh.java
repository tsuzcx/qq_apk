...
public class apuh
{
  public static Intent a(Context paramContext, String paramString1, boolean paramBoolean, long paramLong, MessageForArkApp paramMessageForArkApp, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      if (paramString1 != null)
      {
        ...
        if (paramString1 != null)
        {
          ...
          boolean bool2 = ArkAppCenterUtil.isPublicAccount();
          if ((!bool1) || (bool2)) {
            break label850;
          }
          paramBoolean = true;
          ...
          localIntent.putExtra("h5_ark_url_web_sender_uin", agnx.c);
          if (bool2) {
            localIntent.putExtra("puin", agnx.c);
          }
          QLog.d("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.UrlCheck.launchQQBrowser,appname=", paramString3, ", enableCheck=", Boolean.valueOf(paramBoolean), ", appEnableCheck=", Boolean.valueOf(bool1), ", isPublicAccount=", Boolean.valueOf(bool2), ", senderUin=", agnx.c, ", mUrlChecker=", paramString1.toString() });
          aqba.a().a(new apui());
        }
      }
    }
    paramString1 = aqyt.b(186).a();
    if (!TextUtils.isEmpty(paramString1)) {
    ...
    if (paramMessageForArkApp != null)
    {
      ...
      if (paramString1 != null)
      {
        ...
        localIntent.putExtra("forward_ark_app_desc", paramString1.appDesc);
        localIntent.putExtra("forward_ark_app_prompt", paramString1.promptText);
        ...
        apyp.a(a(), paramString1.appName, "AIOArkSdkCardClick", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
    for (;;)
    {
      ...
      if (paramString1.from == 1) {
        apyp.a(a(), paramString1.appName, "AIOArkMapCardClick ", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
  }
  ...
  public static String a()
  {
    ...
    if (localQQAppInterface != null) {
      return ((awyz)localQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER)).a().nationCode;
    }
    return "";
  }
  ...
  public static String a(SessionInfo paramSessionInfo)
  {
    if (paramSessionInfo != null)
    {
      ...
      localStringBuilder.append("curType:").append(paramSessionInfo.curType);
      localStringBuilder.append(", curFriendUin:").append(paramSessionInfo.curFriendUin);
      localStringBuilder.append(", troopUin:").append(paramSessionInfo.troopUin);
      localStringBuilder.append(", curFriendNick").append(paramSessionInfo.curFriendNick);
  ...
  public static String a(boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((awyz)((QQAppInterface)localObject).getManager(QQManagerFactory.CONTACT_MANAGER)).a();
  ...
  public static boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (((localObject2 instanceof FragmentActivity)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if ((!(localObject3 instanceof aido)) || (!"biz_src_ads".equals("biz_src_jc_ark"))) {
        break label855;
      }
      localObject1 = uuc.b(((BaseChatPie)localObject3).sessionInfo.curFriendUin);
      QLog.d("ArkApp.ArkCommonUtil", 1, "ArkSafe.OpenUrl set hsSourceID for " + ((BaseChatPie)localObject3).sessionInfo.curFriendUin + ", input " + "biz_src_jc_ark" + ", output " + (String)localObject1);
    }
    for (;;)
    {
      if (aptq.a(paramString1, "", new JSONObject(), paramInt, paramString2))
      {
        apyp.a(null, paramString2, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
        Log.d("ark.OpenUrl ", paramString1);
        apyp.a(null, paramString2, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
        return true;
      }
      int j;
      int i;
      ...
      if ((paramString1.startsWith("http://")) || (paramString1.startsWith("https://")))
      {
        ...
        if (localObject3 != null)
        {
          ...
          QLog.e("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", paramString2, ",url=", nwo.b(paramString1, new String[0]), ", isValid set=true" });
          paramInt = 1;
          i = 2;
        }
      }
      ...
      for (;;)
      {
        aqbw.b(paramString2, paramString1, j, i, agnx.c);
        if (paramInt == 0)
        {
          QLog.d("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", nwo.b(paramString1, new String[0]), ", app=", paramString2 });
          return false;
          label471:
          paramInt = 0;
          break label264;
        ...
        localObject1 = bhey.a(a(), (Context)localObject2, paramString1);
        ...
        if (localObject2 != null)
        {
          ...
          QLog.e("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", paramString2, ",url=", nwo.b(paramString1, new String[0]), ", isValid set=true" });
          paramInt = 1;
          i = 2;
        }
        for (;;)
        {
          ...
          QLog.e("ArkApp.ArkCommonUtil", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", nwo.b(paramString1, new String[0]), ", app=", paramString2 });
          break;
        }
      }
      label648:
