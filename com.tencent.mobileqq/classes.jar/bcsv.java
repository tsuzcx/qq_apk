  ...
  implements bcsk
{
  private void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, long paramLong1, long paramLong2, long paramLong3, msg_comm.MsgHead paramMsgHead)
  {
    ...
    for (;;)
    {
      ...
      for (Object localObject4 = anyv.a(paramQQAppInterface, paramString1, str2);; localObject4 = paramMsgHead) {
        for (;;)
        {
          String str1;
          Object localObject5;
          ...
          try
          {
            ...
            if ((paramInt == -126) || (paramInt == 2))
            {
              ...
              if (paramLong2 > 0L)
              {
                paramMsgHead = (String)localObject4 + anvx.a(2131700790);
                paramString2 = anyv.a(paramQQAppInterface, String.valueOf(paramLong2), str2);
                i = k;
                ...
                if (j == 1)
                {
                  paramMsgHead = paramMsgHead + anvx.a(2131700789);
                  localObject2 = paramMsgHead + paramString2 + anvx.a(2131700791);
                  str1 = paramString2;
                  ...
                  localObject3 = paramQQAppInterface.getApp().getApplicationContext().getString(2131697152);
                  if (!a(str2, paramQQAppInterface)) {
                    break label2131;
                  }
                  paramString2 = paramString2 + "，" + (String)localObject3;
                  localObject2 = "";
                  localObject6 = (MessageForGrayTips)bcsa.a(-1012);
                  ...
                  paramMsgHead = (bgmf)paramQQAppInterface.getManager(QQManagerFactory.TROOP_TIPS_MSG_MANAGER);
                  ...
                  if (!bool)
                  {
                    ...
                    paramMsgHead = ((aoep)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).a();
                    if ((paramMsgHead.b("newMember")) && (paramMsgHead.a(str2))) {
                      paramMsgHead.c(str2, paramString1);
                    }
                    new bdlf(paramQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_bar").a(new String[] { str2, "", "" + TroopUtils.convSfToReportParam(paramQQAppInterface, str2) }).a();
                  }
                  if (!QLog.isColorLevel()) {
                    break;
                  }
          ...
          catch (Exception paramMsgHead)
          {
            ...
            l1 = paramLong1;
            continue;
            localObject2 = paramMsgHead + paramString2 + anvx.a(2131700792);
            str1 = paramString2;
            paramString2 = (String)localObject2;
            continue;
            paramString2 = (String)localObject4 + anvx.a(2131700779);
            paramMsgHead = "";
            i = 0;
            str1 = "";
            continue;
            localObject2 = paramQQAppInterface.getApp().getApplicationContext().getString(2131697153);
          ...
          if (((paramInt != -125) && (paramInt != 3)) || (((bfgz)paramQQAppInterface.getManager(QQManagerFactory.MGR_TROOP_CREATE)).a(str2, (String)localObject3))) {
            break;
          }
          paramMsgHead = anyv.a(paramQQAppInterface, paramString2, str2);
          i = 0;
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (((String)localObject2).equals(paramString2)))
          {
            paramMsgHead = anvx.a(2131700778);
            i = 1;
          }
          for (;;)
          {
            if (i != 0)
            {
              str1 = paramMsgHead + anvx.a(2131700780);
              label1522:
              localObject2 = str1 + (String)localObject4 + anvx.a(2131700787);
              localObject3 = paramQQAppInterface.getApp().getApplicationContext().getString(2131697153);
              localObject2 = (String)localObject2 + "，" + (String)localObject3;
              localObject5 = (MessageForGrayTips)bcsa.a(-1012);
              ...
              paramString2 = (bgmf)paramQQAppInterface.getManager(QQManagerFactory.TROOP_TIPS_MSG_MANAGER);
            ...
            for (bool = true;; bool = false)
            {
              if (!bool)
              {
                ...
                paramString2 = ((aoep)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).a();
              ...
              return;
              str1 = paramMsgHead + anvx.a(2131700785);
              break label1522;
            }
          }
          label2131:
  ...
  {
    return anyv.a(paramQQAppInterface, paramMessageRecord, false);
  }
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bcre parambcre)
  {
    ...
    long l1 = bhbx.a(paramMsg, 0);
    int i = paramMsg[4];
    String str = String.valueOf(bhbx.a(paramMsg, 5));
    i = paramMsg[9];
    long l2 = bhbx.a(paramMsg, 10);
    int j = paramMsg[14];
    try
    {
      ...
      if (!parambcre.d)
      {
        ...
        ((aoep)paramMessageHandler.app.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).a(l1 + "", str, paramList.auth_nick.get());
        paramMsg = new ArrayList();
        paramMsg.add(new Pair(Long.valueOf(paramList.from_uin.get()), Long.valueOf(paramList.msg_time.get())));
        ((acmp)paramMessageHandler.a("c2c_processor")).a(paramMsg);
      }
      return;
    }
