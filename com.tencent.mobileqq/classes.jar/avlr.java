...
public class avlr
{
  ...
  public View a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localLinearLayout.addView((View)localObject, xee.b(this.jdField_a_of_type_AndroidContentContext, 18.0F), xee.b(this.jdField_a_of_type_AndroidContentContext, 15.0F));
    ((LinearLayout.LayoutParams)((View)localObject).getLayoutParams()).leftMargin = xee.b(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ...
    paramString1.rightMargin = xee.b(this.jdField_a_of_type_AndroidContentContext, 6.0F);
    paramString1.leftMargin = xee.b(this.jdField_a_of_type_AndroidContentContext, 2.0F);
    localLinearLayout.setBackgroundResource(2130845085);
    ...
    localLinearLayout.setOnClickListener(new avls(this));
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131377977);
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer = ((LabelContainer)paramView.findViewById(2131369279));
    this.b = paramView.findViewById(2131369465);
  ...
  public void a(cmd0xac5.NearbyNowData paramNearbyNowData)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer.setSpace(xee.b(this.jdField_a_of_type_AndroidContentContext, 6.0F), xee.b(this.jdField_a_of_type_AndroidContentContext, 8.0F));
    ...
    for (paramNearbyNowData = paramNearbyNowData.label_info.get();; paramNearbyNowData = null)
    {
      if ((paramNearbyNowData != null) && (paramNearbyNowData.size() > 0))
      {
        ...
        while (i < paramNearbyNowData.size())
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardLabelContainer.addView((View)localObject, -2, xee.b(this.jdField_a_of_type_AndroidContentContext, 24.0F));
          i += 1;
        }
