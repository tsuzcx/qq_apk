...
public class vrz
{
  ...
  {
    wxe.b("Q.qqstory.playernew.AnimationUtils", "doExitAnimation");
    View localView = paramViewGroup.findViewById(2131376034);
    ImageView localImageView2 = (ImageView)paramViewGroup.findViewById(2131362571);
    ViewGroup localViewGroup = (ViewGroup)paramViewGroup.findViewById(2131379910);
    ...
    paramViewGroup.addUpdateListener(new vsa(localViewGroup, localDrawable, localImageView1, localImageView2));
    paramViewGroup.addListener(new vsb(paramAnimatorListener));
  ...
  {
    wxe.b("Q.qqstory.playernew.AnimationUtils", "doEnterAnimation");
    Object localObject = paramViewGroup.findViewById(2131376034);
    ...
    ((ValueAnimator)localObject).addUpdateListener(new vsc(localViewGroup, paramViewGroup, localImageView));
    ((ValueAnimator)localObject).addListener(new vsd(paramAnimatorListener, localViewGroup, paramViewGroup));
