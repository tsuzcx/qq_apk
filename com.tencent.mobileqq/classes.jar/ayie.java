  ...
  extends ayjh
{
  ...
  public ayie(QQAppInterface paramQQAppInterface, int paramInt, RecentUser paramRecentUser, long paramLong)
  {
  ...
  private void a()
  {
    ...
    case 2: 
      this.l = this.c;
      this.m = ayrd.a(new String[] { this.e, this.f });
      return;
    case 3: 
      this.l = this.d;
      this.m = ayrd.a(new String[] { this.e, this.f });
      return;
    case 1: 
      this.l = ayrd.a(new String[] { this.c, this.d });
    ...
    this.l = ayrd.a(new String[] { this.c, this.d, this.e });
    this.m = this.f;
  }
  ...
  private void b()
  {
    ...
    {
    default: 
      localObject1 = alpo.a(2131702926);
      if (!ayrd.a(this.jdField_b_of_type_Int)) {
        break;
      }
    }
    for (this.jdField_a_of_type_JavaLangString = (alpo.a(2131702948) + (String)localObject1);; this.jdField_a_of_type_JavaLangString = ((String)localObject1))
    {
      if ((TextUtils.isEmpty(this.e)) || (this.e.equals(this.f))) {
        this.e = bdbt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.f, true);
      }
      return;
      ...
      localObject1 = alpo.a(2131702910);
      break;
      localObject1 = ((almv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.troopUin);
      if (localObject1 != null)
      {
      ...
      Object localObject2 = alpo.a(2131702933);
      ...
      this.e = bdbt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin, true);
      localObject1 = localObject2;
      break;
      ...
      this.e = null;
      localObject1 = bdbt.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin);
      localObject2 = ((aubm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11)).c(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin);
      if (localObject2 != null) {
        this.g = ((PhoneContact)localObject2).name;
      }
      for (;;)
      {
        localObject1 = alpo.a(2131702951);
        break;
        if (localObject1 != null) {
          this.g = bdbt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, true);
        }
      }
      localObject1 = alpo.a(2131702945);
      break;
      localObject1 = alpo.a(2131702916);
      break;
  ...
  protected long a(String paramString)
  {
    ...
    long l1 = ayrd.b(paramString, this.c, aydi.g);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 2;
    }
    l1 = ayrd.b(paramString, this.d, aydi.k);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 3;
    }
    l1 = ayrd.b(paramString, this.e, aydi.l);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 1;
    }
    l1 = ayrd.b(paramString, this.g, aydi.m);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
      this.jdField_a_of_type_Int = 4;
    }
    l1 = ayrd.a(paramString, this.f, aydi.o, false);
    if (l1 > this.jdField_a_of_type_Long)
    {
      this.jdField_a_of_type_Long = l1;
  ...
  public void a(View paramView)
  {
    ...
    if (ayrd.a(this.jdField_b_of_type_Int))
    {
      ...
      String str2;
      String str3;
      if (!aydw.a(this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin)) {
        switch (this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType())
        {
        default: 
          ayrd.a(this.jdField_b_of_type_JavaLangString, 20, 1, paramView);
      ...
      {
        ayrd.a(localQQAppInterface, str2, str3, str1, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType());
        ...
        return;
        ajgm.a = true;
        ajgm.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.troopUin, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType(), this.l, false);
        break;
        ajgm.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.getType(), this.l, false);
        break;
        bcgx.a(paramView.getContext(), null, this.jdField_a_of_type_ComTencentMobileqqDataRecentUser.uin);
        break;
      }
      label418:
