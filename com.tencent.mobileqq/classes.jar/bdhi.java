  ...
  extends Handler
{
  ...
  public bdhi(Looper paramLooper)
  {
    super(paramLooper);
    this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam = new NoticeParam();
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject2 = ((Bundle)localObject1).getString(bdkm.jdField_a_of_type_JavaLangString);
    bdht.a("NoticeHintHandler", "+++++what:" + paramMessage.what + "+++++" + localObject1);
    ...
    if (localObject2 != null)
    {
      if (((DownloadInfo)localObject2).i == TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE) {
        bdht.c("NoticeHintHandler", "notification isShowNotification=" + ((DownloadInfo)localObject2).i);
      }
    }
    else {
      return;
    ...
    for (;;)
    {
      ...
      {
        bdht.c("NoticeHintHandler", "init Notification>>>", localException);
        continue;
        bdht.b("NoticeHintHandler", ">>downloading:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
        bdht.c("NoticeHintHandler", "size = " + ((DownloadInfo)localObject2).jdField_f_of_type_Int + " content = ");
        ...
        continue;
        bdht.b("NoticeHintHandler", ">>complete:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      for (;;)
      {
        ...
        bdmb.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
        break;
        bdht.b("NoticeHintHandler", ">>download icon fail,so we use default notification icon");
        this.jdField_a_of_type_AndroidAppNotification.contentView.setImageViewResource(2131370949, 2130843544);
      }
      bdht.b("NoticeHintHandler", ">>pause:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      ...
      bdmb.a().b(this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_f_of_type_JavaLangString);
      continue;
      bdht.b("NoticeHintHandler", ">>error:" + this.jdField_a_of_type_ComTencentOpenDownloadnewCommonNoticeParam.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131370948, 0);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131370944, 8);
      this.jdField_a_of_type_AndroidAppNotification.contentView.setViewVisibility(2131370952, 8);
