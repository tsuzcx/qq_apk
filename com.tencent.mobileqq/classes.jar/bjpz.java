...
public class bjpz
{
  ...
  {
    List localList = ((bjqa)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
    if (localList != null) {
  ...
  public Friend a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((bjqa)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  {
    return ((bjqa)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaLangString;
  }
  ...
  public List<Friend> a()
  {
    ...
    {
      Iterator localIterator2 = ((bjqa)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator2.hasNext()) {
  ...
  {
    return ((bjqa)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(List<bjqa> paramList, int paramInt1, int paramInt2)
  {
    label9:
    String str2;
    ...
    else
    {
      ...
      this.c.clear();
      str2 = bjjo.a().a().getResources().getString(2131690798);
    ...
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        paramList = (bjqa)localIterator1.next();
