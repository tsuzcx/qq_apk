  ...
  extends WebViewPlugin
{
  ...
  public aqby(Bundle paramBundle)
  {
    this.mPluginNameSpace = "ArkSecurity";
    if (paramBundle != null) {
      try
      {
        paramBundle.setClassLoader(aqby.class.getClassLoader());
  ...
  protected void a()
  {
    ...
    QLog.i("ArkApp.ArkSecurityWebViewPlugin", 1, "now jump url=" + nwo.b("https://qzonestyle.gtimg.cn/qzone/hybrid/page/safeTips/index.html", new String[0]));
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentArkOpenSecurityArkBaseUrlChecker != null)
    {
      ...
      if (j == 0)
      {
        ...
        QLog.d("ArkApp.ArkSecurityWebViewPlugin", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.web.set isPermitted=true,url=", nwo.b(paramString1, new String[0]) });
        i = 2;
        bool1 = true;
        label101:
        aqbw.c(this.jdField_a_of_type_JavaLangString, paramString1, j, i, this.b);
        bool2 = bool1;
        if (!bool1)
        {
          QLog.d("ArkApp.ArkSecurityWebViewPlugin", 1, new Object[] { "ArkSafe.handleSchemaRequest,isPermitted=", Boolean.valueOf(bool1), ", url=", nwo.b(paramString1, new String[0]) });
          a();
        }
      }
    }
  ...
  public void onDestroy()
  {
    ...
    aqba.a().a("callDisableReport", null, null);
  }
}
