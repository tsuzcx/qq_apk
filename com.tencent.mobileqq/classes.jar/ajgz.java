...
public class ajgz
  implements Runnable
{
  public ajgz(TroopGiftAnimationController paramTroopGiftAnimationController, MessageForDeliverGiftTips paramMessageForDeliverGiftTips) {}
  ...
  public void run()
  {
    ...
    if (TroopGiftAnimationController.a(this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController) != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController.b = this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.receiverUin), new ajhc(this));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController.jdField_a_of_type_AndroidOsHandler.postDelayed(new ajhe(this, str, (Bitmap)localObject2, (Bitmap)localObject1, (Bitmap)localObject3), 300L);
          return;
