...
public class anoy
{
  ...
  public static int a(anow paramanow)
  {
    if (paramanow == null) {
      return 0;
    }
    return paramanow.jdField_a_of_type_Int * 1000 + paramanow.b;
  }
  ...
  /* Error */
  public static List<anow> a(QQAppInterface paramQQAppInterface)
  {
    // Byte code:
    ...
    //   74: new 10	anow
    //   77: dup
    //   78: invokespecial 110	anow:<init>	()V
    //   81: astore 6
    //   83: iconst_0
    //   84: istore_2
    //   85: iload_2
    ...
    //   121: putfield 127	anow:jdField_a_of_type_Long	J
    //   124: goto +104 -> 228
    //   127: ldc 129
    //   129: aload 7
    ...
    //   146: putfield 13	anow:jdField_a_of_type_Int	I
    //   149: goto +79 -> 228
    //   152: ldc 134
    //   154: aload 7
  ...
  public static Map<Long, anow> a(List<anow> paramList)
  {
    if (paramList == null) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      if (localanow != null) {
        localHashMap.put(Long.valueOf(localanow.jdField_a_of_type_Long), localanow);
      }
    }
    return localHashMap;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.putString("sp_key_leba_upgrade_info", "4680");
    paramQQAppInterface.commit();
    if (QLog.isColorLevel()) {
      QLog.i("LebaHelper", 2, String.format("update version, buildNum[%s]", new Object[] { "4680" }));
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<anow> paramList)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        if (paramList.hasNext())
        {
          ...
          try
          {
            ...
            localJSONObject.put("uiResId", localanow.jdField_a_of_type_Long);
            localJSONObject.put("groudId", localanow.jdField_a_of_type_Int);
            localJSONObject.put("index", localanow.b);
            localJSONArray.put(localJSONObject);
            if (QLog.isColorLevel()) {
              QLog.i("LebaHelper", 2, "" + localanow);
            }
          }
  ...
  public static void a(List<arcs> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  public static void a(List<arcs> paramList1, List<arcs> paramList2)
  {
    ...
    {
      arcs localarcs1 = (arcs)paramList2.next();
      arcs localarcs2;
      if (a(localarcs1.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.sPriority) != j)
      {
        localarcs2 = new arcs();
        if (paramList1.size() > 0) {
          if (i < 2)
          {
            ((arcs)paramList1.get(paramList1.size() - 1)).jdField_a_of_type_Int = 0;
            label101:
            localarcs2.jdField_a_of_type_JavaLangString = "empty_normal";
            label109:
            paramList1.add(localarcs2);
            j = a(localarcs1.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.sPriority);
            localarcs1.jdField_a_of_type_Int = 1;
            i = 1;
          }
        }
      }
      for (;;)
      {
        paramList1.add(localarcs1);
        break;
        ((arcs)paramList1.get(paramList1.size() - 1)).jdField_a_of_type_Int = 2;
        break label101;
        localarcs2.jdField_a_of_type_JavaLangString = "empty_normal";
        break label109;
        i += 1;
        localarcs1.jdField_a_of_type_Int = 3;
      }
    }
    if (paramList1.size() > 0)
    {
  ...
  public static boolean a(arcs paramarcs)
  {
    if ((paramarcs.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.cDataType == 1) && (!TextUtils.isEmpty(paramarcs.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strPkgName))) {
      return "qzone_feedlist".equals(paramarcs.jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strPkgName);
    }
    return false;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = ((aqjm)paramQQAppInterface.getManager(269)).a();
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean, Map<Long, LebaPluginInfo> paramMap)
  {
    ...
    for (;;)
    {
      ...
      return bool;
      if (!ajvi.a().a(paramQQAppInterface, paramLong)) {
        bool = false;
      } else {
        label144:
        bool = true;
  ...
  public static void b(List<arcs> paramList, List<Integer> paramList1)
  {
    int i = 0;
    if ((paramList == null) || (paramList.isEmpty())) {}
    for (;;)
    {
      ...
      if ((paramList1 == null) || (paramList1.isEmpty()))
      {
        ...
        Collections.sort(paramList, new anoz());
        return;
      }
      ...
      while (localIterator.hasNext())
      {
        ...
        for (;;)
        {
          try
          {
            j = paramList1.indexOf(Integer.valueOf((int)localarcs.jdField_a_of_type_Long));
            if (j < 0) {
              continue;
            }
            localarcs.b = j;
          ...
          catch (Exception localException)
          {
            ...
            continue;
            localStringBuilder.append(",fix ").append(localarcs.jdField_a_of_type_Long);
          }
          if (localarcs.c()) {
            continue;
          }
          ...
          break;
          localarcs.b = 2147483647;
        }
      }
      QLog.i("leba_sort", 1, localStringBuilder.toString());
      Collections.sort(localArrayList, new anpa());
      int k;
      for (int j = 0; i < paramList.size(); j = k)
      {
        k = j;
        if (!((arcs)paramList.get(i)).c())
        {
          k = j;
  ...
  public static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (!"4680".equals(paramQQAppInterface)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("LebaHelper", 2, String.format("update version isAppUpgrade[%b], preBuildNum[%s], cur[%s]", new Object[] { Boolean.valueOf(bool), paramQQAppInterface, "4680" }));
      }
      return bool;
    }
  }
