  ...
  implements bahw
{
  ...
  private ArrayList<bhjk> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int;
  private boolean jdField_b_of_type_Boolean;
  
  public bhjj(String paramString, Handler paramHandler)
  {
    this(paramString, paramHandler, 0);
  }
  
  public bhjj(String paramString, Handler paramHandler, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidOsHandler = paramHandler;
    if (paramInt == 0) {
      this.jdField_a_of_type_Bahv = new AmrPlayer();
    }
    for (this.jdField_b_of_type_Int = 2;; this.jdField_b_of_type_Int = 3)
    {
      this.jdField_a_of_type_Int = 1;
      return;
      this.jdField_a_of_type_Bahv = new SilkPlayer();
    }
  }
    ...
    for (this.jdField_a_of_type_Int = 8;; this.jdField_a_of_type_Int = 4)
    {
      if (this.jdField_a_of_type_Bahv != null)
      {
        ...
        if (this.jdField_a_of_type_Int == 4) {
          i = this.jdField_a_of_type_Bahv.b();
        }
      ...
      while (localIterator.hasNext()) {
        ((bhjk)localIterator.next()).a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, i);
      }
    }
  }
  ...
  {
    if (a()) {
      ((SilkPlayer)this.jdField_a_of_type_Bahv).a(parambahu);
    }
  }
  ...
  public void a(bhjk parambhjk)
  {
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(parambhjk)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambhjk);
    }
  }
  
  public boolean a()
  {
    return (this.jdField_a_of_type_Bahv != null) && ((this.jdField_a_of_type_Bahv instanceof SilkPlayer));
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Int == 1)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_Bahv.a(this.jdField_a_of_type_JavaLangString);
  ...
  {
    this.jdField_a_of_type_Bahv.b(paramInt);
  }
  ...
  public void c()
  {
    ...
    {
      this.jdField_a_of_type_Int = 2;
      ((AmrPlayer)this.jdField_a_of_type_Bahv).b();
      if (this.jdField_b_of_type_Boolean) {
        bhcl.a(this.jdField_a_of_type_AndroidContentContext, true);
      }
      QLog.d("Q.profilecard.VoicePlayer", 2, "continue to play... for test time=" + System.currentTimeMillis());
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext()) {
        ((bhjk)localIterator.next()).b(this.jdField_a_of_type_JavaLangString, c(), b());
      }
    }
  }
