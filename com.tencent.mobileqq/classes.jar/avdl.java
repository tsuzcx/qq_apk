...
public class avdl
{
  private static volatile avdl a;
  public static final String a;
  
  static
  {
    jdField_a_of_type_JavaLangString = ajsf.aW + "qbdownres";
  }
  ...
  {
    if (jdField_a_of_type_Avdl == null) {}
    try
    {
      if (jdField_a_of_type_Avdl == null) {
        jdField_a_of_type_Avdl = new avdl();
      }
      return jdField_a_of_type_Avdl;
    }
    finally {}
  }
  ...
  public static void a(String paramString, HashMap<String, String> paramHashMap)
  {
    try
    {
      ...
      {
        axrl.a(BaseApplicationImpl.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramString, true, 0L, 0L, paramHashMap, null, false);
  ...
  public static boolean a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if ((QzoneConfig.getInstance().getConfig("Schema", "jump_installapp_scheme_enable", 0) == 0) && (apvb.b((String)localObject)))
      {
  ...
  private boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (avds.a(paramString2))
    {
      a(paramQQAppInterface.getAccount(), paramString1);
      apvb.c(str);
      return false;
    }
    bhkd.a().c(paramString4, null);
    return false;
  }
  ...
  private static void b(String paramString1, SoftReference<QQAppInterface> paramSoftReference, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      if (paramSoftReference != null)
      {
        paramSoftReference = (ayxq)paramSoftReference.getManager(193);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (localayxq.a())
      {
        ...
        localayxq.a(10088, "vas", paramString2, 0, paramString2, paramString3, 1, 2, true, new avdm(this, paramQQAppInterface, "qboss_pre_download_res", paramString1, paramString3, paramString2, paramString4));
        return;
      }
