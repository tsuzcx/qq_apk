...
public class bjpt
{
  ...
  private String jdField_b_of_type_JavaLangString = aljq.aW + "/tencent/Qzone/AntishakeGif/";
  ...
  static
  {
    ...
    jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor = new ThreadPoolExecutor(bdcb.b(), bdcb.b() + 5, 200L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    a();
  }
  ...
  public static bjpt a()
  {
    try
    {
      if (jdField_a_of_type_Bjpt == null) {
        jdField_a_of_type_Bjpt = new bjpt();
      }
      bjpt localbjpt = jdField_a_of_type_Bjpt;
      return localbjpt;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      localFile = new File(bduw.a(this.jdField_b_of_type_JavaLangString));
      if (!localFile.exists()) {
        localFile.mkdirs();
      }
      localFile = new File(bduw.a(this.jdField_b_of_type_JavaLangString + this.jdField_c_of_type_JavaLangString));
      if (localFile.exists()) {}
    }
    try
    {
  ...
  private void a(int paramInt)
  {
    if (this.jdField_a_of_type_Bjpu != null) {
      this.jdField_a_of_type_Bjpu.a(paramInt);
    }
  }
  ...
  public void a(bjpu parambjpu)
  {
    this.jdField_a_of_type_Bjpu = parambjpu;
  }
  ...
  public boolean a(ArrayList<String> paramArrayList)
  {
    ...
    String str = aljq.aW + "/tencent/Qzone/AlbumAutoVConvGif/";
  ...
  public boolean a(ArrayList<String> paramArrayList, LruCache<Integer, BitmapDrawable> paramLruCache)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QzoneVision", 2, "DeviceInfoUtil.getMemoryClass() = " + bdcb.f() / 1048576L + "M, DeviceInfoUtil.getSystemAvaialbeMemory() = " + bdcb.e() / 1048576L + "M");
    }
