...
public class bdds
{
  public static bddb a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            paramQQAppInterface = new bddb(paramQQAppInterface, paramContext);
          ...
          paramContext = new bddb(paramQQAppInterface, paramContext);
    ...
    for (paramString = "mqqavshare://avshare/forward?url=https%3a%2f%2fwww.baidu.com%2fs%3fwd%3dabc%26rsv_spt%3d1&exp=1566906601";; paramString = localException4)
    {
      ...
      for (;;)
      {
        localObject2 = new bddb(paramQQAppInterface, paramContext);
        if (paramString.startsWith("mqqapi://now/openroom"))
        {
          ((bddb)localObject2).a = paramString;
        ...
        for (;;)
        {
          ...
          if (paramQQAppInterface.startsWith("mqqopensdkapi://bizAgent/"))
          {
            ...
            ((bddb)localObject2).a("attr_original_url", localException4);
          }
          for (;;)
          {
            paramQQAppInterface = paramQQAppInterface.split("/");
            if (paramQQAppInterface.length != 2)
            {
              ...
              ((bddb)localObject2).a = paramContext;
              break label5984;
            ...
            ((bddb)localObject2).a = paramContext;
            ((bddb)localObject2).b = paramQQAppInterface[0];
            ((bddb)localObject2).c = paramQQAppInterface[1];
            if (str2 == null) {
              return localObject2;
            }
            if (bool3)
            {
              ...
              if (i < paramQQAppInterface.length)
              {
                ...
                for (bool1 = true;; bool1 = false)
                {
                  ...
                  if (j > 0) {
                    ((bddb)localObject2).a(paramContext.substring(0, j), paramContext.substring(j + 1, paramContext.length()));
                  }
                  i += 1;
                  break;
                }
            ...
            if (i < paramQQAppInterface.length)
            {
              ...
              if (paramContext.length == 2)
              {
                ...
                ((bddb)localObject2).a(paramContext[0], a(paramContext[1], false));
              }
              for (;;)
              {
                i += 1;
                break;
                label6635:
                ((bddb)localObject2).a(paramContext[0], paramContext[1]);
              }
            }
            return localObject2;
            label6652:
