...
public class vip
{
  ...
  private int jdField_A_of_type_Int = BaseApplication.getContext().getResources().getColor(2131166801);
  ...
  private Drawable.Callback jdField_a_of_type_AndroidGraphicsDrawableDrawable$Callback = new viq(this);
  ...
  private ColorTextCell jdField_a_of_type_ComTencentBizQqcircleBizpartsDanmakuTextColorTextCell = new ColorTextCell(10, anzj.a(2131713655), -8947849);
  ...
  private vij<Integer, Integer> jdField_a_of_type_Vij;
  private viw jdField_a_of_type_Viw;
  private vix jdField_a_of_type_Vix;
  private viy jdField_a_of_type_Viy;
  private viz jdField_a_of_type_Viz;
  public vja a;
  protected vjf a;
  private vjg jdField_a_of_type_Vjg;
  public boolean a;
  ...
  private ArrayList<viv> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  private vij<Integer, Float> jdField_b_of_type_Vij;
  private viy jdField_b_of_type_Viy;
  public boolean b;
  ...
  private vij<Integer, Integer> jdField_c_of_type_Vij;
  public boolean c;
  ...
  private ArrayList<viz> jdField_e_of_type_JavaUtilArrayList;
  protected volatile boolean e;
  private int jdField_f_of_type_Int;
  private String jdField_f_of_type_JavaLangString;
  private ArrayList<viz> jdField_f_of_type_JavaUtilArrayList;
  private boolean jdField_f_of_type_Boolean;
  private int jdField_g_of_type_Int = bhtq.a(2.0F);
  ...
  public vip(vjg paramvjg)
  {
    this(paramvjg, new Paint(1));
  }
  
  public vip(vjg paramvjg, Paint paramPaint)
  {
  ...
  private int a(ArrayList<viz> paramArrayList)
  {
    int i2;
    ...
    for (int i1 = 0;; i1 = ((viz)paramArrayList.next()).jdField_a_of_type_AndroidGraphicsRect.width() + this.U + i1)
    {
      i2 = i1;
  ...
  private Bitmap a(vjg paramvjg)
  {
    if (!this.jdField_c_of_type_Boolean)
    {
      paramvjg = (Bitmap)vjb.a().a().get(Integer.valueOf(d()));
      if (paramvjg != null) {
        return paramvjg;
      }
    }
  ...
  private bnqp a(String paramString, int paramInt)
  {
    ...
    localbnqp.a(paramString, paramInt);
    localbnqp.setCallback(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable$Callback);
    localbnqp.a(bhtq.a() / 720.0F);
    localbnqp.a();
    localbnqp.a(true);
    localbnqp.b(true);
    localbnqp.start();
  ...
  private TextCell a(TextCell paramTextCell, int paramInt1, viv paramviv, float paramFloat, int paramInt2)
  {
    ...
    paramviv = paramTextCell.copy();
    paramviv.text = paramTextCell.text.substring(i2);
    return paramviv;
  }
  ...
  private vij<Integer, Integer> a(float paramFloat1, float paramFloat2)
  {
    if (this.jdField_c_of_type_Vij == null) {
      this.jdField_c_of_type_Vij = new vij(Integer.valueOf(-1), Integer.valueOf(-1));
    }
    int i3 = this.jdField_b_of_type_JavaUtilArrayList.size();
    int i1 = 0;
    while (i1 < i3)
    {
      viv localviv = (viv)this.jdField_b_of_type_JavaUtilArrayList.get(i1);
      int i4 = localviv.c();
      int i2 = 0;
      while (i2 < i4)
      {
        if (a(paramFloat1, paramFloat2, localviv.a(i2), localviv.a(i2))) {
          return this.jdField_c_of_type_Vij.a(Integer.valueOf(i1), Integer.valueOf(i2));
        }
        i2 += 1;
      }
      i1 += 1;
    }
    return this.jdField_c_of_type_Vij.a(Integer.valueOf(-1), Integer.valueOf(-1));
  }
  
  private vij<Integer, Float> a(TextCell paramTextCell, int paramInt)
  {
    if (this.jdField_b_of_type_Vij == null) {
      this.jdField_b_of_type_Vij = new vij(Integer.valueOf(-1), Float.valueOf(-1.0F));
    }
    if (!paramTextCell.canBreak()) {
      return this.jdField_b_of_type_Vij.a(Integer.valueOf(paramTextCell.getLength()), Float.valueOf(paramTextCell.getWidth(this.jdField_a_of_type_AndroidGraphicsPaint)));
    }
    float f1 = 0.0F;
    ...
    for (;;)
    {
      return this.jdField_b_of_type_Vij.a(Integer.valueOf(i4), Float.valueOf(f1));
      i1 = 0;
      break;
      label176:
      ...
      while (i1 < i5)
      {
        ...
        if (f2 > paramInt - 6) {
          return this.jdField_b_of_type_Vij.a(Integer.valueOf(i1 + i2), Float.valueOf(f1));
        }
        i1 += 1;
        f1 = f2;
      }
  ...
  private viv a(int paramInt)
  {
    ...
    viv localviv = new viv();
    this.jdField_b_of_type_JavaUtilArrayList.add(localviv);
    this.jdField_c_of_type_JavaUtilArrayList.add(Integer.valueOf(0));
    return localviv;
  }
  
  private viz a(ArrayList<viz> paramArrayList, float paramFloat1, float paramFloat2)
  {
    if ((paramArrayList == null) || (paramArrayList.isEmpty()))
    {
      paramArrayList = null;
    ...
    viz localviz;
    int i2;
    for (int i1 = 0;; i1 = localviz.jdField_a_of_type_AndroidGraphicsRect.width() + i2 + i1)
    {
      if (!localIterator.hasNext()) {
        break label92;
      }
      localviz = (viz)localIterator.next();
      paramArrayList = localviz;
      if (a(paramFloat1 - i1, paramFloat2, localviz.jdField_a_of_type_AndroidGraphicsRect)) {
        break;
      }
      i2 = this.U;
    }
  ...
  private void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) {}
      for (vhx localvhx = (vhx)this.jdField_a_of_type_AndroidGraphicsPaint;; localvhx = new vhx(1))
      {
        if (localvhx.a(paramInt1, paramString, this.jdField_a_of_type_AndroidGraphicsPaint, paramInt2)) {
          break label88;
        }
        if (!(this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) {
          break;
        }
        this.jdField_a_of_type_AndroidGraphicsPaint = ((vhx)this.jdField_a_of_type_AndroidGraphicsPaint).a();
        return;
      }
      this.jdField_a_of_type_AndroidGraphicsPaint = localvhx;
      paramString = this.jdField_a_of_type_Vjg.a();
  ...
  private void a(Canvas paramCanvas)
  {
    ...
    {
      viz localviz = (viz)localIterator.next();
      i2 = (this.jdField_v_of_type_Int - localviz.jdField_a_of_type_AndroidGraphicsRect.height()) / 2;
      paramCanvas.translate(0.0F, i2);
      a(localviz);
      localviz.jdField_a_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
      paramCanvas.translate(0.0F, -i2);
      i2 = localviz.jdField_a_of_type_AndroidGraphicsRect.width() + this.U;
      paramCanvas.translate(i2, 0.0F);
    }
    paramCanvas.translate(-i1, 0.0F);
  }
  
  private void a(Canvas paramCanvas, viv paramviv)
  {
    int i1;
    if (this.D == 1)
    {
    ...
    if ((this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && (paramviv.a(0) != null))
    {
      Rect localRect = paramviv.a(0);
      i1 = localRect.bottom - localRect.top;
      paramCanvas.translate(-bhtq.a(3.0F), 0.0F);
      paramviv = new Rect(0, localRect.top + i1 / 4, paramviv.a() + bhtq.a(6.0F), localRect.top + i1 * 3 / 4);
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setBounds(paramviv);
  ...
  private void a(TextCell paramTextCell, MotionEvent paramMotionEvent)
  {
    ...
    if ((paramTextCell != null) && (paramTextCell.type == 18))
    {
      ...
      if (!this.jdField_v_of_type_Boolean)
      {
        ...
        b();
        this.jdField_a_of_type_Vjg.requestLayout();
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Vjg.a(paramTextCell);
      return;
      ...
      if ((paramTextCell != null) && (paramTextCell.type == 10) && (this.jdField_g_of_type_Boolean))
      {
        b();
        d(0);
        this.jdField_a_of_type_Vjg.invalidate();
        this.jdField_a_of_type_Vjg.requestLayout();
      }
    }
  }
  
  private void a(vij<Integer, Integer> paramvij)
  {
    if (this.jdField_a_of_type_ComTencentBizQqcircleBizpartsDanmakuTextTextCell == null) {
      return;
    }
    int i3 = this.jdField_b_of_type_JavaUtilArrayList.size();
    int i1 = ((Integer)paramvij.jdField_a_of_type_JavaLangObject).intValue();
    viv localviv;
    TextCell localTextCell;
    while (i1 >= 0)
    {
      localviv = (viv)this.jdField_b_of_type_JavaUtilArrayList.get(i1);
      i2 = localviv.c() - 1;
      while (i2 >= 0)
      {
        localTextCell = localviv.a(i2);
    ...
    int i2 = ((Integer)paramvij.jdField_a_of_type_JavaLangObject).intValue();
    while (i2 < i3)
    {
      localviv = (viv)this.jdField_b_of_type_JavaUtilArrayList.get(i2);
      int i4 = localviv.c();
      if (i2 == ((Integer)paramvij.jdField_a_of_type_JavaLangObject).intValue()) {
        i1 = ((Integer)paramvij.b).intValue();
      }
      while (i1 < i4)
      {
        localTextCell = localviv.a(i1);
        if (this.jdField_a_of_type_ComTencentBizQqcircleBizpartsDanmakuTextTextCell.linebreakSeq != localTextCell.linebreakSeq) {
          break;
        }
        localTextCell.isPresseding = true;
  ...
  private void a(viv paramviv, TextCell paramTextCell, float paramFloat)
  {
    ...
    for (i1 = this.jdField_e_of_type_Int;; i1 = this.jdField_s_of_type_Int)
    {
      ...
      paramviv.a(paramTextCell, localRect);
      return;
    }
  }
  ...
  {
    if (!paramviz.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getBounds().equals(paramviz.jdField_a_of_type_AndroidGraphicsRect)) {
      paramviz.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setBounds(paramviz.jdField_a_of_type_AndroidGraphicsRect);
    }
  }
  ...
  private boolean a(float paramFloat1, float paramFloat2)
  {
    ...
    if ((this.jdField_c_of_type_Float - paramFloat1) * (this.jdField_c_of_type_Float - paramFloat1) + (this.jdField_d_of_type_Float - paramFloat2) * (this.jdField_d_of_type_Float - paramFloat2) > vjn.jdField_a_of_type_Int) {}
  ...
  private boolean a(int paramInt)
  {
    ...
    if (i4 < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      localTextCell2.text = vjm.a(localTextCell2.text);
      int i7 = a(localTextCell2);
      if (this.jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
        this.jdField_c_of_type_JavaUtilArrayList.add(Integer.valueOf(0));
      }
      if (localTextCell2.isEmo()) {
        via.a().a((EmoCell)localTextCell2, this.jdField_a_of_type_Vjg, this.jdField_a_of_type_ComTencentComponentMediaImageImageLoader$ImageLoadListener);
      }
      ...
      i1 = ((Integer)((vij)localObject).jdField_a_of_type_JavaLangObject).intValue();
      float f1 = ((Float)((vij)localObject).b).floatValue();
      ...
      localObject = localviv.a(i8 - 1);
      if ((localObject == null) || ((!((TextCell)localObject).isEmo()) && (!(localObject instanceof SystemEmoCell)))) {
        break label774;
      }
      localviv.a(i8 - 1);
      localviv = a(i7);
      vij localvij = a((TextCell)localObject, i3);
      a((TextCell)localObject, ((Integer)localvij.jdField_a_of_type_JavaLangObject).intValue(), localviv, ((Float)localvij.b).floatValue(), i3);
      i3 = paramInt - this.jdField_e_of_type_Int;
      localObject = a(localTextCell1, i3);
      i2 = ((Integer)((vij)localObject).jdField_a_of_type_JavaLangObject).intValue();
      f1 = ((Float)((vij)localObject).b).floatValue();
      ...
      for (;;)
      {
        ...
        localTextCell1 = a(localTextCell1, i2, localviv, f1, i3);
        if ((localTextCell1 == null) || (TextUtils.isEmpty(localTextCell1.getText()))) {
          break label711;
        }
        localviv = a(i7);
  ...
  {
    if ((this.jdField_a_of_type_Vhz == null) || (this.jdField_a_of_type_ComEtrumpMixlayoutETDecoration == null)) {}
    int i1;
    do
    {
      int i2;
  ...
  private boolean a(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      default: 
        return false;
      case 0: 
        this.jdField_a_of_type_Viz = a(this.jdField_e_of_type_JavaUtilArrayList, paramMotionEvent.getX(), paramMotionEvent.getY());
        if (this.jdField_a_of_type_Viz == null)
        {
          i1 = a(this.jdField_e_of_type_JavaUtilArrayList);
          i2 = this.jdField_t_of_type_Int;
          i3 = this.U;
          this.jdField_a_of_type_Viz = a(this.jdField_f_of_type_JavaUtilArrayList, paramMotionEvent.getX() - (i1 + i2 + i3), paramMotionEvent.getY());
        }
        if (this.jdField_a_of_type_Viz != null) {}
        for (;;)
        {
      ...
      case 2: 
        viz localviz2 = a(this.jdField_e_of_type_JavaUtilArrayList, paramMotionEvent.getX(), paramMotionEvent.getY());
        viz localviz1 = localviz2;
        if (localviz2 == null)
        {
          i1 = a(this.jdField_e_of_type_JavaUtilArrayList);
          i2 = this.jdField_t_of_type_Int;
          i3 = this.U;
          localviz1 = a(this.jdField_f_of_type_JavaUtilArrayList, paramMotionEvent.getX() - (i1 + i2 + i3), paramMotionEvent.getY());
        }
        if (localviz1 == this.jdField_a_of_type_Viz) {}
        for (bool1 = bool2;; bool1 = false) {
          return bool1;
        }
      case 3: 
        this.jdField_a_of_type_Viz = null;
        return false;
      }
    } while (this.jdField_a_of_type_Viz == null);
    this.jdField_a_of_type_Vix.a(this.jdField_a_of_type_Viz.jdField_a_of_type_AndroidGraphicsDrawableDrawable, this.jdField_a_of_type_Viz.jdField_a_of_type_Int);
    this.jdField_a_of_type_Viz = null;
    return true;
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx))
    {
      localvhx = (vhx)this.jdField_a_of_type_AndroidGraphicsPaint;
      if ((localETEngine == null) || (localvhx == null)) {
        break label200;
      }
      if (this.jdField_a_of_type_Vhz == null) {
        this.jdField_a_of_type_Vhz = new vhz();
      }
      if (this.jdField_a_of_type_Vht == null) {
        this.jdField_a_of_type_Vht = new vht(this, Looper.getMainLooper());
      }
      int i1 = this.jdField_t_of_type_Int;
      vhz localvhz = this.jdField_a_of_type_Vhz;
      ...
      bool = true;
      label142:
      paramBoolean = localvhz.a(localArrayList, i2, i3 - i4 - i5, i1, i6, paramBoolean, bool, ETFont.createFont(localvhx.a()));
      if (this.jdField_a_of_type_ComEtrumpMixlayoutETDecoration != null) {
        break label208;
      }
      this.jdField_a_of_type_ComEtrumpMixlayoutETDecoration = this.jdField_a_of_type_Vhz.a(localETEngine, false);
    }
    for (;;)
    {
      return paramBoolean;
  ...
  private void b(int paramInt, boolean paramBoolean)
  {
    ...
    viv localviv = (viv)this.jdField_b_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_JavaUtilArrayList.size() - 2);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i1 < i4)
        {
          localObject2 = localviv.a(i1);
          int i5 = (int)(paramInt - f1 - this.jdField_e_of_type_Int);
          if (i5 <= 0) {
            return;
          }
          localObject1 = a((TextCell)localObject2, i5);
          int i2 = ((Integer)((vij)localObject1).jdField_a_of_type_JavaLangObject).intValue();
          float f2 = localviv.a(i1).width();
          if (f2 <= i5)
          {
          ...
          else if (((TextCell)localObject2).canBreak())
          {
            ...
            if ("...".equals(this.jdField_d_of_type_JavaLangString))
            {
              ...
              this.jdField_e_of_type_Int = ((int)(((Float)((vij)localObject1).b).floatValue() + f2));
              if (!paramBoolean) {
                break label943;
              }
              localObject1 = localviv.a(localviv.c() - 1);
      ...
      for (;;)
      {
        ...
        if ((this.jdField_b_of_type_JavaUtilArrayList.size() == 2) && (((viv)this.jdField_b_of_type_JavaUtilArrayList.get(1)).a(0) == null))
        {
          ...
          localObject1 = new Rect(localviv.a(localviv.c() - 1));
          ...
          if (i1 == 0)
          {
            localObject2 = localviv.a(localviv.c() - 1);
            ...
            localviv.a(this.jdField_b_of_type_ComTencentBizQqcircleBizpartsDanmakuTextTextCell, (Rect)localObject1);
          }
          if (!paramBoolean) {
            break;
          }
        ...
        for (;;)
        {
          ...
          localviv.a(this.jdField_a_of_type_ComTencentBizQqcircleBizpartsDanmakuTextColorTextCell, (Rect)localObject1);
          return;
          ((TextCell)localObject2).text = ((TextCell)localObject2).text.substring(0, paramInt);
          localviv.a(i1 + 1);
          localObject2 = localviv.a(localviv.c() - 1);
          paramInt = this.jdField_e_of_type_Int;
          ((Rect)localObject2).right = (((Float)((vij)localObject1).b).intValue() + paramInt);
          localObject2 = new Rect(localviv.a(localviv.c() - 1));
          TextCell localTextCell = localviv.a(localviv.c() - 1);
          ...
          paramInt = this.jdField_e_of_type_Int;
          ((Rect)localObject2).left = (((Float)((vij)localObject1).b).intValue() + paramInt);
          paramInt = this.jdField_e_of_type_Int;
          ((Rect)localObject2).right = (((Float)((vij)localObject1).b).intValue() + paramInt + (int)f1);
          localviv.a(this.jdField_b_of_type_ComTencentBizQqcircleBizpartsDanmakuTextTextCell, (Rect)localObject2);
          break;
          localviv.a(i1);
          paramInt = 0;
          break label341;
  ...
  private void b(Canvas paramCanvas)
  {
    ...
    {
      viz localviz = (viz)localIterator.next();
      int i2 = (this.jdField_v_of_type_Int - localviz.jdField_a_of_type_AndroidGraphicsRect.height()) / 2;
      paramCanvas.translate(0.0F, i2);
      a(localviz);
      localviz.jdField_a_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
      paramCanvas.translate(0.0F, -i2);
  ...
  {
    if ((this.jdField_a_of_type_Vhz != null) && (this.jdField_a_of_type_ComEtrumpMixlayoutETDecoration != null) && (this.jdField_a_of_type_Boolean))
    {
      int i1 = this.jdField_a_of_type_Vhz.c();
      int i2 = this.E;
      int i3 = this.jdField_a_of_type_Vhz.d();
      int i4 = this.F;
  ...
  private boolean b(vjg paramvjg, Canvas paramCanvas)
  {
    boolean bool1 = d();
    Bitmap localBitmap = a(paramvjg);
    if ((this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) {}
    for (boolean bool2 = ((vhx)this.jdField_a_of_type_AndroidGraphicsPaint).jdField_a_of_type_Boolean;; bool2 = true)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          int i1;
          Object localObject;
          if ((this.jdField_l_of_type_Boolean) && (paramvjg.isPressed()))
          {
            if (this.D == 80)
            {
              i1 = this.jdField_v_of_type_Int;
          ...
          if (this.D == 80)
          {
            ...
            localObject = (viv)this.jdField_b_of_type_JavaUtilArrayList.get(i5);
            int i11 = ((viv)localObject).c();
            a(localCanvas, (viv)localObject);
            i6 = 0;
            if (i6 >= i11) {
              break label2135;
            }
            localTextCell = ((viv)localObject).a(i6);
            localRect = ((viv)localObject).a(i6);
            if (i5 >= i10) {
              break label828;
            }
            ...
            ((EmoCell)localTextCell).reloadDrawable(paramvjg, this.jdField_a_of_type_ComTencentComponentMediaImageImageLoader$ImageLoadListener);
          }
          Shader localShader;
          for (;;)
          {
            ...
            if (this.D == 1)
            {
              i2 = i3;
              i7 = i1;
              if (((viv)localObject).b() != 0)
              {
                localCanvas.translate(-((viv)localObject).b(), 0.0F);
                i7 = i1;
                i2 = i3;
              }
            }
            ...
            break;
            label828:
            i7 = vim.jdField_a_of_type_Int;
            break label534;
            label836:
            if (((localTextCell instanceof SystemEmoCell)) && (!localTextCell.isDrawableLoaded)) {
              ((SystemEmoCell)localTextCell).reloadDrawable(paramvjg, this.jdField_a_of_type_ComTencentComponentMediaImageImageLoader$ImageLoadListener);
            }
          }
          label868:
          int i2 = i3;
              ...
              if (i3 == 0)
              {
                ...
                if (TextUtils.isEmpty(localTextCell.getUrl()))
                {
                  ...
                  if ((this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation == null) || (this.X != i8) || (this.Y != i12))
                  {
                    ...
                    this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new vir(this));
                  }
                  ...
                  if ((!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString)) && (this.aa > 0) && (this.jdField_a_of_type_Bnqp != null))
                  {
                    localCanvas.translate(this.E, this.F);
                    this.jdField_a_of_type_Bnqp.setBounds(localRect.left, 0, i2 + localRect.left, af);
                    this.jdField_a_of_type_Bnqp.draw(localCanvas);
                    localCanvas.translate(-this.E, -this.F);
                  }
          ...
          for (;;)
          {
            ...
            if ((this.jdField_y_of_type_Boolean) && (i2 != 0))
            {
              ...
              continue;
              label2135:
              if ((this.D == 1) && (((viv)localObject).b() != 0)) {
                localCanvas.translate(-((viv)localObject).b(), 0.0F);
              }
              i5 += 1;
              break;
  ...
  private Bitmap c()
  {
    try
    {
      ...
      vjb.a().a().put(Integer.valueOf(d()), localBitmap);
      o();
      return localBitmap;
    }
  ...
  private void c(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) {}
      for (localObject2 = (vhx)this.jdField_a_of_type_AndroidGraphicsPaint; localObject2 != null; localObject2 = null)
      {
        this.jdField_a_of_type_ComEtrumpMixlayoutETDecoration.drawBackgroundSpace((Bitmap)localObject1, ((vhx)localObject2).a(), i1, i2);
  ...
  private boolean c(vjg paramvjg, Canvas paramCanvas)
  {
    boolean bool1 = d();
    Bitmap localBitmap = a(paramvjg);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (this.D == 80)
        {
          ...
          localObject = (viv)this.jdField_b_of_type_JavaUtilArrayList.get(i4);
          i7 = ((viv)localObject).c();
          if (this.D == 1)
          {
            i2 = ((viv)localObject).a();
            i2 = (this.jdField_s_of_type_Int - i2) / 2;
            ((viv)localObject).b(i2);
        ...
        for (;;)
        {
          ...
          if (i5 < i7)
          {
            localTextCell = ((viv)localObject).a(i5);
            localRect = ((viv)localObject).a(i5);
        ...
        {
          if (!this.jdField_u_of_type_Boolean) {
            this.jdField_a_of_type_Vja.a(this.jdField_b_of_type_Long - this.jdField_a_of_type_Long);
          }
        }
        else
        {
        ...
        for (;;)
        {
          ...
          this.jdField_c_of_type_Boolean = false;
          return true;
          this.jdField_a_of_type_Vja.a(l1 - this.jdField_a_of_type_Long);
          break;
          label839:
          localCanvas.translate(-(this.E + a(this.jdField_e_of_type_JavaUtilArrayList)), -this.F);
        }
  ...
  private boolean d()
  {
    return (this.jdField_w_of_type_Boolean) && ((this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) && (vie.a()) && (this.jdField_b_of_type_JavaUtilArrayList.size() <= 9) && (this.jdField_b_of_type_JavaUtilArrayList.size() >= 0);
  }
  ...
  private int f()
  {
    ...
    try
    {
      ...
      {
        viv localviv = (viv)this.jdField_b_of_type_JavaUtilArrayList.get(0);
        if ((localviv != null) && (localviv.c() > 0)) {
          localviv.a(0);
        }
      }
    }
  ...
  private void l(int paramInt)
  {
    ...
    if (e())
    {
      ...
      if (!f())
      {
        localObject2 = vhy.a().b();
        if (!(this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) {
          break label464;
        }
        localObject1 = (vhx)this.jdField_a_of_type_AndroidGraphicsPaint;
        if ((this.jdField_a_of_type_JavaLangInteger == null) && (localObject2 != null) && (localObject1 != null)) {
          this.jdField_a_of_type_JavaLangInteger = Integer.valueOf(((ETEngine)localObject2).native_getHorizontalMarginThreshold(((vhx)localObject1).a(), paramInt));
        }
  ...
  private void n()
  {
    if (this.Q > 0)
    {
      Bitmap localBitmap = (Bitmap)vjb.a().a().remove(Integer.valueOf(d()));
      if (localBitmap != null) {
        localBitmap.recycle();
      }
    }
  ...
  private void o()
  {
    if ((this.jdField_a_of_type_Viy == null) && (this.Q > 0)) {
      this.jdField_a_of_type_Viy = new viy(this, this.Q);
    }
  }
  ...
  private void p()
  {
    ...
    float f3;
    float f4;
    switch (viu.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable$Orientation.ordinal()])
    {
    default: 
      f1 = localRect.left;
      f2 = localRect.top;
  ...
  Bitmap a()
  {
    Bitmap localBitmap = (Bitmap)vjb.a().a().get(Integer.valueOf(e()));
    if (localBitmap != null) {
      return localBitmap;
    }
    return null;
  ...
  public String a()
  {
    ...
    while (i1 < i3)
    {
      ...
      while (i2 < i4)
      {
        localStringBuilder.append(localviv.a(i2).getText());
        i2 += 1;
      }
      i1 += 1;
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    //   2: aload_0
    //   3: iconst_1
    //   4: putfield 1383	vip:jdField_e_of_type_Boolean	Z
    //   7: aload_0
    //   8: aconst_null
    //   9: putfield 1304	vip:jdField_a_of_type_JavaLangInteger	Ljava/lang/Integer;
    //   12: aload_0
    //   13: iload_1
    //   14: iload_2
    //   15: invokevirtual 1385	vip:b	(II)V
    //   18: aload_0
    //   19: invokespecial 491	vip:e	()Z
    //   22: ifeq +27 -> 49
    //   25: aload_0
    //   26: invokespecial 493	vip:f	()Z
    //   29: ifeq +52 -> 81
    //   32: aload_0
    //   33: iconst_0
    //   34: invokespecial 1387	vip:a	(Z)Z
    //   37: pop
    //   38: aload_0
    //   39: getfield 863	vip:jdField_a_of_type_Boolean	Z
    //   42: ifne +7 -> 49
    //   45: aload_0
    //   46: invokevirtual 1389	vip:d	()V
    //   49: aload_0
    //   50: iconst_0
    //   51: putfield 1383	vip:jdField_e_of_type_Boolean	Z
    //   54: aload_0
    //   55: invokespecial 993	vip:d	()Z
    //   58: ifeq +20 -> 78
    //   61: aload_0
    //   62: invokespecial 491	vip:e	()Z
    //   65: ifne +13 -> 78
    //   68: aload_0
    //   69: aload_0
    //   70: getfield 356	vip:jdField_a_of_type_Vjg	Lvjg;
    //   73: aconst_null
    //   74: invokevirtual 1391	vip:a	(Lvjg;Landroid/graphics/Canvas;)Z
    //   77: pop
    //   78: aload_0
    //   79: monitorexit
    //   80: return
    //   81: aload_0
    //   82: iconst_1
    //   83: invokespecial 1387	vip:a	(Z)Z
    //   86: pop
    //   87: aload_0
    //   88: getfield 861	vip:jdField_a_of_type_ComEtrumpMixlayoutETDecoration	Lcom/etrump/mixlayout/ETDecoration;
    //   91: ifnonnull -53 -> 38
    //   94: aload_0
    //   95: iconst_0
    //   96: invokestatic 344	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   99: putfield 1304	vip:jdField_a_of_type_JavaLangInteger	Ljava/lang/Integer;
    //   102: aload_0
    //   103: iconst_1
    //   104: putfield 213	vip:jdField_i_of_type_Boolean	Z
    //   107: aload_0
    //   108: iload_1
    //   109: iload_2
    //   110: invokevirtual 1385	vip:b	(II)V
    //   113: aload_0
    //   114: iconst_0
    //   115: invokespecial 1387	vip:a	(Z)Z
    //   118: pop
    //   119: goto -81 -> 38
    //   122: astore_3
    //   123: aload_0
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      this.I = paramInt;
      if (this.jdField_a_of_type_Vii == null) {
        this.jdField_a_of_type_Vii = new vis(this, paramInt);
      }
      paramString = vig.a().a(paramInt, paramString, this.jdField_a_of_type_Vii);
    } while (paramString == null);
  ...
  {
    if (this.jdField_a_of_type_Vjg != null)
    {
      View localView = this.jdField_a_of_type_Vjg.a();
      if (localView != null) {
  ...
  public void a(ArrayList<Integer> paramArrayList, int paramInt)
  {
    if (this.jdField_a_of_type_Vjf != null) {
      this.jdField_a_of_type_Vjf.cancel();
    }
    ...
    this.jdField_a_of_type_Vjf = new vjf(this, paramArrayList);
    this.jdField_a_of_type_Vjf.setFillAfter(true);
    this.jdField_a_of_type_Vjf.setRepeatCount(-1);
    this.jdField_a_of_type_Vjf.setRepeatMode(2);
    this.jdField_a_of_type_Vjf.setInterpolator(new LinearInterpolator());
    this.jdField_a_of_type_Vjf.setDuration(paramInt);
    this.jdField_a_of_type_Vjf.setStartTime(0L);
  }
  ...
  public void a(boolean paramBoolean, QzoneBarrageEffectData.BarrageEffectInfo paramBarrageEffectInfo)
  {
    ...
    this.jdField_a_of_type_Bnqp = a(this.jdField_f_of_type_JavaLangString, this.aa);
    return;
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Vjg != null)
    {
      ...
      if (localView != null)
      {
        ...
        if (localView.getHeight() + arrayOfInt[1] > bhtq.b(50.0F))
        {
          int i1 = arrayOfInt[1];
          int i2 = vvv.b();
          if (i1 < bhtq.a(localView.getContext()) + i2) {
            return true;
          }
        }
        return false;
  ...
  public boolean a(MotionEvent paramMotionEvent, Handler paramHandler)
  {
    ...
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      {
        this.jdField_a_of_type_Vjg.setLongClickTrig(false);
        this.jdField_a_of_type_Vjg.b();
      }
      if (this.jdField_o_of_type_Boolean)
      {
        ...
        {
          this.jdField_a_of_type_Vij = paramMotionEvent;
          TextCell localTextCell = ((viv)this.jdField_b_of_type_JavaUtilArrayList.get(((Integer)paramMotionEvent.jdField_a_of_type_JavaLangObject).intValue())).a(((Integer)paramMotionEvent.b).intValue());
      ...
      {
        this.jdField_a_of_type_Vjg.setPressed(true);
        this.jdField_a_of_type_Vjg.invalidate();
        return true;
      }
    ...
    {
      this.jdField_c_of_type_Boolean = true;
      if (this.jdField_a_of_type_Vjg.a()) {
        return true;
      }
      boolean bool = a(paramMotionEvent.getX(), paramMotionEvent.getY());
      if (this.jdField_a_of_type_ComTencentBizQqcircleBizpartsDanmakuTextTextCell != null)
      {
        if (a(paramMotionEvent.getX(), paramMotionEvent.getY(), ((viv)this.jdField_b_of_type_JavaUtilArrayList.get(((Integer)this.jdField_a_of_type_Vij.jdField_a_of_type_JavaLangObject).intValue())).a(((Integer)this.jdField_a_of_type_Vij.b).intValue()))) {
          return true;
        }
        g();
        paramHandler.removeMessages(0);
      ...
      if ((!bool) && ((this.jdField_m_of_type_Boolean) || (!this.jdField_a_of_type_Vjg.a()))) {
        return true;
      }
    }
    else
    {
      ...
      {
        this.jdField_c_of_type_Boolean = true;
        this.jdField_a_of_type_Vjg.setPressed(false);
        if (this.jdField_a_of_type_Vjg.a())
        {
          g();
          return true;
  ...
  public boolean a(vhv paramvhv, ETEngine paramETEngine, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    ...
    try
    {
      ...
      {
        bool1 = bool2;
        if (paramvhv.jdField_b_of_type_Int == this.jdField_c_of_type_Int)
        {
  ...
  public boolean a(vjg paramvjg, Canvas paramCanvas)
  {
    ...
    {
      if ((this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) {
        ((vhx)this.jdField_a_of_type_AndroidGraphicsPaint).jdField_a_of_type_Boolean = bool;
      }
      int i1;
      int i2;
      if (this.jdField_a_of_type_Int == 1)
      {
        ...
        if (this.jdField_a_of_type_Vjf != null)
        {
          if (this.jdField_a_of_type_Vjf.getTransformation(AnimationUtils.currentAnimationTimeMillis(), this.jdField_a_of_type_AndroidViewAnimationTransformation)) {
            i();
          }
          this.jdField_y_of_type_Int = this.jdField_a_of_type_Vjf.a();
          this.jdField_A_of_type_Int = this.jdField_a_of_type_Vjf.a();
        }
        this.jdField_a_of_type_AndroidGraphicsPaint.setTypeface(this.jdField_a_of_type_AndroidGraphicsTypeface);
  ...
  Bitmap b()
  {
    int i1 = 0;
    Object localObject2;
    if ((this.jdField_a_of_type_ComEtrumpMixlayoutETDecoration == null) || (this.jdField_a_of_type_Vhz == null)) {
      localObject2 = null;
    }
    int i2;
    for (;;)
    {
      ...
      if (f())
      {
        i2 = this.jdField_a_of_type_Vhz.a();
        i1 = this.jdField_a_of_type_Vhz.b();
        localObject2 = a();
        try
        {
          int i3 = (int)a() * 4;
          ...
          vjb.a().a().remove(Integer.valueOf(e()));
          ...
          ((Bitmap)localObject1).eraseColor(0);
          vjb.a().a().put(Integer.valueOf(e()), localObject1);
          localObject2 = localObject1;
          if (this.jdField_b_of_type_Viy == null)
          {
            this.jdField_b_of_type_Viy = new viy(this, e());
            return localObject1;
          }
        }
        catch (Throwable localThrowable)
  ...
  public void b(int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (((this.jdField_a_of_type_AndroidGraphicsPaint instanceof vhx)) && (paramString1.equals(((vhx)this.jdField_a_of_type_AndroidGraphicsPaint).a())));
      this.I = paramInt1;
      if (this.jdField_a_of_type_Bmza == null) {
        this.jdField_a_of_type_Bmza = new vit(this, paramInt1, paramInt2);
      }
      paramString1 = bmyy.a(paramInt1, paramString1, null, this.jdField_a_of_type_Bmza);
      if (!TextUtils.isEmpty(paramString1)) {
  ...
  public int c()
  {
    if (this.jdField_w_of_type_Int <= 0) {
      this.jdField_w_of_type_Int = bhtq.b(QzoneConfig.getInstance().getConfig("QzCustomFont", "LargeFontSize", 30));
    }
  ...
  public void c()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Vht == null) || (this.jdField_a_of_type_ComEtrumpMixlayoutETDecoration == null))
      {
  ...
  protected void c(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (int i1 = paramInt2 * 3;; i1 = paramInt1)
      {
        ...
        {
          vjj localvjj = vjh.a().a(paramInt2, (int)this.jdField_a_of_type_AndroidGraphicsPaint.getTextSize(), b());
          if ((localvjj != null) && (!this.jdField_j_of_type_Boolean))
          {
            this.jdField_c_of_type_JavaUtilArrayList = localvjj.jdField_b_of_type_JavaUtilArrayList;
            this.jdField_b_of_type_JavaUtilArrayList = localvjj.jdField_a_of_type_JavaUtilArrayList;
            this.jdField_s_of_type_Int = localvjj.jdField_a_of_type_Int;
          }
        }
        int i2;
        for (;;)
        {
          ...
          l(paramInt2);
          vjh.a().a(paramInt2, (int)this.jdField_a_of_type_AndroidGraphicsPaint.getTextSize(), b(), new vjj(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_c_of_type_JavaUtilArrayList, this.jdField_s_of_type_Int));
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_Vjg.setPressed(false);
    this.jdField_a_of_type_Vjg.postInvalidate();
    if (this.jdField_a_of_type_ComTencentBizQqcircleBizpartsDanmakuTextTextCell == null) {
      return;
    }
  ...
  public void h()
  {
    if ((this.jdField_a_of_type_Vjf != null) && ((!this.jdField_a_of_type_Vjf.hasStarted()) || (this.jdField_a_of_type_Vjf.hasEnded())))
    {
      this.jdField_a_of_type_Vjf.start();
      f();
    }
