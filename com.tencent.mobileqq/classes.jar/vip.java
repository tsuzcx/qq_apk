...
public class vip
  extends vqr<viq>
{
  private static final String jdField_a_of_type_JavaLangString = vpl.a("StorySvc.batch_get_poi_list");
  ...
  public viq a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new viq(localRspBatchGetPOIList);
    }
