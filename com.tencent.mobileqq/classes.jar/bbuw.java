...
public class bbuw
{
  private bbuu jdField_a_of_type_Bbuu = new bbuu();
  private String jdField_a_of_type_JavaLangString;
  private String b;
  
  public static bbuw a()
  {
    return bbuy.a;
  }
  ...
  private List<String> a(QQAppInterface paramQQAppInterface)
  {
    ...
    localArrayList.add(ajsf.aW + paramQQAppInterface + File.separator);
  ...
  private void a(String paramString)
  {
    ...
    {
      paramString = new File(bbuv.a(paramString));
  ...
  private void c(Context paramContext)
  {
    ...
    Iterator localIterator = bbuz.a.iterator();
  ...
  private void d()
  {
    for (;;)
    {
      try
      {
        File[] arrayOfFile = new File(ajsf.aW).listFiles();
        if (arrayOfFile == null) {
          return;
        }
  ...
  public final void a()
  {
    Iterator localIterator = bbuz.b.iterator();
    while (localIterator.hasNext()) {
  ...
  public void a(Context paramContext)
  {
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        this.jdField_a_of_type_Bbuu.reportError(paramContext);
  ...
  public void b(Context paramContext)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      FileSystemManager.setStatisticsCallback(this.jdField_a_of_type_Bbuu);
    }
  }
}
