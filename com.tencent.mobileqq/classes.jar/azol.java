...
public class azol
  implements azoc
{
  private static azol jdField_a_of_type_Azol;
  private azod jdField_a_of_type_Azod;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private QIPCModule jdField_a_of_type_ComTencentMobileqqQipcQIPCModule = new azom(this, "PrecoverIPCServer_MODEL");
  ...
  private azol()
  {
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_Azod = ((azod)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PRECOVER_MANAGER));
      this.jdField_a_of_type_Azod.a().a(this);
    }
  }
  
  public static azol a()
  {
    if (jdField_a_of_type_Azol == null) {}
    try
    {
      if (jdField_a_of_type_Azol == null) {
        jdField_a_of_type_Azol = new azol();
      }
      return jdField_a_of_type_Azol;
    }
    finally {}
  }
  ...
  private EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Azod.a((String)localObject2, str);
  ...
  public void a(int paramInt, String paramString, PrecoverResource paramPrecoverResource, Object paramObject)
  {
    if ((paramObject != null) && ((paramObject instanceof Object[])) && ("PrecoverIPCServer_MODEL".equals(((Object[])(Object[])paramObject)[0])))
    {
      ...
      paramObject.putString("key_action", azok.b);
