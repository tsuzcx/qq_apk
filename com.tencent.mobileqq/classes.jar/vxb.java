...
{
  public vxb(QCircleFollowView paramQCircleFollowView, int paramInt1, int paramInt2) {}
  ...
  public void a(boolean paramBoolean, long paramLong, String paramString, FeedCloudWrite.StDoFollowRsp paramStDoFollowRsp)
  {
    ...
    if ((paramBoolean) && (paramLong == 0L))
    {
      ...
      if ((QCircleFollowView.b(this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleFollowView)) && (this.jdField_a_of_type_Int == 1)) {
        QQToast.a(this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleFollowView.getContext(), 2, 2131697162, 0).a();
      }
      ...
      if (this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleFollowView.a != null)
      {
        ...
        zwp.a().a(new QCircleFollowUpdateEvent(this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleFollowView.a.id.get()));
      ...
      for (paramBoolean = bool;; paramBoolean = false)
      {
        ...
        if (paramStDoFollowRsp != null) {
          vtj.a().a(this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleFollowView.a.id.get(), this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleFollowView.a.nick.get(), paramStDoFollowRsp.isDoubly.get());
        }
        return;
        paramBoolean = false;
        break;
