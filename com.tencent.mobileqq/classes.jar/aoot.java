...
public abstract class aoot
  extends bhgg
  implements aooc
{
  Paint jdField_a_of_type_AndroidGraphicsPaint;
  RectF jdField_a_of_type_AndroidGraphicsRectF = new RectF();
  aoou jdField_a_of_type_Aoou;
  FaceInfo jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo;
  boolean jdField_a_of_type_Boolean;
  boolean b;
  
  protected aoot(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, byte paramByte, int paramInt3, int paramInt4, boolean paramBoolean1, Drawable paramDrawable1, Drawable paramDrawable2, aoou paramaoou, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo = new FaceInfo(paramInt1, paramString, false, paramByte, aope.a((byte)paramInt3), paramBoolean1, paramInt2, paramBoolean2, paramInt4);
    if ((paramInt1 == 4) && (!bguq.a(paramString))) {
      this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo.jdField_a_of_type_Int = 113;
    }
    if ((this instanceof aopn))
    {
      paramAppInterface = a();
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Aoou != null) {
        this.jdField_a_of_type_Aoou.onLoadingStateChanged(-1, this.jdField_a_of_type_Int);
      }
  ...
  public static aoot a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString)
  {
  ...
  public static aoot a(AppInterface paramAppInterface, int paramInt, String paramString)
  {
    int i = a(paramInt);
  ...
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    int i = a(paramInt1);
  ...
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, null);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, int paramInt3)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, null);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, aoou paramaoou)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, paramaoou, false);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, aoou paramaoou, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new aoov(paramAppInterface, paramInt1, 200, paramString, (byte)0, paramInt2, 100, false, paramDrawable1, paramDrawable2, paramaoou, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new aopn(paramAppInterface, paramInt1, 200, paramString, (byte)1, paramInt2, false, paramDrawable1, paramDrawable2, paramaoou, paramBoolean);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, aoou paramaoou)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramaoou, false);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, aoou paramaoou, boolean paramBoolean)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new aoov(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, 100, true, localDrawable, localDrawable, paramaoou, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new aopn(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, true, localDrawable, localDrawable, paramaoou, paramBoolean);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, boolean paramBoolean)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
        QLog.i("Q.qqhead.FaceDrawable", 2, "getFaceDrawable fail, uin=" + paramString + ", idType=" + paramInt1 + ",appIntf=" + paramAppInterface + ",shape=" + paramInt2);
    ...
    do
    {
      ...
      localDrawable = a(32, paramInt2);
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new aoov(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, 100, true, localDrawable, localDrawable, null, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new aopn(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, true, localDrawable, localDrawable, null, paramBoolean);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt, String paramString, boolean paramBoolean)
  {
    return a(paramAppInterface, paramInt, paramString, paramBoolean, false);
  }
  
  public static aoot a(AppInterface paramAppInterface, int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new aoov(paramAppInterface, 32, paramInt, paramString, (byte)1, 3, 100, paramBoolean1, localDrawable, localDrawable, null, paramBoolean2);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new aopn(paramAppInterface, 32, paramInt, paramString, (byte)1, 3, paramBoolean1, localDrawable, localDrawable, null, paramBoolean2);
  }
  
  public static aoot a(AppInterface paramAppInterface, String paramString, byte paramByte)
  {
  ...
  public static aoot b(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, false);
  }
  
  public static aoot b(AppInterface paramAppInterface, String paramString, byte paramByte)
  {
  ...
  public void a(FaceInfo paramFaceInfo, Bitmap paramBitmap)
  {
    ...
    {
      invalidateSelf();
      if ((i == this.jdField_a_of_type_Int) || (this.jdField_a_of_type_Aoou == null)) {
        break;
      }
      this.jdField_a_of_type_Aoou.onLoadingStateChanged(i, this.jdField_a_of_type_Int);
      return;
      i = j;
      if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) {
        break label107;
  ...
  public void b()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      setCallback(null);
      this.jdField_a_of_type_Aoou = null;
      a(null);
    }
    super.b();
  }
  ...
  {
    if ((this.jdField_b_of_type_Boolean) && (blqj.a()))
    {
