  ...
  implements Serializable
{
  ...
  private static eDisGroupInfoFlag[] a = new eDisGroupInfoFlag[6];
  ...
  public static eDisGroupInfoFlag convert(int paramInt)
  {
    ...
    for (;;)
    {
      eDisGroupInfoFlag[] arrayOfeDisGroupInfoFlag = a;
      if (i >= arrayOfeDisGroupInfoFlag.length) {
        break;
      }
      if (arrayOfeDisGroupInfoFlag[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static eDisGroupInfoFlag convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfeDisGroupInfoFlag[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
