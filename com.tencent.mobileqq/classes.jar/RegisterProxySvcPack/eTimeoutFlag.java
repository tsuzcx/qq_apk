  ...
  implements Serializable
{
  ...
  public static final eTimeoutFlag DIS_MSG_TIMEOUT = new eTimeoutFlag(7, 128, "DIS_MSG_TIMEOUT");
  ...
  private static eTimeoutFlag[] a = new eTimeoutFlag[8];
  ...
  public static eTimeoutFlag convert(int paramInt)
  {
    ...
    for (;;)
    {
      eTimeoutFlag[] arrayOfeTimeoutFlag = a;
      if (i >= arrayOfeTimeoutFlag.length) {
        break;
      }
      if (arrayOfeTimeoutFlag[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static eTimeoutFlag convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfeTimeoutFlag[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
