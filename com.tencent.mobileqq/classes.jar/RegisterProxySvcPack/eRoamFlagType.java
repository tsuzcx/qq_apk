...
{
  public static final eRoamFlagType QQ_24HOURS_ROAM = new eRoamFlagType(5, 32, "QQ_24HOURS_ROAM");
  ...
  private static eRoamFlagType[] a = new eRoamFlagType[6];
  ...
  public static eRoamFlagType convert(int paramInt)
  {
    ...
    for (;;)
    {
      eRoamFlagType[] arrayOfeRoamFlagType = a;
      if (i >= arrayOfeRoamFlagType.length) {
        break;
      }
      if (arrayOfeRoamFlagType[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static eRoamFlagType convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfeRoamFlagType[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
