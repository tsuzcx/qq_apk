  ...
  implements Serializable
{
  ...
  public static final eRequestOptional IS_NEED_PULL_BOX_FILTER_LIST = new eRequestOptional(15, 65536, "IS_NEED_PULL_BOX_FILTER_LIST");
  ...
  public static final int _IS_NEED_PULL_BOX_FILTER_LIST = 65536;
  ...
  private static eRequestOptional[] a = new eRequestOptional[16];
  ...
  public static eRequestOptional convert(int paramInt)
  {
    ...
    for (;;)
    {
      eRequestOptional[] arrayOfeRequestOptional = a;
      if (i >= arrayOfeRequestOptional.length) {
        break;
      }
      if (arrayOfeRequestOptional[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static eRequestOptional convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfeRequestOptional[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
