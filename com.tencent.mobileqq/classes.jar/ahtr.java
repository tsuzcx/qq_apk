...
public class ahtr
  extends ahzi
{
  public ahtr(TroopMemberListInnerFrame paramTroopMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131496808, paramViewGroup, false);
      paramView = new ahts(this.a, null);
      ...
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131312503);
    }
    paramViewGroup = (ahts)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localTroopMemberInfo.memberuin))
      {
        ...
        str = babh.h(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTroopMemberInfo.troopuin, localTroopMemberInfo.memberuin);
        ...
        {
          if (!azgu.b(this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app, localTroopMemberInfo.memberuin)) {
            break label737;
          }
        ...
        localView.setContentDescription(str + ajjy.a(2131649755));
      }
      for (;;)
      {
        ...
        break label430;
        label707:
        paramViewGroup.b.setText(babh.h(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTroopMemberInfo.troopuin, localTroopMemberInfo.memberuin));
        break label438;
        label737:
        ...
        break label525;
        label760:
        localView.setContentDescription(str + ajjy.a(2131649779));
        continue;
        label792:
        if ((this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.d == 14) && (!paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled())) {
          localView.setContentDescription(str + ajjy.a(2131649768));
        }
      }
    }
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131626315), new Object[] { paramView.toLowerCase() }));
    return localView;
  }
}
