  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if ((this.a.jdField_a_of_type_AndroidContentContext instanceof FragmentActivity))
      {
        ...
        {
          localObject2 = (agvx)((BaseChatPie)localObject2).a(27);
          if (localObject2 != null) {
            ((agvx)localObject2).a((String)localObject1, localaeau, 0);
          }
        }
      }
      Object localObject2 = MessageForText.getTroopMemberInfoFromExtrJson(localMessageForText.getExtInfoFromExtStr(bcrn.i));
      aean.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (String)localObject1, (ArrayList)localObject2, localaeau);
    ...
    {
      bdll.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_msg", "", "grp_msg", "clk_like", 0, 0, localMessageForText.frienduin, "", (String)localObject1, "");
      break;
