...
public abstract class apdt
{
  ...
  public apdt(int paramInt)
  {
    this.jdField_c_of_type_JavaLangString = apdx.jdField_a_of_type_JavaLangString;
    ...
    this.jdField_j_of_type_JavaLangString = apdx.jdField_b_of_type_JavaLangString;
    this.jdField_k_of_type_JavaLangString = apdx.jdField_c_of_type_JavaLangString;
    this.jdField_l_of_type_JavaLangString = apdx.jdField_d_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = "precision mediump float;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nuniform mat4 uMVPMatrix;\nvoid main() {\n   gl_Position = uMVPMatrix * aPosition;\n   vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}";
    this.o = paramInt;
  }
  
  private final int a(apdw paramapdw, boolean paramBoolean)
  {
    int i1 = 0;
    a(paramapdw);
    if (this.jdField_a_of_type_Apdu != null) {
      this.jdField_a_of_type_Apdu.a();
    }
    if (this.n == 1) {
      this.jdField_a_of_type_Apdp.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      GLES20.glBindTexture(3553, 0);
      GLES20.glBindFramebuffer(36160, 0);
      apdx.a("keyingHandleAfter");
      if (paramBoolean) {
        i1 = this.jdField_a_of_type_Apdq.a();
      }
      return i1;
  ...
  private final void a(apdw paramapdw, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_Apdq.a(paramInt1, paramInt2);
    ...
    for (;;)
    {
      ...
      if (this.m != -1) {
        GLES20.glUniform4f(this.m, paramapdw.jdField_a_of_type_Float, paramapdw.jdField_b_of_type_Float, paramapdw.jdField_c_of_type_Float, 1.0F);
      }
      apdx.a("keyingHandleBefore");
      return;
      this.jdField_a_of_type_Apdz.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
  }
  
  public final int a(int[] paramArrayOfInt, apdw paramapdw, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    return a(paramArrayOfInt, paramapdw, paramArrayOfFloat1, paramArrayOfFloat2, false, 0, 0);
  }
  
  public final int a(int[] paramArrayOfInt, apdw paramapdw, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    if (paramArrayOfInt == null) {
      throw new IllegalArgumentException("textureIds can not be null!");
    }
    a(paramapdw, paramArrayOfFloat1, paramArrayOfFloat2, paramBoolean, paramInt1, paramInt2);
    switch (this.o)
    {
    }
    for (;;)
    {
      apdx.a("keyingTexture");
      return a(paramapdw, paramBoolean);
  ...
  protected String a()
  {
    this.jdField_c_of_type_JavaLangString = apdx.a(this.o);
  ...
  public final void a(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (this.n == 1) {
      this.jdField_a_of_type_Apdp = new apdp(1.0F, this.jdField_a_of_type_Float, this.jdField_b_of_type_Float, this.jdField_c_of_type_Float);
    }
    for (;;)
    {
      this.jdField_a_of_type_Apdq = new apdq();
      this.jdField_d_of_type_Int = apdx.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
      apdx.a("createProgram");
      if (this.jdField_d_of_type_Int == 0) {
        break;
      }
      this.jdField_e_of_type_Int = GLES20.glGetAttribLocation(this.jdField_d_of_type_Int, "aPosition");
      apdx.a("glGetAttribLocation aPosition");
      if (this.jdField_e_of_type_Int != -1) {
        break label303;
      }
      throw new RuntimeException("Could not get attrib location for aPosition");
      if ((this.jdField_b_of_type_ArrayOfFloat != null) && (this.jdField_a_of_type_ArrayOfShort != null)) {
        this.jdField_a_of_type_Apdz = new apdz(this.jdField_b_of_type_ArrayOfFloat, this.jdField_a_of_type_ArrayOfShort);
      } else {
  ...
  public void a(String paramString1, String paramString2, String paramString3, apdu paramapdu)
  {
    ...
    this.jdField_a_of_type_Apdu = paramapdu;
  }
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Apdq == null);
    this.jdField_a_of_type_Apdq.a();
    this.jdField_a_of_type_Apdq = null;
  }
}
