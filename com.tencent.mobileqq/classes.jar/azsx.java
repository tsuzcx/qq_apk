  ...
  implements Manager
{
  ...
  public azsx(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    String str = SecurityUtil.encrypt(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()) + "GetQZoneFeeds";
  ...
  private void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), azsz.class);
    paramArrayList = new ArrayList(paramArrayList.subList(paramInt, i));
    azta.a(localNewIntent, azta.a(1, Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), paramArrayList, 0L, null));
  ...
  public void a()
  {
    ...
    while (!NetworkUtil.isNetworkAvailable(BaseApplication.getContext())) {
      return;
    }
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), azsz.class);
    azta.a(localNewIntent, azta.a(2, Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), null, paramLong, paramString));
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(localNewIntent);
  }
  ...
  public void b()
  {
    ...
    this.e = 1;
    this.f = 0;
    this.jdField_a_of_type_JavaUtilArrayList = azta.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("QzoneContactsFeedManager", 2, new Object[] { "allFriends.size:", Integer.valueOf(i), ",getAllFreindsCount:", Integer.valueOf(localamsw.a()) });
    }
    a(this.jdField_a_of_type_JavaUtilArrayList, this.f);
  }
