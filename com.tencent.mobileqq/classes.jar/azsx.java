...
{
  azsx(azsv paramazsv, View paramView) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      if (!this.jdField_a_of_type_Azsv.b)
      {
        this.jdField_a_of_type_Azsv.b = true;
        ObjectAnimator localObjectAnimator = (ObjectAnimator)paramView.getTag(2131373507);
        ...
        if (localObjectAnimator == null)
        {
          ...
          paramView.setTag(2131373507, paramMotionEvent);
        }
        paramMotionEvent.start();
      }
      return true;
      this.jdField_a_of_type_Azsv.a.onClick(this.jdField_a_of_type_AndroidViewView);
      this.jdField_a_of_type_Azsv.b = false;
      paramView = (ObjectAnimator)paramView.getTag(2131373507);
      if (paramView != null) {
        paramView.reverse();
      }
    }
