...
public class teq
{
  ...
  public teq(qqstory_struct.VideoSpreadGroupList paramVideoSpreadGroupList)
  {
  ...
  public teq(List<String> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  public static boolean a(teq paramteq)
  {
    return (paramteq == null) || (paramteq.jdField_a_of_type_JavaUtilList == null) || (paramteq.jdField_a_of_type_JavaUtilList.isEmpty());
  }
