  ...
  implements adig
{
  ...
  {
    axqw.b(paramQQAppInterface, "dc00898", "", "", "0X8008C70", "0X8008C70", aezn.a(paramInt), 0, "", "", "", "");
    paramString = aqxh.a(paramString);
    if ((paramString != null) && (paramString.length() > 20))
    {
      bcpw.a(paramContext, ajyc.a(2131705457), 0).a();
      axqw.b(paramQQAppInterface, "dc00898", "", "", "0X800932C", "0X800932C", 0, 0, "", "", "", "");
      return false;
    }
    return true;
  }
  ...
  public boolean a(Context paramContext, String paramString, EditText paramEditText)
  {
    ...
    return (paramString.length() < 200) && (!paramString.contains("\n")) && ((int)this.a.measureText(paramString) + actn.a(45.0F, paramContext.getResources()) + paramEditText.getPaddingLeft() < paramEditText.getMeasuredWidth());
  }
}
