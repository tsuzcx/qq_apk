...
public class adid
  extends anmu
{
  public adid(AccountManageActivity paramAccountManageActivity) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    Object localObject3 = (bdeh)this.a.app.getManager(61);
    Object localObject1 = "";
    int i = ((bdeh)localObject3).a();
    label67:
    label124:
    Object localObject2;
    if (i == 0)
    {
      ...
      if ((i > j) && (this.a.jdField_a_of_type_JavaUtilList.get(j) != null) && (paramString.equals(((SimpleAccount)this.a.jdField_a_of_type_JavaUtilList.get(j)).getUin())))
      {
        localObject1 = (TextView)this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).findViewById(2131371539);
        localObject2 = (TextView)this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).findViewById(2131361856);
        ((TextView)localObject1).setText(bglf.h(this.a.app, paramString));
    ...
    {
      localObject3 = ((bdeh)localObject3).a("sub.uin.default");
      if (localObject3 == null) {
        break label571;
      }
      localObject2 = bglf.c(this.a.app, ((SubAccountInfo)localObject3).subuin, false);
    ...
    {
      break label67;
      localObject2 = i + anni.a(2131698558);
      localObject3 = ((bdeh)localObject3).a();
      localObject1 = localObject2;
