...
{
  public apoc(ColorNoteSmallScreenService paramColorNoteSmallScreenService) {}
    ...
    for (;;)
    {
      ...
      if (QLog.isDevelopLevel())
      {
        ...
        if ((paramContext != null) && (paramContext.size() != 0))
        {
          ...
          if (aplm.a(paramContext)) {
            ColorNoteSmallScreenService.a(this.a).a();
          }
          if (QLog.isColorLevel())
          {
            aplm.a("ColorNoteSmallScreenService", "[onReceive->FromType_UpdateData]\n[visibleColorNotes]: " + this.a.jdField_a_of_type_Int + "\n" + aplm.b(paramContext));
            break label728;
            paramContext = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().a();
            if ((!apku.a()) && (((paramContext.size() == 1) && (aplm.b((ColorNote)paramContext.get(0)))) || (paramContext.size() == 0)))
            {
              this.a.f();
              break label728;
              ...
              aplm.a("ColorNoteSmallScreenService", "[onReceive->FromType_CustomNightMode]\n[setCustomNightMode]: " + bool);
              break label728;
              label549:
