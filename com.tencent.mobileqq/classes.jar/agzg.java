...
public class agzg
  implements ahan, Handler.Callback, View.OnClickListener
{
  private static final String jdField_a_of_type_JavaLangString = alud.a(2131701655);
  private static final String jdField_b_of_type_JavaLangString = alud.a(2131701656);
  ...
  public agzg(BaseActivity paramBaseActivity, ahap paramahap)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Ahap = paramahap;
    this.jdField_a_of_type_Bfyh = ((bfyh)paramBaseActivity.app.getManager(165));
  ...
  {
    if ((paramMessage.what == 1) && (this.jdField_a_of_type_Ahap.a() == this)) {
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131362401: 
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009788", "ClickLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bfyh.a(this.f), "8.3.5", "");
      return;
    }
    ...
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
    this.jdField_a_of_type_Ahap.a();
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009789", "CloseLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bfyh.a(this.f), "8.3.5", "");
  }
}
