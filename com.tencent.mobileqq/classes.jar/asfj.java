...
public class asfj
{
  ...
  public static void a(List<String> paramList)
  {
    ...
    Object localObject1 = (QQAppInterface)bofz.a();
    asfk localasfk = (asfk)((QQAppInterface)localObject1).getManager(QQManagerFactory.FAVROAMING_DB_MANAGER);
    anua localanua = (anua)((QQAppInterface)localObject1).getBusinessHandler(BusinessHandlerFactory.FAVEMO_ROAMING_HANDLER);
    ...
    for (;;)
    {
      ...
      if (!a(localCustomEmotionData1.emoOriginalPath))
      {
        ...
        localasfk.c(localCustomEmotionData1);
        k += 1;
        localanua.notifyUI(2, true, null);
        a(false, 1, 0);
        break;
      }
      ...
      localObject2 = AppConstants.SDCARD_IMG_FAVORITE + aozu.a(str1) + str3 + (String)localObject2;
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localasfk.a(localCustomEmotionData2, localList.indexOf(localCustomEmotionData2));
          i = 1;
        }
      }
      for (;;)
      {
        ...
        {
          localasfk.a(localCustomEmotionData2);
        }
        else
        {
          m = 1;
  ...
  public static boolean a(String paramString)
  {
    try
    {
      arar localarar = (arar)aqxe.a().a(561);
      if (new File(paramString).length() >= localarar.a) {
        return false;
      }
      if (!azlo.a(paramString))
      {
        ...
        if (localOptions.outWidth < localarar.b)
        {
