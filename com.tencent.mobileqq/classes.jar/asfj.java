...
public class asfj
{
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    return 0;
    Object localObject = paramQQAppInterface.a(1044).a(ajsf.aT, 1044);
    if (localObject == null)
    {
  ...
  public static Intent a(Context paramContext)
  {
    ...
    paramContext.putExtra("uin", ajsf.aT);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = paramQQAppInterface.a(1044).a(ajsf.aT, 1044);
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentMatchChatListItem paramRecentMatchChatListItem, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean) {
        paramQQAppInterface.a().a(ajsf.aT, 1044, paramRecentMatchChatListItem.a(), paramQQAppInterface.getCurrentAccountUin());
      }
    } while (i <= 0);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    bbjn.a(paramQQAppInterface.getAccount(), "match_chat_config_sp").edit().putBoolean(paramString, paramBoolean).apply();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    return bbjn.a(paramQQAppInterface.getAccount(), "match_chat_config_sp").getBoolean(paramString, false);
  }
}
