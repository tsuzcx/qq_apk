...
public class alpv
{
  ...
  public String b()
  {
    if (8 == this.jdField_a_of_type_Int) {
      return amip.h + this.jdField_b_of_type_Int + File.separator + this.jdField_a_of_type_JavaLangString;
    }
    return amip.jdField_a_of_type_JavaLangString + this.jdField_b_of_type_Int + File.separator + this.jdField_a_of_type_JavaLangString;
  }
  
  public boolean b()
  {
    if ((ApolloUtil.c(b())) && (this.jdField_a_of_type_Int == 8)) {
      return ApolloUtil.c(amip.h + this.jdField_b_of_type_Int + File.separator + "room.bin");
    }
    return false;
  }
  ...
  public String c()
  {
    ...
    if (this.jdField_a_of_type_Int == 6)
    {
      ...
      localObject1 = new File(amip.j + (String)localObject1 + File.separator + "face.json");
    ...
    {
      return "";
      Object localObject2 = new File(amip.f + this.jdField_b_of_type_Int + File.separator + "blendshape.json");
      if (((File)localObject2).exists())
      {
        ...
        continue;
        Object localObject3 = new File(amip.f + this.jdField_b_of_type_Int + File.separator + "face.json");
        ...
        {
          Object localObject4 = new File(amip.f + this.jdField_b_of_type_Int + File.separator + "blendshape.json");
