...
public class axxd
{
  ...
  private static String a(android.graphics.Bitmap paramBitmap)
  {
    ...
    //   6: dup
    //   7: getstatic 30	antf:cj	Ljava/lang/String;
    //   10: invokestatic 35	bigv:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, beyf parambeyf)
  {
    parambeyf.addFilter(new Class[] { bevi.class });
    paramQQAppInterface.a().a(parambeyf);
  ...
  {
    new bdlq(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, agej.a(150.0F, paramActivity.getResources()));
    new ayua(paramActivity).a(localImageView, localLayoutParams).b(anzj.a(2131706284)).a(new aytu(anzj.a(2131706286), new axxe(paramActivity, paramQQAppInterface))).show();
