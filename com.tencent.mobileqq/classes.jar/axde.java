...
public class axde
{
  ...
  public static void a()
  {
    ...
    bbdx.d(str1 + "libartfilter.so");
    bbdx.d(str1 + "262_8_model");
    bbdx.d(str1 + "262_8_md04_reshape");
    str1 = str1 + "bakcup/";
    if (bbdx.a(str1))
    {
      arrayOfString = b;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return bool;
      i = bbdx.a(paramString, biiv.b, false, true, QLog.isColorLevel());
  ...
  static boolean b(String paramString1, String paramString2)
  {
    ...
    if (i < paramString2.size())
    {
      ...
      do
      {
        ...
        localObject = axev.a(str);
        j = ((axew)localObject).a('|');
        if (j != 0) {
          break label407;
        }
        str = paramString1 + ((axew)localObject).c();
        File localFile = new File(str);
        if (!localFile.exists())
        {
        ...
        j = Integer.parseInt(((axew)localObject).d());
        l = localFile.length();
      } while (j == l);
