...
{
  public ajee(ImageView paramImageView, int paramInt1, int paramInt2, int paramInt3, String paramString, URLDrawable paramURLDrawable, float paramFloat, int paramInt4) {}
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    {
      ThreadManager.post(new ajef(this), 5, null, true);
      return;
    }
