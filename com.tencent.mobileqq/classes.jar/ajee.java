...
public class ajee
  extends BaseAdapter
  implements ajgv, ajgx, View.OnClickListener, View.OnLongClickListener, bcwt, bhww
{
  public int a;
  private long jdField_a_of_type_Long;
  private ajdx jdField_a_of_type_Ajdx;
  private ajel jdField_a_of_type_Ajel;
  protected ajfa a;
  protected ajfi a;
  protected Context a;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajek(this);
  ...
  public ajee(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, ajdx paramajdx, int paramInt)
  {
    this(paramContext, paramQQAppInterface, paramXListView, paramajdx, paramInt, false);
  }
  
  public ajee(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, ajdx paramajdx, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Ajfi = new ajfi(paramInt);
    this.jdField_a_of_type_Ajfi.a(this);
    this.jdField_a_of_type_Ajfa = new ajfa(paramQQAppInterface, this, paramBoolean);
    this.jdField_a_of_type_Uzh = new uzh(paramQQAppInterface);
    this.jdField_a_of_type_Uzh.a(new ajef(this));
    if (paramInt == 0) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    if ((paramRecentBaseData instanceof RecentItemChatMsgData))
    {
      ...
      if ((paramRecentBaseData == null) || (paramRecentBaseData.getType() != 1008) || (!ssp.b(paramQQAppInterface, paramRecentBaseData.uin))) {
        break label131;
      }
    }
    label131:
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      paramQQAppInterface = ((behr)paramQQAppInterface.a(107)).a("");
  ...
  private void b(RecentBaseData paramRecentBaseData, String paramString1, String paramString2)
  {
    ...
    {
      ors.a();
      nrt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80067CE", "0X80067CE", 0, 0, "", "", "", ors.c(), false);
    }
    try
    {
    ...
    catch (Exception paramString1)
    {
      ...
      if (i == 8113)
      {
        ...
        paramString1 = paramRecentBaseData.a();
        ((alro)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).d(paramString1);
      }
      a(paramRecentBaseData, paramString2);
      switch (i)
      {
      default: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "999", paramString2, "", "");
        return;
      case 0: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "0", "", paramString2, "");
        return;
      case 1: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "1", "", paramString2, "");
        return;
      case 3000: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "2", "", paramString2, "");
        return;
      case 1008: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "3", "", paramString2, "");
        if ((paramRecentBaseData instanceof RecentItemEcShop)) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_DelMsghelper", "Clk_DelshopItem", 0, 0, paramRecentBaseData.a(), "", paramRecentBaseData.mTitleName, "");
        }
        paramString1 = paramRecentBaseData.a();
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", paramString1, "0X80064C9", "0X80064C9", 0, 0, "" + paramRecentBaseData.mUnreadNum, "", "", "");
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "", "0X80067EE", "0X80067EE", 0, 0, "" + paramRecentBaseData.a(), "", "", "");
        ajfx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.mUnreadFlag, paramRecentBaseData.b(), 1, paramRecentBaseData.b());
        if (aljq.aQ.equals(paramString1)) {
          osm.a();
        }
        szp.a(paramString1);
        return;
      case 5000: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "4", "", paramString2, "");
        return;
      case 7000: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "5", "", paramString2, "");
        return;
      case 4000: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "6", "", paramString2, "");
        return;
      case 1022: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "7", "", paramString2, "");
        return;
      case 6000: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "8", "", paramString2, "");
        return;
      case 7200: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004142", "0X8004142", 0, 0, "9", "", paramString2, "");
        return;
      case 1001: 
      case 10002: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80050FC", "0X80050FC", 0, 0, "", "", "", "");
        if ((paramRecentBaseData instanceof RecentMsgBoxItem))
        {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", ((RecentMsgBoxItem)paramRecentBaseData).c(), "msg_box", "delete_msg", 0, 0, "", "", "", "");
          return;
        }
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "swipe_msg", 0, 0, "", "", "", "");
        return;
      case 1010: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80050FE", "0X80050FE", 0, 0, "", "", "", "");
        return;
      }
    }
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006353", "0X8006353", 0, 0, "", "", "", "");
    return;
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "0", "0X80064C5", "0X80064C5", 0, 0, "" + paramRecentBaseData.mUnreadNum, "", "", "");
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "", "0X80067EE", "0X80067EE", 0, 0, "" + paramRecentBaseData.a(), "", "", "");
    return;
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "1", "0X80064C5", "0X80064C5", 0, 0, "" + paramRecentBaseData.mUnreadNum, "", "", "");
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "", "0X80067EE", "0X80067EE", 0, 0, "" + paramRecentBaseData.a(), "", "", "");
    return;
    szp.a();
    ajfx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.mUnreadFlag, paramRecentBaseData.b(), 1, paramRecentBaseData.b());
    return;
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80090EB", "0X80090EB", 0, 0, "", "", "", "");
    return;
    LpReportInfo_dc00518.report(100, 3, 0);
    if (QLog.isColorLevel()) {
      QLog.d("RecentAdapter", 2, "do report: QQnotice.list.delete");
    }
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.list.delete", 0, 0, "", "", "", "");
  }
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (i < j)
      {
        ...
        if ((localObject instanceof RecentBaseData))
        {
          ...
          if (augl.a(((RecentBaseData)localObject).a())) {
            return localObject;
          }
        }
        i += 1;
  ...
  public List<View> a()
  {
    ...
    while (i < j)
    {
      ...
      if (localView != null)
      {
        localView = localView.findViewById(2131379273);
  ...
  public void a(ajel paramajel)
  {
    this.jdField_a_of_type_Ajel = paramajel;
  }
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    ...
    for (;;)
    {
      localDrawable = this.jdField_a_of_type_Ajfa.a(i, paramRecentBaseData.a());
      paramDrawable = this.jdField_a_of_type_Ajfi.a(paramRecentBaseData);
      if (paramDrawable == null) {
        break;
      }
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, MessageRecord paramMessageRecord, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if (paramDrawable == null) {
        localDrawable = this.jdField_a_of_type_Ajfa.a(paramMessageRecord.istroop, paramMessageRecord.senderuin);
      }
      paramDrawable = this.jdField_a_of_type_Ajfi.a(paramRecentBaseData);
    } while ((paramDrawable == null) || (!(paramDrawable instanceof ajgn)));
    ((ajgn)paramDrawable).a(paramView, paramRecentBaseData, paramMessageRecord, localDrawable);
  }
  ...
  public void a(RecentBaseData paramRecentBaseData, String paramString)
  {
    if (this.jdField_a_of_type_Ajdx != null) {
      this.jdField_a_of_type_Ajdx.a(paramRecentBaseData, paramString);
    }
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
  ...
  protected void a(RecentBaseData paramRecentBaseData, String paramString1, String paramString2)
  {
    ...
    if (bdal.a(paramString1, localResources.getString(ajff.a[0])))
    {
      paramRecentBaseData.a();
      b(paramRecentBaseData, paramString1, paramString2);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A360", "0X800A360", 0, 0, "1", "", paramString2, "");
    }
    while (this.jdField_a_of_type_Ajdx == null) {
      return;
    }
    this.jdField_a_of_type_Ajdx.a(paramString1, paramRecentBaseData, paramString2);
    szp.a(paramRecentBaseData.a(), paramRecentBaseData.a(), paramString1, localResources);
  }
  ...
  {
    this.jdField_a_of_type_Ajfa.a(paramQQAppInterface);
    ...
    if (this.jdField_a_of_type_Uzh != null) {
      this.jdField_a_of_type_Uzh.a();
    }
    if (this.jdField_a_of_type_Ajfi != null) {
      this.jdField_a_of_type_Ajfi.a(paramQQAppInterface);
    }
    this.jdField_a_of_type_Uzh = new uzh(paramQQAppInterface);
    this.jdField_a_of_type_Uzh.a(new ajeg(this));
    if (QLog.isColorLevel()) {
      QLog.i("RecentTabHaloPresenter", 2, "onAccountChanged: invoked. Message: app: " + paramQQAppInterface + " recreate mRecentTabHaloPresenter: " + this.jdField_a_of_type_Uzh);
    }
  }
  ...
  {
    azmj.b(null, "dc00899", "Grp_video", "", "notice", "call", 0, 0, paramString, "" + bclo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString), "", "");
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    label71:
    while (!bdal.a(localRecentBaseData.a(), paramString))
    {
      i += 1;
      break label26;
      break;
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      localView = this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(i);
      localRecentBaseData = a(localView);
      if ((localRecentBaseData != null) && (bdal.a(paramString, localRecentBaseData.a()))) {
        break label74;
      }
    }
    label74:
  ...
  {
    if (this.jdField_a_of_type_Ajfa.a == null) {
      return;
    }
    if (paramBoolean)
    {
      this.jdField_a_of_type_Ajfa.a.a();
      this.jdField_a_of_type_Ajfa.a.c();
      return;
    }
    if (this.jdField_a_of_type_Ajfa.a.a()) {
      this.jdField_a_of_type_Ajfa.a.b();
    }
    ...
    for (;;)
    {
      ...
      if (!(localRecentBaseData instanceof RecentItemImaxADData)) {
        this.jdField_a_of_type_Ajfa.a(localRecentBaseData.a(), localRecentBaseData.a(), false);
      }
    }
  }
  ...
  public void a(boolean paramBoolean, int paramInt, DragFrameLayout paramDragFrameLayout)
  {
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        if (paramInt == 2)
        {
              ...
              if (paramDragFrameLayout.hasNext())
              {
                ...
                if (((localObject1 instanceof RecentBaseData)) && ((localObject1 instanceof RecentUserBaseData)))
                {
                  ...
                  if (((RecentUserBaseData)localObject1).mUnreadNum > 0)
                  {
                    ...
                    ajgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentBaseData)localObject1, (RecentUser)localObject2, true);
                    continue;
                    i = 0;
                    break;
                  }
          ...
          paramDragFrameLayout = (ntw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
          ...
          if (localIterator.hasNext())
          {
            ...
            bhpd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(((RecentUserBaseData)localObject3).a());
            ...
            if ((localObject5 instanceof RecentItemTroopMsgData))
            {
              ...
              {
                ajgm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentUser)localObject4, true, false);
    ...
    for (;;)
    {
      ...
      {
        ajgm.a((QQAppInterface)localObject3, (RecentUser)localObject4, paramBoolean, false);
        localObject3 = paramDragFrameLayout;
        localObject4 = localObject1;
        localObject5 = localObject2;
        break;
      ...
      {
        suv.a().i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        suk.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        if (localMessageHandler == null) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
      ...
      if ((localObject5 instanceof RecentItemServiceAccountFolderData))
      {
        ...
        {
          ajgm.a((QQAppInterface)localObject3, (RecentUser)localObject4, paramBoolean, false);
          ssp.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, NetConnInfoCenter.getServerTime());
          if (swy.c) {
            ssp.a().e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
      ...
      else
      {
        ...
        {
          localObject3 = (awwg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38);
          if (localObject3 != null) {
            ((awwg)localObject3).a(ayvc.a());
          }
        }
        if (this.c == 0)
        {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800419D", "0X800419D", 0, 0, "", "", "", "");
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80041A0", "0X80041A0", 0, 0, "", "", "", "");
          if (!TextUtils.isEmpty(paramDragFrameLayout)) {
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", String.valueOf(localObject2), "0X8005C37", "0X8005C37", 0, 1, 0, String.valueOf(paramDragFrameLayout), String.valueOf(NetConnInfoCenter.getServerTime() * 1000L), "", String.valueOf(localObject1));
          }
        }
        oxp.a().h();
        label1225:
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        if ((i != 0) && ((paramDragFrameLayout instanceof RecentUserBaseData)))
                        {
                          ...
                          ajgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentBaseData)localObject1, (RecentUser)localObject2, false);
                        }
                        ...
                        {
                          if (QLog.isColorLevel()) {
                            QLog.d("RecentAdapter", 2, "clearServiceAccountFolderUnreadByFolderRed, red dot switch:" + swy.b);
                          }
                          ...
                          for (paramDragFrameLayout = "0";; paramDragFrameLayout = "1")
                          {
                            ...
                            if (!(paramDragFrameLayout instanceof axho)) {
                              break;
                            }
                            ((axho)paramDragFrameLayout).a(104000, "104000.104001");
                            return;
                            paramInt = 0;
                            break label1225;
                          }
                        ...
                        paramDragFrameLayout.c();
                        ajgm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDragFrameLayout.a(), paramDragFrameLayout.a());
                        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramDragFrameLayout.a(), paramDragFrameLayout.a());
                    ...
                    ((ntw)localObject1).a(paramDragFrameLayout.time);
                    return;
                    if ((paramDragFrameLayout instanceof RecentUserBaseData))
                    {
                      ...
                      if (((RecentUser)localObject2).getType() == 1008) {
                        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "" + ((RecentUser)localObject2).uin, "0X80064CA", "0X80064CA", 0, 0, "" + ((RecentUserBaseData)localObject1).mUnreadNum, "", "", "");
                      }
                      for (;;)
                      {
                        ((RecentUserBaseData)localObject1).c();
                        bhpd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(((RecentUserBaseData)localObject1).a());
                        ajgm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentUser)localObject2, true, false);
                        if (this.c == 0) {
                          ajgm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentUser)localObject2);
                        }
                        if ((paramDragFrameLayout instanceof SendBlessRecentItemData)) {
                          ((agyc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(138)).b(true);
                        }
                        if ((((RecentUser)localObject2).getType() != 0) || (!bdal.b(((RecentUser)localObject2).uin))) {
                          break;
                        }
                        ...
                        if (i >= 3)
                        {
                          bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230, "babyQ提醒", "是否需要关闭babyQ的推送开关\n", alpo.a(2131713530), alpo.a(2131713529), new ajei(this), new ajej(this)).show();
                          paramInt = 0;
                        ...
                        if (((RecentUser)localObject2).getType() == 6004) {
                          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80090EA", "0X80090EA", 0, 0, "", "", "", "");
                        }
                      }
                    }
                  ...
                  atwd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDragFrameLayout.time);
                  return;
                  if (!(paramDragFrameLayout instanceof RecentItemEcShop)) {
                    break;
                  }
                  paramDragFrameLayout = (RecentItemEcShop)paramDragFrameLayout;
                  azmj.b(null, "dc00899", "Pb_account_lifeservice", paramDragFrameLayout.a(), "0X80064D3", "0X80064D3", 0, 0, "" + paramDragFrameLayout.mUnreadNum, "", "", "");
                  paramDragFrameLayout.c();
                  ajgm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDragFrameLayout.a(), paramDragFrameLayout.a());
                  this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramDragFrameLayout.a(), paramDragFrameLayout.a());
                  paramDragFrameLayout = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramDragFrameLayout.a(), 1008);
              ...
              paramDragFrameLayout.c();
              if (abot.c(paramDragFrameLayout.a()))
              {
                ThreadManager.post(new RecentAdapter.7(this, paramDragFrameLayout.a(), paramDragFrameLayout.a()), 8, null, false);
                azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005298", "0X8005298", 0, 0, "", "", "", "");
                azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "drag_hi", 0, 0, "", "", "", "");
                return;
              }
              ajgm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDragFrameLayout.a(), paramDragFrameLayout.a());
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramDragFrameLayout.a(), paramDragFrameLayout.a());
              if (abot.f(paramDragFrameLayout.a()))
              {
                azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "drag_update", 0, 0, "", "", String.valueOf(paramDragFrameLayout.mFromFlag), "");
                return;
              }
            } while (!abot.g(paramDragFrameLayout.a()));
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "drag_focus", 0, 0, "", "", "", "");
            return;
          ...
          ((alpr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255)).a(paramDragFrameLayout.time);
          return;
          if ((paramDragFrameLayout instanceof RecentItemConfessMsg))
          {
            aoep.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (RecentItemConfessMsg)paramDragFrameLayout, false);
            return;
          }
  ...
  public void b(RecentBaseData paramRecentBaseData)
  {
    ...
    for (Object localObject = ((aubm)localObject).c(paramRecentBaseData.mPhoneNumber);; localObject = null)
    {
      ...
      {
        return;
        localObject = ((awvw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(140)).a(paramRecentBaseData.a());
  ...
  {
    if (this.jdField_a_of_type_Ajfi != null) {
      this.jdField_a_of_type_Ajfi.b(paramQQAppInterface);
    }
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    return this.jdField_a_of_type_Ajfi.a(localObject);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      Object localObject = getItem(paramInt);
      ajff localajff = this.jdField_a_of_type_Ajfi.a(localObject);
      if ((localObject instanceof RecentBaseData))
      {
        localObject = (RecentBaseData)localObject;
        b((RecentBaseData)localObject);
        return localajff.a(paramInt, localObject, this.jdField_a_of_type_Ajfa, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, this, this);
      }
      if ((localObject instanceof Integer)) {
        return localajff.a(paramInt, localObject, null, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, this, this);
      }
      if ((localObject instanceof String)) {
        return localajff.a(paramInt, localObject, null, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, null, null, null);
      }
      paramView = localajff.a(paramInt, localObject, null, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, null, null, null);
      return paramView;
    }
    catch (Throwable paramView)
    {
      ajfw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), false, paramView);
  ...
  {
    return this.jdField_a_of_type_Ajfi.b();
  }
  
  public void notifyDataSetChanged()
  {
    super.notifyDataSetChanged();
    ajel localajel = this.jdField_a_of_type_Ajel;
    if (localajel == null) {
      return;
    }
        ...
        do
        {
          ...
          do
          {
            do
            {
              ...
              if (!bdal.a("tag_recent_item_icon", paramView.getTag())) {
                break;
              }
              localObject1 = paramView.getTag(-22);
            } while ((this.jdField_a_of_type_Ajdx == null) || (localObject1 == null));
            this.jdField_a_of_type_Ajdx.a(paramView, localObject1);
            return;
            ...
            if (((uhu)localObject1).b(localObject2)) {
              this.jdField_a_of_type_Ajdx.a(paramView, localObject2);
            }
            localObject1 = paramView.getTag(-1);
          ...
          if (((paramView instanceof bhtp)) && ((localObject1 instanceof RecentItemEcShop))) {
            this.jdField_a_of_type_Ajdx.a(paramView, localObject1);
          }
          for (;;)
          {
            ...
            this.jdField_a_of_type_Ajdx.a(paramView, (RecentBaseData)localObject2, ((RecentBaseData)localObject2).mTitleName, true);
          }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        i = ((Integer)ajfa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, localRecentBaseData.a()).first).intValue();
        if (i == -2147483648) {
          break label856;
        }
        ...
        {
          l = System.currentTimeMillis();
          paramBitmap = BaseApplication.getContext().getResources().getDrawable(2130840164);
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Ajfi != null) {}
    for (int i = this.jdField_a_of_type_Ajfi.a(); (i == 0) && (FrameHelperActivity.b()); i = 0) {
      return false;
    }
    if (paramView == null)
    {
    ...
    for (localObject1 = (RecentBaseData)localObject1;; localObject1 = null)
    {
      ...
      Object localObject2 = this.jdField_a_of_type_Ajfi.a(localObject1);
      if (((RecentBaseData)localObject1).a() == 1)
      {
        ...
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "right", 0, 0, ((RecentBaseData)localObject1).a(), String.valueOf(i - 1), "", "");
      }
      if ("9970".equals(((RecentBaseData)localObject1).a())) {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Shop_lifeservice", "", "Shop_folder", "Press_Shopfolderlong", 0, 0, "", "", "", "");
      }
      if (localObject2 != null) {}
      for (List localList = ((ajff)localObject2).a((RecentBaseData)localObject1, this.jdField_a_of_type_AndroidContentContext);; localList = null)
      {
        if ((localList != null) && (localList.size() > 0) && (SystemClock.uptimeMillis() - this.jdField_b_of_type_Long > 100L))
        {
          localObject2 = new bdkz();
          i = 0;
          while (i < localList.size())
          {
            ((bdkz)localObject2).a(j, (String)localList.get(i));
            i += 1;
          }
          boolean bool2 = false;
          boolean bool1;
          if ((this.jdField_a_of_type_Boolean) && (augs.a(this.jdField_a_of_type_AndroidContentContext, ((RecentBaseData)localObject1).a(), ((RecentBaseData)localObject1).a(), ((RecentBaseData)localObject1).b(), "conversation_tab_list")))
          {
            bool1 = bool2;
            if (QLog.isColorLevel())
            {
          ...
          for (;;)
          {
            ...
            try
            {
              this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = bdbk.a(paramView, (bdkz)localObject2, this.jdField_a_of_type_AndroidViewView$OnClickListener, new ajeh(this, paramView));
              bool1 = true;
            }
            catch (Throwable paramView)
            {
