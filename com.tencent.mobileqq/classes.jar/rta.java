...
public abstract class rta
{
  ...
  pvq jdField_a_of_type_Pvq = new rtb(this);
  ...
  private void a(Bundle paramBundle, sdx paramsdx, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(paramsdx.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(paramsdx.a()).toString());
      ...
      olh.a(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, sdx paramsdx, rtc paramrtc)
  {
    String str1 = paramsdx.a();
    String str2 = paramsdx.b();
    String str3 = paramsdx.c();
    String str4 = paramsdx.d();
    String str5 = paramsdx.e();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Rtc = paramrtc;
    if (paramBundle == null) {}
