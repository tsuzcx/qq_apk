...
public class bdhp
{
  private static bdhp jdField_a_of_type_Bdhp;
  ...
  public static bdhp a()
  {
    try
    {
      if (jdField_a_of_type_Bdhp == null) {
        jdField_a_of_type_Bdhp = new bdhp();
      }
      return jdField_a_of_type_Bdhp;
    }
    finally {}
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((bdhq)localSelectionKey.attachment()).handle(localSelectionKey)) {
  ...
  public void a(SelectableChannel paramSelectableChannel, int paramInt, bdhq parambdhq)
  {
    try
    {
      this.jdField_a_of_type_Boolean = true;
      this.jdField_a_of_type_JavaNioChannelsSelector.wakeup();
      paramSelectableChannel.register(this.jdField_a_of_type_JavaNioChannelsSelector, paramInt, parambdhq);
      return;
    }
    finally
    {
