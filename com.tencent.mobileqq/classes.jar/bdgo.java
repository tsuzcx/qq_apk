...
public class bdgo
{
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    //   71: invokestatic 116	bdnw:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   74: aload_2
    //   75: areturn
    //   76: astore_2
    //   77: aconst_null
    ...
    //   102: invokestatic 116	bdnw:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   105: aload_1
    //   106: ifnull +7 -> 113
    //   109: aload_1
    ...
    //   137: invokestatic 116	bdnw:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   140: goto -27 -> 113
    //   143: astore_1
    //   144: aconst_null
    //   145: astore_0
    ...
    //   178: invokestatic 116	bdnw:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   181: goto -27 -> 154
    //   184: astore_1
    //   185: goto -39 -> 146
    //   188: astore_2
  ...
  public static ArrayList<String> a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        bdnw.d("FileUtils.getChildFiles", "getChildFiles error. " + localException);
      }
      return paramString;
      i += 1;
    }
  ...
  public static JSONObject a(String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      ...
      {
        bdnw.d("FileUtils.getStats", "getStats error. " + paramString);
      }
    }
    for (;;)
    {
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    bdnw.b("FileUtils", "saveVideoToAlbum: " + bool);
  ...
  public static byte[] a(File paramFile)
  {
    ...
    //   7: aconst_null
    //   8: areturn
    //   9: new 318	java/io/BufferedInputStream
    //   12: dup
    //   13: new 24	java/io/FileInputStream
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 27	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   21: invokespecial 321	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   24: astore 5
    //   26: aload_0
    ...
    //   60: lload_3
    //   61: invokevirtual 328	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   64: invokevirtual 110	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   67: invokestatic 330	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   70: aload 5
    //   72: ifnull -65 -> 7
    //   75: aload 5
    ...
    //   114: iload_1
    //   115: isub
    //   116: invokevirtual 333	java/io/InputStream:read	([BII)I
    //   119: istore_2
    //   120: iload_2
    //   121: iflt +10 -> 131
    //   124: iload_1
    ...
    //   160: invokestatic 330	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   163: aload 5
    //   165: ifnull +8 -> 173
    //   168: aload 5
    ...
    //   211: invokestatic 330	bdnw:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   214: aload 5
    //   216: ifnull -209 -> 7
    //   219: aload 5
  ...
  public static String b(File paramFile)
  {
    ...
    //   56: invokespecial 357	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   59: athrow
    //   60: aload_0
    //   61: invokevirtual 360	java/io/File:canRead	()Z
    //   64: ifne +71 -> 135
    ...
    //   97: invokespecial 357	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   100: athrow
    //   101: new 364	java/io/FileNotFoundException
    //   104: dup
    ...
    //   131: invokespecial 367	java/io/FileNotFoundException:<init>	(Ljava/lang/String;)V
    //   134: athrow
    ...
    //   143: astore_3
    //   144: new 369	java/io/InputStreamReader
    //   147: dup
    //   148: aload_3
    //   149: ldc_w 371
    //   152: invokespecial 374	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   155: astore_2
    //   156: aload_0
    ...
    //   178: dup
    //   179: sipush 12288
    //   182: invokespecial 377	java/lang/StringBuilder:<init>	(I)V
    //   185: astore 5
    //   187: aload_2
    //   188: aload_0
    //   189: invokevirtual 380	java/io/InputStreamReader:read	([C)I
    //   192: istore_1
    //   193: iconst_m1
    //   194: iload_1
    ...
    //   201: iconst_0
    //   202: iload_1
    //   203: invokevirtual 383	java/lang/StringBuilder:append	([CII)Ljava/lang/StringBuilder;
    //   206: pop
    //   207: goto -20 -> 187
    //   210: astore_0
    //   211: aload_2
    ...
    //   225: ifnull -215 -> 10
    //   228: aload_0
    //   229: invokevirtual 384	java/io/InputStreamReader:close	()V
    //   232: aconst_null
    //   233: areturn
    //   234: astore_0
    //   235: aconst_null
    ...
    //   254: ifnull -244 -> 10
    //   257: aload_2
    //   258: invokevirtual 384	java/io/InputStreamReader:close	()V
    //   261: aload_0
    //   262: areturn
    //   263: astore_2
    //   264: aload_0
    ...
    //   276: aload_2
    //   277: aload_0
    //   278: invokevirtual 380	java/io/InputStreamReader:read	([C)I
    //   281: invokespecial 387	java/lang/String:<init>	([CII)V
    //   284: astore_0
    //   285: goto -42 -> 243
    //   288: astore_0
    //   289: aconst_null
    ...
    //   302: ifnull +7 -> 309
    //   305: aload_2
    //   306: invokevirtual 384	java/io/InputStreamReader:close	()V
    //   309: aload_0
    //   310: athrow
    //   311: astore_3
    //   312: goto -61 -> 251
  ...
  public static JSONObject b(String paramString)
  {
    ...
    {
      bdnw.d("FileUtils.getStatsByDir", "getStatsByDir error. " + paramString);
      return null;
    }
  }
  ...
  public static boolean b(File paramFile1, File paramFile2)
  {
    ...
    //   27: dup
    //   28: aload_1
    //   29: invokespecial 418	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   32: astore_1
    //   33: new 318	java/io/BufferedInputStream
    //   36: dup
    //   37: new 24	java/io/FileInputStream
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 27	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   45: invokespecial 321	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   48: astore_0
    //   49: sipush 1024
    //   52: newarray byte
    //   54: astore 5
    //   56: aload_0
    //   57: aload 5
    //   59: invokevirtual 419	java/io/BufferedInputStream:read	([B)I
    //   62: istore_2
    //   63: iload_2
    //   64: iconst_m1
    //   65: if_icmpeq +52 -> 117
    ...
    //   105: ifnull +10 -> 115
    //   108: aload_1
    //   109: invokevirtual 420	java/io/BufferedInputStream:close	()V
    //   112: iload 4
    //   114: istore_3
    //   115: iload_3
    //   116: ireturn
    ...
    //   128: ifnull -13 -> 115
    //   131: aload_0
    //   132: invokevirtual 420	java/io/BufferedInputStream:close	()V
    //   135: iconst_1
    //   136: ireturn
    //   137: astore_0
    //   138: iconst_1
    ...
    //   158: ifnull -43 -> 115
    //   161: aload_0
    //   162: invokevirtual 420	java/io/BufferedInputStream:close	()V
    //   165: iconst_0
    //   166: ireturn
    //   167: astore_0
    //   168: iconst_0
    ...
    //   183: ifnull +8 -> 191
    //   186: aload 5
    //   188: invokevirtual 420	java/io/BufferedInputStream:close	()V
    //   191: aload_0
    //   192: athrow
    //   193: astore_1
    //   194: goto -67 -> 127
  ...
  public static boolean c(String paramString)
  {
    ...
    {
      bdnw.c("FileUtils", "mkdirs failed, path: " + paramString);
      return false;
    }
    return true;
  }
