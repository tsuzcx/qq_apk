  ...
  implements bdgn
{
  ...
  public static bdgo a()
  {
    if (jdField_a_of_type_Bdgo == null) {
      jdField_a_of_type_Bdgo = new bdgo();
    }
    return jdField_a_of_type_Bdgo;
  }
  ...
  protected String a(int paramInt)
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        bdii.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", localJSONException);
      }
    }
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bdii.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  public JSONObject a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      bdii.c("DownloadCallbackWebImpl", "onNetworkConnect " + paramDownloadInfo.getMessage(), paramDownloadInfo);
    }
    return localJSONObject;
  }
  ...
  {
    bdgs localbdgs = bdgs.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbdgs.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bdjn)localbdgs.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bdjn)localObject).getJsCallbackMethod()))
            {
              ...
              bdii.a("DownloadCallbackWebImpl", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bdii.c("DownloadCallbackWebImpl", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
