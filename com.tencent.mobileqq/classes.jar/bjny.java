...
public class bjny
{
  ...
  private static bjny jdField_a_of_type_Bjny;
  ...
  {
    return LocalMultiProcConfig.getLong(bjdm.a() + "p_len", 0L);
  }
  ...
  public static bjny a()
  {
    if (jdField_a_of_type_Bjny == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bjny == null) {
        jdField_a_of_type_Bjny = new bjny();
      }
      return jdField_a_of_type_Bjny;
    }
  }
  ...
  {
    LocalMultiProcConfig.putLong(bjdm.a() + "p_qzone_len", paramLong);
  }
  ...
  private static void a(Context paramContext, String paramString1, String paramString2)
  {
    if (Build.VERSION.SDK_INT >= 24)
    {
      ...
      if (str2 != null)
      {
        ...
        e();
        b("---> merge :" + str1);
        if (!bjnw.a(str2, paramString1, str1)) {
          break label259;
        }
        b(a(str1));
  ...
  {
    return LocalMultiProcConfig.getLong(bjdm.a() + "p_merge_len", 0L);
  }
      ...
      if (!localObject3.isDirectory()) {
        if (l != localObject3.length()) {
          ...
          catch (Exception localException)
          {
            ...
            localObject3.delete();
            e();
            bjdt.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "qz_patch", 12, "patch verify failed: file md5: " + str1 + " but expected md5: " + str3, 1, System.currentTimeMillis());
  ...
  {
    LocalMultiProcConfig.putLong(bjdm.a() + "p_merge_len", paramLong);
  }
  ...
  {
    return LocalMultiProcConfig.getLong(bjdm.a() + "p_merge_odex_len", 0L);
  }
  ...
  {
    LocalMultiProcConfig.putLong(bjdm.a() + "p_merge_odex_len", paramLong);
  }
  ...
  private static void c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        bjdt.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "qz_patch", 11, "clear patch:" + jdField_a_of_type_JavaLangString, 1, System.currentTimeMillis());
        QLog.d("qz_patch", 1, "report [qz_patch] clear patch:" + jdField_a_of_type_JavaLangString);
        break;
        LocalMultiProcConfig.putLong(bjdm.a() + "p_len", 0L);
        jdField_a_of_type_JavaLangString = null;
        e();
      }
      b(alud.a(2131712460));
  ...
  private static void d(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 378	bjny:a	(Ljava/lang/String;)Ljava/lang/String;
    //   4: astore 7
    ...
    //   38: ldc_w 398
    //   41: invokestatic 268	alud:a	(I)Ljava/lang/String;
    ...
    //   55: invokestatic 139	bjny:b	(Ljava/lang/String;)V
    ...
    //   251: invokestatic 139	bjny:b	(Ljava/lang/String;)V
    //   254: aload 7
    //   256: lload 5
    ...
    //   299: aload_1
    //   300: invokestatic 411	bjny:a	(Ljava/lang/String;)V
    ...
    //   315: bipush 10
    //   317: aconst_null
    //   318: invokestatic 413	bjny:a	(ILjava/lang/String;)I
    ...
    //   356: invokestatic 341	bjdt:a	(Lmqq/app/AppRuntime;Ljava/lang/String;ILjava/lang/String;IJ)V
    //   359: ldc_w 310
    //   362: iconst_1
    ...
    //   376: bipush 10
    //   378: aconst_null
    //   379: invokestatic 413	bjny:a	(ILjava/lang/String;)I
    ...
    //   399: aload_0
    //   400: invokestatic 380	bjny:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    //   403: goto +109 -> 512
    //   406: astore_0
    //   407: ldc_w 310
    //   410: iconst_1
    ...
    //   436: goto -256 -> 180
    //   439: ldc_w 422
    //   442: invokestatic 139	bjny:b	(Ljava/lang/String;)V
    //   445: ldc_w 310
    //   448: iconst_1
