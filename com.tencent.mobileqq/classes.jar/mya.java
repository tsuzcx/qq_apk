  ...
  implements BusinessObserver
{
  ...
  private void c(boolean paramBoolean, Object paramObject)
  {
    ...
    {
      paramObject = (Object[])paramObject;
      myb localmyb = new myb(this);
      localmyb.jdField_a_of_type_JavaLangString = ((String)paramObject[2]);
      localmyb.jdField_a_of_type_JavaUtilList = ((List)paramObject[3]);
      localmyb.jdField_a_of_type_Int = ((Integer)paramObject[4]).intValue();
      localmyb.b = ((Integer)paramObject[5]).intValue();
      localmyb.c = ((Integer)paramObject[6]).intValue();
      a(((Integer)paramObject[0]).intValue(), (String)paramObject[1], localmyb);
      return;
    }
  ...
  protected void a(boolean paramBoolean, long paramLong, List<nil> paramList, int paramInt1, List<Long> paramList1, int paramInt2, String paramString) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        paramObject = (Object[])paramObject;
        a(paramBoolean, ((Long)paramObject[0]).longValue(), (List)paramObject[1], ((Integer)paramObject[2]).intValue(), (List)paramObject[3], ((Integer)paramObject[4]).intValue(), (String)paramObject[5]);
        return;
      }
