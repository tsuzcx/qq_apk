...
public class bbcg
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForPoke paramMessageForPoke)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((anyw)paramQQAppInterface.getManager(51)).b(paramString);
        if (localObject != null) {
          break;
        }
      ...
      Object localObject = String.format(Locale.getDefault(), anzj.a(2131704591), new Object[] { ((Friends)localObject).getFriendNickWithAlias() });
      paramMessageForPoke = new avpd(paramString, paramQQAppInterface.c(), (String)localObject, paramInt, -5040, 655379, l);
      ...
      bdll.b(paramQQAppInterface, "dc00898", "", "", "0X8009891", "0X8009891", 0, 0, "", "", "", "");
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramString.length() < 5) || (bcsa.a(paramMessageRecord.msgtype)) || (adak.j(paramMessageRecord.msgtype)) || (a(paramMessageRecord.msgtype)));
        paramQQAppInterface = (bbcd)paramQQAppInterface.getManager(285);
        if (paramInt == 1)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      localObject = (bbcd)paramQQAppInterface.getManager(285);
      localFriends = localanyw.b(paramString);
    } while ((localFriends == null) || (!localFriends.isFriend()));
    if (aiti.a(paramQQAppInterface).b()) {
      if (((bbcd)localObject).a(true))
      {
        if (!((bbcd)localObject).c(paramString)) {
          break label227;
        }
        ((bbcd)localObject).a(paramString);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = localanyw.a(paramString, true);
      ...
      return;
      label227:
      ((bbcd)localObject).a(paramString, true);
      break;
      if (QLog.isColorLevel()) {
  ...
  {
    if (((b(paramInt)) || (c(paramInt)) || (d(paramInt)) || (e(paramInt))) && (!bhjx.b(paramString)) && (!bgpy.b(paramQQAppInterface, paramString))) {}
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        bbcd localbbcd = (bbcd)paramQQAppInterface.getManager(285);
        if (!localbbcd.a(false))
        {
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          else if (localbbcd.f(paramString))
          {
            if (QLog.isColorLevel()) {
          ...
          {
            float f = localbbcd.a();
            Object localObject2 = localanyw.a(paramString, true);
