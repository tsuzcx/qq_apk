  ...
  implements Handler.Callback, EIPCResultCallback
{
  ...
  @RequiresApi(api=18)
  public avez(QQIdentiferActivity paramQQIdentiferActivity, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity = paramQQIdentiferActivity;
    this.jdField_a_of_type_Avfa = avfa.a(paramInt, paramQQIdentiferActivity.getIntent(), paramQQIdentiferActivity);
  ...
  public static boolean a()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!a("new_qq_android_native_short_new_other_", bgsg.b())) && (b())) {
      return false;
    }
    bgsg.c("");
    bgsg.b(0);
  ...
  {
    String str = a();
    File localFile = new File(bnpy.a(bnpt.c) + "libYTCommon.so");
    ...
    if ((a("new_qq_android_native_short_new_other_", bgsg.b())) || (a(bnpt.jdField_b_of_type_Bnpt.jdField_b_of_type_JavaLangString, bnpy.a(bnpt.jdField_b_of_type_Bnpt.jdField_a_of_type_Int))))
    {
    ...
    QLog.d("qq_Identification.Helper", 1, new Object[] { "preCheck is pass, so version is ", Integer.valueOf(bgsg.b()), " current bits is : ", Integer.valueOf(b()) });
  ...
  public void b()
  {
    ...
    {
      jdField_a_of_type_Boolean = this.jdField_a_of_type_Avfa.a(bnpy.a(bnpt.c), avfa.b);
      jdField_a_of_type_Boolean &= this.jdField_a_of_type_Avfa.a(this.jdField_a_of_type_JavaLangString + "identification/so/", avfa.a);
    }
    int i;
    if (jdField_a_of_type_Boolean)
    {
    ...
    for (;;)
    {
      ...
      return;
      i = this.jdField_a_of_type_Avfa.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity, this.jdField_a_of_type_JavaLangString);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      if (paramMessage.arg1 == 0)
      {
        ...
        this.jdField_a_of_type_Avfa.a(true, this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity);
      }
      if (paramMessage.arg1 != 0) {
        break label238;
      }
