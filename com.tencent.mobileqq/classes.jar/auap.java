  ...
  implements Handler.Callback
{
  ...
  auaq jdField_a_of_type_Auaq;
  EglHandlerThread jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEglHandlerThread;
  String jdField_a_of_type_JavaLangString;
  List<amzu> jdField_a_of_type_JavaUtilList = new ArrayList();
  private CopyOnWriteArrayList<WeakReference<auas>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList;
  ...
  public auap(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private int a()
  {
    ...
    auar localauar = new auar();
    localauar.jdField_a_of_type_Int = this.jdField_d_of_type_Int;
    localauar.jdField_b_of_type_Int = 256;
    localauar.jdField_c_of_type_Int = 256;
    localauar.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localauar.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    localauar.jdField_a_of_type_JavaLangString = auao.a(this.jdField_b_of_type_JavaLangString);
    localauar.jdField_d_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("runType").append("=").append(localauar.jdField_a_of_type_Int).append("\n");
    localStringBuilder.append("netHeight").append("=").append(localauar.jdField_b_of_type_Int).append("\n");
    localStringBuilder.append("netWidth").append("=").append(localauar.jdField_c_of_type_Int).append("\n");
    localStringBuilder.append("paramPath").append("=").append(localauar.jdField_b_of_type_JavaLangString).append("\n");
    localStringBuilder.append("anchorPath").append("=").append(localauar.jdField_c_of_type_JavaLangString).append("\n");
    localStringBuilder.append("kernelBinaryIndex").append("=").append(localauar.jdField_d_of_type_JavaLangString).append("\n");
    localStringBuilder.append("modelString").append("=").append(localauar.jdField_a_of_type_JavaLangString).append("\n");
    if (QLog.isColorLevel()) {
      QLog.i("MiniRecog.detector", 2, localStringBuilder.toString());
    }
    if ((this.jdField_b_of_type_Int > 0) && (this.jdField_c_of_type_Int > 0)) {
      this.jdField_a_of_type_Int = auam.a(this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    }
    this.jdField_a_of_type_Auaq = new auaq(localauar);
    if (this.jdField_a_of_type_Auaq.a()) {
      return 1;
    }
    return 0;
  }
  ...
  private static void a(int paramInt, Bitmap paramBitmap)
  {
    ...
    auam.a("glBindTexture");
    GLES20.glTexParameterf(3553, 10241, 9729.0F);
    GLES20.glTexParameterf(3553, 10240, 9729.0F);
    GLES20.glTexParameteri(3553, 10242, 33071);
    GLES20.glTexParameteri(3553, 10243, 33071);
    auam.a("glTexParameteri");
  ...
  private boolean a(long paramLong, boolean paramBoolean)
  {
    ...
    if ((((Bitmap)localObject).getWidth() != this.jdField_b_of_type_Int) || (((Bitmap)localObject).getHeight() != this.jdField_c_of_type_Int) || (this.jdField_a_of_type_Int < 0))
    {
      ...
      try
      {
        int j = axqh.a(3553, (Bitmap)localObject);
        i = j;
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Auaq != null) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_Int >= 0)
    {
      List localList = this.jdField_a_of_type_Auaq.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, paramLong, paramBoolean);
  ...
  public void a(auas paramauas)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      auas localauas = (auas)((WeakReference)localIterator.next()).get();
      if ((localauas != null) && (localauas == paramauas)) {
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramauas));
  }
  ...
  public void b(auas paramauas)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)localIterator.next();
      auas localauas = (auas)localWeakReference.get();
      if ((localauas != null) && (localauas == paramauas)) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_AndroidOsHandler != null)
      {
        ...
        boolean bool1 = auan.jdField_b_of_type_Boolean;
        ...
        if ((this.jdField_b_of_type_AndroidOsHandler != null) && (bool1))
        {
          ...
          {
            localauas = (auas)((WeakReference)((Iterator)localObject).next()).get();
            if (localauas != null) {
              localauas.a(this.jdField_a_of_type_JavaUtilList, ((Long)paramMessage[1]).longValue());
            }
          }
          this.jdField_b_of_type_Boolean = false;
          return false;
          ...
          {
            localObject = (auas)((WeakReference)paramMessage.next()).get();
            if (localObject != null) {
              ((auas)localObject).a(i);
            }
          }
          paramMessage = (Object[])paramMessage.obj;
          ...
          while (((Iterator)localObject).hasNext())
          {
            localauas = (auas)((WeakReference)((Iterator)localObject).next()).get();
            if (localauas != null) {
              localauas.a(((Long)paramMessage[0]).longValue());
            }
          }
        }
      }
