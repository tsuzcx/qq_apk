  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.share.ForwardSdkShareProcessor", 2, "RichStep|run|retry=" + aipu.a(this.a));
    }
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          if (!aipu.a(this.a).get()) {
            continue;
          }
          if ((k != -1) || (aipu.a(this.a).getAndIncrement() >= 2)) {
            continue;
          }
