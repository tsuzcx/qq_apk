...
public class ybx
  extends xza<CertifiedAccountMeta.StComment>
  implements View.OnClickListener, Animation.AnimationListener, CompoundButton.OnCheckedChangeListener, IEventReceiver
{
  private static final String jdField_a_of_type_JavaLangString = ybx.class.getSimpleName();
  ...
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new yca(this);
  View jdField_a_of_type_AndroidViewView;
  private ViewStub jdField_a_of_type_AndroidViewViewStub;
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  private AbsListView.OnScrollListener jdField_a_of_type_AndroidWidgetAbsListView$OnScrollListener = new ybz(this);
  public ListView a;
  ...
  protected ybg a;
  private final yce jdField_a_of_type_Yce;
  private ycf jdField_a_of_type_Ycf;
  private ycg jdField_a_of_type_Ycg;
  private ych jdField_a_of_type_Ych;
  private ydd jdField_a_of_type_Ydd;
  ...
  public ybx(Activity paramActivity, boolean paramBoolean, CertifiedAccountMeta.StFeed paramStFeed, ycg paramycg, ExtraTypeInfo paramExtraTypeInfo)
  {
    super(paramActivity, paramBoolean);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Yce = new yce(this);
    uht.a().registerSubscriber(this.jdField_a_of_type_Yce);
  ...
  private ybg a()
  {
    ...
    {
      this.jdField_a_of_type_Ybg = new ybg();
      this.jdField_e_of_type_Int = this.jdField_a_of_type_Ybg.hashCode();
    }
    return this.jdField_a_of_type_Ybg;
  }
  ...
  private void a(int paramInt)
  {
    ...
    uht.a().dispatch(new ybt(5, new Object[] { b(), Integer.valueOf(this.jdField_d_of_type_Int) }));
  }
  ...
  private void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Ydk == null) {
      this.jdField_a_of_type_Ydk = new ydk((Activity)this.jdField_a_of_type_AndroidContentContext);
    }
    String str2;
    String str1;
    if (paramStReply != null) {
      ...
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692455), new Object[] { paramStReply.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
        ...
        this.jdField_a_of_type_Ydk.b(str1);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Ydk.a(new ycb(this, paramStComment, paramStReply));
      c(paramStComment, paramStReply);
      this.jdField_a_of_type_Ydk.a(paramBoolean2);
      return;
      if ((paramStComment != null) && (paramStComment.postUser != null))
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692455), new Object[] { paramStComment.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
          str1 = str2.substring(0, 10);
      ...
      {
        this.jdField_a_of_type_Ydk.b(this.jdField_a_of_type_AndroidContentContext.getString(2131692450));
      }
    }
  }
  ...
  private void a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    for (paramStComment = paramStReply;; paramStComment = str)
    {
      ...
      ygv.a(this.jdField_a_of_type_AndroidContentContext, paramStReply);
      return;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Ydk != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Ydk.a());
      }
      return;
      k = 0;
    }
  ...
  private void a(Object[] paramArrayOfObject)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              do
              {
                do
                {
                  for (;;)
                  {
                    ...
                    if (paramArrayOfObject[3] != null)
                    {
                      ...
                      if (this.jdField_a_of_type_Ycg != null) {
                        this.jdField_a_of_type_Ycg.a((CertifiedAccountRead.StGetFeedDetailRsp)localObject2, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if ((paramArrayOfObject.length >= 6) && (paramArrayOfObject[5] != null))
                      {
                        ...
                        if (((COMM.StCommonExt)localObject1).mapInfo.size() > 0)
                        {
                          ...
                          f();
                          yej.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), (CertifiedAccountMeta.StReply)localObject1));
                          this.i = true;
                          this.j = true;
                        }
                      }
                    ...
                    for (;;)
                    {
                      ...
                      break;
                      f();
                      yej.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), null));
                      break;
                      a(new CommentPresenter.12(this));
                      break;
                      QLog.w(jdField_a_of_type_JavaLangString, 1, "get feed detail response failed");
                      if (this.jdField_a_of_type_Ycg != null) {
                        this.jdField_a_of_type_Ycg.a(null, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if (!this.h) {
                  ...
                  if (this.jdField_a_of_type_Ydk != null) {
                    this.jdField_a_of_type_Ydk.c(this.jdField_a_of_type_AndroidWidgetTextView);
                  }
                ...
                if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp))
                {
                  ...
                  if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Ydd != null) && (this.jdField_a_of_type_Ydd.a(String.valueOf(paramArrayOfObject[4])))) {
                    m();
                  }
                  if (localLong.longValue() == 0L)
                  {
                    if ((this.jdField_a_of_type_Ydd != null) && (this.jdField_a_of_type_Ydd.a(String.valueOf(paramArrayOfObject[4]), (CertifiedAccountMeta.StComment)localObject2))) {
                      m();
                    }
                    a(1);
                  }
                }
                a(localLong.longValue(), alpo.a(2131702568), (String)localObject1);
              ...
              if ((localLong.longValue() == 0L) && ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp)))
              {
                ...
                if ((this.jdField_a_of_type_Ydd != null) && (this.jdField_a_of_type_Ydd.a(paramArrayOfObject))) {
                  m();
                }
                a(-1);
              }
              a(localLong.longValue(), alpo.a(2131702562), alpo.a(2131702571));
              return;
            ...
            if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoReplyRsp))
            {
              ...
              if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Ydd != null) && (this.jdField_a_of_type_Ydd.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject))) {
                m();
              }
              if ((localLong.longValue() == 0L) && (this.jdField_a_of_type_Ydd != null) && (this.jdField_a_of_type_Ydd.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject, (CertifiedAccountMeta.StReply)localObject1))) {
                m();
              }
            }
            a(localLong.longValue(), alpo.a(2131702561), alpo.a(2131702572));
            return;
          } while (a(5, paramArrayOfObject));
          a(localLong.longValue(), alpo.a(2131702567), alpo.a(2131702574));
      ...
      } while ((localLong.longValue() != 0L) || (this.jdField_a_of_type_Ydd == null) || (TextUtils.isEmpty(paramArrayOfObject)) || (TextUtils.isEmpty((CharSequence)localObject1)));
      this.jdField_a_of_type_Ydd.a(paramArrayOfObject, (String)localObject1);
      m();
      return;
    ...
    label414:
    label486:
    if (this.jdField_a_of_type_Ydd != null)
    {
    ...
    label1207:
    for (paramArrayOfObject = this.jdField_a_of_type_Ybg.a((List)localObject1, (String)paramArrayOfObject[5]);; paramArrayOfObject = (Object[])localObject1)
    {
      this.jdField_a_of_type_Ydd.a(paramArrayOfObject);
      m();
      return;
    }
  }
  ...
  {
    if ((paramStUser != null) && (xxf.a() != null) && (paramStUser.id.get().equals(xxf.a().id.get()))) {}
  ...
  private void c(int paramInt)
  {
    ...
    if (paramInt == 0) {
      this.jdField_a_of_type_Ydd.a(a().poster.id.get());
    }
  ...
  private void c(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    this.jdField_a_of_type_Ydk.setOnShowListener(new ycc(this, paramStComment, paramStReply));
    this.jdField_a_of_type_Ydk.a(new ycd(this, paramStComment, paramStReply));
  }
  ...
  private void n()
  {
    ...
    this.jdField_e_of_type_AndroidViewView = a(2131366084);
    ...
    this.jdField_d_of_type_AndroidViewView = a(2131363574);
    ...
    this.jdField_a_of_type_Ych = new ych(this);
    this.jdField_a_of_type_Ydd = new ydd(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Ych);
    this.jdField_a_of_type_Ydd.a(this.jdField_d_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Ydd);
    this.jdField_a_of_type_AndroidWidgetListView.setEmptyView(this.jdField_c_of_type_AndroidViewView);
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new yby(this));
    }
  }
  ...
  private void p()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 313	ybx:jdField_a_of_type_Ybg	Lybg;
    //   6: ifnonnull +16 -> 22
    //   9: getstatic 65	ybx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: iconst_1
    //   13: ldc_w 902
    //   16: invokestatic 435	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   19: aload_0
    //   20: monitorexit
    //   21: return
    //   22: aload_0
    //   23: aload_0
    //   24: invokespecial 326	ybx:a	()Lybg;
    //   27: aload_0
    //   28: invokespecial 299	ybx:b	()Ljava/lang/String;
    //   31: invokevirtual 632	ybg:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   34: putfield 305	ybx:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   37: aload_0
    //   38: aload_0
    //   39: invokespecial 326	ybx:a	()Lybg;
    //   42: aload_0
    //   43: invokespecial 299	ybx:b	()Ljava/lang/String;
    //   46: invokevirtual 905	ybg:a	(Ljava/lang/String;)LNS_COMM/COMM$StCommonExt;
    //   49: putfield 286	ybx:jdField_a_of_type_NS_COMMCOMM$StCommonExt	LNS_COMM/COMM$StCommonExt;
    //   52: aload_0
    //   53: getfield 305	ybx:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   56: ifnull -37 -> 19
    //   59: aload_0
    //   60: getfield 330	ybx:jdField_a_of_type_Ydd	Lydd;
    //   63: ifnull +44 -> 107
    //   66: aload_0
    //   67: getfield 330	ybx:jdField_a_of_type_Ydd	Lydd;
    //   70: invokevirtual 907	ydd:a	()V
    //   73: aload_0
    //   74: getfield 330	ybx:jdField_a_of_type_Ydd	Lydd;
    //   77: aload_0
    //   78: getfield 305	ybx:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   81: invokevirtual 780	ydd:a	(Ljava/util/Collection;)Z
    //   84: pop
    //   85: aload_0
    //   86: getfield 677	ybx:i	Z
    //   89: ifeq +11 -> 100
    //   92: aload_0
    //   93: getfield 330	ybx:jdField_a_of_type_Ydd	Lydd;
    //   96: iconst_0
    //   97: invokevirtual 908	ydd:a	(I)V
    //   100: aload_0
    //   101: getfield 330	ybx:jdField_a_of_type_Ydd	Lydd;
    //   104: invokevirtual 911	ydd:notifyDataSetChanged	()V
    //   107: aload_0
    //   108: getfield 357	ybx:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   111: ifnull +47 -> 158
    //   114: aload_0
    //   115: getfield 97	ybx:jdField_g_of_type_Int	I
    //   118: aload_0
    //   119: invokevirtual 149	ybx:b	()I
    //   122: if_icmpeq +36 -> 158
    //   125: aload_0
    //   126: getfield 677	ybx:i	Z
    //   129: ifeq +29 -> 158
    //   132: aload_0
    //   133: aload_0
    //   134: invokevirtual 149	ybx:b	()I
    //   137: putfield 97	ybx:jdField_g_of_type_Int	I
    //   140: getstatic 65	ybx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   143: iconst_1
    //   144: ldc_w 913
    //   147: invokestatic 391	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: getfield 357	ybx:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   154: iconst_0
    //   155: invokevirtual 916	android/widget/ListView:setSelection	(I)V
    //   158: aload_0
    //   159: getfield 305	ybx:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   162: ifnull -143 -> 19
    //   165: aload_0
    //   166: getfield 305	ybx:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   169: invokevirtual 647	java/util/ArrayList:size	()I
    //   172: ifle -153 -> 19
    //   175: aload_0
    //   176: aload_0
    //   177: invokespecial 326	ybx:a	()Lybg;
    //   180: aload_0
    //   181: invokespecial 299	ybx:b	()Ljava/lang/String;
    //   184: invokevirtual 339	ybg:a	(Ljava/lang/String;)I
    //   187: putfield 131	ybx:jdField_d_of_type_Int	I
    //   190: goto -171 -> 19
    //   193: astore_1
    //   194: aload_0
    //   195: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ...
          {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(yda.a(this.jdField_d_of_type_Int));
          ...
          if (this.jdField_a_of_type_Ydd.getCount() == 0)
          {
            bool = true;
            b(bool);
          }
  ...
  public void a(ycf paramycf)
  {
    this.jdField_a_of_type_Ycf = paramycf;
  }
  
  public void a(ydf paramydf)
  {
    this.jdField_a_of_type_Ydf = paramydf;
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_Ydk != null) && (this.jdField_a_of_type_Ydk.isShowing());
  }
  
  protected void e()
  {
    uht.a().unRegisterSubscriber(this.jdField_a_of_type_Yce);
    a().a();
    this.jdField_a_of_type_Ybg = null;
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    if (paramAnimation == this.jdField_a_of_type_AndroidViewAnimationAnimation)
    {
      ...
      if (this.jdField_a_of_type_Ycf != null) {
        this.jdField_a_of_type_Ycf.i();
      }
    }
