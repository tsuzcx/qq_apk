  ...
  implements DialogInterface.OnDismissListener
{
  ...
  private static bhwo jdField_a_of_type_Bhwo;
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new bhwm(this);
  ...
  private JSONObject a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        bheg.a(paramString, new File((String)localObject));
        if (paramString == null) {
          break;
        }
        ...
        callJs(str, new String[] { localJSONObject.toString() });
        paramString = localJSONObject;
      } while (this.jdField_a_of_type_Bisl == null);
      this.jdField_a_of_type_Bisl.dismiss();
  ...
  private void a(String paramString)
  {
    Object localObject1;
    Object localObject2;
    if (jdField_a_of_type_Bhwo == null)
    {
      localObject1 = new bhwo(null);
      ...
      jdField_a_of_type_Bhwo = (bhwo)localObject1;
    ...
    try
    {
      ...
      try
      {
        ...
        return;
        label180:
        bhwn localbhwn = new bhwn(this);
        ((SensorManager)localObject1).registerListener(localbhwn, (Sensor)localObject2, 3, 0);
        ((SensorManager)localObject1).flush(localbhwn);
        localObject1 = new NewIntent(this.mRuntime.a().getApplication(), bhxe.class);
    ...
    do
    {
      do
      {
        ...
        if ((l1 > 0L) && (((JSONObject)localObject1).toString().getBytes().length > l1))
        {
          ...
          paramString2.put("businessRet", 0);
          paramString2.put("msg", anvx.a(2131704928));
          super.callJs(paramString1, new String[] { paramString2.toString() });
          return;
        }
        if (this.jdField_c_of_type_JavaUtilHashMap.containsKey("yundong_report.steps"))
        {
          ...
          if ((l1 > 0L) && (System.currentTimeMillis() - l2 < l1))
          {
            ...
            paramString2.put("businessRet", 0);
            paramString2.put("msg", anvx.a(2131704927));
            super.callJs(paramString1, new String[] { paramString2.toString() });
        ...
        localObject2 = String.valueOf(bhww.a());
      ...
      ((JSONObject)localObject1).put("version", "8.4.10");
      ...
      if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = bjls.c();
      }
      ...
      localObject1 = new bhwl(this);
    } while (this.mRuntime == null);
    Object localObject2 = new NewIntent(this.mRuntime.a().getApplicationContext(), awcn.class);
  ...
  private JSONObject b(String paramString)
  {
    ...
    //   12: lstore_3
    //   13: aload_0
    //   14: getfield 109	bhwk:mRuntime	Lbifw;
    //   17: ifnull +1113 -> 1130
    //   20: aload_0
    //   21: getfield 283	bhwk:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   24: ifnull +1106 -> 1130
    //   27: iconst_0
    //   28: istore 5
    ...
    //   153: astore_1
    //   154: aload_0
    //   155: getfield 215	bhwk:jdField_a_of_type_Bisl	Lbisl;
    //   158: ifnull +975 -> 1133
    //   161: aload 7
    //   163: astore_1
    //   164: aload_0
    //   165: getfield 215	bhwk:jdField_a_of_type_Bisl	Lbisl;
    //   168: invokevirtual 636	bisl:isShowing	()Z
    //   171: ifeq +962 -> 1133
    //   174: aload 7
    //   176: astore_1
    //   177: aload_0
    //   178: getfield 215	bhwk:jdField_a_of_type_Bisl	Lbisl;
    //   181: invokevirtual 220	bisl:dismiss	()V
    //   184: goto +949 -> 1133
    //   187: aload 7
    //   189: astore_1
    ...
    //   270: ldc_w 323
    //   273: ldc_w 644
    //   276: invokestatic 410	anvx:a	(I)Ljava/lang/String;
    ...
    //   331: aastore
    //   332: invokevirtual 213	bhwk:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   335: aload 9
    //   337: areturn
    //   338: astore_1
    ...
    //   529: astore_1
    //   530: aload_0
    //   531: getfield 283	bhwk:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   534: aload 12
    //   536: bipush 21
    //   538: invokestatic 687	aupt:a	(Landroid/app/Activity;Landroid/content/Intent;I)V
    //   541: goto -354 -> 187
    //   544: astore 8
    //   546: aload 7
    //   548: astore_1
    ...
    //   676: ldc_w 707
    //   679: ldc_w 708
    //   682: invokestatic 410	anvx:a	(I)Ljava/lang/String;
    ...
    //   754: astore_1
    //   755: aload_0
    //   756: getfield 109	bhwk:mRuntime	Lbifw;
    //   759: invokevirtual 338	bifw:a	()Lcom/tencent/common/app/AppInterface;
    //   762: aload_0
    //   763: getfield 109	bhwk:mRuntime	Lbifw;
    //   766: invokevirtual 177	bifw:a	()Landroid/app/Activity;
    //   769: aload 8
    //   771: aload_0
    ...
    //   798: aload 7
    //   800: astore_1
    //   801: invokestatic 725	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   804: invokevirtual 727	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Z
    //   807: ifeq +20 -> 827
    //   810: aload 7
    //   812: astore_1
    //   813: invokestatic 725	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   816: aload 11
    //   818: aload 8
    //   820: iconst_1
    //   821: invokevirtual 730	com/tencent/mobileqq/wxapi/WXShareHelper:a	(Ljava/lang/String;Landroid/graphics/Bitmap;I)V
    //   824: goto -637 -> 187
    //   827: aload 7
    //   829: astore_1
    //   830: aload_0
    //   831: getfield 109	bhwk:mRuntime	Lbifw;
    //   834: invokevirtual 114	bifw:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   837: new 732	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4
    //   840: dup
    //   841: aload_0
    //   842: invokespecial 733	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4:<init>	(Lbhwk;)V
    //   845: invokevirtual 737	com/tencent/biz/pubaccount/CustomWebView:post	(Ljava/lang/Runnable;)Z
    //   848: pop
    //   849: goto -662 -> 187
    //   852: aload 7
    //   854: astore_1
    //   855: invokestatic 725	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   858: invokevirtual 727	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Z
    //   861: ifeq +20 -> 881
    //   864: aload 7
    //   866: astore_1
    //   867: invokestatic 725	com/tencent/mobileqq/wxapi/WXShareHelper:a	()Lcom/tencent/mobileqq/wxapi/WXShareHelper;
    //   870: aload 11
    //   872: aload 8
    //   874: iconst_0
    //   875: invokevirtual 730	com/tencent/mobileqq/wxapi/WXShareHelper:a	(Ljava/lang/String;Landroid/graphics/Bitmap;I)V
    //   878: goto -691 -> 187
    //   881: aload 7
    //   883: astore_1
    //   884: aload_0
    //   885: getfield 109	bhwk:mRuntime	Lbifw;
    //   888: invokevirtual 114	bifw:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   891: new 739	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5
    //   894: dup
    //   895: aload_0
    //   896: invokespecial 740	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5:<init>	(Lbhwk;)V
    //   899: invokevirtual 737	com/tencent/biz/pubaccount/CustomWebView:post	(Ljava/lang/Runnable;)Z
    //   902: pop
    //   903: goto -716 -> 187
    //   906: aload 7
    //   908: astore_1
    ...
    //   920: getstatic 745	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_SAVE	Ljava/lang/String;
    ...
    //   955: aload 8
    //   957: aload 12
    //   959: invokestatic 265	bheg:a	(Landroid/graphics/Bitmap;Ljava/io/File;)V
    //   962: aload 7
    //   964: astore_1
    //   965: new 677	android/content/Intent
    //   968: dup
    //   969: ldc_w 747
    //   972: invokespecial 748	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   975: astore 8
    //   977: aload 7
    //   979: astore_1
    //   980: aload 8
    //   982: aload 12
    //   984: invokestatic 754	android/net/Uri:fromFile	(Ljava/io/File;)Landroid/net/Uri;
    //   987: invokevirtual 758	android/content/Intent:setData	(Landroid/net/Uri;)Landroid/content/Intent;
    //   990: pop
    //   991: aload 7
    //   993: astore_1
    //   994: aload_0
    //   995: getfield 109	bhwk:mRuntime	Lbifw;
    //   998: invokevirtual 177	bifw:a	()Landroid/app/Activity;
    //   1001: invokevirtual 582	android/app/Activity:getApplicationContext	()Landroid/content/Context;
    //   1004: aload 8
    //   1006: invokevirtual 764	android/content/Context:sendBroadcast	(Landroid/content/Intent;)V
    //   1009: aload 7
    //   1011: astore_1
    ...
    //   1037: getstatic 745	com/tencent/mobileqq/app/AppConstants:SDCARD_IMG_SAVE	Ljava/lang/String;
    ...
    //   1062: ldc_w 323
    //   1065: ldc_w 767
    //   1068: invokestatic 410	anvx:a	(I)Ljava/lang/String;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((Build.VERSION.SDK_INT < 19) || (paramJsBridgeListener.getDefaultSensor(19) == null))
      {
        ...
        paramString1.put("msg", anvx.a(2131704933));
        super.callJs(paramJsBridgeListener, new String[] { paramString1.toString() });
      }
      else
      {
        paramJsBridgeListener = new NewIntent(this.mRuntime.a().getApplication(), bhxe.class);
    ...
    if (paramString3.equals("healthSwitch"))
    {
      ...
      if ((!TextUtils.isEmpty(paramJsBridgeListener)) && (Integer.parseInt(paramJsBridgeListener) == 0))
      {
        ...
        paramJsBridgeListener.put("msg", anvx.a(2131704929));
      ...
      paramString2 = new NewIntent(this.jdField_a_of_type_AndroidAppActivity, bhxe.class);
      ...
      paramJsBridgeListener.put("msg", anvx.a(2131704930));
      super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
      i = 1;
    }
    for (;;)
    {
      if (i == 0)
      {
        ...
        paramJsBridgeListener.put("msg", anvx.a(2131704936));
        super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
        break label1169;
        if (paramString3.equals("shareSnapshot"))
        {
          if (this.jdField_a_of_type_Bisl == null)
          {
            ...
            this.jdField_a_of_type_Bisl = paramJsBridgeListener;
          }
          if (this.jdField_a_of_type_Bisl != null)
          {
        ...
        {
          paramJsBridgeListener = new JSONObject(paramVarArgs[0]).getString("callback");
          paramString1 = new NewIntent(this.mRuntime.a().getApplication(), bhxe.class);
  ...
  public void onDestroy()
  {
    ...
    if (jdField_a_of_type_Bhwo != null)
    {
      ((SensorManager)this.jdField_a_of_type_AndroidAppActivity.getSystemService("sensor")).unregisterListener(jdField_a_of_type_Bhwo);
      jdField_a_of_type_Bhwo = null;
    }
  }
