...
public class ypf
{
  public static bbqq a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean1, boolean paramBoolean2, ypt paramypt)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    int i = arni.a(arof.a(paramItem.FileName));
    ...
    for (;;)
    {
      ...
      return a(paramQQAppInterface, paramypt, paramItem.toByteArray(), "OidbSvc.0x6d6_2", 1750, 2, (Bundle)localObject);
      bool = false;
      break;
      label250:
  ...
  public static bbqq a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, ypv paramypv)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    return a(paramQQAppInterface, paramypv, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  
  public static bbqq a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, ypx paramypx)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    return a(paramQQAppInterface, paramLong, paramItem.FileName, paramItem.LocalFile, paramItem.ProgressTotal, paramItem.isFromAIO, paramItem.Md5, paramItem.Sha, paramItem.Sha3, paramItem.BusId, paramItem.mParentId, localBundle, paramypx);
  }
  
  public static bbqq a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, ypm paramypm)
  {
    ...
    return a(paramQQAppInterface, paramypm, paramString.toByteArray(), "OidbSvc.0x6d8_4", 1752, 4, null);
  }
  
  public static bbqq a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString3, int paramInt, String paramString4, Bundle paramBundle, ypx paramypx)
  {
    ...
    for (paramInt = 5;; paramInt = 4)
    {
      ...
      return a(paramQQAppInterface, paramypx, paramString1.toByteArray(), "OidbSvc.0x6d6_0", 1750, 0, paramBundle);
      localUploadFileReqBody.str_parent_folder_id.set(paramString4);
      break;
    }
  }
  
  public static bbqq a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, String paramString3, Bundle paramBundle, ypx paramypx)
  {
    if (paramLong1 == 0L) {
      return null;
    }
    return a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, true, paramArrayOfByte1, paramArrayOfByte2, null, paramInt, paramString3, paramBundle, paramypx);
  }
  
  private static bbqq a(QQAppInterface paramQQAppInterface, nac paramnac, byte[] paramArrayOfByte, String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    paramArrayOfByte.jdField_a_of_type_Nac = paramnac;
  ...
  private static String a(TroopFileTransferManager.Item paramItem)
  {
    try
    {
      ...
      Object localObject;
      if (xmx.c(paramItem.middleThumbnailFile)) {
      ...
      for (String str = "mid";; str = "larg")
      {
        ...
        return paramItem.strQRUrl;
        if (!xmx.c(paramItem.largeThumbnailFile)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString, int paramInt6, long paramLong2, int paramInt7, ByteStringMicro paramByteStringMicro, ypl paramypl)
  {
    boolean bool;
    ...
    for (;;)
    {
      ...
      mzy.b(paramQQAppInterface, paramypl, paramString.toByteArray(), "OidbSvc.0x6d8_1", 1752, 1, paramByteStringMicro);
      return;
      bool = false;
      break;
      label343:
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, msg_ctrl.MsgCtrl paramMsgCtrl, ypu paramypu)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        mzy.b(paramQQAppInterface, paramypu, paramMsgCtrl.toByteArray(), "OidbSvc.0x6d9_4", 1753, 4, paramBundle);
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, ypu paramypu)
  {
    a(paramQQAppInterface, paramLong, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, null, paramypu);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, Bundle paramBundle, yps paramyps)
  {
    ...
    mzy.b(paramQQAppInterface, paramyps, paramString.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, paramBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, ypi paramypi)
  {
    ...
    mzy.b(paramQQAppInterface, paramypi, paramString2.toByteArray(), "OidbSvc.0x6d6_3", 1750, 3, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, ypp paramypp)
  {
    ...
    mzy.b(paramQQAppInterface, paramypp, paramString1.toByteArray(), "OidbSvc.0x6d6_5", 1750, 5);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString, ypo paramypo)
  {
    ...
    mzy.b(paramQQAppInterface, paramypo, paramString.toByteArray(), "OidbSvc.0x6d8_0", 1752, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, bbnr parambbnr, ypw paramypw)
  {
    if ((paramLong == 0L) || (parambbnr == null)) {
      return;
    }
    ...
    localTransFileReqBody.uint32_bus_id.set(parambbnr.a);
    localTransFileReqBody.str_file_id.set(parambbnr.b);
    Bundle localBundle = new Bundle();
    localBundle.putLong("troopUin", paramLong);
    localBundle.putString("fileId", parambbnr.b);
    parambbnr = new oidb_0x6d9.ReqBody();
    parambbnr.trans_file_req.set(localTransFileReqBody);
    mzy.b(paramQQAppInterface, paramypw, parambbnr.toByteArray(), "OidbSvc.0x6d9_0", 1753, 0, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, ypu paramypu)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return;
    }
    ...
    localObject = asmi.a(paramItem.LocalFile, paramItem.width, paramItem.height, (String)localObject);
    a(paramQQAppInterface, paramLong, paramItem.BusId, paramItem.FilePath, paramItem.RandomNum, paramItem.width, paramItem.height, paramItem.duration, true, localBundle, (msg_ctrl.MsgCtrl)localObject, paramypu);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, yph paramyph)
  {
    ...
    mzy.b(paramQQAppInterface, paramyph, paramString1.toByteArray(), "OidbSvc.0x6d7_0", 1751, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, ypr paramypr)
  {
    if ((paramLong == 0L) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return;
    }
    ...
    mzy.b(paramQQAppInterface, paramypr, localReqBody.toByteArray(), "OidbSvc.0x6d7_2", 1751, 2, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, ypj paramypj)
  {
    ...
    mzy.b(paramQQAppInterface, paramypj, paramString.toByteArray(), "OidbSvc.0x6d7_1", 1751, 1);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, ypk paramypk)
  {
    if (QLog.isDevelopLevel()) {
    ...
    mzy.b(paramQQAppInterface, paramypk, localReqBody.toByteArray(), "OidbSvc.0x6d8_1", 1752, 2, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, ypn paramypn)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d("TroopFileProtocol", 4, "getFileList" + paramLong);
    }
    ...
    mzy.a(paramQQAppInterface, paramypn, localReqBody.toByteArray(), "OidbSvc.0x6d8_3", 1752, 3, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, bbqq parambbqq)
  {
    if ((paramQQAppInterface == null) || (parambbqq == null)) {
      return;
    }
    paramQQAppInterface.getTroopFileProtoReqMgr().b(parambbqq);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, FileManagerEntity paramFileManagerEntity, ypq paramypq)
  {
    paramString1 = new bcgp("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + bhos.a(paramString4) + "&", "GET", new ypg(new ArrayList(), paramString4, paramFileManagerEntity, paramQQAppInterface, paramInt, paramypq), 1000, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, long paramLong1, TroopFileTransferManager.Item paramItem, long paramLong2, long paramLong3, yps paramyps)
  {
    ...
    for (;;)
    {
      ...
      mzy.b(paramQQAppInterface, paramyps, localReqBody.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, (Bundle)localObject);
      return;
