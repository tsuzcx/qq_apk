...
{
  private static Singleton<bieb, Void> jdField_a_of_type_ComTencentWeiyunUtilsSingleton = new biec();
  private long jdField_a_of_type_Long = 1L;
  private ConcurrentHashMap<Integer, bied> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  
  public static bieb a()
  {
    return (bieb)jdField_a_of_type_ComTencentWeiyunUtilsSingleton.get(null);
  }
  ...
  private void a(int paramInt, String paramString, byte[] paramArrayOfByte)
  {
    ...
    {
      paramArrayOfByte = new bidz(i, paramArrayOfByte);
      ...
      paramString.putWupBuffer(biea.a(paramArrayOfByte));
      paramString.extraData.putInt("sequence", paramInt);
      paramString.extraData.putLong("sendtimekey", System.currentTimeMillis());
      paramArrayOfByte = new NewIntent(localAppRuntime.getApplication(), biee.class);
  ...
  void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      localbidz = biea.a(paramFromServiceMsg.getWupBuffer());
      label53:
    ...
    {
      label99:
      bied localbied = (bied)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Integer.valueOf(k));
      if (localbied != null) {
        if (localbidz != null) {
          break label196;
        }
      }
      for (paramFromServiceMsg = localObject;; paramFromServiceMsg = localbidz.a())
      {
        localbied.a(i, paramToServiceMsg, paramFromServiceMsg);
        return;
        ...
        localbidz = null;
        break label53;
        paramFromServiceMsg = localbidz.a();
  ...
  public void a(String paramString, byte[] paramArrayOfByte, bied parambied)
  {
    int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    if (parambied != null) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(i), parambied);
    }
