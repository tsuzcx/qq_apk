  ...
  extends zrx
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "DoraemonOpenAPI." + zsu.class.getSimpleName();
  }
  ...
  private void a(JSONObject paramJSONObject, zrt paramzrt)
  {
    ...
    if (i <= 0)
    {
      zva.a(paramzrt, -100, "rankingID must be bigger than 0");
      return;
    }
    Object localObject = (ztd)this.jdField_a_of_type_Zrw.a(ztd.class, false);
    if (localObject == null)
    {
      zva.a(paramzrt, -10, "internal error, try again.");
      return;
    }
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject = ((ztd)localObject).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Zrw.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Zrw.jdField_a_of_type_Int);
    localReqBody.openid.set(((ztg)localObject).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((ztg)localObject).b);
    ...
    mmj.a(BaseApplicationImpl.getApplication().getRuntime(), new zsv(this, (ztg)localObject, paramJSONObject, paramzrt), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 2, null, 0L);
  }
  ...
  private void b(JSONObject paramJSONObject, zrt paramzrt)
  {
    ...
    if (i <= 0)
    {
      zva.a(paramzrt, -100, "rankingID 没有传或者值小于等于0");
      return;
    }
    Object localObject1 = (ztd)this.jdField_a_of_type_Zrw.a(ztd.class, false);
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject1 = ((ztd)localObject1).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Zrw.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Zrw.jdField_a_of_type_Int);
    localReqBody.openid.set(((ztg)localObject1).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((ztg)localObject1).b);
    ...
    {
      zva.a(paramzrt, -101, "参数处理错误, 是否是类型不对? 查看一下文档吧. \nerrorMsg: " + paramJSONObject.getMessage());
      return;
    }
    mmj.a(BaseApplicationImpl.getApplication().getRuntime(), new zsw(this, (ztg)localObject1, paramJSONObject, paramzrt), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 1, null, 0L);
  }
