  ...
  extends adnc
{
  ...
  private void a(JSONObject paramJSONObject, @NonNull admy paramadmy)
  {
    ...
    for (int i = ((BaseActivity)paramJSONObject).getTitleBarHeight();; i = 0)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(paramJSONObject.getString(2131718159));
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetItems(a(paramJSONObject));
      }
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setItemClickListener(paramadmy);
      try
      {
  ...
  private void b(JSONObject paramJSONObject, @NonNull admy paramadmy)
  {
    ...
    Activity localActivity = this.jdField_a_of_type_Adnb.a();
    if (!bhnv.g(BaseApplicationImpl.getContext()))
    {
      adqf.a(paramadmy, -1, "net work not available");
      return;
    }
