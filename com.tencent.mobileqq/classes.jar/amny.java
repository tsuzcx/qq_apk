...
public class amny
{
  ...
  public static Bitmap a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, alxg paramalxg)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          localPaint.setColor(-1);
          a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramString1, paramString2, paramString3, paramJSONArray, paramalxg, i, j, k, m, str, localCanvas, localPaint);
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130844184);
          paramAppInterface.setBounds(i / 2 - 45, j - 102 - 42, i / 2 + 45, j - 102);
          paramAppInterface.draw(localCanvas);
          paramAppInterface = ajyc.a(2131702409);
  ...
  public static String a(AppInterface paramAppInterface, Context paramContext, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = wim.a(paramContext, str, paramBitmap);
        paramAppInterface = paramContext;
        if (QLog.isColorLevel())
        {
  ...
  public static String a(String paramString, float paramFloat)
  {
    ...
    int i;
    int j;
    if (amob.a(paramString) > paramFloat)
    {
    ...
    for (;;)
    {
      if ((i >= paramString.length()) || (amob.a(paramString.substring(0, i) + "…") > paramFloat))
      {
  ...
  public static String a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        paramAppInterface = nam.a(nar.a("http://cgi.connect.qq.com/qqconnectopen/upload_share_image", 1007), str1, str2, null, localHashMap, (Map)localObject1);
        localObject2 = paramAppInterface;
        if (paramAppInterface == null) {
          localObject2 = nam.a("http://cgi.connect.qq.com/qqconnectopen/upload_share_image", str1, str2, null, localHashMap, (Map)localObject1);
        }
        if (QLog.isColorLevel()) {
  ...
  public static ArrayList<amoj> a(JSONArray paramJSONArray)
  {
    ...
    if (i < j)
    {
      ...
      do
      {
        ...
        localArrayList.add(new amoj(str));
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, alxg paramalxg, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    if (paramInt3 == 0)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (amoc)paramJSONArray.next();
        localObject2 = ((amoc)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
        label721:
        if (((Iterator)localObject2).hasNext())
        {
          localObject3 = (amod)((Iterator)localObject2).next();
          paramString3.left = (((amod)localObject3).jdField_a_of_type_AndroidGraphicsRect.left + paramString2.left + 1);
          paramString3.top = (((amod)localObject3).jdField_a_of_type_AndroidGraphicsRect.top + paramString2.top + 1);
          paramString3.right = (((amod)localObject3).jdField_a_of_type_AndroidGraphicsRect.right + paramString2.left - 2);
          paramString3.bottom = (((amod)localObject3).jdField_a_of_type_AndroidGraphicsRect.bottom + paramString2.top - 2);
          paramPaint.setColor(((amoc)localObject1).jdField_a_of_type_Int);
          if (!((amoc)localObject1).jdField_b_of_type_Boolean) {
            break label913;
          }
          paramInt1 = 178;
          paramPaint.setAlpha(paramInt1);
          paramPaint.setFakeBoldText(((amoc)localObject1).jdField_a_of_type_Boolean);
          paramString1 = Paint.Align.CENTER;
          if (((amoc)localObject1).c != -1) {
            break label920;
          }
        ...
        {
          label849:
          a(paramCanvas, paramPaint, paramString3, ((amod)localObject3).jdField_a_of_type_JavaLangString, paramString1, ((amoc)localObject1).d, ((amoc)localObject1).jdField_b_of_type_Int);
          break label721;
          break;
          label913:
          paramInt1 = 255;
      ...
      if (paramalxg != null)
      {
        paramAppInterface = paramalxg.a(paramAppInterface.getCurrentAccountUin(), true);
        QLog.i("ConfessShareHelper", 4, "preLoadQQSelfHeaderBitmap " + paramAppInterface);
      }
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130844177))
      {
        ...
        paramContext = a(paramString4, 8.0F) + ajyc.a(2131702410);
  ...
  public static final void a(String paramString, Canvas paramCanvas, Rect paramRect)
  {
    ...
    try
    {
      localObject = wim.a(paramString, -1);
      m = ((ij)localObject).a();
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    amnz[] arrayOfamnz = a(paramInt2, paramInt1);
    paramInt2 = arrayOfamnz.length;
    paramInt1 = 0;
    amnz localamnz;
    if (paramInt1 < paramInt2) {
      localamnz = arrayOfamnz[paramInt1];
    }
    for (;;)
    {
      try
      {
        localDrawable = paramContext.getResources().getDrawable(localamnz.jdField_a_of_type_Int);
        if (localamnz.jdField_a_of_type_Int == 2130844186) {
          break label316;
        }
        if (localamnz.jdField_a_of_type_Int != 2130844179) {
          break label309;
        }
      }
      ...
      m = (int)(localamnz.jdField_b_of_type_Int - j * localamnz.jdField_a_of_type_Float * f1 / 2.0F);
      n = (int)(localamnz.c * f2 - k * localamnz.jdField_a_of_type_Float * f1 / 2.0F);
      f3 = localamnz.jdField_b_of_type_Int;
      localDrawable.setBounds(m, n, (int)(j * localamnz.jdField_a_of_type_Float * f1 / 2.0F + f3), (int)(f2 * localamnz.c + k * localamnz.jdField_a_of_type_Float * f1 / 2.0F));
      if (localamnz.jdField_a_of_type_Boolean)
      {
  ...
  public static amnz[] a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 0) {
      switch (paramInt2)
      {
    ...
    do
    {
      ...
      {
        return new amnz[0];
        return new amnz[] { new amnz(2130844151, 60, 60, true, 0.75F), new amnz(2130844156, 458, 84, true, 0.75F), new amnz(2130844157, 142, 250, true, 0.75F), new amnz(2130844151, 368, 188, true, 0.75F), new amnz(2130844149, 168, 120, true, 0.75F), new amnz(2130844182, 120, 40, true, 0.75F), new amnz(2130844183, 120, 110, true, 0.75F), new amnz(2130844180, 30, 150, true, 0.75F), new amnz(2130844180, 180, 200, true, 0.75F), new amnz(2130844182, 420, 160, true, 0.75F), new amnz(2130844183, 495, 150, true, 0.75F), new amnz(2130844179, 257, 82, false, 1.0F) };
        return new amnz[] { new amnz(2130844158, 60, 88, true, 0.75F), new amnz(2130844150, 226, 56, true, 0.75F), new amnz(2130844157, 480, 140, true, 0.75F), new amnz(2130844155, 330, 198, true, 0.75F), new amnz(2130844156, 168, 244, true, 0.75F), new amnz(2130844182, 300, 50, true, 0.75F), new amnz(2130844183, 460, 50, true, 0.75F), new amnz(2130844180, 60, 230, true, 0.75F), new amnz(2130844182, 120, 120, true, 0.75F), new amnz(2130844182, 440, 270, true, 0.75F), new amnz(2130844179, 257, 82, false, 1.0F) };
        return new amnz[] { new amnz(2130844151, 174, 58, true, 0.75F), new amnz(2130844153, 70, 146, true, 0.75F), new amnz(2130844155, 390, 106, true, 0.75F), new amnz(2130844150, 206, 240, true, 0.75F), new amnz(2130844152, 470, 225, true, 0.75F), new amnz(2130844183, 120, 88, true, 0.75F), new amnz(2130844183, 480, 70, true, 0.75F), new amnz(2130844180, 110, 230, true, 0.75F), new amnz(2130844182, 340, 210, true, 0.75F), new amnz(2130844179, 257, 82, false, 1.0F) };
        return new amnz[] { new amnz(2130844157, 138, 88, true, 0.75F), new amnz(2130844151, 68, 232, true, 0.75F), new amnz(2130844155, 298, 206, true, 0.75F), new amnz(2130844158, 480, 140, true, 0.75F), new amnz(2130844187, 382, 140, true, 0.75F), new amnz(2130844182, 60, 90, true, 0.75F), new amnz(2130844180, 182, 64, true, 0.75F), new amnz(2130844180, 440, 210, true, 0.75F), new amnz(2130844182, 440, 30, true, 0.75F), new amnz(2130844182, 190, 200, true, 0.75F), new amnz(2130844179, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new amnz[] { new amnz(2130844152, 110, 230, true, 1.0F), new amnz(2130844155, 656, 170, true, 1.0F), new amnz(2130844150, 516, 350, true, 1.0F), new amnz(2130844151, 84, 550, true, 1.0F), new amnz(2130844156, 656, 586, true, 1.0F), new amnz(2130844151, 526, 735, true, 1.0F), new amnz(2130844157, 198, 830, true, 1.0F), new amnz(2130844153, 70, 1016, true, 1.0F), new amnz(2130844155, 397, 952, true, 1.0F), new amnz(2130844158, 670, 880, true, 1.0F), new amnz(2130844150, 220, 1257, true, 1.0F), new amnz(2130844154, 606, 1220, true, 1.0F), new amnz(2130844187, 452, 475, true, 1.0F), new amnz(2130844149, 240, 645, true, 1.0F), new amnz(2130844180, 160, 300, true, 1.0F), new amnz(2130844183, 660, 330, true, 1.0F), new amnz(2130844181, 620, 450, true, 1.0F), new amnz(2130844182, 175, 500, true, 1.0F), new amnz(2130844182, 460, 570, true, 1.0F), new amnz(2130844183, 180, 630, true, 1.0F), new amnz(2130844180, 40, 690, true, 1.0F), new amnz(2130844180, 260, 750, true, 1.0F), new amnz(2130844183, 710, 600, true, 1.0F), new amnz(2130844182, 600, 710, true, 1.0F), new amnz(2130844182, 140, 970, true, 1.0F), new amnz(2130844180, 85, 1200, true, 1.0F), new amnz(2130844180, 600, 1050, true, 1.0F), new amnz(2130844183, 420, 1100, true, 1.0F), new amnz(2130844182, 540, 1250, true, 1.0F), new amnz(2130844186, 375, 134, false, 1.0F) };
      return new amnz[] { new amnz(2130844155, 110, 368, true, 1.0F), new amnz(2130844156, 570, 256, true, 1.0F), new amnz(2130844151, 655, 475, true, 1.0F), new amnz(2130844158, 75, 740, true, 1.0F), new amnz(2130844150, 320, 686, true, 1.0F), new amnz(2130844157, 670, 832, true, 1.0F), new amnz(2130844155, 505, 955, true, 1.0F), new amnz(2130844156, 260, 1020, true, 1.0F), new amnz(2130844154, 75, 1216, true, 1.0F), new amnz(2130844150, 565, 1235, true, 1.0F), new amnz(2130844187, 430, 355, true, 1.0F), new amnz(2130844149, 110, 174, true, 1.0F), new amnz(2130844180, 140, 250, true, 1.0F), new amnz(2130844183, 640, 195, true, 1.0F), new amnz(2130844180, 170, 450, true, 1.0F), new amnz(2130844182, 490, 1220, true, 1.0F), new amnz(2130844181, 350, 520, true, 1.0F), new amnz(2130844181, 630, 410, true, 1.0F), new amnz(2130844183, 60, 500, true, 1.0F), new amnz(2130844183, 680, 655, true, 1.0F), new amnz(2130844183, 310, 1110, true, 1.0F), new amnz(2130844182, 470, 660, true, 1.0F), new amnz(2130844182, 190, 780, true, 1.0F), new amnz(2130844182, 680, 1060, true, 1.0F), new amnz(2130844180, 180, 1230, true, 1.0F), new amnz(2130844186, 375, 134, false, 1.0F) };
      return new amnz[] { new amnz(2130844151, 110, 220, true, 1.0F), new amnz(2130844157, 654, 240, true, 1.0F), new amnz(2130844155, 562, 482, true, 1.0F), new amnz(2130844153, 95, 537, true, 1.0F), new amnz(2130844150, 295, 672, true, 1.0F), new amnz(2130844152, 683, 660, true, 1.0F), new amnz(2130844154, 60, 850, true, 1.0F), new amnz(2130844156, 442, 872, true, 1.0F), new amnz(2130844150, 114, 1046, true, 1.0F), new amnz(2130844151, 680, 950, true, 1.0F), new amnz(2130844156, 230, 1197, true, 1.0F), new amnz(2130844158, 480, 1260, true, 1.0F), new amnz(2130844187, 670, 1200, true, 1.0F), new amnz(2130844180, 140, 630, true, 1.0F), new amnz(2130844180, 500, 960, true, 1.0F), new amnz(2130844180, 330, 1050, true, 1.0F), new amnz(2130844180, 50, 1150, true, 1.0F), new amnz(2130844181, 290, 430, true, 1.0F), new amnz(2130844181, 330, 760, true, 1.0F), new amnz(2130844182, 60, 310, true, 1.0F), new amnz(2130844182, 480, 580, true, 1.0F), new amnz(2130844182, 220, 820, true, 1.0F), new amnz(2130844183, 600, 150, true, 1.0F), new amnz(2130844183, 700, 410, true, 1.0F), new amnz(2130844183, 25, 900, true, 1.0F), new amnz(2130844183, 150, 430, true, 1.0F), new amnz(2130844186, 375, 134, false, 1.0F) };
      return new amnz[] { new amnz(2130844151, 104, 278, true, 1.0F), new amnz(2130844154, 588, 200, true, 1.0F), new amnz(2130844150, 690, 390, true, 1.0F), new amnz(2130844153, 420, 534, true, 1.0F), new amnz(2130844152, 92, 592, true, 1.0F), new amnz(2130844156, 660, 624, true, 1.0F), new amnz(2130844151, 475, 735, true, 1.0F), new amnz(2130844157, 192, 818, true, 1.0F), new amnz(2130844158, 696, 880, true, 1.0F), new amnz(2130844155, 430, 990, true, 1.0F), new amnz(2130844150, 64, 1034, true, 1.0F), new amnz(2130844150, 272, 1250, true, 1.0F), new amnz(2130844154, 584, 1205, true, 1.0F), new amnz(2130844149, 254, 638, true, 1.0F), new amnz(2130844180, 200, 320, true, 1.0F), new amnz(2130844180, 260, 780, true, 1.0F), new amnz(2130844180, 620, 1000, true, 1.0F), new amnz(2130844180, 150, 1250, true, 1.0F), new amnz(2130844181, 70, 420, true, 1.0F), new amnz(2130844181, 460, 590, true, 1.0F), new amnz(2130844181, 630, 450, true, 1.0F), new amnz(2130844182, 70, 800, true, 1.0F), new amnz(2130844182, 280, 980, true, 1.0F), new amnz(2130844182, 610, 720, true, 1.0F), new amnz(2130844182, 480, 1220, true, 1.0F), new amnz(2130844183, 170, 590, true, 1.0F), new amnz(2130844183, 330, 1160, true, 1.0F), new amnz(2130844183, 700, 680, true, 1.0F), new amnz(2130844183, 660, 290, true, 1.0F), new amnz(2130844186, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new amnz[] { new amnz(2130844152, 110, 310, true, 1.0F), new amnz(2130844155, 650, 216, true, 1.0F), new amnz(2130844150, 516, 350, true, 1.0F), new amnz(2130844152, 92, 592, true, 1.0F), new amnz(2130844156, 656, 586, true, 1.0F), new amnz(2130844151, 470, 716, true, 1.0F), new amnz(2130844157, 198, 830, true, 1.0F), new amnz(2130844158, 670, 980, true, 1.0F), new amnz(2130844155, 397, 1060, true, 1.0F), new amnz(2130844153, 70, 1016, true, 1.0F), new amnz(2130844180, 200, 320, true, 1.0F), new amnz(2130844149, 240, 438, true, 1.0F), new amnz(2130844187, 452, 475, true, 0.75F), new amnz(2130844180, 200, 600, true, 1.0F), new amnz(2130844180, 1000, 620, true, 1.0F), new amnz(2130844181, 70, 420, true, 1.0F) };
  }
  
  public static Bitmap b(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, alxg paramalxg)
  {
    if ((paramJSONArray == null) || (paramJSONArray.length() < 1) || (paramContext == null))
    {
      paramAppInterface = null;
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          try
          {
            ...
            localPaint.setColor(-1);
            a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, null, paramString2, paramString3, paramJSONArray, paramalxg, i, j, 5, 5, str, localCanvas, localPaint);
            localPaint.setAlpha(255);
            localPaint.setColor(-1);
            return paramString1;
          }
