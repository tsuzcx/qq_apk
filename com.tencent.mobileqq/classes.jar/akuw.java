  ...
  implements bdkg
{
  ...
  public akuw(String paramString, akux paramakux)
  {
    ...
    if (paramString1.equals(BaseApplicationImpl.sApplication.getPackageName()))
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Akux != null) {
          this.jdField_a_of_type_Akux.a(paramInt);
        }
        ...
        else
        {
          try
          {
            ...
            bfkl.a(paramBundle, this.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString, int paramInt, Bundle paramBundle)
  {
    if (BaseApplicationImpl.sApplication.getPackageName().equals(paramString))
    {
      ...
      if ((this.jdField_a_of_type_Akux != null) && (!this.jdField_a_of_type_Akux.a(paramInt))) {
