...
public final class akuw
  implements akvg, Handler.Callback, INetInfoHandler
{
  ...
  public akuw(QQAppInterface paramQQAppInterface)
  {
  ...
  private byte[] a(short paramShort, String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.3.5");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Akux.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Akux.b);
    ...
    try
    {
      paramString = akwd.a(paramString, this.jdField_a_of_type_Akux.jdField_a_of_type_JavaLangString);
  ...
  {
    ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Akux.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Akux.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    akvi localakvi = new akvi();
    localakvi.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Akux.jdField_a_of_type_JavaUtilList;
    localakvi.jdField_a_of_type_Int = this.jdField_a_of_type_Akux.jdField_a_of_type_Int;
    localakvi.b = 10000;
    localakvi.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localakvi);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localakvi);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        this.b = true;
        if (!bdin.e(BaseApplicationImpl.getApplication().getApplicationContext()))
        {
        ...
        {
          ((bdug)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).e();
        }
      }
      finally {}
    }
  ...
  public void a(akux paramakux)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Akux = paramakux;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Bhtd.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Bhtd.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = akwd.b((byte[])localObject, this.jdField_a_of_type_Akux.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = bdin.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.jdField_a_of_type_Bhtd.removeMessages(7);
      this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Akux });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Akux != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Bhtd.removeMessages(1);
        this.jdField_a_of_type_Bhtd.removeMessages(2);
        this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int <= 2))
    {
      ...
      this.jdField_a_of_type_Bhtd.removeMessages(1);
      this.jdField_a_of_type_Bhtd.sendEmptyMessageDelayed(1, 10000L);
    }
  }
  ...
  public void onNetMobile2Wifi(String paramString)
  {
    ...
    this.jdField_a_of_type_Bhtd.removeMessages(5);
    this.jdField_a_of_type_Bhtd.sendEmptyMessage(5);
  }
