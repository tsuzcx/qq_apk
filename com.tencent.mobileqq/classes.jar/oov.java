  ...
  implements ooy
{
  ...
  private void a(List<ChatMessage> paramList)
  {
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      if ((paramList != null) && (opg.a(opg.a(paramList)))) {
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    opg.a(paramMessageRecord.uniseq);
  }
  ...
  public void a(List<ChatMessage> paramList, ooz paramooz)
  {
    ...
    if (paramooz != null) {
      paramooz.a(this.jdField_a_of_type_JavaUtilList);
    }
    ...
    try
    {
      if (opg.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime())) {
      ...
      for (;;)
      {
        ...
        ooj.a(paramList.toByteArray(), "trpc.qqshop.adpush.PushService.GetAd", new oow(this, paramooz));
        return;
