...
public class agxf
  extends BaseAdapter
  implements View.OnClickListener, bhtm
{
  public static int a;
  ...
  public agxf(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler)
  {
    ...
    {
      this.jdField_b_of_type_JavaUtilList.add(new agxh());
      i += 1;
    }
    this.jdField_a_of_type_JavaUtilList.addAll(this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_Float = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().density;
    this.c = aekt.a(85.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = aekt.a(85.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = aekt.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.f = aekt.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.g = aekt.a(2.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  
  public agxh a(int paramInt)
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size()) {
      return (agxh)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return null;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilList.clear();
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008C71", "0X8008C71", agwq.a(agwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a()), 0, "", "", "", "");
    }
  ...
  public void a(agxh paramagxh)
  {
    if (paramagxh != null)
    {
      int i = paramagxh.jdField_a_of_type_Int;
      if ((i >= 0) && (i < this.jdField_a_of_type_JavaUtilList.size())) {
        ((agxh)this.jdField_a_of_type_JavaUtilList.get(i)).a(paramagxh);
      }
      notifyDataSetChanged();
    }
  }
  ...
  public void b()
  {
    ...
    if (TextUtils.isEmpty(((agxh)this.jdField_a_of_type_JavaUtilList.get(i - 1)).d)) {}
    while (i <= this.jdField_b_of_type_Int) {
      return;
    }
    this.jdField_b_of_type_Int = i;
    agwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_JavaUtilList.size(), this.jdField_a_of_type_JavaLangString);
  }
  
  public void b(View paramView)
  {
    if ((paramView != null) && ((paramView.getTag() instanceof agxg)))
    {
      paramView = (agxg)paramView.getTag();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (paramView.getTag() == null))
    {
      ...
      paramViewGroup.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localagxh);
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      if (!localagxh.jdField_a_of_type_Boolean) {
        break label822;
      }
      String str = agwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(localagxh);
      localObject2 = agwq.a(str);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        agwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).c(localagxh);
        localObject1 = localObject2;
        if (QLog.isColorLevel()) {
    ...
    {
      if ((localagxh.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) || (localObject1 != null))
      {
        paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout.setMinimumWidth(0);
        localObject2 = localagxh.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setTag(localagxh.jdField_a_of_type_JavaLangString + localagxh.e);
      ...
      for (localObject1 = new GifDrawable((AbstractGifImage)localObject1);; localObject1 = localObject2)
      {
        ...
        for (;;)
        {
          ...
          {
            agwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(localagxh);
            localagxh.jdField_a_of_type_Agxi.jdField_a_of_type_Boolean = true;
          }
          return paramView;
          paramViewGroup = (agxg)paramView.getTag();
          break;
          if (j > this.f)
          {
            i = i * this.f / j;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof agxg))) {}
      for (paramView = (agxg)paramView;; paramView = null)
      {
        if (paramView == null) {
          break label149;
        }
        paramView = (agxh)paramView.jdField_a_of_type_JavaLangRefWeakReference.get();
        if ((paramView == null) || (paramView.jdField_a_of_type_JavaLangString == null) || (paramView.jdField_a_of_type_Agxi == null)) {
          break;
        }
        ThreadManager.post(new ZhituPicAdapter.1(this, paramView), 8, null, false);
        agwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramView);
