...
public class scm
{
  public static final String a = antf.cD;
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    {
      String str = bjty.a(paramString1 + System.currentTimeMillis());
      StringBuilder localStringBuilder = new StringBuilder(a());
  ...
  public static boolean a(scn paramscn)
  {
    if (paramscn == null) {}
    long l;
    do
    {
      do
      {
        ...
        {
          return false;
          if (a(paramscn.a, paramscn.jdField_b_of_type_Int))
          {
            if (QLog.isColorLevel()) {
          ...
          if ((paramscn.d >= a()) && (paramscn.d <= b())) {
            break;
          }
        } while (!QLog.isColorLevel());
        QLog.d("VideoConvertUtils", 2, "needCompress(): false! fileSize not match, size=" + paramscn.d);
        return false;
        if (a()) {
          break;
        }
      ...
      return false;
      l = a(paramscn.a, paramscn.jdField_b_of_type_Int);
      if ((l > 0L) && (paramscn.jdField_b_of_type_Long > 3L * l))
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoConvertUtils", 2, "needCompress(): true! sourceBitRate:" + paramscn.jdField_b_of_type_Long + ", targetBitRate:" + l);
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("VideoConvertUtils", 2, "needCompress(): false, bitrate not match, sourceBitRate:" + paramscn.jdField_b_of_type_Long + ", targetBitRate:" + l);
    return false;
  }
