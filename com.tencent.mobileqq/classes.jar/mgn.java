...
public class mgn
{
  ...
  mgq jdField_a_of_type_Mgq = null;
  public boolean a;
  
  public mgn(RelativeLayout paramRelativeLayout, int paramInt, mgq parammgq)
  {
  ...
  public void a(long paramLong, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidAnimationObjectAnimator != null)
      {
        ...
        a();
        if (this.jdField_a_of_type_Mgq != null) {
          this.jdField_a_of_type_Mgq.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
        }
        if (!paramBoolean) {
          break label268;
        }
      ...
      ((ObjectAnimator)localObject).addListener(new mgp(this, i, paramLong));
      ...
      this.jdField_a_of_type_Boolean = true;
    } while (this.jdField_a_of_type_Mgq == null);
    label268:
    this.jdField_a_of_type_Mgq.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
  
  public void a(long paramLong, boolean paramBoolean, int paramInt, mie parammie)
  {
    int i = 4;
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      parammie = amtj.a(2131708047) + this.jdField_a_of_type_Boolean + "], height[" + i + "], seq[" + paramLong + "]";
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, parammie, new Throwable("打印调用栈"));
      throw new IllegalArgumentException(parammie);
    }
    ((ObjectAnimator)localObject).setDuration(300L);
    ((ObjectAnimator)localObject).addListener(new mgo(this, i, paramLong, parammie));
    this.jdField_a_of_type_AndroidAnimationObjectAnimator = ((ObjectAnimator)localObject);
    ((ObjectAnimator)localObject).start();
    this.jdField_a_of_type_Boolean = false;
    if (this.jdField_a_of_type_Mgq != null) {
      this.jdField_a_of_type_Mgq.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
    }
    label319:
    label320:
    do
    ...
    this.jdField_a_of_type_Mgq.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
