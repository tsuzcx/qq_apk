...
public class mgn
  implements Runnable
{
  public mgn(ReadInJoyBaseAdapter paramReadInJoyBaseAdapter, long paramLong1, List paramList, int paramInt1, int paramInt2, long paramLong2) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localLinkedList.add(mgw.a(localURL, ReadInJoyDisplayUtils.c()));
        }
      ...
      if (((BaseArticleInfo)localObject2).mVideoCoverUrl != null)
      {
        ...
        localLinkedList.add(mgw.a((URL)localObject1, ReadInJoyDisplayUtils.d()));
      ...
      for (;;)
      {
        ...
        if (((ArticleInfo)localObject1).mSinglePicture != null) {
          ...
          localObject1 = ReadInJoyUtils.b(((ArticleInfo)localObject1).mFirstPagePicUrl);
        }
      }
      if ((((BaseArticleInfo)localObject2).mPictures == null) || (((BaseArticleInfo)localObject2).mPictures.length <= 0))
      {
        ...
        if ((localObject3 != null) && (((JSONArray)localObject3).length() > 0))
        {
          ...
          if (localObject1 == null)
          {
            ...
            label439:
            localLinkedList.add(mgw.a(ReadInJoyUtils.b((String)localObject1), ReadInJoyDisplayUtils.a()));
      ...
      else
      {
        if ((((BaseArticleInfo)localObject2).mPictures.length < 1) || (localObject2.mPictures[0] == null))
        {
          localObject1 = ((BaseArticleInfo)localObject2).mSinglePicture;
          label602:
          localLinkedList.add(mgw.a((URL)localObject1, ReadInJoyDisplayUtils.a()));
        ...
        label743:
        localLinkedList.add(mgw.a(((BaseArticleInfo)localObject2).mSinglePicture, ReadInJoyDisplayUtils.b()));
      }
    }
    for (;;)
    {
      localLinkedList.add(mgw.a(((BaseArticleInfo)localObject2).mSinglePicture, ReadInJoyDisplayUtils.a()));
      break label61;
      label787:
      if (ReadInJoyBaseAdapter.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter) != this.jdField_a_of_type_Long) {
        break;
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject2 != null) && (((mgw)localObject2).jdField_a_of_type_JavaNetURL != null))
        {
          localObject3 = new ImageRequest();
          ((ImageRequest)localObject3).jdField_a_of_type_JavaNetURL = ((mgw)localObject2).jdField_a_of_type_JavaNetURL;
          ((ImageRequest)localObject3).jdField_a_of_type_Int = ((Integer)((mgw)localObject2).jdField_a_of_type_AndroidUtilPair.first).intValue();
          ((ImageRequest)localObject3).jdField_b_of_type_Int = ((Integer)((mgw)localObject2).jdField_a_of_type_AndroidUtilPair.second).intValue();
