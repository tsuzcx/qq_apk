  ...
  implements BaseConstants.NetType
{
  ...
  protected static azty[] a;
  
  static
  {
    jdField_a_of_type_ArrayOfAzty = new azty[4];
    jdField_a_of_type_ArrayOfAzty[1] = new azty();
    jdField_a_of_type_ArrayOfAzty[2] = new azty();
    jdField_a_of_type_ArrayOfAzty[3] = new azty();
  }
  
  public static azty a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    a(paramQQAppInterface, false);
    return jdField_a_of_type_ArrayOfAzty[paramInt];
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, int paramInt, azty paramazty)
  {
    ...
    try
    {
      a(((String)localObject).substring(((String)localObject).indexOf(':') + 1), paramazty);
      return paramQQAppInterface;
    }
    catch (Exception paramazty) {}
    return paramQQAppInterface;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, azty paramazty, int paramInt)
  {
    ...
    ((StringBuilder)localObject).append(paramazty.jdField_a_of_type_Int);
    int i = 0;
    while (i <= 5)
    {
      ((StringBuilder)localObject).append('#').append(i).append('_').append(paramazty.jdField_a_of_type_ArrayOfInt[i]);
      i += 1;
    }
    paramQQAppInterface = paramQQAppInterface.getCurrentAccountUin();
    paramazty = BaseApplicationImpl.sApplication.getSharedPreferences("RecordParams_" + paramQQAppInterface, 0);
    localObject = ((StringBuilder)localObject).toString();
    paramazty.edit().putString("PTTPreDownloadParams_" + paramInt, (String)localObject).commit();
    if (QLog.isDevelopLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((arrayOfString != null) && (arrayOfString.length >= 2))
        {
          ...
          if ((j >= 1) && (j < jdField_a_of_type_ArrayOfAzty.length))
          {
            azty localazty = jdField_a_of_type_ArrayOfAzty[j];
            a(arrayOfString[1], localazty);
          }
        }
      }
  ...
  protected static void a(String paramString, azty paramazty)
  {
    ...
    {
      return;
      paramazty.jdField_a_of_type_Int = Integer.parseInt(paramString[0]);
      int i = 1;
      for (;;)
      {
        ...
        paramazty.jdField_a_of_type_ArrayOfInt[j] = k;
        i += 1;
      }
    }
  }
