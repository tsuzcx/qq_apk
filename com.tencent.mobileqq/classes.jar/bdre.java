...
public class bdre
{
  ...
  public static Set<String> a()
  {
    ...
    {
      c = new HashSet(a);
      Object localObject = bdhg.a("MiniGame", "MiniGameAPILogWhiteList");
      bdrb.a().i("LogFilterUtil", "wns config white list: " + (String)localObject);
  ...
  public static Set<String> b()
  {
    ...
    {
      d = new HashSet(b);
      Object localObject = bdhg.a("MiniGame", "MiniGameAPILogBlackList");
      bdrb.a().i("LogFilterUtil", "wns config black list: " + (String)localObject);
      localObject = a((String)localObject);
      if (localObject != null) {
