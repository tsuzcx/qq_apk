...
{
  public bdre(TroopBarPublishActivity paramTroopBarPublishActivity, String paramString1, long paramLong, String paramString2) {}
  
  public void onVideoCompositeFinish(int paramInt, String paramString1, String paramString2)
  {
    ypi.f(this.jdField_a_of_type_JavaLangString);
    if (paramInt != 0)
    {
