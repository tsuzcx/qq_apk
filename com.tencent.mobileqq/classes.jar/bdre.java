  ...
  extends bdom
{
  ...
  private TextViewWrapLayout a(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(this.c)) {
      paramContext.setBackgroundResource(2130839440);
    }
    d(paramContext);
    return paramContext;
  }
  ...
  private void a(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    int m = localResources.getDimensionPixelSize(2131298913);
    int n = localResources.getDimensionPixelSize(2131298914);
  ...
  private void b(Context paramContext, ViewGroup paramViewGroup)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      int i = agej.a(11.0F, paramContext);
      int j = agej.a(14.0F, paramContext);
      paramViewGroup.setPadding(j, i, j, agej.a(12.0F, paramContext));
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      Object localObject11 = (bdol)((Iterator)localObject10).next();
      if ((localObject11 instanceof bdqo))
      {
        localObject11 = (bdqo)localObject11;
        if (((bdqo)localObject11).t == bdqo.s) {
          ((bdqo)localObject11).t = bdqo.q;
        }
      }
    }
    if ((paramView != null) && ((paramView instanceof TextViewWrapLayout)))
    {
      ...
      localObject4 = (bdol)((Iterator)localObject9).next();
      ((bdol)localObject4).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      localObject5 = ((bdol)localObject4).jdField_a_of_type_JavaLangString;
      if ((("picture".equals(localObject5)) || ("vote".equals(localObject5)) || ("video".equals(localObject5))) && (localObject3 == null)) {
        localObject3 = ((bdol)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131368493), paramBundle);
      }
    }
    for (;;)
    {
      ...
      if (("title".equals(localObject5)) && (localObject2 == null))
      {
        ...
        localObject2 = (TextView)((bdol)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131380141), paramBundle);
      }
      else if (localObject1 == null)
      {
        if (("summary".equals(localObject5)) || ("timer".equals(localObject5)))
        {
          localObject1 = (TextView)((bdol)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131380110), paramBundle);
        }
        else if ("checklist".equals(localObject5))
        {
          paramView = (LinearLayout)((bdol)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131379733), paramBundle);
          continue;
          ...
          {
            localObject5 = (bdol)((Iterator)localObject10).next();
            ((bdol)localObject5).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject6 = ((bdol)localObject5).jdField_a_of_type_JavaLangString;
            if ((("picture".equals(localObject6)) || ("vote".equals(localObject6)) || ("video".equals(localObject6))) && (localObject3 == null)) {
              localObject3 = ((bdol)localObject5).a(paramContext, null, paramBundle);
            }
          }
          for (;;)
          {
            ...
            if (("title".equals(localObject6)) && (localObject2 == null))
            {
              ...
              localObject2 = (TextView)((bdol)localObject5).a(paramContext, null, paramBundle);
            }
            else if (localObject1 == null)
            {
              if (("summary".equals(localObject6)) || ("timer".equals(localObject6)))
              {
                localObject1 = (TextView)((bdol)localObject5).a(paramContext, null, paramBundle);
              }
              else if ("checklist".equals(localObject6))
              {
                paramView = (LinearLayout)((bdol)localObject5).a(paramContext, null, paramBundle);
                continue;
                ...
                if ((this.o == 1) || (this.o == 3)) {
                  if (this.o == 1)
                  {
                    localObject2 = new RelativeLayout.LayoutParams(agej.a(50.0F, (Resources)localObject9), agej.a(50.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = agej.a(3.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = agej.a(12.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).leftMargin = agej.a(10.0F, (Resources)localObject9);
                    ...
                    if (localObject6 != null)
                    {
                      ...
                      i = k;
                      if ((paramContext instanceof bdtj))
                      {
                        paramContext = (bdtj)paramContext;
                        i = k;
                        if (paramContext != null)
                        {
                          if (TextUtils.isEmpty(paramContext.b())) {
                    ...
                    if (!(paramContext instanceof bdub)) {
                      break label1809;
                    }
                    paramContext = ((bdub)paramContext).jdField_a_of_type_JavaUtilArrayList;
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    return localObject4;
                    localObject2 = new RelativeLayout.LayoutParams(agej.a(115.0F, (Resources)localObject9), agej.a(70.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = agej.a(3.0F, (Resources)localObject9);
                    break label819;
                    label1399:
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = agej.a(7.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject7).topMargin = 0;
                    break label881;
                    if (!this.jdField_a_of_type_Boolean)
                    {
                      if (localObject1 != null) {
                        ((TextView)localObject1).setLineSpacing(agej.a(1.0F, (Resources)localObject9), 1.0F);
                      }
                      localObject2 = new RelativeLayout.LayoutParams(agej.a(50.0F, (Resources)localObject9), agej.a(50.0F, (Resources)localObject9));
                      ((RelativeLayout.LayoutParams)localObject2).topMargin = agej.a(7.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).leftMargin = agej.a(10.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).addRule(3, ((TextView)localObject5).getId());
                      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
                      ((RelativeLayout.LayoutParams)localObject7).topMargin = agej.a(5.0F, (Resources)localObject9);
                    ...
                    localObject2 = new RelativeLayout.LayoutParams(agej.a(32.0F, (Resources)localObject9), agej.a(32.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).leftMargin = agej.a(6.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject2).addRule(11);
