...
public class bdre
  extends bdnv
{
  private void a(Context paramContext, RelativeLayout paramRelativeLayout, Resources paramResources, bdrg parambdrg)
  {
    paramContext = new ImageView(paramContext);
    paramContext.setImageResource(2130850428);
    ...
    parambdrg.jdField_a_of_type_AndroidWidgetImageView = paramContext;
    paramContext.setVisibility(4);
    paramRelativeLayout.addView(paramContext, localLayoutParams);
  }
  
  private void b(Context paramContext, RelativeLayout paramRelativeLayout, Resources paramResources, bdrg parambdrg)
  {
    paramContext = new TextView(paramContext);
    paramContext.setId(2131376258);
    ...
    parambdrg.b = paramContext;
    paramRelativeLayout.addView(paramContext, localLayoutParams);
  }
  
  private void c(Context paramContext, RelativeLayout paramRelativeLayout, Resources paramResources, bdrg parambdrg)
  {
    paramContext = new TextView(paramContext);
    paramContext.setId(2131376259);
    paramContext.setText(2131698220);
    ...
    parambdrg.jdField_a_of_type_AndroidWidgetTextView = paramContext;
    paramRelativeLayout.addView(paramContext, localLayoutParams);
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (paramContext = "-";; paramContext = this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message)
    {
      ...
      paramView = (bdrg)paramContext.getTag(-1);
      break;
    }
    label190:
    ...
    {
      bdnu localbdnu = (bdnu)paramBundle.next();
    ...
    for (;;)
    {
      ...
      {
        paramContext.setBackgroundDrawable(new BitmapDrawable(localResources, localbbbc.a(localResources, bool, i)));
        paramView.jdField_a_of_type_Boolean = bool;
        paramView.jdField_a_of_type_Int = i;
      }
      if (bool)
      {
        paramView.b.setText(2131698219);
      ...
      for (;;)
      {
        if ((!bool) && (BaseApplicationImpl.sProcessId == 1))
        {
          ...
          bbbc.a().a(paramView, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message);
        }
        return paramContext;
        if ("1".equals(bbbc.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message)))
        {
          paramView.b.setText(2131698217);
          paramView.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
        }
        else
        {
          paramView.b.setText(2131698218);
