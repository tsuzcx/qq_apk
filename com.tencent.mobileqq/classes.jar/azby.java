...
public class azby
{
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    return bgku.encodeToString(localByteArrayOutputStream.toByteArray(), 2);
  }
  ...
  public static String a(String paramString)
  {
    ...
    try
    {
      ...
      if (arrayOfByte != null) {
        localObject1 = bkcx.b(arrayOfByte);
      }
    }
  ...
  public static String a(String paramString, long paramLong)
  {
    for (i = 1;; i = j)
    {
      ...
      str = bgku.encodeToString(str.getBytes(), 2);
  ...
  public static String a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return bkcx.b(jdField_a_of_type_JavaSecurityMessageDigest.digest());
    }
  ...
  public static String b(String paramString)
  {
    ...
    //   23: iconst_2
    //   24: invokestatic 242	bgku:decode	([BI)[B
    //   27: astore_0
