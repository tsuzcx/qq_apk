...
public class azby
  ...
  implements bjqx
{
  private static ampn jdField_a_of_type_Ampn;
  private static ampt jdField_a_of_type_Ampt;
  ...
  {
    SosoInterface.SosoLbsInfo localSosoLbsInfo = ampk.a(paramString);
    if (localSosoLbsInfo != null) {}
    for (boolean bool = true;; bool = false)
    {
      bjqy.a(bool, paramString);
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      return;
      e = l;
    } while (jdField_a_of_type_Ampn == null);
  ...
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Ampn == null))
    {
      jdField_a_of_type_Ampn = new azbz(paramString, false);
      try
      {
  ...
  {
    super.onDestroy();
    if (jdField_a_of_type_Ampt != null) {
      SosoInterface.b(jdField_a_of_type_Ampt);
    }
    jdField_a_of_type_Ampt = null;
    if (jdField_a_of_type_Ampn != null) {
      ampk.b(jdField_a_of_type_Ampn);
    }
    jdField_a_of_type_Ampn = null;
    bjqu.a().b(this);
    if (this.jdField_a_of_type_MqqOsMqqHandler != null)
    {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      azaw.a(paramIntent, paramFromServiceMsg, (QQAppInterface)localObject, this);
      return;
    }
    azaw.a((QQAppInterface)localObject, paramIntent, paramFromServiceMsg, this);
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject2 = (azbw)((QQAppInterface)localObject1).getManager(10);
        Object localObject3;
        if (localObject2 != null)
        {
          paramIntent = ((azbw)localObject2).a;
          if (paramIntent != null)
          {
            localObject3 = azaw.a(paramIntent);
            ...
            if (j < i1)
            {
              ...
              localObject4 = (bjha)((azbw)localObject2).a.get(Integer.valueOf(i2));
              ArrayList localArrayList;
              if (localObject4 != null)
              {
                localObject5 = new single_count(((bjha)localObject4).jdField_a_of_type_Long, (byte)((bjha)localObject4).jdField_a_of_type_Int);
                localArrayList = new ArrayList();
                if ((((bjha)localObject4).jdField_a_of_type_JavaUtilArrayList == null) || (((bjha)localObject4).jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
                  break label765;
                }
              }
              label765:
              for (paramIntent = new feed_host_info(((QZoneCountUserInfo)((bjha)localObject4).jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long, "", ((bjha)localObject4).jdField_a_of_type_JavaLangString, null, null, null);; paramIntent = new feed_host_info(0L, "", ((bjha)localObject4).jdField_a_of_type_JavaLangString, null, null, null))
              {
                localArrayList.add(paramIntent);
                localConcurrentHashMap1.put(Integer.valueOf(i2), new count_info((single_count)localObject5, localArrayList, ((bjha)localObject4).jdField_b_of_type_JavaLangString, ((bjha)localObject4).c, ((bjha)localObject4).e, ((bjha)localObject4).f, ((bjha)localObject4).g, ((bjha)localObject4).jdField_b_of_type_Long, ((bjha)localObject4).d));
                j += 1;
                break;
              }
            }
            paramIntent = (bjha)((azbw)localObject2).a.get(Integer.valueOf(56));
            if (paramIntent != null)
            {
        ...
        for (;;)
        {
          ...
          paramIntent = azaw.a(Long.valueOf(((QQAppInterface)localObject1).getCurrentAccountUin()).longValue(), null, m, n, i, k, localConcurrentHashMap1, paramIntent, localConcurrentHashMap2);
          if (paramIntent == null)
          {
            paramIntent = new byte[4];
            notifyObserver(null, 1000, false, new Bundle(), avvd.class);
          }
          for (;;)
          {
            a();
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    azaw.a((QQAppInterface)paramString, i, paramBundle);
  }
  ...
  public void service(Intent paramIntent)
  {
    if (paramIntent.getAction().equals("Qzone_Refresh_UI"))
    {
      ...
      notifyObserver(null, 1000, true, paramIntent, avvd.class);
      if (QLog.isColorLevel()) {
