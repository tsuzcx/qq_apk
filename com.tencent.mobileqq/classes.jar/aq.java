...
public class aq
  implements begw
{
  public aq(LiteActivity paramLiteActivity, DataLineMsgSet paramDataLineMsgSet, ed paramed, begr parambegr) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        paramView = this.jdField_a_of_type_Ed.a().jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_ComDatalineActivitiesLiteActivity.a(paramView, this.jdField_a_of_type_Ed.a().jdField_a_of_type_Long, -1);
      }
      else
      {
