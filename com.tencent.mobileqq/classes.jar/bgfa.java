  ...
  extends bgez
{
  ...
  public bgfa(Context paramContext, QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, Bundle paramBundle)
  {
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup.a = new bgfb(this, this.b);
    ...
    for (;;)
    {
      ...
      return paramView;
      ((bgfd)paramView.getTag()).a.a(this.jdField_a_of_type_JavaUtilList);
    }
  }
