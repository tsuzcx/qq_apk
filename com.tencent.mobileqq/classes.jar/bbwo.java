...
public class bbwo
{
  private static bbwo jdField_a_of_type_Bbwo;
  ...
  static String g = ajya.a(2131700147);
  static String h = ajya.a(2131700145);
  static String i = ajya.a(2131700146);
  static String j = ajya.a(2131700144);
  public int a;
  public long a;
  ...
  public static bbwo a()
  {
    if (jdField_a_of_type_Bbwo == null) {}
    try
    {
      if (jdField_a_of_type_Bbwo == null) {
        jdField_a_of_type_Bbwo = new bbwo();
      }
      return jdField_a_of_type_Bbwo;
    }
    finally {}
  }
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    bbdx.a(paramContext.getFilesDir() + File.separator + "vipKerwordJson", paramString1);
  }
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramInt1 = awyn.jdField_a_of_type_Int;
      awyn.jdField_a_of_type_Int = paramInt1 + 1;
      ...
      localMessageRecord.msgUid = apug.b();
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord == null) {
        break label249;
      }
    }
    ...
    label230:
    label249:
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;; l1 = awzy.a())
    {
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    if (localObject1 != null) {
      anzn.a(((JSONObject)localObject1).optLong("interval", 86400L));
    }
    ...
    {
      apzh.jdField_a_of_type_Boolean = bool1;
      QLog.i("AioVipKeywordHelper", 1, "lottieConfig.switch is " + bool1);
      localObject1 = paramAppRuntime.optJSONObject("ipProductGrayTips");
      if (localObject1 != null)
      {
        aske.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("leftText", aske.jdField_a_of_type_JavaLangString);
        aske.jdField_b_of_type_JavaLangString = ((JSONObject)localObject1).optString("linkText", aske.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
      ...
      if (localObject1 != null)
      {
        bbcm.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("interval", 5000);
        QLog.d("AioVipKeywordHelper", 1, "getStrangerInterval is " + bbcm.jdField_a_of_type_Int);
      }
      localObject1 = paramAppRuntime.optJSONObject("downloadTimeoutConfig");
      if (localObject1 != null)
      {
        anvx.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("emotion", anvx.jdField_b_of_type_Int);
        bool1 = bool2;
        if (((JSONObject)localObject1).optInt("emoTryReadNoLen", 0) == 1) {
          bool1 = true;
        }
        anvx.jdField_b_of_type_Boolean = bool1;
      ...
      if (localObject1 != null) {
        bbsk.a().a((JSONArray)localObject1);
      }
      anxg.a(paramAppRuntime.optJSONArray("h5MagicTips"));
      return;
    }
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((axmv.b()) || (this.jdField_d_of_type_Int == 0));
      l1 = 86400L;
      int i1;
      switch (paramSessionInfo.jdField_a_of_type_Int)
      {
