...
public class uny
  implements begh
{
  public uny(MystoryListView paramMystoryListView) {}
  ...
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (-MystoryListView.b(this.a) > vms.d(this.a.jdField_a_of_type_AndroidAppActivity) * 3) {
        this.a.jdField_a_of_type_Unx.b(true);
      }
