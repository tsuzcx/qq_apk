...
public class blzs
  implements Observer
{
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new blzy(this);
  public blzz a;
  ...
  public blzs(QQAppInterface paramQQAppInterface)
  {
  ...
  private Bundle a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramBundle = this.jdField_a_of_type_Blzz.a("com.qqdataline.action.notify", paramBundle);
        if (paramBundle != null) {
          paramBundle.setClassLoader(getClass().getClassLoader());
        }
        return paramBundle;
  ...
  private void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Blzz.a("com.qqdataline.action.notify", paramBundle);
        return;
      }
      catch (Exception paramBundle)
      {
  ...
  private Bundle b(Bundle paramBundle)
  {
    ...
    if (((String)localObject2).equals("DatalineHandler_sendC2CMessage_ToService"))
    {
      ...
      paramBundle.putParcelable("ToServiceMsg", ((ansr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER)).a(l1, (String)localObject1, i, j, k, (byte[])localObject2, l2));
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            {
              ((ansr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER)).sendPbReq((ToServiceMsg)paramBundle.getParcelable("ToServiceMsg"));
              return null;
            }
          ...
          localObject2 = ((aoxy)localObject2).a();
          paramBundle = (Bundle)localObject1;
      ...
      if (((String)localObject2).equals("DatalineHandler_saveFileManagerEntity"))
      {
        ...
        paramBundle = auea.a((String)localObject1);
        ...
        localFileManagerEntity.fileSize = auea.a((String)localObject1);
        localFileManagerEntity.isReaded = true;
        localFileManagerEntity.peerUin = ((String)localObject2);
        if (l1 == 0L) {}
        for (localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694211);; localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694213))
        {
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Blzz == null) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  private void d()
  {
    ...
    {
      CheckPermission.requestSDCardPermission(BaseActivity.sTopActivity, new blzu(this));
      return;
    }
    f();
  }
  ...
  private void f()
  {
    a(0);
    this.b = false;
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(BaseActivity.sTopActivity, 230, anvx.a(2131702251), anvx.a(2131702255), 2131694291, 2131720187, new blzv(this), new blzw(this));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new blzx(this));
    ...
    for (;;)
    {
      ...
      while (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        try
        {
          ...
          localObject1 = localObject2;
          this.jdField_a_of_type_Blzz.a("com.qqdataline.action.notify", localBundle);
          localObject1 = localObject2;
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  private void i()
  {
    ...
    localPluginCommunicationHandler.register(new blzt(this, "dataline.remotecall"));
  }
  ...
  private void k()
  {
    ...
    blzq.a(BaseActivity.sTopActivity, (Bundle)localObject, "com.qqdataline.activity.LiteWifiphotoActivity");
  ...
  public blzr a()
  {
    ...
    blzr localblzr = new blzr();
    localblzr.jdField_a_of_type_JavaLangString = localBundle.getString("ServerInfo.serverIp");
    localblzr.jdField_a_of_type_Int = localBundle.getInt("ServerInfo.serverPort");
    return localblzr;
  }
  ...
  {
    FileManagerEntity localFileManagerEntity = auea.a(paramMpfileTaskInfo, paramLong);
