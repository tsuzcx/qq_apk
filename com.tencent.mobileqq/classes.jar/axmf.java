  ...
  extends axmi
{
  ...
  public String a;
  private HashMap<String, axmh> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new axmg(this);
  public String b;
  public String c;
  private String d;
  
  public axmf(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  private void a(int paramInt, long paramLong)
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", alud.a(2131711615));
    localIntent.putExtra("key_register_from", 7);
    if (QLog.isColorLevel()) {
      QLog.d("QueryAccount", 2, "go2next countryCode=" + this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_b_of_type_JavaLangString + ", phoneNum=" + bdjb.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_a_of_type_JavaLangString) + ", leftTime=" + paramInt + ", exitTime=" + paramLong);
    }
    b(localIntent);
  ...
  private void b(String paramString)
  {
    ...
    localIntent.putExtra("key_register_has_pwd", this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_c_of_type_Boolean);
    localIntent.putExtra("key_register_binded_qq", this.d);
    localIntent.putExtra("selfSet_leftViewText", alud.a(2131711612));
    localIntent.putExtra("key_register_from", 7);
    b(localIntent);
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_AndroidContentIntent != null) && (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("key_register_from_fail_pay_lh", false)))
    {
      if (this.jdField_a_of_type_Axmj == null) {
        this.jdField_a_of_type_Axmj = new axmj(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity);
      }
      this.jdField_a_of_type_Axmj.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getIntent());
      return;
    }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 2) && (paramInt2 == -1))
    {
      ...
      if (QLog.isColorLevel())
      {
        localObject = new StringBuilder().append("doOnActivityResult countryCode=").append(str3).append(", phoneNum=").append(bdjb.a((String)localObject)).append(", leftTime=").append(paramInt1).append(", exitTime=").append(l).append(", inviteCode=");
        if (str1 != null) {
          break label231;
        }
      }
  ...
  public void a(Context paramContext)
  {
    ...
    Object localObject = amrm.a(BaseApplicationImpl.getContext(), "key_local_cache", "0");
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      ((AccountManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(0)).sendRegistByPhoneNumber(paramString, (byte)2, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_c_of_type_JavaLangString, Long.valueOf(AppSetting.a()), "8.3.5", localBundle, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public boolean a()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717510, 1);
      return false;
    }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(str))
    {
      ...
      if ((localObject != null) && ((localObject instanceof axmh)))
      {
        axmh localaxmh = (axmh)localObject;
        if ((localaxmh.jdField_a_of_type_Int > 0) && (localaxmh.jdField_a_of_type_Long > 0L) && (a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_c_of_type_JavaLangString, localaxmh.jdField_a_of_type_JavaLangString)))
        {
          long l = System.currentTimeMillis() - localaxmh.jdField_a_of_type_Long;
          StringBuilder localStringBuilder;
          if (QLog.isColorLevel())
          {
            localStringBuilder = new StringBuilder().append("startQueryAccount countryCode=").append(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_b_of_type_JavaLangString).append(", phoneNum=").append(bdjb.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_a_of_type_JavaLangString)).append(", leftTime=").append(localaxmh.jdField_a_of_type_Int).append(", exitTime=").append(localaxmh.jdField_a_of_type_Long).append(", interval=").append(l).append(", inviteCode=");
          ...
          for (localObject = "";; localObject = this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_c_of_type_JavaLangString)
          {
            ...
            if ((l <= 0L) || (l >= localaxmh.jdField_a_of_type_Int * 1000L)) {
              break;
            }
            a(localaxmh.jdField_a_of_type_Int, localaxmh.jdField_a_of_type_Long);
            return;
          }
        }
      }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("queryMobile", 2, "startQueryAccount countryCode=" + this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_b_of_type_JavaLangString + " phoneNum=" + bdjb.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.jdField_a_of_type_JavaLangString));
      }
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.b(2131717556);
      return;
    }
    catch (Exception localException)
    {
