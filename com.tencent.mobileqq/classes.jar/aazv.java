...
public class aazv
  extends ajhi
{
  private aazv(JoinDiscussionActivity paramJoinDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((ajjj)this.a.app.getManager(51)).b(((DiscussionMemberInfo)localObject1).memberUin);
        ...
        while (paramInt < this.a.jdField_b_of_type_Int)
        {
          ...
          if (azwp.a(this.a.app, 1, (String)localObject2) != null)
          {
      ...
      this.a.c = babh.a(this.a.app, this.a.d, String.valueOf(this.a.jdField_a_of_type_Long), l | 0x20000000, paramRespGetDiscussInfo.Name, localHashMap);
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      awqx.b(this.a.app, "CliOper", "", this.a.app.getCurrentAccountUin(), "discuss", "discuss_QR_join", 0, 0, "", "", "", "");
      this.a.stopTitleProgress();
    ...
    {
      if (paramInt != 0) {
        bbmy.a(this.a, ajjy.a(2131640087), 0).b(this.a.getTitleBarHeight());
      }
      Intent localIntent = aciy.a(new Intent(this.a, SplashActivity.class), null);
  ...
  protected void c(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Ajhf.c(this.a.jdField_a_of_type_JavaLangString);
      return;
    }
    this.a.a(0, -161);
  }
