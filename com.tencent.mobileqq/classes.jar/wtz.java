  ...
  extends wfm<wvk>
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = weg.a("StorySvc.union_batch_vid_basic_info");
  }
  ...
  public wfh a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      ykq.a("Q.qqstory.net:GetVideoFullInfoListRequest", "%s", zel.a(localRspBatchGetVideoFullInfoList));
      return new wvk(localRspBatchGetVideoFullInfoList);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ykq.b("Q.qqstory.net:GetVideoFullInfoListRequest", a(), paramArrayOfByte);
    }
    return null;
  }
