...
public class agvq
  implements Runnable
{
  public agvq(EffectsCameraCaptureFragment paramEffectsCameraCaptureFragment, RecentDanceConfigMgr.DItemInfo paramDItemInfo) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845420);
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(new agvr(this));
    if (EffectsCameraCaptureFragment.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment) == null) {
      EffectsCameraCaptureFragment.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureFragmentEffectsCameraCaptureFragment, new agvs(this));
    }
    ...
    CaptureReportUtil.j();
    ThreadManager.getUIHandler().postDelayed(new agvt(this), 2000L);
  }
}
