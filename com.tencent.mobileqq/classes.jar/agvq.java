...
public class agvq
  implements agve, Handler.Callback
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bdbw(ThreadManager.getSubThreadLooper(), this);
  private int b;
  
  public agvq(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, agwa paramagwa)
  {
  ...
  {
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800524B", "0X800524B", 0, 0, String.valueOf(paramInt), "", "", "");
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (this.b == 0) {}
    for (String str = "0";; str = "1")
    {
      azmj.b(localQQAppInterface, "dc00899", "grp_lbs", "", "tmp_grey", "exp_oper", 0, 0, str, "", "", "");
      return this.jdField_a_of_type_Agwa.a(this, paramVarArgs);
    }
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    for (paramVarArgs = paramVarArgs[0].toString();; paramVarArgs = null)
    {
      ...
      {
        MessageRecord localMessageRecord = ayvw.a(-2027);
        long l = ayvc.a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return false;
            if ((this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a()) && (!this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a(ayvc.a() * 1000L))) {
              break;
            }
            return false;
            l1 = ayvc.a() * 1000L;
        ...
        } while (ayvy.a(paramMessage.msgtype));
      ...
      while (!TextUtils.isEmpty(paramMessage))
      {
        ...
        if (localGrayTipsConfig.sceneId == 4)
        {
          ...
          else
          {
            ...
            paramMessage.text = alpo.a(2131707588);
            paramMessage.highlightText = alpo.a(2131707587);
          }
      ...
      if (!bdec.b(((ChatMessage)localObject).issend)) {
        break label1201;
      }
    ...
    } while (bdec.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (QQMessageFacade.Message)localObject));
    ...
    if (paramMessage != null)
    {
      ...
      if (ayvy.a(((ChatMessage)paramMessage.next()).msgtype)) {
        break label1348;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (paramMessage = this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.c(this.b, this.jdField_a_of_type_Int, l1);; paramMessage = null)
      {
        ...
        if (ayvy.a(((ChatMessage)localObject).msgtype)) {
          break;
        }
