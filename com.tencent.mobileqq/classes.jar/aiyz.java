...
public abstract class aiyz
{
  public static final int[] a;
  public static final int[] b;
  public static final int[] c = { 2131370896 };
  public ajav a;
  public ajbn a;
  protected Context a;
  protected blfk a;
  ...
  public aiyz(Context paramContext, QQAppInterface paramQQAppInterface, ajav paramajav, ajbn paramajbn)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ajav = paramajav;
    this.jdField_a_of_type_Ajbn = paramajbn;
    this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131297425);
  }
  ...
  public static void a(TextView paramTextView, int paramInt1, int paramInt2, StringBuilder paramStringBuilder)
  {
    ...
    {
    default: 
      paramTextView.setBackgroundResource(2130845859);
      j = 0;
      i = 0;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          break;
          j = 2130845856;
          paramTextView.setBackgroundResource(2130845857);
          i = j;
          if (paramStringBuilder == null) {
            break label231;
          }
  ...
  protected View a(Context paramContext, int paramInt, aizb paramaizb)
  {
    View localView = LayoutInflater.from(paramContext).inflate(paramInt, null);
    if (this.jdField_a_of_type_Ajav != null) {
      return this.jdField_a_of_type_Blfk.a(paramContext, localView, paramaizb, -1);
    }
    paramaizb.g = localView;
    paramaizb.a = null;
    return localView;
  }
  ...
  protected blfk a(Context paramContext)
  {
    ...
    return new aiza(this, 1, 2, new int[] { i, j }, -1, paramContext, arrayOfInt1, arrayOfInt2);
  }
  
  protected void a() {}
  
  public void a(ajbn paramajbn)
  {
    this.jdField_a_of_type_Ajbn = paramajbn;
  }
  ...
  protected void a(Context paramContext, View paramView, int paramInt, Object paramObject, blfl paramblfl, View.OnClickListener paramOnClickListener)
  {
    ...
    {
      if ((this.jdField_a_of_type_Ajav != null) && (this.jdField_a_of_type_Ajav.a != -1))
      {
        if (paramInt != this.jdField_a_of_type_Ajav.a) {
  ...
  protected void a(View paramView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!bhbx.a(paramView, this.jdField_a_of_type_AndroidContentContext.getResources().getString(jdField_a_of_type_ArrayOfInt[0]))) {
          continue;
        }
        a();
        return;
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    {
      return;
      localView = paramView.findViewById(2131376771);
