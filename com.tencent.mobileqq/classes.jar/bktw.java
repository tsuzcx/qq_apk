...
public class bktw
  extends QIPCModule
{
  private static bktw a;
  
  public bktw(String paramString)
  {
    super(paramString);
  }
  ...
  {
    bkvd.e("ReaderIPCModule", "action = " + paramString);
    if (paramBundle == null)
    {
      bkvd.e("ReaderIPCModule", "Err params = null, action = " + paramString);
      return null;
    }
    ...
    do
    {
      ...
      {
        bkst.a().a(((QQAppInterface)localObject).getApp());
