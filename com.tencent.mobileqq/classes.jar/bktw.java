...
public class bktw
{
  ...
  public static Map<String, String> a()
  {
    try
    {
      Map localMap = a(new FileInputStream("/proc/cpuinfo"), new bktx());
      return localMap;
    }
  ...
  /* Error */
  private static Map<String, String> a(InputStream paramInputStream, bktz parambktz)
  {
    // Byte code:
  ...
  {
    // Byte code:
    //   0: invokestatic 88	com/tencent/mobileqq/util/SystemUtil:isExistSDCard	()Z
    //   3: ifne +4 -> 7
    //   6: return
    //   7: aconst_null
    //   8: astore_3
    ...
    //   50: new 424	javax/crypto/CipherOutputStream
    //   53: dup
    //   54: new 426	java/io/FileOutputStream
    //   57: dup
    //   58: invokestatic 94	bktw:d	()Ljava/lang/String;
    //   61: invokespecial 427	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   64: aload 5
    //   66: invokespecial 430	javax/crypto/CipherOutputStream:<init>	(Ljava/io/OutputStream;Ljavax/crypto/Cipher;)V
    //   69: astore_2
    //   70: aload_1
    //   71: invokeinterface 398 1 0
    //   76: invokeinterface 402 1 0
    //   81: astore_1
    //   82: aload_1
    //   83: invokeinterface 407 1 0
    //   88: ifeq +116 -> 204
    //   91: aload_1
    //   92: invokeinterface 411 1 0
    //   97: checkcast 413	java/util/Map$Entry
    //   100: astore_3
    //   101: aload_0
    //   102: aload_3
    //   103: invokeinterface 416 1 0
    ...
    //   136: iconst_2
    //   137: invokestatic 434	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    ...
    //   161: iconst_2
    //   162: invokestatic 434	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    ...
    //   180: invokevirtual 443	java/io/OutputStream:write	([B)V
    //   183: goto -101 -> 82
    //   186: astore_1
    //   187: aload_2
    //   188: astore_0
    ...
    //   194: ifnull -188 -> 6
    //   197: aload_0
    //   198: invokevirtual 444	java/io/OutputStream:close	()V
    //   201: return
    //   202: astore_0
    //   203: return
    //   204: aload_2
    //   205: ifnull -199 -> 6
    //   208: aload_2
    //   209: invokevirtual 444	java/io/OutputStream:close	()V
    //   212: return
    //   213: astore_0
    //   214: return
    //   215: astore_0
    ...
    //   219: ifnull +7 -> 226
    //   222: aload_1
    //   223: invokevirtual 444	java/io/OutputStream:close	()V
    //   226: aload_0
    //   227: athrow
    //   228: astore_1
    //   229: goto -3 -> 226
  ...
  private static boolean a()
  {
    ...
    return (SystemUtil.isExistSDCard()) && (!localFile.exists());
  }
  ...
  private static String b(Map<String, String> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        paramMap = Long.toString(DeviceInfoUtil.getSystemTotalMemory());
      }
      else if (paramString.equals("ts"))
      {
        paramMap = Long.toString(DeviceInfoUtil.getSDCardMemory()[0]);
      }
      else if (paramString.equals("rs"))
      {
        paramMap = DeviceInfoUtil.getResolutionString();
      }
  ...
  private static Map<String, String> b()
  {
    ...
    {
      return localHashMap;
      a(a(localInputStream, new bkty()), localHashMap);
  ...
  private static void b()
  {
    ...
    bksv.b(localStringBuilder.toString().substring(1), 110);
  }
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        try
        {
          ...
          localObject = Base64.encodeToString((DeviceInfoUtil.getQQVersion() + "_" + Long.toString(l ^ 0xADCD123)).getBytes(), 2);
          return localObject;
        }
        catch (Exception localException) {}
      }
