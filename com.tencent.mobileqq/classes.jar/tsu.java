...
class tsu
{
  ...
  private final tss[] jdField_a_of_type_ArrayOfTss;
  ...
  tsu(tss[] paramArrayOftss, tsw paramtsw)
  {
    this.jdField_a_of_type_ArrayOfTss = paramArrayOftss;
  ...
  private void a(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, char[] paramArrayOfChar, int paramInt2, int paramInt3)
  {
    ...
    int i = 0;
    Object localObject1;
    if (i < this.jdField_a_of_type_ArrayOfTss.length)
    {
      tst localtst = this.jdField_a_of_type_ArrayOfTss[i].a(this.jdField_a_of_type_Char, c1, this.jdField_a_of_type_Tsw.a());
      ...
      for (localObject1 = localObject2;; localObject1 = this.jdField_a_of_type_ArrayOfTss[i].a())
      {
        i += 1;
        localObject2 = localObject1;
        break;
        label121:
        this.jdField_a_of_type_ArrayOfChar = this.jdField_a_of_type_ArrayOfTss[i].a();
        this.jdField_a_of_type_Int = localtst.jdField_a_of_type_Int;
        this.jdField_b_of_type_Int = localtst.jdField_b_of_type_Int;
      }
    }
    if ((this.jdField_a_of_type_ArrayOfChar != null) && (paramInt1 > 1) && (!TextUtils.isEmpty(localObject2)))
    {
      ...
      if (this.jdField_a_of_type_Tsw.a() == 1)
      {
        paramInt1 = 0;
        for (;;)
        {
      ...
      paramArrayOfChar = (char[])localObject1;
      if (this.jdField_a_of_type_Tsw.a() == 2)
      {
        paramInt1 = 0;
        for (;;)
        {
  ...
  private void b()
  {
    float f1 = this.jdField_a_of_type_Tsw.a(this.jdField_b_of_type_Char);
  ...
  void a(float paramFloat, boolean paramBoolean)
  {
    ...
    float f1 = this.jdField_a_of_type_Tsw.a();
  ...
  void a(int paramInt, char paramChar, boolean paramBoolean)
  {
    ...
    this.e = this.jdField_a_of_type_Tsw.a(paramChar);
