...
public class tsu
{
  private static SparseArray<ttc> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = sxp.a("StorySvc.report_comment");
    b = sxp.a(2131699675);
  ...
  {
    Object localObject2 = wan.a(a(), paramStoryVideoItem.mVid, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, paramInt);
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      QLog.i("Q.qqstory.player.PlayModeUtils", 1, "get download water mark failed, logoMarkPath is null!");
    }
    Object localObject3 = wan.b(paramStoryVideoItem);
    Object localObject1 = wan.a(paramStoryVideoItem);
    String str = wan.a(paramStoryVideoItem.getInteractLayout(), paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight);
    ...
    while ((!TextUtils.isEmpty((CharSequence)localObject3)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
    {
      ...
      if (!wan.a((String)localObject3, (String)localObject1, str))
      {
    ...
    for (;;)
    {
      ...
      localObject1 = new avxj(2000000, (PublishVideoEntry)localObject1);
      ((avxj)localObject1).b(0);
      localObject2 = new avxh();
      localObject3 = ssi.k + paramStoryVideoItem.mVid + ".mp4";
      paramInt = ((avxh)localObject2).a(paramStoryVideoItem.mLocalVideoPath, (String)localObject3, (avxj)localObject1);
      if (paramInt == 0) {
        break label481;
      }
      if (paramInt == -1) {
      ...
      veg.b("Q.qqstory.player.PlayModeUtils", new Throwable("MergeVideoError"), "watermarkVideoByMediaCodec() error after mergeVideo() return, errorCode=%d", new Object[] { Integer.valueOf(paramInt) });
      return paramInt;
      localObject1 = localObject2;
    }
    vyi.c(paramStoryVideoItem.mLocalVideoPath, paramString);
    label481:
    for (paramInt = 0;; paramInt = wbh.a((String)localObject3, paramStoryVideoItem.mLocalVideoPath, paramString, 0))
    {
      if (paramInt == 0) {
        vyi.a(BaseApplication.getContext(), new File(paramString));
      }
  ...
  {
    paramString = ((tdo)tdc.a(2)).b(paramString);
    if (paramString == null)
    {
  ...
  public static final String a(String paramString, boolean paramBoolean)
  {
    ...
    for (String str = ".png";; str = ".mp4") {
      return wan.a(paramString, str);
    }
  }
  
  @NonNull
  public static ttc a(int paramInt)
  {
    ttc localttc2 = (ttc)jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    ttc localttc1 = localttc2;
    if (localttc2 == null)
    {
      localttc1 = new ttc();
      jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localttc1);
    }
    return localttc1;
  }
  ...
  public static void a(Context paramContext, CommentEntry paramCommentEntry)
  {
    ...
    do
    {
      do
      {
        ...
        bcpw.a(BaseApplicationImpl.getContext(), 1, ajyc.a(2131708210), 0).a();
        vel.b("story_net", jdField_a_of_type_JavaLangString, 0, 99980, new String[] { "", "0", vel.a(BaseApplication.getContext()) });
      } while (!QLog.isColorLevel());
      QLog.w("Q.qqstory.player.PlayModeUtils", 2, "reportVideoCommemt - isNetSupport is false----");
      return;
      paramContext = (bfol)bfoy.b(paramContext, null);
      paramContext.a(ajyc.a(2131708202), 5);
      paramContext.a(ajyc.a(2131708221), 5);
      paramContext.a(ajyc.a(2131708218), 5);
      paramContext.a(ajyc.a(2131708206), 5);
      paramContext.c(2131690596);
      paramContext.a(new tta(paramCommentEntry, paramContext));
  ...
  {
    if (!bbev.d(BaseApplicationImpl.getContext())) {
      bcpw.a(BaseApplicationImpl.getContext(), 1, ajyc.a(2131708219), 0).a();
    }
    do
    {
      return;
      paramContext = (bfol)bfoy.b(paramContext, null);
      paramContext.a(ajyc.a(2131708217), 5);
      paramContext.a(ajyc.a(2131708211), 5);
      paramContext.a(ajyc.a(2131708224), 5);
      paramContext.a(ajyc.a(2131708201), 5);
      paramContext.c(2131690596);
      paramContext.a(new tsz(paramQQUserUIItem, paramContext));
  ...
  {
    if (!bbev.d(BaseApplicationImpl.getContext())) {
      bcpw.a(BaseApplicationImpl.getContext(), 1, ajyc.a(2131708204), 0).a();
    }
    do
    {
      return;
      paramContext = (bfol)bfoy.b(paramContext, null);
      paramContext.a(ajyc.a(2131708200), 5);
      paramContext.a(ajyc.a(2131708203), 5);
      paramContext.a(ajyc.a(2131708222), 5);
      paramContext.a(ajyc.a(2131708223), 5);
      paramContext.c(2131690596);
      paramContext.a(new ttb(paramStoryVideoItem, paramContext));
      paramContext.setOnDismissListener(paramOnDismissListener);
    } while (paramContext.isShowing());
    paramContext.show();
  }
  ...
  {
    boolean bool = false;
    if ((paramResources == null) || (paramTextView == null) || (!nam.a(paramString))) {
      if (QLog.isColorLevel())
      {
    ...
    do
    {
      ...
      try
      {
        ...
        int i = actn.a(paramFloat1, paramResources);
        ...
        paramTextView.setCompoundDrawablePadding(actn.a(paramFloat2, paramResources));
  ...
  public static void a(Resources paramResources, QQUserUIItem paramQQUserUIItem, ImageView paramImageView, float paramFloat1, TextView paramTextView, float paramFloat2, float paramFloat3, boolean paramBoolean, String paramString)
  {
    ...
    if (sxu.a())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        i = actn.a(paramFloat1, paramResources);
        ...
        paramTextView.setText(((tdk)tdc.a(23)).a(paramQQUserUIItem, paramString, false, true));
      }
    }
    for (;;)
    {
      ...
      localObject = paramResources.getDrawable(2130845927);
      i = actn.a(paramFloat2, paramResources);
      int j = actn.a(paramFloat3, paramResources);
      if (localObject == null) {
        break;
      }
    ...
    {
      paramResources = baxt.a(a(), 1, paramQQUserUIItem.qq, 3, localDrawable, localDrawable);
    ...
    for (;;)
    {
      ...
      return;
      break;
      if (nam.a(paramQQUserUIItem.headUrl)) {
        a(paramImageView, paramQQUserUIItem.headUrl, true, i);
      } else {
        paramImageView.setImageDrawable(localDrawable);
      }
  ...
  public static final void a(ImageView paramImageView, QQUserUIItem paramQQUserUIItem)
  {
    ...
    paramQQUserUIItem = sxu.a(paramQQUserUIItem);
  ...
  {
    Drawable localDrawable = bbdr.a();
    paramImageView.setImageDrawable(baxt.a(a(), 1, paramString, 3, localDrawable, localDrawable));
  }
  ...
  protected static void a(ImageView paramImageView, String paramString1, int paramInt1, int paramInt2, boolean paramBoolean, Drawable paramDrawable, DownloadParams.DecodeHandler paramDecodeHandler, Object paramObject, String paramString2, ttg paramttg)
  {
    for (;;)
    {
      try
    ...
    paramString1.setURLDrawableListener(new tsv(System.currentTimeMillis(), paramttg));
  }
  ...
  protected static void a(ImageView paramImageView, String paramString1, int paramInt1, int paramInt2, boolean paramBoolean, DownloadParams.DecodeHandler paramDecodeHandler, Object paramObject, String paramString2, ttg paramttg)
  {
    a(paramImageView, paramString1, paramInt1, paramInt2, paramBoolean, new ColorDrawable(0), paramDecodeHandler, paramObject, paramString2, paramttg);
  }
  ...
  public static void a(ImageView paramImageView, String paramString1, String paramString2, boolean paramBoolean, ttg paramttg)
  {
    String str = null;
    boolean bool = apvb.a(paramString1);
    DownloadParams.DecodeHandler localDecodeHandler;
    int[] arrayOfInt;
    if (paramBoolean)
    {
      localDecodeHandler = bavi.r;
      if (!paramBoolean) {
        break label73;
      }
    ...
    for (;;)
    {
      a(paramImageView, paramString1, axli.jdField_a_of_type_Int / 2, axli.b / 2, bool, localDecodeHandler, arrayOfInt, str, paramttg);
      return;
      localDecodeHandler = null;
      break;
      label73:
  ...
  public static void a(ShareFromMemoryPlayInfo paramShareFromMemoryPlayInfo, ttf paramttf)
  {
    tmf localtmf = new tmf();
    localtmf.jdField_c_of_type_JavaLangString = paramShareFromMemoryPlayInfo.uid;
    localtmf.d = "";
    localtmf.jdField_c_of_type_Int = 20;
    localtmf.jdField_e_of_type_Int = paramShareFromMemoryPlayInfo.shareTimeZone;
    localtmf.jdField_e_of_type_JavaLangString = paramShareFromMemoryPlayInfo.feedId;
    localtmf.f = paramShareFromMemoryPlayInfo.identify;
    localtmf.g = paramShareFromMemoryPlayInfo.videoListOrder;
    syr.a().a(localtmf, new tsy(paramttf));
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, tth paramtth)
  {
    ...
    mxi.a(paramQQAppInterface, paramtth, localReqBatchGetVideoFullInfoList.toByteArray(), tnj.jdField_a_of_type_JavaLangString, paramString);
  }
  
  protected static final void a(wae paramwae, String paramString1, StoryVideoItem paramStoryVideoItem, String paramString2, int paramInt, String paramString3)
  {
    try
    {
      tte localtte = new tte(paramString2, paramStoryVideoItem, paramString3);
      paramwae.a(paramString2);
      paramwae.a(wan.a(a(), paramStoryVideoItem.mVid, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, paramInt), paramString1, paramString2, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, localtte);
      return;
    }
    catch (Exception paramwae)
    {
      paramString1 = new ttd(paramString3, 3, paramStoryVideoItem);
      ste.a().dispatch(paramString1);
      QLog.e("Q.qqstory.player.PlayModeUtils", 2, paramwae.getMessage());
    }
  }
  ...
  public static boolean a(StoryVideoItem paramStoryVideoItem, Context paramContext)
  {
    ...
    veg.a("Q.qqstory.player.PlayModeUtils", "onClickRetryUploadBtn=%s", paramStoryVideoItem);
    vel.a("mystory", "clk_retry", 0, 0, new String[0]);
    if (svy.a(paramStoryVideoItem.mUpLoadFailedError))
    {
      veg.d("Q.qqstory.player.PlayModeUtils", "video file not exist, vid:%s", new Object[] { paramStoryVideoItem.mVid });
      String str = paramStoryVideoItem.mVid;
      paramContext = bbcv.a(paramContext, 230);
      paramContext.setTitle(ajyc.a(2131708209));
      if (svy.b(paramStoryVideoItem.mUpLoadFailedError)) {
        paramContext.setMessage(ajyc.a(2131708216));
      }
      for (;;)
      {
        paramContext.setPositiveButton(ajyc.a(2131708215), new tsx(paramStoryVideoItem, str));
        paramContext.setCancelable(false);
        paramContext.getWindow().setBackgroundDrawable(new ColorDrawable(0));
        paramContext.show();
        return false;
        paramContext.setMessage(ajyc.a(2131708212));
      }
    }
    return svo.a(paramStoryVideoItem, paramContext);
  }
  
  public static final String b(QQUserUIItem paramQQUserUIItem)
  {
    return sxu.b(paramQQUserUIItem);
  }
  ...
  {
    a(paramImageView, paramString1, paramInt1, paramInt2, paramBoolean, bbdr.b(), paramDecodeHandler, paramObject, paramString2);
  }
  ...
  public static void b(ImageView paramImageView, String paramString1, String paramString2, boolean paramBoolean, ttg paramttg)
  {
    String str = null;
    boolean bool = apvb.a(paramString1);
    DownloadParams.DecodeHandler localDecodeHandler;
    ...
    for (;;)
    {
      a(paramImageView, paramString1, axli.jdField_a_of_type_Int, axli.b, bool, localDecodeHandler, arrayOfInt, str, paramttg);
      return;
      localDecodeHandler = null;
      break;
      label69:
  ...
  public static void b(StoryVideoItem paramStoryVideoItem, int paramInt, String paramString)
  {
    ...
    {
      paramStoryVideoItem = new ttd(paramString, 3, paramStoryVideoItem);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          paramString = new ttd(paramString, 2, paramStoryVideoItem);
          paramString.b = str2;
          ste.a().dispatch(paramString);
          long l2 = paramStoryVideoItem.mVideoDuration;
          vel.a("play_video", "down_watermark_time", 1, 0, new String[] { String.valueOf(SystemClock.uptimeMillis() - l1), String.valueOf(l2) });
          vel.a("play_video", "down_watermark", 1, 0, new String[0]);
          vel.a("play_video", "down_suc", 1, 0, new String[] { "", "", "", paramStoryVideoItem.mVid });
          return;
        }
      }
      catch (IllegalStateException localIllegalStateException)
      {
        ...
        Object localObject1 = ssi.k + paramStoryVideoItem.mVid + ".mp4";
        wae localwae = wae.a(a());
        if (localwae.a())
        {
          if (!localwae.a(str2))
          {
            paramStoryVideoItem = new ttd(paramString, 1, paramStoryVideoItem);
            ste.a().dispatch(paramStoryVideoItem);
          }
        }
        else
        {
          if (vyi.c(str2))
          {
            paramStoryVideoItem = new ttd(paramString, 2, paramStoryVideoItem);
            paramStoryVideoItem.b = str2;
            ste.a().dispatch(paramStoryVideoItem);
            return;
          }
          if (vyi.c((String)localObject1))
          {
            a(localwae, (String)localObject1, paramStoryVideoItem, str2, paramInt, paramString);
            return;
          }
          if ((paramStoryVideoItem.getVideoMaskType() == 0) && (!paramStoryVideoItem.isPollVideo()) && (!paramStoryVideoItem.isInteractVideo()))
          {
            a(localwae, paramStoryVideoItem.mLocalVideoPath, paramStoryVideoItem, str2, paramInt, paramString);
            return;
          }
          Object localObject3 = wan.a(a(), paramStoryVideoItem.mVid, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, paramInt);
          if (TextUtils.isEmpty((CharSequence)localObject3)) {
            QLog.i("Q.qqstory.player.PlayModeUtils", 1, "get download water mark failed, logoMarkPath is null!");
          }
          Object localObject2 = wan.b(paramStoryVideoItem);
          localObject1 = wan.a(paramStoryVideoItem);
          String str1 = wan.a(paramStoryVideoItem.getInteractLayout(), paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight);
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
          while ((!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            if (!wan.a((String)localObject2, (String)localObject1, str1))
            {
              paramStoryVideoItem = new ttd(paramString, 3, paramStoryVideoItem);
              ste.a().dispatch(paramStoryVideoItem);
              QLog.e("Q.qqstory.player.PlayModeUtils", 2, "combineTwoImg maxMask videoVote failed");
          ...
          while ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject3))) {
            if (!wan.a((String)localObject1, (String)localObject3, (String)localObject3))
            {
              paramStoryVideoItem = new ttd(paramString, 3, paramStoryVideoItem);
              ste.a().dispatch(paramStoryVideoItem);
          ...
          for (;;)
          {
            try
            {
              localObject1 = new tte(str2, paramStoryVideoItem, paramString);
              localwae.a(str2);
              paramInt = vzx.b(paramStoryVideoItem.mLocalVideoPath);
              if ((paramInt != 0) && (paramInt != -1)) {
                break;
              }
              localwae.a((String)localObject2, paramStoryVideoItem.mLocalVideoPath, str2, paramStoryVideoItem.mVideoWidth, paramStoryVideoItem.mVideoHeight, (wam)localObject1);
              return;
            }
          ...
          str1 = ssi.k + "hflip" + paramStoryVideoItem.mVid + ".mp4";
          if (!vyi.c(str1))
          {
            localObject4 = new wak();
            ((wak)localObject4).jdField_a_of_type_Int = 10;
            ((wak)localObject4).jdField_a_of_type_JavaUtilArrayList = new PlayModeUtils.3(paramStoryVideoItem, str1);
            ((wak)localObject4).jdField_a_of_type_Wam = new waw(localException);
            ((ArrayList)localObject3).add(localObject4);
            localObject4 = new ttd(paramString, 0, paramStoryVideoItem);
            ste.a().dispatch((Dispatcher.Dispatchable)localObject4);
          }
          Object localObject4 = new wak();
          ((wak)localObject4).jdField_a_of_type_Int = 1;
          ((wak)localObject4).jdField_a_of_type_JavaUtilArrayList = new PlayModeUtils.4((String)localObject2, str1, str2, paramStoryVideoItem);
          ((wak)localObject4).jdField_a_of_type_Wam = localException;
          ((ArrayList)localObject3).add(localObject4);
          localwae.a((ArrayList)localObject3);
        }
      }
    }
  }
  ...
  {
    ttd localttd = new ttd(paramString, 0, paramStoryVideoItem);
