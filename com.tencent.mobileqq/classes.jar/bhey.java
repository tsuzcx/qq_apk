...
public class bhey
{
  public static bheh a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    catch (Exception paramString)
    {
      ...
      paramQQAppInterface = new bheh(paramQQAppInterface, paramContext);
    ...
    localObject3 = paramString;
    Object localObject1 = aoum.a(paramQQAppInterface, paramContext, paramString);
        ...
        if (AudioHelper.a(8) == 1)
        {
          ...
          if (((String)localObject1).startsWith("mqqconferenceflyticket://"))
          {
            ...
            if (paramString.startsWith("mqqapi://qzone/groupalbum"))
            {
              ...
              localObject3 = localObject1;
              localObject4 = new bheh(paramQQAppInterface, paramContext);
              localObject3 = localObject1;
              ...
              localObject3 = localObject1;
              ((bheh)localObject4).a = paramString;
              localObject3 = localObject1;
              ((bheh)localObject4).b = localObject2[0];
              localObject3 = localObject1;
              ((bheh)localObject4).c = localObject2[1];
              localObject3 = localObject1;
    ...
    for (;;)
    {
      ...
      if (i < paramString.length)
      {
        ...
        try
        {
          ...
          localObject3 = localObject1;
          ((bheh)localObject4).a(localObject2[0], localObject2[1]);
        }
  ...
  private static bheh a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
  ...
  private static bheh a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String[] paramArrayOfString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    String str = "";
    bheh localbheh = new bheh(paramQQAppInterface, paramContext);
    if (paramString2.startsWith("mqqapi://now/openroom"))
    {
      localbheh.a = paramString2;
      ...
      localbheh.a("attr_original_url", paramString1);
    }
    label144:
    int i;
    for (;;)
    ...
    label399:
    localbheh.a = paramContext;
    localbheh.b = paramQQAppInterface[0];
    ...
    if (paramBoolean1)
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        ...
        for (paramBoolean1 = true;; paramBoolean1 = false)
        {
          ...
          if (j > 0) {
            localbheh.a(paramContext.substring(0, j), paramContext.substring(j + 1, paramContext.length()));
          }
          i += 1;
          break;
        }
    ...
    else
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        ...
        if (paramContext.length == 2)
        {
          ...
          localbheh.a(paramContext[0], a(paramContext[1], false));
        }
        for (;;)
        {
          i += 1;
          break;
          label587:
          localbheh.a(paramContext[0], paramContext[1]);
        }
      }
    }
    return localbheh;
