  ...
  implements bbik
{
  ...
  bblk jdField_a_of_type_Bblk;
  private bbll jdField_a_of_type_Bbll = new sfl(this);
  ...
  public sfk(Activity paramActivity, String paramString, bcdb parambcdb)
  {
  ...
  private void j()
  {
    SpannableString localSpannableString = new SpannableString(this.jdField_a_of_type_AndroidAppActivity.getString(2131698545));
    bbcv.a(this.jdField_a_of_type_AndroidAppActivity, ajyc.a(2131708799), localSpannableString, 0, 2131720411, null, null, new sfm(this)).show();
  }
  ...
  public int a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bcdb.a() != null) {
        this.jdField_a_of_type_Bcdb.a().callJs(sfn.c, new String[] { localJSONObject.toString() });
      }
      axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, 0, "1", "", "", "");
      i();
      return 0;
    }
  ...
  {
    axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bcdb.a() != null) {
        this.jdField_a_of_type_Bcdb.a().callJs(sfn.c, new String[] { paramString.toString() });
      }
      axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
    ...
    for (;;)
    {
      try
      {
        if (jdField_a_of_type_Double == this.jdField_b_of_type_Int)
        {
          ...
          paramString.put("msg", ajyc.a(2131708779));
          paramString.put("localId", d());
          if (this.jdField_a_of_type_Bcdb.a() != null) {
            this.jdField_a_of_type_Bcdb.a().callJs(sfn.g, new String[] { paramString.toString() });
          }
          axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2B", "0X8005D2B", 0, 0, "1", "", "", "");
          return;
        }
        if (this.jdField_a_of_type_JavaIoFile.exists())
        {
          paramString.put("retCode", 0);
          paramString.put("msg", ajyc.a(2131708745) + d());
          paramString.put("localId", d());
          axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2A", "0X8005D2A", 0, 0, "1", "", "", "");
          if (this.jdField_a_of_type_Bcdb.a() == null) {
            break;
          }
          this.jdField_a_of_type_Bcdb.a().callJs(sfn.d, new String[] { paramString.toString() });
          return;
        }
      }
      ...
      paramString.put("retCode", -1);
      paramString.put("msg", ajyc.a(2131708805));
      paramString.put("localId", d());
      axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2A", "0X8005D2A", 0, -1, "1", "", "", "");
    }
  }
  ...
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bcdb.a() != null) {
        this.jdField_a_of_type_Bcdb.a().callJs(sfn.c, new String[] { paramString1.toString() });
      }
      axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
  ...
  {
    return ajsf.aW + "c2bPTT/" + paramString + ".amr";
  }
  ...
  public void b()
  {
    ...
    f = ajsf.aW + "c2bPTT/" + ayqm.a() + ".amr";
    bbbr.a(this.jdField_a_of_type_AndroidAppActivity, true);
  ...
  public void b(String paramString)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bblk == null) || (this.jdField_a_of_type_AndroidOsHandler == null) || ((this.jdField_a_of_type_Bblk != null) && (this.jdField_a_of_type_Bblk.a() != 3)))
      {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
        this.jdField_a_of_type_Bblk = new bblk(paramString, this.jdField_a_of_type_AndroidOsHandler);
      }
      this.jdField_a_of_type_Bblk.a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_Bblk.b();
      this.jdField_a_of_type_Bblk.a(this.jdField_a_of_type_Bbll);
      if (this.jdField_a_of_type_Bblk.a() == 1)
      {
        this.jdField_a_of_type_Bblk.c();
        return;
      }
    } while (this.jdField_a_of_type_Bblk.a() != 3);
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Bblk != null) && (this.jdField_a_of_type_Bblk.a() == 2);
  }
  ...
  public void c()
  {
    ...
    d();
    bbbr.a(this.jdField_a_of_type_AndroidAppActivity, false);
  }
  ...
  public void e()
  {
    ...
    {
      localJSONObject.put("retCode", 0);
      localJSONObject.put("msg", ajyc.a(2131708748) + d() + ajyc.a(2131708816));
      localJSONObject.put("localId", d());
      if (this.jdField_a_of_type_Bcdb.a() != null) {
        this.jdField_a_of_type_Bcdb.a().callJs(sfn.f, new String[] { localJSONObject.toString() });
      }
      return;
    }
    catch (JSONException localJSONException)
