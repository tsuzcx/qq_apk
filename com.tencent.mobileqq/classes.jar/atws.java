...
public class atws
{
  ...
  private static void a(atwm paramatwm)
  {
    boolean bool = a(paramatwm.jdField_a_of_type_JavaLangCharSequence);
    if (((paramatwm.jdField_b_of_type_Boolean) && (paramatwm.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramatwm.jdField_c_of_type_Int = 0;
      return;
    }
    paramatwm.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<atwm> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new atwt());
    ...
    atwm localatwm = new atwm();
    localatwm.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localatwm.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localatwm.jdField_e_of_type_Int = 2;
      localatwm.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localatwm.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localatwm.jdField_b_of_type_Boolean = true;
        localatwm.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localatwm.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localatwm.jdField_b_of_type_Boolean = true;
        if (localatwm.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localatwm.jdField_a_of_type_Float = (m * paramFloat);
            localatwm.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localatwm.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localatwm.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localatwm.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localatwm);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localatwm.d = true;
            localatwm.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localatwm.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (atwm)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (atwm)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new atwm();
                ((atwm)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((atwm)localObject2).jdField_c_of_type_Boolean = true;
                ((atwm)localObject2).jdField_b_of_type_Boolean = false;
                ((atwm)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((atwm)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
