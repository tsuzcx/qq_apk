...
public class adzs
{
  private static adzs jdField_a_of_type_Adzs;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = ajed.cM + "icons/";
  private static final String jdField_c_of_type_JavaLangString = ajed.cM + "zip/";
  private static final String jdField_d_of_type_JavaLangString = ajjy.a(2131644065);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new batm(paramString1, new File(jdField_c_of_type_JavaLangString + "android_qim_theme_icons.zip"));
  ...
  {
    if (jdField_a_of_type_Adzs == null) {
      jdField_a_of_type_Adzs = new adzs();
    }
    return jdField_a_of_type_Adzs;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	adzs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	adzs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 143	bace:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	adzs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  public void a(ArrayList<adzt> paramArrayList, ArrayList<int[]> paramArrayList1)
  {
  ...
  {
    if ((!paramBoolean) && ((!(paramObject instanceof adra)) || ((paramObject instanceof adrj)))) {}
    do
    {
      return false;
        ...
        if (localBitmap != null)
        {
          ...
          if (localObject2 == null)
          {
            ...
            if (localBitmap != null)
            {
              ...
              {
                localObject2 = bacm.a(jdField_b_of_type_JavaLangString + "qim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bacm.a(jdField_b_of_type_JavaLangString + "aio_qim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
