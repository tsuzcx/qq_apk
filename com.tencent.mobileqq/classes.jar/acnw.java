  ...
  extends ReportDialog
{
  ...
  public acnw(@NonNull Context paramContext)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_Acow = new acow(new acnx(this), this.jdField_a_of_type_Acoe, true);
    ...
    if (Build.VERSION.SDK_INT >= 19) {
      ((ViewGroup)localObject1).setOnSystemUiVisibilityChangeListener(new acny(this, (ViewGroup)localObject1));
    }
    Object localObject2 = this.jdField_a_of_type_Acow.a(LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity), (ViewGroup)localObject1);
    setContentView((View)localObject2);
    setOnDismissListener(new acnz(this));
    ((ViewGroup)localObject1).getViewTreeObserver().addOnGlobalLayoutListener(new acoa(this, (ViewGroup)localObject1, (View)localObject2));
    this.jdField_a_of_type_AndroidAppApplication$ActivityLifecycleCallbacks = new acob(this);
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    acqy.a("GdtMotiveVideoDialog", "onWindowFocusChanged() called with: hasFocus = [" + paramBoolean + "]");
