...
public class axrj
{
  ...
  private final axrs jdField_a_of_type_Axrs;
  ...
  static
  {
    if (!axrj.class.desiredAssertionStatus()) {}
  ...
  public axrj(DecodeConfig paramDecodeConfig, axrs paramaxrs)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Axrk = a(this.jdField_a_of_type_AndroidMediaMediaExtractor);
      if (this.jdField_a_of_type_Axrk.jdField_a_of_type_Int >= 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("HWAudioRecoder", 1, "audio track normal");
        }
        this.jdField_a_of_type_Axrs.a(1, this.jdField_a_of_type_Axrk.jdField_a_of_type_AndroidMediaMediaFormat);
        this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(this.jdField_a_of_type_Axrk.jdField_a_of_type_Int);
        if (this.jdField_a_of_type_Axrk.jdField_a_of_type_AndroidMediaMediaFormat.containsKey("max-input-size")) {
          this.jdField_a_of_type_Int = this.jdField_a_of_type_Axrk.jdField_a_of_type_AndroidMediaMediaFormat.getInteger("max-input-size");
        }
        if (this.jdField_a_of_type_Axrk.jdField_b_of_type_Int >= 0)
        {
          this.jdField_a_of_type_Axrs.a(2);
          this.jdField_a_of_type_Axrs.a(2, this.jdField_a_of_type_Axrk.jdField_b_of_type_AndroidMediaMediaFormat);
          this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(this.jdField_a_of_type_Axrk.jdField_b_of_type_Int);
          if (this.jdField_a_of_type_Axrk.jdField_b_of_type_AndroidMediaMediaFormat.containsKey("max-input-size"))
          {
            int i = this.jdField_a_of_type_Axrk.jdField_b_of_type_AndroidMediaMediaFormat.getInteger("max-input-size");
      ...
      for (;;)
      {
        ...
        return;
        this.jdField_a_of_type_Axrs.a(0);
        this.jdField_a_of_type_Axrs.a(1, null);
        if (QLog.isColorLevel()) {
  ...
  public axrk a(MediaExtractor paramMediaExtractor)
  {
    axrk localaxrk = new axrk();
    ...
    if (i < j)
    {
      ...
      l1 = l2;
      if (localaxrk.jdField_a_of_type_Int >= 0) {
        break label206;
      }
      l1 = l2;
      ...
      if (l2 == 1L)
      {
        localaxrk.jdField_a_of_type_Int = i;
        localaxrk.jdField_a_of_type_JavaLangString = str;
        localaxrk.jdField_a_of_type_AndroidMediaMediaFormat = localMediaFormat;
        label99:
        l1 = l2;
        if (l2 < 2L) {
          break label206;
    ...
    {
      this.b = bool;
      QLog.d("HWAudioRecoder", 1, new Object[] { "getAudioTrack, ", Integer.valueOf(localaxrk.jdField_a_of_type_Int), " ", Integer.valueOf(localaxrk.jdField_b_of_type_Int) });
      return localaxrk;
      if (l2 != 2L) {
        break label99;
      }
      localaxrk.jdField_b_of_type_Int = i;
      localaxrk.jdField_b_of_type_JavaLangString = str;
      localaxrk.jdField_b_of_type_AndroidMediaMediaFormat = localMediaFormat;
      break label99;
      i += 1;
      l2 = l1;
      break;
  ...
  public boolean b()
  {
    ...
    if (j < 0)
    {
      ...
      this.jdField_a_of_type_Axrs.a(1, this.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
      this.jdField_a_of_type_Axrs.a(2, this.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
      this.c = true;
      this.d = true;
      return true;
    }
    if (j == this.jdField_a_of_type_Axrk.jdField_a_of_type_Int) {
      i = 1;
    }
    int k;
    long l;
    while (j == this.jdField_a_of_type_Axrk.jdField_b_of_type_Int)
    {
      this.jdField_a_of_type_JavaNioByteBuffer.clear();
    ...
    if ((k < 0) || ((this.jdField_a_of_type_Long > 0L) && (l > this.jdField_a_of_type_Long)))
    {
      this.jdField_a_of_type_JavaNioByteBuffer.clear();
      this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.set(0, 0, 0L, 4);
      this.jdField_a_of_type_Axrs.a(i, this.jdField_a_of_type_JavaNioByteBuffer, this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo);
      if (j == this.jdField_a_of_type_Axrk.jdField_a_of_type_Int)
      {
        this.c = true;
        return true;
