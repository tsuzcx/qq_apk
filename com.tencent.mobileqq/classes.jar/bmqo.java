...
{
  private static bmqo jdField_a_of_type_Bmqo;
  ...
  private bkfv jdField_a_of_type_Bkfv = new bkfv(Looper.getMainLooper(), this);
  ...
  private blfq jdField_b_of_type_Blfq;
  private String jdField_b_of_type_JavaLangString;
  private String c;
  
  public static bmqo a()
  {
    if (jdField_a_of_type_Bmqo == null) {
      jdField_a_of_type_Bmqo = new bmqo();
    }
    return jdField_a_of_type_Bmqo;
  }
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Blfq = null;
    this.jdField_a_of_type_AndroidAppActivity = null;
    this.jdField_b_of_type_Blfq = null;
    this.jdField_a_of_type_AndroidContentContext = null;
    b(paramInt);
    String str = anni.a(2131712976);
    if (-4 == paramInt) {
      str = anni.a(2131712971);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  private void a(String paramString, PluginBaseInfo paramPluginBaseInfo)
  {
    ...
    if ((-2 != paramPluginBaseInfo.mState) && (4 != paramPluginBaseInfo.mState) && (!bgnt.g(BaseApplicationImpl.getContext())) && (System.currentTimeMillis() - this.jdField_a_of_type_Long > 5000L))
    {
      a(-4);
      return;
    }
  ...
  private void b()
  {
    if ((this.c != null) && (this.c.compareToIgnoreCase("openActivity") == 0))
    {
      ...
      this.jdField_a_of_type_Bkfv.sendEmptyMessageDelayed(1002, 2000L);
    }
    if ((this.jdField_b_of_type_JavaLangString != null) && (this.jdField_b_of_type_JavaLangString.compareToIgnoreCase("launchService") == 0))
    {
      ...
      if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_b_of_type_Blfq != null))
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader]  launchPluginService:");
        }
        blfh.c(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_Blfq);
        this.jdField_b_of_type_Blfq = null;
        this.jdField_a_of_type_AndroidContentContext = null;
      }
    }
  ...
  public void a(Activity paramActivity, AppRuntime paramAppRuntime, String paramString1, Intent paramIntent, String paramString2, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener, Class<? extends Activity> paramClass)
  {
    ...
    paramAppRuntime = new biau(paramActivity, paramActivity.getResources().getDimensionPixelSize(2131298998));
    if ((!bool) || (paramOnDismissListener != null))
    {
      paramAppRuntime.a(anni.a(2131712969));
      paramAppRuntime.setOnDismissListener(new bmqp(this, paramOnDismissListener));
      if (bool) {
        paramAppRuntime.setOnShowListener(new bmqq(this, paramAppRuntime));
      }
    }
    for (;;)
    {
      paramOnDismissListener = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ((abqn)paramOnDismissListener.a(51)).b();
      paramIntent.putExtra("userQqResources", 2);
      paramIntent.putExtra("useSkinEngine", true);
      paramIntent.putExtra("param_plugin_gesturelock", true);
      this.jdField_a_of_type_Blfq = new blfq(this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Blfq.jdField_b_of_type_JavaLangString = "qqsmartdevice.apk";
      this.jdField_a_of_type_Blfq.d = PluginInfo.e;
      this.jdField_a_of_type_Blfq.jdField_a_of_type_JavaLangString = paramString1;
      this.jdField_a_of_type_Blfq.e = paramString2;
      this.jdField_a_of_type_Blfq.jdField_a_of_type_JavaLangClass = paramClass;
      this.jdField_a_of_type_Blfq.jdField_a_of_type_AndroidContentIntent = paramIntent;
      this.jdField_a_of_type_Blfq.jdField_b_of_type_Int = paramInt;
      this.jdField_a_of_type_Blfq.jdField_a_of_type_AndroidAppDialog = paramAppRuntime;
      this.jdField_a_of_type_Blfq.c = 10000;
      this.jdField_a_of_type_Blfq.f = null;
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: plugin is installed " + this.jdField_a_of_type_Blfq.e);
        }
        if (bool)
        {
          blfh.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Blfq);
          this.jdField_a_of_type_AndroidAppActivity = null;
          this.jdField_a_of_type_Blfq = null;
          return;
        }
        if (this.jdField_a_of_type_Biau == null)
        {
          ...
          this.jdField_a_of_type_Biau.a(anni.a(2131712970));
        }
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: waiting for plugin to install " + this.jdField_a_of_type_Blfq.e);
      }
      this.c = "openActivity";
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getContext(), this);
      return;
  ...
  public void a(AppRuntime paramAppRuntime, ServiceConnection paramServiceConnection)
  {
    ...
    this.jdField_b_of_type_Blfq = new blfq(this.jdField_a_of_type_Int);
    this.jdField_b_of_type_Blfq.jdField_b_of_type_JavaLangString = "qqsmartdevice.apk";
    this.jdField_b_of_type_Blfq.d = PluginInfo.e;
    this.jdField_b_of_type_Blfq.jdField_a_of_type_JavaLangString = paramAppRuntime.getAccount();
    this.jdField_b_of_type_Blfq.e = "com.tencent.device.ipc.QQSmartDeviceService";
    this.jdField_b_of_type_Blfq.jdField_a_of_type_AndroidContentIntent = localIntent;
    this.jdField_b_of_type_Blfq.jdField_a_of_type_AndroidContentServiceConnection = paramServiceConnection;
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      blfh.c(paramAppRuntime.getApplication(), this.jdField_b_of_type_Blfq);
      this.jdField_b_of_type_Blfq = null;
      this.jdField_a_of_type_AndroidContentContext = null;
      return;
    }
  ...
  {
    paramQQAppInterface = (blfh)paramQQAppInterface.getManager(27);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      continue;
      b(0);
      if ((this.jdField_a_of_type_AndroidAppActivity != null) && (this.jdField_a_of_type_Blfq != null))
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader]  launchPluginActivity:" + this.jdField_a_of_type_Blfq.e);
        }
        blfh.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Blfq);
      }
      this.jdField_a_of_type_AndroidAppActivity = null;
      this.jdField_a_of_type_Blfq = null;
      this.jdField_a_of_type_Bkfv.sendEmptyMessageDelayed(1003, 600L);
      continue;
      if (this.jdField_a_of_type_Biau != null)
      {
