...
public class xxk
{
  ...
  {
    yfo.a("1001" + paramString);
    yfo.a("1001" + paramString, new yfx(paramString));
  ...
  private static boolean a(Context paramContext, CertifiedAccountMeta.StFeed paramStFeed, ExtraTypeInfo paramExtraTypeInfo, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        yfo.a("1002" + paramStFeed.id.get());
        yfo.a("1002" + paramStFeed.id.get(), new yfv(paramStFeed));
      }
      if (bool2)
      {
        ...
        paramContext.startActivity(paramIntent, ygg.a());
