...
public class aqcr
  extends aqbc
{
  public aqcr(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  protected void a(bbgg parambbgg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwwardMapOption", 2, "updateImageView:setDefaultDialogPreviewImage");
    }
    a(aqdl.a(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130839352), this.jdField_a_of_type_Float), false, 0);
  }
