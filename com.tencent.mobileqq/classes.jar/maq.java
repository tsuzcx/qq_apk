  ...
  implements lhr
{
  ...
  public maq(VideoLayerUI paramVideoLayerUI) {}
  
  public boolean a(lhq paramlhq, MotionEvent paramMotionEvent)
  {
    boolean bool = b(paramlhq, paramMotionEvent);
  ...
  boolean b(lhq paramlhq, MotionEvent paramMotionEvent)
  {
    boolean bool2 = true;
    boolean bool1;
    if ((paramlhq == null) || (paramMotionEvent == null) || (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvVideoController == null)) {
      bool1 = false;
    }
    label438:
    label459:
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                for (;;)
                {
                  ...
                  {
                    paramlhq = MotionEvent.obtain(paramMotionEvent);
                    paramlhq.setAction(0);
                    VideoLayerUI.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI).a(paramlhq);
                    paramlhq.recycle();
                  }
                  ...
                  i += 1;
                  break label486;
                  paramlhq = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI;
                  if (!VideoLayerUI.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI).a()) {}
                  for (bool1 = true;; bool1 = false)
                  {
                    VideoLayerUI.c(paramlhq, bool1);
                  ...
                  {
                    paramlhq = MotionEvent.obtain(paramMotionEvent);
                    paramlhq.setAction(3);
                    VideoLayerUI.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI).onTouchEvent(paramlhq);
            ...
            bool1 = bool2;
          } while (2 != this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfLtl[0].h());
          bool1 = bool2;
