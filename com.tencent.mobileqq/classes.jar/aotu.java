  ...
  extends aczo
{
  ...
  public aotu(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    int i1 = bcsa.b(paramMessageRecord.msgUid);
    ...
    if ((i2 == 0) || (i2 == 1000) || (i2 == 1004))
    {
      ...
      if (paramMessageRecord.msgtype == -2005)
      {
        ...
        if ((paramMessageRecord != null) && (paramMessageRecord.nOLfileSessionId != 0L))
        {
          ...
          ((msg_svc.PbDelRoamMsgReq.C2CMsg)localObject).msg_random.set(bcsa.b(paramMessageRecord.msgUid));
        }
      }
    }
    for (;;)
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    boolean bool = paramToServiceMsg.extraData.getBoolean(bcrn.h);
    if (QLog.isColorLevel()) {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    boolean bool3 = paramToServiceMsg.extraData.getBoolean(bcrn.h);
  ...
  public static void b(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bdmc.a(BaseApplication.getContext()).a(localAppInterface.getCurrentAccountUin(), "revokeMsgErrorTag", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public ToServiceMsg a(List<MessageRecord> paramList, int paramInt)
  {
    ...
    if ((paramInt == 1) && (!((MessageRecord)localObject1).isSend()) && (!bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        case 1004: 
          for (;;)
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              int i4 = bcsa.b(localMessageRecord.msgUid);
              ...
              for (localObject2 = localMessageRecord.senderuin;; localObject2 = localMessageRecord.selfuin) {
                try
                {
                  ...
                  if (bcrw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, (msg_svc.RoutingHead)localObject2)) {
        ...
        if (localIterator.hasNext())
        {
          ...
          i3 = bcsa.b(localMessageRecord.msgUid);
          ...
          if (i2 == 1)
          {
            ...
            {
              if (!bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
                break label1394;
              }
          ...
          for (i1 = 1;; i1 = 0)
          {
            ...
            break label1176;
            label1394:
            if (!bguq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
              break label1288;
            }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      break;
      if ((!adak.a(paramMessageRecord)) && (adak.g(paramMessageRecord.msgtype)))
      {
        ...
        for (;;)
        {
          ...
          int i2 = bcpt.jdField_a_of_type_Int;
          bcpt.jdField_a_of_type_Int = i2 + 1;
          long l1 = i2;
  ...
  public void a(MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, aear paramaear)
  {
    paramArrayList = aoci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramArrayList, paramaear);
    ...
    {
      a(false, true, true, 0L, new aotv(this, paramMessageRecord, bool, paramArrayList));
      return;
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e())
    {
      if (this.jdField_a_of_type_Asko != null) {
        this.jdField_a_of_type_Asko.a(false);
      }
  ...
  {
    if (this.jdField_a_of_type_Asko != null) {
      this.jdField_a_of_type_Asko.a(true);
    }
