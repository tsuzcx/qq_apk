...
public class bcac
  extends JobSegment<bcaa, bcaa>
{
  private int jdField_a_of_type_Int;
  private WeakReference<XMediaEditor> jdField_a_of_type_JavaLangRefWeakReference;
  private boolean jdField_a_of_type_Boolean;
  
  public bcac(XMediaEditor paramXMediaEditor, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramXMediaEditor);
    this.jdField_a_of_type_Int = paramInt;
  }
  
  protected void a(JobContext paramJobContext, bcaa parambcaa)
  {
    if (QLog.isColorLevel()) {
      QLog.d("GenerateVideoPosterSegment", 2, new Object[] { "GenerateVideoPosterSegment start. info status=", Integer.valueOf(parambcaa.g) });
    }
    String str2 = bbzu.b();
    ...
    for (;;)
    {
      try
      {
        localMediaMetadataRetriever.setDataSource(parambcaa.f);
      ...
      finally
      {
        ...
        catch (RuntimeException parambcaa)
        {
          continue;
        }
      }
      ...
      localObject3 = str1;
      localObject1 = localObject4;
      arrayOfInt = bcar.a(this.jdField_a_of_type_Int, 200, 300, parambcaa.jdField_a_of_type_Int, parambcaa.b);
      localBitmap1 = localBitmap2;
      localObject3 = str1;
      localObject1 = localObject4;
      ...
      else
      {
        ...
        localObject3 = localBitmap2;
        localObject1 = localBitmap2;
        str1 = bduw.a(str2 + "videoThumb_" + System.currentTimeMillis() + ".jpg");
        localBitmap1 = localBitmap2;
        localObject3 = localBitmap2;
        localObject1 = localBitmap2;
        bdda.a(localBitmap2, new File(str1));
        localBitmap1 = localBitmap2;
        localObject3 = localBitmap2;
        localObject1 = localBitmap2;
        parambcaa.c = str1;
        ...
        localObject3 = localBitmap2;
        localObject1 = localBitmap2;
        ThreadManager.getUIHandler().post(new VideoInfo.GenerateVideoPosterSegment.1(this, parambcaa, str1));
        localBitmap1 = localBitmap2;
        localObject3 = localBitmap2;
        localObject1 = localBitmap2;
        if (!isCanceled())
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            localObject3 = localBitmap2;
            localObject1 = localBitmap2;
            QLog.d("GenerateVideoPosterSegment", 2, new Object[] { "GenerateVideoPosterSegment notifyResult. info status=", Integer.valueOf(parambcaa.g) });
          }
          localBitmap1 = localBitmap2;
          localObject3 = localBitmap2;
          localObject1 = localBitmap2;
          notifyResult(parambcaa);
        }
        try
        {
          localMediaMetadataRetriever.release();
