...
public class aijz
  implements ailp, Handler.Callback, View.OnClickListener
{
  private static final String jdField_a_of_type_JavaLangString = anvx.a(2131700772);
  private static final String jdField_b_of_type_JavaLangString = anvx.a(2131700773);
  private int jdField_a_of_type_Int;
  private ailr jdField_a_of_type_Ailr;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bjxa jdField_a_of_type_Bjxa;
  ...
  public aijz(BaseActivity paramBaseActivity, ailr paramailr)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Ailr = paramailr;
    this.jdField_a_of_type_Bjxa = ((bjxa)paramBaseActivity.app.getManager(QQManagerFactory.QIDIAN_MANAGER));
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131558663, null);
    TextView localTextView = (TextView)paramVarArgs.findViewById(2131362520);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramVarArgs.findViewById(2131362519).setOnClickListener(this);
        return paramVarArgs;
      }
  ...
  {
    if ((paramMessage.what == 1) && (this.jdField_a_of_type_Ailr.a() == this)) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009788", "ClickLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bjxa.a(this.f), "8.4.10", "");
      continue;
      ...
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
      this.jdField_a_of_type_Ailr.a();
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009789", "CloseLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bjxa.a(this.f), "8.4.10", "");
    }
  }
}
