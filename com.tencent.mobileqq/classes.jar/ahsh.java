  ...
  implements URLDrawable.URLDrawableListener
{
  ...
  public void onLoadFialed(URLDrawable paramURLDrawable, Throwable paramThrowable)
  {
    ...
    QQToast.a(ahri.b(this.a), ahri.c(this.a).getString(2131694770), 0).a();
    this.a.c(true);
    this.a.a(false);
    this.a.jdField_a_of_type_Ahsh = null;
  }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    this.a.c(false);
    this.a.a(false);
    this.a.jdField_a_of_type_Ahsn.b.b = paramURLDrawable.getExifOrientation();
    this.a.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(paramURLDrawable, ahri.c(this.a).getSelectedItemPosition());
