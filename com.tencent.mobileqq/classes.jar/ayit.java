  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public ayit(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131361928));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131720163);
    Object localObject1;
    ...
    if (a())
    {
      ...
      localObject1 = (LinearLayout)localView.findViewById(2131361931);
      ...
      localObject1 = (TextView)localView.findViewById(2131361927);
      ((TextView)localObject1).setTextColor(-16777216);
      ((TextView)localObject1).setText(2131690596);
      ((TextView)localObject1).setOnClickListener(new ayiu(this));
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bfol == null)
      {
        ...
        View localView = a();
        this.jdField_a_of_type_Bfol.setOnDismissListener(new ayiv(this));
        this.jdField_a_of_type_Bfol.setOnKeyListener(new ayiw(this));
  ...
  public void a(ayix paramayix)
  {
    this.jdField_a_of_type_Ayix = paramayix;
  }
  ...
  protected List<nnc>[] a()
  {
    ...
    ((nnc)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696695);
    ...
    localObject = new nnc();
    ((nnc)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696715);
    ((nnc)localObject).jdField_a_of_type_Int = 2130838758;
    ((nnc)localObject).jdField_b_of_type_Int = 9;
    ((nnc)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new nnc();
    ((nnc)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696698);
    ((nnc)localObject).jdField_a_of_type_Int = 2130838752;
    ((nnc)localObject).jdField_b_of_type_Int = 10;
    ((nnc)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new nnc();
    ((nnc)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696712);
    ...
    localnnc.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696703);
    localnnc.jdField_a_of_type_Int = 2130837570;
    localnnc.jdField_a_of_type_Boolean = true;
    localnnc.jdField_b_of_type_Int = 26;
    ...
    ((ArrayList)localObject).add(localnnc);
    localnnc = new nnc();
    localnnc.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131696693);
  ...
  public void c()
  {
    ...
    {
      this.jdField_a_of_type_Ayix = null;
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      return;
      paramAdapterView = ((nne)paramAdapterView).a;
    } while (this.jdField_a_of_type_Ayix == null);
    this.jdField_a_of_type_Ayix.a(paramAdapterView.jdField_b_of_type_Int);
  }
}
