...
class auiv
  extends QIPCModule
{
  public auiv(auiu paramauiu, String paramString)
  {
    super(paramString);
  }
  ...
  {
    bjko.c("WeiyunDownloadServiceIPC", "onCall action|" + paramString + " params|" + paramBundle + " callbackId|" + paramInt);
    Object localObject;
    ...
    if (paramBundle == null)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        auiu.a = (String)localObject;
      }
      if (!TextUtils.isEmpty(paramString))
      {
        localQQAppInterface = auiu.a(this.a);
        if (localQQAppInterface != null) {
          break label103;
        }
        bjko.c("WeiyunDownloadServiceIPC", "onCall action but appInterface is null");
      }
    }
    label103:
    do
    {
      do
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          bjko.c("WeiyunDownloadServiceIPC", "onCall action but file_id is null");
          return null;
        }
      ...
      localObject = auea.a(paramBundle);
      ...
      auiu.a(this.a).put(paramString, Long.valueOf(((FileManagerEntity)localObject).nSessionId));
      if (auea.b(((FileManagerEntity)localObject).getFilePath()))
      {
        ...
        QIPCServerHelper.getInstance().callClient(auiu.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Suc", paramString, null);
        paramString = new Bundle();
        paramString.putString("taskId", ((FileManagerEntity)localObject).miniAppDownloadId);
        paramString.putInt("retCode", 1);
        paramString.putString("retMsg", "");
        QIPCServerHelper.getInstance().callClient(auiu.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Complete", paramString, null);
        return null;
      }
    ...
    localQQAppInterface.getFileManagerEngine().a(((Long)auiu.a(this.a).get(paramString)).longValue());
    return null;
  }
}
