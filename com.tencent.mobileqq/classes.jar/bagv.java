  ...
  implements aycb
{
  ...
  public void a()
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) && (this.a.jdField_a_of_type_AndroidAppActivity == null) && (!bagr.jdField_a_of_type_JavaLangString.equals(this.a.jdField_b_of_type_JavaLangString))) {}
    String str1;
    List localList;
    do
    {
    ...
    } while ((balg.a(localList)) || (localList == null));
    if (localList != null) {}
    for (;;)
    {
      try
      {
        Object localObject3 = (bahf)localList.remove(0);
        if ((localObject3 instanceof MessageForDeliverGiftTips))
        {
          localObject3 = (MessageForDeliverGiftTips)localObject3;
          String str2 = balg.b((MessageForDeliverGiftTips)localObject3);
          ...
          if (this.a.jdField_a_of_type_Bahg != null) {
            this.a.jdField_a_of_type_Bahg.a(str1, str2);
          }
        }
        if (localList.size() == 0) {
          break label250;
      ...
      break;
      label250:
      this.a.jdField_a_of_type_Bara.a(null);
      bagr.a(this.a, false);
      ...
      if ((bagr.jdField_a_of_type_Boolean) && (localObject2 != null) && (-1 == ((Integer)localObject2).intValue()) && (this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)) {
        bagr.jdField_a_of_type_Boolean = false;
      }
    }
  }
}
