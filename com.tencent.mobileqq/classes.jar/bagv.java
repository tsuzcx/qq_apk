  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131493333, null);
      paramView = new baha(this.a, null);
      paramView.a = ((TextView)paramViewGroup.findViewById(2131302757));
      paramViewGroup.setTag(paramView);
    }
    paramView = (baha)paramViewGroup.getTag();
    int i;
    int j;
    int k;
    int m;
    if (paramView.a != null)
    {
      ...
      paramView.a.setOnClickListener(new bagz(this.a, paramInt));
