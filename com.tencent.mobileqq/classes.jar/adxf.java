...
public abstract class adxf
  extends BaseBubbleBuilder
{
  public adxf(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  private View a(Context paramContext, View paramView, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt, boolean paramBoolean, View.OnClickListener paramOnClickListener)
  {
    ...
    for (;;)
    {
      ...
      localTextView.setId(2131364138);
      if (!TextUtils.isEmpty(paramString2))
      {
        Drawable localDrawable = localResources.getDrawable(2130849346);
        localDrawable.setBounds(0, 0, actn.a(12.0F, localResources), actn.a(12.0F, localResources));
        paramString1 = localResources.getDrawable(2130849347);
        paramString1.setBounds(0, 0, actn.a(12.0F, localResources), actn.a(12.0F, localResources));
        try
        {
        ...
        paramContext.setBounds(0, 0, actn.a(12.0F, localResources), actn.a(12.0F, localResources));
  ...
  public View a(QQAppInterface paramQQAppInterface, BaseChatItemLayout paramBaseChatItemLayout, SessionInfo paramSessionInfo, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener)
  {
    ...
    apyq localapyq = ((FlashChatManager)paramQQAppInterface.getManager(217)).a;
    ...
    do
    {
      ...
      if ((!TextUtils.isEmpty(localapyq.b)) && (bool) && ("1".equals(str))) {
        break;
      }
    } while (localRelativeLayout == null);
    paramBaseChatItemLayout.removeView(localRelativeLayout);
    return paramBaseChatItemLayout;
    axqw.b(paramQQAppInterface, "dc00898", "", "", "0X8008279", "0X8008279", i, 0, "", "", "", "");
    a(paramBaseChatItemLayout, paramMessageRecord, paramOnClickListener, paramSessionInfo, localRelativeLayout, localapyq.b, localapyq.d, -1, true);
    return paramBaseChatItemLayout;
  }
  ...
  protected void a(BaseChatItemLayout paramBaseChatItemLayout, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener, Context paramContext, RelativeLayout paramRelativeLayout, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    if (paramRelativeLayout == null)
    {
      ...
      paramRelativeLayout.setId(2131376564);
    }
    for (int i = 1;; i = 0)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject1).topMargin = actn.a(-2.0F, (Resources)localObject2);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = actn.a(0.0F, (Resources)localObject2);
      ...
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (actn.a(18.0F, (Resources)localObject2) + j);
      ...
      for (;;)
      {
        ...
        return;
        j = ((RelativeLayout.LayoutParams)localObject1).leftMargin;
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (actn.a(9.0F, (Resources)localObject2) + j);
        ((RelativeLayout.LayoutParams)localObject1).addRule(7, 2131364110);
        break;
        label248:
