...
public class ong
{
  private static ong jdField_a_of_type_Ong;
  ...
  private List<onh> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  private String a(onh paramonh, BaseArticleInfo paramBaseArticleInfo, TemplateBean paramTemplateBean, ViewBase paramViewBase)
  {
    if (paramBaseArticleInfo == null) {
      return "";
    }
    if ((TextUtils.isEmpty(paramonh.jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(paramonh.c)) || (TextUtils.isEmpty(paramonh.jdField_a_of_type_JavaLangString))) {
      return "";
    }
    String str3 = paramonh.jdField_a_of_type_JavaLangString;
    String str1 = paramonh.jdField_b_of_type_JavaLangString;
    String str2 = paramonh.c;
  ...
  public static ong a()
  {
    try
    {
      if (jdField_a_of_type_Ong == null) {
        jdField_a_of_type_Ong = new ong();
      }
      ong localong = jdField_a_of_type_Ong;
      return localong;
    }
    finally {}
  }
  
  private onh a(oidb_cmd0x64e.SRTRule paramSRTRule)
  {
    if (paramSRTRule == null) {
      return null;
    }
    onh localonh = new onh(this);
    if (paramSRTRule.uint32_click_number.has()) {
      localonh.jdField_b_of_type_JavaUtilList = paramSRTRule.uint32_click_number.get();
    }
    if (paramSRTRule.uint32_feeds_type.has()) {
      localonh.jdField_a_of_type_JavaUtilList = paramSRTRule.uint32_feeds_type.get();
    }
    if (paramSRTRule.uint32_network_type.has()) {
      localonh.jdField_a_of_type_Int = paramSRTRule.uint32_network_type.get();
    }
    if (paramSRTRule.bytes_app_package_name.has()) {
      localonh.jdField_a_of_type_JavaLangString = paramSRTRule.bytes_app_package_name.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_schema.has()) {
      localonh.c = paramSRTRule.bytes_schema.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_h5.has()) {
      localonh.jdField_b_of_type_JavaLangString = paramSRTRule.bytes_h5.get().toStringUtf8();
    }
    QLog.d("ReadInJoySrtUtils", 1, "convertSRTPbToSRTClassclickNumList = " + localonh.jdField_b_of_type_JavaUtilList + " feedsTypeList= " + localonh.jdField_a_of_type_JavaUtilList + " netWorkType= " + localonh.jdField_a_of_type_Int + " packageName = " + localonh.jdField_a_of_type_JavaLangString + " schemaUrl= " + localonh.c + " h5Url= " + localonh.jdField_b_of_type_JavaLangString);
    return localonh;
  }
  ...
  private oidb_cmd0x64e.SRTRule a(onh paramonh)
  {
    if (paramonh == null) {
      return null;
    }
    ...
    if (paramonh.c != null) {
      localSRTRule.bytes_schema.set(ByteStringMicro.copyFromUtf8(paramonh.c));
    }
    if (paramonh.jdField_b_of_type_JavaLangString != null) {
      localSRTRule.bytes_h5.set(ByteStringMicro.copyFromUtf8(paramonh.jdField_b_of_type_JavaLangString));
    }
    if (paramonh.jdField_a_of_type_JavaLangString != null) {
      localSRTRule.bytes_app_package_name.set(ByteStringMicro.copyFromUtf8(paramonh.jdField_a_of_type_JavaLangString));
    }
    if (paramonh.jdField_b_of_type_JavaUtilList != null) {
      localSRTRule.uint32_click_number.set(paramonh.jdField_b_of_type_JavaUtilList);
    }
    if (paramonh.jdField_a_of_type_JavaUtilList != null) {
      localSRTRule.uint32_feeds_type.set(paramonh.jdField_a_of_type_JavaUtilList);
    }
    localSRTRule.uint32_network_type.set(paramonh.jdField_a_of_type_Int);
    return localSRTRule;
  }
  
  private void a(onh paramonh, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramonh != null)
      {
        ...
        paramonh.uint32_click_number.set(localArrayList1);
        paramonh.uint32_feeds_type.set(localArrayList2);
      }
    ...
    this.jdField_a_of_type_TencentImOidbCmd0x64eOidb_cmd0x64e$SRTClickInfo.msg_hit_srt_rule.set(paramonh);
  }
  
  private boolean a(onh paramonh, int paramInt)
  {
    if (paramonh == null) {}
    int i;
    int j;
    do
    {
      ...
      {
        return false;
      } while ((paramonh.jdField_b_of_type_JavaUtilList == null) || (paramonh.jdField_a_of_type_JavaUtilList == null));
      i = paramonh.jdField_a_of_type_Int;
      j = nar.a(BaseActivity.sTopActivity);
    } while ((j == 0) || ((i == 1) && (j != 1)) || ((i == 2) && (j == 1)) || (!paramonh.jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(paramInt))) || (!paramonh.jdField_b_of_type_JavaUtilList.contains(Integer.valueOf(this.jdField_a_of_type_Int))));
    return true;
  }
  ...
  private void c()
  {
    try
    {
      Object localObject = (String)bhvh.a("readinjoy_srt_click_time_key", "");
      String str1;
      int i;
      ...
      for (;;)
      {
        ...
        bhvh.a("readinjoy_srt_click_time_key", ((JSONObject)localObject).toString());
        return;
  ...
  public void a(List<oidb_cmd0x64e.SRTRule> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        onh localonh = a((oidb_cmd0x64e.SRTRule)localIterator.next());
        if (localonh != null) {
          localArrayList.add(localonh);
        }
      }
  ...
  {
    if ((this.jdField_b_of_type_JavaUtilList == null) || (this.jdField_b_of_type_JavaUtilList.size() == 0) || (paramBaseArticleInfo == null) || ((paramBaseArticleInfo.mChannelID != 0L) && (!oox.c((int)paramBaseArticleInfo.mChannelID)))) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        onh localonh = (onh)this.jdField_b_of_type_JavaUtilList.get(i);
        int j = onk.a(paramBaseArticleInfo);
        QLog.d("ReadInJoySrtUtils", 1, "startJudge feedsType:" + j + " clickTimes: " + this.jdField_a_of_type_Int + " position" + i);
        if (a(localonh, j))
        {
          paramBaseArticleInfo = a(localonh, paramBaseArticleInfo, paramTemplateBean, paramViewBase);
          if (TextUtils.isEmpty(paramBaseArticleInfo)) {
            break;
          }
          this.jdField_a_of_type_JavaLangString = paramBaseArticleInfo;
          a(localonh, j, this.jdField_a_of_type_Int, i);
