...
public class ong
  extends pfh
{
  public ong(ReadInJoyDeliverBiuActivity paramReadInJoyDeliverBiuActivity) {}
  ...
  public void a(int paramInt1, long paramLong, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    if (paramInt1 == 0)
    {
      QQToast.a(this.a, 2, this.a.getString(2131717092), 0).b(this.a.getTitleBarHeight());
  ...
  public void a(long paramLong, int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      paramString = this.a.getString(2131717092);
      if (ReadInJoyDeliverBiuActivity.g(this.a)) {
        paramString = this.a.getString(2131717086);
      }
    ...
    for (;;)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actMultiBiuResult", bool, paramLong, 0L, paramString, "");
