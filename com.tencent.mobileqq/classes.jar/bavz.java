  ...
  implements Manager
{
  ...
  batl jdField_a_of_type_Batl = new bawe(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public bavz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bato = ((bato)paramQQAppInterface.getManager(47));
    paramQQAppInterface = new File(bavy.jdField_a_of_type_JavaLangString + File.separator);
    ...
    for (;;)
    {
      try
      {
        ...
        bace.a(bavy.jdField_a_of_type_JavaLangString + File.separator, new StringBuffer("config.json"), localInputStream);
      }
  ...
  public static VipFullScreenVideoView a(Activity paramActivity, RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    {
      return null;
      localView = paramActivity.getLayoutInflater().inflate(2131497005, null);
      localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
      localLayoutParams.addRule(13);
    } while (paramActivity.isFinishing());
    paramRelativeLayout.addView(localView, 0, localLayoutParams);
    return (VipFullScreenVideoView)localView.findViewById(2131313074);
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, String paramString)
  {
    ...
    paramString = bavy.jdField_a_of_type_JavaLangString + File.separator + paramInt1 + File.separator;
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt, Bundle paramBundle, VipFunCallAndRing.TSourceInfo paramTSourceInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        localObject1 = new File(bavy.jdField_a_of_type_JavaLangString + File.separator + paramInt + File.separator);
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    } while (bace.a(paramString2));
    String str = b(paramAppRuntime, paramInt2, 8, null);
    paramString2 = new Bundle();
    paramString1 = new batm(str, paramString1);
    ((bato)paramAppRuntime.getManager(47)).a(1).a(paramString1, null, paramString2);
  }
  
  public static boolean a()
  {
    return new File(bavy.b).exists();
  }
  
  public static boolean a(Context paramContext, VideoView paramVideoView, String paramString, int paramInt1, bawf parambawf, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramContext.exists()) && (!paramVideoView.isPlaying()))
    {
      ...
      if (paramInt1 == 6)
      {
        paramVideoView.setOnTouchListener(new bawa());
        paramVideoView.setVideoPath(paramContext.getAbsolutePath());
        paramVideoView.requestFocus();
        paramVideoView.setVisibility(0);
        paramVideoView.setOnPreparedListener(new bawb(parambawf));
        paramVideoView.setOnCompletionListener(new bawc(paramVideoView));
        paramVideoView.setOnErrorListener(new bawd(paramInt2, parambawf, paramVideoView, paramBoolean));
        return true;
      }
      if (paramInt1 == 7)
      {
        paramContext = azvq.a(paramString);
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bapm.a("externalStorageType", paramString, i + "_t", l2 + "", bool + "", l2 + "", bool + "_p", "", "", "");
        return bool;
      }
      catch (Exception paramContext)
      {
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    for (int i = 0;; i = paramInt2)
    {
      ...
      if (bool)
      {
        ...
        localObject = new batm(str1, (File)localObject);
        ((batm)localObject).a(3);
        ((batm)localObject).jdField_a_of_type_Int = 0;
        ((batm)localObject).a(localBundle);
        this.jdField_a_of_type_Batl.onDone((batm)localObject);
        return;
        label519:
        bool = false;
        break label298;
      ...
      if (i == 0)
      {
        label530:
        localObject = new batm(str1, (File)localObject);
        ((batm)localObject).jdField_a_of_type_Byte = 1;
        ((batm)localObject).jdField_e_of_type_Long = 5242880L;
        ((batm)localObject).jdField_e_of_type_JavaLangString = jdField_a_of_type_JavaLangString;
      ...
      {
        ((batm)localObject).l = paramBoolean;
        if (7 != paramInt2) {
          ((batm)localObject).b = true;
        }
        this.jdField_a_of_type_Bato.a(1).a((batm)localObject, this.jdField_a_of_type_Batl, localBundle);
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, bats parambats)
  {
    ...
    if (paramInt2 != 0)
    {
      bamr localbamr = (bamr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(45);
      localbamr.jdField_a_of_type_Bats = parambats;
      localbamr.a(paramInt2, 3, paramBoolean, paramInt3, "comering");
    }
    if (i == 6) {
