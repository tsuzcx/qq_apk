...
public class bavz
  extends bawb
{
  public bavz(KDSearchResultFragment paramKDSearchResultFragment, Context paramContext, Activity paramActivity, AppInterface paramAppInterface, TouchWebView paramTouchWebView)
  {
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    KDSearchResultFragment.a(this.a).setText(bbgk.a(paramString));
      ...
      if (i + 1 < localObject1.length)
      {
        if (("p".equals(localObject1[i])) && (!TextUtils.isEmpty(localObject1[(i + 1)]))) {
          try
          {
            ...
            localObject2 = bbgk.a(str);
            if (TextUtils.isEmpty((CharSequence)localObject2)) {
              break label232;
            }
            localObject1 = bjnd.a(str, "searchbox", "native");
