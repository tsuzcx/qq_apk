...
{
  public abnf(BusinessCardEditActivity paramBusinessCardEditActivity) {}
  ...
  public void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    paramString = this.a.getResources().getString(2131437120);
    if (paramInt == 66) {
      paramString = this.a.getResources().getString(2131437121);
    }
