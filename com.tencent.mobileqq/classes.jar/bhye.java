...
public class bhye
{
  ...
  private static bhye jdField_a_of_type_Bhye;
  ...
  public static bhye a()
  {
    if (jdField_a_of_type_Bhye == null) {}
    try
    {
      if (jdField_a_of_type_Bhye == null) {
        jdField_a_of_type_Bhye = new bhye();
      }
      return jdField_a_of_type_Bhye;
    }
    finally {}
  }
  ...
  public void a(bhyj parambhyj)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambhyj.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bhyf(this, parambhyj));
  }
  ...
  public void b(bhyj parambhyj)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambhyj.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bhyg(this, parambhyj));
  }
}
