  ...
  implements yxe
{
  ...
  private GdtMotiveVideoPageData a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt)
  {
    ...
    if ((localGdtAd != null) && (localGdtAd.info != null))
    {
      ...
      yxp.d("GdtOpenMvPageHandler", "VideoUrl " + localGdtMotiveVideoPageData.url);
      ...
      if (localGdtAd.getImageData() == null)
      {
        ...
        if (paramAdInfo != null) {
          localObject1 = yxo.a(paramAdInfo);
        }
  ...
  public void a(GdtMotiveVideoPageData paramGdtMotiveVideoPageData, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramGdtMotiveVideoPageData != null)
    {
      ...
      if (str != null)
      {
        ...
        {
          paramGdtMotiveVideoPageData = (ywk)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramGdtMotiveVideoPageData != null)
          {
  ...
  public boolean a(ywk paramywk, String paramString, String... paramVarArgs)
  {
    ...
    j = 0;
    if (paramywk != null) {}
    for (Object localObject1 = paramywk.a(); (paramywk == null) || (localObject1 == null); localObject1 = null)
    {
      yxp.d("GdtOpenMvPageHandler", "GdtOpenMvPageHandler error");
      return true;
    }
    for (;;)
    {
      ...
      catch (Throwable paramVarArgs)
      {
        try
        {
          ...
          j = k;
          paramVarArgs = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(yxo.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(str)));
          ...
          if (localGdtMotiveVideoPageData != null)
          {
            ...
            GdtMotiveVideoFragment.b(paramywk.a(), GdtMotiveVideoFragment.class, localGdtMotiveVideoPageData);
          }
          if (paramywk == null) {
            break label322;
          }
