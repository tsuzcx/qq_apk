  ...
  implements Handler.Callback
{
  ...
  private static ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, asnr>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bduw.a(aljq.aX + ".hiboom_font/");
  ...
  private asnr b(int paramInt1, int paramInt2, asnq paramasnq)
  {
    paramasnq = new asnr(paramInt1, paramasnq);
    ((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).put(Integer.valueOf(paramInt1), paramasnq);
    return paramasnq;
  }
  
  public asnr a(int paramInt1, int paramInt2, @Nonnull asnq paramasnq)
  {
    try
    {
      ...
      asnr localasnr2 = (asnr)((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).get(Integer.valueOf(paramInt1));
      asnr localasnr1 = localasnr2;
      if (localasnr2 == null) {
        localasnr1 = b(paramInt1, paramInt2, paramasnq);
      }
      return localasnr1;
    }
    finally {}
  ...
  public void a()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        ((asnr)((Map.Entry)localIterator2.next()).getValue()).a(false);
      }
    }
  }
  ...
  public void c()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        i = bdkd.a(bdkd.a(), "libFounderColorFont_818.so");
        if (!QLog.isColorLevel()) {
          break label131;
        }
