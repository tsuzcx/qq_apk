...
public class bgtf
{
  private static volatile bgtf jdField_a_of_type_Bgtf;
  ...
  private CopyOnWriteArrayList<WeakReference<bgte>> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = Long.valueOf(0L);; paramString1 = Long.valueOf(Long.parseLong(paramString1)))
    {
      ...
      paramString1 = new NewIntent(BaseApplicationImpl.getApplication(), bgtd.class);
  ...
  private void a(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bgte localbgte = (bgte)((WeakReference)localObject).get();
      if (localbgte != null)
      {
        localObject = localbgte.getFilterCmds();
        if ((localObject == null) || (((HashSet)localObject).contains(paramString)))
        {
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "notifyListeners cmd=" + paramString + ",ret=" + paramLong + ",listener=" + localbgte);
          }
          localbgte.onCmdRsp(paramIntent, paramString, paramLong, paramJSONObject);
        }
      }
      else
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bati.a() == 1)
        {
          ...
          localJSONObject4 = new JSONObject();
          localJSONObject4.put("status", azyx.a(BaseApplicationImpl.getContext()));
          localJSONObject3.put("screen", localJSONObject4);
          localJSONObject4 = new JSONObject();
          long[] arrayOfLong = babp.b();
  ...
  public void a(bgte parambgte)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "addListener listener=" + parambgte);
    }
    if (parambgte == null) {
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      bgte localbgte = (bgte)((WeakReference)localIterator.next()).get();
      if ((localbgte != null) && (localbgte == parambgte)) {
        return;
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "addListener listener=" + parambgte + " succ");
    }
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(parambgte));
  }
  ...
  public void a(String paramString1, String paramString2, bckt parambckt)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "reportDC05076 appRuntime=" + localAppRuntime + ",oper_id=" + paramString1 + ",operType=" + paramString2 + ",reportInfo=" + parambckt);
    }
    if (parambckt == null) {
      return;
    }
    for (;;)
    {
      ...
      try
      {
        localWadlParams = parambckt.jdField_a_of_type_CooperationWadlIpcWadlParams;
        if (TextUtils.isEmpty(b)) {
          b = String.valueOf(babp.e());
        }
        String str = parambckt.a();
        ...
        localJSONObject3.put("sq_ver", "8.2.6");
        ...
        localJSONObject3.put("apk_volume", String.valueOf(parambckt.jdField_a_of_type_Long));
        int j = mpl.a();
        if (j < 0) {
          break label810;
        }
        ...
        localJSONObject3.put("net_type", ajed.c[i]);
        ...
        localJSONObject3.put("ret_id", String.valueOf(parambckt.jdField_a_of_type_Int));
        if (localWadlParams != null)
        {
          ...
          localJSONObject3.put("ext32", parambckt.jdField_d_of_type_JavaLangString);
          localJSONObject3.put("ext36", parambckt.b());
          localJSONObject3.put("ext37", bckt.jdField_a_of_type_JavaLangString);
          if (localWadlParams != null)
          {
            ...
            if (TextUtils.isEmpty(parambckt.c)) {
              break label788;
            }
            paramString1 = parambckt.c;
          ...
          if (!TextUtils.isEmpty(parambckt.g)) {
            localJSONObject3.put("ext42", parambckt.g);
          }
          if (!TextUtils.isEmpty(parambckt.h)) {
            localJSONObject3.put("ext43", parambckt.h);
          }
      ...
      continue;
      label797:
      awpy.a(null, "dc05076", localJSONObject1.toString());
      return;
      label810:
      int i = 0;
    }
  ...
  public void a(String paramString1, String paramString2, bckt parambckt, String paramString3)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "reportDC appRuntime=" + localAppRuntime + ",dcId=" + paramString3 + ",oper_id=" + paramString1 + ",operType=" + paramString2 + ",reportInfo=" + parambckt);
    }
    if (parambckt == null) {
      return;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if (localWadlParams != null)
        {
          ...
          localJSONObject3.put("ext15", Build.VERSION.RELEASE);
          localJSONObject3.put("ext16", b);
          localJSONObject3.put("ext31", parambckt.b);
          localJSONObject3.put("ext32", parambckt.jdField_d_of_type_JavaLangString);
          localJSONObject3.put("ext36", parambckt.b());
          localJSONObject3.put("ext37", bckt.jdField_a_of_type_JavaLangString);
          if (localWadlParams != null)
  ...
  public void a(String paramString, JSONObject paramJSONObject, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(BaseApplicationImpl.getApplication(), bgtd.class);
  ...
  {
    long l = yez.a("LAST_GET_CONF_VERSION");
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Long == -1L) {
        this.jdField_a_of_type_Long = yez.a("LAST_GET_CONF_TIME");
      }
  ...
  public void b(bgte parambgte)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "removeListener listener=" + parambgte);
    }
    if (parambgte == null) {
      return;
    }
    ...
    do
    {
      ...
      bgte localbgte = (bgte)localWeakReference.get();
      if ((localbgte == null) || (localbgte != parambgte)) {
        break;
      }
      bool = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localWeakReference);
    } while (!QLog.isColorLevel());
    QLog.d(jdField_a_of_type_JavaLangString, 1, "removeListener listener=" + parambgte + " " + bool);
  }
}
