  ...
  extends mbx
{
  ...
  protected void a(int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      bool = lgn.a(this.a.getBaseContext());
      lgo.a(bool);
    } while (!bool);
  ...
  protected void a(long paramLong)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.w("double_2_multi", 2, "onChangeUI_DobuleAudio2MultiAudio, isBackground_Stop[" + this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.isBackground_Stop + "], ActivityState[" + this.a.b() + "], getVideoAbilityLevel[" + this.a.jdField_a_of_type_ComTencentAvVideoController.h() + "], session[" + localley + "], seq[" + paramLong + "]");
      }
      ...
      if ((localley.B) && (this.a.jdField_a_of_type_Mih != null)) {
        this.a.jdField_a_of_type_Mih.c();
      }
      if ((localley.C) || ((this.a.jdField_a_of_type_Mih != null) && (this.a.jdField_a_of_type_Mih.d() != 1)))
      {
        localley.C = false;
        this.a.jdField_a_of_type_Mih.m();
      }
      bool = localley.jdField_g_of_type_Boolean;
      if (localley.i != 11) {
        break;
      }
    ...
    if (this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) {
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.h() != 4) || (!msn.c())) {
        break label586;
      }
    }
    long l2;
    ...
    {
      this.a.a(i, false);
      this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.a(paramLong, localley.jdField_d_of_type_JavaLangString, 1, false, false, false);
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null)
      {
      ...
      this.a.jdField_b_of_type_Int = localley.jdField_d_of_type_Int;
    ...
    label591:
    localley.h = Long.valueOf(localley.jdField_d_of_type_JavaLangString).longValue();
    long l1 = localley.jdField_g_of_type_Long;
    Object localObject2;
    Object localObject1;
    if (localley.jdField_j_of_type_Int == 1)
    {
      ...
      if ((localObject1[i] != l2) && (localObject1[i] != localley.h)) {
        break label786;
      }
    }
    for (;;)
    {
      i += 1;
      break label696;
      if (localley.jdField_j_of_type_Int != 3000) {
        break;
      }
      localley.a = this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(String.valueOf(l1));
      break;
      label772:
      localObject1 = Integer.valueOf(localley.a.length);
      break label657;
      label786:
      ((ArrayList)localObject2).add(Long.valueOf(localley.a[i]));
    }
    label805:
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      int m = mqo.c(localley.F);
      localObject2 = this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getDisplayName(m, String.valueOf(l2), String.valueOf(localley.jdField_g_of_type_Long));
      ...
      if (i > 1) {
        localObject2 = (String)localObject1 + anni.a(2131699669) + i + anni.a(2131699668);
      }
      localObject1 = String.format(this.a.getString(2131695246), new Object[] { localObject2 });
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
    ...
    for (;;)
    {
      ...
      this.a.jdField_d_of_type_JavaLangString = String.valueOf(localley.jdField_g_of_type_Long);
      if (this.a.jdField_a_of_type_Mmj != null) {
        this.a.jdField_a_of_type_Mmj.a();
      }
      QLog.w("double_2_multi", 1, "onChangeUI_DobuleAudio2MultiAudio end, oldSessionType[" + j + "], oldUinType[" + k + "], oldRelationId[" + str + "], mRelationId[" + this.a.jdField_d_of_type_JavaLangString + "], sessionInfo[" + localley + "]");
      return;
      if (QLog.isColorLevel()) {
  ...
  protected void a(long paramLong, ArrayList<lnn> paramArrayList)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) && (paramArrayList != null))
    {
      ...
      Collections.sort(paramArrayList, new maz(this));
      if (QLog.isColorLevel()) {
      ...
      {
        locallnn = (lnn)paramArrayList.get(j);
        str2 = mqu.a(locallnn.jdField_a_of_type_Long);
        m = locallnn.jdField_a_of_type_Int;
        bool2 = locallnn.jdField_a_of_type_Boolean;
        ...
        if (!locallnn.jdField_b_of_type_Boolean) {
          break label1324;
        }
        if (!str2.equals(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin()))
        {
          ...
          if ((locallnn.jdField_b_of_type_Long == 5L) || (locallnn.jdField_b_of_type_Long == 14L))
          {
            ...
            localObject = String.format(this.a.getString(2131694874), new Object[] { localObject });
    ...
    for (;;)
    {
      ...
      {
        AVActivity.a(this.a);
        if ((locallnn.jdField_b_of_type_Boolean) || (locallnn.jdField_a_of_type_Boolean)) {
          break label1151;
        }
        if (k == 4) {
          break label1116;
        ...
        if (this.a.jdField_a_of_type_AndroidGraphicsBitmap == null) {
          this.a.jdField_a_of_type_AndroidGraphicsBitmap = mue.a(this.a.getApplicationContext(), 2130842096);
        }
        this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.a(paramLong, str2, m, this.a.jdField_a_of_type_AndroidGraphicsBitmap, locallnn.jdField_b_of_type_Boolean, locallnn.jdField_a_of_type_Boolean);
      }
      for (;;)
      {
        if ((!bool3) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().J))
        {
          ...
          f1 = mue.a(this.a.getApplicationContext(), f1);
        ...
        break label385;
        label789:
        maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1036, (String)localObject);
        break label520;
        label808:
        localObject = String.format(this.a.getString(2131694875), new Object[] { localObject });
        if (QLog.isColorLevel()) {
        ...
        maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1037, (String)localObject);
        break label520;
        ...
        {
          bcst.b(null, "CliOper", "", "", "0X800594A", "0X800594A", 0, 0, "", "", "", "");
          break label607;
        }
        bcst.b(null, "CliOper", "", "", "0X8004F5C", "0X8004F5C", 0, 0, "", "", "", "");
        break label607;
        label1116:
        this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.a(paramLong, str2, m, this.a.jdField_b_of_type_AndroidGraphicsBitmap, locallnn.jdField_b_of_type_Boolean, locallnn.jdField_a_of_type_Boolean);
        continue;
        label1151:
        this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.a(paramLong, str2, m, this.a.jdField_b_of_type_AndroidGraphicsBitmap, locallnn.jdField_b_of_type_Boolean, locallnn.jdField_a_of_type_Boolean);
      }
  ...
  protected void a(Object paramObject)
  {
    ...
    if (this.a.jdField_d_of_type_Int == 9500) {
      if ((paramObject instanceof lkt))
      {
        paramObject = (lkt)paramObject;
        ...
        if ((this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI instanceof DoubleVideoCtrlUI))
        {
          ...
          ((DoubleVideoCtrlUI)this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI).a(2131373209, true, 2130841973);
        }
      }
    }
    label277:
      ...
      do
      {
        do
        {
          do
          {
              ...
              do
              {
                ...
                for (;;)
                {
                  ...
                  if (((paramObject.jdField_b_of_type_Int & 0x1) == 0) && ((this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI instanceof DoubleVideoCtrlUI)))
                  {
                    ...
                    ((DoubleVideoCtrlUI)this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI).a(2131373209, false, 2130841973);
                  }
                }
            ...
            paramObject = (DoubleVideoCtrlUI)this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI;
            paramObject.a(2131695250, 2, 0, paramObject.a.getDimensionPixelSize(2131298998));
            return;
          ...
          paramObject = (DoubleVideoCtrlUI)this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI;
          paramObject.a(2131695249, 1, 0, paramObject.a.getDimensionPixelSize(2131298998));
          return;
        } while (!(paramObject instanceof lkt));
        paramObject = (lkt)paramObject;
  ...
  protected void a(String paramString, AVFunChat.AVFunChatMessage paramAVFunChatMessage)
  {
    ...
    for (;;)
    {
      ...
      if ((l2 == 14L) && (bool))
      {
        ...
        ((lhz)this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5)).a(3, 14, "SUPPORT_CREATIVECOP_TRUE");
      }
      while (QLog.isColorLevel())
      {
        ...
        for (;;)
        {
          ...
          new mcc(l1, str, false, 4).a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
          break;
          label311:
  ...
  protected void a(String paramString1, String paramString2)
  {
    if (this.a.jdField_a_of_type_Mih != null) {
      this.a.jdField_a_of_type_Mih.a(paramString1, paramString2);
    }
  }
  ...
  protected void a(ArrayList<lnn> paramArrayList)
  {
    if ((this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) && (paramArrayList != null))
    {
      ...
      Collections.sort(paramArrayList, new mba(this));
      int i = 0;
      if (i < paramArrayList.size())
      {
        localObject = (lnn)paramArrayList.get(i);
        String str = mqu.a(((lnn)localObject).jdField_a_of_type_Long);
        ...
        for (;;)
        {
          ...
          bool1 = false;
          break label260;
          if (((lnn)localObject).jdField_a_of_type_Int == 2) {}
          for (j = 1;; j = 0)
          {
            if (j == 0) {
              break label324;
  ...
  protected void a(boolean paramBoolean, long paramLong)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null)
      {
        ...
        if (!paramBoolean) {
          bool = mpu.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, "onRequest_OpenCamera");
        }
        AVActivity.a(this.a);
        ...
        if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_Int == 4) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().J))
        {
          ...
          f = mue.a(this.a.getApplicationContext(), f);
  ...
  protected void b(long paramLong)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("normal_2_meeting", 2, "onChangeUI_Normal2Meeting, cur[" + localley + "]");
    }
    ...
    boolean bool = localley.jdField_g_of_type_Boolean;
    if (localley.i == 16) {
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
        this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI.c(null);
      }
    ...
    do
    {
      ...
      {
        localley.jdField_d_of_type_Int = 1;
        if (QLog.isColorLevel()) {
    ...
    return;
    long l = localley.jdField_g_of_type_Long;
    localley.h = Long.valueOf(localley.jdField_d_of_type_JavaLangString).longValue();
    if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
      this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI.c(null);
    }
    ...
    localley.f("AVActivity.onChangeUI_Normal2Meeting", false);
    this.a.jdField_d_of_type_Int = localley.jdField_j_of_type_Int;
    this.a.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, localley.jdField_d_of_type_Int, false, true);
    if ((localley.jdField_j_of_type_Boolean) || (localley.aG)) {
      this.a.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, localley.jdField_d_of_type_Int, false, false);
    }
    this.a.jdField_d_of_type_JavaLangString = String.valueOf(localley.jdField_g_of_type_Long);
    if (this.a.jdField_a_of_type_Mmj != null) {
      this.a.jdField_a_of_type_Mmj.a();
    }
    QLog.w("normal_2_meeting", 1, "onChangeUI_Normal2Meeting end, oldSessionType[" + i + "], oldUinType[" + j + "], oldRelationId[" + str + "], mRelationId[" + this.a.jdField_d_of_type_JavaLangString + "], sessionInfo[" + localley + "]");
  }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentAvUiFunchatRecordQavRecordButtonView != null) && (this.a.jdField_a_of_type_ComTencentAvUiFunchatRecordQavRecordButtonView.getVisibility() == 0) && (this.a.jdField_a_of_type_Mih != null)) {
  ...
  protected void c()
  {
    ViewGroup localViewGroup = (ViewGroup)this.a.findViewById(2131363079);
    if (localViewGroup != null) {
      lld.a(localViewGroup);
    }
  }
  ...
  protected void c(int paramInt)
  {
    ...
    if ((i == 1) || (i == 3)) {}
    while ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().h()) || ((this.a.jdField_a_of_type_Mbq != null) && (this.a.jdField_a_of_type_Mbq.a())) || (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI == null)) {
      return;
    }
    if ((this.a.jdField_a_of_type_Mbq == null) && ((this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI instanceof DoubleVideoCtrlUI))) {
      this.a.jdField_a_of_type_Mbq = new mbq(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.a, this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI, (RelativeLayout)AVActivity.a(this.a, 2131373224));
    }
    if ((this.a.jdField_a_of_type_Mbq != null) && (this.a.jdField_a_of_type_Mbq.c()))
    {
      this.a.jdField_a_of_type_Mbq.e();
      bcst.b(null, "CliOper", "", "", "0X80061F6", "0X80061F6", 0, 0, "", "", "", "");
      return;
    }
  ...
  {
    if (this.a.jdField_a_of_type_Mih != null) {
      this.a.jdField_a_of_type_Mih.g(paramInt);
    }
  }
  ...
  protected void k()
  {
    maf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1008, 2131694838);
  }
}
