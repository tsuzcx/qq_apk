...
{
  public afol(TroopSuspiciousFragment paramTroopSuspiciousFragment) {}
  
  public void onClick(View paramView)
  {
    paramView = (afnj)paramView.getTag();
    ...
    {
      bcql.a(this.a.a, this.a.getActivity().getString(2131694608), 0).b(this.a.a());
      return;
    }
    ((FriendListHandler)TroopSuspiciousFragment.a(this.a).a(1)).b(String.valueOf(paramView.a.req_uin.get()));
    afoo.a((structmsg.StructMsg)paramView.a.get());
    ...
    if ((str1 == null) || ("".equals(str1)))
    {
      ...
      afoo.a(paramView.a, "unnormal_join");
    }
    for (;;)
    {
      TroopSuspiciousFragment.c(this.a);
      TroopSuspiciousFragment.a(this.a).c(2131719292);
