...
public class ahku
  implements Runnable
{
  public ahku(ReportBadCase paramReportBadCase, BadcaseReportUtils.BadDataFrame paramBadDataFrame) {}
  ...
  public void run()
  {
    ...
    synchronized (ReportBadCase.a())
    {
      ...
      if (i == 3) {
        ThreadManager.postDownLoadTask(new ahkv(this), 5, null, true);
      }
      return;
      str2 = finally;
      throw str2;
