...
public final class bbsa
{
  ...
  public bbsa(cmd0x383.ApplyGetFileListRspBody.FileInfo paramFileInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public bbsa(group_file_common.FolderInfo paramFolderInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public bbsa(oidb_0x6d8.GetFileListRspBody.Item paramItem)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  {
    String str = bdns.b(paramContext, paramLong);
    paramContext = str;
    int i1;
    int i2;
    if (str != null)
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.n == null)
        {
          ...
          if (i1 != 0)
          {
            this.n = bdgc.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
            if (this.n.length() <= 10)
            {
              i1 = i5;
              break label307;
  ...
  public String a()
  {
    return bcnt.a(this.jdField_a_of_type_Long);
  }
  
  public String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    return bdgc.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
  }
  ...
  public void a(bbsa parambbsa)
  {
    if (parambbsa != null)
    {
      if ((parambbsa.jdField_e_of_type_Int != 8) && (parambbsa.jdField_e_of_type_Int != 9)) {
        break label45;
      }
      if (parambbsa.jdField_b_of_type_JavaLangString != null) {
        this.jdField_a_of_type_JavaUtilMap.put(parambbsa.jdField_b_of_type_JavaLangString, parambbsa);
      }
    }
    label45:
    while (((parambbsa.jdField_e_of_type_Int != 11) && (parambbsa.jdField_e_of_type_Int != 10) && (parambbsa.jdField_e_of_type_Int != 12)) || (parambbsa.jdField_b_of_type_JavaLangString == null)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.remove(parambbsa.jdField_b_of_type_JavaLangString);
  }
  
  public void a(bbtn parambbtn, QQAppInterface paramQQAppInterface)
  {
    this.jdField_i_of_type_JavaLangString = parambbtn.jdField_b_of_type_JavaLangString;
    this.j = parambbtn.jdField_c_of_type_JavaLangString;
    this.k = parambbtn.jdField_d_of_type_JavaLangString;
    this.jdField_e_of_type_Int = parambbtn.jdField_b_of_type_Int;
    this.jdField_h_of_type_JavaLangString = parambbtn.jdField_a_of_type_JavaLangString;
    this.jdField_d_of_type_Long = parambbtn.jdField_d_of_type_Long;
    this.jdField_f_of_type_Int = parambbtn.jdField_c_of_type_Int;
    this.jdField_c_of_type_Boolean = parambbtn.jdField_a_of_type_Boolean;
    if (this.jdField_b_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = parambbtn.jdField_d_of_type_Int;
      this.l = a(BaseApplicationImpl.getApplication(), this.jdField_b_of_type_Int * 1000L);
    }
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = parambbtn.jdField_e_of_type_JavaLangString;
    }
    if (this.jdField_f_of_type_JavaLangString == null) {
      this.jdField_f_of_type_JavaLangString = parambbtn.jdField_i_of_type_JavaLangString;
    }
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = parambbtn.jdField_c_of_type_Long;
    }
    if (this.jdField_c_of_type_JavaLangString == null) {
      this.jdField_c_of_type_JavaLangString = parambbtn.jdField_g_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Int == 0) || (bbsb.a(parambbtn.jdField_b_of_type_Int))) {
      this.jdField_a_of_type_Int = parambbtn.jdField_h_of_type_Int;
    }
    if ((this.jdField_b_of_type_Long == 0L) && (bbsb.a(parambbtn.jdField_b_of_type_Int))) {}
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (NumberFormatException parambbtn)
    {
  ...
  {
    return (bcnt.a(paramQQAppInterface, paramLong)) && (this.jdField_d_of_type_Boolean);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    boolean bool2 = bcnt.a(paramQQAppInterface, paramLong);
  ...
  public void b(bbsa parambbsa)
  {
    ...
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = parambbsa.jdField_b_of_type_JavaLangString;
    this.jdField_f_of_type_JavaLangString = parambbsa.jdField_f_of_type_JavaLangString;
    this.jdField_c_of_type_JavaLangString = parambbsa.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Int = parambbsa.jdField_a_of_type_Int;
    this.jdField_b_of_type_Long = parambbsa.jdField_b_of_type_Long;
    this.jdField_c_of_type_Long = parambbsa.jdField_c_of_type_Long;
    this.jdField_a_of_type_Long = parambbsa.jdField_a_of_type_Long;
    this.jdField_b_of_type_Int = parambbsa.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = parambbsa.jdField_c_of_type_Int;
    this.jdField_i_of_type_Int = parambbsa.jdField_i_of_type_Int;
    this.jdField_d_of_type_Int = parambbsa.jdField_d_of_type_Int;
    this.jdField_e_of_type_JavaLangString = parambbsa.jdField_e_of_type_JavaLangString;
    this.jdField_h_of_type_Int = parambbsa.jdField_h_of_type_Int;
    this.jdField_d_of_type_JavaLangString = parambbsa.jdField_d_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = parambbsa.jdField_d_of_type_Boolean;
    this.l = parambbsa.l;
    this.m = parambbsa.m;
  }
  ...
  {
    return (bcnt.a(paramQQAppInterface, paramLong)) && (!this.jdField_d_of_type_Boolean) && (!paramBoolean) && (!bbsb.a(this.jdField_e_of_type_Int)) && (!bbsb.b(this.jdField_e_of_type_Int));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject == null) || (!(paramObject instanceof bbsa))) {
      return false;
    }
    paramObject = (bbsa)paramObject;
