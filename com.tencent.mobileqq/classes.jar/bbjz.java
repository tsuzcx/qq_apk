  ...
  extends bbjq
{
  ...
  protected View a()
  {
    View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562425, null);
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            ((TextView)localObject1).setOnClickListener(new bbka(this));
            if (j == 0) {
            ...
            for (;;)
            {
              ...
              localObject1 = (RelativeLayout)localView.findViewById(2131376024);
              ...
              for (;;)
              {
                localObject1 = (ImageView)localView.findViewById(2131376023);
