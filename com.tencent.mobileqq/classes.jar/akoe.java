...
public class akoe
  extends akon
{
  public akoe(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(long paramLong, akoh paramakoh)
  {
    ArrayList localArrayList = paramakoh.jdField_a_of_type_JavaUtilArrayList;
    int i = 0;
    try
    {
        ...
        if (-56 == ((MsgItem)localObject1).cType)
        {
          ...
          if (PushType.PUSH_TYPE_VOTE_INCR.value() == ((PushCardMsg)localObject2).ePushType)
          {
            ...
            if (((PushVoteIncreaseInfo)localObject1).iIncrement > 0)
            {
              ...
              localObject2 = (ajti)((QQAppInterface)localObject2).a(2);
              if (localObject2 != null) {
                ((ajti)localObject2).a((PushVoteIncreaseInfo)localObject1, String.valueOf(paramLong), String.valueOf(paramakoh.jdField_a_of_type_Long));
              }
            }
          }
        }
    ...
    catch (Exception paramakoh)
    {
      paramakoh.printStackTrace();
    }
  }
  
  private void a(long paramLong, akoh paramakoh, SvcGetMsgInfo paramSvcGetMsgInfo, boolean paramBoolean)
  {
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = paramakoh.jdField_a_of_type_JavaUtilArrayList;
    String str2 = paramakoh.jdField_a_of_type_JavaLangString;
    int m = 0;
    int i = -1000;
    Object localObject3;
    String str1;
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        QLog.w("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp msgItem.MsgContent:" + bbea.a(((MsgItem)localObject3).MsgContent));
        localObject3 = null;
        j = i;
        continue;
        if (paramakoh.jdField_a_of_type_Int != 201) {
          continue;
        }
        localObject2 = bbbu.a((String)localObject3, str2);
        if (j != -2000) {
          continue;
        }
        i = -1032;
        ...
        l1 = l2;
        continue;
        if (paramakoh.jdField_a_of_type_Int != 6) {
          continue;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp accostMsg.eAccostType" + paramakoh.jdField_a_of_type_Int + "accostMsg.msgId: " + paramakoh.jdField_b_of_type_Long + " accostMsg.time" + paramakoh.c + " msgConten: " + bbbr.a((String)localObject3));
        }
        l2 = paramakoh.jdField_a_of_type_Long;
        if (paramakoh.jdField_a_of_type_Int != 1) {
          continue;
        }
        l1 = 9999L;
        i = j;
        localObject1 = localObject3;
        localObject3 = axas.a(i);
        ((MessageRecord)localObject3).init(paramLong, l1, paramakoh.jdField_a_of_type_Long, (String)localObject1, paramakoh.c, i, 1001, 0L);
        ((MessageRecord)localObject3).shmsgseq = paramakoh.jdField_b_of_type_Long;
      ...
      if (((MsgItem)localObject3).MsgContent != null)
      {
        localObject1 = new String(axau.a(((MsgItem)localObject3).MsgContent), "utf-8");
        break label953;
        localObject1 = aywk.a(str1, 0L, 1, false, str1);
        i = -2000;
        continue;
        localObject1 = aywk.a(str1, 0L, 2, false, str1);
        i = -2002;
        continue;
        a(paramLong, paramBoolean, paramakoh);
        return;
        if (localArrayList1.size() <= 0) {
          continue;
        }
        boolean bool = akas.a(localArrayList1);
        i = akpx.a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramakoh = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramakoh.a(localArrayList1, String.valueOf(paramLong), paramBoolean);
  ...
  private void a(long paramLong1, ArrayList<AccostMsg> paramArrayList, ArrayList<akog> paramArrayList1, ArrayList<SvcGetMsgInfo> paramArrayList2, long paramLong2, String paramString)
  {
    int i = 0;
    ...
    {
      Object localObject = new akog();
      ((akog)localObject).jdField_a_of_type_Long = localAccostMsg.lFromMID;
      ((akog)localObject).jdField_b_of_type_Long = localAccostMsg.lToMID;
      ((akog)localObject).c = localAccostMsg.uMsgID;
      ((akog)localObject).jdField_a_of_type_Short = localAccostMsg.shMsgType;
      paramArrayList1.add(localObject);
      boolean bool = a(String.valueOf(paramLong1), String.valueOf(localAccostMsg.lFromMID));
      if (QLog.isColorLevel())
      {
        akas.a("Q.msg.BaseMessageProcessor", paramString, localAccostMsg.uMsgID, String.valueOf(paramLong1), String.valueOf(localAccostMsg.lToMID));
      ...
      {
        a(paramLong1, new akoh(paramLong2, j, localAccostMsg.uMsgID, localAccostMsg.iMsgTime, localArrayList, ((RichMsg)localObject).sAction), localSvcGetMsgInfo, false);
        break;
      }
      return;
    }
  ...
  private void a(long paramLong, boolean paramBoolean, akoh paramakoh)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      int j = 0;
      while (j < paramakoh.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ((StringBuffer)localObject).append(new String(((MsgItem)paramakoh.jdField_a_of_type_JavaUtilArrayList.get(j)).MsgContent));
        if (j < paramakoh.jdField_a_of_type_JavaUtilArrayList.size() - 1) {
    ...
    localSystemMsg.auth = paramakoh.jdField_a_of_type_ArrayOfByte;
    localSystemMsg.lToMobile = paramakoh.e;
    localSystemMsg.strNickName = paramakoh.jdField_b_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, addUin=" + paramakoh.d + ", msgUid=" + paramakoh.jdField_b_of_type_Long + ", msg=" + localSystemMsg.sMsg);
    }
    Object localObject = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(String.valueOf(l));
    label320:
    ...
    if (localObject != null)
    {
      ...
      localObject = bbea.a(((JceOutputStream)localObject).toByteArray());
      if (localObject != null)
      {
        localMessageRecord = axas.a(-1011);
        localMessageRecord.init(paramLong, 9998L, l, (String)localObject, 0L, -1011, 0, paramakoh.c);
        localMessageRecord.shmsgseq = 187L;
        localMessageRecord.msgUid = paramakoh.jdField_b_of_type_Long;
        if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      {
        i = akpx.a(localArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      label599:
      if (QLog.isColorLevel()) {
        QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, the message is remove by msgFilter, addUin=" + paramakoh.d + ", msgUid=" + localMessageRecord.msgUid + ", msg=" + localSystemMsg.sMsg);
      }
    }
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getUin() == null)
    {
      ...
      if (QLog.isColorLevel()) {
        akas.a("Q.msg.BaseMessageProcessor", (String)paramFromServiceMsg.getAttribute("_tag_LOGSTR"), paramObject.stMsg.uMsgID, paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID));
      }
      if (!bool) {
    ...
    for (;;)
    {
      ...
      if ((paramObject.bResend != 1) || (!a(paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID), paramObject.stMsg.uMsgID)))
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.VecMsg != null))
        {
          ...
          localObject = new akoh(paramObject.stMsg.lFromMID, paramObject.stMsg.eAccostType, paramObject.stMsg.uMsgID, paramObject.stMsg.iMsgTime, (ArrayList)localObject, paramFromServiceMsg.sAction);
          if (paramFromServiceMsg.stSender != null)
          {
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "handlePushAccostMsg richMsg.stSender is null");
            }
            ((akoh)localObject).d = paramFromServiceMsg.stSender.lMobileUin;
            ((akoh)localObject).jdField_a_of_type_ArrayOfByte = paramFromServiceMsg.stSender.sig;
            ((akoh)localObject).jdField_b_of_type_JavaLangString = paramFromServiceMsg.stSender.nickname;
          }
          ((akoh)localObject).e = paramObject.stMsg.lFromMID;
          a(Long.valueOf(paramToServiceMsg).longValue(), (akoh)localObject, null, false);
          continue;
          paramFromServiceMsg = a(paramObject.stMsg.strMsg);
          if (paramFromServiceMsg != null)
          {
            paramFromServiceMsg = new akoh(paramObject.stMsg.lFromMID, paramFromServiceMsg.VecMsg);
  ...
  {
    paramString = bdfn.a(paramString);
    ...
    {
      if (str != null) {
        bdkd.a().a(String.valueOf(paramLong), str, paramString, "100", paramBoolean);
      }
      return;
    }
  }
  ...
  {
    paramString1 = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString2);
  ...
  {
    aukp localaukp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory(String.valueOf(paramString1)).createEntityManager();
    paramString1 = localaukp.a(false, MessageRecord.getTableName(paramString2, 1001), null, "msgseq=?", new String[] { String.valueOf(paramLong) }, null, null, null, null);
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = localaukp.a(false, MessageRecord.getTableName(paramString2, 10002), null, "msgseq=?", new String[] { String.valueOf(paramLong) }, null, null, null, null);
        int j = 0;
        if (paramString1 != null) {}
        return false;
      }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    a(false, false, false, 0L, new akof(this, paramArrayOfByte, paramInt));
  }
