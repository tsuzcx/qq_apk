  ...
  extends vhm
{
  ...
  private void b(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EditPicActivity.EditPicPartManager", 2, "reset2Camera begin " + this.jdField_a_of_type_Vix.getActivity() + " new path " + str);
    }
    PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_Vix.a()).edit().putString("edit_pic_new_path", str).commit();
    Intent localIntent;
    if (paramInt == 101)
    {
    ...
    try
    {
      bcql.a(localActivity, ajya.a(2131703691), 0).a();
  ...
  private void w()
  {
    ...
    localvsa.b = vsq.a(2);
    localvsa.jdField_a_of_type_Vse = new vse(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
    localvsa.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064 = new LpReportInfo_pf00064();
    localvsa.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.actionType = 615;
    localvsa.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.subactionType = 8;
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 3)
    {
      ...
      int i = 0;
      while (i < localvsa.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.size())
      {
        ((StringBuilder)localObject).append((String)localvsa.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.get(i) + ",");
        i += 1;
      }
      if (((StringBuilder)localObject).length() > 0) {
        ((StringBuilder)localObject).deleteCharAt(((StringBuilder)localObject).length() - 1);
      }
      localvsa.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves5 = ((StringBuilder)localObject).toString();
      LpReportManager.getInstance().reportToPF00064(localvsa.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064, true, false);
    }
    vej.b("0X80076EA");
    ved.d("EditPicActivity.EditPicPartManager", "PUBLISH start ...");
    this.jdField_a_of_type_Vix.a(ajya.a(2131703690), false, 500L);
    Stream.of(localvsa).map(new vsc((ver)a(ver.class), null)).map(new ThreadOffFunction("EditPicActivity.EditPicPartManager", 2)).map(new vso(vfh.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(new vfk(this, localvsa));
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 1000) && (paramInt2 != -1) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      vyf.b(BaseApplication.getContext(), new File(this.jdField_a_of_type_JavaLangString));
  ...
  void a(Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    default: 
      ...
      this.jdField_a_of_type_Vix.a(-1, null, 2130772028, 0);
    case 101: 
    case 104: 
      do
      {
    ...
    case 5: 
      ...
      paramIntent.putExtra("param_title", paramActivity.getString(2131690514));
      paramIntent.putExtra("param_done_button_wording", paramActivity.getString(2131691035));
  ...
  protected void a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    Object localObject = new vfy(this, paramEditVideoParams.b);
    this.jdField_a_of_type_Vfy = ((vfy)localObject);
    localArrayList.add(localObject);
    localObject = new vga(this, paramEditVideoParams.b);
    ...
    {
      localObject = new vew(this);
      this.jdField_a_of_type_Vew = ((vew)localObject);
      localArrayList.add(localObject);
    }
    a(localArrayList);
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_Vix.getActivity().getIntent();
    ...
    if ((i == 103) && (i == 103))
    {
      ...
      axqy.b(null, "dc00898", "", "", "0X80072C5", "0X80072C5", 0, 0, (String)localObject, "" + j, "", "");
      if (bool) {
        axqy.b(null, "dc00898", "", "", "0X80083B2", "0X80083B2", 0, 0, (String)localObject, "" + j, "", "");
      }
      vej.b("0X80075E8");
    }
    for (;;)
    {
      ...
      break;
      label379:
      axqy.b(null, "dc00898", "", "", "0X80072C4", "0X80072C4", 0, 0, (String)localObject, "" + j, "", "");
    }
  }
  ...
  protected void c()
  {
    ...
    if (i != -1)
    {
      ...
      bbef.a(this.jdField_a_of_type_Vix.a(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
      ...
      if (i == 103)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Vix.a(0, localIntent, 2130772028, 0);
          return;
          localObject = "1";
          break;
          label264:
