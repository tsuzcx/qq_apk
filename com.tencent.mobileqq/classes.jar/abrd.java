...
public class abrd
{
  ...
  private static abrd jdField_a_of_type_Abrd;
  private abre jdField_a_of_type_Abre;
  private SQLiteDatabase jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase;
  
  private abrd(Context paramContext)
  {
    this.jdField_a_of_type_Abre = abre.a(paramContext);
    try
    {
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Abre.getWritableDatabase();
      return;
    }
  ...
  public static abrd a(Context paramContext)
  {
    if (jdField_a_of_type_Abrd == null) {}
    try
    {
      if (jdField_a_of_type_Abrd == null) {
        jdField_a_of_type_Abrd = new abrd(paramContext);
      }
      return jdField_a_of_type_Abrd;
    }
    finally {}
  }
  ...
  private JSONObject a(abra paramabra)
  {
    JSONObject localJSONObject1 = new JSONObject();
    JSONObject localJSONObject2 = new JSONObject();
    JSONArray localJSONArray = new JSONArray();
    localJSONObject2.put("dropDuration", (float)paramabra.b / 1000.0F);
    int i = 0;
    while (i < 6)
    {
      localJSONArray.put(i, paramabra.jdField_a_of_type_ArrayOfLong[i]);
      i += 1;
    }
    localJSONObject2.put("dropTimes", localJSONArray);
    localJSONObject1.put(String.valueOf(paramabra.jdField_a_of_type_Int), localJSONObject2);
    return localJSONObject1;
  }
  
  private JSONObject a(HashMap<String, abra> paramHashMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localJSONObject.put(str, a((abra)paramHashMap.get(str)));
    }
  ...
  private java.util.List<ResultObject> b(boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   4: ifnull +13 -> 17
    //   7: aload_0
    //   8: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   11: invokevirtual 59	android/database/sqlite/SQLiteDatabase:isOpen	()Z
    //   14: ifne +5 -> 19
    //   17: aconst_null
    //   18: areturn
    //   19: bipush 101
    //   21: invokestatic 197	abqr:a	(I)V
    ...
    //   44: if_icmpne +40 -> 84
    //   47: aload_0
    //   48: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   51: ldc 203
    //   53: aconst_null
    //   54: ldc 205
    //   56: aconst_null
    ...
    //   83: areturn
    //   84: aload_0
    //   85: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   88: ldc 203
    //   90: aconst_null
    //   91: aconst_null
    //   92: aconst_null
    ...
    //   518: lload 23
    //   520: lastore
    //   521: invokespecial 273	abra:<init>	(JJ[J)V
    ...
    //   577: aload_0
    //   578: aload 26
    //   580: invokespecial 284	abrd:a	(Ljava/util/HashMap;)Lorg/json/JSONObject;
    ...
    //   677: aconst_null
    //   678: aconst_null
    //   679: invokespecial 316	abrd:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   682: pop
    //   683: aload 25
    //   685: ifnull +10 -> 695
    //   688: aload 25
    ...
    //   701: aconst_null
    //   702: aconst_null
    //   703: invokespecial 316	abrd:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   706: pop
    //   707: aload 25
    //   709: ifnull -14 -> 695
    //   712: aload 25
  ...
  public long a(long paramLong, String paramString, abra paramabra)
  {
    if ((this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase == null) || (!this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen())) {
      return -2L;
    }
    ...
    localContentValues.put("state", Integer.valueOf(paramabra.jdField_a_of_type_Int));
    localContentValues.put("drop_duration", Long.valueOf(paramabra.b));
    localContentValues.put("drop_count", Long.valueOf(paramabra.jdField_a_of_type_Long));
    localContentValues.put("range_0", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[0]));
    localContentValues.put("range_1", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[1]));
    localContentValues.put("range_2_4", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[2]));
    localContentValues.put("range_4_8", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[3]));
    localContentValues.put("range_8_15", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[4]));
    localContentValues.put("range_over_15", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[5]));
    localContentValues.put("status", Integer.valueOf(1));
    if (QLog.isColorLevel()) {
      QLog.d("Magnifier_DBHandler", 2, new Object[] { "insertDropFrame", ",scene = ", paramString, ",duration=", Long.valueOf(paramabra.b), ",range_0=", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[0]), ",range_1_2=", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[1]), ",range_2_4=", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[2]), ",range_4_8=", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[3]), ",range_8_15=", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[4]), ",range_bigegr=", Long.valueOf(paramabra.jdField_a_of_type_ArrayOfLong[5]) });
    }
    try
    {
  ...
  public long a(SparseArray<abql> paramSparseArray)
  {
    if ((this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase == null) || (!this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen())) {
      return -2L;
    }
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        abql localabql = (abql)paramSparseArray.get(k);
        localContentValues.put("plugin", Integer.valueOf(k));
        localContentValues.put("user_sample_ratio", Float.valueOf(localabql.jdField_a_of_type_Float));
        localContentValues.put("threshold", Integer.valueOf(localabql.jdField_a_of_type_Int));
        localContentValues.put("max_report_num", Integer.valueOf(localabql.jdField_b_of_type_Int));
        localContentValues.put("event_sample_ratio", Float.valueOf(localabql.jdField_b_of_type_Float));
        localContentValues.put("stack_depth", Integer.valueOf(localabql.c));
        try
        {
  ...
  /* Error */
  public SparseArray<abql> a()
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    //   2: aload_0
    //   3: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   6: ifnull +13 -> 19
    //   9: aload_0
    //   10: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   24: areturn
    //   25: aload_0
    //   26: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   29: ldc_w 382
    //   32: aconst_null
    //   33: aconst_null
    //   34: aconst_null
    ...
    //   204: invokespecial 469	abql:<init>	(FIIFI)V
    ...
    //   20	3	4	localSparseArray	SparseArray<abql>
  ...
  public java.util.List<ResultObject> a(boolean paramBoolean)
  {
    ...
    //   14: astore 7
    //   16: aload_0
    //   17: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   20: ifnull +13 -> 33
    //   23: aload_0
    //   24: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   38: if_icmpne +64 -> 102
    //   41: aload_0
    //   42: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   45: ldc_w 320
    //   48: aconst_null
    //   49: ldc_w 475
    //   52: iconst_2
    ...
    //   101: areturn
    //   102: aload_0
    //   103: getfield 39	abrd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   106: ldc_w 320
    //   109: aconst_null
    //   110: aconst_null
    //   111: aconst_null
    ...
    //   153: aload_0
    //   154: aload 4
    //   156: invokespecial 477	abrd:a	(Landroid/database/Cursor;)Lcom/tencent/mfsdk/collector/ResultObject;
    //   159: astore 6
    //   161: aload 6
    //   163: ifnull +17 -> 180
    //   166: aload 4
    ...
    //   235: aload_0
    //   236: iload_1
    //   237: invokespecial 479	abrd:b	(Z)Ljava/util/List;
    //   240: astore 4
    //   242: aload 4
    //   244: ifnull +23 -> 267
    //   247: aload 4
