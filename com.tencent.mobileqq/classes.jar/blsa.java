  ...
  implements View.OnClickListener
{
  ...
  public blsa(QQComicTabBarView paramQQComicTabBarView, int paramInt, boolean paramBoolean, List<WebViewTabBarData> paramList)
  {
  ...
  void a(QQComicTabBarView paramQQComicTabBarView)
  {
    ...
    try
    {
      ...
      ((blrp)localObject).dispatchJsEvent("qbrowserTabClick", null, localJSONObject);
