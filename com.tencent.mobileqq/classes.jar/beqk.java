...
public class beqk
  implements Manager
{
  public final SparseArray<beqb> a;
  public QQAppInterface a;
  protected final List<String> a;
  protected final Map<String, beqa> a;
  protected boolean a;
  public final SparseArray<TroopAioKeywordTipInfo> b;
  public final List<String> b;
  protected boolean b;
  
  public beqk(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<Integer> a(MessageRecord arg1)
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      {
        localObject1 = (beqa)this.jdField_a_of_type_JavaUtilMap.get(localObject1);
        if (localObject1 != null)
        {
          localObject1 = ((beqa)localObject1).jdField_a_of_type_JavaUtilList;
          return localObject1;
        }
      }
    }
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo, beqn parambeqn)
  {
    if (parambeqn != null) {
      ThreadManager.getUIHandler().post(new TroopAioKeywordTipManager.5(this, parambeqn, paramMessageRecord, paramTroopAioKeywordTipInfo));
    }
  }
  
  private void a(Integer paramInteger, MessageRecord paramMessageRecord, beqn parambeqn)
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramInteger);
    ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(localArrayList, new beqm(this, paramMessageRecord, parambeqn));
  }
  ...
  private boolean a(Integer paramInteger, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    {
      localObject1 = (beqb)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInteger.intValue());
      if (localObject1 == null) {
        return false;
      }
    }
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      ...
      {
        this.jdField_b_of_type_JavaUtilList.addAll(bepz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      ...
      if ((((beqb)localObject1).b > NetConnInfoCenter.getServerTime()) || (((beqb)localObject1).c < NetConnInfoCenter.getServerTime()))
      {
        if (QLog.isColorLevel()) {
          QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support timelimit, currentTime=" + NetConnInfoCenter.getServerTime() + ",ruleInfo.startTime =" + ((beqb)localObject1).b + ",ruleInfo.endTime=" + ((beqb)localObject1).c);
        }
        return false;
      }
    }
    if ((((beqb)localObject1).d & paramInt) == 0)
    {
      if (QLog.isColorLevel()) {
        QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support positionFlag, ruleInfo.positionFlag=" + ((beqb)localObject1).d + ", curInvokeType=" + paramInt);
      }
      return false;
    }
    if ((((beqb)localObject1).jdField_a_of_type_JavaUtilList != null) && (((beqb)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((beqb)localObject1).jdField_a_of_type_JavaUtilList.contains(Integer.valueOf((int)paramInteger.dwGroupClassExt)))
      {
        if (QLog.isColorLevel())
        {
          paramMessageRecord = new StringBuilder();
          paramMessageRecord.append("[");
          localObject1 = ((beqb)localObject1).jdField_a_of_type_JavaUtilList.iterator();
  ...
  public void a()
  {
    try
    {
      ...
      {
        oidb_0x496.AioKeyword localAioKeyword = bepz.a();
        a(bepz.a(localAioKeyword), bepz.b(localAioKeyword));
      }
      return;
    }
    finally
  ...
  public void a(List<beqa> arg1, List<beqb> paramList1)
  {
    if (??? != null)
    {
      Object localObject2;
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          {
            beqa localbeqa = (beqa)((Iterator)localObject2).next();
            this.jdField_a_of_type_JavaUtilList.add(localbeqa.jdField_a_of_type_JavaLangString.toLowerCase());
          }
        }
      }
      finally {}
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (???.hasNext())
        {
          localObject2 = (beqa)???.next();
          this.jdField_a_of_type_JavaUtilMap.put(((beqa)localObject2).jdField_a_of_type_JavaLangString.toLowerCase(), localObject2);
        }
      }
    }
    if (paramList1 != null) {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        {
          ??? = (beqb)paramList1.next();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(((beqb)???).jdField_a_of_type_Int, ???);
        }
      }
    }
  ...
  public void a(List<MessageRecord> paramList, List<String> paramList1, int paramInt, beqn parambeqn)
  {
    ThreadManager.post(new TroopAioKeywordTipManager.3(this, paramList, paramList1, paramInt, parambeqn), 8, null, true);
  }
