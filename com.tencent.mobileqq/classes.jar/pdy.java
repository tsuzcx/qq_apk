...
public class pdy
{
  public static JSONObject a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.mGalleryPicNumber > 2)
    {
      ...
      ((JSONObject)localObject1).put("gallery_cn_text", paramBaseArticleInfo.mGalleryPicNumber + ajyc.a(2131712967));
    ...
    {
      localObject2 = rap.a(paramBaseArticleInfo.mJsonPictureList, "pictures");
