...
public class oji
  implements ojt
{
  public oji(ReadInJoyPicWaterFallFragment paramReadInJoyPicWaterFallFragment) {}
  
  public BaseArticleInfo a(int paramInt)
  {
    if ((this.a.jdField_a_of_type_Ojw.a.size() > 0) && (paramInt < this.a.jdField_a_of_type_Ojw.a.size())) {
      return (BaseArticleInfo)this.a.jdField_a_of_type_Ojw.a.get(paramInt);
    }
    return null;
  }
  ...
  {
    return this.a.jdField_a_of_type_Ojw.a;
  }
  
  public void a()
  {
    this.a.jdField_a_of_type_Ojw.notifyDataSetChanged();
  }
  
  public void a(BaseArticleInfo paramBaseArticleInfo, int paramInt)
  {
    ReadInJoyPicWaterFallFragment.b(this.a);
    this.a.jdField_a_of_type_Ojw.a.remove(paramBaseArticleInfo);
    this.a.jdField_a_of_type_Ojw.notifyItemRemoved(paramInt);
  }
  
  public void a(List<BaseArticleInfo> paramList)
  {
    this.a.jdField_a_of_type_Ojw.a(paramList);
  }
  
  public void a(Map<Long, pov> paramMap, boolean paramBoolean)
  {
    Map localMap = rvf.a(this.a.a());
    String str = obz.e(this.a.a());
  ...
  public boolean a()
  {
    return this.a.jdField_a_of_type_Ojw.getItemCount() == 0;
  }
  ...
  {
    this.a.jdField_a_of_type_Ojw.a.removeAll(paramList);
  }
  ...
  public void c(List<ChannelCoverInfo> paramList)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewChannelClassificationListView != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        this.a.jdField_a_of_type_JavaUtilArrayList.add(new ojm(localChannelCoverInfo, localChannelCoverInfo.mChannelCoverName, String.valueOf(localChannelCoverInfo.mChannelCoverId)));
      }
      this.a.jdField_a_of_type_Ojw.notifyDataSetChanged();
    }
  }
