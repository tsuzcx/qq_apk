...
class bpwx
{
  ...
  private final Class<? extends bpen> jdField_a_of_type_JavaLangClass;
  private Set<Integer> jdField_a_of_type_JavaUtilSet = new HashSet();
  private final int b;
  private final int c;
  
  private bpwx(int paramInt1, int paramInt2, int paramInt3, Class<? extends bpen> paramClass)
  {
  ...
  static bpwx a(int paramInt1, int paramInt2, int paramInt3, Class<? extends bpen> paramClass)
  {
    return new bpwx(paramInt1, paramInt2, paramInt3, paramClass);
  }
  
  Class<? extends bpen> a()
  {
