...
public abstract class aqbe
  implements DialogInterface.OnDismissListener, aqat, aqau, aqbv
{
  ...
  public long a;
  ajvj jdField_a_of_type_Ajvj = new aqbh(this);
  public Activity a;
  public Context a;
  ...
  public aqbe(Intent paramIntent)
  {
  ...
  private void H()
  {
    ...
    if (this.jdField_a_of_type_Xnw == null) {
      this.jdField_a_of_type_Xnw = new xnw(this.jdField_a_of_type_AndroidAppActivity);
    }
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131719421);
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("app_name");
    Object localObject1 = localObject2;
    if (str != null) {
      localObject1 = (String)localObject2 + str;
    }
    localObject2 = new aqbf(this);
    this.jdField_a_of_type_Xnw.a((String)localObject1, (DialogInterface.OnClickListener)localObject2);
    this.jdField_a_of_type_Xnw.a((DialogInterface.OnClickListener)localObject2);
  ...
  private void K()
  {
    aqdd localaqdd = new aqdd(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Bbgu = localaqdd;
    if (!d()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      localaqdd.b(210);
      localaqdd.a(a());
      localaqdd.setCanceledOnTouchOutside(false);
      localaqdd.a(c(), d(), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(a()), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(b()), a(), b());
      a(localaqdd);
      if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        localaqdd.show();
      }
      this.jdField_a_of_type_Bbgu.setOnDismissListener(this);
      return;
    }
  }
  ...
  private void a(Bundle paramBundle, int paramInt, String paramString)
  {
    ...
    {
      axqy.b(null, "dc00899", str, "", "video_tab", "videoark_share", 0, 0, paramString, paramBundle, "", "");
      return;
      paramBundle = l + "";
      break;
      bool = false;
  ...
  private void a(bbhz parambbhz)
  {
    ...
    String str3 = ajya.a(2131704746);
    Object localObject = str1;
    if (str1.startsWith(str3)) {
      localObject = str1.substring(str3.length());
    }
    localObject = ((String)localObject).trim();
    parambbhz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, str2, i, (String)localObject, bool);
    return;
    if (((List)localObject).size() == 1)
    {
      localObject = (ResultRecord)((List)localObject).get(0);
      parambbhz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, ((ResultRecord)localObject).jdField_a_of_type_JavaLangString, ((ResultRecord)localObject).a(), ((ResultRecord)localObject).jdField_b_of_type_JavaLangString, false);
      return;
    }
    parambbhz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, (List)localObject, true);
  }
  ...
  private void a(MessageForPic paramMessageForPic, String paramString)
  {
    ...
    for (Object localObject = Long.valueOf(paramMessageForPic.uniseq);; localObject = "")
    {
      ...
      if (paramMessageForPic != null)
      {
        ...
        localObject = new Bundle();
        ((Bundle)localObject).putBoolean("extra.EXTRA_NOT_CLEAR_TOP", true);
        a((Bundle)localObject, paramString, aehw.a(paramMessageForPic));
        D();
      }
      return;
    }
  ...
  private void a(String paramString, int paramInt)
  {
    if ((this.jdField_a_of_type_AndroidContentIntent != null) && (("ChatActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))) || ("SplashActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))))) {
      advs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F55", paramString);
    }
    ...
    advs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F56", paramString);
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      axqy.b(null, "dc00899", str, "", "music_tab", "musicark_share", 0, 0, paramString, "", "", "");
      return;
      bool = false;
      break;
      str = "Grp_AIO";
  ...
  private void e()
  {
    if (jdField_a_of_type_Int <= 0)
    {
      ...
      int i = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297280);
      int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297282);
  ...
  public void A()
  {
    ...
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A7EB", "0X800A7EB", i, 0, "", "", String.valueOf(j), str);
  }
  ...
  public void B()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      int m = a(str3, k);
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", str3, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
      if (QLog.isColorLevel())
      {
        ...
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", (String)localObject, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
        if (QLog.isColorLevel()) {
  ...
  public void C()
  {
    ...
    int k = a(i);
    Object localObject1 = "";
    if ((this.jdField_a_of_type_Bbgu instanceof bbhp))
    {
      localObject1 = ((bbhp)this.jdField_a_of_type_Bbgu).getInputValue();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          {
            axqy.b(localQQAppInterface, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
            if (QLog.isColorLevel()) {
            ...
            localObject1 = str1;
            break label230;
            if (!(this.jdField_a_of_type_Bbgu instanceof aqdd)) {
              break;
            }
            localObject1 = ((aqdd)this.jdField_a_of_type_Bbgu).getInputValue();
            break;
          }
        }
      }
      else
      {
        ...
        localObject1 = "1";
        axqy.b((QQAppInterface)localObject2, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
        if (QLog.isColorLevel()) {
  ...
  public void D()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BE9", "0X8009BE9", this.jdField_b_of_type_Int, 0, "", "", "", "");
  }
  
  public void E()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BEA", "0X8009BEA", this.jdField_b_of_type_Int, 0, "", "", "", "");
    C();
  }
  ...
  public void F()
  {
    ...
    do
    {
      ...
      axqy.b(null, "dc00898", "", "", "0X800A27", "0X800A27", 0, 0, "", ForwardUtils.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype")), str, ForwardUtils.b(i));
  ...
  public float a(float paramFloat)
  {
    ...
    int i = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296763);
    float f1 = paramFloat;
    if (i > f2 * paramFloat)
    {
  ...
  protected final DialogInterface.OnClickListener a()
  {
    if (this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new aqbi(this);
    }
  ...
  protected View.OnClickListener a(aqbq paramaqbq)
  {
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    if (this.jdField_a_of_type_AndroidViewView$OnClickListener == null) {
      this.jdField_a_of_type_AndroidViewView$OnClickListener = new aqbl(this, str, paramaqbq);
    }
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!bbbr.a(localRecentUser.uin)) && (localRecentUser.getType() != 1020) && (localRecentUser.getType() != 1008) && (localRecentUser.getType() != 1005) && ((localRecentUser.getType() != 1006) || (a(aqau.jdField_h_of_type_JavaLangInteger))) && (localRecentUser.getType() != 1009) && (localRecentUser.getType() != 1021) && (localRecentUser.getType() != 1001) && (localRecentUser.getType() != 10002) && (localRecentUser.getType() != 10004) && (localRecentUser.getType() != 1022) && (localRecentUser.getType() != 1032) && (localRecentUser.getType() != 1033) && (localRecentUser.getType() != 1034) && (localRecentUser.getType() != 7000) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 1) || (!a(localRecentUser.uin))) && ((localRecentUser.getType() != 0) || (!naz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) && (((localRecentUser.getType() != 1004) && (localRecentUser.getType() != 1000)) || (this.jdField_b_of_type_Boolean))) {
  ...
  public void a(int paramInt)
  {
    if (this.jdField_b_of_type_Bcqf == null) {
      this.jdField_b_of_type_Bcqf = new bcqf(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865));
    }
  ...
  public void a(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    paramDrawable.setBounds(bbef.a(paramDrawable, 36, 100, this.jdField_a_of_type_Float));
  }
  ...
  {
    bgky.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, paramAIOImageProviderService, paramAIORichMediaData, 19001, 4);
  }
  
  protected void a(Bundle paramBundle, String paramString, er paramer)
  {
    ajum localajum = (ajum)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8);
    paramBundle = "";
    if ((this.jdField_a_of_type_Bbgu instanceof bbhp)) {
      paramBundle = ((bbhp)this.jdField_a_of_type_Bbgu).getInputValue();
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(paramBundle))
      {
        ...
        int i = localajum.a().b(paramString, localBundle, paramer);
        if (QLog.isColorLevel()) {
      ...
      return;
      if ((this.jdField_a_of_type_Bbgu instanceof aqdd)) {
        paramBundle = ((aqdd)this.jdField_a_of_type_Bbgu).getInputValue();
      }
    }
  }
  
  public void a(bbgu parambbgu) {}
  ...
  protected final void a(String paramString, bbgu parambbgu)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "addSourceNameView start! sourceName =" + paramString);
    }
    if ((paramString == null) || ("".equals(paramString)) || (parambbgu == null)) {
      return;
    }
    ...
    parambbgu.addView(localTextView);
  }
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    localBundle.putString("uinname", ajya.a(2131704745) + paramString2);
    a(aqau.jdField_d_of_type_JavaLangInteger.intValue(), localBundle);
  }
  ...
  public boolean a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_c_of_type_Boolean) || ((this instanceof aqfq)) || ((this instanceof aqbr)) || (this.jdField_a_of_type_AndroidOsBundle.getInt("cmshow_game_id") > 0));
    ...
    if (paramInt1 == 1) {
      if (((baky)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramString, true).jdField_a_of_type_Boolean)
      {
        bool1 = false;
        bool2 = bool1;
        if (bool1)
        {
          bool2 = bool1;
          if ((this instanceof aqcg))
          {
            paramString = (aqcg)this;
            bool2 = bool1;
  ...
  protected boolean a(Intent paramIntent)
  {
    ...
    if (!bool2)
    {
      ...
      {
        bool1 = bool2;
        if (str.equals(this.jdField_a_of_type_AndroidAppActivity.getString(2131692346))) {
          bool1 = true;
        }
      }
    }
    if (bool1)
    {
      ...
      this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", this.jdField_a_of_type_AndroidAppActivity.getString(2131720034));
  ...
  protected final DialogInterface.OnClickListener b()
  {
    if (this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new aqbj(this);
    }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false))
      {
        ...
        paramInt = localajum.a().a(str, localBundle, localaqbo);
        a(localBundle, str, null);
        label257:
        if ((f()) || (paramInt != 0)) {
          break label359;
        }
        eo.b(this.jdField_a_of_type_AndroidAppActivity, paramInt);
      ...
      for (;;)
      {
        ...
        b(localIntent);
        localBundle.putAll(localIntent.getExtras());
        paramInt = localajum.a().b(str, localBundle, localaqbo);
        a(localBundle, str, null);
        break label257;
        label359:
        break;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (paramBundle != null) {
      a(paramBundle.getInt("key_forward_ability_type", aqau.a.intValue()), paramBundle);
    }
  }
  
  protected void b(String paramString) {}
  
  protected final void b(String paramString, bbgu parambbgu)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "updateImageView: filepath=" + paramString);
    }
    ThreadManager.post(new ForwardBaseOption.8(this, paramString, parambbgu), 8, null, false);
    if (QLog.isColorLevel()) {
  ...
  protected boolean b(String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Bbgu instanceof bbhp))
    {
      str = ((bbhp)this.jdField_a_of_type_Bbgu).getInputValue();
      if (TextUtils.isEmpty(str)) {
        break label270;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (!(this instanceof aqgd)) {
        adgc.a().a((SessionInfo)localObject, str, i);
      }
      return true;
      if (!(this.jdField_a_of_type_Bbgu instanceof aqdd)) {
        break;
      }
      str = ((aqdd)this.jdField_a_of_type_Bbgu).getInputValue();
      break;
      label241:
  ...
  protected final DialogInterface.OnClickListener c()
  {
    if (this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new aqbk(this);
    }
  ...
  public void c()
  {
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "0", "", "", "");
  }
  ...
  protected void c(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajya.a(2131704738));
  ...
  protected void c(String paramString)
  {
    ...
    Object localObject2 = ((yah)localObject1).a(Long.parseLong(paramString));
    ((yah)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, (DeviceInfo)localObject2, false);
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false)) {
  ...
  protected void d(int paramInt)
  {
    ...
    x();
    aqbg localaqbg = new aqbg(this);
    if (this.jdField_a_of_type_Xnz == null) {
      this.jdField_a_of_type_Xnz = new xnz(this.jdField_a_of_type_AndroidAppActivity);
    }
    for (;;)
    {
      String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131690572);
      ...
      this.jdField_a_of_type_Xnz.a((String)localObject, localaqbg);
      this.jdField_a_of_type_Xnz.a(2131692230);
      localObject = this.jdField_a_of_type_Xnz;
      boolean bool;
      if (paramInt == 0)
      {
        bool = true;
        ((xnz)localObject).a(bool);
        this.jdField_a_of_type_Xnz.a(2131719509);
        this.jdField_a_of_type_Xnz.b(0);
        this.jdField_a_of_type_Xnz.c(2131719510);
        this.jdField_a_of_type_Xnz.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131694895), localaqbg);
      }
      try
      {
  ...
  public void d(String paramString)
  {
    ...
    do
    {
      ...
      axqy.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 0, paramString, ForwardUtils.b(i), str, "");
    } while (!QLog.isColorLevel());
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A220", "0X800A220", 0, 0, "0", "", "", "");
    }
    B();
  }
  ...
  public void j()
  {
    if ((this.jdField_a_of_type_Bbgu instanceof bbgl)) {
      ((bbgl)this.jdField_a_of_type_Bbgu).a(0);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Bbgu instanceof bbgl)) {
      ((bbgl)this.jdField_a_of_type_Bbgu).a(1);
    }
  ...
  protected boolean k()
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajvi)localObject).a();
  ...
  public final void l()
  {
    ...
    if (i == 0)
    {
      ...
      if ((i == 27) || (i == 39))
      {
        this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
        this.jdField_a_of_type_Bbgu.setMessage("");
        this.jdField_a_of_type_Bbgu.setNegativeButton(2131690596, b());
        this.jdField_a_of_type_Bbgu.setPositiveButton(2131690745, a());
        this.jdField_a_of_type_Bbgu.show();
      }
    }
    for (;;)
    {
      if ((this.jdField_a_of_type_Bbgu instanceof bbhz)) {
        a((bbhz)this.jdField_a_of_type_Bbgu);
      }
      Object localObject1 = d();
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
        this.jdField_a_of_type_Bbgu.setEditLint((String)localObject1);
      }
      if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("miniAppNeedOnlyPreview", false))
      {
        ((bbgl)this.jdField_a_of_type_Bbgu).a(c());
        ((bbgl)this.jdField_a_of_type_Bbgu).a();
      }
      this.jdField_a_of_type_Bbgu.setOnDismissListener(this);
      this.jdField_a_of_type_Bbgu.adjustTitle();
      b();
      this.jdField_a_of_type_Bbgu.setMsgMaxLineWithEnd(this.jdField_a_of_type_JavaLangString, 3);
      if (a(this.jdField_a_of_type_Bbgu)) {
        b(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Bbgu);
      }
      if (this.jdField_a_of_type_AndroidOsBundle.getInt(jdField_e_of_type_JavaLangString, 0) == 1) {
        this.jdField_a_of_type_Bbgu.setPreviewImageScaleType(true);
      }
      if (this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        break;
      }
      this.jdField_a_of_type_Bbgu.show();
      return;
      this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), d(), a(), b(), a(), b());
      continue;
      if (i == 1)
      {
        m();
        ...
        this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b());
        continue;
      }
      if (i == 2)
      {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject3))) {
          altc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, "AIOArkSdkSelectSend", 1, 0, 0L, 0L, 0L, (String)localObject2, "");
        }
        label690:
        this.jdField_a_of_type_Bbgu.setMessage("");
        this.jdField_a_of_type_Bbgu.setNegativeButton(2131690596, b());
        ...
        this.jdField_a_of_type_Bbgu.show();
        continue;
        this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
        ...
        localObject1 = (bbhp)this.jdField_a_of_type_Bbgu;
        ((bbhp)localObject1).b();
        ((bbhp)localObject1).getEditText().setHint(ajya.a(2131704740));
        continue;
        if (i == 3)
        {
          this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          continue;
        }
        if (i == 4)
        {
          ...
          this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), (String)localObject1, (String)localObject2, (ArrayList)localObject3, null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          continue;
        }
        if (i == 5)
        {
          i = this.jdField_a_of_type_AndroidOsBundle.getInt("key_hiboom_id");
          this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), "", null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          localObject1 = new HiBoomTextView(this.jdField_a_of_type_AndroidAppActivity);
          ((HiBoomTextView)localObject1).setHiBoom(i, 0, aqxj.jdField_a_of_type_Aqxc);
          ((HiBoomTextView)localObject1).setText(this.jdField_a_of_type_JavaLangString);
          ((HiBoomTextView)localObject1).setMaxSize(aqxj.jdField_a_of_type_Int);
          localObject2 = new LinearLayout.LayoutParams(500, 500);
          ((LinearLayout.LayoutParams)localObject2).gravity = 17;
          this.jdField_a_of_type_Bbgu.addView((View)localObject1, (LinearLayout.LayoutParams)localObject2);
          continue;
        }
        this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
      }
  ...
  protected boolean m()
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajxl)localObject).e();
      if (localObject != null)
      {
  ...
  protected boolean o()
  {
    ...
    do
    {
      ...
      {
        bool1 = bool2;
        if (((yah)localObject).a())
        {
          localObject = ((yah)localObject).a();
          bool1 = bool2;
          if (localObject != null)
          {
            bool1 = bool2;
  ...
  protected void q()
  {
    ...
    for (;;)
    {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8009AAE", "0X8009AAE", i, 0, "", "", "", "");
      return;
      label80:
      if (j == 1) {
        i = 2;
  ...
  protected void t()
  {
    this.jdField_a_of_type_Bbgu.setImageOnClickListener(a(new aqbn(this)));
  }
  ...
  protected void v()
  {
    ...
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004047", "0X8004047", 0, 0, "", "", "", "");
  }
