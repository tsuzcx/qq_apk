...
public class rug
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.video." + rug.class.getSimpleName();
  ...
  private static String b()
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 294	java/io/InputStreamReader
    //   5: dup
    //   6: new 296	java/io/FileInputStream
    //   9: dup
    //   10: ldc_w 298
    //   13: invokespecial 301	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   16: ldc_w 303
    //   19: invokespecial 306	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   22: astore 4
    //   24: new 308	java/io/BufferedReader
    //   27: dup
    //   28: aload 4
    //   30: invokespecial 311	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   33: astore 5
    //   35: aload 5
    //   37: invokevirtual 314	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   40: astore_3
    //   41: aload_3
    //   42: ifnonnull +44 -> 86
    //   45: aload_2
    ...
    //   62: ifnull +8 -> 70
    //   65: aload 4
    //   67: invokevirtual 319	java/io/InputStreamReader:close	()V
    //   70: aload_2
    //   71: astore_3
    //   72: aload 5
    //   74: ifnull +10 -> 84
    //   77: aload 5
    //   79: invokevirtual 320	java/io/BufferedReader:close	()V
    //   82: aload_2
    //   83: astore_3
    //   84: aload_3
    //   85: areturn
    //   86: aload_3
    //   87: ldc_w 322
    //   90: invokevirtual 325	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   93: ifeq -58 -> 35
    //   96: aload_3
    //   97: bipush 58
    //   99: invokevirtual 328	java/lang/String:indexOf	(I)I
    //   102: istore_0
    //   103: iload_0
    //   104: iconst_1
    //   105: if_icmple -70 -> 35
    ...
    //   110: iconst_1
    //   111: iadd
    //   112: invokevirtual 332	java/lang/String:substring	(I)Ljava/lang/String;
    //   115: invokevirtual 335	java/lang/String:trim	()Ljava/lang/String;
    //   118: ldc_w 337
    //   121: ldc_w 339
    //   124: invokevirtual 343	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   127: astore_3
    //   128: aload_3
    ...
    //   154: ifnull +8 -> 162
    //   157: aload 4
    //   159: invokevirtual 319	java/io/InputStreamReader:close	()V
    //   162: aload_2
    //   163: ifnull -79 -> 84
    //   166: aload_2
    //   167: invokevirtual 320	java/io/BufferedReader:close	()V
    //   170: ldc_w 316
    //   173: areturn
    //   174: astore_2
    //   175: ldc_w 316
    ...
    //   187: ifnull +8 -> 195
    //   190: aload 4
    //   192: invokevirtual 319	java/io/InputStreamReader:close	()V
    //   195: aload_3
    //   196: ifnull +7 -> 203
    //   199: aload_3
    //   200: invokevirtual 320	java/io/BufferedReader:close	()V
    //   203: aload_2
    //   204: athrow
    //   205: astore_3
    //   206: goto -3 -> 203
  ...
  private static JSONObject b()
  {
    ...
    //   3: dup
    //   4: invokespecial 344	org/json/JSONObject:<init>	()V
    //   7: astore_1
    //   8: aload_1
    //   9: astore_2
    //   10: aload_1
    //   11: ldc_w 346
    //   14: invokestatic 351	com/tencent/mobileqq/utils/DeviceInfoUtil:getIMEI	()Ljava/lang/String;
    //   17: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   20: pop
    //   21: aload_1
    //   22: astore_2
    //   23: aload_1
    //   24: ldc_w 357
    //   27: invokestatic 360	com/tencent/mobileqq/utils/DeviceInfoUtil:getIMSI	()Ljava/lang/String;
    //   30: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   33: pop
    //   34: aload_1
    //   35: astore_2
    //   36: aload_1
    //   37: ldc_w 362
    //   40: invokestatic 366	com/tencent/mobileqq/utils/DeviceInfoUtil:getCpuFrequency	()J
    //   43: invokevirtual 369	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   46: pop
    //   47: aload_1
    //   48: astore_2
    //   49: aload_1
    //   50: ldc_w 371
    //   53: invokestatic 374	com/tencent/mobileqq/utils/DeviceInfoUtil:getCpuNumber	()I
    //   56: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   59: pop
    //   60: aload_1
    //   61: astore_2
    //   62: aload_1
    //   63: ldc_w 379
    //   66: invokestatic 382	com/tencent/mobileqq/utils/DeviceInfoUtil:getOsVersion	()I
    //   69: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   72: pop
    //   73: aload_1
    //   74: astore_2
    //   75: aload_1
    //   76: ldc_w 384
    //   79: invokestatic 387	com/tencent/mobileqq/utils/DeviceInfoUtil:getDeviceModel	()Ljava/lang/String;
    //   82: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   85: pop
    //   86: aload_1
    //   87: astore_2
    //   88: aload_1
    //   89: ldc_w 389
    //   92: invokestatic 392	com/tencent/mobileqq/utils/DeviceInfoUtil:getDeviceOSVersion	()Ljava/lang/String;
    //   95: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   98: pop
    //   99: aload_1
    //   100: astore_2
    //   101: aload_1
    //   102: ldc_w 394
    //   105: invokestatic 397	com/tencent/mobileqq/utils/DeviceInfoUtil:getManufactureInfo	()Ljava/lang/String;
    //   108: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   111: pop
    //   112: aload_1
    //   113: astore_2
    //   114: aload_1
    //   115: ldc_w 399
    //   118: getstatic 404	android/os/Build$VERSION:SDK_INT	I
    //   121: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   124: pop
    //   125: aload_1
    //   126: astore_2
    //   127: aload_1
    //   128: ldc_w 406
    //   131: invokestatic 409	com/tencent/mobileqq/utils/DeviceInfoUtil:getQQVersion	()Ljava/lang/String;
    //   134: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   137: pop
    //   138: aload_1
    //   139: astore_2
    //   140: aload_1
    //   141: ldc_w 411
    //   144: invokestatic 414	com/tencent/mobileqq/utils/DeviceInfoUtil:getSystemTotalMemory	()J
    //   147: invokevirtual 369	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   150: pop
    //   151: aload_1
    //   152: astore_2
    //   153: aload_1
    //   154: ldc_w 416
    //   157: invokestatic 419	com/tencent/mobileqq/utils/DeviceInfoUtil:getSystemAvaialbeMemory	()J
    //   160: invokevirtual 369	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   163: pop
    //   164: aload_1
    //   165: astore_2
    //   166: invokestatic 423	com/tencent/mobileqq/utils/DeviceInfoUtil:getRomMemroy	()[J
    //   169: astore_3
    //   170: aload_1
    //   171: astore_2
    //   172: aload_1
    ...
    //   177: iconst_0
    //   178: laload
    //   179: invokevirtual 369	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   182: pop
    //   183: aload_1
    //   184: astore_2
    //   185: aload_1
    ...
    //   190: iconst_1
    //   191: laload
    //   192: invokevirtual 369	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   195: pop
    //   196: aload_1
    //   197: astore_2
    //   198: aload_1
    //   199: ldc_w 429
    //   202: iconst_1
    //   203: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   206: pop
    //   207: aload_1
    //   208: astore_2
    //   209: invokestatic 431	rug:b	()Ljava/lang/String;
    //   212: astore_3
    //   213: aload_1
    //   214: astore_2
    //   215: aload_1
    //   216: ldc_w 433
    //   219: aload_3
    //   220: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   223: pop
    //   224: aload_1
    //   225: astore_2
    //   226: aload_1
    //   227: ldc_w 435
    //   230: aload_3
    //   231: invokestatic 437	rug:a	(Ljava/lang/String;)Ljava/lang/String;
    //   234: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   237: pop
    //   238: aload_1
    //   239: astore_2
    //   240: getstatic 35	rug:jdField_a_of_type_Int	I
    //   243: iconst_m1
    ...
    //   252: ldc_w 439
    //   255: iload_0
    //   256: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   259: pop
    //   260: aload_1
    //   261: astore_2
    //   262: aload_1
    //   263: ldc_w 441
    //   266: invokestatic 443	rug:a	()F
    //   269: invokestatic 446	java/lang/String:valueOf	(F)Ljava/lang/String;
    //   272: invokevirtual 355	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   275: pop
    //   276: aload_1
    //   277: areturn
    //   278: aload_1
    //   279: astore_2
    //   280: getstatic 35	rug:jdField_a_of_type_Int	I
    //   283: istore_0
    //   284: goto -35 -> 249
    //   287: astore_3
    //   288: aconst_null
    ...
    //   290: aload_1
    //   291: astore_2
    //   292: invokestatic 279	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   295: ifeq +47 -> 342
    //   298: aload_1
    //   299: astore_2
    //   300: getstatic 33	rug:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   303: iconst_2
    ...
    //   317: aload_3
    //   318: invokevirtual 451	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   327: invokestatic 454	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   330: aload_1
    //   331: areturn
    //   332: astore_1
    //   333: aload_2
