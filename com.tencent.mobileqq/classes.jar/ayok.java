  ...
  extends Observable
{
  ...
  public ayok(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new ArrayList());
    this.jdField_a_of_type_AndroidOsHandler = new ayol(this, Looper.getMainLooper());
    this.jdField_a_of_type_Azgl = new ayom(this);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangLong = paramLong;
  }
  
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt, azgl paramazgl)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("muid", MD5.toMD5(babp.a()));
      ((JSONObject)localObject2).put("carrier", babp.e());
      ((JSONObject)localObject2).put("conn", mpl.a());
      ...
      if (paramQQAppInterface != null)
      {
        ...
        new azgk(paramQQAppInterface, "GET", paramazgl, paramInt, null, true).execute(new HashMap[] { localObject2 });
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          {
            localTroopFeedItem.tag = ajjy.a(2131649521);
            ...
            localObject = new ByteArrayInputStream(awwf.a(localTroopNotificationCache.xmlBytes, i));
            localayon = new ayon(this);
            SAXParserFactory.newInstance().newSAXParser().parse((InputStream)localObject, localayon);
            ((InputStream)localObject).close();
            if (localTroopNotificationCache.serviceID == 20)
            {
              localTroopFeedItem.title = localayon.jdField_a_of_type_JavaLangString;
              localTroopFeedItem.content = "";
              localTroopFeedItem.picPath = localayon.jdField_b_of_type_JavaLangString;
              localTroopFeedItem.linkUrl = localayon.jdField_d_of_type_JavaLangString;
          ...
          for (;;)
          {
            localTroopFeedItem.tag = ajjy.a(2131649522);
            localTroopFeedItem.type = 133;
            break;
            localTroopFeedItem.title = localTroopNotificationCache.title;
            localTroopFeedItem.content = localayon.jdField_c_of_type_JavaLangString;
            break label282;
            i = 0;
            break;
            i = 0;
  ...
  public void b(int paramInt)
  {
    ...
    new azgk("http://web.qun.qq.com/cgi-bin/announce/get_t_list", "GET", this.jdField_a_of_type_Azgl, paramInt, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
