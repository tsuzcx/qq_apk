...
{
  adul(Emoticon paramEmoticon, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType == 4)
    {
      ...
      if (adug.a != null)
      {
        ...
        adug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, adug.a.frienduin, "ep_mall", "Clk_pkg_forward", 0);
      }
    }
    label80:
    ...
    adug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, adug.a.frienduin, "ep_mall", "Clk_collect_more", 0);
  }
}
