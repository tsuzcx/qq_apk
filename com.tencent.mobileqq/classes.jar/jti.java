...
{
  public jti(CallbackWaitingActivityExt paramCallbackWaitingActivityExt) {}
    ...
    for (Object localObject = localCallTypeRspParam;; localObject = null)
    {
      if (paramBoolean.booleanValue())
      {
        if (localObject != null)
        {
          ...
          if ((((PstnHandler.CallTypeRspParam)localObject).jdField_b_of_type_Int == 5) && (this.a.jdField_a_of_type_ComTencentAvAppPstnSessionInfo != null) && (CallbackWaitingActivityExt.a(this.a) != null))
          {
            ...
            this.a.jdField_a_of_type_ComTencentAvUiBaseCallbackUI.a.postDelayed(new jtj(this), 30000L);
          }
      ...
      for (;;)
      {
        if (i == 2)
        {
          ...
          DialogUtil.a(this.a, 230, paramBoolean, paramObject, this.a.getString(2131428675), (String)localObject, new jtl(this), new jtm(this)).show();
          return;
        ...
        {
          DialogUtil.b(this.a, 230, "", paramBoolean, 2131428674, 2131428674, null, new jtn(this)).show();
          return;
          i = 1;
        }
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if ((this.a.b != null) && (this.a.jdField_a_of_type_AndroidWidgetButton != null))
    {
      ...
      this.a.a(this.a.jdField_a_of_type_AndroidWidgetButton, false, 2130840151);
