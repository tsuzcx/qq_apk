  ...
  public static String a(long paramLong, boolean paramBoolean)
  {
    ...
    if (i == j + 1)
    {
      ...
      for (localObject = "H点m分";; localObject = "HH:mm")
      {
        ...
        return String.format(anvx.a(2131702350), new Object[] { localObject });
      }
    }
    if (i == j + 2)
    {
      ...
      {
        localObject = new SimpleDateFormat((String)localObject).format(localCalendar.getTime());
        return String.format(anvx.a(2131702351), new Object[] { localObject });
      }
    }
  ...
  public static boolean a()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        try
        {
          bool = TextUtils.isEmpty(DeviceInfoUtil.getIMSI());
          if (bool) {
            continue;
          }
          i = 1;
