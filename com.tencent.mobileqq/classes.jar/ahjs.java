...
public class ahjs
  implements bknm
{
  public ahjs(StructingMsgItemBuilder paramStructingMsgItemBuilder, ChatMessage paramChatMessage, Activity paramActivity, AbsStructMsg paramAbsStructMsg) {}
  ...
  public void a(bknl parambknl)
  {
    ...
    localSubscribeRequest.index.set(parambknl.a);
    long l1 = 0L;
    try
    {
    ...
    localNewIntent.setObserver(new ahjt(this, str));
