  ...
  extends xfp
{
  ...
  {
    paramFromServiceMsg = bfql.a(paramFromServiceMsg.getWupBuffer());
  ...
  {
    paramFromServiceMsg = bfpq.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
  ...
  private byte[] b(ToServiceMsg paramToServiceMsg)
  {
    ...
    return bakc.a(localUniPacket.encode());
  }
  
  private Object c(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    paramFromServiceMsg = bfpo.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          ...
          l3 = l1;
          return new bfql(l3, l2, localInteger.intValue()).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bfpo(l3, l2, str1, localLong).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bfpq(l3, l2, str1).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
