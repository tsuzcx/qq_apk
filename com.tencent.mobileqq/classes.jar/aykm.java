...
public class aykm
  implements ayky
{
  public aykm(NearbyMomentFragment paramNearbyMomentFragment) {}
  
  public void a(boolean paramBoolean1, List<aylx> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (paramBoolean2) {
        NearbyMomentFragment.a(this.a).setText(anvx.a(2131706688));
      }
