...
public class blbc
{
  private static final Singleton<blbc, Void> jdField_a_of_type_CooperationQzoneStatisticSingleton = new blbd();
  public WeakReference<blbe> a;
  ...
  {
    return (blbc)jdField_a_of_type_CooperationQzoneStatisticSingleton.get(null);
  }
  ...
  public void a(long paramLong, int paramInt1, String paramString, int paramInt2, blbe paramblbe)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramblbe);
  ...
  public void a(blah paramblah)
  {
    ...
    {
      QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new GdtGeneralManager.3(this, paramblah));
      return;
    }
    blbf.a(paramblah, this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo);
  ...
  public void a(vac_adv_get.VacAdvRsp paramVacAdvRsp)
  {
    ...
    {
      ((blbe)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a((AlumBasicData)localArrayList.get(0));
