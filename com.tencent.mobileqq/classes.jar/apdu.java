...
public class apdu
{
  static apdu jdField_a_of_type_Apdu;
  private befy jdField_a_of_type_Befy = new apdv(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  apdu(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static apdu a(QQAppInterface paramQQAppInterface)
  {
    jdField_a_of_type_Apdu = new apdu(paramQQAppInterface);
    return jdField_a_of_type_Apdu;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Befy);
