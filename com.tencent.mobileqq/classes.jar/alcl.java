  ...
  implements BusinessObserver
{
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    {
      return;
      List localList = alck.a(this.a).getList();
      localList.clear();
      alck.a(this.a, localList);
      ...
      if (localGetSkinListRsp != null)
      {
        ...
        for (paramInt = 8;; paramInt = 0)
        {
          ...
          alch.c = alck.a(this.a, -1);
          return;
        }
        alck.b(this.a, true);
        alch.c = alck.a(this.a, alck.a(this.a));
        return;
        alch.jdField_a_of_type_Boolean = paramBundle.getBoolean("isCache");
        alck.a(this.a, localGetSkinListRsp.selected_id);
        if (QLog.isColorLevel()) {
          QLog.d("HbSkinLogic", 2, "rsp size = " + localGetSkinListRsp.skin_list.size() + " serverSkinID = " + alck.b(this.a));
        }
        alch.c = localGetSkinListRsp.selected_id;
        if (QLog.isColorLevel()) {
          QLog.d("HbSkinLogic", 2, "select restor: " + alch.c);
        }
        alck.a(this.a).clear();
        paramInt = 0;
        while (paramInt < localGetSkinListRsp.skin_list.size())
        {
          ...
          paramBundle = new alch((SkinInfo)localObject);
          paramBundle.jdField_a_of_type_Int = (paramInt + 1);
          alck.a(this.a).add(paramBundle);
          paramInt += 1;
        }
        if (!TextUtils.isEmpty(localGetSkinListRsp.more_skin_url)) {
          localList.add(alcj.c(localGetSkinListRsp.more_skin_url));
        }
      }
      alch.a(localList);
      alck.a(this.a).notifyDataSetChanged();
      alck.b(this.a, alck.a(this.a));
      return;
