...
public class alcl
{
  private static volatile alcl jdField_a_of_type_Alcl;
  private int jdField_a_of_type_Int = -1;
  
  public static alcl a()
  {
    if (jdField_a_of_type_Alcl == null) {}
    try
    {
      if (jdField_a_of_type_Alcl == null) {
        jdField_a_of_type_Alcl = new alcl();
      }
      return jdField_a_of_type_Alcl;
    }
    finally {}
  }
  ...
  public String a(AppRuntime paramAppRuntime)
  {
    ...
    try
    {
      paramAppRuntime = ((PreloadManager)paramAppRuntime.getManager(QQManagerFactory.PRELOAD_MANAGER)).b("2017112200");
  ...
  public boolean a(AppRuntime paramAppRuntime)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          PreloadManager localPreloadManager = (PreloadManager)paramAppRuntime.getManager(QQManagerFactory.PRELOAD_MANAGER);
  ...
  public boolean c()
  {
    ...
    //   23: aload_0
    //   24: getfield 13	alcl:jdField_a_of_type_Int	I
    //   27: invokevirtual 118	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   30: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   33: invokestatic 122	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   36: aload_0
    //   37: getfield 13	alcl:jdField_a_of_type_Int	I
    //   40: istore_1
    //   41: iload_1
    //   42: iconst_m1
    //   43: if_icmpeq +25 -> 68
    //   46: invokestatic 176	com/qq/wx/voice/embed/recognizer/GrammarNative:destroy	()I
    //   49: ifne +19 -> 68
    //   52: aload_0
    //   53: iconst_m1
    //   54: putfield 13	alcl:jdField_a_of_type_Int	I
    //   57: iconst_1
    //   58: istore_2
    //   59: aload_0
    //   60: monitorexit
    ...
    //   63: astore_3
    //   64: aload_3
    //   65: invokevirtual 177	java/lang/Exception:printStackTrace	()V
    //   68: iconst_0
    //   69: istore_2
    //   70: goto -11 -> 59
    //   73: astore_3
