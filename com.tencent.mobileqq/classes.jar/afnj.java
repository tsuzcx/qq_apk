...
{
  public afnj(NearbyProfileEditTribePanel paramNearbyProfileEditTribePanel) {}
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    paramView.startDrag(new ClipData("", new String[] { "text/plain" }, (ClipData.Item)localObject), new afnw(this.a, paramView), paramView, 0);
