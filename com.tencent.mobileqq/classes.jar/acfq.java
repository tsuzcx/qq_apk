...
public class acfq
  extends MqqHandler
{
  public acfq(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (AssociatedAccountManageActivity.a(this.a) == null) {
        AssociatedAccountManageActivity.a(this.a, new bety(this.a, this.a.getTitleBarHeight()));
      }
