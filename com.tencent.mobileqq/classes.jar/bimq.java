...
public class bimq
  implements bijf
{
  public bimq(DoodleLayout paramDoodleLayout) {}
  
  public void a(int paramInt)
  {
    if (this.a.jdField_a_of_type_Bimt != null) {
      this.a.jdField_a_of_type_Bimt.a(1, paramInt);
    }
  }
  ...
  public boolean a(bijc parambijc)
  {
    boolean bool = false;
    ...
    this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView.a.a(parambijc);
    parambijc.k = true;
    SegmentKeeper localSegmentKeeper = parambijc.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper;
    ...
    if ((parambijc.h == 1) || (parambijc.h == 3)) {
      parambijc.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setCallback(this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView);
    }
