  ...
  extends AccountObserver
{
  ...
  bbyi(Intent paramIntent, String paramString, bbyk parambbyk)
  {
  ...
  public void onRegisterCommitPassRespWithLhSig(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = BaseApplicationImpl.getContext().getString(2131717143);
        ...
        if (QLog.isDevelopLevel()) {
          bbyl.a("LHLoginMng -- onRegisterCommitPassRespWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bbyk != null) {
          this.jdField_a_of_type_Bbyk.a(localIntent, paramBoolean, this.jdField_a_of_type_JavaLangString, paramArrayOfByte3, paramString);
        }
