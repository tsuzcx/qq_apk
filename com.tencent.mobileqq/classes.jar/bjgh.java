...
import dov.com.tencent.mobileqq.richmedia.capture.view.ShareActionSheet.2;
...
public class bjgh
{
  ...
  public bjgh(Context paramContext)
  {
    ...
    this.e = paramContext.getDimensionPixelSize(2131165597);
    this.f = this.e;
    this.g = paramContext.getDimensionPixelOffset(2131165599);
    this.h = paramContext.getDimensionPixelOffset(2131165600);
    this.jdField_a_of_type_Bjgm = new bjgm();
    int i = (paramContext.getDisplayMetrics().widthPixels - (int)(a() * 5.2F)) / (((int)5.2F + 1) * 2);
    b(i);
    a((int)(i * 6 / 5.5F));
  }
  
  private String a(List<bahx> paramList)
  {
    Object localObject = "";
    int i = 0;
    if (i < paramList.size())
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Bjgm.a((RelativeLayout)localView.findViewById(2131296596));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          localObject4 = (GridView)localView.findViewById(2131301556);
          ...
          {
            if (((bahx)((Iterator)localObject5).next()).d != 0) {
              break label885;
            }
            i += 1;
          }
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new bjgj(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          if (k != 0)
          {
            localObject1 = (GridView)localView.findViewById(2131301557);
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new bjgj(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            localObject1 = (TextView)localView.findViewById(2131296376);
            ((TextView)localObject1).setText(2131625035);
            ((TextView)localObject1).setOnClickListener(new bjgi(this));
            if (j == 0) {
