...
public class akux
{
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString1 = bbdx.a(new File(new File(BaseApplicationImpl.getApplication().getFilesDir(), "upgrade_config"), paramString1 + paramString2));
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      bbdx.a(localFile.getAbsolutePath() + "/", paramString1 + paramString2, paramString3);
