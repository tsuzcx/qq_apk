  ...
  implements Comparator<ChatMessage>
{
  ...
  private static axio jdField_a_of_type_Axio;
  public static final String a;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  public int a;
  private bkyb<Integer> jdField_a_of_type_Bkyb;
  ...
  {
    if (jdField_a_of_type_Axio == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Axio == null) {
        jdField_a_of_type_Axio = new axio();
      }
      return jdField_a_of_type_Axio;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      FileUtils.copyResToFile(paramQQAppInterface.getApp(), 2130841532, jdField_a_of_type_JavaLangString);
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    //   42: aload_0
    //   43: getfield 163	axio:jdField_a_of_type_Bkyb	Lbkyb;
    //   46: ifnull +40 -> 86
    //   49: aload_0
    //   50: getfield 163	axio:jdField_a_of_type_Bkyb	Lbkyb;
    //   53: lload_1
    //   54: iconst_0
    //   55: invokestatic 169	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   58: invokevirtual 174	bkyb:a	(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    //   71: ifeq +18 -> 89
    //   74: aload_0
    //   75: getfield 163	axio:jdField_a_of_type_Bkyb	Lbkyb;
    //   78: lload_1
    //   79: iload_3
    //   80: invokestatic 169	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   83: invokevirtual 181	bkyb:a	(JLjava/lang/Object;)V
    //   86: aload_0
    //   87: monitorexit
    //   88: return
    //   89: aload_0
    //   90: getfield 163	axio:jdField_a_of_type_Bkyb	Lbkyb;
    //   93: lload_1
    //   94: invokevirtual 184	bkyb:b	(J)V
    //   97: goto -11 -> 86
    //   100: astore 4
    //   102: aload_0
    //   103: monitorexit
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, int paramInt2, @Nullable Bundle paramBundle)
  {
    ...
    for (int k = a(paramBundle.getInt("ReceiptMsgManager.EXTRA_KEY_PTT_SEND_SOURCE"));; k = 0)
    {
      ...
      localTransferRequest.mUpCallBack = new axit(paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramInt2, this, null);
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, anyz paramanyz, ArrayList<MessageRecord> paramArrayList, boolean paramBoolean, int paramInt2)
  {
    ...
    paramanyz = paramQQAppInterface.getProxyManager().a().a(paramArrayList, paramHashMap, paramBoolean);
    if (paramanyz == null)
    {
    ...
    do
    {
      ...
      if (paramInt2 == 0) {
        paramHashMap = new axis(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
      }
      for (;;)
      {
        if (a(paramQQAppInterface, paramanyz, paramQQAppInterface.getCurrentAccountUin(), paramString, paramString, paramInt1, paramMessageRecord.uniseq, 1035, paramHashMap))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (paramInt2 == 2)
          {
            paramHashMap = new axir(paramQQAppInterface, paramMessageRecord, paramString, paramInt1, paramArrayList, paramHashMap);
          }
          else if (paramInt2 == 5)
          {
            paramHashMap = new bbbd(paramQQAppInterface, paramMessageRecord, paramString, paramInt1);
          }
          else
          {
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<azjz> paramArrayList1, int paramInt2)
  {
    azke localazke = azjv.a(8, 7);
    localazke.a(paramArrayList1);
    localazke.a(new axip(this, paramInt2, paramMessageRecord, paramArrayList, paramQQAppInterface, paramString, paramInt1, paramHashMap));
    azjv.a(localazke, paramQQAppInterface);
  }
  
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, ArrayList<MessageRecord> paramArrayList, ArrayList<bcxd> paramArrayList1, bcxr parambcxr, int paramInt2)
  {
    ...
    localbcxr.a(new axiq(this, paramArrayList, paramMessageRecord, paramQQAppInterface, paramString, paramInt1, paramHashMap, paramInt2));
  ...
  private boolean a(long paramLong)
  {
    for (;;)
    {
      try
      {
        ...
        boolean bool1;
        if (((Integer)this.jdField_a_of_type_Bkyb.a(paramLong, Integer.valueOf(0))).intValue() == 0)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  {
    return a(paramQQAppInterface, paramArrayOfByte, paramString1, paramString2, paramString3, paramInt1, paramLong, paramInt2, false, paramazla);
  }
  
  private boolean a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, String paramString1, String paramString2, String paramString3, int paramInt1, long paramLong, int paramInt2, boolean paramBoolean, azla paramazla)
  {
    if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    ...
    {
      if (this.jdField_a_of_type_Bkyb == null) {
        this.jdField_a_of_type_Bkyb = new bkyb();
      }
      return;
    }
    finally
  ...
  private boolean b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, String paramString1, String paramString2, String paramString3, int paramInt1, long paramLong, int paramInt2, azla paramazla)
  {
    return a(paramQQAppInterface, paramArrayOfByte, paramString1, paramString2, paramString3, paramInt1, paramLong, paramInt2, true, paramazla);
  }
  ...
  public MessageForStructing a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, AbsStructMsg paramAbsStructMsg)
  {
    ...
    paramQQAppInterface = bcsa.a(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, 0L, paramAbsStructMsg);
  ...
  public List<ChatMessage> a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramString != null) {
      acnh.a(paramString, paramInt, (List)localObject, paramQQAppInterface);
    }
    ...
    while (paramString.hasNext())
    {
      ...
      if ((localObject instanceof MessageForStructing))
      {
        ...
        if (localMessageForStructing.structingMsg == null) {
          localMessageForStructing.structingMsg = bdof.a(((MessageRecord)localObject).msgData);
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      k = bhhr.a(paramQQAppInterface.getCurrentUin(), "multimsg_config");
      if (k > 0) {
    ...
    catch (NumberFormatException paramQQAppInterface)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramQQAppInterface))
        {
          ...
          if (DeviceProfileManager.a(paramQQAppInterface, (Object[])localObject, new antj()) >= localObject.length)
          {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    ((bbob)paramQQAppInterface.getManager(QQManagerFactory.MEDIA_MSG_ORDER_SEND_MANAGER)).a(paramSessionInfo.curFriendUin, paramArrayList);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, azla paramazla)
  {
    paramString2 = new ArrayList(awcw.a().a());
    Iterator localIterator = paramString2.iterator();
    while (localIterator.hasNext())
    {
      MessageRecord localMessageRecord = (MessageRecord)localIterator.next();
      if (((localMessageRecord instanceof axcu)) && ((localMessageRecord instanceof MessageForRichText))) {
        ((MessageForRichText)localMessageRecord).richText = ((axcu)localMessageRecord).getRichText();
      }
    }
    b(paramQQAppInterface, paramQQAppInterface.getProxyManager().a().a(paramString2, null, true), paramQQAppInterface.getCurrentAccountUin(), paramString1, paramString1, paramInt, 0L, 1035, paramazla);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, String paramString2, AbsStructMsg paramAbsStructMsg, long paramLong, boolean paramBoolean, int paramInt2, int paramInt3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      break;
      if (k != 0) {
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X800662C", "0X800662C", 0, 1, 0, "", "", "", "");
      }
      ...
      new aijb().a(paramQQAppInterface, paramString1, (ArrayList)localObject2, paramInt2);
      if (paramInt2 == 1)
      {
      ...
      if (paramInt2 == 2)
      {
        ...
        paramBundle = bcsa.a(paramQQAppInterface, paramBundle, paramString1, paramBundle, 1040, k, paramAbsStructMsg);
        paramBundle.msg = admh.a((List)localObject2, (Map)localObject1);
      }
      for (;;)
      {
        ...
        if (paramBundle == null)
        {
          ...
          localObject3 = bhhn.a(paramQQAppInterface, paramString1, paramInt1, paramAbsStructMsg);
        }
        if (localObject3 == null) {
          break;
        }
        ((MessageRecord)localObject3).isReMultiMsg = true;
        agfe.a().a(((MessageRecord)localObject3).uniseq, 0L, paramInt3);
        if (paramBoolean) {
        ...
        for (;;)
        {
          ...
          while (((Iterator)localObject4).hasNext())
          {
            ...
            if (!((HashMap)localObject3).containsKey(localMessageRecord.senderuin))
            {
              ...
              {
                localObject1 = axiv.a(localMessageRecord.senderuin);
              }
  ...
  public void a(MessageForStructing paramMessageForStructing, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.h != 0) && (azkc.a(paramQQAppInterface, paramMessageForStructing.istroop, paramMessageForStructing.frienduin) == 1));
  ...
  public void a(HashMap<String, String> paramHashMap, long paramLong, QQAppInterface paramQQAppInterface)
  {
    ...
    //   1: ifnull +184 -> 185
    //   4: aload_1
    //   5: invokevirtual 574	java/util/HashMap:size	()I
    //   8: ifle +177 -> 185
    ...
    //   18: astore 5
    //   20: aload_1
    //   21: invokevirtual 630	java/util/HashMap:entrySet	()Ljava/util/Set;
    //   24: invokeinterface 633 1 0
    //   29: astore_1
    //   30: aload_1
    //   31: invokeinterface 524 1 0
    //   36: ifeq +78 -> 114
    //   39: aload_1
    //   40: invokeinterface 528 1 0
    //   45: checkcast 635	java/util/Map$Entry
    //   48: astore 7
    //   50: aload 7
    //   52: invokeinterface 646 1 0
    //   57: checkcast 585	java/lang/String
    //   60: astore 6
    //   62: aload 7
    //   64: invokeinterface 638 1 0
    //   69: checkcast 585	java/lang/String
    //   72: astore 7
    //   74: new 580	com/tencent/mobileqq/multimsg/MultiMsgNick
    //   77: dup
    //   78: invokespecial 607	com/tencent/mobileqq/multimsg/MultiMsgNick:<init>	()V
    //   81: astore 8
    //   83: aload 8
    //   85: aload 6
    //   87: putfield 583	com/tencent/mobileqq/multimsg/MultiMsgNick:uin	Ljava/lang/String;
    //   90: aload 8
    //   92: lload_2
    //   93: putfield 590	com/tencent/mobileqq/multimsg/MultiMsgNick:uniseq	J
    //   96: aload 8
    //   98: aload 7
    //   100: putfield 593	com/tencent/mobileqq/multimsg/MultiMsgNick:nick	Ljava/lang/String;
    //   103: aload 5
    //   105: aload 8
    //   107: invokevirtual 953	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   110: pop
    //   111: goto -81 -> 30
    //   114: aload 4
    //   116: invokevirtual 600	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   119: invokevirtual 606	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   122: astore 4
    //   124: aload 4
    //   126: invokevirtual 1064	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   129: astore_1
    //   130: aload_1
    //   131: invokevirtual 1069	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   134: aload 5
    //   136: invokevirtual 828	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   139: astore 5
    //   141: aload 5
    //   143: invokeinterface 524 1 0
    //   148: ifeq +38 -> 186
    //   151: aload 4
    //   153: aload 5
    //   155: invokeinterface 528 1 0
    //   160: checkcast 580	com/tencent/mobileqq/multimsg/MultiMsgNick
    //   163: invokevirtual 1073	com/tencent/mobileqq/persistence/EntityManager:persistOrReplace	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   166: goto -25 -> 141
    //   169: astore 5
    //   171: aload 5
    //   173: invokevirtual 1076	java/lang/Exception:printStackTrace	()V
    //   176: aload_1
    //   177: invokevirtual 1079	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   180: aload 4
    //   182: invokevirtual 1082	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   185: return
    //   186: aload_1
    //   187: invokevirtual 1085	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   190: aload_1
    //   191: invokevirtual 1079	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   194: goto -14 -> 180
    //   197: astore 4
    //   199: aload_1
    //   200: invokevirtual 1079	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   203: aload 4
    //   205: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  {
    bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8006628", "0X8006628", 0, 1, 0, "", "", "", "");
    return a(paramQQAppInterface, paramLong).size() > 0;
  }
  
  public boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, long paramLong, int paramInt2, azjj paramazjj)
  {
  ...
  {
    if ((paramList != null) && (paramList.size() > 0)) {
      Collections.sort(paramList, jdField_a_of_type_Axio);
    }
  }
        ...
        for (paramQQAppInterface = (MessageForPic)paramQQAppInterface;; paramQQAppInterface = (QQAppInterface)localObject)
        {
          ...
          for (;;)
          {
            ...
            if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof StructMsgForImageShare)))
            {
              ...
              if ((localObject != null) && (((bdqa)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic == null))
              {
                if (((bdqa)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare == null) {
                  ((bdqa)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForImageShare = ((StructMsgForImageShare)paramQQAppInterface);
                }
                ((bdqa)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic = ((bdqa)localObject).a();
                paramQQAppInterface = ((bdqa)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
                break label99;
              }
            }
  ...
  public int c()
  {
    ...
    {
      break;
      m = axiv.a(localChatMessage);
      break label64;
      axiv.b("checkMap.size = %d,count= %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilHashMap.size()), Integer.valueOf(k) });
      return k;
    }
  }
