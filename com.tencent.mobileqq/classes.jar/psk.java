...
public abstract class psk
{
  ...
  ohe jdField_a_of_type_Ohe = new psl(this);
  ...
  private void a(Bundle paramBundle, pwl parampwl, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(parampwl.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(parampwl.a()).toString());
      ...
      ndn.a(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  private void b(int paramInt)
  {
    ...
    {
      localawrn.a(str, "actReadInJoyDeliverVideoSendRequest", bool, this.jdField_f_of_type_Long - this.jdField_c_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localawrn.a(str, "actReadInJoyDeliverUGCVideo", bool, this.jdField_e_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, pwl parampwl, psm parampsm)
  {
    String str1 = parampwl.a();
    String str2 = parampwl.b();
    String str3 = parampwl.c();
    String str4 = parampwl.d();
    String str5 = parampwl.e();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Psm = parampsm;
    if (paramBundle == null) {}
