...
import com.tencent.av.wtogether.gles.WatchTogetherVideoRenderHelper.1;
import com.tencent.av.wtogether.gles.WatchTogetherVideoRenderHelper.2;
  ...
  implements myi, myl
{
  ...
  public mzi(boolean paramBoolean)
  {
    this.f = paramBoolean;
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Mzf != null) && (Build.VERSION.SDK_INT >= 16)) {}
  ...
  public boolean a(@NonNull mzf parammzf, int paramInt1, int paramInt2)
  {
    try
    {
  ...
  {
    int j = 1;
    if ((this.jdField_a_of_type_Mzf != null) && (this.jdField_a_of_type_Mzf.a())) {}
    for (int i = 1;; i = 0)
    {
      this.jdField_d_of_type_Boolean = true;
      if ((this.jdField_a_of_type_Mzf != null) && (this.jdField_c_of_type_Boolean) && (i != 0)) {
        break;
      }
      return;
    }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_Mzf)
      {
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          this.jdField_a_of_type_Mzf.a(this.jdField_c_of_type_Int);
          this.jdField_a_of_type_Mzf.a();
          this.jdField_a_of_type_Mzf.a(this.jdField_a_of_type_ArrayOfFloat);
        }
        int k = AIOUtils.dp2px(64.0F, ((GLSurfaceView)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
        int m = nad.a(((GLSurfaceView)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getContext());
        int n = nad.a();
        int i1 = nad.a();
