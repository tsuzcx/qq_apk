  ...
  extends PublicBaseFragment
{
  ...
  protected aamo()
  {
    ...
    this.jdField_a_of_type_Aaip = new aamr(this);
  }
  
  public static void a(Activity paramActivity, JSONObject paramJSONObject, Class<? extends aamo> paramClass)
  {
    ...
    adky.a(paramActivity, paramJSONObject, PublicFragmentActivityForTool.class, paramClass);
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      paramBundle = (qq_ad_get.QQAdGet)qq_ad_get.QQAdGet.class.cast(aano.a(new qq_ad_get.QQAdGet(), paramBundle));
    ...
    catch (JSONException paramLayoutInflater)
    {
      for (;;)
      {
        aanp.d("GdtBaseBannerFragment", "createParams error", paramLayoutInflater);
      }
    }
    paramLayoutInflater = new Button(getActivity());
    paramLayoutInflater.setText("load");
    paramLayoutInflater.setOnClickListener(new aamp(this));
    paramViewGroup = new Button(getActivity());
    paramViewGroup.setText("show");
    paramViewGroup.setOnClickListener(new aamq(this));
