  ...
  implements ance, anci, anco
{
  ...
  public void a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Ancc != null)) {
  ...
  public void a(long paramLong, ancs paramancs)
  {
    ...
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Ancb != null)) {
        this.jdField_a_of_type_Ancb.a(paramLong, paramancs);
      }
      return;
    }
  }
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    } while (this.jdField_a_of_type_Ancc == null);
    this.jdField_a_of_type_Ancc.a(paramLong, paramArrayOfByte);
  }
  
  public void a(ancg paramancg)
  {
    a(4L, paramancg);
  }
  ...
  public boolean a()
  {
    ...
    if ((this.jdField_a_of_type_Ancc != null) && (!this.jdField_a_of_type_Ancc.b()))
    {
      this.jdField_b_of_type_Boolean = false;
  ...
  public boolean a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Ancc != null)) {
      return this.jdField_a_of_type_Ancc.c();
    }
    if (((0x1000 & paramLong) != 0L) && (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {
  ...
  public boolean a(anbo paramanbo)
  {
    ...
    return this.jdField_a_of_type_Ancc.a(paramanbo);
  }
  
  public boolean a(Context arg1, long paramLong, int paramInt1, int paramInt2, ArConfigInfo paramArConfigInfo, ArrayList<ArCloudConfigInfo> paramArrayList, ARScanStarFaceConfigInfo paramARScanStarFaceConfigInfo, ancb paramancb)
  {
    ...
    this.jdField_a_of_type_Ancb = paramancb;
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalMarkerRecog != null) || (this.jdField_a_of_type_Ancc != null) || (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {}
      for (this.jdField_a_of_type_Boolean = true;; this.jdField_a_of_type_Boolean = false)
      {
        ...
        ando.a().a(System.currentTimeMillis() - l, this.jdField_a_of_type_Boolean);
  ...
  {
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Ancc != null)) {
      return this.jdField_a_of_type_Ancc.d();
    }
    return true;
  }
