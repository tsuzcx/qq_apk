...
public class anca
{
  ...
  protected static String a(String paramString)
  {
    ...
    return paramString.replace("[client]", "androidQQ").replace("[version]", "8.4.1.4680").replace("[platformId]", "2").replace("[device]", Build.DEVICE).replace("[system]", Build.VERSION.RELEASE).replace("[systemInt]", Integer.toString(Build.VERSION.SDK_INT));
  }
  ...
  public static void a(String paramString)
  {
    ...
    {
      return;
      ancb.ah = a(paramString);
    } while (!QLog.isColorLevel());
    QLog.d("ApolloConfigUtils", 2, "sApolloStoreUrl = " + ancb.ah);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          bgsg.j((Context)localObject2, Integer.parseInt(paramString));
          ...
          bgsg.k((Context)localObject2, Integer.parseInt((String)localObject3));
        }
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < paramString.length())
        {
          ...
          if (!a("8.4.1", ((JSONObject)localObject3).optString("minVersion"), ((JSONObject)localObject3).optString("maxVersion"))) {
            break label1466;
          }
        ...
        if (((JSONObject)localObject1).has("freqConfig"))
        {
          ...
          if (paramString != null)
          {
            ...
            if (odh.jdField_a_of_type_Int < i) {
              odh.jdField_a_of_type_Int = i;
            }
          }
        }
        ...
        if (((JSONObject)localObject1).has("gameConfig"))
        {
          ...
          if ((paramString != null) && (paramString.has("aio")))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject1)) {
              ancb.aD = (String)localObject1;
            }
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              ancb.aE = ((String)localObject2).trim();
            }
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              ancb.aF = ((String)localObject3).trim();
            }
          }
        }
        if (amhd.a.get()) {
        ...
        paramString = (amhd)paramQQAppInterface.getManager(153);
        amhd.a.set(true);
        paramString.h();
        return;
        label1466:
                          ...
                          do
                          {
                            do
                            {
                              do
                              {
                                ...
                                ancb.ai = a(paramString2);
                              } while (!QLog.isColorLevel());
                              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloStoreInteractUrl=", ancb.ai });
                              return;
                            ...
                            ancb.aj = a(paramString2);
                          } while (!QLog.isColorLevel());
                          QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewStoreUrl=", ancb.aj });
                          return;
                          if (!"game_center".equals(paramString1)) {
                            break;
                          }
                        } while (TextUtils.isEmpty(paramString2));
                        ancb.ak = a(paramString2);
                      } while (!QLog.isColorLevel());
                      QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCenterUrl=", ancb.ak });
                      return;
                      if (!"new_interact".equals(paramString1)) {
                        break;
                      }
                    } while (TextUtils.isEmpty(paramString2));
                    ancb.al = a(paramString2);
                  } while (!QLog.isColorLevel());
                  QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewInteractUrl=", ancb.al });
                  return;
                  if (!"game_city".equals(paramString1)) {
                    break;
                  }
                } while (TextUtils.isEmpty(paramString2));
                ancb.am = a(paramString2);
              } while (!QLog.isColorLevel());
              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCityUrl=", ancb.am });
              return;
              if ("apollo_drawer_game_box_lottie".equals(paramString1))
              {
                ancb.ar = paramString2;
                return;
              }
      ...
      try
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (i < paramJSONObject.length())
          {
            ...
            if (!a("8.4.1", localJSONObject.optString("minVersion"), localJSONObject.optString("maxVersion"))) {
              continue;
            }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            if (a("8.4.1", str1, str2))
            {
              if (!TextUtils.isEmpty((CharSequence)localObject2))
              {
                ancb.at = (String)localObject2;
                ancb.au = localJSONObject.optString("id");
                ancb.av = ancb.jdField_a_of_type_JavaLangString + "/script/" + ancb.au + "/";
                if (paramBoolean)
                {
              ...
              if (QLog.isColorLevel())
              {
                QLog.d("ApolloConfigUtils", 2, new Object[] { "parseBaseScriptConfig: localversion target.url=" + (String)localObject2, ",scriptId:", ancb.au, ",isUpdate:", Boolean.valueOf(paramBoolean) });
                localObject3 = localObject1;
              }
            }
            else
            {
              ...
              if (a("8.4.1", str1) < 0)
              {
                ...
                if (a((String)localObject1, str1) < 0)
                {
                  if (!TextUtils.isEmpty((CharSequence)localObject2))
                  {
                    ancb.aw = (String)localObject2;
                    ancb.ax = localJSONObject.optString("id");
                    ancb.ay = ancb.jdField_a_of_type_JavaLangString + "/script/" + ancb.ax + "/";
                  }
                  if (QLog.isColorLevel()) {
                    QLog.d("ApolloConfigUtils", 2, "parseBaseScriptConfig: newestMinVersion=" + str1 + " target.url=" + (String)localObject2 + ", id=" + ancb.ax);
                  }
                  localObject3 = str1;
                }
              }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localApolloPreDownloadData.resId = bkcx.b(localApolloPreDownloadData.url);
          ...
          if ((!TextUtils.isEmpty(localApolloPreDownloadData.minVer)) && (!TextUtils.isEmpty(localApolloPreDownloadData.maxVer)) && (!a("8.4.1", localApolloPreDownloadData.minVer, localApolloPreDownloadData.maxVer))) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amop.a(jdField_a_of_type_OrgJsonJSONArray);
        ...
        if (localJSONObject2 != null)
        {
          ammy.a("aio.enter.bg", localJSONObject2.optString("entranceBkgUrl"));
          ...
          else
          {
            ...
            ammy.a("aio.enter", paramQQAppInterface);
            ammy.a("aio.enter.name", localJSONObject2.optString("entranceName"));
          }
        }
        else
        {
