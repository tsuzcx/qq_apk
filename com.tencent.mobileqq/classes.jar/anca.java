...
{
  public anca(EmoticonFromGroupManager.5 param5, URLDrawable paramURLDrawable, CustomEmotionData paramCustomEmotionData, anch paramanch, ancg paramancg) {}
  
  public void onLoadCanceled(URLDrawable paramURLDrawable)
  {
    anbw.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0).a.remove(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    do
    {
      ...
      {
        return;
        str = anbw.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0, paramURLDrawable);
      } while ("".equals(str));
    ...
    try
    {
      ...
      this.jdField_a_of_type_Anch.d(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      this.jdField_a_of_type_Ancg.c(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      return;
    }
