  ...
  implements bleb, Manager
{
  ...
  private HashMap<Long, bbok> jdField_a_of_type_JavaUtilHashMap;
  ...
  public bboi(QQAppInterface paramQQAppInterface)
  {
    ...
    d();
    a();
    this.jdField_a_of_type_Atxa = new atxa(paramQQAppInterface);
        ...
        if ((localObject != null) && (localObject.length > 0))
        {
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              if (l > 0L)
              {
                bbok localbbok = new bbok(this);
                localbbok.jdField_a_of_type_Long = this.jdField_a_of_type_AndroidContentSharedPreferences.getLong("gc_unread" + str1 + "_" + str2, 0L);
                localbbok.jdField_a_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_newmsg" + str1 + "_" + str2, false);
                localbbok.jdField_b_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_redpoint" + str1 + "_" + str2, false);
                localbbok.c = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_tab" + str1 + "_" + str2, false);
                localbbok.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_text" + str1 + "_" + str2, "");
                localbbok.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_icon" + str1 + "_" + str2, "");
                localbbok.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("gc_type" + str1 + "_" + str2, -1);
                this.jdField_a_of_type_JavaUtilArrayList.add(Long.valueOf(l));
                this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localbbok);
              }
            }
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilHashMap != null))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(l)))
        {
          ...
          {
            bbok localbbok = (bbok)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
            localEditor.putLong("gc_unread" + str2 + "_" + l, localbbok.jdField_a_of_type_Long);
            localEditor.putBoolean("gc_newmsg" + str2 + "_" + l, localbbok.jdField_a_of_type_Boolean);
            localEditor.putBoolean("gc_redpoint" + str2 + "_" + l, localbbok.jdField_b_of_type_Boolean);
            localEditor.putBoolean("gc_tab" + str2 + "_" + l, localbbok.c);
            localEditor.putString("gc_text" + str2 + "_" + l, localbbok.jdField_a_of_type_JavaLangString);
            localEditor.putString("gc_icon" + str2 + "_" + l, localbbok.jdField_b_of_type_JavaLangString);
            localEditor.putInt("gc_type" + str2 + "_" + l, localbbok.jdField_a_of_type_Int);
            break;
          }
        }
      }
  ...
  public atxa a()
  {
    return this.jdField_a_of_type_Atxa;
  }
  ...
  public void a(long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    {
      localObject = (bbok)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong1));
      ((bbok)localObject).jdField_a_of_type_Boolean = paramBoolean;
      ((bbok)localObject).jdField_a_of_type_Long = paramLong2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong1), localObject);
      e();
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bbol.class);
  ...
  public void a(String paramString, JSONArray paramJSONArray)
  {
    ...
    abet.a(paramString, localJSONArray.toString());
  }
  ...
  public void a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        arrayOfString = abet.a("APPOINTMENT_DOWNLOAD_LIST").split("\\|");
        i = 0;
        ...
        abet.a("APPID_PKGNAME_" + str1, str2);
        if (bool)
        {
          abet.c(str1, "APPOINTMENT_RES_LIST");
          abet.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
        }
      }
      ...
      for (j = 1;; j = 0)
      {
        ...
        abet.c(str1, "APPOINTMENT_LIST");
        abet.a(str1, paramJSONArray.get(i).toString(), "APPOINT_APPID_DETAIL_");
        abet.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
        break label282;
        j += 1;
        break;
  ...
  public void a(MsgBody paramMsgBody)
  {
    ...
    for (;;)
    {
      ...
      case 1: 
        c();
        abet.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "205581", "", "42601", "1", "116");
        return;
      case 2: 
        try
        {
      ...
      case 3: 
        try
        {
          ...
          paramMsgBody = new bboj(this, i);
          if (i == 1)
          {
            abfg.a().a(paramMsgBody);
            return;
          }
        }
        catch (JSONException paramMsgBody)
        ...
        if (i == 2)
        {
          abfg.a().b(paramMsgBody);
          return;
        }
        if (i == 3)
        {
          abfg.a().c(paramMsgBody);
          return;
        }
        break;
      case 4: 
  ...
  public boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramLong))) {
      return ((bbok)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Boolean;
    }
    return false;
  }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (m < paramList.size())
      {
        ...
        do
        {
          ...
          localbbok = (bbok)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localPluginInfo.Id));
          if (QLog.isColorLevel()) {
            QLog.d("GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",before unreaddata:" + localbbok.toString());
          }
          if (localPluginInfo.Count > 0L)
          {
            j = i;
            if (localbbok.jdField_a_of_type_Long != localPluginInfo.Count)
            {
              bool2 = true;
              bool1 = bool2;
              j = i;
            ...
            localbbok.jdField_a_of_type_Long = localPluginInfo.Count;
            localbbok.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
            localbbok.jdField_a_of_type_Boolean = false;
            localbbok.jdField_b_of_type_Boolean = false;
            if (TextUtils.isEmpty(localbbok.jdField_a_of_type_JavaLangString))
            {
              localbbok.jdField_a_of_type_Int = 1;
              localbbok.c = localPluginInfo.Tab;
              bool2 = bool1;
            }
          }
          do
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",unreaddata:" + localbbok.toString());
              k = j;
              bool3 = bool2;
            }
            bool1 = bool3;
            i = k;
            break;
            localbbok.jdField_a_of_type_Int = 4;
            break label296;
            if (localPluginInfo.Flag)
            {
              if (localbbok.jdField_a_of_type_Long > 0L) {
                break;
              }
              j = i;
              if (!localbbok.jdField_a_of_type_Boolean)
              {
                bool2 = true;
                bool1 = bool2;
                j = i;
              ...
              localbbok.jdField_a_of_type_Boolean = localPluginInfo.Flag;
              localbbok.jdField_b_of_type_Boolean = false;
              localbbok.jdField_a_of_type_Long = 0L;
              localbbok.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
              if (TextUtils.isEmpty(localbbok.jdField_a_of_type_JavaLangString)) {}
              for (localbbok.jdField_a_of_type_Int = 3;; localbbok.jdField_a_of_type_Int = 6)
              {
                localbbok.c = localPluginInfo.Tab;
                bool2 = bool1;
                break;
        ...
        } while ((localbbok.jdField_a_of_type_Long > 0L) || ((localPluginInfo.Id == 769L) && (localbbok.jdField_a_of_type_Boolean)));
        j = i;
        if (!localbbok.jdField_b_of_type_Boolean)
        {
          bool2 = true;
          bool1 = bool2;
          j = i;
        ...
        localbbok.jdField_b_of_type_Boolean = localPluginInfo.RedPoint;
        localbbok.jdField_a_of_type_Boolean = false;
        localbbok.jdField_a_of_type_Long = 0L;
        localbbok.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
        localbbok.jdField_b_of_type_JavaLangString = localPluginInfo.PicUrl;
        if (TextUtils.isEmpty(localbbok.jdField_a_of_type_JavaLangString)) {
          if (TextUtils.isEmpty(localbbok.jdField_b_of_type_JavaLangString)) {
            localbbok.jdField_a_of_type_Int = 2;
          }
        }
        for (;;)
        {
          ...
          bool2 = bool1;
          break;
          localbbok.jdField_a_of_type_Int = 7;
          continue;
          localbbok.jdField_a_of_type_Int = 5;
        }
      }
      e();
      if (QLog.isColorLevel()) {
      ...
      if (i != -1)
      {
        paramList = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bbol.class);
  ...
  public void b()
  {
    ...
    if ((k - j > i) || (k < j)) {
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).getCheckUpdate(true, 2);
    }
  }
  ...
  public void onCmdRsp(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      abet.a("APPOINTMENT_LASTGET_TIME", NetConnInfoCenter.getServerTime());
      abet.a("APPOINTMENT_LOAD_GAP", paramJSONObject.optLong("load_gap"));
      abet.a(paramJSONObject.optLong("res_valid") * 1000L);
