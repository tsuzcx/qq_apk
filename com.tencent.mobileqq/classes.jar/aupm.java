...
public class aupm
{
  public static SpannableStringBuilder a(Context paramContext, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject2 = auoj.a((String)localObject1);
      ...
      {
        localObject5 = (auol)((Iterator)localObject4).next();
        if (TextUtils.isEmpty(((auol)localObject5).jdField_b_of_type_JavaLangString)) {
          break label635;
        }
        localauom = new auom(paramContext, 0, ((auol)localObject5).jdField_b_of_type_JavaLangString, bdkf.b(16.0F), null);
        localObject2 = "[icon]";
        if (!TextUtils.isEmpty(((auol)localObject5).c)) {
          localObject2 = ((auol)localObject5).c;
        }
        ((auol)localObject5).jdField_a_of_type_Int += i;
        ((auol)localObject5).jdField_b_of_type_Int += i;
        paramSpannableStringBuilder.replace(((auol)localObject5).jdField_a_of_type_Int, ((auol)localObject5).jdField_b_of_type_Int, (CharSequence)localObject2);
        paramSpannableStringBuilder.setSpan(localauom, ((auol)localObject5).jdField_a_of_type_Int, ((auol)localObject5).jdField_a_of_type_Int + ((String)localObject2).length(), 33);
        i = ((auol)localObject5).jdField_a_of_type_Int + ((String)localObject2).length() - ((auol)localObject5).jdField_b_of_type_Int + i;
        break label641;
      }
      ...
      for (;;)
      {
        ...
        if ((j == 0) && (auoj.b.containsKey(localObject3)))
        {
          localObject4 = (Integer)auoj.b.get(localObject3);
  ...
  private static String a(QQAppInterface paramQQAppInterface, String paramString, List<aupn> paramList)
  {
    ...
    if (j < paramList.size())
    {
      int k = ((aupn)paramList.get(j)).jdField_a_of_type_Int;
      int m = ((aupn)paramList.get(j)).jdField_b_of_type_Int;
      if (!auny.a(paramQQAppInterface, k, m)) {
        break label260;
      }
      if (i == 0)
      {
  ...
  private static String a(QQAppInterface paramQQAppInterface, List<aupn> paramList)
  {
    ...
    String str = aupg.a(paramQQAppInterface.getApp(), 134);
    if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString)
  {
    ...
    Iterator localIterator = auoj.a(paramString).iterator();
    while (localIterator.hasNext()) {
      paramString = paramString.replaceAll(((auol)localIterator.next()).jdField_a_of_type_JavaLangString, "");
    }
    localIterator = auoj.a().iterator();
    while (localIterator.hasNext())
    {
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, String paramString)
  {
    ...
    bdiv.e(BaseApplicationImpl.getContext(), paramQQAppInterface.c(), str, paramString);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    bdiv.a(BaseApplicationImpl.getContext(), paramQQAppInterface.c(), paramString, paramLong);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, amgu paramamgu, int paramInt1, int paramInt2, long paramLong, String paramString4)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      do
      {
        ...
        paramString2 = auod.a(paramQQAppInterface, paramString4, paramString3);
        paramString3 = paramString3.toString();
        paramString4 = new aslp(paramString4, paramString4, paramString3, 0, -5040, paramInt1, ayvc.a());
        ...
        ((MessageForUniteGrayTip)localObject).tipParam.d = (paramString1 + "_reactive_" + paramamgu.b + "_" + paramLong);
        auod.a(paramQQAppInterface, paramString3, paramString4, paramString2);
        ...
        azmj.b(paramQQAppInterface, "dc00898", "", "", "0X800A1BC", "0X800A1BC", 0, 0, "", "", "", "");
      ...
      azmj.b(paramQQAppInterface, "dc00898", "", "", "0X800A1BE", "0X800A1BE", 1, 0, "", "", "", "");
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ReactivePushHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 app:" + paramQQAppInterface + "  changeInfo:" + paramRelationalChainChange + "  msginfo:" + paramamgu);
    }
    ...
    a(paramQQAppInterface, paramRelationalChainChange, str, paramamgu);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, submsgtype0xc7.RelationalChainChange paramRelationalChainChange, String paramString, amgu paramamgu)
  {
    ...
    for (long l1 = localToDegradeInfo.notify_time.get();; l1 = 0L)
    {
      ...
      {
        paramRelationalChainChange = bdbt.m(paramQQAppInterface, paramString);
        localRelationalChainChange = paramRelationalChainChange;
        if (QLog.isColorLevel())
        {
    ...
    {
      paramRelationalChainChange.add(new aupn(j, k, m, n, l2));
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    if ((!TextUtils.isEmpty(paramRelationalChainChange)) && (!auoj.a(paramQQAppInterface))) {
      a(paramQQAppInterface, paramString, paramRelationalChainChange, localRelationalChainChange, paramamgu, 2097155, 0, l1, paramString);
    }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    {
      return false;
      l = bdiv.a(BaseApplicationImpl.getContext(), paramQQAppInterface.c(), paramString);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    catch (Exception paramQQAppInterface)
    {
      ...
      if ((paramQQAppInterface.tipParam != null) && (auoj.b(paramQQAppInterface.tipParam.jdField_b_of_type_Int)))
      {
        if (QLog.isColorLevel()) {
