  ...
  extends awum
{
  ...
  private RelativeLayout a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = aciy.a(70.0F, localResources);
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = aciy.a(70.0F, localResources);
      localObject1 = URLDrawable.getDrawable(paramString1, (URLDrawable.URLDrawableOptions)localObject1);
      localAnyScaleTypeImageView.setId(2131302158);
      localAnyScaleTypeImageView.setImageDrawable((Drawable)localObject1);
      paramString1 = new RelativeLayout.LayoutParams(aciy.a(70.0F, localResources), aciy.a(70.0F, localResources));
  ...
  private RelativeLayout a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      j = localResources.getDimensionPixelSize(2131165277);
      if (!paramBoolean) {
        break label135;
      }
      k = localResources.getDimensionPixelSize(2131165278);
      if (!a(1)) {
        break label147;
      }
      m = aciy.a(15.0F, localResources);
    ...
    for (;;)
    {
      ...
      break;
      label135:
      k = localResources.getDimensionPixelSize(2131167691);
      break label63;
      label147:
      m = aciy.a(6.0F, localResources);
      break label80;
      label159:
      if (a(1)) {
        i = aciy.a(15.0F, localResources);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Bundle)localObject3).getBoolean("pre_dialog") == true)
    {
      ...
      {
        localObject4 = (awul)((Iterator)localObject5).next();
        if ((localObject4 instanceof awzo))
        {
          ...
          localObject2 = ((awzo)localObject4).S;
          localObject4 = ((awzo)localObject4).W;
    ...
    for (;;)
    {
      ...
      if ((localObject4 instanceof StructMsgItemTitle))
      {
        ...
        if (((Bundle)localObject3).getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
        {
          ...
          paramView.setBackgroundColor(paramContext.getResources().getColor(2131099690));
          n = aciy.a(10.0F, (Resources)localObject5);
          int i1 = aciy.a(4.0F, (Resources)localObject5);
          int i2 = aciy.a(5.0F, (Resources)localObject5);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject1 = ((awul)localObject4).a(paramContext, null, (Bundle)localObject3);
              localObject4 = ((View)localObject1).findViewById(2131302327);
              if ((localObject4 != null) && ((localObject4 instanceof AnyScaleTypeImageView))) {
                ((AnyScaleTypeImageView)localObject4).setTag(2131306412, Integer.valueOf(1));
              }
              k = i;
            ...
            else
            {
              if ("video".equals(str))
              {
                if ((localObject4 instanceof awzo))
                {
                  localObject1 = (awzo)localObject4;
                  if (this.jdField_a_of_type_Boolean) {
                    ((awzo)localObject1).c = false;
                  }
                  if (((awzo)localObject1).a()) {
                    if (!this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.hasFlag(4))
                    {
                      ...
                      {
                        localObject1 = (awul)this.jdField_a_of_type_JavaUtilArrayList.get(k);
                        if (!"title".equals(((awul)localObject1).jdField_a_of_type_JavaLangString)) {
                          break label859;
                        }
                ...
                for (;;)
                {
                  ...
                  localObject4 = ((awul)localObject4).a(paramContext, null, (Bundle)localObject3);
                  k = 1;
                ...
                if (localObject1 != null)
                {
                  ...
                  i = ((Resources)localObject5).getDimensionPixelSize(2131165277);
                ...
                for (k = (int)(i / 1.8F);; k = m)
                {
                  ...
                  for (;;)
                  {
                    ...
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)) && ((localObject1 instanceof TitledImageView)))
                    {
                      ...
                      ((TitledImageView)localObject3).setTextSize(aciy.a(2, 18, (Resources)localObject5));
                      ((TitledImageView)localObject3).setTextBackground(paramContext.getResources().getColor(2131099690));
                      ((TitledImageView)localObject3).setTextPadding(aciy.a(10.0F, (Resources)localObject5));
                      ((TitledImageView)localObject3).settextBgRadius(aciy.a(12.0F, (Resources)localObject5));
                    }
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)))
                    {
                      paramContext = ((View)localObject1).getTag(2131310781);
                      if ((paramContext != null) && ((paramContext instanceof awzv))) {
                        ((awzv)paramContext).a.setText(paramBundle);
                      }
                    }
                    ...
                    ((RelativeLayout)localObject2).setId(2131310778);
                    return localObject2;
                    i = ((Resources)localObject5).getDimensionPixelSize(2131167690);
                    break;
                  }
                  i = k - i * 2;
                  break label960;
