  ...
  extends AsyncTask<RespondQueryQQBindingStat, Void, List<PhoneContact>>
{
  ...
  private ajcj(PhoneContactManagerImp paramPhoneContactManagerImp) {}
  ...
  protected List<PhoneContact> a(RespondQueryQQBindingStat... paramVarArgs)
  {
    ...
    Collections.sort(paramVarArgs, new ajck(this));
    ArrayList localArrayList = new ArrayList();
    anvk localanvk = (anvk)PhoneContactManagerImp.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactPhonecontactPhoneContactManagerImp).getManager(QQManagerFactory.FRIENDS_MANAGER);
    ...
    do
    {
      do
      {
        ...
        {
          Collections.sort(localArrayList, new ajcl(this));
    ...
    for (;;)
    {
      ...
      break;
      paramVarArgs = localanvk.e(localPhoneContact.uin);
      break label202;
      label261:
      localPhoneContact.uin = "0";
      if (localanvk.d(localPhoneContact.nationCode + localPhoneContact.mobileCode))
      {
