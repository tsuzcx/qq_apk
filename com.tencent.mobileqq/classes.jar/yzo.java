...
public class yzo
  implements Runnable
{
  public yzo(DeviceProfileManager paramDeviceProfileManager, ConfigurationService.RespGetConfig paramRespGetConfig, String paramString) {}
  ...
  public void run()
  {
      ...
      do
      {
        do
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("DeviceProfileManager", 2, "onDPCResponse DPCXmlHandler.tempMap: key=" + (String)localObject9 + ", value=" + localyzq.toString() + ", isAccountName=" + bool1);
          }
    ...
    boolean bool3 = DeviceProfileManager.a((DeviceProfileManager.DPCConfigInfo)localObject9, localyzq.b.toString().trim());
    if (bool1) {
      ((HashMap)localObject7).put(???, localObject9);
    }
    for (;;)
    {
      localEditor1.putString((String)???, localyzq.b);
      label932:
      if (!QLog.isColorLevel()) {
        break label340;
      }
