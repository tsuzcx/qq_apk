...
public class aopd
  extends aofk
  implements aopi, aopj
{
  final int jdField_a_of_type_Int = 1000;
  long jdField_a_of_type_Long = 0L;
  aofk jdField_a_of_type_Aofk = null;
  ...
  public aopd(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = null;
    this.jdField_a_of_type_Aoph = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_Aopf = null;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = paramFileManagerEntity;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    this.jdField_a_of_type_Aoph = new aoph(paramQQAppInterface.getCurrentAccountUin(), "actDiscussFileUp");
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aopf != null) {
        this.jdField_a_of_type_Aopf.a();
      }
    }
  }
  ...
  private boolean a(long paramLong, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((paramString1 == null) || (paramString1.length() == 0))
    {
      ...
      if (paramLong == 0L)
      {
        this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = 9048L;
        this.jdField_a_of_type_Aoph.c = "onSendDiscFile Host null";
        this.jdField_a_of_type_Aoph.c();
        a(false);
        bool = false;
      }
    }
    while ((paramString2 != null) && (paramString2.length() != 0) && (paramString3 != null) && (paramString3.length() != 0)) {
      ...
      {
        return bool;
        this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = ((int)paramLong);
      }
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    if (paramLong == 0L) {}
    for (this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = 9005L;; this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = ((int)paramLong))
    {
      this.jdField_a_of_type_Aoph.c = "onSendDiscFile param error";
      this.jdField_a_of_type_Aoph.c();
      a(false);
      return false;
    }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (paramLong1 - this.jdField_a_of_type_Long >= 1000L)
    {
      ...
      {
        String str = this.jdField_a_of_type_Aoph.a();
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, String paramString5, String paramString6, Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Aoph.jdField_d_of_type_Long = System.currentTimeMillis();
    if (!paramBoolean)
    {
      ...
      for (this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = 9043L;; this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = 9045L)
      {
        this.jdField_a_of_type_Aoph.c = "server retError";
        if (paramString6 != null) {
          this.jdField_a_of_type_Aoph.c = paramString6;
        }
        this.jdField_a_of_type_Aoph.c();
        a(false);
        return;
    ...
    paramBoolean = false;
    int i;
    if ((aonj.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (paramBundle != null))
    {
    ...
    {
      paramString5 = "";
      if (apdq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
      this.jdField_a_of_type_Aope = new aope();
      this.jdField_a_of_type_Aope.a(paramString3, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSHA, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, this);
      this.jdField_a_of_type_Aopf = new aopf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aoph, paramString4, paramInt, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath(), this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_Aope, paramBoolean, paramString2, paramString5);
  ...
  {
    this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = paramLong.longValue();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = 9004L;
    this.jdField_a_of_type_Aoph.g = System.currentTimeMillis();
    this.jdField_a_of_type_Aoph.c();
  }
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Aoph.jdField_a_of_type_Long = 9037L;
    this.jdField_a_of_type_Aoph.g = System.currentTimeMillis();
    this.jdField_a_of_type_Aoph.c();
  ...
  public void f()
  {
    this.jdField_a_of_type_Aoph.jdField_a_of_type_Int = 3000;
    this.jdField_a_of_type_Aoph.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName;
    this.jdField_a_of_type_Aoph.j = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize;
    this.jdField_a_of_type_Aoph.h = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
    if (QLog.isColorLevel()) {
      QLog.i("DiscFileOperator<FileAssistant>", 1, "start sendFile:" + awao.a());
    }
    apcw.a().execute(new DiscFileOperator.2(this));
  }
}
