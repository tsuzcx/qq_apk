  ...
  implements opd
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull otd paramotd, @NotNull otp paramotp, @NotNull ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener((ViewBase.OnClickListener)new oqa(paramotp, paramContainer, paramotd, paramContainer.getVirtualView().findViewBaseByName("id_first_comment_view")));
  }
}
