...
public class ruj
{
  ...
  private static ArrayList<rum> jdField_a_of_type_JavaUtilArrayList;
  private static AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private static JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private static run jdField_a_of_type_Run;
  ...
  private static ArrayList<rum> a()
  {
    ...
    try
    {
      ...
      while (i < localJSONArray.length())
      {
        ...
        localrum.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).getString("vid");
        localrum.jdField_a_of_type_Long = ((JSONObject)localObject).getLong("bitrate");
        localrum.jdField_b_of_type_Long = ((JSONObject)localObject).getLong("timeout_ms");
        localrum.jdField_a_of_type_Float = Float.valueOf(((JSONObject)localObject).getString("hevc_level")).floatValue();
        localrum.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("max_hashdiff");
        localrum.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("tag");
        localObject = ((JSONObject)localObject).getJSONArray("frameInfo");
        int j = 0;
        while (j < ((JSONArray)localObject).length())
        {
          ruu localruu = new ruu();
          JSONObject localJSONObject = (JSONObject)((JSONArray)localObject).get(j);
          localruu.jdField_a_of_type_Int = localJSONObject.getInt("index");
          localruu.jdField_a_of_type_Long = localJSONObject.getLong("serverHash");
          localrum.jdField_a_of_type_JavaUtilArrayList.add(localruu);
          j += 1;
        }
        localArrayList.add(localrum);
        i += 1;
      }
  ...
  private static boolean a()
  {
    ...
    //   0: ldc 219
    //   2: ldc 221
    //   4: invokestatic 226	bkwm:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   63: putstatic 37	ruj:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   66: getstatic 37	ruj:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   69: ldc 241
    //   71: invokevirtual 68	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   74: astore 5
    //   76: getstatic 37	ruj:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   79: ldc 243
    //   81: invokevirtual 102	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   84: istore_0
    //   85: getstatic 37	ruj:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   88: ldc 245
    ...
    //   130: ldc 255
    //   132: ldc 221
    //   134: invokestatic 226	bkwm:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   192: putstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   195: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   198: ldc_w 259
    //   201: ldc 221
    //   203: invokevirtual 262	org/json/JSONObject:optString	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   206: astore 6
    //   208: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   211: ldc_w 264
    //   214: iconst_0
    //   215: invokevirtual 268	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   218: istore_2
    //   219: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   222: ldc_w 270
    //   225: iconst_0
    ...
    //   274: ifne +48 -> 322
    //   277: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   280: ldc_w 259
    //   283: aload 5
    //   285: invokevirtual 279	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   288: pop
    //   289: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   292: ldc_w 264
    //   295: iconst_0
    //   296: invokevirtual 282	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   299: pop
    //   300: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   303: ldc_w 270
    //   306: iconst_0
    //   307: invokevirtual 282	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   310: pop
    //   311: ldc 255
    //   313: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   316: invokevirtual 283	org/json/JSONObject:toString	()Ljava/lang/String;
    //   319: invokestatic 286	bkwm:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   322: invokestatic 288	ruj:a	()Ljava/util/ArrayList;
    //   325: putstatic 289	ruj:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   328: getstatic 289	ruj:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   331: ifnull +71 -> 402
    //   334: iconst_1
    //   335: istore 4
    //   337: iload 4
    ...
    //   347: putstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   350: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   353: ldc_w 259
    //   356: aload 5
    //   358: invokevirtual 279	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   361: pop
    //   362: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   365: ldc_w 264
    //   368: iconst_0
    //   369: invokevirtual 282	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   372: pop
    //   373: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   376: ldc_w 270
    //   379: iconst_0
    //   380: invokevirtual 282	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   383: pop
    //   384: ldc 255
    //   386: getstatic 135	ruj:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   389: invokevirtual 283	org/json/JSONObject:toString	()Ljava/lang/String;
    //   392: invokestatic 286	bkwm:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   395: goto -73 -> 322
    //   398: astore 5
    //   400: iconst_0
    //   401: ireturn
  ...
  public static void b()
  {
    ...
    if ((jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)) && (jdField_a_of_type_Run != null))
    {
      jdField_a_of_type_Run.b();
      jdField_a_of_type_Run = null;
    }
  }
  
  private static void b(Context paramContext, rum paramrum, int paramInt, String paramString, HashMap<Integer, ruu> paramHashMap)
  {
    ...
    try
    {
      ...
      localJSONObject.put("subversion", "8.4.8");
      if (jdField_a_of_type_OrgJsonJSONObject == null) {
        break label631;
      }
      localObject = jdField_a_of_type_OrgJsonJSONObject.optString("version");
      localJSONObject.put("server_version", localObject);
      localJSONObject.put("video_tag", paramrum.jdField_b_of_type_JavaLangString);
      localJSONObject.put("video_vid", paramrum.jdField_a_of_type_JavaLangString);
      localJSONObject.put("video_bitrate", paramrum.jdField_a_of_type_Long);
      localJSONObject.put("video_width", paramrum.jdField_b_of_type_Int);
      localJSONObject.put("video_height", paramrum.c);
      ...
      if (bool1)
      {
        ...
        {
          localObject = (ruu)paramString.next();
          if (((ruu)localObject).jdField_b_of_type_Int > paramrum.jdField_a_of_type_Int) {
            bool1 = false;
          }
          i += ((ruu)localObject).jdField_b_of_type_Int;
          k = j;
          if (j > ((ruu)localObject).jdField_b_of_type_Int) {
            k = ((ruu)localObject).jdField_b_of_type_Int;
          }
          if (paramInt >= ((ruu)localObject).jdField_b_of_type_Int) {
            break label644;
          }
          paramInt = ((ruu)localObject).jdField_b_of_type_Int;
          break label624;
        }
      ...
      paramrum = new JSONArray();
      paramString = paramHashMap.values().iterator();
      while (paramString.hasNext())
      {
        paramHashMap = (ruu)paramString.next();
        ...
        paramrum.put(localObject);
        continue;
        localHashMap.put("param_content", localJSONObject.toString());
      }
    }
    catch (Exception paramrum) {}
    for (;;)
    {
      localHashMap.put("param_device", rug.a());
      if (QLog.isColorLevel()) {
        QLog.d("VideoExtractFrame", 2, "灯塔数据上报 reportMap = " + localHashMap.toString());
      }
      paramrum = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      if (paramrum != null) {
        StatisticCollector.getInstance(paramContext).collectPerformance(paramrum.getCurrentUin(), "actKandianVideoExtractFrame", true, -1L, 0L, localHashMap, null);
      }
      return;
      localJSONObject.put("detail_list", paramrum);
    }
    label644:
    for (;;)
    {
  ...
  private static void b(rum paramrum, String paramString, HashMap<Integer, ruu> paramHashMap, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.d("VideoExtractFrame", 2, "innerDoExtractFrame start() videoInfo.tag = " + paramrum.jdField_b_of_type_JavaLangString);
    }
    jdField_a_of_type_Long = System.currentTimeMillis();
    jdField_a_of_type_Run = new run(BaseApplication.getContext(), paramString, paramHashMap, paramLong);
    jdField_a_of_type_Run.a(new rul(paramrum));
    jdField_a_of_type_Run.a();
  }
  ...
  private static void c()
  {
    try
    {
      ...
      bkwm.a("kandian_video_extract_frame_local_result", jdField_b_of_type_OrgJsonJSONObject.toString());
      float f = rug.a();
      Object localObject = jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        if (((rum)((Iterator)localObject).next()).jdField_a_of_type_Float > f) {
      ...
      localObject = (rum)jdField_a_of_type_JavaUtilArrayList.get(i);
      HashMap localHashMap = new HashMap();
      Iterator localIterator = ((rum)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext())
      {
        ruu localruu = (ruu)localIterator.next();
        localHashMap.put(Integer.valueOf(localruu.jdField_a_of_type_Int), localruu);
      }
      sjo.a().a(((rum)localObject).jdField_a_of_type_JavaLangString, new ruk((rum)localObject, localHashMap));
      return;
    }
    catch (Exception localException) {}
  }
