  ...
  extends bcvu
{
  ...
  public bcxp()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bcxs(this);
    ...
    for (Object localObject = this.d;; localObject = this.e)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject).has("appId")) {
          this.aq = ((JSONObject)localObject).getString("appId");
        }
        if (((JSONObject)localObject).has("orderId")) {
          this.ar = ((JSONObject)localObject).getString("orderId");
        }
        if (((JSONObject)localObject).has("package")) {
          this.at = ((JSONObject)localObject).getString("package");
        }
        if (((JSONObject)localObject).has("expireTime")) {
          this.as = ((JSONObject)localObject).getString("expireTime");
        }
        return;
      }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    paramContext.setBackgroundResource(2130838301);
    if (i > 1) {
      if (j == 0)
      {
        paramContext.setBackgroundResource(2130838294);
        i = 0;
      }
    }
    for (;;)
    {
      paramContext.setTag(2131377918, Integer.valueOf(i));
      ...
      if ((!b()) || ((b()) && (a())))
      {
        ...
        paramContext.setOnLongClickListener(new bcxq(this));
        paramContext.setOnTouchListener(new bcxr(this));
        return paramContext;
        if (j == i - 1)
        {
          paramContext.setBackgroundResource(2130838298);
          i = 2;
        }
        else
        {
          paramContext.setBackgroundResource(2130838296);
          i = 1;
        }
      }
      else
  ...
  public void a(String paramString, MessageRecord paramMessageRecord, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    try
    {
      ...
      if ((i != 23001027) && (i != 0) && (i != -4) && (i != -6))
      {
        ...
        if (!((akpd)paramString.getManager(245)).a(paramMessageRecord.frienduin))
        {
          j = 1;
          i = -4;
          if (j != 0) {
            paramStructMsgForGeneralShare.savePayInfo(paramString.getApplication(), this.ar, i);
          }
          b(i);
          return;
        }
  ...
  {
    super.a(parambcxj);
    this.jdField_c_of_type_JavaLangString = parambcxj.a("action");
    this.d = parambcxj.a("actionData");
    this.e = parambcxj.a("a_actionData");
    this.f = parambcxj.a("i_actionData");
  ...
  public boolean b()
  {
    return (!TextUtils.isEmpty(this.aq)) && (!TextUtils.isEmpty(this.as)) && (!TextUtils.isEmpty(this.ar)) && ("pay".equals(this.jdField_c_of_type_JavaLangString));
  }
  ...
  public boolean c()
  {
    ...
    try
    {
      long l2 = Long.parseLong(this.as);
      if (l2 > l1) {
        return false;
      }
    }
