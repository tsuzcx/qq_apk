  ...
  extends BaseJsPlugin
{
  ...
  {
    MiniAppController.getInstance().setActivityResultListener(new bizq(this, paramRequestEvent));
    ...
    paramRequestEvent.fail(amtj.a(2131704484));
  }
  ...
  public void getMultiMemList(RequestEvent paramRequestEvent)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramRequestEvent)
      {
        ...
        return;
        paramRequestEvent.fail(amtj.a(2131704485));
        return;
        if (localJSONObject != null) {
          continue;
        }
      ...
      {
        paramRequestEvent.fail(amtj.a(2131704486));
        return;
