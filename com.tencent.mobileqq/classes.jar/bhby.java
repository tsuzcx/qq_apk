...
public class bhby
{
  ...
  public static Fragment a(@NonNull Activity paramActivity, @NonNull QQAppInterface paramQQAppInterface, @NonNull String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramString instanceof bhcc))
        {
          try
          {
            ((bhcc)paramString).attachQQContext(paramActivity, paramQQAppInterface);
            i = 1;
          }
  ...
  @Nullable
  public static bhbx a(@NonNull Activity paramActivity)
  {
    if (!jdField_a_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        try
        {
          paramActivity = (bhbx)((Constructor)localObject1).newInstance(new Object[] { paramActivity });
  ...
  public static String a(Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(str)) {
      paramContext = ajya.a(2131720031);
    }
    return paramContext;
  }
  ...
  public static boolean b()
  {
    ...
    PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bhbz(l));
    return false;
  }
  ...
  public static boolean b(@NonNull Context paramContext, @NonNull QQAppInterface paramQQAppInterface)
  {
    ...
    ((bglh)paramQQAppInterface.getManager(27)).a("qzone_plugin.apk");
