  ...
  implements ajfl
{
  ...
  public ajgi(ajgh paramajgh, ajfo paramajfo, ajgn paramajgn, ajgo paramajgo)
  {
    this.jdField_a_of_type_Ajgh = paramajgh;
    this.jdField_a_of_type_Ajfo = paramajfo;
    this.jdField_a_of_type_Ajgn = paramajgn;
    this.jdField_a_of_type_Ajgo = paramajgo;
  }
  
  private boolean a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Ajgh == null) {}
    while (this.jdField_a_of_type_Ajgo.a(paramInt1, paramInt2) == null) {
      return false;
    }
    return true;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject = this.jdField_a_of_type_Ajgo.a(100);
      if (localObject == null)
      {
        QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
        return;
      }
      ((ajgf)localObject).a(localStringBuilder.toString());
      this.jdField_a_of_type_Ajfo.a(paramInt2);
      return;
    }
  ...
  public void a(ajgh paramajgh, int paramInt, ajfz paramajfz, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d("CmShow_SpriteDrawerInfoBridge", 2, "[initSprite]");
    }
    if ((this.jdField_a_of_type_Ajgn == null) || (paramajgh == null) || (!paramajgh.a())) {
      if (paramajgh != null) {
        ajlq.a(paramajgh.a(), 300, 160, new Object[] { "glview is not ready" });
      }
    }
    do
    {
    ...
    } while (paramajgh.jdField_e_of_type_Int != 1);
    ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.5(this, paramajgh));
    return;
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramajgh.a();
    if (paramBundle != null)
    {
      ...
      if (!TextUtils.isEmpty(paramajgh.jdField_b_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramajgh.jdField_b_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.d));
      }
      if (!TextUtils.isEmpty(paramajgh.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramajgh.jdField_a_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.jdField_e_of_type_Int));
      }
    }
    localBundle.putParcelable("IPCSpriteContext", localIPCSpriteContext);
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new ajgl(this, paramajfz, paramInt, paramajgh));
  }
  
  public void a(ajgh paramajgh, CmShowRenderView.PlayActionConfig paramPlayActionConfig)
  {
    int i = 1;
    if ((paramajgh == null) || (paramPlayActionConfig == null)) {
      return;
    }
    long l = System.currentTimeMillis();
    Object localObject1 = ajfu.a(paramPlayActionConfig);
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if ((!TextUtils.isEmpty(paramajgh.jdField_b_of_type_JavaLangString)) && (!paramajgh.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
      {
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramajgh.jdField_b_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramajgh.jdField_a_of_type_JavaLangString;
      ...
      for (;;)
      {
        ...
        ((SpriteTaskParam)localObject2).jdField_a_of_type_Ajfl = this;
        ...
        return;
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramajgh.jdField_a_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramajgh.jdField_b_of_type_JavaLangString;
        break;
        label222:
        i = 0;
      }
    ...
    Object localObject2 = paramajgh.a();
    if ((!TextUtils.isEmpty(paramajgh.jdField_b_of_type_JavaLangString)) && (!paramajgh.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
    {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_play_action", (Bundle)localObject1, new ajgj(this, l, paramPlayActionConfig));
  }
  
  public void a(ajgh paramajgh, String paramString1, String paramString2)
  {
    if (QLog.isColorLevel()) {
      QLog.d("CmShow_SpriteDrawerInfoBridge", 2, "[initSprite]");
    }
    ...
    ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.3(this, paramajgh));
    return;
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramajgh.a();
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new ajgk(this, paramajgh));
  }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      ((ajgf)localObject).a(paramString.toString());
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 1)
        {
          ...
          localObject2 = this.jdField_a_of_type_Ajgo.a(100);
          if (localObject2 == null)
          {
            QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
            return;
          }
          ((ajgf)localObject2).a(((StringBuilder)localObject1).toString());
          ajfu.a(paramString, paramInt);
          return;
        }
      }
      catch (Throwable paramString)
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("text", ajfj.a(bbca.encodeToString(paramString2.getBytes("utf-8"), 0)));
        localJSONObject.put("direction", paramInt1);
        paramString1 = "";
        if (paramInt2 == 1) {
          paramString1 = ajfc.a(paramString2, 1);
        }
        if (TextUtils.isEmpty(paramString1))
        {
          ApolloUtil.b("本地无qzone气泡资源，请检查配置是否ok");
          str = ajfc.a(paramString2, 0, 1);
          localJSONObject.put("bubblePath2D", str);
          paramString1 = "";
          if (paramInt2 == 1) {
            paramString1 = ajfc.a(paramString2, 2);
          }
          if (TextUtils.isEmpty(str)) {
            paramString1 = ajfc.a(paramString2, 0, 2);
          }
          ...
          paramString2 = this.jdField_a_of_type_Ajgo.a(100);
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((ajgf)localObject).a(paramList.toString());
      return;
      label172:
      if (paramBoolean) {
        i = 1;
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Ajgn == null) || (this.jdField_a_of_type_Ajgh == null) || (!this.jdField_a_of_type_Ajgh.a())) {
      return;
    }
    Object localObject1 = this.jdField_a_of_type_Ajgn;
    ajgn.a(paramSpriteTaskParam);
    localObject1 = "";
    ...
    Object localObject3 = this.jdField_a_of_type_Ajgo.a(paramSpriteTaskParam.jdField_c_of_type_Int);
    Object localObject2 = localObject3;
    if (localObject3 == null)
    {
      QLog.i("CmShow_SpriteDrawerInfoBridge", 1, "playAction CmShow_ get sdk basic script");
      localObject3 = this.jdField_a_of_type_Ajgo.a(100);
    ...
    {
      ajkk.a((QQAppInterface)localObject1, paramSpriteTaskParam, bool, paramSpriteTaskParam.jdField_b_of_type_Boolean);
      return;
    }
  }
}
