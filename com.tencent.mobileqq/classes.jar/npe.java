...
public class npe
{
  ...
  public static String a(Context paramContext, String paramString, android.os.Bundle paramBundle1, android.os.Bundle paramBundle2)
  {
    ...
    //   158: aload_2
    //   159: aload_0
    //   160: invokestatic 87	npe:a	(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    //   190: aload_0
    //   191: aload_2
    //   192: invokestatic 108	npe:a	(Ljavax/net/ssl/HttpsURLConnection;Ljava/net/URL;)V
    //   195: aload_0
    //   196: ldc 110
    //   198: ldc 112
  ...
  {
    npf localnpf = new npf(paramURL);
    paramHttpsURLConnection.setRequestProperty("host", paramURL.getHost());
    paramHttpsURLConnection.setSSLSocketFactory(new SniSSLSocketFactory(paramURL.getHost(), localnpf));
    paramHttpsURLConnection.setHostnameVerifier(localnpf);
  }
}
