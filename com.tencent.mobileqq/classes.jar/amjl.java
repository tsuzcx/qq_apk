...
public class amjl
  implements DialogInterface.OnDismissListener, Handler.Callback, AdapterView.OnItemClickListener, bjoe
{
  ...
  public amjl(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.f = (amtj.a(2131699504) + this.jdField_a_of_type_JavaLangString);
  ...
  private void c()
  {
    Object localObject1 = new bcgt(StructMsgForGeneralShare.class).c(96).a(this.f).e(this.c).a(amtj.a(2131699532), null).b("web", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326").a();
    Object localObject2 = bchg.a(2);
    ((bcgx)localObject2).a(this.d, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ...
      if (localObject1 != null) {
        atky.a((Activity)localObject1, (Intent)localObject2, 14002);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    localArrayList.add(bjok.a(3));
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      if (paramString != null)
      {
        localbjok = new bjok(paramString);
        localbjok.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Bjnw == null) && (paramString != null)) {
        this.jdField_a_of_type_Bjnw = bjok.a(paramString, localbjok, this, this, this, false);
      }
      if ((this.jdField_a_of_type_Bjnw != null) && (!this.jdField_a_of_type_Bjnw.isShowing()))
      {
        this.jdField_a_of_type_Bjnw.setOnDismissListener(this);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (Activity localActivity = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localActivity = null)
    {
      ...
      {
        localbjok = new bjok(localActivity);
        localbjok.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Bjnw == null) && (localActivity != null))
      {
        ...
        this.jdField_a_of_type_Bjnw = bjok.a(localActivity, localbjok, new amjm(this, paramString), this, this, false);
      }
      if ((this.jdField_a_of_type_Bjnw == null) || (this.jdField_a_of_type_Bjnw.isShowing())) {
        break;
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localBundle.putString("summary", amtj.a(2131699489));
