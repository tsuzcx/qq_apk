...
public class bhzk
{
  ...
  public static Bitmap a(String paramString)
  {
    ...
    bhzm.b("ImageUtil", "100_url:" + str1 + " icon_path=" + str2);
    if (new File(str2).exists()) {
      return bhzi.a(str2, 72, 72, false);
    }
    paramString = a(paramString, 75);
    str1 = ImageCache.a("app", paramString);
    bhzm.b("ImageUtil", "75_url:" + paramString + " icon_path=" + str1);
    if (new File(str1).exists()) {
      return bhzi.a(str1, 72, 72, false);
    }
    return null;
  }
  ...
  public static String a(String paramString, int paramInt)
  {
    ...
    bhzm.b("opensdk", ">>iconUrl=" + paramString);
    return paramString;
  }
