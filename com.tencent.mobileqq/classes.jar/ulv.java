...
public class ulv
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new ulw(this, Looper.getMainLooper());
  ...
  public ulv(shl paramshl, ArrayList<VideoInfo> paramArrayList, ult paramult)
  {
    this.jdField_a_of_type_Shl = paramshl;
    this.jdField_a_of_type_JavaUtilArrayList = paramArrayList;
    this.jdField_a_of_type_Ult = paramult;
  }
  ...
  private void e()
  {
    ...
    try
    {
      if ((this.jdField_a_of_type_Shl != null) && (ult.a != null))
      {
        Iterator localIterator = ult.a.iterator();
        while (localIterator.hasNext())
        {
          ...
          this.jdField_a_of_type_Shl.c(localVideoInfo);
        }
      }
      return;
    }
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Ult != null) && (uls.a != 1))
    {
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (uls.b())) {
