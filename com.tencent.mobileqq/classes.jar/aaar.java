...
public class aaar
{
  ...
  @Nullable
  private static volatile aaar jdField_a_of_type_Aaar;
  @Nullable
  private static volatile aaau jdField_a_of_type_Aaau;
  @NonNull
  private static aaax jdField_a_of_type_Aaax = new aaax();
  public static Vector<aaau> a;
  private static final String b;
  public static Vector<aaaz> b;
  public String a;
  ...
  {
    if (jdField_a_of_type_Aaar == null) {}
    try
    {
      if (jdField_a_of_type_Aaar == null) {
        jdField_a_of_type_Aaar = new aaar();
      }
      return jdField_a_of_type_Aaar;
    }
    finally {}
  }
  ...
  private aaat a()
  {
    aaat localaaat = new aaat(this, null);
    try
    {
      long[] arrayOfLong = jdField_a_of_type_Aaax.a();
      if (arrayOfLong != null)
      {
        aaat.a(localaaat, arrayOfLong[0]);
        aaat.b(localaaat, arrayOfLong[1]);
        aaat.c(localaaat, arrayOfLong[2]);
        aaat.d(localaaat, arrayOfLong[4]);
      }
    }
    catch (Exception localException)
    {
  ...
  private ArrayList<Double> a(int paramInt)
  {
    ...
    //   135: dload_2
    //   136: dstore 8
    //   138: getstatic 56	aaar:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private aaau b()
  {
    aaau localaaau = new aaau();
    localaaau.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localaaau.f = System.currentTimeMillis();
    localaaau.jdField_a_of_type_Long = (localaaau.f / 1000L);
    Object localObject = a();
    long l1;
    label84:
    label106:
    double d;
    if (aaat.a((aaat)localObject) > 0L)
    {
      l1 = aaat.a((aaat)localObject);
      localaaau.c = l1;
      if (aaat.b((aaat)localObject) <= 0L) {
        break label385;
      }
      l1 = aaat.b((aaat)localObject);
      localaaau.d = l1;
      if (aaat.c((aaat)localObject) <= 0L) {
        break label392;
      }
      l1 = aaat.c((aaat)localObject);
      localaaau.e = l1;
      if ((jdField_a_of_type_Long == 0L) || (aaat.d((aaat)localObject) == 9223372036854775807L)) {
        break label399;
      }
      l1 = aaat.d((aaat)localObject) * jdField_a_of_type_Long;
      label142:
      localaaau.jdField_b_of_type_Long = l1;
      if (jdField_a_of_type_Aaau == null) {
        break label462;
      }
      jdField_a_of_type_Aaau.f = localaaau.f;
      jdField_a_of_type_Aaau.jdField_a_of_type_Long = localaaau.jdField_a_of_type_Long;
      if ((jdField_a_of_type_Aaau.c == 9223372036854775807L) || (jdField_a_of_type_Aaau.d == 9223372036854775807L) || (jdField_a_of_type_Aaau.e == 9223372036854775807L)) {
        break label416;
      }
      l1 = localaaau.c;
      long l2 = jdField_a_of_type_Aaau.c;
      long l3 = localaaau.d - jdField_a_of_type_Aaau.d;
      long l4 = localaaau.e;
      long l5 = jdField_a_of_type_Aaau.e;
      if (l3 > 0L)
      {
        localaaau.jdField_a_of_type_Double = ((l1 - l2) * 1.0D / l3);
        localaaau.jdField_b_of_type_Double = (1.0D * (l4 - l5) / l3);
      }
      if (localaaau.jdField_a_of_type_Double <= 0.0D) {
        break label406;
      }
      d = localaaau.jdField_a_of_type_Double;
      label314:
      localaaau.jdField_a_of_type_Double = d;
      if (localaaau.jdField_b_of_type_Double <= 0.0D) {
        break label411;
      }
      d = localaaau.jdField_b_of_type_Double;
      label336:
      localaaau.jdField_b_of_type_Double = d;
    }
    for (;;)
    {
      jdField_a_of_type_Aaau.c = localaaau.c;
      jdField_a_of_type_Aaau.d = localaaau.d;
      jdField_a_of_type_Aaau.e = localaaau.e;
      return localaaau;
      ...
      localaaau.jdField_b_of_type_Double = ((Double)((ArrayList)localObject).get(0)).doubleValue();
      localaaau.jdField_a_of_type_Double = ((Double)((ArrayList)localObject).get(1)).doubleValue();
    }
    label462:
    jdField_a_of_type_Aaau = new aaau();
    jdField_a_of_type_Aaau.f = localaaau.f;
    jdField_a_of_type_Aaau.jdField_a_of_type_Long = localaaau.jdField_a_of_type_Long;
    jdField_a_of_type_Aaau.c = localaaau.c;
    jdField_a_of_type_Aaau.d = localaaau.d;
    jdField_a_of_type_Aaau.e = localaaau.e;
    localaaau.jdField_a_of_type_Double = 0.0D;
    localaaau.jdField_b_of_type_Double = 0.0D;
    return localaaau;
  }
  ...
  public aaau a()
  {
    aaau localaaau = b();
    if (localaaau != null) {
      jdField_a_of_type_JavaUtilVector.add(localaaau);
    }
    return localaaau;
  }
}
