  ...
  extends bdsh
{
  ...
  public bdsi(String paramString, BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  private void a(Application paramApplication, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(paramApplication, paramString1, bool, 0L, 0L, paramString2, "");
      return;
      boolean bool = false;
      continue;
  ...
  private void a(Application paramApplication, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        bctj.a(BaseApplication.getContext()).a(paramApplication.getCurrentAccountUin(), "report_aio_photo_size", false, 0L, 0L, paramString, "");
        return;
        paramInt /= d;
        if (paramInt >= 10)
        {
  ...
  public static void a(bdsj parambdsj, boolean paramBoolean, int paramInt1, int paramInt2, String paramString, bdul parambdul1, bdul parambdul2, bdum parambdum)
  {
    ...
    a(localHashMap, paramInt2, paramString, parambdul2, parambdum, paramBoolean, parambdul1);
    localHashMap.put("param_uuid", parambdsj.f);
    localHashMap.put("flow", String.valueOf(l1));
    localHashMap.put("msgTime", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(parambdsj.jdField_a_of_type_Long * 1000L)));
    localHashMap.put("client_exist", String.valueOf(parambdsj.jdField_a_of_type_Boolean));
    if (parambdul2 != null) {
      localHashMap.put("param_RequestUrl", parambdul2.a());
    }
    if (parambdum != null) {
      localHashMap.put("param_HttpTran", parambdum.a());
    }
    if (parambdum != null)
    {
      localHashMap.put("param_retry", String.valueOf(parambdum.jdField_b_of_type_Int));
      if (parambdum.jdField_a_of_type_Boolean)
      {
        localHashMap.put("serverip", parambdum.jdField_b_of_type_JavaLangString);
        localHashMap.put("param_Server", parambdum.jdField_b_of_type_JavaLangString);
      }
    }
    else
    {
      ...
      if ((!parambdsj.c.equals("actC2CPicDownloadV1")) && (!parambdsj.c.equals("actC2CPicSmallDownV1"))) {
        break label351;
      }
      localHashMap.put("param_toUin", parambdsj.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      bctj.a(BaseApplication.getContext()).a(null, parambdsj.c, true, paramInt1, l1, localHashMap, "");
      return;
      localHashMap.put("serverip", parambdum.c);
      localHashMap.put("param_Server", parambdum.c);
      if (paramInt2 != -9527) {
        break;
      }
      localHashMap.put("param_rspHeader", parambdum.d);
      break;
      label351:
      localHashMap.put("param_grpUin", parambdsj.jdField_a_of_type_JavaLangString);
    }
    label366:
    if (paramInt2 == 9301) {
      localHashMap.put("param_connecttrycount", paramString);
    }
    if ((parambdsj.g != null) && (!parambdsj.g.equals(""))) {
      localHashMap.put("param_MsgTime", parambdsj.g);
    }
    long l3 = paramInt1;
    if ((parambdsj.c.equals("actC2CPicDownloadV1")) || (parambdsj.c.equals("actC2CPicSmallDownV1")))
    {
      localHashMap.put("param_toUin", parambdsj.jdField_a_of_type_JavaLangString);
      localHashMap.put("param_url", parambdsj.e);
      localHashMap.put("param_fsized", l1 + "");
      localHashMap.put("param_fsizeo", l2 + "");
    }
    for (;;)
    {
      bctj.a(BaseApplication.getContext()).a(null, parambdsj.c, false, 0L, 0L, localHashMap, "");
      return;
      localHashMap.put("param_grpUin", parambdsj.jdField_a_of_type_JavaLangString);
      localHashMap.put("param_url", parambdsj.e);
      localHashMap.put("param_fsized", l1 + "");
  ...
  private void a(Object paramObject, String paramString1, String paramString2)
  {
    if ((paramObject instanceof DownloadParams))
    {
      ...
      if ((((DownloadParams)localObject).tag instanceof ayye))
      {
        paramObject = (ayye)((DownloadParams)localObject).tag;
        localObject = ((DownloadParams)localObject).url.getProtocol();
        if (paramObject.isSendFromLocal())
        {
          i = bdxz.a(bdzx.a((String)localObject, false));
          paramObject = paramObject.getPicUploadInfo();
          bdxz.a(paramObject.jdField_b_of_type_Int, false, i, String.valueOf(paramObject.jdField_a_of_type_Long), paramString1, paramString2);
        }
      }
    }
    while (!QLog.isColorLevel())
    {
      ...
      {
        i = bdxz.a(bdzx.a((String)localObject, bool));
        bdxz.a(paramObject.jdField_b_of_type_Int, false, i, String.valueOf(paramObject.jdField_a_of_type_Long), paramString1, paramString2);
        return;
      }
    }
  ...
  public static void a(HashMap<String, String> paramHashMap, int paramInt, String paramString, bdul parambdul1, bdum parambdum, boolean paramBoolean, bdul parambdul2)
  {
    String str;
    if (!bdsx.a(paramInt, paramHashMap))
    {
      ...
      {
        paramHashMap.put(bdsx.k, paramString);
        str = "";
        if ((!paramBoolean) || (parambdul2 != null) || (parambdul1 != null) || (parambdum != null)) {
          break label157;
        }
    ...
    for (;;)
    {
      ...
      if (parambdul2 != null)
      {
        ...
        if (parambdul1 != null)
        {
          paramString = str;
          if (parambdum != null) {
            paramString = parambdul2.a(1) + ";" + parambdul1.a(2) + ";" + parambdum.a(3);
          }
        }
      }
    }
  ...
  public Object a(File paramFile, DownloadParams paramDownloadParams, BitmapFactory.Options paramOptions)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramOptions.inPreferredConfig = bdzx.b;
      ...
      try
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (i != 0)
          {
            bool = bgmg.a((String)localObject1);
            if (bool)
            {
              ...
              {
                String str2 = bita.a((String)localObject1);
        ...
        if (localObject3 != null)
        {
          ...
          if (paramDownloadParams.tag != null)
          {
            ...
            if ((paramDownloadParams.tag instanceof beaj)) {
              return ((beaj)paramDownloadParams.tag).a((Bitmap)localObject1);
            }
          }
          ...
          localObject1 = new RoundRectBitmap(new beak(paramFile.getAbsolutePath()).a(((RoundRectBitmap)localObject2).mBitmap), ((RoundRectBitmap)localObject2).mCornerRadius, ((RoundRectBitmap)localObject2).mBoardColor, ((RoundRectBitmap)localObject2).mBorderWidth);
        ...
        if (!((ayye)paramDownloadParams.tag).isSendFromLocal())
        {
          localObject1 = bita.a(paramFile.getAbsolutePath());
          localObject2 = ((ayye)paramDownloadParams.tag).getPicDownloadInfo();
          QLog.i("Q.richmedia." + bdxz.b(((ayxp)localObject2).jdField_b_of_type_Int) + ".dw", 1, "id:" + String.valueOf(((ayxp)localObject2).jdField_a_of_type_Long) + "step: UIDecoder FAIL srcPicMD5:" + (String)localObject1);
        }
        paramFile.delete();
  ...
  public Object a(URL paramURL, File paramFile, DownloadParams paramDownloadParams, BitmapFactory.Options paramOptions)
  {
    // Byte code:
    //   0: aload_3
    //   1: getfield 555	com/tencent/image/DownloadParams:urlStr	Ljava/lang/String;
    //   4: astore 17
    //   6: aload 4
    //   8: aload 4
    //   10: aload_3
    //   11: getfield 702	com/tencent/image/DownloadParams:reqWidth	I
    //   14: aload_3
    //   15: getfield 705	com/tencent/image/DownloadParams:reqHeight	I
    //   18: invokestatic 707	bdsi:b	(Landroid/graphics/BitmapFactory$Options;II)I
    //   21: putfield 301	android/graphics/BitmapFactory$Options:inSampleSize	I
    //   24: aload 4
    //   26: getfield 710	android/graphics/BitmapFactory$Options:outWidth	I
    //   29: istore 7
    //   31: aload 4
    //   33: getfield 713	android/graphics/BitmapFactory$Options:outHeight	I
    //   36: istore 8
    //   38: aload 4
    //   40: iconst_0
    //   41: putfield 561	android/graphics/BitmapFactory$Options:inJustDecodeBounds	Z
    //   44: iconst_0
    //   45: istore 10
    //   47: aconst_null
    //   48: astore 16
    ...
    //   122: aload 4
    //   124: invokestatic 584	com/tencent/image/SafeBitmapFactory:decodeFile	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   127: astore 16
    //   129: aload 16
    //   131: astore_1
    //   132: ldc_w 723
    //   135: aload_3
    //   136: getfield 726	com/tencent/image/DownloadParams:mExtraInfo	Ljava/lang/Object;
    ...
    //   156: invokespecial 649	beak:<init>	(Ljava/lang/String;)V
    //   159: aload 16
    //   161: invokevirtual 650	beak:a	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   164: astore 16
    //   166: aload 16
    //   168: astore_1
    //   169: aload_1
    ...
    //   237: invokespecial 280	bdsi:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   240: iload 10
    //   242: istore 11
    ...
    //   293: invokespecial 733	java/lang/OutOfMemoryError:<init>	(Ljava/lang/String;)V
    //   296: athrow
    //   297: astore 16
    //   299: iload 11
    //   301: istore 10
    ...
    //   304: ifnull +7 -> 311
    //   307: aload_1
    //   308: invokevirtual 646	android/graphics/Bitmap:recycle	()V
    //   311: aload 16
    //   313: ifnull +468 -> 781
    //   316: aload 16
    //   318: invokevirtual 698	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    //   321: astore 16
    ...
    //   404: invokespecial 280	bdsi:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   407: iload 6
    //   409: iconst_1
    //   410: iadd
    //   411: istore 6
    ...
    //   428: iload 10
    //   430: istore 11
    //   432: getstatic 742	android/os/Build$VERSION:SDK_INT	I
    //   435: bipush 11
    //   437: if_icmplt +341 -> 778
    //   440: iload 10
    //   442: istore 11
    //   444: aload_1
    //   445: invokestatic 748	com/tencent/image/SliceBitmap:needSlice	(Landroid/graphics/Bitmap;)Z
    //   448: istore 12
    //   450: iload 12
    //   452: ifeq +326 -> 778
    //   455: iload 10
    //   457: istore 11
    //   459: new 744	com/tencent/image/SliceBitmap
    //   462: dup
    //   463: aload_1
    //   464: invokespecial 749	com/tencent/image/SliceBitmap:<init>	(Landroid/graphics/Bitmap;)V
    //   467: astore 16
    //   469: iconst_1
    //   470: istore 10
    //   472: aload_1
    //   473: invokevirtual 646	android/graphics/Bitmap:recycle	()V
    //   476: aload_0
    //   477: aload_3
    //   478: aload_2
    //   479: aload 17
    ...
    //   485: iconst_1
    //   486: ldc_w 751
    //   489: invokespecial 678	bdsi:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    //   492: aload 16
    //   494: astore_1
    //   495: iconst_1
    //   496: istore 10
    ...
    //   514: iload 11
    //   516: ldc 107
    //   518: invokespecial 678	bdsi:a	(Lcom/tencent/image/DownloadParams;Ljava/io/File;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;IZLjava/lang/String;)V
    //   521: aload_3
    ...
    //   550: astore_3
    //   551: aload_2
    //   552: invokevirtual 752	com/tencent/mobileqq/data/MessageForPic:isSendFromLocal	()Z
    //   555: istore 15
    //   557: aload_1
    //   558: ifnull +235 -> 793
    //   561: iconst_1
    ...
    //   569: istore 9
    //   571: iload 9
    //   573: getstatic 755	com/tencent/common/app/BaseApplicationImpl:sImageCacheSize	I
    ...
    //   598: iconst_1
    //   599: istore 13
    //   601: getstatic 757	bdsi:jdField_a_of_type_Int	I
    //   604: ifeq +9 -> 613
    //   607: getstatic 758	bdsi:jdField_b_of_type_Int	I
    //   610: ifne +35 -> 645
    //   613: aload_0
    //   614: getfield 27	bdsi:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   623: getfield 665	android/util/DisplayMetrics:widthPixels	I
    //   626: putstatic 757	bdsi:jdField_a_of_type_Int	I
    //   629: aload_0
    //   630: getfield 27	bdsi:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   639: getfield 671	android/util/DisplayMetrics:heightPixels	I
    //   642: putstatic 758	bdsi:jdField_b_of_type_Int	I
    //   645: getstatic 757	bdsi:jdField_a_of_type_Int	I
    //   648: getstatic 758	bdsi:jdField_b_of_type_Int	I
    //   651: if_icmple +160 -> 811
    //   654: getstatic 757	bdsi:jdField_a_of_type_Int	I
    //   657: istore 7
    //   659: iload 9
    //   661: getstatic 759	bdzx:jdField_a_of_type_Int	I
    ...
    //   691: aload_3
    //   692: iload 11
    //   694: invokespecial 761	bdsi:a	(ZZZZIILjava/lang/String;Z)V
    //   697: aload_0
    //   698: aload_0
    //   699: getfield 27	bdsi:jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl	Lcom/tencent/common/app/BaseApplicationImpl;
    //   702: aload_3
    //   703: iload 9
    //   705: iload 15
    //   707: invokespecial 763	bdsi:a	(Landroid/app/Application;Ljava/lang/String;IZ)V
    //   710: aload_1
    //   711: ifnonnull +114 -> 825
    //   714: new 317	java/io/IOException
    //   717: dup
    //   718: ldc_w 765
    //   721: invokespecial 695	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   724: athrow
    //   725: astore 16
    //   727: iload 10
    //   729: istore 11
    ...
    //   760: invokespecial 280	bdsi:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   763: iload 10
    //   765: istore 11
    //   767: new 463	java/lang/OutOfMemoryError
    //   770: dup
    //   771: ldc_w 769
    //   774: invokespecial 733	java/lang/OutOfMemoryError:<init>	(Ljava/lang/String;)V
    //   777: athrow
    //   778: goto -280 -> 498
    //   781: aconst_null
    //   782: astore 16
    ...
    //   806: istore 13
    //   808: goto -207 -> 601
    //   811: getstatic 758	bdsi:jdField_b_of_type_Int	I
    //   814: istore 7
    //   816: goto -157 -> 659
    //   819: iconst_0
    //   820: istore 14
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    try
    {
      ...
      localOptions.inPreferredConfig = bdzx.jdField_a_of_type_AndroidGraphicsBitmap$Config;
    ...
    catch (Exception localException)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "actPicUIDecoder", false, -1L, 0L, paramDownloadParams, "", true);
