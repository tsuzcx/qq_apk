  ...
  implements bezd
{
  ...
  public void a(JSONObject paramJSONObject, int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          return;
          if ((bewm.a(this.a) != null) && (paramJSONObject != null)) {
            try
            {
            ...
            {
              bewm.a(this.a).d(bewm.a(this.a).getString(2131719178));
            }
          }
        }
      }
    ...
    return;
    label921:
    paramJSONObject = bewm.a(this.a).getString(2131719178);
    switch (paramInt)
    {
    }
    for (;;)
    {
      bewm.a(this.a).d(paramJSONObject);
      break label820;
      paramJSONObject = bewm.a(this.a).getString(2131719173);
      continue;
      paramJSONObject = bewm.a(this.a).getString(2131719179);
      continue;
      label1008:
      paramInt += 1;
      break;
