...
public class owm
{
  ...
  private otk jdField_a_of_type_Otk;
  ...
  public owm()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = pay.a();
  }
  ...
  {
    if ((paramBaseCommentData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Otk == null)) {
      return;
    }
    label394:
    for (;;)
    {
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new owo(this, paramBaseCommentData, paramInt1, paramInt2));
      ...
      catch (Exception paramString)
      {
        if (this.jdField_a_of_type_Otk != null) {
          this.jdField_a_of_type_Otk.a(false, paramBaseCommentData.commentId, paramInt1, paramInt2);
        }
  ...
  public void a(BaseCommentData paramBaseCommentData, String paramString, int paramInt)
  {
    ...
    catch (Exception paramString)
    {
      for (;;)
      {
        Object localObject;
        if (this.jdField_a_of_type_Otk != null) {
          this.jdField_a_of_type_Otk.a(false, paramBaseCommentData, "");
        }
        paramString.printStackTrace();
        if (!QLog.isColorLevel()) {
          break;
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      ((NewIntent)localObject).putExtra("data", paramString.toByteArray());
      ((NewIntent)localObject).setObserver(new own(this, paramBaseCommentData));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject);
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramBaseCommentData instanceof CommentData))
        {
          ...
          localJSONObject.put("report_uin", pay.a());
          ...
          paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), odw.class);
          ...
          paramString2.setObserver(new owp(this, paramBaseCommentData));
