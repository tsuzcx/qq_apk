  ...
  extends bazb
{
  ...
  public bfao(bbcj parambbcj)
  {
    super(parambbcj);
    parambbcj = parambbcj.jdField_a_of_type_AndroidAppActivity.getIntent();
    int j = parambbcj.getIntExtra("key_subtab", 0);
    parambbcj.removeExtra("key_subtab");
    if (this.jdField_a_of_type_Bbcm.jdField_a_of_type_Int != j) {
      g(j);
    }
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bbcm.jdField_a_of_type_OrgJsonJSONObject != null)
    {
      if (!this.jdField_a_of_type_Bbcm.jdField_a_of_type_OrgJsonJSONObject.has("txtclr"))
      {
        bool = true;
        this.g = bool;
        if (this.jdField_a_of_type_Bbcm.jdField_a_of_type_OrgJsonJSONObject.has("titleclr")) {
          break label563;
        }
        bool = true;
        label113:
        this.h = bool;
        if (this.jdField_a_of_type_Bbcm.jdField_a_of_type_OrgJsonJSONObject.has("bgclr")) {
          break label569;
        }
        bool = true;
        label137:
      ...
      if (this.i)
      {
        ...
        if (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
        {
          ...
          if (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d == null) {
            this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.F();
          }
          if (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)
          {
            this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(-4210753);
            this.jdField_a_of_type_Bbcm.i = true;
          }
        }
      }
      if ((!this.i) || (!this.h) || (!this.g)) {
        this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_Bbcm.jdField_a_of_type_OrgJsonJSONObject, true);
      }
      if ((this.jdField_a_of_type_Bbcm.d & 0x20) != 0L)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
        a("", this.c.getResources().getString(2131625271), "", false, 0, 0, null, null, null);
        this.c.setOnClickListener(new bfap(this));
      }
      if ((this.jdField_a_of_type_Bbcm.d & 0x40) != 0L)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
        RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
        localLayoutParams.addRule(15);
        localLayoutParams.addRule(9);
        localLayoutParams.leftMargin = azvv.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), 15.0F);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(localLayoutParams);
      }
      if (this.jdField_a_of_type_Bbcm.b != -1) {
        break label585;
      }
      if ((this.jdField_a_of_type_Bbcm.d & 1L) <= 0L) {
        break label575;
      }
      b(0);
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar != null) {
        this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar.setVisibility(8);
      }
      return;
      bool = false;
      break;
      ...
      continue;
      label585:
      b(this.jdField_a_of_type_Bbcm.b);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonBackgroundResource(2130849437, 2130849438, 2130849439);
    this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonTextColorStateList(2131101534);
    this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setLeftAndRightPaddingByDp(14);
  }
}
