...
public class kso
{
  private static kso jdField_a_of_type_Kso;
  ...
  private ksp jdField_a_of_type_Ksp = new ksp(this);
  private byte[] jdField_a_of_type_ArrayOfByte = new byte[256];
  
  private int a()
  {
    int i = 0;
    String str = badq.a(BaseApplication.getContext());
    if ("wifi".equals(str)) {
      i = 1;
    }
    for (;;)
        ...
        do
        {
          do
          {
            do
            {
              ...
              {
                return i;
                b(this.jdField_a_of_type_Ksp.jdField_a_of_type_JavaLangString.length());
                j = a(this.jdField_a_of_type_Ksp.jdField_a_of_type_JavaLangString);
                i = j;
              } while (j < 0);
              b(this.jdField_a_of_type_Ksp.jdField_b_of_type_JavaLangString.length());
              j = a(this.jdField_a_of_type_Ksp.jdField_b_of_type_JavaLangString);
              i = j;
            } while (j < 0);
            b(this.jdField_a_of_type_Ksp.jdField_c_of_type_JavaLangString.length());
            j = a(this.jdField_a_of_type_Ksp.jdField_c_of_type_JavaLangString);
            i = j;
          } while (j < 0);
          b(this.jdField_a_of_type_Ksp.f.length());
          j = a(this.jdField_a_of_type_Ksp.f);
          i = j;
        } while (j < 0);
        b(this.jdField_a_of_type_Ksp.d.length());
        j = a(this.jdField_a_of_type_Ksp.d);
        i = j;
      } while (j < 0);
      b(this.jdField_a_of_type_Ksp.e.length());
      j = a(this.jdField_a_of_type_Ksp.e);
      i = j;
    } while (j < 0);
    a(this.jdField_a_of_type_Ksp.jdField_c_of_type_Long);
    a(this.jdField_a_of_type_Ksp.jdField_a_of_type_Long);
    a(this.jdField_a_of_type_Ksp.jdField_a_of_type_Int);
    a(this.jdField_a_of_type_Ksp.jdField_b_of_type_Long);
    a(this.jdField_a_of_type_Ksp.jdField_b_of_type_Int);
    a(paramInt);
    return 0;
  }
  ...
  public static kso a()
  {
    if (jdField_a_of_type_Kso == null) {
      jdField_a_of_type_Kso = new kso();
    }
    return jdField_a_of_type_Kso;
  }
  ...
  {
    int i = 0;
    if (this.jdField_a_of_type_Ksp == null) {
      paramInt2 = -1;
    }
    do
    {
      return paramInt2;
      int j = a();
      this.jdField_a_of_type_Ksp.e = jdField_a_of_type_ArrayOfJavaLangString[j];
      this.jdField_a_of_type_Ksp.d = a();
      this.jdField_a_of_type_Ksp.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_Ksp.jdField_b_of_type_Int = paramInt2;
      if (paramLong != 0L) {
        this.jdField_a_of_type_Ksp.jdField_b_of_type_Long = paramLong;
      }
      ...
      a(this.jdField_a_of_type_Ksp.jdField_a_of_type_Long, arrayOfByte);
      this.jdField_a_of_type_Int = 0;
      paramInt2 = i;
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    this.jdField_a_of_type_Ksp.jdField_b_of_type_Long = paramLong3;
    this.jdField_a_of_type_Ksp.jdField_a_of_type_Long = paramLong2;
    this.jdField_a_of_type_Ksp.jdField_c_of_type_Long = paramLong1;
    this.jdField_a_of_type_Ksp.jdField_c_of_type_JavaLangString = String.valueOf(AppSetting.a());
    this.jdField_a_of_type_Ksp.f = AppSetting.d();
  }
}
