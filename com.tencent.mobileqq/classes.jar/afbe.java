...
public class afbe
  extends ajmm
{
  public afbe(NotificationView paramNotificationView) {}
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.a.jdField_a_of_type_Afaz != null)
          {
            this.a.jdField_a_of_type_Afaz.a(this.a.jdField_a_of_type_JavaUtilList);
            ...
            if (this.a.b)
            {
              ...
              this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(ajed.V, 9000, 0 - axcz.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
              axcz.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
    ...
    paramList = this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131654099);
    bbmy.a(this.a.jdField_a_of_type_AndroidContentContext, 1, paramList, 0).b(this.a.a());
  }
