...
public class awli
{
  private static awli jdField_a_of_type_Awli;
  public static boolean a;
  private awlj jdField_a_of_type_Awlj;
  ...
  public static awli a()
  {
    if (jdField_a_of_type_Awli == null) {
      jdField_a_of_type_Awli = new awli();
    }
    return jdField_a_of_type_Awli;
  }
  
  public static URLDrawable a(String paramString, int paramInt1, int paramInt2)
  {
    URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
    localURLDrawableOptions.mLoadingDrawable = new ascz(-10065297, 100, 100);
    localURLDrawableOptions.mFailedDrawable = new ascz(-10065297, 100, 100);
  ...
  public static URLDrawable a(String paramString1, String paramString2, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt3, QQLiveDrawable.OnStateListener paramOnStateListener, URLDrawable paramURLDrawable)
  {
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = new ascz(-10065297, 100, 100);
    ...
    for (paramString1.mLoadingDrawable = paramURLDrawable;; paramString1.mLoadingDrawable = new ascz(-10065297, 100, 100))
    {
      paramString1.mRequestWidth = paramInt1;
      paramString1.mRequestHeight = paramInt2;
      return URLDrawable.getDrawable(ahqw.a(paramLong), paramString1);
    }
  }
  ...
  public void a(awlj paramawlj)
  {
    this.jdField_a_of_type_Awlj = paramawlj;
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Awlj != null) {
      this.jdField_a_of_type_Awlj.a(paramBoolean);
    }
  }
