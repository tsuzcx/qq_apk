...
public class twu
{
  ...
  {
    tto.a(String.valueOf(paramJSONObject.optInt("bid", 3256)), new tww(paramBridgeModule, paramString));
  }
  ...
  public static void B(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      nuz.a(localArrayList, pkh.a(), new twx(paramBridgeModule, paramString), true, false);
      return;
    }
  ...
  public static void C(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramJSONObject = nuz.a(paramJSONObject.optString("bid"));
  ...
  public static void E(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    localReadInJoyUserInfoModule.a(localArrayList, new txd(localArrayList, paramString, paramBridgeModule));
  }
  ...
  private static HashMap<String, Object> a(JSONObject paramJSONObject)
  {
    if (paramJSONObject != null)
    {
      ...
      if (TextUtils.isEmpty(paramJSONObject.optString("bgclr"))) {
        localHashMap.put(tvg.d, paramJSONObject.optString("bgclr"));
      }
      if (TextUtils.isEmpty(paramJSONObject.optString("txtclr"))) {
        localHashMap.put(tvg.c, paramJSONObject.optString("txtclr"));
      }
      if (!TextUtils.isEmpty(paramJSONObject.optString("titleclr"))) {
        localHashMap.put(tvg.e, paramJSONObject.optString("titleclr"));
      }
      if (!TextUtils.isEmpty(paramJSONObject.optString("alpha"))) {
        localHashMap.put(tvg.f, paramJSONObject.optString("alpha"));
      }
      if (!TextUtils.isEmpty(paramJSONObject.optString("statusBarColor"))) {
        localHashMap.put(tvg.g, paramJSONObject.optString("statusBarColor"));
      }
      return localHashMap;
    }
    return null;
  ...
  {
    JSONObject localJSONObject = new JSONObject();
    Object localObject3 = (QQAppInterface)pkh.a();
    String str;
  ...
  {
    if (((QQAppInterface)pkh.a() != null) && (paramActivity != null))
    {
  ...
  {
    pqx.a(paramContext, paramString, paramBundle);
  }
  ...
  private static void a(ArticleInfo paramArticleInfo, JSONObject paramJSONObject, Intent paramIntent, long paramLong1, long paramLong2, int paramInt1, String paramString, int paramInt2, BridgeModule paramBridgeModule)
  {
    ...
    Object localObject = "";
    if (i == 1) {
      localObject = new String(bhcu.decode(paramJSONObject.optString("newComment"), 2));
    }
    if (i == 1)
    {
      paramJSONObject = (JSONObject)localObject;
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList != null)
      {
        paramJSONObject = (JSONObject)localObject;
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList.size() > 0) {
      ...
      if (localObject != null) {
        ((pvp)((QQAppInterface)localObject).getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER)).a().a(pkh.a(), paramLong1, paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw, 0L, paramJSONObject, paramLong2, -1L, paramInt1, paramString, paramInt2, paramArticleInfo);
      }
  ...
  {
    paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq = new rrq();
    a(paramJSONObject, paramArticleInfo);
    paramArticleInfo.mTitle = new String(bhcu.decode(paramString1, 0));
    paramArticleInfo.mSummary = "";
    if ((paramInt1 == 3) || (paramInt1 == 2))
    {
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      paramString1 = new rrr();
      ...
      if ((paramJSONObject != null) && (paramJSONObject.length() > 0))
      {
        ...
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_JavaUtilArrayList.add(paramString1);
      }
    }
    for (;;)
    {
      if (paramInt2 == 22)
      {
        ...
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Rqt = paramJSONObject;
      }
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Int = paramInt1;
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_JavaLangString = paramArticleInfo.mTitle;
      return;
      if ((paramInt1 == 4) || (paramInt1 == 5))
      {
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b = new ArrayList();
        paramString1 = new rrs();
        ...
        if (paramJSONObject != null)
        {
          ...
          paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b.add(paramString1);
        }
      }
      else if (paramInt1 == 1)
      {
  ...
  private static void a(BridgeModule paramBridgeModule, String paramString, File paramFile)
  {
    ...
    paramFile = new bhyo(paramString, paramFile);
    paramFile.d = 60L;
    ((bhyq)pkh.a().getManager(QQManagerFactory.DOWNLOADER_FACTORY)).a(1).a(paramFile, new txj(paramBridgeModule, paramString), localBundle);
  }
  ...
  public static void a(BridgeModule paramBridgeModule, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, String paramString3, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("network", pih.a(paramBridgeModule.getViolaInstance().getActivity()));
      ...
      catch (Exception paramString1)
      {
        ...
        olh.a(null, "", "0X8009546", "0X8009546", 0, 0, "", paramString5, "", paramBridgeModule.a().a(), false);
      }
      paramBridgeModule = new suu(paramBridgeModule);
      if (paramInt4 != 4) {
        continue;
      }
      olh.a(null, "", "0X8009546", "0X8009546", 0, 0, "", paramString4, paramString3, paramBridgeModule.a().a(), false);
      return;
      if (paramInt4 == 11) {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramString1))
      {
        if (!TextUtils.isEmpty(paramString2)) {
          paramBridgeModule.invokeErrorCallJS(paramString2, anvx.a(2131700692));
        }
      }
      else
      {
        if ((paramString1.contains("weishi")) || (paramString1.contains("weishi://feed"))) {
          if (zfn.a(localBaseActivity)) {
            uwq.a(localBaseActivity, "video_type_videopublic");
          }
        }
        while (!TextUtils.isEmpty(paramString2))
        {
          ...
          return;
          QQToast.a(localBaseActivity, -1, anvx.a(2131700698), 0).b(localBaseActivity.getResources().getDimensionPixelSize(2131299080));
          uwq.b(localBaseActivity, "video_type_videopublic");
          continue;
          if (!uks.a(localBaseActivity, paramString1))
          {
  ...
  public static void a(BridgeModule paramBridgeModule, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      bool = bhfn.a(localBaseActivity, paramString1);
      continue;
      label122:
      i = 0;
    }
  ...
  {
    BaseActivity localBaseActivity = BaseActivity.sTopActivity;
    paramBridgeModule = new twy(paramBridgeModule, paramString);
    if (localBaseActivity == null)
    {
      paramBridgeModule.a(null, new acap(5));
      return;
    }
    ...
    uku.a().a(localBaseActivity, paramString, l1, l2, i, j, paramBridgeModule);
  }
  ...
  public static void a(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        String str2 = new String(bhcu.decode(paramJSONObject.optString("title", ""), 0));
        ...
        if (Boolean.valueOf(bool3).booleanValue())
        {
          ...
          localBundle.putString("scroll_image_r5", pqf.a(i, -1, Integer.toString(n), m, "", "", null));
          localBundle.putString("read_article_r5", pqf.a(i, -1, Integer.toString(n), m, "", null));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (paramFragment = ((ViolaFragment)paramFragment).getTtileChangelistener();; paramFragment = null)
        {
          ...
          if (str.equals("right"))
          {
            paramFragment.a(paramJSONObject, new txa(paramBridgeModule, paramString));
            return;
          }
          if (!str.equals("left")) {
            break;
          }
          paramFragment.b(paramJSONObject, new txb(paramBridgeModule, paramString));
          return;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      catch (Exception paramJSONObject)
      {
        try
        {
          ...
          j = k;
          localObject = str1;
          uku.a().a(localBaseActivity, i, (String)localObject, j, paramString, paramJSONObject);
          return;
        }
        catch (Exception paramJSONObject)
        {
  ...
  public static void a(JSONObject paramJSONObject)
  {
    BaseActivity localBaseActivity = BaseActivity.sTopActivity;
    if (localBaseActivity != null) {
      tto.a(localBaseActivity, paramJSONObject);
    }
  }
  ...
  private static void a(JSONObject paramJSONObject, ArticleInfo paramArticleInfo)
  {
    ...
    if (paramJSONObject != null)
    {
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Rqw = new rqw();
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList = new ArrayList();
      int i = 0;
      for (;;)
      {
        if (i < paramJSONObject.length())
        {
          ...
          localBiuCommentInfo.mOrigBiuComment = new String(bhcu.decode(((JSONObject)localObject).optString("comment"), 0));
          ...
          if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2))) {
            localBiuCommentInfo.jumpInfo = new SocializeFeedsInfo.JumpInfo(0L, new String(bhcu.decode(str1, 0)), str2);
          }
          try
          {
            ...
            paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo);
            i += 1;
          }
  ...
  private static void a(JSONObject paramJSONObject, ArticleInfo paramArticleInfo, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      ...
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw = new rqw();
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaLangLong = Long.valueOf(paramLong1);
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b = Long.valueOf(paramLong2);
      paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList = new ArrayList();
    } while (paramJSONObject == null);
    int i = 0;
    while (i < paramJSONObject.length())
    {
      ...
      try
      {
        ...
        paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo);
        i += 1;
      }
      catch (Exception localException)
      {
  ...
  public static void a(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramJSONObject = new String(bhcu.decode((String)localObject, 0));
  ...
  public static void a(JSONObject paramJSONObject, String paramString, BridgeModule paramBridgeModule)
  {
    ...
    try
    {
      localObject1 = new String(bhcu.decode((String)localObject8, 0));
    }
    ...
    try
    {
      localObject2 = new String(bhcu.decode((String)localObject3, 0));
    }
    ...
    try
    {
      ...
      str2 = new String(bhcu.decode(paramJSONObject.optString("accountDesc"), 0));
      ...
      if ((localJSONObject == null) || (!ppe.a(m, l3))) {
        break label1065;
      }
  ...
  private static void b(BridgeModule paramBridgeModule, File paramFile)
  {
    ...
    aupt.a(paramBridgeModule, (Intent)localObject, 18);
  }
  ...
  public static void b(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        ((StringBuilder)localObject).append("&uin=" + pkh.a());
        paramString = asdi.a("VIP_xingying", ((StringBuilder)localObject).toString());
        if (QLog.isColorLevel()) {
  ...
  public static void b(JSONObject paramJSONObject)
  {
    ...
    {
      olh.a(null, null, str, str, 0, 0, paramJSONObject, (String)localObject1, (String)localObject2, (String)localObject3, false);
      return;
      label114:
      paramJSONObject = "";
      break;
  ...
  public static void c(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    ntb.a(pkh.a(), new txc(paramBridgeModule, paramString), localReqBody.toByteArray(), "OidbSvc.0xe36", 3638, 1, new Bundle(), 5000L);
  }
  
  private static void c(BridgeModule paramBridgeModule, String paramString1, String paramString2)
  {
    LbsManagerService.startLocation(new twz(paramString1, paramBridgeModule, paramString2));
  }
  ...
  public static void c(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      pvj.a().a(str, Integer.valueOf(paramJSONObject).intValue());
      paramBridgeModule.invokeCallJS(paramString, null);
      return;
    }
    catch (Exception paramBridgeModule)
  ...
  public static void c(JSONObject paramJSONObject, String paramString)
  {
    ...
    tto.a(BaseActivity.sTopActivity, "", paramString, localBundle);
  }
  ...
  public static void g(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    ((ViolaFragment)localObject).setTitleContainerClick(new txi(paramBridgeModule, paramString));
  }
  ...
  public static void g(JSONObject paramJSONObject)
  {
    try
    {
      acho.a("BridgeModuleHelper", paramJSONObject.toString());
      achv.a(paramJSONObject.optInt("operationType"), paramJSONObject.optInt("businessType"), (qq_ad_get.QQAdGetRsp.AdInfo)achn.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramJSONObject.getJSONObject("adInfo")));
      return;
    }
    catch (Exception paramJSONObject)
    {
      acho.d("BridgeModuleHelper", "handleJsCallRequest", paramJSONObject);
    }
  }
  ...
  public static void h(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    {
      QQToast.a(pkh.a().getApplication(), 1, anvx.a(2131700697), 0).a();
      return;
    }
  ...
  {
    Object localObject = (AppInterface)pkh.a();
    ...
    try
    {
      ...
      if (pqq.a() >= 2)
      {
        QQToast.a(paramBridgeModule, 0, paramBridgeModule.getString(2131717717), 0).b(paramBridgeModule.getResources().getDimensionPixelSize(2131299080));
        return;
      }
    }
    catch (Exception paramJSONObject)
    {
      ...
      oxf.a(paramBridgeModule, (Bundle)localObject, (byte)116);
      pqq.a("2", "2");
    }
  }
  ...
  public static void i(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      localObject3 = new String(bhcu.decode((String)localObject2, 0));
      localObject2 = localObject3;
    }
    catch (Exception localException2)
    {
    ...
    pcp.a(paramBridgeModule, (Intent)localObject3, 117);
  }
  ...
  public static void i(JSONObject paramJSONObject)
  {
    ...
    for (float f1 = FlexConvertUtils.converPxByViewportToRealPx(paramJSONObject.opt("width"), 750);; f1 = 100.0F)
    {
      ...
      paramJSONObject = URLDrawable.getDrawable(str, tuv.a(bool, (int)f1, (int)f2));
  ...
  public static void j(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (str3.isEmpty())
    {
      ...
      paramJSONObject.b(n);
      localIntent.putExtra("comment_create_data", paramJSONObject);
      pcp.a(paramBridgeModule, localIntent, 126);
      return;
    }
  }
  ...
  public static void k(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("result", bhyk.a());
      paramBridgeModule.invokeCallJS(paramString, localJSONObject);
      return;
    }
    catch (Exception paramBridgeModule)
  ...
  public static void k(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    rao.a.a().a(i, bool1, bool2, str, j, paramJSONObject, new txe(paramBridgeModule, paramString));
  }
  ...
  public static void m(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      for (;;)
      {
        QQToast.a((Context)localObject, i, str, 0).b(((Context)localObject).getResources().getDimensionPixelSize(2131299080));
  ...
  public static void n(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      if (!TextUtils.isEmpty(str1))
      {
        ...
        paramJSONObject.putString("big_brother_ref_source_key", pqx.a(0));
      }
    }
    for (;;)
    {
  ...
  public static void p(BridgeModule paramBridgeModule, String paramString)
  {
    ...
    {
      return;
      Object localObject = uwq.b(paramString);
      if (localObject != null)
      {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("big_brother_source_key", pqx.a(0));
  ...
  public static void p(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    QQCustomDialog localQQCustomDialog = new QQCustomDialog(localBaseActivity, 2131755829);
    ...
    if (paramJSONObject.optBoolean("needOkBtn", true)) {
      localQQCustomDialog.setPositiveButton(paramJSONObject.optString("okBtnText", anvx.a(2131700691)), new txf(paramJSONObject, paramBridgeModule, paramString));
    }
    if (paramJSONObject.optBoolean("needCancelBtn", true)) {
      localQQCustomDialog.setNegativeButton(paramJSONObject.optString("cancelBtnText", anvx.a(2131700687)), new txg(paramJSONObject, paramBridgeModule, paramString));
    }
  ...
  public static void q(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    tto.a(localBaseActivity, paramJSONObject, new txh(paramBridgeModule, paramString));
  }
  ...
  public static void s(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramBridgeModule.invokeErrorCallJS(paramString, anvx.a(2131700700));
  }
  ...
  public static void t(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      paramBridgeModule.invokeCallJS(paramString, localJSONObject);
      QQToast.a(pkh.a().getApplication(), 1, anvx.a(2131700701), 0).a();
      return;
    }
    catch (Exception paramBridgeModule)
    {
  ...
  public static void v(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      paramJSONObject = paramJSONObject.optString("apkUrl");
      localObject = bjjq.a().b(paramJSONObject);
      j = -1;
      i = 0;
      if (localObject != null)
      {
  ...
  public static void x(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      else
      {
        ...
        if (localObject2 != null)
        {
          bfxp.a((Activity)localObject2, j, paramJSONObject, null, null, false, bool, (String)localObject1, 100, null, null, null, null, "", true);
          paramBridgeModule.invokeCallJS(paramString, null);
          return;
        }
      }
  ...
  public static void y(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      CheckPermission.requestSDCardPermission((AppActivity)localActivity, new twv(paramBridgeModule, paramJSONObject, paramString));
      return;
    }
  ...
  public static void z(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append("&device=" + Build.DEVICE);
      ((StringBuilder)localObject).append("&uin=" + pkh.a());
      paramJSONObject = asdi.a("VIP_xingying", ((StringBuilder)localObject).toString());
      if (QLog.isColorLevel()) {
