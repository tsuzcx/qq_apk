  ...
  extends pbe
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = pby.class.getSimpleName();
  }
  
  public pby(AppInterface paramAppInterface, aukp paramaukp, ExecutorService paramExecutorService, por parampor, Handler paramHandler)
  {
  ...
  private void a(int paramInt, BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    do
    {
      ...
      localotm = (otm)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(274);
    } while (localotm == null);
    long l = NetConnInfoCenter.getServerTime();
    localotm.a(sgg.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramBaseVideoArticleInfo), l);
  }
  ...
  private void a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<WeiShiVideoArticleInfo> paramList, long paramLong1, long paramLong2)
  {
    ...
    osj.a().b(true, paramInt, paramList, paramBoolean1);
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ...
      paramFromServiceMsg = qul.a(localRspBody.rspChannelArticle.rpt_article_list.get(), i, j);
      bool2 = true;
    }
    for (;;)
    {
  ...
  private void b(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<WeiShiVideoArticleInfo> paramList, long paramLong1, long paramLong2, ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      paramList = b(Integer.valueOf(paramInt));
      osj.a().a(paramBoolean1, paramInt, paramList, paramBoolean2);
      return;
  ...
  List<WeiShiVideoArticleInfo> a(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject = this.jdField_a_of_type_Aukp.a(WeiShiVideoArticleInfo.class, true, str, new String[] { String.valueOf(paramInt1), String.valueOf(paramLong) }, null, null, "recommendSeq desc", String.valueOf(paramInt2));
      if (localObject != null) {
  ...
  public List<WeiShiVideoArticleInfo> a(Integer paramInteger)
  {
    ...
    Collections.sort(localArrayList, new pbz(this));
    return localArrayList;
  }
  ...
  public void a(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if (j < paramInt2)
    {
      Collections.sort((List)localObject1, new pca(this));
      int i = 0;
      for (;;)
      {
        if (i >= paramInt2 - j) {
