  ...
  implements axay
{
  ...
  public auux(QQAppInterface paramQQAppInterface)
  {
  ...
  private SummaryCardUpdate.SUpdateReq a(int paramInt, String paramString)
  {
    ...
    localSUpdateReq.client_version.set("8.3.0");
  ...
  private void a(File paramFile)
  {
    ...
    //   151: dup
    //   152: aload_0
    //   153: getfield 18	auux:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   156: invokevirtual 239	com/tencent/mobileqq/app/QQAppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   159: invokestatic 244	bbac:a	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   204: aload_0
    //   205: aload_1
    //   206: invokespecial 260	auux:a	(Ljava/lang/String;)V
    //   209: aload 4
    //   211: ifnull -76 -> 135
    //   214: aload 4
  ...
  private void a(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      bbdx.a(new File(BaseApplicationImpl.getApplication().getFilesDir(), "labelList").getAbsolutePath(), localByteArrayOutputStream.toByteArray(), false);
    }
  }
  ...
  private boolean e()
  {
    ...
    try
    {
      ...
      {
        QLog.d("ProfileCard.ProfileCardCheckUpdate", 2, bool1);
        localObject = new File(bbac.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()));
        if (l2 <= l1)
        {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    QLog.d("ProfileCard.ProfileCardCheckUpdate", 2, "getCheckUpdateItemData uin=" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin() + ",cardVersion=" + str1 + "labelVersion=" + str2 + ",client_version=" + "8.3.0" + ",dataLen=" + i);
    return localReqItem;
  }
      ...
      if (i == 2) {
        for (;;)
        {
          try
          {
            ...
            i = (int)bbmx.a((byte[])localObject, 0);
            paramRespItem = new byte[i - 4];
            bbmx.a(paramRespItem, 0, (byte[])localObject, 4, i - 4);
  ...
  public void a(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bdes.a().a("SummaryCardUpdate.EM_RT_FUN_CALL", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajya.a(2131708461), true);
  }
  ...
  public void b(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bdes.a().a("SummaryCardUpdate.EM_RT_SPECIAL_REMIND", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajya.a(2131708496), true);
  }
  ...
  public void d(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bdes.a().a("SummaryCardUpdate.EM_RT_SUMMARY_LABEL", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajya.a(2131708466), true);
  }
  ...
  public void e(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bdes.a().a("SummaryCardUpdate.EM_RT_SUMMARY_UPDATE", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajya.a(2131708486), true);
  }
}
