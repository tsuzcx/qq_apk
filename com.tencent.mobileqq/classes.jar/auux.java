...
public class auux
{
  ...
  private Map<Integer, auuy> e = new ConcurrentHashMap();
  ...
  public auux(AppInterface paramAppInterface)
  {
  ...
  {
    return ajsf.cm + "defaultCard" + File.separator + paramString + ".json";
  }
  ...
  {
    return bazo.c(paramContext) + paramLong + ".zip";
  }
  ...
  public auuy a(int paramInt, boolean paramBoolean)
  {
    try
    {
      auuy localauuy = (auuy)this.e.get(Integer.valueOf(paramInt));
      if (localauuy == null)
      {
        localauuy = new auuy(this, paramInt);
        this.e.put(Integer.valueOf(paramInt), localauuy);
      }
      for (;;)
      {
        Object localObject2;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        try
        {
          bbdj.a(paramQQAppInterface.getAbsolutePath(), paramString1, false);
          ...
          if (paramString2.exists())
          {
            ...
            bbdj.a(paramString2.getAbsolutePath(), str, false);
