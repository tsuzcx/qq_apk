...
public class azci
{
  ...
  /* Error */
  public static azci a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   145: aload 9
    //   147: iload 4
    //   149: invokespecial 82	azch:<init>	(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    //   181: new 2	azci
    //   184: dup
    //   185: invokespecial 93	azci:<init>	()V
    //   188: astore 6
    //   190: aload 6
    //   192: aload 7
    //   194: putfield 17	azci:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   197: iload_3
    //   198: iconst_1
    ...
    //   205: aload 6
    //   207: iload 5
    //   209: putfield 95	azci:jdField_a_of_type_Boolean	Z
  ...
  private void a()
  {
    azch localazch1 = new azch(1, "龙王", "https://qzonestyle.gtimg.cn/aoi/sola/20191120171544_qH5yiCN09y.png", 1);
    azch localazch2 = new azch(2, "群聊之火", "https://qzonestyle.gtimg.cn/aoi/sola/20191120171544_AkSb8OcLTK.png", 2);
    azch localazch3 = new azch(3, "群聊炽焰", "https://qzonestyle.gtimg.cn/aoi/sola/20191120171544_y7aXCKODwF.png", 3);
    a(localazch1);
    a(localazch2);
    a(localazch3);
  }
  
  public azch a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null) {
      return (azch)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramazch.a, paramazch);
    }
  }
