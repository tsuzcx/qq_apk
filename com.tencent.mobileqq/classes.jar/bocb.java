...
public class bocb
  implements bocf, bocl
{
  private int jdField_a_of_type_Int = 0;
  private bock jdField_a_of_type_Bock = new bock();
  ...
  private bock jdField_b_of_type_Bock = new bock();
  private String jdField_b_of_type_JavaLangString;
  private boolean jdField_b_of_type_Boolean;
  private byte[] jdField_b_of_type_ArrayOfByte;
  private String c;
  
  public bocb(String paramString1, String paramString2, String paramString3)
  {
  ...
  public bock a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecVideoSourceHelper != null) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_b_of_type_Bock.jdField_a_of_type_ArrayOfByte = this.jdField_b_of_type_ArrayOfByte;
      this.jdField_b_of_type_Bock.jdField_a_of_type_Int = 0;
      this.jdField_b_of_type_Bock.jdField_b_of_type_Int = i;
      this.jdField_b_of_type_Bock.jdField_b_of_type_Boolean = false;
      bock localbock = this.jdField_b_of_type_Bock;
      if (i > 0) {}
      for (;;)
      {
        localbock.jdField_a_of_type_Boolean = bool;
        localbock = this.jdField_b_of_type_Bock;
        this.jdField_b_of_type_Bock.c = -1;
        localbock.jdField_a_of_type_Long = -1;
        this.jdField_b_of_type_Bock.jdField_a_of_type_Float = -1.0F;
        if (QLog.isColorLevel()) {
          QLog.d("HwEncodeHelper", 4, "getAudioFrame() bufferSize=" + this.jdField_b_of_type_ArrayOfByte.length + ", readSize=" + i);
        }
        this.jdField_a_of_type_Boolean = this.jdField_b_of_type_Bock.jdField_a_of_type_Boolean;
        return this.jdField_b_of_type_Bock;
        bool = true;
      }
    }
    return null;
  ...
  public bock a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecVideoSourceHelper != null) && (!this.jdField_b_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_Bock.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
      this.jdField_a_of_type_Bock.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_Bock.jdField_b_of_type_Int = paramInt;
      this.jdField_a_of_type_Bock.jdField_b_of_type_Boolean = true;
      bock localbock = this.jdField_a_of_type_Bock;
      if (paramInt > 0) {
        bool = false;
      }
      localbock.jdField_a_of_type_Boolean = bool;
      this.jdField_a_of_type_Bock.jdField_a_of_type_Long = this.jdField_a_of_type_ArrayOfLong[0];
      this.jdField_a_of_type_Bock.c = -1;
      this.jdField_a_of_type_Bock.jdField_a_of_type_Float = -1.0F;
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bock.jdField_a_of_type_Boolean;
      return this.jdField_a_of_type_Bock;
    }
    return null;
  }
