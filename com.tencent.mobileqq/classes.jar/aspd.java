  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  URLDrawable.URLDrawableListener jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener = new aspf(this);
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new aspe(this);
  ...
  public aspd(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, EditText paramEditText, BaseChatPie paramBaseChatPie)
  {
  ...
  public void d()
  {
    ...
    if (k > 0)
    {
      ...
      label228:
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "View_associate", 0, 0, a() + "", "", localStringBuilder1.toString(), this.jdField_a_of_type_JavaLangString);
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "View_associate_2", 0, 0, a() + "", "", localStringBuilder2.toString(), this.jdField_a_of_type_JavaLangString);
      if (localStringBuilder3.length() > 0)
      {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "View_associate", 0, 0, a() + "", "", localStringBuilder3.toString(), this.jdField_a_of_type_JavaLangString);
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "View_associate_2", 0, 0, a() + "", "", localStringBuilder4.toString(), this.jdField_a_of_type_JavaLangString);
      }
      if (QLog.isColorLevel()) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (paramView == null)
      {
        localObject1 = new aspg(null);
        ((aspg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = new EmojiStickerManager.EmotionKeywordLayout(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
        paramView = new ViewGroup.LayoutParams(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
        ((aspg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(paramView);
        ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView = new URLImageView(this.jdField_a_of_type_AndroidContentContext);
        paramView = new RelativeLayout.LayoutParams(this.jdField_c_of_type_Int, this.jdField_d_of_type_Int);
        paramView.addRule(13, -1);
        ((aspg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView, paramView);
        ((aspg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar = new ProgressBar(this.jdField_a_of_type_AndroidContentContext);
        ((aspg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setIndeterminateDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839410));
        paramView = new RelativeLayout.LayoutParams((int)(this.jdField_a_of_type_Float * 30.0F), (int)(this.jdField_a_of_type_Float * 30.0F));
        paramView.addRule(13, -1);
        ((aspg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((aspg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar, paramView);
        paramView = ((aspg)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout;
      ...
      for (;;)
      {
        ...
        break;
        localObject1 = (aspg)paramView.getTag();
      }
      ((aspg)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon = localEmoticon;
      ((aspg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      if (((aspg)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId.equals("NONE")) {
        break label849;
      }
      ...
      {
        this.jdField_a_of_type_Axfj.b((EmotionKeyword)localObject2, false);
        this.jdField_a_of_type_Axfj.a((EmotionKeyword)localObject2, false);
    ...
    label755:
    ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject3);
    ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(this.jdField_a_of_type_ComTencentImageURLDrawableDownListener);
    ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setTag(((aspg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar);
    ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusable(true);
    ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusableInTouchMode(true);
    ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(localEmoticon.name);
    ...
    for (;;)
    {
      ...
      break;
      label837:
      ((aspg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(4);
      break label755;
      label849:
      ((aspg)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject != null) && ((localObject instanceof aspg))) {}
    for (localObject = (aspg)localObject;; localObject = null)
    {
      if (localObject == null) {}
      do
      {
        do
        {
          ...
          return;
          localObject = ((aspg)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticon;
        ...
        this.jdField_a_of_type_Axfj.b(localEmotionKeyword, true);
        this.jdField_a_of_type_Axfj.a(localEmotionKeyword, true);
        if (QLog.isColorLevel()) {
        ...
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Clk_associate", 0, 0, a() + "", ((Emoticon)localObject).epId, ((Emoticon)localObject).eId + "_" + i, this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        aean.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Emoticon)localObject);
        break;
  ...
  public boolean onLongClick(View paramView)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c != null) && (EmojiStickerManager.e))
    {
      ...
      localStickerFrameLayout.setId(2131374223);
      ...
      if ((paramView.getTag() instanceof aspg))
      {
        paramView = ((aspg)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqDataEmoticon;
      ...
      paramView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847171));
      ...
      localStickerFrameLayout.addView(paramView, localLayoutParams);
      paramView.setVisibility(4);
      paramView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130848570));
      int k = (int)(5.0F * f);
      int i = (int)(110.0F * f);
      int j = (int)(110.0F * f);
