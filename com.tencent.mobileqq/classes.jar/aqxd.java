...
class aqxd
  extends QIPCModule
{
  public aqxd(aqxc paramaqxc, String paramString)
  {
    super(paramString);
  }
  ...
  {
    bfhg.c("WeiyunDownloadServiceIPC", "onCall action|" + paramString + " params|" + paramBundle + " callbackId|" + paramInt);
    Object localObject;
    ...
    if (paramBundle == null)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        aqxc.a = (String)localObject;
      }
      if (!TextUtils.isEmpty(paramString))
      {
        localQQAppInterface = aqxc.a(this.a);
        if (localQQAppInterface != null) {
          break label103;
        }
        bfhg.c("WeiyunDownloadServiceIPC", "onCall action but appInterface is null");
      }
    }
    label103:
    do
    {
      do
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          bfhg.c("WeiyunDownloadServiceIPC", "onCall action but file_id is null");
          return null;
        }
      ...
      localObject = arni.a(paramBundle);
      ...
      aqxc.a(this.a).put(paramString, Long.valueOf(((FileManagerEntity)localObject).nSessionId));
      if (arni.b(((FileManagerEntity)localObject).getFilePath()))
      {
        ...
        QIPCServerHelper.getInstance().callClient(aqxc.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Suc", paramString, null);
        paramString = new Bundle();
        paramString.putString("taskId", ((FileManagerEntity)localObject).miniAppDownloadId);
        paramString.putInt("retCode", 1);
        paramString.putString("retMsg", "");
        QIPCServerHelper.getInstance().callClient(aqxc.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Complete", paramString, null);
        return null;
      }
    ...
    localQQAppInterface.a().a(((Long)aqxc.a(this.a).get(paramString)).longValue());
    return null;
  }
}
