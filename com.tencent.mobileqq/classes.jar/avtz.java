...
public class avtz
{
  ...
  public static ArrayList<avtx> a()
  {
    int i = 0;
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (String)auwq.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)auwq.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            avtx localavtx2 = new avtx();
            localavtx2.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("id");
            if ((!bool) && (localavtx2.jdField_a_of_type_Int != 1) && (localavtx2.jdField_a_of_type_Int != 2)) {
              break label337;
            }
            localavtx2.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("icon");
            localavtx2.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
            localavtx2.c = ((JSONObject)localObject2).optString("subTitle");
            localavtx2.d = ((JSONObject)localObject2).optString("jumpUrl");
            localArrayList.add(localavtx2);
          }
        }
        catch (Exception localException)
        {
          ...
          {
            avtx localavtx1 = new avtx();
            localavtx1.jdField_a_of_type_Int = 1;
            localavtx1.jdField_b_of_type_Int = 2130841078;
            localavtx1.jdField_b_of_type_JavaLangString = alud.a(2131707768);
            localArrayList.add(localavtx1);
            localavtx1 = new avtx();
            localavtx1.jdField_a_of_type_Int = 2;
            localavtx1.jdField_b_of_type_Int = 2130841077;
            localavtx1.jdField_b_of_type_JavaLangString = alud.a(2131707769);
            localArrayList.add(localavtx1);
          }
  ...
  public static void a(Context paramContext, avtx paramavtx, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramavtx.jdField_a_of_type_Int);
    }
    switch (paramavtx.jdField_a_of_type_Int)
    {
    default: 
      a(paramContext, paramavtx.d);
      return;
    case 1: 
      a(paramContext);
      return;
  ...
  {
    autz localautz = autz.a(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
    if (localautz != null)
    {
      if (autz.a(paramContext))
      {
        a(paramContext, localautz.d);
        return;
      }
      localautz.f = a(paramString1, paramString2);
      paramContext = new avtq(paramContext);
      paramContext.a(localautz);
      paramContext.show();
      return;
    }
  ...
  {
    new azqx(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a();
  }
  ...
  protected static void b(Context paramContext)
  {
    ...
    {
      return;
      Object localObject1 = new File(bdzf.a(alof.aX + "photo/"));
      if ((!((File)localObject1).exists()) && (!((File)localObject1).mkdirs()))
      {
        QQToast.a(paramContext, 2131719547, 0).a();
        if (QLog.isColorLevel()) {
      ...
      {
        String str = bdzf.a(alof.aX + "photo/" + System.currentTimeMillis() + ".jpg");
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new avua(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
  ...
  {
    bety localbety = new bety(paramContext, paramContext.getResources().getDimensionPixelSize(2131298914));
    localbety.c(2131694219);
    ThreadManager.post(new NearbyPublishMenuHelper.2(localbety, paramString2, paramContext, paramString1), 5, null, true);
  }
