...
public class afso
  implements Runnable
{
  public afso(ScanTorchActivity paramScanTorchActivity, ARTarget paramARTarget) {}
  ...
  public void run()
  {
    ...
    if (((!ARVideoRecordUIControllerImpl.a().a()) || (ARVideoRecordUIControllerImpl.a().b())) && (!this.jdField_a_of_type_ComTencentMobileqqArARTarget.a.a()) && (!this.jdField_a_of_type_ComTencentMobileqqArARTarget.a.b()))
    {
