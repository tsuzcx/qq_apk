...
public class ldx
  extends Handler
{
  public ldx(QQGAudioCtrl paramQQGAudioCtrl, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        m = paramMessage.what;
        paramMessage = (ldy)paramMessage.obj;
        if (paramMessage == null)
        {
          if (QLog.isColorLevel()) {
                                    ...
                                    if ((paramMessage.jdField_a_of_type_ArrayOfByte != null) && (paramMessage.jdField_a_of_type_ArrayOfByte.length == 16))
                                    {
                                      ...
                                      if (k == 3)
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          continue;
                                          this.a.mVideoController.g(3);
                                          continue;
                                          this.a.mVideoController.g(4);
                                          continue;
                                          ...
                                          localObject1 = lcs.a((byte[])localObject1, i1);
                                          ...
                                          if (((j == 10) || (j == 1)) && (localObject1 != null))
                                          {
                                            ...
                                            while (((Iterator)localObject1).hasNext()) {
                                              paramMessage.add(new ldv(((lcs)((Iterator)localObject1).next()).jdField_a_of_type_Long, l3));
                                            }
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        awqx.b(null, "CliOper", "", "", "0X800A7A6", "0X800A7A6", 0, (int)l3, "", "", "", "");
        break;
        awqx.b(null, "CliOper", "", "", "0X800A7A7", "0X800A7A7", 0, (int)l3, "", "", "", "");
        break;
        l1 = 0L;
        break label997;
        switch (m)
