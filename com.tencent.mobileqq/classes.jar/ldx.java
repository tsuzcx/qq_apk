...
public class ldx
{
  ...
  public ldx(VideoAppInterface paramVideoAppInterface)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Long = mnm.a().n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          str2 = locallga.e;
          i = locallga.E;
          j = locallga.jdField_d_of_type_Int;
          bool1 = locallga.L;
          bool2 = locallga.N;
          bool3 = locallga.g;
  ...
  public void a()
  {
    ...
    {
      ldy.a(true, System.currentTimeMillis() - this.jdField_b_of_type_Long);
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((lga)localObject).jdField_i_of_type_Int, ((lga)localObject).jdField_d_of_type_JavaLangString, ((lga)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.d = false;
      ldy.a(paramInt, System.currentTimeMillis() - this.jdField_c_of_type_Long);
    }
    a(false);
    f();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = lcx.a(j, (String)localObject1, new int[0]);
        localObject3 = lcx.a().a((String)localObject3, false);
        ((lga)localObject3).jdField_i_of_type_Int = 0;
        ((lga)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((lga)localObject3).e = ((String)localObject2);
        ((lga)localObject3).E = j;
        ((lga)localObject3).ag = true;
        ((lga)localObject3).jdField_i_of_type_Long = l2;
        ((lga)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((lga)localObject3).Q = true;
        ((lga)localObject3).L = bool1;
        ((lga)localObject3).g = bool3;
        ...
        if (lze.f())
        {
          lze.a(l3, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((mtq)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          ldy.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      lze.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label588:
