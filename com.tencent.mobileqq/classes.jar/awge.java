  ...
  implements baxz
{
  ...
  public awge(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView, int paramInt)
  {
  ...
  private void a(awgh paramawgh, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if (paramDrawable == null)
    {
      ...
      if (this.jdField_a_of_type_Ahnr != null) {
        paramDrawable = this.jdField_a_of_type_Ahnr.a(paramRecentBaseData);
      }
      ...
      int j = ((Integer)ahnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.a()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      localRecentDynamicAvatarView = paramawgh.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      paramawgh.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData.b());
      return;
      break;
      label176:
      bool = false;
      break label143;
      label182:
      paramawgh.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  
  private void b(awgh paramawgh, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    if ((paramawgh == null) || (paramRecentBaseData == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      a(paramawgh, paramRecentBaseData, localDrawable);
      return;
    }
  }
  ...
  {
    if ((paramViewHolder instanceof awgh))
    {
      RecentBaseData localRecentBaseData = a(paramInt);
      a((awgh)paramViewHolder, localRecentBaseData, null);
    }
  }
  ...
  {
    if ((paramInt == 0) && (this.jdField_a_of_type_Boolean)) {
      return new awgg(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562358, paramViewGroup, false));
    }
    return new awgh(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561049, paramViewGroup, false), this.jdField_a_of_type_Awgf);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(paramBitmap instanceof awgh))
        {
          break label436;
          this.jdField_a_of_type_Long = l;
          break;
        }
        paramBitmap = (awgh)paramBitmap;
