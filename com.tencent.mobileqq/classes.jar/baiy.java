...
public class baiy
{
  public static final int a = bahu.jdField_b_of_type_ArrayOfJavaLangString.length;
  ...
  public static final Drawable a(int paramInt, baiz parambaiz)
  {
    if (paramInt < 0) {
      throw new IllegalArgumentException("invaid emoji index: " + paramInt);
    }
    ...
    if (paramInt >= 1000)
    {
      ...
      ThreadManager.executeOnFileThread(new TextUtils.1(paramInt, parambaiz));
      return null;
    }
    if ((paramInt >= 0) && (paramInt < bahu.jdField_b_of_type_Int)) {}
    for (paramInt = 2130839808 + paramInt;; paramInt = 2130839942)
    {
      if (BaseApplicationImpl.sImageCache != null)
      {
        ...
        ThreadManager.executeOnFileThread(new TextUtils.2(paramInt, parambaiz));
        return null;
      }
  ...
  {
    if (!paramBoolean) {
      return apog.a(paramInt);
    }
    return apog.b(paramInt);
  }
  ...
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramInt = bczs.a((Drawable)localObject);
  ...
  public static final String a(int paramInt)
  {
    ...
    return String.valueOf(Character.toChars(bahu.d[paramInt]));
  }
        ...
        if (paramString != null)
        {
          for (;;)
          {
            ...
            catch (Throwable paramString)
            {
              ...
              paramString[j] = 13;
              continue;
              paramString = apih.a(paramString);
              if (paramString == null) {
                break label425;
              }
            }
  ...
  public static final Drawable b(Resources paramResources, int paramInt)
  {
    ...
    //   63: getstatic 416	bahr:b	Ljava/lang/String;
    ...
    //   114: astore_0
    //   115: aload 6
    //   117: invokestatic 442	bahr:a	([B)I
    //   120: istore_2
    //   121: aload 5
    //   123: astore_0
    ...
    //   212: getstatic 416	bahr:b	Ljava/lang/String;
    ...
    //   256: astore_0
    //   257: aload 6
    //   259: invokestatic 472	bdal:a	(Landroid/graphics/Bitmap;)I
    //   262: istore_2
    //   263: aload 5
    //   265: astore_0
    ...
    //   408: ldc_w 452
    //   411: iconst_2
    //   412: invokestatic 486	aekt:a	()Ljava/lang/StringBuilder;
    //   415: ldc_w 488
    ...
    //   448: getstatic 416	bahr:b	Ljava/lang/String;
    ...
    //   465: getstatic 416	bahr:b	Ljava/lang/String;
    ...
    //   521: getstatic 416	bahr:b	Ljava/lang/String;
    ...
    //   533: ldc_w 452
    //   536: iconst_2
    //   537: invokestatic 486	aekt:a	()Ljava/lang/StringBuilder;
    //   540: ldc_w 488
    ...
    //   575: getstatic 416	bahr:b	Ljava/lang/String;
  ...
  {
    if ((paramInt < 0) || (paramInt >= bjwo.e.length)) {
      throw new IllegalArgumentException("invaid emotcation index: " + paramInt);
    }
    return String.valueOf(Character.toChars(bjwo.e[paramInt]));
  }
  ...
  public static String b(String paramString)
  {
    ...
    do
    {
      ...
      while (i < j)
      {
        k = paramString.indexOf(apnz.a(i), 0);
        str1 = paramString;
        if (k != -1)
        {
          str1 = paramString;
  ...
  {
    return String.valueOf(new char[] { '<', '$', (char)apog.a(paramInt), '>' });
  }
      ...
      catch (AccountNotMatchException localAccountNotMatchException)
      {
        for (;;)
        {
          try
          {
            ...
            localObject1 = (aube)((AppInterface)localObject1).getManager(14);
  ...
  public static String e(String paramString)
  {
    ...
    while (i < a)
    {
      k = paramString.indexOf(bahu.d[i], 0);
      localObject = paramString;
      if (k != -1)
      {
        ...
        catch (AccountNotMatchException paramString)
        {
          for (;;)
          {
            try
            {
              ...
              localObject = apog.a(m);
              if (k != 0) {
                break label647;
              }
              localObject = alpo.a(2131715266) + (String)localObject;
