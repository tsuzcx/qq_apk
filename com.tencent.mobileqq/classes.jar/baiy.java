...
public class baiy
{
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          paramQQAppInterface = localaukp.a(TroopAIONotifyItem.class, false, "troopUin=?", new String[] { paramString }, null, null, null, null);
          localaukp.a();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localakhp.e(Long.valueOf(paramString).longValue());
      bame.a(paramQQAppInterface, paramString, 1102858908);
      ChatActivityUtils.a(paramQQAppInterface, paramString, Integer.valueOf(0));
      return;
    }
    ThreadManager.post(new TroopAioNotifyManager.1(paramQQAppInterface, paramString, localakhp), 8, null, true);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, List<TroopAIONotifyItem> paramList)
  {
    ...
    //   21: return
    //   22: aload_0
    //   23: invokevirtual 22	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   26: invokevirtual 28	aukq:createEntityManager	()Laukp;
    //   29: astore_0
    //   30: iconst_0
    //   31: istore_2
    //   32: iload_2
    ...
    //   45: checkcast 239	auko
    //   48: invokevirtual 241	aukp:b	(Lauko;)Z
    //   51: pop
    //   52: iload_2
    //   53: iconst_1
    //   54: iadd
