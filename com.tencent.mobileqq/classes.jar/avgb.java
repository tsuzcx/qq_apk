...
{
  private static avgb jdField_a_of_type_Avgb;
  avfz jdField_a_of_type_Avfz;
  boolean jdField_a_of_type_Boolean;
  
  public static MovementMethod a()
  {
    if (jdField_a_of_type_Avgb == null) {
      jdField_a_of_type_Avgb = new avgb();
    }
    return jdField_a_of_type_Avgb;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 3))
    {
      ...
      localObject = (avfz[])paramSpannable.getSpans(j, j, avfz.class);
      ...
      if (localObject.length != 0)
      {
        ...
        if (i == 1)
        {
          ...
          {
            this.jdField_a_of_type_Avfz.a(paramTextView, false);
        ...
        for (;;)
        {
          ...
          if (i == 0)
          {
            ...
            this.jdField_a_of_type_Avfz = paramSpannable;
          }
          else if ((i == 3) && (this.jdField_a_of_type_Avfz != null))
          {
            this.jdField_a_of_type_Avfz.a(paramTextView, false);
            this.jdField_a_of_type_Avfz = null;
          }
