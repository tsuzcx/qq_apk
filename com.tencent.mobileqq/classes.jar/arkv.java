...
public class arkv
{
  private static volatile arkv jdField_a_of_type_Arkv;
  ...
  private WeakReference<arky> jdField_a_of_type_MqqUtilWeakReference;
  ...
  private int a(Context paramContext, float paramFloat)
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      arkp.a(paramContext, 4, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin());
      return i;
    }
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(localFloatingScreenManager.setFloatingVideoListener(new arkw(this), 2));
    localFloatingScreenManager.setWindowClickListener(2, new arkx(this, paramContext));
    return 0;
  }
  
  public static arkv a()
  {
    if (jdField_a_of_type_Arkv == null) {}
    try
    {
      if (jdField_a_of_type_Arkv == null) {
        jdField_a_of_type_Arkv = new arkv();
      }
      return jdField_a_of_type_Arkv;
    }
    finally {}
  }
  ...
  public int a(Context paramContext, @Nonnull WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    ...
    {
      bcql.a(BaseApplicationImpl.getContext(), 2131694610, 0).a();
    ...
    this.jdField_a_of_type_Bcdj = new bcdj(localIntent, paramContext);
    this.jdField_a_of_type_Bcdj.a();
    arkp.a(true, paramWatchTogetherFloatingData.getCurUin(), paramWatchTogetherFloatingData.getCurType(), true);
  ...
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramarky);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        ((arky)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt2);
      }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bcdj.e();
      this.jdField_a_of_type_Bcdj.c();
      this.jdField_a_of_type_Bcdj = null;
    }
    ...
    arkp.a(false, paramString, paramInt, paramBoolean);
    if (this.jdField_a_of_type_Arkz != null)
    {
      asgn.a().a(this.jdField_a_of_type_Arkz);
      this.jdField_a_of_type_Arkz = null;
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    arky localarky = (arky)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      localarky.b(i);
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      axqy.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
      return;
      if (QLog.isColorLevel()) {
      ...
      if (paramInt == 1)
      {
        ...
        if (this.jdField_a_of_type_Arkz == null)
        {
          this.jdField_a_of_type_Arkz = new arkz(this.jdField_b_of_type_MqqUtilWeakReference);
          asgn.a().a(1, this.jdField_a_of_type_Arkz);
          return;
        }
        this.jdField_a_of_type_Arkz.a(this.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
    } while (paramInt != 2);
    axqy.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
  ...
  public void b(arky paramarky)
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() == paramarky)) {
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingView == null) || (this.jdField_a_of_type_Bcdj == null)) {}
    TouchWebView localTouchWebView;
    do
    {
      return false;
      localTouchWebView = this.jdField_a_of_type_Bcdj.a;
