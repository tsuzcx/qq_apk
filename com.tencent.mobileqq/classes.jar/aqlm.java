...
public class aqlm
  implements arup
{
  public aqlm(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        bdgm.a(this.a, 233, this.a.getString(2131719371), "是否下载文件:\n" + paramString1 + "(" + arso.a(paramLong) + ")", new aqln(this, paramString2, (araj)localObject2, (Bundle)localObject3), new aqlo(this)).show();
        return;
      ...
      localObject1 = localObject2;
    } while (!arso.b(((FileManagerEntity)localObject3).getFilePath()));
    paramString1 = new arrq();
    paramString1.jdField_b_of_type_JavaLangString = "file_viewer_in";
    paramString1.jdField_a_of_type_Int = 73;
    paramString1.c = arso.a(((FileManagerEntity)localObject3).fileName);
    paramString1.jdField_a_of_type_Long = ((FileManagerEntity)localObject3).fileSize;
    arrp.a(this.a.app.getCurrentAccountUin(), paramString1);
    arrp.a("0X8004AE4");
