  ...
  public static String a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        aqlh localaqlh = new aqlh(new StringReader(paramString), paramString.length());
        paramString = null;
        try
        {
          localaqle = localaqlh.a();
          if (localaqle != null) {
            continue;
          }
      ...
      if ((paramString != null) && (TextUtils.equals(paramString.b(), "double")) && ((!TextUtils.equals(localaqle.b(), "double")) || (paramString.b() < localaqle.a())) && (!TextUtils.isEmpty(paramString.a())))
      {
        localStringBuilder.append(paramString.a().charAt(paramString.a().length() - 1));
        localStringBuilder.append("*");
        localStringBuilder.append(' ');
      }
      if ((!TextUtils.isEmpty(localaqle.a())) && ((!TextUtils.equals(localaqle.b(), "double")) || (localaqle.a().length() != 1)))
      {
        localStringBuilder.append(localaqle.a());
        localStringBuilder.append(' ');
      }
      paramString = localaqle;
    }
    return null;
  }
