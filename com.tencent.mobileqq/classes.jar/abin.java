  ...
  extends View
{
  ...
  Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130843228);
  boolean jdField_a_of_type_Boolean = false;
  int jdField_b_of_type_Int = 0;
  Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130843245);
  protected int c;
  protected int d = this.jdField_b_of_type_AndroidGraphicsDrawableDrawable.getIntrinsicHeight();
  
  public abin(Context paramContext)
  {
    super(paramContext);
