...
public class abin
  extends ajjh
{
  public abin(ProfileCardMoreActivity paramProfileCardMoreActivity) {}
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean1) && (paramBoolean2) && (this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a != null) && (ProfileActivity.AllInOne.b(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne)))
    {
      ...
      if (localObject1 != null)
      {
        ...
        if ((localObject1 != null) && (!azzz.a(this.a.jdField_c_of_type_JavaLangString, ((Groups)localObject1).group_name)))
        {
    ...
    for (Object localObject1 = "";; localObject1 = this.a.jdField_c_of_type_JavaLangString)
    {
      ...
      return;
      localObject1 = ((ajjj)localObject2).e(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a);
      break;
    }
  }
  ...
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne == null) || (TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a)) || (!azzz.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a, paramString))) {}
    for (;;)
    {
      return;
      paramString = (ajjj)this.a.app.getManager(51);
      if (paramString == null) {}
      for (paramString = null; (paramString != null) && (!azzz.a(this.a.jdField_c_of_type_JavaLangString, paramString.group_name)); paramString = paramString.a(String.valueOf(paramByte1)))
      {
