...
public class qvn
{
  private static qvn jdField_a_of_type_Qvn;
  ...
  private Map<qtu, Boolean> jdField_a_of_type_JavaUtilMap = new WeakHashMap();
  private Timer jdField_a_of_type_JavaUtilTimer;
  private qvo jdField_a_of_type_Qvo;
  ...
  public static qvn a()
  {
    if (jdField_a_of_type_Qvn == null) {}
    try
    {
      if (jdField_a_of_type_Qvn == null) {
        jdField_a_of_type_Qvn = new qvn();
      }
      return jdField_a_of_type_Qvn;
    }
    finally {}
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Qvq == null) {
      this.jdField_a_of_type_Qvq = new qvq(this, null);
    }
    ...
    this.l = true;
    BaseApplicationImpl.getApplication().getBaseContext().registerReceiver(this.jdField_a_of_type_Qvq, paramActivity);
    if (this.jdField_a_of_type_Qvo == null) {
      this.jdField_a_of_type_Qvo = new qvo(this);
    }
    ThreadManager.excute(new VideoVolumeControl.2(this), 16, null, true);
    if (this.jdField_a_of_type_Qvp == null) {
      this.jdField_a_of_type_Qvp = new qvp(this);
    }
  ...
  public void a(qtu paramqtu)
  {
    ...
    {
      paramqtu.b(b());
      if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramqtu)) {
        this.jdField_a_of_type_JavaUtilMap.put(paramqtu, Boolean.valueOf(true));
      }
      paramqtu.a(this.jdField_a_of_type_Qvp);
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "addVideoManager :" + paramqtu + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 149	qvn:k	Z
    //   7: aload_0
    //   8: getfield 75	qvn:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   11: ifnull +82 -> 93
    //   14: aload_0
    //   15: getfield 89	qvn:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   18: ifnull +75 -> 93
    ...
    //   63: aload_0
    //   64: getfield 75	qvn:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   67: aload_0
    //   68: getfield 89	qvn:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   71: invokevirtual 336	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   74: aload_0
    //   75: getfield 149	qvn:k	Z
    //   78: ifeq +18 -> 96
    //   81: aload_0
    //   82: getfield 75	qvn:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 89	qvn:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   95: return
    //   96: aload_0
    //   97: getfield 75	qvn:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   100: aload_0
    //   101: getfield 89	qvn:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   104: ldc2_w 175
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) || (paramInt == 0))
    {
      ...
      Object localObject;
      for (boolean bool1 = false; paramString.hasNext(); bool1 = ((qtu)localObject).b() | bool1)
      {
        localObject = (qtu)paramString.next();
        if (localObject == null) {
          break label455;
        }
        ((qtu)localObject).b(paramBoolean);
      }
    ...
    for (;;)
    {
      try
      {
        if (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          ((ImageView)paramString.get()).setImageDrawable(((ImageView)paramString.get()).getResources().getDrawable(2130842482));
          ((ImageView)paramString.get()).setContentDescription(ajyc.a(2131716452));
        }
      }
      ...
      ((ImageView)paramString.get()).setContentDescription(ajyc.a(2131716453));
      break label464;
      label449:
      paramInt = n;
      break label246;
  ...
  public void b(Activity paramActivity)
  {
    if (this.jdField_b_of_type_JavaLangString.equals(paramActivity.toString()))
    {
      ...
      if (!"".equals(this.jdField_b_of_type_JavaLangString))
      {
        BaseApplicationImpl.getApplication().getBaseContext().unregisterReceiver(this.jdField_a_of_type_Qvq);
        ThreadManager.excute(new VideoVolumeControl.4(this), 16, null, true);
      }
      this.jdField_a_of_type_Qvp = null;
  ...
  {
    if (paramqtu != null) {
      this.jdField_a_of_type_JavaUtilMap.remove(paramqtu);
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "removeVideoManager :" + paramqtu + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
