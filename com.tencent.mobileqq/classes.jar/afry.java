  ...
  extends aekw
{
  ...
  public afry(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new afrz(this);
  }
  ...
  protected View a(MessageRecord paramMessageRecord, aekx paramaekx, View paramView, LinearLayout paramLinearLayout, aeov paramaeov)
  {
    ...
    if (paramView == null) {
      paramLinearLayout = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558779, null);
    }
    ...
    paramMessageRecord = (afsa)paramaekx;
    Object localObject3 = localPAMessage.items;
    paramaekx = (ViewGroup)paramLinearLayout.findViewById(2131371518);
    Object localObject1 = (ImageView)paramLinearLayout.findViewById(2131371521);
    TextView localTextView1 = (TextView)paramLinearLayout.findViewById(2131371520);
    TextView localTextView2 = (TextView)paramLinearLayout.findViewById(2131371513);
    TextView localTextView3 = (TextView)paramLinearLayout.findViewById(2131371514);
    TextView localTextView4 = (TextView)paramLinearLayout.findViewById(2131371515);
    TextView localTextView5 = (TextView)paramLinearLayout.findViewById(2131371516);
    TextView localTextView6 = (TextView)paramLinearLayout.findViewById(2131371517);
    ...
    for (int i = ((List)localObject1).size();; i = 0)
    {
      ...
      paramaekx.setTag(paramMessageRecord);
