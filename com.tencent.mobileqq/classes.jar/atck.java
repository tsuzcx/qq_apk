  ...
  implements View.OnTouchListener
{
  ...
  {
    this.jdField_a_of_type_Bcje = new atco(this);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new atcp(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131705090));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, vpm.b(this.jdField_a_of_type_AndroidContentContext, 15.0F));
  ...
  private void b()
  {
    ...
    {
      j = j - this.jdField_a_of_type_AndroidWidgetTextView.getWidth() - vpm.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      if (localLayoutParams.y - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() / 2 <= i * 0.8F) {
        break label251;
      }
      i = i - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() - vpm.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
    }
    for (;;)
    {
      ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { localLayoutParams.x, j });
      localValueAnimator.addUpdateListener(new atcm(this, localLayoutParams, localValueAnimator));
      ...
      localValueAnimator.addUpdateListener(new atcn(this, localLayoutParams, localValueAnimator));
      localValueAnimator.setDuration(200L);
      localValueAnimator.setTarget(this.jdField_a_of_type_AndroidWidgetTextView);
      localValueAnimator.start();
      return;
      j = vpm.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      break;
      label251:
      if (localLayoutParams.y - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() / 2 > i * 0.6F) {
        ...
        i = vpm.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      }
    }
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).removeObserver(this.jdField_a_of_type_Bcje);
      return;
    }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    Object localObject;
    if (!this.jdField_b_of_type_Boolean) {
      if (!lze.c(this.jdField_a_of_type_AndroidContentContext))
      {
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        ((WindowManager.LayoutParams)localObject).x = (j - vpm.b(this.jdField_a_of_type_AndroidContentContext, 62.0F) - vpm.b(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ((WindowManager.LayoutParams)localObject).y = ((int)((k - vpm.b(this.jdField_a_of_type_AndroidContentContext, 67.0F)) * 0.25F));
        this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130841755);
        try
        {
          ...
          if (paramInt1 == 0)
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131705141));
            this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new atcl(this, paramInt1, paramLong, paramString2, paramString1, paramInt2));
            ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).addObserver(this.jdField_a_of_type_Bcje);
            return;
            i = 2010;
          }
        }
        catch (Exception localException1)
        {
          for (;;)
          {
            ...
            continue;
            this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131705132));
          }
        }
      }
    }
  ...
  protected void a(HotChatInfo paramHotChatInfo, int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      ((aukp)localObject2).a(paramHotChatInfo);
      ((aukp)localObject2).a();
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if (i == 2)
      {
        if ((this.jdField_a_of_type_Boolean) || (Math.abs(paramMotionEvent.getX() - this.jdField_a_of_type_Int) > vpm.b(this.jdField_a_of_type_AndroidContentContext, 10.0F)) || (Math.abs(paramMotionEvent.getY() - this.jdField_b_of_type_Int) > vpm.b(this.jdField_a_of_type_AndroidContentContext, 10.0F)))
        {
          ...
          paramView.y = (k - this.jdField_b_of_type_Int - vpm.b(this.jdField_a_of_type_AndroidContentContext, 25.0F));
