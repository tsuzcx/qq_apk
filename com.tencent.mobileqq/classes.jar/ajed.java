...
{
  public ajed(ShowExternalTroopListActivity paramShowExternalTroopListActivity) {}
  
  public void onClick(View paramView)
  {
    if (!bgnt.g(this.a.jdField_a_of_type_AndroidAppActivity))
    {
      QQToast.a(this.a, 1, this.a.getString(2131691915), 0).b(this.a.getTitleBarHeight());
    ...
    for (str1 = "0";; str1 = "1")
    {
      bcst.b((QQAppInterface)localObject, "P_CliOper", "Grp_join", "", "person_data", "Clk_quntag", 0, 0, str2, str1, "", "");
      break;
    }
  }
}
