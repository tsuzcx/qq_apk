  ...
  implements annm, annn, Manager
{
  ...
  private long a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return l3;
          ConcurrentHashMap localConcurrentHashMap = this.jdField_a_of_type_Annj.a();
          ...
          if (localObject != null)
          {
            ...
            if (((List)localObject).size() > 0)
            {
              ...
              for (;;)
              {
                ...
                annl localannl = (annl)localConcurrentHashMap.get(str);
                l2 = l1;
                if (localannl != null)
                {
                  l2 = l1 + localannl.jdField_a_of_type_Long;
                  localannl.b += 1;
                  this.jdField_a_of_type_Annj.a(str, localannl);
                }
                l1 = l2;
              }
            }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else if (annt.c(i))
        {
          paramList = ayav.a(paramList);
          if (paramList != null) {
            paramList = ataw.a(this.jdField_a_of_type_ComTencentMobileqqAppPeakAppInterface, paramList);
          }
        }
        else if (annt.d(i))
        {
        ...
        {
          paramList = ayav.a(paramList);
          if ((paramList != null) && ((paramList instanceof MessageForStructing)) && (awct.a((MessageForStructing)paramList))) {
            b(paramString, this.jdField_a_of_type_Annr.c(MessageRecord.class, "select * from mr_multimessage where msgseq=?", "mr_multimessage", "msgseq=?", new String[] { String.valueOf(paramList.uniseq) }));
          }
        }
        paramList = "";
        continue;
  ...
  private String a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      continue;
      str1 = this.jdField_a_of_type_Annr.a(paramMessageRecord.frienduin);
      continue;
      if (this.jdField_a_of_type_Ahap != null)
      {
        str1 = this.jdField_a_of_type_Ahap.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
        continue;
        str1 = this.jdField_a_of_type_Annr.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
      }
    }
  }
  ...
  private boolean a(anni paramanni)
  {
    if ((paramanni == null) || (this.jdField_a_of_type_Ahap == null)) {}
    String str;
    do
    {
      return true;
      str = MessageRecord.getTableName(paramanni.jdField_a_of_type_JavaLangString, paramanni.jdField_a_of_type_Int);
    } while (TextUtils.isEmpty(str));
    b(str);
    if (this.jdField_a_of_type_Ahap != null) {
      this.jdField_a_of_type_Ahap.b(paramanni.jdField_a_of_type_JavaLangString, paramanni.jdField_a_of_type_Int);
    }
    a(str);
    return true;
  }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null))
    {
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          annl localannl = (annl)localConcurrentHashMap.get(str1);
          if (localannl != null)
          {
            localannl.b -= 1;
            if (localannl.b == 0)
            {
              String str2 = this.jdField_a_of_type_Annj.a(localannl);
              if (!TextUtils.isEmpty(str2))
              {
                this.jdField_a_of_type_Long += localannl.jdField_a_of_type_Long;
                paramString.add(str2);
              }
              this.jdField_a_of_type_Annj.a(str1);
            }
            else
            {
              this.jdField_a_of_type_Annj.a(str1, localannl);
            }
          }
        }
        this.jdField_a_of_type_Annj.a(paramString);
      }
    }
  }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Annj != null) && (this.jdField_a_of_type_Annj.a());
  }
  
  private void c()
  {
    this.jdField_a_of_type_Annr = new annr();
    AppInterface localAppInterface = this.jdField_a_of_type_Annr.a();
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Annr.a(this);
    this.jdField_a_of_type_Annj = new annj(this);
  }
  ...
  private void f()
  {
    ...
    Object localObject = this.jdField_a_of_type_Annr.a();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      b(str1, this.jdField_a_of_type_Annr.a(MessageRecord.class, str2, str1, null, null));
    }
    this.jdField_b_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
  ...
  private void g()
  {
    ...
    Object localObject = this.jdField_a_of_type_Annr.b();
    if ((localObject == null) || (((ArrayList)localObject).size() == 0))
    {
      if (QLog.isColorLevel()) {
    ...
    while (((Iterator)localObject).hasNext())
    {
      String str1 = (String)((Iterator)localObject).next();
      String str2 = String.format("select * from %s", new Object[] { str1 });
      b(str1, this.jdField_a_of_type_Annr.b(MessageRecord.class, str2, str1, null, null));
    }
    this.c = true;
    if (QLog.isColorLevel()) {
  ...
  private void h()
  {
    if ((a()) && (b()))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localanni.jdField_a_of_type_JavaLangString = ((MessageRecord)localObject).frienduin;
          localanni.jdField_b_of_type_JavaLangString = a((MessageRecord)localObject);
          localanni.jdField_a_of_type_Int = ((MessageRecord)localObject).istroop;
          localanni.jdField_b_of_type_Long = ((MessageRecord)localObject).time;
          localanni.jdField_a_of_type_Long = a(MessageRecord.getTableName(localanni.jdField_a_of_type_JavaLangString, ((MessageRecord)localObject).istroop));
          if ((localanni.jdField_a_of_type_Long > 0L) && (this.jdField_a_of_type_JavaUtilList != null))
          {
            localanni.c = annk.a(localanni.jdField_a_of_type_Long);
            this.jdField_a_of_type_JavaUtilList.add(localanni);
          }
        }
      }
      ...
      if (this.jdField_a_of_type_Anno != null)
      {
        a(1);
        if (QLog.isColorLevel()) {
          QLog.e("MessageCleanManager", 2, "conformAllData onLoadFinish");
        }
        this.jdField_a_of_type_Anno.a(this.jdField_a_of_type_JavaUtilList);
      }
    }
    for (;;)
    {
  ...
  private void i()
  {
    ...
    if (this.jdField_a_of_type_Annj != null) {
      this.jdField_a_of_type_Annj.b();
    }
  }
  ...
  public List<anni> a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilList != null) {
      Collections.sort(this.jdField_a_of_type_JavaUtilList, new annh(paramInt));
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  
  public List<anni> a(List<anni> paramList)
  {
    if ((paramList == null) || (paramList.isEmpty()) || (this.jdField_a_of_type_Ahap == null)) {
      return this.jdField_a_of_type_JavaUtilList;
    }
    if (QLog.isColorLevel()) {
    ...
    {
      anni localanni = (anni)paramList.next();
      if (this.jdField_a_of_type_JavaUtilList != null) {
        this.jdField_a_of_type_JavaUtilList.remove(localanni);
      }
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(anno paramanno)
  {
    this.jdField_a_of_type_Anno = paramanno;
  }
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Anno == null);
    if (QLog.isColorLevel()) {
  ...
  {
    i();
    this.jdField_a_of_type_Anno = null;
    this.jdField_a_of_type_Ahap = null;
  }
}
