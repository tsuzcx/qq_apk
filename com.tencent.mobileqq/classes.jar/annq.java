...
public class annq
{
  public static Dialog a(Activity paramActivity, View.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity.setContentView(2131561206);
    Button localButton1 = (Button)paramActivity.findViewById(2131363676);
    Button localButton2 = (Button)paramActivity.findViewById(2131363687);
    localButton1.setOnClickListener(new annr(paramActivity));
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramString.exists())
          {
            ...
            bggl.a(paramString.getAbsolutePath(), localOptions);
            int i = localOptions.outWidth;
            if (i > 150) {
              localOptions.inSampleSize = (i / 150);
            }
            localOptions.inJustDecodeBounds = false;
            paramString = bggl.a(paramString.getAbsolutePath(), localOptions);
            return paramString;
          }
        }
  ...
  public static bgpa a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    int i = paramActivity.getRequestedOrientation();
    paramActivity.setRequestedOrientation(1);
    paramQQAppInterface = bglp.a(paramActivity, 0, 2131559929, paramActivity.getString(2131692903), null, paramActivity.getString(2131693181), paramActivity.getString(2131692669), new anns(paramActivity, paramQQAppInterface), new annt(paramQQAppInterface));
    paramQQAppInterface.setOnDismissListener(new annu(paramActivity, i));
    paramQQAppInterface.getBtnight().setTypeface(Typeface.DEFAULT_BOLD);
    paramQQAppInterface.setMessageCount(paramActivity.getString(2131692902));
    paramQQAppInterface.setPreviewImage(paramActivity.getResources().getDrawable(2130842516), true, 1);
    paramQQAppInterface.show();
    return paramQQAppInterface;
  }
  
  public static bgpa a(HotChatInfo paramHotChatInfo, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramHotChatInfo = bglp.a(localBaseActivity, 230, localBaseActivity.getString(2131692899), localBaseActivity.getString(2131692898), 2131690582, 2131691891, paramOnClickListener, new annv());
    paramOnClickListener = (TextView)paramHotChatInfo.findViewById(2131365475);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 17;
    paramOnClickListener.setLayoutParams(localLayoutParams);
    paramHotChatInfo.setOnDismissListener(new annw(localBaseActivity, i));
  ...
  public static void a(int paramInt, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    paramString5.setActionSheetTitle(paramBaseActivity.getString(2131718027));
    paramString5.setActionSheetItems(a(paramBaseActivity));
    paramString5.setItemClickListener(new annx(paramString5, paramInt, paramQQAppInterface, paramBaseActivity, paramString1, paramString6, paramString3, paramString4, paramString7, paramString2, paramString8));
    try
    {
      paramString5.show();
      return;
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (paramBaseActivity == null) {
      paramString1 = bggl.b(BaseApplicationImpl.getApplication().getResources(), 2130845311);
    }
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    ...
    for (int i = 69;; i = 65)
    {
      paramString4 = new bcvp(StructMsgForGeneralShare.class).c(i).a(paramString2).a("web", paramString4, paramString5, null, null).a(anni.a(2131704347), null).a();
      paramString5 = bcwc.a(2);
      ...
      aufz.a(paramBaseActivity, paramString1, 3);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo)
  {
    ...
    do
    {
      ...
      {
        a(paramQQAppInterface, paramHotChatInfo, paramQQAppInterface.getApp().getString(2131692896), true);
        return;
      }
      a(paramQQAppInterface, paramHotChatInfo, paramQQAppInterface.getApp().getString(2131692901), true);
      aong localaong = paramQQAppInterface.a().a();
      RecentUser localRecentUser = (RecentUser)localaong.findRecentUserByUin(paramHotChatInfo.troopUin, 1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo, String paramString, boolean paramBoolean)
  {
    ...
    aoey.a(paramQQAppInterface, paramHotChatInfo.troopUin, paramString, 1, paramBoolean, false);
  }
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (paramString2.startsWith("邀请加入QQ热聊：")) {
      paramString1 = paramString2 + anni.a(2131704348);
    }
    paramString5.putString("troop_wording", paramString1);
    paramString5.putString("bizname", "JoinTroopLink");
    bltb.a(localQQAppInterface, paramBaseActivity, paramString5, null);
  }
  ...
  static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (paramString2.startsWith("邀请加入QQ热聊：")) {}
    for (paramBaseActivity = paramString2 + anni.a(2131704350);; paramBaseActivity = paramString2)
    {
