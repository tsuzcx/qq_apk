...
public class apyq
{
  ...
  public static int a()
  {
    int j = amfa.a().jdField_b_of_type_Int;
    int i = j;
    if (j == 0) {
  ...
  public static String a()
  {
    String str2 = amfa.a().jdField_a_of_type_JavaLangString;
    String str1 = str2;
  ...
  {
    amez localamez = amfa.a();
    if ((localamez != null) && (localamez.jdField_a_of_type_Int > 0))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    boolean bool2 = false;
    Object localObject = amfa.a();
    boolean bool1 = bool2;
    if (localObject != null)
    {
      bool1 = bool2;
      if (((amez)localObject).c > 0)
      {
        localObject = ((amez)localObject).jdField_a_of_type_JavaLangString;
        bool1 = bool2;
