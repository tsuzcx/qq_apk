...
{
  public awtl(MapWidget paramMapWidget, int paramInt, awtq paramawtq) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    ...
    if (MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget) != null) {
      MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget).a(false, this.jdField_a_of_type_Awtq);
    }
  }
    ...
    for (;;)
    {
      if (paramObject != null)
      {
        ...
        if (blqj.a())
        {
          ...
          label124:
          this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline = this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap.addPolyline(new PolylineOptions().addAll(paramObject).color(paramInt).width(bhgr.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.getContext(), 5.0F)));
          if (this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline != null)
          {
      ...
      {
        ((awtp)localObject1).a(bool, this.jdField_a_of_type_Awtq);
        return;
        ...
        this.jdField_a_of_type_Awtq.a = paramObject.duration;
        this.jdField_a_of_type_Awtq.b = paramObject.distance;
        ...
        this.jdField_a_of_type_Awtq.a = ((float)((TransitResultObject.Route)localObject1).duration);
        this.jdField_a_of_type_Awtq.b = ((TransitResultObject.Route)localObject1).distance;
