...
public class baxy
{
  ...
  public baxy(Context paramContext, AppInterface paramAppInterface)
  {
    this(paramAppInterface);
  }
  
  public baxy(AppInterface paramAppInterface)
  {
    if ((paramAppInterface instanceof QQAppInterface)) {
      this.a = new bayc((QQAppInterface)paramAppInterface);
    }
    while (this.a == null)
    {
      throw new NullPointerException("can not Instantiation FaceDecoder");
      if ((paramAppInterface instanceof NearbyAppInterface)) {
        this.a = new bazw((NearbyAppInterface)paramAppInterface);
      }
    }
  }
