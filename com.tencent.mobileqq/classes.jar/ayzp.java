...
public class ayzp
  implements ayzy
{
  private static ConcurrentHashMap<Integer, ayzp> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(5);
  private static AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  public int a;
  private ayzr jdField_a_of_type_Ayzr;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private String jdField_a_of_type_JavaLangString = "ShortVideoResDownload_";
  boolean jdField_a_of_type_Boolean;
  public boolean b;
  
  private ayzp(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Ayzr = new ayzr(this.jdField_a_of_type_JavaLangString, this);
  ...
  private boolean a()
  {
    ...
    if (bool)
    {
      VideoEnvironment.a(this.jdField_a_of_type_JavaLangString, alpo.a(2131714473), null);
      ShortVideoResourceManager.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
      return bool;
    }
    VideoEnvironment.a(this.jdField_a_of_type_JavaLangString, alpo.a(2131714412), null);
    return bool;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramQQAppInterface = new ayzp(paramQQAppInterface, paramBoolean1);
      }
      finally {}
  ...
  private static void b(ayzp paramayzp)
  {
    if (paramayzp != null) {
      jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Integer.valueOf(paramayzp.jdField_a_of_type_Int));
    }
  }
  ...
  private boolean b()
  {
    ...
    {
      VideoEnvironment.a(this.jdField_a_of_type_JavaLangString, alpo.a(2131714473), null);
      ShortVideoResourceManager.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new ayzq(this));
      return bool;
    }
    VideoEnvironment.a(this.jdField_a_of_type_JavaLangString, alpo.a(2131714412), null);
    return bool;
  ...
  public static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = new ayzp(paramQQAppInterface, true);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 == 1) || (paramInt1 == 0))
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        this.jdField_a_of_type_Ayzr.jdField_a_of_type_Boolean = false;
        ShortVideoResourceManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList, this.jdField_a_of_type_Ayzr);
        VideoEnvironment.a(this.jdField_a_of_type_JavaLangString, "onConfigResult| mDownloadFilterSo=false", null);
        if (this.jdField_a_of_type_Boolean)
        {
          if (azgk.a(VideoEnvironment.a()) == 0) {
            break label239;
          }
          ShortVideoResourceManager.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList, this.jdField_a_of_type_Ayzr);
          this.jdField_a_of_type_Ayzr.b = false;
        }
        for (;;)
        {
          if (azgk.f())
          {
            this.jdField_a_of_type_Ayzr.c = false;
            ShortVideoResourceManager.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList, this.jdField_a_of_type_Ayzr);
          }
          if (azgk.i())
          {
            this.jdField_a_of_type_Ayzr.e = false;
            ShortVideoResourceManager.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList, this.jdField_a_of_type_Ayzr);
          }
          this.jdField_a_of_type_Ayzr.a();
          return;
          label239:
