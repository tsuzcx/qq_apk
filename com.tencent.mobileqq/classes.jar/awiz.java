...
public class awiz
{
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    return bdbi.encodeToString(localByteArrayOutputStream.toByteArray(), 2);
  }
  ...
  public static String a(String paramString)
  {
    ...
    try
    {
      ...
      if (arrayOfByte != null) {
        localObject1 = bhli.b(arrayOfByte);
      }
    }
  ...
  public static String a(String paramString, long paramLong)
  {
    for (i = 1;; i = j)
    {
      ...
      str = bdbi.encodeToString(str.getBytes(), 2);
  ...
  public static String a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return bhli.b(jdField_a_of_type_JavaSecurityMessageDigest.digest());
    }
  ...
  public static String b(String paramString)
  {
    ...
    //   23: iconst_2
    //   24: invokestatic 242	bdbi:decode	([BI)[B
    //   27: astore_0
