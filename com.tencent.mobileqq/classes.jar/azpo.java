...
public abstract class azpo
{
  int jdField_a_of_type_Int;
  azpl jdField_a_of_type_Azpl;
  ...
  public azpo(azpl paramazpl, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new azpp(this);
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = getClass().getSimpleName();
    this.jdField_a_of_type_Azpl = paramazpl;
  }
