  ...
  extends amiz
{
  ...
  awce jdField_a_of_type_Awce = null;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public amgm(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
      ...
      else
      {
        ...
        for (Object localObject = localArrayList;; localObject = null)
        {
          ...
          while (paramMessageForStructing.hasNext())
          {
            ...
            if (aule.a((ChatMessage)localObject))
            {
              if (QLog.isColorLevel()) {
  ...
  private void a(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap1, HashMap<String, ArrayList<MessageRecord>> paramHashMap2, int paramInt, amji paramamji, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList)
  {
    if (paramInt > 3) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          paramMessageForStructing = a(paramMessageForStructing, (ArrayList)localObject, paramamji, paramBoolean1, paramBoolean2, paramArrayList);
          ...
          while (paramMessageForStructing.hasNext())
          {
            localObject = (MessageRecord)paramMessageForStructing.next();
            if (aule.a((ChatMessage)localObject)) {
              a((MessageForStructing)localObject, paramHashMap1, paramHashMap2, paramInt + 1, paramamji, paramBoolean1, paramBoolean2, paramArrayList);
            }
          }
          break;
        }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    } while (!arni.a(paramQQAppInterface, (MessageForFile)paramChatMessage).sendCloudUnsuccessful());
    return false;
    return false;
  }
  ...
  private void b(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessageForStructing.hasNext())
      {
        ...
        if (!aule.a((ChatMessage)localMessageRecord1)) {
          continue;
        }
        if (paramInt != 2) {
          break label214;
        }
        MessageRecord localMessageRecord2 = a(localMessageRecord1, aukv.jdField_a_of_type_JavaLangString, false);
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, amji paramamji, boolean paramBoolean1, boolean paramBoolean2)
  {
    paramMessageRecord = a(paramMessageRecord, paramArrayList, paramamji, paramBoolean1, paramBoolean2, new ArrayList(0));
    if (paramBoolean1) {
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, amji paramamji, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    while (localIterator.hasNext())
    {
          ...
          else if (localMessageRecord.msgtype == -1035)
          {
            ...
            if (((MessageForMixedMsg)localObject1).getReplyMessage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != null)
            {
              ...
              if ((localObject1 != null) && (localObject2 != null)) {
                aroo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForReplyText)localObject1).getSourceMessage(), ((MessageForReplyText)localObject2).getSourceMessage());
              }
            }
          }
      ...
      aroo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramArrayList);
      ...
      if (paramBoolean1) {
        if (paramArrayList.getStatus() == 1000) {
          this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramArrayList.frienduin, paramArrayList.istroop, paramArrayList.getTableName(), paramArrayList, 0, paramamji);
        } else {
  ...
  public ArrayList<MessageRecord> a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bbku parambbku)
  {
    ...
    Object localObject2 = ayvu.a((MessageHandler)localObject3, paramMsg, String.valueOf(l3), String.valueOf(l3));
    long l1;
    ...
    for (long l2 = 0L;; l2 = l1)
    {
      ...
      int i;
      if (((ayvy.c(j)) || (j == 208) || (j == 529)) && (localMsgHead.c2c_cmd.has()))
      {
        ...
        if ((j == 529) && (i == 4))
        {
          ...
          parambbku = localMsgHead.from_nick.get();
          paramHashMap.put(String.valueOf(l3), localMsgHead.from_nick.get());
        }
      }
      for (paramHashMap = parambbku;; paramHashMap = (HashMap<String, String>)localObject1)
      {
        if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
          ayvu.a((MessageHandler)localObject3, (List)localObject2, paramMsg);
        }
        l1 = l3;
        int k = ayvu.a(paramMsg);
        localObject1 = ((ArrayList)localObject2).iterator();
        i = 0;
        if (((Iterator)localObject1).hasNext())
        {
          parambbku = (MessageRecord)((Iterator)localObject1).next();
          paramMsg = parambbku;
          if (!axhe.a(paramMessageRecord))
          {
            paramMsg = parambbku;
            if (!aule.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)parambbku))
            {
              paramMsg = parambbku;
              if (!(parambbku instanceof MessageForArkApp))
              {
                if (QLog.isColorLevel()) {
                  QLog.d("MultiMsg_TAG", 2, "not support multi forward msg! " + parambbku.toString());
                }
                paramMsg = ayvw.a(-1000);
          ...
          paramMsg.vipBubbleID = alxl.a((int)l2, k);
          aule.a(paramMsg, paramHashMap, paramMessageRecord);
          if ((j == 82) || (j == 43)) {
            paramMsg.istroop = 1;
          }
          for (;;)
          {
            ...
            ayvu.a((MessageHandler)localObject3, (List)localObject2, paramMsg, true, false, parambbku);
            break label328;
            if (((j == 82) || (j == 43)) && (localMsgHead.group_info.has()))
            {
              ...
              if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject2, paramMsg)) {
                ayvu.a((MessageHandler)localObject3, (List)localObject2, paramMsg, false, false, parambbku);
              }
              parambbku = (bbku)localObject1;
              ...
              if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
                ayvu.a((MessageHandler)localObject3, paramMsg, (List)localObject2);
              }
  ...
  public ArrayList<MessageRecord> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bbku parambbku)
  {
    ...
    localObject2 = ayvu.a(localMessageHandler, (msg_comm.Msg)localObject3, String.valueOf(l3), String.valueOf(l3));
    long l1;
    if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
    {
      l1 = ((Long)((Pair)localObject2).first).longValue();
    ...
    for (long l2 = 0L;; l2 = l1)
    {
      localObject2 = new ArrayList();
      int k;
      if (((ayvy.c(j)) || (j == 208)) && (((msg_comm.MsgHead)localObject4).c2c_cmd.has()))
      {
        ...
        else
        {
          ...
          if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
            ayvu.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3);
          }
          l1 = l3;
          k = ayvu.a((msg_comm.Msg)localObject3);
      ...
      for (;;)
      {
        ...
        ((MessageRecord)localObject4).vipBubbleID = alxl.a((int)l2, k);
        if ((j == 82) || (j == 43))
        {
          ...
          l1 = ((Long)((Pair)localObject2).second).longValue();
          break;
          ayvu.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3, true, false, parambbku);
          break label497;
          if (((j == 82) || (j == 43)) && (((msg_comm.MsgHead)localObject4).group_info.has()))
          {
            ...
            if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject2, (msg_comm.Msg)localObject3)) {
              ayvu.a(localMessageHandler, (List)localObject2, (msg_comm.Msg)localObject3, false, false, parambbku);
            }
            ...
            if (((paramMessageRecord instanceof MessageForStructing)) && (((MessageForStructing)paramMessageRecord).structingMsg != null) && (((MessageForStructing)paramMessageRecord).structingMsg.mMsgServiceID == 107)) {
              ayvu.a(localMessageHandler, (msg_comm.Msg)localObject3, (List)localObject2);
            }
            break label575;
          }
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, amji paramamji, boolean paramBoolean1, boolean paramBoolean2)
  {
    HashMap localHashMap = new HashMap();
    ArrayList localArrayList = new ArrayList();
    ...
    do
    {
      ...
      {
        return localHashMap;
        if (aule.a((ChatMessage)paramMessageRecord)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("MultiMsg_TAG", 2, "preAddMultiMsgWithNest error before of not structMsg");
      return localHashMap;
      a((MessageForStructing)paramMessageRecord, paramHashMap, localHashMap, 0, paramamji, paramBoolean1, paramBoolean2, localArrayList);
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bbku parambbku)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.msg.has())
      {
        ...
        {
          localObject3 = a((msg_comm.Msg)paramArrayOfByte.msg.get(i), paramHashMap, paramMessageRecord, parambbku);
    ...
    if (!a(paramMessageRecord, (HashMap)localObject1, null))
    {
      ...
      if (i < paramArrayOfByte.pbItemList.size())
      {
        ...
        try
        {
          ...
          {
            ArrayList localArrayList = a((msg_comm.Msg)((msg_transmit.PbMultiMsgNew)localObject3).msg.get(j), paramHashMap, paramMessageRecord, parambbku);
  ...
  public msg_comm.MsgHead a(MessageRecord paramMessageRecord, HashMap<String, String> paramHashMap, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    localMsgHead.from_uin.set(Long.valueOf(abot.c(paramMessageRecord)).longValue());
    ...
    if (paramBoolean1)
    {
      ...
      String str = abot.c(paramMessageRecord);
      ...
      aule.a("step:packPb.getMsgHead.nickName = %s", new Object[] { localObject1 });
  ...
  public im_msg_body.MsgBody a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        localObject1 = ayvu.a(paramMessageRecord);
      }
    }
    for (;;)
    {
      if ((localObject1 != null) && (!((im_msg_body.RichText)localObject1).elems.isEmpty()))
      {
        ...
        if (paramMessageRecord.msgtype == -2005)
        {
          if (paramBoolean)
          {
            localObject1 = alpo.a(2131707394);
            if ((paramMessageRecord instanceof MessageForFile)) {
              localObject1 = ((MessageForFile)paramMessageRecord).getSummaryMsg();
            }
            localObject1 = ayvu.a((MessageForText)a(paramMessageRecord, (String)localObject1, false));
            continue;
          }
        ...
        if (paramMessageRecord.msgtype == -2017)
        {
          if (paramBoolean)
          {
            localObject1 = alpo.a(2131707392);
        ...
        {
          localObject1 = ayvu.a((MessageForQQStoryComment)paramMessageRecord);
          continue;
        }
        ...
        {
          localObject1 = ayvu.a((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5016)
        {
          localObject1 = ayvu.c((MessageForArkBabyqReply)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5017)
        {
          localObject1 = ayvu.b((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5013)
        {
          localObject1 = ayvu.c((MessageForArkFlashChat)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5014)
        {
          localObject1 = ayvu.d((MessageForHiBoom)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2011)
        {
          localObject3 = ayvu.a((MessageForStructing)paramMessageRecord);
          if (localObject3 == null) {
            return null;
          }
          ...
          try
          {
            ...
            localObject1 = ((azsp)localObject4).a.richText;
            if (localObject1 == null) {
              return null;
            }
        ...
        if (paramMessageRecord.msgtype == -1035)
        {
          ...
          if (i < k)
          {
            ...
            {
              localObject3 = ayvu.a((MessageForText)localObject3);
              if (localObject3 == null) {
                return null;
              }
              j = 0;
            ...
            for (;;)
            {
              ...
              {
                localObject3 = ayvu.a((MessageForReplyText)localObject3);
                if (localObject3 != null)
                {
                  j = 0;
                  while (j < ((im_msg_body.RichText)localObject3).elems.size())
        ...
        {
          localObject2 = ayvu.a((MessageForLongTextMsg)paramMessageRecord, false);
          continue;
        }
  ...
  protected void a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, amji paramamji)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(localMessageRecord1.frienduin, localMessageRecord1.istroop, localMessageRecord1.getTableName(), localMessageRecord1, 0, paramamji);
    }
  }
  ...
  public boolean a(MessageRecord paramMessageRecord, amji paramamji)
  {
  ...
  public boolean a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, amji paramamji)
  {
    if ((paramMessageRecord == null) || (paramHashMap == null)) {
      if (QLog.isColorLevel()) {
  ...
  protected boolean a(MessageRecord paramMessageRecord, List<MessageRecord> paramList, amji paramamji)
  {
    a(paramMessageRecord, paramList, paramamji);
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
    return true;
  }
  ...
  public boolean a(List<MessageRecord> paramList, amji paramamji)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      paramamji = (MessageRecord)paramList.next();
      if (paramamji.getStatus() == 1000) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramamji.frienduin, paramamji.istroop, paramamji.getTableName(), paramamji, 3, null);
      } else {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.c(paramamji.frienduin, paramamji.istroop, paramamji.getTableName(), paramamji, 4, null);
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.d();
    return true;
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if (!aule.a((ChatMessage)paramHashMap)) {
            break label610;
          }
          paramHashMap = a(paramHashMap, aukv.jdField_b_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
