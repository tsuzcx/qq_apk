...
{
  public too(VideoViewVideoHolder paramVideoViewVideoHolder, String paramString1, tnz paramtnz, long paramLong1, long paramLong2, int paramInt, String paramString2)
  {
    super(paramString1);
  }
  ...
  protected Object a(@NonNull JobContext paramJobContext, @Nullable Void... paramVarArgs)
  {
    ...
    {
      urk.e(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoLrtbwidgetVideoViewVideoHolder.jdField_a_of_type_JavaLangString, "video info empty , report error! vid :%s", new Object[] { this.jdField_a_of_type_Tnz.jdField_a_of_type_JavaLangString });
      return null;
    }
    paramJobContext = ((sqs)sqg.a(2)).b(localStoryVideoItem.mOwnerUid);
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("vote_id", urp.a(localStoryVideoItem));
        ...
        localJSONObject.put("viewer_id", urp.a(paramVarArgs, localVideoListFeedItem));
        localJSONObject.put("sharefromapp", Integer.toString(skt.a(2131361826)));
        ...
        bool = true;
        vkw.a(bool, "storyVideoItem.mSourceType is illegal");
        ...
        paramVarArgs = srv.a(localStoryVideoItem.mLinkInfoJson);
      ...
      localJSONObject.put("wifi_ssid", vlt.b(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoLrtbwidgetVideoViewVideoHolder.a()));
      localJSONObject.put("wifi_mac", vlt.a(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoLrtbwidgetVideoViewVideoHolder.a()));
      ...
      {
        paramVarArgs = "";
        urp.a("play_video", "video_all_js", i, j, new String[] { localObject, paramVarArgs, this.jdField_a_of_type_JavaLangString, localStoryVideoItem.mVid });
        urp.a("play_video", "video_property", i, this.jdField_a_of_type_Int, new String[] { localStoryVideoItem.mOwnerUid + "", paramJobContext, "1", localStoryVideoItem.mVid });
        urp.a("play_video", "video_time", i, this.jdField_a_of_type_Int, new String[] { this.jdField_a_of_type_Long + "", this.b + "", l + "", localStoryVideoItem.mVid });
        urk.a(this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoLrtbwidgetVideoViewVideoHolder.jdField_a_of_type_JavaLangString, "report user video done , op_result : %d ,json :%s", Integer.valueOf(this.jdField_a_of_type_Int), localJSONObject);
