...
public class axnk
{
  ...
  public axnk(MultiCardFragment paramMultiCardFragment, MultiCardRootLayout paramMultiCardRootLayout, MultiCardCustomLayout paramMultiCardCustomLayout, axmv paramaxmv, axmx paramaxmx)
  {
    ...
    if (this.jdField_a_of_type_Axmv != null) {
      this.jdField_a_of_type_Axmv.a(paramaxmx);
    }
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardCustomLayout != null)
    {
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardCustomLayout.findViewById(2131371536);
      if (localObject != null)
      {
    ...
    if (this.jdField_a_of_type_Axmv != null) {
      this.jdField_a_of_type_Axmv.b(0);
    }
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Axmv != null) {
      this.jdField_a_of_type_Axmv.b(1);
    }
  }
}
