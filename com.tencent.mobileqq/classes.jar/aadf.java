...
public class aadf
  extends zxu<SubscribeDraftBean>
  implements zwr
{
  public static int a;
  ...
  public aadf(Bundle paramBundle)
  {
    super(paramBundle);
  }
  ...
  public void a()
  {
    if ((getBlockMerger() != null) && (getContext() != null) && (((PublicFragmentActivity)getContext()).app != null))
    {
      ...
      if (aaje.a().a(this.jdField_b_of_type_JavaLangString)) {
        aaje.a().a(this.jdField_b_of_type_JavaLangString, new aadg(this));
      }
    }
    else
    {
  ...
  {
    if ((paramViewHolder instanceof aadh)) {
      ((aadh)paramViewHolder).a((SubscribeDraftBean)getDataList().get(paramInt));
    }
  ...
  {
    return new aadh(this, new SubScribeDraftItemView(paramViewGroup.getContext(), this));
  }
