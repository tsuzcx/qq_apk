...
public class agvt
{
  ...
  public agvt(Context paramContext, LinearLayout paramLinearLayout, int paramInt, boolean paramBoolean, AnimationView.MyAnimationListener paramMyAnimationListener)
  {
  ...
  public agvt(AnimationView paramAnimationView, int paramInt, boolean paramBoolean, AnimationView.MyAnimationListener paramMyAnimationListener)
  {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    agvv localagvv = new agvv(this, null);
    if (paramBoolean) {}
    for (String str = "0";; str = "1")
    {
      localagvv.execute(new String[] { paramString, str });
      return;
    }
  }
}
