  ...
  extends akoo
{
  ...
  public akqx(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      {
        ayda.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool1);
        localakbo = (akbo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34);
        j = localakbo.c();
        ayda.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsf.M, 0);
        localakbo.b();
        a(4014, true, null);
        return;
      }
    ...
    localakbo.a(new atyt(paramToServiceMsg, l1));
    return;
    label884:
    j = k;
    if (m == 0)
    ...
    ayda.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    label1328:
    label1334:
    label1340:
    label1876:
    if (j == 0)
    {
      ...
      if (paramRspSystemMsgNew.size() > 0)
      {
        ...
        l3 = ayda.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsf.M, 0, l3);
        localObject2 = paramFromServiceMsg.iterator();
        if (j < 20) {
          while (((Iterator)localObject2).hasNext())
          {
            localObject1 = (ChatMessage)((Iterator)localObject2).next();
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsf.M, 0, ((ChatMessage)localObject1).uniseq, false);
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsf.M, 0, ((ChatMessage)localObject3).uniseq, false);
            ((Iterator)localObject2).remove();
          }
          else if ((localObject3 instanceof MessageForSystemMsg))
          {
            ...
            if ((j == 13) && (((ajxn)localObject1).b(str)))
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsf.M, 0, ((ChatMessage)localObject3).uniseq, false);
              ((Iterator)localObject2).remove();
            }
        ...
        {
          ayda.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l2);
          ...
          if ((!akau.a(paramRspSystemMsgNew)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {
            break label1925;
          }
          bool2 = true;
          ...
          localakbo.a(new atyt(paramObject, l1));
        }
      }
    }
    for (;;)
    {
      ...
      ayda.a().a(true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label1925:
      bool2 = false;
      break label1842;
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    RecentUser localRecentUser = localaktg.a(ajsf.D, 4000);
    localRecentUser.msgType = 26;
    localRecentUser.displayName = akbo.jdField_a_of_type_JavaLangString;
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      if (m == 3)
      {
        afoq.a(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew, paramFromServiceMsg, i1, str1);
        return;
      }
      afoq.a(paramRspSystemMsgNew, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    } while (n == 0);
    this.d = 0;
    ...
    aydb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i1);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(ajsf.W, 9000, i1 - j);
    paramObject = new ArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsf.N, 0, true, false);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsf.S, 0, true, false);
    aydb.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    paramToServiceMsg = (askq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
    if (paramToServiceMsg != null) {
      paramToServiceMsg.a(false);
    }
    Collections.sort(paramFromServiceMsg, new akqy(this));
    j = 0;
    if (j < n)
    {
      localObject1 = axaq.a(-2018);
      ((MessageRecord)localObject1).msgtype = -2018;
      ((MessageRecord)localObject1).selfuin = str1;
      ((MessageRecord)localObject1).frienduin = ajsf.N;
      ...
      if ((m == 1) && (!bool1)) {
        if ((k == 2) && (i3 == 2))
        {
          ...
          if (((TroopManager)localObject3).b(str2) == null)
          {
            ...
            ((akhq)localObject4).a(paramToServiceMsg.troopuin, false, "", true, true, true, false);
            ((akhq)localObject4).a(1, ajsz.a(paramToServiceMsg.troopuin), 0L, 2, 0, 0, true);
            ((akhq)localObject4).notifyUI(127, true, new Object[] { str2 });
          }
          if (localMessageForSystemMsg.structMsg.msg.msg_invite_extinfo.has())
          {
            ...
            if ((k == 2) || (k == 4))
            {
              ...
              aqva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForSystemMsg, paramToServiceMsg, str2);
              if (QLog.isColorLevel()) {
            ...
            bool1 = false;
            label1729:
            paramToServiceMsg = (akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
            if (paramToServiceMsg != null) {
        ...
        else
        {
          ...
          else
          {
            ...
            if ((k == 2) && (i3 == 2))
            {
              ...
              {
                if ((k == 2) || (k == 4)) {
                  aqva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForSystemMsg, paramToServiceMsg, String.valueOf(l1));
                }
                bool2 = bool3;
                if (k == 4) {
                  bool2 = false;
            ...
            else if ((k == 13) || (k == 6))
            {
              ...
              if ((paramToServiceMsg != null) && (!paramToServiceMsg.a(((structmsg.StructMsg)localObject2).msg.group_code.get(), ((structmsg.StructMsg)localObject2).msg_time.get())))
              {
                ...
                if (localObject4 != null) {
                  ((akhq)localObject4).a(str2, (String)localObject3, true);
                }
                paramToServiceMsg.a(((structmsg.StructMsg)localObject2).msg.group_code.get(), ((structmsg.StructMsg)localObject2).msg_time.get());
              }
            }
    ...
    if (paramObject.size() > 0)
    {
      ...
      if ((!akau.a(paramObject)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {
        break label3830;
      }
    }
    label3830:
    for (bool1 = true;; bool1 = false)
    {
      ...
      if (!TextUtils.isEmpty(paramRspSystemMsgNew.grp_msg_display.get())) {
        aydb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew.grp_msg_display.get());
      }
      if ((paramRspSystemMsgNew.msg_ribbon_group.has()) && (paramRspSystemMsgNew.msg_ribbon_group.get() != null))
      {
        ...
        paramToServiceMsg = axaq.a(-2018);
        paramToServiceMsg.selfuin = str1;
        paramToServiceMsg.frienduin = ajsf.S;
      ...
      paramToServiceMsg = (akfc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33);
      paramRspSystemMsgNew = ((MessageForSystemMsg)paramObject.get(0)).getSystemMsg();
      aydb.a().a(paramRspSystemMsgNew);
      l1 = paramRspSystemMsgNew.msg_time.get();
      paramToServiceMsg.a(ajsf.W, 9000, ajyc.a(2131691088), l1, l1);
  ...
  public void a()
  {
    ...
    a(true, true, false, 0L, new akrc(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, String paramString)
  {
    ...
    paramSystemMsgActionInfo = new ayti();
    ...
    paramSystemMsgActionInfo.jdField_a_of_type_Ayth = new akra(this);
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, structmsg.StructMsg paramStructMsg, boolean paramBoolean)
  {
    ...
    localayti.a();
    localayti.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgAction.Friend";
    localayti.jdField_a_of_type_ArrayOfByte = ((structmsg.ReqSystemMsgAction)localObject).toByteArray();
    ...
    localayti.jdField_a_of_type_JavaLangObject = localObject;
    localayti.jdField_a_of_type_Ayth = new akrb(this, paramInt6, paramInt3, paramSystemMsgActionInfo, paramStructMsg, paramLong2);
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    {
      aqva.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte, paramLong1, paramLong2, paramMsgHead);
      b(2001, true, null);
    }
  }
  ...
  public void a(long paramLong1, long paramLong2, short paramShort, int paramInt1, msg_comm.Msg paramMsg, int paramInt2)
  {
    ...
    while (paramShort != 190)
    {
      ...
      localObject = SystemMsg.decode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bbdm.a((byte[])localObject), String.valueOf(str), paramInt1);
      if (localObject != null) {}
      for (localObject = ((SystemMsg)localObject).strGameName;; localObject = "")
      {
        ...
        afkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong1, paramLong2, paramShort, paramMsg, paramInt2);
        return;
      }
    }
    ((ajxn)localObject).a(str, false);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsf.M, 0);
        ((akbo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34)).b();
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_suspicious_seq");; l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_seq"))
    {
      ...
      ayti localayti = new ayti();
      localayti.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Group";
      localayti.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
      localayti.jdField_a_of_type_Ayth = new akre(this, l2, l3, l1);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localayti);
      return;
    }
  }
  ...
  public void b()
  {
    ...
    ayti localayti = new ayti();
    localayti.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Friend";
    localayti.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
    localayti.jdField_a_of_type_Ayth = new akrd(this, l1, l2, l3);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localayti);
  }
  ...
  public void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject = new ayti();
      ((ayti)localObject).a();
      ((ayti)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Group";
      ((ayti)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
      ((ayti)localObject).jdField_a_of_type_JavaLangObject = new Integer(paramInt);
      ((ayti)localObject).jdField_a_of_type_Ayth = new akqz(this);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((ayti)localObject);
      return;
  ...
  public void d()
  {
    ...
    a(true, true, false, 0L, new akrf(this, l, localReqSystemMsgRead));
  }
  ...
  public void e()
  {
    ...
    a(true, true, false, 0L, new akrg(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void g()
  {
    ...
    localObject = new ayti();
    ((ayti)localObject).a();
    ((ayti)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Friend";
    ((ayti)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
    ((ayti)localObject).jdField_a_of_type_Ayth = new akrh(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((ayti)localObject);
  }
