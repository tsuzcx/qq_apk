...
public class oqb
{
  ...
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new oqc(this);
  ...
  private final LbsManagerService.OnLocationChangeListener jdField_a_of_type_ComTencentMobileqqAppSosoLbsManagerService$OnLocationChangeListener = new oqi(this, "readinjoy_weather");
  private final pvq jdField_a_of_type_Pvq = new oqj(this);
  private int jdField_b_of_type_Int = -1;
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new oqe(this);
  private final View.OnClickListener c = new oqf(this);
  private final View.OnClickListener d = new oqg(this);
  private View.OnClickListener e;
  
  public oqb(@NonNull VafContext paramVafContext)
  {
  ...
  private static Container a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = tmh.a("daily_dynamic_header", true);
        if (localObject != null)
        {
          paramJSONObject = ((tmh)localObject).getTemplateBean(paramJSONObject);
          if (paramJSONObject != null)
          {
            paramVafContext = paramVafContext.getViewFactory().inflate(paramVafContext, paramJSONObject);
            piv.a(paramVafContext, null, paramJSONObject);
  ...
  private Container a(JSONObject paramJSONObject, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_b_of_type_Int == -1) || (this.jdField_b_of_type_Int == 0))
    {
      ...
      {
        Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130843253);
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext)
  {
    ...
    paramContext = paramContext.getResources().getDrawable(2130843253);
  ...
  private void a(int paramInt)
  {
    ...
    bmhv.a("sp_key_daily_dynamic_header_state", Integer.valueOf(this.jdField_a_of_type_Int));
  ...
  private void a(@NonNull View paramView, @NonNull Container paramContainer, @NonNull Drawable paramDrawable, JSONObject paramJSONObject)
  {
    ...
    ((DailyTitleBar)paramView.findViewById(2131372066)).setVisibility(8);
    DailyTitleBarSwitcher localDailyTitleBarSwitcher = (DailyTitleBarSwitcher)paramView.findViewById(2131365376);
    ...
    ReadInJoyDailyPullToZoomHeaderXListView localReadInJoyDailyPullToZoomHeaderXListView = (ReadInJoyDailyPullToZoomHeaderXListView)paramView.findViewById(2131378302);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(paramView.getContext()).inflate(2131560203, localReadInJoyDailyPullToZoomHeaderXListView, false));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363343));
    opz.a(paramDrawable);
    opz.a(this.jdField_a_of_type_AndroidWidgetImageView);
  ...
  private static void a(Container paramContainer, String paramString, JSONObject paramJSONObject)
  {
    ...
    ViewFactory.findClickableViewListener(paramContainer.getVirtualView(), new oql(paramString, paramJSONObject));
  }
  ...
  private void a(@NonNull BaseActivity paramBaseActivity, @NonNull Runnable paramRunnable)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        paramBaseActivity.requestPermissions(new oqk(this, paramRunnable), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      paramRunnable.run();
      return;
  ...
  private void a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2131166896);
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher == null) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher = ((DailyTitleBarSwitcher)this.jdField_a_of_type_AndroidViewView.findViewById(2131365376));
      }
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher.setOnTitleClickWeatherListener(new oqd(this, paramJSONObject));
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bmhv.a("sp_key_daily_dynamic_header_last_refresh_time", Long.valueOf(0L))).longValue();
  ...
  private static boolean a(Container paramContainer, JSONObject paramJSONObject)
  {
    ...
    if ((localObject instanceof TemplateBean))
    {
      ...
      try
      {
        tmh localtmh = tmh.a("daily_dynamic_header", true);
        if (localtmh != null) {}
        for (paramJSONObject = localtmh.getTemplateBean(paramJSONObject); (paramJSONObject != null) && (TextUtils.equals(paramJSONObject.getStyleName(), ((TemplateBean)localObject).getStyleName())) && (((TemplateBean)localObject).getId() == paramJSONObject.getId()); paramJSONObject = null)
        {
          QLog.i("DailyHeaderViewController", 1, "[bindDataForProteusHeader] template match, bind data");
          piv.a(paramContainer, (TemplateBean)localObject, paramJSONObject);
          return true;
        }
        return false;
      }
  ...
  private void b()
  {
    ...
    DailyTitleBar localDailyTitleBar = (DailyTitleBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131372066);
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131365376).setVisibility(8);
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      ((ReadInJoyDailyPullToZoomHeaderXListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378302)).removeHeaderView(this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  private void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localJSONObject.putOpt("error_reason", anvx.a(2131702195)).putOpt("operation_text", anvx.a(2131702200));
      View.OnClickListener localOnClickListener = this.c;
      for (;;)
      {
        a(localJSONObject, localOnClickListener);
        return;
        localJSONObject.putOpt("error_reason", anvx.a(2131702201)).putOpt("operation_text", anvx.a(2131702198));
        localOnClickListener = this.d;
        continue;
        localJSONObject.putOpt("error_reason", anvx.a(2131702202)).putOpt("operation_text", anvx.a(2131702199));
  ...
  private void b(View paramView)
  {
    ...
    a(((Integer)bmhv.a("sp_key_daily_dynamic_header_state", Integer.valueOf(0))).intValue());
  }
  ...
  private static void b(String paramString, JSONObject paramJSONObject)
  {
    ...
    localpqg.b("model_type", a(paramString));
    localpqg.b("topic_id", paramJSONObject.optString("topic_id", ""));
    olh.a(null, "CliOper", "", "", "0X8009D12", "0X8009D12", 0, 0, "", "", "", localpqg.a(), false);
  }
  ...
  private void c()
  {
    JSONObject localJSONObject = pvj.a().a();
    Object localObject;
    ...
    if (localContainer != null)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2131166896);
        }
      }
    }
    a(0);
  ...
  private static void c(String paramString, JSONObject paramJSONObject)
  {
    ...
    localpqg.b("model_type", a(paramString));
    localpqg.b("topic_id", paramJSONObject.optString("topic_id", ""));
    olh.a(null, "CliOper", "", "", "0X8009D13", "0X8009D13", 0, 0, "", "", "", localpqg.a(), false);
  }
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      ((JSONObject)localObject).putOpt("error_reason", anvx.a(2131702193));
      for (;;)
      {
        ((JSONObject)localObject).putOpt("operation_text", anvx.a(2131702194));
        break;
        ((JSONObject)localObject).putOpt("error_reason", anvx.a(2131702197));
        continue;
        ((JSONObject)localObject).putOpt("error_reason", anvx.a(2131702196));
      }
    }
  }
