...
public class atgb
  extends aoau
{
  public atgb(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  
  protected void a(athc paramathc, boolean paramBoolean, int paramInt)
  {
    super.a(paramathc, paramBoolean, paramInt);
    ...
    if (paramathc == null)
    {
      ...
      if ((this.a.jdField_b_of_type_Int == 0) && (paramathc != null) && (!this.a.a(paramathc, this.a.jdField_a_of_type_JavaUtilList)))
      {
        this.a.jdField_a_of_type_JavaUtilList.add(paramathc);
        if (QLog.isColorLevel()) {
        ...
        Face2FaceAddFriendActivity.a(this.a, paramathc);
      }
    }
    for (;;)
    {
      ...
      QLog.d(Face2FaceAddFriendActivity.jdField_a_of_type_JavaLangString, 2, "onGetFaceToFaceNearbyUserPush, nearbyUser=" + paramathc.e);
      break;
      label267:
      Message localMessage = Face2FaceAddFriendActivity.a(this.a).obtainMessage();
      localMessage.what = 10;
      localMessage.obj = paramathc;
      Face2FaceAddFriendActivity.a(this.a).sendEmptyMessageDelayed(10, this.a.a());
    }
  }
  
  protected void a(boolean paramBoolean, List<athc> paramList, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      long l = System.currentTimeMillis() - atgp.c;
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.jdField_a_of_type_JavaLangString, 2, "onGetFaceToFaceNearbyUserList interval=" + l + "leaveFaceTofaceTime=" + atgp.c);
      }
      if ((l > i * 1000) || (atgp.c == 0L)) {
        break label259;
      }
    ...
    for (;;)
    {
      ...
      {
        localatha = (atha)paramList.next();
        if (!this.a.jdField_a_of_type_JavaUtilList.contains(localatha)) {}
      }
      else
      {
      ...
      this.a.jdField_a_of_type_JavaUtilList.add(localatha);
    }
  }
}
