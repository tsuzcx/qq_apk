...
public class afvc
  implements Runnable
{
  public afvc(ScanTorchActivity paramScanTorchActivity, ArrayList paramArrayList, int paramInt, String paramString) {}
  ...
  public void run()
  {
    ...
    if (ScanTorchActivity.a(this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity) == null)
    {
      ...
      ScanTorchActivity.a(this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity).a(new afvd(this));
      ...
      String str = "http://sqimg.qq.com/qq_product_operations/mma/binhai_redpack_2017/rank.html?_wv=536929249&_wwv=5&actid=" + ScanTorchActivity.d(this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity);
