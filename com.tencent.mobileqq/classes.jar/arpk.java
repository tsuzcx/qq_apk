  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      ...
      localObject1 = bbco.encodeToString(((cmd0xccb.RspBody)localObject2).res_id.get().toByteArray(), 0);
    ...
    catch (Exception paramFromServiceMsg)
    {
      ...
      notifyObserver(paramIntent, 0, false, paramIntent.getExtras(), arph.class);
      return;
    }
    int n;
    ...
    notifyObserver(paramIntent, 0, bool, paramIntent.getExtras(), arph.class);
    return;
    label770:
    for (;;)
    {
