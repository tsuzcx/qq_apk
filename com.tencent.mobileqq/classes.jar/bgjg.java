  ...
  extends bgix
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bgjh(this);
  ...
  private void a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      if (paramInt1 > 0)
      {
        str = String.format(localActivity.getString(2131652323), new Object[] { Integer.valueOf(paramInt1) }) + "，";
        str = str + paramString + ajjy.a(2131646494);
      }
      paramString = str + String.format(localActivity.getString(2131652316), new Object[] { Integer.valueOf(paramInt2) });
      babr.a(localActivity, 232).setMessage(paramString).setNegativeButton(2131652321, new bgjn(this)).show();
      return;
    }
    bcec.a().a(localActivity.getString(2131652324) + paramString + ajjy.a(2131646493));
  }
  
  private void a(String paramString)
  {
    bgbz.a().a().d(paramString);
  }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localIntent.putExtra("source_name", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getString(2131652127));
  ...
  private void c(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        i = babl.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getAccount(), "troop_photo_message", String.valueOf(i));
        if (QLog.isDevelopLevel()) {
  ...
  private void f(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 1, l, "", paramVarArgs, (String)localObject, 7001, 43);
      return;
    }
    catch (Exception paramVarArgs)
    {
  ...
  private void h(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        bfpr.c(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), (bfpy)localObject2, (Bundle)localObject4, 6);
  ...
  private void i(String... paramVarArgs)
  {
    ...
    bgbz.a().a(new bgji(this, paramVarArgs));
    if (!a())
    {
      bcec.a().a(ajjy.a(2131646492));
      return;
    }
    if (!NetworkState.isNetSupport())
    {
      bcec.a().a(ajjy.a(2131646489));
      return;
    }
    if (!NetworkState.isWifiConn())
    {
      Activity localActivity = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a();
      babr.a(localActivity, 230).setTitle(localActivity.getString(2131652320)).setMessage(localActivity.getString(2131652322)).setPositiveButton(localActivity.getString(2131652319), new bgjm(this, paramVarArgs)).setNegativeButton(localActivity.getString(2131652318), new bgjl(this)).show();
      return;
    }
    a(paramVarArgs[0]);
  }
  ...
  private void j(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 4, j, "", paramVarArgs, (String)localObject, 7001, 43);
        return;
      }
      catch (Exception paramVarArgs) {}
  ...
  private void l(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localbfpy.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getCurrentAccountUin();
        paramVarArgs.putBoolean("key_need_change_to_jpg", true);
        bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), localbfpy, paramVarArgs, bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, 6));
        return;
      }
      catch (Exception paramVarArgs) {}
    } while (!QLog.isColorLevel());
