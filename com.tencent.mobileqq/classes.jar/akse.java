  ...
  extends Dialog
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajsd.aW + "MsgPushNotify" + File.separator;
    ...
    jdField_g_of_type_JavaLangString = ajya.a(2131706962);
    h = ajya.a(2131706956);
    i = ajya.a(2131706959);
  ...
  @TargetApi(14)
  public akse(Context paramContext)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString == null)
    {
      jdField_a_of_type_AndroidContentIntent = bbfa.a(paramQQAppInterface.getApp());
      return;
    }
    Object localObject;
    label143:
    ...
    } while ((!((String)localObject).equals("device")) || (!paramString.getAttributeValue(null, "id").equals(bbdh.d())));
    jdField_a_of_type_AndroidContentIntent = null;
    for (;;)
    {
      if (paramString.next() != 3)
  ...
  public static boolean a(File paramFile)
  {
    ...
    for (;;)
    {
      ...
      if (k < jdField_a_of_type_Int)
      {
        bbdx.d(String.format(jdField_c_of_type_JavaLangString + jdField_e_of_type_JavaLangString, new Object[] { Integer.valueOf(k) }));
        k += 1;
      }
      else
      {
        if (paramFile.exists())
        {
          bbdx.a(paramFile.getPath(), jdField_b_of_type_JavaLangString, false);
          return true;
        }
        return false;
        label151:
  ...
  private static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      if ((jdField_a_of_type_Bbwu.a() == 2) || (jdField_a_of_type_Bbwu.a() == 3))
      {
        QLog.d(jdField_a_of_type_JavaLangString, 1, "res download duplicated, " + str);
        return false;
      }
      QLog.d(jdField_a_of_type_JavaLangString, 1, "res download task status error, cancel it, status: " + jdField_a_of_type_Bbwu.a());
      jdField_a_of_type_Bbwu.a(true);
    }
    jdField_a_of_type_Bbwu = new bbwu(jdField_f_of_type_JavaLangString, localFile);
    jdField_a_of_type_Bbwu.n = true;
    paramQQAppInterface = ((bbww)paramQQAppInterface.getManager(47)).a(1);
    QLog.d(jdField_a_of_type_JavaLangString, 1, "start download ");
    paramQQAppInterface.a(jdField_a_of_type_Bbwu, new aksi(str), null);
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131558914);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131365139));
    ...
    try
    {
      ...
      localButton.setText(ajya.a(2131706957));
      localButton.setOnClickListener(new aksf(this));
      localImageView.setOnClickListener(new aksg(this));
      localImageView.setOnTouchListener(new aksh(this, localImageView));
      return;
    }
