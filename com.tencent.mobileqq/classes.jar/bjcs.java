  ...
  extends Drawable
{
  ...
  public bjcs(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof bjcs))) {}
    Object localObject;
    do
    {
    ...
    return new bjcs((Bitmap)localObject);
  }
  
  public static bjcs a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new bjcs(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f1 = 0.0F;
    switch (bjct.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
    {
    case 4: 
    default: 
      this.d.set(this.c);
  ...
  public bjcs a(float paramFloat)
  {
  ...
  public bjcs a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public bjcs a(ColorStateList paramColorStateList)
  {
  ...
  public bjcs a(Shader.TileMode paramTileMode)
  {
  ...
  public bjcs a(ImageView.ScaleType paramScaleType)
  {
  ...
  public bjcs a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public bjcs b(Shader.TileMode paramTileMode)
  {
