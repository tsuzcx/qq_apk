    ...
    for (;;)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        for (;;)
        {
          ...
          if (k < m)
          {
            ...
            for (;;)
            {
              ...
              l2 = l3;
              break label448;
              paramVarArgs = new bcfq(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgm(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcfr(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcfz(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgi(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgf(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgg(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcfw(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcfu(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcfx(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgh(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcge(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              paramVarArgs = new bcgc(str1, l3, localArrayList2, localResultItem, i);
              break label583;
              l2 = l1 - 1L;
              continue;
              if (!bcnc.b(l2))
              ...
              {
                paramVarArgs = new bcgs(str1, str7, -4, str5);
                paramVarArgs.u = localResultItem.seporator_type.get();
                localArrayList3.add(paramVarArgs);
                l2 = l1;
              }
              ...
              {
                paramVarArgs = new bceh(str1, paramVarArgs, (String)localObject, str5, str6, str7, l2, localArrayList2, i);
                l2 = l1;
        ...
        if (l1 > 0L)
        {
          ...
          {
            localArrayList1.add(new bceg(str1, l3, str2, localArrayList3, l1, paramVarArgs, (String)localObject, localArrayList2, bool1, bool2, bool3, str3, str4));
            break;
            bool2 = false;
            break label1159;
          }
