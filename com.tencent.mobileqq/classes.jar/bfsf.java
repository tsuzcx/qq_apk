...
public class bfsf
  implements bkik, bkja
{
  public static String a;
  protected final int a;
  protected long a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bfmu jdField_a_of_type_Bfmu;
  ...
  public bfsf(boolean paramBoolean, bfmu parambfmu)
  {
  ...
  private void a()
  {
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((JSONArray)localObject1).put(bfsk.a((WadlResult)((Iterator)localObject2).next()));
    }
    localObject1 = ((JSONArray)localObject1).toString();
    localObject2 = this.jdField_a_of_type_Bfmu.getJsCallbackMethod();
  ...
  private void a(int paramInt, WadlParams paramWadlParams)
  {
    ...
    while (i != 0)
    {
      a(bfsk.a(paramInt));
      return;
      bkis.a().c(0, paramWadlParams.jdField_a_of_type_JavaLangString);
      i = j;
      continue;
      bkis.a().a(0, paramWadlParams.jdField_a_of_type_JavaLangString);
  ...
  private void b(String paramString)
  {
    ...
    {
      return;
      bfrz.c(jdField_a_of_type_JavaLangString, "doJsCallBack loadJs=" + paramString);
      try
      {
        WebView localWebView = this.jdField_a_of_type_Bfmu.getWebview();
      ...
      {
        bfrz.a(jdField_a_of_type_JavaLangString, "doJsCallback exception", paramString);
      }
    }
  }
  ...
  public void a(WadlResult paramWadlResult)
  {
    ...
    {
      paramWadlResult = bfsk.a(paramWadlResult).toString();
      str = this.jdField_a_of_type_Bfmu.getJsCallbackMethod();
  ...
  public void a(String paramString)
  {
    ...
    {
      bfrz.a(jdField_a_of_type_JavaLangString, "showToast>>>", paramString);
    }
  }
  ...
  {
    bfrz.c(jdField_a_of_type_JavaLangString, "onCmdRsp cmd=" + paramString + ",isSucc");
  ...
  {
    bfrz.c(jdField_a_of_type_JavaLangString, "onQueryCallback params:" + paramArrayList);
    ...
    if (paramArrayList != null) {
      try
      {
        ...
        {
          localJSONArray.put(bfsk.a((WadlResult)paramArrayList.next()));
          continue;
          return;
        }
      }
      ...
      {
        bfrz.a(jdField_a_of_type_JavaLangString, "onQueryCallback exception:" + paramArrayList.getMessage());
      }
    }
  ...
  {
    bfrz.c(jdField_a_of_type_JavaLangString, "onQueryCallbackVia params:" + paramArrayList);
    JSONArray localJSONArray;
    if (paramArrayList != null) {
      try
      {
      ...
      {
        bfrz.a(jdField_a_of_type_JavaLangString, "onQueryCallbackVia exception:" + paramArrayList.getMessage());
      }
    }
  ...
  public void onWadlTaskStatusChanged(WadlResult paramWadlResult)
  {
    ...
    {
      bfrz.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged error wadlResult is null");
      return;
    }
    WadlParams localWadlParams = paramWadlResult.a;
    String str = localWadlParams.jdField_a_of_type_JavaLangString;
    int i = bfsk.a(paramWadlResult.b);
    bfse.b(localWadlParams.jdField_a_of_type_JavaLangString);
    bfrz.c(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged:" + paramWadlResult + ",localStatus:" + i);
    switch (i)
    {
    default: 
      bfrz.a(jdField_a_of_type_JavaLangString, "download status not response!");
      return;
    case 3: 
    case 4: 
    case 6: 
    ...
    case -2: 
      ...
      bfrz.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged  error,wadlErrCode=" + i);
      c(str);
      a(i, localWadlParams);
      a(paramWadlResult);
      return;
