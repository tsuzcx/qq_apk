...
public class xdu
  implements Runnable
{
  public xdu(RedPacketManager paramRedPacketManager, String paramString1, String paramString2, int paramInt) {}
  ...
  public void run()
  {
    ...
    //   24: aload_0
    //   25: getfield 17	xdu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   28: invokevirtual 58	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   31: aload_0
    //   32: getfield 19	xdu:b	Ljava/lang/String;
    ...
    //   43: aload_0
    //   44: getfield 21	xdu:jdField_a_of_type_Int	I
    ...
    //   118: aload_0
    //   119: aload_1
    //   120: invokespecial 110	xdv:<init>	(Lxdu;LWallet/GetGroupRedPackListRsp;)V
