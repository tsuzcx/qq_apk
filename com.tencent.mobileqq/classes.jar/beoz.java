  ...
  implements beoy
{
  ...
  public static beoy a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.qqmini.sdk.ipc.IAppMainService");
    if ((localIInterface != null) && ((localIInterface instanceof beoy))) {
      return (beoy)localIInterface;
    }
    return new bepa(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 5: 
      ...
      {
        a((String)localObject2, str, (Bundle)localObject1, bepe.a(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      }
    }
