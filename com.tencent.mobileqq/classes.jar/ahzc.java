...
public class ahzc
  implements Runnable
{
  public ahzc(ConfigSetting paramConfigSetting, ConfigurationService.Config paramConfig) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      while (((Iterator)localObject6).hasNext())
      {
        ...
        ahzf localahzf = new ahzf(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting, null);
        localahzf.jdField_b_of_type_ArrayOfJavaLangString = ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting, str);
        ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting).put(localObject7, localahzf);
      }
      ...
      if (((Iterator)localObject4).hasNext())
      {
        ...
        localObject7 = (ahzf)ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting).get(localObject5);
        str = ((JSONObject)localObject6).optString("key");
        ((ahzf)localObject7).jdField_a_of_type_ArrayOfJavaLangString = ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting, str);
        if (ConfigSetting.e(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting) == 1) {
          ((ahzf)localObject7).jdField_a_of_type_JavaLangString = ((JSONObject)localObject6).optString("Tips1");
        }
        for (((ahzf)localObject7).jdField_b_of_type_JavaLangString = ((JSONObject)localObject6).optString("Link1");; ((ahzf)localObject7).jdField_b_of_type_JavaLangString = ((JSONObject)localObject6).optString("Link0"))
        {
          ...
          localEditor.putString("key_str_key_tips" + (String)localObject5, ((ahzf)localObject7).jdField_a_of_type_JavaLangString);
          localEditor.putString("key_str_key_link" + (String)localObject5, ((ahzf)localObject7).jdField_b_of_type_JavaLangString);
          break;
          ((ahzf)localObject7).jdField_a_of_type_JavaLangString = ((JSONObject)localObject6).optString("Tips0");
        }
      }
