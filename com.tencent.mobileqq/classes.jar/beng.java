  ...
  implements aaob
{
  ...
  private void g(String paramString)
  {
    ...
    a();
    localObject = new biau((Context)localObject, ((BaseActivity)localObject).getTitleBarHeight());
    ((biau)localObject).a(paramString);
    ((biau)localObject).setCancelable(false);
    ((biau)localObject).setOnDismissListener(new beni(this));
    this.jdField_a_of_type_Biau = ((biau)localObject);
  ...
  private void h(String paramString)
  {
    ...
    {
      QQToast.a((Context)localObject, 2131693946, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131718883));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131693131));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131694081));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131694082));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131695416));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131718888));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  {
    c();
    bkho localbkho = (bkho)bkif.a(this.mRuntime.a(), null);
    localbkho.a(2131718881);
    localbkho.a(2131718882, 3);
    localbkho.c(2131690582);
    localbkho.setOnDismissListener(new benj(this));
    localbkho.a(new benk(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!bgnt.d(localBaseActivity)) {
      QQToast.a(localBaseActivity, 2131693946, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  public void d(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	beng:mRuntime	Lbhod;
    //   4: invokevirtual 70	bhod:a	()Landroid/app/Activity;
    //   7: astore_3
    ...
    catch (JSONException paramString)
    {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          benf.a(localActivity, localActivity.getIntent().getExtras(), paramString);
        }
        return;
      }
      catch (JSONException paramString) {}
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString3 = this.jdField_a_of_type_Aanz;
      if (j == -1) {}
      ...
      if (paramString3.equals("insertCreateGroupSuccessMsg")) {
        try
        {
          ...
          this.jdField_a_of_type_Aanz.a(paramJsBridgeListener, paramString1, i, paramString2, this);
        }
      ...
      {
        paramJsBridgeListener.a("8.4.1.4680");
        break label2264;
      }
      if (paramString3.equals("isNetworkConnected"))
      {
        paramJsBridgeListener.a(Boolean.valueOf(bist.d(biip.a().a())));
        break label2264;
      }
    ...
    else
    {
      ...
      if ("updateTroopBindedPubAccount".equals(paramString3))
      {
        try
        {
          ...
          if (j > 0)
          {
            ...
            this.jdField_a_of_type_Aanz.a(l, paramString1);
          }
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("getLastSpeakMessage".equals(paramString3))
      {
        try
        {
          ...
          paramString2 = paramString2.optString("callback");
          this.jdField_a_of_type_Aanz.a(paramJsBridgeListener, paramString1, new benh(this, paramString2));
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("notifyTroopEnterEffectStatus".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Aanz.a(i, j, k, paramString1);
      ...
      else if ("returnToTroopAIO".equals(paramString3))
      {
        ...
        SensorAPIJavaScript.returnToAio(this.jdField_a_of_type_Aanz, this.mRuntime.a(), paramJsBridgeListener, true);
        break label2264;
      }
      else
      {
        if ("notifyCreateTroops".equals(paramString3))
        {
          try
          {
            ...
            paramString2 = paramString2.optString("callback");
            this.jdField_a_of_type_Aanz.a(paramJsBridgeListener, paramString1, paramString2, this);
          }
          catch (JSONException paramJsBridgeListener)
          {
            if (!QLog.isColorLevel()) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramString2 != null) && (paramString2.length() > 0))
              {
                ...
                this.jdField_a_of_type_Aanz.a(paramString3);
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      if (bool) {
        QQToast.a((Context)localObject2, 2131718880, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        QQToast.a((Context)localObject2, 2131718885, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131718892);
    }
    for (;;)
    {
      ...
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131718879);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131718884);
      }
    }
  }
