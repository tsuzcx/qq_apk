...
public class bise
{
  ...
  private bisg jdField_a_of_type_Bisg;
      ...
      try
      {
        ...
        if (Build.VERSION.SDK_INT >= 19)
        {
          ...
          if (this.jdField_a_of_type_Bisg != null) {
            this.jdField_a_of_type_Bisg.beforeDraw((Bundle)localObject3);
          }
          ...
          if (this.jdField_a_of_type_Bisg != null) {
            this.jdField_a_of_type_Bisg.afterDraw((Bundle)localObject3);
          }
  ...
  public bise a(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    return this;
  }
  
  public bise a(bisg parambisg)
  {
    this.jdField_a_of_type_Bisg = parambisg;
    return this;
  }
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Bisf != null) {
      bool = this.jdField_a_of_type_Bisf.isDirty();
    }
    for (;;)
    {
  ...
  public void c()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bisg = null;
