...
public class bise
{
  private static volatile bise jdField_a_of_type_Bise;
  private ITMAssistantExchangeURLListenner jdField_a_of_type_ComTencentTmdatasourcesdkITMAssistantExchangeURLListenner = new bisf(this);
  ...
  private int a(Bundle paramBundle, String paramString, ApkUpdateDetail paramApkUpdateDetail)
  {
    ...
    bisy.b("DownloadResolver", "[doDownloadActionBySDK] pParmas =" + paramBundle);
    String str1 = paramBundle.getString(bivp.j);
    if (TextUtils.isEmpty(str1))
    {
      bisy.e("DownloadResolver", "[doDownloadActionBySDK] url is empty");
      return -1;
    }
    String str13 = paramBundle.getString(bivp.f);
    int i = paramBundle.getInt(bivp.k);
    String str14 = paramBundle.getString(bivp.i);
    String str15 = paramBundle.getString(bivp.l);
    String str12 = paramBundle.getString(bivp.D);
    int j = paramBundle.getInt(bivp.H);
    String str11 = paramBundle.getString(bivp.I);
    ...
    boolean bool4 = paramBundle.getBoolean(bivp.jdField_h_of_type_JavaLangString, true);
    boolean bool5 = paramBundle.getBoolean(bivp.x);
    int k = paramBundle.getInt(bivp.C, 0);
    boolean bool6 = paramBundle.getBoolean(bivp.J, false);
    ...
    String str4 = paramBundle.getString(bivp.K, "");
    ...
    for (;;)
    {
      ...
      try
      {
        ((DownloadInfo)localObject1).jdField_b_of_type_Int = paramBundle.getInt(bivp.jdField_e_of_type_JavaLangString);
        ((DownloadInfo)localObject1).jdField_d_of_type_Long = paramBundle.getLong(bivp.G);
        label506:
        ...
        bisy.b("DownloadResolver", "[doDownloadActionBySDK] action == Downloader.ACTION_DOWNLOAD");
        bisa.a().b((DownloadInfo)localObject1);
        continue;
        ...
        ((DownloadInfo)localObject1).a();
        bisa.a().b((DownloadInfo)localObject1);
        bisy.c("DownloadResolver", "[doDownloadActionBySDK] action == Downloader.ACTION_UPDATE " + bool1);
        continue;
        return bisa.a().a(str1);
        localObject1 = localObject2;
        if (!bool2) {
          continue;
        }
        biuh.a("305", str14, str16, str11);
        paramString = bisa.a().b(str1);
        ...
        if (paramString == null)
        {
          ...
          ((DownloadInfo)localObject1).j = paramBundle.getString(bivp.jdField_c_of_type_JavaLangString);
          ((DownloadInfo)localObject1).jdField_b_of_type_Int = paramBundle.getInt(bivp.jdField_e_of_type_JavaLangString);
          ((DownloadInfo)localObject1).jdField_c_of_type_Boolean = paramBundle.getBoolean(bivp.y, true);
          ((DownloadInfo)localObject1).jdField_h_of_type_Int = k;
          ((DownloadInfo)localObject1).n = str12;
          ((DownloadInfo)localObject1).jdField_d_of_type_Int = 0;
          ((DownloadInfo)localObject1).o = str11;
        ...
        ((DownloadInfo)localObject1).jdField_e_of_type_Boolean = bool3;
        ((DownloadInfo)localObject1).a("big_brother_ref_source_key", str10);
        bisa.a().a((DownloadInfo)localObject1);
        continue;
        bisa.a().a(str1, true);
        localObject1 = localObject2;
      }
  ...
  public static bise a()
  {
    if (jdField_a_of_type_Bise == null) {}
    try
    {
      if (jdField_a_of_type_Bise == null) {
        jdField_a_of_type_Bise = new bise();
      }
      return jdField_a_of_type_Bise;
    }
    finally {}
  }
  ...
  {
    bivl.a(paramActivity, paramBundle);
  }
  ...
  public static boolean a(Bundle paramBundle)
  {
    ...
    {
      String str2 = paramBundle.getString(bivp.j);
      if (TextUtils.isEmpty(str2))
      {
        bisy.e("DownloadResolver", "[installApp] url is empty");
        return false;
      }
      String str3 = paramBundle.getString(bivp.f);
      String str4 = paramBundle.getString(bivp.i);
      ...
      String str9 = paramBundle.getString(bivp.K, "");
      ...
      biuh.a("305", str4, str6, (String)localObject);
      localObject = bisa.a().b(str2);
      if (localObject == null)
      {
        ...
        ((DownloadInfo)localObject).j = paramBundle.getString(bivp.jdField_c_of_type_JavaLangString);
        ((DownloadInfo)localObject).k = paramBundle.getString(bivp.jdField_d_of_type_JavaLangString);
        ((DownloadInfo)localObject).jdField_b_of_type_Int = paramBundle.getInt(bivp.jdField_e_of_type_JavaLangString);
        ((DownloadInfo)localObject).o = paramBundle.getString(bivp.I);
  ...
  {
    bisy.b("DownloadResolver", "[doDownloadActionByMyApp] pParmas =" + paramBundle + " myAppConfig = " + paramInt);
    ...
    Object localObject1;
    if (paramBundle.getInt(bivp.jdField_e_of_type_JavaLangString, -10) < 0)
    {
      ??? = TMAssistantGetAppDetailTool.getInstance(this.jdField_a_of_type_ComTencentTmdatasourcesdkITMAssistantExchangeURLListenner, biip.a().a());
    ...
    do
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        try
        {
          ...
          {
            bisa.a().b(biip.a().a().getString(2131694117));
            return;
          }
        }
      ...
      paramBundle.putInt(bivp.jdField_e_of_type_JavaLangString, ((Integer)localObject1).intValue());
      ...
      if (paramInt == 1)
      {
        ...
        biwe.a().a(paramActivity, paramBundle, new bisg(this, paramBundle, paramString, paramApkUpdateDetail));
        return;
      }
    } while ((paramInt != 2) && (paramInt != 0));
    biwe.a().b(paramActivity, paramBundle, new bish(this, paramBundle, paramString, paramApkUpdateDetail));
  }
  ...
  public List<DownloadInfo> a()
  {
    ...
    {
      bisy.b("DownloadResolver", localObject1);
      if ((localObject2 != null) && (((Map)localObject2).size() != 0)) {
        break;
      }
      bisy.e("DownloadResolver", "infos is null!!");
    ...
    if (((Map)localObject2).size() > 0)
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((((DownloadInfo)localObject3).jdField_c_of_type_Int == 0) && (!TextUtils.isEmpty(((DownloadInfo)localObject3).jdField_e_of_type_JavaLangString)) && (((DownloadInfo)localObject3).jdField_c_of_type_Boolean))
        {
          ...
          localObject4 = bisa.a().a(((DownloadInfo)localObject3).jdField_d_of_type_JavaLangString);
          bisy.b("DownloadResolver", "\ninfo=" + ((DownloadInfo)localObject3).toString() + "\ntaskInfo:" + a((TMAssistantDownloadTaskInfo)localObject4));
        }
        for (;;)
        {
          ((List)localObject1).add(Long.valueOf(System.currentTimeMillis() - l2));
          break;
          bisy.e("DownloadResolver", "Info is not SDK && APK task!! \ninfo=" + ((DownloadInfo)localObject3).toString());
        }
      }
    }
    else
    {
      bisy.e("DownloadResolver", "infos is empty!!");
    }
    localObject2 = new Long[((List)localObject1).size()];
    ((List)localObject1).toArray((Object[])localObject2);
    bisy.e("DownloadResolver", "Total time Cost:" + (System.currentTimeMillis() - l1) + ";Every loop time cost:" + Arrays.toString((Object[])localObject2));
    return localArrayList;
  }
  ...
  public void a(List<DownloadInfo> paramList, bivy parambivy)
  {
    if (paramList == null)
    {
      bisy.b("DownloadResolver", "[queryByDownloadManagerV2] infos == null");
      return;
    }
    if (parambivy == null) {
      bisy.b("DownloadResolver", "[queryByDownloadManagerV2] listener == null");
    }
    ThreadManager.getSubThreadHandler().post(new DownloadProxy.2(this, paramList, parambivy));
  }
