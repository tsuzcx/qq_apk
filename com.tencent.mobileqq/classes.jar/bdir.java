  ...
  implements aljq
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int i = aytq.a;
        aytq.a = i + 1;
        paramString = ayvw.a(paramQQAppInterface, str, paramString, str, paramInt, i, paramAbsStructMsg);
        aeyf.a().a(paramString.uniseq, 0L, paramAbsStructMsg.forwardID);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, AbsStructMsg paramAbsStructMsg, alkr paramalkr)
  {
    if (paramAbsStructMsg != null) {
      azlr.a(paramAbsStructMsg);
    }
    ThreadManager.post(new ShareMsgHelper.1(paramQQAppInterface, paramString, paramInt, paramAbsStructMsg, paramalkr), 8, null, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, AbsStructMsg paramAbsStructMsg, alkr paramalkr, String paramString2, String paramString3)
  {
    switch (paramInt)
    {
    default: 
    ...
    for (paramalkr = str;; paramalkr = paramString1)
    {
      paramAbsStructMsg = ayvw.a(paramQQAppInterface, str, paramString1, paramalkr, paramInt, l, paramAbsStructMsg);
      QLog.i(baca.i, 1, "sendDocsStructingMsg. disUin = " + paramString1 + ", disUinType = " + paramInt + ", seq = " + l + ", shmsgseq = " + paramAbsStructMsg.shmsgseq + ", time = " + paramAbsStructMsg.time);
      paramQQAppInterface.a().a(paramAbsStructMsg, null);
      if ((paramInt != 0) && (paramInt != 1)) {
        break;
      }
      badt.a(paramQQAppInterface, paramString1, paramInt, paramAbsStructMsg.shmsgseq, paramAbsStructMsg.time + 1L, paramString2, paramString3);
      return;
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, AbsStructMsg paramAbsStructMsg, alkr paramalkr)
  {
    if (paramAbsStructMsg != null) {
      azlr.a(paramAbsStructMsg);
    }
    ThreadManager.getSubThreadHandler().post(new ShareMsgHelper.2(paramQQAppInterface, paramString1, paramString2, paramInt, paramAbsStructMsg, paramalkr));
  }
  ...
  public static boolean a(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, String paramString15, String paramString16, String paramString17, String paramString18, Intent paramIntent, int paramInt3, String paramString19, long paramLong)
  {
    ...
    if ((paramContext instanceof bebt))
    {
      paramString2 = ((bebt)paramContext).b();
    ...
    paramString1 = azqu.a(localIntent.getExtras());
    if (paramString1 != null)
    {
      ...
      {
        return true;
        if (((1001 == paramInt1) || (38 == paramInt1)) && ((paramContext instanceof bebt)))
        {
          paramString1 = ((bebt)paramContext).b();
          if (paramString1 != null)
          {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, AbsStructMsg paramAbsStructMsg, alkr paramalkr)
  {
    switch (paramInt)
    {
    }
    do
    {
      ...
      {
        return;
        paramalkr = paramQQAppInterface.getCurrentAccountUin();
        i = aytq.a;
        aytq.a = i + 1;
        long l = i;
        ...
        if (paramAbsStructMsg.mMsgServiceID == 80)
        {
          if (TextUtils.isEmpty(paramString2)) {
            paramString2 = paramalkr;
          }
          for (;;)
          {
            paramString2 = ayvw.a(paramQQAppInterface, paramalkr, paramString1, paramString2, paramInt, l, paramAbsStructMsg);
            if (paramAbsStructMsg.mMsgServiceID != 41) {
              break;
            }
            aeyf.a().a(paramString2.uniseq, paramAbsStructMsg.parentUniseq, i);
        ...
        if (paramAbsStructMsg.mMsgServiceID == 100)
        {
          ...
          paramString1 = ayvw.a(paramQQAppInterface, paramalkr, paramString1, paramalkr, paramInt, l, paramAbsStructMsg);
          aeyf.a().a(paramString1.uniseq, paramAbsStructMsg.parentUniseq, i);
          paramQQAppInterface.a().a(paramString1, new bdis());
          return;
        }
        aeyf.a().a(paramString2.uniseq, paramAbsStructMsg.parentUniseq, i);
      ...
      if (paramAbsStructMsg.mMsgServiceID == 1)
      {
        ...
        i = aytq.a;
        aytq.a = i + 1;
        paramString1 = ayvw.a(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, i, paramAbsStructMsg);
