...
public class ayrz
{
  ...
  public static aysa a(String paramString)
  {
    int i = 1;
    aysa localaysa = new aysa();
    if (TextUtils.isEmpty(paramString)) {
      return localaysa;
    }
    for (;;)
      ...
      try
      {
        ...
        if (j == -1)
        {
          ...
          if (-1 == m)
          {
            ...
            localaysa.jdField_a_of_type_Int = Integer.valueOf(str1).intValue();
            if (i == 0) {
              break;
            }
            localaysa.b = 1;
          ...
          str1 = str1 + ":" + str2;
          continue;
          localaysa.jdField_a_of_type_JavaLangString = str2;
          localaysa.jdField_a_of_type_Int = 0;
          continue;
        }
        j += 3;
      }
  ...
  public static azih a(long paramLong)
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
      return null;
    }
    return azih.a(localQQAppInterface, paramLong);
  }
