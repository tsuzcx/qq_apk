...
{
  public ayrz(OCRResultActivity paramOCRResultActivity, EditText paramEditText) {}
  ...
  public boolean onActionItemClicked(ActionMode paramActionMode, MenuItem paramMenuItem)
  {
    if (paramMenuItem.getItemId() == 2131372172)
    {
      ...
      if (TextUtils.isEmpty(paramActionMode)) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqOcrOCRResultActivity, 1, anvx.a(2131707272), 0).a();
      }
    }
    else
    {
