...
public class bocp
{
  private bock jdField_a_of_type_Bock;
  private bocs jdField_a_of_type_Bocs;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bock != null) {
      this.jdField_a_of_type_Bock.setOnDismissListener(new bocr(this));
    }
  }
  ...
  public void a(Context paramContext, TextEditorData paramTextEditorData, TAVCutSession paramTAVCutSession)
  {
    ...
    while ((this.jdField_a_of_type_Bock != null) && (this.jdField_a_of_type_Bock.isShowing())) {
      return;
    }
    this.jdField_a_of_type_Bock = new bock(paramContext, 2131755011, new bocq(this, paramTextEditorData, paramTAVCutSession));
    b();
    paramContext = a(paramTextEditorData);
    this.jdField_a_of_type_Bock.a(paramContext);
    this.jdField_a_of_type_Bock.show();
  }
  
  public void a(bocs parambocs)
  {
    this.jdField_a_of_type_Bocs = parambocs;
  }
