  ...
  implements View.OnClickListener, View.OnFocusChangeListener
{
  ...
  public nqx(VafContext paramVafContext)
  {
  ...
  private void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getSystemService("layout_inflater")).inflate(2131494220, null);
      this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131300169));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312532));
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a != null)
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.b)) {
        this.jdField_a_of_type_AndroidWidgetEditText.setHint(nph.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.b, 32));
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.c)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(nph.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.c, 8));
      }
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (boolean bool = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.jdField_a_of_type_JavaUtilRegexPattern.matcher(str).matches();; bool = true)
    {
      if (bool)
      {
        bbmy.a(paramView.getContext(), -1, ajjy.a(2131647115), 0).b(((BaseActivity)paramView.getContext()).getTitleBarHeight());
      ...
      str = ajjy.a(2131647141);
      bbmy.a(paramView.getContext(), 1, str, 0).b(((BaseActivity)paramView.getContext()).getTitleBarHeight());
      return;
    }
  }
  ...
  public void onFocusChange(View paramView, boolean paramBoolean)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      ...
      nph.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData, 39);
    }
  }
