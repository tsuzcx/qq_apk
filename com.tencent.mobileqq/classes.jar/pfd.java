...
public class pfd
{
  ...
  public static boolean a(Container paramContainer, pxk parampxk)
  {
    int i = 0;
    ...
    do
    {
      do
      {
        ...
        j = parampxk.h();
        parampxk = ((snh)localObject).b(j);
        localObject = ((snh)localObject).b(j + 1);
      } while ((parampxk == null) || (localObject == null));
      j = a(parampxk.mProteusTemplateBean);
    } while (j == -1);
    ...
    parampxk = paramContainer.getVirtualView();
    switch (j)
    {
    }
    for (;;)
    {
      localObject = parampxk.getComLayoutParams();
      ...
      case 2: 
        ...
        continue;
        localObject = parampxk.findViewBaseByName("id_separator_special_bottom_space");
        switch (k)
        {
        default: 
