...
public class aazg
{
  public static final HashMap<String, aazg> a;
  ...
  public Object a;
  public String a;
  nlf jdField_a_of_type_Nlf = new nlf();
  ...
  public aazg(String paramString1, String paramString2)
  {
  ...
  public void a()
  {
    bhte localbhte = (bhte)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(107);
    try
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localbhte.notifyUI(3, true, Integer.valueOf(4));
        return;
      }
      ...
      if ((!nko.a(BaseApplicationImpl.getContext(), str, new aazh(this, l, localbhte, localBaseApplication))) && (QLog.isColorLevel()))
      {
  ...
  {
    if (this.jdField_a_of_type_Aazf != null)
    {
      this.jdField_a_of_type_Aazf = new aazf(paramBaseActivity, 0, this.jdField_a_of_type_Aazf);
      return;
    }
    this.jdField_a_of_type_Aazf = new aazf(paramBaseActivity, 0, this.e, this.jdField_a_of_type_JavaLangClassLoader);
  }
  ...
  public void a(JSONObject paramJSONObject, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = nku.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      ThreadManager.post(new ViewPluginLoader.5(this, paramJSONObject, paramQQAppInterface, new aazj(this, paramQQAppInterface, bool2, bool1)), 8, null, false);
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  public void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!new File(nku.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.jdField_b_of_type_JavaLangString).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
    ...
    nko.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new aazi(this, localQQAppInterface), false);
  }
  
  public void c()
  {
    this.jdField_a_of_type_Aazf = null;
  }
}
