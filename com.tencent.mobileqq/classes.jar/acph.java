  ...
  extends acps
{
  ...
  public ImageView a;
  private axcd jdField_a_of_type_Axcd = new acpi(this);
  ...
  public acph(Activity paramActivity)
  {
    super(paramActivity);
  ...
  public void a()
  {
    ...
    awqx.b(null, "dc00898", "", "", "0X8007777", "0X8007777", 0, 0, "", "", "", "");
  }
  ...
  public void a(acpy paramacpy)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_a_of_type_JavaLangString, localOptions);
        this.jdField_b_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_b_of_type_JavaLangString, localOptions);
        this.jdField_c_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_c_of_type_JavaLangString, localOptions);
        this.jdField_d_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_d_of_type_JavaLangString, localOptions);
        this.jdField_e_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_e_of_type_JavaLangString, localOptions);
        this.jdField_f_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_f_of_type_JavaLangString, localOptions);
        this.jdField_g_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_g_of_type_JavaLangString, localOptions);
        this.jdField_h_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_h_of_type_JavaLangString, localOptions);
        this.jdField_i_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_i_of_type_JavaLangString, localOptions);
        this.jdField_j_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_j_of_type_JavaLangString, localOptions);
        this.jdField_k_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_k_of_type_JavaLangString, localOptions);
        this.jdField_l_of_type_AndroidGraphicsBitmap = bacm.a(str + this.jdField_l_of_type_JavaLangString, localOptions);
        if ((this.jdField_a_of_type_AndroidGraphicsBitmap != null) && (this.jdField_b_of_type_AndroidGraphicsBitmap != null) && (this.jdField_d_of_type_AndroidGraphicsBitmap != null) && (this.jdField_i_of_type_AndroidGraphicsBitmap != null) && (this.jdField_j_of_type_AndroidGraphicsBitmap != null) && (this.jdField_k_of_type_AndroidGraphicsBitmap != null))
        {
          ...
          super.a(paramacpy);
          paramacpy.a(this.jdField_a_of_type_Boolean);
          return;
        }
        if (!QLog.isColorLevel()) {
          continue;
