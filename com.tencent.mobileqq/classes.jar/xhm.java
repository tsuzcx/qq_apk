  ...
  extends xhf
{
  ...
  xhb jdField_a_of_type_Xhb;
  xhl jdField_a_of_type_Xhl = null;
  ...
  static VideoFilterBase b(VideoMaterial paramVideoMaterial)
  {
    ...
    if (localDoodleItem != null) {
      localxhk = new xhk(localDoodleItem, paramVideoMaterial.getDataPath());
    }
    return localxhk;
  }
  ...
  {
    return new xhj(paramVideoMaterial.getDoodleItem(), paramVideoMaterial.getDataPath());
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Xhl.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(localPointF);
    this.jdField_a_of_type_Xhl.jdField_d_of_type_Boolean = paramBoolean;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_c_of_type_Boolean) && ((this.jdField_a_of_type_Xhb instanceof xhd)))
    {
      ((xhd)this.jdField_a_of_type_Xhb).h();
      a(true);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, xhl paramxhl)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(paramxhl.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 1.0D, localFrame);
    GlUtil.setBlendMode(false);
    paramxhl.jdField_a_of_type_Boolean = true;
  }
  
  public void a(Frame paramFrame, int paramInt1, int paramInt2, xhl paramxhl)
  {
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) || (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() < 1)) {
      return;
    }
    ...
    boolean bool = paramxhl.jdField_d_of_type_Boolean;
    localArrayList.addAll(paramxhl.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    Object localObject = (VideoFilterBase)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramxhl.jdField_a_of_type_JavaLangString);
    if ((localObject instanceof xhk))
    {
      localObject = (xhk)localObject;
      ((xhk)localObject).a(localArrayList);
      ((xhk)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
      if (bool)
      {
        ...
        GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        ((xhk)localObject).a(paramxhl.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
        ((xhk)localObject).renderTexture(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), paramInt1, paramInt2);
        paramxhl.b();
      }
    }
    for (;;)
    {
      GlUtil.setBlendMode(false);
      if ((!paramxhl.jdField_d_of_type_Boolean) || (!paramxhl.jdField_c_of_type_Boolean)) {
        break;
      }
      paramFrame = paramxhl.a(paramInt1, paramInt2);
      a(paramFrame.getFBO(), paramFrame.getTextureId(), paramInt1, paramInt2);
      return;
      if ((localObject instanceof xhi))
      {
        localObject = (xhi)localObject;
        ((xhi)localObject).a();
        ((xhi)localObject).a(localArrayList, bool, paramxhl);
        GLES20.glViewport(0, 0, paramInt1, paramInt2);
        GLES20.glBindFramebuffer(36160, paramFrame.getFBO());
        ((xhi)localObject).renderTexture(paramFrame.getTextureId(), paramInt1, paramInt2);
        if (bool)
        {
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          GLES20.glBindFramebuffer(36160, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getFBO());
          GLES20.glViewport(0, 0, paramInt1, paramInt2);
          ((xhi)localObject).a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId());
          paramxhl.b();
        }
      }
      else if ((localObject instanceof xhj))
      {
        localObject = (xhj)localObject;
        ((xhj)localObject).a(localArrayList);
        xhn.a(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2, true);
        ((xhj)localObject).a();
        xhn.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, paramFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
        if (bool)
        {
          ((xhj)localObject).a(paramxhl.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
          this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame.bindFrame(this.jdField_c_of_type_ArrayOfInt[0], paramInt1, paramInt2, 1.0D);
          xhn.a(this.jdField_a_of_type_ComTencentFilterBaseFilter, this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_d_of_type_ArrayOfInt[0], paramInt1, paramInt2);
          paramxhl.b();
        }
      }
    }
  ...
  public void a(VideoMaterial paramVideoMaterial)
  {
    if (paramVideoMaterial != null)
    {
      ...
      if (this.jdField_a_of_type_Xhb != null) {
        this.jdField_a_of_type_Xhb.a(paramVideoMaterial);
      }
      return;
    }
  ...
  public void a(xhl paramxhl)
  {
    if ((paramxhl.jdField_d_of_type_Boolean) && (paramxhl.jdField_a_of_type_Boolean)) {}
    do
    {
      do
      {
      ...
      if ((!paramxhl.jdField_a_of_type_Boolean) && (paramxhl.jdField_b_of_type_Boolean))
      {
        if (paramxhl.jdField_c_of_type_Boolean) {
          a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramxhl);
        }
        this.jdField_f_of_type_Boolean = true;
        return;
      }
    } while (paramxhl.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() <= 1);
    a(this.jdField_d_of_type_ComTencentAekitOpenrenderInternalFrame, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramxhl);
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((this.jdField_f_of_type_Int + 1 <= 50) || (this.jdField_a_of_type_Xhl == null) || (!this.jdField_a_of_type_Xhl.jdField_d_of_type_Boolean)) {
        break;
      }
    } while (paramMotionEvent.getAction() != 0);
    QQStoryContext.a();
    QQToast.a(QQStoryContext.a().getApp(), alud.a(2131708361), 0).a();
    return true;
    ...
    for (;;)
    {
      ...
      if (paramMotionEvent.getAction() == 0)
      {
        ...
        {
          this.jdField_a_of_type_Xhl = new xhl(102, this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial.getId());
          this.jdField_f_of_type_Int += 1;
          this.jdField_a_of_type_Xhl.jdField_c_of_type_Boolean = true;
          if (this.jdField_a_of_type_Xhb != null) {
            this.jdField_a_of_type_Xhb.a(this.jdField_a_of_type_Xhl);
          }
          a(f1, f2, false);
          this.jdField_e_of_type_Int = 0;
        }
      }
      else if (((paramMotionEvent.getAction() == 1) || (paramMotionEvent.getAction() == 3)) && (this.jdField_a_of_type_Xhl != null)) {
        a(f1, f2, true);
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Xhb != null)
      {
        this.jdField_a_of_type_Xhb.a(localBitmap);
        return;
      }
    }
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_Xhb != null) && ((this.jdField_a_of_type_Xhb instanceof xhd))) {
      ((xhd)this.jdField_a_of_type_Xhb).f();
    }
    Object localObject4;
    Object localObject5;
    Bitmap localBitmap1;
    ...
    try
    {
      ...
      if (localBitmap2 != null)
      {
        localObject3 = localObject4;
        localObject2 = localObject5;
        localBitmap1 = xqw.a(localBitmap2, 1.0F * this.jdField_g_of_type_Int / this.jdField_c_of_type_Int, true);
      }
      localObject3 = localBitmap1;
      localObject2 = localBitmap1;
      this.jdField_d_of_type_Boolean = false;
      if (this.jdField_a_of_type_Xhb != null) {
        this.jdField_a_of_type_Xhb.a(localBitmap1);
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Xhb != null) {
          this.jdField_a_of_type_Xhb.a((Bitmap)localObject3);
        }
      }
    }
    finally
    {
      ...
      this.jdField_a_of_type_Xhb.a((Bitmap)localObject2);
    }
