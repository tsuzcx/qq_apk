  ...
  public static void a(AppRuntime paramAppRuntime)
  {
    ...
    for (;;)
    {
      ...
      if (i < paramAppRuntime.length())
      {
        ...
        localObject1 = new awoh();
        ((awoh)localObject1).jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
        ((awoh)localObject1).b = ((JSONObject)localObject2).optString("subtitle");
        ((awoh)localObject1).c = ((JSONObject)localObject2).optString("bannerLink");
        ((awoh)localObject1).d = ((JSONObject)localObject2).optString("reportName");
        ((awoh)localObject1).jdField_a_of_type_JavaUtilVector = new Vector();
      ...
      for (;;)
      {
        if (j < ((JSONArray)localObject2).length())
        {
          ...
          ((awoh)localObject1).jdField_a_of_type_JavaUtilVector.add(str);
          break label442;
