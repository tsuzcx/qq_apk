...
public class baig
{
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt(paramString + "_" + "subscript_recommend_config_version" + "_" + "8.2.6.4370", 0);
  }
  ...
  {
    PreferenceManager.getDefaultSharedPreferences(paramContext).edit().putBoolean(paramString + "readinjoy_takevideo_guide", true).commit();
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt("readinjoy_crop_and_group_version_4370_" + paramString, 0);
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt("readinjoy_remote_reset_config_version_4370_" + paramString, 0);
  }
  ...
  public static Object a(Context paramContext, String paramString1, String paramString2, String paramString3, Object paramObject)
  {
    ...
    try
    {
      ...
      {
        float f = paramContext.getFloat(paramString1, ((Float)paramObject).floatValue());
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getLong(paramString1 + "_" + "spring_festival_hb_offline_donwload_ts" + "_" + paramString2, 0L);
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).getString("identification_download_path_2", "");
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putLong(paramString1 + "_" + "spring_festival_hb_offline_donwload_ts" + "_" + paramString2, paramLong);
    paramContext.apply();
  }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    return !TextUtils.equals(PreferenceManager.getDefaultSharedPreferences(paramContext).getString(paramString, ""), "8.2.6");
  }
  ...
  public static int c(Context paramContext, int paramInt)
  {
    try
    {
      ...
      if (awoa.jdField_d_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Perf", 2, "disable preload mini processes，value =" + i);
        }
        awoa.jdField_d_of_type_Long = System.currentTimeMillis();
        return 0;
      }
      return i;
    }
  ...
  {
    SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getContext()).edit();
    localEditor.putString("identification_download_path_2", paramString);
    localEditor.commit();
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt(paramString1 + "_" + "spring_festival_hb_offline_donwload_cnt" + "_" + paramString2, 0);
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putString("config_app_version_" + paramString, "8.2.6");
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt(paramString1 + "_" + "spring_festival_hb_offline_donwload_cnt" + "_" + paramString2, paramInt);
    paramContext.apply();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt(paramString + "_" + "subscript_recommend_config_version" + "_" + "8.2.6.4370", paramInt);
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt("readinjoy_crop_and_group_version_4370_" + paramString, paramInt);
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt("readinjoy_remote_reset_config_version_4370_" + paramString, paramInt);
    paramContext.commit();
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getBoolean(paramString + "readinjoy_takevideo_guide", false);
  }
