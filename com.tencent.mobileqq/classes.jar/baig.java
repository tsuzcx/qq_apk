  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  static
  {
    jdField_c_of_type_JavaLangString = alpo.a(2131711523);
    jdField_b_of_type_ArrayOfJavaLangObject = new Object[0];
    jdField_a_of_type_AndroidTextSpannable$Factory = new baih();
    try
    {
  ...
  public baig(CharSequence paramCharSequence, int paramInt)
  {
    this(paramCharSequence, paramInt, 32);
  }
  
  public baig(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  }
  
  public baig(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3) {}
  
  protected baig(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    for (paramInt4 = 1;; paramInt4 = 0)
    {
      ...
      if (paramInt4 != 0)
      {
        localObject2 = (bain[])getSpans(paramInt1, paramInt2, bain.class);
        if (localObject2 != null)
        {
          ...
          if (paramInt4 < paramInt5)
          {
            ...
            if (((bain)localObject3).jdField_c_of_type_Int == 1) {
              ((bain)localObject3).jdField_a_of_type_Int &= 0x7FFFFFFF;
            }
            for (;;)
            {
              paramInt4 += 1;
              break;
              if (((bain)localObject3).jdField_c_of_type_Int == 2) {
                ((baip)localObject3).jdField_b_of_type_Boolean = false;
              }
            }
          }
        }
      ...
      if (((paramInt3 & 0x8) == 8) && (this.e != null)) {
        if ((jdField_a_of_type_JavaLangString.length() > 3) && (jdField_a_of_type_JavaLangString.charAt(jdField_a_of_type_JavaLangString.length() - 3) == '0') && (jdField_a_of_type_JavaLangString.charAt(jdField_a_of_type_JavaLangString.length() - 2) == '1'))
        {
          ...
          localObject3 = azmz.a(BaseApplication.getContext());
      ...
      {
        ((azmz)localObject3).a(null, "qq_url_length_report", bool, 0L, 0L, (HashMap)localObject2, null);
        if (this.e.length() < 1000) {
          a();
        }
      ...
      azmz.a(BaseApplication.getContext()).a(null, "qqTextData", false, 0L, 0L, (HashMap)localObject2, null);
      return;
    }
  }
  
  public baig(CharSequence paramCharSequence, int paramInt1, int paramInt2, MessageRecord paramMessageRecord)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  ...
  private int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, StringBuilder paramStringBuilder)
  {
    ...
    if (k < paramInt2)
    {
      ...
      if ((paramInt3 & 0x4) == 4)
      {
        ...
        a(new bain(i, paramInt4, 1), k, k + 2, 33);
        i = k + 1;
        k = j + 1;
        paramInt1 += 1;
        j = i;
    ...
    for (;;)
    {
      ...
      if ((m >= 255) && (k + 4 < i5))
      {
        ...
        {
          bool2 = true;
          a(new baip(arrayOfChar, paramInt4, bool1, bool2), k, k + 5, 33);
          i = 2;
          if (i >= 5) {
            break label504;
          }
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    localbhpy.a(String.format(paramContext.getString(2131694909), new Object[] { paramString }));
    localbhpy.a(2131691370, 1);
    localbhpy.a(2131689693, 1);
    localbhpy.c(2131690648);
    localbhpy.a(new baim(bhoq.a(new bail(paramContext, paramString, localbhpy)).a(1000L)));
    localbhpy.show();
  }
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt == 0)
    {
      localbhpy.a(String.format(paramContext.getString(2131694908), new Object[] { paramString1 }));
      localbhpy.a(2131691699, 1);
      localbhpy.a(2131691360, 1);
      localbhpy.a(2131689686, 1);
      localbhpy.a(2131689648, 1);
      localbhpy.a(2131693811, 1);
    }
    for (;;)
    {
      localbhpy.c(2131690648);
      localbhpy.a(new baii(paramInt, paramString1, paramContext, paramString2, localbhpy));
      localbhpy.show();
      return;
      if (paramInt == 1)
      {
        localbhpy.a(String.format(paramContext.getString(2131694909), new Object[] { paramString1 }));
        localbhpy.a(2131691699, 1);
        localbhpy.a(2131691360, 1);
        localbhpy.a(2131689686, 1);
      }
      ...
      {
        localbhpy.a(String.format(paramContext.getString(2131694184), new Object[] { paramString1 }));
        localbhpy.a(2131719752, 1);
        localbhpy.a(2131691360, 1);
      }
      else if (paramInt == 3)
      {
  ...
  private static void c(String paramString1, String paramString2)
  {
    try
    {
      azmj.b((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(jdField_a_of_type_JavaLangString), "dc00898", "", "", paramString1, paramString2, 0, 0, "", "", "", "");
      return;
    }
  ...
  private static void d(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      {
        azmj.b(localQQAppInterface1, "P_CliOper", "Grp_join", "", "send", "Clk_url", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString2, "");
        return;
      }
    }
    catch (ClassCastException localClassCastException)
    {
      ...
      azmj.b(localQQAppInterface2, "P_CliOper", "Grp_join", "", "send", "Clk_item", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString1, "");
      return;
    }
    catch (AccountNotMatchException paramString1) {}
  }
  ...
  public baig a(String paramString, boolean paramBoolean, int... paramVarArgs)
  {
    baig localbaig = new baig("", 0);
    localbaig.jdField_d_of_type_Int = this.jdField_d_of_type_Int;
    localbaig.jdField_c_of_type_Int = this.jdField_c_of_type_Int;
    localbaig.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    localbaig.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
    localbaig.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localbaig.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localbaig.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localbaig.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
    int i = 0;
    int j = 0;
    ...
    if (paramBoolean)
    {
      ...
      int k = 0;
      while (k < localbaig.jdField_a_of_type_ArrayOfJavaLangObject.length)
      {
      ...
      if (i != 0) {
        localbaig.a(0, paramString.length(), i, j, localStringBuilder);
      }
      localbaig.jdField_d_of_type_JavaLangString = (paramString + this.jdField_d_of_type_JavaLangString);
      localbaig.e = localStringBuilder.toString();
    ...
    {
      if (i != 0) {
        localbaig.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
      }
      return localbaig;
      localStringBuilder = new StringBuilder().append(paramString).append(this.e);
      if (i != 0) {
        localbaig.a(this.e.length(), this.e.length() + paramString.length(), i, j, localStringBuilder);
      }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (j < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject instanceof bain))
      {
        ...
        localObject = (bain)localObject;
        switch (((bain)localObject).jdField_c_of_type_Int)
        {
        default: 
          i = k;
        }
      ...
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          continue;
          localObject = apog.a(((bain)localObject).jdField_a_of_type_Int & 0x7FFFFFFF);
          localStringBuffer.replace(n + k, i1 + k, (String)localObject);
          i = k + (((String)localObject).length() - (i1 - n));
        }
      }
  ...
  protected void a()
  {
    Object localObject = baiu.a(this.e);
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      localObject = ((List)localObject).iterator();
      while (((Iterator)localObject).hasNext())
      {
        bahv localbahv = (bahv)((Iterator)localObject).next();
        a(new baio(this, localbahv.jdField_a_of_type_JavaLangString), localbahv.jdField_a_of_type_Int, localbahv.jdField_b_of_type_Int, 33);
      }
    }
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (paramInt == 2)
    {
      ...
      localObject3 = (aloz)((QQAppInterface)localObject1).getManager(51);
      if (paramInt != 0) {
        break label367;
      }
      if (bdee.a()) {
      ...
      localbhpy.a(String.format(paramContext.getString(2131694909), new Object[] { paramString }));
      localbhpy.a(2131691360, 1);
      localbhpy.a(2131692400, 1);
      localbhpy.a(2131691699, 1);
      localbhpy.a(2131689686, 1);
      azmj.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", ayee.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
    }
    for (;;)
    {
      localbhpy.c(2131690648);
      localbhpy.a(new baij(this, paramContext, paramString, (QQAppInterface)localObject1, i, paramMessageRecord, paramInt, localbhpy));
      localbhpy.a(new baik(this, (QQAppInterface)localObject1, i));
      localbhpy.show();
      return;
      i = 4;
      break;
      label328:
      if (this.jdField_a_of_type_Ayee == null) {
        this.jdField_a_of_type_Ayee = new ayee(this.f);
      }
      this.jdField_a_of_type_Ayee.a((QQAppInterface)localObject1, paramContext, paramString, (ChatMessage)paramMessageRecord);
      return;
      label367:
      if (paramInt == 1)
      {
        ...
        localbhpy.a(2131691699, 1);
        localbhpy.a(2131689686, 1);
        if ((!paramMessageRecord.isSend()) && (((aloz)localObject3).b(paramMessageRecord.senderuin)))
        {
          localObject3 = (alkv)((QQAppInterface)localObject1).a(2);
          if (localObject3 != null) {
            ((alkv)localObject3).a(jdField_a_of_type_JavaLangString, paramMessageRecord.senderuin, 1, 0L, (byte)1, 0L, 0L, null, "", 0L, 10004, null, (byte)0);
          }
          localbhpy.a(2131689696, 1);
        }
        azmj.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", ayee.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      }
      else if (paramInt == 2)
      {
        localbhpy.a(String.format(paramContext.getString(2131694184), new Object[] { paramString }));
        localbhpy.a(2131691360, 1);
        localbhpy.a(2131692400, 1);
        localbhpy.a(2131719752, 1);
        azmj.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A924", "0X800A924", ayee.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      }
      else if (paramInt == 3)
      {
        localbhpy.a(String.format(paramContext.getString(2131694909), new Object[] { paramString }));
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    try
    {
      ...
      if ((localObject1 instanceof QQAppInterface)) {
        aeyb.a(paramView.getContext(), (QQAppInterface)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, 5, paramString);
      }
      localObject2 = null;
      ...
      if (badt.a((String)localObject1))
      {
        ...
        if (bdee.d(BaseApplication.getContext()))
        {
          ...
          azmj.b(null, "CliOper", "", "", "0X80061B1", "0X80061B1", 0, 0, "", "", "", "");
          return;
        }
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        continue;
        QQToast.a((Context)localObject2, ((Context)localObject2).getResources().getString(2131692397), 0).b(((Context)localObject2).getResources().getDimensionPixelSize(2131298914));
        continue;
        aufv.a(paramView.getContext(), localThrowable, true, true, true, false, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.f);
      }
    }
    for (;;)
    {
      try
      {
        ...
        if (paramView.istroop == 1)
        {
          ...
          azmj.b(null, "CliOper", "", str1, "0X80061B1", "0X80061B1", i, 0, "", "", paramView, paramString);
  ...
  {
    baig localbaig = (baig)super.clone();
    localbaig.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localbaig.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localbaig.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localbaig.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
  ...
  {
    if ((paramObject instanceof baig)) {
      return this.jdField_d_of_type_JavaLangString.equals(((baig)paramObject).jdField_d_of_type_JavaLangString);
    }
    return false;
  }
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    label73:
    return new baig(this.e, paramInt1, paramInt2, this.jdField_a_of_type_Int, this.jdField_d_of_type_Int, this.jdField_c_of_type_Int);
  }
