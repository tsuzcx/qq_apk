  ...
  extends BusinessHandler
{
  ...
  public long a;
  private badf jdField_a_of_type_Badf = new badf(paramAppInterface, this.jdField_a_of_type_Baif);
  private baif jdField_a_of_type_Baif = new baif();
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Baif.b())
        {
          this.jdField_a_of_type_Baif.a(2);
          paramArrayOfByte1 = (badg)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Badf.a(paramArrayOfByte2);
          this.jdField_a_of_type_Badf.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Baif.a(0);
  ...
  {
    Object localObject = lfq.a(paramArrayOfByte);
    paramArrayOfByte = ((lfr)localObject).a;
    localObject = ((lfr)localObject).b;
    AudioTransClientTransInfo.IntHead localIntHead = new AudioTransClientTransInfo.IntHead();
    for (;;)
    {
      try
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Baif.c();
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Badf.a(paramLong);
      return;
    }
  ...
  public void a(String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            paramString1 = lfq.a(paramString1.toByteArray(), paramString2.toByteArray());
            this.jdField_a_of_type_Long = System.currentTimeMillis();
            localToServiceMsg.putWupBuffer(paramString1);
            if (!this.jdField_a_of_type_Baif.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Baif.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Baif.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Badf.a())
            {
              sendPbReq(localToServiceMsg);
              this.jdField_a_of_type_Baif.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            localToServiceMsg.putWupBuffer(lfq.a(paramString1.toByteArray(), paramString2.toByteArray()));
            if (this.jdField_a_of_type_Baif.a()) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Baif.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
      ...
      this.jdField_a_of_type_Baif.a(3);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramObject = lfq.a(paramFromServiceMsg.getWupBuffer());
