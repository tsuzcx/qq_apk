...
public class aybe
  implements bclf
{
  public aybe(RobotChatPanelLayout paramRobotChatPanelLayout, long paramLong, int paramInt, String paramString, bcnf parambcnf) {}
  ...
  public void a(int paramInt, cmd0x934.RspBody paramRspBody)
  {
    ...
    {
      this.jdField_a_of_type_Bcnf.a(bool1, this.jdField_a_of_type_JavaLangString);
      if (!QLog.isColorLevel()) {
        break;
      }
