  ...
  implements Manager
{
  ...
  bhhe jdField_a_of_type_Bhhe = new bhjy(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public bhjt(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bgmg.a(lbf.f(), new StringBuffer("config.json"), localInputStream);
      }
  ...
  public static VipFullScreenVideoView a(Activity paramActivity, RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    {
      return null;
      localView = LayoutInflater.from(BaseApplicationImpl.getApplication()).inflate(2131563061, null);
    ...
    return (VipFullScreenVideoView)localView.findViewById(2131380545);
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, String paramString)
  {
    ...
    paramString = lbf.f() + paramInt1 + File.separator;
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt, Bundle paramBundle, VipFunCallAndRing.TSourceInfo paramTSourceInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        localObject1 = new File(lbf.f() + paramInt + File.separator);
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    } while (bgmg.a(paramString2));
    String str = b(paramAppRuntime, paramInt2, 8, null);
    paramString2 = new Bundle();
    paramString1 = new bhhf(str, paramString1);
    ((bhhh)paramAppRuntime.getManager(47)).a(1).a(paramString1, null, paramString2);
  }
  
  public static boolean a()
  {
    return new File(bhjs.jdField_a_of_type_JavaLangString).exists();
  }
  
  public static boolean a(Context paramContext, VideoView paramVideoView, String paramString, int paramInt1, bhjz parambhjz, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramContext.exists()) && (!paramVideoView.isPlaying()))
    {
      ...
      if (paramInt1 == 6)
      {
        paramVideoView.setOnTouchListener(new bhju());
        paramVideoView.setVideoPath(paramContext.getAbsolutePath());
        paramVideoView.requestFocus();
        paramVideoView.setVisibility(0);
        paramVideoView.setOnPreparedListener(new bhjv(parambhjz));
        paramVideoView.setOnCompletionListener(new bhjw(paramVideoView));
        paramVideoView.setOnErrorListener(new bhjx(paramInt2, parambhjz, paramVideoView, paramBoolean));
        return true;
      }
      if (paramInt1 == 7)
      {
        paramContext = bggl.a(paramString);
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bhab.a("externalStorageType", paramString, i + "_t", l2 + "", bool + "", l2 + "", bool + "_p", "", "", "");
        return bool;
      }
      catch (Exception paramContext)
      {
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    for (int i = 0;; i = paramInt2)
    {
      ...
      if (bool)
      {
        ...
        localObject = new bhhf(str1, (File)localObject);
        ((bhhf)localObject).a(3);
        ((bhhf)localObject).jdField_a_of_type_Int = 0;
        ((bhhf)localObject).a(localBundle);
        this.jdField_a_of_type_Bhhe.onDone((bhhf)localObject);
        return;
        label519:
        bool = false;
        break label298;
      ...
      if (i == 0)
      {
        label530:
        localObject = new bhhf(str1, (File)localObject);
        ((bhhf)localObject).jdField_a_of_type_Byte = 1;
        ((bhhf)localObject).jdField_e_of_type_Long = 5242880L;
        ((bhhf)localObject).jdField_e_of_type_JavaLangString = jdField_a_of_type_JavaLangString;
      ...
      {
        ((bhhf)localObject).l = paramBoolean;
        if (7 != paramInt2) {
          ((bhhf)localObject).b = true;
        }
        this.jdField_a_of_type_Bhhh.a(1).a((bhhf)localObject, this.jdField_a_of_type_Bhhe, localBundle);
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, bhhl parambhhl)
  {
    ...
    if (paramInt2 != 0)
    {
      bgxe localbgxe = (bgxe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(45);
      localbgxe.jdField_a_of_type_Bhhl = parambhhl;
      localbgxe.a(paramInt2, 3, paramBoolean, paramInt3, "comering");
    }
    if (i == 6) {
