  ...
  extends ImageSpan
{
  ...
  public auom(Context paramContext, int paramInt1, String paramString, int paramInt2, Drawable.Callback paramCallback)
  {
  ...
  public auom(Context paramContext, int paramInt, String paramString, Drawable.Callback paramCallback)
  {
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_MqqUtilWeakReference != null)
          {
            ...
            this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new auon(this));
            if (QLog.isColorLevel())
            {
