...
class azom
  extends QIPCModule
{
  azom(azol paramazol, String paramString)
  {
    super(paramString);
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          if (azok.a.equals(paramString)) {
            return azol.a(this.a, paramBundle, paramInt);
          }
          if (azok.b.equals(paramString))
          {
            paramString = azol.a(this.a, paramBundle, paramInt);
            if (paramString.isSuccess())
            {
              ...
              if (azol.a(this.a).a().a((PrecoverResource)localObject, new Object[] { "PrecoverIPCServer_MODEL", Integer.valueOf(paramInt) })) {
              ...
              azol.a(this.a).callbackResult(paramInt, EIPCResult.createResult(-2, paramBundle));
            }
            return paramString;
          }
        } while (!azok.c.equals(paramString));
      ...
      paramString = azol.a(this.a).a().a((String)localObject);
