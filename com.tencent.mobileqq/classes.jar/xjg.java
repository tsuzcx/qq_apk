...
class xjg
  implements myz
{
  xjg(xjf paramxjf, long paramLong, bciq parambciq, Context paramContext) {}
  ...
  public void loaded(int paramInt, java.lang.String paramString)
  {
    ...
    //   33: aload_0
    //   34: getfield 17	xjg:jdField_a_of_type_Long	J
    //   37: lsub
    ...
    //   78: aload_0
    //   79: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   82: aload_0
    //   83: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   86: getfield 78	xjf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   89: invokestatic 83	mzb:a	(Ljava/lang/String;)Ljava/lang/String;
    //   92: putfield 86	xjf:d	Ljava/lang/String;
    //   95: new 39	java/lang/StringBuilder
    //   98: dup
    //   99: invokespecial 40	java/lang/StringBuilder:<init>	()V
    //   102: aload_0
    //   103: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   106: getfield 78	xjf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   109: invokestatic 89	mzh:a	(Ljava/lang/String;)Ljava/lang/String;
    //   112: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   115: aload_0
    //   116: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   119: getfield 78	xjf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   130: aload_0
    //   131: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   134: getfield 94	xjf:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   189: aload_0
    //   190: getfield 19	xjg:jdField_a_of_type_Bciq	Lbciq;
    //   193: iconst_3
    //   194: iconst_1
    //   195: iconst_1
    //   196: invokestatic 113	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   199: invokevirtual 119	bciq:notifyUI	(IZLjava/lang/Object;)V
    //   202: aload_0
    //   203: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   206: iconst_0
    //   207: putfield 122	xjf:jdField_b_of_type_Boolean	Z
    //   210: return
    //   211: new 96	java/io/File
    //   214: dup
    //   215: aload_0
    //   216: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   219: getfield 125	xjf:c	Ljava/lang/String;
    //   222: invokespecial 99	java/io/File:<init>	(Ljava/lang/String;)V
    //   225: astore_3
    //   226: aload_0
    //   227: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   230: getfield 128	xjf:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    ...
    //   245: aload_0
    //   246: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   249: getfield 94	xjf:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   265: aload_0
    //   266: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   269: getfield 86	xjf:d	Ljava/lang/String;
    ...
    //   289: invokestatic 151	bbdx:a	(Ljava/lang/String;)V
    //   292: aload_0
    //   293: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   296: getfield 128	xjf:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    ...
    //   316: aload_0
    //   317: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   320: getfield 94	xjf:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   329: aload_0
    //   330: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   333: getfield 78	xjf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   336: invokestatic 83	mzb:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   366: pop
    //   367: aload_0
    //   368: getfield 21	xjg:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   371: aload_0
    //   372: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   375: getfield 94	xjf:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   384: astore_3
    //   385: aload_0
    //   386: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   389: getfield 179	xjf:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   392: ifnonnull +32 -> 424
    //   395: aload_0
    //   396: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   399: new 181	dalvik/system/DexClassLoader
    //   402: dup
    //   403: aload_2
    //   404: aload_0
    //   405: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   408: getfield 125	xjf:c	Ljava/lang/String;
    //   411: aload_3
    ...
    //   421: putfield 179	xjf:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    ...
    //   449: aload_0
    //   450: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   453: getfield 94	xjf:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   463: aload_2
    //   464: aload_3
    //   465: invokestatic 206	bbdx:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   468: pop
    //   469: aload_0
    //   470: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   473: aload_3
    //   474: putfield 208	xjf:e	Ljava/lang/String;
    ...
    //   507: aload_0
    //   508: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   511: getfield 86	xjf:d	Ljava/lang/String;
    ...
    //   523: aload_0
    //   524: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   527: new 214	xje
    //   530: dup
    //   531: invokestatic 187	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   534: iconst_0
    //   535: aload_0
    //   536: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   539: getfield 208	xjf:e	Ljava/lang/String;
    //   542: aload_0
    //   543: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   546: getfield 179	xjf:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   549: invokespecial 217	xje:<init>	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/ClassLoader;)V
    //   552: putfield 220	xjf:jdField_a_of_type_Xje	Lxje;
    //   555: aload_0
    //   556: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   559: iconst_1
    //   560: putfield 222	xjf:jdField_a_of_type_Boolean	Z
    //   563: aload_0
    //   564: getfield 19	xjg:jdField_a_of_type_Bciq	Lbciq;
    //   567: iconst_3
    //   568: iconst_1
    //   569: iconst_0
    //   570: invokestatic 113	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   573: invokevirtual 119	bciq:notifyUI	(IZLjava/lang/Object;)V
    //   576: aload_0
    //   577: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   580: iconst_0
    //   581: putfield 122	xjf:jdField_b_of_type_Boolean	Z
    //   584: aload_0
    //   585: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   588: iconst_0
    //   589: putfield 122	xjf:jdField_b_of_type_Boolean	Z
    //   592: return
    //   593: aload_3
    ...
    //   636: aload_0
    //   637: getfield 19	xjg:jdField_a_of_type_Bciq	Lbciq;
    //   640: iconst_3
    //   641: iconst_1
    //   642: iconst_3
    //   643: invokestatic 113	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   646: invokevirtual 119	bciq:notifyUI	(IZLjava/lang/Object;)V
    //   649: aload_0
    //   650: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   653: iconst_0
    //   654: putfield 122	xjf:jdField_b_of_type_Boolean	Z
    //   657: return
    //   658: astore_2
    //   659: aload_0
    //   660: getfield 15	xjg:jdField_a_of_type_Xjf	Lxjf;
    //   663: iconst_0
    //   664: putfield 122	xjf:jdField_b_of_type_Boolean	Z
    //   667: aload_2
    //   668: athrow
