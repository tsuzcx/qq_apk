...
{
  public bhbc(AEVideoShelfEditFragment paramAEVideoShelfEditFragment, FaceImageViewer paramFaceImageViewer, NodeItem paramNodeItem) {}
  
  public void onGlobalLayout()
  {
    if (Build.VERSION.SDK_INT >= 16) {
      this.jdField_a_of_type_DovComQqImAECameraQudongFaceImageViewer.getViewTreeObserver().removeOnGlobalLayoutListener(this);
    }
    for (;;)
    {
      ViewGroup.MarginLayoutParams localMarginLayoutParams = (ViewGroup.MarginLayoutParams)this.jdField_a_of_type_DovComQqImAECameraQudongFaceImageViewer.getLayoutParams();
      ...
      this.jdField_a_of_type_DovComQqImAECameraQudongFaceImageViewer.setLayoutParams(localMarginLayoutParams);
      return;
      this.jdField_a_of_type_DovComQqImAECameraQudongFaceImageViewer.getViewTreeObserver().removeGlobalOnLayoutListener(this);
    }
  }
}
