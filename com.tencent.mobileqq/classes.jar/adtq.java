...
{
  public adtq(ForwardSdkBaseOption paramForwardSdkBaseOption) {}
    ...
    for (;;)
    {
      synchronized (ForwardSdkBaseOption.jdField_a_of_type_JavaLangObject)
      {
        ...
        if ((this.a.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null) && (this.a.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse.ret.get() != 0) && ((this.a instanceof ForwardSdkShareOption)))
        {
          ...
          localQQCustomDialog = DialogUtil.b(this.a.jdField_a_of_type_AndroidAppActivity, 230).setTitle(this.a.jdField_a_of_type_AndroidAppActivity.getString(2131435605));
          if (TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse.msg.get()))
          {
            paramBundle = this.a.jdField_a_of_type_AndroidAppActivity.getString(2131435606);
            localQQCustomDialog = localQQCustomDialog.setMessageWithUrl(paramBundle).setPositiveButton(2131430153, new adts(this));
            localStringBuilder = new StringBuilder().append(this.a.jdField_a_of_type_AndroidAppActivity.getString(2131433712));
            paramBundle = (Bundle)localObject1;
            if (TextUtils.isEmpty((CharSequence)localObject1)) {
              paramBundle = "";
            }
            paramBundle = localQQCustomDialog.setNegativeButton(paramBundle, new adtr(this));
