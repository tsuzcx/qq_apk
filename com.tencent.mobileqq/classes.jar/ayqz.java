...
public class ayqz
{
  ...
  public ayqz(int paramInt1, int paramInt2, Map<Integer, String> paramMap)
  {
  ...
  {
    boolean bool = false;
    if ((paramObject instanceof ayqz)) {
      bool = bftf.a(((ayqz)paramObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
    }
    return bool;
  }
}
