...
public class one
{
  public static int a()
  {
    SharedPreferences localSharedPreferences = a(onk.a());
  ...
  {
    int i = bbjn.N(BaseApplicationImpl.getApplication(), onk.a());
    int j = a();
  ...
  private static void a(SharedPreferences paramSharedPreferences)
  {
    ...
    {
      List localList = qee.a(paramSharedPreferences.getAll().keySet(), new onf());
  ...
  public static void d()
  {
    ...
    if (localObject != null)
    {
      ...
      if (((SharedPreferences.Editor)localObject).commit())
      {
        ...
        localObject = bhvh.a(onk.a(), false, true);
        if (localObject == null) {
          break label138;
        }
        localObject = ((SharedPreferences)localObject).edit();
  ...
  public static void e()
  {
    ...
    try
    {
      auko localauko = osj.a().a();
      if ((localauko instanceof ReadInJoyEntityManagerFactory)) {
        ((ReadInJoyEntityManagerFactory)localauko).a();
      }
      return;
    }
    catch (Exception localException)
  ...
  private static void g()
  {
    ...
    SettingCloneUtil.writeValue(BaseApplicationImpl.getApplication(), onk.a(), null, "qqsetting_kandian_download_pic_flag", false);
  ...
  private static void h()
  {
    ...
    Object localObject = new File(bdey.e());
    ...
    try
    {
      localObject = (pzb)onk.a().getManager(271);
      if (localObject != null)
      {
        ((pzb)localObject).a();
