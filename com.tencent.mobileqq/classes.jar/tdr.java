  ...
  implements bljd
{
  ...
  public tdr(BridgeModule paramBridgeModule)
  {
  ...
  private void b(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = blir.a((Context)localObject1);
        Object localObject2 = paramJSONObject.optString("title");
        if (!TextUtils.isEmpty((CharSequence)localObject2)) {
          ((blir)localObject1).a((CharSequence)localObject2);
        }
        ...
        if (localObject2 != null)
        {
          ...
          if (((JSONArray)localObject2).length() > 0)
          {
            ...
            ((blir)localObject1).c(((JSONArray)localObject2).getString(j));
            j += 1;
            continue;
          }
        }
        ...
        if (!TextUtils.isEmpty(paramJSONObject)) {
          ((blir)localObject1).d(paramJSONObject);
        }
        ((blir)localObject1).a(new tds(this, paramString));
        ((blir)localObject1).a(new tdt(this, paramString));
        ((blir)localObject1).setOnCancelListener(new tdu(this, paramString));
        ((blir)localObject1).a(this);
        this.jdField_a_of_type_Blir = ((blir)localObject1);
