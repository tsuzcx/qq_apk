...
public class nyj
{
  ...
  public static nxq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((localMessageForStructing.structingMsg != null) && ((localMessageForStructing.structingMsg instanceof AbsShareMsg)))
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            localObject3 = (bcgx)localObject3;
            j = i;
            if (((bcgx)localObject3).a != null)
            {
              j = i;
              if (((bcgx)localObject3).a.size() > 0)
              {
                localObject3 = ((bcgx)localObject3).a.iterator();
                for (;;)
                {
                  j = i;
                  ...
                  if ((localObject4 instanceof bcme))
                  {
                    ...
                    if ((!TextUtils.isEmpty(((bcme)localObject4).ac)) && (!TextUtils.isEmpty(((bcme)localObject4).ad)))
                    {
                      localObject4 = new nxr(i, ((bcme)localObject4).ac, ((bcme)localObject4).ad);
                      i += 1;
                      ((ArrayList)localObject1).add(localObject4);
                      localArrayList2.add(((nxr)localObject4).b);
                      localArrayList1.add(((nxr)localObject4).a);
                    }
                  }
                }
              }
        ...
        {
          localObject1 = new nxq(paramMessageRecord.senderuin, localMessageForStructing.structingMsg.mMsgUrl, (ArrayList)localObject1, localMessageForStructing.structingMsg.mCommonData);
          if (((nxq)localObject1).b())
          {
            ((nxq)localObject1).c = String.valueOf(localMessageForStructing.structingMsg.msgId);
            if (!paramBoolean)
            {
              ((nxq)localObject1).a = NetConnInfoCenter.getServerTimeMillis();
              paramMessageRecord.saveExtInfoToExtStr("recent_list_advertisement_message_push_time", String.valueOf(((nxq)localObject1).a));
            }
            for (;;)
            {
              if (QLog.isColorLevel()) {
                QLog.d("AD_Util", 2, "start preload msgid:" + ((nxq)localObject1).c);
              }
              ThreadManager.executeOnSubThread(new PublicAccountAdUtil.1(localArrayList1));
              if (paramQQAppInterface == null) {
                break;
              }
              paramQQAppInterface = (nyd)paramQQAppInterface.getManager(238);
              if (paramQQAppInterface != null) {
                paramQQAppInterface.a((nxq)localObject1);
              }
              return localObject1;
              paramMessageRecord = paramMessageRecord.getExtInfoFromExtStr("recent_list_advertisement_message_push_time");
              try
              {
                ((nxq)localObject1).a = Long.parseLong(paramMessageRecord);
              }
              catch (Exception paramMessageRecord)
              {
                ((nxq)localObject1).a = 0L;
              }
            }
          }
          return null;
