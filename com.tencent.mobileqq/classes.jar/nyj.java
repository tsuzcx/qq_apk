...
public class nyj
  extends oxx
{
  private static oah jdField_a_of_type_Oah = new oah();
  ...
  private nym jdField_a_of_type_Nym = new nym(this);
  ...
  public nyj()
  {
    this.jdField_a_of_type_Osm = new nyl(this);
  }
  ...
  private void a(ArticleInfo paramArticleInfo, long paramLong, View paramView)
  {
    ...
    if (AdvertisementInfo.isAdvertisementInfo(paramArticleInfo))
    {
      if (oar.a(i))
      {
        ...
        if (localral != null) {
          localral.notifyDataSetChanged();
        }
      }
      if (localral != null)
      {
        localral.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = shq.a(localActivity, (AdvertisementInfo)paramArticleInfo, localral, i, false, null);
        if (localral.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params == null) {
          break label126;
        }
        l = SystemClock.elapsedRealtime();
        localral.jdField_a_of_type_Long = l;
      }
    ...
    } while (((paramView instanceof ProteusItemView)) && (shq.a(paramArticleInfo, ((ProteusItemView)paramView).a().getVirtualView(), (Activity)localActivity, i, localqtr, localAdvertisementInfo)));
    label186:
    if ((onh.a(paramArticleInfo)) && (paramArticleInfo.mFeedType == 2))
    {
      boolean bool = shq.a(paramArticleInfo, localral);
      shq.a((Activity)localActivity, (AdvertisementInfo)paramArticleInfo, localral, i, true, oaq.b((AdvertisementInfo)paramArticleInfo), new nxz(bool));
      paramView = a();
    ...
    for (;;)
    {
      ...
      return;
      if ((AdvertisementInfo.isAppAdvertisementInfo(paramArticleInfo)) && (localral != null) && (paramLong != -1L))
      {
        int j = localral.getItemViewType((int)paramLong);
        if ((j == 39) || (j == 116) || (j == 117) || (j == 66) || (j == 115) || (j == 122)) {
          shq.a(localActivity, (AdvertisementInfo)paramArticleInfo, localral, i, true, oaq.b((AdvertisementInfo)paramArticleInfo));
        } else {
          shq.a(localActivity, (AdvertisementInfo)paramArticleInfo, localral, i, false, null);
        }
      }
      else
      {
        ...
        shq.a((Activity)localActivity, paramArticleInfo, localral, i, null);
      }
    }
  }
  ...
  private void i()
  {
    ...
    if ((oar.a(i)) && (localReadInJoyXListView != null) && (localReadInJoyXListView.getChildCount() > 0))
    {
      i = 0;
      while (i < localReadInJoyXListView.getChildCount())
      {
        View localView = localReadInJoyXListView.getChildAt(i);
        if ((localView.getTag(2131379213) instanceof pbf))
        {
          Object localObject = ((pbf)localView.getTag(2131379213)).a();
          ...
          localView = localView.findViewById(2131362000);
    ...
    saf.a("AdHandler", "refreshADVideoFeedsDownloadState", System.currentTimeMillis() - l);
  }
  ...
  private void j()
  {
    ...
    if (localral != null)
    {
      shq.a(i, localral.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params, localral.jdField_a_of_type_Long);
      localral.jdField_a_of_type_Long = -2147483648L;
      localral.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = null;
    }
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = null;
    nym.a(this.jdField_a_of_type_Nym);
    if (oak.a(i)) {
      paramViewGroup = nym.a(this.jdField_a_of_type_Nym, paramView, localArticleInfo, i, paramInt);
    }
    for (;;)
    {
      ...
      if (pqn.a(i)) {
        paramViewGroup = nym.b(this.jdField_a_of_type_Nym, paramView, localArticleInfo, i, paramInt);
      }
    }
  }
  ...
  public void a(View paramView, ListView paramListView)
  {
    ...
    ram localram = a();
    oag localoag = jdField_a_of_type_Oah.a(this.jdField_a_of_type_Int);
    paramListView = localoag;
    if (localoag == null)
    {
      paramListView = new oag(this.jdField_a_of_type_Int);
      jdField_a_of_type_Oah.a(this.jdField_a_of_type_Int, paramListView);
    }
    localram.a(paramListView);
    ozg.a().a(this.jdField_a_of_type_Int, localram);
  ...
  public void a(ReadInJoyBaseListView paramReadInJoyBaseListView, int paramInt)
  {
    ...
    if (paramReadInJoyBaseListView != null)
    {
      ...
      if ((this.jdField_a_of_type_Int == 0) && (oat.a().jdField_a_of_type_Boolean) && (bhvy.i()))
      {
        paramReadInJoyBaseListView = a();
        if ((paramReadInJoyBaseListView != null) && ((paramReadInJoyBaseListView instanceof ReadInJoyListViewGroup)))
        {
          if ((((ReadInJoyListViewGroup)paramReadInJoyBaseListView).f()) || (oat.a().a().size() <= 0)) {
            break label160;
          }
          oat.a().b(true);
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if ((!((ReadInJoyListViewGroup)paramList).f()) && (oat.a().jdField_a_of_type_Boolean))
    {
      if (this.jdField_a_of_type_Obp == null) {
        this.jdField_a_of_type_Obp = new obp();
      }
      this.jdField_a_of_type_Obp.a(a(), this.jdField_a_of_type_ComTencentWidgetListView);
    }
    oat.a().jdField_a_of_type_Boolean = false;
  }
  
  public boolean a(int paramInt)
  {
    nym.a(this.jdField_a_of_type_Nym);
    return oak.a(paramInt);
  }
  ...
  public void b(View paramView, ListView paramListView)
  {
    ...
    if (((paramListView instanceof ReadInJoyXListView)) && (paramView != null)) {
      ((ReadInJoyXListView)paramListView).setRefreshPullDistanceListener(new nyk(this, paramView));
    }
  }
  ...
  public void b(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (ram.a() != null)
      {
        paramAbsListView = (nzg)ram.a().getManager(307);
  ...
  protected void c(AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while ((!(localObject2 instanceof BaseArticleInfo)) || (!AdvertisementInfo.isAdvertisementInfo((BaseArticleInfo)localObject2)) || (!oaq.c((AdvertisementInfo)localObject2)));
  ...
  public void d()
  {
    ozg.a().b(this.jdField_a_of_type_Int);
  ...
  public void e()
  {
    ...
    if (localram != null)
    {
      Object localObject = localram.a();
      if (localObject != null) {
        ((qki)localObject).jdField_a_of_type_Boolean = false;
      }
      if (ram.a() != null)
      {
        localObject = (nzg)ram.a().getManager(307);
        if (localObject != null)
        {
          ((nzg)localObject).a(localram, localram.a());
          if ((a() != null) && (a().a() != null)) {
            a().a().a(localram, localram.a());
          }
          ((nzg)localObject).a(localram, localram.a(), true);
        }
      }
    }
  }
