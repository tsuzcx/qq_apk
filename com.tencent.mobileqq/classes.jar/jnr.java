...
class jnr
  implements Runnable
{
  jnr(jnq paramjnq, VideoLayerUI paramVideoLayerUI, Bitmap paramBitmap) {}
  ...
  public void run()
  {
    try
    {
      ...
      localBitmap1 = RedPacketGameView.a(this.jdField_a_of_type_Jnq.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView, localBitmap1, i * 90);
      ...
      this.jdField_a_of_type_Jnq.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.setDrawingCacheEnabled(false);
      localBitmap1.recycle();
      this.jdField_a_of_type_Jnq.jdField_a_of_type_ComTencentAvRedpacketAVRedPacketManager.a(localBitmap2);
      return;
    }
