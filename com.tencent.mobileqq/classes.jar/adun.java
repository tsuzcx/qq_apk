...
public class adun
{
  ...
  public adun(ChatHistory paramChatHistory)
  {
    a();
  }
  ...
  public void a(int paramInt, View paramView, Object paramObject, String paramString)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (bgjw.a(paramObject, this.jdField_a_of_type_JavaLangObject)))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    return (!this.jdField_a_of_type_Boolean) && (paramInt == this.jdField_a_of_type_Int) && (bgjw.a(this.jdField_a_of_type_JavaLangObject, paramObject));
  }
  ...
  protected void b()
  {
    ...
    label302:
    label307:
    for (localObject1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372990);; localObject1 = null)
    {
      if (localObject1 != null) {
        if ((this.jdField_a_of_type_AndroidViewView.getTag() == null) || (!(this.jdField_a_of_type_AndroidViewView.getTag() instanceof adum))) {
          break label302;
        }
      }
      for (boolean bool = ((adum)this.jdField_a_of_type_AndroidViewView.getTag()).jdField_a_of_type_Boolean;; bool = false)
      {
        if (bool)
        {
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Int == 1)
          {
            ...
            if (this.jdField_a_of_type_AndroidViewView != null)
            {
              localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377546);
              localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368390);
            }
            for (;;)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.b((ImageView)localObject1, (asbq)localObject2);
              return;
              localImageView = null;
            }
          }
  ...
  protected void c()
  {
    ...
    for (localObject1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372990);; localObject1 = null)
    {
      ...
      for (boolean bool = ((adum)this.jdField_a_of_type_AndroidViewView.getTag()).jdField_a_of_type_Boolean;; bool = false)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.b.stop();
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getResources().getDrawable(2130849964);
        ...
        for (;;)
        {
          return;
          this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a.stop();
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getResources().getDrawable(2130849963);
          ((Drawable)localObject2).setBounds(0, 0, ((Drawable)localObject2).getMinimumWidth(), ((Drawable)localObject2).getMinimumHeight());
          break;
          if (this.jdField_a_of_type_Int == 1)
          {
            if (this.jdField_a_of_type_AndroidViewView != null)
            {
              localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377546);
              localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368390);
            }
            for (;;)
            {
              ...
              if (!(localObject3 instanceof asbq)) {
                break;
              }
              localObject3 = (asbq)localObject3;
              ((asbq)localObject3).a("fromAIO", true);
              this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.b((ImageView)localObject2);
              this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a((ImageView)localObject1, (asbq)localObject3);
              return;
              localObject2 = null;
            }
          }
