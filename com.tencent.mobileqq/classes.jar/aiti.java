  ...
  extends Handler
{
  ...
  public aiti(PublishHomeWorkFragment paramPublishHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
  ...
  void a()
  {
    ...
    localObject = localPublishHomeWorkFragment.getString(2131430609, new Object[] { Integer.valueOf(i), Integer.valueOf(j), PublishHomeWorkFragment.e(localPublishHomeWorkFragment) }).trim();
    String str1 = localPublishHomeWorkFragment.getString(2131430609, new Object[] { Integer.valueOf(i), Integer.valueOf(j), "" }).trim();
    ...
    do
    {
      ...
      case 102: 
        ...
        if (!NetworkUtil.d(localPublishHomeWorkFragment.getActivity()))
        {
          ...
          QQToast.a(localPublishHomeWorkFragment.getActivity(), 2131430281, 0).a();
          PublishHomeWorkFragment.f(localPublishHomeWorkFragment, false);
          PublishHomeWorkFragment.g(localPublishHomeWorkFragment);
          return;
        }
