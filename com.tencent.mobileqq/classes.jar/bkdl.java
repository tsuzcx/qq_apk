...
public class bkdl
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bkdm(this);
  ...
  public bkdl(Context paramContext, int paramInt1, int paramInt2, int paramInt3, GdtAppReceiver paramGdtAppReceiver)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      bkbp.a().a(this.jdField_c_of_type_Int, 0L, paramInt1, paramString, paramInt2);
      return;
    }
    QZLog.i("VipGeneralGdtShowView", " @getGdtInfo sendBusinessReport");
  }
  
  public void a(View paramView, bkdo parambkdo)
  {
    if (paramView == null) {
      return;
    }
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131367110));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367117));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367118));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367120));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367116));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367121));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367122));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367119));
  ...
  public void a(AlumBasicData paramAlumBasicData, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getDrawable(2130840084);
        ...
        if ((this.jdField_c_of_type_Int == 3) && (!azib.b()))
        {
          ((URLDrawable)localObject1).setTag(bcuq.a(bdkf.a(40.0F), bdkf.a(40.0F)));
          ((URLDrawable)localObject1).setDecodeHandler(bcuq.o);
          if (localURLDrawable != null)
          {
            this.jdField_e_of_type_Int = paramAlumBasicData.jdField_a_of_type_Int;
            this.f = paramAlumBasicData.jdField_b_of_type_Int;
            int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - bdkf.b(56.0F);
            paramInt = i;
      ...
      ((URLDrawable)localObject1).setTag(bcuq.b(bdkf.a(40.0F), bdkf.a(40.0F), bdkf.a(3.5F)));
