...
public class bkdl
  implements bkaa
{
  public bkdl(DoodleLayout paramDoodleLayout) {}
  
  public void a(int paramInt)
  {
    if (this.a.jdField_a_of_type_Bkdo != null) {
      this.a.jdField_a_of_type_Bkdo.a(1, paramInt);
    }
  }
  ...
  public boolean a(bjzx parambjzx)
  {
    boolean bool = false;
    ...
    this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView.a.a(parambjzx);
    parambjzx.k = true;
    SegmentKeeper localSegmentKeeper = parambjzx.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper;
    ...
    if ((parambjzx.h == 1) || (parambjzx.h == 3)) {
      parambjzx.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setCallback(this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView);
    }
