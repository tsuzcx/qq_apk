...
public class aywk
{
  ...
  static
  {
    ...
    jdField_b_of_type_Int = (int)bbdh.a(localBaseApplication, 45.0F);
    c = (int)bbdh.a(localBaseApplication, 135.0F);
  ...
  public static Bitmap a()
  {
    ...
    {
      localBitmap1 = bawu.a(BaseApplicationImpl.getContext().getResources(), 2130839139);
  ...
  public static Drawable a()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bawu.a(BaseApplicationImpl.getContext().getResources(), 2130837912);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static Drawable a(int paramInt)
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bawu.a(BaseApplicationImpl.getContext().getResources(), paramInt);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable a(auoa paramauoa, int paramInt)
  {
    return a(paramauoa, paramInt, null, null);
  }
  
  public static URLDrawable a(auoa paramauoa, int paramInt, String paramString, URLDrawable.URLDrawableOptions paramURLDrawableOptions)
  {
    boolean bool2 = true;
    if (paramauoa == null) {
      return null;
    }
    paramString = URLDrawable.getDrawable(a(paramauoa, paramInt, paramString), paramURLDrawableOptions);
    paramString.setTag(paramauoa);
    if (paramauoa.isSendFromLocal()) {}
    for (;;)
    {
      return paramString;
      if (!aunk.jdField_b_of_type_Boolean) {
        break;
      }
      paramString.setAutoDownload(true);
    }
    boolean bool3 = SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131695321), "qqsetting_auto_receive_pic_key", true);
    boolean bool1 = bool2;
  ...
  private static String a(aunh paramaunh)
  {
    if (paramaunh == null) {
      return null;
    }
    switch (paramaunh.jdField_b_of_type_Int)
    {
    default: 
      return null;
    case 0: 
  ...
  private static String a(aunh paramaunh, int paramInt)
  {
    int n;
    String str;
    if (paramInt == 65537)
  ...
  public static URL a(aunl paramaunl, int paramInt, String paramString)
  {
    if (paramaunl == null) {
      return null;
    }
    String str1 = paramaunl.f;
    label48:
    String str2;
    if ((str1 != null) && (!"null".equals(str1)) && (!"".equals(str1)))
    {
      if (paramaunl.jdField_b_of_type_Boolean) {
        paramInt = 1;
      }
      if (paramString == null) {
        break label184;
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramaunl.toString());
          str2 = str1;
        }
        if (paramString == null) {
          break label200;
        }
        paramaunl = new URL(paramString, null, str2);
        return paramaunl;
      }
      catch (MalformedURLException paramaunl)
      {
        label184:
        paramaunl.printStackTrace();
        return null;
      }
      if ((paramaunl.jdField_b_of_type_Int == 8000) && (paramInt == 65537))
      {
        if (axqf.a())
        {
          str1 = paramaunl.k;
      ...
      str1 = paramaunl.g;
      break;
      paramString = a(paramaunl, paramInt);
      break label48;
      label200:
      paramaunl = null;
    }
  ...
  public static URL a(auoa paramauoa, int paramInt)
  {
    return a(paramauoa, paramInt, null);
  }
  
  public static URL a(auoa paramauoa, int paramInt, String paramString)
  {
    if (paramauoa == null) {
      return null;
    }
    if (paramauoa.isSendFromLocal()) {
      return a(paramauoa.getPicUploadInfo(), paramInt, paramString);
    }
    return a(paramauoa.getPicDownloadInfo(), paramInt, paramString);
  }
  
  public static URL a(auob paramauob, int paramInt, String paramString)
  {
    if (paramauob == null) {
      return null;
    }
    if (paramauob.d < 4) {}
    for (String str2 = a(paramauob);; str2 = null)
    {
      String str3 = a(paramauob, paramInt);
      if ((paramauob.jdField_b_of_type_Int == 8000) && (paramInt == 65537)) {}
      for (String str1 = paramauob.h;; str1 = "") {
        for (;;)
        {
          if (str1 != null) {}
          try
          {
            if (("".equals(str1)) && (QLog.isColorLevel())) {
              QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramauob.toString());
            }
            if (paramString != null)
            {
              paramauob = new URL(paramString, str2, str1);
              return paramauob;
              if ((paramauob.f != null) && (!"".equals(paramauob.f)))
              {
                str1 = paramauob.f;
                continue;
              }
              if ((paramauob.a != null) && (!"".equals(paramauob.a)))
              {
                str1 = paramauob.a;
                continue;
              }
              if ((paramauob.g != null) && (!"".equals(paramauob.g))) {
                str1 = paramauob.g;
              }
            }
            else
            {
              ...
              paramauob = new URL(str3, str2, str1);
              return paramauob;
            }
          }
          catch (MalformedURLException paramauob)
          {
            paramauob.printStackTrace();
            return null;
          }
        }
      }
  ...
  public static boolean a(Context paramContext, auoa paramauoa, int paramInt)
  {
    return ayog.a(a(paramauoa, paramInt).toString()) != null;
  }
  ...
  public static Drawable b()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bawu.a(BaseApplicationImpl.getContext().getResources(), 2130837909);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable b(auoa paramauoa, int paramInt)
  {
    URLDrawable localURLDrawable = URLDrawable.getDrawable(a(paramauoa, 65537));
    ...
    {
      localURLDrawable.setTargetDensity(d);
      localURLDrawable.setTag(paramauoa);
  ...
  public static void b()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 500	aywk:jdField_b_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   53: putstatic 61	aywk:m	I
    //   56: iconst_1
    //   57: putstatic 500	aywk:jdField_b_of_type_Boolean	Z
  ...
  {
    return SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131695321), "qqsetting_auto_receive_pic_key", true);
  }
  ...
  public static Drawable c()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bawu.a(BaseApplicationImpl.getContext().getResources(), 2130843720);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
