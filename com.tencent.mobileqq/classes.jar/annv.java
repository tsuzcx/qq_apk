...
public class annv
{
  ...
  public static String aC = anzj.a(2131699233);
  public static String aD = anzj.a(2131699232);
  ...
  public static String aH = anzj.a(2131699231);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bigv.a(antf.ba + "/.apollo");
    ...
    localStringBuilder.append("?client=androidQQ").append("&version=").append("8.4.5.4745").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE);
