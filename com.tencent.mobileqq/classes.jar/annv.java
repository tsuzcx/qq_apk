  ...
  implements Handler.Callback
{
  ...
  public annv(annx paramannx, anny paramanny)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Annx = paramannx;
    this.jdField_a_of_type_Anny = paramanny;
  }
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > 0))
        {
          ...
          new annw(this, 0).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
        }
      }
      return;
    }
  ...
  public void a(int paramInt, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Annx.a(this, paramString1, this.jdField_b_of_type_JavaLangString, paramString2);
      return;
    }
    this.jdField_a_of_type_Int = 2;
  }
  ...
  public void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if ((this.jdField_b_of_type_Boolean) && (paramBitmap != null) && (!paramBitmap.isRecycled()))
    {
      ...
      this.jdField_a_of_type_Bkys.obtainMessage(255, this.jdField_c_of_type_Int, 0).sendToTarget();
    }
    for (;;)
    {
      ...
      return;
      label77:
      paramBitmap = this.jdField_a_of_type_Bkys.obtainMessage(255, this.jdField_c_of_type_Int, 0);
      this.jdField_a_of_type_Bkys.sendMessageDelayed(paramBitmap, this.jdField_b_of_type_Int - l2);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (this.jdField_a_of_type_Anny == null) {
      return false;
    }
    this.jdField_a_of_type_Anny.a(paramMessage.arg1, this.jdField_a_of_type_AndroidGraphicsBitmap);
    ...
    if ((this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > this.jdField_c_of_type_Int)) {
      new annw(this, this.jdField_c_of_type_Int).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
    }
    for (;;)
    {
