...
{
  ral(raj paramraj, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    raj.a(this.jdField_a_of_type_Raj).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.d(raj.b(this.jdField_a_of_type_Raj), 2, paramBundle.getMessage());
        continue;
      ...
      if (QLog.isColorLevel()) {
        QLog.d(raj.b(this.jdField_a_of_type_Raj), 2, "build struct msg fail");
      }
      return;
