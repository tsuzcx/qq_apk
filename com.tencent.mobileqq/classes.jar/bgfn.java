  ...
  extends BaseAdapter
{
  ...
  private LinkedHashMap<Integer, ArrayList<bgez>> jdField_a_of_type_JavaUtilLinkedHashMap = new TroopAppShortcutContainer.AppsListViewAdapter.1(this);
  
  public bgfn(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  public bgez a(int paramInt)
  {
      ...
      if (paramInt < j)
      {
        ...
        if (k >= 0)
        {
          ...
          if (k < ((ArrayList)localEntry.getValue()).size()) {
            return (bgez)((ArrayList)localEntry.getValue()).get(k);
          }
        }
      }
    }
  ...
  public void a(int paramInt, bgez parambgez)
  {
    if (this.jdField_a_of_type_JavaUtilLinkedHashMap.containsKey(Integer.valueOf(paramInt)))
    {
      ...
      ((ArrayList)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(paramInt))).add(parambgez);
      notifyDataSetChanged();
    }
  }
  
  public void a(int paramInt, List<bgez> paramList)
  {
    if (this.jdField_a_of_type_JavaUtilLinkedHashMap.containsKey(Integer.valueOf(paramInt)))
    {
      ((ArrayList)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(paramInt))).clear();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localObject != null) {}
    for (localObject = ((bgez)localObject).a(paramInt, paramView, paramViewGroup);; localObject = null)
    {
