  ...
  extends Writer
{
  ...
  public bfgm(File paramFile, boolean paramBoolean)
  {
    this(new BufferedOutputStream(new FileOutputStream(paramFile, paramBoolean)));
  }
  
  public bfgm(OutputStream paramOutputStream)
  {
    this(paramOutputStream, Charset.defaultCharset());
  }
  
  public bfgm(OutputStream paramOutputStream, Charset paramCharset)
  {
  ...
  private CharBuffer a(char[] paramArrayOfChar, int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 52	bfgm:jdField_a_of_type_Boolean	Z
    //   4: ifne +23 -> 27
    //   7: aload_0
    //   8: aload_1
    //   9: iload_2
    ...
    //   14: putfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   17: aload_0
    //   18: iconst_1
    //   19: putfield 52	bfgm:jdField_a_of_type_Boolean	Z
    //   22: aload_0
    //   23: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   26: areturn
    //   27: getstatic 17	bfgm:jdField_b_of_type_Boolean	Z
    //   30: ifeq +258 -> 288
    //   33: aload_0
    //   34: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   37: invokevirtual 97	java/nio/CharBuffer:clear	()Ljava/nio/Buffer;
    //   40: pop
    //   41: getstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    //   44: ifnull +15 -> 59
    //   47: getstatic 101	bfgm:jdField_a_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   50: ifnull +9 -> 59
    //   53: getstatic 103	bfgm:jdField_b_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   56: ifnonnull +87 -> 143
    ...
    //   80: putstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    //   83: getstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    ...
    //   94: putstatic 101	bfgm:jdField_a_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   97: getstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    ...
    //   114: putstatic 103	bfgm:jdField_b_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   117: getstatic 101	bfgm:jdField_a_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   120: ifnull +10 -> 130
    //   123: getstatic 101	bfgm:jdField_a_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   126: iconst_1
    //   127: invokevirtual 135	java/lang/reflect/Field:setAccessible	(Z)V
    //   130: getstatic 103	bfgm:jdField_b_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   133: ifnull +10 -> 143
    //   136: getstatic 103	bfgm:jdField_b_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   139: iconst_1
    //   140: invokevirtual 135	java/lang/reflect/Field:setAccessible	(Z)V
    //   143: getstatic 103	bfgm:jdField_b_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   146: ifnull +133 -> 279
    //   149: getstatic 101	bfgm:jdField_a_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   152: ifnull +127 -> 279
    //   155: getstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    //   158: ifnull +121 -> 279
    //   161: getstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    //   164: aload_0
    //   165: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   168: invokevirtual 139	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   171: ifeq +108 -> 279
    //   174: getstatic 101	bfgm:jdField_a_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   177: aload_0
    //   178: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   181: aload_1
    //   182: invokevirtual 143	java/lang/reflect/Field:set	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   185: getstatic 103	bfgm:jdField_b_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   188: aload_0
    //   189: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   192: aload_1
    //   193: arraylength
    //   194: invokestatic 148	bfgn:a	(I)Ljava/lang/Integer;
    //   197: invokevirtual 143	java/lang/reflect/Field:set	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   200: aload_0
    //   201: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   204: iload_2
    //   205: invokevirtual 152	java/nio/CharBuffer:position	(I)Ljava/nio/Buffer;
    //   208: pop
    //   209: aload_0
    //   210: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   213: iload_2
    //   214: iload_3
    //   215: iadd
    ...
    //   219: pop
    //   220: aload_0
    //   221: getfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   224: areturn
    ...
    //   238: putstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    //   241: getstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    //   244: ldc 123
    //   246: invokevirtual 127	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   249: putstatic 101	bfgm:jdField_a_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   252: getstatic 99	bfgm:jdField_a_of_type_JavaLangClass	Ljava/lang/Class;
    ...
    //   266: putstatic 103	bfgm:jdField_b_of_type_JavaLangReflectField	Ljava/lang/reflect/Field;
    //   269: goto -152 -> 117
    //   272: astore 4
    //   274: aload 4
    //   276: invokevirtual 160	java/lang/ClassNotFoundException:printStackTrace	()V
    //   279: iconst_0
    //   280: putstatic 17	bfgm:jdField_b_of_type_Boolean	Z
    //   283: aload_0
    //   284: aconst_null
    //   285: putfield 93	bfgm:jdField_a_of_type_JavaNioCharBuffer	Ljava/nio/CharBuffer;
    //   288: aload_1
    //   289: iload_2
    //   290: iload_3
