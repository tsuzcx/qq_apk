...
public class azul
{
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    return bhkv.encodeToString(localByteArrayOutputStream.toByteArray(), 2);
  }
  ...
  public static String a(String paramString)
  {
    ...
    try
    {
      ...
      if (arrayOfByte != null) {
        localObject1 = bleb.b(arrayOfByte);
      }
    }
  ...
  public static String a(String paramString, long paramLong)
  {
    for (i = 1;; i = j)
    {
      ...
      str = bhkv.encodeToString(str.getBytes(), 2);
  ...
  public static String a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return bleb.b(jdField_a_of_type_JavaSecurityMessageDigest.digest());
    }
  ...
  public static String b(String paramString)
  {
    ...
    //   23: iconst_2
    //   24: invokestatic 242	bhkv:decode	([BI)[B
    //   27: astore_0
