  ...
  extends wfh
{
  ...
  public final List<wux> a;
  public final boolean a;
  public final byte[] a;
  
  public wuw(qqstory_service.RspGetEmoticonPackList paramRspGetEmoticonPackList, byte[] paramArrayOfByte, long paramLong)
  {
    ...
    else
    {
      for (;;)
      {
        ...
        wux localwux = new wux((qqstory_struct.EmoticonPack)paramRspGetEmoticonPackList.next());
        if (localwux.a())
        {
          localArrayList.add(localwux);
          continue;
          bool = false;
          break;
        }
        ykq.d("GetEmojiPackInfoListResponse", "found invalid data we ignore it : " + localwux);
      }
    }
    label151:
