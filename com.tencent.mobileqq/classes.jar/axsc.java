  ...
  implements IRequestCallback
{
  ...
  public void onResponse(HwResponse paramHwResponse)
  {
    ...
    if (paramHwResponse.retCode == 0)
    {
      if (paramHwResponse.segmentResp.uint32_cache_addr.has())
      {
        ...
        if (i != 0)
        {
          ...
          if ((axrz.a(this.a) != 0) && (axrz.a(this.a) != i)) {
      ...
      if ((localObject1 != null) && (localObject1.length > 0)) {
        try
        {
          ...
          {
            if ((axrz.jdField_a_of_type_Boolean) || (!QLog.isColorLevel())) {
              return;
            }
    ...
    else
    {
      ...
      badi.a(String.valueOf(this.a.jdField_a_of_type_Axvt.a), "svrcomp_r", "sendAckToBDHServer success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject3));
      this.a.jdField_a_of_type_Axvt.f = HexUtil.bytes2HexStr((byte[])localObject3);
      this.a.jdField_a_of_type_Axvt.i = ShortVideoUtils.a(axrz.a(this.a), "mp4");
      this.a.c = this.a.jdField_a_of_type_Axvt.f;
      ...
      localObject2 = this.a.jdField_a_of_type_Axqf;
      localObject3 = this.a;
      long l = this.a.q;
      ((axrz)localObject3).s = l;
