  ...
  extends BaseAdapter
{
  ...
  public alij(Context paramContext, ArrayList<Object> paramArrayList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, aczw paramaczw)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof alik)))
      {
        localObject1 = (alik)paramView.getTag();
        ((alik)localObject1).jdField_a_of_type_JavaLangObject = localObject2;
        ((alik)localObject1).jdField_a_of_type_JavaLangString = ((aczu)this.jdField_a_of_type_Aczw).c;
        if (!(localObject2 instanceof MessageForStructing)) {
          break label336;
        }
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && ((((MessageForStructing)localObject2).structingMsg instanceof AbsShareMsg)))
        {
          ...
          a(((alik)localObject1).jdField_a_of_type_ComTencentImageURLImageView, localAbsShareMsg);
          ((alik)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(a(localAbsShareMsg, "title"));
          ((alik)localObject1).b.setText(localAbsShareMsg.mSourceName);
        }
        label153:
        if (!this.jdField_a_of_type_Aczw.b()) {
          break label361;
        }
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Aczw.a.a((ChatMessage)localObject2));
      }
      for (;;)
      {
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localObject1 = new alik(this);
        paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562827, null);
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376022));
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131377840));
        ((alik)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131377838));
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363700));
        ((alik)localObject1).b = ((TextView)paramView.findViewById(2131371472));
        paramView.setTag(localObject1);
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject1);
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        break;
        label336:
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("");
        ((alik)localObject1).b.setText("");
        break label153;
        label361:
        ((alik)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(8);
      }
    }
    ...
    for (;;)
    {
      ...
      break;
      label427:
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562828, null);
