  ...
  implements View.OnClickListener
{
  ...
  public tsl(QCircleInitBean paramQCircleInitBean)
  {
  ...
  private void b()
  {
    try
    {
      ...
      if ((QzoneConfig.isQQCircleShowInviteGuideBubbleOnProfilePage()) && (localImageView != null) && (tra.a(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser)))
      {
        ...
        if ("1".equals(bczr.a(localContext, str)))
        {
        ...
        else
        {
          ...
          ((ImageView)localObject).setImageResource(2130843679);
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_FeedcloudFeedCloudRead$StGetMainPageRsp.user != null) && (this.jdField_a_of_type_FeedcloudFeedCloudRead$StGetMainPageRsp.share != null))
    {
      ...
      localObject = new tru();
      ((tru)localObject).jdField_a_of_type_FeedcloudFeedCloudMeta$StFeed = localStFeed;
      this.jdField_a_of_type_Tru = ((tru)localObject);
    }
  }
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser != null)
    {
      ...
      if (tra.a(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser)) {
        tyj.a(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser.id.get(), 11, 2L, 1L);
      }
  ...
  private void g()
  {
    ...
    if ((this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser != null) && (this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser.get() != null)) {
      ...
      {
        this.jdField_a_of_type_Tru.jdField_a_of_type_Int = 1;
        localtru = this.jdField_a_of_type_Tru;
    ...
    {
      localtru.c = bool;
      b("share_action_show_share_sheet", this.jdField_a_of_type_Tru);
      return;
    }
  }
  ...
  private void h()
  {
    ...
    if ((this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser != null) && (this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser.get() != null))
    {
      ...
      localbhpy.a(2131698374, 0);
      localbhpy.a(2131698380, 0);
      localbhpy.c(2131690648);
      localbhpy.a(new tsn(this, localbhpy));
    }
    for (;;)
    {
      ...
      localbhpy.a(2131698374, 0);
      localbhpy.c(2131690648);
      localbhpy.a(new tso(this, localbhpy));
    }
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Tzf.a().observe(a(), new tsm(this));
  }
  ...
  protected void a(View paramView)
  {
    if ((this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser != null) && ((a() instanceof PublicFragmentActivity)) && (((PublicFragmentActivity)a()).getSupportFragmentManager().getFragments() != null))
    {
      ...
      this.jdField_a_of_type_Tsu = new tsu(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser);
      this.jdField_a_of_type_Tsu.a(localComponentBaseFragment, paramView, localComponentBaseFragment.a());
      this.jdField_a_of_type_Tsu.a(paramView);
    }
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368927));
    this.b = ((ImageView)paramView.findViewById(2131368930));
    this.c = ((ImageView)paramView.findViewById(2131368929));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378988));
    this.d = ((ImageView)paramView.findViewById(2131368931));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131379920);
    c();
    a();
    f();
  }
  ...
  public void onActivityDestroyed(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Tsu != null) {
      this.jdField_a_of_type_Tsu.onActivityDestroyed(paramActivity);
    }
  }
  ...
  public void onActivityResumed(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Tsu != null) {
      this.jdField_a_of_type_Tsu.onActivityResumed(paramActivity);
    }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      tqs.a(a(), tqr.a(this.jdField_a_of_type_QqcircleQQCircleFeedBase$StMainPageBusiRspData.urlInfo.get(), "NoticeListUrl"));
      tyj.a(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser.id.get(), 11, 2L, 2L);
      return;
      h();
      tyj.a(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser.id.get(), 11, 7L, 1L);
      return;
    } while ((!tra.a(this.jdField_a_of_type_FeedcloudFeedCloudMeta$StUser)) || (this.jdField_a_of_type_QqcircleQQCircleFeedBase$StMainPageBusiRspData == null));
