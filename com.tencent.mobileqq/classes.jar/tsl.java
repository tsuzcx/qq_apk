...
public class tsl
{
  ...
  public tsl(List<String> paramList)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Tsq = new tsm(this);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Tsp = null;
  }
  ...
  public void a(List<String> paramList)
  {
    ...
    veg.d("BatchGetVideoInfo", "runPuller vid list size = %d", new Object[] { Integer.valueOf(((List)localObject).size()) });
    paramList = tje.a((List)localObject);
    paramList.a("BatchGetVideoInfo");
    paramList.a(new tsn(this, paramList));
    paramList.b();
  }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          if ((this.jdField_a_of_type_Tsq != null) && (this.jdField_a_of_type_Tsq.a(localStoryVideoItem)))
          {
            if (QLog.isColorLevel()) {
    ...
    } while (this.jdField_a_of_type_Tsp == null);
    this.jdField_a_of_type_Tsp.a(localArrayList2);
    return;
    a(localArrayList1);
  }
  ...
  public void c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      StoryVideoItem localStoryVideoItem = localtcz.a((String)localObject2);
      if (localStoryVideoItem == null)
      {
        if (QLog.isColorLevel()) {
      ...
      {
        localObject2 = ((tdo)tdc.a(2)).b(localStoryVideoItem.mOwnerUid);
    ...
    do
    {
      ...
      if (!localArrayList3.isEmpty()) {
        localtcz.a(localArrayList3);
      }
      if (!localArrayList2.isEmpty()) {
        break;
      }
    } while (this.jdField_a_of_type_Tsp == null);
    this.jdField_a_of_type_Tsp.a((ArrayList)localObject1);
    return;
    localObject1 = tje.a(localArrayList2);
    ((tje)localObject1).a("BatchGetVideoInfo");
    ((tje)localObject1).a(new tso(this, (tje)localObject1));
    ((tje)localObject1).b();
  }
  ...
  public void d()
  {
    ...
    while (localIterator.hasNext())
    {
      StoryVideoItem localStoryVideoItem = localtcz.a((String)localIterator.next());
      if (localStoryVideoItem == null)
      {
        veg.d("BatchGetVideoInfo", "user -> video empty ,strange");
      }
      else
      {
        ...
        {
          localQQUserUIItem = ((tdo)tdc.a(2)).b(localStoryVideoItem.mOwnerUid);
    ...
    if (!localArrayList2.isEmpty()) {
      localtcz.a(localArrayList2);
    }
    if (this.jdField_a_of_type_Tsp != null) {
      this.jdField_a_of_type_Tsp.a(localArrayList1);
    }
  }
}
