...
{
  private static final String jdField_a_of_type_JavaLangString = tsl.class.getName();
  ...
  public tsl(Activity paramActivity)
  {
  ...
  public tsl(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    this(paramActivity);
  ...
  public static tsl a(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    return new tsl(paramActivity, paramString1, paramString2, paramString3);
  }
  ...
  private void a()
  {
    for (;;)
    {
      try
      {
        ...
        localObject1 = nnr.a(BaseApplicationImpl.getContext(), (String)localObject1, "GET", null, (Bundle)localObject4);
  ...
  private void a(Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Acyg = new tsq(this, paramActivity.getApplicationContext(), paramActivity, null, localAppInterface);
    this.jdField_a_of_type_Acyg.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
    new binb(this.jdField_a_of_type_Acyg).a(null, localAppInterface, null);
  }
  
  private void b()
  {
    View localView = getLayoutInflater().inflate(2131560048, null);
    ((RelativeLayout)localView.findViewById(2131372876)).setOnClickListener(new tsn(this));
    localView.setOnClickListener(new tso(this));
    this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBar = ((WebViewProgressBar)localView.findViewById(2131373049));
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131372879));
    this.jdField_a_of_type_ComTencentMobileqqMiniUtilSoftKeyboardStateHelper = new SoftKeyboardStateHelper(localView);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131372877));
    ...
    this.jdField_a_of_type_ComTencentMobileqqMiniUtilSoftKeyboardStateHelper.addSoftKeyboardStateListener(new tsp(this, (RelativeLayout.LayoutParams)localObject));
    ...
    int k = (int)(i * 0.85D);
    int m = (int)(k * 0.72D);
    localObject = (RelativeLayout)localView.findViewById(2131372877);
    if (localObject != null)
    {
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    if (this.jdField_a_of_type_Tsr != null) {
      this.jdField_a_of_type_Tsr.a();
    }
  }
  ...
  public void show()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new tsm(this));
