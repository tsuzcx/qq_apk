  ...
  extends naa
{
  public qqstory_struct.ErrorInfo a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      ...
      wta.b("story_net", vby.a, 0, paramInt, new String[] { "", l + "", wta.a(BaseApplication.getContext()) });
      return null;
    }
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 0)
        {
          ...
          if (paramBundle.mErrorCode == 0) {
            ((uro)urr.a(5)).a(paramBundle.mVid, paramBundle);
          }
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        a(-1, null, null);
        return null;
        ((uid)urr.a(28)).b((List)localObject1);
