...
public final class ruz
{
  ...
  {
    boolean bool = true;
    jdField_a_of_type_Rvb = new rvb(null);
  ...
  public ruz(@NotNull VideoFeedsStressFollowLayout paramVideoFeedsStressFollowLayout, @NotNull View paramView)
  {
    ...
    paramVideoFeedsStressFollowLayout = this.jdField_b_of_type_AndroidViewView.findViewById(2131367949);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsStressFollowLayout.a((rvj)new rva(this));
  }
  ...
  private final void a()
  {
    ...
    localValueAnimator.addUpdateListener((ValueAnimator.AnimatorUpdateListener)new rvc(this));
    localValueAnimator.addListener((Animator.AnimatorListener)new rvd(this));
  ...
  private final void a(Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    localAnimatorSet2.addListener((Animator.AnimatorListener)new rve(this));
    ValueAnimator localValueAnimator = ValueAnimator.ofFloat(new float[] { 0.0F, 1.0F });
    Intrinsics.checkExpressionValueIsNotNull(localValueAnimator, "translationAnimator");
    localValueAnimator.setDuration(400L);
    localValueAnimator.addUpdateListener((ValueAnimator.AnimatorUpdateListener)new rvf(this));
    AnimatorSet localAnimatorSet3 = new AnimatorSet();
    localAnimatorSet3.addListener((Animator.AnimatorListener)new rvg(this, paramAnimatorListener));
