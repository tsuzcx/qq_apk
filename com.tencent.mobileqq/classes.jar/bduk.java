...
public class bduk
{
  ...
  public bduk()
  {
    ...
    this.jdField_a_of_type_Bdul = new bdul();
    this.jdField_b_of_type_Bdul = new bdul();
    this.jdField_c_of_type_Bdul = new bdul();
    this.jdField_a_of_type_Bdum = new bdum();
    this.jdField_b_of_type_Bdum = new bdum();
    this.jdField_g_of_type_Long = System.currentTimeMillis();
  }
  
  public bduk(String paramString1, String paramString2, int paramInt)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_d_of_type_Int = -1;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    default: 
      return;
    case 2: 
      localbdum = this.jdField_a_of_type_Bdum;
      localbdum.jdField_b_of_type_Int += 1;
      return;
    case 4: 
      localbdum = this.jdField_a_of_type_Bdum;
      localbdum.e += paramInt2;
      return;
    case 3: 
      localbdum = this.jdField_a_of_type_Bdum;
      localbdum.d += paramInt2;
      return;
    }
    this.jdField_a_of_type_Bdum.c = true;
  }
