  ...
  extends ayxt
{
  ...
  public ayxu(aysx paramaysx, aymg paramaymg)
  {
    super("VasProfileBackgroundComponent", paramaysx, paramaymg);
  }
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      if (bgio.a(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable)) {
        bgio.a().a(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      }
    }
  }
  ...
  {
    Object localObject = (Boolean)aymh.b.get(Long.valueOf(paramLong));
    if ((localObject != null) && (((Boolean)localObject).booleanValue()))
    {
      localObject = "profilecard:" + paramString1;
      BaseApplicationImpl.sImageCache.remove(localObject);
      aymh.b.remove(Long.valueOf(paramLong));
    }
    localObject = new ayxw(this, paramLong, paramString2, null).a();
    if (((ayxw)localObject).a()) {}
    do
    {
      do
      {
        return true;
        paramFile = new ayxv(this, paramString2, paramFile, ((ayxw)localObject).a()).a();
      } while (paramFile.a());
      ...
      paramString1 = bfrj.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources(), paramString2, paramString1);
  ...
  private boolean a(ayxn paramayxn)
  {
    if (QLog.isColorLevel()) {
      QLog.d(b(), 2, String.format("initProfileCardBackground styleId=%s bgId=%s url=%s strZipUrl=%s heroUrl=%s", new Object[] { Long.valueOf(paramayxn.a()), Long.valueOf(paramayxn.b()), paramayxn.a(), paramayxn.b(), paramayxn.c() }));
    }
    if (!TextUtils.isEmpty(paramayxn.a())) {
      try
      {
        Object localObject;
        if ((paramayxn.b() == 160L) || (paramayxn.b() == 1600L))
        {
          localObject = bfrj.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramayxn.a());
          if (!TextUtils.isEmpty(paramayxn.b())) {
            break label259;
          }
        }
        for (String str = "";; str = aymh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramayxn.b()) + ".dynamic")
        {
          if (QLog.isColorLevel()) {
          ...
          return a(paramayxn.b(), (String)localObject, str, localFile);
          localObject = aymh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramayxn.a(), paramayxn.b());
          break;
          label259:
          str = aymh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramayxn.b()) + "dynamicBottom.jpg";
      ...
      {
        QLog.e(b(), 1, "initProfileCardBackground fail.", paramayxn);
      }
    }
  }
  ...
  private void i()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      } else if (bgio.a(localDrawable)) {
        bgio.a().a(localDrawable);
      }
    }
  ...
  public boolean a(ayxq paramayxq)
  {
    if (paramayxq.a() == null) {
    ...
    boolean bool = a(this.jdField_a_of_type_Ayxn);
    if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      if (bgio.b(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable)) {
        a("card-video");
      }
      for (;;)
      {
        a(true);
        return true;
        if (bgio.c(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable)) {
          a("card-etc");
