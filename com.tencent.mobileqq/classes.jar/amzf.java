  ...
  extends amza
{
  ...
  {
    super("qq.android.minidecode.so_v8.1.5", paramQQAppInterface);
  }
  ...
  public void c()
  {
    boolean bool = apdh.a(new File(akvg.a()));
    if (QLog.isColorLevel()) {
  ...
  {
    int i = 0;
    long l1 = akvj.a("report_tag_so_cover", 0L);
    ...
    for (;;)
    {
      akvj.a(paramBoolean, i, str);
      akvj.a("report_tag_so_cover", l2);
      return;
      label102:
      paramBoolean = false;
      continue;
