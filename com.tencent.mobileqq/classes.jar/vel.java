...
public class vel
{
  ...
  public vel(WSTabLayout paramWSTabLayout, @NonNull View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131381219));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131381210));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new vem(this, paramWSTabLayout));
  }
