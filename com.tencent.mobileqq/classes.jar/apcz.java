  ...
  extends apcq
{
  ...
  public apcz(AppInterface paramAppInterface)
  {
  ...
  public void a(AppInterface paramAppInterface, apcs paramapcs)
  {
    if (a("snycGetConfig", paramAppInterface, paramapcs)) {
      return;
    }
    paramapcs.a(a());
  }
  ...
  boolean a(AppInterface paramAppInterface)
  {
    ...
    return paramAppInterface.getApp().registerReceiver(new apda(this), localIntentFilter) != null;
  }
  ...
  void b(String paramString)
  {
    try
    {
      paramString = bhjo.a(this.jdField_b_of_type_JavaLangString, paramString);
      a(paramString);
