...
{
  public scp(ContactSyncJumpActivity paramContactSyncJumpActivity) {}
  ...
  protected void onGetOnlineInfoByUinOrMobile(boolean paramBoolean, long paramLong, String paramString, GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    do
    {
      ...
      for (paramLong = paramGetOnlineInfoResp.uAbiFlag;; paramLong = -10000L)
      {
        ...
        paramString = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131369916);
        paramString.setText(2131437022);
      ...
      if (paramGetOnlineInfoResp.result == 1)
      {
        ...
        {
          paramString = String.format(this.a.getResources().getString(2131437017), new Object[] { ContactSyncJumpActivity.d(this.a) });
    ...
    label760:
    for (paramString = this.a.getResources().getString(2131437022);; paramString = (String)localObject)
    {
      localObject = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131369916);
