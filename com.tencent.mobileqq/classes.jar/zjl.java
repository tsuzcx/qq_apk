  ...
  extends AbstractImageAdapter
{
  ...
  protected void a(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        paramURLDrawable = baqn.a(str);
        if ((paramURLDrawable != null) && (paramURLDrawable.exists())) {
          paramView.setTag(2131296389, Integer.valueOf(bdhj.d(paramURLDrawable.getAbsolutePath())));
        }
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      localzjk = (zjk)getItem(paramInt);
      paramView = localURLImageView;
    } while (localzjk == null);
    URLDrawable localURLDrawable = a(localzjk.a(), paramViewGroup);
    if (localURLDrawable == null) {
      localURLDrawable = (URLDrawable)localzjk.b();
    }
    for (;;)
    {
      ...
      {
        int i = localURLDrawable.getProgress();
        localURLImageView.setURLDrawableDownListener(new zjm(this, paramInt, paramViewGroup));
        a(paramInt, i / 100);
        return localURLImageView;
      }
      paramView = localURLImageView;
