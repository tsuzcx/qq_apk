...
public class bdjg
{
  ...
  {
    bdht.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bdht.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bdht.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bdio(str2, str3, new bdjh(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bdht.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", bcxm.a().g());
    localBundle.putString("keystr", bcxm.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", bdja.e());
    localBundle.putString("keytype", "256");
    if (bdiw.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bdht.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bdio parambdio, Bundle paramBundle)
  {
