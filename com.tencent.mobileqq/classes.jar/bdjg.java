...
public class bdjg
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (k - 10 < c())
    {
      ...
      {
        paramString = (bcpg)paramQQAppInterface.getManager(203);
        localObject2 = (bfyh)paramQQAppInterface.getManager(165);
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if ((paramString.b(((TroopMemberInfo)localObject1).memberuin)) || (((bfyh)localObject2).f(((TroopMemberInfo)localObject1).memberuin))) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    return ((alrk)paramQQAppInterface.getManager(53)).a(paramString);
  }
  ...
  public static Bundle a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    boolean bool3 = ((bcnu)localObject).a(paramString, paramQQAppInterface.getCurrentAccountUin());
    boolean bool4 = ((bcnu)localObject).a(paramString);
    boolean bool5 = ((bcnu)localObject).b(paramString);
    paramQQAppInterface = ((bcnu)localObject).a(paramString);
    int j = 0;
    boolean bool2 = false;
    int i;
    boolean bool1;
  ...
  public static bdjj a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = bdjj.a(lex.b(276).a);
      }
      return a;
    }
    finally {}
  ...
  {
    paramString = bdjj.a(paramString);
    try
    {
      a = paramString;
      return;
  ...
  public static void a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramQQAppInterface.addObserver(new bdjh(l, paramString1, paramQQAppInterface, str));
        localamdu.b(l, 480, 0);
        paramString2 = ((TroopManager)paramQQAppInterface.getManager(52)).c(paramString2);
        if (paramString2.maxInviteMemNum == 0)
        {
          paramQQAppInterface.addObserver(new bdji(str, paramQQAppInterface, paramString1));
          localamdu.j(str);
        }
  ...
  {
    paramQQAppInterface = (bcnu)paramQQAppInterface.getManager(48);
    ...
    {
      AudioHelper.a(alud.a(2131709312));
      return true;
    }
    return bool1;
  }
  ...
  public static boolean a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    if (localTroopInfo != null)
    {
      ...
      bool1 = true;
      str = alud.a(2131709309);
      label91:
      if ((!bool1) || (!localTroopInfo.isAdmin())) {
        break label735;
      }
      str = str + alud.a(2131709314);
    }
    label158:
    label210:
    label597:
    ...
    for (boolean bool5 = false;; bool5 = bool1)
    {
      ...
      for (;;)
      {
        ...
        {
          bool1 = false;
          paramQQAppInterface = ((bcnu)paramQQAppInterface.getManager(48)).a(paramString2);
