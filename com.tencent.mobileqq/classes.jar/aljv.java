...
public class aljv
{
  ...
  private static aljw jdField_a_of_type_Aljw;
  ...
  {
    jdField_a_of_type_Aljw = new aljw(null);
    jdField_a_of_type_Aljw.jdField_a_of_type_Long = System.currentTimeMillis();
  }
  
  public static void a(int paramInt)
  {
    aljw localaljw = jdField_a_of_type_Aljw;
    if (localaljw == null) {}
    long l;
    do
    {
      return;
      jdField_a_of_type_Aljw = null;
      l = System.currentTimeMillis() - localaljw.jdField_a_of_type_Long;
    } while ((l > 600000L) || (localaljw.jdField_a_of_type_Int <= 0));
    int k = localaljw.jdField_a_of_type_Int;
    int m = localaljw.b;
    int n = localaljw.c;
    int i1 = localaljw.d / k;
    int i;
    if (m <= 0)
    {
      i = 0;
  ...
  {
    if ((jdField_a_of_type_Aljw == null) || (paramInt1 <= 1) || (paramInt1 > 15000)) {
      return;
    }
    switch (paramInt2)
    {
    default: 
      return;
    case 0: 
      localaljw = jdField_a_of_type_Aljw;
      localaljw.jdField_a_of_type_Int += 1;
      localaljw = jdField_a_of_type_Aljw;
      localaljw.d += paramInt1;
      return;
    case 1: 
      localaljw = jdField_a_of_type_Aljw;
      localaljw.b += 1;
      localaljw = jdField_a_of_type_Aljw;
      localaljw.e += paramInt1;
      return;
    }
    aljw localaljw = jdField_a_of_type_Aljw;
    localaljw.c += 1;
    localaljw = jdField_a_of_type_Aljw;
    localaljw.f += paramInt1;
  }
