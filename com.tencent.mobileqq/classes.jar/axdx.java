  ...
  implements Manager
{
  ...
  public axdx(QQAppInterface paramQQAppInterface)
  {
  ...
  public static Bitmap a(String paramString)
  {
    ...
    String str = beqz.d(paramString);
    Object localObject = new File(str);
    long l1 = SystemClock.uptimeMillis();
    localObject = new bihu(paramString, (File)localObject);
    ((bihu)localObject).n = true;
    ((bihu)localObject).b = 2;
    ((bihu)localObject).a = str;
    ((bihu)localObject).b(512);
    int i = bihw.a((bihu)localObject, null, null);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
      QLog.i("NewMsgNotificationManager", 2, "download cost " + (l2 - l1) + " result " + i + " key " + ((bihu)localObject).a + " iconUrl: " + paramString);
    }
    return SafeBitmapFactory.decodeFile(str);
  }
  
  public static axdx a(QQAppInterface paramQQAppInterface)
  {
    return (axdx)paramQQAppInterface.getManager(349);
  }
  ...
  {
    return antf.M.equals(paramString);
  }
  ...
  {
    Intent localIntent = bhnl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
  ...
  {
    this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new axdy(this, paramNotifyPushSettingActivity, paramFormSwitchItem1, paramFormSwitchItem2);
  ...
  {
    axea localaxea = new axea(this);
    axeb localaxeb = new axeb(this, paramBaseActivity);
    bhlq.a(paramBaseActivity, 230, null, paramBaseActivity.getString(2131693172), paramBaseActivity.getString(2131690580), paramBaseActivity.getString(2131693171), localaxeb, localaxea).show();
  }
  ...
  public void a(BaseActivity paramBaseActivity, TextView paramTextView)
  {
    ...
    String str = ((Resources)localObject).getString(2131694435);
    localObject = new SpannableString(str + "允许QQ通知" + ((Resources)localObject).getString(2131694436));
    ((SpannableString)localObject).setSpan(new axdz(this, paramBaseActivity), str.length(), (str + "允许QQ通知").length(), 17);
