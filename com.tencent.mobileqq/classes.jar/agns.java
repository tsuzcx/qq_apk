  ...
  extends Handler
{
  ...
  public agns(PhotoListActivity paramPhotoListActivity)
  {
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            localArrayList.addAll(((agnt)localObject).a);
            ...
            ((agnt)localObject).a(localArrayList);
            ((agnt)localObject).notifyDataSetChanged();
            return;
          ...
          if (PhotoListActivity.d((PhotoListActivity)localObject))
          {
            ...
            bcql.a((Context)localObject, String.format(((PhotoListActivity)localObject).getResources().getString(2131695100), new Object[] { Integer.valueOf(((PhotoListActivity)localObject).i) }), 0).a();
          }
          for (;;)
          {
            ...
            {
              bcql.a((Context)localObject, String.format(((PhotoListActivity)localObject).getResources().getString(2131695105), new Object[] { Integer.valueOf(i) }), 0).a();
            }
            else
            {
          ...
          bcql.a((Context)localObject, ((PhotoListActivity)localObject).getResources().getString(2131695104), 0).a();
          return;
        } while (!(paramMessage.obj instanceof String));
        paramMessage = (String)paramMessage.obj;
        if (((PhotoListActivity)localObject).c == null) {
