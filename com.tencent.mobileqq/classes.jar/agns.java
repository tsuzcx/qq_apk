  ...
  extends BaseBubbleBuilder
{
  ...
  public agns(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_b_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
  }
  
  private void a(agnt paramagnt)
  {
    if (paramagnt.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.isMixed)
    {
      Object localObject = paramagnt.jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
      if (((MessageForPic)localObject).msgtype == -1032)
      {
        paramagnt.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        return;
      }
      String str2 = this.jdField_a_of_type_AndroidContentContext.getString(2131719804);
      String str1;
      if (((MessageForPic)localObject).shareAppID != 0L)
      {
        localObject = bhch.a(((MessageForPic)localObject).shareAppID);
        ...
        if (localAppShareID != null)
        {
          ...
          if (localAppShareID.messagetail != null) {
            str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131690121) + localAppShareID.messagetail;
          }
        }
      }
      for (;;)
      {
        paramagnt.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramagnt.jdField_a_of_type_AndroidWidgetTextView.setText(str1);
        return;
        str1 = str2;
        if (!this.jdField_b_of_type_JavaUtilHashSet.contains(localObject))
        {
          ...
          if (((MessageForPic)localObject).msgtype == -3001) {
            str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131692042);
          }
        }
      }
    }
  ...
  {
    paramBaseChatItemLayout = (agnt)paramafqr;
    paramafqr = paramView;
    if (paramView == null)
    {
    ...
    if (!paramChatMessage.isSendFromLocal())
    {
      ...
      {
        paramChatMessage = ahcj.a(this.jdField_a_of_type_AndroidContentContext, paramChatMessage, paramBaseChatItemLayout.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        Object localObject = (agnt)AIOUtils.getHolder(paramView);
        MessageForPic localMessageForPic = (MessageForPic)((agnt)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        localObject = ((agnt)localObject).jdField_a_of_type_ComTencentImageURLDrawable;
