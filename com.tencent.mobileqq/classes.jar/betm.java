...
public class betm
{
  ...
  private List<betp> b = new ArrayList();
  ...
  private static File a()
  {
    if (jdField_a_of_type_JavaIoFile == null)
    {
      ...
      if ((!localFile.exists()) && (!localFile.mkdirs())) {
        betc.d("EngineInstaller", "[MiniEng] dir mk failed " + localFile);
      }
  ...
  private static String a(File paramFile, EngineVersion paramEngineVersion)
  {
    ...
    //   40: invokestatic 106	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   43: aload_0
    ...
    //   81: invokestatic 91	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   84: aconst_null
    //   85: astore_0
    //   86: ldc 2
    //   88: monitorexit
  ...
  private static List<InstalledEngine> a()
  {
    ...
    //   3: ldc 80
    //   5: ldc 144
    //   7: invokestatic 106	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   22: astore 7
    //   24: invokestatic 152	betm:a	()Ljava/io/File;
    //   27: astore 8
    //   29: aload 8
    ...
    //   231: aload 11
    //   233: invokestatic 187	bfgi:a	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   242: invokestatic 106	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   245: aload 10
    //   247: invokevirtual 104	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   250: iconst_0
    //   251: invokestatic 192	belh:a	(Ljava/lang/String;Z)V
    //   254: iload_1
    //   255: iconst_1
    //   256: iadd
    //   257: istore_1
    ...
    //   271: aload 11
    //   273: aload 11
    //   275: invokestatic 197	betm:a	(Lcom/tencent/qqmini/sdk/manager/InstalledEngine;)Z
    ...
    //   323: aload 11
    //   325: aload 10
    //   327: invokestatic 207	betm:a	(Ljava/io/File;)Z
    ...
    //   419: invokestatic 106	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   422: ldc 2
    //   424: monitorexit
    //   425: aload 7
    //   427: areturn
  ...
  private void a(float paramFloat, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      betp localbetp = (betp)localIterator.next();
      if (localbetp != null) {
        localbetp.a(paramFloat, paramString);
      }
    }
  }
  ...
  public static void a(int paramInt)
  {
    ...
    try
    {
      ...
      {
        betc.d("EngineInstaller", "[MiniEng]removeOldEngine null");
        return;
      }
      ArrayList localArrayList = new ArrayList();
    ...
    if ((j > 1) && (i < j))
    {
      ...
      {
        betc.b("EngineInstaller", "[MiniEng] removeOldEngine " + localObject2 + " isPersist, so not deleted");
      }
      else
      {
        if (paramInt == 0)
        ...
        betc.b("EngineInstaller", "[MiniEng] removeOldEngine " + localObject2 + "  is latest, so kept");
        break label226;
      }
    }
    for (;;)
  ...
  private void a(BaseLibInfo paramBaseLibInfo, String paramString, long paramLong, File paramFile, EngineVersion paramEngineVersion, boolean paramBoolean)
  {
    ...
    ((DownloaderProxy)ProxyManager.get(DownloaderProxy.class)).download(paramString, null, str, 60, new betn(this, paramString, paramBaseLibInfo, paramLong, paramFile, paramEngineVersion, paramBoolean));
  ...
  private static boolean a(InstalledEngine paramInstalledEngine)
  {
    ...
    betc.b("EngineInstaller", "[MiniEng]verifyEngine " + paramInstalledEngine.jdField_b_of_type_JavaLangString + " " + bool);
    return bool;
  }
    ...
    if (paramFile != null)
    {
      ...
      if (paramFile.exists())
      {
        ...
        if (paramFile.isDirectory())
        {
          ...
          {
            paramFile = paramFile.listFiles(new beto());
            if (paramFile != null)
            {
              bool1 = bool2;
  ...
  private boolean a(File paramFile, String paramString1, EngineVersion paramEngineVersion, String paramString2, boolean paramBoolean)
  {
    ...
    //   8: aload_1
    //   9: aload_3
    //   10: invokestatic 344	betm:a	(Ljava/io/File;Lcom/tencent/qqmini/sdk/manager/EngineVersion;)Ljava/lang/String;
    //   13: astore_1
    //   14: aload_1
    //   15: ifnonnull +26 -> 41
    //   18: aload_0
    //   19: invokespecial 265	betm:d	()V
    //   22: aload 4
    //   24: iconst_1
    //   25: invokestatic 192	belh:a	(Ljava/lang/String;Z)V
    //   28: aload_0
    //   29: invokespecial 265	betm:d	()V
    //   32: iload 9
    //   34: istore 7
    //   36: aload_0
    //   37: monitorexit
    ...
    //   55: aload_1
    //   56: iconst_0
    //   57: invokestatic 192	belh:a	(Ljava/lang/String;Z)V
    //   60: aload_0
    //   61: fconst_1
    //   62: ldc_w 346
    //   65: invokespecial 267	betm:a	(FLjava/lang/String;)V
    //   68: aload 4
    //   70: aload_1
    //   71: invokestatic 351	bemb:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   74: istore 6
    //   76: iload 6
    //   78: ifne +325 -> 403
    //   81: ldc2_w 352
    ...
    //   88: fconst_1
    //   89: ldc_w 361
    //   92: invokespecial 267	betm:a	(FLjava/lang/String;)V
    //   95: ldc2_w 352
    //   98: invokestatic 359	java/lang/Thread:sleep	(J)V
    //   101: aload_0
    //   102: aload 4
    //   104: aload_1
    //   105: invokespecial 364	betm:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   108: istore 8
    //   110: iload 6
    //   112: ifne +101 -> 213
    //   115: iload 8
    ...
    //   162: invokestatic 106	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   165: invokestatic 111	betm:a	()V
    //   168: iconst_1
    //   169: istore 7
    //   171: aload 4
    //   173: iconst_1
    //   174: invokestatic 192	belh:a	(Ljava/lang/String;Z)V
    //   177: iload 7
    //   179: ifeq +22 -> 201
    //   182: iload 5
    //   184: ifeq +194 -> 378
    ...
    //   188: fconst_1
    //   189: ldc_w 372
    //   192: invokespecial 267	betm:a	(FLjava/lang/String;)V
    //   195: ldc2_w 352
    //   198: invokestatic 359	java/lang/Thread:sleep	(J)V
    //   201: aload_0
    //   202: invokespecial 265	betm:d	()V
    //   205: goto -169 -> 36
    //   208: astore_1
    //   209: aload_0
    //   210: monitorexit
    ...
    //   255: invokestatic 106	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   258: aload_1
    //   259: iconst_0
    //   260: invokestatic 192	belh:a	(Ljava/lang/String;Z)V
    //   263: iload 6
    //   265: ifeq +76 -> 341
    //   268: aload_0
    //   269: fconst_0
    //   270: ldc_w 376
    //   273: invokespecial 267	betm:a	(FLjava/lang/String;)V
    //   276: iload 10
    //   278: istore 7
    //   280: goto -109 -> 171
    //   283: astore_1
    ...
    //   303: aload_1
    //   304: invokestatic 187	bfgi:a	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   313: invokestatic 91	betc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   316: aload_0
    //   317: fconst_0
    //   318: ldc_w 380
    //   321: invokespecial 267	betm:a	(FLjava/lang/String;)V
    //   324: aload 4
    //   326: iconst_1
    //   327: invokestatic 192	belh:a	(Ljava/lang/String;Z)V
    //   330: aload_0
    //   331: invokespecial 265	betm:d	()V
    //   334: iload 9
    //   336: istore 7
    //   338: goto -302 -> 36
    //   341: iload 10
    ...
    //   351: fconst_0
    //   352: ldc_w 382
    //   355: invokespecial 267	betm:a	(FLjava/lang/String;)V
    //   358: iload 10
    //   360: istore 7
    //   362: goto -191 -> 171
    //   365: astore_1
    //   366: aload 4
    //   368: iconst_1
    //   369: invokestatic 192	belh:a	(Ljava/lang/String;Z)V
    //   372: aload_0
    //   373: invokespecial 265	betm:d	()V
    //   376: aload_1
    //   377: athrow
    //   378: aload_0
    //   379: fconst_1
    //   380: ldc_w 384
    //   383: invokespecial 267	betm:a	(FLjava/lang/String;)V
    //   386: goto -191 -> 195
    //   389: astore 11
    //   391: goto -304 -> 87
    //   394: astore 11
  ...
  {
    long l1 = bemb.a(paramString1);
    if (l1 <= 0L)
    {
      betc.d("EngineInstaller", "[MiniEng] getUncompressedFileSize error " + paramString1 + ", sz=" + l1);
      return false;
    }
    long l2 = bfhm.a(paramString2);
    if (l2 <= 0L)
    {
      betc.d("EngineInstaller", "[MiniEng] getDirUsedSpace error " + paramString2 + ", sz2=" + l2);
      return false;
    }
    if (l1 == l2)
    {
    ...
    betc.d("EngineInstaller", "[MiniEng] verifyBaselib failed sz1=" + l1 + ", sz2=" + l2);
    return false;
  }
  ...
  public static void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (jdField_a_of_type_JavaUtilList == null)
        {
          betc.d("EngineInstaller", "[MiniEng]removeOutDatedEngine null");
          return;
        }
      ...
      for (EngineVersion localEngineVersion = beus.a().jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion;; localEngineVersion = null)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            betc.b("EngineInstaller", "[MiniEng] removeOutDatedEngine " + localInstalledEngine + " localMinVer:" + localEngineVersion + ",engineType:" + paramInt);
          ...
          {
            betc.b("EngineInstaller", "[MiniEng] removeOutDatedPersistEngine " + localInstalledEngine + " localMinVer:" + localEngineVersion + ",engineType:" + paramInt);
            localInstalledEngine.a();
            jdField_a_of_type_JavaUtilList.remove(localInstalledEngine);
          }
        }
  ...
  private static boolean b(File paramFile)
  {
    ...
    return (localEngineVersion != null) && (localEngineVersion.equals(beus.a().jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion)) && (a(paramFile));
  }
  ...
  public void a(BaseLibInfo paramBaseLibInfo, betp parambetp)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        betc.c("EngineInstaller", "[MiniEng] invalid BaseLibInfo " + paramBaseLibInfo);
        b();
      }
      finally
      {
        try
        {
          ...
          betc.c("EngineInstaller", "[MiniEng] installWithCallback " + paramBaseLibInfo);
          if (a() != null) {
            break label242;
          }
          betc.c("EngineInstaller", "[MiniEng] shared preference not supported");
          b();
        }
        catch (Exception parambetp)
        {
          betc.c("EngineInstaller", "[MiniEng] refuse installEngine " + paramBaseLibInfo.baseLibDesc + ":" + paramBaseLibInfo.baseLibVersion + paramBaseLibInfo.baseLibUrl + bfgi.a(parambetp));
          b();
        }
      ...
      {
        betc.d("EngineInstaller", "[MiniEng] empty engine url");
        b();
      }
      else if (a())
      {
        betc.b("EngineInstaller", "[MiniEng] downloading already in progress");
        b();
      }
      else
      {
        bool1 = false;
        betc.b("EngineInstaller", "[MiniEng] installWithCallback callback=" + parambetp);
        if ((paramBaseLibInfo.baseLibType == 2) && (!beus.a().a()) && (!paramBaseLibInfo.baseLibUrl.startsWith("assets://")))
        {
          parambetp = beus.a().jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion;
          if (parambetp.a(localEngineVersion) >= 0)
          {
            betc.b("EngineInstaller", "[MiniEng] refuse install remote baselib:" + localEngineVersion + ",local:" + parambetp);
            b();
            continue;
          }
        }
        parambetp = a(paramBaseLibInfo.baseLibType);
        betc.b("EngineInstaller", "[MiniEng] engineForType " + paramBaseLibInfo.baseLibType + ", size=" + parambetp.size());
        if (parambetp.size() <= 0) {
          break;
        }
        parambetp = (InstalledEngine)parambetp.get(0);
        betc.b("EngineInstaller", "[MiniEng]latest engine for type " + paramBaseLibInfo.baseLibType + "," + parambetp);
        if (parambetp.jdField_a_of_type_ComTencentQqminiSdkManagerEngineVersion.a(localEngineVersion) < 0) {
          break label1100;
        }
        betc.b("EngineInstaller", "[MiniEng]engine type " + paramBaseLibInfo.baseLibType + " has no update, remote:" + localEngineVersion + ",latest:" + parambetp);
        b();
      }
    }
    for (;;)
    {
      for (;;)
      {
        ...
        for (;;)
        {
          betc.b("EngineInstaller", "[MiniEng] installEngine " + (String)localObject);
          if ((localFile.exists()) || (localFile.mkdirs())) {
            break label739;
          }
          betc.b("EngineInstaller", "[MiniEng] mkdir failed, is disk writable? " + localFile.getAbsolutePath());
          d();
          break;
        ...
        try
        {
          ...
          betc.b("EngineInstaller", "[MiniEng] installLocalEngine start url=" + (String)localObject + ",installBasePath=" + paramBaseLibInfo);
          if (TextUtils.isEmpty(paramBaseLibInfo))
          {
            a(0.0F, "本地引擎安装失败, 目录为空");
            betc.d("EngineInstaller", "[MiniEng] installLocalEngine failed installBasePath=" + paramBaseLibInfo);
            d();
            break;
          }
        }
      ...
      if ((!((File)localObject).exists()) && (!((File)localObject).mkdir()))
      {
        ...
        betc.d("EngineInstaller", "[MiniEng] installLocalEngine failed targetPath=" + localObject);
        d();
        break;
      }
      bete.a().a();
      betc.b("EngineInstaller", "[MiniEng] installLocalEngine finish copied " + parambetp[0] + "<>" + l);
      if ((parambetp[0] == l) || (l < 0L))
      {
  ...
  public void b(betp parambetp)
  {
    try
    {
      this.b.remove(parambetp);
      return;
    }
    finally
    {
