...
public class akix
{
  ...
  private SurfaceHolder.Callback jdField_a_of_type_AndroidViewSurfaceHolder$Callback = new akiy(this);
  public SurfaceView a;
  
  public akix(Context paramContext, int paramInt)
  {
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = alcm.a(this.jdField_a_of_type_AndroidContentContext).a();
