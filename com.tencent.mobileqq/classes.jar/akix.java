  ...
  extends ajtb
{
  ...
  public akix(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      awml localawml = new awml(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localArrayList2.add(new awmm(localHotWordItem.word_id.get().toStringUtf8(), localHotWordItem.word.get().toStringUtf8()));
      }
      awhn.a.put(awhn.a(localawml.a), localArrayList2);
      ...
      localObject1 = new awmk((String)localObject1, (String)localObject2);
      awhn.b.put(awhn.a(localawml.a), localObject2);
      localArrayList1.add(new BusinessGroupWord(localawml, localArrayList2, (awmk)localObject1));
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          localawky.jdField_a_of_type_JavaLangString = localAssociationItem.word.get().toStringUtf8();
          localawky.jdField_b_of_type_JavaLangString = localAssociationItem.sub_word.get().toStringUtf8();
          localawky.d = localAssociationItem.pic_url.get().toStringUtf8();
          localawky.jdField_c_of_type_JavaLangString = localAssociationItem.jmp_url.get().toStringUtf8();
          localawky.jdField_b_of_type_Int = localAssociationItem.type.get();
          localawky.jdField_c_of_type_Int = localAssociationItem.group_mask.get();
          localArrayList.add(localawky);
          continue;
        }
  ...
  private void a(String paramString1, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    new axrc(this.app).a("dc00899").b("grp_search_engineer").c("search_net").d(paramString1).a(new String[] { paramLong2 + "", "" + (l - paramLong1), "" + paramString2, vei.a(null) }).a();
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        awwa.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new awoc((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bbkb.s(BaseApplicationImpl.getContext(), i);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (((UnifyTabSearch.RspBody)localObject1).search_ver.has()) {
          awwa.a("UnifySearch.Tab", arrayOfLong, ((UnifyTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
        ...
        Object localObject3 = new awqh();
        if (bool2) {
          ((awqh)localObject3).a(true);
        }
        paramToServiceMsg = ((awqh)localObject3).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public List<awoh> a(Object... paramVarArgs)
  {
    ...
    label193:
    for (boolean bool1 = awvx.b(i);; bool1 = true)
    {
  ...
  public void a()
  {
    ...
    localReqBody.version.set(ByteStringMicro.copyFromUtf8("8.3.0"));
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bbkb.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(awwa.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = bbkb.b(this.app.getCurrentAccountUin());
        ...
        paramList2.extraData.putLongArray("masks", awiw.a(paramList1));
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (awhn.a.isEmpty())
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (!bool) {
              awwa.a("sub_result", "active_search", new String[] { paramString1, awwa.a(paramList1), "" + paramInt1, "" });
            }
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = awhn.a.values().iterator();
        paramInt1 = 2;
      }
      label566:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((awmm)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<awoh> paramList)
  {
    ...
    {
      localObject1 = new awpo(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((awpo)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((awpo)localObject1).c(null);
      ((awpo)localObject1).a(bool2);
      if ((localObject1 != null) && (((awor)localObject1).b()))
      {
        ((awor)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((awor)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        default: 
          break;
        case 2: 
          localObject1 = new awop(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 3: 
          localObject1 = new awpl(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 4: 
          localObject1 = new awoq(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 7: 
          localObject1 = new awoy(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 6: 
          localObject1 = new awph(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 8: 
        ...
        case 9: 
          ...
          break;
        case 11: 
          localObject1 = new awov(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 12: 
        ...
        case 13: 
          ...
          break;
        case 14: 
          localObject1 = new awpg(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 15: 
        ...
        case 18: 
          ...
          {
            localObject1 = new awpr(paramString, str7, -4, str5);
            ((awpr)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            localArrayList2.add(localObject1);
            l2 = l1;
          }
          else
          {
            localObject1 = new awng(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
            l2 = l1;
            if (localObject1 != null)
            {
              ((awng)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
              ((awng)localObject1).c = bool1;
              ((awng)localObject1).g = i;
              ((awng)localObject1).a = paramInt;
              localArrayList2.add(localObject1);
              l2 = l1;
            }
          }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new awob(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label1262:
      paramList.add(new awnf(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  {
    return bbdx.a(BaseApplication.getContext().getFileStreamPath(paramString));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bbkb.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = awpp.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
