...
public class abss
  extends BaseAdapter
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new abst(this);
  List<ProfileLabelInfo> jdField_a_of_type_JavaUtilList;
  
  public abss(List<ProfileLabelInfo> paramList)
  {
    Object localObject;
  ...
  private void a(ProfileLabelInfo paramProfileLabelInfo)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzr.a().keySet().iterator();
    ...
    {
      break;
      if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzr.a(localObject)))
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzr.c(localObject, this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzr.a(localObject));
        return;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.getLayoutInflater().inflate(2131562487, null);
      ...
      paramViewGroup = new absr();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376838));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (absr)paramView.getTag();
    }
  }
}
