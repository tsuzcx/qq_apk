  ...
  implements View.OnClickListener
{
  ...
  public awzk(BaseChatPie paramBaseChatPie)
  {
  ...
  {
    bgot localbgot = (bgot)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a.getManager(223);
    if ((localbgot != null) && (localbgot.a != 1)) {
      localbgot.e();
    }
  ...
  public void a(Emoticon paramEmoticon, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_Awzg != null) && (((View)this.jdField_a_of_type_Awzg).getVisibility() == 0))
    {
      ...
      if (this.jdField_a_of_type_Awzp != null)
      {
        ...
        this.jdField_a_of_type_Awzp = null;
      }
    }
    do
    {
      do
      {
        ...
        {
          return;
          if ((this.jdField_b_of_type_Awzg == null) || (((View)this.jdField_b_of_type_Awzg).getVisibility() != 0)) {
            break;
          }
          if (QLog.isColorLevel()) {
            QLog.d("MagicfaceViewController", 2, "func playMaigcface ends, step 2.");
          }
        } while (this.jdField_a_of_type_Awzp == null);
        this.jdField_a_of_type_Awzp.a();
        this.jdField_a_of_type_Awzp = null;
        return;
        if ((this.jdField_a_of_type_Awyt == null) || (!this.jdField_a_of_type_Awyt.a())) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_Awyb = awyt.a(paramEmoticon, paramInt1, paramInt2);
    ...
    b();
    this.jdField_a_of_type_Awyt = new awyt(this);
    Object localObject2;
    Object localObject1;
    Object localObject3;
    if (paramInt1 == 0)
    {
      ...
      ((View)this.jdField_b_of_type_Awzg).setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setVisibility(0);
      localObject2 = this.jdField_a_of_type_Awzg;
      localObject1 = this.jdField_a_of_type_AndroidWidgetTextView;
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setMagicfaceGestureListener(this.jdField_a_of_type_Awyt);
    ...
    for (;;)
    {
      ...
      localObject3 = new awzb();
      ((awzb)localObject3).a((awyn)localObject2);
      this.jdField_a_of_type_Awyt.a((awzb)localObject3);
      this.jdField_a_of_type_Awyt.a(new awzm(this, paramInt1, (TextView)localObject1));
      this.jdField_a_of_type_Awyt.a(new awzn(this, l, paramInt1));
      if (!((awzg)localObject2).a()) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.d("MagicfaceViewController", 2, "func playMaigcface ends, step 7.");
      }
      this.jdField_a_of_type_Awyt.a(paramEmoticon, paramInt1, paramString, paramInt2);
      return;
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.updateViewLayout((View)this.jdField_b_of_type_Awzg, (ViewGroup.LayoutParams)localObject2);
      ...
      this.jdField_b_of_type_Awzg.setIsFullScreen(this.jdField_a_of_type_Awyb.jdField_b_of_type_Boolean);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      localObject2 = this.jdField_b_of_type_Awzg;
      localObject1 = this.jdField_c_of_type_AndroidWidgetTextView;
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setMagicfaceGestureListener(this.jdField_a_of_type_Awyt);
    ...
    ((awzg)localObject2).setSurfaceCreatelistener(new awzo(this, paramEmoticon, paramInt1, paramString, paramInt2));
  }
  
  public void a(Emoticon paramEmoticon, awzp paramawzp)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MagicfaceViewController", 2, "func magicfaceAutoPlay, magicValue:" + paramEmoticon.magicValue);
    }
    this.jdField_a_of_type_Awzp = paramawzp;
    if (!a())
    {
      if (this.jdField_a_of_type_Awzp != null)
      {
    ...
    {
      return;
      paramawzp = new Emoticon();
      paramawzp.eId = paramEmoticon.eId;
      paramawzp.epId = paramEmoticon.epId;
      paramawzp.magicValue = paramEmoticon.magicValue;
      paramawzp.jobType = paramEmoticon.jobType;
      this.jdField_a_of_type_ComTencentMobileqqDataEmoticon = paramawzp;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView == null)
    {
      ...
      {
        localView = View.inflate(BaseApplicationImpl.getContext(), 2131562018, null);
        this.jdField_a_of_type_Awzg = ((awzg)localView.findViewById(2131370539));
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131370540));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370553));
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370541));
        this.jdField_b_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131370550));
        this.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131370538));
        this.jdField_d_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131370551));
        this.e = ((Button)localView.findViewById(2131370552));
    ...
    for (View localView = View.inflate(BaseApplicationImpl.getContext(), 2131562017, null);; localView = View.inflate(BaseApplicationImpl.getContext(), 2131562019, null))
    {
      ...
      this.jdField_b_of_type_Awzg = ((awzg)localView.findViewById(2131370542));
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131370544));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370548));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370546));
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131370543));
      this.f = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131370545));
      ...
      return;
      localView = View.inflate(BaseApplicationImpl.getContext(), 2131562020, null);
      break;
    }
  }
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Awyt != null) && ((this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.getVisibility() != 8) || (this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.getVisibility() != 8)))
    {
      g();
      return true;
    }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Awyt.b())
    {
      this.e.setBackgroundResource(2130847185);
      return;
    }
    this.e.setBackgroundResource(2130847184);
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Awyt.c())
    {
      this.f.setBackgroundResource(2130847134);
      return;
    }
    this.f.setBackgroundResource(2130847182);
  }
  ...
  public void f()
  {
    ...
    if ((this.jdField_a_of_type_Awyt != null) && (this.jdField_a_of_type_Awyt.a() >= 0)) {
      if (this.jdField_a_of_type_Awyt.a() != 0) {
        break label83;
      }
    }
    label83:
    for (localEmoticon.magicValue = "value=1";; localEmoticon.magicValue = ("value=" + this.jdField_a_of_type_Awyt.a()))
    {
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Awyt != null)
    {
      ...
      ((View)this.jdField_b_of_type_Awzg).setVisibility(8);
      this.jdField_b_of_type_Awzg.setSurfaceCreatelistener(null);
    }
    try
    {
      if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_Awyt.a())
    {
      localObject = this.jdField_a_of_type_Awyt;
      ((awyt)localObject).a(new awzl(this, (awyt)localObject));
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Awzp != null)
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131370551: 
      for (;;)
      {
        ...
        return;
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbFasong", "MbGuanbi", 0, 0, this.jdField_a_of_type_JavaLangString, "", "", "");
        g();
        continue;
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbJieshou", "MbZhudongGuanbi", 0, 0, this.jdField_a_of_type_JavaLangString, "", "", "");
        g();
        continue;
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbFasong", "MbChongzuo", 0, 0, this.jdField_a_of_type_JavaLangString, "", "", "");
        if (this.jdField_a_of_type_Awyt != null)
        {
          this.jdField_a_of_type_Awyt.f();
    ...
    case 2131370552: 
      bool3 = this.jdField_a_of_type_Awyt.b();
      localawyt = this.jdField_a_of_type_Awyt;
      if (!bool3)
      {
        bool1 = true;
        label275:
      ...
      for (bool1 = bool2;; bool1 = false)
      {
        ...
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbFasong", "MbKaiqiShengxiao", 0, 0, "", "", "", "");
        break;
        bool1 = false;
        break label275;
      }
    }
    bool2 = this.jdField_a_of_type_Awyt.c();
    awyt localawyt = this.jdField_a_of_type_Awyt;
    if (!bool2)
    {
      bool1 = true;
      label381:
    ...
    for (boolean bool1 = bool3;; bool1 = false)
    {
      ...
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbJieshou", "MbKaiqiShengxiao2", 0, 0, "", "", "", "");
      break;
      bool1 = false;
      break label381;
    }
