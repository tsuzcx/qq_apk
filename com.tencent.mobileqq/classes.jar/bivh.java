...
public class bivh
{
  ...
  private Intent a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramActivity == null)
      {
        ...
        paramBundle.putExtras(biup.a(paramBundle, 1));
      }
    ...
    str1 = bdcb.a(paramActivity).a;
    String str2 = bixj.a(paramActivity);
    if (l2 != 0L) {}
    for (paramBundle = String.valueOf(l2);; paramBundle = "")
    {
      bixh.a(str1, str2, "2198", paramBundle, "2", "");
      paramActivity = a(paramActivity);
  ...
  private View a()
  {
    ...
    localTextView.setText(2131694095);
    localTextView.setTextColor(-16777216);
    localTextView.setGravity(17);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(13);
    localTextView.setPadding(0, bcwh.a(this.jdField_a_of_type_AndroidAppActivity, 120.0F), 0, 0);
    localRelativeLayout.addView(localTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = localTextView;
    bivp.a().a(this.jdField_a_of_type_AndroidAppActivity, localImageView);
  ...
  {
    boolean bool = biwm.a();
    bixe.e("ReaderSplashImpl", "jumpToPlugin: isUseShadow = " + bool);
    if (bool)
    {
      biwm.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, "com.qqreader.pureader.SSReaderActivity", new bivk(this));
      return;
    }
  ...
  private void a(View paramView)
  {
    ...
    {
      bixe.a("ReaderSplashImpl", "showLoadingView: mContentView == null");
      return;
    }
  ...
  private void a(JsCallParams paramJsCallParams)
  {
    if (biuv.a().a())
    {
      ReaderJsPluginProxy localReaderJsPluginProxy = biuv.a().a(new bivj(this));
      ...
      for (;;)
      {
        d();
        return;
        bixe.a("ReaderSplashImpl", "checkPluginForHandleSpecialJsCall: plugin is ready but jsPluginProxy is null");
      }
    }
  ...
  private void b(@NonNull Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidAppActivity == null) {
      bixe.a("ReaderSplashImpl", "doJump: activity is null");
    }
    Intent localIntent;
    do
    {
    ...
    localIntent.putExtra("login_interval", bixj.a(BaseApplicationImpl.getApplication()));
  ...
  private void c()
  {
    ...
    {
      bixe.a("ReaderSplashImpl", "handlePendingJumpPluginIntent: mPendingJumpPluginIntent == null");
      return;
    }
    ...
    {
      bixe.b("ReaderSplashImpl", "handlePendingJumpPluginIntent: activity is destroyed");
      return;
    }
    biup.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentIntent, "com.qqreader.pureader.SSReaderActivity", new bivl(this));
  ...
  public void a()
  {
    bixe.d("ReaderSplashImpl", "onCreate");
    Object localObject = new IntentFilter();
    ((IntentFilter)localObject).addAction("cooperation.qqreader.start_reader_act_completed");
    if (this.jdField_a_of_type_Bivm == null)
    {
      this.jdField_a_of_type_Bivm = new bivm(this, null);
      this.jdField_a_of_type_AndroidAppActivity.registerReceiver(this.jdField_a_of_type_Bivm, (IntentFilter)localObject);
    }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bivm != null)
    {
      this.jdField_a_of_type_AndroidAppActivity.unregisterReceiver(this.jdField_a_of_type_Bivm);
      this.jdField_a_of_type_Bivm = null;
    }
  }
}
