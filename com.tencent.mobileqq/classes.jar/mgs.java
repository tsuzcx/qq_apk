  ...
  extends BaseAdapter
{
  ...
  public mgs(AppInterface paramAppInterface, Context paramContext, ArrayList<mhr> paramArrayList, HorizontalListView paramHorizontalListView)
  {
    this(paramAppInterface, paramContext, paramArrayList, paramHorizontalListView, 6.25F);
  }
  
  public mgs(AppInterface paramAppInterface, Context paramContext, ArrayList<mhr> paramArrayList, HorizontalListView paramHorizontalListView, float paramFloat)
  {
    ...
    jdField_c_of_type_Int = jdField_a_of_type_Int + actj.a(30.0F, this.jdField_a_of_type_AndroidContentResResources);
    ...
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.addOnLayoutChangeListener(new mgt(this));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnScrollStateChangedListener(new mgu(this));
  ...
  void a(View paramView, mhr parammhr)
  {
    if (paramView == null) {}
    View localView;
    do
    {
      return;
      localView = paramView.findViewById(2131372252);
      if (parammhr == null) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (paramView == null)
      {
        ...
        paramViewGroup.setId(Integer.valueOf(localmhr.jdField_a_of_type_JavaLangString).intValue());
    ...
    for (;;)
    {
      paramView.a(paramInt, bool, this.jdField_b_of_type_Boolean, localmhr, this.jdField_a_of_type_Mhp);
      a(paramView, localmhr);
      return paramView;
      ...
      if (this.jdField_a_of_type_Float < 6.0F)
      {
        paramViewGroup = paramView.findViewById(2131372416);
