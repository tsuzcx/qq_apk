  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView.getTag() instanceof PicInfo))
    {
      ...
      localPicInfo.c = this.a.a.app.a(32, String.valueOf(atpi.a(this.a).uin), 200);
      if (QLog.isColorLevel()) {
        QLog.e("Q.nearby_people_card.", 2, "on mode guest small head clicked: uin is: " + atpi.a(this.a).uin + " local path is: " + localPicInfo.c);
      }
      ...
      if (ProfileActivity.c(this.a.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.h)) {
        axqw.b(this.a.a.app, "CliOper", "", "", "0X8005240", "0X8005240", 0, 0, "", "", "", "");
      }
    }
    return;
    label189:
    ...
    if (i < this.a.a.jdField_a_of_type_JavaUtilArrayList.size()) {
      if (atpi.a(this.a).nowUserType == 0)
      {
