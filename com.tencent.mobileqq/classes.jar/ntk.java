  ...
  implements osg
{
  ...
  private ViewPager.OnPageChangeListener jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new ntq(this);
  private View jdField_a_of_type_AndroidViewView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private bfrx jdField_a_of_type_Bfrx;
  ...
  private Map<Integer, qar> jdField_a_of_type_JavaUtilMap = new HashMap();
  private nss jdField_a_of_type_Nss;
  private ntr jdField_a_of_type_Ntr;
  private osj jdField_a_of_type_Osj;
  private osp jdField_a_of_type_Osp = new ntp(this);
  private oti jdField_a_of_type_Oti = new nto(this);
  ...
  static
  {
    ...
    jdField_b_of_type_Int = bbkx.b(0.0F);
    jdField_c_of_type_Int = bbkx.b(0.0F);
    jdField_a_of_type_Long = bhvh.g(onk.a());
  }
  
  public ntk(Context paramContext, View paramView, ReadInJoyChannelViewPager paramReadInJoyChannelViewPager)
  {
    ...
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout = ((TabLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131376823));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368624));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131368674));
  ...
  public static void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      paramString = new onr().b().f().a(paramInt1).b(paramInt2 + 1).d(paramString);
      if (paramInt1 == 41695)
      {
        localObject = osj.a().a();
        if (localObject != null)
  ...
  private void a(View paramView1, View paramView2)
  {
    ...
    paramView1 = (TextView)paramView1.findViewById(2131378378);
    paramView2 = (TextView)paramView2.findViewById(2131378378);
    a(paramView1);
    b(paramView2);
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    noo.a(null, "", paramString1, paramString1, 0, 0, paramString2, "", "", paramString3, false);
  }
  ...
  private void a(List<TabChannelCoverInfo> paramList)
  {
    ...
    if (this.jdField_a_of_type_Ntr != null)
    {
      ...
      this.jdField_a_of_type_Ntr.a(paramList);
    }
  ...
  private void a(Map<Integer, qar> paramMap)
  {
    if (paramMap != null)
    {
      ...
      if (paramMap.hasNext())
      {
        ...
        int j = oes.jdField_b_of_type_Int;
        ...
        for (int i = localqar.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo.redPoint.jdField_a_of_type_Int + 1;; i = 0)
        {
          oes.a("0X8009495", localTabChannelCoverInfo, j, i, localqar.l);
          break;
        }
      }
    }
  ...
  private void b(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    KandianSubscribeManager localKandianSubscribeManager = (KandianSubscribeManager)onk.a().getManager(280);
    qdj localqdj = new qdj();
    localqdj.jdField_a_of_type_Long = 0L;
    localqdj.b = 9223372036854775807L;
    localqdj.jdField_a_of_type_Boolean = localKandianSubscribeManager.a();
    paramTabChannelCoverInfo.redPoint = localqdj;
    a(paramTabChannelCoverInfo);
  }
  
  private void b(List<TabChannelCoverInfo> paramList)
  {
    List localList = this.jdField_a_of_type_Osj.a();
    if ((localList != null) && (localList.size() > 0))
    {
      ((qat)localList.get(0)).jdField_a_of_type_JavaUtilList = paramList;
      this.jdField_a_of_type_Osj.a(localList, 1, true);
    }
  ...
  private int d()
  {
    List localList = this.jdField_a_of_type_Osj.b();
    int k;
    if ((localList == null) || (localList.size() == 0))
    {
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_Rfl = new rfl(this.jdField_b_of_type_AndroidViewView.getContext(), this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentBizWidgetsTabLayout, this);
    this.jdField_a_of_type_JavaUtilMap.clear();
    this.jdField_a_of_type_Rfl.a(this.jdField_a_of_type_JavaUtilMap);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.setAdapter(this.jdField_a_of_type_Rfl);
    ...
    otd.a(this.jdField_a_of_type_Oti);
  }
  ...
  private void h()
  {
    Object localObject = (oso)onk.a().getManager(163);
    List localList;
    if (localObject != null)
    {
  ...
  {
    if (oot.a()) {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848419);
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Nss != null) {
        this.jdField_a_of_type_Nss.d();
      }
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842370);
    }
  }
  
  private void j()
  {
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new ntl(this));
  }
  ...
  private void m()
  {
    ...
    int k = (int)(bbct.m() - i) / 2 - bbkx.a(12.0F);
    i = 200;
    ...
    if (this.jdField_a_of_type_Bfrx == null) {
      this.jdField_a_of_type_Bfrx = new ntn(this);
    }
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.setOnScrollStateChangedListener(this.jdField_a_of_type_Bfrx);
  ...
  private void p()
  {
    ...
    {
      KandianMergeManager localKandianMergeManager = (KandianMergeManager)onk.a().getManager(162);
  ...
  public void A_()
  {
    ...
    qdj localqdj = new qdj();
    localqdj.jdField_a_of_type_Boolean = true;
    localqdj.jdField_a_of_type_Long = 0L;
    localqdj.b = 9223372036854775807L;
    localTabChannelCoverInfo.redPoint = localqdj;
    a(localTabChannelCoverInfo);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.a();
  }
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      localObject = new onr().a("source", "302").a(((TabChannelCoverInfo)localObject).mChannelCoverId);
      if (!nss.a()) {
        break label374;
      }
      i = 1;
    ...
    catch (JSONException localJSONException1)
    {
      try
      {
        for (;;)
        {
          a("0X8009665", "", onk.a().a(((TabChannelCoverInfo)localObject).mChannelCoverId).m(ReadInJoyChannelPanelFragment.a((ChannelCoverInfo)localObject)).n(ReadInJoyChannelPanelFragment.a((TabChannelCoverInfo)localObject)).a());
          bool = bhvh.y();
          if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_JavaUtilList.size())) {
            break label427;
          }
    ...
    a("0X8009B94", "", ((onr)localObject).b("style", i).a());
    if (b() == paramInt)
    {
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = (oso)onk.a().getManager(163);
      } while (localObject == null);
      localObject = ((oso)localObject).a();
    } while (localObject == null);
    if (onk.i())
    {
      ((osj)localObject).a(paramTabChannelCoverInfo);
      return;
    }
    onk.b().post(new ReadInJoyChannelViewPagerController.3(this, (osj)localObject, paramTabChannelCoverInfo));
  }
  
  public void a(nss paramnss)
  {
    this.jdField_a_of_type_Nss = paramnss;
  }
  
  public void a(ntr paramntr)
  {
    if (paramntr != null) {
      paramntr.a(a(this.jdField_a_of_type_JavaUtilList));
    }
    this.jdField_a_of_type_Ntr = paramntr;
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (i > 0)
      {
        ...
        this.jdField_a_of_type_Osj.a(localTabChannelCoverInfo.mChannelCoverId, 5, false, false);
        i -= 1;
      }
      this.jdField_a_of_type_Rfl.notifyDataSetChanged();
    }
