...
class biyv
{
  ...
  private final Class<? extends bifz> jdField_a_of_type_JavaLangClass;
  private Set<Integer> jdField_a_of_type_JavaUtilSet = new HashSet();
  private final int b;
  private final int c;
  
  private biyv(int paramInt1, int paramInt2, int paramInt3, Class<? extends bifz> paramClass)
  {
  ...
  static biyv a(int paramInt1, int paramInt2, int paramInt3, Class<? extends bifz> paramClass)
  {
    return new biyv(paramInt1, paramInt2, paramInt3, paramClass);
  }
  
  Class<? extends bifz> a()
  {
