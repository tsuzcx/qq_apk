...
public class sbw
{
  ...
  static ArrayList<scg> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  static boolean jdField_a_of_type_Boolean;
  private static int b;
  private Activity jdField_a_of_type_AndroidAppActivity;
  protected behi a;
  
  public sbw(Activity paramActivity, ArrayList<scg> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_Behi = new sbx(this);
  ...
  static int a()
  {
    ...
    int j = (jdField_a_of_type_Int - aciy.a(110.0F, jdField_a_of_type_AndroidContentContext.getResources())) / 3;
    if (i % 2 == 0) {
      return i / 2 * j;
    }
    return (i + 1) / 2 * j;
  ...
  private ArrayList<scg> a(ArrayList<scg> paramArrayList)
  {
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    int i = aciy.a(2.0F, jdField_a_of_type_AndroidContentContext.getResources());
    int j = (b - i) / 2;
    paramRelativeLayout = (GridView)paramRelativeLayout.findViewById(2131309202);
    ...
    paramRelativeLayout.setOnItemClickListener(this.jdField_a_of_type_Behi);
    if (Build.VERSION.SDK_INT >= 9) {
      paramRelativeLayout.setOverScrollMode(2);
    }
    paramRelativeLayout.setAdapter(new sby(this));
  }
  ...
  public View a(Activity paramActivity, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if ((localObject != null) && ((localObject instanceof sca)))
      {
    ...
    paramActivity = (RelativeLayout)LayoutInflater.from(paramActivity).inflate(2131493841, paramViewGroup, false);
    paramView = paramActivity.getLayoutParams();
    paramView.height = jdField_a_of_type_Int;
    paramActivity.setLayoutParams(paramView);
    paramView = new sca();
    paramView.jdField_a_of_type_ComTencentWidgetGridView = ((GridView)paramActivity.findViewById(2131309202));
    paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramActivity.findViewById(2131304145));
    paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramActivity.findViewById(2131309189));
    ...
    if ((jdField_a_of_type_JavaUtilArrayList == null) && (jdField_a_of_type_Boolean))
    {
      ...
      int i = aciy.a(66.0F, jdField_a_of_type_AndroidContentContext.getResources());
