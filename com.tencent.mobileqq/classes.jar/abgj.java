  ...
  extends WebViewPlugin
{
  ...
  private static long a(bioy parambioy)
  {
    if (parambioy == null) {
      return 0L;
    }
    try
    {
      long l = parambioy.a().getIntent().getLongExtra("preAct_time", 0L);
      return l;
    }
    catch (Exception parambioy)
    {
      QLog.w("QzoneWebViewOfflinePlugin", 2, "can not get click time", parambioy);
    }
    return 0L;
  }
  ...
  private Object a(String paramString)
  {
    ...
    for (AppInterface localAppInterface = this.mRuntime.a();; localAppInterface = null)
    {
      ...
      return bnnr.a(localAppInterface, localCustomWebView, paramString, (String)localObject);
      localObject = null;
      break;
      localObject = null;
      break label27;
  ...
  private void a(bisp parambisp, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambisp == null) {
      return;
    }
    QLog.i("QzoneWebViewOfflinePlugin", 1, "state is " + parambisp);
    for (;;)
    {
      ...
      try
      {
        ...
        switch (parambisp.jdField_a_of_type_Int)
        {
        case 1: 
          if (!TextUtils.isEmpty(parambisp.jdField_b_of_type_JavaLangString)) {
            localJSONObject.put("url", parambisp.jdField_b_of_type_JavaLangString);
          }
          localJSONObject.put("code", parambisp.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(parambisp.f)) {
            localJSONObject.put("msg", parambisp.f);
          }
          localJSONObject.put("dataIsBase64", parambisp.jdField_a_of_type_Boolean);
          if (TextUtils.isEmpty(parambisp.d)) {
            break label396;
          }
          if (!parambisp.jdField_a_of_type_Boolean) {
            break label387;
          }
          str = bhkv.encodeToString(parambisp.d.getBytes(), 0);
          localJSONObject.put("data", str);
          if (parambisp.jdField_b_of_type_Int > 0) {
            localJSONObject.put("httpStatusCode", parambisp.jdField_b_of_type_Int);
          }
          if (!TextUtils.isEmpty(parambisp.jdField_c_of_type_JavaLangString)) {
            localJSONObject.put("header", new JSONObject(parambisp.jdField_c_of_type_JavaLangString));
          }
          if (parambisp.jdField_a_of_type_JavaLangObject != null) {
            localJSONObject.put("userinfo", parambisp.jdField_a_of_type_JavaLangObject);
          }
          callJs(paramString, new String[] { localJSONObject.toString() });
          long l1 = System.currentTimeMillis();
          long l2 = parambisp.jdField_a_of_type_Long;
          QLog.i("QzoneWebViewOfflinePlugin", 1, "wnscgi@ status=" + parambisp.jdField_a_of_type_Int + ",total cost " + (l1 - l2) + " ms");
          return;
        }
      }
      catch (Exception parambisp)
      {
        parambisp.printStackTrace();
        return;
      }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new abgl(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private static void b(String paramString, long paramLong, bioy parambioy)
  {
    int i;
    long l;
    try
    ...
    label205:
    String str1;
    if ((!TextUtils.isEmpty(paramString)) && (parambioy != null) && ((8589934594L == paramLong) || (8589934593L == paramLong)) && (paramString.equals(QzoneConfig.getInstance().getConfig("H5Url", "GameBar", "https://h5.qzone.qq.com/h5plus/homeV2/index/alpha?_proxy=1&_wv=3&via=qqnavigation.2017"))))
    {
      l = a(parambioy);
      if (l <= 0L)
      {
      ...
      if (QzoneOfflineCacheHelper.getSmallGameLastCacheTime(parambioy.a().getLongAccountUin()) <= 0L) {
        break label367;
      }
      i = 1;
    ...
    for (;;)
    {
      ...
      bdla.a(localBaseApplication).reportTimeKVEvent(str1, localProperties, (int)l);
      if (8589934594L == paramLong) {}
      for (paramString = anzj.a(2131711502);; paramString = anzj.a(2131711503))
      {
        QLog.i("QzoneWebViewOfflinePlugin", 2, paramString + l + "ms,mta key=" + str1);
        if (8589934594L != paramLong) {
          break;
        }
        QzoneOfflineCacheHelper.updataSmallGameLastCacheFinishTime(parambioy.a().getLongAccountUin(), System.currentTimeMillis());
        return;
      }
      while (i == 0)
      {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      localbiso.f = ((JSONObject)localObject2).optString("callback");
      localbiso.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("url");
    ...
    catch (Exception localException)
    {
      ...
      paramVarArgs = new bisp();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbiso.jdField_a_of_type_JavaLangString;
      paramVarArgs.jdField_a_of_type_Int = 3;
      paramVarArgs.jdField_c_of_type_Int = 101;
      paramVarArgs.f = localException.getMessage();
      paramVarArgs.e = localbiso.f;
      a(paramVarArgs, localbiso.f);
      return;
    }
    if (!a(a(), localbiso.jdField_a_of_type_JavaLangString))
    {
      localObject1 = a(a());
      localObject2 = a(localbiso.jdField_a_of_type_JavaLangString);
      throw new Exception("not support for cross-domain request!!! current host=" + (String)localObject1 + ",req host=" + (String)localObject2);
    }
    localbiso.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("method");
    if ((!"GET".equalsIgnoreCase(localbiso.jdField_b_of_type_JavaLangString)) && (!"POST".equalsIgnoreCase(localbiso.jdField_b_of_type_JavaLangString))) {
    ...
    for (localbiso.d = a((JSONObject)localObject1);; localbiso.d = localObject1.toString())
    {
    ...
    {
      localbiso.jdField_c_of_type_JavaLangString = ((String)localObject1);
      localbiso.jdField_a_of_type_Boolean = ((JSONObject)localObject2).optBoolean("dataNeedBase64", false);
      localbiso.jdField_a_of_type_Int = ((int)(((JSONObject)localObject2).optDouble("timeout", 0.0D) * 1000.0D));
      localbiso.jdField_a_of_type_JavaLangObject = ((JSONObject)localObject2).opt("userinfo");
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new abgm(this, Looper.getMainLooper());
      }
      if (bisn.a().a(localbiso, this.jdField_b_of_type_AndroidOsHandler)) {
        break;
      }
      paramVarArgs = new bisp();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbiso.jdField_a_of_type_JavaLangString;
  ...
  protected void a(bisp parambisp)
  {
    a(parambisp, parambisp.e);
  }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if (paramLong == 8L)
    {
      if (this.mRuntime != null)
      {
        bnnr.a = new WeakReference(this.mRuntime.a());
        bnnr.b = new WeakReference(this.mRuntime.a());
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if ((bool) && (!TextUtils.isEmpty(bitb.d(this.jdField_a_of_type_JavaLangString))))
        {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new abgk(this, Looper.getMainLooper());
        }
