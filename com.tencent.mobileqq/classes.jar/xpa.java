...
public class xpa
  extends xpg<HotRecommendFeedItem>
{
  public xpa(@NonNull HotRecommendFeedItem paramHotRecommendFeedItem)
  {
    ...
    if (!this.c.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localStoryVideoItem.mOwnerUid)) {
          localvvj.b(localStoryVideoItem.mOwnerUid);
        }
      }
    }
  }
