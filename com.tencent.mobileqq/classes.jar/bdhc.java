  ...
  implements View.OnClickListener
{
  ...
  public bdhc(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.jdField_b_of_type_Float = 45.5F;
    this.jdField_c_of_type_Float = 39.0F;
    this.jdField_c_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bdhe(this);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bdhf(this, paramInt));
    }
  }
  
  void a(Context paramContext)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout = ((MyLinearLayout)View.inflate(paramContext, 2131558959, null));
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131369507).setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.setDispatchKeyEventListener(new bdhg(this));
  }
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131369504);
    localLinearLayout.removeAllViews();
    int i = 0;
    while (i < paramArrayList.size())
    {
      View localView = View.inflate(getContext(), 2131558960, null);
      localView.setTag(Integer.valueOf(i));
      localView.setClickable(true);
      localView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ((TextView)localView.findViewById(2131369503)).setText((CharSequence)paramArrayList.get(i));
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131368343)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout != null)
      {
        ...
        {
          a();
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846765);
          this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130846765));
      ...
      if ((paramView != null) && ((paramView instanceof Integer)) && (((Integer)paramView).intValue() == 2130847356))
      {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130847356));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new QQCustomDialogWtihInputAndChoose.6(this), 200L);
      return;
    }
    if (paramView.getId() == 2131369507)
    {
      a();
      return;
    }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bdhd(this));
    Context localContext = (Context)this.jdField_a_of_type_JavaLangRefSoftReference.get();
    if (localContext == null) {
      return;
    }
    aacm.a(localContext, this.jdField_a_of_type_AndroidWidgetEditText);
    a(localContext);
  }
  ...
  {
    TextView localTextView = (TextView)findViewById(2131365208);
  ...
  public bdfq setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bdhh(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bdfq setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bdhi(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
