  ...
  extends aibn
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aibu(this);
  ...
  public aibq(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new aibr(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131367807)).setOnClickListener(new aibs(this));
    Button localButton = (Button)findViewById(2131363520);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new aibt(this));
  }
  ...
  private void h()
  {
    ...
    this.d = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131371192));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131370748));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131719576));
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_Aibp = new aibp(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bhoe, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aibp);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new aibv(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new aibw(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new aibx(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Aibp.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Aibp.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
    a(0, null);
  }
  
  public void a(List<Object> paramList)
  {
    this.jdField_a_of_type_Aibp.a(paramList);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131701645));
        ...
        {
          this.jdField_a_of_type_Aibp.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_c_of_type_Boolean, 0);
          this.jdField_a_of_type_Aibp.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Aibp.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Aibp.a(this.jdField_a_of_type_JavaUtilList, this.jdField_c_of_type_Boolean);
      if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Aibp.getCount() < 20))
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131701648));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131372313).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Aibp.a((List)localObject, this.jdField_c_of_type_Boolean);
    this.jdField_a_of_type_Aibp.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aibp);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
