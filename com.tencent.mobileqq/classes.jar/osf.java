  ...
  extends osm
{
  ...
  private WeakReference<pan> jdField_b_of_type_JavaLangRefWeakReference;
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  
  public osf(AppInterface paramAppInterface, pan parampan)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramAppInterface);
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(parampan);
  ...
  private void a(aukp paramaukp, long paramLong, int paramInt)
  {
    if (paramaukp == null)
    {
    ...
    {
      ReadinjoyFollowingUserBriefInfo localReadinjoyFollowingUserBriefInfo = (ReadinjoyFollowingUserBriefInfo)paramaukp.a(ReadinjoyFollowingUserBriefInfo.class, String.valueOf(paramLong));
      if (localReadinjoyFollowingUserBriefInfo != null) {
        paramaukp.b(localReadinjoyFollowingUserBriefInfo);
      }
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(paramLong));
      return;
    }
    paramaukp.b(new ReadinjoyFollowingUserBriefInfo(paramLong, paramInt));
    this.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(paramLong));
  }
  
  private void a(List<qaz> paramList, int paramInt)
  {
    if (paramList == null) {}
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        while (paramList.hasNext()) {
          a((aukp)localObject, ((qaz)paramList.next()).a().longValue(), paramInt);
        }
      }
    }
  }
  
  private void a(List<qaz> paramList, boolean paramBoolean)
  {
    ...
    {
      return;
      paramList = (pan)this.jdField_b_of_type_JavaLangRefWeakReference.get();
