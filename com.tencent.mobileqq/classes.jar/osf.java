...
{
  public osf(ReadInJoyCommentComponentFragment paramReadInJoyCommentComponentFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if ((paramEditable instanceof oog))
    {
      ...
      localahtj = ReadInJoyCommentComponentFragment.a(this.a);
      if (localahtj != null)
      {
    ...
    for (;;)
    {
      if ((i <= 0) || (paramEditable.length() > 24) || (!localahtj.a(paramEditable))) {
        break label308;
      }
      if (ReadInJoyCommentComponentFragment.a(this.a))
      {
        localahtj.a(ReadInJoyCommentComponentFragment.a(this.a).app, paramEditable, null, 7220, false);
      ...
      this.a.f.setImageResource(2130842836);
      return;
      ...
      break label51;
      label261:
      this.a.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColor(2131165615));
      this.a.d = false;
      break label86;
      label294:
    ...
    this.a.f.setImageResource(2130843227);
  }
