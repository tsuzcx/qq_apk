  ...
  extends alja
{
  ...
  public algn(Context paramContext, SessionInfo paramSessionInfo)
  {
      ...
      for (;;)
      {
        ...
        if (n < this.jdField_a_of_type_Int)
        {
          ...
          if (i1 < this.jdField_a_of_type_JavaUtilList.size())
          {
            ...
            if (localalhm.jdField_a_of_type_Alhk.jdField_b_of_type_Int == 2)
            {
              localalhm.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130838449);
              localalhm.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
              ...
              ((ImageView)localObject2).postDelayed(new ApolloFavViewBinder.1(this, (ImageView)localObject2, localRelativeLayout, (RelativeLayout)localObject1, localalhm), 200L);
              this.f = -1;
              localView.setContentDescription(localApolloActionData.actionName + alpo.a(2131700706));
            }
          }
          for (;;)
          {
            ...
            break label526;
            localalhm.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
            break label638;
            if (localalhm.jdField_a_of_type_AndroidViewView == null) {
              break label968;
            }
