...
public final class algn
{
  ...
  public algn(@NotNull String paramString1, @NotNull String paramString2, @NotNull String paramString3, @NotNull String paramString4)
  {
    this.a = paramString1;
    this.b = paramString2;
    this.c = paramString3;
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof algn))
      {
        paramObject = (algn)paramObject;
