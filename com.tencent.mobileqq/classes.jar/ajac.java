...
public class ajac
{
  ...
  public static ajcf a(int paramInt)
  {
    ajco localajco = a();
    if (localajco == null) {
      return null;
  ...
  public static ajcf a(int paramInt1, int paramInt2)
  {
    ajco localajco = a();
    if (localajco == null) {
      return null;
    }
    return localajco.a(paramInt1, paramInt2);
  }
  
  public static ajcf a(long paramLong)
  {
  ...
  public static ajco a()
  {
    ...
    if ((localAppInterface instanceof CmGameAppInterface)) {
      return (ajco)((CmGameAppInterface)localAppInterface).getManager(255);
    }
    return null;
  }
  
  public static ajct a(int paramInt)
  {
    ajcf localajcf = a(paramInt);
    if (localajcf != null) {
      return localajcf.a();
    }
  ...
  public static ajct a(long paramLong)
  {
    ajcf localajcf = b(paramLong);
    if (localajcf != null) {
      return localajcf.a();
  ...
  public static ApolloSurfaceView a()
  {
    ...
    {
      return null;
      localObject = ((ajco)localObject).a();
    } while (localObject == null);
    return ((ajcf)localObject).a();
  }
  ...
  public static void a(Activity paramActivity, Conversation paramConversation)
  {
    ...
    {
      return;
      localairx = (airx)a().getManager(153);
      if (a(null)) {
        localairx.k = true;
      }
    } while ((localairx == null) || (!localairx.j) || (paramActivity == null) || (!(paramActivity instanceof SplashActivity)) || (paramActivity.isFinishing()) || (!((SplashActivity)paramActivity).isResume()) || (paramConversation == null));
    if (FrameHelperActivity.b())
    {
      FrameHelperActivity.c(true);
      FrameHelperActivity.s();
    }
    a(paramConversation.b, localairx.a());
    localairx.j = false;
  ...
  public static void a(View paramView, String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTextView.setPadding((int)(bbdh.jdField_a_of_type_Float * 7.0F), (int)(bbdh.jdField_a_of_type_Float * 7.0F), (int)(bbdh.jdField_a_of_type_Float * 7.0F), 0);
        ...
        int i = (int)((float)bbdh.k() - bbdh.jdField_a_of_type_Float * 7.0F - localTextView.getMeasuredWidth());
        int j = (int)(localRect.bottom - 6.0F * bbdh.jdField_a_of_type_Float);
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("sqVersion", "8.3.0.4480");
      ...
      paramJSONObject = new NewIntent(paramAppInterface.getApp(), aiwg.class);
      ...
      paramJSONObject.setObserver(new ajad());
  ...
  public static void a(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    else
    {
      ...
      if ((paramStartCheckParam.mStartType == 2) || (paramStartCheckParam.mStartType == 1) || (paramStartCheckParam.mStartType == 3))
      {
        ...
        if (localList != null)
        {
          ...
          if (i < localList.size())
          {
            localObject3 = (ajcr)localList.get(i);
            if ((localObject3 == null) || (((ajcr)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)) {
              break label713;
            }
            localObject1 = localajco.a(((ajcr)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
            if (localObject1 == null) {
              break label713;
            }
            localObject4 = ((ajcf)localObject1).a();
            if ((((ajcf)localObject1).a() != paramStartCheckParam.gameId) || ((paramStartCheckParam.roomId != 0L) && (paramStartCheckParam.roomId != ((ajrd)localObject4).jdField_a_of_type_Long))) {
              break label713;
            }
            if (((ajcf)localObject1).a() == null) {
              break label1490;
            }
          }
        }
    ...
    label849:
    label1490:
    for (localObject1 = ((ajcf)localObject1).a().getClass();; localObject1 = null)
    {
      QLog.i("cmgame_process.CmGameUtil", 1, " launchGame found old task.mStartCheckParam:" + ((ajcr)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
      if (localObject1 == null)
      {
        if ((localList != null) && (localList.size() >= ajco.jdField_a_of_type_ArrayOfJavaLangClass.length))
        {
          localObject2 = (ajcr)localList.get(0);
          if ((localObject2 != null) && (((ajcr)localObject2).jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            localObject3 = (Activity)((ajcr)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject3 != null)
            {
              ((Activity)localObject3).finish();
              if (((ajcr)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
              {
                ajbu.a("cs.close_room.local", "{}", false, null, ((ajcr)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + ((ajcr)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
              }
            }
          }
          localajco.jdField_a_of_type_JavaUtilList.remove(0);
        }
        localObject2 = new HashMap();
        i = 0;
        for (;;)
        {
          if (i < localajco.jdField_a_of_type_JavaUtilList.size())
          {
            localObject3 = (ajcr)localajco.jdField_a_of_type_JavaUtilList.get(i);
            if ((localObject3 != null) && (((ajcr)localObject3).jdField_a_of_type_JavaLangString != null)) {
              ((HashMap)localObject2).put(((ajcr)localObject3).jdField_a_of_type_JavaLangString, ((ajcr)localObject3).jdField_a_of_type_JavaLangString);
            }
            i += 1;
            continue;
            i += 1;
        ...
        i = 0;
        if (i >= ajco.jdField_a_of_type_ArrayOfJavaLangClass.length) {
          break label1483;
        }
        if (TextUtils.isEmpty((String)((HashMap)localObject2).get(ajco.jdField_a_of_type_ArrayOfJavaLangClass[i].getSimpleName())))
        {
          localObject2 = ajco.jdField_a_of_type_ArrayOfJavaLangClass[i];
      ...
      for (;;)
      {
        ...
        {
          localObject1 = ajco.jdField_a_of_type_ArrayOfJavaLangClass[0];
          QLog.e("cmgame_process.CmGameUtil", 1, "can not find activityClass, use first class");
        }
        localObject2 = new ajcr();
        ((ajcr)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        ((ajcr)localObject2).jdField_a_of_type_JavaLangString = ((Class)localObject1).getSimpleName();
        localajco.jdField_a_of_type_JavaUtilList.add(localObject2);
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            localObject2 = localajco.jdField_a_of_type_JavaUtilList.iterator();
            for (;;)
            {
              if (((Iterator)localObject2).hasNext())
              {
                localObject3 = (ajcr)((Iterator)localObject2).next();
                QLog.d("cmgame_process.CmGameUtil", 2, "launchGame task:" + ((ajcr)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                continue;
                i += 1;
                break;
                ...
                {
                  ajcr localajcr = (ajcr)localList.get(i);
                  boolean bool2 = false;
                  localObject3 = localObject1;
                  if (localajcr != null)
                  {
                    localObject3 = localObject1;
                    if (localajcr.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                    {
                      localObject3 = localajco.a(localajcr.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                      boolean bool1 = bool2;
                      localObject2 = localObject1;
                      if (localObject3 != null)
                      {
                        ajrd localajrd = ((ajcf)localObject3).a();
                        bool1 = bool2;
                        localObject2 = localObject1;
                        if (((ajcf)localObject3).a() == paramStartCheckParam.gameId) {
                          if (paramStartCheckParam.roomId != 0L)
                          {
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (paramStartCheckParam.roomId != localajrd.jdField_a_of_type_Long) {}
                          }
                          else
                          {
                            bool2 = true;
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (((ajcf)localObject3).a() != null)
                            {
                              localObject2 = ((ajcf)localObject3).a().getClass();
                              bool1 = bool2;
                            }
                          }
                        }
                      ...
                      if (!bool1)
                      {
                        if (localajcr.jdField_a_of_type_JavaLangRefWeakReference != null)
                        {
                          localObject1 = (Activity)localajcr.jdField_a_of_type_JavaLangRefWeakReference.get();
                          if (localObject1 != null)
                          {
                            ((Activity)localObject1).finish();
                            if (localajcr.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
                              ajbu.a("cs.close_room.local", "{}", false, null, localajcr.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                            }
                            QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + localajcr.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                          }
                        }
                        ((List)localObject4).add(localajcr);
                        localObject3 = localObject2;
                      }
                    }
                  }
        ...
        for (;;)
        {
          ...
          localObject2 = ajco.jdField_a_of_type_ArrayOfJavaLangClass[0];
          break;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localajdo = a();
    } while (localajdo == null);
    localajdo.a(paramString1, paramString2, -1L, 4, false, null);
  }
  ...
  public static void a(Object... paramVarArgs)
  {
    aiws localaiws = a();
    if (localaiws != null) {
      localaiws.a("cmg_launch", 4, paramVarArgs);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    ApolloGameData localApolloGameData = ((ajmu)localObject).a(paramStartCheckParam.gameId);
    airx localairx = (airx)paramQQAppInterface.getManager(153);
    if (localairx != null)
    {
      paramStartCheckParam.game = localApolloGameData;
      if ((localApolloGameData != null) && ((((ajmu)localObject).a(paramStartCheckParam.gameId)) || (paramStartCheckParam.isRequestConf))) {
        break label244;
      }
    }
    label244:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramStartCheckParam.isWhiteUsr = localairx.c((String)localObject);
      paramStartCheckParam.apolloStatus = localairx.b((String)localObject);
      paramStartCheckParam.pushItem = localairx.a().a();
      ...
      paramStartCheckParam.gender = ((aszf)paramQQAppInterface.getManager(106)).b();
      paramStartCheckParam.isEnableMSAA = c(paramStartCheckParam.gameId);
      paramStartCheckParam.mIsTransGame = ajmr.c.contains(Integer.valueOf(paramStartCheckParam.gameId));
      return true;
    }
  }
  ...
  public static int b()
  {
    ...
    airx localairx = (airx)a().getManager(153);
    if ((localairx != null) && (localairx.j())) {
      return 1;
    }
    return 0;
  }
  ...
  public static int b(int paramInt)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append(ajms.s).append(paramInt).append(File.separator).append("gameConfig.json");
      ...
      localObject = new JSONObject(bbdx.b((File)localObject)).optJSONArray("subpackages");
      if (localObject != null)
      {
  ...
  public static ajcf b(int paramInt1, int paramInt2)
  {
    ajco localajco = a();
    if (localajco == null) {
      return null;
    }
    return localajco.b(paramInt1, paramInt2);
  }
  
  public static ajcf b(long paramLong)
  {
    ajco localajco = a();
    if (localajco == null) {
      return null;
    }
    return localajco.a(paramLong);
  }
  ...
  public static String b(CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject1 = ajnc.a(0, ajhu.a);
        ...
        if (("1".equals(paramCmGameInitParams.mGameName)) || ("2".equals(paramCmGameInitParams.mGameName)))
        {
          ...
          if ((!ApolloGameStateMachine.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(false)) || (ApolloGameStateMachine.jdField_a_of_type_Aiyc == null)) {
            break label999;
          }
          localJSONObject1.put("freeMemory", ApolloGameStateMachine.jdField_a_of_type_Aiyc.jdField_b_of_type_Long);
          localJSONObject1.put("totalMemory", ApolloGameStateMachine.jdField_a_of_type_Aiyc.jdField_c_of_type_Long);
          localJSONObject1.put("osVersion", aiyc.jdField_a_of_type_JavaLangString);
          localJSONObject1.put("model", aiyc.jdField_b_of_type_JavaLangString);
          localJSONObject1.put("cpuType", aiyc.jdField_c_of_type_JavaLangString);
          localJSONObject1.put("cpuNumber", aiyc.jdField_a_of_type_Int);
          localJSONObject1.put("cpuFrequency", aiyc.jdField_a_of_type_Long);
          localJSONObject1.put("gameVersion", paramCmGameInitParams.mVersion);
          localJSONObject1.put("QQVer", "8.3.0.4480");
      ...
      localJSONObject1.put("connType", bbfj.a(BaseApplicationImpl.getContext()));
      ...
      continue;
      label999:
      localJSONObject1.put("freeMemory", bbdh.a(Process.myPid()));
      localJSONObject1.put("totalMemory", bbdh.f());
      localJSONObject1.put("osVersion", bbdh.e());
      localJSONObject1.put("model", bbdh.i());
      localJSONObject1.put("cpuType", bbdh.g());
      localJSONObject1.put("cpuNumber", bbdh.b());
      localJSONObject1.put("cpuFrequency", bbdh.a());
    }
  }
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject = (airx)a().getManager(153);
        if ((localObject != null) && (((airx)localObject).k())) {
          ((airx)localObject).a().b();
        }
        i = a();
      } while (-1 == i);
      localObject = aizu.a().a(i);
    } while (localObject == null);
    ((ajck)localObject).c();
  }
  ...
  public static void b(int paramInt)
  {
    try
    {
      ...
      ((bbrd)a().getBusinessHandler(71)).a("apollo_router_game.game_extend_linkcmd_set_plus_flag", localJSONObject.toString(), -1L, 0);
      return;
    }
    catch (Exception localException) {}
  }
  ...
  public static boolean c(int paramInt)
  {
    ...
    try
    {
      ...
      int i = new JSONObject(bbdx.b((File)localObject)).optInt("enableMSAA");
  ...
  public static int e()
  {
    ...
    if (jdField_a_of_type_Float < 0.0F) {
      jdField_a_of_type_Float = (float)bbdh.a() / 1.0F / 1024.0F;
    }
    if (d < 0L) {
      d = Math.ceil(bbdh.d() / 1073741824.0D);
    }
    if (QLog.isColorLevel()) {
