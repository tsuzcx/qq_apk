...
public class bbtm
{
  ...
  public static bbtm a()
  {
    try
    {
      if (jdField_a_of_type_Bbtm == null) {
        jdField_a_of_type_Bbtm = new bbtm();
      }
      bbtm localbbtm = jdField_a_of_type_Bbtm;
      return localbbtm;
    }
    finally {}
  }
  ...
  public long a()
  {
    try
    {
      ...
      bcds.b("CommonDataAdapter", "get uin from app runtim succ:" + this.jdField_a_of_type_Long);
      label46:
  ...
  protected void a()
  {
    ...
    {
      bcds.e("AppUpdate", "getPackageInfo NameNotFoundException : " + localNameNotFoundException.toString());
      return;
    }
    catch (Exception localException)
    {
      bcds.e("AppUpdate", "getPackageInfo exception : " + localException.toString());
    }
  }
  ...
  public void a(String paramString, Context paramContext, WebView paramWebView)
  {
    try
    {
      ...
      localJSONObject2.put("imei", bcez.c());
      localJSONObject2.put("imsi", bcez.d());
      localJSONObject2.put("mac_addr", bcez.a());
      localJSONObject2.put("model_info", Build.MODEL);
      localJSONObject2.put("network_type", bcdn.a(a().a()));
      localJSONObject2.put("network_operater", "");
      localJSONObject2.put("location", bcez.f());
    ...
    {
      bcds.e("AppUpdate", "getUpdateApp parse H5 params error : " + localJSONException.toString());
      if (!paramContext.getSharedPreferences("appcenter_app_report", 0).getBoolean("is_app_last_fullReport_success", false))
      {
        bcds.c("AppUpdate", "getUpdateApp will do full report");
        bcfc.a(paramContext, paramString, paramWebView, String.valueOf(a().a()), false);
        return;
      ...
      {
        bcds.c("AppUpdate", "getUpdateApp will do incremental report");
        bcfc.a(paramContext, null, 0, paramString, paramWebView, String.valueOf(a().a()));
        return;
      }
      bcds.c("AppUpdate", "getUpdateApp will get update app directly");
      bcff.a(paramContext, paramWebView, paramString, true, String.valueOf(a().a()));
    }
  }
