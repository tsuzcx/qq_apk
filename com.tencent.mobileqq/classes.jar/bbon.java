  ...
  extends MSFServlet
{
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/if_proxy", "application/json", localJSONObject.toString(), new bboo(paramBusinessObserver));
      return;
    }
  ...
  public static void a(int paramInt, byte[] paramArrayOfByte, long paramLong, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/available", "application/json", ((JSONObject)localObject).toString(), 2000, 2000, new bbop(paramBusinessObserver));
      return;
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(paramQQAppInterface.getApp(), bbon.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, axkv paramaxkv)
  {
    a(paramQQAppInterface, 2478, "OidbSvc.0x9ae_13", 13, new cmd0x9ae.ReqBody().toByteArray(), paramaxkv);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, axkv paramaxkv)
  {
    paramString = new FaceSecureCheck.SecureCheckRequest();
    Object localObject = pri.a(BaseApplicationImpl.getApplication());
    boolean bool;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      localObject = new NewIntent(paramQQAppInterface.getApp(), bbon.class);
      ((NewIntent)localObject).setObserver(paramaxkv);
  ...
  public static void a(String paramString1, long paramLong, String paramString2, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/appconf", "application/json", localJSONObject.toString(), new bboq(paramBusinessObserver));
      return;
    }
    catch (JSONException paramString1)
    {
  ...
  private static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, bbos parambbos)
  {
    ThreadManager.getNetExcutor().execute(new LoginVerifyServlet.4(paramString1, paramInt1, paramInt2, paramString2, paramString3, parambbos));
  }
  
  private static void a(String paramString1, String paramString2, String paramString3, bbos parambbos)
  {
    a(paramString1, paramString2, paramString3, 10000, 30000, parambbos);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, axkv paramaxkv)
  {
    a(paramQQAppInterface, 2478, "OidbSvc.0x9ae_14", 14, new cmd0x9ae.ReqBody().toByteArray(), paramaxkv);
  }
  ...
  public static void c(QQAppInterface paramQQAppInterface, axkv paramaxkv)
  {
    a(paramQQAppInterface, 2478, "OidbSvc.0x9ae_15", 15, new cmd0x9ae.ReqBody().toByteArray(), paramaxkv);
  }
