...
public class bbon
  implements Manager
{
  bbwf jdField_a_of_type_Bbwf = new bboo(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  private bbwi jdField_a_of_type_Bbwi;
  public bbwm a;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bbon(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a(long paramLong, int paramInt)
  {
    ...
    do
    {
      return "";
      if (paramInt == 2) {
        return bbom.a + File.separator + paramLong + File.separator + "config.txt";
      }
      if (paramInt == 1) {
        return bbom.a + File.separator + paramLong + File.separator + "cover.jpg";
      }
    } while (paramInt != 3);
    return bbom.a + File.separator + paramLong + File.separator + "ring.mp3";
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 3)
    {
      localObject = bbyt.a(paramAppRuntime, 0, null).getString("_3_" + paramInt1, null);
      paramAppRuntime = (AppRuntime)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramAppRuntime = bbpp.a("colorringAudio");
      }
    }
    for (;;)
    {
      ...
      if (paramInt2 == 2)
      {
        paramAppRuntime = bbpp.a("colorringConfig");
      }
      else
      {
        paramAppRuntime = (AppRuntime)localObject;
        if (paramInt2 == 1) {
          paramAppRuntime = bbpp.a("colorringCover");
        }
      }
    }
  }
  ...
  {
    Object localObject = new File(bbom.a + File.separator + paramLong + File.separator + "config.txt");
    try
    {
  ...
  {
    this.jdField_a_of_type_Bbwi.a(1).a(true, a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramInt2));
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, String paramString)
  {
    ...
    do
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        paramString = new bbwg(paramString, localFile);
        paramString.a(3);
        paramString.a = 0;
        paramString.a(localBundle);
        this.jdField_a_of_type_Bbwf.onDone(paramString);
        return;
      }
      paramString = new bbwg(paramString, new File(str + ".tmp"));
      paramString.e = 3145728L;
      paramString.b = true;
      this.jdField_a_of_type_Bbwi.a(1).a(paramString, this.jdField_a_of_type_Bbwf, localBundle);
  ...
  {
    this.jdField_a_of_type_Bbwm = null;
  }
}
