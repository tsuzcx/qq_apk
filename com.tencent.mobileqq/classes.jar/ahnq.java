  ...
  extends ahmt
{
  ...
  public ahnq(Emoticon paramEmoticon)
  {
  ...
  public String a()
  {
    ...
    {
      bool = ((areb)((AppRuntime)localObject).getManager(43)).c(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
      if (!this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.isAPNG) {
        break label136;
      }
  ...
  {
    ((avsq)paramQQAppInterface.getManager(14)).a(this);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    ((avsq)paramQQAppInterface.getManager(14)).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
  }
