  ...
  implements Handler.Callback
{
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = aabc.a().a();
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, long paramLong, int paramInt7, String paramString, boolean paramBoolean)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      return aabc.a().a(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramLong, paramInt7, paramString);
    }
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
    aabd localaabd = (aabd)aabc.a.obtain(aabd.class);
    localaabd.jdField_a_of_type_Int = paramInt1;
    localaabd.c = paramInt2;
    localaabd.d = paramInt3;
    localaabd.e = paramInt4;
    localaabd.b = paramInt5;
    localaabd.f = paramInt6;
    localaabd.jdField_a_of_type_Long = paramLong;
    localaabd.jdField_a_of_type_JavaLangString = paramString;
    localMessage.obj = localaabd;
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((Math.abs(System.currentTimeMillis() - l) <= 86400000L) || (!bbfj.h(BaseApplicationImpl.getContext()))) {
          continue;
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      Object localObject = (aabd)paramMessage.obj;
      jdField_a_of_type_AndroidOsBundle.putInt("key_delay", ((aabd)localObject).jdField_a_of_type_Int);
      jdField_a_of_type_AndroidOsBundle.putInt("key_cpu", ((aabd)localObject).c);
      jdField_a_of_type_AndroidOsBundle.putInt("key_io", ((aabd)localObject).d);
      jdField_a_of_type_AndroidOsBundle.putInt("key_bind", ((aabd)localObject).e);
      jdField_a_of_type_AndroidOsBundle.putInt("key_timeout", ((aabd)localObject).b);
      jdField_a_of_type_AndroidOsBundle.putInt("key_scene", ((aabd)localObject).f);
      jdField_a_of_type_AndroidOsBundle.putLong("key_action", ((aabd)localObject).jdField_a_of_type_Long);
      jdField_a_of_type_AndroidOsBundle.putString("key_tag", ((aabd)localObject).jdField_a_of_type_JavaLangString);
