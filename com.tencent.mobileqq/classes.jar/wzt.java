...
public class wzt
  extends bifz
  implements Handler.Callback, View.OnClickListener, bibw, wys
{
  public float a;
  public int a;
  ...
  private bigl jdField_a_of_type_Bigl;
  ...
  private String jdField_d_of_type_JavaLangString = (String)wwt.a().a("KEY_SMART_MUSIC_ENTER_ANIM_DOWNLOAD_URL", "http://down.qq.com/video_story/smart_music_anim.zip");
  ...
  public wzt(@NonNull bigb parambigb)
  {
    super(parambigb);
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new xaa(this);
  }
  ...
  private bigl a()
  {
    if (this.jdField_a_of_type_Bigl == null) {
      this.jdField_a_of_type_Bigl = ((bigl)this.jdField_a_of_type_Bigb.a(bigl.class));
    }
  ...
  private void a(int paramInt, xaf paramxaf)
  {
    if (paramxaf == null) {
      paramxaf = (xaf)this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.findViewHolderForAdapterPosition(paramInt);
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = paramInt;
      this.jdField_a_of_type_Xaf = paramxaf;
      if ((this.jdField_a_of_type_Xaf != null) && (!this.jdField_a_of_type_Boolean))
      {
  ...
  private void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_Wyr != null)
          {
            this.jdField_a_of_type_Wyr.c();
            i();
          }
          ...
          if (this.jdField_a_of_type_Xac.a() <= 0) {
            break label277;
          }
          i = 1;
          if (i == 0) {
          ...
          if (this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int, paramIntent))
          {
          ...
          this.jdField_d_of_type_Int = (this.jdField_a_of_type_Xac.a(paramIntent.mSongMid) + a());
          if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView == null) {
            break;
          }
    ...
    this.jdField_a_of_type_Xac.a((ArrayList)localObject1);
  }
  
  private void a(VsMusicItemInfo paramVsMusicItemInfo, int paramInt, xaf paramxaf)
  {
  ...
  private void a(ArrayList<FrameVideoHelper.FrameBuffer> paramArrayList)
  {
    ...
    paramArrayList = new SmartMusicMatchRequest(paramArrayList, wvh.a().a(), this.jdField_f_of_type_Boolean, this.jdField_c_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
    this.jdField_c_of_type_JavaLangString = paramArrayList.getCmdName();
    VSNetworkHelper.a().a(paramArrayList, new wzz(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Xac != null) {
      this.jdField_a_of_type_Xac.a(paramArrayList, true);
    }
  }
  ...
  {
    Object localObject;
    if ((this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a instanceof EditTakeVideoSource))
    {
      localObject = (EditTakeVideoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a;
      ...
      this.jdField_a_of_type_Wyr = new wyr();
      this.jdField_a_of_type_Wyr.a(this);
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo != null)
      {
        this.jdField_a_of_type_Wyr.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration);
        a(ajjy.a(2131638038) + "\n视频时长：" + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration / 1000L + "s");
        a(ajjy.a(2131638055) + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaWidth + "  " + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaHeight);
        bhcm.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration / 1000L);
      }
      if (this.g) {
        this.jdField_a_of_type_Wyr.a(60000);
      }
      this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)this.jdField_a_of_type_Bigb.a().getSerializable("KEY_VIDEO_STORY_CAPTYRE_FRAMES"));
      if (this.jdField_a_of_type_Bigb.a().getInt("KEY_VIDEO_STORY_CAMERA_TYPE", 2) != 2) {
        break label345;
      }
    }
    label345:
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Bigb.a().getLong("KEY_VIDEO_STORY_CAPTYRE_FRAMES_SIZE");
      k();
      return;
      ...
      localObject = (EditLocalVideoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a;
  ...
  private void k()
  {
    ...
    l();
    if ((this.jdField_a_of_type_JavaIoFile.exists()) || (baip.a(this.jdField_d_of_type_JavaLangString)))
    {
  ...
  private void n()
  {
    this.jdField_e_of_type_AndroidViewView = a(2131313261);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131312272));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131312515));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131313247));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131303001));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)a(2131302994));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131312434));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)a(2131302931));
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetEasylyricSingleLyricView = ((SingleLyricView)a(2131310493));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)a(2131310503));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = a().getResources().getDrawable(2130849406);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = a().getResources().getDrawable(2130849405);
    this.jdField_c_of_type_AndroidViewView = a(2131303747);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131303742);
    this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)a(2131300728));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_Bigb.jdField_a_of_type_Bihj.getActivity().findViewById(2131297747);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Bigb.jdField_a_of_type_Bihj.getActivity().findViewById(2131297745);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(this);
    o();
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new wzv(this));
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new wzw(this));
    if ((this.jdField_c_of_type_AndroidViewView != null) && (this.g)) {
      this.jdField_c_of_type_AndroidViewView.setVisibility(8);
    }
    QLog.d("EditVideoSmartMusicPart", 2, "getRealHeight" + awmc.c(a()) + "ScreenUtil.getRealWidth(getContext())" + awmc.e(a()));
    int i;
    int m;
    int k;
    int j;
    if (awmc.c(a()) / awmc.e(a()) >= 2.0F)
    {
      bjeh.c((Activity)a());
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
      if ((!bgww.b.a(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.f)) || ((!this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c()) && (!this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()) && (!this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b()))) {
        break label667;
      }
      i = aciy.a(105.0F, a().getResources());
      m = aciy.a(34.0F, a().getResources());
      k = aciy.a(19.0F, a().getResources());
      j = i;
    }
    for (;;)
    {
      ...
      return;
      if ((this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams() == null)) {
        break;
      }
      this.jdField_e_of_type_AndroidViewView.setPadding(0, 0, 0, this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams().height);
      break;
      label667:
      j = aciy.a(17.0F, a().getResources());
      i = aciy.a(0.0F, a().getResources());
      k = aciy.a(-15.0F, a().getResources());
      m = i;
    }
  }
  ...
  private void o()
  {
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView = ((SmartMusicRecyclerView)a(2131299289));
    this.jdField_a_of_type_Xac = ((xac)this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.getAdapter());
    this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.setListener(new wzx(this));
  }
  ...
  private void p()
  {
    ...
    {
      return;
      localVsMusicItemInfo = this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int);
    ...
    try
    {
      ...
      wye.a("mystatus_edit", "aimusic_exp_clk", 0, 0, new String[] { String.valueOf(localVsMusicItemInfo.jdField_a_of_type_Int), "", localJSONObject.toString() });
      this.jdField_f_of_type_Long = System.currentTimeMillis();
      urk.c("EditVideoSmartMusicPart", "reportSmartMusic   reportClickMusic() args3:" + localJSONObject.toString());
      return;
    }
  ...
  private void q()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0))
    {
      ...
      this.jdField_a_of_type_ComTencentBizVideostoryVideoFrameVideoHelper.a(this.jdField_e_of_type_Long, new wzy(this));
      return;
    }
  ...
  private void r()
  {
    ...
    {
      q();
      wye.a("mystatus_edit", "musiclib_entry_clk", 0, 0, new String[0]);
    }
    if (!this.jdField_a_of_type_Boolean) {
      bool = true;
    }
  ...
  private void v()
  {
    ...
    else if (this.jdField_a_of_type_Xaf != null)
    {
      localObject = this.jdField_a_of_type_Xaf;
      if (this.jdField_a_of_type_Boolean) {
        break label74;
      }
    }
  ...
  private void w()
  {
    ...
    localIntent.putExtra("url", String.format("https://ti.qq.com/music/index.html?_wv=5&_bid=2831&device_id=%s&client_ip=%s&bustype=%s", new Object[] { babp.a(), "", Integer.valueOf(6) }));
  ...
  private void x()
  {
    ...
    {
      this.jdField_e_of_type_AndroidViewView.setBackgroundResource(2130838506);
  ...
  private void y()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int - 1) != null) {
        localJSONObject.put("mid1", this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int - 1).mSongMid);
      }
      if (this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int) != null) {
        localJSONObject.put("mid2", this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int).mSongMid);
      }
      if (this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int + 1) != null) {
        localJSONObject.put("mid3", this.jdField_a_of_type_Xac.a(this.jdField_a_of_type_Int + 1).mSongMid);
      }
    }
    catch (JSONException localJSONException)
    {
    ...
    wye.a("mystatus_edit", "aimusic_exp", 0, 0, new String[] { "", "", localJSONObject.toString() });
    urk.c("EditVideoSmartMusicPart", "reportSmartMusic   reportShowMusic() args3:" + localJSONObject.toString());
  }
  ...
  public int a()
  {
    if ((this.jdField_a_of_type_Xac.a() == null) || (this.jdField_a_of_type_Xac.a().size() == 0)) {
      return 0;
    }
    return (int)(Math.floor(this.jdField_a_of_type_Xac.getItemCount() / this.jdField_a_of_type_Xac.a().size() / 2) * this.jdField_a_of_type_Xac.a().size());
  }
  ...
  {
    super.a();
    this.jdField_f_of_type_Boolean = this.jdField_a_of_type_Bigb.b();
    this.g = this.jdField_a_of_type_Bigb.c();
    n();
    j();
    a(bibw.class, this);
    ...
    this.jdField_b_of_type_Int = ((Long)wwt.a().a("SmartMatchMusicSwitch", Long.valueOf(0L))).intValue();
  ...
  public void a(int paramInt, bitz parambitz)
  {
    boolean bool2 = false;
    ...
    Object localObject = parambitz.a;
    boolean bool1;
    if (!this.jdField_b_of_type_Boolean)
    {
      bool1 = true;
      ((PublishVideoEntry)localObject).putExtra("isMixOriginal", Boolean.valueOf(bool1));
      localObject = parambitz.a;
      bool1 = bool2;
      if (!this.jdField_b_of_type_Boolean) {
        bool1 = true;
      }
      ((PublishVideoEntry)localObject).isMixOriginal = bool1;
      parambitz.a.isMuteRecordVoice = this.jdField_b_of_type_Boolean;
      parambitz.a.putExtra("KEY_PIC_TO_VIDEO_LOCAL_PIC_PATH", this.jdField_a_of_type_Bigb.a().getString("KEY_PIC_TO_VIDEO_LOCAL_PIC_PATH"));
      parambitz.a.putExtra("KEY_FROM_PIC_TO_VIDEO", Boolean.valueOf(this.g));
      parambitz.a.putExtra("KEY_VIDEO_STORY_CAMERA_TYPE", Boolean.valueOf(this.jdField_a_of_type_Bigb.a().isLandTakePicToVideo()));
      if (!this.jdField_a_of_type_Boolean) {
        break label200;
      }
    ...
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo != null) {
        this.jdField_a_of_type_Bigb.a().setVideoDuration(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mDuration);
      }
      return;
      bool1 = false;
      break;
      label200:
      if ((this.jdField_a_of_type_Wyr != null) && (this.jdField_a_of_type_Wyr.a() != null))
      {
        localObject = this.jdField_a_of_type_Wyr.a();
        parambitz.a.backgroundMusicOffset = ((VsMusicItemInfo)localObject).musicStart;
        ...
        if (!this.g)
        {
          ...
          j = Math.min(j, (int)this.jdField_a_of_type_Bigb.a(paramInt));
        }
        parambitz.a.backgroundMusicDuration = j;
        parambitz.a.backgroundMusicPath = ((VsMusicItemInfo)localObject).getLocalPath();
        parambitz.a.putExtra("vs_publish_entry_json_key_music_id", Integer.valueOf(((VsMusicItemInfo)localObject).mItemId));
        parambitz.a.putExtra("vs_publish_entry_json_key_music_mid_id", ((VsMusicItemInfo)localObject).mSongMid);
        parambitz.a.putExtra("vs_publish_entry_json_key_song_name", ((VsMusicItemInfo)localObject).mMusicName);
        parambitz.a.putExtra("vs_publish_entry_json_key_music_album_pic", ((VsMusicItemInfo)localObject).mAlbumUrl);
        parambitz.a.putExtra("vs_publish_entry_json_key_music_download_url", ((VsMusicItemInfo)localObject).mUrl);
        parambitz.a.putExtra("vs_publish_entry_json_key_music_source_from", Integer.valueOf(((VsMusicItemInfo)localObject).jdField_a_of_type_Int));
        parambitz.a.putExtra("originalRecordVolume", Float.valueOf(a(1)));
        parambitz.a.putExtra("backgroundVolume", Float.valueOf(a(2)));
        this.jdField_a_of_type_Bigb.a().setSongMid(((VsMusicItemInfo)localObject).mSongMid);
        this.jdField_a_of_type_Bigb.a().setMusicType(((VsMusicItemInfo)localObject).jdField_a_of_type_Int);
        this.jdField_a_of_type_Bigb.a().setMusciPlayTime(System.currentTimeMillis() - this.jdField_f_of_type_Long);
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Wyr != null) {
      this.jdField_a_of_type_Wyr.b(paramLong);
    }
  }
  ...
  public void a(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    if ((this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo != null) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      bbmy.a(BaseApplicationImpl.sApplication, this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo.jdField_c_of_type_JavaLangString, 1).a();
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    do
    {
      ...
      a(paramVsMusicItemInfo);
      if (this.jdField_a_of_type_Xaf != null) {
        this.jdField_a_of_type_Xaf.b(true);
      }
    } while ((this.jdField_a_of_type_Wyr == null) || (this.jdField_a_of_type_Boolean));
    this.jdField_a_of_type_Wyr.a(a(2));
    this.jdField_a_of_type_Wyr.a(paramVsMusicItemInfo);
  }
  ...
  public void a(List<META.StMusic> paramList)
  {
    ...
    if (((paramList == null) || (paramList.size() == 0)) && (this.jdField_a_of_type_Xac.a() == 0))
    {
  ...
  public void b()
  {
    ...
    while (this.jdField_a_of_type_Wyr == null) {
      return;
    }
    if (this.jdField_a_of_type_Xaf != null)
    {
