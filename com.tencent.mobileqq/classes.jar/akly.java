...
public class akly
{
  ...
  public long a;
  private aklz jdField_a_of_type_Aklz = new aklz();
  ...
  public aklz a(int paramInt1, int paramInt2)
  {
    if (this.jdField_f_of_type_Boolean)
    {
      ...
      localObject2 = new aklz();
      ((aklz)localObject2).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((aklz)localObject2).a("CAMERA_MATRIX", arrayOfFloat2);
      ((aklz)localObject2).a("CAMERA_POSITION", localObject1);
      ((aklz)localObject2).a("POSE", arrayOfFloat1);
      return localObject2;
    }
    if (paramInt1 == 100)
    {
      ...
      ((aklz)localObject2).a("CAMERA_POSITION", localObject1);
      ((aklz)localObject2).a("POSE", arrayOfFloat1);
      ((aklz)localObject2).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject2;
    }
    if (paramInt1 == 8)
    {
      localObject1 = new aklz();
      this.jdField_b_of_type_Int = 1;
      arrayOfFloat1 = new float[jdField_a_of_type_Int];
      arrayOfFloat2 = new float[jdField_a_of_type_Int];
      ...
      Matrix.setIdentityM(arrayOfFloat1, 0);
      ((aklz)localObject1).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((aklz)localObject1).a("CAMERA_MATRIX", localObject2);
      ((aklz)localObject1).a("CAMERA_POSITION", arrayOfFloat1);
      ((aklz)localObject1).a("POSE", arrayOfFloat2);
      ((aklz)localObject1).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject1;
    }
    ...
    if ((this.jdField_h_of_type_Boolean) && (((paramInt2 == 0) && (!this.jdField_c_of_type_Boolean)) || (paramInt2 == 2) || ((paramInt2 == 1) && (!this.jdField_d_of_type_Boolean))))
    {
      ...
      localaklz = new aklz();
      localaklz.a("TARGET_SIZE", localObject1);
      localaklz.a("CAMERA_MATRIX", localObject2);
      localaklz.a("CAMERA_POSITION", arrayOfFloat1);
      localaklz.a("POSE", arrayOfFloat2);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aklz.a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
    this.jdField_a_of_type_Aklz.a("POSE", arrayOfFloat1);
    this.jdField_a_of_type_Aklz.a("CAMERA_MATRIX", arrayOfFloat2);
    this.jdField_a_of_type_Aklz.a("CAMERA_POSITION", arrayOfFloat3);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
  }
  
  public void a(int paramInt1, int paramInt2, akpn paramakpn)
  {
    ...
    float f3;
    if (paramInt2 == 0) {
      if ((paramakpn.jdField_a_of_type_Int == 0) || (paramakpn.jdField_b_of_type_Int == 0))
      {
        this.k[0] = akwv.jdField_a_of_type_Int;
        this.k[1] = akwv.jdField_b_of_type_Int;
        paramakpn = new float[jdField_a_of_type_Int];
        Matrix.setIdentityM(paramakpn, 0);
        Matrix.perspectiveM(paramakpn, 0, 45.0F, 1.0F * akwv.jdField_b_of_type_Int / akwv.jdField_a_of_type_Int, 100.0F, 8000.0F);
        float[] arrayOfFloat = new float[16];
        Matrix.setRotateM(arrayOfFloat, 0, 270.0F, 0.0F, 0.0F, 1.0F);
        Matrix.multiplyMM(this.l, 0, arrayOfFloat, 0, paramakpn, 0);
        if (paramInt2 != 0) {
          break label659;
        }
        f1 = 1.25F;
        if (this.k[0] <= akwv.jdField_a_of_type_Int) {
          break label665;
        }
        f2 = this.k[0];
        if (this.k[0] == 0.0F) {
        ...
        f3 = this.k[1] / this.k[0] / (1.0F * akwv.jdField_b_of_type_Int / akwv.jdField_a_of_type_Int);
        label233:
        if ((f3 <= 1.0F) || (this.k[1] <= akwv.jdField_b_of_type_Int)) {
          break label680;
        }
        f1 *= f3;
      }
    ...
    for (;;)
    {
      ...
      paramakpn = new float[jdField_a_of_type_Int];
      Matrix.setIdentityM(paramakpn, 0);
      Matrix.translateM(paramakpn, 0, this.k[1] / 2.0F, -this.k[0] / 2.0F, -f2 / 2.0F * 2.414214F * f1);
      Matrix.rotateM(paramakpn, 0, 90.0F, 0.0F, 0.0F, 1.0F);
      System.arraycopy(paramakpn, 0, this.m, 0, jdField_a_of_type_Int);
      ...
      System.arraycopy(this.n, 0, this.j, 0, jdField_a_of_type_Int);
      return;
      this.k[0] = paramakpn.jdField_a_of_type_Int;
      this.k[1] = paramakpn.jdField_b_of_type_Int;
      break;
  ...
  public void a(aklw paramaklw)
  {
    ...
    paramaklw = (aklu)paramaklw;
    this.jdField_c_of_type_Int = paramaklw.jdField_a_of_type_Int;
    this.jdField_g_of_type_ArrayOfFloat[0] = paramaklw.jdField_a_of_type_Float;
    this.jdField_g_of_type_ArrayOfFloat[1] = paramaklw.jdField_b_of_type_Float;
    System.arraycopy(paramaklw.jdField_b_of_type_ArrayOfFloat, 0, this.jdField_h_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    System.arraycopy(paramaklw.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_i_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
    System.arraycopy(paramaklw.jdField_a_of_type_ArrayOfFloat, 0, this.j, 0, jdField_a_of_type_Int);
  }
  
  public void a(boolean paramBoolean, aklv paramaklv)
  {
    QLog.i("AREngine_ARRenerArumentManager", 1, "start. trackMode = " + paramaklv.jdField_b_of_type_Int + ", arType = " + paramaklv.jdField_a_of_type_Int + ", isObjectAnim = " + paramBoolean);
    this.jdField_f_of_type_Boolean = paramBoolean;
    this.jdField_b_of_type_Int = paramaklv.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramaklv.jdField_c_of_type_Int;
    this.jdField_h_of_type_Boolean = false;
    if ((this.jdField_f_of_type_Boolean) || (paramaklv.jdField_a_of_type_Int == 100) || (paramaklv.jdField_a_of_type_Int == 8))
    {
      this.jdField_g_of_type_Boolean = true;
      return;
    }
    Object localObject;
    if (paramaklv.jdField_a_of_type_Int == 0)
    {
      localObject = (akmh)paramaklv;
      a(this.jdField_b_of_type_Int, paramaklv.jdField_a_of_type_Int, ((akmh)localObject).a);
    }
    for (;;)
    {
      this.jdField_g_of_type_Boolean = true;
      return;
      if ((paramaklv.jdField_a_of_type_Int == 2) || (paramaklv.jdField_a_of_type_Int == 3))
      {
        localObject = (akmq)paramaklv;
        a(this.jdField_b_of_type_Int, paramaklv.jdField_a_of_type_Int, ((akmq)localObject).a);
      }
      else if (paramaklv.jdField_a_of_type_Int == 4)
      {
        localObject = (akmt)paramaklv;
        a(this.jdField_b_of_type_Int, paramaklv.jdField_a_of_type_Int, ((akmt)localObject).a);
      }
    }
  }
