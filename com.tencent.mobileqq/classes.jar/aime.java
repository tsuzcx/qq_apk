...
public final class aime
  implements aimo, Handler.Callback, INetInfoHandler
{
  ...
  public aime(QQAppInterface paramQQAppInterface)
  {
  ...
  private byte[] a(short paramShort, String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).mqqver.set("8.2.6");
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).distribute_ts.set(this.jdField_a_of_type_Aimf.jdField_a_of_type_Long);
    ...
    ((CmGameMsgTunnel.TunnelMsgStream)localObject).sign.set(this.jdField_a_of_type_Aimf.b);
    ...
    try
    {
      paramString = aing.a(paramString, this.jdField_a_of_type_Aimf.jdField_a_of_type_JavaLangString);
  ...
  {
    ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().a(paramTunnelMsgStream);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Aimf.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_Aimf.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      QLog.e("CmGameConnManager", 1, "[createConnection] no connection host");
      return false;
    }
    aimq localaimq = new aimq();
    localaimq.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Aimf.jdField_a_of_type_JavaUtilList;
    localaimq.jdField_a_of_type_Int = this.jdField_a_of_type_Aimf.jdField_a_of_type_Int;
    localaimq.b = 10000;
    localaimq.c = 3000;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection == null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection = new CmGameSocketConnection(localaimq);
    }
    for (;;)
    {
      ...
      return true;
      this.jdField_a_of_type_ComTencentMobileqqApolloLightGameCmGameSocketConnection.a(localaimq);
    }
  }
  ...
  private void f()
  {
    for (;;)
    {
      try
      {
        ...
        this.b = true;
        if (!badq.e(BaseApplicationImpl.getApplication().getApplicationContext()))
        {
        ...
        {
          ((baot)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).e();
        }
      }
      finally {}
    }
  ...
  public void a(aimf paramaimf)
  {
    ...
    for (;;)
    {
      return;
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Aimf = paramaimf;
      }
  ...
  public void a(MsfSocketInputBuffer paramMsfSocketInputBuffer)
  {
    ...
    if (s == 6)
    {
      ...
      paramMsfSocketInputBuffer = this.jdField_a_of_type_Befq.obtainMessage(5);
      paramMsfSocketInputBuffer.obj = Boolean.valueOf(true);
      this.jdField_a_of_type_Befq.sendMessage(paramMsfSocketInputBuffer);
      return;
    }
    ...
    try
    {
      paramMsfSocketInputBuffer = aing.b((byte[])localObject, this.jdField_a_of_type_Aimf.jdField_a_of_type_JavaLangString);
  ...
  {
    boolean bool = badq.e(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      this.jdField_a_of_type_Befq.removeMessages(7);
      this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(7, 130000L);
      a("page_tag_match");
      if ((a()) && (paramBoolean2)) {
        a();
      }
  ...
  public void b()
  {
    QLog.d("CmGameConnManager", 1, new Object[] { "[onGetConnInfoFailed] mShouldKeepConnect=", Boolean.valueOf(this.jdField_a_of_type_Boolean), ", mConnInfo=", this.jdField_a_of_type_Aimf });
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aimf != null)) {}
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() == 0)
      {
        this.jdField_a_of_type_Befq.removeMessages(1);
        this.jdField_a_of_type_Befq.removeMessages(2);
        this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(2, 2000L);
      }
      return;
    }
    finally
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int <= 2))
    {
      ...
      this.jdField_a_of_type_Befq.removeMessages(1);
      this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(1, 10000L);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 5: 
      ...
      if ((paramMessage.obj != null) && (((Boolean)paramMessage.obj).booleanValue()))
      {
        ...
        this.jdField_a_of_type_Aimf = null;
      }
      i();
      return false;
    case 7: 
    ...
    bbmy.a(BaseApplicationImpl.getContext(), (String)paramMessage.obj, 0).a();
    return false;
  }
