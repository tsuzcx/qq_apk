...
public class azaw
{
  ...
  public static HashMap<Integer, HashMap<Integer, bjha>> a;
  ...
  public static List<Integer> a(Map<Integer, bjha> paramMap)
  {
  ...
  public static Map<Integer, String> a(long paramLong)
  {
    ...
    Map localMap = azay.a(LocalMultiProcConfig.getString("EXTEND_INFO" + paramLong, ""));
    if (a(paramLong)) {
  ...
  public static void a(mobile_count_rsp_new parammobile_count_rsp_new)
  {
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.vec_soft_infos != null) && (parammobile_count_rsp_new.vec_soft_infos.size() != 0))
    {
      ...
      LocalMultiProcConfig.putString("qzone_soft_infos", bdfr.encodeToString(localJceOutputStream.toByteArray(), 0));
    }
  }
  ...
  private static void a(mobile_count_rsp_new parammobile_count_rsp_new, azby paramazby)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (paramazby == null);
        if (parammobile_count_rsp_new.iNextTimeout > 0)
        {
          paramazby.jdField_a_of_type_Long = (parammobile_count_rsp_new.iNextTimeout * 1000);
          if (QLog.isColorLevel()) {
            QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getFeedInterval:" + paramazby.jdField_a_of_type_Long);
          }
        }
      } while (parammobile_count_rsp_new.switchTimeout <= 0);
      paramazby.jdField_b_of_type_Long = (parammobile_count_rsp_new.switchTimeout * 1000);
    } while (!QLog.isColorLevel());
    QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getActiveAppInterval:" + paramazby.jdField_b_of_type_Long);
  }
  ...
  public static void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, QQAppInterface paramQQAppInterface, azby paramazby)
  {
    ...
    do
    {
      ...
      {
        return;
        paramFromServiceMsg = azat.a(paramIntent, paramQQAppInterface, "getUndealCount");
    ...
    aufx localaufx = (aufx)paramQQAppInterface.getManager(10);
    if (localaufx != null) {
      localaufx.b(0);
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      long l = System.currentTimeMillis();
      HashMap localHashMap = new HashMap();
      azri.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", true, l - azby.c, 0L, localHashMap, "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, Long paramLong)
  {
    ...
    do
    {
      ...
      } while ((paramQQAppInterface == null) || (!(paramQQAppInterface instanceof azbw)));
    ...
    {
      bjha localbjha = (bjha)localHashMap.get(Integer.valueOf(1));
      localbjha.jdField_a_of_type_Long = paramLong.longValue();
      localHashMap.put(Integer.valueOf(1), localbjha);
    }
    ((azbw)paramQQAppInterface).a(localHashMap);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, FromServiceMsg paramFromServiceMsg, azby paramazby)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    if (paramazby != null) {
      paramazby.notifyObserver(null, 1000, false, new Bundle(), avvd.class);
    }
    if (paramQQAppInterface != null)
    {
      ...
      azri.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, azby.d - azby.c, 0L, paramFromServiceMsg, "");
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, azby paramazby)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    ...
    if (paramQQAppInterface != null)
    {
      paramArrayOfByte = "|wufbuf: " + bdhe.a(paramArrayOfByte);
      paramazby = new HashMap();
      paramazby.put("param_FailCode", String.valueOf(9045));
      paramazby.put("param_errorDesc", paramArrayOfByte);
      azri.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, azby.d - azby.c, 0L, paramazby, "");
    }
  }
  
  public static void a(String paramString) {}
  
  private static void a(String paramString, azby paramazby)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (paramazby == null) {
      return;
    ...
    paramazby.notifyObserver(null, 1003, true, localBundle, avvd.class);
  }
  ...
  public static void a(String paramString, ArrayList<String> paramArrayList)
  {
    ...
    {
      paramArrayList = bdnn.a(paramArrayList, ",");
    ...
    if (paramArrayList != null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localoperat_data != null)
        {
          ...
          localbjuy.jdField_a_of_type_Int = localoperat_data.cmd;
          if ((localoperat_data.mapExt != null) && (localoperat_data.mapExt.size() > 0)) {
            localbjuy.jdField_a_of_type_JavaUtilMap.putAll(localoperat_data.mapExt);
          }
          localbjuy.jdField_a_of_type_JavaUtilMap.put("key_desc", localoperat_data.desc);
  ...
  private static void a(byte[] paramArrayOfByte, mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface, azby paramazby)
  {
    HashMap localHashMap = new HashMap();
    boolean bool = a(parammobile_count_rsp_new, localHashMap, paramQQAppInterface);
    int i = 0;
    if (bool) {
      i = bjqu.a().a().a(paramQQAppInterface.getLongAccountUin());
    }
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof azbw)))
    {
      ((azbw)paramArrayOfByte).a(localHashMap);
      if (QLog.isColorLevel()) {
    ...
    label129:
    a(paramQQAppInterface, paramArrayOfByte, paramazby);
  }
  ...
  public static boolean a(int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localazax.a())
      {
        ...
        if (localazax.jdField_a_of_type_Int <= 0) {
          break label53;
        }
        bool1 = bool2;
      }
  ...
  private static boolean a(long paramLong)
  {
    ...
    try
    {
      localObject = (stNuanNuanComment)b(stNuanNuanComment.class, bdfr.decode((String)localObject, 0));
  ...
  public static boolean a(mobile_count_rsp_new parammobile_count_rsp_new, HashMap<Integer, bjha> paramHashMap, QQAppInterface paramQQAppInterface)
  {
    if (QLog.isDevelopLevel()) {
    ...
    if (localcount_info != null)
    {
      ...
      {
        localbjha.jdField_a_of_type_Long = localcount_info.stCount.uCount;
        localbjha.jdField_a_of_type_Int = localcount_info.stCount.iControl;
        if (QLog.isDevelopLevel())
        {
        ...
        if ((i == 1) && (localbjha.jdField_a_of_type_Long > 0L) && (paramQQAppInterface != null) && (parammobile_count_rsp_new.isPreLoad == 1) && (!TextUtils.isEmpty(parammobile_count_rsp_new.undealCountTime)) && (!LocalMultiProcConfig.getString4Uin("qzone_passive_undealtime", "", paramQQAppInterface.getLongAccountUin()).equals(parammobile_count_rsp_new.undealCountTime)))
        {
          bool1 = true;
          label466:
          ...
          if (parammobile_count_rsp_new.mapTransData != null)
          {
            ...
            if (arrayOfByte != null) {
              localObject = (PassiveFeedsPush)bjuf.a(PassiveFeedsPush.class, arrayOfByte);
            }
          }
          if ((localcount_info.vecUinList != null) && (localcount_info.vecUinList.size() > 0))
          {
            ...
            while (j < localcount_info.vecUinList.size())
            {
              ...
              localbjha.jdField_a_of_type_JavaUtilArrayList.add(localQZoneCountUserInfo);
              j += 1;
            }
            localbjha.jdField_a_of_type_JavaLangString = ((feed_host_info)localcount_info.vecUinList.get(0)).actiondesc;
            if (QLog.isDevelopLevel()) {
          ...
          localbjha.jdField_b_of_type_JavaLangString = localcount_info.trace_info;
          localbjha.c = localcount_info.iSubCountID;
          localbjha.f = localcount_info.strShowMsg;
          localbjha.g = localcount_info.strReportValue;
          localbjha.e = localcount_info.strIconUrl;
          localbjha.jdField_b_of_type_Long = localcount_info.cTime;
          paramHashMap.put(Integer.valueOf(i), localbjha);
        }
      }
    }
    for (;;)
  ...
  public static byte[] a(long paramLong, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Map<Integer, count_info> paramMap, String paramString2, Map<Long, Long> paramMap1)
  {
    ...
    return azat.a(paramString1, "getUndealCount", paramLong, paramInt1, paramInt2, paramInt4);
  }
  ...
  public static void b(int paramInt, QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if (str != null)
      {
        ...
        bjup.a();
        paramQQAppInterface = (aufx)paramQQAppInterface.getManager(10);
        if ((paramInt & 0x80) == 0) {
          break label84;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((parammobile_count_rsp_new.snnComment != null) && (parammobile_count_rsp_new.snnComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_comment_info", bdfr.encodeToString(localJceOutputStream.toByteArray(), 0), paramLong);
        ...
        if ((parammobile_count_rsp_new.sContentOpComment != null) && (parammobile_count_rsp_new.sContentOpComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_operation_comment_info", bdfr.encodeToString(((JceOutputStream)localObject).toByteArray(), 0), paramLong);
          return;
        }
      }
  ...
  private static void d(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    bjfh.a().a(parammobile_count_rsp_new.stYellowInfo.iYellowType, parammobile_count_rsp_new.stYellowInfo.iYellowLevel, parammobile_count_rsp_new.stYellowInfo.isAnnualVip, parammobile_count_rsp_new.stuStarInfo, parammobile_count_rsp_new.stuCombineDiamondInfo);
  }
  ...
  private static void i(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.length > 0))
    {
      ...
      bjuf.a((JceStruct)localObject, parammobile_count_rsp_new);
