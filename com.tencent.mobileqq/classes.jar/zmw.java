...
public class zmw
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      zmu localzmu = (zmu)paramQQAppInterface.getManager(208);
      String str = a(paramString);
      paramString = localzmu.a(paramString);
      if (paramString != null) {
  ...
  {
    return ("gs_" + paramMessageForShortVideo.frienduin + '_' + paramMessageForShortVideo.getMd5() + '_' + bjtz.d(paramMessageForShortVideo.uuid) + "-700").toLowerCase();
  }
  ...
  {
    return (wjb.i()) && (paramInt == 1) && ((paramMessageRecord instanceof MessageForShortVideo)) && (((MessageForShortVideo)paramMessageRecord).busiType == 1);
  }
