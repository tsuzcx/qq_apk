...
public class nyf
  extends aczw
{
  public nyf(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  public void a(long paramLong, List<msg_comm.Msg> paramList)
  {
    ...
    {
      localobj = obj.a();
      l2 = localobj.a(this.a, String.valueOf(paramLong));
      l1 = l2;
      if (l2 == 0L) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (l3 < l1)
        {
          ...
          if (l3 != 0L)
          {
            localobj.a(this.a, String.valueOf(paramLong), l3);
            l2 = l3;
          }
        }
        l1 = l2;
