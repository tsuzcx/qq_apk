...
public class amte
  implements bkhw
{
  public amte(CmGameFloatView paramCmGameFloatView) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    default: 
      return;
    case 0: 
      if ((this.a.jdField_a_of_type_Amrk != null) && (this.a.jdField_a_of_type_Amrk.a()))
      {
        QLog.d("cmframe_CmGameFloatView", 1, "pack up game");
        this.a.f();
        if (this.a.jdField_a_of_type_Amnt != null) {
          this.a.jdField_a_of_type_Amnt.c();
        }
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        return;
        paramView = this.a.jdField_a_of_type_Amrk.a();
      ...
      if ((this.a.jdField_a_of_type_Amrk != null) && (this.a.jdField_a_of_type_Amrk.a()) && (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {}
      try
      {
        ...
        this.a.jdField_a_of_type_Amrk.b(paramView.toString());
        if (this.a.jdField_a_of_type_Amnt != null) {
          this.a.jdField_a_of_type_Amnt.b();
        }
        if (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
        {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        PublicFragmentActivity.a(this.a.jdField_a_of_type_Amrk.a(), paramView, ApolloGameInfoFragment.class, 10000);
        if (this.a.jdField_a_of_type_Amnt == null) {
          break;
        }
        this.a.jdField_a_of_type_Amnt.d();
        return;
        paramInt = 0;
        break label518;
      }
      ...
      if ((!TextUtils.isEmpty(paramView)) && (localActivity != null)) {
        ampj.b(localActivity, paramView);
      }
      for (paramInt = 0;; paramInt = 1)
      {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        if ((bool2) || (!amlz.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam))) {
          break label1082;
        }
        paramView.b(true);
        return;
