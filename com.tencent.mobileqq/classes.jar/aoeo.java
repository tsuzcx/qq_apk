  ...
  extends ajtd
{
  ...
  private Card a(String paramString1, String paramString2, String paramString3, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Card localCard = localajxn.c(paramString1);
  ...
  private void a(List<Long> paramList1, int paramInt1, int paramInt2, List<Long> paramList2)
  {
    ...
    for (;;)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        arrayOfByte = localawzw.c(String.valueOf(localLong), (String)localObject);
        if (arrayOfByte != null)
        {
  ...
  private void a(oidb_0xe03.MatchUinData paramMatchUinData, aofc paramaofc)
  {
    int j = 0;
    if ((paramMatchUinData == null) || (paramaofc == null))
    {
    ...
    if (paramMatchUinData.uint32_age.has())
    {
      ...
      label279:
      if (localObject != null) {
        paramaofc.i = RichStatus.parseStatus((byte[])localObject).getPlainText();
      }
      if (!paramMatchUinData.uint32_sex.has()) {
        break label516;
      }
      paramaofc.jdField_a_of_type_Int = paramMatchUinData.uint32_sex.get();
    }
    for (;;)
    {
      ...
      while (i < paramMatchUinData.rpt_tag.size())
      {
        if (((oidb_0xe03.ProfileTagInfo)paramMatchUinData.rpt_tag.get(i)).bytes_tag.has())
        {
          ...
          aogg localaogg = new aogg();
          localaogg.jdField_a_of_type_Int = j;
          localaogg.jdField_a_of_type_JavaLangString = str;
          ((ArrayList)localObject).add(localaogg);
        }
        i += 1;
      }
      localObject = "";
      ...
      break label279;
      label516:
      paramaofc.jdField_a_of_type_Int = 0;
      QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 2, "mGender  is null. set 0  ");
    }
    label534:
    if (QLog.isColorLevel()) {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "ChatFriendInfo. " + paramaofc.toString());
    }
    paramaofc.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord != null) && ((paramMessageRecord instanceof MessageForLimitChatConfirm)))
    {
      ...
      {
        localObject1 = new aofq();
        ((aofq)localObject1).jdField_a_of_type_Boolean = paramMessageRecord.bEnterMsg;
        ((aofq)localObject1).jdField_a_of_type_Int = paramMessageRecord.leaveChatType;
        ((aofq)localObject1).jdField_a_of_type_Long = paramMessageRecord.timeStamp;
        ((aofq)localObject1).jdField_a_of_type_JavaLangString = paramMessageRecord.frienduin;
        ((aofq)localObject1).jdField_b_of_type_JavaLangString = paramMessageRecord.SenderNickName;
        ((aofq)localObject1).d = paramMessageRecord.c2cExpiredTime;
        ((aofq)localObject1).jdField_b_of_type_Int = paramMessageRecord.leftChatTime;
        ((aofq)localObject1).jdField_c_of_type_JavaLangString = paramMessageRecord.tipsWording;
        ((aofq)localObject1).jdField_c_of_type_Int = paramMessageRecord.matchExpiredTime;
        ((aofq)localObject1).jdField_b_of_type_Long = paramMessageRecord.readyTs;
        QLog.i("ExtendFriendHandlerExtendFriendLimitChat", 2, "HandleC2CConfirmOrCancelMsg  info：" + ((aofq)localObject1).toString());
        i = 1;
        j = i;
        if (!bbet.b(paramMessageRecord.issend)) {
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    {
      bcpw.a(this.app.getApp(), 1, 2131694607, 0).a();
  ...
  public void a(String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2, long paramLong, String paramString3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localReqBody.bytes_req_buff.set(ByteStringMicro.copyFrom(bhzc.a().a()));
      ...
      if ((!TextUtils.isEmpty(paramString3)) && (paramString3.equals(paramString1)))
      {
        ...
        {
          paramInt = 1;
          axqw.b(paramString1, "dc00898", "", "", "0X8009423", "0X8009423", paramInt, 0, "", "", paramString2, "");
          return;
  ...
  public void a(submsgtype0x128.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      ...
      localaofp.jdField_a_of_type_JavaLangString = this.app.c();
      localaofp.jdField_a_of_type_ArrayOfByte = paramMsgBody.bytes_sig.get().toByteArray();
      String str;
      label91:
      long l;
      label116:
      ...
      if (paramMsgBody.uint64_match_uin.has())
      {
        ...
        localaofp.jdField_b_of_type_Int = paramMsgBody.msg_tag.uint32_tag_id.get();
        ...
        localaofp.jdField_a_of_type_Aofc = new aofc();
        localaofp.jdField_a_of_type_Aofc.jdField_a_of_type_JavaLangString = localaofp.jdField_b_of_type_JavaLangString;
        a(paramMsgBody.msg_match_uin_data, localaofp.jdField_a_of_type_Aofc);
      }
      for (;;)
      {
        str = "";
        ...
        localaofp.e = paramMsgBody;
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleGetUnlimitMatchOfflinePush push matchInfo = ", localaofp });
        }
        paramMsgBody = (aoix)this.app.getManager(292);
        if (paramMsgBody != null) {
          paramMsgBody.a();
        }
        notifyUI(16, true, new Object[] { localaofp });
        return;
        str = "0";
        break;
        label427:
        ...
        break label241;
        label461:
        localaofp.jdField_b_of_type_Int = 1;
  ...
  public void b()
  {
    ...
    if (!asfj.a(this.app, "matchchat_redpoint_show")) {
      asfj.a(this.app, "matchchat_redpoint_show", true);
    }
    c();
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localaogh = new aogh();
          localaogh.mUin = String.valueOf(localStrangerInfo.uint64_uin.get());
          localaogh.mNickName = localStrangerInfo.bytes_nick.get().toStringUtf8();
          localaogh.mGender = localStrangerInfo.uint32_gender.get();
          if (localStrangerInfo.uint32_is_my_like.get() != 1) {
            break label775;
          }
          bool4 = true;
          localaogh.mLiked = bool4;
          localaogh.mAvailLikeCount = localStrangerInfo.uint32_my_left_like_count.get();
          if (localStrangerInfo.uint32_addfri_status.get() != 1) {
            break label781;
          }
          bool4 = true;
          localaogh.mAddFriendVerified = bool4;
          localaogh.mPopularity = localStrangerInfo.uint32_popularity.get();
          localaogh.mDeclaration = localStrangerInfo.bytes_declaration.get().toStringUtf8();
          localaogh.mVoiceUrl = localStrangerInfo.bytes_voice_url.get().toStringUtf8();
          localaogh.mVoiceDuration = localStrangerInfo.uint32_voice_duration.get();
          if (localStrangerInfo.uint32_vote_switch.get() != 0) {
            break label787;
          }
          bool4 = true;
          localaogh.mbAllowStrangerVote = bool4;
          localaogh.mStrRecomTrace = localStrangerInfo.str_recom_trace.get();
          if (!TextUtils.isEmpty(localaogh.mDeclaration))
          {
            localaogh.mDeclaration = localaogh.mDeclaration.replace('\n', ' ');
            localaogh.mDeclaration = localaogh.mDeclaration.trim();
          }
          if (localStrangerInfo.uint32_show_vip_info_flag.get() != 0) {
            break label793;
          }
          bool4 = true;
          localaogh.mVipHide = bool4;
        ...
        localaogh.mBigVipHide = bool4;
        localaogh.mBigVipLevel = localStrangerInfo.uint32_bigvip_level.get();
        localaogh.mVipType = localStrangerInfo.uint32_vip_flag.get();
        localaogh.mVipLevel = localStrangerInfo.uint32_svip_level.get();
        localaogh.mTemplateId = localStrangerInfo.uint32_vipicon_id.get();
        if (localStrangerInfo.bytes_ad_content.has())
        {
          ...
          localaogh.mAlumbasicdata = paramToServiceMsg;
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: " + localaogh.mUin + " " + localStrangerInfo.uint32_vip_flag.get() + " " + localStrangerInfo.uint32_svip_level.get());
          }
          if ((!TextUtils.isEmpty(localaogh.mNickName)) || (localaogh.mAlumbasicdata != null))
          {
            localArrayList.add(localaogh);
            continue;
            aokk.a().c(paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode());
            return;
            bool1 = false;
            continue;
            bool2 = false;
        ...
        if (QLog.isColorLevel()) {
          QLog.w("ExtendFriendHandler", 2, String.format("handleGetSquareStrangerList nick name is empty, uin=%s", new Object[] { localaogh.mUin }));
        }
      }
      paramToServiceMsg = new aofo();
      ...
      if (n <= 12)
      {
        ...
        {
          paramToServiceMsg.jdField_a_of_type_JavaUtilList.add(((aogh)((List)localObject1).get(i)).mUin);
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      if (i < n)
      {
        ...
        break label1283;
        if (this.app != null) {
          ((aoix)this.app.getManager(292)).a(true, paramToServiceMsg);
        }
        if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    notifyUI(17, true, Integer.valueOf(asfj.a(this.app)));
  }
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   332: lload 8
    //   334: iload 5
    //   336: invokespecial 669	aoeo:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJI)Lcom/tencent/mobileqq/data/Card;
    //   339: astore 11
    //   341: new 1015	aogh
    //   344: dup
    //   345: invokespecial 1016	aogh:<init>	()V
    //   348: astore 10
    //   350: aload 10
    //   352: aload 13
    //   354: putfield 1020	aogh:mUin	Ljava/lang/String;
    //   357: aload 10
    //   359: aload_2
    //   360: putfield 1058	aogh:mDeclaration	Ljava/lang/String;
    //   363: aload 10
    //   365: aload_3
    //   366: putfield 1062	aogh:mVoiceUrl	Ljava/lang/String;
    //   369: aload 10
    //   371: iload 4
    //   373: putfield 1054	aogh:mPopularity	I
    //   376: aload 10
    //   378: iload 5
    //   380: putfield 1066	aogh:mVoiceDuration	I
    //   383: aload 10
    //   385: aload 12
    ...
    //   393: putfield 1030	aogh:mGender	I
    //   396: aload 10
    //   398: aload 12
    ...
    //   406: putfield 1024	aogh:mNickName	Ljava/lang/String;
    //   409: aload 12
    ...
    //   423: aload 10
    //   425: iload 7
    //   427: putfield 1088	aogh:mVipHide	Z
    //   430: aload 12
    ...
    //   455: aload 10
    //   457: iload 7
    //   459: putfield 1097	aogh:mBigVipHide	Z
    //   462: aload 10
    //   464: aload 12
    ...
    //   472: putfield 1103	aogh:mBigVipLevel	I
    //   475: aload 10
    //   477: aload 12
    ...
    //   485: putfield 1109	aogh:mVipType	I
    //   488: aload 10
    //   490: aload 12
    ...
    //   498: putfield 1115	aogh:mVipLevel	I
    //   501: aload 10
    //   503: aload 12
    ...
    //   511: putfield 1121	aogh:mTemplateId	I
    //   514: aload 10
    //   516: astore_2
    //   517: aload 11
    //   519: astore_3
    ...
    //   542: aload 10
    //   544: getfield 1020	aogh:mUin	Ljava/lang/String;
    ...
    //   653: iload 7
    //   655: aload_3
    //   656: invokevirtual 451	aoeo:notifyUI	(IZLjava/lang/Object;)V
    //   659: aload_0
    //   660: bipush 9
    //   662: iload 7
    //   664: iconst_2
    ...
    //   688: aastore
    //   689: invokevirtual 451	aoeo:notifyUI	(IZLjava/lang/Object;)V
    //   692: return
    //   693: iconst_0
    //   694: istore 6
    //   696: goto -622 -> 74
    ...
    do
    {
      ...
      if (j == 0)
      {
        ...
        for (int k = paramToServiceMsg.uint32_match_count.get();; k = -1)
        {
          ...
          if ((aoix)this.app.getManager(292) != null) {}
  ...
  public void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0) {
      if (localRspBody.uint64_allow_kuolie.has())
      {
        ...
        if (this.app != null)
        {
          aojo.a(this.app, bool, j, i, paramToServiceMsg, l2);
          if (bool) {
  ...
  public void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (((oidb_0xe03.RspBody)localObject1).enum_matchopcode.has())
    {
      ...
      localObject2 = new aofp();
      ((aofp)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(((oidb_0xe03.RspBody)localObject1).uint64_uin.get());
      ((aofp)localObject2).jdField_a_of_type_ArrayOfByte = paramObject.bytes_sig.get().toByteArray();
      if (!paramObject.uint64_match_uin.has()) {
        break label764;
      }
      paramToServiceMsg = String.valueOf(paramObject.uint64_match_uin.get());
      ((aofp)localObject2).jdField_b_of_type_JavaLangString = paramToServiceMsg;
      if (!paramObject.bytes_tips_wording.has()) {
        break label771;
      }
      paramToServiceMsg = paramObject.bytes_tips_wording.get().toStringUtf8();
      ((aofp)localObject2).jdField_c_of_type_JavaLangString = paramToServiceMsg;
      if (!paramObject.uint64_time_stamp.has()) {
        break label778;
      }
      l = paramObject.uint64_time_stamp.get();
      label374:
      ((aofp)localObject2).jdField_a_of_type_Long = l;
      if (!paramObject.uint32_match_expired_time.has()) {
        break label786;
      }
      k = paramObject.uint32_match_expired_time.get();
      label400:
      ((aofp)localObject2).jdField_a_of_type_Int = k;
      if (!paramObject.bytes_nick.has()) {
        break label793;
      }
      paramToServiceMsg = paramObject.bytes_nick.get().toStringUtf8();
      label428:
      ((aofp)localObject2).d = paramToServiceMsg;
    ...
    for (paramToServiceMsg = paramObject.string_report_id.get();; paramToServiceMsg = "")
    {
      ...
      ((aofp)localObject2).e = paramObject;
      if (((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.has()) {
        ...
        {
          ((aofp)localObject2).jdField_b_of_type_Int = ((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.uint32_tag_id.get();
          if (((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.bytes_tag.has()) {
            ((aofp)localObject2).f = ((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_tag.bytes_tag.get().toStringUtf8();
          }
          if (!((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_match_uin_data.has()) {
            break label824;
          }
          if (((aofp)localObject2).jdField_a_of_type_Aofc == null)
          {
            ((aofp)localObject2).jdField_a_of_type_Aofc = new aofc();
            ((aofp)localObject2).jdField_a_of_type_Aofc.jdField_a_of_type_JavaLangString = ((aofp)localObject2).jdField_b_of_type_JavaLangString;
          }
          a(((oidb_0xe03.RspBody)localObject1).msg_match_info.msg_match_uin_data, ((aofp)localObject2).jdField_a_of_type_Aofc);
        }
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleMatchResponse TYPE_GET_UNLIMIT_MATCH. uin = ", str, ", match_op = ", Integer.valueOf(i), " retCode = ", Integer.valueOf(j), " matchInfo = ", ((aofp)localObject2).toString(), " errMsg = ", paramFromServiceMsg });
        }
