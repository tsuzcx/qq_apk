...
public class bgbn
  implements View.OnClickListener, bgbo
{
  protected int a;
  protected View a;
  ...
  public bgbn(PublishHomeWorkFragment paramPublishHomeWorkFragment, String paramString)
  {
  ...
  private void a(View paramView)
  {
    ...
    {
      bhju.a("Grp_edu", "homework", "createHW_doc_clk", 0, 0, new String[] { paramView, ((Bundle)localObject).getString("reportIdentity", ""), ((Bundle)localObject).getString("reportCourse", "") });
      return;
    }
  }
  ...
  private boolean b()
  {
    bfzm localbfzm = (bfzm)aran.a().a(605);
    if ((localbfzm != null) && (!localbfzm.b())) {
      return false;
    }
  ...
  private void c(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView != null)
    {
      if (paramBoolean)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(2130837961, 0, 0, 0);
      }
    }
    else {
      return;
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131373174);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131373176));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131372420);
    bfzm localbfzm = (bfzm)aran.a().a(605);
    if (localbfzm != null)
    {
      if (!localbfzm.b()) {
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379410));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131379542));
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131379378);
  ...
  public void a(int paramInt)
  {
    ...
    {
      bhju.a("Grp_edu", "homework", "createHW_doc", 0, 0, new String[] { str, localBundle.getString("reportIdentity", ""), localBundle.getString("reportCourse", "") });
      return;
    }
  }
