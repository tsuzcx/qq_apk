...
public class lxo
{
  ...
  public lxo(RelativeLayout paramRelativeLayout, int paramInt, lxr paramlxr)
  {
  ...
  public void a(long paramLong, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidAnimationObjectAnimator != null)
      {
        ...
        a();
        if (this.jdField_a_of_type_Lxr != null) {
          this.jdField_a_of_type_Lxr.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
        }
        if (!paramBoolean) {
          break label252;
        }
      ...
      for (;;)
      {
        ...
        ((ObjectAnimator)localObject).addListener(new lxq(this, i, paramLong));
      ...
      this.jdField_a_of_type_Boolean = true;
    } while (this.jdField_a_of_type_Lxr == null);
    this.jdField_a_of_type_Lxr.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
  
  public void a(long paramLong, boolean paramBoolean, int paramInt, lxs paramlxs)
  {
    int i = 4;
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramlxs = ajjy.a(2131643150) + this.jdField_a_of_type_Boolean + "], height[" + i + "], seq[" + paramLong + "]";
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, paramlxs, new Throwable("打印调用栈"));
      throw new IllegalArgumentException(paramlxs);
    }
    ((ObjectAnimator)localObject).setDuration(300L);
    ((ObjectAnimator)localObject).addListener(new lxp(this, i, paramLong, paramlxs));
    this.jdField_a_of_type_AndroidAnimationObjectAnimator = ((ObjectAnimator)localObject);
    ((ObjectAnimator)localObject).start();
    this.jdField_a_of_type_Boolean = false;
    if (this.jdField_a_of_type_Lxr != null) {
      this.jdField_a_of_type_Lxr.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
    }
    label319:
    label320:
    do
    {
      ...
      this.jdField_a_of_type_Boolean = false;
    } while ((this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Lxr == null));
    this.jdField_a_of_type_Lxr.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
