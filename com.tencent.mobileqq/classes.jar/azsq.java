  ...
  extends azqk
{
  ...
  public azsq(Collection<azqj> paramCollection)
  {
  ...
  {
    return aekt.a(5.0F, paramResources);
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (int k = 6;; k = 10)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        if (j < k)
        {
          localObject2 = (azqj)((ArrayList)localObject1).get(j);
          ...
          localView = ((azqj)localObject2).a(paramContext, paramView.getChildAt(j), paramBundle);
          if (localView != null) {}
        }
        else
        {
      ...
      for (int j = a(paramContext, k) + i;; j = i)
      {
        ...
        i = j;
        break;
        m = aekt.a(10.0F, localResources);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
        if (j > 0) {
          localLayoutParams.topMargin = a(localResources, j, (azqj)localObject2);
        }
