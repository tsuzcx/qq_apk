...
public class aimd
  extends BaseAdapter
{
  aasw jdField_a_of_type_Aasw;
  Context jdField_a_of_type_AndroidContentContext;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener;
  public ArrayList<Object> a;
  View.OnClickListener b;
  
  public aimd(Context paramContext, ArrayList<Object> paramArrayList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, aasw paramaasw)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof aime)))
      {
        paramViewGroup = (aime)paramView.getTag();
        paramViewGroup.jdField_a_of_type_JavaLangObject = localObject1;
        paramViewGroup.jdField_a_of_type_JavaLangString = ((aasu)this.jdField_a_of_type_Aasw).c;
        ...
        label147:
        if (!this.jdField_a_of_type_Aasw.a()) {
          break label328;
        }
        paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
        paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Aasw.a.a((ChatMessage)localObject1));
    ...
    do
    {
      ...
      paramViewGroup = new aime(this);
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562453, null);
    ...
    for (;;)
    {
      ...
      return paramViewGroup;
      paramViewGroup = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562454, null);
