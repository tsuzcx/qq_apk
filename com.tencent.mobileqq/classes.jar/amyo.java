...
public class amyo
  implements amnv, ampy, Handler.Callback, View.OnKeyListener
{
  public int a;
  public long a;
  private adad jdField_a_of_type_Adad;
  private amri jdField_a_of_type_Amri;
  private amth jdField_a_of_type_Amth;
  private amwq jdField_a_of_type_Amwq;
  private amxf jdField_a_of_type_Amxf;
  private amxj jdField_a_of_type_Amxj;
  private amxv jdField_a_of_type_Amxv;
  private amxx jdField_a_of_type_Amxx;
  private amyk jdField_a_of_type_Amyk;
  private amys jdField_a_of_type_Amys;
  private amzb jdField_a_of_type_Amzb;
  private amzc jdField_a_of_type_Amzc;
  private amzg jdField_a_of_type_Amzg;
  private amzo jdField_a_of_type_Amzo;
  private anah jdField_a_of_type_Anah;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new amyp(this);
  private ankv jdField_a_of_type_Ankv;
  private anmd jdField_a_of_type_Anmd = new amyr(this);
  ...
  private amxf jdField_b_of_type_Amxf;
  ...
  public amyo(int paramInt)
  {
    ...
    if (localamyx != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = localamyx.a();
    ...
    this.jdField_a_of_type_Amzc = new amzc(paramInt);
    this.jdField_e_of_type_Int = paramInt;
    amzh.a();
    this.jdField_a_of_type_Amzo = new amzo(paramInt);
    this.jdField_a_of_type_Amwq = new amwq(paramInt);
  }
  ...
  private void c(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Amys = new amys();
      this.jdField_a_of_type_Amys.g = localJSONObject.optString("payParam");
      ...
      this.jdField_a_of_type_Amys.jdField_a_of_type_Int = localJSONObject.optInt("score", -1);
      this.jdField_a_of_type_Amys.jdField_c_of_type_JavaLangString = localJSONObject.optString("baseUrl");
      this.jdField_a_of_type_Amys.b = localJSONObject.optString("listId");
      this.jdField_a_of_type_Amys.jdField_c_of_type_Int = this.jdField_e_of_type_Int;
      if (amwn.a() != null) {
        this.jdField_a_of_type_Amys.jdField_a_of_type_Long = Long.parseLong(amwn.a().getCurrentAccountUin());
      }
      this.jdField_a_of_type_Amys.e = localJSONObject.optString("nickName", String.valueOf(this.jdField_a_of_type_Amys.jdField_a_of_type_Long));
      if (QLog.isColorLevel()) {
        QLog.d("cmgame_process.CmGameLauncher", 1, "[setRedPacketInfo] " + this.jdField_a_of_type_Amys.toString());
      }
      return;
    }
  ...
  private void n()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      amwn.a(new Object[] { "[startGameEngine], game is not ready, so status:", Boolean.valueOf(this.k) });
    }
    for (;;)
    {
      return;
      Object localObject1;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)) || (!FileUtils.fileExists(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)))
      {
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        ...
        this.i = true;
        this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.init_global_var.local", amwn.b(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams));
        ...
        if (this.jdField_a_of_type_Ankv != null) {
          this.jdField_a_of_type_Ankv.a();
        }
      }
      try
      {
        if (b()) {
          amwn.a().callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
        for (;;)
        {
          o();
          ...
          amwn.a(new Object[] { "[startGameEngine] cost:", Long.valueOf(l) });
          if (l <= 0L) {
            break;
          }
          ...
          return;
          label516:
          localObject1 = String.valueOf(amta.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
          break label241;
          amwn.a().callbackFromRequest(a(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
      }
  ...
  public adad a(long paramLong, Activity paramActivity)
  {
    if (this.jdField_a_of_type_Adad != null) {
      return this.jdField_a_of_type_Adad;
    }
    adai.a();
    this.jdField_a_of_type_Adad = adai.a(paramActivity, 5, String.valueOf(paramLong));
  ...
  public amri a()
  {
    return this.jdField_a_of_type_Amri;
  }
  
  public amwq a()
  {
    return this.jdField_a_of_type_Amwq;
  }
  ...
  public amys a()
  {
    return this.jdField_a_of_type_Amys;
  }
  
  public amzc a()
  {
    return this.jdField_a_of_type_Amzc;
  }
  
  public amzg a()
  {
    if ((this.jdField_a_of_type_Amzg == null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams != null)) {
      this.jdField_a_of_type_Amzg = new amzg(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView, this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    return this.jdField_a_of_type_Amzg;
  }
  
  public amzo a()
  {
    return this.jdField_a_of_type_Amzo;
  }
  
  public anah a()
  {
    return this.jdField_a_of_type_Anah;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null))
        {
          ...
          localObject = new amzj();
          ((amzj)localObject).jdField_e_of_type_Int = paramInt1;
          ((amzj)localObject).jdField_a_of_type_Long = System.currentTimeMillis();
          ((amzj)localObject).jdField_a_of_type_Int = this.jdField_e_of_type_Int;
          ((amzj)localObject).d = paramInt2;
          ((amzj)localObject).jdField_c_of_type_Int = paramInt3;
          ((amzj)localObject).jdField_a_of_type_JavaLangString = paramString;
          ((amzj)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
          ...
          amzh.a().a((amzj)localObject);
        }
        if ((this.jdField_a_of_type_Amyk == null) || (!this.jdField_a_of_type_Amyk.a())) {
          break label430;
        }
        paramInt3 = 1;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localApolloFloatActivity.a != null)
        {
          ...
          paramString = "window.mqq && mqq.execEventCallback && mqq.execEventCallback(" + nwo.a("apolloGameWebMessage") + "," + String.valueOf(paramString) + "," + String.valueOf("") + ");";
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_Amth != null) {
      this.jdField_a_of_type_Amth.a(paramInt, paramString1, paramString2);
    }
  }
  ...
  public void a(amth paramamth)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addRenderRunner(paramamth);
    }
  }
  ...
  public void a(anan paramanan)
  {
    ...
    localanat.a(paramanan);
  }
  
  public void a(Activity paramActivity)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    if (this.jdField_a_of_type_Amzo != null) {
      this.jdField_a_of_type_Amzo.a(paramActivity);
    }
    this.jdField_a_of_type_Amyk = new amyk(a(), amwn.a());
    this.jdField_a_of_type_Amyk.a(null, this.jdField_e_of_type_Int);
  }
  ...
  public void a(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
      this.jdField_a_of_type_Bkys.sendEmptyMessage(204);
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        if (!anmb.a())
        {
          ...
          anmb.a(this.jdField_a_of_type_Anmd);
          anmb.a("CmGameLauncher");
          return;
        }
        anmb.b(this.jdField_a_of_type_Anmd);
        a(paramActivity);
        a(paramActivity);
        this.jdField_a_of_type_Ankv = new ankv(this.jdField_e_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          break label541;
        }
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
      ...
      if (this.jdField_a_of_type_Anah == null) {
        this.jdField_a_of_type_Anah = new anah((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_e_of_type_Int);
      }
    ...
    {
      QLog.e("cmgame_process.CmGameLauncher", 1, localThrowable, new Object[0]);
      bool2 = amwn.a(this.jdField_e_of_type_Int);
      if (!bool2) {}
    }
    label541:
    label734:
        ...
        try
        {
          if ((paramActivity instanceof ApolloGameActivity))
          {
            ...
            if (this.jdField_a_of_type_Amxx != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Amxx);
            }
            if (this.jdField_a_of_type_Amxj != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Amxj);
            }
            this.jdField_a_of_type_Amxx = new amxx(this.jdField_e_of_type_Int, paramActivity);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Amxx);
            this.jdField_a_of_type_Amxj = new amxj(this.jdField_e_of_type_Int);
            this.jdField_a_of_type_Amxv = new amxv(this);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Amxj);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Amxv);
  ...
  public void a(Bitmap paramBitmap)
  {
    if (this.jdField_a_of_type_Amyk != null) {
      this.jdField_a_of_type_Amyk.a(paramBitmap, this.jdField_e_of_type_Int);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        b(paramBundle);
        amwn.a(new Object[] { "[checkFinish], loading from main process and tool process is on, before cost:", Long.valueOf(l1) });
  ...
  {
    if (this.jdField_a_of_type_Amxf == null)
    {
      if (paramInt != 0) {
        break label52;
      }
      this.jdField_a_of_type_Amxf = new amwr(amwn.a(), this.jdField_e_of_type_Int);
    }
    for (;;)
    {
      if (this.jdField_b_of_type_Amxf == null) {
        this.jdField_b_of_type_Amxf = new amwu(this.jdField_a_of_type_Amxv);
      }
      return;
      label52:
      if (1 == paramInt) {
        this.jdField_a_of_type_Amxf = new amxc(this.jdField_e_of_type_Int);
      }
    }
  }
  ...
  public void b(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      ...
      break label152;
      label230:
      str = String.valueOf(amta.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
      break label164;
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.jdField_a_of_type_Bkys.removeMessages(203);
      Message localMessage = this.jdField_a_of_type_Bkys.obtainMessage(203);
      localMessage.obj = paramString;
      this.jdField_a_of_type_Bkys.sendMessageDelayed(localMessage, 1000L);
  ...
  public void d()
  {
    ...
    {
      if (this.jdField_a_of_type_Amxf != null) {
        this.jdField_a_of_type_Amxf.b();
      }
      if (this.jdField_b_of_type_Amxf != null) {
        this.jdField_b_of_type_Amxf.b();
      }
  ...
  {
    this.jdField_a_of_type_Bkys.removeMessages(203);
    if (((!this.jdField_b_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (paramString.contains("inner")))) && (this.jdField_a_of_type_Amyk != null))
    {
      boolean bool = this.jdField_e_of_type_Boolean;
      this.jdField_a_of_type_Bkys.post(new CmGameLauncher.9(this, paramString, bool));
    }
  ...
  {
    if (this.jdField_a_of_type_Amxj != null) {
      this.jdField_a_of_type_Amxj.b();
    }
    if (this.jdField_a_of_type_Amxf != null) {
      this.jdField_a_of_type_Amxf.a();
    }
    if (this.jdField_b_of_type_Amxf != null) {
      this.jdField_b_of_type_Amxf.a();
    }
    ApolloCmdChannel localApolloCmdChannel = amwn.a();
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Amxf != null) {
      this.jdField_a_of_type_Amxf.c();
    }
    if (this.jdField_b_of_type_Amxf != null) {
      this.jdField_b_of_type_Amxf.c();
    }
    ...
    for (;;)
    {
      ...
      try
      {
        AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Amzb);
        if (this.jdField_a_of_type_Ankv != null) {
          this.jdField_a_of_type_Ankv.b();
        }
        if (this.jdField_a_of_type_Amyk != null) {
        ...
        if (this.jdField_a_of_type_Anah != null) {
          this.jdField_a_of_type_Anah.a();
        }
        if (this.jdField_a_of_type_Amwq != null) {
          this.jdField_a_of_type_Amwq.a();
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameLauncher", 2, "onDestroy");
        }
        return;
        this.jdField_a_of_type_Bkys.obtainMessage(202).sendToTarget();
        if (!QLog.isColorLevel()) {
          continue;
        }
  ...
  public void g()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Amth != null) {
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeRenderRunner(this.jdField_a_of_type_Amth);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          ...
          if (this.jdField_a_of_type_Amxj != null) {
            this.jdField_a_of_type_Amxj.d();
          }
          if (this.jdField_a_of_type_Amxv != null)
          {
            this.jdField_a_of_type_Amxv.a();
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Amxv);
          }
        }
        return;
        label231:
  ...
  public void h()
  {
    ...
    {
      if (this.jdField_a_of_type_Amxj != null) {
        this.jdField_a_of_type_Amxj.a(false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
    ...
    amyd.a("cs.make_room_min.local", "{}", false, null, this.jdField_e_of_type_Int);
    if ((amwn.a() != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null)) {
      amwn.a(this.jdField_e_of_type_Int, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      if ((this.jdField_a_of_type_Amyk == null) || (!this.jdField_a_of_type_Amyk.a(this.jdField_e_of_type_Int))) {
        break label271;
      }
      this.jdField_a_of_type_Amyk.a((String)paramMessage.obj, this.jdField_e_of_type_Int, this.jdField_e_of_type_Boolean);
    ...
    for (;;)
    {
      ...
      return false;
      label271:
      ankm.a(this.jdField_e_of_type_Int, (String)paramMessage.obj, a());
    }
  }
  ...
  public void i()
  {
    ...
    amyd.a("cs.close_room.local", "{}", false, null, this.jdField_e_of_type_Int);
  }
  ...
  public void j()
  {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_query_check_game_data", localBundle, new amyq(this));
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_Bkys.sendEmptyMessage(200);
        this.jdField_f_of_type_Boolean = false;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.mIsGameReady = true;
      }
      this.jdField_a_of_type_Amzb = new amzb(this.jdField_e_of_type_Int);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Amzb);
    }
  }
}
