  ...
  implements View.OnClickListener
{
  ...
  public qrt(Context paramContext)
  {
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    localGradientDrawable1.setCornerRadius(bajq.a(17.0F));
    ...
    localGradientDrawable2.setCornerRadius(bajq.a(17.0F));
  ...
  {
    this.jdField_a_of_type_Qrv = paramqrv;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localObject = new qrw(this, null);
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131494406, paramViewGroup, false);
      ((qrw)localObject).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131299097);
      ((qrw)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131311024));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (!((ChannelCoverInfo)localObject).isReport)
        {
          ...
          nti.a("0X8007F01", (ChannelCoverInfo)localObject, nti.b);
        }
        ...
        return paramView;
        paramViewGroup = (qrw)paramView.getTag();
        break;
        paramViewGroup.jdField_a_of_type_AndroidViewView.setPadding(bajq.a(8.0F), 0, bajq.a(8.0F), 0);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localChannelCoverInfo != null)
    {
      ...
      nji.a(this.jdField_a_of_type_AndroidContentContext, localChannelCoverInfo.mChannelCoverId, localChannelCoverInfo.mChannelCoverName, localChannelCoverInfo.mChannelType, 4, (Map)localObject);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      nti.a("0X8007F02", localChannelCoverInfo, nti.b);
      if ((this.jdField_a_of_type_Qrv == null) || (!(paramView.getTag() instanceof ChannelCoverInfo))) {
        break;
      }
      this.jdField_a_of_type_Qrv.a((ChannelCoverInfo)paramView.getTag());
      return;
      label252:
      if (rjb.b(localChannelCoverInfo.mChannelJumpUrl)) {
        rjb.a(this.jdField_a_of_type_AndroidContentContext, "", localChannelCoverInfo.mChannelJumpUrl, null);
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
