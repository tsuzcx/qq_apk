...
public class qrt
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new qsl(this, null);
  private nkt jdField_a_of_type_Nkt;
  private qsg jdField_a_of_type_Qsg;
  sgv jdField_a_of_type_Sgv;
  ...
  public qrt(Activity paramActivity, QQAppInterface paramQQAppInterface, VideoFeedsPlayManager paramVideoFeedsPlayManager, int paramInt1, boolean paramBoolean, qsg paramqsg, int paramInt2)
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager = paramVideoFeedsPlayManager;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Qsg = paramqsg;
    this.e = paramBoolean;
    this.jdField_a_of_type_Nkt = ((nkt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(136));
    this.jdField_a_of_type_Nkt.a();
  ...
  public static Intent a(VideoInfo paramVideoInfo)
  {
    ...
    localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131696698, new Object[] { paramVideoInfo.jdField_c_of_type_JavaLangString }));
    if (paramVideoInfo.jdField_a_of_type_Int == 6)
    {
      ...
      localAbsStructMsg = axva.a(localIntent.getExtras());
  ...
  public static Bundle a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int == 6)
    {
      ...
      ((Bundle)localObject).putInt("PREVIEW_START_POSI", qtx.a(paramInt, paramVideoInfo.a()));
      localObject = (StructMsgForGeneralShare)axva.a((Bundle)localObject);
      if ((!TextUtils.isEmpty(((StructMsgForGeneralShare)localObject).mMsgBrief)) && (((StructMsgForGeneralShare)localObject).mMsgBrief.indexOf(ajya.a(2131716217)) == -1)) {
        ((StructMsgForGeneralShare)localObject).mMsgBrief = (ajya.a(2131716239) + ((StructMsgForGeneralShare)localObject).mMsgBrief);
      }
      set.a((StructMsgForGeneralShare)localObject);
  ...
  public static void a(VideoInfo paramVideoInfo, Activity paramActivity, int paramInt)
  {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int == 0)
    {
      ...
      aqbe.a(paramActivity, localIntent);
      return;
    }
    ...
    {
      aqbe.a(paramActivity, a(paramVideoInfo), 21);
      return;
    }
    paramVideoInfo = a(paramVideoInfo, paramInt);
    Intent localIntent = new Intent();
    localIntent.putExtras(paramVideoInfo);
    aqbe.a(paramActivity, localIntent, 21);
  }
  ...
  private void a(VideoInfo paramVideoInfo, String paramString1, String paramString2, String paramString3, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localJSONObject.put("network", old.a(this.jdField_a_of_type_AndroidAppActivity));
    ...
    nol.a(null, "", "0X8009546", "0X8009546", 0, 0, "", String.valueOf(paramString2), String.valueOf(paramLong), paramVideoInfo, false);
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localObject[0] = ajya.a(2131716241);
    localObject[1] = ajya.a(2131716170);
    localObject[2] = ajya.a(2131716204);
    localObject[3] = ajya.a(2131716152);
    localObject[4] = ajya.a(2131716199);
    localObject[5] = ajya.a(2131716163);
    localObject[6] = ajya.a(2131716221);
    localObject[7] = ajya.a(2131716182);
    localObject[8] = ajya.a(2131716175);
    ...
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      ...
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, 0, 2131719487, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      return;
    }
    ...
    try
    {
      ...
      paramString3.putExtra("big_brother_source_key", onh.f(i));
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, long paramLong, int paramInt2, int paramInt3, int paramInt4, String paramString6, boolean paramBoolean)
  {
    ...
    paramString4 = new qzb(paramString4, paramString1, paramString5, paramString3).a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsPlayManager.a()).c(paramInt1 * 1000);
    if (!paramBoolean) {
      paramString4.e(paramLong).d(paramInt2).h(paramInt4).a(paramString6);
    }
    paramString4.a(paramInt3).O(this.jdField_c_of_type_Int);
    if (!TextUtils.isEmpty(paramString3)) {}
    for (;;)
    {
      nol.a(null, paramString1, str1, str1, 0, 0, "0", paramString2, paramString3, paramString4.a().a(), false);
      return;
      paramString3 = "0";
    }
  }
  ...
  private static void b(Context paramContext, int paramInt1, int paramInt2, VideoInfo paramVideoInfo, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      nol.a(null, "", "0X800979D", "0X800979D", 0, 0, "", String.valueOf(paramVideoInfo.g), String.valueOf(paramVideoInfo.jdField_f_of_type_Long), paramContext, false);
      return;
      paramInt1 = 1;
    }
  }
  ...
  private void e()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        int i = qoi.b(this.jdField_a_of_type_AndroidAppActivity)[0];
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new qsc(this));
  ...
  private void f()
  {
    ...
    Object localObject = new qsd(this);
    ...
    ((ReadInJoyDisLikeDialogView)localObject).setOnUninterestConfirmListener(new qse(this, localVideoInfo));
    ((ReadInJoyDisLikeDialogView)localObject).setOnComplainListener(new qrv(this, localVideoInfo));
      ...
      try
      {
        if (!this.jdField_a_of_type_Bfpc.isShowing())
        {
          if ((bfnz.g()) && (!ShortVideoUtils.c()))
          {
            ...
            this.jdField_a_of_type_Bfpc.setOnShowListener(new qrw(this));
          }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Sgv == null) {
      this.jdField_a_of_type_Sgv = new sgv(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new qsf(this), new qsh(this));
    }
    this.jdField_a_of_type_Sgv.a.a("biu出去让更多好友看到");
    this.jdField_a_of_type_Sgv.a.a(new qrz(this));
    this.jdField_a_of_type_Sgv.a.a(new qsa(this));
    try
    {
      if (!this.jdField_a_of_type_Sgv.a.a())
      {
        if ((bfnz.g()) && (!ShortVideoUtils.c()))
        {
          this.jdField_a_of_type_Sgv.a.a().setFlags(8, 8);
          this.jdField_a_of_type_Sgv.a.a().getDecorView().setSystemUiVisibility(this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().getSystemUiVisibility());
          this.jdField_a_of_type_Sgv.a.a(new qsb(this));
        }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Qsg != null) {
        this.jdField_a_of_type_Qsg.e();
      }
  ...
  void a(MessageForShortVideo paramMessageForShortVideo)
  {
    ...
    String str1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719605);
    String str2 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719563);
    String str3 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719606);
    String str4 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719583);
    String str5 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131690596);
    ...
    {
      localObject = bfpc.b(this.jdField_a_of_type_AndroidAppActivity);
      ((bfpc)localObject).c(str1);
      ((bfpc)localObject).setOnDismissListener(new qru(this));
      if (paramMessageForShortVideo.videoFileStatus != 5001) {
        ((bfpc)localObject).c(str3);
      }
      if (!bool1) {
        break label334;
      }
      ((bfpc)localObject).c(str2);
      ((bfpc)localObject).c(str4);
    }
    for (;;)
    {
      ((bfpc)localObject).d(str5);
      if (!((bfpc)localObject).isShowing())
      {
        if ((bfnz.g()) && (!ShortVideoUtils.c()))
        {
          ((bfpc)localObject).getWindow().setFlags(8, 8);
          if (bfnz.g()) {
            ((bfpc)localObject).getWindow().getDecorView().setSystemUiVisibility(this.jdField_a_of_type_AndroidAppActivity.getWindow().getDecorView().getSystemUiVisibility());
          }
          ((bfpc)localObject).setOnShowListener(new qrx(this, (bfpc)localObject));
        }
        ((bfpc)localObject).show();
      }
      ((bfpc)localObject).a(new qry(this, (bfpc)localObject, str1, paramMessageForShortVideo, str3, bool1, str6, str2, str4));
      return;
      localObject = bfpc.a(this.jdField_a_of_type_AndroidAppActivity);
      break;
      label334:
      ((bfpc)localObject).a(str2, 7);
      ((bfpc)localObject).a(str4, 7);
    }
  }
