  ...
  implements Manager
{
  ...
  public nws(QQAppInterface paramQQAppInterface)
  {
  ...
  private ogo a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      return (ogo)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(237);
    }
    return null;
  }
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new nww(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new nwx(this, null));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(b(), "");
    this.jdField_a_of_type_Nwv = new nwv(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nwv);
  ...
  public void a(nwf paramnwf)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        c("handlePreloadTaskFromMessage msgid:" + paramnwf.c + ", vid:" + localnwg.b);
        if (!TextUtils.isEmpty(localnwg.b))
        {
          ...
          localPAAdPreloadTask.mMsgId = paramnwf.c;
          ...
          if (paramnwf.jdField_a_of_type_Long > 0L)
          {
            ...
            c("handlePreloadTaskFromMessage msgid:" + paramnwf.c + ", vid:" + localnwg.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label309:
      c("handlePreloadTaskFromMessage msgid:" + paramnwf.c + ", vid:" + localnwg.b + ", exist in queue, ignore");
    }
  }
  
  public void a(nwf paramnwf, int paramInt)
  {
    Object localObject = this.jdField_a_of_type_JavaLangObject;
    if (paramnwf != null) {}
    for (;;)
    {
      ...
      try
      {
        if ((paramnwf.jdField_a_of_type_Nwh == null) || (paramnwf.jdField_a_of_type_JavaUtilArrayList == null) || (paramnwf.jdField_a_of_type_JavaUtilArrayList.size() <= paramInt))
        {
          c("handlePreloadTaskFromPlay invalid item");
          return;
        }
        str = ((nwg)paramnwf.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).b;
        c("handlePreloadTaskFromPlay msgid:" + paramnwf.c + ", index:" + paramInt + ", vid:" + str);
        if (!TextUtils.isEmpty(str))
        {
          PAAdPreloadTask localPAAdPreloadTask = new PAAdPreloadTask();
          localPAAdPreloadTask.mUserUin = b();
          ...
          if (paramnwf.jdField_a_of_type_Long > 0L)
          {
            ...
            localPAAdPreloadTask.mExpireTime = (localPAAdPreloadTask.mReceiveTime + jdField_a_of_type_JavaLangLong.longValue());
            localPAAdPreloadTask.mPreloadState = 1;
            localPAAdPreloadTask.mNetworkType = paramnwf.jdField_a_of_type_Nwh.e;
            this.c.add(localPAAdPreloadTask);
            ThreadManager.executeOnNetWorkThread(new AdvertisementVideoPreloadManager.9(this));
            c("handlePreloadTaskFromPlay msgid:" + paramnwf.c + ", index:" + paramInt + ", vid:" + str + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label317:
      c("handlePreloadTaskFromPlay msgid:" + paramnwf.c + ", index:" + paramInt + ", vid:" + str + ", exist in queue, ignore");
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Nwv != null)
    {
      this.jdField_a_of_type_Nwv.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Nwv);
      this.jdField_a_of_type_Nwv = null;
    }
