...
public class bamr
  implements Manager
{
  batl jdField_a_of_type_Batl = new bams(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public static String a(long paramLong, int paramInt)
  {
    ...
    do
    {
      return "";
      if (paramInt == 2) {
        return bamq.a + File.separator + paramLong + File.separator + "config.txt";
      }
      if (paramInt == 1) {
        return bamq.a + File.separator + paramLong + File.separator + "cover.jpg";
      }
    } while (paramInt != 3);
    return bamq.a + File.separator + paramLong + File.separator + "ring.mp3";
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 3)
    {
      localObject = bavz.a(paramAppRuntime, 0, null).getString("_3_" + paramInt1, null);
      paramAppRuntime = (AppRuntime)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramAppRuntime = bant.a("colorringAudio");
      }
    }
    for (;;)
    {
      ...
      if (paramInt2 == 2)
      {
        paramAppRuntime = bant.a("colorringConfig");
      }
      else
      {
        paramAppRuntime = (AppRuntime)localObject;
        if (paramInt2 == 1) {
          paramAppRuntime = bant.a("colorringCover");
        }
      }
    }
  }
  ...
  {
    Object localObject = new File(bamq.a + File.separator + paramLong + File.separator + "config.txt");
    try
    {
  ...
  {
    this.jdField_a_of_type_Bato.a(1).a(true, a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramInt2));
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, String paramString)
  {
    ...
    do
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        paramString = new batm(paramString, localFile);
        paramString.a(3);
        paramString.a = 0;
        paramString.a(localBundle);
        this.jdField_a_of_type_Batl.onDone(paramString);
        return;
      }
      paramString = new batm(paramString, new File(str + ".tmp"));
      paramString.e = 3145728L;
      paramString.b = true;
      this.jdField_a_of_type_Bato.a(1).a(paramString, this.jdField_a_of_type_Batl, localBundle);
