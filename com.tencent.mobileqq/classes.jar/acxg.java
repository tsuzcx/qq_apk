...
public class acxg
{
  ...
  public static ArrayList<acxg> a(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    try
    {
      paramString = new JSONArray(acxk.a(paramString));
      int i = 0;
      while (i < paramString.length())
      {
        acwx.b("KingKongSubPatch", "Parsing sub patch " + i);
        acxg localacxg = new acxg();
        if (localacxg.a(paramString.getJSONObject(i)))
        {
          localacxg.a();
          localArrayList.add(localacxg);
          i += 1;
        }
        else
        {
          acwx.a("KingKongSubPatch", "Parse sub patch failed, give up");
          return null;
        }
      }
    ...
    {
      acwx.a("KingKongSubPatch", "Parse SubPatch List exception : " + paramString);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    while (i < this.c.size())
    {
      acwx.b("KingKongSubPatch", "--> HookPoints : " + this.c.get(i));
      i += 1;
    }
    i = 0;
    int j;
    for (;;)
    {
      ...
      acwx.b("KingKongSubPatch", "--> Parameters : " + ((Integer)this.jdField_a_of_type_JavaUtilArrayList.get(i)).toString());
      i += 1;
    }
    while (j < this.b.size())
    {
      acwx.b("KingKongSubPatch", "--> FingerPrint : " + (String)this.b.get(j) + ", " + this.d.get(j));
      j += 1;
    }
  }
  ...
  public boolean a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        acwx.a("KingKongSubPatch", "Fingerprint value count mismatch " + n + ", " + k);
        return false;
      }
      catch (JSONException paramJSONObject)
      {
        ...
        int k;
        int j;
        acwx.a("KingKongSubPatch", "Parse SubPatch error : " + paramJSONObject);
        return false;
      }
