...
public abstract class aiyi
{
  public static final int[] a;
  public static final int[] b;
  public static final int[] c = { 2131370639 };
  public ajae a;
  public ajax a;
  protected Context a;
  protected bkos a;
  ...
  public aiyi(Context paramContext, QQAppInterface paramQQAppInterface, ajae paramajae, ajax paramajax)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ajae = paramajae;
    this.jdField_a_of_type_Ajax = paramajax;
    this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131297357);
  }
  ...
  public static void a(TextView paramTextView, int paramInt1, int paramInt2, StringBuilder paramStringBuilder)
  {
    ...
    {
    default: 
      paramTextView.setBackgroundResource(2130845856);
      j = 0;
      i = 0;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          break;
          j = 2130845853;
          paramTextView.setBackgroundResource(2130845854);
          i = j;
          if (paramStringBuilder == null) {
            break label231;
          }
  ...
  protected View a(Context paramContext, int paramInt, aiyk paramaiyk)
  {
    View localView = LayoutInflater.from(paramContext).inflate(paramInt, null);
    if (this.jdField_a_of_type_Ajae != null) {
      return this.jdField_a_of_type_Bkos.a(paramContext, localView, paramaiyk, -1);
    }
    paramaiyk.g = localView;
    paramaiyk.a = null;
    return localView;
  }
  ...
  protected bkos a(Context paramContext)
  {
    ...
    return new aiyj(this, 1, 2, new int[] { i, j }, -1, paramContext, arrayOfInt1, arrayOfInt2);
  }
  
  protected void a() {}
  
  public void a(ajax paramajax)
  {
    this.jdField_a_of_type_Ajax = paramajax;
  }
  ...
  protected void a(Context paramContext, View paramView, int paramInt, Object paramObject, bkot parambkot, View.OnClickListener paramOnClickListener)
  {
    ...
    {
      if ((this.jdField_a_of_type_Ajae != null) && (this.jdField_a_of_type_Ajae.a != -1))
      {
        if (paramInt != this.jdField_a_of_type_Ajae.a) {
  ...
  protected void a(View paramView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!bgjw.a(paramView, this.jdField_a_of_type_AndroidContentContext.getResources().getString(jdField_a_of_type_ArrayOfInt[0]))) {
          continue;
        }
        a();
        return;
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    {
      return;
      localView = paramView.findViewById(2131376609);
  ...
  public int c()
  {
    return this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298998);
  }
}
