...
public class bejj
{
  ...
  {
    boolean bool = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramBeancurdMsg.frienduin);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((bejk)paramQQAppInterface.getManager(QQManagerFactory.TOFUMSG_MANAGER)).a(paramString);
    ((afqy)paramQQAppInterface.getManager(QQManagerFactory.BEANCURD_MANAGER)).b(paramString);
  }
  
  private static boolean a(QQAppInterface paramQQAppInterface, BeancurdMsg paramBeancurdMsg)
  {
    boolean bool = false;
    int i = ((afqy)paramQQAppInterface.getManager(QQManagerFactory.BEANCURD_MANAGER)).a(paramBeancurdMsg.busiid);
