...
class asok
  extends Handler
{
  asok(asoi paramasoi, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      return;
      if (this.a.jdField_a_of_type_Asot != null)
      {
        int i = this.a.jdField_a_of_type_Asot.a();
        this.a.jdField_a_of_type_Asor.a(i);
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.i("VideoPlayerView", 2, "UPDATE_COVER  mPlayer.getCurrentPosition()=" + this.a.jdField_a_of_type_Asot.a());
        }
        ...
        asoi.a(this.a).addView(this.a.jdField_a_of_type_AndroidWidgetImageView, 0, new RelativeLayout.LayoutParams(-1, -1));
        asoi.a(this.a).requestLayout();
        return;
      }
