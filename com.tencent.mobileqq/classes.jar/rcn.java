...
public class rcn
{
  private static final String jdField_a_of_type_JavaLangString = alpo.a(2131716527);
  ...
  private void a(View paramView1, View paramView2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    int i = bcwh.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 7.0F);
    int j = bcwh.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 12.0F);
    int k = bcwh.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 80.0F);
    int m = -(paramInt1 - paramView2.getWidth() + paramView2.getWidth() / 2 - j / 2 - (paramInt1 / 2 - k - j / 2));
    int n = bcwh.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, -8.0F);
  ...
  private void b(View paramView)
  {
    ...
    if (this.b == null)
    {
      i = bcwh.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 8.0F);
      int j = bcwh.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 10.0F);
      TextView localTextView = new TextView(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
      localTextView.setId(2131377552);
    ...
    int i = bcwh.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 3.0F);
