  ...
  extends lhi
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new ljc(this);
  Handler jdField_a_of_type_AndroidOsHandler;
  HandlerThread jdField_a_of_type_AndroidOsHandlerThread = new HandlerThread("VideoNodeReportThread");
  public List<ljd> a;
  
  public ljb(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private void b(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    {
      localObject1 = new ljd();
      ((ljd)localObject1).a = paramLong1;
    ...
    if (((ljd)localObject1).a == locallgf.b()) {
      ((ljd)localObject1).a(locallgf, (String)localObject2);
    }
    localObject2 = ((ljd)localObject1).a();
    localObject1 = ((ljd)localObject1).a(paramInt, paramLong2);
  ...
  private void c(long paramLong)
  {
    ...
    localEditor.commit();
    lcl.d("VideoNodeReporter", "removeSpSessionRecord,roomId = " + paramLong);
  }
  
  ljd a(long paramLong)
  {
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    {
      lcl.d("VideoNodeReporter", " report error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lcl.d("VideoNodeReporter", " report error 1 ,exit has been called,node = " + paramInt);
      return;
    }
  ...
  public void a(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a() == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a() == null))
    {
      lcl.d("VideoNodeReporter", " reportByRoomId error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lcl.d("VideoNodeReporter", " reportByRoomId error 1 ,exit has been called,node = " + paramInt);
      return;
    }
    if (paramLong1 == 0L)
    {
  ...
  {
    lcl.d("VideoNodeReporter", " onSessionStatusChanged :" + paramInt + ",para = " + paramString2);
    switch (paramInt)
    {
    case 2: 
    case 3: 
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      while (paramString1.hasNext()) {
        ((ljd)paramString1.next()).b = System.currentTimeMillis();
      }
    }
  ...
  public void b()
  {
    try
    {
      ...
      long l1 = bbct.a(Process.myPid()) / 1024L / 1024L;
