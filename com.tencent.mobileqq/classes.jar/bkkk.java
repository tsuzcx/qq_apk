...
public class bkkk
{
  private static volatile bkkk jdField_a_of_type_Bkkk;
  ...
  private bkkk(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a();
  }
  
  public static final bkkk a(Context paramContext)
  {
    if (jdField_a_of_type_Bkkk == null) {}
    try
    {
      if (jdField_a_of_type_Bkkk == null) {
        jdField_a_of_type_Bkkk = new bkkk(paramContext);
      }
      return jdField_a_of_type_Bkkk;
    }
    finally {}
  }
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (localPluginInfo != null)
      {
        if (paramPluginBaseInfo != null)
        {
          ...
          if (!bool) {
            bcdb.a(new RuntimeException(), "plugin_tagCreateClassLoaderNotUpToDay");
          }
          return bool;
        }
  ...
  void b()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 36	bkkk:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   150: aload_0
    //   151: getfield 34	bkkk:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   154: aload_3
    //   155: aload 4
