  ...
  extends aekt
{
  ...
  public aels(QQAppInterface paramQQAppInterface, aell paramaell, QQWalletTransferMsgElem paramQQWalletTransferMsgElem, int paramInt, acvj paramacvj)
  {
  ...
  public boolean b()
  {
    ...
    this.jdField_a_of_type_Aell.b.setText("QQ会员红包");
    return false;
  }
  ...
  public void g()
  {
    ...
    for (boolean bool = this.jdField_a_of_type_Ajzf.c();; bool = false)
    {
      Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      if (bool) {}
      for (Object localObject1 = "1";; localObject1 = "0")
      {
        axqw.b((QQAppInterface)localObject2, "CliOper", "", "", "0X8006133", "0X8006133", 0, 0, (String)localObject1, "0", "", "");
        ...
        localObject1 = CustomizeStrategyFactory.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (CustomizeStrategyFactory.RedPacketInfo)localObject2, this.jdField_a_of_type_Acvj);
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Aell.a.setVisibility(0);
        ...
        while (i < j)
        {
          ...
          if (localDrawable != null) {
            ((AnimationDrawable)localObject2).addFrame(localDrawable, ((CustomizeStrategyFactory.RedPacketInfo)localObject1).jdField_a_of_type_Acvh.b);
          }
          i += 1;
        }
      }
      if (Build.VERSION.SDK_INT < 16) {
        this.jdField_a_of_type_Aell.a.setBackgroundDrawable((Drawable)localObject2);
      }
      for (;;)
      {
        ...
        return;
        this.jdField_a_of_type_Aell.a.setBackground((Drawable)localObject2);
      }
      label433:
      ...
      if (Build.VERSION.SDK_INT < 16)
      {
        this.jdField_a_of_type_Aell.a.setBackgroundDrawable((Drawable)localObject1);
        return;
      }
      this.jdField_a_of_type_Aell.a.setBackground((Drawable)localObject1);
      return;
    }
  }
}
