...
public class baky
  implements Manager
{
  akil jdField_a_of_type_Akil = new bakz(this);
  ...
  {
    ((ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).d(new balb(paramString, new bald(paramBoolean, paramLong)));
  }
  
  private void b(String paramString)
  {
    ((ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).d(new balb(paramString, a(paramString)));
  }
  ...
  private void b(String paramString, boolean paramBoolean, long paramLong)
  {
    ...
    paramString = new balb(paramString, new balc(paramBoolean, paramLong));
    paramString.b = 3;
    localajsx.d(paramString);
  }
  
  public bale a(String paramString, boolean paramBoolean)
  {
    ...
    if (localObject == null) {
      return new bale(this, paramString, false, "", 0L);
    }
    ...
    if ((((TroopInfo)localObject).dwGagTimeStamp != 0L) && (!bool))
    {
      ...
      return new bale(this, paramString, true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131697489), 60L);
    }
    if ((((TroopInfo)localObject).dwGagTimeStamp_me != 0L) && (l < ((TroopInfo)localObject).dwGagTimeStamp_me + 3L))
    {
      ...
      String str = localContext.getString(2131697991);
      l = ((TroopInfo)localObject).dwGagTimeStamp_me + 3L;
      if (paramBoolean) {
        l = ((TroopInfo)localObject).dwGagTimeStamp_me - 30L;
      }
      return new bale(this, paramString, true, String.format(str, new Object[] { b(localContext, l) }), 60L);
    }
    if (QLog.isDevelopLevel()) {
  ...
  public balf a(String paramString)
  {
    Object localObject = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    if (localObject == null) {
      return new balf(this, paramString, 0L);
    }
    localObject = ((TroopManager)localObject).c(paramString);
    if (localObject == null) {
      return new balf(this, paramString, 0L);
    }
    return new balf(this, paramString, ((TroopInfo)localObject).dwGagTimeStamp);
  }
  
  public String a(Context paramContext, long paramLong)
  {
    return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getString(2131697850), new Object[] { b(paramContext, paramLong) });
  }
  ...
  public String a(Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    paramContext = ((Context)localObject).getString(2131697668);
    String str1 = ((Context)localObject).getString(2131697667);
    localObject = ((Context)localObject).getString(2131697666);
    String str2 = ajya.a(2131715399);
    if (paramLong1 < 60L) {
  ...
  public ArrayList<akih> a(String paramString, boolean paramBoolean)
  {
    Object localObject = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
    if (localObject == null) {
      localObject = null;
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramLong3 == 0L)
        {
          paramString = ((Context)localObject2).getResources().getString(2131696361);
          localObject2 = (MessageForGrayTips)axas.a(-2030);
      ...
      paramString = ((Context)localObject2).getResources().getString(2131696351);
      continue;
      label244:
      if (paramLong3 == 0L) {
        paramString = ((Context)localObject2).getResources().getString(2131696353, new Object[] { paramString });
      } else {
        paramString = ((Context)localObject2).getResources().getString(2131696354, new Object[] { paramString, c((Context)localObject2, paramLong3) });
      }
    }
  }
  
  public void a(int paramInt, long paramLong1, long paramLong2, long paramLong3, ArrayList<akqn> paramArrayList)
  {
    int i = 0;
    label528:
    label563:
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(((TroopInfo)localObject).troopowneruin)) {
          ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).b(((TroopInfo)localObject).troopuin, false);
        }
        ...
        localakqn = (akqn)paramArrayList.next();
        str4 = localakqn.jdField_a_of_type_JavaLangString;
        if ((localakqn.jdField_a_of_type_Long == 0L) || (localakqn.jdField_a_of_type_Long == 4294967295L))
        {
          paramLong2 = localakqn.jdField_a_of_type_Long;
          if (str4.equals(str2))
          {
            if (QLog.isColorLevel()) {
            ...
            a(str1, true);
            a(str1, str3, paramLong3, localakqn.jdField_a_of_type_Long, paramInt, false, bool);
            i = 1;
          }
          if (!str4.equals("0")) {
            break label467;
          ...
          b(str1);
          a(str1, true);
          a(str1, str3, paramLong3, localakqn.jdField_a_of_type_Long, paramInt, true, bool);
          i = 1;
          continue;
        }
        paramLong2 = localakqn.jdField_a_of_type_Long + paramLong3;
      }
      finally {}
      continue;
      label467:
      if (!str4.equals(str2)) {
        a(str1, paramLong3, localakqn.jdField_a_of_type_Long, paramInt, str3, str4, bool);
      }
      ...
      paramArrayList = (akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
      try
      {
  ...
  public void a(String paramString)
  {
    ...
    ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).h(paramString);
  }
  ...
  public final void a(String paramString, long paramLong)
  {
    ...
    ((ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).a("OidbSvc.0x89a_0", ((oidb_sso.OIDBSSOPkg)localObject2).toByteArray(), (Bundle)localObject1);
  }
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, int paramInt, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (bool))
    {
      ...
      str1 = bbcz.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2);
      str2 = bbcz.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString3);
      j = 0;
      i = 0;
      localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      if (((String)localObject2).equalsIgnoreCase(paramString2))
      {
        localObject1 = ajya.a(2131715394);
        str1 = "";
        i = 1;
      }
      ...
      localObject1 = ajya.a(2131715395) + (String)localObject1;
      str2 = "";
      j = 1;
    }
    label545:
    ...
    for (;;)
    {
      ...
      for (localObject2 = localObject3;; localObject2 = " " + (String)localObject3)
      {
        ...
        localObject3 = (MessageForGrayTips)axas.a(-2030);
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      localObject1 = ((Context)localObject3).getString(2131697664);
      if ((paramBoolean2) && (bool))
      {
        str = (String)localObject1 + ((Context)localObject3).getString(2131698006);
        if (!paramBoolean1) {
          break label422;
        }
        if (paramLong2 == 0L) {
        ...
        localObject1 = ((Context)localObject3).getString(2131697658);
        localObject2 = bbcz.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, paramString2);
        if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equalsIgnoreCase(paramString2)) {
          break label570;
        }
        str = ajya.a(2131715397);
      }
    }
    label409:
    label422:
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        ((MessageForGrayTips)localObject2).isread = true;
        if (!akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2, false)) {
          break label550;
        }
        return;
        str = (String)localObject1 + ((Context)localObject3).getString(2131698005);
        break;
        if ((paramBoolean2) && (bool))
        {
          str = ((Context)localObject3).getString(2131697663);
          break;
        }
        str = ((Context)localObject3).getString(2131697656);
        break;
        localObject1 = ((Context)localObject3).getString(2131697572);
        break label126;
        if (paramLong2 != 0L) {}
        for (i = 2131697655;; i = 2131697571)
        {
  ...
  public final void a(String paramString, ArrayList<bala> paramArrayList)
  {
    ...
    {
      localObject = (bala)paramArrayList.get(i);
      str = str + ((bala)localObject).jdField_a_of_type_JavaLangString + ((bala)localObject).jdField_a_of_type_Long + "|";
      i += 1;
    }
    if (QLog.isDevelopLevel()) {
    ...
    while (i < paramArrayList.size())
    {
      bala localbala = (bala)paramArrayList.get(i);
      ((ByteBuffer)localObject).putInt((int)Long.valueOf(localbala.jdField_a_of_type_JavaLangString).longValue());
      ((ByteBuffer)localObject).putInt((int)localbala.jdField_a_of_type_Long);
      str = localbala.jdField_a_of_type_JavaLangString;
      l = localbala.jdField_a_of_type_Long;
      i += 1;
    }
    ...
    ((ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).a("OidbSvc.0x570_8", paramArrayList.toByteArray(), (Bundle)localObject);
  }
  
  public void a(String paramString, boolean paramBoolean)
  {
    ((ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).d(new balb(paramString, a(paramString, paramBoolean)));
  }
  ...
  public final boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (ajsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22);
  ...
  public boolean a(String paramString1, String paramString2, long paramLong)
  {
    ...
    localArrayList.add(new bala(paramString2, paramLong));
    a(paramString1, localArrayList);
    return true;
  }
  
  public boolean a(String paramString, ArrayList<bala> paramArrayList)
  {
    if (QLog.isDevelopLevel()) {
  ...
  public boolean a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (i == 12)
    {
      ...
      l2 = bbmx.a(paramArrayOfByte, 6);
      bbmx.a(paramArrayOfByte, 10);
      l3 = NetConnInfoCenter.getServerTime();
      int k = bbmx.a(paramArrayOfByte, 14);
      int j = 16;
      ArrayList localArrayList = new ArrayList();
      i = 0;
      while (i < k)
      {
        long l4 = bbmx.a(paramArrayOfByte, j);
        j += 4;
        long l5 = bbmx.a(paramArrayOfByte, j);
        j += 4;
        localArrayList.add(new akqn(String.valueOf(l4), l5));
        i += 1;
      }
    ...
    {
      i = paramArrayOfByte[5];
      bbmx.a(paramArrayOfByte, 6);
      l2 = NetConnInfoCenter.getServerTime();
      l3 = bbmx.a(paramArrayOfByte, 10);
      i = paramArrayOfByte[14];
      a(paramInt, l1, l2, l3, bbmx.a(paramArrayOfByte, 15, i), paramArrayOfByte[(i + 15)]);
    }
    return false;
  }
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      bcql.a(localContext, 2, paramString, 0).b(i);
      return;
    }
    bcql.a(localContext, 2130839317, paramString, 0).b(i);
  }
  ...
  public final boolean b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = 2131697575;; i = 2131697662)
    {
      a(i, true);
      return true;
    }
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    if (localakhp != null)
    {
      try
      {
        ...
        {
          localakhp.a(Long.parseLong(paramString1), 0L, 6, null, 0, 0);
        }
        else
        {
          ...
          localakhp.a(l1, 0L, 3, paramString1, 0, 0);
        }
      }
  ...
  public String c(Context paramContext, long paramLong)
  {
    ...
    String str1 = paramContext.getString(2131697668);
    String str2 = paramContext.getString(2131697667);
    Object localObject = paramContext.getString(2131697666);
    if (paramLong < 60L) {
      paramContext = 1 + str1;
    }
    long l2;
