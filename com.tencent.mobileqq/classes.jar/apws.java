...
public class apws
  extends anii
{
  public apws(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  public void a(List<String> paramList, anil paramanil)
  {
    ...
    do
    {
      ...
      localBubble_Req_Comm.mqqver.set("8.4.1");
    ...
    paramanil = super.createToServiceMsg("bubble.1", paramanil);
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd_0x01.has()) && (paramFromServiceMsg.rspcmd_0x01.user_text_info.has()))
          {
            ...
            apwr.a().a(this.app, true, paramFromServiceMsg);
