...
{
  public abjr(DynamicAvatarRecordActivity paramDynamicAvatarRecordActivity) {}
  ...
  public boolean queueIdle()
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 14) {
        this.a.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.a, 230).setMessage("你的系统版本过低，不支持拍摄动态头像。").setPositiveButton(this.a.getString(2131428346), new abjs(this));
      }
      try
      {
