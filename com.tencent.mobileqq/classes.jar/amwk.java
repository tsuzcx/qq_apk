...
public class amwk
{
  ...
  public boolean a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 98	amwk:f	I
    //   4: ifeq +10 -> 14
    //   7: aload_0
    //   8: getfield 99	amwk:g	I
    //   11: ifne +149 -> 160
    //   14: ldc 67
    //   16: iconst_1
    //   17: ldc 140
    ...
    //   22: aload_0
    //   23: iload_2
    //   24: putfield 98	amwk:f	I
    //   27: aload_0
    //   28: iload_3
    //   29: putfield 99	amwk:g	I
    //   32: aload_0
    //   33: aload_0
    //   34: getfield 98	amwk:f	I
    //   37: aload_0
    //   38: getfield 99	amwk:g	I
    //   41: imul
    //   42: putfield 102	amwk:h	I
    //   45: aload_0
    //   46: aload_0
    //   47: getfield 98	amwk:f	I
    //   50: aload_0
    //   51: getfield 99	amwk:g	I
    //   54: imul
    //   55: iconst_3
    //   56: imul
    //   57: iconst_2
    //   58: idiv
    //   59: putfield 106	amwk:i	I
    //   62: aload_0
    //   63: aload_0
    //   64: getfield 102	amwk:h	I
    //   67: newarray byte
    //   69: putfield 101	amwk:jdField_a_of_type_ArrayOfByte	[B
    //   72: aload_0
    //   73: aload_0
    //   74: getfield 106	amwk:i	I
    //   77: newarray byte
    //   79: putfield 104	amwk:jdField_b_of_type_ArrayOfByte	[B
    //   82: aload_0
    //   83: aload_0
    //   84: getfield 102	amwk:h	I
    //   87: newarray byte
    //   89: putfield 112	amwk:jdField_d_of_type_ArrayOfByte	[B
    //   92: aload_0
    //   93: getfield 98	amwk:f	I
    //   96: aload_0
    //   97: getfield 99	amwk:g	I
    //   100: if_icmple +553 -> 653
    //   103: aload_0
    //   104: getfield 98	amwk:f	I
    //   107: sipush 480
    //   110: if_icmplt +460 -> 570
    //   113: aload_0
    //   114: getfield 99	amwk:g	I
    //   117: sipush 480
    //   120: if_icmplt +450 -> 570
    //   123: aload_0
    //   124: sipush 480
    //   127: putfield 39	amwk:l	I
    //   130: aload_0
    //   131: sipush 480
    //   134: putfield 41	amwk:m	I
    //   137: aload_0
    //   138: aload_0
    //   139: getfield 39	amwk:l	I
    //   142: aload_0
    //   143: getfield 41	amwk:m	I
    //   146: imul
    //   147: putfield 110	amwk:n	I
    //   150: aload_0
    //   151: aload_0
    //   152: getfield 110	amwk:n	I
    //   155: newarray byte
    //   157: putfield 108	amwk:jdField_c_of_type_ArrayOfByte	[B
    //   160: aload_0
    //   161: getfield 98	amwk:f	I
    //   164: iload_2
    //   165: if_icmpne +11 -> 176
    //   168: aload_0
    //   169: getfield 99	amwk:g	I
    //   172: iload_3
    //   173: if_icmpeq +161 -> 334
    //   176: aload_0
    //   177: iload_2
    //   178: putfield 98	amwk:f	I
    //   181: aload_0
    //   182: iload_3
    //   183: putfield 99	amwk:g	I
    //   186: aload_0
    //   187: aload_0
    //   188: getfield 98	amwk:f	I
    //   191: aload_0
    //   192: getfield 99	amwk:g	I
    //   195: imul
    //   196: putfield 102	amwk:h	I
    //   199: aload_0
    //   200: aload_0
    //   201: getfield 98	amwk:f	I
    //   204: aload_0
    //   205: getfield 99	amwk:g	I
    //   208: imul
    //   209: iconst_3
    //   210: imul
    //   211: iconst_2
    //   212: idiv
    //   213: putfield 106	amwk:i	I
    //   216: aload_0
    //   217: aload_0
    //   218: getfield 102	amwk:h	I
    //   221: newarray byte
    //   223: putfield 101	amwk:jdField_a_of_type_ArrayOfByte	[B
    //   226: aload_0
    //   227: aload_0
    //   228: getfield 106	amwk:i	I
    //   231: newarray byte
    //   233: putfield 104	amwk:jdField_b_of_type_ArrayOfByte	[B
    //   236: aload_0
    //   237: aload_0
    //   238: getfield 102	amwk:h	I
    //   241: newarray byte
    //   243: putfield 112	amwk:jdField_d_of_type_ArrayOfByte	[B
    //   246: aload_0
    //   247: getfield 98	amwk:f	I
    //   250: aload_0
    //   251: getfield 99	amwk:g	I
    //   254: if_icmple +474 -> 728
    //   257: aload_0
    //   258: getfield 98	amwk:f	I
    //   261: sipush 480
    //   264: if_icmplt +445 -> 709
    //   267: aload_0
    //   268: getfield 99	amwk:g	I
    //   271: sipush 480
    //   274: if_icmplt +435 -> 709
    //   277: aload_0
    //   278: sipush 480
    //   281: putfield 39	amwk:l	I
    //   284: aload_0
    //   285: sipush 480
    //   288: putfield 41	amwk:m	I
    //   291: aload_0
    //   292: aload_0
    //   293: getfield 39	amwk:l	I
    //   296: aload_0
    //   297: getfield 41	amwk:m	I
    //   300: imul
    //   301: putfield 110	amwk:n	I
    //   304: aload_0
    //   305: aload_0
    //   306: getfield 110	amwk:n	I
    //   309: newarray byte
    //   311: putfield 108	amwk:jdField_c_of_type_ArrayOfByte	[B
    //   314: aload_0
    //   315: getfield 90	amwk:jdField_a_of_type_Boolean	Z
    //   318: istore 5
    //   320: iload 5
    //   322: ifeq +12 -> 334
    ...
    //   329: aload_0
    //   330: iconst_0
    //   331: putfield 90	amwk:jdField_a_of_type_Boolean	Z
    //   334: aload_0
    //   335: getfield 90	amwk:jdField_a_of_type_Boolean	Z
    //   338: ifne +104 -> 442
    //   341: invokestatic 145	amtr:a	()Lamtr;
    //   344: invokevirtual 147	amtr:a	()Z
    //   347: ifeq +471 -> 818
    //   350: iconst_1
    //   351: istore_2
    //   352: aload_0
    //   353: getfield 48	amwk:e	I
    //   356: getstatic 50	amwk:jdField_a_of_type_Int	I
    //   359: if_icmpne +464 -> 823
    //   362: aload_0
    //   363: getfield 98	amwk:f	I
    //   366: aload_0
    //   367: getfield 99	amwk:g	I
    //   370: aload_0
    //   371: getfield 35	amwk:j	I
    //   374: aload_0
    //   375: getfield 37	amwk:k	I
    //   378: aload_0
    //   379: getfield 106	amwk:i	I
    ...
    //   396: putfield 44	amwk:jdField_c_of_type_Int	I
    ...
    //   422: iconst_1
    //   423: aload_0
    //   424: getfield 44	amwk:jdField_c_of_type_Int	I
    ...
    //   437: aload_0
    //   438: iconst_1
    //   439: putfield 90	amwk:jdField_a_of_type_Boolean	Z
    //   442: aload_0
    //   443: getfield 48	amwk:e	I
    //   446: getstatic 50	amwk:jdField_a_of_type_Int	I
    //   449: if_icmpne +443 -> 892
    //   452: aload_1
    //   453: iconst_0
    //   454: aload_0
    //   455: getfield 101	amwk:jdField_a_of_type_ArrayOfByte	[B
    //   458: iconst_0
    //   459: aload_0
    //   460: getfield 102	amwk:h	I
    //   463: invokestatic 124	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   466: aload_1
    //   467: iconst_0
    //   468: aload_0
    //   469: getfield 104	amwk:jdField_b_of_type_ArrayOfByte	[B
    //   472: iconst_0
    //   473: aload_0
    //   474: getfield 106	amwk:i	I
    //   477: invokestatic 124	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   480: lconst_0
    //   481: lstore 6
    //   483: getstatic 170	amtr:jdField_a_of_type_Boolean	Z
    //   486: ifeq +8 -> 494
    //   489: invokestatic 174	java/lang/System:currentTimeMillis	()J
    //   492: lstore 6
    //   494: aload_0
    //   495: getfield 48	amwk:e	I
    //   498: getstatic 50	amwk:jdField_a_of_type_Int	I
    //   501: if_icmpne +511 -> 1012
    //   504: aload_0
    //   505: aload_0
    //   506: getfield 101	amwk:jdField_a_of_type_ArrayOfByte	[B
    //   509: aload_0
    //   510: getfield 104	amwk:jdField_b_of_type_ArrayOfByte	[B
    //   513: invokestatic 177	com/tencent/mobileqq/ar/arcloud/ARCloudImageFilter:nativeFilter	([B[B)Z
    //   516: putfield 114	amwk:jdField_b_of_type_Boolean	Z
    //   519: aload_0
    //   520: getfield 114	amwk:jdField_b_of_type_Boolean	Z
    //   523: ifeq +20 -> 543
    //   526: aload_0
    //   527: getfield 101	amwk:jdField_a_of_type_ArrayOfByte	[B
    //   530: iconst_0
    //   531: aload_0
    //   532: getfield 112	amwk:jdField_d_of_type_ArrayOfByte	[B
    //   535: iconst_0
    //   536: aload_0
    //   537: getfield 102	amwk:h	I
    //   540: invokestatic 124	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   543: getstatic 170	amtr:jdField_a_of_type_Boolean	Z
    //   546: ifeq +19 -> 565
    //   549: invokestatic 145	amtr:a	()Lamtr;
    //   552: invokestatic 174	java/lang/System:currentTimeMillis	()J
    //   555: lload 6
    //   557: lsub
    //   558: aload_0
    //   559: getfield 44	amwk:jdField_c_of_type_Int	I
    //   562: invokevirtual 180	amtr:a	(JI)V
    //   565: aload_0
    //   566: getfield 114	amwk:jdField_b_of_type_Boolean	Z
    //   569: ireturn
    //   570: aload_0
    //   571: aload_0
    //   572: getfield 98	amwk:f	I
    //   575: putfield 39	amwk:l	I
    //   578: aload_0
    //   579: aload_0
    //   580: getfield 99	amwk:g	I
    //   583: putfield 41	amwk:m	I
    //   586: goto -449 -> 137
    //   589: astore_1
    //   590: ldc 67
    //   592: iconst_1
    ...
    //   618: aload_0
    //   619: aconst_null
    //   620: putfield 101	amwk:jdField_a_of_type_ArrayOfByte	[B
    //   623: aload_0
    //   624: aconst_null
    //   625: putfield 104	amwk:jdField_b_of_type_ArrayOfByte	[B
    //   628: aload_0
    //   629: aconst_null
    //   630: putfield 108	amwk:jdField_c_of_type_ArrayOfByte	[B
    //   633: aload_0
    //   634: iconst_0
    //   635: putfield 98	amwk:f	I
    //   638: aload_0
    //   639: iconst_0
    //   640: putfield 99	amwk:g	I
    //   643: aload_0
    //   644: aconst_null
    //   645: putfield 112	amwk:jdField_d_of_type_ArrayOfByte	[B
    //   648: invokestatic 186	java/lang/System:gc	()V
    //   651: iconst_0
    //   652: ireturn
    //   653: aload_0
    //   654: getfield 98	amwk:f	I
    //   657: sipush 480
    //   660: if_icmplt +30 -> 690
    //   663: aload_0
    //   664: getfield 99	amwk:g	I
    //   667: sipush 480
    //   670: if_icmplt +20 -> 690
    //   673: aload_0
    //   674: sipush 480
    //   677: putfield 39	amwk:l	I
    //   680: aload_0
    //   681: sipush 480
    //   684: putfield 41	amwk:m	I
    //   687: goto -550 -> 137
    //   690: aload_0
    //   691: aload_0
    //   692: getfield 98	amwk:f	I
    //   695: putfield 39	amwk:l	I
    //   698: aload_0
    //   699: aload_0
    //   700: getfield 99	amwk:g	I
    //   703: putfield 41	amwk:m	I
    //   706: goto -569 -> 137
    //   709: aload_0
    //   710: aload_0
    //   711: getfield 98	amwk:f	I
    //   714: putfield 39	amwk:l	I
    //   717: aload_0
    //   718: aload_0
    //   719: getfield 99	amwk:g	I
    //   722: putfield 41	amwk:m	I
    //   725: goto -434 -> 291
    //   728: aload_0
    //   729: getfield 98	amwk:f	I
    //   732: sipush 480
    //   735: if_icmplt +30 -> 765
    //   738: aload_0
    //   739: getfield 99	amwk:g	I
    //   742: sipush 480
    //   745: if_icmplt +20 -> 765
    //   748: aload_0
    //   749: sipush 480
    //   752: putfield 39	amwk:l	I
    //   755: aload_0
    //   756: sipush 480
    //   759: putfield 41	amwk:m	I
    //   762: goto -471 -> 291
    //   765: aload_0
    //   766: aload_0
    //   767: getfield 98	amwk:f	I
    //   770: putfield 39	amwk:l	I
    //   773: aload_0
    //   774: aload_0
    //   775: getfield 99	amwk:g	I
    //   778: putfield 41	amwk:m	I
    //   781: goto -490 -> 291
    //   784: astore 8
    //   786: ldc 67
    //   788: iconst_1
    ...
    //   820: goto -468 -> 352
    //   823: aload_0
    //   824: getfield 39	amwk:l	I
    //   827: aload_0
    //   828: getfield 41	amwk:m	I
    //   831: aload_0
    //   832: getfield 35	amwk:j	I
    //   835: aload_0
    //   836: getfield 37	amwk:k	I
    //   839: aload_0
    //   840: getfield 106	amwk:i	I
    ...
    //   884: aload_0
    //   885: iconst_0
    //   886: putfield 44	amwk:jdField_c_of_type_Int	I
    //   889: goto -490 -> 399
    //   892: aload_0
    //   893: getfield 98	amwk:f	I
    //   896: aload_0
    //   897: getfield 39	amwk:l	I
    //   900: if_icmpne +14 -> 914
    //   903: aload_0
    //   904: getfield 99	amwk:g	I
    //   907: aload_0
    //   908: getfield 41	amwk:m	I
    //   911: if_icmpeq +84 -> 995
    //   914: aload_0
    //   915: getfield 98	amwk:f	I
    //   918: aload_0
    //   919: getfield 39	amwk:l	I
    //   922: isub
    //   923: iconst_2
    //   924: idiv
    //   925: istore_3
    //   926: aload_0
    //   927: getfield 39	amwk:l	I
    //   930: istore_2
    //   931: aload_0
    //   932: getfield 99	amwk:g	I
    //   935: aload_0
    //   936: getfield 41	amwk:m	I
    //   939: isub
    //   940: iconst_2
    //   941: idiv
    //   942: istore 4
    //   944: aload_0
    //   945: getfield 41	amwk:m	I
    //   948: istore_2
    //   949: iconst_0
    //   950: istore_2
    //   951: iload_2
    //   952: aload_0
    //   953: getfield 41	amwk:m	I
    ...
    //   963: iadd
    //   964: aload_0
    //   965: getfield 98	amwk:f	I
    //   968: imul
    //   969: iload_3
    //   970: iadd
    //   971: aload_0
    //   972: getfield 108	amwk:jdField_c_of_type_ArrayOfByte	[B
    //   975: aload_0
    //   976: getfield 39	amwk:l	I
    //   979: iload_2
    //   980: imul
    //   981: aload_0
    //   982: getfield 39	amwk:l	I
    ...
    //   996: iconst_0
    //   997: aload_0
    //   998: getfield 108	amwk:jdField_c_of_type_ArrayOfByte	[B
    //   1001: iconst_0
    //   1002: aload_0
    //   1003: getfield 110	amwk:n	I
    //   1006: invokestatic 124	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   1009: goto -543 -> 466
    //   1012: aload_0
    //   1013: aload_0
    //   1014: getfield 108	amwk:jdField_c_of_type_ArrayOfByte	[B
    //   1017: aload_0
    //   1018: getfield 104	amwk:jdField_b_of_type_ArrayOfByte	[B
    //   1021: invokestatic 177	com/tencent/mobileqq/ar/arcloud/ARCloudImageFilter:nativeFilter	([B[B)Z
    //   1024: putfield 114	amwk:jdField_b_of_type_Boolean	Z
    //   1027: aload_0
    //   1028: getfield 114	amwk:jdField_b_of_type_Boolean	Z
    //   1031: ifeq -488 -> 543
    //   1034: aload_0
    //   1035: getfield 108	amwk:jdField_c_of_type_ArrayOfByte	[B
    //   1038: iconst_0
    //   1039: aload_0
    //   1040: getfield 112	amwk:jdField_d_of_type_ArrayOfByte	[B
    //   1043: iconst_0
    //   1044: aload_0
    //   1045: getfield 110	amwk:n	I
