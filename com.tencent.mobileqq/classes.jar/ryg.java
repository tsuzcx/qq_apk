...
public class ryg
{
  ...
  private HashMap<String, ArrayList<ryi>> jdField_a_of_type_JavaUtilHashMap;
  ...
  public ryg(BridgeModule paramBridgeModule)
  {
  ...
  private void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString1))
    {
      ...
      localArrayList.add(new ryi(this, paramString2, paramString3));
  ...
  private void b(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      {
        ryi localryi = (ryi)localArrayList.get(i);
        if ((localryi.jdField_a_of_type_JavaLangString.equals(paramString2)) && (localryi.b.equals(paramString3))) {
          localArrayList.remove(localryi);
        }
        i += 1;
      }
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ryh(this);
  }
  ...
  protected void a(android.content.Context paramContext, Intent paramIntent)
  {
    ...
    //   31: aload_1
    //   32: aload_0
    //   33: invokespecial 243	ryg:b	()Ljava/lang/String;
    ...
    //   117: astore_2
    //   118: aload_0
    //   119: invokespecial 261	ryg:c	()Ljava/lang/String;
    //   122: astore 9
    //   124: invokestatic 266	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   127: ifeq +80 -> 207
    //   130: getstatic 38	ryg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   133: astore 10
    //   135: aload_0
    //   136: getfield 48	ryg:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   139: ifnull +107 -> 246
    //   142: aload_0
    //   143: getfield 48	ryg:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   229: aload 9
    //   231: invokestatic 289	mvs:b	(Ljava/lang/String;Ljava/lang/String;)Z
    //   234: ifeq +28 -> 262
    //   237: aload_0
    //   238: aload 7
    //   240: aload_1
    //   241: aload_2
    //   242: invokevirtual 292	ryg:a	(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    //   245: return
    //   246: ldc_w 294
    //   249: astore 5
    //   251: goto -100 -> 151
  ...
  protected void a(String paramString, JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      if ((localArrayList != null) && (localArrayList.size() > 0))
      {
        ...
        {
          String str = ((ryi)localArrayList.get(i)).b;
