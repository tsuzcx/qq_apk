  ...
  implements Manager
{
  ...
  private ArrayList<bbgu> jdField_a_of_type_JavaUtilArrayList;
  ...
  private ArrayList<ayau> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public ayaq(QQAppInterface paramQQAppInterface)
  {
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    ayaq localayaq = (ayaq)paramQQAppInterface.getManager(62);
    if (localayaq != null) {}
    for (int i = localayaq.a(paramQQAppInterface.c() + "_all_third_last_msg_time");; i = 0)
    {
      if (QLog.isColorLevel()) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, akpb paramakpb)
  {
    int i;
    if ((paramQQAppInterface == null) || (!paramQQAppInterface.isRunning()) || (paramakpb == null))
    {
      i = 0;
      return i;
    }
    ...
    if (localayax != null)
    {
      Iterator localIterator = localayax.b().iterator();
      i = 0;
      j = i;
      ...
      if ((localObject == null) || (TextUtils.isEmpty(((SubAccountInfo)localObject).subuin)) || (localayax.a(((SubAccountInfo)localObject).subuin) != 1)) {
        break label238;
      }
    }
    label179:
    label191:
    label238:
    for (int j = paramakpb.a(((SubAccountInfo)localObject).subuin, 7000);; j = 0)
    {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      j = localayaq.a(paramQQAppInterface.c() + "_" + paramString + "_msgNum");
      i = j;
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    paramQQAppInterface = (ayaq)paramQQAppInterface.getManager(62);
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        i = ((Integer)((ayau)localObject).jdField_a_of_type_JavaLangObject).intValue();
        return i;
      }
      ...
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new ayau(paramString, Integer.valueOf(i)));
        }
        return i;
      }
      return 0;
  ...
  private ayau a(String paramString)
  {
    if (this.jdField_c_of_type_JavaUtilArrayList != null) {
      try
      {
        ...
        while (i < j)
        {
          ...
          for (ayau localayau = (ayau)this.jdField_c_of_type_JavaUtilArrayList.get(i); localayau != null; localayau = null)
          {
            boolean bool = TextUtils.equals(localayau.jdField_a_of_type_JavaLangString, paramString);
            if (!bool) {
              break;
            }
            return localayau;
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      paramQQAppInterface = bbcz.b(paramQQAppInterface, paramString2, true);
      ...
      continue;
      paramString1 = localBaseApplication.getString(2131718690);
      continue;
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        paramString = (String)((ayau)localObject).jdField_a_of_type_JavaLangObject;
        return paramString;
      }
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("qq_subaccount_associated_cache", 0);
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new ayau(paramString, localObject));
        }
        return localObject;
      }
      return "";
  ...
  public static ArrayList<String> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localayaq != null)
    {
      ...
      localayaq.jdField_b_of_type_JavaUtilConcurrentLocksLock.lock();
    }
    for (;;)
    {
      try
      {
        ayau localayau = localayaq.a(paramString);
        if (localayau != null)
        {
          localArrayList.addAll((ArrayList)localayau.jdField_a_of_type_JavaLangObject);
          localayaq.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          if (QLog.isColorLevel()) {
        ...
        {
          localayaq.jdField_c_of_type_JavaUtilArrayList.add(new ayau(paramString, localArrayList));
          continue;
        }
        i += 1;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject2 = (ayax)paramQQAppInterface.getManager(61);
      } while (localObject2 == null);
      long l1 = bbdd.a().a(paramQQAppInterface.getApp());
      long l2 = aney.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (l1 < l2)
      {
        if (l1 == 0L)
        {
          ...
          bool = bbdd.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
          localObject1 = ((ayax)localObject2).a("sub.uin.default");
          if ((localObject1 != null) && (((SubAccountInfo)localObject1).subuin != null))
          {
            ((ayax)localObject2).g(((SubAccountInfo)localObject1).subuin);
            i = ((ayax)localObject2).c(((SubAccountInfo)localObject1).subuin) - paramQQAppInterface.a().a(((SubAccountInfo)localObject1).subuin, 7000);
            if (i != 0)
            {
              paramQQAppInterface.a().c(((SubAccountInfo)localObject1).subuin, 7000, i);
              paramQQAppInterface.a().a(new String[] { ajsd.x, ((SubAccountInfo)localObject1).subuin });
            }
            if (bool)
            {
              if (QLog.isColorLevel()) {
          ...
          bbdd.a().a(paramQQAppInterface.getApp());
        }
      }
      else
      {
        if (!bbdd.a().b(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("SUB_ACCOUNT", 2, "initAllData() showedBefore:false, isFirstTime to user SubAccount.");
          }
          bbdd.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), true);
          a(paramQQAppInterface, 7);
        }
        localObject1 = paramQQAppInterface.a().a();
        localObject3 = ((aktf)localObject1).b(ajsd.x, 7000);
        if (((ayax)localObject2).a() <= 0) {
          break label788;
        }
        if (QLog.isColorLevel()) {
          QLog.d("SUB_ACCOUNT", 2, "initAllData() getBindedNumber > 0, go to initAllData");
        }
        localObject4 = ((ayax)localObject2).b();
      ...
      for (;;)
      {
        ...
        if ((localObject3 != null) && (l1 == 0L))
        {
          ...
          if (localObject2 != null) {
            j = ((ayax)localObject2).c(localSubAccountInfo.subuin);
          }
          int n = j - m;
          if (QLog.isColorLevel()) {
          ...
          if (n != 0)
          {
            ...
            paramQQAppInterface.a().a(new String[] { ajsd.x, localSubAccountInfo.subuin });
          }
        }
        bool = false;
        ...
        if (bool) {
          paramQQAppInterface.getSubAccountKey(paramQQAppInterface.getAccount(), localSubAccountInfo.subuin, new ayar(paramQQAppInterface));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "initAllData() delete subaccount recentuser, add default subaccount box");
      }
      Object localObject2 = ((ayax)localObject2).b();
      int j = ((ArrayList)localObject2).size();
      int i = 0;
      if (i < j)
      {
        localObject3 = (SubAccountInfo)((ArrayList)localObject2).get(i);
        if ((localObject3 == null) || (ajsd.x.equals(((SubAccountInfo)localObject3).subuin))) {}
        for (;;)
        {
          i += 1;
          break;
          localObject3 = ((aktf)localObject1).b(((SubAccountInfo)localObject3).subuin, 7000);
          if (localObject3 != null) {
            ((aktf)localObject1).b((RecentUser)localObject3);
          }
        }
      }
      localObject2 = ((aktf)localObject1).b(ajsd.x, 7000);
      ...
      {
        a(paramQQAppInterface, (aktf)localObject1, ajsd.x, 7);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte paramByte, ArrayList<String> paramArrayList)
  {
    ...
    for (paramArrayList = (String)localIterator.next();; paramArrayList = null)
    {
      try
      {
        ...
        Object localObject2 = (ayax)paramQQAppInterface.getManager(61);
        if (localObject2 == null) {
          continue;
        }
        paramArrayList = ((ayax)localObject2).a(paramArrayList);
        if (paramArrayList == null)
        {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          long l1 = 0L;
          continue;
          paramArrayList = bbea.a(paramArrayList);
          continue;
          label377:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      for (;;)
      {
        ...
        if ((localRecentUser != null) && (localRecentUser.getType() == 7000) && (!ajsd.x.equals(localRecentUser.uin)))
        {
          if (QLog.isColorLevel()) {
    ...
    a(paramQQAppInterface, localaktf, ajsd.x, i);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, aktf paramaktf, String paramString, int paramInt)
  {
    int i = 1;
    if (QLog.isColorLevel()) {
    ...
    if ((paramString == null) || (paramString.length() == 0) || (paramInt == 0)) {
      if (QLog.isColorLevel())
      {
        paramaktf = new StringBuilder().append("updateRecentUser() return,");
        if (paramString != null) {
          break label103;
        }
    ...
    do
    {
      ...
      {
        localRecentUser = paramaktf.b(paramString, 7000);
        if (localRecentUser != null) {
          paramaktf.b(localRecentUser);
        }
      }
      localRecentUser = paramaktf.b(ajsd.x, 7000);
      if (localRecentUser != null) {
        break label693;
      }
    ...
    for (;;)
    {
      localRecentUser.uin = ajsd.x;
      Object localObject;
      long l1;
      long l2;
      if (ajsd.x.equals(paramString))
      {
        paramString = (ayax)paramQQAppInterface.getManager(61);
      ...
      for (;;)
      {
        ...
        while (paramInt != 0)
        {
          ...
          paramInt = 1;
          continue;
          paramQQAppInterface = (ayax)paramQQAppInterface.getManager(61);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, RecentItemSubAccount paramRecentItemSubAccount, MsgSummary paramMsgSummary)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject5 = (ayax)paramQQAppInterface.getManager(61);
      ...
      return;
      localArrayList = ((ayax)localObject5).b();
      ...
      paramMsgSummary.strContent = paramContext.getString(2131719891);
    } while (!QLog.isColorLevel());
    ...
    int j = a(paramQQAppInterface, localakpb);
    label281:
    Object localObject3;
    if ((i < l) || (j > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject3 != null) && (!TextUtils.isEmpty(((SubAccountInfo)localObject3).subuin)) && (((ayax)localObject5).a(((SubAccountInfo)localObject3).subuin) == 1))
        {
          List localList = ((ayax)localObject5).a(((SubAccountInfo)localObject3).subuin);
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (localObject2 != null))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject3))
        {
          ...
          if (((((SubAccountMessage)localObject2).mEmoRecentMsg == null) || (((SubAccountMessage)localObject2).mEmoRecentMsg.length() == 0)) && (((SubAccountMessage)localObject2).msg != null)) {
            ((SubAccountMessage)localObject2).mEmoRecentMsg = new aykk(((SubAccountMessage)localObject2).msg, 3, 16);
          }
          ...
          paramRecentItemSubAccount.mMsgExtroInfo = ("[" + paramContext.getString(2131717485) + "]");
      ...
      if ((j > 0) && (localakpb != null))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            i = localakpb.a(((SubAccountInfo)localObject2).subuin, 7000);
            if (i > 0)
            {
      ...
      localObject2 = ((ayax)localObject5).a();
      ...
      for (;;)
      {
        ...
        if (i > 0)
        {
          paramMsgSummary.strContent = paramContext.getString(2131719836, new Object[] { String.valueOf(i) });
          if (QLog.isColorLevel()) {
        ...
        paramMsgSummary.strContent = paramContext.getString(2131719830);
        return;
        k = i;
        i = j;
        j = k;
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
    ...
    localObject1 = paramBaseActivity.getString(2131719896);
    Object localObject2 = paramBaseActivity.getString(2131719858, new Object[] { Integer.valueOf(2) });
    localObject1 = bbdj.a(paramBaseActivity, 230).setTitle((String)localObject1).setMessage((CharSequence)localObject2);
    ((bbgu)localObject1).setOwnerActivity(paramBaseActivity);
    ((bbgu)localObject1).setPositiveButton(paramBaseActivity.getString(2131719878), new ayat(paramQQAppInterface, paramBaseActivity));
      ...
      if (paramString != null)
      {
        ...
        while (paramString.hasNext())
        {
          ...
          if (!"sub.uin.all".equals(localObject))
          {
            ...
            if (paramQQAppInterface != null)
            {
              localObject = (ayax)paramQQAppInterface.getManager(61);
              if (localObject != null)
              {
                ((ayax)localObject).a(paramString);
                ((ayax)localObject).c(paramString);
                if (bbcz.c(paramQQAppInterface, paramString, false) != null) {
                  break;
                }
              }
            }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((!ajsd.x.equals(paramString)) && ((paramString == null) || (paramString.length() < 5))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      return;
      aktf localaktf = paramQQAppInterface.a().a();
      if ((localaktf.b(ajsd.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      a(paramQQAppInterface, localaktf, paramString, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localayaq = (ayaq)paramQQAppInterface.getManager(62);
    } while (localayaq == null);
    ...
    for (;;)
    {
      try
      {
        paramString2 = localayaq.a(paramString1);
        ...
        if (paramString2 != null) {
          ...
          localayaq.jdField_c_of_type_JavaUtilArrayList.add(new ayau(paramString1, localArrayList));
        }
      }
      finally
      {
    ...
    localayaq.a(paramString1 + "_sysTime", Integer.valueOf(paramInt1));
    localayaq.jdField_a_of_type_Long = paramInt2;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    do
    {
      do
      {
        ...
        paramString1 = (ayaq)paramQQAppInterface.getManager(62);
      } while (paramString1 == null);
      paramQQAppInterface = paramQQAppInterface.c() + "_" + paramString2;
      paramString2 = bbmx.a(paramArrayOfByte);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (ajsd.x.equals(paramString)) {
      if (paramBoolean) {
        a(paramQQAppInterface, paramQQAppInterface.a().a(), ajsd.x, 7);
      }
    }
    for (;;)
    {
      ...
      paramQQAppInterface.sendEmptyMessage(1009);
      return;
      ((ayax)paramQQAppInterface.getManager(61)).a(paramString, paramBoolean);
      aktf localaktf = paramQQAppInterface.a().a();
      if (paramBoolean) {
        a(paramQQAppInterface, localaktf, paramString, 4);
      } else {
        a(paramQQAppInterface, localaktf, paramString, 5);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((((aktf)localObject).b(ajsd.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      ...
      while (paramArrayList.hasNext())
      {
        ...
        a(paramQQAppInterface, (aktf)localObject, str, paramInt);
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    localayaq.a(paramQQAppInterface.c() + "_display_third_qq_checked", String.valueOf(paramBoolean));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localayax != null) && (paramQQAppInterface != null))
      {
        Iterator localIterator = localayax.a().iterator();
        while (localIterator.hasNext())
        {
          String str = (String)localIterator.next();
          if (!TextUtils.isEmpty(str))
          {
            int i = localayax.c(str);
            localayax.b(str);
            if ((paramBoolean) || (i > 0))
            {
              if (QLog.isColorLevel()) {
              ...
              akqs localakqs = paramQQAppInterface.a();
              if (localakqs != null) {
                localakqs.a(str, paramString);
              }
            }
          }
        }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    ayaq localayaq = (ayaq)paramQQAppInterface.getManager(62);
    if (localayaq != null) {
      return localayaq.a(paramQQAppInterface.c() + "_all_third_last_msg_time", Integer.valueOf(paramInt));
    }
    return false;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      localObject = ((ayax)localObject).a();
      label45:
      paramQQAppInterface = (ayaq)paramQQAppInterface.getManager(62);
      bool1 = bool2;
      if (paramQQAppInterface != null) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    label381:
    for (Object localObject = ((ayax)localObject).a(paramString);; localObject = null)
    {
      ayav localayav = (ayav)paramQQAppInterface.getManager(28);
      if (localayav != null)
      {
        paramBoolean = localayav.a();
        if (!paramBoolean)
        {
          localObject = new ayay();
          ((ayay)localObject).jdField_a_of_type_JavaLangString = "";
          ((ayay)localObject).b = paramQQAppInterface.getAccount();
          ((ayay)localObject).c = paramString;
          ((ayay)localObject).jdField_a_of_type_Int = 1009;
      ...
      if ((paramString == null) || (paramString.length() == 0) || (localObject == null) || (((String)localObject).length() == 0) || (((String)localObject).trim().equals("")))
      {
        ...
        ((ayay)localObject).b = paramQQAppInterface.getAccount();
        ((ayay)localObject).c = paramString;
        ((ayay)localObject).jdField_a_of_type_Int = 1010;
        paramQQAppInterface.a().notifyUI(8003, false, localObject);
        return false;
      }
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (localayaq != null)
    {
      if (!localayaq.jdField_b_of_type_Boolean) {
        return false;
      }
      if (BaseActivity.mAppForground)
      {
        bool = localayaq.d(paramQQAppInterface, paramBoolean);
        paramBoolean = bool;
        if (bool) {
          localayaq.d(paramQQAppInterface);
        }
      }
      for (paramBoolean = bool;; paramBoolean = bool)
      {
        if ((!paramBoolean) && (localayaq.jdField_b_of_type_JavaLangRunnable != null)) {
          ThreadManager.getSubThreadHandler().removeCallbacks(localayaq.jdField_b_of_type_JavaLangRunnable);
        }
        return paramBoolean;
        localayaq.jdField_a_of_type_Boolean = true;
      }
    }
    return false;
  }
  ...
  private boolean a(String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject == null)
        {
          this.jdField_c_of_type_JavaUtilArrayList.add(new ayau(paramString, paramObject));
          bool1 = true;
          this.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          bool2 = bool1;
          if (!bool1) {
        ...
        if (((paramObject instanceof Integer)) && ((((ayau)localObject).jdField_a_of_type_JavaLangObject instanceof Integer)))
        {
          if ((Integer)((ayau)localObject).jdField_a_of_type_JavaLangObject == (Integer)paramObject) {
            break label346;
          }
          bool2 = true;
          bool1 = bool2;
          ...
          ((ayau)localObject).jdField_a_of_type_JavaLangObject = paramObject;
          bool1 = bool2;
          continue;
        }
      ...
      if ((((ayau)localObject).jdField_a_of_type_JavaLangObject instanceof String))
      {
        bool1 = TextUtils.equals((String)((ayau)localObject).jdField_a_of_type_JavaLangObject, (String)paramObject);
        if (!bool1)
        {
          bool2 = true;
          continue;
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localayaq != null)
    {
      paramQQAppInterface = localayaq.a(paramQQAppInterface.c() + "_" + paramString + "_cookie");
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        return bbmx.a(paramQQAppInterface);
      }
    }
    return null;
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      paramString = (ayaq)paramQQAppInterface.getManager(62);
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject1 = (ayaq)paramQQAppInterface.getManager(62);
        if (localObject1 == null) {
          break label110;
        }
        l1 = System.currentTimeMillis();
        l2 = (l1 - ((ayaq)localObject1).jdField_b_of_type_Long) / 1000L;
        if (l2 >= ((ayaq)localObject1).jdField_a_of_type_Long) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("SUB_ACCOUNT", 2, "getSubAccountSpecialCareListFromService skip adviseGap=" + ((ayaq)localObject1).jdField_a_of_type_Long + "  realGap=" + l2);
      return;
      ((ayaq)localObject1).jdField_b_of_type_Long = l1;
      localObject1 = (ayax)paramQQAppInterface.getManager(61);
    } while (localObject1 == null);
    Object localObject2 = new ArrayList();
    if (paramBoolean) {
      ((List)localObject2).addAll(((ayax)localObject1).b());
    }
    for (;;)
    {
      ...
      break;
      ((List)localObject2).add(((ayax)localObject1).a(paramString));
    }
  }
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramString = localaktf.b(paramString, 7000);
        if (paramString != null)
        {
      ...
      } while (((ayax)paramQQAppInterface.getManager(61)).a() != 0);
      a(paramQQAppInterface, localaktf, ajsd.x, 7);
    } while (!QLog.isColorLevel());
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1 = (ayax)paramQQAppInterface.getManager(61);
    ayaq localayaq = (ayaq)paramQQAppInterface.getManager(62);
    if ((localObject1 == null) || (localayaq == null)) {
      return false;
    }
    localObject1 = ((ayax)localObject1).a();
    Object localObject2 = new ArrayList();
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localObject3 != null) && (!TextUtils.isEmpty(((SimpleAccount)localObject3).getUin())) && (!((SimpleAccount)localObject3).getUin().equals(paramQQAppInterface)) && (!((List)localObject1).contains(((SimpleAccount)localObject3).getUin())))
      {
        ...
        String str = localayaq.a((String)localObject3 + "_last_cookie");
        if (!TextUtils.isEmpty(str)) {
          localayaq.a((String)localObject3 + "_cookie", str);
        }
        localayaq.a((String)localObject3 + "_msgNum", Integer.valueOf(0));
        localayaq.a((String)localObject3 + "_msgFlag", Integer.valueOf(0));
        localayaq.a((String)localObject3 + "_redBagTime", Integer.valueOf(0));
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    ...
    ayaq localayaq = (ayaq)paramQQAppInterface.getManager(62);
    return (localayaq == null) || (!TextUtils.equals(localayaq.a(paramQQAppInterface.c() + "_display_third_qq_checked"), String.valueOf(false)));
  }
  ...
  private boolean d(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject3 = (ayax)paramQQAppInterface.getManager(61);
    if ((((List)localObject2).size() >= 1) && (localObject3 != null))
    {
      localObject1 = new ArrayList();
      String str = paramQQAppInterface.c();
      localObject3 = ((ayax)localObject3).a();
      localObject2 = ((List)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
  ...
  public ArrayList<Pair<String, Integer>> a(String paramString)
  {
    ...
    //   45: areturn
    //   46: aload_0
    //   47: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   50: invokeinterface 256 1 0
    //   55: aload_0
    //   56: getfield 1020	ayaq:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   59: ifnull +29 -> 88
    //   62: ldc_w 912
    //   65: aload_1
    ...
    //   72: aload_3
    //   73: aload_0
    //   74: getfield 1020	ayaq:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   77: invokevirtual 432	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   80: pop
    //   81: aload_0
    //   82: getfield 1020	ayaq:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 71	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   92: invokeinterface 271 1 0
    //   97: aload_3
    //   98: areturn
    //   99: aload_0
    //   100: getfield 1020	ayaq:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   110: iflt -22 -> 88
    //   113: aload_0
    //   114: getfield 1020	ayaq:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   117: iload_2
    ...
    //   144: pop
    //   145: aload_0
    //   146: getfield 1020	ayaq:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   149: iload_2
    ...
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(SubAccountBaseActivity paramSubAccountBaseActivity)
  {
    ...
    while (i >= 0)
    {
      localObject = (bbgu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if ((localObject == null) || (((bbgu)localObject).getOwnerActivity() != paramSubAccountBaseActivity) || (((bbgu)localObject).isShowing())) {}
      try
      {
        ((bbgu)localObject).dismiss();
        label116:
  ...
  public void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, Pair<String, Integer> paramPair, android.content.DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    //   222: istore 6
    //   224: aload_0
    //   225: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   228: invokeinterface 256 1 0
    //   233: aload_0
    //   234: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   237: ifnull +141 -> 378
    //   240: aload_0
    //   241: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   253: iflt +125 -> 378
    //   256: aload_0
    //   257: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   260: iload 5
    //   262: invokevirtual 296	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   265: checkcast 879	bbgu
    //   268: astore 10
    //   270: aload 10
    //   272: ifnull +298 -> 570
    //   275: aload 10
    //   277: invokevirtual 1215	bbgu:getTag	()Ljava/lang/Object;
    //   280: instanceof 315
    //   283: ifeq +287 -> 570
    //   286: aload 10
    //   288: invokevirtual 1215	bbgu:getTag	()Ljava/lang/Object;
    ...
    //   306: ifeq +264 -> 570
    //   309: aload 10
    //   311: invokevirtual 1196	bbgu:isShowing	()Z
    //   314: istore 7
    //   316: iload 7
    //   318: ifeq +8 -> 326
    //   321: aload 10
    //   323: invokevirtual 1199	bbgu:dismiss	()V
    //   326: aload_0
    //   327: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   330: iload 5
    ...
    //   388: aload 8
    //   390: iconst_0
    //   391: invokestatic 922	bbcz:c	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Z)Ljava/lang/String;
    //   394: astore 9
    //   396: aload 9
    //   398: ifnull +181 -> 579
    //   401: aload 9
    ...
    //   436: aload_2
    //   437: sipush 230
    //   440: invokestatic 877	bbdj:a	(Landroid/content/Context;I)Lbbgu;
    //   443: aload 10
    //   445: invokevirtual 883	bbgu:setTitle	(Ljava/lang/String;)Lbbgu;
    //   448: aload_1
    //   449: invokevirtual 887	bbgu:setMessage	(Ljava/lang/CharSequence;)Lbbgu;
    //   452: astore_1
    //   453: aload_1
    //   454: aload_3
    //   455: invokevirtual 1221	bbgu:setTag	(Ljava/lang/Object;)V
    //   458: aload_1
    //   459: aload_2
    //   460: invokevirtual 891	bbgu:setOwnerActivity	(Landroid/app/Activity;)V
    //   463: aload_1
    //   464: aload_2
    //   465: ldc_w 892
    //   468: invokevirtual 870	com/tencent/mobileqq/app/BaseActivity:getString	(I)Ljava/lang/String;
    //   471: aload 4
    //   473: invokevirtual 900	bbgu:setPositiveButton	(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lbbgu;
    //   476: pop
    //   477: aload_1
    //   478: new 1223	ayas
    //   481: dup
    ...
    //   483: aload 8
    //   485: iload 6
    //   487: invokespecial 1226	ayas:<init>	(Layaq;Ljava/lang/String;I)V
    //   490: invokevirtual 1230	bbgu:setOnCancelListener	(Landroid/content/DialogInterface$OnCancelListener;)V
    //   493: aload_1
    //   494: invokevirtual 907	bbgu:show	()V
    //   497: aload_0
    //   498: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   501: ifnonnull +14 -> 515
    //   504: aload_0
    //   505: new 54	java/util/ArrayList
    //   508: dup
    //   509: invokespecial 55	java/util/ArrayList:<init>	()V
    //   512: putfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   515: aload_0
    //   516: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   519: aload_1
    //   520: invokevirtual 289	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   523: pop
    //   524: aload_0
    //   525: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   553: astore_1
    //   554: aload_0
    //   555: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   54: return
    //   55: aload_0
    //   56: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   59: invokeinterface 256 1 0
    //   64: aload_0
    //   65: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: ifnull +253 -> 321
    //   71: aload_0
    //   72: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   84: iflt +237 -> 321
    //   87: aload_0
    //   88: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: iload 5
    //   93: invokevirtual 296	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   96: checkcast 879	bbgu
    //   99: astore 7
    //   101: aload 7
    //   103: ifnull +162 -> 265
    //   106: aload 7
    //   108: invokevirtual 1215	bbgu:getTag	()Ljava/lang/Object;
    //   111: astore 8
    //   113: aload 8
    //   115: ifnull +193 -> 308
    //   118: aload 8
    ...
    //   169: ifeq +173 -> 342
    //   172: aload 7
    //   174: invokevirtual 1196	bbgu:isShowing	()Z
    //   177: istore 6
    //   179: iload 6
    //   181: ifeq +8 -> 189
    //   184: aload 7
    //   186: invokevirtual 1199	bbgu:dismiss	()V
    //   189: aload_0
    //   190: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   193: iload 5
    ...
    //   262: goto +80 -> 342
    //   265: aload_0
    //   266: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   269: iload 5
    ...
    //   278: astore_1
    //   279: aload_0
    //   280: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   305: goto -138 -> 167
    //   308: aload_0
    //   309: getfield 1189	ayaq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   312: iload 5
    //   314: invokevirtual 1027	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   317: pop
    //   318: goto +24 -> 342
    //   321: aload_0
    //   322: getfield 38	ayaq:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void onDestroy()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          bbgu localbbgu = (bbgu)localIterator.next();
          try
          {
