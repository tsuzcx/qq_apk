  ...
  extends akis
{
  public int a;
  protected alrk a;
  ameq jdField_a_of_type_Ameq = new akbt(this);
  protected Context a;
  protected LayoutInflater a;
  protected View.OnClickListener a;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected XListView a;
  protected List<akbv> a;
  private nac jdField_a_of_type_Nac = new akbs(this);
  public int b;
  public int c;
  public int d;
  public int e;
  ...
  public akbr(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, int paramInt, boolean paramBoolean, View.OnClickListener paramOnClickListener)
  {
    ...
    this.g = paramContext.getResources().getColor(2131166903);
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<awge> paramArrayList)
  {
    ...
    {
      Collections.sort((List)localObject2, new akbu(this));
    ...
    while (((Iterator)localObject6).hasNext())
    {
      ...
      if (!((TroopInfo)localObject7).isQidianPrivateTroop())
      {
        ...
        if ((((TroopInfo)localObject7).dwAdditionalFlag & 1L) == 1L) {
          ((List)localObject3).add(new aklz(i, (awge)localObject7));
        }
        for (;;)
        {
          ...
          ((List)localObject5).add(new aklz(i, (awge)localObject7));
          break;
          if ((((TroopInfo)localObject7).dwCmdUinUinFlag & 1L) == 1L) {
            ((List)localObject2).add(new aklz(i, (awge)localObject7));
          } else {
            ((List)localObject1).add(new aklz(i, (awge)localObject7));
          }
        }
      }
    }
    localObject6 = paramQQAppInterface.a().a();
    Object localObject7 = ((alrk)paramQQAppInterface.getManager(53)).a().iterator();
    label508:
    while (((Iterator)localObject7).hasNext())
    {
      DiscussionInfo localDiscussionInfo = (DiscussionInfo)((Iterator)localObject7).next();
      RecentUser localRecentUser = ((amnz)localObject6).a(localDiscussionInfo.uin, 3000);
      ...
      if (paramQQAppInterface.c().equals(localDiscussionInfo.ownerUin)) {
        ((List)localObject3).add(new aklz(1, localDiscussionInfo));
      }
      for (;;)
      {
        ...
        ((List)localObject5).add(new aklz(1, localDiscussionInfo));
        break;
        ((List)localObject1).add(new aklz(1, localDiscussionInfo));
      }
    }
    this.d = ((List)localObject4).size();
    ...
    if (this.d > 0)
    {
      this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 0, null));
      localObject4 = ((List)localObject4).iterator();
      while (((Iterator)localObject4).hasNext())
      {
        localObject6 = (awge)((Iterator)localObject4).next();
        if ((localObject6 instanceof TroopInfo))
        {
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 1, (awge)localObject6));
        }
        else if ((localObject6 instanceof DiscussionInfo))
        {
          localObject6 = (DiscussionInfo)localObject6;
          i = this.jdField_a_of_type_Alrk.a(((DiscussionInfo)localObject6).uin);
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 1, (DiscussionInfo)localObject6, i));
        }
      }
    }
    if (this.e > 0)
    {
      this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 8, null));
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 3, ((aklz)localObject5).a));
        }
        else if ((((aklz)localObject5).a instanceof DiscussionInfo))
        {
          localObject5 = (DiscussionInfo)((aklz)localObject5).a;
          i = this.jdField_a_of_type_Alrk.a(((DiscussionInfo)localObject5).uin);
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 3, (DiscussionInfo)localObject5, i));
        }
      }
    }
    if (this.jdField_a_of_type_Int > 0)
    {
      this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 4, null));
      localObject3 = ((List)localObject3).iterator();
      while (((Iterator)localObject3).hasNext())
      {
        localObject4 = (aklz)((Iterator)localObject3).next();
        if ((((aklz)localObject4).a instanceof TroopInfo))
        {
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 5, ((aklz)localObject4).a));
        }
        else if ((((aklz)localObject4).a instanceof DiscussionInfo))
        {
          localObject4 = (DiscussionInfo)((aklz)localObject4).a;
          i = this.jdField_a_of_type_Alrk.a(((DiscussionInfo)localObject4).uin);
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 5, (DiscussionInfo)localObject4, i));
        }
      }
    }
    ...
    if (this.b > 0)
    {
      this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 6, null));
      localObject2 = ((List)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject3 = (aklz)((Iterator)localObject2).next();
        this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 7, ((aklz)localObject3).a));
      }
    }
    if (this.c > 0)
    {
      this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 2, null));
      localObject1 = ((List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (aklz)((Iterator)localObject1).next();
        if ((((aklz)localObject2).a instanceof TroopInfo))
        {
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 3, ((aklz)localObject2).a));
        }
        else if ((((aklz)localObject2).a instanceof DiscussionInfo))
        {
          localObject2 = (DiscussionInfo)((aklz)localObject2).a;
          i = this.jdField_a_of_type_Alrk.a(((DiscussionInfo)localObject2).uin);
          this.jdField_a_of_type_JavaUtilList.add(new akbv(this, 3, (DiscussionInfo)localObject2, i));
        }
      }
    }
  ...
  {
    akbv localakbv = (akbv)getItem(paramInt);
    if (localakbv == null) {
    ...
    do
    {
      ...
      if ((paramView != null) && (paramView.getTag() != null)) {
        paramViewGroup = (akbw)paramView.getTag();
      }
      for (;;)
      {
        localView = paramView.findViewById(2131378436);
        localObject2 = (TextView)paramView.findViewById(2131378502);
        if (localakbv.jdField_a_of_type_Int != 0) {
          break;
        }
        localView.setVisibility(8);
        ((TextView)localObject2).setVisibility(0);
        ((TextView)localObject2).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131696672, new Object[] { String.valueOf(this.d) }));
        return paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562637, this.jdField_a_of_type_ComTencentWidgetXListView, false);
        paramViewGroup = new akbw(this);
        paramViewGroup.c = ((ImageView)paramView.findViewById(2131365912));
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365940));
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378468));
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378457));
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362823));
        paramView.setTag(paramViewGroup);
      }
      if (localakbv.jdField_a_of_type_Int == 2)
      {
        localView.setVisibility(8);
        ((TextView)localObject2).setVisibility(0);
        ((TextView)localObject2).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131696692, new Object[] { String.valueOf(this.c) }));
        return paramView;
      }
      if (localakbv.jdField_a_of_type_Int == 4)
      {
        localView.setVisibility(8);
        ((TextView)localObject2).setVisibility(0);
        ((TextView)localObject2).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131696605, new Object[] { String.valueOf(this.jdField_a_of_type_Int) }));
        return paramView;
      }
      if (localakbv.jdField_a_of_type_Int == 6)
      {
        localView.setVisibility(8);
        ((TextView)localObject2).setVisibility(0);
        ((TextView)localObject2).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131696644, new Object[] { String.valueOf(this.b) }));
        return paramView;
      }
      if (localakbv.jdField_a_of_type_Int == 8)
      {
        localView.setVisibility(8);
        ((TextView)localObject2).setVisibility(0);
        ((TextView)localObject2).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131696786, new Object[] { String.valueOf(this.e) }));
        return paramView;
      }
      if (localakbv.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null)
      {
        localView.setVisibility(0);
        ((TextView)localObject2).setVisibility(8);
        localObject2 = localakbv.jdField_a_of_type_ComTencentMobileqqDataTroopInfo;
        ...
        if (((TroopInfo)localObject2).getTroopName() != null)
        {
          ...
          paramViewGroup.jdField_a_of_type_Int = localakbv.jdField_a_of_type_Int;
      ...
      localObject1 = paramView;
    } while (localakbv.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo == null);
    label676:
    label688:
    localView.setVisibility(0);
    ((TextView)localObject2).setVisibility(8);
    Object localObject1 = localakbv.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo;
    ...
    {
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(String.format("(%d)", new Object[] { Integer.valueOf(this.jdField_a_of_type_Alrk.a(((DiscussionInfo)localObject1).uin)) }));
    }
