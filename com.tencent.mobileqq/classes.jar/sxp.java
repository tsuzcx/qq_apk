  ...
  implements View.OnClickListener
{
  ...
  private URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new sxu(this);
  private URLImageView jdField_a_of_type_ComTencentImageURLImageView;
  public HotWordSearchEntryDataModel a;
  protected String a;
  private pkt jdField_a_of_type_Pkt = new sxq(this);
  private sxv jdField_a_of_type_Sxv;
  ...
  private sxv jdField_b_of_type_Sxv;
  protected boolean b;
  private ReadInJoyCapsuleView jdField_c_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView;
  private sxv jdField_c_of_type_Sxv;
  
  public sxp(Context paramContext)
  {
    this.jdField_a_of_type_Andt = new sxr(this);
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new sxs(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560195, null);
    Object localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131378553);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView = ((ReadInJoyCapsuleView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364202));
    this.jdField_a_of_type_Sxv = new sxv(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView);
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView = ((ReadInJoyCapsuleView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364201));
    this.jdField_b_of_type_Sxv = new sxv(this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView);
    this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView = ((ReadInJoyCapsuleView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364200));
    this.jdField_c_of_type_Sxv = new sxv(this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369263));
    a(a(pkm.a().a(0)));
  ...
  private URLDrawable a(ChannelCoverInfo paramChannelCoverInfo, boolean paramBoolean)
  {
    ...
    paramChannelCoverInfo = URLDrawable.getDrawable(udt.a(paramChannelCoverInfo.externalExposureBackgroundUrl), (URLDrawable.URLDrawableOptions)localObject);
  ...
  private List<ChannelCoverInfo> a(List<ChannelCoverInfo> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localChannelCoverInfo.isExternalExposure) && (((bkwm.i()) && (!bkwm.j())) || (localChannelCoverInfo.mChannelCoverId != 56)))
      {
        paramList = localChannelCoverInfo.externalExposureBackgroundUrl;
        if ((!TextUtils.isEmpty(paramList)) && (!TextUtils.equals(bkwm.d(localChannelCoverInfo.mChannelCoverId), paramList)))
        {
          if (localChannelCoverInfo.isExternalExposurePersist) {
            paramList = "";
          }
          bkwm.a(paramList, localChannelCoverInfo.mChannelCoverId);
          bkwm.a(localChannelCoverInfo.mChannelCoverId, false);
        }
    ...
    if (localURLDrawable.getStatus() == 1)
    {
      if ((localURLDrawable.getCurrDrawable() instanceof GifDrawable))
      {
        ...
        if ((localAbstractGifImage instanceof udu))
        {
          ...
          ((udu)localAbstractGifImage).a(new sxt(this, paramChannelCoverInfo));
        }
      }
  ...
  private void a(List<ChannelCoverInfo> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localChannelCoverInfo.mChannelCoverId == 56)
      {
        ...
        paramList = this.jdField_a_of_type_Sxv;
      }
      for (;;)
      {
        ...
        if (localChannelCoverInfo.mChannelCoverId == 1000000)
        {
          ...
          paramList = this.jdField_b_of_type_Sxv;
        }
        ...
        else
        {
          ...
          paramList = this.jdField_c_of_type_Sxv;
        }
      }
    }
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Sxv.a() != null) {
      a("0X8008B88", this.jdField_a_of_type_Sxv.a());
    }
    if (this.jdField_b_of_type_Sxv.a() != null) {
      a("0X8008B89", this.jdField_b_of_type_Sxv.a());
    }
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Sxv.b();
    this.jdField_b_of_type_Sxv.b();
    this.jdField_c_of_type_Sxv.b();
    ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).removeObserver(this.jdField_a_of_type_Andt);
  ...
  public void f()
  {
    ...
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378553)).setText(this.jdField_a_of_type_JavaLangString);
  ...
  protected void g()
  {
    ...
    if (!TextUtils.isEmpty(aqcc.a().jdField_a_of_type_JavaLangString))
    {
  ...
  public void onClick(View paramView)
  {
    ...
    {
      pay.a((Activity)this.jdField_a_of_type_AndroidContentContext, (HotWordSearchEntryDataModel.HotSearchItem)localObject);
      bbda.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), new ReportModelDC02528().opername("Kdian_inner_search").module("kd_web_search").action("active_search").ver1(this.jdField_a_of_type_JavaLangString).ver7("{experiment_id:" + bbda.b + "}"));
      break;
      localObject = this.jdField_a_of_type_Sxv.a();
      ...
      okj.a(this.jdField_a_of_type_AndroidContentContext, ((ChannelCoverInfo)localObject).mChannelCoverId, ((ChannelCoverInfo)localObject).mChannelCoverName, ((ChannelCoverInfo)localObject).mChannelType, 4, localHashMap);
      a("0X8008B84", this.jdField_a_of_type_Sxv.a());
      break;
      this.jdField_b_of_type_Sxv.a();
      tgc.a(this.jdField_a_of_type_AndroidContentContext, amtj.a(2131712134), "https://kandian.qq.com/viola/bundle_hotTopic.js?v_bid=3256&statusColor=1", null);
      a("0X8008B85", this.jdField_b_of_type_Sxv.a());
      break;
      localObject = (ChannelCoverInfo)paramView.getTag();
      pay.a(paramView.getContext(), ((ChannelCoverInfo)localObject).mChannelJumpUrl);
