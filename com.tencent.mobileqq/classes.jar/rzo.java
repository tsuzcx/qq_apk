  ...
  implements rzn, rzr
{
  ...
  public rzo(int paramInt)
  {
    this(paramInt, null, false);
  }
  
  public rzo(int paramInt, String paramString, boolean paramBoolean)
  {
    super(BaseApplicationImpl.getContext(), paramString, paramBoolean);
    this.jdField_a_of_type_Rzq = new rzq(paramInt, this);
    a(this.jdField_a_of_type_Rzq);
    a(this);
  }
  ...
  private void b(String paramString, long paramLong, int paramInt)
  {
    ...
    scq.a().a(paramString, new rzp(this, paramString, paramLong, paramInt));
  }
  ...
  public void a(String paramString)
  {
    this.d = paramString;
    if (h()) {
      rpt.a(new ReadInjoyPlayer.2(this));
    }
  }
  
  public void a(qwv paramqwv)
  {
    paramqwv.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    paramqwv.j = b();
    paramqwv.k = c();
  }
  ...
  {
    rpt.a(new ReadInjoyPlayer.4(this));
  }
