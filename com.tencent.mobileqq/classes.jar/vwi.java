  ...
  public void a(boolean paramBoolean, long paramLong, String paramString, FeedCloudRead.StGetFollowListRsp paramStGetFollowListRsp)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          vwh.a(this.a, paramString, paramLong);
          return;
        }
        vwh.a(this.a, (List)vwh.a(this.a).clone());
        this.a.a(vwh.a(this.a));
        uyk.a().a(System.currentTimeMillis());
        return;
