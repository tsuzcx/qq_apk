...
{
  poj(pog parampog, AdvertisementInfo paramAdvertisementInfo) {}
        ...
        if (paramInt == 0)
        {
          ...
          if (paramInt == 0)
          {
            ...
            if ((paramBundle != null) && (paramBundle.length() > 0))
            {
              ...
              this.jdField_a_of_type_Pog.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
            }
          }
        }
        return;
