  ...
  extends BusinessHandler
{
  ...
  public ntj(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqAppBusinessObserver = new ntm(this);
    this.jdField_a_of_type_Ntp = new ntp(this);
    AppNetConnInfo.registerConnectionChangeReceiver(paramQQAppInterface.getApplication(), this.jdField_a_of_type_Ntp);
    ...
    if ((paramArrayOfByte != null) && (paramQQAppInterface != null))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (bool != bcvo.jdField_a_of_type_Boolean)
          {
            ykq.a("TroopRedTouchHandler", "parsePushRedPointInfo env not match!! isTestEnvFromPush = %b, sIsTestEnv = %b", Boolean.valueOf(bool), Boolean.valueOf(bcvo.jdField_a_of_type_Boolean));
            if (bool != yfc.a())
            {
              ykq.a("TroopRedTouchHandler", "parsePushRedPointInfo env not match!! isTestEnvFromPush = %b, QQStoryNetReqUtils.isDevEnv() = %b", Boolean.valueOf(bool), Boolean.valueOf(yfc.a()));
              return null;
            }
          }
          ...
          if (QLog.isColorLevel()) {
            QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "parsePushRedPointInfo:" + ntq.a(paramArrayOfByte));
          }
        ...
        try
        {
          ...
          m = ((Integer)axqc.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
          if (i != 0)
          {
            new bdlf(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("push_red_send").a(new String[] { String.valueOf(m), "0", String.valueOf(k), "0" }).a();
        ...
        catch (Exception localException)
        {
          ...
          i = nti.a(paramArrayOfByte, paramQQAppInterface);
          if (i >= 0) {
            break label701;
          }
          if (!QLog.isColorLevel()) {
          ...
          QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "comparePriority:比上一个红点优先级低，current：" + ntq.a(paramArrayOfByte) + "|lastRedPoint:" + ntq.a(paramQQAppInterface));
          return null;
          ...
          QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "当前红点比上一个红点旧，current：" + ntq.a(paramArrayOfByte) + "|lastRedPoint:" + ntq.a(paramQQAppInterface));
          return null;
          paramQQAppInterface = localException.a();
          ...
          QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "故事的撤回红点需要判断uin和lasttime，强校验，和上一个不一致的话直接返回，不处理，current：" + ntq.a(paramArrayOfByte) + "|lastRedPoint:" + ntq.a(paramQQAppInterface));
          return null;
          if (46 != paramArrayOfByte.uint32_appid.get()) {
            break label1003;
          }
          if (!becr.a(paramQQAppInterface)) {
            break label1032;
          }
          ...
          return null;
          if (nti.c(paramArrayOfByte.uint32_appid.get())) {
            break label1032;
          }
        }
        localObject2 = (ntq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH_EX);
        if (!nti.b(paramArrayOfByte.uint32_appid.get())) {
          break label884;
        }
        if (!paramArrayOfByte.bool_display_reddot.get()) {
          break label772;
        }
        paramQQAppInterface = (wjl)wjs.a(10);
        ...
        QLog.d("TroopRedTouchHandlerQ.qqstory.redPoint", 2, "故事红点下发到达时间：" + l1 + "小于最近更新刷新时间：" + l2 + ntq.a(paramArrayOfByte));
        return null;
        ykq.a("TroopRedTouchHandler", "parsePushRedPointInfo() return %s", paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    {
      return;
      localntq = (ntq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH_EX);
    } while ((localntq == null) || (paramRedDotInfo == null));
    int i = paramRedDotInfo.uint32_appid.get();
    if ((i != 56) && (i != 61))
    {
      paramRedDotInfo.bool_display_reddot.set(false);
      paramRedDotInfo.uint32_number.set(0);
      localntq.a(paramRedDotInfo);
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, oidb_0x791.RedDotInfo paramRedDotInfo, int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramQQAppInterface != null) && (paramRedDotInfo != null) && (paramRedDotInfo.uint32_appid.has()))
    {
      ...
      if (j == 46)
      {
        ...
        if (localaoxz.findRecentUser(AppConstants.TENCENT_DOCS_ASSISTANT_UIN, 6004) == null) {
          break label192;
        }
      }
    }
    ...
    label198:
    RecentUser localRecentUser = (RecentUser)localaoxz.findRecentUserByUin(AppConstants.TENCENT_DOCS_ASSISTANT_UIN, 6004);
    ...
    for (long l = paramRedDotInfo.uint32_last_time.get();; l = NetConnInfoCenter.getServerTimeMillis() / 1000L)
    {
      ...
      localRecentUser.displayName = paramQQAppInterface.getApp().getString(2131719311);
      if (paramInt != 0) {
  ...
  private static boolean b(QQAppInterface paramQQAppInterface, List<Integer> paramList, byte[] paramArrayOfByte)
  {
    try
    {
      ...
      if (paramArrayOfByte != null)
      {
        ...
        boolean bool = ((ntq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH_EX)).a(paramList, paramArrayOfByte);
        return bool;
      }
    }
    catch (Exception paramQQAppInterface)
  ...
  private void c()
  {
    ...
    localObject2 = new NewIntent(this.app.getApplication(), nta.class);
    ...
    ((NewIntent)localObject2).setObserver(new ntk(this, (List)localObject1));
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        localbbbq.b(str);
      } while (localbbbq.a(7719) == null);
      localbbbq.a(7719, str);
      return;
      label148:
      str = "";
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), nta.class);
    localNewIntent.putExtra("cmd", weg.a("StorySvc.clr_710_message_list"));
    localNewIntent.putExtra("data", localReqClearMessage.toByteArray());
    localNewIntent.setObserver(new ntn(this));
    this.app.startServlet(localNewIntent);
  }
  
  public void a(int paramInt, boolean paramBoolean)
  {
    Object localObject = (ntq)this.app.getManager(QQManagerFactory.MGR_RED_TOUCH_EX);
    if (localObject != null)
    {
      oidb_0x791.RedDotInfo localRedDotInfo = ((ntq)localObject).a(paramInt, false);
      if ((localRedDotInfo != null) && (localRedDotInfo.uint32_number.has()) && (localRedDotInfo.uint32_number.get() > 0))
      {
        ...
        ((ntq)localObject).a(localRedDotInfo);
  ...
  public void a(int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2, oidb_0x791.RedDotInfo paramRedDotInfo, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    for (paramInt2 = 2887;; paramInt2 = 1937)
    {
      ...
      paramRedDotInfo = new NewIntent(this.app.getApplication(), nta.class);
      ...
      paramRedDotInfo.setObserver(new nto(this));
      this.app.startServlet(paramRedDotInfo);
      return;
    }
  }
  
  public void a(ntq paramntq, int paramInt)
  {
    paramntq = paramntq.a(paramInt);
    a(this.app, paramntq);
  }
  ...
  public void a(oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    for (;;)
    {
      ...
      ((NewIntent)localObject2).setObserver(new ntl(this));
      this.app.startServlet((NewIntent)localObject2);
      return;
  ...
  public void onDestroy()
  {
    if (this.jdField_a_of_type_Ntp != null) {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Ntp);
    }
    this.jdField_a_of_type_Int = 0;
    super.onDestroy();
  }
