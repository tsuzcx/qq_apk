...
public class ksm
{
  ...
  public static String a(ConfigurationService.Config paramConfig, int paramInt1, int paramInt2)
  {
    ...
    while (paramInt1 < paramInt2)
    {
      ...
      else
      {
        ...
        {
          localObject1 = aknk.a((byte[])localObject2);
  ...
  public static void a(int paramInt, String paramString, ConfigurationService.ConfigSeq paramConfigSeq)
  {
    ...
    for (;;)
    {
      ...
      return;
      paramInt = EffectConfigBase.c(paramInt, EffectConfigBase.d);
      paramConfigSeq.version.set(paramInt);
      paramConfigSeq.compress.set(1);
      continue;
      paramInt = baig.a(BaseApplicationImpl.getContext());
      paramConfigSeq.version.set(paramInt);
      paramConfigSeq.compress.set(1);
    }
  }
  ...
  public static void b(int paramInt, String paramString, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      return;
      int j = EffectConfigBase.c(paramInt, EffectConfigBase.d);
      paramConfig = a(paramConfig, j, paramInt);
      paramString = paramConfig;
      i = j;
      if (paramConfig != null)
      {
        EffectConfigBase.a(paramInt, EffectConfigBase.d, k, paramConfig);
        paramString = paramConfig;
        i = j;
        continue;
        i = EffectConfigBase.c(paramInt, EffectConfigBase.d);
        paramConfig = a(paramConfig, i, paramInt);
        paramString = paramConfig;
        paramInt = i;
        if (paramConfig != null)
        {
          lfd.a(localQQAppInterface.getApplication(), paramConfig, k, true);
          paramString = paramConfig;
          continue;
          i = baig.a(localQQAppInterface.getApplication());
          paramConfig = a(paramConfig, i, paramInt);
          paramString = paramConfig;
          paramInt = i;
          if (paramConfig != null)
          {
            baig.a(localQQAppInterface.getApplication(), k);
            paramString = baig.c(localQQAppInterface.getCurrentAccountUin());
            if (paramString != null) {
