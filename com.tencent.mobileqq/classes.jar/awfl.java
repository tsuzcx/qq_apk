  ...
  implements awgr
{
  ...
  public awfl()
  {
    this.jdField_a_of_type_EipcEIPCResultCallback = new awfm(this);
    this.jdField_b_of_type_EipcEIPCResultCallback = new awfn(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("listenTogether".equals(paramString2))
    {
      ...
      do
      {
        ...
        awgo.a(paramJsBridgeListener, "isOpener", this.jdField_b_of_type_EipcEIPCResultCallback);
        return true;
        if (!"isShowAtmosphere".equals(paramString3)) {
          break;
        }
      } while (TextUtils.isEmpty(this.c));
      awgo.a(paramJsBridgeListener, "isShowAtmosphere", this.jdField_a_of_type_EipcEIPCResultCallback);
      return true;
      if ("setPlayerId".equals(paramString3))
      {
        awgo.a(paramJsBridgeListener, "setPlayerId", null);
        return true;
      }
      if ("setThemeEnabled".equals(paramString3))
      {
        awgo.a(paramJsBridgeListener, "setThemeEnabled", null);
        return true;
      }
    }
    return false;
