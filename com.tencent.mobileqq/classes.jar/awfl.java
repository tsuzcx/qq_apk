  ...
  extends aweq
{
  ...
  public int a()
  {
    ...
    if (this.jdField_g_of_type_JavaLangString != null)
    {
      ...
      awen.b("PIC_TAG_ERROR", "PicUploadInfo.getProtocolType", "localPath == null");
    }
  ...
  public boolean a()
  {
    ...
    if (this.i)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.rawMd5)) || (!bdcs.b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.thumbPath)))
      {
    ...
    if (!bdcs.b(this.jdField_g_of_type_JavaLangString))
    {
    ...
    Object localObject = aipm.a(this.jdField_g_of_type_JavaLangString);
    if (localObject != null)
    {
      if (this.jdField_g_of_type_Int == 1)
      {
        localObject = ((aipm)localObject).a();
        if (localObject != null) {
  ...
  String b()
  {
    ...
    {
      awen.b("PIC_TAG_ERROR", "PicUploadInfo.getUrlString", "protocol == null");
      return null;
    }
    if ("chatthumb".equals(this.jdField_e_of_type_JavaLangString)) {}
    for (;;)
    {
      URL localURL = baul.a(this, i1, null);
      if (localURL == null) {
        break;
      }
