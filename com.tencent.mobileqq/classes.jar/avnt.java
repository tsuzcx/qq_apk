  ...
  implements Manager
{
  ...
  public avnt(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    try
    {
      SharedPreferences.Editor localEditor = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("tim_upgrade_hongdian_pre_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 0).edit();
      if (localEditor != null)
      {
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        SharedPreferences localSharedPreferences = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("tim_upgrade_hongdian_pre_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 0);
