...
public class aetz
  extends akim
{
  public aetz(TroopChatPie paramTroopChatPie) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if ((paramInt1 == 9) && (this.a.af)) {
      bcpw.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajyc.a(2131715265), 0).a();
    }
  }
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if ((paramInt1 == 2) || (paramInt1 == 9))
    {
      if (paramInt2 == 0)
      {
        ...
        String str = ajyc.a(2131715270);
        if (this.a.af) {
          str = ajyc.a(2131715268);
        }
        bcpw.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2, str, 0).a();
        str = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
        TroopChatPie.a(this.a, paramString, str);
        ((akhq)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
    else {
      return;
    }
    bcpw.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajyc.a(2131715263), 0).a();
  }
  
  protected void a(azru paramazru)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "onPushTroopEnterEffect: troopUin = " + paramazru.b + ", data.id = " + paramazru.jdField_a_of_type_Int);
    }
    ...
    paramazru = this.a.a();
    paramazru.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    paramazru.a();
  }
  ...
  {
    if (!bbbd.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      localHashMap.put("netType", bbev.a(BaseApplication.getContext()) + "");
      axrl.a(BaseApplication.getContext()).a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "multiMsgNickTimeoutR", false, 30000L, 0L, localHashMap, "");
      do
      {
        return;
        if (paramBoolean) {
        ...
        i = 1;
        break;
        if ((this.a.c != null) && (asty.a().jdField_a_of_type_Int != 2)) {
          this.a.c.dismiss();
        }
        asty.a().b.clear();
      ...
      if (asty.a().jdField_a_of_type_Int == 6)
      {
        ((adin)TroopChatPie.a(this.a).a(11)).a((Map)paramObject, asty.a().jdField_a_of_type_JavaUtilArrayList, asty.a().jdField_a_of_type_Int);
        return;
      }
      ((adiq)TroopChatPie.b(this.a).a(1)).a((Map)paramObject, asty.a().jdField_a_of_type_JavaUtilArrayList, asty.a().jdField_a_of_type_Int);
      return;
      label405:
      i = 0;
    }
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt, List<String> paramList)
  {
    ...
    if ((paramBoolean) && (baqn.a(paramInt)) && (paramString.equalsIgnoreCase((String)localObject)))
    {
      if ((paramInt != 2) && (paramInt != 3) && (paramInt != 1) && (paramInt != 5)) {
        break label129;
      }
      paramList = (adjn)this.a.a(28);
      if (paramList != null) {
    ...
    for (;;)
    {
      ...
      if ((paramInt == 4) && (paramList != null) && (paramList.size() > 0))
      {
        if (!this.a.am)
        {
          ...
          localObject = (adjn)this.a.a(28);
          if (localObject != null) {
            ((adjn)localObject).a(paramBoolean, paramString);
          }
        }
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    if (i != 0) {
      new baae(this.a.jdField_a_of_type_AndroidContentContext, "3171", "libWXVoice.so", "WXVoice").a();
    }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1)) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramString2)) && (paramInt1 == 1) && (paramInt2 == 0))
    {
      ...
      axqw.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "AIOchat", "Get_history", 0, 0, paramString1, "", "", "");
      if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString3, String paramString4)
  {
    if (paramBoolean)
    {
      if (paramInt4 == 0)
      {
        mye.a().a(paramString1, paramInt2, paramInt1, paramString2, paramInt3, null, paramString4);
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    {
      if ((!bahk.a(paramInt)) && (TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof badj))) {
        ((badj)TroopChatPie.a(this.a).a).b(this.a);
      }
  ...
  protected void a(boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      baik.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<basr> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        localbasr = (basr)paramList.next();
        if (!TextUtils.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localbasr.jdField_a_of_type_JavaLangString)) {
          continue;
        }
        if (localbasr.jdField_a_of_type_Long == 1104445552L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, new Object[] { "onUpdateTroopUnreadMsg homework. num=", Integer.valueOf(localbasr.b) });
          }
          ...
          if ((TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof badj))) {
            ((badj)TroopChatPie.a(this.a).a).a(false, this.a);
          }
        }
      }
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive troop album  red dot, push=" + paramBoolean2 + ", num=" + localbasr.b);
        }
        Message localMessage = TroopChatPie.c(this.a).obtainMessage(85);
        localMessage.arg1 = localbasr.b;
        localMessage.sendToTarget();
        break label72;
        break;
        label328:
        if (localbasr.jdField_a_of_type_Long == 1106611799L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive game feed red dot, push=" + paramBoolean2 + ", num=" + localbasr.b);
          }
  ...
  protected void c(String paramString1, String paramString2)
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1))
    {
      List localList = this.a.jdField_a_of_type_Acut.a();
      ...
      paramString1 = ((bals)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(paramString1, paramString2);
      if (paramString1 != null)
      {
  ...
  protected void c(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = (batb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234);
  ...
  {
    if ((this.a.N) || (this.a.jdField_a_of_type_Bass == null)) {}
    boolean bool1;
    boolean bool2;
    do
    {
      ...
      bool1 = ((aruf)this.a.a(33)).c();
      bool2 = ((adjk)this.a.a(43)).c();
    } while ((this.a.V) || (bool1) || (bool2));
    if (!paramBoolean)
    {
      this.a.jdField_a_of_type_Bass.a(2);
      return;
    }
    paramString2 = ((batb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(paramString1);
    ...
    {
      this.a.jdField_a_of_type_Bass.a(paramString1);
      if (this.a.jdField_a_of_type_Bass.a())
      {
        this.a.jdField_a_of_type_Bass.d();
        TroopChatPie.a(this.a, true);
        return;
      }
      this.a.jdField_a_of_type_Bass.a(0);
  ...
  protected void d(boolean paramBoolean, String paramString, List<TroopAIONotifyItem> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.a.jdField_a_of_type_Aznm == null);
      bool1 = this.a.jdField_a_of_type_Aznm.a();
      bool2 = this.a.jdField_a_of_type_Aznm.d();
      int j = 0;
      int i = j;
      if (paramList != null)
      {
        ...
        if (paramList.size() > 0)
        {
          this.a.jdField_a_of_type_Aznm.a(paramList);
          i = j;
          if (!bool2)
          {
            i = j;
            if (!bool1)
            {
              this.a.jdField_a_of_type_Aznm.f();
              i = 1;
            }
          }
        }
