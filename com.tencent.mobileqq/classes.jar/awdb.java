...
public class awdb
  ...
  implements bgcc
{
  private static akfx jdField_a_of_type_Akfx;
  private static akgd jdField_a_of_type_Akgd;
  ...
  {
    SosoInterface.SosoLbsInfo localSosoLbsInfo = akfu.a(paramString);
    if (localSosoLbsInfo != null) {}
    for (boolean bool = true;; bool = false)
    {
      bgcd.a(bool, paramString);
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      return;
      e = l;
    } while (jdField_a_of_type_Akfx == null);
  ...
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Akfx == null))
    {
      jdField_a_of_type_Akfx = new awdc(paramString, false);
      try
      {
  ...
  {
    super.onDestroy();
    if (jdField_a_of_type_Akgd != null) {
      SosoInterface.b(jdField_a_of_type_Akgd);
    }
    jdField_a_of_type_Akgd = null;
    if (jdField_a_of_type_Akfx != null) {
      akfu.b(jdField_a_of_type_Akfx);
    }
    jdField_a_of_type_Akfx = null;
    bgbz.a().b(this);
    if (this.jdField_a_of_type_MqqOsMqqHandler != null)
    {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      awbz.a(paramIntent, paramFromServiceMsg, (QQAppInterface)localObject, this);
      return;
    }
    awbz.a((QQAppInterface)localObject, paramIntent, paramFromServiceMsg, this);
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (awcz)((QQAppInterface)localObject1).getManager(10);
      Object localObject3;
      if (localObject2 != null)
      {
        paramIntent = ((awcz)localObject2).a;
        if (paramIntent != null)
        {
          localObject3 = awbz.a(paramIntent);
          ...
          if (j < i1)
          {
            ...
            localObject4 = (bfso)((awcz)localObject2).a.get(Integer.valueOf(i2));
            ArrayList localArrayList;
            if (localObject4 != null)
            {
              localObject5 = new single_count(((bfso)localObject4).jdField_a_of_type_Long, (byte)((bfso)localObject4).jdField_a_of_type_Int);
              localArrayList = new ArrayList();
              if ((((bfso)localObject4).jdField_a_of_type_JavaUtilArrayList == null) || (((bfso)localObject4).jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
                break label715;
              }
            }
            label715:
            for (paramIntent = new feed_host_info(((QZoneCountUserInfo)((bfso)localObject4).jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long, "", ((bfso)localObject4).jdField_a_of_type_JavaLangString, null, null, null);; paramIntent = new feed_host_info(0L, "", ((bfso)localObject4).jdField_a_of_type_JavaLangString, null, null, null))
            {
              localArrayList.add(paramIntent);
              localConcurrentHashMap1.put(Integer.valueOf(i2), new count_info((single_count)localObject5, localArrayList, ((bfso)localObject4).jdField_b_of_type_JavaLangString, ((bfso)localObject4).c, ((bfso)localObject4).e, ((bfso)localObject4).f, ((bfso)localObject4).g, ((bfso)localObject4).jdField_b_of_type_Long, ((bfso)localObject4).d));
              j += 1;
              break;
            }
          }
          paramIntent = (bfso)((awcz)localObject2).a.get(Integer.valueOf(56));
          if (paramIntent != null)
          {
      ...
      for (;;)
      {
        ...
        paramIntent = awbz.a(Long.valueOf(((QQAppInterface)localObject1).getCurrentAccountUin()).longValue(), null, m, n, i, k, localConcurrentHashMap1, paramIntent, localConcurrentHashMap2);
        if (paramIntent == null)
        {
          paramIntent = new byte[4];
          notifyObserver(null, 1000, false, new Bundle(), atdk.class);
        }
        for (;;)
        {
          a();
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    awbz.a((QQAppInterface)paramString, i, paramBundle);
  }
  ...
  public void service(Intent paramIntent)
  {
    if (paramIntent.getAction().equals("Qzone_Refresh_UI"))
    {
      ...
      notifyObserver(null, 1000, true, paramIntent, atdk.class);
      if (QLog.isColorLevel()) {
