...
public class aslg
{
  ...
  private static Map<String, aslh> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  {
    aslh localaslh = new aslh();
    localaslh.jdField_a_of_type_JavaLangString = paramString;
    localaslh.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    jdField_b_of_type_JavaUtilMap.put(paramString, localaslh);
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    {
      aszk.a(0, String.format(BaseApplicationImpl.getApplication().getResources().getString(2131692364), new Object[] { Integer.valueOf(jdField_c_of_type_Int) }), 0);
      return false;
    }
    if ((jdField_a_of_type_Long > 0L) && (d() + paramLong > jdField_a_of_type_Long))
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131692371);
      aszk.a(0, str + FileUtil.filesizeToString(jdField_a_of_type_Long), 0);
      return false;
    }
    return true;
  }
  ...
  public static boolean b()
  {
    ...
    while (localIterator.hasNext())
    {
      str = FileUtil.getExtension(((FileInfo)localIterator.next()).d());
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
      if (!bcvs.jdField_a_of_type_JavaLangString.contains(str)) {
        return false;
      }
    }
    ...
    while (localIterator.hasNext())
    {
      str = FileUtil.getExtension(((FileManagerEntity)localIterator.next()).fileName);
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
  ...
  {
    paramFileInfo = FileUtil.getExtension(paramFileInfo.d());
    if ((paramFileInfo == null) || (paramFileInfo.length() == 0)) {}
    do
    {
      return false;
      paramFileInfo = paramFileInfo.toLowerCase();
    } while (!bcvs.jdField_a_of_type_JavaLangString.contains(paramFileInfo));
    return true;
  }
  ...
  public static boolean b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    } while (!bcvs.jdField_a_of_type_JavaLangString.contains(paramFileManagerEntity));
    return true;
  }
  ...
  public static long c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (asyq.a(localFileManagerEntity).a(false)) {
        l += FileUtil.getFileSize(localFileManagerEntity.getFilePath());
      }
    }
    return l;
  }
