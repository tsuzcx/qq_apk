...
public class aqao
{
  ...
  public static void a(int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_init_result", true, 0L, 0L, localHashMap, "", false);
  ...
  public static void a(long paramLong1, long paramLong2, long paramLong3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_open_total_cost", true, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public static void a(String paramString)
  {
    if (a())
    {
      ...
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_exception", true, 0L, 0L, localHashMap, "", false);
    }
  }
  ...
  public static void a(String paramString, int paramInt, double paramDouble)
  {
    if (a())
    {
      ...
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_fps", true, 0L, 0L, localHashMap, "", false);
    }
  }
  ...
  public static void a(String paramString, long paramLong)
  {
    if (a())
    {
      ...
      localHashMap.put("pagePath", paramString);
      localHashMap.put("cost", String.valueOf(paramLong));
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_page_render_cost", true, 0L, 0L, localHashMap, "", false);
    }
  }
  ...
  public static void a(boolean paramBoolean, long paramLong)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("cost", String.valueOf(paramLong));
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_launch_result", true, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public static void a(boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      localHashMap.put("isLocalAppExist", str);
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_install_result", true, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, Map<String, Integer> paramMap)
  {
    ...
    Object localObject = bbct.a(BaseApplicationImpl.getContext());
    ...
    for (paramMap = "1";; paramMap = "0")
    {
      ...
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_enter_memory_increment", true, 0L, 0L, localHashMap, "", false);
      return;
    }
    axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_exit_memory_increment", true, 0L, 0L, localHashMap, "", false);
  }
  ...
  public static void b(String paramString)
  {
    if (a())
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("pagePath", paramString);
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_pv", true, 0L, 0L, localHashMap, "", false);
    }
  }
  ...
  public static void b(boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      localHashMap.put("isLocalAppExist", str);
      axrl.a(BaseApplicationImpl.getContext()).a("", "qq_flutter_download_cost", true, 0L, 0L, localHashMap, "", false);
      if (!QLog.isColorLevel()) {
        break;
      }
