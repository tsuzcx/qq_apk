  ...
  extends aaap
{
  ...
  public aaat(String paramString1, String paramString2)
  {
  ...
  private void c()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 52	aaat:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   6: ifnull +13 -> 19
    //   9: aload_0
    //   10: invokevirtual 52	aaat:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   13: invokevirtual 61	com/jakewharton/disklrucache/DiskLruCache:isClosed	()Z
    //   16: ifeq +86 -> 102
    //   19: invokestatic 65	bhrw:c	()Z
    //   22: ifne +10 -> 32
    //   25: aload_0
    //   26: getfield 42	aaat:jdField_b_of_type_Long	J
    //   29: putstatic 20	aaat:jdField_a_of_type_Long	J
    //   32: aload_0
    //   33: invokevirtual 68	aaat:b	()Ljava/lang/String;
    //   36: astore_1
    ...
    //   76: getstatic 20	aaat:jdField_a_of_type_Long	J
    //   79: invokestatic 92	bhsr:a	(J)Ljava/lang/String;
    ...
    //   88: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   91: aload_2
    //   92: invokevirtual 102	java/io/File:mkdirs	()Z
    //   95: pop
    //   96: aload_0
    //   97: aload_2
    //   98: invokevirtual 105	aaat:a	(Ljava/io/File;)Z
    //   101: pop
    //   102: aload_0
    //   103: monitorexit
    //   104: return
    ...
    //   128: getstatic 20	aaat:jdField_a_of_type_Long	J
    //   131: invokestatic 92	bhsr:a	(J)Ljava/lang/String;
    ...
    //   140: invokestatic 109	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   143: goto -47 -> 96
    //   146: astore_1
    //   147: aload_0
    //   148: monitorexit
  ...
  public aaaq a(String paramString)
  {
    c();
    aaaq localaaaq = new aaaq(this);
    ...
    if ((a() != null) && (str != null))
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          yuk.d("LruCache", "Get cache error: Cache name: " + str + ", Url: " + paramString);
        }
        yuk.c("LruCache", "Get cache success: Cache name: " + str + ", Url: " + paramString);
        return localaaaq;
      }
      if (localObject != null)
      {
        localaaaq.a(localObject);
        localaaaq.a(localObject.getInputStream(0));
        if (localaaaq.a() == null)
        {
          yuk.d("LruCache", "Get cache error: InputStream is null. Cache name: " + str + ", Url: " + paramString);
          return localaaaq;
        }
      }
      yuk.d("LruCache", "Get cache error: snapshot is null. Cache name: " + str + ", Url: " + paramString + ",instance hashCode:" + a());
      return localaaaq;
    }
    yuk.d("LruCache", "Get cache error: DiskCache or cacheName is null. Cache name: " + str + ", Url: " + paramString);
    return localaaaq;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    //   9: istore_3
    //   10: aload_0
    //   11: invokespecial 48	aaat:c	()V
    //   14: aload_0
    //   15: invokevirtual 52	aaat:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   18: ifnull +177 -> 195
    //   21: aload_0
    //   22: aload_1
    //   23: invokevirtual 120	aaat:a	(Ljava/lang/String;)Ljava/lang/String;
    //   26: astore 6
    //   28: aload_0
    //   29: getfield 162	aaat:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   32: astore 7
    //   34: aload 7
    //   36: monitorenter
    //   37: iload 4
    //   39: istore_2
    //   40: aload_0
    //   41: invokevirtual 52	aaat:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   44: aload 6
    //   46: invokevirtual 124	com/jakewharton/disklrucache/DiskLruCache:get	(Ljava/lang/String;)Lcom/jakewharton/disklrucache/DiskLruCache$Snapshot;
    //   49: astore 8
    //   51: aload 8
    //   53: ifnull +20 -> 73
    //   56: iload 4
    ...
    //   107: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   110: goto -44 -> 66
    //   113: astore 6
    //   115: aload 7
    //   117: monitorexit
    ...
    //   144: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   147: iload_2
    //   148: ireturn
    //   149: astore 6
    //   151: iload 5
    ...
    //   175: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   178: iload_2
    //   179: ireturn
    //   180: astore 6
    //   182: goto -28 -> 154
  ...
  public boolean a(String arg1, java.io.InputStream paramInputStream)
  {
    ...
    //   7: istore 5
    //   9: aload_0
    //   10: getfield 36	aaat:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 7
    //   15: aload 7
    //   17: monitorenter
    //   18: aload_0
    //   19: iconst_1
    //   20: putfield 191	aaat:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: aload_1
    //   25: putfield 40	aaat:d	Ljava/lang/String;
    //   28: aload 7
    //   30: monitorexit
    //   31: aload_0
    //   32: invokespecial 48	aaat:c	()V
    //   35: aload_0
    //   36: aload_1
    //   37: invokevirtual 120	aaat:a	(Ljava/lang/String;)Ljava/lang/String;
    //   40: astore 11
    //   42: aload_0
    //   43: invokevirtual 52	aaat:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   46: ifnull +477 -> 523
    //   49: aload 11
    //   51: ifnull +472 -> 523
    //   54: aload_2
    //   55: ifnull +468 -> 523
    //   58: aload_0
    //   59: getfield 162	aaat:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   62: astore 10
    //   64: aload 10
    //   66: monitorenter
    //   67: aload_0
    //   68: invokevirtual 52	aaat:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   71: aload 11
    ...
    //   93: getstatic 22	aaat:jdField_b_of_type_Int	I
    //   96: invokespecial 206	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   99: astore 8
    //   101: aload 8
    //   103: astore 7
    //   105: getstatic 22	aaat:jdField_b_of_type_Int	I
    //   108: newarray byte
    //   110: astore 12
    //   112: aload 8
    //   114: astore 7
    ...
    //   130: astore 7
    //   132: aload_0
    //   133: getfield 191	aaat:jdField_a_of_type_Boolean	Z
    //   136: ifne +192 -> 328
    //   139: aload 8
    //   141: astore 7
    //   143: ldc 29
    //   145: ldc 214
    //   147: invokestatic 217	yuk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   150: aload 8
    //   152: astore 7
    //   154: aload 8
    ...
    //   214: aload_0
    //   215: invokespecial 155	aaat:a	()I
    //   218: invokevirtual 158	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   221: invokevirtual 95	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   224: invokestatic 149	yuk:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   227: aload_0
    //   228: getfield 162	aaat:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    ...
    //   239: istore 5
    //   241: aload_0
    //   242: getfield 191	aaat:jdField_a_of_type_Boolean	Z
    //   245: ifne +12 -> 257
    //   248: aload_0
    //   249: aload_1
    //   250: invokevirtual 237	aaat:a	(Ljava/lang/String;)V
    //   253: iload 4
    //   255: istore 5
    //   257: aload_0
    //   258: getfield 36	aaat:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   261: astore_1
    //   262: aload_1
    //   263: monitorenter
    //   264: aload_0
    //   265: iconst_0
    //   266: putfield 191	aaat:jdField_a_of_type_Boolean	Z
    //   269: aload_0
    //   270: ldc 38
    //   272: putfield 40	aaat:d	Ljava/lang/String;
    //   275: aload_1
    //   276: monitorexit
    //   277: iload 5
    //   279: ireturn
    ...
    //   319: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   322: aconst_null
    //   323: astore 9
    //   325: goto -247 -> 78
    //   328: aload 8
    ...
    //   358: invokestatic 109	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   361: aload 8
    //   363: astore 7
    //   365: aload 8
    //   367: aload 12
    ...
    //   417: aload_0
    //   418: invokespecial 155	aaat:a	()I
    //   421: invokevirtual 158	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   424: invokevirtual 95	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   427: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   430: iload 5
    //   432: istore 4
    //   434: aload_2
    //   435: ifnull -254 -> 181
    ...
    //   517: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   520: goto -293 -> 227
    //   523: ldc 29
    ...
    //   554: invokestatic 99	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   557: iload 6
    //   559: istore 5
    //   561: goto -304 -> 257
    //   564: astore_2
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    if ((a() != null) && (str != null))
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          yuk.d("LruCache", "Set cache error: Exception ");
        }
      }
      finally {}
      bool1 = bool2;
      if (localObject != null) {
        yuk.c("LruCache", "name: " + paramString1 + ", Cache name: " + str + ", value length: " + paramString2.length());
      }
      try
      {
        localObject.set(0, twy.a(paramString2));
        localObject.commit();
        bool1 = true;
      }
      catch (IOException paramString1)
      {
        for (;;)
        {
          yuk.d("LruCache", "Commit cache error: Exception ");
          bool1 = bool2;
        }
      }
  ...
  {
    if (bhrw.c()) {}
    for (String str = bhrw.a() + File.separator + "Android" + File.separator + "data" + File.separator + jdField_b_of_type_JavaLangString + File.separator + "cache" + File.separator + a();; str = c + File.separator + "cache" + File.separator + a())
    {
      yuk.b("LruCache", "Init cache dir: " + str);
      return str;
    }
  }
