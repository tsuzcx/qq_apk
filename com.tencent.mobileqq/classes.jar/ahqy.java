  ...
  implements Handler.Callback, View.OnClickListener, Animation.AnimationListener
{
  ...
  static
  {
    jdField_a_of_type_Int = actj.a(50.0F, BaseApplicationImpl.getApplication().getResources());
  }
  
  public ahqy(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)paramViewGroup.findViewById(2131374885));
    i();
    b();
  }
      ...
      for (int i = ((RecentBaseData)localObject1).b();; i = 0)
      {
        ...
        if ((paramObject instanceof RecentUserBaseData))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 instanceof ahqp))
            {
              i = 1;
              boolean bool = BaseApplicationImpl.getContext().getResources().getString(2131699621).equals(((RecentUserBaseData)localObject1).mContentDesc);
              if ((i == 0) && (!bool)) {
                break label147;
              }
              i = 1;
  ...
  private boolean c(Object paramObject)
  {
    if ((paramObject instanceof RecentUserBaseData))
    {
      ...
      if (paramObject.mUser.getType() == 1)
      {
        ...
        {
          paramObject = ((asks)localAppRuntime.getManager(37)).a(paramObject.mUser.uin, 100);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bfob.post(local1);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1381653; paramView.getTag(2131373681) == null; i = 11580351)
      {
        paramView.setTag(2131373681, paramView.getBackground());
  ...
  public boolean a(ahmv paramahmv)
  {
    boolean bool2 = false;
    int j = 0;
    boolean bool1 = bool2;
  ...
  public boolean a(Object paramObject)
  {
    ...
    label109:
    for (bool1 = aiiz.a((String)localObject + str);; bool1 = false)
    {
      boolean bool3 = BaseApplicationImpl.getContext().getResources().getString(2131717490).equals(((RecentUserBaseData)paramObject).mMsgExtroInfo);
      if (!bool1)
      {
        bool1 = bool2;
        if (!bool3) {}
  ...
  public void b()
  {
    ...
    int i = 0;
    int m;
    if (k < ((ahmv)localObject1).getCount())
    {
      Object localObject2 = ((ahmv)localObject1).getItem(k);
      ...
      if (m == 100)
      {
        ...
        if ((i == 0) && (j > 0))
        {
          ...
          if (this.jdField_b_of_type_Int != i)
          {
            ...
            axqy.b(null, "dc00898", "", "", "0X800A493", "0X800A493", 0, 0, "", "", "", "");
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Bfob.post((Runnable)localObject1);
          return;
          if ((i > 0) && (j == 0))
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityConversation.f = 17;
          ...
          for (k = 1;; k = 2)
          {
            ...
            this.d = k;
            axqy.b(null, "dc00898", "", "", "qq_vip", "0X800A8F9", k, 1, 0, "", "", "", "");
            break;
          }
        }
      }
  ...
  public boolean b()
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374888));
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374887));
  ...
  public void c()
  {
    String str;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityConversation.f == 17) {
      str = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getString(2131717491, new Object[] { Integer.valueOf(this.jdField_b_of_type_Int) });
    }
    for (int i = 2130839261;; i = 2130846568)
    {
      ...
      return;
      str = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getString(2131699616, new Object[] { Integer.valueOf(this.c) });
    }
  }
  ...
  public void e()
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131374884);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374888);
    if (bool)
    {
      localLinearLayout.setBackgroundResource(2130848516);
  ...
  public void onClick(View paramView)
  {
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentMobileqqActivityConversation.x();
    } while (this.c <= 0);
    axqy.b(null, "dc00898", "", "", "qq_vip", "0X800A8FA", this.d, 1, 0, "", "", "", "");
  }
}
