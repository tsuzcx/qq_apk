...
public class ahqy
  extends ajuc
{
  public ahqy(FriendTeamListInnerFrame paramFriendTeamListInnerFrame) {}
  ...
  protected void a(String paramString, boolean paramBoolean, List<TroopMemberInfo> paramList, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    localObject2 = (azks)this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app.getManager(203);
    bcpn localbcpn = (bcpn)this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app.getManager(165);
    Object localObject3 = (ajjj)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localObject3 != null)
        {
          ...
          if (!TextUtils.equals(((TroopMemberInfo)localObject3).memberuin, paramString)) {
            if ((((azks)localObject2).b(((TroopMemberInfo)localObject3).memberuin)) || (localbcpn.f(((TroopMemberInfo)localObject3).memberuin)))
            {
              if (QLog.isDevelopLevel()) {
