  ...
  extends BaseAdapter
{
  ...
  public auib(QQAppInterface paramQQAppInterface, Context paramContext, Drawable paramDrawable)
  {
  ...
  private View a(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (TextView)paramLayoutInflater.findViewById(2131364692);
  ...
  private auil a(LayoutInflater paramLayoutInflater, int paramInt, View paramView, ViewGroup paramViewGroup, AutoReplyText paramAutoReplyText)
  {
    if ((paramView == null) || (paramView.getTag() == null) || (paramView.getVisibility() == 8))
    {
      ...
      paramLayoutInflater = paramView.findViewById(2131365264);
      if (ThemeUtil.isDefaultTheme())
      {
        ...
        if ((!ThemeUtil.isDefaultTheme()) && (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))) {
          paramView.findViewById(2131375129).setBackgroundResource(2130839179);
        }
        paramView.findViewById(2131369113).setPadding(0, 0, 0, 0);
        paramView.findViewById(2131375300).setVisibility(8);
        paramViewGroup = (TextView)paramView.findViewById(2131369134);
        paramViewGroup.setEditableFactory(new auid(this, paramViewGroup));
        paramLayoutInflater = new auil(null);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375277));
        paramLayoutInflater.b = paramView.findViewById(2131365401);
        paramLayoutInflater.c = paramView.findViewById(2131365402);
        paramLayoutInflater.d = paramView.findViewById(2131377059);
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.setTag(paramLayoutInflater);
        label200:
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new auie(this, paramAutoReplyText));
        paramLayoutInflater.b.setOnClickListener(new auif(this, paramAutoReplyText));
        ...
        paramView = ayla.a(paramView, paramLayoutInflater.jdField_a_of_type_AndroidWidgetTextView.getPaint(), 3, i, axli.a - axli.a(67.0F), true);
        if (QLog.isColorLevel()) {
          QLog.d("AutoReplyAdapter", 2, "Truncate subText: " + paramView);
        }
        paramViewGroup = new ayki(paramView, 3, i);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(new ayki(ajyc.a(2131700849) + paramView, 3, i));
        paramLayoutInflater.c.setOnClickListener(new auig(this, paramAutoReplyText, bool));
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.findViewById(2131375129).setOnClickListener(new auih(this, paramAutoReplyText));
    ...
    label562:
    label567:
    for (paramInt = 0;; paramInt = axli.a(200.0F))
    {
      ...
      paramInt = 8;
      break;
      paramLayoutInflater = (auil)paramView.getTag();
      paramLayoutInflater.jdField_a_of_type_AndroidViewView = paramView;
      break label200;
      paramInt = 0;
      break label259;
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    auii localauii = new auii(this, paramView, paramView.getMeasuredHeight());
    localauii.setAnimationListener(new auij(this, paramInt));
    localauii.setDuration(150L);
    paramView.startAnimation(localauii);
  }
  ...
  private View b(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramLayoutInflater.setOnClickListener(new auic(this));
    return paramLayoutInflater;
  }
  ...
  private void b(int paramInt)
  {
    ...
    if (((Iterator)localObject).hasNext())
    {
      ...
      if (localAutoReplyText.getTextId() == paramInt)
      {
        ...
        {
          auik localauik = this.jdField_a_of_type_Auik;
          if (localAutoReplyText.getTextId() == 2147483647)
          {
            bool = true;
            localauik.a(localAutoReplyText, bool);
          }
        }
        else
        {
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.b = bool;
      if (this.jdField_a_of_type_Auik != null) {
        this.jdField_a_of_type_Auik.a(localObject2, localObject1);
      }
      notifyDataSetChanged();
      return;
    }
  ...
  public void a(@Nullable auik paramauik)
  {
    this.jdField_a_of_type_Auik = paramauik;
  }
  ...
  public void a(@Nullable AutoReplyText paramAutoReplyText)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Auik != null) {
        this.jdField_a_of_type_Auik.a(paramAutoReplyText);
      }
      a();
      this.b = true;
      notifyDataSetChanged();
