...
public class auib
{
  private static auib jdField_a_of_type_Auib;
  ...
  private auib()
  {
    try
    {
      ...
      this.jdField_a_of_type_Auid = new auid(this, BaseApplicationImpl.getContext());
  ...
  public static auib a()
  {
    if (jdField_a_of_type_Auib == null) {
      jdField_a_of_type_Auib = new auib();
    }
    return jdField_a_of_type_Auib;
  }
  ...
  public int a(aukz paramaukz, Bundle paramBundle, long paramLong, int paramInt)
  {
    if (-1 == paramInt)
    {
      paramInt = a();
    ...
    while (paramaukz != null)
    {
      paramaukz.a(new auic(this, ThreadManager.getSubThreadHandler().getLooper(), paramInt, paramBundle, paramLong), false);
      return paramInt;
  ...
  public Notification a(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      ((Notification)localObject1).icon = 2130844340;
      paramBundle = new RemoteViews(BaseApplication.getContext().getPackageName(), 2131560866);
      paramBundle.setImageViewResource(2131372108, 2130844336);
      paramBundle.setTextViewText(2131372119, (CharSequence)localObject2);
      paramBundle.setProgressBar(2131372101, 100, 0, false);
      paramBundle.setViewVisibility(2131372107, 8);
      paramBundle.setViewVisibility(2131372102, 8);
      paramBundle.setTextColor(2131372119, -7829368);
      paramBundle.setTextColor(2131372107, -7829368);
      paramBundle.setTextColor(2131372103, -7829368);
      float f1 = this.jdField_a_of_type_Auid.a();
      if (this.jdField_a_of_type_Auid.a() <= 0.0F)
      {
        QLog.w(jdField_a_of_type_JavaLangString, 1, "[UniformDL]. initNotification param error. getTextSize failed. set defualt value:14");
        f1 = 14.0F;
      }
      paramBundle.setFloat(2131372107, "setTextSize", f1);
      paramBundle.setFloat(2131372103, "setTextSize", f1);
      float f2 = this.jdField_a_of_type_Auid.b();
      f1 = f2;
      if (f2 <= 0.0F)
      {
      ...
      paramBundle.setFloat(2131372119, "setTextSize", f1);
      ...
      try
      {
        int i = this.jdField_a_of_type_Auid.a().intValue();
        paramBundle.setInt(2131372109, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
  ...
  protected void a(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    {
      return;
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131719775) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setImageViewResource(2131372108, 2130844336);
      int i = paramBundle2.getInt("_START_WAITING_");
      if (1 == i)
      {
        paramNotification.contentView.setTextViewText(2131372103, BaseApplication.getContext().getString(2131719776));
        paramNotification.contentView.setViewVisibility(2131372102, 0);
        paramNotification.contentView.setViewVisibility(2131372107, 8);
        paramNotification.contentView.setProgressBar(2131372101, 100, 0, false);
      ...
      for (;;)
      {
        ...
        paramNotification.contentView.setTextViewText(2131372103, "0%");
        break;
        paramNotification.when = a(3);
        break label243;
        paramNotification.contentView.setOnClickPendingIntent(2131372109, paramBundle1);
      }
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      auht.a().b(paramBundle.getString("_notify_param_Url"));
      return;
    }
  ...
  protected void a(int paramInt, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    localNotification.tickerText = (BaseApplication.getContext().getString(2131719769) + " " + paramBundle1.getString("_notify_param_Filename"));
    ...
    localObject = BaseApplication.getContext().getString(2131719771);
    if (auku.a(str1) != null)
    {
      localBitmap = auku.a(str1);
      localObject = BaseApplication.getContext().getString(2131719770);
    }
    if (localBitmap == null)
    {
      int j = auea.b(str1);
      if (j != 0)
      {
        localNotification.contentView.setImageViewResource(2131372108, j);
        label236:
        localNotification.contentView.setImageViewResource(2131372108, 2130844338);
      }
    }
    for (;;)
    {
      localNotification.contentView.setViewVisibility(2131372107, 0);
      localNotification.contentView.setViewVisibility(2131372102, 8);
      localNotification.contentView.setTextViewText(2131372107, (CharSequence)localObject);
      ...
      localNotification.contentView.setImageViewResource(2131372108, 2130844338);
      break label236;
      localNotification.contentView.setImageViewBitmap(2131372108, localBitmap);
    }
  }
  ...
  protected void b(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setProgressBar(2131372101, 100, i, false);
      paramNotification.contentView.setTextViewText(2131372103, "" + i + "%");
      paramNotification.flags = 34;
      paramBundle2 = new Intent("com.tencent.mobileqq.UniformDownloadNfn.PAUSE");
      paramBundle2.setPackage(MobileQQ.getContext().getPackageName());
      paramBundle2.putExtra("_PARAM_EXTRA", paramBundle1);
  ...
  public void b(int paramInt, Bundle paramBundle)
  {
    ...
    if (localNotification != null)
    {
      ...
      auht.a().a(paramBundle.getString("_notify_param_Url"), paramBundle.getString("_notify_param_Filename"), paramBundle.getString("_notify_param_ContentTitle", ""), paramBundle.getLong("_notify_param_Filesize"), paramBundle.getBundle("_notify_param_userdata"), paramInt, true);
      return;
    }
  ...
  protected void c(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    paramNotification.tickerText = null;
    int i = paramBundle2.getInt("_FILE_PROGRESS_");
    paramNotification.contentView.setImageViewResource(2131372108, 2130844339);
    paramNotification.contentView.setViewVisibility(2131372107, 0);
    paramNotification.contentView.setViewVisibility(2131372102, 8);
    paramNotification.contentView.setTextViewText(2131372107, BaseApplication.getContext().getString(2131719774));
    paramNotification.contentView.setProgressBar(2131372101, 100, i, false);
    paramNotification.contentView.setTextViewText(2131372103, "" + i + "%");
    ...
    for (;;)
    {
      ...
      paramNotification.contentView.setOnClickPendingIntent(2131372109, paramBundle2);
    }
  }
  ...
  protected void d(int paramInt, Notification paramNotification, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (2 == i)
    {
      paramNotification.tickerText = BaseApplication.getContext().getString(2131719773);
      paramNotification.contentView.setTextViewText(2131372107, BaseApplication.getContext().getString(2131719773));
      label115:
      paramNotification.contentView.setImageViewResource(2131372108, 2130844337);
      paramNotification.contentView.setViewVisibility(2131372107, 0);
      paramNotification.contentView.setTextViewText(2131372103, " ");
      paramNotification.flags = 16;
    ...
    for (;;)
    {
      ...
      paramNotification.tickerText = (BaseApplication.getContext().getString(2131719772) + " " + paramBundle1.getString("_notify_param_Filename"));
      paramNotification.contentView.setTextViewText(2131372107, aukz.a(i) + anvx.a(2131715243));
      break label115;
      label397:
      paramNotification.contentView.setOnClickPendingIntent(2131372109, paramBundle2);
    }
