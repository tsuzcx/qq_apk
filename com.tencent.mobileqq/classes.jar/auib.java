...
public class auib
  extends RecyclerView.Adapter<auic>
  implements bdbc
{
  ...
  public auib(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView)
  {
  ...
  private void a(auic paramauic, int paramInt, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if ((localRecentBaseData instanceof MsgBackupMsgUserData))
    {
      ...
      if (this.jdField_a_of_type_Ajjp != null) {
        paramDrawable = this.jdField_a_of_type_Ajjp.a(localRecentBaseData);
      }
      if (!a(localRecentBaseData)) {
        break label233;
      }
      localQQAppInterface = ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app;
      int j = ((Integer)ajjp.a(localQQAppInterface, localRecentBaseData.a(), localRecentBaseData.a()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
    ...
    for (;;)
    {
      ...
      paramauic.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(localRecentBaseData.mTitleName);
      auic.a(paramauic).setChecked(((Boolean)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(paramInt)).booleanValue());
      if (AppSetting.c) {
        paramauic.jdField_a_of_type_AndroidViewView.setContentDescription(localMsgBackupMsgUserData.name);
      }
      return;
      label224:
      break;
  ...
  private void b(auic paramauic, int paramInt, Drawable paramDrawable)
  {
    ...
    } while ((paramauic == null) || (localRecentBaseData == null));
    Drawable localDrawable = paramDrawable;
    if (paramDrawable == null)
    {
      int i = localRecentBaseData.a();
      localDrawable = this.jdField_a_of_type_Ajjp.a(i, localRecentBaseData.a());
    }
    a(paramauic, paramInt, localDrawable);
  }
  
  public auic a(ViewGroup paramViewGroup, int paramInt)
  {
    return new auic(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562544, paramViewGroup, false), this.jdField_a_of_type_Auid);
  }
  ...
  public void a(auic paramauic, int paramInt)
  {
    a(paramauic, paramInt, null);
  }
  
  public void a(auid paramauid)
  {
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        paramBitmap = (auic)this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildViewHolder(paramBitmap);
        ...
        j = ((Integer)ajjp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, j, ((RecentBaseData)localObject).a()).first).intValue();
        if (j == -2147483648) {
          break label438;
        }
