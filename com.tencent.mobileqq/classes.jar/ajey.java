  ...
  implements ajfe
{
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, ArrayList<azgo> paramArrayList, int paramInt4) {}
  ...
  public final void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    for (Object localObject = (Object[])paramObject;; localObject = null)
    {
      ...
      for (paramObject = (String)localObject[4];; paramObject = null)
      {
        ...
        for (paramInt = ((Integer)localObject[0]).intValue(); (paramBoolean) && (localObject != null) && (localObject.length >= 4); paramInt = 2131630729)
        {
