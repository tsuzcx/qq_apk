...
public class ajey
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localajfe = ajfh.a(paramQQAppInterface);
      } while (localajfe == null);
      ajez localajez = ajfh.a(paramQQAppInterface);
      if (localajez != null) {
        localajez.a(paramString, paramBoolean);
      }
      if (ajfh.a(paramQQAppInterface))
      {
        QLog.i("cmshow_scripted_SpriteCommFunc", 1, "showOrHideSprite double should hide");
        return;
      }
      paramQQAppInterface = localajfe.a();
    } while (paramQQAppInterface == null);
  ...
  {
    boolean bool1 = ajfh.b(paramQQAppInterface);
    boolean bool2 = ajfh.a(paramQQAppInterface);
    return (bool1) || (bool2);
  }
