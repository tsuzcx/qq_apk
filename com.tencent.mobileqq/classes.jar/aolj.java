...
public class aolj
  extends aolh
{
  public aolj(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            while (Arrays.equals(paramToServiceMsg.vecGuid, NetConnInfoCenter.GUID))
            {
              ...
              {
                if (QLog.isColorLevel()) {
                  QLog.d("FriendListHandler.BaseHandlerReceiver", 2, "handlerLoginDevList NetConnInfoCenter.GUID =" + PkgTools.toHexStr(NetConnInfoCenter.GUID) + "; info.guid = " + PkgTools.toHexStr(paramToServiceMsg.vecGuid));
                }
              }
        ...
        if ((paramSvcRspGetDevLoginInfo.vecHistoryLoginDevInfo != null) && (paramSvcRspGetDevLoginInfo.vecHistoryLoginDevInfo.size() > 0))
        {
          ...
          if (i < paramSvcRspGetDevLoginInfo.vecHistoryLoginDevInfo.size())
          {
            ...
            for (;;)
            {
              ...
              {
                if (QLog.isColorLevel()) {
                  QLog.d("FriendListHandler.BaseHandlerReceiver", 2, "handlerRecentLoginDevList NetConnInfoCenter.GUID =" + PkgTools.toHexStr(NetConnInfoCenter.GUID) + "; info.guid = " + PkgTools.toHexStr(paramToServiceMsg.vecGuid));
                }
              }
              catch (Exception paramFromServiceMsg)
              {
          ...
          if (i < paramSvcRspGetDevLoginInfo.vecAuthLoginDevInfo.size())
          {
            ...
            for (;;)
            {
              ...
              else if (NetConnInfoCenter.GUID == null)
              {
                ...
                {
                  if (QLog.isColorLevel()) {
                    QLog.d("FriendListHandler.BaseHandlerReceiver", 2, "handlerAuthLoginDevList NetConnInfoCenter.GUID =" + PkgTools.toHexStr(NetConnInfoCenter.GUID) + "; info.guid = " + PkgTools.toHexStr(paramToServiceMsg.vecGuid));
                  }
                }
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            while (Arrays.equals(paramToServiceMsg.vecGuid, NetConnInfoCenter.GUID))
            {
              ...
              {
                if (QLog.isColorLevel()) {
                  QLog.d("FriendListHandler.BaseHandlerReceiver", 2, "handlerMultiClientList NetConnInfoCenter.GUID =" + PkgTools.toHexStr(NetConnInfoCenter.GUID) + "; info.guid = " + PkgTools.toHexStr(paramToServiceMsg.vecGuid));
                }
              }
              catch (Exception paramFromServiceMsg)
              {
