  ...
  extends axuq
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((localObject1 == null) || (!((String)localObject1).equals("1"))) || (paramBundle.getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA))
    {
      ...
      j = localResources.getDimensionPixelSize(2131298790);
      m = actj.a(2.0F, localResources);
      if (i == 0) {
        break label1962;
      }
      k = actj.a(12.0F, localResources);
      j = k;
    }
    label794:
    label1181:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          ((LinearLayout)localObject1).setBackgroundResource(2130838131);
          n = actj.a(1.0F, localResources);
        ...
        if (((LinearLayout)localObject1).getChildCount() == this.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          if (n < i1)
          {
            paramView = (axup)this.jdField_a_of_type_JavaUtilArrayList.get(n);
        ...
        do
        {
          ...
          break label105;
          i2 = actj.a(10.0F, localResources);
          i3 = actj.a(5.0F, localResources);
          ...
          for (;;)
          {
            ...
            else
            {
              if ("summary".equals(str))
              {
                ...
                if (i != 0)
                {
                  localObject2 = ((axzj)paramView).f();
                  if ((localObject2 == null) || (!((String)localObject2).equals("1"))) {
                    break label639;
                  }
                  if (TextUtils.isEmpty(((axzj)paramView).c())) {
                    ((TextView)localView).setTextSize(12.0F);
                  }
                  if (TextUtils.isEmpty(((axzj)paramView).d())) {
              ...
              if ("hr".equals(str))
              {
                if (((axwu)paramView).a)
                {
                  ...
                  if ((i != 0) && (n != 0)) {
                    ((LinearLayout.LayoutParams)localObject2).topMargin += actj.a(6.0F, localResources);
                  }
              ...
              {
                ((LinearLayout.LayoutParams)localObject2).height = actj.a(4.0F, localResources);
          ...
          localObject2 = (axup)this.jdField_a_of_type_JavaUtilArrayList.get(n);
          ...
          localView = ((axup)localObject2).a(paramContext, null, paramBundle);
        } while (localView == null);
        label725:
        label997:
        int i2 = actj.a(10.0F, localResources);
        int i3 = actj.a(5.0F, localResources);
        paramView = new LinearLayout.LayoutParams(-1, -2);
        if (n > 0) {
          paramView.topMargin = i3;
        }
        String str = ((axup)localObject2).jdField_a_of_type_JavaLangString;
        if ("picture".equals(str))
        {
          localView.setId(-1);
          paramView.height = (BaseChatItemLayout.e - i2 - i2);
          paramView.topMargin = actj.a(9.5F, localResources);
          paramView.bottomMargin = actj.a(9.5F, localResources);
        }
        for (;;)
        {
          ...
          else if ("title".equals(str))
          {
            ...
            paramView.topMargin = actj.a(3.0F, localResources);
            paramView.bottomMargin = actj.a(3.0F, localResources);
            if ((a(1)) && (n == 0)) {
              paramView.topMargin += actj.a(14.0F, localResources);
            }
            localView.setId(-1);
          }
          else
          {
            if ("summary".equals(str))
            {
              if (i != 0)
              {
                str = ((axzj)localObject2).f();
                if ((str == null) || (!str.equals("1"))) {
                  break label1576;
                }
                if (TextUtils.isEmpty(((axzj)localObject2).c())) {
                  ((TextView)localView).setTextSize(12.0F);
                }
                if (TextUtils.isEmpty(((axzj)localObject2).d())) {
                  ((TextView)localView).setTextColor(Color.parseColor("#8e8e8e"));
                }
              }
              label1452:
              localObject2 = ((axzj)localObject2).f();
              if ((localObject2 != null) && (((String)localObject2).equals("1")))
              {
                paramView.topMargin = actj.a(3.0F, localResources);
                paramView.bottomMargin = actj.a(8.0F, localResources);
                label1501:
                if (this.k == 1)
                {
                  ((TextView)localView).setTextSize(12.0F);
              ...
              label1663:
              for (paramView.bottomMargin += actj.a(12.0F, localResources);; paramView.bottomMargin += actj.a(16.0F, localResources))
              {
                localView.setId(-1);
                break;
                if (TextUtils.isEmpty(((axzj)localObject2).c())) {
                ...
                ((TextView)localView).setLineSpacing(4.0F, 1.0F);
                break label1452;
                paramView.topMargin = actj.a(5.0F, localResources);
                paramView.bottomMargin = actj.a(5.0F, localResources);
                break label1501;
              }
            }
            if ("hr".equals(str))
            {
              ...
              {
                if ((i != 0) && (n != 0)) {
                  paramView.topMargin += actj.a(6.0F, localResources);
                }
                if (i == 0) {
                  break label1761;
                }
            ...
            {
              paramView.height = actj.a(4.0F, localResources);
              if ((i1 == 1) && (localView.getVisibility() == 8))
              {
                ((LinearLayout)localObject1).setPadding(0, 0, 0, 0);
                if (a(1)) {
            ...
            {
              paramView = new LinearLayout.LayoutParams(-1, actj.a(36.0F, localResources));
            }
          }
        }
      }
