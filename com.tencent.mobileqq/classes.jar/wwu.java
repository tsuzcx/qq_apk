  ...
  extends wwz
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "https://story.now.qq.com/mobile/transfer.html?src_type=app&version=1&fromId=17&videoOwnerUin=%s&videoId=%s&unionid=%s&ptype=%d&actionnamekey=1&storysharefrom=%s&sharefromtype=%d&one_page=0" + weg.a(2131699184);
  }
  
  public wwu(StoryVideoItem paramStoryVideoItem, String paramString, int paramInt)
  {
    Object localObject = ((yck)wjs.a(11)).a(paramString);
    if (localObject == null) {
      return;
    }
    ...
    this.jdField_d_of_type_JavaLangString = (((QQUserUIItem)localObject).nickName + anvx.a(2131703917) + vzh.jdField_a_of_type_JavaLangString);
    this.e = (((QQUserUIItem)localObject).nickName + anvx.a(2131703916) + vzh.jdField_a_of_type_JavaLangString);
    this.f = localwke.a(((QQUserUIItem)localObject).getUnionId(), false);
    int i;
    if (((QQUserUIItem)localObject).isMe())
    {
      ...
      this.i = (paramStoryVideoItem + " · " + this.jdField_d_of_type_Int + anvx.a(2131703919));
      this.j = ("#" + vzh.jdField_a_of_type_JavaLangString + "# " + this.jdField_c_of_type_JavaLangString + anvx.a(2131703918) + vzh.jdField_a_of_type_JavaLangString + "（" + this.i + "）");
  ...
  public String a(String paramString, long paramLong)
  {
    ...
    return paramString + anvx.a(2131703912) + str;
  }
}
