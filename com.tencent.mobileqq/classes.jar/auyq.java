...
public class auyq
  extends aofu
{
  public auyq(TroopRobotFragment paramTroopRobotFragment) {}
  ...
  protected void onGetAllRobots(boolean paramBoolean, int paramInt, long paramLong, bglq parambglq)
  {
    ...
    if ((str != null) && (str.equals(TroopRobotFragment.a(this.a))))
    {
      if ((paramBoolean) && (parambglq != null) && (this.a.getActivity() != null))
      {
        QLog.d("TroopRobotFragment", 2, "onGetAllRobots");
        this.a.getActivity().runOnUiThread(new TroopRobotFragment.1.1(this, parambglq));
        return;
      }
