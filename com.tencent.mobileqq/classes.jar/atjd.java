...
public class atjd
{
  ...
  {
    this.jdField_c_of_type_AndroidWidgetTextView.setText(atit.a(1000L * paramLong));
  }
  
  public void a(MedalInfo paramMedalInfo, int paramInt, Paint paramPaint, boolean paramBoolean)
  {
    paramInt = (int)(paramInt - (int)paramPaint.measureText(this.jdField_c_of_type_AndroidWidgetTextView.getText().toString()) - muf.a(this.jdField_c_of_type_AndroidWidgetTextView.getContext(), 30.0F));
