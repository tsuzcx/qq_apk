  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (int i = ((cmd0xac5.MasterState)((cmd0xac5.NearbyNowData)this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nearbyNowData.get()).master_state.get()).uint32_state.get();; i = 0)
    {
      ...
      {
        new axra(this.a.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app).a("dc00899").b("grp_lbs").c("face_score_vip").d("expert_change").a(new String[] { "", "" + (this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender + 1) }).a();
      ...
      if ((this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) && (bool1))
      {
        ...
        paramView.setPositiveButton(ajyc.a(2131707242), new atsn(this, paramView));
        paramView.setNegativeButton(ajyc.a(2131707371), new atso(this, paramView));
        paramView.show();
        return;
      }
      if ((bool1) && (bool2))
      {
        paramView = ajyc.a(2131707359);
        paramView = bbcv.a(this.a.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramView, 0, 0, null, null);
        paramView.setPositiveButton(ajyc.a(2131707308), new atsp(this, paramView));
        paramView.setNegativeButton(ajyc.a(2131707310), new atsq(this, paramView));
        paramView.show();
