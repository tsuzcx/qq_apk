...
public class askx
{
  private static askx a;
  
  public static askx a()
  {
    if (a == null) {}
    try
    {
  ...
  private MsgBackupUserData a(submsgtype0x11a.UserData paramUserData)
  {
    ...
    if (paramUserData.bytes_ip.has()) {
      localasmf.a(paramUserData.bytes_ip.get().toStringUtf8());
    }
    if (paramUserData.rpt_fixed32_port.has()) {
      localasmf.a(paramUserData.rpt_fixed32_port.get());
    }
    if (paramUserData.bytes_bssid.has()) {
      localasmf.c(paramUserData.bytes_bssid.get().toStringUtf8());
    }
    if (paramUserData.bytes_ssid.has()) {
      localasmf.b(paramUserData.bytes_ssid.get().toStringUtf8());
    }
    if (paramUserData.enum_platform.has()) {
      localasmf.a(paramUserData.enum_platform.get());
    }
    return localasmf.a();
  }
  ...
  public void a(String paramString)
  {
    ...
    localObject1 = new axax();
    localObject2 = ((SubMsgType0x7.MsgBody)localObject2).toByteArray();
    ((axax)localObject1).jdField_a_of_type_Int = 7;
    ((axax)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject2);
    long l1 = apug.b();
    long l2 = apug.a();
    localObject1 = axaq.a(paramString, 13, paramString.c(), (axax)localObject1, l2, axau.b(l1));
    ...
    if (paramMsgBody != null)
    {
      ...
      if (paramMsgBody.enum_result.has())
      {
        ...
        if (paramMsgBody.bytes_token.has()) {
          localaslr.a(paramMsgBody.bytes_token.get().toStringUtf8());
        }
        if (paramMsgBody.bytes_encrypt_key.has()) {
          localaslr.b(paramMsgBody.bytes_encrypt_key.get().toStringUtf8());
        }
        if (paramMsgBody.msg_user_data.has()) {
          localaslr.a(a((submsgtype0x11a.UserData)paramMsgBody.msg_user_data.get()));
        }
        if (paramMsgBody.enum_biz_type.has()) {
          localaslr.a(paramMsgBody.enum_biz_type.get());
        }
        paramMsgBody = localaslr.a();
        if (QLog.isColorLevel()) {
          QLog.d("MsgBackup.MsgBackupPushHandler", 2, "processOnLinePush receive processOnLinePush0x11a response = " + paramMsgBody);
        }
        aslg.a().a(paramMsgBody);
      }
    }
    label180:
    do
  ...
  public void a(submsgtype0x11b.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      aslz localaslz = new aslz();
      if (paramMsgBody.bytes_qr_sig.has()) {
        localaslz.a(paramMsgBody.bytes_qr_sig.get().toStringUtf8());
      }
      if (paramMsgBody.enum_biz_type.has()) {
        localaslz.a(paramMsgBody.enum_biz_type.get());
      }
      paramMsgBody = localaslz.a();
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (paramGenericSubCmd.length() == 1)
      {
        ...
        if ("exit".equals(paramGenericSubCmd.optString("cmd")))
        {
          ...
          if (TextUtils.equals(paramGenericSubCmd, askv.a().a())) {
            asnz.a().b(true);
          }
        }
      }
