...
public class acub
{
  private static acub jdField_a_of_type_Acub;
  ...
  private Map<Integer, acuc> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(int paramInt, boolean paramBoolean)
  {
    ...
    acuc localacuc = (acuc)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localacuc != null)
    {
      Object localObject = localacuc.jdField_a_of_type_JavaLangRefWeakReference;
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            if ((!((DoodleMsgLayout)localObject).b()) && (this.jdField_a_of_type_Long != localacuc.jdField_b_of_type_Long) && (((DoodleMsgLayout)localObject).a()))
            {
              if (paramBoolean)
              {
                a((DoodleMsgLayout)localObject, false);
                if (localacuc.jdField_b_of_type_Long == this.jdField_c_of_type_Long) {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: can not play:" + localacuc.jdField_a_of_type_Long + "uniID:" + localacuc.jdField_b_of_type_Long + " mPlayedID:" + this.jdField_a_of_type_Long);
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: invisible MsgID:" + localacuc.jdField_a_of_type_Long + "uniID:" + localacuc.jdField_b_of_type_Long);
          }
        }
      }
    }
  ...
  public static acub a()
  {
    try
    {
      if (jdField_a_of_type_Acub == null) {
        jdField_a_of_type_Acub = new acub();
      }
      return jdField_a_of_type_Acub;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        acuc localacuc = (acuc)((Map.Entry)localIterator.next()).getValue();
        if ((localacuc == null) || (localacuc.jdField_a_of_type_Int < paramInt1) || (localacuc.jdField_a_of_type_Int > paramInt2)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (acuc)localIterator.next();
        if ((localObject != null) && (((acuc)localObject).jdField_a_of_type_Int >= this.d) && (((acuc)localObject).jdField_a_of_type_Int <= this.e))
        {
          localObject = ((acuc)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          if (localObject != null)
          {
            localObject = (DoodleMsgLayout)((WeakReference)localObject).get();
            if (localObject != null) {
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      do
      {
        do
        {
          ...
          acuc localacuc = (acuc)((Iterator)localObject).next();
          if (localacuc.jdField_b_of_type_Long != this.jdField_c_of_type_Long) {
            break;
          }
          localObject = localacuc.jdField_a_of_type_JavaLangRefWeakReference;
    ...
    for (;;)
    {
      ...
      break;
      label135:
      localObject = (acuc)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(i));
      if ((localObject != null) && ((((acuc)localObject).jdField_a_of_type_Long > this.jdField_b_of_type_Long) || (((acuc)localObject).jdField_b_of_type_Long == this.jdField_c_of_type_Long)))
      {
        localObject = ((acuc)localObject).jdField_a_of_type_JavaLangRefWeakReference;
        if (localObject != null)
        {
  ...
  public static void b()
  {
    try
    {
      if (jdField_a_of_type_Acub != null)
      {
        jdField_a_of_type_Acub.a();
        jdField_a_of_type_Acub = null;
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, DoodleMsgLayout paramDoodleMsgLayout)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new acuc(this, paramLong1, paramLong2, paramInt, paramDoodleMsgLayout));
    boolean bool;
    if (this.jdField_a_of_type_Int != 0)
    {
      bool = true;
  ...
  public void a(DoodleMsgLayout paramDoodleMsgLayout, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          acuc localacuc = (acuc)((Iterator)localObject).next();
          if ((localacuc.jdField_a_of_type_JavaLangRefWeakReference != null) && (localacuc.jdField_a_of_type_JavaLangRefWeakReference.get() == paramDoodleMsgLayout))
          {
            this.jdField_a_of_type_Long = localacuc.jdField_b_of_type_Long;
            if (QLog.isColorLevel()) {
