...
public class awju
{
  ...
  public static QQCustomDialog a(int paramInt, String paramString)
  {
    ...
    {
      localQQCustomDialog = bhdj.a(localBaseActivity, 230, null, localBaseActivity.getString(2131718879), 2131690845, 2131691220, new awjz(), new awka(localBaseActivity, paramInt, paramString));
  ...
  static void a(Activity paramActivity, awlt paramawlt)
  {
    paramActivity = new LocationDialogUtil.4(paramActivity, paramawlt);
    ThreadManager.getUIHandlerV2().post(paramActivity);
  }
  ...
  {
    a(paramActivity, bhdj.a(paramActivity, 230, null, paramActivity.getResources().getString(2131693684), 2131690697, 2131694399, new awjv(paramActivity, paramString1, paramString2, paramString3, paramLatLng1, paramLatLng2), new awkd()));
  }
  ...
  public static void a(BaseActivity paramBaseActivity)
  {
    ...
    biwm.b();
    QQCustomDialog localQQCustomDialog = bhdj.a(paramBaseActivity, 230, null, "位置共享将收起为小窗进行展示，请开启QQ悬浮窗权限以正常使用功能。", paramBaseActivity.getString(2131690697), paramBaseActivity.getString(2131694399), new awkb(paramBaseActivity), null);
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt1, int paramInt2, String paramString)
  {
    ...
    awiz.a(paramBaseActivity.app).a(paramInt2, paramString, paramInt1, 2);
  }
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (paramInt2 == 1) {}
    for (String str = paramBaseActivity.getResources().getString(2131718877);; str = paramBaseActivity.getResources().getString(2131718876))
    {
  ...
  private static void b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      bdla.b(null, "CliOper", "", "", paramString, paramString, i, 0, "", "0", "0", "");
      return;
      if (paramInt != 2) {
        i = 0;
      }
