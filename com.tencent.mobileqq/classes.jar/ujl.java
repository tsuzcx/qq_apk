  ...
  implements uqz
{
  ...
  public ujl()
  {
    ...
    this.jdField_a_of_type_Ujm = new ujn(this);
    Object localObject1 = new ujo();
    ((ujo)localObject1).a(0);
    localObject1 = ((ujo)localObject1).a();
    Object localObject2 = new ujo();
    ((ujo)localObject2).a(1);
    localObject2 = ((ujo)localObject2).a();
    Object localObject3 = new ujo();
    ((ujo)localObject3).a(2);
    localObject3 = ((ujo)localObject3).a();
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(this.jdField_a_of_type_Ujm);
  ...
  public void a(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 24	ujl:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: iload_1
    ...
    //   41: invokestatic 89	wsv:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   44: aload_0
    //   45: monitorexit
    //   46: return
    //   47: aload_0
    //   48: getfield 29	ujl:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   51: invokevirtual 92	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	()I
    //   54: istore_2
    //   55: aload_0
    //   56: getfield 29	ujl:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   59: invokevirtual 95	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	()Luja;
    //   62: astore 4
    //   64: aload_3
    ...
    //   98: invokestatic 105	wsv:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   101: iload_2
    //   102: iload_1
    //   103: if_icmpne -59 -> 44
    //   106: aload_0
    //   107: getfield 29	ujl:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   110: aload 4
    //   112: invokevirtual 108	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	(Luja;)V
    //   115: goto -71 -> 44
    //   118: astore_3
    //   119: aload_0
    //   120: monitorexit
  ...
  public void a(List<uja> paramList, int paramInt, boolean paramBoolean)
  {
    if (paramList == null) {}
    ...
    for (;;)
    {
      ...
      try
      {
        wsv.d("Q.qqstory.download.preload.PreloadDownloaderManager", "setPreloadTaskList , id = %d , size = %d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(paramList.size()) });
        localPreloadQueue = (PreloadQueue)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        if (localPreloadQueue == null) {
          wsv.d("Q.qqstory.download.preload.PreloadDownloaderManager", "cannot find queue , id = " + paramInt);
        }
      }
      finally {}
    }
    uja localuja2 = this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a();
    if (paramList.size() == 0) {}
    for (uja localuja1 = null;; localuja1 = (uja)paramList.get(0))
    {
      localPreloadQueue.clearAllTask();
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        localPreloadQueue.addTask((uja)paramList.next(), false);
      }
    }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(localuja2);
      break;
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(paramuje);
  }
