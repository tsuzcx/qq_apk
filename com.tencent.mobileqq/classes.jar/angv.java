...
public class angv
{
  private WeakReference<anhg> jdField_a_of_type_JavaLangRefWeakReference;
  private final ConcurrentHashMap<String, anhb> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  angv(anhg paramanhg)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramanhg);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    if (!a())
    {
      paramanhg = (AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web");
      if (paramanhg != null)
      {
  ...
  public static void a(angv paramangv, AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    boolean bool2 = true;
    ...
    do
    {
      do
      {
        ...
        Object localObject = new File(angg.a());
        ...
        localObject = new bhyo("https://cmshow.gtimg.cn/qqshow/admindata/comdata/vipApollo_thunder_config/xydata.json", (File)localObject);
        ...
        ((bhyo)localObject).a(new angx(localSharedPreferences, paramInt, paramangv));
        paramangv = (bhyq)paramAppInterface.getManager(QQManagerFactory.DOWNLOADER_FACTORY);
        paramBoolean = bool2;
        if (paramangv != null)
        {
          paramangv = paramangv.a(3);
          paramBoolean = bool2;
          if (paramangv != null)
          {
            paramangv.a((bhyo)localObject, ((bhyo)localObject).a(), null);
            paramBoolean = false;
          }
        }
        if (paramBoolean) {
          ThreadManager.executeOnNetWorkThread(new ApolloSSOConfig.3((bhyo)localObject));
        }
  ...
  private boolean a()
  {
    ...
    Object localObject1 = new File(angg.a());
    Object localObject2;
    int i;
    Object localObject4;
    int i1;
    ...
    if (((File)localObject1).exists())
    {
      try
      {
        localObject2 = angg.a((File)localObject1);
        ...
        localObject2 = new anhb();
        ((anhb)localObject2).jdField_a_of_type_Int = n;
        ((anhb)localObject2).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ...
        if (k < i2)
        {
          ...
          localObject8 = new anha(null);
          ((anha)localObject8).jdField_a_of_type_JavaLangString = str1;
          ((anha)localObject8).jdField_a_of_type_Int = i3;
          ((anha)localObject8).b = str2;
      ...
      localObject7 = new angz();
      ((angz)localObject7).jdField_a_of_type_JavaLangString = ((String)localObject5);
      ((angz)localObject7).jdField_a_of_type_Int = n;
      ((angz)localObject7).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject6);
      ((anhb)localObject2).jdField_a_of_type_JavaUtilList.add(localObject7);
      break label1056;
      label544:
      ...
      localObject4 = new angy();
      ((angy)localObject4).jdField_a_of_type_JavaLangString = str1;
      ((angy)localObject4).b = str2;
    ...
    for (;;)
    {
      if (k < i1)
      {
        ...
        if (localObject8 != null)
        {
          ...
          if (!TextUtils.isEmpty(str1))
          {
            ...
            localObject8 = new anha(null);
            ((anha)localObject8).jdField_a_of_type_JavaLangString = str1;
            ((anha)localObject8).jdField_a_of_type_Int = i2;
            ((anha)localObject8).b = str2;
      ...
      {
        ((angy)localObject4).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject7);
        ...
        if (localObject5 != null)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((angy)localObject4).jdField_a_of_type_JavaUtilHashMap.put(localObject7, ((JSONObject)localObject5).optString((String)localObject7));
          }
        }
        ((anhb)localObject2).b.add(localObject4);
        break label1070;
        label936:
        if (QLog.isColorLevel())
        {
  ...
  public String a(String paramString)
  {
    ...
    {
      paramString = (anhb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (paramString != null) {
  ...
  public List<angy> a(String paramString)
  {
    paramString = (anhb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (paramString != null) {
  ...
  public Set<String> a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Object localObject = (anhb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (localObject != null)
      {
        paramString = new HashSet();
        localObject = ((anhb)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          angz localangz = (angz)((Iterator)localObject).next();
          if ((localangz != null) && (!TextUtils.isEmpty(localangz.jdField_a_of_type_JavaLangString))) {
            paramString.add(localangz.jdField_a_of_type_JavaLangString);
          }
        }
        return paramString;
      }
  ...
  public JSONObject a(String paramString1, String paramString2, String paramString3, AppInterface paramAppInterface)
  {
    ...
    paramString2 = (anhb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
    if (paramString2 != null)
    {
      paramString2 = paramString2.jdField_a_of_type_JavaUtilList.iterator();
      while (paramString2.hasNext())
      {
        angz localangz = (angz)paramString2.next();
        if ((localangz != null) && (paramString3.equals(localangz.jdField_a_of_type_JavaLangString))) {
          return localangz.a(paramString1, paramAppInterface);
        }
      }
    }
    return null;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = new NewIntent(paramAppInterface.getApp(), awcn.class);
    ...
    ((NewIntent)localObject1).setObserver(new angw(this, paramAppInterface));
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = (anhb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
      if (paramString1 != null)
      {
        paramString1 = paramString1.jdField_a_of_type_JavaUtilList.iterator();
        while (paramString1.hasNext())
        {
          angz localangz = (angz)paramString1.next();
          if ((localangz != null) && (paramString2.equals(localangz.jdField_a_of_type_JavaLangString))) {
            return true;
          }
        }
      }
