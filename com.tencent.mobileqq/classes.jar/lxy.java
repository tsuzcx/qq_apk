...
final class lxy
  implements lyf
{
  lxy(String paramString1, QQAppInterface paramQQAppInterface, String paramString2, int paramInt, long paramLong, WeakReference paramWeakReference) {}
  ...
  public String a()
  {
    return lxv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.b);
  }
  ...
  {
    if (paramInt3 == 2) {
      mqy.a(paramInt1, paramInt2, this.jdField_a_of_type_Int, this.b);
    }
    lxv.a(this.jdField_a_of_type_Long, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
  }
