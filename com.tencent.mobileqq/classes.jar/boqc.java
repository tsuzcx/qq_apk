  ...
  public static String a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      catch (IOException paramString1)
      {
        ...
        bpam.a("AEVoiceVideoMergeUtil", "Mixer Error 1 " + paramString1.toString(), paramString1);
        return null;
      ...
      {
        bpam.a("AEVoiceVideoMergeUtil", "Mixer Error 2 " + paramString1.toString(), paramString1);
        return null;
      }
      if (i != 0) {
        break label286;
