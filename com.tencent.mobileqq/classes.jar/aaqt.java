...
public class aaqt
{
  public static bevk a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean1, boolean paramBoolean2, aark paramaark)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    int i = atvo.a(atwl.a(paramItem.FileName));
    ...
    for (;;)
    {
      ...
      return a(paramQQAppInterface, paramaark, paramItem.toByteArray(), "OidbSvc.0x6d6_2", 1750, 2, (Bundle)localObject);
      bool = false;
      break;
      label250:
  ...
  public static bevk a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, aarm paramaarm)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    return a(paramQQAppInterface, paramaarm, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  
  public static bevk a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, aaro paramaaro)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    return a(paramQQAppInterface, paramLong, paramItem.FileName, paramItem.LocalFile, paramItem.ProgressTotal, paramItem.isFromAIO, paramItem.Md5, paramItem.Sha, paramItem.Sha3, paramItem.BusId, paramItem.mParentId, localBundle, paramaaro);
  }
  
  public static bevk a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, aare paramaare)
  {
    ...
    return a(paramQQAppInterface, paramaare, paramString.toByteArray(), "OidbSvc.0x6d8_4", 1752, 4, null);
  }
  
  public static bevk a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString3, int paramInt, String paramString4, Bundle paramBundle, aaro paramaaro)
  {
    ...
    for (paramInt = 5;; paramInt = 4)
    {
      ...
      return a(paramQQAppInterface, paramaaro, paramString1.toByteArray(), "OidbSvc.0x6d6_0", 1750, 0, paramBundle);
      localUploadFileReqBody.str_parent_folder_id.set(paramString4);
      break;
    }
  }
  
  public static bevk a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, String paramString3, Bundle paramBundle, aaro paramaaro)
  {
    if (paramLong1 == 0L) {
      return null;
    }
    return a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, true, paramArrayOfByte1, paramArrayOfByte2, null, paramInt, paramString3, paramBundle, paramaaro);
  }
  
  private static bevk a(QQAppInterface paramQQAppInterface, niv paramniv, byte[] paramArrayOfByte, String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    paramArrayOfByte.jdField_a_of_type_Niv = paramniv;
  ...
  private static String a(TroopFileTransferManager.Item paramItem)
  {
    try
    {
      ...
      Object localObject;
      if (zkr.c(paramItem.middleThumbnailFile)) {
      ...
      for (String str = "mid";; str = "larg")
      {
        ...
        return paramItem.strQRUrl;
        if (!zkr.c(paramItem.largeThumbnailFile)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString, int paramInt6, long paramLong2, int paramInt7, ByteStringMicro paramByteStringMicro, aard paramaard)
  {
    boolean bool;
    ...
    for (;;)
    {
      ...
      nir.b(paramQQAppInterface, paramaard, paramString.toByteArray(), "OidbSvc.0x6d8_1", 1752, 1, paramByteStringMicro);
      return;
      bool = false;
      break;
      label343:
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, aarl paramaarl)
  {
    a(paramQQAppInterface, paramLong, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, null, paramaarl);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, msg_ctrl.MsgCtrl paramMsgCtrl, aarl paramaarl)
  {
    ...
    for (;;)
    {
      ...
      nir.b(paramQQAppInterface, paramaarl, paramMsgCtrl.toByteArray(), "OidbSvc.0x6d9_4", 1753, 4, paramBundle);
      return;
      localFeedsInfo.uint32_feed_flag.set(3);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, Bundle paramBundle, aarj paramaarj)
  {
    ...
    nir.b(paramQQAppInterface, paramaarj, paramString.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, paramBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString, aarg paramaarg)
  {
    ...
    nir.b(paramQQAppInterface, paramaarg, paramString.toByteArray(), "OidbSvc.0x6d8_0", 1752, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, aara paramaara)
  {
    ...
    nir.b(paramQQAppInterface, paramaara, paramString2.toByteArray(), "OidbSvc.0x6d6_3", 1750, 3, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, aarh paramaarh)
  {
    ...
    nir.b(paramQQAppInterface, paramaarh, paramString1.toByteArray(), "OidbSvc.0x6d6_5", 1750, 5);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, aarc paramaarc)
  {
    if (QLog.isDevelopLevel()) {
    ...
    nir.b(paramQQAppInterface, paramaarc, localReqBody.toByteArray(), "OidbSvc.0x6d8_1", 1752, 2, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, aarf paramaarf)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d("TroopFileProtocol", 4, "getFileList" + paramLong);
    }
    ...
    nir.a(paramQQAppInterface, paramaarf, localReqBody.toByteArray(), "OidbSvc.0x6d8_3", 1752, 3, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, besl parambesl, aarn paramaarn)
  {
    if ((paramLong == 0L) || (parambesl == null)) {
      return;
    }
    ...
    localTransFileReqBody.uint32_bus_id.set(parambesl.a);
    localTransFileReqBody.str_file_id.set(parambesl.b);
    Bundle localBundle = new Bundle();
    localBundle.putLong("troopUin", paramLong);
    localBundle.putString("fileId", parambesl.b);
    parambesl = new oidb_0x6d9.ReqBody();
    parambesl.trans_file_req.set(localTransFileReqBody);
    nir.b(paramQQAppInterface, paramaarn, parambesl.toByteArray(), "OidbSvc.0x6d9_0", 1753, 0, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, aarl paramaarl)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return;
    }
    ...
    localObject = auxv.a(paramItem.LocalFile, paramItem.width, paramItem.height, (String)localObject);
    a(paramQQAppInterface, paramLong, paramItem.BusId, paramItem.FilePath, paramItem.RandomNum, paramItem.width, paramItem.height, paramItem.duration, true, localBundle, (msg_ctrl.MsgCtrl)localObject, paramaarl);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, aarb paramaarb)
  {
    ...
    nir.b(paramQQAppInterface, paramaarb, paramString.toByteArray(), "OidbSvc.0x6d7_1", 1751, 1);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, aaqz paramaaqz)
  {
    ...
    nir.b(paramQQAppInterface, paramaaqz, paramString1.toByteArray(), "OidbSvc.0x6d7_0", 1751, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, aari paramaari)
  {
    if ((paramLong == 0L) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return;
    }
    ...
    nir.b(paramQQAppInterface, paramaari, localReqBody.toByteArray(), "OidbSvc.0x6d7_2", 1751, 2, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, bevk parambevk)
  {
    if ((paramQQAppInterface == null) || (parambevk == null)) {
      return;
    }
    paramQQAppInterface.getTroopFileProtoReqMgr().b(parambevk);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, FileManagerEntity paramFileManagerEntity, aaqv paramaaqv)
  {
    paramString1 = new bfpp("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + bkgj.a(paramString4) + "&", "GET", new aaqu(new ArrayList(), paramString4, paramFileManagerEntity, paramQQAppInterface, paramInt, paramaaqv), 1000, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, long paramLong1, TroopFileTransferManager.Item paramItem, long paramLong2, long paramLong3, aarj paramaarj)
  {
    ...
    for (;;)
    {
      ...
      nir.b(paramQQAppInterface, paramaarj, localReqBody.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, (Bundle)localObject);
      return;
