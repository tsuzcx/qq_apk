...
{
  public ndj(QQAppInterface paramQQAppInterface)
  {
  ...
  private void l(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localncz = (ncz)this.app.getManager(QQManagerFactory.AV_GAME_MANAGER);
      if (i != 0) {
        break;
      }
      localncz.a().a(paramFromServiceMsg, k);
      return;
    }
    ...
    localncz.a().a(paramFromServiceMsg, k, str);
  }
  ...
  {
    long l = nqi.a(this.app.getCurrentUin());
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      localCmdRoomDestroyReq.uin.set(nqi.a((String)localObject));
      localCmdRoomDestroyReq.type.set(2);
      localCmdRoomDestroyReq.groupid.set(nqi.a(paramString));
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      ...
      localCmdRoomBatchForGroupReq.groupid.set(nqi.a(paramString));
      localCmdRoomBatchForGroupReq.uin.set(nqi.a((String)localObject));
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("AvGameRoomListHandler", 4, "getGameLobbyInfo uin: " + paramLong);
    }
  ...
  {
    long l2 = paramToServiceMsg.extraData.getLong("uin");
    boolean bool;
    Object localObject1;
    int i;
    int j;
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      bool = true;
      if (QLog.isColorLevel()) {
        QLog.d("AvGameRoomListHandler", 2, "handleGetGameLobbyInfo. isSuccess = " + bool + " " + l2);
      }
      if (bool)
      {
    ...
    else
    {
      for (;;)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramToServiceMsg)
        {
          ...
          Object localObject2 = (AvGameLobbyInfo.PlayerInfo)paramFromServiceMsg.player_list.get().get(j);
          ...
          localObject1 = ((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject1).pk_list.get();
          j = 0;
          if (j >= ((List)localObject1).size()) {
            continue;
          }
          localObject2 = new nek(4);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).pk_id.has()) {
            continue;
          }
          int k = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).pk_id.get();
          ((nek)localObject2).a(k);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).title_url.has()) {
            continue;
          }
          paramFromServiceMsg = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).title_url.get();
          ((nek)localObject2).a(paramFromServiceMsg);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).backgroud_url.has()) {
            continue;
          }
          paramFromServiceMsg = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).backgroud_url.get();
          ((nek)localObject2).b(paramFromServiceMsg);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).start_time.has()) {
            continue;
          }
          long l1 = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).start_time.get();
          ((nek)localObject2).a(l1);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).end_time.has()) {
            continue;
          }
          l1 = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).end_time.get();
          ((nek)localObject2).b(l1);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).is_reserve.has()) {
            continue;
          }
          bool = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).is_reserve.get();
          ((nek)localObject2).a(bool);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).reserve_user_num.has()) {
            continue;
          }
          k = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).reserve_user_num.get();
          ((nek)localObject2).b(k);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).play_user_num.has()) {
            continue;
          }
          k = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).play_user_num.get();
          ((nek)localObject2).c(k);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).wording.has()) {
            continue;
          }
          paramFromServiceMsg = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).wording.get();
          ((nek)localObject2).c(paramFromServiceMsg);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).color_start.has()) {
            continue;
          }
          k = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).color_start.get();
          ((nek)localObject2).d(k);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).color_end.has()) {
            continue;
          }
          k = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).color_end.get();
          ((nek)localObject2).e(k);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).time_wording.has()) {
            continue;
          }
          paramFromServiceMsg = ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).time_wording.get();
          ((nek)localObject2).f(paramFromServiceMsg);
          if (!((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).player_list.has()) {
            continue;
          }
          k = 0;
          if (k >= ((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).player_list.get().size()) {
            continue;
          }
          paramFromServiceMsg = (AvGameLobbyInfo.PlayerInfo)((AvGameLobbyInfo.PKCardInfo)((List)localObject1).get(j)).player_list.get().get(k);
          if ((!paramFromServiceMsg.has()) || (!((AvGameLobbyInfo.PlayerInfo)paramFromServiceMsg.get()).uid.has())) {
            continue;
          }
          ((nek)localObject2).a().add(Long.valueOf(((AvGameLobbyInfo.PlayerInfo)paramFromServiceMsg.get()).uid.get()));
          k += 1;
          continue;
          k = 0;
          continue;
          ...
          j += 1;
          continue;
          notifyUI(10, true, new Object[] { Long.valueOf(l2), localArrayList1, paramObject, localArrayList2, Integer.valueOf(i), paramToServiceMsg });
          return;
        }
        if (QLog.isColorLevel()) {
          QLog.i("AvGameRoomListHandler", 2, String.format("handleGetGameLobbyInfo() uin=%d errCode=%d errMsg=%s", new Object[] { Long.valueOf(l2), Integer.valueOf(i), paramToServiceMsg }));
        }
        if ((!bool) || (i != 0)) {
          break label1562;
        }
        ...
        localObject2 = ((AvGameLobbyInfo.CmdGetGameLobbyInfoRsp)localObject1).banner_list.get();
        j = 0;
        if (j >= ((List)localObject2).size()) {
          continue;
        }
        localnph = new nph();
        if (!((AvGameLobbyInfo.BannerInfo)((List)localObject2).get(j)).picture_url.has()) {
          continue;
        }
        paramFromServiceMsg = ((AvGameLobbyInfo.BannerInfo)((List)localObject2).get(j)).picture_url.get();
        localnph.a = paramFromServiceMsg;
        if (!((AvGameLobbyInfo.BannerInfo)((List)localObject2).get(j)).skip_url.has()) {
          continue;
        }
        paramFromServiceMsg = ((AvGameLobbyInfo.BannerInfo)((List)localObject2).get(j)).skip_url.get();
        localnph.b = paramFromServiceMsg;
        localArrayList1.add(localnph);
        j += 1;
        continue;
        bool = false;
        break;
      ...
      label1562:
      notifyUI(10, false, new Object[] { Long.valueOf(l2), null, null, null, Integer.valueOf(i), paramToServiceMsg });
      return;
    }
    notifyUI(10, false, new Object[] { Long.valueOf(l2), null, null, null, Integer.valueOf(-1), null });
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    } while (!"qqvgame.PKReserve-Reserve".equals(paramFromServiceMsg.getServiceCmd()));
