...
{
  public ampi(FavoriteSearchFragment paramFavoriteSearchFragment, ListView paramListView, FaceDecoder paramFaceDecoder)
  {
  ...
  {
    return new SearchResultView(paramViewGroup, 2130971536);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (getItemViewType(paramInt) == 1)
    {
      ...
      if (paramView == null)
      {
        ...
        ((TextView)localObject).setTextColor(paramViewGroup.getResources().getColor(2131494243));
      ...
      do
      {
        ...
        break;
        paramViewGroup.setText(2131431715);
  ...
  public void onClick(View paramView)
  {
    ...
    Animatable localAnimatable = (Animatable)BaseApplicationImpl.sApplication.getResources().getDrawable(2130838596);
