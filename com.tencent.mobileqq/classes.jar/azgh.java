...
public class azgh
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)awbi.a(-2043);
    ...
    if (paramTroopTipsEntity.highlightNum != 0) {
      azlf.a(localMessageForGrayTips, paramTroopTipsEntity.highlightItems);
    }
    if (paramTroopTipsEntity.optShowLatest == 1) {
      localMessageForGrayTips.shmsgseq = 0L;
    }
    if (!ajml.a(paramQQAppInterface, localMessageForGrayTips, false))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((azhx)paramQQAppInterface.getManager(132)).a(paramTroopTipsEntity.troopUin))
      {
        aylt localaylt = new aylt();
        Object localObject1 = new aylt();
        ((aylt)localObject1).r.a(localMessageForGrayTips.shmsgseq, localMessageForGrayTips.uniseq);
        localaylt.a((aylt)localObject1);
        localMessageForGrayTips.mMessageInfo = ((aylt)localObject1);
        ((arom)paramQQAppInterface.getManager(37)).a(paramTroopTipsEntity.troopUin, localaylt);
        Object localObject2 = new ajzz(paramQQAppInterface);
        localObject1 = ((ajzz)localObject2).jdField_a_of_type_Akeu;
        localObject2 = ((ajzz)localObject2).jdField_a_of_type_JavaUtilMap;
        localObject1 = ((akeu)localObject1).a(paramTroopTipsEntity.troopUin, 1);
        int i = localaylt.a(paramQQAppInterface, true, paramTroopTipsEntity.troopUin);
        if (i >= ((RecentUser)localObject1).msgType)
        {
          ((RecentUser)localObject1).msgType = i;
          ((RecentUser)localObject1).msg = aylt.a(paramQQAppInterface, paramTroopTipsEntity.troopUin, localaylt, ((RecentUser)localObject1).msg, localMessageForGrayTips, true);
          ((Map)localObject2).put(akbm.a(paramTroopTipsEntity.troopUin, 1), localObject1);
        }
        ((ajtg)paramQQAppInterface.a(20)).notifyUI(80, true, null);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((ajtg)paramQQAppInterface.a(20)).notifyUI(61, true, new Object[] { paramString, str, Boolean.valueOf(false) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong)
  {
    ...
    String str = ((Resources)localObject).getString(2131632032);
    localObject = ((Resources)localObject).getString(2131632028);
    ...
    for (String str = "";; str = paramString1)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString1)) {
          azkm.a(paramQQAppInterface, paramString1, i);
        }
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, azgj paramazgj, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      if (QLog.isColorLevel())
      {
        paramazgj = new StringBuilder().append("checkIdentity error. app null: ");
      ...
      {
        paramazgj = paramazgj.append(String.valueOf(paramBoolean)).append(", troopUin: ");
        paramQQAppInterface = paramString1;
        if (TextUtils.isEmpty(paramString1)) {
          paramQQAppInterface = "";
        }
        paramString1 = paramazgj.append(paramQQAppInterface).append(", memberUin: ");
    ...
    ((TroopManager)paramQQAppInterface.getManager(52)).a(paramString1, paramString2, new azgi(paramString1, paramString2, paramBoolean, paramQQAppInterface, paramazgj));
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      Object localObject2 = apck.a(localFileInfo);
  ...
  private static void b(azgj paramazgj, int paramInt)
  {
    if (paramazgj == null) {
      return;
    }
    ...
    {
      paramazgj.a(paramInt);
      return;
    }
    ThreadManager.getUIHandler().post(new HWTroopUtils.2(paramazgj, paramInt));
  }
