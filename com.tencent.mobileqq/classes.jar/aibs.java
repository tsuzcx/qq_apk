  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.share.ForwardSdkShareProcessor", 2, "RichStep|run|retry=" + aibr.a(this.a));
    }
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          if (!aibr.a(this.a).get()) {
            continue;
          }
          if ((k != -1) || (aibr.a(this.a).getAndIncrement() >= 2)) {
            continue;
          }
