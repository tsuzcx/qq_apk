...
public class anfq
{
  ...
  private void a(ApolloActionData paramApolloActionData)
  {
    ...
    ((angf)this.a.a().getManager(249)).a().a(localSpriteTaskParam);
  }
  ...
  public void a(int paramInt)
  {
    ...
    ApolloActionData localApolloActionData = ((annx)localQQAppInterface.getManager(155)).a(paramInt);
    String str = anzj.a(2131713122);
    ...
    {
      ((amsx)localQQAppInterface.getManager(153)).a(localApolloActionData, 4);
      a(str);
      return;
    }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (localJSONArray.length() > 0)
          {
            ...
            {
              paramMessageForApollo = (ApolloSlaveInfo)bhhq.a(localJSONArray.getJSONObject(i), ApolloSlaveInfo.class);
