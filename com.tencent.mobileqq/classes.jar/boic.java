...
public class boic
  extends bohr
{
  public boic(Object paramObject)
  {
    super(paramObject);
  }
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    {
      bohe localbohe = (bohe)((Iterator)localObject).next();
      if ((localbohe instanceof bohg)) {
        localArrayList.add(((bohg)localbohe).a);
      }
    }
    ((bohj)bogd.a(5)).a[paramInt].a(this);
    localObject = (QIMFilterCategoryItem)this.a;
    bpjt.a().a((QIMFilterCategoryItem)localObject, paramInt);
    if ((QLog.isColorLevel()) && (localObject != null)) {
      QLog.i("QCombo", 2, "setApplyedFilterGroup" + ((QIMFilterCategoryItem)localObject).b);
    }
    bohg.a(paramActivity, localArrayList, this, paramInt);
    return 0;
  }
  ...
  public boolean a()
  {
    ...
    {
      Object localObject = (bohe)localIterator.next();
      if ((localObject instanceof bohg))
      {
        localObject = ((bohg)localObject).a;
  ...
  public void b(Activity paramActivity, int paramInt)
  {
    ...
    bpjt.a().b(localQIMFilterCategoryItem, paramActivity, paramInt);
  }
