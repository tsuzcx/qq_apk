...
{
  anpr(anpq paramanpq, Activity paramActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Anpq.a(String.format((String)localObject1, new Object[] { paramBundle }));
      anpq.a(this.jdField_a_of_type_Anpq).show();
      return;
      localObject2 = str;
