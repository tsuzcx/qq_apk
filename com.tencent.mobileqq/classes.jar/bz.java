  ...
  extends AsyncTask<Integer, Integer, String>
{
  ...
  DataLineMsgRecord a(ajuo paramajuo, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      localDataLineMsgRecord.sessionid = paramajuo.a(0, this.jdField_a_of_type_ComDatalineActivitiesLiteActivity.a).longValue();
  ...
  void a(List<String> paramList, int paramInt)
  {
    ...
    {
      return;
      localajuo = (ajuo)this.jdField_a_of_type_ComDatalineActivitiesLiteActivity.app.a(8);
      j = paramList.size();
      if (j > 3) {
        break;
      }
