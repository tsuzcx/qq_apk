...
public class msl
{
  ...
  private static msl jdField_a_of_type_Msl;
  private Context jdField_a_of_type_AndroidContentContext;
  Handler jdField_a_of_type_AndroidOsHandler = new msm(this, Looper.getMainLooper());
  ...
  public static msl a()
  {
    if (jdField_a_of_type_Msl == null) {}
    try
    {
      if (jdField_a_of_type_Msl == null) {
        jdField_a_of_type_Msl = new msl();
      }
      return jdField_a_of_type_Msl;
    }
    finally {}
  }
  ...
  private void e()
  {
    ...
    if (i <= m)
    {
      ...
      if (localObject != null)
      {
        localObject = ((View)localObject).findViewById(2131310784);
