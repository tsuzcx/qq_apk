  ...
  implements bfpc
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.i(aget.jdField_a_of_type_JavaLangString, 2, "onItemClick, position = " + paramInt);
    }
    ...
    {
      paramAdapterView = (ager)this.a.jdField_a_of_type_Ages.getItem(paramInt);
      ...
      if (QLog.isColorLevel()) {
        QLog.i(aget.jdField_a_of_type_JavaLangString, 2, "onItemClick, mRecordCount = " + this.a.jdField_a_of_type_Int);
      }
      this.a.a(true);
      this.a.dismiss();
    }
    ...
    {
      return;
      if (paramAdapterView == this.a.jdField_a_of_type_Agfd)
      {
        paramAdapterView = (ageh)this.a.jdField_a_of_type_Agfd.getItem(paramInt);
        this.a.b = false;
    ...
    QLog.i(aget.jdField_a_of_type_JavaLangString, 2, "onItemClick, unknown data type");
  }
}
