...
{
  public int a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new auvi(this);
  ...
  private void a(int paramInt)
  {
    ...
    case 0: 
      d();
      c();
      axqy.b(null, "CliOper", "", "", "card_mall", "0X80066CA", 0, 0, "1", "", "", "");
      return;
    case 1: 
      e();
      c();
      axqy.b(null, "CliOper", "", "", "card_mall", "0X80066CA", 0, 0, "2", "", "", "");
      return;
    }
    c();
    axqy.b(null, "CliOper", "", "", "card_mall", "0X80066CA", 0, 0, "3", "", "", "");
  }
  
  private void b()
  {
    c();
    this.jdField_a_of_type_Bfpc = bfpc.c(this.mRuntime.a());
    this.jdField_a_of_type_Bfpc.c(this.mRuntime.a().getResources().getString(2131719267));
    this.jdField_a_of_type_Bfpc.c(this.mRuntime.a().getResources().getString(2131719278));
    this.jdField_a_of_type_Bfpc.c(this.mRuntime.a().getResources().getString(2131690596));
    this.jdField_a_of_type_Bfpc.a(new auvj(this));
    this.jdField_a_of_type_Bfpc.setCanceledOnTouchOutside(true);
    try
    {
      this.jdField_a_of_type_Bfpc.show();
      axqy.b(null, "CliOper", "", "", "card_mall", "0X80066C9", 0, 0, "", "", "", "");
      return;
    }
  ...
  private void c()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 51	auvh:jdField_a_of_type_Bfpc	Lbfpc;
    //   4: ifnull +25 -> 29
    //   7: aload_0
    //   8: getfield 51	auvh:jdField_a_of_type_Bfpc	Lbfpc;
    //   11: invokevirtual 163	bfpc:isShowing	()Z
    //   14: ifeq +15 -> 29
    //   17: aload_0
    //   18: getfield 51	auvh:jdField_a_of_type_Bfpc	Lbfpc;
    //   21: invokevirtual 166	bfpc:dismiss	()V
    //   24: aload_0
    //   25: aconst_null
    //   26: putfield 51	auvh:jdField_a_of_type_Bfpc	Lbfpc;
    //   29: return
    //   30: astore_1
    //   31: aload_0
    //   32: aconst_null
    //   33: putfield 51	auvh:jdField_a_of_type_Bfpc	Lbfpc;
    //   36: return
    //   37: astore_1
    //   38: aload_0
    //   39: aconst_null
    //   40: putfield 51	auvh:jdField_a_of_type_Bfpc	Lbfpc;
    //   43: aload_1
    //   44: athrow
  ...
  private void d()
  {
    sendRemoteReq(anqu.a("selectPhoto", "", this.mOnRemoteResp.key, new Bundle()), false, false);
  }
  
  private void e()
  {
    sendRemoteReq(anqu.a("takePhoto", "", this.mOnRemoteResp.key, new Bundle()), false, false);
  }
  ...
  public int a()
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      if (((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).g == auwf.jdField_a_of_type_JavaLangInteger) {
        return 0;
      }
      i += 1;
    }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (a() == 0)
        {
          localObject = (auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
          str = ((auwf)localObject).jdField_d_of_type_JavaLangString;
          Long localLong = ((auwf)localObject).jdField_a_of_type_JavaLangLong;
          if (((auwf)localObject).jdField_b_of_type_Boolean)
          {
            ((auwf)localObject).jdField_b_of_type_Boolean = false;
            this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(1);
            localObject = anqu.a("card_download_wzry_template", str, this.mOnRemoteResp.key, new Bundle());
    ...
    this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(1);
    Object localObject = anqu.a("card_download", str, this.mOnRemoteResp.key, new Bundle());
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    catch (JSONException paramJsBridgeListener)
    {
      ...
      try
      {
        ...
        {
          paramJsBridgeListener = paramString2;
          sendRemoteReq(anqu.a("card_getinfo", paramString2, this.mOnRemoteResp.key, new Bundle()), false, false);
        }
        else
        {
          paramJsBridgeListener = paramString2;
          if (paramString3.equals("setSummaryCard"))
          {
            ...
            paramJsBridgeListener = paramString2;
            paramString3 = anqu.a("card_setSummaryCard", paramString2, this.mOnRemoteResp.key, new Bundle());
            paramJsBridgeListener = paramString2;
      ...
      catch (Exception paramString1)
      {
        ...
        if (paramString3.equals("download"))
        {
          ...
          paramJsBridgeListener = paramString2;
          if (auuz.a((Context)localObject1, i, "cardPreview.jpg"))
          {
            paramJsBridgeListener = paramString2;
            if (QLog.isColorLevel())
            {
            ...
            paramJsBridgeListener = paramString2;
            if (auuz.a((Context)localObject1, i, ".dynamic"))
            {
              paramJsBridgeListener = paramString2;
              paramVarArgs.put("result", 0);
              paramJsBridgeListener = paramString2;
          ...
          paramJsBridgeListener = paramString2;
          if (!bbfj.d(this.mRuntime.a().getApplicationContext()))
          {
            paramJsBridgeListener = paramString2;
          ...
          {
            paramJsBridgeListener = paramString2;
            if (((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).g == auwf.jdField_d_of_type_JavaLangInteger)
            {
              paramJsBridgeListener = paramString2;
              if (((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).jdField_a_of_type_JavaLangString.equalsIgnoreCase(paramString3))
              {
                paramJsBridgeListener = paramString2;
                if (paramString1.getLong("id") == ((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).jdField_a_of_type_JavaLangLong.longValue())
                {
                  paramJsBridgeListener = paramString2;
                  ((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).g = auwf.jdField_b_of_type_JavaLangInteger;
                  paramJsBridgeListener = paramString2;
                  ((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).jdField_d_of_type_JavaLangString = paramString2;
                  return true;
                }
              }
            }
          ...
          paramJsBridgeListener = paramString2;
          paramString1.g = auwf.jdField_a_of_type_JavaLangInteger;
          paramJsBridgeListener = paramString2;
      ...
      paramJsBridgeListener = paramString2;
      if (!auuz.a((Context)localObject1, j, "cardPreview.jpg")) {
        break label1216;
      }
    }
    paramJsBridgeListener = paramString2;
    ...
    {
      paramJsBridgeListener = paramString2;
      if (!auuz.a((Context)localObject1, j, ".dynamic")) {}
    }
    else
    {
      paramJsBridgeListener = paramString2;
    ...
    {
      paramJsBridgeListener = paramString2;
      if (!((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangString.equalsIgnoreCase(paramString3)) {
        break label3636;
      }
      paramJsBridgeListener = paramString2;
      if (j != ((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangLong.longValue()) {
        break label3636;
      }
      paramJsBridgeListener = paramString2;
      if (((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).g == auwf.jdField_d_of_type_JavaLangInteger) {
        break label3636;
      }
      paramJsBridgeListener = paramString2;
      if (QLog.isColorLevel())
      {
        paramJsBridgeListener = paramString2;
        QLog.i("ProfileCardWebviewPlugin", 2, "mIndex:" + this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() + ",id:" + ((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangLong + "status:" + ((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).g);
      }
      paramJsBridgeListener = paramString2;
      if (((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).g != auwf.jdField_a_of_type_JavaLangInteger)
      {
        paramJsBridgeListener = paramString2;
        if (((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).g != auwf.jdField_b_of_type_JavaLangInteger) {}
      }
      else
      {
        paramJsBridgeListener = paramString2;
        paramString1 = anqu.a("card_query_download", paramString2, this.mOnRemoteResp.key, new Bundle());
        paramJsBridgeListener = paramString2;
      ...
      paramJsBridgeListener = paramString2;
      if (((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).g != auwf.jdField_c_of_type_JavaLangInteger) {
        break label1712;
      }
      paramJsBridgeListener = paramString2;
      ((JSONObject)localObject2).put("status", 1);
      paramJsBridgeListener = paramString2;
      ((JSONObject)localObject2).put("progress", ((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).e);
    }
    for (;;)
    {
      paramJsBridgeListener = paramString2;
      paramVarArgs.put("result", ((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).f);
      paramJsBridgeListener = paramString2;
      if (i < this.jdField_a_of_type_JavaUtilList.size()) {
        break;
      }
    ...
    else
    {
      ...
      else
      {
        ...
        if (paramString3.equals("cancelDownload"))
        {
          ...
          {
            paramJsBridgeListener = paramString2;
            if (((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangLong.longValue() != l1) {
              break label3645;
            }
            paramJsBridgeListener = paramString2;
            if (!((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangString.equalsIgnoreCase(paramString3)) {
            ...
            paramJsBridgeListener = paramString2;
            paramString1 = anqu.a("card_cancel_download", paramString2, this.mOnRemoteResp.key, new Bundle());
            paramJsBridgeListener = paramString2;
            ...
            paramJsBridgeListener = paramString2;
            ((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).g = auwf.jdField_d_of_type_JavaLangInteger;
            paramJsBridgeListener = paramString2;
            paramVarArgs.put("result", 0);
            paramJsBridgeListener = paramString2;
            paramVarArgs.put("message", "ok");
          ...
          try
          {
            ...
            paramJsBridgeListener = paramString2;
            paramString1.put("message", "cancel download bgUrl:" + ((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangString);
            paramJsBridgeListener = paramString2;
            a(((auwf)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_d_of_type_JavaLangString, paramString1.toString());
          }
        ...
        else
        {
          ...
          {
            paramJsBridgeListener = paramString2;
            paramString3 = anqu.a("card_getVipInfo", paramString2, this.mOnRemoteResp.key, new Bundle());
            paramJsBridgeListener = paramString2;
          ...
          else
          {
            ...
            if (paramString3.equals("openView"))
            {
              ...
              if (paramString3 != null)
              {
                ...
                paramJsBridgeListener = paramString2;
                ((Intent)localObject1).putExtra("url", bbqd.a(paramString3, "card", paramString1));
                paramJsBridgeListener = paramString2;
            ...
            else
            {
              ...
              if (paramString3.equals("clickPhotoWall"))
              {
                ...
                {
                  paramJsBridgeListener = paramString2;
                  if ((paramString1 instanceof bcij))
                  {
                    paramJsBridgeListener = paramString2;
                    paramString1 = ((bcij)paramString1).b();
                    paramJsBridgeListener = paramString2;
                ...
                for (this.jdField_a_of_type_Int = bfnx.a(bfnx.a(paramString1), "entryId", 2);; this.jdField_a_of_type_Int = 2)
                {
                  paramJsBridgeListener = paramString2;
                  ...
                  paramJsBridgeListener = paramString2;
                  bgyp.a(this.mRuntime.a(), paramString3, null, paramString1, getRequestCode((byte)2));
                  break;
                  paramJsBridgeListener = paramString2;
                }
              }
              ...
              else
              {
                ...
                {
                  paramJsBridgeListener = paramString2;
                  paramString3 = anqu.a("card_set_custom_honor", paramString2, this.mOnRemoteResp.key, new Bundle());
                  paramJsBridgeListener = paramString2;
                ...
                else
                {
                  ...
                  if (paramString3.equals("downloadWzResource"))
                  {
                    ...
                    paramJsBridgeListener = paramString2;
                    if (!auwp.a(paramString1.optInt("styleId"))) {
                      break label3654;
                    }
                    paramJsBridgeListener = paramString2;
                    if (!auwp.a((Context)localObject1, "cardWZ.zip")) {
                      break label3654;
                    }
                    i = 1;
                    label2971:
                    ...
                    paramJsBridgeListener = paramString2;
                    if (!auuz.a((Context)localObject1, l1, "wzJoinImage.png")) {
                      break label3660;
                    }
                    j = 1;
                    label2999:
                    ...
                    paramJsBridgeListener = paramString2;
                    if (!auuz.a((Context)localObject1, l1, "wzMainImage.png")) {
                      break label3666;
                    }
                    k = 1;
                    label3027:
                    if ((i != 0) && (j != 0))
                    {
                      ...
                      {
                        paramJsBridgeListener = paramString2;
                        bool = auuz.a((Context)localObject1, l1, "wzMainImage.png");
                      }
                      if (bool)
                      {
                        paramJsBridgeListener = paramString2;
                    ...
                    if (!this.jdField_a_of_type_JavaUtilList.isEmpty())
                    {
                      ...
                      if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() >= 0)
                      {
                        ...
                        {
                          paramJsBridgeListener = paramString2;
                          paramString1 = (auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
                          paramJsBridgeListener = paramString2;
                          if (this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 1)
                          {
                            paramJsBridgeListener = paramString2;
                            if (paramString1.g.equals(auwf.jdField_d_of_type_JavaLangInteger))
                            {
                              paramJsBridgeListener = paramString2;
                              if (paramString1.jdField_a_of_type_JavaLangString.equalsIgnoreCase((String)localObject2))
                              {
                                ...
                                {
                                  paramJsBridgeListener = paramString2;
                                  paramString1.g = auwf.jdField_b_of_type_JavaLangInteger;
                                  paramJsBridgeListener = paramString2;
                                  paramString1.jdField_d_of_type_JavaLangString = paramString2;
                                  return true;
                                }
                    ...
                    paramJsBridgeListener = paramString2;
                    localObject1 = new auwf();
                    paramJsBridgeListener = paramString2;
                    ((auwf)localObject1).jdField_a_of_type_JavaLangLong = Long.valueOf(l1);
                    paramJsBridgeListener = paramString2;
                    ((auwf)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject2);
                    paramJsBridgeListener = paramString2;
                    ((auwf)localObject1).jdField_d_of_type_JavaLangString = paramString2;
                    if (k == 0) {
                      break label3672;
                    }
                    paramString1 = null;
                    label3472:
                    paramJsBridgeListener = paramString2;
                    ((auwf)localObject1).jdField_c_of_type_JavaLangString = paramString1;
                    if (i != 0) {
                      break label3678;
                    }
                  }
    ...
    {
      paramJsBridgeListener = paramString2;
      ((auwf)localObject1).jdField_b_of_type_Boolean = bool;
      paramJsBridgeListener = paramString2;
      ((auwf)localObject1).jdField_a_of_type_Boolean = true;
      paramJsBridgeListener = paramString2;
      ((auwf)localObject1).e = Integer.valueOf(0);
      paramJsBridgeListener = paramString2;
      ((auwf)localObject1).g = auwf.jdField_a_of_type_JavaLangInteger;
      paramJsBridgeListener = paramString2;
      ...
      if (this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 0)
      {
        ...
        if (paramString3.equals("setSwitchOfKingGlory"))
        {
          ...
          paramJsBridgeListener = paramString2;
          sendRemoteReq(anqu.a("ipc_plateofking_switch", paramString2, this.mOnRemoteResp.key, paramString1), false, false);
        }
        else
        {
          return false;
  ...
  {
    super.onCreate();
    this.jdField_a_of_type_Bbww = new bbww(this.mRuntime.a());
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ("card_getinfo".equals(str2))
          {
            ...
            i = 0;
            if ((l2 == auvf.e) || (l2 == auvf.a) || (l2 == auvf.g)) {
              break label806;
            }
        ...
        {
          axqy.b(null, "P_CliOper", "Vip_SummaryCard", "", paramBundle.getString("op_name"), paramBundle.getString("op_name"), 0, 0, paramBundle.getString("ext1"), paramBundle.getString("ext2"), paramBundle.getString("ext3"), localBundle.getString("vip_info"));
        ...
        if ("card_download_wzry_template".equals(str2))
        {
          ...
          localObject1 = anqu.a("card_download", str1, this.mOnRemoteResp.key, new Bundle());
        ...
        if ("card_download".equals(str2))
        {
          ...
          if (((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).g != auwf.jdField_d_of_type_JavaLangInteger) {
            ((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).g = auwf.jdField_c_of_type_JavaLangInteger;
          }
          ((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).e = Integer.valueOf(100);
          a(str1, ((JSONObject)localObject1).toString());
          this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
          a();
          return;
        ...
        if (((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).g != auwf.jdField_c_of_type_JavaLangInteger) {
          ((auwf)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())).e = Integer.valueOf(i);
        }
        ((JSONObject)localObject1).put("data", localObject2);
        a(str1, ((JSONObject)localObject1).toString());
        return;
