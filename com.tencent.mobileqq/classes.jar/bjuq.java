  ...
  implements Handler.Callback
{
  ...
  private bjur jdField_a_of_type_Bjur;
  ...
  public bjuq(Context paramContext, Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
    ...
    label301:
    for (this.d = (ScreenUtil.SCREEN_WIDTH - paramContext.getResources().getDimensionPixelSize(2131298434));; this.d = ScreenUtil.SCREEN_WIDTH)
    {
      int i = paramInt2;
      if (paramInt2 <= 0) {
      ...
      this.c = this.f;
      this.jdField_a_of_type_Bjur = new bjur(this);
      return;
    }
  }
  ...
  private void e()
  {
    this.jdField_a_of_type_Bjur.jdField_a_of_type_Int = (this.g - this.e);
    this.jdField_a_of_type_Bjur.jdField_b_of_type_Int = (-(this.g - this.f - this.e));
    this.jdField_a_of_type_Bjur.c = 12000;
    this.jdField_a_of_type_Bjur.d = 3;
  }
  
  private void f()
  {
    this.jdField_a_of_type_Bjur.jdField_a_of_type_Int = this.f;
    this.jdField_a_of_type_Bjur.jdField_b_of_type_Int = (this.g - this.f - this.e);
    this.jdField_a_of_type_Bjur.c = 12000;
    this.jdField_a_of_type_Bjur.d = 2;
  }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bjur.jdField_a_of_type_Int = this.c;
      this.jdField_a_of_type_Bjur.c = (this.jdField_a_of_type_AndroidWidgetScroller.getDuration() - this.jdField_a_of_type_AndroidWidgetScroller.timePassed());
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      this.jdField_a_of_type_AndroidWidgetScroller.startScroll(0, this.jdField_a_of_type_Bjur.jdField_a_of_type_Int, 0, this.jdField_a_of_type_Bjur.jdField_b_of_type_Int, this.jdField_a_of_type_Bjur.c);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(this.jdField_a_of_type_Bjur.d);
