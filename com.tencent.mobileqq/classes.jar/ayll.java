...
public class ayll
{
  ...
  public static String a(long paramLong)
  {
    ...
    if (l2 < 600000L) {
      return anvx.a(2131706694);
    }
    if (l2 < 3600000L) {
      return l2 / 60L / 1000L + 1L + anvx.a(2131706687);
    }
    if ((l2 < 21600000L) && (k == i)) {
      return l2 / 60L / 60L / 1000L + anvx.a(2131706681);
    }
    if ((l2 < 86400000L) && (k == i))
    {
    ...
    {
      localSimpleDateFormat.applyPattern("HH:mm");
      return anvx.a(2131706692) + localSimpleDateFormat.format(localCalendar.getTime());
    }
    if (m == j)
    {
