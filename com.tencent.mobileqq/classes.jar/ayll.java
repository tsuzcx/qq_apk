...
{
  public ayll(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(Activity paramActivity, String paramString, QQAppInterface paramQQAppInterface, PersonalityLabel paramPersonalityLabel, aymg paramaymg)
  {
    byte[] arrayOfByte = PersonalityLabel.convertToBytes(paramPersonalityLabel);
    paramActivity.runOnUiThread(new PersonalityLabelHandler.1(paramString, paramQQAppInterface, paramaymg, arrayOfByte));
    paramActivity = (amsw)paramQQAppInterface.getManager(51);
  ...
  {
    aezm localaezm = (aezm)this.mApp.getManager(282);
    Object localObject = localaezm.a(paramString2, 0, 3);
    if (localObject != null) {
        ...
        do
        {
          for (;;)
          {
            ...
            else
            {
              ...
              paramFromServiceMsg = localamsw.a(paramObject);
            ...
            try
            {
              ...
              for (paramToServiceMsg = ((PersonalityLabelPhoto)paramToServiceMsg.personalityLabelPhotos.get(0)).get128SizeUrl() + aykk.d;; paramToServiceMsg = "")
              {
