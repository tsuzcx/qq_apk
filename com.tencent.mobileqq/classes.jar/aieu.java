...
public class aieu
  extends aliy
  implements View.OnClickListener, bjts, bjtu, AbsListView.OnScrollListener
{
  ...
  private amsu jdField_a_of_type_Amsu = new aiev(this);
  ...
  public aieu(Context paramContext, QQAppInterface paramQQAppInterface, SwipListView paramSwipListView, View paramView)
  {
  ...
  private bjty a(Context paramContext)
  {
    ...
    return new aiew(this, 1, 1, new int[] { i, j }, -1, paramContext, arrayOfInt1, arrayOfInt2);
  }
  ...
  private void a(aiex paramaiex, SysSuspiciousMsg paramSysSuspiciousMsg)
  {
    if (paramSysSuspiciousMsg == null)
    {
      paramaiex.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      paramaiex.b.setVisibility(8);
      paramaiex.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      paramaiex.d.setVisibility(8);
      paramaiex.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      return;
    }
    paramaiex.jdField_a_of_type_ComTencentMobileqqDataSysSuspiciousMsg = paramSysSuspiciousMsg;
    paramaiex.jdField_a_of_type_JavaLangString = (paramSysSuspiciousMsg.uin + "");
    paramaiex.g.setOnClickListener(this);
    paramaiex.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(a(paramaiex.jdField_c_of_type_Int, paramaiex.jdField_a_of_type_JavaLangString));
    paramaiex.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    TextView localTextView = paramaiex.jdField_a_of_type_AndroidWidgetTextView;
    String str;
    if (paramSysSuspiciousMsg.nick == null)
    {
      str = "";
      localTextView.setText(str);
      b(paramaiex, paramSysSuspiciousMsg);
    ...
    for (;;)
    {
      paramaiex.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramaiex.jdField_a_of_type_AndroidWidgetButton.setText(amtj.a(2131706625));
      paramaiex.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      paramaiex.jdField_a_of_type_AndroidWidgetButton.setTag(paramaiex);
      return;
      str = paramSysSuspiciousMsg.nick;
      break;
      label222:
      paramaiex.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
      paramaiex.jdField_c_of_type_AndroidWidgetTextView.setText(paramSysSuspiciousMsg.msg);
      break label160;
      label244:
      paramaiex.d.setVisibility(0);
      paramaiex.d.setText(paramSysSuspiciousMsg.reason);
      paramSysSuspiciousMsg = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847724);
      paramSysSuspiciousMsg.setBounds(0, 0, ViewUtils.dip2px(16.0F), ViewUtils.dip2px(16.0F));
      paramaiex.d.setCompoundDrawablePadding(ViewUtils.dip2px(5.0F));
      paramaiex.d.setCompoundDrawables(paramSysSuspiciousMsg, null, null, null);
    }
  }
  ...
  private void b(aiex paramaiex, SysSuspiciousMsg paramSysSuspiciousMsg)
  {
    int j = 1;
    int i;
    ...
    {
    default: 
      paramaiex.b.setBackgroundResource(2130845771);
      i = 0;
      j = 0;
    }
    for (;;)
    {
      paramaiex.b.setText(paramSysSuspiciousMsg.age + "");
      paramaiex.b.setCompoundDrawablesWithIntrinsicBounds(i, 0, 0, 0);
      if (j == 0) {
        break;
      }
      paramaiex.b.setVisibility(0);
      return;
      i = 2130845770;
      paramaiex.b.setBackgroundResource(2130845771);
      continue;
      i = 2130845768;
      paramaiex.b.setBackgroundResource(2130845769);
    }
    paramaiex.b.setVisibility(8);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localaiex = new aiex();
      localObject = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561479, null);
      paramView = this.jdField_a_of_type_Bjty.a(this.jdField_a_of_type_AndroidContentContext, (View)localObject, localaiex, -1);
      localaiex.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131361795));
      localaiex.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371791));
      localaiex.b = ((TextView)paramView.findViewById(2131362305));
      localaiex.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376354));
      localaiex.d = ((TextView)paramView.findViewById(2131377631));
      localaiex.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131376341));
      localaiex.e = ((TextView)paramView.findViewById(2131376351));
      if ((localaiex.jdField_c_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)localaiex.jdField_c_of_type_AndroidWidgetImageView).setSupportMaskView(true);
      }
      paramView.setTag(localaiex);
      if (ThemeUtil.isDefaultTheme())
      {
        ((View)localObject).setBackgroundResource(2130839437);
        a(this.jdField_a_of_type_AndroidContentContext, paramView, paramInt, null, localaiex, this);
    ...
    {
      a(localaiex, (SysSuspiciousMsg)localObject);
      localaiex.g.setTag(localaiex);
      if (paramInt == 0) {
      ...
      for (;;)
      {
        ...
        break;
        localaiex = (aiex)paramView.getTag();
        break;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((localObject instanceof aiex))
      {
        bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A32E", "0X800A32E", 0, 0, "", "", "", "");
        localObject = (aiex)localObject;
        Intent localIntent = new Intent();
        localIntent.putExtra("msg_extra", ((aiex)localObject).jdField_a_of_type_ComTencentMobileqqDataSysSuspiciousMsg);
        PublicFragmentActivity.a(this.jdField_a_of_type_AndroidContentContext, localIntent, AddRequestSuspiciousMsgFragment.class);
        continue;
        if ((localObject instanceof aiex))
        {
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A32C", "0X800A32C", 1, 0, "", "", "", "");
          localObject = (aiex)localObject;
          if (!NetworkUtil.isNetworkAvailable(this.jdField_a_of_type_AndroidContentContext))
          {
            QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131694073, 0).a();
          }
          else if (((amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(((aiex)localObject).jdField_a_of_type_JavaLangString))
          {
            QQToast.a(this.jdField_a_of_type_AndroidContentContext, amtj.a(2131706620), 0).a();
          }
          else if (this.jdField_a_of_type_ComTencentMobileqqAppFriendListHandler != null)
          {
            this.jdField_a_of_type_ComTencentMobileqqAppFriendListHandler.agreeSuspiciousMsg(((aiex)localObject).jdField_a_of_type_ComTencentMobileqqDataSysSuspiciousMsg.uin);
            continue;
            localObject = paramView.getTag(-1);
            if ((localObject instanceof Integer))
            {
              bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A32D", "0X800A32D", 0, 0, "", "", "", "");
