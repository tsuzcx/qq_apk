  ...
  implements INetInfoHandler
{
  ...
  {
    Iterator localIterator = avwj.a(this.a).iterator();
    while (localIterator.hasNext()) {
      ((avwm)localIterator.next()).a(5);
    }
  ...
  {
    paramString = avwj.a(this.a).iterator();
    while (paramString.hasNext()) {
      ((avwm)paramString.next()).a(4);
    }
    if (QLog.isColorLevel()) {
