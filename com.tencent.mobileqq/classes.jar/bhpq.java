...
public class bhpq
  extends bhou
  implements Handler.Callback, AdapterView.OnItemClickListener, ubn
{
  ...
  ubl jdField_a_of_type_Ubl = null;
  public boolean a;
  int b;
  public String b;
  public boolean b;
  ...
  private void c()
  {
    this.jdField_a_of_type_Tcf = new tcf(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Tcf.a(this);
    ...
    {
      this.jdField_a_of_type_Tcf.a((String)localObject);
      return;
    }
  }
  ...
  View a()
  {
    Object localObject = (bhql)this.jdField_a_of_type_Bhov.a().a(2);
    if ((((bhql)localObject).a.jdField_a_of_type_Boolean) || (((bhql)localObject).a.jdField_b_of_type_Boolean)) {}
    for (int i = 2131363653;; i = 2131378887)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
      {
        ...
        {
          localObject = localView;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d != null) {
  ...
  public String a()
  {
    return this.jdField_a_of_type_Tcf.a();
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Tcf == null);
      ...
      return;
      if ((this.jdField_a_of_type_Tcf != null) && (this.jdField_a_of_type_Tcf.a() != null)) {
        this.jdField_a_of_type_Tcf.a().onConfigurationChanged();
      }
  ...
  public void a(Uri paramUri, String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Tcf != null) {
      paramUri = this.jdField_a_of_type_Tcf.c();
    }
    int i;
    for (;;)
    {
      ...
      try
      {
        ...
        bcst.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A69", "0X8006A69", 0, 0, "", paramString, "", "");
        oat.a("0X8006A69", "", "", paramString, "", "");
        if (QLog.isDevelopLevel()) {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = tce.a(this.jdField_a_of_type_AndroidAppActivity.getWindow(), paramString);
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      if (this.jdField_a_of_type_Tcf != null) {
        this.jdField_a_of_type_Tcf.a(paramInt);
      }
      if (paramInt != 1) {
        break label487;
      }
  ...
  {
    if (this.jdField_a_of_type_Tcf != null) {
      this.jdField_a_of_type_Tcf.a(paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Tcf != null) {
      this.jdField_a_of_type_Tcf.a(paramString1, paramString2, paramInt);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Tcf.a().show();
  ...
  {
    if (this.jdField_a_of_type_Tcf != null) {
      this.jdField_a_of_type_Tcf.a(paramJSONArray);
    }
  }
  ...
  void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          if ((this.jdField_a_of_type_AndroidWidgetLinearLayout != null) && ((this.jdField_a_of_type_AndroidWidgetLinearLayout.getTag() instanceof Integer)))
          {
            ...
            if (i != paramInt)
            {
              ...
              localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363653);
              if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d != null)) {
                this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d.findViewById(2131363653);
              }
          ...
          if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559630, null));
            localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363653);
            if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d != null)) {
              this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.d.findViewById(2131363653);
            }
            ...
            localLayoutParams.setMargins(0, 0, afur.a(10.0F, BaseApplicationImpl.getContext().getResources()), afur.a(65.0F, BaseApplicationImpl.getContext().getResources()));
            ...
            if (paramInt == 2)
            {
              localObject = (LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376960).getLayoutParams();
              ((LinearLayout.LayoutParams)localObject).width = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297515);
              ((LinearLayout.LayoutParams)localObject).height = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297516);
            }
            this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376960).setOnClickListener(new bhps(this));
          }
          ...
          ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376960)).setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      ...
      ((AlphaAnimation)localObject).setAnimationListener(new bhpt(this));
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Ubl != null;
  }
  ...
  {
    if ((this.jdField_a_of_type_Ubl == null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      this.jdField_a_of_type_Ubl = new ubl(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
      this.jdField_a_of_type_Ubl.a(this);
      localObject = a();
      if (localObject != null)
      {
        ((View)localObject).setDrawingCacheEnabled(true);
        ((View)localObject).getViewTreeObserver().addOnGlobalLayoutListener(new bhpr(this, (View)localObject));
      }
      if (QLog.isColorLevel()) {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Tcf != null)) {
      this.jdField_a_of_type_Tcf.c(paramString.replace("|", "｜"));
    }
    while ((this.jdField_a_of_type_Tcf == null) || (!TextUtils.isEmpty(this.jdField_a_of_type_Tcf.b())) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
      return;
    }
    this.jdField_a_of_type_Tcf.c(BaseApplicationImpl.getContext().getResources().getString(2131694638));
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Tcf != null)) {
      this.jdField_a_of_type_Tcf.b(paramString);
    }
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Tcf != null)) {
      this.jdField_a_of_type_Tcf.e(paramString);
    }
  }
  ...
  public void f(String paramString)
  {
    ...
    paramString.putExtra("EditPicType", this.jdField_a_of_type_Tcf.b());
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          bcst.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1001", localException, "", "");
          oat.a("0X8006A1F", "", "1001", localException, "", "");
          if (QLog.isColorLevel())
          {
            QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action friend!");
            continue;
            bcst.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1002", localException, "", "");
            oat.a("0X8006A1F", "", "1002", localException, "", "");
            if (QLog.isColorLevel())
            {
              QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action qzone!");
              continue;
              bcst.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1003", localException, "", "");
              oat.a("0X8006A1F", "", "1003", localException, "", "");
              if (QLog.isColorLevel())
              {
                QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat!");
                continue;
                bcst.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1004", localException, "", "");
                oat.a("0X8006A1F", "", "1004", localException, "", "");
                if (QLog.isColorLevel())
                {
                  QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat circle!");
                  continue;
                  oat.a(null, "", "0X800787A", "0X800787A", 0, 0, localException, str, "", "");
                  bcst.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1005", localException, "", "");
                  oat.a("0X8006A1F", "", "1005", localException, "", "");
                  if (QLog.isColorLevel()) {
