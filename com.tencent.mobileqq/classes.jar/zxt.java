  ...
  extends zve
{
  ...
  private ArrayList<zxu> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, zxv> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  private ConcurrentHashMap<Long, Long> b = new ConcurrentHashMap(10);
  
  public zxt(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new zxv(this, paramString, paramInt, paramLong2);
  ...
  private void a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    {
      Object localObject = (zxu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((zxu)localObject).a();
      localObject = ((zxu)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((apep)localObject).a(localView, paramMessageForDeviceSingleStruct);
      }
      for (;;)
      {
        i += 1;
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, View paramView, apep paramapep)
  {
    long l1;
    ...
    if (paramView != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localzxu.a() == paramView) {
          localzxu.b = new WeakReference(paramapep);
        }
      }
    }
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(new zxu(this, paramView, paramapep));
      }
  ...
  {
    paramLong = (zxv)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  {
    int i = 3;
    MessageForDeviceSingleStruct localMessageForDeviceSingleStruct = (MessageForDeviceSingleStruct)azaf.a(-4502);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = ((ztp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramDataPoint.mDin);
        if (localObject == null) {
          break label636;
        }
        j = ((DeviceInfo)localObject).productId;
        aagb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "Usr_AIO_ReceiveMsg", i, 0, j);
        if ((localObject != null) && (((DeviceInfo)localObject).isAdmin == 1) && (!TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect))) {
          aagb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "FR_StrangerComming", 0, 0, 0);
        }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        return;
        this.b.put(Long.valueOf(localMessageForDeviceSingleStruct.uniseq), Long.valueOf(ayzl.a()));
        continue;
