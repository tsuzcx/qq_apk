  ...
  implements axgl
{
  ...
  private bixf jdField_a_of_type_Bixf;
  ...
  public bixi(Activity paramActivity, ViewStub paramViewStub, biws parambiws)
  {
    super(paramActivity, paramViewStub, parambiws);
    this.jdField_a_of_type_Bijd = ((bijd)parambiws.a(65537, new Object[0]));
    this.jdField_a_of_type_Bixf = ((bixf)bjav.a().c(19));
    ...
    this.jdField_a_of_type_Bixf.a(this, 1);
    this.jdField_a_of_type_Birb.a(this, 116);
    d();
    a(null);
  }
  ...
  private bira a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        bira localbira = (bira)((Iterator)localObject).next();
        if ((localbira != null) && (paramString != null) && (paramString.equals(localbira.b))) {
          return localbira;
        }
      }
    }
  ...
  private String a()
  {
    ...
    if ((localArrayList != null) && (i < localArrayList.size())) {
      return ((bjlr)localArrayList.get(i)).jdField_a_of_type_JavaLangString;
    }
    return "";
  }
      ...
      do
      {
        ...
        while (!localIterator.hasNext())
        {
          do
          {
            ...
            localbira = (bira)((Iterator)localObject).next();
          } while ((localbira == null) || (localbira.jdField_a_of_type_JavaUtilList == null));
          localIterator = localbira.jdField_a_of_type_JavaUtilList.iterator();
        }
        localbire = (bire)localIterator.next();
      } while ((localbire == null) || (paramString == null) || (!paramString.equals(localbire.jdField_a_of_type_JavaLangString)));
      return localbira.jdField_a_of_type_JavaLangString;
    }
    return "";
  }
  
  private ArrayList<bjlr> a(List<bira> paramList)
  {
    if (paramList == null) {
      paramList = null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        while (paramList.hasNext())
        {
          ...
          localbjlr.jdField_a_of_type_JavaLangString = localbira.b;
  ...
  private List<bira> a()
  {
    ...
    return this.jdField_a_of_type_Bixf.a();
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bire localbire = (bire)paramString1.get(i);
        if ((localbire != null) && (paramString2 != null) && (paramString2.equals(localbire.jdField_a_of_type_JavaLangString)))
        {
  ...
  private void a(List<bira> paramList, List<bjlr> paramList1)
  {
    if ((CollectionUtils.isEmpty(paramList)) || (CollectionUtils.isEmpty(paramList1)))
    {
      if (this.jdField_b_of_type_AndroidViewViewGroup == null)
      {
        ...
        this.jdField_b_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131378030);
        this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bixn(this));
      }
          ...
          while (!((Iterator)localObject2).hasNext())
          {
            do
            {
              do
              {
                ...
                localbira = (bira)((Iterator)localObject1).next();
              } while (localbira == null);
              localObject2 = localbira.jdField_a_of_type_JavaUtilList;
            } while (localObject2 == null);
            localObject2 = ((List)localObject2).iterator();
          }
          localbire = (bire)((Iterator)localObject2).next();
        } while ((localbire == null) || (paramString == null) || (!paramString.equals(localbire.jdField_a_of_type_JavaLangString)));
        return localbira.b;
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Bijd != null) && (this.jdField_a_of_type_Bijd.a() != null) && (this.jdField_a_of_type_Bijd.a().getIntent() != null)) {
      return this.jdField_a_of_type_Bijd.a().getIntent().getStringExtra(paramString);
    }
    return "";
  }
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Biwp.a().a(this.jdField_a_of_type_Bijd, new bixl(this));
    biqu.c().a(this.jdField_a_of_type_Bijd, new bixm(this));
  }
  ...
  private void e()
  {
    ...
    if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0))
    {
      ...
      {
        bjah.a("AEPlayShowPart", bool);
        if ((localbira == null) || (!"1".equals(localObject2))) {
          break;
        }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 655361) {
      if ((paramVarArgs != null) && (paramVarArgs.length == 1) && ((paramVarArgs[0] instanceof bire)))
      {
        ...
        if (paramVarArgs.equals(biwy.a))
        {
          localObject1 = bijb.b + File.separator + paramVarArgs.jdField_a_of_type_JavaLangString;
          localObject2 = a(paramVarArgs.jdField_a_of_type_JavaLangString);
          bizx.a().d(paramVarArgs.jdField_a_of_type_JavaLangString);
      ...
      else if ((paramInt == 655364) && (paramVarArgs != null) && (paramVarArgs.length == 2) && ((paramVarArgs[0] instanceof String)) && ((paramVarArgs[1] instanceof String)))
      {
        ...
        if (this.jdField_a_of_type_DovComQqImAePlayAEPlayShowTabView != null)
        {
          ...
          if (localObject2 != null)
          {
            ...
            {
              bjlr localbjlr = (bjlr)((List)localObject2).get(paramInt);
              if ((localbjlr != null) && (((String)localObject1).equals(localbjlr.jdField_a_of_type_JavaLangString)))
              {
                a(paramInt);
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379342));
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131379347));
    this.jdField_a_of_type_DovComQqImAePlayAEPlayShowTabView.setTabCheckListener(new bixj(this));
    this.jdField_a_of_type_DovComQqImAePlayPlayViewPagerAdapter = new PlayViewPagerAdapter(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Biws, a());
    ...
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new bixk(this));
    e();
  }
  ...
  public void a(Object paramObject, int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 1)
    {
      bjah.b("AEPlayShowPart", "notify, eventId=AEPlayShowMaterialManager.EVENT_MATERIAL_LIST_UPDATED");
      if (a()) {
    ...
    bjah.b("AEPlayShowPart", "notify, eventId=AEMaterialManager.TEMPLATE_INFO_LIST_UPDATE");
    this.jdField_a_of_type_Bixf.d();
  }
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_Bixf != null)
    {
      this.jdField_a_of_type_Bixf.a(this);
      this.jdField_a_of_type_Bixf.e();
    }
  }
}
