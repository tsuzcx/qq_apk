  ...
  implements bahf, bakb
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bgok(this);
  private baka jdField_a_of_type_Baka;
  private bgol jdField_a_of_type_Bgol;
  ...
  public bgoj(Context paramContext, bgol parambgol)
  {
    this.jdField_a_of_type_Int = 360000;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_Bgol = parambgol;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (int i = 0;; i = 1)
    {
      this.jdField_a_of_type_Baka = new baka(paramString, localHandler, i);
      this.jdField_a_of_type_Baka.a(BaseApplication.getContext());
  ...
  {
    a();
    if (this.jdField_a_of_type_Bgol == null) {
      return;
    }
    if (this.jdField_b_of_type_Int > 0)
    {
      this.jdField_a_of_type_Bgol.b(this.jdField_b_of_type_Int, paramString);
      this.jdField_b_of_type_Int = 0;
      return;
    }
    this.jdField_a_of_type_Bgol.a(3, this.e);
  }
  ...
  {
    aucl.b(paramString);
    this.jdField_a_of_type_Bgol.a(paramString, paramDouble);
  }
  
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    aucl.a(paramString1);
    this.jdField_a_of_type_Bgol.c();
  }
  ...
  public void b(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_Bgol != null) && (!TextUtils.isEmpty(str1)))
    {
      this.jdField_a_of_type_Bgol.a(1, paramString);
      d(str1);
      return;
    }
    ...
    for (;;)
    {
      if (i != 0)
      {
        if (new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1)
        {
          ...
          paramString = axoy.a(paramString, null, 2, null);
        ...
        bbmy.a(BaseApplication.getContext(), 2131653221, 0).a();
        return;
      }
    }
    bbmy.a(BaseApplication.getContext(), 2131629029, 0).a();
  }
}
