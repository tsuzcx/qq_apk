...
public class tmv
{
  ...
  public tmv(String paramString1, String paramString2)
  {
  ...
  private File a(String paramString1, String paramString2)
  {
    ...
    //   36: aload_0
    //   37: invokespecial 69	tmv:a	()Ljava/lang/String;
    ...
    //   65: invokestatic 82	tmy:a	(Ljava/io/File;)Z
    //   68: pop
    //   69: aload 6
    ...
    //   125: aload_1
    //   126: aload_3
    //   127: invokestatic 116	tmy:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   130: pop2
    //   131: aload_1
    //   132: invokestatic 119	tmy:a	(Ljava/io/Closeable;)V
    //   135: aload_3
    //   136: invokestatic 119	tmy:a	(Ljava/io/Closeable;)V
    //   139: aload 6
    //   141: areturn
    //   142: astore 6
    //   144: aconst_null
    ...
    //   181: aload_1
    //   182: invokestatic 119	tmy:a	(Ljava/io/Closeable;)V
    //   185: aload_3
    //   186: invokestatic 119	tmy:a	(Ljava/io/Closeable;)V
    //   189: aconst_null
    //   190: areturn
    //   191: astore_1
    //   192: aconst_null
    ...
    //   196: astore_3
    //   197: aload 5
    //   199: invokestatic 119	tmy:a	(Ljava/io/Closeable;)V
    //   202: aload_3
    //   203: invokestatic 119	tmy:a	(Ljava/io/Closeable;)V
    //   206: aload_1
    //   207: athrow
    //   208: astore_1
    //   209: aconst_null
  ...
  private String a()
  {
    return jdField_a_of_type_JavaLangString + pkh.a() + "/" + this.c + "/" + "styles";
  }
  
  private boolean a()
  {
    if (this.d == null) {}
    while (!this.d.equals(pkh.a())) {
      return true;
    }
    return false;
  }
  ...
  public tmw a(boolean paramBoolean)
  {
    Object localObject3;
    Object localObject1;
    if ((paramBoolean) && (this.jdField_a_of_type_Boolean) && (!a()))
    {
      localObject3 = tmw.a(this.jdField_b_of_type_JavaLangString, false);
    ...
    {
      this.d = pkh.a();
      localObject1 = new tmw();
      ((tmw)localObject1).a(tmn.a());
      ((tmw)localObject1).b(this.jdField_b_of_type_JavaLangString);
      ((tmw)localObject1).a(3);
      l = System.currentTimeMillis();
      for (;;)
      {
        try
        {
          localObject3 = new tms(a());
          localObject4 = ((tmq)localObject3).a();
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          tmw localtmw = null;
          return localtmw;
          Object localObject5 = tmz.a((InputStream)localObject5);
          a(localtmw, new JSONObject((String)localObject5), false);
        ...
        if (localIterator.hasNext())
        {
          ...
          try
          {
            ...
            localObject5 = ((tmq)localObject3).a((String)localObject4);
  ...
  public void a(tmw paramtmw, JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramtmw.a(str1, str2, (String)localJSONObject.keys().next());
      localProteusParser.createViewTemplate(paramtmw, localJSONObject, null);
