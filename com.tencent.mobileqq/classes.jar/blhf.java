...
public class blhf
{
  ...
  public static void a(Context paramContext, blhi paramblhi)
  {
    ...
    {
      if (paramblhi != null) {
        paramblhi.a(localFile1.getAbsolutePath(), localFile2.getAbsolutePath());
      }
      return;
    }
    String str2 = blhk.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    blfu.a().a(b, str1, "SoHelper", new blhg(str2, str1, paramblhi, paramContext, localFile1, localFile2));
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    paramContext = blhe.a(paramContext, "0", "key_local_so_version");
