...
public class bjve
{
  ...
  public static String e()
  {
    ...
    WindowManager localWindowManager = (WindowManager)bjjo.a().a().getSystemService("window");
  ...
  public static String f()
  {
    ...
    {
      bjtx.c("getLocation", "getLocation>>>", localException);
    }
    return "";
  }
  ...
  public static String h()
  {
    try
    {
      ...
      String str = bjts.b(localContext);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        localStringBuilder.append("wifi=").append(bjts.e(localContext));
  ...
  public static String i()
  {
    ...
    try
    {
      localJSONObject.put("qua", bjjo.a().f());
      localJSONObject.put("longitude", f());
      localJSONObject.put("platform", bjjo.a().g());
      localJSONObject.put("uin", bjjo.a().a());
      localJSONObject.put("imei", c());
      localJSONObject.put("imei", c());
      localJSONObject.put("resolution", e());
      localJSONObject.put("network", bjts.a(bjjo.a().a()));
      ...
      localJSONObject.put("qua", bjjo.a().f());
      localJSONObject.put("qz_ver", bjjo.a().c());
      localJSONObject.put("imsi", d());
      localJSONObject.put("androidID", Settings.Secure.getString(bjjo.a().a().getContentResolver(), "android_id"));
      localJSONObject.put("os_api_level", Build.VERSION.SDK_INT);
      localJSONObject.put("sdkVersionCode", 1);
      localJSONObject.put("QVersionCode", bjjo.a().a());
