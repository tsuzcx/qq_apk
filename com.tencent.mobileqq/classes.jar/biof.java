...
public class biof
  extends bisx
{
  public biof(SendStoryActivity paramSendStoryActivity, EditText paramEditText, int paramInt)
  {
  ...
  public CharSequence filter(CharSequence paramCharSequence, int paramInt1, int paramInt2, Spanned paramSpanned, int paramInt3, int paramInt4)
  {
    ...
    Arrays.sort(arrayOfFriend, new biog(this, paramSpanned));
    ...
    paramInt4 = this.jdField_a_of_type_Int - bite.a(localStringBuilder.toString());
