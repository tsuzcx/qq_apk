...
public class abac
  implements Manager
{
  private static abac jdField_a_of_type_Abac;
  public static String a;
  public static String b = "1";
  public static final String c = anzj.a(2131715647);
  ...
  public static abac a()
  {
    if (jdField_a_of_type_Abac == null) {}
    try
    {
      if (jdField_a_of_type_Abac == null) {
        jdField_a_of_type_Abac = new abac();
      }
      return jdField_a_of_type_Abac;
    }
    finally {}
  }
  ...
  public void a()
  {
    VSNetworkHelper.a().a(new GetStoryConfigRequest(), new abad(this));
  }
  ...
  public <V> void a(String paramString, V paramV)
  {
    ...
    for (;;)
    {
      ...
      bpam.b("Q.videostory.config.VSConfigManager", "set value into map success :  K:" + paramString + ", V : " + paramV);
