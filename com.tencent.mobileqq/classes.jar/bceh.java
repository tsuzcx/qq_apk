  ...
  extends DynamicDrawableSpan
{
  ...
  private bceh(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint)
  {
    super(0);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = a(String.format("%s%s", new Object[] { "@", new bahs(paramString2, 32).a() }));
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a(paramPaint);
  }
  
  private bceh(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint, String paramString3)
  {
    this(paramContext, paramString1, paramString2, paramInt, paramPaint);
    this.d = a(String.format("%s%s", new Object[] { "@", new bahs(paramString3, 32).a() }));
  }
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, EditText paramEditText)
  {
    ...
    try
    {
      paramQQAppInterface = new bceh(paramContext, paramString2, paramString3, i - j - k, paramEditText.getPaint(), paramString4);
    ...
    catch (OutOfMemoryError paramQQAppInterface)
    {
      ...
      paramString1 = new SpannableString(new bahs(paramContext + " ", 16).a());
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, EditText paramEditText, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    bceh[] arrayOfbceh = (bceh[])paramEditText.getEditableText().getSpans(0, paramEditText.getEditableText().toString().length(), bceh.class);
    int i = paramEditText.getWidth();
    int j = paramEditText.getPaddingLeft();
    int k = paramEditText.getPaddingRight();
    try
  ...
  private static bceh a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, int paramInt, Paint paramPaint, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {
        ...
        {
          paramString1 = bdbt.e(paramQQAppInterface, paramString1, paramString2);
      ...
      while (!TextUtils.isEmpty(paramQQAppInterface))
      {
        if (QLog.isColorLevel()) {
          QLog.d("_At_Me_DISC", 2, " memUin:" + paramString2 + " troopMemName:" + bdal.a(paramQQAppInterface) + " isTroop:" + paramBoolean2);
        }
        return new bceh(paramContext, paramString2, paramQQAppInterface, paramInt, paramPaint);
        paramQQAppInterface = paramString3;
        continue;
        if (!paramString2.equalsIgnoreCase("0"))
        {
          paramString1 = bdbt.c(paramQQAppInterface, paramString2, true);
          paramQQAppInterface = paramString1;
  ...
  public static String a(Spannable paramSpannable, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    bceh[] arrayOfbceh = (bceh[])paramSpannable.getSpans(0, m - 1, bceh.class);
    if (arrayOfbceh.length == 0) {
      return localStringBuffer.toString();
    }
    if (arrayOfbceh.length > 1) {
      Arrays.sort(arrayOfbceh, new bcei(paramSpannable));
    }
    int j = 0;
    int i = 0;
    int n;
    ...
    for (;;)
    {
      if (i >= arrayOfbceh.length) {
        break label345;
      }
      bceh localbceh = arrayOfbceh[i];
      n = paramSpannable.getSpanStart(localbceh) + j;
      i1 = paramSpannable.getSpanEnd(localbceh) + j;
      String str = localbceh.jdField_b_of_type_JavaLangString;
      if (!TextUtils.isEmpty(localbceh.d)) {
        str = localbceh.d;
      }
      try
      {
        ...
        localAtTroopMemberInfo.uin = Long.valueOf(localbceh.jdField_a_of_type_JavaLangString).longValue();
        if ((localbceh.jdField_a_of_type_JavaLangString != null) && (localbceh.jdField_a_of_type_JavaLangString.equalsIgnoreCase("0"))) {
      ...
      catch (JSONException paramQQAppInterface)
      {
        try
        {
          ...
          if (i1 == 0)
          {
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
            str = "@" + bdbt.c(paramQQAppInterface, paramString2, str);
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
  ...
  private List<bejq> a(Paint paramPaint)
  {
    int i = (int)Math.ceil(paramPaint.measureText(" "));
    List localList = bdnm.a(this.jdField_b_of_type_Int - i * 2, this.jdField_b_of_type_JavaLangString, paramPaint, this.jdField_a_of_type_Bejr, 16);
    localList.add(new bejq(1, 0, 0, "  ", null));
    this.jdField_a_of_type_Int = bdnm.a(localList, paramPaint, new Rect());
    return localList;
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    {
      localObject3 = (bejq)((Iterator)localObject2).next();
      switch (((bejq)localObject3).c)
      {
      default: 
        break;
      case 1: 
        localCanvas.drawText(((bejq)localObject3).jdField_a_of_type_JavaLangString, f1, f2, paramPaint);
        f1 += paramPaint.measureText(((bejq)localObject3).jdField_a_of_type_JavaLangString);
        break;
      case 2: 
        localObject3 = (bain)((bejq)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle;
        j = ((bain)localObject3).a().getBounds().height();
        ((bain)localObject3).draw(localCanvas, "", 0, 0, f1, (i - j) / 2, (i + j) / 2, (j + i) / 2, paramPaint);
        f1 += ((bain)localObject3).a().getBounds().width();
      }
    }
    localCanvas.save();
    localCanvas.restore();
