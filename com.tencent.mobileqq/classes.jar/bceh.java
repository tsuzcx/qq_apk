  ...
  extends bcfk
{
  ...
  public bceh()
  {
    this.jdField_c_of_type_Int = 2131167107;
  ...
  public bceh(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt)
  {
    this.jdField_c_of_type_Int = 2131167107;
    this.jdField_g_of_type_Int = -1;
    this.jdField_h_of_type_Int = -1;
  ...
  public bceh(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt1, String paramString7, String paramString8, int paramInt2, String paramString9, String paramString10, String paramString11)
  {
    this.jdField_c_of_type_Int = 2131167107;
    this.jdField_g_of_type_Int = -1;
    this.jdField_h_of_type_Int = -1;
  ...
  private void a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bjxa.a((QQAppInterface)localObject3, this.jdField_l_of_type_Int, this.jdField_b_of_type_JavaLangString);
          bjxa.a((QQAppInterface)localObject3, this.jdField_b_of_type_JavaLangString, str1);
          if ((!bjxa.b(this.jdField_l_of_type_Int)) && (!bjxa.c(this.jdField_l_of_type_Int))) {
            break;
          }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131695881);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = bcmq.a(Long.parseLong(((JSONObject)localObject3).optString("create_time")));
  ...
  public CharSequence a()
  {
    ...
    do
    {
      try
      {
        CharSequence localCharSequence = bcnc.a(this.jdField_c_of_type_JavaLangString, a(), true);
      ...
      localObject = new bcmr(this.jdField_a_of_type_JavaUtilList, a());
      if (d() != 1002) {
        break;
      }
      this.jdField_c_of_type_JavaLangString = bcnc.a(this.jdField_c_of_type_JavaLangString);
      localSpannableString = ((bcmr)localObject).a(this.jdField_c_of_type_JavaLangString, true);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
    this.jdField_c_of_type_JavaLangString = bcnc.a(this.jdField_c_of_type_JavaLangString);
    SpannableString localSpannableString = ((bcmr)localObject).a(this.jdField_c_of_type_JavaLangString, true);
    if (((bcmr)localObject).jdField_a_of_type_Int > 0) {}
    for (;;)
    {
  ...
  public Object a(String paramString)
  {
    ...
    {
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699036);
      ...
      for (;;)
      {
        ...
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699038);
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699036);
        bool = true;
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699037);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      if ((localObject2 instanceof bbzj))
      {
        localObject3 = (bbzj)localObject2;
        if (((bbzj)localObject3).b()) {}
        localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        localObject1 = ((bbzj)localObject3).a();
        if (!(localObject1 instanceof bbzi)) {
          break label2630;
        }
      }
      break;
    ...
    label2625:
    label2630:
    for (Object localObject1 = (bbzi)localObject1;; localObject1 = null)
    {
      switch (((bbzj)localObject3).a())
      {
      }
      Object localObject4;
      for (;;)
      {
        if (d() == 268435456)
        {
          bcnc.a("all_result", "clk_function", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + this.jdField_b_of_type_JavaLangString, "" + (this.jdField_j_of_type_Int + 1) });
          if ("63".equals(b()))
          {
            localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
            if (amfb.a(paramView.getContext(), (QQAppInterface)localObject1))
            {
              return;
              bcnc.a(this.jdField_a_of_type_JavaLangString, 70, 0, this.jdField_j_of_type_Int, paramView);
              if (this.jdField_o_of_type_Int == 1)
              {
                bdla.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
                bdla.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 2, 0, "", "", "", "");
                break;
              }
              bdla.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
              bdla.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 1, 0, "", "", "", "");
              break;
              bcnc.a(this.jdField_a_of_type_JavaLangString, 80, 0, this.jdField_j_of_type_Int, paramView);
              break;
              bcnc.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_JavaLangString, this.jdField_t_of_type_JavaLangString, e(), e());
              bcnc.a(this.jdField_a_of_type_JavaLangString, 120, 0, this.jdField_j_of_type_Int, paramView);
              if ((this.jdField_t_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_t_of_type_JavaLangString)))
              {
                bcjs.a(null, 0, this.jdField_a_of_type_Int, "0X8009D31", 4, 0, this.jdField_b_of_type_JavaLangString, null);
                break;
              }
              ...
              {
                bcjs.a(null, 0, this.jdField_a_of_type_Int, "0X8009D35", 0, 0, this.jdField_b_of_type_JavaLangString, null);
                break;
              }
              bcjs.a(null, 0, this.jdField_a_of_type_Int, "0X8009D49", 0, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
              QQAppInterface localQQAppInterface;
              JSONObject localJSONObject;
              if ((bbzq.jdField_b_of_type_JavaUtilHashMap.containsKey(this)) && (d() != 268435456))
              {
                localObject4 = (bbzr)bbzq.jdField_b_of_type_JavaUtilHashMap.get(this);
              ...
              try
              {
                ...
                localJSONObject.put("obj_lct", ((bbzr)localObject4).jdField_a_of_type_Int);
                localJSONObject.put("get_src", "web");
                bcjs.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(((bbzr)localObject4).jdField_b_of_type_JavaLangString).ver1(this.jdField_a_of_type_JavaLangString).ver2(bcjs.a(this.jdField_a_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + bbzq.jdField_a_of_type_Long));
                if (bcnc.a(this.jdField_a_of_type_Long)) {
                  if (bbzq.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
                  {
                    localObject4 = (bbzr)bbzq.jdField_a_of_type_JavaUtilHashMap.get(this);
                    if (((bbzr)localObject4).jdField_b_of_type_Boolean)
                    {
                      i1 = 2;
                      bcnc.a("all_result", "clk_object", i1, 0, new String[] { this.jdField_a_of_type_JavaLangString, "" + this.jdField_a_of_type_Long, ((bbzr)localObject4).jdField_b_of_type_JavaLangString + "", ((bbzr)localObject4).jdField_a_of_type_Int + "" });
                    }
                  }
                  else
                  {
                    if ((localObject1 == null) || (!((bbzi)localObject1).b())) {
                      continue;
                    }
                    ((bbzi)localObject1).a(true);
                    bcnc.a("all_result", "clk_first_result", new String[] { ((bbzj)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(3), bcnc.a("dynamic_tab_search.1", ((bbzj)localObject3).a()) });
                  }
                }
              }
              catch (JSONException localJSONException2)
              {
                ...
                if (bbzq.jdField_b_of_type_Boolean) {}
                for (i1 = 2;; i1 = 1)
                {
                  bcnc.a("all_result", "clk_content", i1, 0, new String[] { ((bbzj)localObject3).a(), "" + this.jdField_a_of_type_Long, "", bcnc.a("dynamic_tab_search.1", ((bbzj)localObject3).a()) });
                  if ((localObject1 == null) || (!((bbzi)localObject1).b())) {
                    break;
                  }
                  ((bbzi)localObject1).a(true);
                  bcnc.a("all_result", "clk_first_result", new String[] { ((bbzj)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcnc.a("dynamic_tab_search.1", ((bbzj)localObject3).a()) });
                  break;
                }
              }
              if ((localObject1 != null) && (((bbzi)localObject1).b()))
              {
                ((bbzi)localObject1).a(true);
                bcnc.a("all_result", "clk_tab_first_result", new String[] { ((bbzj)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcnc.a("dynamic_tab_search.1", ((bbzj)localObject3).a()) });
              }
              bcnc.a("all_result", "clk_tab_result", new String[] { ((bbzj)localObject3).a(), "" + this.jdField_a_of_type_Long, "", bcnc.a("dynamic_tab_search.1", ((bbzj)localObject3).a()) });
              continue;
              if ((localObject1 != null) && (((bbzi)localObject1).b()))
              {
                ((bbzi)localObject1).a(true);
                bcnc.a("sub_result", "clk_sub_first_result", new String[] { ((bbzj)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcnc.a("dynamic_tab_search.1", ((bbzj)localObject3).a()) });
              }
              bcnc.a("sub_result", "clk_result", new String[] { ((bbzj)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcnc.a("dynamic_tab_search.1", ((bbzj)localObject3).a()) });
              continue;
            }
          }
          if (((paramView.getContext() instanceof UniteSearchActivity)) && (bbzq.jdField_b_of_type_JavaUtilHashMap.containsKey(this)))
          {
            localObject1 = (bbzr)bbzq.jdField_b_of_type_JavaUtilHashMap.get(this);
            localObject3 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ...
      try
      {
        ((JSONObject)localObject4).put("project", bcjs.a());
        ((JSONObject)localObject4).put("event_src", "client");
        ((JSONObject)localObject4).put("obj_lct", ((bbzr)localObject1).jdField_a_of_type_Int);
        ((JSONObject)localObject4).put("get_src", "native");
        bcjs.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(((bbzr)localObject1).jdField_a_of_type_Long + "").obj2(((bbzr)localObject1).jdField_b_of_type_JavaLangString).ver1(((bbzr)localObject1).jdField_a_of_type_JavaLangString).ver2(bcjs.a(UniteSearchActivity.jdField_d_of_type_Int)).ver7(((JSONObject)localObject4).toString()).session_id(((QQAppInterface)localObject3).getCurrentAccountUin() + bbzq.jdField_a_of_type_Long));
      ...
      catch (JSONException localJSONException1)
      {
        ...
        {
          paramView = bhey.a(((BaseActivity)paramView.getContext()).app, (Context)localObject2, this.jdField_e_of_type_JavaLangString);
          if (paramView != null)
          {
            paramView.a();
            return;
      ...
      {
        bcnc.a(paramView.getContext(), Integer.valueOf(this.jdField_b_of_type_JavaLangString).intValue(), this.jdField_a_of_type_Int);
        return;
      }
      if (this.jdField_a_of_type_Long == 1001L)
      {
        ...
        if (bghs.b((QQAppInterface)localObject1, this.jdField_b_of_type_JavaLangString))
        {
  ...
  {
    bcmr localbcmr = new bcmr(this.jdField_a_of_type_JavaUtilList, a());
    Object localObject1 = null;
    Object localObject2;
    if (!TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString))
    {
      localObject1 = bcnc.a("(" + this.jdField_h_of_type_JavaLangString + ")");
      localObject2 = null;
    }
    for (;;)
    {
      localObject2 = localbcmr.a((CharSequence)localObject1, (String)localObject2, false, false, true);
      localObject1 = localObject2;
      ...
      {
        this.jdField_g_of_type_JavaLangString = bcnc.a(this.jdField_g_of_type_JavaLangString);
        localObject2 = bhnz.a(this.jdField_g_of_type_Int);
        if (localObject2 != null) {
          localObject1 = ((LhLogoResources)localObject2).lightColor;
        }
        CharSequence localCharSequence = bhnz.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int, this.jdField_g_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
        localObject2 = localObject1;
        localObject1 = localCharSequence;
      }
      else
      {
        localObject1 = bcnc.a(this.jdField_g_of_type_JavaLangString);
        localObject2 = null;
      }
    }
  }
  ...
  public CharSequence c()
  {
    boolean bool = false;
    bcmr localbcmr = new bcmr(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_a_of_type_JavaLangCharSequence = bcnc.a(this.jdField_a_of_type_JavaLangCharSequence);
    SpannableString localSpannableString = localbcmr.a(this.jdField_a_of_type_JavaLangCharSequence, false, false, false);
    if (localbcmr.jdField_a_of_type_Int > 0) {
      bool = true;
    }
  ...
  public CharSequence d()
  {
    ...
    {
      return localObject;
      localSpannableString = new bcmr(this.jdField_a_of_type_JavaUtilList, a()).a(this.jdField_b_of_type_JavaLangCharSequence, false, this.jdField_a_of_type_Boolean);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
  }
