...
{
  public aaqp(MoveFileActivity paramMoveFileActivity, EditText paramEditText, abdk paramabdk) {}
  
  public void afterTextChanged(Editable paramEditable)
  {
    paramEditable = this.jdField_a_of_type_AndroidWidgetEditText.getText().toString().trim();
    TextView localTextView = this.jdField_a_of_type_Abdk.getBtnight();
    if (bfsj.b(paramEditable))
    {
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 > 0)
    {
      ...
      String str = bfsj.b(paramCharSequence);
