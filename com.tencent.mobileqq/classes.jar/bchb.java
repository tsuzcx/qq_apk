...
public class bchb
{
  ...
  protected bchb()
  {
    this.jdField_a_of_type_ComTencentTmassistantsdkITMAssistantCallBackListener = new bchn(this);
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        bcds.c("MyAppApi", "MyAppApi init>>>", localThrowable);
      }
    }
  }
  ...
  {
    return Uri.parse("tmast://sdk_wake?jump_code=" + bcfa.a(bbtm.a().a(), null).a("Common_jump_code") + "&outerCallTime=" + paramOuterCallReportModel.mOuterCallTime + "&outerCallType=" + paramOuterCallReportModel.mOuterCallType + "&outerCallMode=" + paramOuterCallReportModel.mOuterCallMode + "&hostpname=com.tencent.mobileqq&hostversion=" + GlobalUtil.getAppVersionCode(bbtm.a().a()));
  }
  
  public static bchb a()
  {
    try
    {
      if (jdField_a_of_type_Bchb == null) {
        jdField_a_of_type_Bchb = new bchb();
      }
      c();
      bchb localbchb = jdField_a_of_type_Bchb;
      return localbchb;
    }
    finally {}
  }
  ...
  protected static void a(String paramString)
  {
    ...
    if (localDownloadInfo != null) {
      localbcgo.a(10, localDownloadInfo);
    }
  }
  ...
  private static void c(OuterCallReportModel paramOuterCallReportModel)
  {
    ...
    if (!(bbtm.a().a() instanceof Activity)) {
    ...
    {
      bcds.e("TAMST_WAKE", "activity not found error:" + paramOuterCallReportModel.getMessage());
    }
  }
  
  private static void d(OuterCallReportModel paramOuterCallReportModel)
  {
    GlobalUtil.getInstance().setContext(bbtm.a().a());
  ...
  public static boolean d()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 142	bchb:jdField_a_of_type_Bchb	Lbchb;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +10 -> 18
    //   11: iconst_1
  ...
  private void i()
  {
    ...
    bbtm.a().a().registerReceiver(new AppReportReceiver(), localIntentFilter);
  }
  
  private static boolean i()
  {
    return (bcgg.i()) && (TMAssistantCallYYB_V1.getQQDownloadApiLevel(bbtm.a().a()) >= 7);
  }
  
  public int a()
  {
    int i = TMAssistantCallYYB_V1.getQQDownloadApiLevel(bbtm.a().a());
    if (!amom.a("com.tencent.android.qqdownloader", BaseActivity.sTopActivity)) {
      i = 3;
    }
    return i;
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    {
      i = j;
      if (paramBundle.getInt(bcgl.k) == 3) {
        i = 2;
      }
    }
    return i;
  ...
  public long a(Bundle paramBundle)
  {
    try
    {
      bcds.c("MyAppApi", "--addDownloadTaskFromTmast--params = " + paramBundle);
      if (paramBundle == null) {
        return -1L;
      }
  ...
  {
    bcds.c("MyAppApi", "--addDownloadTaskFromTaskList--params = " + paramBundle + "autoDownload = " + paramBoolean1);
    if (paramBundle == null) {
      return -1L;
    }
  ...
  public DownloadInfo a(TMAssistantCallYYBParamStruct paramTMAssistantCallYYBParamStruct, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      localDownloadInfo.jdField_h_of_type_JavaLangString = paramBundle.getString(bcgl.i);
      localDownloadInfo.f = paramBundle.getString(bcgl.l);
      localDownloadInfo.jdField_d_of_type_JavaLangString = paramBundle.getString(bcgl.j);
      localDownloadInfo.jdField_d_of_type_Int = paramBundle.getInt(bcgl.E);
    }
  ...
  protected TMAssistantCallYYBParamStruct a(Bundle paramBundle)
  {
    ...
    String str5 = paramBundle.getString(bcgl.jdField_c_of_type_JavaLangString);
    String str6 = paramBundle.getString(bcgl.jdField_d_of_type_JavaLangString);
    String str7 = paramBundle.getString(bcgl.f);
    Object localObject1 = paramBundle.getString(bcgl.i);
    int j = paramBundle.getInt(bcgl.e);
    int i = j;
    if (j == 0) {}
    try
    {
      i = Integer.valueOf(paramBundle.getString(bcgl.e)).intValue();
      String str2;
      String str1;
      String str3;
      Object localObject2;
      ...
      {
        str2 = bcfb.a((String)localObject1, "NEWYYB");
        str1 = paramBundle.getString(bcgl.v);
        localObject1 = paramBundle.getString(bcgl.w);
        str3 = str1;
        if (TextUtils.isEmpty(str1)) {
          str3 = Long.valueOf(bbtm.a().a()).toString();
        }
        localObject2 = localObject1;
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          localObject2 = "qqNumber";
        }
        paramBundle.getString(bcgl.z);
        localObject1 = paramBundle.getString(bcgl.B);
        j = paramBundle.getInt(bcgl.A);
        if (j != 1) {
          break label479;
        }
      ...
      for (;;)
      {
        bcds.b("State_Log", " channelId:" + (String)localObject1);
        ...
        bcds.b("MyAppApi", "recommendId:" + ((TMAssistantCallYYBParamStruct)localObject1).recommendId);
        return localObject1;
        str2 = bcfb.a((String)localObject1, "YYB");
        break;
        label479:
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
  ...
  public String a()
  {
    if ((this.jdField_a_of_type_Bchm != null) && (this.jdField_a_of_type_Bchm.jdField_a_of_type_AndroidOsBundle != null)) {
      return this.jdField_a_of_type_Bchm.jdField_a_of_type_AndroidOsBundle.getString(bcgl.b);
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentTmassistantsdkInternalOpenSDKTMAssistantBaseCallYYB.initTMAssistantCallYYBApi(bbtm.a().a());
      g();
      return;
    }
  }
  ...
  {
    String str = paramBundle.getString(bcgl.p);
    int i = paramBundle.getInt("dialogType");
    int j = paramBundle.getInt("auto_start_yyb_download");
    bcds.c("TIME-STATISTIC", "MyAppApi--showTipDialog");
    bcds.c("MyAppApi", "-showTipDialog-");
    ...
    if (paramInt2 == 1) {
      if (paramInt1 == 2)
      {
        ...
        localObject = bcgg.a(paramInt1, paramString2);
        label86:
        ...
        {
        default: 
          paramString2 = localResources.getString(2131626076);
          label138:
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = localResources.getString(2131626089);
        if ((paramInt2 == 1) && (i == 1))
        {
          paramString1 = localResources.getString(2131626090);
          paramString2 = localResources.getString(2131626080);
          paramInt1 = 2131626083;
          if (paramBundle.getInt("qqupdate_support_go_market", 0) != 0) {
            paramInt1 = 2131626086;
          }
          localObject = new bchp(paramActivity);
          ((bchp)localObject).b(paramInt1, paramOnClickListener2, true);
          if (!paramBoolean)
          {
            bool = true;
            ((bchp)localObject).a(2131626087, paramOnClickListener1, bool);
            ((bchp)localObject).a(paramString1);
            ((bchp)localObject).b(paramString2);
            if (i == 1)
            {
              ((bchp)localObject).b(paramInt1, Color.parseColor("#D2D1D1"), paramOnClickListener2, true);
              paramInt1 = Color.parseColor("#3AC8FF");
              if (paramBoolean) {
                continue;
              }
              paramBoolean = true;
              ((bchp)localObject).a(2131626087, paramInt1, paramOnClickListener1, paramBoolean);
              ((bchp)localObject).a(paramActivity.getResources().getDrawable(2130841288));
              ((bchp)localObject).a(Color.parseColor("#848484"));
            }
            ((bchp)localObject).setCancelable(true);
            ((bchp)localObject).setOnCancelListener(paramOnCancelListener);
            ((bchp)localObject).setOnDismissListener(new bche(this));
            if ((!(paramActivity instanceof AppActivity)) || (((AppActivity)paramActivity).isResume())) {
              continue;
            }
            bcds.c("TIME-STATISTIC", "MyAppApi--showTipDialog---cancel !isResume");
            return;
            ...
            paramString2 = localResources.getString(2131626076);
            break label138;
            paramString2 = localResources.getString(2131626077, new Object[] { paramString1 });
            break label138;
            paramString2 = localResources.getString(2131626078);
            break label138;
            paramString2 = localResources.getString(2131626079, new Object[] { paramString1 });
          }
        }
      }
      catch (Exception paramString2)
      {
        if (paramInt1 == 2)
        {
          paramString1 = localResources.getString(2131626076);
          bcds.c("MyAppApi", " errorMsg = " + paramString2.getMessage());
          continue;
        }
        paramString1 = localResources.getString(2131626078);
        continue;
        boolean bool = false;
        continue;
        paramBoolean = false;
        ...
        try
        {
          ...
          {
            ((bchp)localObject).show();
            awqx.b(null, "dc00898", "", "", "0X8008F7A", "0X8008F7A", 0, 0, "", "", "", "");
            if (i == 1)
            {
              bcdj.a("6006", "0", "0", paramBundle.getString(bcgl.i), paramBundle.getString("pageId") + "_" + paramBundle.getString("moduleId") + "_" + paramBundle.getString(bcgl.f) + "_" + paramBundle.getString(bcgl.jdField_c_of_type_JavaLangString) + "_" + paramBundle.getString(bcgl.jdField_d_of_type_JavaLangString));
              if (j == 1) {
                ThreadManager.getUIHandler().post(new MyAppApi.13(this, paramOnClickListener1, (bchp)localObject));
              }
            }
          }
        }
        ...
        bcds.c("TIME-STATISTIC", "MyAppApi--showTipDialog---complete");
        this.jdField_a_of_type_Bchp = ((bchp)localObject);
        return;
  ...
  protected void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    do
    {
      ...
      break label74;
      bcds.e("MyAppApi", "startToAuthorizedDirect mLastAuthorizeParam = null, needCarryQQIdentity = false");
      return;
      localbcdz = new bcdz();
      localbcdz.a(new bchf(this, localbcdz, l, paramActivity, paramOnClickListener));
    } while (!(paramActivity instanceof BaseActivity));
    localbcdz.a(((BaseActivity)paramActivity).getAppRuntime(), 710020706L, "com.tencent.android.qqdownloader");
  }
  
  public void a(Activity paramActivity, Bundle paramBundle, DialogInterface.OnClickListener paramOnClickListener)
  {
    bcds.c("TIME-STATISTIC", "MyAppApi--handleDownloadAction");
    ...
    boolean bool2 = paramBundle.getBoolean(bcgl.g, false);
    boolean bool3 = paramBundle.getBoolean(bcgl.jdField_h_of_type_JavaLangString, true);
    int k = paramBundle.getInt(bcgl.n);
    int j = paramBundle.getInt(bcgl.k);
    String str3 = paramBundle.getString(bcgl.i);
    String str2 = paramBundle.getString(bcgl.b);
    int m = paramBundle.getInt("dialogType");
    int n = paramBundle.getInt(bcgl.t, 0);
    int i1 = paramBundle.getInt(bcgl.u, 0);
    boolean bool4 = bcgg.e();
    bool5 = bcgg.g();
    bcds.c("OpenConfig-MyAppApi", " useMyAppFlag = " + bool4);
    localDownloadInfo = bcgo.a().a(str2);
    boolean bool1;
    if ((localDownloadInfo != null) && (localDownloadInfo.jdField_c_of_type_Int == 1))
    {
      ...
      {
        bcds.a("MyAppApi", "allowMyApp=" + bool4 + " allowMyAppDownload=" + bool5 + " taskExist=" + bool1);
        paramOnClickListener.onClick(null, 0);
      }
      bcfb.a("200", str3, str2);
    }
    for (;;)
    {
      return;
      ...
      if (i == 1) {
        label307:
        if ((this.jdField_a_of_type_Bchp != null) && (this.jdField_a_of_type_Bchp.isShowing())) {
          if (this.jdField_a_of_type_Bchp.a() == paramActivity)
          {
            bcds.a("MyAppApi", "mTipDialog is showing return");
            return;
          }
        }
      }
      try
      {
        ...
        label351:
        for (this.jdField_a_of_type_Bchp = null; (!bcgg.f()) || ((j != 2) && (j != 12)); this.jdField_a_of_type_Bchp = null)
        {
          bcds.a("MyAppApi", "not allowShowDialog return actionCode = " + j);
          if (paramOnClickListener != null) {
            paramOnClickListener.onClick(null, 0);
          }
          bcfb.a("200", str3, str2);
        ...
        bool4 = bcgg.a();
        bchi localbchi = new bchi(this, bool2, paramOnClickListener, paramBundle, k, bool4, paramActivity, str3, bool1, bool3, str2, m);
        bchk localbchk = new bchk(this, paramOnClickListener, str3, str2);
        bchj localbchj = new bchj(this, str3, str2);
        String str1 = null;
        ...
        if (i1 > 0)
        {
          ...
          if (n > 0)
          {
            ...
            localObject = str1;
            if (k > 0) {
              localObject = bchy.a(k);
            }
          }
        }
        str1 = paramBundle.getString("source");
        ThreadManager.getUIHandler().post(new MyAppApi.7(this, paramActivity, j, i, (String)localObject, localbchi, localbchk, localbchj, str1, bool4, paramBundle));
        ...
        if ((bcgg.h()) || (bool1))
        {
          paramOnClickListener = bcfb.a(str3, "YYB");
          if (k == 0) {
            a(paramActivity, paramBundle, bool2, bool3);
          }
          while ((localObject == null) && ((j == 2) || (j == 12)))
          {
            bcfb.a("202", paramOnClickListener, str2);
            return;
            a(paramActivity, paramBundle, bool2, bool3);
          }
          bcfb.a("200", paramOnClickListener, str2);
          return;
        }
        if (paramOnClickListener != null) {
          paramOnClickListener.onClick(null, 0);
  ...
  {
    bcds.c("NewUpgradeDialog", "preDownload called,get updateDetail info");
  ...
  {
    bcds.c("MyAppApi", "downloadYyb");
    if (paramInt == 1) {
      bcgh.a("_1101070898");
    }
    if (this.jdField_a_of_type_Bcho == null)
    {
      this.jdField_a_of_type_Bcho = new bcho(this);
      bcgo.a().a(this.jdField_a_of_type_Bcho);
    }
    Object localObject = bcgo.a().a("1101070898");
    ...
    if (localObject != null)
    {
      ...
      for (((DownloadInfo)localObject).jdField_h_of_type_Int = 1;; ((DownloadInfo)localObject).jdField_h_of_type_Int = 0)
      {
        ...
        bcgo.a().a((DownloadInfo)localObject);
        return;
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    localBundle.putString(bcgl.b, "1101070898");
    localBundle.putString(bcgl.j, str);
    localBundle.putString(bcgl.f, "com.tencent.android.qqdownloader");
    localBundle.putInt(bcgl.k, 2);
    localBundle.putString(bcgl.i, paramString2);
    localBundle.putString(bcgl.l, bchy.jdField_d_of_type_JavaLangString);
    if (paramInt == 1) {
      localBundle.putBoolean(bcgl.x, true);
    }
    for (;;)
    {
      localBundle.putInt(bcgl.C, paramInt);
      localBundle.putString(bcgl.m, "yyb");
      localBundle.putString(bcgl.jdField_c_of_type_JavaLangString, "5848");
      localBundle.putBoolean(bcgl.g, true);
      localBundle.putBoolean(bcgl.jdField_h_of_type_JavaLangString, paramBoolean);
      localBundle.putInt(bcgl.n, 1);
      bcgh.a(paramActivity, localBundle, "biz_src_yyb", null, 0);
      return;
  ...
  {
    bcds.c("TIME-STATISTIC", "MyAppApi--startToDownloadTaskList");
    ...
    while ((i == 0) || (paramContext == null) || (!(paramContext instanceof BaseActivity)))
    {
      ...
      {
        bcds.e("MyAppApi", "--startToDownloadTaskList--Exception = " + paramContext);
        return;
      }
      i = 0;
      continue;
      i = paramBundle.getInt(bcgl.k);
      j = a(paramBundle);
      if (i != 3) {
        break label400;
      }
    ...
    for (;;)
    {
      ...
      return;
      localObject = new bcdz();
      ((bcdz)localObject).a(new bchd(this, (bcdz)localObject, localTMAssistantCallYYBParamStruct, paramBundle, l, paramContext, paramBoolean1, paramBoolean2));
      if (!(paramContext instanceof BaseActivity)) {
        break;
      }
      ((bcdz)localObject).a(((BaseActivity)paramContext).getAppRuntime(), 710020706L, "com.tencent.android.qqdownloader");
      return;
    }
  }
  ...
  public void a(Context paramContext, JSONArray paramJSONArray, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (i < k)
    {
      ...
      for (;;)
      {
        ...
        localTMAssistantCallYYBParamStruct.channelId = localJSONObject.optString(bcgl.K);
        localTMAssistantCallYYBParamStruct.taskPackageName = localJSONObject.optString(bcgl.f);
        localTMAssistantCallYYBParamStruct.taskVersion = localJSONObject.optInt(bcgl.e);
        localTMAssistantCallYYBParamStruct.via = localJSONObject.optString(bcgl.i);
        localTMAssistantCallYYBParamStruct.taskApkId = localJSONObject.optString(bcgl.jdField_d_of_type_JavaLangString);
        localTMAssistantCallYYBParamStruct.taskAppId = localJSONObject.optString(bcgl.jdField_c_of_type_JavaLangString);
        localTMAssistantCallYYBParamStruct.SNGAppId = localJSONObject.optString(bcgl.jdField_c_of_type_JavaLangString);
        if (TextUtils.isEmpty(localTMAssistantCallYYBParamStruct.SNGAppId)) {
          localTMAssistantCallYYBParamStruct.SNGAppId = localJSONObject.optString(bcgl.b);
        }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    SharedPreferences.Editor localEditor = bbtm.a().a().getSharedPreferences("showTost_pf", 0).edit();
  ...
  {
    bcds.c("TIME-STATISTIC", "MyAppApi--startToWebView");
    if (paramBundle == null) {
      return false;
    }
  ...
  {
    bcds.c("TIME-STATISTIC", "MyAppApi--startToAppDetail ");
    if (paramBundle == null) {
      return false;
    }
    if (TMAssistantCallYYB_V1.getQQDownloadApiLevel(paramContext) >= 6) {
    ...
    TMAssistantCallYYBParamStruct localTMAssistantCallYYBParamStruct = a(paramBundle);
    if (!bcgh.b(localTMAssistantCallYYBParamStruct.SNGAppId)) {
      return false;
    }
    boolean bool = bcgg.d();
    long l = bbtm.a().a();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        {
          bcds.b("MyAppApi", "startToAppDetail err", paramContext);
          return false;
        }
        localObject = new bcdz();
        ((bcdz)localObject).a(new bchc(this, (bcdz)localObject, localTMAssistantCallYYBParamStruct, paramBundle, l, paramContext, paramBoolean1, paramBoolean2));
        if ((paramContext instanceof BaseActivity)) {
          ((bcdz)localObject).a(((BaseActivity)paramContext).getAppRuntime(), 710020706L, "com.tencent.android.qqdownloader");
        }
        return true;
  ...
  public long b(Bundle paramBundle)
  {
    try
    {
      bcds.c("MyAppApi", "--addDownloadTaskFromAppDetail--params = " + paramBundle);
      if (paramBundle == null) {
        return -1L;
      }
  ...
  {
    bcds.c("MyAppApi", "--addDownloadTaskFromAppDetail--params = " + paramBundle + "autoDownload = " + paramBoolean1);
    if (paramBundle == null) {
      return -1L;
    }
    paramBundle = a(paramBundle);
  ...
  public void b(Activity paramActivity)
  {
    ...
    bcds.c("MyAppApi", "judgeInstallFlag -- mInstalledFlag = " + this.jdField_a_of_type_Boolean + "mInstallTime = " + this.jdField_b_of_type_Long + " countTime =" + l);
    int i;
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) && (i == 0))
      {
        ...
        if (this.jdField_a_of_type_Bchm != null)
        {
          if (this.jdField_a_of_type_Bchm.jdField_a_of_type_Int != 0) {
            break label350;
          }
          a(paramActivity, this.jdField_a_of_type_Bchm.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_Bchm.jdField_a_of_type_Boolean, this.jdField_a_of_type_Bchm.jdField_b_of_type_Boolean);
        }
      }
    }
    for (;;)
    {
      ...
      {
        paramActivity = bbtm.a().a().getSharedPreferences("showTost_pf", 0);
      ...
      if (this.jdField_d_of_type_Boolean)
      {
        ...
        this.jdField_d_of_type_Boolean = false;
        paramActivity = bbtm.a().a().getSharedPreferences("showTost_pf", 0).edit();
      ...
      {
        label404:
        if (new File(bbtm.a().a().getFilesDir() + File.separator + "yyb_via_info.txt").exists()) {
          bbtm.a().a().deleteFile("yyb_via_info.txt");
        }
        label464:
        if ((this.jdField_b_of_type_Boolean) || (i != 0)) {
          continue;
  ...
  public void b(Activity paramActivity, Bundle paramBundle, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    catch (Exception localException)
    {
      ...
      paramOnClickListener.onClick(null, 0);
      bcfb.a("202", str2, localException);
      return;
      if ((!bcgg.h()) && (j == 0)) {
        break label331;
      }
      ...
      for (;;)
      {
        paramActivity = bcfb.a(str2, "YYB");
        if ((localDownloadInfo != null) || ((m != 2) && (m != 12))) {
          break;
        }
        bcfb.a("202", paramActivity, localException);
        return;
        a(paramActivity, paramBundle, bool1, bool2);
      }
      bcfb.a("200", paramActivity, localException);
      return;
      if (paramOnClickListener == null) {
        break label343;
      }
      paramOnClickListener.onClick(null, 0);
      bcfb.a("200", str2, localException);
    }
    bool1 = paramBundle.getBoolean(bcgl.g, false);
    bool2 = paramBundle.getBoolean(bcgl.jdField_h_of_type_JavaLangString, true);
    k = paramBundle.getInt(bcgl.n);
    m = paramBundle.getInt(bcgl.k);
    bool3 = bcgg.e();
    bool4 = bcgg.g();
    str1 = paramBundle.getString(bcgl.b);
    str2 = paramBundle.getString(bcgl.i);
    localDownloadInfo = bcgo.a().a(str1);
    if ((localDownloadInfo != null) && (localDownloadInfo.jdField_c_of_type_Int == 1))
    {
      j = 1;
      bcds.c("OpenConfig-MyAppApi", " useMyAppFlag = " + bool3);
      if (((bool3) && (bool4)) || (j != 0)) {
        break label209;
      }
      if (paramOnClickListener != null) {
  ...
  public void b(String paramString, DialogInterface.OnClickListener paramOnClickListener, Activity paramActivity)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        str3 = localJSONObject.optString("appName", ajjy.a(2131641261));
        ...
        localBundle.putString(bcgl.jdField_c_of_type_JavaLangString, localJSONObject.optString("myAppid", ""));
        localBundle.putString(bcgl.jdField_d_of_type_JavaLangString, localJSONObject.optString("apkId"));
        localBundle.putInt(bcgl.e, i);
        localBundle.putString(bcgl.f, localJSONObject.optString("appPackageName"));
        localBundle.putString(bcgl.i, localJSONObject.optString("via"));
        localBundle.putString(bcgl.l, localJSONObject.optString("appName"));
        localBundle.putString(bcgl.z, localJSONObject.optString("channelId"));
        localBundle.putString(bcgl.B, localJSONObject.optString("channel"));
        localBundle.putString(bcgl.v, localJSONObject.optString("uin"));
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          boolean bool = bcgg.a();
          localObject1 = new bchg(this, localBundle, bool, paramActivity, str2, paramOnClickListener, str1);
          paramOnClickListener = new bchk(this, paramOnClickListener, str2, str1);
          localObject2 = new bchj(this, str2, str1);
          localBundle.putString(bcgl.p, paramString);
      ...
      paramString = str3 + ajjy.a(2131641258);
    }
  }
  ...
  public boolean b()
  {
    ...
    {
      bcds.c("MyAppApi", "hasValidQQDownloader>>>", localException);
    }
    return false;
  }
  ...
  public boolean b(Context paramContext, Bundle paramBundle)
  {
    ...
    bcds.c("TIME-STATISTIC", "mDownloadSdk.startToDownloadListWithParams");
  ...
  {
    new bchz(paramActivity, null).execute(new Void[0]);
  }
  
  public boolean c()
  {
    return (b()) && (bcgg.e()) && (bcgg.h());
  }
  ...
  protected void d()
  {
    ...
    bchh localbchh = new bchh(this);
    bbtm.a().a().registerReceiver(localbchh, localIntentFilter);
  }
  ...
  public void h()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        try
        {
          jdField_a_of_type_Bchb = null;
          return;
        }
        finally {}
        localException = localException;
        bcds.a("MyAppApi", "onDestroy>>>", localException);
      }
    }
  }
}
