...
public class andw
{
  ...
  public static CopyOnWriteArrayList<WeakReference<andx>> a;
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (andx)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((andx)localObject2).a(paramInt);
          }
        }
      }
    }
  ...
  public static void a(andx paramandx)
  {
    if (paramandx == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((localWeakReference != null) && (paramandx == localWeakReference.get()))
            {
              QLog.i("ApolloSoLoader", 1, "already add, cb:" + paramandx);
              break;
            }
          }
        }
      ...
      jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramandx));
    }
  }
  ...
  public static void a(String paramString)
  {
    ...
    if ((jdField_d_of_type_Boolean) && (amhd.a(BaseApplicationImpl.getContext()))) {}
    ...
    for (;;)
    {
      ...
      synchronized (bkgc.a)
      {
        ...
        if (i < j)
        {
          ...
          anaw.a(10, 300, new Object[] { "load [" + ((File)localObject1).getAbsolutePath() + "]" });
        }
      }
      return;
      label223:
  ...
  /* Error */
  public static void b(andx paramandx)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: aload_0
    //   4: ifnull +14 -> 18
    //   7: getstatic 70	andw:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   20: monitorexit
    //   21: return
    //   22: getstatic 70	andw:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   57: if_acmpne -28 -> 29
    //   60: getstatic 70	andw:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: aload_3
  ...
  public static boolean b()
  {
    ...
    try
    {
      ...
      {
        str3 = arrayOfString[i];
        bool = bgmg.d(str2 + "/" + str3);
        if (!bool) {
          return false;
        }
        i += 1;
      }
      bgmg.a(bkgc.a(1), false);
      return true;
    }
  ...
  private static boolean b(int paramInt)
  {
    try
    {
      synchronized (bkgc.a)
      {
        File localFile1 = new File(bkgc.a(paramInt));
        String str1 = bkgc.a();
        if (localFile1.exists())
        {
          ...
          while (i < j)
          {
            ...
            if (jdField_e_of_type_Boolean) {
              anaw.a(10, 100, new Object[] { localStringBuilder.toString() });
            }
            if (!bool) {
              return false;
            }
          ...
          bgmg.a(localFile1.getAbsolutePath());
  ...
  private static void c(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (l < 120000L)
      {
        ...
        if (jdField_e_of_type_Boolean) {
          anaw.a(10, 200, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
        }
      }
    }
    do
    {
      do
      {
        return;
        if (jdField_e_of_type_Boolean) {
          anaw.a(10, 200, new Object[] { "startDownload:", Long.valueOf(l) });
        }
    ...
    anaw.a(10, 201, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
    return;
    jdField_a_of_type_Long = System.currentTimeMillis();
    if (jdField_e_of_type_Boolean) {
      anaw.a(10, 201, new Object[] { "startDownload:", Long.valueOf(l) });
    }
    arnu.a();
  }
  ...
  private static void f()
  {
    try
    {
      File localFile = new File(anhk.ba + "pddata/prd/early", "android.qq.apollo.js.839g1");
      if (!localFile.exists())
      {
        c(1);
        return;
      ...
      {
        bkgc.a(localFile.getAbsolutePath(), 1);
  ...
  private static boolean j()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bool1 = localSharedPreferences.getBoolean("is_handle_reinstall_android.qq.apollo.js.839g1", false);
        if ((jdField_f_of_type_Boolean) || ((bool1) && (str.equals("android.qq.apollo.js.839g1")))) {
          break label257;
        }
        if (str.equals("android.qq.apollo.js.839g1")) {
          break;
        }
        QLog.i("ApolloSoLoader", 1, "oldRes:" + str + ",newRes:" + "android.qq.apollo.js.839g1");
        if (k())
        {
          bool1 = false;
          if (bool1)
          {
            localSharedPreferences.edit().putBoolean("is_handle_reinstall_android.qq.apollo.js.839g1", true).commit();
          ...
          anaw.a(10, 100, new Object[] { "reinstall delete old so, oldRes:", str, ",newRes:", "android.qq.apollo.js.839g1" });
          return true;
        }
      }
      catch (Throwable localThrowable)
      {
        QLog.e("ApolloSoLoader", 1, localThrowable, new Object[0]);
        if (jdField_e_of_type_Boolean) {
          anaw.a(10, 100, new Object[] { "reinstall th:", localThrowable });
        }
        b();
        return false;
      }
  ...
  {
    String str1 = bkgc.a() + "libsava.so" + "." + "android.qq.apollo.js.839g1";
    if (new File(str1).exists())
    {
      QLog.i("ApolloSoLoader", 1, "Bingo, the latest sava has been predownloaded.");
      String str2 = bkgc.a() + "libsava.so";
      bgmg.d(str2);
      if (!bgmg.c(str1, str2))
      {
    ...
    for (;;)
    {
      try
      {
        if (ApolloGameUtil.a())
        {
          ...
          anaw.a(10, 300, 1002, new Object[] { "arch=x86" });
          break;
        }
        if (!UpdateArkSo.a(BaseApplicationImpl.getContext(), UpdateArkSo.a()))
        {
          ...
          anaw.a(10, 300, 1003, new Object[] { "png-armeabi-v7a load failed" });
          jdField_a_of_type_Boolean = true;
          break label531;
        }
        ...
        localObject = (arno)((AppInterface)localObject).getManager(77);
        if (localObject == null) {
          break label524;
        }
        ...
        localObject = ((arnu)localObject).a();
        if (localObject == null) {
          break label524;
        }
        i = ((XmlData)localObject).Version;
        QLog.i("ApolloSoLoader", 1, "[so info], str:android.qq.apollo.js.839g1,ver:" + i + ", IS_CPU_64_BIT=" + false);
        if (jdField_e_of_type_Boolean) {
          anaw.a(10, 300, new Object[] { "[so info], str:android.qq.apollo.js.839g1,ver:" + i });
        }
        if (a(jdField_d_of_type_ArrayOfJavaLangString))
        {
          ...
          anaw.a(10, 300, 0, new Object[] { "loadAllSo success" });
          break label533;
        }
      ...
      catch (Throwable localThrowable)
      {
        ...
        if (jdField_e_of_type_Boolean)
        {
          anaw.a(10, 300, 1004, new Object[] { "[loadAllSo], Something unexpected happened.", localThrowable });
          jdField_a_of_type_Boolean = true;
        }
        return false;
      }
      ...
      if (!AVSoUtils.a())
      {
        ...
        anaw.a(10, 299, 1005, new Object[] { "sharpp load fail" });
        return false;
      }
      anaw.a(10, 299, 0, new Object[0]);
      continue;
      label519:
      int i = 4;
      continue;
  ...
  private static boolean m()
  {
    ...
    boolean bool = new ancv(-1, 3, "", "").a();
    QLog.i("ApolloSoLoader", 1, "[isSavaSoExists], check result:" + bool);
    if (jdField_e_of_type_Boolean) {
      anaw.a(10, 100, new Object[] { "[isSavaSoExists], check result:" + bool });
    }
    return bool;
  }
  ...
  private static boolean n()
  {
    ...
    if ((BaseApplicationImpl.sProcessId == 2) || (BaseApplicationImpl.sProcessId == 8))
    {
      if (a(jdField_b_of_type_ArrayOfJavaLangString))
      {
        ...
        if (new File(bkgc.a() + "checkList_jsc").exists())
        {
          bool = new ancv(-1, 4, "", "").a();
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        for (;;)
        {
          try
          {
            synchronized (bkgc.a)
            {
              ...
              str3 = arrayOfString[i];
              bool = bgmg.d(str1 + "/" + str3, (String)localObject2 + str3);
              if (bool) {
                continue;
              }
              return false;
        ...
        {
          str3 = arrayOfString[i];
          bool = bgmg.d(str2 + "/" + str3, (String)localObject2 + str3);
          if (!bool) {
            return false;
          }
          i += 1;
  ...
  private static boolean o()
  {
    ...
    try
    {
      if (TextUtils.isEmpty(amhd.f)) {
        amhd.f = bgmg.b(new File(a("brick.js"), "brick.js"));
      }
      if (TextUtils.isEmpty(amhd.g)) {
        amhd.g = bgmg.b(new File(a("ticker.js"), "ticker.js"));
      }
      if (TextUtils.isEmpty(amhd.h)) {
        amhd.h = bgmg.b(new File(a("scene.js"), "scene.js"));
      }
      if (TextUtils.isEmpty(amhd.i)) {
        amhd.i = bgmg.b(new File(a("game.js"), "game.js"));
      }
      return true;
    }
    catch (Throwable localThrowable)
    {
      ...
      if (jdField_e_of_type_Boolean) {
        anaw.a(10, 100, new Object[] { "[initScriptLib], th:", localThrowable });
      }
      return false;
    }
    finally
