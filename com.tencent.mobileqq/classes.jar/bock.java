  ...
  extends ReportDialog
{
  ...
  private boco jdField_a_of_type_Boco;
  ...
  public bock(@NonNull Context paramContext, int paramInt, boco paramboco)
  {
    super(paramContext, paramInt);
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131558575, null);
    this.jdField_a_of_type_Boco = paramboco;
    f();
  ...
  private void b()
  {
    this.jdField_a_of_type_JavaLangString = getContext().getResources().getString(2131693759);
    this.jdField_b_of_type_JavaLangString = getContext().getResources().getString(2131691425);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131369356);
    this.c = this.jdField_a_of_type_AndroidViewView.findViewById(2131379929);
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131366269));
    this.jdField_a_of_type_OrgLibpagPAGView = ((PAGView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378518));
    this.jdField_a_of_type_OrgLibpagPAGView.play();
    this.jdField_a_of_type_OrgLibpagPAGView.setRepeatCount(0);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bocl(this));
    this.c.setOnClickListener(new bocm(this));
    e();
  ...
  private void b(TextEditorData paramTextEditorData)
  {
    if (paramTextEditorData == null)
    {
      bnrh.d("AEEditorTextEditDialog", "render PAV data null.");
      return;
    }
    ...
    {
      bnrh.d("AEEditorTextEditDialog", "render PAGFile null.");
      return;
    }
    PAGText localPAGText = localPAGFile.getTextData(0);
    if (localPAGText == null)
    {
      bnrh.d("AEEditorTextEditDialog", "pagText is null.");
      return;
    }
  ...
  private static void b(Map<String, Integer> paramMap, PAGView paramPAGView)
  {
    ...
    if (paramPAGView != null)
    {
      ...
      if (localPAGComposition == null) {
        bnrh.d("AEEditorTextEditDialog", "pagComposition null.");
      }
    }
    else
    {
  ...
  private void c()
  {
    if (this.jdField_a_of_type_ComTencentTavcutBeanTextEditorData == null)
    {
      bnrh.d("AEEditorTextEditDialog", "originTextData is null.");
      return;
    }
  ...
  private void d()
  {
    ...
    while (this.jdField_a_of_type_Boco == null) {
      return;
    }
    this.jdField_a_of_type_Boco.a(this.jdField_a_of_type_ComTencentTavcutBeanTextEditorData);
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bocn(this));
  }
