      ...
      do
      {
        do
        {
          do
          {
            ...
            new bbpx().a((AIOPictureData)localObject, paramInt2, paramString);
            return i;
          ...
          new bbpy().a((AIOVideoData)localObject, paramInt2, paramString);
          return i;
        ...
        new bbpt().a((AIOFilePictureData)localObject, paramInt2, paramString);
        return i;
