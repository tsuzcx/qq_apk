...
public class bbps
  extends bfmt
{
  public bbps(PendantInfo paramPendantInfo, Looper paramLooper, Handler.Callback paramCallback)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      if (this.a.r == 0)
      {
        this.a.jdField_a_of_type_Bbpt = null;
        return;
        label435:
        localBitmap.recycle();
      ...
      if (PendantInfo.g == l)
      {
        ...
        {
          localObject = (Drawable)paramMessage.next();
          if ((localObject != null) && ((localObject instanceof aczp))) {
            this.a.a((aczp)localObject, l);
          }
        }
        break;
      }
      paramMessage = (Drawable)this.a.jdField_a_of_type_ComTencentMobileqqVasPendantInfo$AnimationLruCache.get(Long.valueOf(l));
      if ((paramMessage == null) || (!(paramMessage instanceof aczp))) {
        break;
      }
      this.a.a((aczp)paramMessage, l);
      return;
    }
  }
}
