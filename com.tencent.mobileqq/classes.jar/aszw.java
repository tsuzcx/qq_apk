...
public class aszw
  implements bkzq
{
  public aszw(UniformDownloadActivity paramUniformDownloadActivity) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (paramView != null)
    {
      paramView = this.a.jdField_a_of_type_Bkzi.a(paramInt);
      if (!TextUtils.isEmpty(paramView))
      {
        if ((!paramView.equals(this.a.getResources().getString(2131691783))) && (!paramView.equals(this.a.getResources().getString(2131691784)))) {
          break label270;
        }
        bdla.b(null, "dc00898", "", "", "0X8008F87", "0X8008F87", 1, 0, "", "", "", "");
        ...
        bjme.a().a(UniformDownloadActivity.a(this.a), "1", "ANDROIDQQ.POPUP.YYBDOWNAPP", "3007", false);
    ...
    for (;;)
    {
      ...
      continue;
      label270:
      if ((paramView.equals(this.a.getResources().getString(2131691782))) || (paramView.equals(this.a.getResources().getString(2131690116))) || (paramView.equals(this.a.getResources().getString(2131690115)))) {
        UniformDownloadActivity.c(this.a);
      }
    }
  }
