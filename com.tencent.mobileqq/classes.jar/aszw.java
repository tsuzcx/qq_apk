...
final class aszw
  implements atas
{
  aszw(QQAppInterface paramQQAppInterface) {}
  ...
  public String a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, long paramLong1, long paramLong2, long paramLong3, int paramInt3)
  {
    ...
    long l = 0L;
    paramInt1 = aszt.a(paramString1.jdField_a_of_type_JavaLangString);
    if ((FileUtil.isFileExists(paramString1.jdField_a_of_type_JavaLangString)) && ((paramInt1 == 0) || (paramInt1 == 2))) {
      if (paramInt1 == 0)
      {
        ...
        paramLong1 = bfby.a(this.a, paramString2, paramString1.g, paramString1.c, paramString1.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, String.valueOf(paramString1.b), paramLong2, paramString3.outWidth, paramString3.outHeight, paramLong3, paramInt3);
      }
    }
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        paramLong1 = bfby.a(this.a, paramString2, paramString1.g, paramString1.c, paramString1.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, String.valueOf(paramString1.b), paramLong2, paramString3[0], paramString3[1], paramString3[2], paramLong3, paramInt3);
        continue;
        if (localFileManagerEntity != null) {
          paramLong1 = bfby.a(this.a, paramString2, paramString4, paramLong1, paramString1.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, String.valueOf(8888L), paramLong2, localFileManagerEntity.imgWidth, localFileManagerEntity.imgHeight, 0, paramLong3, paramInt3);
        } else {
          paramLong1 = bfby.a(this.a, paramString2, paramString4, paramLong1, paramString1.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, String.valueOf(8888L), paramLong2, paramLong3, paramInt3);
        }
      }
    }
  }
