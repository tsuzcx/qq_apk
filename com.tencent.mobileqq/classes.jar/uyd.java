...
public class uyd
{
  private static void a(int paramInt, uwy paramuwy)
  {
    if (paramuwy == null) {
      return;
    }
    WSPublicAccReport.getInstance().reportShareClick(paramuwy.c, paramInt, paramuwy.jdField_a_of_type_JavaLangString, paramuwy.jdField_b_of_type_JavaLangString, paramuwy.jdField_a_of_type_UserGrowthStSimpleMetaFeed);
  }
  
  public static void a(stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt1, int paramInt2)
  {
    bhzt.a().a(2131719675);
    paramstSimpleMetaFeed = uvi.a(paramstSimpleMetaFeed, paramInt1);
    paramstSimpleMetaFeed.dislike_reason = "用户手动点击不感兴趣";
    uvi.a(8, paramInt2, paramstSimpleMetaFeed);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString4))
    {
      ...
      paramString2.putExtra("app_name", amtj.a(2131715932));
      paramString2.putExtra("image_url_remote", paramString3);
      paramString2.putExtra("desc", amtj.a(2131715931));
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    ((Intent)localObject).putExtra("app_name", amtj.a(2131715932));
    ((Intent)localObject).putExtra("image_url_remote", paramString2);
    ((Intent)localObject).putExtra("desc", amtj.a(2131715931));
    ...
    atky.a(paramContext, (Intent)localObject, ForwardRecentTranslucentActivity.class, 1);
  }
  ...
  public static void a(Context paramContext, uwy paramuwy)
  {
    if (uyo.b()) {
      return;
    }
    ...
    if ((paramuwy != null) && (paramuwy.jdField_a_of_type_UserGrowthStSimpleMetaFeed != null) && (paramuwy.jdField_a_of_type_UserGrowthStSimpleMetaFeed.gdt_ad_type == 1) && (paramuwy.jdField_a_of_type_UserGrowthStSimpleMetaFeed.gdt_ad_info != null))
    {
    ...
    for (;;)
    {
      ((ShareActionSheet)localObject).setItemClickListenerV2(new uyg(paramContext, paramuwy));
      ...
      ((ShareActionSheet)localObject).setOnShowListener(new uyh(paramuwy));
      ((ShareActionSheet)localObject).setCancelListener(new uyi(paramuwy));
      ((ShareActionSheet)localObject).setOnDismissListener(new uyj(paramuwy));
      ((ShareActionSheet)localObject).show();
      return;
      ((ShareActionSheet)localObject).setActionSheetTitle(paramContext.getString(2131692584));
      localArrayList1 = new ArrayList();
      localArrayList2 = new ArrayList();
      localArrayList1.add(ShareActionSheetBuilder.ActionSheetItem.build(2));
      localArrayList1.add(ShareActionSheetBuilder.ActionSheetItem.build(3));
  ...
  private static void b(Context paramContext, ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem, uwy paramuwy)
  {
    ...
    do
    {
      ...
      do
      {
          ...
          do
          {
            ...
            do
            {
              ...
              do
              {
                ...
                {
                  return;
                  localstSimpleMetaFeed = paramuwy.jdField_a_of_type_UserGrowthStSimpleMetaFeed;
                } while ((localstSimpleMetaFeed == null) || (localstSimpleMetaFeed.share_info == null));
                str1 = localstSimpleMetaFeed.share_info.jump_url;
                k = paramuwy.jdField_b_of_type_Int;
                m = paramuwy.jdField_a_of_type_Int;
                localObject1 = null;
                localObject2 = null;
                localObject3 = null;
                localObject4 = null;
        ...
        catch (Exception paramContext)
        {
          ...
          uya.d("WeishiShareUtil", "shareToQzone error:" + paramContext);
          return;
        }
    ...
    return;
    a(1003012, paramuwy);
    bhzt.a().a("已收到你的举报，我们会及时处理");
    paramContext = uvi.a(localstSimpleMetaFeed, k);
    paramContext.jubao_reason = "用户手动点击举报";
    uvi.a(116, m, paramContext);
    return;
    a(1003008, paramuwy);
    a(localstSimpleMetaFeed, k, m);
    return;
    var.a(paramContext, 131072, localstSimpleMetaFeed, k);
  }
  ...
  private static void b(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      WXShareHelper.getInstance().addObserver(new uyf());
      return;
  ...
  public static void b(Context paramContext, uwy paramuwy)
  {
    if (uyo.b()) {
      return;
    }
    ...
    localArrayList2.add(ShareActionSheetBuilder.ActionSheetItem.build(44));
    ((ShareActionSheet)localObject).setItemClickListenerV2(new uyk(paramContext, paramuwy));
    ((ShareActionSheet)localObject).setActionSheetItems(localArrayList1, localArrayList2);
    ((ShareActionSheet)localObject).setRowVisibility(8, 8, 0);
    paramContext = (Activity)paramContext;
    if (paramContext != null)
    ...
    ((ShareActionSheet)localObject).setOnShowListener(new uyl(paramuwy));
    ((ShareActionSheet)localObject).setCancelListener(new uym(paramuwy));
    ((ShareActionSheet)localObject).setOnDismissListener(new uye(paramuwy));
    ((ShareActionSheet)localObject).show();
  }
  
  private static void c(uwy paramuwy)
  {
    if ((paramuwy != null) && (paramuwy.a() != null)) {
      paramuwy.a().b(2);
    }
  }
  
  private static void d(uwy paramuwy)
  {
    if ((paramuwy != null) && (paramuwy.a() != null)) {
      paramuwy.a().c(2);
    }
