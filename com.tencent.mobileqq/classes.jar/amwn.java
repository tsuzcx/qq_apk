    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          azmz.a(BaseApplication.getContext()).a("", "AndroidARException", true, 0L, 0L, (HashMap)localObject1, "", true);
          continue;
        }
      ...
      if (localJSONObject1.has("traversing360")) {
        paramString.jdField_a_of_type_Amos = amos.a(localJSONObject1.getJSONObject("traversing360"));
      }
