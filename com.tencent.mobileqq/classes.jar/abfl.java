...
public abstract class abfl
  extends abgh
  implements abfy, bkij, bkik, bkil, bkks, bkkt
{
  protected abfk a;
  protected abfp a;
  protected abfx a;
  ...
  public abfl(Activity paramActivity, abfp paramabfp)
  {
    this.jdField_a_of_type_Abfy = new abfm(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Abfp = paramabfp;
  }
  
  protected abfk a(Context paramContext)
  {
    return new abgd();
  }
  ...
  protected RelativeLayout a()
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131561369, null);
  }
  ...
  {
    if ((this.jdField_a_of_type_Abfx != null) && (this.jdField_a_of_type_Abfx.a())) {
      this.jdField_a_of_type_Abfx.b();
    }
    if ((this.jdField_a_of_type_Abfx != null) && (this.jdField_a_of_type_Abfx.b())) {
      this.jdField_a_of_type_Abfx.c();
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      b((ViewGroup)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376788));
      this.jdField_a_of_type_ComTencentWidgetGallery = ((Gallery)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131367288));
      this.d = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363219);
      this.jdField_a_of_type_Abfk = a(this.jdField_a_of_type_AndroidAppActivity);
      if (this.jdField_a_of_type_Abfk != null) {
        this.jdField_a_of_type_Abfk.a(this.jdField_a_of_type_AndroidAppActivity, this, this.b);
      }
      this.jdField_a_of_type_Abfx = a();
      if (this.jdField_a_of_type_Abfx != null) {
        this.jdField_a_of_type_Abfx.a(this.jdField_a_of_type_AndroidAppActivity, this);
      }
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter = a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Abfp);
      if (this.jdField_a_of_type_Abfx != null)
      {
        this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Abfx);
        this.jdField_a_of_type_Abfx.a();
      }
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setSpacing(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131297079));
      this.jdField_a_of_type_ComTencentWidgetGallery.setSelection(this.jdField_a_of_type_Abfp.b());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Abgc.a().a());
    ...
    localAlphaAnimation.setAnimationListener(new abfn(this));
  ...
  public void b(boolean paramBoolean)
  {
    if (b())
    {
      a(paramBoolean, this.jdField_a_of_type_Abgc.a().b());
      return;
    }
  ...
  public void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setInterpolator(new bkgl());
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Abgc.a().a());
    ...
    localScaleAnimation.setDuration(this.jdField_a_of_type_Abgc.a().a());
    AnimationSet localAnimationSet = new AnimationSet(true);
    localAnimationSet.setFillAfter(true);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.setAnimationListener(new abfo(this));
    this.d.startAnimation(localAlphaAnimation);
  ...
  public boolean d()
  {
    return this.jdField_a_of_type_Abgc.a().a();
  }
  ...
  public boolean e()
  {
    ...
    if (c()) {
      b(false, this.jdField_a_of_type_Abgc.a().c());
    }
    for (;;)
    {
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Abfk != null) && (a())) {
        this.jdField_a_of_type_Abfk.a(paramAdapterView, paramInt);
      }
      this.jdField_a_of_type_Abfp.a(paramInt);
      if ((!d()) && (this.jdField_a_of_type_Abfx != null) && (!this.jdField_a_of_type_Abfx.a())) {
        this.jdField_a_of_type_Abfx.a();
      }
  ...
  public void q()
  {
    if (this.jdField_a_of_type_Abgc.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Abgc.jdField_a_of_type_Boolean = false;
      return;
    }
    b(true, this.jdField_a_of_type_Abgc.jdField_a_of_type_Abfj.c());
  }
