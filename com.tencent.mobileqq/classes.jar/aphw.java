  ...
  implements apar
{
  ...
  private aphw(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, aphx paramaphx, apib paramapib)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, 0, paramaphx, paramapib);
  ...
  public static apar a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, aphx paramaphx, apib paramapib)
  {
    if (paramaphx == null) {
    ...
    return null;
    return new aphw(paramQQAppInterface, paramLong1, paramLong2, paramaphx, paramapib);
  }
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Aozz != null) {
      this.jdField_a_of_type_Aozz.a(paramLong1);
    }
  }
  
  public void a(aozz paramaozz)
  {
    this.jdField_a_of_type_Aozz = paramaozz;
  }
  ...
  protected void a(ExcitingTransferUploadBizInfo paramExcitingTransferUploadBizInfo)
  {
    ...
    if ((this.jdField_a_of_type_Aphy instanceof aphx))
    {
      aphx localaphx = (aphx)this.jdField_a_of_type_Aphy;
      paramExcitingTransferUploadBizInfo.bufUuid = localaphx.a;
      paramExcitingTransferUploadBizInfo.bufUploadKey = localaphx.b;
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_Aphy.a(paramArrayOfByte);
    b();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    e();
    b(null);
    if ((this.jdField_a_of_type_Aphy.d() == null) || (this.jdField_a_of_type_Aphy.d().length == 0))
    {
      if (this.jdField_a_of_type_Aozz != null)
      {
        Bundle localBundle = new Bundle();
        byte[] arrayOfByte = this.jdField_a_of_type_Aozz.a(localBundle);
        ...
        this.jdField_a_of_type_Aphy.a(arrayOfByte);
      }
    }
    else {
      return b();
  ...
  protected void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    for (String str = paramExcitingTransferUploadResultRp.m_strFileUrl;; str = "")
    {
      ...
      paramInt = a(paramInt);
      if (this.jdField_a_of_type_Aozz != null) {
        this.jdField_a_of_type_Aozz.a(true, this.c, paramInt, "", "");
      }
      return;
    }
  }
