  ...
  extends alpd
{
  ...
  public long a;
  private axsq jdField_a_of_type_Axsq = new axsq(paramAppInterface, this.jdField_a_of_type_Axxq);
  private axxq jdField_a_of_type_Axxq = new axxq();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  
  public axxr(AppInterface paramAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        localObject2 = new axsr(str, j);
        ((axsr)localObject2).d = i;
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Axxq.b())
        {
          this.jdField_a_of_type_Axxq.a(2);
          paramArrayOfByte1 = (axsr)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Axsq.a(paramArrayOfByte2);
          this.jdField_a_of_type_Axsq.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Axxq.a(0);
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Axxq.d())
        {
          ...
          this.jdField_a_of_type_Axsq.a(paramLong);
          return;
        }
        ...
        {
          this.jdField_a_of_type_Axxq.c(4);
          return;
        }
      } while (!this.jdField_a_of_type_Axxq.g());
      this.jdField_a_of_type_Axxq.c(4);
      return;
    } while (this.jdField_a_of_type_Axxq.c());
    this.jdField_a_of_type_Axxq.c(4);
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Axxq.c();
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Axsq.a()) {
          break label200;
        }
        if (!QLog.isColorLevel()) {
          break;
    ...
    label200:
    this.jdField_a_of_type_Axsq.a(paramString1);
  }
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            if (!this.jdField_a_of_type_Axxq.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Axxq.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Axxq.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Axsq.a())
            {
              ...
              this.jdField_a_of_type_Axxq.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Axxq.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
