...
public class aqsy
  implements RecyclerView.ItemAnimator.ItemAnimatorFinishedListener, View.OnClickListener, aqtk
{
  private static int jdField_a_of_type_Int = 2131167317;
  private static int jdField_b_of_type_Int = 2131167302;
  private static int jdField_c_of_type_Int = 2130839262;
  ...
  private aqst jdField_a_of_type_Aqst;
  ...
  public aqsy(Context paramContext, aqtk paramaqtk)
  {
  ...
  {
    f();
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558915, null);
    this.jdField_a_of_type_ComTencentMobileqqColornoteListColorNoteListLayout = ((ColorNoteListLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364714));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364718));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363657));
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131364717));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new aqsz(this));
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(new aqta(this));
    localObject = new aqtb(this);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener((View.OnTouchListener)localObject);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131363657).setOnTouchListener((View.OnTouchListener)localObject);
  ...
  private void e()
  {
    ...
    {
      localViewPropertyAnimator.translationX(f).setDuration(180L).setListener(new aqtg(this)).start();
      return;
    }
  }
  ...
  private void f()
  {
    if (ThemeUtil.isNowThemeIsNight(null, false, null))
    {
      ...
      jdField_c_of_type_Int = 2130839263;
      return;
    }
    jdField_a_of_type_Int = 2131167317;
    jdField_b_of_type_Int = 2131167302;
    jdField_c_of_type_Int = 2130839262;
  }
  ...
  {
    this.jdField_a_of_type_Aqst.a(paramList);
    a();
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    d();
    this.jdField_a_of_type_Aqst = new aqst();
    this.jdField_a_of_type_Aqst.a(this);
    this.jdField_a_of_type_Aqst.a(paramBoolean);
    Object localObject1 = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a().a().a();
    this.jdField_a_of_type_Aqst.a((List)localObject1);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Aqst);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setVisibility(4);
    this.jdField_a_of_type_Aqst.a(new aqtc(this));
    Object localObject2;
    if (((List)localObject1).size() > 0)
    {
      localObject2 = (ColorNote)((List)localObject1).get(0);
      if (aqsd.b((ColorNote)localObject2)) {
        bdll.b(null, "dc00898", "", "", "0X800A8AA", "0X800A8AA", aqrd.b(aqsd.a(((ColorNote)localObject2).getServiceType())), 0, "", "", "", "");
      }
    }
    ...
    this.jdField_a_of_type_AndroidViewView.animate().alpha(0.9F).setDuration(200L).setListener(new aqtf(this, paramBoolean)).start();
    ...
    for (paramInt2 = i;; paramInt2 = i)
    {
      ...
      paramInt1 = i;
      break;
      bdll.b(null, "dc00898", "", "", "0X800A6CD", "0X800A6CD", 0, 0, ((List)localObject1).size() + "", aqrd.a(paramInt1) + "", "", "");
      localObject1 = ((List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (ColorNote)((Iterator)localObject1).next();
        if (aqsd.d((ColorNote)localObject2))
        {
          localObject3 = aixg.a((ColorNote)localObject2);
          if (aqsd.c((ColorNote)localObject2)) {}
          for (paramInt1 = 1;; paramInt1 = 2)
          {
            bdll.b(null, "dc00898", "", "", "0X800AE8E", "0X800AE8E", paramInt1, ((UpComingMsgModel)localObject3).reportType, "", "", "", "");
            break;
          }
        }
      }
  ...
  {
    if (this.jdField_a_of_type_Aqst.getItemCount() == 0) {
      e();
    }
  }
