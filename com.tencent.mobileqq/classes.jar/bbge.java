  ...
  implements bbmv
{
  ...
  public bbge(String paramString, int paramInt, bbgd parambbgd)
  {
  ...
  private boolean b()
  {
    return (c()) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_a_of_type_Bbgd != null);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.e = 0;
        if ((!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_Bbmt != null)) {
          continue;
        }
        this.jdField_a_of_type_Bbmt = new bbmt();
        this.jdField_a_of_type_Bbmt.a(CodecParam.mAudioSampleRate);
        this.jdField_a_of_type_Bbmt.a(this);
        this.jdField_a_of_type_Bbmt.a(this.jdField_b_of_type_JavaLangString);
        bnrh.a("AudioChangerManager", "New mHwAudioEncoder");
        return;
      }
      ...
      for (;;)
      {
        ...
        if (localObject != null) {
          try
          {
            ...
            if ((this.jdField_a_of_type_Bbmt != null) && (this.jdField_b_of_type_Boolean))
            {
  ...
  public void b()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bbmt != null) {
        this.jdField_a_of_type_Bbmt.c();
      }
      if (!this.jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Bbgd.onAudioChangeCaptured(this.jdField_c_of_type_JavaLangString);
      }
      return;
    }
    catch (IOException localIOException)
  ...
  public void h()
  {
    bnrh.a("AudioChangerManager", "[onAudioFileEncoded]");
    this.jdField_a_of_type_Bbgd.onAudioChangeCaptured(this.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_Bbmt = null;
  }
  
  public void i()
  {
    bnrh.a("AudioChangerManager", "[onAudioFileEncodeFailed]");
