  ...
  extends pnb
{
  ...
  {
    return ajed.aU + ".readInjoy/skin_res/";
  }
  
  public static String a(String paramString)
  {
    return ajed.aU + ".readInjoy/skin_res/" + paramString;
  }
  ...
  public static JSONObject a()
  {
    ...
    try
    {
      jdField_a_of_type_OrgJsonJSONObject = new JSONObject(bace.b(new File(b() + "/colors.json")));
  ...
  public static void a()
  {
    ...
    try
    {
      String str = bace.b(new File(c() + "refreshConfig.json"));
      localObject = str;
  ...
  {
    return axbo.a(new File(a(paramString)));
  }
  ...
  {
    return ajed.aU + ".readInjoy/skin_res/" + jdField_a_of_type_JavaLangString;
  }
  ...
  public Drawable a(String paramString)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject1).mPlayGifImage = atra.a(paramString.getAbsolutePath());
