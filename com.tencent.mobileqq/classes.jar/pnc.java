...
public class pnc
  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, tcb, tcc
{
  public int a;
  private int[] a;
  private int c = -1;
  ...
  public pnc(ReadInJoyChannelPanelFragment paramReadInJoyChannelPanelFragment, Context paramContext, int paramInt1, int paramInt2)
  {
  ...
  private void a(int paramInt, TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      ...
      try
      {
        ReadInJoyChannelPanelFragment.a("0X800949C", new pbg().b().a(paramTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramTabChannelCoverInfo)).a());
    ...
    for (paramTabChannelCoverInfo.channelConfigType = ((rcp)ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment).get(1)).a;; paramTabChannelCoverInfo.channelConfigType = paramTabChannelCoverInfo.sectionId)
    {
      localReadInJoyStaticGridView.a(localReadInJoyStaticGridView.getAdapter().getCount() - 1, 0, paramTabChannelCoverInfo);
      paramTabChannelCoverInfo = new pnd(this, localReadInJoyStaticGridView);
      localReadInJoyStaticGridView.setTag(2131375910, paramTabChannelCoverInfo);
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = new rdx();
        ((rcn)localObject).a = ((TabChannelCoverInfo)localList.get(i));
        ((rcn)localObject).l = i;
        ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (rcn)localObject, this.d);
        i += 1;
      }
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949B", new pbg().b().a(localTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(localTabChannelCoverInfo)).a());
      this.c = -1;
      return;
    }
    catch (JSONException localJSONException)
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, 2131560229), null);
      localpne = new pne(this);
      localpne.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369975));
      localpne.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView = ((AutoFitTextView)paramView.findViewById(2131364386));
      localpne.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376186));
      localpne.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376191));
      localpne.b = ((ImageView)paramView.findViewById(2131365403));
      localpne.b.setOnClickListener(this);
      localpne.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setOnGetMaxWidthCallback(localpne);
      localpne.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView = ((KanDianUrlRoundCornerImageView)paramView.findViewById(2131369264));
      if (localpne.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView != null) {
        localpne.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView.setCorner(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment));
      }
      paramView.setTag(localpne);
    }
    for (;;)
    {
      paramView.setAlpha(1.0F);
      localpne.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setText(((TabChannelCoverInfo)localObject).mChannelCoverName);
      localpne.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setTextColor(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (TabChannelCoverInfo)localObject));
      ImageView localImageView = localpne.b;
      int i;
      if (ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment))
      {
        ...
        localpne.b.setTag(localObject);
        localpne.b.setTag(2131375960, Integer.valueOf(paramInt));
        if ((paramInt < this.jdField_a_of_type_Int) && (ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)))
        {
          ...
          localpne.b.setVisibility(8);
        }
        if (!ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)) {
          break label413;
        }
        localpne.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        localpne.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        if ((localpne.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView == null) || (!pch.a())) {}
      }
      try
      {
        localObject = new URL(((TabChannelCoverInfo)localObject).mChannelCoverIcon);
        pai.a(localpne.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView, (URL)localObject, paramView.getContext());
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localpne = (pne)paramView.getTag();
        continue;
        i = 8;
        break label239;
        label413:
        localImageView = localpne.jdField_a_of_type_AndroidWidgetImageView;
        ...
        for (i = 0;; i = 8)
        {
          ...
          localpne.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (TabChannelCoverInfo)localObject, localpne.jdField_a_of_type_AndroidWidgetTextView);
          break;
        }
        label493:
        localpne.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      int i = ((Integer)paramView.getTag(2131375960)).intValue();
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (!ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)) {
      try
      {
        ReadInJoyChannelPanelFragment.a("0X8009499", new pbg().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).n(ReadInJoyChannelPanelFragment.a(paramAdapterView)).c((int)paramAdapterView.sectionId).b("style", 1).a());
        ...
        if (bkwm.B())
        {
          pkm.a().a(paramAdapterView.mChannelCoverId, 3, false, true);
          pay.b().post(new ReadInJoyChannelPanelFragment.DynamicGridViewAdapter.1(this, paramAdapterView));
          return;
        }
      }
      catch (JSONException paramView)
      {
        for (;;)
        {
          ...
          continue;
          pkm.a().b(paramAdapterView.mChannelCoverId, 3);
        }
      }
    }
  ...
  public boolean onItemLongClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949A", new pbg().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).a());
      return true;
    }
