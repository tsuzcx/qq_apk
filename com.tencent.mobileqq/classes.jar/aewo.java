  ...
  implements URLDrawableDownListener
{
  ...
  public void onLoadSuccessed(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    aewn.a(this.a, paramURLDrawable, l1);
    paramView = paramView.getTag();
    if (aexd.b((aewh)paramView))
    {
      paramView = (aewx)paramView;
      if ((aexd.b(paramView)) && (!aewn.a(this.a).contains(paramView.j())))
      {
        aewn.a(this.a).add(paramView.j());
        paramURLDrawable = paramView.l();
        aewn.a(this.a).add(new StickerRecCacheEntity(paramURLDrawable, System.currentTimeMillis(), paramView.j()));
      }
    }
  }
}
