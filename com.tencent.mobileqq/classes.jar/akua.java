  ...
  implements Manager
{
  ...
  public int a;
  private akoe jdField_a_of_type_Akoe;
  ...
  private CopyOnWriteArrayList<aktr> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public akua(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    QLog.i("cmgame_process.CmGameManager", 1, "[CmGameManager] created.");
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = new ApolloCmdChannel(akro.a());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new akuc();
  ...
  public akoe a()
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 379	akua:jdField_a_of_type_Akoe	Lakoe;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 381	akoe
    //   28: dup
    //   29: invokespecial 382	akoe:<init>	()V
    //   32: putfield 379	akua:jdField_a_of_type_Akoe	Lakoe;
    ...
    //   50: aload_0
    //   51: getfield 379	akua:jdField_a_of_type_Akoe	Lakoe;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
  ...
  public aktr a()
  {
    ...
    {
      aktr localaktr = (aktr)localIterator.next();
      if ((localaktr != null) && (!akro.a(localaktr.a())) && (!akro.b(localaktr.a()))) {
        return localaktr;
      }
    }
    return null;
  ...
  public aktr a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      aktr localaktr = (aktr)localIterator.next();
      if ((localaktr != null) && (paramInt == localaktr.a())) {
        return localaktr;
      }
    }
    return null;
  ...
  public aktr a(int paramInt1, int paramInt2)
  {
    if (paramInt1 <= 0) {}
    for (;;)
    {
      ...
      aktr localaktr = new aktr(paramInt1);
      localaktr.d = paramInt2;
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, localaktr);
  ...
  /* Error */
  public aktr a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	akua:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   28: checkcast 390	aktr
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 423	aktr:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
  ...
  public List<akud> a()
  {
    ...
    Collections.sort(localArrayList, new akub(this));
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localakud != null) {
        if (localakud.jdField_a_of_type_JavaLangRefWeakReference == null)
        {
          localArrayList.add(localakud);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localakud.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localakud);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localakud = (akud)localIterator.next();
        if ((localakud != null) && (localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localakud.jdField_a_of_type_Int = 1;
          localakud.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localakud);
        }
      }
      for (;;)
      {
        ...
        localakud = new akud();
        localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localakud.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localakud.jdField_a_of_type_Int = 1;
        localakud.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localakud);
        return;
        localakud = null;
      }
    }
  ...
  /* Error */
  public aktr b(int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 392	aktr:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 406	aktr:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 47	akua:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    ...
    //   89: aload_0
    //   90: getfield 47	akua:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localakud != null) && (localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localakud.jdField_a_of_type_Int = 2;
          localakud.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localakud.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localakud);
        }
      }
      for (paramActivity = localakud; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (akud)localIterator.next();
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      akpp.a();
      if (this.jdField_a_of_type_Akoe != null) {
        this.jdField_a_of_type_Akoe.a();
      }
      this.c = false;
      return;
    }
