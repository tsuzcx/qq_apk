  ...
  extends ajfb
{
  ...
  public ajex(QQAppInterface paramQQAppInterface)
  {
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      try
      {
        paramToServiceMsg = azgn.a(l, paramFromServiceMsg.opt_msg_record.get().toByteArray(), paramFromServiceMsg.uint32_cur_cnt.get());
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (ajqt)this.app.getManager(22);
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
    ...
    if (badq.a(this.app.getApplication().getApplicationContext()) == 1)
    {
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (j == 1)
      {
        ...
        if (i == 1224)
        {
          baig.j(this.app.getApplication().getApplicationContext(), this.app.getCurrentAccountUin(), (String)localObject2);
  ...
  {
    aynv localaynv = new aynv();
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      notifyUI(28, false, localaynv);
      return;
    }
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
  ...
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null)) {
      notifyUI(41, false, new Object[] { Integer.valueOf(2131630729) });
    }
    for (;;)
    {
      return;
    ...
    if (localObject != null) {
      ((ajtg)localObject).j(paramObject.troopuin);
    }
    localObject = (aynk)this.app.getManager(32);
    if (localObject != null) {
      ((aynk)localObject).a(this.app, paramObject.troopuin);
    }
    ...
    paramObject = (ajhh)this.app.getManager(53);
    ...
    notifyUI(41, true, new Object[] { Integer.valueOf(2131630736), paramToServiceMsg, paramFromServiceMsg, Boolean.valueOf(true) });
    return;
    label534:
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        if (i == 1328) {
          paramToServiceMsg[2] = ajjy.a(2131635361);
        }
  ...
  public void a(long paramLong1, int paramInt1, String paramString1, long paramLong2, List<String> paramList, int paramInt2, long paramLong3, long paramLong4, long paramLong5, String paramString2, String paramString3)
  {
    ...
    paramString1 = azrj.a(BaseApplicationImpl.getApplication()).a(BaseApplicationImpl.getApplication(), String.valueOf(localgroupinfo.uint32_group_class_ext.get()));
  ...
  public void a(String paramString1, int paramInt, @Nullable String paramString2)
  {
    ...
    if (baig.a(this.app.getApplication(), this.app.getCurrentAccountUin()).contains(str))
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (i == 0)
    {
      bbmy.a(BaseApplication.getContext(), 2131630710, 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131167766));
      return false;
    }
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      ...
                      if (i == 2)
                      {
                        ((azjh)this.app.getManager(48)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
                        return;
                      }
                      if (i == 3)
                      {
                ...
                paramToServiceMsg = (byte[])paramObject;
                paramToServiceMsg = azkm.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
              } while ((TextUtils.isEmpty(str)) || (paramToServiceMsg == null));
              short s = (short)paramToServiceMsg.length;
              if ("OidbSvc.0x852_35".equals(str))
              {
                azkm.a(this.app, i, l1, l2, s, paramToServiceMsg, l3, paramFromServiceMsg, j);
                return;
              }
              if ("OidbSvc.0x852_48".equals(str))
              {
                azkm.a(this.app, i, l1, l2, s, paramToServiceMsg, (short)k, bool);
                return;
              }
            } while (!"OidbSvc.0x8ca_2".equals(str));
            ((ajtg)this.app.a(20)).a(this.app, "" + l1, paramToServiceMsg, i);
            return;
          ...
          j = paramToServiceMsg.extraData.getInt("time");
          paramToServiceMsg = (byte[])paramObject;
          azkm.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
          return;
        ...
        paramToServiceMsg = (byte[])paramObject;
        paramToServiceMsg = azkm.a(this.app, l1, l2, paramToServiceMsg, j, i);
        if ((paramToServiceMsg != null) && (bool))
        {
          ...
          notifyUI(24, true, Long.valueOf(l2));
          return;
        }
      ...
      paramFromServiceMsg = this.app.a();
      paramObject = new ArrayList();
      paramObject.add(paramToServiceMsg);
      int i = (int)awao.a();
      paramFromServiceMsg.a().a(this.app, String.valueOf(l1), String.valueOf(l2), paramObject, 34, i, 0);
