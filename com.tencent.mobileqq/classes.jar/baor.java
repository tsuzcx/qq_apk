...
public class baor
  extends QIPCModule
{
  private static baor a;
  
  private baor(String paramString)
  {
    super(paramString);
  }
  ...
  public static baor a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	baor:a	Lbaor;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	baor:a	Lbaor;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	baor
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	baor:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	baor:a	Lbaor;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	baor:a	Lbaor;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          ((ajve)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(27)).notifyUI(5, true, paramBundle);
