...
public class anze
{
  private ArrayList<anzf> a = new ArrayList();
  
  /* Error */
  public static anze a(String paramString)
  {
    // Byte code:
    ...
    //   103: aload_2
    //   104: invokestatic 100	anze:b	(Ljava/lang/String;)Lanze;
    //   107: astore_2
    //   108: aload_0
    //   109: ifnull +7 -> 116
    //   112: aload_0
  ...
  public static anze b(String paramString)
  {
    try
    {
      Object localObject = new JSONObject(paramString);
      anze localanze = new anze();
      JSONArray localJSONArray = ((JSONObject)localObject).getJSONArray("360senceinfo");
      paramString = localanze;
      if (((JSONObject)localObject).has("360senceinfo"))
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject = new anzf();
            if (paramString.has("text")) {
              ((anzf)localObject).jdField_a_of_type_JavaLangString = paramString.optString("text");
            }
            if (paramString.has("starttime")) {
              ((anzf)localObject).jdField_a_of_type_Long = paramString.optLong("starttime");
            }
            if (paramString.has("endtime")) {
              ((anzf)localObject).b = paramString.optLong("endtime");
            }
            localanze.a.add(localObject);
            if (QLog.isColorLevel()) {
              QLog.d("ARTransferDoorVideoInfo", 2, "ARTransferDoorVideoInfo parseJson index: " + i + "," + ((anzf)localObject).toString());
            }
            i += 1;
          }
        }
  ...
  public anzf a(long paramLong)
  {
    Iterator localIterator = this.a.iterator();
    while (localIterator.hasNext())
    {
      anzf localanzf = (anzf)localIterator.next();
      long l = localanzf.jdField_a_of_type_Long;
      if ((paramLong < localanzf.b * 1000L) && (paramLong >= l * 1000L)) {
        return localanzf;
      }
    }
    return null;
