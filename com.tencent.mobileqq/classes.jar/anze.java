...
public class anze
  implements View.OnTouchListener, arbm, bfob
{
  private float jdField_a_of_type_Float;
  private int jdField_a_of_type_Int;
  private aoal jdField_a_of_type_Aoal;
  private arbl jdField_a_of_type_Arbl = new arbl(120, this);
  ...
  public anze(EmotionPanelListView paramEmotionPanelListView, aoal paramaoal, bfob parambfob)
  {
    ...
    this.c = bbkx.a(5.0F);
    this.jdField_a_of_type_Arbl.b(30);
  }
  ...
  public arbl a()
  {
    return this.jdField_a_of_type_Arbl;
  }
  
  public void a(AbsListView paramAbsListView)
  {
    if (((paramAbsListView.getAdapter() instanceof aocn)) || ((paramAbsListView.getAdapter() instanceof aocd)))
    {
      if (((this.jdField_a_of_type_Aoal instanceof EmoticonMainPanel)) && (((EmoticonMainPanel)this.jdField_a_of_type_Aoal).jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelViewPagerAdapter != null))
      {
        int i = EmoticonMainPanel.c;
        List localList = ((EmoticonMainPanel)this.jdField_a_of_type_Aoal).jdField_a_of_type_JavaUtilList;
        EmotionPanelViewPagerAdapter localEmotionPanelViewPagerAdapter = ((EmoticonMainPanel)this.jdField_a_of_type_Aoal).jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelViewPagerAdapter;
  ...
  {
    if ((paramBoolean) && (this.jdField_a_of_type_Aoal != null))
    {
  ...
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((a(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView)) && (this.b == 2) && (this.jdField_a_of_type_Aoal != null)) {
      a(0);
    }
    a(paramAbsListView);
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (i == 0)
    {
      ...
      this.jdField_a_of_type_Arbl.a(true);
      if (this.jdField_a_of_type_Aoal != null) {
        this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Aoal.a();
      }
    }
    for (;;)
    {
      ...
      if ((i == 1) && (this.jdField_a_of_type_Boolean)) {
        if ((a(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView)) && (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView.getListViewScrollY() < this.jdField_a_of_type_Int) && (this.jdField_a_of_type_Aoal != null))
        {
          this.jdField_a_of_type_Aoal.d();
          if (QLog.isColorLevel()) {
        ...
        else if ((a(this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmotionPanelListView)) && (paramMotionEvent.getY() > this.jdField_a_of_type_Float) && (this.jdField_a_of_type_Aoal != null))
        {
          this.jdField_a_of_type_Aoal.d();
          if (QLog.isColorLevel()) {
