...
public class mqr
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    Bitmap localBitmap = bhgm.a(paramString, localOptions);
    if (localBitmap == null) {
  ...
  public static mpv a(VideoAppInterface paramVideoAppInterface)
  {
    return (mpv)paramVideoAppInterface.a(7);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramBundle = new avpd((String)localObject, paramQQAppInterface.getCurrentAccountUin(), paramBundle, i, -5040, 65560, 0L);
  ...
  public static boolean a()
  {
    ...
    if ((!lpm.a(4, 1800000L)) && (!lpm.a(8, 1400000L))) {}
    for (;;)
    {
  ...
  {
    boolean bool = mvd.a(paramVideoAppInterface).getBoolean("qav_userguide_for_recever", true);
    if (QLog.isColorLevel()) {
