...
public class lpm
{
  ...
  public BeautyRender a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender == null) {
      this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender = new BeautyRender(VideoController.a().a(), lcj.h());
    }
    if (paramInt == this.jdField_a_of_type_Int) {
      return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
    }
    this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender.setBeautyLevel(paramInt * 1.0F / 100.0F * lpq.a());
    this.jdField_a_of_type_Int = paramInt;
    return this.jdField_a_of_type_ComTencentAvVideoEffectBeautyBeautyRender;
  }
  
  public lqe a(int paramInt1, int paramInt2, lqe paramlqe, FilterDesc paramFilterDesc, int paramInt3)
  {
    if (!lpq.a()) {}
    ...
    for (;;)
    {
      paramlqe = localBeautyRender.process(paramlqe.b, paramlqe.jdField_a_of_type_Int, paramInt1, paramInt2);
      return lqe.a(paramlqe.getFbo(), paramlqe.getTextureId());
  ...
  public byte[] a(int paramInt1, int paramInt2, byte[] paramArrayOfByte, FilterDesc paramFilterDesc, int paramInt3)
  {
    ...
    {
      lcg.e("AVSDKBeautyRender", "(mHeight * mWidth * 3 / 2) != yuvData.length");
      return paramArrayOfByte;
    }
    ...
    for (;;)
    {
      ...
      {
        lcg.e("AVSDKBeautyRender", "convertI420ToNV21 or convertI420ToNV12 e = " + paramArrayOfByte.getMessage());
