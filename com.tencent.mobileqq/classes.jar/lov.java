  ...
  implements lou
{
  ...
  private final List<lpb> jdField_a_of_type_JavaUtilList = new ArrayList(11);
  ...
  public lov(lqm paramlqm, int paramInt)
  {
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Int < 3)
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!bhmi.a(str))) {
        break label267;
      }
  ...
  private void e()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Lpa.a(0, this.jdField_a_of_type_JavaUtilList);
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      boolean bool2 = false;
      boolean bool1 = false;
      while (localIterator.hasNext())
      {
        lpb locallpb = (lpb)localIterator.next();
        if (locallpb != null)
        {
          boolean bool3;
          switch (locallpb.jdField_a_of_type_Int)
          {
          default: 
            bool3 = bool2;
            bool2 = bool1;
          ...
          for (;;)
          {
            ...
            bool1 = bool3;
            break;
            localAEFilterManager.setSmoothLevel(locallpb.jdField_d_of_type_Int);
            bool3 = bool1;
            bool1 = bool2;
            bool2 = bool3;
            continue;
            localAEFilterManager.setBeautyOrTransformLevel(locallpb.jdField_a_of_type_ComTencentTtpicOpenapiConfigBeautyRealConfig$TYPE, locallpb.jdField_d_of_type_Int);
            if (locallpb.jdField_d_of_type_Int == locallpb.jdField_c_of_type_Int) {
              break label116;
            }
            bool1 = bool2;
            bool2 = true;
  ...
  public int a(int paramInt, boolean paramBoolean1, lpp paramlpp, boolean paramBoolean2)
  {
    int i;
    if (this.jdField_a_of_type_Int < 1)
    {
    ...
    paramlpp.a(a(), (float)a(), paramBoolean2);
    return paramInt;
  }
  ...
  {
    boolean bool;
    if ((!lqk.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem, paramPendantItem)) || (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != paramVideoMaterial))
    {
      ...
      if (this.jdField_a_of_type_Lqm != null) {
        this.jdField_a_of_type_Lqm.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem.getGestureType());
      }
      label157:
      if (this.jdField_a_of_type_Lqm != null) {
        this.jdField_a_of_type_Lqm.a(false);
      }
  ...
  public void a(FilterDesc paramFilterDesc)
  {
    ...
    if (!lqk.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, paramFilterDesc))
    {
      this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc = paramFilterDesc;
      str = a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc);
      if ((this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager == null) || ((!TextUtils.isEmpty(str)) && (!bhmi.a(str)))) {
        break label112;
      }
      this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.updateLutGL(str);
      if (QLog.isColorLevel())
  ...
  public void a(lpj paramlpj, lpp paramlpp)
  {
    String str2 = "";
    String str1 = "";
    ...
    {
      boolean bool2 = lhq.a().b();
      if ((lhx.a(localVideoMaterial)) && (!bool2)) {
        bool1 = false;
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
          QLog.i("AEFilterAVWrapperImpl", 4, "processTip, cnt[" + paramlpp.jdField_a_of_type_Int + "], bIsPendantHasFace[" + bool1 + "], gesture[" + this.jdField_b_of_type_Boolean + "], gestureType[" + str2 + "], gestureWording[" + str1);
        }
        if (this.jdField_a_of_type_Lqm != null)
        {
          int i = this.jdField_a_of_type_Lqm.a(paramlpj, paramlpp.jdField_a_of_type_Int, this.jdField_b_of_type_Boolean, bool1, str1, str2);
        ...
        this.jdField_a_of_type_Lqm.a(true);
        return;
      }
    }
  }
  ...
  public boolean a(lpa paramlpa)
  {
    ...
    for (;;)
    {
      return this.jdField_a_of_type_Lpa.b();
      this.jdField_a_of_type_Lpa.a(paramlpa);
    }
  }
