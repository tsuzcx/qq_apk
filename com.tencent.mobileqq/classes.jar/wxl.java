...
{
  public wxl(AvatarPendantActivity paramAvatarPendantActivity, boolean paramBoolean, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          ThreadManager.postImmediately(new wxm(this), null, true);
