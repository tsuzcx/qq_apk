  ...
  extends WebViewPlugin
{
  ...
  private SparseArray<WeakReference<yyt>> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  yyt a(int paramInt)
  {
    ...
    Object localObject = new yyt(this, null);
    ((yyt)localObject).jdField_a_of_type_Int = paramInt;
    localObject = new WeakReference(localObject);
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localObject);
    return (yyt)((WeakReference)localObject).get();
  }
  ...
  boolean a(int paramInt)
  {
    ...
    localObject = (yyt)((WeakReference)localObject).get();
    if (localObject == null) {
      return false;
    }
    try
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSparseArray != null) && (this.jdField_a_of_type_AndroidUtilSparseArray.size() > 0))
    {
      ...
      {
        yyt localyyt = (yyt)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
        if (localyyt != null) {
          a(localyyt.jdField_a_of_type_Int);
        }
        i += 1;
      }
    }
