  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = (alkk)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22);
    int i;
    label100:
    label120:
    azmo localazmo;
    ...
    if (bool)
    {
      ...
      azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_contactlist", paramView, 0, 0, ((TroopInfo)localObject).troopuin, "", "", "");
      localazmo = new azmo(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_set").c("Grp_contactlist");
      if (!bool) {
        break label249;
      }
      paramView = "Clk_unstick";
      localazmo = localazmo.d(paramView);
    ...
    {
      localazmo.a(new String[] { str, paramView }).a();
      return;
      i = 0;
      break label100;
      break;
