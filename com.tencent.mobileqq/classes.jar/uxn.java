  ...
  implements PluginManagerHelper.OnPluginManagerLoadedListener
{
  ...
  public static uxn a()
  {
    if (jdField_a_of_type_Uxn == null) {}
    try
    {
      if (jdField_a_of_type_Uxn == null) {
        jdField_a_of_type_Uxn = new uxn();
      }
      return jdField_a_of_type_Uxn;
    }
    finally {}
  }
  ...
  public void b()
  {
    ...
    uya.b("QzoneVerticalVideoPluginApk", "initPluginThreshold configBean = " + localObject);
    if ((localObject == null) || (((umy)localObject).a == null))
    {
      uya.d("QzoneVerticalVideoPluginApk", "doDownloadWeishi : configBean is null");
      return;
    }
    localObject = ((umy)localObject).a;
    this.jdField_a_of_type_Long = (((unb)localObject).jdField_a_of_type_Long * 1000L);
    this.d = ((unb)localObject).jdField_a_of_type_Boolean;
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    ...
    for (;;)
    {
      ...
      if (paramPluginManagerClient != null)
      {
        ...
        try
        {
          this.jdField_a_of_type_ComTencentMobileqqPluginsdkPluginManagerClient.installPlugin("qzone_vertical_video_plugin.apk", new uxo(this));
        }
