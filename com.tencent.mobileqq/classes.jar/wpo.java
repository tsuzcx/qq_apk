  ...
  extends wri
{
  ...
  public wpo(CommentEntry paramCommentEntry, wrk paramwrk)
  {
    this(paramCommentEntry.feedId, paramCommentEntry.replierUnionId, paramCommentEntry.content, paramCommentEntry.fakeId, paramCommentEntry.pbType, paramCommentEntry.extras, paramCommentEntry.commentType, paramwrk);
    this.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry = paramCommentEntry;
  }
  
  public wpo(String paramString1, String paramString2, String paramString3, long paramLong, int paramInt1, String paramString4, int paramInt2, wrk paramwrk)
  {
    ...
    paramString1 = yup.a("home_page-comment_suc-d1");
  ...
  public String a()
  {
    return wpm.jdField_a_of_type_JavaLangString;
  }
  ...
  public wrj a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wpp(localRspAddFeedComment, this.jdField_a_of_type_Wrk);
    }
