...
public class bazb
{
  ...
  public TextView a;
  bajj<Integer> jdField_a_of_type_Bajj = new bazc(this);
  public bbcj a;
  public bbcm a;
  public bbdj a;
  TouchWebView.OnScrollChangedListener jdField_a_of_type_ComTencentBizUiTouchWebView$OnScrollChangedListener = new bazd(this);
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      localObject2 = null;
      if ((paramInt < this.jdField_c_of_type_Int) || (!this.jdField_a_of_type_Bbcm.t)) {
        break label94;
      }
      this.jdField_a_of_type_Bbcm.t = false;
      if (!paramBoolean) {
        break label80;
      }
    ...
    for (;;)
    {
      ...
      {
        localObject1 = localObject2;
        if (!this.jdField_a_of_type_Bbcm.t)
        {
          this.jdField_a_of_type_Bbcm.t = true;
          if (paramBoolean)
          {
        ...
        try
        {
          ...
          if (i >= 40300)
          {
            ...
            if (i <= 40313)
            {
              ...
              {
                str1 = str2;
                if (str2.contains(ajjy.a(2131648906))) {
                  str1 = BaseApplicationImpl.getApplication().getString(2131625011);
                }
              }
            }
          }
          ...
          paramIntent = str1;
          if (str1 == null) {
            paramIntent = BaseApplicationImpl.getApplication().getString(2131625011);
          }
          if (!bbdc.a())
          {
            ...
            if (AppSetting.jdField_c_of_type_Boolean)
            {
              ...
              paramIntent = str1;
              if (!str1.contains(BaseApplicationImpl.getApplication().getString(2131625011))) {
                paramIntent = BaseApplicationImpl.getApplication().getString(2131625011) + str1;
              }
  ...
  {
    LayoutInflater.from(this.jdField_a_of_type_Bbcj.d.getContext()).inflate(2131493105, this.jdField_a_of_type_Bbcj.d);
    this.jdField_b_of_type_AndroidContentIntent = paramIntent;
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_Bbcj.d.findViewById(2131309578));
    a(this.jdField_a_of_type_AndroidViewViewGroup);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131309714);
    this.jdField_c_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidViewView.setPadding(0, -bajq.b(12.0F), 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302804));
    ...
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView = ((FadeIconImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302807));
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setOnClickListener(paramOnClickListener);
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131624336));
    a(paramIntent);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302847));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131309695));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302832));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302816));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Bbcj.d.findViewById(2131311707);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311705));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311708));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131311703);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new baze(this));
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311586));
    d();
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    int j = 0;
    if ((paramIntent == null) || (TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Bbcm.jdField_a_of_type_Boolean)) {
      return;
    }
    Object localObject;
    if ((this.jdField_a_of_type_Bbcm.jdField_a_of_type_Long & 0x4) == 0L)
    {
      if (!bbdc.a()) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(BaseApplicationImpl.getApplication().getResources().getString(2131625011));
      }
    }
    else
    {
      ...
      this.jdField_a_of_type_Bbcm.j = paramIntent.getBooleanExtra("ishiderefresh", false);
      this.jdField_a_of_type_Bbcm.k = paramIntent.getBooleanExtra("ishidebackforward", false);
      boolean bool = paramIntent.getBooleanExtra("hide_left_button", false);
      this.jdField_a_of_type_Bbcm.l = paramIntent.getBooleanExtra("show_right_close_button", false);
      if (QLog.isColorLevel()) {
        QLog.d("QQBrowser", 2, "QQBrowser url=" + mpw.b(paramString, new String[0]));
      }
      ...
      label224:
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131624998));
      if (!this.jdField_a_of_type_Bbcm.jdField_e_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        localObject = this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130839708);
        if ((!this.jdField_a_of_type_Bbcj.jdField_a_of_type_Bbcm.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Bbcm.m)) {
          break label700;
        }
        paramString = bacm.a((Drawable)localObject, -1);
        label306:
        this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramString);
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627103));
        i();
      }
      if (b())
      {
    ...
    label844:
    label857:
    for (int i = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_Bbcj.jdField_a_of_type_AndroidAppActivity) + 0;; i = 0)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Bbcm.p)
        {
          ...
          label506:
          if (this.jdField_a_of_type_Bbcm.l) {
            a(paramIntent.getStringExtra("left_close_button_text"));
          }
          if (TextUtils.isEmpty(this.jdField_a_of_type_Bbcm.jdField_a_of_type_JavaLangString)) {
            break label844;
          }
        }
        try
        {
          paramIntent = new JSONObject(URLDecoder.decode(this.jdField_a_of_type_Bbcm.jdField_a_of_type_JavaLangString));
          i = k;
          ...
          for (paramIntent = paramIntent.getJSONArray("subTextArray");; paramIntent = null)
          {
            ...
            paramString = bacm.a((Drawable)localObject, this.jdField_a_of_type_Bbcm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_d_of_type_Int);
            break label306;
            label732:
            if (this.jdField_a_of_type_Bbcm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle == null) {
              break label372;
            }
            c(this.jdField_a_of_type_Bbcm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_d_of_type_Int);
            break label372;
            m = this.jdField_a_of_type_AndroidViewViewGroup.getTop();
            n = this.jdField_a_of_type_AndroidViewViewGroup.getBottom();
          ...
          a(new bazi(this.jdField_a_of_type_Bbcm.jdField_a_of_type_Int, i, null, null, paramString));
        }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bajd localbajd = new bajd(Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), new bazf(this, paramView, paramInt2));
    localbajd.setDuration(paramInt3);
    this.jdField_a_of_type_Bbcm.v = true;
    paramView.startAnimation(localbajd);
  }
  ...
  public void a(bazi parambazi)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setOnCheckedChangeListener(new bazh(this));
  ...
  public void a(bazj parambazj)
  {
    ...
    Object localObject2;
    boolean bool;
    if ((parambazj != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null))
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView;
      localObject2 = parambazj.jdField_a_of_type_ArrayOfInt;
      if (parambazj.jdField_a_of_type_Int != 1) {
        break label56;
      }
      bool = true;
      ((WebViewTopTabView)localObject1).setRedHotStatus((int[])localObject2, bool);
      localObject2 = this.jdField_a_of_type_Bbcj.a();
      if (localObject2 != null) {
        break label61;
      }
    }
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          if (TextUtils.isEmpty(parambazj.jdField_a_of_type_JavaLangString)) {
            break;
          }
          ((TouchWebView)localObject2).callJs(parambazj.jdField_a_of_type_JavaLangString, new String[] { ((JSONObject)localObject3).toString() });
          return;
          try
          {
  ...
  public void a(TouchWebView paramTouchWebView)
  {
    ...
    if ((this.jdField_a_of_type_Bbcm.q) && (localViewGroup != null) && (!this.jdField_a_of_type_Bbcm.u) && (a()))
    {
      this.jdField_a_of_type_Bbcm.u = true;
      this.jdField_a_of_type_Bbcm.r = true;
      this.jdField_a_of_type_Bbcm.t = true;
      localViewGroup.setBackgroundResource(2130849442);
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
        this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
      }
      paramTouchWebView.setOnScrollChangedListenerForBiz(new bazg(this));
    }
  }
  ...
  public void a(TouchWebView paramTouchWebView, boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAnimation = new bajd(Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), this.jdField_a_of_type_Bajj);
      ...
      this.jdField_b_of_type_AndroidViewAnimationAnimation = new bajd(Integer.valueOf(paramInt3), Integer.valueOf(paramInt2), this.jdField_a_of_type_Bajj);
  ...
  {
    if ((this.jdField_a_of_type_AndroidViewViewGroup == null) || (this.jdField_a_of_type_Bbcm.jdField_a_of_type_Boolean)) {}
    do
    {
      return;
      localObject = (RelativeLayout)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131311586);
    } while (localObject == null);
    paramWebView = (TextView)((RelativeLayout)localObject).findViewById(2131311625);
    Object localObject = (TextView)((RelativeLayout)localObject).findViewById(2131311563);
    if (paramBoolean)
    {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return;
      label70:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131625271);
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt1, int paramInt2, JsBridgeListener paramJsBridgeListener, View.OnClickListener paramOnClickListener, zrt paramzrt)
  {
    if ((paramJsBridgeListener != null) && (paramJsBridgeListener.jdField_a_of_type_Boolean)) {}
    for (int i = 1; paramBoolean; i = 0)
    {
      this.jdField_a_of_type_Bbcm.jdField_e_of_type_Boolean = true;
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ...
      if (paramInt1 == 0)
      {
        ...
        try
        {
          ...
          if ((paramString1 != null) && (i == 0))
          {
            ...
            if (this.jdField_a_of_type_Bbcm.jdField_a_of_type_OrgJsonJSONObject.has("txtclr"))
            {
              paramString2 = this.jdField_a_of_type_Bbcm.jdField_a_of_type_OrgJsonJSONObject.optString("txtclr", "");
              if (!TextUtils.isEmpty(paramString2))
              {
          ...
          try
          {
            ...
            paramString1 = bacm.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), paramInt1);
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
    if ((this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) || (!(this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment)))
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      i();
    }
    paramString3 = this.jdField_a_of_type_Bbcm;
    if (paramInt1 != 4)
    {
      paramBoolean = true;
      label457:
      ...
      default: 
        ...
        if (paramInt1 != 0)
        {
          if (this.jdField_b_of_type_AndroidWidgetImageView == null)
          {
            ...
            paramString3 = (RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131309694);
            paramString3 = new RelativeLayout.LayoutParams(-2, -2);
            paramString3.addRule(7, 2131302816);
            paramString3.addRule(6, 2131302816);
    ...
    for (;;)
    {
      ...
      paramBoolean = false;
      break label457;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843172, 2130843171);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(bacm.a(this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130843172), this.jdField_a_of_type_AndroidWidgetImageView.getResources().getColor(2131101257)));
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627100));
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843170, 2130843170);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627099));
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839708, 2130839708);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627101));
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839083, 2130839083);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627103));
      break label589;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843216);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627105));
      ((AnimationDrawable)this.jdField_a_of_type_AndroidWidgetImageView.getDrawable()).start();
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130841909, 2130841912);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131624088));
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130848837, 2130848841);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131624088));
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130838572, 2130838572);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627102));
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130848966, 2130848966);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131627102));
      break label589;
      ...
      localLayoutParams.rightMargin = bajq.b(10.0F);
      paramString3.setLayoutParams(localLayoutParams);
      break label589;
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839708, 2130839708);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131653544));
      break label589;
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130842993);
      break label777;
  ...
  public void a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      if ((paramJSONObject.length() > 0) && (!this.jdField_a_of_type_Bbcm.u))
      {
        this.jdField_a_of_type_Bbcm.u = a();
        if ((this.jdField_a_of_type_Bbcm.A) && (this.jdField_a_of_type_Bbcj.jdField_b_of_type_AndroidViewView != null)) {
          this.jdField_a_of_type_Bbcj.jdField_b_of_type_AndroidViewView.setPadding(0, (int)bacc.a(BaseApplicationImpl.getApplication(), 30.0F), 0, 0);
        }
      }
      if (paramJSONObject == null) {
        return;
    ...
    catch (Exception paramJSONObject)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        this.jdField_a_of_type_Bbcm.jdField_d_of_type_Int = j;
        return;
        continue;
        i = -1;
        continue;
    ...
    if ((this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null))
    {
      ...
      {
        this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(i);
        awnu.a(true, i, this.jdField_a_of_type_Bbcj.jdField_a_of_type_AndroidAppActivity.getWindow());
      }
    }
    else
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        {
          localObject1 = bacm.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), i);
        ...
        localObject1 = bacm.a(this.jdField_a_of_type_AndroidWidgetTextView.getBackground(), i);
        if (localObject1 != null) {
          this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable((Drawable)localObject1);
        }
        localObject1 = bacm.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), i);
        if (localObject1 != null)
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
          c(i);
        }
        localObject1 = this.jdField_c_of_type_AndroidViewView.findViewById(2131304578);
        localObject2 = bacm.a(((View)localObject1).getBackground(), i);
        if (localObject2 != null) {
        ...
        {
          if ((TextUtils.isEmpty(this.jdField_b_of_type_AndroidWidgetTextView.getText())) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bbcj.jdField_a_of_type_JavaLangString))) {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Bbcj.jdField_a_of_type_JavaLangString);
          }
          ...
          if ((paramBoolean) && (i > 0))
          {
            a(localViewGroup, this.jdField_a_of_type_Bbcm.jdField_d_of_type_Int, j, i);
            return;
          }
        }
      }
  ...
  {
    this.jdField_a_of_type_Bbcm.t = paramBoolean;
  ...
  public boolean a()
  {
    if ((!this.jdField_a_of_type_Bbcj.jdField_a_of_type_Bbcm.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Bbcm.m) && (this.jdField_a_of_type_AndroidViewViewGroup != null) && (this.jdField_a_of_type_Bbcj.d != null) && (Build.VERSION.SDK_INT >= 17))
    {
      ...
      if (localObject2 != null)
      {
        ((FrameLayout.LayoutParams)localObject2).topMargin -= BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131167773);
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bbcm.C)
    {
      if ((!this.jdField_a_of_type_Bbcm.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Bbcm.m))
      {
        Resources localResources = this.jdField_a_of_type_Bbcj.jdField_a_of_type_AndroidAppActivity.getResources();
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundColor(localResources.getColor(2131101467));
        if ((this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)) {
          this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(0);
        }
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetTextView, true, 2130848815, 2130849303);
      this.jdField_a_of_type_Bbcj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839708, 2130839704);
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)) {
        this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.getBackground().mutate().setAlpha(paramInt);
      }
  ...
  public void b(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Bbcj.a();
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Bbcj.a() == null) || (this.jdField_a_of_type_Bbcj.a().getPluginEngine() == null)) {}
    WebViewPlugin localWebViewPlugin;
    do
    {
      return false;
      localWebViewPlugin = this.jdField_a_of_type_Bbcj.a().getPluginEngine().a(45, false);
    } while (((localWebViewPlugin instanceof UiApiPlugin)) && (((UiApiPlugin)localWebViewPlugin).g));
    if ((this.jdField_a_of_type_Bbcm.D) || (this.jdField_a_of_type_Bbcm.E)) {}
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!this.jdField_a_of_type_Bbcj.jdField_a_of_type_Bbcm.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Bbcj.jdField_a_of_type_AndroidAppActivity.getWindow().clearFlags(1024);
      }
    }
    for (;;)
    {
      ...
      b(0);
      this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
      this.jdField_a_of_type_Bbcj.jdField_a_of_type_AndroidAppActivity.getWindow().addFlags(1024);
    }
  }
  ...
  public void c(int paramInt)
  {
    if (b())
    {
      View localView = this.jdField_c_of_type_AndroidViewView.findViewById(2131304578);
      localView.setBackgroundDrawable(bacm.a(localView.getBackground(), paramInt));
    }
  }
  ...
  public void e(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
    {
      if ((paramBoolean) && (b()))
      {
        this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.n = 100;
        this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.q();
        this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.e(true);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Bbcj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.e(false);
  }
  
  public void f()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColorStateList(2131101254));
    this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColorStateList(2131101254));
    this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(BaseApplicationImpl.getApplication().getResources().getColor(2131101257));
    Object localObject;
    if (this.jdField_a_of_type_AndroidWidgetImageView != null)
    {
    ...
    if (c())
    {
      localObject = this.jdField_c_of_type_AndroidViewView.findViewById(2131304578);
  ...
  public void f(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentWidgetFadeIconImageView != null) && (this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getVisibility() == 0))
    {
      localDrawable1 = bacm.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), paramInt);
    ...
    if (localDrawable2 != null)
    {
      ...
      localDrawable2 = bacm.a(localDrawable2, paramInt);
      if (localDrawable2 != null) {
    ...
    if (localDrawable1 != null)
    {
      ...
      localDrawable1 = bacm.a(localDrawable1, paramInt);
      if (localDrawable1 != null)
      {
  ...
  public void g()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bbcm.t) && (this.jdField_a_of_type_Bbcm.s))
      {
        this.jdField_a_of_type_Bbcm.s = false;
        this.jdField_a_of_type_Bbcm.s = true;
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130849442);
        this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        return;
      }
    } while ((this.jdField_a_of_type_Bbcm.t) || (!this.jdField_a_of_type_Bbcm.s));
    this.jdField_a_of_type_Bbcm.s = false;
    this.jdField_a_of_type_Bbcm.s = true;
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131101315));
    f();
  }
  
  public void g(int paramInt)
  {
    this.jdField_a_of_type_Bbcm.jdField_a_of_type_Int = paramInt;
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null) {
