  ...
  extends ajxj
{
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    Object localObject;
    if ((paramBoolean) && (QCallDetailActivity.a(this.a) == 3000) && (!bbbr.a(paramString, this.a.app.getCurrentAccountUin())))
    {
      localObject = (ajvi)this.a.app.getManager(53);
      if (localObject != null) {
        break label109;
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
        if (((ajvi)localObject).a(QCallDetailActivity.a(this.a)) != null) {
          break;
        }
      ...
      localObject = ((ajvi)localObject).a(QCallDetailActivity.a(this.a));
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        localDiscussionInfo = ((ajvi)localObject).a(QCallDetailActivity.a(this.a));
