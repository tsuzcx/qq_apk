...
public class aotx
  extends aoub
{
  public aotx(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  protected void a(View paramView, acun paramacun, ChatMessage paramChatMessage, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        paramView = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
    ...
    apsz.a(paramView).a(false, this.jdField_a_of_type_AndroidContentContext, new aoty(this, paramView));
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          paramChatMessage = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        } while (paramChatMessage == null);
        i = apue.a(paramChatMessage.fileName);
      } while ((i == 0) || (i == 2));
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      default: 
        ...
        if (paramChatMessage.nOpType == 0) {
          ...
          {
            if (bbdj.b(paramChatMessage.strFilePath)) {
              break label447;
            }
          }
        }
      ...
      label447:
      for (boolean bool1 = bool3; (!bool1) || (!bbdj.b(paramChatMessage.strFilePath)); bool1 = false)
      {
        return bool1;
        bool2 = true;
        break label383;
