  ...
  extends bgix
{
  ...
  public bgio()
  {
    this.jdField_a_of_type_JavaLangString = bgio.class.getSimpleName();
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          abju.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), paramString3, PublicTransFragmentActivity.class, ActivateFriendShareFragment.class);
          return false;
        }
