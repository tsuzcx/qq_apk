  ...
  extends qpk
{
  ...
  public qst(Context paramContext, FaceDecoder paramFaceDecoder, slt paramslt)
  {
  ...
  public qpk a()
  {
    ...
    return f(this.jdField_a_of_type_Slt, this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder).q().l().h().g();
  }
  ...
  public qpk d()
  {
    ...
    if ((this.jdField_a_of_type_Qpj != null) && ((this.jdField_a_of_type_Qpj instanceof ComponentContentGridImage)))
    {
      ...
      ((ComponentContentGridImage)this.jdField_a_of_type_Qpj).setOnNoItemClickListener(new qsu(this));
