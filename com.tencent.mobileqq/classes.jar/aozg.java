  ...
  extends Observable
{
  ...
  public aozg(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new aozh(this, Looper.getMainLooper());
  ...
  private void b(FileManagerEntity paramFileManagerEntity, int paramInt, String paramString)
  {
    ...
    ((HashMap)localObject).put("fileType", apvd.a(paramFileManagerEntity.fileName));
    switch (paramInt)
    {
    default: 
    ...
    for (;;)
    {
      apug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, (String)localObject, 1L, paramString, paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, paramFileManagerEntity.strFileMd5, 0L, 0L, paramFileManagerEntity.fileSize, 0, null);
      return;
