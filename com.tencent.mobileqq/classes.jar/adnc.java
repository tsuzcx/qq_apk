  ...
  implements ackq
{
  ...
  public adnc(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
  ...
  public FrameLayout a(LinearLayout paramLinearLayout)
  {
    ...
    this.jdField_a_of_type_Aeam = new aeam();
    this.jdField_a_of_type_Aeam.jdField_a_of_type_ComTencentMobileqqDataChatMessage = this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg;
    this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Aead.b(this.jdField_a_of_type_Aeam, this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
    Object localObject1 = paramLinearLayout.findViewById(2131307805);
    ...
    if (localObject1 == null)
    {
      ...
      this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Aead.b(this.jdField_a_of_type_Aeam, this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
      View localView = paramLinearLayout.findViewById(2131307830);
      localObject1 = localObject2;
      if (this.jdField_a_of_type_Aeam.b != null)
      {
    ...
    for (;;)
    {
      ...
      return localObject1;
      label305:
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Aeam.b, (ViewGroup.LayoutParams)localObject1);
      break;
      ...
      if ((localObject1 instanceof FrameLayout))
      {
        ...
        this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Aead.b(this.jdField_a_of_type_Aeam, this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
        ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Aeam.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
        localObject2 = new RelativeLayout.LayoutParams(i, j);
        paramLinearLayout = paramLinearLayout.findViewById(2131307830);
        if (paramLinearLayout != null) {
          paramLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        } else {
          ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Aeam.b, (ViewGroup.LayoutParams)localObject2);
        }
      }
      else
      {
  ...
  public void a(RedPackGrapInfo paramRedPackGrapInfo)
  {
    ...
    this.jdField_a_of_type_Int = aeas.a(paramRedPackGrapInfo.iMsgType);
  ...
  {
    int i = aeas.a(paramMessageForQQWalletMsg.messageType);
    paramMessageForQQWalletMsg = aeas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aeam, paramMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem, i, this);
    if ((paramMessageForQQWalletMsg instanceof aeap)) {
      ((aeap)paramMessageForQQWalletMsg).a(new azwg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    }
    try
    {
  ...
  public boolean a(FrameLayout paramFrameLayout, RedPackGrapInfo paramRedPackGrapInfo, agmg paramagmg)
  {
    if (paramFrameLayout == null) {
      return false;
    }
    this.jdField_a_of_type_Aead.a(paramagmg);
    paramFrameLayout = (RelativeLayout)paramFrameLayout.findViewById(2131307805);
    if (paramFrameLayout == null) {
      return false;
    }
    ...
    if (this.jdField_a_of_type_AndroidContentContext != null) {
      this.jdField_a_of_type_AndroidContentContext.getString(2131651533);
    }
    return this.jdField_a_of_type_Aead.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramFrameLayout, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Int, paramRedPackGrapInfo.iSkinId, "");
  }
