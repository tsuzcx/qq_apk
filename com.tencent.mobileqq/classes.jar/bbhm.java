...
public class bbhm
{
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      bhhr.a(BaseApplicationImpl.getApplication().getSharedPreferences("CaptureUtil", 4).edit().putBoolean("capture_shared_gesture_recognize_result", paramBoolean1));
    ...
    for (;;)
    {
      ...
      try
      {
        if (!jdField_a_of_type_Boolean)
        {
          ...
          int j = bnky.a(bnkt.b);
          bnrh.d("CaptureUtil", "PtvFilterSoLoad.getFilterSoState result = " + j);
          bnrh.d("CaptureUtil", "[loadEffectSo] base so load start ");
          if (j != 1) {
            continue;
          }
          bool2 = bnky.c();
