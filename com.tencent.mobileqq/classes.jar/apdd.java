  ...
  implements Manager
{
  ...
  public apdd(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    ...
    Object localObject1 = apda.a().query(RockDownloadInfo.class);
    ...
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localObject2 = bfwv.d(this.a.getApp(), localRockDownloadInfo.getPackageName());
          try
          {
    ...
    localObject1 = new VFSFile(apda.a());
