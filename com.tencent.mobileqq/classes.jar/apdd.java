  ...
  implements apdc, RecogCallback
{
  ...
  public apdd(Handler paramHandler, Context paramContext)
  {
  ...
  private boolean b(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramArrayOfByte = this.jdField_a_of_type_Apcy.a(paramArrayOfByte, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, 0);
      bool2 = apcy.a(paramArrayOfByte);
      ...
      bool1 = bool2;
    } while (this.jdField_a_of_type_Apde == null);
    this.jdField_a_of_type_Apde.a(bool2, paramArrayOfByte, paramBoolean);
    return bool2;
  }
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Apcy.a(this);
    this.jdField_a_of_type_Apcy.a(this);
    this.jdField_a_of_type_Apcy.a(this.jdField_a_of_type_AndroidContentContext, hashCode(), "MiniRecog");
  ...
  {
    boolean bool1 = this.jdField_a_of_type_Apcy.c();
    ...
    catch (Throwable paramArrayOfByte)
    {
      ...
      try
      {
        ...
        bool1 = bool2;
        bool2 = this.jdField_a_of_type_Apcy.a(paramRect, this.jdField_a_of_type_Long);
        bool3 = bool2;
        if (!bool2)
        {
          bool1 = bool2;
  ...
  public Bitmap a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (apcy.a(this.jdField_a_of_type_ArrayOfInt, paramArrayOfByte, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int) != 0) {
      try
      {
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Apcy.c(this);
      this.jdField_a_of_type_Apcy.b(this);
      this.jdField_a_of_type_Apcy.a(hashCode(), "MiniRecog");
    }
  }
  ...
  {
    this.jdField_a_of_type_Apde = ((apde)paramapcx);
  }
  
  public boolean a()
  {
    return (this.jdField_a_of_type_Apcy.c()) && (this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean);
  }
  ...
  public void onDetectReady(int paramInt)
  {
    ...
    apdk.d(this.jdField_c_of_type_Int, (int)l);
  }
  ...
  public void onDetectResult(List<apcu> paramList, long paramLong)
  {
    ...
    {
      if ((((apcu)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.width() > 0) && (((apcu)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.height() > 0))
      {
        Rect localRect = new Rect(((apcu)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect);
        ...
        localapcu.jdField_a_of_type_Int = ((apcu)paramList.get(i)).jdField_a_of_type_Int;
        localapcu.jdField_a_of_type_Float = ((apcu)paramList.get(i)).jdField_a_of_type_Float;
