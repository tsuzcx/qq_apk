...
{
  public zyb(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (TextUtils.isEmpty(paramView))
    {
      if (!this.a.isFinishing())
      {
        ...
        paramView.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131634073));
        paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849089);
        paramView.a();
      }
      return;
    }
