...
{
  zyb(zxz paramzxz, String paramString) {}
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (;;)
    {
      Intent localIntent = new Intent(this.jdField_a_of_type_Zxz.jdField_a_of_type_MqqAppAppActivity, QQBrowserDelegationActivity.class);
      ...
      this.jdField_a_of_type_Zxz.jdField_a_of_type_MqqAppAppActivity.startActivity(localIntent);
      if (this.jdField_a_of_type_Zxz.jdField_a_of_type_ComTencentBizQrcodeIpcScannerParams.e) {
        this.jdField_a_of_type_Zxz.jdField_a_of_type_MqqAppAppActivity.finish();
      }
      if (this.jdField_a_of_type_Zxz.jdField_a_of_type_ComTencentBizQrcodeIpcScannerParams.b) {
        this.jdField_a_of_type_Zxz.jdField_a_of_type_MqqAppAppActivity.finish();
      }
      return;
