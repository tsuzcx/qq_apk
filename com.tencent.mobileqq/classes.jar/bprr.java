...
public class bprr
  implements bppr, QQSpecialAVFilter.MusicWaveformSupporter
{
  private int jdField_a_of_type_Int;
  private bpso jdField_a_of_type_Bpso;
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private QQFilterRenderManager jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = bmvb.a();
  public boolean a;
  ...
  public bprr(List<FilterDesc> paramList, MusicItemInfo paramMusicItemInfo, int paramInt1, int paramInt2, PublishVideoEntry paramPublishVideoEntry)
  {
    if (paramList != null)
    {
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      bprs localbprs = new bprs(this);
      try
      {
        long l = SystemClock.elapsedRealtimeNanos();
        boolean bool = this.jdField_a_of_type_Bpso.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, localbprs, 0);
        if (QLog.isColorLevel()) {
  ...
  public float getCurrentMusicGain()
  {
    try
    {
      if (this.jdField_a_of_type_Bpso != null)
      {
        ...
        float f = this.jdField_a_of_type_Bpso.a(this.jdField_a_of_type_Int);
        return f;
      }
    }
    catch (Exception localException)
