  ...
  extends Handler
{
  ...
  public agqd(SendPhotoActivity paramSendPhotoActivity1, SendPhotoActivity paramSendPhotoActivity2)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoSendPhotoActivity.a(2131695125);
      return;
      if (localSendPhotoActivity.jdField_a_of_type_AndroidOsHandler.hasMessages(2))
      {
        aune.b(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage", "remove delayed Message:MSG_CANCLE_PROGRESS");
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        ((Intent)localObject2).putExtra(bbbi.h, 2);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          aune.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage print CompressInfo", "info:" + localObject3);
      ...
      aune.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "CompressLog", "compress startTime = " + localSendPhotoActivity.b + "ns,finishTime = " + l1 + "ns,duration = " + l2 + "ms,count = " + i + ",isShowing = " + bool1);
      agqf.a(l2, i, bool1);
      localSendPhotoActivity.app.a().a(l1);
      aune.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "TimeCompare", "CompressFinish Time = " + l1 + "ns");
      ...
      auoy.a(BaseApplication.getContext(), paramMessage);
      return;
      if (QLog.isColorLevel()) {
