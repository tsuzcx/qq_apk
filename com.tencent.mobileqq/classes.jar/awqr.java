...
public class awqr
{
  ...
  public awpy a;
  protected awqo a;
  private awqu jdField_a_of_type_Awqu = new awqs(this);
  ...
  public awqr(LyricView paramLyricView)
  {
    ...
    this.jdField_a_of_type_Awqo = new awqo();
    ...
    this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewScroll.setScrollListener(this.jdField_a_of_type_Awqu);
  }
  
  private void d()
  {
    this.jdField_a_of_type_Awpy = this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal.a();
    awpy localawpy = this.jdField_a_of_type_Awpy;
    if ((localawpy == null) || (localawpy.a()) || (this.jdField_a_of_type_Boolean))
    {
  ...
  public void a()
  {
    ...
    awqd.a().post(new LyricViewController.4(this));
  ...
  public void a(int paramInt)
  {
    ...
    awqd.a().post(new LyricViewController.5(this, paramInt));
  }
  ...
  public void a(awpy paramawpy1, awpy paramawpy2, awpy paramawpy3)
  {
    Log.v("ModuleController", "setLyric begin");
    awqd.a().post(new LyricViewController.3(this, paramawpy3, paramawpy1, paramawpy2));
  }
  ...
  protected void b(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Awpy != null) || (this.jdField_a_of_type_ComTencentMobileqqLyricWidgetLyricViewInternal != null))
    {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Awpy.a.size()))
    {
      if (this.jdField_a_of_type_Awpy.a.get(paramInt) == null)
      {
        Log.w("ModuleController", "onScrollStop -> current sentence is null");
        return;
      }
      long l2 = ((awqa)this.jdField_a_of_type_Awpy.a.get(paramInt)).jdField_a_of_type_Long;
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Awqo.a(l1);
  ...
  protected void c(int paramInt)
  {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_Awpy.a.size()))
    {
      ...
      for (;;)
      {
        ...
        l1 = l2 / 10L;
        this.jdField_a_of_type_Awqo.b((l1 + 1L) * 10L);
        return;
        label178:
        l1 = l2;
        if (this.jdField_b_of_type_Int >= 0)
