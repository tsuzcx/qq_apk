  ...
  extends aoyb
{
  ...
  public aoyc(QQAppInterface paramQQAppInterface, aoyf paramaoyf)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localanvk.b((String)localObject3))
          {
        ...
        else if (bhff.a(MessageRecord.getTableName((String)localObject3, i), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getReadableDatabase()))
        {
          localArrayList.add(localFTSEntity);
  ...
  private void a(FTSMessage paramFTSMessage, int paramInt)
  {
    try
    {
      ...
      if ((paramFTSMessage.istroop == 0) && (!((anvk)localObject1).b(paramFTSMessage.senderuin)) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramFTSMessage.senderuin)) && (!bhff.a((String)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getReadableDatabase())))
      {
  ...
  public ArrayList<FTSEntity> a(long paramLong, Pair<CharSequence, CharSequence> paramPair)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      localObject = aoya.a(FTSMessage.class, String.valueOf(paramLong));
      localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a((azij)localObject);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = bhkf.a(str);
        paramString = aoya.a(paramString, (String[])((ArrayList)localObject1).toArray(new String[((ArrayList)localObject1).size()]), paramClass, paramBoolean1, paramBoolean2);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString = bhkf.a((String)localObject);
        if (QLog.isColorLevel()) {
          QLog.i("Q.fts.FTSMsgOperator", 2, "query segments = " + Arrays.toString(paramString));
        }
        ...
        localObject = bhkf.a((String)localObject);
        paramString = aoya.a(paramString, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt);
  ...
  public ArrayList<FTSEntity> a(String paramString1, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString1 = bhkf.a((String)localObject);
        if (QLog.isColorLevel()) {
        ...
        localObject = bhkf.a((String)localObject);
        paramString1 = aoya.a(paramString1, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt, paramString2);
  ...
  public void a(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    if ((paramMsgQueueItem.whereClause != null) && (!TextUtils.isEmpty(paramMsgQueueItem.whereClause)))
    {
      ...
      if ((localObject1 != null) && (bhkf.a(paramMsgQueueItem.value))) {
    ...
    while (paramMsgQueueItem.hasNext())
    {
      ...
      if ((((MessageRecord)localObject1).isSupportFTS()) && (((MessageRecord)localObject1).isValid) && (((MessageRecord)localObject1).msgtype != -2006) && (!((MessageRecord)localObject1).isMultiMsg))
      {
        ...
        continue;
        if ((localObject1 != null) && (bhkf.b(paramMsgQueueItem.value)))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((((MessageRecord)localObject3).isSupportFTS()) && (((MessageRecord)localObject3).isValid) && (((MessageRecord)localObject3).msgtype != -2006) && (!((MessageRecord)localObject3).isMultiMsg))
            {
              ...
              localObject3 = bhkf.a(paramMsgQueueItem.value, (MessageRecord)localObject3);
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Aoyi = new aoyd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
  ...
  public long b(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
    {
      ...
      if (((FTSMsgCounter)localObject).mMsgCnt > 1000L)
      {
        ...
        this.jdField_a_of_type_Azhs.update((Entity)localObject);
      }
      for (;;)
      {
  ...
  public void b(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    try
    {
      ((FTSMessage)localObject).uin = mry.a(paramMsgQueueItem.frindUin);
  ...
  {
    super.c();
    if (1 == bhkf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_a_of_type_Aoyf.obtainMessage(1, this).sendToTarget();
    }
  }
  ...
  public void e()
  {
    if ((!aoxx.jdField_a_of_type_Boolean) && (bhkf.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.fts.FTSMsgOperator", 2, "transToDatabase ENABLE = " + aoxx.jdField_a_of_type_Boolean + ", FTSUpgradeFlag = " + bhkf.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
    }
  ...
  {
    // Byte code:
    //   0: getstatic 856	aoxx:jdField_a_of_type_Boolean	Z
    //   3: ifne +64 -> 67
    //   6: aload_0
    //   7: getfield 72	aoyc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10: invokestatic 868	bhkf:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   13: ifeq +54 -> 67
    //   16: invokestatic 197	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   19: ifeq +47 -> 66
    //   22: ldc 165
    //   24: iconst_2
    ...
    //   38: getstatic 856	aoxx:jdField_a_of_type_Boolean	Z
    //   41: invokevirtual 873	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   44: ldc_w 875
    //   47: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   50: aload_0
    //   51: getfield 72	aoyc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: invokestatic 868	bhkf:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   57: invokevirtual 873	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   66: return
    //   67: aload_0
    //   68: getfield 72	aoyc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 563	com/tencent/mobileqq/app/QQAppInterface:getWritableDatabase	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   74: astore 9
    //   76: aload_0
    //   77: getfield 72	aoyc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   83: invokevirtual 432	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   86: astore 7
    //   88: invokestatic 334	java/lang/System:currentTimeMillis	()J
    //   91: lstore_3
    //   92: aload 9
    //   94: ldc_w 421
    //   97: ldc_w 423
    //   100: iconst_1
    //   101: anewarray 136	java/lang/String
    //   104: dup
    //   105: iconst_0
    //   106: aload_0
    //   107: getfield 399	aoyc:jdField_a_of_type_Int	I
    //   110: invokestatic 260	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   113: aastore
    //   114: invokevirtual 429	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   117: pop
    //   118: aload 7
    //   120: ldc_w 434
    //   123: ldc_w 421
    ...
    //   127: ldc_w 436
    //   130: iconst_1
    //   131: anewarray 136	java/lang/String
    //   134: dup
    //   135: iconst_0
    //   136: aload_0
    //   137: getfield 399	aoyc:jdField_a_of_type_Int	I
    //   140: invokestatic 260	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   143: aastore
    //   144: aconst_null
    //   145: aconst_null
    //   146: ldc_w 438
    //   149: aconst_null
    //   150: invokevirtual 444	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   153: astore 8
    //   155: aload 9
    //   157: ldc_w 500
    //   160: ldc_w 423
    //   163: iconst_1
    //   164: anewarray 136	java/lang/String
    //   167: dup
    //   168: iconst_0
    //   169: aload_0
    //   170: getfield 329	aoyc:jdField_b_of_type_Int	I
    //   173: invokestatic 260	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   176: aastore
    //   177: invokevirtual 429	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   180: pop
    //   181: aload 7
    //   183: ldc_w 502
    //   186: ldc_w 500
    ...
    //   190: ldc_w 436
    //   193: iconst_1
    //   194: anewarray 136	java/lang/String
    //   197: dup
    //   198: iconst_0
    //   199: aload_0
    //   200: getfield 329	aoyc:jdField_b_of_type_Int	I
    //   203: invokestatic 260	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   206: aastore
    //   207: aconst_null
    //   208: aconst_null
    //   209: ldc_w 438
    //   212: aconst_null
    //   213: invokevirtual 444	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   216: astore 9
    //   218: new 524	com/tencent/mobileqq/data/fts/FTSMessageForDel
    //   221: dup
    //   222: invokespecial 542	com/tencent/mobileqq/data/fts/FTSMessageForDel:<init>	()V
    //   225: astore 10
    //   227: aload 10
    //   229: iconst_4
    //   230: putfield 532	com/tencent/mobileqq/data/fts/FTSMessageForDel:mode	I
    //   233: aload 10
    //   235: invokevirtual 539	com/tencent/mobileqq/data/fts/FTSMessageForDel:deleteOpt	()V
    //   238: aload_0
    //   239: getfield 303	aoyc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   242: ifnull +271 -> 513
    //   245: aload_0
    //   246: getfield 303	aoyc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   249: invokevirtual 307	com/tencent/mobileqq/persistence/fts/FTSDatatbase:a	()Z
    //   252: ifeq +261 -> 513
    //   255: new 89	java/util/ArrayList
    //   258: dup
    //   259: bipush 10
    //   261: invokespecial 308	java/util/ArrayList:<init>	(I)V
    //   264: astore 11
    //   266: aload 11
    //   268: aload 10
    //   270: invokevirtual 163	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   273: pop
    //   274: aload 8
    //   276: ifnull +243 -> 519
    //   279: aload 8
    //   281: invokeinterface 452 1 0
    //   286: istore_1
    //   287: aload_0
    //   288: getfield 303	aoyc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   291: aload 11
    //   293: iconst_1
    //   294: iload_1
    //   295: invokevirtual 327	com/tencent/mobileqq/persistence/fts/FTSDatatbase:a	(Ljava/util/ArrayList;II)I
    //   298: istore_2
    //   299: aload_0
    //   300: aload_0
    //   301: getfield 399	aoyc:jdField_a_of_type_Int	I
    //   304: iload_1
    //   305: iadd
    //   306: putfield 399	aoyc:jdField_a_of_type_Int	I
    //   309: invokestatic 197	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   312: ifeq +39 -> 351
    //   315: ldc 165
    //   317: iconst_2
    //   318: iconst_4
    //   319: anewarray 167	java/lang/Object
    //   322: dup
    //   323: iconst_0
    //   324: ldc_w 885
    //   327: aastore
    ...
    //   347: aastore
    //   348: invokestatic 215	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   351: aload 9
    //   353: ifnull +171 -> 524
    //   356: aload 9
    //   358: invokeinterface 452 1 0
    //   363: istore_1
    //   364: aload_0
    //   365: getfield 303	aoyc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   368: aload 11
    //   370: iconst_2
    //   371: iload_1
    //   372: invokevirtual 327	com/tencent/mobileqq/persistence/fts/FTSDatatbase:a	(Ljava/util/ArrayList;II)I
    //   375: istore_2
    //   376: aload_0
    //   377: aload_0
    //   378: getfield 329	aoyc:jdField_b_of_type_Int	I
    //   381: iload_1
    //   382: iadd
    //   383: putfield 329	aoyc:jdField_b_of_type_Int	I
    //   386: invokestatic 197	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   389: ifeq +39 -> 428
    //   392: ldc 165
    //   394: iconst_2
    //   395: iconst_4
    //   396: anewarray 167	java/lang/Object
    //   399: dup
    //   400: iconst_0
    //   401: ldc_w 889
    //   404: aastore
    ...
    //   419: iconst_3
    //   420: iload_2
    //   421: invokestatic 204	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   424: aastore
    //   425: invokestatic 215	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   428: aload_0
    //   429: getfield 342	aoyc:d	I
    //   432: i2l
    //   433: lstore 5
    //   435: aload_0
    //   436: aload_0
    //   437: getfield 303	aoyc:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   440: ldc_w 409
    //   443: invokevirtual 412	com/tencent/mobileqq/persistence/fts/FTSDatatbase:b	(Ljava/lang/String;)I
    //   446: putfield 342	aoyc:d	I
    //   449: invokestatic 197	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   452: ifeq +61 -> 513
    //   455: ldc 165
    //   457: iconst_2
    //   458: bipush 6
    //   460: anewarray 167	java/lang/Object
    //   463: dup
    //   464: iconst_0
    //   465: ldc_w 891
    //   468: aastore
    //   469: dup
    //   470: iconst_1
    //   471: invokestatic 334	java/lang/System:currentTimeMillis	()J
    //   474: lload_3
    //   475: lsub
    //   476: invokestatic 280	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   479: aastore
    //   480: dup
    //   481: iconst_2
    //   482: ldc_w 363
    ...
    //   487: iconst_3
    //   488: aload_0
    //   489: getfield 342	aoyc:d	I
    //   492: invokestatic 204	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   495: aastore
    //   496: dup
    //   497: iconst_4
    //   498: ldc_w 365
    ...
    //   503: iconst_5
    //   504: lload 5
    //   506: invokestatic 280	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   509: aastore
    //   510: invokestatic 215	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   513: aload 7
    //   515: invokevirtual 447	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   518: return
    //   519: iconst_0
    //   520: istore_1
    //   521: goto -234 -> 287
    ...
    //   533: iconst_1
    //   534: iconst_2
    //   535: anewarray 167	java/lang/Object
    //   538: dup
    //   539: iconst_0
    //   540: ldc_w 893
    //   543: aastore
    ...
    //   545: iconst_1
    //   546: aload 8
    //   548: invokevirtual 894	java/lang/Exception:toString	()Ljava/lang/String;
    //   551: aastore
    //   552: invokestatic 896	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   555: aload 7
    //   557: invokevirtual 447	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   560: return
    //   561: astore 8
    //   563: aload 7
    //   565: invokevirtual 447	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   568: aload 8
    //   570: athrow
