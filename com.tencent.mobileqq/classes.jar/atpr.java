  ...
  implements bcwt
{
  ...
  public atpr(QQAppInterface paramQQAppInterface, Context paramContext, HorizontalListView paramHorizontalListView, HeadSetView paramHeadSetView)
  {
  ...
  public void a(atof paramatof)
  {
    ...
    this.jdField_a_of_type_Atof.a(this);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new atpt(paramView);
    ...
    for (;;)
    {
      paramView.setOnClickListener(new atps(this, str));
      Bitmap localBitmap2 = this.jdField_a_of_type_Atof.a(paramViewGroup.jdField_a_of_type_JavaLangString);
      Bitmap localBitmap1 = localBitmap2;
      if (localBitmap2 == null) {
        localBitmap1 = bdda.a();
      }
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(localBitmap1);
      atpb.a(paramView, bdbt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 0) + "正在共享位置");
      return paramView;
      paramViewGroup = (atpt)paramView.getTag();
      paramViewGroup.jdField_a_of_type_JavaLangString = str;
    }
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(localObject instanceof atpt)) {
          break label87;
        }
        localObject = (atpt)localObject;
        if ((paramString == null) || (!paramString.equals(((atpt)localObject).jdField_a_of_type_JavaLangString))) {
          break label87;
        }
        if (paramBitmap != null)
        {
          paramString = this.jdField_a_of_type_Atof.a(paramString);
          if (paramString != null) {
            ((atpt)localObject).jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(paramString);
          }
        }
      }
      return;
