  ...
  extends apsv
{
  ...
  public apsr(GalleryBaseData paramGalleryBaseData)
  {
  ...
  public Drawable a()
  {
    for (;;)
    {
      try
      {
        ...
        {
          localDrawable = new apsz().a((AIOPicData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
          localObject2 = a();
        ...
        else
        {
          ...
          {
            localDrawable = new aptd().a((AIOShortVideoData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
            continue;
          }
          if ((this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData instanceof AIOFilePicData))
          {
            localDrawable = new apsy().a((AIOFilePicData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
            continue;
          }
          if (!(this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData instanceof AIOFileVideoData)) {
            break label219;
          }
          localDrawable = new apta().a((AIOFileVideoData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
          continue;
        }
        return null;
      }
