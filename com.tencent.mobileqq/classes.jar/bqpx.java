  ...
  extends LinearLayout
{
  ...
  public bqpx(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  public void a(bqpd parambqpd, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131370371);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131370358);
      localObject3 = (TextView)((View)localObject1).findViewById(2131370372);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131370370);
      str = parambqpd.b(paramInt2);
      localObject1 = parambqpd.a(paramInt2);
      if (localObject1 != null) {
        break label146;
      }
      yuk.e("LocationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { parambqpd.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
    ...
    Object localObject2 = new bqpy((String)localObject1, localURLImageView, localProgressBar);
    ...
    if (((URLDrawable)localObject1).getStatus() == 1) {
      ((bqpy)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
    }
    if (paramBoolean) {}
    for (;;)
    {
