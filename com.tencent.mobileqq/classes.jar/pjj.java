  ...
  implements ManagedClientConnection
{
  ...
  private volatile pji jdField_a_of_type_Pji;
  private volatile boolean jdField_a_of_type_Boolean;
  
  public pjj(ClientConnectionManager paramClientConnectionManager, ClientConnectionOperator paramClientConnectionOperator, pji parampji)
  {
    ...
    this.jdField_a_of_type_Pji = parampji;
  ...
  {
    pji localpji = this.jdField_a_of_type_Pji;
    if (localpji == null) {
      return null;
    }
    return (OperatedClientConnection)localpji.b();
  }
  ...
  {
    pji localpji = this.jdField_a_of_type_Pji;
    this.jdField_a_of_type_Pji = null;
    return localpji;
  }
  ...
  public void abortConnection()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 34	pjj:jdField_a_of_type_Pji	Lpji;
    //   6: ifnonnull +6 -> 12
    //   9: aload_0
    //   10: monitorexit
    //   11: return
    //   12: aload_0
    //   13: iconst_0
    //   14: putfield 36	pjj:jdField_a_of_type_Boolean	Z
    //   17: aload_0
    //   18: getfield 34	pjj:jdField_a_of_type_Pji	Lpji;
    //   21: invokevirtual 48	pji:b	()Ljava/lang/Object;
    //   24: checkcast 50	org/apache/http/conn/OperatedClientConnection
    //   27: astore_1
    //   28: aload_1
    //   29: invokeinterface 61 1 0
    //   34: aload_0
    //   35: getfield 30	pjj:jdField_a_of_type_OrgApacheHttpConnClientConnectionManager	Lorg/apache/http/conn/ClientConnectionManager;
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 40	pjj:jdField_a_of_type_Long	J
    //   43: getstatic 67	java/util/concurrent/TimeUnit:MILLISECONDS	Ljava/util/concurrent/TimeUnit;
    //   46: invokeinterface 73 5 0
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 34	pjj:jdField_a_of_type_Pji	Lpji;
    //   56: aload_0
    //   57: monitorexit
    //   58: return
    //   59: astore_1
  ...
  public void close()
  {
    ...
    if (localpji != null)
    {
      OperatedClientConnection localOperatedClientConnection = (OperatedClientConnection)localpji.b();
      localpji.a();
  ...
  public void layerProtocol(HttpContext paramHttpContext, HttpParams paramHttpParams)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Pji == null) {
        throw new ConnectionShutdownException();
      }
    }
    finally {}
    Object localObject = this.jdField_a_of_type_Pji.a();
    ...
    OperatedClientConnection localOperatedClientConnection = (OperatedClientConnection)this.jdField_a_of_type_Pji.b();
    ...
    this.jdField_a_of_type_Pji.a().layerProtocol(localOperatedClientConnection.isSecure());
  }
  ...
  public void open(HttpRoute paramHttpRoute, HttpContext paramHttpContext, HttpParams paramHttpParams)
  {
    ...
    if (this.jdField_a_of_type_Pji.a().isConnected()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramHttpRoute)
      {
        ...
        continue;
        paramHttpRoute = this.jdField_a_of_type_Pji.a();
        if (localHttpHost2 != null) {
          break;
        }
      }
  ...
  public void tunnelProxy(HttpHost paramHttpHost, boolean paramBoolean, HttpParams paramHttpParams)
  {
    ...
    this.jdField_a_of_type_Pji.a().tunnelProxy(paramHttpHost, paramBoolean);
  }
  ...
  public void tunnelTarget(boolean paramBoolean, HttpParams paramHttpParams)
  {
    ...
    this.jdField_a_of_type_Pji.a().tunnelTarget(paramBoolean);
  }
