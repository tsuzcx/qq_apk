  ...
  implements aoyi
{
  ...
  aoyd(QQAppInterface paramQQAppInterface, aoyc paramaoyc)
  {
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aoyc = paramaoyc;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase = this.jdField_a_of_type_Aoyc.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase;
    this.jdField_a_of_type_Aoyf = this.jdField_a_of_type_Aoyc.jdField_a_of_type_Aoyf;
  }
  ...
  private List<MessageRecord> a(SQLiteDatabase paramSQLiteDatabase, azhs paramazhs)
  {
    ...
    if ((localObject1 != null) && (((Cursor)localObject1).getCount() == 1))
    {
      ...
      if (paramSQLiteDatabase != null)
      {
        ...
        if (l > 0L)
        {
          ...
          localObject1 = paramazhs.a((String)localObject1, new String[] { String.valueOf(l) }, paramSQLiteDatabase);
          if (QLog.isColorLevel())
          {
            paramazhs = new StringBuilder().append("UpgradeThread: list size = ");
            if (localObject1 != null) {
              break label345;
            }
          }
  ...
  private void b()
  {
    ...
    localHashMap.put("param_table", String.valueOf(bhkf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)));
    localHashMap.put("param_msg", String.valueOf(bhkf.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)));
    StatisticCollector.getInstance(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).collectPerformance(null, "actFTSUpgradeCost", true, bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), 0L, localHashMap, null, false);
    bhkf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
    if (QLog.isColorLevel()) {
      QLog.d("Q.fts.FTSMsgUpgrader", 2, "========== upgrade table complete, cost =" + bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) + "us, tables = " + bhkf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) + ", msgs = " + bhkf.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    }
  }
  
  private void c()
  {
    long l1 = bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    for (int i = 0;; i = -1)
    {
      ...
      bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, l2);
  ...
  private boolean c()
  {
    ...
    if (bhkf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
    ...
    l2 = (System.nanoTime() - l2) / 1000L;
    bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, l2);
    this.jdField_a_of_type_Aoyf.post(new FTSMsgUpgrader.1(this));
    return false;
  }
  ...
  private boolean d()
  {
    ...
    //   31: astore 11
    //   33: aload_0
    //   34: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   37: invokestatic 227	bhkf:c	(Lcom/tencent/mobileqq/app/QQAppInterface;)I
    //   40: istore_1
    //   41: aload_0
    //   42: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   45: invokestatic 234	bhkf:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)I
    //   48: istore_2
    //   49: aload_0
    //   50: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   53: invokestatic 251	bhkf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)J
    //   56: lstore 4
    //   58: invokestatic 274	java/lang/System:nanoTime	()J
    //   61: lstore 6
    //   63: aload_0
    //   64: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   73: checkcast 176	azhs
    //   76: astore 9
    //   78: aload_0
    //   79: aload_0
    //   80: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   86: aload 9
    //   88: invokespecial 354	aoyd:a	(Lcom/tencent/mobileqq/app/SQLiteDatabase;Lazhs;)Ljava/util/List;
    //   91: astore 8
    //   93: aload 8
    //   95: ifnull +205 -> 300
    //   98: aload 8
    ...
    //   275: aload_0
    //   276: getfield 37	aoyd:jdField_b_of_type_Int	I
    ...
    //   290: ifnull +8 -> 298
    //   293: aload 9
    //   295: invokevirtual 409	azhs:close	()V
    //   298: iconst_0
    //   299: ireturn
    ...
    //   336: aload_0
    //   337: getfield 37	aoyd:jdField_b_of_type_Int	I
    ...
    //   351: ifnull +8 -> 359
    //   354: aload 9
    //   356: invokevirtual 409	azhs:close	()V
    //   359: aload_0
    //   360: getfield 30	aoyd:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   363: aload 11
    //   365: iconst_1
    ...
    //   379: aload_0
    //   380: getfield 30	aoyd:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   383: aload 11
    //   385: iconst_1
    ...
    //   400: lstore 6
    //   402: aload_0
    //   403: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   406: lload 4
    //   408: lload 6
    //   410: invokestatic 298	bhkf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;JJ)J
    //   413: pop2
    //   414: iload_3
    //   415: iconst_m1
    ...
    //   434: aload_0
    //   435: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   471: aload_0
    //   472: aload_0
    //   473: getfield 37	aoyd:jdField_b_of_type_Int	I
    //   476: iconst_1
    //   477: iadd
    //   478: putfield 37	aoyd:jdField_b_of_type_Int	I
    //   481: aload_0
    //   482: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   485: iload_1
    //   486: iconst_1
    //   487: invokestatic 428	bhkf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;II)I
    //   490: pop
    //   491: aload_0
    //   492: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   495: iload_2
    //   496: aload 11
    //   498: invokevirtual 406	java/util/ArrayList:size	()I
    //   501: invokestatic 430	bhkf:b	(Lcom/tencent/mobileqq/app/QQAppInterface;II)I
    //   504: pop
    //   505: iconst_1
    //   506: ireturn
    ...
    //   517: lstore 6
    //   519: aload_0
    //   520: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   523: lload 4
    //   525: lload 6
    //   527: invokestatic 298	bhkf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;JJ)J
    //   530: pop2
    //   531: aload_0
    //   532: aload_0
    //   533: getfield 37	aoyd:jdField_b_of_type_Int	I
    //   536: iconst_1
    //   537: iadd
    //   538: putfield 37	aoyd:jdField_b_of_type_Int	I
    //   541: goto -60 -> 481
    //   544: astore 8
    //   546: aload 10
    //   548: astore 9
    ...
    //   624: aload_0
    //   625: getfield 37	aoyd:jdField_b_of_type_Int	I
    ...
    //   639: ifnull +8 -> 647
    //   642: aload 9
    //   644: invokevirtual 409	azhs:close	()V
    //   647: iconst_0
    //   648: ireturn
    //   649: astore 10
    //   651: aload 8
    ...
    //   695: aload_0
    //   696: getfield 37	aoyd:jdField_b_of_type_Int	I
    ...
    //   710: ifnull +8 -> 718
    //   713: aload 9
    //   715: invokevirtual 409	azhs:close	()V
    //   718: aload_0
    //   719: getfield 30	aoyd:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   722: aload 11
    //   724: iconst_1
    ...
    //   738: aload_0
    //   739: getfield 30	aoyd:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   742: aload 11
    //   744: iconst_1
    ...
    //   759: lstore 6
    //   761: aload_0
    //   762: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   765: lload 4
    //   767: lload 6
    //   769: invokestatic 298	bhkf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;JJ)J
    //   772: pop2
    //   773: iload_3
    //   774: iconst_m1
    ...
    //   793: aload_0
    //   794: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   830: aload_0
    //   831: aload_0
    //   832: getfield 37	aoyd:jdField_b_of_type_Int	I
    //   835: iconst_1
    //   836: iadd
    //   837: putfield 37	aoyd:jdField_b_of_type_Int	I
    //   840: aload_0
    //   841: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   844: iload_1
    //   845: iconst_1
    //   846: invokestatic 428	bhkf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;II)I
    //   849: pop
    //   850: aload_0
    //   851: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   854: iload_2
    //   855: aload 11
    //   857: invokevirtual 406	java/util/ArrayList:size	()I
    //   860: invokestatic 430	bhkf:b	(Lcom/tencent/mobileqq/app/QQAppInterface;II)I
    //   863: pop
    //   864: aload 8
    //   866: athrow
    ...
    //   877: lstore 6
    //   879: aload_0
    //   880: getfield 23	aoyd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   883: lload 4
    //   885: lload 6
    //   887: invokestatic 298	bhkf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;JJ)J
    //   890: pop2
    //   891: aload_0
    //   892: aload_0
    //   893: getfield 37	aoyd:jdField_b_of_type_Int	I
    //   896: iconst_1
    //   897: iadd
    //   898: putfield 37	aoyd:jdField_b_of_type_Int	I
    //   901: goto -61 -> 840
    //   904: astore 8
    //   906: goto -247 -> 659
    //   909: astore 10
  ...
  public boolean a()
  {
    return !bhkf.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  
  public boolean b()
  {
    if (bhkf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.d("Q.fts.FTSMsgUpgrader", 2, "========== upgrade log has complete");
      return c();
    }
    QLog.d("Q.fts.FTSMsgUpgrader", 2, "========== upgrade log start");
    long l3 = bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
          bool = c();
          return bool;
        }
        HashMap localHashMap = new HashMap();
      ...
      finally
      {
        ...
        bhkf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l3, l1);
      }
    }
  }
}
