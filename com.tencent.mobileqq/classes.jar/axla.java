...
public class axla
{
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, axlm paramaxlm)
  {
    ...
    if (!TextUtils.isEmpty(paramString5))
    {
      ...
      if (a.getStatus() == 1)
      {
        yqp.c("ShortVideoShareUtil", "URLDrawable's status is SUCCESSED.");
        b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, a(a), paramaxlm);
        return;
      }
      if (a.getStatus() == 2)
      {
        b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, null, paramaxlm);
        a.downloadImediatly();
        return;
      }
      yqp.c("ShortVideoShareUtil", "start load URLDrawable.");
      a.setURLDrawableListener(new axlf(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, paramaxlm));
      a.downloadImediatly();
      return;
    }
    b(paramBaseActivity, paramString1, paramString2, paramString3, paramString4, null, paramaxlm);
  ...
  {
    paramString1 = new bcvp(StructMsgForGeneralShare.class).c(131).a(paramString2).a("web", paramString4, null, null, null).a();
    paramString4 = bcwc.a(2);
    ...
    aufz.a(paramBaseActivity, paramString2, 123);
  }
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, int paramInt, String paramString6)
  {
    ...
    paramString4 = new bcvp(StructMsgForGeneralShare.class).c(131).a(paramString2).a("web", paramString4, null, null, null).a();
    bcvt localbcvt = bcwc.a(2);
    localbcvt.a(paramString5, paramString2, paramString3, 0);
    paramString4.addItem(localbcvt);
    ...
    aufz.a(paramBaseActivity, paramString1, ForwardRecentTranslucentActivity.class, 123, 100500, "biz_src_hdsp_nearby");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, URLDrawable paramURLDrawable, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    ((ShareActionSheet)localObject).setItemClickListenerV2(new axlb(paramBaseActivity, paramString2, paramString4, paramString5, paramString3, paramString6, paramString7, paramQQAppInterface));
    ((ShareActionSheet)localObject).setCancelListener(new axle(paramOnDismissListener));
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    bltb.a(paramString1, paramBaseActivity, paramString5, null, 124);
    new axlq().h("video").i("playpage_fw_suc").a().a(paramString1);
  }
  
  static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, axlm paramaxlm)
  {
    ...
    if (!TextUtils.isEmpty(paramString5))
    {
      ...
      if (a.getStatus() == 1)
      {
        ...
        if (paramString1 == null) {
          paramBaseActivity = bggl.b(BaseApplicationImpl.getApplication().getResources(), 2130845311);
        }
        WXShareHelper.a().a(new axlh(str, paramaxlm));
        WXShareHelper.a().a(str, paramString2, paramBaseActivity, paramString3, paramString4);
        new axlq().h("video").i("playpage_fw_suc").a().a(paramString5);
      }
    }
    else
    {
    ...
    if (a.getStatus() == 2)
    {
      ...
      WXShareHelper.a().a(new axli(str, paramaxlm));
      WXShareHelper.a().a(str, paramString2, paramBaseActivity, paramString3, paramString4);
      a.downloadImediatly();
      new axlq().h("video").i("playpage_fw_suc").a().a(paramString5);
      return;
    ...
    yqp.c("ShortVideoShareUtil", "start load URLDrawable.");
    a.setURLDrawableListener(new axlj(str, paramaxlm, paramString2, paramString3, paramString4, paramString5));
    a.startDownload();
  }
  
  private static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap, axlm paramaxlm)
  {
    String str = String.valueOf(System.currentTimeMillis());
    if (paramBitmap == null) {}
    for (paramString1 = bggl.b(BaseApplicationImpl.getApplication().getResources(), 2130845311);; paramString1 = paramBitmap)
    {
      WXShareHelper.a().a(new axlg(str, paramaxlm));
      WXShareHelper.a().b(str, paramString2, paramString1, paramString3, paramString4);
      new axlq().h("video").i("playpage_fw_suc").a().a(paramQQAppInterface);
      return;
    }
  }
}
