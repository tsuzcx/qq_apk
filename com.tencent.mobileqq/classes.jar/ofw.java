    ...
    for (int j = 1;; j = 0)
    {
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          {
            localObject2 = (ogr)paramAppInterface.getBusinessHandler(0);
            if (localObject2 == null) {
              break label339;
            }
            ((ogr)localObject2).a(i, null, paramString2, null, null, 0L, false);
            return;
            i += 1;
            break;
          }
