...
public class spt
  implements spo
{
  protected sfq<String, VideoCollectionItem> a;
  protected uhi a;
  protected sfq<String, MemoryInfoEntry> b = new sfq(300);
  ...
  protected static List<? extends atmo> a(atmp paramatmp, Class<? extends atmo> paramClass, String paramString1, String paramString2, String[] paramArrayOfString)
  {
  ...
  public ShareGroupCollectionItem a(String paramString)
  {
    ...
    {
      return localObject;
      localShareGroupCollectionItem = (ShareGroupCollectionItem)this.jdField_a_of_type_Sfq.a(paramString);
    ...
    paramString = a((atmp)localObject, VideoCollectionEntry.class, VideoCollectionEntry.class.getSimpleName(), VideoCollectionEntry.getKeySelectionNoArgs(), new String[] { paramString });
    if ((paramString == null) || (paramString.size() == 0)) {
      return null;
    }
    ...
    paramString = ((uac)sqg.a(7)).a(localShareGroupCollectionItem.groupId);
    if (paramString == null) {
      return null;
    }
    localShareGroupCollectionItem.shareGroupItem = paramString;
    paramString = a((atmp)localObject, StoryVideoListEntry.class, StoryVideoListEntry.class.getSimpleName(), StoryVideoListEntry.getCollectionSelectionNoArg(), new String[] { String.valueOf(5), localShareGroupCollectionItem.key });
    if (paramString != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject = localsqd.a(localStoryVideoListEntry.vid);
    ...
    this.jdField_a_of_type_Sfq.a(localShareGroupCollectionItem.key, localShareGroupCollectionItem);
  ...
  public VideoCollectionItem a(@NonNull VideoCollectionItem paramVideoCollectionItem)
  {
    ...
    paramVideoCollectionItem = (VideoCollectionItem)this.jdField_a_of_type_Sfq.a(paramVideoCollectionItem.key, paramVideoCollectionItem);
    atmp localatmp = a().a().createEntityManager();
    if (localatmp.a(paramVideoCollectionItem.convertTo())) {
      a(localatmp, paramVideoCollectionItem.key, paramVideoCollectionItem.videoVidList, true);
    }
  ...
  public VideoCollectionItem a(String paramString)
  {
    ...
    {
      return localObject1;
      localObject2 = (VideoCollectionItem)this.jdField_a_of_type_Sfq.a(paramString);
      localObject1 = localObject2;
    } while (localObject2 != null);
    Object localObject1 = a().a().createEntityManager();
    paramString = a((atmp)localObject1, VideoCollectionEntry.class, VideoCollectionEntry.class.getSimpleName(), VideoCollectionEntry.getKeySelectionNoArgs(), new String[] { paramString });
    if ((paramString == null) || (paramString.size() == 0)) {
      return null;
    }
    paramString = new VideoCollectionItem((VideoCollectionEntry)paramString.get(0));
    Object localObject2 = a((atmp)localObject1, StoryVideoListEntry.class, StoryVideoListEntry.class.getSimpleName(), StoryVideoListEntry.getCollectionSelectionNoArg(), new String[] { String.valueOf(5), paramString.key });
    if (localObject2 != null)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        StoryVideoItem localStoryVideoItem = ((sqd)localObject1).a(str);
        paramString.videoVidList.add(str);
        paramString.collectionVideoUIItemList.add(new uhj(str, localStoryVideoItem));
      }
    }
    this.jdField_a_of_type_Sfq.a(paramString.key, paramString);
    return paramString;
  }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = sqd.a(QQStoryContext.a().a().createEntityManager(), MemoriesYearNodeEntry.class, MemoriesYearNodeEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
      return localArrayList;
    }
  ...
  public List<VideoCollectionItem> a(String paramString, VideoCollectionItem paramVideoCollectionItem, long paramLong)
  {
    ...
    for (long l = -1L;; l = paramVideoCollectionItem.dbIndex)
    {
      ...
      paramString = localatmp.a(VideoCollectionEntry.class, paramVideoCollectionItem, true, str2, new String[] { paramString, String.valueOf(l) }, null, null, "dbIndex asc", str3);
      if (paramString != null) {
        break;
      }
      return localArrayList;
    }
    urk.a("MemoryManager", "query sql = %s , resultCount = %d", str1, Integer.valueOf(paramString.size()));
    paramString = paramString.iterator();
    while (paramString.hasNext())
    {
  ...
  protected void a(atmp paramatmp, String paramString, List<String> paramList, boolean paramBoolean)
  {
    Object localObject;
    if (paramBoolean)
    {
      ...
      paramatmp.a((atmo)localObject, StoryVideoListEntry.getCollectionSelectionNoArg(), new String[] { String.valueOf(5), paramString });
    }
    ...
    while (paramList.hasNext())
    {
      ...
      paramatmp.b(localStoryVideoListEntry);
    }
  }
  ...
  {
    atmp localatmp = a().a().createEntityManager();
    paramVideoCollectionItem = a(localatmp, VideoCollectionEntry.class, VideoCollectionEntry.class.getSimpleName(), VideoCollectionEntry.getKeySelectionNoArgs(), new String[] { paramVideoCollectionItem.key });
    if (paramVideoCollectionItem != null)
    {
      ...
      while (paramVideoCollectionItem.hasNext())
      {
        ...
        localatmp.b(localVideoCollectionEntry);
      }
    }
  }
  ...
  protected void a(List<VideoCollectionItem> paramList, VideoCollectionItem paramVideoCollectionItem)
  {
    if (paramList.indexOf(paramVideoCollectionItem) > 0) {
      urk.b("MemoryManager", "data already exist, id=%s, time=%d", paramVideoCollectionItem.collectionId, Long.valueOf(paramVideoCollectionItem.collectionTime));
    }
    int i;
    do
    {
      return;
      i = Collections.binarySearch(paramList, paramVideoCollectionItem, this.jdField_a_of_type_Uhi);
    } while (i >= 0);
  ...
  public void a(List<VideoCollectionItem> paramList, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        localObject = a(localatmp, VideoCollectionEntry.class, VideoCollectionEntry.class.getSimpleName(), VideoCollectionEntry.getUinSelectionNoArgs(), new String[] { paramString });
        if (localObject != null)
        {
          localObject = ((List)localObject).iterator();
          while (((Iterator)localObject).hasNext())
      ...
      localObject = a(swm.a(paramString));
    }
    finally
    {
      localatmr.b();
    ...
    for (paramString = new MemoryInfoEntry(paramString);; paramString = (String)localObject)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localObject = (VideoCollectionItem)this.jdField_a_of_type_Sfq.a(((VideoCollectionItem)localObject).key, (sfp)localObject);
        ((VideoCollectionItem)localObject).videoItemList = localsqd.a(((VideoCollectionItem)localObject).videoItemList);
        a(localatmp, ((VideoCollectionItem)localObject).key, ((VideoCollectionItem)localObject).videoVidList, true);
        a(((VideoCollectionItem)localObject).key);
        localatmp.b(((VideoCollectionItem)this.jdField_a_of_type_Sfq.a(((VideoCollectionItem)localObject).key, (sfp)localObject)).convertTo());
      }
      localatmr.c();
      a(paramString);
      localatmr.b();
  ...
  public void a(List<MomeriesYearNode> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        localatmp.b(((MomeriesYearNode)paramList.next()).convertTo());
      }
    }
    finally
    {
  ...
  public void b()
  {
    this.jdField_a_of_type_Sfq.a(20);
  }
  ...
  public void b(List<ShareGroupCollectionItem> paramList, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        paramString = a(localatmp, VideoCollectionEntry.class, VideoCollectionEntry.class.getSimpleName(), "unionId=? and collectionType=?", new String[] { paramString, String.valueOf(4) });
        if (paramString != null)
        {
          paramString = paramString.iterator();
          while (paramString.hasNext())
    ...
    while (paramList.hasNext())
    {
      ...
      paramString = (ShareGroupCollectionItem)this.jdField_a_of_type_Sfq.a(paramString.key, paramString);
      paramString.shareGroupItem = localuac.a(paramString.shareGroupItem);
      paramString.videoItemList = localsqd.a(paramString.videoItemList);
      a(localatmp, paramString.key, paramString.videoVidList, true);
      localatmp.b(paramString.convertTo());
    }
    localatmr.c();
    localatmr.b();
  }
