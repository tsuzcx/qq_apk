...
{
  public ajgv(TroopGiftAnimationController paramTroopGiftAnimationController) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      str1 = TroopGiftAnimationController.a(this.a).getResources().getString(2131430736);
    ...
    for (paramString = "0";; paramString = "1")
    {
      ...
      break label546;
      label497:
      paramString = TroopGiftAnimationController.a(this.a).getResources().getString(2131430737);
      break label299;
