  ...
  implements InputFilter
{
  ...
  public bnvr(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    akxd localakxd = ExtendEditText.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localakxd == null)
    {
