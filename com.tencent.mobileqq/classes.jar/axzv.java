...
public class axzv
{
  private static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    if (paramQQAppInterface != null)
    {
      i = j;
      if (localakaq != null) {
        i = localakaq.a(paramQQAppInterface.frienduin, paramQQAppInterface.istroop);
      }
    }
    return i;
  }
  ...
  {
    Object localObject = paramQQAppInterface.a(1001).a(ajed.ai, 1001);
    if (localObject == null)
    {
  ...
  {
    Object localObject1 = paramQQAppInterface.a(1001).a(ajed.ai, 1001);
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == ((ArrayList)localObject2).size())
      {
        ...
        paramQQAppInterface.a().a(ajed.H, 1001, ajed.ai, paramQQAppInterface.getCurrentAccountUin());
        return;
      }
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramQQAppInterface.a().a(ajed.ai, 1001, (String)localObject2, paramQQAppInterface.getCurrentAccountUin());
      }
    }
  }
  ...
  {
    int i = 0;
    Object localObject = paramQQAppInterface.a(1001).a(ajed.H, 1001);
    if (localObject == null)
    {
    ...
    try
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if (ajed.ai.equals(localMessageRecord.senderuin))
        {
          a(paramQQAppInterface, localJSONObject2);
          break label402;
        }
        if ((!ajed.ak.equals(localMessageRecord.senderuin)) && (!ajed.al.equals(localMessageRecord.senderuin)) && (!ajed.am.equals(localMessageRecord.senderuin)) && (!ajed.an.equals(localMessageRecord.senderuin)) && (!ajed.ao.equals(localMessageRecord.senderuin)))
        {
          localArrayList.add(localMessageRecord);
  ...
  public static final void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      default: 
        return;
      case 1: 
        a(paramQQAppInterface, paramString, ajed.H);
        return;
      }
      a(paramQQAppInterface, paramString, ajed.ai);
      return;
    }
