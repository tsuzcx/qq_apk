  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = paramView.getTag(2131376577);
    if ((localObject1 != null) && ((localObject1 instanceof axzx)))
    {
      localObject7 = (axzx)localObject1;
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          l1 = l2;
          if (((axzx)localObject7).a.getDrawable() != null)
          {
            l1 = l2;
            if ((((axzx)localObject7).a.getDrawable() instanceof URLDrawable))
            {
              localObject3 = (URLDrawable)((axzx)localObject7).a.getDrawable();
              l1 = l2;
          ...
          paramView = (String)paramView.getTag(2131376583);
        } while (TextUtils.isEmpty(paramView));
        String str = bfng.a(bfng.a(paramView, "progress", String.valueOf(l1)), "msgId", (String)localObject1);
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            try
            {
              ...
              localObject7 = new nra();
              ((nra)localObject7).a = 3;
              ((nra)localObject7).f = 1;
              localObject7 = nqx.a((nra)localObject7, this.a.a.message);
              ((nqx)((QQAppInterface)localObject5).a(139)).a((nra)localObject7, null);
              Long.parseLong((String)localObject1);
              if (this.a.a != null) {
                localObject5 = (axun)((AbsShareMsg)this.a.a).mStructMsgItemLists.get(0);
              }
              ...
              paramView = (nqq)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(88);
              if (paramView == null) {
                break;
              }
