...
public class yho
{
  ...
  private static yho jdField_a_of_type_Yho;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private String b = aljq.cV;
  private String c = aljq.cW;
  ...
  public static yho a()
  {
    try
    {
      if (jdField_a_of_type_Yho == null) {
        jdField_a_of_type_Yho = new yho();
      }
      yho localyho = jdField_a_of_type_Yho;
      return localyho;
    }
    finally {}
  }
  
  public void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, yhs paramyhs)
  {
    boolean bool = true;
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.1(this, paramString1, paramString2, paramString3, paramString4, paramyhs));
      return;
    }
    if (paramyhs != null) {
      paramyhs.a(3, false, paramString2, new Object[0]);
    }
    QLog.d(jdField_a_of_type_JavaLangString, 4, "modifyDraft failed because something is empty");
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, int paramInt, yhz paramyhz)
  {
    ...
    do
    {
      ...
      paramContext.a(new yhp(this, paramyhz, paramString1, paramContext));
      paramContext.a(new yhq(this, paramString1, paramString2, paramyhz, paramContext));
    } while (paramContext.isShowing());
    paramContext.show();
  }
  
  public void a(String paramString1, String paramString2, yhs paramyhs)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.4(this, paramString1, paramString2, paramyhs));
  }
  
  public void a(String paramString, yhs paramyhs)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.2(this, paramString, paramyhs));
  }
  ...
  public void b(String paramString1, String paramString2, yhs paramyhs)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "deletDraft failed because uin or draftID is empty");
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.5(this, paramString1, paramString2, paramyhs));
  }
}
