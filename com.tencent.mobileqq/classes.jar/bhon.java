  ...
  extends WebViewClient
{
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramWebView = new Bundle();
          paramWebView.putStringArrayList("recognised-text", bhqf.a());
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      afuh.b(this.b.jdField_a_of_type_AndroidContentIntent, str);
      paramString = bhre.b(str);
      if ((this.b.jdField_a_of_type_Bhnj == null) || (!this.b.jdField_a_of_type_Bhnj.beforeWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str))) {
        break label298;
      }
      ...
      break;
      label261:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + nmj.b(str, new String[0]));
    }
    label298:
    ...
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Bhnj != null) && (this.b.jdField_a_of_type_Bhnj.shouldOverrideUrlLoading(paramWebView, str))) {
        return true;
      }
      ...
      {
        boolean bool = this.b.jdField_a_of_type_Bhnj.afterWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str);
        if (bool) {
          return true;
        }
      }
