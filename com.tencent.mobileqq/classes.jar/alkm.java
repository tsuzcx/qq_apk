...
public class alkm
{
  ...
  {
    bcst.b(null, "dc00898", "", "", "0X80072C1", "0X80072C1", 0, 0, "", "", "", "");
  }
  ...
  public static void a(int paramInt)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "acQQFilterDownload", true, 0L, 0L, localHashMap, null);
  }
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    bctj.a(BaseApplicationImpl.getApplication()).a(null, "actSetPreviewSizeWay", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      paramString3 = ((aowp)localEntry.getValue()).a();
    ...
    for (;;)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "dynamic_adjustment_on_destroy", true, paramString1.jdField_a_of_type_ArrayOfLong[((int)(paramString1.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
      a(localHashMap, "DynamicAdjustment", "dynamic_adjustment_on_destroy");
      return;
    }
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, aowq paramaowq)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("camera_type", paramString1);
    ...
    localHashMap.put("is_dynamic", VideoEnvironment.a.d + "");
    if ((paramaowq == null) || (paramaowq.jdField_a_of_type_ArrayOfLong == null) || (paramaowq.jdField_a_of_type_ArrayOfLong.length == 0)) {
      return;
    }
    localHashMap.put("cost_time", paramaowq.jdField_a_of_type_ArrayOfLong[((int)(paramaowq.jdField_a_of_type_ArrayOfLong.length * 0.5F))] + "");
    bctj.a(BaseApplication.getContext()).a(null, "dynamic_adjustment_on_triggering", true, paramaowq.jdField_a_of_type_ArrayOfLong[((int)(paramaowq.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (String str = "0"; (!bgsp.a(paramString1)) || (!aqbj.a()); str = "1")
    {
      bcst.b(null, "dc00898", "", "", "0X80072C3", "0X80072C3", 0, 0, str, paramString1, "", "");
      if (paramBoolean) {
        bcst.b(null, "dc00898", "", "", "0X80083B0", "0X80083B0", 0, 0, str, paramString1, "", "");
      }
      if (!bgsp.a(paramString2)) {
        bcst.b(null, "dc00898", "", "", "0X80083B6", "0X80083B6", 0, 0, paramString1, "", paramString2, "");
      }
      return;
    }
    bcst.b(null, "dc00898", "", "", "0X80072C2", "0X80072C2", 0, 0, str, "", "", "");
  }
  ...
  public static void a(String paramString1, boolean paramBoolean, String paramString2, long paramLong)
  {
    ...
    for (paramString1 = "beauty";; paramString1 = "nBeauty")
    {
      ...
      paramString2 = (aowp)jdField_a_of_type_JavaUtilMap.get(localObject);
      paramString1 = paramString2;
      if (paramString2 == null)
      {
        paramString1 = new aowp(2147483647);
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "photo_shot_from_shortvideo", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "actSetPhotoClipSize", paramBoolean, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean2, int paramInt5, boolean paramBoolean3)
  {
    ...
    {
      localbctj.a(null, "actShootPhotoClip", bool, 0L, 0L, localHashMap, "");
      if (QLog.isColorLevel()) {
  ...
  public static void b(int paramInt)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(null, "acQQfilterView", true, 0L, 0L, localHashMap, null);
  }
  ...
  public static void l()
  {
    ...
    while (localIterator.hasNext()) {
      ((aowp)((Map.Entry)localIterator.next()).getValue()).a();
    }
    jdField_a_of_type_JavaLangString = "";
  }
}
