...
public class bfwr
{
  ...
  public void a(Canvas paramCanvas, bfws parambfws)
  {
    if ((paramCanvas == null) || (parambfws == null)) {
      return;
    }
    if ((this.jdField_a_of_type_Boolean) && (a()))
    {
      this.jdField_a_of_type_AndroidGraphicsRectF.set(0.0F, 0.0F, parambfws.getWidth(), parambfws.getHeight());
      int i = this.e;
      if (b()) {
        i = c;
      }
