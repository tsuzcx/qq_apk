  ...
  implements Manager
{
  ...
  public akjw(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Acsr = new acsr(paramQQAppInterface);
    acsq.a(paramQQAppInterface);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, submsgtype0xeb.MsgBody paramMsgBody)
  {
    ...
    int j = 0;
    Object localObject1 = paramQQAppInterface.a().b(ajsf.ad, 9002);
    ...
    {
      if (i != 0) {
        paramQQAppInterface.a().c(ajsf.ad, 9002);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if ((paramInt == 2) || (paramInt == 3))
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007210", "0X8007211", 0, 0, "", "", "", "");
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putLong("key_last_birth_msg_stamp", awzw.a()).commit();
  ...
  public void a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localMessageForText.frienduin = ajsf.ad;
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.list.show", 0, 0, "", "", paramString2, "");
      return;
    }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    if (paramLong > NetConnInfoCenter.getServerTime())
    {
      ...
      acso localacso = (acso)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(321);
      if (localacso != null)
      {
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean2)
    {
      ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).l(paramBoolean1);
      return;
    }
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695237) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBoolean1).commit();
  }
  ...
  {
    if (paramBoolean) {
      ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).v();
    }
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695237) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
  }
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695237) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
  ...
  public void c()
  {
    ...
    akjv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, true, false, true);
  }
  ...
  public void e()
  {
    ...
    try
    {
      str1 = acrt.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd");
      if (QLog.isColorLevel()) {
    ...
    l1 += acrt.a(NetConnInfoCenter.getServerTimeMillis());
    if (QLog.isColorLevel()) {
      QLog.i("ActivateFriends.Manager", 2, "do login currentDelayTs: " + acrt.a(l1, "yyyy-MM-dd HH:mm:ss"));
    }
    ...
    {
      this.jdField_a_of_type_Acsr.a(str1, new akjx(this, str1));
      return;
    }
  }
