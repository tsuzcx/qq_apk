...
{
  public afkf(NearbyProfileDisplayTribePanel paramNearbyProfileDisplayTribePanel) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (paramBundle = "关注成功";; paramBundle = "已取消关注")
    {
      ...
      {
        paramBundle = (Button)NearbyProfileDisplayTribePanel.a(this.a).getChildAt(1).findViewById(2131365278);
        paramBundle.setTextColor(this.a.a.getResources().getColor(2131494242));
        paramBundle.setBackgroundDrawable(this.a.a.getResources().getDrawable(2130838497));
      }
      if (NearbyProfileDisplayTribePanel.a(this.a))
      {
        paramBundle = (Button)NearbyProfileDisplayTribePanel.a(this.a).getChildAt(1).findViewById(2131365278);
        paramBundle.setTextColor(this.a.a.getResources().getColor(2131494244));
        paramBundle.setBackgroundDrawable(this.a.a.getResources().getDrawable(2130838537));
        return;
        QQToast.a(this.a.a, 1, "操作失败，请稍后重试", 1).a();
        return;
        QQToast.a(this.a.a, 1, "操作失败，请稍后重试", 1).a();
