...
{
  public aglh(ScanTorchActivity paramScanTorchActivity) {}
  ...
  public void onGetARRedDotInfo(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    for (paramInt = 1; paramInt != 0; paramInt = 0)
    {
      if (paramLong > l)
      {
        this.a.runOnUiThread(new aglk(this));
      ...
      {
        this.a.n = false;
        this.a.runOnUiThread(new agll(this));
        localSharedPreferences.edit().putBoolean("key_show_reddot", false).commit();
      }
      return;
    }
    this.a.n = false;
    this.a.runOnUiThread(new aglm(this));
  }
  ...
  public void onOpenPOI(boolean paramBoolean1, int paramInt1, ItemInfo paramItemInfo, boolean paramBoolean2, int paramInt2, int paramInt3, boolean paramBoolean3)
  {
    ...
    if (this.a.jdField_a_of_type_AndroidOsHandler.hasMessages(297))
    {
      ...
      default: 
        ...
        paramInt1 = 299;
        l = 2000L;
        this.a.jdField_a_of_type_AndroidOsHandler.post(new agli(this, paramItemInfo));
    ...
    this.a.jdField_a_of_type_AndroidOsHandler.post(new aglj(this, paramItemInfo));
