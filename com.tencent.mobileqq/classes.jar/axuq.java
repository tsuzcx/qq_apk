  ...
  extends axup
{
  ...
  protected axuq(Collection<axup> paramCollection)
  {
    this.jdField_a_of_type_JavaLangString = "item";
  ...
  {
    if (((paramaxup instanceof axur)) && (!b())) {
      ((axur)paramaxup).S = null;
    }
  ...
  public void a(AbsShareMsg paramAbsShareMsg)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((axup)localIterator.next()).a(paramAbsShareMsg);
    }
  }
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    for (;;)
    {
      label182:
      str = b();
      if ((str != null) && (localObject != null) && ((localObject instanceof axws)))
      {
        if ((!str.endsWith("Layout4")) && (!str.endsWith("Layout2")) && (!str.endsWith("Layout9"))) {
          break label350;
        }
        ((axws)localObject).p = axws.jdField_m_of_type_Int;
      }
      int j;
      for (;;)
      {
        ...
        i1 += 1;
        break;
        localObject = axuz.a(str);
        j = i;
        if ("button".equals(str))
        {
          ((axup)localObject).Q = String.valueOf(i);
          ((axup)localObject).R = this.R;
          j = i + 1;
        }
        if ((localObject == null) || (!axuq.class.isInstance(localObject))) {
          break label874;
        }
        ...
        if (str.endsWith("Layout3")) {
          ((axws)localObject).p = axws.jdField_n_of_type_Int;
        }
      }
  ...
  public void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    a(new axws(paramString1, paramString3));
  ...
  {
    this.jdField_k_of_type_Int = paramInt;
    a(new axws(paramString1, paramString4));
    a(new StructMsgItemTitle(paramString2));
    a(new axzj(paramString3));
  }
  ...
  public void a(XmlSerializer paramXmlSerializer)
  {
    ...
    for (Object localObject = "0";; localObject = String.valueOf(this.jdField_n_of_type_Int))
    {
      ...
      localObject = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((axup)((Iterator)localObject).next()).a(paramXmlSerializer);
      }
    }
  ...
  public boolean a(axwg paramaxwg)
  {
    ...
    {
      return bool1;
      this.jdField_c_of_type_JavaLangString = paramaxwg.a("action");
      this.jdField_d_of_type_JavaLangString = paramaxwg.a("actionData");
      this.jdField_e_of_type_JavaLangString = paramaxwg.a("a_actionData");
      this.jdField_f_of_type_JavaLangString = paramaxwg.a("i_actionData");
      this.b = paramaxwg.a("url");
      this.jdField_g_of_type_JavaLangString = paramaxwg.a("brief");
      this.q = paramaxwg.a("apurl");
      Object localObject1 = paramaxwg.a("flag");
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      try
      {
        this.jdField_i_of_type_Int = Integer.parseInt((String)localObject1);
        localObject1 = paramaxwg.a("mode");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {}
      }
      catch (NumberFormatException localNumberFormatException8)
      {
        ...
        catch (NumberFormatException localNumberFormatException8)
        {
          try
          {
            ...
            {
              this.jdField_h_of_type_JavaLangString = paramaxwg.a("businessData");
              this.jdField_i_of_type_JavaLangString = paramaxwg.a("commonData");
              this.j = paramaxwg.a("index");
              this.jdField_k_of_type_JavaLangString = paramaxwg.a("index_name");
              this.jdField_l_of_type_JavaLangString = paramaxwg.a("index_type");
              this.o = paramaxwg.a("canvas");
              this.jdField_m_of_type_JavaLangString = paramaxwg.a("rurl");
              this.p = paramaxwg.a("disType");
              this.jdField_n_of_type_JavaLangString = paramaxwg.a("tid");
              if (this.jdField_a_of_type_Int > 10)
              {
                localObject1 = paramaxwg.a;
                if (localObject1 != null)
                {
                  localObject3 = ((axwg)localObject1).a("action_type");
          ...
          catch (IllegalArgumentException localNumberFormatException8)
          {
            try
            {
              ...
              localObject3 = ((axwg)localObject1).a("dest_type");
              if (TextUtils.isEmpty((CharSequence)localObject3)) {}
            }
            catch (NumberFormatException localNumberFormatException8)
            {
              try
              {
                ...
                localObject3 = ((axwg)localObject1).a("product_type");
                if (TextUtils.isEmpty((CharSequence)localObject3)) {}
              }
              catch (NumberFormatException localNumberFormatException8)
              {
                try
                {
                  ...
                  this.r = ((axwg)localObject1).a("advertiser_id");
                  this.s = ((axwg)localObject1).a("aid");
                  this.t = ((axwg)localObject1).a("app_download_schema");
                  this.u = ((axwg)localObject1).a("canvas_json");
                  this.v = ((axwg)localObject1).a("customized_invoke_url");
                  this.w = ((axwg)localObject1).a("effect_url");
                  this.x = ((axwg)localObject1).a("landing_page");
                  this.y = ((axwg)localObject1).a("landing_page_report_url");
                  this.z = ((axwg)localObject1).a("noco_id");
                  this.A = ((axwg)localObject1).a("product_id");
                  this.B = ((axwg)localObject1).a("rl");
                  this.C = ((axwg)localObject1).a("subordinate_product_id");
                  this.D = ((axwg)localObject1).a("traceid");
                  this.E = ((axwg)localObject1).a("via");
                  this.F = ((axwg)localObject1).a("video_url");
                  this.G = ((axwg)localObject1).a("appname");
                  this.H = ((axwg)localObject1).a("customized_invoke_url");
                  this.I = ((axwg)localObject1).a("pkg_name");
                  this.J = ((axwg)localObject1).a("pkgurl");
                  this.q = ((axwg)localObject1).a("apurl");
                  if (this.jdField_a_of_type_Int > 11)
                  {
                    localObject1 = paramaxwg.a;
                    if (localObject1 != null)
                    {
                      this.K = ((axwg)localObject1).a("api_click_monitor_url");
                      this.L = ((axwg)localObject1).a("api_exposure_monitor_url");
                      this.M = ((axwg)localObject1).a("trace_info_aid");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 12)
                  {
                    ...
                    if (localObject1 != null)
                    {
                      this.N = ((axwg)localObject1).a("corporate_image_name");
                      this.O = ((axwg)localObject1).a("corporate_logo");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 13)
                  {
                    localObject1 = paramaxwg.a.a("mini_program_type");
                    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
                  }
                }
                catch (NumberFormatException localNumberFormatException8)
                {
                  try
                  {
                    ...
                    if (this.jdField_a_of_type_Int > 14)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        localObject3 = ((axwg)localObject1).a("tab_id");
                  ...
                  catch (NumberFormatException localNumberFormatException8)
                  {
                    try
                    {
                      ...
                      localObject1 = ((axwg)localObject1).a("is_hidden");
                    ...
                    catch (NumberFormatException localNumberFormatException8)
                    {
                      ...
                      catch (NumberFormatException localNumberFormatException4)
                      {
                        ...
                        for (Object localObject2 = localNumberFormatException8.a("layout");; localObject2 = axuz.a(localNumberFormatException8.b))
                        {
                          try
                          {
                            ...
                            {
                              localObject2 = axuz.a(j);
                              bool1 = bool2;
                              if (localObject2 == null) {
                                break;
                              }
                              bool1 = bool2;
                              if (!((axup)localObject2).a(localNumberFormatException8)) {
                                break;
                              }
                              a((axup)localObject2);
                              break label857;
  ...
  public void b(View paramView)
  {
    ...
    do
    {
      ...
      paramView.setBackgroundResource(2130838130);
      break;
      paramView = paramView.findViewById(2131376574);
  ...
  protected void d(View paramView)
  {
    ...
    do
    {
      ...
      int i = actj.a(4.0F, paramView.getResources());
      float f1 = i;
      float f2 = i;
      float f3 = i;
      float f4 = i;
      localStateListDrawable = axwj.a(paramView.getResources(), this.jdField_l_of_type_Int, new float[] { f1, f2, f3, f4, 0.0F, 0.0F, 0.0F, 0.0F });
