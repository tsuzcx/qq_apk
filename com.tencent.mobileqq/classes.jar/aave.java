...
public class aave
{
  ...
  static
  {
    ...
    a.add("pulldownRefreshMinDistance".toLowerCase());
    a.add("ark_scene_white_list".toLowerCase());
    b = new HashSet();
  ...
  {
    // Byte code:
    //   0: invokestatic 79	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   3: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   6: getstatic 89	com/tencent/common/config/provider/QZoneConfigProvider:f	Landroid/net/Uri;
    //   9: aconst_null
    //   10: aconst_null
    //   11: aconst_null
    //   12: aconst_null
    //   13: invokevirtual 95	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   16: astore_2
    //   17: aload_2
    //   18: ifnull +39 -> 57
    //   21: aload_2
    ...
    //   31: aload_2
    //   32: ldc 103
    //   34: invokeinterface 107 2 0
    //   39: invokeinterface 111 2 0
    //   44: lstore_0
    //   45: aload_2
    //   46: ifnull +9 -> 55
    //   49: aload_2
    ...
    //   84: dup
    //   85: invokespecial 124	java/lang/StringBuilder:<init>	()V
    //   88: ldc 126
    //   90: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   93: aload_3
    //   94: invokevirtual 133	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   103: aload_3
    //   104: invokestatic 140	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   107: aload_2
    //   108: ifnull -41 -> 67
    //   111: aload_2
    //   112: invokeinterface 114 1 0
    //   117: goto -50 -> 67
    //   120: astore_3
    //   121: aconst_null
    //   122: astore_2
  ...
  public static String a()
  {
    ...
    //   0: invokestatic 79	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   3: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   6: getstatic 251	com/tencent/common/config/provider/QZoneConfigProvider:b	Landroid/net/Uri;
    //   9: aconst_null
    //   10: aconst_null
    //   11: aconst_null
    //   12: aconst_null
    ...
    //   47: invokeinterface 257 2 0
    //   52: invokevirtual 261	java/lang/String:getBytes	()[B
    //   55: ldc_w 263
    //   58: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    //   61: astore_2
    //   62: aload_1
    //   63: ifnull +9 -> 72
    //   66: aload_1
    ...
    //   90: aload_1
    //   91: astore_0
    //   92: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   95: ifeq +35 -> 130
    //   98: aload_1
    //   99: astore_0
    //   100: ldc 121
    //   102: iconst_2
    //   103: new 123	java/lang/StringBuilder
    //   106: dup
    //   107: invokespecial 124	java/lang/StringBuilder:<init>	()V
    //   110: ldc_w 268
    //   113: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   116: aload_2
    //   117: invokevirtual 133	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   126: aload_2
    //   127: invokestatic 271	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   130: aload_1
    //   131: ifnull -47 -> 84
    //   134: aload_1
  ...
  {
    // Byte code:
    //   0: new 307	java/util/HashMap
    //   3: dup
    //   4: invokespecial 308	java/util/HashMap:<init>	()V
    //   7: astore_3
    //   8: invokestatic 79	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   11: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   14: getstatic 310	com/tencent/common/config/provider/QZoneConfigProvider:e	Landroid/net/Uri;
    //   17: aconst_null
    //   18: aconst_null
    //   19: aconst_null
    //   20: aconst_null
    //   21: invokevirtual 95	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   24: astore_2
    //   25: aload_2
    //   26: ifnull +92 -> 118
    //   29: aload_2
    ...
    //   57: invokeinterface 257 2 0
    //   62: invokevirtual 261	java/lang/String:getBytes	()[B
    //   65: ldc_w 263
    //   68: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    //   71: new 21	java/lang/String
    //   74: dup
    //   75: aload_2
    //   76: aload_2
    //   77: ldc_w 314
    //   80: invokeinterface 107 2 0
    //   85: invokeinterface 257 2 0
    //   90: invokevirtual 261	java/lang/String:getBytes	()[B
    //   93: ldc_w 263
    //   96: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    //   99: invokeinterface 319 3 0
    //   104: pop
    //   105: aload_2
    //   106: astore_1
    //   107: aload_2
    //   108: invokeinterface 322 1 0
    //   113: istore_0
    //   114: iload_0
    //   115: ifne -75 -> 40
    //   118: aload_2
    ...
    //   159: aload_3
    //   160: invokevirtual 133	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   169: aload_3
    //   170: invokestatic 140	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   173: aload_2
    //   174: ifnull +9 -> 183
    //   177: aload_2
  ...
  public static boolean a(String paramString, ArrayList<entrance_cfg> paramArrayList)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_0
    //   5: invokestatic 559	android/text/TextUtils:getTrimmedLength	(Ljava/lang/CharSequence;)I
    //   8: ifgt +5 -> 13
    //   11: iconst_0
    //   12: ireturn
    //   13: aload_1
    //   14: ifnull -3 -> 11
    //   17: aload_1
    //   18: invokevirtual 570	java/util/ArrayList:clear	()V
    //   21: aload_0
    //   22: ldc 155
    //   24: ldc 157
    //   26: invokevirtual 161	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   29: astore_0
    ...
    //   60: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   63: getstatic 577	com/tencent/common/config/provider/QZoneConfigProvider:g	Landroid/net/Uri;
    //   66: aconst_null
    //   67: aload_0
    //   68: aconst_null
    //   69: aconst_null
    //   70: invokevirtual 95	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   73: astore_0
    //   74: aload_0
    //   75: ifnull +214 -> 289
    //   78: aload_0
    ...
    //   84: ifeq +205 -> 289
    //   87: aload_1
    //   88: new 149	NS_UNDEAL_COUNT/entrance_cfg
    //   91: dup
    //   92: aload_0
    //   93: aload_0
    //   94: ldc 211
    //   96: invokeinterface 107 2 0
    //   101: invokeinterface 581 2 0
    ...
    //   119: invokeinterface 257 2 0
    //   124: invokevirtual 261	java/lang/String:getBytes	()[B
    //   127: ldc_w 263
    //   130: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    ...
    //   146: invokeinterface 257 2 0
    //   151: invokevirtual 261	java/lang/String:getBytes	()[B
    //   154: ldc_w 263
    //   157: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    //   160: new 21	java/lang/String
    //   163: dup
    //   164: aload_0
    //   165: aload_0
    //   166: ldc 220
    //   168: invokeinterface 107 2 0
    //   173: invokeinterface 257 2 0
    //   178: invokevirtual 261	java/lang/String:getBytes	()[B
    //   181: ldc_w 263
    //   184: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    //   187: aload_0
    //   188: aload_0
    //   189: ldc 222
    //   191: invokeinterface 107 2 0
    //   196: invokeinterface 581 2 0
    //   201: aload_0
    //   202: aload_0
    //   203: ldc 227
    //   205: invokeinterface 107 2 0
    //   210: invokeinterface 581 2 0
    ...
    //   228: invokeinterface 257 2 0
    //   233: invokevirtual 261	java/lang/String:getBytes	()[B
    //   236: ldc_w 263
    //   239: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    //   242: new 21	java/lang/String
    //   245: dup
    //   246: aload_0
    //   247: aload_0
    //   248: ldc 233
    //   250: invokeinterface 107 2 0
    //   255: invokeinterface 257 2 0
    //   260: invokevirtual 261	java/lang/String:getBytes	()[B
    //   263: ldc_w 263
    //   266: invokespecial 266	java/lang/String:<init>	([BLjava/lang/String;)V
    //   269: iconst_0
    //   270: aconst_null
    //   271: invokespecial 584	NS_UNDEAL_COUNT/entrance_cfg:<init>	(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;ILNS_UNDEAL_COUNT/st_report_info;)V
    //   274: invokevirtual 479	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   277: pop
    //   278: aload_0
    //   279: invokeinterface 322 1 0
    //   284: istore_2
    //   285: iload_2
    //   286: ifne -199 -> 87
    //   289: aload_0
    //   290: ifnull -279 -> 11
    //   293: aload_0
    //   294: invokeinterface 114 1 0
    //   299: iconst_0
    //   300: ireturn
    //   301: astore_1
    //   302: aconst_null
    //   303: astore_0
    //   304: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   307: ifeq +33 -> 340
    //   310: ldc 121
    //   312: iconst_2
    //   313: new 123	java/lang/StringBuilder
    //   316: dup
    //   317: invokespecial 124	java/lang/StringBuilder:<init>	()V
    //   320: ldc_w 586
    //   323: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   326: aload_1
    //   327: invokevirtual 133	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   336: aload_1
    //   337: invokestatic 140	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   340: aload_0
    //   341: ifnull -330 -> 11
    //   344: aload_0
  ...
  public static boolean a(Map<String, java.util.concurrent.ConcurrentHashMap<String, String>> paramMap)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokeinterface 589 1 0
    //   6: invokestatic 79	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   9: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   12: getstatic 591	com/tencent/common/config/provider/QZoneConfigProvider:a	Landroid/net/Uri;
    //   15: aconst_null
    //   16: aconst_null
    //   17: aconst_null
    //   18: aconst_null
    //   19: invokevirtual 95	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   22: astore 4
    //   24: aload 4
    //   26: ifnull +310 -> 336
    //   29: aload 4
    ...
    //   94: aload_0
    //   95: aload 7
    //   97: invokeinterface 501 2 0
    //   102: checkcast 593	java/util/concurrent/ConcurrentHashMap
    //   105: astore 6
    //   107: aload 6
    //   109: astore 5
    //   111: aload 6
    ...
    //   116: aload 4
    //   118: astore_3
    //   119: new 593	java/util/concurrent/ConcurrentHashMap
    //   122: dup
    //   123: invokespecial 594	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   126: astore 5
    //   128: aload 4
    //   130: astore_3
    //   131: aload_0
    ...
    //   152: aload 8
    //   154: aload 9
    //   156: invokevirtual 595	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   159: pop
    //   160: goto -131 -> 29
    //   163: astore_0
    //   164: aload 4
    //   166: astore_3
    //   167: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   170: ifeq +23 -> 193
    //   173: aload 4
    //   175: astore_3
    //   176: ldc 121
    ...
    //   186: ldc_w 597
    //   189: aastore
    //   190: invokestatic 600	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   193: aload 4
    //   195: ifnull +139 -> 334
    //   198: aload 4
    ...
    //   228: iload_1
    //   229: istore_2
    //   230: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   233: ifeq -26 -> 207
    //   236: ldc 121
    //   238: iconst_2
    //   239: aload_0
    ...
    //   246: ldc_w 597
    //   249: aastore
    //   250: invokestatic 600	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   253: iload_1
    //   254: ireturn
    //   255: astore_0
    //   256: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   259: ifeq +20 -> 279
    //   262: ldc 121
    //   264: iconst_2
    //   265: aload_0
    ...
    //   272: ldc_w 597
    //   275: aastore
    //   276: invokestatic 600	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   279: iconst_0
    //   280: ireturn
    //   281: astore_0
    //   282: aconst_null
    ...
    //   295: athrow
    //   296: astore_3
    //   297: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   300: ifeq -6 -> 294
    //   303: ldc 121
    //   305: iconst_2
    //   306: aload_3
    ...
    //   313: ldc_w 597
    //   316: aastore
    //   317: invokestatic 600	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   320: goto -26 -> 294
    //   323: astore_0
    //   324: goto -40 -> 284
    //   327: astore_0
  ...
  public static String b()
  {
    ...
    //   0: invokestatic 79	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   3: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   6: getstatic 564	com/tencent/common/config/provider/QZoneConfigProvider:c	Landroid/net/Uri;
    //   9: aconst_null
    //   10: aconst_null
    //   11: aconst_null
    //   12: aconst_null
    ...
    //   67: aload_0
    //   68: astore_1
    //   69: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   72: ifeq +35 -> 107
    //   75: aload_0
    //   76: astore_1
    //   77: ldc 121
    //   79: iconst_2
    //   80: new 123	java/lang/StringBuilder
    //   83: dup
    //   84: invokespecial 124	java/lang/StringBuilder:<init>	()V
    //   87: ldc_w 665
    //   90: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   93: aload_2
    //   94: invokevirtual 133	java/lang/Exception:getMessage	()Ljava/lang/String;
  ...
  public static String b(String paramString1, String paramString2)
  {
    ...
    //   14: ifnull -3 -> 11
    //   17: aload_1
    //   18: invokestatic 559	android/text/TextUtils:getTrimmedLength	(Ljava/lang/CharSequence;)I
    //   21: ifle -10 -> 11
    //   24: invokestatic 79	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   27: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   30: getstatic 591	com/tencent/common/config/provider/QZoneConfigProvider:a	Landroid/net/Uri;
    //   33: aconst_null
    //   34: ldc_w 667
    //   37: iconst_2
    ...
    //   48: aastore
    //   49: aconst_null
    //   50: invokevirtual 95	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   53: astore_1
    //   54: aload_1
    //   55: ifnull +149 -> 204
    //   58: aload_1
    ...
    //   103: astore_0
    //   104: aload_0
    //   105: invokevirtual 670	java/lang/Exception:printStackTrace	()V
    //   108: aload_2
    //   109: astore_0
    //   110: goto -9 -> 101
    //   113: astore_2
    ...
    //   116: aload_1
    //   117: astore_0
    //   118: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   121: ifeq +22 -> 143
    //   124: aload_1
    //   125: astore_0
    //   126: ldc 121
    ...
    //   136: ldc_w 672
    //   139: aastore
    //   140: invokestatic 600	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   143: aload_1
    //   144: ifnull +55 -> 199
    //   147: aload_1
    ...
    //   158: astore_0
    //   159: aload_0
    //   160: invokevirtual 670	java/lang/Exception:printStackTrace	()V
    //   163: aconst_null
    //   164: astore_0
    //   165: goto -64 -> 101
    //   168: astore_1
    ...
    //   183: astore_0
    //   184: aload_0
    //   185: invokevirtual 670	java/lang/Exception:printStackTrace	()V
    //   188: goto -7 -> 181
    //   191: astore_1
    //   192: goto -21 -> 171
    //   195: astore_2
  ...
  private static boolean b(String paramString)
  {
    ...
    //   0: invokestatic 79	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   3: invokevirtual 83	com/tencent/qphone/base/util/BaseApplication:getContentResolver	()Landroid/content/ContentResolver;
    //   6: getstatic 591	com/tencent/common/config/provider/QZoneConfigProvider:a	Landroid/net/Uri;
    //   9: iconst_1
    ...
    //   29: aastore
    //   30: aconst_null
    //   31: invokevirtual 95	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   34: astore 4
    //   36: aload 4
    //   38: ifnull +175 -> 213
    //   41: aload 4
    ...
    //   111: aload 4
    //   113: astore_3
    //   114: invokestatic 119	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   117: ifeq +48 -> 165
    //   120: aload 4
    //   122: astore_3
    //   123: ldc 121
    ...
    //   129: dup
    //   130: invokespecial 124	java/lang/StringBuilder:<init>	()V
    //   133: ldc_w 687
    ...
    //   149: aload 5
    //   151: invokevirtual 133	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   154: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   157: invokevirtual 136	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   160: aload 5
    //   162: invokestatic 140	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   165: aload 4
    //   167: ifnull +41 -> 208
    //   170: aload 4
