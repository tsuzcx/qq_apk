  ...
  extends aasp
{
  ...
  private ArrayList<aavf> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, aavg> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  private ConcurrentHashMap<Long, Long> b = new ConcurrentHashMap(10);
  
  public aave(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new aavg(this, paramString, paramInt, paramLong2);
  ...
  private void a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    {
      Object localObject = (aavf)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((aavf)localObject).a();
      localObject = ((aavf)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((aqqx)localObject).a(localView, paramMessageForDeviceSingleStruct);
      }
      for (;;)
      {
        i += 1;
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    for (;;)
    {
      ...
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgItemByUniseq(paramMessageForDeviceSingleStruct.frienduin, paramMessageForDeviceSingleStruct.istroop, paramMessageForDeviceSingleStruct.uniseq);
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, View paramView, aqqx paramaqqx)
  {
    long l1;
    ...
    if (paramView != null)
    {
      ...
      {
        aavf localaavf = (aavf)localIterator.next();
        if (localaavf.a() == paramView) {
          localaavf.b = new WeakReference(paramaqqx);
        }
      }
    }
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(new aavf(this, paramView, paramaqqx));
      }
      ...
      long l2 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForDeviceSingleStruct.strCoverKey, paramMessageForDeviceSingleStruct.strCoverKey2, paramMessageForDeviceSingleStruct.nCoverChannelType, 2154);
      paramView = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgItemByUniseq(paramMessageForDeviceSingleStruct.frienduin, paramMessageForDeviceSingleStruct.istroop, paramMessageForDeviceSingleStruct.uniseq);
  ...
  {
    paramLong = (aavg)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  {
    int i = 3;
    MessageForDeviceSingleStruct localMessageForDeviceSingleStruct = (MessageForDeviceSingleStruct)bbli.a(-4502);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage(localMessageForDeviceSingleStruct, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        if (localMessageForDeviceSingleStruct.nDataType == 2) {
          i = 4;
        }
        localObject = ((aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51)).a(paramDataPoint.mDin);
        if (localObject == null) {
          break label636;
        }
        j = ((DeviceInfo)localObject).productId;
        abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "Usr_AIO_ReceiveMsg", i, 0, j);
        if ((localObject != null) && (((DeviceInfo)localObject).isAdmin == 1) && (!TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect))) {
          abdm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "FR_StrangerComming", 0, 0, 0);
        }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgContentByUniseq(localMessageForDeviceSingleStruct.frienduin, 9501, localMessageForDeviceSingleStruct.uniseq, localMessageForDeviceSingleStruct.msgData);
        ...
        return;
        this.b.put(Long.valueOf(localMessageForDeviceSingleStruct.uniseq), Long.valueOf(bbko.a()));
        continue;
  ...
  public boolean b(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageForDeviceSingleStruct.frienduin, 9501, paramMessageForDeviceSingleStruct.uniseq, paramMessageForDeviceSingleStruct.msgData);
    ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(50)).a(0, paramMessageForDeviceSingleStruct.nMediaSessionID, false);
    return true;
  }
}
