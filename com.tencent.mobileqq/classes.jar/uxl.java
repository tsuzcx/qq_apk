  ...
  extends uxn
{
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    {
      paramString1 = ajjy.a(2131642402) + paramInt1 + ajjy.a(2131642395) + paramInt2 + ajjy.a(2131642394);
      this.t = paramString1;
      return paramString1;
    }
  ...
  public String a(String paramString)
  {
    ...
    //   3: ldc 49
    //   5: aload_0
    //   6: getfield 51	uxl:m	Ljava/lang/String;
    ...
    //   37: putfield 85	uxl:r	Ljava/lang/String;
    //   40: aload_0
    //   41: getfield 85	uxl:r	Ljava/lang/String;
    //   44: invokestatic 90	bace:a	(Ljava/lang/String;)Z
    //   47: ifne +60 -> 107
    //   50: aload_0
    //   51: getfield 93	uxl:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   70: dup
    //   71: aload_0
    //   72: getfield 85	uxl:r	Ljava/lang/String;
    //   75: invokestatic 111	bace:a	(Ljava/lang/String;)Ljava/io/File;
    ...
    //   107: aload_0
    //   108: getfield 85	uxl:r	Ljava/lang/String;
    //   111: areturn
    //   112: astore_1
    //   113: aload_1
    ...
    //   187: goto -7 -> 180
    //   190: aload_0
    //   191: getfield 140	uxl:h	Ljava/lang/String;
    //   194: invokestatic 146	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   197: ifne +25 -> 222
    //   200: aload_0
    //   201: getfield 140	uxl:h	Ljava/lang/String;
    //   204: aload_0
    //   205: getfield 85	uxl:r	Ljava/lang/String;
    //   208: invokevirtual 57	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   211: ifne +11 -> 222
    //   214: aload_0
    //   215: aload_0
    //   216: getfield 140	uxl:h	Ljava/lang/String;
    //   219: invokevirtual 149	uxl:a	(Ljava/lang/String;)V
    //   222: aload_0
    //   223: aload_1
    //   224: putfield 151	uxl:s	Ljava/lang/String;
    //   227: aload_0
    //   228: getfield 151	uxl:s	Ljava/lang/String;
    //   231: areturn
    //   232: astore 4
    //   234: aload_1
    //   235: astore_2
