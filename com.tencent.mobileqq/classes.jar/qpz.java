  ...
  extends uux
{
  ...
  qpz(ArticleInfo paramArticleInfo, WeakReference<Activity> paramWeakReference)
  {
  ...
  public boolean a(int paramInt, @NotNull ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    try
    {
      ...
      {
        Object localObject1 = ((rrm)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.a.jdField_a_of_type_JavaUtilArrayList.get(0)).c;
        if (paramActionSheetItem.action == 13)
        {
          localObject1 = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject1 != null)
          {
            localObject2 = qqs.a((Activity)localObject1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
            if (owc.a() == 1)
            {
              bool = true;
    ...
    catch (NullPointerException localNullPointerException1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (qph.a(this.jdField_a_of_type_Qph) == null) {
            qph.a(this.jdField_a_of_type_Qph, new txn());
          }
          str1 = null;
          if (paramActionSheetItem.action == 72) {
            str1 = paramActionSheetItem.uin;
          }
          qph.a(this.jdField_a_of_type_Qph).a(localJSONObject, paramInt, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), str1, paramActionSheetItem.uinType, paramActionSheetItem.label);
        }
