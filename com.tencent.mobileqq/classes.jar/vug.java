...
public class vug
  extends ajjh
{
  public vug(QRLoginMgrActivity paramQRLoginMgrActivity) {}
  ...
  protected void onKickOutDevFResult(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if ((QRLoginMgrActivity.a(this.a) == null) || (QRLoginMgrActivity.a(this.a).size() == 0))
    {
      ...
      this.a.finish();
      if ((QRLoginMgrActivity.a(this.a) != null) && (QRLoginMgrActivity.a(this.a).size() > 0)) {
        bbmy.a(this.a.getApplicationContext(), 1, 2131651411, 0).a();
      }
    }
    while (paramInt2 != 100)
    {
      return;
      bbmy.a(this.a.getApplicationContext(), 2, 2131651412, 0).a();
    ...
    if (paramBoolean)
    {
      bbmy.a(this.a.getApplicationContext(), 2, 2131651437, 0).a();
      return;
    }
    bbmy.a(this.a.getApplicationContext(), 1, 2131651411, 0).a();
  }
