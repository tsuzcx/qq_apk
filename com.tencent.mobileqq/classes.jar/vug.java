...
public class vug
  extends ojo
{
  public vug(PublicAccountImageCollectionMainActivity paramPublicAccountImageCollectionMainActivity) {}
  ...
  public void a(vus paramvus)
  {
    ...
    PublicAccountImageCollectionMainActivity.a(this.a, paramvus);
    if (paramvus == null)
    {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      olh.a(null, this.a.jdField_a_of_type_JavaLangString, "0X8007B97", "0X8007B97", 0, 0, this.a.b, this.a.c, "" + i, "", false);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, vus paramvus, byte[] paramArrayOfByte, String paramString)
  {
    ...
    if (paramBoolean) {
      if ((paramString != null) && (!paramString.equals(this.a.b)))
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.pubaccount.video.PublicAccountArticleObserver", 2, "onGetPhotoCollectionInfoRespond isSuccess=" + paramBoolean + " ;articleID = " + paramvus.jdField_a_of_type_JavaLangString);
          }
          PublicAccountImageCollectionPreloadManager.a().a(paramvus, paramArrayOfByte);
          PublicAccountImageCollectionPreloadManager.a().b(paramvus);
        }
        if ((paramvus == null) || (paramvus.jdField_a_of_type_JavaUtilArrayList == null)) {
          break label308;
        }
      }
    }
    label308:
    for (int i = paramvus.jdField_a_of_type_JavaUtilArrayList.size();; i = 0)
    {
      olh.a(null, this.a.jdField_a_of_type_JavaLangString, "0X8007B8A", "0X8007B8A", 0, 0, this.a.b, this.a.c, "" + PublicAccountImageCollectionMainActivity.b(this.a, PublicAccountImageCollectionMainActivity.a(this.a)), "" + i, false);
      return;
      PublicAccountImageCollectionMainActivity.a(this.a, paramvus);
      if (paramvus == null)
      {
