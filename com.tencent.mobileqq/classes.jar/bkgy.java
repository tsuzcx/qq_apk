  ...
  extends bkgn<bkgf>
{
  ...
  public bkgy(Context paramContext, FaceListPage paramFaceListPage)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561233, null);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131379334));
      this.b = ((ImageView)localView.findViewById(2131374702));
