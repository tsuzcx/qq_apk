...
public abstract class aryv
  implements DialogInterface.OnDismissListener, aryk, aryl, arzm
{
  ...
  public long a;
  alrl jdField_a_of_type_Alrl = new aryy(this);
  public Activity a;
  public Context a;
  ...
  public aryv(Intent paramIntent)
  {
  ...
  private void H()
  {
    ...
    if (this.jdField_a_of_type_Zhe == null) {
      this.jdField_a_of_type_Zhe = new zhe(this.jdField_a_of_type_AndroidAppActivity);
    }
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131719921);
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("app_name");
    Object localObject1 = localObject2;
    if (str != null) {
      localObject1 = (String)localObject2 + str;
    }
    localObject2 = new aryw(this);
    this.jdField_a_of_type_Zhe.a((String)localObject1, (DialogInterface.OnClickListener)localObject2);
    this.jdField_a_of_type_Zhe.a((DialogInterface.OnClickListener)localObject2);
  ...
  private void K()
  {
    asau localasau = new asau(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Bdjz = localasau;
    if (!d()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      localasau.b(210);
      localasau.a(a());
      localasau.setCanceledOnTouchOutside(false);
      localasau.a(c(), d(), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(a()), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(b()), a(), b());
      a(localasau);
      if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        localasau.show();
      }
      this.jdField_a_of_type_Bdjz.setOnDismissListener(this);
      return;
    }
  }
  ...
  private void a(Bundle paramBundle, int paramInt, String paramString)
  {
    ...
    {
      azqs.b(null, "dc00899", str, "", "video_tab", "videoark_share", 0, 0, paramString, paramBundle, "", "");
      return;
      paramBundle = l + "";
      break;
      bool = false;
  ...
  private void a(bdle parambdle)
  {
    ...
    String str3 = alud.a(2131705130);
    Object localObject = str1;
    if (str1.startsWith(str3)) {
      localObject = str1.substring(str3.length());
    }
    localObject = ((String)localObject).trim();
    parambdle.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, str2, i, (String)localObject, bool);
    return;
    if (((List)localObject).size() == 1)
    {
      localObject = (ResultRecord)((List)localObject).get(0);
      parambdle.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, ((ResultRecord)localObject).jdField_a_of_type_JavaLangString, ((ResultRecord)localObject).a(), ((ResultRecord)localObject).jdField_b_of_type_JavaLangString, false);
      return;
    }
    parambdle.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, (List)localObject, true);
  }
  ...
  private void a(MessageForPic paramMessageForPic, String paramString)
  {
    ...
    for (Object localObject = Long.valueOf(paramMessageForPic.uniseq);; localObject = "")
    {
      ...
      if (paramMessageForPic != null)
      {
        ...
        localObject = new Bundle();
        ((Bundle)localObject).putBoolean("extra.EXTRA_NOT_CLEAR_TOP", true);
        a((Bundle)localObject, paramString, agjb.a(paramMessageForPic));
        D();
      }
      return;
    }
  ...
  private void a(String paramString, int paramInt)
  {
    if ((this.jdField_a_of_type_AndroidContentIntent != null) && (("ChatActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))) || ("SplashActivity".equals(this.jdField_a_of_type_AndroidContentIntent.getStringExtra("caller_name"))))) {
      afwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F55", paramString);
    }
    ...
    afwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_sender_uin"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("forward_photo_md5"), "0X8009F56", paramString);
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      azqs.b(null, "dc00899", str, "", "music_tab", "musicark_share", 0, 0, paramString, "", "", "");
      return;
      bool = false;
      break;
      str = "Grp_AIO";
  ...
  public void A()
  {
    ...
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A7EB", "0X800A7EB", i, 0, "", "", String.valueOf(j), str);
  }
  ...
  public void B()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      int m = a(str3, k);
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", str3, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
      if (QLog.isColorLevel())
      {
        ...
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", (String)localObject, "0X800A7EC", "0X800A7EC", i, 0, str2, String.valueOf(m), String.valueOf(j), str1);
        if (QLog.isColorLevel()) {
  ...
  public void C()
  {
    ...
    int k = a(i);
    Object localObject1 = "";
    if ((this.jdField_a_of_type_Bdjz instanceof bdku))
    {
      localObject1 = ((bdku)this.jdField_a_of_type_Bdjz).getInputValue();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          {
            azqs.b(localQQAppInterface, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
            if (QLog.isColorLevel()) {
            ...
            localObject1 = str1;
            break label230;
            if (!(this.jdField_a_of_type_Bdjz instanceof asau)) {
              break;
            }
            localObject1 = ((asau)this.jdField_a_of_type_Bdjz).getInputValue();
            break;
          }
        }
      }
      else
      {
        ...
        localObject1 = "1";
        azqs.b((QQAppInterface)localObject2, "dc00898", "", str1, "0X800A7ED", "0X800A7ED", j, 0, (String)localObject1, String.valueOf(i), String.valueOf(k), str2);
        if (QLog.isColorLevel()) {
  ...
  public void D()
  {
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BE9", "0X8009BE9", this.jdField_b_of_type_Int, 0, "", "", "", "");
  }
  
  public void E()
  {
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009BEA", "0X8009BEA", this.jdField_b_of_type_Int, 0, "", "", "", "");
    C();
  }
  ...
  public void F()
  {
    ...
    do
    {
      ...
      azqs.b(null, "dc00898", "", "", "0X800A27", "0X800A27", 0, 0, "", ForwardUtils.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype")), str, ForwardUtils.b(i));
  ...
  protected final DialogInterface.OnClickListener a()
  {
    if (this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new aryz(this);
    }
  ...
  protected View.OnClickListener a(arzh paramarzh)
  {
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    if (this.jdField_a_of_type_AndroidViewView$OnClickListener == null) {
      this.jdField_a_of_type_AndroidViewView$OnClickListener = new arzc(this, str, paramarzh);
    }
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    {
      localRecentUser = new RecentUser(alof.z, 6000);
      localRecentUser.displayName = alud.a(2131694654);
    ...
    while (paramList.hasNext())
    {
      ...
      if ((bool) && (this.jdField_c_of_type_Int == 1) && (localRecentUser != null) && (TextUtils.equals(localRecentUser.uin, alof.z))) {
        localArrayList.add(localRecentUser);
      } else if ((localRecentUser != null) && (!bdeu.a(localRecentUser.uin)) && (localRecentUser.getType() != 1020) && (localRecentUser.getType() != 1008) && (localRecentUser.getType() != 1005) && ((localRecentUser.getType() != 1006) || (a(aryl.jdField_h_of_type_JavaLangInteger))) && (localRecentUser.getType() != 1009) && (localRecentUser.getType() != 1021) && (localRecentUser.getType() != 1001) && (localRecentUser.getType() != 10002) && (localRecentUser.getType() != 10004) && (localRecentUser.getType() != 1022) && (localRecentUser.getType() != 1032) && (localRecentUser.getType() != 1033) && (localRecentUser.getType() != 1034) && (localRecentUser.getType() != 7000) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 1) || (!a(localRecentUser.uin))) && ((localRecentUser.getType() != 0) || (!ndv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) && (((localRecentUser.getType() != 1004) && (localRecentUser.getType() != 1000)) || (this.jdField_b_of_type_Boolean))) {
        localArrayList.add(localRecentUser);
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    if (this.jdField_b_of_type_Bety == null) {
      this.jdField_b_of_type_Bety = new bety(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298914));
    }
  ...
  public void a(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    paramDrawable.setBounds(bdhj.a(paramDrawable, 36, 100, this.jdField_a_of_type_Float));
  }
  ...
  {
    biqe.a(this.jdField_a_of_type_AndroidAppActivity, paramBundle, paramAIOImageProviderService, paramAIORichMediaData, 19001, 4);
  }
  ...
  protected void a(Bundle paramBundle, String paramString, da paramda)
  {
    ...
    paramBundle = "";
    if ((this.jdField_a_of_type_Bdjz instanceof bdku)) {
      paramBundle = ((bdku)this.jdField_a_of_type_Bdjz).getInputValue();
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(paramBundle))
      {
        ...
        int i = localalqo.a().b(paramString, localBundle, paramda);
        if (QLog.isColorLevel()) {
      ...
      return;
      if ((this.jdField_a_of_type_Bdjz instanceof asau)) {
        paramBundle = ((asau)this.jdField_a_of_type_Bdjz).getInputValue();
      }
    }
  }
  
  public void a(bdjz parambdjz) {}
  ...
  protected final void a(String paramString, bdjz parambdjz)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "addSourceNameView start! sourceName =" + paramString);
    }
    if ((paramString == null) || ("".equals(paramString)) || (parambdjz == null)) {
      return;
    }
    ...
    parambdjz.addView(localTextView);
  }
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    localBundle.putString("uinname", alud.a(2131705129) + paramString2);
    a(aryl.jdField_d_of_type_JavaLangInteger.intValue(), localBundle);
  }
  ...
  public boolean a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_c_of_type_Boolean) || ((this instanceof asdo)) || ((this instanceof arzi)) || (this.jdField_a_of_type_AndroidOsBundle.getInt("cmshow_game_id") > 0));
    ...
    if (paramInt1 == 1) {
      if (((bcnu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramString, true).jdField_a_of_type_Boolean)
      {
        bool1 = false;
        bool2 = bool1;
        if (bool1)
        {
          bool2 = bool1;
          if ((this instanceof arzx))
          {
            paramString = (arzx)this;
            bool2 = bool1;
  ...
  protected boolean a(Intent paramIntent)
  {
    ...
    if (!bool2)
    {
      ...
      {
        bool1 = bool2;
        if (str.equals(this.jdField_a_of_type_AndroidAppActivity.getString(2131692423))) {
          bool1 = true;
        }
      }
    }
  ...
  protected final DialogInterface.OnClickListener b()
  {
    if (this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = new arza(this);
    }
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_Bdjz.setMessageWithEmo(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Float);
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false))
      {
        ...
        paramInt = localalqo.a().a(str, localBundle, localarzf);
      ...
      for (;;)
      {
        ...
        b(localIntent);
        localBundle.putAll(localIntent.getExtras());
        paramInt = localalqo.a().b(str, localBundle, localarzf);
        a(localBundle, str, null);
        break label257;
        label359:
        break;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    if (paramBundle != null) {
      a(paramBundle.getInt("key_forward_ability_type", aryl.a.intValue()), paramBundle);
    }
  }
  
  protected void b(String paramString) {}
  
  protected final void b(String paramString, bdjz parambdjz)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ForwardOption.ForwardBaseOption", 2, "updateImageView: filepath=" + paramString);
    }
    ThreadManager.post(new ForwardBaseOption.8(this, paramString, parambdjz), 8, null, false);
    if (QLog.isColorLevel()) {
  ...
  protected boolean b(String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Bdjz instanceof bdku))
    {
      str = ((bdku)this.jdField_a_of_type_Bdjz).getInputValue();
      if (TextUtils.isEmpty(str)) {
        break label270;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (!(this instanceof aseb)) {
        afcu.a().a((SessionInfo)localObject, str, i);
      }
      return true;
      if (!(this.jdField_a_of_type_Bdjz instanceof asau)) {
        break;
      }
      str = ((asau)this.jdField_a_of_type_Bdjz).getInputValue();
      break;
      label241:
  ...
  protected final DialogInterface.OnClickListener c()
  {
    if (this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener == null) {
      this.jdField_c_of_type_AndroidContentDialogInterface$OnClickListener = new arzb(this);
    }
  ...
  public void c()
  {
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "0", "", "", "");
  }
  ...
  protected void c(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", alud.a(2131705122));
  ...
  protected void c(String paramString)
  {
    ...
    Object localObject2 = ((ztp)localObject1).a(Long.parseLong(paramString));
    ((ztp)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, (DeviceInfo)localObject2, false);
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false)) {
  ...
  protected void d(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Zhh.a((String)localObject, localaryx);
      ...
      if (paramInt == 0)
      {
        ...
        this.jdField_a_of_type_Zhh.a(2131720053);
        this.jdField_a_of_type_Zhh.b(0);
        this.jdField_a_of_type_Zhh.c(2131720054);
        this.jdField_a_of_type_Zhh.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131695054), localaryx);
      }
      try
      {
  ...
  public void d(String paramString)
  {
    ...
    do
    {
      ...
      azqs.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 0, paramString, ForwardUtils.b(i), str, "");
    } while (!QLog.isColorLevel());
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_AndroidOsBundle != null) && (this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A220", "0X800A220", 0, 0, "0", "", "", "");
    }
    B();
  }
  ...
  public void j()
  {
    if ((this.jdField_a_of_type_Bdjz instanceof bdjq)) {
      ((bdjq)this.jdField_a_of_type_Bdjz).a(0);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Bdjz instanceof bdjq)) {
      ((bdjq)this.jdField_a_of_type_Bdjz).a(1);
    }
  ...
  protected boolean k()
  {
    ...
    if (localObject != null)
    {
      localObject = ((alrk)localObject).a();
  ...
  public final void l()
  {
    ...
    if (i == 0)
    {
      ...
      if ((i == 27) || (i == 39))
      {
        this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
        this.jdField_a_of_type_Bdjz.setMessage("");
        this.jdField_a_of_type_Bdjz.setNegativeButton(2131690648, b());
        this.jdField_a_of_type_Bdjz.setPositiveButton(2131690797, a());
        this.jdField_a_of_type_Bdjz.show();
      }
    }
    for (;;)
    {
      if ((this.jdField_a_of_type_Bdjz instanceof bdle)) {
        a((bdle)this.jdField_a_of_type_Bdjz);
      }
      Object localObject1 = d();
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
        this.jdField_a_of_type_Bdjz.setEditLint((String)localObject1);
      }
      if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("miniAppNeedOnlyPreview", false))
      {
        ((bdjq)this.jdField_a_of_type_Bdjz).a(c());
        ((bdjq)this.jdField_a_of_type_Bdjz).a();
      }
      this.jdField_a_of_type_Bdjz.setOnDismissListener(this);
      this.jdField_a_of_type_Bdjz.adjustTitle();
      b();
      this.jdField_a_of_type_Bdjz.setMsgMaxLineWithEnd(this.jdField_a_of_type_JavaLangString, 3);
      if (a(this.jdField_a_of_type_Bdjz)) {
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.getInt(jdField_e_of_type_JavaLangString, 0) == 1) {
        this.jdField_a_of_type_Bdjz.setPreviewImageScaleType(true);
      }
      if (this.jdField_a_of_type_AndroidAppActivity.isFinishing()) {
        break;
      }
      this.jdField_a_of_type_Bdjz.show();
      return;
      this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), d(), a(), b(), a(), b());
      continue;
      if (i == 1)
      {
        m();
        ...
        this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b());
        continue;
      }
      if (i == 2)
      {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject2)) && (!TextUtils.isEmpty((CharSequence)localObject3))) {
          anoe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, "AIOArkSdkSelectSend", 1, 0, 0L, 0L, 0L, (String)localObject2, "");
        }
        label690:
        this.jdField_a_of_type_Bdjz.setMessage("");
        this.jdField_a_of_type_Bdjz.setNegativeButton(2131690648, b());
        ...
        this.jdField_a_of_type_Bdjz.show();
        continue;
        this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338));
        ...
        localObject1 = (bdku)this.jdField_a_of_type_Bdjz;
        ((bdku)localObject1).b();
        ((bdku)localObject1).getEditText().setHint(alud.a(2131705124));
        continue;
        if (i == 3)
        {
          this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          continue;
        }
        if (i == 4)
        {
          ...
          this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), (String)localObject1, (String)localObject2, (ArrayList)localObject3, null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          continue;
        }
        if (i == 5)
        {
          i = this.jdField_a_of_type_AndroidOsBundle.getInt("key_hiboom_id");
          this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), "", null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
          localObject1 = new HiBoomTextView(this.jdField_a_of_type_AndroidAppActivity);
          ((HiBoomTextView)localObject1).setHiBoom(i, 0, assg.jdField_a_of_type_Asrz);
          ((HiBoomTextView)localObject1).setText(this.jdField_a_of_type_JavaLangString);
          ((HiBoomTextView)localObject1).setMaxSize(assg.jdField_a_of_type_Int);
          localObject2 = new LinearLayout.LayoutParams(500, 500);
          ((LinearLayout.LayoutParams)localObject2).gravity = 17;
          this.jdField_a_of_type_Bdjz.addView((View)localObject1, (LinearLayout.LayoutParams)localObject2);
          continue;
        }
        this.jdField_a_of_type_Bdjz = bdgm.a(this.jdField_a_of_type_AndroidAppActivity, c(), a(), null, a(), b(), this.jdField_a_of_type_AndroidAppActivity.getResources().getInteger(2131427338), false);
      }
  ...
  protected boolean m()
  {
    ...
    if (localObject != null)
    {
      localObject = ((alto)localObject).e();
      if (localObject != null)
      {
  ...
  protected boolean o()
  {
    ...
    do
    {
      ...
      {
        bool1 = bool2;
        if (((ztp)localObject).a())
        {
          localObject = ((ztp)localObject).a();
          bool1 = bool2;
          if (localObject != null)
          {
            bool1 = bool2;
  ...
  protected void q()
  {
    ...
    for (;;)
    {
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8009AAE", "0X8009AAE", i, 0, "", "", "", "");
      return;
      label80:
      if (j == 1) {
        i = 2;
  ...
  protected void t()
  {
    this.jdField_a_of_type_Bdjz.setImageOnClickListener(a(new arze(this)));
  }
  ...
  protected void v()
  {
    ...
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004047", "0X8004047", 0, 0, "", "", "", "");
  }
