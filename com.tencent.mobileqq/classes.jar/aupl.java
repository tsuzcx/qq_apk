...
public class aupl
{
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, long paramLong1, long paramLong2, long paramLong3, long paramLong4, auox paramauox, String paramString)
  {
    if ((paramBoolean2) && (paramauox == null))
    {
    ...
    if (paramBoolean1)
    {
      ...
      l2 = paramauox.a;
      l1 = paramauox.b;
      paramLong1 = paramauox.c;
      long l3 = paramauox.d - l2 - l1 - paramLong1;
    ...
    for (;;)
    {
      ...
      if (paramauox != null) {}
      for (paramLong1 = paramauox.d;; paramLong1 = 0L)
      {
