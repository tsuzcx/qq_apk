...
public class agwj
{
  private static volatile agwj jdField_a_of_type_Agwj;
  private List<agwk> jdField_a_of_type_JavaUtilList;
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_JavaUtilList = agwk.a(paramString);
    }
  ...
  public boolean a(String paramString, WebViewFragment paramWebViewFragment)
  {
    ...
    do
    {
      do
      {
        ...
        localagwk = (agwk)((Iterator)localObject1).next();
      } while (TextUtils.isEmpty(localagwk.jdField_b_of_type_JavaLangString));
      if (localagwk.jdField_a_of_type_JavaUtilRegexPattern == null) {
        localagwk.jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile(localagwk.jdField_b_of_type_JavaLangString);
      }
    } while (!localagwk.jdField_a_of_type_JavaUtilRegexPattern.matcher(paramString).matches());
    Object localObject1 = "";
    Object localObject2 = paramWebViewFragment.a;
    paramWebViewFragment = (WebViewFragment)localObject1;
    if (localObject2 != null)
    {
      localObject2 = ((bcfa)localObject2).jdField_a_of_type_JavaUtilList;
      paramWebViewFragment = (WebViewFragment)localObject1;
      if (localObject2 != null)
      {
        paramWebViewFragment = (WebViewFragment)localObject1;
    ...
    boolean bool;
    if (TextUtils.isEmpty(localagwk.jdField_a_of_type_JavaLangString)) {
      bool = true;
    }
    while (bool)
    {
      if (localagwk.jdField_a_of_type_Boolean) {
        VACDReportUtil.a("originURL=" + paramWebViewFragment + "|interceptURL=" + paramString, "qqwallet", "InterceptOpenOtherApp", null, null, 0, null);
      }
      if (!localagwk.jdField_b_of_type_Boolean) {
        break;
      }
      if (!TextUtils.isEmpty(localagwk.c))
      {
        if (TextUtils.isEmpty(localagwk.d)) {
          localagwk.d = a(localagwk.c, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDsE3WI7sDFUi6QWV/oK8qozDvS\nTlxmu1a3NSFxeOrjlVEVtOx8yIMVFYIixq/Fv1XgUlyvL7bGJbaLLKaqlYruGd2z\nNbaIz90Zm4H0pMFHx4vCYhsRP1HXbVMo2ZDiHEDbnSm/99uzFPPiXqLi8jE9t4if\n0GuYdSZfe5o+SIKT5QIDAQAB");
        }
        paramWebViewFragment = localagwk.d;
        if (QLog.isColorLevel()) {
      ...
      try
      {
        for (;;)
        {
          ...
          return true;
          if (localagwk.jdField_b_of_type_JavaUtilRegexPattern == null) {
            localagwk.jdField_b_of_type_JavaUtilRegexPattern = Pattern.compile(localagwk.jdField_a_of_type_JavaLangString);
          }
          bool = localagwk.jdField_b_of_type_JavaUtilRegexPattern.matcher(paramWebViewFragment).matches();
          break;
          label515:
          paramWebViewFragment = paramWebViewFragment + "?j=";
        }
