...
public abstract class ncl
  implements View.OnClickListener, ndc
{
  ...
  public ncl(AVGameAppInterface paramAVGameAppInterface, BaseActivity paramBaseActivity, ViewGroup paramViewGroup)
  {
    ...
    lbc.d(this.jdField_a_of_type_JavaLangString, "mRes is null. exit video progress");
    paramBaseActivity = paramAVGameAppInterface.getString(2131719019) + " 0x08";
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    if ("android.permission.CAMERA".equals(paramString)) {
      str = localAVGameActivity.getString(2131694994);
    }
    for (paramString = localAVGameActivity.getString(2131694995);; paramString = localAVGameActivity.getString(2131695005))
    {
      ...
      str = localAVGameActivity.getString(2131695004);
    }
  }
  ...
  void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    paramString1 = bglp.a(localAVGameActivity, 230).setMessage(paramString1).setTitle(paramString2).setNegativeButton(2131690582, new nco(this, paramLong));
    if (nfx.a(localAVGameActivity)) {}
    for (int i = 2131695006;; i = 2131695007)
    {
      paramString1.setPositiveButton(i, new ncn(this, paramLong)).show();
      return;
    }
  }
  ...
  public void a(ncz paramncz)
  {
    this.jdField_a_of_type_Ncz = paramncz;
    this.jdField_a_of_type_Ncz.a(this);
  }
  ...
  protected boolean a(long paramLong, String paramString, View paramView, int paramInt)
  {
    ...
    if (localAVGameActivity.checkSelfPermission(paramString) == 0)
    {
      ...
      ncm localncm = new ncm(this, paramString, paramLong, paramInt, paramView);
      ...
      localAVGameActivity.requestPermissions(localncm, 0, new String[] { paramString });
      if (!"android.permission.CAMERA".equals(paramString)) {
        break label169;
      }
