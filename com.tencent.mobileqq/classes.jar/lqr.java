...
public class lqr
  extends kzq
{
  public lqr(AVActivity paramAVActivity) {}
  ...
  protected void a(long paramLong, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      kya.a().a(this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    mfr.a("switch_camera", "onAfterSwitchCamera", 3, new Object[] { Long.valueOf(l) });
    QLog.w(this.a.b, 1, "onAfterSwitchCamera, success[" + paramBoolean + "], seq[" + l + "]");
    if (paramBoolean)
    {
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
        this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI.b(2131306809, true);
      }
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) {
  ...
  protected void b()
  {
    mfr.a("switch_camera", "onBeforeSwitchCamera", 3, new Object[0]);
    if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
      this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI.b(2131306809, false);
    }
  }
