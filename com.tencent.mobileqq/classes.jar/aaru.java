...
public class aaru
{
  ...
  public aaru(ChatHistory paramChatHistory)
  {
    a();
  }
  ...
  public void a(int paramInt, View paramView, Object paramObject, String paramString)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (bbbd.a(paramObject, this.jdField_a_of_type_JavaLangObject)))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    return (!this.jdField_a_of_type_Boolean) && (paramInt == this.jdField_a_of_type_Int) && (bbbd.a(this.jdField_a_of_type_JavaLangObject, paramObject));
  }
  ...
  protected void b()
  {
    ...
    for (localObject1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372061);; localObject1 = null)
    {
      if (localObject1 != null) {
        if ((this.jdField_a_of_type_AndroidViewView.getTag() == null) || (!(this.jdField_a_of_type_AndroidViewView.getTag() instanceof aart))) {
          break label302;
        }
      }
      for (boolean bool = ((aart)this.jdField_a_of_type_AndroidViewView.getTag()).jdField_a_of_type_Boolean;; bool = false)
      {
        if (bool)
        {
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Int == 1)
          {
            ...
            if (this.jdField_a_of_type_AndroidViewView != null)
            {
              localImageView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376182);
            ...
            for (;;)
            {
              ...
              this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.b((ImageView)localObject1, (aobk)localObject2);
              return;
              localImageView = null;
            }
          }
  ...
  protected void c()
  {
    ...
    for (localObject1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372061);; localObject1 = null)
    {
      ...
      for (boolean bool = ((aart)this.jdField_a_of_type_AndroidViewView.getTag()).jdField_a_of_type_Boolean;; bool = false)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.b.stop();
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getResources().getDrawable(2130848903);
        ...
        for (;;)
        {
          return;
          this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a.stop();
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.getResources().getDrawable(2130848902);
          ((Drawable)localObject2).setBounds(0, 0, ((Drawable)localObject2).getMinimumWidth(), ((Drawable)localObject2).getMinimumHeight());
          break;
          if (this.jdField_a_of_type_Int == 1)
          {
            if (this.jdField_a_of_type_AndroidViewView != null)
            {
              localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376182);
              localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367918);
            }
            for (;;)
            {
              ...
              if (!(localObject3 instanceof aobk)) {
                break;
              }
              localObject3 = (aobk)localObject3;
              ((aobk)localObject3).a("fromAIO", true);
              this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.b((ImageView)localObject2);
              this.jdField_a_of_type_ComTencentMobileqqActivityChatHistory.a((ImageView)localObject1, (aobk)localObject3);
              return;
              localObject2 = null;
            }
          }
