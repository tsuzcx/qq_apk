...
public class avhh
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, avcq paramavcq)
  {
    if (paramavcq == null) {}
    do
    {
      ...
      {
        return 0;
        paramQQAppInterface = avcw.a(paramQQAppInterface).a(paramavcq);
  ...
  public static void a()
  {
    ...
    {
      jdField_a_of_type_Int = bfyz.G(localBaseApplicationImpl);
      c = bfyz.d(localBaseApplicationImpl);
      if (QLog.isColorLevel()) {
    ...
    bfyz.a(localBaseApplicationImpl, false, 0);
  }
  ...
  public static void d()
  {
    ...
    bcef.b(null, "CliOper", "", "", "0X800A976", "0X800A976", 0, 0, String.valueOf(l), "0", "0", "");
  }
