...
public class anaj
{
  public static FrameworkView a(Context paramContext, amyo paramamyo, bkys parambkys, amti paramamti, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      paramContext.a(paramamyo, parambkys, paramamti, paramStartCheckParam);
      return paramContext;
      paramContext = new QzoneGameFloatView(paramContext, paramStartCheckParam);
      continue;
  ...
  public static FrameworkView a(Context paramContext, amyo paramamyo, bkys parambkys, CmGameStartChecker.StartCheckParam paramStartCheckParam, int paramInt)
  {
    switch (paramInt)
    {
    default: 
    ...
    for (;;)
    {
      paramContext.a(paramamyo, parambkys, null, paramStartCheckParam);
      return paramContext;
      paramContext = new CmGameGuideView(paramContext, paramStartCheckParam);
      continue;
