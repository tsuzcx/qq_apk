...
public class ahxt
  implements bhqd
{
  public ahxt(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (this.a.jdField_d_of_type_Int == 9) {
            ...
            case 0: 
              ...
              azmj.b(this.a.getActivity().app, "P_CliOper", "Grp_pay", "", "un_pay_list", "Clk_del", 0, 0, this.a.c, this.a.o, "", "");
              break;
            }
          } else {
            switch (i)
            ...
            case 1: 
              if (!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString))
              {
                ...
                azmj.b(this.a.getActivity().app, "dc00899", "Grp_mber", "", "mber_list", "clk_Add", 0, 0, this.a.c, "", "", "");
              }
              break;
            case 2: 
            ...
            case 3: 
              ...
              this.a.jdField_d_of_type_AndroidWidgetTextView = ((TextView)ChatHistoryTroopMemberFragment.a(this.a, 2131368615));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
              this.a.jdField_d_of_type_AndroidWidgetTextView.setText(alpo.a(2131701987));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new ahxu(this));
              if (this.a.jdField_a_of_type_Ahys != null) {
                this.a.jdField_a_of_type_Ahys.a();
              }
              paramView = this.a.o;
