...
public class ahxt
  extends Handler
{
  public ahxt(GroupSearchFragment paramGroupSearchFragment, Looper paramLooper)
  {
    super(paramLooper);
  }
                  ...
                  if (j != 0)
                  {
                    ...
                    if (SearchEntryConfigManager.a(GroupSearchFragment.a(this.a)) != 0)
                    {
                      if (this.a.jdField_a_of_type_ComTencentMobileqqSearchModelSearchResultModelForEntrance == null) {
                        this.a.jdField_a_of_type_ComTencentMobileqqSearchModelSearchResultModelForEntrance = new SearchResultModelForEntrance(this.a.jdField_b_of_type_JavaLangString, -1, 2130839227, true);
                      }
