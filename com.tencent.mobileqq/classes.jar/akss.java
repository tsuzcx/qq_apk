  ...
  extends QIPCModule
{
  ...
  public static akss a()
  {
    if (jdField_a_of_type_Akss == null) {}
    try
    {
      if (jdField_a_of_type_Akss == null) {
        jdField_a_of_type_Akss = new akss();
      }
      return jdField_a_of_type_Akss;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (anyr)paramQQAppInterface.getManager(85);
    ...
    case 11: 
      ...
      paramQQAppInterface = (afts)paramQQAppInterface.getManager(321);
    ...
    case 12: 
      ...
      if (paramBundle != null)
      {
        ...
        paramQQAppInterface = (afts)paramQQAppInterface.getManager(321);
        if (paramQQAppInterface != null) {
          paramQQAppInterface.a(paramBundle.msg_id.hashCode());
        }
      }
      return null;
    case 13: 
      ...
      if ((paramQQAppInterface != null) && (paramBundle != null))
      {
        paramQQAppInterface.a().b(anhk.ad, 9002, paramBundle.msg_id.hashCode());
        paramQQAppInterface.E();
      }
      return null;
    case 0: 
      paramQQAppInterface = bglf.b(paramQQAppInterface, paramBundle.getString("uin"), true);
      paramBundle = new Bundle();
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new aksx(this, paramInt));
      return null;
    case 8: 
    ...
    case 17: 
      ...
      if (bool)
      {
        paramQQAppInterface = new bcnu(paramQQAppInterface, paramBundle).a();
        paramBundle = new Bundle();
        paramBundle.putSerializable("res", paramQQAppInterface);
        return EIPCResult.createSuccessResult(paramBundle);
      }
      new bcnp(paramQQAppInterface, paramBundle).a(new aksy(this, paramInt));
      return null;
    case 18: 
      paramInt = akwm.a(paramBundle.getString("path"));
    ...
    case 16: 
      ...
      {
        paramBundle = (akph)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    ...
    case 15: 
      localObject = paramBundle.getString("key");
      paramInt = paramBundle.getInt("code");
      paramBundle = new aksz(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
      paramQQAppInterface = (akpd)paramQQAppInterface.getManager(245);
      if (paramQQAppInterface != null)
      {
        if ((this.jdField_a_of_type_JavaUtilMap != null) && (!this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt)))) {
    ...
    paramBundle = new akta(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject1;
    if (((i != 5) && ((i & 0x10) == 0)) || ((((anmw)localObject2).b(str)) && (!paramQQAppInterface.getCurrentAccountUin().equals(str)))) {
      if (!TextUtils.isEmpty(paramBundle))
      {
        localObject1 = (TroopManager)paramQQAppInterface.getManager(52);
        localObject2 = ((anmw)localObject2).e(str);
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramBundle)) {
        localObject1 = bglf.b(paramQQAppInterface, str, true);
      }
      for (;;)
      {
        ...
        localObject1 = bglf.b(paramQQAppInterface, str, true);
        continue;
        paramBundle = bglf.q(paramQQAppInterface, str);
        localObject1 = paramBundle;
        if (TextUtils.isEmpty(paramBundle)) {
          localObject1 = str;
        }
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (akpd)((QQAppInterface)paramAppRuntime).getManager(245);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new aktc(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new aktb(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
    ...
    ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new akst(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new aksu(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
      ...
      else
      {
        ...
        else
        {
          if ("getConditionSearchManager".equals(paramString))
          {
            ...
            paramBundle = (anjh)((QQAppInterface)localObject).getManager(59);
            ...
            if (paramInt != 0)
            {
              ...
              if (i == 0) {
                paramBundle.c(new aksw(this, (Bundle)localObject, i, paramString, paramBundle));
              }
