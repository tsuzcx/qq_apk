...
public class bhlz
{
  ...
  private final RejectedExecutionHandler jdField_a_of_type_JavaUtilConcurrentRejectedExecutionHandler = new bhma(this);
  ...
  public bhlz(String paramString, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor = new ThreadPoolExecutor(paramInt1, paramInt2, 5000L, TimeUnit.SECONDS, new ArrayBlockingQueue(100), new bhmb(paramString), this.jdField_a_of_type_JavaUtilConcurrentRejectedExecutionHandler);
  }
