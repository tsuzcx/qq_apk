  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public bjwj mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  bjwa mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new bjwg(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<bjwn> mRecoverAnimations = new ArrayList();
  ...
  public bjwf(bjwj parambjwj)
  {
    this.mCallback = parambjwj;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new bjwi(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      bjwn localbjwn = (bjwn)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localbjwn.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new bjwa(this.mRecyclerView.getContext(), new bjwm(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return bjwj.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return bjwj.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      bjwn localbjwn = (bjwn)this.mRecoverAnimations.get(i);
      if (localbjwn.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localbjwn.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localbjwn.jdField_c_of_type_Boolean) {
          localbjwn.b();
        }
        this.mRecoverAnimations.remove(i);
        return localbjwn.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  bjwn findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      bjwn localbjwn = (bjwn)this.mRecoverAnimations.get(i);
      paramMotionEvent = localbjwn;
      if (localbjwn.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (bjwn)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((bjwn)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(bjwn parambjwn, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, parambjwn, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new bjwh(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((bjwn)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
