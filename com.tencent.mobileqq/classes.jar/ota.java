...
public class ota
{
  ...
  private static volatile ota jdField_a_of_type_Ota;
  private static otk jdField_a_of_type_Otk = new otk(null);
  ...
  private otc jdField_a_of_type_Otc;
  public oto a;
  ...
  private ota()
  {
    this.jdField_a_of_type_Oto = new oto(this);
    this.jdField_b_of_type_Oto = this.jdField_a_of_type_Oto;
    p();
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (m < localObject2.length)
        {
          ...
          String str = bbfd.a(BaseApplicationImpl.getContext(), localObject2[m]);
  ...
  private String a(axuo paramaxuo)
  {
    paramaxuo = paramaxuo.a.iterator();
    while (paramaxuo.hasNext())
    {
      axun localaxun = (axun)paramaxuo.next();
      if ((localaxun instanceof StructMsgItemTitle)) {
        return ((StructMsgItemTitle)localaxun).b();
      }
    }
    return "";
  }
  ...
  private String a(List<ChatMessage> paramList)
  {
    ...
    if (MessageForStructing.class.isInstance(paramList))
    {
      ...
      if (StructMsgForGeneralShare.class.isInstance(paramList))
      {
        ...
        {
          Object localObject = (axun)paramList.next();
          if ((localObject instanceof axuo))
          {
            localObject = a((axuo)localObject);
  ...
  public static ota a()
  {
    if (jdField_a_of_type_Ota == null) {}
    try
    {
      if (jdField_a_of_type_Ota == null) {
        jdField_a_of_type_Ota = new ota();
      }
      return jdField_a_of_type_Ota;
    }
    finally {}
  }
  
  private otc a(List<ChatMessage> paramList)
  {
    otc localotc = new otc(this);
    int m = 0;
    int n = 0;
    Object localObject = bhvh.a();
    ...
    else
    {
      ...
      localotc.a = paramList;
      localotc.b = ((oidb_cmd0x80a.AttributeList)localObject);
      localotc.c = localAttributeList1;
      localotc.d = localAttributeList2;
      return localotc;
    }
    int i2;
  ...
  public static void a(List<otn> paramList)
  {
  ...
  {
    oto localoto = a().jdField_a_of_type_Oto;
    if (paramInt1 == 0) {}
  ...
  public static void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        boolean bool2;
        m = 0;
        actn.a("onMainFragmentTabClick", "onMainFragmentTabClick", localException1);
        continue;
      }
      try
      {
                ...
                if (SPEventReportSwitch.a(paramInt))
                {
                  ...
                  if (SPEventReportSwitch.a(paramInt))
                  {
                    ...
                    if (((SPEventReportSwitch.a()) && (l1 - jdField_f_of_type_Long >= SPEventReportSwitch.c() * 1000) && (jdField_a_of_type_Int <= 1)) || (SPEventReportSwitch.a(paramInt)))
                    {
                      ...
                      try
                      {
                        Pair localPair = bhvh.b();
                        paramInt = (int)(Long.valueOf(onk.a()).longValue() % 100L);
  ...
  public static void d(boolean paramBoolean)
  {
    ...
    } while (otd.jdField_a_of_type_Int == 2);
    otd.c();
  ...
  {
    Object localObject = vyb.a();
    if (TextUtils.equals((CharSequence)localObject, (String)bhvh.a("dau_report_type_" + paramInt, "")))
    {
      QLog.d("ReadinjoySPEventReport", 2, "has report dau for type today, type :" + paramInt);
      return;
    }
    bhvh.a("dau_report_type_" + paramInt, localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
  ...
  public static void g()
  {
    ...
    try
    {
      ...
      BaseApplicationImpl.getContext().registerReceiver(jdField_a_of_type_Otk, localIntentFilter);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void m()
  {
    ...
    localAttributeList.att_value.set(olm.a());
    localArrayList.add(localAttributeList);
    sgj.a(91, localArrayList);
  }
  ...
  private void r()
  {
    ...
    {
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(this.jdField_a_of_type_Otc.a);
      localArrayList.add(this.jdField_a_of_type_Otc.c);
      localArrayList.add(this.jdField_a_of_type_Otc.d);
      sgj.a(14, localArrayList);
    }
  }
  ...
  public ArrayList<oidb_cmd0x80a.AttributeList> a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x80a.AttributeList)localObject2).att_value.set(String.valueOf(onk.jdField_d_of_type_Int));
      localArrayList.add(localObject2);
      localObject2 = new oidb_cmd0x80a.AttributeList();
      ...
      if (onk.c((QQAppInterface)localObject1)) {}
      ...
      ((oidb_cmd0x80a.AttributeList)localObject1).att_value.set(onk.jdField_a_of_type_Long + ":" + onk.jdField_d_of_type_Int);
      ...
      if (a())
      {
        ...
        if (localObject1 != null)
        {
          ((otc)localObject1).b.att_id.set(110);
          localArrayList.add(((otc)localObject1).b);
        }
        localObject1 = new oidb_cmd0x80a.AttributeList();
      ...
      localObject3 = ((oidb_cmd0x80a.AttributeList)localObject2).att_value;
      if ((i1 >= 0) && (i1 + 1 <= onk.jdField_a_of_type_Int)) {}
      for (localObject1 = "1";; localObject1 = "0")
      {
        ((PBStringField)localObject3).set((String)localObject1);
        localArrayList.add(localObject2);
        localObject1 = vyp.c(BaseApplicationImpl.getContext());
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          localObject2 = new oidb_cmd0x80a.AttributeList();
      ...
      localObject3 = ((oidb_cmd0x80a.AttributeList)localObject2).att_value;
      if ((paramInt >= 0) && (paramInt + 1 <= onk.jdField_a_of_type_Int))
      {
        localObject1 = "1";
        ((PBStringField)localObject3).set((String)localObject1);
        localArrayList.add(localObject2);
        boolean bool = SettingCloneUtil.readValue(BaseApplicationImpl.getContext(), onk.a(), "", "qqsetting_notify_showcontent_key", true);
        localObject2 = new oidb_cmd0x80a.AttributeList();
        ...
        ((PBStringField)localObject3).set((String)localObject1);
        localArrayList.add(localObject2);
        paramInt = bhvh.a((QQAppInterface)onk.a());
        if (paramInt != -1)
        {
          localObject1 = new oidb_cmd0x80a.AttributeList();
        ...
        localObject1 = bbct.b(BaseApplicationImpl.getContext());
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          localObject2 = new oidb_cmd0x80a.AttributeList();
        ...
        if (onk.jdField_d_of_type_Int != 1) {
          break label2879;
        }
        paramInt = 0;
        label2684:
  ...
  public otc a()
  {
    otc localotc = this.jdField_a_of_type_Otc;
    this.jdField_a_of_type_Otc = null;
    return localotc;
  }
  ...
  public void a(String paramString, axun paramaxun)
  {
    if ("2909288299".equals(paramString))
    {
      b("ClickMsg");
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      shx.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long);
      if (paramBoolean)
      {
  ...
  public void b()
  {
    try
    {
      ...
      boolean bool = onk.c((QQAppInterface)localObject1);
      oidb_cmd0x80a.AttributeList localAttributeList1 = new oidb_cmd0x80a.AttributeList();
      localAttributeList1.att_id.set(1);
      ...
      for (localObject1 = "1";; localObject1 = "0")
      {
        ...
        ((oidb_cmd0x80a.AttributeList)localObject1).att_value.set(onk.jdField_d_of_type_Int + "");
        localObject2 = new ArrayList(3);
        ((List)localObject2).add(localAttributeList1);
        ((List)localObject2).add(localAttributeList2);
        ((List)localObject2).add(localObject1);
        sgj.a(1, (List)localObject2);
        if (!QLog.isColorLevel()) {
          break;
        }
