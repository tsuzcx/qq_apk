  ...
  implements axeo, axeq
{
  ...
  public oeh(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    if (axlc.a(paramContext) != 0) {}
    for (;;)
    {
  ...
  private void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Oei != null) {
      this.jdField_a_of_type_Oei.a(paramInt);
    }
  }
  ...
  public void a(oei paramoei)
  {
    this.jdField_a_of_type_Oei = paramoei;
  }
}
