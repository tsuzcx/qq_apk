...
public class bkyh
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, arpq paramarpq, int paramInt1, int paramInt2)
  {
    try
    {
      if (paramarpq.a.strPkgName.equals("com.android.ReadInJoy")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MainFragment paramMainFragment, anun paramanun, int paramInt)
  {
    try
    {
      if ((((paramanun instanceof ReadinjoyTabFrame)) || (paramInt == MainFragment.h)) && ((ReadinjoyTabFrame)paramMainFragment.a(ReadinjoyTabFrame.class) != null) && (paramInt == MainFragment.h) && (paramMainFragment.getActivity().getIntent().getIntExtra("launch_from", 5) == 6)) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    try
    {
      ...
      {
        avdu.a(paramQQAppInterface, paramMessageRecord.frienduin, 10006, 1);
        return;
      }
    }
    catch (Throwable paramQQAppInterface)
    ...
    if (paramRecentUser != null) {
      try
      {
        ...
        while (paramRecentUser.getType() == 7220)
        {
          ...
          return;
          label145:
          if (AppConstants.KANDIAN_DAILY_UIN.equals(paramRecentBaseData.getRecentUserUin())) {
  ...
  {
    bdla.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, paramString3, paramString4, paramString5);
  }
}
