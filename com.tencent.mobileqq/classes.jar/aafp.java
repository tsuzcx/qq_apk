...
public class aafp
  implements acho, IMemoryManager, MemoryManager.IReportListener, IAppStateChangeListener
{
  private static aafp jdField_a_of_type_Aafp;
  ...
  private Vector<aafq> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  public static aafp a()
  {
    if (jdField_a_of_type_Aafp == null) {}
    try
    {
      if (jdField_a_of_type_Aafp == null) {
        jdField_a_of_type_Aafp = new aafp();
      }
      return jdField_a_of_type_Aafp;
    }
    finally {}
  }
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    for (Object localObject = ((AppRuntime)localObject).getAccount();; localObject = null)
    {
      ...
      {
        if (paramString != null) {
          StatisticCollector.getInstance(BaseApplicationImpl.getApplication()).collectPerformance((String)localObject, paramString, true, 0L, 0L, localHashMap, "", true);
        }
        return;
        if (paramInt == l)
        {
  ...
  public void a()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", amxy.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", bcer.a().a());
    ...
    for (String str2 = "low_mem_report_rdm_time";; str2 = "bg_mem_report_rdm_time")
    {
      ...
      if (l1 > 0L) {
        if (Math.abs(l2 - l1) > 3600000L)
        {
          ...
          localHashMap.put("memoryPss", String.valueOf(MemoryManager.getMemory(Process.myPid()) / 1024L));
          label402:
          StatisticCollector.getInstance(BaseApplicationImpl.getApplication()).collectPerformance(null, str1, true, 0L, 0L, localHashMap, null);
  ...
  {
    aafl localaafl = MagnifierSDK.a().a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localaafl.jdField_a_of_type_Boolean + "configId" + localaafl.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramaafm.jdField_b_of_type_Int * localaafl.jdField_b_of_type_Int * 1000)) && (localaafl.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramaafm);
      return;
    }
    catch (Exception paramaafm)
    {
      while (!QLog.isColorLevel()) {}
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramaafm);
    }
  }
  ...
  public void a(aafq paramaafq)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramaafq);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", amxy.a());
        ...
        localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
        StatisticCollector.getInstance(BaseApplicationImpl.getApplication()).collectPerformance(null, "MemoryIncreaseInfo", true, 0L, 0L, localHashMap, "", true);
  ...
  public void b(int paramInt, aafm paramaafm)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((aafq)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramaafm.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramaafm.a > 0.0F) && (paramaafm.a < 1.0F))
          {
            l4 = MemoryManager.getAvailClassSize() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramaafm.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramaafm.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramaafm.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramaafm = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramaafm.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramaafm.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramaafm = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramaafm.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramaafm.next();
              ...
              break label1465;
              label842:
              paramaafm = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramaafm.length < 2) {
                break label1522;
              }
              if ((paramaafm[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramaafm[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramaafm[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramaafm[1].toString());
              i1 = i2;
              break label1522;
            }
          }
    ...
    for (;;)
    {
      aafn.a(BaseApplicationImpl.class.getClassLoader());
  ...
  public void b(aafq paramaafq)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramaafq);
      return;
    }
  }
  ...
  public final void c()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
      StatisticCollector.getInstance(BaseApplicationImpl.getApplication()).collectPerformance(null, "memory_oom_Info", true, 0L, 0L, localHashMap, null);
      localSharedPreferences.edit().remove("trim_count").commit();
      return;
    }
  }
  
  public void onReportMemory()
  {
    a(2);
    aafn.a(BaseApplicationImpl.class.getClassLoader());
  }
