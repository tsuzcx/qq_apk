...
public class obb
{
  ...
  public Activity a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new obg(this);
  ...
  public obb(Activity paramActivity, obh paramobh)
  {
  ...
  void a(ojh paramojh)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new obc(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new obd(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new obe(this));
    }
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ...
        if (paramojh.a != null)
        {
          ...
          if (paramojh.a.size() != 0) {
            localObject1 = ((oji)paramojh.a.get(0)).j;
          }
        }
        if ((localObject1 != null) && (!TextUtils.isEmpty((CharSequence)localObject1)))
        {
          ...
          paramojh = new HashMap();
          paramojh.put("shouq_bus_type", "bus_type_account_detail");
          this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_PlayerVideoInfo.setReportInfoMap(paramojh);
  ...
  public void a(ojh paramojh, FrameLayout paramFrameLayout)
  {
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_Obh.f();
    }
    label86:
    while (!paramBoolean) {
      return;
    }
    this.jdField_a_of_type_Obh.g();
  }
