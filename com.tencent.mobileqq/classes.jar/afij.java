  ...
  implements afxj
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new afiw(this, null);
  bdqc jdField_a_of_type_Bdqc = new afio(this);
  ...
  VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new afja(this);
  Runnable jdField_a_of_type_JavaLangRunnable = null;
  private float jdField_b_of_type_Float = 1.0F;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new afiz(this);
  ...
  public afij(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  private int a(afiv paramafiv)
  {
    switch (((MessageForPoke)paramafiv.jdField_a_of_type_ComTencentMobileqqDataChatMessage).interactType)
    {
    default: 
      return azgq.a(paramafiv.jdField_a_of_type_Float * 100.0F);
    case 0: 
    case 1: 
      if (paramafiv.jdField_a_of_type_Float == 2.0F) {
        return azgq.a(150.0F * paramafiv.jdField_a_of_type_Float);
      }
      return azgq.a(paramafiv.jdField_a_of_type_Float * 100.0F);
    case 2: 
      return azgq.a(280.0F * paramafiv.jdField_a_of_type_Float);
    case 3: 
      return azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    case 4: 
      return azgq.a(paramafiv.jdField_a_of_type_Float * 100.0F);
    case 6: 
      return 0;
    }
    return azgq.a(230.0F * paramafiv.jdField_a_of_type_Float);
  }
  ...
  public static AnimationSet a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      i = aekt.a(22.0F, paramContext.getResources());
      j = aekt.a(30.0F, paramContext.getResources());
      if (!paramBoolean) {
        break label184;
      }
    ...
    for (;;)
    {
      ...
      i += 1;
      break label107;
      i = aekt.a(15.0F, paramContext.getResources());
      j = aekt.a(20.0F, paramContext.getResources());
      break;
      label184:
      paramContext = new int[4];
      paramContext[0] = i;
  ...
  private void a(long paramLong, MessageForPoke paramMessageForPoke)
  {
    if (this.jdField_a_of_type_AndroidUtilLruCache == null) {
      this.jdField_a_of_type_AndroidUtilLruCache = new afik(this, jdField_e_of_type_Int);
    }
    this.jdField_a_of_type_AndroidUtilLruCache.put(Long.valueOf(paramLong), paramMessageForPoke);
  }
  
  private void a(afiv paramafiv, MessageForPoke paramMessageForPoke)
  {
    RelativeLayout.LayoutParams localLayoutParams1 = (RelativeLayout.LayoutParams)paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getLayoutParams();
    Object localObject1 = (RelativeLayout.LayoutParams)((ViewGroup)paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getParent()).getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams2 = (RelativeLayout.LayoutParams)paramafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
    Object localObject2 = (RelativeLayout.LayoutParams)paramafiv.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
    Object localObject3 = (RelativeLayout.LayoutParams)paramafiv.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams();
    Object localObject4 = (RelativeLayout.LayoutParams)paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams3 = (RelativeLayout.LayoutParams)paramafiv.jdField_c_of_type_AndroidViewView.getLayoutParams();
    paramafiv.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    paramafiv.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    paramafiv.jdField_c_of_type_AndroidViewView.setVisibility(8);
    int i;
    label415:
    label480:
    int j;
    ...
    {
    default: 
      paramafiv.jdField_a_of_type_Float = this.jdField_b_of_type_Float;
      f();
      if (126 != paramMessageForPoke.interactType) {
        break label1328;
      }
      localLayoutParams1.height = azgq.a(70.0F);
      localLayoutParams1.topMargin = azgq.a(10.0F);
      localLayoutParams1.bottomMargin = azgq.a(10.0F);
      ((RelativeLayout.LayoutParams)localObject2).width = azgq.a(70.0F);
      ((RelativeLayout.LayoutParams)localObject2).height = azgq.a(70.0F);
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleType(ImageView.ScaleType.FIT_CENTER);
      paramafiv.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
      ((RelativeLayout.LayoutParams)localObject1).height = azgq.a(90.0F);
      localLayoutParams2.leftMargin = 0;
      localLayoutParams2.rightMargin = 0;
      localLayoutParams2.width = azgq.a(90.0F);
      localLayoutParams2.height = azgq.a(90.0F);
      if ((this.jdField_c_of_type_JavaUtilMap != null) && (!this.jdField_c_of_type_JavaUtilMap.isEmpty()) && (this.jdField_c_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramMessageForPoke.subId))))
      {
        ...
        if ((4 == i) || (5 == i))
        {
          localObject1 = bdda.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838113);
          localObject4 = bdda.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838114);
          localObject1 = bhnx.a(this.jdField_a_of_type_AndroidContentContext.getResources(), (Bitmap)localObject1, (Bitmap)localObject4);
          paramafiv.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
        }
      }
      else
      {
        ...
        paramafiv.jdField_a_of_type_AndroidWidgetImageView.setScaleX(1.0F);
        paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(1.0F);
        ((RelativeLayout.LayoutParams)localObject2).leftMargin = azgq.a(20.0F);
        ((RelativeLayout.LayoutParams)localObject2).rightMargin = 0;
        ((RelativeLayout.LayoutParams)localObject2).topMargin = azgq.a(10.0F);
        ((RelativeLayout.LayoutParams)localObject2).bottomMargin = 0;
        localObject2 = new File(afsw.e + paramMessageForPoke.subId + "/pressed.png");
        localObject3 = URLDrawable.URLDrawableOptions.obtain();
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846869);
        ...
        localObject3 = new File(afsw.e + paramMessageForPoke.subId + "/normal.png");
        ...
        ((URLDrawable)localObject1).setURLDrawableListener(new afit(this, (StateListDrawable)localObject3));
        if ((((URLDrawable)localObject1).getStatus() == 2) || (((URLDrawable)localObject1).getStatus() == 3)) {
          ((URLDrawable)localObject1).restartDownload();
        }
        paramafiv.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject3);
        if (afsw.a("bubble", paramMessageForPoke.subId)) {
          break label1098;
        }
        i = 1;
        label774:
        if (afsw.a("/normal.png", paramMessageForPoke.subId)) {
          break label1103;
        }
        j = 1;
        label790:
        ...
        if (!afsw.a.contains(Integer.valueOf(paramMessageForPoke.subId))) {
          break label1120;
        }
        if ((!afsw.c.contains(Integer.valueOf(paramMessageForPoke.subId))) && (!afsw.d.contains(Integer.valueOf(paramMessageForPoke.subId)))) {
          break label1109;
        }
        paramafiv.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      }
      break;
    }
    for (;;)
    {
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable((Drawable)localObject1);
      paramafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(localLayoutParams2);
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setLayoutParams(localLayoutParams1);
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.removeAllAnimatorListener();
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new afiu(this, paramafiv, paramMessageForPoke));
      return;
      ...
      break;
      localObject1 = bdda.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838111);
      localObject4 = bdda.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838112);
      localObject1 = bhnx.a(this.jdField_a_of_type_AndroidContentContext.getResources(), (Bitmap)localObject1, (Bitmap)localObject4);
      break label415;
      label992:
      paramafiv.jdField_a_of_type_AndroidWidgetImageView.setScaleX(-1.0F);
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(-1.0F);
      ((RelativeLayout.LayoutParams)localObject2).rightMargin = azgq.a(20.0F);
      ((RelativeLayout.LayoutParams)localObject2).leftMargin = 0;
      ((RelativeLayout.LayoutParams)localObject2).topMargin = azgq.a(10.0F);
      ((RelativeLayout.LayoutParams)localObject2).bottomMargin = 0;
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + azgq.a(10.0F) - azgq.a(6.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(azgq.a(80.0F) * paramafiv.jdField_a_of_type_Float - azgq.a(34.0F)));
      break label480;
      label1098:
      i = 0;
      break label774;
      ...
      break label790;
      label1109:
      paramafiv.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      continue;
      label1120:
      afsw.a.add(Integer.valueOf(paramMessageForPoke.subId));
      afsw.c.add(Integer.valueOf(paramMessageForPoke.subId));
      afsw.d.add(Integer.valueOf(paramMessageForPoke.subId));
      paramafiv.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
    ...
    label1328:
    localLayoutParams1.height = azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    localLayoutParams1.width = a(paramafiv);
    localLayoutParams1.topMargin = azgq.a(0.0F);
    localLayoutParams1.bottomMargin = azgq.a(0.0F);
    ((RelativeLayout.LayoutParams)localObject4).height = azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    localLayoutParams2.width = azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    localLayoutParams2.height = azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    localLayoutParams3.width = azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    localLayoutParams3.height = azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).width = azgq.a(80.0F * paramafiv.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).height = azgq.a(70.0F * paramafiv.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).topMargin = azgq.a(10.0F * paramafiv.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).bottomMargin = azgq.a(10.0F * paramafiv.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject1).height = azgq.a(90.0F * paramafiv.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).leftMargin = 0;
    ((RelativeLayout.LayoutParams)localObject2).rightMargin = 0;
    paramafiv.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramafiv.jdField_a_of_type_AndroidWidgetImageView.setScaleX(1.0F);
    paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(1.0F);
    localObject1 = bdda.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838111);
    localObject4 = bdda.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838112);
    ...
    for (;;)
    {
      localObject1 = afsw.a(paramMessageForPoke.interactType, paramMessageForPoke.isSend(), this.jdField_a_of_type_AndroidContentContext.getResources());
      paramafiv.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
      paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a(paramMessageForPoke, paramafiv.jdField_a_of_type_Float);
      break;
      if ((paramafiv.jdField_b_of_type_Int == f) && (!paramMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke)))
      {
        paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        if (!paramMessageForPoke.hasQuickBackShowed)
        {
          paramMessageForPoke.hasQuickBackShowed = true;
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8008912", "0X8008912", 0, 0, "", "", "", "");
        }
      }
      for (;;)
      {
        localLayoutParams2.leftMargin = azgq.a(10.0F * paramafiv.jdField_a_of_type_Float);
        localLayoutParams2.rightMargin = 0;
        ...
        default: 
          break;
        case 0: 
          ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - azgq.a(6.0F));
          ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(azgq.a(80.0F) * paramafiv.jdField_a_of_type_Float - azgq.a(34.0F)));
          break;
          paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        }
      }
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - azgq.a(6.0F) - azgq.a(10.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(azgq.a(80.0F) * paramafiv.jdField_a_of_type_Float - azgq.a(35.0F)));
      continue;
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - azgq.a(6.0F) - azgq.a(20.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(azgq.a(80.0F) * paramafiv.jdField_a_of_type_Float - azgq.a(36.0F)));
      continue;
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - azgq.a(6.0F) - azgq.a(40.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(azgq.a(80.0F) * paramafiv.jdField_a_of_type_Float - azgq.a(38.0F)));
    }
  }
  ...
  private void a(Context paramContext)
  {
    if (jdField_e_of_type_Int == 0) {
      jdField_e_of_type_Int = (paramContext.getResources().getDisplayMetrics().heightPixels - azgq.a(50.0F) * 2) / azgq.a(90.0F);
    }
    if (jdField_e_of_type_Int <= 0) {
  ...
  private String b(ChatMessage paramChatMessage)
  {
    ...
    for (paramChatMessage = alpo.a(2131705658);; paramChatMessage = paramChatMessage.msg.substring(1, paramChatMessage.msg.length() - 1)) {
      try
      {
  ...
  private void b(afiv paramafiv, MessageForPoke paramMessageForPoke)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    ...
    {
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
      paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
      paramafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      if ((paramafiv.jdField_b_of_type_Int == f) && (!paramMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke)))
      {
        paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
        if (paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a())
        {
          localUnlimitedBladeWorks = paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
          if (paramMessageForPoke.isSend()) {
            break label193;
          }
          label149:
        ...
        paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (PokeBigResHandler.jdField_a_of_type_Boolean)
      {
        ...
        {
          bool1 = true;
          localUnlimitedBladeWorks.a(localContext, bool1, afsw.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface), paramafiv.jdField_a_of_type_Float);
        }
      }
      else
      {
        ...
        paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(0);
        paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
        paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
        paramafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
        paramafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        paramafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        localUnlimitedBladeWorks = paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
        if (paramMessageForPoke.isSend()) {
          break label398;
        }
        ...
        paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new afim(this, paramafiv, paramMessageForPoke));
        localUnlimitedBladeWorks = paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
        if (paramMessageForPoke.isSend()) {
          break label403;
        }
      ...
      {
        localUnlimitedBladeWorks.a(paramMessageForPoke, bool1, paramafiv.jdField_a_of_type_Float);
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    paramafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
    paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new afin(this, paramafiv, paramMessageForPoke));
    if (QLog.isColorLevel()) {
      QLog.i("fangdazhao", 2, "[start]");
    }
    paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.c();
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new afip(this));
    ...
    this.jdField_b_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new afiq(this);
    e();
    if (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) {
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bdqc);
    }
  }
  ...
  private String c(ChatMessage paramChatMessage)
  {
    ...
    if (TextUtils.isEmpty(paramChatMessage.msg)) {}
    for (paramChatMessage = alpo.a(2131705657);; paramChatMessage = paramChatMessage.msg.substring(1, paramChatMessage.msg.length() - 1)) {
      try
      {
        Integer.parseInt(paramChatMessage);
  ...
  private void f()
  {
    List localList;
    int i;
    if ((this.jdField_a_of_type_AndroidWidgetBaseAdapter != null) && ((this.jdField_a_of_type_AndroidWidgetBaseAdapter instanceof aelz)))
    {
      localList = ((aelz)this.jdField_a_of_type_AndroidWidgetBaseAdapter).a();
      if (localList != null) {
        i = localList.size() - 1;
      }
    }
  ...
  public View a(ChatMessage paramChatMessage, aelt paramaelt, View paramView, BaseChatItemLayout paramBaseChatItemLayout, aeov paramaeov)
  {
    ...
    if (paramView == null)
    {
      ...
      localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)localObject4);
      ...
      ((ImageView)localObject3).setId(2131373942);
      paramView = bdda.a(((Context)localObject1).getResources(), 2130838111);
      Object localObject2 = bdda.a(((Context)localObject1).getResources(), 2130838112);
      ((ImageView)localObject3).setImageDrawable(bhnx.a(((Context)localObject1).getResources(), paramView, (Bitmap)localObject2));
      localafiv.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localObject3);
      paramaelt.addView((View)localObject3);
      UnlimitedBladeWorks localUnlimitedBladeWorks = new UnlimitedBladeWorks((Context)localObject1);
      localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks = localUnlimitedBladeWorks;
      paramaelt.addView(localUnlimitedBladeWorks);
      RelativeLayout localRelativeLayout = new RelativeLayout((Context)localObject1);
      localRelativeLayout.setId(2131372154);
      ImageView localImageView = new ImageView((Context)localObject1);
      localafiv.jdField_a_of_type_AndroidWidgetImageView = localImageView;
      ...
      ((ProgressBar)localObject2).setIndeterminateDrawable(((Context)localObject1).getResources().getDrawable(2130839228));
      localafiv.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)localObject2);
      localRelativeLayout.addView((View)localObject2);
      paramView = new ImageView((Context)localObject1);
      paramView.setId(2131377365);
      paramView.setImageResource(2130846870);
      localafiv.jdField_b_of_type_AndroidWidgetImageView = paramView;
      localRelativeLayout.addView(paramView);
      localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout = localRelativeLayout;
      paramaelt.addView(localRelativeLayout);
      View localView = new View((Context)localObject1);
      paramaelt.addView(localView);
      localafiv.jdField_c_of_type_AndroidViewView = localView;
      localObject4 = (RelativeLayout.LayoutParams)((DiniFlyAnimationView)localObject4).getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject4).height = azgq.a(90.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject4).height = azgq.a(40.0F);
      ((RelativeLayout.LayoutParams)localObject4).width = azgq.a(40.0F);
      ((ImageView)localObject3).setPadding(azgq.a(6.0F), azgq.a(6.0F), azgq.a(6.0F), azgq.a(6.0F));
      ...
      ((RelativeLayout.LayoutParams)localObject3).height = azgq.a(90.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject3).width = azgq.a(90.0F);
      ((RelativeLayout.LayoutParams)localObject3).height = azgq.a(90.0F);
      ((RelativeLayout.LayoutParams)localObject3).addRule(12, -1);
      ...
      ((RelativeLayout.LayoutParams)localObject3).height = azgq.a(70.0F);
      ((RelativeLayout.LayoutParams)localObject3).width = azgq.a(80.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = azgq.a(10.0F);
      ...
      paramView.bottomMargin = azgq.a(10.0F);
    }
    if (QLog.isColorLevel()) {
      QLog.d("GivingHeart", 2, "[getBubbleView]set Holder's contentView");
    }
    paramaelt.setTag(localafiv);
    a(localafiv, paramBaseChatItemLayout);
    localafiv.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
    ...
    localafiv.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(c(paramChatMessage));
    if (jdField_e_of_type_Boolean)
    {
      if ((localafiv.jdField_b_of_type_JavaLangStringBuilder != null) && (localafiv.jdField_b_of_type_JavaLangStringBuilder.length() > 0)) {
        localafiv.jdField_b_of_type_JavaLangStringBuilder.setLength(0);
      }
      paramaelt.setContentDescription(b(paramChatMessage));
    }
    return paramaelt;
  }
  ...
  public void a()
  {
    ...
    if (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) {
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bdqc);
    }
    aekt.jdField_a_of_type_Int = 0;
  }
  ...
  public void a(afiv paramafiv)
  {
    if (paramafiv != null)
    {
      paramafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      paramafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      if ((paramafiv.jdField_b_of_type_Int != f) || (paramafiv.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) || ((this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) || (b(paramafiv.jdField_a_of_type_ComTencentMobileqqDataChatMessage))) {
        break label106;
      }
      paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    ...
    {
      paramafiv.jdField_c_of_type_AndroidViewView.setVisibility(8);
      if (!((MessageForPoke)paramafiv.jdField_a_of_type_ComTencentMobileqqDataChatMessage).isPlayed) {
        ((MessageForPoke)paramafiv.jdField_a_of_type_ComTencentMobileqqDataChatMessage).setPlayed(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      return;
      label106:
      paramafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, aelt paramaelt, int paramInt1, int paramInt2)
  {
    ...
    {
      localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
      localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
      localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
      localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      if ((!localMessageForPoke.isSend()) && (localafiv.jdField_b_of_type_Int == f) && (localMessageForPoke.isPlayed) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(localMessageForPoke))) {
        localafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if ((!localMessageForPoke.isPlayed) && (!localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.isAnimating()))
      {
        if (akwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).d != 1) {
          break label345;
        }
        paramInt1 = 0;
        if (paramInt1 != 0)
        {
          akwk.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "vas_poke", true);
          if (QLog.isColorLevel()) {
            QLog.i("GivingHeart.sprite", 2, "hide sprite (normal) in play.");
          }
        }
        afsw.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramContext, localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView, localafiv, localMessageForPoke.subId, "bubble");
      }
    }
    label345:
    label378:
    ...
    do
    {
      ...
      do
      {
        ...
        if (localMessageForPoke.isSend())
        {
          ...
          localObject = (RelativeLayout.LayoutParams)paramaelt.a.getLayoutParams();
        ...
        for (;;)
        {
          paramaelt.a.setLayoutParams((ViewGroup.LayoutParams)localObject);
          if ((PokeBigResHandler.jdField_a_of_type_Boolean) && (!(paramContext instanceof ChatHistoryActivity))) {
            break label601;
          }
          localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
          localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
          localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
          localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PokeMsg", 2, "Strength holder = " + localafiv.jdField_a_of_type_Float);
        }
        if ((localMessageForPoke.interactType != 5) || (localafiv.jdField_a_of_type_Float != 2.0F)) {
          break label1019;
        }
        localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
        localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
      ...
      localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      localafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      localafiv.jdField_c_of_type_AndroidViewView.setVisibility(0);
      paramChatMessage.setListener(this);
      aekt.jdField_a_of_type_Int += 1;
      paramChatMessage.a(localafiv, afsw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      return;
      paramChatMessage = paramChatMessage.a();
      if (localafiv.jdField_a_of_type_ComTencentMobileqqDataChatMessage == paramChatMessage)
      {
      ...
      if (SixCombolEffectView.jdField_a_of_type_Int > 0)
      {
        ...
        if ((paramChatMessage != null) && (localafiv.jdField_a_of_type_ComTencentMobileqqDataChatMessage == paramChatMessage))
        {
          switch (SixCombolEffectView.jdField_a_of_type_Int)
          {
          default: 
      ...
      if (localMessageForPoke.interactType == 6)
      {
        b(localafiv, localMessageForPoke);
        return;
      }
      localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      if ((localMessageForPoke.isPlayed) && (!localMessageForPoke.mFrameState.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a.containsKey(Long.valueOf(localMessageForPoke.uniseq))))
      {
        ...
        localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
        localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        if ((localafiv.jdField_b_of_type_Int == f) && (!localMessageForPoke.isSend()) && (localMessageForPoke.interactType != 126) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(localMessageForPoke))) {
          localafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        for (;;)
        {
      ...
      paramInt1 = 0;
      paramaelt = a(localMessageForPoke.interactType);
      switch (localMessageForPoke.interactType)
      {
      default: 
        paramContext = afss.jdField_a_of_type_JavaLangString + "/chuo_icon/chuo_icon_";
        if ((localMessageForPoke.interactType == 1) || (localMessageForPoke.interactType <= 0) || (localMessageForPoke.interactType > 6)) {
          if (localafiv.jdField_a_of_type_Float == 2.0F)
          {
      ...
      for (;;)
      {
        try
        {
          paramContext = bdda.a(PokeBigResHandler.b + "/chuo_caidan/chuo_caidan_" + "01.png", paramContext);
          paramContext = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramContext, afss.a().a(), localMessageForPoke.mFrameState, paramaelt, afsw.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
          a(paramContext);
          paramContext.a(1);
          if (!paramChatMessage.isSend())
          {
          ...
          localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(0);
          localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
          localafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
          localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
          localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
          localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
          localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(paramContext);
          paramContext.a(new afir(this, localafiv, localMessageForPoke));
          paramContext.d();
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          continue;
          paramContext = afss.jdField_a_of_type_JavaLangString + "/dazhao_icon/dazhao_icon_";
        }
        ...
        paramContext = bdda.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838528);
        paramContext = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramContext, afss.a().a(), localMessageForPoke.mFrameState, paramaelt, afsw.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
        b(paramContext);
        continue;
        ...
        try
        {
          paramBaseChatItemLayout = bdda.a(paramContext + "01.png", (BitmapFactory.Options)localObject);
          paramBaseChatItemLayout = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBaseChatItemLayout, afss.a().a(), localMessageForPoke.mFrameState, paramaelt, afsw.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
          paramBaseChatItemLayout.i();
          paramInt2 = 40;
          if (localMessageForPoke.interactType == 2) {
            paramInt2 = 30;
          }
          if ((localMessageForPoke.interactType == 4) && (localafiv.jdField_a_of_type_Float == 2.0F))
          {
            i = 0;
            for (;;)
            {
        ...
        if (localMessageForPoke.mFrameState.jdField_a_of_type_Boolean)
        {
          try
          {
            paramContext = bdda.a(paramBaseChatItemLayout.a(localMessageForPoke.mFrameState.jdField_a_of_type_Int).jdField_a_of_type_JavaLangString, (BitmapFactory.Options)localObject);
      ...
      if (localMessageForPoke.mFrameState.c)
      {
        ...
        localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
        localafiv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        if ((localafiv.jdField_b_of_type_Int == f) && (!localMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(localMessageForPoke))) {
          localafiv.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        for (;;)
        {
    ...
    localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
    localafiv.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
    paramContext.a(new afis(this, localafiv, localMessageForPoke));
    localafiv.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(paramContext);
    paramContext.c();
    ...
    if (localafiv.jdField_a_of_type_Float == 2.0F)
    {
      ...
      {
        afss.a().a(1);
        afss.a().a(2, 1500L, localMessageForPoke.isSend());
      }
    }
