...
public class aujh
{
  public static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null) {
      axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8009DDA", "0X8009DDA", 0, 0, "", "", "", "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AppRuntime.Status paramStatus, long paramLong)
  {
    ...
    if ((paramQQAppInterface != null) && (paramStatus != null)) {
      switch (auji.a[paramStatus.ordinal()])
      {
      default: 
        i = 0;
      }
    ...
    for (;;)
    {
      ...
      if (j != 0) {
        axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8009DDB", "0X8009DDB", j, 0, "", "", "", "");
      }
      return;
      i = 1;
      continue;
  ...
  {
    if ((paramQQAppInterface != null) && (paramAutoReplyText != null) && (aujf.a(paramStatus)))
    {
      int i = 1;
      if (paramAutoReplyText.getTextId() == 2147483647) {
        i = 2;
      }
      axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8009DDC", "0X8009DDC", i, 0, "", "", "", "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      axqy.b(paramQQAppInterface, "dc00898", "", "", str1, str2, 0, 0, "", "", "", "");
      return;
      str1 = "0X8009DDF";
      break;
    }
  ...
  {
    if (paramQQAppInterface != null) {
      axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8009DDD", "0X8009DDD", 0, 0, "", "", "", "");
    }
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, AppRuntime.Status paramStatus, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8009DE0", "0X8009DE0", 0, 0, String.valueOf(j), "", "", "");
      return;
      i = 1;
      continue;
      i = 2;
