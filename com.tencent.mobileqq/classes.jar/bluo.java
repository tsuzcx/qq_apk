...
public class bluo
{
  ...
  public static void a(Context paramContext)
  {
    ...
    blus.a().enter(paramContext, 1002L, BaseApplicationImpl.getApplication().getRuntime().getAccount(), "", new Bundle(), new blup());
  }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, EnterCallback paramEnterCallback)
  {
    ...
    for (paramIntent = paramIntent.getExtras();; paramIntent = null)
    {
      ...
      blus.a().enter(paramContext, 1003L, BaseApplicationImpl.getApplication().getRuntime().getAccount(), "", (Bundle)localObject, paramEnterCallback);
      return;
    }
  }
}
