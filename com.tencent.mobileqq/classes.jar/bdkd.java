...
public final class bdkd
{
  ...
  public static int a()
  {
    ...
    if (!TextUtils.isEmpty(bdag.a("ro.build.version.opporom"))) {
      return 3;
    }
    if (!TextUtils.isEmpty(bdag.a("ro.vivo.os.version"))) {
      return 4;
    }
    return 0;
  }
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, com.tencent.imcore.message.QQMessageFacade.Message paramMessage, boolean paramBoolean)
  {
    ...
    //   86: astore_1
    //   87: aload_0
    //   88: invokestatic 253	bdkd:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Ljava/lang/String;
    //   91: astore_0
    //   92: aload 8
    //   94: astore 6
    //   96: aload 7
  ...
  public static void a()
  {
    ...
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      asnx localasnx = (asnx)((QQAppInterface)localObject).getManager(219);
      if (localasnx != null) {
        localasnx.d();
      }
  ...
  public static void a(Activity paramActivity, AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      {
        localObject1 = bdox.a("signatureEntrance");
        str1 = str2;
      }
    ...
    for (;;)
    {
      ...
      localObject1 = bdox.a("signatureDIYEntrance");
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {
          ((axho)paramQQAppInterface.getManager(36)).b("100005");
        }
        return;
        i = 0;
        break;
    ...
    for (BubbleManager localBubbleManager = (BubbleManager)paramQQAppInterface.getManager(44);; localBubbleManager = null)
    {
      if ((paramXListView != null) && (localBubbleManager != null))
      {
        ...
        while (i >= 0)
        {
          ...
          {
            aelt localaelt = (aelt)aekt.a((View)localObject);
            localObject = aekt.a((View)localObject);
            if ((localObject != null) && (((ChatMessage)localObject).needVipBubble()) && (localaelt != null) && (localaelt.a != null) && (localaelt.a.jdField_a_of_type_Int == antf.a.jdField_a_of_type_Int) && (localBubbleManager.a(alxl.a(((ChatMessage)localObject).vipBubbleID)))) {
              return true;
            }
            if ((localObject != null) && (((fx)paramQQAppInterface.getManager(42)).a(localaelt, (ChatMessage)localObject))) {
              return true;
            }
          }
          else if ((localObject != null) && ((aekt.a((View)localObject) instanceof afvg)))
          {
            return true;
          }
          i -= 1;
  ...
  public static byte[] a(byte[] paramArrayOfByte, tencent.im.msg.im_msg_body.GeneralFlags paramGeneralFlags, int paramInt)
  {
    ...
    //   153: invokestatic 253	bdkd:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Ljava/lang/String;
    ...
    //   164: aload_0
    //   165: iload_2
    //   166: invokestatic 727	azsd:a	([BI)[B
    //   169: ldc_w 729
    ...
    //   187: ifeq +68 -> 255
    //   190: getstatic 13	bdkd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   193: iconst_1
    ...
    //   260: aconst_null
    //   261: astore_1
    //   262: getstatic 13	bdkd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   265: iconst_1
    //   266: aload 4
    //   268: iconst_0
