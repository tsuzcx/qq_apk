...
public class lah
{
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new lai(this, this.jdField_a_of_type_Int);
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    //   2: monitorenter
    //   3: aload_0
    //   4: getfield 22	lah:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   7: aload_1
    //   8: invokevirtual 28	android/support/v4/util/LruCache:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   11: ifnonnull +17 -> 28
    //   14: aload_0
    //   15: getfield 22	lah:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   18: aload_1
    //   19: aload_2
    ...
    //   27: return
    //   28: aload_0
    //   29: getfield 22	lah:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   32: aload_1
    //   33: invokevirtual 43	android/support/v4/util/LruCache:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   36: pop
    //   37: aload_0
    //   38: getfield 22	lah:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   41: aload_1
    //   42: aload_2
  ...
  {
    a(lal.a(paramString1, paramString2, paramLong) + "tween", paramBoolean.toString());
  }
  
  public boolean a(String paramString1, String paramString2, long paramLong)
  {
    paramString1 = a(lal.a(paramString1, paramString2, paramLong) + "tween");
  ...
  {
    a(lal.a(paramString1, paramString2, paramLong) + "HasChangeToOriginalText", paramBoolean.toString());
  }
  
  public boolean b(String paramString1, String paramString2, long paramLong)
  {
    paramString1 = a(lal.a(paramString1, paramString2, paramLong) + "HasChangeToOriginalText");
    if (paramString1 == null) {
      return false;
    }
    return Boolean.valueOf(paramString1).booleanValue();
