  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, DynamicGridView.OnDragListener, DynamicGridView.OnDropListener
{
  ...
  public abpu(CampusCirclePublishActivity paramCampusCirclePublishActivity, Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramContext, paramInt1);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = paramInt2;
    this.jdField_a_of_type_Boolean = false;
    paramInt1 = paramContext.getResources().getDimensionPixelSize(2131559413);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130970272, null);
    }
    label72:
    ...
    if ((paramViewGroup.getLayoutParams() instanceof AbsListView.LayoutParams))
    {
      ...
      localURLImageView = (URLImageView)paramViewGroup.findViewById(2131363628);
      localView = paramViewGroup.findViewById(2131363520);
      localView.setOnClickListener(this);
      localView.setTag(Integer.valueOf(paramInt));
      if (!"add_plus".equals(str)) {
        break label186;
      }
      paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842349);
  ...
  public boolean onItemLongClick(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (paramInt < j)
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        {
          paramAdapterView = this.jdField_a_of_type_ComTencentMobileqqCampuscircleCampusCirclePublishActivity.jdField_a_of_type_ComTencentWidgetDynamicGridView.getChildAt(i).findViewById(2131363520);
