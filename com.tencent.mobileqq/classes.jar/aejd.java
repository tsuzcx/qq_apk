  ...
  extends Dialog
{
  ...
  public aejd(Context paramContext)
  {
    super(paramContext);
    a(paramContext);
  }
  ...
  protected void a(Context paramContext)
  {
    ...
    setContentView(LayoutInflater.from(paramContext).inflate(2131560779, null));
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableAnimatable = ((Animatable)this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839228));
      if (this.jdField_a_of_type_AndroidGraphicsDrawableAnimatable != null) {
