  ...
  extends axup
{
  ...
  public axwk()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new axwn(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      paramContext.setTag(2131376555, Integer.valueOf(i));
      ...
      if ((!b()) || ((b()) && (a())))
      {
        ...
        paramContext.setOnLongClickListener(new axwl(this));
        paramContext.setOnTouchListener(new axwm(this));
        return paramContext;
        if (j == i - 1)
        {
  ...
  public void a(String paramString, MessageRecord paramMessageRecord, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    try
    {
      ...
      if ((i != 23001027) && (i != 0) && (i != -4) && (i != -6))
      {
        ...
        if (!((agzf)paramString.getManager(245)).a(paramMessageRecord.frienduin))
        {
          j = 1;
          i = -4;
          if (j != 0) {
