...
public class areq
{
  public static String a(QQAppInterface paramQQAppInterface, bgoe parambgoe, boolean paramBoolean)
  {
    ArrayList localArrayList = null;
    if ((paramQQAppInterface == null) && (parambgoe == null)) {}
    ...
    int i = ((Bundle)localObject).getInt("jsonType", areb.c);
    File localFile = (File)parambgoe.jdField_a_of_type_JavaUtilMap.get(parambgoe.jdField_a_of_type_JavaLangString);
    Object localObject = new arfb();
    parambgoe = localArrayList;
    if (localFile != null)
    {
      if (localFile.exists()) {
        parambgoe = FileUtils.fileToBytes(localFile);
      }
    }
    else
    {
    ...
    label162:
    for (paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambgoe, localArrayList);; paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambgoe, localArrayList, (arfb)localObject))
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, arfb paramarfb)
  {
    if (QLog.isColorLevel()) {
      QLog.d("EmotionJsonUtils", 2, "parseJson : parseJson start");
    }
    Object localObject = a(paramQQAppInterface, paramEmoticonPackage, paramArrayOfByte, paramArrayList, paramarfb);
    if (localObject != null) {
    ...
    {
      return paramQQAppInterface;
      localObject = (avsq)paramQQAppInterface.getManager(14);
      try
      {
        ...
        paramArrayOfByte = a(paramEmoticonPackage, paramInt, (avsq)localObject, localJSONObject, str, paramQQAppInterface, "");
        ...
        for (paramEmoticonPackage.supportSize = paramQQAppInterface;; paramEmoticonPackage.supportSize = localJSONObject.getJSONArray("supportSize").toString()) {
          do
          {
            ...
            ((avsq)localObject).a(paramEmoticonPackage);
            int i = ((avsq)localObject).a(str);
            boolean bool = false;
            ...
            paramArrayOfByte = a(paramEmoticonPackage, paramInt, paramArrayList, paramarfb, (avsq)localObject, localJSONObject, str, i, bool);
            paramQQAppInterface = paramArrayOfByte;
            if (paramArrayOfByte != null) {
              break;
            }
  ...
  protected static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, arfb paramarfb)
  {
    if (paramQQAppInterface == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList == null) || (paramarfb == null))
    {
      if (QLog.isColorLevel()) {
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt, avsq paramavsq, JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3)
  {
    int i2 = 0;
            ...
            for (int n = paramJSONObject.getInt("updateTime");; n = 0)
            {
              ...
              for (;;)
              {
                ...
                for (int i1 = 3;; i1 = 0)
                {
                  ...
                  a(paramEmoticonPackage, paramInt, paramavsq, paramJSONObject, paramString1, m, j, n);
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, arfb paramarfb, avsq paramavsq, JSONObject paramJSONObject, String paramString, int paramInt2, boolean paramBoolean)
  {
    ...
    if (j < n)
    {
      ...
      localObject = paramavsq.a(paramString, str1);
      if (localObject == null) {
        if (paramInt1 != areb.d)
        {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        k = i;
        break;
        paramavsq.b(localArrayList);
        if (paramEmoticonPackage.newSoundEp) {
          paramavsq.a(paramEmoticonPackage);
        }
        if (i == 0) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramarfb.a = paramBoolean;
          return null;
        }
      }
    }
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, avsq paramavsq, JSONObject paramJSONObject, String paramString, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramEmoticonPackage.copywritingType != avsp.a)
    {
    ...
    paramavsq = paramavsq.b(paramString);
    if (paramavsq != null)
    {
      paramEmoticonPackage.status = paramavsq.status;
      paramEmoticonPackage.valid = paramavsq.valid;
    }
    ...
    if (paramavsq != null)
    {
      paramEmoticonPackage.wordingId = paramavsq.wordingId;
      return;
    }
    paramEmoticonPackage.wordingId = -1L;
  }
  
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, avsq paramavsq, JSONArray paramJSONArray, int paramInt2, boolean paramBoolean)
  {
    int i = 0;
    Object localObject;
    String str1;
    ...
    if (i < paramInt2)
    {
      ...
      localObject = paramavsq.a(str3, str1);
      if (localObject == null)
      {
        if (paramInt1 == areb.d) {
          break label362;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramBoolean) && (j == 0)) {
          paramavsq.a((Emoticon)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt, ArrayList<Emoticon> paramArrayList, avsq paramavsq, JSONObject paramJSONObject1, long paramLong, JSONObject paramJSONObject2, JSONArray paramJSONArray1, JSONArray paramJSONArray2)
  {
    ...
    for (int i = paramJSONArray1.getInt("isOriginal");; i = 0)
    {
      ...
      for (j = paramJSONArray2.getInt("feeType");; j = 0)
      {
        ...
        for (;;)
        {
          ...
          a(paramEmoticonPackage, paramInt, paramArrayList, paramavsq, paramJSONObject1, paramJSONObject1.length(), true);
          return;
          if (j <= 0) {
            break;
          }
          paramEmoticonPackage.extraFlags &= i;
          break;
          paramJSONObject1 = paramavsq.b(paramEmoticonPackage.epId);
