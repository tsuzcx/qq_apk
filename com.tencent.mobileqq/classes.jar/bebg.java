  ...
  implements Handler.Callback
{
  ...
  public bebg(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (this.app == null) {}
    while (((TicketManager)this.app.getManager(2)).getPskey(this.app.getCurrentAccountUin(), 16L, this.a, new bebh(this, paramRunnable)) == null) {
      return;
    }
