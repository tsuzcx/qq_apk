...
public class trb
{
  ...
  private ppm jdField_a_of_type_Ppm;
  ...
  public trb(rnu paramrnu, List<VideoInfo> paramList, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, Handler paramHandler)
  {
    ...
    ozs.a().getManager(163);
    this.jdField_a_of_type_Ppm = new trc(this);
  }
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    return Math.max(trd.h + paramInt2 + 1, paramInt1 + 1);
  }
  ...
  public static VideoInfo a(AdvertisementInfo paramAdvertisementInfo, boolean paramBoolean)
  {
    ...
    localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo = nzq.a(paramAdvertisementInfo);
    ...
    try
    {
      ...
      {
        localObject = ozs.a(paramAdvertisementInfo.mJsonVideoList, paramAdvertisementInfo);
  ...
  private void a(int paramInt, ArrayList<VideoInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        tpx.a("VIDEO_LINK", "fetchChangePosAd : 当前广告位置后面没有广告");
  ...
  private void a(VideoInfo paramVideoInfo, ArrayList<VideoInfo> paramArrayList, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Rnu != null) {
        this.jdField_a_of_type_Rnu.b(paramVideoInfo);
      }
  ...
  private void a(AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localnyp.jdField_a_of_type_Int = paramAdvertisementInfo.mAdMaterialId;
      localnyp.jdField_b_of_type_Int = 1;
      localnyp.jdField_c_of_type_Int = paramAdvertisementInfo.mAdKdPos;
      localnyp.jdField_a_of_type_Long = paramAdvertisementInfo.mAdPosID;
      pfa.a().a().a(paramInt2, this.jdField_a_of_type_Ppm);
      ThreadManager.executeOnSubThread(new VideoAdExposureManager.1(this, paramInt3, paramInt2, localnyp));
      return;
  ...
  private void a(ArrayList<VideoInfo> paramArrayList, int paramInt)
  {
    ...
    } while ((localObject == null) || (!((VideoInfo)localObject).jdField_c_of_type_Boolean) || (((VideoInfo)localObject).jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo == null) || (this.jdField_a_of_type_Rnu == null) || (!this.jdField_a_of_type_Rnu.a(((VideoInfo)localObject).jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h)));
    ...
    tpx.a("VIDEO_LINK", "fetchChangePosAd : 下一个广告存在但是已经曝光过");
    a((VideoInfo)paramArrayList.get(paramInt), paramInt);
  }
  
  private boolean a(int paramInt1, int paramInt2)
  {
    return ((paramInt1 == -1) && (paramInt2 < trd.f) && (this.g >= trd.f)) || (this.g >= trd.g);
  }
    ...
    do
    {
      do
      {
        do
        {
          return false;
          paramrrm = paramrrm.a;
        } while ((paramrrm == null) || (paramrrm.jdField_c_of_type_Boolean));
        if ((trd.jdField_a_of_type_Boolean) && (!this.jdField_a_of_type_Boolean)) {
          break;
        }
      } while (!QLog.isColorLevel());
      if (!trd.jdField_a_of_type_Boolean) {
  ...
  private void b(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_Rnu.notifyItemChanged(paramInt);
  }
  ...
  private void b(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    do
    {
      ...
      } while ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecyclerView == null) || (this.jdField_a_of_type_Rnu == null) || ((this.e >= this.jdField_a_of_type_JavaUtilList.size()) && (this.e > 0)));
      ...
      if ((localVideoInfo != null) && (!localVideoInfo.jdField_c_of_type_Boolean) && (this.e > i))
      {
        ...
        tpx.a("AdVideoDataLink", "onAsyncDataReady add at =" + this.e + ", currentAdpaterPosition=" + i);
        this.jdField_a_of_type_Rnu.notifyItemInserted(this.e);
        this.e = 0;
      }
    } while ((localVideoInfo == null) || (!localVideoInfo.jdField_c_of_type_Boolean) || (localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo == null) || (!this.jdField_a_of_type_Rnu.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h)));
    this.jdField_b_of_type_JavaUtilArrayList.remove(paramAdvertisementInfo);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == this.jdField_b_of_type_Int)
        {
          i = this.f;
          this.f = 0;
          AdvertisementInfo localAdvertisementInfo1 = pfa.a().a(paramInt, i);
  ...
  public void a()
  {
    pog localpog = pfa.a().a();
    if (localpog != null)
    {
      localpog.a(this.jdField_a_of_type_Int);
      localpog.a(this.jdField_b_of_type_Int);
    }
  }
  ...
  public void a(int paramInt, rrm paramrrm, ArrayList<VideoInfo> paramArrayList)
  {
    if (trd.a()) {}
    for (;;)
    {
      return;
      if ((paramrrm != null) && (paramrrm.a != null) && (trd.jdField_a_of_type_Boolean))
      {
        if (!paramrrm.a.jdField_c_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
            QLog.d("VideoAdExposureManager", 2, "checkAndInsert , mPlayVmCount=" + this.g);
          }
          b(paramInt, paramrrm, paramArrayList);
        }
        while (QLog.isColorLevel())
        {
  ...
  public void a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    a(nzq.a(paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo), paramInt, this.jdField_b_of_type_Int, 6);
  }
  
  /* Error */
  public void a(rol paramrol)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 393	trd:a	()Z
    //   5: istore_2
    //   6: iload_2
    //   7: ifeq +6 -> 13
    //   10: aload_0
    //   11: monitorexit
    //   12: return
    //   13: getstatic 400	trd:jdField_a_of_type_Boolean	Z
    //   16: ifeq -6 -> 10
    //   19: aload_0
    //   20: iconst_0
    //   21: putfield 401	trb:jdField_a_of_type_Boolean	Z
    //   24: aload_1
    //   25: ifnull -15 -> 10
    //   28: aload_1
    //   29: getfield 495	rol:a	Lrrm;
    //   32: ifnull -22 -> 10
    //   35: aload_1
    //   36: getfield 495	rol:a	Lrrm;
    //   39: getfield 398	rrm:a	Lcom/tencent/biz/pubaccount/VideoInfo;
    //   42: ifnull -32 -> 10
    //   45: aload_1
    //   46: getfield 495	rol:a	Lrrm;
    //   49: getfield 398	rrm:a	Lcom/tencent/biz/pubaccount/VideoInfo;
    //   52: getfield 112	com/tencent/biz/pubaccount/VideoInfo:jdField_c_of_type_Boolean	Z
    //   55: ifeq -45 -> 10
    //   58: aload_1
    //   59: getfield 495	rol:a	Lrrm;
    //   62: getfield 398	rrm:a	Lcom/tencent/biz/pubaccount/VideoInfo;
    ...
    //   71: aload_0
    //   72: aload_1
    //   73: getfield 496	rol:jdField_b_of_type_Int	I
    //   76: invokevirtual 267	trb:d	(I)V
    //   79: invokestatic 228	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   82: ifeq -72 -> 10
    //   85: ldc 230
    //   87: iconst_2
    //   88: new 232	java/lang/StringBuilder
    //   91: dup
    //   92: invokespecial 233	java/lang/StringBuilder:<init>	()V
    //   95: ldc_w 498
    //   98: invokevirtual 239	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   101: aload_1
    //   102: getfield 496	rol:jdField_b_of_type_Int	I
    //   105: invokevirtual 272	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   108: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   111: invokestatic 245	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   114: goto -104 -> 10
    //   117: astore_1
    //   118: aload_0
    //   119: monitorexit
  ...
  public void a(boolean paramBoolean, int paramInt, ArrayList<VideoInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoAdExposureManager", 2, "checkAdPos , hasQueryParam= " + trd.jdField_b_of_type_Boolean + " ,needChangeAdPos =" + trd.jdField_a_of_type_Boolean);
        }
        if (trd.jdField_b_of_type_Boolean)
        {
          boolean bool2 = trd.jdField_a_of_type_Boolean;
          if (!bool2) {
            return;
          }
        }
      ...
      if (!trd.jdField_b_of_type_Boolean)
      {
        trd.jdField_b_of_type_Boolean = true;
        paramBoolean = bool1;
        if (tpz.f(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo))
        {
          paramBoolean = bool1;
        ...
        trd.jdField_a_of_type_Boolean = paramBoolean;
      ...
      try
      {
        ...
        for (trd.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("strategy", 0);; trd.jdField_a_of_type_Int = 2)
        {
          trd.f = ((JSONObject)localObject).optInt("ad_first_pos", 3);
          trd.g = ((JSONObject)localObject).optInt("ad_interval_pos", 3);
          trd.h = ((JSONObject)localObject).optInt("ad_protect_interval", 2);
          trd.jdField_b_of_type_Int = ((JSONObject)localObject).optInt("ad_first_time", 10);
          trd.jdField_c_of_type_Int = ((JSONObject)localObject).optInt("ad_interval_time", 25);
          trd.jdField_d_of_type_Int = ((JSONObject)localObject).optInt("ad_pre_req", 2);
          trd.e = ((JSONObject)localObject).optInt("ad_protect_gap", 2);
          tpx.a("VideoAdStrategy", "setAdStrategyFromServer: strategy = " + trd.jdField_a_of_type_Int + " adFirstTime = " + trd.jdField_b_of_type_Int + " adIntervalTime = " + trd.jdField_c_of_type_Int + " adPreReq = " + trd.jdField_d_of_type_Int + " adProtectGap = " + trd.e + " adFirstPos = " + trd.f + " adIntervalPos = " + trd.g + " adProtectInterval = " + trd.h);
          trd.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true);
          if (trd.jdField_a_of_type_Int == 1)
          {
            localObject = tre.a(paramArrayList);
            if (localObject != null) {
              paramArrayList.removeAll((Collection)localObject);
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("VideoAdExposureManager", 2, "checkAdPos needChangeAdPos = " + trd.jdField_a_of_type_Boolean);
          }
          if ((trd.a()) || (!trd.jdField_a_of_type_Boolean)) {
            break;
          }
      ...
      catch (JSONException localJSONException)
      {
        for (;;)
        {
          ...
          trd.jdField_a_of_type_Boolean = false;
        }
  ...
  public void b(int paramInt, rrm paramrrm, ArrayList<VideoInfo> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
  ...
  public void d(int paramInt)
  {
    ...
    //   12: return
    //   13: aload_0
    //   14: getfield 57	trb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   17: iload_1
    //   18: invokestatic 652	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   21: invokevirtual 655	java/util/ArrayList:contains	(Ljava/lang/Object;)Z
    //   24: ifne -14 -> 10
    //   27: invokestatic 228	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   30: ifeq +29 -> 59
    //   33: ldc 230
    //   35: iconst_2
    //   36: new 232	java/lang/StringBuilder
    //   39: dup
    //   40: invokespecial 233	java/lang/StringBuilder:<init>	()V
    //   43: ldc_w 657
    //   46: invokevirtual 239	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   49: iload_1
    //   50: invokevirtual 272	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   53: invokevirtual 242	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   56: invokestatic 245	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   59: aload_0
    //   60: getfield 57	trb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   63: iload_1
    //   64: invokestatic 652	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   67: invokevirtual 422	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   70: pop
    //   71: goto -61 -> 10
    //   74: astore_3
    //   75: aload_0
