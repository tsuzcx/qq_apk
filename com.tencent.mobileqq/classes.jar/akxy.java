  ...
  implements Animatable
{
  ...
  public akxy(int paramInt1, int[] paramArrayOfInt, ImageView paramImageView, int paramInt2)
  {
  ...
  public akxy(int[] paramArrayOfInt, ImageView paramImageView, int paramInt)
  {
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new akxz(this);
    this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new akya(this);
  }
