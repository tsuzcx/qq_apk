...
public class acgs
{
  ...
  public acgs()
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new acgt(this);
    this.jdField_a_of_type_MqqAppAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    this.c = false;
  }
  
  public acgs(Activity paramActivity)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new acgt(this);
  ...
  public acgs(Activity paramActivity, acgu paramacgu)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new acgt(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Acgu = paramacgu;
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AppActivity))
    {
      this.jdField_a_of_type_MqqAppAppRuntime = ((AppActivity)this.jdField_a_of_type_AndroidAppActivity).getAppRuntime();
      this.c = true;
  ...
  public static String a(Resources paramResources, LightAppSettingInfo paramLightAppSettingInfo, String paramString)
  {
    ...
    {
      str = paramResources.getString(2131691380);
    }
    if ((!TextUtils.isEmpty(paramLightAppSettingInfo.b)) && (!TextUtils.isEmpty(paramLightAppSettingInfo.jdField_a_of_type_JavaLangString)) && (bjva.a(paramLightAppSettingInfo.b))) {
      return paramResources.getString(2131691382, new Object[] { str });
    }
    return paramResources.getString(2131691381, new Object[] { str });
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    {
      bjva.a(paramActivity, paramString1);
      return;
    }
    ...
    bjqz.b(paramActivity, localBundle);
  }
  ...
  private void d()
  {
    ...
    {
      ache.a((String)localObject, localBundle, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqObserverBusinessObserver);
      return;
    }
  }
  ...
  public LightAppSettingInfo a(DeviceInfo paramDeviceInfo)
  {
    ...
    if (localLightAppSettingInfo2 == null)
    {
      ...
      if (!this.c)
      {
        ...
        {
          a(((abur)((QQAppInterface)localAppRuntime).a(51)).a());
  ...
  public void a()
  {
    ...
    {
      localObject1 = ((abur)((QQAppInterface)localObject1).a(51)).a();
  ...
  public void a(DeviceInfo paramDeviceInfo, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    {
      if (this.jdField_a_of_type_Acgu != null) {
        this.jdField_a_of_type_Acgu.a(false);
      }
      return;
    }
    if (paramBundle != null) {}
    for (boolean bool = paramBundle.getBoolean("showProgress", true);; bool = true)
    {
      ...
      for (;;)
      {
        if ((str == null) && (0 == 0))
        {
          ...
          achd.a(null, "Net_LiteApp_Setting", 0, 1, localLightAppSettingInfo.jdField_c_of_type_Int);
          if (str != null) {
            break label713;
          }
          ...
          this.jdField_a_of_type_Acgu.a(true);
          return;
        ...
        for (Intent localIntent = new Intent();; localIntent = null)
        {
          ...
          for (;;)
          {
            ...
            break;
            localIntent.putExtra("uinname", ache.a(paramDeviceInfo));
          }
          label713:
          ...
          bnrt.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), paramDeviceInfo, str, -1, null, SmartDevicePluginProxyActivity.class);
          break label247;
          label794:
          break;
          ...
          bjuh.a().a(2131691385);
          if ((this.jdField_a_of_type_Bjbs != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bjbs.c(2131691384);
      this.jdField_a_of_type_Bjbs.show();
    }
    while (this.jdField_a_of_type_MqqAppAppRuntime == null)
    {
      bjtx.d("LightAppUtil", "app == null when dologin");
      if (this.jdField_a_of_type_Acgu != null) {
        this.jdField_a_of_type_Acgu.a(false);
      }
      return;
