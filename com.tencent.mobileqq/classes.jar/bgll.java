...
public class bgll
{
  ...
  private void a(oidb_0xea3.RspBody paramRspBody)
  {
    ...
    bgkq localbgkq = (bgkq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(171);
    if (localbgkq == null) {
      return;
    }
    ...
    localbgkq.notifyUI(4, true, new Object[] { Long.valueOf(this.jdField_a_of_type_Long), this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilList });
    b();
  }
  ...
  public void a()
  {
    ...
    localObject = localbgkq.makeOIDBPkg("OidbSvcTcp.0xea3", 3747, 1, ((oidb_0xea3.ReqBody)localObject).toByteArray(), 30000L);
    ((ToServiceMsg)localObject).extraData.putLong("sendSeq", this.jdField_b_of_type_Long);
    localbgkq.sendPbReq((ToServiceMsg)localObject);
  }
  
  public boolean a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((bgkq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(171) == null) {
      return true;
    }
    oidb_0xea3.RspBody localRspBody = new oidb_0xea3.RspBody();
    int i = bgkq.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
    boolean bool;
    if (i == 0)
    {
