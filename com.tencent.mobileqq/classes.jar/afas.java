...
public class afas
  extends ayri
{
  public afas(TextPreviewTranslateActivity paramTextPreviewTranslateActivity) {}
  ...
  public void a(boolean paramBoolean, int paramInt, TranslateResult paramTranslateResult)
  {
    ...
    String str2 = this.a.getResources().getString(2131698707);
    String str1 = str2;
    ...
    for (;;)
    {
      ...
      if (paramTranslateResult.a()) {
        str1 = this.a.getResources().getString(2131698694);
      }
    }
  }
}
