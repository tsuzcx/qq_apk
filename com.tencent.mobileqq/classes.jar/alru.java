  ...
  extends ambr
{
  ...
  public alru(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562867, paramViewGroup, false);
      localalrv = new alrv(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
      paramView.setTag(localalrv);
      localalrv.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376678));
      localalrv.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379723));
      localalrv.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131364466));
      localalrv.c = ((ImageView)paramView.findViewById(2131368138));
      localalrv.b = ((TextView)paramView.findViewById(2131371539));
    }
    for (;;)
    {
      localalrv = (alrv)paramView.getTag();
      Object localObject;
      if (i < 0)
      {
        i = -(i + 1) - 1;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(((Friends)localObject).uin))
        {
          localalrv.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
          localalrv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          localalrv.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          localalrv.c.setImageBitmap(a(((Friends)localObject).uin));
          localalrv.b.setText(((Friends)localObject).getFriendNick());
          localalrv.jdField_a_of_type_JavaLangString = ((Friends)localObject).uin;
          if ((this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b.contains(((Friends)localObject).uin))) {
            break label404;
          }
          localalrv.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          label309:
          if ((AppSetting.c) && (localalrv.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            if (!localalrv.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
              break label416;
            }
            paramView.setContentDescription(((Friends)localObject).getFriendNick() + anni.a(2131703661));
          }
          label368:
      ...
      for (;;)
      {
        ...
        return paramView;
        localalrv.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        break;
        label404:
        localalrv.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
        break label309;
        label416:
        paramView.setContentDescription(((Friends)localObject).getFriendNick() + anni.a(2131703664));
        break label368;
        localalrv.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        localalrv.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject = String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[i]);
        localalrv.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        localalrv.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131691635), new Object[] { ((String)localObject).toLowerCase() }));
      }
    }
  }
}
