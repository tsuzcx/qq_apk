  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Ajxv != null) {
        this.a.jdField_a_of_type_Ajxv.a(8);
      }
      ...
      if (akgc.a(ahcp.jdField_a_of_type_Long, l))
      {
        ...
        {
          ((ajul)localObject2).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, 8);
        ...
        else
        {
          if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType == 1)
          {
            ...
            {
              ((ajul)localObject2).b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, 8);
              if (!QLog.isColorLevel()) {
                continue;
              }
          ...
          if ((localObject3 != null) && ((((ajuk)localObject3).jdField_a_of_type_Boolean) || (((ajuk)localObject3).b) || (((ajuk)localObject3).c) || (((ajuk)localObject3).jdField_a_of_type_Long < l)))
          {
            ...
            ((Bundle)localObject4).putString("feedsid", akgt.a(localMessageForQQWalletMsg));
            ((ajul)localObject2).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (ajuk)localObject3, l, 131072, (String)localObject1, localMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.skinId, localMessageForQQWalletMsg.fromHBList, (Bundle)localObject4);
            if (QLog.isColorLevel()) {
          ...
          else
          {
            ...
            adxr.a(paramView.getContext(), (Intent)localObject2, PublicTransFragmentActivity.class, RedPacketKSongFragment.class);
            if (QLog.isColorLevel()) {
