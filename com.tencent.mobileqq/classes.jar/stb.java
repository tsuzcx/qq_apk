  ...
  implements Handler.Callback, AdapterView.OnItemClickListener
{
  ...
  public stb(Activity paramActivity)
  {
    ...
    this.jdField_b_of_type_Int = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299011);
  ...
  private void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        a(this.jdField_a_of_type_Aasb, this.jdField_a_of_type_Boolean, paramBoolean);
        return;
      }
    }
  ...
  {
    paramString = sta.a(paramString, this.jdField_d_of_type_Int, this.jdField_c_of_type_JavaLangString, "QRCode_");
  ...
  public bjbs a()
  {
    ...
    {
      this.jdField_a_of_type_Bjbs = new bjbs(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int);
  ...
  public String a()
  {
    String str2 = BaseApplicationImpl.getApplication().getString(2131718123);
    String str1 = str2;
    try
    {
  ...
  protected void a(aasb paramaasb, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (!paramBoolean1)
    {
      paramaasb.d(new stc(this, paramBoolean2));
      return;
    }
    if (paramBoolean2) {}
    for (int i = 3;; i = 2)
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695738);
    ...
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695751);
    ...
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695758);
    localActionSheetItem.icon = 2130839095;
    localActionSheetItem.action = 9;
    localActionSheetItem.argus = "";
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695741);
    localActionSheetItem.icon = 2130839089;
    localActionSheetItem.action = 10;
    localActionSheetItem.argus = "";
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = BaseApplicationImpl.getContext().getString(2131695755);
    localActionSheetItem.icon = 2130839094;
  ...
  public void b()
  {
    ...
    if ((tzq.b(this.jdField_c_of_type_JavaLangString)) && (!TextUtils.isEmpty(a()))) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        return;
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getContext().getString(2131718159));
      }
      catch (Exception localException)
      {
        for (;;)
  ...
  public void c()
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      localbmtk.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getRuntime().getAccount();
      bmtd.a(this.jdField_a_of_type_AndroidAppActivity, localbmtk, this.jdField_a_of_type_JavaLangString, BaseApplicationImpl.getContext().getString(2131719349), "", -1);
      return;
    }
  ...
  public void d(String paramString)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
    {
      ...
      str = BaseApplicationImpl.getContext().getResources().getString(2131694680);
      label115:
    ...
    for (paramString = paramString.concat("|1");; paramString = paramString.concat("|0"))
    {
      ...
      localIntent.putExtra("brief_key", anzj.a(2131712461));
  ...
  public void g()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = BaseApplicationImpl.getContext().getResources().getString(2131694680);
      ...
      catch (PackageManager.NameNotFoundException localNameNotFoundException)
      {
        ...
        this.jdField_a_of_type_Bjbs.dismiss();
        QQToast.a(BaseApplicationImpl.getContext(), 0, 2131694686, 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299011));
        continue;
      }
      if (QLog.isColorLevel()) {
