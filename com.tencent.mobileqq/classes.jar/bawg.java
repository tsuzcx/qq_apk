  ...
  extends baqn
{
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramDownloadParams = bjhx.a(BaseApplication.getContext(), paramOutputStream);
    if (QLog.isColorLevel())
    {
      QLog.i("Q.qzonecover.", 2, "downloadImage|path = " + paramDownloadParams);
      if (!bdhb.b(paramDownloadParams)) {
        break label198;
      }
    ...
    if ((paramURLDrawableHandler.exists()) || ((paramOutputStream.startsWith("http://")) && (beag.a(new beae(paramOutputStream, paramURLDrawableHandler), null) == 0) && (paramURLDrawableHandler.exists()))) {
