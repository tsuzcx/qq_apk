...
public class ahql
{
  public static void a(absi paramabsi, MessageRecord paramMessageRecord, QQMessageFacade paramQQMessageFacade, QQAppInterface paramQQAppInterface)
  {
    if ((paramabsi == null) || (paramMessageRecord == null) || (paramQQMessageFacade == null) || (paramQQAppInterface == null)) {}
    Object localObject;
    int k;
    int i;
    do
    {
      ...
      k = bafj.a().b(paramQQAppInterface);
      if (k <= 0) {
        break;
      }
      int j = 0;
    ...
    try
    {
      paramabsi.a((QQMessageFacade.Message)localObject);
      paramQQMessageFacade.a().unReadNum = k;
      return;
    }
    catch (Throwable paramabsi)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopSuspiciousHelper", 2, "add GroupSuspiciousMsg ERROR", paramabsi);
        }
      }
    }
  ...
  public static void a(amlp paramamlp, QQAppInterface paramQQAppInterface, structmsg.RspNextSystemMsg paramRspNextSystemMsg, String paramString)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        localMessageRecord.frienduin = alof.O;
    ...
    localObject = (auga)paramQQAppInterface.getManager(37);
    boolean bool;
    if (localArrayList.size() > 0)
    {
      if ((localArrayList.size() < 20) && (localObject != null)) {
        ((auga)localObject).b(true);
      }
      ...
      if ((alww.a(localArrayList)) && (paramQQAppInterface.isBackground_Stop))
      {
        bool = true;
    ...
    for (;;)
    {
      paramamlp.a(4019, true, localArrayList);
      return;
      bool = false;
      break;
      if (localObject != null) {
  ...
  public static void a(amlp paramamlp, QQAppInterface paramQQAppInterface, structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt, String paramString)
  {
    ...
    bafj.a().b(paramQQAppInterface, paramInt);
    paramRspSystemMsgNew = new ArrayList();
    int i = paramList.size();
    Object localObject = (auga)paramQQAppInterface.getManager(37);
    if (localObject != null) {
      ((auga)localObject).b(false);
    }
    Collections.sort(paramList, new ahqm());
    paramInt = 0;
    if (paramInt < i)
    {
      localObject = azaf.a(-2018);
      ((MessageRecord)localObject).msgtype = -2018;
      ((MessageRecord)localObject).selfuin = paramString;
      ((MessageRecord)localObject).frienduin = alof.O;
    ...
    paramQQAppInterface.a().a(alof.O, 0);
    if (paramRspSystemMsgNew.size() > 0)
    {
      paramList = paramQQAppInterface.a();
      paramString = String.valueOf(paramString);
      if ((!alww.a(paramRspSystemMsgNew)) || (!paramQQAppInterface.isBackground_Stop)) {
        break label568;
      }
    }
    label568:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramamlp.a(4019, true, paramRspSystemMsgNew);
      return;
    }
  }
  ...
  public static void a(structmsg.StructMsg paramStructMsg, String paramString)
  {
    ...
    {
      bdes.a("Grp_contacts_news", "notice", paramString, 0, 0, new String[] { str1, str2, paramStructMsg });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = paramQQAppInterface.a().b(alof.O, 0);
