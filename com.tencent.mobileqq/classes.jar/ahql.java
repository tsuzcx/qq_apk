  ...
  implements Cloneable
{
  ...
  public ahql(Context paramContext, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaLangString = paramContext.getString(2131720273);
    if (paramBoolean) {
      this.jdField_a_of_type_JavaLangString = paramContext.getString(2131720274);
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    if (QLog.isColorLevel()) {
      QLog.d(ahql.class.getSimpleName(), 2, "deSerialize");
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(ahql.class.getSimpleName(), 2, "serialize");
    }
    return b();
  }
