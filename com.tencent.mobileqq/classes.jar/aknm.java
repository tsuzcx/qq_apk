...
public class aknm
{
  public static int a(String paramString)
  {
    try
    {
      int i = akno.a("arfeature", "v8.0.0", akno.b("arfeature", "v8.0.0", "arfeature"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        akno.a("arfeature", "v8.0.0", "arfeature", paramString2);
        try
        {
          aknk.a(paramString1, akno.a("arfeature", "v8.0.0", akno.b("arfeature", "v8.0.0", "arfeature")));
          paramString2 = akno.a("arfeature", "v8.0.0", akno.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bace.a(akno.a("arfeature", "v8.0.0", akno.b("arfeature", "v8.0.0", "arfeature")), false);
      ...
      try
      {
        ...
        {
          paramString1 = akno.a("arfeature", "v8.0.0", akno.b("arfeature", "v8.0.0", "arfeature")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          akno.a("arfeature", "v8.0.0", "libARFeature", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(akno.a("arfeature", "v8.0.0", akno.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "libARFeature" + ".so").exists();
  }
}
