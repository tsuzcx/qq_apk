...
public class mcy
{
  ...
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380306) != null)
    {
    ...
    int k = arrayOfInt2[1];
    float f2 = AIOUtils.dp2px(0, this.jdField_a_of_type_AndroidViewView.getResources()) + (k - j);
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        ...
        if (!mum.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface)) {
          return false;
        }
      }
  ...
  private void b(TextView paramTextView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetPopupWindow.setAnimationStyle(2131755818);
    paramTextView.measure(0, 0);
    ...
    int m = AIOUtils.dp2px(0, this.jdField_a_of_type_AndroidViewView.getResources());
  ...
  private void d()
  {
    ...
    {
      TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380306);
  ...
  private void e()
  {
    ...
    do
    {
      ...
      localTextView = null;
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380306);
      }
    ...
    float f1 = i - m - this.jdField_a_of_type_AndroidViewView.getWidth() / 2 - k / 2 - i1 + AIOUtils.dp2px(0.0F, this.jdField_a_of_type_AndroidViewView.getResources());
    float f2 = j - n - i2 - AIOUtils.dp2px(11.0F, this.jdField_a_of_type_AndroidViewView.getResources());
    ...
    localTextView.getViewTreeObserver().addOnPreDrawListener(new mcz(this, localTextView));
    d();
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
      b(localTextView);
    }
    for (;;)
    {
      localTextView.setOnClickListener(new mda(this));
      return;
      a(localTextView);
    }
  }
  ...
  public void a()
  {
    ...
    mum.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    d();
  }
