...
public class uiz
  implements Runnable
{
  public uiz(PlusPanel paramPlusPanel, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString) {}
  ...
  public void run()
  {
    ...
    Object localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityAioPanelAdapter.a(2130838004);
    ...
    if (localObject3 != null)
    {
      ...
      localTextView.setBackgroundResource(2130838059);
      localTextView.setTextColor(-1);
      localTextView.setTextSize(2, 16.0F);
      localTextView.setText(ApolloConstant.ah);
      localTextView.setSingleLine();
      localTextView.setGravity(17);
      i = (int)localTextView.getPaint().measureText(ApolloConstant.ah);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        localImageView.setBackgroundResource(2130838058);
      ...
      for (i = 1;; i = 0)
      {
        ...
        break label370;
        label726:
        localImageView.setBackgroundResource(2130838057);
