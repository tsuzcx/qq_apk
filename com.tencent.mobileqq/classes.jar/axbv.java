  ...
  implements bicx, Manager
{
  ...
  private HashMap<Long, axbx> jdField_a_of_type_JavaUtilHashMap;
  ...
  public axbv(QQAppInterface paramQQAppInterface)
  {
    ...
    d();
    a();
    this.jdField_a_of_type_Aqro = new aqro(paramQQAppInterface);
        ...
        if ((localObject != null) && (localObject.length > 0))
        {
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              if (l > 0L)
              {
                axbx localaxbx = new axbx(this);
                localaxbx.jdField_a_of_type_Long = this.jdField_a_of_type_AndroidContentSharedPreferences.getLong("gc_unread" + str1 + "_" + str2, 0L);
                localaxbx.jdField_a_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_newmsg" + str1 + "_" + str2, false);
                localaxbx.jdField_b_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_redpoint" + str1 + "_" + str2, false);
                localaxbx.c = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_tab" + str1 + "_" + str2, false);
                localaxbx.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_text" + str1 + "_" + str2, "");
                localaxbx.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_icon" + str1 + "_" + str2, "");
                localaxbx.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("gc_type" + str1 + "_" + str2, -1);
                this.jdField_a_of_type_JavaUtilArrayList.add(Long.valueOf(l));
                this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localaxbx);
              }
            }
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilHashMap != null))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(l)))
        {
          ...
          {
            axbx localaxbx = (axbx)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
            localEditor.putLong("gc_unread" + str2 + "_" + l, localaxbx.jdField_a_of_type_Long);
            localEditor.putBoolean("gc_newmsg" + str2 + "_" + l, localaxbx.jdField_a_of_type_Boolean);
            localEditor.putBoolean("gc_redpoint" + str2 + "_" + l, localaxbx.jdField_b_of_type_Boolean);
            localEditor.putBoolean("gc_tab" + str2 + "_" + l, localaxbx.c);
            localEditor.putString("gc_text" + str2 + "_" + l, localaxbx.jdField_a_of_type_JavaLangString);
            localEditor.putString("gc_icon" + str2 + "_" + l, localaxbx.jdField_b_of_type_JavaLangString);
            localEditor.putInt("gc_type" + str2 + "_" + l, localaxbx.jdField_a_of_type_Int);
            break;
          }
        }
      }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if ((localBoolean == null) || (!localBoolean.booleanValue()))
      {
        ...
        jdField_a_of_type_ArrayOfByte = bbdx.a((File)localObject2);
  ...
  public void a(long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    {
      localObject = (axbx)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong1));
      ((axbx)localObject).jdField_a_of_type_Boolean = paramBoolean;
      ((axbx)localObject).jdField_a_of_type_Long = paramLong2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong1), localObject);
      e();
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), axby.class);
  ...
  public void a(JSONArray paramJSONArray)
  {
    for (;;)
    {
      ...
      try
      {
        arrayOfString = yoa.a("APPOINTMENT_HAS_DOWNLOAD_LIST").split("\\|");
        i = 0;
        ...
        yoa.a("APPID_PKGNAME_" + str1, str2);
        if (!localJSONObject.optBoolean("isRes")) {
          break label287;
        }
        yoa.c(str1, "APPOINTMENT_RES_LIST");
        yoa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
      }
      ...
      if (j < arrayOfString.length)
      {
        ...
        if ((!TextUtils.isEmpty(arrayOfString[j])) && (!TextUtils.isEmpty(str1)) && (arrayOfString[j].equals(str1)))
        {
          ...
          {
            yoa.c(str1, "APPOINTMENT_LIST");
            yoa.a(str1, paramJSONArray.get(i).toString(), "APPOINT_APPID_DETAIL_");
            yoa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
          }
        }
        else
  ...
  public void a(MsgBody paramMsgBody)
  {
    ...
    do
    {
      ...
      case 1: 
        c();
        yoa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "205581", "", "42601", "1", "116");
        return;
      case 2: 
        try
        {
      ...
      try
      {
        ...
        paramMsgBody = new axbw(this, i);
        if (i == 1)
        {
          yoo.a().a(paramMsgBody);
          return;
        }
      }
      catch (JSONException paramMsgBody)
      ...
      if (i == 2)
      {
        yoo.a().b(paramMsgBody);
        return;
      }
    } while (i != 3);
    yoo.a().c(paramMsgBody);
  }
  
  public boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramLong))) {
      return ((axbx)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Boolean;
    }
    return false;
  }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (m < paramList.size())
      {
        ...
        do
        {
          ...
          localaxbx = (axbx)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localPluginInfo.Id));
          if (QLog.isColorLevel()) {
            QLog.d("Q.lebatab.GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",before unreaddata:" + localaxbx.toString());
          }
          if (localPluginInfo.Count > 0L)
          {
            j = i;
            if (localaxbx.jdField_a_of_type_Long != localPluginInfo.Count)
            {
              bool2 = true;
              bool1 = bool2;
              j = i;
            ...
            localaxbx.jdField_a_of_type_Long = localPluginInfo.Count;
            localaxbx.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
            localaxbx.jdField_a_of_type_Boolean = false;
            localaxbx.jdField_b_of_type_Boolean = false;
            if (TextUtils.isEmpty(localaxbx.jdField_a_of_type_JavaLangString))
            {
              localaxbx.jdField_a_of_type_Int = 1;
              localaxbx.c = localPluginInfo.Tab;
              bool2 = bool1;
            }
          }
          do
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("Q.lebatab.GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",unreaddata:" + localaxbx.toString());
              k = j;
              bool3 = bool2;
            }
            bool1 = bool3;
            i = k;
            break;
            localaxbx.jdField_a_of_type_Int = 4;
            break label296;
            if (localPluginInfo.Flag)
            {
              if (localaxbx.jdField_a_of_type_Long > 0L) {
                break;
              }
              j = i;
              if (!localaxbx.jdField_a_of_type_Boolean)
              {
                bool2 = true;
                bool1 = bool2;
                j = i;
              ...
              localaxbx.jdField_a_of_type_Boolean = localPluginInfo.Flag;
              localaxbx.jdField_b_of_type_Boolean = false;
              localaxbx.jdField_a_of_type_Long = 0L;
              localaxbx.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
              if (TextUtils.isEmpty(localaxbx.jdField_a_of_type_JavaLangString)) {}
              for (localaxbx.jdField_a_of_type_Int = 3;; localaxbx.jdField_a_of_type_Int = 6)
              {
                localaxbx.c = localPluginInfo.Tab;
                bool2 = bool1;
                break;
        ...
        } while ((localaxbx.jdField_a_of_type_Long > 0L) || ((localPluginInfo.Id == 769L) && (localaxbx.jdField_a_of_type_Boolean)));
        j = i;
        if (!localaxbx.jdField_b_of_type_Boolean)
        {
          bool2 = true;
          bool1 = bool2;
          j = i;
        ...
        localaxbx.jdField_b_of_type_Boolean = localPluginInfo.RedPoint;
        localaxbx.jdField_a_of_type_Boolean = false;
        localaxbx.jdField_a_of_type_Long = 0L;
        localaxbx.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
        localaxbx.jdField_b_of_type_JavaLangString = localPluginInfo.PicUrl;
        if (TextUtils.isEmpty(localaxbx.jdField_a_of_type_JavaLangString)) {
          if (TextUtils.isEmpty(localaxbx.jdField_b_of_type_JavaLangString)) {
            localaxbx.jdField_a_of_type_Int = 2;
          }
        }
        for (;;)
        {
          ...
          bool2 = bool1;
          break;
          localaxbx.jdField_a_of_type_Int = 7;
          continue;
          localaxbx.jdField_a_of_type_Int = 5;
        }
      }
      e();
      if (QLog.isColorLevel()) {
      ...
      if (i != -1)
      {
        paramList = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), axby.class);
  ...
  {
    bicy.a().a();
    yoa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", "", "42601", "1", "116");
  }
  ...
  public void onCmdRsp(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    while ((!"12942".equals(paramString)) || (paramLong != 0L) || (paramJSONObject == null)) {
      try
      {
        ...
        yoa.a("APPOINTMENT_LOAD_GAP", paramLong);
        yoa.a(paramJSONObject.optLong("res_valid") * 1000L);
        if (QLog.isColorLevel()) {
        ...
        if ((!TextUtils.isEmpty(yoa.a("APPOINTMENT_LIST"))) || (!TextUtils.isEmpty(yoa.a("APPOINTMENT_CHECKLIST"))) || (!TextUtils.isEmpty(yoa.a("DELAY_LIST"))) || (!TextUtils.isEmpty(yoa.a("APPOINTMENT_RES_LIST")))) {
          ynw.a();
        }
        GameCenterCheck.b();
        GameCenterCheck.c();
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < paramIntent.length())
        {
          ...
          if (!yoa.e(paramJSONObject.optString("appid"), paramJSONObject.optString("resName")))
          {
            yoa.a(paramJSONObject.toString(), false, 1);
