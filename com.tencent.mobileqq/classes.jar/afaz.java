...
public class afaz
  implements Manager
{
  private final TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new afba(this, Looper.getMainLooper());
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private final ArrayList<afbc> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static afaz a(QQAppInterface paramQQAppInterface)
  {
    return (afaz)paramQQAppInterface.getManager(23);
  }
  ...
  void a(Message paramMessage)
  {
    for (;;)
    {
      ...
      {
        Object localObject2 = (afbc)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localObject2 != null)
        {
          Object localObject1 = ((afbc)localObject2).a();
          localObject2 = ((afbc)localObject2).a();
          if ((localObject1 != null) && (localObject2 != null))
          {
            ((afbb)localObject2).a((View)localObject1, (FileMsg)paramMessage.obj, paramMessage.what, paramMessage.arg1);
            break label208;
          }
  ...
  /* Error */
  public void a(View paramView, afbb paramafbb)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 35	afaz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   6: invokevirtual 222	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   9: astore_3
    //   10: aload_3
    //   11: invokeinterface 227 1 0
    //   16: ifeq +39 -> 55
    //   19: aload_3
    //   20: invokeinterface 230 1 0
    //   25: checkcast 193	afbc
    //   28: astore 4
    //   30: aload 4
    //   32: invokevirtual 196	afbc:a	()Landroid/view/View;
    //   35: aload_1
    //   36: if_acmpne -26 -> 10
    //   39: aload 4
    ...
    //   49: putfield 233	afbc:b	Ljava/lang/ref/WeakReference;
    //   52: aload_0
    //   53: monitorexit
    //   54: return
    //   55: aload_0
    //   56: getfield 35	afaz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   59: new 193	afbc
    //   62: dup
    //   63: aload_0
    //   64: aload_1
    //   65: aload_2
    //   66: invokespecial 236	afbc:<init>	(Lafaz;Landroid/view/View;Lafbb;)V
    //   69: invokevirtual 240	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   72: pop
    //   73: goto -21 -> 52
    //   76: astore_1
    //   77: aload_0
    ...
    //   0	81	2	paramafbb	afbb
    //   9	11	3	localIterator	java.util.Iterator
    //   28	12	4	localafbc	afbc
    // Exception table:
    //   from	to	target	type
    //   2	10	76	finally
    //   10	52	76	finally
