  ...
  extends apay
{
  ...
  public apaz(QQAppInterface paramQQAppInterface, apbc paramapbc)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localanyw.b((String)localObject3))
          {
        ...
        else if (bhnp.a(MessageRecord.getTableName((String)localObject3, i), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()))
        {
          localArrayList.add(localFTSEntity);
  ...
  private void a(FTSMessage paramFTSMessage, int paramInt)
  {
    try
    {
      ...
      if ((paramFTSMessage.istroop == 0) && (!((anyw)localObject1).b(paramFTSMessage.senderuin)) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramFTSMessage.senderuin)) && (!bhnp.a((String)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a())))
      {
        ...
        bdmc.a(BaseApplicationImpl.getContext()).a(null, "actStrangerFtsMsg", true, 0L, 0L, (HashMap)localObject1, "");
      }
      return;
    }
      ...
      synchronized (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList)
      {
        ...
        if (!localThrowable.isEmpty())
        {
          ...
          if ((QLog.isColorLevel()) || (paramLong > 60000L))
          {
            ...
            bdmc.a(BaseApplication.getContext()).a(null, "actFTSMsgCost", true, paramLong, 0L, (HashMap)localObject3, null, false);
  ...
  public int a()
  {
    ...
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager().query(FTSMessageSync.class, "msg_sync_log", false, "_id>?", new String[] { String.valueOf(this.jdField_a_of_type_Int) }, null, null, null, null);
    if (localList != null) {
      i = localList.size();
    }
    return i;
  ...
  public ArrayList<FTSEntity> a(long paramLong, Pair<CharSequence, CharSequence> paramPair)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      localObject = apax.a(FTSMessage.class, String.valueOf(paramLong));
      localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a((azop)localObject);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = bhut.a(str);
        paramString = apax.a(paramString, (String[])((ArrayList)localObject1).toArray(new String[((ArrayList)localObject1).size()]), paramClass, paramBoolean1, paramBoolean2);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString = bhut.a((String)localObject);
        if (QLog.isColorLevel()) {
          QLog.i("Q.fts.FTSMsgOperator", 2, "query segments = " + Arrays.toString(paramString));
        }
        ...
        localObject = bhut.a((String)localObject);
        paramString = apax.a(paramString, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt);
  ...
  public ArrayList<FTSEntity> a(String paramString1, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString1 = bhut.a((String)localObject);
        if (QLog.isColorLevel()) {
        ...
        localObject = bhut.a((String)localObject);
        paramString1 = apax.a(paramString1, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt, paramString2);
  ...
  public void a(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    if ((paramMsgQueueItem.whereClause != null) && (!TextUtils.isEmpty(paramMsgQueueItem.whereClause)))
    {
      ...
      if ((localObject1 != null) && (bhut.a(paramMsgQueueItem.value))) {
    ...
    while (paramMsgQueueItem.hasNext())
    {
      ...
      if ((((MessageRecord)localObject1).isSupportFTS()) && (((MessageRecord)localObject1).isValid) && (((MessageRecord)localObject1).msgtype != -2006) && (!((MessageRecord)localObject1).isMultiMsg))
      {
        ...
        continue;
        if ((localObject1 != null) && (bhut.b(paramMsgQueueItem.value)))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((((MessageRecord)localObject3).isSupportFTS()) && (((MessageRecord)localObject3).isValid) && (((MessageRecord)localObject3).msgtype != -2006) && (!((MessageRecord)localObject3).isMultiMsg))
            {
              ...
              localObject3 = bhut.a(paramMsgQueueItem.value, (MessageRecord)localObject3);
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Apbf = new apba(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
  ...
  public long b(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
    {
      ...
      if (((FTSMsgCounter)localObject).mMsgCnt > 1000L)
      {
        ...
        this.jdField_a_of_type_Aznw.update((Entity)localObject);
      }
      for (;;)
      {
  ...
  public void b(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    try
    {
      ((FTSMessage)localObject).uin = mrs.a(paramMsgQueueItem.frindUin);
  ...
  {
    super.c();
    if (1 == bhut.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_a_of_type_Apbc.obtainMessage(1, this).sendToTarget();
    }
  }
  ...
  public void e()
  {
    if ((!apau.jdField_a_of_type_Boolean) && (bhut.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.fts.FTSMsgOperator", 2, "transToDatabase ENABLE = " + apau.jdField_a_of_type_Boolean + ", FTSUpgradeFlag = " + bhut.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
    }
  ...
  {
    // Byte code:
    //   0: getstatic 845	apau:jdField_a_of_type_Boolean	Z
    //   3: ifne +64 -> 67
    //   6: aload_0
    //   7: getfield 72	apaz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10: invokestatic 857	bhut:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   13: ifeq +54 -> 67
    ...
    //   38: getstatic 845	apau:jdField_a_of_type_Boolean	Z
    //   41: invokevirtual 862	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   44: ldc_w 864
    //   47: invokevirtual 141	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   50: aload_0
    //   51: getfield 72	apaz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: invokestatic 857	bhut:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   57: invokevirtual 862	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   60: invokevirtual 150	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   63: invokestatic 373	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   66: return
    //   67: aload_0
    //   68: getfield 72	apaz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 552	com/tencent/mobileqq/app/QQAppInterface:getWritableDatabase	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   74: astore 9
    //   76: aload_0
    //   77: getfield 72	apaz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   80: invokevirtual 77	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   83: invokevirtual 423	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   86: astore 7
    //   88: invokestatic 325	java/lang/System:currentTimeMillis	()J
    //   91: lstore_3
    //   92: aload 9
    //   94: ldc_w 412
    //   97: ldc_w 414
    ...
    //   105: iconst_0
    //   106: aload_0
    //   107: getfield 390	apaz:jdField_a_of_type_Int	I
    //   110: invokestatic 253	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   113: aastore
    //   114: invokevirtual 420	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   117: pop
    //   118: aload 7
    //   120: ldc_w 425
    //   123: ldc_w 412
    ...
    //   135: iconst_0
    //   136: aload_0
    //   137: getfield 390	apaz:jdField_a_of_type_Int	I
    //   140: invokestatic 253	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   143: aastore
    //   144: aconst_null
    //   145: aconst_null
    //   146: ldc_w 429
    //   149: aconst_null
    //   150: invokevirtual 435	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   153: astore 8
    //   155: aload 9
    //   157: ldc_w 489
    //   160: ldc_w 414
    ...
    //   168: iconst_0
    //   169: aload_0
    //   170: getfield 320	apaz:jdField_b_of_type_Int	I
    //   173: invokestatic 253	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   176: aastore
    //   177: invokevirtual 420	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   180: pop
    //   181: aload 7
    //   183: ldc_w 491
    //   186: ldc_w 489
    ...
    //   198: iconst_0
    //   199: aload_0
    //   200: getfield 320	apaz:jdField_b_of_type_Int	I
    //   203: invokestatic 253	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   206: aastore
    //   207: aconst_null
    //   208: aconst_null
    //   209: ldc_w 429
    //   212: aconst_null
    //   213: invokevirtual 435	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   216: astore 9
    //   218: new 513	com/tencent/mobileqq/data/fts/FTSMessageForDel
    //   221: dup
    //   222: invokespecial 531	com/tencent/mobileqq/data/fts/FTSMessageForDel:<init>	()V
    //   225: astore 10
    //   227: aload 10
    //   229: iconst_4
    //   230: putfield 521	com/tencent/mobileqq/data/fts/FTSMessageForDel:mode	I
    //   233: aload 10
    //   235: invokevirtual 528	com/tencent/mobileqq/data/fts/FTSMessageForDel:deleteOpt	()V
    //   238: aload_0
    //   239: getfield 294	apaz:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   242: ifnull +271 -> 513
    //   245: aload_0
    //   246: getfield 294	apaz:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   249: invokevirtual 298	com/tencent/mobileqq/persistence/fts/FTSDatatbase:a	()Z
    //   252: ifeq +261 -> 513
    //   255: new 88	java/util/ArrayList
    //   258: dup
    //   259: bipush 10
    //   261: invokespecial 299	java/util/ArrayList:<init>	(I)V
    //   264: astore 11
    //   266: aload 11
    //   268: aload 10
    ...
    //   276: ifnull +243 -> 519
    //   279: aload 8
    //   281: invokeinterface 443 1 0
    //   286: istore_1
    //   287: aload_0
    //   288: getfield 294	apaz:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   291: aload 11
    //   293: iconst_1
    //   294: iload_1
    //   295: invokevirtual 318	com/tencent/mobileqq/persistence/fts/FTSDatatbase:a	(Ljava/util/ArrayList;II)I
    //   298: istore_2
    //   299: aload_0
    //   300: aload_0
    //   301: getfield 390	apaz:jdField_a_of_type_Int	I
    //   304: iload_1
    //   305: iadd
    //   306: putfield 390	apaz:jdField_a_of_type_Int	I
    ...
    //   363: istore_1
    //   364: aload_0
    //   365: getfield 294	apaz:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   368: aload 11
    //   370: iconst_2
    //   371: iload_1
    //   372: invokevirtual 318	com/tencent/mobileqq/persistence/fts/FTSDatatbase:a	(Ljava/util/ArrayList;II)I
    //   375: istore_2
    //   376: aload_0
    //   377: aload_0
    //   378: getfield 320	apaz:jdField_b_of_type_Int	I
    //   381: iload_1
    //   382: iadd
    //   383: putfield 320	apaz:jdField_b_of_type_Int	I
    ...
    //   428: aload_0
    //   429: getfield 333	apaz:d	I
    //   432: i2l
    //   433: lstore 5
    //   435: aload_0
    //   436: aload_0
    //   437: getfield 294	apaz:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   440: ldc_w 400
    //   443: invokevirtual 403	com/tencent/mobileqq/persistence/fts/FTSDatatbase:b	(Ljava/lang/String;)I
    //   446: putfield 333	apaz:d	I
    ...
    //   469: dup
    //   470: iconst_1
    //   471: invokestatic 325	java/lang/System:currentTimeMillis	()J
    //   474: lload_3
    //   475: lsub
    //   476: invokestatic 273	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   479: aastore
    //   480: dup
    //   481: iconst_2
    //   482: ldc_w 354
    ...
    //   503: iconst_5
    //   504: lload 5
    //   506: invokestatic 273	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   509: aastore
    //   510: invokestatic 208	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   513: aload 7
    //   515: invokevirtual 438	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   518: return
    //   519: iconst_0
    //   520: istore_1
    //   521: goto -234 -> 287
    ...
    //   545: iconst_1
    //   546: aload 8
    //   548: invokevirtual 883	java/lang/Exception:toString	()Ljava/lang/String;
    //   551: aastore
    //   552: invokestatic 885	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   555: aload 7
    //   557: invokevirtual 438	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   560: return
    //   561: astore 8
    //   563: aload 7
    //   565: invokevirtual 438	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   568: aload 8
    //   570: athrow
