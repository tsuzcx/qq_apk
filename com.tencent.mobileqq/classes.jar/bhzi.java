...
{
  private static bhzi jdField_a_of_type_Bhzi;
  ...
  private bhzi(String paramString)
  {
    super(paramString);
  }
  ...
  public static bhzi a()
  {
    try
    {
      if (jdField_a_of_type_Bhzi == null) {
        jdField_a_of_type_Bhzi = new bhzi("VasApngIPCModule");
      }
      bhzi localbhzi = jdField_a_of_type_Bhzi;
      return localbhzi;
    }
    finally {}
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (bhto.a(str2, str1, "libAPNG_release_845.so"))
      {
  ...
  public void a(URLDrawableHandler paramURLDrawableHandler, boolean paramBoolean)
  {
    ...
    QIPCClientHelper.getInstance().callServer("VasApngIPCModule", jdField_a_of_type_JavaLangString, null, new bhzj(this, paramURLDrawableHandler));
  }
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          if (new File(str).exists())
          {
            ...
            catch (Throwable localThrowable)
            {
              ...
              bdll.b(null, "CliOper", "", "", "Font_Mall", "0X80073FE", 0, 0, "101", "", "", "");
              break label206;
            }
          }
