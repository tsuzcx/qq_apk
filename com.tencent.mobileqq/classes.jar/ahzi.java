  ...
  implements azwh, begh
{
  ...
  public ahzi(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  {
    Bitmap localBitmap = this.jdField_a_of_type_Azwg.b(paramInt1, paramString, paramInt2);
    if (localBitmap != null) {
      return localBitmap;
    }
  ...
  {
    return (paramaiac != null) && (paramaiac.a != null) && (paramaiac.a.length() > 0);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_ComTencentWidgetXListView != null))
    {
      ...
      while (paramInt1 < paramInt2)
      {
        ...
        if ((paramString != null) && ((paramString instanceof aiac)))
        {
          paramString = (aiac)paramString;
          if (a(paramString))
          {
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentWidgetXListView != null)
      {
        ...
        while (paramInt < i)
        {
          paramAbsListView = (aiac)this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(paramInt).getTag();
