...
{
  public ahzi(SearchTemplatePresenter paramSearchTemplatePresenter, NetSearchTemplateUniversalView paramNetSearchTemplateUniversalView, int paramInt, Context paramContext, boolean paramBoolean, SongInfo paramSongInfo, NetSearchTemplateUniversalItem paramNetSearchTemplateUniversalItem) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if ((QQPlayerService.a() == 2) && (SearchTemplatePresenter.a(this.jdField_a_of_type_ComTencentMobileqqSearchPresenterSearchTemplatePresenter) == SearchUtils.a))
    {
      ...
      {
        paramView.setImageResource(2130845573);
        i = 0;
      }
    }
    for (;;)
