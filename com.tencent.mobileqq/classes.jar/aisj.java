  ...
  extends BaseAdapter
{
  ...
  public aisj(Activity paramActivity, List paramList1, TroopInfo paramTroopInfo, List paramList2)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    if (paramTroopInfo != null)
    {
      this.jdField_a_of_type_JavaUtilList.add(new aisn(paramTroopInfo, Boolean.valueOf(true)));
    ...
    if (paramList1 != null)
    {
      ...
      while (paramActivity.hasNext())
      {
        ...
        if (paramList1 != null)
        {
          ...
          {
            this.jdField_a_of_type_JavaUtilList.add(new aisn(paramList1, Boolean.valueOf(bool)));
            break;
          }
        }
      }
  ...
  {
    aisn localaisn = (aisn)getItem(paramInt);
    Object localObject1;
    if (paramView != null)
    {
      localObject1 = (aism)paramView.getTag();
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(((Boolean)localaisn.b).booleanValue());
      localObject1 = paramView.jdField_a_of_type_AndroidWidgetCheckBox;
      if (((TroopInfo)localaisn.a).troopuin.equals(this.jdField_a_of_type_JavaLangString)) {
        break label458;
      }
    }
    label458:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new aisk(this, localaisn));
      paramViewGroup.setOnClickListener(new aisl(this, paramView.jdField_a_of_type_AndroidWidgetCheckBox));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(((TroopInfo)localaisn.a).troopname);
      ...
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setButtonDrawable(2130838337);
