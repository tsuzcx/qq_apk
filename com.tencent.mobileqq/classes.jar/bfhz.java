  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  bfht jdField_a_of_type_Bfht;
  bfiv jdField_a_of_type_Bfiv;
  ...
  private void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetURLThemeImageView == null) {
      this.jdField_a_of_type_ComTencentWidgetURLThemeImageView = ((URLThemeImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379164));
    }
    if (this.jdField_a_of_type_Bfht.a(this.g, this.jdField_a_of_type_ComTencentWidgetURLThemeImageView, paramString)) {
      return;
    }
    Object localObject2;
    if ((this.g != 1) && (!TextUtils.isEmpty(paramString)))
    {
      if ((!paramString.equals(this.jdField_d_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentWidgetURLThemeImageView.getVisibility() == 0))
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetURLThemeImageView.setImageDrawable(aoch.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, paramString));
        return;
      }
      ...
      {
        int i = bggq.a(this.jdField_a_of_type_AndroidContentContext, 30.0F);
      ...
      for (;;)
      {
        ...
        if ((localObject2 == null) || (!((HotChatManager)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) || (localObject1 == null) || (((anmw)localObject1).b(paramString))) {
          break;
        }
        this.jdField_a_of_type_ComTencentWidgetURLThemeImageView.setImageDrawable(aoch.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 200, paramString, true));
        label260:
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) {
          localLayoutParams.leftMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 7.0F);
        }
        label287:
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 3000) {
          break label578;
        ...
        return;
        ((LinearLayout.LayoutParams)localObject1).setMargins(bggq.a(this.jdField_a_of_type_AndroidContentContext, 2.5F), bggq.a(this.jdField_a_of_type_AndroidContentContext, 2.5F), 0, bggq.a(this.jdField_a_of_type_AndroidContentContext, 2.5F));
      }
      if (this.g == 22)
      {
        localObject1 = this.jdField_b_of_type_AndroidViewView.getTag();
        if (!(localObject1 instanceof bepx)) {
          break label580;
        }
        long l = ((bepx)localObject1).jdField_a_of_type_Long;
        ...
        if ((localObject1 != null) && (((List)localObject1).size() > 0))
        {
          ...
          label437:
          if ((localObject1 == null) || (!njo.a((MessageRecord)localObject1))) {
            break label580;
          }
          localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843602);
        }
      }
    }
    label578:
    label580:
    for (Object localObject1 = URLDrawable.getDrawable(njo.a(njo.a((MessageRecord)localObject1).b), (Drawable)localObject2, (Drawable)localObject2);; localObject1 = null)
    {
      localObject2 = localObject1;
      if (localObject1 == null) {
        localObject2 = aoch.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, paramString);
      }
      ...
      this.jdField_a_of_type_ComTencentWidgetURLThemeImageView.setImageDrawable(aoch.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, paramString));
      break label260;
      bgtn.b(this.jdField_a_of_type_ComTencentWidgetURLThemeImageView, 4);
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 3000) {
        break label287;
      }
      localLayoutParams.leftMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 14.0F);
      break label287;
      break;
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.g);
      if (paramInt != 0) {
        break label129;
      }
      this.g = -1;
    ...
    if ((this.jdField_f_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int)))
    {
      setChanged();
  ...
  private void l()
  {
    ...
    if ((this.jdField_c_of_type_AndroidViewView.getVisibility() == 8) && (this.jdField_b_of_type_AndroidViewView != null) && (this.jdField_a_of_type_AndroidViewAnimationAnimation != null))
    {
      ...
      this.jdField_a_of_type_Bfht.a(this.g, this.jdField_b_of_type_AndroidViewView.getTag(), this.jdField_b_of_type_JavaLangString);
    }
  }
  ...
  private void n()
  {
    ...
    bcst.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "qq_vip", "0X800A8FC", 0, 1, 0, "", "", "", "");
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800621C", "0X800621C", 0, 0, "", "", "", "");
    }
    if ((this.jdField_e_of_type_Boolean) && (c())) {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_work", "", "use", "Clk_owner", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
    }
    if (bfix.a(this.g))
    {
      o();
    ...
    this.jdField_a_of_type_Bfht.b(this.g, this.jdField_b_of_type_AndroidViewView.getTag(), this.jdField_b_of_type_JavaLangString);
    k();
  }
  
  private void o()
  {
    if ((bgnk.a(this.jdField_a_of_type_JavaUtilList)) || (!(this.jdField_b_of_type_AndroidViewView.getTag() instanceof bepx)))
    {
      k();
      return;
    }
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
    bepx localbepx = (bepx)this.jdField_b_of_type_AndroidViewView.getTag();
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      long l1 = ((Long)this.jdField_a_of_type_JavaUtilList.remove(0)).longValue();
      bepx.a(this.g, l1, localbepx);
      ...
      if (i > 0)
      {
        ...
        MessageRecord localMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, l2);
        l1 = l2;
        if (this.jdField_a_of_type_ComTencentWidgetURLThemeImageView != null)
        {
          l1 = l2;
      ...
      this.jdField_a_of_type_Bfht.a(this.g, localbepx, this.jdField_b_of_type_JavaLangString, i, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_a_of_type_AndroidWidgetTextView, l1);
      if ((i > 0) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int)))
      {
        if (QLog.isColorLevel()) {
          QLog.d("Navigate.TroopAioMsgNavigateBar", 2, "onClick notify");
        }
        setChanged();
        notifyObservers(localbepx);
        return;
      }
    }
    k();
  ...
  protected MessageRecord a()
  {
    ...
    if (this.jdField_a_of_type_Afwy != null)
    {
      localObject1 = localObject2;
      if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null) {
        localObject1 = (MessageRecord)this.jdField_a_of_type_Afwy.getItem(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getFirstVisiblePosition());
      }
    }
    return localObject1;
  }
  ...
  public void a(int paramInt, String paramString1, Object paramObject, String paramString2)
  {
    ...
    {
      this.jdField_c_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560552, null);
    ...
    int i = a(new int[] { 2131379329, 2131374148, 2131374235, 2131374230 });
    if (i > 0) {
      localLayoutParams.addRule(3, i);
    }
    if (this.jdField_b_of_type_AndroidViewView == null) {
      this.jdField_b_of_type_AndroidViewView = this.jdField_c_of_type_AndroidViewView.findViewById(2131379162);
    }
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379167));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379166));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379163));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(bglf.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramString2));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(paramString1);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    a(paramString2);
    this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130843819);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166226));
    this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166226));
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130850715);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_Bfht.a(paramInt, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_b_of_type_JavaLangString);
  }
  ...
  protected void a(bfhr parambfhr)
  {
    if (this.g != 102) {
      return;
    }
    this.jdField_c_of_type_Boolean = parambfhr.a();
    this.jdField_b_of_type_JavaLangString = parambfhr.a();
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramList = (bepx)this.jdField_b_of_type_AndroidViewView.getTag();
        ...
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131717749));
          return;
        }
      }
      finally {}
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131717763));
      continue;
      label214:
      ...
      if ((paramList != null) && (paramList.c == 17))
      {
        ...
        {
          ((TextView)localObject).setText(localResources.getString(2131693882, new Object[] { paramList }));
          break;
        }
      }
      if ((paramList != null) && (paramList.c == 100))
      {
        ...
        for (paramList = "99+";; paramList = Integer.valueOf(i))
        {
          ((TextView)localObject).setText(localResources.getString(2131698411, new Object[] { paramList }));
          break;
        }
        label354:
        this.jdField_f_of_type_Boolean = false;
  ...
  {
    return this.jdField_a_of_type_Bfht.a(paramInt);
  }
  ...
  public boolean b()
  {
    ...
    int i = this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    boolean bool = this.jdField_a_of_type_Bfht.a(i, this.jdField_d_of_type_Int);
  ...
  protected void c()
  {
    this.jdField_a_of_type_Bfiv = ((bfiv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(363));
    this.jdField_b_of_type_Boolean = false;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Navigate.TroopAioMsgNavigateBar", 2, "onInit: troopUin = " + this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString + ", uinType = " + this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int + ", mUnreadCount = " + this.jdField_d_of_type_Int + ", mTroopLastReadSeq:" + this.jdField_b_of_type_Long);
    }
    if (!((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1, this.jdField_b_of_type_Long, this.jdField_b_of_type_Long, "", 0, null);
    }
    ...
    this.jdField_f_of_type_Int = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297904));
    ...
    this.jdField_a_of_type_Bfht = new bfhv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
  }
  
  public boolean c()
  {
    return (bfix.a(this.g)) && (!bgnk.a(this.jdField_a_of_type_JavaUtilList));
  }
  
  protected void d()
  {
    this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 0);
    this.jdField_b_of_type_Boolean = false;
  ...
  public void e()
  {
    ...
    {
      Object localObject = (bepx)this.jdField_b_of_type_AndroidViewView.getTag();
      if (localObject != null)
      {
        long l2 = ((bepx)localObject).jdField_a_of_type_Long;
        long l1 = l2;
        if (((bepx)localObject).jdField_b_of_type_Long != 0L)
        {
          localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, ((bepx)localObject).jdField_b_of_type_Long);
          l1 = l2;
          if (localObject != null) {
        ...
        if (l1 > 0L)
        {
          ...
          localObject = (ChatMessage)this.jdField_a_of_type_Afwy.getItem(i);
  ...
  protected void g()
  {
    this.g = this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.g);
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) {
      this.jdField_a_of_type_JavaLangObject = this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
    if (c())
    {
      if (this.jdField_a_of_type_Bfiv.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) != -1L) {
        Collections.sort(this.jdField_a_of_type_JavaUtilList, new bfia(null));
      }
      if (bgnk.a(this.jdField_a_of_type_JavaUtilList)) {}
    }
    for (this.jdField_c_of_type_Long = ((Long)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilList.size() - 1)).longValue();; this.jdField_c_of_type_Long = this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      this.jdField_d_of_type_Long = this.jdField_a_of_type_Bfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_Long);
      if (QLog.isColorLevel()) {
  ...
  public void h()
  {
    ...
    if (c())
    {
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        if (??? != null)
        {
          ...
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_work", "", "use", "his_owner", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", "", l1 - l2 + "");
        }
      }
      if ((!bgnk.a(this.jdField_a_of_type_JavaUtilList)) && (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null) && (this.jdField_a_of_type_Afwy != null))
      {
        localObject2 = (ChatMessage)this.jdField_a_of_type_Afwy.getItem(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getFirstVisiblePosition());
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        l1 = bepx.a(this.g, ((ChatMessage)localObject2).shmsgseq, ((ChatMessage)localObject2).uniseq);
      ...
      continue;
      label526:
      if ((c()) && (bgnk.a(this.jdField_a_of_type_JavaUtilList))) {}
  ...
  public void i()
  {
    ...
    {
      return;
      localbfhq = this.jdField_a_of_type_Bfht.a(102);
    } while (!(localbfhq instanceof bfin));
    ((bfin)localbfhq).c();
  }
  ...
  protected void j()
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      m();
      b();
      bcst.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "qq_vip", "0X800A8FB", 0, 1, 0, "", "", "", "");
      return;
    }
    ...
    for (;;)
    {
      if ((i != 0) && (a(this.g)) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int)))
      {
        setChanged();
        notifyObservers(bepx.a(this.g, this.jdField_c_of_type_Long, this.jdField_d_of_type_Int));
        if (QLog.isColorLevel()) {
