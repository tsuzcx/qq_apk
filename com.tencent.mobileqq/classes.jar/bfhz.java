  ...
  extends Observable
{
  ...
  public bfhz(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new ArrayList());
    this.jdField_a_of_type_AndroidOsHandler = new bfia(this, Looper.getMainLooper());
    this.jdField_a_of_type_Bghi = new bfib(this);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangLong = paramLong;
  }
  
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt, bghi parambghi)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("muid", MD5.toMD5(DeviceInfoUtil.getIMEI()));
      ((JSONObject)localObject2).put("carrier", DeviceInfoUtil.getCarrier());
      ...
      if (paramQQAppInterface != null)
      {
        ...
        new bghh(paramQQAppInterface, "GET", parambghi, paramInt, null, true).execute(new HashMap[] { localObject2 });
  ...
  {
    List localList = ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).a("" + this.jdField_a_of_type_JavaLangLong);
    if (localList == null) {
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          {
            localTroopFeedItem.tag = anvx.a(2131714675);
            ...
            localObject = new ByteArrayInputStream(bdpo.a(localTroopNotificationCache.xmlBytes, i));
            localbfic = new bfic(this);
            SAXParserFactory.newInstance().newSAXParser().parse((InputStream)localObject, localbfic);
            ((InputStream)localObject).close();
            if (localTroopNotificationCache.serviceID == 20)
            {
              localTroopFeedItem.title = localbfic.jdField_a_of_type_JavaLangString;
              localTroopFeedItem.content = "";
              localTroopFeedItem.picPath = localbfic.jdField_b_of_type_JavaLangString;
              localTroopFeedItem.linkUrl = localbfic.jdField_d_of_type_JavaLangString;
          ...
          for (;;)
          {
            localTroopFeedItem.tag = anvx.a(2131714676);
            localTroopFeedItem.type = 133;
            break;
            localTroopFeedItem.title = localTroopNotificationCache.title;
            localTroopFeedItem.content = localbfic.jdField_c_of_type_JavaLangString;
            break label283;
            i = 0;
            break;
            i = 0;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      new bghh("https://web.qun.qq.com/cgi-bin/announce/get_feed", "GET", this.jdField_a_of_type_Bghi, paramInt, null, true).execute(new HashMap[] { localObject1 });
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    ((HashMap)localObject1).put("CONTEXT", MobileQQ.getContext());
    new bghh("https://web.qun.qq.com/cgi-bin/announce/get_t_list", "GET", this.jdField_a_of_type_Bghi, paramInt, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
