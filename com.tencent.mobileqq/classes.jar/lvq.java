  ...
  implements View.OnClickListener
{
  ...
  public lvq(RedPacketGameView paramRedPacketGameView, AVActivity paramAVActivity)
  {
    this.jdField_a_of_type_ArrayOfLvm = new lvm[4];
    this.jdField_a_of_type_Lvm = new lvm();
    this.jdField_b_of_type_Lvm = new lvm();
    this.jdField_c_of_type_Lvm = new lvm();
    ...
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLvm.length)
    {
      this.jdField_a_of_type_ArrayOfLvm[n] = new lvm();
      this.jdField_a_of_type_ArrayOfLvm[n].jdField_b_of_type_Int = (n * 37 + 30);
      this.jdField_a_of_type_ArrayOfLvm[n].jdField_c_of_type_Int = 30;
      this.jdField_a_of_type_ArrayOfLvm[n].d = 37;
      this.jdField_a_of_type_ArrayOfLvm[n].e = 46;
      this.jdField_a_of_type_ArrayOfLvm[n].a(255);
      n += 1;
    }
    this.jdField_a_of_type_Lvm.jdField_c_of_type_Int = 36;
    this.jdField_a_of_type_Lvm.d = 200;
    this.jdField_a_of_type_Lvm.e = 28;
    this.jdField_a_of_type_Lvm.a(255);
    this.jdField_b_of_type_Lvm.jdField_c_of_type_Int = 36;
    this.jdField_b_of_type_Lvm.d = 200;
    this.jdField_b_of_type_Lvm.e = 28;
    this.jdField_b_of_type_Lvm.a(255);
    this.jdField_c_of_type_Lvm.jdField_c_of_type_Int = 36;
    this.jdField_c_of_type_Lvm.d = 200;
    this.jdField_c_of_type_Lvm.e = 28;
    this.jdField_c_of_type_Lvm.a(255);
    ...
    paramAVActivity.setId(2131372449);
    ...
    paramRedPacketGameView.setId(2131372450);
  ...
  private void e()
  {
    View localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131372449);
    ...
    localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131372450);
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_Lvm.jdField_b_of_type_Int = n;
      this.jdField_b_of_type_Lvm.jdField_b_of_type_Int = n;
      this.jdField_c_of_type_Lvm.jdField_b_of_type_Int = n;
      this.jdField_a_of_type_Lvm.b(this.h, this.i, 0, 0);
      this.jdField_b_of_type_Lvm.b(this.h, this.i, 0, 0);
  ...
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Lvm.a();
    int i1 = this.e * this.jdField_b_of_type_Int / this.jdField_c_of_type_Int + this.d;
    int n = ((Rect)localObject).width() + i1;
    this.jdField_c_of_type_Lvm.a(i1, ((Rect)localObject).top, n, ((Rect)localObject).bottom);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_Int != paramInt)
    {
      ...
      int i1 = paramInt;
      paramInt = i2;
      while (paramInt < this.jdField_a_of_type_ArrayOfLvm.length)
      {
        i2 = i1 / n;
        if (this.jdField_a_of_type_ArrayOfLvr != null) {
          this.jdField_a_of_type_ArrayOfLvm[paramInt].a = this.jdField_a_of_type_ArrayOfLvr[i2];
        }
        i1 %= n;
        n /= 10;
        paramInt += 1;
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLvm.length)
    {
      this.jdField_a_of_type_ArrayOfLvm[n].b(paramInt1, paramInt2, paramInt3, paramInt4);
      n += 1;
    }
    this.h = paramInt1;
    this.i = paramInt2;
  ...
  public void a(long paramLong)
  {
    ...
    else
    {
      ...
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Lvm.a(n);
        this.jdField_b_of_type_Lvm.a(n);
        this.jdField_c_of_type_Lvm.a(n);
        localObject = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131372449);
        ...
        localObject = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131372450);
  ...
  public void a(Canvas paramCanvas, Paint paramPaint)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLvm.length)
    {
      this.jdField_a_of_type_ArrayOfLvm[n].a(paramCanvas, paramPaint);
      n += 1;
    }
    this.jdField_a_of_type_Lvm.a(paramCanvas, paramPaint);
    paramCanvas.save();
    paramCanvas.clipPath(this.jdField_a_of_type_AndroidGraphicsPath);
    this.jdField_b_of_type_Lvm.a(paramCanvas, paramPaint);
    this.jdField_c_of_type_Lvm.a(paramCanvas, paramPaint);
    paramCanvas.restore();
    paramCanvas.restore();
  }
  ...
  {
    this.jdField_a_of_type_Lvm.a = new lvr(paramAVRedPacketManager.a("qav_redpacket_progressbar_bg.png"));
    this.jdField_b_of_type_Lvm.a = new lvr(paramAVRedPacketManager.a("qav_redpacket_progressbar_red.png"));
    this.jdField_c_of_type_Lvm.a = new lvr(paramAVRedPacketManager.a("qav_redpacket_progressbar_yellow.png"));
    this.jdField_a_of_type_ArrayOfLvr = paramArrayOflvr;
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLvm.length)
    {
      this.jdField_a_of_type_ArrayOfLvm[n].a = this.jdField_a_of_type_ArrayOfLvr[0];
      n += 1;
    }
  }
  ...
  public void a(boolean paramBoolean, AVRedPacketManager paramAVRedPacketManager)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
        localView.setBackgroundDrawable(mts.a(paramAVRedPacketManager, this.jdField_a_of_type_AndroidGraphicsBitmap, 2131165919));
      }
  ...
  public void b()
  {
    this.jdField_a_of_type_Lvm.b();
    this.jdField_b_of_type_Lvm.b();
    this.jdField_c_of_type_Lvm.b();
    ...
    this.jdField_b_of_type_Lvm = null;
    this.jdField_c_of_type_Lvm = null;
  ...
  public void c()
  {
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131372449).getLayoutParams();
    localLayoutParams.width = (this.h * 52 / 750);
    localLayoutParams.height = (this.h * 52 / 750);
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131372450).getLayoutParams();
