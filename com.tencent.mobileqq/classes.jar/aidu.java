...
public class aidu
  implements Runnable
{
  public aidu(TransFileController paramTransFileController, String paramString, Intent paramIntent, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      for (byte b = 1;; b = 0)
      {
        ...
        ((TransferRequest)localObject2).jdField_a_of_type_ComTencentMobileqqPicUpCallBack = new aidv(this, bool);
