...
public class aidu
  extends aimb
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aidv(this);
  ...
  public aidu(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = aieb.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131558857);
    }
    paramView = (aieb)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      aieb.a(this, paramView, paramViewGroup);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(paramView.jdField_a_of_type_JavaLangString))
      {
        ...
        if ((AppSetting.d) && (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          ...
          localView.setContentDescription(paramViewGroup.name + ajyc.a(2131707991));
        }
      }
      for (;;)
      {
        ...
        break;
        label265:
        localView.setContentDescription(paramViewGroup.name + ajyc.a(2131707989));
      }
    }
