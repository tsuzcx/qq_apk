  ...
  extends ContextThemeWrapper
{
  ...
  public aazf(Context paramContext, int paramInt, aazf paramaazf)
  {
    super(paramContext, paramInt);
    this.jdField_a_of_type_JavaLangClassLoader = paramaazf.jdField_a_of_type_JavaLangClassLoader;
    this.jdField_a_of_type_AndroidContentResAssetManager = paramaazf.jdField_a_of_type_AndroidContentResAssetManager;
    this.jdField_a_of_type_AndroidContentResResources$Theme = paramaazf.jdField_a_of_type_AndroidContentResResources$Theme;
    this.jdField_a_of_type_AndroidContentResResources = paramaazf.jdField_a_of_type_AndroidContentResResources;
    this.jdField_a_of_type_Int = paramaazf.jdField_a_of_type_Int;
  }
  
  public aazf(Context paramContext, int paramInt, String paramString, ClassLoader paramClassLoader)
  {
    this(paramContext, paramInt, paramString, paramClassLoader, null, true);
  }
  
  public aazf(Context paramContext, int paramInt, String paramString, ClassLoader paramClassLoader, Resources paramResources, boolean paramBoolean)
  {
    super(paramContext, paramInt);
