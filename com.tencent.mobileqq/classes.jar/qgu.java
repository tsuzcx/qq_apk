...
public class qgu
{
  private static final String jdField_a_of_type_JavaLangString = qgu.class.getSimpleName();
  ...
  public qgu(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_b_of_type_JavaLangString = obz.a();
  }
  ...
  public boolean a(VideoInfo.ECommerceEntranceInfo paramECommerceEntranceInfo)
  {
    ...
    try
    {
      boolean bool = bgmq.u(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (!bool) {
        bgmq.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0));
      }
      if (bool) {}
      for (int i = ((Integer)bgmq.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0))).intValue();; i = 0)
      {
