...
public class bbpu
{
  ...
  static
  {
    jdField_d_of_type_JavaLangString = alpo.a(2131715687);
  }
    ...
    while (this.jdField_a_of_type_JavaLangString.indexOf('[') > 0)
    {
      ...
      if ((i < this.jdField_a_of_type_JavaLangString.length() - 1) && (this.jdField_a_of_type_JavaLangString.charAt(i + 1) == '('))
      {
        ...
        if (m > 0)
        {
          ...
          localbbpv.jdField_a_of_type_Int = k;
          localbbpv.jdField_b_of_type_Int = (i + 1);
          localbbpv.jdField_a_of_type_JavaLangString = str;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbbpv);
        }
      }
    }
  }
