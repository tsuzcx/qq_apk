  ...
  implements View.OnClickListener, beno
{
  ...
  private afgd jdField_a_of_type_Afgd;
  private ajfo jdField_a_of_type_Ajfo = new afan(this);
  private ajjh jdField_a_of_type_Ajjh = new afam(this);
  private ajls jdField_a_of_type_Ajls;
  private Context jdField_a_of_type_AndroidContentContext;
  private View jdField_a_of_type_AndroidViewView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private avck jdField_a_of_type_Avck = new afal(this);
  private avev jdField_a_of_type_Avev;
  private begh jdField_a_of_type_Begh = new afaq(this);
  private bens jdField_a_of_type_Bens;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  protected Runnable a;
  private Comparator<MayKnowRecommend> jdField_a_of_type_JavaUtilComparator = new afap(this);
  ...
  public afak(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, View paramView1, View paramView2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131300044));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131301633);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
    if (ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null)) {
      this.jdField_c_of_type_AndroidViewView.setBackgroundResource(2130839020);
    }
    paramXListView = (ThemeImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301630);
    paramXListView.setSupportMaskView(true);
    paramXListView.setMaskShape(beog.jdField_b_of_type_Int);
    ...
    this.jdField_a_of_type_Afgd = ((afgd)paramQQAppInterface.getManager(295));
  ...
  private void a(afar paramafar)
  {
    if (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))
    {
      paramafar.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839019);
      paramafar.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#12B7F5"));
      paramafar.b.setTextColor(Color.parseColor("#7F12B7F5"));
      paramafar.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a("https://qzonestyle.gtimg.cn/aoi/sola/20190920103348_DVTS7XhGQJ.png"));
      return;
    }
    paramafar.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839020);
    paramafar.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.argb(102, 255, 255, 255));
    paramafar.b.setTextColor(Color.argb(102, 255, 255, 255));
    paramafar.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a("https://qzonestyle.gtimg.cn/aoi/sola/20190920103348_9H32GY0LpT.png"));
  }
  ...
  protected View a(Context paramContext, int paramInt, afar paramafar)
  {
    View localView = LayoutInflater.from(paramContext).inflate(paramInt, null);
    return this.jdField_a_of_type_Bens.a(paramContext, localView, paramafar, -1);
  }
  
  protected View a(Context paramContext, int paramInt, afas paramafas)
  {
    View localView = LayoutInflater.from(paramContext).inflate(paramInt, null);
    return this.jdField_a_of_type_Bens.a(paramContext, localView, paramafas, -1);
  }
  ...
  protected bens a(Context paramContext)
  {
    ...
    return new afao(this, 1, 2, new int[] { i, j }, -1, paramContext, arrayOfInt1, arrayOfInt2);
  }
  ...
  public void a(TextView paramTextView, MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    String str = paramMayKnowRecommend.getDisplayName(this.jdField_a_of_type_Ajls.a());
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_b_of_type_Int != 23) && (this.jdField_a_of_type_Afgd.c()))
    {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131633456);
      this.jdField_c_of_type_AndroidViewView.setVisibility(0);
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A5D3", "0X800A5D3", 0, 0, "2", "", "", "");
      return;
    }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    Object localObject = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ArrayList localArrayList = ((alov)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(112)).a();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramViewGroup = new afar();
      paramView = a(this.jdField_a_of_type_AndroidContentContext, 2131495538, paramViewGroup);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131302887));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131312349));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312553));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131297930));
      ...
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "frd_list", "info_add_exp", 2, 0, "", "", "", "");
      paramViewGroup = null;
    ...
    for (;;)
    {
      ...
      return paramView;
      if ((paramView == null) || (!(paramView.getTag() instanceof afas)))
      {
        paramViewGroup = new afas();
        ...
        paramViewGroup.e = ((TextView)paramView.findViewById(2131310850));
        paramView.setTag(paramViewGroup);
      ...
      paramViewGroup = (afas)paramView.getTag();
      break;
      label778:
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131309584: 
      ...
      do
      {
        ...
        if ((!((ajjj)localObject).b(paramView.uin)) && (!((ajjj)localObject).d(paramView.uin)))
        {
          ...
          localObject = paramView.getDisplayName(this.jdField_a_of_type_Ajls.a());
          ...
          ((Intent)localObject).putExtra("key_param_age_area", azyk.a(this.jdField_a_of_type_AndroidContentContext, paramView.gender, paramView.age, paramView.country, paramView.province, paramView.city));
        ...
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "frd_list", "info_add_clk", 2, 0, "", "", "", "");
      ...
      for (int i = 1;; i = 110)
      {
        ...
        String str = ((MayKnowRecommend)localObject).getRecommendName(this.jdField_a_of_type_Ajls.a());
    ...
    {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A5D4", "0X800A5D4", 0, 0, "2", "", "", "");
      this.jdField_a_of_type_Afgd.b(true);
      return;
    }
    bbmy.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131626719), 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167766));
  }
