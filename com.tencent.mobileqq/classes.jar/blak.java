...
public class blak
{
  ...
  public void a(Context paramContext, AudioCapture paramAudioCapture)
  {
    ...
    VoiceTextRecognizer.getInstance().setVRErrorListener(new blal(this));
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      new wbc(paramArrayOfByte, localByteArrayOutputStream, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureAudioAudioCapture.a(), 16000, 2, 2, 1, paramInt2, 0.0D, 0, true);
