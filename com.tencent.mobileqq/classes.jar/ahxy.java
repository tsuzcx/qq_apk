...
{
  public ahxy(ClassificationSearchActivity paramClassificationSearchActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((this.a.f == ClassificationSearchActivity.jdField_a_of_type_Int) && (!TextUtils.isEmpty(((String)localObject).trim())))
      {
        ...
        odq.a(null, "dc00899", "Pb_account_lifeservice", "", "0X80067C4", "0X80067C4", 0, 0, "", "", (String)localObject, "", true);
      }
      else if (this.a.f == ClassificationSearchActivity.d)
      {
        odq.a(null, "", "0X800742D", "0X800742D", 0, 0, (String)localObject, "", "", "");
        ClassificationSearchActivity.a(this.a, (String)localObject);
      }
      else
      {
