  ...
  implements InputFilter
{
  ...
  public ahof(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    ahoe localahoe = ExtendEditText.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localahoe == null)
    {
    ...
    for (;;)
    {
      ...
      a();
      return "";
      paramInt3 = localahoe.a(paramSpanned, 0, paramInt3) + localahoe.a(paramSpanned, paramInt4, paramSpanned.length());
      break;
      label95:
      paramInt2 = localahoe.a(paramCharSequence, paramInt1, paramInt2);
    }
    label109:
    ...
    if (localahoe != null)
    {
      paramInt3 = localahoe.b(paramCharSequence, paramInt1, paramInt1 + paramInt3);
      paramInt2 = paramInt3;
      if (paramInt3 <= 0) {
        return "";
      }
