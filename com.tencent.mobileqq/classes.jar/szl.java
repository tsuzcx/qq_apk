  ...
  extends tbb
{
  ...
  public szl(sze paramsze) {}
  
  public szl(sze paramsze, qqstory_service.RspGetCommentList paramRspGetCommentList)
  {
  ...
  public void a()
  {
    ...
    sze.a(this.jdField_a_of_type_Sze, this.jdField_a_of_type_ComTencentBizQqstoryNetworkPbQqstory_service$RspGetCommentList.cookie.get().toStringUtf8());
    ...
    if (i < ((List)localObject).size())
    {
      ...
      QQUserUIItem localQQUserUIItem = localtdl.c(localCommentEntry.authorUnionId);
      if ((localQQUserUIItem == null) || (!localQQUserUIItem.isAvailable()))
      {
        localCommentEntry.authorName = tsr.b;
        label114:
        if (!TextUtils.isEmpty(localCommentEntry.replyUin))
        {
          localQQUserUIItem = localtdl.c(localCommentEntry.replierUnionId);
          if ((localQQUserUIItem != null) && (localQQUserUIItem.isAvailable())) {
            break label187;
          }
        }
      ...
      label187:
      for (localCommentEntry.replierName = tsr.b;; localCommentEntry.replierName = localQQUserUIItem.nickName)
      {
    ...
    localObject = this.jdField_a_of_type_Sze;
    if (this.jdField_a_of_type_ComTencentBizQqstoryNetworkPbQqstory_service$RspGetCommentList.is_end.get() == 1) {
      bool = true;
    }
    ((sze)localObject).jdField_a_of_type_Boolean = bool;
    this.jdField_a_of_type_Sze.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentBizQqstoryNetworkPbQqstory_service$RspGetCommentList.total_comment_num.get();
    this.jdField_a_of_type_Sze.jdField_a_of_type_Szs.a(localArrayList);
  }
  
  public void a(int paramInt, Bundle paramBundle)
  {
    this.jdField_a_of_type_Sze.jdField_a_of_type_Szs.d();
