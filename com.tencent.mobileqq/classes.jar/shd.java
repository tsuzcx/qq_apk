  ...
  implements AbsListView.OnScrollListener
{
  ...
  public shd(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void a(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramInt1 > this.jdField_a_of_type_Int) && (paramInt1 >= this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.n) && (this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_AndroidWidgetRelativeLayout.getVisibility() != 0))
    {
      ...
      if ((paramAbsListView != null) && (paramAbsListView != this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_AndroidWidgetRelativeLayout.getAnimation()))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839162);
        this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130846346);
      }
    }
    for (;;)
    {
      ...
      if (paramAbsListView == this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_b_of_type_AndroidViewAnimationAlphaAnimation) {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData != null) && (!this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.hasSetNewTroopHead))
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841327);
            this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841328);
          }
          else
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841481);
            this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841466);
          }
        }
        else
        {
