...
final class astx
  implements auna
{
  astx(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2) {}
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          Object localObject4 = new azml();
          ((azml)localObject4).jdField_a_of_type_Int = localMessageRecord.istroop;
          ArrayList localArrayList1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramaunb.jdField_a_of_type_ArrayOfByte, (HashMap)localObject1, null, (azml)localObject4);
          ...
          if (((MessageRecord)localArrayList1.get(0)).msgtype == -1035)
          {
            ...
            ((asju)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(174)).a(true, this.jdField_a_of_type_Int);
            ...
            {
              if (((azml)localObject4).f.jdField_a_of_type_Long != -1L) {
                ((azml)localObject4).f.b = this.jdField_a_of_type_Long;
              }
              if (((azml)localObject4).jdField_a_of_type_Azmm.jdField_a_of_type_Long != -1L) {
                ((azml)localObject4).jdField_a_of_type_Azmm.b = this.jdField_a_of_type_Long;
              }
              ...
              if (QLog.isColorLevel()) {
                QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg update MessageInfo-- groupUin:" + str + "lastSeq:" + l + ",shMsgSeq:" + localMessageRecord.shmsgseq + ",msgInfo.hasFlag:" + ((azml)localObject4).a());
              }
              if ((localMessageRecord.shmsgseq > l) && (((azml)localObject4).a()))
              {
                localMessageRecord.mMessageInfo = ((azml)localObject4);
                localObject4 = (akom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1);
                ArrayList localArrayList2 = new ArrayList();
                localArrayList2.add(localMessageRecord);
                ((akom)localObject4).a(str, localArrayList2);
              }
            }
            ...
            ((astu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(166)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Int, paramaunb.jdField_a_of_type_Int, 1);
            return;
          }
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg onDownload exception! resultCode:" + paramaunb.jdField_a_of_type_Int + ",errCode: " + paramaunb.b + ",errStr:" + paramaunb.jdField_a_of_type_JavaLangString + ",cost:" + (System.currentTimeMillis() - this.b));
        continue;
        ...
        try
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg onDownload failed! resultCode:" + paramaunb.jdField_a_of_type_Int + ",errCode: " + paramaunb.b + ",errStr:" + paramaunb.jdField_a_of_type_JavaLangString + ",cost:" + (System.currentTimeMillis() - this.b));
          }
        }
