  ...
  implements AladdinConfigHandler
{
  ...
  private static boolean jdField_a_of_type_Boolean = ((Boolean)bhvy.a("readinjjoy_feeds_card_whitelist", Boolean.valueOf(false))).booleanValue();
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    ...
    do
    {
      do
      {
        ...
        } while (((paramArticleInfo.mChannelID != 0L) && (paramArticleInfo.mChannelID != 70L) && (!oou.c((int)paramArticleInfo.mChannelID))) || ((paramArticleInfo instanceof AdvertisementInfo)) || (paramArticleInfo.mFeedType == 29));
        i = onh.a(paramArticleInfo);
        if (!jdField_a_of_type_JavaUtilSet.contains(Integer.valueOf(i))) {
          break;
        }
      } while (!onh.s(paramArticleInfo));
      i = pgm.a(paramArticleInfo);
    } while ((i == 1) || (i == 2));
    return false;
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (TextUtils.equals(str, "kandian_feeds_card_whitelist")) {
        if (Integer.valueOf((String)localObject2).intValue() == 1)
        {
          ...
          bhvy.a("readinjjoy_feeds_card_whitelist", Boolean.valueOf(bool));
        }
      }
    }
    for (;;)
    {
      ...
      {
        bhvy.a("default_feeds_proteus_offline_bid", (String)localObject2);
        new rpu().a("default_feeds");
      ...
      else if (TextUtils.equals(str, "kandian_feeds_card_cdn_url"))
      {
        ...
        continue;
        rqm.a((String)localObject1, paramString);
        return true;
      }
    }
  }
