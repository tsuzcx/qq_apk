  ...
  implements begw
{
  ...
  public zwl(AccountManageActivity paramAccountManageActivity) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
      return;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.jdField_a_of_type_Begr != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.jdField_a_of_type_Begr.dismiss();
      }
      switch (paramInt)
      {
      default: 
