...
{
  private static final String jdField_a_of_type_JavaLangString = blag.class.getSimpleName();
  ...
  public blag(GLSurfaceView paramGLSurfaceView)
  {
  ...
  {
    if (this.jdField_a_of_type_Blae != null) {
      this.jdField_a_of_type_Blae.a(paramblaf);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Blae != null) {
      this.jdField_a_of_type_Blae.a(paramBoolean);
    }
  }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    {
      a(this.jdField_a_of_type_Blae.a(this.jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float));
      return;
    }
    GLES20.glBindFramebuffer(36160, 0);
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Blae.a(paramInt1, paramInt2);
  }
