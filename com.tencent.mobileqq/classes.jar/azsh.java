...
public class azsh
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new azsi(ThreadManager.getFileThreadLooper());
  ...
  {
    if (d == null) {
      d = bdzf.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/com/tencent/mobileqq/battery/");
    }
