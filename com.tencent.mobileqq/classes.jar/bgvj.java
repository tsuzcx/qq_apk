...
public class bgvj
{
  ...
  public bgvj(AppInterface paramAppInterface, bguk parambguk, Intent paramIntent, Context paramContext, boolean paramBoolean)
  {
  ...
  public bgvj(AppInterface paramAppInterface, bguk parambguk, Intent paramIntent, TouchWebView paramTouchWebView)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_Bguk = parambguk;
    this.jdField_a_of_type_AndroidContentIntent = paramIntent;
  ...
  {
    bgvk localbgvk = new bgvk(this);
    paramTouchWebView.setWebChromeClient(localbgvk);
    this.jdField_a_of_type_Nyz = localbgvk;
  }
  ...
  public TouchWebView a(TouchWebView paramTouchWebView, AppInterface paramAppInterface, Intent paramIntent)
  {
    ...
    String str1 = a(this.jdField_a_of_type_Bguk);
    boolean bool;
    ...
    for (;;)
    {
      localWebSettings.setUserAgentString(bgyb.a((String)localObject, str1, bool));
      ...
      try
      {
        ...
        if (paramTouchWebView.getX5WebViewExtension() != null)
        {
          paramTouchWebView.getX5WebViewExtension().setWebViewClientExtension(new bgvn(this, paramTouchWebView, this.jdField_a_of_type_Bguk));
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(bgxd.x), " cost:", Long.valueOf(bgya.jdField_a_of_type_Long) });
          }
          ...
          paramAppInterface.put("coreInit", String.valueOf(bgya.jdField_a_of_type_Long));
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new bgvl(this);; localObject = new bgvm(this))
    {
