...
public class alte
{
  ...
  public alte(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(ambl paramambl, int paramInt1, int paramInt2, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    for (paramInt1 = 14;; paramInt1 = 5)
    {
      ...
      ambc.a(paramambl, paramInt1, paramAppInterface);
      return 0;
    }
  }
  ...
  public int a(ambl paramambl, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    paramAppInterface.actionId = -1;
    paramAppInterface.actionType = 0;
    ambc.a(paramambl, 5, paramAppInterface);
    if (QLog.isColorLevel()) {
