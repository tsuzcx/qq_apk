  ...
  implements View.OnClickListener
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setOutlineProvider(new bhlh(paramInt2));
      ...
      {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.setOutlineProvider(new bhlh(paramInt1));
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setBackgroundColor(paramContext.getResources().getColor(2131167276));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = new FrameLayout(paramContext);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131374273);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundColor(paramContext.getResources().getColor(2131167276));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate(paramContext, 2131561553, null));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374260));
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(amtj.a(2131703752));
  ...
  {
    if ((paramInt != 1) || (this.jdField_a_of_type_Bhlz == null) || (!this.jdField_a_of_type_Bhlz.a()))
    {
      this.jdField_a_of_type_Bhlz = null;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((i == 2131374266) && (this.jdField_a_of_type_Bhlz != null)) {
        this.jdField_a_of_type_Bhlz.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b());
      }
    }
  }
}
