...
public class bbme
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((paramBoolean) && (this.jdField_a_of_type_Bbmi != null)) {
          this.jdField_a_of_type_Bbmi.k();
        }
        return;
        if (QLog.isColorLevel()) {
  ...
  public void a(MediaFormat paramMediaFormat)
  {
    ...
    if (this.jdField_a_of_type_Bbmi != null) {
      this.jdField_a_of_type_Bbmi.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
    }
    return;
    label114:
    this.jdField_a_of_type_Bbmv.a(0, paramMediaFormat);
  }
  ...
  public void a(bbmc parambbmc)
  {
    ...
    if (parambbmc.j != -1) {
      ((MediaFormat)localObject).setInteger("bitrate-mode", parambbmc.j);
    }
    if (parambbmc.k != -1)
    {
    ...
    if (parambbmc.jdField_b_of_type_Boolean)
    {
      ((MediaFormat)localObject).setInteger("profile", 1);
      ((MediaFormat)localObject).setInteger("level", 512);
    }
    if (QLog.isColorLevel()) {
      QLog.d("HWVideoEncoder", 2, "start : encodeConfig = + " + parambbmc.toString() + " ; format: " + localObject);
    }
    ...
    if (parambbmc.jdField_a_of_type_Bbmv == null)
    {
    ...
    for (;;)
    {
      if (parambbmc.jdField_a_of_type_Bbmi != null) {
        this.jdField_a_of_type_Bbmi = parambbmc.jdField_a_of_type_Bbmi;
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_a_of_type_Boolean = false;
      return;
      this.jdField_a_of_type_Bbmv = parambbmc.jdField_a_of_type_Bbmv;
      this.jdField_a_of_type_Bbmv.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(parambbmc.g);
    }
  }
  ...
  public void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    if (this.jdField_a_of_type_Bbmv == null)
    {
      ...
      if (this.jdField_a_of_type_Bbmi != null)
      {
        ...
        this.jdField_a_of_type_Bbmi.a(paramBufferInfo);
    ...
    this.jdField_a_of_type_Bbmv.a(0, paramByteBuffer, paramBufferInfo);
  }
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_Bbmv != null) || (this.jdField_a_of_type_AndroidMediaMediaMuxer == null)) {
            break label237;
          }
          try
          {
