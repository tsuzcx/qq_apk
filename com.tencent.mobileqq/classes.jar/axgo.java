...
public class axgo
{
  private static axgo jdField_a_of_type_Axgo;
  ...
  {
    if (jdField_a_of_type_Axgo == null) {
      jdField_a_of_type_Axgo = new axgo();
    }
    return jdField_a_of_type_Axgo;
  }
  ...
  public static boolean a(AppInterface paramAppInterface)
  {
    ...
    } while ((axle.a(BaseApplicationImpl.getContext()) == 2) || (axle.a() == 2));
    return true;
  }
  ...
  public static boolean b(AppInterface paramAppInterface)
  {
    ...
    do
    {
      ...
      } while (!bbdx.a(str + paramAppInterface));
    } while ((axle.a(BaseApplicationImpl.getContext()) == 2) || (axle.a() == 2));
    return true;
  }
  ...
  public static boolean c()
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        QmcfManager.getInstance().setQmcfMobileNotSupport(axjr.jdField_a_of_type_JavaLangString);
        QLog.d("DanceGameVideoManager", 1, String.format("isDanceGameSupport supportFrameType[%d], gpuinfo[%s], model[%s]", new Object[] { Integer.valueOf(i), axjr.jdField_a_of_type_JavaLangString, Build.MODEL }));
        bool2 = bool1;
      }
      return bool2;
    }
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    if (a(paramQQAppInterface))
    {
      ...
      paramQQAppInterface = bigo.a(paramQQAppInterface, paramActivity.getClass().getName(), 10000, 100, true, 10, "");
      vwj.a().a(paramActivity, paramQQAppInterface, 11);
    }
  }
  ...
  public void a(Packet paramPacket, String paramString, int paramInt)
  {
    ...
    localByteBuffer.putInt(bbbr.a(l)).put((byte)0).putShort((short)1).putShort((short)27245).putShort((short)2).putShort((short)paramInt);
    paramString = new oidb_sso.OIDBSSOPkg();
  ...
  public void b(FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          long l = bbbr.a(ByteBuffer.wrap(paramFromServiceMsg.bytes_bodybuffer.get().toByteArray()).getInt());
