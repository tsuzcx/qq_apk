...
class bkwi
{
  ...
  void a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        ...
        if (!bkwg.a().equals(new bkwm(arrayOfByte))) {
          break;
        }
    ...
    } while (!bkwg.b().equals(new bkwm(paramArrayOfByte)));
    if (i - j <= 2)
    {
    ...
    localByteBuffer.get(paramArrayOfByte);
    int k = new bkwn(paramArrayOfByte).a();
    if (i - j - 2 < k)
    {
    ...
    return;
    if (bkwg.b().equals(new bkwm(arrayOfByte)))
    {
      j = bkwg.b().a().length;
      if (paramArrayOfByte.length - i <= 2)
      {
  ...
  byte[] a()
  {
    ...
    {
      localByteArrayOutputStream.write(bkwg.a().a());
      ...
      localByteArrayOutputStream.write(new bkwn(localObject1.length).a());
      localByteArrayOutputStream.write((byte[])localObject1);
    }
    if ((this.jdField_a_of_type_ArrayOfByte != null) && (this.jdField_a_of_type_ArrayOfByte.length > 0))
    {
      localByteArrayOutputStream.write(bkwg.b().a());
      localByteArrayOutputStream.write(new bkwn(this.jdField_a_of_type_ArrayOfByte.length).a());
