  ...
  extends Dialog
{
  ...
  private beoh jdField_a_of_type_Beoh;
  private CharSequence jdField_a_of_type_JavaLangCharSequence;
  private ArrayList<Pair<CharSequence, Integer>> jdField_a_of_type_JavaUtilArrayList;
  private HashMap<CharSequence, benx> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private HashSet<Integer> jdField_a_of_type_JavaUtilHashSet;
  public boolean a;
  private int jdField_b_of_type_Int = 300;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new beob(this);
  private CharSequence jdField_b_of_type_JavaLangCharSequence;
  private HashMap<Integer, Drawable> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  protected boolean b;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new beoc(this);
  ...
  protected beny(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true);
  }
  
  @TargetApi(14)
  protected beny(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if ((paramBoolean3) && (bfgl.jdField_a_of_type_Boolean)) {
  ...
  public static beny a(Context paramContext)
  {
    paramContext = new beny(paramContext, false, false);
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    paramTextView.setContentDescription(getContext().getString(2131694213) + paramTextView.getText());
  }
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_JavaLangCharSequence != null)
    {
      ...
      ((View)localObject1).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840699));
      ((View)localObject1).setOnClickListener(new benz(this));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          ...
          TextView localTextView = (TextView)((View)localObject2).findViewById(2131361913);
          ...
          bekv.a(localTextView, Button.class.getName());
          if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
          {
            localObject3 = (benx)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
            if ((localObject3 != null) && (((benx)localObject3).jdField_a_of_type_Int != 0)) {
              localTextView.setId(((benx)localObject3).jdField_a_of_type_Int);
            }
          }
          Object localObject3 = (ImageView)((View)localObject2).findViewById(2131361924);
          RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)((ImageView)localObject3).getLayoutParams();
          localLayoutParams.rightMargin = bfgl.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
          ...
          if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(i)))
          {
            ...
            label415:
            localObject3 = (ImageView)((View)localObject2).findViewById(2131361925);
            ...
            {
              localLayoutParams.width = bfgl.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
              localLayoutParams.height = bfgl.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
              localLayoutParams.addRule(15);
            }
            localLayoutParams.rightMargin = bfgl.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
            ((ImageView)localObject3).setLayoutParams(localLayoutParams);
            ...
            if (this.jdField_c_of_type_Boolean)
            {
              ...
              ((View)localObject2).findViewById(2131361914).setVisibility(0);
  ...
  public Drawable a(int paramInt)
  {
    ...
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840695);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840698);
    }
    return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840702);
  }
