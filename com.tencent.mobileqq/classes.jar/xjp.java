  ...
  implements View.OnClickListener
{
  ...
  public xjp(LoginView paramLoginView, Context paramContext)
  {
    super(paramContext, 2130968588, 2131362728, paramLoginView.jdField_a_of_type_JavaUtilList);
  }
  ...
  public Filter getFilter()
  {
    if (this.jdField_a_of_type_AndroidWidgetFilter == null) {
      this.jdField_a_of_type_AndroidWidgetFilter = new xjq(this);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (LinearLayout)paramView.findViewById(2131362727);
    ImageView localImageView = (ImageView)paramView.findViewById(2131362729);
    ...
    for (;;)
    {
      localImageView = (ImageView)paramView.findViewById(2131362730);
