  ...
  implements bhpo
{
  ...
  private Object a()
  {
    ...
    try
    {
      ...
      bjpe localbjpe = new bjpe(this);
      this.jdField_b_of_type_JavaLangObject = Proxy.newProxyInstance(localClassLoader, new Class[] { localClass }, localbjpe);
      return this.jdField_b_of_type_JavaLangObject;
    }
  ...
  public void a()
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentWidgetListView != null)) {
      this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(new bhyu(null));
    }
  }
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, Card paramCard, ListView paramListView, View paramView)
  {
    ...
    bjdh.a(new bjpd(this, paramActivity, paramQQAppInterface, paramListView, paramCard));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, ListView paramListView, Card paramCard)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramQQAppInterface != bjdh.a()) {
          bjdh.a(paramActivity, paramQQAppInterface);
        }
