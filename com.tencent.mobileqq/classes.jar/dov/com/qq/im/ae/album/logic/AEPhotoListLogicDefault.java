...
public class AEPhotoListLogicDefault
  ...
  implements SlideShowViewController.SlideShowActionListener, AEPhotoListLogic.IadapterCallback, AEPhotoListLogic.IcheckBoxCallback, AEPhotoListLogic.IitemClickCallback
{
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.isSupportVideoCheckbox)
      {
        ...
        if (paramLocalMediaInfo != null)
        {
          ...
          if ("video".equals(paramLocalMediaInfo[0])) {
            str1 = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131694869, new Object[] { Integer.valueOf(i) });
          }
        }
      }
    }
  ...
  public List<LocalMediaInfo> a(boolean paramBoolean)
  {
    ...
    for (i = 12;; i = 100)
    {
      localList = AlbumUtil.getAlbumMedias(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName, i, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.filterVideoDurationLimit);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    RecyclerView localRecyclerView = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
    AEAbstractPhotoListFragment.PhotoGridAdapter localPhotoGridAdapter = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumFragmentAEAbstractPhotoListFragment$PhotoGridAdapter;
    if ((paramInt1 >= 0) && (paramInt1 < localArrayList.size()) && (paramInt2 >= 0) && (paramInt2 < localArrayList.size()))
    {
      ...
      while (paramInt1 <= i)
      {
        Object localObject = localPhotoGridAdapter.a(paramInt1);
        int j = localArrayList.indexOf(((LocalMediaInfo)localObject).path);
        if (j >= 0)
        {
          localObject = (AEAbstractPhotoListFragment.PhotoVH)localRecyclerView.getChildViewHolder(localRecyclerView.getChildAt(((LocalMediaInfo)localObject).position.intValue() - paramInt2));
          if ((localObject != null) && (((AEAbstractPhotoListFragment.PhotoVH)localObject).a != null)) {
            ((AEAbstractPhotoListFragment.PhotoVH)localObject).a.setCheckedNumber(j + 1 + this.jdField_a_of_type_DovComQqImAeAlbumDataAEAlbumLogicData.initialHasPickedNum);
          }
        }
        paramInt1 += 1;
      }
      SlideShowPhotoListManager.a().b(localArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.allMediaInfoHashMap);
    }
    ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).d(true);
  }
  ...
  public void a(Intent paramIntent)
  {
    ...
    k();
    l();
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.k = paramIntent.getBooleanExtra("PhotoConst.IS_FROM_EDIT", false);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.f = paramIntent.getBooleanExtra("PhotoConst.IS_SINGLE_DERECTBACK_MODE", false);
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.g = paramIntent.getBooleanExtra("PhotoConst.IS_SINGLE_NEED_EDIT", false);
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.h = paramIntent.getBooleanExtra("PhotoConst.IS_CALL_IN_PLUGIN", false);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.i = paramIntent.getBooleanExtra("PhotoConst.IS_FINISH_RESTART_INIT_ACTIVITY", false);
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = ((SessionInfo)paramIntent.getParcelableExtra("session_info"));
      if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.e) {
        this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.e = paramIntent.getBooleanExtra("PhotoConst.SHOW_MAGIC_USE_PASTER", false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.e)
      {
  ...
  {
    int i2 = PhotoUtils.getTypeforReportSpcialDiscuss(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        localObject1 = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131719019);
      ...
      if (paramBoolean) {
        PhotoUtils.sendPhoto(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramIntent, paramArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.currentQualityType, false);
      }
      for (;;)
      {
        ReportController.b(null, "CliOper", "", "", "0X8009AB0", "0X8009AB0", i2, 0, (String)localObject2, (String)localObject3, "", "");
        return;
        PhotoUtils.sendPhoto(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramIntent, paramArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.currentQualityType, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_Boolean);
      }
    }
  }
  ...
  public void a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).j();
    }
  }
  ...
  {
    boolean bool2 = true;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.isSingleMode) {}
    ...
    } while (l - this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.lastTimeShowToast < 1000L);
    QQToast.a(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), a(localLocalMediaInfo), 0).b(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).d);
    ...
    return;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_a_of_type_Int == 9501) && (((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false)) && (i != 1))
    {
      ...
      if (FileUtils.a(localLocalMediaInfo.path) + l > 52428800L)
      {
        QQToast.a(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), "选择图片总大小不能超过50M", 0).b(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).d);
        paramCheckBox.setChecked(false);
        return;
      }
    }
    if ((((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(localLocalMediaInfo)) && (FileUtils.a(localLocalMediaInfo.path) > 3145728L))
    {
      QQToast.a(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), "图片文件过大", 0).b(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).d);
      paramCheckBox.setChecked(false);
      return;
    }
    boolean bool1;
    ...
    if (i == 1)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.isSupportVideoCheckbox) && (localObject != null) && ("video".equals(localObject[0])))
      {
        localPhotoListData = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData;
        localPhotoListData.videoSelectedCnt += 1;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.videoSelectedCnt == 1) {
          this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.selectedVideoInfo = localLocalMediaInfo;
        }
      }
      if ((!TextUtils.isEmpty(localLocalMediaInfo.mMimeType)) && ("image/gif".equals(localLocalMediaInfo.mMimeType)))
      {
        localPhotoListData = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData;
        localPhotoListData.gifSelectedCount += 1;
      }
      ...
      if ((paramView != null) && (localObject != null) && (localObject[0] != null) && (!"video".equals(localObject[0]))) {
        paramView.a(paramCheckBox, 1052, ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getIntExtra("entrance", 0));
      }
    ...
    for (;;)
    {
      paramView.put(paramCheckBox, Integer.valueOf(((GridLayoutManager)((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition()));
      ...
      label890:
      if (this.jdField_a_of_type_DovComQqImAeAlbumLogicAEPhotoListLogic$IonSelectionChangeListener != null) {
        this.jdField_a_of_type_DovComQqImAeAlbumLogicAEPhotoListLogic$IonSelectionChangeListener.a(bool1, localLocalMediaInfo);
      }
      ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt, bool1);
      paramView = (AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (!bool1) {}
  ...
  {
    Object localObject1 = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumFragmentAEAbstractPhotoListFragment$PhotoGridAdapter;
    ArrayList localArrayList = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList;
    Object localObject2;
    int i;
    if ((localObject1 != null) && (paramSlideItemInfo != null))
    {
      localObject2 = ((AEAbstractPhotoListFragment.PhotoGridAdapter)localObject1).a();
      i = 0;
    ...
    for (;;)
    {
      ...
      {
        paramSlideItemInfo = ((AEAbstractPhotoListFragment.PhotoGridAdapter)localObject1).a(i);
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.isSupportVideoCheckbox) && (localObject2 != null) && ("video".equals(localObject2[0])))
        {
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData;
          ((PhotoListData)localObject2).videoSelectedCnt -= 1;
          if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.videoSelectedCnt == 1) {
            this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.selectedVideoInfo = paramSlideItemInfo;
          }
        }
        ...
        if (this.jdField_a_of_type_DovComQqImAeAlbumLogicAEPhotoListLogic$IonSelectionChangeListener != null) {
          this.jdField_a_of_type_DovComQqImAeAlbumLogicAEPhotoListLogic$IonSelectionChangeListener.a(false, paramSlideItemInfo);
        }
        ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(i, false);
        e();
        SlideShowPhotoListManager.a().b(localArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.allMediaInfoHashMap);
      }
      label402:
  ...
  protected void a(AEAbstractPhotoListFragment.PhotoVH paramPhotoVH, LocalMediaInfo paramLocalMediaInfo)
  {
    if (ReplacePhotoDataUtil.a(paramLocalMediaInfo.path, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.jdField_c_of_type_JavaUtilHashMap))
    {
      if (Build.VERSION.SDK_INT >= 21) {
        paramPhotoVH.d.setImageDrawable(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getDrawable(2130839494));
      }
      for (;;)
      {
        paramPhotoVH.d.setVisibility(0);
        return;
        paramPhotoVH.d.setImageResource(2130839494);
      }
    }
  ...
  public void a(String paramString)
  {
    ...
    if ((i > 0) && (i < ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumFragmentAEAbstractPhotoListFragment$PhotoGridAdapter.getItemCount()))
    {
      localObject = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumFragmentAEAbstractPhotoListFragment$PhotoGridAdapter.a(i);
    ...
    PhotoListData.sPhotoListFirstPos = ((GridLayoutManager)((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
    localIntent.putExtra("PhotoConst.CURRENT_SELECTED_INDEX", localArrayList.indexOf(paramString));
    localIntent.setClass(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), NewPhotoPreviewActivity.class);
  ...
  protected void a(boolean paramBoolean, Intent paramIntent)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if ((localArrayList != null) && (localArrayList.size() > 0)) {
        ReportController.b(null, "CliOper", "", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.myUin, "0X8004072", "0X8004072", 0, localArrayList.size(), 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      AlbumUtil.anim(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), true, true);
      return;
      paramIntent.putExtra("PhotoConst.SINGLE_PHOTO_PATH", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.currentPhotoPath);
    }
  }
  ...
  public boolean a(List<LocalMediaInfo> paramList, boolean paramBoolean)
  {
    ...
    while (!super.a(paramList, paramBoolean)) {
      return false;
    }
    int i;
    int j;
    int k;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.firstResume)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.firstResume = false;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.photoListStartPos != -1) {
        break label356;
      }
      ...
      {
        i = j;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.isRecodeLastAlbumPath)
        {
      ...
      label308:
      i = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumFragmentAEAbstractPhotoListFragment$PhotoGridAdapter.getItemCount();
      if (i != 0) {
        break label395;
      }
    }
    for (;;)
    {
      ...
      return true;
      label356:
      i = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.photoListStartPos;
      break;
      label367:
      k += 1;
      break label164;
  ...
  public void c(View paramView)
  {
    ...
    if (((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false))
    {
      ...
      {
        FMDialogUtil.a(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2131692609, 2131692614, new AEPhotoListLogicDefault.6(this));
        return;
      }
    }
    j();
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.requestCode == 100016)
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListData.requestCode = 0;
  }
  ...
  protected void j()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList != null)
    {
      ...
      StatisticConstants.a(((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.currentQualityType);
    }
    Intent localIntent = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
  ...
  public void onPhotoListDatasetDurationChanged(int paramInt, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((AENewPhotoListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumFragmentAEAbstractPhotoListFragment$PhotoGridAdapter;
      } while ((localObject == null) || (((AEAbstractPhotoListFragment.PhotoGridAdapter)localObject).a == null));
 ...
 * Qualified Name:     dov.com.qq.im.ae.album.logic.AEPhotoListLogicDefault
