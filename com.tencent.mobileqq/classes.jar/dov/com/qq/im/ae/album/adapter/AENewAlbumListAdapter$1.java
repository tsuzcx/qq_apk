...
class AENewAlbumListAdapter$1
  implements Runnable
{
  AENewAlbumListAdapter$1(AENewAlbumListAdapter paramAENewAlbumListAdapter) {}
  ...
  public void run()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        String str2 = AEAlbumListAdapter.a(localQQAlbumInfo.mCoverInfo.path);
