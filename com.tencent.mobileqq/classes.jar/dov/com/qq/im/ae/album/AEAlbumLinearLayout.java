  ...
  implements NestedScrollingParent
{
  ...
  public AEAlbumLinearLayout(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    catch (Exception paramAttributeSet)
    {
      for (;;)
      {
        bpam.a("AEAlbumLinearLayout", "constructor, error=", paramAttributeSet);
  ...
  private void d()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bogb(this));
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bogc(this));
      return;
    }
  ...
  public void a()
  {
    bpam.a("AEAlbumLinearLayout", "[collapsePreviewContainer]");
    if (getScrollY() >= this.c)
    {
      bpam.a("AEAlbumLinearLayout", "[collapsePreviewContainer], already collapsed");
      return;
    }
    this.e = 1;
    int i = this.c - getScrollY();
    int j = (int)(1.0F * i / this.c * 275.0F);
    bpam.a("AEAlbumLinearLayout", "[collapsePreviewContainer], dy=" + i + ", duration=" + j);
    d();
  ...
  public void b()
  {
    bpam.a("AEAlbumLinearLayout", "[expandPreviewContainer]");
    if (getScrollY() <= 0)
    {
      bpam.a("AEAlbumLinearLayout", "[expandPreviewContainer], already expanded");
      return;
    }
    this.e = 2;
    int i = -getScrollY();
    int j = (int)(1.0F * getScrollY() / this.c * 275.0F);
    bpam.a("AEAlbumLinearLayout", "[expandPreviewContainer], dy=" + i + ", duration=" + j);
    d();
  ...
  {
    bpam.a("AEAlbumLinearLayout", "[getNestedScrollAxes]");
    return 2;
  }
  ...
  {
    bpam.a("AEAlbumLinearLayout", "[onNestedFling], velocityX=" + paramFloat1 + ", velocityY=" + paramFloat2 + ", consumed=" + paramBoolean);
    return super.onNestedFling(paramView, paramFloat1, paramFloat2, paramBoolean);
  }
  
  public boolean onNestedPreFling(View paramView, float paramFloat1, float paramFloat2)
  {
    bpam.a("AEAlbumLinearLayout", "[onNestedPreFling], velocityX=" + paramFloat1 + ", velocityY=" + paramFloat2);
  ...
  {
    bpam.a("AEAlbumLinearLayout", "[onNestedPreScroll], dy=" + paramInt2 + ", scrollY=" + getScrollY());
    int i;
    ...
    for (paramInt1 = 1;; paramInt1 = 2)
    {
      ...
      {
        this.jdField_a_of_type_Bogd.a(this.d);
        this.jdField_a_of_type_Bogd.b(a());
      }
      return;
      paramInt1 = 0;
      break;
  ...
  {
    bpam.a("AEAlbumLinearLayout", "[onNestedScroll], dxConsumed=" + paramInt1 + ", dyConsumed=" + paramInt2 + ", dxUnconsumed=" + paramInt3 + ", dyUnconsumed=" + paramInt4);
  ...
  {
    bpam.a("AEAlbumLinearLayout", "[onNestedScrollAccepted], axes=" + paramInt);
    super.onNestedScrollAccepted(paramView1, paramView2, paramInt);
  }
  
  public boolean onStartNestedScroll(View paramView1, View paramView2, int paramInt)
  {
    bpam.a("AEAlbumLinearLayout", "[onStartNestedScroll], nestedScrollAxes=" + paramInt);
    return (paramInt & 0x2) != 0;
  }
  
  public void onStopNestedScroll(View paramView)
  {
    bpam.a("AEAlbumLinearLayout", "[onStopNestedScroll], scrollY=" + getScrollY());
    ...
    {
      if (this.jdField_a_of_type_Bogd != null) {
        this.jdField_a_of_type_Bogd.a(this.d, a(this.d));
      }
      this.d = 0;
      return;
  ...
  public void setScrollListener(@Nullable bogd parambogd)
  {
    this.jdField_a_of_type_Bogd = parambogd;
  }
}
