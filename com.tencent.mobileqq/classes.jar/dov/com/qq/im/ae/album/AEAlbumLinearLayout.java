  ...
  implements NestedScrollingParent
{
  ...
  private bnev jdField_a_of_type_Bnev;
  ...
  public AEAlbumLinearLayout(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    catch (Exception paramAttributeSet)
    {
      for (;;)
      {
        bnzb.a("AEAlbumLinearLayout", "constructor, error=", paramAttributeSet);
  ...
  private void d()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bnet(this));
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bneu(this));
      return;
    }
  ...
  public void a()
  {
    bnzb.a("AEAlbumLinearLayout", "[collapsePreviewContainer]");
    if (getScrollY() >= this.c)
    {
      bnzb.a("AEAlbumLinearLayout", "[collapsePreviewContainer], already collapsed");
      return;
    }
    this.e = 1;
    int i = this.c - getScrollY();
    int j = (int)(1.0F * i / this.c * 275.0F);
    bnzb.a("AEAlbumLinearLayout", "[collapsePreviewContainer], dy=" + i + ", duration=" + j);
    d();
  ...
  public void b()
  {
    bnzb.a("AEAlbumLinearLayout", "[expandPreviewContainer]");
    if (getScrollY() <= 0)
    {
      bnzb.a("AEAlbumLinearLayout", "[expandPreviewContainer], already expanded");
      return;
    }
    this.e = 2;
    int i = -getScrollY();
    int j = (int)(1.0F * getScrollY() / this.c * 275.0F);
    bnzb.a("AEAlbumLinearLayout", "[expandPreviewContainer], dy=" + i + ", duration=" + j);
    d();
  ...
  {
    bnzb.a("AEAlbumLinearLayout", "[getNestedScrollAxes]");
    return 2;
  }
  ...
  {
    bnzb.a("AEAlbumLinearLayout", "[onNestedFling], velocityX=" + paramFloat1 + ", velocityY=" + paramFloat2 + ", consumed=" + paramBoolean);
    return super.onNestedFling(paramView, paramFloat1, paramFloat2, paramBoolean);
  }
  
  public boolean onNestedPreFling(View paramView, float paramFloat1, float paramFloat2)
  {
    bnzb.a("AEAlbumLinearLayout", "[onNestedPreFling], velocityX=" + paramFloat1 + ", velocityY=" + paramFloat2);
  ...
  {
    bnzb.a("AEAlbumLinearLayout", "[onNestedPreScroll], dy=" + paramInt2 + ", scrollY=" + getScrollY());
    int i;
    ...
    for (paramInt1 = 1;; paramInt1 = 2)
    {
      ...
      {
        this.jdField_a_of_type_Bnev.a(this.d);
        this.jdField_a_of_type_Bnev.b(a());
      }
      return;
      paramInt1 = 0;
      break;
  ...
  {
    bnzb.a("AEAlbumLinearLayout", "[onNestedScroll], dxConsumed=" + paramInt1 + ", dyConsumed=" + paramInt2 + ", dxUnconsumed=" + paramInt3 + ", dyUnconsumed=" + paramInt4);
  ...
  {
    bnzb.a("AEAlbumLinearLayout", "[onNestedScrollAccepted], axes=" + paramInt);
    super.onNestedScrollAccepted(paramView1, paramView2, paramInt);
  }
  
  public boolean onStartNestedScroll(View paramView1, View paramView2, int paramInt)
  {
    bnzb.a("AEAlbumLinearLayout", "[onStartNestedScroll], nestedScrollAxes=" + paramInt);
    return (paramInt & 0x2) != 0;
  }
  
  public void onStopNestedScroll(View paramView)
  {
    bnzb.a("AEAlbumLinearLayout", "[onStopNestedScroll], scrollY=" + getScrollY());
    ...
    {
      if (this.jdField_a_of_type_Bnev != null) {
        this.jdField_a_of_type_Bnev.a(this.d, a(this.d));
      }
      this.d = 0;
      return;
  ...
  public void setScrollListener(@Nullable bnev parambnev)
  {
    this.jdField_a_of_type_Bnev = parambnev;
  }
}
