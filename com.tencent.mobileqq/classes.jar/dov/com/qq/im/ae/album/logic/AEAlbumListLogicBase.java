  ...
  implements AEAlbumListLogic.IalbumListAdapterCallBack
{
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = ((AEAbstractAlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getLayoutInflater().inflate(2131561095, null);
      localTextView = (TextView)localView;
      localQQAlbumInfo = localAEAlbumListAdapter.a(paramInt);
  ...
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (((AEAbstractAlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity() == null)) {
      return null;
    }
    Object localObject;
  ...
  public void a(int paramInt)
  {
    ...
    {
      LogTag.a();
      localList1 = localAEAlbumListAdapter.a(((AEAbstractAlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt);
    ...
    for (;;)
    {
      ...
      {
        LogTag.a();
        localList2 = localAEAlbumListAdapter.a(((AEAbstractAlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramInt, localMediaFileFilter);
      ...
      for (;;)
      {
        ...
        do
        {
          ...
          localAEAlbumListAdapter.b(localList1);
        } while (paramInt == -1);
        if (i != 0)
        {
  ...
  public void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_DovComQqImAeAlbumAdapterAEAlbumListAdapter = a();
      ((AEAbstractAlbumListFragment)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_DovComQqImAeAlbumAdapterAEAlbumListAdapter = this.jdField_a_of_type_DovComQqImAeAlbumAdapterAEAlbumListAdapter;
      ...
      break;
      label260:
      AEQLog.b("AEAlbumListLogicBase", "passed in albumId=" + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId + ", albumName=" + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName);
    }
  }
  ...
  {
    return this.jdField_a_of_type_DovComQqImAeAlbumAdapterAEAlbumListAdapter;
  }
 ...
 * Qualified Name:     dov.com.qq.im.ae.album.logic.AEAlbumListLogicBase
