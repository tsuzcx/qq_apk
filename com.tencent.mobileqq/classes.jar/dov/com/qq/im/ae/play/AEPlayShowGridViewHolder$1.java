  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    int k = ViewUtils.a(10.0F);
    int j = ViewUtils.a() - k * 2;
    ...
    for (;;)
    {
      ...
      if (QLog.isDevelopLevel()) {
        QLog.d("AEPlayShowGridViewHolder", 4, "one itemHeight " + i + " itemWidth: " + j + " screenWidth: " + ViewUtils.a() + " viewWidth: " + localViewGroup.getWidth() + " padding: " + k);
      }
