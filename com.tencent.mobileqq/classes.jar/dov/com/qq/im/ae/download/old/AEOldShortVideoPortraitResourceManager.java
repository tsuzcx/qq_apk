...
public class AEOldShortVideoPortraitResourceManager
{
  ...
  public static String a()
  {
    ...
    VideoEnvironment.LogDownLoad("AEOldShortVideoPortraitResourceManager", "getCurrentPendantUnzipPath success=" + bool + ",md5Version=" + str, null);
    if (bool) {
      return str;
    }
  ...
  static boolean a(com.tencent.mobileqq.app.QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    //   6: ldc 2
    //   8: monitorenter
    //   9: invokestatic 93	dov/com/qq/im/ae/download/old/AEOldShortVideoPortraitResourceManager:b	()Ljava/lang/String;
    //   12: astore_0
    ...
    //   28: getstatic 98	java/io/File:separator	Ljava/lang/String;
    ...
    //   41: dup
    //   42: aload_0
    //   43: invokespecial 101	java/io/File:<init>	(Ljava/lang/String;)V
    //   46: astore 7
    //   48: aload 7
    //   50: invokevirtual 104	java/io/File:exists	()Z
    //   53: ifeq +65 -> 118
    //   56: invokestatic 106	dov/com/qq/im/ae/download/old/AEOldShortVideoPortraitResourceManager:a	()Ljava/lang/String;
    //   59: aload_1
    //   60: invokevirtual 112	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   63: ifeq +26 -> 89
    //   66: aload_0
    //   67: ldc 114
    //   69: invokestatic 117	dov/com/qq/im/ae/download/old/AEOldPendantVersionManager:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   72: ifeq +17 -> 89
    //   75: ldc 46
    //   77: ldc 119
    //   79: aconst_null
    //   80: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   83: ldc 2
    //   85: monitorexit
    //   86: iload 4
    //   88: ireturn
    //   89: aload_0
    //   90: invokestatic 123	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;)V
    //   93: ldc 46
    ...
    //   114: aconst_null
    //   115: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   118: aload 7
    ...
    //   147: aconst_null
    //   148: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   151: aload_2
    //   152: aload_0
    //   153: iconst_0
    //   154: invokestatic 133	com/tencent/mobileqq/utils/FileUtils:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   157: aload_0
    //   158: ldc 114
    //   160: invokestatic 117	dov/com/qq/im/ae/download/old/AEOldPendantVersionManager:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   163: istore 4
    //   165: ldc 46
    ...
    //   187: aconst_null
    //   188: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   191: iload 4
    //   193: ifeq +155 -> 348
    //   196: aload_1
    //   197: invokestatic 138	dov/com/qq/im/ae/download/old/AEOldShortVideoPortraitResourceManager:a	(Ljava/lang/String;)Z
    //   200: istore 6
    //   202: ldc 46
    ...
    //   224: aconst_null
    //   225: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   228: iload 5
    //   230: istore 4
    //   232: iload 6
    //   234: ifne +97 -> 331
    //   237: aload_1
    //   238: invokestatic 138	dov/com/qq/im/ae/download/old/AEOldShortVideoPortraitResourceManager:a	(Ljava/lang/String;)Z
    //   241: istore 6
    //   243: ldc 46
    ...
    //   265: aconst_null
    //   266: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   269: iload 5
    //   271: istore 4
    //   273: iload 6
    //   275: ifne +56 -> 331
    ...
    //   280: ldc 144
    //   282: aconst_null
    //   283: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   286: ldc 33
    //   288: invokestatic 138	dov/com/qq/im/ae/download/old/AEOldShortVideoPortraitResourceManager:a	(Ljava/lang/String;)Z
    //   291: istore 4
    //   293: ldc 46
    ...
    //   324: aconst_null
    //   325: invokestatic 69	com/tencent/mobileqq/shortvideo/VideoEnvironment:LogDownLoad	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   328: iconst_1
    //   329: istore 4
    //   331: invokestatic 150	dov/com/qq/im/ae/download/old/AEOldShortVideoPortraitResourceManager:a	()V
    //   334: goto -251 -> 83
    //   337: astore_0
    //   338: aload_0
    //   339: invokevirtual 153	java/lang/Exception:printStackTrace	()V
    //   342: iconst_1
    //   343: istore 4
    //   345: goto -262 -> 83
    //   348: iconst_1
  ...
  private static boolean a(String paramString)
  {
    ...
    VideoEnvironment.LogDownLoad("AEOldShortVideoPortraitResourceManager", "storeNewPendantUnzipPath commitValue=" + bool + ",pathName=" + paramString, null);
    return bool;
  }
