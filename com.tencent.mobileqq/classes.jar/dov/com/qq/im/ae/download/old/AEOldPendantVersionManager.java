...
public class AEOldPendantVersionManager
{
  /* Error */
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkSignatureVersionIsOK signature=" + paramString, null);
    paramString = AEOldShortVideoSoManager.a(str);
    int i = paramString.a();
    VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkSignatureVersionIsOK errCode=" + i + ",trimSignature=" + str, null);
    if (i == 0)
    {
      paramString = paramString.a().trim();
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkSignatureVersionIsOK versionValid=" + paramString, null);
      i = Integer.parseInt(paramString);
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkSignatureVersionIsOK version=" + i + ",limitVersion=" + paramInt, null);
      if (i >= paramInt) {
        return true;
      }
    }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK configPath=" + paramString2, null);
    Object localObject = new File(paramString2);
    if (!((File)localObject).exists())
    {
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK configPath=" + paramString2 + ",exists=false", null);
      return false;
    }
    paramString2 = a((File)localObject);
    if (paramString2.size() <= 0)
    {
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK configData.size()=" + paramString2.size(), null);
      return false;
    }
    int i = 0;
    if (i < paramString2.size())
    {
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK itemLineValue=" + (String)paramString2.get(i), null);
      ...
      do
      {
        ...
        VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK trimValue=" + str, null);
        localObject = AEOldShortVideoSoManager.a(str);
        j = ((AEOldShortVideoSoManager.CfgParser)localObject).a('|');
        if (j != 0) {
          break label398;
        }
        str = paramString1 + ((AEOldShortVideoSoManager.CfgParser)localObject).b();
        File localFile = new File(str);
        if (!localFile.exists())
        {
          VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK[exists=false] fileName=" + str, null);
          return false;
        }
        j = Integer.parseInt(((AEOldShortVideoSoManager.CfgParser)localObject).c());
        l = localFile.length();
      } while (j == l);
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK sizeConfig=" + j + ",fileSize=" + l, null);
      return false;
      label398:
      VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK[CfgParser] errCode=" + j + ",trimValue=" + str, null);
      return false;
    }
    VideoEnvironment.LogDownLoad("AEOldPendantVersionManager", "checkUnzipFileListSizeIsOK[OK]", null);
    return true;
  }
}
 ...
 * Qualified Name:     dov.com.qq.im.ae.download.old.AEOldPendantVersionManager
