  ...
  implements View.OnLayoutChangeListener, View.OnTouchListener
{
  ...
  private CustomGestureDetector jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector;
  private OnGestureListener jdField_a_of_type_DovComQqImAeBizQcircleWidgetOnGestureListener = new PhotoViewAttacher.1(this);
  private PhotoViewAttacher.FlingRunnable jdField_a_of_type_DovComQqImAeBizQcircleWidgetPhotoViewAttacher$FlingRunnable;
  ...
  public PhotoViewAttacher(ImageView paramImageView)
  {
    ...
    this.i = 0.0F;
    this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector = new CustomGestureDetector(paramImageView.getContext(), this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetOnGestureListener);
  ...
  private void a(Drawable paramDrawable)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        switch (PhotoViewAttacher.4.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
        {
        default: 
          break;
        case 1: 
  ...
  private void d()
  {
    if (this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetPhotoViewAttacher$FlingRunnable != null)
    {
      this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetPhotoViewAttacher$FlingRunnable.a();
      this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetPhotoViewAttacher$FlingRunnable = null;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Boolean) && (!this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a()) && (!this.jdField_b_of_type_Boolean))
    {
      int m;
      ...
      for (int n = 1;; n = 0)
      {
        ...
        QLog.d("PhotoViewAttacher", 4, "isNeedToDisAllowInterceptEvent vertical solp false mAllowParentInterceptOnEdge:" + this.jdField_a_of_type_Boolean + " isScaling:" + this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a() + " mBlockParentIntercept:" + this.jdField_b_of_type_Boolean + " getScale:" + a() + " mHorizontalScrollEdge:" + this.jdField_d_of_type_Int + " mVerticalScrollEdge:" + this.jdField_e_of_type_Int + " dx:" + paramFloat1 + " dy:" + paramFloat2);
        return false;
        m = 0;
        break;
      }
      ...
      {
        QLog.d("PhotoViewAttacher", 4, "isNeedToDisAllowInterceptEvent horizontal solp false mAllowParentInterceptOnEdge:" + this.jdField_a_of_type_Boolean + " isScaling:" + this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a() + " mBlockParentIntercept:" + this.jdField_b_of_type_Boolean + " getScale:" + a() + " mHorizontalScrollEdge:" + this.jdField_d_of_type_Int + " mVerticalScrollEdge:" + this.jdField_e_of_type_Int + " dx:" + paramFloat1 + " dy:" + paramFloat2);
        return false;
      }
      ...
      {
        QLog.d("PhotoViewAttacher", 4, "isNeedToDisAllowInterceptEvent corner slop false mAllowParentInterceptOnEdge:" + this.jdField_a_of_type_Boolean + " isScaling:" + this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a() + " mBlockParentIntercept:" + this.jdField_b_of_type_Boolean + " getScale:" + a() + " mHorizontalScrollEdge:" + this.jdField_d_of_type_Int + " mVerticalScrollEdge:" + this.jdField_e_of_type_Int + " dx:" + paramFloat1 + " dy:" + paramFloat2);
        return false;
      }
    }
    else
    {
      QLog.d("PhotoViewAttacher", 4, "isNeedToDisAllowInterceptEvent true mAllowParentInterceptOnEdge:" + this.jdField_a_of_type_Boolean + " isScaling:" + this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a() + " mBlockParentIntercept:" + this.jdField_b_of_type_Boolean + " getScale:" + a() + " mHorizontalScrollEdge:" + this.jdField_d_of_type_Int + " mVerticalScrollEdge:" + this.jdField_e_of_type_Int + " dx:" + paramFloat1 + " dy:" + paramFloat2);
      return true;
    }
    QLog.d("PhotoViewAttacher", 4, "isNeedToDisAllowInterceptEvent default:true mAllowParentInterceptOnEdge:" + this.jdField_a_of_type_Boolean + " isScaling:" + this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a() + " mBlockParentIntercept:" + this.jdField_b_of_type_Boolean + " getScale:" + a() + " mHorizontalScrollEdge:" + this.jdField_d_of_type_Int + " mVerticalScrollEdge:" + this.jdField_e_of_type_Int + " dx:" + paramFloat1 + " dy:" + paramFloat2);
    return true;
  }
  ...
  {
    boolean bool3 = false;
    if ((this.jdField_c_of_type_Boolean) && (Util.a((ImageView)paramView)))
    {
      boolean bool1;
      label59:
      boolean bool5;
      ...
      default: 
        bool1 = false;
        if (this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector != null)
        {
          bool5 = this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a();
          bool6 = this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.b();
          bool4 = this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a(paramMotionEvent);
          if ((bool5) || (this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.a())) {
            break label611;
          }
          bool1 = true;
          label112:
          if ((bool6) || (this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetCustomGestureDetector.b())) {
            break label617;
          }
        }
        break;
 ...
 * Qualified Name:     dov.com.qq.im.ae.biz.qcircle.widget.PhotoViewAttacher
