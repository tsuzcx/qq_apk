...
class CustomGestureDetector
{
  ...
  private OnGestureListener jdField_a_of_type_DovComQqImAeBizQcircleWidgetOnGestureListener;
  ...
  CustomGestureDetector(Context paramContext, OnGestureListener paramOnGestureListener)
  {
    ...
    this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetOnGestureListener = paramOnGestureListener;
        ...
        if (this.jdField_a_of_type_AndroidViewVelocityTracker != null)
        {
          ...
          if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_AndroidViewVelocityTracker != null))
          {
            ...
            if (Math.max(Math.abs(f1), Math.abs(f2)) >= this.d) {
              this.jdField_a_of_type_DovComQqImAeBizQcircleWidgetOnGestureListener.a(this.jdField_a_of_type_Float, this.jdField_b_of_type_Float, -f1, -f2);
            }
          }
          if (this.jdField_a_of_type_AndroidViewVelocityTracker != null)
          {
 ...
 * Qualified Name:     dov.com.qq.im.ae.biz.qcircle.widget.CustomGestureDetector
