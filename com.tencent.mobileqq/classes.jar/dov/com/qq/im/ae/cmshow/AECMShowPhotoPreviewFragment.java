...
public class AECMShowPhotoPreviewFragment
  ...
  implements aeox, View.OnClickListener, bnrq
{
  ...
  private bnrp a(@NonNull List<PointF> paramList)
  {
    ...
    ((bnrp)localObject).a(localRectF);
    f1 = localPointF2.y;
    f2 = localPointF1.y;
    float f3 = localPointF2.x;
    float f4 = localPointF1.x;
    ((bnrp)localObject).a((float)Math.toDegrees(Math.atan2(f1 - f2, f3 - f4)));
    return localObject;
  }
  
  @NonNull
  private bolh<Boolean, List<PointF>> a(@Nullable Bitmap paramBitmap, @Nullable String paramString)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramBitmap == null))
    {
      bnrh.a("AECMShowPhotoPreviewFragment", "[detectFaceLocally] invalid data");
      return new bolh(Boolean.valueOf(false), null);
    }
    ...
    {
      bnrh.b("AECMShowPhotoPreviewFragment", "[detectFaceLocally] no face detected");
      return new bolh(Boolean.valueOf(false), null);
    }
    bnrh.b("AECMShowPhotoPreviewFragment", "[detectFaceLocally] face detected");
    return new bolh(Boolean.valueOf(true), FaceChangeUtils.transFromImageSpace2ContainerSpace(this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth(), this.jdField_a_of_type_AndroidGraphicsBitmap.getHeight(), this.jdField_a_of_type_AndroidWidgetRelativeLayout.getWidth(), this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight(), (List)paramBitmap.b));
  }
  
  private void a()
  {
    this.jdField_a_of_type_Int = bpdd.a(getActivity());
    this.jdField_b_of_type_Int = bpdd.b(getActivity());
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
      {
        ...
        if (((ViewTreeObserver)localObject).isAlive()) {
          ((ViewTreeObserver)localObject).addOnGlobalLayoutListener(new bnir(this));
        }
      }
    }
  }
  ...
  {
    aeow.a(paramActivity, paramIntent, PublicFragmentActivityForPeak.class, AECMShowPhotoPreviewFragment.class);
  }
  
  private void a(View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376867));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369487));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369358));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380139));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380064));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131366891));
    this.jdField_a_of_type_DovComQqImAeCmshowAECMShowLoadingView = ((AECMShowLoadingView)paramView.findViewById(2131364783));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131380660);
    this.jdField_a_of_type_DovComQqImAeViewAECMShowFaceScanView = ((AECMShowFaceScanView)paramView.findViewById(2131366392));
  ...
  public void F()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130837670);
    b();
  }
  ...
  {
    if (this.c == 2) {
      bnqm.a().a(1, System.currentTimeMillis() - this.jdField_a_of_type_Long);
    }
    getActivity().finish();
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_DovComQqImAeCmshowAECMShowRequestController = new AECMShowRequestController(2, new bniq(this));
    this.jdField_a_of_type_DovComQqImAeCmshowAECMShowRequestController.a();
  }
  
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131558501, paramViewGroup, false);
