  ...
  private void b(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_DovComQqImAeCameraFilterAEFilterProcessTex$CapturePhotoListener != null) {
        this.jdField_a_of_type_DovComQqImAeCameraFilterAEFilterProcessTex$CapturePhotoListener.onPhotoCaptured((Bitmap)localObject);
      }
      return;
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      while (this.jdField_a_of_type_DovComQqImAeCameraFilterAEFilterProcessTex$CapturePhotoListener == null) {}
 ...
 * Qualified Name:     dov.com.qq.im.ae.camera.filter.NonAEFilterProcess
