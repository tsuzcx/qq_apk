...
public abstract class FilterProcessBase
{
  ...
  {
    AEQLog.b("FilterProcessBase", "previewWidth: " + paramInt5 + " previewHeight: " + paramInt6);
  ...
  public void a(boolean paramBoolean, int paramInt, AEFilterProcessTex.CapturePhotoListener paramCapturePhotoListener)
  {
    ...
    this.l = paramInt;
    this.jdField_a_of_type_DovComQqImAeCameraFilterAEFilterProcessTex$CapturePhotoListener = paramCapturePhotoListener;
  }
 ...
 * Qualified Name:     dov.com.qq.im.ae.camera.filter.FilterProcessBase
