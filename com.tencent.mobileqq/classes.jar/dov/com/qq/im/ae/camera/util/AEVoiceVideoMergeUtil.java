  ...
  public static String a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      catch (IOException paramString1)
      {
        ...
        AEQLog.a("AEVoiceVideoMergeUtil", "Mixer Error 1 " + paramString1.toString(), paramString1);
        return null;
      ...
      {
        AEQLog.a("AEVoiceVideoMergeUtil", "Mixer Error 2 " + paramString1.toString(), paramString1);
        return null;
      }
      if (i != 0) {
        break label286;
 ...
 * Qualified Name:     dov.com.qq.im.ae.camera.util.AEVoiceVideoMergeUtil
