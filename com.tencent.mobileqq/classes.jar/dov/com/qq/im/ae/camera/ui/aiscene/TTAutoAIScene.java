  ...
  implements IAIScene
{
  ...
  private TTAutoAIScene.FaceResult a(Bitmap paramBitmap, ArrayList<IAIScene.FaceRect> paramArrayList)
  {
    ...
    while (i < paramArrayList.size())
    {
      ...
      localFaceResult.jdField_a_of_type_Double = (d2 / d1 + d3);
  ...
  private TTAutoAISceneType a(JSONArray paramJSONArray)
  {
    ...
    if (paramJSONArray.length() > 0)
    {
      ...
      if (i < paramJSONArray.length())
      {
        ...
        TTAutoAISceneType localTTAutoAISceneType = a((String)localObject3);
        double d6;
        double d5;
        if (localTTAutoAISceneType == null)
        {
          d6 = d3;
          d5 = d2;
          localObject2 = localObject1;
        ...
        for (;;)
        {
          ...
          d5 = d2;
          d6 = d3;
          if (localTTAutoAISceneType.jdField_b_of_type_Int != -1)
          {
            localObject3 = localObject1;
            double d1 = d2;
            if (localTTAutoAISceneType.jdField_a_of_type_Int == 3)
            {
              localObject3 = localObject1;
              d1 = d2;
              if (d4 > c.doubleValue())
              {
                ...
                {
                  d1 = d4;
                  localObject3 = localTTAutoAISceneType;
                }
              }
            }
            ...
            if (d4 > d3)
            {
              ...
              if (d1 <= 0.0D)
              {
                localObject2 = localTTAutoAISceneType;
                d5 = d1;
                d6 = d4;
              }
            }
  ...
  private JSONObject a()
  {
    ...
    try
    {
      JSONObject localJSONObject2 = new JSONObject(FileUtils.d("video_story_aiSceneParams.json"));
  ...
  private JSONObject b(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("token", b(paramString));
      paramString = HttpUtil.a("https://tu.qq.com/cgi-bin/qq/do_image_classify.fcg", localJSONObject2.toString());
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public void a(Bitmap paramBitmap, ArrayList<IAIScene.FaceRect> paramArrayList, IAIScene.GetImageSceneCB paramGetImageSceneCB)
  {
    ...
    if (paramArrayList.jdField_a_of_type_Boolean) {
      if (paramArrayList.b) {
        paramBitmap = a(HardCodeUtil.a(2131715686));
      }
    }
    while (paramBitmap == null)
    {
      ...
      if ((paramBitmap != null) && (paramBitmap.has("retcode")) && (paramBitmap.optInt("retcode") == 0))
      {
        ...
        if (i <= 5) {
          paramBitmap = a(HardCodeUtil.a(2131715689));
        } else if (j < 50) {
          paramBitmap = a(HardCodeUtil.a(2131715687));
        } else {
          paramBitmap = a(HardCodeUtil.a(2131715684));
        }
      }
      else
      {
        paramBitmap = a(HardCodeUtil.a(2131715688));
        continue;
 ...
 * Qualified Name:     dov.com.qq.im.ae.camera.ui.aiscene.TTAutoAIScene
