  ...
  extends RelativeLayout
{
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((Math.abs(this.jdField_a_of_type_AndroidViewVelocityTracker.getXVelocity()) > 100.0F) && (paramMotionEvent.getEventTime() - paramMotionEvent.getDownTime() < 100L) && (bpaf.a(this.jdField_a_of_type_AndroidViewView, paramMotionEvent)) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  protected void onAttachedToWindow()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131366821);
    this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollView = ((AEBottomListScrollView)findViewById(2131376988));
  }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    if (this.b)
    {
      bpam.a("AECircleBottomLayout", "in onInterceptTouchEvent true.");
