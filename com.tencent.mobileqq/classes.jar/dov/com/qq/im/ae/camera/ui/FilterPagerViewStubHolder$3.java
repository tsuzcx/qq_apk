...
public class FilterPagerViewStubHolder$3
  implements Runnable
{
  public FilterPagerViewStubHolder$3(bikb parambikb, boolean paramBoolean) {}
  
  public void run()
  {
    Object localObject = ((bjbk)bjae.a(5)).a;
    VideoFilterViewPager localVideoFilterViewPager = bikb.a(this.this$0);
    if ((localVideoFilterViewPager != null) && (localObject != null))
    {
      ...
      if (!this.a) {
        bikb.a(this.this$0).a(0);
      }
    }
    while (!QLog.isColorLevel())
    {
      return;
      bikb.a(this.this$0).a();
      return;
    }
