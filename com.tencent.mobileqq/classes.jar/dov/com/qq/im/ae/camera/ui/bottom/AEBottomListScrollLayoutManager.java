...
import dov.com.qq.im.ae.camera.ui.Direction.End;
import dov.com.qq.im.ae.camera.ui.Direction.Start;
  ...
  extends RecyclerView.LayoutManager
{
  ...
  @NonNull
  private final AEBottomListScrollLayoutManager.ScrollStateListener jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollLayoutManager$ScrollStateListener;
  private AEBottomListScrollView.LayoutCallback jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollView$LayoutCallback;
  private DSVOrientation.Helper jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper;
  protected boolean a;
  protected int b;
  protected Point b;
  private boolean b;
  ...
  public AEBottomListScrollLayoutManager(@NonNull Context paramContext, @NonNull AEBottomListScrollLayoutManager.ScrollStateListener paramScrollStateListener, @NonNull DSVOrientation paramDSVOrientation)
  {
    ...
    this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollLayoutManager$ScrollStateListener = paramScrollStateListener;
    this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper = paramDSVOrientation.a();
  ...
  {
    return Math.min(Math.max(-1.0F, this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a(this.jdField_b_of_type_AndroidGraphicsPoint, getDecoratedLeft(paramView) + this.jdField_a_of_type_Int, getDecoratedTop(paramView) + this.jdField_b_of_type_Int) / paramInt), 1.0F);
  }
  
  private int a(int paramInt)
  {
    int i2 = this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy.b();
    int i1;
  ...
  private void a(RecyclerView.Recycler paramRecycler, Direction paramDirection, int paramInt)
  {
    ...
    int i1;
    int i2;
    if ((this.i == -1) || (!paramDirection.a(this.i - this.h)))
    {
      i1 = 1;
      ...
      this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a(paramDirection, this.d, this.jdField_a_of_type_AndroidGraphicsPoint);
  ...
  private boolean a()
  {
    ...
    if (b())
    {
      ...
      for (;;)
      {
        f(i2);
        return false;
        i1 = this.h + localDirection.a(i3 + 1);
        break;
        label133:
        i2 = i1;
  ...
  {
    return this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a(paramPoint, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, paramInt, this.jdField_c_of_type_Int);
  }
  ...
  private void f()
  {
    ...
    for (float f1 = Math.abs(this.f + this.g);; f1 = this.d)
    {
      ...
      this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollLayoutManager$ScrollStateListener.a(f1);
      return;
    }
  }
  ...
  private void f(int paramInt)
  {
    ...
    int i2 = this.d;
    int i3 = this.g;
    this.g = (localDirection.a(i1 * i2) + i3);
    this.i = paramInt;
    e();
  }
  ...
  public int a()
  {
    ...
    return this.h + Direction.a(this.f).a(1);
  }
  ...
  protected int a(int paramInt, RecyclerView.Recycler paramRecycler)
  {
    ...
    this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a(-paramInt, this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy);
    if (this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a(this)) {
      b(paramRecycler);
    }
    f();
    b();
  ...
  {
    int i1 = 1;
    int i2 = this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.c(paramInt1, paramInt2);
    if (this.f * i2 >= 0) {}
    ...
    label178:
    for (paramInt1 = i1 + localDirection.a(i4);; paramInt1 = i1 + localDirection.a(i4 + 1))
    {
      paramInt1 = a(Direction.a(i2).a(paramInt2) + paramInt1);
      if (!a(paramInt1)) {
        break;
      }
      f(paramInt1);
  ...
  protected void a(RecyclerView.Recycler paramRecycler)
  {
    ...
    this.d = this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.b(i1, i2);
  ...
  public void a(RecyclerView.State paramState)
  {
    ...
    {
      this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollLayoutManager$ScrollStateListener.c();
    ...
    do
    {
      ...
      this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollLayoutManager$ScrollStateListener.d();
      this.jdField_b_of_type_Boolean = false;
    } while (this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollView$LayoutCallback == null);
    this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollView$LayoutCallback.i();
  }
  ...
  {
    this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollView$LayoutCallback = paramLayoutCallback;
  }
  ...
  public View b()
  {
    return this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy.a(this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy.a() - 1);
  }
  ...
  {
    a();
    this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a(this.jdField_b_of_type_AndroidGraphicsPoint, this.f, this.jdField_c_of_type_AndroidGraphicsPoint);
    int i1 = this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a(this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy.c(), this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy.d());
  ...
  {
    return this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.b();
  }
  
  public boolean canScrollVertically()
  {
    return this.jdField_a_of_type_DovComQqImAeCameraUiBottomDSVOrientation$Helper.a();
  }
  ...
  public void onAdapterChanged(RecyclerView.Adapter paramAdapter1, RecyclerView.Adapter paramAdapter2)
  {
    ...
    for (this.h = ((AEBottomListScrollLayoutManager.InitialPositionProvider)paramAdapter2).a();; this.h = 0)
    {
      this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy.b();
      return;
    }
  ...
  public void onItemsAdded(RecyclerView paramRecyclerView, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (this.h >= paramInt1) {
        i1 = Math.min(this.h + paramInt2, this.jdField_a_of_type_ComTencentBizVideostoryCaptureWidgetsRecyclerViewProxy.b() - 1);
      }
    }
  }
  ...
  public void onScrollStateChanged(int paramInt)
  {
    if ((this.e == 0) && (this.e != paramInt)) {
      this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollLayoutManager$ScrollStateListener.a();
    }
    if (paramInt == 0) {
      if (a()) {
        this.jdField_a_of_type_DovComQqImAeCameraUiBottomAEBottomListScrollLayoutManager$ScrollStateListener.b();
      }
    }
    for (;;)
    {
 ...
 * Qualified Name:     dov.com.qq.im.ae.camera.ui.bottom.AEBottomListScrollLayoutManager
