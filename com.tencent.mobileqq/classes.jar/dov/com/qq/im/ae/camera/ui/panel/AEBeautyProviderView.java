  ...
  extends FrameLayout
{
  ...
  private SeekBar.OnSeekBarChangeListener jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new binm(this);
  ...
  private SeekBar.OnSeekBarChangeListener jdField_b_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new binn(this);
  ...
  public static int a()
  {
    ...
    str = "ae_beauty_level_" + str + "_CAMERA_ID_" + ahua.jdField_a_of_type_Int;
    int i = 55;
  ...
  {
    return new bbkk(Float.valueOf(paramFloat1), Float.valueOf(paramFloat2), new bino(this, paramAEProviderContainerView, paramView));
  }
  ...
  public static int b()
  {
    ...
    if ((TextUtils.isEmpty(str2)) || ("0".equals(str2)))
    {
      ...
      str1 = "ae_sharp_face_level_" + str1 + "_CAMERA_ID_" + ahua.jdField_a_of_type_Int;
      if (ahua.jdField_a_of_type_Int != 2) {
        break label142;
      }
      i = 0;
  ...
  private void b(int paramInt)
  {
    ...
    if ((TextUtils.isEmpty(str2)) || ("0".equals(str2)))
    {
      ...
      str1 = "ae_sharp_face_level_" + str3 + "_CAMERA_ID_" + ahua.jdField_a_of_type_Int;
    }
    label172:
    for (;;)
    {
      bizj.a().a(str1, paramInt, 0);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131562447, this, true);
    ...
    this.c = this.jdField_a_of_type_AndroidViewView.findViewById(2131363128);
    if (!avtc.d()) {
      this.c.setVisibility(8);
    }
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131363136));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363129));
    c();
    this.d = this.jdField_a_of_type_AndroidViewView.findViewById(2131376057);
    this.jdField_b_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131376059));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376058));
    d();
  }
  ...
  public void b()
  {
    ...
    do
    {
      return;
      i = c();
    } while (this.jdField_a_of_type_Biju == null);
  ...
  public void setController(biju parambiju)
  {
