  ...
  implements Runnable
{
  ...
  public void run()
  {
    QLog.d(GIFCreator.b(), 4, "gif encode loop");
    try
    {
      GIFCreator.b(this.this$0).a(320, 320, GIFCreator.a(this.this$0));
      GIFCreator.b(this.this$0).a(false);
      long l = System.currentTimeMillis();
      Object localObject1 = GIFCreator.d(this.this$0).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          QLog.d(GIFCreator.b(), 4, "gif encode frame start");
          GIFCreator.b(this.this$0).a((Bitmap)localObject3, 55);
          QLog.d(GIFCreator.b(), 4, "gif encode frame end");
          ((Bitmap)localObject3).recycle();
        }
        else
        {
          QLog.d(GIFCreator.b(), 4, new Object[] { "gif encode frame but bitmap == null, png path = ", localObject2 });
          i = 0;
          break label175;
        }
      }
      int i = 1;
      label175:
      GIFCreator.b(this.this$0).a();
      localObject1 = GIFCreator.b();
      ...
      FileUtil.e(GIFCreator.e(this.this$0));
      l = System.currentTimeMillis();
      int j = GifUtil.compressGif(GIFCreator.a(this.this$0), GIFCreator.e(this.this$0), 30);
      localObject1 = GIFCreator.b();
      localObject2 = new StringBuilder();
      ...
      FileUtil.e(GIFCreator.a(this.this$0));
      QLog.d(GIFCreator.b(), 4, new Object[] { "gif create success, gif path = ", GIFCreator.e(this.this$0) });
      localObject1 = this.a;
      if (localObject1 != null) {
        if (i != 0) {
          ((GIFCreator.Callback)localObject1).onGifCreateSuccess(GIFCreator.e(this.this$0));
        } else {
          ((GIFCreator.Callback)localObject1).onGifCreateFail();
        }
      }
      GIFCreator.c(this.this$0).getLooper().quit();
      return;
    }
    catch (FileNotFoundException localFileNotFoundException)
    {
      Object localObject2 = GIFCreator.b();
