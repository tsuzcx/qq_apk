  ...
  extends RecyclerView.Adapter<AEGIFTextColorAdapter.TextEditColorViewHolder>
{
  ...
  public AEGIFTextColorAdapter.TextEditColorViewHolder a(@NonNull ViewGroup paramViewGroup, int paramInt)
  {
    ...
    return new AEGIFTextColorAdapter.TextEditColorViewHolder(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558616, paramViewGroup, false));
  }
  ...
  public void a(@NonNull AEGIFTextColorAdapter.TextEditColorViewHolder paramTextEditColorViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      EventCollector.getInstance().onRecyclerBindViewHolder(paramTextEditColorViewHolder, paramInt, getItemId(paramInt));
      return;
 ...
 * Qualified Name:     dov.com.qq.im.ae.gif.giftext.adapter.AEGIFTextColorAdapter
