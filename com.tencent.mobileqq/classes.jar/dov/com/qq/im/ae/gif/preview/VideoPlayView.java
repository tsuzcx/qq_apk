  ...
  extends GLSurfaceView
{
  ...
  private final VideoPlayerRenderer jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer;
  ...
  public VideoPlayView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer = new VideoPlayerRenderer(this);
    setRenderer(this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer);
    setRenderMode(0);
  }
  ...
  public VideoPlayView a(MediaPlayer paramMediaPlayer)
  {
    ...
    this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer.a(paramMediaPlayer);
    return this;
  }
  ...
  {
    if (this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer != null) {
      this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer.a(paramFrameRenderCallback);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer != null) {
      this.jdField_a_of_type_DovComQqImAeGifPreviewVideoPlayerRenderer.a(paramBoolean);
    }
  }
}
