package dov.com.qq.im.ae.gif.filter;
...
public class GifFilterProcess
{
  ...
  private GifFilterProcess.TextConfig jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig;
  private PreMultiplyFilter jdField_a_of_type_DovComQqImAeGifFilterPreMultiplyFilter = new PreMultiplyFilter();
  ...
  public Frame a(Frame paramFrame, int paramInt1, int paramInt2, PTFaceAttr paramPTFaceAttr)
  {
    ...
    for (;;)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig != null))
      {
        GLES20.glEnable(3042);
        GLES20.glBlendFunc(770, 771);
        float f1 = -1.0F + this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.jdField_a_of_type_Float * 2.0F;
        float f2 = -1.0F + this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.b * 2.0F;
        float f3 = this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.c * 2.0F + f1;
        float f4 = this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.d * 2.0F + f2;
        this.jdField_a_of_type_ComTencentFilterBaseFilter.setPositions(new float[] { f1, f2, f1, f4, f3, f4, f3, f2 });
        this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.jdField_a_of_type_Int, paramFrame.width, paramFrame.height, -1, 0.0D, paramFrame);
      ...
      paramFrame = this.jdField_a_of_type_DovComQqImAeGifFilterPreMultiplyFilter.RenderProcess(this.jdField_b_of_type_ComTencentAekitOpenrenderInternalFrame.getTextureId(), 320, 320);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_DovComQqImAeGifFilterPreMultiplyFilter.apply();
  ...
  {
    if (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterLightNode != null) {
      this.jdField_a_of_type_JavaLangString = (paramString + File.separator + "template.json");
    }
  }
  ...
  {
    this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig = new GifFilterProcess.TextConfig(this);
    AEGIFTextDrawer localAEGIFTextDrawer = new AEGIFTextDrawer((int)(320.0F * paramFloat3), (int)(320.0F * paramFloat4));
    ...
    this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.jdField_a_of_type_Int = RendererUtils.createTexture(paramString1);
    localAEGIFTextDrawer.b();
    this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.jdField_a_of_type_Float = paramFloat1;
    this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.b = paramFloat2;
    this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.c = paramFloat3;
    this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.d = paramFloat4;
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_DovComQqImAeGifFilterPreMultiplyFilter.clearGLSL();
    ...
    if (this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig != null)
    {
      int[] arrayOfInt = new int[1];
      arrayOfInt[0] = this.jdField_a_of_type_DovComQqImAeGifFilterGifFilterProcess$TextConfig.jdField_a_of_type_Int;
 ...
 * Qualified Name:     dov.com.qq.im.ae.gif.filter.GifFilterProcess
