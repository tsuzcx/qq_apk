  ...
  public CharSequence filter(CharSequence paramCharSequence, int paramInt1, int paramInt2, Spanned paramSpanned, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      if ((paramInt1 <= this.jdField_a_of_type_Int) && (paramInt2 < paramSpanned.length()))
      {
        ...
        paramInt1 += AEGIFTextEditFragment.a(this.jdField_a_of_type_DovComQqImAeGifGiftextFragmentAEGIFTextEditFragment, c);
        paramInt2 += 1;
      }
      else
      {
        ...
        while ((paramInt2 <= this.jdField_a_of_type_Int) && (paramInt1 < paramCharSequence.length()))
        {
          ...
          paramInt2 = AEGIFTextEditFragment.a(this.jdField_a_of_type_DovComQqImAeGifGiftextFragmentAEGIFTextEditFragment, c) + paramInt2;
          paramInt1 += 1;
        }
        paramInt3 = paramInt1;
 ...
 * Qualified Name:     dov.com.qq.im.ae.gif.giftext.fragment.AEGIFTextEditFragment.LengthInputFilter
