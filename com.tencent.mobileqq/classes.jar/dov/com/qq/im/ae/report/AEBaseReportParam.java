...
import dov.com.qq.im.ae.camera.ui.dashboard.AEDashboardUtil.ResolutionInfo;
...
public class AEBaseReportParam
{
  ...
  private AEEditReportData jdField_a_of_type_DovComQqImAeReportAEEditReportData = new AEEditReportData();
  ...
  private HashMap<String, String> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      QLog.d("AEBaseReportParam", 1, "getPostBtnParam---editJsonStr=" + paramString1);
  ...
  {
    return this.jdField_a_of_type_DovComQqImAeReportAEEditReportData;
  }
  ...
  public HashMap<String, String> a(int paramInt)
  {
    ...
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_Long));
    localHashMap.put("MD5", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_JavaLangString);
    Object localObject2 = (String)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    Object localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = "none";
    }
    localHashMap.put("filter_id", localObject1);
    localObject1 = (Float)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    if (localObject1 == null)
    {
      localObject1 = "none";
      localHashMap.put("filter_value", localObject1);
      localObject2 = (String)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
      localObject1 = localObject2;
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = "none";
      }
      localHashMap.put("color_type", localObject1);
      localObject2 = (String)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_c_of_type_AndroidUtilSparseArray.get(paramInt);
      localObject1 = localObject2;
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = "none";
      }
      localHashMap.put("ai_color_frame_states", localObject1);
      localObject2 = (String)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
      localObject1 = localObject2;
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = "none";
      }
      ...
      localHashMap.put("video_id", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_JavaLangString);
      localObject2 = (Integer)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_c_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
      localObject1 = localObject2;
    ...
    label365:
    for (localObject1 = "none";; localObject1 = ((AEMaterialMetaData)localObject1).jdField_a_of_type_JavaLangString)
    {
  ...
  public HashMap<String, String> a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.jdField_h_of_type_JavaLangString == null) || (!this.jdField_h_of_type_JavaLangString.equals(paramString)))
      {
        ...
        this.jdField_i_of_type_JavaLangString = MD5Utils.toMD5(QQStoryContext.a().getAccount() + AEBaseDataUtil.a());
      }
  ...
  public void a()
  {
    ...
    AEQLog.b("AEBaseReportParam", "【operation_time】:" + str);
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("content_type", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_Long + "");
    localHashMap.put("MD5", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_JavaLangString);
    localHashMap.put("pic_count", paramInt + "");
    if (jdField_g_of_type_JavaLangLong.equals(Long.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_Long)))
    {
      localHashMap.put("video_num", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_f_of_type_Int + "");
      localHashMap.put("video_duration", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_c_of_type_Long + "");
    }
    return localHashMap;
  }
  ...
  public HashMap<String, String> b(long paramLong)
  {
    ...
    label610:
    label624:
    for (Object localObject = "none";; localObject = ((AEMaterialMetaData)localObject).jdField_a_of_type_JavaLangString)
    {
  ...
  {
    AEQLog.a("AEBaseReportParam", "EditJson--HasGraffiti=" + paramBoolean);
    if (paramBoolean)
    {
      this.jdField_a_of_type_JavaUtilMap.put("graffiti", "1");
      return;
    }
  ...
  {
    AEQLog.a("AEBaseReportParam", "EditJson--HasCut=" + paramBoolean);
    if (paramBoolean)
    {
  ...
  {
    AEQLog.a("AEBaseReportParam", "EditJson--speedChanged=" + paramBoolean);
    if (paramBoolean)
    {
  ...
  {
    AEQLog.a("AEBaseReportParam", "EditJson--sticker=" + paramString);
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  {
    AEQLog.a("AEBaseReportParam", "EditJson--text=" + paramString);
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  {
    AEQLog.a("AEBaseReportParam", "EditJson--music=" + paramString);
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  public HashMap<String, String> i()
  {
    ...
    for (String str = MD5Utils.toMD5(QQStoryContext.a().getAccount() + AEBaseDataUtil.a());; str = this.jdField_i_of_type_JavaLangString) {
      return a(str, 1, "-1");
    }
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_Long));
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_Long));
    localHashMap.put("MD5", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_JavaLangString);
    String str = this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_d_of_type_JavaLangString;
    Object localObject = str;
    if (TextUtils.isEmpty(str)) {
      localObject = "none";
    }
    localHashMap.put("filter_id", localObject);
    localHashMap.put("filter_value", String.valueOf((int)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_Float));
    localHashMap.put("music_id", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_e_of_type_JavaLangString);
    str = (String)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_AndroidUtilSparseArray.get(0);
    localObject = str;
    if (TextUtils.isEmpty(str)) {
      localObject = "none";
    }
    localHashMap.put("color_type", localObject);
    str = (String)this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_AndroidUtilSparseArray.get(0);
    localObject = str;
    if (TextUtils.isEmpty(str)) {
      localObject = "none";
    }
    localHashMap.put("text_item_id", localObject);
    localHashMap.put("sound_type", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_Int));
    localHashMap.put("text_count", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_d_of_type_Int));
    localHashMap.put("music_list", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_g_of_type_JavaLangString);
    localHashMap.put("video_id", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_JavaLangString);
    localHashMap.put("music_common_info", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_f_of_type_JavaLangString);
    localHashMap.put("lyric_status", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_g_of_type_Int));
    if (this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_Boolean)
    {
      localObject = "1";
      localHashMap.put("is_recommend", localObject);
      localHashMap.put("recommend_index", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_Int));
      localHashMap.put("music_duration", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_c_of_type_Int));
      localHashMap.put("video_duration", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_Long));
      localHashMap.put("video_source", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_e_of_type_Int));
      localHashMap.put("face_id", this.jdField_c_of_type_JavaLangString);
      localHashMap.put("change_speed_type", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_a_of_type_Double));
      localObject = AEMaterialManager.b();
      if (localObject != null) {
        break label442;
      }
    ...
    label442:
    for (localObject = "none";; localObject = ((AEMaterialMetaData)localObject).jdField_a_of_type_JavaLangString)
    {
      localHashMap.put("watermark_id", localObject);
      return localHashMap;
      localObject = "0";
  ...
  public void k()
  {
    ...
    localStringBuilder.append(" ");
    localStringBuilder.append(str);
    this.n = MD5.a(localStringBuilder.toString());
  }
  ...
  public HashMap<String, String> l()
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_b_of_type_Long));
    localHashMap.put("red_point", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_i_of_type_Int));
    return localHashMap;
  }
  ...
  public HashMap<String, String> n(@NonNull String paramString)
  {
    HashMap localHashMap = new HashMap();
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("color_type", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_h_of_type_JavaLangString);
    localHashMap.put("text_item_id", this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_i_of_type_JavaLangString);
    localHashMap.put("common_color_list", String.valueOf(this.jdField_a_of_type_DovComQqImAeReportAEEditReportData.jdField_h_of_type_Int));
    return localHashMap;
  }
 ...
 * Qualified Name:     dov.com.qq.im.ae.report.AEBaseReportParam
