  ...
  public static void a(String paramString)
  {
    try
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (b(paramString)))
      {
        ...
        StatisticCollector.a(MobileQQ.sMobileQQ).a(str, paramString, false, 0L, 0L, localHashMap, null);
      }
      return;
    }
  ...
  public static void a(String paramString, int paramInt)
  {
    try
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (a(paramString)))
      {
        ...
        StatisticCollector.a(MobileQQ.sMobileQQ).a(str, paramString, true, 0L, 0L, localHashMap, null);
      }
      return;
    }
    catch (Throwable paramString)
 ...
 * Qualified Name:     dov.com.qq.im.poi.LbsPackStatsCollector
