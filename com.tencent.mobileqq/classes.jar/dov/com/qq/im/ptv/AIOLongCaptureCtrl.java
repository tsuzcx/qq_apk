  ...
  implements View.OnTouchListener
{
  ...
  public AIOLongCaptureCtrl(bhxa parambhxa)
  {
    this.jdField_a_of_type_Bhxa = parambhxa;
  ...
  private boolean b()
  {
    ...
    {
      return false;
      if (!this.jdField_a_of_type_Bhxa.a()) {
        return true;
      }
      int[] arrayOfInt = bjeh.a(this.jdField_a_of_type_Bhxa.a());
  ...
  private void c(Bundle paramBundle)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaRichmediaService != null) && (!this.jdField_a_of_type_ComTencentMobileqqRichmediaRichmediaService.a(251, -1, paramBundle)))
    {
      ...
      this.jdField_a_of_type_Bhxa.a().sendBroadcast(localIntent);
    }
  }
  ...
  private void e()
  {
    ...
    for (;;)
    {
      localBundle.putParcelable("PhotoConst.SEND_SESSION_INFO", this.jdField_a_of_type_Bhxa.a());
      ...
      bhyr.a(this.jdField_a_of_type_Bhxa.a(), this.jdField_a_of_type_Bhxa.a(), localBundle, 20101);
      if (QLog.isColorLevel()) {
