  ...
  extends LightWeightCaptureButtonLayout
{
  ...
  private void a(float paramFloat)
  {
    if (!this.jdField_a_of_type_Bjqb.i)
    {
      ...
      float f = this.jdField_a_of_type_Bjqb.jdField_f_of_type_Int;
      this.c.setTranslationX(f - paramFloat);
      if (AppSetting.d) {
        bawi.a(this.jdField_a_of_type_DovComQqImPtvBaseButton, ajyc.a(2131706077));
      }
      return;
    }
    s();
  ...
  {
    if (!this.jdField_a_of_type_Bjqb.h)
    {
      this.jdField_a_of_type_Bjqb.h = true;
      float f = this.jdField_a_of_type_Bjqb.jdField_e_of_type_Int;
      this.b.setTranslationX(-(f - paramFloat));
      if (AppSetting.d) {
        bawi.a(this.jdField_a_of_type_DovComQqImPtvBaseButton, ajyc.a(2131706092));
      }
      return;
    }
    r();
  ...
  private void o()
  {
    ...
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setImageWidth(blbz.a(32.0F));
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setImageHeight(blbz.a(32.0F));
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setImageResource(2130843629);
    i = getResources().getColor(2131165228);
    this.b.setBackgroundColor(-1);
    this.b.setImageWidth(blbz.a(30.0F));
    this.b.setImageHeight(blbz.a(30.0F));
    this.b.setImageResource(2130843618);
    this.b.setShadowColor(i);
    this.c.setBackgroundColor(-1);
    this.c.setShadowColor(i);
    this.c.setImageWidth(blbz.a(30.0F));
    this.c.setImageHeight(blbz.a(30.0F));
    this.c.setImageResource(2130843635);
  }
  
  private void p()
  {
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setShadowStrokeMaxWidth(blbz.a(10.0F));
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setShadowStrokeWidth(blbz.a(10.0F));
  }
  
  private void q()
  {
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setShadowStrokeMaxWidth(blbz.a(30.0F));
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setShadowStrokeWidth(blbz.a(2.0F));
  }
  ...
  private void u()
  {
    ...
    localAnimatorSet.addListener(new bjpj(this));
    ...
    localObjectAnimator1.setDuration(100L);
    localObjectAnimator1.start();
    localObjectAnimator1.addListener(new bjpk(this));
    localObjectAnimator1 = ObjectAnimator.ofFloat(this.jdField_a_of_type_DovComQqImPtvBaseButton, "translationX", new float[] { this.jdField_a_of_type_DovComQqImPtvBaseButton.getTranslationX(), this.jdField_a_of_type_Bjqb.jdField_g_of_type_Float });
    localObjectAnimator1.setDuration(100L);
    localObjectAnimator1.start();
  }
  ...
  private void w()
  {
    ...
    ((AnimatorSet)localObject1).addListener(new bjpl(this));
    ((AnimatorSet)localObject1).start();
    this.b.setImageResource(2130843616);
    ...
    ((AnimatorSet)localObject1).addListener(new bjpm(this));
    ((AnimatorSet)localObject1).start();
    ...
    ((ObjectAnimator)localObject1).addListener(new bjpn(this));
  ...
  {
    super.a();
    this.jdField_e_of_type_Int = blbz.a(5.0F);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131375010));
    o();
    axlw.a(this.jdField_a_of_type_DovComQqImPtvBaseButton, 0.0F, 0.0F, this.jdField_e_of_type_Int, 0.0F, 400, 0.0F, 1.0F);
    axlw.a(this.jdField_a_of_type_AndroidWidgetTextView, 0.0F, 0.0F, this.jdField_e_of_type_Int, 0.0F, 400, 0.0F, 1.0F);
  }
  ...
  protected void a(bjqc parambjqc, SimpleEffectsCaptureView paramSimpleEffectsCaptureView, LightWeightProgress paramLightWeightProgress)
  {
    ...
    axlw.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewSimpleEffectsCaptureView, 0.0F, 0.0F, this.jdField_e_of_type_Int, 0.0F, 400, 0.0F, 1.0F);
    axlw.a(this.jdField_a_of_type_DovComQqImPtvLightWeightProgress, 0.0F, 0.0F, this.jdField_e_of_type_Int, 0.0F, 400, 0.0F, 1.0F);
  }
  ...
  protected void a(LWMotionEvent paramLWMotionEvent)
  {
    ...
    localLayoutParams.bottomMargin = blbz.a(2.5F);
  ...
  protected void b()
  {
    ...
    localLayoutParams.width = i;
    localLayoutParams.height = i;
    localLayoutParams.bottomMargin = blbz.a(32.0F);
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setLayoutParams(localLayoutParams);
    o();
    axlw.a(this.jdField_a_of_type_DovComQqImPtvBaseButton, 0.0F, 0.0F, 0.0F, 0.0F, 100, 0.0F, 1.0F);
    if (this.jdField_a_of_type_Bjqd != null) {
      this.jdField_a_of_type_Bjqd.j();
    }
  }
  ...
  protected void b(LWMotionEvent paramLWMotionEvent)
  {
    if (this.jdField_g_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_Bjqb.jdField_c_of_type_Boolean = true;
        return;
      }
      this.jdField_g_of_type_Boolean = false;
      if (this.jdField_a_of_type_Bjqb.jdField_c_of_type_Boolean)
      {
        super.a(paramLWMotionEvent);
        return;
      }
  ...
  {
    float f2;
    if ((!this.jdField_a_of_type_Bjqb.jdField_a_of_type_Boolean) && (Math.abs(this.jdField_a_of_type_Bjqb.jdField_e_of_type_Float) > bjqb.jdField_a_of_type_Int))
    {
      this.jdField_a_of_type_Bjqb.jdField_a_of_type_Boolean = true;
      if (this.jdField_a_of_type_Bjqb.jdField_e_of_type_Float > 0.0F)
      {
        ...
        this.jdField_a_of_type_Bjqb.jdField_e_of_type_Int = b();
    ...
    else if (this.jdField_a_of_type_Bjqb.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_DovComQqImPtvBaseButton.setTranslationX(this.jdField_a_of_type_DovComQqImPtvBaseButton.getTranslationX() + this.jdField_a_of_type_Bjqb.jdField_e_of_type_Float);
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            break;
            if (f1 > bjqb.jdField_b_of_type_Int)
            {
              this.b.setImageResource(2130843616);
              this.jdField_a_of_type_Bjqb.d = 1;
              return;
            }
          } while ((f1 >= 0.0F) || (f2 <= bjqb.jdField_b_of_type_Int));
          this.jdField_a_of_type_Bjqb.jdField_b_of_type_Boolean = false;
          this.c.setImageResource(2130843634);
          this.jdField_a_of_type_Bjqb.d = 1;
          return;
          if (f1 > bjqb.jdField_c_of_type_Int)
          {
            this.jdField_a_of_type_Bjqb.d = 2;
            return;
          }
        } while (f1 > bjqb.jdField_b_of_type_Int);
        this.jdField_a_of_type_Bjqb.d = 0;
        this.b.setImageResource(2130843618);
        this.jdField_a_of_type_Bjqb.jdField_f_of_type_Boolean = true;
        return;
        k();
        this.jdField_a_of_type_Bjqb.h = false;
        return;
        ...
        f3 = (float)l1 * 1.0F / (float)this.jdField_a_of_type_Bjqb.jdField_b_of_type_Long;
        ...
        default: 
          return;
        case 0: 
          if ((f1 < 0.0F) && (f2 > bjqb.jdField_b_of_type_Int))
          {
            this.c.setImageResource(2130843634);
            this.jdField_a_of_type_Bjqb.d = 1;
            return;
      ...
      this.jdField_a_of_type_Bjqb.d = 1;
      return;
      if ((f1 < 0.0F) && (f2 > bjqb.jdField_c_of_type_Int))
      {
        this.jdField_a_of_type_Bjqb.d = 2;
        return;
      }
    ...
    return;
    float f1 = this.jdField_a_of_type_Bjqb.jdField_f_of_type_Int;
    long l2 = SystemClock.uptimeMillis() - this.jdField_a_of_type_Bjqb.jdField_a_of_type_Long;
    long l1 = l2;
    if (l2 >= this.jdField_a_of_type_Bjqb.jdField_b_of_type_Long) {
      l1 = this.jdField_a_of_type_Bjqb.jdField_b_of_type_Long;
    }
    float f3 = (float)l1 * 1.0F / (float)this.jdField_a_of_type_Bjqb.jdField_b_of_type_Long;
