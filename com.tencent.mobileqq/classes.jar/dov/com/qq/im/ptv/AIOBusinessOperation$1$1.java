  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    long l2;
    if (boqt.a().equalsIgnoreCase(this.a))
    {
      Drawable localDrawable = (Drawable)boqt.a().get(boqt.a());
    ...
    do
    {
      ...
      this.this$0.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844410);
      l2 = SystemClock.uptimeMillis();
    } while (!QLog.isColorLevel());
    QLog.i("AIOBusinessOperation", 2, "updateLightVideoEntry total cost:" + (l2 - l1) + " ms");
    return;
    if (this.this$0.jdField_a_of_type_Boolean) {
      boqt.a(this.this$0.jdField_a_of_type_AndroidWidgetImageView, this.a);
    }
    for (;;)
    {
      boqt.a(this.a);
      break;
      boqt.b(this.this$0.jdField_a_of_type_AndroidWidgetImageView, this.a);
    }
  }
}
