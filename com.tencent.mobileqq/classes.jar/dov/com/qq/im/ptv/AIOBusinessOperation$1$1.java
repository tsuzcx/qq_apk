  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    long l2;
    if (bhwy.a().equalsIgnoreCase(this.a))
    {
      Drawable localDrawable = (Drawable)bhwy.a().get(bhwy.a());
    ...
    do
    {
      ...
      this.this$0.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843537);
      l2 = SystemClock.uptimeMillis();
    } while (!QLog.isColorLevel());
    QLog.i("AIOBusinessOperation", 2, "updateLightVideoEntry total cost:" + (l2 - l1) + " ms");
    return;
    if (this.this$0.jdField_a_of_type_Boolean) {
      bhwy.a(this.this$0.jdField_a_of_type_AndroidWidgetImageView, this.a);
    }
    for (;;)
    {
      bhwy.a(this.a);
      break;
      bhwy.b(this.this$0.jdField_a_of_type_AndroidWidgetImageView, this.a);
    }
  }
}
