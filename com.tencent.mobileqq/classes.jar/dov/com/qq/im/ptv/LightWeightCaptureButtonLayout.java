  ...
  implements bbji
{
  ...
  protected long a;
  protected Handler a;
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new bpzc(this);
  public bpzp a;
  protected bpzq a;
  protected bpzr a;
  ...
  public LightWeightCaptureButtonLayout(Context paramContext)
  {
    ...
    this.jdField_b_of_type_Float = brkm.a(2.0F);
    this.jdField_c_of_type_Float = brkm.a(5.0F);
    this.jdField_d_of_type_Float = brkm.a(2.0F);
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_AndroidOsHandler = new bpzf(this, Looper.getMainLooper());
    this.jdField_a_of_type_Bpzp = new bpzp();
    a();
  }
  ...
  protected void a()
  {
    this.jdField_a_of_type_Int = getResources().getColor(2131166279);
    LayoutInflater.from(getContext()).inflate(a(), this, true);
    this.jdField_a_of_type_DovComQqImPtvBaseButton = ((BaseButton)findViewById(2131376394));
    this.jdField_b_of_type_DovComQqImPtvBaseButton = ((BaseButton)findViewById(2131365370));
    this.jdField_c_of_type_DovComQqImPtvBaseButton = ((BaseButton)findViewById(2131370379));
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setShadowDraw(false);
    if (AppSetting.jdField_c_of_type_Boolean)
    {
      bhga.a(this.jdField_a_of_type_DovComQqImPtvBaseButton, true);
      bhga.a(this.jdField_a_of_type_DovComQqImPtvBaseButton, anzj.a(2131704978), Button.class.getName());
      bhga.a(this.jdField_b_of_type_DovComQqImPtvBaseButton, anzj.a(2131705004), Button.class.getName());
      bhga.a(this.jdField_c_of_type_DovComQqImPtvBaseButton, anzj.a(2131705006), Button.class.getName());
    }
    ...
    this.jdField_c_of_type_DovComQqImPtvBaseButton.setShadowStrokeWidth(brkm.a(3.0F));
    this.jdField_b_of_type_DovComQqImPtvBaseButton.setShadowStrokeWidth(brkm.a(3.0F));
  ...
  public void a(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            case 2: 
              if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
              {
                if (this.jdField_a_of_type_Bpzq != null) {
                  this.jdField_a_of_type_Bpzq.n();
                }
        ...
        if (this.jdField_a_of_type_Bpzq != null) {
          this.jdField_a_of_type_Bpzq.o();
        }
        this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
        return;
      } while (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get());
      if (this.jdField_a_of_type_Bpzq != null) {
        this.jdField_a_of_type_Bpzq.q();
      }
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
      b();
      return;
  ...
  public void a(bpzq parambpzq, SimpleEffectsCaptureView paramSimpleEffectsCaptureView, LightWeightProgress paramLightWeightProgress)
  {
    ...
    this.jdField_a_of_type_Bpzq = parambpzq;
  ...
  {
    this.jdField_a_of_type_Bpzp.jdField_a_of_type_Float = paramLWMotionEvent.a();
    this.jdField_a_of_type_Bpzp.jdField_b_of_type_Float = paramLWMotionEvent.b();
    this.jdField_a_of_type_Bpzp.jdField_c_of_type_Float = paramLWMotionEvent.a();
    this.jdField_a_of_type_Bpzp.jdField_d_of_type_Float = paramLWMotionEvent.b();
    this.jdField_a_of_type_Bpzp.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bpzp.jdField_c_of_type_Boolean = false;
    this.jdField_a_of_type_Bpzp.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Bpzp.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_Bpzp.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_Bpzp.jdField_e_of_type_Boolean = false;
    if (QLog.isColorLevel()) {
      QLog.i("CameraCaptureLayout", 2, "handleTouch[Adsorption] startX=" + this.jdField_a_of_type_Bpzp.jdField_a_of_type_Float + " startY=" + this.jdField_a_of_type_Bpzp.jdField_b_of_type_Float + " lastX=" + this.jdField_a_of_type_Bpzp.jdField_c_of_type_Float + " lastY=" + this.jdField_a_of_type_Bpzp.jdField_d_of_type_Float);
    }
  ...
  {
    this.jdField_a_of_type_DovComQqImPtvBaseButton.setShadowDraw(false);
    this.jdField_a_of_type_Bpzp.jdField_d_of_type_Boolean = true;
    if (!this.jdField_a_of_type_Bpzp.jdField_a_of_type_Boolean)
    {
      h();
      return true;
    }
    switch (this.jdField_a_of_type_Bpzp.jdField_d_of_type_Int)
    {
    default: 
      return false;
    case 0: 
  ...
  protected void b(LWMotionEvent paramLWMotionEvent)
  {
    ...
    this.jdField_a_of_type_Bpzp.jdField_e_of_type_Float = (f1 - this.jdField_a_of_type_Bpzp.jdField_c_of_type_Float);
    this.jdField_a_of_type_Bpzp.f = (f2 - this.jdField_a_of_type_Bpzp.jdField_d_of_type_Float);
    c();
    if (this.jdField_a_of_type_Bpzp.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Bpzp.jdField_c_of_type_Float = f1;
      this.jdField_a_of_type_Bpzp.jdField_d_of_type_Float = f2;
    }
    if (QLog.isColorLevel()) {
      QLog.i("CameraCaptureLayout", 2, "handleTouch[Adsorption] xDiff=" + this.jdField_a_of_type_Bpzp.jdField_e_of_type_Float + " currentX=" + f1 + " yDiff=" + this.jdField_a_of_type_Bpzp.f + " currentY=" + f2);
    }
  }
  ...
  protected void e()
  {
    ...
    {
      String str = (int)l / 1000 + anzj.a(2131705008);
      if (QLog.isColorLevel()) {
        QLog.i("CameraCaptureLayout", 2, "updateProgress percent:" + j + ", time:" + str);
      }
      if (this.jdField_a_of_type_Bpzq != null) {
        this.jdField_a_of_type_Bpzq.c(j);
      }
      if (this.jdField_a_of_type_Boolean) {
        h();
      }
  ...
  protected void k()
  {
    this.jdField_a_of_type_Bpzp.jdField_d_of_type_Int = 3;
    ...
    localObjectAnimator.addListener(new bpzg(this));
    ...
    this.jdField_b_of_type_DovComQqImPtvBaseButton.setImageResource(2130844460);
    ...
    j = getResources().getColor(2131165391);
    ...
    ((AnimatorSet)localObject1).addListener(new bpzh(this));
    ((AnimatorSet)localObject1).start();
    j = getResources().getColor(2131166283);
    ...
    ((ObjectAnimator)localObject1).addListener(new bpzi(this));
  ...
  protected void l()
  {
    ...
    localObjectAnimator.addListener(new bpzj(this));
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_a_of_type_JavaUtilArrayList.add(localObjectAnimator);
    ...
    this.jdField_c_of_type_DovComQqImPtvBaseButton.setImageResource(2130844465);
    localObject1 = ObjectAnimator.ofInt(this.jdField_a_of_type_DovComQqImPtvBaseButton, "backgroundColor", new int[] { j });
    ((ObjectAnimator)localObject1).setEvaluator(bpyi.a());
    j = getResources().getColor(2131165394);
    localObjectAnimator = ObjectAnimator.ofInt(this.jdField_a_of_type_DovComQqImPtvBaseButton, "shadowColor", new int[] { j });
    localObjectAnimator.setEvaluator(bpyi.a());
    localObject2 = new AnimatorSet();
    ((AnimatorSet)localObject2).play((Animator)localObject1).with(localObjectAnimator);
    ((AnimatorSet)localObject2).setDuration(100L);
    localObject1 = a(this.jdField_a_of_type_DovComQqImPtvBaseButton, 1.0F, 1.022F, 1.022F, 1.0F, (Animator)localObject2, null, 140L, 50L);
    ((AnimatorSet)localObject1).addListener(new bpzk(this));
    ((AnimatorSet)localObject1).start();
  }
  ...
  protected void m()
  {
    ...
    ((AnimatorSet)localObject2).addListener(new bpzl(this));
    ((AnimatorSet)localObject2).start();
    m = getResources().getColor(2131165392);
    k = getResources().getColor(2131165393);
    ...
    localObject2 = new AnimatorSet();
    ((AnimatorSet)localObject2).play(localAnimatorSet).with((Animator)localObject1);
    ((AnimatorSet)localObject2).addListener(new bpzm(this));
    ((AnimatorSet)localObject2).start();
  }
  ...
  protected void n()
  {
    ...
    localObjectAnimator.addListener(new bpzd(this));
    this.jdField_a_of_type_JavaUtilArrayList.clear();
    this.jdField_a_of_type_JavaUtilArrayList.add(localObjectAnimator);
    ...
    m = getResources().getColor(2131165388);
    ...
    ((AnimatorSet)localObject2).setDuration(100L);
    localObject1 = a(this.jdField_a_of_type_DovComQqImPtvBaseButton, 1.0F, 1.022F, 1.022F, 1.0F, (Animator)localObject2, null, 140L, 50L);
    ((AnimatorSet)localObject1).addListener(new bpze(this));
    ((AnimatorSet)localObject1).start();
  }
  ...
  public void setUIButtonListener(bpzr parambpzr)
  {
    this.jdField_a_of_type_Bpzr = parambpzr;
  }
}
