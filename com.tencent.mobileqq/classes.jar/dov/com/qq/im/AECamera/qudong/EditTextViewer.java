  ...
  implements View.OnClickListener
{
  ...
  private bhbk jdField_a_of_type_Bhbk;
  private bhbt jdField_a_of_type_Bhbt;
  private bhbu jdField_a_of_type_Bhbu;
  ...
  public EditTextViewer(Context paramContext)
  {
    ...
    setBackgroundDrawable(getResources().getDrawable(2130837627));
    this.jdField_a_of_type_AndroidGraphicsDrawableLayerDrawable = ((LayerDrawable)getResources().getDrawable(2130837626));
  ...
  private String a(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    bace.a(paramArrayOfByte, paramContext);
    return paramContext;
  }
  ...
  private void d()
  {
    ...
    {
      this.jdField_a_of_type_Bhbk = new bhbk(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_Bhbk.a(this.jdField_a_of_type_ComTencentTtpicVideoshelfModelEditNodeItem.nodeTextMaxCount);
      this.jdField_a_of_type_Bhbk.a(this.jdField_a_of_type_ComTencentTtpicOpenapiModelTextWMElement, this.jdField_c_of_type_Boolean);
      this.jdField_a_of_type_Bhbk.a(new bhbq(this));
      this.jdField_a_of_type_Bhbk.show();
      this.jdField_a_of_type_Bhbk.setOnDismissListener(new bhbr(this));
    }
  }
  ...
  private void e()
  {
    ...
    localAppInterface.addObserver(new bhbs(this, localAppInterface, str2));
    ((avzm)localAppInterface.getBusinessHandler(3)).a(str1, str2);
  }
  ...
  private void g()
  {
    ...
    if (this.jdField_a_of_type_Bhbu != null) {
      this.jdField_a_of_type_Bhbu.b(this.jdField_a_of_type_ComTencentTtpicVideoshelfModelEditNodeItem);
    }
  ...
  private void h()
  {
    if (this.jdField_a_of_type_Bhbt != null) {
      this.jdField_a_of_type_Bhbt.a();
    }
  }
  ...
  public void a(String paramString)
  {
    if (!DeviceUtils.isNetworkAvailable(AEModule.getContext())) {
      bbmy.a(getContext(), 2131624265, 1).a();
    }
    label131:
    for (;;)
    {
      ...
      for (this.jdField_a_of_type_ComTencentTtpicOpenapiModelTextWMElement.userValue = "";; this.jdField_a_of_type_ComTencentTtpicOpenapiModelTextWMElement.userValue = paramString)
      {
        ...
        this.jdField_a_of_type_Bhbu.c(this.jdField_a_of_type_ComTencentTtpicVideoshelfModelEditNodeItem);
        return;
      }
    }
    label133:
  ...
  public void setOnDownloadDialogListener(bhbt parambhbt)
  {
    this.jdField_a_of_type_Bhbt = parambhbt;
  }
  
  public void setOnSaveTextInfoListener(bhbu parambhbu)
  {
    this.jdField_a_of_type_Bhbu = parambhbu;
  }
 ...
 * Qualified Name:     dov.com.qq.im.AECamera.qudong.EditTextViewer
