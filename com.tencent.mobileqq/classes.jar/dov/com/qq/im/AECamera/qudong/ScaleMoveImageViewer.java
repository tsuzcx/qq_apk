  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  public ScaleMoveImageViewer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130837593);
  }
  ...
  public void a()
  {
    ...
    if ((n <= 0) || (i1 <= 0) || (k < 0) || (m < 0))
    {
      ...
      if (this.jdField_a_of_type_Bhcb != null) {
        this.jdField_a_of_type_Bhcb.a(this.jdField_a_of_type_ComTencentTtpicVideoshelfModelEditNodeItem);
      }
    }
    for (;;)
    {
  ...
  public void onClick(View paramView)
  {
    ...
    b();
    bhci.a().h();
    bgyg.b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentTtpicVideoshelfModelEditNodeItem.nodeID);
  }
  ...
  public void setOnSaveScrollInfoListener(bhcb parambhcb)
  {
 ...
 * Qualified Name:     dov.com.qq.im.AECamera.qudong.ScaleMoveImageViewer
