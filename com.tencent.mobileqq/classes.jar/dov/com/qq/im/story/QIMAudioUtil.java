...
public class QIMAudioUtil
{
  public static boolean a(File paramFile1, File paramFile2)
  {
    ...
    AudioFileDecoder localAudioFileDecoder = new AudioFileDecoder(44100, 16, 1);
    localAudioFileDecoder.a(new QIMAudioUtil.1());
    long l = System.currentTimeMillis();
    try
    {
      localAudioFileDecoder.a(paramFile1.getAbsolutePath(), paramFile2.getAbsolutePath());
      return true;
    }
 ...
 * Qualified Name:     dov.com.qq.im.story.QIMAudioUtil
