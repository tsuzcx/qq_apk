...
public class LyricWithBuoyView
  extends FrameLayout
{
  private Handler jdField_a_of_type_AndroidOsHandler = new bobn(this, Looper.getMainLooper());
  private View jdField_a_of_type_AndroidViewView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  public bobe a;
  private bobq jdField_a_of_type_Bobq;
  ...
  public LyricWithBuoyView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = LayoutInflater.from(paramContext).inflate(2131558553, this);
    this.jdField_a_of_type_DovComQqImAeeditorLyricWidgetLyricViewDetail = ((LyricViewDetail)paramContext.findViewById(2131363837));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131379775));
    this.jdField_a_of_type_AndroidViewView = paramContext.findViewById(2131363838);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new bobo(this));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new bobp(this));
    this.jdField_a_of_type_DovComQqImAeeditorLyricWidgetLyricViewDetail.setIsDealTouchEvent(false);
    this.b = paramContext.findViewById(2131371457);
    this.jdField_a_of_type_Bobe = new bobe(this.jdField_a_of_type_DovComQqImAeeditorLyricWidgetLyricViewDetail);
  }
  ...
  {
    if (this.b == null) {
      bnzb.c("LyricWithBuoyView", "handlerHideSelection() mMusicLyricLineView == null.");
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Bobe != null) {
        this.jdField_a_of_type_Bobe.b(false);
      }
      return;
  ...
  public void a(boaz paramboaz)
  {
    if (this.jdField_a_of_type_Bobe == null)
    {
      bnzb.c("LyricWithBuoyView", "registerScrollListener() mLyricViewController == null.");
      return;
    }
    this.jdField_a_of_type_Bobe.a(paramboaz);
  }
  
  public void a(String paramString1, String paramString2, int paramInt, bobh parambobh)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      bnzb.a("LyricWithBuoyView", "initLyricView() lyric info is empty.");
    }
    label199:
    for (;;)
    {
      ...
      if (TextUtils.equals(paramString2.toUpperCase(), "LRC"))
      {
        ...
        if (this.jdField_a_of_type_Bobe != null)
        {
          this.jdField_a_of_type_Bobe.a(null, localLyric, null);
          paramString1 = localLyric;
        }
      }
      for (;;)
      {
        ...
        bnzb.a("LyricWithBuoyView", "initLyricView() startTime => " + paramInt + ",lyricFormat:" + paramString2);
        if (this.jdField_a_of_type_Bobe == null) {
          break;
        }
        this.jdField_a_of_type_Bobe.a(false);
        this.jdField_a_of_type_Bobe.a(paramInt, true);
        this.jdField_a_of_type_Bobe.a(parambobh);
        return;
        if (TextUtils.equals(paramString2.toUpperCase(), "QRC"))
        {
          ...
          if (this.jdField_a_of_type_Bobe != null)
          {
            this.jdField_a_of_type_Bobe.a(localLyric, null, null);
            paramString1 = localLyric;
          }
        }
        else
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bobe != null)
      {
        this.jdField_a_of_type_Bobe.b(true);
        continue;
        Log.d("LyricWithBuoyView", "onTouchEvent -> ACTION_MOVE");
        String str = a(this.jdField_a_of_type_Bobe.a());
  ...
  public void setLyric(Lyric paramLyric1, Lyric paramLyric2, Lyric paramLyric3)
  {
    if (this.jdField_a_of_type_Bobe == null)
    {
      bnzb.c("LyricWithBuoyView", "setLyric() mLyricViewController == null.");
      return;
    }
    this.jdField_a_of_type_Bobe.a(paramLyric1, paramLyric2, paramLyric3);
  }
  
  public void setOnLyricWithBuoyViewOperationListener(bobq parambobq)
  {
    this.jdField_a_of_type_Bobq = parambobq;
  }
