  ...
  extends FrameLayout
{
  ...
  public SelectableThumbClipView(@NotNull Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setBackground(getResources().getDrawable(2130837722));
    ...
    localTextView.setTextColor(localTextView.getResources().getColor(2131167363));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setTypeface(zpz.a(paramContext, "https://downv6.qq.com/video_story/qcircle/ttf/qircle_number_bold.ttf"));
