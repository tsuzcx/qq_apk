  ...
  extends FrameLayout
{
  ...
  public SelectableThumbClipView(@NotNull Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setLayoutParams((ViewGroup.LayoutParams)new FrameLayout.LayoutParams(getResources().getDimensionPixelSize(2131296347), getResources().getDimensionPixelSize(2131296345)));
    this.jdField_a_of_type_AndroidViewView.setBackground(getResources().getDrawable(2130837733));
    this.jdField_a_of_type_AndroidViewView.setVisibility(4);
    paramAttributeSet = new FrameLayout.LayoutParams(-2, (int)getResources().getDimension(2131296330));
    paramAttributeSet.leftMargin = ((int)getResources().getDimension(2131296306));
    paramAttributeSet.bottomMargin = ((int)getResources().getDimension(2131296308));
    ...
    localTextView.setTextColor(localTextView.getResources().getColor(2131167374));
    this.jdField_a_of_type_AndroidWidgetTextView.setShadowLayer(2.0F, 1.0F, 1.0F, 2131165368);
