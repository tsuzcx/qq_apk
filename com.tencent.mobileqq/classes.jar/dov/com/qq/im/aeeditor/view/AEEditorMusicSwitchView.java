  ...
  implements View.OnClickListener
{
  ...
  private bmnu jdField_a_of_type_Bmnu;
  private TextView b;
  ...
  private void a(int paramInt)
  {
    ...
    b(paramInt);
    c(paramInt);
    if (this.jdField_a_of_type_Bmnu != null) {
      this.jdField_a_of_type_Bmnu.a(paramInt);
    }
  }
  
  private void a(@NonNull Context paramContext)
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131558560, this, true);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379748));
    this.b = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379487));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369381));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      a(0);
      continue;
      if ((i == 2131379487) && (this.jdField_a_of_type_Int != 1)) {
        a(1);
      }
    }
  }
  
  public void setSwitchClickListener(@Nullable bmnu parambmnu)
  {
    this.jdField_a_of_type_Bmnu = parambmnu;
  }
}
