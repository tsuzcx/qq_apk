  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  static
  {
    jdField_a_of_type_DovComQqImAeeditorViewReorderReorderContainerView$SpacingAdapter$Companion = new ReorderContainerView.SpacingAdapter.Companion(null);
  }
  ...
  public void onBindViewHolder(@NotNull RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    if ((paramViewHolder instanceof ReorderVH))
    {
      ...
      ((ReorderVH)paramViewHolder).a().setClipUrl(localCutModelKt.getUuid(), localCutModelKt.getResource().getPath(), localCutModelKt.getResource().getSelectTimeStart());
      int i = ReorderViewIdManager.a.a(localCutModelKt.getUuid());
      if (i != -1) {
        ((ReorderVH)paramViewHolder).a().setId(i);
      }
      ((ReorderVH)paramViewHolder).a().setText((CharSequence)TimeFormatUtil.getDurationSecondsEnglish(localCutModelKt.getResource().getScaleDuration()));
    }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup paramViewGroup, int paramInt)
  {
    ...
    paramInt = localContext.getResources().getDimensionPixelSize(2131296346);
    paramViewGroup = paramViewGroup.getContext();
    Intrinsics.checkExpressionValueIsNotNull(paramViewGroup, "parent.context");
 ...
 * Qualified Name:     dov.com.qq.im.aeeditor.view.reorder.ReorderContainerView.SpacingAdapter
