...
public class AELocalMediaInfoUtil
{
  public static LocalMediaInfo a(@NonNull LocalMediaInfo paramLocalMediaInfo, @Nullable String paramString1, @Nullable String paramString2, @Nullable String paramString3, int paramInt, @Nullable String paramString4)
  {
    ...
    if (i != 0)
    {
      ...
      AEQLog.b("AELocalMediaInfoUtil", "[addTakeSamePhotoInfo] scheme :" + paramLocalMediaInfo.scheme);
    }
    AEQLog.b("AELocalMediaInfoUtil", "[addTakeSamePhotoInfo] takePhotoSame :" + paramInt);
  ...
  public static LocalMediaInfo a(String paramString1, String paramString2, @Nullable String paramString3, @Nullable String paramString4)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString1)
      {
        ...
        AEQLog.d("AELocalMediaInfoUtil", "error msg: " + paramString1.getMessage());
        continue;
      }
      try
      {
      ...
      {
        paramString1.printStackTrace();
        AEQLog.d("AELocalMediaInfoUtil", "[buildLocalMediaInfoForReady] " + paramString1.getMessage());
        return null;
      }
 ...
 * Qualified Name:     dov.com.qq.im.aeeditor.util.AELocalMediaInfoUtil
