...
class AEEditorImageEditFragment$14
  implements Runnable
{
  AEEditorImageEditFragment$14(AEEditorImageEditFragment paramAEEditorImageEditFragment, int paramInt1, int paramInt2, bodh parambodh, AEEditorFilterBean paramAEEditorFilterBean) {}
  ...
  public void run()
  {
    ...
    AEEditorImageEditFragment.a(this.this$0).a(this.b, this.jdField_a_of_type_Bodh, this.jdField_a_of_type_Int);
    ...
    if (AEEditorImageEditFragment.a(this.this$0) != null) {
      AEEditorImageEditFragment.a(this.this$0).setOverlayImage(this.b, this.jdField_a_of_type_Bodh.a());
    }
    bnyl.a().a().a.put(Integer.valueOf(this.b), this.jdField_a_of_type_DovComQqImAeeditorModuleFilterAEEditorFilterBean.getEffectId());
    bnyl.a().a().b.put(Integer.valueOf(this.b), Float.valueOf(-1.0F));
  }
}
