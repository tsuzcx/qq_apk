  ...
  implements View.OnClickListener
{
  ...
  protected void a(int paramInt1, String paramString, int paramInt2, int paramInt3)
  {
    ...
    localAECompoundButton.setForegroundSize(bgtn.a(32.0F), bgtn.a(32.0F));
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.width = bgtn.a(56.0F);
    localLayoutParams.height = bgtn.a(56.0F);
    if ((a(paramString)) && (!b(paramString))) {
      localAECompoundButton.addView(LayoutInflater.from(getContext()).inflate(2131558558, localAECompoundButton, false));
    }
  ...
  {
    paramString = findViewById(2131376606);
    if (paramString != null) {
  ...
  {
    return bnyp.a().a("ae_editor_tool_bar_red_dot_" + paramString, false, 0);
  }
  ...
  public void setToolBarListener(boip paramboip)
  {
    this.jdField_a_of_type_Boip = paramboip;
  }
}
