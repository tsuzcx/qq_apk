  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localHttpNetReq.mCallback = new AEEditorCommonEditFragment.12.1(this);
    localHttpNetReq.mReqUrl = "https://downv6.qq.com/shadow_qqcamera/AutoTemplateAnimation.zip";
    localHttpNetReq.mHttpMethod = 0;
    localHttpNetReq.mOutPath = new File(AEEditorPath.AISCENE.FILES.f).getPath();
 ...
 * Qualified Name:     dov.com.qq.im.aeeditor.module.edit.AEEditorCommonEditFragment.12
