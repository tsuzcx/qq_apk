  ...
  implements Runnable
{
  ...
  public void run()
  {
    Bitmap localBitmap = AEEditorImageEditFragment.a(this.this$0, (String)AEEditorImageEditFragment.b(this.this$0).get(this.jdField_a_of_type_Int), ((bpbu)AEEditorImageEditFragment.a(this.this$0).get(this.jdField_a_of_type_Int)).a);
    if (localBitmap == null)
    {
      bpam.d(AEEditorImageEditFragment.e(), "bitmap null error.");
      return;
    }
