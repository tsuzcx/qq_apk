...
class AEEditorVideoEditFragment$15
  implements Runnable
{
  AEEditorVideoEditFragment$15(AEEditorVideoEditFragment paramAEEditorVideoEditFragment, bobg parambobg, boolean paramBoolean, String paramString) {}
  
  public void run()
  {
    boolean bool2 = false;
    if ((AEEditorVideoEditFragment.a(this.this$0) != null) && (!AEEditorVideoEditFragment.a(this.this$0).a()) && (!this.jdField_a_of_type_Bobg.a()) && (AEEditorVideoEditFragment.a(this.this$0).a().equals(this.jdField_a_of_type_Bobg.a()))) {}
    for (int i = 1; !this.jdField_a_of_type_Boolean; i = 0)
    {
      AEEditorVideoEditFragment.a(this.this$0, this.jdField_a_of_type_Bobg, this.jdField_a_of_type_Boolean);
      if (i != 0)
      {
        if (AEEditorVideoEditFragment.a(this.this$0) != null) {
          AEEditorVideoEditFragment.a(this.this$0).f();
        }
        QQToast.a(BaseApplicationImpl.getApplication(), 2131689712, 0).a();
      }
      bnrh.d(AEEditorVideoEditFragment.f(), "[onDownloadFinished], download music failed, editorMusicInfo=" + this.jdField_a_of_type_Bobg);
      return;
    }
    if (i != 0)
    {
      ...
      {
        bnrh.b(AEEditorVideoEditFragment.f(), "[onDownloadFinished], avCutVideoSession=null");
        return;
      }
      AEEditorVideoEditFragment.a(this.this$0, AEEditorMusicHelper.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Bobg.a(), this.jdField_a_of_type_Bobg.b()));
    ...
    AEEditorVideoEditFragment.a(this.this$0, this.jdField_a_of_type_Bobg, this.jdField_a_of_type_Boolean);
    bnrh.b(AEEditorVideoEditFragment.f(), "[onDownloadFinished], currentMusic invalid OR editorMusicInfo invalid OR mid not match");
  }
}
