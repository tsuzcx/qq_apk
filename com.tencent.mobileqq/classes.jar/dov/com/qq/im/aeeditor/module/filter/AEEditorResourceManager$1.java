  ...
  implements EIPCResultCallback
{
  ...
  {
    AEQLog.a(AEEditorResourceManager.a(this.a), "ipc result.");
    ...
    try
    {
      paramEIPCResult = (AEEditorEffectGroupListBean)AEEditorEffectUtils.a(paramEIPCResult);
      ...
      {
        AEQLog.b(AEEditorResourceManager.c(this.a), "use local effect data.");
        localObject1 = (AEEditorEffectGroupListBean)GsonUtils.json2Obj(AEEditorResourceManager.a(this.a, "camera/ae_camera_editor_display_effects.json"), new AEEditorResourceManager.1.1(this).getType());
      }
      ...
      {
        AEQLog.d(AEEditorResourceManager.d(this.a), "effect list is empty.");
        return;
      }
    }
    catch (Exception paramEIPCResult)
    {
      for (;;)
      {
        AEQLog.d(AEEditorResourceManager.b(this.a), "parse online config error e: " + paramEIPCResult.toString());
      ...
      localObject1 = AEEditorResourceManager.e(this.a);
    ...
    {
      AEQLog.b((String)localObject1, paramEIPCResult);
 ...
 * Qualified Name:     dov.com.qq.im.aeeditor.module.filter.AEEditorResourceManager.1
