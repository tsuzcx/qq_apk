...
public class QIMCameraCaptureUnit$2
  implements Runnable
{
  public QIMCameraCaptureUnit$2(bhdi parambhdi, String paramString) {}
  ...
  public void run()
  {
    ...
    {
      this.this$0.B();
      if (!bhdi.a(this.this$0).isShowing())
      {
        bhdi.a(this.this$0).setCancelable(false);
        bhdi.a(this.this$0).show();
      }
