  ...
  extends View
{
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsPaint.setStrokeWidth(azvv.a(this.jdField_a_of_type_AndroidContentContext, 2.0F));
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.e = (this.jdField_a_of_type_Int / 2 - azvv.a(this.jdField_a_of_type_AndroidContentContext, 1.0F));
    this.jdField_c_of_type_Int = (this.e - azvv.a(this.jdField_a_of_type_AndroidContentContext, 5.0F));
    this.jdField_d_of_type_Int = (this.jdField_c_of_type_Int - azvv.a(this.jdField_a_of_type_AndroidContentContext, 2.0F));
  }
 ...
 * Qualified Name:     dov.com.qq.im.giftext.AEGIFTextColorSelectionView
