  ...
  implements SurfaceTexture.OnFrameAvailableListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnVideoSizeChangedListener, GLSurfaceView.Renderer, View.OnClickListener
{
  ...
  private boqc jdField_a_of_type_Boqc;
  ...
  public CropVideoActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bopx(this);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramString = this.jdField_a_of_type_Boqc.a();
          n = this.jdField_a_of_type_Boqc.a();
          i1 = this.jdField_a_of_type_Boqc.b();
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong1, long paramLong2)
  {
    ...
    try
    {
      localFFmpeg.execute((String[])localArrayList.toArray(new String[0]), new bopz(this));
      return;
    }
  ...
  public void a()
  {
    ...
    ((TextView)this.jdField_a_of_type_AndroidAppProgressDialog.findViewById(2131372740)).setText(anvx.a(2131702118));
  ...
  {
    super.setContentView(2131560899);
    ...
    if (this.mSystemBarComp != null)
    {
      ...
      paramBundle = findViewById(2131364160);
    ...
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView = ((GLSurfaceView)findViewById(2131367755));
    ...
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131373220));
    this.jdField_a_of_type_AndroidWidgetProgressBar.setProgress(0);
    this.jdField_a_of_type_AndroidWidgetProgressBar.setMax(100);
    this.jdField_a_of_type_DovComQqImCropvideoRegionView = ((RegionView)findViewById(2131376470));
    ...
    findViewById(2131364250).setOnClickListener(this);
    findViewById(2131365326).setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this, new bopt(this));
    this.jdField_a_of_type_Lql = new lql(this, new bopu(this));
    this.jdField_a_of_type_AndroidViewScaleGestureDetector = new ScaleGestureDetector(this, new bopv(this));
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView.setOnTouchListener(new bopw(this));
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    try
    {
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Boqc.a(this.jdField_a_of_type_ArrayOfFloat);
        this.jdField_a_of_type_Boolean = false;
      }
      this.jdField_a_of_type_Boqc.a(this.jdField_a_of_type_Int);
      return;
    }
    finally {}
  }
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Boqc.b(paramInt1, paramInt2);
    ...
    this.jdField_a_of_type_Boqc.a(k, n, paramInt1, paramInt2);
  }
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    if (this.jdField_a_of_type_Boqc == null)
    {
      this.jdField_a_of_type_Boqc = new boqc();
      this.jdField_a_of_type_Boqc.a();
      this.jdField_a_of_type_Boqc.b(4.0F);
      this.jdField_a_of_type_Boqc.a(1.0F);
    }
  ...
  public void onVideoSizeChanged(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Boqc.a(paramInt1, paramInt2);
  }
}
