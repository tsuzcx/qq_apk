...
public class QIMCaptureBannerManager$1
  implements Runnable
{
  public QIMCaptureBannerManager$1(blmy paramblmy) {}
  
  public void run()
  {
    QIMCaptureBannerConfig localQIMCaptureBannerConfig = QIMCaptureBannerConfig.getBannerConfigFromFile(this.this$0.a(), blmy.jdField_a_of_type_JavaLangString);
    ...
    synchronized (blmy.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.this$0.a().notifyObservers(blpe.class, 6, true, null);
      return;
    }
  }
}
