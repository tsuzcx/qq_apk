...
public class QIMCaptureBannerManager$1
  implements Runnable
{
  public QIMCaptureBannerManager$1(bmre parambmre) {}
  
  public void run()
  {
    QIMCaptureBannerConfig localQIMCaptureBannerConfig = QIMCaptureBannerConfig.getBannerConfigFromFile(this.this$0.getApp(), bmre.jdField_a_of_type_JavaLangString);
    ...
    synchronized (bmre.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.this$0.getApp().notifyObservers(bmtc.class, 6, true, null);
      return;
    }
  }
}
