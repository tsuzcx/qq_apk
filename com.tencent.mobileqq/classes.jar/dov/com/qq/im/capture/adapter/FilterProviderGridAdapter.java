  ...
  extends BaseAdapter
{
  ...
  private View a()
  {
    ...
    ((URLImageView)localObject2).setImageResource(2130844687);
    ...
    ((TextView)localObject3).setText(HardCodeUtil.a(2131704627));
    ...
    ((TextView)localObject2).setBackgroundResource(2130844686);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      TextView localTextView = (TextView)paramView.findViewById(2131366983);
      ...
      Object localObject1 = VideoFilterTools.a().c(this.c);
      boolean bool = false;
      ...
      for (;;)
      {
        ...
        if (localQIMFilterCategoryItem.c())
        {
          ...
          if (bool)
          {
            ...
            localImageView1.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844688));
            label302:
            localImageView2.setVisibility(8);
            localTextView.setText(HardCodeUtil.a(2131704628));
          }
        }
        for (;;)
        {
          ...
          localImageView1.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844688));
          break label302;
          localObject1 = ((CaptureComboManager)QIMManager.a(5)).a(localQIMFilterCategoryItem);
          if (bool)
          {
            localImageView3.setVisibility(0);
            ...
            if (((FilterSet)localObject1).jdField_a_of_type_Int != 1) {
              break label599;
            }
          ...
          label619:
          VideoFilterTools.a();
          bool = VideoFilterTools.a(3, localQIMFilterCategoryItem.jdField_a_of_type_Int, localQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
          int i = ((FilterSet)localObject1).d();
          localQIMCommonLoadingView.setVisibility(0);
