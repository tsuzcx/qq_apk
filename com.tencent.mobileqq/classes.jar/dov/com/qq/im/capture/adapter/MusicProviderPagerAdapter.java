  ...
  extends PagerAdapter
{
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    if (localGridView == null)
    {
      ...
      localGridView.setPadding(jdField_a_of_type_Int, jdField_a_of_type_Int, jdField_a_of_type_Int, jdField_a_of_type_Int * 2 + AIOUtils.a(36.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    for (;;)
    {
      ...
      localMusicProviderGridAdapter = (MusicProviderGridAdapter)localGridView.getAdapter();
    }
  }
