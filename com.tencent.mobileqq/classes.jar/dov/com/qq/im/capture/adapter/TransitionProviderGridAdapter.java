  ...
  extends BaseAdapter
{
  ...
  private View a()
  {
    ...
    for (;;)
    {
      ...
      ((URLImageView)localObject1).setId(2131368603);
      ...
      ((TextView)localObject2).setId(2131366983);
      ((TextView)localObject2).setGravity(17);
      ((TextView)localObject2).setTextSize(2, 12.0F);
      ((TextView)localObject2).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167374));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((paramView.getTag() == null) || (!(paramView.getTag() instanceof TransitionProviderGridAdapter.ConvertViewTag)))
      {
        if (QLog.isColorLevel()) {
      ...
      TransitionProviderGridAdapter.ConvertViewTag localConvertViewTag = (TransitionProviderGridAdapter.ConvertViewTag)paramView.getTag();
      ...
      for (boolean bool1 = TextUtils.equals(((QIMFilterCategoryItem)localObject).a, localTransitionCategoryItem.a);; bool1 = false) {
        for (;;)
        {
          ...
          try
          {
            ...
            paramView.setContentDescription(localTransitionCategoryItem.b + HardCodeUtil.a(2131714923));
          }
