  ...
  implements Observer
{
  ...
  private PtvTemplateManager.IPtvTemplateDownloadListener jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$IPtvTemplateDownloadListener = new QIMPtvTemplateAdapter.2(this);
  ...
  public QIMPtvTemplateAdapter(Context paramContext, GridView paramGridView, ProviderView.ProviderViewListener paramProviderViewListener, int paramInt)
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureAdapterQIMPtvTemplateAdapter$IPtvTemplateItemCallback = new QIMPtvTemplateAdapter.1(this);
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener != null)
      {
        ...
        if ((FlowCameraConstant.jdField_a_of_type_Int == 2) && (jdField_b_of_type_JavaLangString.equals("0")) && (jdField_b_of_type_Int == 0))
        {
          ...
          this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener.a(0);
          this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener.b(-1);
        }
        if (QLog.isColorLevel()) {
          QLog.i("QIMPtvTemplateManager", 2, "setVideoFilter null");
        }
      }
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoQIMPtvTemplateManager.a(113, null);
      if (this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener != null) {
        this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener.a(null);
      }
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoQIMPtvTemplateManager.a(jdField_b_of_type_JavaLangString);
      return;
      i = this.e;
      if (i >= this.jdField_a_of_type_JavaUtilArrayList.size()) {
        break;
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.usable)
    {
      jdField_b_of_type_Int = paramPtvTemplateInfo.categoryId;
      jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.id;
      String str = QIMPtvTemplateManager.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name;
      if (this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener != null)
      {
        if (QLog.isColorLevel()) {
        ...
        {
          this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener.a(str);
          str = "";
          this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener.a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, str);
      ...
      {
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoQIMPtvTemplateManager.a(paramPtvTemplateInfo, 111);
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoQIMPtvTemplateManager.a(113, null);
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoQIMPtvTemplateManager.a(jdField_b_of_type_JavaLangString);
      }
    }
    for (;;)
    {
      ...
      StoryReportor.a((Activity)this.jdField_a_of_type_AndroidContentContext, "face_element", String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.categoryId), this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id);
      return;
      this.jdField_a_of_type_DovComQqImCaptureViewProviderView$ProviderViewListener.a(null);
      break;
      if ((!this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.downloading) && (!TextUtils.isEmpty(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoQIMPtvTemplateManager != null)) {
        if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.kind == 3) && (NetworkUtil.b(this.jdField_a_of_type_AndroidContentContext)))
        {
          if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog == null) {
            this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(HardCodeUtil.a(2131709796)).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131698303)).setPositiveButton(this.jdField_a_of_type_AndroidContentContext.getString(2131694615), new QIMPtvTemplateAdapter.5(this)).setNegativeButton(this.jdField_a_of_type_AndroidContentContext.getString(2131690800), new QIMPtvTemplateAdapter.4(this));
          }
          try
          {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      localPtvTemplateItemView.a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_DovComQqImCaptureAdapterQIMPtvTemplateAdapter$IPtvTemplateItemCallback, jdField_b_of_type_Int, jdField_b_of_type_JavaLangString, jdField_a_of_type_Boolean);
