  ...
  extends PagerAdapter
{
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    if (localObject2 == null)
    {
      ...
      localObject2 = new blml(this.jdField_a_of_type_AndroidContentContext, this.c);
      ((blml)localObject2).a(((FilterCategory)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).a);
