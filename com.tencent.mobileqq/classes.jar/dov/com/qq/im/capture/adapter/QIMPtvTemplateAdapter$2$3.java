...
public class QIMPtvTemplateAdapter$2$3
  implements Runnable
{
  public QIMPtvTemplateAdapter$2$3(blrc paramblrc, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (i <= k)
    {
      ...
      do
      {
        i += 1;
        break;
        localObject = (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Blrc.a.jdField_a_of_type_JavaUtilArrayList.get(i);
