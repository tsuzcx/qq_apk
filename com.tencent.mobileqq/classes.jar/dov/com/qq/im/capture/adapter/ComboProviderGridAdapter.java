  ...
  implements Handler.Callback
{
  ...
  private View a()
  {
    ...
    ((URLImageView)localObject2).setId(2131362701);
    ...
    ((ImageView)localObject2).setId(2131369854);
    ((ImageView)localObject2).setVisibility(8);
    ((ImageView)localObject2).setScaleType(ImageView.ScaleType.FIT_XY);
    ((ImageView)localObject2).setImageResource(2130841714);
    ((RelativeLayout)localObject1).addView((View)localObject2, new RelativeLayout.LayoutParams(-1, -1));
    localObject2 = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
    ((LinearLayout)localObject2).setId(2131362479);
    ...
    ((ImageView)localObject3).setImageResource(2130841715);
    ...
    ((TextView)localObject3).setId(2131362478);
    ((TextView)localObject3).setTextSize(2, 12.0F);
    ((TextView)localObject3).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131492968));
    ...
    ((RelativeLayout)localObject2).setId(2131369857);
    ((RelativeLayout)localObject2).setBackgroundResource(2130841842);
    ...
    ((RelativeLayout)localObject1).addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
    localObject3 = new TextView(this.jdField_a_of_type_AndroidContentContext);
    ((TextView)localObject3).setCompoundDrawables(null, null, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841843), null);
    ...
    ((TextView)localObject2).setId(2131369855);
    ((TextView)localObject2).setTextSize(2, 12.0F);
    ((TextView)localObject2).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131492968));
    ...
    ((QIMCommonLoadingView)localObject2).setId(2131369000);
    ((QIMCommonLoadingView)localObject2).setVisibility(8);
    ((RelativeLayout)localObject1).addView((View)localObject2, new RelativeLayout.LayoutParams(-1, -1));
    localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    ((ImageView)localObject1).setId(2131363385);
  ...
  public static void a(ImageView paramImageView, CaptureComboBase paramCaptureComboBase, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    if ((bool2) || (paramQIMFilterCategoryItem.jdField_a_of_type_Boolean) || (bool1))
    {
      ...
      if (bool2)
      {
        paramImageView.setImageResource(2130841919);
        return;
      }
      if (bool1)
      {
        paramImageView.setImageResource(2130843091);
        return;
      }
      switch (i)
      {
      ...
      paramImageView.setImageResource(2130843090);
      return;
    }
    paramImageView.setVisibility(8);
  }
  ...
  public void a(ImageView paramImageView, AnimationDrawable paramAnimationDrawable, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new amur(this, paramImageView), 200L);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    TextView localTextView1 = (TextView)paramViewGroup.findViewById(2131369855);
    ImageView localImageView3 = (ImageView)paramViewGroup.findViewById(2131369854);
    ImageView localImageView1 = (ImageView)paramViewGroup.findViewById(2131362701);
    ImageView localImageView2 = (ImageView)paramViewGroup.findViewById(2131363385);
    TextView localTextView2 = (TextView)paramViewGroup.findViewById(2131362478);
    View localView = paramViewGroup.findViewById(2131362479);
    QIMCommonLoadingView localQIMCommonLoadingView = (QIMCommonLoadingView)paramViewGroup.findViewById(2131369000);
    ...
    for (paramView = (QIMFilterCategoryItem)paramView.a;; paramView = null)
    {
      ...
      for (;;)
      {
        ...
        if (localQIMFilterCategoryItem.b())
        {
          ...
          if (bool)
          {
            localImageView1.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841717));
            label337:
        ...
        for (;;)
        {
          ...
          bool = false;
          break;
          localImageView1.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841718));
          break label337;
          ...
          if (!TextUtils.isEmpty(localQIMFilterCategoryItem.b))
          {
            ...
            localImageView3.setImageResource(2130841716);
            localImageView3.setVisibility(0);
            localTextView1.setShadowLayer(0.0F, 0.0F, 0.0F, this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131492975));
          }
          for (;;)
          {
            localObject = URLDrawable.URLDrawableOptions.obtain();
            ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841713);
            ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841713);
            ...
            localImageView2.setVisibility(8);
            ((ImageView)paramViewGroup.findViewById(2131369859)).setVisibility(0);
            ...
            label678:
            localImageView3.setVisibility(8);
            localTextView1.setShadowLayer(3.0F, 0.0F, 0.0F, this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131492975));
          }
          label710:
    ...
    if (paramMessage.what == 9)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          try
          {
            localObject1 = (ImageView)((View)localObject1).findViewById(2131363385);
            localObject2 = (AnimationDrawable)((ImageView)localObject1).getContext().getResources().getDrawable(2130842039);
