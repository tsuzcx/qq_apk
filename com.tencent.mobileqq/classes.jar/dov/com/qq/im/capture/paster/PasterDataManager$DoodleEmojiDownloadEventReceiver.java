  ...
  public void a(@NonNull PasterDataManager paramPasterDataManager, @NonNull DoodleEmojiManager.DoodleEmojiDownloadEvent paramDoodleEmojiDownloadEvent)
  {
    ...
    if (paramPasterDataManager != null)
    {
      ...
      if (paramDoodleEmojiDownloadEvent.jdField_a_of_type_Int == 0)
      {
        ...
        SLog.b(this.TAG, "notify ui we new progress : " + paramDoodleEmojiDownloadEvent.jdField_b_of_type_Long + " / " + paramDoodleEmojiDownloadEvent.jdField_a_of_type_Long);
      ...
      {
        PasterDataManager.a((NormalFacePackage)localObject, paramDoodleEmojiDownloadEvent.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem);
