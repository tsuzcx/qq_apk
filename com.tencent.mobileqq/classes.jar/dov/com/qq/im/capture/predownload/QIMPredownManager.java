  ...
  implements Handler.Callback, QIMPredownJob.Listener
{
  ...
  ArrayList<QIMPredownManager.Config.Item> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  LinkedList<QIMPredownJob> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  public boolean a;
  ArrayList<QIMPredownManager.Config.Item> b;
  public boolean b;
  ...
  {
    this.jdField_a_of_type_DovComQqImCapturePredownloadQIMPredownJob = null;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (paramMessage = "1";; paramMessage = "2")
    {
      ...
      QIMReportController.a(null, (QIMReadWriteReportItem)localObject2);
      break;
      j = 0;
      break label548;
      label872:
