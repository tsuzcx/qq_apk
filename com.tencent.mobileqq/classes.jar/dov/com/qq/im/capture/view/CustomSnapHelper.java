...
public abstract class CustomSnapHelper
  extends SpeedFlexibleRecyclerView.OnFlingListener
{
  private final RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new CustomSnapHelper.1(this);
  ...
  {
    return new CustomSnapHelper.2(this, this.jdField_a_of_type_DovComQqImCaptureViewSpeedFlexibleRecyclerView.getContext());
  }
 ...
 * Qualified Name:     dov.com.qq.im.capture.view.CustomSnapHelper
