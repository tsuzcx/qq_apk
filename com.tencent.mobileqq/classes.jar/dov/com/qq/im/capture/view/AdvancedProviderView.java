  ...
  implements View.OnClickListener
{
  ...
  {
    return new bbkk(Float.valueOf(paramFloat1), Float.valueOf(paramFloat2), new bjji(this, paramQIMProviderContainerView, paramView));
  }
  ...
  public static int b()
  {
    ...
    str = "beauty_level_" + str + "_CAMERA_ID_" + ahua.jdField_a_of_type_Int;
  ...
  public static int c()
  {
    ...
    if ((TextUtils.isEmpty(str2)) || ("0".equals(str2)))
    {
      ...
      str1 = "sharp_face_level_" + str1 + "_CAMERA_ID_" + ahua.jdField_a_of_type_Int;
      if (ahua.jdField_a_of_type_Int != 2) {
        break label157;
      }
      i = j;
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null) {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131560532, this, false);
    }
    paramBundle = this.jdField_a_of_type_AndroidViewView.findViewById(2131363128);
    if (!avtc.d()) {
      paramBundle.setVisibility(8);
    }
    View localView1 = this.jdField_a_of_type_AndroidViewView.findViewById(2131376057);
    SeekBar localSeekBar = (SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131363136);
    if (Build.VERSION.SDK_INT >= 21) {
      localSeekBar.setSplitTrack(false);
    }
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363129);
    int i = b();
    ...
    localSeekBar.setOnSeekBarChangeListener(new bjje(this, localTextView, localView2, paramBundle, localQIMProviderContainerView, localView1));
    localSeekBar = (SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131376059);
    if (Build.VERSION.SDK_INT >= 21) {
      localSeekBar.setSplitTrack(false);
    }
    localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376058);
    i = c();
    localSeekBar.setProgress(i);
    localTextView.setText("+" + String.format("%.1f", new Object[] { Float.valueOf(i / 10.0F) }));
    localSeekBar.setOnSeekBarChangeListener(new bjjf(this, localTextView, localView2, localView1, localQIMProviderContainerView, paramBundle));
    this.jdField_a_of_type_AndroidViewView.findViewById(2131379410).setOnClickListener(new bjjg(this));
    this.jdField_a_of_type_AndroidViewView.findViewById(2131379411).setOnClickListener(new bjjh(this));
    this.c = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379412));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379419));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379414));
    this.d = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379413));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379420));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379415));
  ...
  public void b(int paramInt)
  {
    ...
    if (i != 0) {
      str1 = "sharp_face_level_" + str3 + "_CAMERA_ID_" + ahua.jdField_a_of_type_Int;
    }
    for (;;)
    {
  ...
  {
    g();
    Object localObject1 = bkyx.a().a();
    View localView;
    Object localObject2;
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      localView = this.jdField_a_of_type_AndroidViewView.findViewById(2131376055);
      ...
      if (((List)localObject1).size() > 1)
      {
        ...
        if (this.jdField_b_of_type_AndroidWidgetImageView != null)
        {
          ...
          this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845090);
        }
    ...
    if (this.jdField_a_of_type_AndroidWidgetImageView != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845090);
    }
    for (;;)
    {
      ...
      return;
      label270:
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845103);
      break;
      label283:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845103);
    }
  ...
  public void e()
  {
    ...
    do
    {
      ...
      localSeekBar.setProgress(i);
      localTextView.setText("+" + i / 10.0F);
    } while (this.jdField_a_of_type_Bjkh == null);
  ...
  public void g()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      SeekBar localSeekBar = (SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131376059);
      TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376058);
      int i = c();
      localSeekBar.setProgress(i);
      localTextView.setText("+" + String.format("%.1f", new Object[] { Float.valueOf(i / 10.0F) }));
      ...
      localSeekBar = (SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131363136);
      localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363129);
      i = b();
      localSeekBar.setProgress(i);
      localTextView.setText("+" + i / 10.0F);
      if (this.jdField_a_of_type_Bjkh != null) {
