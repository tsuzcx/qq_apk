...
public class ProviderViewBuilder
{
  ...
  public static final int[] b = { 101, 2130850066, 2131374465 };
  public static final int[] c = { 102, 2130850065, 2131374464 };
  private int jdField_a_of_type_Int;
  private ArrayList<int[]> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 100, 2130850064, 2131374463 };
  }
  ...
  public ProviderView a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramContext.setId(2131364391);
      continue;
      paramContext = new StaticStickerProviderView(paramContext);
      paramContext.setId(2131364400);
    }
  }
 ...
 * Qualified Name:     dov.com.qq.im.capture.view.ProviderViewBuilder
