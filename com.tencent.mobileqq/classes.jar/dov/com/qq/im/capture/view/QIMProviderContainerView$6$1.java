  ...
  implements Runnable
{
  ...
  public void run()
  {
    if ((this.jdField_a_of_type_Boolean) && (!this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView$6.a.a()))
    {
      ...
      this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView$6.a.setRedDotDrawable(this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView$6.a.getResources().getDrawable(2130849802));
