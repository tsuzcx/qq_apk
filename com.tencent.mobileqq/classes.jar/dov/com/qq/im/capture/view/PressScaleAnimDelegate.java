...
public final class PressScaleAnimDelegate
{
  ...
  private final PressScaleAnimDelegate.ScaleAnimUpdateListener jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener;
  
  PressScaleAnimDelegate(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener = new PressScaleAnimDelegate.ScaleAnimUpdateListener(paramView);
  }
  ...
  void a()
  {
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.removeUpdateListener(this.jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener);
    }
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(this.jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener);
  ...
  void a(Canvas paramCanvas)
  {
    ...
    int k = (i + j) / 2;
    m = (m + (n - i1 - i2)) / 2;
    paramCanvas.scale(this.jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener.a, this.jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener.a, k, m);
    if (QLog.isColorLevel()) {
      QLog.d("PressScaleAnimDelegate ", 2, "draw, left=" + i + ",right=" + j + ",centerX=" + k + ",centerY=" + m + ",scale=" + this.jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener.a);
    }
  }
  
  boolean a()
  {
    return this.jdField_a_of_type_DovComQqImCaptureViewPressScaleAnimDelegate$ScaleAnimUpdateListener.a != 1.0F;
  }
}
