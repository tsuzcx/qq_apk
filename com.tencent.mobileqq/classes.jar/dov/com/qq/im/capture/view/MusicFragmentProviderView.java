...
public class MusicFragmentProviderView
  ...
  implements Handler.Callback, View.OnClickListener, bpwn
{
  ...
  public blhq a;
  private bpor jdField_a_of_type_Bpor = new bpvd(this);
  private bpou jdField_a_of_type_Bpou = new bpve(this);
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bpoz.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, this.jdField_g_of_type_Int);
      if (this.jdField_a_of_type_Bpvt != null)
      {
        localbpvt = this.jdField_a_of_type_Bpvt;
        if (paramBoolean) {
          break label294;
        }
      }
  ...
  private int b()
  {
    ...
    if (this.jdField_c_of_type_Int > bdbt.jdField_c_of_type_Int) {
      return bdbt.jdField_c_of_type_Int;
    }
  ...
  private void b(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      String str1 = zhq.a(paramInt1, false);
      String str2 = zhq.a(i * 1000 + paramInt1, false);
      if (QLog.isColorLevel())
      {
  ...
  private void n()
  {
    ...
    ((QIMMusicConfigManager)bplq.a(2)).a(str, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo instanceof VsMusicItemInfo, new bpvf(this));
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (this.jdField_a_of_type_Bpvt != null) {
      this.jdField_a_of_type_Bpvt.c(false);
    }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null) {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131560988, this, false);
    }
    a(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_DovComQqImCaptureViewQimMusicSeekView = ((QimMusicSeekView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371540));
    this.jdField_a_of_type_DovComQqImCaptureViewQimMusicSeekView.setOnSeekListener(this);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131370314);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365701));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365727));
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131371554));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365717));
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131377296);
    this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377842));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377249));
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377248));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371581));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364042));
    this.e = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364052));
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath().equals(paramString)) && (this.jdField_a_of_type_Blhq != null))
    {
      paramString = this.jdField_a_of_type_Blhq.obtainMessage();
      paramString.what = 1;
      paramString.arg1 = paramInt;
      this.jdField_a_of_type_Blhq.sendMessage(paramString);
    }
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    float f2 = bhtq.b() - this.jdField_f_of_type_Int;
    if (QLog.isColorLevel()) {
  ...
  public void c(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (this.jdField_a_of_type_Bpoz != null)
    {
      if (this.jdField_g_of_type_Int == 0) {
        this.jdField_a_of_type_Bpoz.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, true, this.jdField_g_of_type_Int);
      }
    }
    else {
      return;
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (((QIMMusicConfigManager)bplq.a(2)).a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.mItemId) == null)
      {
        zom.a(new File(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath()));
        if (QLog.isColorLevel()) {
  ...
  public void h()
  {
    ...
    for (;;)
    {
      ...
      ((QIMMusicConfigManager)bplq.a(2)).a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, true);
      if (QLog.isColorLevel())
      {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 4: 
      do
      {
        ...
        i = paramMessage.arg1;
        if (i == 1) {
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697603));
        }
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      } while (!QLog.isColorLevel());
    ...
    case 8: 
      ...
      while (QLog.isColorLevel())
      {
        ...
        if (i == -104)
        {
          ...
          this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697604));
        }
        else
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
          this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697599));
        }
      }
    case 2: 
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      a(bool);
      return false;
      this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697605));
      return false;
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo == null) {
        break;
      }
      ...
      return false;
      String str = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697599);
      ...
      for (paramMessage = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131697600);; paramMessage = str)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
  ...
  public void j()
  {
    ...
    if (this.jdField_c_of_type_Int > bdbt.jdField_c_of_type_Int) {
      this.jdField_a_of_type_Long = ((this.jdField_c_of_type_Int * 400.0F / bdbt.jdField_c_of_type_Int));
    }
    for (;;)
    {
  ...
  public void setMusicProviderView(MusicItemInfo paramMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_Bpvt != null)
    {
      this.jdField_c_of_type_Int = this.jdField_a_of_type_Bpvt.a();
      if (this.jdField_c_of_type_Int < 1000) {
        this.jdField_c_of_type_Int = 1000;
      }
      if (this.jdField_c_of_type_Int != bdbt.e) {
        break label249;
      }
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694395));
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
