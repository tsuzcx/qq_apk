  ...
  extends CaptureComboBase
{
  ...
  {
    super(null);
    this.jdField_a_of_type_DovComQqImCaptureMusicMusicDownloadListener = new CaptureComboMusic.1(this);
    this.d = paramInt;
  ...
  public int a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bool = FileUtils.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath());
        if (bool) {
          continue;
        }
      }
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    MusicProviderView localMusicProviderView2 = (MusicProviderView)paramActivity.findViewById(2131364399);
    MusicProviderView localMusicProviderView1 = localMusicProviderView2;
    if (localMusicProviderView2 == null)
    {
      ((QIMProviderContainerView)paramActivity.findViewById(2131373593)).a(104);
      localMusicProviderView1 = (MusicProviderView)paramActivity.findViewById(2131364399);
  ...
  public int b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          if (!FileUtils.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath()))
          {
            if (QLog.isColorLevel()) {
            ...
            QimMusicDownloader.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.mUrl, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath(), this.jdField_a_of_type_DovComQqImCaptureMusicMusicDownloadListener);
            a();
            i = 2;
            continue;
          }
  ...
  public void c(Activity paramActivity, int paramInt)
  {
    ...
    ((QimMusicPlayer)QIMManager.a().c(8)).b();
  }
