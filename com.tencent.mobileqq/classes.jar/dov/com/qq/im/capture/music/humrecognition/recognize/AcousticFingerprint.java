...
public class AcousticFingerprint
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Tencent/qim/hum_recognition";
  ...
  private String a()
  {
    ...
    int i = a();
    String str1 = HumUtils.a("musicopi_12345683" + "a45a1b" + l);
  ...
  public AcousticFingerprint a(float paramFloat)
  {
    if (QLog.isColorLevel()) {
 ...
 * Qualified Name:     dov.com.qq.im.capture.music.humrecognition.recognize.AcousticFingerprint
