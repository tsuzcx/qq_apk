  ...
  implements QQSpecialAVFilter.MusicWaveformSupporter
{
  ...
  private MusicPlayerScene a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    //   9: if_icmpne +62 -> 71
    //   12: aload_0
    //   13: getfield 44	dov/com/qq/im/capture/music/QimMusicPlayer:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: iconst_1
    ...
    //   23: checkcast 73	dov/com/qq/im/capture/music/MusicPlayerScene
    //   26: astore_3
    //   27: aload_3
    //   28: astore_2
    //   29: aload_3
    //   30: ifnonnull +32 -> 62
    //   33: new 73	dov/com/qq/im/capture/music/MusicPlayerScene
    //   36: dup
    //   37: invokespecial 74	dov/com/qq/im/capture/music/MusicPlayerScene:<init>	()V
    //   40: astore_2
    //   41: aload_2
    //   42: aload_0
    //   43: getfield 49	dov/com/qq/im/capture/music/QimMusicPlayer:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   46: invokevirtual 77	dov/com/qq/im/capture/music/MusicPlayerScene:a	(Ljava/util/List;)V
    //   49: aload_0
    //   50: getfield 44	dov/com/qq/im/capture/music/QimMusicPlayer:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   53: iconst_1
    ...
    //   62: aload_2
    //   63: aload_1
    //   64: invokevirtual 84	dov/com/qq/im/capture/music/MusicPlayerScene:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   67: aload_0
    //   68: monitorexit
    //   69: aload_2
    //   70: areturn
    ...
    //   76: if_icmpne -9 -> 67
    //   79: aload_0
    //   80: getfield 44	dov/com/qq/im/capture/music/QimMusicPlayer:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   83: iconst_2
    ...
    //   90: checkcast 73	dov/com/qq/im/capture/music/MusicPlayerScene
    //   93: astore_3
    //   94: aload_3
    //   95: astore_2
    //   96: aload_3
    ...
    //   108: aload_2
    //   109: aload_0
    //   110: getfield 49	dov/com/qq/im/capture/music/QimMusicPlayer:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: invokevirtual 77	dov/com/qq/im/capture/music/MusicPlayerScene:a	(Ljava/util/List;)V
    //   116: aload_0
    //   117: getfield 44	dov/com/qq/im/capture/music/QimMusicPlayer:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   120: iconst_2
    ...
    //   129: aload_2
    //   130: aload_1
    //   131: invokevirtual 84	dov/com/qq/im/capture/music/MusicPlayerScene:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   134: goto -67 -> 67
    //   137: astore_1
    //   138: aload_0
    //   139: monitorexit
  ...
  {
    if ((this.jdField_a_of_type_DovComQqImCaptureMusicMusicMuteListener != null) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo == null) || (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute() != paramMusicItemInfo.isMute()))) {
      this.jdField_a_of_type_DovComQqImCaptureMusicMusicMuteListener.a(paramMusicItemInfo.isMute());
    }
  }
  ...
  public void a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    {
      localObject = (DownloadTask)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramMusicItemInfo.getLocalPath());
      if (localObject != null) {
  ...
  public void a(MusicMuteListener paramMusicMuteListener)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_DovComQqImCaptureMusicMusicMuteListener != null)) {
      this.jdField_a_of_type_DovComQqImCaptureMusicMusicMuteListener.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute());
    }
  }
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!b(paramMusicItemInfo)) {}
    while ((DanceGameVideoManager.a().a()) || (c(paramMusicItemInfo))) {
      return false;
    }
  ...
  public float getCurrentMusicGain()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoMusicwavesupportMusicWaveformManager != null) && (localMusicItemInfo.needPlay()) && (a()))
          {
            float f = this.jdField_a_of_type_DovComTencentMobileqqShortvideoMusicwavesupportMusicWaveformManager.a(a() - localMusicItemInfo.musicStart);
            return f;
          }
        }
