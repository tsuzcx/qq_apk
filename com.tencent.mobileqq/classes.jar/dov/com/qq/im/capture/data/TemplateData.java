...
{
  public static final Parcelable.Creator<TemplateData> CREATOR = new bjch();
  public int a;
  public String a;
  ...
  public TemplateData(JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject.has("content"))
    {
      ...
      for (boolean bool = false; i < k; bool = true)
      {
        ...
        localQIMTemplateItem.j = (bjbt.jdField_b_of_type_JavaLangString + localQIMTemplateItem.jdField_b_of_type_JavaLangString + ".mp4");
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty((CharSequence)localObject1))) {
          localArrayList.add(new bjfh(str2, str1, (String)localObject1));
        }
      }
