  ...
  extends CaptureComboBase
{
  ...
  CaptureComboFilter.MyDownloaderListener jdField_a_of_type_DovComQqImCaptureDataCaptureComboFilter$MyDownloaderListener = new CaptureComboFilter.MyDownloaderListener(this);
  public boolean a;
  ...
  public static void a(Context paramContext, List<FilterDesc> paramList)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      if (localFilterDesc.name.equals("EMPTY"))
      {
        ...
        AEFilterManagerHolder.getAEFilterManager().d(false);
  ...
  public static boolean a(ComboSet paramComboSet, int paramInt)
  {
    if (paramComboSet != null)
    {
      ...
      if ((paramComboSet != null) && (localComboSet != null) && (paramComboSet.b().equals(localComboSet.b()))) {}
      for (boolean bool = true;; bool = false)
      {
        if (QLog.isColorLevel()) {
          QLog.d("QCombo", 2, new Object[] { "isApplying :" + paramComboSet + " ", Boolean.valueOf(bool) });
        }
        return bool;
      }
    }
  ...
  public static void b(List<FilterDesc> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      new CaptureComboFilter.1(bool2, bool1, localArrayList, paramBoolean).execute(new Void[0]);
      return;
      if (localFilterDesc.id == 9)
      {
        localArrayList.clear();
  ...
  public int b()
  {
    ...
    VideoFilterListDownloader.a().a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, this.jdField_a_of_type_DovComQqImCaptureDataCaptureComboFilter$MyDownloaderListener);
    a();
    return super.b();
  }
