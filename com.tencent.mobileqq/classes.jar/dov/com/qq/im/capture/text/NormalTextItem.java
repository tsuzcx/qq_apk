  ...
  extends DynamicTextItem
{
  ...
  static
  {
    ...
    jdField_b_of_type_Int = AIOUtils.a(22.0F, localResources);
    d = AIOUtils.a(14.0F, localResources);
    jdField_c_of_type_Int = Math.min(localResources.getDisplayMetrics().widthPixels - TextLayer.jdField_a_of_type_Int, AIOUtils.a(270.0F, localResources));
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.jdField_b_of_type_AndroidTextStaticLayout = StaticLayoutWithMaxLines.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, jdField_c_of_type_Int, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, this.e);
    str = paramString;
    if (this.jdField_b_of_type_AndroidTextStaticLayout.getLineCount() > this.e)
    {
      ...
      this.jdField_b_of_type_AndroidTextStaticLayout = StaticLayoutWithMaxLines.a(str, 0, str.length(), this.jdField_a_of_type_AndroidTextTextPaint, jdField_c_of_type_Int, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, this.e);
    }
    paramInt = i;
