...
{
  private static final int jdField_a_of_type_Int = AIOUtils.a(20.0F, BaseApplicationImpl.getContext().getResources());
  private static final int jdField_b_of_type_Int = AIOUtils.a(12.0F, BaseApplicationImpl.getContext().getResources());
  ...
  public BubbleTextItem(int paramInt, List paramList, Typeface paramTypeface, Bitmap paramBitmap)
  {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    int j = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText("最多五个字个字");
    this.jdField_b_of_type_AndroidTextStaticLayout = StaticLayoutWithMaxLines.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, j, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 3);
    int k = this.jdField_b_of_type_AndroidTextStaticLayout.getLineCount();
    float f1 = 0.0F;
    paramInt = i;
    while (paramInt < k)
    {
    ...
    float f3 = Math.max(this.jdField_a_of_type_AndroidGraphicsNinePatch.getWidth(), jdField_b_of_type_Int + jdField_a_of_type_Int + f1);
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    paramCanvas.translate(jdField_a_of_type_Int, this.jdField_a_of_type_AndroidGraphicsNinePatch.getHeight() * 0.4F);
    ...
    if (b(0))
    {
      ...
      float f2 = a(this.jdField_b_of_type_AndroidTextStaticLayout);
