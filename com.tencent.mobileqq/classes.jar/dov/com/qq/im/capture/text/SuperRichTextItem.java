  ...
  extends DynamicTextItem
{
  ...
  static
  {
    ...
    jdField_b_of_type_Int = AIOUtils.a(36.0F, localResources);
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.b(new PerLineBackgoundDrawer(-65536, d));
    this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.a(paramString, c, jdField_b_of_type_Int, this.jdField_a_of_type_AndroidTextTextPaint);
    this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.a(new LineMarginCoverter(this.e));
    this.jdField_a_of_type_Float = this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.a(1, this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.a()).width();
    this.jdField_b_of_type_Float = this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.a(1, this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.a()).height();
    this.jdField_a_of_type_DovComQqImCaptureTextTextDrawImplement.a(new CenterMarginCoverter(this.jdField_a_of_type_Float, this.jdField_b_of_type_Float));
  }
 ...
 * Qualified Name:     dov.com.qq.im.capture.text.SuperRichTextItem
