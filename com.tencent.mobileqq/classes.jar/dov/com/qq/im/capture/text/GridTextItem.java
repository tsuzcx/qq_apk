  ...
  extends DynamicTextItem
{
  ...
  public GridTextItem(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface, List<Bitmap> paramList1)
  {
    ...
    {
      this.c += this.g;
      this.c += AIOUtils.a(3.0F, this.jdField_a_of_type_AndroidContentResResources);
      paramInt = this.c;
      this.c = (((Bitmap)this.jdField_a_of_type_JavaUtilList.get(1)).getHeight() + paramInt);
    }
    if (this.h <= 0) {
      this.h = AIOUtils.a(2.0F, this.jdField_a_of_type_AndroidContentResResources);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      if (paramInt > 1) {
        this.d += (paramInt - 1) * AIOUtils.a(9.0F, this.jdField_a_of_type_AndroidContentResResources);
      }
    ...
    label184:
    this.d = (((Bitmap)this.jdField_a_of_type_JavaUtilList.get(1)).getWidth() * 5 + AIOUtils.a(9.0F, this.jdField_a_of_type_AndroidContentResResources) * 4);
    this.f = (paramInt / 5);
    if (paramInt % 5 > 0) {
      this.f += 1;
    }
    this.e = ((this.f - 1) * this.c + (this.f - 1) * AIOUtils.a(15.0F, this.jdField_a_of_type_AndroidContentResResources));
    int i = this.e;
