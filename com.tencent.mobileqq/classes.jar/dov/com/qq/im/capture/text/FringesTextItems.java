  ...
  extends DynamicTextItem
{
  ...
  private static final String jdField_a_of_type_JavaLangString = FringesTextItems.class.getSimpleName();
  ...
  public FringesTextItems(int paramInt, List paramList, Typeface paramTypeface, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    QLog.i(TextLayer.jdField_a_of_type_JavaLangString, 1, "setLetterSpacing" + bool);
  ...
  private void c(Canvas paramCanvas)
  {
    ...
    paramCanvas.restore();
    paramCanvas.save();
    paramCanvas.translate(jdField_b_of_type_Float - 0.5F * (this.jdField_b_of_type_AndroidTextStaticLayout.getWidth() - this.i), e + this.jdField_b_of_type_AndroidGraphicsBitmap.getHeight());
    paramCanvas.save();
  ...
  private void d(Canvas paramCanvas)
  {
    ...
    {
      paramCanvas.translate(f1 - (this.jdField_b_of_type_AndroidTextStaticLayout.getWidth() - this.i) * 0.5F, f + this.jdField_b_of_type_AndroidGraphicsBitmap.getHeight());
      paramCanvas.save();
      paramCanvas.translate(-jdField_a_of_type_Float, -jdField_a_of_type_Float);
      this.jdField_a_of_type_AndroidTextTextPaint.setColor(-65536);
      this.jdField_b_of_type_AndroidTextStaticLayout.draw(paramCanvas);
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramInt = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText("最多最多七个字");
    this.jdField_b_of_type_AndroidTextStaticLayout = new StaticLayout(paramString, this.jdField_a_of_type_AndroidTextTextPaint, paramInt, Layout.Alignment.ALIGN_CENTER, 1.2F, 0.0F, false);
    this.i = 0.0F;
    int i2 = this.jdField_b_of_type_AndroidTextStaticLayout.getLineCount();
    paramInt = i1;
    while (paramInt < i2)
    {
      this.i = Math.max(this.jdField_b_of_type_AndroidTextStaticLayout.getLineWidth(paramInt), this.i);
      paramInt += 1;
    }
    ...
    {
      this.m = this.j;
      this.n = (this.jdField_b_of_type_AndroidTextStaticLayout.getHeight() + jdField_a_of_type_Float * 2.0F + c + d + e + this.jdField_b_of_type_AndroidGraphicsBitmap.getHeight());
      return;
    }
    float f2 = (this.jdField_b_of_type_AndroidTextStaticLayout.getLineWidth(i2 - 2) * 0.5F + h + this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth()) * 2.0F;
    this.m = Math.max(this.j, f2);
    this.n = (this.jdField_b_of_type_AndroidTextStaticLayout.getHeight() + jdField_a_of_type_Float * 2.0F + c + d + f + this.jdField_b_of_type_AndroidGraphicsBitmap.getHeight());
    if (f2 > this.j) {}
    for (;;)
    {
      this.k = f1;
      this.l = (this.jdField_b_of_type_AndroidTextStaticLayout.getLineBottom(i2 - 2) - this.jdField_a_of_type_AndroidTextTextPaint.descent() - this.jdField_a_of_type_AndroidGraphicsBitmap.getHeight() + this.jdField_b_of_type_AndroidGraphicsBitmap.getHeight() + f);
      return;
      f1 = (this.j - f2) * 0.5F;
    }
  }
 ...
 * Qualified Name:     dov.com.qq.im.capture.text.FringesTextItems
