  ...
  extends CaptureComboBase
{
  ...
  private DynamicTextConfigManager.IDynamicTextResDownloadCallback jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager$IDynamicTextResDownloadCallback = new CaptureComboText.2(this);
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    float f = ScreenUtil.a * this.c / localDynamicTextItem.a();
    TextLayer.LayerParams localLayerParams = new TextLayer.LayerParams(this.jdField_a_of_type_Float * ScreenUtil.a, this.b * ScreenUtil.a, f, 0.0F, 0.0F, 0.0F, localDynamicTextItem.a(), localDynamicTextItem.b());
    if (localDoodleLayout.a().a(localLayerParams, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper, localDoodleLayout.d()) != null)
    {
    ...
    QQToast.a(paramActivity, paramActivity.getString(2131698302), 0).a();
