  ...
  extends CaptureComboBase
{
  ...
  private DynamicTextConfigManager.IDynamicTextResDownloadCallback jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager$IDynamicTextResDownloadCallback = new amxm(this);
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    QQToast.a(paramActivity, paramActivity.getString(2131439183), 0).a();
    ThreadManager.getUIHandler().post(new amxl(this, localDoodleLayout));
    return 0;
  }
