  ...
  extends DynamicTextItem
{
  ...
  private String jdField_a_of_type_JavaLangString = HardCodeUtil.a(2131705906);
  ...
  public JourneyTextItem(int paramInt, List<String> paramList, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    d();
    this.m = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(HardCodeUtil.a(2131705907)));
    this.n = ((int)(this.jdField_b_of_type_AndroidTextTextPaint.measureText(HardCodeUtil.a(2131705905)) * 10.0F));
    if (paramList == null) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    String str2 = a(paramInt, new JourneyTextItem.1(this));
    ...
    for (;;)
    {
      ...
      break label173;
      label965:
      this.jdField_a_of_type_AndroidTextStaticLayout = StaticLayoutWithMaxLines.a(str2, 0, str2.length(), this.jdField_b_of_type_AndroidTextTextPaint, this.n, Layout.Alignment.ALIGN_NORMAL, 1.5F, 0.0F, false, null, 0, 2);
  ...
  {
    boolean bool = false;
    String str1 = a(0, new JourneyTextItem.2(this));
    String str2 = b(1);
