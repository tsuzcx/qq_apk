...
public class TextDrawImplement
{
  ...
  private BaseBackgroundDrawer jdField_a_of_type_DovComQqImCaptureTextBaseBackgroundDrawer;
  private TextDrawer jdField_a_of_type_DovComQqImCaptureTextTextDrawer;
  ...
  {
    if (paramInt == 1) {
      this.jdField_a_of_type_DovComQqImCaptureTextTextDrawer = new PerLineDrawer();
    }
    while (paramInt == 0) {
      return;
    }
  ...
  {
    if ((this.jdField_a_of_type_Int == 2) && (this.jdField_a_of_type_DovComQqImCaptureTextBaseBackgroundDrawer != null)) {
      this.jdField_a_of_type_DovComQqImCaptureTextBaseBackgroundDrawer.a(paramCanvas, this.jdField_a_of_type_JavaUtilArrayList, paramInt1, paramInt2);
    }
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      PerLineModel localPerLineModel = (PerLineModel)localIterator.next();
      if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_DovComQqImCaptureTextBaseBackgroundDrawer != null)) {
        localPerLineModel.a(paramCanvas, this.jdField_a_of_type_DovComQqImCaptureTextBaseBackgroundDrawer, paramInt1, paramInt2);
      }
  ...
  public void a(BaseBackgroundDrawer paramBaseBackgroundDrawer)
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureTextBaseBackgroundDrawer = paramBaseBackgroundDrawer;
  }
 ...
 * Qualified Name:     dov.com.qq.im.capture.text.TextDrawImplement
