  ...
  extends DynamicTextItem
{
  ...
  public LangTextItem(int paramInt, @NonNull List paramList, Typeface paramTypeface1, Typeface paramTypeface2, Bitmap paramBitmap)
  {
  ...
  private void a(Typeface paramTypeface1, Typeface paramTypeface2)
  {
    ...
    this.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText("噶"));
    ...
    this.jdField_c_of_type_Int = ((int)(this.jdField_b_of_type_Int * 1.3F));
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.d.clear();
    paramString = a(paramInt, new amxz(this)).split("\n");
    ...
    if (paramInt < i)
    {
      ...
      if ((((String)localObject).length() == 6) && (i == 1))
      {
        ...
        this.d.add(Integer.valueOf((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText((String)localObject)));
      }
      for (;;)
      {
        paramInt += 1;
        ...
        if (((String)localObject).length() > 15)
        {
          ...
          this.d.add(Integer.valueOf((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(str)));
    ...
    this.jdField_a_of_type_Int = a(this.d);
  }
  ...
  protected void a(Canvas paramCanvas)
  {
    ...
    paramCanvas.save();
    paramCanvas.translate(this.jdField_a_of_type_Int - a(77.0F), this.jdField_c_of_type_Int - a(78.0F));
    ...
    while (j < i1)
    {
      int n = (this.jdField_a_of_type_Int - ((Integer)this.d.get(j)).intValue()) / 2;
      ...
      if (m < str.length())
      {
        ...
        int i3;
        int i2;
        if (SpellUtil.a(((String)localObject2).charAt(0)) == 3)
        {
          ...
          paramCanvas.drawText((String)localObject2, n, i - 0.085F * this.jdField_c_of_type_Int, this.jdField_a_of_type_AndroidTextTextPaint);
          float f1 = n;
          float f2 = i - this.jdField_c_of_type_Int + (this.jdField_c_of_type_Int - i3) / 2;
          float f3 = n + i2;
          int i4 = this.jdField_c_of_type_Int;
          localObject2 = new RectF(f1, f2, f3, (i3 + this.jdField_c_of_type_Int) / 2 + (i - i4));
 ...
 * Qualified Name:     dov.com.qq.im.capture.text.LangTextItem
