  ...
  extends BaseBackgroundDrawer
{
  ...
  public void a(Canvas paramCanvas, ArrayList<PerLineModel> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    RectF localRectF1 = ((PerLineModel)paramArrayList.get(0)).jdField_a_of_type_AndroidGraphicsRectF;
    RectF localRectF2 = ((PerLineModel)paramArrayList.get(paramArrayList.size() - 1)).jdField_a_of_type_AndroidGraphicsRectF;
    float f3 = localRectF1.width() / ((PerLineModel)paramArrayList.get(0)).jdField_a_of_type_JavaLangString.length();
    ...
    {
      localRectF1 = ((PerLineModel)paramArrayList.get(i)).jdField_a_of_type_AndroidGraphicsRectF;
      if ((f2 != -1.0F) && (f1 != -1.0F)) {
        break label504;
      }
      localRectF2 = ((PerLineModel)paramArrayList.get(i + 1)).jdField_a_of_type_AndroidGraphicsRectF;
 ...
 * Qualified Name:     dov.com.qq.im.capture.text.PathDrawBackground
