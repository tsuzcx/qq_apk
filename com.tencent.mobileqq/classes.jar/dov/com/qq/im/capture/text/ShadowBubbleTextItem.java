  ...
  extends DynamicTextItem
{
  ...
  List jdField_a_of_type_JavaUtilList = new ArrayList(3);
  
  public ShadowBubbleTextItem(int paramInt, Typeface paramTypeface, @NonNull List paramList1, @NonNull List paramList2)
  {
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, String paramString, Point paramPoint)
  {
    ...
    while (i >= 16)
    {
      this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(AIOUtils.a(i, this.jdField_a_of_type_AndroidContentResResources));
      ...
      this.jdField_a_of_type_AndroidTextStaticLayout = localStaticLayout;
      int j = 1;
      paramInt3 = j;
  ...
  public float a()
  {
    return ((Bitmap)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int)).getWidth();
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    while (paramInt < 3)
    {
      ...
      f1 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(paramInt * 4)], this.jdField_a_of_type_AndroidContentResResources);
      f2 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(paramInt * 4 + 1)], this.jdField_a_of_type_AndroidContentResResources);
      localObject1[paramInt] = a((int)f1, (int)f2, 37, (String)localObject2, arrayOfPoint[paramInt]);
      arrayOfStaticLayout[paramInt] = this.jdField_a_of_type_AndroidTextStaticLayout;
      paramString[paramInt] = this.jdField_a_of_type_AndroidTextStaticLayout.getPaint().getTextSize();
      paramInt += 1;
    }
    ...
    if (paramInt < 3)
    {
      ...
      if (localObject1[paramInt] != 0)
      {
        f1 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(paramInt * 4)], this.jdField_a_of_type_AndroidContentResResources);
        f2 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(paramInt * 4 + 1)], this.jdField_a_of_type_AndroidContentResResources);
        localObject2[paramInt] = (a(arrayOfStaticLayout[paramInt]) * arrayOfStaticLayout[paramInt].getHeight() / (f1 * f2));
      }
      for (;;)
      {
    ...
    this.jdField_a_of_type_AndroidTextStaticLayout = arrayOfStaticLayout[j];
  ...
  {
    paramCanvas.save();
    paramCanvas.drawBitmap((Bitmap)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int), 0.0F, 0.0F, this.jdField_a_of_type_AndroidTextTextPaint);
    if (this.jdField_a_of_type_AndroidTextStaticLayout != null)
    {
      float f1 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_a_of_type_Int * 4 + 2)], this.jdField_a_of_type_AndroidContentResResources);
      float f2 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_a_of_type_Int * 4 + 3)], this.jdField_a_of_type_AndroidContentResResources);
      float f3 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_a_of_type_Int * 4)], this.jdField_a_of_type_AndroidContentResResources);
      float f4 = AIOUtils.a(jdField_a_of_type_ArrayOfFloat[(this.jdField_a_of_type_Int * 4 + 1)], this.jdField_a_of_type_AndroidContentResResources);
      float f5 = a(this.jdField_a_of_type_AndroidTextStaticLayout);
      float f6 = this.jdField_a_of_type_AndroidTextStaticLayout.getHeight();
  ...
  public float b()
  {
    return ((Bitmap)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int)).getHeight();
  }
 ...
 * Qualified Name:     dov.com.qq.im.capture.text.ShadowBubbleTextItem
