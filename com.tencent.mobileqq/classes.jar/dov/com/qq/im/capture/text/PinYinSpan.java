  ...
  implements Cloneable
{
  ...
  private PinYinSpan.OnHanZiToPinYinListener jdField_a_of_type_DovComQqImCaptureTextPinYinSpan$OnHanZiToPinYinListener = null;
  private PinYinSpan.OnPinYinDrawListener jdField_a_of_type_DovComQqImCaptureTextPinYinSpan$OnPinYinDrawListener = null;
  private PinYinSpan.OnTextDrawListener jdField_a_of_type_DovComQqImCaptureTextPinYinSpan$OnTextDrawListener = null;
  ...
  private void a(@NonNull Paint paramPaint, @NonNull PinYinSpan.PaintType paramPaintType)
  {
    ...
    switch (PinYinSpan.1.a[paramPaintType.ordinal()])
    {
    }
    do
    {
