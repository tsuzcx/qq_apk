  ...
  extends DynamicTextItem
{
  ...
  private void a(Typeface paramTypeface, Bitmap paramBitmap)
  {
    ...
    this.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(HardCodeUtil.a(2131704732)));
    this.f = a(27.0F);
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(this.f);
    this.c = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(HardCodeUtil.a(2131704731)));
    this.g = a(18.0F);
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(this.g);
    this.d = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(HardCodeUtil.a(2131704733)));
    this.k = a(0.0F);
    this.l = a(0.0F);
