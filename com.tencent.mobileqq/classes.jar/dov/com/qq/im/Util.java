...
public class Util
{
  ...
  public static android.graphics.Bitmap a(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    //   0: iload_1
    //   1: iload_2
    //   2: getstatic 21	android/graphics/Bitmap$Config:ARGB_8888	Landroid/graphics/Bitmap$Config;
    //   5: invokestatic 27	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   8: astore 4
    //   10: aload 4
    //   12: iload_3
    //   13: invokevirtual 31	android/graphics/Bitmap:setPremultiplied	(Z)V
    //   16: new 33	java/io/File
    //   19: dup
    //   20: aload_0
    //   21: invokespecial 36	java/io/File:<init>	(Ljava/lang/String;)V
    //   24: invokestatic 39	dov/com/qq/im/Util:a	(Ljava/io/File;)[B
    //   27: astore_0
    //   28: aload 4
    //   30: invokevirtual 43	android/graphics/Bitmap:getWidth	()I
    //   33: aload 4
    //   35: invokevirtual 46	android/graphics/Bitmap:getHeight	()I
    //   38: imul
    //   39: iconst_4
    //   40: imul
    //   41: invokestatic 52	java/nio/ByteBuffer:allocate	(I)Ljava/nio/ByteBuffer;
    //   44: astore 5
    //   46: aload_0
    //   47: ifnull +10 -> 57
    //   50: aload 5
    //   52: aload_0
    //   53: invokevirtual 56	java/nio/ByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   56: pop
    //   57: aload 5
    //   59: iconst_0
    //   60: invokevirtual 60	java/nio/ByteBuffer:position	(I)Ljava/nio/Buffer;
    //   63: pop
    //   64: aload 4
    //   66: aload 5
    //   68: invokevirtual 64	android/graphics/Bitmap:copyPixelsFromBuffer	(Ljava/nio/Buffer;)V
    //   71: aload 4
    //   73: areturn
    //   74: astore_0
    //   75: aconst_null
    ...
    //   93: aload_0
    //   94: invokevirtual 79	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   115: iconst_4
    //   116: ldc 90
    //   118: invokestatic 88	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   121: aload 4
    //   123: areturn
    //   124: astore_0
    //   125: goto -12 -> 113
  ...
  public static void a(String paramString, android.graphics.Bitmap paramBitmap)
  {
    ...
    //   95: ifnull +7 -> 102
    //   98: aload_0
    //   99: invokevirtual 153	java/io/FileOutputStream:close	()V
    //   102: return
    //   103: astore_0
    //   104: aload_0
    //   105: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   108: return
    //   109: astore_1
    //   110: aload_3
    //   111: astore_0
    ...
    //   113: astore_2
    //   114: aload_1
    //   115: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   118: aload_0
    //   119: ifnull -17 -> 102
    //   122: aload_0
    //   123: invokevirtual 153	java/io/FileOutputStream:close	()V
    //   126: return
    //   127: astore_0
    //   128: aload_0
    //   129: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   132: return
    //   133: astore_1
    //   134: aload 4
    //   136: astore_0
    ...
    //   138: astore_2
    //   139: aload_1
    //   140: invokevirtual 115	java/lang/Exception:printStackTrace	()V
    //   143: aload_0
    //   144: astore_2
    //   145: ldc 66
    //   147: iconst_4
    ...
    //   160: aload_1
    //   161: invokevirtual 79	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   170: invokestatic 88	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   173: aload_0
    //   174: ifnull -72 -> 102
    //   177: aload_0
    //   178: invokevirtual 153	java/io/FileOutputStream:close	()V
    //   181: return
    //   182: astore_0
    //   183: aload_0
    //   184: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   187: return
    //   188: astore_1
    //   189: aload 5
    //   191: astore_0
    ...
    //   193: astore_2
    //   194: aload_1
    //   195: invokevirtual 118	java/lang/OutOfMemoryError:printStackTrace	()V
    //   198: aload_0
    //   199: astore_2
    //   200: ldc 66
    //   202: iconst_4
    //   203: new 68	java/lang/StringBuilder
    //   206: dup
    ...
    //   215: aload_1
    //   216: invokevirtual 121	java/lang/OutOfMemoryError:getMessage	()Ljava/lang/String;
    ...
    //   225: invokestatic 88	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   228: aload_0
    //   229: ifnull -127 -> 102
    //   232: aload_0
    //   233: invokevirtual 153	java/io/FileOutputStream:close	()V
    //   236: return
    //   237: astore_0
    //   238: aload_0
    //   239: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   242: return
    //   243: astore_0
    //   244: aload_2
    //   245: ifnull +7 -> 252
    //   248: aload_2
    //   249: invokevirtual 153	java/io/FileOutputStream:close	()V
    //   252: aload_0
    //   253: athrow
    //   254: astore_1
    //   255: aload_1
    //   256: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   259: goto -7 -> 252
    //   262: astore_1
    //   263: aload_0
    //   264: astore_2
  ...
  private static byte[] a(java.io.File paramFile)
  {
    ...
    //   1: astore 4
    //   3: aload_0
    //   4: invokevirtual 181	java/io/File:isFile	()Z
    //   7: ifeq +135 -> 142
    //   10: new 183	java/io/FileInputStream
    //   13: dup
    //   14: aload_0
    //   15: invokespecial 184	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   18: astore_2
    //   19: aload_2
    //   20: astore_0
    //   21: sipush 1024
    ...
    //   27: aload_2
    //   28: astore_0
    //   29: new 186	java/io/ByteArrayOutputStream
    //   32: dup
    //   33: invokespecial 187	java/io/ByteArrayOutputStream:<init>	()V
    //   36: astore 5
    //   38: aload_2
    //   39: astore_0
    //   40: aload_2
    //   41: aload_3
    //   42: invokevirtual 191	java/io/FileInputStream:read	([B)I
    //   45: istore_1
    //   46: iload_1
    //   47: iconst_m1
    //   48: if_icmpeq +39 -> 87
    ...
    //   56: iconst_0
    //   57: iload_1
    //   58: invokevirtual 194	java/io/ByteArrayOutputStream:write	([BII)V
    //   61: goto -23 -> 38
    //   64: astore_3
    //   65: aload_2
    //   66: astore_0
    //   67: aload_3
    //   68: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   71: aload 4
    //   73: astore_0
    //   74: aload_2
    //   75: ifnull +10 -> 85
    //   78: aload_2
    //   79: invokevirtual 195	java/io/FileInputStream:close	()V
    //   82: aload 4
    //   84: astore_0
    //   85: aload_0
    //   86: areturn
    ...
    //   88: astore_0
    //   89: aload 5
    //   91: invokevirtual 198	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   94: astore_3
    //   95: aload_3
    //   96: astore_0
    //   97: aload_2
    //   98: ifnull -13 -> 85
    //   101: aload_2
    //   102: invokevirtual 195	java/io/FileInputStream:close	()V
    //   105: aload_3
    //   106: areturn
    //   107: astore_0
    //   108: aload_0
    //   109: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   112: aload_3
    //   113: areturn
    //   114: astore_0
    //   115: aload_0
    //   116: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   119: aconst_null
    //   120: areturn
    //   121: astore_2
    //   122: aconst_null
    ...
    //   125: ifnull +7 -> 132
    //   128: aload_0
    //   129: invokevirtual 195	java/io/FileInputStream:close	()V
    //   132: aload_2
    //   133: athrow
    //   134: astore_0
    //   135: aload_0
    //   136: invokevirtual 154	java/io/IOException:printStackTrace	()V
    //   139: goto -7 -> 132
    //   142: ldc 66
    //   144: iconst_4
    //   145: new 68	java/lang/StringBuilder
    //   148: dup
    ...
    //   157: aload_0
    //   158: invokevirtual 203	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   167: invokestatic 88	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   170: aconst_null
    //   171: areturn
    //   172: astore_2
    //   173: goto -49 -> 124
 ...
 * Qualified Name:     dov.com.qq.im.Util
