  ...
  implements FFmpegExecuteResponseCallback
{
  ...
  public EncodeVideoTask$VideoSaveAlumCallBack(PublishVideoEntry paramPublishVideoEntry, String paramString1, String paramString2, ansk paramansk)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      this.jdField_a_of_type_Ansk.b(this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry, this.b);
    }
  }
  
  public void b(String paramString)
  {
    this.jdField_a_of_type_Ansk.a(-12);
    if (QLog.isColorLevel()) {
