  ...
  extends AsyncTask
{
  ...
  private int a(String paramString1, String paramString2, PublishVideoEntry paramPublishVideoEntry, boolean paramBoolean)
  {
    ...
    paramPublishVideoEntry = new MergeEditVideo.EditParam(CodecParam.r, paramPublishVideoEntry);
    paramPublishVideoEntry.a = paramBoolean;
    return localMergeEditVideo.a(paramString1, paramString2, paramPublishVideoEntry);
  }
