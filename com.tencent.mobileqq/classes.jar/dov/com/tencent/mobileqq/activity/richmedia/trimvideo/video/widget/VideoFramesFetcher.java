  ...
  implements bpzk
{
  ...
  private BlockingQueue<bpzo> jdField_a_of_type_JavaUtilConcurrentBlockingQueue;
  private ConcurrentHashMap<Integer, bpzo> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  private bpzi b(int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          bpzo localbpzo1 = (bpzo)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
          l = jdField_a_of_type_Long;
          jdField_a_of_type_Long = 1L + l;
          localbpzo1.jdField_a_of_type_Long = l;
          return null;
        }
      }
      ...
      jdField_a_of_type_Long = 1L + l;
      localbpzo2 = new bpzo(this, l, paramInt, paramInt + this.b);
    } while (this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue == null);
    this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue.offer(localbpzo2);
    return null;
  }
