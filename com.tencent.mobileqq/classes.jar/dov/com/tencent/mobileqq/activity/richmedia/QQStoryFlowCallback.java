...
public class QQStoryFlowCallback
{
        ...
        if (paramLocalMediaInfo.mMimeType.contains("video"))
        {
          if ((TextUtils.isEmpty(paramLocalMediaInfo.path)) || (paramLocalMediaInfo.path.equalsIgnoreCase("null")))
          {
            ...
            if (paramInt7 == 11)
            {
              ...
              JSONObject localJSONObject = TribePublishLauncher.a(paramLocalMediaInfo);
            ...
            break label839;
            label227:
            if (AECameraEntry.a(paramActivity.getIntent(), paramInt7)) {
              break label885;
            }
            if (!AECameraEntry.c(paramActivity.getIntent())) {
              break label889;
            }
            break label885;
            label252:
            paramString1 = new EditVideoParams(paramInt7, paramInt2, paramString1, localBundle);
            paramString1.f = paramActivity.getIntent().getIntExtra("VIDEO_STORY_FROM_TYPE", AECameraEntry.a.a());
            if (l != 0L) {
            ...
            StoryIntentUtils.a(paramLocalMediaInfo, paramActivity.getIntent().getExtras(), paramActivity);
            ...
            paramLocalMediaInfo.putExtra("VIDEO_STORY_FROM_TYPE", AECameraEntry.a(paramActivity.getIntent()));
            if (paramInt7 == 14)
            {
              paramLocalMediaInfo.putExtra("VIDEO_STORY_JUMP_TO_TYPE", AECameraEntry.b(paramActivity.getIntent()));
              paramLocalMediaInfo.putExtra("VIDEO_STORY_MEDIA_TYPE", AECameraEntry.c(paramActivity.getIntent()));
            }
            if (paramBundle == null) {
              break label918;
            }
  ...
  public static boolean a()
  {
    ...
    e = ((Integer)localStoryConfigManager.b("localUploadVideoRatioLimit", Integer.valueOf(e))).intValue();
    f = ((Integer)localStoryConfigManager.b("localUploadImageSizeLimit", Integer.valueOf(f))).intValue();
    g = ((Integer)localStoryConfigManager.b("localUploadImageMinResolutionLimit", Integer.valueOf(g))).intValue();
    jdField_a_of_type_Float = e / 10000 / 1000.0F;
    jdField_b_of_type_Float = e % 10000 / 1000.0F;
    SLog.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config %d|%d|%d|%d|%d|%d", new Object[] { Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(c), Integer.valueOf(e), Integer.valueOf(f), Integer.valueOf(g) });
    SLog.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config from %d to %d", new Object[] { Integer.valueOf(h), Integer.valueOf(i) });
    h = localStoryConfigManager.b();
    return true;
  }
  ...
  public static boolean a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    if (localLocalMediaInfo == null) {
      throw new IllegalArgumentException(HardCodeUtil.a(2131710855));
    }
    ...
    if (j == 10012)
    {
      if (l < QIMTribeEffectsCameraCaptureUnit.jdField_a_of_type_Int)
      {
  ...
  public static boolean a(@NonNull Activity paramActivity, @NonNull LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        label200:
        StoryReportor.a("video_shoot", "chose_video", 0, 0, new String[] { str1, String.valueOf(k), String.valueOf(f1) });
      ...
      for (;;)
      {
        ...
        {
          localObject = QQToast.a(paramActivity, 1, HardCodeUtil.a(2131710845), 0);
          SLog.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, HardCodeUtil.a(2131710833), 0);
          SLog.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 1;
        ...
        if ((f1 < 0.4F) || (f1 > 2.2F))
        {
          localObject = QQToast.a(paramActivity, 1, HardCodeUtil.a(2131710838), 0);
          SLog.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          j = 3;
          i = 1;
          break;
        ...
        localObject = QQToast.a(paramActivity, 1, HardCodeUtil.a(2131710824), 0);
        SLog.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 6;
        k = 8;
        i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, HardCodeUtil.a(2131710840), 0);
          SLog.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 0;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, HardCodeUtil.a(2131710839), 0);
          SLog.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 0;
        ...
        localObject = QQToast.a(paramActivity, 1, HardCodeUtil.a(2131710837), 0);
        SLog.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 3;
        i = 0;
        break;
