  ...
  implements View.OnClickListener
{
  ...
  public void a()
  {
    ...
    int k = aciy.a(16.0F, getResources());
    int m = aciy.a(6.0F, getResources());
    ...
    ((ImageView)localObject).setImageResource(2130837629);
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130843807);
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130843691);
  ...
  public void a(int paramInt1, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bhga parambhga, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bhga = parambhga;
    ...
    paramInt1 = bjin.jdField_a_of_type_Int;
    boolean bool;
    if ((paramPtvTemplateInfo.funcType == PtvTemplateManager.PtvTemplateInfo.FUNC_REDBAG_GET) && (awkk.a(paramInt1)))
    {
      bool = true;
      ...
      parambhga = URLDrawable.URLDrawableOptions.obtain();
      paramInt1 = aciy.a(60.0F, getResources());
      Drawable localDrawable = getResources().getDrawable(2130843690);
      parambhga.mRequestWidth = paramInt1;
      parambhga.mRequestHeight = paramInt1;
      parambhga.mFailedDrawable = localDrawable;
      parambhga.mLoadingDrawable = localDrawable;
      parambhga.mRetryCount = 3;
      parambhga = URLDrawable.getDrawable(paramPtvTemplateInfo.iconurl, parambhga);
      if (parambhga.getStatus() == 2) {
        parambhga.restartDownload();
      }
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(parambhga);
      ...
      this.c.setImageResource(2130845004);
    }
    for (;;)
    {
      vnd.a(paramPtvTemplateInfo);
      return;
      bool = false;
      break;
      label433:
    ...
    for (;;)
    {
      this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.a(bhpu.a(paramPtvTemplateInfo));
      return;
      this.c.setVisibility(8);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bhga != null) {
      this.jdField_a_of_type_Bhga.a(this.jdField_a_of_type_Int);
    }
  }
}
