  ...
  implements View.OnClickListener
{
  ...
  public void a()
  {
    ...
    ((ImageView)localObject).setImageResource(2130837694);
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844584);
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130844474);
  ...
  public void a(int paramInt1, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bmqz parambmqz, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bmqz = parambmqz;
    ...
    paramInt1 = boba.jdField_a_of_type_Int;
    boolean bool;
    if ((paramPtvTemplateInfo.funcType == PtvTemplateManager.PtvTemplateInfo.FUNC_REDBAG_GET) && (bbwb.a(paramInt1)))
    {
      bool = true;
      ...
      parambmqz = URLDrawable.URLDrawableOptions.obtain();
      paramInt1 = AIOUtils.dp2px(60.0F, getResources());
      Drawable localDrawable = getResources().getDrawable(2130844473);
      parambmqz.mRequestWidth = paramInt1;
      parambmqz.mRequestHeight = paramInt1;
      parambmqz.mFailedDrawable = localDrawable;
      parambmqz.mLoadingDrawable = localDrawable;
      parambmqz.mRetryCount = 3;
      parambmqz = URLDrawable.getDrawable(paramPtvTemplateInfo.iconurl, parambmqz);
      if (parambmqz.getStatus() == 2) {
        parambmqz.restartDownload();
      }
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(parambmqz);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845852);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849654);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      if ((!paramPtvTemplateInfo.id.equals(paramString)) || (!paramPtvTemplateInfo.usable)) {
        break label560;
      }
      ...
      this.c.setImageResource(2130845841);
    }
    for (;;)
    {
      yqu.a(paramPtvTemplateInfo);
      return;
      bool = false;
      break;
      label433:
      ...
      {
        this.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130845849);
        break label303;
      }
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130845850);
      break label303;
      label560:
    ...
    for (;;)
    {
      this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.a(bmzd.a(paramPtvTemplateInfo));
      return;
      this.c.setVisibility(8);
    }
  }
  ...
  public void onClick(View paramView)
  {
    if (this.jdField_a_of_type_Bmqz != null) {
      this.jdField_a_of_type_Bmqz.a(this.jdField_a_of_type_Int);
    }
