  ...
  implements FFmpegExecuteResponseCallback
{
  ...
  public void onFinish(boolean paramBoolean)
  {
    ...
    ((HashMap)localObject).put("generate_video_cost", this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask.a + "");
    ...
    int i;
    Intent localIntent;
    if (SaveVideoActivity.SaveVideoTask.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask).get() != null)
    {
      localObject = (Activity)SaveVideoActivity.SaveVideoTask.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask).get();
      if (SaveVideoActivity.SaveVideoTask.b(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask).get() != null) {
        SaveVideoActivity.a((AppInterface)SaveVideoActivity.SaveVideoTask.b(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask).get(), this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
      }
      if (!paramBoolean) {
        break label335;
      }
      i = SaveVideoActivity.SaveVideoTask.b(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask, -1);
      if (!AECameraEntry.e(((Activity)localObject).getIntent())) {
        break label348;
      }
    ...
    SaveVideoActivity.SaveVideoTask.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask, SaveVideoActivity.SaveVideoTask.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaSaveVideoActivity$SaveVideoTask));
  }
  ...
  public void onSuccess(String paramString)
  {
    ...
    com.tencent.mobileqq.utils.FileUtils.e(new File(this.jdField_a_of_type_JavaLangString).getParent());
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes14.jar
 * Qualified Name:     dov.com.tencent.mobileqq.activity.richmedia.SaveVideoActivity.SaveVideoTask.VideoSaveAlumCallBack
