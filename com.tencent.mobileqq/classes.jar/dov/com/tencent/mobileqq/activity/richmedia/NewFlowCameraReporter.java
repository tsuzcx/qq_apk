...
public class NewFlowCameraReporter
{
  ...
  {
    b(paramString, jdField_b_of_type_Long);
  }
  ...
  public static void b(String paramString, long paramLong)
  {
    ...
    {
      long l = System.currentTimeMillis();
      QLog.d(jdField_c_of_type_JavaLangString, 2, paramString + ";" + (l - paramLong));
  ...
  public static void e()
  {
    ...
    if (f > 0L)
    {
      ...
      StatisticCollector.a(BaseApplicationImpl.sApplication).a(null, "COT", true, l, 0L, localHashMap, null);
      f = 0L;
    }
  }
  ...
  public static void f()
  {
    ...
    if (jdField_c_of_type_Long > 0L)
    {
      ...
      StatisticCollector.a(BaseApplicationImpl.sApplication).a(null, "actLoginQ", true, l2, 0L, localHashMap, null);
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.activity.richmedia.NewFlowCameraReporter
