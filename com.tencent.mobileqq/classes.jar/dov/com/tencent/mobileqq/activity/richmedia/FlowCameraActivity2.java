...
import dov.com.tencent.mobileqq.activity.richmedia.state.RMVideoStateMgr.ForceReleaseLockOnPause;
import dov.com.tencent.mobileqq.activity.richmedia.state.RMVideoSwitchCameraPicMgr;
import dov.com.tencent.mobileqq.activity.richmedia.state.RMVideoSwitchCameraPicMgr.ViewBitmapSource;
...
import dov.com.tencent.mobileqq.shortvideo.widget.TCProgressBar.DelEvent;
import java.io.File;
  ...
  implements View.OnClickListener, View.OnLongClickListener, RMVideoSwitchCameraPicMgr.ViewBitmapSource, RMViewSTInterface, ImageViewVideoPlayer.IMPlayerEndListener, TCProgressBar.DelEvent
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aooq(this);
  ...
  CameraExceptionHandler.Callback jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraExceptionHandler$Callback = new aooj(this);
  ...
  private FlowComponentInterface jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface;
  public FlowPlusPanel a;
  public RMVideoStateMgr a;
  public CameraGLSurfaceView a;
  private SVHwAutoSegmentMgr jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwAutoSegmentMgr = new SVHwAutoSegmentMgr();
  private volatile SVHwEncoder jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder;
  private ImageViewVideoPlayer jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer;
  SimpleProgressBar jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar;
  public TCProgressBar a;
  Runnable jdField_a_of_type_JavaLangRunnable = new aooc(this);
  public String a;
  public double b;
  float jdField_b_of_type_Float = 0.0F;
  public int b;
  private long jdField_b_of_type_Long;
  View.OnTouchListener jdField_b_of_type_AndroidViewView$OnTouchListener = new aoog(this);
  View jdField_b_of_type_AndroidViewView;
  public Button b;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  public TextView b;
  Runnable jdField_b_of_type_JavaLangRunnable = new aoos(this);
  public String b;
  public boolean b;
  ...
  Runnable jdField_c_of_type_JavaLangRunnable = new aoom(this);
  ...
  public FlowCameraActivity2()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr = RMVideoStateMgr.a();
    ...
    this.jdField_a_of_type_AndroidViewView$OnTouchListener = new aoof(this);
  }
  ...
  private void C()
  {
    float f1 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a();
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder != null)
    {
      RMVideoClipSpec localRMVideoClipSpec = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoClipSpec;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(this.jdField_a_of_type_Double, this.jdField_b_of_type_Double, f1, localRMVideoClipSpec.jdField_e_of_type_Int);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FlowCameraActivity", 2, "handleQQVideo(): onSendVideoClick mHwEncoder=" + this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder);
    }
    QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread", false).post(new aoox(this, this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder));
  }
  
  private void E()
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar != null)
    {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.setVisibility(0);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.setEnabled(true);
    }
    ...
    this.jdField_i_of_type_AndroidViewView.setBackgroundResource(2130843262);
    a(1002, 0, null);
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar != null) {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c();
    }
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a().b();
  ...
  private void F()
  {
    ...
    {
      localObject2 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoClipSpec;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder = new SVHwEncoder();
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString, ((RMVideoClipSpec)localObject2).jdField_e_of_type_Int, ((RMVideoClipSpec)localObject2).jdField_f_of_type_Int);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(-1, this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_b_of_type_Int * 1000);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(CodecParam.jdField_q_of_type_Int, i1, 128000, i2);
        if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext == null) {
          break label321;
        }
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.mEncodeRef.getAndSet(this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder);
        if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadeviceAudioCapture != null) {
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadeviceAudioCapture.a.getAndSet(this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder);
        }
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwAutoSegmentMgr.a.getAndSet(this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder);
        ...
        localObject1 = ((VideoCompoundController)localObject2).a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder, (SessionInfo)localObject1, i1);
        ...
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a((SVHwOutputNotify)localObject1, null, this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_e_of_type_Boolean);
        return;
        label296:
      ...
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder = null;
      return;
      label342:
      i1 = 1;
    }
  ...
  {
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.a(paramInt, paramFloat, true, ScreenUtil.a(5.0F));
  ...
  private void b(Bundle paramBundle)
  {
    ...
    if ((this.jdField_n_of_type_Int >= 57671680L) && (this.jdField_n_of_type_Int <= 314572800L)) {
      dov.com.tencent.mobileqq.shortvideo.util.storage.StorageManager.jdField_a_of_type_Long = this.jdField_n_of_type_Int;
    }
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface = ((FlowComponentInterface)paramBundle);
            this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface.a(this.jdField_c_of_type_JavaLangString);
            return;
          }
        }
        catch (Throwable paramBundle)
        {
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface = null;
        }
      }
  ...
  private void c(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (HwEnvData.a()) {
        this.s = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(16);
      }
      for (;;)
      {
        if (!this.y) {
        ...
        return;
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(4);
      }
    }
  }
  ...
  private boolean c()
  {
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder != null) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a())) {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder = null;
    }
    int i1;
    int i2;
    ...
    {
      return false;
      i1 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c();
      i2 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.d();
    } while ((i1 > 0) || (i2 > 0) || (this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder == null) || (this.jdField_c_of_type_AndroidWidgetButton.isEnabled()));
    return true;
  }
  ...
  protected FlowPanel a()
  {
    if (this.jdField_k_of_type_Boolean) {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowPlusPanel = ((FlowPlusPanel)FlowPanelFactory.a(this, 0));
    }
    return this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowPlusPanel;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext != null) {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.mEncodeRef.getAndSet(null);
    }
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadeviceAudioCapture != null) {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadeviceAudioCapture.a.getAndSet(null);
    }
  }
  ...
  public void a(float paramFloat)
  {
    if (paramFloat > 0.0F)
    {
      ...
      while ((!this.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c() > 0) || (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.d() > 0)) {
        return;
      }
    }
    ...
    if (paramFloat > 0.0F)
    {
      ...
      if (this.jdField_p_of_type_Boolean)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetButton.setText(2131438182);
        this.jdField_b_of_type_AndroidWidgetButton.setBackgroundResource(2130843269);
        if (!this.jdField_g_of_type_Boolean)
        {
          if (!this.y) {
            break label359;
  ...
  public void a(int paramInt)
  {
    ...
    {
      int i1 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.d();
      if (i1 > 0)
      {
        int i2 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c();
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(i2, i1, true);
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.d();
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr == null)
    {
      if (QLog.isColorLevel()) {
    ...
    {
      e(true);
      if ((this.r) && (this.jdField_q_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder == null)) {
        F();
      }
      for (;;)
      {
        paramInt1 = i1;
        if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar != null) {
          paramInt1 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c();
        }
        ...
        if (c())
        {
          localObject = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoClipSpec;
          this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString, ((RMVideoClipSpec)localObject).jdField_e_of_type_Int, ((RMVideoClipSpec)localObject).jdField_f_of_type_Int);
          C();
          this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(-1, this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_b_of_type_Int * 1000);
          if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext != null)
          {
    ...
    label367:
    boolean bool;
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView != null)
    {
      localObject = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView;
      if (localObject != this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView) {
        break label563;
      }
      bool = true;
      label379:
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(2, localRMVideoClipSpec, 0);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(localRMVideoClipSpec, false);
      if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView == null) {
        break;
      }
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.setPreviewSize(this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, localRMVideoClipSpec);
      break;
      ...
      break label379;
      label569:
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(5, localRMVideoClipSpec, 0);
    }
  }
  ...
  protected void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder != null) {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.e();
    }
  }
  ...
  {
    runOnUiThread(new aoon(this, paramString, paramInt));
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      RMVideoStateMgr localRMVideoStateMgr = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr;
      localRMVideoStateMgr.jdField_a_of_type_Int += 1;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.setProgress(paramInt, paramBoolean);
      if (paramBoolean) {
        h(true);
      }
    }
    ...
    int i1 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.getFrameIndex();
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwAutoSegmentMgr.a(paramInt, i1);
    ...
    return;
    label100:
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.setCurrentProgress(paramInt, paramBoolean);
  }
  ...
  void a(Context paramContext, int paramInt)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppProgressDialog.findViewById(2131363418));
      }
      return;
    }
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    for (int i1 = paramBundle.jdField_a_of_type_Int;; i1 = 0)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a((AppInterface)getAppRuntime(), i2, str, bool, i1, i3, this.jdField_c_of_type_Int);
      if (!this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(this, FlowCameraMqqAction.a(this), this))
      {
        super.finish();
        return;
      }
      this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this, new aoow(this, this));
      ...
      this.jdField_a_of_type_AndroidViewOrientationEventListener = new aoop(this, this);
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraProxy);
  ...
  {
    getLayoutInflater().inflate(2130970356, paramViewGroup);
    this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover = ((CameraCover)a(2131363439));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131362848));
    this.jdField_b_of_type_AndroidViewView = a(2131370128);
    this.jdField_a_of_type_ComTencentMobileqqWidgetHorizontalItemIndicator = ((HorizontalItemIndicator)a(2131370129));
    this.jdField_c_of_type_AndroidViewView = a(2131365916);
    this.jdField_a_of_type_AndroidViewView = a(2131369001);
    this.jdField_g_of_type_AndroidViewView = a(2131369820);
    this.jdField_h_of_type_AndroidViewView = a(2131362086);
    this.jdField_e_of_type_AndroidViewView = a(2131370120);
    this.jdField_f_of_type_AndroidViewView = a(2131370121);
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)a(2131369009));
    this.jdField_c_of_type_AndroidWidgetButton = ((Button)a(2131370123));
    this.jdField_d_of_type_AndroidWidgetButton = ((Button)a(2131368626));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131370119));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131369824));
    this.jdField_i_of_type_AndroidViewView = a(2131370124);
    this.jdField_j_of_type_AndroidViewView = a(2131370126);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)a(2131369823));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)a(2131370125));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)a(2131364435));
    ...
    if (this.jdField_g_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar = ((SimpleProgressBar)a(2131370122));
      this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover.setBackgroundColor(-16777216);
      this.jdField_b_of_type_AndroidWidgetButton.setText(2131438183);
      this.jdField_b_of_type_AndroidWidgetButton.setBackgroundResource(2130843244);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131438185);
      ...
      {
        paramViewGroup = (TextView)a(2131363446);
        paramViewGroup.setVisibility(0);
        paramViewGroup.setText(2131438178);
      ...
      label701:
      paramViewGroup = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoSwitchCameraPicMgr.a(this.jdField_g_of_type_Boolean);
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar = ((TCProgressBar)a(2131370130));
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.setMax(CodecParam.jdField_g_of_type_Int, CodecParam.jdField_c_of_type_Int);
      this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover.setBackgroundResource(2130838688);
      if (!CameraAbility.c()) {
  ...
  public void a(File paramFile)
  {
    ...
    if (a(2131369822) == null) {
      ((ViewStub)a(2131369821)).setVisibility(0);
    }
    if (this.jdField_d_of_type_AndroidViewView == null) {
      this.jdField_d_of_type_AndroidViewView = a(2131369822);
    }
    if (this.jdField_a_of_type_AndroidWidgetImageView == null) {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(this.jdField_d_of_type_AndroidViewView, 2131370181));
    }
    ...
    localObject = (Button)a(this.jdField_d_of_type_AndroidViewView, 2131370182);
    Button localButton = (Button)a(this.jdField_d_of_type_AndroidViewView, 2131370183);
    ((Button)localObject).setOnClickListener(new aooh(this, paramFile));
    localButton.setOnClickListener(new aooi(this, paramFile, localButton));
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if (paramBoolean2)
      {
        if (this.jdField_l_of_type_Boolean)
        {
          ...
          if ((this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr == null) || (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.c())) {
            break label134;
          }
    ...
    if (this.jdField_l_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130837706);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.setProgressColor(SimpleProgressBar.jdField_c_of_type_Int);
    ...
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.setProgressColor(SimpleProgressBar.jdField_d_of_type_Int);
    if (this.jdField_k_of_type_AndroidViewView == null)
    {
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetButton.setBackgroundResource(2130843241);
      return;
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoSwitchCameraPicMgr.a(this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_n_of_type_Boolean, this.jdField_g_of_type_Boolean, (RMVideoClipSpec)localObject);
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover, 2131362087) == null)
    {
      ...
      if (paramBoolean) {
        localObject1 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext;
      }
    }
    if ((VersionUtils.d()) && (!this.jdField_e_of_type_Boolean))
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof TexturePreviewContext)))
      {
        ...
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(((CameraTextureView)localObject2).a);
        ...
        if (this.jdField_g_of_type_Boolean)
        {
          ...
          ((FrameLayout.LayoutParams)localObject3).width = ((int)(this.jdField_a_of_type_Int * FlowCameraConstant.jdField_a_of_type_Float));
          ((FrameLayout.LayoutParams)localObject3).gravity = 49;
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView = ((CameraGLSurfaceView)a(2131362089));
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.setVideoContext(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext);
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.setLayoutParams((ViewGroup.LayoutParams)localObject3);
          ((FrameLayout.LayoutParams)localObject1).height = 1;
        }
      }
    }
    for (((FrameLayout.LayoutParams)localObject1).width = 1;; ((FrameLayout.LayoutParams)localObject1).width = ((int)(this.jdField_a_of_type_Int * FlowCameraConstant.jdField_a_of_type_Float)))
    {
      ...
      {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(((CameraPreview)localObject2).a);
        localObject1 = new FrameLayout.LayoutParams(-1, ((DisplayMetrics)localObject3).heightPixels);
      ...
      label429:
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView = ((CameraGLSurfaceView)a(2131362089));
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.setVisibility(8);
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView = null;
  ...
  void c()
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer != null)
    {
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr != null)
    {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.j();
      if (this.jdField_d_of_type_Boolean) {}
    }
    else
    {
    ...
    if (this.jdField_g_of_type_Boolean)
    {
      ...
      if (paramBoolean)
      {
        ...
        float f1 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a();
        Object localObject = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr;
        if (this.jdField_g_of_type_Boolean) {
          f1 = 1.0F;
        }
        FlowCameraMqqAction.a(this, (RMVideoStateMgr)localObject, f1, this.jdField_g_of_type_Boolean, this.jdField_a_of_type_Double, this.jdField_b_of_type_Double, this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface, 0);
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      return;
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMViewSTInterface.y();
      break;
  ...
  {
    if (!this.jdField_g_of_type_Boolean) {
      return this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a();
    }
    return -1;
  }
  ...
  void d(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr != null)
    {
      if (paramBoolean)
      {
        ...
        if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext != null)
        {
          int i1 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.getSegmentCount();
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(0, i1, true);
        }
      }
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.c();
      if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoThumbGenMgr != null) {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoThumbGenMgr.a();
      }
      if (this.jdField_g_of_type_Boolean) {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.b(paramBoolean);
      }
      if ((this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr$ForceReleaseLockOnPause != null) && (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr$ForceReleaseLockOnPause.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr$ForceReleaseLockOnPause.jdField_b_of_type_Boolean)) {
        this.jdField_h_of_type_Boolean = false;
      }
    }
  }
  ...
  void e()
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Double == 0.0D)
    {
      b();
    ...
    this.jdField_a_of_type_ComTencentWidgetActionSheet.a(new aoou(this));
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      try
      {
        ...
        if (bool) {
          if (this.jdField_n_of_type_Boolean)
          {
            this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(2, localRMVideoClipSpec, this.jdField_i_of_type_Int);
            if (!this.y) {
              break label314;
            }
        ...
        for (;;)
        {
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(localRMVideoClipSpec, false);
          return;
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(5, localRMVideoClipSpec, this.jdField_j_of_type_Int);
          break;
          if (this.jdField_n_of_type_Boolean)
          {
            this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.b(2, localRMVideoClipSpec, this.jdField_i_of_type_Int);
            break;
          }
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.b(5, localRMVideoClipSpec, this.jdField_j_of_type_Int);
          break;
          label314:
  ...
  {
    int i1 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c();
    if (QLog.isColorLevel()) {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetButton.setText(2131438184);
      this.jdField_b_of_type_AndroidWidgetButton.setEnabled(false);
    ...
    if (i1 == 0)
    {
      ...
      if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.d() <= 0) && (!this.jdField_j_of_type_Boolean) && (!this.jdField_i_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqWidgetHorizontalItemIndicator.getVisibility() == 4)) {
  ...
  public void g(boolean paramBoolean)
  {
    if ((this.jdField_d_of_type_Boolean) && (!this.jdField_g_of_type_Boolean))
    {
      int i1 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.b();
      if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(i1, 1, paramBoolean);
    }
  }
  ...
  void h()
  {
    ...
    localValueAnimator.addUpdateListener(new aood(this, i1));
    localValueAnimator.addListener(new aooe(this));
    localValueAnimator.start();
  }
  
  void h(boolean paramBoolean)
  {
    runOnUiThread(new aooy(this, paramBoolean));
  }
  ...
  public void m()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.d();
  }
  ...
  public void n()
  {
    if (!this.jdField_g_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a(3);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a = this;
      this.jdField_c_of_type_AndroidWidgetButton.setEnabled(true);
      if (this.w)
      {
        this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    ...
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.jdField_a_of_type_Int = 2;
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.jdField_b_of_type_Int = CodecParam.jdField_c_of_type_Int;
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.setCurrentProgress(0, false);
  }
  ...
  public void o()
  {
    if ((this.jdField_d_of_type_Boolean) && (!this.jdField_g_of_type_Boolean))
    {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a(1);
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Int = 0;
      if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Double <= 0.0D) {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_f_of_type_Boolean = true;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetHorizontalItemIndicator.getVisibility() == 0) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetHorizontalItemIndicator.setVisibility(4);
      }
      ...
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwAutoSegmentMgr.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Double);
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface != null) {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface.a(this, paramInt1, paramInt2, paramIntent);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          paramView = new File(AppConstants.aS);
          if (!paramView.exists()) {
            paramView.mkdirs();
          }
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover.a(paramView, new aoov(this, paramView), i1, false);
          ...
          if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 4)
          {
            a(true);
            return;
          }
        } while (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c() <= 0);
        if (QLog.isColorLevel()) {
          QLog.d("FlowCameraActivity", 2, "mVideoDrawablePlayer.getVFileAndAFile=" + this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString);
        }
        if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString) != 0)
        {
          this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.b(0, "视频文件不存在", false);
          return;
        }
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_Boolean = true;
        this.jdField_i_of_type_AndroidViewView.setEnabled(false);
        if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder != null) {
          this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.f();
        }
        a(this, 2131436163);
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.lockFrameSync();
        f();
        this.u = true;
        ...
        if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder != null) || (this.y))
        {
          paramView = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoClipSpec;
        ...
        if (i1 == 2131370126)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.getSegmentCount() <= 1) {
                continue;
              }
              bool = true;
              paramView.a(i1, bool);
            ...
            this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.j();
            a(102);
            LogTag.a(this.jdField_a_of_type_JavaLangString, "SendBtn Click ", ",(int)rmStateMgr.mTotalTime = " + (int)this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Double + ",frames = " + this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.getFrameIndex() + " VideoABTest:" + SystemClock.uptimeMillis());
            paramView = RichmediaClient.a().a().a(this.jdField_a_of_type_JavaLangString);
            if (paramView != null) {
              paramView.a(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString, (int)this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Double, this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.getFrameIndex(), this.jdField_b_of_type_Long, this.jdField_m_of_type_Int);
            }
            c(true);
            if (!this.jdField_g_of_type_Boolean) {
              continue;
            ...
            paramView = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoClipSpec;
            this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoSwitchCameraPicMgr.a(this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_n_of_type_Boolean, this.jdField_g_of_type_Boolean, paramView);
            if (!VideoEnvironment.d())
            {
              setResult(1001);
              finish();
        ...
        if (i1 == 2131370123)
        {
          ...
          if (!this.jdField_n_of_type_Boolean)
          {
            ...
            paramView = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoClipSpec;
            paramView = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoSwitchCameraPicMgr.a(this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_n_of_type_Boolean, this.jdField_g_of_type_Boolean, paramView);
            if (paramView != null)
            {
              ...
              a(104);
              this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a(3);
              this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.invalidate();
          ...
          for (FlowCameraConstant.jdField_a_of_type_Int = 2;; FlowCameraConstant.jdField_a_of_type_Int = 1)
          {
            g();
            this.jdField_b_of_type_AndroidWidgetButton.setEnabled(false);
            this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.i();
            return;
            this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838688);
            break;
            this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130838688);
            break;
          }
    ...
    } while (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface == null);
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaFlowComponentInterface.a(this);
  }
  ...
  protected void onDestroy()
  {
    ...
    try
    {
      ...
      if (!this.jdField_g_of_type_Boolean) {
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a = null;
      }
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a(this);
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    if ((paramInt == 4) && (this.jdField_g_of_type_Boolean)) {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a().a();
    }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (paramView.getId() == 2131369009)
    {
      ...
      if (this.jdField_d_of_type_Boolean)
      {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMViewSTInterface.x();
        m();
      }
    }
    for (;;)
    {
      ...
      paramView.addUpdateListener(new aook(this, i1));
      paramView.addListener(new aool(this));
      paramView.start();
  ...
  public void onPause()
  {
    ...
    {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.b();
      if ((this.jdField_g_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView != null)) {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.onPause();
      }
      this.jdField_b_of_type_Boolean = false;
    }
  ...
  public void onResume()
  {
    ...
    if ((!this.jdField_h_of_type_Boolean) && (this.jdField_m_of_type_Boolean)) {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a();
    }
    View localView = a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover, 2131362087);
    if (((!this.jdField_h_of_type_Boolean) || (localView == null)) && (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 4))
    {
      if (localView != null) {
        break label144;
      }
      Looper.myQueue().addIdleHandler(new aoor(this));
    }
    for (;;)
    {
      this.jdField_h_of_type_Boolean = false;
      ...
      label144:
      if ((this.jdField_g_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView != null)) {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.onResume();
      }
    }
  }
  ...
  public void onStart()
  {
    ...
    this.jdField_a_of_type_Double = 0.0D;
    this.jdField_b_of_type_Double = 0.0D;
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new aoot(this, 1, true, true, 0L, false, false, "FlowCameraActivity2");
  ...
  public void p()
  {
    ...
    if ((this.jdField_d_of_type_Boolean) && (!this.jdField_g_of_type_Boolean))
    {
      if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.d() <= 0) {
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a(2);
      }
      if (QLog.isColorLevel())
      {
      ...
      if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_f_of_type_Boolean)
      {
        f2 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.a();
        i1 = 320;
        if (RMVideoStateMgr.jdField_a_of_type_Boolean) {
          i1 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoClipSpec.jdField_e_of_type_Int;
        }
        localObject = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoThumbGenMgr;
        str = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString;
        if (!this.jdField_g_of_type_Boolean) {
          break label515;
        }
      }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_f_of_type_Boolean = false;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = null;
      boolean bool = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.b();
      if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder != null) && (!bool))
      {
        f1 = (float)(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.getFrameIndex() * 1000.0F / this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Double);
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(f1, -1);
      }
      return;
      label515:
      f1 = f2;
  ...
  public void q()
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.isEnabled())
    {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.setVisibility(4);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.setEnabled(false);
    }
    int i1 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c();
    int i2 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.d();
    i2 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.getRemainedRecordFrames(i2);
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.a(CodecParam.jdField_c_of_type_Int, i1, i2, this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString);
    Object localObject2 = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaStateRMVideoThumbGenMgr.a();
    BitmapFactory.Options localOptions;
    Object localObject1;
    if ((localObject2 != null) && (((RMVideoThumbGenMgr.ThumbGenItem)localObject2).jdField_c_of_type_JavaLangString != null) && (((RMVideoThumbGenMgr.ThumbGenItem)localObject2).a.get() == 3) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null))
    {
    ...
    if (localObject1 != null) {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable(super.getResources(), localObject1);
    }
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.b();
    if (!this.jdField_i_of_type_AndroidViewView.isEnabled())
    {
      this.jdField_i_of_type_AndroidViewView.setEnabled(true);
      this.jdField_i_of_type_AndroidViewView.setBackgroundResource(2130843273);
    }
  }
  ...
  public void r()
  {
    ...
    if ((this.jdField_q_of_type_Boolean) && (this.r) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder == null)) {
      F();
    }
  ...
  public void s()
  {
    ...
    if ((this.jdField_g_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView != null) && (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.getVisibility() != 0)) {
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewCameraGLSurfaceView.setVisibility(0);
    }
  ...
  public void v()
  {
    int i3 = this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c();
    int i2 = i3 / 1000;
    int i4 = i3 % 1000;
    int i1 = i2;
    if (i4 >= 500) {
  ...
  public void w()
  {
    if ((!this.jdField_g_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar != null)) {
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.a();
    }
  }
  ...
  public void x()
  {
    if (!this.jdField_g_of_type_Boolean)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_b_of_type_AndroidWidgetButton.setLongClickable(false);
      if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetTCProgressBar.c() > 0)
      {
        this.jdField_i_of_type_AndroidViewView.setVisibility(0);
        this.jdField_j_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_Int = ((int)((this.jdField_e_of_type_AndroidViewView.getMeasuredHeight() - this.jdField_b_of_type_AndroidWidgetButton.getHeight()) * 0.5F) + getResources().getDimensionPixelSize(2131559189));
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.setVisibility(0);
  }
  ...
  public void y()
  {
    if (!this.jdField_g_of_type_Boolean)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetButton.setLongClickable(true);
      this.jdField_b_of_type_AndroidWidgetButton.setEnabled(true);
      this.jdField_b_of_type_AndroidWidgetButton.setBackgroundResource(2130843245);
      this.jdField_b_of_type_AndroidWidgetButton.setText(null);
      if (!this.jdField_c_of_type_AndroidWidgetButton.isEnabled())
      {
        this.jdField_c_of_type_AndroidWidgetButton.setEnabled(true);
    ...
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.setCurrentProgress(0, false);
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetSimpleProgressBar.setVisibility(4);
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.activity.richmedia.FlowCameraActivity2
