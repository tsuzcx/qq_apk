...
public class LBSDetetor
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(new aopc(this));
  private aopd jdField_a_of_type_Aopd = new aopd(this, null);
  ...
  private LBSDetetor(AppInterface paramAppInterface)
  {
    ...
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Aopd);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Aopd);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new aope(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaLBSDetetor$LBSTemplateListener != null) {
