...
public class LBSDetetor
{
  ...
  private LBSDetetor.LBSDetectorObserver jdField_a_of_type_DovComTencentMobileqqActivityRichmediaLBSDetetor$LBSDetectorObserver = new LBSDetetor.LBSDetectorObserver(this, null);
  ...
  private LBSDetetor(AppInterface paramAppInterface)
  {
    ...
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaLBSDetetor$LBSDetectorObserver);
    }
  }
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaLBSDetetor$LBSTemplateListener != null)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaLBSDetetor$LBSTemplateListener.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
