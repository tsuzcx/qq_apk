  ...
  extends EditText
{
  ...
  private static final ExtendEditText.LengthConvertor jdField_c_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText$LengthConvertor = new anrx();
  protected int a;
  ...
  static
  {
    jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText$LengthConvertor = new anry();
  }
  ...
  private void d()
  {
    if (this.jdField_b_of_type_Int >= 0) {
      setFilters(new InputFilter[] { new anrz(this, this.jdField_b_of_type_Int) });
    }
  }
