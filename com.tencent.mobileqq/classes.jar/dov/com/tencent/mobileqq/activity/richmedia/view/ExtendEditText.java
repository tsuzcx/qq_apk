  ...
  extends EditText
{
  ...
  static
  {
    jdField_c_of_type_Ambb = new brbn();
    jdField_a_of_type_Ambb = new brbo();
  }
  ...
  private void d()
  {
    if (this.jdField_b_of_type_Int >= 0) {
      setFilters(new InputFilter[] { new brbq(this, this.jdField_b_of_type_Int) });
    }
  }
  ...
  private void e()
  {
    ...
    float f3;
    float f4;
    switch (brbp.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable$Orientation.ordinal()])
    {
    default: 
      f1 = localRect.left;
      f2 = localRect.top;
