...
public class RangeProcessor
{
  ...
  private RangeProcessor.OnRangeChangeListener jdField_a_of_type_DovComTencentMobileqqActivityRichmediaTrimvideoVideoWidgetRangeProcessor$OnRangeChangeListener;
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaTrimvideoVideoWidgetRangeProcessor$OnRangeChangeListener == null) {
        break;
      }
      this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaTrimvideoVideoWidgetRangeProcessor$OnRangeChangeListener.a(this.e, this.f);
      return;
      label148:
      if (this.f - f1 < this.g)
      {
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.activity.richmedia.trimvideo.video.widget.RangeProcessor
