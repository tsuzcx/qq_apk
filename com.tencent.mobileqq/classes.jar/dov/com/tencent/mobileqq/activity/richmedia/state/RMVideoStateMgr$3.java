  ...
  implements Runnable
{
  ...
  public void run()
  {
    synchronized (RMVideoStateMgr.a(this.this$0))
    {
      if (this.this$0.d())
      {
        this.this$0.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadeviceAudioCapture.b(this.this$0.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadeviceAudioCapture$OnAudioRecordListener);
