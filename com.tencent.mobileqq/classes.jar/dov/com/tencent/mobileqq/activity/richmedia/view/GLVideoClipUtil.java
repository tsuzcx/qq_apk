...
public class GLVideoClipUtil
{
  ...
  public int a;
  private bnel jdField_a_of_type_Bnel = new bnel(this, null);
  ...
  private boolean a(int paramInt)
  {
    ...
    else
    {
      ...
      if (l1 != paramInt)
      {
        bnel localbnel = this.jdField_a_of_type_Bnel;
        localbnel.jdField_a_of_type_Int += 1;
        bool = true;
        if (this.jdField_a_of_type_Bnel.jdField_a_of_type_Int >= 3) {
          throw new GLVideoClipUtil.GLClipOldLibException("checkDataLength: dataSize=" + l1 + " length=" + paramInt + "prev*preh=" + this.r + " * " + this.s);
        }
      }
      else
      {
        this.jdField_a_of_type_Bnel.jdField_a_of_type_Int = 0;
      }
    }
    return bool;
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    bneh.a("glError:err=" + i1 + " errname=" + bneh.a(i1));
    return bool;
  }
