...
public class GLVideoClipUtil
{
  ...
  public int a;
  private bksk jdField_a_of_type_Bksk = new bksk(this, null);
  ...
  private boolean a(int paramInt)
  {
    ...
    else
    {
      ...
      if (l1 != paramInt)
      {
        bksk localbksk = this.jdField_a_of_type_Bksk;
        localbksk.jdField_a_of_type_Int += 1;
        bool = true;
        if (this.jdField_a_of_type_Bksk.jdField_a_of_type_Int >= 3) {
          throw new GLVideoClipUtil.GLClipOldLibException("checkDataLength: dataSize=" + l1 + " length=" + paramInt + "prev*preh=" + this.r + " * " + this.s);
        }
      }
      else
      {
        this.jdField_a_of_type_Bksk.jdField_a_of_type_Int = 0;
      }
    }
    return bool;
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    bksg.a("glError:err=" + i1 + " errname=" + bksg.a(i1));
    return bool;
  }
