...
public class GLVideoClipUtil
{
  ...
  public int a;
  private GLVideoClipUtil.DataSizeErr jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewGLVideoClipUtil$DataSizeErr = new GLVideoClipUtil.DataSizeErr(this, null);
  ...
  private boolean a(int paramInt)
  {
    ...
    else
    {
      ...
      if (l1 != paramInt)
      {
        GLVideoClipUtil.DataSizeErr localDataSizeErr = this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewGLVideoClipUtil$DataSizeErr;
        localDataSizeErr.jdField_a_of_type_Int += 1;
        bool = true;
        if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewGLVideoClipUtil$DataSizeErr.jdField_a_of_type_Int >= 3) {
          throw new GLVideoClipUtil.GLClipOldLibException("checkDataLength: dataSize=" + l1 + " length=" + paramInt + "prev*preh=" + this.r + " * " + this.s);
        }
      }
      else
      {
        this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewGLVideoClipUtil$DataSizeErr.jdField_a_of_type_Int = 0;
      }
    }
    return bool;
  }
