...
public class GLVideoClipUtil
{
  ...
  public int a;
  private bktb jdField_a_of_type_Bktb = new bktb(this, null);
  ...
  private boolean a(int paramInt)
  {
    ...
    else
    {
      ...
      if (l1 != paramInt)
      {
        bktb localbktb = this.jdField_a_of_type_Bktb;
        localbktb.jdField_a_of_type_Int += 1;
        bool = true;
        if (this.jdField_a_of_type_Bktb.jdField_a_of_type_Int >= 3) {
          throw new GLVideoClipUtil.GLClipOldLibException("checkDataLength: dataSize=" + l1 + " length=" + paramInt + "prev*preh=" + this.r + " * " + this.s);
        }
      }
      else
      {
        this.jdField_a_of_type_Bktb.jdField_a_of_type_Int = 0;
      }
    }
    return bool;
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    bksx.a("glError:err=" + i1 + " errname=" + bksx.a(i1));
    return bool;
  }
