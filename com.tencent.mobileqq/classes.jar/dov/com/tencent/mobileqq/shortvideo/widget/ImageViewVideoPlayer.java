  ...
  implements URLDrawableDownListener, VideoDrawable.OnPlayRepeatListener, VideoDrawable.OnPlayerOneFrameListener
{
  ...
  private void a()
  {
    ...
    try
    {
      ...
      if ((localDrawable != null) && ((localDrawable instanceof VideoDrawable)))
      {
        ...
        if ((!awii.d(awii.c)) && (!awii.a(awii.d))) {
          break label141;
        }
        bool1 = true;
  ...
  public int a(String paramString)
  {
    ...
    while (i < j)
    {
      ...
      if ((localFile.endsWith(".vf")) && (vlm.a(str + localFile) > 0L)) {
    ...
    this.f = false;
    if (vlm.a(this.jdField_b_of_type_JavaLangString) > 0L)
    {
      if (QLog.isColorLevel()) {
  ...
  public void oneFrameDrawed()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_Bjmk != null) {
        this.jdField_a_of_type_Bjmk.a(this.jdField_c_of_type_Int);
      }
      return;
    }
  }
  ...
  public void setIMPFrameListener(bjmk parambjmk)
  {
    this.jdField_a_of_type_Bjmk = parambjmk;
  }
  
  public void setIMPlayerEndListener(bjml parambjml)
  {
    this.jdField_a_of_type_Bjml = parambjml;
  }
