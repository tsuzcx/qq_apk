  ...
  implements azdf
{
  ...
  public static String a(File paramFile)
  {
    ...
    paramFile = bnsv.a(paramFile);
    StringBuilder localStringBuilder = new StringBuilder(ajrx.d);
  ...
  public static String a(String paramString)
  {
    ...
    paramString = bnsv.a(new File(paramString));
    StringBuilder localStringBuilder = new StringBuilder(ajrx.d);
    localStringBuilder.append("shortvideo");
    localStringBuilder.append(File.separator);
    localStringBuilder.append("temp");
  ...
  {
    String str = bnsv.a();
    return ajrx.d + "shortvideo" + File.separator + "temp" + File.separator + "source" + File.separator + str + "watermark.png";
  }
