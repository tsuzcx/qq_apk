...
public class GloableValue
{
    ...
    do
    {
      do
      {
        do
        {
          ...
          return false;
          jdField_a_of_type_JavaLangString = paramContext + File.separator + "Cover" + File.separator + paramLong;
        ...
        jdField_b_of_type_JavaLangString = paramContext + File.separator + "trimvideo" + File.separator + paramLong;
      ...
      jdField_f_of_type_JavaLangString = paramContext + "/Product";
      jdField_e_of_type_JavaLangString = paramContext + "/Material";
      jdField_g_of_type_JavaLangString = jdField_e_of_type_JavaLangString + "/ProcessedMaterial";
      jdField_c_of_type_JavaLangString = paramContext + "/log.txt";
      jdField_d_of_type_JavaLangString = paramContext + File.separator + "Source" + File.separator + paramLong;
      paramContext = new File(jdField_d_of_type_JavaLangString);
  ...
  public static boolean a(String paramString, Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    //   9: aconst_null
    //   10: astore 8
    //   12: invokestatic 103	dov/com/tencent/mobileqq/shortvideo/util/storage/StorageManager:a	()Ldov/com/tencent/mobileqq/shortvideo/util/storage/StorageManager;
    //   15: getfield 105	dov/com/tencent/mobileqq/shortvideo/util/storage/StorageManager:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   18: astore 9
    //   20: new 211	com/tencent/maxvideo/common/MessageStruct
    //   23: dup
    //   24: bipush 6
    //   26: invokespecial 214	com/tencent/maxvideo/common/MessageStruct:<init>	(I)V
    //   29: astore 4
    //   31: aload 4
    //   33: new 115	java/lang/StringBuilder
    //   36: dup
    //   37: invokespecial 116	java/lang/StringBuilder:<init>	()V
    //   40: ldc 216
    //   42: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   45: aload_0
    ...
    //   54: aload 9
    //   56: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   59: ldc 220
    //   61: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   64: getstatic 182	dov/com/tencent/mobileqq/shortvideo/common/GloableValue:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   75: getstatic 61	dov/com/tencent/mobileqq/shortvideo/common/GloableValue:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   86: getstatic 170	dov/com/tencent/mobileqq/shortvideo/common/GloableValue:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   97: getstatic 174	dov/com/tencent/mobileqq/shortvideo/common/GloableValue:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   108: getstatic 178	dov/com/tencent/mobileqq/shortvideo/common/GloableValue:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   119: getstatic 233	com/tencent/mobileqq/shortvideo/mediadevice/CodecParam:jdField_c_of_type_Int	I
    //   122: invokevirtual 236	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   125: ldc 238
    //   127: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   130: getstatic 240	com/tencent/mobileqq/shortvideo/mediadevice/CodecParam:g	I
    //   133: invokevirtual 236	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   136: ldc 242
    //   138: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   141: iload_2
    //   142: invokevirtual 236	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   145: ldc 244
    //   147: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   150: iload_3
    //   151: invokevirtual 236	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   154: ldc 246
    //   156: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   159: iconst_0
    //   160: invokevirtual 236	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   163: ldc 248
    //   165: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   171: putfield 252	com/tencent/maxvideo/common/MessageStruct:mObj0	Ljava/lang/Object;
    //   174: aload 4
    //   176: aconst_null
    //   177: aconst_null
    //   178: invokestatic 258	com/tencent/maxvideo/common/GlobalInit:nativeSyncProcessMsg	(Lcom/tencent/maxvideo/common/MessageStruct;Lcom/tencent/maxvideo/common/MessageStruct;Ljava/lang/Object;)Z
    //   181: pop
    //   182: aload_1
    //   183: invokevirtual 262	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   186: ldc_w 263
    //   189: invokevirtual 269	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   192: astore_0
    //   193: aload_0
    //   194: invokevirtual 275	java/io/InputStream:available	()I
    //   197: newarray byte
    //   199: astore 10
    //   201: aload_0
    //   202: aload 10
    //   204: invokevirtual 279	java/io/InputStream:read	([B)I
    //   207: pop
    //   208: new 281	java/io/FileOutputStream
    //   211: dup
    //   212: new 127	java/io/File
    //   215: dup
    //   216: new 115	java/lang/StringBuilder
    //   219: dup
    //   220: invokespecial 116	java/lang/StringBuilder:<init>	()V
    //   223: aload 9
    //   225: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   228: ldc_w 283
    //   231: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   234: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   237: invokespecial 130	java/io/File:<init>	(Ljava/lang/String;)V
    //   240: invokespecial 286	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   243: astore 4
    //   245: aload 4
    //   247: aload 10
    //   249: invokevirtual 290	java/io/FileOutputStream:write	([B)V
    //   252: aload_0
    //   253: ifnull +7 -> 260
    //   256: aload_0
    //   257: invokevirtual 293	java/io/InputStream:close	()V
    //   260: aload 4
    //   262: ifnull +8 -> 270
    //   265: aload 4
    //   267: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   270: aload_1
    //   271: invokevirtual 262	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   274: ldc_w 295
    //   277: invokevirtual 269	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   280: astore_0
    //   281: aload_0
    //   282: invokevirtual 275	java/io/InputStream:available	()I
    //   285: newarray byte
    //   287: astore 4
    //   289: aload_0
    //   290: aload 4
    //   292: invokevirtual 279	java/io/InputStream:read	([B)I
    //   295: pop
    //   296: new 281	java/io/FileOutputStream
    //   299: dup
    //   300: new 127	java/io/File
    //   303: dup
    //   304: new 115	java/lang/StringBuilder
    //   307: dup
    //   308: invokespecial 116	java/lang/StringBuilder:<init>	()V
    //   311: aload 9
    //   313: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   316: ldc_w 297
    ...
    //   325: invokespecial 130	java/io/File:<init>	(Ljava/lang/String;)V
    //   328: invokespecial 286	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   331: astore_1
    //   332: aload_1
    //   333: aload 4
    //   335: invokevirtual 290	java/io/FileOutputStream:write	([B)V
    //   338: aload_0
    //   339: ifnull +7 -> 346
    //   342: aload_0
    //   343: invokevirtual 293	java/io/InputStream:close	()V
    //   346: aload_1
    //   347: ifnull +7 -> 354
    //   350: aload_1
    ...
    //   363: ifnull +7 -> 370
    //   366: aload_0
    //   367: invokevirtual 293	java/io/InputStream:close	()V
    //   370: aload 4
    //   372: ifnull -102 -> 270
    //   375: aload 4
    //   377: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   380: goto -110 -> 270
    //   383: astore_0
    //   384: goto -114 -> 270
    //   387: astore_0
    ...
    //   394: ifnull +7 -> 401
    //   397: aload_0
    //   398: invokevirtual 293	java/io/InputStream:close	()V
    //   401: aload 4
    //   403: ifnull -133 -> 270
    //   406: aload 4
    //   408: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   411: goto -141 -> 270
    //   414: astore_0
    //   415: goto -145 -> 270
    //   418: astore_1
    ...
    //   426: ifnull +7 -> 433
    //   429: aload_0
    //   430: invokevirtual 293	java/io/InputStream:close	()V
    //   433: aload 4
    //   435: ifnull +8 -> 443
    //   438: aload 4
    //   440: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   443: aload_1
    //   444: athrow
    //   445: astore_0
    //   446: aconst_null
    ...
    //   452: ifnull +7 -> 459
    //   455: aload_0
    //   456: invokevirtual 293	java/io/InputStream:close	()V
    //   459: aload_1
    //   460: ifnull -106 -> 354
    //   463: aload_1
    //   464: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   467: goto -113 -> 354
    //   470: astore_0
    //   471: goto -117 -> 354
    //   474: astore_0
    ...
    //   481: ifnull +7 -> 488
    //   484: aload_0
    //   485: invokevirtual 293	java/io/InputStream:close	()V
    //   488: aload_1
    //   489: ifnull -135 -> 354
    //   492: aload_1
    //   493: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   496: goto -142 -> 354
    //   499: astore_0
    //   500: goto -146 -> 354
    //   503: astore_1
    ...
    //   511: ifnull +7 -> 518
    //   514: aload_0
    //   515: invokevirtual 293	java/io/InputStream:close	()V
    //   518: aload 4
    //   520: ifnull +8 -> 528
    //   523: aload 4
    //   525: invokevirtual 294	java/io/FileOutputStream:close	()V
    //   528: aload_1
    //   529: athrow
    //   530: astore_0
    //   531: goto -271 -> 260
