...
public class PtvTemplateManager
{
  ...
  static
  {
    ...
    h = "200";
    i = "20";
    File localFile = new File(ahvy.jdField_d_of_type_JavaLangString);
  ...
  static PtvTemplateManager.PtvTemplateInfo a(String paramString)
  {
    ...
    //   18: aload_0
    //   19: ldc 147
    //   21: invokestatic 152	bazp:a	(Lorg/json/JSONObject;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    //   93: ldc 179
    //   95: invokestatic 152	bazp:a	(Lorg/json/JSONObject;Ljava/lang/Class;)Ljava/lang/Object;
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Bkzn != null) {
      this.jdField_a_of_type_Bkzn.a();
    }
  }
  ...
  public void a(AppInterface paramAppInterface, bkzl parambkzl, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo != null) && (!this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.doodleInfos.isEmpty()))
    {
      if (QLog.isColorLevel()) {
    ...
    return;
    parambkzl = new PtvTemplateManager.10(this, localFile, paramBoolean, parambkzl, paramAppInterface);
    if (QLog.isDevelopLevel()) {
      QLog.d("DOV_Doodle_Strokes_PtvTemplateManager", 4, String.format("initLocalDoodleInfo async, runnable[%s]", new Object[] { Integer.valueOf(parambkzl.hashCode()) }));
    }
    if ((paramAppInterface instanceof QQAppInterface))
    {
      ThreadManager.getFileThreadHandler().postDelayed(parambkzl, 0L);
      return;
    }
    ThreadManager.postImmediately(parambkzl, null, false);
  }
  ...
  public boolean a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
    ...
    //   42: invokestatic 548	bbdx:c	(Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_2
    //   46: aload_2
    ...
    //   149: invokestatic 560	nav:a	(Ljava/io/File;Ljava/lang/String;)V
    //   152: iconst_1
    //   153: ireturn
    //   154: astore_1
