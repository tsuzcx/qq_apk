...
public class ShortVideoTrimmer
{
  ...
  public static int a()
  {
    ...
    try
    {
      File[] arrayOfFile = new File("/sys/devices/system/cpu/").listFiles(new bptr());
      if (arrayOfFile == null) {
        return 1;
      }
  ...
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   3: lstore 5
    //   5: aload_1
    //   6: invokestatic 58	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:a	(Ljava/lang/String;)Lbpts;
    //   9: astore 9
    //   11: aload 9
    //   13: getfield 62	bpts:jdField_a_of_type_Boolean	Z
    //   16: ifne +10 -> 26
    //   19: ldc 64
    ...
    //   27: aload_2
    //   28: aload 9
    //   30: invokestatic 69	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:a	(Ljava/lang/String;Ljava/lang/String;Lbpts;)[Ljava/lang/String;
    //   33: astore_1
    //   34: aload_1
    //   35: ifnonnull +11 -> 46
    //   38: ldc 71
    ...
    //   55: astore 13
    //   57: getstatic 84	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:jdField_a_of_type_Boolean	Z
    //   60: ifne +39 -> 99
    ...
    //   74: aload 11
    //   76: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   79: aload 13
    ...
    //   90: invokevirtual 98	java/io/File:exists	()Z
    //   93: ifne +6 -> 99
    //   96: bipush 253
    //   98: ireturn
    //   99: aconst_null
    ...
    //   102: aconst_null
    //   103: astore 10
    //   105: new 100	java/lang/ProcessBuilder
    //   108: dup
    //   109: iconst_0
    //   110: anewarray 102	java/lang/String
    //   113: invokespecial 105	java/lang/ProcessBuilder:<init>	([Ljava/lang/String;)V
    //   116: astore 12
    //   118: aload 12
    //   120: iconst_1
    //   121: invokevirtual 109	java/lang/ProcessBuilder:redirectErrorStream	(Z)Ljava/lang/ProcessBuilder;
    //   124: pop
    //   125: new 111	java/util/ArrayList
    //   128: dup
    //   129: invokespecial 112	java/util/ArrayList:<init>	()V
    //   132: astore_0
    //   133: aload_0
    ...
    //   172: aload_0
    //   173: iconst_0
    //   174: invokeinterface 126 2 0
    //   179: checkcast 102	java/lang/String
    //   182: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   185: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   228: aload 11
    //   230: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   233: aload 13
    //   235: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   238: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   241: invokeinterface 120 2 0
    //   246: pop
    //   247: aload 12
    //   249: aload_0
    //   250: invokevirtual 130	java/lang/ProcessBuilder:command	(Ljava/util/List;)Ljava/lang/ProcessBuilder;
    //   253: pop
    //   254: new 86	java/lang/StringBuilder
    //   257: dup
    //   258: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   261: ldc 132
    //   263: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   266: aload_0
    //   267: aload_0
    //   268: invokeinterface 135 1 0
    //   273: iconst_1
    //   274: isub
    //   275: invokeinterface 126 2 0
    //   280: checkcast 102	java/lang/String
    ...
    //   292: aload 12
    //   294: invokevirtual 139	java/lang/ProcessBuilder:start	()Ljava/lang/Process;
    //   297: astore 13
    ...
    //   304: monitorenter
    //   305: aload 13
    //   307: putstatic 141	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   310: aload_0
    //   311: monitorexit
    ...
    //   315: invokevirtual 143	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   318: ifne +256 -> 574
    //   321: aconst_null
    //   322: putstatic 141	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   325: aload 13
    //   327: invokevirtual 148	java/lang/Process:destroy	()V
    ...
    //   333: iconst_1
    //   334: invokevirtual 151	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   337: iconst_0
    //   338: ifeq +11 -> 349
    //   341: new 153	java/lang/NullPointerException
    //   344: dup
    //   345: invokespecial 154	java/lang/NullPointerException:<init>	()V
    //   348: athrow
    //   349: iconst_0
    //   350: ifeq +11 -> 361
    //   353: new 153	java/lang/NullPointerException
    //   356: dup
    //   357: invokespecial 154	java/lang/NullPointerException:<init>	()V
    //   360: athrow
    //   361: iconst_0
    //   362: ifeq -338 -> 24
    //   365: new 153	java/lang/NullPointerException
    //   368: dup
    //   369: invokespecial 154	java/lang/NullPointerException:<init>	()V
    //   372: athrow
    //   373: astore_0
    //   374: iconst_m1
    //   375: ireturn
    ...
    //   403: astore 9
    //   405: aload 13
    //   407: invokevirtual 157	java/io/IOException:printStackTrace	()V
    //   410: aload 12
    //   412: astore 11
    //   414: aload_1
    //   415: astore 10
    ...
    //   423: dup
    //   424: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   427: ldc 159
    //   429: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   432: aload 13
    //   434: invokevirtual 160	java/io/IOException:toString	()Ljava/lang/String;
    //   437: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   440: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   443: invokestatic 66	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:a	(Ljava/lang/String;)V
    //   446: aload_0
    //   447: ifnull +7 -> 454
    //   450: aload_0
    //   451: invokevirtual 165	java/io/InputStream:close	()V
    //   454: aload_1
    //   455: ifnull +7 -> 462
    //   458: aload_1
    //   459: invokevirtual 168	java/io/InputStreamReader:close	()V
    //   462: iload 4
    //   464: istore_3
    //   465: aload 12
    //   467: ifnull +11 -> 478
    //   470: aload 12
    //   472: invokevirtual 171	java/io/BufferedReader:close	()V
    //   475: iload 4
    //   477: istore_3
    ...
    //   490: ldc 173
    //   492: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   495: lload 7
    //   497: lload 5
    //   499: lsub
    //   500: invokevirtual 176	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   503: ldc 178
    //   505: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   508: iload_3
    //   509: invokevirtual 181	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   512: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   530: astore_0
    //   531: aload_0
    //   532: invokevirtual 98	java/io/File:exists	()Z
    //   535: ifeq +30 -> 565
    //   538: aload_0
    //   539: invokevirtual 184	java/io/File:delete	()Z
    //   542: pop
    //   543: new 86	java/lang/StringBuilder
    //   546: dup
    //   547: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   550: ldc 186
    //   552: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   555: iload_3
    //   556: invokevirtual 181	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   559: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   568: iconst_1
    //   569: invokevirtual 151	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   572: iload_3
    //   573: ireturn
    //   574: aload 13
    //   576: invokevirtual 190	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   579: astore_0
    //   580: new 167	java/io/InputStreamReader
    //   583: dup
    //   584: aload_0
    //   585: invokespecial 193	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   588: astore_1
    //   589: new 170	java/io/BufferedReader
    //   592: dup
    //   593: aload_1
    //   594: invokespecial 196	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   597: astore 12
    //   599: aload 12
    //   601: astore 11
    //   603: aload_1
    ...
    //   607: astore 9
    //   609: aload 13
    //   611: invokevirtual 199	java/lang/Process:waitFor	()I
    //   614: pop
    //   615: aload 12
    //   617: astore 11
    //   619: aload_1
    ...
    //   623: astore 9
    //   625: aload 13
    //   627: invokevirtual 202	java/lang/Process:exitValue	()I
    //   630: istore 4
    //   632: aload 12
    //   634: astore 11
    //   636: aload_1
    ...
    //   639: aload_0
    //   640: astore 9
    //   642: new 86	java/lang/StringBuilder
    //   645: dup
    //   646: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   649: ldc 204
    //   651: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   654: iload 4
    //   656: invokevirtual 181	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   659: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   673: astore 9
    //   675: aload 12
    //   677: invokevirtual 207	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   680: astore 14
    //   682: aload 14
    //   684: ifnull +39 -> 723
    //   687: aload 12
    ...
    //   694: aload_0
    //   695: astore 9
    //   697: new 86	java/lang/StringBuilder
    //   700: dup
    //   701: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   704: ldc 209
    ...
    //   714: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   731: astore 9
    //   733: aload 13
    //   735: invokevirtual 148	java/lang/Process:destroy	()V
    //   738: aload 12
    //   740: astore 11
    //   742: aload_1
    //   743: astore 10
    ...
    //   765: monitorenter
    //   766: aconst_null
    //   767: putstatic 141	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   770: aload 14
    //   772: monitorexit
    //   773: aload 12
    //   775: astore 11
    ...
    //   789: ifnull +7 -> 796
    //   792: aload_0
    //   793: invokevirtual 165	java/io/InputStream:close	()V
    //   796: aload_1
    //   797: ifnull +7 -> 804
    //   800: aload_1
    //   801: invokevirtual 168	java/io/InputStreamReader:close	()V
    //   804: iload 4
    //   806: istore_3
    //   807: aload 12
    //   809: ifnull -331 -> 478
    //   812: aload 12
    //   814: invokevirtual 171	java/io/BufferedReader:close	()V
    //   817: iload 4
    //   819: istore_3
    //   820: goto -342 -> 478
    //   823: astore_0
    ...
    //   863: astore 9
    //   865: aload 13
    //   867: invokevirtual 212	java/lang/InterruptedException:printStackTrace	()V
    //   870: aload 12
    //   872: astore 11
    //   874: aload_1
    //   875: astore 10
    //   877: aload_0
    //   878: astore 9
    //   880: new 86	java/lang/StringBuilder
    //   883: dup
    //   884: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   887: ldc 214
    //   889: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   892: aload 13
    //   894: invokevirtual 215	java/lang/InterruptedException:toString	()Ljava/lang/String;
    //   897: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   900: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   903: invokestatic 66	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:a	(Ljava/lang/String;)V
    //   906: aload_0
    //   907: ifnull +7 -> 914
    //   910: aload_0
    //   911: invokevirtual 165	java/io/InputStream:close	()V
    //   914: aload_1
    //   915: ifnull +7 -> 922
    //   918: aload_1
    //   919: invokevirtual 168	java/io/InputStreamReader:close	()V
    //   922: iload 4
    //   924: istore_3
    //   925: aload 12
    //   927: ifnull -449 -> 478
    //   930: aload 12
    //   932: invokevirtual 171	java/io/BufferedReader:close	()V
    //   935: iload 4
    //   937: istore_3
    //   938: goto -460 -> 478
    //   941: astore_0
    ...
    //   970: astore 9
    //   972: aload 13
    //   974: invokevirtual 216	java/lang/Exception:printStackTrace	()V
    //   977: aload 12
    //   979: astore 11
    //   981: aload_1
    //   982: astore 10
    //   984: aload_0
    //   985: astore 9
    //   987: new 86	java/lang/StringBuilder
    //   990: dup
    //   991: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   994: ldc 218
    //   996: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   999: aload 13
    //   1001: invokevirtual 219	java/lang/Exception:toString	()Ljava/lang/String;
    //   1004: invokevirtual 91	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   1007: invokevirtual 94	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1010: invokestatic 66	dov/com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:a	(Ljava/lang/String;)V
    //   1013: aload_0
    //   1014: ifnull +7 -> 1021
    //   1017: aload_0
    //   1018: invokevirtual 165	java/io/InputStream:close	()V
    //   1021: aload_1
    //   1022: ifnull +7 -> 1029
    //   1025: aload_1
    //   1026: invokevirtual 168	java/io/InputStreamReader:close	()V
    //   1029: iload 4
    //   1031: istore_3
    //   1032: aload 12
    //   1034: ifnull -556 -> 478
    //   1037: aload 12
    //   1039: invokevirtual 171	java/io/BufferedReader:close	()V
    //   1042: iload 4
    //   1044: istore_3
    //   1045: goto -567 -> 478
    //   1048: astore_0
    ...
    //   1062: ifnull +7 -> 1069
    //   1065: aload_0
    //   1066: invokevirtual 165	java/io/InputStream:close	()V
    //   1069: aload_2
    //   1070: ifnull +7 -> 1077
    //   1073: aload_2
    //   1074: invokevirtual 168	java/io/InputStreamReader:close	()V
    //   1077: aload 10
    //   1079: ifnull +8 -> 1087
    //   1082: aload 10
    //   1084: invokevirtual 171	java/io/BufferedReader:close	()V
    //   1087: aload_1
    //   1088: athrow
    //   1089: astore_0
    //   1090: goto -525 -> 565
    ...
    //   50	1069	11	localObject4	Object
    //   116	1086	12	localObject5	Object
  ...
  public static bpts a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = new bpts();
        localFile = new File(paramString);
        if (!localFile.exists())
        {
          ((bpts)localObject).jdField_a_of_type_Boolean = false;
  ...
  private static String[] a(String paramString1, String paramString2, bpts parambpts)
  {
    String str1 = "1";
    if (a() >= 2) {
      str1 = "2";
    }
    String str2 = parambpts.c + "x" + String.valueOf(parambpts.d);
    a("[@] generateCommand threads=" + str1 + "  resolution=" + str2);
    return new String[] { "-d", "-y", "-threads", str1, "-copyts", "-copytb", "0", "-i", paramString1, "-metadata:s", "rotate=" + parambpts.jdField_a_of_type_JavaLangString, "-acodec", "aac", "-vcodec", "libx264", "-preset", "ultrafast", "-tune", "fastdecode", "-profile:v", "High", "-level", "1.3", "-minrate", "300k", "-maxrate", "600k", "-bufsize", "800k", "-qmin", "1", "-qmax", String.valueOf(parambpts.e), "-qdiff", "3", "-bf", "3", "-coder", "1", "-refs", "1", "-s", str2, "-movflags", "faststart", paramString2 };
  }
