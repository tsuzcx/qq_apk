...
public class HwVideoMerge
{
  ...
  private aoyw jdField_a_of_type_Aoyw = new aoyw(null);
  ...
  {
    int i = 0;
    this.jdField_a_of_type_Aoyw.jdField_a_of_type_JavaNioByteBuffer.position(0);
    if (this.jdField_a_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Aoyw.jdField_a_of_type_JavaNioByteBuffer, 0) <= 0)
    {
      a();
      i = -5;
    }
    do
    {
      return i;
      this.jdField_a_of_type_Aoyw.jdField_a_of_type_JavaNioByteBuffer.position(0);
    } while (this.jdField_b_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Aoyw.jdField_a_of_type_JavaNioByteBuffer, 0) > 0);
    a();
    return -6;
  }
  ...
  private static int a(List paramList)
  {
    ...
    //   137: dup
    //   138: aconst_null
    //   139: invokespecial 243	aoyv:<init>	(Laoyu;)V
    //   142: astore 4
    ...
    //   177: aload 4
    //   179: aload_0
    //   180: putfield 246	aoyv:a	Ljava/lang/Process;
    //   183: aload 4
    //   185: invokevirtual 247	aoyv:a	()V
    //   188: aload_0
    ...
    //   225: aload 4
    //   227: invokevirtual 249	aoyv:b	()V
    //   230: iload_2
    //   231: istore_1
    //   232: aload_0
    //   233: ifnull -217 -> 16
  ...
  private static int c(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    //   229: dup
    //   230: aconst_null
    //   231: invokespecial 243	aoyv:<init>	(Laoyu;)V
    //   234: astore_0
    ...
    //   265: aload_0
    //   266: aload_1
    //   267: putfield 246	aoyv:a	Ljava/lang/Process;
    //   270: aload_0
    //   271: invokevirtual 247	aoyv:a	()V
    //   274: aload_1
    ...
    //   332: aload_0
    //   333: invokevirtual 249	aoyv:b	()V
    //   336: aload_1
    //   337: ifnull +7 -> 344
    //   340: aload_1
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aoyw.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      j = a();
      i = j;
    } while (j != 0);
    if (!a(paramString))
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aoyw.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack(localMediaFormat);
      this.jdField_a_of_type_Aoyw.jdField_b_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack((MediaFormat)localObject);
      return j;
    }
