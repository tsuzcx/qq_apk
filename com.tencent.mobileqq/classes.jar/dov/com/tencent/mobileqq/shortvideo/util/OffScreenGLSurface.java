  ...
  implements Handler.Callback
{
  ...
  private aoah jdField_a_of_type_Aoah = new aoah(null);
  ...
  {
    this.jdField_a_of_type_Aoah.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Aoah.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Aoah.jdField_b_of_type_Int = 0;
    GLSurfaceUtil.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Aoah.jdField_a_of_type_Int);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_Aoah.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Aoah.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Aoah.jdField_a_of_type_Int = -1;
        f();
      } while (!QLog.isColorLevel());
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoUtilPtvFilterOpenglFrameBuffer != null)
        {
          ...
          if (localTextureDataPipe != null)
          {
            ...
            {
              this.jdField_a_of_type_Aoah.jdField_a_of_type_Boolean = true;
              localObject = localAVIOStruct;
            }
            label752:
            ...
            if ((QLog.isColorLevel()) && (localStringBuilder != null))
            {
              localStringBuilder.append("write ns=").append(this.jdField_a_of_type_Aoah.jdField_a_of_type_Boolean).append("|");
            ...
            if (!bool1)
            {
              if (this.jdField_a_of_type_Aoah.jdField_a_of_type_Boolean) {
        ...
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext != null) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadevicePreviewContext.notifyFirstFrame)) {
            this.jdField_a_of_type_AndroidOsHandler.post(new aoag(this));
          }
          if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoUtilPtvFilterOpenglFrameBuffer != null)
          {
