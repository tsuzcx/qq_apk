  ...
  implements MaxVideoConst, Runnable
{
  ...
  public void run()
  {
    ...
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString))
    {
      ...
      bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "9", null);
      label65:
      return;
    }
    ...
    if (this.f)
    {
      ...
      i = bnrf.a(localObject2, localObject1, this.jdField_b_of_type_Int, str1);
    ...
    try
    {
      ...
      if ((!((File)localObject4).mkdirs()) && (!((File)localObject4).isDirectory()))
      {
        ...
        a(this.jdField_a_of_type_Int, null);
        bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "10", null);
        return;
      }
    }
    ...
    Object localObject4 = bnsv.a(localFile);
    ...
    if (this.jdField_b_of_type_Boolean) {
      localObject4 = new bnqq(localObject2, localIOException, this.jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      try
      {
        i = ((bnqq)localObject4).a();
        if (i == 0)
        {
          this.jdField_a_of_type_JavaLangString = ((bnqq)localObject4).a();
          ...
          bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "record_hw_success", "0", null);
          if (QLog.isColorLevel()) {
          ...
          if (j == -1)
          {
            ...
            bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "record_sw_success", "0", null);
          }
          if (QLog.isColorLevel())
          {
          ...
          bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "record_success", "0", null);
          switch (i)
          {
          default: 
      ...
      catch (NoSuchMethodError localNoSuchMethodError)
      {
        ...
        i = -1;
        continue;
        bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "record_hw_success", "1", i + "_" + Build.MODEL);
        continue;
        localObject4 = localIOException;
        continue;
        bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "record_sw_success", "1", i + "_" + Build.MODEL);
        continue;
        bjwi.a(bnqj.jdField_a_of_type_Long + "", "qzone_video_record", "record_success", "1", i + "_" + Build.MODEL);
        continue;
        this.jdField_a_of_type_Int = 0;
