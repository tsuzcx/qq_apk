...
{
  private static QIMBeautyManager jdField_a_of_type_DovComTencentMobileqqShortvideoQIMBeautyManager;
  ...
  {
    if (jdField_a_of_type_DovComTencentMobileqqShortvideoQIMBeautyManager == null) {}
    try
    {
      if (jdField_a_of_type_DovComTencentMobileqqShortvideoQIMBeautyManager == null) {
        jdField_a_of_type_DovComTencentMobileqqShortvideoQIMBeautyManager = new QIMBeautyManager();
      }
      return jdField_a_of_type_DovComTencentMobileqqShortvideoQIMBeautyManager;
    }
    finally {}
  }
        ...
        if (localObject != null)
        {
          ...
          if (k > 0)
          {
            ...
            while (i < k)
            {
              ...
              {
                WeishiGuideUtils.jdField_a_of_type_JavaLangString = localJSONObject1.getString("downloadInfo");
                if (QLog.isColorLevel()) {
                  QLog.e(jdField_a_of_type_JavaLangString, 2, "QIMBeautyManager WeishiGuideUtils.DOWNLOAD_JSON=  " + WeishiGuideUtils.jdField_a_of_type_JavaLangString);
                }
              }
              i += 1;
            }
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.shortvideo.QIMBeautyManager
