...
public class RecordThumbnailUtils
{
  ...
  public static String a(int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2, int paramInt4)
  {
    ...
    //   342: iload_2
    //   343: iload_3
    //   344: invokestatic 125	blbr:a	([I[BII)V
    //   347: aload 12
    //   349: iload_2
    //   350: iload_3
    ...
    //   371: astore 11
    //   373: iload 5
    //   375: invokestatic 139	bksa:a	(I)Z
    //   378: ifne +11 -> 389
    //   381: aload_1
    //   382: iload 5
    //   384: invokestatic 141	dov/com/tencent/mobileqq/shortvideo/cover/RecordThumbnailUtils:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   387: astore 11
  ...
  public static String a(String paramString, int paramInt1, int paramInt2, int paramInt3, Bitmap.Config paramConfig)
  {
    ...
    return a(paramString, paramInt1, paramInt2, bkzw.a + File.separator + blci.a(localFile) + ".jpg", paramInt3, paramConfig);
  }
  ...
  public static String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, Bitmap.Config paramConfig)
  {
    ...
    //   7: iload_2
    //   8: aload 5
    //   10: invokestatic 208	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   13: astore 5
    //   15: aload 5
    //   17: iload_1
    //   18: iload_2
    //   19: invokestatic 212	dov/com/tencent/mobileqq/shortvideo/cover/RecordThumbnailUtils:nativeGenCover	(Landroid/graphics/Bitmap;II)I
    //   22: istore 6
    ...
    //   45: iload 6
    //   47: invokevirtual 217	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   50: ldc 219
    ...
    //   75: aload_3
    //   76: iload 4
    //   78: invokestatic 221	dov/com/tencent/mobileqq/shortvideo/cover/RecordThumbnailUtils:a	(ILjava/lang/String;IILjava/lang/String;I)Ljava/lang/String;
    //   81: astore_0
    //   82: aload_0
    //   83: areturn
    //   84: astore_0
    ...
    //   93: invokestatic 228	com/tencent/image/URLDrawable:clearMemoryCache	()V
    //   96: invokestatic 233	java/lang/System:gc	()V
    //   99: aconst_null
    //   100: areturn
    //   101: astore_0
    //   102: ldc 49
    ...
    //   153: ifeq +237 -> 390
    //   156: iload 4
    //   158: invokestatic 139	bksa:a	(I)Z
    //   161: ifne +229 -> 390
    //   164: aload 5
    //   166: iload 4
    //   168: invokestatic 141	dov/com/tencent/mobileqq/shortvideo/cover/RecordThumbnailUtils:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   171: astore 5
    ...
    //   269: aload_3
    //   270: invokestatic 244	bbdj:b	(Ljava/lang/String;)Z
