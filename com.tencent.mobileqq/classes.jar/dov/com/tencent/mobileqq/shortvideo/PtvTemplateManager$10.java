...
class PtvTemplateManager$10
  implements Runnable
{
  PtvTemplateManager$10(PtvTemplateManager paramPtvTemplateManager, File paramFile, boolean paramBoolean, bjij parambjij, AppInterface paramAppInterface) {}
  ...
  public void run()
  {
    ...
    synchronized (this.this$0.jdField_d_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_Bjij != null) {
        this.jdField_a_of_type_Bjij.a();
      }
