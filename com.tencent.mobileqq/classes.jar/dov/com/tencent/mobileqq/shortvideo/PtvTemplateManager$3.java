  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (PtvTemplateManager.a() == null) {}
    File[] arrayOfFile;
    do
    {
      return;
      arrayOfFile = PtvTemplateManager.a().listFiles();
    ...
    for (;;)
    {
      ...
      {
        localObject = PtvTemplateManager.a(this.this$0).doodleInfos.iterator();
        ...
        for (int j = 1;; j = 0)
        {
          ...
          new File(PtvTemplateManager.a() + localFile.getName()).deleteOnExit();
          break;
        }
      }
    }
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.shortvideo.PtvTemplateManager.3
