  ...
  implements QQSpecialAVFilter.MusicWaveformSupporter, Mp4ReEncoder.EncodeFilterRender
{
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      QQEncodeFilterRender.1 local1 = new QQEncodeFilterRender.1(this);
      try
      {
        long l = SystemClock.elapsedRealtimeNanos();
        boolean bool = this.jdField_a_of_type_DovComTencentMobileqqShortvideoMusicwavesupportMusicSoundFile.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, local1, 0);
        if (QLog.isColorLevel()) {
