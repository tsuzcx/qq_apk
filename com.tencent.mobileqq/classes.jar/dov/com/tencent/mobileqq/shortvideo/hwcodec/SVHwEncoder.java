...
public class SVHwEncoder
{
  ...
  public void a(SVHwOutputNotify paramSVHwOutputNotify, SVHwDataSource paramSVHwDataSource, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Aoyg = new aoyg(this, this.jdField_a_of_type_JavaLangString, paramSVHwOutputNotify, paramSVHwDataSource, paramBoolean, 99000);
    new Thread(this.jdField_a_of_type_Aoyg, "encode_qq" + jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.getAndIncrement()).start();
  }
  ...
  {
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwOutputNotify = paramSVHwOutputNotify;
    this.jdField_a_of_type_Aoyg = new aoyg(this, this.jdField_a_of_type_JavaLangString, paramSVHwOutputNotify, paramSVHwDataSource, paramBoolean, 0);
    this.jdField_a_of_type_Aoyg.run();
  }
