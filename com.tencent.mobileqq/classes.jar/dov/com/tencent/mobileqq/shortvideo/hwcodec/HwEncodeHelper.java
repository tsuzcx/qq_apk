  ...
  implements SVHwDataSource, SVHwOutputNotify
{
  ...
  private SVHwEncoder.HwFrame jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame = new SVHwEncoder.HwFrame();
  ...
  private SVHwEncoder.HwFrame jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame = new SVHwEncoder.HwFrame();
  ...
  public SVHwEncoder.HwFrame a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecVideoSourceHelper != null) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_ArrayOfByte = this.jdField_b_of_type_ArrayOfByte;
      this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_Int = 0;
      this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_b_of_type_Int = i;
      this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_b_of_type_Boolean = false;
      SVHwEncoder.HwFrame localHwFrame = this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame;
      if (i > 0) {}
      for (;;)
      {
        localHwFrame.jdField_a_of_type_Boolean = bool;
        localHwFrame = this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame;
        this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.c = -1;
        localHwFrame.jdField_a_of_type_Long = -1;
        this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_Float = -1.0F;
        if (QLog.isColorLevel()) {
          QLog.d("HwEncodeHelper", 4, "getAudioFrame() bufferSize=" + this.jdField_b_of_type_ArrayOfByte.length + ", readSize=" + i);
        }
        this.jdField_a_of_type_Boolean = this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_Boolean;
        return this.jdField_b_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame;
        bool = true;
      }
    }
    return null;
  ...
  public SVHwEncoder.HwFrame a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecVideoSourceHelper != null) && (!this.jdField_b_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_b_of_type_Int = paramInt;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_b_of_type_Boolean = true;
      SVHwEncoder.HwFrame localHwFrame = this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame;
      if (paramInt > 0) {
        bool = false;
      }
      localHwFrame.jdField_a_of_type_Boolean = bool;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_Long = this.jdField_a_of_type_ArrayOfLong[0];
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.c = -1;
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_Float = -1.0F;
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame.jdField_a_of_type_Boolean;
      return this.jdField_a_of_type_DovComTencentMobileqqShortvideoHwcodecSVHwEncoder$HwFrame;
    }
    return null;
  }
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.shortvideo.hwcodec.HwEncodeHelper
