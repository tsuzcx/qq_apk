...
{
  private static VideoSendTaskManager jdField_a_of_type_DovComTencentMobileqqRichmediaVideoSendTaskManager;
  ...
  public static VideoSendTaskManager a()
  {
    try
    {
      if (jdField_a_of_type_DovComTencentMobileqqRichmediaVideoSendTaskManager == null) {
        jdField_a_of_type_DovComTencentMobileqqRichmediaVideoSendTaskManager = new VideoSendTaskManager();
      }
      VideoSendTaskManager localVideoSendTaskManager = jdField_a_of_type_DovComTencentMobileqqRichmediaVideoSendTaskManager;
  ...
  {
    ThreadManager.post(new anut(this, paramHashMap), 5, null, true);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, Bundle paramBundle)
  {
    ...
    TransferRequest localTransferRequest = a(new anuu(this, paramQQAppInterface, paramString));
  ...
  public void b(QQAppInterface paramQQAppInterface, String paramString, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_MqqOsMqqHandler.post(new anuw(this, paramString));
      return;
    }
    finally {}
  }
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.richmedia.VideoSendTaskManager
