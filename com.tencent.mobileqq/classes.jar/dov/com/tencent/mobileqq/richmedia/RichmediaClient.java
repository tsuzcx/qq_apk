  ...
  implements RichmediaIPCConstants
{
  ...
  private RichmediaClient()
  {
    ...
    this.jdField_a_of_type_Anur = new anur(this.jdField_a_of_type_AndroidOsHandlerThread.getLooper(), this);
    this.jdField_a_of_type_AndroidOsMessenger = new Messenger(this.jdField_a_of_type_Anur);
    this.jdField_a_of_type_AndroidContentServiceConnection = new anup(this);
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaICallBack = new anuq(this);
  }
