  ...
  implements Handler.Callback, RichmediaIPCConstants
{
  ...
  {
    super.onCreate();
    this.jdField_a_of_type_Aotq = new aotq(ThreadManager.getSubThreadLooper(), this);
    this.jdField_a_of_type_AndroidOsMessenger = new Messenger(this.jdField_a_of_type_Aotq);
  ...
  {
    super.onDestroy();
    this.jdField_a_of_type_Aotq = null;
