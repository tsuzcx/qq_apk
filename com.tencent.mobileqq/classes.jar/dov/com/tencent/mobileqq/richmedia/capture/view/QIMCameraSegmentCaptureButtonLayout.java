  ...
  extends QIMCameraCaptureButtonLayout
{
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new anws(this));
    ...
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_DovComQqImCaptureViewQIMCircleProgress.a().size() > 0)) {
      this.jdField_c_of_type_AndroidAnimationValueAnimator.addListener(new anwt(this, paramBoolean, f));
    }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new anwu(this));
    this.jdField_c_of_type_AndroidAnimationValueAnimator.addListener(new anwv(this, paramBoolean));
    this.jdField_c_of_type_AndroidAnimationValueAnimator.start();
