...
public class LiuHaiUtils
{
  ...
  private static boolean c(Activity paramActivity)
  {
    ...
    if (i > 27)
    {
      ...
      {
        localObject = (SplashActivity)SplashActivity.a.get();
        label110:
        if (localObject == null) {
          break label266;
        }
        label115:
        bool1 = a((Activity)localObject);
      }
    }
    else
    {
  ...
  public static void d(Activity paramActivity)
  {
    ...
    try
    {
      jdField_f_of_type_Boolean = c(paramActivity);
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.richmedia.capture.util.LiuHaiUtils
