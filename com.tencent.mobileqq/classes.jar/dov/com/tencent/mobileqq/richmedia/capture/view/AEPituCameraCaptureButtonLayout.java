  ...
  extends RelativeLayout
{
  ...
  public AEPituCameraCaptureButtonLayout(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnTouchListener = new bjel(this);
    this.jdField_a_of_type_AndroidOsHandler = new bjem(this, Looper.getMainLooper());
    a();
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            c();
            return;
          } while (this.jdField_a_of_type_Bjen == null);
          this.jdField_a_of_type_Bjen.x();
          return;
        } while (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get());
        if (this.jdField_a_of_type_Bjen != null) {
          this.jdField_a_of_type_Bjen.y();
        }
        this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
        f();
        return;
        if (this.jdField_a_of_type_Bjen != null) {
          this.jdField_a_of_type_Bjen.w();
        }
        f();
        return;
      } while (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get());
  ...
  public void a(bjen parambjen, AECameraGLSurfaceView paramAECameraGLSurfaceView)
  {
    this.jdField_a_of_type_DovComQqImAECameraViewAECameraGLSurfaceView = paramAECameraGLSurfaceView;
  ...
  public void a(boolean paramBoolean, bjep parambjep)
  {
    this.jdField_d_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_Bjep = parambjep;
  }
  ...
  public boolean a(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        return false;
        if (this.g) {
          GLGestureProxy.getInstance().onTouchEvent(paramMotionEvent, true, this.jdField_b_of_type_AndroidViewView, this.jdField_a_of_type_DovComQqImAECameraViewAECameraGLSurfaceView);
        }
      } while ((this.jdField_a_of_type_Boolean) || (!this.e));
      if ((this.jdField_a_of_type_Bjen != null) && ((paramMotionEvent.getAction() & 0xFF) == 0)) {
        this.jdField_a_of_type_Bjen.z();
      }
  ...
  public void b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_DovComQqImStoryViewAnimationQIMCircleProgress.setTranslationY(bajq.a(17.0F));
      this.jdField_b_of_type_AndroidViewView.setTranslationY(bajq.a(17.0F));
      return;
    }
    this.jdField_a_of_type_DovComQqImStoryViewAnimationQIMCircleProgress.setTranslationY(bajq.a(17.0F));
    this.jdField_b_of_type_AndroidViewView.setTranslationY(bajq.a(17.0F));
  ...
  protected void c()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bjei(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bjej(this));
    ...
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bjek(this));
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Bjep != null) {
      this.jdField_a_of_type_Bjep.a();
    }
  }
    ...
    do
    {
      ...
      case 3: 
        ...
        for (;;)
        {
          ...
          } else if ((this.jdField_a_of_type_Int == 3) && (this.jdField_a_of_type_Bjen != null)) {
            this.jdField_a_of_type_Bjen.B();
          }
        }
      case 2: 
        this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(4);
