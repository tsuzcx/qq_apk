  ...
  extends RelativeLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new aouz(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new aouy(this);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new aouw(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new aoux(this));
