  ...
  extends LinearLayout
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new anvx(this);
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new anvy(this);
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new anvz(this));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getContext().getResources().getDrawable(2130842896);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131370048));
