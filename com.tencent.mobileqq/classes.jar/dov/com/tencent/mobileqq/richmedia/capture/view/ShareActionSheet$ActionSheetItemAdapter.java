...
class ShareActionSheet$ActionSheetItemAdapter
  extends BaseAdapter
{
  private int jdField_a_of_type_Int;
  private Resources jdField_a_of_type_AndroidContentResResources;
  private LayoutInflater jdField_a_of_type_AndroidViewLayoutInflater;
  private ShareActionSheet.ActionSheetItemAdapter.IconFactory jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory == null) {
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory = new ShareActionSheet.ActionSheetItemAdapter.IconFactory(paramViewGroup.getContext());
    }
    View localView;
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559010, paramViewGroup, false);
      paramView = new ShareActionSheet.ActionSheetItemViewHolder();
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (ShareActionSheet.ActionSheetItemViewHolder)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
    }
    localView.setId(paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.id);
    paramView.jdField_a_of_type_AndroidWidgetTextView.setText(ShareActionSheet.a(paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.label, 6));
    int i = -8947849;
    ...
    if (paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable)
    {
      ...
      localObject = this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory.a((Drawable)localObject, i, j);
      if (!paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label459;
      }
      Drawable localDrawable = ShareActionSheet.ActionSheetItemAdapter.IconFactory.a(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory, (Drawable)localObject);
      localObject = this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label328;
      label459:
      localObject = ShareActionSheet.ActionSheetItemAdapter.IconFactory.b(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewShareActionSheet$ActionSheetItemAdapter$IconFactory, (Drawable)localObject);
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      break label408;
      label482:
 ...
 * Qualified Name:     dov.com.tencent.mobileqq.richmedia.capture.view.ShareActionSheet.ActionSheetItemAdapter
