...
public class DragAnimationMgr
{
  ...
  private bkwl jdField_a_of_type_Bkwl = new bkwl();
  ...
  private void a(float paramFloat)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bkwl.jdField_a_of_type_Float = (Math.max(i, paramFloat) / 4.0F);
      if (this.jdField_a_of_type_Bkwl.jdField_a_of_type_Float <= 0.0F) {
        this.jdField_a_of_type_Bkwl.jdField_a_of_type_Float = blcq.a(1.0F);
      }
      return;
      i = this.c.getWidth() / 2;
      continue;
  ...
  private void a(DragAnimationMgr.DragViewIcon paramDragViewIcon, int paramInt)
  {
    ...
    localObjectAnimator.addListener(new bkwj(this, paramDragViewIcon));
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (this.jdField_a_of_type_Bkwk != null) {
      if (paramBoolean1) {
        this.jdField_a_of_type_Bkwk.a(paramBoolean2);
      }
    }
    while (!this.jdField_a_of_type_Boolean)
    {
      return;
      this.jdField_a_of_type_Bkwk.b(paramBoolean2);
      return;
    }
    if (paramBoolean1)
    {
      bcql.a(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon.getContext(), ajya.a(2131703526) + paramBoolean2, 0).a();
      return;
    }
    bcql.a(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon.getContext(), ajya.a(2131703525) + paramBoolean2 + " max:" + paramBoolean3, 0).a();
  }
  ...
  private void c()
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon == null)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon.setTranslationY(blcq.a(17.0F));
  ...
  private void c(MotionEvent paramMotionEvent)
  {
    ...
    if (i == 0)
    {
      ...
      if (this.jdField_a_of_type_Bkwk != null) {
        this.jdField_a_of_type_Bkwk.a(false, false);
      }
    }
    boolean bool1;
    label184:
    do
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        this.jdField_a_of_type_Bkwk.a(true, false);
        return;
      }
      if (this.jdField_a_of_type_Int != 1) {
        break;
      }
    } while (this.jdField_a_of_type_Bkwk == null);
    this.jdField_a_of_type_Bkwk.a(false, false);
    return;
    label211:
    ...
    float f2 = Math.abs(f1 - this.jdField_a_of_type_Bkwl.jdField_c_of_type_Float);
    int k = this.jdField_a_of_type_AndroidViewViewGroup.getHeight() / 2;
    if (QLog.isColorLevel()) {
      QLog.i("DragAnimationMgr", 2, "upScreenAnimation: currentY=" + f1 + " startY=" + this.jdField_a_of_type_Bkwl.jdField_c_of_type_Float + " moveYOffset=" + f2 + " parentHeightHalf=" + k);
    }
    boolean bool2 = bool3;
    ...
    if (this.jdField_a_of_type_Bkwk != null) {
      this.jdField_a_of_type_Bkwk.a(bool1, bool2);
    }
    if (j <= 5)
    {
    ...
    a(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon, i, j, new bkwi(this));
  }
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon.jdField_e_of_type_Int = ((int)this.jdField_a_of_type_Bkwl.jdField_a_of_type_Float);
      return;
  ...
  protected void a()
  {
    if (!this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean)
    {
      float f = Math.abs(this.jdField_a_of_type_Bkwl.f);
      if (QLog.isColorLevel()) {
        QLog.i("DragAnimationMgr", 2, "longTouchMoveUser: absMoveInter=" + f + " limit=" + bkwl.jdField_c_of_type_Int);
      }
      if (f > bkwl.jdField_c_of_type_Int) {
        this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean = false;
      }
    }
    int j;
    int i;
    ...
    default: 
      if (QLog.isColorLevel()) {
        QLog.i("DragAnimationMgr", 2, "longTouchMoveUser: [big] mAnimationDirection=" + this.jdField_a_of_type_Int + " xDiff=" + this.jdField_a_of_type_Bkwl.f);
      }
      if ((this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Bkwk != null)) {
        this.jdField_a_of_type_Bkwk.c();
      }
      if (QLog.isColorLevel()) {
        QLog.i("DragAnimationMgr", 2, "longTouchMoveUser: hasMoved=" + this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean + " mAnimationDirection=" + this.jdField_a_of_type_Int);
      }
      if (this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean)
      {
        j = (int)(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon.a() + this.jdField_a_of_type_Bkwl.f);
        switch (this.jdField_a_of_type_Int)
        {
        default: 
          i = j;
    ...
    for (;;)
    {
      if (Math.abs(i) >= bkwl.jdField_b_of_type_Int) {
        break label396;
      }
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewDragAnimationMgr$DragViewIcon.b(0);
      return;
      if (this.jdField_a_of_type_Bkwl.f <= 0.0F) {
        break;
      }
      this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean = true;
      break;
      if (this.jdField_a_of_type_Bkwl.f >= 0.0F) {
        break;
      }
  ...
  protected void a(MotionEvent paramMotionEvent)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Bkwl.jdField_b_of_type_Float = paramMotionEvent.getRawX();
      this.jdField_a_of_type_Bkwl.jdField_c_of_type_Float = paramMotionEvent.getRawY();
      this.jdField_a_of_type_Bkwl.jdField_d_of_type_Float = paramMotionEvent.getRawX();
      this.jdField_a_of_type_Bkwl.jdField_e_of_type_Float = paramMotionEvent.getRawY();
      this.jdField_a_of_type_Bkwl.h = paramMotionEvent.getRawX();
      this.jdField_a_of_type_Bkwl.i = paramMotionEvent.getRawY();
      this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Bkwl.jdField_d_of_type_Boolean = false;
      this.jdField_a_of_type_Bkwl.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_Bkwl.jdField_c_of_type_Boolean = false;
      this.jdField_a_of_type_Bkwl.jdField_e_of_type_Int = 0;
      a(bkwl.jdField_a_of_type_Int);
      c();
      if (this.jdField_a_of_type_Bkwk != null) {
        this.jdField_a_of_type_Bkwk.a();
      }
    } while (!QLog.isColorLevel());
    QLog.i("DragAnimationMgr", 2, "longTouchDown: hasMoved=" + this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean + " startX=" + this.jdField_a_of_type_Bkwl.jdField_b_of_type_Float);
  }
  ...
  protected void b(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bkwl.h = paramMotionEvent.getRawX();
      this.jdField_a_of_type_Bkwl.i = paramMotionEvent.getRawY();
      this.jdField_a_of_type_Bkwl.f = (this.jdField_a_of_type_Bkwl.h - this.jdField_a_of_type_Bkwl.jdField_d_of_type_Float);
      this.jdField_a_of_type_Bkwl.g = (this.jdField_a_of_type_Bkwl.i - this.jdField_a_of_type_Bkwl.jdField_e_of_type_Float);
      if (QLog.isColorLevel()) {
        QLog.i("DragAnimationMgr", 2, "longTouchDown: hasMoved=" + this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean + " startX=" + this.jdField_a_of_type_Bkwl.jdField_b_of_type_Float + "  xDiff=" + this.jdField_a_of_type_Bkwl.f + "  lastX=" + this.jdField_a_of_type_Bkwl.jdField_d_of_type_Float);
      }
      if (this.jdField_b_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.i("DragAnimationMgr", 2, "handleTouch hasCheckLong" + this.jdField_a_of_type_Bkwl.jdField_c_of_type_Boolean);
        }
        if (!this.jdField_a_of_type_Bkwl.jdField_c_of_type_Boolean)
        {
          this.jdField_a_of_type_Bkwl.jdField_c_of_type_Boolean = true;
          if (Math.abs(this.jdField_a_of_type_Bkwl.f) <= bkwl.jdField_d_of_type_Int) {
            break label540;
          }
        }
        for (this.jdField_a_of_type_Bkwl.jdField_b_of_type_Boolean = false;; this.jdField_a_of_type_Bkwl.jdField_b_of_type_Boolean = true)
        {
          if (this.jdField_a_of_type_Bkwk != null) {
            this.jdField_a_of_type_Bkwk.c(this.jdField_a_of_type_Bkwl.jdField_b_of_type_Boolean);
          }
          if (QLog.isColorLevel()) {
            QLog.i("DragAnimationMgr", 2, "handleTouch enableMoved" + this.jdField_a_of_type_Bkwl.jdField_b_of_type_Boolean);
          }
          if (QLog.isColorLevel()) {
            QLog.i("DragAnimationMgr", 2, "handleTouch enableMoved" + this.jdField_a_of_type_Bkwl.jdField_b_of_type_Boolean);
          }
          if (this.jdField_a_of_type_Bkwl.jdField_b_of_type_Boolean)
          {
            a();
            if (this.jdField_a_of_type_Bkwl.jdField_a_of_type_Boolean)
            {
              this.jdField_a_of_type_Bkwl.jdField_d_of_type_Float = this.jdField_a_of_type_Bkwl.h;
              this.jdField_a_of_type_Bkwl.jdField_e_of_type_Float = this.jdField_a_of_type_Bkwl.i;
            }
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          QLog.i("DragAnimationMgr", 2, "handleTouch[Adsorption] xDiff=" + this.jdField_a_of_type_Bkwl.f + " currentX=" + this.jdField_a_of_type_Bkwl.h + " yDiff=" + this.jdField_a_of_type_Bkwl.g + " currentY=" + this.jdField_a_of_type_Bkwl.i);
          return;
        }
      }
    } while (!QLog.isColorLevel());
