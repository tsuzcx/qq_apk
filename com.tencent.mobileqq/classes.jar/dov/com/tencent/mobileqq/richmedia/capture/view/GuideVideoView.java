  ...
  implements acwb, View.OnClickListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnInfoListener, TVK_IMediaPlayer.OnNetVideoInfoListener, TVK_IMediaPlayer.OnVideoPreparedListener, TVK_IMediaPlayer.OnVideoPreparingListener, IVideoViewBase.IVideoViewCallBack
{
  ...
  private bkwn jdField_a_of_type_Bkwn;
  private bkwo jdField_a_of_type_Bkwo;
  ...
  public void a()
  {
    ...
    int i = blcq.a(getContext()) - blcq.a(95.0F) * 2;
    double d1 = 0.0D;
    if (Double.isNaN(0.0D)) {
      d1 = 0.6D;
    }
    int j = (int)(d1 * i);
    int k = (blcq.jdField_a_of_type_Int - j) / 2;
    setPadding(k, blcq.a(95.0F), k, 0);
    setOrientation(1);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131705428));
    ...
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewFadedButton.setBackgroundResource(2130845089);
    localObject1 = new LinearLayout.LayoutParams(blcq.a(40.0F), blcq.a(40.0F));
  ...
  public void onClick(View paramView)
  {
    if (paramView == this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewFadedButton) {
      if (this.jdField_a_of_type_Bkwm != null) {
        this.jdField_a_of_type_Bkwm.a();
      }
    }
    do
    {
  ...
  {
    if (this.jdField_a_of_type_Bkwn != null) {
      this.jdField_a_of_type_Bkwn.a();
    }
  }
  
  public boolean onError(TVK_IMediaPlayer paramTVK_IMediaPlayer, int paramInt1, int paramInt2, int paramInt3, String paramString, Object paramObject)
  {
    if (this.jdField_a_of_type_Bkwo != null) {
      this.jdField_a_of_type_Bkwo.a("onError sdkError : " + paramInt1 + "  sdkDetailError : " + paramInt2);
    }
    return false;
  }
  ...
  public void setOnCloseListener(bkwm parambkwm)
  {
    this.jdField_a_of_type_Bkwm = parambkwm;
  }
  
  public void setOnCompleteListener(bkwn parambkwn)
  {
    this.jdField_a_of_type_Bkwn = parambkwn;
  }
  
  public void setOnErrorListener(bkwo parambkwo)
  {
    this.jdField_a_of_type_Bkwo = parambkwo;
  }
}
