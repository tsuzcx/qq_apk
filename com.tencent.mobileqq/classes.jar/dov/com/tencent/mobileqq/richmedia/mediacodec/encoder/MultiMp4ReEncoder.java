  ...
  implements SurfaceTexture.OnFrameAvailableListener, HWEncodeListener, HWEncodeNextListener, HWDecodeListener
{
  ...
  private List<HWVideoDecoder> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean = false;
  private int jdField_b_of_type_Int = 0;
  private long jdField_b_of_type_Long = -1L;
  private Object jdField_b_of_type_JavaLangObject = new Object();
  private List<DecodeConfig> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean;
  private int jdField_c_of_type_Int;
  private long jdField_c_of_type_Long = 0L;
  private volatile int d = 0;
  
  public MultiMp4ReEncoder()
  {
  ...
  public void a()
  {
    ...
    ((HWVideoDecoder)this.jdField_a_of_type_JavaUtilList.get(this.d)).startDecode((DecodeConfig)this.jdField_b_of_type_JavaUtilList.get(this.d), this.jdField_c_of_type_Int, this, this);
  }
  ...
  public void onEncodeError(int paramInt, Throwable paramThrowable)
  {
    ...
    ((HWVideoDecoder)this.jdField_a_of_type_JavaUtilList.get(this.d)).stopDecode();
  ...
  public void onEncodeStart()
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUOESBaseFilter.onOutputSizeChanged(this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEncodeConfig.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEncodeConfig.jdField_b_of_type_Int);
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecEncoderEncodeConfig.h != 0)
          {
            ...
            this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUOESBaseFilter.drawTexture(this.jdField_c_of_type_Int, null, arrayOfFloat2);
            paramSurfaceTexture.unbind();
            this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter.drawTexture(paramSurfaceTexture.getTexId(), arrayOfFloat1, null);
            this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWVideoRecorder.a(3553, paramSurfaceTexture.getTexId(), arrayOfFloat1, null, this.jdField_b_of_type_Long + this.jdField_c_of_type_Long);
            int i = 1;
            if (i > this.jdField_a_of_type_Int) {
              break;
            }
            this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecRecorderHWVideoRecorder.a(3553, paramSurfaceTexture.getTexId(), arrayOfFloat1, null, this.jdField_b_of_type_Long + this.jdField_c_of_type_Long + i * 5 * 1000);
            i += 1;
            continue;
        ...
        catch (Exception paramSurfaceTexture)
        {
          this.jdField_a_of_type_Boolean = true;
          this.jdField_a_of_type_JavaLangObject.notifyAll();
          QLog.w("MultiMp4ReEncoder", 2, "onFrameAvailable error=" + this.jdField_b_of_type_Int + " ; canceled=" + this.jdField_b_of_type_Boolean, paramSurfaceTexture);
          return;
        }
      }
