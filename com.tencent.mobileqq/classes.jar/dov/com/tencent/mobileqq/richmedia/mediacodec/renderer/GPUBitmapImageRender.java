  ...
  implements GLSurfaceView.Renderer
{
  ...
  public Bitmap a(Bitmap paramBitmap, long paramLong)
  {
    ...
    if (localQQFilterRenderManager != null)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender = new QQEncodeFilterRender(localQQFilterRenderManager.getBusinessOperation().getCurrentAVFilterIdList(), localMusicItemInfo, this.b, this.c, null);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender.a(true);
      if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender == null) || (localObject == null)) {
        break label210;
      }
    }
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender.a(this.b, this.c);
      ...
      try
      {
        ...
        this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender = null;
        return localObject;
      }
  ...
  public Bitmap a(Bitmap paramBitmap, GPUBaseFilter paramGPUBaseFilter)
  {
    ...
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender != null) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender.jdField_a_of_type_Boolean)) {}
    for (int i = 30;; i = 2)
    {
      int j = 0;
      while (j < i)
  ...
  public Bitmap a(Bitmap paramBitmap, List<FilterDesc> paramList, GPUBitmapImageRender paramGPUBitmapImageRender)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
      int i = 5;
      if (paramGPUBitmapImageRender.jdField_a_of_type_Boolean)
      {
    ...
    for (;;)
    {
      ...
      for (localObject = this.jdField_a_of_type_AndroidGraphicsBitmap;; localObject = paramGL10)
      {
        ...
        if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender != null) {
          this.jdField_a_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqShortvideoFilterQQEncodeFilterRender.a(this.b, this.c, this.jdField_a_of_type_Int, this.jdField_a_of_type_Long);
        }
        if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
        {
