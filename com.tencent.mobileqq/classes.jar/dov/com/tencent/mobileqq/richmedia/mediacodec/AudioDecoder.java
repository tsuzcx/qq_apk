...
public class AudioDecoder
{
  ...
  private void a(AudioTrack paramAudioTrack, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    {
    default: 
      if (!this.jdField_a_of_type_Brft.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      if ((!this.jdField_a_of_type_Brft.jdField_b_of_type_Boolean) && (paramInt == 0) && (paramArrayOfByte != null)) {
  ...
  public static void a(java.lang.String paramString1, long paramLong, java.lang.String paramString2)
  {
    ...
    //   11: new 23	brft
    //   14: dup
    //   15: invokespecial 55	brft:<init>	()V
    //   18: putfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Brft	Lbrft;
    //   21: aload 4
    //   23: getfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Brft	Lbrft;
    //   26: aload_0
    //   27: putfield 58	brft:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   30: aload 4
    //   32: getfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Brft	Lbrft;
    //   35: aload_0
    //   36: aconst_null
    //   37: iconst_0
    //   38: invokestatic 63	com/tencent/mobileqq/shortvideo/util/AudioEncoder:a	(Ljava/lang/String;Ljava/lang/String;I)Lbddn;
    //   41: putfield 66	brft:jdField_a_of_type_Bddn	Lbddn;
    //   44: aload 4
    //   46: getfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Brft	Lbrft;
    //   49: lload_1
    //   50: putfield 70	brft:c	J
    //   53: aload_3
    //   54: invokestatic 75	bhmi:c	(Ljava/lang/String;)V
  ...
  public void a(long paramLong)
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecAudioDecoder$AudioPlayRunnable != null)
    {
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecAudioDecoder$AudioPlayRunnable.a(paramLong, this.jdField_a_of_type_Brft.c);
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if ((paramLong1 == this.jdField_a_of_type_Brft.jdField_a_of_type_Long) && (paramLong2 == this.jdField_a_of_type_Brft.jdField_b_of_type_Long))
    {
    ...
    this.jdField_a_of_type_Brft.jdField_a_of_type_Long = paramLong1;
    this.jdField_a_of_type_Brft.jdField_b_of_type_Long = paramLong2;
    a(this.jdField_a_of_type_Brft);
  }
  ...
  public void a(brft parambrft)
  {
    for (;;)
    {
      ...
      try
      {
        QLog.d("AudioDecoder", 4, "startPlay " + parambrft.toString());
        c();
        b();
        if (this.jdField_a_of_type_Brft == null) {
        ...
        if (this.jdField_a_of_type_Brft.jdField_b_of_type_Long == 0L) {
          this.jdField_a_of_type_Brft.jdField_b_of_type_Long = this.jdField_a_of_type_Brft.c;
        }
        f2 = (float)this.jdField_a_of_type_Brft.jdField_a_of_type_Long / (float)this.jdField_a_of_type_Brft.c;
        f3 = (float)this.jdField_a_of_type_Brft.jdField_b_of_type_Long / (float)this.jdField_a_of_type_Brft.c;
        f1 = f2;
        if (f2 >= 0.0F) {
          break label228;
        }
      ...
      if (!TextUtils.isEmpty(parambrft.jdField_b_of_type_JavaLangString))
      {
  ...
  public byte[] a()
  {
    return AudioDecoder.AudioPlayRunnable.a(new AudioDecoder.AudioPlayRunnable(this, 0.0F, 1.0F), this.jdField_a_of_type_Brft.jdField_a_of_type_JavaLangString, false);
  }
