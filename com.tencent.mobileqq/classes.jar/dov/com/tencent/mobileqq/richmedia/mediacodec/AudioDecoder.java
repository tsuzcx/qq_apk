...
public class AudioDecoder
{
  ...
  private void a(AudioTrack paramAudioTrack, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    {
    default: 
      if (!this.jdField_a_of_type_Bqei.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      if ((!this.jdField_a_of_type_Bqei.jdField_b_of_type_Boolean) && (paramInt == 0) && (paramArrayOfByte != null)) {
  ...
  public static void a(java.lang.String paramString1, long paramLong, java.lang.String paramString2)
  {
    ...
    //   11: new 23	bqei
    //   14: dup
    //   15: invokespecial 55	bqei:<init>	()V
    //   18: putfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Bqei	Lbqei;
    //   21: aload 4
    //   23: getfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Bqei	Lbqei;
    //   26: aload_0
    //   27: putfield 58	bqei:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   30: aload 4
    //   32: getfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Bqei	Lbqei;
    //   35: aload_0
    //   36: aconst_null
    //   37: iconst_0
    //   38: invokestatic 63	com/tencent/mobileqq/shortvideo/util/AudioEncoder:a	(Ljava/lang/String;Ljava/lang/String;I)Lbckv;
    //   41: putfield 66	bqei:jdField_a_of_type_Bckv	Lbckv;
    //   44: aload 4
    //   46: getfield 21	dov/com/tencent/mobileqq/richmedia/mediacodec/AudioDecoder:jdField_a_of_type_Bqei	Lbqei;
    //   49: lload_1
    //   50: putfield 70	bqei:c	J
    //   53: aload_3
    //   54: invokestatic 75	bgmg:c	(Ljava/lang/String;)V
  ...
  public void a(long paramLong)
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecAudioDecoder$AudioPlayRunnable != null)
    {
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecAudioDecoder$AudioPlayRunnable.a(paramLong, this.jdField_a_of_type_Bqei.c);
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if ((paramLong1 == this.jdField_a_of_type_Bqei.jdField_a_of_type_Long) && (paramLong2 == this.jdField_a_of_type_Bqei.jdField_b_of_type_Long))
    {
    ...
    this.jdField_a_of_type_Bqei.jdField_a_of_type_Long = paramLong1;
    this.jdField_a_of_type_Bqei.jdField_b_of_type_Long = paramLong2;
    a(this.jdField_a_of_type_Bqei);
  }
  ...
  public void a(bqei parambqei)
  {
    for (;;)
    {
      ...
      try
      {
        QLog.d("AudioDecoder", 4, "startPlay " + parambqei.toString());
        c();
        b();
        if (this.jdField_a_of_type_Bqei == null) {
        ...
        if (this.jdField_a_of_type_Bqei.jdField_b_of_type_Long == 0L) {
          this.jdField_a_of_type_Bqei.jdField_b_of_type_Long = this.jdField_a_of_type_Bqei.c;
        }
        f2 = (float)this.jdField_a_of_type_Bqei.jdField_a_of_type_Long / (float)this.jdField_a_of_type_Bqei.c;
        f3 = (float)this.jdField_a_of_type_Bqei.jdField_b_of_type_Long / (float)this.jdField_a_of_type_Bqei.c;
        f1 = f2;
        if (f2 >= 0.0F) {
          break label228;
        }
      ...
      if (!TextUtils.isEmpty(parambqei.jdField_b_of_type_JavaLangString))
      {
  ...
  public byte[] a()
  {
    return AudioDecoder.AudioPlayRunnable.a(new AudioDecoder.AudioPlayRunnable(this, 0.0F, 1.0F), this.jdField_a_of_type_Bqei.jdField_a_of_type_JavaLangString, false);
  }
