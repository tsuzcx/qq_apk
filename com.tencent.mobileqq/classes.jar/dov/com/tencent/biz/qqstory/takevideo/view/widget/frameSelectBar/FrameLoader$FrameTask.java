  ...
  extends Task
{
  ...
  private FrameLoader.GetFrameReport jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetFrameSelectBarFrameLoader$GetFrameReport;
  ...
  public FrameLoader$FrameTask(ImageView paramImageView, MediaMetadataRetriever paramMediaMetadataRetriever, Integer paramInteger, int paramInt1, int paramInt2, long paramLong, int paramInt3, boolean paramBoolean1, FrameLoader.GetFrameReport paramGetFrameReport, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetFrameSelectBarFrameLoader$GetFrameReport = paramGetFrameReport;
      ...
      try
      {
        ...
        if (this.jdField_b_of_type_Boolean)
        {
          ...
          if (TrimNative.getThumbnail(0L, l1, localBitmap1) == 0)
          {
            ...
            this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetFrameSelectBarFrameLoader$GetFrameReport.a(this.jdField_a_of_type_JavaLangInteger.intValue(), l1);
          }
        }
        else
        {
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.view.widget.frameSelectBar.FrameLoader.FrameTask
