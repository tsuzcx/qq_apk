  ...
  implements Handler.Callback, boud, bpqi, HWDecodeListener
{
  ...
  public HWEditLocalVideoPlayer(@NonNull botw parambotw)
  {
    super(parambotw);
  ...
  private Bitmap a(@NonNull boux paramboux, boolean paramBoolean)
  {
    long l1 = 0L;
    Object localObject2 = boux.a(paramboux);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localObject2 = localObject1;
          if (boux.b(paramboux) != null)
          {
            bppw localbppw = (bppw)bppt.a(106);
            localbppw.a(boux.b(paramboux));
            localbppw.init();
        ...
        if ((0 != 0) && (boux.a(paramboux) != null) && (localObject2 != null)) {
        ...
        localObject2 = localObject1;
        if (localObject1 != boux.a(paramboux)) {
          break;
        }
        localObject2 = localObject1;
        if (boux.b(paramboux)) {
        ...
        return paramboux.jdField_a_of_type_AndroidGraphicsBitmap;
      }
    }
  }
  ...
  private void a(@NonNull boux paramboux)
  {
    ykq.b("Q.qqstory.record.HWEditLocalVideoPlayer", "setPlayInfo，index : %d => %d", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(paramboux.c));
    if (paramboux.jdField_a_of_type_JavaLangString == null)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setPlayRange((int)boux.a(paramboux), (int)boux.b(paramboux));
      if (this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoSpeedFilter != null) {
        this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoSpeedFilter.d(3, anvx.a(2131705156));
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = paramboux.c;
      return;
      if (!this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a().equalsIgnoreCase(paramboux.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c();
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setFilePath(paramboux.jdField_a_of_type_JavaLangString, paramboux.jdField_b_of_type_JavaLangString);
  ...
  private void c(int paramInt)
  {
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer$ConvertIFramesRunnable == null)
    {
      ...
      {
        localObject = (boux)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        if ((!((boux)localObject).jdField_a_of_type_Boolean) && (TextUtils.isEmpty(((boux)localObject).jdField_a_of_type_JavaLangString)))
        {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer$ConvertIFramesRunnable = a(((boux)localObject).c);
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer$ConvertIFramesRunnable == null)
      {
        ...
        {
          boux localboux = (boux)((Iterator)localObject).next();
          if ((!localboux.jdField_a_of_type_Boolean) && (TextUtils.isEmpty(localboux.jdField_a_of_type_JavaLangString)))
          {
            this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer$ConvertIFramesRunnable = a(localboux.c);
            this.jdField_b_of_type_AndroidOsHandler.postDelayed(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer$ConvertIFramesRunnable, 300L);
          }
        }
      }
  ...
  private void d()
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size()) {
      if ((boux.a((boux)this.jdField_a_of_type_JavaUtilList.get(i)) == 1) && (TextUtils.isEmpty(((boux)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangString))) {
        this.jdField_a_of_type_Botw.d(false);
      }
    }
  ...
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size()) {
      return a((boux)this.jdField_a_of_type_JavaUtilList.get(paramInt), true);
    }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource))
    {
      Object localObject = (EditTakeVideoSource)this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setTrackerCallback(new bouv(this));
      a(boud.class, this);
      this.jdField_a_of_type_Botw.d(false);
  ...
  public void a(int paramInt)
  {
    ...
    {
      localboux = (boux)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int);
      if (localboux.jdField_a_of_type_JavaLangString == null)
      {
  ...
  public void a(int paramInt, @NonNull bpel parambpel)
  {
    ...
    if ((parambpel.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource))
    {
      if (this.jdField_a_of_type_Bppq != null)
      {
        ...
        this.jdField_a_of_type_Bppq = null;
      }
      ...
      localboux = (boux)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.hasFragments = true;
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoNeedRotate = false;
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoRangeStart = ((int)boux.a(localboux));
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoRangeEnd = ((int)boux.b(localboux));
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mIFrameVideoPath = localboux.jdField_a_of_type_JavaLangString;
      ykq.b("Q.qqstory.record.HWEditLocalVideoPlayer", "editVideoPrePublish : %s", localboux);
    }
    for (;;)
    {
      ...
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("landscape_video", Boolean.valueOf(bool));
      return;
      label235:
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      localboux = (boux)this.jdField_a_of_type_JavaUtilList.get(i);
      boux.a(localboux, paramBitmap);
      if ((!boux.a(localboux)) && (!paramBoolean)) {
        break label73;
      }
    }
    label73:
  ...
  public void a(boolean paramBoolean)
  {
    int i = this.jdField_a_of_type_Botw.a();
    if (i < this.jdField_a_of_type_JavaUtilList.size()) {
      boux.b((boux)this.jdField_a_of_type_JavaUtilList.get(i), paramBoolean);
    }
  ...
  public void b(int paramInt)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      boux localboux = (boux)this.jdField_a_of_type_JavaUtilList.get(i);
      if (boux.a(localboux) != paramInt)
      {
        boux.a(localboux, paramInt);
        boux.c(localboux, true);
      }
    }
  }
  ...
  public void g()
  {
    ...
    super.g();
    if ((bomw.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView != null) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.j > 100) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c > 0L))
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      paramMessage = (boux)this.jdField_a_of_type_JavaUtilList.get(i);
