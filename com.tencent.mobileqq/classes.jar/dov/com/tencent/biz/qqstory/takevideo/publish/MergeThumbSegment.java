  ...
  protected void a(JobContext paramJobContext, GenerateContext paramGenerateContext)
  {
    ...
    if ((str3 != null) || (str2 != null) || (str4 != null))
    {
      try
      {
        ...
        super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131706567)));
        return;
      }
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError localIOException)
      {
        ...
        catch (IOException localIOException)
        {
          try
          {
            ...
            localObject1 = BitmapUtils.b((Bitmap)localObject3, paramJobContext);
            ...
            try
            {
              ...
              localObject1 = BitmapUtils.b(paramJobContext, (Bitmap)localObject3);
              if (localObject1 == null) {
                break label733;
              }
              paramJobContext.recycle();
      ...
      break;
      label715:
      super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131706570)));
      return;
      label733:
      continue;
      label736:
