  ...
  extends RelativeLayout
{
  ...
  public ArtFilterItemView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    inflate(paramContext, 2131559392, this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131362816));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131362818));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131362819));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131362817));
  }
  ...
  public void a(EditVideoArtFilter paramEditVideoArtFilter)
  {
    ...
    localTranslateAnimation.setAnimationListener(new bjzk(this, paramEditVideoArtFilter));
  ...
  {
    setVisibility(0);
    TranslateAnimation localTranslateAnimation = new TranslateAnimation(0.0F, 0.0F, actn.a(190.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0.0F);
