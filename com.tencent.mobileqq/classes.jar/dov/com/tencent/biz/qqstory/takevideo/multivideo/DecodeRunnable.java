  ...
  implements Runnable
{
  ...
  protected long a;
  protected String a;
  protected WeakReference<bita> a;
  protected boolean a;
  protected int b;
  protected long b;
  protected int c;
  ...
  public DecodeRunnable(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong1, long paramLong2, bita parambita)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambita);
  ...
  protected void a(int paramInt)
  {
    ...
    {
      bita localbita = (bita)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbita != null) {
        localbita.a(paramInt);
      }
    }
  }
  ...
  protected void a(int paramInt, long paramLong, Bitmap paramBitmap)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      bita localbita = (bita)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbita != null) {
        localbita.a(paramInt, paramLong, paramBitmap);
      }
    }
  }
  ...
  protected void a(List<Long> paramList)
  {
    ...
    do
    {
      ...
      localbita = (bita)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbita == null);
    localbita.a(paramList);
  }
