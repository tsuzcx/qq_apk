...
{
  public static int a;
  public static final LongSparseArray<EditVideoButton.EntryButtonInfo> a;
  ...
  private int a()
  {
    ...
    int k = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int;
    int i;
    if (k != 2)
    {
      i = j;
    ...
    {
      i = j;
      if (EditPicMeiHua.a(this.jdField_b_of_type_Int))
      {
        i = j;
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject3 != null) && (((List)localObject3).size() > 0))
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            paramFaceLayer.append((String)localObject2).append('_').append(str).append(',');
          }
        }
      }
      localObject1 = paramFaceLayer.toString();
    }
    return localObject1;
  }
  ...
  private void a(View paramView)
  {
    ...
    case 2131365361: 
      do
      {
        ...
        } while ((l - this.jdField_b_of_type_Long < 800L) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi.getActivity().isFinishing()));
        ...
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager instanceof QzEditVideoPartManager)) {
          ((QzEditVideoPartManager)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager).r = true;
        }
      ...
      } while ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_b_of_type_Int != 2) || (SlideShowPhotoListManager.a().a() != 13) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi == null) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi.getActivity() == null));
      StoryReportor.a("video_edit_new", "back_smartalbum", this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi.getActivity().getIntent(), new String[0]);
      return;
    case 2131379680: 
      ...
      if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int != 2) && (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int != 5) && (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int != 6)) {
        break;
      }
    }
    for (int i = 1;; i = 0)
  ...
  {
    if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a() == 102) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a() == 11) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a() == 12)) {
    ...
    for (paramInt = 0;; paramInt = j)
    {
      ...
      if ((k & l) == l)
      {
        ...
        if ((jdField_a_of_type_Int & l) == l)
        {
          ...
          EditVideoButton.EntryButtonInfo localEntryButtonInfo = (EditVideoButton.EntryButtonInfo)jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.get(l);
          if (localEntryButtonInfo != null)
          {
            ...
            this.jdField_b_of_type_AndroidSupportV4UtilLongSparseArray.put(localEntryButtonInfo.jdField_a_of_type_Long, localObject);
          }
          j = paramInt + 1;
        }
      }
  ...
  private void b(View paramView)
  {
    ...
    if ((paramView instanceof TextView))
    {
      ...
      localTextView.setText(HardCodeUtil.a(2131703777));
      localTextView.setContentDescription(HardCodeUtil.a(2131703813));
    }
    label53:
    do
    {
      ...
      {
        paramView = HardCodeUtil.a(2131703954);
        int i = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c();
        if ((i == 122) || (i == 125) || (i == 133) || (EditVideoParams.a(i)) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.h())) {
          paramView = a(2131689976);
        }
        i = j;
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi.getActivity() != null)
        {
          ...
          {
            i = j;
            if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi.getActivity().getIntent().getBooleanExtra("input_full_screen_mode", false)) {
              i = 1;
            }
          }
        }
        if (i != 0) {
          paramView = a(2131694615);
        }
        localTextView.setText(paramView);
        localTextView.setContentDescription(paramView);
        return;
      }
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 8)
      {
        localTextView.setText(HardCodeUtil.a(2131703737));
        localTextView.setContentDescription(HardCodeUtil.a(2131703773));
        return;
      }
      ...
      {
        paramView = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_publish_text");
        ...
        localTextView.setText(HardCodeUtil.a(2131703875));
        localTextView.setContentDescription(HardCodeUtil.a(2131703784));
        return;
      }
    } while ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int != 5) && (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int != 6));
    localTextView.setText(HardCodeUtil.a(2131703940));
    localTextView.setContentDescription(HardCodeUtil.a(2131703955));
    paramView = localTextView.getLayoutParams();
    paramView.width = AIOUtils.a(70.0F, localTextView.getContext().getResources());
  ...
  {
    c();
    if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a() != null) && ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a().getActivity() instanceof EditPicActivity))) {
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(32L, new EditVideoButton.EntryButtonInfo(32L, 2130844665, HardCodeUtil.a(2131703860)));
    }
    int i = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int;
    if ((i == 2) || (i == 6))
    {
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a())
      {
        jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1L, new EditVideoButton.EntryButtonInfo(1024L, 2130844671, HardCodeUtil.a(2131703949)));
        jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1024L, new EditVideoButton.EntryButtonInfo(1L, 2130844675, HardCodeUtil.a(2131703890)));
      }
    }
    else
    {
      ...
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1L, new EditVideoButton.EntryButtonInfo(2L, 2130844673, HardCodeUtil.a(2131703781)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(2L, new EditVideoButton.EntryButtonInfo(32768L, 2130844664, HardCodeUtil.a(2131703935)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(8L, new EditVideoButton.EntryButtonInfo(16L, 2130844678, HardCodeUtil.a(2131703932)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(16L, new EditVideoButton.EntryButtonInfo(8L, 2130844676, HardCodeUtil.a(2131703751)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(32768L, new EditVideoButton.EntryButtonInfo(1L, 2130844675, HardCodeUtil.a(2131703764)));
    }
    label436:
    while ((i != 3) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a()))
    {
      return;
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1L, new EditVideoButton.EntryButtonInfo(1024L, 2130844671, HardCodeUtil.a(2131703792)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(2L, new EditVideoButton.EntryButtonInfo(8L, 2130844676, HardCodeUtil.a(2131703833)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(8L, new EditVideoButton.EntryButtonInfo(64L, 2130844668, HardCodeUtil.a(2131703944)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(64L, new EditVideoButton.EntryButtonInfo(1L, 2130844675, HardCodeUtil.a(2131703771)));
      jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1024L, new EditVideoButton.EntryButtonInfo(2L, 2130844673, HardCodeUtil.a(2131703768)));
      break;
    }
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1L, new EditVideoButton.EntryButtonInfo(1024L, 2130844671, HardCodeUtil.a(2131703889)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1024L, new EditVideoButton.EntryButtonInfo(1L, 2130844675, HardCodeUtil.a(2131703827)));
  }
  
  private void i()
  {
    Object localObject = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager;
    if (EditVideoPartManager.a(this.jdField_b_of_type_Int, 512))
    {
    ...
    if (EditPicMeiHua.a(this.jdField_b_of_type_Int))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).height = AIOUtils.a(39.0F, a().getResources());
      ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, AIOUtils.a(25.0F, a().getResources()), AIOUtils.a(15.0F, a().getResources()));
      int i = 0;
      while (i < this.jdField_b_of_type_AndroidSupportV4UtilLongSparseArray.size())
      {
        ...
        if (localObject != null) {
          ((LinearLayout.LayoutParams)((ImageView)localObject).getLayoutParams()).setMargins(AIOUtils.a(25.0F, a().getResources()), 0, AIOUtils.a(5.0F, a().getResources()), 0);
        }
        i += 1;
      }
    }
  ...
  private void k()
  {
    ...
    if (localTransitionCategoryItem != null) {
      StoryReportor.a("video_edit_transition", "pub_effects", EditVideoTransfer.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_transiton_src_from", -1)), 0, new String[] { localTransitionCategoryItem.k, localTransitionCategoryItem.n, localTransitionCategoryItem.l, localTransitionCategoryItem.m });
    }
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c() == 122) {
  ...
  private void m()
  {
    ...
    try
    {
      ...
      m = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.f();
      n = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c();
      if (m == 9) {
        break label612;
      }
      if (m != 2) {
    ...
    localObject1 = a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoDoodle.a().a());
    localObject3 = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoDoodle.a().a();
    localObject1 = (String)localObject1 + a((FaceLayer)localObject3);
    ...
    if (localObject1 != null)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoDoodle.a().a().a();
        if (localObject1 == null) {
          break label568;
        }
  ...
  private void n()
  {
    QzoneModuleManager.getInstance().downloadModule("cyber_clink_version_2.jar", new EditVideoButton.2(this));
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)a(2131365361));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131365359));
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = a(2131366140);
    ...
    this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)a(2131364267));
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)a(2131364263));
    ...
    {
      if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager instanceof QzEditVideoPartManager)) {
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130848251);
      }
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)a(2131379662));
      ...
      int i = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi.getActivity().getIntent().getIntExtra("pic_entrance_type", -1);
      if ((!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a()) || (i == 1) || (i == 2) || (i == 3) || (i == 11) || (i == 13)) {
        break label610;
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703957));
      this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(HardCodeUtil.a(2131703824));
    }
    for (;;)
    {
      ...
      break label297;
      label610:
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_b_of_type_Int == 0)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703775));
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(HardCodeUtil.a(2131703798));
      }
      else
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(HardCodeUtil.a(2131703907));
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(HardCodeUtil.a(2131703851));
    ...
    case 16: 
      do
      {
        ...
        for (;;)
        {
          ...
          {
            this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(Message.obtain(null, 12, 3, (int)this.jdField_d_of_type_Long));
            this.jdField_d_of_type_Boolean = false;
          }
          if ((!this.e) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a())) {
            break;
          }
  ...
  protected void a(@Nullable ImageView paramImageView)
  {
    ...
    if (paramImageView != null) {
      paramImageView.setColorFilter(a().getColor(2131166314), PorterDuff.Mode.SRC_IN);
    }
  }
  
  public void a(TextView paramTextView)
  {
    paramTextView.setTextColor(a().getColor(2131167066));
    paramTextView.setTextSize(0, a().getDimension(2131296756));
    paramTextView.setBackgroundResource(2130839424);
    paramTextView.setMinimumHeight(a().getDimensionPixelSize(2131296755));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      SLog.d("Q.qqstory.record.EditVideoButton", "setEnableButtonEnable: %d", new Object[] { Integer.valueOf(i) });
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (paramBoolean2)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(Message.obtain(null, 11, Long.valueOf(this.jdField_d_of_type_Long)));
        if (!paramBoolean1) {
          break;
        }
        i = 0;
  ...
  public void b()
  {
    ...
    if (localImageView != null) {
      localImageView.setImageResource(2130844677);
    }
  }
  ...
  public void c()
  {
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(2L, new EditVideoButton.EntryButtonInfo(2L, 2130844673, HardCodeUtil.a(2131703862)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1024L, new EditVideoButton.EntryButtonInfo(1024L, 2130844671, HardCodeUtil.a(2131703812)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(1L, new EditVideoButton.EntryButtonInfo(1L, 2130844675, HardCodeUtil.a(2131703901)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(8L, new EditVideoButton.EntryButtonInfo(8L, 2130844676, HardCodeUtil.a(2131703863)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(4L, new EditVideoButton.EntryButtonInfo(4L, 2130844666, HardCodeUtil.a(2131703906)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(64L, new EditVideoButton.EntryButtonInfo(64L, 2130844668, HardCodeUtil.a(2131703896)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(32L, new EditVideoButton.EntryButtonInfo(32L, 2130844665, HardCodeUtil.a(2131703945)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(16L, new EditVideoButton.EntryButtonInfo(16L, 2130844678, HardCodeUtil.a(2131703951)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(2048L, new EditVideoButton.EntryButtonInfo(2048L, 2130844674, "跳转到P图"));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(32768L, new EditVideoButton.EntryButtonInfo(32768L, 2130844664, HardCodeUtil.a(2131703816)));
    jdField_a_of_type_AndroidSupportV4UtilLongSparseArray.put(131072L, new EditVideoButton.EntryButtonInfo(131072L, 2130844672, BaseApplicationImpl.getContext().getString(2131691935)));
  }
  
  public void f()
  {
    super.f();
    if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_Int == 0) && (!this.jdField_c_of_type_Boolean))
    {
      if (((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakePhotoSource)) || ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource)) || ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditRecordVideoSource)))
      {
        ...
        i = AIOUtils.a(a().getDimension(2131298154), a());
  ...
  public void onClick(View paramView)
  {
    ...
    if (Math.abs(SystemClock.uptimeMillis() - this.jdField_a_of_type_Long) > 500L)
    {
      ...
      SLog.d("Q.qqstory.record.EditVideoButton", "animation is playing, please wait, animation end time: %d, now: %d.", new Object[] { Long.valueOf(this.jdField_d_of_type_Long), Long.valueOf(System.currentTimeMillis()) });
    }
    label94:
    Object localObject;
    int i;
    ...
    for (;;)
    {
      ...
      SLog.d("Q.qqstory.record.EditVideoButton", "onClick : mask=%d, view=%s", new Object[] { Long.valueOf(l), paramView });
      i = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(Message.obtain(null, 1, new Object[] { Long.valueOf(l), paramView }));
      if (i <= 0) {
        break;
      }
      SLog.c("Q.qqstory.record.EditVideoButton", "%d parts intercept the click event : " + i);
    }
    ...
    for (;;)
    {
      ...
      localObject = null;
      if (i != -1) {
        localObject = new EditVideoButton.1(this, i);
      }
      if ((jdField_a_of_type_Int & l) != l) {
        break;
      }
      PressScaleAnimDelegate.a(paramView, 200L, (View.OnClickListener)localObject);
      break;
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(21))
      {
      ...
      else
      {
        i = 21;
        continue;
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(1)) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
        }
        for (i = -1;; i = 1)
        {
        ...
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(4)) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
        }
        for (i = -1;; i = 4)
        {
          ...
          EditActivityEntranceUtil.a("0X800B3C5", this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c());
          break;
        }
        ...
        for (;;)
        {
          ...
          EditActivityEntranceUtil.a("0X800B3C9", this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c());
          i = -1;
          break label346;
        ...
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.s();
        VideoEditReport.b("0X80075C5", VideoEditReport.jdField_a_of_type_Int);
        b(4);
        StoryReportor.a("video_edit_new", "clk_cut", c(), 0, new String[0]);
        EditActivityEntranceUtil.a("0X800B3C7", this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c());
        i = -1;
        continue;
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(13))
        {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
          label799:
          i = c();
        ...
        {
          StoryReportor.a("video_edit_new", "clk_filter", i, 0, new String[] { "", localObject, "", "" });
          i = -1;
          break;
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(13);
          break label799;
        }
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(14)) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
        }
        for (i = -1;; i = 14)
        {
        ...
        localObject = (EditTransferExport)a(EditTransferExport.class);
        if (localObject == null) {
          break label344;
        }
        if (((EditTransferExport)localObject).a() == 0)
        {
          if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(17)) {
            this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
          }
          for (i = -1;; i = 17)
          {
        ...
        ((EditTransferExport)localObject).b();
        ...
        break;
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_Int == 10)
        {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(0);
          label1090:
          i = j;
          ...
          {
            i = j;
            if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int != 5) {
              if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int != 6) {
                break label1186;
              }
            }
          }
        ...
        for (i = j;; i = 0)
        {
          ...
          i = -1;
          break;
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoPartManager.a(10);
          break label1090;
        }
        if (SlideShowPhotoListManager.a().b() == 22) {
          LpReportInfo_pf00064.allReport(680, 2, 2);
        }
        localObject = new ArrayList(SlideShowPhotoListManager.a().a());
        QZoneHelper.UserInfo localUserInfo = QZoneHelper.UserInfo.getInstance();
        Bundle localBundle = new Bundle();
        localBundle.putParcelableArrayList("qzone_slide_show_matters", (ArrayList)localObject);
        QZoneHelper.forwardToQzDynamicEditVideoActivity(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoUi.getActivity(), localUserInfo, localBundle, 666);
        i = -1;
        continue;
        label1273:
        i += 1;
