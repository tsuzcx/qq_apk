  ...
  extends MeasureJobSegment<GenerateContext, GenerateContext>
{
  ...
  private final WeakReference<EditVideoPlayerExport> jdField_a_of_type_JavaLangRefWeakReference = null;
  ...
  protected void a(JobContext paramJobContext, GenerateContext paramGenerateContext)
  {
    ...
    while (paramJobContext != null)
    {
      ...
      if (localBitmap != null)
      {
        ...
        super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131705269) + this.jdField_a_of_type_Int));
      }
      else
      {
        ...
        super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131705271) + this.jdField_a_of_type_Int));
        return;
      }
    }
    ...
    super.notifyError(new ErrorMessage(-1, HardCodeUtil.a(2131705268) + this.jdField_a_of_type_Int));
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes14.jar
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.publish.GenerateThumbSegment
