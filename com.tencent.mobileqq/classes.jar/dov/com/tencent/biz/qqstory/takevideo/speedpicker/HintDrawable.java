  ...
  implements Animatable
{
  ...
  Property jdField_a_of_type_AndroidUtilProperty = new aomw(this, Float.class, "backScale");
  private String jdField_a_of_type_JavaLangString;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float;
  private int jdField_b_of_type_Int = 0;
  Property jdField_b_of_type_AndroidUtilProperty = new aomx(this, Integer.class, "backAlpha");
    ...
    for (;;)
    {
      ...
      try
      {
        if ("1/4".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839579);
        }
        if ("1/2".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839578);
        }
        if ("1x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839580);
        }
        if ("2x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839581);
        }
        if ("4x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839582);
        }
        if ("倒播".equals(paramString))
        {
          paramString = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839583);
          return paramString;
        }
      }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new aomy(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new aomz(this));
