...
public class GestureHelper
{
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if ((this.jdField_f_of_type_Int == 1) || (this.jdField_f_of_type_Int == 3))
    {
      ...
      this.l = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.r;
  ...
  private boolean a(GestureHelper.ZoomItem paramZoomItem, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, boolean paramBoolean)
  {
    ...
    if ((paramZoomItem.f) && (paramZoomItem.g)) {
      return (paramFloat1 >= paramZoomItem.l + paramZoomItem.jdField_j_of_type_Float - f3 - 10.0F) && (paramFloat1 <= paramZoomItem.l + paramZoomItem.jdField_j_of_type_Float + f3 + 10.0F) && (paramFloat2 >= paramZoomItem.m + paramZoomItem.k - f3 - 10.0F) && (paramFloat2 <= paramZoomItem.m + paramZoomItem.k + f3 + 10.0F);
    }
  ...
  private void b(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.f) && (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.g))
      {
    ...
    } while ((!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.f) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.g));
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.h) {
            break;
          }
          if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.q > this.m) {
            this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.q = this.m;
          }
        ...
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper$ZoomItem.r = this.l;
        return;
  ...
  public void a(GestureHelper.ZoomItem paramZoomItem, boolean paramBoolean)
  {
    ...
    paramZoomItem.l = arrayOfFloat[0];
    paramZoomItem.m = arrayOfFloat[1];
  }
  ...
  public boolean a(GestureHelper.ZoomItem paramZoomItem, float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    if ((paramZoomItem.jdField_c_of_type_Boolean) && (arrayOfFloat[0] >= f3 - f5 - 10.0F) && (arrayOfFloat[0] <= f3 + f5 + 10.0F) && (arrayOfFloat[1] >= f2 - f5 - 10.0F) && (arrayOfFloat[1] <= f2 + f5 + 10.0F))
    {
      paramZoomItem.d = true;
      return true;
    }
  ...
  public float b(GestureHelper.ZoomItem paramZoomItem)
  {
    float f1 = paramZoomItem.u;
    float f2 = paramZoomItem.v;
    float f4 = paramZoomItem.jdField_j_of_type_Int * 2;
    float f3 = paramZoomItem.jdField_j_of_type_Int * 2;
    f1 = (f1 + f4) / 2.0F;
    f2 = (f2 + f3) / 2.0F;
    f3 = -f1;
    f4 = -f2;
    ...
    return Math.min(Math.min(Math.min(arrayOfFloat1[1], arrayOfFloat2[1]), arrayOfFloat3[1]), arrayOfFloat4[1]);
  }
  ...
  public boolean c(GestureHelper.ZoomItem paramZoomItem, float paramFloat1, float paramFloat2)
  {
    ...
    } while ((arrayOfFloat[0] < paramZoomItem.l + paramZoomItem.jdField_j_of_type_Float - paramFloat1 - 10.0F) || (arrayOfFloat[0] > paramZoomItem.l + paramZoomItem.jdField_j_of_type_Float + paramFloat1 + 10.0F) || (arrayOfFloat[1] < paramZoomItem.m + paramZoomItem.k - paramFloat1 - 10.0F) || (arrayOfFloat[1] > paramFloat1 + (paramZoomItem.m + paramZoomItem.k) + 10.0F));
    return true;
