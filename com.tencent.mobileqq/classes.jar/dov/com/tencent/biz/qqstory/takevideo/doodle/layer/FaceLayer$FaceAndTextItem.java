  ...
  extends FaceLayer.FaceItem
{
  ...
  public void a()
  {
    ...
    localValueAnimator.addUpdateListener(new angv(this));
    localValueAnimator.addListener(new angw(this));
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      label491:
      label507:
      for (int k = 2130841977;; k = 2130841976)
      {
        ...
        if (this.jdField_c_of_type_Boolean) {
          DisplayUtil.b(paramCanvas, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleLayerFaceLayer.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper, this, 2130841983, 2130841983, 2130841982);
        }
        return;
        i = 2130841971;
        break;
