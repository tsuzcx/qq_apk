  ...
  extends MeasureJobSegment
{
  ...
  private Bitmap a(Bitmap paramBitmap)
  {
    ...
    return BitmapUtils.a(paramBitmap, 720, i, false, false);
  }
  ...
  protected void a(JobContext paramJobContext, GenerateContext paramGenerateContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = a(BitmapUtils.b((Bitmap)localObject, localBitmap2), this.jdField_a_of_type_AndroidGraphicsBitmap);
        if (localObject == null) {
          continue;
        }
      ...
      else
      {
        ...
        paramGenerateContext.jdField_a_of_type_DovComTencentBizQqstoryTakevideoPublishGeneratePicArgs.jdField_a_of_type_Boolean = bool;
