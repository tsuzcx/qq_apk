...
class VideoFrameLoader$3
  implements Runnable
{
  VideoFrameLoader$3(VideoFrameLoader paramVideoFrameLoader) {}
  ...
  public void run()
  {
    if (VideoFrameLoader.b(this.this$0) != VideoFrameLoader.a(this.this$0).size())
    {
      if (QLog.isColorLevel()) {
        QLog.d("VideoFrameLoader", 2, "onLoadEnd , framecount error!" + VideoFrameLoader.b(this.this$0) + "-" + VideoFrameLoader.a(this.this$0).size());
      }
