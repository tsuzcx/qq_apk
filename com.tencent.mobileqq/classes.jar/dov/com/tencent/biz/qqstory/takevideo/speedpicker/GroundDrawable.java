  ...
  implements Animatable
{
  ...
  private void a(float paramFloat)
  {
    if (this.jdField_h_of_type_Int == 4)
    {
      ...
      {
        GroundDrawable.GroundDrawableListener localGroundDrawableListener = (GroundDrawable.GroundDrawableListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localGroundDrawableListener != null) {
          localGroundDrawableListener.a(this.jdField_h_of_type_Int, this.jdField_b_of_type_AndroidGraphicsRectF);
        }
      }
    }
  }
    ...
    if ((this.jdField_h_of_type_Int == 1) || (this.jdField_h_of_type_Int == 3))
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSpeedpickerPickerFore != null)
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          GroundDrawable.GroundDrawableListener localGroundDrawableListener = (GroundDrawable.GroundDrawableListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localGroundDrawableListener != null) {
            localGroundDrawableListener.a(this.jdField_h_of_type_Int, a());
          }
        }
      }
    }
  ...
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {}
    GroundDrawable.GroundDrawableListener localGroundDrawableListener;
    do
    {
      return;
      localGroundDrawableListener = (GroundDrawable.GroundDrawableListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localGroundDrawableListener == null);
    localGroundDrawableListener.b(paramInt);
  }
  ...
  private void g(int paramInt)
  {
    ...
    localGroundDrawableListener.a(paramInt);
  }
  ...
  private void h(int paramInt)
  {
    ...
    localGroundDrawableListener.c(paramInt);
  }
  ...
  public RectF a(int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSpeedpickerPickerFore != null)
    {
      ...
      if (localRectF != null)
      {
        ...
        {
          localObject = (GroundDrawable.GroundDrawableListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null)
          {
            ((GroundDrawable.GroundDrawableListener)localObject).a(this.jdField_h_of_type_Int, this.jdField_g_of_type_Int, localRectF);
  ...
  public boolean a(Context paramContext, int paramInt, float paramFloat1, float paramFloat2, GroundDrawable.GroundDrawableListener paramGroundDrawableListener)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841725);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130841724);
    return true;
  }
  ...
  protected void onBoundsChange(Rect paramRect)
  {
    ...
    if (this.jdField_g_of_type_Int >= 0)
    {
      ...
      {
        paramRect = (GroundDrawable.GroundDrawableListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (paramRect != null)
        {
