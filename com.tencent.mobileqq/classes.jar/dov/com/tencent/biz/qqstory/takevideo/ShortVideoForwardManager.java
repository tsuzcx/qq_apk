...
public class ShortVideoForwardManager
{
  public static Intent a(String paramString1, String paramString2, SendPanelItemInfo paramSendPanelItemInfo, String paramString3, String paramString4)
  {
    ...
    paramString3 = HexUtil.bytes2HexStr(FileManagerUtil.e(paramString2));
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt, String paramString3)
  {
    ...
    String str2 = HexUtil.bytes2HexStr(FileManagerUtil.e(paramString1));
    if (str2 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "video file md5 compute fail");
      return;
    }
    String str1 = HexUtil.bytes2HexStr(FileManagerUtil.e(paramString2));
    if (str1 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "thumb file md5 compute fail");
      return;
    ...
    if (TextUtils.isEmpty(paramString3))
    {
      ...
      if (!TextUtils.isEmpty(paramString1))
      {
        ...
        AEQLog.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString1);
        if (TextUtils.isEmpty(paramString1)) {
          break label652;
        }
    ...
    if (((paramActivity instanceof PublicFragmentActivityForPeak)) || ((paramActivity instanceof QQBrowserActivity)))
    {
      ...
      for (;;)
      {
        if (paramActivity.getIntent() == null)
        {
          ...
          paramString3 = "";
          label712:
          AEQLog.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString3);
        }
        try
        {
        ...
        catch (UnsupportedEncodingException paramString1)
        {
          for (;;)
          {
            ...
            continue;
            if ((!StringUtil.a(paramString2)) && (!StringUtil.a(paramString1)))
            {
  ...
  public static void a(Activity paramActivity, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramActivity != null) && (paramActivity.getIntent() != null))
      {
        ...
        if (paramString2 != null)
        {
          ...
          AEQLog.b("ShortVideoForwardManager", "gotoForwardPicUI---activity=" + paramActivity + ", takeSameName=" + paramString2);
          if (TextUtils.isEmpty(paramString2)) {
            break label492;
          }
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("forward_summary_extra", HardCodeUtil.a(2131713988));
      break;
      label492:
      localIntent.putExtra("qq_camera_top_title", "魔法视频");
    }
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.ShortVideoForwardManager
