  ...
  extends LinearLayout
{
  ...
  private StrokePicker.OnStrokeDrawableSelectedListener jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker$OnStrokeDrawableSelectedListener;
  private StrokeStrategy jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarStrategyStrokeStrategy;
  ...
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarStrategyStrokeStrategy = paramStrokeStrategy;
    removeAllViews();
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (localStroke != null)
      {
        ...
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker$OnStrokeDrawableSelectedListener != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker$OnStrokeDrawableSelectedListener.a(paramMotionEvent, localDrawable1, localDrawable2, localStroke);
        }
      }
      return true;
      f1 = f2;
  ...
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarStrokePicker$OnStrokeDrawableSelectedListener = paramOnStrokeDrawableSelectedListener;
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes7.jar
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.view.widget.colorbar.StrokePicker
