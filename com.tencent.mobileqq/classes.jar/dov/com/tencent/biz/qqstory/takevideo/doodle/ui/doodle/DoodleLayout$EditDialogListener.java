  ...
  implements EditTextDialog.EditTextDialogEventListener
{
  ...
  public void a(DynamicTextItem paramDynamicTextItem, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("DoodleLayout", 2, "raymondguo count " + localTextLayer.b() + ", items:" + localTextLayer.jdField_a_of_type_JavaUtilArrayList.size());
      }
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      this.a.setTrackerState(this.a.a().jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleLayerTextLayer$TextItem, 0);
      return;
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.doodle.ui.doodle.DoodleLayout.EditDialogListener
