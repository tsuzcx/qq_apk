  ...
  implements TypeEvaluator
{
  ...
  {
    int i = this.c.size();
    paramString = new aokg(paramLong1, paramLong2, i);
  ...
  public ArrayList a(float paramFloat, ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
    ...
    if (i < j)
    {
      ...
      long l1 = ((aokg)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_Long;
      long l2 = ((aokg)this.jdField_a_of_type_JavaUtilArrayList.get(i)).b;
