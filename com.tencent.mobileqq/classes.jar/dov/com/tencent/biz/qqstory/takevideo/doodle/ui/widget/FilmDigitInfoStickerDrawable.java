  ...
  extends InfoStickerDrawable
{
  ...
  protected void a(Canvas paramCanvas, ArrayList<Integer> paramArrayList)
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setShadowLayer(f2 * 20.0F, 0.0F, 0.0F, this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165663));
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165662));
    ...
    this.e = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("anim", 0L, 1000L, 0, 999, new LinearInterpolator());
  }
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.doodle.ui.widget.FilmDigitInfoStickerDrawable
