  ...
  implements Handler.Callback
{
  ...
  private void a()
  {
    ...
    this.d = bcwh.a(getContext(), ScrollFrameSelectBar.jdField_a_of_type_Int);
  }
  ...
  {
    wsv.a("Q.qqstory.frameWidget.ProgressPointer", "++++++++setRange++++++start=%s,end=%s,duration=%s,mProgress=%s", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Float.valueOf(this.jdField_a_of_type_Float));
