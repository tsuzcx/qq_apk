  ...
  extends LinearLayout
{
  ...
  public void a(NormalFacePackage paramNormalFacePackage, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localImageView.setTag(2131378926, localObject);
      ...
      localImageView.setTag(2131378926, localObject);
      ImageLoader.a().a(localImageView, (String)localObject, this.d, this.d, paramBoolean);
    }
    for (;;)
    {
      paramInt2 += 1;
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.doodle.ui.face.adapter.NormalFaceAdapter.NormalItemLayout
