  ...
  implements Handler.Callback, View.OnClickListener, XPanelContainer.PanelCallback, EditTextPanel.EditTextPanelListener
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aogs(this);
  public View a;
  public ViewGroup a;
  public EditText a;
  public ImageView a;
  ...
  private Runnable jdField_a_of_type_JavaLangRunnable = new aogr(this);
  public String a;
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2130968955, null));
    this.jdField_a_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new aogv(this, null));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout = ((FitSystemWindowsRelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364404));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setFitsSystemWindows(true);
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer = ((XPanelContainer)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362845));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364406));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364405);
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView = ((EditTextPreView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364408));
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setOnClickListener(new aogk(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new aogm(this));
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new aogn(this));
      this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new aogp(this));
      return;
  ...
  public View a(int paramInt)
  {
    ...
    if (paramInt == 34)
    {
      ...
      localLinearLayout = (LinearLayout)View.inflate(this.jdField_a_of_type_AndroidContentContext, 2130970730, null);
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiPanelEditTextPanel = ((EditTextPanel)localLinearLayout.findViewById(2131362975));
      localLinearLayout.findViewById(2131371712).setVisibility(8);
  ...
  public void a(DynamicTextConfigManager.DynamicTextConfigBean paramDynamicTextConfigBean, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_AndroidWidgetEditText != null) && (paramDynamicTextConfigBean != null))
    {
      ...
      this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a(-1, this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView, true, 3000, 500, new aogl(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_MqqOsMqqHandler.post(new aogu(this));
      break;
      label294:
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 34)
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840518);
    ...
    for (;;)
    {
      this.jdField_a_of_type_MqqOsMqqHandler.post(new aogt(this, paramInt1, paramInt2));
      return;
      if (paramInt2 == 1)
      {
