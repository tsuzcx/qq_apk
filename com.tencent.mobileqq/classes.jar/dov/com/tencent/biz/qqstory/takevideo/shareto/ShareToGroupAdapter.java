  ...
  extends BaseAdapter
{
  ...
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSharetoShareToGroupAdapter$OnSelectStateChangeListener = paramOnSelectStateChangeListener;
  }
  
  protected void a(ShareToGroupAdapter.TroopInfoSelector paramTroopInfoSelector)
  {
    if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSharetoShareToGroupAdapter$OnSelectStateChangeListener == null) || (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSharetoShareToGroupAdapter$OnSelectStateChangeListener.a(a(), paramTroopInfoSelector))) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSharetoShareToGroupAdapter$OnSelectStateChangeListener != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoSharetoShareToGroupAdapter$OnSelectStateChangeListener.a(a());
      }
      return;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      localObject = (ImageView)paramView.a(2131368582);
    ...
    for (;;)
    {
      ((TextView)paramView.a(2131368583)).setText(localTroopInfo.troopname);
      ((CheckBox)paramView.a(2131368580)).setChecked(localTroopInfoSelector.jdField_a_of_type_Boolean);
      if (getCount() > 1) {
        break label164;
      }
      paramViewGroup.setBackgroundResource(2130838629);
      return paramViewGroup;
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969965, null);
    ...
    if (paramInt == 0)
    {
      paramViewGroup.setBackgroundResource(2130838641);
      return paramViewGroup;
    }
    if (paramInt == getCount() - 1)
    {
      paramViewGroup.setBackgroundResource(2130838636);
      return paramViewGroup;
    }
    paramViewGroup.setBackgroundResource(2130838639);
    return paramViewGroup;
  }
}
