...
{
  public static final Parcelable.Creator<EditLocalVideoSource> CREATOR = new bjsr();
  public int a;
  @NonNull
  ...
  public EditLocalVideoSource(Parcel paramParcel)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo = ((LocalMediaInfo)paramParcel.readParcelable(azmi.class.getClassLoader()));
