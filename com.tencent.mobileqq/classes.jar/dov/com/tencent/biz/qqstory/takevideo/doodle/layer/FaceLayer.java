  ...
  extends BaseLayer
{
  ...
  private void a(FaceLayer.FaceItem paramFaceItem, Map<String, List<String>> paramMap)
  {
    ...
    ((List)localObject).add(paramFaceItem.jdField_e_of_type_JavaLangString);
  }
  ...
  private boolean a(float paramFloat1, float paramFloat2)
  {
    ...
    while (i >= 0)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper.a(localFaceItem, paramFloat1, paramFloat2, false))
      {
  ...
  private void b(MotionEvent paramMotionEvent)
  {
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleLayerFaceLayer$FaceItem != null) {
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleLayerFaceLayer$FaceItem.jdField_e_of_type_Boolean = false;
    }
  ...
  private void b(FaceLayer.FaceItem paramFaceItem, Map<String, List<String>> paramMap)
  {
    ...
    if (localList != null)
    {
      localList.remove(paramFaceItem.jdField_e_of_type_JavaLangString);
  ...
  {
    boolean bool1 = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper.a(paramFaceItem, StoryGuideLineView.jdField_a_of_type_Int, true);
    boolean bool2 = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper.a(paramFaceItem, StoryGuideLineView.b, false);
    boolean bool3 = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper.b(paramFaceItem, StoryGuideLineView.d, false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleLayerFaceLayer$LayerEventListener != null) {
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleLayerFaceLayer$LayerEventListener.a(bool1, bool2, false, bool3, paramFaceItem.jdField_l_of_type_Boolean);
    }
    if (paramFaceItem != null)
    {
      if (paramFaceItem.k) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(paramFaceItem.jdField_l_of_type_Boolean, paramFaceItem.r, paramFaceItem.s, paramFaceItem.t, paramFaceItem.jdField_a_of_type_AndroidGraphicsPointF, paramFaceItem.jdField_m_of_type_Boolean, 2);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(paramFaceItem.jdField_l_of_type_Boolean, paramFaceItem.r, paramFaceItem.s, paramFaceItem.t, paramFaceItem.jdField_a_of_type_AndroidGraphicsPointF, paramFaceItem.jdField_m_of_type_Boolean, 1);
  }
  
  private void e()
  {
    this.jdField_a_of_type_AndroidGraphicsPaint = new Paint();
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847100);
  ...
  public GestureHelper.ZoomItem a(GestureHelper.ZoomItem paramZoomItem, String paramString1, String paramString2, Drawable paramDrawable, FaceLayer.LayerParams paramLayerParams, String paramString3, int paramInt1, boolean paramBoolean, String paramString4, String paramString5, int paramInt2)
  {
    ...
    if ((paramZoomItem instanceof FaceLayer.FaceItem))
    {
      ...
      if (localFaceItem.b)
      {
        ...
        b(localFaceItem, this.jdField_b_of_type_JavaUtilMap);
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      return paramString1;
      b(localFaceItem, this.jdField_a_of_type_JavaUtilMap);
      break;
      label321:
  ...
  public void a(Canvas paramCanvas, float paramFloat, boolean paramBoolean)
  {
    ...
    {
      FaceLayer.FaceItem localFaceItem = (FaceLayer.FaceItem)localIterator.next();
      if ((localFaceItem.h == 0) && ((paramBoolean) || ((!localFaceItem.b()) && (!localFaceItem.c()))))
      {
        paramCanvas.save();
  ...
  public void a(FaceLayer.FaceItem paramFaceItem, TroopBarPOI paramTroopBarPOI)
  {
    if (paramFaceItem != null)
    {
      ...
      paramFaceItem.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setCallback(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a.a);
      k();
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
    {
      ...
      {
        FaceLayer.FaceItem localFaceItem = (FaceLayer.FaceItem)localIterator.next();
        if ((a(localFaceItem.d, paramString1)) && (a(localFaceItem.jdField_e_of_type_JavaLangString, paramString2))) {
          a(localFaceItem);
        }
      }
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      c(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleLayerFaceLayer$FaceItem);
      return true;
  ...
  public boolean a(String paramString1, String paramString2, Drawable paramDrawable, FaceLayer.LayerParams paramLayerParams, String paramString3, boolean paramBoolean, int paramInt1, int paramInt2, SegmentKeeper paramSegmentKeeper)
  {
    ...
    {
      f1 = localLayerParams.jdField_a_of_type_Float;
      localLayerParams.jdField_a_of_type_Float = (this.jdField_a_of_type_AndroidGraphicsRect.height() / j * f1);
    ...
    SLog.b(jdField_a_of_type_JavaLangString, "addFace after drawRect:" + this.jdField_a_of_type_AndroidGraphicsRect);
  ...
  {
    if ((paramFaceItem.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) || (!(paramFaceItem.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof BitmapDrawable))) {}
    long l1;
    label95:
    long l2;
    do
    {
      ...
      int j = (int)paramFaceItem.u;
      paramFaceItem.jdField_a_of_type_ArrayOfInt = new int[j * 2];
      float f1 = k / paramFaceItem.u;
      float f2 = paramFaceItem.v / m;
      i = 0;
      while (i < j)
      {
        k = (int)(i * f1);
        paramFaceItem.jdField_a_of_type_ArrayOfInt[(i * 2)] = ((int)(localObject[(k * 2)] * f2));
        paramFaceItem.jdField_a_of_type_ArrayOfInt[(i * 2 + 1)] = ((int)(localObject[(k * 2 + 1)] * f2));
        if (localObject[(k * 2 + 1)] > 0)
        {
          if (paramFaceItem.jdField_l_of_type_Int == -1) {
            paramFaceItem.jdField_l_of_type_Int = i;
          }
          paramFaceItem.jdField_m_of_type_Int = Math.max(i, paramFaceItem.jdField_m_of_type_Int);
        }
        i += 1;
      }
  ...
  public boolean b(MotionEvent paramMotionEvent)
  {
    ...
    {
      FaceLayer.FaceItem localFaceItem = (FaceLayer.FaceItem)this.jdField_a_of_type_JavaUtilList.get(i);
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUtilGestureHelper.a(localFaceItem, f1, f2, false))
      {
