  ...
  implements IManager
{
  ...
  DoodleEmojiManager.POIPostersRequestCallback jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiManager$POIPostersRequestCallback = null;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = QQStoryConstant.j + "emoji";
  ...
  public DoodleEmojiManager()
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem = null;
  ...
  public void a(List<DoodleEmojiItem> arg1)
  {
    ...
    DoodleEmojiManager localDoodleEmojiManager = (DoodleEmojiManager)SuperManager.a(39);
    ...
    if (localIterator.hasNext())
    {
      ...
      SLog.a("DoodleEmojiManager", "EmojiPack md5 has changed. old : %s, new : %s", ((DoodleEmojiItem)localObject2).md5, localDoodleEmojiItem.md5);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        {
          FileUtils.d(???);
          localObject2 = new DoodleEmojiManager.DoodleEmojiDownloadEvent(localDoodleEmojiItem, 0, false, 0L, 0L);
          ((DoodleEmojiManager.DoodleEmojiDownloadEvent)localObject2).b = true;
          StoryDispatcher.a().dispatch((Dispatcher.Dispatchable)localObject2);
          ??? = null;
          localDoodleEmojiItem.setLocalEmojiFolderPath(???);
          b(localDoodleEmojiManager, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.icon);
          c(localDoodleEmojiManager, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.name);
          d(localDoodleEmojiManager, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.config);
          a(localDoodleEmojiManager, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.md5);
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if ((a((File)???)) && (!paramBoolean))
    {
      ...
      StoryDispatcher.a().dispatch(new DoodleEmojiManager.DoodleEmojiDownloadEvent(localDoodleEmojiItem, 0, true, 0L, 0L));
      return true;
    }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.compareAndSet(0, 1))
    {
      ...
      {
        localObject1 = ((File)localObject1).listFiles(new DoodleEmojiManager.1(this));
        if (localObject1 != null)
        {
          ...
          if (i < j)
          {
            ...
            Object localObject2 = localFile.listFiles(new DoodleEmojiManager.2(this));
            if ((localObject2 != null) && (localObject2.length > 0))
            {
              localObject2 = a(localFile);
              Object localObject3 = b(localDoodleEmojiManager, (String)localObject2);
              localObject3 = new DoodleEmojiItem((String)localObject2, a(localDoodleEmojiManager, (String)localObject2), (String)localObject3, null, c(localDoodleEmojiManager, (String)localObject2), d(localDoodleEmojiManager, (String)localObject2));
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem == null)
      {
        ...
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem != null)
        {
          ...
          Bosses.get().postJob(new DoodleEmojiManager.3(this, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem));
        }
        return;
      }
