  ...
  implements View.OnClickListener, View.OnTouchListener, AdapterView.OnItemClickListener, Runnable
{
  ...
  private bjue jdField_a_of_type_Bjue;
  private bjug jdField_a_of_type_Bjug;
  ...
  public EditVideoArtFilter(@NonNull bjww parambjww)
  {
    super(parambjww);
  ...
  {
    this.jdField_a_of_type_Bjue.jdField_c_of_type_Int = paramInt;
    this.jdField_a_of_type_Bjue.notifyDataSetChanged();
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_Bjww.jdField_a_of_type_Bjye.getActivity();
    this.jdField_a_of_type_Bjue = new bjue(this, this.jdField_a_of_type_AndroidContentContext);
    this.jdField_e_of_type_JavaLangString = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();
    this.jdField_a_of_type_Bjug = new bjug(this);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView = ((ArtFilterItemView)a(2131362820));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362813));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362814));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362821));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnItemClickListener(this);
    if ((this.jdField_a_of_type_ComTencentWidgetHorizontalListView != null) && (this.jdField_a_of_type_Bjue != null)) {
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.postDelayed(this, 10L);
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362815));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnTouchListener(this);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.setHandler(this.jdField_a_of_type_Bjug, this.jdField_c_of_type_JavaLangString);
  }
  ...
  public void a(int paramInt, @NonNull bkkm parambkkm)
  {
    if (b())
    {
      ...
      localbkks.jdField_a_of_type_Int += 1;
      axqw.b(null, "dc00898", "", "", "0X8007551", "0X8007551", 0, 0, "", "", "", "");
      axqw.b(null, "dc00898", "", "", "0X8007552", "0X8007552", this.jdField_d_of_type_Int, 0, "", "", "", "");
      parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("5");
      parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves7 = (this.jdField_d_of_type_Int + "");
      vem.b("0X80075EF", vem.jdField_a_of_type_Int);
    }
  }
  
  public void a(int paramInt, boolean paramBoolean)
  {
    vkb localvkb = this.jdField_a_of_type_Bjue.a(paramInt);
    if (localvkb == null) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.qqstory.publish.edit.EditVideoArtFilter", 2, "submitFilterTask:position:" + paramInt + "FilterTemplate" + localvkb);
    }
    a(paramInt);
    if ((this.jdField_d_of_type_JavaLangString.endsWith(".gif")) && (!paramBoolean))
    {
      bcpw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690245), 0).a();
      return;
    }
    if (paramInt == 0)
    {
    ...
    this.jdField_f_of_type_Int = localvkb.jdField_a_of_type_Int;
    Object localObject = jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Long + "_" + localvkb.jdField_a_of_type_Int + ".png";
    if (new File((String)localObject).exists())
    {
      a((String)localObject, localvkb.jdField_a_of_type_Int);
      return;
    }
    ...
    localObject = this.jdField_a_of_type_Bjug.obtainMessage(35);
    ((Message)localObject).obj = Integer.valueOf(paramInt);
    this.jdField_a_of_type_Bjug.sendMessageDelayed((Message)localObject, 20000L);
    b(true);
    localObject = new Bundle();
    ((Bundle)localObject).putInt("param_art_filter_style_id", localvkb.jdField_a_of_type_Int);
    ((Bundle)localObject).putString("param_art_filter_style_name", localvkb.jdField_b_of_type_JavaLangString);
    ...
    QIPCClientHelper.getInstance().callServer("ArtFilterModule", "action_get_art_filter_path", (Bundle)localObject, new bjud(this, localvkb));
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_d_of_type_Boolean)
        {
          localObject2 = localBitmap;
          localObject1 = localBitmap;
          if (this.jdField_a_of_type_Bjww.jdField_b_of_type_Int != 0)
          {
            localObject2 = localBitmap;
            localObject1 = localBitmap;
            if (this.jdField_a_of_type_Bjww.jdField_b_of_type_Int % 90 == 0)
            {
              localObject1 = localBitmap;
              if (QLog.isColorLevel())
              {
                localObject1 = localBitmap;
                QLog.d("Q.qqstory.publish.edit.EditVideoArtFilter", 2, "load bitmap has exif rotate " + this.jdField_a_of_type_Bjww.jdField_b_of_type_Int);
              }
              localObject1 = localBitmap;
              ...
              localObject1 = localBitmap;
              ((Matrix)localObject2).postRotate(this.jdField_a_of_type_Bjww.jdField_b_of_type_Int, i / 2.0F, j / 2.0F);
              localObject1 = localBitmap;
      ...
      {
        this.jdField_a_of_type_Bjww.a((Bitmap)localObject2, true);
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
      if (!this.jdField_e_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Bjww.a((Bitmap)localObject1, true);
      }
    }
    for (;;)
    {
      ...
      label477:
      break;
      this.jdField_a_of_type_AndroidGraphicsBitmap = this.jdField_a_of_type_Bjww.a().copy(a(this.jdField_a_of_type_Bjww.a()), true);
    }
  }
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Bjww.jdField_a_of_type_Int == 12)
    {
  ...
  boolean a(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_Int != 0) {
      axqw.b(null, "dc00898", "", "", "0X8007550", "0X8007550", 0, 0, "", "", "", "");
    }
    return true;
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Bjue.jdField_c_of_type_Int;
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.b();
    axqw.b(null, "dc00898", "", "", "0X800754F", "0X800754F", 0, 0, "", "", "", "");
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bjug.removeCallbacksAndMessages(null);
    if (QLog.isColorLevel()) {
  ...
  public void g()
  {
    ...
    this.jdField_a_of_type_Bjug.removeCallbacksAndMessages(null);
    this.jdField_a_of_type_Bjug = null;
  ...
  {
    if ((paramMotionEvent.getAction() == 0) && (paramView.getId() == 2131362815))
    {
      if (this.jdField_a_of_type_Boolean) {
        return true;
      }
  ...
  public void run()
  {
    ...
    //   92: invokespecial 710	vkb:<init>	(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    //   134: checkcast 347	vkb
    //   137: getfield 727	vkb:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   225: aload_0
    //   226: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjue	Lbjue;
    //   229: aload_2
    //   230: invokevirtual 743	bjue:a	(Ljava/util/List;)V
    //   233: aload_0
    ...
    //   237: aload_0
    //   238: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjue	Lbjue;
    ...
    //   295: aload_0
    //   296: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjue	Lbjue;
    //   299: aload_2
    //   300: invokevirtual 743	bjue:a	(Ljava/util/List;)V
    //   303: goto -70 -> 233
    //   306: astore_3
    ...
    //   345: aload_0
    //   346: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjue	Lbjue;
    //   349: aload_2
    //   350: invokevirtual 743	bjue:a	(Ljava/util/List;)V
    //   353: aload_3
    //   354: athrow
    // Local variable table:
    //   start	length	slot	name	signature
