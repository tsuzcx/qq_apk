  ...
  implements View.OnClickListener, View.OnTouchListener, AdapterView.OnItemClickListener, Runnable
{
  ...
  private bjuv jdField_a_of_type_Bjuv;
  private bjux jdField_a_of_type_Bjux;
  ...
  public EditVideoArtFilter(@NonNull bjxn parambjxn)
  {
    super(parambjxn);
  ...
  {
    this.jdField_a_of_type_Bjuv.jdField_c_of_type_Int = paramInt;
    this.jdField_a_of_type_Bjuv.notifyDataSetChanged();
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_Bjxn.jdField_a_of_type_Bjyv.getActivity();
    this.jdField_a_of_type_Bjuv = new bjuv(this, this.jdField_a_of_type_AndroidContentContext);
    this.jdField_e_of_type_JavaLangString = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();
    this.jdField_a_of_type_Bjux = new bjux(this);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView = ((ArtFilterItemView)a(2131362819));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362812));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362813));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362820));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnItemClickListener(this);
    if ((this.jdField_a_of_type_ComTencentWidgetHorizontalListView != null) && (this.jdField_a_of_type_Bjuv != null)) {
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.postDelayed(this, 10L);
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.findViewById(2131362814));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnTouchListener(this);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoArtfilterArtFilterItemView.setHandler(this.jdField_a_of_type_Bjux, this.jdField_c_of_type_JavaLangString);
  }
  ...
  public void a(int paramInt, @NonNull bkld parambkld)
  {
    if (b())
    {
      ...
      localbklj.jdField_a_of_type_Int += 1;
      axqy.b(null, "dc00898", "", "", "0X8007551", "0X8007551", 0, 0, "", "", "", "");
      axqy.b(null, "dc00898", "", "", "0X8007552", "0X8007552", this.jdField_d_of_type_Int, 0, "", "", "", "");
      parambkld.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("5");
      parambkld.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves7 = (this.jdField_d_of_type_Int + "");
  ...
  {
    vjy localvjy = this.jdField_a_of_type_Bjuv.a(paramInt);
    if (localvjy == null) {
      return;
    }
    ...
    this.jdField_f_of_type_Int = localvjy.jdField_a_of_type_Int;
    ...
    localObject = this.jdField_a_of_type_Bjux.obtainMessage(35);
    ((Message)localObject).obj = Integer.valueOf(paramInt);
    this.jdField_a_of_type_Bjux.sendMessageDelayed((Message)localObject, 20000L);
    b(true);
    ...
    QIPCClientHelper.getInstance().callServer("ArtFilterModule", "action_get_art_filter_path", (Bundle)localObject, new bjuu(this, localvjy));
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_d_of_type_Boolean)
        {
          localObject2 = localBitmap;
          localObject1 = localBitmap;
          if (this.jdField_a_of_type_Bjxn.jdField_b_of_type_Int != 0)
          {
            localObject2 = localBitmap;
            localObject1 = localBitmap;
            if (this.jdField_a_of_type_Bjxn.jdField_b_of_type_Int % 90 == 0)
            {
              localObject1 = localBitmap;
              if (QLog.isColorLevel())
              {
                localObject1 = localBitmap;
                QLog.d("Q.qqstory.publish.edit.EditVideoArtFilter", 2, "load bitmap has exif rotate " + this.jdField_a_of_type_Bjxn.jdField_b_of_type_Int);
              }
              localObject1 = localBitmap;
              ...
              localObject1 = localBitmap;
              ((Matrix)localObject2).postRotate(this.jdField_a_of_type_Bjxn.jdField_b_of_type_Int, i / 2.0F, j / 2.0F);
              localObject1 = localBitmap;
      ...
      {
        this.jdField_a_of_type_Bjxn.a((Bitmap)localObject2, true);
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
      if (!this.jdField_e_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Bjxn.a((Bitmap)localObject1, true);
      }
    }
    for (;;)
    {
      ...
      label477:
      break;
      this.jdField_a_of_type_AndroidGraphicsBitmap = this.jdField_a_of_type_Bjxn.a().copy(a(this.jdField_a_of_type_Bjxn.a()), true);
    }
  }
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Bjxn.jdField_a_of_type_Int == 12)
    {
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Bjuv.jdField_c_of_type_Int;
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bjux.removeCallbacksAndMessages(null);
    if (QLog.isColorLevel()) {
  ...
  public void run()
  {
    ...
    //   92: invokespecial 710	vjy:<init>	(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    //   134: checkcast 347	vjy
    //   137: getfield 727	vjy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   225: aload_0
    //   226: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjuv	Lbjuv;
    //   229: aload_2
    //   230: invokevirtual 743	bjuv:a	(Ljava/util/List;)V
    //   233: aload_0
    ...
    //   237: aload_0
    //   238: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjuv	Lbjuv;
    ...
    //   295: aload_0
    //   296: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjuv	Lbjuv;
    //   299: aload_2
    //   300: invokevirtual 743	bjuv:a	(Ljava/util/List;)V
    //   303: goto -70 -> 233
    //   306: astore_3
    ...
    //   345: aload_0
    //   346: getfield 113	dov/com/tencent/biz/qqstory/takevideo/EditVideoArtFilter:jdField_a_of_type_Bjuv	Lbjuv;
    //   349: aload_2
    //   350: invokevirtual 743	bjuv:a	(Ljava/util/List;)V
    //   353: aload_3
    //   354: athrow
    // Local variable table:
    //   start	length	slot	name	signature
