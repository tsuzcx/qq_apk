  ...
  implements bihj
{
  ...
  public bigb a;
  bjij jdField_a_of_type_Bjij = new bibx(this);
  
  public EditPicActivity()
  {
    this.jdField_a_of_type_Bigb = new bica();
  ...
  public Intent a(bitz parambitz)
  {
    ...
    if (this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidContentIntent == null)
    {
      ...
      localObject2 = this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();
      label123:
      localArrayList.add(localObject2);
      if ((this.jdField_a_of_type_Bigb == null) || (this.jdField_a_of_type_Bigb.jdField_a_of_type_Bief == null) || (this.jdField_a_of_type_Bigb.jdField_a_of_type_Bief.a() == null) || (this.jdField_a_of_type_Bigb.jdField_a_of_type_Bief.a().a() == null)) {
        break label1092;
      }
    }
    label301:
    ...
    label1087:
    label1092:
    for (Object localObject3 = this.jdField_a_of_type_Bigb.jdField_a_of_type_Bief.a().a().a;; localObject3 = null)
    {
      ...
      if ((localObject3 != null) && (!((List)localObject3).isEmpty()))
      {
        ...
        for (;;)
        {
          ...
          {
            bijr localbijr = (bijr)((Iterator)localObject3).next();
            if ((localbijr.a != null) && (localbijr.a.a() != null))
            {
              localJSONArray.put(localbijr.a.a().toString());
              continue;
              localObject1 = this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidContentIntent;
              break;
              localObject2 = parambitz.jdField_a_of_type_Biuf.jdField_b_of_type_JavaLangString;
              if (getIntent().getIntExtra("camera_type", -1) != -1)
              {
                bace.d(parambitz.jdField_a_of_type_Biuf.jdField_a_of_type_JavaLangString);
                new File(parambitz.jdField_a_of_type_Biuf.jdField_a_of_type_JavaLangString);
                bacm.a(this, parambitz.jdField_a_of_type_Biuf.jdField_a_of_type_JavaLangString);
              }
      ...
      if ((parambitz.jdField_a_of_type_Biuf.c) || (!parambitz.jdField_a_of_type_Biuf.jdField_b_of_type_Boolean))
      {
        ...
        ((Intent)localObject1).putExtra("video_sync_to_story", parambitz.d);
        ...
        if (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.j()) {
          ((Intent)localObject1).putExtra("key_multi_edit_source_path", this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
        }
        if (QLog.isColorLevel()) {
        ...
        localObject2 = a((Intent)localObject1, this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a(), (String)localObject2);
        ...
        ((Intent)localObject1).putExtra("open_chatfragment_fromphoto", true);
        ((Intent)localObject1).putExtra("VIDEO_LOCATE_DESCRIPTION", parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription);
        ((Intent)localObject1).putExtra("VIDEO_LOCAL_LONGITUDE", parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude);
        ((Intent)localObject1).putExtra("VIDEO_LOCAL_LATITUDE", parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude);
        if (parambitz.e)
        {
          ...
          parambitz = ((Intent)localObject1).getStringExtra("uin");
          i = ((Intent)localObject1).getIntExtra("uintype", 0);
          localObject3 = new awtt();
          ((awtt)localObject3).d = "0X800699A";
          ((awtt)localObject3).e = String.valueOf(parambitz);
          ((awtt)localObject3).f = "3";
          ((awtt)localObject3).i = "shanzhao";
          localObject2 = DataReporter.a().a(i);
          parambitz = (bitz)localObject2;
          if (localObject2 == null) {
            parambitz = DataReporter.Destination.UNKNOWN;
          }
          ((awtt)localObject3).g = parambitz.toString();
          awqt.b(null, (awtt)localObject3);
        }
        if (this.jdField_a_of_type_Bigb.jdField_a_of_type_Bihb == null) {
          break label1087;
        }
        if (this.jdField_a_of_type_Bigb.jdField_a_of_type_Bihb.a(this.jdField_a_of_type_Bigb.a()) == null) {
          break label1082;
        }
        bool1 = bool2;
      }
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    urk.c("EditPicActivity", "doOnActivityResult");
    Intent localIntent;
    Object localObject;
    if (paramInt1 == 666) {
      if (paramInt2 == -1)
      {
        ...
        {
          paramIntent = this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();
          if (QLog.isColorLevel()) {
          ...
          bbmy.a(this, ajjy.a(2131637882), 0).a();
          finish();
        }
      }
    }
    ...
    do
    {
      do
      {
        do
        {
          ...
          break;
          paramIntent = new EditVideoParams(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int, this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Long, new EditTakePhotoSource((String)localObject, 2, 0, 0), EditVideoParams.a(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a()));
          localIntent.putExtra(EditVideoParams.class.getName(), paramIntent);
          finish();
          startActivity(localIntent);
          return;
          urk.c("EditPicActivity", "recamera cancel, finish");
          finish();
          return;
          if (paramInt1 != 1000) {
            break label443;
  ...
  {
    urk.c("EditPicActivity", "doOnBackPressed");
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    biby.a(QQStoryContext.a().a(), this);
    paramBundle = (EditVideoParams)getIntent().getParcelableExtra(EditVideoParams.class.getName());
    biyr.a("finish jump activity", biyr.a(getIntent()));
    urk.d("EditPicActivity", "doOnCreate instance=%d, video params=%s", new Object[] { Integer.valueOf(System.identityHashCode(this)), paramBundle });
    ...
    {
      bbmy.a(this, ajjy.a(2131637885), 0).a();
      finish();
      return true;
    }
    if (QLog.isColorLevel()) {
    ...
    if (!bace.a(paramBundle.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a()))
    {
      bbmy.a(this, ajjy.a(2131637886), 0).a();
      finish();
      return true;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (VideoEnvironment.a("AVCodec", super.getApplicationContext()) != 0) {
          urk.e("EditPicActivity", "load AVCodec so failed");
        }
        this.jdField_a_of_type_Bigb.e = true;
        setContentViewC(2131493432);
        if (isInMultiWindow())
        {
          bbmy.a(this, ajjy.a(2131637883), 0).a();
          finish();
          return true;
          if (i != 2) {
            continue;
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          urk.c("EditPicActivity", "load so failed", localException);
        }
        a();
        this.jdField_a_of_type_Bigb.a(this, paramBundle);
        if (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter != null)
        {
          this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_b_of_type_JavaLangString = getIntent().getStringExtra("FILTER_STRING");
          this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_a_of_type_Int = getIntent().getIntExtra("FILTER_MAXSIDE", 640);
          this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter.c = getIntent().getStringExtra("FILTER_LOADING_PATH");
        }
        if (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditPicRawImage == null) {
          break label593;
        }
      }
    }
    ...
    int j;
    int k;
    if (this.jdField_a_of_type_Bigb.jdField_a_of_type_Bibz != null)
    {
      l = getIntent().getLongExtra("babyq_ability", 0L) & 0x2;
      localObject = this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditPicRawImage;
      if (l > 0L)
      {
        bool = true;
        ((EditPicRawImage)localObject).a = bool;
        localObject = this.jdField_a_of_type_Bigb.jdField_a_of_type_Bibz;
        if (l <= 0L) {
          break label861;
        }
        bool = true;
        ((bibz)localObject).f = bool;
      }
    }
    else
    {
      localObject = (bhdr)bhfm.a(13);
      ((bhdr)localObject).b(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a());
      this.jdField_a_of_type_Bigb.j();
      PtvTemplateManager.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_Bjij, false);
      if (paramBundle.jdField_a_of_type_AndroidOsBundle != null) {
        urq.a(paramBundle.jdField_a_of_type_AndroidOsBundle.getInt("pic_entrance_type", 0));
      }
      biuf.a(null);
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      j = this.jdField_a_of_type_Bigb.g();
      k = this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c();
    ...
    {
      urp.b("time_openedit", 1, i, new String[] { urp.b(j), "0", "", String.valueOf(k) });
      i = this.jdField_a_of_type_Bigb.i();
      getIntent().putExtra("capture_operation_in", i);
      urp.a("video_edit_new", "edit_exp", i, 0, new String[] { urp.b(j), "", "", String.valueOf(k) });
      ((bhdr)localObject).d(1);
      ((bhdr)localObject).a(4);
      return true;
      bool = false;
      break;
      bool = false;
  ...
  {
    super.doOnDestroy();
    urk.b("EditPicActivity", "doOnDestroy %d", Integer.valueOf(System.identityHashCode(this)));
  ...
  {
    super.doOnPause();
    urk.c("EditPicActivity", "doOnPause");
  ...
  {
    super.doOnResume();
    urk.c("EditPicActivity", "doOnResume");
    this.jdField_a_of_type_Bigb.l();
    biyr.a("resume activity");
    ((bhdr)bhfm.a(13)).c(1);
  ...
  {
    super.doOnStart();
    urk.c("EditPicActivity", "doOnStart");
    this.jdField_a_of_type_Bigb.k();
    urq.jdField_a_of_type_JavaLangString = urq.a(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int);
    urq.jdField_b_of_type_JavaLangString = "pic_edit";
    bhci.a().a();
    bhcm.a().c();
  }
  ...
  public void doOnStop()
  {
    ...
    bhci.a().b();
    bhcs.a("EditPicActivity", 1, "【doOnStop】");
