  ...
  implements Runnable
{
  ...
  public void run()
  {
    Object localObject1 = bbwm.a().a("CMD_GET_CURRENT_NICK_NAME", null);
    if (localObject1 == null) {
      localObject1 = "";
    }
    for (;;)
    {
      Object localObject2 = bbwm.a().a("CMD_GET_CURRENT_USER_HEAD", null);
      ...
      try
      {
        for (;;)
        {
          ...
          Bitmap localBitmap = bfvo.c((Bitmap)localObject2, 50, 50);
