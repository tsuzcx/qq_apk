  ...
  implements anok
{
  ...
  Property jdField_a_of_type_AndroidUtilProperty = new anol(this, Float.class, "containerAlpha");
  ...
  private void b(boolean paramBoolean, long paramLong)
  {
    ...
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new anom(this));
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new anon(this));
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new anoo(this, paramString), 300L);
      return;
      label123:
      if (paramBoolean2)
      {
