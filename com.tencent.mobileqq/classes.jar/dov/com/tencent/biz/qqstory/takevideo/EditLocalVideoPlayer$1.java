...
class EditLocalVideoPlayer$1
  implements Callbacks.Callback<Boolean, MediaCodecThumbnailGenerator.ThumbnailResult>
{
  EditLocalVideoPlayer$1(EditLocalVideoPlayer paramEditLocalVideoPlayer) {}
  ...
  public Void a(Boolean paramBoolean, MediaCodecThumbnailGenerator.ThumbnailResult paramThumbnailResult)
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.a.a(), 1, HardCodeUtil.a(2131703696) + paramThumbnailResult.jdField_a_of_type_Int, 1);
    }
  }
}
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.EditLocalVideoPlayer.1
