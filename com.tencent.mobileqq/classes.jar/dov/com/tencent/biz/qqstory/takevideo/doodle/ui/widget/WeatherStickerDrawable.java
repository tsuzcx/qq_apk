...
import com.tencent.biz.qqstory.takevideo.slideshow.EaseCubicInterpolator;
  ...
  extends InfoStickerDrawable
{
  ...
  private WeatherStickerDrawable.ApngHandler jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetWeatherStickerDrawable$ApngHandler;
  ...
  private void d()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetWeatherStickerDrawable$ApngHandler.sendEmptyMessageDelayed(0, 40L);
      localBitmap = null;
  ...
  public Bitmap a()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a());
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetWeatherStickerDrawable$ApngHandler != null) {
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetWeatherStickerDrawable$ApngHandler.removeCallbacksAndMessages(null);
    }
  }
  ...
  protected void b()
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetWeatherStickerDrawable$ApngHandler = new WeatherStickerDrawable.ApngHandler(new WeakReference(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.k = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("offsetX", 0L, 650L, (int)(-i1 * 0.3D), 0, new SpringInterpolator());
        this.l = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("offsetX", 100L, 650L, (int)(-i1 * 0.3D), 0, new SpringInterpolator());
        this.m = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("offsetX", 200L, 650L, (int)(-i1 * 0.3D), 0, new SpringInterpolator());
        this.n = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("alpha", 0L, 370L, 0, 255, new EaseCubicInterpolator(0.33F, 0.0F, 0.67F, 1.0F));
        this.o = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("alpha", 100L, 370L, 0, 255, new EaseCubicInterpolator(0.33F, 0.0F, 0.67F, 1.0F));
        this.p = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("alpha", 200L, 370L, 0, 255, new EaseCubicInterpolator(0.33F, 0.0F, 0.67F, 1.0F));
        return;
      }
  ...
  protected void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) && (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetWeatherStickerDrawable$ApngHandler.sendEmptyMessage(0);
    }
  }
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.doodle.ui.widget.WeatherStickerDrawable
