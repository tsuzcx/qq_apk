  ...
  implements DialogInterface.OnDismissListener, EditInteractExport, Publishable
{
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoInteractInteractPasterEditDialog.setContentView(2130970855);
  ...
  public boolean b()
  {
    ...
    DialogUtil.a(a(), 230, "还没有输入问题哦", null, "我知道了", "输入", new anlr(this), new anls(this)).show();
    return false;
  }
