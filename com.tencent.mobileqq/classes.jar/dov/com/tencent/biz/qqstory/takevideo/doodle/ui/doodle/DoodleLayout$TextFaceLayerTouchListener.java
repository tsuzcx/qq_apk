...
{
  private final int jdField_a_of_type_Int = DisplayUtil.b(DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  ...
  public boolean a(BaseLayer paramBaseLayer, MotionEvent paramMotionEvent)
  {
    ...
    for (Rect localRect = ((FaceLayer)paramBaseLayer).a(localRect);; localRect = null)
    {
      ...
      {
        float f2 = f1;
        if (SystemBarTintManager.hasNavBar(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext())) {
          f2 = f1 + SystemBarTintManager.getNavigationBarHeight(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.getContext());
        }
        ...
        case 6: 
          do
          {
            ...
            if (DoodleLayout.d(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout)) {
              TakeVideoUtils.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
            }
        ...
        for (;;)
        {
          ...
          if (!(paramBaseLayer instanceof TextFaceEditLayer)) {
            break;
          }
          ((TextFaceEditLayer)paramBaseLayer).c();
          break;
          ...
          label926:
          DoodleLayout.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout).a.a(Message.obtain(null, 15, 0, 0, new EditVideoLimitRegion.LimitMessage(false, false, false, false, true)));
          break label714;
          label963:
          bool = false;
        }
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.doodle.ui.doodle.DoodleLayout.TextFaceLayerTouchListener
