  ...
  extends Drawable
{
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new anlj(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new anlk(this));
