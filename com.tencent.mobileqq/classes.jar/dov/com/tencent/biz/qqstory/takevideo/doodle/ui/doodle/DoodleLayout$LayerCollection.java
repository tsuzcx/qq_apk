...
public class DoodleLayout$LayerCollection
{
  ...
  public DoodleLayout$LayerCollection(@NonNull TextLayer paramTextLayer, @NonNull LineLayer paramLineLayer, @NonNull FaceLayer paramFaceLayer, @NonNull DynamicFaceLayer paramDynamicFaceLayer, @NonNull EmptyLayer paramEmptyLayer)
  {
