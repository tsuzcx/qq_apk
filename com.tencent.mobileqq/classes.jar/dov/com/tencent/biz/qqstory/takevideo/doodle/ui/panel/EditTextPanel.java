  ...
  implements OnHolderItemClickListener
{
  ...
  private DynamicTextConfigManager.IDynamicTextResDownloadCallback jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager$IDynamicTextResDownloadCallback = new anlb(this);
  ...
  public int a(int paramInt)
  {
    ...
    if (paramInt >= 0)
    {
      ...
      postDelayed(new anla(this, paramInt), 200L);
      this.c = paramInt;
  ...
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    while (!QLog.isColorLevel()) {
      ...
      catch (Exception localException)
      {
        ...
        {
          FMDialogUtil.a(paramView.getContext(), 2131439185, 2131439186, new anlf(this, localException, localDynamicTextConfigBean));
          return;
        }
