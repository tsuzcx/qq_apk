...
import dov.com.tencent.biz.qqstory.takevideo.doodle.ui.Clip.ClipUtils;
import dov.com.tencent.biz.qqstory.takevideo.doodle.ui.Clip.ClipWindow;
...
public class CropNewImage
{
  ...
  private ClipWindow jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow = new ClipWindow();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  {
    RectF localRectF = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(paramFloat1, paramFloat2);
    ...
    return new CropHomeing(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public CropHomeing a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(paramFloat1, paramFloat2);
      CropHomeing localCropHomeing = new CropHomeing(paramFloat1, paramFloat2, c(), a());
      localCropHomeing.a(ClipUtils.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
  ...
  {
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.c()) {}
  ...
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(false);
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.b(true);
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.c(false);
      return paramBoolean;
    }
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.c(paramBoolean);
  }
  ...
  {
    CropHomeing localCropHomeing = new CropHomeing(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.d())
    {
    ...
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(paramFloat1, paramFloat2));
  ...
  {
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipWindow.d(true);
  }
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.doodle.ui.crop.CropNewImage
