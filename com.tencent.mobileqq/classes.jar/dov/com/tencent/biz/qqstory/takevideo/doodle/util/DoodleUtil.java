...
public class DoodleUtil
{
  ...
  public static FaceLayer.LayerParams a(LocationFacePackage.Item paramItem, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
  {
    ...
    float f2 = paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.c;
    ...
    paramInt1 = (int)(paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.b / f1 * paramInt2);
    paramItem = new FaceLayer.LayerParams(paramFloat1, paramFloat2, f2, 0.0F, 0.0F, 0.0F, i, paramInt2 + a(paramItem.b, paramInt1, i) * 2 + 32, paramItem.b, Color.parseColor(paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.a), paramInt1);
  ...
  public static FaceLayer.LayerParams a(LocationFacePackage.Item paramItem, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    float f = paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.c;
    ...
    paramInt1 = (int)(paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.b / f * paramInt2);
    paramItem = new FaceLayer.LayerParams(paramFloat1, paramFloat2, paramFloat3, 0.0F, 0.0F, 0.0F, i, paramInt2 + a(paramItem.b, paramInt1, i) * 2 + 32, paramItem.b, Color.parseColor(paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.a), paramInt1);
    SLog.b("DoodleUtil", "LayerParams:" + paramItem.toString());
    return paramItem;
  }
  ...
  public static ArrayList<DynamicStickerData> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localDynamicStickerData.mGifDecoder = new ApngDecodeWrapper(localDynamicStickerData.path);
        ...
        localDynamicStickerData.mGifDecoder = new AnimationDecodeWrapper(localDynamicStickerData.type, localDynamicStickerData.data);
        continue;
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public static boolean a(LocationFacePackage.Item paramItem)
  {
    ...
    if (paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.b < 0)
    {
      SLog.e("DoodleUtil", "item textSize < 0. textSize:" + paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.b);
      return false;
    }
    if ((paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.c <= 0) || (paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.d <= 0))
    {
      SLog.e("DoodleUtil", "item pictureWidth <= 0 or item pictureHeight <= 0. pictureWidth:" + paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.c + ",pictureHeight:" + paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.d);
      return false;
    }
    ...
    try
    {
      Color.parseColor(paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.a);
      return true;
    }
    catch (Exception localException)
    {
      SLog.e("DoodleUtil", "item color is illegal:" + paramItem.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiFaceLocationFacePackage$Item$ItemParams.a);
