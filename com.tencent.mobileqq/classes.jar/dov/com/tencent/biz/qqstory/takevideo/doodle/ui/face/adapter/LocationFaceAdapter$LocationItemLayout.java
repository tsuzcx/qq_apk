  ...
  extends LinearLayout
{
  ...
  private void a()
  {
    ...
    if (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131559185, null);
  ...
  public void a(LocationFacePackage paramLocationFacePackage, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131370806);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131370791);
      localObject3 = (TextView)((View)localObject1).findViewById(2131370807);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131370805);
    ...
    Object localObject2 = new LocationFaceAdapter.URLDrawableListener((String)localObject1, localURLImageView, localProgressBar);
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.doodle.ui.face.adapter.LocationFaceAdapter.LocationItemLayout
