  ...
  extends ImageViewVideoPlayer
{
  ...
  @NonNull
  public List<bjyz> a(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2, int paramInt3, float paramFloat)
  {
    ...
    if ((paramInt1 < arrayOfLong.length) && (paramInt1 + 2 < arrayOfLong.length))
    {
      ...
      for (;;)
      {
        ...
        localArrayList.add(new bjyz(paramInt1 / 2, arrayOfLong[paramInt1], arrayOfLong[(paramInt1 + 2)], arrayOfLong[(paramInt1 + 1)], arrayOfLong[(paramInt1 + 3)], (Bitmap)localObject));
        paramInt1 += 2;
        break;
        label571:
  ...
  public void onLoadCancelled(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    paramView = this.jdField_a_of_type_Bjza;
    if (paramView != null) {
      paramView.n();
    }
  }
  ...
  public void setCurrentVideoFragment(bjyz parambjyz)
  {
    if (parambjyz != null)
    {
      VideoSourceHelper localVideoSourceHelper = null;
      ...
      int i = localVideoSourceHelper.setCurrentVideoFrameRange(true, parambjyz.a, parambjyz.c, parambjyz.b, parambjyz.d);
      if (i != 0) {
  ...
  public void setVideoLoadListener(bjza parambjza)
  {
    this.jdField_a_of_type_Bjza = parambjza;
  }
}
