  ...
  extends MeasureJobSegment<GenerateContext, GenerateContext>
{
  ...
  protected void a(JobContext paramJobContext, GenerateContext paramGenerateContext)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && (!((EditDoodleExport)localObject).r_()))
      {
        localObject = ((EditDoodleExport)localObject).a();
        if (localObject != null)
        {
          paramGenerateContext.jdField_a_of_type_DovComTencentBizQqstoryTakevideoPublishGeneratePicArgs.b = ((Bitmap)localObject);
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.publish.GenerateEditPicDoodleSegment
