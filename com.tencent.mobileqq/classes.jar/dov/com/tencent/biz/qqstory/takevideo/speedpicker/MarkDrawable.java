  ...
  implements Animatable
{
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841682));
    this.jdField_a_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841683));
    this.jdField_a_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841684));
    this.jdField_a_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841685));
    this.jdField_a_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841686));
    this.jdField_a_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841709));
    this.jdField_b_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841726));
    this.jdField_b_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841727));
    this.jdField_b_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841728));
    this.jdField_b_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841729));
    this.jdField_b_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841730));
    this.jdField_b_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841731));
  }
  ...
  private void c(int paramInt)
  {
    ...
    MarkDrawable.MarkDrawableListener localMarkDrawableListener;
    do
    {
      do
      {
      ...
      localMarkDrawableListener = (MarkDrawable.MarkDrawableListener)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localMarkDrawableListener == null);
    localMarkDrawableListener.a(this.jdField_c_of_type_Int, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.getNumberOfFrames());
  }
  ...
  private void d(int paramInt)
  {
    ...
    localMarkDrawableListener.e(paramInt);
  }
  ...
  private void e(int paramInt)
  {
    ...
    localMarkDrawableListener.d(paramInt);
  }
  ...
  private void f(int paramInt)
  {
    ...
    localMarkDrawableListener.f(paramInt);
  }
