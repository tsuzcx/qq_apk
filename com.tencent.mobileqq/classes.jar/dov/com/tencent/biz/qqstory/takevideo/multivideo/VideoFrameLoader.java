...
public class VideoFrameLoader
  implements DecodeRunnable.DecodeRunnableListener
{
  ...
  private GPUBitmapImageRender jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecRendererGPUBitmapImageRender;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<VideoFrameLoader.VideoFrameLoaderListener> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public VideoFrameLoader(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private Bitmap a(Context paramContext, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = ImageUtil.a(paramContext, ImageUtil.c(paramBitmap), 0.4F, 25.0F);
      ...
      for (;;)
      {
        paramContext = BitmapUtils.a(BitmapUtils.a(paramContext, i, j, true), paramBitmap);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecRendererGPUBitmapImageRender != null) {
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecRendererGPUBitmapImageRender.a();
    }
  }
}
