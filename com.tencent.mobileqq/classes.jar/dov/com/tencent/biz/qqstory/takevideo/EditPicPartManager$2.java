  ...
  implements ActionSheet.OnButtonClickListener
{
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (((String)localObject).equals(paramView.getResources().getString(2131693302)))
    {
      int i = 1;
      paramInt = i;
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditPicPartManager.a.c() == 130)
      {
        paramInt = i;
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetActionSheet.dismiss();
      return;
      if (((String)localObject).equals(paramView.getResources().getString(2131693308)))
      {
        localObject = new File(this.jdField_a_of_type_JavaLangString);
        String str = ((File)localObject).getAbsolutePath();
        AIOGalleryUtils.a((Activity)paramView.getContext(), (File)localObject, Utils.Crc64String(str), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditPicPartManager);
        ReportController.b(null, "dc00898", "", "", "0X800A185", "0X800A185", 0, 0, "", "", "", "");
      }
      else if (((String)localObject).equals(paramView.getResources().getString(2131693300)))
      {
        paramView = BaseApplicationImpl.getApplication();
        QfavBuilder.b(this.jdField_a_of_type_JavaLangString).a(this.jdField_a_of_type_AndroidAppActivity, paramView.getRuntime().getAccount(), 2131694901, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditPicPartManager);
 ...
 * Qualified Name:     dov.com.tencent.biz.qqstory.takevideo.EditPicPartManager.2
