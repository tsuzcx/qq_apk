  ...
  extends FaceLayer
{
  ...
  public static Drawable a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 22	com/tencent/biz/qqstory/utils/BitmapUtils:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +74 -> 86
    //   15: invokestatic 28	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   18: ifeq +43 -> 61
    //   21: ldc 30
    //   23: iconst_2
    ...
    //   36: aload_1
    //   37: invokevirtual 47	android/graphics/Bitmap:getWidth	()I
    //   40: invokevirtual 50	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   43: ldc 52
    //   45: invokevirtual 41	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   48: aload_1
    //   49: invokevirtual 55	android/graphics/Bitmap:getHeight	()I
    //   52: invokevirtual 50	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   61: new 65	android/graphics/drawable/BitmapDrawable
    //   64: dup
    //   65: aload_1
    //   66: invokespecial 68	android/graphics/drawable/BitmapDrawable:<init>	(Landroid/graphics/Bitmap;)V
    //   69: astore_0
    //   70: aload_0
    //   71: iconst_0
    //   72: iconst_0
    //   73: aload_1
    //   74: invokevirtual 47	android/graphics/Bitmap:getWidth	()I
    //   77: aload_1
    //   78: invokevirtual 55	android/graphics/Bitmap:getHeight	()I
    //   81: invokevirtual 74	android/graphics/drawable/Drawable:setBounds	(IIII)V
    //   84: aload_0
    //   85: areturn
    //   86: invokestatic 28	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   89: ifeq +28 -> 117
    //   92: ldc 30
    //   94: iconst_2
    //   95: new 32	java/lang/StringBuilder
    //   98: dup
    //   99: invokespecial 35	java/lang/StringBuilder:<init>	()V
    //   102: ldc 76
    ...
    //   111: invokevirtual 59	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   124: astore_0
    //   125: aload_1
    //   126: invokevirtual 79	java/lang/OutOfMemoryError:printStackTrace	()V
    //   129: goto -45 -> 84
    //   132: astore_1
    //   133: goto -8 -> 125
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            localDynamicStickerData.scale = localFaceItem.q;
            localDynamicStickerData.rotate = localFaceItem.r;
            localDynamicStickerData.translateX = (localFaceItem.s + paramInt1);
            localDynamicStickerData.translateY = (localFaceItem.t + paramInt2);
            localDynamicStickerData.height = localFaceItem.v;
            localDynamicStickerData.width = localFaceItem.u;
            ...
            localDynamicStickerData.mapMotionTrack = localFaceItem.jdField_a_of_type_JavaUtilMap;
  ...
  public void a(ArrayList<PasterParcelData> paramArrayList, boolean paramBoolean, JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      if (paramJSONArray != null)
      {
        ...
        localFaceItem.jdField_b_of_type_Boolean = InformationFaceConstant.a(localInfoStickerDrawable.a());
        localFaceItem.c = InformationFaceConstant.b(localInfoStickerDrawable.a());
        if (localFaceItem.jdField_b_of_type_Boolean)
        {
          this.jdField_b_of_type_JavaUtilList.add(localFaceItem);
  ...
  public void c(Canvas paramCanvas)
  {
    ...
    {
      FaceLayer.FaceItem localFaceItem = (FaceLayer.FaceItem)localIterator.next();
      Object localObject2 = a(a(localFaceItem.jdField_f_of_type_JavaLangString));
      if (localObject2 != null) {
        ((Drawable)localObject2).setBounds(0, 0, (int)localFaceItem.u, (int)localFaceItem.v);
      }
      ...
      for (;;)
      {
        try
        {
          localObject1 = (InfoStickerDrawable)localFaceItem.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), ((InfoStickerDrawable)localObject1).a());
        }
