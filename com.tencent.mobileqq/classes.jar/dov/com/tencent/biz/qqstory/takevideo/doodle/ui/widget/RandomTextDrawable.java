  ...
  extends InfoStickerDrawable
{
  ...
  protected void a()
  {
    ...
    Typeface localTypeface = Typeface.createFromAsset((AssetManager)localObject, "info_sticker_typeface/roboto-medium.ttf");
    localObject = Typeface.createFromAsset((AssetManager)localObject, "info_sticker_typeface/roboto-regular.ttf");
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetPerLineFontBitmapsInfo = a(this.jdField_b_of_type_JavaLangString, AIOUtils.a(48.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1, 0, 0, 0, 600, localTypeface, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator, 0);
    this.jdField_b_of_type_Int = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetAnimStateTypeEvaluator.a("", 300L, 500L, 0, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetPerLineFontBitmapsInfo.e, new LinearInterpolator());
  ...
  protected void a(Canvas paramCanvas, ArrayList paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        localTextPaint.setAlpha(((Integer)this.jdField_a_of_type_JavaUtilArrayList.get(localFontBitmapInfo.jdField_b_of_type_Int)).intValue());
        i = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetPerLineFontBitmapsInfo.jdField_a_of_type_Int;
        paramCanvas.drawBitmap(localBitmap, localFontBitmapInfo.jdField_a_of_type_Int + i, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetPerLineFontBitmapsInfo.jdField_b_of_type_Int, localTextPaint);
      }
      ...
      paramCanvas.drawLine(0.0F, i, ((Integer)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)).intValue(), i, this.jdField_a_of_type_AndroidGraphicsPaint);
      ...
      while (paramArrayList.hasNext())
      {
        ...
        paramCanvas.drawBitmap(localBitmap, localFontBitmapInfo.jdField_a_of_type_Int + i, this.jdField_b_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetPerLineFontBitmapsInfo.jdField_b_of_type_Int, localTextPaint);
      }
    }
  }
