...
public class albm
  implements alcv
{
  public albm(ArConfigService paramArConfigService) {}
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((alen)ArConfigService.a(this.a).getBroadcastItem(i)).a(paramInt);
        i += 1;
      }
    ...
    albv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false, paramInt);
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((alen)ArConfigService.a(this.a).getBroadcastItem(i)).a(paramLong1, paramLong2);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void a(ARCommonConfigInfo paramARCommonConfigInfo)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((alen)ArConfigService.a(this.a).getBroadcastItem(i)).a(null, null, paramARCommonConfigInfo);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void a(ArConfigInfo paramArConfigInfo)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((alen)ArConfigService.a(this.a).getBroadcastItem(i)).a(paramArConfigInfo, null, null);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void a(ArEffectConfig paramArEffectConfig)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((alen)ArConfigService.a(this.a).getBroadcastItem(i)).a(null, paramArEffectConfig, null);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void b()
  {
    ...
    synchronized (this.a.jdField_a_of_type_JavaLangObject)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          if (i < j) {
            try
            {
              ((alen)ArConfigService.a(this.a).getBroadcastItem(i)).a();
              i += 1;
            }
            catch (RemoteException localRemoteException)
            {
      ...
      do
      {
        ...
        albv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true, 0);
        return;
        ArConfigService.a(this.a).finishBroadcast();
