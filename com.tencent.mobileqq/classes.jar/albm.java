...
public class albm
{
  ...
  public static int a(String paramString)
  {
    try
    {
      int i = alca.a("arcloud", "v8.2.0.1", alca.b("arcloud", "v8.2.0.1", "arcloud"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        alca.a("arcloud", "v8.2.0.1", "arcloud", paramString2);
        paramString2 = alca.a("arcloud", "v8.2.0.1", paramString2);
        try
        {
      ...
      try
      {
        localObject1 = a(bbdj.b((File)localObject2));
        ...
        alca.a("arcloud", "v8.2.0.1", (String)localObject3, (String)((Map.Entry)localObject2).getValue());
        localObject3 = new File((String)localObject1);
        QLog.i("AREngine_ArCloudNativeSoLoader", 2, "doOnDownloadSuccess. soFilename = " + (String)localObject1);
        if (!((File)localObject3).exists()) {
          break label516;
        }
        str = aurl.a((String)localObject1);
  ...
  {
    return new File(alca.a("arcloud", "v8.2.0.1", alca.b("arcloud", "v8.2.0.1", "arcloud")) + File.separator + a() + ".so").exists();
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        String str = alca.a("arcloud", "v8.2.0.1", alca.b("arcloud", "v8.2.0.1", "arcloud")) + File.separator + paramString + ".so";
        ...
        {
          paramString = alca.b("arcloud", "v8.2.0.1", paramString);
          localObject = aurl.a(str);
