...
public class albm
  implements albt, Handler.Callback
{
  private static long jdField_a_of_type_Long = new Random().nextInt(263167);
  public static String a;
  private volatile albk jdField_a_of_type_Albk;
  private albr jdField_a_of_type_Albr = new albr();
  ...
  private ConcurrentHashMap<String, albn> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131700895);
  }
  
  public albm(String paramString1, String paramString2)
  {
    this.jdField_c_of_type_JavaLangString = paramString2;
    long l = jdField_a_of_type_Long;
    jdField_a_of_type_Long = 1L + l;
    this.jdField_b_of_type_JavaLangString = String.valueOf(l);
    this.jdField_d_of_type_JavaLangString = alao.a(paramString1, "apollo_task_id", String.valueOf(this.jdField_b_of_type_JavaLangString));
  ...
  public static albm a(boolean paramBoolean, String paramString)
  {
    long l = System.currentTimeMillis();
    if (!TextUtils.isEmpty(paramString))
    {
      String str = albo.a().a(paramString);
      if (albo.a().a(str))
      {
        paramString = new albm(paramString, str);
        if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    ...
    {
      albo.a().a(BaseApplicationImpl.getContext(), this.jdField_c_of_type_JavaLangString, this.jdField_e_of_type_JavaLangString, (AppInterface)localObject, this.jdField_a_of_type_Albr);
      localObject = albo.a().a(this.jdField_c_of_type_JavaLangString);
      if ((localObject != null) && (!((List)localObject).isEmpty()))
      {
        localObject = ((List)localObject).iterator();
        while (((Iterator)localObject).hasNext())
        {
          albg localalbg = (albg)((Iterator)localObject).next();
          if (localalbg.a())
          {
            albn localalbn = new albn(this, localalbg);
            this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localalbg.jdField_a_of_type_JavaLangString, localalbn);
            localalbn.b();
          }
        }
      }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (3 != i)
    {
      ...
      if ((this.jdField_a_of_type_Albk != null) && (!paramBoolean))
      {
        this.jdField_a_of_type_Albk.a();
  ...
  private void c()
  {
    ...
    this.jdField_f_of_type_JavaLangString = alao.e(this.jdField_e_of_type_JavaLangString);
    ...
    Object localObject1 = alao.d(this.jdField_f_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    localObject1 = alao.a((File)localObject2);
    this.jdField_a_of_type_Albr.e = (System.currentTimeMillis() - l1);
    boolean bool1;
    label296:
    boolean bool2;
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if (albo.a().a(this.jdField_c_of_type_JavaLangString, (String)localObject1)) {
        break label652;
      }
      localObject1 = null;
      ...
      this.jdField_a_of_type_Albr.a = 1;
      bool1 = false;
      label387:
      this.jdField_a_of_type_Albr.f = (System.currentTimeMillis() - l2);
    ...
    for (;;)
    {
      ...
      break label296;
      label652:
      this.jdField_a_of_type_Albr.a = 2;
      break label387;
      label663:
      this.jdField_a_of_type_Albr.a = 0;
      localObject2 = localObject1;
      bool2 = bool1;
      break label451;
      label682:
  ...
  private void d()
  {
    ...
    long l1 = System.currentTimeMillis();
    this.jdField_a_of_type_Albk = new albk(this.jdField_e_of_type_JavaLangString, true, null, null);
    long l2 = System.currentTimeMillis();
    int j = this.jdField_a_of_type_Albk.a();
    int i = j;
    Map localMap;
    if (j == 0)
    {
      ...
      j = this.jdField_a_of_type_Albk.b();
      if (QLog.isColorLevel()) {
      ...
      l2 = System.currentTimeMillis();
      localMap = this.jdField_a_of_type_Albk.a();
      if (QLog.isColorLevel()) {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          alao.a(this.jdField_e_of_type_JavaLangString, (List)localObject);
          i = j;
        }
        if (QLog.isColorLevel()) {
  ...
  {
    int i = 2;
    Object localObject1 = this.jdField_a_of_type_Albk.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean, null);
    ...
    this.jdField_a_of_type_JavaIoInputStream = new albs(this, ((albl)localObject1).jdField_a_of_type_JavaIoByteArrayOutputStream, ((albl)localObject1).jdField_a_of_type_JavaIoBufferedInputStream);
    if (((albl)localObject1).jdField_a_of_type_Boolean) {}
    for (;;)
    {
      try
      {
        localObject1 = ((albl)localObject1).jdField_a_of_type_JavaIoByteArrayOutputStream.toString("UTF-8");
      }
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          long l = System.currentTimeMillis();
          albo.a().b(this.jdField_e_of_type_JavaLangString, (String)localObject1);
  ...
  public albr a()
  {
    return this.jdField_a_of_type_Albr;
  }
  ...
  public Object a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 345	albm:jdField_c_of_type_Boolean	Z
    //   4: ifeq +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: aload_0
    //   10: getfield 286	albm:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   13: ifnull +66 -> 79
    //   16: invokestatic 174	albo:a	()Lalbo;
    //   19: aload_1
    //   20: invokevirtual 521	albo:b	(Ljava/lang/String;)Z
    //   23: ifeq +56 -> 79
    ...
    //   58: invokestatic 174	albo:a	()Lalbo;
    //   61: aload_1
    //   62: aload_0
    //   63: getfield 106	albm:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   66: invokevirtual 526	albo:a	(Ljava/lang/String;Ljava/lang/String;)Lcom/tencent/smtt/export/external/interfaces/WebResourceResponse;
    //   69: astore 5
    //   71: aload 5
    //   73: ifnull +6 -> 79
    //   76: aload 5
    //   78: areturn
    //   79: aload_0
    //   80: getfield 286	albm:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   83: ifnull +139 -> 222
    //   86: aload_0
    //   87: getfield 104	albm:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   90: invokevirtual 527	java/util/concurrent/ConcurrentHashMap:isEmpty	()Z
    //   93: ifne +129 -> 222
    //   96: aload_0
    //   97: getfield 104	albm:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   127: checkcast 267	albn
    //   130: astore 6
    //   132: aload_1
    //   133: aload 6
    //   135: invokestatic 530	albn:a	(Lalbn;)Lalbg;
    //   138: getfield 271	albg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   141: invokevirtual 533	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   144: ifeq -34 -> 110
    //   147: aload 6
    //   149: aload_1
    //   150: invokevirtual 536	albn:a	(Ljava/lang/String;)Lcom/tencent/smtt/export/external/interfaces/WebResourceResponse;
    //   153: astore 7
    ...
    //   187: aload 7
    //   189: invokevirtual 433	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   198: aload_0
    //   199: getfield 104	albm:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   202: aload 6
    //   204: invokestatic 530	albn:a	(Lalbn;)Lalbg;
    //   207: getfield 271	albg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   210: invokevirtual 543	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   213: pop
    //   214: aload 7
    //   216: ifnull -106 -> 110
    //   219: aload 7
    ...
    //   222: aload_0
    //   223: aload_1
    //   224: invokevirtual 544	albm:a	(Ljava/lang/String;)Z
    //   227: ifne +49 -> 276
    ...
    //   251: aload_0
    //   252: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   275: areturn
    //   276: aload_0
    //   277: getfield 67	albm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   307: aload_0
    //   308: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   330: aload_0
    //   331: getfield 67	albm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   334: iconst_0
    //   335: iconst_1
    ...
    //   363: aload_0
    //   364: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   407: aload_0
    //   408: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   433: lstore_2
    //   434: aload_0
    //   435: getfield 60	albm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   438: invokevirtual 284	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   441: iconst_1
    //   442: if_icmpne +357 -> 799
    //   445: aload_0
    //   446: getfield 60	albm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   449: astore_1
    //   450: aload_1
    //   451: monitorenter
    //   452: aload_0
    //   453: getfield 60	albm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   484: aload_0
    //   485: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   503: aload_0
    //   504: getfield 60	albm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   507: ldc2_w 555
    //   510: invokevirtual 560	java/lang/Object:wait	(J)V
    //   513: aload_1
    //   514: monitorexit
    ...
    //   533: aload_0
    //   534: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   546: astore_1
    //   547: aload_0
    //   548: getfield 288	albm:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   551: ifnull +298 -> 849
    //   554: iconst_1
    //   555: istore 4
    //   557: ldc 136
    ...
    //   592: aload_0
    //   593: getfield 288	albm:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   596: ifnonnull +54 -> 650
    //   599: aload_0
    //   600: getfield 290	albm:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   603: invokestatic 169	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   606: ifne +44 -> 650
    //   609: aload_0
    //   610: new 566	java/io/ByteArrayInputStream
    //   613: dup
    //   614: aload_0
    //   615: getfield 290	albm:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   618: ldc_w 502
    //   621: invokevirtual 570	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   624: invokespecial 573	java/io/ByteArrayInputStream:<init>	([B)V
    //   627: putfield 288	albm:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   630: aload_0
    //   631: iconst_1
    //   632: putfield 575	albm:jdField_d_of_type_Boolean	Z
    ...
    //   650: aload_0
    //   651: getfield 288	albm:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   654: ifnull +236 -> 890
    //   657: aload_0
    //   658: invokespecial 435	albm:b	()Z
    //   661: ifne +209 -> 870
    //   664: new 579	com/tencent/smtt/export/external/interfaces/WebResourceResponse
    //   667: dup
    //   668: aload_0
    //   669: getfield 128	albm:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   672: invokestatic 580	alao:a	(Ljava/lang/String;)Ljava/lang/String;
    //   675: ldc_w 582
    //   678: aload_0
    //   679: getfield 288	albm:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   682: invokespecial 585	com/tencent/smtt/export/external/interfaces/WebResourceResponse:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)V
    //   685: astore_1
    //   686: aload_0
    //   687: getfield 75	albm:jdField_e_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   690: iconst_1
    //   691: invokevirtual 308	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   694: aload_0
    //   695: getfield 575	albm:jdField_d_of_type_Boolean	Z
    //   698: ifeq +8 -> 706
    //   701: aload_0
    //   702: iconst_0
    //   703: putfield 575	albm:jdField_d_of_type_Boolean	Z
    ...
    //   728: aload_1
    //   729: invokevirtual 433	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   738: aload_0
    //   739: aconst_null
    //   740: putfield 288	albm:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   743: aload_1
    //   744: areturn
    //   745: astore 5
    //   747: ldc 136
    ...
    //   762: aload_0
    //   763: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   775: aload 5
    //   777: invokevirtual 517	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   786: invokestatic 591	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   789: goto -276 -> 513
    //   792: astore 5
    //   794: aload_1
    //   795: monitorexit
    ...
    //   820: aload_0
    //   821: getfield 114	albm:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   833: aload_0
    //   834: getfield 60	albm:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   837: invokevirtual 433	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   864: invokestatic 596	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   867: goto -232 -> 635
  ...
  public void a(boolean paramBoolean)
  {
    ...
    albr localalbr = this.jdField_a_of_type_Albr;
    long l = System.currentTimeMillis();
    localalbr.g = l;
    b();
    c();
    ...
    this.jdField_a_of_type_Albr.h = System.currentTimeMillis();
  }
  ...
  public boolean b(String paramString)
  {
    ...
    {
      this.jdField_e_of_type_JavaLangString = alao.a(paramString, "apollo_task_id", String.valueOf(this.jdField_b_of_type_JavaLangString));
      this.jdField_a_of_type_Albr.i = System.currentTimeMillis();
      if (QLog.isColorLevel())
      {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 1) {
      if (this.jdField_c_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))
      {
        ...
        this.jdField_a_of_type_Albr.j = System.currentTimeMillis();
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {
