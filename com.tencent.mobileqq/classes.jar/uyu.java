  ...
  extends WebViewPlugin
{
  ...
  {
    Object localObject = new uyv(this, paramString);
    paramString = ((uyv)localObject).getString("status");
    int i = ((uyv)localObject).getInt("balance");
    localObject = ((uyv)localObject).getString("uin");
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localIntent.putExtras(uzg.a(localIntent.getExtras(), paramString1));
  ...
  private void a(String paramString, String[] paramArrayOfString)
  {
    if (("getLabel".equals(paramString)) && (a(paramArrayOfString))) {
      f(new JSONObject(paramArrayOfString[0]).optString("callback"));
    }
    do
    {
      return;
      ...
      if (("setTitleBarStyle".equals(paramString)) && (a(paramArrayOfString)))
      {
        b(paramArrayOfString[0]);
        return;
      }
    } while ((!"chargeStatusCallback".equals(paramString)) || (!a(paramArrayOfString)));
  ...
  {
    paramString = new uyv(this, paramString);
    int i;
    if (paramString.has("titleTextColor"))
    {
      i = uzg.a(paramString, "titleTextColor");
      paramString = a();
      if (paramString != null)
      {
        if (i != -1) {
  ...
  {
    Object localObject1 = new uyv(this, paramString);
    paramString = ((uyv)localObject1).getString("callback");
    localObject1 = ((uyv)localObject1).optJSONArray("images");
    ...
    if (i < ((JSONArray)localObject1).length())
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        localObject2 = axse.a(localObject2.split(",")[1]);
        ...
        if (localObject2 != null)
        {
          ...
          String str2 = bigv.a(antf.bg);
          File localFile = new File(str2);
          if (!localFile.exists()) {
            localFile.mkdirs();
          }
          str1 = str2 + str1;
          if (bnkc.a((Bitmap)localObject2, str1, Bitmap.CompressFormat.JPEG, 100, true))
          {
  ...
  private void f(String paramString)
  {
    ...
    callJs(paramString, new String[] { uzg.a((Bundle)localObject) });
  }
  
  private void g(String paramString)
  {
    paramString = new uyv(this, paramString).getString("uin");
    if ((this.mRuntime != null) && ((this.mRuntime.a() instanceof QCircleHybirdFragment))) {
  ...
  {
    paramString = new uyv(this, paramString).getString("page");
    if ((this.mRuntime != null) && ((this.mRuntime.a() instanceof QCircleHybirdFragment))) {
  ...
  {
    paramString = new uyv(this, paramString).getString("module");
  ...
  {
    Object localObject = new uyv(this, paramString);
    paramString = ((uyv)localObject).getString("uin");
    int i = ((uyv)localObject).getInt("type");
    int j = ((uyv)localObject).optInt("isDoubly");
    localObject = ((uyv)localObject).optString("nick");
    if ((this.mRuntime != null) && ((this.mRuntime.a() instanceof QCircleHybirdFragment))) {
  ...
  {
    int i = new uyv(this, paramString).getInt("createTime");
    if ((this.mRuntime != null) && ((this.mRuntime.a() instanceof QCircleHybirdFragment)))
    {
