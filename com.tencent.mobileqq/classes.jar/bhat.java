...
public class bhat
{
  ...
  public static EIPCResult a(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    ((axfy)paramString.getManager(160)).a(10014);
    paramBundle.code = 0;
    return paramBundle;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    {
      localObject1 = (axfy)paramQQAppInterface.getManager(160);
      paramQQAppInterface = ((axfy)localObject1).a(10013);
      localObject2 = ((axfy)localObject1).a(10014);
      if (!((axfy)localObject1).a(paramQQAppInterface, false)) {
        break label1102;
      }
    ...
    for (;;)
    {
      int k = i;
      int m = j;
      if (((axfy)localObject1).a((RedTouchItem)localObject2, false))
      {
        k = i;
        m = j;
  ...
  public static EIPCResult b(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    paramString = (axfy)paramString.getManager(160);
