  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.share.ForwardSdkShareProcessor", 2, "ImageUploadStep|run|retry=" + aiuu.a(this.a));
    }
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        if (((File)localObject1).exists())
        {
          ...
          label728:
          if (!bool1) {
            QLog.e("Q.share.ForwardSdkShareProcessor", 1, "ImageUploadStep|uploadImage|ret=" + i + ",retry=" + aiuu.a(this.a));
          }
      ...
      if (!TextUtils.isEmpty(ForwardSdkShareProcessor.a(this.a.jdField_b_of_type_ComTencentMobileqqTransfileForwardSdkShareProcessor)))
      {
        try
        {
          ...
          if (bool1)
          {
            ...
            this.a.f();
            this.a.jdField_b_of_type_ComTencentMobileqqTransfileForwardSdkShareProcessor.jdField_a_of_type_ComTencentMobileqqTransfileBaseTransFileController.a.post(new aiuw(this));
          }
        }
