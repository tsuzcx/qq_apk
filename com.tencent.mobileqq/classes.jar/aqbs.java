  ...
  extends WebViewPlugin
{
  ...
  private void a(String paramString)
  {
    try
    {
      ...
      bjqu.a().a().a((Bundle)localObject, this.mRuntime.a().getCurrentAccountUin());
      return;
    }
    ...
    do
    {
      ...
      if ("answerResult".equals(paramString3))
      {
        ...
        if (!TextUtils.isEmpty(paramJsBridgeListener)) {
          aqbg.a(paramJsBridgeListener, false);
        }
        return true;
      }
      if ("notifyCampusFriendCertificateResult".equals(paramString3))
      {
        ...
        {
          b(paramVarArgs[0]);
          bjqu.a().a().a(paramVarArgs[0], "notifyCampusFriendCertificateResult", this.mRuntime.a().getCurrentAccountUin());
        }
        for (;;)
        {
          return true;
      ...
      if ("notifyUploadSutudentIDResult".equals(paramString3))
      {
        ...
        {
          c(paramVarArgs[0]);
          bjqu.a().a().a(paramVarArgs[0], "notifyUploadSutudentIDResult", this.mRuntime.a().getCurrentAccountUin());
        }
        for (;;)
        {
          return true;
