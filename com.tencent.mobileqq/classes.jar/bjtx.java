  ...
  extends bjts
{
  ...
  bjtx()
  {
    this.jdField_a_of_type_Bjfk = new bjty(this);
  }
  
  private static void a(becq parambecq, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      bjvr.a(Integer.valueOf(i), Long.valueOf(parambecq.a().getLongAccountUin()));
      return;
    }
  ...
  public static void a(CustomWebView paramCustomWebView)
  {
    try
    {
      ...
      paramCustomWebView.setTag(2131375037, Boolean.FALSE);
      paramCustomWebView.setTag(2131375040, Boolean.FALSE);
      return;
    }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(bjfh.a(i, str1, str2, paramVarArgs)))
      {
        a(str2, 0, "success");
        return;
      }
      ...
      do
      {
        paramVarArgs = this.jdField_a_of_type_Bjfk;
        break;
  ...
  private void b()
  {
    ...
    try
    {
      ...
      localCustomWebView.setTag(2131375040, Boolean.TRUE);
    ...
    Object localObject2 = localException.getTag(2131375037);
  ...
  private static void b(becq parambecq, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        new HashMap();
        localObject = bjvr.a(Long.valueOf(parambecq.a().getLongAccountUin()));
        i = j;
      ...
      bjvr.a((Map)localObject, Long.valueOf(parambecq.a().getLongAccountUin()));
      return;
      label190:
      i += 1;
    }
  ...
  private void c(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        localObject2 = new bjfq();
        ((bjfq)localObject2).jdField_a_of_type_Int = i;
        ((bjfq)localObject2).jdField_a_of_type_JavaLangString = bjfq.a(i, paramVarArgs, (String)localObject1, str1, str2, j);
        bjfh.a(l, (bjfq)localObject2);
        ...
        bizm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bizt.a(), paramVarArgs);
        if (i > 0)
        {
          bjfh.a(l, null);
          bjfh.a(l, null);
      ...
      try
      {
        ...
        if (((JSONObject)localObject).getInt("success") == 1)
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length() > 0))
          {
            ...
            parambecq.a().setResult(-1, paramVarArgs);
            parambecq.a().finish();
            return;
          }
        }
  ...
  private void d(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        bjfs localbjfs = new bjfs();
        localbjfs.jdField_a_of_type_Int = i;
        localbjfs.jdField_a_of_type_JavaLangString = paramVarArgs;
        bjfh.a(l, localbjfs);
        if (i > 0)
        {
          bjfh.a(l, null);
  ...
  private void e(becq parambecq, String... paramVarArgs)
  {
    Intent localIntent = new Intent("action_personalize_js2qzone");
    Bundle localBundle = new Bundle();
    ...
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0)) {
      for (;;)
      {
        ...
        try
        {
          ...
          i = localbjfr.jdField_a_of_type_Int;
        }
        ...
        continue;
        label194:
        int i = localbjfs.jdField_a_of_type_Int;
        continue;
        label203:
        i = localbjfq.jdField_a_of_type_Int;
      }
    }
  }
  ...
  private void f(String... paramVarArgs)
  {
    try
    {
      ...
      localIntent.putExtras(localBundle);
      bizm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bizt.a(), localIntent);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void g(String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        {
          bizm.a(((BasePluginActivity)localActivity).getOutActivity(), paramArrayOfString, -1, null, null);
          return;
        }
        bizm.a(localActivity, paramArrayOfString, -1, null, null);
        return;
      }
      if ((localActivity instanceof BasePluginActivity))
      {
  ...
  private void h(String[] paramArrayOfString)
  {
    try
    {
      ...
      if (bool)
      {
        ...
        bjmn.a().a("cmd.getYellowDiamondRedPocket", localBundle, false);
      }
      return;
    }
    catch (Exception paramArrayOfString)
  ...
  private void j(String[] paramArrayOfString)
  {
    try
    {
      ...
      bjmn.a().a("cmd.setResponsiveLike", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
  ...
  private void k(String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      bjmn.a().a("cmd.setDIYData", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
  ...
  private void l(String[] paramArrayOfString)
  {
    try
    {
      ...
      bjmn.a().a("cmd.setCustomTrack", localBundle, false);
      return;
    }
    catch (Exception paramArrayOfString)
    {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            bjvv.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
            return true;
          }
          if (paramString3.equals("SetPersonalizeFinished"))
          {
            bjvs.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
            return true;
          }
          if (paramString3.equals("openNameplateSucc"))
          {
            bjvo.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, paramVarArgs);
            return true;
          }
          ...
          {
            bjmn.a().a("cmd.refeshDecoCustom", null, false);
            return true;
          }
