...
public class pbu
{
  ...
  public String a()
  {
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_OrgJsonJSONObject.put("source", pqf.a());
  ...
  public pbu a(String paramString)
  {
    try
    {
