...
public class awnw
{
  ...
  public static Pair<awnn, List<PrecoverResource>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject4 == null) || (!((awnn)localObject4).a()) || (localArrayList.size() <= 0)) {
        break;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        if (localObject1 != null) {
          ((PrecoverResource)localObject1).businessId = ((awnn)localObject4).a;
        }
      }
      localObject3 = paramString;
  ...
  {
    if (bdep.a()) {
      return alof.aX + "pddata/prd/" + "res_precover";
    }
