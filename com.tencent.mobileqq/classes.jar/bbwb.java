  ...
  implements View.OnClickListener
{
  ...
  public bbwb(Activity paramActivity, bbwe parambbwe, int paramInt1, String paramString, int paramInt2)
  {
  ...
  public bbwb(Activity paramActivity, CustomWebView paramCustomWebView, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    super(paramActivity, 2131755791);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363037));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131369941));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131364860));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131364726));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363852));
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bbwe != null) {
      this.jdField_a_of_type_Bbwe.callback(3);
    }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131364726: 
      ...
      {
        return;
        paramView = bbwc.a(this.jdField_b_of_type_JavaLangString);
        Object localObject;
        ...
        {
          if (this.jdField_a_of_type_Bbwe != null) {
            this.jdField_a_of_type_Bbwe.callback(4);
          }
          dismiss();
          if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView == null) {
            break;
        ...
        if (this.jdField_a_of_type_Bbwe != null) {
          this.jdField_a_of_type_Bbwe.callback(1);
        }
        dismiss();
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {}
        try
