...
public class lcc
{
  private static lcc jdField_a_of_type_Lcc;
  ...
  private lcd jdField_a_of_type_Lcd = new lcd(this);
  private byte[] jdField_a_of_type_ArrayOfByte = new byte[256];
  
  private int a()
  {
    int i = 0;
    String str = bhnv.a(BaseApplication.getContext());
    if ("wifi".equals(str)) {
      i = 1;
    }
    for (;;)
        ...
        do
        {
          do
          {
            do
            {
              ...
              {
                return i;
                b(this.jdField_a_of_type_Lcd.jdField_a_of_type_JavaLangString.length());
                j = a(this.jdField_a_of_type_Lcd.jdField_a_of_type_JavaLangString);
                i = j;
              } while (j < 0);
              b(this.jdField_a_of_type_Lcd.jdField_b_of_type_JavaLangString.length());
              j = a(this.jdField_a_of_type_Lcd.jdField_b_of_type_JavaLangString);
              i = j;
            } while (j < 0);
            b(this.jdField_a_of_type_Lcd.jdField_c_of_type_JavaLangString.length());
            j = a(this.jdField_a_of_type_Lcd.jdField_c_of_type_JavaLangString);
            i = j;
          } while (j < 0);
          b(this.jdField_a_of_type_Lcd.f.length());
          j = a(this.jdField_a_of_type_Lcd.f);
          i = j;
        } while (j < 0);
        b(this.jdField_a_of_type_Lcd.d.length());
        j = a(this.jdField_a_of_type_Lcd.d);
        i = j;
      } while (j < 0);
      b(this.jdField_a_of_type_Lcd.e.length());
      j = a(this.jdField_a_of_type_Lcd.e);
      i = j;
    } while (j < 0);
    a(this.jdField_a_of_type_Lcd.jdField_c_of_type_Long);
    a(this.jdField_a_of_type_Lcd.jdField_a_of_type_Long);
    a(this.jdField_a_of_type_Lcd.jdField_a_of_type_Int);
    a(this.jdField_a_of_type_Lcd.jdField_b_of_type_Long);
    a(this.jdField_a_of_type_Lcd.jdField_b_of_type_Int);
    a(paramInt);
    return 0;
  }
  ...
  public static lcc a()
  {
    if (jdField_a_of_type_Lcc == null) {
      jdField_a_of_type_Lcc = new lcc();
    }
    return jdField_a_of_type_Lcc;
  }
  ...
  {
    lcc locallcc = a();
    locallcc.a(0L, paramLong1, paramLong2);
    locallcc.a(paramInt, 2, paramLong2);
  }
  ...
  public int a(int paramInt1, int paramInt2, long paramLong)
  {
    ...
    do
    {
      return paramInt2;
      int j = a();
      this.jdField_a_of_type_Lcd.e = jdField_a_of_type_ArrayOfJavaLangString[j];
      this.jdField_a_of_type_Lcd.d = a();
      this.jdField_a_of_type_Lcd.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_Lcd.jdField_b_of_type_Int = paramInt2;
      if (paramLong != 0L) {
        this.jdField_a_of_type_Lcd.jdField_b_of_type_Long = paramLong;
      }
      ...
      a(this.jdField_a_of_type_Lcd.jdField_a_of_type_Long, arrayOfByte);
      this.jdField_a_of_type_Int = 0;
      paramInt2 = i;
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    this.jdField_a_of_type_Lcd.jdField_b_of_type_Long = paramLong3;
    this.jdField_a_of_type_Lcd.jdField_a_of_type_Long = paramLong2;
    this.jdField_a_of_type_Lcd.jdField_c_of_type_Long = paramLong1;
    this.jdField_a_of_type_Lcd.jdField_c_of_type_JavaLangString = String.valueOf(AppSetting.a());
    this.jdField_a_of_type_Lcd.f = AppSetting.d();
  }
}
