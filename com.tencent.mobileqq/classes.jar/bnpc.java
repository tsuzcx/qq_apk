...
public class bnpc
{
  ...
  public bnpc(int paramInt1, int paramInt2, String paramString1, float paramFloat, boolean paramBoolean1, int paramInt3, double paramDouble1, double paramDouble2, String paramString2, int paramInt4, boolean paramBoolean2)
  {
    this.d = paramInt1;
    this.e = paramInt2;
  ...
  public bnpc(@NonNull Bitmap paramBitmap, @NonNull String paramString, int paramInt1, int paramInt2, int paramInt3, float paramFloat, double paramDouble1, double paramDouble2, int paramInt4)
  {
  ...
  private int a()
  {
    ...
    {
      return i;
      if (!yoy.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_a_of_type_JavaLangString))
      {
