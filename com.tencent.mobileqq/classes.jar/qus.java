...
public class qus
  extends qqt
{
  public qus(Context paramContext, aobu paramaobu, snh paramsnh)
  {
  ...
  public qqt a()
  {
    ...
    return a(this.jdField_a_of_type_Snh, this.jdField_a_of_type_Aobu).r().l().g().n().q().j().h();
  }
  ...
  public qqt d()
  {
    ...
    if (this.jdField_a_of_type_Qqs != null)
    {
      ...
      if ((this.jdField_a_of_type_Qqs instanceof ComponentContentBigImageVideo))
      {
        ...
        localLinearLayout3.setOnClickListener(new qut(this));
      }
    ...
    localLinearLayout2.setOnClickListener(new quu(this));
