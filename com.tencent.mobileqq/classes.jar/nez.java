  ...
  extends QIPCModule
{
  ...
  private static nez jdField_a_of_type_Nez;
  private static boolean jdField_a_of_type_Boolean;
  private anyu jdField_a_of_type_Anyu;
  private final ConcurrentHashMap<String, nfe> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(8);
  private nas jdField_a_of_type_Nas;
  private nfd jdField_a_of_type_Nfd;
  
  private nez(String paramString)
  {
    super(paramString);
  ...
  {
    if (this.jdField_a_of_type_Nfd == null) {
      this.jdField_a_of_type_Nfd = new nfd(this);
    }
    boolean bool = bdek.a(paramQQAppInterface, paramQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_Nfd);
    if (QLog.isColorLevel()) {
  ...
  public static nez a()
  {
    if (jdField_a_of_type_Nez == null) {}
    try
    {
      if (jdField_a_of_type_Nez == null) {
        jdField_a_of_type_Nez = new nez("AVGameServerIPCModule");
      }
      return jdField_a_of_type_Nez;
    }
    finally {}
  }
  ...
  private static void a()
  {
    ...
    QIPCServerHelper.getInstance().getServer().addListener(new nfb());
  }
  ...
  private void a(Bundle paramBundle, @NotNull QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    paramBundle = (mxc)paramQQAppInterface.getManager(373);
    if (paramBundle == null)
    {
  ...
  {
    nfe localnfe2 = (nfe)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    nfe localnfe1 = localnfe2;
    if (localnfe2 == null)
    {
      localnfe1 = new nfe();
      localnfe1.jdField_a_of_type_JavaLangString = paramString;
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localnfe1);
    }
    if ((paramInt >= 0) && (paramInt < localnfe1.jdField_a_of_type_ArrayOfBoolean.length)) {
      localnfe1.jdField_a_of_type_ArrayOfBoolean[paramInt] = true;
    }
    if ((paramQQAppInterface != null) && (this.jdField_a_of_type_Anyu == null) && ((paramInt == 1) || (paramInt == 0)))
    {
      this.jdField_a_of_type_Anyu = new nfc(this, paramQQAppInterface);
  ...
  {
    paramString = (nfe)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  ...
  private EIPCResult c(Bundle paramBundle, @NotNull QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        String str2 = bhlg.j(paramQQAppInterface, str1);
  ...
  private void c(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Nas == null) {
      this.jdField_a_of_type_Nas = new nfa(this);
    }
    ((mxc)paramQQAppInterface.getManager(373)).a().a(paramQQAppInterface, str1, str2, paramBundle, this.jdField_a_of_type_Nas);
  }
  ...
  private void d(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    ((mxc)paramQQAppInterface.getManager(373)).a().a(paramBundle);
  }
  
  private void e(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    paramBundle = paramBundle.getString("key_play_game_id");
    ((mxc)paramQQAppInterface.getManager(373)).a().b(paramBundle);
  }
