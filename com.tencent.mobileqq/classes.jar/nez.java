...
public class nez
{
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, String paramString2, long paramLong5, List<String> paramList, String paramString3, long paramLong6, int paramInt2, String paramString4, nfd paramnfd)
  {
    ...
    paramString1 = new NewIntent(paramQQAppInterface.getApplication(), mzx.class);
    paramString1.putExtra("cmd", "OidbSvc.0x79b_1");
    paramString1.putExtra("data", paramString2.toByteArray());
    paramString1.setObserver(new nfb(paramQQAppInterface, paramnfd));
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, nac paramnac)
  {
    ...
    mzy.b(paramQQAppInterface, paramnac, localReqBody.toByteArray(), "OidbSvc.0x6f6_0", 1782, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, nfc paramnfc)
  {
    ...
    localObject = new NewIntent(paramQQAppInterface.getApplication(), mzx.class);
    ((NewIntent)localObject).putExtra("cmd", "OidbSvc.0x79a_1");
    ((NewIntent)localObject).putExtra("data", localOIDBSSOPkg.toByteArray());
    ((NewIntent)localObject).setObserver(new nfa(paramQQAppInterface, paramnfc));
    paramQQAppInterface.startServlet((NewIntent)localObject);
  }
  
  private static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, nfc paramnfc)
  {
    try
    {
  ...
  private static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, nfd paramnfd)
  {
    try
    {
      paramQQAppInterface = new oidb_sso.OIDBSSOPkg();
      ...
      if ((paramQQAppInterface == null) || (!paramQQAppInterface.uint32_result.has()) || (paramQQAppInterface.uint32_result.get() != 0) || (!paramQQAppInterface.bytes_bodybuffer.has()) || (paramQQAppInterface.bytes_bodybuffer.get() == null))
      {
        paramnfd.a(paramQQAppInterface.str_error_msg.get());
        return;
      }
      paramnfd.a();
      return;
