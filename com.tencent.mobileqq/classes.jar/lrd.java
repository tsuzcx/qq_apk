...
public abstract class lrd
{
  ...
  public kvq a;
  ldf jdField_a_of_type_Ldf = new lre(this);
  public lzu a;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Lzu != null) {}
    for (TextView localTextView = this.jdField_a_of_type_Lzu.a();; localTextView = null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable == null) {
        this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable = new BaseGaInvite.GetGaFaceRunnable(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Ldf);
      }
  ...
  void a(boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "refreshUI, isMultiCall[" + mfs.b(this.jdField_b_of_type_Int) + "], multiIncomingCall[" + paramBoolean + "], mUinType[" + this.jdField_b_of_type_Int + "], mIsAudioMode[" + this.jdField_a_of_type_Boolean + "]");
    }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Lzu == null)
      {
        this.jdField_a_of_type_Lzu = new lzu(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext());
        this.jdField_a_of_type_Lzu.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_JavaLangString);
        localObject = new Date();
        localObject = new SimpleDateFormat("HH:mm").format((Date)localObject);
        this.jdField_a_of_type_Lzu.b((String)localObject);
        this.jdField_a_of_type_Lzu.a(this.jdField_a_of_type_Boolean, mfs.b(this.jdField_b_of_type_Int), paramBoolean);
        if (mfs.b(this.jdField_b_of_type_Int)) {
      ...
      if (this.jdField_a_of_type_Kvq != null)
      {
        ...
        if (this.jdField_a_of_type_Kvq.x == 1)
        {
          ...
          if (this.jdField_b_of_type_Int == 9500)
          {
            ...
            {
              localObject = this.jdField_a_of_type_Kvq.o;
              i = 0;
            }
          }
        }
      ...
      {
        if (this.jdField_a_of_type_Kvq != null) {
          this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Kvq.a();
        }
        if (QLog.isColorLevel()) {
