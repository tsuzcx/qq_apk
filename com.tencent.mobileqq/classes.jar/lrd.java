...
public class lrd
{
  ...
  private static lrd jdField_a_of_type_Lrd;
  ...
  public static lrd a()
  {
    if (jdField_a_of_type_Lrd == null) {
      jdField_a_of_type_Lrd = new lrd();
    }
    return jdField_a_of_type_Lrd;
  }
  ...
  public void a(lpx paramlpx, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      paramlpx = lqw.a(0);
      GLES20.glUseProgram(paramlpx.a());
      GLES20.glActiveTexture(33984);
      GLES20.glBindTexture(3553, this.g);
      GLES20.glUniform1i(paramlpx.a()[4].jdField_a_of_type_Int, 0);
      GLES20.glUniform1f(paramlpx.a()[2].jdField_a_of_type_Int, 1.0F);
    }
  }
  
  public void a(lpx paramlpx, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, float[] paramArrayOfFloat, int paramInt8, int paramInt9)
  {
    ...
    TextureProgram localTextureProgram = lqw.a(2);
    ...
    GLES20.glUniformMatrix4fv(arrayOflqy[1].jdField_a_of_type_Int, 1, false, AVGLUtils.matrixV, 0);
    ...
    GLES20.glClearColor(0.4F, 0.4F, 0.4F, 1.0F);
    GLES20.glClear(16640);
    localTextureProgram = lqw.a(3);
    arrayOflqy = localTextureProgram.a();
    GLES20.glUseProgram(localTextureProgram.a());
    GLES20.glUniform1f(localTextureProgram.a()[7].jdField_a_of_type_Int, paramInt1);
    GLES20.glUniform1f(localTextureProgram.a()[8].jdField_a_of_type_Int, paramInt2);
    GLES20.glUniformMatrix4fv(localTextureProgram.a()[9].jdField_a_of_type_Int, 1, false, paramArrayOfFloat, 0);
    ...
    a(paramlpx, paramInt1, paramInt2, paramInt5, paramInt6, paramInt7);
  }
}
