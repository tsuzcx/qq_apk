  ...
  implements Manager
{
  ...
  public bfas(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          for (;;)
          {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_public", "", "oper", "bottom_one", 0, 0, paramString, "", "", "");
            break;
            if (((ChatMessage)???.get(i)).shmsgseq > l) {
              ???.add(i, ???);
  ...
  public boolean a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: invokestatic 296	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifne +63 -> 69
    //   9: aload_1
    //   10: aload_0
    //   11: getfield 33	bfas:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   14: invokevirtual 301	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   17: ifeq +52 -> 69
    //   20: iconst_1
    //   21: istore_2
