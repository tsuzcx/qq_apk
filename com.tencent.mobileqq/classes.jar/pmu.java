...
public class pmu
{
  ...
  public static void a(Context paramContext, opw paramopw, ViewGroup.LayoutParams paramLayoutParams)
  {
    a(paramContext, paramopw, paramLayoutParams, null);
  }
  
  public static void a(Context paramContext, opw paramopw, ViewGroup.LayoutParams paramLayoutParams, View paramView)
  {
    ...
    paramLayoutParams.height = paramContext.getResources().getDimensionPixelSize(2131167453);
    int i = paramopw.a();
    int j = paramopw.b();
  ...
  public static void a(opw paramopw, RingAvatarView paramRingAvatarView, ImageView paramImageView)
  {
    if ((paramRingAvatarView == null) || (paramImageView == null) || (paramopw == null)) {}
    do
    {
      return;
      paramopw = paramopw.a();
  ...
  public static void a(pre parampre, ReadInJoyYAFolderTextView paramReadInJoyYAFolderTextView, pjg parampjg, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    if (obz.a(parampre))
    {
      List localList = parampre.jdField_a_of_type_Pqm.a;
      ...
      {
        parampre = paramSpannableStringBuilder.substring(1);
        localStringBuilder.append(parampre);
        ...
        parampre = babh.b((QQAppInterface)obz.a(), String.valueOf(l), true);
        paramSpannableStringBuilder = "@" + parampre;
        parampre = paramSpannableStringBuilder;
      ...
      {
        localStringBuilder.append(parampre).append(paramSpannableStringBuilder);
        paramSpannableStringBuilder = new pli();
        paramSpannableStringBuilder.jdField_a_of_type_Int = j;
        paramSpannableStringBuilder.b = (parampre.length() + j);
      ...
      label329:
      parampre = new SpannableStringBuilder(new axkd(localStringBuilder, 7, 16));
      paramSpannableStringBuilder = ((List)localObject).iterator();
      while (paramSpannableStringBuilder.hasNext())
      {
        localObject = (pli)paramSpannableStringBuilder.next();
        parampre.setSpan(new pji(((pli)localObject).jdField_a_of_type_Long, -3355444, parampjg), ((pli)localObject).jdField_a_of_type_Int, ((pli)localObject).b, 17);
      }
      localSpannableStringBuilder.append(parampre);
    }
    for (;;)
    {
      paramReadInJoyYAFolderTextView.setText(localSpannableStringBuilder);
      return;
      if (!TextUtils.isEmpty(parampre.jdField_a_of_type_JavaLangString)) {
        try
        {
          localSpannableStringBuilder.append(new axkd(awbk.b(parampre.jdField_a_of_type_JavaLangString), 7, 16));
        }
        catch (Exception parampre)
        {
          QLog.d("UtilsForComponent", 1, "parse bytes_comments failed ", parampre);
        }
      }
    }
  }
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      bool1 = bool2;
      if (!qoe.i(paramArticleInfo)) {
        if (!qoe.k(paramArticleInfo)) {
          break label36;
        }
      }
    }
  ...
  {
    return (qoe.a(paramArticleInfo) == 23) || (qoe.b(paramArticleInfo) == 56);
  }
