...
public class bgnu
{
  ...
  public static bgnu a(View paramView, TabBarInfo.ButtonInfo paramButtonInfo, TabBarInfo paramTabBarInfo)
  {
    bgnu localbgnu = new bgnu();
    localbgnu.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377552));
    localbgnu.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367808));
    localbgnu.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370591);
    localbgnu.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131370588);
    localbgnu.c = paramView.findViewById(2131370589);
    localbgnu.e = paramView.findViewById(2131370590);
    localbgnu.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370586));
    localbgnu.jdField_b_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.END);
    localbgnu.jdField_b_of_type_AndroidWidgetTextView.setMaxEms(3);
    localbgnu.jdField_b_of_type_AndroidWidgetTextView.setSingleLine();
    localbgnu.d = paramView;
    localbgnu.jdField_a_of_type_ComTencentQqminiSdkLauncherModelTabBarInfo = paramTabBarInfo;
    localbgnu.jdField_a_of_type_ComTencentQqminiSdkLauncherModelTabBarInfo$ButtonInfo = paramButtonInfo;
    return localbgnu;
  }
