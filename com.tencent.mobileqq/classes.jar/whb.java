  ...
  extends whv
{
  ...
  public whb(wgz paramwgz) {}
  
  public whb(wgz paramwgz, qqstory_service.RspFeedLikeList paramRspFeedLikeList, boolean paramBoolean)
  {
  ...
  public List<LikeEntry> a(qqstory_struct.FeedLikeInfo paramFeedLikeInfo)
  {
    ...
    while (i < paramFeedLikeInfo.size())
    {
      ...
      if (localwke.b(localLikeEntry.unionId) == null) {
        localArrayList2.add(new wkz("", localLikeEntry.unionId));
      }
      localArrayList1.add(localLikeEntry);
      i += 1;
    }
    if (!localArrayList2.isEmpty()) {
      new wrb().a(1, localArrayList2);
    }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Wgz.a.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.mLikeCount = localFeedLikeInfo.like_total_count.get();
    this.jdField_a_of_type_Wgz.a.jdField_a_of_type_JavaUtilList = localList;
    this.jdField_a_of_type_Wgz.a.jdField_a_of_type_Wje.a(localList, this.jdField_a_of_type_Wgz.c, this.jdField_a_of_type_Boolean, true);
    this.jdField_a_of_type_Wgz.a.a(localList);
  }
  
  public void a(int paramInt, Bundle paramBundle)
  {
    this.jdField_a_of_type_Wgz.a.c();
