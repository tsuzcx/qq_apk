  ...
  extends anud
{
  ...
  aohh(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718186);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718187);
    this.c = paramQQAppInterface.getApplication().getString(2131718184);
    this.d = paramQQAppInterface.getApplication().getString(2131718188);
    this.f = paramQQAppInterface.getApplication().getString(2131718182);
    this.g = paramQQAppInterface.getApplication().getString(2131718180);
    this.h = paramQQAppInterface.getApplication().getString(2131718183);
    this.e = paramQQAppInterface.getApplication().getString(2131718185);
    this.i = paramQQAppInterface.getApplication().getString(2131718181);
  }
  ...
  private String a(boolean paramBoolean, long paramLong, int paramInt, String paramString)
  {
    ...
    if (paramInt != 1006) {
      if (paramBoolean)
      {
        ...
        localbkgt = (bkgt)this.app.getManager(165);
        if ((localbkgt != null) && ((localbkgt.a(paramString)) || (localbkgt.f(paramString)))) {
          break label298;
        }
        str = this.d;
      }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((axad)this.app.getManager(16)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        if (k == 1006) {
          localObject = bhlg.f(this.app, String.valueOf(l1));
        }
        ...
        {
          localMessageRecord = bcry.a(-2012);
          localMessageRecord.init(str1, (String)localObject, str1, str2, l2, 0, k, 0L);
          localMessageRecord.msgtype = -2012;
          localMessageRecord.isread = true;
          localObject = this.app.a().b((String)localObject, k);
          if ((localObject == null) || (((List)localObject).size() <= 0) || (!adak.a((MessageRecord)((List)localObject).get(((List)localObject).size() - 1), localMessageRecord, false))) {
            break label297;
          }
          if (QLog.isColorLevel()) {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      break;
      this.app.a().a(localArrayList, String.valueOf(str1), false);
      return;
    }
  }
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    long l1 = bhvd.a(arrayOfByte1, 0);
    long l2 = bhvd.a(arrayOfByte1, 4);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (axad)this.app.getManager(16);
    int j = 0;
  ...
  private byte[] a(sso2sns_comm_info.Sso2SnsCommInfo paramSso2SnsCommInfo, sso2sns_0x3_blocklist.ReqBody paramReqBody)
  {
    ...
    bhvd.a(arrayOfByte1, 0, l1);
    bhvd.a(arrayOfByte2, 0, l2);
  ...
  private void d()
  {
    ...
    ((axad)this.app.getManager(16)).a(localArrayList);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1006)
    {
      paramString = bhlg.e(this.app, paramString);
