...
public class aohh
  implements aoil
{
  public aohh(ConditionSearchFriendActivity paramConditionSearchFriendActivity) {}
  
  public void a()
  {
    if ((this.a.i == 0) && (this.a.f > this.a.g) && (this.a.g != 0)) {
      QQToast.a(this.a, this.a.getResources().getString(2131691068), 0).b(this.a.getTitleBarHeight());
    }
    while ((this.a.jdField_a_of_type_Bhuf == null) || (!this.a.jdField_a_of_type_Bhuf.isShowing())) {
      return;
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.i == 0)
    {
      ...
      default: 
        ...
        localObject = this.a.jdField_a_of_type_Alpy.a(this.a.jdField_b_of_type_Int, this.a.jdField_c_of_type_Int);
    ...
    do
    {
      ...
      if (this.a.i == 3)
      {
        ...
        this.a.d = paramInt1;
        this.a.e.setRightText(alpy.c[paramInt1]);
        return;
      }
      switch (paramInt1)
      {
      ...
      while (this.a.i == 1)
      {
        this.a.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(this.a.jdField_a_of_type_Alpy.c(ConditionSearchFriendActivity.a(this.a)));
        return;
    ...
    this.a.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(this.a.jdField_a_of_type_Alpy.c(ConditionSearchFriendActivity.a(this.a)));
  }
}
