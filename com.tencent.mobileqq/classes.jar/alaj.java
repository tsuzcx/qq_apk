...
public class alaj
{
  ...
  public long a;
  private alak jdField_a_of_type_Alak = new alak();
  ...
  public alak a(int paramInt1, int paramInt2)
  {
    if (this.jdField_f_of_type_Boolean)
    {
      ...
      localObject2 = new alak();
      ((alak)localObject2).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((alak)localObject2).a("CAMERA_MATRIX", arrayOfFloat2);
      ((alak)localObject2).a("CAMERA_POSITION", localObject1);
      ((alak)localObject2).a("POSE", arrayOfFloat1);
      return localObject2;
    }
    if (paramInt1 == 100)
    {
      ...
      ((alak)localObject2).a("CAMERA_POSITION", localObject1);
      ((alak)localObject2).a("POSE", arrayOfFloat1);
      ((alak)localObject2).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject2;
    }
    if (paramInt1 == 8)
    {
      localObject1 = new alak();
      this.jdField_b_of_type_Int = 1;
      arrayOfFloat1 = new float[jdField_a_of_type_Int];
      arrayOfFloat2 = new float[jdField_a_of_type_Int];
      ...
      Matrix.setIdentityM(arrayOfFloat1, 0);
      ((alak)localObject1).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((alak)localObject1).a("CAMERA_MATRIX", localObject2);
      ((alak)localObject1).a("CAMERA_POSITION", arrayOfFloat1);
      ((alak)localObject1).a("POSE", arrayOfFloat2);
      ((alak)localObject1).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject1;
    }
    ...
    if ((this.jdField_h_of_type_Boolean) && (((paramInt2 == 0) && (!this.jdField_c_of_type_Boolean)) || (paramInt2 == 2) || ((paramInt2 == 1) && (!this.jdField_d_of_type_Boolean))))
    {
      ...
      localalak = new alak();
      localalak.a("TARGET_SIZE", localObject1);
      localalak.a("CAMERA_MATRIX", localObject2);
      localalak.a("CAMERA_POSITION", arrayOfFloat1);
      localalak.a("POSE", arrayOfFloat2);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Alak.a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
    this.jdField_a_of_type_Alak.a("POSE", arrayOfFloat1);
    this.jdField_a_of_type_Alak.a("CAMERA_MATRIX", arrayOfFloat2);
    this.jdField_a_of_type_Alak.a("CAMERA_POSITION", arrayOfFloat3);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
  }
  
  public void a(int paramInt1, int paramInt2, aldy paramaldy)
  {
    ...
    float f3;
    if (paramInt2 == 0) {
      if ((paramaldy.jdField_a_of_type_Int == 0) || (paramaldy.jdField_b_of_type_Int == 0))
      {
        this.k[0] = allg.jdField_a_of_type_Int;
        this.k[1] = allg.jdField_b_of_type_Int;
        paramaldy = new float[jdField_a_of_type_Int];
        Matrix.setIdentityM(paramaldy, 0);
        Matrix.perspectiveM(paramaldy, 0, 45.0F, 1.0F * allg.jdField_b_of_type_Int / allg.jdField_a_of_type_Int, 100.0F, 8000.0F);
        float[] arrayOfFloat = new float[16];
        Matrix.setRotateM(arrayOfFloat, 0, 270.0F, 0.0F, 0.0F, 1.0F);
        Matrix.multiplyMM(this.l, 0, arrayOfFloat, 0, paramaldy, 0);
        if (paramInt2 != 0) {
          break label659;
        }
        f1 = 1.25F;
        if (this.k[0] <= allg.jdField_a_of_type_Int) {
          break label665;
        }
        f2 = this.k[0];
        if (this.k[0] == 0.0F) {
        ...
        f3 = this.k[1] / this.k[0] / (1.0F * allg.jdField_b_of_type_Int / allg.jdField_a_of_type_Int);
        label233:
        if ((f3 <= 1.0F) || (this.k[1] <= allg.jdField_b_of_type_Int)) {
          break label680;
        }
        f1 *= f3;
      }
    ...
    for (;;)
    {
      ...
      paramaldy = new float[jdField_a_of_type_Int];
      Matrix.setIdentityM(paramaldy, 0);
      Matrix.translateM(paramaldy, 0, this.k[1] / 2.0F, -this.k[0] / 2.0F, -f2 / 2.0F * 2.414214F * f1);
      Matrix.rotateM(paramaldy, 0, 90.0F, 0.0F, 0.0F, 1.0F);
      System.arraycopy(paramaldy, 0, this.m, 0, jdField_a_of_type_Int);
      ...
      System.arraycopy(this.n, 0, this.j, 0, jdField_a_of_type_Int);
      return;
      this.k[0] = paramaldy.jdField_a_of_type_Int;
      this.k[1] = paramaldy.jdField_b_of_type_Int;
      break;
  ...
  public void a(alah paramalah)
  {
    ...
    paramalah = (alaf)paramalah;
    this.jdField_c_of_type_Int = paramalah.jdField_a_of_type_Int;
    this.jdField_g_of_type_ArrayOfFloat[0] = paramalah.jdField_a_of_type_Float;
    this.jdField_g_of_type_ArrayOfFloat[1] = paramalah.jdField_b_of_type_Float;
    System.arraycopy(paramalah.jdField_b_of_type_ArrayOfFloat, 0, this.jdField_h_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    System.arraycopy(paramalah.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_i_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
    System.arraycopy(paramalah.jdField_a_of_type_ArrayOfFloat, 0, this.j, 0, jdField_a_of_type_Int);
  }
  
  public void a(boolean paramBoolean, alag paramalag)
  {
    QLog.i("AREngine_ARRenerArumentManager", 1, "start. trackMode = " + paramalag.jdField_b_of_type_Int + ", arType = " + paramalag.jdField_a_of_type_Int + ", isObjectAnim = " + paramBoolean);
    this.jdField_f_of_type_Boolean = paramBoolean;
    this.jdField_b_of_type_Int = paramalag.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramalag.jdField_c_of_type_Int;
    this.jdField_h_of_type_Boolean = false;
    if ((this.jdField_f_of_type_Boolean) || (paramalag.jdField_a_of_type_Int == 100) || (paramalag.jdField_a_of_type_Int == 8))
    {
      this.jdField_g_of_type_Boolean = true;
      return;
    }
    Object localObject;
    if (paramalag.jdField_a_of_type_Int == 0)
    {
      localObject = (alas)paramalag;
      a(this.jdField_b_of_type_Int, paramalag.jdField_a_of_type_Int, ((alas)localObject).a);
    }
    for (;;)
    {
      this.jdField_g_of_type_Boolean = true;
      return;
      if ((paramalag.jdField_a_of_type_Int == 2) || (paramalag.jdField_a_of_type_Int == 3))
      {
        localObject = (albb)paramalag;
        a(this.jdField_b_of_type_Int, paramalag.jdField_a_of_type_Int, ((albb)localObject).a);
      }
      else if (paramalag.jdField_a_of_type_Int == 4)
      {
        localObject = (albe)paramalag;
        a(this.jdField_b_of_type_Int, paramalag.jdField_a_of_type_Int, ((albe)localObject).a);
      }
    }
  }
