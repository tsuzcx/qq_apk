...
public class bigp
  extends bigw
  implements agmh, View.OnClickListener, View.OnTouchListener, avti, avuj, avuk, bjrm, bkww
{
  protected int a;
  ...
  public bigp(bjrl parambjrl, bjrk parambjrk)
  {
    ...
    this.jdField_a_of_type_JavaLangString = ajya.a(2131709776);
  ...
  public void T()
  {
    this.d = bkvi.a(this.jdField_a_of_type_AndroidWidgetLinearLayout, this.jdField_b_of_type_AndroidWidgetRelativeLayout, bbll.a(1.0F));
  ...
  public View a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Bjrl.a().getLayoutInflater().inflate(a(), (ViewGroup)localObject, false).findViewById(2131366493);
    bkpu.a("onCreateView1");
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView = ((CameraCaptureView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363832));
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363294));
      this.d = bkvi.a(this.jdField_a_of_type_AndroidWidgetLinearLayout, this.jdField_b_of_type_AndroidWidgetRelativeLayout, bbll.a(1.0F));
      if (QLog.isColorLevel()) {
        QLog.i("QIMCameraCaptureUnit", 1, "initLiuHaiScreenUI_Common mEnableLHLayout:" + this.d);
      }
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364029));
      ...
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364897));
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetButton.setSelected(false);
      this.jdField_c_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363851));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363856));
      u();
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131372846);
      ...
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bjrl.a().getIntent().getBooleanExtra("enable_local_video", true);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369524));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130848254);
      int i1 = actj.a(36.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ((Drawable)localObject).setBounds(0, 0, i1, i1);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_Avsx = new avsx(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView);
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363887));
  ...
  {
    if (axkt.n()) {
      return bkvg.a().a(this.jdField_a_of_type_Bjrl.a());
    }
    return bkvg.a().b(this.jdField_a_of_type_Bjrl.a());
  }
  ...
  public void a(Activity paramActivity)
  {
    for (;;)
    {
      try
      {
        ...
        c(localIntent);
        vzh.a(localIntent, paramActivity.getIntent().getExtras(), paramActivity);
        localIntent.putExtra("from_qqstory", true);
        localIntent.putExtra("edit_video_type", this.jdField_a_of_type_Bjrd.a());
        ...
        localIntent.putExtra("video_refer", this.jdField_a_of_type_Bjrd.a());
        ...
        localIntent.putExtra("entrance_type", this.jdField_a_of_type_Bjrd.c());
        ...
        localObject = (SessionWrap)this.jdField_a_of_type_Bjrl.a().getIntent().getParcelableExtra("ARG_SESSION_INFO");
        if (localObject != null)
        {
          ...
          str = this.jdField_a_of_type_Bjrl.a().getIntent().getStringExtra("f_a_a_n");
          if ((str != null) && (str.equals(ChatActivity.class.getName())))
          {
            ...
            localIntent.putExtra("key_activity_code", this.jdField_a_of_type_Bjrl.a().getIntent().getStringExtra("key_activity_code"));
      ...
      {
        ved.b("QIMCameraCaptureUnit", "QQStoryFlowCallback ", paramActivity);
        return;
      }
    }
  }
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    try
    {
      ...
      localIntent.putExtra("qq_sub_business_id", this.jdField_a_of_type_Bjrd.b());
      localIntent.putExtra("edit_video_type", this.jdField_a_of_type_Bjrd.a());
      b(localIntent);
    ...
    {
      ved.b("QIMCameraCaptureUnit", "intentToPhotoList ", paramActivity);
    }
  }
  ...
  {
    super.a(paramBundle);
    this.jdField_b_of_type_Long = this.jdField_a_of_type_Bjrl.a().getIntent().getLongExtra("ACTIVITY_START_TIME", -1L);
    if (paramBundle != null) {
    ...
    this.jdField_a_of_type_Bjrl.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, a());
    avtp.a();
  }
  ...
  protected void a(List<CameraCaptureView.VideoCaptureResult> paramList, List<LocalMediaInfo> paramList1)
  {
    ...
    if ((!this.o) || (paramList.size() == 1))
    {
      ...
      agmg.a(BaseApplicationImpl.getContext()).a(new bigv(this), this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
      return;
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    avtp.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a();
  }
  ...
  public void d(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bigy = ((bigy)bjav.a().c(13));
      this.jdField_a_of_type_Bigy.a(paramBoolean);
      AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
      if ((localAppRuntime instanceof AppInterface)) {
        localAppRuntime.notifyObservers(bjdt.class, 7, false, null);
      }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    label41:
    g();
    float f1 = vzl.a(this.jdField_a_of_type_Bjrl.a(), 90.0F);
    ArrayList localArrayList = new ArrayList();
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      localArrayList.add(new bjjs(this.jdField_a_of_type_AndroidWidgetFrameLayout, "translationY", 0.0F, f1, 450L, 0L));
      localArrayList.add(new bjjs(this.jdField_a_of_type_AndroidWidgetFrameLayout, "alpha", 1.0F, 0.0F, 450L, 0L));
    }
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      localArrayList.add(new bjjs(this.jdField_a_of_type_AndroidViewViewGroup, "translationY", f1, 0.0F, 450L, 0L));
      localArrayList.add(new bjjs(this.jdField_a_of_type_AndroidViewViewGroup, "alpha", 0.0F, 1.0F, 450L, 0L));
    ...
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        localArrayList.add(new bjjs(localView, "translationY", f1, 0.0F, 450L, 0L));
        localArrayList.add(new bjjs(localView, "alpha", 0.0F, 1.0F, 450L, 0L));
        localView.setAlpha(0.0F);
      }
    }
    bjjp.a(localArrayList, new bigr(this));
  }
  ...
  protected void i()
  {
    ...
    agmg.a(BaseApplicationImpl.getContext()).a(this, this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131364029: 
      ...
      {
        avtp.f();
        vei.a("clk_switch", this.jdField_a_of_type_Bjrd.a(), 0, new String[0]);
        return;
        this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidWidgetButton.getResources().getString(2131718778));
      }
    case 2131366361: 
      ...
      {
        avtd.d(i1);
        vei.a("clk_flash", this.jdField_a_of_type_Bjrd.a(), 0, new String[0]);
        bizt.a().l();
        return;
        bool = false;
        break;
    ...
    case 2131364897: 
      bjkv.a(this.jdField_c_of_type_AndroidWidgetButton, 200L, null);
    ...
    bjkv.a(this.jdField_a_of_type_AndroidWidgetImageView, 200L, null);
    paramView = new axty();
    paramView.d = "0X800822E";
    axqu.a(null, paramView);
    vei.a("clk_local", this.jdField_a_of_type_Bjrd.a(), 0, new String[0]);
    ...
    if (Build.VERSION.SDK_INT >= 17)
    {
      vtz.a().c(21);
      vtz.a().b(11);
      a(this.jdField_a_of_type_Bjrl.a(), true);
      return;
    }
    a(this.jdField_a_of_type_Bjrl.a());
  }
  ...
  protected void u()
  {
    this.jdField_b_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363880));
    ...
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraSegmentCaptureButtonLayout = ((QIMCameraSegmentCaptureButtonLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131375789));
  ...
  public void v()
  {
    ...
    localLayoutParams.bottomMargin = actj.a(-30.0F, this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout.getResources());
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      localLayoutParams.bottomMargin = actj.a(50.0F, this.jdField_a_of_type_AndroidWidgetImageView.getResources());
  ...
  public void x()
  {
    ...
    for (;;)
    {
      vei.a("clk_cancel", vei.b(this.jdField_a_of_type_Bjrd.a()), 0, new String[0]);
      return;
  ...
  public void z()
  {
    ...
    this.jdField_a_of_type_Bbgu = bbdj.a(localActivity, 230).setMessage(str).setPositiveButton(localActivity.getString(2131694088), new bigu(this));
  }
}
