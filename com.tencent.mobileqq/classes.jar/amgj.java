...
public class amgj
  extends BaseAdapter
{
  adqi jdField_a_of_type_Adqi;
  Context jdField_a_of_type_AndroidContentContext;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener;
  public ArrayList<Object> a;
  View.OnClickListener b;
  
  public amgj(Context paramContext, ArrayList<Object> paramArrayList, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, adqi paramadqi)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof amgk)))
      {
        localObject1 = (amgk)paramView.getTag();
        ((amgk)localObject1).jdField_a_of_type_JavaLangObject = localObject2;
        ((amgk)localObject1).jdField_a_of_type_JavaLangString = ((adqg)this.jdField_a_of_type_Adqi).c;
        if (!(localObject2 instanceof MessageForStructing)) {
          break label336;
        }
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && ((((MessageForStructing)localObject2).structingMsg instanceof AbsShareMsg)))
        {
          ...
          a(((amgk)localObject1).jdField_a_of_type_ComTencentImageURLImageView, localAbsShareMsg);
          ((amgk)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(a(localAbsShareMsg, "title"));
          ((amgk)localObject1).b.setText(localAbsShareMsg.mSourceName);
        }
        label153:
        if (!this.jdField_a_of_type_Adqi.b()) {
          break label361;
        }
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Adqi.a.a((ChatMessage)localObject2));
      }
      for (;;)
      {
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localObject1 = new amgk(this);
        paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562898, null);
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376269));
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131378122));
        ((amgk)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131378120));
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363771));
        ((amgk)localObject1).b = ((TextView)paramView.findViewById(2131371658));
        paramView.setTag(localObject1);
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject1);
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        break;
        label336:
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("");
        ((amgk)localObject1).b.setText("");
        break label153;
        label361:
        ((amgk)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(8);
      }
    }
    ...
    for (;;)
    {
      ...
      break;
      label427:
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131562899, null);
