...
public class amgj
{
  ...
  public static amgj a()
  {
    try
    {
      if (jdField_a_of_type_Amgj == null) {
        jdField_a_of_type_Amgj = new amgj();
      }
      amgj localamgj = jdField_a_of_type_Amgj;
      return localamgj;
    }
    finally {}
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    {
      return;
      localamir = (amir)paramQQAppInterface.getManager(155);
      localObject1 = localamir.a(paramSessionInfo);
    ...
    if (i >= 0)
    {
      ...
      ApolloGameData localApolloGameData = localamir.a(((MessageForApollo)localObject1).gameId);
      if ((localApolloGameData == null) || (!amio.a("8.4.8", localApolloGameData.minVer, localApolloGameData.maxVer))) {
        break label262;
      }
    }
    label262:
        ...
        do
        {
          do
          {
            do
            {
              ...
              localObject1 = localamir.a(((MessageForApollo)localObject1).gameId);
            } while ((localObject1 != null) && (amio.a("8.4.8", ((ApolloGameData)localObject1).minVer, ((ApolloGameData)localObject1).maxVer)));
            paramQQAppInterface = ((amaz)paramQQAppInterface.getManager(249)).a();
