  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener
{
  ...
  public awie(int paramInt, boolean paramBoolean)
  {
    super(paramInt);
    ...
    for (String str1 = this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchSpecialDataModel.a.title;; str1 = "")
    {
      ...
      for (String str2 = "hotword";; str2 = "title")
      {
        ...
        for (;;)
        {
          ...
          awwa.a("hot_list", "clk_hot_event_list", new String[] { str5, str1, str3, str2 });
          paramString = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
          awsq.a(null, new ReportModelDC02528().module("hot_list").action("clk_hot_event_list").ver2(str5).ver3(str1).ver4(str3).ver5(str2).ver7(localJSONObject.toString()).session_id(paramString.getCurrentAccountUin() + this.jdField_a_of_type_Long));
          return;
  ...
  public View a(Context paramContext, QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (paramViewGroup = ((BaseActivity)paramContext).getAppRuntime();; paramViewGroup = null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131560584, null);
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370437));
      ...
      this.jdField_a_of_type_Awig = new awig(this, paramContext, LayoutInflater.from(paramContext));
      this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(this.jdField_a_of_type_Awig);
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131369630));
  ...
  public void a(GridView paramGridView)
  {
    ...
    ((ViewGroup.LayoutParams)localObject).height = (actj.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + j);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      if (this.jdField_a_of_type_Int == 10) {
        str = awvx.a(paramString2, 5, "kandian_hotword");
      }
    }
    else
    {
      ...
      paramString1 = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, str);
    ...
    while (!QLog.isColorLevel())
    {
      ...
      {
        return;
        str = awvx.a(paramString2, 5, "hotword");
        break;
  ...
  {
    HotWordSearchSpecialDataModel localHotWordSearchSpecialDataModel = (HotWordSearchSpecialDataModel)paramawpp;
    ...
    if ((localHotWordSearchSpecialDataModel.a.topicItems != null) && (localHotWordSearchSpecialDataModel.a.topicItems.size() > 0))
    {
      ...
      this.jdField_a_of_type_Awig.a(localHotWordSearchSpecialDataModel.a.topicItems);
      a(this.jdField_a_of_type_AndroidWidgetGridView);
      this.jdField_a_of_type_Awig.notifyDataSetChanged();
      ...
      label159:
      paramawpp = new ColorDrawable();
      if (!ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime())) {
        break label601;
      }
      paramawpp.setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167111));
      label196:
      if (TextUtils.isEmpty(localHotWordSearchSpecialDataModel.a.leftIconUrl)) {
        break label621;
      }
      localObject1 = URLDrawable.URLDrawableOptions.obtain();
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = paramawpp;
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = paramawpp;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        TextView localTextView = (TextView)((View)localObject1).findViewById(2131365017);
        j = (vzl.a(this.jdField_a_of_type_AndroidContentContext) - vzl.a(this.jdField_a_of_type_AndroidContentContext, 59.0F)) / 4;
        int m = j * 60 / 79;
        ...
        localURLDrawableOptions.mLoadingDrawable = paramawpp;
        localURLDrawableOptions.mFailedDrawable = paramawpp;
        ...
        ((View)localObject1).setVisibility(0);
        ((View)localObject1).setOnClickListener(new awif(this, (HotWordSearchSpecialDataModel.TopicImage)localObject2));
        i += 1;
      }
      ...
      break label159;
      label601:
      paramawpp.setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167110));
      break label196;
      label621:
    ...
    else
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = paramawpp;
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = paramawpp;
      paramawpp = URLDrawable.getDrawable(localHotWordSearchSpecialDataModel.a.iconUrl, (URLDrawable.URLDrawableOptions)localObject1);
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramawpp);
    ...
    for (;;)
    {
      try
      {
        paramawpp = (Boolean)SearchEntryFragment.a.get(Integer.valueOf(5));
        if ((paramawpp != null) && (paramawpp.booleanValue())) {
          break;
        }
        if (this.jdField_a_of_type_Int == 3)
        {
          i = 21;
          localObject1 = awsq.a(i);
        ...
        awwa.a("hot_list", "exp_hot_event_list", new String[] { localObject1, localHotWordSearchSpecialDataModel.a.title, ((StringBuilder)localObject2).toString() });
        SearchEntryFragment.a.put(Integer.valueOf(5), Boolean.valueOf(true));
        localObject3 = new JSONObject();
      }
      catch (Exception paramawpp) {}
      try
      {
        ...
        paramawpp = "word";
        ((JSONObject)localObject3).put("template", paramawpp);
      }
      catch (JSONException paramawpp)
      {
        QLog.e("Q.uniteSearch.HotWordSearchSpecialEntryModel", 2, "e = " + paramawpp);
        continue;
      }
      paramawpp = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      awsq.a(null, new ReportModelDC02528().module("hot_list").action("exp_hot_event_list").ver2((String)localObject1).ver3(localHotWordSearchSpecialDataModel.a.title).ver4(((StringBuilder)localObject2).toString()).ver7(((JSONObject)localObject3).toString()).session_id(paramawpp.getCurrentAccountUin() + this.jdField_a_of_type_Long));
      return;
  ...
  public void onClick(View paramView)
  {
    ...
    a(true, "");
    ((akgc)((QQAppInterface)onh.a()).getManager(299)).a(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchSpecialDataModel.a.title);
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (paramInt < this.jdField_a_of_type_Awig.a().size())
    {
      paramAdapterView = (HotWordSearchSpecialDataModel.TopicItem)this.jdField_a_of_type_Awig.a().get(paramInt);
      if (!TextUtils.isEmpty(paramAdapterView.title))
      {
        ...
        ((akgc)((QQAppInterface)onh.a()).getManager(299)).a(paramAdapterView.title);
      }
    }
  }
}
