  ...
  implements uyo<uyd>
{
  ...
  private vaz(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new vba(this));
    ...
    localAlphaAnimation.setAnimationListener(new vbb(this));
    if (paramBoolean2) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Vau != null) {
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Vau.b((Animation)localObject);
      }
      return;
    }
  }
  
  public boolean a(uyd paramuyd, MotionEvent paramMotionEvent)
  {
    vja localvja = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_ComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.a();
    if (localvja != null) {}
    int i;
    int j;
    switch (localvja.jdField_a_of_type_Int)
    {
    default: 
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          i = localvja.jdField_b_of_type_Int;
          if (i != vbv.jdField_a_of_type_Int) {
          ...
          for (;;)
          {
            localObject = (vbv)paramuyd.a(101);
            if (localObject != null) {
              ((vbv)localObject).a(i);
            }
            if (paramuyd.b()) {
          ...
          paramuyd.a((AppInterface)localObject, 2, localvja.jdField_b_of_type_Int);
          break;
