...
public class afxr
  extends afwh
  implements aftj, View.OnClickListener
{
  int jdField_a_of_type_Int;
  afyl jdField_a_of_type_Afyl;
  ...
  public afxr(FragmentActivity paramFragmentActivity)
  {
  ...
  public int a()
  {
    return this.jdField_a_of_type_Afyl.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_Int];
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)a(2131376281));
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager = ((QQViewPager)a(2131364066));
    this.jdField_a_of_type_Afyl = new afyl();
    int[] arrayOfInt1 = a();
    int[] arrayOfInt2 = b();
    if ((arrayOfInt1 != null) && (arrayOfInt2 != null))
    {
      this.jdField_a_of_type_Afyl.a(a(), arrayOfInt1, arrayOfInt2);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Afyl.jdField_a_of_type_ArrayOfJavaLangString, arrayOfInt1);
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setOnTabListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryViewPagerAdapter = new ChatHistoryViewPagerAdapter(a(), a(), this, this.jdField_a_of_type_Afyl, this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager.setOnPageChangeListener(new afxs(this));
    c(0);
  }
  ...
  public void e()
  {
    if (this.c == 2)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131690000);
      this.c = 1;
      if (this.jdField_a_of_type_Afyk != null) {
        this.jdField_a_of_type_Afyk.c();
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      this.c = 1;
      return;
    } while (this.jdField_a_of_type_Afyk == null);
    this.jdField_a_of_type_Afyk.a();
  }
}
