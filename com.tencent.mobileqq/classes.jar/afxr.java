...
public class afxr
  implements akse
{
  public afxr(CustomizeStrategyFactory.PanelStrategy.1 param1) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      Bitmap localBitmap = SafeBitmapFactory.decodeFile(paramPathResult, bgmo.a(paramPathResult, (int)(CustomizeStrategyFactory.a * 50.0F + 0.5D)));
      if (localBitmap != null) {
