...
{
  bhyn jdField_a_of_type_Bhyn = new anrw(this);
  private bhyq jdField_a_of_type_Bhyq;
  public QQAppInterface a;
  
  anrv(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    ((awyr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(paramString, paramInt1, "", paramInt2, 0);
    if (QLog.isColorLevel()) {
      QLog.d("ClubContentUpdateHandler", 2, "small emotion has update info.");
    }
    bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), "small_emosm_update_flag" + paramString, paramInt1);
  }
  
  private void a(int paramInt, bhlr parambhlr)
  {
    if (Math.abs(paramInt - bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambhlr.d)) > 5)
    {
      if (QLog.isColorLevel()) {
        QLog.i("ClubContentUpdateHandler", 2, "New version json found!");
      }
      if (this.jdField_a_of_type_Bhyq == null) {
        this.jdField_a_of_type_Bhyq = ((bhyq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DOWNLOADER_FACTORY));
      }
      File localFile = new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambhlr.a);
      Bundle localBundle = new Bundle();
      localBundle.putInt("version", paramInt);
      localBundle.putString("json_name", parambhlr.d);
      parambhlr = new bhyo(parambhlr.b, localFile);
      this.jdField_a_of_type_Bhyq.a(1).a(parambhlr, this.jdField_a_of_type_Bhyn, localBundle);
    }
  }
  ...
  private void a(String paramString1, int paramInt1, String paramString2, int paramInt2, Map<String, Integer> paramMap, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (!paramString1.equals(bhln.a.e)) {
            break;
          }
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentUpdateHandler", 2, "func updateEmojiJson, sEPPromotionTask!");
          }
          paramInt2 = bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bhln.a.d);
        } while (paramInt1 <= paramInt2);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
        bhln.a(MobileQQ.getContext(), bhln.a.d, paramInt2);
        ...
        ((antu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.HANDLER_EMOSM)).a();
      ...
      ((awyr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).b(paramString1.replace("_json", "").trim(), paramInt1, paramString2, paramInt2, 0);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("ClubContentUpdateHandler", 2, "func updateEmojiJson, update emoji package!");
      }
      ((awyr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(paramString1, paramInt1, paramString2, paramInt2, 0);
  ...
  private boolean a(int paramInt, bhlr parambhlr, boolean paramBoolean)
  {
    int i = bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambhlr.d);
    if (QLog.isColorLevel()) {
      QLog.d("ClubContentUpdateHandler", 2, "updateResJson name = " + parambhlr.e + " localVersion = " + i + " version = " + paramInt);
    }
    if (paramInt > i)
    {
      bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, parambhlr, paramInt, paramBoolean);
      return true;
    }
    return false;
  }
  ...
  private void b(int paramInt1, String paramString, int paramInt2)
  {
    ...
    case 201: 
      do
      {
        ...
        if ((!amme.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (localamme == null) || (1 != localamme.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()))) {
          break;
        }
    ...
    case 205: 
      ...
      angv.a(null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt2, false);
      return;
    case 202: 
  ...
  private void b(String paramString, int paramInt)
  {
    try
    {
      ...
      if ((amme.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) && (localamme != null) && (1 == localamme.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin())))
      {
        ...
        long l = localamme.a(2, i) / 1000L;
        if (l != paramInt)
        {
          anex.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), null, -1, new int[] { i }, -1, -1, true);
  ...
  {
    if (aozm.a().equals(paramString))
    {
      paramString = (amme)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER);
      if ((!amme.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (paramString == null) || (1 != paramString.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()))) {
        break label181;
      }
      if ((aozm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.APOLLO_CONTENT_UPDATE_HANDLER) != null)
      {
        long l = aozm.b();
        if (l != paramInt)
        {
          paramString = anka.I + "base.zip";
          Bundle localBundle = new Bundle();
          localBundle.putLong("version", paramInt);
          anex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, anka.G, localBundle, new aozo());
        }
  ...
  private void g(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      if (!str1.equals(bhln.b.e)) {}
    }
  }
  
  protected ClubContentUpdateInfoPb.ReqAppInfo a()
  {
    Object localObject = ((awyr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER)).a(0);
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo a(bhlr parambhlr, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    ClubContentUpdateInfoPb.ReqItemInfo localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
    localReqItemInfo.str_name.set(parambhlr.e);
    localReqItemInfo.uint_version.set(bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambhlr.d));
    localArrayList.add(localReqItemInfo);
    parambhlr = new ClubContentUpdateInfoPb.ReqAppInfo();
    parambhlr.uint_appid.set(paramInt);
    parambhlr.rpt_msg_reqiteminfo.set(localArrayList);
    parambhlr.setHasFlag(true);
    return parambhlr;
  }
  ...
  public void a()
  {
    ...
    localArrayList.add(b(bhln.c, 7));
    localArrayList.add(a(bhln.e, 105));
    localArrayList.add(b(bhln.f, 11));
    localArrayList.add(b(bhln.h, 113));
    localArrayList.add(b(bhln.i, 5));
        ...
        do
        {
          do
          {
            do
            {
              ...
              {
                return;
                paramInt1 = bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), "small_emosm_update_flag" + paramString);
                if (QLog.isColorLevel()) {
  ...
  public void a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (bhln.a(paramContext, bhln.e.d) != i)
      {
        a(i, bhln.e);
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        a(k, paramString, j);
        b(k, paramString, j);
        if (bhln.e.e.equals(paramString)) {
          a(j, bhln.e);
        }
      }
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo b()
  {
    ...
    for (;;)
    {
      ...
      ((ClubContentUpdateInfoPb.ReqItemInfo)localObject).str_name.set(bhln.d.e);
      ((ClubContentUpdateInfoPb.ReqItemInfo)localObject).uint_version.set(bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bhln.d.d));
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo b(bhlr parambhlr, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    ClubContentUpdateInfoPb.ReqItemInfo localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
    localReqItemInfo.str_name.set(parambhlr.e);
  ...
  protected void b(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((str1.equals(bhln.e.e)) && (i > bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bhln.e.d))) {
        a(i, bhln.e);
      }
    }
  ...
  protected void c(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      if (!TextUtils.isEmpty(str1))
      {
        ...
        if (str1.equals(bhln.c.e))
        {
          if (i > bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bhln.c.d)) {
            bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bhln.c, i, false);
          }
        }
        else if (str1.equals(bhln.f.e))
        {
          if (i > bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bhln.f.d)) {
            bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bhln.f, i, false);
          }
        }
        else if (str1.equals(bhln.i.e))
        {
          j = bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bhln.i.d);
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentUpdateHandler", 2, "FontInfoList_json remoteVersion = " + i + " localVersion = " + j);
          }
          if (i > j) {
            bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bhln.i, i, false);
          }
        }
      }
    }
  ...
  protected void d(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      int i = localRspItemInfo.uint_version.get();
      int j = localRspItemInfo.uint_update_flag.get();
      int k = bhln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), "small_emosm_update_flag" + str);
      if (QLog.isColorLevel()) {
