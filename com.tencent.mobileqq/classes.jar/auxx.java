...
public class auxx
{
  private static final ConcurrentLinkedQueue<auxx> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static auxx a()
  {
    ...
    {
      auxx localauxx1 = (auxx)jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      ??? = localauxx1;
      if (localauxx1 != null) {}
    }
    return localauxx2;
  ...
  public static void a()
  {
    try
    {
      urk.c("FlowEdit_DecodedFrame", "releaseAll");
      synchronized (jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue)
      {
        if (!jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
          ((auxx)jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll()).c();
        }
      }
    }
    finally {}
  ...
  public void c()
  {
    ...
    urk.d("FlowEdit_DecodedFrame", "release duplicate %d", new Object[] { Integer.valueOf(System.identityHashCode(this)) });
  }
  ...
  protected void finalize()
  {
    ...
    //   4: aload_0
    //   5: getfield 63	auxx:jdField_a_of_type_Int	I
    //   8: ifeq +10 -> 18
    //   11: ldc 73
    //   13: ldc 135
    //   15: invokestatic 137	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   18: return
    //   19: astore_1
    //   20: aload_0
    //   21: getfield 63	auxx:jdField_a_of_type_Int	I
    //   24: ifeq -6 -> 18
    //   27: ldc 73
    //   29: ldc 135
    //   31: invokestatic 137	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   34: return
    //   35: astore_1
    //   36: aload_0
    //   37: getfield 63	auxx:jdField_a_of_type_Int	I
    //   40: ifeq +10 -> 50
    //   43: ldc 73
    //   45: ldc 135
    //   47: invokestatic 137	urk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   50: aload_1
    //   51: athrow
