  ...
  extends ViewBase
{
  ...
  private tqn jdField_a_of_type_Tqn = new tqn();
  private ttg jdField_a_of_type_Ttg;
  private tth jdField_a_of_type_Tth;
  ...
  private tth jdField_b_of_type_Tth;
  private int c = -1;
  private int d;
  private int e;
  private int f;
  ...
  public tti(VafContext paramVafContext)
  {
  ...
  private Boolean a(float paramFloat1, float paramFloat2)
  {
    ...
    boolean bool3 = true;
    boolean bool1 = true;
    float f1 = this.jdField_a_of_type_Tth.d;
    float f2 = this.jdField_a_of_type_Tth.c;
    float f3 = this.jdField_b_of_type_Tth.d;
    float f4 = this.jdField_b_of_type_Tth.c;
    if (f1 == f3)
    {
      if (paramFloat2 <= f1) {}
      for (;;)
  ...
  private tth a(String paramString)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131560044, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369120));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369122));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView = ((ReadInjoyCutImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369121));
  ...
  private void a(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_Ppu != null) && (this.jdField_a_of_type_Ppu.a() != null) && (this.jdField_a_of_type_Ppu.a().a() != null))
    {
      this.jdField_b_of_type_Int = this.jdField_a_of_type_Ppu.a().a().getPaddingTop();
      this.c = this.jdField_a_of_type_Ppu.a().a().getTop();
      if (this.jdField_a_of_type_Int <= 0) {
        this.jdField_a_of_type_Int = this.jdField_a_of_type_Ppu.a().a().getBottom();
      }
    }
    for (;;)
    {
  ...
  private void a(String paramString)
  {
    ...
    if (localObject.length == 2)
    {
      ...
      this.jdField_a_of_type_Tth = a(paramString);
      this.jdField_b_of_type_Tth = a((String)localObject);
    }
  }
  ...
  private void a(String paramString, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if ((paramDrawable != null) && (paramDrawable.getStatus() == 1))
      {
        ...
        this.jdField_a_of_type_Ttg = new ttg(paramDrawable.getCurrDrawable(), this.d, this.jdField_a_of_type_Int - (this.jdField_b_of_type_Int + this.c));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Ttg);
        this.jdField_a_of_type_JavaLangString = paramString;
        return;
      }
    } while (paramDrawable == null);
    paramDrawable.setURLDrawableListener(new ttj(this, paramString));
  }
  
  private void a(ArrayList<String> paramArrayList)
  {
    if ((tqa.k(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo)) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
  ...
  private void c()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
      if (!tqa.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
      {
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c)) || (this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialWidth == 0) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialHeight == 0) || (this.jdField_a_of_type_JavaLangRunnable != null) || (this.jdField_a_of_type_Tqn.a() != null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView == null)) {
      return;
    }
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView.setOnTouchListener(new ttk(this));
    if ((this.jdField_a_of_type_Tth != null) && (this.jdField_b_of_type_Tth != null)) {
      this.jdField_a_of_type_Tqn.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdViewReadInjoyCutImageView, this.jdField_a_of_type_Tth, this.jdField_b_of_type_Tth, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.k, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.l, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.o);
    }
    this.jdField_a_of_type_Tqn.a(new ttl(this));
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, double paramDouble)
  {
    ...
    } while (this.jdField_a_of_type_Ttg == null);
    if (this.jdField_a_of_type_Ttg.getCallback() == null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Ttg);
    }
    ...
    this.jdField_a_of_type_Ttg.a(paramInt1, paramInt2);
  }
  ...
  public void a(ppu paramppu)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (tqa.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      d();
    }
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (tqa.k(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView);
    }
  }
  ...
  public void reset()
  {
    ...
    {
      this.jdField_a_of_type_Tqn.a();
      this.jdField_a_of_type_Tqn.a(null);
      this.jdField_a_of_type_Tqn = null;
    ...
    if (this.jdField_a_of_type_Ttg != null)
    {
      ...
      this.jdField_a_of_type_Ttg = null;
    }
  }
