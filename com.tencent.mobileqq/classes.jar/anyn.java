...
public class anyn
{
  ...
  public anyn(int paramInt, String... paramVarArgs)
  {
    try
    {
      this.e = true;
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new anyr(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new anys(this));
  ...
  public anyn(String paramString1, String paramString2)
  {
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new anyo(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer = new MediaPlayer();
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new anyp(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new anyq(this));
