...
public class anyn
  implements azgl
{
  public anyn(TroopFileZipPreviewActivity paramTroopFileZipPreviewActivity, List paramList, String paramString1, FileManagerEntity paramFileManagerEntity, boolean paramBoolean1, String paramString2, boolean paramBoolean2, String paramString3, String paramString4, short paramShort, String paramString5, int paramInt, String paramString6, wlx paramwlx) {}
  ...
  public void a(JSONObject paramJSONObject, int paramInt, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (!paramJSONObject.isNull("dirs"))
      {
        ...
        {
          localaoys = new aoys();
          localaoys.jdField_a_of_type_Boolean = true;
          localaoys.jdField_a_of_type_JavaLangString = paramBundle.getString(paramInt);
      ...
      if ((paramJSONObject != null) && (!paramJSONObject.isNull("files")))
      {
        ...
        if (paramInt < paramBundle.length())
        {
          ...
          if (this.jdField_a_of_type_JavaLangString.equals("/"))
          {
            ...
            localFileManagerEntity.fileName = localaoys.jdField_a_of_type_JavaLangString;
            ...
            localFileManagerEntity.fileSize = localaoys.jdField_a_of_type_Long;
            ...
            if (this.jdField_a_of_type_Boolean)
            {
              ...
              localFileManagerEntity.nRelatedSessionId = apck.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize);
            }
            ...
            localFileManagerEntity.strServerPath = ("https://" + this.d + ":" + this.jdField_a_of_type_Short + "/ftn_compress_getfile/rkey=" + this.e + "&filetype=" + this.jdField_a_of_type_Int + "&path=" + befm.a(paramJSONObject) + "&");
          ...
          for (;;)
          {
            ...
            localaoys.b = localFileManagerEntity.nSessionId;
            ...
            break label186;
            label691:
            localFileManagerEntity.strServerPath = ("http://" + this.d + ":" + this.f + "/ftn_compress_getfile/rkey=" + this.e + "&filetype=" + this.jdField_a_of_type_Int + "&path=" + befm.a(paramJSONObject) + "&");
          }
        }
      }
      return;
