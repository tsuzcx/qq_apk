  ...
  extends azut
{
  ...
  public azxe()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new azxf(this);
  }
  
  private FrameLayout a(Context paramContext)
  {
    FrameLayout localFrameLayout = new FrameLayout(paramContext);
    localFrameLayout.setLayoutParams(new FrameLayout.LayoutParams(-2, aepi.a(105.0F, paramContext.getResources())));
    localFrameLayout.setId(2131371014);
    if (AppSetting.c) {
  ...
  public static String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if ((paramAbsStructMsg instanceof AbsShareMsg))
    {
      ...
      if ((paramAbsStructMsg.getItemCount() > 0) && ((paramAbsStructMsg.getItemByIndex(0) instanceof azxe)))
      {
        paramAbsStructMsg = (azxe)paramAbsStructMsg.getItemByIndex(0);
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForStructing))
    {
      ...
      if ((paramChatMessage.structingMsg != null) && ((paramChatMessage.structingMsg instanceof AbsShareMsg)) && (paramChatMessage.structingMsg.mMsgServiceID == 52))
      {
        ...
        if ((paramChatMessage.getItemCount() > 0) && ((paramChatMessage.getItemByIndex(0) instanceof azxe))) {
          return true;
        }
      }
    }
  ...
  {
    paramView.setOnTouchListener(new azxg(this, paramView));
  }
    ...
    if (((JSONObject)localObject8).has("cMean"))
    {
      ...
      for (i = 0;; i = Integer.valueOf(str5).intValue())
      {
        ...
        do
        {
          ...
          localObject10 = (azus)((Iterator)localObject9).next();
        } while (!(localObject10 instanceof azwv));
        localObject9 = ((azwv)localObject10).S;
        str11 = b(str11);
        String str15 = b((String)localObject7);
        localObject7 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        Object localObject10 = (alto)((QQAppInterface)localObject7).getManager(51);
        this.jdField_a_of_type_AndroidOsBundle.putString("sNick", str15);
        if (!bool1)
        {
          if ((localObject10 == null) || (!((alto)localObject10).b(str7))) {
            break label1479;
          }
          j = 1;
          if (j != 0)
          {
            str15 = bdgc.j((QQAppInterface)localObject7, str7);
            this.jdField_a_of_type_AndroidOsBundle.putString("sNick", str15);
            if (bool2) {
        ...
        if (!bool2)
        {
          if ((localObject10 == null) || (!((alto)localObject10).b(str6))) {
            break label1484;
          }
          j = 1;
          if (j != 0)
          {
            localObject7 = bdgc.j((QQAppInterface)localObject7, str6);
        ...
        localObject4 = (azus)((Iterator)localObject6).next();
        str1 = ((azus)localObject4).jdField_a_of_type_JavaLangString;
        if (!"remark".equals(str1)) {
          break;
        }
        localObject4 = ((azzl)localObject4).b();
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!TextUtils.isEmpty(str1)) {
      if (bool1)
      {
        ...
        alxn.a(((BaseActivity)paramContext).app, (String)localObject1);
        localResources = paramContext.getResources();
        if ((paramView == null) || (!(paramView instanceof FrameLayout)) || (((FrameLayout)paramView).getChildCount() != 2) || (!(((FrameLayout)paramView).getTag() instanceof azxh))) {
          break label523;
        }
        localObject1 = (FrameLayout)paramView;
        paramView = (azxh)((FrameLayout)localObject1).getTag();
        if (paramView.c != null) {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramView.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding(0, 0, aepi.a(15.0F, localResources), 0);
      ...
      for (;;)
      {
        if (((Iterator)localObject2).hasNext())
        {
          ...
          Object localObject4 = ((azus)localObject3).jdField_a_of_type_JavaLangString;
          Object localObject5;
          int i;
          if ("title".equals(localObject4))
          {
            ...
            localObject4 = ((azus)localObject3).a(paramContext, paramView.c, paramBundle);
            localObject5 = (TextView)((View)localObject4).findViewById(2131379043);
            if (paramView.c == null)
            {
            ...
            for (;;)
            {
              ...
              QLog.i("StructMsgItemLayout12", 2, "getview title:" + ((azuu)localObject3).b() + " realText:" + ((TextView)localObject5).getText());
              break label288;
              if (bool2)
              {
              ...
              ((FrameLayout.LayoutParams)localObject2).setMargins(0, aepi.a(10.0F, localResources), 0, 0);
              if (this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable == null)
              {
                ...
                this.jdField_a_of_type_AndroidGraphicsDrawableGradientDrawable.setCornerRadius(aepi.a(14.0F, localResources));
              }
              ...
              localObject2 = new LinearLayout.LayoutParams(aepi.a(135.0F, localResources), -2);
              ((LinearLayout.LayoutParams)localObject2).weight = 1.0F;
              ((LinearLayout.LayoutParams)localObject2).topMargin = aepi.a(5.0F, localResources);
              ...
              paramView.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding(aepi.a(15.0F, localResources), 0, 0, 0);
              break label279;
          ...
          else
          {
            ...
            {
              if ((localObject3 instanceof azzm)) {
                ((azzm)localObject3).b("black");
              }
              localObject4 = ((azus)localObject3).a(paramContext, paramView.d, paramBundle);
              localObject5 = (TextView)localObject4;
              if (!TextUtils.isEmpty(str1))
              {
                ((TextView)localObject5).setMaxLines(1);
                if ((localObject3 instanceof azzm)) {
                  ((azzm)localObject3).a(str2);
                }
                if (paramView.d != null) {
                  break label1026;
                }
                ...
                ((LinearLayout.LayoutParams)localObject5).setMargins(0, aepi.a(4.0F, localResources), 0, 0);
                paramView.jdField_b_of_type_AndroidWidgetLinearLayout.addView((View)localObject4, (ViewGroup.LayoutParams)localObject5);
              }
              for (;;)
              {
                localObject3 = (azzm)localObject3;
                if ((this.jdField_a_of_type_AndroidOsBundle.size() <= 0) || (!TextUtils.isEmpty(str1))) {
                  break;
                }
                this.jdField_a_of_type_AndroidOsBundle.putString("cMeanPostfix", ((azzm)localObject3).b());
                break;
            ...
            {
              localObject4 = (azwv)localObject3;
              if (!((azwv)localObject4).S.startsWith("http://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s".substring(0, 4))) {
                ((azwv)localObject4).S = String.format("http://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s", new Object[] { ((azwv)localObject4).S });
              }
              localObject3 = ((azus)localObject3).a(paramContext, paramView.jdField_b_of_type_AndroidViewView, paramBundle);
              if (this.jdField_a_of_type_AndroidOsBundle.getInt("count", 0) > 9)
              {
                ...
                localObject4 = new LinearLayout.LayoutParams(aepi.a(115.0F, localResources), -1);
            ...
            {
              if ((localObject3 instanceof azzl)) {
                ((azzl)localObject3).b("#FF9B9B9B");
              }
              localObject4 = ((azus)localObject3).a(paramContext, paramView.e, paramBundle);
              if (paramView.e == null)
              {
                paramView.e = ((View)localObject4);
                localObject5 = new LinearLayout.LayoutParams(-1, -2);
                ((LinearLayout.LayoutParams)localObject5).topMargin = aepi.a(7.0F, localResources);
                paramView.jdField_b_of_type_AndroidWidgetLinearLayout.addView((View)localObject4, (ViewGroup.LayoutParams)localObject5);
              }
              for (;;)
              {
                localObject4 = (azzl)localObject3;
                if (this.jdField_a_of_type_AndroidOsBundle.size() > 0)
                {
                  this.jdField_a_of_type_AndroidOsBundle.putString("remark", ((azzl)localObject4).b());
                  if (!TextUtils.isEmpty(str1)) {
                    this.jdField_a_of_type_AndroidOsBundle.putString("cMeanPostfix", ((azzl)localObject4).b());
                  }
                }
                if (!QLog.isColorLevel()) {
                  break;
                }
                QLog.i("StructMsgItemLayout12", 2, "getview remark:" + ((azuu)localObject3).b());
                break;
