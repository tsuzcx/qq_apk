  ...
  extends azxh
{
  ...
  private WeakReference<Map<Long, azxh>> jdField_a_of_type_JavaLangRefWeakReference;
  private WeakReference<QQAppInterface> b;
  private WeakReference<azxf> c;
  
  public azxe(long paramLong, WeakReference<Map<Long, azxh>> paramWeakReference, WeakReference<QQAppInterface> paramWeakReference1, WeakReference<azxf> paramWeakReference2)
  {
  ...
  private boolean a(Map<Long, azxh> paramMap, QQAppInterface paramQQAppInterface)
  {
    QLog.d("QuickLoginObserver", 1, "wrapper.remove");
    paramMap = (azxh)paramMap.remove(Long.valueOf(this.jdField_a_of_type_Long));
    if (paramMap == null)
    {
  ...
  public void a(boolean paramBoolean, long paramLong)
  {
    ...
    ((azxf)this.c.get()).a(paramBoolean);
  }
}
