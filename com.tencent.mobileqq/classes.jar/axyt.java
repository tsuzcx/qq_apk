  ...
  extends BusinessHandler
{
  ...
  public axyt(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg != null) {
          ((axvp)this.mApp.getManager(370)).a(new OnlineStatusFriendsPermissionItem(paramFromServiceMsg.isAllHasPermission(), paramFromServiceMsg.getPermissionUins()));
        }
        ...
        {
          paramFromServiceMsg = (axvk)this.mApp.getManager(369);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          paramToServiceMsg = (axvk)this.mApp.getManager(369);
          if (l > 40000L)
          {
  ...
  private void d(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      if (b == 0)
      {
        ...
        ((axvk)this.mApp.getManager(369)).c();
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ((axvk)this.mApp.getManager(369)).a(-1L, j);
  ...
  public void a(axyu paramaxyu)
  {
    long l = a().a(this.app);
    if (QLog.isColorLevel()) {
      QLog.d("OnlineStatusHandler", 2, new Object[] { "pushMusicStatus curExtStatus:", Long.valueOf(l), ", ", paramaxyu });
    }
    Object localObject = paramaxyu;
    if (paramaxyu == null) {
      localObject = new axyu();
    }
    if (l == 1028L)
    {
      paramaxyu = new StatSvcStatSong.ReqBody();
      paramaxyu.bool_need_convert.set(((axyu)localObject).jdField_a_of_type_Boolean);
      paramaxyu.uint32_song_type.set(((axyu)localObject).jdField_a_of_type_Int);
      paramaxyu.uint32_remaining_time.set(((axyu)localObject).jdField_b_of_type_Int);
      paramaxyu.uint32_source_type.set(((axyu)localObject).jdField_c_of_type_Int);
      paramaxyu.bytes_song_id.set(ByteStringMicro.copyFromUtf8(((axyu)localObject).jdField_a_of_type_JavaLangString));
      paramaxyu.bytes_song_name.set(ByteStringMicro.copyFromUtf8(((axyu)localObject).jdField_b_of_type_JavaLangString));
      paramaxyu.bytes_singer_name.set(ByteStringMicro.copyFromUtf8(((axyu)localObject).jdField_c_of_type_JavaLangString));
      paramaxyu.bool_pause_flag.set(((axyu)localObject).jdField_b_of_type_Boolean);
      paramaxyu.uint32_song_play_time.set(((axyu)localObject).d);
      ...
      ((ToServiceMsg)localObject).putWupBuffer(paramaxyu.toByteArray());
  ...
  public void a(QQAppInterface paramQQAppInterface, AppRuntime.Status paramStatus, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    try
    {
      if (paramQQAppInterface.getExtOnlineStatus() != 1000L) {
        paramQQAppInterface.setPowerConnect(axuy.c());
      }
  ...
  public void a(Friends paramFriends)
  {
    ...
    if (axys.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(str))
    {
      QLog.e("OnlineStatusHandler", 1, "getMusicLyric return, getting status");
      return;
    }
    this.a = paramFriends;
    axys.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, new avjt(0, 0, null));
  ...
  public void a(MusicInfo paramMusicInfo, int paramInt, boolean paramBoolean, long paramLong)
  {
    ...
    localaxyu.jdField_a_of_type_Boolean = true;
    localaxyu.jdField_a_of_type_JavaLangString = paramMusicInfo.jdField_a_of_type_JavaLangString;
    localaxyu.jdField_b_of_type_JavaLangString = paramMusicInfo.jdField_b_of_type_JavaLangString;
    ...
    if ((paramMusicInfo.jdField_a_of_type_JavaUtilList != null) && (!paramMusicInfo.jdField_a_of_type_JavaUtilList.isEmpty())) {
      localaxyu.jdField_c_of_type_JavaLangString = ((String)paramMusicInfo.jdField_a_of_type_JavaUtilList.get(0));
    }
    localaxyu.jdField_b_of_type_Int = paramInt;
    localaxyu.jdField_c_of_type_Int = axys.a().jdField_a_of_type_Int;
    localaxyu.jdField_b_of_type_Boolean = paramBoolean;
    localaxyu.d = ((int)paramLong);
    a(localaxyu);
  }
  ...
  public void a(SongInfo paramSongInfo, int paramInt, boolean paramBoolean, long paramLong)
  {
    ...
    axyu localaxyu = new axyu();
    localaxyu.jdField_a_of_type_Boolean = false;
    localaxyu.jdField_a_of_type_JavaLangString = paramSongInfo.jdField_a_of_type_JavaLangString;
    ...
    {
      localaxyu.jdField_a_of_type_JavaLangString = a(paramSongInfo.f);
      if (TextUtils.isEmpty(localaxyu.jdField_a_of_type_JavaLangString))
      {
        QLog.d("OnlineStatusHandler", 1, "pushMusicStatus, songMid is null");
        return;
      }
    }
    localaxyu.jdField_b_of_type_JavaLangString = paramSongInfo.jdField_c_of_type_JavaLangString;
    localaxyu.jdField_a_of_type_Int = 1;
    if (TextUtils.isEmpty(paramSongInfo.h)) {}
    for (paramSongInfo = paramSongInfo.d;; paramSongInfo = paramSongInfo.h)
    {
      localaxyu.jdField_c_of_type_JavaLangString = paramSongInfo;
      if (localaxyu.jdField_c_of_type_JavaLangString == null) {
        localaxyu.jdField_c_of_type_JavaLangString = "";
      }
      localaxyu.jdField_b_of_type_Int = paramInt;
      localaxyu.jdField_c_of_type_Int = axys.a().jdField_a_of_type_Int;
      localaxyu.jdField_b_of_type_Boolean = paramBoolean;
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          axys.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(str);
          return;
        }
        ...
        paramFromServiceMsg = new avjt(0, 0, new ArrayList());
        ...
        if (((cmd0xe59.RspBody)localObject).song_lyric.has())
        {
          ...
          if (localObject.length > 0)
          {
            ...
            paramToServiceMsg = new String(bblb.a((byte[])localObject));
            paramToServiceMsg = a(paramToServiceMsg);
          }
        }
        if (paramToServiceMsg != null) {
          axys.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, paramToServiceMsg);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if ((bool1) && (this.a != null) && (str.equals(this.a.songId)))
      {
        this.a.songName = "";
        this.a.singerName = "";
        axys.a().jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(this.a.songId);
        ((FriendListHandler)this.app.getBusinessHandler(1)).getOnlineInfo(this.a.uin, false);
      }
    }
  }
