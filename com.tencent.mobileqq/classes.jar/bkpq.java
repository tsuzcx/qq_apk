...
public class bkpq
  extends QIPCModule
{
  private bkpq(String paramString)
  {
    super(paramString);
  }
  
  public static bkpq a()
  {
    return bkpv.a();
  }
  ...
  public static void a()
  {
    ...
    try
    {
      QMLog.i("MiniSDKClientQIPCModule", "register " + localbkpq);
      QIPCClientHelper.getInstance().register(localbkpq);
      return;
    }
  ...
  {
    a(paramString4, new bkpr(this, paramBaseRuntime, paramString1, paramString2, paramString3, paramInt, paramRequestEvent));
  }
  ...
  {
    MiniAppCmdUtil.getInstance().createUpdatableMsg(paramString2, paramString3, paramInt1, paramInt2, paramString4, new bkpu(this, paramString1, paramIJsService, paramInt3));
  }
  ...
  private void a(String paramString, CmdCallback paramCmdCallback)
  {
    ...
    try
    {
      ...
      if (!URLUtil.isNetworkUrl(str))
      {
        ...
        QIPCClientHelper.getInstance().getClient().callServer("MiniMsgIPCServer", "cmd_mini_share_upload_image", localBundle, new bkps(this, localJSONObject, paramCmdCallback));
        return;
      }
    }
  ...
  {
    MiniAppCmdUtil.getInstance().sendArkMsg(null, paramString3, paramString2, paramString4, paramRequestEvent.event, new bkpt(this, paramRequestEvent, paramBaseRuntime, paramString1, paramInt));
  }
