  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      View localView = paramView.findViewById(2131376583);
      if (localView != null)
      {
        Object localObject1 = localView.getTag(2131376583);
        if ((localObject1 != null) && (StructMsgForGeneralShare.class.isInstance(localObject1)))
        {
          ...
          if (localObject1 != null) {
            if ((localObject1 instanceof aebw))
            {
              localObject2 = (aebw)localObject1;
          ...
          for (;;)
          {
            ...
            if (paramView.getTag(2131376580) == null) {
              break;
            }
            do
            {
              localObject2 = null;
              break;
            } while (paramView.getTag(2131376580) != null);
            return;
            label235:
            ...
            if ((localObject1 != null) && ((localObject1 instanceof QQAppInterface)))
            {
              ...
              akwv.a((QQAppInterface)localObject1, 0, 4, localStructMsgForGeneralShare.message);
              ...
              try
              {
                ...
                ses.a((AppInterface)localObject1, localStructMsgForGeneralShare.message.selfuin, ((JSONObject)localObject3).toString(), "" + localStructMsgForGeneralShare.msgId);
                Object localObject4 = (nqq)((QQAppInterface)localObject1).getManager(88);
                localObject3 = (nri)((QQAppInterface)localObject1).a(88);
                if ((localStructMsgForGeneralShare.message != null) && (localObject4 != null) && (localObject3 != null) && (((nqq)localObject4).a(localStructMsgForGeneralShare.message.senderuin)))
                {
                  localObject4 = localStructMsgForGeneralShare.message;
                  if (TextUtils.isEmpty(localStructMsgForGeneralShare.index))
                  {
                    i = 0;
                    ((nri)localObject3).a(false, (MessageRecord)localObject4, i, localStructMsgForGeneralShare.mMsgUrl);
                  }
                }
                else
                {
                  ...
                  {
                    axqw.b((QQAppInterface)localObject1, "P_CliOper", "Pb_account_lifeservice", localStructMsgForGeneralShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForGeneralShare.msgId), "");
                  ...
                  if ((localObject2 != null) && (((aebw)localObject2).a != null)) {
                    nax.a((QQAppInterface)localObject1, "", "click", localStructMsgForGeneralShare.mSourceAppid, localStructMsgForGeneralShare.mMsgServiceID, nax.a(((aebw)localObject2).a.jdField_a_of_type_Int));
                  }
                  ...
                  axqw.b((QQAppInterface)localObject1, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForGeneralShare.mMsgServiceID + "", "", "", "");
                  if (localStructMsgForGeneralShare.uinType != 1008) {
                    break label1573;
                  }
                  j = 2;
                  axqw.b((QQAppInterface)localObject1, "CliOper", "", "", "0X8004B5C", "0X8004B5C", j, 0, "", String.valueOf(i), (String)localObject3, localStructMsgForGeneralShare.source_puin);
                  axqw.b(null, "dc00898", "", "", "0X800A630", "0X800A630", 0, 0, "1", ForwardUtils.b(localStructMsgForGeneralShare.uinType), localStructMsgForGeneralShare.mContentTitle, "");
                  ...
                  if ((localView instanceof ViewGroup))
                  {
                    ...
                    if ((localObject3 != null) && ((localObject3 instanceof TextViewWrapLayout)))
                    {
                      ...
                      if ((localObject3 != null) && ((localObject3 instanceof axxg))) {
                        axqw.b((QQAppInterface)localObject1, "dc00898", "", "", "0X8007C38", "0X8007C38", 0, 0, ((axxg)localObject3).k + "", "", "", "");
                      }
                    }
                  }
                  if ((localObject2 != null) && (localStructMsgForGeneralShare.hasFlag(16)))
                  {
                    ...
                    ThreadManager.post(new StructMsgForGeneralShare.5.2(this, (aebw)localObject2, (QQAppInterface)localObject1), 2, null, false);
                  }
                  if ((localStructMsgForGeneralShare != null) && (localObject2 != null) && (((aebw)localObject2).a != null) && ((((aebw)localObject2).a.jdField_a_of_type_Int == 1025) || (((aebw)localObject2).a.jdField_a_of_type_Int == 0)) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (myy.b(((aebw)localObject2).a.jdField_a_of_type_JavaLangString)) && ((localStructMsgForGeneralShare.mMsgServiceID != 92) || (localStructMsgForGeneralShare.message == null))) {}
                }
                try
                {
                  if (QLog.isColorLevel()) {
                  ...
                  if (!localStructMsgForGeneralShare.mQidianBulkTaskId.equals("0"))
                  {
                    ...
                    ((bduw)((QQAppInterface)localObject1).a(85)).a(((JSONObject)localObject2).toString(), localStructMsgForGeneralShare.message.frienduin, "", 10009, 0);
                  }
                }
                ...
                ((bdto)((QQAppInterface)localObject1).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 0, "");
                if (localChatFragment != null)
                {
                  localObject2 = localChatFragment.a();
                  if ((localObject2 instanceof aerv)) {
                    ((aerv)localObject2).a.b();
                  }
                }
                StructMsgForGeneralShare.onClickEvent((QQAppInterface)localObject1, localContext, localStructMsgForGeneralShare, paramView, new axvk((QQAppInterface)localObject1, paramView, localStructMsgForGeneralShare));
                return;
              }
              catch (JSONException localJSONException)
              {
                for (;;)
                {
                  ...
                  else
                  {
                    ...
                    j = 1;
                    continue;
                    if ((localStructMsgForGeneralShare != null) && (localObject2 != null) && (((aebw)localObject2).a != null) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (((aebw)localObject2).a.jdField_a_of_type_Int == 1024)) {
                      ((bdto)((QQAppInterface)localObject1).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 1, "");
                    }
                  }
                }
              }
