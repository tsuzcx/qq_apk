  ...
  implements Manager
{
  ...
  public long a;
  private amhb jdField_a_of_type_Amhb;
  private amho jdField_a_of_type_Amho;
  private amhr jdField_a_of_type_Amhr;
  amhw jdField_a_of_type_Amhw;
  private amll jdField_a_of_type_Amll = new amll();
  private amnw jdField_a_of_type_Amnw;
  private amoc jdField_a_of_type_Amoc;
  private amop jdField_a_of_type_Amop;
  amxk jdField_a_of_type_Amxk;
  Handler jdField_a_of_type_AndroidOsHandler = new amhg(this, ThreadManager.getSubThreadLooper());
  andu jdField_a_of_type_Andu;
  bhhe jdField_a_of_type_Bhhe = new amhl(this);
  bmvh jdField_a_of_type_Bmvh = new amhk(this);
  private QQLruCache<String, ApolloBaseInfo> jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new amhe(this, 2009, 1024, ApolloBaseInfo.calcSelfMemorySize());
  ...
  Comparator<DrawerPushItem> jdField_a_of_type_JavaUtilComparator = new amhh(this);
  ...
  private List<amhn> jdField_b_of_type_JavaUtilList;
  private AtomicBoolean jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private bhhe jdField_c_of_type_Bhhe = new amhi(this);
  private Runnable jdField_c_of_type_JavaLangRunnable = new ApolloManager.5(this);
  private List<WeakReference<amhp>> jdField_c_of_type_JavaUtilList = new ArrayList();
  public boolean c;
  public boolean d;
  ...
  public amhd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_OrgJsonJSONObject = new JSONObject();
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = true;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Bhhe = new amhm(this);
    ...
    {
      this.jdField_a_of_type_Andu = new andu();
      q();
      ampb.b();
    ...
    this.jdField_a_of_type_Amhw = new amhw(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
    this.jdField_a_of_type_Amhb = new amhb(paramQQAppInterface);
    o();
  }
  
  public static int a()
  {
    if ((u) && (anca.jdField_e_of_type_Boolean)) {
      return 3;
    }
    return 2;
  }
    ...
    for (;;)
    {
      try
      {
        if (jdField_c_of_type_Int == -1)
        {
          ...
          {
            i1 = bgsg.p(paramAppInterface.getApplication());
            if (i1 != 0) {
              continue;
            }
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((amhd)paramQQAppInterface.getManager(153)).a(paramQQAppInterface.c());
    int i1;
  ...
  {
    if ((paramQQAppInterface == null) || (!c(paramQQAppInterface.getApplication())) || (TextUtils.isEmpty(paramString1)) || (anca.jdField_a_of_type_OrgJsonJSONObject == null)) {
      return -1;
    }
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      {
        paramString2 = (amhd)paramQQAppInterface.getManager(153);
    ...
    if ((anca.jdField_a_of_type_OrgJsonJSONObject != null) && (str != null))
    {
      paramQQAppInterface = anca.jdField_a_of_type_OrgJsonJSONObject.optJSONObject(str);
      if (paramQQAppInterface == null) {}
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return 0;
          paramQQAppInterface = ((amhd)paramQQAppInterface.getManager(153)).a(paramString);
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    localbmvj.jdField_e_of_type_JavaLangString = "tianshu.75";
    localbmvj.jdField_f_of_type_JavaLangString = "tianshu.75";
    localbmvj.g = paramString1;
    localbmvj.h = "";
    localbmvj.jdField_a_of_type_Long = l1;
    localbmvj.jdField_d_of_type_Int = paramInt;
    localbmvj.jdField_e_of_type_Int = 1;
    localbmvj.jdField_f_of_type_Int = 1;
    localbmvj.jdField_l_of_type_JavaLangString = paramString2;
    if (!TextUtils.isEmpty(paramString3)) {
      localbmvj.m = paramString3;
    }
    bmvi.a().a(localbmvj);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   49: new 787	java/io/File
    //   52: dup
    //   53: getstatic 791	ancb:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   56: invokespecial 794	java/io/File:<init>	(Ljava/lang/String;)V
    //   59: invokevirtual 797	java/io/File:mkdirs	()Z
    //   62: pop
    //   63: aload_0
    //   64: invokevirtual 803	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   67: aload_1
    //   68: invokevirtual 809	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   71: astore_0
    //   72: new 811	java/io/FileOutputStream
    //   75: dup
    //   76: new 787	java/io/File
    //   79: dup
    //   80: aload_2
    //   81: invokespecial 794	java/io/File:<init>	(Ljava/lang/String;)V
    //   84: invokespecial 814	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   87: astore_1
    //   88: sipush 4096
    //   91: newarray byte
    //   93: astore_2
    //   94: aload_0
    //   95: aload_2
    //   96: invokevirtual 820	java/io/InputStream:read	([B)I
    //   99: istore_3
    //   100: iload_3
    //   101: iconst_m1
    ...
    //   107: iconst_0
    //   108: iload_3
    //   109: invokevirtual 824	java/io/FileOutputStream:write	([BII)V
    //   112: goto -18 -> 94
    //   115: astore 4
    //   117: aload_0
    //   118: astore_2
    ...
    //   121: astore_0
    //   122: aload_0
    //   123: invokevirtual 827	java/lang/Exception:printStackTrace	()V
    ...
    //   149: aload_0
    //   150: invokevirtual 748	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   163: ifnull +7 -> 170
    //   166: aload_2
    //   167: invokevirtual 832	java/io/InputStream:close	()V
    //   170: aload_1
    //   171: ifnull +7 -> 178
    //   174: aload_1
    //   175: invokevirtual 833	java/io/FileOutputStream:close	()V
    //   178: return
    //   179: aload_1
    //   180: invokevirtual 836	java/io/FileOutputStream:flush	()V
    //   183: aload_0
    //   184: ifnull +7 -> 191
    //   187: aload_0
    //   188: invokevirtual 832	java/io/InputStream:close	()V
    //   191: aload_1
    //   192: ifnull -14 -> 178
    //   195: aload_1
    //   196: invokevirtual 833	java/io/FileOutputStream:close	()V
    //   199: return
    //   200: astore_0
    //   201: return
    //   202: astore_0
    ...
    //   209: ifnull +7 -> 216
    //   212: aload_2
    //   213: invokevirtual 832	java/io/InputStream:close	()V
    //   216: aload_1
    //   217: ifnull +7 -> 224
    //   220: aload_1
    //   221: invokevirtual 833	java/io/FileOutputStream:close	()V
    //   224: aload_0
    //   225: athrow
    //   226: astore_1
    //   227: goto -3 -> 224
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    Object localObject = (amhd)paramQQAppInterface.getManager(153);
    VasExtensionHandler localVasExtensionHandler = (VasExtensionHandler)paramQQAppInterface.a(71);
    ApolloBaseInfo localApolloBaseInfo = ((amhd)localObject).b(paramString1 + "");
    ...
    for (paramQQAppInterface = paramString1.substring(0, 4);; paramQQAppInterface = paramString1)
    {
      ...
      do
      {
        ...
        localObject = ((amhd)localObject).b(paramQQAppInterface.c());
  ...
  private void a(ApolloActionPackage paramApolloActionPackage, List<ApolloActionData> paramList)
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      paramList = ((ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionPackage.packageId);
  ...
  private void a(TianShuAccess.RspEntry paramRspEntry)
  {
      ...
      do
      {
        for (;;)
        {
          try
          {
            ...
            continue;
            bmvi.a().a((TianShuAccess.AdItem)paramRspEntry.value.lst.get(i1));
          }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      break label366;
      ((ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).i(localArrayList);
      return;
    }
  }
  ...
  private void a(TianShuAccess.RspEntry paramRspEntry, boolean paramBoolean)
  {
    ...
    for (int i2 = 2;; i2 = 3)
    {
      ...
      for (;;)
      {
        ...
        break;
        if (i2 == 1) {
          ((DrawerPushItem)localObject2).ext_url = ancb.T;
        } else if (i2 == 2) {
          ((DrawerPushItem)localObject2).ext_url = localThrowable.optString("url");
        }
      }
  ...
  public static boolean a()
  {
    ...
    bgmg.a(new File(ancb.c, "/def/basic").getAbsolutePath());
    do
    {
      try
      {
        long l2 = System.currentTimeMillis();
        a(BaseApplicationImpl.getApplication().getApplicationContext(), "apollo_def_rsc", ancb.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        long l3 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, "copy file to sdcard cost:" + (l3 - l2));
        }
        new File(ancb.c, "def").mkdirs();
        int i1 = LzmaUtils.a(BaseApplicationImpl.getApplication().getApplicationContext(), ancb.jdField_a_of_type_JavaLangString + "/apollo_def_rsc", ancb.c + "/def/");
        bgmg.d(ancb.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        if (i1 != 0) {
          continue;
        }
        boolean bool2 = true;
  ...
  {
    String str = ancb.s + paramString1 + ".zip";
    localObject1 = ancb.s + paramString1 + ".patch";
    localObject2 = ancb.s + paramString1 + ".patched";
    ...
    for (;;)
    {
      try
      {
        if (jdField_d_of_type_Int == -1)
        {
          ...
          if (paramAppInterface != null)
          {
            i1 = bgsg.q(paramAppInterface.getApplication());
  ...
  public static int b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            paramString = ((amhd)localObject).a(paramString);
      ...
      localObject = ((amhd)localObject).a(paramQQAppInterface.c());
  ...
  private void b(TianShuAccess.RspEntry paramRspEntry)
  {
    ...
    for (;;)
    {
      ...
      bmvi.a().a((TianShuAccess.AdItem)paramRspEntry.value.lst.get(i2));
      i2 += 1;
      break;
  ...
  public static void b(boolean paramBoolean)
  {
    ...
    aoph.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  ...
  public static int c(String paramString)
  {
    ...
    do
    {
      ...
      i2 = anca.b.optInt(paramString);
      i1 = i2;
    } while (i2 != 2);
    return jdField_e_of_type_Int;
    return anca.b.optInt(paramString);
  }
  ...
  private void d(TianShuAccess.RspEntry paramRspEntry)
  {
    ...
    Object localObject2 = (ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    Object localObject3 = ((ancd)localObject2).a(i3);
    ...
    for (;;)
    {
      if (i2 < i4)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject4))
        {
          ...
          if (localObject3 != null)
          {
            localObject5 = ((ancd)localObject2).a(i5);
            if (localObject5 != null)
            {
              ...
              ((ancd)localObject2).a((ApolloActionPackage)localObject5);
              g(i5);
  ...
  public static boolean d()
  {
    ...
    do
    {
      ...
      {
        return false;
        if (!anca.b.has("autoOpenBox")) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, new Object[] { "openBoxByH5 autoOpenBox:", Integer.valueOf(anca.b.optInt("autoOpenBox")) });
        }
      } while (anca.b.optInt("autoOpenBox") != 0);
      return true;
    } while (!QLog.isColorLevel());
  ...
  public static boolean f()
  {
    ...
    try
    {
      String str = ancb.av + "cmshow_script_engine.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
        if (new anef(str + ".sig", str).a(1)) {
          break label181;
        }
    ...
    if (bool1)
    {
      jdField_d_of_type_JavaLangString = bgmg.b(localFile);
      return bool1;
    }
  ...
  public static boolean g()
  {
    ...
    try
    {
      String str = ancb.av + "cmshow_script_0.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
    ...
    if (bool1)
    {
      jdField_e_of_type_JavaLangString = bgmg.b(localFile);
      return bool1;
    }
  ...
  private void o()
  {
    this.jdField_a_of_type_Amho = new amho(this);
    IntentFilter localIntentFilter = new IntentFilter();
    localIntentFilter.addAction("com.tencent.mobileqq.action.ACTION_APOLLO_STORE_CRASH_EVENT");
    try
    {
      BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Amho, localIntentFilter, "com.tencent.msg.permission.pushnotify", null);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void r()
  {
    ...
    //   18: aload_0
    //   19: getfield 2061	amhd:y	Z
    //   22: ifne +586 -> 608
    //   25: aload_0
    //   26: getfield 2061	amhd:y	Z
    //   29: ifeq +4 -> 33
    //   32: return
    //   33: aload_0
    //   34: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   37: ifnull +293 -> 330
    //   40: aload_0
    //   41: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   44: invokevirtual 423	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   47: astore 5
    //   49: invokestatic 876	com/tencent/mobileqq/msf/core/NetConnInfoCenter:getServerTime	()J
    //   52: lstore_3
    //   53: aload_0
    //   54: getfield 260	amhd:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   57: ldc 150
    //   59: invokevirtual 2065	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   62: checkcast 105	java/util/ArrayList
    //   65: astore 6
    //   67: aload 6
    //   69: ifnull +534 -> 603
    //   72: aload 6
    //   74: invokevirtual 2066	java/util/ArrayList:size	()I
    //   77: istore_1
    //   78: aload 6
    //   80: invokevirtual 2067	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   83: astore 7
    //   85: aload 7
    //   87: invokeinterface 615 1 0
    //   92: ifeq +254 -> 346
    //   95: aload 7
    //   97: invokeinterface 619 1 0
    //   102: checkcast 2069	com/tencent/mobileqq/persistence/Entity
    //   105: checkcast 150	com/tencent/mobileqq/data/ApolloBaseInfo
    //   108: astore 8
    //   110: aload 8
    //   112: ifnull -27 -> 85
    //   115: aload 8
    //   117: getfield 2072	com/tencent/mobileqq/data/ApolloBaseInfo:uin	Ljava/lang/String;
    //   120: invokestatic 421	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   123: ifne -38 -> 85
    //   126: lload_3
    //   127: aload 8
    //   129: getfield 873	com/tencent/mobileqq/data/ApolloBaseInfo:apolloSignValidTS	J
    //   132: lcmp
    //   133: ifle +19 -> 152
    //   136: aload 8
    //   138: aload 8
    //   140: getfield 873	com/tencent/mobileqq/data/ApolloBaseInfo:apolloSignValidTS	J
    //   143: putfield 879	com/tencent/mobileqq/data/ApolloBaseInfo:apolloLocalSignTs	J
    //   146: aload 8
    //   148: aconst_null
    //   149: putfield 2075	com/tencent/mobileqq/data/ApolloBaseInfo:apolloSignStr	Ljava/lang/String;
    //   152: aload_0
    //   153: getfield 159	amhd:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   156: astore 6
    //   158: aload 6
    //   160: monitorenter
    //   161: aload_0
    //   162: getfield 159	amhd:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   165: aload 8
    //   167: getfield 2072	com/tencent/mobileqq/data/ApolloBaseInfo:uin	Ljava/lang/String;
    //   170: aload 8
    //   172: invokevirtual 2078	com/tencent/commonsdk/cache/QQLruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   175: pop
    //   176: aload 6
    //   178: monitorexit
    //   179: aload 8
    //   181: getfield 2072	com/tencent/mobileqq/data/ApolloBaseInfo:uin	Ljava/lang/String;
    //   184: aload 5
    //   186: invokevirtual 1068	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   189: ifeq -104 -> 85
    //   192: aload_0
    //   193: aload 8
    //   195: putfield 425	amhd:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   198: aload_0
    //   199: aload_0
    //   200: getfield 425	amhd:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   203: getfield 2081	com/tencent/mobileqq/data/ApolloBaseInfo:apolloAISwitch	I
    //   206: iconst_0
    //   207: invokevirtual 2083	amhd:a	(II)V
    //   210: goto -125 -> 85
    //   213: astore 5
    ...
    //   236: ifeq -204 -> 32
    //   239: aload_0
    //   240: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   243: ifnull -211 -> 32
    //   246: aload_0
    //   247: getfield 159	amhd:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   250: aload_0
    //   251: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   254: invokevirtual 423	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   257: invokevirtual 2086	com/tencent/commonsdk/cache/QQLruCache:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   293: aload_0
    //   294: getfield 159	amhd:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   297: invokevirtual 2089	com/tencent/commonsdk/cache/QQLruCache:size	()I
    ...
    //   345: athrow
    //   346: aload_0
    //   347: getfield 260	amhd:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   350: ldc_w 623
    //   353: invokevirtual 2065	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   356: checkcast 105	java/util/ArrayList
    //   359: astore 6
    //   361: aload 6
    //   363: ifnull +124 -> 487
    //   366: aload_0
    //   367: getfield 136	amhd:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   370: astore 5
    //   372: aload 5
    //   374: monitorenter
    //   375: aload_0
    //   376: getfield 139	amhd:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   379: invokeinterface 2094 1 0
    //   384: invokestatic 1150	java/lang/System:currentTimeMillis	()J
    //   387: ldc2_w 547
    //   390: ldiv
    //   391: lstore_3
    //   392: aload 6
    //   394: invokeinterface 610 1 0
    //   399: astore 6
    //   401: aload 6
    //   403: invokeinterface 615 1 0
    //   408: ifeq +76 -> 484
    //   411: aload 6
    //   413: invokeinterface 619 1 0
    //   418: checkcast 623	com/tencent/mobileqq/DrawerPushItem
    //   421: astore 7
    //   423: aload 7
    //   425: getfield 666	com/tencent/mobileqq/DrawerPushItem:end_ts	I
    //   428: i2l
    //   429: lload_3
    //   430: lcmp
    //   431: ifle +40 -> 471
    //   434: aload_0
    //   435: aload 7
    //   437: invokevirtual 757	amhd:a	(Lcom/tencent/mobileqq/DrawerPushItem;)Z
    //   440: ifne +31 -> 471
    //   443: aload_0
    //   444: getfield 139	amhd:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   447: aload 7
    //   449: invokeinterface 761 2 0
    //   454: pop
    //   455: goto -54 -> 401
    //   458: astore 6
    //   460: aload 5
    ...
    //   468: goto -253 -> 215
    //   471: aload_0
    //   472: getfield 260	amhd:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   475: aload 7
    //   477: invokevirtual 2097	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   480: pop
    //   481: goto -80 -> 401
    //   484: aload 5
    //   486: monitorexit
    //   487: aload_0
    //   488: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   491: ifnull +61 -> 552
    //   494: aload_0
    //   495: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   541: ldc_w 540
    //   544: invokeinterface 938 3 0
    //   549: putfield 2103	amhd:k	Ljava/lang/String;
    //   552: aload_0
    //   553: getfield 425	amhd:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   556: ifnonnull +32 -> 588
    //   559: aload_0
    //   560: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   563: ifnull +25 -> 588
    //   566: aload_0
    //   567: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   570: bipush 71
    //   572: invokevirtual 845	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lanii;
    //   575: checkcast 847	com/tencent/mobileqq/vas/VasExtensionHandler
    //   578: aload_0
    //   579: getfield 244	amhd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   582: invokevirtual 396	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   585: invokevirtual 854	com/tencent/mobileqq/vas/VasExtensionHandler:b	(Ljava/lang/String;)V
    //   588: aload_0
    //   589: iconst_1
    //   590: putfield 2061	amhd:y	Z
    //   593: goto -360 -> 233
    //   596: astore 5
    //   598: iconst_0
    //   599: istore_1
  ...
  public amhb a()
  {
    return this.jdField_a_of_type_Amhb;
  }
  
  public amhr a()
  {
    if (this.jdField_a_of_type_Amhr == null) {}
    try
    {
      if (this.jdField_a_of_type_Amhr == null) {
        this.jdField_a_of_type_Amhr = new amhr(this, null);
      }
      return this.jdField_a_of_type_Amhr;
    }
    finally {}
  }
  ...
  public amhw a()
  {
    return this.jdField_a_of_type_Amhw;
  }
  ...
  public amnw a()
  {
    try
    {
      if (this.jdField_a_of_type_Amnw == null) {
        this.jdField_a_of_type_Amnw = new amnw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      amnw localamnw = this.jdField_a_of_type_Amnw;
      return localamnw;
    }
    finally {}
  }
  ...
  public amoc a()
  {
    try
    {
      if (this.jdField_a_of_type_Amoc == null) {
        this.jdField_a_of_type_Amoc = new amoc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      amoc localamoc = this.jdField_a_of_type_Amoc;
      return localamoc;
    }
    finally {}
  }
  ...
  public amop a()
  {
    if (this.jdField_a_of_type_Amop == null) {
      this.jdField_a_of_type_Amop = new amop(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
  ...
  public amxk a()
  {
    if (this.jdField_a_of_type_Amxk == null) {
      this.jdField_a_of_type_Amxk = new amhf(this);
    }
    return this.jdField_a_of_type_Amxk;
  }
  ...
  public bhhk a()
  {
    ...
    return ((bhhh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(3);
  }
  ...
  public DrawerPushItem a(String paramString1, String paramString2, JSONObject paramJSONObject, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label496:
      if (paramInt == 1) {
        localDrawerPushItem.ext_url = ancb.T;
      } else if (paramInt == 2) {
  ...
  public ApolloActionData a(QQAppInterface paramQQAppInterface, String paramString, int... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      amxb.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), paramVarArgs);
  ...
  public String a()
  {
    if ((!this.f) && (!this.jdField_l_of_type_Boolean)) {
      return anni.a(2131699273);
    }
    return anni.a(2131699270);
  }
  ...
  public String a(int paramInt)
  {
    ...
    if (((ancd)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() == 0) {
      ((ancd)localObject1).a();
    }
    for (;;)
    {
      localObject2 = (String)((ancd)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      ...
      return localObject1;
      if (TextUtils.isEmpty((CharSequence)((ancd)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt)))) {
        ((ancd)localObject1).a(paramInt);
      }
    }
  }
  ...
  public String a(int paramInt, String paramString)
  {
    ...
    for (paramInt = 2;; paramInt = 1)
    {
      ...
      for (;;)
      {
        ...
        if (bool)
        {
          ...
          if (i2 == 1)
          {
            ...
            if (a() != null)
            {
              ...
              {
                localObject2 = localObject1;
                if (!TextUtils.isEmpty(ancb.ao))
                {
                  localObject2 = ancb.ao;
        ...
        {
          paramString = (String)localObject2;
          if (ancb.ao.equals(localObject2)) {
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (paramString2.jdField_a_of_type_JavaLangString != null) {
      paramQQAppInterface = bkgj.a(paramString1, "facedata", paramString2.jdField_a_of_type_JavaLangString);
    }
    paramString1 = paramQQAppInterface;
    if (paramString2.a() != null) {
      paramString1 = bkgj.a(paramQQAppInterface, "dressids", Arrays.toString(paramString2.a()).replaceAll(" ", ""));
    }
    return bkgj.a(paramString1, "roleid", String.valueOf(paramString2.jdField_a_of_type_Int));
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    return a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ancb.ao, paramString);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (a() != null)
    {
      localObject = new bhhf((List)localObject, localHashMap, "apollo_json_task" + System.currentTimeMillis());
      ((bhhf)localObject).p = true;
      ((bhhf)localObject).j = false;
      ((bhhf)localObject).n = true;
      ((bhhf)localObject).s = false;
      ((bhhf)localObject).jdField_f_of_type_JavaLangString = "apollo_res";
      ((bhhf)localObject).r = true;
      ((bhhf)localObject).q = true;
      a().a((bhhf)localObject, this.jdField_a_of_type_Bhhe, localBundle);
      if ((paramInt & 0x1) == 1) {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (localancd.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      localancd.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), paramString);
    }
  ...
  public void a(amhn paramamhn)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 2500	amhd:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnonnull +17 -> 23
    //   9: aload_0
    //   10: new 105	java/util/ArrayList
    //   13: dup
    //   14: invokespecial 137	java/util/ArrayList:<init>	()V
    //   17: invokestatic 2504	java/util/Collections:synchronizedList	(Ljava/util/List;)Ljava/util/List;
    //   20: putfield 2500	amhd:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   23: aload_0
    //   24: getfield 2500	amhd:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   27: astore_2
    //   28: aload_2
    //   29: monitorenter
    //   30: aload_0
    //   31: getfield 2500	amhd:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   34: aload_1
    //   35: invokeinterface 761 2 0
    //   40: pop
    //   41: aload_2
    //   42: monitorexit
    //   43: aload_0
  ...
  public void a(amhp paramamhp)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, new Object[] { "[setApolloStatusUpdateListener] listener=", paramamhp });
    }
    this.jdField_c_of_type_JavaUtilList.add(new WeakReference(paramamhp));
  }
  ...
  public void a(aned paramaned)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Andu != null) {
        this.jdField_a_of_type_Andu.a(paramaned);
      }
      return;
    }
    finally
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 0) && (paramSessionInfo.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (bgnt.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))) {}
    do
    {
      do
      {
  ...
  public void a(ApolloPreDownloadData paramApolloPreDownloadData, String paramString1, String paramString2)
  {
    ...
    paramString2 = (ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
  ...
  {
    if ((paramApolloActionData == null) && (!bgmg.a(ApolloUtil.a(paramApolloActionData, 7)))) {}
    while ((!a(bgmg.a(new File(ApolloUtil.a(paramApolloActionData, 7))), paramApolloActionData)) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ((ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionData);
  }
  ...
  public void a(String paramString1, String paramString2, amht paramamht)
  {
    ...
    do
    {
      return;
      localbhhk = a();
    } while ((localbhhk == null) || (localbhhk.a(paramString1) != null));
    File localFile = new File(paramString2);
    paramString2 = new bhhf(paramString1, localFile);
    if (localFile.exists())
    {
    ...
    localbhhk.a(paramString2, new amhu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramamht), paramString1);
  }
  ...
  public void a(List<ApolloActionData> paramList, String paramString)
  {
    ...
    do
    {
      ...
      paramList = new bhhf(localArrayList, localHashMap, paramString);
      paramList.n = true;
    ...
    a().a(paramList, this.jdField_b_of_type_Bhhe, localBundle);
  }
  ...
  public void a(List<String> paramList, Map<String, File> paramMap, List<ApolloActionData> paramList1, Bundle paramBundle)
  {
    ...
    if (i1 < paramList1.size())
    {
      ...
      if (!atwl.a((String)localObject)) {
        break label216;
      }
      localObject = new bhhf(str1, new File((String)localObject));
      Bundle localBundle = new Bundle();
      localBundle.putSerializable(str1, localApolloActionData);
      ((bhhf)localObject).c = str1;
      ((bhhf)localObject).a(localBundle);
      this.jdField_b_of_type_Bhhe.onDoneFile((bhhf)localObject);
    }
    for (;;)
    {
  ...
  public void a(Map<String, ApolloPreDownloadData> paramMap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ((localObject == null) || (((ApolloPreDownloadData)localObject).status == 0) || (localApolloPreDownloadData.version > ((ApolloPreDownloadData)localObject).version))
          {
            ...
            for (localObject = ApolloUtil.e(localApolloPreDownloadData.dirType) + localApolloPreDownloadData.zipDir;; localObject = ancb.t + localApolloPreDownloadData.resId + ".zip")
            {
      ...
      paramMap = new bhhf(localArrayList, localHashMap, "apollo_preDownload");
      paramMap.n = true;
    ...
    a().a(paramMap, this.jdField_c_of_type_Bhhe, localBundle);
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) || (((paramInt & 0x1) == 1) && (!atwl.a(ApolloUtil.jdField_a_of_type_JavaLangString))))
    {
      a(paramInt);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((TextUtils.isEmpty(paramArrayOfByte)) || (anca.a("8.4.1", paramArrayOfByte) >= 0)) {
          break label334;
        }
  ...
  public boolean a(ApolloActionData paramApolloActionData, int paramInt, aned paramaned)
  {
    if (paramApolloActionData == null) {}
    for (;;)
    {
      ...
      if ((paramInt & 0x1) == 1)
      {
        ...
        {
          localObject1 = new bhhf((String)localObject1, new File((String)localObject2));
          ((bhhf)localObject1).jdField_f_of_type_JavaLangString = "apollo_res";
          ((bhhf)localObject1).jdField_b_of_type_Int = 1;
          ((bhhf)localObject1).n = true;
          ((bhhf)localObject1).q = true;
          ((bhhf)localObject1).r = true;
          i1 = bhhh.a((bhhf)localObject1, a());
          if (i1 != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      if ((paramInt & 0x4) == 4)
      {
        ...
        {
          localObject2 = new bhhf((String)localObject2, new File((String)localObject1));
          ((bhhf)localObject2).jdField_f_of_type_JavaLangString = "apollo_res";
          ((bhhf)localObject2).jdField_b_of_type_Int = 1;
          ((bhhf)localObject2).n = true;
          ((bhhf)localObject2).q = true;
          ((bhhf)localObject2).r = true;
          paramInt = bhhh.a((bhhf)localObject2, a());
          if (paramInt != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        bgmg.a((String)localObject1, ApolloUtil.a(paramApolloActionData, 6), false);
      ...
      catch (Exception localException)
      {
        ...
        paramaned.b(paramApolloActionData);
      }
    }
    return true;
  }
  ...
  public boolean a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    do
    {
      ...
      paramApolloActionPackage = new bhhf(ApolloUtil.b(paramApolloActionPackage), new File(ApolloUtil.a(paramApolloActionPackage)));
      ...
      i1 = bhhh.a(paramApolloActionPackage, a());
    } while (i1 != 0);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, "ret:" + i1);
    }
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bgsg.p(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label139;
      }
  ...
  void b(int paramInt1, int paramInt2)
  {
    if ((!ApolloUtil.a(paramInt1, paramInt2)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, str);
    }
  }
  
  public void b(aned paramaned)
  {
    if ((paramaned != null) && (this.jdField_a_of_type_Andu != null)) {
      this.jdField_a_of_type_Andu.b(paramaned);
    }
  }
    ...
    if (paramApolloActionData != null)
    {
      ...
      if (((File)localObject).exists()) {
        try
        {
          ...
          {
            boolean bool = atwl.c(ApolloUtil.a(paramApolloActionData, 6));
  ...
  public boolean b()
  {
    ...
    try
    {
      localObject1 = bgmg.b(new File(ApolloUtil.jdField_a_of_type_JavaLangString));
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          localObject3 = (ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
          ((ancd)localObject3).a(false, localArrayList4);
          ((ancd)localObject3).b();
          ((ancd)localObject3).a(localArrayList1);
          ((ancd)localObject3).b(1);
          ((ancd)localObject3).c(localArrayList2);
          ((ancd)localObject3).d();
          ((ancd)localObject3).d(localArrayList3);
          ...
          this.jdField_a_of_type_Andu.a(Boolean.valueOf(true));
          m();
        }
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          ...
          if (!((SharedPreferences)localObject3).getBoolean("8.4.1" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false)) {
            ((SharedPreferences)localObject3).edit().putBoolean("8.4.1" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true).commit();
          }
          if (localObject1 != null)
          {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).l();
        }
      }
      catch (Exception localException)
      {
  ...
  public boolean b(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    return atwl.a(ApolloUtil.a(paramApolloActionPackage));
  }
  ...
  public void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bgsg.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label137;
      }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt1 & 0x1) != (paramInt2 & 0x1)) || ((paramInt1 & 0x2) != (paramInt2 & 0x2)))
    {
      ...
      if (this.jdField_c_of_type_JavaUtilList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          amhp localamhp = (amhp)((WeakReference)localIterator.next()).get();
          if (localamhp != null) {
            localamhp.a(paramInt1, bool);
          }
        }
      }
    }
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (anca.a("8.4.1", str1, (String)localObject2))
      {
  ...
  public void h()
  {
    ...
    {
      return;
      localaoph = (aoph)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(115);
    } while ((localaoph == null) || (!localaoph.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()));
    QLog.w("ApolloManager", 1, "config is done, then request update");
    ArrayList localArrayList = new ArrayList();
    localaoph.b(localArrayList);
    localaoph.a(localArrayList);
    localaoph.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
  }
  
  public boolean h()
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_new_user_bar_showed" + ampj.a().getCurrentAccountUin(), false)) || (this.i)) {
      bool = true;
    }
    return bool;
  }
  ...
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_780_guide_showed" + ampj.a().getCurrentAccountUin(), false)) || (this.m)) {
      bool = true;
    }
    return bool;
  }
  ...
  public boolean k()
  {
    return this.jdField_a_of_type_Amnw != null;
  }
  ...
  public void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      ApolloActionData localApolloActionData = ((ancd)localObject).a(1450);
      if (localApolloActionData != null) {
        b(localApolloActionData.actionId, localApolloActionData.personNum);
      }
      localObject = ((ancd)localObject).a(1454);
      if (localObject != null) {
  ...
  public void m()
  {
    ...
    {
      Object localObject2 = (ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      localObject1 = ((ancd)localObject2).d(400);
      if (((ancd)localObject2).d(3000059) == null) {
        break label99;
      }
      if (localObject1 != null) {
        break label96;
  ...
  public void n()
  {
    ...
    localbmvg.jdField_a_of_type_Int = 364;
    localbmvg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbmvg);
    localbmvg = new bmvg();
    localbmvg.jdField_a_of_type_Int = 365;
    localbmvg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbmvg);
    localbmvg = new bmvg();
    localbmvg.jdField_a_of_type_Int = 366;
    localbmvg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbmvg);
    localbmvg = new bmvg();
    localbmvg.jdField_a_of_type_Int = 367;
    localbmvg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbmvg);
    localbmvg = new bmvg();
    localbmvg.jdField_a_of_type_Int = 393;
    localbmvg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbmvg);
    localbmvg = new bmvg();
    localbmvg.jdField_a_of_type_Int = 433;
    localbmvg.jdField_b_of_type_Int = 20;
    localArrayList.add(localbmvg);
    localbmvg = new bmvg();
    localbmvg.jdField_a_of_type_Int = 501;
    localbmvg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbmvg);
    localbmvg = new bmvg();
    localbmvg.jdField_a_of_type_Int = 502;
    localbmvg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbmvg);
  ...
  public void onDestroy()
  {
    ...
    try
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Amho);
      this.jdField_a_of_type_Amho = null;
      if (QLog.isColorLevel()) {
      ...
      amxb.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_Amhw.c();
          this.jdField_a_of_type_Amhw = null;
        }
        ApolloGameStateMachine.d();
        ApolloGameUtil.a();
        this.jdField_a_of_type_Amhb.b();
        amnl.a();
        anbx.a();
        if (this.jdField_a_of_type_Amop != null) {
        ...
        if (this.jdField_a_of_type_Amoc != null)
        {
          this.jdField_a_of_type_Amoc.e();
          this.jdField_a_of_type_Amoc = null;
        }
        if (this.jdField_a_of_type_Amnw != null)
        {
          this.jdField_a_of_type_Amnw.c();
          this.jdField_a_of_type_Amnw = null;
        }
        j();
        ampb.a().a();
        amrq localamrq = ampb.a().a();
        if (localamrq != null) {
          localamrq.a();
        }
        anba.a().a();
