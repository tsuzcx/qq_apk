...
public class agnb
  implements Runnable
{
  public agnb(ScanTorchActivity paramScanTorchActivity) {}
  ...
  public void run()
  {
    ...
    tmp12_7[1] = 2131362439;
    Object tmp17_12 = tmp12_7;
    tmp17_12[2] = 2131362440;
    tmp17_12;
    int i = 0;
    ...
    ScanTorchActivity.a(this.a).setId(2131362439);
    ...
    ScanTorchActivity.a(this.a).setId(2131362438);
    ...
    ((LinearLayout)localObject2).setId(2131362437);
    ...
    ((RelativeLayout.LayoutParams)localObject3).addRule(2, 2131362439);
    ScanTorchActivity.a(this.a, new ImageView(this.a));
    ScanTorchActivity.c(this.a).setId(2131362440);
    ScanTorchActivity.c(this.a).setScaleType(ImageView.ScaleType.FIT_CENTER);
    ScanTorchActivity.c(this.a).setImageBitmap(ScanTorchActivity.a(this.a, "res/fudai/progress/loadingbar_hongbao.png", false));
    ...
    this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(ScanTorchActivity.c(this.a), (ViewGroup.LayoutParams)localObject4);
    ...
    ScanTorchActivity.c(this.a).startAnimation((Animation)localObject1);
