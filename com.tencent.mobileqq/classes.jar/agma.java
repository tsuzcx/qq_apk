  ...
  extends BaseBubbleBuilder
{
  ...
  protected HashMap<String, SparseArray<WeakReference<agmd>>> a;
  protected float b;
  final String b;
  ...
  protected String d;
  protected final int e = 2131374774;
  protected final int f = 2131374781;
  protected final int g = 2131374773;
  protected final int h = 2131374772;
  protected final int i = 2131374776;
  protected int j;
  protected int k;
  protected int l;
  protected int m;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = agma.class.getSimpleName();
  }
  
  public agma(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_c_of_type_Int = 2131374757;
    this.jdField_d_of_type_Int = 2131374786;
    this.jdField_b_of_type_JavaLangString = "pay";
    this.jdField_d_of_type_JavaLangString = "";
    this.jdField_b_of_type_Float = 1.0F;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new agmb(this);
    this.jdField_a_of_type_Akav = new agmc(this);
    this.jdField_d_of_type_JavaLangString = paramContext.getString(2131716277);
  ...
  private RelativeLayout a(agmd paramagmd, Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setId(2131374757);
    ...
    ((TextView)localObject1).setId(2131374774);
    ...
    localTextView.setId(2131374781);
    ...
    ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131374757);
    ((QQWalletTransferBubbleView)localObject2).setLayoutParams((ViewGroup.LayoutParams)localObject3);
    ((QQWalletTransferBubbleView)localObject2).setBackgroundResource(2130847157);
    ((QQWalletTransferBubbleView)localObject2).setId(2131374773);
    ...
    paramContext.setId(2131374772);
    ((QQWalletTransferBubbleView)localObject2).addView(paramContext);
    localRelativeLayout.addView((View)localObject2);
    paramagmd.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject1);
    paramagmd.jdField_b_of_type_AndroidWidgetTextView = localTextView;
    paramagmd.jdField_a_of_type_AndroidWidgetImageView = localImageView;
    paramagmd.c = paramContext;
    paramagmd.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView = ((QQWalletTransferBubbleView)localObject2);
    paramagmd.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView = localQQWalletTransferBubbleView;
  ...
  private void a(agmd paramagmd, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletBaseMsgElem paramQQWalletBaseMsgElem, boolean paramBoolean, afce paramafce)
  {
    if (paramMessageForQQWalletMsg.messageType == 16) {}
    for (int i1 = 1;; i1 = 0)
    {
      a(paramagmd.jdField_a_of_type_AndroidWidgetTextView, paramQQWalletBaseMsgElem.title);
      paramagmd.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramQQWalletBaseMsgElem.titleColor);
      paramagmd.jdField_b_of_type_AndroidWidgetTextView.setText(paramQQWalletBaseMsgElem.subTitle);
      paramagmd.jdField_b_of_type_AndroidWidgetTextView.setTextColor(paramQQWalletBaseMsgElem.subtitleColor);
      paramagmd.c.setText(paramQQWalletBaseMsgElem.content);
      if (i1 != 0)
      {
        ...
        if (!TextUtils.isEmpty(paramQQWalletBaseMsgElem.iconUrl)) {
          localObject = URLDrawableHelper.getDrawable(paramQQWalletBaseMsgElem.iconUrl, (int)bfvh.a(this.jdField_a_of_type_AndroidContentContext, this.k), (int)bfvh.a(this.jdField_a_of_type_AndroidContentContext, this.k), null, null);
        }
        paramagmd.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      }
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().waitAppRuntime(null), false, null))
      {
        paramagmd.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleNightBackground(2130847156, Color.parseColor("#FF19BAFF"), paramBoolean);
        paramagmd.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847157, Color.parseColor("#A4A5A8"), paramBoolean);
        paramagmd.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#B2B2B2"));
        paramagmd.jdField_b_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#B2B2B2"));
        paramagmd.c.setTextColor(Color.parseColor("#5D616B"));
      }
      for (;;)
      {
        paramagmd.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramQQWalletBaseMsgElem.title + paramQQWalletBaseMsgElem.subTitle + this.jdField_d_of_type_JavaLangString);
        paramagmd.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramagmd.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnLongClickListener(paramafce);
        paramagmd.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(paramafce);
        if (i1 != 0) {
          a(paramagmd, paramMessageForQQWalletMsg, paramQQWalletBaseMsgElem);
        }
        return;
        if (bbyp.b())
        {
          paramagmd.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847156, Color.parseColor("#FF19BAFF"), paramBoolean);
          paramagmd.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847157, Color.parseColor("#FFECEDF2"), paramBoolean);
          paramagmd.c.setTextColor(Color.parseColor("#FF878B99"));
        }
        else
        {
          paramagmd.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847156, paramQQWalletBaseMsgElem.background, paramBoolean);
          if (paramQQWalletBaseMsgElem.contentBgColor != 0) {
            paramagmd.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847157, paramQQWalletBaseMsgElem.contentBgColor, paramBoolean);
          }
          if (paramQQWalletBaseMsgElem.contentColor != 0) {
            paramagmd.c.setTextColor(paramQQWalletBaseMsgElem.contentColor);
          }
        }
      }
    }
  ...
  private boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, MessageForQQWalletMsg paramMessageForQQWalletMsg, SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          paramString1 = agma.class.getClassLoader();
  ...
  {
    agmd localagmd = (agmd)paramaezf;
    paramaezf = null;
    if ((paramChatMessage instanceof MessageForQQWalletMsg)) {
      paramaezf = (MessageForQQWalletMsg)paramChatMessage;
    }
    if ((paramaezf == null) || (paramaezf.mQQWalletTransferMsg == null)) {
      return null;
    }
    if ((localagmd.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || ((localagmd.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (localagmd.jdField_a_of_type_Long != paramChatMessage.uniseq)))
    {
      localagmd.jdField_a_of_type_AndroidWidgetRelativeLayout = a(localagmd, this.jdField_a_of_type_AndroidContentContext);
      paramBaseChatItemLayout.addView(a(this.jdField_a_of_type_AndroidContentContext));
    }
    localagmd.jdField_a_of_type_Long = paramChatMessage.uniseq;
    paramView = paramaezf.mQQWalletTransferMsg.elem;
    if (paramView == null) {
      return localagmd.jdField_a_of_type_AndroidWidgetRelativeLayout;
    }
    boolean bool;
    if (!paramChatMessage.isSend())
    {
      bool = true;
      a(localagmd, paramaezf, paramView, bool, paramafce);
      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "transferaccountmsg", "show", 0, 0, "" + paramaezf.mQQWalletTransferMsg.templateId, "", "", "");
      paramChatMessage = (TextView)paramBaseChatItemLayout.findViewById(2131374776);
    ...
    for (;;)
    {
      if (paramaezf.messageType == 16)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Akav);
        if (!TextUtils.isEmpty(paramaezf.mQQWalletTransferMsg.listId))
        {
          paramView = (SparseArray)this.jdField_a_of_type_JavaUtilHashMap.get(paramaezf.mQQWalletTransferMsg.listId);
          paramChatMessage = paramView;
          if (paramView == null)
          {
            paramChatMessage = new SparseArray();
            this.jdField_a_of_type_JavaUtilHashMap.put(paramaezf.mQQWalletTransferMsg.listId, paramChatMessage);
          }
          paramChatMessage.put((int)paramaezf.uniseq, new WeakReference(localagmd));
        }
      }
      return localagmd.jdField_a_of_type_AndroidWidgetRelativeLayout;
      bool = false;
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Akav);
  ...
  protected void a(agmd paramagmd, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletBaseMsgElem paramQQWalletBaseMsgElem)
  {
    int i2;
    boolean bool;
    if (paramMessageForQQWalletMsg.messageType == 16)
    {
      ...
      paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716270);
      i1 = 2130847133;
      a(paramagmd.jdField_a_of_type_AndroidWidgetTextView, paramQQWalletBaseMsgElem);
      if ((i1 != 0) && (paramagmd.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        paramQQWalletBaseMsgElem = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(i1);
        paramagmd.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramQQWalletBaseMsgElem);
      }
      if (paramagmd.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView != null)
      {
        paramagmd = paramagmd.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView;
        if (paramMessageForQQWalletMsg.isSend()) {
          break label337;
        }
        bool = true;
        label120:
        paramagmd.setBubbleBackground(2130847156, i2, bool);
      }
    }
    return;
    label132:
    paramQQWalletBaseMsgElem = akat.a(1, paramMessageForQQWalletMsg.mQQWalletTransferMsg.listId, paramMessageForQQWalletMsg);
    ...
    for (int i1 = paramQQWalletBaseMsgElem.a("state", -1);; i1 = -1)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716276);
          i1 = 2130847134;
          i2 = -7676215;
        }
      ...
      if (i1 == 2)
      {
        paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716271);
        i1 = 2130847131;
        i2 = -7676215;
        break;
      }
      if (i1 == 3)
      {
        paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716273);
        i1 = 2130847131;
        i2 = -7676215;
        break;
      }
      if (paramMessageForQQWalletMsg.isSend())
      {
        paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716274);
        i1 = 2130847132;
        break;
      }
      paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716272);
      i1 = 2130847132;
      break;
      label337:
      bool = false;
