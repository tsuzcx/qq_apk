  ...
  extends bohe
{
  ...
  private bolg jdField_a_of_type_Bolg = new bola(this);
  ...
  public bokz(@NonNull String paramString, @NonNull List<String> paramList, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    super(null);
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        localDoodleLayout = bonc.a().a(paramInt);
      } while ((localDoodleLayout == null) || (localDoodleLayout.a() == null));
      localDoodleLayout.a().a(4);
      localDynamicTextItem = new bolc().a(Integer.valueOf(this.jdField_a_of_type_JavaLangString).intValue(), this.jdField_a_of_type_JavaUtilList);
    } while (localDynamicTextItem == null);
    float f = bptp.a * this.c / localDynamicTextItem.a();
    bowh localbowh = new bowh(this.jdField_a_of_type_Float * bptp.a, this.b * bptp.a, f, 0.0F, 0.0F, 0.0F, localDynamicTextItem.a(), localDynamicTextItem.b());
    if (localDoodleLayout.a().a(localbowh, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper, localDoodleLayout.d()) != null)
    {
    ...
    QQToast.a(paramActivity, paramActivity.getString(2131698026), 0).a();
  ...
  public int b()
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager$DynamicTextConfigBean, this.jdField_a_of_type_Bolg);
