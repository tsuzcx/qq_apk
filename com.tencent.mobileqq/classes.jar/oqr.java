  ...
  implements opd
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull otd paramotd, @NotNull otp paramotp, @NotNull ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener((ViewBase.OnClickListener)new oqs(paramotd, paramotp));
    paramotp = paramViewBase.findViewBaseByName("id_comment_expose_subcomment_two");
    if ((paramotp instanceof owv)) {
      ((owv)paramotp).a(paramotd, (View)paramContainer, 1);
    }
  }
}
