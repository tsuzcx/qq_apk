...
public final class bmom
  extends VasAdvService
{
  public static final bmon a;
  @NotNull
  private bmoj jdField_a_of_type_Bmoj;
  @NotNull
  private bmok jdField_a_of_type_Bmok;
  ...
  static
  {
    jdField_a_of_type_Bmon = new bmon(null);
  }
  
  public bmom(@NotNull Activity paramActivity, @NotNull bmok parambmok, @NotNull bmoj parambmoj)
  {
    this.jdField_a_of_type_Bmok = parambmok;
    this.jdField_a_of_type_Bmoj = parambmoj;
  ...
  private final void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Bmoj.onReward(paramInt, this.jdField_a_of_type_ArrayOfByte, this.b);
    this.jdField_a_of_type_Boolean = true;
  }
  ...
  private final void d()
  {
    if (this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo == null) {
      this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo = a(this.jdField_a_of_type_Bmok.c());
    }
  }
  ...
  public adv_report.MobileAdvReportReq a()
  {
    ...
    localMobileAdvReportReq.qq.set(this.jdField_a_of_type_Bmok.a());
    localMobileAdvReportReq.adv_pos.set(this.jdField_a_of_type_Bmok.a());
    ...
    if (localObject2 != null)
    {
      ...
      ((adv_report.RewardReportInfo)localObject2).reward_type.set(this.jdField_a_of_type_Bmok.b());
      ((adv_report.RewardReportInfo)localObject2).reward_item.set(ByteStringMicro.copyFromUtf8(this.jdField_a_of_type_Bmok.a()));
  ...
  public vac_adv_get.VacAdvReq a()
  {
    ...
    localVacAdvReq.qq.set(this.jdField_a_of_type_Bmok.a());
    localVacAdvReq.adv_pos.set(this.jdField_a_of_type_Bmok.a());
    ...
    if (localObject2 != null)
    {
      ...
      ((vac_adv_get.RewardReqInfo)localObject2).reward_type.set(this.jdField_a_of_type_Bmok.b());
      ((vac_adv_get.RewardReqInfo)localObject2).reward_item.set(ByteStringMicro.copyFromUtf8(this.jdField_a_of_type_Bmok.a()));
  ...
  public void a(@NotNull bmkg parambmkg)
  {
    Intrinsics.checkParameterIsNotNull(parambmkg, "showAdCallback");
    Object localObject2 = new bmop(this, parambmkg);
    ...
    if (localObject1 != null)
    {
      ...
      if (localActivity != null)
      {
        ...
        localbmkk.a(localActivity, (qq_ad_get.QQAdGetRsp.AdInfo)localObject1, (bmoi)localObject2, this.jdField_a_of_type_Bmok.b(), this.jdField_a_of_type_Bmok.d());
        if (localActivity == null) {}
      }
      while (localObject1 != null)
      {
        return;
        localObject2 = (bmom)this;
        parambmkg.a(false);
        ((bmom)localObject2).a(8);
        localObject2 = Unit.INSTANCE;
      }
    }
    localObject1 = (bmom)this;
    parambmkg.a(false);
    ((bmom)localObject1).a(1);
    parambmkg = Unit.INSTANCE;
  }
  ...
  public void a(@NotNull VasAdvService.ServiceCode paramServiceCode, @NotNull String paramString)
  {
    ...
    int i;
    switch (bmoo.a[paramServiceCode.ordinal()])
    {
    default: 
