  ...
  implements azal
{
  ...
  public ambu(AppInterface paramAppInterface)
  {
  ...
  public void a(RespItem paramRespItem)
  {
    ...
    if (paramRespItem.eServiceID == 117)
    {
      ...
      arrayOfByte = bdpd.b(paramRespItem.vecUpdate);
      if (arrayOfByte != null) {
    ...
    else
    {
      ...
      catch (InvalidProtocolBufferMicroException paramRespItem)
      {
        ...
        if ((this.a instanceof QQAppInterface)) {
          ((ult)((QQAppInterface)this.a).a(98)).notifyUI(1023, true, Boolean.valueOf(false));
        }
      }
    }
    for (;;)
