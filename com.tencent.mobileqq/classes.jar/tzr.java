...
public class tzr
{
  ...
  public static ArticleInfo a(JSONObject paramJSONObject)
  {
    ...
    if (!TextUtils.isEmpty(paramJSONObject.optString("picUrl", ""))) {
      localArticleInfo.mVideoCoverUrl = pqa.a(paramJSONObject.optString("picUrl"));
    }
    if (QLog.isColorLevel()) {
  ...
  public static String a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("appVersion", "8.4.10.4875");
        ...
        localJSONObject.put("appVersionId", "8.4.10");
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = nuz.d(paramString2);
  ...
  {
    sad.a(paramQQAppInterface).a(paramLong, new tzx(paramBridgeModule, paramLong, paramString));
  }
  ...
  public static void a(BridgeModule paramBridgeModule, String paramString)
  {
    try
    {
      ReadInJoyUserInfoModule.a(pkh.a(), new tzs(paramBridgeModule, paramString), true);
      return;
    }
  ...
  public static void a(BridgeModule paramBridgeModule, JSONObject paramJSONObject)
  {
    if ((paramBridgeModule.getViolaInstance() != null) && (paramBridgeModule.getViolaInstance().getActivity() != null))
    {
      ...
      six.a(paramBridgeModule.getViolaInstance().getActivity(), localUrlJumpInfo);
    }
  }
  ...
  public static void a(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      paramJSONObject = six.a((Activity)localObject, paramJSONObject.optInt("width"), paramJSONObject.optInt("height"));
      f = 750.0F / six.b(localObject)[0];
  ...
  public static void b(BridgeModule paramBridgeModule, JSONObject paramJSONObject)
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      qec.a().a(paramBridgeModule.getViolaInstance().getActivity(), (String)localObject, 2, str1, str2, str3, str4, str5, localBundle, true);
      return;
    }
  }
  ...
  public static void b(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    if (paramJSONObject != null) {
      sad.a(paramJSONObject).a(j, new tzt(str, paramJSONObject, i, paramBridgeModule, j, paramString));
    }
  }
  ...
  {
    return DeviceInfoUtil.getQQVersionWithCode(BaseApplication.getContext());
  }
  ...
  public static String c(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      localSharedPreferences = bmhv.a(BaseApplicationImpl.getApplication().getRuntime(), true, true);
  ...
  public static void c(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramJSONObject = pnn.a();
    if (paramJSONObject != null) {
      sad.a(paramJSONObject).a(j, new tzu(str, paramJSONObject, i, paramBridgeModule, j, paramString));
    }
  }
  ...
  public static void d(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    paramJSONObject = pnn.a();
    if (paramJSONObject != null) {
      sad.a(paramJSONObject).a(j, new tzw(str, paramJSONObject, i, paramBridgeModule, j, paramString));
    }
  }
  ...
  public static void e(BridgeModule paramBridgeModule, JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        ryr.a(localArrayList, i, new tzy(localJSONObject, paramBridgeModule, paramString));
        return;
      }
