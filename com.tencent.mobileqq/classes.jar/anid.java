...
public class anid
{
  ...
  anid(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a()
  {
    ...
    Iterator localIterator = ((aoia)localObject1).a.iterator();
    while (localIterator.hasNext())
    {
      Object localObject2 = (aoik)localIterator.next();
      if (localObject2 != null)
      {
        aoij localaoij = ((aoik)localObject2).jdField_a_of_type_Aoij;
        if (localaoij != null)
        {
          localObject2 = ((aoik)localObject2).jdField_a_of_type_Aoim;
          if ((localObject2 != null) && (a(localaoij)))
          {
            localObject2 = b((aoim)localObject2);
            if (localObject2 != null)
            {
              ArkAppCenter.c("ArkApp.Dict.Update", String.format("getEffectDictIdentifier, use condition dict, dict-id=%s, condition=%s", new Object[] { localObject2, localaoij.toString() }));
              return localObject2;
            }
          }
        }
    ...
    localObject1 = b((aoim)localObject1);
  ...
  {
    return ania.a(paramString) + "/WordData";
  }
  ...
  private static Map<String, anin> a(aoim paramaoim)
  {
    if (paramaoim == null) {
      return new HashMap();
    }
    Object localObject = paramaoim.jdField_b_of_type_JavaUtilArrayList;
    if (localObject == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "getDictInfoFromConfig, 'word_dict_list' field not found");
      return new HashMap();
    }
    paramaoim = new HashMap();
    localObject = ((ArrayList)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      anin localanin = (anin)((Iterator)localObject).next();
      if (localanin != null) {
        paramaoim.put(localanin.a, localanin);
      }
    }
    return paramaoim;
  }
  
  private void a(aoim paramaoim1, aoim paramaoim2, anip paramanip)
  {
    if (paramaoim2 == null)
    {
    ...
    for (;;)
    {
      ...
      Object localObject = a(paramaoim2);
      ...
      paramaoim2 = b(paramaoim1);
      paramaoim1 = a(paramaoim1);
      anir localanir = new anir(null);
      localanir.jdField_a_of_type_Int = ((Map)localObject).size();
      localanir.jdField_a_of_type_Boolean = true;
      localObject = ((Map)localObject).values().iterator();
      while (((Iterator)localObject).hasNext())
      {
        anin localanin = (anin)((Iterator)localObject).next();
        a(str2, paramaoim2, (anin)paramaoim1.get(localanin.a), localanin, new anif(this, localanir, localanin, str2, paramanip, str1));
      }
    }
  }
  
  private void a(String paramString, anin paramanin, anip paramanip)
  {
    a(paramanin.a, paramanin.jdField_b_of_type_JavaLangString, new anik(this, paramanin, paramString, paramanip));
  }
  
  private void a(String paramString1, String paramString2, anin paramanin1, anin paramanin2, anip paramanip)
  {
    boolean bool = false;
    if (!a(paramString2, paramanin1)) {
      paramanin1 = null;
    }
    for (;;)
    {
      if (paramanin1 == null)
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, local not exists, full update, name=%s", new Object[] { paramanin2.a }));
        a(paramString1, paramanin2, new anig(this, paramanin2, paramanip));
        return;
      }
      if (paramanin1.d.equals(paramanin2.d))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, file not change, copy from origin, name=%s", new Object[] { paramanin2.a }));
        paramString2 = b(paramString2, paramanin1.a);
        paramString1 = String.format("%s/%s", new Object[] { paramString1, paramanin2.a });
        if (bdcs.d(paramString2, paramString1)) {
          break label281;
        }
      ...
      for (;;)
      {
        paramanip.a(bool);
        return;
        if ((paramanin2.b()) && (paramanin1.d.equals(paramanin2.g)))
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, incremental update, name=%s", new Object[] { paramanin2.a }));
          b(paramString1, paramString2, paramanin1, paramanin2, new anih(this, paramanin2, paramanip, paramString1));
          return;
        }
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, full update, name=%s", new Object[] { paramanin2.a }));
        a(paramString1, paramanin2, new anij(this, paramanip));
        return;
        label281:
        bool = true;
      }
  ...
  private void a(String paramString1, String paramString2, anio paramanio)
  {
    aniq localaniq = new aniq(null);
    ...
    bavr localbavr = (bavr)localQQAppInterface.getManager(193);
    localaniq.jdField_a_of_type_JavaLangRefWeakReference = new java.lang.ref.WeakReference(localbavr);
    paramanio = new ArkAiDictUpdateMgr.8(this, paramString2, localaniq, paramanio);
    if (localQQAppInterface == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "downloadDictFile, qq app interface is null, return");
      return;
    }
    localaniq.jdField_a_of_type_Boolean = localbavr.a();
    if (localaniq.jdField_a_of_type_Boolean)
    {
      localbavr.a(10022, "prd", paramString1, 0, paramString2, "", 1, 0, false, new bavs(localQQAppInterface, paramString1, paramanio, 10000L));
      return;
    }
    paramanio.run();
  ...
  private static boolean a(aoij paramaoij)
  {
    if (paramaoij == null) {}
    for (;;)
    {
      return false;
      paramaoij = paramaoij.a;
      String[] arrayOfString = paramaoij.split("-");
      if (arrayOfString.length == 2) {
        ...
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "isDictConditionEffect, invalid date, date=%s", new Object[] { paramaoij }));
        }
      }
    }
    return false;
  ...
  private boolean a(aoim paramaoim)
  {
    if (paramaoim == null)
    {
    ...
    String str = b(paramaoim);
    paramaoim = a(paramaoim);
    if (paramaoim == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "checkLocalDictIntegrity, local dict list is empty");
      return true;
    }
    Iterator localIterator = paramaoim.values().iterator();
    do
    {
      if (!localIterator.hasNext()) {
        break;
      }
    } while (a(str, (anin)localIterator.next()));
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
      ...
      ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "checkLocalDictIntegrity, %d of %d files need update", new Object[] { Integer.valueOf(i), Integer.valueOf(paramaoim.size()) }));
      return false;
    }
  }
  
  private static boolean a(String paramString, anin paramanin)
  {
    if (paramanin == null) {}
    while (!b(b(paramString, paramanin.a), paramanin.d)) {
      return false;
    }
    return true;
  }
  ...
  private static String b(aoim paramaoim)
  {
    if (paramaoim == null) {}
    String str;
    do
    {
      return null;
      str = paramaoim.c;
      paramaoim = paramaoim.jdField_b_of_type_JavaLangString;
    } while ((TextUtils.isEmpty(str)) || (TextUtils.isEmpty(paramaoim)));
    return String.format("%s-%s", new Object[] { str, paramaoim });
  }
  ...
  private static Map<String, aoim> b(aoia paramaoia)
  {
    ...
    Object localObject1 = b(paramaoia);
    if (localObject1 != null) {
      localHashMap.put(localObject1, paramaoia);
    }
    paramaoia = paramaoia.a.iterator();
    while (paramaoia.hasNext())
    {
      Object localObject2 = (aoik)paramaoia.next();
      if (localObject2 != null)
      {
        localObject1 = ((aoik)localObject2).jdField_a_of_type_Aoij;
        localObject2 = ((aoik)localObject2).jdField_a_of_type_Aoim;
        if ((localObject1 != null) && (localObject2 != null))
        {
          localObject1 = b((aoim)localObject2);
          if (localObject1 != null) {
  ...
  private void b(String paramString1, String paramString2, anin paramanin1, anin paramanin2, anip paramanip)
  {
    a(paramanin2.a, paramanin2.e, new anil(this, paramanin2, paramString2, paramanin1, paramString1, paramanip));
  }
  
  private static boolean b(aoim paramaoim)
  {
    if (paramaoim == null) {
      return false;
    }
    paramaoim = paramaoim.e;
    if ((TextUtils.isEmpty(paramaoim)) || (paramaoim.equalsIgnoreCase("wifi")))
    {
      if ((AppNetConnInfo.isNetSupport()) && (AppNetConnInfo.isWifiConn()))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("getNetType, invalid dict info, netType=%s", new Object[] { paramaoim }));
        return true;
      }
  ...
  private static boolean b(String paramString1, String paramString2)
  {
    ...
    //   80: invokestatic 521	anid:a	([B)Ljava/lang/String;
    //   83: aload_1
  ...
  private static aoia c()
  {
    ...
    try
    {
      localObject = (aoia)aogt.a(localObject, aoia.class);
      return localObject;
    }
  ...
  private static void c(aoia paramaoia)
  {
    if (paramaoia == null)
    {
  ...
  private static aoia d()
  {
    aohj localaohj = aoho.b(170).a();
    if (localaohj == null)
    {
  ...
  private static void d(aoia paramaoia)
  {
    if (paramaoia == null) {
