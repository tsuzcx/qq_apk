  ...
  extends abnw
{
  ...
  public bbpk(QQAppInterface paramQQAppInterface, QQMessageFacade paramQQMessageFacade, aboq paramaboq)
  {
  ...
  public MessageForGrayTips a(QQAppInterface paramQQAppInterface, String paramString, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    for (int i = 1;; i = 1)
    {
      ...
      paramQQAppInterface = (bclk)paramQQAppInterface.getManager(81);
      if ((paramQQAppInterface != null) && (i == 0))
      {
        ...
        paramString = (bclk)paramQQAppInterface.getManager(81);
        if (paramString != null) {
  ...
  protected String a(String paramString1, String paramString2)
  {
    ...
    for (paramString2 = alpo.a(2131716039); paramString2 == null; paramString2 = bdbt.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1)) {
      return paramString1;
    }
    return paramString2;
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<TroopNotificationCache> paramArrayList, int paramInt1, int paramInt2, int paramInt3, String paramString3)
  {
    ...
    bckr.a(paramQQAppInterface, paramString2, paramArrayList, paramInt2, paramInt3, paramString3);
  }
  ...
  public void a(MessageRecord paramMessageRecord, awbw paramawbw, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, abnu paramabnu)
  {
    ...
    Map localMap1 = paramabnu.jdField_a_of_type_JavaUtilMap;
    Map localMap2 = paramabnu.b;
    Map localMap3 = paramabnu.c;
    Object localObject2 = paramabnu.jdField_a_of_type_Aubr;
    Object localObject1 = paramabnu.jdField_a_of_type_Amjk;
    ...
    RecentUser localRecentUser = ((amjk)localObject1).a(str1, paramMessageRecord.istroop);
    if (localObject2 != null)
    {
      localObject1 = ((aubr)localObject2).a(str1);
      if (localObject1 != null) {
        if (((bbku)localObject1).b() != paramMessageRecord.shmsgseq) {
          localObject1 = null;
        }
      }
    }
    for (;;)
    {
      ...
      if (j == 1)
      {
        if ((localRecentUser.msgType == 24) || (localObject1 == null) || (((bbku)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, str1) != 24)) {
          break label1047;
        }
        if ((i != 1) && (i != 4)) {
          break label990;
        }
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_atsign_norm", 0, 0, localRecentUser.uin, "", "", "");
        label246:
        if ((!paramMessageRecord.isSend()) && (localObject1 != null) && (((bbku)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, str1) == 17) && (((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(str1)) && (MessageForQQWalletMsg.isRedPacketMsg(paramMessageRecord))) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005C8D", "0X8005C8D", 0, 0, "", "", "", "");
        }
        ...
        if (paramMessageRecord.senderuin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
          amfl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord.frienduin, j, paramMessageRecord);
        }
      }
      int k;
      if ((localObject1 != null) && (((bbku)localObject1).a()))
      {
        k = ((bbku)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, str1);
        if (QLog.isColorLevel()) {
        ...
        if (bbku.a(k, localRecentUser.msgType))
        {
          localRecentUser.msgType = k;
          localRecentUser.msg = bbku.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, (bbku)localObject1, localRecentUser.msg, paramMessageRecord, true);
          if (!atwd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1))
          {
            ...
            localMap1.put(abot.a(str1, j), localRecentUser);
          }
          if ((j == 1) || (j == 3000))
          {
            if (k != 8) {
            ...
            label651:
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_public", "", "oper", (String)localObject2, 0, 0, str1, "", "", "");
          }
        }
        label685:
        if ((j == 1) && ((k == 24) || (k == 22)) && (!nav.a(paramMessageRecord)) && (bclo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "atMeOrReplyMe")))
        {
      ...
      if (localMap1.containsKey(abot.a(localRecentUser.uin, localRecentUser.getType()))) {}
      for (localObject2 = (RecentUser)localMap1.get(abot.a(localRecentUser.uin, localRecentUser.getType()));; localObject2 = localRecentUser)
      {
        if (((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(str1)) {
          if ((!localMap3.containsKey(abot.a(str1, j))) || (((MessageRecord)localMap3.get(abot.a(str1, j))).time <= paramMessageRecord.time)) {
            localMap3.put(abot.a(str1, j), paramMessageRecord);
          }
        }
        for (;;)
        {
          ...
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_atsign_grphelper", 0, 0, localRecentUser.uin, "", "", "");
          break label246;
          label1047:
          boolean bool;
          if ((localRecentUser.msgType != 17) && (localRecentUser.msgType != 22) && (localRecentUser.msgType != 24) && (localObject1 != null) && (((bbku)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, str1) == 17))
          {
            ...
            if ((i == 3) || (i == 4))
            {
              if (bool)
              {
                azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_hongbaoSign_allscreen", 0, 0, localRecentUser.uin, "", "", "");
                break label246;
              }
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_sfsign_allscreen", 0, 0, localRecentUser.uin, "", "", "");
              break label246;
            }
            if (i == 2)
            {
              if (bool)
              {
                azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_hongbaoSign_grphelper", 0, 0, localRecentUser.uin, "", "", "");
                break label246;
              }
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_sfsign_grphelper", 0, 0, localRecentUser.uin, "", "", "");
              break label246;
            }
            if (i != 1) {
              break label246;
            }
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_sfsign_norm", 0, 0, localRecentUser.uin, "", "", "");
            break label246;
          }
          if ((localRecentUser.msgType == 17) || (localRecentUser.msgType == 22) || (localRecentUser.msgType == 24) || (localRecentUser.msgType == 13) || (localObject1 == null) || (((bbku)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, str1) != 13)) {
            break label246;
          }
          if ((i == 3) || (i == 4)) {
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_atall_allscreen", 0, 0, localRecentUser.uin, "", "", "");
          }
          for (;;)
          {
            if (!QLog.isColorLevel()) {
            ...
            break;
            if (i == 2) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_atall_grphelper", 0, 0, localRecentUser.uin, "", "", "");
            } else if (i == 1) {
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Appear_atall_norm", 0, 0, localRecentUser.uin, "", "", "");
            }
          }
          label1567:
          break label246;
          ...
          {
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", (String)localObject2, "", "Msglist", "Appear_replySign", 0, 0, localRecentUser.troopUin, "" + i, "", "");
            if ((i != 3) && (i != 4)) {
              break label1718;
            }
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", (String)localObject2, "", "Msglist", "Appear_replySign_allscreen", 0, 0, localRecentUser.troopUin, "", "", "");
            break;
          }
          label1718:
          if (i != 2) {
          ...
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", (String)localObject2, "", "Msglist", "Appear_replySign_grphelper", 0, 0, localRecentUser.troopUin, "", "", "");
          break label685;
          if ((!abot.h(paramMessageRecord.msgtype)) && (!abot.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord)))
          {
            if ((j == 1) && (i != 1) && (i != 4))
            {
              if (localObject1 == null) {}
              for (i = 0;; i = ((bbku)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, str1))
              {
                if ((i == 17) || (i == 24) || (i == 16) || (i == 13) || (i == 5) || (i == 27) || (i == 18) || (i == 22) || (i == 14) || (i == 4) || (i == 10) || (i == 11))
                {
                  ...
                  localMap1.put(abot.a(str1, j), localObject2);
                  if (QLog.isColorLevel()) {
                    QLog.d("Q.msg.BaseMessageManager.troop.special_msg", 2, "addMessageRecord, MsgBizType:" + i + "uin:" + ((RecentUser)localObject2).uin);
                  }
                }
                if ((!atwd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1)) || ((localMap2.containsKey(abot.a(str1, j))) && (((MessageRecord)localMap2.get(abot.a(str1, j))).time > paramMessageRecord.time))) {
                  break;
                }
                localMap2.put(abot.a(str1, j), paramMessageRecord);
                break;
              }
            }
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, long paramLong)
  {
    ...
    if ((paramInt == 1) && (i != 1) && (i != 4))
    {
      ...
      try
      {
        atwd.a().a(paramString1, paramLong, paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramString2.a();
  ...
  public void a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    //   27: astore 6
    //   29: aload_0
    //   30: getfield 27	bbpk:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   33: aload_1
    //   34: invokevirtual 593	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   37: ifeq +23 -> 60
    //   40: aload_0
    //   41: getfield 27	bbpk:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   44: aload_1
    //   45: invokevirtual 594	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   48: checkcast 596	java/util/HashSet
    //   51: aload 6
    //   53: invokevirtual 599	java/util/HashSet:add	(Ljava/lang/Object;)Z
    //   56: pop
    //   57: aload_0
    //   58: monitorexit
    //   59: return
    //   60: new 596	java/util/HashSet
    //   63: dup
    //   64: invokespecial 600	java/util/HashSet:<init>	()V
    //   67: astore 7
    //   69: aload 7
    //   71: aload 6
    //   73: invokevirtual 599	java/util/HashSet:add	(Ljava/lang/Object;)Z
    //   76: pop
    //   77: aload_0
    //   78: getfield 27	bbpk:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   81: aload_1
    //   82: aload 7
    //   84: invokevirtual 601	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   87: pop
    //   88: goto -31 -> 57
    //   91: astore_1
    //   92: aload_0
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramString1)) {}
    for (paramString2 = alpo.a(2131716040); paramString2 == null; paramString2 = bdbt.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1)) {
      return paramString1;
    }
    return paramString2;
  }
  ...
  {
    return this.jdField_a_of_type_ComTencentImcoreMessageQQMessageFacade.b.containsKey(abot.a(paramString, paramInt));
  }
  ...
  public boolean c(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 27	bbpk:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: aload_1
    //   7: invokevirtual 593	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   10: istore_2
    //   11: iload_2
    //   12: ifeq +9 -> 21
    //   15: iconst_0
