  ...
  extends MSFServlet
{
  ...
  private void a(VideoCallMsg paramVideoCallMsg)
  {
    ...
    {
      lba.g("VideoConfigServlet", "handleVideoConfigMessage error videoMsg = null");
      return;
    }
    int i;
    int j;
    ...
    {
      int[] arrayOfInt = lkq.a(paramVideoCallMsg.vMsg);
      if (arrayOfInt != null)
      {
        i = arrayOfInt[0];
        j = arrayOfInt[1];
        ...
        bool1 = true;
        AudioHelper.a(0, new bfts(i, j, bool1));
        i = arrayOfInt[3];
        j = arrayOfInt[4];
        if (arrayOfInt[5] != 1) {
          break label218;
        ...
        bool1 = true;
        label97:
        AudioHelper.a(1, new bfts(i, j, bool1));
        i = arrayOfInt[6];
        j = arrayOfInt[7];
        if (arrayOfInt[8] != 1) {
          break label224;
        ...
        bool1 = true;
        label136:
        AudioHelper.a(2, new bfts(i, j, bool1));
        i = arrayOfInt[9];
        j = arrayOfInt[10];
        if (arrayOfInt[11] != 1) {
          break label230;
    ...
    {
      AudioHelper.a(3, new bfts(i, j, bool1));
      lkq.a(String.valueOf(AppSetting.a()), getAppRuntime().getApplication(), paramVideoCallMsg.vMsg);
      return;
      bool1 = false;
      break;
      bool1 = false;
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      do
      {
        ...
        try
        {
          ...
          {
            lba.f("VideoConfigServlet", "cmd0xa02 onReceive uint32_result = " + paramFromServiceMsg.uint32_result.get());
            return;
          }
        }
      ...
      lba.f("VideoConfigServlet", "cmd0xa02 onReceive list = " + paramIntent.toString());
      new ArrayList();
    ...
    return;
    lba.f("VideoConfigServlet", "cmd0xa02 onReceive not success!");
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    lba.f("VideoConfigServlet", "cmd0xa02 onSend");
    return;
    ...
    paramIntent.vMsg = lkq.a(paramIntent.lUin, String.valueOf(AppSetting.a()), getAppRuntime().getApplication());
