  ...
  extends BusinessHandler
{
  ...
  public aslm(QQAppInterface paramQQAppInterface)
  {
  ...
  private Card a(String paramString1, String paramString2, String paramString3, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Card localCard = localanvk.c(paramString1);
  ...
  private void a(List<Long> paramList1, int paramInt1, int paramInt2, List<Long> paramList2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localbcrg = this.app.getMsgCache();
  ...
  private void a(oidb_0xe03.MatchUinData paramMatchUinData, asmk paramasmk)
  {
    int j = -1;
    int k = 0;
    if ((paramMatchUinData == null) || (paramasmk == null))
    {
    ...
    if (paramMatchUinData.uint32_age.has())
    {
      ...
      if (localObject1 != null) {
        paramasmk.i = RichStatus.parseStatus((byte[])localObject1).getPlainText();
      }
      if (!paramMatchUinData.uint32_sex.has()) {
        break label569;
      }
      paramasmk.jdField_a_of_type_Int = paramMatchUinData.uint32_sex.get();
      label319:
    ...
    {
      paramasmk.jdField_a_of_type_Long = l;
      ...
      while (i < paramMatchUinData.rpt_school_info.size())
      {
        ...
        {
          localObject2 = new asnp(((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).str_school_id.get(), ((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).str_school_name.get(), ((oidb_0xe03.schoolInfo)paramMatchUinData.rpt_school_info.get(i)).uint64_state.get());
          ((ArrayList)localObject1).add(localObject2);
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "schoolInfo. " + ((asnp)localObject2).toString());
          }
        }
        i += 1;
      }
      ...
      localObject1 = null;
      break label281;
      paramasmk.jdField_a_of_type_Int = 0;
      QLog.e("ExtendFriendHandlerExtendFriendLimitChat", 2, "mGender  is null. set 0  ");
      break label319;
    }
    label593:
    paramasmk.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
    ...
    if (paramMatchUinData.rpt_tag.has())
    {
      ...
      while (i < paramMatchUinData.rpt_tag.size())
      {
        if (((oidb_0xe03.ProfileTagInfo)paramMatchUinData.rpt_tag.get(i)).bytes_tag.has())
        {
          ...
          localasno.jdField_a_of_type_Int = k;
          localasno.jdField_a_of_type_JavaLangString = ((String)localObject2);
          ((ArrayList)localObject1).add(localasno);
        }
        i += 1;
      }
    }
    paramasmk.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
    if (paramMatchUinData.uint32_distance.has())
    {
      i = paramMatchUinData.uint32_distance.get();
      label755:
      paramasmk.jdField_c_of_type_Int = i;
      i = j;
      if (paramMatchUinData.uint32_match_pool.has()) {
        i = paramMatchUinData.uint32_match_pool.get();
      }
      paramasmk.jdField_d_of_type_Int = i;
      if (!paramMatchUinData.str_from_city_name.has()) {
        break label876;
      }
      localObject1 = paramMatchUinData.str_from_city_name.get();
      label805:
      paramasmk.j = ((String)localObject1);
    ...
    {
      paramasmk.k = paramMatchUinData;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "ChatFriendInfo. " + paramasmk.toString());
      return;
      i = -1;
      break label755;
      localObject1 = "";
  ...
  private void a(Object[] paramArrayOfObject, String paramString)
  {
    if (((paramArrayOfObject instanceof Object[])) && (paramArrayOfObject.length == 9))
    {
      ...
      paramArrayOfObject = asss.a(this.app);
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramFromServiceMsg = (aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      paramObject = (aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (paramObject != null) {
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (i == 0)
      {
        ...
        if ((this.app != null) && (this.app.getMsgCache() != null))
        {
          this.app.getMsgCache().a(paramObject, paramFromServiceMsg, (byte[])localObject, false);
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.uint32_flare_switch.has())
        {
          ...
          if ((k == 1) && (i == 1))
          {
            if (((aslo)this.app.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).c())
            {
              paramToServiceMsg = "1";
              bdla.b(null, "dc00898", "", "", "0X800AE9B", "0X800AE9B", 0, 0, "", paramToServiceMsg, "", "");
            }
          }
          else
          {
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((j == 0) || (j == 33))
    {
      ...
      {
        bool1 = true;
        asss localasss = asss.a(this.app);
        localasss.a(1, paramObject);
        localasss.a(2, str2);
        localasss.a(0, paramToServiceMsg);
        localasss.a(k);
        ...
        if (j == 0) {
          this.app.getMessageFacade().removeMsgFromMsgBox(AppConstants.MATCH_CHAT_UIN, i, str1, this.app.getCurrentAccountUin());
        }
        if (j != 0) {
          break label456;
        }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord != null) && ((paramMessageRecord instanceof MessageForLimitChatConfirm)))
    {
      ...
      {
        localObject1 = new asnf();
        ((asnf)localObject1).jdField_a_of_type_Boolean = paramMessageRecord.bEnterMsg;
        ((asnf)localObject1).jdField_a_of_type_Int = paramMessageRecord.leaveChatType;
        ((asnf)localObject1).jdField_a_of_type_Long = paramMessageRecord.timeStamp;
        ((asnf)localObject1).jdField_a_of_type_JavaLangString = paramMessageRecord.frienduin;
        ((asnf)localObject1).jdField_b_of_type_JavaLangString = paramMessageRecord.SenderNickName;
        ((asnf)localObject1).jdField_d_of_type_Int = paramMessageRecord.c2cExpiredTime;
        ((asnf)localObject1).jdField_b_of_type_Int = paramMessageRecord.leftChatTime;
        ((asnf)localObject1).jdField_c_of_type_JavaLangString = paramMessageRecord.tipsWording;
        ((asnf)localObject1).jdField_c_of_type_Int = paramMessageRecord.matchExpiredTime;
        ((asnf)localObject1).jdField_b_of_type_Long = paramMessageRecord.readyTs;
        QLog.i("ExtendFriendHandlerExtendFriendLimitChat", 2, "HandleC2CConfirmOrCancelMsg  info：" + ((asnf)localObject1).toString());
        i = 1;
        j = i;
        if (!bhfj.b(paramMessageRecord.issend)) {
    ...
    for (;;)
    {
      ...
      if (l2 != -1L)
      {
        ...
        localObject2 = this.app.getMsgHandler().a().a();
        if (localObject2 != null) {
        ...
        this.app.getMsgHandler().a("c2c_processor").a(paramMessageRecord);
        for (j = i;; j = 0)
        {
          if (j != 0) {
            break label408;
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      QQToast.a(this.app.getApp(), 1, 2131694253, 0).a();
    ...
    new bhyv("QC.UniBusinessLogicServer.UniBusinessLogicObj", "QCUniBusinessLogic.UniSetExtFriend").a("UniSetExtFriend", new UniSetExtFriendReq(bhyv.a(), new UniBusinessItem(304, paramInt4, ""), new ExtendFriend(paramInt2)), new UniSetExtFriendRsp(), new asln(this, paramString1, paramInt4, paramInt2), true);
    try
    {
  ...
  public void a(String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2, long paramLong, String paramString3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localReqBody.bytes_req_buff.set(ByteStringMicro.copyFrom(bmnn.a().a()));
      ...
      localSosoLbsInfo = SosoInterface.getCanUsedLbsInfoCache(3600000L, false, 0, true);
      ...
      if ((!TextUtils.isEmpty(paramString3)) && (paramString3.equals(paramString1)))
      {
        ...
        {
          paramInt = 1;
          bdla.b(paramString1, "dc00898", "", "", "0X8009423", "0X8009423", paramInt, 0, "", "", paramString2, "");
          return;
  ...
  public void a(submsgtype0x128.MsgBody paramMsgBody, boolean paramBoolean)
  {
    if (paramMsgBody != null)
    {
      ...
      localasne.jdField_a_of_type_JavaLangString = this.app.getCurrentUin();
      localasne.jdField_a_of_type_ArrayOfByte = paramMsgBody.bytes_sig.get().toByteArray();
      String str;
      label91:
      long l;
      label117:
      ...
      if (paramMsgBody.uint64_match_uin.has())
      {
        ...
        localasne.jdField_a_of_type_Asmk.jdField_a_of_type_JavaLangString = localasne.jdField_b_of_type_JavaLangString;
        a(paramMsgBody.msg_match_uin_data, localasne.jdField_a_of_type_Asmk);
      }
      for (;;)
      {
        str = "";
        ...
        localasne.e = paramMsgBody;
        if (QLog.isColorLevel()) {
          QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleGetUnlimitMatchOfflinePush push matchInfo = ", localasne + "bUnlimitMatchPush：" + paramBoolean });
        }
        paramMsgBody = (asqt)this.app.getManager(QQManagerFactory.EXTEND_FRIEND_LIMIT_CHAT_MANAGER);
        if (paramMsgBody != null) {
          paramMsgBody.a();
        }
        if (!paramBoolean) {
        ...
        notifyUI(16, true, new Object[] { localasne });
        return;
        str = "0";
        break;
        label472:
        ...
        break label243;
        label504:
        localasne.jdField_b_of_type_Int = 1;
      ...
      label570:
      ((aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).a(localasne);
      notifyUI(23, true, new Object[] { localasne.jdField_b_of_type_JavaLangString });
      return;
    }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((PBUInt32Field)localObject2).set(i);
        localObject2 = (aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
        if (localObject2 != null)
        {
          localObject2 = ((aslo)localObject2).a();
          if (localObject2 != null)
          {
            oidb_0xdb1.LBSInfo localLBSInfo = new oidb_0xdb1.LBSInfo();
            oidb_0xdb1.GPS localGPS = new oidb_0xdb1.GPS();
            localGPS.int32_lon.set(((asmo)localObject2).jdField_b_of_type_Int);
            localGPS.int32_lat.set(((asmo)localObject2).jdField_a_of_type_Int);
            localGPS.int32_alt.set(((asmo)localObject2).jdField_c_of_type_Int);
            localGPS.int32_type.set(((asmo)localObject2).jdField_d_of_type_Int);
            localLBSInfo.msg_gps.set(localGPS);
  ...
  public boolean a(int paramInt, asmo paramasmo)
  {
    asmo localasmo = paramasmo;
    if (paramasmo == null) {
      localasmo = ((aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).a();
    }
    ...
    try
    {
      ...
      paramasmo = new oidb_0xe03.ReqBody();
      paramasmo.uint64_uin.set(a((String)localObject, "openSignalBomb"));
      paramasmo.enum_matchopcode.set(6);
      paramasmo.uint32_tag_id.set(0);
      paramasmo.uint32_sex.set(paramInt);
      if (((aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER) != null) && (localasmo != null))
      {
        localObject = new oidb_0xe03.LBSInfo();
        oidb_0xe03.GPS localGPS = new oidb_0xe03.GPS();
        localGPS.int32_lon.set(localasmo.jdField_b_of_type_Int);
        localGPS.int32_lat.set(localasmo.jdField_a_of_type_Int);
        localGPS.int32_alt.set(localasmo.jdField_c_of_type_Int);
        localGPS.int32_type.set(localasmo.jdField_d_of_type_Int);
        ((oidb_0xe03.LBSInfo)localObject).msg_gps.set(localGPS);
        paramasmo.msg_lbs_info.set((MessageMicro)localObject);
        QLog.d("ExtendFriendHandler", 1, "openSignalBomb. with msg_lbs_info info ");
      }
      paramasmo = makeOIDBPkg("OidbSvc.0xe03", 3587, 0, paramasmo.toByteArray());
      paramasmo.extraData.putInt("match_op", 6);
      sendPbReq(paramasmo);
      return true;
    }
    catch (NumberFormatException paramasmo)
    {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "openSignalBomb. error = " + paramasmo);
    }
    return false;
  }
  
  public boolean a(asmo paramasmo)
  {
    try
    {
      ...
      if (paramasmo != null)
      {
        ...
        localGPS.int32_lon.set(paramasmo.jdField_b_of_type_Int);
        localGPS.int32_lat.set(paramasmo.jdField_a_of_type_Int);
        localGPS.int32_alt.set(paramasmo.jdField_c_of_type_Int);
        localGPS.int32_type.set(paramasmo.jdField_d_of_type_Int);
        localLBSInfo.msg_gps.set(localGPS);
        localReqBody.msg_lbs_info.set(localLBSInfo);
        QLog.i("ExtendFriendHandler", 1, "EnterExtendFriend. with msg_lbs_info info ");
      }
      paramasmo = makeOIDBPkg("OidbSvc.0xe67", 3687, 1, localReqBody.toByteArray());
      paramasmo.extraData.putInt("uint32_action", 1);
      sendPbReq(paramasmo);
      return true;
    }
    catch (NumberFormatException paramasmo)
    {
      QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, "EnterExtendFriend. error = " + paramasmo);
    }
    return false;
  }
  ...
  public void b()
  {
    notifyUI(17, true, Integer.valueOf(awui.a(this.app)));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localasnq = new asnq();
          localasnq.mUin = String.valueOf(localStrangerInfo.uint64_uin.get());
          localasnq.mNickName = localStrangerInfo.bytes_nick.get().toStringUtf8();
          localasnq.mGender = localStrangerInfo.uint32_gender.get();
          if (localStrangerInfo.uint32_is_my_like.get() != 1) {
            break label1731;
          }
          bool4 = true;
          localasnq.mLiked = bool4;
          localasnq.mAvailLikeCount = localStrangerInfo.uint32_my_left_like_count.get();
          if (localStrangerInfo.uint32_addfri_status.get() != 1) {
            break label1737;
          }
          bool4 = true;
          localasnq.mAddFriendVerified = bool4;
          localasnq.mPopularity = localStrangerInfo.uint32_popularity.get();
          localasnq.mDeclaration = localStrangerInfo.bytes_declaration.get().toStringUtf8();
          localasnq.mVoiceUrl = localStrangerInfo.bytes_voice_url.get().toStringUtf8();
          localasnq.mVoiceDuration = localStrangerInfo.uint32_voice_duration.get();
          if (localStrangerInfo.uint32_vote_switch.get() != 0) {
            break label1743;
          }
          bool4 = true;
          localasnq.mbAllowStrangerVote = bool4;
          localasnq.mStrRecomTrace = localStrangerInfo.str_recom_trace.get();
          localasnq.voiceCode = localStrangerInfo.bytes_voice_code.get().toByteArray();
          ...
          localasnq.fontId = paramToServiceMsg.fontid.get();
          localasnq.fontType = paramToServiceMsg.fonttype.get();
          localasnq.clothesId = paramToServiceMsg.itemid.get();
          if (!TextUtils.isEmpty(localasnq.mDeclaration))
          {
            localasnq.mDeclaration = localasnq.mDeclaration.replace('\n', ' ');
            localasnq.mDeclaration = localasnq.mDeclaration.trim();
          }
          if (localStrangerInfo.uint32_show_vip_info_flag.get() != 0) {
            break label1749;
          }
          bool4 = true;
          localasnq.mVipHide = bool4;
          if (localStrangerInfo.uint32_bigvip_open.get() != 0) {
            break label1755;
          }
          bool4 = true;
          localasnq.mBigVipHide = bool4;
          localasnq.mBigVipLevel = localStrangerInfo.uint32_bigvip_level.get();
          localasnq.mVipType = localStrangerInfo.uint32_vip_flag.get();
          localasnq.mVipLevel = localStrangerInfo.uint32_svip_level.get();
          localasnq.mTemplateId = localStrangerInfo.uint32_vipicon_id.get();
          ...
          label659:
          localasnq.mAlumbasicdata = paramToServiceMsg;
          localasnq.mAge = localStrangerInfo.uint32_age.get();
          localasnq.mLabelInfos = new ArrayList();
          Object localObject3;
          if (localStrangerInfo.rpt_label_info.has())
          {
            ...
            {
              localObject3 = new asnr();
              ((asnr)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.labelInfo)localStrangerInfo.rpt_label_info.get().get(i)).uint64_label_id.get();
              ...
              label812:
              ((asnr)localObject3).jdField_a_of_type_JavaLangString = paramToServiceMsg;
              localasnq.mLabelInfos.add(localObject3);
              i += 1;
              continue;
            }
          }
          localasnq.mSchoolInfos = new ArrayList();
          if (localStrangerInfo.rpt_school_info.has())
          {
            i = 0;
            if (i < localStrangerInfo.rpt_school_info.get().size())
            {
              localObject3 = new asns();
              ((asns)localObject3).jdField_a_of_type_JavaLangString = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).str_school_id.get();
              ((asns)localObject3).jdField_a_of_type_Long = ((ExtendFriendSquareInfo.schoolInfo)localStrangerInfo.rpt_school_info.get().get(i)).uint64_state.get();
              ...
              ((asns)localObject3).jdField_b_of_type_JavaLangString = paramToServiceMsg;
              if (QLog.isColorLevel()) {
                QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: schoolId " + ((asns)localObject3).jdField_a_of_type_JavaLangString + " schoolName " + ((asns)localObject3).jdField_b_of_type_JavaLangString + " authState " + ((asns)localObject3).jdField_a_of_type_Long);
              }
              localasnq.mSchoolInfos.add(localObject3);
              i += 1;
              continue;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandler", 2, "handleGetSquareStrangerList: " + localasnq.mUin + " " + localStrangerInfo.uint32_vip_flag.get() + " " + localStrangerInfo.uint32_svip_level.get());
          }
          if ((TextUtils.isEmpty(localasnq.mNickName)) && (localasnq.mAlumbasicdata == null)) {
            break label1252;
          }
          localArrayList.add(localasnq);
          continue;
          assw.a().c(paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode());
        }
        catch (Exception paramToServiceMsg)
        {
          if (QLog.isColorLevel()) {
        ...
        return;
        if (QLog.isColorLevel()) {
          QLog.w("ExtendFriendHandler", 2, String.format("handleGetSquareStrangerList nick name is empty, uin=%s", new Object[] { localasnq.mUin }));
        }
      }
      paramToServiceMsg = new asnd();
      ...
      if (n <= 12)
      {
        ...
        {
          paramToServiceMsg.jdField_a_of_type_JavaUtilList.add(((asnq)((List)localObject1).get(i)).mUin);
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      if (i < n)
      {
        ...
        break label1782;
        if (this.app != null) {
          ((asqt)this.app.getManager(QQManagerFactory.EXTEND_FRIEND_LIMIT_CHAT_MANAGER)).a(true, paramToServiceMsg);
        }
        if (QLog.isColorLevel()) {
  ...
  public boolean b()
  {
    try
    {
      ...
      Object localObject2 = (aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (localObject2 != null)
      {
        localObject2 = ((aslo)localObject2).a();
        if (localObject2 != null)
  ...
  public boolean b(String paramString)
  {
    ...
    try
    {
      ...
      paramString = (aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (paramString != null)
      {
      ...
      catch (InvalidProtocolBufferMicroException paramObject)
      {
        try
        {
          ...
          if (localRspBody.rpt_label_info.has())
          {
            ...
            {
              localObject1 = new asnr();
              ((asnr)localObject1).jdField_a_of_type_Long = ((GetExtendFriendInfo.labelInfo)localRspBody.rpt_label_info.get().get(i)).uint64_label_id.get();
              ...
              ((asnr)localObject1).jdField_a_of_type_JavaLangString = paramFromServiceMsg;
      ...
      if (i == 0) {
        if (localRspBody.uint64_allow_kuolie.has())
        {
          ...
          if (this.app != null)
          {
            ...
            asrt.a(this.app, bool2, j, i, paramToServiceMsg, l2);
            if (bool2) {
          ...
          bool3 = true;
          label257:
          asqt.b(this.app, Boolean.valueOf(bool3));
          if (QLog.isColorLevel()) {
  ...
  public void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (localRspBody.enum_matchopcode.has())
    {
      ...
      paramToServiceMsg = (aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER);
      if (paramToServiceMsg != null) {
      ...
      localObject2 = new asne();
      ((asne)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(localRspBody.uint64_uin.get());
      ((asne)localObject2).jdField_a_of_type_ArrayOfByte = ((oidb_0xe03.MatchInfo)localObject1).bytes_sig.get().toByteArray();
      ...
      ((asne)localObject2).jdField_b_of_type_JavaLangString = paramToServiceMsg;
      ...
      label456:
      ((asne)localObject2).jdField_a_of_type_Int = k;
      ...
      label486:
      ((asne)localObject2).jdField_d_of_type_JavaLangString = paramToServiceMsg;
    ...
    for (paramToServiceMsg = ((oidb_0xe03.MatchInfo)localObject1).string_report_id.get();; paramToServiceMsg = "")
    {
      ...
      ((asne)localObject2).e = ((String)localObject1);
      if (localRspBody.msg_match_info.msg_tag.has()) {
        if (localRspBody.msg_match_info.msg_tag.uint32_tag_id.has())
        {
          ((asne)localObject2).jdField_b_of_type_Int = localRspBody.msg_match_info.msg_tag.uint32_tag_id.get();
          label594:
          if (localRspBody.msg_match_info.msg_tag.bytes_tag.has()) {
            ((asne)localObject2).f = localRspBody.msg_match_info.msg_tag.bytes_tag.get().toStringUtf8();
          }
          label633:
          if (!localRspBody.msg_match_info.msg_match_uin_data.has()) {
            break label942;
          }
          if (((asne)localObject2).jdField_a_of_type_Asmk == null)
          {
            ((asne)localObject2).jdField_a_of_type_Asmk = new asmk();
            ((asne)localObject2).jdField_a_of_type_Asmk.jdField_a_of_type_JavaLangString = ((asne)localObject2).jdField_b_of_type_JavaLangString;
          }
          a(localRspBody.msg_match_info.msg_match_uin_data, ((asne)localObject2).jdField_a_of_type_Asmk);
          label697:
          if (QLog.isColorLevel()) {
            QLog.d("ExtendFriendHandlerExtendFriendLimitChat", 2, new Object[] { "handleMatchResponse type =" + m, " uin = ", str, ", match_op = ", Integer.valueOf(i), " retCode = ", Integer.valueOf(j), " matchInfo = ", ((asne)localObject2).toString(), " errMsg = ", paramObject });
          }
      ...
      for (;;)
      {
        ...
        if (m == 13)
        {
          if (localRspBody.uint32_switch.has())
          {
            ...
            localObject1 = new asnt();
            localObject2 = (oidb_0xe03.TagInfo)localRspBody.rpt_tag.get(k);
            ((asnt)localObject1).jdField_a_of_type_Int = ((oidb_0xe03.TagInfo)localObject2).uint32_tag_id.get();
            ...
            label1326:
            ((asnt)localObject1).jdField_a_of_type_JavaLangString = paramToServiceMsg;
          ...
          {
            ((asnt)localObject1).jdField_b_of_type_Int = m;
          ...
          for (boolean bool3 = true;; bool3 = false)
          {
            ...
            asqt.a(this.app, Boolean.valueOf(bool1));
            asqt.b(this.app, Boolean.valueOf(bool2));
            asqt.a(this.app, paramObject);
            if (!QLog.isColorLevel()) {
              break;
            }
        ...
        {
          ((aslo)this.mApp.getManager(QQManagerFactory.EXTEND_FRIEND_MANAGER)).h();
          if (QLog.isColorLevel()) {
