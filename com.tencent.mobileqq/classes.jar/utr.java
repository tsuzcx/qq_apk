...
public class utr
  extends AsyncTask<utt, utv, utu>
{
  public final uio a;
  
  public utr(uio paramuio)
  {
    if (paramuio == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	wsv:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	utr:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    wsv.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    wsv.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    wsv.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected utu a(utt... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new utu(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new uts(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        xmx.d(paramVarArgs.b);
        return new utu(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new utu(paramVarArgs, i, "error=" + i);
  }
}
