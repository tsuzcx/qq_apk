...
public class awqd
  extends awqa
{
  public awqd(MsgBackupResEntity paramMsgBackupResEntity)
  {
  ...
  public awnz a()
  {
    ...
    if (str1 == null)
    {
      ...
      localawnz.jdField_a_of_type_Boolean = false;
      return localawnz;
    }
    String str2 = a(str1);
    ...
    localawnz.jdField_a_of_type_JavaLangString = str2;
    return localawnz;
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (!TextUtils.isEmpty(str1))
        {
          try
          {
            paramMsgBackupResEntity = bdsh.d(new URL(paramMsgBackupResEntity, null, str1).toString());
  ...
  public String a(String paramString)
  {
    try
    {
      ...
      paramString = awqo.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
