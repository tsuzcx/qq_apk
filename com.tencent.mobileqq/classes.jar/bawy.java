  ...
  extends baww
{
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    else
    {
      ...
      str = new bawq().a((AIOFilePictureData)paramRichMediaBrowserInfo.baseData, 20);
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        catch (Throwable localThrowable)
        {
          ...
          continue;
          GalleryUrlImageView localGalleryUrlImageView = (GalleryUrlImageView)this.jdField_a_of_type_Baxx.mBrowserItemView.findViewById(2131368246);
          if (localGalleryUrlImageView == null) {
            break label386;
          }
          localGalleryUrlImageView.setGalleryImageListener(new bawz(this, paramString, paramRichMediaBrowserInfo));
          localGalleryUrlImageView.setImageDrawable(paramString);
          this.jdField_a_of_type_Baxx.a = afur.a(this.jdField_a_of_type_Baxx.b, paramString);
        }
        if (paramString != null) {
          continue;
        }
        QQToast.a(this.jdField_a_of_type_Baxx.mContext, this.jdField_a_of_type_Baxx.mContext.getString(2131694413), 0).a();
        return;
    ...
    {
      if (!this.jdField_a_of_type_Baxx.mContext.getString(2131692466).equals(paramString)) {
        break label467;
      }
      QQToast.a(this.jdField_a_of_type_Baxx.mContext, paramString, 0).a();
    }
    for (;;)
    {
  ...
  public void a(int paramInt, URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((this.jdField_a_of_type_Baxx != null) && (paramInt == getCurrentPosition())) {
        this.jdField_a_of_type_Baxx.bindView(paramInt);
      }
    }
  }
    ...
    if ((localObject2 != null) && (((RichMediaBrowserInfo)localObject2).baseData != null) && (((AIOBrowserBaseData)((RichMediaBrowserInfo)localObject2).baseData).jdField_a_of_type_Long == paramLong))
    {
      ...
      if ((this.mainBrowserPresenter != null) && (this.mainBrowserPresenter.browserModel != null))
      {
        ...
        if ((paramInt3 == 2) && (!TextUtils.isEmpty(paramString))) {
          new bawq().b((AIOFilePictureData)((RichMediaBrowserInfo)localObject2).baseData, paramInt2, paramString);
        }
        this.jdField_a_of_type_Baxx.updateView(paramInt1, this.jdField_a_of_type_Baxx.mBrowserItemView, paramBoolean);
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bawx != null) && (this.jdField_a_of_type_Bawx.a != null) && (this.jdField_a_of_type_Bawx.a() != null))
    {
      ...
      this.jdField_a_of_type_Bawx.a().a((int)afur.a(bqcd.jdField_a_of_type_Int, this.jdField_a_of_type_Baxx.mContext.getResources()) + 40);
    }
    for (;;)
    {
  ...
  public boolean b()
  {
    if (QLog.isColorLevel()) {
      QLog.d("AIOFilePicPresenter", 2, "isImmersionOpen, ImmersiveConfProcessor.isImageEnable() = " + aqgz.a());
    }
    return aqgz.a();
  }
  ...
  {
    super.onDestroy();
    if (this.jdField_a_of_type_Baxx.a != null) {
      this.jdField_a_of_type_Baxx.b.removeCallbacks(this.jdField_a_of_type_Baxx.a);
    }
  }
  ...
  public void setGalleryView(BrowserBaseView paramBrowserBaseView)
  {
    ...
    if ((paramBrowserBaseView instanceof baxx)) {
      this.jdField_a_of_type_Baxx = ((baxx)paramBrowserBaseView);
    }
  }
}
