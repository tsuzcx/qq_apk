  ...
  extends blqj
{
  ...
  static
  {
    jdField_a_of_type_JavaIoFile = new File(blzq.a(), "dov_doodle_sticker");
  }
  ...
  public ArrayList<DoodleEmojiItem> a()
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   6: ifnonnull +153 -> 159
    //   9: aload_0
    //   10: monitorenter
    //   11: aload_0
    //   12: getfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   15: ifnonnull +142 -> 157
    //   18: getstatic 25	blvu:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   21: ldc 104
    //   23: invokestatic 126	blzq:a	(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    //   26: astore_3
    //   27: aload_3
    ...
    //   35: aload_0
    //   36: aload_3
    //   37: invokespecial 134	blvu:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   40: putfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   61: astore_3
    //   62: aload_0
    //   63: getfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   66: ifnull +98 -> 164
    //   69: iconst_1
    //   70: istore_1
    //   71: ldc 78
    ...
    //   85: aload_0
    //   86: getfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   89: ifnull +13 -> 102
    //   92: aload_0
    //   93: getfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   96: invokevirtual 139	java/util/ArrayList:size	()I
    //   99: ifne +58 -> 157
    //   102: aload_0
    //   103: aload_0
    //   104: ldc 141
    //   106: invokestatic 144	blzq:a	(Ljava/lang/String;)Ljava/lang/String;
    //   109: invokespecial 134	blvu:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   112: putfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   133: astore_3
    //   134: aload_0
    //   135: getfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   138: ifnull +31 -> 169
    //   141: iload_2
    //   142: istore_1
    //   143: ldc 78
    ...
    //   158: monitorexit
    //   159: aload_0
    //   160: getfield 123	blvu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   163: areturn
    //   164: iconst_0
    //   165: istore_1
    //   166: goto -95 -> 71
  ...
  public void a(String paramString)
  {
    ...
    if ((localObject != null) && (!((ArrayList)localObject).isEmpty()))
    {
      ...
      localObject = (blvi)blqr.a().c(4);
      if (((blvi)localObject).a != null) {
        ((blvi)localObject).a.clear();
      }
      ((bmru)uwa.a(39)).a(this.jdField_a_of_type_JavaUtilArrayList);
      a().notifyObservers(bltq.class, 4, true, null);
      if (QLog.isColorLevel()) {
        QLog.i("QIMPasterConfigManager", 2, "paster config send notify");
      }
      blzq.a(jdField_a_of_type_JavaIoFile, "doodle_sticker_config.cfg", paramString);
    }
    if (QLog.isColorLevel())
    {
