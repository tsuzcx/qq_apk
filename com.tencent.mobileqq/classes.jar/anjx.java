  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private anqd jdField_a_of_type_Anqd = new ankc(this);
  public anrd a;
  ...
  public dk a;
  public String a;
  private ArrayList<bbxm> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  protected HashMap<Long, bbxl> a;
  ...
  public anjx(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Anrd = new anrd(paramQQAppInterface);
    this.jdField_a_of_type_Dk = new dk(paramQQAppInterface);
    this.jdField_a_of_type_Dc = new dc(paramQQAppInterface);
    this.jdField_c_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296758);
    this.jdField_d_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296757);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new anjy(this);
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new anka(this, paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new ankb(this);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Anqd);
    this.jdField_a_of_type_Blja = new blja(paramQQAppInterface);
    f();
    g();
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2, int paramInt4)
  {
    ...
    paramString = a(13, paramString, localbbzm, l, bbzj.b(paramLong1), paramLong2);
  ...
  private void a(int paramInt, long paramLong, String paramString)
  {
    ...
    localDataLineMsgRecord.md5 = bgmj.a(paramString);
    if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
      QLog.d("DataLineHandler", 4, "SessionUpdateType_FileMD5, uSessionID[" + paramLong + "], strValuebuf[" + paramString + "], strMD5MR[" + bgmj.a(localDataLineMsgRecord.md5) + "], strMD5Notify" + paramString);
    }
    this.app.a().a(i).a(localDataLineMsgRecord.msgId, localDataLineMsgRecord.serverPath, localDataLineMsgRecord.md5);
  }
  ...
  private void a(int paramInt1, DataLineMsgRecord paramDataLineMsgRecord, int paramInt2)
  {
    ...
    if (paramDataLineMsgRecord.isSend())
    {
      if (paramInt2 == 2)
      {
        ...
        bcst.b(this.app, "CliOper", "", "", "0X8006223", "0X8006223", 0, 0, "", "", "", "");
        return;
      }
      if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
      {
        ...
        bcst.b(this.app, "CliOper", "", "", "0X8006224", "0X8006224", 0, 0, "", "", "", "");
        return;
      }
      paramDataLineMsgRecord.fileMsgStatus = 0L;
      this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
    ...
    if (paramInt2 == 2)
    {
      ...
      String str = atwe.a(paramDataLineMsgRecord.path);
      if (str != null)
      {
        bgmg.d(paramDataLineMsgRecord.path);
      ...
      this.app.a().a(paramInt1).a(paramDataLineMsgRecord.msgId);
      this.app.a().a(paramInt1).c();
      bcst.b(this.app, "CliOper", "", "", "0X8006226", "0X8006226", 0, 0, "", "", "", "");
      return;
    }
    if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
    {
      ...
      this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
      this.app.a().a(paramInt1).b(paramDataLineMsgRecord.msgId);
      bcst.b(this.app, "CliOper", "", "", "0X8006227", "0X8006227", 0, 0, "", "", "", "");
      return;
    }
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      {
        ((bdks)this.app.getManager(305)).a(localDataLineMsgRecord, i);
        return;
      }
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.a().a().a(paramWeiYunFileInfo, new anjz(this, l));
  }
  
  private void a(ToServiceMsg paramToServiceMsg)
  {
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), ankf.class);
  ...
  private boolean a(bbxm parambbxm)
  {
    int j = 0;
    int i = 0;
    StringBuffer localStringBuffer = new StringBuffer();
    int m = parambbxm.a(localStringBuffer);
    if (m == -1) {
      return false;
    }
    int k;
    if (this.jdField_a_of_type_Int == 0) {
      while (i < localStringBuffer.length())
      {
        ...
        if (localStringBuffer.charAt(i) == '\024')
        {
          ...
          {
            k = arvq.a(localStringBuffer.charAt(i + 1));
            j = i;
            if (k >= 0)
            {
    ...
    parambbxm.a(a(parambbxm.a().longValue(), 1001, parambbxm.a(), m, localStringBuffer.toString().getBytes()));
    return true;
  }
  ...
  private void b(List<SubMsgType0x7.MsgBody.MoloNotify> paramList)
  {
    ...
    for (;;)
    {
      ...
      localDataLineMsgRecord.fileMsgStatus = 1L;
      bool = bgnt.h(BaseApplication.getContext());
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    paramToServiceMsg.path = (anhk.bp + paramToServiceMsg.filename);
  ...
  private void d(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (bgmg.b(paramDataLineMsgRecord.thumbPath));
      str = atvo.a(str, 384, 384);
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size()) {
      if (!((bbxm)this.jdField_a_of_type_JavaUtilArrayList.get(i)).a().equals(paramToServiceMsg)) {}
    }
    for (paramToServiceMsg = (bbxm)this.jdField_a_of_type_JavaUtilArrayList.get(i);; paramToServiceMsg = null)
    {
      if (paramToServiceMsg == null) {}
      do
      {
  ...
  public void GetThumbFilePath(int paramInt, Session paramSession)
  {
    ...
    Object localObject = (antz)this.app.a(10);
    if ((localObject != null) && (((antz)localObject).a() == 0))
    {
  ...
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    if (paramSession.bSend)
    {
      bcst.b(this.app, "CliOper", "", "", "0X8006222", "0X8006222", 0, 0, "", "", "", "");
      if ((paramSession.actionInfo != null) && (paramSession.actionInfo.strServiceName != null) && (paramSession.actionInfo.strServiceName.length() != 0)) {
        break label210;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      a(paramSession);
      return;
      bcst.b(this.app, "CliOper", "", "", "0X8006225", "0X8006225", 0, 0, "", "", "", "");
      break;
      label199:
  ...
  public Session a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      localSession.strFilePathSrc = atwe.c(localDataLineMsgRecord.path);
      ...
      if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
        QLog.d("DataLineHandler", 4, "getSessionFromMsgRecord, uSessionID[" + localDataLineMsgRecord.sessionid + "], strMR[" + bgmj.a(localDataLineMsgRecord.md5) + "], filesize[" + localDataLineMsgRecord.filesize);
      }
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x345 paramMsgCSBody0x345)
  {
    ...
    for (localObject = arrayOfByte;; localObject = createToServiceMsg("GTalkFileAppSvr.CMD_DISCUSS_FILE", null))
    {
      ...
      if (localObject != null)
      {
        ...
        bgva.a(arrayOfByte, 0, paramMsgCSBody0x345.length + 4);
        bgva.a(arrayOfByte, 4, paramMsgCSBody0x345, paramMsgCSBody0x345.length);
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x346 paramMsgCSBody0x346)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bgva.a((byte[])localObject2, 0, paramMsgCSBody0x346.length + 4);
        bgva.a((byte[])localObject2, 4, paramMsgCSBody0x346, paramMsgCSBody0x346.length);
        paramMsgCSBody0x346 = (MsgCSBody0x346)localObject1;
  ...
  public Long a(String paramString, int paramInt)
  {
    ...
    localDataLineMsgRecord.issuc = false;
    ((anuk)this.app.a(13)).a(localDataLineMsgRecord);
    ...
    localDataLineMsgRecord.issuc = true;
    paramString = new bbxm(paramString, localLong, localDataLineMsgRecord);
    if (!a(paramString)) {
      return Long.valueOf(0L);
    }
  ...
  protected void a(long paramLong1, long paramLong2, SubMsgType0x7.MsgBody.GenericSubCmd paramGenericSubCmd, SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        case 1: 
          ...
          default: 
            ...
            {
              localbbxl = new bbxl(Long.valueOf(paramGenericSubCmd.uint32_size.get()), Long.valueOf(l));
              this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localbbxl);
            ...
            {
              localbbxl = (bbxl)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
              continue;
            }
            if (!paramGenericSubCmd.uint32_index.has()) {
              break label697;
            }
            localbbxl.a(paramGenericSubCmd.uint32_index.get(), paramMsgHeader);
            if (!localbbxl.a()) {
              break label697;
            }
            ...
            if (i == 1)
            {
              paramGenericSubCmd = localbbxl.a();
              i = 0;
              if (i < bdnh.a.length)
              {
                paramMsgHeader = paramGenericSubCmd;
                if (paramGenericSubCmd.indexOf('\024' + bdnh.a[i]) == -1) {
                  break label714;
                }
                paramMsgHeader = paramGenericSubCmd.replace('\024' + bdnh.a[i], "\024" + (char)i);
                break label714;
              }
              ...
              h();
              a(8, true, new Object[] { Integer.valueOf((int)paramLong1), localbbxl.a(), Long.valueOf(((DataLineMsgRecord)localObject1).sessionid) });
              return;
            }
            break;
          }
      ...
      ((DataLineMsgRecord)localObject1).msg = localbbxl.a();
      continue;
      awni.a().a(paramGenericSubCmd);
      return;
      label691:
      break label705;
      label694:
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = atwl.a(atwl.a(this.app.getApplication()), atvo.a(paramFileManagerEntity.strThumbPath));
      bgmg.d(paramFileManagerEntity.strThumbPath, localDataLineMsgRecord.thumbPath);
    }
    ...
    Object localObject = (anjx)this.app.a(8);
    localDataLineMsgRecord.sessionid = ((anjx)localObject).a(0, 0).longValue();
    localDataLineMsgRecord.msg = "";
    localDataLineMsgRecord.issend = 1;
    localDataLineMsgRecord.isread = true;
    localDataLineMsgRecord.issuc = false;
    ...
    ((anjx)localObject).a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.a().a(DataLineMsgRecord.getDevTypeBySeId(localDataLineMsgRecord.sessionid)).a(localDataLineMsgRecord, true);
    localanjx.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getServiceCmd().equals("MessageSvc.PbSendMsg"))
    {
      ...
      awni.a().a(paramToServiceMsg, paramFromServiceMsg, paramObject);
    }
    label72:
  ...
  {
    this.jdField_a_of_type_Blja.a(paramMsg);
  }
  
  public void a(msg_comm.Msg paramMsg, SubMsgType0x7.MsgBody paramMsgBody)
  {
    this.jdField_a_of_type_Blja.a(paramMsg, paramMsgBody);
    DataLineMsgRecord localDataLineMsgRecord;
    try
    {
      localDataLineMsgRecord = new DataLineMsgRecord();
    ...
    localObject = (antz)this.app.a(10);
    if ((localObject != null) && (((antz)localObject).d() != 1)) {
      ((antz)localObject).e(1);
    }
  ...
  public void a(msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    this.jdField_a_of_type_Anrd.a(this, paramMsg, paramMsgBody);
  }
  ...
  public boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    for (;;)
    {
      ...
      bgva.a(arrayOfByte, 0, localObject2.length + 4);
      bgva.a(arrayOfByte, 4, (byte[])localObject2, localObject2.length);
      if (localObject1 != null)
      {
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    bgva.a(arrayOfByte, 0, paramFromServiceMsg.getWupBuffer(), 4, j);
    label390:
  ...
  public void d()
  {
    long l = this.app.a().a(String.valueOf(anhk.z), 6000).time;
    ...
    if ((l != 0L) && (l != this.jdField_c_of_type_Long))
    {
      ...
      ((acvt)this.app.a().a("c2c_processor")).a(localArrayList);
      this.jdField_c_of_type_Long = l;
    }
    l = this.app.a().a(String.valueOf(anhk.A), 6003).time;
  ...
  public void onDestroy()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if ((this.app != null) && (this.app.getApp() != null) && (this.jdField_a_of_type_Anqd != null))
        {
        ...
        this.jdField_a_of_type_Blja.a();
        this.jdField_a_of_type_Dg.a();
        this.jdField_a_of_type_Anrd.a();
  ...
  {
    this.jdField_a_of_type_Blja.a(paramToServiceMsg, paramFromServiceMsg, (byte[])paramObject);
