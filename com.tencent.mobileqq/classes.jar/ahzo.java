  ...
  extends BaseChatPie
{
  ...
  anif jdField_a_of_type_Anif = new ahzs(this);
  private ankx jdField_a_of_type_Ankx = new ahzr(this);
  protected anqd a;
  public bkho a;
  private Observer jdField_a_of_type_JavaUtilObserver = new ahzu(this);
  private Dialog c;
  private TextView l;
  
  public ahzo(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_a_of_type_Anqd = new ahzv(this);
  }
  
  private void bp()
  {
    ankw localankw = (ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
    DiscussionInfo localDiscussionInfo = localankw.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    ...
    if (localankw.a.containsKey(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      bq();
    }
  }
  ...
  private void bq()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          localankw = (ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
          if (localankw.a.containsKey(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
            break;
          }
        ...
        return;
        localObject1 = (String[])localankw.a.get(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      try
      {
        localObject1 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130842420);
      ...
      catch (OutOfMemoryError localOutOfMemoryError1)
      {
        try
        {
          localObject2 = bgmo.b((Bitmap)localObject1, 10.0F, 140, 140);
          this.c = bglp.a(this.jdField_a_of_type_AndroidContentContext, (Bitmap)localObject2, bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str2) + anni.a(2131702126), anni.a(2131702125) + str1, this.jdField_a_of_type_AndroidContentContext.getString(2131718062), null, new ahzq(this, str1), null);
          if ((this.c != null) && (!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing())) {
            this.c.show();
          }
          localankw.a.remove(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
          return;
        }
  ...
  public void L()
  {
    if (!this.M)
    {
      bfiv localbfiv = (bfiv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(363);
      if (localbfiv != null) {
        localbfiv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString + "&" + 3000, 0);
      }
    }
    super.L();
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt2 == -1) {
      ...
      case 6001: 
        ...
        paramIntent = bglf.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str1);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Anff.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.peerUin = str1;
      ...
      {
        VipUtils.a((AppInterface)localObject, "cmshow", "Apollo", "g_action_double_sent", str1, paramInt1, paramInt2, new String[] { str2, str3, paramIntent, this.jdField_a_of_type_Anff.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.peerUin, String.valueOf(System.currentTimeMillis() / 1000L) });
        return;
        paramInt1 = paramInt2;
      ...
      for (paramIntent = paramIntent.getStringExtra("result"); (paramIntent != null) && (!paramIntent.equals("")); paramIntent = "")
      {
        if (bgnt.d(a()))
        {
          ((anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue(), paramIntent);
          return;
        }
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131693991), 0).b(a());
        return;
  ...
  public void a(SessionInfo paramSessionInfo, awhc paramawhc, Spanned paramSpanned, QQAppInterface paramQQAppInterface, String paramString1, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, String paramString2)
  {
    if (paramSessionInfo.jdField_a_of_type_Int == 3000)
    {
      ...
      paramSpanned = bfmd.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText(), paramSpanned);
    }
    for (;;)
    {
  ...
  public void a(String paramString1, String paramString2, TextView paramTextView)
  {
    ...
    {
      return;
      i = ((ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      paramString1 = new bdnt(paramString1, 1);
      if (i > 0) {
        break;
      }
    ...
    if (this.jdField_l_of_type_AndroidWidgetTextView == null) {
      this.jdField_l_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365560));
    }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("_At_Me_DISC", 2, "memUin:" + paramString1 + " displayName:" + bgjw.a(paramString2) + " isRemoveOldAtFlag:" + paramBoolean);
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_l_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetPatchedButton.setText(anni.a(2131702122));
  ...
  public void ap()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ankx);
  ...
  {
    super.j();
    aild localaild = new aild(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aimj, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Afwy);
    ailf localailf = new ailf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aimj, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Afwy);
    ...
    this.jdField_a_of_type_Aimj.a(localaild);
    this.jdField_a_of_type_Aimj.a(localailf);
  ...
  public void o(int paramInt)
  {
    ...
    lmn locallmn = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue(), 2);
    if (locallmn != null)
    {
      if (!locallmn.a) {
        break label139;
      }
      bcst.b(null, "CliOper", "", "", "0X80066C0", "0X80066C0", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      ...
      return;
      label139:
      bcst.b(null, "CliOper", "", "", "0X80066BD", "0X80066BD", 0, 0, "", "", "", "");
    }
  }
  
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    if ((this.jdField_a_of_type_Beqr != null) && (this.jdField_a_of_type_Beqr.d()) && (this.jdField_a_of_type_Afwy != null)) {
      this.jdField_a_of_type_Beqr.b(0);
    }
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      return;
      DiscussionInfo localDiscussionInfo = ((ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      bool = false;
      if (localDiscussionInfo != null) {
        bool = localDiscussionInfo.isDiscussHrMeeting();
      }
    } while ((bool) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.length() == 0) || (paramInt3 != 1) || ((paramCharSequence.charAt(paramInt1) != '@') && (paramCharSequence.charAt(paramInt1) != 65312)) || (this.r) || (((agmv)a(27)).a));
    bs();
  }
  ...
  public void r()
  {
    this.d.setOnClickListener(new ahzp(this));
    if (mal.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
      this.d.setVisibility(0);
      this.d.setContentDescription(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131697747));
    }
    for (;;)
    {
      aU();
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      {
        paramObservable = (bepx)paramObject;
        if (paramObservable != null)
        {
          if (paramObservable.jdField_a_of_type_Int != bepw.jdField_a_of_type_Int) {
            break label127;
          }
      ...
      for (;;)
      {
        ...
        return;
        label127:
        if ((paramObservable.jdField_a_of_type_Int == bepw.b) && (this.jdField_e_of_type_AndroidViewView != null))
        {
