...
public class antd
  extends anrh
{
  public antd(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  private boolean C()
  {
    if (this.jdField_a_of_type_JavaLangString != null)
    {
      ...
      if (this.jdField_a_of_type_JavaLangString.startsWith("mqqzone"))
      {
        ...
        uyo.a(this.jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo, this.d);
        ukw.a(this.jdField_a_of_type_AndroidContentContext, this.d, this.jdField_a_of_type_ComTencentPbGetbusiinfoBusinessInfoCheckUpdate$AppInfo, localIntent);
      }
      for (;;)
      {
        for (;;)
