...
public class oeg
{
  private static Map<String, oeg> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private oeg(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidContentContext = pay.a().getApplication();
    a();
  }
  ...
  {
    int i = 0;
    paramString = SharePreferenceUtils.get(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString + "expo_stat_key_" + paramString);
  ...
  public static oeg a()
  {
    ...
    {
      if (jdField_a_of_type_JavaUtilMap.get(str) == null) {
        jdField_a_of_type_JavaUtilMap.put(str, new oeg(str));
      }
      return (oeg)jdField_a_of_type_JavaUtilMap.get(str);
    }
    finally {}
  }
  ...
  {
    Object localObject = SharePreferenceUtils.get(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString + "expo_stat_key_timewindow");
  ...
  private void c()
  {
    ...
    if ((TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) || (!Objects.equals(str, this.jdField_b_of_type_JavaLangString)))
    {
      ...
      SharePreferenceUtils.set(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString + "expo_stat_soft_fstreq", str);
    }
  }
  ...
  public boolean a()
  {
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = SharePreferenceUtils.get(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString + "expo_stat_soft_fstreq");
    }
    String str = this.jdField_a_of_type_JavaTextSimpleDateFormat.format(new Date());
  ...
  public int b()
  {
    ...
    {
      return i;
      str = SharePreferenceUtils.get(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString + "expo_stat_last_req_vd_cnt");
  ...
  public void b(int paramInt)
  {
    ...
    SharePreferenceUtils.set(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString + "expo_stat_last_req_vd_cnt", String.valueOf(paramInt));
  }
}
