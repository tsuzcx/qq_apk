...
public class mhr
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mhs(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new mht(this);
  ...
  private mjb jdField_a_of_type_Mjb;
  ...
  public mhr(View paramView, ViewStub paramViewStub, int paramInt, VideoController paramVideoController, AVActivity paramAVActivity)
  {
    ...
    this.jdField_a_of_type_Mjb = new mjb(paramVideoController, paramAVActivity);
  ...
  {
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373428);
    String str = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131694959);
    Object localObject = this.jdField_a_of_type_ComTencentAvVideoController.a.getApp();
    if (paramBoolean) {}
    for (int i = 2131694958;; i = 2131694957)
    {
      ...
      localSpannableString.setSpan(localmhz, 0, ((String)localObject).length(), 18);
  ...
  private void h()
  {
    ...
    int i = (int)mvd.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 4.0F);
    int j = (int)mvd.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 132.0F);
    int k = (int)mvd.a(this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getApplicationContext(), 8.0F);
  ...
  private void i()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373610)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
      if (lof.jdField_c_of_type_Boolean)
      {
        ...
        ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373606)).setText(this.jdField_a_of_type_ComTencentAvVideoController.a().n);
        h();
      }
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new mhy(this));
  ...
  private void j()
  {
    ...
    label164:
    label171:
    for (int i = 2130842234;; i = 2130842233)
    {
      localImageView.setBackgroundDrawable(localResources.getDrawable(i));
      return;
      i = 2130842231;
  ...
  private void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController != null)
    {
      ...
      if (locallff != null) {
        this.jdField_a_of_type_ComTencentAvVideoController.a(Long.valueOf(locallff.jdField_d_of_type_JavaLangString).longValue(), this.jdField_b_of_type_Int);
      }
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((localObject == null) || (((lff)localObject).jdField_d_of_type_Int != 2) || ((this.jdField_b_of_type_Boolean) && (this.jdField_c_of_type_Boolean)) || ((this.jdField_a_of_type_ComTencentAvVideoController.a().w != 0) && (this.jdField_a_of_type_ComTencentAvVideoController.a().w != 2)) || (this.jdField_a_of_type_ComTencentAvUiAVActivity.b() != 2));
          localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373509);
        } while (((localObject != null) && (((View)localObject).getVisibility() == 0)) || (this.jdField_a_of_type_AndroidViewView.findViewById(2131373636).getVisibility() != 0));
        if (paramInt < 2) {
          break;
        }
      } while ((!lof.jdField_c_of_type_Boolean) || (this.jdField_c_of_type_Boolean));
      ...
      localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373427);
      a(true);
      ((RelativeLayout)localObject).setVisibility(0);
      this.jdField_c_of_type_Boolean = true;
      bdll.b(null, "CliOper", "", "", "0X800AA5D", "0X800AA5D", 4, 0, "", "", "", "");
      return;
    } while ((paramInt < 1) || (this.jdField_b_of_type_Boolean));
    QLog.i("QavDoubleVideoSharpnessMangaer", 1, "onNetworkQualityChanged. networkQuality = " + paramInt);
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.L();
    this.jdField_a_of_type_ComTencentAvUiAVActivity.a.C(AudioHelper.b());
    Object localObject = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373427);
    a(true);
    ((RelativeLayout)localObject).setVisibility(0);
    this.jdField_b_of_type_Boolean = true;
    bdll.b(null, "CliOper", "", "", "0X800AA5D", "0X800AA5D", 3, 0, "", "", "", "");
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        } while ((locallff == null) || (locallff.jdField_d_of_type_Int != 2));
      ...
      mbb.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695176));
      this.e = true;
      bdll.b(null, "CliOper", "", "", "0X800AA60", "0X800AA60", 4, 0, "", "", "", "");
      return;
    } while ((paramInt1 < 1280) || (paramInt2 < 720) || (this.d));
    QLog.i("QavDoubleVideoSharpnessMangaer", 1, "onRecvVideoResolutionChanged. w = " + paramInt1 + ", h = " + paramInt2);
    mbb.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1058, this.jdField_a_of_type_ComTencentAvVideoController.a.getApp().getString(2131695177));
    this.d = true;
    bdll.b(null, "CliOper", "", "", "0X800AA60", "0X800AA60", 3, 0, "", "", "", "");
  }
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() < 5)
    {
      ...
      if (((Long)localIterator.next()).longValue() >= mtl.b()) {
        break label239;
      }
    ...
    for (;;)
    {
      ...
      if (paramLong1 >= 4L)
      {
        ...
        if (paramLong2 - this.jdField_a_of_type_Long > 10000L)
        {
          ...
          mbb.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1057, anzj.a(2131707787));
          bdll.b(null, "CliOper", "", "", "0X800A346", "0X800A346", 0, 0, "", "", "", "");
        }
  ...
  public void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (!paramBoolean)
    {
      if ((paramInt1 != 0) && (!TextUtils.isEmpty(paramString))) {
        mbb.a(this.jdField_a_of_type_ComTencentAvVideoController.a, 1057, paramString);
      }
      return;
    }
    int i;
    ...
    {
      if (paramInt1 == 10000) {
        bdll.b(null, "CliOper", "", "", "0X800AA5F", "0X800AA5F", 4, 0, "", "", "", "");
      }
  ...
  public void b()
  {
    ...
    localObjectAnimator.addListener(new mhw(this));
  ...
  public void d()
  {
    ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373427)).setVisibility(4);
    i();
    boolean bool = this.jdField_a_of_type_Mjb.a();
    ...
    {
      i = 3;
      bdll.b(null, "CliOper", "", "", "0X800AA5E", "0X800AA5E", i + 1, 0, "", "", "", "");
    ...
    Object localObject = new mhx(this);
    localObject = bhlq.a(this.jdField_a_of_type_ComTencentAvUiAVActivity, 0, anzj.a(2131707782), null, anzj.a(2131707783), anzj.a(2131707784), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
    if (localObject != null) {
