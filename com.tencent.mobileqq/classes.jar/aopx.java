  ...
  extends aopl
{
  ...
  public aopx(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (azzu.a()) {}
    for (long l = azzu.a() * 1024L; this.jdField_a_of_type_Aopm.d > l; l = azzu.b() * 1024L) {
      return true;
    }
    return false;
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Aopm.jdField_a_of_type_Long = 5L;
    this.jdField_a_of_type_Long = 3L;
    this.jdField_a_of_type_Aopm.jdField_b_of_type_Long = 9004L;
    a(false);
  }
  ...
  public void a(int paramInt1, int paramInt2, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    localaopm.jdField_b_of_type_Int = this.jdField_a_of_type_Aopm.jdField_b_of_type_Int;
    localaopm.jdField_a_of_type_Int = this.jdField_a_of_type_Aopm.jdField_a_of_type_Int;
    localaopm.c = this.jdField_a_of_type_Aopm.c;
    localaopm.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Aopm.jdField_a_of_type_JavaLangString;
    localaopm.d = this.jdField_a_of_type_Aopm.d;
    localaopm.jdField_a_of_type_Long = paramInt1;
    localaopm.jdField_b_of_type_Long = paramInt2;
    super.a(localaopm, paramExcitingTransferOneSlotComplete);
  }
  ...
  protected HashMap<String, String> b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null)
    {
      ...
      localHashMap.put("param_FailCode", String.valueOf(a(this.jdField_a_of_type_Aopm.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_nSrvReturnCode)));
      ...
      localHashMap.put("param_ipStackType", String.valueOf(apdq.a()));
    ...
    for (;;)
    {
      ...
      localHashMap.put("param_fsizeo", String.valueOf(this.jdField_a_of_type_Aopm.d));
      localHashMap.put("param_PeerUin", String.valueOf(this.jdField_a_of_type_Aopm.c));
      ...
      continue;
      localHashMap.put("param_FailCode", String.valueOf(this.jdField_a_of_type_Aopm.jdField_b_of_type_Long));
    }
  }
  
  public void b()
  {
    this.jdField_a_of_type_Aopm.jdField_a_of_type_Long = 1L;
    if (this.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_Long = 3L;; this.jdField_a_of_type_Long = 2L)
    {
      this.jdField_a_of_type_Aopm.jdField_b_of_type_Long = 9037L;
      a(false);
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Aopm.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Aopm.jdField_b_of_type_Long = paramLong;
    a(false);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloaderFirstPkgRp.mCSStartTime = awao.a();
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloaderFirstPkgRp.mCSEndTime = awao.a();
  }
