  ...
  extends lis
{
  ...
  static
  {
    jdField_a_of_type_ComTencentTtpicUtilDecryptListener = new lim();
  }
  ...
  public lit a(int paramInt1, int paramInt2)
  {
    ...
    if ((locallit != null) && (locallit.a != null)) {
      locallit.a.extraParam = Integer.valueOf(this.c);
    }
    return locallit;
  }
  ...
  public boolean a(long paramLong, PendantItem paramPendantItem)
  {
    ...
    if ((!a()) && (bool) && (paramPendantItem != null) && (!TextUtils.isEmpty(paramPendantItem.getId())) && (!TextUtils.equals("0", paramPendantItem.getId())))
    {
      ...
      if (locallhs != null) {
        locallhs.a(3004, paramPendantItem.getId());
      }
    }
    return bool;
  }
