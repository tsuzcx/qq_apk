...
public class aknu
  implements amos, Handler.Callback, Manager
{
  public static final String a;
  public static boolean a;
  private float jdField_a_of_type_Float = 7.0F;
  public int a;
  ajxj jdField_a_of_type_Ajxj = new aknv(this);
  private akil jdField_a_of_type_Akil = new aknw(this);
  private bfnk jdField_a_of_type_Bfnk = new bfnk(ThreadManager.getFileThreadLooper(), this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<akny> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private WeakReference<aknt> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajya.a(2131705700);
  }
  
  public aknu(QQAppInterface paramQQAppInterface)
  {
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = bbkb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "breaking_ice_config");
    }
    i2 = i3;
    m = n;
    k = i1;
  ...
  private void f()
  {
    ...
    Object localObject1 = bbdx.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bbdx.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bbdx.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bbdx.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
  ...
  private void g()
  {
    ...
    bbdx.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localConcurrentHashMap);
  }
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).o(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((ajxl)localObject1).b(str2))) {
          break label318;
        }
        i += 1;
      }
  ...
  public void a(aknt paramaknt)
  {
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramaknt);
  }
  
  public void a(akny paramakny)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakny);
  }
  
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString, amor paramamor)
  {
    if ((paramamor != null) && ("breaking_ice_config".equals(paramString)))
    {
      if (!this.jdField_b_of_type_Boolean) {
        f();
      }
      paramQQAppInterface = a(true, paramamor.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aexg.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      Object localObject = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
      boolean bool;
      int i;
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (akny)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
            ((akny)localObject).a(paramString, false);
          }
        }
        if (this.jdField_a_of_type_Bfnk.hasMessages(1)) {
          this.jdField_a_of_type_Bfnk.removeMessages(1);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("IceBreak.HotPic", 2, bfnu.a(paramArrayOfByte));
        return;
        ...
        while (i < paramArrayOfByte.size())
        {
          ...
          localaewv.a(localImgInfo.bytes_img_word.get().toStringUtf8());
          ...
          ((List)localObject).add(localaewv);
          i += 1;
        }
  ...
  public void b()
  {
    ...
    bbdx.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  
  public void b(akny paramakny)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == paramakny)) {
  ...
  public void c()
  {
    ...
    bbdx.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void d()
  {
    ...
    bbdx.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public boolean d(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        akny localakny = (akny)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localakny != null) {
          localakny.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_Bfnk.hasMessages(1)) {
        this.jdField_a_of_type_Bfnk.removeMessages(1);
  ...
  public boolean e(String paramString)
  {
    ...
    if (bool2)
    {
      paramString = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
  ...
  public void h(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (((aoeu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264)).c()) {
            break;
          }
      ...
      localakny = (akny)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localakny == null);
    localakny.a(paramString, false);
  }
  ...
  {
    if (!aexb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
