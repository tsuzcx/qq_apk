...
public class bawe
{
  ...
  public void a(Intent paramIntent)
  {
    ...
    for (int j = 1;; j = 0)
    {
      ...
      this.jdField_c_of_type_Boolean = localBundle.getBoolean(bley.jdField_b_of_type_JavaLangString, true);
      this.jdField_b_of_type_Boolean = localBundle.getBoolean(bley.jdField_a_of_type_JavaLangString);
      return;
      bool = true;
      break;
      bool = false;
