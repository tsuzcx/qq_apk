  ...
  extends acwf
{
  ...
  public beqt(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, acwe paramacwe)
  {
    super(paramQQAppInterface, paramProxyManager, paramacwe);
    this.jdField_a_of_type_JavaUtilComparator = new bequ(this);
  }
  ...
  private List<MessageRecord> b(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((localObject1 == null) || (((List)localObject1).isEmpty())) {
      if (paramBoolean1)
      {
        localObject1 = new bctq();
        if (Looper.myLooper() == Looper.getMainLooper()) {}
        for (int i = 1;; i = 0)
        {
          ((bctq)localObject1).jdField_a_of_type_Int = i;
          ((bctq)localObject1).jdField_a_of_type_JavaLangString = "select";
          ((bctq)localObject1).jdField_b_of_type_JavaLangString = "AIO";
          localList = a(paramString, paramInt, (bctq)localObject1);
          if ((((bctq)localObject1).jdField_b_of_type_Int != 0) && (bctj.a()) && (bctj.a(1)))
          {
            localObject2 = new HashMap();
            ((HashMap)localObject2).put("param_IsMainThread", String.valueOf(((bctq)localObject1).jdField_a_of_type_Int));
            ((HashMap)localObject2).put("param_OptType", ((bctq)localObject1).jdField_a_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_OptTotalCost", String.valueOf(((bctq)localObject1).jdField_a_of_type_Long));
            ((HashMap)localObject2).put("param_OptCount", String.valueOf(((bctq)localObject1).jdField_b_of_type_Int));
            ((HashMap)localObject2).put("param_OptMsgCount", String.valueOf(((bctq)localObject1).c));
            ((HashMap)localObject2).put("param_OptOneCost", String.valueOf(((bctq)localObject1).jdField_b_of_type_Long));
            ((HashMap)localObject2).put("param_OptScene", ((bctq)localObject1).jdField_b_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_WalSwitch", String.valueOf(SQLiteOpenHelper.WAL_ENABLE));
            bctj.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, ((bctq)localObject1).c, 0L, (HashMap)localObject2, null, false);
          }
        ...
        label423:
        new ArrayList();
        localObject2 = acwh.a(localList, false);
        ...
        if ((!acwh.a(paramString, paramInt, (List)localObject2)) && (acwh.b((List)localObject2)))
        {
          localObject1 = localObject2;
          if (!acwh.c((List)localObject2)) {}
        }
        else
        {
          ...
          localObject1 = acwh.a(localList, false, 30);
        }
        if ((acwh.a((List)localObject1)) || (localObject1 == null) || (((List)localObject1).isEmpty())) {
          break label1070;
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = acwh.a(localList, true);
        break label730;
        label980:
  ...
  protected int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    ayvj localayvj = a();
    String str = "( msgtype " + acwh.b() + " and isValid=1 ) and shmsgseq <= ?";
    long l = paramMessageRecord.shmsgseq;
    paramString = localayvj.query(false, paramString, new String[] { "_id" }, str, new String[] { String.valueOf(l) }, null, null, null, null);
    paramInt = i;
    if (paramString != null)
    {
  ...
  public MessageRecord a(String paramString, int paramInt, MessageRecord paramMessageRecord, List<MessageRecord> paramList)
  {
    ...
    label43:
    if (paramInt >= 0) {
      if (acwh.a((MessageRecord)paramList.get(paramInt), paramMessageRecord, true, true)) {
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, int[] paramArrayOfInt)
  {
    ...
    paramString = bgnn.a(MessageRecord.getOldTableName(paramString, paramInt1), MessageRecord.getTableName(paramString, paramInt1), paramLong1, paramInt2, paramLong2, (String)localObject1, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
    if (paramString == null) {
  ...
  public List<MessageRecord> a(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    if (bgnn.a(MessageRecord.getTableName(paramString1, paramInt1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()))
    {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localMessageRecord.shmsgseq == paramLong1) && ((!localMessageRecord.isSendFromLocal()) || (localMessageRecord.extraflag == 0)) && (!acwh.a(localMessageRecord))) {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, bctq parambctq)
  {
    ...
    try
    {
      paramString = super.a(paramString, paramInt, parambctq);
      if (paramString != null) {
        Collections.sort(paramString, this.jdField_a_of_type_JavaUtilComparator);
      }
      return paramString;
  ...
  protected void a(SessionInfo paramSessionInfo, String paramString, int paramInt, Set<String> paramSet)
  {
    ...
    paramSessionInfo = ((ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    paramString = paramSessionInfo.iterator();
    while (paramString.hasNext()) {
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    {
      a(paramString, paramInt, str2, localContentValues, String.format("isread=? and %s<=? and " + acwh.d(), new Object[] { "shmsgseq" }), new String[] { "0", str1 }, null);
      return;
    }
  ...
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramMessageRecord.isSendFromLocal()) || ((acwh.a(paramMessageRecord)) && (paramMessageRecord.msgtype != -4012) && (paramMessageRecord.msgtype != -4009) && (paramMessageRecord.msgtype != -5001) && (paramMessageRecord.msgtype != -5021)) || (acwh.f(paramMessageRecord)))
        {
          if ((localObject == null) || (((List)localObject).isEmpty()) || (((MessageRecord)((List)localObject).get(((List)localObject).size() - 1)).shmsgseq <= 0L)) {
            break label629;
          }
          if ((!acwh.j(paramMessageRecord.msgtype)) || (paramMessageRecord.shmsgseq <= 0L)) {}
        }
        else
        {
          ...
          if ((a().a().containsKey(str)) && (paramBoolean))
          {
            ...
            acwh.a((List)localObject, paramMessageRecord, true);
            if ((paramMessageRecord.msgtype == -2006) && (aklj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) && ((paramMessageRecord instanceof MessageForFoldMsg)) && (!paramMessageRecord.isSend()))
            {
              ...
              this.jdField_a_of_type_Aklj.a((List)localObject, (MessageForFoldMsg)paramMessageRecord);
            }
          }
          return;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.TroopMsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + atvo.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    paramString = localayvj.a(paramString, new String[] { String.valueOf(paramLong1) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
