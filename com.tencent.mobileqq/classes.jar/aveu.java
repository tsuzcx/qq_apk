...
{
  public aveu(StatusJsHandler paramStatusJsHandler) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 0)
        {
          ...
          ncw.a().a(localBaseActivity.getApplicationContext(), localBaseActivity.app, this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin, null, true);
