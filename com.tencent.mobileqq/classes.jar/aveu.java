...
public class aveu
{
  ...
  private aveu(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Int = localaver.b(paramString, paramInt1);
      ...
      if (!bbbg.b(paramMessage.msgtype))
      {
        bool = bbbg.c(paramMessage.msgtype);
        if (!bool) {
          break label235;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_JavaLangString = ajyc.a(2131709571);
      }
      catch (Exception paramMessage) {}
