  ...
  implements Manager
{
  ...
  private ardl jdField_a_of_type_Ardl;
  ...
  private static MessageRecord a(String paramString, nis paramnis)
  {
    MessageRecord localMessageRecord = new MessageRecord();
    localMessageRecord.selfuin = paramString;
    localMessageRecord.frienduin = paramnis.jdField_a_of_type_JavaLangString;
    localMessageRecord.senderuin = paramnis.jdField_a_of_type_JavaLangString;
    localMessageRecord.msgtype = -1000;
    localMessageRecord.msg = paramnis.f;
    localMessageRecord.time = paramnis.jdField_c_of_type_Long;
    localMessageRecord.shmsgseq = paramnis.jdField_a_of_type_Short;
    localMessageRecord.msgUid = paramnis.d;
  ...
  private void a()
  {
    ardh.b("installTVKSdk");
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(a(), "");
    this.jdField_a_of_type_Ardl = new ardl(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Ardl);
    try
    {
      TVK_SDKMgr.setOnLogListener(new ardj(this));
      ...
      {
        TVK_SDKMgr.installPlugin(this.jdField_a_of_type_AndroidContentContext, new ardk(this));
        return;
      }
      b();
      return;
  ...
  private void a(int paramInt)
  {
    ...
    {
      ardh.b("startVideoDownload queueType:" + paramInt);
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr == null)
      {
        ardh.b("startVideoDownload cache manager not init!");
        c();
        return;
      }
      if (paramInt <= this.jdField_a_of_type_Int)
      {
        ardh.b("startVideoDownload queue(" + this.jdField_a_of_type_Int + ") already run!");
        return;
      }
    }
    if (this.jdField_a_of_type_Int != 0)
    {
      ardh.b("startVideoDownload break current queue(" + this.jdField_a_of_type_Int + ")!");
    ...
    for (;;)
    {
      ...
      {
        ardh.b("startVideoDownload no task to download");
        c();
        return;
      ...
      else
      {
        ...
        if (!TextUtils.isEmpty(str1)) {
          ...
          {
            i = a(str1);
            ardh.b("startVideoDownload vid:" + str1 + ", cacheState:" + i);
            if (i != 2) {
        ...
        for (;;)
        {
          try
          {
            ...
            ardh.b("startVideoDownload vid:" + str1);
            return;
          }
          catch (IOException localIOException)
          {
            ardh.b("startVideoDownload create tmp file failed for vid:" + str1);
            continue;
          }
          i = bbfj.a(BaseApplication.getContext());
          ardh.b("startVideoDownload vid:" + str1 + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", curNetType:" + i + ", no valid network, skip to next task");
          b(paramInt);
          continue;
          ...
          b(paramInt);
          continue;
          ardh.b("startVideoDownload vid:" + str1 + ", expireTime:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mExpireTime + ", task expired, clean cache and skip to next task");
          b(paramInt);
          if (a(str1) != 0)
          {
            ThreadManager.executeOnFileThread(new ImaxAdVideoPreloadManager.7(this, str1));
            continue;
            ardh.b("startVideoDownload empty vid, skip to next task");
            b(paramInt);
          }
        }
        switch (paramInt)
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, aukp paramaukp, aktf paramaktf)
  {
    ...
    {
      ardf.a().a(((nis)localObject1).jdField_a_of_type_JavaLangString);
      ardf.a().a((nis)localObject1);
      ...
      paramMessageRecord.saveExtInfoToExtStr("recent_list_advertisement_uin_head_url", ((nis)localObject1).e);
    ...
    else
    {
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramaukp.b((auko)localObject2);
        ahpd.b(paramQQAppInterface, ((MessageRecord)localObject2).frienduin, ((MessageRecord)localObject2).istroop);
        localObject3 = paramaktf.a(paramMessageRecord.frienduin, paramMessageRecord.istroop);
        if (localObject3 != null)
        {
          ahnl.a().a(paramMessageRecord.frienduin + "-" + paramMessageRecord.istroop);
          paramaktf.b((RecentUser)localObject3);
        }
  ...
  private void a(List<PAAdPreloadTask> paramList, nis paramnis, nit paramnit)
  {
    ...
    localPAAdPreloadTask.mVideoVid = paramnit.b;
    localPAAdPreloadTask.mMsgId = paramnis.jdField_c_of_type_JavaLangString;
    localPAAdPreloadTask.mSource = 2;
    if (paramnis.jdField_a_of_type_Long > 0L) {}
    for (long l = paramnis.jdField_a_of_type_Long;; l = NetConnInfoCenter.getServerTimeMillis())
    {
      localPAAdPreloadTask.mReceiveTime = l;
      localPAAdPreloadTask.mExpireTime = paramnis.b;
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new ardm(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new ardn(this, null));
    }
  ...
  {
    ardh.b("continueDownload queueType:" + paramInt);
  ...
  {
    ardh.b("clearCacheVideo vid:" + paramString);
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  private void b(nis paramnis)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ImaxAdvertisement", 2, "insertToMsgSystem 0xf9 advertisementItem:" + paramnis.jdField_a_of_type_JavaLangString);
    }
    ...
    MessageRecord localMessageRecord = a(str, paramnis);
    localMessageRecord.advertisementItem = paramnis;
    paramnis = new ArrayList();
    paramnis.add(localMessageRecord);
    localQQAppInterface.a().a(paramnis, str, false, true, true);
  ...
  {
    paramString = ardf.a().a(paramString).iterator();
    while (paramString.hasNext())
    {
      nis localnis = (nis)paramString.next();
      b(localnis);
      localnis.jdField_a_of_type_Int = 1;
      ardh.b(a(), localnis.jdField_a_of_type_JavaLangString, localnis.a());
    }
  }
  ...
  private void d()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask != null)
    {
      axqy.a(null, "dc00898", "", "", "0X8008F77", "0X8008F77", 0, 0, "", "", this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid, String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mSource));
      return;
    }
    axqy.a(null, "dc00898", "", "", "0X8008F77", "0X8008F77", 0, 0, "", "", "", "");
  }
  ...
  private void d(String paramString)
  {
    ...
    {
      njc.b((String)localObject, paramString);
      return;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Int == 0) {
      ardh.b("onNetworkChange, no queue is working");
    }
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask == null)
      {
        ardh.b("onNetworkChange, no valid task");
        return;
      }
      if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.isNetworkValid())
      {
        ardh.b("onNetworkChange, vid:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", valid network, going on");
        return;
      }
      ardh.b("onNetworkChange, vid:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", invalid network, skip to next task");
  ...
  {
    ardh.b("loadLocalConfigTaskForImax uin:" + paramString);
    Object localObject3 = ardh.a(paramString);
    ??? = new ArrayList();
    Object localObject2 = new ArrayList();
    paramString = a();
    ardc.a().b(ardh.a(paramString, "delete_uin_list"));
    Object localObject5;
    if (localObject3 != null)
    {
      ardh.b("loadLocalConfigTaskForImax sp size:" + ((Map)localObject3).size());
      localObject4 = ((Map)localObject3).keySet().iterator();
      while (((Iterator)localObject4).hasNext())
      {
        localObject5 = nis.a((String)((Map)localObject3).get((String)((Iterator)localObject4).next()));
        if (localObject5 != null)
        {
          ardf.a().a((nis)localObject5);
          ((List)???).add(localObject5);
          if ((((nis)localObject5).c()) || (ardc.a().a(paramString, ((nis)localObject5).jdField_a_of_type_JavaLangString)))
          {
            ((List)localObject2).add(localObject5);
            if ((((nis)localObject5).jdField_a_of_type_JavaUtilArrayList != null) && (((nis)localObject5).jdField_a_of_type_JavaUtilArrayList.size() > 0))
            {
              localObject5 = ((nis)localObject5).jdField_a_of_type_JavaUtilArrayList.iterator();
              while (((Iterator)localObject5).hasNext()) {
                b(((nit)((Iterator)localObject5).next()).b);
              }
            }
          }
        }
    ...
    {
      localObject5 = ((aktf)localObject4).a(true);
      int i = 0;
      while (i < ((List)localObject5).size())
      {
        RecentUser localRecentUser = (RecentUser)((List)localObject5).get(i);
        nis localnis = ardf.a().b(localRecentUser.uin);
        if ((localRecentUser.getType() == 10005) && (localnis != null))
        {
          ((List)localObject3).add(localnis);
          if ((localnis.c()) || (ardc.a().a(paramString, localnis.jdField_a_of_type_JavaLangString)))
          {
            ahnl.a().a(localRecentUser.uin + "-" + localRecentUser.getType());
            ((aktf)localObject4).b(localRecentUser);
            ahpd.b(paramQQAppInterface, localRecentUser.uin, 10005);
    ...
    {
      localObject4 = (nis)paramQQAppInterface.next();
      ardf.a().a((nis)localObject4);
      ardh.b(paramString, ((nis)localObject4).jdField_a_of_type_JavaLangString, ((nis)localObject4).a());
    }
    ardh.b("loadLocalConfigTaskForImax recentImaxAdList:" + ((List)localObject3).size() + " expiredImaxAdList:" + ((List)localObject2).size() + " imaxAdList:" + ((List)???).size());
    paramQQAppInterface = new ArrayList();
    ??? = ((List)???).iterator();
    while (((Iterator)???).hasNext())
    {
      localObject2 = (nis)((Iterator)???).next();
      if ((((nis)localObject2).jdField_a_of_type_JavaUtilArrayList != null) && (((nis)localObject2).jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        localObject4 = (nit)((nis)localObject2).jdField_a_of_type_JavaUtilArrayList.get(0);
        if (!((List)localObject3).contains(localObject2)) {
          a(paramQQAppInterface, (nis)localObject2, (nit)localObject4);
        } else if (a(((nit)localObject4).b) != 2) {
          a(paramQQAppInterface, (nis)localObject2, (nit)localObject4);
        }
      }
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (paramQQAppInterface.size() > 0)
      {
        ...
        ardh.b("loadLocalConfigTaskForImax taskSize:" + paramQQAppInterface.size());
        ThreadManager.executeOnNetWorkThread(new ImaxAdVideoPreloadManager.3(this));
        ardc.a().c(paramString);
        return;
      }
      ardh.b("loadLocalConfigTaskForImax tasklist null");
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        localPAAdPreloadTask.mMsgId = bdik.d(localPAAdPreloadTask.mVideoVid);
        localPAAdPreloadTask.mSource = 2;
        ...
        ardh.b("handlePreloadTaskFromMessage msgid:" + localPAAdPreloadTask.mMsgId + ", vid:" + localPAAdPreloadTask.mVideoVid + ", add to queue");
        return;
      }
      ardh.b("handlePreloadTaskFromMessage msgid:" + localPAAdPreloadTask.mMsgId + ", vid:" + localPAAdPreloadTask.mVideoVid + ", exist in queue, ignore");
    }
  }
  ...
  public void a(nis paramnis)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ardh.b("handlePreloadTaskFromMessage invalid item");
          return;
        }
        ardh.b("handlePreloadTaskFromMessage adItem " + paramnis.jdField_a_of_type_JavaLangString);
        niu localniu = paramnis.jdField_a_of_type_Niu;
        ...
        if (!TextUtils.isEmpty(localnit.b))
        {
          ...
          if (paramnis.jdField_a_of_type_Long > 0L)
          {
            ...
            ardh.b("handlePreloadTaskFromMessage msgid:" + paramnis.jdField_c_of_type_JavaLangString + ", vid:" + localnit.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label287:
      ardh.b("handlePreloadTaskFromMessage msgid:" + paramnis.jdField_c_of_type_JavaLangString + ", vid:" + localnit.b + ", exist in queue, ignore");
    }
  }
  
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ardh.b("processMsg0x210Sub0xfd " + paramInt);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ardc.a().a(paramArrayOfByte);
        ardh.a(a(), "delete_uin_list", ardc.a().a());
        ardh.a(a(), "delete_st_" + paramArrayOfByte, String.valueOf(NetConnInfoCenter.getServerTimeMillis()));
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          ardc.a().a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramArrayOfByte);
          return;
        }
      }
  ...
  {
    ardh.b("processMsg0x210Sub0xf9 " + paramInt);
    if (paramArrayOfByte == null)
    {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte = ardh.a(paramArrayOfByte.bytes_zip_AdInfo.get().toByteArray());
        if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0))
        {
          ardh.b("output == null " + paramInt);
          return;
        }
      }
      catch (Exception paramArrayOfByte)
      ...
      paramArrayOfByte = nis.a((submsgtype0xf9.AdInfo)localObject, paramMsgInfo);
      if (ardc.a().a(a(), paramArrayOfByte.jdField_a_of_type_JavaLangString))
      {
        ardh.b("processMsg0x210Sub0xf9 InDeleteFilter mSenderUin " + paramArrayOfByte.jdField_a_of_type_JavaLangString);
        return;
      }
      ardf.a().a(paramArrayOfByte.jdField_a_of_type_JavaLangString);
      ardf.a().a(paramArrayOfByte);
      ardh.b("processMsg0x210Sub0xf9 sp :advertisementItem " + paramArrayOfByte.jdField_a_of_type_JavaLangString);
      ardh.b(a(), paramArrayOfByte.jdField_a_of_type_JavaLangString, paramArrayOfByte.a());
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Ardl != null)
    {
      this.jdField_a_of_type_Ardl.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Ardl);
      this.jdField_a_of_type_Ardl = null;
    }
