  ...
  implements TextWatcher
{
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    label86:
    aezn localaezn;
    if ((paramEditable instanceof ods))
    {
      i = ((ods)paramEditable).a();
      ...
      localaezn = ReadInJoyCommentComponentFragment.a(this.a);
      if (localaezn != null)
      {
    ...
    for (;;)
    {
      if ((i <= 0) || (paramEditable.length() > 24) || (!localaezn.a(paramEditable))) {
        break label308;
      }
      if (ReadInJoyCommentComponentFragment.a(this.a))
      {
        localaezn.a(ReadInJoyCommentComponentFragment.a(this.a).app, paramEditable, null, 7220, false);
      ...
      this.a.f.setImageResource(2130842263);
      return;
    ...
    this.a.f.setImageResource(2130842612);
  }
