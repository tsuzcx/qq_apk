  ...
  extends MessageMicro<IntimateRelationExtMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 800, 808, 8000 }, new String[] { "uint64_upgrade_push_time", "uint64_downgrade_push_time", "uint64_egalitarian_soon_push_time", "uint64_upgrade_time", "uint64_downgrade_time", "uint64_chat_days_start_time", "uint64_chat_days_end_time", "uint64_icon_status" }, new Object[] { localLong, localLong, localLong, localLong, localLong, localLong, localLong, localLong }, IntimateRelationExtMsg.class);
  }
}
