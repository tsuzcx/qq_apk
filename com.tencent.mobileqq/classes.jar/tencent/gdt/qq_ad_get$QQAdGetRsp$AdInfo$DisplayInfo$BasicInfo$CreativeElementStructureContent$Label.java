  ...
  extends MessageMicro<Label>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 48, 56, 64 }, new String[] { "coordinate_x", "coordinate_y", "content", "direction", "landing_page_url", "angle", "percent", "order" }, new Object[] { localInteger, localInteger, "", localInteger, "", localInteger, localInteger, localInteger }, Label.class);
  }
}
