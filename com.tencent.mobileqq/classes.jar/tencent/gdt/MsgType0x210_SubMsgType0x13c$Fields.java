  ...
  extends MessageMicro<Fields>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 50, 56, 66, 74, 82, 90, 98, 104, 112, 130, 138, 146, 154, 162 }, new String[] { "str_landing_page", "uint64_app_id", "str_app_name", "str_pkg_url", "str_pkg_name", "str_pkg_md5", "str_via", "uint32_dest_type", "uint32_product_type", "str_product_id", "str_landing_page_report_url", "str_customized_invoke_url", "str_effect_url", "str_traceid" }, new Object[] { "", Long.valueOf(0L), "", "", "", "", "", localInteger, localInteger, "", "", "", "", "" }, Fields.class);
  }
}
