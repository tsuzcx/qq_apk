...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 50, 56, 66, 74, 80, 90, 98, 16010 }, new String[] { "user_info", "position_info", "device_info", "context_info", "debug_info", "gdt_cookie", "support_https", "external_exp_info", "version_info", "dynamic_timeout_in_ms", "weather_info", "request_id", "busi_cookie" }, new Object[] { null, null, null, null, null, "", Boolean.valueOf(false), null, null, Integer.valueOf(0), null, "", "" }, QQAdGet.class);
