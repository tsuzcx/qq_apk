  ...
  extends MessageMicro<PositionExt>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 42, 48, 56, 66, 74, 82, 90 }, new String[] { "share_info", "deep_link_version", "get_ad_type", "specified_ads", "sub_position_id", "black_category_list", "debug_adindexid_list", "cps_req_info", "video_req_info", "context_info", "search_content_info" }, new Object[] { null, localInteger, localInteger, null, "", localInteger, localInteger, null, null, null, null }, PositionExt.class);
  }
}
