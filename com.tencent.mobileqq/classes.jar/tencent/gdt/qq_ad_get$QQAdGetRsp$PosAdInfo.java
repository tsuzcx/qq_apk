...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 48 }, new String[] { "ret", "msg", "pos_id", "ads_info", "no_ad_indicator", "report_type" }, new Object[] { Integer.valueOf(0), "", "", null, null, Integer.valueOf(0) }, PosAdInfo.class);
