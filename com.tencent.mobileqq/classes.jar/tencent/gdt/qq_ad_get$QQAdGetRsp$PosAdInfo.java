  ...
  extends MessageMicro<PosAdInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 48 }, new String[] { "ret", "msg", "pos_id", "ads_info", "no_ad_indicator", "report_type" }, new Object[] { localInteger, "", "", null, null, localInteger }, PosAdInfo.class);
  }
}
