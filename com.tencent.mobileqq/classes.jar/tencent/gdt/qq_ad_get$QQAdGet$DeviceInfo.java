  ...
  extends MessageMicro<DeviceInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 42, 50, 56, 66, 74, 82, 88, 98, 106, 114, 120, 130, 138, 146, 154, 160, 168, 176, 186, 194, 202, 210, 218, 226, 232, 240, 248, 256, 266, 274, 282 }, new String[] { "muid", "muid_type", "conn", "carrier_code", "os_ver", "qq_ver", "os_type", "client_ip", "ios_qidfa", "location", "is_wk_webview", "manufacturer", "device_brand_and_model", "qadid", "app_version_id", "imei", "idfa", "android_id", "mac", "is_googleplay_version", "device_orientation", "is_ios_review_state", "oaid", "taid_ticket", "md5_mac", "md5_android_id", "client_ipv4", "aid_ticket", "wx_api_ver", "wx_installed", "wx_ul", "origin_network_type", "brand", "device_ext", "cached_idfa" }, new Object[] { "", localInteger, localInteger, localInteger, "", "", localInteger, "", "", null, localBoolean, "", "", "", localInteger, "", "", "", "", localBoolean, localInteger, localBoolean, "", "", "", "", "", "", Long.valueOf(0L), localBoolean, localBoolean, localInteger, "", "", "" }, DeviceInfo.class);
  }
}
