  ...
  extends MessageMicro<NoAdIndicator>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "partition_timestamp", "placement_id", "no_ad_reason", "ad_count" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, null }, NoAdIndicator.class);
  }
}
