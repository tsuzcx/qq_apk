  ...
  extends MessageMicro<PositionContextInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42 }, new String[] { "seq", "abs_seq", "wesee_feeds_id", "wesee_first_category", "wesee_second_category" }, new Object[] { localInteger, localInteger, "", "", "" }, PositionContextInfo.class);
  }
}
