...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48, 56, 66, 74 }, new String[] { "img", "img_s", "txt", "desc", "pic_width", "pic_height", "ad_type", "element_structure_content", "marketing_pendant" }, new Object[] { "", "", "", "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null, "" }, BasicInfo.class);
