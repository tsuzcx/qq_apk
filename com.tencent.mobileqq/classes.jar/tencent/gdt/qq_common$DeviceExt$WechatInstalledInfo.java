  ...
  extends MessageMicro<WechatInstalledInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "api_ver", "installed", "has_universal_link" }, new Object[] { Long.valueOf(0L), localBoolean, localBoolean }, WechatInstalledInfo.class);
  }
}
