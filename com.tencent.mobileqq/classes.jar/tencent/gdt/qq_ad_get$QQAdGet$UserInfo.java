  ...
  extends MessageMicro<UserInfo>
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 50, 58, 64, 72 }, new String[] { "qq", "wx_appid", "wx_openid", "media_specified_id", "qq_appid", "qq_openid", "wuid", "is_study_mode", "group" }, new Object[] { Long.valueOf(0L), "", "", "", Long.valueOf(0L), "", "", Boolean.valueOf(false), Integer.valueOf(0) }, UserInfo.class);
