  ...
  extends MessageMicro<DebugInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "debug_adindexid", "nomatch", "debug", "qq_broswer_debug" }, new Object[] { Integer.valueOf(0), localBoolean, localBoolean, localBoolean }, DebugInfo.class);
  }
}
