...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 16, 24, 32 }, new String[] { "uint32_user_num", "rpt_uint64_uins", "int32_media_type" }, new Object[] { Integer.valueOf(0), Long.valueOf(0L), Integer.valueOf(0) }, DynamicInfo.class);
