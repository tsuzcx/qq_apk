  ...
  extends MessageMicro<ReqCreateRoom>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "enum_aio_type", "uint64_id", "str_song_id", "enum_media_type" }, new Object[] { localInteger, Long.valueOf(0L), "", localInteger }, ReqCreateRoom.class);
  }
}
