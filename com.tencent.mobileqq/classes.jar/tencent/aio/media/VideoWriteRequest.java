  ...
  extends MessageMicro<VideoWriteRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40, 50, 58 }, new String[] { "gid", "categoryId", "matchId", "operType", "targetUin", "roomTitle", "roomCover" }, new Object[] { localLong, localInteger, "", localInteger, localLong, "", "" }, VideoWriteRequest.class);
  }
}
