  ...
  extends MessageMicro<TypeMusic>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40, 48 }, new String[] { "rpt_msg_song_list", "uint32_progress_seek", "int32_progress_seek", "enum_play_mode", "bool_allow_member_start", "bool_allow_member_add" }, new Object[] { null, localInteger, localInteger, Integer.valueOf(1), Boolean.valueOf(true), Boolean.valueOf(false) }, TypeMusic.class);
  }
}
