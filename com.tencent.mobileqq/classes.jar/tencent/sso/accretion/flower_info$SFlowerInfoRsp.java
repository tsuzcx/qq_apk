  ...
  extends MessageMicro<SFlowerInfoRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 42, 48 }, new String[] { "flowers", "num", "ret", "rpt_flower_url", "flower_msg_tips", "flower_flag" }, new Object[] { null, localInteger, localInteger, "", "", localInteger }, SFlowerInfoRsp.class);
  }
}
