  ...
  extends MessageMicro<SFlowerInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "send_uin", "recv_uin", "flower_url", "num" }, new Object[] { localLong, localLong, "", Integer.valueOf(0) }, SFlowerInfo.class);
  }
}
