  ...
  extends MessageMicro<TGetMyEffectRsp0x2>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "ret", "global_effect_id", "st_global_effectinfo", "rpt_userconfig", "query_interval" }, new Object[] { localInteger, localInteger, null, null, localInteger }, TGetMyEffectRsp0x2.class);
  }
}
