  ...
  extends MessageMicro<EffectInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 48, 56, 66, 74, 82, 88, 96, 104, 114, 122, 130, 138, 146, 808, 816 }, new String[] { "effect_id", "name", "wording", "get_mode", "svip_level", "group_level", "price", "gif_url", "pic_url", "mp4_url", "duration", "status", "sort_num", "attr_id", "small_pic_url", "bg_pic_url", "spirit_url", "spirit_config", "ttl", "user_config_status" }, new Object[] { localInteger, "", "", localInteger, localInteger, localInteger, localInteger, "", "", "", localInteger, localInteger, localInteger, "", "", "", "", "", localInteger, Boolean.valueOf(false) }, EffectInfo.class);
  }
}
