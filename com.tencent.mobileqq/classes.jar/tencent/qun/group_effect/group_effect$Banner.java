  ...
  extends MessageMicro<Banner>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48, 810 }, new String[] { "effect_id", "bottom_url", "top_url", "goto_url", "time_begin", "time_end", "effect_info" }, new Object[] { localInteger, "", "", "", localInteger, localInteger, null }, Banner.class);
  }
}
