  ...
  extends MessageMicro<RspSystemMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 56, 66 }, new String[] { "head", "msgs", "unread_count", "latest_friend_seq", "latest_group_seq", "following_friend_seq", "following_group_seq", "msg_display" }, new Object[] { null, null, Integer.valueOf(0), localLong, localLong, localLong, localLong, "" }, RspSystemMsg.class);
  }
}
