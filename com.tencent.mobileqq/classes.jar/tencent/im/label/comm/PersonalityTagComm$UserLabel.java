  ...
  extends MessageMicro<UserLabel>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40, 48, 56 }, new String[] { "rpt_msg_label", "uint32_remain_quota", "uint32_max_photo_quota", "uint32_total_photo", "uint32_total_praise", "uint32_unread_praise", "uint64_last_prise_uin" }, new Object[] { null, localInteger, localInteger, localInteger, localInteger, localInteger, Long.valueOf(0L) }, UserLabel.class);
  }
}
