  ...
  extends MessageMicro<LabelDuplicate>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_is_ori_label", "uint64_ori_label_id", "rpt_uint64_all_id" }, new Object[] { Integer.valueOf(0), localLong, localLong }, LabelDuplicate.class);
  }
}
