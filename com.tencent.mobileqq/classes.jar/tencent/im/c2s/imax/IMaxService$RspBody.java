  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "int32_ret", "str_msg", "int32_type", "int32_exposure_flag" }, new Object[] { localInteger, "", localInteger, localInteger }, RspBody.class);
  }
}
