  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "int32_ret", "str_msg", "uint32_stop_exposure" }, new Object[] { localInteger, "", localInteger }, RspBody.class);
  }
}
