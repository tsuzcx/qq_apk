  ...
  extends MessageMicro<GPS>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_lat", "uint32_lon", "int32_alt", "type" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, GPS.class);
  }
}
