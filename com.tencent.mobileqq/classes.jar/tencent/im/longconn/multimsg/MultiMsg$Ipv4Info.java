  ...
  extends MessageMicro<Ipv4Info>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_ip_v4_addr", "uint32_ip_v4_port", "uint32_is_https_addr" }, new Object[] { localInteger, localInteger, localInteger }, Ipv4Info.class);
  }
}
