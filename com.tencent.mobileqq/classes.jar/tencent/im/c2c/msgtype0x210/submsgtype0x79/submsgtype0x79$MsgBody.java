  ...
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_src_app_id", "uint32_undeal_count" }, new Object[] { localInteger, localInteger }, MsgBody.class);
  }
}
