  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42, 50 }, new String[] { "banner_card", "pop_card", "uint32_latitude", "uint32_longitude", "str_city_id", "pop_hotword" }, new Object[] { null, null, localInteger, localInteger, "", null }, RspBody.class);
  }
}
