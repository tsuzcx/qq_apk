  ...
  extends MessageMicro<MedalTaskInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 256, 264, 272, 280 }, new String[] { "uint32_taskid", "int32_task_value", "uint32_tar_value", "uint32_tar_value_level2", "uint32_tar_value_level3" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger }, MedalTaskInfo.class);
  }
}
