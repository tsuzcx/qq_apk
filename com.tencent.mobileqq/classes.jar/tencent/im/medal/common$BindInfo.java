  ...
  extends MessageMicro<BindInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "uint64_fri_uin", "str_fri_nick", "uint64_time", "uint32_bind_status" }, new Object[] { localLong, "", localLong, Integer.valueOf(0) }, BindInfo.class);
  }
}
