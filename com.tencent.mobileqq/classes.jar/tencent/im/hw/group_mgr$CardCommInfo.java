  ...
  extends MessageMicro<CardCommInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40 }, new String[] { "uin", "nick_name", "card_name", "level", "point" }, new Object[] { Long.valueOf(0L), "", "", localInteger, localInteger }, CardCommInfo.class);
  }
}
