  ...
  extends MessageMicro<CrmS2CMsgHead>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 66 }, new String[] { "uint32_crm_sub_cmd", "uint32_head_len", "uint32_ver_no", "uint64_kf_uin", "uint32_seq", "uint32_pack_num", "uint32_cur_pack", "str_buf_sig" }, new Object[] { localInteger, localInteger, localInteger, Long.valueOf(0L), localInteger, localInteger, localInteger, "" }, CrmS2CMsgHead.class);
  }
}
