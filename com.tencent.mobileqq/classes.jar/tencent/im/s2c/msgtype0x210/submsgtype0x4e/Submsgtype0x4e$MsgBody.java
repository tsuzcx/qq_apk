  ...
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint64_group_id", "uint64_group_code", "uint32_appid", "msg_group_bulletin" }, new Object[] { localLong, localLong, Integer.valueOf(0), null }, MsgBody.class);
  }
}
