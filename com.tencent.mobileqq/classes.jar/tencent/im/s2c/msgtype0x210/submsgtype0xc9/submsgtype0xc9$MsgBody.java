  ...
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48 }, new String[] { "uint32_type", "uint64_from_uin", "uint64_action_uin", "source", "rpt_msg_business_msg", "bool_new_friend" }, new Object[] { localInteger, localLong, localLong, localInteger, null, Boolean.valueOf(false) }, MsgBody.class);
  }
}
