  ...
  extends MessageMicro<AdInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 48, 56, 64, 74, 82, 90, 96, 104, 112 }, new String[] { "uint64_from_uin", "str_nick", "str_head_url", "str_brief", "str_action", "uint32_flag", "uint32_serviceID", "uint32_templateID", "str_url", "msg_msgCommonData", "rpt_msg_video", "uint32_pushTime", "uint32_invalidTime", "uint32_maxExposureTime" }, new Object[] { Long.valueOf(0L), "", "", "", "", localInteger, localInteger, localInteger, "", null, null, localInteger, localInteger, localInteger }, AdInfo.class);
  }
}
