  ...
  extends MessageMicro<ModGroupMemberProfile>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uint64_group_uin", "uint64_uin", "rpt_msg_group_member_profile_infos", "uint64_group_code" }, new Object[] { localLong, localLong, null, localLong }, ModGroupMemberProfile.class);
  }
}
