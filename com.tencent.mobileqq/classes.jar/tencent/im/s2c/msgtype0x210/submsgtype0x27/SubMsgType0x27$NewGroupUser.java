  ...
  extends MessageMicro<NewGroupUser>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42 }, new String[] { "uint64_uin", "int32_sex", "int32_age", "str_nick", "bytes_distance" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, "", localByteStringMicro }, NewGroupUser.class);
  }
}
