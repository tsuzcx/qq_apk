  ...
  extends MessageMicro<SnsUpateBuffer>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 3202, 3208 }, new String[] { "uint64_uin", "uint64_code", "uint32_result", "rpt_msg_sns_update_item", "rpt_uint32_idlist" }, new Object[] { localLong, localLong, localInteger, null, localInteger }, SnsUpateBuffer.class);
  }
}
