  ...
  extends MessageMicro<GrpMsgRoamFlag>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_groupcode", "uint32_flag", "uint64_timestamp" }, new Object[] { localLong, Integer.valueOf(0), localLong }, GrpMsgRoamFlag.class);
  }
}
