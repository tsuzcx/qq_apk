...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 1080 }, new String[] { "uint64_puin", "uint64_uin", "uint32_type", "uint32_seqno", "uint32_disable_cancel_chat" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) }, FollowList.class);
