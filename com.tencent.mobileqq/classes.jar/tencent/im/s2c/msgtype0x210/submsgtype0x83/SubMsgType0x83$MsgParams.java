  ...
  extends MessageMicro<MsgParams>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42 }, new String[] { "uint32_type", "uint64_from_uin", "uint64_to_uin", "str_data", "bytes_data" }, new Object[] { Integer.valueOf(0), localLong, localLong, "", localByteStringMicro }, MsgParams.class);
  }
}
