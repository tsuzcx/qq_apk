  ...
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "rpt_msg_params", "uint64_seq", "uint64_group_id" }, new Object[] { null, localLong, localLong }, MsgBody.class);
  }
}
