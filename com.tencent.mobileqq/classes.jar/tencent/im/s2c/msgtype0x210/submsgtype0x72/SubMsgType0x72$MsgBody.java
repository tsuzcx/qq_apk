  ...
  extends MessageMicro<MsgBody>
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42 }, new String[] { "uint32_sub_cmd", "uint32_urgency", "uint32_template_no", "str_content", "str_info_date" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", "" }, MsgBody.class);
