  ...
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40 }, new String[] { "uint32_type", "uint32_msgbox_unread_count", "uint32_unread_count", "msg_content", "uint64_timestamp" }, new Object[] { localInteger, localInteger, localInteger, null, Long.valueOf(0L) }, MsgBody.class);
  }
}
