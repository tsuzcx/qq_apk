  ...
  extends MessageMicro<InviteInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint64_uin", "uint64_group_code", "uint32_expire_time", "str_id" }, new Object[] { localLong, localLong, Integer.valueOf(0), "" }, InviteInfo.class);
  }
}
