  ...
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42 }, new String[] { "uint32_msg_type", "rpt_uint64_invite_uin", "uint64_invite_leader", "msg_poi_info", "rpt_msg_player_state" }, new Object[] { Integer.valueOf(0), localLong, localLong, null, null }, MsgBody.class);
  }
}
