  ...
  extends MessageMicro<MsgContent>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 56, 66, 72, 82 }, new String[] { "uint64_tag", "uint64_msg_type", "uint64_seq", "str_content", "uint64_action_id", "uint64_ts", "uint64_expts", "str_error_msg", "uint64_show_space", "str_region_url" }, new Object[] { localLong, localLong, localLong, "", localLong, localLong, localLong, "", localLong, "" }, MsgContent.class);
  }
}
