  ...
  extends MessageMicro<RelationalChainChange>
{
  ...
  public final PBUInt64Field uint64_trigger_uin = PBField.initUInt64(0L);
  
  static
  {
    Long localLong = Long.valueOf(0L);
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50, 58, 162, 320, 800 }, new String[] { "uint64_appid", "uint64_src_uin", "uint64_dst_uin", "uint32_change_type", "msg_relational_chain_info_old", "msg_relational_chain_info_new", "msg_to_degrade_info", "rpt_relational_chain_infos", "uint64_trigger_uin", "rpt_uint32_feature_id" }, new Object[] { localLong, localLong, localLong, Integer.valueOf(1), null, null, null, null, localLong, Integer.valueOf(0) }, RelationalChainChange.class);
  }
}
