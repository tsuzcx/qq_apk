  ...
  extends MessageMicro<MutualmarkInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 56, 64, 72, 82, 88, 96, 106, 8002 }, new String[] { "uint64_last_action_time", "uint32_level", "uint64_last_change_time", "uint32_continue_days", "bytes_wildcard_wording", "uint64_notify_time", "uint64_icon_status", "uint64_icon_status_end_time", "uint32_close_flag", "bytes_resource_info", "uint32_graytip_type", "uint64_sub_level", "bytes_grade_resource_info", "bytes_duplicate_removal_key" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), Long.valueOf(0L), Integer.valueOf(0), localByteStringMicro1, Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), localByteStringMicro2, Integer.valueOf(0), Long.valueOf(0L), localByteStringMicro3, localByteStringMicro4 }, MutualmarkInfo.class);
  }
}
