  ...
  extends MessageMicro<SubCmd0x1UpdateAppUnreadNum>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 40 }, new String[] { "msg_app_id", "uint64_group_code", "sint32_unread_num", "msg_app_tip_notify", "sint32_album_cnt" }, new Object[] { null, Long.valueOf(0L), localInteger, null, localInteger }, SubCmd0x1UpdateAppUnreadNum.class);
  }
}
