  ...
  extends MessageMicro<GameTeam_TurnOverMessage>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 34, 40, 48, 56, 64, 72, 80, 88, 98, 104, 114 }, new String[] { "str_teamId", "uint32_sessionType", "str_sourceUin", "str_actionUin", "actionType", "uint32_currentCount", "uint32_totalCount", "uint64_createMsgTime", "uint32_status", "uint32_expire", "uint64_buildTeamTime", "str_leaderUin", "uin32_leaderStatus", "InviteSourceList" }, new Object[] { "", localInteger, "", "", localInteger, localInteger, localInteger, Long.valueOf(0L), localInteger, localInteger, Long.valueOf(0L), "", localInteger, null }, GameTeam_TurnOverMessage.class);
  }
}
