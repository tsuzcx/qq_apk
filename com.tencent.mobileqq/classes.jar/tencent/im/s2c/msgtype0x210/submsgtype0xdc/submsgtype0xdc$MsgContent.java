...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 66, 74, 82, 88, 96, 104, 114 }, new String[] { "uint64_master_pri", "uint64_sub_pri", "uint64_show_times", "uint64_show_beg_ts", "uint64_exp_ts", "uint64_msg_sent_ts", "uint64_action_id", "str_wording", "str_scheme", "str_region_url", "uint64_wording_color", "uint64_msg_id", "uint64_bubble_id", "str_tips" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), "", "", "", Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), "" }, MsgContent.class);
