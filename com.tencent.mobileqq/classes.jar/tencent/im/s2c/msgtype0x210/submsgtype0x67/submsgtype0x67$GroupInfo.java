  ...
  extends MessageMicro<GroupInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40 }, new String[] { "uint64_group_code", "str_group_name", "str_group_memo", "uint32_member_num", "uint32_group_type" }, new Object[] { Long.valueOf(0L), "", "", localInteger, localInteger }, GroupInfo.class);
  }
}
