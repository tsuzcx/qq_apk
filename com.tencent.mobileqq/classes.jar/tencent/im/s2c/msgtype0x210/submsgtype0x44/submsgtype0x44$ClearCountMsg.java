  ...
  extends MessageMicro<ClearCountMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_uin", "uint32_time", "uint32_processflag", "uint32_updateflag" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, ClearCountMsg.class);
  }
}
