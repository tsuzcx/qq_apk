...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 82 }, new String[] { "uint32_bid", "uint32_source", "operator_type", "uint64_article_id", "uint32_push_time", "uint64_seq", "msg_notify_infos" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(1), Long.valueOf(0L), Integer.valueOf(0), Long.valueOf(0L), null }, MsgBody.class);
