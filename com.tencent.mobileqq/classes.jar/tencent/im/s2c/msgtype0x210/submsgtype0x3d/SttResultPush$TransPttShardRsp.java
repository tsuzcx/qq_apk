...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 72, 80, 88, 98, 106, 168, 176, 184, 242, 250 }, new String[] { "uint64_sessionid", "uint32_ptt_type", "uint32_error_code", "uint64_sender_uin", "uint64_receiver_uin", "uint32_FileID", "str_Filemd5", "str_file_path", "uint32_total_seq", "bool_is_total_end", "bool_is_cur_end", "cur_text_rsp", "all_text_rsp" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(0), "", "", Integer.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(false), null, null }, TransPttShardRsp.class);
