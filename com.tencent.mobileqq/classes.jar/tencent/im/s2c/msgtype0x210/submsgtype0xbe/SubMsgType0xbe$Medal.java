  ...
  extends MessageMicro<Medal>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50 }, new String[] { "uint32_id", "uint32_level", "uint32_type", "str_icon_url", "str_flash_url", "str_name" }, new Object[] { localInteger, localInteger, localInteger, "", "", "" }, Medal.class);
  }
}
