  ...
  extends MessageMicro<VipInfoNotify>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48, 56, 64, 74 }, new String[] { "uint64_uin", "uint32_vip_level", "uint32_vip_identify", "uint32_ext", "str_ext", "uint32_red_flag", "uint32_disable_red_envelope", "uint32_redpack_id", "str_redpack_name" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, "", localInteger, localInteger, localInteger, "" }, VipInfoNotify.class);
  }
}
