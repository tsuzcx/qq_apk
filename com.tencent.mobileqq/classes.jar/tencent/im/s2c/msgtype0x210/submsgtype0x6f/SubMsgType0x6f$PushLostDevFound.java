  ...
  extends MessageMicro<PushLostDevFound>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 24, 48 }, new String[] { "uint32_msg_type", "uint32_dev_time", "uint64_din" }, new Object[] { localInteger, localInteger, Long.valueOf(0L) }, PushLostDevFound.class);
  }
}
