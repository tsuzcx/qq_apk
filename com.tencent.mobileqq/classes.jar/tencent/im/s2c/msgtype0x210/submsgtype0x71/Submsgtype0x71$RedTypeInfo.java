  ...
  extends MessageMicro<RedTypeInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32 }, new String[] { "uint32_red_type", "str_red_content", "str_red_desc", "uint32_red_priority" }, new Object[] { localInteger, "", "", localInteger }, RedTypeInfo.class);
  }
}
