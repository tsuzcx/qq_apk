  ...
  extends MessageMicro<AddFrdSNInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_not_see_dynamic", "uint32_set_sn" }, new Object[] { localInteger, localInteger }, AddFrdSNInfo.class);
  }
}
