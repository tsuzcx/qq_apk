  ...
  extends MessageMicro<AddtionInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42 }, new String[] { "uint32_poke", "uint32_format", "str_entity_category", "str_entity_name", "str_entity_url" }, new Object[] { localInteger, localInteger, "", "", "" }, AddtionInfo.class);
  }
}
