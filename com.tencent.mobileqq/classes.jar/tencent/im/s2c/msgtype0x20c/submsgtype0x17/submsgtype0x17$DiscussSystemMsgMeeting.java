  ...
  extends MessageMicro<DiscussSystemMsgMeeting>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint64_uin", "uint32_operation", "uint64_discuss_uin", "uint32_time", "uint64_meeting_seq" }, new Object[] { localLong, localInteger, localLong, localInteger, localLong }, DiscussSystemMsgMeeting.class);
  }
}
