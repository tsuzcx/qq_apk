...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 42, 50, 58 }, new String[] { "msg_not_online_file", "uint32_msg_time", "uint32_OnlineFileForPolyToOffline", "file_image_info", "msg_xtf_sender_info", "resv_attr", "msg_wlan_recved_notify" }, new Object[] { null, Integer.valueOf(0), Integer.valueOf(0), null, null, null, null }, MsgBody.class);
