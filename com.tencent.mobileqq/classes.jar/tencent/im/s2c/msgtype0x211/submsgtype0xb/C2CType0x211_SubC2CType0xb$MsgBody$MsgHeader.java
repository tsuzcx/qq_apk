  ...
  extends MessageMicro<MsgHeader>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40 }, new String[] { "uint32_body_type", "uint32_session_type", "uint64_to_uin", "str_to_mobile", "uint64_room_id" }, new Object[] { Integer.valueOf(101), Integer.valueOf(0), localLong, "", localLong }, MsgHeader.class);
  }
}
