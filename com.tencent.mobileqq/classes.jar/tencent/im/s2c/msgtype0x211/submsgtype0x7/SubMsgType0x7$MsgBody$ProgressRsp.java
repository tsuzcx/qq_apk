  ...
  extends MessageMicro<ProgressRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uint32_cmd", "uint64_cookie", "uint32_package_count", "uint32_package_index", "rpt_msg_progressinfo" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, localInteger, null }, ProgressRsp.class);
  }
}
