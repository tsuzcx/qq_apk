  ...
  extends MessageMicro<MsgHeader>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72, 80 }, new String[] { "uint32_src_app_id", "uint32_src_inst_id", "uint32_dst_app_id", "uint32_dst_inst_id", "uint64_dst_uin", "uint64_src_uin", "uint32_src_uin_type", "uint32_dst_uin_type", "uint32_src_ter_type", "uint32_dst_ter_type" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localLong, localLong, localInteger, localInteger, localInteger, localInteger }, MsgHeader.class);
  }
}
