  ...
  extends MessageMicro<QunInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 50 }, new String[] { "qun_index", "qun_code", "qun_name", "onlive_num", "qvideo_url", "logo_url" }, new Object[] { localInteger, Long.valueOf(0L), "", localInteger, "", "" }, QunInfo.class);
  }
}
