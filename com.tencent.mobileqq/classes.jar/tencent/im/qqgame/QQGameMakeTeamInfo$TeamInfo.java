...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 42, 50, 58, 66, 72 }, new String[] { "appid", "team_bus_id", "team_id", "status", "icons", "main_text", "sub_text", "jump_url", "tm" }, new Object[] { "", "", "", Integer.valueOf(0), "", "", "", "", Long.valueOf(0L) }, TeamInfo.class);
