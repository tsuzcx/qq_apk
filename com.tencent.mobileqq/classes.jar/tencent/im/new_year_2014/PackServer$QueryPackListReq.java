  ...
  extends MessageMicro<QueryPackListReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "from_index", "count", "type" }, new Object[] { localInteger, localInteger, localInteger }, QueryPackListReq.class);
  }
}
