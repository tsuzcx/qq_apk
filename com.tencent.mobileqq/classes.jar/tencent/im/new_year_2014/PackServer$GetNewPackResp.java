  ...
  extends MessageMicro<GetNewPackResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40, 80 }, new String[] { "promotion_id", "seq", "data", "empty_url", "follow", "is_bingo_limit" }, new Object[] { localInteger, localInteger, null, "", Boolean.valueOf(false), localInteger }, GetNewPackResp.class);
  }
}
