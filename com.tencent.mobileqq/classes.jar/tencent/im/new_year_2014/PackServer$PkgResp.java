  ...
  extends MessageMicro<PkgResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50, 58, 66, 74, 82, 90, 98, 106, 114, 122, 160, 168, 176 }, new String[] { "cmdtype", "uin", "errcode", "errmsg", "resp_name", "get_new_pack", "query_pack_list", "set_pack_used", "give_pack", "query_pack", "query_user_history", "query_lucky_users", "query_promotion", "query_business", "query_remain_pack", "grab_interval", "report_active_interval", "report_normal_interval" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, "", "", null, null, null, null, null, null, null, null, null, null, localInteger, localInteger, localInteger }, PkgResp.class);
  }
}
