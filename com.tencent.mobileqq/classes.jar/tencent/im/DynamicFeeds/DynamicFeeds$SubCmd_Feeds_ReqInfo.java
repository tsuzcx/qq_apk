  ...
  extends MessageMicro<SubCmd_Feeds_ReqInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40, 50 }, new String[] { "uiReqEvent", "ReqResIDs", "uiLoadDayTimestamp", "HistoryFeedIDs", "ulFinishDayBitmap", "strReqCookie" }, new Object[] { localInteger, null, localInteger, null, Long.valueOf(0L), "" }, SubCmd_Feeds_ReqInfo.class);
  }
}
