...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50 }, new String[] { "promotion_id", "open_luck_word_id", "star_id", "open_luck_title", "open_luck_desc", "open_luck_pic" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", "", "" }, PromotionResult.class);
