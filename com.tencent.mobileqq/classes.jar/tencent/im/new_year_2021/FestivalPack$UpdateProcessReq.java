...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "promotion_id", "question_list" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0) }, UpdateProcessReq.class);
