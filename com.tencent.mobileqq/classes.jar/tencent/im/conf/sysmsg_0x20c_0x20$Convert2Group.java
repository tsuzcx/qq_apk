  ...
  extends MessageMicro<Convert2Group>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "u64_operator", "u64_discuss_code", "u64_group_code" }, new Object[] { localLong, localLong, localLong }, Convert2Group.class);
  }
}
