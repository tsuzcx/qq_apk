...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 48, 58, 64, 74, 80, 90, 98, 106, 112, 122, 130 }, new String[] { "str_app_class", "str_app_sub_id", "str_app_sub_id_ext", "str_msg_id", "str_seq_no", "int_user_id_type", "str_user_id", "int_device_id_type", "str_device_id", "int32_phone_data_type", "rpt_local_code_data", "str_cell_ip", "str_user_ip", "int64_timestamp", "str_process_cookies", "str_mask_phone" }, new Object[] { "", "", "", "", "", Integer.valueOf(0), "", Integer.valueOf(0), "", Integer.valueOf(0), null, "", "", Long.valueOf(0L), "", "" }, GetPhoneReqBody.class);
