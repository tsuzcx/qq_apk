  ...
  extends MessageMicro<ReqBodyThirdLogin>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 88, 162, 170, 178, 186 }, new String[] { "uint32_service_type", "uin_account_type", "msg_req_google", "msg_req_facebook", "msg_req_phone", "msg_req_apple" }, new Object[] { localInteger, localInteger, null, null, null, null }, ReqBodyThirdLogin.class);
  }
}
