...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32 }, new String[] { "uint32_display_flag", "str_hori_bar_content", "str_bar_url", "uint32_next_access_time" }, new Object[] { Integer.valueOf(0), "", "", Integer.valueOf(0) }, RspBody.class);
