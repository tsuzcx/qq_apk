  ...
  extends MessageMicro<GetUrlReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 42, 50, 56, 64, 72, 82, 88, 98, 106, 114, 120 }, new String[] { "str_app_class", "str_app_sub_id", "str_app_sub_id_ext", "int_client_type", "str_seq_no", "str_mobile_phone", "int_isp_type", "int_business_type", "int_user_id_type", "str_user_id", "int_device_id_type", "str_device_id", "str_cell_ip", "str_user_ip", "int64_timestamp" }, new Object[] { "", "", "", localInteger, "", "", localInteger, localInteger, localInteger, "", localInteger, "", "", "", Long.valueOf(0L) }, GetUrlReqBody.class);
  }
}
