...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 42 }, new String[] { "uint32_appid", "str_account", "uint32_err_code", "str_err_msg", "str_guid" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(0), "", "" }, Head.class);
