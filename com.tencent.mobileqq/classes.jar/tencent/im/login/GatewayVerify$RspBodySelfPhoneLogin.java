...
public final class GatewayVerify$RspBodySelfPhoneLogin
  extends MessageMicro<RspBodySelfPhoneLogin>
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 82, 88, 98, 106 }, new String[] { "rpt_bind_uin_info", "int32_phone_bind_result", "str_phone_bind_msg_title", "str_phone_bind_msg_content" }, new Object[] { null, Integer.valueOf(0), "", "" }, RspBodySelfPhoneLogin.class);
