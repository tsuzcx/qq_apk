  ...
  extends MessageMicro<RspBodyThirdLogin>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 88, 96, 162, 170, 178, 186 }, new String[] { "uint32_service_type", "uint64_qq_uin", "uint32_register_flag", "msg_rsp_google", "msg_rsp_facebook", "msg_rsp_phone", "msg_rsp_apple" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, null, null, null, null }, RspBodyThirdLogin.class);
  }
}
