  ...
  extends MessageMicro<ReqBodySelfPhoneGetUrl>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 90, 98, 104 }, new String[] { "uint32_get_upload_url", "str_mobile_phone", "str_cell_ip", "uint32_isp_type" }, new Object[] { localInteger, "", "", localInteger }, ReqBodySelfPhoneGetUrl.class);
  }
}
