  ...
  extends MessageMicro<GetResourceRespV2>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42 }, new String[] { "uin", "result", "addedResInfo", "deletedResInfo", "updatedResInfo" }, new Object[] { localInteger, localInteger, null, null, null }, GetResourceRespV2.class);
  }
}
