...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 50 }, new String[] { "string_today_trend", "string_tomorrow_trend", "string_miniapp", "string_today_date", "string_lucky_color", "string_lucky_number" }, new Object[] { "", "", "", "", "", "" }, ZodiacBizInfo.class);
