...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32 }, new String[] { "is_allowed", "forbid_wording", "jump_url", "level" }, new Object[] { Boolean.valueOf(false), "", "", Long.valueOf(0L) }, PrivilegeRspBody.class);
