  ...
  extends MessageMicro<ReqOption>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88 }, new String[] { "uint32_biu_count", "uint32_like_count", "uint32_is_like", "uint32_style_card", "uint32_related_search_size", "uint32_article_business", "uint32_related_search", "uint32_need_fusion_biu_info", "uint32_need_proteus_json_data", "uint32_need_coin", "uint32_need_share" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, ReqOption.class);
  }
}
