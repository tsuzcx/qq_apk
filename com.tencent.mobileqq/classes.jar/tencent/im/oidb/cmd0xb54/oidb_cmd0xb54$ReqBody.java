...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24 }, new String[] { "msg_client", "msg_req_article", "uint32_topic" }, new Object[] { null, null, Integer.valueOf(0) }, ReqBody.class);
