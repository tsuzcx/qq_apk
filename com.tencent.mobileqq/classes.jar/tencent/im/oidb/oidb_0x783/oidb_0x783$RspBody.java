  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 29, 34 }, new String[] { "uint32_result", "str_errmsg", "uint32_server_time", "rpt_remark_infos" }, new Object[] { localInteger, "", localInteger, null }, RspBody.class);
  }
}
