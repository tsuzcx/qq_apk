  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "uint32_subcmd", "uint32_type", "msg_discussinfo", "rpt_uinlist", "uint32_groupid" }, new Object[] { localInteger, localInteger, null, null, localInteger }, ReqBody.class);
  }
}
