  ...
  extends MessageMicro<VisitProfRec>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "uint64_tinyid", "uint32_seq", "uint32_enter_count", "uint32_visit_duration", "uint32_visit_pic_count", "uint32_opflag" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger, localInteger }, VisitProfRec.class);
  }
}
