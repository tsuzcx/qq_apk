  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint32_listtype", "rpt_msg_visit_prof_rec", "uint32_list_ruleid" }, new Object[] { localInteger, null, localInteger }, ReqBody.class);
  }
}
