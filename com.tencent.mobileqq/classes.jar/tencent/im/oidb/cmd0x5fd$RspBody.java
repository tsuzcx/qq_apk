  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 40 }, new String[] { "msg_comment", "str_error_tips", "uint32_clear_cache_flag", "str_comment_wording", "uint32_comment_num" }, new Object[] { null, "", localInteger, "", localInteger }, RspBody.class);
  }
}
