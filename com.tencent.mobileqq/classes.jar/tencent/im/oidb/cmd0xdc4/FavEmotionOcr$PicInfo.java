  ...
  extends MessageMicro<PicInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 40, 48 }, new String[] { "string_pic_fileid", "string_pic_md5", "uint32_img_width", "uint32_img_height", "uint64_img_size" }, new Object[] { "", "", localInteger, localInteger, Long.valueOf(0L) }, PicInfo.class);
  }
}
