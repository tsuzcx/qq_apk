  ...
  extends MessageMicro<UserDeviceInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "int32_client_type", "uint32_portal", "uint32_instance_id" }, new Object[] { localInteger, localInteger, localInteger }, UserDeviceInfo.class);
  }
}
