...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34 }, new String[] { "opt_uint32_msg_type", "opt_st_alliance_notify", "opt_st_sec_front_info", "opt_st_special_flag" }, new Object[] { Integer.valueOf(0), null, null, null }, GroupNotify.class);
  ...
  public general_group_notify.NotifySpecialFlag opt_st_special_flag = new general_group_notify.NotifySpecialFlag();
