  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32 }, new String[] { "rpt_msg_comment", "str_error_tips", "uint32_clear_cache_flag", "uint32_comment_count" }, new Object[] { null, "", localInteger, localInteger }, RspBody.class);
  }
}
