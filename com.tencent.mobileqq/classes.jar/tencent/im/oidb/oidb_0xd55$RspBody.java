...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 90, 98, 106, 114 }, new String[] { "wording", "appinfo", "check_app_sign_rsp", "check_user_rsp", "check_mini_app_rsp", "check_url_sig_rsp" }, new Object[] { "", null, null, null, null, null }, RspBody.class);
  ...
  public oidb_0xd55.CheckUrlSigRsp check_url_sig_rsp = new oidb_0xd55.CheckUrlSigRsp();
