  ...
  extends MessageMicro<UserTopicItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42, 48, 56 }, new String[] { "uint32_topic_id", "str_topic", "uint32_total_num", "uint32_frd_num", "rpt_frd_item", "uint32_audit_state", "uint32_apply_num" }, new Object[] { localInteger, "", localInteger, localInteger, null, localInteger, localInteger }, UserTopicItem.class);
  }
}
