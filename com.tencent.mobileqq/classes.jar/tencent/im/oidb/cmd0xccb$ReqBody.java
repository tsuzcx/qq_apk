  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 56, 66 }, new String[] { "type", "dest_uin", "group_code", "c2c_msg", "group_msg", "c2c_type", "service_type", "local_msg" }, new Object[] { localInteger, localLong, localLong, null, null, localInteger, localInteger, null }, ReqBody.class);
  }
}
