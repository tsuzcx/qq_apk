  ...
  extends MessageMicro<RspHelloContent>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_req_type", "uint32_next_time_gap" }, new Object[] { localInteger, localInteger }, RspHelloContent.class);
  }
}
