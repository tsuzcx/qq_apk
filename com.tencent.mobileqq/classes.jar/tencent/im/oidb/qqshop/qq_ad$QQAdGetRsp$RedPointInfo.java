  ...
  extends MessageMicro<RedPointInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 58 }, new String[] { "task_id", "tab_id", "begin_time", "end_time", "delay_second", "red_type", "red_url" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, "" }, RedPointInfo.class);
  }
}
