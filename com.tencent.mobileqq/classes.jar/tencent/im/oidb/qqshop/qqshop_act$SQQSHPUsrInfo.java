  ...
  extends MessageMicro<SQQSHPUsrInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "carriertype", "src", "src_idx", "net_type" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, SQQSHPUsrInfo.class);
  }
}
