  ...
  extends MessageMicro<SQQSHPAccoutRelation>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "puin", "binduin", "distance", "customerservice" }, new Object[] { localLong, localLong, Integer.valueOf(-1), Integer.valueOf(0) }, SQQSHPAccoutRelation.class);
  }
}
