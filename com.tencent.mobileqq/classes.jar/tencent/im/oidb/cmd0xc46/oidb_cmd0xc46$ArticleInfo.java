  ...
  extends MessageMicro<ArticleInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "comment_count", "forbidden", "use_black_menu", "has_anchor" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, ArticleInfo.class);
  }
}
