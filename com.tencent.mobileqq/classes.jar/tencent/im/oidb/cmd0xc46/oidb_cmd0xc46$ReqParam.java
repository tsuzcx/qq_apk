  ...
  extends MessageMicro<ReqParam>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "with_sub_comments", "platform", "with_author_reply", "with_style_data", "req_advertise_para" }, new Object[] { localInteger, localInteger, localInteger, localInteger, null }, ReqParam.class);
  }
}
