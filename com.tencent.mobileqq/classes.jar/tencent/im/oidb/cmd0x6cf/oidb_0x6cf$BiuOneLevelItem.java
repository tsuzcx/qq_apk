  ...
  extends MessageMicro<BiuOneLevelItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 58 }, new String[] { "uint64_feeds_id", "uint64_uin", "uint32_biu_time", "bytes_biu_comments", "feeds_type", "op_type", "msg_jump_info" }, new Object[] { localLong, localLong, localInteger, localByteStringMicro, localInteger, localInteger, null }, BiuOneLevelItem.class);
  }
}
