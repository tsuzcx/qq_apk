  ...
  extends MessageMicro<EntranceDownloadInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 34, 42 }, new String[] { "bytes_icon_url", "bytes_small_icon_url", "uint32_is_use_gif", "msg_url_jump_info", "bytes_common_data" }, new Object[] { localByteStringMicro1, localByteStringMicro2, Integer.valueOf(0), null, localByteStringMicro3 }, EntranceDownloadInfo.class);
  }
}
