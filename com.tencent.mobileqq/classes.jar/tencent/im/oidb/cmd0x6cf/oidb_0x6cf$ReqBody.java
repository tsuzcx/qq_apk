  ...
  extends MessageMicro<ReqBody>
{
  ...
  public oidb_0x6cf.PositionInfo msg_position_info = new oidb_0x6cf.PositionInfo();
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40, 48, 58, 64, 74, 80, 112, 120, 128, 138, 144, 154, 162, 170, 176, 184, 192, 202, 208, 216, 224, 234, 242, 248, 256, 264, 272, 282, 306, 322, 328, 336, 346, 354, 360, 370 }, new String[] { "uint64_uin", "uint64_article_id", "bytes_inner_id", "enum_article_source", "uint32_want_count", "uint32_want_type", "req_advertise_para", "rpt_uint64_redo_article_id", "rpt_bytes_redo_inner_id", "uint32_req_source", "uint32_req_dislike_type", "uint32_req_topic_id", "uint32_req_vertical_video", "ugc_feeds_info", "uint32_is_ugc", "bytes_req_web", "bytes_cookie", "rpt_inner_msg_list", "uint32_req_network", "uint32_req_os", "uint32_req_times", "bytes_req_range_cookie", "uint32_req_sub_source", "uint32_req_sim_type", "uint64_end_recommend_seq", "bytes_end_rowkey", "bytes_req_context_pb", "uint32_has_cache_pre_video", "uint32_entrance_one_day_display_count", "uint32_req_column_id", "enum_req_video_show_mode", "rpt_pkg_install_info", "user_expose_article", "bytes_req_ug_interface_data", "uint32_youngster_status", "uint32_req_recommend_flag", "bytes_entrance_cookie", "bytes_req_recommend_json", "unit32_fnum", "msg_position_info" }, new Object[] { localLong, localLong, localByteStringMicro1, localInteger, localInteger, localInteger, null, localLong, localByteStringMicro2, localInteger, localInteger, localInteger, localInteger, null, localInteger, localByteStringMicro3, localByteStringMicro4, null, localInteger, localInteger, localInteger, localByteStringMicro5, localInteger, localInteger, localLong, localByteStringMicro6, localByteStringMicro7, localInteger, localInteger, localInteger, localInteger, null, null, localByteStringMicro8, localInteger, localInteger, localByteStringMicro9, localByteStringMicro10, localInteger, null }, ReqBody.class);
  }
}
