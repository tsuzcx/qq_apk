  ...
  extends MessageMicro<VideoFloatInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint32_ad_support", "uint32_info_num", "rpt_msg_ad_video_pos" }, new Object[] { localInteger, localInteger, null }, VideoFloatInfo.class);
  }
}
