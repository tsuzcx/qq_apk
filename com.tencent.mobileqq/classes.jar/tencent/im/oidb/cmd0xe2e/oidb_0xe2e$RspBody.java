  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 42, 48 }, new String[] { "get_apps", "recommend_apps", "search_apps", "reach_tail", "attachinfo", "max_app_num" }, new Object[] { null, null, null, localInteger, "", localInteger }, RspBody.class);
  }
}
