...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42, 48, 56, 66, 72, 80, 88, 114, 120, 128 }, new String[] { "appid", "type", "name", "icon", "url", "removable", "source", "desc", "added", "redpoint", "add_ts", "cmd_trace", "show_frame", "playing_num" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), "", "", "", Integer.valueOf(0), Integer.valueOf(0), "", Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), "", Integer.valueOf(0), Integer.valueOf(0) }, App.class);
