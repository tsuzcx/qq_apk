  ...
  extends MessageMicro<SetRedDotOpt>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 66, 74, 80, 88, 96, 104, 112, 120 }, new String[] { "uint64_cmd_uin", "rpt_uint64_uin", "bool_clear", "bool_display_reddot", "int32_number", "uint32_reason", "bool_push_to_client", "str_face_url", "str_custom_buffer", "uint32_expire_time", "uint32_last_time", "uint32_total_number", "uint32_cmd_uin_type", "uint32_report_type", "bool_keep_unchanged" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), localBoolean, localBoolean, localInteger, localInteger, localBoolean, localByteStringMicro1, localByteStringMicro2, localInteger, localInteger, localInteger, localInteger, localInteger, localBoolean }, SetRedDotOpt.class);
  }
}
