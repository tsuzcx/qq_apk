  ...
  extends MessageMicro<RedDotInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 58, 66, 72, 80, 88, 98, 106 }, new String[] { "uint32_appid", "bool_display_reddot", "uint32_number", "uint32_reason", "uint32_last_time", "uint64_cmd_uin", "str_face_url", "str_custom_buffer", "uint32_expire_time", "uint32_cmd_uin_type", "uint32_report_type", "msg_word_corner_red_dot", "msg_nearby_entrance_extend_config" }, new Object[] { localInteger, Boolean.valueOf(false), localInteger, localInteger, localInteger, Long.valueOf(0L), localByteStringMicro1, localByteStringMicro2, localInteger, localInteger, localInteger, null, null }, RedDotInfo.class);
  }
}
