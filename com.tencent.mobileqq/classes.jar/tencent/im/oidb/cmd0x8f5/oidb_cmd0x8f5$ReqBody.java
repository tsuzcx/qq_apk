  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_uin", "enum_follow_op", "uint32_parent_channel_id", "rpt_child_channel_list" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
