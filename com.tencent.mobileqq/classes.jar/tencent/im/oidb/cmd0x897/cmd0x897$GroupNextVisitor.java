  ...
  extends MessageMicro<GroupNextVisitor>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 40, 48 }, new String[] { "msg_group_uin_code", "uint64_next_visitor", "msg_req_field", "uint32_max_count", "uint32_administrator_field", "uint32_guest_field" }, new Object[] { null, Long.valueOf(0L), null, localInteger, localInteger, localInteger }, GroupNextVisitor.class);
  }
}
