  ...
  extends MessageMicro<VisitorInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "uint64_visitor_uin", "uint32_visitor_faceid", "string_visitor_nick", "uint32_role", "uint32_guest_flag" }, new Object[] { Long.valueOf(0L), localInteger, localByteStringMicro, localInteger, localInteger }, VisitorInfo.class);
  }
}
