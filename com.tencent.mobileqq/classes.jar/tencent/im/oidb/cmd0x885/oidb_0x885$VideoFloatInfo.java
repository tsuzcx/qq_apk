  ...
  extends MessageMicro<VideoFloatInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "uint32_ad_support", "uint32_info_num", "rpt_msg_ad_video_pos", "uint32_req_info_num", "uint32_req_vertical_video" }, new Object[] { localInteger, localInteger, null, localInteger, localInteger }, VideoFloatInfo.class);
  }
}
