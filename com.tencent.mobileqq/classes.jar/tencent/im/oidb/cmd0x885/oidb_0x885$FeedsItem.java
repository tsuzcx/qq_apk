  ...
  extends MessageMicro<FeedsItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 56, 66 }, new String[] { "uint32_feed_pos", "string_title", "uint32_score", "uint32_ai_kongbu_level", "uint32_ai_disu_level", "uint32_ai_biaotidang_level", "uint32_ai_unsocial_level", "rpt_kd_tag_list" }, new Object[] { localInteger, "", localInteger, localInteger, localInteger, localInteger, localInteger, null }, FeedsItem.class);
  }
}
