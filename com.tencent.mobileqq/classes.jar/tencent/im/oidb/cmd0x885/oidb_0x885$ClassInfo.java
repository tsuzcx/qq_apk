  ...
  extends MessageMicro<ClassInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40, 50 }, new String[] { "uint64_ch1_id", "string_ch1", "uint64_ch2_id", "string_ch2", "uint64_ch3_id", "string_ch3" }, new Object[] { localLong, "", localLong, "", localLong, "" }, ClassInfo.class);
  }
}
