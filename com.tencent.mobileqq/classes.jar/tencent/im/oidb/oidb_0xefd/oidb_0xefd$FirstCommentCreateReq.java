...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 40, 50, 56, 64, 74, 80, 88, 98, 106, 112, 120, 130, 152, 162, 810 }, new String[] { "article_id", "author_id", "puin", "content", "is_anonymous", "business_info", "create_time", "is_multi_media", "media_data", "content_src", "src", "user_info", "rpt_media_data_list", "hide_name", "src_uin", "rowkey", "scene", "link_data", "extra_param" }, new Object[] { "", Long.valueOf(0L), Long.valueOf(0L), "", Integer.valueOf(0), "", Long.valueOf(0L), Integer.valueOf(0), null, Integer.valueOf(0), Integer.valueOf(0), null, null, Integer.valueOf(0), Long.valueOf(0L), "", Integer.valueOf(0), null, "" }, FirstCommentCreateReq.class);
