...
public final class oidb_0xefd$AuthorCommentDeleteReq
  extends MessageMicro<AuthorCommentDeleteReq>
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40, 48, 58 }, new String[] { "article_id", "first_comment_id", "sub_comment_id", "comment_type", "content_src", "src", "business_info" }, new Object[] { "", "", "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "" }, AuthorCommentDeleteReq.class);
 ...
 * Qualified Name:     tencent.im.oidb.oidb_0xefd.oidb_0xefd.AuthorCommentDeleteReq
