  ...
  extends MessageMicro<SubCommentCreateRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 794 }, new String[] { "sub_comment_id", "link_comment_over_times", "link_comment_num", "dirty_word_show_toast", "str_comment" }, new Object[] { localInteger, localInteger, localInteger, localInteger, "" }, SubCommentCreateRsp.class);
  }
}
