...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 794 }, new String[] { "comment_id", "link_comment_over_times", "str_comment" }, new Object[] { "", Integer.valueOf(0), "" }, FirstCommentCreateRsp.class);
