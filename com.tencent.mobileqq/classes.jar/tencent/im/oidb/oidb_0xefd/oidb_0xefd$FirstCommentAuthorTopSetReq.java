...
public final class oidb_0xefd$FirstCommentAuthorTopSetReq
  extends MessageMicro<FirstCommentAuthorTopSetReq>
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 58 }, new String[] { "article_id", "comment_id", "comment_type", "op_type", "content_src", "src", "business_info" }, new Object[] { "", "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "" }, FirstCommentAuthorTopSetReq.class);
 ...
 * Qualified Name:     tencent.im.oidb.oidb_0xefd.oidb_0xefd.FirstCommentAuthorTopSetReq
