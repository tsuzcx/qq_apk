  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 56, 64, 72 }, new String[] { "msg_client", "msg_req_article", "uint32_friend", "uint32_qzhone", "uint32_wechat", "uint32_wechat_pyq", "uint32_wechat_dpyq", "uint32_weibo", "uint32_biu" }, new Object[] { null, null, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
