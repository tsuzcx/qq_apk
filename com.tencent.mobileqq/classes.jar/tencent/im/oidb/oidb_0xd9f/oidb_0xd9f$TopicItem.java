  ...
  extends MessageMicro<TopicItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34 }, new String[] { "uint32_topic_id", "str_topic", "uint32_frd_num", "rpt_frd_item" }, new Object[] { localInteger, "", localInteger, null }, TopicItem.class);
  }
}
