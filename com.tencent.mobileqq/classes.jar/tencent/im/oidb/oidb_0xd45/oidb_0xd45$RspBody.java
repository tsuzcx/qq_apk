  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_from_uin", "uint64_group_uin", "uint64_group_code", "rpt_uint64_uin_list" }, new Object[] { localLong, localLong, localLong, localLong }, RspBody.class);
  }
}
