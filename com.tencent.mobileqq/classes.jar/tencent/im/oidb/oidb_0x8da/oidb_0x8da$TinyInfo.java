  ...
  extends MessageMicro<TinyInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_uin", "uint64_tinyid", "uint32_result" }, new Object[] { localLong, localLong, Integer.valueOf(0) }, TinyInfo.class);
  }
}
