  ...
  extends MessageMicro<ReqGroupInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "uint64_group_code", "rpt_msg_member_info", "uint32_op", "uint32_client_type", "uint64_root_code" }, new Object[] { localLong, null, localInteger, localInteger, localLong }, ReqGroupInfo.class);
  }
}
