  ...
  extends MessageMicro<MemberInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72 }, new String[] { "uint64_member_uin", "uint64_flag_ex_pos", "uint32_heartbeat_time", "uint64_group_msg_mask", "uint32_group_msg_hide_switch", "uint32_group_msg_preview_switch", "uint32_group_ringtone_switch", "uint32_group_vibrate_switch", "uint32_group_ringtone_id" }, new Object[] { localLong, localLong, localInteger, localLong, localInteger, localInteger, localInteger, localInteger, localInteger }, MemberInfo.class);
  }
}
