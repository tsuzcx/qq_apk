  ...
  extends MessageMicro<RecheckFlagItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_flag", "uint32_cur_level", "uint32_lst_level" }, new Object[] { localInteger, localInteger, localInteger }, RecheckFlagItem.class);
  }
}
