  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uint64_uin", "uint32_report_type", "str_report_conent", "uint64_report_time" }, new Object[] { localLong, Integer.valueOf(0), "", localLong }, ReqBody.class);
  }
}
