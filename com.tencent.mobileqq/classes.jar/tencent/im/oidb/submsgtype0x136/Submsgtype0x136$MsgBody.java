...
public final class Submsgtype0x136$MsgBody
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_msg_type", "uint64_group_id", "uint64_notify_timestamp" }, new Object[] { Integer.valueOf(0), localLong, localLong }, MsgBody.class);
  }
}
