  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42 }, new String[] { "opt_uint32_switch_on", "opt_uint32_num", "rpt_string_pics", "opt_uint64_group_id", "opt_string_url" }, new Object[] { localInteger, localInteger, "", Long.valueOf(0L), "" }, RspBody.class);
  }
}
