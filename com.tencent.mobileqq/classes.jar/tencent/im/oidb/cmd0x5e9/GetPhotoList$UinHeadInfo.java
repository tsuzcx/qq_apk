  ...
  extends MessageMicro<UinHeadInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50 }, new String[] { "uint64_uin", "uint32_timestamp", "uint32_headcount", "rpt_msg_headinfo", "str_headurl", "msg_verify_video_info" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null, "", null }, UinHeadInfo.class);
  }
}
