  ...
  extends MessageMicro<FeedsReportData>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint64_feeds_id", "uint64_publish_uin", "rpt_like_uin_list", "uint32_like_total_count", "uint32_comment_total_count" }, new Object[] { localLong, localLong, localLong, localInteger, localInteger }, FeedsReportData.class);
  }
}
