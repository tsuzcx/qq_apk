  ...
  extends MessageMicro<BiuMultiLevel>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "rpt_biu_mutli_level", "uint64_origin_feeds_id", "uint64_origin_feeds_type" }, new Object[] { null, localLong, localLong }, BiuMultiLevel.class);
  }
}
