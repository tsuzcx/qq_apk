  ...
  extends MessageMicro<All>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50, 56, 64, 72, 80, 88, 96, 106, 112, 120, 128 }, new String[] { "uint64_uin", "uint64_fuin", "uint32_reqtype", "uint32_time", "rpt_str_wording", "str_add_source", "uint32_sourceid", "uint32_sourcesubid", "uint32_flag", "uint32_ackflag", "uint32_groupid", "uint32_count", "str_mainemailaccount", "uint64_group_code", "uint32_relatioin", "uint32_comm_friend_num" }, new Object[] { localLong, localLong, localInteger, localInteger, "", "", localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, "", localLong, localInteger, localInteger }, All.class);
  }
}
