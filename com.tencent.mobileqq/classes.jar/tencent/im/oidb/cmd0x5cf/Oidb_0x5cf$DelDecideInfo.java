  ...
  extends MessageMicro<DelDecideInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_uin", "uint32_time", "uint32_req_type" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, DelDecideInfo.class);
  }
}
