  ...
  extends MessageMicro<UnDecide>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 90, 98, 106, 112 }, new String[] { "uint64_uin", "uint64_fuin", "uint32_flag", "uint32_ackflag", "uint32_reqtype", "uint32_groupid", "uint32_sourceid", "uint32_sourcesubid", "uint32_time", "uint32_count", "rpt_str_wording", "str_mainemailaccount", "str_add_source", "uint64_group_code" }, new Object[] { localLong, localLong, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, "", "", "", localLong }, UnDecide.class);
  }
}
