  ...
  extends MessageMicro<GetFeedsByTypeReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_feeds_type", "int32_req_start", "uint32_req_num" }, new Object[] { localInteger, localInteger, localInteger }, GetFeedsByTypeReq.class);
  }
}
