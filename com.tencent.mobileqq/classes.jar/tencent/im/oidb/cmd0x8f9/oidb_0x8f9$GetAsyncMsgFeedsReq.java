  ...
  extends MessageMicro<GetAsyncMsgFeedsReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "int32_req_start", "uint32_req_num" }, new Object[] { localInteger, localInteger }, GetAsyncMsgFeedsReq.class);
  }
}
