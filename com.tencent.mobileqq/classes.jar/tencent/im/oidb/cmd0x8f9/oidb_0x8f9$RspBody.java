  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48, 56, 66, 74, 82 }, new String[] { "msg_source_id", "msg_result_msg", "rpt_feeds_recored", "rpt_feeds_comments", "uint32_last_modify_time", "uint32_feeds_rsp_flag", "uint32_unread_num", "msg_litemail_list", "msg_set_all_litemail_readed_by_endtime", "msg_rsp_get_latest_node_info" }, new Object[] { null, null, null, null, localInteger, localInteger, localInteger, null, null, null }, RspBody.class);
  }
}
