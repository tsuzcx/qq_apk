  ...
  extends MessageMicro<GetFeedsByTimeReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_begin_time", "uint32_end_time", "uint32_req_num" }, new Object[] { localInteger, localInteger, localInteger }, GetFeedsByTimeReq.class);
  }
}
