  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40 }, new String[] { "bytes_msg", "uint32_source_id", "uint32_sub_source_id", "rpt_uint64_uin", "uint64_group_uin" }, new Object[] { "", localInteger, localInteger, localLong, localLong }, ReqBody.class);
  }
}
