  ...
  extends MessageMicro<AddFrdInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "uint64_uin", "bytes_remark", "uint32_allow_type", "uint32_send_req_flag", "uint32_send_req_result" }, new Object[] { Long.valueOf(0L), "", localInteger, localInteger, localInteger }, AddFrdInfo.class);
  }
}
