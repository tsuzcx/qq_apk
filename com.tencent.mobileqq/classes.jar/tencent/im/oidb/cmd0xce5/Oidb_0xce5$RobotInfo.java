  ...
  extends MessageMicro<RobotInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 48, 58, 66, 72, 80, 90, 98, 104, 112, 120, 128, 136, 144, 154 }, new String[] { "robot_uin", "name", "status", "desc", "enabled_groups", "welcome_msg", "call_name", "show_invite", "offline", "verify", "fallback", "join_time", "order", "appid", "api_mark", "miniapp_ids", "robot_type", "extra_info" }, new Object[] { localLong, "", localInteger, "", localInteger, "", "", localInteger, localInteger, "", "", localInteger, localInteger, localLong, localLong, localLong, localInteger, "" }, RobotInfo.class);
  }
}
