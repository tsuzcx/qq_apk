  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40, 48, 56 }, new String[] { "msg_ext_parm", "uint64_uin", "uint64_tinyid", "bool_stock", "bool_is_first", "bool_need_warn", "bool_need_update_url" }, new Object[] { null, localLong, localLong, localBoolean, localBoolean, localBoolean, localBoolean }, ReqBody.class);
  }
}
