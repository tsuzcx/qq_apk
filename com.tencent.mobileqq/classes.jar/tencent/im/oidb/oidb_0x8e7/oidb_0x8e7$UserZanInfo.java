  ...
  extends MessageMicro<UserZanInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint64_uin", "uint64_tinyid", "uint64_free_zan", "uint64_pay_zan", "uint64_pay_stock" }, new Object[] { localLong, localLong, localLong, localLong, localLong }, UserZanInfo.class);
  }
}
