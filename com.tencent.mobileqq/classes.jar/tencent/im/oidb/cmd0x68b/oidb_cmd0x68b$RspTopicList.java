  ...
  extends MessageMicro<RspTopicList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 90 }, new String[] { "uint32_position", "uint32_fix_position", "rpt_topic_list" }, new Object[] { localInteger, localInteger, null }, RspTopicList.class);
  }
}
