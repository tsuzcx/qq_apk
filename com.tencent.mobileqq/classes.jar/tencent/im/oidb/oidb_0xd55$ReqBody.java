  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 90, 98, 106 }, new String[] { "appid", "app_type", "src_id", "raw_url", "is_need_appinfo", "check_app_sign_req", "check_user_req", "check_mini_app_req" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, "", localInteger, null, null, null }, ReqBody.class);
  }
}
