  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint32_set_mode", "uint32_test_mode", "rpt_msg_tags" }, new Object[] { localInteger, localInteger, null }, ReqBody.class);
  }
}
