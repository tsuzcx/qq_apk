  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "uint64_group_code", "uint32_req_type", "msg_join_group", "msg_exit_group", "uint32_req_client_type" }, new Object[] { Long.valueOf(0L), localInteger, null, null, localInteger }, ReqBody.class);
  }
}
