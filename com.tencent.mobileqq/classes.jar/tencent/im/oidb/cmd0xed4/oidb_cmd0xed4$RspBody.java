  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 50 }, new String[] { "retcode", "retmsg", "retobj", "content_has_coin", "content_coin_num", "extra" }, new Object[] { localInteger, "", null, Boolean.valueOf(false), localInteger, null }, RspBody.class);
  }
}
