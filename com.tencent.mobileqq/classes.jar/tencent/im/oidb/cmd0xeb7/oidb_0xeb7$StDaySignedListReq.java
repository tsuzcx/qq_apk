...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40 }, new String[] { "dayYmd", "uid", "groupId", "offset", "limit" }, new Object[] { "", "", "", Integer.valueOf(0), Integer.valueOf(0) }, StDaySignedListReq.class);
