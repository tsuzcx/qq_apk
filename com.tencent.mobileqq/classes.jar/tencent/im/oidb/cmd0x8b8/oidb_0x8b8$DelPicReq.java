  ...
  extends MessageMicro<DelPicReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_del_cnt", "rpt_uint32_del_list" }, new Object[] { localInteger, localInteger }, DelPicReq.class);
  }
}
