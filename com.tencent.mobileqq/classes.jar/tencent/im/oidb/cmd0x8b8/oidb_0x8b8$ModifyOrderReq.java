  ...
  extends MessageMicro<ModifyOrderReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_pic_cnt", "rpt_uint32_pic_list" }, new Object[] { localInteger, localInteger }, ModifyOrderReq.class);
  }
}
