  ...
  extends MessageMicro<PlayerDeviceInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "int32_client_type", "uint32_portal" }, new Object[] { localInteger, localInteger }, PlayerDeviceInfo.class);
  }
}
