  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34 }, new String[] { "msg_req_info", "uint64_group_uin", "uint64_group_code", "msg_kick_visitor" }, new Object[] { null, localLong, localLong, null }, ReqBody.class);
  }
}
