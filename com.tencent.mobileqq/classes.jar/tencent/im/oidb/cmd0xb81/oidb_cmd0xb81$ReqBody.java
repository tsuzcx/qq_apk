...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26 }, new String[] { "uint32_client_type", "msg_get_user_info_req", "tracerParent" }, new Object[] { Integer.valueOf(0), null, "" }, ReqBody.class);
