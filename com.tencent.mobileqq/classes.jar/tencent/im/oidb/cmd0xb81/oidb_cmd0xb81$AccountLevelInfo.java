...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 40, 50, 58, 66 }, new String[] { "uint32_account_cc_level", "account_cc_level_icon_s", "account_cc_level_icon_l", "authorize_desc" }, new Object[] { Integer.valueOf(0), "", "", "" }, AccountLevelInfo.class);
