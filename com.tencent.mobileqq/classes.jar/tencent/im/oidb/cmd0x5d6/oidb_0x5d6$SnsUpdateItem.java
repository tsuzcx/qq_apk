  ...
  extends MessageMicro<SnsUpdateItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint32_update_sns_type", "bytes_value", "uint32_value_offset" }, new Object[] { localInteger, localByteStringMicro, localInteger }, SnsUpdateItem.class);
  }
}
