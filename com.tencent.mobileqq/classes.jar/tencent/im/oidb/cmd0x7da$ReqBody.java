  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "rpt_msg_appoint_ids", "uint32_appoint_operation", "uint32_operation_reason", "uint32_overwrite" }, new Object[] { null, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
