  ...
  extends MessageMicro<DeviceLoc>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "timestamp", "lat", "lon", "gps_type", "uint32_precision" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger }, DeviceLoc.class);
  }
}
