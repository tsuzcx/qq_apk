  ...
  extends MessageMicro<IdolInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48, 58, 64, 72 }, new String[] { "name", "alias", "avatar", "desc", "gender", "idol_id", "pic", "score", "rank" }, new Object[] { "", "", "", "", localInteger, localInteger, "", Long.valueOf(0L), localInteger }, IdolInfo.class);
  }
}
