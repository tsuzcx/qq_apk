  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 56, 64 }, new String[] { "group_id", "client_info", "last_game_dynamic_ts", "page", "num", "mini_appids", "mini_app_disable", "mode" }, new Object[] { localLong, null, localInteger, localInteger, localInteger, localLong, localInteger, localInteger }, ReqBody.class);
  }
}
