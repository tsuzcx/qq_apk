  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 50, 56, 64 }, new String[] { "group_id", "lbs_info", "is_private", "is_ignore_show_num", "online_num", "online_info", "hok_appid", "hok_type" }, new Object[] { Long.valueOf(0L), null, localBoolean, localBoolean, localInteger, null, localInteger, localInteger }, ReqBody.class);
  }
}
