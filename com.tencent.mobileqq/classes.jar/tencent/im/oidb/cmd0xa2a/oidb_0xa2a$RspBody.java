  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 56, 64 }, new String[] { "online_info", "infos", "cache_time", "group_id", "list_type", "online_num", "game_switch_status", "show_game_switch_status" }, new Object[] { "", null, localInteger, Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger }, RspBody.class);
  }
}
