  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 90, 96 }, new String[] { "uint64_uin", "uint64_client_switch", "msg_req_follow_para", "uint32_refer" }, new Object[] { localLong, localLong, null, Integer.valueOf(0) }, ReqBody.class);
  }
}
