...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 88 }, new String[] { "uint64_dst_uin", "uint32_op_account_type", "uint32_op_result", "enum_follow_status", "uint32_guide_type" }, new Object[] { Long.valueOf(0L), Integer.valueOf(1), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) }, OneFollowOperationResult.class);
