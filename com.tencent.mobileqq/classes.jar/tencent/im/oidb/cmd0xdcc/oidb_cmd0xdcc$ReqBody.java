  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_group_id", "em_entry", "rpt_uint64_filter_uin" }, new Object[] { localLong, Integer.valueOf(11), localLong }, ReqBody.class);
  }
}
