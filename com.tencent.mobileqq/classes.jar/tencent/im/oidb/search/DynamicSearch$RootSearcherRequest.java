  ...
  extends MessageMicro<RootSearcherRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 16, 32, 80, 90, 402, 408 }, new String[] { "business", "page_size", "rpt_busi_mask", "cookie", "ocean_data", "use_all_mask" }, new Object[] { localInteger, localInteger, Long.valueOf(0L), localByteStringMicro1, localByteStringMicro2, localInteger }, RootSearcherRequest.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes12.jar
 * Qualified Name:     tencent.im.oidb.search.DynamicSearch.RootSearcherRequest
