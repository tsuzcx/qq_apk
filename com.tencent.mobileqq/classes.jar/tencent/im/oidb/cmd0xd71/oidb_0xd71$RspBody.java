  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "group_id", "game_switch_status", "show_game_switch_status" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, RspBody.class);
  }
}
