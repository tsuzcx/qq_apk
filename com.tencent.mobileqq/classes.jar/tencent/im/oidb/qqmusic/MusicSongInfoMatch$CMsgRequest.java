  ...
  extends MessageMicro<CMsgRequest>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uin", "ct", "cv", "reqtype", "urlparams" }, new Object[] { localLong, localLong, localLong, Integer.valueOf(0), null }, CMsgRequest.class);
  }
}
