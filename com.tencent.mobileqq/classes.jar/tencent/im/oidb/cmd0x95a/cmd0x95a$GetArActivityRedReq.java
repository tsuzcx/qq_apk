  ...
  extends MessageMicro<GetArActivityRedReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint64_uin", "uint64_client_activity_id" }, new Object[] { localLong, localLong }, GetArActivityRedReq.class);
  }
}
