  ...
  extends MessageMicro<ArActivityItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42, 48, 56, 66 }, new String[] { "uint32_activity_id", "uint32_activity_type", "str_activity_pic_url", "str_activity_name", "str_scan_name", "uint32_new_activity", "uint32_jump_type", "str_jump_url" }, new Object[] { localInteger, localInteger, "", "", "", localInteger, localInteger, "" }, ArActivityItem.class);
  }
}
