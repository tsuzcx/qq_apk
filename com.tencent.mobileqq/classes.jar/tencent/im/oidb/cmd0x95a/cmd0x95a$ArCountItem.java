  ...
  extends MessageMicro<ArCountItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint32_count_type", "uint32_count_value", "str_count_name" }, new Object[] { localInteger, localInteger, "" }, ArCountItem.class);
  }
}
