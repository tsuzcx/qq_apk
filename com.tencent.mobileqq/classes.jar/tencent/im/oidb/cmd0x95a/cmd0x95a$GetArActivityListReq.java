  ...
  extends MessageMicro<GetArActivityListReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 37 }, new String[] { "uint64_uin", "uint32_start_pos", "uint32_want_num", "fixed32_last_get_time" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, GetArActivityListReq.class);
  }
}
