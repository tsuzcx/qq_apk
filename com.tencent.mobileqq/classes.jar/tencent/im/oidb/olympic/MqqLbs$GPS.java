  ...
  extends MessageMicro<GPS>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 50 }, new String[] { "int32_lat", "int32_lon", "int32_alt", "int32_type", "uint32_precision", "str_addr" }, new Object[] { localInteger2, localInteger2, Integer.valueOf(-10000000), localInteger1, localInteger1, "" }, GPS.class);
  }
}
