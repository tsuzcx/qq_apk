  ...
  extends MessageMicro<LBSCheckInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "uint32_fake_period", "uint32_fake_times", "rpt_msg_lbs_fake_info", "rpt_msg_cheat_app", "uint32_root_jailbreak" }, new Object[] { Integer.valueOf(60), localInteger, null, null, localInteger }, LBSCheckInfo.class);
  }
}
