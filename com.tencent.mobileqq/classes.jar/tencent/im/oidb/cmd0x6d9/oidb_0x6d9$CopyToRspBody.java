  ...
  extends MessageMicro<CopyToRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 322 }, new String[] { "int32_ret_code", "str_ret_msg", "str_client_wording", "str_save_file_path", "uint32_bus_id", "str_file_name" }, new Object[] { localInteger, "", "", "", localInteger, "" }, CopyToRspBody.class);
  }
}
