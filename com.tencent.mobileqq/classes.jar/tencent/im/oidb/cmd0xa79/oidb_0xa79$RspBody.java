  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_real_state", "uint32_bind_num", "uint32_id_level", "enum_upload_cre" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, RspBody.class);
  }
}
