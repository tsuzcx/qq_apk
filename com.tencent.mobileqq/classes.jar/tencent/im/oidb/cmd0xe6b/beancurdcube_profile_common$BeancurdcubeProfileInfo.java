  ...
  extends MessageMicro<BeancurdcubeProfileInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 160018, 160090, 160154, 160250, 160258, 192018, 192066, 216298, 218114 }, new String[] { "enum_beancurdcube_profile_type", "uint32_last_modify_time", "msg_nickname", "msg_email", "msg_intro", "msg_birthday", "msg_location", "msg_homeland", "msg_company", "msg_occupation", "msg_education" }, new Object[] { localInteger, localInteger, null, null, null, null, null, null, null, null, null }, BeancurdcubeProfileInfo.class);
  }
}
