  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 40, 50, 56, 64, 72, 80 }, new String[] { "uint64_group_code", "uint64_begin_uin", "uint64_data_time", "rpt_uin_list", "opt_filter", "uint32_seq", "uint32_uin_num", "uint32_group_type", "uint32_rich_card_name_ver" }, new Object[] { localLong, localLong, localLong, localLong, null, localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
