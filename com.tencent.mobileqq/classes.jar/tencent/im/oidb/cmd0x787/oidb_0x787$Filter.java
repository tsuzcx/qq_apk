  ...
  extends MessageMicro<Filter>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128, 136, 144, 152, 160, 168, 176, 184, 192, 200, 208, 216, 224, 232, 240 }, new String[] { "uint32_member_level_info_uin", "uint32_member_level_info_point", "uint32_member_level_info_active_day", "uint32_member_level_info_level", "uint32_member_level_info_name", "uint32_level_name", "uint32_data_time", "uint32_user_show_flag", "uint32_sys_show_flag", "uint32_time_to_update", "uint32_nick_name", "uint32_special_title", "uint32_phone", "uint32_email", "uint32_remark", "uint32_gender", "uint32_job", "uint32_office_mode", "uint32_glamour_level", "uint32_torchbearer_flag", "uint32_global_group_level", "uint32_title_id", "uint32_global_group_point", "uint32_ringtone_id", "uint32_group_honor", "uint32_membership", "uint32_level_name_new", "uint32_user_show_flag_new", "uint32_msg_need_field", "uint32_cmduin_flagex3_grocery" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, Filter.class);
  }
}
