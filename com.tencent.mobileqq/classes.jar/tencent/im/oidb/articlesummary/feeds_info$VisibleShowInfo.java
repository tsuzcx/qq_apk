...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_visible_type", "uint64_who", "uint64_feed_id" }, new Object[] { Integer.valueOf(0), Long.valueOf(0L), Long.valueOf(0L) }, VisibleShowInfo.class);
