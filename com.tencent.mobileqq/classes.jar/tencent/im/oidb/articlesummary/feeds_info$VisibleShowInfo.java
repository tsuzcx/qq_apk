  ...
  extends MessageMicro<VisibleShowInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_visible_type", "uint64_who", "uint64_feed_id", "uint32_is_visible" }, new Object[] { localInteger, localLong, localLong, localInteger }, VisibleShowInfo.class);
  }
}
