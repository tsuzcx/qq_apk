  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_uin", "uint32_req_not_see_qzone", "uint32_req_prevent_dynamic" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, ReqBody.class);
  }
}
