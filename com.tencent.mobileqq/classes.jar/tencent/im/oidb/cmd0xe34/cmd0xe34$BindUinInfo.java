  ...
  extends MessageMicro<BindUinInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint64_uin", "uint32_app_id", "uint32_instance_id", "msg_login_sig" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null }, BindUinInfo.class);
  }
}
