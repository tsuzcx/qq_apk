  ...
  extends MessageMicro<GroupMsgUnreadNumInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "group_num", "msg_num", "last_msg_time" }, new Object[] { localInteger, localInteger, localInteger }, GroupMsgUnreadNumInfo.class);
  }
}
