  ...
  extends MessageMicro<AuthItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32 }, new String[] { "auth_group_id", "auth_group_name", "auth_group_desc", "auth_result" }, new Object[] { Integer.valueOf(0), localByteStringMicro1, localByteStringMicro2, Integer.valueOf(0) }, AuthItem.class);
  }
}
