  ...
  extends MessageMicro<GroupInfoExt>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48 }, new String[] { "uint32_group_info_ext_seq", "uint64_lucky_word_id", "uint32_light_char_num", "bytes_lucky_word", "uint32_star_id", "uint32_essential_msg_switch" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, localByteStringMicro, localInteger, localInteger }, GroupInfoExt.class);
  }
}
