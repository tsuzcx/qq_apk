  ...
  extends MessageMicro<GetListReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "group_code", "start", "limit" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, GetListReq.class);
  }
}
