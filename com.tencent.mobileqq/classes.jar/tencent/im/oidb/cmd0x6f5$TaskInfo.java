  ...
  extends MessageMicro<TaskInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48 }, new String[] { "uint32_task_id", "uint32_appid", "uint32_passthrough_level", "uint32_show_level", "uint32_extra", "uint32_priority" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, TaskInfo.class);
  }
}
