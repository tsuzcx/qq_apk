  ...
  extends MessageMicro<GetRecommendSNFrdListReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_uin", "uint32_sequence", "uint32_start_idx", "uint32_req_num" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, GetRecommendSNFrdListReq.class);
  }
}
