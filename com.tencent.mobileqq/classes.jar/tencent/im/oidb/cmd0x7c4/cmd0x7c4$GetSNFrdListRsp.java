  ...
  extends MessageMicro<GetSNFrdListRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48 }, new String[] { "uint64_uin", "uint32_sequence", "uint32_over", "uint32_next_start_idx", "rpt_msg_one_frd_data", "uint32_recommend_frd_count" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, null, localInteger }, GetSNFrdListRsp.class);
  }
}
