  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48 }, new String[] { "uint32_seq", "uint32_over", "uint32_next_start", "rpt_msg_friend_score", "uint32_total", "uint32_low_score" }, new Object[] { localInteger, localInteger, localInteger, null, localInteger, localInteger }, RspBody.class);
  }
}
