  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50, 58, 66 }, new String[] { "uint32_appid", "uint32_cmdid", "int32_channel", "msg_add_hate_group", "msg_channel_status", "msg_channel_set", "msg_get_hate_group", "msg_get_web_info" }, new Object[] { localInteger, localInteger, localInteger, null, null, null, null, null }, ReqBody.class);
  }
}
