  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 32, 40, 72, 80, 90 }, new String[] { "rpt_results", "uint32_metal_count", "uint32_metal_total", "int32_new_count", "int32_upgrade_count", "str_prompt_params" }, new Object[] { null, localInteger, localInteger, localInteger, localInteger, "" }, RspBody.class);
  }
}
