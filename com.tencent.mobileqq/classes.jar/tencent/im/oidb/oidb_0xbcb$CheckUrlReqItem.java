  ...
  extends MessageMicro<CheckUrlReqItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 40, 48, 56, 64, 72, 82 }, new String[] { "url", "refer", "plateform", "qq_pf_to", "msg_type", "msg_from", "msg_chatid", "service_type", "send_uin", "req_type" }, new Object[] { "", "", "", "", localInteger, localInteger, localLong, localLong, localLong, "" }, CheckUrlReqItem.class);
  }
}
