  ...
  extends MessageMicro<MsgProcessInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "msg", "error_code", "digest_uin", "digest_time" }, new Object[] { null, localInteger, Long.valueOf(0L), localInteger }, MsgProcessInfo.class);
  }
}
