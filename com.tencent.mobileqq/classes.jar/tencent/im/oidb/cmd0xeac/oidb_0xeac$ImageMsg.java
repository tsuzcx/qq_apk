...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 808, 816, 824, 834, 1610, 1618, 1626 }, new String[] { "md5", "uuid", "img_type", "file_size", "width", "height", "file_id", "server_ip", "server_port", "str_file_path", "thumb_url", "original_url", "resave_url" }, new Object[] { "", "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", "", "", "" }, ImageMsg.class);
