  ...
  extends MessageMicro<OnlineInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_friend_uin", "uint32_status", "uint32_ext_online_status", "uint64_act_time" }, new Object[] { localLong, localInteger, localInteger, localLong }, OnlineInfo.class);
  }
}
