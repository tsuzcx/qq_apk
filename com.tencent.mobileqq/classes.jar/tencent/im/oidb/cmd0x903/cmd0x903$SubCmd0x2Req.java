  ...
  extends MessageMicro<SubCmd0x2Req>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "opt_uint64_group_code", "uint64_req_start_time", "uint32_uin_num" }, new Object[] { localLong, localLong, Integer.valueOf(0) }, SubCmd0x2Req.class);
  }
}
