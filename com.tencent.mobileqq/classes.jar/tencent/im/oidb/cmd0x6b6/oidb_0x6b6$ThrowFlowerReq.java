  ...
  extends MessageMicro<ThrowFlowerReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "int32_count", "uint32_play_rule", "uint32_product_id" }, new Object[] { localInteger, localInteger, localInteger }, ThrowFlowerReq.class);
  }
}
