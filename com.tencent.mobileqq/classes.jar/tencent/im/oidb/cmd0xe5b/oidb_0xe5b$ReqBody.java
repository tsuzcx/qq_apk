  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_uin", "rpt_achievement_id", "uint32_max_count", "bool_req_achievement_content" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, Boolean.valueOf(false) }, ReqBody.class);
  }
}
