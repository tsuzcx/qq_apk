  ...
  extends MessageMicro<GroupRemarkInfoRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_group_code", "uint64_group_uin", "int32_result" }, new Object[] { localLong, localLong, Integer.valueOf(0) }, GroupRemarkInfoRsp.class);
  }
}
