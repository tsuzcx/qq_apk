  ...
  extends MessageMicro<HeadInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 34, 40, 48, 88 }, new String[] { "uint32_id", "rpt_videoheadlist", "str_photohead", "uint32_timestamp", "uint32_type", "uint32_invalid" }, new Object[] { localInteger, null, "", localInteger, localInteger, localInteger }, HeadInfo.class);
  }
}
