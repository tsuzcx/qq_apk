  ...
  extends MessageMicro<OneUinHeadInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 34, 88 }, new String[] { "uint64_uin", "uint32_timestamp", "rpt_msg_head_list", "uint64_tinyid" }, new Object[] { localLong, Integer.valueOf(0), null, localLong }, OneUinHeadInfo.class);
  }
}
