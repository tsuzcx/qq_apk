  ...
  extends MessageMicro<GroupFee>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 56, 64, 72 }, new String[] { "string_project_id", "string_project_name", "uint32_project_cost", "uint32_project_paid_user", "uint32_project_npaid_user", "uint64_project_start_time", "uint64_project_close_time", "uint32_project_status", "uint32_project_paid" }, new Object[] { "", "", localInteger, localInteger, localInteger, localLong, localLong, localInteger, localInteger }, GroupFee.class);
  }
}
