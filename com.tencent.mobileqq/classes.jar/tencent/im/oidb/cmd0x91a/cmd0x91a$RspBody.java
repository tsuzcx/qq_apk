  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40 }, new String[] { "uint32_result_status", "uint32_audit_times_max", "uint32_audit_times_remain", "group_info", "uint64_group_code" }, new Object[] { localInteger, localInteger, localInteger, null, Long.valueOf(0L) }, RspBody.class);
  }
}
