  ...
  extends MessageMicro<SelectedUinInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_all_frd", "uint64_uin", "uint64_group_code", "uint64_discuss_uin" }, new Object[] { Integer.valueOf(0), localLong, localLong, localLong }, SelectedUinInfo.class);
  }
}
