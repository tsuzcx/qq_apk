  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_uin", "uint64_start_time", "uint64_end_time" }, new Object[] { localLong, localLong, localLong }, ReqBody.class);
  }
}
