  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint64_uin", "uint32_parent_channel_id", "rpt_child_channel_list", "uint32_req_channel_subscription_count", "uint32_req_channel_header_url" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
