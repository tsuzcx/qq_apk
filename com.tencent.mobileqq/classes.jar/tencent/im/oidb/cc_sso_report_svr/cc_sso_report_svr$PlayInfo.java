  ...
  extends MessageMicro<PlayInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48 }, new String[] { "genurl_duration", "genurl_errcode", "prepare_duration", "play_duration", "play_errcode", "skipframe_cnt" }, new Object[] { localLong, localInteger, localLong, localLong, "", localInteger }, PlayInfo.class);
  }
}
