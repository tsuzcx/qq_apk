  ...
  extends MessageMicro<VideoInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 66 }, new String[] { "busitype", "video_type", "file_size", "video_duration", "encode_type", "weight", "height", "rate" }, new Object[] { localInteger, localInteger, localLong, localLong, localInteger, localLong, localLong, "" }, VideoInfo.class);
  }
}
