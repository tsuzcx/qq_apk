  ...
  extends MessageMicro<QQVedioGamePushInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42 }, new String[] { "uint32_msg_type", "uint64_group_code", "uint64_oper_uin", "bytes_version_ctrl", "bytes_ext_info" }, new Object[] { Integer.valueOf(0), localLong, localLong, localByteStringMicro1, localByteStringMicro2 }, QQVedioGamePushInfo.class);
  }
}
