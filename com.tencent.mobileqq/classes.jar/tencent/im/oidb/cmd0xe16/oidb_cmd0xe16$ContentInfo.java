...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 34, 40 }, new String[] { "str_rowkey", "uint32_src", "str_article_id", "str_feeds_id", "uint32_feeds_type" }, new Object[] { "", Integer.valueOf(0), "", "", Integer.valueOf(0) }, ContentInfo.class);
