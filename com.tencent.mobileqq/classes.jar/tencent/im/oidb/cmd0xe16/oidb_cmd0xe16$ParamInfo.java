...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "bool_with_biu", "bool_diffuse_to_friends", "bool_only_biu" }, new Object[] { Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false) }, ParamInfo.class);
