  ...
  extends MessageMicro<GroupAllianceNotify>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40 }, new String[] { "uint64_alliance_id", "uint64_alliance_owner", "uint64_leader_group_code", "st_apply_alliance", "uint32_result" }, new Object[] { localLong, localLong, localLong, null, Integer.valueOf(0) }, GroupAllianceNotify.class);
  }
}
