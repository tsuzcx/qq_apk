  ...
  extends MessageMicro<StockItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "int32_productid", "int32_amount", "int32_free_limit_chance" }, new Object[] { localInteger, localInteger, localInteger }, StockItem.class);
  }
}
