  ...
  extends MessageMicro<GetStockReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "bool_not_need_gift_stock", "uint32_imgshow_config", "uint32_not_give_stock", "uint32_not_midas_stock" }, new Object[] { Boolean.valueOf(false), localInteger, localInteger, localInteger }, GetStockReq.class);
  }
}
