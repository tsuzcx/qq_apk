  ...
  extends MessageMicro<MutualMarkData>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 90 }, new String[] { "uint64_frd_uin", "uint32_result", "uint32_is_gray_for_chat_move", "mutualmark_info" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null }, MutualMarkData.class);
  }
}
