...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 90, 98, 106, 114 }, new String[] { "uint64_uin", "msg_current_skin_info", "msg_next_guide_info", "msg_current_refresh_info", "msg_current_guide_info" }, new Object[] { Long.valueOf(0L), null, null, null, null }, ReqBody.class);
