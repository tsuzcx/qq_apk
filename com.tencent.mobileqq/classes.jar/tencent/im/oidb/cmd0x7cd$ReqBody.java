  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 800 }, new String[] { "uint32_stamp", "uint32_start", "uint32_want", "msg_lbs_info", "rpt_msg_appoint_ids", "uint32_appoint_operation", "uint64_request_uin" }, new Object[] { localInteger, localInteger, localInteger, null, null, localInteger, Long.valueOf(0L) }, ReqBody.class);
  }
}
