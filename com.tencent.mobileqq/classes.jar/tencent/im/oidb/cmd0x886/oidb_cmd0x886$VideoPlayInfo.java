  ...
  extends MessageMicro<VideoPlayInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56 }, new String[] { "uint32_bt", "uint32_et", "uint32_bf", "uint32_ef", "uint32_pp", "uint32_pa", "uint32_pb" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, VideoPlayInfo.class);
  }
}
