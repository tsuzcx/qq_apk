...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42 }, new String[] { "uint32_check_result", "rpt_phone_info", "str_mibao_set_url", "str_mibao_change_url", "str_mibao_verify_url" }, new Object[] { Integer.valueOf(0), null, "", "", "" }, RspBody.class);
