  ...
  extends MessageMicro<ReadFaceScoreReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_user_id", "uint32_day", "uint32_range_min", "uint32_range_max" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, ReadFaceScoreReq.class);
  }
}
