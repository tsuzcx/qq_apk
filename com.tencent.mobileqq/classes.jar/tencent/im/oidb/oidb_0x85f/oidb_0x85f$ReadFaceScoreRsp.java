  ...
  extends MessageMicro<ReadFaceScoreRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "uint64_user_id", "uint32_score_of_mine", "msg_score", "uint32_show_user", "uint32_score_to_me" }, new Object[] { Long.valueOf(0L), localInteger, null, localInteger, localInteger }, ReadFaceScoreRsp.class);
  }
}
