  ...
  extends MessageMicro<ReqMsgInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40, 48, 56 }, new String[] { "uint64_feeds_id", "uint32_feeds_style", "bytes_recommend_reason", "uint32_biu_time", "feeds_type", "uint32_business_id", "rpt_topic_id" }, new Object[] { Long.valueOf(0L), localInteger, localByteStringMicro, localInteger, localInteger, localInteger, localInteger }, ReqMsgInfo.class);
  }
}
