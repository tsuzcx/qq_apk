  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_praiseuin", "uint32_achievement_id", "uint32_actiontype" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, ReqBody.class);
  }
}
