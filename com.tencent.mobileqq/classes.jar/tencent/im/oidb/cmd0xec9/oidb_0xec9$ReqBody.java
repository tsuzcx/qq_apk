...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 40 }, new String[] { "str_quest_id", "uint64_uin", "uint64_act_type", "str_like_key", "uint64_quest_time" }, new Object[] { "", Long.valueOf(0L), Long.valueOf(0L), "", Long.valueOf(0L) }, ReqBody.class);
