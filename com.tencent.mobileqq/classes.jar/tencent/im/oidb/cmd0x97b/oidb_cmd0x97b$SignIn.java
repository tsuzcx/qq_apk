  ...
  extends MessageMicro<SignIn>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "int64_status", "uint32_current_continuous_sign_days", "uint32_max_continuous_sign_days" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, SignIn.class);
  }
}
