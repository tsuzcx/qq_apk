  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56 }, new String[] { "uint64_uin", "uint32_req_ctrl_bits", "uint32_like_total", "uint32_publish_feeds_total", "uint32_sign_in", "uint32_medal", "uint32_column_info" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
