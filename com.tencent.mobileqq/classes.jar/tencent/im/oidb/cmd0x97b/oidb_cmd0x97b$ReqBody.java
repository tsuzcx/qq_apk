...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint64_uin", "uint32_req_ctrl_bits" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0) }, ReqBody.class);
