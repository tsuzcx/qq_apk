  ...
  extends MessageMicro<GroupMemberInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint64_group_code", "uint32_show_flag", "uint32_sys_show_flag", "rpt_msg_level_name" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null }, GroupMemberInfo.class);
  }
}
