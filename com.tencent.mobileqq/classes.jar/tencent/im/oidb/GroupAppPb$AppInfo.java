...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 50, 58, 66 }, new String[] { "appid", "icon", "name", "url", "is_gray", "icon_simple_day", "icon_simple_night", "icon_youth" }, new Object[] { Integer.valueOf(0), "", "", "", Integer.valueOf(0), "", "", "" }, AppInfo.class);
