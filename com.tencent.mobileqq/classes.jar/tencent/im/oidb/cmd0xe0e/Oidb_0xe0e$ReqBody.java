  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "group_id", "disabled", "disabled_appids" }, new Object[] { localLong, Integer.valueOf(0), localLong }, ReqBody.class);
  }
}
