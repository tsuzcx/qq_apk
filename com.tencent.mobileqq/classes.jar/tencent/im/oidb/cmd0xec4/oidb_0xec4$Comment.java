  ...
  extends MessageMicro<Comment>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 50, 58 }, new String[] { "str_id", "str_comment", "uint64_time", "uint64_from_uin", "uint64_to_uin", "str_reply_id", "str_from_nick" }, new Object[] { "", "", localLong, localLong, localLong, "", "" }, Comment.class);
  }
}
