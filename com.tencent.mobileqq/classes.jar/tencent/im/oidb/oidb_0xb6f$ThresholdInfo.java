  ...
  extends MessageMicro<ThresholdInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "threshold_per_minute", "threshold_per_day", "threshold_per_hour", "threshold_per_week" }, new Object[] { localLong, localLong, localLong, localLong }, ThresholdInfo.class);
  }
}
