  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50, 58 }, new String[] { "uint64_group_uin", "uint64_group_code", "uint32_req_type", "str_err_msg", "msg_join_group", "msg_exit_group", "msg_kick_visitor" }, new Object[] { localLong, localLong, Integer.valueOf(0), "", null, null, null }, RspBody.class);
  }
}
