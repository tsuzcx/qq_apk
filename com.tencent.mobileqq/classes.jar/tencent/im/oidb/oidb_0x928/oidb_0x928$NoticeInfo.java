  ...
  extends MessageMicro<NoticeInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 48, 56, 64, 72 }, new String[] { "id", "title", "summary", "url", "icon", "type", "app_id", "show_expire", "hide_mode" }, new Object[] { "", "", "", "", "", localInteger, Long.valueOf(0L), localInteger, localInteger }, NoticeInfo.class);
  }
}
