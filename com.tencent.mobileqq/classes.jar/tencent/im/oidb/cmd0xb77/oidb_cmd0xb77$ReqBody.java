...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50, 80, 88, 98, 106, 114, 122, 130, 138, 146 }, new String[] { "appid", "app_type", "msg_style", "sender_uin", "client_info", "text_msg", "send_type", "recv_uin", "rich_msg_body", "ark_msg_body", "recv_openid", "arkv1_msg_body", "ark_json_body", "xml_msg_body", "mini_app_msg_body" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L), null, "", Integer.valueOf(0), Long.valueOf(0L), null, null, "", null, null, null, null }, ReqBody.class);
