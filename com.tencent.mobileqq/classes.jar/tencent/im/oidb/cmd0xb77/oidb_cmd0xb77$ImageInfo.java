  ...
  extends MessageMicro<ImageInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48, 56, 808, 816, 824 }, new String[] { "md5", "uuid", "img_type", "file_size", "width", "height", "original", "file_id", "server_ip", "server_port" }, new Object[] { "", "", localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, ImageInfo.class);
  }
}
