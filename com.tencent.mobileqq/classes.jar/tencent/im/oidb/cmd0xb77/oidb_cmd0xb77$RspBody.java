  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 40, 50 }, new String[] { "wording", "jump_result", "jump_url", "uint32_level", "uint32_sub_level", "develop_msg" }, new Object[] { "", localInteger, "", localInteger, localInteger, "" }, RspBody.class);
  }
}
