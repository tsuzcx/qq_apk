  ...
  extends MessageMicro<GetAtAllRemainRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint64_uin", "uint32_uin_remain", "uint64_discuss_uin", "uint32_discuss_uin_remain", "bool_priviledge" }, new Object[] { localLong, localInteger, localLong, localInteger, Boolean.valueOf(false) }, GetAtAllRemainRsp.class);
  }
}
