  ...
  extends MessageMicro<DecreaseUnreadMailCountReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40 }, new String[] { "uint32_type", "uint32_amount", "rpt_msg_indexes", "msg_recalled_index", "uint32_data_version" }, new Object[] { localInteger, localInteger, null, null, localInteger }, DecreaseUnreadMailCountReq.class);
  }
}
