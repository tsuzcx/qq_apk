  ...
  extends MessageMicro<ResvAttr>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_friend_banned_flag", "uint32_gray_tips_from" }, new Object[] { localInteger, localInteger }, ResvAttr.class);
  }
}
