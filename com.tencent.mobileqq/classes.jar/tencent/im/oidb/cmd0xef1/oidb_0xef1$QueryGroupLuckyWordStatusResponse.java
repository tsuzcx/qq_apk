...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "wording", "status", "remain_times" }, new Object[] { "", Integer.valueOf(0), Integer.valueOf(0) }, QueryGroupLuckyWordStatusResponse.class);
