  ...
  extends MessageMicro<GetSpaceRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 48 }, new String[] { "int32_ret_code", "str_ret_msg", "str_client_wording", "uint64_total_space", "uint64_used_space", "bool_all_upload" }, new Object[] { Integer.valueOf(0), "", "", localLong, localLong, Boolean.valueOf(false) }, GetSpaceRspBody.class);
  }
}
