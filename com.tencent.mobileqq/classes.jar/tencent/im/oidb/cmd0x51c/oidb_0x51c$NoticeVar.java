  ...
  extends MessageMicro<NoticeVar>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "opt_uint32_operate_type", "opt_uint32_notice_var", "opt_uint32_notice_version" }, new Object[] { localInteger, localInteger, localInteger }, NoticeVar.class);
  }
}
