  ...
  extends MessageMicro<MsgContent>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 90, 98, 106, 112 }, new String[] { "string_feeds_id", "uint32_feed_type", "uint32_type", "str_desc", "str_feeds_pic", "string_sys_activityid", "uint32_sys_from" }, new Object[] { "", localInteger, localInteger, "", "", "", localInteger }, MsgContent.class);
  }
}
