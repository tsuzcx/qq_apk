  ...
  extends MessageMicro<MsgBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50, 58, 66, 74, 82, 88, 106 }, new String[] { "uint64_seq", "uint64_msg_time", "uint32_msg_type", "uint64_from_uin", "bytes_pic_url", "bytes_jump_url", "msg_folder_info", "msg_content", "bytes_ext_data", "str_msgid", "uint32_msg_sub_type", "str_summary" }, new Object[] { localLong, localLong, localInteger, localLong, localByteStringMicro1, localByteStringMicro2, null, null, localByteStringMicro3, "", localInteger, "" }, MsgBody.class);
  }
}
