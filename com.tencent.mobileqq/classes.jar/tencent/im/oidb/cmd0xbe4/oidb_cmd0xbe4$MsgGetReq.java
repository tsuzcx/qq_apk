...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_last_msg", "uint32_msg_content" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0) }, MsgGetReq.class);
