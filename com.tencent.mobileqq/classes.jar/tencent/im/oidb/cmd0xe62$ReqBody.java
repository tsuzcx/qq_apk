...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "set_type", "rpt_uint64_uin", "rpt_uint32_smart_status", "bool_clear_smart_status" }, new Object[] { Integer.valueOf(0), Long.valueOf(0L), Integer.valueOf(0), Boolean.valueOf(false) }, ReqBody.class);
