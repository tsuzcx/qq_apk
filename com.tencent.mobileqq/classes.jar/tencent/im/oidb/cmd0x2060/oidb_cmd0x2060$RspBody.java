  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_vote_total", "uint32_vote_yes_num", "uint32_vote_no_num", "uint32_vote_status" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, RspBody.class);
  }
}
