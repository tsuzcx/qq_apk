  ...
  extends MessageMicro<GroupConcernedInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42, 48 }, new String[] { "uint64_group_code", "uint32_update_time", "rpt_msg_concerned", "rpt_msg_word", "rpt_msg_forbid_uins", "rpt_uint64_default_uins" }, new Object[] { localLong, Integer.valueOf(0), null, null, null, localLong }, GroupConcernedInfo.class);
  }
}
