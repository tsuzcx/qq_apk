  ...
  extends MessageMicro<GetRankListReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "ranklist_id", "top_count", "rank_key", "rank_value_type", "rank_order_type" }, new Object[] { localInteger, Integer.valueOf(10), "", localInteger, localInteger }, GetRankListReqBody.class);
  }
}
