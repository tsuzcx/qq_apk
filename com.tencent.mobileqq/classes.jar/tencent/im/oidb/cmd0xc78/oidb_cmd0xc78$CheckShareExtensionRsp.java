  ...
  extends MessageMicro<CheckShareExtensionRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "result", "jump_result", "jump_url", "uint32_level", "uint32_sub_level" }, new Object[] { localInteger, localInteger, "", localInteger, localInteger }, CheckShareExtensionRsp.class);
  }
}
