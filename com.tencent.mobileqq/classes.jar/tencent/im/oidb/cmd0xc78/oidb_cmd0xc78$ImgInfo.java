  ...
  extends MessageMicro<ImgInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42, 50 }, new String[] { "md5", "sha1", "width", "height", "qr_decode_type", "qr_code_result" }, new Object[] { "", "", localInteger, localInteger, "", "" }, ImgInfo.class);
  }
}
