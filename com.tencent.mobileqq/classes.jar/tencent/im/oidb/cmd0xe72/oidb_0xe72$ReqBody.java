  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uint64_grp_code", "uint64_uin", "bytes_join_group_auth", "uint32_edu_support_no_verify" }, new Object[] { localLong, localLong, localByteStringMicro, Integer.valueOf(0) }, ReqBody.class);
  }
}
