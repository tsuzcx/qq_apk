...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_no_verify", "uint32_high_risk_group" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0) }, RspBody.class);
