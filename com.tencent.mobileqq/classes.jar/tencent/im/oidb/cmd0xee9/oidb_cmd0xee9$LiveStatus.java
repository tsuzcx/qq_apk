  ...
  extends MessageMicro<LiveStatus>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50, 58 }, new String[] { "uint32_liveing", "uint64_live_time", "uint32_source", "str_account", "str_roomid", "rowkey", "str_url" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, "", "", "", "" }, LiveStatus.class);
  }
}
