  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 90 }, new String[] { "uint32_reserved", "uint32_query_mode", "msg_req_search_tag_info" }, new Object[] { localInteger, localInteger, null }, ReqBody.class);
  }
}
