  ...
  extends MessageMicro<RspChannelArticle>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uint32_channel_id", "uint32_channel_type", "rpt_article_list", "uint32_is_no_more_data" }, new Object[] { localInteger, localInteger, null, localInteger }, RspChannelArticle.class);
  }
}
