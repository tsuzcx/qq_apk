  ...
  extends MessageMicro<TemplateMsgConfig>
{
  ...
  public final PBUInt64Field helper_msg_uin = PBField.initUInt64(0L);
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "service_msg_uin", "public_msg_uin", "camp_msg_uin", "helper_msg_uin" }, new Object[] { localLong, localLong, localLong, localLong }, TemplateMsgConfig.class);
  }
}
