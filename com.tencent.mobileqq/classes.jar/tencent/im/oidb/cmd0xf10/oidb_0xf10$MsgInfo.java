...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 58, 66, 72, 82, 90 }, new String[] { "group_code", "msg_seq", "msg_random", "sender_avatar", "sender_nick", "sender_time", "add_digest_avatar", "add_digest_nick", "add_digest_time", "jump_url", "msg_content" }, new Object[] { Long.valueOf(0L), Integer.valueOf(0), Integer.valueOf(0), "", "", Integer.valueOf(0), "", "", Integer.valueOf(0), "", null }, MsgInfo.class);
