  ...
  extends MessageMicro<TinyID2UserAccInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint64_tinyid", "uint32_useracctype", "uint32_sdkappid", "str_useracc_identifier" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, "" }, TinyID2UserAccInfo.class);
  }
}
