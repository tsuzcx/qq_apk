  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint64_group_code", "uint64_from_uin", "uint32_msg_seq", "uint32_msg_time", "uint64_start_uin" }, new Object[] { localLong, localLong, localInteger, localInteger, localLong }, ReqBody.class);
  }
}
