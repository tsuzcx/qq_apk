  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "uint64_group_code", "rpt_msg_uin_info", "uint64_next_uin", "uint32_read_uin_num" }, new Object[] { localLong, null, localLong, Integer.valueOf(0) }, RspBody.class);
  }
}
