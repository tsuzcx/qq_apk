  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "bool_online_status_visible_to_all_frd", "rpt_uint64_uin_can_see_my_online_status", "rpt_uint64_uin_online_status_visible_to_me", "rpt_uint32_smart_status" }, new Object[] { Boolean.valueOf(false), localLong, localLong, Integer.valueOf(0) }, RspBody.class);
  }
}
