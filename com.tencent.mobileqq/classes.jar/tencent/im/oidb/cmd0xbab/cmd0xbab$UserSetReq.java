  ...
  extends MessageMicro<UserSetReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48 }, new String[] { "uin", "doc_url", "privilege_flag", "policy", "only", "exp_set_time" }, new Object[] { Long.valueOf(0L), "", localInteger, localInteger, Boolean.valueOf(false), localInteger }, UserSetReq.class);
  }
}
