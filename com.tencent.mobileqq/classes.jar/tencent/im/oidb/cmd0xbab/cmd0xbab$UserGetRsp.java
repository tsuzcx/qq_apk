  ...
  extends MessageMicro<UserGetRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "policy", "privilege_flag", "member_number", "exp_remain_time", "exp_set_time" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger }, UserGetRsp.class);
  }
}
