  ...
  extends MessageMicro<NoticeInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 48 }, new String[] { "rule_id", "title", "summary", "icon", "url", "version" }, new Object[] { localInteger, "", "", "", "", localInteger }, NoticeInfo.class);
  }
}
