  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "uint64_group_code", "uint64_current_max_msgseq", "string_verify_url", "uint32_verify_type" }, new Object[] { localLong, localLong, "", Integer.valueOf(0) }, RspBody.class);
  }
}
