  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 170, 178, 186 }, new String[] { "uint32_result", "uint32_flag", "bytes_tag", "rpt_group_info", "bytes_text_label" }, new Object[] { localInteger, localInteger, localByteStringMicro1, null, localByteStringMicro2 }, RspBody.class);
  }
}
