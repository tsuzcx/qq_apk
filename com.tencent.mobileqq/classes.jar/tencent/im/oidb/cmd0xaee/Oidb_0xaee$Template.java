  ...
  extends MessageMicro<Template>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 42, 50, 58, 66, 72, 160 }, new String[] { "template_id", "template_name", "group_type", "mob_thumb_url", "mob_prev_url", "web_thumb_url", "web_prev_url", "template_url", "doc_type", "group_code" }, new Object[] { localInteger, "", localInteger, "", "", "", "", "", localInteger, Long.valueOf(0L) }, Template.class);
  }
}
