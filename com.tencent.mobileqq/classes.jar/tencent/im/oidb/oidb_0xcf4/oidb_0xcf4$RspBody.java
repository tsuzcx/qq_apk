...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 82, 90, 98, 106, 114, 122, 130, 138, 146, 154, 162, 170, 178, 186 }, new String[] { "uint64_from_uin", "uint64_to_uin", "msg_cur_mutual_mark_info", "msg_friend_info", "msg_common_group_chat_info", "rpt_msg_mutual_mark_info", "rpt_msg_dna_info", "rpt_msg_prefetch_mutual_mark_info", "rpt_msg_data_tips", "rpt_msg_common_rspbody", "rpt_msg_mutual_score", "rpt_msg_mutual_score_card", "msg_love_ach_info", "rpt_new_dna_info", "msg_empty_status", "msg_love_tree_info" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), null, null, null, null, null, null, null, null, null, null, null, null, null, null }, RspBody.class);
  ...
  public oidb_0xcf4.EmptyStatusInfo msg_empty_status = new oidb_0xcf4.EmptyStatusInfo();
  public oidb_0xcf4.FriendInfo msg_friend_info = new oidb_0xcf4.FriendInfo();
  public oidb_0xcf4.LoveAchievementInfo msg_love_ach_info = new oidb_0xcf4.LoveAchievementInfo();
  public oidb_0xcf4.LoveTreeInfo msg_love_tree_info = new oidb_0xcf4.LoveTreeInfo();
  ...
  public final PBRepeatMessageField<oidb_0xcf4.NewDnaInfo> rpt_new_dna_info = PBField.initRepeatMessage(oidb_0xcf4.NewDnaInfo.class);
