...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint32_achievement_id", "str_achievement_backurl", "clockState" }, new Object[] { Integer.valueOf(0), "", Integer.valueOf(0) }, LoveAchievementItem.class);
