...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48 }, new String[] { "uint64_from_uin", "uint64_to_uin", "eDateType", "bool_qzone_dna", "rpt_msg_common_reqbody", "bool_new_dna" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Integer.valueOf(1), Boolean.valueOf(false), null, Boolean.valueOf(false) }, ReqBody.class);
