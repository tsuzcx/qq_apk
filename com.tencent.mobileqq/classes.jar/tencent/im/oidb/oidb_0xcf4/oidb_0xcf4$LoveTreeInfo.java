...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 34, 42, 48 }, new String[] { "str_use_tree_icon", "uint32_lack_water_flag", "str_drop_icon", "str_jump_url", "str_jump_h5_url", "uint32_level" }, new Object[] { "", Integer.valueOf(0), "", "", "", Integer.valueOf(0) }, LoveTreeInfo.class);
