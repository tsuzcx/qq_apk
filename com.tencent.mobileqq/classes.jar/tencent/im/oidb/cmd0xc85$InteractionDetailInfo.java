  ...
  extends MessageMicro<InteractionDetailInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 808, 816, 824, 834, 842 }, new String[] { "uint32_continuous_record_days", "uint32_send_day_time", "uint32_recv_day_time", "str_send_record", "str_recv_record" }, new Object[] { localInteger, localInteger, localInteger, "", "" }, InteractionDetailInfo.class);
  }
}
