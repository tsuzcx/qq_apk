  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 80, 88, 96 }, new String[] { "rpt_topiclist", "uint32_req_pv", "uint32_req_followed_count", "uint32_req_ugc_count" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
