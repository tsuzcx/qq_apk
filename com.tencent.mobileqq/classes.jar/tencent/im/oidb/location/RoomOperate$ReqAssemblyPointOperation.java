  ...
  extends MessageMicro<ReqAssemblyPointOperation>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 25, 33, 42, 50 }, new String[] { "room_key", "point_operation", "lon", "lat", "poi_name", "poi_address" }, new Object[] { null, Integer.valueOf(1), localDouble, localDouble, localByteStringMicro1, localByteStringMicro2 }, ReqAssemblyPointOperation.class);
  }
}
