  ...
  extends MessageMicro<GetAppinfoReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "appid", "app_type", "platform" }, new Object[] { localInteger, localInteger, localInteger }, GetAppinfoReq.class);
  }
}
