  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "opt_uint32_ret_code", "rpt_uint64_groupcode", "opt_uint64_timestamp" }, new Object[] { Integer.valueOf(0), localLong, localLong }, RspBody.class);
  }
}
