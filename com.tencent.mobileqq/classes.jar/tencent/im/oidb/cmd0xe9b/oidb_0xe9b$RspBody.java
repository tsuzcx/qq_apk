  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 50 }, new String[] { "uint64_next_req_interval", "msg_basic_profile", "rpt_msg_label", "msg_qzone_info", "rpt_msg_selected_pic", "rpt_bytes_longnick" }, new Object[] { Long.valueOf(0L), null, null, null, null, localByteStringMicro }, RspBody.class);
  }
}
