...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42 }, new String[] { "str_id", "str_quest", "uint64_quest_uin", "uint64_time", "str_ans" }, new Object[] { "", "", Long.valueOf(0L), Long.valueOf(0L), "" }, Quest.class);
