  ...
  extends MessageMicro<ForwardGroupRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40 }, new String[] { "int32_ret_code", "str_ret_msg", "str_client_wording", "bytes_save_file_path", "uint32_bus_id" }, new Object[] { localInteger, "", "", localByteStringMicro, localInteger }, ForwardGroupRspBody.class);
  }
}
