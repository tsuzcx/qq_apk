  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 32, 40, 48, 58 }, new String[] { "info", "uint32_tribe_status", "uint64_tribe_id", "uint32_modify_countdown", "str_tribe_name" }, new Object[] { null, localInteger, Long.valueOf(0L), localInteger, "" }, RspBody.class);
  }
}
