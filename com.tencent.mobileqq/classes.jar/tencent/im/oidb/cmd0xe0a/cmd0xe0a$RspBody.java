  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "cache_ts", "disabled", "app", "group_disabled", "redpoint_cache_ts" }, new Object[] { localInteger, localInteger, null, localInteger, localInteger }, RspBody.class);
  }
}
