...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "client", "group_id", "group_type" }, new Object[] { null, Long.valueOf(0L), Integer.valueOf(0) }, ReqBody.class);
