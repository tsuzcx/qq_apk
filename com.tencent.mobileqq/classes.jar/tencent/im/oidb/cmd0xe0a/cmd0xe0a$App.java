  ...
  extends MessageMicro<App>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48 }, new String[] { "appid", "name", "icon", "url", "disabled", "default_disabled" }, new Object[] { Long.valueOf(0L), "", "", "", localInteger, localInteger }, App.class);
  }
}
