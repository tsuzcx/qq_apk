  ...
  extends MessageMicro<ChainInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 56, 64 }, new String[] { "id", "type", "uin", "desc", "pic", "created", "expired", "is_joined" }, new Object[] { localLong, localInteger, localLong, "", "", localInteger, localInteger, localInteger }, ChainInfo.class);
  }
}
