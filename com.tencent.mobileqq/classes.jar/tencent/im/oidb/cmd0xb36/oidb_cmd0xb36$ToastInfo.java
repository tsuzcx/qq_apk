  ...
  extends MessageMicro<ToastInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 50, 58 }, new String[] { "type", "wording", "id", "uins", "expired", "link", "icon" }, new Object[] { localInteger, "", localLong, localLong, localInteger, "", "" }, ToastInfo.class);
  }
}
