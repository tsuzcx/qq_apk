  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "opt_uint64_handled_uin", "opt_uint64_office_appid" }, new Object[] { localLong, localLong }, ReqBody.class);
  }
}
