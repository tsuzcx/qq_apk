  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "msg_lbs_info", "uint32_last_config_seq", "uint32_last_config_time", "uint32_push_redpoint_id" }, new Object[] { null, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
