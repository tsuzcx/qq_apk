  ...
  extends MessageMicro<FollowInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "follow_word", "uint32_follow_count", "uint32_follow_flag", "uint64_follow_info_time" }, new Object[] { null, localInteger, localInteger, Long.valueOf(0L) }, FollowInfo.class);
  }
}
