  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "group_id", "client_info", "last_game_dynamic_ts", "mini_app_disable", "mode" }, new Object[] { Long.valueOf(0L), null, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
