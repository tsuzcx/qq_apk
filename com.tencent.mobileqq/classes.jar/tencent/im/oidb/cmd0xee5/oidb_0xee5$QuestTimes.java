...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "str_quest_id", "uint64_quest_time", "uint64_uin", "uint64_show_times" }, new Object[] { "", Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L) }, QuestTimes.class);
