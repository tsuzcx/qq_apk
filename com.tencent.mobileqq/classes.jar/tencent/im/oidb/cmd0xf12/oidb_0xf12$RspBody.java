...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34 }, new String[] { "uint32_guidecardid", "uint32_guidecardtype", "str_main_msg", "str_secondary_msg" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), "", "" }, RspBody.class);
