  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 34, 40, 48, 56, 66, 74, 80, 90, 98, 106 }, new String[] { "rowkey", "article_id", "title", "cover_image_url", "read_count", "publish_time", "puin", "account_avatar_url", "account_name", "over_length", "json_article_content", "json_extend_info", "tags" }, new Object[] { "", localLong, "", "", localLong, localLong, localLong, "", "", Boolean.valueOf(false), "", "", "" }, RspBody.class);
  }
}
