  ...
  extends MessageMicro<PraiseInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 88, 96, 104 }, new String[] { "uint64_ddwuin", "uint32_praise_today_count", "uint32_rank_number", "uint32_praise_total_count" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, PraiseInfo.class);
  }
}
