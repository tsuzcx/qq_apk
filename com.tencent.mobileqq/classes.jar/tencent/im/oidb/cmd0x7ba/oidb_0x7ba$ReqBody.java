  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 88, 96 }, new String[] { "uint64_uin", "uint32_start_index", "uint32_want_num" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, ReqBody.class);
  }
}
