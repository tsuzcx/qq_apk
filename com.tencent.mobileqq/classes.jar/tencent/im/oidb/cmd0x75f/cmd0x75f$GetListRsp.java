  ...
  extends MessageMicro<GetListRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34 }, new String[] { "msg_owner", "uint64_start_time", "uint64_end_time", "rpt_messages" }, new Object[] { null, localLong, localLong, null }, GetListRsp.class);
  }
}
