  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "bytes_poid", "uint64_flower_num", "uint64_flower_point" }, new Object[] { localByteStringMicro, localLong, localLong }, ReqBody.class);
  }
}
