...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "int32_result", "uint32_msg_seq", "uint32_rand_num" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) }, SendWriteTogetherMsgRsp.class);
