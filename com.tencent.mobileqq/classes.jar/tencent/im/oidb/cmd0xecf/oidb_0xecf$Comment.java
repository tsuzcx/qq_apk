...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 58, 66, 74 }, new String[] { "str_id", "str_comment", "uint64_time", "uint64_from_uin", "uint64_to_uin", "str_from_nick", "str_to_nick", "str_reply_id" }, new Object[] { "", "", Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), "", "", "" }, Comment.class);
