  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint32_appid", "stzreqgroupinfo", "uint32_pc_client_version" }, new Object[] { localInteger, null, localInteger }, ReqBody.class);
  }
}
