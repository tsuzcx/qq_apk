  ...
  extends MessageMicro<ReportExData>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34 }, new String[] { "request_timestamp", "mf_seq", "alid", "sort_func" }, new Object[] { localLong, "", localLong, "" }, ReportExData.class);
  }
}
