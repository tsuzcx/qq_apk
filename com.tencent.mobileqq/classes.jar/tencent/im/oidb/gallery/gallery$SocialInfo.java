  ...
  extends MessageMicro<SocialInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uint32_is_like", "uint32_like_count", "uint32_comments_count", "uint32_biu_count", "attach_comments" }, new Object[] { localInteger, localInteger, localInteger, localInteger, null }, SocialInfo.class);
  }
}
