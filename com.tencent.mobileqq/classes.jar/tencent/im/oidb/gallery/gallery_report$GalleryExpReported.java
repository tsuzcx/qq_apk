  ...
  extends MessageMicro<GalleryExpReported>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 37, 42, 48, 56, 66, 402 }, new String[] { "phone_type", "client_ver", "source", "mem_size", "city", "exptime", "pos", "rowkey", "proxy_bytes" }, new Object[] { localInteger, localByteStringMicro1, localInteger, Float.valueOf(0.0F), localByteStringMicro2, Long.valueOf(0L), localInteger, localByteStringMicro3, localByteStringMicro4 }, GalleryExpReported.class);
  }
}
