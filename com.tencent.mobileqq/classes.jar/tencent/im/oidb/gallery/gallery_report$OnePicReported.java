  ...
  extends MessageMicro<OnePicReported>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "index", "come_in_time", "load_completed_time", "go_away_time", "pic_type" }, new Object[] { localInteger, localLong, localLong, localLong, localInteger }, OnePicReported.class);
  }
}
