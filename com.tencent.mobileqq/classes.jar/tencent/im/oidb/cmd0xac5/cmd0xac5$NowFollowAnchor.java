  ...
  extends MessageMicro<NowFollowAnchor>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40, 50, 58, 64, 72 }, new String[] { "uint64_uin", "uint64_now_uid", "bytes_nick_name", "bytes_head_url", "uint32_live_status", "bytes_live_url", "bytes_live_cover_url", "uint32_account_type", "uint64_nowid" }, new Object[] { localLong, localLong, localByteStringMicro1, localByteStringMicro2, localInteger, localByteStringMicro3, localByteStringMicro4, localInteger, localLong }, NowFollowAnchor.class);
  }
}
