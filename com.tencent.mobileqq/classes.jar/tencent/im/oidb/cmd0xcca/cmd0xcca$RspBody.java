  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_group_members_num", "uint32_group_friends_num", "friends_uins", "uint32_status" }, new Object[] { localInteger, localInteger, Long.valueOf(0L), localInteger }, RspBody.class);
  }
}
