  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_grp_code", "uint64_msg_seq", "uint64_uin" }, new Object[] { localLong, localLong, localLong }, ReqBody.class);
  }
}
