  ...
  extends MessageMicro<GetPkgUrlReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 50 }, new String[] { "appid", "app_type", "app_version", "platform", "sys_version", "qq_version" }, new Object[] { localInteger, localInteger, localInteger, localInteger, "", "" }, GetPkgUrlReq.class);
  }
}
