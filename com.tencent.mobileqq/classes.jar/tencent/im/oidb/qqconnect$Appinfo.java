  ...
  extends MessageMicro<Appinfo>
{
  ...
  public final PBUInt64Field company_id = PBField.initUInt64(0L);
  ...
  public qqconnect.QunProRobotAppInfo qun_pro_robot_app_info = new qqconnect.QunProRobotAppInfo();
  public final PBStringField remark = PBField.initString("");
  public qqconnect.RobotAppInfo robot_app_info = new qqconnect.RobotAppInfo();
  ...
  public qqconnect.WindowsAppInfo windows_app_info = new qqconnect.WindowsAppInfo();
  
  static
  {
    Integer localInteger = Integer.valueOf(0);
    Long localLong = Long.valueOf(0L);
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 58, 66, 74, 82, 90, 98, 106, 168, 176, 184, 194, 202, 208, 218, 226, 232, 240, 248, 258, 264, 802, 810, 818, 826, 834, 842, 850 }, new String[] { "appid", "app_type", "platform", "app_name", "app_key", "app_state", "iphone_url_scheme", "android_pack_name", "icon_url", "source_url", "icon_small_url", "icon_middle_url", "tencent_docs_appinfo", "developer_uin", "app_class", "app_subclass", "remark", "icon_mini_url", "auth_time", "app_url", "universal_link", "qqconnect_feature", "is_hatchery", "test_uin_list", "edit_universal_link", "company_id", "template_msg_config", "mini_app_info", "web_app_info", "mobile_app_info", "windows_app_info", "robot_app_info", "qun_pro_robot_app_info" }, new Object[] { localInteger, localInteger, localInteger, "", "", localInteger, "", "", "", "", "", "", null, localLong, localInteger, localInteger, "", "", localLong, "", "", localInteger, localInteger, localLong, "", localLong, null, null, null, null, null, null, null }, Appinfo.class);
  }
}
