  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 80, 88, 96 }, new String[] { "uint32_want_count", "uint32_req_article_info", "uint32_req_subscribe_info", "uint32_last_req_time", "uint32_comefrom", "uint32_version", "uint32_network_type", "uint32_pic_size" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
