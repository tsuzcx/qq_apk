  ...
  extends MessageMicro<GestureEvent>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 29, 32, 45, 50, 58, 66 }, new String[] { "ges_scroll_direction", "delta_ts_from_last_scroll_mills", "ges_scroll_distance", "ges_scroll_mills", "ges_scroll_speed", "ges_scroll_downNup", "ges_click_point", "get_scroll_feeds_info" }, new Object[] { Integer.valueOf(0), localLong, localFloat, localLong, localFloat, "", "", null }, GestureEvent.class);
  }
}
