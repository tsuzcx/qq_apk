  ...
  extends MessageMicro<Item>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 48 }, new String[] { "id", "name", "icon", "value", "type", "puin" }, new Object[] { localLong, "", "", localInteger, localInteger, localLong }, Item.class);
  }
}
