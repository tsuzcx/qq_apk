  ...
  extends MessageMicro<UinPhotoListInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 34, 40, 80, 90 }, new String[] { "uint64_uin", "uint32_timestamp", "rpt_msg_photo_info", "cover_flag", "rpt_selected_id_list", "str_default_photo" }, new Object[] { Long.valueOf(0L), localInteger, null, localInteger, localInteger, "" }, UinPhotoListInfo.class);
  }
}
