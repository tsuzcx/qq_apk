  ...
  extends MessageMicro<FollowStatusInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 82, 88, 96, 106, 112 }, new String[] { "uint64_uin", "enum_status", "enum_account_type", "enum_fans_status", "msg_topic_info", "enum_forbid_idol_status", "enum_forbid_fans_status", "user_info", "uint32_is_being_followed" }, new Object[] { Long.valueOf(0L), localInteger1, Integer.valueOf(1), localInteger1, null, localInteger2, localInteger2, null, localInteger1 }, FollowStatusInfo.class);
  }
}
