...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "business_type", "ret_code", "result_json" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), "" }, RspBody.class);
