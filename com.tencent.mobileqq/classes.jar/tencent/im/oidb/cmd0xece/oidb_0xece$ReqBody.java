...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32 }, new String[] { "group_id", "client_info", "from", "miniapp_protect" }, new Object[] { Long.valueOf(0L), null, Integer.valueOf(0), Integer.valueOf(0) }, ReqBody.class);
