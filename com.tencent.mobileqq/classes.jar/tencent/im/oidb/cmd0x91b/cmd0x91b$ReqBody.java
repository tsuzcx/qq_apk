  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42 }, new String[] { "uint64_group_code", "info", "uint32_source", "uint32_notify_aio_flag", "str_user_data" }, new Object[] { Long.valueOf(0L), null, localInteger, localInteger, "" }, ReqBody.class);
  }
}
