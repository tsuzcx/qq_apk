  ...
  extends MessageMicro<Guidelines_common_web>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 40, 48, 56, 64 }, new String[] { "str_web_url", "uint32_groups_recomm_flag", "uint32_set_gender", "uint32_set_birthday", "uint32_set_head", "uint32_set_school", "uint32_set_region", "uint32_set_company" }, new Object[] { "", localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, Guidelines_common_web.class);
  }
}
