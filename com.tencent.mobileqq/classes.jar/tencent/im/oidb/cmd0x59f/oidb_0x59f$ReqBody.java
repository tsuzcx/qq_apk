...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint32_contact_right", "uint32_from_pad" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0) }, ReqBody.class);
