  ...
  extends MessageMicro<operate_result>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint32_id", "int32_result", "str_errmsg" }, new Object[] { localInteger, localInteger, "" }, operate_result.class);
  }
}
