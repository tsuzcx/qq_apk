  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48 }, new String[] { "msg_client", "msg_req_article", "uint32_article", "uint32_read_count", "uint32_comment", "uint32_comment_key_type" }, new Object[] { null, null, localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
