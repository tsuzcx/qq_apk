...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 13, 16, 26, 32, 40 }, new String[] { "fixed32_modify_time", "uint32_use_webview", "msg_rsp_body", "uint64_low_version", "uint64_under" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), null, Long.valueOf(0L), Long.valueOf(0L) }, ArtcleCache.class);
