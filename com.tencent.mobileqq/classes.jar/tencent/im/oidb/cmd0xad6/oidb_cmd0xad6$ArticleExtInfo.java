  ...
  extends MessageMicro<ArticleExtInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint64_read_count", "uint64_comment", "bytes_comment_url" }, new Object[] { localLong, localLong, localByteStringMicro }, ArticleExtInfo.class);
  }
}
