  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "int32_result", "uint32_sequence", "str_errormessage", "rpt_uint64_uin" }, new Object[] { localInteger, localInteger, "", Long.valueOf(0L) }, RspBody.class);
  }
}
