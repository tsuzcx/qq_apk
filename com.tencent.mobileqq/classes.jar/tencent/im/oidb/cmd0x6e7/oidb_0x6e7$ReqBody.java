  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 42 }, new String[] { "uint64_group_code", "str_app_src", "str_version", "uint64_number", "combine_key" }, new Object[] { localLong, "", "", localLong, null }, ReqBody.class);
  }
}
