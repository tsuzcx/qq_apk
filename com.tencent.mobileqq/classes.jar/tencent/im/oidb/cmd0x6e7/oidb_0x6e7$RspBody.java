  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_is_white", "uint32_interval", "int64_data" }, new Object[] { localInteger, localInteger, Long.valueOf(0L) }, RspBody.class);
  }
}
