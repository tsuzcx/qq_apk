  ...
  extends MessageMicro<ResendReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42 }, new String[] { "uint64_group_code", "uint32_app_id", "uint32_bus_id", "str_file_id", "bytes_sha" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, "", localByteStringMicro }, ResendReqBody.class);
  }
}
