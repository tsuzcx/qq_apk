  ...
  extends MessageMicro<MoveFileReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50 }, new String[] { "uint64_group_code", "uint32_app_id", "uint32_bus_id", "str_file_id", "str_parent_folder_id", "str_dest_folder_id" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, "", "", "" }, MoveFileReqBody.class);
  }
}
