  ...
  extends MessageMicro<DownloadFileReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 56, 64 }, new String[] { "uint64_group_code", "uint32_app_id", "uint32_bus_id", "str_file_id", "bool_thumbnail_req", "uint32_url_type", "bool_preview_req", "uint32_src" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, "", localBoolean, localInteger, localBoolean, localInteger }, DownloadFileReqBody.class);
  }
}
