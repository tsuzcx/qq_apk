  ...
  extends MessageMicro<ProfileListResult>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_result", "uint32_update_profile_id", "uint32_new_content_timestamp" }, new Object[] { localInteger, localInteger, localInteger }, ProfileListResult.class);
  }
}
