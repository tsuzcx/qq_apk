...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32, 42, 50, 114 }, new String[] { "comment_id", "link_comment_over_times", "link_comment_num", "dirty_word_show_toast", "actual_create_content", "share_url", "rpt_data" }, new Object[] { "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", "", null }, FirstCommentCreateRsp.class);
