  ...
  extends MessageMicro<VideoRspInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 90, 98, 106, 114, 122, 128, 136, 144 }, new String[] { "uint32_business_id", "bytes_business_name", "bytes_business_url", "bytes_business_name_prefix", "bytes_title", "bytes_desc", "bytes_uuid", "bytes_video_url", "bytes_pic_url", "uint32_pic_height", "uint32_pic_width", "uint64_duration" }, new Object[] { localInteger, localByteStringMicro1, localByteStringMicro2, localByteStringMicro3, localByteStringMicro4, localByteStringMicro5, localByteStringMicro6, localByteStringMicro7, localByteStringMicro8, localInteger, localInteger, Long.valueOf(0L) }, VideoRspInfo.class);
  }
}
