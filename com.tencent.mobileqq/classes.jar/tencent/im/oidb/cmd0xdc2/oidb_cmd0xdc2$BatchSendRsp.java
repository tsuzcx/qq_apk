  ...
  extends MessageMicro<BatchSendRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 50 }, new String[] { "send_type", "recv_uin", "recv_openid", "err_code", "err_msg", "rsp_body" }, new Object[] { localInteger, Long.valueOf(0L), "", localInteger, "", null }, BatchSendRsp.class);
  }
}
