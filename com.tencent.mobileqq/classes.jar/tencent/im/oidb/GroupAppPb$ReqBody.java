...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 34, 42 }, new String[] { "client", "group_id", "group_type", "full_list_hash", "group_gray_list_hash" }, new Object[] { null, Long.valueOf(0L), Integer.valueOf(0), "", "" }, ReqBody.class);
