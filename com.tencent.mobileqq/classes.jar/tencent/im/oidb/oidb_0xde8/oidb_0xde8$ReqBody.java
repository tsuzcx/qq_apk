  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 32, 40, 48, 56, 64, 80 }, new String[] { "uint64_to_uin", "uint32_check_fri_type", "uint32_start_time", "uint32_end_time", "uint32_type", "uint32_start", "uint32_num", "uint32_comment_size" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
