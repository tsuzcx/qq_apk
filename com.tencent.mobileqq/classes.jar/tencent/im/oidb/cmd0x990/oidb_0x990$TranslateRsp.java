  ...
  extends MessageMicro<TranslateRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32 }, new String[] { "int32_ret_code", "int32_type", "bytes_trans_result", "int32_text_len" }, new Object[] { localInteger, localInteger, localByteStringMicro, localInteger }, TranslateRsp.class);
  }
}
