  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 88, 96, 104, 112, 120, 128, 136, 144 }, new String[] { "uint64_req_uin", "uint32_only_obtained", "uint32_read_report", "uint32_sort_type", "uint32_only_new", "rpt_filter_medal_ids", "uint32_only_summary", "uint32_do_scan", "uint32_start_timestamp" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, ReqBody.class);
  }
}
