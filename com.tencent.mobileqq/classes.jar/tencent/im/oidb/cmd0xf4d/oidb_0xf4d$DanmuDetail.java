...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18 }, new String[] { "danmu_base_info", "post_account_info" }, new Object[] { null, null }, DanmuDetail.class);
