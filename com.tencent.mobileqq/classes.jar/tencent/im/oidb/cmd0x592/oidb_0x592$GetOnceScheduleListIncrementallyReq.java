  ...
  extends MessageMicro<GetOnceScheduleListIncrementallyReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_get_way", "uint64_lastest_modtime", "uint32_amount", "uint32_main_type" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, localInteger }, GetOnceScheduleListIncrementallyReq.class);
  }
}
