  ...
  extends MessageMicro<GetRepeatedScheduleListReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_lastest_modtime", "uint32_amount", "uint32_main_type", "uint32_get_way" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, GetRepeatedScheduleListReq.class);
  }
}
