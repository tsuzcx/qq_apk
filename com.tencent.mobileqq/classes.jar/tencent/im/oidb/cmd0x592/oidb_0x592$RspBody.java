...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 34, 42, 50, 58, 66, 74, 82, 90, 98, 106 }, new String[] { "msg_appid", "msg_add_schedule_rsp", "msg_get_once_schedule_list_rsp", "msg_get_schedule_by_id_rsp", "msg_get_repeated_schedule_list_rsp", "msg_update_schedule_content_rsp", "msg_delete_my_schedule_rsp", "msg_recall_schedule_rsp", "msg_share_schedule_rsp", "msg_change_my_recv_status_rsp", "msg_set_all_readed_time_rsp", "msg_modify_unread_cnt_rsp", "msg_set_remind_bell_switch_rsp" }, new Object[] { null, null, null, null, null, null, null, null, null, null, null, null, null }, RspBody.class);
