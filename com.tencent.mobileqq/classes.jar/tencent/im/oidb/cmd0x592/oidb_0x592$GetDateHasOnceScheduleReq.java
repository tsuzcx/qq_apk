  ...
  extends MessageMicro<GetDateHasOnceScheduleReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_req_start_time", "uint64_req_end_time", "uint32_main_type" }, new Object[] { localLong, localLong, Integer.valueOf(0) }, GetDateHasOnceScheduleReq.class);
  }
}
