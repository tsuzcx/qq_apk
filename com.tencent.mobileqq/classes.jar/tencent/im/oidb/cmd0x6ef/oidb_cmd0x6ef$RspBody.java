  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "gc", "seq", "remind_brief", "is_create", "is_join" }, new Object[] { localLong, localLong, localByteStringMicro, localInteger, localInteger }, RspBody.class);
  }
}
