  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uint64_group_code", "uint64_old_owner", "uint64_new_owner", "uint32_result", "str_errorinfo" }, new Object[] { localLong, localLong, localInteger, localInteger, localByteStringMicro }, RspBody.class);
  }
}
