  ...
  extends MessageMicro<ModifyConfInfoReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48 }, new String[] { "uint64_conf_uin", "uint32_last_passwd_red_bag_time", "uint32_conf_meeting_origin", "msg_self_member_info", "uint32_qidian_conf_type", "uint32_conf_meeting_option" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null, localInteger, localInteger }, ModifyConfInfoReq.class);
  }
}
