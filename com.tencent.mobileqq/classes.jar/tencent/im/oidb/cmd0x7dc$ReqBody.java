  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32 }, new String[] { "uint32_seq", "msg_appointment", "msg_lbs_info", "uint32_overwrite" }, new Object[] { localInteger, null, null, localInteger }, ReqBody.class);
  }
}
