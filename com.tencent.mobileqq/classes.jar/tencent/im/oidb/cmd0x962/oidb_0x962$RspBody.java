  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uint64_already_pay_microseconds", "uint64_play_total_microseconds", "uint64_state_microseconds", "uint32_play_state", "msg_finish_info" }, new Object[] { localLong, localLong, localLong, Integer.valueOf(0), null }, RspBody.class);
  }
}
