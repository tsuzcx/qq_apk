  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 58 }, new String[] { "uint64_group_code", "info", "uint32_source", "uint32_notify_aio_flag", "uint32_tribe_type", "uint64_tribe_id", "str_tribe_name" }, new Object[] { localLong, null, localInteger, localInteger, localInteger, localLong, "" }, ReqBody.class);
  }
}
