  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42, 50, 56, 66, 74 }, new String[] { "uint32_timestamp", "rpt_result", "uint32_res", "bool_order", "available_app", "often_app", "disable_often", "often_app_wording", "all_app_wording" }, new Object[] { localInteger, null, localInteger, localBoolean, null, null, localBoolean, "", "" }, RspBody.class);
  }
}
