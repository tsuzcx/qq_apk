  ...
  extends MessageMicro<ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40 }, new String[] { "uint32_type", "rpt_app_ids", "msg_app_info", "uint64_group_code", "uint32_group_type" }, new Object[] { localInteger, localInteger, null, Long.valueOf(0L), localInteger }, ReqBody.class);
  }
}
