...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 90, 98, 106 }, new String[] { "type", "showPlace", "priority", "pm1", "pm2", "pm3" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null, null, null }, STPushMsgElem.class);
  ...
  public final PBRepeatMessageField pm3 = PBField.initRepeatMessage(apollo_push_msgInfo.STPushMsgElem.STPushMsgElem0x3.class);
