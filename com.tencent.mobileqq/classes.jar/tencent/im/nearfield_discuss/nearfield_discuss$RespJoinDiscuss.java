  ...
  extends MessageMicro<RespJoinDiscuss>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 40, 48 }, new String[] { "msg_head", "str_number", "uint32_session_id", "uint32_discuss_id", "bool_is_creater", "uint32_join_type" }, new Object[] { null, "", localInteger, localInteger, Boolean.valueOf(false), localInteger }, RespJoinDiscuss.class);
  }
}
