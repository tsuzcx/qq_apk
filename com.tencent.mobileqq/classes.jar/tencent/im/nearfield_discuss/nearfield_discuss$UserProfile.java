  ...
  extends MessageMicro<UserProfile>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uint64_uin", "int32_face_id", "int32_sex", "int32_age", "str_nick" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, "" }, UserProfile.class);
  }
}
