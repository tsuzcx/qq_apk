  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint32_error_code", "string_error_msg", "uint32_interval" }, new Object[] { localInteger, "", localInteger }, RspBody.class);
  }
}
