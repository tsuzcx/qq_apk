  ...
  extends MessageMicro<LowVersionTips>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42 }, new String[] { "uint32_business_id", "uint32_session_type", "uint64_session_uin", "uint64_sender_uin", "str_text" }, new Object[] { localInteger, localInteger, localLong, localLong, "" }, LowVersionTips.class);
  }
}
