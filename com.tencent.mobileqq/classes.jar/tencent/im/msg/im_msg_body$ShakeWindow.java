  ...
  extends MessageMicro<ShakeWindow>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint32_type", "uint32_reserve", "uint64_uin" }, new Object[] { localInteger, localInteger, Long.valueOf(0L) }, ShakeWindow.class);
  }
}
