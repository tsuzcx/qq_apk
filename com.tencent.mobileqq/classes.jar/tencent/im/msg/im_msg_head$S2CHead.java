  ...
  extends MessageMicro<S2CHead>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 45, 48, 56 }, new String[] { "uint32_sub_msgtype", "uint32_msg_type", "uint64_from_uin", "uint32_msg_id", "uint32_relay_ip", "uint32_relay_port", "uint64_to_uin" }, new Object[] { localInteger, localInteger, localLong, localInteger, localInteger, localInteger, localLong }, S2CHead.class);
  }
}
