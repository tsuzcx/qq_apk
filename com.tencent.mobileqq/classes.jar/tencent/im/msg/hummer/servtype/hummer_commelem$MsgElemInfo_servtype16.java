  ...
  extends MessageMicro<MsgElemInfo_servtype16>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 42, 50, 56, 64, 74, 82, 90, 96 }, new String[] { "uid", "unionID", "storyID", "md5", "thumbUrl", "doodleUrl", "videoWidth", "videoHeight", "sourceName", "sourceActionType", "sourceActionData", "ctr_version" }, new Object[] { Long.valueOf(0L), localByteStringMicro1, localByteStringMicro2, localByteStringMicro3, localByteStringMicro4, localByteStringMicro5, localInteger, localInteger, localByteStringMicro6, localByteStringMicro7, localByteStringMicro8, localInteger }, MsgElemInfo_servtype16.class);
  }
}
