  ...
  extends MessageMicro
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 56, 64 }, new String[] { "uint64_confessor_uin", "uint64_confess_to_uin", "uint64_send_uin", "bytes_confessor_nick", "bytes_confess", "uint32_bg_type", "uint32_topic_id", "uint64_confess_time" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), localByteStringMicro1, localByteStringMicro2, Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0L) }, C2CConfessContext.class);
  }
}
