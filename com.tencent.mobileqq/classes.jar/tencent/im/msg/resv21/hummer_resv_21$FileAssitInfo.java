  ...
  extends MessageMicro<FileAssitInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_session_id", "uint32_group_id", "uint32_group_idx", "uint32_group_count" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger }, FileAssitInfo.class);
  }
}
