  ...
  extends MessageMicro<QueryRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 48, 56, 64, 72 }, new String[] { "ret", "msg", "uin", "pv_flag", "pv_timestamp", "uv_flag", "uv_day_freq", "uv_week_freq", "uv_mon_freq" }, new Object[] { localInteger, "", "", localInteger, Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger }, QueryRsp.class);
  }
}
