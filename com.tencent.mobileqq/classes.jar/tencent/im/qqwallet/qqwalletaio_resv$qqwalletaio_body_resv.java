  ...
  extends MessageMicro<qqwalletaio_body_resv>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18 }, new String[] { "uint32_pfa_type", "bytes_feeds_id" }, new Object[] { Integer.valueOf(0), localByteStringMicro }, qqwalletaio_body_resv.class);
  }
}
