  ...
  extends MessageMicro<ReqBodyGetBlockList>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 21, 24, 32, 40 }, new String[] { "uint64_uin", "fixed32_last_get_time", "uint32_start_pos", "uint32_want_num", "uint32_get_type" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger }, ReqBodyGetBlockList.class);
  }
}
