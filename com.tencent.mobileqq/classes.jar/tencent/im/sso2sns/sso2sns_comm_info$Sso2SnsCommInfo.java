  ...
  extends MessageMicro<Sso2SnsCommInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "uint32_seq", "uint32_result", "str_error_msg" }, new Object[] { localInteger, localInteger, "" }, Sso2SnsCommInfo.class);
  }
}
