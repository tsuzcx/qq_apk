  ...
  extends MessageMicro<NeighbourNumber>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_group_code", "uint64_neighbour_number", "uint64_located_number" }, new Object[] { localLong, localLong, localLong }, NeighbourNumber.class);
  }
}
