  ...
  extends MessageMicro<NearbyEntranceContent>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40, 50, 58, 66, 74, 82, 90, 98, 106, 114 }, new String[] { "int64_id", "int32_id_type", "str_url", "int32_pic_type", "int32_sub_pic_type", "str_title", "str_content", "str_content2", "pic_url", "bg_color", "txt_color", "logo_url", "corner_wording", "str_distance" }, new Object[] { Long.valueOf(0L), localInteger, "", localInteger, localInteger, "", "", "", "", "", "", "", "", "" }, NearbyEntranceContent.class);
  }
}
