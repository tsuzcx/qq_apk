  ...
  extends MessageMicro<SpecialWordCardGetInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "uint64_uin", "uint32_can_get_card_count", "uint64_last_give_card_time" }, new Object[] { localLong, Integer.valueOf(0), localLong }, SpecialWordCardGetInfo.class);
  }
}
