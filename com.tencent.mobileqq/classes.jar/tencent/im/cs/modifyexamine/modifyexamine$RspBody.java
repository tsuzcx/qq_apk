  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint32_result", "uint32_limit_times", "uint32_modify_times", "str_errmsg" }, new Object[] { localInteger, localInteger, localInteger, "" }, RspBody.class);
  }
}
