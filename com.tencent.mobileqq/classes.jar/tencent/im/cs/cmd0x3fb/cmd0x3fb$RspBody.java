  ...
  extends MessageMicro<RspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 48, 56, 66, 74, 80 }, new String[] { "int32_ret", "int32_gray_flag", "str_url", "int32_color", "rpt_msg_buffer_ex_data", "int32_enter_glive_strategy", "uint64_to_guin", "str_update_title", "str_update_content", "int32_pre_download_toggle" }, new Object[] { localInteger, localInteger, "", localInteger, null, localInteger, Long.valueOf(0L), "", "", localInteger }, RspBody.class);
  }
}
