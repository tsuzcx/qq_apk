  ...
  extends MessageMicro<BufferExData>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34 }, new String[] { "uint32_index", "uint32_value", "string_value", "bytes_value" }, new Object[] { localInteger, localInteger, "", localByteStringMicro }, BufferExData.class);
  }
}
