  ...
  extends MessageMicro<ApplyUploadRspV3>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 162, 240, 320, 400, 482, 562, 640, 722, 802, 880, 960, 1042, 1120, 1202, 1282, 1362 }, new String[] { "int32_ret_code", "str_ret_msg", "uint64_total_space", "uint64_used_space", "uint64_uploaded_size", "str_upload_ip", "str_upload_domain", "uint32_upload_port", "bytes_uuid", "bytes_upload_key", "bool_file_exist", "uint32_pack_size", "rpt_str_uploadip_list", "uint32_upload_https_port", "str_upload_https_domain", "str_upload_dns", "str_upload_lanip" }, new Object[] { Integer.valueOf(0), "", Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L), "", "", Integer.valueOf(0), localByteStringMicro1, localByteStringMicro2, Boolean.valueOf(false), Integer.valueOf(0), "", Integer.valueOf(443), "", "", "" }, ApplyUploadRspV3.class);
  }
}
