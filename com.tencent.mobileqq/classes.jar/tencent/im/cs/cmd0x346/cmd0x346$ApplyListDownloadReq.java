  ...
  extends MessageMicro<ApplyListDownloadReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 160, 240 }, new String[] { "uint64_uin", "uint32_begin_index", "uint32_req_count" }, new Object[] { Long.valueOf(0L), localInteger, localInteger }, ApplyListDownloadReq.class);
  }
}
