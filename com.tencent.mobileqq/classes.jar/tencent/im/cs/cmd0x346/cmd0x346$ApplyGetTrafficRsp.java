  ...
  extends MessageMicro<ApplyGetTrafficRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 80, 162, 240, 320, 400, 480 }, new String[] { "int32_ret_code", "str_ret_msg", "uint64_use_file_size", "uint32_use_file_num", "uint64_all_file_size", "uint32_all_file_num" }, new Object[] { localInteger, "", localLong, localInteger, localLong, localInteger }, ApplyGetTrafficRsp.class);
  }
}
