  ...
  extends MessageMicro<ExtensionRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint32_transfer_type", "uint32_channel_type", "uint32_allow_retry", "server_addr_ipv6_list" }, new Object[] { localInteger, localInteger, localInteger, null }, ExtensionRsp.class);
  }
}
