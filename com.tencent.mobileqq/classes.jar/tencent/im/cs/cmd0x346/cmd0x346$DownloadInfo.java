  ...
  extends MessageMicro<DownloadInfo>
{
  ...
  public final PBRepeatField<String> str_downloadipv6_list = PBField.initRepeat(PBStringField.__repeatHelper__);
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 82, 162, 242, 320, 402, 482, 562, 640, 722, 882, 962, 1042 }, new String[] { "bytes_download_key", "str_download_ip", "str_download_domain", "uint32_port", "str_download_url", "rpt_str_downloadip_list", "str_cookie", "uint32_https_port", "str_https_download_domain", "str_download_dns", "bytes_media_platform_download_key", "str_downloadipv6_list" }, new Object[] { localByteStringMicro1, "", "", Integer.valueOf(0), "", "", "", Integer.valueOf(443), "", "", localByteStringMicro2, "" }, DownloadInfo.class);
  }
}
