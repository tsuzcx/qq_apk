  ...
  extends MessageMicro<SendListQueryRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 56, 64, 74 }, new String[] { "int32_ret_code", "str_ret_msg", "uint32_file_tot_count", "uint32_begin_index", "uint32_rsp_file_count", "uint32_is_end", "uint64_tot_limit", "uint64_used_limit", "rpt_msg_file_list" }, new Object[] { localInteger, "", localInteger, localInteger, localInteger, localInteger, localLong, localLong, null }, SendListQueryRsp.class);
  }
}
