  ...
  extends MessageMicro<SubCmd0xaRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42 }, new String[] { "uint64_uin", "uint64_disscus_uin", "str_file_id", "str_session_info", "str_ret_msg" }, new Object[] { localLong, localLong, "", "", "" }, SubCmd0xaRspBody.class);
  }
}
