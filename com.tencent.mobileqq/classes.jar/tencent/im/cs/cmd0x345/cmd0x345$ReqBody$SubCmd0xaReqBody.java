  ...
  extends MessageMicro<SubCmd0xaReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34 }, new String[] { "uint64_uin", "uint64_disscus_uin", "str_file_id", "str_session_info" }, new Object[] { localLong, localLong, "", "" }, SubCmd0xaReqBody.class);
  }
}
