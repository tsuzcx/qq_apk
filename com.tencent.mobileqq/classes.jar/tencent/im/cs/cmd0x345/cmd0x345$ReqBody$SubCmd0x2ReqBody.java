  ...
  extends MessageMicro<SubCmd0x2ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 42, 50, 58, 66, 74, 80, 88, 96, 104, 112, 122 }, new String[] { "uint32_disscus_uin", "uint32_sender_uin", "str_file_name", "uint64_file_size", "str_file_id", "str_batch_id", "str_batch_item_id", "str_client_key", "str_file_key", "uint32_mark", "uint64_time", "uint64_sequence", "uint32_busid", "uint32_random", "bytes_pb_bytes_reserve" }, new Object[] { localInteger, localInteger, "", localLong, "", "", "", "", "", localInteger, localLong, localLong, localInteger, localInteger, localByteStringMicro }, SubCmd0x2ReqBody.class);
  }
}
