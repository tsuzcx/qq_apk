  ...
  extends MessageMicro<SubCmd0x1ReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 40, 48, 56, 64 }, new String[] { "str_md5", "str_sha", "str_file_name", "uint64_file_size", "uint32_upload_type", "uint32_disscus_uin", "uint32_sender_uin", "uint32_costom_id" }, new Object[] { "", "", "", Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger }, SubCmd0x1ReqBody.class);
  }
}
