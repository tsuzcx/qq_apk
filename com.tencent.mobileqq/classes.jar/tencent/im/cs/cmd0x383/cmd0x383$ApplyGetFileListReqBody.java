  ...
  extends MessageMicro<ApplyGetFileListReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uint32_start_index", "uint32_file_count", "uint32_req_from", "str_parent_folder_path" }, new Object[] { localInteger, localInteger, localInteger, "" }, ApplyGetFileListReqBody.class);
  }
}
