  ...
  extends MessageMicro<ApplyLinkFileReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "uint32_src_bus_id", "str_src_file_path", "uint32_dst_bus_id" }, new Object[] { localInteger, "", localInteger }, ApplyLinkFileReqBody.class);
  }
}
