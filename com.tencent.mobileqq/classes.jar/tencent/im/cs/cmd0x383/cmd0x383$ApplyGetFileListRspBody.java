  ...
  extends MessageMicro<ApplyGetFileListRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 50, 56 }, new String[] { "uint32_file_count", "uint32_all_file_count", "bool_is_end", "rpt_msg_file_info_list", "uint32_folder_count", "rpt_msg_folder_info_list", "uint32_filter_code" }, new Object[] { localInteger, localInteger, Boolean.valueOf(false), null, localInteger, null, localInteger }, ApplyGetFileListRspBody.class);
  }
}
