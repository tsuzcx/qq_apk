  ...
  extends MessageMicro<ApplyGetSpaceRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16 }, new String[] { "uint64_total_space", "uint64_used_space" }, new Object[] { localLong, localLong }, ApplyGetSpaceRspBody.class);
  }
}
