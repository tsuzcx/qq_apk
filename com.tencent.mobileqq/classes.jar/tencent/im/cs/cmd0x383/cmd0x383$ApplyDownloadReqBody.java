  ...
  extends MessageMicro<ApplyDownloadReqBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "uint32_bus_id", "str_file_path", "bool_thumbnail_req", "uint32_url_type", "bool_preview_req" }, new Object[] { localInteger, "", localBoolean, localInteger, localBoolean }, ApplyDownloadReqBody.class);
  }
}
