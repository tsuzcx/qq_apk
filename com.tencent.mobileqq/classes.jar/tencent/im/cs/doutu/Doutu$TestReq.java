  ...
  extends MessageMicro<TestReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint64_src_uin", "uint32_src_term", "uint32_age", "uin32_gender", "randomNum" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, localInteger, localInteger }, TestReq.class);
  }
}
