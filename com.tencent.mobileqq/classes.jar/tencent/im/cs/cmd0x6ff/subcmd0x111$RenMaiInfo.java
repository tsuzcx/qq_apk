  ...
  extends MessageMicro<RenMaiInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 40, 48 }, new String[] { "uint32_sync_type", "uint32_next_start_time", "rpt_msg_group_info", "rpt_msg_frd", "rpt_uint64_del_frd", "uint32_next_interval" }, new Object[] { localInteger, localInteger, null, null, Long.valueOf(0L), localInteger }, RenMaiInfo.class);
  }
}
