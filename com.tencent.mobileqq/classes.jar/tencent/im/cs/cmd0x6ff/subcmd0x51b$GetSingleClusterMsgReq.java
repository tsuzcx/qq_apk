  ...
  extends MessageMicro<GetSingleClusterMsgReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 25 }, new String[] { "uint64_puin", "bytes_cluster_id", "rpt_fixed64_msgid_list" }, new Object[] { localLong, localByteStringMicro, localLong }, GetSingleClusterMsgReq.class);
  }
}
