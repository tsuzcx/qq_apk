  ...
  extends MessageMicro<IpAddr>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 21, 24, 32 }, new String[] { "uint32_type", "uint32_ip", "uint32_port", "uint32_area" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, IpAddr.class);
  }
}
