  ...
  extends MessageMicro<PttTransRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 34, 40 }, new String[] { "uint32_ret_code", "str_voice_id", "uint32_is_final", "str_text", "uint32_offset" }, new Object[] { localInteger, "", localInteger, "", localInteger }, PttTransRsp.class);
  }
}
