  ...
  extends MessageMicro<CorretTextReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 50, 58, 64, 72, 80, 88, 98, 104 }, new String[] { "uint64_sessionid", "uint32_ptt_type", "uint64_sender_uin", "uint64_receiver_uin", "uint32_fileid", "str_Filemd5", "str_file_path", "uint32_total_len", "uint32_seq", "uint32_pos", "uint32_len", "bytes_text", "uint32_ptt_format" }, new Object[] { localLong, localInteger, localLong, localLong, localInteger, "", "", localInteger, localInteger, localInteger, localInteger, localByteStringMicro, localInteger }, CorretTextReq.class);
  }
}
