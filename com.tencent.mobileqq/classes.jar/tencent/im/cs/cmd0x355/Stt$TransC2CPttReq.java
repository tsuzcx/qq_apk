  ...
  extends MessageMicro<TransC2CPttReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 40, 48, 56, 64, 74, 80 }, new String[] { "uint64_sessionid", "uint64_sender_uin", "uint64_receiver_uin", "str_file_path", "uint32_ptt_time", "uint32_filesize", "uint32_ptt_format", "uint32_event_type", "str_filemd5", "uint32_msg_type" }, new Object[] { localLong, localLong, localLong, "", localInteger, localInteger, localInteger, Integer.valueOf(1), "", localInteger }, TransC2CPttReq.class);
  }
}
