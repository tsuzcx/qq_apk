  ...
  extends MessageMicro<OCRRspBody>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 810, 818, 826, 888, 896 }, new String[] { "textDetections", "language", "requestId", "ocrLanguageList", "dstTranslateLanguageList", "languageList", "afterCompressWeight", "afterCompressHeight" }, new Object[] { null, "", "", "", "", null, localInteger, localInteger }, OCRRspBody.class);
  }
}
