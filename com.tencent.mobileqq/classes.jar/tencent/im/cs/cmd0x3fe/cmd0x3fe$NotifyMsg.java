  ...
  extends MessageMicro<NotifyMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40 }, new String[] { "uint32_subcmd", "uint64_from_uin", "uint64_to_uin", "uint64_guin", "uint32_count" }, new Object[] { localInteger, localLong, localLong, localLong, localInteger }, NotifyMsg.class);
  }
}
