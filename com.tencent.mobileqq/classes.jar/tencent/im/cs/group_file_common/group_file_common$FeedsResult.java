  ...
  extends MessageMicro<FeedsResult>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40 }, new String[] { "int32_ret_code", "str_detail", "str_file_id", "uint32_bus_id", "uint32_dead_time" }, new Object[] { localInteger, "", "", localInteger, localInteger }, FeedsResult.class);
  }
}
