  ...
  extends MessageMicro<SharpTraeInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88 }, new String[] { "uint32_trae_source", "uint32_trae_interface", "uint32_trae_stream_type", "uint32_trae_volume", "uint32_trae_mode", "uint32_arm_flag", "uint32_cpu_hertz", "uint32_audio_set", "uint32_param9", "uint32_param10", "uint32_param11" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, SharpTraeInfo.class);
  }
}
