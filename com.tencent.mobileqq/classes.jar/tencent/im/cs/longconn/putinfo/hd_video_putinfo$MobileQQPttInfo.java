  ...
  extends MessageMicro<MobileQQPttInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120 }, new String[] { "uint32_param1", "uint32_param2", "uint32_param3", "uint32_param4", "uint32_param5", "uint32_param6", "uint32_param7", "uint32_param8", "uint32_param9", "uint32_param10", "uint32_param11", "uint32_param12", "uint32_param13", "uint32_param14", "uint32_param15" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger }, MobileQQPttInfo.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes17.jar
 * Qualified Name:     tencent.im.cs.longconn.putinfo.hd_video_putinfo.MobileQQPttInfo
