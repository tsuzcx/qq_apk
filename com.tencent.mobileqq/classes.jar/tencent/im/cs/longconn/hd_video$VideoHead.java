  ...
  extends MessageMicro<VideoHead>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 50, 58, 66, 106, 176 }, new String[] { "uint64_room_id", "uint64_uin", "uint32_seq", "enum_body_type", "uint32_error_no", "str_from_nation", "str_from_mobile", "str_to_mobile", "str_to_nation", "int32_sub_service_type" }, new Object[] { localLong, localLong, localInteger, Integer.valueOf(22), localInteger, "", "", "", "", localInteger }, VideoHead.class);
  }
}
