  ...
  extends MessageMicro<ReqNearbyPostInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint64_longtitude", "uint64_latitude", "uint64_range", "uint64_uin" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, ReqNearbyPostInfo.class);
  }
}
