  ...
  extends MessageMicro<iplistInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42 }, new String[] { "int32_result", "string_dname", "uint32_type", "uint32_ttl", "ServerList_data" }, new Object[] { localInteger, "", localInteger, localInteger, null }, iplistInfo.class);
  }
}
