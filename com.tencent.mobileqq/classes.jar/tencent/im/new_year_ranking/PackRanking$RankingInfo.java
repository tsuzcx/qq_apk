  ...
  extends MessageMicro<RankingInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "uin", "ranking", "count", "elems" }, new Object[] { Long.valueOf(0L), localInteger, localInteger, null }, RankingInfo.class);
  }
}
