  ...
  extends BaseAdapter
{
  ...
  private wnq(ClassificationSearchFragment paramClassificationSearchFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (paramView == null)
          {
            localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2130970174, paramViewGroup, false);
            ...
            ((View)localObject1).setTag(2131363486, Integer.valueOf(paramInt));
        ...
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2130970606, null);
        ...
        try
        {
          ...
          if ((((AccountSearchPb.record)localObject1).brief.has()) && (!"".equals(((AccountSearchPb.record)localObject1).brief.get()))) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a(paramView.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a()) > 1)
            {
              ...
              localObject2 = (ImageView)paramViewGroup.findViewById(2131371254);
              ((ImageView)localObject2).setVisibility(4);
              ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131364504);
        ...
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2130969106, null);
          paramViewGroup.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
          paramView = new wnp();
          paramViewGroup.setTag(paramView);
        ...
        localObject1 = (wnp)paramViewGroup.getTag();
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Boolean)
        {
          ...
          ((wnp)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
          ((wnp)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("获取失败，请稍后再试");
          return paramViewGroup;
        }
      ...
      ((wnp)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      ((wnp)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("载入中，请稍候...");
    ...
    ((wnp)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    ((wnp)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("获取失败，请检查网络连接");
    return paramViewGroup;
  }
