...
public class rvd
  extends pvq
{
  public rvd(ReadInJoyUgcSearchTopicFragment paramReadInJoyUgcSearchTopicFragment) {}
  ...
  public void a(int paramInt, long paramLong, String paramString)
  {
    if ((0L != paramLong) && (!TextUtils.isEmpty(paramString))) {
      if ((ReadInJoyUgcSearchTopicFragment.a(this.a) != null) && (ReadInJoyUgcSearchTopicFragment.a(this.a).size() == 1))
      {
        ...
        pkh.a("0X800980A", ReadInJoyUgcSearchTopicFragment.a(this.a), paramLong, "1");
        rtg.a(String.valueOf(paramLong), "1");
      }
    }
    for (;;)
    {
      ...
      return;
      this.a.a(1, this.a.getString(2131717670));
    }
  }
}
