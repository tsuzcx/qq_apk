  ...
  implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener
{
  ...
  private bhgh jdField_a_of_type_Bhgh;
  ...
  public bhge(Handler paramHandler)
  {
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    {
      this.jdField_a_of_type_Bhgg.onError(paramInt1, paramInt2);
      d(6);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bhgg != null) {
      this.jdField_a_of_type_Bhgg.onPlayerProgress(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, paramInt);
    }
  }
  ...
  private void d(int paramInt)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bhgg != null) {
        this.jdField_a_of_type_Bhgg.onPlayerStateChange(paramInt);
      }
      return;
    }
    finally
  ...
  public void a(bhgg parambhgg)
  {
    this.jdField_a_of_type_Bhgg = parambhgg;
  }
  
  public void a(String paramString, bhgh parambhgh)
  {
  ...
  public void b(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_AndroidMediaMediaPlayer != null) && (i > 0) && (i < 3) && (paramInt >= 0)) {
      ...
      {
        if (this.jdField_a_of_type_Bhgg != null) {
          this.jdField_a_of_type_Bhgg.onPlayerSeek(false, paramInt);
        }
  ...
  public void onBufferingUpdate(MediaPlayer paramMediaPlayer, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bhgg != null) {
      this.jdField_a_of_type_Bhgg.onPlayerBufferingUpdate(paramInt);
    }
  }
  ...
  public void onPrepared(MediaPlayer paramMediaPlayer)
  {
    ...
    d(1);
    if (this.jdField_a_of_type_Bhgh != null) {
      this.jdField_a_of_type_Bhgh.onPrepared();
    }
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {}
  ...
  public void onSeekComplete(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Bhgg != null) {
      this.jdField_a_of_type_Bhgg.onPlayerSeek(true, c());
    }
  }
}
