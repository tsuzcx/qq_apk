...
public class bkzo
{
  private static bkzo jdField_a_of_type_Bkzo;
  ...
  {
    if (jdField_a_of_type_Bkzo == null) {}
    try
    {
      if (jdField_a_of_type_Bkzo == null) {
        jdField_a_of_type_Bkzo = new bkzo();
      }
      return jdField_a_of_type_Bkzo;
    }
    finally {}
  }
        ...
        if (localObject != null)
        {
          ...
          if (k > 0)
          {
            ...
            while (i < k)
            {
              ...
              {
                vzw.jdField_a_of_type_JavaLangString = localJSONObject1.getString("downloadInfo");
                if (QLog.isColorLevel()) {
                  QLog.e(jdField_a_of_type_JavaLangString, 2, "QIMBeautyManager WeishiGuideUtils.DOWNLOAD_JSON=  " + vzw.jdField_a_of_type_JavaLangString);
                }
              }
              i += 1;
            }
