...
public class alfa
  extends alej
{
  public alfa(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = String.format(anni.a(2131696697), new Object[] { anni.a(2131714393) });
  ...
  {
    if ((paramObject instanceof alfa))
    {
      paramObject = (alfa)paramObject;
      paramObject.jdField_a_of_type_Beps.a(parambepr.jdField_a_of_type_Beps);
      return paramObject;
    }
    paramObject = new alfa(BaseApplication.getContext());
