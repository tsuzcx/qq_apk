...
class pvm
  extends nis
{
  pvm(pvl parampvl, pvo parampvo) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d(pvl.a, 2, "getAtlasFavoriteStatus onResult, errorCode=" + paramInt);
    }
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        if (this.jdField_a_of_type_Pvo != null) {
          this.jdField_a_of_type_Pvo.a(false, null, false, null);
        }
        QLog.e(pvl.a, 1, "getAtlasFavoriteStatus onResult(), exception=" + paramArrayOfByte.toString());
      }
      boolean bool = false;
      continue;
      label242:
      if (this.jdField_a_of_type_Pvo != null) {
        this.jdField_a_of_type_Pvo.a(true, paramBundle, bool, localArrayList);
      }
    }
  }
}
