...
public class agoy
  extends bimg
  implements bioz, bips, bito, bits
{
  protected abgu a;
  private agov a;
  
  public agoy(Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
    super(paramContext, paramActivity, paramAppInterface);
    super.preInitPluginEngine();
    this.mWebview = new TouchWebView(paramContext);
    buildBaseWebView(this.mInterface);
    this.jdField_a_of_type_Agov = new agov(paramActivity, this.mWebview);
  }
  ...
  protected abgu a()
  {
    ...
    {
      this.jdField_a_of_type_Abgu = new abgu(this.mInterface, this.mInActivity);
      this.jdField_a_of_type_Abgu.a(this);
    }
    return this.jdField_a_of_type_Abgu;
  }
  ...
  public void bindJavaScript(ArrayList<WebViewPlugin> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      paramArrayList.add(new abha());
      paramArrayList.add(new ocq());
    }
  }
  ...
  {
    this.jdField_a_of_type_Agov.a(a());
  }
