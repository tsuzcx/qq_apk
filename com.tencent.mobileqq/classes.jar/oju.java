...
public class oju
{
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Ohb == null)) {
      return -1L;
    }
    try
    {
      JSONObject localJSONObject = new JSONObject(paramString1);
      String str1 = new String(bbco.decode(localJSONObject.getString("comment"), 0));
      ...
      ((JSONObject)localObject1).put("native_version", bbdh.a(BaseApplicationImpl.getContext()));
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), nor.class);
        ...
        ((NewIntent)localObject2).setObserver(new ojx(this, paramBoolean, l, paramInt2, paramString1, paramInt3, System.currentTimeMillis(), str1, paramString4, paramString2, paramString3, localJSONObject.optString("commentId")));
  ...
  {
    if ((paramBaseCommentData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Ohb == null)) {
      return;
    }
    label400:
    for (;;)
    {
      ...
      try
      {
        ...
        ((JSONObject)localObject).put("native_version", bbdh.a(BaseApplicationImpl.getContext()));
        ...
        ((NewIntent)localObject).setObserver(new ojw(this, paramBaseCommentData, paramInt1, paramInt2));
      ...
      catch (Exception paramString)
      {
        if (this.jdField_a_of_type_Ohb != null) {
          this.jdField_a_of_type_Ohb.a(false, paramBaseCommentData.commentId, paramInt1, paramInt2);
        }
  ...
  public void a(BaseCommentData paramBaseCommentData, String paramString, int paramInt)
  {
    ...
    catch (Exception paramString)
    {
      for (;;)
      {
        Object localObject;
        if (this.jdField_a_of_type_Ohb != null) {
          this.jdField_a_of_type_Ohb.a(false, paramBaseCommentData);
        }
        paramString.printStackTrace();
        if (!QLog.isColorLevel()) {
          break;
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      ((NewIntent)localObject).putExtra("data", paramString.toByteArray());
      ((NewIntent)localObject).setObserver(new ojv(this, paramBaseCommentData));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject);
      return;
    }
  }
  ...
  {
    if ((paramBaseCommentData == null) || (this.jdField_a_of_type_Ohb == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramBaseCommentData instanceof CommentData))
        {
          ...
          localJSONObject.put("report_uin", onh.a());
          ...
          paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), nor.class);
          ...
          paramString2.setObserver(new ojy(this, paramBaseCommentData));
