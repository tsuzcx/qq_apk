  ...
  extends WebViewFragment
{
  ...
  protected Bundle a;
  protected String a;
  private SoftReference<ojz> jdField_a_of_type_JavaLangRefSoftReference;
  protected boolean a;
  ...
  private void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("WebLog_WebViewFragment", 2, "get a url:" + nwo.b((String)localObject1, new String[0]));
    }
    ...
    try
    {
      ...
      if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("hide_operation_bar"))
      {
        ...
        this.c = bool1;
        localObject1 = (biho)this.mComponentsProvider.a(4);
        if ((!this.c) && ((this.mUIStyle.mRulesFromUrl & 0x2378) == 9080L) && (!((biho)localObject1).a())) {
          this.c = true;
        }
        localObject1 = localObject2;
        if (uuc.f((String)localObject2)) {
          localObject1 = uuc.a((String)localObject2);
        }
        if (QLog.isColorLevel()) {
  ...
  private void a(Bundle paramBundle)
  {
    if ((this.mApp != null) && (!NetworkUtil.isNetSupport(this.mApp.getApplication()))) {
      QQToast.a(this.mApp.getApplication(), 2131694253, 0).b(super.getTitleBarHeight());
    }
    if (!this.mUIStyleHandler.mUIStyle.isFullScreen)
    {
      ...
      this.mSwiftTitleUI.rightViewImg.setImageResource(2130840369);
      this.mSwiftTitleUI.rightViewImg.setContentDescription(super.getText(2131692544));
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Int == 1001)
      {
        ...
        this.mSwiftTitleUI.rightViewText.setText(anvx.a(2131708197));
      ...
      this.mSwiftTitleUI.rightViewImg.setVisibility(8);
      int i = (int)bhdz.a(BaseApplicationImpl.getApplication(), 8.0F);
  ...
  public void a(int paramInt)
  {
    ...
    default: 
    case 7: 
      olh.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X800572A", "0X800572A", 1010, 0, this.publicUin, (String)localObject2, this.msgid, (String)localObject3, false);
      return;
    }
  }
  ...
  void a(Context paramContext, Uri paramUri, String paramString)
  {
    ...
    try
    {
      ...
      aodv.a("scheme", paramString, paramUri, "1", "web", getActivity().getClass().getName());
  ...
  public void a(Context paramContext, String paramString1, Uri paramUri, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      paramContext = bhdj.a(paramContext, 230, null, paramString3, anvx.a(2131708239), anvx.a(2131708218), new ojx(this, paramContext, paramUri, paramString1, paramString4), new ojy(this, paramString4));
      paramContext.show();
  ...
  public void a(DialogInterface paramDialogInterface, boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      if (this.mApp != null) {
        bdla.b(null, "dc01160", "Pb_account_lifeservice", this.mApp.getCurrentAccountUin(), "0X80090F3", "0X80090F3", 0, 0, "", "", "", paramString);
      }
    }
    while (this.mApp == null) {
      return;
    }
    bdla.b(null, "dc01160", "Pb_account_lifeservice", this.mApp.getCurrentAccountUin(), "0X80090F4", "0X80090F4", 0, 0, "", "", "", paramString);
  }
  ...
  public boolean afterWebViewEngineHandleOverrideUrl(WebView paramWebView, String paramString)
  {
    ...
    if ((super.getActivity().isResume()) && ((System.currentTimeMillis() - this.mLastTouchTime < 1000L) || (this.authConfig.a(paramWebView.getUrl(), str).booleanValue())))
    {
      ...
      boolean bool = akqo.a().a(paramString, this);
  ...
  {
    return new bigl(this, 127, new ojw(this));
  }
  ...
  public int doCreateLoopStep_Final(Bundle paramBundle)
  {
    ...
    {
      ojv localojv = new ojv(this);
      this.mSwiftTitleUI.leftView.setOnClickListener(localojv);
      this.mSwiftTitleUI.rightViewText.setText(2131691834);
      this.mSwiftTitleUI.rightViewText.setOnClickListener(localojv);
    }
    a(paramBundle);
    return i;
  }
  ...
  public void onDestroy()
  {
    ...
    {
      ojz localojz = (ojz)this.jdField_a_of_type_JavaLangRefSoftReference.get();
      if (localojz != null)
      {
        localojz.a();
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("WebLog_WebViewFragment", 2, "shouldOverride: " + nwo.b(paramString, new String[0]));
    }
