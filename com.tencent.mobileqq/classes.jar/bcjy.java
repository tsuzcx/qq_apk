  ...
  implements ArkAppMgr.IGetAppPathByNameCallback
{
  ...
  public boolean a(bcjx parambcjx, String paramString, float paramFloat)
  {
    ...
    return super.init(this.jdField_a_of_type_Bcjx.b(), this.jdField_a_of_type_Bcjx.d(), this.jdField_a_of_type_Bcjx.c(), paramString, ArkAppCenterUtil.getCurrentAppConfig(), paramFloat);
  }
  
  public void initLibrary()
  {
    ark.MediaSetStub(apzg.a);
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Bcjx.a();
    ...
    ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new bcjz(this));
    return false;
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      apyp.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131718384);
    }
    label90:
    for (this.mErrorInfo.msg = String.format((String)localObject, new Object[] { this.jdField_a_of_type_Bcjx.b() });; this.mErrorInfo.msg = "")
    {
