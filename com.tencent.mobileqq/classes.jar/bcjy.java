...
public class bcjy
{
  public static final String a = bcjy.class.getSimpleName();
  ...
  public static void a(int paramInt1, int paramInt2, bcey parambcey)
  {
    if ((parambcey == null) || (parambcey.a() == null)) {}
    do
    {
      do
      {
      ...
      if (parambcey.a().equals(bcfe.a)) {
        a(null, 0, paramInt2, "0X8009D4E", 0, 0, null, null);
      }
      if (parambcey.a().equals(bcfb.a)) {
        a(null, 0, paramInt2, "0X8009D38", 0, 0, null, null);
      }
      if (parambcey.a().equals(bcfd.a)) {
        a(null, 0, paramInt2, "0X8009D3C", 0, 0, null, null);
      }
    } while (!parambcey.a().equals(anzj.a(2131714686)));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          bdll.b(paramQQAppInterface, "dc00898", "", "", "qqsearch", paramString1, paramInt1, 0, str2, str1, paramString2, "");
          return;
        }
        catch (Exception localException)
        {
          bdll.b(paramQQAppInterface, "dc00898", "", "", "qqsearch", paramString1, paramInt1, 0, "0", str1, paramString2, "");
          return;
        }
        paramInt1 = 1;
        continue;
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString1, int paramInt3, int paramInt4, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        bdll.b(paramQQAppInterface, "dc00898", "", "", "qqsearch", paramString1, i, 0, paramInt3 + "", paramInt4 + "", paramString2, paramString3);
  ...
  {
    if ((paramObject instanceof bcey)) {
      a(0, paramInt, (bcey)paramObject);
    }
    if ((paramObject instanceof bcfh)) {
    ...
    {
      localObject = (bcfb)paramObject;
      if (((bcfb)localObject).a() == null) {
        break label611;
      }
      i = ((bcfb)localObject).a().size();
      if (i > ((bcfb)localObject).a())
      {
        i = ((bcfb)localObject).a();
        bcni.a("all_result", "exp_contact", new String[] { "" + paramString, "" + i });
    ...
    else
    {
      ...
      if ((paramObject instanceof bcdj))
      {
        localObject = (bcdj)paramObject;
        if (((bcdj)localObject).a() == null) {
          break label655;
        }
        i = ((bcdj)localObject).a().size();
        if (i <= ((bcdj)localObject).a()) {
          break label652;
        }
        i = ((bcdj)localObject).a();
        label215:
        bcni.a("all_result", "exp_talk", new String[] { "" + paramString, "" + i });
        a(null, 0, paramInt, "0X8009D4C", 0, 0, null, null);
      }
      if ((paramObject instanceof bmlp))
      {
        localObject = (bmlp)paramObject;
        if (((bmlp)localObject).a() == null) {
          break label699;
        }
        i = ((bmlp)localObject).a().size();
        if (i <= ((bmlp)localObject).a()) {
          break label696;
        }
        i = ((bmlp)localObject).a();
        label329:
        bcni.a("all_result", "exp_collect", new String[] { "" + paramString, "" + i });
      }
      if ((paramObject instanceof auaa))
      {
        localObject = (auaa)paramObject;
        if (((auaa)localObject).a() == null) {
          break label743;
        }
        i = ((auaa)localObject).a().size();
        if (i <= ((auaa)localObject).a()) {
          break label740;
        }
        i = ((auaa)localObject).a();
        label431:
        bcni.a("all_result", "exp_file", new String[] { "" + paramString, "" + i });
      }
      label486:
      if ((paramObject instanceof bcfi))
      {
        localObject = (bcfi)paramObject;
        if (((bcfi)localObject).a() == null) {
          break label787;
        }
        i = ((bcfi)localObject).a().size();
        if (i <= ((bcfi)localObject).a()) {
          break label784;
        }
        i = ((bcfi)localObject).a();
        bcni.a("all_result", "exp_discuss", new String[] { "" + paramString, "" + i });
      }
    }
    for (;;)
    {
      label384:
      if ((paramObject instanceof bcfj)) {
        a(null, 0, paramInt, "0X8009D50", 0, 0, null, null);
      }
      return;
      break;
      label611:
      bcni.a("all_result", "exp_contact", new String[] { "" + paramString, "0" });
      break label137;
      label652:
      break label215;
      label655:
      bcni.a("all_result", "exp_talk", new String[] { "" + paramString, "0" });
      break label270;
      label696:
      break label329;
      label699:
      bcni.a("all_result", "exp_collect", new String[] { "" + paramString, "0" });
      break label384;
      label740:
      break label431;
      label743:
      bcni.a("all_result", "exp_file", new String[] { "" + paramString, "0" });
      break label486;
      label784:
      break label533;
      label787:
      bcni.a("all_result", "exp_discuss", new String[] { "" + paramString, "0" });
    }
  }
  ...
  protected static void b(String paramString, QQAppInterface paramQQAppInterface, ReportModel paramReportModel)
  {
    ...
    do
    {
      ...
      paramReportModel.version = "8.4.5";
      NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), bcvz.class);
