...
public class ajzt
  extends akac
{
  public ajzt(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(long paramLong, ajzw paramajzw)
  {
    ArrayList localArrayList = paramajzw.jdField_a_of_type_JavaUtilArrayList;
    int i = 0;
    try
    {
        ...
        if (-56 == ((MsgItem)localObject1).cType)
        {
          ...
          if (PushType.PUSH_TYPE_VOTE_INCR.value() == ((PushCardMsg)localObject2).ePushType)
          {
            ...
            if (((PushVoteIncreaseInfo)localObject1).iIncrement > 0)
            {
              ...
              localObject2 = (ajfi)((QQAppInterface)localObject2).a(2);
              if (localObject2 != null) {
                ((ajfi)localObject2).a((PushVoteIncreaseInfo)localObject1, String.valueOf(paramLong), String.valueOf(paramajzw.jdField_a_of_type_Long));
              }
            }
          }
        }
    ...
    catch (Exception paramajzw)
    {
      paramajzw.printStackTrace();
    }
  }
  
  private void a(long paramLong, ajzw paramajzw, SvcGetMsgInfo paramSvcGetMsgInfo, boolean paramBoolean)
  {
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = paramajzw.jdField_a_of_type_JavaUtilArrayList;
    String str2 = paramajzw.jdField_a_of_type_JavaLangString;
    int m = 0;
    int i = -1000;
    Object localObject3;
    String str1;
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        QLog.w("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp msgItem.MsgContent:" + bach.a(((MsgItem)localObject3).MsgContent));
        localObject3 = null;
        j = i;
        continue;
        if (paramajzw.jdField_a_of_type_Int != 201) {
          continue;
        }
        localObject2 = baac.a((String)localObject3, str2);
        if (j != -2000) {
          continue;
        }
        i = -1032;
        ...
        l1 = l2;
        continue;
        if (paramajzw.jdField_a_of_type_Int != 6) {
          continue;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp accostMsg.eAccostType" + paramajzw.jdField_a_of_type_Int + "accostMsg.msgId: " + paramajzw.jdField_b_of_type_Long + " accostMsg.time" + paramajzw.c + " msgConten: " + azzz.a((String)localObject3));
        }
        l2 = paramajzw.jdField_a_of_type_Long;
        if (paramajzw.jdField_a_of_type_Int != 1) {
          continue;
        }
        l1 = 9999L;
        i = j;
        localObject1 = localObject3;
        localObject3 = awbi.a(i);
        ((MessageRecord)localObject3).init(paramLong, l1, paramajzw.jdField_a_of_type_Long, (String)localObject1, paramajzw.c, i, 1001, 0L);
        ((MessageRecord)localObject3).shmsgseq = paramajzw.jdField_b_of_type_Long;
      ...
      if (((MsgItem)localObject3).MsgContent != null)
      {
        localObject1 = new String(awbk.a(((MsgItem)localObject3).MsgContent), "utf-8");
        break label966;
        localObject1 = axwb.a(str1, 0L, 1, false, str1);
        i = -2000;
        continue;
        localObject1 = axwb.a(str1, 0L, 2, false, str1);
        i = -2002;
        continue;
        a(paramLong, paramBoolean, paramajzw);
        return;
        if (localArrayList1.size() <= 0) {
          continue;
        }
        boolean bool1 = ajml.a(localArrayList1);
        boolean bool2 = ajml.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList1);
        i = akbm.a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramajzw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if ((bool1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramajzw.a(localArrayList1, String.valueOf(paramLong), paramBoolean);
  ...
  private void a(long paramLong1, ArrayList<AccostMsg> paramArrayList, ArrayList<ajzv> paramArrayList1, ArrayList<SvcGetMsgInfo> paramArrayList2, long paramLong2, String paramString)
  {
    int i = 0;
    ...
    {
      Object localObject = new ajzv();
      ((ajzv)localObject).jdField_a_of_type_Long = localAccostMsg.lFromMID;
      ((ajzv)localObject).jdField_b_of_type_Long = localAccostMsg.lToMID;
      ((ajzv)localObject).c = localAccostMsg.uMsgID;
      ((ajzv)localObject).jdField_a_of_type_Short = localAccostMsg.shMsgType;
      paramArrayList1.add(localObject);
      boolean bool = a(String.valueOf(paramLong1), String.valueOf(localAccostMsg.lFromMID));
      if (QLog.isColorLevel())
      {
        ajml.a("Q.msg.BaseMessageProcessor", paramString, localAccostMsg.uMsgID, String.valueOf(paramLong1), String.valueOf(localAccostMsg.lToMID));
      ...
      {
        a(paramLong1, new ajzw(paramLong2, j, localAccostMsg.uMsgID, localAccostMsg.iMsgTime, localArrayList, ((RichMsg)localObject).sAction), localSvcGetMsgInfo, false);
        break;
      }
      return;
    }
  ...
  private void a(long paramLong, boolean paramBoolean, ajzw paramajzw)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      int j = 0;
      while (j < paramajzw.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ((StringBuffer)localObject).append(new String(((MsgItem)paramajzw.jdField_a_of_type_JavaUtilArrayList.get(j)).MsgContent));
        if (j < paramajzw.jdField_a_of_type_JavaUtilArrayList.size() - 1) {
    ...
    localSystemMsg.auth = paramajzw.jdField_a_of_type_ArrayOfByte;
    localSystemMsg.lToMobile = paramajzw.e;
    localSystemMsg.strNickName = paramajzw.jdField_b_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, addUin=" + paramajzw.d + ", msgUid=" + paramajzw.jdField_b_of_type_Long + ", msg=" + localSystemMsg.sMsg);
    }
    Object localObject = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(String.valueOf(l));
    label320:
    ...
    if (localObject != null)
    {
      ...
      localSystemMsg.message = (l + BaseApplication.getContext().getString(2131624123));
      ...
      localObject = bach.a(((JceOutputStream)localObject).toByteArray());
      if (localObject != null)
      {
        localMessageRecord = awbi.a(-1011);
        localMessageRecord.init(paramLong, 9998L, l, (String)localObject, 0L, -1011, 0, paramajzw.c);
        localMessageRecord.shmsgseq = 187L;
        localMessageRecord.msgUid = paramajzw.jdField_b_of_type_Long;
        if (paramBoolean) {
        ...
        if (ajml.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, true)) {
          break label599;
        }
    ...
    for (;;)
    {
      ...
      {
        i = akbm.a(localArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      break;
      label558:
      localSystemMsg.message = ((String)localObject + BaseApplication.getContext().getString(2131624123));
      break label320;
      label593:
      i = 0;
      break label427;
      label599:
      if (QLog.isColorLevel()) {
        QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, the message is remove by msgFilter, addUin=" + paramajzw.d + ", msgUid=" + localMessageRecord.msgUid + ", msg=" + localSystemMsg.sMsg);
      }
    }
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getUin() == null)
    {
      ...
      if (QLog.isColorLevel()) {
        ajml.a("Q.msg.BaseMessageProcessor", (String)paramFromServiceMsg.getAttribute("_tag_LOGSTR"), paramObject.stMsg.uMsgID, paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID));
      }
      if (!bool) {
    ...
    for (;;)
    {
      ...
      if ((paramObject.bResend != 1) || (!a(paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID), paramObject.stMsg.uMsgID)))
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.VecMsg != null))
        {
          ...
          localObject = new ajzw(paramObject.stMsg.lFromMID, paramObject.stMsg.eAccostType, paramObject.stMsg.uMsgID, paramObject.stMsg.iMsgTime, (ArrayList)localObject, paramFromServiceMsg.sAction);
          if (paramFromServiceMsg.stSender != null)
          {
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "handlePushAccostMsg richMsg.stSender is null");
            }
            ((ajzw)localObject).d = paramFromServiceMsg.stSender.lMobileUin;
            ((ajzw)localObject).jdField_a_of_type_ArrayOfByte = paramFromServiceMsg.stSender.sig;
            ((ajzw)localObject).jdField_b_of_type_JavaLangString = paramFromServiceMsg.stSender.nickname;
          }
          ((ajzw)localObject).e = paramObject.stMsg.lFromMID;
          a(Long.valueOf(paramToServiceMsg).longValue(), (ajzw)localObject, null, false);
          continue;
          paramFromServiceMsg = a(paramObject.stMsg.strMsg);
          if (paramFromServiceMsg != null)
          {
            paramFromServiceMsg = new ajzw(paramObject.stMsg.lFromMID, paramFromServiceMsg.VecMsg);
  ...
  {
    paramString = bcax.a(paramString);
    ...
    {
      if (str != null) {
        bcfn.a().a(String.valueOf(paramLong), str, paramString, "100", paramBoolean);
      }
      return;
    }
  }
  ...
  {
    paramString1 = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString2);
  ...
  {
    atmp localatmp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory(String.valueOf(paramString1)).createEntityManager();
    paramString1 = localatmp.a(false, MessageRecord.getTableName(paramString2, 1001), null, "msgseq=?", new String[] { String.valueOf(paramLong) }, null, null, null, null);
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = localatmp.a(false, MessageRecord.getTableName(paramString2, 10002), null, "msgseq=?", new String[] { String.valueOf(paramLong) }, null, null, null, null);
        int j = 0;
        if (paramString1 != null) {}
        return false;
      }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    a(false, false, false, 0L, new ajzu(this, paramArrayOfByte, paramInt));
  }
