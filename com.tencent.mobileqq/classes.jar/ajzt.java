...
public class ajzt
{
  ...
  {
    if (paramInt == 2052) {
      return ajya.a(2131693719);
    }
    if (paramInt == 1033) {
      return ajya.a(2131693718);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = akwh.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      akwh.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = akwh.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      akwh.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    akwh.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    akwh.a(paramContext, "key_local_cache", String.valueOf(paramInt));
