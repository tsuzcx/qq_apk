...
public abstract class awyp
{
  ...
  private ConcurrentHashMap<String, xop> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  public xop a(String paramString)
  {
    ...
    return (xop)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  }
  ...
  protected void a(ToServiceMsg paramToServiceMsg, amlw paramamlw, Class<? extends MSFServlet> paramClass)
  {
    ...
    paramToServiceMsg = new PeakJceServiceBase.1(this, paramToServiceMsg, paramamlw, paramClass);
  ...
  public void a(boolean paramBoolean, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Exception paramException)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: invokevirtual 204	awyp:a	()Lcom/tencent/common/app/AppInterface;
    //   9: astore 8
    ...
    //   79: aload_0
    //   80: getfield 32	awyp:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   83: fload 5
    //   85: f2d
    ...
    //   130: invokevirtual 250	awyp:a	(Ljava/lang/String;)Lxop;
    //   133: astore 9
    //   135: iload_1
    //   136: ifeq +323 -> 459
    //   139: aload 9
    ...
    //   146: aload_2
    //   147: aload_3
    //   148: invokevirtual 253	xop:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   151: aload 9
    //   153: aload_2
    //   154: aload_3
    //   155: invokevirtual 256	xop:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)Ljava/lang/Object;
    //   158: astore 4
    //   160: aload_0
    //   161: aload_3
    //   162: invokevirtual 258	awyp:a	(Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   165: aload 9
    //   167: ifnull -163 -> 4
    //   170: invokestatic 263	ajtw:b	()Ljava/util/Map;
    //   173: aload_3
    ...
    //   236: aload_3
    //   237: aload 4
    //   239: invokevirtual 280	ajtd:onReceive	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Ljava/lang/Object;)V
    //   242: iload 6
    //   244: iconst_1
    //   245: iadd
    //   246: istore 6
    ...
    //   387: aload_0
    //   388: getfield 32	awyp:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   391: fload 5
    //   393: f2d
  ...
  protected boolean a(xop paramxop)
  {
    int i = 0;
    String[] arrayOfString = paramxop.a();
    if ((arrayOfString == null) || (arrayOfString.length == 0)) {
      return false;
    }
    while (i < arrayOfString.length)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(arrayOfString[i], paramxop);
      i += 1;
    }
    return true;
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, amlw paramamlw, Class<? extends MSFServlet> paramClass)
  {
    int i = 1;
    AppInterface localAppInterface = a();
    Object localObject1 = paramToServiceMsg.getServiceCmd();
    xop localxop = a((String)localObject1);
    Object localObject2;
    int j;
    if (localxop != null)
    {
      ...
      if (localxop.a())
      {
        localObject2 = localxop.a(paramToServiceMsg);
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        paramamlw = new NewIntent(localAppInterface.getApplication(), paramClass);
        paramamlw.putExtra(ToServiceMsg.class.getSimpleName(), paramToServiceMsg);
        localAppInterface.startServlet(paramamlw);
      ...
      do
      {
        ...
        {
          return;
          if (!localxop.a(paramToServiceMsg, (UniPacket)localObject2)) {
            break label314;
          }
          paramToServiceMsg.putWupBuffer(((UniPacket)localObject2).encode());
          break;
        } while (localxop == null);
        paramamlw = new FromServiceMsg(localAppInterface.getCurrentAccountUin(), (String)localObject1);
        paramClass = (int[])ajtw.a().get(localObject1);
      } while ((paramClass == null) || (paramClass.length <= 0));
      j = paramClass.length;
      i = 0;
      while (i < j)
      {
        localObject1 = (ajtd)localAppInterface.getBusinessHandler(paramClass[i]);
        if (localObject1 != null) {}
        try
        {
          ((ajtd)localObject1).onReceive(paramToServiceMsg, paramamlw, null);
          i += 1;
        }
