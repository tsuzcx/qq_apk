  ...
  implements View.OnClickListener
{
  ...
  public bers()
  {
    ...
    this.jdField_a_of_type_Anmu = new berv(this, null);
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    nir.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bert(this, paramLong), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, Observer paramObserver, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, afwy paramafwy, ChatXListView paramChatXListView)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374148);
    }
    ...
    this.d = paramContext.getResources().getColor(2131166229);
    this.e = paramContext.getResources().getColor(2131166230);
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_AndroidViewView == null) {
      this.jdField_c_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560551, null);
    }
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).topMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131374148);
      ((RelativeLayout.LayoutParams)localObject).addRule(11);
      ((RelativeLayout.LayoutParams)localObject).height = bggq.a(this.jdField_a_of_type_AndroidContentContext, 41.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379165));
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    int i = bggq.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
    ...
    if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130850670);
    }
    for (;;)
    {
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843625);
      ...
      return;
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130850671);
    }
  }
  ...
  public void c()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379164);
    localImageView.setVisibility(0);
    LinearLayout.LayoutParams localLayoutParams = (LinearLayout.LayoutParams)localImageView.getLayoutParams();
    localLayoutParams.height = -2;
    localLayoutParams.width = -2;
    localLayoutParams.leftMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 3.0F);
    localLayoutParams.rightMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 8.0F);
    Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843626);
    localLayoutParams.leftMargin = bggq.a(this.jdField_a_of_type_AndroidContentContext, 11.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131696954);
  }
  ...
  public void e()
  {
    ...
    {
      bcst.b(localQQAppInterface, "P_CliOper", "Grp_public", "", "oper", str1, 0, 0, "", "", "", str2);
      return;
