...
public class ackj
  implements bhqd
{
  public ackj(ChatSettingActivity paramChatSettingActivity, String paramString, bhpy parambhpy) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (bdee.d(BaseApplication.getContext()))
      {
        ...
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.app, "CliOper", "", "", "AIO", "AIO_delete_frd", 0, 0, "", "", "", "");
        if (bdal.b(this.jdField_a_of_type_JavaLangString)) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.app, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
        }
        this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.finish();
      }
      else
      {
        ChatSettingActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity, 2131691542, 1);
        continue;
        if (bdal.b(this.jdField_a_of_type_JavaLangString)) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.app, "dc00898", "", "", "0X8007FE0", "0X8007FE0", 0, 0, "", "", "", "");
        }
      }
    }
  }
