  ...
  extends BaseAdapter
{
  ...
  public apte(Context paramContext, List<Object> paramList, URLDrawable.URLDrawableListener paramURLDrawableListener, Drawable paramDrawable, String paramString1, String paramString2, String paramString3)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramInt < getCount() - 1)
    {
      ...
      if (paramView == null)
      {
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559062, null, false);
        paramViewGroup = new apth(this, null);
      ...
      for (;;)
      {
        ...
        {
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(bdkd.a(((IPSiteModel.Goods)localObject2).cover, this.jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable));
          ...
          paramViewGroup.b.setText((String)localObject1 + alpo.a(2131706218));
          paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new aptf(this, (IPSiteModel.Goods)localObject2));
        }
        return paramView;
        paramViewGroup = (apth)paramView.getTag();
      }
    }
    ...
    Object localObject1 = new AbsListView.LayoutParams(aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    paramViewGroup.setMinimumWidth(aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    paramViewGroup.setMinimumHeight(aekt.a(75.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    ((TextView)localObject2).setText(alpo.a(2131706219));
    ((TextView)localObject2).setLayoutParams(new RelativeLayout.LayoutParams(-2, -2));
    ImageView localImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    localImageView.setImageResource(2130846585);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(1, 2131362317);
    localLayoutParams.addRule(15);
    localLayoutParams.leftMargin = aekt.a(2.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    localImageView.setLayoutParams(localLayoutParams);
    ((RelativeLayout)localObject1).addView((View)localObject2);
    ((RelativeLayout)localObject1).addView(localImageView);
    paramViewGroup.addView((View)localObject1);
    paramViewGroup.setOnClickListener(new aptg(this, paramView));
