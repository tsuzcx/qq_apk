...
public class biqo
{
  private static biqo jdField_a_of_type_Biqo = new biqo();
  private static final String jdField_a_of_type_JavaLangString = biqo.class.getSimpleName();
  private Map<String, WeakReference<biqq>> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  private Map<String, MetaMaterial> b = new HashMap();
  
  public static biqo a()
  {
    return jdField_a_of_type_Biqo;
  }
  ...
  private void a(MetaMaterial paramMetaMaterial)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (biqq)((WeakReference)localObject).get();
        if (localObject != null) {
          ((biqq)localObject).a(paramMetaMaterial);
        }
      }
    }
  }
  ...
  private void a(MetaMaterial paramMetaMaterial, int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (biqq)((WeakReference)localObject).get();
        if (localObject != null) {
          ((biqq)localObject).a(paramMetaMaterial, paramInt);
        }
      }
    }
  }
  ...
  {
    return new File(biid.e, paramMetaMaterial.id).getAbsolutePath();
  }
  
  public void a(AppInterface paramAppInterface, MetaMaterial paramMetaMaterial, biqq parambiqq)
  {
    if ((paramMetaMaterial == null) || (TextUtils.isEmpty(paramMetaMaterial.id)))
    {
      if (parambiqq != null) {
        parambiqq.b(paramMetaMaterial);
      }
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.put(paramMetaMaterial.id, new WeakReference(parambiqq));
  ...
  public boolean a(MetaMaterial paramMetaMaterial)
  {
    ...
    //   14: iconst_0
    //   15: ireturn
    //   16: getstatic 127	biid:d	Ljava/lang/String;
    //   19: astore_2
    ...
    //   44: invokestatic 140	bbdj:c	(Ljava/lang/String;)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_3
    ...
    //   73: getstatic 80	biid:e	Ljava/lang/String;
    ...
    //   162: getstatic 80	biid:e	Ljava/lang/String;
    ...
    //   177: invokestatic 171	nay:a	(Ljava/io/File;Ljava/lang/String;)V
    //   180: iconst_1
    //   181: ireturn
    //   182: astore_1
