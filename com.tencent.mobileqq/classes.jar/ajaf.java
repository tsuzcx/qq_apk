...
public class ajaf
{
  ...
  private HashMap<Integer, ajah> jdField_a_of_type_JavaUtilHashMap;
  
  public ajaf(int paramInt)
  {
  ...
  private int a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((localObject == null) || (((ajcf)localObject).a() == null)) {
          break label105;
        }
        i = ((ajcf)localObject).a().getMeasuredHeight();
        if (i == 0)
        {
          localObject = a();
          if (localObject != null)
          {
            localObject = (FrameLayout)((Activity)localObject).findViewById(2131366941);
            if (localObject != null)
            {
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      ajac.a().callbackFromRequest(paramLong, paramInt2, "sc.game_ad_banner_load.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  private static qq_ad_get.QQAdGet b(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt1, int paramInt2)
  {
    ...
    ((qq_ad_get.QQAdGet.PositionInfo.PositionExt.ShareInfo)localObject1).share_check.set(ysq.a(paramLong2, paramLong3, paramInt2));
