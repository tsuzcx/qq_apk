...
class bpim
{
  ...
  private final Class<? extends botu> jdField_a_of_type_JavaLangClass;
  private Set<Integer> jdField_a_of_type_JavaUtilSet = new HashSet();
  private final int b;
  private final int c;
  
  private bpim(int paramInt1, int paramInt2, int paramInt3, Class<? extends botu> paramClass)
  {
  ...
  static bpim a(int paramInt1, int paramInt2, int paramInt3, Class<? extends botu> paramClass)
  {
    return new bpim(paramInt1, paramInt2, paramInt3, paramClass);
  }
  
  Class<? extends botu> a()
  {
