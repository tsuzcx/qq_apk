...
public class aupz
{
  ...
  public auot a;
  private aupx jdField_a_of_type_Aupx;
  ActionCallback jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceActionCallback = new auqb(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public aupz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Auot = auqe.a().a();
  ...
  private void c(Bundle paramBundle)
  {
    ...
    paramBundle.putString("hostVersion", String.valueOf(aqmy.a(BaseApplicationImpl.getContext())));
  ...
  {
    this.jdField_a_of_type_Aupx = paramaupx;
    paramaupx = paramBundle.getString("mqqUrl", "");
    long l = System.currentTimeMillis();
    if ((l - this.jdField_a_of_type_Long < 1000L) && (!auow.c(paramBundle).equals("1")))
    {
      QLog.i("DynamicNow | NowEntry", 1, "开始处理mqq　scheme,time = " + System.currentTimeMillis() + " 点太快了");
      QQToast.a(BaseApplicationImpl.getContext(), amtj.a(2131706773), 0).a();
      return;
    }
    this.jdField_a_of_type_Long = l;
    QLog.i("DynamicNow | NowEntry", 1, "开始进入now结合版,time = " + System.currentTimeMillis() + " mqqScheme = " + paramaupx);
  ...
  {
    Object localObject1 = auow.a(paramBundle);
    Object localObject2 = auow.b(paramBundle);
    long l = auow.a(paramBundle);
    this.jdField_a_of_type_Auot.a(false, (String)localObject2, String.valueOf(l), (String)localObject1, false, false, true);
    ...
    ((URLDrawable)localObject1).setURLDrawableListener(new auqa(this, l, (AtomicBoolean)localObject2, paramBundle));
