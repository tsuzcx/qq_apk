...
public class bejx
{
  private static bejx jdField_a_of_type_Bejx;
  public static final Object a;
  public int a;
  final bejo jdField_a_of_type_Bejo = new bejo(new bejy(this));
  public boolean a;
  public int b = 0;
  ...
  {
    if (jdField_a_of_type_Bejx == null) {}
    try
    {
      if (jdField_a_of_type_Bejx == null) {
        jdField_a_of_type_Bejx = new bejx();
      }
      return jdField_a_of_type_Bejx;
    }
    finally {}
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    for (boolean bool = BaseApplicationImpl.sApplication.getSharedPreferences("sp_x5_config_" + (String)localObject, 4).getBoolean("key_x5_init_sub_thread", true);; bool = true)
    {
      ...
      bejz.b();
      beiy.X = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "initX5Environment on main thread, cost " + beiy.X + "ms.");
      return 1;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    if (Looper.getMainLooper() == Looper.myLooper())
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Bejo.b();
        this.jdField_a_of_type_Bejo.a(localBundle);
  ...
  public int b(Bundle paramBundle)
  {
    ...
    beiy.Y = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateWebView:create webview cost " + beiy.Y + "ms.");
    return 1;
  }
  ...
  public int c(Bundle paramBundle)
  {
    ...
    beiy.Z = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "tendocpreload doMainStep_WarnUpWebView:load " + paramBundle + ", cost " + beiy.Z + "ms.");
    return 1;
  }
  ...
  public int e(Bundle paramBundle)
  {
    ...
    if (WebAccelerateHelper.preloadBrowserView == null)
    {
      ...
      beiy.aa = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateBrowserView, cost = " + beiy.aa + "ms.");
      return 1;
    }
    return 0;
  }
