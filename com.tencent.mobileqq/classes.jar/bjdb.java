  ...
  implements KingCardProxy
{
  ...
  public ImageView getCapsuleButtonMoreView(Context paramContext)
  {
    ...
    for (Object localObject = MiniAppGlobal.KINGCARD_GUIDE_TEXT;; localObject = paramContext.getResources().getString(2131693788))
    {
      ...
      ((DiniFlyAnimationView)localObject).setContentDescription(amtj.a(2131700500));
