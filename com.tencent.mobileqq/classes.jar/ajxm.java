...
public class ajxm
  extends QIPCModule
{
  private static volatile ajxm a;
  
  public ajxm(String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("ACTION_IS_FRIEND".equals(paramString))
    {
      ...
      paramBundle = (ajxn)((QQAppInterface)localObject1).getManager(51);
    ...
    if ("ACTION_GET_PHONE_NUMBER".equals(paramString))
    {
      ...
      paramString = (ajxn)((QQAppInterface)localObject1).getManager(51);
    ...
    for (paramString = paramString.unifiedCode;; paramString = null)
    {
      ...
      if ("ACTION_GET_SPECIAL_CARE_INFO".equals(paramString))
      {
        ...
        paramString = ((ajxn)((QQAppInterface)localObject1).getManager(51)).a(str);
        localObject2 = new Bundle();
        ...
        paramBundle = bbjo.a(localSharedPreferences, (String)localObject1, null);
        ...
        if (paramString.add(str))
        {
          ...
          bbjo.a(paramBundle, (String)localObject1, paramString.toArray());
          paramBundle.commit();
        }
        for (;;)
        {
      ...
      {
        paramString = paramBundle.getString("KEY_UIN");
        paramBundle = ((ajxn)((QQAppInterface)localObject1).getManager(51)).a(paramString, false);
        if (paramBundle != null) {}
        for (paramInt = paramBundle.friendRingId;; paramInt = 0)
        {
          paramString = amgc.a((QQAppInterface)localObject1).a(paramInt, paramString, 0);
      ...
      if ("ACTION_SET_SAVE_SWITCH".equals(paramString))
      {
        ...
        aijb.a(paramString, "1", (QQAppInterface)localObject1);
      }
      label750:
      label758:
      do
