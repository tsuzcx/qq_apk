  ...
  implements ahpr
{
  ...
  public ahpj(QQAppInterface paramQQAppInterface, ahqs paramahqs, Activity paramActivity, SessionInfo paramSessionInfo, aezn paramaezn)
  {
  ...
  {
    paramVarArgs = bbli.a(-1016);
    long l = bbko.a();
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691645), l, -1017, 3000, l);
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = aqlq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (((aqlq)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 2))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            localList = this.jdField_a_of_type_Aezn.a();
            if (localList == null)
            {
              if (!QLog.isColorLevel()) {
                break;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramInt >= 5) && (i >= 2))
        {
          ...
          ((aqlq)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, 2);
        ...
        for (;;)
        {
          try
          {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8003F01", "0X8003F01", 0, 0, "", "", "", "");
