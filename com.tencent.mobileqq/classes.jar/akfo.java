  ...
  extends akfg
{
  ...
  public akfo(Context paramContext, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  private void A()
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = (ViewGroup)localObject1;; localObject1 = null)
      {
        ...
        if (bghs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin))
        {
          int i = ((ViewGroup)localObject1).indexOfChild(this.jdField_a_of_type_AndroidWidgetTextView);
          localObject2 = bbxa.a(this.jdField_a_of_type_AndroidContentContext);
          if (localObject2 == null) {
            break;
          }
          ((View)localObject2).setId(2131376928);
          ...
          localLayoutParams.addRule(1, 2131379001);
          localLayoutParams.addRule(6, 2131379001);
          ((View)localObject2).setLayoutParams(localLayoutParams);
          ((ViewGroup)localObject1).addView((View)localObject2, i);
          return;
        }
        Object localObject2 = ((ViewGroup)localObject1).findViewById(2131376928);
        if (localObject2 == null) {
          break;
        }
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                {
                  ahwv.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
                  aijq.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
                }
                ...
                localObject = ((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).e(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
                if ((localObject != null) && ((ContactUtils.getFriendStatus(((Friends)localObject).detalStatusFlag, ((Friends)localObject).iTermType) != 0) || (!TextUtils.isEmpty(((Friends)localObject).strTermDesc))))
                {
                  ...
                  this.b.setCompoundDrawables(ahwv.a().b(5), null, null, null);
              ...
              if ((localObject != null) && ((ContactUtils.getFriendStatus(((Friends)localObject).detalStatusFlag, ((Friends)localObject).iTermType) != 0) || (!TextUtils.isEmpty(((Friends)localObject).strTermDesc))))
              {
                localObject = ContactUtils.getStatusName((Friends)localObject);
                this.b.setCompoundDrawablePadding(AIOUtils.dp2px(2.0F, BaseApplicationImpl.getContext().getResources()));
                this.b.setCompoundDrawables(aijq.a().b(5), null, null, null);
                this.b.setText((CharSequence)localObject);
                e(true);
                return;
              }
          ...
          } while ((!this.c) || ((this.jdField_a_of_type_Bjxa != null) && (this.jdField_a_of_type_Bjxa.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin))));
        ...
        localObject = ((anvk)localObject).e(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
        ...
        localObject = ContactUtils.getStatusName((Friends)localObject);
        if ((TextUtils.isEmpty((CharSequence)localObject)) || (bhbx.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin))) {
          break;
        }
        this.b.setText((CharSequence)localObject);
        e(true);
