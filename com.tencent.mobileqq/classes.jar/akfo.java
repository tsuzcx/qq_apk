...
{
  private static volatile akfo jdField_a_of_type_Akfo;
  ...
  {
    if (jdField_a_of_type_Akfo == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Akfo == null) {
        jdField_a_of_type_Akfo = new akfo();
      }
      return jdField_a_of_type_Akfo;
    }
  }
  ...
  public void a()
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getContext(), akfn.class);
    akfn.a(localNewIntent, BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin());
