...
public class bprt
  implements bprx, bpsd
{
  private int jdField_a_of_type_Int = 0;
  private bpsc jdField_a_of_type_Bpsc = new bpsc();
  ...
  private bpsc jdField_b_of_type_Bpsc = new bpsc();
  private String jdField_b_of_type_JavaLangString;
  private boolean jdField_b_of_type_Boolean;
  private byte[] jdField_b_of_type_ArrayOfByte;
  private String c;
  
  public bprt(String paramString1, String paramString2, String paramString3)
  {
  ...
  public bpsc a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecVideoSourceHelper != null) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_b_of_type_Bpsc.jdField_a_of_type_ArrayOfByte = this.jdField_b_of_type_ArrayOfByte;
      this.jdField_b_of_type_Bpsc.jdField_a_of_type_Int = 0;
      this.jdField_b_of_type_Bpsc.jdField_b_of_type_Int = i;
      this.jdField_b_of_type_Bpsc.jdField_b_of_type_Boolean = false;
      bpsc localbpsc = this.jdField_b_of_type_Bpsc;
      if (i > 0) {}
      for (;;)
      {
        localbpsc.jdField_a_of_type_Boolean = bool;
        localbpsc = this.jdField_b_of_type_Bpsc;
        this.jdField_b_of_type_Bpsc.c = -1;
        localbpsc.jdField_a_of_type_Long = -1;
        this.jdField_b_of_type_Bpsc.jdField_a_of_type_Float = -1.0F;
        if (QLog.isColorLevel()) {
          QLog.d("HwEncodeHelper", 4, "getAudioFrame() bufferSize=" + this.jdField_b_of_type_ArrayOfByte.length + ", readSize=" + i);
        }
        this.jdField_a_of_type_Boolean = this.jdField_b_of_type_Bpsc.jdField_a_of_type_Boolean;
        return this.jdField_b_of_type_Bpsc;
        bool = true;
      }
    }
    return null;
  ...
  public bpsc a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecVideoSourceHelper != null) && (!this.jdField_b_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_Bpsc.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
      this.jdField_a_of_type_Bpsc.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_Bpsc.jdField_b_of_type_Int = paramInt;
      this.jdField_a_of_type_Bpsc.jdField_b_of_type_Boolean = true;
      bpsc localbpsc = this.jdField_a_of_type_Bpsc;
      if (paramInt > 0) {
        bool = false;
      }
      localbpsc.jdField_a_of_type_Boolean = bool;
      this.jdField_a_of_type_Bpsc.jdField_a_of_type_Long = this.jdField_a_of_type_ArrayOfLong[0];
      this.jdField_a_of_type_Bpsc.c = -1;
      this.jdField_a_of_type_Bpsc.jdField_a_of_type_Float = -1.0F;
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bpsc.jdField_a_of_type_Boolean;
      return this.jdField_a_of_type_Bpsc;
    }
    return null;
  }
