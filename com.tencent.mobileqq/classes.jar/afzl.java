...
public class afzl
  implements Runnable
{
  public afzl(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity, PersonalityLabel paramPersonalityLabel) {}
  ...
  public void run()
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.isFinishing())
    {
      ...
      PersonalityLabelGalleryActivity.a(this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity, this.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelPersonalityLabelGalleryActivity.getResources().getString(2131433196));
