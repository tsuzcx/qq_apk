  ...
  extends acka
{
  ...
  public aerd(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Aerg = new aerg(this, null);
  ...
  public void a(aerf paramaerf)
  {
    this.jdField_a_of_type_Aerf = paramaerf;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    ackk localackk = this.jdField_a_of_type_Adie.a(localChatMessage, this);
    if ((localackk instanceof BaseBubbleBuilder)) {
      ((BaseBubbleBuilder)localackk).c = true;
    }
    paramView = localackk.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Aerg);
    if (paramView != null) {
      paramView.setTag(2131298565, localChatMessage);
    }
    ...
    for (;;)
    {
      ...
      {
        if ((localackk instanceof adis)) {
          ((adis)localackk).a(false);
        }
      }
      else if ((localChatMessage.msgtype == -2039) && ((localackk instanceof ApolloItemBuilder)))
      {
        ((ApolloItemBuilder)localackk).a(false);
        paramViewGroup = (adac)aciy.a(paramView);
      ...
      {
        ((LightVideoItemBuilder)localackk).a((ListView)paramViewGroup);
      }
    }
  }
}
