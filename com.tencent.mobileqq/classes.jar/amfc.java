  ...
  implements View.OnClickListener
{
  ...
  public amfc(SigCommentListActivity paramSigCommentListActivity, QQAppInterface paramQQAppInterface, XListView paramXListView, View paramView)
  {
  ...
  {
    if (this.b != null) {
      ((amfd)this.b.getTag()).jdField_a_of_type_AndroidWidgetTextView.setText(paramInt);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (1 == i)
      {
        ...
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562904, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          localObject1 = new amfe();
          ((amfe)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377553));
          ((amfe)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377554));
          ((amfe)localObject1).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377551));
          ((amfe)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377552));
          ((amfe)localObject1).c = ((TextView)paramView.findViewById(2131377555));
          paramView.setTag(localObject1);
          localSigCommentInfo = a(paramInt);
          localObject2 = String.valueOf(localSigCommentInfo.uin);
          aoch localaoch = aoch.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, (String)localObject2);
          if (localaoch != null) {
            ((amfe)localObject1).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(localaoch);
          }
          localObject2 = bglf.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2);
          ((amfe)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          ((amfe)localObject1).jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130850023);
        ...
        label375:
        for (Object localObject2 = anni.a(2131712868) + (String)localObject2;; localObject2 = anni.a(2131712865) + (String)localObject2)
        {
          ((amfe)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          a(localSigCommentInfo.feedsid, ((amfe)localObject1).c);
          break;
          localObject1 = (amfe)paramView.getTag();
          break label171;
        }
      }
      if (2 == i)
      {
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562092, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          paramView.setOnClickListener(this);
          localObject1 = new amfd();
          paramView.setTag(localObject1);
          paramView.findViewById(2131370192).setVisibility(8);
          ((amfd)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371326));
          this.b = paramView;
        }
        for (;;)
        {
          paramView = this.b;
          break;
          paramView = (amfd)paramView.getTag();
        }
      }
    }
  }
