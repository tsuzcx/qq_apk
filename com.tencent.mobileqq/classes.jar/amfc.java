  ...
  extends alpd
{
  ...
  public amfc(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      aylx localaylx = new aylx(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localArrayList2.add(new ayly(localHotWordItem.word_id.get().toStringUtf8(), localHotWordItem.word.get().toStringUtf8()));
      }
      ayha.a.put(ayha.a(localaylx.a), localArrayList2);
      ...
      localObject1 = new aylw((String)localObject1, (String)localObject2);
      ayha.b.put(ayha.a(localaylx.a), localObject2);
      localArrayList1.add(new BusinessGroupWord(localaylx, localArrayList2, (aylw)localObject1));
    }
  ...
  private void a(String paramString1, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    new azqx(this.app).a("dc00899").b("grp_search_engineer").c("search_net").d(paramString1).a(new String[] { paramLong2 + "", "" + (l - paramLong1), "" + paramString2, wxj.a(null) }).a();
  }
  ...
  {
    return (babd.a()) && ((paramLong == 1100L) || (paramLong == 1012L) || (paramLong == 1003L));
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        ayvm.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new ayno((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bdne.s(BaseApplicationImpl.getContext(), i);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (((UnifyTabSearch.RspBody)localObject1).search_ver.has()) {
          ayvm.a("UnifySearch.Tab", arrayOfLong, ((UnifyTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
        ...
        Object localObject3 = new aypt();
        if (bool2) {
          ((aypt)localObject3).a(true);
        }
        paramToServiceMsg = ((aypt)localObject3).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public List<aynt> a(Object... paramVarArgs)
  {
    ...
    label202:
    for (boolean bool1 = ayvj.b(i);; bool1 = true)
    {
  ...
  public void a()
  {
    ...
    localReqBody.version.set(ByteStringMicro.copyFromUtf8("8.3.5"));
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bdne.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(ayvm.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = bdne.b(this.app.getCurrentAccountUin());
        ...
        paramList2.extraData.putLongArray("masks", ayif.a(paramList1));
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (ayha.a.isEmpty())
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (!bool) {
              ayvm.a("sub_result", "active_search", new String[] { paramString1, ayvm.a(paramList1), "" + paramInt1, "" });
            }
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = ayha.a.values().iterator();
        paramInt1 = 2;
      }
      label566:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((ayly)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<aynt> paramList)
  {
    ...
    {
      localObject1 = new aypa(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((aypa)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((aypa)localObject1).c(null);
      ((aypa)localObject1).a(bool2);
      if ((localObject1 != null) && (((ayod)localObject1).b()))
      {
        ((ayod)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((ayod)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        default: 
          break;
        case 2: 
          localObject1 = new ayob(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 3: 
          localObject1 = new ayox(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 4: 
          localObject1 = new ayoc(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 7: 
          localObject1 = new ayok(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 6: 
          localObject1 = new ayot(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 8: 
          localObject1 = new ayoq(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 9: 
          localObject1 = new ayor(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 11: 
          localObject1 = new ayoh(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 12: 
          localObject1 = new ayof(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 13: 
          localObject1 = new ayoi(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 14: 
          localObject1 = new ayos(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 15: 
          localObject1 = new ayop(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 16: 
          localObject1 = new ayon(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 17: 
          localObject1 = new ayoo(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 18: 
          localObject1 = new ayom(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
          l2 = l1 - 1L;
          continue;
          label939:
          ...
          {
            localObject1 = new aypd(paramString, str7, -4, str5);
            ((aypd)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            localArrayList2.add(localObject1);
            l2 = l1;
          }
          else
          {
            localObject1 = new ayms(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
            l2 = l1;
            if (localObject1 != null)
            {
              ((ayms)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
              ((ayms)localObject1).c = bool1;
              ((ayms)localObject1).g = i;
              ((ayms)localObject1).a = paramInt;
              localArrayList2.add(localObject1);
              l2 = l1;
            }
          }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new aynn(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label1262:
      paramList.add(new aymr(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  {
    return bdhb.a(BaseApplication.getContext().getFileStreamPath(paramString));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bdne.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = aypb.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
