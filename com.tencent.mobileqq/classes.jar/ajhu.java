  ...
  extends ayog
{
  ...
  public static URLDrawable a(boolean paramBoolean1, String paramString1, URLDrawable.URLDrawableOptions paramURLDrawableOptions, String paramString2, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1) {}
    for (String str = ajmu.k + "boxcard/" + paramString1;; str = paramString1)
    {
      ...
      if (localURLDrawableOptions.mExtraInfo == null) {
        localURLDrawableOptions.mExtraInfo = new ajhv();
      }
      paramBoolean1 = paramBoolean2;
      if ((localURLDrawableOptions.mExtraInfo instanceof ajhv))
      {
        paramURLDrawableOptions = (ajhv)localURLDrawableOptions.mExtraInfo;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return false;
      String str = ajmu.k + paramString.substring(paramString.lastIndexOf("/") + 1);
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof ajhv)))
    {
      paramOutputStream = (ajhv)paramDownloadParams.mExtraInfo;
      ...
      do
      {
        ...
        bbwg localbbwg = new bbwg(paramOutputStream, paramDownloadParams);
        localbbwg.b = 1;
        localbbwg.p = false;
        localbbwg.q = true;
        localbbwg.r = true;
        i = bbwi.a(localbbwg, null);
        if (i != 0) {
          break;
        }
        if (paramURLDrawableHandler != null) {
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    ajhv localajhv;
    if ((paramFile != null) && (paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof ajhv)))
    {
      localajhv = (ajhv)paramDownloadParams.mExtraInfo;
      if (localajhv.jdField_a_of_type_Int != jdField_a_of_type_Int) {
        break label102;
      }
    }
    for (;;)
    {
      try
      {
        ...
        localBitmap = bbdr.a(localBitmap, localBitmap.getWidth(), localBitmap.getHeight());
      ...
      } while (localajhv.jdField_a_of_type_Int != b);
      if (paramFile.exists())
      {
        ...
        paramURLDrawableHandler.inSampleSize = bbdr.a(paramURLDrawableHandler, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight);
        ...
        try
        {
          ...
          if (paramFile != null) {
            if (localajhv.jdField_a_of_type_Boolean)
            {
              i = 2130848928;
              paramDownloadParams = bbdr.a(paramFile, i, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight, true);
