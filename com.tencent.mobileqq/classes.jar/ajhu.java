...
public class ajhu
{
  ...
  private static HashMap<String, List<ajfl>> c = new HashMap();
  ...
  public static List<ajfl> a(String paramString)
  {
  ...
  public static List<ajdy> a(ArrayList<ajfl> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      String str = String.valueOf(((ajfl)paramArrayList.get(i)).jdField_a_of_type_Long);
      ...
      {
        ajdy localajdy = new ajdy();
        localajdy.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo = localTroopInfo;
        localajdy.jdField_a_of_type_JavaLangString = str;
        localajdy.jdField_a_of_type_Int = ((ajfl)paramArrayList.get(i)).jdField_a_of_type_Int;
        localArrayList.add(localajdy);
      }
      i += 1;
    }
    return localArrayList;
  ...
  public static void a(String paramString1, String paramString2, String paramString3, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      paramString2 = (aoep)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
  ...
  public static void a(String paramString, List<ajfl> paramList)
  {
  ...
  public static boolean a(long paramLong, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (auzb)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.INTIMATE_INFO_HANDLER);
    if (!a(str))
    {
