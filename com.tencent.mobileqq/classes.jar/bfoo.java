...
{
  aaho jdField_a_of_type_Aaho = new bfoq(this);
  aahq jdField_a_of_type_Aahq = new bfop(this);
  protected Bundle a;
  public bflq a;
  protected bfls a;
  protected bfnz a;
  ...
  protected bfoo(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfol parambfol)
  {
  ...
  private boolean a(Bundle paramBundle, long paramLong)
  {
    ...
    {
      bfmf.b("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onReqUploadFileResult.but stoped");
      return false;
    }
    return true;
  }
  
  public static bfoo b(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfol parambfol)
  {
    if (paramLong == 0L)
    {
      bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null) {
      bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "getWoker. item.id=null");
    }
    return new bfoo(paramLong, paramItem, paramBundle, parambfol);
  }
  ...
  protected bfnz a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    return null;
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop. but had stoped. mStatus:" + this.jdField_b_of_type_Int);
      return;
    }
    this.jdField_a_of_type_Boolean = true;
    a(8, 0);
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop. mStatus:" + this.jdField_b_of_type_Int + " reason:" + paramInt);
    int j;
    if (this.jdField_b_of_type_Int == 1)
    {
      bfoc.a().a(this.jdField_e_of_type_Long);
      e();
    ...
    for (;;)
    {
      bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, k);
      b(0);
      this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = j;
      c();
      p();
      return;
      ...
      bfmf.b("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop upload. uploader=null");
      break;
      label299:
      if (paramInt == 2)
      {
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Bfnz != null)
    {
      this.jdField_a_of_type_Bflq.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Bfnz.a();
      this.jdField_a_of_type_Bflq.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Bfnz.b();
      this.jdField_a_of_type_Bflq.jdField_a_of_type_Int = this.jdField_a_of_type_Bfnz.b();
      this.jdField_a_of_type_Bflq.jdField_b_of_type_Int = this.jdField_a_of_type_Bfnz.h();
    }
    ...
    if (paramInt1 == 0)
    {
      ...
      if (this.jdField_a_of_type_Bfnz != null)
      {
        this.jdField_a_of_type_Bflq.jdField_a_of_type_Long = this.jdField_a_of_type_Bfnz.a();
        this.jdField_a_of_type_Bflq.jdField_a_of_type_Boolean = this.jdField_a_of_type_Bfnz.d();
        if (!this.jdField_a_of_type_Bflq.jdField_a_of_type_Boolean) {
          break label246;
        }
      }
    }
    label246:
    for (l1 = 0L;; l1 = this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal - this.jdField_a_of_type_Bfnz.a())
    {
      this.jdField_a_of_type_Bflq.jdField_b_of_type_Long = l1;
      if (this.jdField_g_of_type_Long != 0L)
      {
        this.jdField_a_of_type_Bflq.jdField_c_of_type_Long = (System.currentTimeMillis() - this.jdField_g_of_type_Long);
        if ((this.jdField_a_of_type_Bflq.jdField_b_of_type_Long <= 0L) || (this.jdField_a_of_type_Bflq.jdField_c_of_type_Long <= 0L)) {
          break;
        }
        float f1 = (float)this.jdField_a_of_type_Bflq.jdField_c_of_type_Long / 1000.0F;
        this.jdField_a_of_type_Bflq.jdField_e_of_type_Long = (((float)this.jdField_a_of_type_Bflq.jdField_b_of_type_Long / f1));
      }
      return;
    }
  ...
  public void a(long paramLong)
  {
    ...
    for (this.h += paramLong - this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressValue;; this.h = paramLong)
    {
      ...
      this.i = paramLong;
      bflo.b(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item);
      return;
    }
  }
  ...
  public void a(long paramLong1, String paramString, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, Bundle paramBundle, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      bfmf.b("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onFileScanResult. but had stop");
      return;
    }
    if (this.f != 0L)
    {
      this.jdField_a_of_type_Bflq.jdField_g_of_type_Long = (System.currentTimeMillis() - this.f);
      this.f = 0L;
    }
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onFileScanResult. errCode:" + paramInt);
    if (paramInt != 0)
    {
      int j = 1;
      int k = bgme.l;
      if (paramInt == -2)
      {
        this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 5;
        this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 501;
        j = 102;
        paramInt = bgme.s;
      }
      for (;;)
      {
        a(true, bgme.jdField_b_of_type_Int, paramInt, j);
        return;
        if (paramInt == -1)
        {
          this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 7;
          this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 700;
          j = 201;
          paramInt = bgme.jdField_g_of_type_Int;
        }
        else if (paramInt == -4)
        {
          this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 5;
          this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 502;
          j = 205;
          paramInt = bgme.jdField_e_of_type_Int;
        }
        else if (paramInt == -3)
        {
          this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 7;
          this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 701;
          j = 203;
          paramInt = bgme.j;
        }
        else
        {
          this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 5;
          this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 503;
          paramInt = k;
        }
      }
    }
    ...
    {
      bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onFileScanResult. md5 or sha is null");
      this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 5;
      this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 503;
      a(true, bgme.jdField_b_of_type_Int, bgme.l, 211);
      return;
    }
  ...
  protected final void a(bfjs parambfjs, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      localFileManagerEntity.localModifyTime = new VFSFile(parambfjs.jdField_a_of_type_JavaLangString).lastModified();
      label229:
  ...
  {
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onChangeUrl:" + paramString);
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (localQQAppInterface == null)
    {
      bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] startUpload app=null");
    ...
    if (b())
    {
      ...
      bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] startUpload. nSessionId:" + l + " use custom fileuploader bUseHttps:" + bool1 + " httpsDomain:" + (String)localObject1);
      this.jdField_a_of_type_Bfnz = a(localQQAppInterface, l, paramBoolean, bool1, (String)localObject1);
      if (this.jdField_a_of_type_Bfnz == null)
      {
        this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 9;
        this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 904;
        a(true, bgme.jdField_b_of_type_Int, bgme.w, 1);
      }
    }
    else
    {
      ...
      if ((!paramBoolean) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ServerDns))) {
        if (atlb.a().a(localQQAppInterface, 3))
        {
          ...
          localObject1 = new atlc(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ServerDns, 0);
      ...
      for (;;)
      {
        ...
        bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] startUpload. nSessionId:" + l + " UseLastUploadIp=false firstIP=" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.UploadIp + " bUseHttps:" + paramBoolean + " httpsDomain:" + (String)localObject1);
        this.jdField_a_of_type_Bfnz = bfor.a(localQQAppInterface, l, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile, str1, str2, localArrayList, "/ftn_handler", paramBoolean, (String)localObject1);
        break;
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 12);
    c();
    p();
    if (paramBoolean)
    {
      ...
      bgmd.a(paramInt1, paramInt2, str);
    }
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = 0;
    bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onFileInvailDel  nReportResultCode:" + paramInt1 + " nReportSecResultCode:" + paramInt2);
    if (this.jdField_a_of_type_Bfol != null) {
      this.jdField_a_of_type_Bfol.a(a(), false, paramInt2, this);
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    e();
    b(6);
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 3, paramInt3);
    c();
    p();
    if (paramBoolean)
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = 0;
    bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onUploadErr  nReportResultCode:" + paramInt1 + " nReportSecResultCode:" + paramInt2 + " troopFileError:" + paramInt3);
    if (this.jdField_a_of_type_Bfol != null) {
      this.jdField_a_of_type_Bfol.a(a(), false, paramInt2, this);
    }
  }
  
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, bgje parambgje)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Bfls = null;
    e();
    b(6);
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 3, parambgje);
    c();
    p();
    if (paramBoolean)
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = 0;
    bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onUploadErr  nReportResultCode:" + paramInt1 + " nReportSecResultCode:" + paramInt2 + " troopFileError:" + parambgje.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Bfol != null) {
      this.jdField_a_of_type_Bfol.a(a(), false, paramInt2, this);
    }
  }
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    int j = bfmd.a(paramString1);
    int m = j;
    if (j == 0) {
      m = bfmd.b(paramString2);
    }
    int i6 = bfmd.c(paramString1);
    int k;
    if (!paramBoolean)
    {
      j = a(paramInt);
      ...
      a(j, k);
      this.jdField_a_of_type_Bflq.jdField_e_of_type_Int = i6;
      this.jdField_a_of_type_Bflq.f = m;
      n();
    ...
    bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onHasErr. upload fail. errCode:" + paramInt + " transferedSize:" + paramLong + " rspHeader:" + paramString2 + " errMsg:" + paramString1);
    int i2 = a(paramInt);
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Bfnz.c())
      {
        i1 = 4;
        if (m != 0) {
          paramInt = m;
  ...
  public void a(boolean paramBoolean, long paramLong, String paramString1, String paramString2)
  {
    ...
    a(3, 312);
    a(true, bgme.jdField_d_of_type_Int, bgme.v, 102);
  }
  ...
  public boolean a()
  {
    ...
    {
      bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] start filepath:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile + " bResueFromW2MPause:" + bool1);
      this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.Pausing = 0;
      if (!NetworkUtil.isNetworkAvailable(BaseApplication.getContext()))
      {
        bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] no network");
        this.jdField_a_of_type_Boolean = true;
        b(6);
        bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 3, 106);
        this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 9;
        this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 901;
        c();
        this.jdField_a_of_type_Bflq.a();
        bgmd.a(bgme.jdField_b_of_type_Int, bgme.k);
        return false;
      }
  ...
  protected void b()
  {
    ...
    if (localQQAppInterface == null)
    {
      bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqReUpload app=null");
      this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 9;
      this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 902;
      a(true, bgme.jdField_b_of_type_Int, bgme.w, 1);
      return;
    }
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqReUpload");
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 1);
    this.jdField_a_of_type_Bfls = aagu.a(localQQAppInterface, this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Aaho);
    b(2);
  }
  ...
  {
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onUploadSuc. bHit:" + paramBoolean);
    e();
    b(5);
    ...
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 6);
    j();
    ...
    this.jdField_a_of_type_Bfls = null;
    this.jdField_a_of_type_Bflq.jdField_a_of_type_Boolean = paramBoolean;
    a(0, 0);
    d();
    if (!b()) {
      o();
    ...
    for (int j = 0;; j = 1)
    {
      bdla.b((QQAppInterface)localObject, "P_CliOper", "Grp_files", "", "oper", "upload_suc", 0, 0, str, j + "", "", "");
      bgmd.a(bgme.jdField_a_of_type_Int, 0);
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = 0;
      if (this.jdField_a_of_type_Bfol != null) {
        this.jdField_a_of_type_Bfol.a(a(), true, 0, this);
      }
      return;
    }
  }
  ...
  public String c()
  {
    return atrr.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.Md5);
  }
  ...
  protected void c()
  {
    ...
    if (b())
    {
      this.jdField_a_of_type_Bflq.jdField_g_of_type_Int = 1;
      this.jdField_a_of_type_Bflq.h = this.jdField_c_of_type_Int;
      this.jdField_a_of_type_Bflq.i = e();
    ...
    {
      localbflq.j = j;
      bflp.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, "actGroupFileUp", this.jdField_a_of_type_Bflq);
      return;
      this.jdField_a_of_type_Bflq.jdField_g_of_type_Int = 0;
      break;
      label86:
      j = 0;
    }
  ...
  public String d()
  {
    return atrr.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.Sha);
  }
  ...
  protected void d()
  {
    ...
    {
      localbflq.j = j;
      bflp.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Bflq, "actGroupFileUp");
      return;
      this.jdField_a_of_type_Bflq.jdField_g_of_type_Int = 0;
      break;
      label86:
  ...
  protected int e()
  {
    ...
    return aufd.c(this.jdField_a_of_type_Bfnz.a());
  }
  ...
  public void h()
  {
    ...
    bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onOutDate. upload fail");
    a(3, 302);
    this.jdField_a_of_type_Bflq.f = -29120;
    a(true, bgme.jdField_d_of_type_Int, -29120, 206);
  }
  
  public void i()
  {
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onRetrySend");
    if (this.jdField_a_of_type_Bfnz != null) {
      this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = this.jdField_a_of_type_Bfnz.a();
    }
    this.jdField_g_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_Bflq.jdField_a_of_type_Long = this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressValue;
    this.jdField_a_of_type_Bflq.jdField_e_of_type_Int = 0;
  ...
  public void k()
  {
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 0);
    b(7);
  }
  ...
  {
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 0);
    this.jdField_e_of_type_Long = bfoc.a().a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile, this, null);
    if (this.jdField_e_of_type_Long == 0L)
    {
      this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 5;
      this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 504;
      a(true, bgme.jdField_b_of_type_Int, bgme.w, 1);
      return;
    }
    b(1);
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] scanFile. cookie:" + this.jdField_e_of_type_Long);
  }
  ...
  protected void m()
  {
    ...
    if (localQQAppInterface == null)
    {
      bfmf.a("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqUploadFile app=null");
      this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 9;
      this.jdField_a_of_type_Bflq.jdField_d_of_type_Int = 902;
      a(true, bgme.jdField_b_of_type_Int, bgme.w, 1);
      return;
    }
    bfmf.c("TroopFileUploadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqUploadFile");
    bflo.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 1);
    a();
    this.jdField_a_of_type_Bfls = aagu.a(localQQAppInterface, Long.valueOf(this.jdField_d_of_type_Long).longValue(), this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Aahq);
    b(2);
  }
  ...
  protected final void n()
  {
    ...
    {
      localbflq.j = j;
      bflp.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, "actGroupFileUpDetail", this.jdField_a_of_type_Bflq);
      return;
      this.jdField_a_of_type_Bflq.jdField_g_of_type_Int = 0;
      break;
      label86:
  ...
  protected final void o()
  {
    ...
    {
      localbflq.j = j;
      bflp.a(this.jdField_d_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Bflq, "actGroupFileUpDetail");
      return;
      this.jdField_a_of_type_Bflq.jdField_g_of_type_Int = 0;
      break;
      label86:
