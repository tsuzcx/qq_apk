  ...
  extends vqr<wfs>
{
  ...
  public wdn(String paramString, List<String> paramList, List<Long> paramList1, List<Integer> paramList2, int paramInt)
  {
  ...
  public String a()
  {
    return vpl.a("StoryGroupSvc.add_video");
  }
  ...
  public vqm a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wfs(localRspAddGroupVideo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        xvv.b("AddGroupVideoRequest", "decodeResponse", paramArrayOfByte);
      }
    }
  }
