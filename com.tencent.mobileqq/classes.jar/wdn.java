...
{
  public wdn(TroopMemberHistoryFragment paramTroopMemberHistoryFragment) {}
  
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (this.a.jdField_a_of_type_Wdt != null)
    {
    ...
    do
    {
      ...
      paramView = ((wds)this.a.jdField_a_of_type_Wdt.getItem(paramInt)).a;
