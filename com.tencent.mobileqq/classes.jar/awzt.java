  ...
  extends xom
{
      ...
      if (i1 == 3)
      {
        ...
        try
        {
          ...
          for (;;)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject3).qqver.set("8.3.0.4480");
            ...
            localObject5[0] = 40;
            bbmx.a((byte[])localObject5, 1, k);
            bbmx.a((byte[])localObject5, 5, i4);
            bbmx.a((byte[])localObject5, 9, (byte[])localObject3, k);
            int m = localObject3.length + 9;
            k = m;
            if (localObject4 != null)
            {
              bbmx.a((byte[])localObject5, m, (byte[])localObject4, i4);
              k = m + i4;
            }
            localObject5[k] = 41;
  ...
  private boolean D(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    {
      localByteBuffer.putInt(ajtw.a(localObject3[0]));
      localByteBuffer.putInt(ajtw.a(localObject3[1]));
      localByteBuffer.putInt(ajtw.a(localObject3[2]));
      localByteBuffer.putInt(ajtw.a(localObject3[3]));
      localObject3 = ByteBuffer.allocate(16);
      if ((localObject2 == null) || (localObject2.length != 4)) {
        break label482;
      }
      ((ByteBuffer)localObject3).putInt(ajtw.a(localObject2[0]));
      ((ByteBuffer)localObject3).putInt(ajtw.a(localObject2[1]));
      ((ByteBuffer)localObject3).putInt(ajtw.a(localObject2[2]));
      ((ByteBuffer)localObject3).putInt(ajtw.a(localObject2[3]));
    }
    for (;;)
    {
      short s2 = (short)k;
  ...
  public static ReqSummaryCard a(ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        localObject4 = new SSummaryCardQueryReq(1, Long.parseLong(paramToServiceMsg.getUin()), l2, "8.3.0", k, 109L);
        ...
        try
        {
          ...
          if ((l2 > 0L) || (bool))
          {
            ...
            if (l1 == l2)
            {
              ...
              ((SummaryCardBusiEntry.comm)localObject8).qqver.set("8.3.0.4480");
              ...
              localObject9[0] = 40;
              bbmx.a((byte[])localObject9, 1, i1);
              bbmx.a((byte[])localObject9, 5, j);
              bbmx.a((byte[])localObject9, 9, (byte[])localObject8, i1);
              j = localObject8.length + 9;
              if (((BusinessBuff)localObject7).a() == null) {
                break label1039;
              }
              bbmx.a((byte[])localObject9, j, ((BusinessBuff)localObject7).a(), ((BusinessBuff)localObject7).a().length);
  ...
  public static ArrayList<afgv> a(ArrayList<byte[]> paramArrayList)
  {
    ...
    if (i < k)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          break label53;
          n = (int)bbmx.a((byte[])localObject1, 1);
          m = (int)bbmx.a((byte[])localObject1, 5);
        } while ((n <= 0) || (n + 9 >= j));
        localObject2 = new byte[n];
        bbmx.a((byte[])localObject2, 0, (byte[])localObject1, 9, n);
        j = n + 9;
        ...
        for (;;)
        {
          try
          {
            ...
            bbmx.a((byte[])localObject2, 0, (byte[])localObject1, j, m);
            localObject1 = new AccountSearchPb.search();
            ((AccountSearchPb.search)localObject1).mergeFrom((byte[])localObject2);
            localObject2 = new afgv();
            ((afgv)localObject2).jdField_a_of_type_Int = n;
            ((afgv)localObject2).jdField_b_of_type_Int = ((AccountSearchPb.search)localObject1).start.get();
            if (((AccountSearchPb.search)localObject1).end.get() != 1) {
              break label496;
            }
            bool = true;
            ((afgv)localObject2).jdField_a_of_type_Boolean = bool;
            ((afgv)localObject2).jdField_b_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).list.get();
            ((afgv)localObject2).jdField_a_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).highlight.get();
            ((afgv)localObject2).jdField_a_of_type_JavaLangString = ((AccountSearchPb.search)localObject1).article_more_url.get();
            ((afgv)localObject2).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord = ((AccountSearchPb.hotwordrecord)((AccountSearchPb.search)localObject1).hotword_record.get());
            ((afgv)localObject2).jdField_c_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).result_items.get();
            ((afgv)localObject2).jdField_b_of_type_Boolean = ((AccountSearchPb.search)localObject1).bool_keyword_suicide.get();
            if (((((afgv)localObject2).jdField_b_of_type_JavaUtilList == null) || (((afgv)localObject2).jdField_b_of_type_JavaUtilList.size() <= 0)) && ((((afgv)localObject2).jdField_c_of_type_JavaUtilList == null) || (((afgv)localObject2).jdField_c_of_type_JavaUtilList.size() <= 0)) && (!((afgv)localObject2).jdField_b_of_type_Boolean)) {
              break;
            }
    ...
    for (int j = 1;; j = 2)
    {
      ((afgv)localObject2).jdField_c_of_type_Int = j;
      break;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    boolean bool = ((ajxl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51)).b(String.valueOf(l));
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.vClientVersion = "8.3.0".getBytes();
  ...
  private Object p(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.vUserList != null) && (!paramFromServiceMsg.vUserList.isEmpty()))
    {
      ...
      while (i < paramFromServiceMsg.vUserList.size())
      {
        ...
        String str1 = ajtw.a(paramToServiceMsg.dwCountry);
        String str2 = ajtw.a(paramToServiceMsg.dwProvince);
        String str3 = ajtw.a(paramToServiceMsg.dwCity);
        paramToServiceMsg.locDesc = ((ajtw)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(59)).b(new String[] { str1, str2, str3, "0" });
        i += 1;
      }
    }
    return paramFromServiceMsg;
  ...
  private boolean q(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localObject = new ReqVoiceManage(i, new VoiceInfo(bbac.a((String)localObject), s, (byte)0, null), l);
    SummaryCard.ReqHead localReqHead = new SummaryCard.ReqHead();
    localReqHead.iVersion = 2;
    paramUniPacket.setServantName("SummaryCardServantObj");
  ...
  private boolean t(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localSSummaryCardSetLabel.version = "8.3.0";
  ...
  private boolean u(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    try
    {
      ...
      localSSummaryCardLikeIt.version = "8.3.0";
      paramUniPacket.setServantName("SummaryCard");
