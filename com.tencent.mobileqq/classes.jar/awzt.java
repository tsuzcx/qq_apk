  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = paramView.getTag(2131310781);
    if ((localObject1 != null) && ((localObject1 instanceof awzv)))
    {
      localObject7 = (awzv)localObject1;
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          l1 = l2;
          if (((awzv)localObject7).a.getDrawable() != null)
          {
            l1 = l2;
            if ((((awzv)localObject7).a.getDrawable() instanceof URLDrawable))
            {
              localObject3 = (URLDrawable)((awzv)localObject7).a.getDrawable();
              l1 = l2;
          ...
          paramView = (String)paramView.getTag(2131310787);
        } while (TextUtils.isEmpty(paramView));
        String str = befm.a(befm.a(paramView, "progress", String.valueOf(l1)), "msgId", (String)localObject1);
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            try
            {
              ...
              localObject7 = new nfz();
              ((nfz)localObject7).a = 3;
              ((nfz)localObject7).f = 1;
              localObject7 = nfw.a((nfz)localObject7, this.a.a.message);
              ((nfw)((QQAppInterface)localObject5).a(139)).a((nfz)localObject7, null);
              Long.parseLong((String)localObject1);
              if (this.a.a != null) {
                localObject5 = (awul)((AbsShareMsg)this.a.a).mStructMsgItemLists.get(0);
              }
              ...
              paramView = (nfp)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(88);
              if (paramView == null) {
                break;
              }
