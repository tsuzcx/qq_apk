...
public abstract class bepv
  extends bfeu
  implements Handler.Callback, begx
{
  public static final String TAG = "AppRuntimeLoader";
  private boolean isSucceed;
  private Map<String, bfer> mActivatedTasks;
  private final bepr mAppStateManager;
  protected Context mContext;
  private final bepl mEventCenter;
  protected Handler mHandler;
  protected boolean mIsRunning;
  protected MiniAppInfo mMiniAppInfo;
  protected begw mRuntime;
  protected bepx mRuntimeLoadListener;
  protected boolean runtimeLoadCompleted;
  
  /* Error */
  public bepv(Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 40	bfeu:<init>	()V
    //   4: aload_0
    //   5: new 42	bepl
    //   8: dup
    //   9: invokespecial 43	bepl:<init>	()V
    //   12: putfield 45	bepv:mEventCenter	Lbepl;
    //   15: aload_0
    //   16: new 47	bepr
    //   19: dup
    //   20: aload_0
    //   21: invokespecial 50	bepr:<init>	(Lbepv;)V
    //   24: putfield 52	bepv:mAppStateManager	Lbepr;
    //   27: aload_0
    //   28: aload_1
    //   29: putfield 54	bepv:mContext	Landroid/content/Context;
    //   32: aload_0
    //   33: new 56	java/util/HashMap
    //   36: dup
    //   37: invokespecial 57	java/util/HashMap:<init>	()V
    //   40: putfield 59	bepv:mActivatedTasks	Ljava/util/Map;
    //   43: aload_0
    //   44: getfield 45	bepv:mEventCenter	Lbepl;
    //   47: aload_0
    //   48: getfield 52	bepv:mAppStateManager	Lbepr;
    //   51: invokevirtual 63	bepl:addObserver	(Ljava/util/Observer;)V
    ...
    //   95: putfield 86	bepv:mHandler	Landroid/os/Handler;
    //   98: aload_0
    //   99: invokespecial 89	bepv:initTask	()V
    //   102: return
    //   103: aload_0
    ...
    //   115: putfield 86	bepv:mHandler	Landroid/os/Handler;
    //   118: goto -20 -> 98
    //   121: astore_3
    //   122: aconst_null
    //   123: astore_2
    ...
    //   128: ldc 96
    //   130: aload_3
    //   131: invokestatic 102	besl:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   134: aload_2
    //   135: ifnull +29 -> 164
    //   138: aload_2
    ...
    //   158: putfield 86	bepv:mHandler	Landroid/os/Handler;
    //   161: goto -63 -> 98
    //   164: aload_0
    ...
    //   176: putfield 86	bepv:mHandler	Landroid/os/Handler;
    //   179: goto -81 -> 98
    //   182: astore_2
    //   183: aconst_null
    //   184: astore_1
    ...
    //   209: putfield 86	bepv:mHandler	Landroid/os/Handler;
    //   212: aload_2
    //   213: athrow
    //   214: aload_0
    ...
    //   226: putfield 86	bepv:mHandler	Landroid/os/Handler;
    //   229: goto -17 -> 212
    //   232: astore_2
    //   233: goto -48 -> 185
    //   236: astore_3
  ...
  {
    bfer[] arrayOfbfer = createTasks();
    initTasks(arrayOfbfer);
    if (arrayOfbfer != null)
    {
      ...
      while (i < j)
      {
        registTaskName(arrayOfbfer[i]);
        i += 1;
      }
    }
  }
  
  private void registTaskName(bfer parambfer)
  {
    if (parambfer == null) {}
    for (;;)
    {
      ...
      if ((parambfer != null) && (parambfer.size() > 0))
      {
        ...
        while (parambfer.hasNext()) {
          registTaskName((bfer)parambfer.next());
        }
      }
    }
  }
  
  public void addRuntimeStateObserver(bepn parambepn)
  {
    this.mEventCenter.addObserver(parambepn);
  }
  
  public void addTask(bfer parambfer)
  {
    if (parambfer == null) {
      return;
    }
    String str = parambfer.getClass().getCanonicalName();
    if (this.mActivatedTasks.containsKey(str))
    {
      besl.c("AppRuntimeLoader", "Failed to add task: duplicated " + str);
      return;
    }
    this.mActivatedTasks.put(str, parambfer);
  }
  
  public void addTasks(bfer... paramVarArgs)
  {
  ...
  public abstract bfer[] createTasks();
  ...
  public bepr getAppStateManager()
  {
  ...
  public bfer getTask(Class paramClass)
  {
    return (bfer)this.mActivatedTasks.get(paramClass.getCanonicalName());
  }
  
  public boolean handleMessage(Message paramMessage)
  {
    besl.a("AppRuntimeLoader", "handleMessage " + paramMessage.what);
    return false;
  }
  ...
  {
    bepm localbepm = bepm.a(paramInt, this);
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      localbepm.a = paramVarArgs[0];
    }
    this.mEventCenter.a(localbepm);
  }
  ...
  public void removeRuntimeStateObserver(bepn parambepn)
  {
    this.mEventCenter.deleteObserver(parambepn);
  }
  
  public void setRuntimeLoadListener(bepx parambepx)
  {
    this.mRuntimeLoadListener = parambepx;
  }
