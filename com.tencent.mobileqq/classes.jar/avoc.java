  ...
  implements avol
{
  ...
  WeakReference<avod> jdField_a_of_type_MqqUtilWeakReference;
  
  public avoc(QQAppInterface paramQQAppInterface, avod paramavod)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramavod);
  ...
  public avod a()
  {
    ...
    return (avod)this.jdField_a_of_type_MqqUtilWeakReference.get();
  }
  ...
  public void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if ((paramInt == 10016) || (paramInt == 10015)) {
      if (!avoo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
      {
        bool1 = true;
    ...
    do
    {
      ...
      if (paramInt == 100601)
      {
        if (!avoo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {}
        for (;;)
        {
          paramRedTouchItem.isClosed = bool1;
          return;
    ...
    for (;;)
    {
      ...
      if (bool2) {
        bdcs.a(a(-4), localObject3);
      }
      for (;;)
      {
        QLog.d("DefaultRedPointPrePostHandler", 1, new Object[] { "isQQSettingMeBubbleMsg show=", Boolean.valueOf(bool2), " uin=", bdje.e((String)localObject2) });
        return;
  ...
  {
    avod localavod = a();
    if ((paramList == null) || (localavod == null)) {
      return;
    }
    ...
    while (((Iterator)localObject3).hasNext())
    {
      ...
      {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", (String)localObject1, (String)localObject1, 0, 0, "", "", "", "");
        localObject2 = localObject1;
      }
    }
    localObject3 = localavod.a(10015);
    ...
    if (localObject3 != null)
    {
      ...
      if (paramList.contains(localObject3))
      {
        ...
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007391", "0X8007391", 0, 0, "", "", "", "");
        ((MedalWallMng)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(250)).b();
      }
    }
    localObject2 = localavod.a(10016);
    ...
    for (;;)
    {
      ...
      localObject1 = localavod.a(10018);
      ...
      paramList = (aoel)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269);
      localObject2 = paramList.a();
      if ((localObject2 != null) && (((aoeh)localObject2).c())) {
        continue;
      }
