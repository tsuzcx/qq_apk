...
public final class rit
{
  private final void a(Readinjoy.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.msg_video_data.has())
    {
      ...
      paramArticleSummary.jdField_a_of_type_JavaLangString = pvd.a(paramWeiShiVideoArticleInfo);
      ...
      paramArticleSummary.jdField_b_of_type_JavaLangString = pvd.a(paramWeiShiVideoArticleInfo);
    }
  }
  ...
  private final void a(oidb_cmd0xbed.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_article_list.has())
    {
      ...
      if (i < m)
      {
        ...
        SimpleChannelInfo localSimpleChannelInfo = sfm.a(paramArticleSummary.msg_channel_info);
        int j;
        ...
        {
          localObject = (BaseVideoArticleInfo)sfm.a((oidb_cmd0xbed.ArticleSummary)localObject, j, k);
          if (localObject != null) {
  ...
  private final void b(oidb_cmd0xbed.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_label_list.has())
    {
      ...
      {
        SimpleChannelInfo localSimpleChannelInfo = sfm.a((oidb_cmd0xbed.ChannelInfo)paramArticleSummary.next());
        if (localSimpleChannelInfo != null) {
  ...
  private final void c(Readinjoy.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_label_list.has())
    {
      ...
      while (paramArticleSummary.hasNext())
      {
        ...
        paramWeiShiVideoArticleInfo.labelList.add(sfm.a(localChannelInfo));
      }
    }
  }
  ...
  public final WeiShiVideoArticleInfo a(@Nullable Readinjoy.ArticleSummary paramArticleSummary)
  {
    ...
    try
    {
      ...
      localWeiShiVideoArticleInfo.rowkey = pvd.a(localPBBytesField);
      ...
      for (;;)
      {
        ...
        localWeiShiVideoArticleInfo.title = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.summary = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pagePicUrl = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.articleContentUrl = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeName = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeIcon = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeID = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.recommendReason = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pushContext = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.adsJumpUrl = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoReportInfo = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.businessInfo = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptTxt = pvd.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptColor = pvd.a(localPBBytesField);
        ((rit)this).c(paramArticleSummary, localWeiShiVideoArticleInfo);
        ((rit)this).b(paramArticleSummary, localWeiShiVideoArticleInfo);
        ((rit)this).a(paramArticleSummary, localWeiShiVideoArticleInfo);
    ...
    if (paramArticleSummary != null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          Intrinsics.checkExpressionValueIsNotNull(localPBBytesField, "summary.bytes_video_subscript_color");
          localWeiShiVideoArticleInfo.videoSubscriptColor = pvd.a(localPBBytesField);
          ((rit)this).d(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((rit)this).c(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((rit)this).b(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((rit)this).a(paramArticleSummary, localWeiShiVideoArticleInfo);
        }
        catch (Throwable paramArticleSummary)
        {
          ...
          QLog.e("VideoProtoHelper", 0, "cmd0xbedToWeiShiVideoArticleInfo error:" + pha.a(paramArticleSummary));
          continue;
        }
        return localWeiShiVideoArticleInfo;
        bool = false;
