...
public class xap
{
  public static azsf a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean1, boolean paramBoolean2, xbd paramxbd)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    int i = apue.a(apvb.a(paramItem.FileName));
    ...
    for (;;)
    {
      ...
      return a(paramQQAppInterface, paramxbd, paramItem.toByteArray(), "OidbSvc.0x6d6_2", 1750, 2, (Bundle)localObject);
      bool = false;
      break;
      label250:
  ...
  public static azsf a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, xbf paramxbf)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    return a(paramQQAppInterface, paramxbf, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  
  public static azsf a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, xbh paramxbh)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    return a(paramQQAppInterface, paramLong, paramItem.FileName, paramItem.LocalFile, paramItem.ProgressTotal, paramItem.isFromAIO, paramItem.Md5, paramItem.Sha, paramItem.Sha3, paramItem.BusId, paramItem.mParentId, localBundle, paramxbh);
  }
  
  public static azsf a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, xaw paramxaw)
  {
    ...
    return a(paramQQAppInterface, paramxaw, paramString.toByteArray(), "OidbSvc.0x6d8_4", 1752, 4, null);
  }
  
  public static azsf a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString3, int paramInt, String paramString4, Bundle paramBundle, xbh paramxbh)
  {
    ...
    for (paramInt = 5;; paramInt = 4)
    {
      ...
      return a(paramQQAppInterface, paramxbh, paramString1.toByteArray(), "OidbSvc.0x6d6_0", 1750, 0, paramBundle);
      localUploadFileReqBody.str_parent_folder_id.set(paramString4);
      break;
    }
  }
  
  public static azsf a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, String paramString3, Bundle paramBundle, xbh paramxbh)
  {
    if (paramLong1 == 0L) {
      return null;
    }
    return a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, true, paramArrayOfByte1, paramArrayOfByte2, null, paramInt, paramString3, paramBundle, paramxbh);
  }
  
  private static azsf a(QQAppInterface paramQQAppInterface, mxm parammxm, byte[] paramArrayOfByte, String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    paramArrayOfByte.jdField_a_of_type_Mxm = parammxm;
  ...
  private static String a(TroopFileTransferManager.Item paramItem)
  {
    try
    {
      ...
      Object localObject;
      if (vyi.c(paramItem.middleThumbnailFile)) {
      ...
      for (String str = "mid";; str = "larg")
      {
        ...
        return paramItem.strQRUrl;
        if (!vyi.c(paramItem.largeThumbnailFile)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString, int paramInt6, long paramLong2, int paramInt7, ByteStringMicro paramByteStringMicro, xav paramxav)
  {
    boolean bool;
    ...
    for (;;)
    {
      ...
      mxi.b(paramQQAppInterface, paramxav, paramString.toByteArray(), "OidbSvc.0x6d8_1", 1752, 1, paramByteStringMicro);
      return;
      bool = false;
      break;
      label343:
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, msg_ctrl.MsgCtrl paramMsgCtrl, xbe paramxbe)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        mxi.b(paramQQAppInterface, paramxbe, paramMsgCtrl.toByteArray(), "OidbSvc.0x6d9_4", 1753, 4, paramBundle);
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, xbe paramxbe)
  {
    a(paramQQAppInterface, paramLong, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, null, paramxbe);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, Bundle paramBundle, xbc paramxbc)
  {
    ...
    mxi.b(paramQQAppInterface, paramxbc, paramString.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, paramBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, xas paramxas)
  {
    ...
    mxi.b(paramQQAppInterface, paramxas, paramString2.toByteArray(), "OidbSvc.0x6d6_3", 1750, 3, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, xaz paramxaz)
  {
    ...
    mxi.b(paramQQAppInterface, paramxaz, paramString1.toByteArray(), "OidbSvc.0x6d6_5", 1750, 5);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString, xay paramxay)
  {
    ...
    mxi.b(paramQQAppInterface, paramxay, paramString.toByteArray(), "OidbSvc.0x6d8_0", 1752, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, azpg paramazpg, xbg paramxbg)
  {
    if ((paramLong == 0L) || (paramazpg == null)) {
      return;
    }
    ...
    localTransFileReqBody.uint32_bus_id.set(paramazpg.a);
    localTransFileReqBody.str_file_id.set(paramazpg.b);
    Bundle localBundle = new Bundle();
    localBundle.putLong("troopUin", paramLong);
    localBundle.putString("fileId", paramazpg.b);
    paramazpg = new oidb_0x6d9.ReqBody();
    paramazpg.trans_file_req.set(localTransFileReqBody);
    mxi.b(paramQQAppInterface, paramxbg, paramazpg.toByteArray(), "OidbSvc.0x6d9_0", 1753, 0, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, xbe paramxbe)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return;
    }
    ...
    localObject = aqvs.a(paramItem.LocalFile, paramItem.width, paramItem.height, (String)localObject);
    a(paramQQAppInterface, paramLong, paramItem.BusId, paramItem.FilePath, paramItem.RandomNum, paramItem.width, paramItem.height, paramItem.duration, true, localBundle, (msg_ctrl.MsgCtrl)localObject, paramxbe);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, xar paramxar)
  {
    ...
    mxi.b(paramQQAppInterface, paramxar, paramString1.toByteArray(), "OidbSvc.0x6d7_0", 1751, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, xbb paramxbb)
  {
    if ((paramLong == 0L) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return;
    }
    ...
    mxi.b(paramQQAppInterface, paramxbb, localReqBody.toByteArray(), "OidbSvc.0x6d7_2", 1751, 2, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, xat paramxat)
  {
    ...
    mxi.b(paramQQAppInterface, paramxat, paramString.toByteArray(), "OidbSvc.0x6d7_1", 1751, 1);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, xau paramxau)
  {
    if (QLog.isDevelopLevel()) {
    ...
    mxi.b(paramQQAppInterface, paramxau, localReqBody.toByteArray(), "OidbSvc.0x6d8_1", 1752, 2, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, xax paramxax)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d("TroopFileProtocol", 4, "getFileList" + paramLong);
    }
    ...
    mxi.a(paramQQAppInterface, paramxax, localReqBody.toByteArray(), "OidbSvc.0x6d8_3", 1752, 3, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, azsf paramazsf)
  {
    if ((paramQQAppInterface == null) || (paramazsf == null)) {
      return;
    }
    paramQQAppInterface.getTroopFileProtoReqMgr().b(paramazsf);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, FileManagerEntity paramFileManagerEntity, xba paramxba)
  {
    paramString1 = new bahp("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + bfng.a(paramString4) + "&", "GET", new xaq(new ArrayList(), paramString4, paramFileManagerEntity, paramQQAppInterface, paramInt, paramxba), 1000, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, long paramLong1, TroopFileTransferManager.Item paramItem, long paramLong2, long paramLong3, xbc paramxbc)
  {
    ...
    for (;;)
    {
      ...
      mxi.b(paramQQAppInterface, paramxbc, localReqBody.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, (Bundle)localObject);
      return;
