...
public class amcj
{
  ...
  public static amcj a(String paramString)
  {
    boolean bool = true;
    if (paramString == null) {
      return null;
    ...
    try
    {
      amcj localamcj = new amcj();
      paramString = new JSONObject(paramString);
      if (paramString.optInt("isUpgradeOpen", 0) == 1) {}
      for (;;)
      {
        localamcj.jdField_a_of_type_Boolean = bool;
        localamcj.jdField_a_of_type_JavaLangString = paramString.optString("managePageURL", "https://ti.qq.com/hybrid-h5/intimate/list?_wv=83886083");
        if (TextUtils.isEmpty(localamcj.jdField_a_of_type_JavaLangString)) {
          localamcj.jdField_a_of_type_JavaLangString = "https://ti.qq.com/hybrid-h5/intimate/list?_wv=83886083";
        }
        localamcj.jdField_b_of_type_JavaLangString = paramString.optString("bindPageURL", "https://ti.qq.com/hybrid-h5/intimate/launch?_wv=83886083");
        if (TextUtils.isEmpty(localamcj.jdField_b_of_type_JavaLangString)) {
          localamcj.jdField_b_of_type_JavaLangString = "https://ti.qq.com/hybrid-h5/intimate/launch?_wv=83886083";
        }
        Object localObject;
        ...
        if (paramString.has("bgImg"))
        {
          ...
          if ((localObject != null) && (((JSONObject)localObject).has("relationNo")))
          {
            ...
            if ((localJSONArray != null) && (localJSONArray.length() > 0)) {
              localamcj.jdField_c_of_type_JavaLangString = localJSONArray.getString(0);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationGuimi")))
          {
            ...
            {
              localamcj.d = localJSONArray.getString(0);
              localamcj.e = localJSONArray.getString(1);
              localamcj.f = localJSONArray.getString(2);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationJiyou")))
          {
            ...
            if ((localJSONArray != null) && (localJSONArray.length() > 2))
            {
              localamcj.g = localJSONArray.getString(0);
              localamcj.h = localJSONArray.getString(1);
              localamcj.i = localJSONArray.getString(2);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationLover")))
          {
            ...
            {
              localamcj.j = ((JSONArray)localObject).getString(0);
              localamcj.k = ((JSONArray)localObject).getString(1);
              localamcj.l = ((JSONArray)localObject).getString(2);
            }
          }
        }
        if (paramString.has("darkBgImg"))
        {
          ...
          if ((localObject != null) && (((JSONObject)localObject).has("relationGuimi")))
          {
            ...
            if ((localJSONArray != null) && (localJSONArray.length() > 2))
            {
              localamcj.m = localJSONArray.getString(0);
              localamcj.n = localJSONArray.getString(1);
              localamcj.o = localJSONArray.getString(2);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationJiyou")))
          {
            ...
            if ((localJSONArray != null) && (localJSONArray.length() > 2))
            {
              localamcj.p = localJSONArray.getString(0);
              localamcj.q = localJSONArray.getString(1);
              localamcj.r = localJSONArray.getString(2);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationLover")))
          {
            ...
            if ((localObject != null) && (((JSONArray)localObject).length() > 2))
            {
              localamcj.s = ((JSONArray)localObject).getString(0);
              localamcj.t = ((JSONArray)localObject).getString(1);
              localamcj.u = ((JSONArray)localObject).getString(2);
            }
          }
        }
        if (paramString.has("shareImg"))
        {
          ...
          if ((localObject != null) && (((JSONObject)localObject).has("relationNo")))
          {
            localJSONArray = ((JSONObject)localObject).optJSONArray("relationNo");
            if ((localJSONArray != null) && (localJSONArray.length() > 0)) {
              localamcj.v = localJSONArray.getString(0);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationGuimi")))
          {
            ...
            if ((localJSONArray != null) && (localJSONArray.length() > 2))
            {
              localamcj.w = localJSONArray.getString(0);
              localamcj.x = localJSONArray.getString(1);
              localamcj.y = localJSONArray.getString(2);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationJiyou")))
          {
            ...
            if ((localJSONArray != null) && (localJSONArray.length() > 2))
            {
              localamcj.z = localJSONArray.getString(0);
              localamcj.A = localJSONArray.getString(1);
              localamcj.B = localJSONArray.getString(2);
            }
          }
          if ((localObject != null) && (((JSONObject)localObject).has("relationLover")))
          {
            ...
            if ((localObject != null) && (((JSONArray)localObject).length() > 2))
            {
              localamcj.C = ((JSONArray)localObject).getString(0);
              localamcj.D = ((JSONArray)localObject).getString(1);
              localamcj.E = ((JSONArray)localObject).getString(2);
            }
          }
        }
        if (paramString.has("scoreAnimation")) {
          localamcj.H = paramString.optString("scoreAnimation");
        }
        if (paramString.has("scoreAnimationMd5")) {
          localamcj.I = paramString.optString("scoreAnimationMd5");
        }
        if (paramString.has("scoreRuleURL")) {
          localamcj.J = paramString.optString("scoreRuleURL");
        }
        if (paramString.has("scoreDisplayIntimateMin")) {
          localamcj.jdField_a_of_type_Int = paramString.optInt("scoreDisplayIntimateMin");
        }
        if (paramString.has("scoreDisplayFriendMin")) {
          localamcj.jdField_b_of_type_Int = paramString.optInt("scoreDisplayFriendMin");
        }
        if (paramString.has("scoreDisplayFriendMin818")) {
          localamcj.jdField_c_of_type_Int = paramString.optInt("scoreDisplayFriendMin818");
        }
        localamcj.F = paramString.optString("gifNormalUrl");
        localamcj.G = paramString.optString("gifNightUrl");
        return localamcj;
        bool = false;
      }
      return null;
