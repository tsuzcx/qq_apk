...
public class aymx
{
  ...
  {
    return a(this.jdField_a_of_type_Aymy, paramListAdapter);
  }
  
  ListAdapter a(aymy paramaymy, ListAdapter paramListAdapter)
  {
    ...
    if (paramaymy != null)
    {
      ...
      if (paramListAdapter != null) {
        localObject = new aymu(paramaymy, (BaseAdapter)paramListAdapter);
      }
    }
    return localObject;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Aymy != null) {
      this.jdField_a_of_type_Aymy.b();
    }
  }
  ...
  public void a(aymy paramaymy)
  {
    if (this.jdField_a_of_type_Aymy != null)
    {
      this.jdField_a_of_type_Aymy.a(null);
      this.jdField_a_of_type_Aymy = null;
    }
    ...
    {
      paramaymy.a(this);
      a(a(paramaymy, this.jdField_a_of_type_AndroidWidgetListAdapter));
    }
    for (;;)
    {
      this.jdField_a_of_type_Aymy = paramaymy;
      this.jdField_a_of_type_Boolean = false;
      b();
      return;
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Aymy != null;
  }
  
  public void b()
  {
    if ((a()) && (this.jdField_a_of_type_AndroidWidgetListAdapter != null)) {
      this.jdField_a_of_type_Aymy.a();
    }
  }
}
