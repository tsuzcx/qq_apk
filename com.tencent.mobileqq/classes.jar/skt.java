...
{
  private static final String jdField_a_of_type_JavaLangString = anzj.a(2131712021);
  ...
  public skt(@NonNull Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  public skt(@NonNull Context paramContext, Runnable paramRunnable)
  {
    this(paramContext, 0);
  ...
  private Drawable a()
  {
    float f = agej.a(3.0F, getContext().getResources());
  ...
  private SpannableString a()
  {
    ...
    localSpannableString.setSpan(new sku(this, Color.parseColor("#12B7F5")), i, "《QQ看点用户行为规范》".length() + i, 33);
  ...
  public static boolean a(BaseActivity paramBaseActivity, Runnable paramRunnable)
  {
    ...
    paramRunnable = new skt(paramBaseActivity, paramRunnable);
    paramRunnable.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    paramRunnable.show();
    ocd.a(null, "", "0X800992C", "0X800992C", 0, 0, "", "", "", "");
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = LayoutInflater.from(getContext()).inflate(2131560158, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBundle.findViewById(2131365076));
    this.jdField_a_of_type_AndroidWidgetTextView.setFocusable(false);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramBundle.findViewById(2131362317));
    this.jdField_a_of_type_AndroidViewView = paramBundle.findViewById(2131364599);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a());
    this.jdField_a_of_type_AndroidWidgetTextView.setMovementMethod(new skv());
    ...
    paramBundle.findViewById(2131363405).setBackgroundDrawable(localDrawable);
    setContentView(paramBundle);
    paramBundle = getWindow().getAttributes();
    paramBundle.height = -2;
    paramBundle.width = agej.a(320.0F, getContext().getResources());
