  ...
  implements oyi
{
  ...
  public oyl(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public oyl(Context paramContext, oye paramoye)
  {
  ...
  {
    return rlz.a().b(this.jdField_f_of_type_AndroidViewView.getContext());
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetImageView.getVisibility() == 0)
    {
      ...
      if (bbdh.l() - vpm.b(this.jdField_f_of_type_AndroidViewView.getContext(), 54.0F) <= localObject[1] + vpm.b(this.jdField_f_of_type_AndroidViewView.getContext(), 100.0F)) {
        break label198;
      }
      bool = true;
      if (!bool) {
      ...
      j = localObject[1] - vpm.b(this.jdField_f_of_type_AndroidViewView.getContext(), 75.0F);
      k = j;
      if (paramBoolean) {
        k = j - vpm.b(this.jdField_f_of_type_AndroidViewView.getContext(), 15.0F);
      }
      if (!paramBoolean) {
        break label225;
      }
    ...
    {
      localReadInJoyListViewGroup.a(paramBoolean, (SpannableString)localObject, bool, k, (ArticleInfo)oye.a(this.jdField_a_of_type_Oye, this.jdField_a_of_type_Int));
      ...
      bool = false;
      break label85;
      j = localObject[1] - vpm.b(this.jdField_f_of_type_AndroidViewView.getContext(), 172.0F);
      break label108;
    }
  }
  ...
  {
    return rlz.a().a(this.jdField_f_of_type_AndroidViewView.getContext());
  }
  ...
  public View a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetRoundAngleFrameLayout = ((RoundAngleFrameLayout)paramViewGroup.findViewById(2131379077));
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramViewGroup.findViewById(2131379009));
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyNickNameTextView = ((ReadInJoyNickNameTextView)paramViewGroup.findViewById(2131374770));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131365420));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131368514));
    if (rlz.a().b()) {}
    try
    {
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131379018));
      ...
      this.jdField_b_of_type_AndroidViewView = paramViewGroup.findViewById(2131375144);
      this.jdField_c_of_type_AndroidViewView = paramViewGroup.findViewById(2131379009);
      this.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131374732);
      ...
      this.h = ((TextView)paramViewGroup.findViewById(2131362044));
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramViewGroup.findViewById(2131368911));
      this.i = ((TextView)paramViewGroup.findViewById(2131361969));
      this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131361968));
  ...
  public void a(qtv paramqtv, int paramInt1, int paramInt2)
  {
    try
    {
      ArticleInfo localArticleInfo = (ArticleInfo)oye.a(this.jdField_a_of_type_Oye, this.jdField_a_of_type_Int);
      if (localArticleInfo == null) {
        return;
      }
      if ((paramqtv != null) && (paramqtv.a != null) && (paramqtv.a.innerUniqueID.equals(localArticleInfo.innerUniqueID)) && (paramInt1 >= paramInt2 - 7000L) && (rlz.a().a()) && (localArticleInfo.fusionBiuInfo != null) && (!localArticleInfo.fusionBiuInfo.b))
      {
        a(true);
        return;
      }
    }
    catch (NullPointerException paramqtv)
    {
      if (QLog.isColorLevel()) {
        QLog.e("ReadInJoyBaseAdapter", 1, paramqtv.toString());
      }
    }
  }
  ...
  {
    BaseArticleInfo localBaseArticleInfo = oye.a(this.jdField_a_of_type_Oye, this.jdField_a_of_type_Int);
    if ((rlz.a().b()) && (localBaseArticleInfo.innerUniqueID.equals(paramString)) && (paramBoolean))
    {
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
  ...
  {
    BaseArticleInfo localBaseArticleInfo = oye.a(this.jdField_a_of_type_Oye, this.jdField_a_of_type_Int);
    if ((rlz.a().b()) && (localBaseArticleInfo.innerUniqueID != null) && (localBaseArticleInfo.innerUniqueID.equals(paramString)))
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
