...
public class ajiv
  implements agzw
{
  public ajiv(FrameHelperActivity paramFrameHelperActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    agzw[] arrayOfagzw = this.a.jdField_a_of_type_ArrayOfAgzw;
    int j = arrayOfagzw.length;
    while (i < j)
    {
      agzw localagzw = arrayOfagzw[i];
      if (localagzw != null) {
        localagzw.a(paramInt);
      }
      i += 1;
    }
    this.a.d(true);
  ...
  public void a(int paramInt, float paramFloat)
  {
    ...
    if ((!this.a.getActivity().isFinishing()) && (FrameHelperActivity.a(this.a) != null) && (beeu.a()))
    {
      localObject1 = FrameHelperActivity.a(this.a).a(beeu.a);
      if (localObject1 != null) {
        ((beom)localObject1).c();
      }
    }
    if (Build.VERSION.SDK_INT >= 11) {}
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAgzw;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      if (Build.VERSION.SDK_INT < 11) {}
      localObject1 = this.a.jdField_a_of_type_ArrayOfAgzw;
      int j = localObject1.length;
      int i = 0;
      while (i < j)
      {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      agzw localagzw = arrayOfagzw[i];
      if (localagzw != null) {
        localagzw.a(paramInt, paramBoolean);
      }
      i += 1;
    }
    if (paramBoolean) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.jdField_a_of_type_AndroidViewViewGroup != null) {
      ((ImageView)this.a.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131312829)).setImageResource(0);
    }
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAgzw;
    int j = localObject1.length;
    int i = 0;
