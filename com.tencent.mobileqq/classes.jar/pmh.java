  ...
  implements AladdinConfigHandler
{
  ...
  public static int[] a()
  {
    ...
    //   0: ldc 96
    //   2: ldc 98
    //   4: invokestatic 103	bmhv:a	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    try
    {
      paramString = pku.a(paramString).entrySet().iterator();
      while (paramString.hasNext())
      {
        Object localObject2 = (Map.Entry)paramString.next();
        Object localObject1 = (String)bmhv.a("key_viola_dynamic", "");
        localObject2 = (String)((Map.Entry)localObject2).getValue();
        bmhv.a("key_viola_dynamic", localObject2);
