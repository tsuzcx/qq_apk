  ...
  implements bcxv
{
  ...
  public zzm(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = zzl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new bcxp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bcxm)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (bcxu)((bcxp)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((bcxu)localObject1).a(this);
          ((bcxu)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
