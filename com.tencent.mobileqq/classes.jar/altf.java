  ...
  extends alte
{
  ...
  {
    SharedPreferences localSharedPreferences = alnr.a();
  ...
  {
    if ((paramambl == null) || (paramAppInterface == null) || (paramContext == null))
    {
    ...
    paramContext = ((alnr)paramAppInterface.getManager(153)).a((QQAppInterface)paramAppInterface, paramAppInterface.getCurrentAccountUin(), new int[] { 2, 4 });
    if (paramContext != null)
    {
      ...
      ambc.a(paramambl, 12, paramContext);
    }
    for (;;)
    {
      return 0;
