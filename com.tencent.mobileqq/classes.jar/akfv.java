  ...
  extends alsi
{
  ...
  protected void a(String paramString)
  {
    ...
    akfo.d(this.a);
    paramString = akfo.a(this.a).getResources().getString(2131720539);
    QQToast.a(akfo.a(this.a), 1, paramString, 0).b(akfo.b(this.a));
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QQToast.a(akfo.a(this.a), 1, paramString3, 0).b(akfo.b(this.a));
      ...
      continue;
      label219:
      paramString3 = akfo.a(this.a).getResources().getString(2131719743);
      continue;
      label239:
      paramString1 = akfo.a(this.a).getResources().getString(2131692864);
      QQToast.a(akfo.a(this.a), 2, paramString1, 0).b(akfo.b(this.a));
      long l2 = baaz.a().a();
      babb.a(localStructMsg, paramInt1, paramString2, paramInt2);
      if ((l2 != 0L) && (localStructMsg != null)) {}
      try
      {
        this.a.a.a().a(aljq.M, 0, l2, localStructMsg.toByteArray());
        ...
        if (avpz.a(this.a.a, String.valueOf(localStructMsg.req_uin.get()), localStructMsg, false))
        {
        ...
        AutoRemarkActivity.a(akfo.a(this.a), 0, String.valueOf(localStructMsg.req_uin.get()), l1, paramString3);
        return;
      }
      catch (Exception paramString1)
      {
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((!paramBoolean2) || (!akfo.a(this.a))) {
      return;
    }
    String str = akfo.a(this.a).getResources().getString(2131720527);
    QQToast.a(akfo.a(this.a), 1, str, 0).b(akfo.b(this.a));
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      akfo.e(this.a);
      return;
      if ((paramBoolean2) && (akfo.a(this.a)))
      {
        paramList = akfo.a(this.a).getResources().getString(2131720534);
        QQToast.a(akfo.a(this.a), 1, paramList, 0).b(akfo.b(this.a));
      }
    }
  }
  ...
  protected void b(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      if (akfo.a(this.a) != null) {
        akfo.a(this.a).finish();
      }
      return;
    }
    QQToast.a(akfo.a(this.a), 2131699909, 0).a();
  }
