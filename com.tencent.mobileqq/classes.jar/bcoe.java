...
class bcoe
  extends nab
{
  bcoe(bcod parambcod, bcoc parambcoc) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bcoc == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0x6b6. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bcoc);
      }
    ...
    try
    {
      ...
      if (localRspBody.msg_send_flower.has())
      {
        ...
        this.jdField_a_of_type_Bcoc.a(paramArrayOfByte.uint32_product_id.get());
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    ...
    if (localRspBody.msg_throw_flower.has())
    {
      ...
      this.jdField_a_of_type_Bcoc.b(paramArrayOfByte.uint32_product_id.get());
      return;
    }
