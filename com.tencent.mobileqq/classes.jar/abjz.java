...
public class abjz
  implements ajob, ajoc
{
  private int jdField_a_of_type_Int;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<JumpActivity> jdField_a_of_type_JavaLangRefWeakReference;
  
  public abjz(JumpActivity paramJumpActivity, int paramInt, String paramString)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      airz localairz = (airz)localJumpActivity.app.getManager(153);
      ...
      localStartCheckParam.version = localairz.a(this.jdField_a_of_type_Int);
      ApolloGameUtil.a(localJumpActivity, localStartCheckParam);
      JumpActivity.a(localJumpActivity, true);
      localJumpActivity.a();
      return;
    }
    bcpw.a(BaseApplicationImpl.getApplication(), ajyc.a(2131705909), 0).a();
  ...
  public void b(boolean paramBoolean)
  {
    ...
    localWebProcessManager.a(100, new abka(this, localJumpActivity));
    return;
    bcpw.a(BaseApplicationImpl.getApplication(), ajyc.a(2131705908), 0).a();
