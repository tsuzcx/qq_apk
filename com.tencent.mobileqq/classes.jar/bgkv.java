...
class bgkv
  extends nte
{
  bgkv(bgko parambgko, bgkn parambgkn, aaik paramaaik) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bgkn == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0xdad. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bgkn);
      }
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Bgkn.a(this.jdField_a_of_type_Aaik.a);
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
