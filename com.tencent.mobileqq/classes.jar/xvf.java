...
{
  public xvf(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    while (j != this.a.jdField_a_of_type_Int)
    {
      ...
      CreateFaceToFaceDiscussionActivity.a(this.a, 1, this.a.getString(2131437162));
      return;
    }
    CreateFaceToFaceDiscussionActivity.b(this.a, 1, this.a.getString(2131437162));
  }
    ...
    for (;;)
    {
      ...
      default: 
        if (this.a.jdField_a_of_type_JavaUtilList == null)
        {
          ...
          if (this.a.jdField_a_of_type_Xvi != null)
          {
            this.a.jdField_a_of_type_Xvi.notifyDataSetChanged();
      ...
      for (;;)
      {
        ...
        return;
        CreateFaceToFaceDiscussionActivity.a(this.a).setText(this.a.getString(2131435482));
        CreateFaceToFaceDiscussionActivity.a(this.a).setContentDescription(this.a.getString(2131435482));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131435954));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131435954));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131435956));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131435956));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.a.getResources().getColor(2131494229));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838487);
        this.a.jdField_a_of_type_AndroidWidgetButton.setText("立即创建");
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131435961));
        break;
        this.a.jdField_b_of_type_Boolean = false;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131435963, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131435959));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131435959));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838487);
        break;
        this.a.jdField_b_of_type_Boolean = true;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131435962, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131435960));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131435960));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838487);
        break;
