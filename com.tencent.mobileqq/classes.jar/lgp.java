...
public abstract class lgp
{
  ...
  protected lgp(VideoAppInterface paramVideoAppInterface)
  {
  ...
  {
    if ((paramInt >= 0) && (paramInt < 16) && (paramInt < jdField_a_of_type_ArrayOfJavaLangString.length))
    {
      String str = "Business_" + jdField_a_of_type_ArrayOfJavaLangString[paramInt];
      paramContext = bhhr.b(paramContext).edit();
      paramContext.putBoolean(str, paramBoolean);
      paramContext.commit();
      lbd.h(paramString, "setPreload zzzzz  bid=" + paramInt);
      return;
    }
    lbd.h(paramString, "setPreload ERROR : bid=" + paramInt);
  }
  ...
  static boolean a(String paramString, VideoAppInterface paramVideoAppInterface, int paramInt)
  {
    ...
    {
      String str = "Business_" + jdField_a_of_type_ArrayOfJavaLangString[paramInt];
      boolean bool = bhhr.b(paramVideoAppInterface.getApplication()).getBoolean(str, false);
      lbd.f(paramString, "isPreloaded:" + str + "|" + bool);
      return bool;
    }
    lbd.h(paramString, "isPreloaded ERROR : bid=" + paramInt);
    return false;
  }
