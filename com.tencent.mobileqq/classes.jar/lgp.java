...
public class lgp
  ...
  implements lgm, lgy
{
  public static final String d = lbf.a() + 176 + File.separator;
  ...
  lgr jdField_a_of_type_Lgr = new lgr();
  private lgz jdField_a_of_type_Lgz;
  private lhc jdField_a_of_type_Lhc = new lhc();
  private lhz jdField_a_of_type_Lhz;
  private boolean jdField_a_of_type_Boolean;
  private ArrayList<lgq> b = new ArrayList();
  private String e;
  private String f;
  
  public lgp(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private MagicFaceDataEntity a(FaceItem paramFaceItem, String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      lbc.c(this.jdField_a_of_type_JavaLangString, String.format("createMagicEntity: id=%s, senderType%s.", new Object[] { paramFaceItem.getId(), Integer.valueOf(paramInt) }));
      str1 = paramFaceItem.getId();
      str2 = paramFaceItem.getType();
      if (!"multi_result".equalsIgnoreCase(paramFaceItem.getAttr())) {
        break label100;
      }
      paramString = new lgw(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
    }
    for (;;)
    {
      ...
      if ("huanlian".equalsIgnoreCase(paramFaceItem.getAttr())) {
        paramString = new lzp(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
      } else {
  ...
  private MagicFaceDataEntity a(String paramString, boolean paramBoolean)
  {
    ...
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_Lgf.a(paramString, a(paramString), b(paramString), localArrayList, false);
      lbc.e(this.jdField_a_of_type_JavaLangString, "prepareEntity FILE not exist: " + ((File)localObject).getPath());
    }
    return null;
  }
  
  private void a(long paramLong, MagicFaceDataEntity paramMagicFaceDataEntity, lgz paramlgz)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      if (localFaceItem != null)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          this.jdField_a_of_type_Lhc.a(paramLong, str, paramMagicFaceDataEntity, paramlgz, this);
        }
      }
    }
  }
  ...
  private boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() > 0)
    {
      ...
      a(paramLong, localMagicFaceDataEntity, this.jdField_a_of_type_Lgz);
  ...
  private int b()
  {
    ...
    int i = localVideoController.b(localley.d);
    if ((i == 2) || (i == 3) || (i == 4))
    {
      i = 1;
      if (i != 0) {
    ...
    do
    {
      ...
      i = 0;
      break;
      k = localVideoController.c(localley.d);
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 3)
    {
      ...
      if ((bool1) || (bool2)) {
        if ((!"0".equalsIgnoreCase(str2)) && (!"0_iOS".equalsIgnoreCase(str2)))
        {
          ...
          new mcc(l, str2, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    for (;;)
    {
      ...
      if ("STOP".equals(str1))
      {
        continue;
        if (paramInt == 1) {
          new mcc(l, paramString, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
        }
      }
    }
  }
  ...
  public FaceItem a()
  {
    if ((this.jdField_a_of_type_Lgj != null) && (((FaceItem)this.jdField_a_of_type_Lgj).isSameType("creativecop"))) {
      return (FaceItem)this.jdField_a_of_type_Lgj;
    }
    return null;
  }
      ...
      else if (paramInt == 370)
      {
        if (((JSONObject)localObject1).has("blessingTips"))
        {
          ...
          while (i < localJSONArray.length())
          {
            ...
            lgq locallgq = new lgq();
            locallgq.jdField_a_of_type_JavaLangString = localJSONObject.optString("id");
            if (localJSONObject.has("start_date")) {
              locallgq.jdField_a_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("start_date")).getTime();
            }
            if (localJSONObject.has("end_date")) {
              locallgq.jdField_b_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("end_date")).getTime();
            }
            if (localJSONObject.has("text")) {
              locallgq.jdField_b_of_type_JavaLangString = localJSONObject.getString("text");
            }
            if (localJSONObject.has("image_url")) {
              locallgq.c = localJSONObject.getString("image_url");
            }
            if (localJSONObject.has("call_time_len")) {
              locallgq.jdField_a_of_type_Int = localJSONObject.getInt("call_time_len");
            }
            if (localJSONObject.has("show_time_len")) {
              locallgq.jdField_b_of_type_Int = localJSONObject.getInt("show_time_len");
            }
            this.b.add(locallgq);
            QLog.w(this.jdField_a_of_type_JavaLangString, 1, "parseConfig, blessingTips[" + locallgq + "]");
            i += 1;
          }
        }
        ...
        {
          this.jdField_a_of_type_Lgr.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("exposure_show_time_len", 5);
          this.jdField_a_of_type_Lgr.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("exposure_call_time", 2);
          this.jdField_a_of_type_Lgr.c = ((JSONObject)localObject1).optInt("click_call_time", 2);
          this.jdField_a_of_type_Lgr.d = ((JSONObject)localObject1).optInt("click_show_time_len", 5);
          this.jdField_a_of_type_Lgr.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("exposure_show_text", this.jdField_a_of_type_Lgr.jdField_a_of_type_JavaLangString);
        }
      }
    }
  ...
  public void a()
  {
    ...
    if (locallgl != null) {
      locallgl.a(3003, this);
    }
    this.jdField_a_of_type_Lhz = ((lhz)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5));
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        ...
        this.f = null;
        a(l, null);
        if (this.jdField_a_of_type_Lhc.a()) {
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    case 2: 
      ...
      new mcd(paramLong, "onSessionStatusChanged", 5, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      lgs.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramString1);
      lgs.a(2, paramString1);
      lgs.a(2);
      return;
    }
    a(paramLong, 6101, null, Boolean.valueOf(false));
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    {
      bool2 = this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity.a((lha)localObject);
      bool1 = bool2;
      if (bool2)
      {
        bool1 = bool2;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          ((lhp)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2)).a(paramLong, this.e);
          a(paramLong, 6102, null, null);
          this.e = null;
        }
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      lgs.a(4, paramString2);
      lgs.a(4);
    } while (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13));
    ((lhe)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13)).a(l, "stopInteractiveVideo");
  }
  ...
  public boolean a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.clear();
        lbc.e(this.jdField_a_of_type_JavaLangString, "stop dequeue" + paramString);
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity = null;
        if (paramBoolean) {
          e(paramString);
        }
        ...
        {
          this.jdField_a_of_type_Lhc.b();
          lbc.e(this.jdField_a_of_type_JavaLangString, "stop " + paramString + ", mStopType =" + paramInt);
        }
      }
    }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem)
  {
    ...
    if ((paramFaceItem != null) && (paramFaceItem.isSameType("creativecop")))
    {
      ...
      ((FaceItem)this.jdField_a_of_type_Lgj).setDesc((String)localObject);
      bcst.b(null, "CliOper", "", "", "0X800A74C", "0X800A74C", 0, 0, "", "", paramFaceItem.getId(), "");
      j = b();
      if (this.jdField_a_of_type_Lhz.a(3, "creative") != 1) {
        break label282;
      }
      bool1 = true;
      i = 0;
    ...
    for (;;)
    {
      ...
      if (i != 0) {
        maf.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1010, i);
      }
      if (bool2)
      {
        this.jdField_a_of_type_AndroidOsHandler.obtainMessage(101, this.jdField_a_of_type_Lgj).sendToTarget();
        if (paramFaceItem != null)
        {
          ...
          if ((!paramFaceItem.equalsIgnoreCase("face")) && (!paramFaceItem.equalsIgnoreCase("voicesticker")))
          {
            ...
            if (localObject != null) {
              ((lgl)localObject).a(3003, paramFaceItem);
            }
          }
        }
      }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem, String paramString, boolean paramBoolean, lgz paramlgz)
  {
    boolean bool2 = true;
    if (AudioHelper.f()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, id[" + paramString + "], curData[" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity + "], isSender[" + paramBoolean + "], queue[" + this.jdField_a_of_type_JavaUtilQueue.size() + "], isPlaying[" + this.jdField_a_of_type_Lhc.a() + "], mLastPendantId[" + this.e + "], seq[" + paramLong + "]");
    }
    boolean bool1;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramFaceItem != null) || (bool3))
        {
          ...
          paramFaceItem = (lhp)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
        ...
        for (;;)
        {
          QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, step[" + i + "], mLastPendantId[" + paramlgz + "->" + this.e + "]");
          ...
          a(paramLong, (MagicFaceDataEntity)localObject, paramlgz);
          paramFaceItem = (FaceItem)localObject;
          break label269;
          label499:
          i = 2;
