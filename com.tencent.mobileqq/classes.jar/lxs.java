  ...
  implements View.OnClickListener
{
  ...
  public lxs(RedPacketGameView paramRedPacketGameView, AVActivity paramAVActivity)
  {
    this.jdField_a_of_type_ArrayOfLxo = new lxo[4];
    this.jdField_a_of_type_Lxo = new lxo();
    this.jdField_b_of_type_Lxo = new lxo();
    this.jdField_c_of_type_Lxo = new lxo();
    ...
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLxo.length)
    {
      this.jdField_a_of_type_ArrayOfLxo[n] = new lxo();
      this.jdField_a_of_type_ArrayOfLxo[n].jdField_b_of_type_Int = (n * 37 + 30);
      this.jdField_a_of_type_ArrayOfLxo[n].jdField_c_of_type_Int = 30;
      this.jdField_a_of_type_ArrayOfLxo[n].d = 37;
      this.jdField_a_of_type_ArrayOfLxo[n].e = 46;
      this.jdField_a_of_type_ArrayOfLxo[n].a(255);
      n += 1;
    }
    this.jdField_a_of_type_Lxo.jdField_c_of_type_Int = 36;
    this.jdField_a_of_type_Lxo.d = 200;
    this.jdField_a_of_type_Lxo.e = 28;
    this.jdField_a_of_type_Lxo.a(255);
    this.jdField_b_of_type_Lxo.jdField_c_of_type_Int = 36;
    this.jdField_b_of_type_Lxo.d = 200;
    this.jdField_b_of_type_Lxo.e = 28;
    this.jdField_b_of_type_Lxo.a(255);
    this.jdField_c_of_type_Lxo.jdField_c_of_type_Int = 36;
    this.jdField_c_of_type_Lxo.d = 200;
    this.jdField_c_of_type_Lxo.e = 28;
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_Lxo.jdField_b_of_type_Int = n;
      this.jdField_b_of_type_Lxo.jdField_b_of_type_Int = n;
      this.jdField_c_of_type_Lxo.jdField_b_of_type_Int = n;
      this.jdField_a_of_type_Lxo.b(this.h, this.i, 0, 0);
      this.jdField_b_of_type_Lxo.b(this.h, this.i, 0, 0);
  ...
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Lxo.a();
    int i1 = this.e * this.jdField_b_of_type_Int / this.jdField_c_of_type_Int + this.d;
    int n = ((Rect)localObject).width() + i1;
    this.jdField_c_of_type_Lxo.a(i1, ((Rect)localObject).top, n, ((Rect)localObject).bottom);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_Int != paramInt)
    {
      ...
      int i1 = paramInt;
      paramInt = i2;
      while (paramInt < this.jdField_a_of_type_ArrayOfLxo.length)
      {
        i2 = i1 / n;
        if (this.jdField_a_of_type_ArrayOfLxt != null) {
          this.jdField_a_of_type_ArrayOfLxo[paramInt].a = this.jdField_a_of_type_ArrayOfLxt[i2];
        }
        i1 %= n;
        n /= 10;
        paramInt += 1;
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLxo.length)
    {
      this.jdField_a_of_type_ArrayOfLxo[n].b(paramInt1, paramInt2, paramInt3, paramInt4);
      n += 1;
    }
    this.h = paramInt1;
    this.i = paramInt2;
  ...
  public void a(Canvas paramCanvas, Paint paramPaint)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLxo.length)
    {
      this.jdField_a_of_type_ArrayOfLxo[n].a(paramCanvas, paramPaint);
      n += 1;
    }
    this.jdField_a_of_type_Lxo.a(paramCanvas, paramPaint);
    paramCanvas.save();
    paramCanvas.clipPath(this.jdField_a_of_type_AndroidGraphicsPath);
    this.jdField_b_of_type_Lxo.a(paramCanvas, paramPaint);
    this.jdField_c_of_type_Lxo.a(paramCanvas, paramPaint);
    paramCanvas.restore();
    paramCanvas.restore();
  }
  ...
  {
    this.jdField_a_of_type_Lxo.a = new lxt(paramAVRedPacketManager.a("qav_redpacket_progressbar_bg.png"));
    this.jdField_b_of_type_Lxo.a = new lxt(paramAVRedPacketManager.a("qav_redpacket_progressbar_red.png"));
    this.jdField_c_of_type_Lxo.a = new lxt(paramAVRedPacketManager.a("qav_redpacket_progressbar_yellow.png"));
    this.jdField_a_of_type_ArrayOfLxt = paramArrayOflxt;
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLxo.length)
    {
      this.jdField_a_of_type_ArrayOfLxo[n].a = this.jdField_a_of_type_ArrayOfLxt[0];
      n += 1;
    }
  }
  ...
  public void a(boolean paramBoolean, AVRedPacketManager paramAVRedPacketManager)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
        localView.setBackgroundDrawable(mwj.a(paramAVRedPacketManager, this.jdField_a_of_type_AndroidGraphicsBitmap, 2131165958));
      }
  ...
  public void b()
  {
    this.jdField_a_of_type_Lxo.b();
    this.jdField_b_of_type_Lxo.b();
    this.jdField_c_of_type_Lxo.b();
    ...
    this.jdField_a_of_type_ArrayOfLxo = null;
    this.jdField_a_of_type_Lxo = null;
    this.jdField_b_of_type_Lxo = null;
    this.jdField_c_of_type_Lxo = null;
