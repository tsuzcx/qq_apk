  ...
  extends lwx
{
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    {
      lcl.d("QQServiceForAV", "linkToVideoProcessDeath");
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder = paramIBinder;
    }
    try
    {
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder.linkToDeath(new lxu(this), 0);
      return;
    }
    catch (RemoteException paramIBinder)
    {
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder = null;
      lcl.e("QQServiceForAV", "linkToVideoProcessDeath exception msg = " + paramIBinder.getMessage());
    }
  }
  
  public int a()
  {
    return ((askl)((QQAppInterface)this.a.a()).getManager(11)).d();
  }
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    {
      int i = bbfn.a(localQQAppInterface, bool, paramString);
  ...
  {
    paramString = ((ajvk)((QQAppInterface)this.a.a()).getManager(53)).a(paramString);
    long l = 0L;
    if (paramString != null) {
  ...
  public Bitmap a(int paramInt, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      if (paramString2 == null)
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Ajxl);
      }
      if ((paramString2 == null) && (paramBoolean2))
      {
        ...
        if (paramInt == 1)
        {
          ...
          continue;
          paramString2 = (BitmapDrawable)((ajvi)localQQAppInterface.a(6)).a(paramString1, false);
          if (paramString2 == null) {
            break label578;
          }
      ...
      for (;;)
      {
        paramString2 = baxt.b(localQQAppInterface, paramString2, b).a();
        break;
        paramString2 = baxt.a(localQQAppInterface, 200, paramString1, true).a();
        break;
        paramString2 = ((yak)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(51)).a(Long.parseLong(paramString1));
        paramString2 = DeviceHeadMgr.getInstance().getDeviceHeadByPID(paramString2.productId);
        break;
        Object localObject = (askl)localQQAppInterface.getManager(11);
        if ((localObject != null) && (paramString2 != null)) {}
        for (localObject = ((askl)localObject).c(paramString2);; localObject = null)
        {
          if (QLog.isColorLevel()) {
          ...
          break;
          paramString2 = avdy.a(localQQAppInterface, paramString2);
          break;
          if (paramInt == 3000) {
            return bbdr.h();
          }
  ...
  public Bundle a(int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
    ...
    case 4: 
      for (;;)
      {
        ...
        bool1 = bbfn.a("GetInviteFlag", paramResultReceiver, paramArrayOfByte);
        bbfn.a("GetInviteFlag", paramResultReceiver, paramArrayOfByte);
        paramBundle.putBoolean("enableInvite", bool1);
        return paramBundle;
        bbfu.a((QQAppInterface)this.a.a(), paramBundle);
      }
    case 5: 
      return bbfu.a((QQAppInterface)this.a.a(), paramBundle);
    case 6: 
      return bbfn.a((QQAppInterface)this.a.a(), paramBundle.getString("uin"));
    }
    paramArrayOfByte = paramBundle.getString("red_touch_app_id");
    paramBundle.putParcelable("red_touch_red_app_info", avpt.a(((avpq)((QQAppInterface)this.a.a()).getManager(36)).a(paramArrayOfByte)));
    return paramBundle;
  }
  ...
  public String a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if (paramInt == 26)
        {
          paramString1 = avdy.a(localQQAppInterface, paramString2);
        }
        else if (paramInt == 25)
        {
        ...
        else if (paramInt == 1)
        {
          if (!TextUtils.isEmpty(paramString2)) {
            paramString1 = bbcl.h(localQQAppInterface, str1, paramString2);
          } else {
            paramString1 = bbcl.a(localQQAppInterface, str1, false);
          }
        }
        else
        {
          ...
          paramString1 = ((yak)localQQAppInterface.a(51)).a(Long.parseLong(str1));
          if (paramString1 == null) {
            break label461;
          }
          paramString1 = ymx.a(paramString1);
        }
      }
      int i = bbcl.a(paramInt);
      if (i == -1) {}
      for (paramString1 = bbcl.b(localQQAppInterface, str1, paramInt);; paramString1 = bbcl.a(localQQAppInterface, str1, paramString2, i, 0))
      {
        ...
        {
          str2 = bbcl.b(localQQAppInterface, str1, true);
        }
        paramString1 = str2;
        ...
        localObject = (ajxn)localQQAppInterface.getManager(51);
        str2 = paramString1;
        if (localObject != null)
        {
          ...
          str2 = paramString1;
          if (localObject != null) {
            str2 = bbcl.a((Friends)localObject);
          }
        }
        if (!str1.equals(str2))
        {
  ...
  String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    for (str = paramString2;; str = paramString1)
    {
      ...
      label236:
      label248:
      for (localObject1 = ((askl)localObject1).c(str);; localObject1 = null)
      {
        if (localObject1 != null)
        {
        ...
        localObject1 = bbcl.e(paramQQAppInterface, str);
        ...
        for (;;)
        {
          ...
          if (paramString1 != null)
          {
            bbcl.a(paramQQAppInterface, str, paramString1);
            localObject2 = paramString1;
          }
          if (localObject2 != null)
          {
            paramString1 = (ajxn)paramQQAppInterface.getManager(51);
            if (paramString1 == null) {
              break label248;
            }
          }
          ...
          {
            if (paramString1 != null) {}
            for (paramString1 = bbcl.a(paramString1);; paramString1 = null)
            {
              if ((paramString1 == null) || (paramString1.equals(localObject2)))
              {
                ...
                paramQQAppInterface.addObserver(this.a.jdField_a_of_type_Ajxl);
  ...
  public String a(String paramString)
  {
    ...
    askl localaskl = (askl)((QQAppInterface)this.a.a()).getManager(11);
    if (localaskl == null)
    {
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject = (anox)QQServiceForAV.d(this.a).getManager(77);
    if (localObject != null)
    {
      anpw localanpw = (anpw)((anox)localObject).a(anpw.e());
      if (localanpw != null) {
        localanpw.a(false);
      }
    }
    if (localObject != null)
    {
      localObject = (anpy)((anox)localObject).a("qq.android.qav.video");
      if (localObject != null) {
        ((anpy)localObject).a(false);
      }
    }
  }
  ...
  public void a(int paramInt1, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Akim);
        localakhq.a(paramInt1, paramLong);
        return;
      }
      catch (Exception localException)
      {
        do
        {
          localQQAppInterface.removeObserver(this.a.jdField_a_of_type_Akim);
        } while (!QLog.isColorLevel());
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.a.jdField_b_of_type_Long = awzw.a();
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    if (localakhq != null) {
      try
      {
        localakhq.a(paramLong, Long.parseLong(paramString), paramInt);
        return;
      }
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    atbx localatbx = (atbx)localQQAppInterface.a(60);
    localQQAppInterface.addObserver(this.a.jdField_a_of_type_Atcb);
    localatbx.a(paramString);
  }
  
  public void a(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte)
  {
    mxi.a((QQAppInterface)this.a.a(), new lxt(this, paramString, paramInt2), paramArrayOfByte, paramString, paramInt1, paramInt2);
  }
  
  public void a(String paramString, long paramLong)
  {
    Object localObject = (bagr)((QQAppInterface)this.a.a()).getManager(223);
    if (localObject != null) {
      ((bagr)localObject).a(paramString);
    }
    if ((paramLong > 0L) && ((QQServiceForAV.h(this.a) instanceof QQAppInterface)))
    {
      ...
      aaod.a((QQAppInterface)localObject, localSessionInfo);
    }
  }
  ...
  {
    ((lun)QQServiceForAV.b(this.a).getManager(254)).b(paramlwk);
  }
  
  public void a(lwt paramlwt)
  {
    if (paramlwt != null) {
      this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.unregister(paramlwt);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(lwt paramlwt, String paramString)
  {
    if (paramlwt != null)
    {
      this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.register(paramlwt, paramString);
      if (QLog.isColorLevel()) {
        QLog.d("QQServiceForAV", 2, "registerCallback");
      }
      a(paramlwt.asBinder());
      paramlwt = (QQAppInterface)this.a.a();
      paramlwt.a = null;
      paramlwt.a = new WeakReference(this.a);
    }
  }
  ...
  public void a(lwz paramlwz)
  {
    ...
    localObject = (ajty)QQServiceForAV.a(this.a).getManager(59);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQServiceForAV", 2, "getAddressConfig for IQQServiceLocationCallback");
      }
      if (((ajty)localObject).a() == 1)
      {
        if (((ajty)localObject).a(((ajty)localObject).a(), true) == 0)
        {
          if (QQServiceForAV.a(this.a) == null) {
            QQServiceForAV.a(this.a, new lxo(this, (ajty)localObject, paramlwz));
          }
          for (;;)
          {
            ((ajty)localObject).c(QQServiceForAV.a(this.a));
            return;
            QQServiceForAV.a(this.a).a(paramlwz);
          }
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean, lwz paramlwz)
  {
    int i;
    if (paramBoolean) {
      i = 0;
    ...
    try
    {
      for (;;)
      {
        paramlwz.a(i, "admin_region_config");
        return;
        i = -26;
      }
    }
    catch (RemoteException paramlwz)
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("QQServiceForAV", 2, "Call onGetAddressConfig fail", paramlwz);
    }
  }
  ...
  public void a(long[] paramArrayOfLong, String paramString)
  {
    ...
    if (localakhq != null) {
      try
      {
        localakhq.a(paramArrayOfLong, Long.parseLong(paramString));
        return;
      }
  ...
  public boolean a(long paramLong)
  {
    ...
    if (localakhq != null) {
      try
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Akim);
        localakhq.a(paramLong, 0L, 2, 0, 0);
        return true;
      }
      catch (Exception localException)
      {
  ...
  {
    return ((ajxn)((QQAppInterface)this.a.a()).getManager(51)).b(paramString);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localakhq != null) {
      try
      {
        localakhq.f(paramString, paramBoolean);
        return true;
      }
  ...
  String b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((localaskl != null) && (paramString2 != null)) {}
    for (paramString2 = localaskl.c(paramString2);; paramString2 = null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramString2 = ((aveh)paramQQAppInterface.getManager(140)).a(paramString1);
      paramQQAppInterface = (avee)paramQQAppInterface.a(79);
      paramQQAppInterface.a(paramString1);
      paramQQAppInterface.a(this.a.jdField_a_of_type_Avef);
  ...
  {
    ((lun)QQServiceForAV.c(this.a).getManager(254)).a(paramlwk);
  }
  
  public void b(lwz paramlwz)
  {
    if (paramlwz == null) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        return;
        QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
        if ((localQQAppInterface.getApp() == null) || (!bbev.d(localQQAppInterface.getApp().getApplicationContext()))) {
          break;
        }
        if (QQServiceForAV.a(this.a) == null) {
          QQServiceForAV.a(this.a, new lxp());
        }
        QQServiceForAV.a(this.a).a(paramlwz);
        if (QQServiceForAV.a(this.a).a() == 1)
        {
          localQQAppInterface.addObserver(QQServiceForAV.a(this.a));
          ((ajzl)localQQAppInterface.a(3)).b();
          return;
        }
      } while (!QLog.isColorLevel());
      ...
      try
      {
        paramlwz.a(false, null);
        return;
      }
      catch (RemoteException paramlwz) {}
    } while (!QLog.isColorLevel());
    QLog.e("QQServiceForAV", 2, "Call getUserCurrentLocation fail", paramlwz);
  }
  
  public void b(boolean paramBoolean)
  {
    SharedPreferences localSharedPreferences = bbjn.a(((QQAppInterface)this.a.a()).getApplication().getApplicationContext());
  ...
  public boolean b(String paramString, int paramInt)
  {
    ...
    {
      this.a.jdField_a_of_type_Baxk = new baxk(localQQAppInterface.getApp().getApplicationContext(), localQQAppInterface);
      this.a.jdField_a_of_type_Baxk.a(this.a.jdField_a_of_type_Baxl);
    }
    if (paramInt == 25) {
      return this.a.jdField_a_of_type_Baxk.c(paramString, 16, true, false);
    }
    return this.a.jdField_a_of_type_Baxk.a(paramString, 200, true, false);
  }
  
  public long[] b(String paramString)
  {
    bagr localbagr = (bagr)((QQAppInterface)this.a.a()).getManager(223);
    if (localbagr != null) {
      return localbagr.a(paramString);
    }
    return null;
  }
  ...
  public String c(String paramString)
  {
    ...
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    paramString = ((askl)QQServiceForAV.e(this.a).getManager(11)).b(paramString);
    if (paramString == null) {
      return null;
    }
  ...
  public boolean c(String paramString)
  {
    ...
    try
    {
      ...
      bakk localbakk = (bakk)((QQAppInterface)QQServiceForAV.l(this.a)).getManager(48);
      boolean bool1 = localbakk.a(paramString, localQQAppInterface.getCurrentAccountUin());
      boolean bool2 = localbakk.a(paramString);
      boolean bool3 = localbakk.b(paramString);
      paramString = localbakk.a(paramString);
  ...
  public String d(String paramString)
  {
    ...
    localObject2 = ((ajxn)QQServiceForAV.f(this.a).getManager(51)).b(paramString);
    if (localObject2 != null)
    {
  ...
  {
    ((avpq)((QQAppInterface)this.a.a()).getManager(36)).b(paramString);
  }
  ...
  public boolean d()
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    if (QQServiceForAV.a(this.a) == null) {
      QQServiceForAV.a(this.a, new lxr(this.a));
    }
    boolean bool = axlc.a(localQQAppInterface, localQQAppInterface.getApplication().getApplicationContext(), QQServiceForAV.a(this.a));
    if (QLog.isDevelopLevel()) {
  ...
  {
    avpq localavpq = (avpq)((QQAppInterface)this.a.a()).getManager(36);
    localavpq.b(localavpq.a(paramString), "");
  }
  
  public boolean e()
  {
    if (QQServiceForAV.a(this.a) == null) {
      QQServiceForAV.a(this.a, new lxq(this.a));
    }
    biqz.a().a(1, QQServiceForAV.a(this.a), false);
    if (QLog.isDevelopLevel()) {
