...
public class lwh
  implements lpf, mjr
{
  private final lwi jdField_a_of_type_Lwi = new lwi();
  private final WeakReference<ScreenShareCtrl> jdField_a_of_type_MqqUtilWeakReference;
  
  public lwh(ScreenShareCtrl paramScreenShareCtrl)
  {
  ...
  public void a(Bitmap paramBitmap, lwf paramlwf)
  {
    ScreenShareCtrl localScreenShareCtrl = (ScreenShareCtrl)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (localScreenShareCtrl != null) {
      localScreenShareCtrl.a(paramBitmap, paramlwf);
    }
  }
  ...
  public void a(lwf paramlwf, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localScreenShareCtrl.a(paramlwf, paramInt1, paramInt2);
  ...
  {
    this.jdField_a_of_type_Lwi.a(1, paramArrayOfByte, paramInt1, paramInt2, paramlwf);
    ScreenShareCtrl localScreenShareCtrl = (ScreenShareCtrl)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (localScreenShareCtrl != null) {
      localScreenShareCtrl.a(paramArrayOfByte, paramInt1, paramInt2, paramlwf);
    }
  }
