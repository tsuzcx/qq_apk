  ...
  implements atvt
{
  ...
  public atvx(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  private String a(String paramString, int paramInt, List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBoolean) && (paramList != null) && (paramList.size() > 0))
      {
        ...
        paramString = atlb.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, paramList);
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (paramInt < i)
        {
          paramList = (atld)paramString.a.get(paramInt);
  ...
  public void a(atmc paramatmc)
  {
    ...
    {
      a(true);
      paramatmc.a(-6101, BaseApplication.getContext().getResources().getString(2131692655));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bSend, false, new atvy(this, paramatmc));
  }
  ...
  public String b()
  {
    return audf.a().c() + bkwk.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid);
  }
