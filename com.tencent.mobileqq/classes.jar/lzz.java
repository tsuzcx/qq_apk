  ...
  extends VideoLayerUIBase
{
  ...
  public lzz(VideoAppInterface paramVideoAppInterface, Context paramContext, View paramView, maa parammaa)
  {
    super(paramVideoAppInterface, paramContext, paramView);
    this.jdField_a_of_type_Maa = parammaa;
    this.t = 2;
    this.jdField_a_of_type_Mjj = mjj.a(paramContext, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvVideoController.a().N, true);
    n();
    m();
    l();
    r();
  ...
  private void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      this.jdField_a_of_type_ArrayOfMep[0].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMep[1].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMep[2].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMep[3].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfMep[4].a(Boolean.valueOf(true));
      if ((!this.jdField_a_of_type_ArrayOfMep[0].f()) || ((this.u != 0) && (this.u != 180)) || (this.jdField_a_of_type_ArrayOfMep[0].k())) {
        break label208;
      }
      if (this.u != 0) {
        break label181;
      }
      this.jdField_a_of_type_ArrayOfMep[0].a(0, 0, 0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297721));
    }
    for (;;)
    {
      this.jdField_a_of_type_Mjj.a(this.jdField_a_of_type_ComTencentAvVideoController.a(), this.jdField_a_of_type_ArrayOfMep, paramInt1, paramInt2, paramBoolean, this.u, this.o);
      return;
      label181:
      this.jdField_a_of_type_ArrayOfMep[0].a(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297721), 0, 0);
      continue;
      label208:
      this.jdField_a_of_type_ArrayOfMep[0].a(paramInt3, paramInt3, paramInt3, paramInt3);
    }
  }
  ...
  private int i()
  {
    int j = 0;
    int m;
    for (int k = 0; j < this.jdField_a_of_type_ArrayOfMep.length; k = m)
    {
      mep localmep = this.jdField_a_of_type_ArrayOfMep[j];
      String str = (String)localmep.a(0);
      m = k;
      if (localmep.a() == 0)
      {
        m = k;
  ...
  private void i(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      m = this.jdField_a_of_type_ArrayOfMep[0].f();
      float f2 = this.jdField_a_of_type_ArrayOfMep[0].d();
      n = this.jdField_a_of_type_ArrayOfMep[0].g();
      boolean bool2 = this.jdField_a_of_type_ArrayOfMep[0].i();
      ...
      if (i1 == 4)
      {
        localObject1 = this.jdField_a_of_type_ArrayOfMep[0].a();
        k = m;
        f1 = f2;
        j = n;
        bool1 = bool2;
    ...
    int m = paramInt;
    while (m < this.jdField_a_of_type_ArrayOfMep.length) {
      if ((m < this.jdField_a_of_type_ArrayOfMep.length - 1) && (this.jdField_a_of_type_ArrayOfMep[(m + 1)].a() == 0))
      {
        n = this.jdField_a_of_type_ArrayOfMep[m].d();
        int i2 = this.jdField_a_of_type_ArrayOfMep[(m + 1)].d();
        this.jdField_a_of_type_ArrayOfMep[m].c(i2);
        this.jdField_a_of_type_ArrayOfMep[(m + 1)].c(n);
        localObject2 = this.jdField_a_of_type_ArrayOfMep[m];
        this.jdField_a_of_type_ArrayOfMep[m] = this.jdField_a_of_type_ArrayOfMep[(m + 1)];
        this.jdField_a_of_type_ArrayOfMep[(m + 1)] = localObject2;
        m += 1;
      }
      else
      {
        ...
        w_();
        ((mep)localObject2).b(null);
        ((mep)localObject2).l(true);
        ((mep)localObject2).j(false);
        ((mep)localObject2).f(false);
        ((mep)localObject2).k(true);
        ((mep)localObject2).a(null, 0);
        ((mep)localObject2).a("");
      }
    }
    u();
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfMep[0].k(k);
      this.jdField_a_of_type_ArrayOfMep[0].a(f1);
      this.jdField_a_of_type_ArrayOfMep[0].j(j);
      this.jdField_a_of_type_ArrayOfMep[0].i(bool1);
      if (i1 == 4) {
        this.jdField_a_of_type_ArrayOfMep[0].a((ImageView.ScaleType)localObject1);
      }
    }
    c(false);
  }
  ...
  private int j()
  {
    ...
    int j = 0;
    while (j < this.jdField_a_of_type_ArrayOfMep.length)
    {
      mep localmep = this.jdField_a_of_type_ArrayOfMep[j];
      String str2 = (String)localmep.a(0);
      if ((localmep.a() == 0) && (!TextUtils.isEmpty(str2)) && (!str2.equals(str1))) {
        return j;
      }
      j += 1;
    }
  ...
  private void t()
  {
    if (this.jdField_a_of_type_ArrayOfMep != null)
    {
      ...
      while (j < this.jdField_a_of_type_ArrayOfMep.length)
      {
        this.jdField_a_of_type_ArrayOfMep[j].c(-1);
        j += 1;
      }
    }
  }
  ...
  private void u()
  {
    if (this.jdField_a_of_type_ArrayOfMep[0].a() == 0)
    {
      String str1 = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin();
      String str2 = (String)this.jdField_a_of_type_ArrayOfMep[0].a(0);
  ...
  void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().d == 4) {
      ...
      else
      {
        ...
        {
          this.jdField_a_of_type_ArrayOfMep[paramInt1].i(false);
          paramInt1 += 1;
        }
      }
    }
  ...
  void a(String paramString, int paramInt, Bitmap paramBitmap, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (k < 0)
    {
      ...
      if (k >= 0)
      {
        localmep = this.jdField_a_of_type_ArrayOfMep[k];
        localmep.a(0);
        w_();
        u();
        localmep.a(0, paramString);
        localmep.a(1, Integer.valueOf(paramInt));
        localmep.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
        String str = VideoLayerUI.a(paramString, paramInt);
        a(str, null);
        a(str, localmep.a());
        long l = AudioHelper.b();
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[setBackground], key[" + str + "], index[" + k + "], seq[" + l + "], " + localmep.c());
        boolean bool1 = bool2;
        if (paramString != null)
        {
          bool1 = bool2;
    ...
    if (j >= 0)
    {
      localmep = this.jdField_a_of_type_ArrayOfMep[j];
  ...
  void a(String paramString1, int paramInt1, String paramString2, float paramFloat, int paramInt2)
  {
    ...
    if (j >= 0)
    {
      paramString1 = this.jdField_a_of_type_ArrayOfMep[j];
      paramString1.a(0);
      w_();
      u();
  ...
  void a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (j < 0)
      {
        ...
        localObject = this.jdField_a_of_type_ArrayOfMep[j];
        ((mep)localObject).a(paramString, paramInt);
        ((mep)localObject).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
      }
    }
    for (;;)
    {
      try
      {
        a(str, ((mep)localObject).a());
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[RemoteHasVideo_1], key[" + str + "], index[" + j + "], " + ((mep)localObject).c());
        ...
        if (paramString != null)
        {
          ...
          paramString.a(l, this.jdField_a_of_type_Mjj.b());
          paramString.j(true);
          paramString.a(0);
          w_();
          if (this.jdField_a_of_type_ComTencentAvVideoController.a().d != 4) {
      ...
      paramString = this.jdField_a_of_type_ArrayOfMep[j];
      a(str, paramString.a());
  ...
  public void a(Observable paramObservable, Object paramObject)
  {
    ...
    case 6005: 
      ...
      {
        return;
      } while (((mcz)mct.a(paramObservable)).a != 2);
      return;
    }
    o();
  ...
  boolean a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (j < 0)
      {
        ...
        if (k >= 0)
        {
          localObject3 = this.jdField_a_of_type_ArrayOfMep[k];
          ((mep)localObject3).a(0, str2);
          ((mep)localObject3).a(1, Integer.valueOf(1));
          ((mep)localObject3).a(str2);
        }
        try
        {
          GraphicRenderMgr.getInstance().setAccountUin(str2);
          a(str1, ((mep)localObject3).a());
        ...
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[LocalHasVideo_1], key[" + str1 + "], index[" + k + "], log[" + localObject1 + "], " + ((mep)localObject3).c());
    ...
    for (;;)
    {
      ...
      return true;
      localObject3 = this.jdField_a_of_type_ArrayOfMep[j];
      a(str1, ((mep)localObject3).a());
      QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[LocalHasVideo_2], key[" + str1 + "], index[" + j + "], " + ((mep)localObject3).c());
      this.jdField_a_of_type_ComTencentAvVideoController.a(l, this.jdField_a_of_type_ComTencentAvVideoController.a().d, false, false);
      label566:
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("SmallScreenVideoLayerUI", 1, "layoutVideoView, virtical[" + paramBoolean + "], sessionType[" + locallff.d + "], width[" + j + "], height[" + k + "]");
    }
    this.jdField_a_of_type_ArrayOfMep[0].a(0, 0, 0, 0);
    this.jdField_a_of_type_ArrayOfMep[0].b(0, 0, j, k);
    ...
    if (a(locallff))
    {
      ...
      {
        paramBoolean = bool;
        localmjj.a(arrayOfmep, j, k, m, n, i1, paramBoolean);
        lir.b(k, j);
      }
    }
    for (;;)
  ...
  {
    super.g(paramInt);
    if (this.jdField_a_of_type_Mjj.a() != paramInt)
    {
      this.jdField_a_of_type_Mjj = mjj.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, true);
      c(true);
      paramInt = 0;
      while (paramInt < this.jdField_a_of_type_ArrayOfMep.length)
      {
        this.jdField_a_of_type_ArrayOfMep[paramInt].d(this.jdField_a_of_type_Mjj.b());
        a(-1049L, this.jdField_a_of_type_ArrayOfMep[paramInt]);
        paramInt += 1;
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_Mjj.a(this.jdField_a_of_type_ArrayOfMep, b(), c(), paramInt, this.n, this.o);
  }
  ...
  public void n()
  {
    ...
    while (j < this.jdField_a_of_type_ArrayOfMep.length)
    {
      this.jdField_a_of_type_ArrayOfMep[j].m(true);
      j += 1;
    }
  }
  ...
  void w_()
  {
    ...
    if (this.i != j)
    {
      ...
      if (this.jdField_a_of_type_Maa != null) {
        this.jdField_a_of_type_Maa.a(this.i);
      }
    }
  }
}
