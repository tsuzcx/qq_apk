...
public class aaek
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2, int paramInt3, Bitmap.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = new gx().a(paramString, paramInt1, paramInt1, (Map)localObject);
        if (paramString == null) {
          break;
        }
        j = paramString.a();
  ...
  {
    return aaed.c("certified_account_download_pics");
  }
  ...
  public static String a(long paramLong)
  {
    ...
    if (((Time)localObject1).yearDay == i - 1) {
      return BaseApplicationImpl.getApplication().getString(2131719411);
    }
    return ((Time)localObject1).month + 1 + BaseApplicationImpl.getApplication().getString(2131693745) + ((Time)localObject1).monthDay + BaseApplicationImpl.getApplication().getString(2131691294);
  }
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    //   38: iconst_2
    //   39: invokestatic 226	bhkv:encodeToString	([BI)Ljava/lang/String;
    //   42: astore_0
    //   43: aload_0
    //   44: astore_1
    //   45: aload_2
  ...
  {
    a(paramFile, paramString, aaed.a);
  }
