...
public class aidx
  extends aimu
{
  public aidx(RecentMemberInnerFrame paramRecentMemberInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (aidy)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramView = new aidy(this.a, null);
      paramViewGroup = this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getLayoutInflater().inflate(2131562408, paramViewGroup, false);
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramViewGroup.findViewById(2131364193));
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localRecentUser.uin))
    {
      ...
      if (AppSetting.d)
      {
        ...
        paramViewGroup.setContentDescription((String)localObject + ajyc.a(2131713198));
      }
    }
    for (;;)
    {
      ...
      break label249;
      label344:
      paramViewGroup.setContentDescription((String)localObject + ajyc.a(2131713195));
    }
  }
}
