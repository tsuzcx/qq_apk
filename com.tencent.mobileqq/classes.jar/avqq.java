...
{
  private static final avqq jdField_a_of_type_Avqq = new avqq();
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  
  public static avqq a()
  {
    return jdField_a_of_type_Avqq;
  }
  ...
  {
    alhp.a(paramBaseActivity, 0L, 4096L, 1);
  }
  
  void a(QQAppInterface paramQQAppInterface, algc paramalgc, AbsListView paramAbsListView, String paramString)
  {
    int i;
    ...
    for (;;)
    {
      ...
      while (j < k + 1)
      {
        Object localObject = paramalgc.getItem(j);
  ...
  {
    oez localoez = oez.a();
    oeq localoeq = localoez.a(paramString1);
    if ((localoeq != null) && (avqu.a(paramView)) && (paramString2.equals(localoeq.c)))
    {
      ...
      if (paramString2 != null)
      {
        ...
        if ((paramString1 != null) && (paramString1.size() > 0))
        {
          ...
          if ("false".equals(paramString1.getExtInfoFromExtStr("recent_list_advertisement_message_first_report")))
          {
            ...
            if ((localoeq != null) && (localoeq.jdField_a_of_type_Oes != null))
            {
              bdla.a(paramQQAppInterface, "dc00898", "", localoeq.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8008F5D", "0X8008F5D", 0, 0, localoeq.jdField_a_of_type_Oes.c, String.valueOf(((Integer)paramView.getTag()).intValue() + 1), ofj.a(), localoeq.jdField_a_of_type_Oes.b);
              bdla.a(paramQQAppInterface, "dc00898", "", localoeq.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8008F5C", "0X8008F5C", 0, 0, localoeq.jdField_a_of_type_Oes.c, "", ofj.a(), localoeq.jdField_a_of_type_Oes.b);
            }
          }
        }
      }
      if ((localoeq != null) && (!localoeq.jdField_a_of_type_Boolean))
      {
        localoeq.jdField_a_of_type_Boolean = true;
        if (QLog.isColorLevel()) {
          QLog.d("AdvertisementRecentUserManager", 2, "do exposure Report");
        }
        a(localoeq);
        localoez.a(paramQQAppInterface, 1, localoeq);
        if ((localoeq != null) && (localoeq.jdField_a_of_type_Oes != null)) {
          bdla.a(paramQQAppInterface, "dc00898", "", localoeq.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8008F5F", "0X8008F5F", 0, 0, localoeq.jdField_a_of_type_Oes.c, "", "", localoeq.jdField_a_of_type_Oes.b);
        }
      }
    }
  }
  
  public void a(QQAppInterface paramQQAppInterface, oeq paramoeq)
  {
    if (paramoeq != null) {
      bdla.a(paramQQAppInterface, "dc00898", "", paramoeq.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8009102", "0X8009102", 0, 0, paramoeq.jdField_a_of_type_Oes.c, "", ofj.a(), paramoeq.jdField_a_of_type_Oes.b);
    }
  ...
  {
    if ((paramoeq == null) || (paramoeq.jdField_a_of_type_Oes == null)) {
      return;
    }
    Message localMessage = Message.obtain();
    localMessage.what = 3;
    localMessage.obj = paramoeq.jdField_a_of_type_Oes.e;
    this.jdField_a_of_type_AndroidOsHandler.sendMessage(localMessage);
  }
  
  public void a(oeq paramoeq, Activity paramActivity, AppInterface paramAppInterface)
  {
    boolean bool;
    if ((paramActivity == null) || (paramoeq == null)) {
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      break label55;
      int i = 0;
      switch (paramoeq.jdField_a_of_type_Oes.d)
      {
      }
      for (;;)
      {
        ...
        {
          bdla.b(null, "dc00898", "", paramoeq.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X80090FE", "0X80090FE", 0, 0, paramoeq.jdField_a_of_type_Oes.c, "", ofj.a(), paramoeq.jdField_a_of_type_Oes.b);
          a((BaseActivity)paramActivity);
          i = 1;
          continue;
          bdla.b(null, "dc00898", "", paramoeq.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8009101", "0X8009101", 0, 0, paramoeq.jdField_a_of_type_Oes.c, "", ofj.a(), paramoeq.jdField_a_of_type_Oes.b);
          bdla.b(null, "dc00898", "", paramoeq.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8009100", "0X8009100", 0, 0, paramoeq.jdField_a_of_type_Oes.c, "", ofj.a(), paramoeq.jdField_a_of_type_Oes.b);
          if (paramAppInterface == null)
          {
            if (!QLog.isColorLevel()) {
              break;
            }
            paramoeq = new StringBuilder().append("app is null : ");
            if (paramAppInterface == null) {}
          ...
          b(paramoeq, paramActivity, paramAppInterface);
          i = 1;
        }
      }
    }
  ...
  public void a(oeq paramoeq, QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2)
  {
    if ((paramoeq == null) || (paramoeq.jdField_a_of_type_Oes == null)) {
      QLog.e("ImaxAdNetPresenter", 1, "doIMaxServiceRequest error " + paramoeq);
    }
    ...
    do
    {
      ...
      localObject = paramoeq.jdField_a_of_type_Oes.c;
      l = Long.parseLong(localAppRuntime.getAccount());
      if (paramInt2 == 2)
      {
        paramoeq = new IMaxService.IgnoreADMsg();
        paramoeq.uint64_uin.set(l);
        paramoeq.str_ad_id.set((String)localObject);
        localReqBody.msg_ignoreAD.set(paramoeq);
        localReqBody.int32_type.set(2);
        paramoeq = new NewIntent(BaseApplicationImpl.getApplication(), nta.class);
        paramQQAppInterface = new avqr(this, paramInt1);
        paramQQAppInterface.b = 2;
        paramoeq.putExtra("cmd", "iMaxServiceSvc.IgnoreADMsg");
        paramoeq.putExtra("data", localReqBody.toByteArray());
        paramoeq.putExtra("isResend", false);
        paramoeq.setObserver(paramQQAppInterface);
        localAppRuntime.startServlet(paramoeq);
        return;
      }
    } while (paramInt2 != 1);
    ...
    Object localObject = new NewIntent(BaseApplicationImpl.getApplication(), nta.class);
    paramoeq = new avqr(this, paramoeq, paramQQAppInterface);
    paramoeq.b = 2;
    ...
    ((NewIntent)localObject).setObserver(paramoeq);
    localAppRuntime.startServlet((NewIntent)localObject);
  }
  
  void b(QQAppInterface paramQQAppInterface, algc paramalgc, AbsListView paramAbsListView, String paramString)
  {
    int i;
    if ((paramAbsListView != null) && (paramalgc != null) && (paramQQAppInterface != null))
    {
  ...
  {
    oeq localoeq2 = avqs.a().b(paramString1);
    ...
    if (localoeq2 == null)
    {
      ...
      localoeq1 = oeq.a(avqu.b(paramQQAppInterface.getCurrentUin(), paramString1));
      if (localoeq1 == null) {
        if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        return;
        avqs.a().a(localoeq1);
      } while ((localoeq1 == null) || (!avqu.a(paramView)) || (!paramString2.equals(localoeq1.c)));
      paramString2 = paramQQAppInterface.getMessageFacade();
      if (paramString2 != null)
      {
        paramString1 = paramString2.getMsgList(paramString1, paramInt);
        if ((paramString1 != null) && (paramString1.size() > 0))
        {
          ...
          if ("false".equals(paramString1.getExtInfoFromExtStr("recent_list_advertisement_message_first_report")))
          {
            ...
            if ((localoeq1 != null) && (localoeq1.jdField_a_of_type_Oes != null)) {
              bdla.a(paramQQAppInterface, "dc00898", "", localoeq1.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8008F5D", "0X8008F5D", 0, 0, localoeq1.jdField_a_of_type_Oes.c, String.valueOf(((Integer)paramView.getTag()).intValue() + 1), ofj.a(), localoeq1.jdField_a_of_type_Oes.b);
            }
          }
        }
      }
    } while ((localoeq1 == null) || (localoeq1.jdField_a_of_type_Boolean) || (localoeq1.jdField_a_of_type_Oes == null));
    if (localoeq1.a())
    {
      a(localoeq1, paramQQAppInterface, -1, 1);
      avqu.b(paramQQAppInterface.getCurrentUin(), localoeq1.jdField_a_of_type_JavaLangString, localoeq1.a());
    }
    bdla.a(paramQQAppInterface, "dc00898", "", localoeq1.jdField_a_of_type_Oes.jdField_a_of_type_JavaLangString, "0X8008F5F", "0X8008F5F", 0, 0, localoeq1.jdField_a_of_type_Oes.c, "", "", localoeq1.jdField_a_of_type_Oes.b);
  }
  
  public void b(oeq paramoeq)
  {
    if ((paramoeq == null) || (paramoeq.jdField_a_of_type_Oes == null)) {
      return;
    }
    Message localMessage = Message.obtain();
    localMessage.what = 4;
    localMessage.obj = paramoeq.jdField_a_of_type_Oes.r;
    this.jdField_a_of_type_AndroidOsHandler.sendMessage(localMessage);
  }
  
  public void b(oeq paramoeq, Activity paramActivity, AppInterface paramAppInterface)
  {
    if ((!TextUtils.isEmpty(paramoeq.jdField_a_of_type_Oes.q)) && (paramoeq.jdField_a_of_type_Oes.f != -1)) {
      bdej.a(paramActivity, "1", "1", "1", "1", "1", "1", paramoeq.jdField_a_of_type_Oes.q, "" + paramoeq.jdField_a_of_type_Oes.f, "1", "1", "", "", "", "", 108);
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          b((QQAppInterface)((WeakReference)paramMessage.get("key_app")).get(), (algc)((WeakReference)paramMessage.get("key_adapter")).get(), (AbsListView)((WeakReference)paramMessage.get("key_listview")).get(), (String)localObject);
          return true;
          localObject = paramMessage.getData();
        } while (localObject == null);
        Object localObject = ((Bundle)localObject).getString("key_ad_id");
        paramMessage = (HashMap)paramMessage.obj;
        a((QQAppInterface)((WeakReference)paramMessage.get("key_app")).get(), (algc)((WeakReference)paramMessage.get("key_adapter")).get(), (AbsListView)((WeakReference)paramMessage.get("key_listview")).get(), (String)localObject);
        return true;
