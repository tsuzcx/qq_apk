...
public class bbiy
  extends anxt
{
  public bbiy(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698582));
        this.a.g.setOnClickListener(new bbja(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new bbjb(this));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<bbmx> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      {
        if (this.a.isAdded()) {
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(BitmapFactory.decodeResource(this.a.getResources(), 2130842283));
        }
        if (2 == paramInt)
        {
          paramString1 = this.a.getString(2131717615);
      ...
      catch (OutOfMemoryError paramString1)
      {
        for (;;)
        {
          ...
          continue;
          paramString1 = anni.a(2131698579);
        }
      }
    }
            ...
            if ((paramList == null) || (paramList.isEmpty()))
            {
              ...
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Ajcl == null)
                {
                  ...
                  paramArrayOfByte.setText(anni.a(2131698584));
                  ...
                  paramArrayOfByte.setText(anni.a(2131698590));
                  paramArrayOfByte.setBackgroundResource(2130838759);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698579));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bbiz(this, paramString2));
