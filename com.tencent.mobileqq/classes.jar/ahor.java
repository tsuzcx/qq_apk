...
public class ahor
  extends alox
{
  private ahor(FriendFragment paramFriendFragment) {}
  ...
  protected void onSetSpecialCareSwitch_global(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    if (this.a.jdField_a_of_type_Akdd != null) {
      this.a.jdField_a_of_type_Akdd.notifyDataSetChanged();
    }
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, alpo.a(2131705247), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, alpo.a(2131705248), 0).a();
          return;
        }
      }
      ...
      if (FriendFragment.a(this.a))
      {
        if (FriendFragment.b(this.a))
        {
          ...
          if (this.a.jdField_a_of_type_Ahoj != null) {
            this.a.jdField_a_of_type_Ahoj.a(this.a.b(), paramBoolean1, null);
          }
        }
  ...
  protected void onUpdateSpecialCareList(boolean paramBoolean1, boolean paramBoolean2, List<SpecialCareInfo> paramList)
  {
    ...
    if ((paramBoolean1) && (this.a.jdField_a_of_type_Akdd != null)) {
      this.a.jdField_a_of_type_Akdd.notifyDataSetChanged();
    }
  }
}
