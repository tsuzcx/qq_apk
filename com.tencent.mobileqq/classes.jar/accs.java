...
public final class accs
  extends acko
{
  accs(AppInterface paramAppInterface1, Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface2)
  {
  ...
  public boolean shouldOverrideUrlLoading(@NotNull WebView paramWebView, @Nullable String paramString)
  {
    ...
    if (paramString != null)
    {
      if (!accm.a(this.jdField_a_of_type_Accm).a(paramString, accm.a(this.jdField_a_of_type_Accm))) {
