  ...
  implements Animatable
{
  ...
  Property<bput, Float> jdField_a_of_type_AndroidUtilProperty = new bpuu(this, Float.class, "backScale");
  private String jdField_a_of_type_JavaLangString;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float;
  private int jdField_b_of_type_Int = 0;
  Property<bput, Integer> jdField_b_of_type_AndroidUtilProperty = new bpuv(this, Integer.class, "backAlpha");
    ...
    for (;;)
    {
      ...
      try
      {
        if ("1/4".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841481);
        }
        if ("1/2".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841480);
        }
        if ("1x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841482);
        }
        if ("2x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841483);
        }
        if ("4x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841484);
        }
        if (PickerContainer.jdField_a_of_type_JavaLangString.equals(paramString))
        {
          paramString = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841485);
          return paramString;
        }
      }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bpuw(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bpux(this));
