  ...
  extends bbsv
{
  ...
  static bbuc jdField_a_of_type_Bbuc;
  ...
  public int a;
  public Camera a;
  apiy jdField_a_of_type_Apiy = apiy.a();
  bbue jdField_a_of_type_Bbue = new bbue(this);
  bbuf jdField_a_of_type_Bbuf;
  ...
  static
  {
    if (!bbuc.class.desiredAssertionStatus()) {}
  ...
  {
    if (jdField_a_of_type_Bbuc == null) {}
    try
    {
      if (jdField_a_of_type_Bbuc == null) {
        jdField_a_of_type_Bbuc = new bbuc();
      }
      return jdField_a_of_type_Bbuc;
    }
    finally {}
  }
  
  private bbuf a(List<Camera.Size> paramList, int paramInt1, int paramInt2)
  {
    int j = -1;
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        localbbuf.jdField_b_of_type_Int = paramInt2;
        localbbuf.jdField_a_of_type_Int = i;
        if (localbbuf.jdField_a_of_type_Int / 4 == localbbuf.jdField_b_of_type_Int / 3)
        {
          if (QLog.isColorLevel()) {
  ...
  private bbuf a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((localSize != null) && (localSize.width >= paramInt1) && (localSize.height >= paramInt2) && (localSize.width / localSize.height >= d1))
        {
          ...
          if (l2 < l1)
          {
            localbbuf.jdField_a_of_type_Int = localSize.width;
            localbbuf.jdField_b_of_type_Int = localSize.height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (localSize.width < localbbuf.jdField_a_of_type_Int))
          {
            localbbuf.jdField_a_of_type_Int = localSize.width;
            localbbuf.jdField_b_of_type_Int = localSize.height;
          }
    ...
    if (((localbbuf.jdField_a_of_type_Int <= 0) || (localbbuf.jdField_b_of_type_Int <= 0)) && (paramList != null) && (!paramList.isEmpty()))
    {
      localIterator = paramList.iterator();
      l1 = 0L;
      if (localIterator.hasNext())
    ...
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSize[self-adaption] cSize.width=" + localbbuf.jdField_a_of_type_Int + "  cSize.height=" + localbbuf.jdField_b_of_type_Int);
    }
    if ((localbbuf.jdField_a_of_type_Int > 0) && (localbbuf.jdField_b_of_type_Int > 0)) {
      return localbbuf;
    }
    if ((paramList != null) && (!paramList.isEmpty()) && (paramList.get(0) != null))
    {
      localbbuf.jdField_a_of_type_Int = ((Camera.Size)paramList.get(0)).width;
      localbbuf.jdField_b_of_type_Int = ((Camera.Size)paramList.get(0)).height;
      return localbbuf;
    }
    return null;
  }
  
  private bbuf a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == 0)
      {
        ...
        if (paramList.hasNext())
        {
          localObject3 = (bbuf)paramList.next();
          if (localObject3 == null) {
            break label885;
          }
          paramInt1 = Math.max(((bbuf)localObject3).jdField_a_of_type_Int, ((bbuf)localObject3).jdField_b_of_type_Int);
          paramInt2 = Math.min(((bbuf)localObject3).jdField_a_of_type_Int, ((bbuf)localObject3).jdField_b_of_type_Int);
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (localObject1 != null)
          {
            ...
            for (;;)
            {
              ...
              QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getHighVersionPreviewSizeV2 secend: width=" + ((bbuf)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int + " height=" + ((bbuf)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int + " w/h=" + ((bbuf)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int / ((bbuf)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int);
              paramInt1 += 1;
            }
            f2 = 10000.0F;
          }
        ...
        if (((List)localObject1).size() == 0)
        {
          ...
          while (paramList.hasNext())
          {
            ...
            {
              paramInt1 = Math.max(((bbuf)localObject2).jdField_a_of_type_Int, ((bbuf)localObject2).jdField_b_of_type_Int);
              paramInt2 = Math.min(((bbuf)localObject2).jdField_a_of_type_Int, ((bbuf)localObject2).jdField_b_of_type_Int);
        ...
        if (((List)localObject1).size() > 0)
        {
          ...
          if ((localObject1 == null) || (((bbuf)localObject1).jdField_a_of_type_Int * ((bbuf)localObject1).jdField_b_of_type_Int <= paramList.jdField_a_of_type_Int * paramList.jdField_b_of_type_Int)) {
            break label882;
          }
  ...
  private int c()
  {
    ...
    float f = i * 1.0F / 8.0F;
    int j = (int)(this.jdField_a_of_type_Bbuf.jdField_b_of_type_Int * this.jdField_a_of_type_Bbuf.jdField_a_of_type_Int * f);
    if (QLog.isColorLevel()) {
      ...
      try
      {
        for (;;)
        {
          ...
          if (VersionUtils.isGingerBread())
          {
            ...
            bmbx.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:" + this.jdField_a_of_type_Int);
            bmbx.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:currentCount= " + j);
          }
          for (this.jdField_a_of_type_AndroidHardwareCamera = Camera.open(this.jdField_a_of_type_Int);; this.jdField_a_of_type_AndroidHardwareCamera = Camera.open())
          {
            ...
            if (bbua.a().a(this.jdField_a_of_type_AndroidHardwareCamera)) {
              break label321;
            }
            if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            i = 3;
            break label83;
            this.jdField_a_of_type_Bbue = new bbue(this);
  ...
  public bbuf a(int paramInt)
  {
    Object localObject2 = bbua.a().a();
    int i;
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      for (paramInt = 2147483647; ((Iterator)localObject1).hasNext(); paramInt = i)
      {
        ...
        if (((Camera.Size)localObject2).width < paramInt)
        {
          ...
          localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
          localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
        }
      }
    }
  ...
  public bbuf a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    Object localObject2 = bbua.a().a();
    ...
    label400:
    int i = bbsu.jdField_c_of_type_Int;
    int j = bbsu.d;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt2 > 0)
      {
        localbbuf.jdField_b_of_type_Int = j;
        localbbuf.jdField_a_of_type_Int = paramInt2;
        if ((bbub.a()) && (a((ArrayList)localObject3, i, j))) {
          localbbuf.jdField_a_of_type_Int = i;
        }
        return localbbuf;
      }
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject5 != null) && (a(paramInt1, paramInt3, paramInt4, ((Camera.Size)localObject5).width, ((Camera.Size)localObject5).height)))
        {
          ...
          if (l2 < l1)
          {
            localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (((Camera.Size)localObject5).width < localbbuf.jdField_a_of_type_Int))
          {
            localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
          }
      ...
      for (;;)
      {
        ...
        if (paramInt1 > 0)
        {
          localbbuf.jdField_b_of_type_Int = i;
          localbbuf.jdField_a_of_type_Int = paramInt1;
          return localbbuf;
        }
        if ((localbbuf.jdField_a_of_type_Int <= 0) || (localbbuf.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (localObject4 != null)
            {
              ...
              if (l2 < l1)
              {
                localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject4).width < localbbuf.jdField_a_of_type_Int))
              {
                localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
              }
        ...
        if ((localbbuf.jdField_a_of_type_Int <= 0) || (localbbuf.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject3 != null) && (a(320, paramInt3, paramInt4, ((Camera.Size)localObject3).width, ((Camera.Size)localObject3).height)))
            {
              ...
              if (l2 < l1)
              {
                localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject3).width < localbbuf.jdField_a_of_type_Int))
              {
                localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
              }
        ...
        if ((localbbuf.jdField_a_of_type_Int <= 0) || (localbbuf.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject2).width < localbbuf.jdField_a_of_type_Int))
              {
                localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
                localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
              }
        ...
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getFullVideoPreviewSize[self-adaption] cSize.width=" + localbbuf.jdField_a_of_type_Int + "  cSize.height=" + localbbuf.jdField_b_of_type_Int);
        }
        if ((localbbuf.jdField_a_of_type_Int > 0) && (localbbuf.jdField_b_of_type_Int > 0)) {
          return localbbuf;
        }
  ...
  public bbuf a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_AndroidHardwareCamera == null)) {
      throw new AssertionError();
    }
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Bbuf == null)) {
      throw new AssertionError();
    }
    if (a() == null) {
      return null;
    ...
    bbuf localbbuf = new bbuf();
    Object localObject1 = bbua.a().b();
    if ((localObject1 == null) || (((List)localObject1).isEmpty())) {
      return null;
    }
    Object localObject2 = new bbuf();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localSize != null)
      {
        ...
        if (localSize.width >= paramInt1)
        {
          ...
          {
            f2 = Math.abs(f4 - f3);
            ((bbuf)localObject2).jdField_a_of_type_Int = localSize.width;
            ((bbuf)localObject2).jdField_b_of_type_Int = localSize.height;
          }
        }
        f1 = f2;
      }
    }
    if ((localArrayList.isEmpty()) && (((bbuf)localObject2).jdField_a_of_type_Int >= paramInt1))
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "getPictureSize: width=" + ((bbuf)localObject2).jdField_a_of_type_Int + " height=" + ((bbuf)localObject2).jdField_b_of_type_Int + " w/h=" + ((bbuf)localObject2).jdField_a_of_type_Int / ((bbuf)localObject2).jdField_b_of_type_Int);
      }
      return localObject2;
    }
    if ((localArrayList.isEmpty()) && (((List)localObject1).size() > 0))
    {
      localbbuf.jdField_a_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).width;
      localbbuf.jdField_b_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).height;
      return localbbuf;
    }
    ...
    if (paramInt5 == -1)
    {
      ...
      {
        localObject2 = (Camera.Size)((Iterator)localObject1).next();
        if (localbbuf.jdField_a_of_type_Int < ((Camera.Size)localObject2).width)
        {
          localbbuf.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
          localbbuf.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
        }
    ...
    while (localbbuf.jdField_a_of_type_Int == 0)
    {
      return null;
      localbbuf = a(paramInt3, paramInt4, paramInt5, localArrayList);
    }
    return localbbuf;
  }
  
  public bbuf a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeV2: dstwidth=" + paramInt1 + "  dstheight=" + paramInt2);
    }
    Object localObject = bbua.a().a();
    ...
    bbuf localbbuf = a((List)localObject, paramInt1, paramInt2);
    if (localbbuf != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      }
      localObject = localbbuf;
      if (paramBoolean)
      {
        aktv.a(2, paramInt1, paramInt2, localbbuf.jdField_a_of_type_Int, localbbuf.jdField_b_of_type_Int);
        localObject = localbbuf;
      }
    }
    do
    {
      ...
      {
        return localObject;
        localbbuf = a((List)localObject, 960, 720);
        if (localbbuf == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      aktv.a(3, paramInt1, paramInt2, localbbuf.jdField_a_of_type_Int, localbbuf.jdField_b_of_type_Int);
      return localbbuf;
      localbbuf = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localbbuf;
    } while (!paramBoolean);
    if (localbbuf == null)
    {
    ...
    label379:
    for (paramInt4 = j;; paramInt4 = localbbuf.jdField_b_of_type_Int)
    {
      aktv.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localbbuf;
      paramInt3 = localbbuf.jdField_a_of_type_Int;
      break;
    }
  }
  
  public bbuf a(int paramInt1, int paramInt2, int paramInt3, List<Camera.Size> paramList)
  {
  ...
  @TargetApi(17)
  public void a(File paramFile, Rect paramRect, akwr paramakwr, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    if (this.jdField_a_of_type_AndroidHardwareCamera == null) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidHardwareCamera.takePicture(null, null, null, new bbud(this, paramInt1, l, paramFile, paramRect, paramakwr, paramBoolean, paramInt2));
          return;
        }
  ...
  public boolean a(bbuf parambbuf)
  {
    ...
    try
    {
      localParameters.setPreviewSize(parambbuf.jdField_a_of_type_Int, parambbuf.jdField_b_of_type_Int);
      this.jdField_a_of_type_Bbuf = parambbuf;
      boolean bool = a(localParameters);
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] setParamsPreviewSize, result = " + bool + ",size.width = " + parambbuf.jdField_a_of_type_Int + ",size.height = " + parambbuf.jdField_b_of_type_Int);
      }
      return bool;
    }
    catch (Exception parambbuf)
    {
      parambbuf.printStackTrace();
    }
    return false;
  }
  
  public boolean a(bbut parambbut)
  {
    Camera.Parameters localParameters = a();
    if (localParameters == null)
    {
    ...
    localParameters.setPreviewFormat(parambbut.jdField_a_of_type_Int);
    localParameters.setPreviewSize(parambbut.jdField_a_of_type_Bbuf.jdField_a_of_type_Int, parambbut.jdField_a_of_type_Bbuf.jdField_b_of_type_Int);
    localParameters.setPreviewFpsRange(parambbut.jdField_b_of_type_Int, parambbut.jdField_c_of_type_Int);
    if (parambbut.jdField_a_of_type_Boolean) {
      localParameters.setPictureSize(parambbut.jdField_b_of_type_Bbuf.jdField_a_of_type_Int, parambbut.jdField_b_of_type_Bbuf.jdField_b_of_type_Int);
    }
    boolean bool = a(localParameters);
    if (bool)
    {
      this.jdField_b_of_type_Int = parambbut.jdField_a_of_type_Int;
      this.jdField_a_of_type_Bbuf = parambbut.jdField_a_of_type_Bbuf;
      this.jdField_a_of_type_ArrayOfInt = new int[] { parambbut.jdField_b_of_type_Int, parambbut.jdField_c_of_type_Int };
      this.jdField_b_of_type_Bbuf = parambbut.jdField_b_of_type_Bbuf;
    }
    return bool;
  }
  ...
  public bbuf[] a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    bbuf localbbuf1 = a(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localbbuf1 != null)
    {
      arrayOfbbuf[0] = localbbuf1;
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 preview=" + localbbuf1.jdField_a_of_type_Int + " " + localbbuf1.jdField_b_of_type_Int);
      }
      bbuf localbbuf2 = a(localbbuf1.jdField_a_of_type_Int, localbbuf1.jdField_b_of_type_Int, paramInt3, paramInt4, 1);
      arrayOfbbuf[1] = localbbuf2;
      if (localbbuf2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 picture=" + localbbuf2.jdField_a_of_type_Int + " " + localbbuf2.jdField_b_of_type_Int);
        }
        aktv.a(true, localbbuf1.jdField_a_of_type_Int, localbbuf1.jdField_b_of_type_Int, localbbuf2.jdField_a_of_type_Int, localbbuf2.jdField_b_of_type_Int);
      }
    }
    else
    {
    ...
    aktv.a(true, localbbuf1.jdField_a_of_type_Int, localbbuf1.jdField_b_of_type_Int, -1, -1);
    return arrayOfbbuf;
  }
  ...
  public bbuf b()
  {
    return this.jdField_b_of_type_Bbuf;
  }
  
  public bbuf b(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    bbuf localbbuf = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 1000);
    if (localbbuf != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
    ...
    do
    {
      ...
      localbbuf = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 700);
      if (localbbuf == null) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    label444:
    label453:
    for (paramInt4 = 0;; paramInt4 = ((bbuf)localObject).jdField_b_of_type_Int)
    {
      aktv.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localObject;
      paramInt3 = ((bbuf)localObject).jdField_a_of_type_Int;
      break;
    }
  }
  ...
  public void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bbuf = null;
  ...
  public boolean b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 347	bbuc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   4: ifnonnull +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    //   9: aload_0
    //   10: getfield 531	bbuc:jdField_a_of_type_Boolean	Z
    //   13: ifne +5 -> 18
    //   16: iconst_1
    //   17: ireturn
    //   18: aload_0
    //   19: iconst_0
    //   20: putfield 531	bbuc:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: invokespecial 597	bbuc:h	()Z
    //   27: istore_1
    //   28: iload_1
    //   29: ifeq +10 -> 39
    //   32: aload_0
    //   33: getfield 347	bbuc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   36: invokevirtual 600	android/hardware/Camera:cancelAutoFocus	()V
    //   39: aload_0
    //   40: getfield 347	bbuc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   43: invokevirtual 752	android/hardware/Camera:stopPreview	()V
    //   46: aload_0
    //   47: getfield 347	bbuc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   50: aconst_null
    //   51: invokevirtual 623	android/hardware/Camera:setPreviewCallback	(Landroid/hardware/Camera$PreviewCallback;)V
    //   54: aload_0
    //   55: getfield 347	bbuc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   58: aconst_null
  ...
  public boolean b(bbuf parambbuf)
  {
    ...
    do
    {
      ...
      try
      {
        localParameters.setPictureSize(parambbuf.jdField_a_of_type_Int, parambbuf.jdField_b_of_type_Int);
        this.jdField_b_of_type_Bbuf = parambbuf;
        boolean bool = a(localParameters);
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "setRawPictureSize w " + parambbuf.jdField_a_of_type_Int + ", h " + parambbuf.jdField_b_of_type_Int + ", success=" + bool);
        }
        return bool;
      }
      catch (Exception parambbuf)
    ...
    QLog.i(jdField_b_of_type_JavaLangString, 2, "setParamsPictureSize", parambbuf);
    return false;
  }
  ...
  public bbuf[] b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
    ...
    bbuf[] arrayOfbbuf = new bbuf[2];
    bbuf localbbuf1 = b(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localbbuf1 != null)
    {
      arrayOfbbuf[0] = localbbuf1;
      if (QLog.isColorLevel()) {
  ...
  public bbuf c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
    ...
    bbuf localbbuf = a((List)localObject, bbsu.jdField_c_of_type_Int, bbsu.d);
    if (localbbuf != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      ...
      if (paramBoolean)
      {
        aktv.a(2, bbsu.jdField_c_of_type_Int, bbsu.d, localbbuf.jdField_a_of_type_Int, localbbuf.jdField_b_of_type_Int);
        localObject = localbbuf;
      }
    }
    do
    {
      do
      {
        ...
        localbbuf = a((List)localObject, bbsu.jdField_a_of_type_ArrayOfInt[1], bbsu.b[1]);
        if (localbbuf == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      aktv.a(3, bbsu.jdField_c_of_type_Int, bbsu.d, localbbuf.jdField_a_of_type_Int, localbbuf.jdField_b_of_type_Int);
      return localbbuf;
      localbbuf = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localbbuf;
    } while (!paramBoolean);
    ...
    label413:
    for (paramInt2 = j;; paramInt2 = localbbuf.jdField_b_of_type_Int)
    {
      aktv.a(4, bbsu.jdField_c_of_type_Int, bbsu.d, paramInt1, paramInt2);
      return localbbuf;
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Int == 1)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_b_of_type_JavaLangString, 2, "setDisplayOrientation degrees=" + i + " blackPhone=" + bool1 + " camera=" + akrw.jdField_a_of_type_Int + " rom_black=" + bool2);
          }
          return true;
          i = 0;
          break;
  ...
  public bbuf[] c(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee wanted size=" + bbsu.jdField_c_of_type_Int + " " + bbsu.d + " cliped=" + paramInt1 + " " + paramInt2);
    }
    if (0 != 0)
    {
      paramInt1 = bbsu.jdField_c_of_type_Int;
      paramInt1 = bbsu.d;
      throw new NullPointerException();
    }
    bbuf[] arrayOfbbuf = new bbuf[2];
    bbuf localbbuf1 = c(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localbbuf1 != null)
    {
      arrayOfbbuf[0] = localbbuf1;
      if (QLog.isColorLevel()) {
