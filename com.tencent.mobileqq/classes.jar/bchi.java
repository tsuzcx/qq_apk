  ...
  public List<bcfi> a(Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        continue;
        paramVarArgs = new bcfq(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcgm(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcfr(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcfz(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcgi(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcgf(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcgg(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcfw(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcfu(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcfx(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcgh(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcge(str2, l3, localArrayList3, localResultItem, k);
        continue;
        paramVarArgs = new bcgc(str2, l3, localArrayList3, localResultItem, k);
        continue;
        l1 -= 1L;
        continue;
        if (!bcnc.b(l2))
        ...
        {
          paramVarArgs = new bcgs(str2, str12, -4, str10);
          paramVarArgs.u = localResultItem.seporator_type.get();
          localArrayList4.add(paramVarArgs);
        }
        else
        {
          paramVarArgs = new bceh(str2, str9, str8, str10, str11, str12, l2, localArrayList3, k, paramVarArgs, (String)localObject2, i, (String)localObject4, (String)localObject5, (String)localObject8);
          paramVarArgs.u = localResultItem.seporator_type.get();
          ...
          else
          {
            ...
            if (l3 == 1001L)
            {
              ...
              if (localResultItemGroup.highlight_title_keyword.get() == 1)
              {
                ...
                bool3 = true;
                paramVarArgs = new bceg(str2, l3, "QID", null, 0L, paramVarArgs, (String)localObject1, localArrayList3, bool1, bool2, bool3, str6, str7);
                if (l1 > 0L)
                {
              ...
              {
                localArrayList2.add(new bceg(str2, l3, str5, localArrayList4, l1, (String)localObject1, (String)localObject2, localArrayList3, bool1, bool2, bool3, str6, str7));
              ...
              {
                ((bceg)localObject1).a(localArrayList1);
                ((bceg)localObject1).a(localArrayList1.size());
