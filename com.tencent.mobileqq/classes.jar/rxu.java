...
public class rxu
{
  ...
  private static rxt jdField_a_of_type_Rxt;
  private static String jdField_b_of_type_JavaLangString;
  private static HashMap<String, Integer> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private static rxt jdField_b_of_type_Rxt;
  
  static
  {
    jdField_a_of_type_JavaLangString = ajjy.a(2131651108);
  ...
  public static int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localPackageInfo != null)
      {
        ...
        i = j;
        sai.a("WeishiDownloadUtil", "versionName:" + localPackageInfo.versionName + ",versionCode:" + localPackageInfo.versionCode);
        return j;
      }
      i = j;
      sai.c("WeishiDownloadUtil", paramString + "获取 PackageInfo 失败");
      return -1;
    }
    catch (Exception paramString)
    {
      sai.a("WeishiDownloadUtil", paramString.getLocalizedMessage());
    }
    return i;
  }
  ...
  private static RockDownloadInfo a(ArrayList<RockDownloadInfo> paramArrayList, RockDownloadInfo paramRockDownloadInfo)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      {
        sai.a("WeishiDownloadUtil", "Rock包版本大于或等于要下载的版本，有效~~~");
  ...
  {
    Object localObject2 = bccu.a().b("com.tencent.weishi", 4);
    Object localObject1 = localObject2;
    if (((List)localObject2).size() == 0) {
      localObject1 = bccu.a().a("com.tencent.weishi", 4);
    }
    localObject2 = bcgo.a().a("10261931");
    if (localObject2 != null)
    {
      ((DownloadInfo)localObject2).a(4);
      ((List)localObject1).add(localObject2);
    }
    sai.a("WeishiDownloadUtil", ">existValidQQDownloadWeishiApk, info:" + localObject1);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (localObject2 != null)
      {
        sai.d("WeishiDownloadUtil", "downloadInfo 's url: " + ((DownloadInfo)localObject2).d);
        if ((((DownloadInfo)localObject2).a() == 4) && (TextUtils.equals(((DownloadInfo)localObject2).e, "com.tencent.weishi")) && (((DownloadInfo)localObject2).d != null) && (((DownloadInfo)localObject2).d.startsWith(b()))) {
          ...
          {
            sai.a("WeishiDownloadUtil", "QQ下载包filePath为空!!!");
          }
          else
          {
            int i = a(((DownloadInfo)localObject2).l);
            sai.a("WeishiDownloadUtil", "判断QQ下载包有没有过期，apkVersionCode：" + i + ",targetVersion:" + paramInt);
            if (i >= paramInt)
            {
              sai.a("WeishiDownloadUtil", "本地包版本(" + i + ")大于或等于要下载的版本" + paramInt + ")，直接安装~~~");
      ...
      {
        sai.d("WeishiDownloadUtil", "downloadInfo is null");
      }
    }
    return "";
  }
  ...
  private static ArrayList<RockDownloadInfo> a(rxm paramrxm, RockDownloadInfo paramRockDownloadInfo)
  {
    ArrayList localArrayList = alme.a(paramRockDownloadInfo);
    ...
    if (i < localArrayList.size())
    {
      ...
      if ((k < paramRockDownloadInfo.versionCode) || (j < paramRockDownloadInfo.versionCode))
      {
        ...
        paramrxm.a(localRockDownloadInfo);
      }
      for (;;)
      {
        i += 1;
  ...
  public static rxt a(int paramInt1, int paramInt2)
  {
    if (b()) {
  ...
  {
    sai.a("WeishiDownloadUtil", "resetDownloadingMark");
  ...
  public static void a(Activity paramActivity, WSDownloadParams paramWSDownloadParams)
  {
    if ((paramActivity == null) || (paramWSDownloadParams == null)) {
      sai.a("WeishiDownloadUtil", "rock download activity or params is null");
    }
    rxm localrxm;
    ...
    do
    {
      ...
      {
        return;
        sai.d("WeishiDownloadUtil", "WSDownloadParams:" + paramWSDownloadParams.toString());
        localrxm = new rxm(paramActivity);
        if (vlt.b(paramActivity)) {
          break;
        }
      } while (a(paramWSDownloadParams, localrxm, localrxm.a(), 3));
      bbmy.a(paramActivity, ajjy.a(2131651107), 0).a();
      return;
      if (c())
      {
        a(true);
        sai.d("WeishiDownloadUtil", "当前有正在下载的任务,不响应钩子下载请求,但更改下载类型为主动下载");
        if ((rxf.a().e()) && (a()))
        {
          b(3);
          return;
        ...
        rzw.a(true, paramWSDownloadParams);
        rzw.a(paramWSDownloadParams, 2);
        WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, 3, 1, 2, 0);
        rxn.a(paramActivity);
        return;
      }
      if ((rxf.a().d()) && (sae.a(paramActivity)))
      {
        sam.a(paramWSDownloadParams.mScheme);
        paramWSDownloadParams.mStReportItem = rzu.a();
        rxn.a(115, paramWSDownloadParams);
        rzw.a(false, paramWSDownloadParams);
        rzw.a(paramWSDownloadParams, 3);
        WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, 3, 0, 3, 0);
        bcct.a(paramActivity, paramWSDownloadParams.mScheme, "com.tencent.weishi", "biz_src_jc_gzh_weishi");
        return;
      }
      localRockDownloadInfo = localrxm.a();
    } while (a(paramWSDownloadParams, localrxm, localRockDownloadInfo, 3));
    if ((!rxf.a().a()) && (!a()))
    {
      sai.a("WeishiDownloadUtil", "服务器关闭了4g开关");
      rxn.b(paramActivity, paramWSDownloadParams);
      return;
    }
    sai.a("WeishiDownloadUtil", "服务器打开了4g");
    if (rxf.a().e())
    {
      localrxm.a(paramActivity, localRockDownloadInfo, 3, paramWSDownloadParams, null);
      return;
    }
    rxn.a(paramActivity, paramWSDownloadParams);
  }
  
  public static void a(Activity paramActivity, WSDownloadParams paramWSDownloadParams, rxt paramrxt, RockDownloadListenerWrapper paramRockDownloadListenerWrapper)
  {
    paramrxt = new rxm(paramActivity);
    RockDownloadInfo localRockDownloadInfo = paramrxt.a();
    if (a(paramWSDownloadParams, paramrxt, localRockDownloadInfo, 2)) {
      return;
    }
    if ((!rxf.a().a()) && (!a()))
    {
      sai.d("WeishiDownloadUtil", "不可以在非WIFI环境下，静默下载微视");
      return;
    }
    if (c())
    {
      sai.d("WeishiDownloadUtil", "当前有正在下载的任务,不响应静默下载请求");
      if ((rxf.a().e()) && (a()))
      {
        b(3);
        return;
    ...
    if (rxf.a().e())
    {
      paramrxt.a(paramActivity, localRockDownloadInfo, 2, paramWSDownloadParams, paramRockDownloadListenerWrapper);
      return;
    }
  ...
  public static void a(Activity paramActivity, rxm paramrxm, WSDownloadParams paramWSDownloadParams, boolean paramBoolean, int paramInt)
  {
  ...
  private static void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramString.hasNext())
      {
        ...
        sai.d("WeishiDownloadUtil", "删除了info:" + ((DownloadInfo)localObject1).d);
        bccu.a().b(((DownloadInfo)localObject1).d, false);
      }
    }
  }
  ...
  {
    sai.a("WeishiDownloadUtil", "setPreDownloadingClick");
  ...
  public static boolean a(Activity paramActivity, WSDownloadParams paramWSDownloadParams)
  {
    ...
    {
      sai.d("WeishiDownloadUtil", "本地已经安装微视app");
      return false;
    }
    if (!e())
    {
      sai.d("WeishiDownloadUtil", "预下载开关没打开");
      return false;
    }
    rxm localrxm = new rxm(paramActivity);
    RockDownloadInfo localRockDownloadInfo = localrxm.a();
    if (a(paramWSDownloadParams, localrxm, localRockDownloadInfo, 1)) {
      return false;
    }
    if ((rxf.a().e()) && (a()))
    {
      localrxm.a(paramActivity, localRockDownloadInfo, 1, paramWSDownloadParams, null);
      return true;
    }
    sai.c("WeishiDownloadUtil", "用QQ预下载兜底~");
    a(99, 1);
  ...
  public static boolean a(Activity paramActivity, WSDownloadParams paramWSDownloadParams, boolean paramBoolean, int paramInt)
  {
    if ((paramActivity == null) || (paramWSDownloadParams == null))
    {
      sai.a("startQQDownload: activity is null Or params is null:");
      return false;
    }
    sai.a("downloadWeishi:" + paramWSDownloadParams);
    String str = rxf.a().d();
    a(paramWSDownloadParams.mEventId, paramInt);
    sam.a(paramWSDownloadParams.mScheme);
  ...
  {
    sai.a("WeishiDownloadUtil", String.format("downloadWeishi : autoInstall = %s, showNotification = %s, mDownloadUrlStr = %s", new Object[] { Boolean.valueOf(paramBoolean1), Boolean.valueOf(paramBoolean2), paramString }));
    b();
    Bundle localBundle = new Bundle();
    localBundle.putString(bcgl.jdField_b_of_type_JavaLangString, "10261931");
    localBundle.putString(bcgl.l, jdField_a_of_type_JavaLangString);
    localBundle.putString(bcgl.f, "com.tencent.weishi");
    localBundle.putString(bcgl.j, paramString);
    localBundle.putInt(bcgl.k, 2);
    localBundle.putBoolean(bcgl.h, false);
    paramString = bcgl.x;
    if (!paramBoolean2) {}
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      localBundle.putBoolean(paramString, paramBoolean1);
      bccy.a().a(paramActivity, localBundle, "biz_src_jc_gzh_weishi", null, 0);
  ...
  {
    if (bcev.a(bbtm.a().a(), paramString, "biz_src_jc_gzh_weishi", ""))
    {
      sai.d("WeishiDownloadUtil", "本地QQ包的版本有效，启动开始安装成功！");
      rzw.a(1, 2);
      WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, paramInt, 2, 2, 1);
      if (paramWSDownloadParams.mStReportItem == null) {
        paramWSDownloadParams.mStReportItem = rzu.a();
      }
      rzu.a(115, paramWSDownloadParams.mStReportItem.pagetype, paramWSDownloadParams.mStReportItem.comment_loctaion, null);
      sam.a(paramWSDownloadParams.mScheme);
      return true;
    }
    sai.d("WeishiDownloadUtil", "本地QQ包安装失败,重新下载！");
    return false;
  }
  
  private static boolean a(WSDownloadParams paramWSDownloadParams, rxm paramrxm, RockDownloadInfo paramRockDownloadInfo, int paramInt)
  {
    ArrayList localArrayList = a(paramrxm, paramRockDownloadInfo);
    if (a(localArrayList, paramRockDownloadInfo))
    {
      ...
      if (paramRockDownloadInfo != null)
      {
        if (paramInt == 1)
        {
          sai.c("WeishiDownloadUtil", "预下载包有效也不call安装----------------");
          return true;
        }
        if (rxf.a().a() == 2)
        {
          rwm.b += 1;
          sai.c("WeishiDownloadUtil", "CCCCCCCCC onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + rwm.b);
        }
        paramrxm.a(paramRockDownloadInfo, 1);
        sam.a(paramWSDownloadParams.mScheme);
        sai.d("WeishiDownloadUtil", "本地Rock包的版本有效，直接安装");
        return true;
      }
    }
    paramrxm = a(rxf.a().e());
    if (!TextUtils.isEmpty(paramrxm))
    {
      sai.d("WeishiDownloadUtil", "checkAndInstallValidApp QQDownloader apkPath = " + paramrxm);
      if (paramInt == 1)
      {
        sai.c("WeishiDownloadUtil", "预下载包有效也不call安装----------------");
        return true;
      ...
      {
        rwm.b += 1;
        sai.c("WeishiDownloadUtil", "DDDDDDDDDDD onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + rwm.b);
      }
      WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, paramInt, 1, 2, 0);
      a(paramWSDownloadParams.mEventId, paramInt);
      if (a(paramWSDownloadParams, paramInt, paramrxm))
      {
        sai.a("WeishiDownloadUtil", "installApkByQQDownloader！eventId:" + paramWSDownloadParams.mEventId + ",eventType:" + paramInt);
        return true;
      }
    }
    else
    {
      sai.a("WeishiDownloadUtil", "本地QQ包路径为空！");
    }
    return false;
  }
  ...
  private static rxt b(int paramInt1, int paramInt2)
  {
    if (jdField_a_of_type_Rxt != null)
    {
      if (!c()) {
        a(paramInt1);
      }
      b(paramInt2);
      return jdField_a_of_type_Rxt;
    }
    a(paramInt1);
    b(paramInt2);
    jdField_a_of_type_Rxt = new rxv();
    bccu.a().a(jdField_a_of_type_Rxt);
    return jdField_a_of_type_Rxt;
  }
  
  public static void b()
  {
    sai.a("WeishiDownloadUtil", "updateDownloadingMark");
  ...
  private static void b(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      sai.d("WeishiDownloadUtil", " 下载器的DB还没准备就绪,重新注册监听，并重试下载一次");
      ...
      for (;;)
      {
        ...
        sai.d("WeishiDownloadUtil", "onDownloadError retryCount = " + localInteger);
        if (localInteger.intValue() <= 3) {
          break;
        }
        sai.d("WeishiDownloadUtil", "重试次数已经达到3次，中止！");
        return;
    ...
    sai.d("WeishiDownloadUtil", "下载器其他错误");
  }
  
  private static void b(DownloadInfo paramDownloadInfo, int paramInt1, int paramInt2, String paramString)
  {
    sai.d("WeishiDownloadUtil", paramString + " onDownloadFinish info = " + paramDownloadInfo);
    sai.d("WeishiDownloadUtil", paramString + " onDownloadFinish eventId:" + paramInt1 + ",eventType:" + paramInt2);
    int i;
    if (b(paramDownloadInfo))
    {
      ...
      rxn.a();
      sai.c("WeishiDownloadUtil", paramString + " onDownloadFinish ACTIVE closeDownloadDialog");
      i = 1;
      rzw.a(paramInt1, true);
      rzw.a(2);
    ...
    for (;;)
    {
      if (jdField_b_of_type_JavaUtilHashMap.containsKey(paramDownloadInfo.d))
      {
        ...
        sai.d("WeishiDownloadUtil", paramString + " onDownloadFinish remove retryCount!");
      }
      if (i != 0)
      {
        paramString = a(rxf.a().e());
        a(jdField_a_of_type_ComTencentBizPubaccountWeishi_newDownloadWSDownloadParams, paramInt2, paramString);
      }
      a(paramDownloadInfo.d, rxf.a().e());
      return;
      label255:
      if (paramInt2 == 2)
      {
        ...
        {
          rwm.b += 1;
          sai.b("WeishiDownloadUtil", paramString + " onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + rwm.b);
          i = 1;
          break;
        }
        sai.a("WeishiDownloadUtil", "processDownloadFinish, this is maybe DTest silent download,linktype is :" + rxf.a().a());
        i = 1;
        break;
      }
      if (d())
      {
        a(false);
        sai.d("WeishiDownloadUtil", paramString + " 预下载中用户点击了钩子，下载完成需弹起安装！！！ByQQ");
        i = 1;
        break;
      }
      sai.d("WeishiDownloadUtil", paramString + " 正常预下载无需安装");
      i = 0;
      break;
      label423:
      if (paramInt1 == 401) {
  ...
  {
    sai.d("WeishiDownloadUtil", "qq installSucceed appid = " + paramString1 + ", packageName = " + paramString2);
    int i;
    if ((TextUtils.equals(paramString1, "10261931")) && (TextUtils.equals(paramString2, "com.tencent.weishi")))
    {
      sai.d("WeishiDownloadUtil", "这是统一的DownloadListener，installSucceed, appId:" + paramString1 + ",packName:" + paramString2);
      bccu.a().b(jdField_a_of_type_Rxt);
      rwm.b = 0;
      if (!paramBoolean) {
        break label155;
      }
      jdField_b_of_type_Rxt = null;
      i = a();
      int j = b();
      rzw.a(i, false);
      rzw.b(2);
  ...
  {
    String str = c();
    sai.b("WeishiDownloadUtil", "~~~~~~~~~~~~~~~~~~~~~~~~~currentProcessName:" + str);
  ...
  private static rxt c(int paramInt1, int paramInt2)
  {
    sai.a("WeishiDownloadUtil", "createQzoneListener~~~");
    if (jdField_b_of_type_Rxt != null)
    {
      if (!c()) {
        a(paramInt1);
      }
      b(paramInt2);
      return jdField_b_of_type_Rxt;
    }
    a(paramInt1);
    b(paramInt2);
    jdField_b_of_type_Rxt = new rxw();
    bccu.a().a(jdField_b_of_type_Rxt);
    sai.a("WeishiDownloadUtil", "qzone registerListener");
    return jdField_b_of_type_Rxt;
  }
  ...
  public static boolean c()
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      sai.b("WeishiDownloadUtil", "downloading  = " + bool2 + ", timeout = " + bool1 + ", time passed = " + l / 1000L + "s");
      if ((!bool2) || (bool1)) {
        break;
      }
      return true;
  ...
  {
    sai.a("WeishiDownloadUtil", "getPreDownloadingClick");
    return LocalMultiProcConfig.getBool("preDownloadingClick", false);
  }
  
  private static boolean e()
  {
    return (rxf.a().c()) && (!TextUtils.isEmpty(rxf.a().c())) && (rxf.a().c().startsWith("http"));
  }
}
