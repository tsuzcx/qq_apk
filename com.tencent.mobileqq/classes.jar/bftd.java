...
public class bftd
{
  private static bfte a = new bfte();
  ...
  public static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if ((localSet != null) && (localSet.contains(str)) && (a(paramQQAppInterface, paramSessionInfo.a)))
    {
      ...
      if (l3 - l1 >= 86400L)
      {
        ...
        paramSessionInfo = new NewIntent(BaseApplicationImpl.getApplication(), awci.class);
        l1 = 0L;
      }
    }
    try
  ...
  {
    if (asax.a(paramQQAppInterface, paramString, 5L, false) != null) {}
    while ((asax.a(paramQQAppInterface, paramString, 12L, false) != null) || (asax.a(paramQQAppInterface, paramString, false) != null)) {
      return true;
    }
    return false;
  }
