...
public class arho
{
  ...
  public void a()
  {
    ...
    {
      baan.a(BaseApplicationImpl.getContext(), false);
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        return false;
        baan.a(BaseApplicationImpl.getContext(), true);
        if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {
      ...
      if (Build.VERSION.SDK_INT >= 8) {
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new arhp(this, paramInt1, paramString));
      }
      do
      {
        for (;;)
