  ...
  implements View.OnClickListener, ScaleGestureDetector.OnScaleGestureListener
{
  ...
  private PublicAccountImageCollectionListView.ListViewEventListener jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionListView$ListViewEventListener = new mxd(this);
  ...
  public mxc(Context paramContext, PublicAccountImageCollectionListView paramPublicAccountImageCollectionListView, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ZImageView paramZImageView, ImageRequest paramImageRequest, ImageProgressCircle paramImageProgressCircle, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        paramZImageView.a(localColorDrawable).a(paramImageRequest, new mxh(this, bool, l, paramImageProgressCircle));
        return;
  ...
  private void e()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131430063));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839698));
    }
  }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838491));
    this.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131430062));
  }
  ...
  private void g()
  {
    ...
    if (i <= j - k)
    {
      ...
      if ((((View)localObject).getTag() != null) && ((((View)localObject).getTag() instanceof mxj)))
      {
        localObject = (mxj)((View)localObject).getTag();
        if (((mxj)localObject).jdField_a_of_type_AndroidWidgetTextView.getVisibility() != 0) {
          break label97;
        }
        this.jdField_f_of_type_Boolean = false;
        ((mxj)localObject).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      }
      for (;;)
      {
        i += 1;
        ...
        ((mxj)localObject).jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      }
    }
  ...
  private void h()
  {
    if ((this.jdField_b_of_type_AndroidViewView == null) || (!(this.jdField_b_of_type_AndroidViewView.getTag() instanceof mxj))) {}
    Intent localIntent;
    Object localObject;
    float[] arrayOfFloat;
    String str;
  ...
  {
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(paramContext, new mxk(this, null));
  }
  ...
  void a(mxi parammxi)
  {
    if (this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo == null)
    {
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        parammxi.f.setVisibility(0);
        a(parammxi.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle);
        ((PublicAccountImageCollectionMainActivity)this.jdField_a_of_type_AndroidAppActivity).g();
        return;
      }
      parammxi.f.setVisibility(8);
      return;
    }
    ...
    parammxi.jdField_a_of_type_AndroidViewView.setVisibility(0);
    parammxi.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.e);
    Object localObject = "" + this.jdField_g_of_type_Int;
    if (this.jdField_g_of_type_Int > 1000000)
    {
      localObject = "100万+";
      parammxi.e.setText("阅读 " + (String)localObject);
      ...
      if (localObject != null)
      {
        parammxi.d.setText(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).jdField_b_of_type_JavaLangString);
        parammxi.b.setText(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).d);
        parammxi.c.setText(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).jdField_c_of_type_JavaLangString);
        if (TextUtils.isEmpty(((PublicAccountImageCollectionUtils.PhotoFirstItemInfo)localObject).jdField_b_of_type_JavaLangString)) {
          break label630;
        }
        parammxi.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        parammxi.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(FaceDrawable.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.jdField_c_of_type_JavaLangString));
      }
    }
    for (;;)
    {
      ...
      a(parammxi.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView, localImageRequest, parammxi.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, 0);
      if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.jdField_c_of_type_JavaLangString)) || (this.jdField_a_of_type_ComTencentBizPublicAccountImageCollectionPublicAccountImageCollectionUtils$PhotoCollectionInfo.jdField_c_of_type_JavaLangString.equals("0")))
      {
        ...
        parammxi.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        parammxi.e.setTextSize(2, 14.0F);
        parammxi.d.setVisibility(8);
        parammxi.b.setTextSize(2, 14.0F);
        parammxi.c.setTextSize(2, 14.0F);
  ...
  void a(mxj parammxj, int paramInt)
  {
    ...
    do
    {
      ...
      localObject = (RelativeLayout.LayoutParams)parammxj.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView.getLayoutParams();
      localLayoutParams = (RelativeLayout.LayoutParams)parammxj.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
      localLayoutParams1 = parammxj.jdField_a_of_type_AndroidViewView.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject).width = this.jdField_f_of_type_Int;
      ((RelativeLayout.LayoutParams)localObject).height = i;
      parammxj.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
    ...
    a(parammxj.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView, localImageRequest, parammxj.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, parammxj.jdField_a_of_type_Int);
    int j;
    if ((localPhotoItemInfo.jdField_a_of_type_Int / localPhotoItemInfo.jdField_b_of_type_Int > 1.3D) && (!TextUtils.isEmpty(localPhotoItemInfo.jdField_b_of_type_JavaLangString)) && (!localPhotoItemInfo.jdField_b_of_type_JavaLangString.equals(" ")))
    {
      ...
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setMinHeight(AIOUtils.a(97.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setGravity(16);
      label348:
      if (i <= this.jdField_e_of_type_Int - (int)(88.0F * this.jdField_a_of_type_Float)) {
        break label616;
      }
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)(15.0F * this.jdField_a_of_type_Float), (int)(10.0F * this.jdField_a_of_type_Float), (int)(15.0F * this.jdField_a_of_type_Float), (int)(44.0F * this.jdField_a_of_type_Float));
      label409:
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams(localLayoutParams);
      parammxj.jdField_a_of_type_AndroidViewView.setLayoutParams(localLayoutParams1);
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setMaxLines(3);
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.valueOf("END"));
      localObject = paramInt + "/" + this.jdField_a_of_type_JavaUtilArrayList.size() + "  " + localPhotoItemInfo.jdField_b_of_type_JavaLangString;
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
      ...
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setBackgroundColor(0);
      label536:
      if (this.jdField_f_of_type_Boolean) {
        break label678;
      }
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    }
    for (;;)
    {
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new mxf(this));
      return;
      ...
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setGravity(80);
      break label348;
      label616:
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)(15.0F * this.jdField_a_of_type_Float), (int)(10.0F * this.jdField_a_of_type_Float), (int)(15.0F * this.jdField_a_of_type_Float), (int)(10.0F * this.jdField_a_of_type_Float));
      break label409;
      label662:
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setBackgroundColor(Color.parseColor("#66000000"));
      break label536;
      label678:
      parammxj.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          bool1 = bool2;
        } while ((paramView.getTag() instanceof mxj));
        return false;
        bool1 = bool2;
      } while (paramInt != 0);
      if (paramView.getTag() == null) {
      ...
      bool1 = bool2;
    } while ((paramView.getTag() instanceof mxi));
    return false;
  }
  ...
  void d()
  {
    ...
    localNewIntent.setObserver(new mxg(this));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      paramView.setOnTouchListener(new mxe(this, paramInt));
      return paramView;
      localObject1 = (mxi)paramView.getTag();
      localObject2 = null;
      break;
      localObject2 = (mxj)paramView.getTag();
      ((mxj)localObject2).jdField_a_of_type_Int = paramInt;
      ...
      {
        break;
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969214, paramViewGroup, false);
        localObject1 = paramView.getLayoutParams();
        ((ViewGroup.LayoutParams)localObject1).height = this.jdField_e_of_type_Int;
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject1);
        localObject1 = new mxi();
        ((mxi)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView = ((ZImageView)paramView.findViewById(2131365625));
        ((mxi)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle = ((ImageProgressCircle)paramView.findViewById(2131365626));
        ((mxi)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365628));
        ((mxi)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365630));
        ((mxi)localObject1).d = ((TextView)paramView.findViewById(2131365631));
        ((mxi)localObject1).c = ((TextView)paramView.findViewById(2131365632));
        ((mxi)localObject1).b = ((TextView)paramView.findViewById(2131365633));
        ((mxi)localObject1).b = ((TextView)paramView.findViewById(2131365633));
        ((mxi)localObject1).e = ((TextView)paramView.findViewById(2131365634));
        ((mxi)localObject1).jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131365635));
        ((mxi)localObject1).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramView.findViewById(2131365568));
        ((mxi)localObject1).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131365629);
        ((mxi)localObject1).f = ((TextView)paramView.findViewById(2131365627));
        ((mxi)localObject1).jdField_a_of_type_Int = paramInt;
        this.jdField_a_of_type_AndroidWidgetButton = ((mxi)localObject1).jdField_a_of_type_AndroidWidgetButton;
        this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
        this.jdField_a_of_type_AndroidViewView = ((mxi)localObject1).jdField_a_of_type_AndroidViewView;
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
        this.jdField_a_of_type_AndroidWidgetTextView = ((mxi)localObject1).e;
        paramView.setTag(localObject1);
        break;
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969215, paramViewGroup, false);
        localObject2 = new mxj();
        ((mxj)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle = ((ImageProgressCircle)paramView.findViewById(2131365639));
        ((mxj)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewImageloaderZImageView = ((ZImageView)paramView.findViewById(2131365637));
        ((mxj)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365638));
        ((mxj)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramView.findViewById(2131365568));
        ((mxj)localObject2).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131365636);
        ((mxj)localObject2).jdField_a_of_type_Int = paramInt;
        paramView.setTag(localObject2);
      }
      if (i != 0) {
