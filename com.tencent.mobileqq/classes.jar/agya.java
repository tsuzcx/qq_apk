...
class agya
  implements Runnable
{
  agya(agxz paramagxz, QQVideoMaterial paramQQVideoMaterial1, QQFilterRenderManager paramQQFilterRenderManager, VideoFilterList paramVideoFilterList, QQVideoMaterial paramQQVideoMaterial2, boolean paramBoolean1, boolean paramBoolean2, int paramInt) {}
  
  public void run()
  {
    EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, null);
    EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, -1);
    long l = SystemClock.elapsedRealtime();
    if (this.jdField_a_of_type_Agxz.a.i) {
    ...
    {
      EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, new GroupVideoFilterList(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvfilterMaterialQQVideoMaterial));
      this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.a(EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a));
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvfilterVideoFilterList == null) || (!EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvfilterVideoFilterList.a())) || (!EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a).jdField_b_of_type_Boolean)) {
        break label610;
      }
      EffectsCameraCaptureView.b(this.jdField_a_of_type_Agxz.a, true);
      ...
      label307:
      if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvfilterVideoFilterList == null) || (!EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvfilterVideoFilterList.a())) || (!EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a).jdField_a_of_type_Boolean)) {
        break label633;
      }
      ...
      EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, this.jdField_b_of_type_ComTencentMobileqqShortvideoPtvfilterMaterialQQVideoMaterial);
      ...
      EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, (String)localObject);
      EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, 2);
      label500:
      if (EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a).jdField_a_of_type_Int != 0) {
        break label764;
      }
      EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.jdField_b_of_type_Boolean, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.jdField_a_of_type_Boolean, false, false, 0);
    }
    label568:
    label610:
    label633:
    ...
    do
    {
      ...
      break;
      if (EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a).jdField_a_of_type_Boolean)
      {
      ...
      ImageMemoryManager.getInstance().loadAllImages(this.jdField_b_of_type_ComTencentMobileqqShortvideoPtvfilterMaterialQQVideoMaterial);
      break label227;
      EffectsCameraCaptureView.b(this.jdField_a_of_type_Agxz.a, false);
      ...
      {
        EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, "切换后置摄像头试试");
        EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, 0);
        break label500;
      }
      if (this.jdField_b_of_type_Boolean)
      {
        EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, LbsFilterStatusManager.a());
        EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, 3);
        break label500;
      }
      EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, this.jdField_a_of_type_Int));
      EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, 1);
      break label500;
      if (EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a).jdField_a_of_type_Int == 1)
      {
        EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, false, false, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.c, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.d, 1);
        return;
      }
    } while (EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a).jdField_a_of_type_Int != 2);
    label644:
    label649:
    EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.jdField_b_of_type_Boolean, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.jdField_a_of_type_Boolean, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.c, this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.d, 2);
    return;
    label866:
    EffectsCameraCaptureView.a(this.jdField_a_of_type_Agxz.a, false, false, false, false, 0);
  }
}
