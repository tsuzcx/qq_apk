...
public class agya
{
  ...
  protected static akeu a;
  public static Handler a;
  public static String a;
  public static WeakReference<agyg> a;
  public static int b;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new agyb(Looper.myLooper());
    jdField_a_of_type_Akeu = new akeu(jdField_a_of_type_AndroidOsHandler);
  }
  ...
  public static ArrayList<PfaFriend> a()
  {
    ...
    do
    {
      ...
      localObject2 = ((aktf)localObject1).a(true);
  ...
  public static HashMap<String, Object> a(agyg paramagyg, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramagyg);
    ...
    paramagyg = new HashMap();
    if (jdField_a_of_type_WalletPfaFriendRsp == null)
    {
      paramagyg.put(jdField_a_of_type_JavaLangString, a());
    ...
    for (;;)
    {
      paramagyg.put(jdField_b_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecPfaMsg);
      if (!paramBoolean) {
        break;
      }
      ...
      return paramagyg;
      label142:
      paramagyg.put(jdField_a_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecRec);
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    localQQAppInterface.addObserver(jdField_a_of_type_Akeu);
    PfaFriendRqt localPfaFriendRqt = new PfaFriendRqt();
    localPfaFriendRqt.mqq_version = bbdh.a(BaseApplicationImpl.getContext());
    if (jdField_a_of_type_WalletPfaFriendRsp != null)
    {
    ...
    for (;;)
    {
      ((aket)localQQAppInterface.a(42)).a(localPfaFriendRqt);
      return;
  ...
  public static void a(SelectMemberActivity paramSelectMemberActivity, ArrayList<ResultRecord> paramArrayList)
  {
    ...
    Object localObject2 = ajya.a(2131715033);
    ...
    for (localObject2 = (String)localObject1 + "、";; localObject2 = localObject1)
    {
      ...
      {
        bcql.a(paramSelectMemberActivity, paramSelectMemberActivity.getString(2131720352), 0).a();
        return;
      }
      paramArrayList = new agyc(new WeakReference(paramSelectMemberActivity), localArrayList);
      localObject2 = paramSelectMemberActivity.getIntent().getExtras();
      paramSelectMemberActivity = bbdj.a(paramSelectMemberActivity, (String)localObject1, ((Bundle)localObject2).getString("choose_friend_content"), ((Bundle)localObject2).getString("choose_friend_subcontent"), paramSelectMemberActivity.f, null, paramArrayList, paramArrayList, 36, false);
      axqy.b(ahiw.a(), "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.selectpage.windowshow", 0, 0, "", "", "", "");
  ...
  public static void a(SelectMemberActivity paramSelectMemberActivity, ArrayList<ResultRecord> paramArrayList, bbig parambbig)
  {
    if ((paramSelectMemberActivity == null) || (paramSelectMemberActivity.isFinishing()) || (paramSelectMemberActivity.getIntent() == null) || (paramSelectMemberActivity.getIntent().getExtras() == null)) {}
    ...
    if (parambbig != null) {
      paramArrayList.putString("choose_friend_feedback", parambbig.getInputValue());
    }
    parambbig = new TopayManager.5(null, new WeakReference(paramSelectMemberActivity), localResultReceiver, localArrayList1, localArrayList3);
    b(paramSelectMemberActivity, true);
    paramSelectMemberActivity = Parcel.obtain();
    parambbig.writeToParcel(paramSelectMemberActivity, 0);
    paramSelectMemberActivity.setDataPosition(0);
    parambbig = (ResultReceiver)ResultReceiver.CREATOR.createFromParcel(paramSelectMemberActivity);
    paramSelectMemberActivity.recycle();
    paramArrayList.putParcelable("callback", parambbig);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null) {
      paramQQAppInterface.removeObserver(jdField_a_of_type_Akeu);
    }
  }
  ...
  protected static void a(boolean paramBoolean)
  {
    if (jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      agyg localagyg = (agyg)jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localagyg != null) {
        localagyg.b(paramBoolean);
      }
    }
  }
  ...
  {
    agye localagye = new agye(paramActivity);
    paramList1 = new agyf(paramActivity, paramList1, paramList2);
    paramActivity = bbdj.a(paramActivity, 230, null, ajya.a(2131715034), ajya.a(2131715032), "留在QQ", paramList1, localagye);
