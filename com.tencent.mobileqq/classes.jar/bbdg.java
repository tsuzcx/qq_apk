  ...
  implements ArkAppMgr.IGetAppPathByNameCallback
{
  ...
  public boolean a(bbdf parambbdf, String paramString, float paramFloat)
  {
    ...
    return super.init(this.jdField_a_of_type_Bbdf.b(), this.jdField_a_of_type_Bbdf.d(), this.jdField_a_of_type_Bbdf.c(), paramString, ArkAppCenterUtil.getCurrentAppConfig(), paramFloat);
  }
  
  public void initLibrary()
  {
    ark.MediaSetStub(aowc.a);
  }
  ...
  public boolean onLoadApp(ArkViewModelBase.AppInfo paramAppInfo)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Bbdf.a();
    ...
    ArkAppMgr.getInstance().getAppPathByName(paramAppInfo.name, paramAppInfo.view, paramAppInfo.appMinVersion, null, new bbdh(this));
    return false;
  }
  ...
  public void onLoadReport(int paramInt)
  {
    if (this.mAppInfo != null) {
      aovl.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), this.mAppInfo.name, "ArkAppLoadState", paramInt, 0, 0L, 0L, 0L, this.mAppInfo.view, "");
    }
  }
  ...
  public void onRunAppFailed()
  {
    ...
    if (localObject != null)
    {
      ...
      localObject = ((ArkViewImplement)localObject).getView().getContext().getString(2131717999);
    }
    label90:
    for (this.mErrorInfo.msg = String.format((String)localObject, new Object[] { this.jdField_a_of_type_Bbdf.b() });; this.mErrorInfo.msg = "")
    {
