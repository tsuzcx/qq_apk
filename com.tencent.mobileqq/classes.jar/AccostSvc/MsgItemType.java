  ...
  implements Serializable
{
  ...
  public static final MsgItemType MsgItem_Event_ShareTrace = new MsgItemType(21, 201, "MsgItem_Event_ShareTrace");
  ...
  private static MsgItemType[] a = new MsgItemType[22];
  ...
  public static MsgItemType convert(int paramInt)
  {
    ...
    for (;;)
    {
      MsgItemType[] arrayOfMsgItemType = a;
      if (i >= arrayOfMsgItemType.length) {
        break;
      }
      if (arrayOfMsgItemType[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static MsgItemType convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfMsgItemType[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
