...
public class njk
{
  ...
  public static String a(Context paramContext, int paramInt)
  {
    ...
    default: 
      return null;
    case 104: 
      return paramContext.getResources().getString(2131690312);
    case 105: 
      return paramContext.getResources().getString(2131690313);
    }
    return paramContext.getResources().getString(2131690314);
  }
  ...
  public static String a(boolean paramBoolean, Context paramContext, int paramInt, long paramLong, String paramString)
  {
    if (paramBoolean) {
      ...
      default: 
        if ((TextUtils.isEmpty(paramString)) || (a(paramInt))) {
          paramString = paramContext.getResources().getString(2131690395);
        }
        break;
      }
    }
    ...
    {
      return paramString;
      return paramContext.getResources().getString(2131690281);
      return paramContext.getResources().getString(2131690282);
      return String.format(paramContext.getResources().getString(2131690277), new Object[] { new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Long.valueOf(1000L * paramLong)) });
      return paramContext.getResources().getString(2131690283);
      return paramContext.getResources().getString(2131690278);
      return paramContext.getResources().getString(2131690284);
      switch (paramInt)
      {
      }
    } while ((!TextUtils.isEmpty(paramString)) && (!a(paramInt)));
    return paramContext.getResources().getString(2131690399);
    return paramContext.getResources().getString(2131690393);
    return paramContext.getResources().getString(2131690401);
    return paramContext.getResources().getString(2131690282);
    return String.format(paramContext.getResources().getString(2131690277), new Object[] { new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Long.valueOf(1000L * paramLong)) });
    return paramContext.getResources().getString(2131690283);
    return paramContext.getResources().getString(2131690278);
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    paramContext.setMessage(paramString).setPositiveButton(2131690397, new njm());
    paramContext.show();
  }
  ...
  public static boolean a()
  {
    ...
    if (localnji != null) {}
    for (boolean bool = localnji.a();; bool = false)
    {
  ...
  public static boolean a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity = new njn(paramOnClickListener);
    if ((!bool2) && (!bool1))
    {
  ...
  public static boolean a(com.tencent.mobileqq.app.BaseActivity paramBaseActivity, String paramString)
  {
    ...
    mxn localmxn = (mxn)paramBaseActivity.app.getManager(373);
    if ((localObject == null) || (localmxn == null)) {
      return false;
    }
    if (paramBaseActivity.app.getAVNotifyCenter().b(paramBaseActivity, paramString))
    {
      QQToast.a(paramBaseActivity, 2131690351, 1).b(paramBaseActivity.getResources().getDimensionPixelSize(2131299076));
      return true;
    }
    ...
    if (localmxn.c(paramString))
    {
      paramString = bfur.a(paramBaseActivity, 230);
      paramString.setMessage(paramBaseActivity.getString(2131690281)).setPositiveButton(paramBaseActivity.getString(2131690397), new njl());
      paramString.show();
      return true;
    }
    return false;
