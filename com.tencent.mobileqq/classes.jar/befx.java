  ...
  implements Manager
{
  ...
  public befx(QQAppInterface paramQQAppInterface)
  {
  ...
  private axjq a(String paramString)
  {
    paramString = new axjq(paramString, 16);
    paramString.setSpan(new ForegroundColorSpan(BaseApplicationImpl.context.getResources().getColor(2131100542)), 0, paramString.length(), 33);
    return paramString;
  }
  ...
  public static befx a(QQAppInterface paramQQAppInterface)
  {
    return (befx)paramQQAppInterface.getManager(313);
  }
  ...
  public String a(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (ahwj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = ajjy.a(2131641851) + paramString;
    }
    return str;
  }
  ...
  public void a(QQMessageFacade.Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new axjq("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(ajjy.a(2131641850)));
      paramSpannableStringBuilder.append(new axjq(paramMessage.nickName, 16));
    }
  }
  
  public void a(QQMessageFacade.Message paramMessage, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((ahwj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(ajjy.a(2131641852)));
    }
  }
  ...
  public String b(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = ajjy.a(2131641853) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131633814) + paramString;
  }
  
  public void b()
  {
    ((ajfi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).j();
  }
  ...
  {
    return ahwj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
