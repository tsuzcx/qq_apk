  ...
  extends ProtocolDownloader.Adapter
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bduw.a(aljq.aX + "keyword_emotion/");
  }
  
  public agub()
  {
    if (BaseApplicationImpl.sProcessId == 1) {
      this.jdField_a_of_type_Awbw = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getEntityManagerFactory().createEntityManager();
    }
  ...
  public static String a(agua paramagua)
  {
    String str = null;
    if (!TextUtils.isEmpty(paramagua.e())) {
      str = paramagua.e();
    }
    while (TextUtils.isEmpty(paramagua.a())) {
      return str;
    }
    return paramagua.a();
  }
  ...
  {
    return agug.a(paramString).exists();
  }
  ...
  public File a(String paramString, File paramFile, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramURLDrawableHandler)
      {
        try
        {
          new bapk().a((OutputStream)localObject, localDownloadParams, paramURLDrawableHandler);
          ((FileOutputStream)localObject).close();
          paramURLDrawableHandler = new File(str2);
          if (!paramURLDrawableHandler.renameTo(paramFile))
          {
            bdcs.a(paramURLDrawableHandler, paramFile);
          ...
          azmz.a(BaseApplication.getContext()).a(null, "StickerRecImgDownload", true, l, 0L, paramURLDrawableHandler, "");
          return paramFile;
        }
        catch (Exception paramURLDrawableHandler)
        {
    ...
    azmz.a(BaseApplication.getContext()).a(null, "StickerRecImgDownload", false, l, 0L, null, "");
    paramFile.delete();
  ...
  public boolean hasDiskFile(DownloadParams paramDownloadParams)
  {
    try
    {
      paramDownloadParams = a((agua)paramDownloadParams.mExtraInfo);
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    File localFile1 = agug.a(paramDownloadParams);
