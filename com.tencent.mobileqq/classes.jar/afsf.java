...
public class afsf
  extends aojs
{
  public afsf(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        localObject = bhlq.a(this.a, 230);
        ((bhpc)localObject).setTitle(this.a.getString(2131695474));
        ((bhpc)localObject).setMessage(this.a.getString(2131695475));
        ((bhpc)localObject).setNegativeButton(this.a.getString(2131695506), new afsg(this, (bhpc)localObject));
        ((bhpc)localObject).setPositiveButton(this.a.getString(2131718195), new afsh(this, (bhpc)localObject));
  ...
  {
    if (!bhjx.a(paramString, this.a.jdField_a_of_type_JavaLangString)) {}
    while (paramInt1 != 9) {
      return;
    }
    paramString = this.a;
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131691902));
  ...
  {
    if (!bhjx.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_JavaLangString)) {}
    Object localObject;
    label132:
    label190:
    label320:
    ...
    do
    {
      do
      {
        ...
        case 4: 
          if (paramBoolean)
          {
            ...
            } while ((this.a.jdField_a_of_type_JavaUtilArrayList.contains(localObject)) || (localObject == null) || ("".equals(((String)localObject).trim())) || (bhjx.a(this.a.d, localObject)));
          ...
          paramList = (aoip)this.a.app.a(20);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131715998));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Bjbv.b(2, 2131718865, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_Bjbv.b(2, 2131718860, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
    ...
    for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      this.a.jdField_a_of_type_Afsj.b(paramList);
      return;
      paramInt1 = paramList.size();
      break;
    }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (bhjx.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
      paramString = (TroopManager)this.a.app.getManager(52);
  ...
  protected void b(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    label56:
    while (!bhjx.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString))
    {
      i += 1;
      break label21;
      break;
