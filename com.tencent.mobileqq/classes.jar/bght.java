...
public class bght
{
  private static bght jdField_a_of_type_Bght;
  private Handler jdField_a_of_type_AndroidOsHandler = new bghu(this, BaseApplication.getContext().getMainLooper());
  private LinkedList<bghv> jdField_a_of_type_JavaUtilLinkedList;
  public boolean a;
  
  public static bght a()
  {
    if (jdField_a_of_type_Bght == null) {
      jdField_a_of_type_Bght = new bght();
    }
    return jdField_a_of_type_Bght;
  }
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 40	bght:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnonnull +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 40	bght:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   18: invokevirtual 72	java/util/LinkedList:clear	()V
    //   21: aload_0
    //   22: aconst_null
    //   23: putfield 40	bght:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   26: goto -15 -> 11
    //   29: astore_1
    //   30: aload_0
    //   31: monitorexit
  ...
  public Bitmap b(String paramString, RollangleImageView paramRollangleImageView)
  {
    ...
    //   40: areturn
    //   41: aload_0
    //   42: getfield 40	bght:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   45: ifnonnull +14 -> 59
    //   48: aload_0
    //   49: new 69	java/util/LinkedList
    //   52: dup
    //   53: invokespecial 77	java/util/LinkedList:<init>	()V
    //   56: putfield 40	bght:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   59: aload_0
    //   60: getfield 40	bght:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    ...
    //   72: dup
    //   73: aload_0
    //   74: invokespecial 86	com/tencent/mobileqq/troop/utils/RollangleImageView$ImageCache$1:<init>	(Lbght;)V
    //   77: iconst_5
    //   78: aconst_null
    //   79: iconst_1
    ...
    //   83: new 94	bghv
    //   86: dup
    //   87: invokespecial 95	bghv:<init>	()V
    //   90: astore_3
    //   91: aload_3
    //   92: aload_2
    //   93: putfield 98	bghv:jdField_a_of_type_ComTencentMobileqqTroopUtilsRollangleImageView	Lcom/tencent/mobileqq/troop/utils/RollangleImageView;
    //   96: aload_3
    //   97: aload_1
    //   98: putfield 101	bghv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   101: aload_0
    //   102: getfield 40	bght:jdField_a_of_type_JavaUtilLinkedList	Ljava/util/LinkedList;
    //   105: aload_3
