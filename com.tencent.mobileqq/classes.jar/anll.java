...
public class anll
{
  ...
  private static float a(Context paramContext)
  {
    ...
    float f2 = Float.valueOf(aoqd.a(paramContext, "key_font_level", String.valueOf(16.0F))).floatValue();
    float f1;
    if (f2 >= 13.92F)
    {
      f1 = f2;
  ...
  private static void a(Context paramContext, float paramFloat)
  {
    ...
    aoqd.a(paramContext, "key_font_level", String.valueOf(paramFloat));
  }
