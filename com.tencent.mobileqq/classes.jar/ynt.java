...
{
  static final String jdField_a_of_type_JavaLangString = vpl.a("StoryGroupSvc.do_group_video_forward");
  public int a;
  amwl jdField_a_of_type_Amwl = new ynv(this);
  public Handler a;
  public QQAppInterface a;
  public MessageForTroopStory a;
  nmd jdField_a_of_type_Nmd = new ynu(this);
  protected boolean a;
  public int b;
  public String b;
  public int c;
  ...
  private ynt(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
  ...
  private ynt(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
  ...
  public static ynt a(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
    try
    {
      paramQQAppInterface = new ynt(paramQQAppInterface, paramBundle, paramSessionInfo);
  ...
  public static ynt a(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
    return new ynt(paramQQAppInterface, paramMessageForTroopStory);
  }
  ...
  private boolean a(Bundle paramBundle, SessionInfo paramSessionInfo)
  {
    ...
    this.k = paramSessionInfo.curFriendUin;
    this.l = paramSessionInfo.troopUin;
    this.jdField_d_of_type_Int = paramSessionInfo.curType;
    return true;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setChangeAndNotify(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopStory);
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        nmb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Nmd, localReqGroupVideoForward.toByteArray(), jdField_a_of_type_JavaLangString);
        return;
      }
  ...
  public void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().sendMessage(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopStory, this.jdField_a_of_type_Amwl);
  }
