  ...
  extends aomz
{
  ...
  public acwf(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, acwe paramacwe)
  {
  ...
  private QQMessageFacade.Message a(String paramString, EntityManager paramEntityManager, int paramInt1, int paramInt2)
  {
    ...
    if ((paramString.startsWith("mr_discusssion")) || (paramString.startsWith("mr_troop")))
    {
      ...
      str = "select * from (select count() as unReadNum from %s mr where mr.isread=0),(select count() as hasReply from %s mr where mr.issend=0),%s m where m.isValid=1 and m.msgtype " + acwh.a() + " and m.longMsgId='%d' and m.issend='%d' order by %s limit 1";
      if (!bool) {
        break label177;
      }
      if (i == 0) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (!acwh.a(paramMessageRecord1, paramMessageRecord2)) {
            break;
          }
  ...
  private List<MessageRecord> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (localList2 == null)
    {
      ...
      localList1 = b(paramString1, paramInt, new bctq());
  ...
  private List<MessageRecord> a(String paramString, int paramInt, List<MessageRecord> paramList1, List<MessageRecord> paramList2)
  {
    if (paramList1.size() > 15)
    {
      ...
      if ((!acwh.a(paramString, paramInt, paramList2)) && (!acwh.c(paramList2))) {
        break label207;
      }
      paramInt = 1;
      label60:
  ...
  private void a(bctq parambctq)
  {
    if ((parambctq.jdField_b_of_type_Int != 0) && (bctj.a()) && (bctj.a(1)))
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("param_IsMainThread", String.valueOf(parambctq.jdField_a_of_type_Int));
      localHashMap.put("param_OptType", parambctq.jdField_a_of_type_JavaLangString);
      localHashMap.put("param_OptTotalCost", String.valueOf(parambctq.jdField_a_of_type_Long));
      localHashMap.put("param_OptCount", String.valueOf(parambctq.jdField_b_of_type_Int));
      localHashMap.put("param_OptMsgCount", String.valueOf(parambctq.c));
      localHashMap.put("param_OptOneCost", String.valueOf(parambctq.jdField_b_of_type_Long));
      localHashMap.put("param_OptScene", parambctq.jdField_b_of_type_JavaLangString);
      localHashMap.put("param_WalSwitch", String.valueOf(SQLiteOpenHelper.WAL_ENABLE));
      bctj.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, parambctq.c, 0L, localHashMap, null, false);
    }
  }
  ...
  private void a(String paramString, int paramInt, bctq parambctq, long paramLong)
  {
    if (TextUtils.equals(parambctq.jdField_b_of_type_JavaLangString, "launch"))
    {
      paramLong = (System.nanoTime() - paramLong) / 1000L;
      parambctq.jdField_a_of_type_Long += paramLong;
      parambctq.jdField_b_of_type_Int += 1;
      parambctq.c += 1;
      parambctq.jdField_b_of_type_Long = (parambctq.jdField_a_of_type_Long / parambctq.jdField_b_of_type_Int);
      if ((bctj.c) && (QLog.isColorLevel()) && (acwh.a(paramString, paramInt))) {
    ...
    {
      return;
      if (TextUtils.equals(parambctq.jdField_b_of_type_JavaLangString, "AIO"))
      {
        paramLong = (System.nanoTime() - paramLong) / 1000L;
        parambctq.jdField_a_of_type_Long = paramLong;
        parambctq.jdField_b_of_type_Int = 1;
      ...
      else
      {
        ...
        for (paramInt = 1; (paramInt != 0) && (bctj.a()) && (bctj.a(2)); paramInt = 0)
        {
          parambctq.jdField_a_of_type_Int = 1;
          parambctq.jdField_a_of_type_JavaLangString = "select";
          parambctq.jdField_b_of_type_JavaLangString = "mainThread";
          parambctq.jdField_a_of_type_Long = paramLong;
          parambctq.jdField_b_of_type_Int = 1;
          parambctq.c = 1;
          parambctq.jdField_b_of_type_Long = (parambctq.jdField_a_of_type_Long / parambctq.jdField_b_of_type_Int);
          paramString = new HashMap();
          paramString.put("param_IsMainThread", String.valueOf(parambctq.jdField_a_of_type_Int));
          paramString.put("param_OptType", parambctq.jdField_a_of_type_JavaLangString);
          paramString.put("param_OptTotalCost", String.valueOf(parambctq.jdField_a_of_type_Long));
          paramString.put("param_OptCount", String.valueOf(parambctq.jdField_b_of_type_Int));
          paramString.put("param_OptMsgCount", String.valueOf(parambctq.c));
          paramString.put("param_OptOneCost", String.valueOf(parambctq.jdField_b_of_type_Long));
          paramString.put("param_OptScene", parambctq.jdField_b_of_type_JavaLangString);
          paramString.put("param_WalSwitch", String.valueOf(SQLiteOpenHelper.WAL_ENABLE));
          bctj.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, parambctq.c, 0L, paramString, null, false);
          return;
        }
      }
    }
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    if (i >= 0)
    {
      String str = acwh.a((MessageRecord)paramList.get(i));
  ...
  {
    Object localObject = e(anhk.Y, 4001);
    int i;
    if (localObject != null)
    {
      ...
      a(String.valueOf(anhk.Y), 4001, c(String.valueOf(anhk.Y), 4001), "msgtype=?", new String[] { String.valueOf(paramInt) }, null);
    }
    for (;;)
    {
      if ((localObject != null) && (((List)localObject).size() == 0) && (bdgn.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) <= 0))
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
        RecentUser localRecentUser = (RecentUser)((aong)localObject).findRecentUserByUin(anhk.W, 9000);
  ...
  {
    Object localObject = new bctq();
    if (Looper.myLooper() == Looper.getMainLooper()) {}
    for (int i = 1;; i = 0)
    {
      ((bctq)localObject).jdField_a_of_type_Int = i;
      ((bctq)localObject).jdField_a_of_type_JavaLangString = "select";
      ((bctq)localObject).jdField_b_of_type_JavaLangString = "AIO";
      localList = a(paramString, paramInt, (bctq)localObject);
      a((bctq)localObject);
      if ((localList == null) || (localList.isEmpty())) {
        break label292;
      }
  ...
  private void b(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    acwh.a((List)localObject, paramMessageRecord, true);
    if ((localObject != null) && (((List)localObject).size() > 40) && (!acwh.a(paramString))) {
    ...
    for (;;)
    {
      ...
      for (paramInt = 1;; paramInt = 0)
      {
        ...
        for (int i = 1;; i = 0)
        {
          if (paramString.equals(anhk.G))
          {
            ((List)localObject).add(0, paramMessageRecord);
            return;
          }
          if ((paramMessageRecord.msgtype == -4021) || (paramInt != 0) || (i != 0) || (paramMessageRecord.msgtype == -7012))
          {
            acwh.a((List)localObject, paramMessageRecord, true);
            return;
          }
  ...
  private MessageRecord c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (localObject2 == null)
      {
        ...
        aofl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt1);
  ...
  private List<MessageRecord> c(String paramString, int paramInt, bctq parambctq)
  {
    String str = a(paramString, paramInt);
    ...
    {
      long l = System.nanoTime();
      localList1 = b(paramString, paramInt, parambctq);
      a(paramString, paramInt, localList1);
      a(paramString, str, localList1, l);
    }
    if (QLog.isColorLevel())
    {
      parambctq = new StringBuilder();
      parambctq.append("getMsgList2 uin ").append(paramString).append(" , type = ").append(paramInt).append(" itemList size=").append(localList1.size());
      if ((jdField_b_of_type_Int % 20 == 0) && (jdField_b_of_type_Int > 100)) {
        parambctq.append("\n").append(QLog.getStackTraceString(new Throwable("MsgProxy_getMsgList1")));
      }
      QLog.d("Q.msg.MsgProxy", 2, parambctq.toString());
      jdField_b_of_type_Int += 1;
    }
    return localList1;
  }
  ...
  private void c(String paramString, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((!localMessageRecord.isread) && (a(paramInt, paramLong, localMessageRecord)) && ((!acwh.b(paramInt)) || (!acwh.n(localMessageRecord.msgtype)))) {
          localMessageRecord.isread = true;
        }
      }
      ...
      if ((paramString != null) && (!paramString.isEmpty()))
      {
        ...
        {
          localObject = (MessageRecord)paramString.next();
          if ((!((MessageRecord)localObject).isread) && (a(paramInt, paramLong, (MessageRecord)localObject)) && ((!acwh.b(paramInt)) || (!acwh.n(((MessageRecord)localObject).msgtype)))) {
            ((MessageRecord)localObject).isread = true;
          }
        }
      }
  ...
  private void c(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (localList != null)
    {
      acwh.a(localList, paramMessageRecord, true);
  ...
  private List<MessageRecord> d(String paramString, int paramInt, bctq parambctq)
  {
    ...
    do
    {
      ...
      a(paramString, paramInt, parambctq, l2);
      if (localObject1 != null)
      {
        ...
        while (i < j)
        {
          parambctq = (MessageRecord)((List)localObject1).get(i);
          ((List)localObject1).set(i, ((List)localObject1).get(paramInt));
          ((List)localObject1).set(paramInt, parambctq);
          i += 1;
          paramInt -= 1;
        }
      }
      for (parambctq = (bctq)localObject1;; parambctq = new ArrayList())
      {
        localObject1 = acwh.a(parambctq, localList).iterator();
        while (((Iterator)localObject1).hasNext()) {
          acwh.a(parambctq, (MessageRecord)((Iterator)localObject1).next(), true);
        }
      }
      localObject1 = parambctq;
    } while (!QLog.isColorLevel());
    QLog.d("Q.msg.MsgProxy", 2, new Object[] { "init from db, uin=", paramString, ", isSaveToDatabase=", Boolean.valueOf(bool), ", cost=", Long.valueOf(System.currentTimeMillis() - l1), " sqlStr = ", localObject2, " size =", Integer.valueOf(parambctq.size()) });
    return parambctq;
  }
  ...
  private List<MessageRecord> g(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      localObject1 = acwh.a(paramString, (List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext()) {
        acwh.a(paramString, (MessageRecord)((Iterator)localObject1).next(), true);
      }
      label348:
  ...
  private void g()
  {
    aklj localaklj = (aklj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(125);
    localaklj.e = null;
    localaklj.f = null;
  }
  ...
  {
    Lock localLock = a(anhk.Y, paramInt);
    localLock.lock();
    try
    {
      paramInt = b(paramInt);
  ...
  public int a(String paramString, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().transSaveLock)
      {
  ...
  public int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (acwh.d(paramInt))
    {
      paramString = "( msgtype " + acwh.b() + " and isValid=1 ) and ( time < ? or (time = ? and longMsgIndex <= ? and _id <= ?))";
  ...
  protected int a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localaywe = (aywe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
      Looper localLooper = Looper.getMainLooper();
      if (Thread.currentThread() != localLooper.getThread()) {
        break label95;
      }
      ThreadManager.post(new MsgProxy.1(this, localaywe, paramString, paramInt), 10, null, false);
    }
    label95:
    while (localaywe == null) {
      return i;
    }
    localaywe.a(c(paramString, paramInt), null, null);
    return i;
  }
  ...
  public acwe a()
  {
    return this.jdField_a_of_type_Acwe;
  }
  ...
  public Cursor a(String paramString, int paramInt)
  {
    ...
    if (paramString.equals(String.valueOf(anhk.G)))
    {
      ArrayList localArrayList = new ArrayList();
      int i = 0;
      ...
      return new acwc(this, localArrayList);
    }
    return new acwc(this, (List)((ArrayList)localList).clone());
  }
  
  protected ayvj a()
  {
    if ((this.jdField_a_of_type_Ayvj == null) || (!this.jdField_a_of_type_Ayvj.isOpen())) {}
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_Ayvj == null) || (!this.jdField_a_of_type_Ayvj.isOpen())) {
        this.jdField_a_of_type_Ayvj = ((ayvj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createMessageRecordEntityManager());
      }
  ...
  protected QQMessageFacade.Message a(String paramString, EntityManager paramEntityManager, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().transSaveLock)
      {
        ...
        ((StringBuilder)localObject1).append(acwh.a());
  ...
  public FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt1, String paramString2, int paramInt2, aodg paramaodg)
  {
    ...
    for (;;)
    {
      ...
      long l2 = aodl.jdField_a_of_type_Long;
      ...
      try
      {
        paramString2 = a(paramString1, paramInt1, paramString2, paramaodg, (Cursor)localObject);
  ...
  protected FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt, String paramString2, aodg paramaodg, Cursor paramCursor)
  {
    return aodi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Ayvj, paramCursor, paramString1, paramInt, paramString2, paramaodg);
  }
  ...
  protected ChatHistorySearchData a(Cursor paramCursor, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      if (str1 != null)
      {
        localObject = bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo, str1.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()), str1);
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    //   12: astore_3
    //   13: aload_1
    //   14: getfield 1018	com/tencent/mobileqq/activity/aio/SessionInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   17: invokestatic 991	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   20: ifne +13 -> 33
    //   23: aload_2
    //   24: invokestatic 991	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   27: ifeq +8 -> 35
    //   30: aload 4
    //   32: astore_3
    //   33: aload_3
    ...
    //   35: aload_0
    //   36: aload_1
    //   37: getfield 1018	com/tencent/mobileqq/activity/aio/SessionInfo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   40: aload_1
    //   41: getfield 1019	com/tencent/mobileqq/activity/aio/SessionInfo:jdField_a_of_type_Int	I
    //   44: invokevirtual 497	acwf:c	(Ljava/lang/String;I)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_0
    //   49: invokevirtual 182	acwf:a	()Layvj;
    //   52: iconst_0
    //   53: aload_3
    //   54: aconst_null
    //   55: ldc_w 1112
    ...
    //   73: ldc_w 1003
    //   76: aconst_null
    //   77: invokevirtual 859	ayvj:query	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   80: astore 5
    //   82: aload_0
    //   83: aload 5
    //   85: aload_1
    //   86: aload_2
    //   87: invokevirtual 1114	acwf:a	(Landroid/database/Cursor;Lcom/tencent/mobileqq/activity/aio/SessionInfo;Ljava/lang/String;)Lcom/tencent/mobileqq/data/ChatHistorySearchData;
    //   90: astore_1
    //   91: aload_1
    //   92: astore_3
    //   93: aload 5
  ...
  protected String a(Cursor paramCursor, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    if (bgnr.a(paramCursor.getInt(paramCursor.getColumnIndex("issend")))) {
  ...
  {
    return bdzv.b(paramString1, paramString2, paramString3, paramLong, paramInt);
  }
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if ((!acwh.a(paramInt1)) || (((MessageRecord)localObject2).versionCode != 3) || (((MessageRecord)localObject2).shmsgseq != l3) || (l3 == 0L)) {
            for (;;)
            {
              int j;
              long l5;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByMsgUniseqFromDB, peerUin[" + atvo.e(paramString) + "] type[" + paramInt + "] uniseq[" + paramLong + "]");
    }
    if (paramLong == 0L)
    {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localObject = ((ayvj)localObject).a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
  ...
  protected List<MessageRecord> a(String paramString1, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, String paramString2)
  {
    ...
    paramString2 = bgnn.a(d(paramString1, paramInt1), c(paramString1, paramInt1), paramLong1, paramInt2, paramLong2, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString2);
    if (paramString2 != null)
    {
      if (a(paramString1, paramInt1, true)) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.transSaveToDatabase(a());
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    for (int i = aqjq.a(paramInt1, paramInt2) << 3;; i = 0)
    {
      ...
      if (i == 0)
      {
        ...
        localObject1 = ((ayvj)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, (QQAppInterface)localObject3);
        if (QLog.isColorLevel())
        {
      ...
      for (paramInt1 = 0;; paramInt1 = ((List)localObject1).size())
      {
        ...
        localObject1 = ((StringBuilder)localObject1).toString();
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        localObject1 = ((ayvj)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2), String.valueOf(i) }, (QQAppInterface)localObject3);
        break;
      }
    }
  }
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, bctq parambctq)
  {
    Lock localLock = a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = c(paramString, paramInt, parambctq);
      return paramString;
    }
    finally
    {
  ...
  public List<MessageRecord> a(String paramString, int paramInt, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfInt.hasNext())
      {
        ...
        if (((!acwh.a(paramInt)) || (((MessageRecord)localObject).versionCode != 3) || (((MessageRecord)localObject).shmsgseq != l) || (l == 0L)) && ((paramString.contains(Integer.valueOf(((MessageRecord)localObject).msgtype))) || (paramString.isEmpty()))) {
  ...
  {
    return this.jdField_a_of_type_Acwe.b();
  }
  
  protected Lock a(String paramString, int paramInt)
  {
    return this.jdField_a_of_type_Acwe.a(paramString, paramInt);
  }
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    if ((localList != null) && (localList.size() == 0))
    {
      ...
      a().remove(a(paramString, paramInt));
      a(paramString, paramInt, b(paramString, paramInt, new bctq()));
    }
  }
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    for (String str1 = "shmsgseq";; str1 = "time")
    {
      ...
      if ((!acwh.b(paramInt)) || (acwh.d() == null)) {
        break;
      }
      a(paramString, paramInt, str3, localContentValues, String.format("isread=? and %s<=? and " + acwh.d(), new Object[] { str1 }), new String[] { "0", str2 }, null);
      return;
    }
  ...
  protected void a(String paramString, int paramInt1, MessageRecord paramMessageRecord, int paramInt2)
  {
    ...
    if (((paramInt1 == 1001) || (paramInt1 == 10002)) && (paramMessageRecord.msgtype != -1003) && (paramMessageRecord.msgtype != -1031) && (paramMessageRecord.msgtype != -1032) && (paramMessageRecord.msgtype != 201)) {
      ...
      {
        str = c(String.valueOf(anhk.H), 1001);
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        str = d(String.valueOf(anhk.H), 1001);
        break;
        if (paramInt1 == 1009)
        {
          a(paramString, paramInt1, c(anhk.w, 1009), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else if (paramInt1 == 1010)
        {
          a(paramString, paramInt1, c(anhk.ab, 1010), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else
        {
          if ((paramInt1 != 0) || (!TextUtils.equals(paramString, anhk.M))) {
            break label315;
          }
          a(paramString, paramInt1, c(anhk.M, 0), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
      }
      if ((paramInt1 == 1032) && (TextUtils.equals(paramString, anhk.aM)))
      {
    ...
    paramInt2 = aqjq.a(paramInt1, paramInt2) << 3;
    a(paramString, paramInt1, c(anhk.aM, 1032), localContentValues, "senderuin=? and isread=? and (extLong & 4194296)=? ", new String[] { paramString, "0", Integer.toString(paramInt2) }, null);
  ...
  {
    if ((acwh.o(paramMessageRecord.msgtype)) && (!acwh.b(paramMessageRecord.frienduin, paramMessageRecord.istroop))) {}
    while (!paramBoolean2) {
      return;
    }
    if (paramBoolean1)
  ...
  protected void a(String paramString1, String paramString2, List<MessageRecord> paramList, long paramLong)
  {
    ...
    if (bgso.a())
    {
      bbyr localbbyr2 = (bbyr)bbyp.b.get(paramString2);
      bbyr localbbyr1 = localbbyr2;
      if (localbbyr2 == null) {
        localbbyr1 = new bbyr();
      }
      localbbyr1.jdField_a_of_type_JavaLangString = paramString1;
      localbbyr1.jdField_a_of_type_Boolean = false;
      if (!paramList.isEmpty()) {
        bool = true;
      }
      localbbyr1.b = bool;
      localbbyr1.jdField_a_of_type_Long = ((System.nanoTime() - paramLong) / 1000000L);
      bbyp.b.put(paramString2, localbbyr1);
    }
  }
  
  public void a(List<MessageRecord> paramList, ProxyListener paramProxyListener)
  {
    b(acwh.a(paramList), paramProxyListener);
  }
  ...
  {
    return bgnn.a(c(paramString, paramInt), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
  }
  ...
  protected boolean a(String paramString1, int paramInt, String paramString2, List<MessageRecord> paramList)
  {
    ...
    if ((!a().containsKey(paramString2)) && (localbauy.a(paramString1)))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
      {
        ...
        if (i < localVector.size())
        {
          ...
          if ((acwh.a(localMsgQueueItem.frindUin, paramString, localMsgQueueItem.type, paramInt)) && ((localMsgQueueItem.action == 1) || (localMsgQueueItem.action == 2) || ((paramBoolean) && (localMsgQueueItem.action == 0))))
          {
            if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            MessageRecord localMessageRecord = (MessageRecord)localMsgQueueItem.item;
            if ((acwh.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt)) && (localMsgQueueItem.action == 0) && (localMessageRecord.time > paramLong) && (!localMessageRecord.isread) && (!localMessageRecord.isSend())) {
              i += 1;
            }
          }
        }
  ...
  public MessageRecord b(String paramString, int paramInt)
  {
    ...
    if (a(str1, false)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.transSaveToDatabase(this.jdField_a_of_type_Ayvj);
    }
    String str2 = acwh.b();
    if (acwh.a(paramInt)) {}
  ...
  public MessageRecord b(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (acwh.a(paramInt))
    {
      localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(acwh.a()).append(" ");
      if (paramString2 != null) {}
    ...
    StringBuilder localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(acwh.a()).append(" ");
    if (paramString2 != null) {}
    for (paramString1 = "and " + paramString2;; paramString1 = "")
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, bctq parambctq)
  {
    Lock localLock = a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = d(paramString, paramInt, parambctq);
      return paramString;
    }
    finally
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, List<Long> paramList)
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject = new StringBuilder().append("queryMessagesByMsgUniseqFromDB, peerUin[").append(atvo.e(paramString)).append("] type[").append(paramInt).append("] uniseqList[");
      if (paramList == null)
      {
        i = 0;
  ...
  {
    if ((this.jdField_a_of_type_Ayvj != null) && (this.jdField_a_of_type_Ayvj.isOpen())) {
      this.jdField_a_of_type_Ayvj.close();
    }
  }
  ...
  protected List<MessageRecord> c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          MessageRecord localMessageRecord = (MessageRecord)localMsgQueueItem.item;
          if ((acwh.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt1)) && (localMsgQueueItem.action == 0) && ((paramInt2 <= 0) || (localMessageRecord.getConfessTopicId() == paramInt2))) {
            localArrayList.add(localMessageRecord);
          }
        }
      }
  ...
  protected List<MessageRecord> c(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    for (;;)
    {
      localObject = a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      paramString2 = ((ayvj)localObject).a(paramString2, new String[] { String.valueOf(paramLong), String.valueOf(l) }, localQQAppInterface);
      if (paramString2 == null) {
        break label299;
      }
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> c(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = ((ayvj)localObject).a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    paramString = (String)localObject;
    if (localObject == null) {
      paramString = new ArrayList();
    }
  ...
  protected void c(String paramString, int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      List localList = acwh.a((List)localObject1, paramList);
      Iterator localIterator = localList.iterator();
      while (localIterator.hasNext())
      {
      ...
      if (aklj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) {
      ...
      if ((paramInt == 0) && (((List)localObject1).size() > 0) && (auxd.a((MessageRecord)((List)localObject1).get(0)))) {
        paramInt = localList.size() - 1;
      }
      while (paramInt >= 0)
      {
        acwh.a((List)localObject1, (MessageRecord)localList.get(paramInt), true);
        paramInt -= 1;
        continue;
  ...
  public MessageRecord d(String paramString, int paramInt, long paramLong)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if ((localMessageRecord.shmsgseq == paramLong) && (!acwh.a(localMessageRecord))) {
          return localMessageRecord;
        }
      }
    }
  ...
  public List<MessageRecord> d(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Object localObject1 = "select * from " + paramString + " where (shmsgseq < ? and msgtype " + acwh.b() + " and isValid=1) order by shmsgseq desc limit ";
    ...
    for (;;)
    {
      ...
      {
        aywe localaywe = (aywe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
        if (localaywe != null)
        {
          localObject1 = localaywe.a().a((String)localObject1 + (paramInt2 - paramString.size()), (String[])localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          if (QLog.isColorLevel())
          {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt1, int paramInt2)
  {
    ...
    ayvj localayvj = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localayvj.a((String)localObject, new String[] { String.valueOf(-2006), String.valueOf(paramInt2) }, localQQAppInterface);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> e(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    paramString = "select * from " + (String)localObject2 + " where (shmsgseq >= ? and msgtype " + acwh.b() + " and isValid=1) order by shmsgseq asc limit " + (paramInt2 + 1);
    ...
    for (;;)
    {
      ...
      if (localaywe != null)
      {
        localObject2 = "select * from " + (String)localObject2 + " where (shmsgseq > ? and msgtype " + acwh.b() + " and isValid=1) order by shmsgseq asc limit " + paramInt2;
        localObject1 = localaywe.a().a((String)localObject2, (String[])localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel())
        {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    int i = 0;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByTimeFromDB, peerUin[" + atvo.e(paramString) + "] type[" + paramInt + "] time[" + paramLong1 + "] uid[" + paramLong2 + "]");
    }
    ...
    ayvj localayvj = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localayvj.a((String)localObject, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByTimeFromDB, peerUin[").append(atvo.e(paramString)).append("] type[").append(paramInt).append("] time[").append(paramLong1).append("] uid[").append(paramLong2).append("], list.size():");
      if (localObject != null) {
        break label287;
      }
    }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 141	acwf:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   4: invokevirtual 637	com/tencent/mobileqq/app/proxy/ProxyManager:transSaveToDatabase	()V
    //   7: aload_0
    //   8: getfield 141	acwf:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   11: invokevirtual 1984	com/tencent/mobileqq/app/proxy/ProxyManager:clearMsgQueue	()V
    //   14: aload_0
    //   15: invokevirtual 182	acwf:a	()Layvj;
    //   18: invokevirtual 1988	ayvj:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   21: astore 11
    //   23: aload_0
    //   24: getfield 279	acwf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   27: invokevirtual 1991	com/tencent/mobileqq/app/QQAppInterface:getWritableDatabase	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   30: astore 12
    //   32: aload 12
    //   34: invokevirtual 1997	com/tencent/mobileqq/app/SQLiteDatabase:getAllTableNameFromCache	()[Ljava/lang/String;
    //   37: astore 13
    //   39: aload 13
    //   41: ifnonnull +4 -> 45
    //   44: return
    //   45: aload_0
    //   46: getfield 279	acwf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   49: sipush 201
    //   52: invokevirtual 769	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   55: checkcast 874	aywe
    //   58: astore 14
    //   60: iconst_0
    //   61: istore_1
    //   62: iload_1
    ...
    //   75: aload 15
    //   77: ldc_w 1999
    //   80: invokevirtual 153	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   83: ifeq +449 -> 532
    ...
    //   167: aload 8
    //   169: aconst_null
    //   170: invokevirtual 2008	com/tencent/mobileqq/app/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   173: astore 9
    //   175: aload 9
    //   177: ifnull +170 -> 347
    //   180: aload 9
    //   182: astore 8
    //   184: aload 9
    //   186: invokeinterface 864 1 0
    //   191: ifle +156 -> 347
    //   194: aload 9
    //   196: astore 8
    //   198: aload 9
    //   200: invokeinterface 1059 1 0
    //   205: pop
    //   206: aload 9
    //   208: astore 8
    //   210: aload 9
    //   212: aload 9
    //   214: ldc_w 2010
    //   217: invokeinterface 2013 2 0
    //   222: invokeinterface 2017 2 0
    //   227: lstore 6
    //   229: aload 9
    //   231: astore 8
    //   233: aload 9
    //   235: aload 9
    //   237: ldc_w 2018
    //   240: invokeinterface 2013 2 0
    //   245: invokeinterface 1323 2 0
    //   250: astore 10
    //   252: aload 9
    //   254: astore 8
    //   256: aload 9
    //   258: aload 9
    //   260: ldc_w 2019
    //   263: invokeinterface 2013 2 0
    //   268: invokeinterface 1099 2 0
    //   273: istore_2
    //   274: aload 9
    //   276: astore 8
    //   278: aload 9
    //   280: aload 9
    //   282: ldc_w 1324
    //   285: invokeinterface 2013 2 0
    //   290: invokeinterface 1099 2 0
    //   295: istore_3
    //   296: lload 6
    //   298: lstore 4
    //   300: aload 9
    //   302: astore 8
    //   304: iload_2
    //   305: invokestatic 828	acwh:a	(I)Z
    //   308: ifne +20 -> 328
    //   311: lload 6
    //   313: lstore 4
    //   315: iload_3
    ...
    //   330: astore 8
    //   332: aload_0
    //   333: getfield 279	acwf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   336: invokevirtual 284	com/tencent/mobileqq/app/QQAppInterface:a	()Lbbyp;
    //   339: aload 10
    //   341: iload_2
    //   342: lload 4
    //   344: invokevirtual 2023	bbyp:a	(Ljava/lang/String;IJ)V
    //   347: aload 9
    //   349: ifnull +10 -> 359
    //   352: aload 9
    //   354: invokeinterface 867 1 0
    //   359: aload 11
    //   361: ifnull +8 -> 369
    //   364: aload 11
    //   366: invokevirtual 2028	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   369: aload 12
    //   371: aload 15
    //   373: aconst_null
    //   374: aconst_null
    //   375: invokevirtual 2031	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   378: pop
    //   379: aload 11
    //   381: ifnull +8 -> 389
    //   384: aload 11
    //   386: invokevirtual 2034	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   389: aload 11
    //   391: ifnull +8 -> 399
    //   394: aload 11
    //   396: invokevirtual 2037	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   399: aload 14
    //   401: ifnull +13 -> 414
    //   404: aload 14
    //   406: aload 15
    //   408: aconst_null
    //   409: aconst_null
    //   410: invokevirtual 897	aywe:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   413: pop
    //   414: iload_1
    //   415: iconst_1
    //   416: iadd
    ...
    //   428: astore 8
    //   430: aload 10
    //   432: invokevirtual 1096	java/lang/Exception:printStackTrace	()V
    //   435: aload 9
    //   437: ifnull -78 -> 359
    //   440: aload 9
    //   442: invokeinterface 867 1 0
    //   447: goto -88 -> 359
    //   450: astore 9
    //   452: aconst_null
    //   453: astore 8
    ...
    //   457: ifnull +10 -> 467
    //   460: aload 8
    //   462: invokeinterface 867 1 0
    //   467: aload 9
    //   469: athrow
    //   470: astore 8
    //   472: aload 8
    //   474: invokevirtual 1096	java/lang/Exception:printStackTrace	()V
    ...
    //   486: ldc_w 2039
    //   489: aload 8
    //   491: invokestatic 1256	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   494: aload 11
    //   496: ifnull -97 -> 399
    //   499: aload 11
    //   501: invokevirtual 2037	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   504: goto -105 -> 399
    //   507: astore 8
    //   509: aload 11
    //   511: ifnull +8 -> 519
    //   514: aload 11
    //   516: invokevirtual 2037	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   519: aload 8
    //   521: athrow
    //   522: astore 9
    //   524: goto -69 -> 455
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + atvo.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    ayvj localayvj = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localayvj.a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + atvo.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    ...
    ayvj localayvj = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localayvj.a((String)localObject, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByShmsgseqFromDB, peerUin[").append(atvo.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
      if (localObject != null) {
        break label261;
      }
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB4Troop, peerUin[" + atvo.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    if ((paramLong == 0L) && (QLog.isColorLevel())) {
    ...
    paramString = "select * from " + c(paramString, paramInt) + " where shmsgseq=? and msgtype " + acwh.c();
    ayvj localayvj = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localayvj.a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if ((paramString != null) && (paramString.size() > 0)) {
      return (MessageRecord)paramString.get(0);
    }
    return null;
  ...
  public MessageRecord j(String paramString, int paramInt, long paramLong)
  {
    ...
    Object localObject2 = (aywe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    if (localObject2 != null)
    {
      if (QLog.isColorLevel()) {
      ...
      localObject2 = ((aywe)localObject2).a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      localObject1 = ((ayvj)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
      if (QLog.isColorLevel())
      {
        paramString = new StringBuilder().append("queryMsgItemHistoryByShmsgseq, slow db return peerUin[").append(atvo.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
        if (localObject1 != null) {
          break label211;
        }
      }
