...
public class ambc
{
  ...
  {
    return alnr.b(paramQQAppInterface);
  }
  
  public static alrq a(String paramString1, QQAppInterface paramQQAppInterface, int paramInt, String paramString2)
  {
    for (;;)
    {
      try
  ...
  public static amal a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return (amal)((amaz)paramQQAppInterface.getManager(249)).a().a(0);
  }
  
  public static amar a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {}
    do
    {
  ...
  public static amau a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return ((amaz)paramQQAppInterface.getManager(249)).a();
  }
  
  public static amav a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
  ...
  public static amaz a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      return null;
    }
    return (amaz)paramQQAppInterface.getManager(249);
  }
  ...
  public static ApolloActionData a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    return ((amir)paramQQAppInterface.getManager(155)).d(paramInt);
  }
  
  public static MessageForApollo a(String paramString, amau paramamau)
  {
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          ((ApolloMessage)localObject).name = bfuc.decode(paramString.getBytes("utf-8"), 0);
        }
        ...
        if (!paramString.isEmpty()) {
          ((ApolloMessage)localObject).text = bfuc.decode(paramString.getBytes("utf-8"), 0);
        }
        ...
        if (paramString == null)
        {
          ...
          paramamau = bbli.a(paramamau.a(), paramamau.a().sessionInfo.curFriendUin, paramamau.a().sessionInfo.troopUin, paramamau.jdField_a_of_type_Int, (ApolloMessage)localObject);
          paramamau.inputText = paramString.optString("inputText");
          paramamau.audioId = paramString.optInt("audioID");
          if (paramString.has("audioStartTime")) {
            paramamau.audioStartTime = ((float)paramString.optDouble("audioStartTime"));
          }
          paramamau.actionType = paramString.optInt("actionType");
          if (localJSONObject != null) {
            paramamau.extendJson = localJSONObject.toString();
          }
          if (paramString.has("mApollo3DMessage"))
          {
            ...
            paramamau.mApollo3DMessage = ((Apollo3DMessage)localObject);
          }
          return paramamau;
        }
      }
    ...
    do
    {
      for (;;)
      {
        ...
        for (str = ContactUtils.getTroopMemberNameRemarkFirst(paramQQAppInterface, paramString2, paramString1);; str = ContactUtils.getTroopMemberNameWithoutRemark(paramQQAppInterface, paramString2, paramString1))
        {
          ...
          paramString2 = ((amsw)paramQQAppInterface.getManager(51)).e(paramString1);
        ...
        ((FriendListHandler)paramQQAppInterface.getBusinessHandler(1)).getFriendInfo(paramString1, false);
        paramString2 = str;
      }
      paramString2 = str;
    } while (paramInt != 0);
  ...
  public static void a(int paramInt, Object... paramVarArgs)
  {
    ...
    ((amaz)localObject).a(i, paramVarArgs);
  }
  
  public static void a(amau paramamau, List<SpriteTaskParam> paramList)
  {
    if ((paramamau == null) || (paramList == null) || (paramList.size() == 0)) {}
    do
    {
      return;
      paramamau = a(paramamau.a());
    } while (paramamau == null);
    paramamau.a().a(paramList);
  }
  
  public static void a(ambl paramambl, int paramInt, ApolloActionData paramApolloActionData)
  {
    if (paramambl == null) {
      return;
    }
    ...
    paramApolloActionData = paramambl.a();
    ...
    paramambl.a().a(localSpriteTaskParam);
  }
  
  public static void a(ambl paramambl, String paramString, int paramInt1, int paramInt2)
  {
    if ((paramambl == null) || (paramambl.a() == null)) {
      return;
    }
    amal localamal = paramambl.a();
    paramambl.a().a(paramInt1);
    paramambl = paramambl.a();
    int i = 1;
    if (paramambl != null) {
      i = alnr.a(paramambl, paramambl.getCurrentUin());
    }
    localamal.a("", paramString, a(paramInt1, paramInt2, paramString, i));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    do
    {
      ...
      {
        return;
        localamau = a(paramQQAppInterface);
      } while (localamau == null);
      k = localamau.jdField_a_of_type_Int;
      if ((1 == k) || (3000 == k))
      {
        i = 0;
        int j;
        ...
        {
          VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "g_msg_clk", j, k, new String[] { str, paramSpriteTaskParam, String.valueOf(i), String.valueOf(System.currentTimeMillis() / 1000L), localamau.jdField_a_of_type_JavaLangString });
          return;
          i = 1;
          break;
          j = 1;
    ...
    for (int i = 0;; i = 1)
    {
      VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "msg_clk", i, 0, new String[] { Integer.toString(paramSpriteTaskParam.f), str, "", String.valueOf(System.currentTimeMillis() / 1000L), localamau.jdField_a_of_type_JavaLangString });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    if ((paramInt == 0) && (bftf.b(paramString)))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramInt != 1) && (paramInt != 0) && ((paramInt != 3000) || (alnr.c("discuss") != 1)))
    {
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString, SpriteTaskParam paramSpriteTaskParam, amau paramamau, boolean paramBoolean)
  {
    boolean bool2 = true;
    boolean bool1;
    if ((TextUtils.isEmpty(paramString)) || (paramamau == null) || (paramamau.a() == null)) {
      bool1 = false;
    }
    label111:
    do
    {
      do
      {
        ...
        {
          return bool1;
          paramamau = paramamau.a().getCurrentAccountUin();
          ...
          if ((!paramString.equals(paramSpriteTaskParam.jdField_b_of_type_JavaLangString)) || (!paramString.equals(paramamau))) {
            break;
          }
          bool1 = bool2;
      ...
      bool1 = bool2;
    } while (paramString.equals(paramamau));
    return false;
    return false;
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localSharedPreferences = localamau.jdField_a_of_type_AndroidContentSharedPreferences;
        } while (localSharedPreferences == null);
        i = localSharedPreferences.getInt("audio_tips_times" + localamau.jdField_b_of_type_JavaLangString, 0);
        if (QLog.isColorLevel()) {
          QLog.d("cmshow_scripted_SpriteUtil", 2, "totalTimes:" + i);
        }
      } while (3 == i);
      localSharedPreferences.edit().putInt("audio_tips_times" + localamau.jdField_b_of_type_JavaLangString, i + 1).commit();
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    {
      amhk.a(i, 10, 102, new Object[] { "not meet basic case" });
    ...
    do
    {
      ...
      {
        return false;
        if (2 == amge.a(paramQQAppInterface.getCurrentUin(), paramQQAppInterface))
        {
          amhk.a(i, 10, 101, new Object[] { "cmshow switch NOT opend CLOSED_STATUS" });
        ...
        amhk.a(i, 10, 104, new Object[] { "aio anonymous" });
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return false;
        if (alnr.b(BaseApplicationImpl.getContext())) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    ...
    if (1 != amge.a(paramQQAppInterface.getCurrentUin(), paramQQAppInterface))
    {
      QLog.i("cmshow_scripted_SpriteUtil", 1, "cmshow switch NOT opend.");
      return false;
    }
