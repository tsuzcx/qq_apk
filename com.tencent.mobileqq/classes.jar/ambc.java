  ...
  implements InputFilter
{
  ...
  public ambc(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    ambb localambb = ExtendEditText.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localambb == null)
    {
