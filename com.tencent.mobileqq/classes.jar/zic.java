  ...
  implements zie
{
  ...
  public zic(AppInterface paramAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(@NonNull ArrayList<zif> paramArrayList, @NonNull Context paramContext)
  {
    if (QLog.isColorLevel()) {
      QLog.e("Doodle_Strokes_CfgLineLayerStrokeStrategy", 2, "createHorizontalStroke");
    }
    if (this.jdField_a_of_type_Boolean) {
      paramArrayList.add(new zif(paramContext.getResources().getDrawable(2130846774), 1, 0));
    }
      ...
      if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
      {
        ...
        if (bool)
        {
          ...
          if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
          {
            ...
            do
            {
              localObject4 = localzif1;
              localObject5 = localObject2;
              localObject6 = localObject3;
              localObject7 = localzif2;
            ...
            {
              localObject4 = new zif(paramContext.getResources().getDrawable(2130845056), 2, i);
    ...
    for (;;)
    {
      ...
      {
        localzif1 = new zif(paramContext.getResources().getDrawable(2130845057), 2, i);
      ...
      {
        localObject4 = new zif(paramContext.getResources().getDrawable(2130845058), 2, i);
        localObject3 = localObject1;
        localObject1 = localObject2;
      ...
      {
        localObject4 = new zif(paramContext.getResources().getDrawable(2130845055), 2, i);
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
      }
      ...
      {
        localzif2 = new zif(paramContext.getResources().getDrawable(2130845054), 2, i);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
        ...
        while (i < 4)
        {
          paramArrayList.add(new zif(paramContext.getResources().getDrawable(zif.b[i]), 0, zif.a[i]));
          i += 1;
        }
        paramArrayList.add(new zif(paramContext.getResources().getDrawable(2130846766), 0, -1));
        int k = 0;
