  ...
  extends pwo
{
  ...
  axvs jdField_a_of_type_Axvs = new pwr(this);
  ...
  public pwq(Context paramContext, QQAppInterface paramQQAppInterface, pwp parampwp)
  {
  ...
  private void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localawrn.a(str, "actReadInJoyDeliverVideoCompressCover", bool, this.jdField_b_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  private void c(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localawrn.a(str, "actReadInJoyDeliverVideoUploadCover", bool, this.jdField_c_of_type_Long - this.jdField_d_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    if (!mpq.a(this.jdField_a_of_type_AndroidContentContext))
    {
    ...
    if (!atqs.a((CompressInfo)localObject)) {
      a(1001);
    }
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Axvt.i = this.jdField_a_of_type_JavaLangString;
