...
{
  public acac(ScoreQAVFragment paramScoreQAVFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.a.jdField_b_of_type_JavaLangString != null)
    {
      ...
      if (!this.a.jdField_b_of_type_JavaLangString.isEmpty()) {
        l1 = mtb.a(this.a.jdField_b_of_type_JavaLangString);
      }
    }
    paramView = bbjn.e(this.a.jdField_d_of_type_JavaLangString);
    l2 = paramView.getLong("qav_roomid", 0L);
    long l3 = paramView.getLong(ldi.g, 0L);
    axri.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_Long, this.a.jdField_b_of_type_Long, this.a.jdField_c_of_type_Long, this.a.jdField_d_of_type_Long, this.a.e, this.a.jdField_a_of_type_Int, l3, l1, l2, this.a.jdField_c_of_type_JavaLangString, this.a.jdField_a_of_type_JavaLangString);
    ...
    paramView.edit().putBoolean(ldi.l, true).commit();
    if (this.a.f != 0L) {}
    try
    {
