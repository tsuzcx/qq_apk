...
public class bfdx
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bfdx.class.getSimpleName();
  }
  
  public bfdx(List<ParagraphInfo> paramList, bfcb parambfcb, String paramString)
  {
    this.jdField_a_of_type_Bfcb = parambfcb;
        ...
        try
        {
          ...
          if ((k >= 0) && (k < ((List)localObject).size()))
          {
            ...
            if (this.jdField_a_of_type_Bfcb != null) {
              this.jdField_a_of_type_Bfcb.a((WordInfo)localObject);
            }
          }
