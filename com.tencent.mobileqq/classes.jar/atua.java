...
public class atua
{
  private static atua jdField_a_of_type_Atua;
  ...
  {
    if (jdField_a_of_type_Atua == null) {
      jdField_a_of_type_Atua = new atua();
    }
    return jdField_a_of_type_Atua;
  }
  
  private void a()
  {
    atud localatud = new atud(this);
    ThreadManagerV2.getUIHandlerV2().post(new LocalTbsViewManager.4(this, localatud));
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean1)
    {
      bdla.b(null, "dc00898", "", "", "0X800B00B", "0X800B00B", 0, 0, "", "", "", "");
      return;
    }
    if (paramBoolean2) {}
    for (int i = 1;; i = 2)
    {
      bdla.b(null, "dc00898", "", "", "0X800B00C", "0X800B00C", i, 0, "", "", "", "");
      return;
    }
  }
  ...
  public TbsReaderView a(Activity paramActivity, String paramString, atuf paramatuf)
  {
    ...
    this.jdField_a_of_type_ComTencentTbsReaderTbsReaderView = new TbsReaderView(paramActivity, new atug(this, paramatuf, paramActivity, paramString));
    ...
    paramatuf = str;
    if (str.startsWith(".")) {
      paramatuf = str.replaceFirst(".", "");
    }
    if (this.jdField_a_of_type_ComTencentTbsReaderTbsReaderView.preOpen(paramatuf, false))
    {
  ...
  public void a(int paramInt, atuf paramatuf)
  {
    ThreadManagerV2.getUIHandlerV2().post(new LocalTbsViewManager.6(this, paramInt, paramatuf));
  }
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    ...
    {
      return;
      bdla.b(null, "dc00898", "", "", "0X800AF73", "0X800AF73", 0, 0, "", "", "", "");
  ...
  public void a(Context paramContext, Bundle paramBundle, String paramString)
  {
    ...
    if (auht.a().a(paramBundle))
    {
      QLog.w("LocalTbsViewManager<FileAssistant>", 1, "downloadQQBrowser isExistedDownloadOfUrl show toast!");
      QQToast.a(paramContext, 0, 2131697966, 0).a();
      return;
    }
    Bundle localBundle = new Bundle();
    localBundle.putString("_open_with_qq_browser_", paramString);
    localBundle.putBoolean("tbs_new_report", true);
    auea.a(paramContext, paramBundle, localBundle);
    a("stat_download_start");
  }
  
  public void a(Context paramContext, Object paramObject1, Object paramObject2, String paramString, atuf paramatuf)
  {
    ...
    default: 
      return;
    case 1: 
      bdla.b(null, "dc00898", "", "", "0X800AF71", "0X800AF71", 0, 0, "", "", "", "");
      return;
    case 2: 
      bdla.b(null, "dc00898", "", "", "0X800AF72", "0X800AF72", 1, 0, "", "", "", "");
      return;
    case 4: 
      bdla.b(null, "dc00898", "", "", "0X800AF74", "0X800AF74", 0, 0, "", "", "", "");
      return;
    case 5: 
      bdla.b(null, "dc00898", "", "", "0X800AF75", "0X800AF75", 0, 0, "", "", "", "");
    ...
    a(paramObject2, paramatuf);
  }
  
  public void a(Object paramObject, Activity paramActivity, atuf paramatuf)
  {
    if (paramObject == null) {
      return;
    }
    int i = ((Bundle)paramObject).getInt("function_id");
    paramatuf.a(TbsReaderView.getResString(paramActivity, i), TbsReaderView.getResDrawable(paramActivity, i + 1), TbsReaderView.getResDrawable(paramActivity, i + 2), new atue(this, i, paramActivity));
  }
  
  public void a(Object paramObject, atuf paramatuf)
  {
    paramatuf = paramatuf.a();
    if (((paramObject instanceof ViewGroup)) && ((paramatuf instanceof View))) {
      ((ViewGroup)paramObject).addView(paramatuf);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      {
        bdla.b(null, "dc00898", "", "", "0X800AF76", "0X800AF76", 0, 0, "", "", "", "");
        return;
      }
  ...
  public boolean a(Activity paramActivity, String paramString, atuf paramatuf, boolean paramBoolean)
  {
    if (!a(true)) {}
    do
    {
    ...
    } while (paramatuf == null);
    paramatuf.b(false);
    return false;
    TbsReaderView localTbsReaderView = new TbsReaderView(paramActivity, new atub(this, paramatuf));
    paramActivity = FileUtil.getExtension(paramString);
    ...
    for (;;)
    {
      ...
      label165:
      if ((paramBoolean) && (paramatuf != null)) {
        paramatuf.b(true);
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    atuc localatuc = new atuc(this);
    paramBoolean = ReaderEngine.getInstance().fileEnginePreLoad(BaseApplicationImpl.getApplication(), localatuc, paramBoolean);
    if (paramBoolean)
    {
    ...
    bdla.b(null, "dc00898", "", "", "0X800B009", "0X800B009", 0, 0, "", "", "", "");
    return paramBoolean;
  }
