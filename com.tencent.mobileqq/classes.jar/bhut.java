  ...
  implements bcbx
{
  ...
  protected Intent a;
  private bhuv jdField_a_of_type_Bhuv;
  private boolean jdField_a_of_type_Boolean = true;
  
  static
  {
    jdField_a_of_type_ComTencentMobileqqWebprocessWebAccelerateHelper$CommonJsPluginFactory = new bhuu();
  }
  
  public bhut(Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface, boolean paramBoolean)
  {
  ...
  {
    if (this.jdField_a_of_type_Bhuv != null) {}
    try
    {
      this.jdField_a_of_type_Bhuv.a();
      return;
    }
  ...
  public void onReceivedError(WebView paramWebView, int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      this.jdField_a_of_type_Bhuv.a(paramInt, paramString1, paramString2);
      return;
    }
    catch (Exception paramWebView) {}
  }
