...
public class bhut
  extends bhzl
{
  public bhut(SendStoryActivity paramSendStoryActivity, EditText paramEditText, int paramInt)
  {
  ...
  public CharSequence filter(CharSequence paramCharSequence, int paramInt1, int paramInt2, Spanned paramSpanned, int paramInt3, int paramInt4)
  {
    ...
    Arrays.sort(arrayOfFriend, new bhuu(this, paramSpanned));
    ...
    paramInt4 = this.jdField_a_of_type_Int - bhzp.a(localStringBuilder.toString());
