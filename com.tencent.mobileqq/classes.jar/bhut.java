...
{
  private bhuq jdField_a_of_type_Bhuq = new bhuq(a());
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = this.jdField_a_of_type_Bhuq.createEntityManager();
  ...
  public EntityManager a()
  {
    if (this.jdField_a_of_type_Bhuq == null) {
      this.jdField_a_of_type_Bhuq = new bhuq(a());
    }
    if (this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager == null) {
      this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = this.jdField_a_of_type_Bhuq.createEntityManager();
    }
