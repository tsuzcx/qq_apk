...
public class bhut
{
  ...
  public static Pair<CharSequence, CharSequence> a(bcfn parambcfn)
  {
    if ((parambcfn instanceof bcec)) {
      return ((bcec)parambcfn).a();
    }
    if ((parambcfn instanceof bceb)) {
      return ((bceb)parambcfn).a();
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      {
      default: 
        return bhlg.a(paramQQAppInterface, paramString1, paramInt);
      }
      if (antf.G.equals(paramString1)) {
        return paramContext.getString(2131718503);
      }
      if (antf.J.equals(paramString1)) {
        return paramContext.getString(2131718502);
      }
      if (antf.E.equals(paramString1)) {
        return paramContext.getString(2131718534);
      }
      if (paramInt != 1000) {
        break;
      }
    ...
    return bhlg.a(paramQQAppInterface, paramString1, paramContext.b(paramString2), paramString2, true, null);
    if (paramInt == 1004)
    {
      paramContext = bhlg.c(paramQQAppInterface, paramString2, paramString1);
      if ((paramContext != null) && (paramContext.equals(paramString1))) {
        return bhlg.b(paramQQAppInterface, paramString1, true);
      }
    }
    else
    {
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localavhz = new avhz(new StringReader(paramString), paramString.length());
        paramString = null;
      }
  ...
  public static ArrayList<bhuv> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (j >= 3)
    {
      ...
      if (j >= 3)
      {
        ...
        localObject2 = bhlg.b(paramQQAppInterface, (String)localObject1, true);
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167134)), 0, paramString.length(), 17);
        localArrayList.add(new bhuv((String)localObject1, 0, new Pair(localObject2, null)));
        i = m + 1;
      }
      label193:
      paramQQAppInterface = new bclc(paramQQAppInterface, 10001, 29, null);
      paramQQAppInterface.a();
      paramQQAppInterface = paramQQAppInterface.a(new bcmq(paramString));
    ...
    for (;;)
    {
      ...
      {
        paramString = (bcfn)((Iterator)localObject1).next();
        if ((paramString.b() & 0xFFFFFFFF & 0xFF000000) >> 24 != 2L) {
          if (localArrayList.size() < i)
          {
            if ((paramString.d() == 0) || (paramString.d() == 1004))
            {
              ...
              localArrayList.add(new bhuv(paramString.b(), paramString.d(), paramQQAppInterface));
              j = m;
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            for (paramString = "null";; paramString = paramString.a())
            {
              ...
              if (((String)localObject1).toLowerCase().startsWith(paramString.toLowerCase()))
              {
                ...
                ((SpannableStringBuilder)localObject3).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167134)), 1, paramString.length() + 1, 17);
                localArrayList.add(new bhuv((String)localObject1, 0, new Pair(localObject2, localObject3)));
                i = m + 1;
                break label193;
              }
              Object localObject3 = bcni.a((String)localObject2, paramString, 1);
              if (localObject3[0] == 0)
              {
                i = localObject3[1];
                localObject2 = new SpannableStringBuilder((CharSequence)localObject2);
                ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167134)), 0, i, 17);
                localArrayList.add(new bhuv((String)localObject1, 0, new Pair(localObject2, null)));
                i = m + 1;
                break label193;
              }
              localObject3 = bcni.a((String)localObject2, paramString, 2);
              i = m;
              if (localObject3[0] != 0) {
                break label193;
              }
              ...
              i = m + 1;
              break label193;
              localArrayList.add(new bhuv(paramString.b(), paramString.d(), null));
              m = j;
              break label349;
              label767:
  ...
  public static void a(View paramView)
  {
    ...
    bhuu.jdField_c_of_type_Int = a(paramView.getContext());
    paramView = (Integer)paramView.getTag(2131381110);
    if (paramView != null) {}
    for (int i = paramView.intValue();; i = -1)
    {
      bhuu.jdField_e_of_type_Int = i + 1;
      if (bhuu.jdField_f_of_type_Int == 1)
      {
        bhuu.jdField_a_of_type_Long = bhuu.jdField_d_of_type_Long + (System.nanoTime() - bhuu.jdField_c_of_type_Long) / 1000000L;
        bhuu.jdField_b_of_type_Long = bhuu.jdField_f_of_type_Long + (System.nanoTime() - bhuu.jdField_e_of_type_Long) / 1000000L;
      }
      if (bhuu.jdField_d_of_type_Int == 1)
      {
        bhuu.h = -1;
        bhuu.i = -1;
        bhuu.j = -1;
      }
      localHashMap.put("keyNum", String.valueOf(bhuu.jdField_a_of_type_Int));
      localHashMap.put("firstKeyLen", String.valueOf(bhuu.jdField_b_of_type_Int));
      localHashMap.put("itemPage", String.valueOf(bhuu.jdField_c_of_type_Int));
      localHashMap.put("itemSearchStrategy", String.valueOf(bhuu.jdField_d_of_type_Int));
      localHashMap.put("itemPosition", String.valueOf(bhuu.jdField_e_of_type_Int));
      localHashMap.put("itemType", String.valueOf(bhuu.jdField_f_of_type_Int));
      localHashMap.put("itemUinType", String.valueOf(bhuu.g));
      if (bhuu.jdField_f_of_type_Int == 1)
      {
        localHashMap.put("totalCost", String.valueOf(bhuu.jdField_a_of_type_Long));
        localHashMap.put("searchCost", String.valueOf(bhuu.jdField_b_of_type_Long));
      }
      localHashMap.put("senderNum", String.valueOf(bhuu.h));
      localHashMap.put("friendNum", String.valueOf(bhuu.i));
      localHashMap.put("friendIndex", String.valueOf(bhuu.j));
      bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actFtsItemClickEvent", true, bhuu.jdField_a_of_type_Long, bhuu.jdField_b_of_type_Long, localHashMap, "", false);
      if ((bhuu.jdField_f_of_type_Int == 1) && (QLog.isColorLevel())) {
        QLog.d("Q.fts.utils", 2, "actFtsItemClickEvent: totalCost = " + bhuu.jdField_a_of_type_Long + ", searchCost = " + bhuu.jdField_b_of_type_Long);
      }
      return;
    }
  }
  ...
  public static boolean b()
  {
    ...
    if (a())
    {
      ...
      if (!e((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject1).put("param_ROM", bhlo.j());
        bdmc.a(BaseApplication.getContext()).a(null, "actQQInstallExternal", true, -1L, 0L, (HashMap)localObject1, null, false);
        c((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), true);
      }
    }
    Object localObject1 = bhlo.a();
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (!f((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject2).put("param_ROM", bhlo.j());
        ...
        bdmc.a(BaseApplication.getContext()).a(null, "actLowRomForFTS", true, -1L, 0L, (HashMap)localObject2, null, false);
  ...
  public static String[] b(String paramString)
  {
    ...
    paramString = new avia(new StringReader(paramString));
    try
    {
      for (;;)
      {
        avhw localavhw = paramString.a();
        if (localavhw == null) {
          break;
        }
        if (!TextUtils.isEmpty(localavhw.a()))
        {
          ((StringBuilder)localObject).append(localavhw.a());
