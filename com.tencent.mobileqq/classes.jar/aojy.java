...
public abstract class aojy
{
  ...
  public static byte a(int paramInt, String arg1)
  {
    ...
    //   2: iload_0
    //   3: iconst_1
    //   4: invokestatic 11	aojy:a	(IZ)V
    //   7: aload_1
    //   8: iload_0
    //   9: invokestatic 14	aojy:a	(I)Ljava/lang/String;
    //   12: invokestatic 17	aojy:a	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   51: iload_0
    //   52: invokestatic 14	aojy:a	(I)Ljava/lang/String;
    ...
    //   96: aload_1
    //   97: aload 6
    //   99: invokestatic 72	aojy:a	(ILjava/lang/String;Ljava/util/HashMap;)Z
    //   102: ifeq +322 -> 424
    //   105: iload_0
    //   106: invokestatic 75	aojy:a	(I)Ljava/lang/Object;
    //   109: astore_1
    //   110: aload_1
    //   111: monitorenter
    //   112: aload 6
    ...
    //   157: invokestatic 105	aojy:c	(ILjava/lang/String;)Ljava/lang/String;
    //   160: astore 7
    //   162: new 45	java/lang/StringBuilder
    //   165: dup
    //   166: invokespecial 46	java/lang/StringBuilder:<init>	()V
    //   169: iload_0
    //   170: invokestatic 14	aojy:a	(I)Ljava/lang/String;
    ...
    //   208: ifeq +211 -> 419
    //   211: aload 9
    //   213: invokestatic 114	ayja:a	(Ljava/lang/String;)Ljava/lang/String;
    //   216: astore 9
    //   218: aload 6
    ...
    //   254: iload_0
    //   255: iconst_0
    //   256: invokestatic 11	aojy:a	(IZ)V
    //   259: iload_2
    //   260: ireturn
    //   261: astore_1
    //   262: iload_0
    //   263: iconst_0
    //   264: invokestatic 11	aojy:a	(IZ)V
    ...
    //   301: iload_0
    //   302: invokestatic 14	aojy:a	(I)Ljava/lang/String;
    //   305: iconst_0
  ...
  {
    if (paramInt == 0) {
      return aokk.a(paramString, paramHashMap);
    }
    if (paramInt == 1) {
      return aokm.a(paramString, paramHashMap);
    }
    if (paramInt == 2) {
      return aokl.a(paramString, paramHashMap);
    }
    return false;
  }
  ...
  {
    if (paramInt == 0) {
      return aokk.a(paramString);
    }
    if (paramInt == 1) {
      return aokm.a(paramString);
    }
    if (paramInt == 2) {
      return aokl.a(paramString);
    }
    return "";
  }
  ...
  {
    if (paramInt == 0) {
      return aokk.b(paramString);
    }
    if (paramInt == 1) {
      return aokm.b(paramString);
    }
    if (paramInt == 2) {
      return aokl.b(paramString);
    }
    return "";
  }
}
