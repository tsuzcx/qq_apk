  ...
  implements Manager
{
  ...
  public ArrayList<bamk> a;
  protected Queue<String> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "<{text:'A',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + ajyc.a(2131715791) + "<{text:'B',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + ajyc.a(2131715792) + "<{icon:'/rose',url:'url.qq.com?rose.png',alt:'玫瑰'}>";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public bamj(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(GroupOpenSysMsg.SysMsgBody paramSysMsgBody, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    {
      MessageForArkApp localMessageForArkApp = (MessageForArkApp)axaq.a(-5008);
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    boolean bool = localaukn.a(TroopTipsEntity.class.getSimpleName(), localContentValues, "troopUin=? and msgSeq=?", new String[] { paramString1, paramString2 });
    localaukn.a();
    if (bool)
    {
  ...
  public MessageForGrayTips a(TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    do
    {
      ...
      } while (akau.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForGrayTips, false));
  ...
  public MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2, akpb paramakpb)
  {
    ...
    do
    {
        ...
        try
        {
          ...
          case 1: 
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_redtips.has())
            {
              ...
              {
                a(new bamk(this, ((TroopTipsEntity)localObject2).troopUin, paramArrayOfByte));
                return null;
              }
              ((TroopTipsEntity)localObject2).currentUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              paramQQAppInterface = (MessageForQQWalletTips)axaq.a(-2029);
              ...
              paramQQAppInterface.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((TroopTipsEntity)localObject2).troopUin, "", "[QQWallet Tips]", awzw.a(), -2029, 1, awzw.a());
            ...
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint32_robot_group_opt.has())
            {
              ...
              paramArrayOfByte = (balw)paramQQAppInterface.getManager(203);
            }
            ...
            if (j == 3)
            {
              bahk.a(paramQQAppInterface, (TroopTipsEntity)localObject2);
              return null;
            }
            if ((j == 6) && (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint64_receiver_uin.has()))
            {
              ...
              {
                azrd.a().a(String.valueOf(l1), paramQQAppInterface.getCurrentAccountUin(), true);
                ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1, paramLong);
              }
            }
            for (;;)
            {
              ...
              if ((paramBoolean1) || (!akau.a(paramQQAppInterface, paramArrayOfByte, false))) {
                break label1220;
              }
              return null;
              if (j != 11) {
      ...
      bamn.a(l1, paramQQAppInterface, paramLong);
      return null;
    ...
    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_group_notify.has())
    {
      ...
      paramArrayOfByte = ((askq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(Long.valueOf(l1), true);
      if ((paramArrayOfByte != null) && (1 == paramQQAppInterface.opt_uint32_auto_pull_flag.get()))
      {
        ...
        ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(67, true, new Object[] { String.valueOf(l1), paramQQAppInterface.opt_bytes_feeds_id.get().toStringUtf8(), Integer.valueOf(paramQQAppInterface.opt_uint32_auto_pull_flag.get()) });
        break label3381;
        if (!paramBoolean2)
        {
          if (paramakpb != null) {
          ...
          {
            paramakpb = (TroopTips0x857.MessageRecallReminder)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_recall.get();
            paramLong = paramakpb.uint64_uin.get();
            paramInt = paramakpb.uint32_op_type.get();
            paramQQAppInterface = new HashMap();
            try
            {
              paramArrayOfByte = new msgrevoke_userdef.MsgInfoUserDef();
              paramArrayOfByte.mergeFrom(paramakpb.bytes_userdef.get().toByteArray());
            ...
            paramakpb = ((ArrayList)paramakpb.uint32_recalled_msg_list.get()).iterator();
            while (paramakpb.hasNext())
            {
              localObject2 = (TroopTips0x857.MessageRecallReminder.MessageMeta)paramakpb.next();
            ...
            {
              paramakpb = (TroopTips0x857.NotifyObjmsgUpdate)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_objmsg_update.get();
              if (paramakpb.bytes_ext_msg.has())
              {
                paramArrayOfByte = new SubMsgType0xaa.MsgBody();
                try
                {
                  paramArrayOfByte.mergeFrom(paramakpb.bytes_ext_msg.get().toByteArray());
                  ((aqug)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
                }
                catch (Exception paramakpb)
                {
                  for (;;)
                  {
                    if (QLog.isColorLevel()) {
                ...
                if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.has())
                {
                  ...
                  ((bcic)paramQQAppInterface.a(107)).a((TroopTips0x857.WereWolfPush)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.get(), paramArrayOfByte);
                  break label3381;
                  if (QLog.isColorLevel()) {
                  ...
                  if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_stcm_game_state.has())
                  {
                    ...
                    {
                      ((airv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a(0, 1, Long.toString(l1), paramQQAppInterface);
                      break label3381;
                      if (QLog.isColorLevel()) {
                      ...
                      if (((TroopTips0x857.NotifyMsgBody)localObject1).apllo_msg_push.has())
                      {
                        ...
                        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
                        {
                          ((aist)paramQQAppInterface.getManager(227)).a(1, paramArrayOfByte);
                          break label3381;
                          if (QLog.isColorLevel()) {
                          ...
                          if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.has())
                          {
                            ...
                            {
                              ahbe.a(1, (TroopTips0x857.GoldMsgTipsElem)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.get(), null);
                              break label3381;
                              if (QLog.isColorLevel()) {
                              ...
                              if (paramBoolean1)
                              {
                                ...
                                {
                                  ((akhq)paramQQAppInterface.a(20)).a(String.valueOf(l1), false, "", false, true, false, true);
                                  break label3381;
                                  if (QLog.isColorLevel()) {
                                  ...
                                  {
                                    ayfv.a(paramQQAppInterface, (TroopTips0x857.TroopFormGrayTipsInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_troopformtips_push.get(), ((TroopTipsEntity)localObject2).troopUin);
                                    break label3381;
                                    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.has())
                                    {
                                      arrj.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.MediaChangePushInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.get());
                                    }
                                    else
                                    {
                                      ...
                                      if (paramBoolean1)
                                      {
                                        try
                                        {
                                          paramakpb = (TroopTips0x857.GeneralGrayTipInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_general_gray_tip.get();
                                          if (paramakpb.uint64_busi_type.has())
                                          {
                                            l1 = paramakpb.uint64_busi_type.get();
                                            if (!paramakpb.uint64_busi_id.has()) {
                                              break label2825;
                                            }
                                            l2 = paramakpb.uint64_busi_id.get();
                                            if (!paramakpb.uint32_ctrl_flag.has()) {
                                              break label2831;
                                            }
                                            paramInt = paramakpb.uint32_ctrl_flag.get();
                                            if (paramakpb.uint32_c2c_type.has()) {
                                              paramakpb.uint32_c2c_type.get();
                                            }
                                            if (paramakpb.uint32_service_type.has()) {
                                              paramakpb.uint32_service_type.get();
                                            }
                                            if (!paramakpb.bytes_pb_reserv.has()) {
                                              break label2836;
                                            }
                                            paramArrayOfByte = paramakpb.bytes_pb_reserv.get().toByteArray();
                                            if (!paramakpb.bytes_content.has()) {
                                              break label2841;
                                            }
                                            paramakpb = paramakpb.bytes_content.get().toByteArray();
                                            localObject1 = "";
                                            if ((paramakpb == null) || (paramakpb.length <= 0)) {
                                              break label2847;
                                            }
                                            paramakpb = new String(paramakpb, "utf-8");
                                            paramInt = aqva.a(paramInt);
                                            paramakpb = aqva.a(paramakpb);
                                            paramArrayOfByte = aqva.a(paramQQAppInterface, ((TroopTipsEntity)localObject2).troopUin, 1, paramInt, paramLong, paramakpb, l1, l2, paramArrayOfByte);
                                            if (paramArrayOfByte == null) {
                                              break label3381;
                                            }
                                            ...
                                            axqw.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", 3, 0, "" + l2, "" + l1, "", "");
                                            aqva.a(paramQQAppInterface, paramArrayOfByte);
                                          }
                                        }
                                      ...
                                      else
                                      {
                                        ...
                                        {
                                          paramArrayOfByte = ((ayna)paramQQAppInterface.getManager(339)).a(2);
                                          if (paramArrayOfByte != null) {
                                        ...
                                        else
                                        {
                                          ...
                                          {
                                            paramArrayOfByte = ((ayna)paramQQAppInterface.getManager(339)).a(4);
                                            if (paramArrayOfByte != null) {
                                          ...
                                          else
                                          {
                                            ...
                                            if ((paramQQAppInterface != null) && (paramQQAppInterface.uint32_group_honor_switch.has()))
                                            {
                                              ...
                                              paramQQAppInterface = (bacv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346);
                                              if (paramInt != 0) {
                                                break label3385;
                                              }
                                              paramBoolean1 = true;
                                              ...
                                              break label3381;
                                              arve.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.NotifyMsgBody)localObject1);
                                              break label3381;
                                              if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.has())
                                              {
                                                paramakpb = (TroopTips0x857.GroupAnnounceTBCInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.get();
                                                if (paramakpb != null) {
                                                  if (!paramakpb.feeds_id.has()) {
                                                    break label3394;
                                                  }
                                                }
                                              }
    ...
    label3385:
    label3394:
    for (paramArrayOfByte = paramakpb.feeds_id.get().toStringUtf8();; paramArrayOfByte = null)
    {
      paramLong = paramakpb.group_id.get();
      paramInt = paramakpb.action.get();
      switch (paramInt)
      {
      case 0: 
        balq.b(paramQQAppInterface, paramArrayOfByte, String.valueOf(paramLong), 1);
        break;
      case 1: 
      case 2: 
  ...
  public List<TroopTipsEntity> a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = ((aukn)localObject).a(TroopTipsEntity.class, true, "troopUin=? and read=? and currentUin=?", new String[] { paramString, "0", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }, null, null, "time ASC", null);
      ((aukn)localObject).a();
  ...
  public void a(bamk parambamk)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopTipsMsgMgr", 2, "addWalletTipsCache");
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(parambamk);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      TroopTips0x857.RedGrayTipsInfo localRedGrayTipsInfo = localbamk.jdField_a_of_type_TencentImOidbCmd0x857TroopTips0x857$RedGrayTipsInfo;
      String str = paramQQAppInterface.getCurrentAccountUin();
      MessageForQQWalletTips localMessageForQQWalletTips = (MessageForQQWalletTips)axaq.a(-2029);
      ...
      localMessageForQQWalletTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localbamk.jdField_a_of_type_JavaLangString, "", "[QQWallet Tips]", awzw.a(), -2029, 1, awzw.a());
  ...
  public void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    localaukn.a(paramTroopTipsEntity);
    localaukn.a();
  }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    aukn localaukn = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    Cursor localCursor = localaukn.a(true, TroopTipsEntity.class.getSimpleName(), new String[] { "troopUin" }, "read=?", new String[] { String.valueOf(0) }, "troopUin", null, null, null);
    if (localCursor != null) {}
    for (;;)
    {
      try
