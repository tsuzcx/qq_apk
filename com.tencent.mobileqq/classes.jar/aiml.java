...
public class aiml
{
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, aimm paramaimm)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(BaseApplicationImpl.getContext(), aijp.class);
      ...
      paramString.setObserver(paramaimm);
