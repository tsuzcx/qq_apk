...
public class qrc
{
  ...
  public static void a(Context paramContext, ppu paramppu, ViewGroup.LayoutParams paramLayoutParams)
  {
    a(paramContext, paramppu, paramLayoutParams, null);
  }
  
  public static void a(Context paramContext, ppu paramppu, ViewGroup.LayoutParams paramLayoutParams, View paramView)
  {
    ...
    paramLayoutParams.height = paramContext.getResources().getDimensionPixelSize(2131298667);
    int i = paramppu.a();
    int j = paramppu.b();
  ...
  public static void a(ppu paramppu, RingAvatarView paramRingAvatarView, ImageView paramImageView)
  {
    if ((paramRingAvatarView == null) || (paramImageView == null) || (paramppu == null)) {}
    do
    {
      return;
      paramppu = paramppu.a();
  ...
  public static void a(qyl paramqyl, ReadInJoyYAFolderTextView paramReadInJoyYAFolderTextView, qno paramqno, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    if (ozs.a(paramqyl))
    {
      List localList = paramqyl.jdField_a_of_type_Qxr.a;
      ...
      {
        paramqyl = paramSpannableStringBuilder.substring(1);
        localStringBuilder.append(paramqyl);
        ...
        paramqyl = bhlg.b((QQAppInterface)ozs.a(), String.valueOf(l), true);
        paramSpannableStringBuilder = "@" + paramqyl;
        paramqyl = paramSpannableStringBuilder;
      ...
      {
        localStringBuilder.append(paramqyl).append(paramSpannableStringBuilder);
        paramSpannableStringBuilder = new qpo();
        paramSpannableStringBuilder.jdField_a_of_type_Int = j;
        paramSpannableStringBuilder.b = (paramqyl.length() + j);
      ...
      label329:
      paramqyl = new SpannableStringBuilder(new begp(localStringBuilder, 7, 16));
      paramSpannableStringBuilder = ((List)localObject).iterator();
      while (paramSpannableStringBuilder.hasNext())
      {
        localObject = (qpo)paramSpannableStringBuilder.next();
        paramqyl.setSpan(new qnq(((qpo)localObject).jdField_a_of_type_Long, -3355444, paramqno), ((qpo)localObject).jdField_a_of_type_Int, ((qpo)localObject).b, 17);
      }
      localSpannableStringBuilder.append(paramqyl);
    }
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramqyl.jdField_a_of_type_JavaLangString)) {
        try
        {
          localSpannableStringBuilder.append(new begp(bcsa.b(paramqyl.jdField_a_of_type_JavaLangString), 7, 16));
        }
        catch (Exception paramqyl)
        {
          QLog.d("UtilsForComponent", 1, "parse bytes_comments failed ", paramqyl);
        }
      }
    }
  }
  ...
  {
    return (sel.a(paramArticleInfo) == 23) || (sel.b(paramArticleInfo) == 56);
  }
