  ...
  implements Manager
{
  ...
  private SosoInterface.OnLocationListener jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new aocg(this, 3, true, true, 60000L, false, false, "TroopNotifyAndRecommendView");
  ...
  public aoce(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramQQAppInterface = paramQQAppInterface.getMessageFacade().getMsgList(AppConstants.RECOMMEND_TROOP_UIN, 4001);
    int j;
  ...
  private void a(long paramLong, oidb_0x935.RspBody paramRspBody)
  {
    ...
    this.jdField_a_of_type_Aoep.notifyUI(29, true, this.jdField_b_of_type_JavaUtilList);
  }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      localObject1 = new NewIntent(paramAppInterface.getApplication(), nta.class);
      ...
      try
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          if (k == 0)
          {
            ...
            localObject = bcsa.a(-1039);
            String str = localRecommendTroopInfo.name;
            ((MessageRecord)localObject).extStr = localRecommendTroopInfo.uin;
            ((MessageRecord)localObject).init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), AppConstants.RECOMMEND_TROOP_UIN, "0", str, paramLong, -1039, 4001, 0L);
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (k >= 0)
      {
        ...
        if (paramHashMap.msgtype == -1039)
        {
          ...
          if (j > paramInt)
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().removeMsgByUniseq(paramHashMap.frienduin, paramHashMap.istroop, paramHashMap.uniseq);
  ...
  private void e()
  {
    ...
    try
    {
      ...
      Object localObject = (aqxv)aqxe.a().a(691);
      if ((localObject == null) || (!((aqxv)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getConversationFacade().d(AppConstants.TROOP_NOTIFICATION_UIN, 9000, b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
        localObject = (aocd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECENT_MANAGER_FOR_3RDPART);
        MessageRecord localMessageRecord = a();
        if ((localMessageRecord != null) && (!((aocd)localObject).a(AppConstants.TROOP_NOTIFICATION_UIN, 9000, localMessageRecord.time))) {
          ((aocd)localObject).a(AppConstants.TROOP_NOTIFICATION_UIN, 9000, anvx.a(2131691074), localMessageRecord.time, localMessageRecord.time);
        }
        if (QLog.isColorLevel()) {
          QLog.d("RecommendTroopManagerImp", 1, "pushRecommendUnreadMessage, add notification node to recent");
        }
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          continue;
          if (QLog.isColorLevel()) {
            QLog.d("RecommendTroopManagerImp", 1, "pushRecommendUnreadMessage, no add notification node to recent");
          }
        }
      }
    }
  ...
  public MessageRecord a()
  {
    try
    {
      List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgList(AppConstants.RECOMMEND_TROOP_UIN, 4001);
      if ((localList != null) && (localList.size() > 0))
      {
        int i = localList.size() - 1;
        while (i >= 0)
  ...
  public String a()
  {
    try
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgList(AppConstants.RECOMMEND_TROOP_UIN, 4001);
  ...
  public void a(int paramInt1, oidb_0x935.GPS paramGPS, int paramInt2, BusinessObserver paramBusinessObserver)
  {
    ...
    for (long l1 = ((Long)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt1)).longValue();; l1 = 0L)
    {
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), nta.class);
  ...
  {
    a(2, paramGPS, paramInt, new aocf(this, paramLong));
  }
  ...
  public void a(List<group_activity.GroupAct> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        paramList = bcsa.a(-1040);
        paramList.extStr = ((RecTroopBusinessItem)localObject).id;
        paramList.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), AppConstants.RECOMMEND_TROOP_UIN, "0", ((RecTroopBusinessItem)localObject).title, l, -1040, 4001, 0L);
        localArrayList.add(paramList);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().clearRecommendTroopMsgByMsgType(-1040);
      }
      ...
      if ((localArrayList.size() >= 1) || ((localArrayList.size() == 1) && (localObject == null)))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().clearRecommendTroopMsgByMsgType(-1039);
      }
      for (;;)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage(localArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
        this.jdField_a_of_type_JavaUtilList.clear();
        f();
        e();
        return;
        label396:
        a(paramList, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgList(AppConstants.RECOMMEND_TROOP_UIN, 4001));
      }
      paramList = null;
    }
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setRecommendTroopMsgReaded(-1039);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setRecommendTroopMsgReaded(-1040);
