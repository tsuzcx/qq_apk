  ...
  extends bjbe
{
  ...
  public List<bjci> a;
  private bjci jdField_b_of_type_Bjci;
  protected Object b;
  String d;
  String e;
  ...
  static
  {
    ...
    File localFile = new File(ahwa.d);
    h = localFile.getPath();
  ...
  private ArrayList<bjci> a(ArrayList<bjci> paramArrayList)
  {
    ArrayList localArrayList = new ArrayList();
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      bjci localbjci = b((bjci)paramArrayList.next());
      if ((localbjci != null) && (localbjci.jdField_a_of_type_JavaUtilList.size() > 0)) {
        localArrayList.add(localbjci);
  ...
  public static List<bjci> a(bkyy parambkyy, String paramString)
  {
      ...
      try
      {
        ...
        if (parambkyy != null)
        {
          if (((JSONObject)localObject).has("guide_video_url")) {
            parambkyy.d = ((JSONObject)localObject).getString("guide_video_url");
          }
          if (((JSONObject)localObject).has("guide_video_md5")) {
            parambkyy.e = ((JSONObject)localObject).getString("guide_video_md5");
          }
        }
        ...
        parambkyy = paramString.optString("bighead_model_resurl", "");
        ...
        a((List)localObject, str, parambkyy, paramString);
        return localObject;
      }
      catch (JSONException parambkyy) {}
      if (!QLog.isColorLevel()) {
        break;
      }
      parambkyy.printStackTrace();
      return null;
      label152:
      String str = "";
      paramString = "";
  ...
  static List<bjci> a(JSONArray paramJSONArray)
  {
      ...
      if (j < k) {
        try
        {
          ...
          if (((JSONObject)localObject).has("content")) {
            localbjci.jdField_a_of_type_JavaUtilList = PtvTemplateManager.PtvTemplateInfo.convertFrom(((JSONObject)localObject).getJSONArray("content"));
          }
          if (((JSONObject)localObject).has("categoryName")) {
            localbjci.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).getString("categoryName");
          }
          if ((((JSONObject)localObject).has("TipsVer")) && (((JSONObject)localObject).has("Tips")))
          {
            localbjci.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("TipsVer");
            localbjci.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).getString("Tips");
          }
          localbjci.jdField_b_of_type_Boolean = "1".equals(((JSONObject)localObject).optString("random_position"));
          if (((JSONObject)localObject).has("categoryId"))
          {
            localbjci.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("categoryId");
            if ((localbjci.jdField_a_of_type_JavaUtilList != null) && (!localbjci.jdField_a_of_type_JavaUtilList.isEmpty()))
            {
              localObject = localbjci.jdField_a_of_type_JavaUtilList.iterator();
              while (((Iterator)localObject).hasNext())
              {
                ((PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next()).categoryId = localbjci.jdField_a_of_type_Int;
                continue;
                return localArrayList;
              }
            }
  ...
  private static void a(List<bjci> paramList, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      Object localObject = (bjci)paramList.next();
      if ((((bjci)localObject).jdField_a_of_type_JavaUtilList == null) || (((bjci)localObject).jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break;
      }
      localObject = ((bjci)localObject).jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext())
      {
      ...
      do
      {
        for (;;)
        {
          ...
          if (((File)localObject).exists()) {
            try
            {
              localObject = bbdj.c(((File)localObject).getPath());
            ...
            catch (UnsatisfiedLinkError paramString1)
            {
              try
              {
                nay.a(new File(jdField_b_of_type_JavaIoFile, paramString1), jdField_a_of_type_JavaLangString);
                return true;
              }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Bjci != null) && (this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.size() >= 100);
  }
  ...
  public bjci a(bjci parambjci)
  {
    ...
    for (;;)
    {
      ...
      {
        parambjci.jdField_a_of_type_JavaUtilList.clear();
        ...
        if (parambjci.jdField_a_of_type_JavaUtilList.size() >= 100) {
          return parambjci;
        }
      }
      parambjci.jdField_a_of_type_JavaUtilList.add(localObject2);
      break label216;
      label212:
      return parambjci;
      label216:
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        do
        {
          ...
          localObject = (bjci)localIterator.next();
        } while ((localObject == null) || (((bjci)localObject).jdField_a_of_type_JavaUtilList == null) || (((bjci)localObject).jdField_a_of_type_Int != bjan.jdField_b_of_type_Int));
        localObject = ((bjci)localObject).jdField_a_of_type_JavaUtilList.iterator();
      }
      localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next();
    } while (!localPtvTemplateInfo.id.equals(bjan.jdField_b_of_type_JavaLangString));
    if (QLog.isColorLevel()) {
  ...
  public PtvTemplateManager.PtvTemplateInfo a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((bjci)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  public ArrayList<bjci> a(boolean paramBoolean)
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      {
        this.jdField_a_of_type_Bjci = new bjci(ajyc.a(2131709819));
        this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList = new ArrayList(100);
      }
      if (paramBoolean) {
        a(this.jdField_a_of_type_Bjci);
      }
      jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      this.jdField_b_of_type_Bjci = b(this.jdField_a_of_type_Bjci);
      localArrayList.add(0, this.jdField_b_of_type_Bjci);
      if (QLog.isColorLevel()) {
  ...
  public List<bjci> a()
  {
    ...
    {
      bjci localbjci = (bjci)localIterator.next();
      if (localbjci.jdField_a_of_type_Boolean) {
        localArrayList.add(localbjci);
      }
    }
    return localArrayList;
  ...
  public List<bjci> a(File paramFile)
  {
    if (QLog.isColorLevel()) {
    ...
    while (localIterator.hasNext())
    {
      Object localObject = (bjci)localIterator.next();
      if ((((bjci)localObject).jdField_a_of_type_JavaUtilList != null) && (((bjci)localObject).jdField_a_of_type_JavaUtilList.size() != 0))
      {
        localObject = ((bjci)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
  ...
  public void a(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bkyv parambkyv)
  {
    ...
    b(paramAppInterface, paramPtvTemplateInfo, parambkyv);
  }
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Bjci == null)
        {
          this.jdField_a_of_type_Bjci = new bjci(ajyc.a(2131709822));
          this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList = new ArrayList(100);
          a(this.jdField_a_of_type_Bjci);
        }
        if (this.jdField_b_of_type_Bjci == null) {
          this.jdField_b_of_type_Bjci = this.jdField_a_of_type_Bjci.a();
        }
        j = a(this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList, paramPtvTemplateInfo.id);
        if (j == -1)
        {
          if (!b())
          {
            this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
            this.jdField_b_of_type_Bjci.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
            if (this.jdField_a_of_type_Axgh != null) {
              this.jdField_a_of_type_Axgh.a(paramInt, new Object[] { this.jdField_b_of_type_Bjci });
            }
            if (QLog.isColorLevel()) {
          ...
          PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.remove(99);
          this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          this.jdField_b_of_type_Bjci.jdField_a_of_type_JavaUtilList.remove(localPtvTemplateInfo);
          this.jdField_b_of_type_Bjci.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          if (this.jdField_a_of_type_Axgh == null) {
            continue;
          }
      ...
      if (j != 0)
      {
        this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.remove(j);
        this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
      }
    }
  }
  ...
  {
    bjan.jdField_b_of_type_JavaLangString = paramString1;
    bjan.jdField_b_of_type_Int = paramInt;
    bjan.jdField_a_of_type_JavaLangString = paramString2;
  ...
  public void a(List<bjci> paramList)
  {
    ...
    Object localObject = (bjci)paramList.next();
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(((bjci)localObject).jdField_a_of_type_JavaUtilList);
    int j = 0;
    label63:
  ...
  protected bjci b(bjci parambjci)
  {
    if (parambjci == null) {
      return null;
    }
    Object localObject = (bigh)bjae.a().c(13);
    parambjci = parambjci.a();
    if ((localObject == null) || (!((bigh)localObject).a())) {
      return parambjci;
    }
    localObject = parambjci.jdField_a_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext())
    {
      PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next();
  ...
  public void b(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, bkyv parambkyv)
  {
    ...
    for (;;)
    {
      ...
      localayrv.jdField_a_of_type_Aysa = new bkza(this, paramPtvTemplateInfo, parambkyv);
      localayrv.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.resurl;
      ...
      localayrv.jdField_c_of_type_JavaLangString = new File(jdField_b_of_type_JavaIoFile, paramPtvTemplateInfo.name).getPath();
  ...
  public void f()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.isEmpty()));
        localStringBuilder = new StringBuilder();
        localObject1 = this.jdField_a_of_type_Bjci.jdField_a_of_type_JavaUtilList.iterator();
