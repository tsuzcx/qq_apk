  ...
  implements Manager
{
  ...
  public bkyy(QQAppInterface paramQQAppInterface)
  {
  ...
  private begq a(String paramString)
  {
    paramString = new begq(paramString, 16);
    paramString.setSpan(new ForegroundColorSpan(BaseApplicationImpl.context.getResources().getColor(2131166255)), 0, paramString.length(), 33);
    return paramString;
  }
  
  public static bkyy a()
  {
    return a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  
  public static bkyy a(QQAppInterface paramQQAppInterface)
  {
    return (bkyy)paramQQAppInterface.getManager(QQManagerFactory.NOTIFY_ID_MANAGER);
  }
  ...
  {
    return (aoso.a(paramInt)) && (a(paramString));
  }
  
  public static boolean a(QQMessageFacade.Message paramMessage)
  {
    if (paramMessage == null) {}
    while ((!aoso.a(paramMessage.istroop)) || (!a(paramMessage.frienduin))) {
      return false;
    }
    return true;
  }
  ...
  public String a(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (amci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = anvx.a(2131707097) + paramString;
    }
    return str;
  }
  ...
  public void a(QQMessageFacade.Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new begq("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(anvx.a(2131707096)));
      paramSpannableStringBuilder.append(new begq(paramMessage.nickName, 16));
    }
  }
  
  public void a(QQMessageFacade.Message paramMessage, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((amci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(anvx.a(2131707098)));
    }
  }
  ...
  public String b(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = anvx.a(2131707099) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131699039) + paramString;
  }
  
  public void b()
  {
    ((anri)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER)).h();
  }
  ...
  {
    return amci.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
