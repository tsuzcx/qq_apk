  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    this.a.c = false;
    afry.a(this.a).setVisibility(8);
    afry.a(this.a, 0, null);
    this.a.jdField_a_of_type_Afrw.a(afry.a(this.a), this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long);
    this.a.jdField_a_of_type_Afrw.notifyDataSetChanged();
    this.a.b = 1;
    bajr.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "chat_history", "ChatSearch", "Clk_cloudtips", 0, 0, new String[0]);
  }
}
