  ...
  implements Manager
{
  ...
  private final aybv jdField_a_of_type_Aybv;
  private final QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final int[] jdField_a_of_type_ArrayOfInt;
  
  public anlq(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aybv = new aybv();
    this.jdField_a_of_type_ArrayOfInt = new int[] { 0, 1 };
  }
  
  public static anlq a(QQAppInterface paramQQAppInterface)
  {
    return (anlq)paramQQAppInterface.getManager(371);
  }
  ...
  {
    this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new anlr(this, paramBaseActivity, paramFormSwitchItem);
    return this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener;
  }
  
  public aybv a()
  {
    return this.jdField_a_of_type_Aybv;
  }
  ...
  public boolean b()
  {
    return SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), null, "top_msg_notification_key", true);
  }
  
  public boolean c()
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Pause))
    {
  ...
  public boolean h()
  {
    adhi localadhi = this.jdField_a_of_type_Aybv.a();
    if ((localadhi != null) && (localadhi.c())) {}
    return false;
  }
