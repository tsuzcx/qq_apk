...
public class appv
{
  private static appv jdField_a_of_type_Appv;
  private static final FileFilter jdField_a_of_type_JavaIoFileFilter = new appw();
  ...
  {
    if (jdField_a_of_type_Appv == null) {
      jdField_a_of_type_Appv = new appv();
    }
    return jdField_a_of_type_Appv;
  }
