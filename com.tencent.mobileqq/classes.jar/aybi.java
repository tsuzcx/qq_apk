  ...
  implements View.OnClickListener
{
  ...
  public aybi(TribeVideoListPlayerFragment paramTribeVideoListPlayerFragment, View paramView)
  {
  ...
  {
    aybq localaybq = (aybq)this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int);
    String str;
    ...
    case 2131300979: 
      ...
      do
      {
        do
        {
          ...
          str = "2";
          break;
          paramView = new ProfileActivity.AllInOne(String.valueOf(localaybq.jdField_c_of_type_Long), 86);
          ...
          boolean bool = BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(String.valueOf(localaybq.jdField_c_of_type_Long));
          ...
          for (;;)
          {
            awqx.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_poster", 0, 0, localaybq.d, localaybq.b + "", "", str);
            return;
        ...
        } while (localaybq.jdField_c_of_type_Boolean);
        ...
        this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(1, String.valueOf(localaybq.jdField_c_of_type_Long), new aybj(this, localaybq, str));
        return;
        ...
        for (paramView = "" + localaybq.h;; paramView = "")
        {
          awqx.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localaybq.d, localaybq.b + "", paramView, str);
          return;
        ...
        for (;;)
        {
          awqx.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localaybq.d, localaybq.b + "", "", str);
          return;
        ...
        for (;;)
        {
          awqx.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_share", 0, 0, localaybq.d, localaybq.b + "", "", str);
          return;
          if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_c_of_type_Boolean)
          {
            if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_a_of_type_ComTencentBizUiTouchWebView != null) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(localaybq.b, localaybq.d, new aybk(this, localaybq));
      awqx.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_like", 0, 0, localaybq.d, localaybq.b + "", "", str);
      return;
    }
    ...
    paramView.putExtra("url", localaybq.g);
    this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.getActivity().startActivity(paramView);
    awqx.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_detail", 0, 0, localaybq.d, localaybq.b + "", "", str);
  }
}
