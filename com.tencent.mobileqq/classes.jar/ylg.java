  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  public ylg(StoryMessageListActivity paramStoryMessageListActivity, View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370299);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370327));
    this.b = paramView.findViewById(2131371412);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131371400));
