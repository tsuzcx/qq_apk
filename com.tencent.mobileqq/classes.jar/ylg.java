  ...
  implements View.OnTouchListener
{
  ...
  private ylh jdField_a_of_type_Ylh;
  ...
  String a(String paramString, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      i = 1;
      j = awmc.b(BaseApplicationImpl.getContext());
      k = awmc.a(BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      ...
      {
        String str;
        yny.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString error", localException);
        continue;
        paramString = "?";
        continue;
      }
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if (!paramString.contains("&s={"))
        {
          ...
          yny.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString click url result : " + (String)localObject);
        }
      }
      return localObject;
      i = 0;
  ...
  public void a()
  {
    this.jdField_a_of_type_Ylh = null;
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Ylh != null) {
        this.jdField_a_of_type_Ylh.a(this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c, this.d);
      }
    }
  }
}
