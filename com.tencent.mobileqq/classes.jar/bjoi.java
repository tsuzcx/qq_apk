  ...
  implements DownloadListener
{
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bjko.c("WebViewDownloadListener", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  {
    bjlr localbjlr = bjlr.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbjlr.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bjlq)localbjlr.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bjlq)localObject).getJsCallbackMethod()))
            {
              ...
              bjko.a("WebViewDownloadListener", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bjko.c("WebViewDownloadListener", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
