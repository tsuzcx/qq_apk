  ...
  implements XmlSerializer
{
  ...
  public azqi(AbsStructMsg paramAbsStructMsg, XmlSerializer paramXmlSerializer)
  {
  ...
  public XmlSerializer text(String paramString)
  {
    if (paramString != null) {
      try
      {
        XmlSerializer localXmlSerializer = this.jdField_a_of_type_OrgXmlpullV1XmlSerializer.text(ayvy.a(paramString, false));
