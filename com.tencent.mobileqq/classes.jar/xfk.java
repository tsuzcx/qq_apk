...
public class xfk
{
  ...
  public xfk(Activity paramActivity, xfl paramxfl)
  {
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    vpl.a(paramActivity, i, paramIntent);
  }
  ...
  public static void c(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      xvv.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handleOpenTagAction parm error");
      return;
    }
    wlg.a(paramActivity, str, paramIntent);
  }
  
  public static void d(Activity paramActivity, Intent paramIntent)
  {
    paramIntent = (String)((vuq)vux.a(10)).b("mainHallConfig", "");
    if (!TextUtils.isEmpty(paramIntent)) {}
    for (;;)
    {
      try
      {
        ...
        xvv.d("Q.qqstory.home.QQStoryHomeJumpHelper", "square config not ready , use default config instead");
        return;
      }
      catch (Exception paramIntent)
      {
        xvv.d("Q.qqstory.home.QQStoryHomeJumpHelper", "analyze config error , error :%s", new Object[] { paramIntent.getMessage() });
      }
      paramIntent = "";
    }
  ...
  private void e(Intent paramIntent)
  {
    ...
    bfvp.c(QQStoryContext.a(), this.jdField_a_of_type_AndroidAppActivity, paramIntent, str);
  }
  ...
  private void h(Intent paramIntent)
  {
    ...
    vpl.a(this.jdField_a_of_type_AndroidAppActivity, 23, str);
  }
  ...
  {
    xvv.b("Q.qqstory.home.QQStoryHomeJumpHelper", "handleAction=" + paramInt);
    switch (paramInt)
    {
    case 3: 
    default: 
    ...
    case 1: 
      ...
      this.jdField_a_of_type_Xfl.a(false, true, 16, null);
      return true;
    case 2: 
      a(paramIntent);
      return true;
  ...
  protected void c(Intent paramIntent)
  {
    ...
    if (paramIntent == null)
    {
      xvv.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handle open play list error , no play info !");
      return;
    }
    wmu.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, 31, null);
  }
