...
public class usp
{
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    if (3 == paramInt)
    {
      if (((Boolean)bmhv.a(paramString, Boolean.valueOf(false))).booleanValue()) {
        return;
      }
      bmhv.a(paramString, Boolean.valueOf(true));
    }
    uuc.a(200, localArrayList);
  }
    ...
    try
    {
      ...
      if ((paramMap != null) && (paramMap.entrySet() != null))
      {
        ...
        while ((paramMap != null) && (paramMap.hasNext()))
        {
          ...
          continue;
          olh.a(null, pqw.b(paramArticleInfo), paramString1, paramString2, 0, 0, prg.a(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), paramMap, false);
        }
      }
    }
  ...
  {
    paramBaseArticleInfo = rnz.a(paramBaseArticleInfo);
  ...
  {
    return bhfn.a(BaseApplicationImpl.getContext(), "com.tencent.weishi");
  }
}
