...
public class lqu
{
  ...
  public static ArrayList<lqw> a(String paramString, Context paramContext)
  {
    ...
    if (DeviceCheck.b()) {
      if (DeviceCheck.e())
      {
        ((ArrayList)localObject1).add(new lqw(1, true));
        if (AudioHelper.e()) {
        ...
        ((ArrayList)localObject1).add(new lqw(2, true));
        if (AudioHelper.e()) {
    ...
    for (;;)
    {
      ...
      break;
      localObject2 = new lra(lim.a(paramContext));
      lqw locallqw = ((lra)localObject2).c();
      if ((locallqw != null) && (locallqw.jdField_a_of_type_Boolean)) {
        if (DeviceCheck.e())
        {
          ((ArrayList)localObject1).add(locallqw);
          if (AudioHelper.e()) {
            QLog.w(paramString, 1, "checkSupportHWCodecAbility, 支持H264解码. maxW = " + locallqw.jdField_b_of_type_Int + ", maxH = " + locallqw.jdField_c_of_type_Int);
          }
        }
      }
      for (;;)
      {
        localObject2 = ((lra)localObject2).a();
        if ((localObject2 == null) || (!((lqw)localObject2).jdField_a_of_type_Boolean)) {
          break label722;
        }
        if (!DeviceCheck.c()) {
          break label711;
        ...
        QLog.w(paramString, 1, "checkSupportHWCodecAbility, 支持H265解码. maxW = " + ((lqw)localObject2).jdField_b_of_type_Int + ", maxH = " + ((lqw)localObject2).jdField_c_of_type_Int);
        break;
      ...
      continue;
      label750:
      paramContext = new lra(lim.a(paramContext));
      ...
      if ((localObject2 != null) && (((lqw)localObject2).jdField_a_of_type_Boolean)) {
        if (DeviceCheck.f())
        {
          ((ArrayList)localObject1).add(localObject2);
          if (AudioHelper.e()) {
            QLog.w(paramString, 1, "checkSupportHWCodecAbility, 支持H264编码. maxW = " + ((lqw)localObject2).jdField_b_of_type_Int + ", maxH = " + ((lqw)localObject2).jdField_c_of_type_Int);
          }
        }
      }
      for (;;)
  ...
  private static boolean a(ArrayList<lqw> paramArrayList)
  {
    boolean bool2 = false;
    int m;
    int k;
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      locallqw = (lqw)paramArrayList.next();
      if ((locallqw.jdField_a_of_type_Int == 1) && (locallqw.jdField_a_of_type_Boolean) && (locallqw.jdField_b_of_type_Int >= 1920) && (locallqw.jdField_c_of_type_Int >= 1080))
      {
        n = m;
        j = k;
        k = 1;
    ...
    for (;;)
    {
      ...
      i = n;
      break;
      if ((locallqw.jdField_a_of_type_Int == 2) && (locallqw.jdField_a_of_type_Boolean) && (locallqw.jdField_b_of_type_Int >= 1920) && (locallqw.jdField_c_of_type_Int >= 1080))
      {
        i = m;
        m = j;
        n = 1;
      ...
      else if ((locallqw.jdField_a_of_type_Int == 4) && (locallqw.jdField_a_of_type_Boolean) && (locallqw.jdField_b_of_type_Int >= 1920) && (locallqw.jdField_c_of_type_Int >= 1080))
      {
        i1 = 1;
        m = j;
        n = i;
      ...
      else if ((locallqw.jdField_a_of_type_Int == 8) && (locallqw.jdField_a_of_type_Boolean) && (locallqw.jdField_b_of_type_Int >= 1920) && (locallqw.jdField_c_of_type_Int >= 1080))
      {
        n = m;
        k = j;
        j = 1;
  ...
  public lqv a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   4: ifnonnull +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: new 456	lqv
    //   12: dup
    //   13: aload_0
    //   14: invokespecial 459	lqv:<init>	(Llqu;)V
    //   17: astore_2
    //   18: aload_0
    //   19: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   22: getstatic 40	lqu:jdField_c_of_type_Int	I
    //   25: i2l
    ...
    //   44: aload_2
    //   45: iload_1
    //   46: putfield 464	lqv:jdField_a_of_type_Int	I
    //   49: aload_2
    //   50: aload_0
    //   51: getfield 466	lqu:jdField_a_of_type_ArrayOfJavaNioByteBuffer	[Ljava/nio/ByteBuffer;
    //   54: iload_1
    //   55: aaload
    //   56: putfield 469	lqv:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   59: aload_0
    //   60: monitorexit
    //   61: aload_2
    //   62: areturn
    ...
    //   70: aload_2
    //   71: iload_1
    //   72: putfield 464	lqv:jdField_a_of_type_Int	I
    //   75: aload_2
    //   76: getstatic 347	lqu:jdField_a_of_type_JavaLangReflectMethod	Ljava/lang/reflect/Method;
    //   79: aload_0
    //   80: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   83: iconst_1
    ...
    //   100: putfield 469	lqv:jdField_a_of_type_JavaNioByteBuffer	Ljava/nio/ByteBuffer;
    //   103: aload_0
    //   104: monitorexit
    //   105: aload_2
    //   106: areturn
    ...
    //   112: aload_2
    //   113: iconst_0
    //   114: putfield 471	lqv:jdField_a_of_type_Boolean	Z
    //   117: goto -14 -> 103
    //   120: astore_2
    //   121: aload_0
    //   122: monitorexit
    ...
    //   130: aload_2
    //   131: iconst_0
    //   132: putfield 471	lqv:jdField_a_of_type_Boolean	Z
    //   135: goto -32 -> 103
    //   138: astore_3
    //   139: aload_3
    ...
    //   143: aload_2
    //   144: iconst_0
    //   145: putfield 471	lqv:jdField_a_of_type_Boolean	Z
    //   148: goto -45 -> 103
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	151	0	this	lqu
    //   29	61	1	i	int
    //   17	45	2	locallqv1	lqv
    //   63	50	2	locallqv2	lqv
  ...
  public lqv a(long paramLong)
  {
    ...
    int i = this.jdField_a_of_type_AndroidMediaMediaCodec.dequeueOutputBuffer(locallqv.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo, 3000L);
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          locallqv.jdField_a_of_type_JavaNioByteBuffer = this.jdField_b_of_type_ArrayOfJavaNioByteBuffer[i];
          locallqv.jdField_a_of_type_Int = i;
          locallqv.jdField_a_of_type_AndroidMediaMediaFormat = this.jdField_b_of_type_AndroidMediaMediaFormat;
          localObject3 = locallqv;
          break;
          ...
          locallqv.jdField_a_of_type_Int = -3;
          l1 = l2;
          break label100;
          locallqv.jdField_a_of_type_Int = -2;
        ...
        l1 = l2;
        break label100;
        locallqv.jdField_a_of_type_Int = -1;
        Object localObject4 = locallqv;
        break;
        label417:
        locallqv.jdField_a_of_type_Int = i;
        try
        {
          locallqv.jdField_a_of_type_JavaNioByteBuffer = ((ByteBuffer)jdField_b_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
          locallqv.jdField_a_of_type_AndroidMediaMediaFormat = ((MediaFormat)jdField_c_of_type_JavaLangReflectMethod.invoke(this.jdField_a_of_type_AndroidMediaMediaCodec, new Object[] { Integer.valueOf(i) }));
          localObject4 = locallqv;
        }
        catch (IllegalAccessException localIllegalAccessException)
        {
          for (;;)
          {
            ...
            locallqv.jdField_a_of_type_Boolean = false;
          }
        }
  ...
  public void a(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   18: iload_1
    //   19: iconst_0
  ...
  public void a(int paramInt1, int paramInt2, long paramLong, int paramInt3)
  {
    ...
    //   15: return
    //   16: aload_0
    //   17: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   20: iload_1
    //   21: iconst_0
    //   22: iload_2
    //   23: lload_3
    ...
    //   29: goto -16 -> 13
    //   32: astore 6
    //   34: invokestatic 228	com/tencent/mobileqq/utils/AudioHelper:e	()Z
    //   37: ifeq -24 -> 13
    //   40: aload_0
    //   41: getfield 72	lqu:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   44: iconst_1
  ...
  boolean a(MediaCodec paramMediaCodec, lqy paramlqy)
  {
    if ((paramlqy != null) && (DeviceCheck.g()))
    {
      DexClassLoader localDexClassLoader = mtp.a();
      Object localObject = mtp.a(localDexClassLoader, "com.tencent.av.mediacodec.MediaCodecWrapper");
      if (localObject != null) {
        try
        {
          Object[] arrayOfObject = new Object[1];
          boolean bool = mtp.a(localDexClassLoader, localObject, "setCallback", new Class[] { MediaCodec.class, lqy.class }, new Object[] { paramMediaCodec, paramlqy }, arrayOfObject);
          return bool;
        }
  ...
  /* Error */
  public boolean a(MediaFormat paramMediaFormat, int paramInt, lqy paramlqy)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    //   3: aload_0
    //   4: aload_1
    //   5: putfield 583	lqu:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   8: iload_2
    //   9: getstatic 55	lqu:jdField_b_of_type_Int	I
    //   12: if_icmpne +88 -> 100
    //   15: aload_0
    //   16: aload_0
    //   17: getfield 583	lqu:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   20: ldc_w 585
    ...
    //   29: putfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   32: aload_0
    //   33: iload_2
    //   34: putfield 57	lqu:e	I
    //   37: aload_0
    //   38: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   41: ifnull +39 -> 80
    //   44: iload_2
    //   45: getstatic 23	lqu:jdField_a_of_type_Int	I
    //   48: if_icmpne +86 -> 134
    //   51: iconst_1
    //   52: istore_2
    //   53: aload_0
    //   54: aload_0
    //   55: aload_0
    //   56: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   59: aload_3
    //   60: invokevirtual 595	lqu:a	(Landroid/media/MediaCodec;Llqy;)Z
    //   63: putfield 597	lqu:jdField_d_of_type_Boolean	Z
    //   66: aload_0
    //   67: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   70: aload_0
    //   71: getfield 583	lqu:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   74: aconst_null
    //   75: aconst_null
    //   76: iload_2
    ...
    //   80: aload_0
    //   81: getfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   84: ifnull +6 -> 90
    //   87: iconst_1
    //   88: istore 4
    //   90: iload 4
    ...
    //   100: aload_0
    //   101: aload_0
    //   102: getfield 583	lqu:jdField_a_of_type_AndroidMediaMediaFormat	Landroid/media/MediaFormat;
    //   105: ldc_w 585
    ...
    //   114: putfield 426	lqu:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   117: goto -85 -> 32
    //   120: astore_1
    //   121: aload_1
  ...
  public boolean a(MediaFormat paramMediaFormat, String paramString, Surface paramSurface, lqy paramlqy)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramMediaFormat)
      {
        try
        {
          if (this.jdField_a_of_type_AndroidMediaMediaCodec != null)
          {
            this.jdField_d_of_type_Boolean = a(this.jdField_a_of_type_AndroidMediaMediaCodec, paramlqy);
  ...
  public boolean a(MediaFormat paramMediaFormat, String paramString, lqy paramlqy)
  {
    this.jdField_a_of_type_AndroidMediaMediaFormat = paramMediaFormat;
    paramMediaFormat = a(paramString);
    if ((paramMediaFormat != null) && (paramMediaFormat.isEncoder())) {
  ...
  public lqv b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        lqv locallqv = new lqv(this);
        i = this.jdField_a_of_type_AndroidMediaMediaCodec.dequeueOutputBuffer(locallqv.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo, jdField_c_of_type_Int);
        switch (i)
        {
        case -3: 
          if (NativeCodec.canLog()) {
