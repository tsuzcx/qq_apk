  ...
  extends lrc
{
  ...
  public lqu(int paramInt1, int paramInt2)
  {
    super(2);
  ...
  protected Frame a(List<lrg> paramList, long paramLong)
  {
    ...
    Frame localFrame = ((lrg)paramList.get(0)).a;
    a(this.jdField_a_of_type_ArrayOfFloat, localFrame.width, localFrame.height);
    this.jdField_a_of_type_Lqv.addParam(new UniformParam.Float4fParam("offset", this.jdField_a_of_type_ArrayOfFloat[0], this.jdField_a_of_type_ArrayOfFloat[1], this.jdField_a_of_type_ArrayOfFloat[2], this.jdField_a_of_type_ArrayOfFloat[3]));
    if (paramList.size() > 1)
    {
      paramList = ((lrg)paramList.get(1)).a;
      a(this.jdField_b_of_type_ArrayOfFloat, paramList.width, paramList.height);
      this.jdField_a_of_type_Lqv.addParam(new UniformParam.TextureParam("inputImageTexture1", paramList.getTextureId(), 33985));
      this.jdField_a_of_type_Lqv.addParam(new UniformParam.Float4fParam("offset1", this.jdField_b_of_type_ArrayOfFloat[0], this.jdField_b_of_type_ArrayOfFloat[1], this.jdField_b_of_type_ArrayOfFloat[2], this.jdField_b_of_type_ArrayOfFloat[3]));
    }
    for (;;)
    {
      return this.jdField_a_of_type_Lqv.RenderProcess(localFrame.getTextureId(), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      this.jdField_a_of_type_Lqv.addParam(new UniformParam.TextureParam("inputImageTexture1", -1, 33985));
    }
  }
  
  protected void a()
  {
    this.jdField_a_of_type_Lqv = new lqv(this);
    QLog.d(this.jdField_a_of_type_JavaLangString, 1, "onInit: create filter#" + Integer.toHexString(this.jdField_a_of_type_Lqv.hashCode()));
    this.jdField_a_of_type_Lqv.setPositions(AEOpenRenderConfig.ORIGIN_POSITION_COORDS, true);
    this.jdField_a_of_type_Lqv.setTexCords(AEOpenRenderConfig.ORIGIN_TEX_COORDS, true);
    this.jdField_a_of_type_Lqv.ApplyGLSLFilter();
  }
  
  protected void b()
  {
    if (this.jdField_a_of_type_Lqv != null)
    {
      this.jdField_a_of_type_Lqv.clearGLSLSelf();
      QLog.d(this.jdField_a_of_type_JavaLangString, 1, "onDestroy: filter#" + Integer.toHexString(this.jdField_a_of_type_Lqv.hashCode()));
      this.jdField_a_of_type_Lqv = null;
    }
  }
}
