...
public class ashc
  extends ases<CustomEmotionData>
{
  private boolean a;
  
  public ashc(QQAppInterface paramQQAppInterface)
  {
  ...
  private CustomEmotionData a(String paramString1, String paramString2, String paramString3, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localashk = new ashk(paramString1);
          localObject = localCustomEmotionData;
        } while (TextUtils.isEmpty(localashk.jdField_a_of_type_JavaLangString));
        str2 = localashk.c;
        localObject = localCustomEmotionData;
      } while (str2 == null);
      localObject = localCustomEmotionData;
    ...
    if (str2.equals("1"))
    {
      ...
      localCustomEmotionData.emoPath = localashk.e;
      localCustomEmotionData.eId = localashk.f;
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.url = asha.a(paramString1, paramString2, str1);
    ...
    for (;;)
    {
      ...
      localCustomEmotionData.uin = str1;
      localCustomEmotionData.emoPath = asha.a(paramString1);
      localCustomEmotionData.resid = paramString1;
      localCustomEmotionData.md5 = localashk.jdField_d_of_type_JavaLangString;
      localCustomEmotionData.url = asha.a(paramString1, paramString2, str1);
      localCustomEmotionData.RomaingType = paramString3;
      localCustomEmotionData.emoId = paramInt;
      break;
      ...
      {
        localCustomEmotionData.eId = localashk.e;
        if (QLog.isColorLevel()) {
  ...
  private List<CustomEmotionData> a(List<CustomEmotionData> paramList)
  {
    ...
    if (paramList.size() > asha.b) {
      localObject = paramList.subList(0, asha.b);
    }
    int i = 0;
        ...
        for (;;)
        {
          ...
          if (paramList2 != null)
          {
            ...
            if ((TextUtils.isEmpty(localCustomEmotionData2.url)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
            {
              ...
              localCustomEmotionData2.url = asha.a(str, paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
            }
  ...
  public aseu<CustomEmotionData> a()
  {
    return (ashd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(103);
  }
  
  public asmu a(CustomEmotionData paramCustomEmotionData)
  {
    if (paramCustomEmotionData.isMarkFace)
    {
      ...
      ((asre)localObject1).jdField_c_of_type_Boolean = paramCustomEmotionData.isAPNG;
      ((asre)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((axfj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str, (String)localObject2);
      ((asre)localObject1).jdField_d_of_type_Int = 2;
      ((asre)localObject1).jdField_a_of_type_JavaLangString = paramCustomEmotionData.RomaingType;
      ((asre)localObject1).jdField_g_of_type_Int = paramCustomEmotionData.emoId;
      return localObject1;
    }
    Object localObject1 = ((asig)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
    Object localObject2 = new asqn();
    ((asqn)localObject2).jdField_c_of_type_Int = 4;
    ((asqn)localObject2).e = a(paramCustomEmotionData);
    ((asqn)localObject2).jdField_d_of_type_Int = 2;
    ((asqn)localObject2).jdField_d_of_type_JavaLangString = paramCustomEmotionData.eId;
    ((asqn)localObject2).f = paramCustomEmotionData.url;
    if (localObject1 != null) {
      ((asqn)localObject2).jdField_a_of_type_JavaLangString = asqn.a((Map)localObject1, paramCustomEmotionData.md5);
    }
    ((asqn)localObject2).h = paramCustomEmotionData.RomaingType;
    ((asqn)localObject2).jdField_g_of_type_Int = paramCustomEmotionData.emoId;
    ((asqn)localObject2).jdField_g_of_type_JavaLangString = paramCustomEmotionData.resid;
    return localObject2;
  }
  ...
  public CustomEmotionData a(List<CustomEmotionData> paramList, String paramString)
  {
    ...
    for (;;)
    {
      label131:
      return paramList;
      Object localObject = new ashk(paramString);
      if (!((ashk)localObject).a())
      {
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      {
        str = ((ashk)localObject).e;
        localObject = ((ashk)localObject).f;
      ...
      localObject = ((ashk)localObject).jdField_d_of_type_JavaLangString;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        break label98;
      }
  ...
  public String a(CustomEmotionData paramCustomEmotionData)
  {
    ...
    do
    {
      ...
      localObject1 = antf.bl;
      localObject2 = (asig)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141);
      if ((localObject2 != null) && (((asig)localObject2).a(paramCustomEmotionData)))
      {
        if ((!TextUtils.isEmpty(paramCustomEmotionData.emoPath)) && (paramCustomEmotionData.emoPath.startsWith(antf.bl))) {
          return paramCustomEmotionData.emoPath;
        }
        if (!TextUtils.isEmpty(paramCustomEmotionData.md5)) {
          return ((asig)localObject2).a(paramCustomEmotionData.md5);
        }
        if (!TextUtils.isEmpty(paramCustomEmotionData.resid)) {
          return (String)localObject1 + apdf.a(paramCustomEmotionData.resid);
        }
      ...
      if ((paramCustomEmotionData.url != null) && (paramCustomEmotionData.url.contains("qto_"))) {
        return (String)localObject1 + anyz.a(paramCustomEmotionData.url);
      }
      if (TextUtils.isEmpty(anyz.a(paramCustomEmotionData.eId))) {
        break;
      }
  ...
  public List<CustomEmotionData> a(List<String> paramList1, List<String> paramList2, String paramString, List<Integer> paramList)
  {
    ...
    paramString = (anxd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(72);
  ...
  public boolean a(CustomEmotionData paramCustomEmotionData, int paramInt)
  {
    ...
    for (Object localObject = "isUpdate";; localObject = "overflow_downloaded")
    {
      ...
      localObject = (ashd)a();
      if (localObject != null) {
        ((ashd)localObject).d(paramCustomEmotionData);
      }
      return true;
    }
  }
  ...
  public List<asmu> b()
  {
    bhsq.a("AIO_EmoticonPanel_Refresh", null);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          else
          {
            ...
            if ((localObject2 instanceof asre))
            {
              localObject2 = (asre)localObject2;
              if (((asre)localObject2).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) {
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        ...
        bhsq.a(null, "AIO_EmoticonPanel_Refresh");
      }
      if (QLog.isColorLevel()) {
      ...
      break label322;
      if ((localObject2 instanceof asqn))
      {
        localObject1 = (asqn)localObject2;
        if ((TextUtils.isEmpty(((asqn)localObject1).e)) && (TextUtils.isEmpty(((asqn)localObject1).f))) {
          QLog.e("FavroamingDBManager", 1, "path and url is null! " + ((asqn)localObject1).toString());
        } else {
  ...
  {
    Map localMap = ((asig)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(141)).a();
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i >= 0)
        {
          ...
          {
            localObject = new asre(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
            ((asre)localObject).jdField_c_of_type_Int = 6;
            String str1 = localCustomEmotionData.eId;
            String str2 = localCustomEmotionData.emoPath;
            ((asre)localObject).jdField_c_of_type_Boolean = localCustomEmotionData.isAPNG;
            ((asre)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((axfj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str2, str1);
            ((asre)localObject).jdField_d_of_type_Int = 2;
            if (((asre)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) {
      ...
      break label471;
      Object localObject = new asqn();
      ((asqn)localObject).jdField_c_of_type_Int = 4;
      ((asqn)localObject).e = a(localCustomEmotionData);
      ((asqn)localObject).jdField_d_of_type_Int = 2;
      ((asqn)localObject).jdField_d_of_type_JavaLangString = localCustomEmotionData.eId;
      ((asqn)localObject).f = localCustomEmotionData.url;
      ((asqn)localObject).jdField_a_of_type_JavaLangString = asqn.a(localOutOfMemoryError, localCustomEmotionData.md5);
      ((asqn)localObject).h = localCustomEmotionData.RomaingType;
      ((asqn)localObject).jdField_g_of_type_Int = localCustomEmotionData.emoId;
      ((asqn)localObject).jdField_g_of_type_JavaLangString = localCustomEmotionData.resid;
      if ((TextUtils.isEmpty(((asqn)localObject).e)) && (TextUtils.isEmpty(((asqn)localObject).f))) {
        QLog.e("FavroamingDBManager", 1, "path and url is null! " + ((asqn)localObject).toString());
      } else {
        localArrayList.add(localObject);
      }
      label471:
  ...
  public List<CustomEmotionData> d()
  {
    ...
    //   13: astore 8
    //   15: aload_0
    //   16: getfield 64	ashc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   19: ifnonnull +10 -> 29
    //   22: aload 8
    //   24: astore 9
    //   26: aload 9
    //   28: areturn
    //   29: aload_0
    //   30: getfield 64	ashc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   46: aload 11
    //   48: aload_0
    //   49: invokevirtual 502	ashc:a	()Ljava/lang/Class;
    //   52: iconst_0
    //   53: aconst_null
    //   54: aconst_null
    //   55: aconst_null
    ...
    //   64: ldc_w 510
    //   67: aload_0
    //   68: getfield 64	ashc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 512	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   74: invokestatic 515	apdf:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   77: iconst_1
    ...
    //   144: getstatic 355	antf:bl	Ljava/lang/String;
    ...
    //   181: getstatic 355	antf:bl	Ljava/lang/String;
    ...
    //   192: invokestatic 362	apdf:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   274: getstatic 355	antf:bl	Ljava/lang/String;
    ...
    //   327: aload 12
    //   329: aload 12
    //   331: invokestatic 362	apdf:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   399: ldc_w 510
    //   402: aload_0
    //   403: getfield 64	ashc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   406: invokevirtual 512	com/tencent/mobileqq/app/QQAppInterface:c	()Ljava/lang/String;
    //   409: iconst_1
    //   410: invokestatic 542	apdf:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   413: aload 11
    ...
    //   519: aload 11
    //   521: iconst_1
    //   522: invokevirtual 489	ashc:b	(Lcom/tencent/mobileqq/data/CustomEmotionBase;I)V
    //   525: goto -61 -> 464
    //   528: astore 8
    //   530: iconst_0
    //   531: istore 4
    ...
    //   599: pop
    //   600: aload_0
    //   601: invokevirtual 550	ashc:b	()V
    //   604: iconst_1
    //   605: istore_1
    //   606: goto -88 -> 518
    //   609: aload_0
    //   610: invokevirtual 552	ashc:a	()V
    //   613: iload_2
    //   614: ifeq +10 -> 624
    //   617: aload_0
    //   618: aload 8
    //   620: iconst_2
    //   621: invokevirtual 419	ashc:a	(Ljava/util/List;I)V
    //   624: aload 8
