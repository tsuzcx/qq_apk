...
public class bdsn
{
  ...
  public bdsn(QQAppInterface paramQQAppInterface)
  {
  ...
  private long a()
  {
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = bdwk.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_last_pull_timestamp", 0L);
    }
    return this.jdField_a_of_type_Long;
  }
  
  public static bdsn a(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong)
  {
    ...
    bdwk.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_last_pull_timestamp", paramLong);
  }
  ...
  private static void a(boolean paramBoolean)
  {
    ...
    bdwk.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_open", paramBoolean);
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
  ...
  public static boolean a()
  {
    ...
    if (bdwk.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_open", true)) {}
    for (int i = 1;; i = 0)
    {
      jdField_a_of_type_Int = i;
      if (QLog.isColorLevel()) {
  ...
  private void c()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Awbw.a(TroopKeyWord.class);
  ...
  public bdsm a(String paramString)
  {
    bdsm localbdsm = new bdsm();
    if ((TextUtils.isEmpty(paramString)) || (!a()))
    {
      localbdsm.jdField_a_of_type_JavaLangString = "";
      localbdsm.jdField_a_of_type_Boolean = false;
      localbdsm.c = 1;
    ...
    {
      localObject1 = ((Resources)localObject1).getString(2131693167);
      if ((!bdwk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_guide_clicked", false)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.isEmpty()))
      {
        bool = true;
        if (!bool) {
          break label245;
    ...
    for (;;)
    {
      ...
      localbdsm.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localbdsm.jdField_a_of_type_Boolean = bool;
      localbdsm.c = i;
      return localbdsm;
      bool = false;
      break;
      ...
      localbdsm.jdField_a_of_type_Int = j;
      localbdsm.jdField_b_of_type_Int = i;
      localbdsm.jdField_b_of_type_JavaLangString = localExpireSet.toJson();
      localObject2 = bdwk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_expire_list_" + paramString, null);
      if (!ExpireSet.fromJson((String)localObject2).containsAll(localExpireSet))
      {
        ...
        QLog.e("TroopKeywordManager.troop.special_msg.keyword", 1, "expireList hasNewExpiredId, last:" + (String)localObject2 + " now:" + localbdsm.jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        if (j <= 0) {
        ...
        localObject1 = ((Resources)localObject1).getString(2131699975, new Object[] { Integer.valueOf(j) });
        i = 5;
        break;
        bool = false;
        break label429;
        label511:
        bdwk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_expire_list_" + paramString, localbdsm.jdField_b_of_type_JavaLangString);
      }
      label547:
      if (i > 0)
      {
        localObject1 = ((Resources)localObject1).getString(2131699980);
        i = 4;
      }
      else
      {
        localObject1 = ((Resources)localObject1).getString(2131699976, new Object[] { Integer.valueOf(localList.size()) });
        bool = false;
        i = 3;
      }
    }
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    azmj.b(null, "dc00898", "", paramString2, "qq_vip", "0X800A8FD", 0, 1, 0, "", "", localTroopKeyWord.keyword, "");
    return true;
  }
  ...
  public void b()
  {
    ...
    ((alxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(new bdso(this), true);
  }
}
