...
{
  public anih(BrowserAppInterface paramBrowserAppInterface, SharedPreferences paramSharedPreferences, long paramLong) {}
  ...
  public void onDownloadFinish(int paramInt)
  {
    ...
    if ((paramInt != 100) && (paramInt != 120) && (paramInt != 122))
    {
      if (BrowserAppInterface.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(true, false))
      {
        ...
        localEditor.commit();
        bcst.b(null, "P_CliOper", "BizTechReport", "", "web", "tbs_download_error", 0, 1, paramInt, "", "", "", "");
    ...
    {
      return;
      bcst.b(null, "P_CliOper", "BizTechReport", "", "web", "tbs_download_ok", 0, 1, paramInt, "", "", "", "");
  ...
  public void onInstallFinish(int paramInt)
  {
    ...
    if (BrowserAppInterface.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(true, false))
    {
      ...
      localEditor.putLong("tbs_download_cost", l1 + (l2 - l3));
      localEditor.commit();
      bcst.b(null, "P_CliOper", "BizTechReport", "", "web", "tbs_install_error", 0, 1, paramInt, "", "", "", "");
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      localEditor.commit();
      bcst.b(null, "P_CliOper", "BizTechReport", "", "web", "tbs_install_ok", 0, 1, paramInt, Long.toString(l1 + (l2 - l3)), Integer.toString(i + 1), "", "");
      if (QLog.isColorLevel()) {
