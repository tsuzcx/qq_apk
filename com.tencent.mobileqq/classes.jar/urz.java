  ...
  implements uqz
{
  ...
  amab jdField_a_of_type_Amab = new usa(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = vhj.b;
  }
      ...
      if (localIterator.hasNext())
      {
        ...
        else
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            this.jdField_a_of_type_Alzf.a(str1, localTroopInfo.troopcode, (ArrayList)localObject1);
            localObject1 = new ArrayList(20);
            i = 1;
          }
        }
