...
public class mwb
  extends BaseAdapter
{
  public mwb(mwa parammwa) {}
  
  public nbu a(int paramInt)
  {
    return (nbu)this.a.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    int i = aciy.a(200.0F, paramViewGroup);
    int j = aciy.a(140.0F, paramViewGroup);
    int k = aciy.a(12.0F, paramViewGroup);
    Object localObject;
    if (paramView == null)
    {
      paramView = new mwc(this);
    ...
    for (;;)
    {
      ...
      paramView.jdField_a_of_type_ComTencentImageURLImageView.setBackgroundDrawable(URLDrawable.getDrawable(((nbu)localObject).e, null, null, true));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(((nbu)localObject).a);
      return paramViewGroup;
      localObject = (mwc)paramView.getTag();
