...
public class anxb
{
  public static HashMap<String, anwk> a;
  public anvs a;
  private bbwf a;
  ...
  public anxb(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_Bbwf = new anxc(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = ((QQAppInterface)paramAppInterface);
    this.jdField_a_of_type_Anvs = ((anvs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(43));
  }
  ...
  {
    File localFile = new File(anzm.r.replace("[epId]", paramString1));
    boolean bool = true;
    if (localFile.exists()) {
  ...
  private void a(EmoticonPackage paramEmoticonPackage, ArrayList<Emoticon> paramArrayList, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    localanvs.b(localArrayList, localHashMap, paramEmoticonPackage, paramBundle);
    int i = localanvs.a(paramEmoticonPackage, paramArrayList, localArrayList, localHashMap, paramBundle, 6);
    if (i != 0)
    {
      QLog.e("VasEmojiManager", 1, "downloadOthers error : " + i);
      return;
    }
    paramArrayList = new bbwg(localArrayList, localHashMap, "vipEmoticonKey_" + paramEmoticonPackage.epId);
    paramArrayList.n = true;
    if (localArrayList.size() == 0)
    {
      paramArrayList.a(paramBundle);
      paramArrayList.a(3);
      this.jdField_a_of_type_Bbwf.onDone(paramArrayList);
    }
    for (;;)
    {
      localanvs.b(paramEmoticonPackage, paramBoolean);
      return;
      localanvs.a().a(paramArrayList, this.jdField_a_of_type_Bbwf, paramBundle);
    }
  }
  ...
  public static void a(String paramString)
  {
    ...
    VasQuickUpdateEngine.safeDeleteFile(new File(anzm.n.replace("[epId]", paramString)));
  }
      ...
      for (;;)
      {
        if (i >= 0)
        {
          ...
          try
          {
            ...
            localanwk.jdField_a_of_type_JavaLangString = localJSONObject.getString("leftText");
            localanwk.b = localJSONObject.getString("linkText");
            localanwk.c = localJSONObject.getString("type");
            localHashMap.put(str, localanwk);
            i -= 1;
          }
  ...
  private boolean a(String paramString, Bundle paramBundle, EmoticonPackage paramEmoticonPackage)
  {
    ...
    try
    {
      ...
      try
      {
        str2 = anzm.v.replace("[epId]", str1);
        localObject = str2.replace("h5magic", "tmp_unzip");
        bbdj.a(paramString, (String)localObject, false);
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = bbdj.a((File)localObject);
        paramString = anwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramEmoticonPackage, anvs.c, paramString, localArrayList, localanwq);
        if (paramString != null)
        {
      ...
      catch (OutOfMemoryError paramString)
      {
        ...
        if ((!localanwq.jdField_a_of_type_Boolean) && (paramEmoticonPackage.jobType != 4))
        {
          ...
          paramString.a(paramEmoticonPackage.epId, localArrayList, localanwq);
          int j = i + 1;
          ...
          if (QLog.isColorLevel()) {
            QLog.d("VasEmojiManager", 2, "addEmoticonsTask| fetchEncryptKeys count=" + j + " encryptKeysSuccess=" + localanwq.jdField_a_of_type_Boolean);
          }
          if (!localanwq.jdField_a_of_type_Boolean)
          {
            QLog.e("VasEmojiManager", 1, "addEmoticonsTask| fetchEncryptKeys fail epId=" + paramEmoticonPackage.epId + " encryptGetKeySeq=" + localanwq.jdField_a_of_type_JavaLangString + " encryptKeysResultCode" + localanwq.jdField_a_of_type_Int);
            bool = false;
            break;
          }
        }
  ...
  {
    paramString = a(paramString);
    return anzm.u.replace("[epId]", paramString);
  }
  
  public anvs a()
  {
    return this.jdField_a_of_type_Anvs;
  }
  ...
  public void a(EmoticonPackage paramEmoticonPackage, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localBundle.putBoolean("isUpdate", anzm.a(paramEmoticonPackage));
    ...
    a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramEmoticonPackage.epId, new anxa(paramEmoticonPackage.epId, null));
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (localObject1 == null)
    {
      ...
      EmoticonPackage localEmoticonPackage = ((askd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(str);
      localObject1 = localEmoticonPackage;
      if (localEmoticonPackage == null)
      {
        localObject1 = new EmoticonPackage();
        ((EmoticonPackage)localObject1).name = ajyc.a(2131716037);
      ...
      ((Bundle)localObject2).putBoolean("isUpdate", anzm.a((EmoticonPackage)localObject1));
    ...
    for (;;)
    {
      ...
      if ((paramInt != 0) || (!a(b(paramString), (Bundle)localObject1, (EmoticonPackage)localObject2))) {
        anvs.jdField_a_of_type_Anvr.a((EmoticonPackage)localObject2, paramInt, 8, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
  ...
  {
    paramString = a(paramString);
    anxa localanxa = (anxa)a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localanxa != null) {
      localanxa.a((float)paramLong1 * 100.0F / (float)paramLong2);
    }
    ...
    if (paramString != null)
    {
      ...
      anvs.jdField_a_of_type_Anvr.b(paramString, (int)paramLong1, (int)paramLong2);
    }
  }
}
