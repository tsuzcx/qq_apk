...
public class aitz
{
  ...
  public aitz()
  {
    this.jdField_a_of_type_Ajop = new aiua(this);
  }
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if ((TextUtils.isEmpty(airz.d)) || (TextUtils.isEmpty(airz.e)))
    {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (ajfj.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        break label178;
      }
    ...
    bakq localbakq = ((bakk)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
    if ((localbakq != null) && (localbakq.jdField_a_of_type_Boolean))
    {
      QLog.i("sava_ChatPieApolloViewController", 1, "checkNeedPreLoadEngine isGag");
      return;
    }
    if (ajfj.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.d("sava_ChatPieApolloViewController", 1, "Apollo func is double-hidden.");
      return;
    }
    if (!ajfj.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
  ...
  public boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    Object localObject = ((bakk)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
    if ((localObject != null) && (((bakq)localObject).jdField_a_of_type_Boolean)) {
      return false;
    }
    ...
    ajou.b("aio_pre");
    int i = ajfj.b(0);
    ajlq.a(i, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    ajlq.a(i, 1);
    ajlq.a(i, 10);
    ajlq.a(i, null, new int[] { ajlp.a(i, false, 0, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false) });
    localObject = (ajfg)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    ((ajfg)localObject).a(paramBaseChatPie);
    if (ajfj.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      if (QLog.isColorLevel()) {
        QLog.d("sava_ChatPieApolloViewController", 2, "Apollo func is double-hidden.");
      }
      ajlq.a(i, 10, 103, new Object[] { "double hidden" });
      return false;
    }
    if (!ajfj.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      return false;
    ...
    if (localObject != null) {
      ((SpriteUIHandler)localObject).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, paramBaseChatPie.jdField_a_of_type_Acut);
    }
    if (ajkk.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != 1)
    {
      if (QLog.isColorLevel()) {
  ...
  public void b(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      ajlq.a(i, 10, 106, new Object[] { "aio is finished" });
    } while (!QLog.isColorLevel());
    QLog.d("sava_ChatPieApolloViewController", 2, "aio is finished, not init apollo.");
    return;
    Object localObject = (aist)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(227);
    ((aist)localObject).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    ((aist)localObject).a(((aist)localObject).a);
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView != null))
    {
    ...
    boolean bool1;
    if ((Build.VERSION.SDK_INT >= 26) || (airz.p))
    {
      bool1 = true;
      label142:
      if (QLog.isColorLevel()) {
      ...
      localObject = (ajfg)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
      ajlq.a(i, 10, 0, new Object[] { "cmshow switch done" });
      ajlq.a(i, 100);
      ajlq.a(i, 101);
      ajou.a("onSurfaceCreated");
      if (!bool1) {
        break label733;
      }
    }
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(paramBaseChatPie.jdField_a_of_type_Ajrq, 0, this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender);
        ...
        if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((ajfg)localObject).a(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView);
        }
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender = null;
        if (ajmt.jdField_b_of_type_Boolean) {
          break label827;
        }
        bool2 = true;
        ...
        ThreadManager.postImmediately(new ChatPieApolloViewController.5(this, i, paramBaseChatPie, (ajfg)localObject), null, false);
        ...
        ((RelativeLayout.LayoutParams)localObject).addRule(6, 2131369274);
        adho localadho = (adho)paramBaseChatPie.a(52);
        if ((localadho == null) || (!localadho.jdField_a_of_type_Boolean)) {
          break label891;
        }
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131375658);
        ...
        localLayoutParams = new RelativeLayout.LayoutParams(-1, (int)((float)bbct.j() * 0.171F));
        if ((localadho == null) || (!localadho.jdField_a_of_type_Boolean)) {
          break label903;
        }
        localLayoutParams.addRule(2, 2131375658);
        ...
        localObject = (airz)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
        if (localObject == null) {
          break;
        }
        ((airz)localObject).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramBaseChatPie.jdField_a_of_type_AndroidContentContext);
        return;
      }
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.init(paramBaseChatPie.jdField_a_of_type_Ajrq, 0, this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender);
      if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        ((ajfg)localObject).a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView);
      }
      ...
      continue;
      label833:
      ThreadManager.excute(new ChatPieApolloViewController.6(this, paramBaseChatPie, (ajfg)localObject), 16, null, false);
      continue;
      label854:
      ...
      continue;
      label869:
      ((RelativeLayout.LayoutParams)localObject).bottomMargin = (-actn.a(5.0F, paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getResources()));
      continue;
      label891:
  ...
  public void c(BaseChatPie paramBaseChatPie)
  {
    ...
    if (paramBaseChatPie == null) {}
    while ((!airz.e()) || (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null)) {
      return;
    }
    ...
    Object localObject1 = (adho)paramBaseChatPie.a(52);
    if ((localObject1 != null) && (((adho)localObject1).jdField_a_of_type_Boolean)) {
      localLayoutParams.addRule(2, 2131375658);
    }
    for (;;)
    {
      ...
      localObject1 = new ajpa(paramBaseChatPie);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.init((aive)localObject1);
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender() != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback((aivc)localObject1);
      }
      Object localObject2 = (ajfg)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
      ((ajfg)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
      localObject2 = ((ajfg)localObject2).a();
      if (localObject2 != null) {
        ((ajpa)localObject1).a((aivc)localObject2);
      }
      paramBaseChatPie.a().addView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, 0, localLayoutParams);
      return;
      label274:
      localLayoutParams.bottomMargin = (-actn.a(5.0F, paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getResources()));
      break;
      localLayoutParams.addRule(2, 2131368187);
    }
  }
  ...
  public void d(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      ((airz)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(new WeakReference(paramBaseChatPie));
    } while (!a());
    ((ajfg)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
  ...
  public void e(BaseChatPie paramBaseChatPie)
  {
    ...
    ((ajfg)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
  ...
  public void f(BaseChatPie paramBaseChatPie)
  {
    ...
    for (;;)
    {
      ((ajfg)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).onDestroy();
      if (a()) {
        break label271;
      }
    ...
    label271:
    localObject = (aist)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(227);
    ((aist)localObject).a(null);
    ((aist)localObject).a(null);
    localObject = (airv)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211);
    if (localObject != null) {
      ((airv)localObject).a();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
