  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (int i = paramFromServiceMsg.getResultCode();; i = -1)
    {
      ...
      paramFromServiceMsg = bjqn.a(paramFromServiceMsg.getWupBuffer());
      if (paramFromServiceMsg == null) {
        break;
      }
      ...
      notifyObserver(null, 1008, true, paramIntent, avvd.class);
      return;
    }
    ...
    notifyObserver(null, 1008, false, paramIntent, avvd.class);
    return;
    label152:
    if (QLog.isColorLevel()) {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    localObject2 = new bjqn(a((String)localObject1, i, (String)localObject2, l, paramIntent));
    localObject1 = ((bjqn)localObject2).encode();
    paramIntent = (Intent)localObject1;
    if (localObject1 == null)
    {
      QLog.e("QbossReportServlet", 1, "onSend request encode result is null.cmd=" + ((bjqn)localObject2).uniKey());
      paramIntent = new byte[4];
    }
    paramPacket.setTimeout(60000L);
    paramPacket.setSSOCommand("SQQzoneSvc." + ((bjqn)localObject2).uniKey());
