  ...
  extends AsyncTask<String, Void, Integer>
{
  ...
  public alea(ShortVideoPreviewActivity paramShortVideoPreviewActivity, Activity paramActivity)
  {
  ...
  protected Integer a(String... paramVarArgs)
  {
    ...
    //   10: ifne +10 -> 20
    //   13: aload_0
    //   14: getfield 21	alea:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   17: ifnonnull +8 -> 25
    //   20: iconst_m1
    ...
    //   25: aload_0
    //   26: aload 13
    //   28: putfield 46	alea:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   75: lstore 6
    //   77: aload_0
    //   78: getfield 21	alea:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   81: iconst_0
    //   82: iconst_0
    //   83: invokestatic 88	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:initVideoTrim	(Landroid/content/Context;II)Z
    //   86: istore 12
    //   88: aload 13
    //   90: ldc 90
    //   92: invokevirtual 96	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   95: istore_2
    //   96: iload_2
    //   97: iconst_m1
    //   98: if_icmpne +8 -> 106
    ...
    //   114: iconst_1
    //   115: iadd
    //   116: invokevirtual 100	java/lang/String:substring	(I)Ljava/lang/String;
    //   119: invokestatic 106	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoCompressPath	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   122: putfield 108	alea:b	Ljava/lang/String;
    //   125: iload 12
    //   127: ifeq +161 -> 288
    //   130: aload 13
    //   132: invokestatic 112	com/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer:getCompressConfig	(Ljava/lang/String;)Lcom/tencent/mobileqq/shortvideo/util/ShortVideoTrimmer$CompressConfig;
    //   135: pop
    //   136: getstatic 118	com/tencent/mobileqq/activity/shortvideo/ShortVideoPreviewActivity:i	I
    //   139: iconst_m1
    //   140: if_icmpne +255 -> 395
    //   143: invokestatic 123	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   146: ifeq +11 -> 157
    //   149: ldc 125
    //   151: iconst_2
    //   152: ldc 127
    //   154: invokestatic 131	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   157: aload_0
    //   158: aload_0
    //   159: getfield 46	alea:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   162: putfield 108	alea:b	Ljava/lang/String;
    //   165: iconst_0
    //   166: istore_2
    ...
    //   181: invokevirtual 134	java/io/File:length	()J
    //   184: lstore 10
    //   186: lconst_0
    //   187: lstore 4
    //   189: aload_0
    //   190: getfield 108	alea:b	Ljava/lang/String;
    //   193: invokestatic 38	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   196: ifne +19 -> 215
    //   199: new 48	java/io/File
    //   202: dup
    //   203: aload_0
    //   204: getfield 108	alea:b	Ljava/lang/String;
    //   207: invokespecial 69	java/io/File:<init>	(Ljava/lang/String;)V
    //   210: invokevirtual 134	java/io/File:length	()J
    //   213: lstore 4
    //   215: iload_2
    //   216: istore_3
    ...
    //   238: iload_2
    //   239: invokevirtual 141	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   242: ldc 143
    //   244: invokevirtual 60	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   247: lload 8
    //   249: lload 6
    //   251: lsub
    //   252: invokevirtual 146	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   255: ldc 148
    //   257: invokevirtual 60	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   260: lload 10
    //   262: invokevirtual 146	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   265: ldc 150
    //   267: invokevirtual 60	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   270: lload 4
    //   272: invokevirtual 146	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   275: ldc 152
    ...
    //   283: invokestatic 131	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   286: iload_2
    //   287: istore_3
    //   288: aload_0
    //   289: getfield 21	alea:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   292: aload 13
    //   294: invokestatic 156	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getVideoThumbnail	(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   297: astore 14
    //   299: aload 14
    //   301: ifnull +89 -> 390
    ...
    //   316: lload 6
    //   318: invokestatic 159	java/lang/String:valueOf	(J)Ljava/lang/String;
    ...
    //   332: invokespecial 164	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   335: astore_1
    //   336: aload_1
    //   337: invokevirtual 167	java/io/File:createNewFile	()Z
    //   340: ifeq +233 -> 573
    //   343: aload_0
    //   344: aload_1
    //   345: invokevirtual 170	java/io/File:getPath	()Ljava/lang/String;
    //   348: putfield 172	alea:c	Ljava/lang/String;
    //   351: new 174	java/io/FileOutputStream
    //   354: dup
    //   355: aload_1
    //   356: invokevirtual 170	java/io/File:getPath	()Ljava/lang/String;
    //   359: invokespecial 175	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   362: astore 13
    //   364: aload 13
    //   366: astore_1
    //   367: aload 14
    //   369: getstatic 181	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   372: bipush 100
    //   374: aload 13
    //   376: invokevirtual 187	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   379: pop
    //   380: aload 13
    //   382: ifnull +8 -> 390
    //   385: aload 13
    //   387: invokevirtual 190	java/io/FileOutputStream:close	()V
    //   390: iload_3
    //   391: invokestatic 44	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   394: areturn
    //   395: new 192	java/util/HashMap
    //   398: dup
    //   399: invokespecial 193	java/util/HashMap:<init>	()V
    //   402: pop
    //   403: aload 13
    //   405: aload_0
    //   406: getfield 21	alea:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   409: invokestatic 196	com/tencent/mobileqq/activity/shortvideo/ShortVideoPreviewActivity:a	(Ljava/lang/String;Landroid/content/Context;)Ljava/util/HashMap;
    //   412: astore 14
    //   414: aload 14
    //   416: ldc 198
    //   418: invokevirtual 202	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   421: checkcast 92	java/lang/String
    //   424: invokestatic 205	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   427: istore_2
    //   428: aload_0
    //   429: aload 14
    //   431: ldc 207
    //   433: invokevirtual 202	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   436: checkcast 92	java/lang/String
    //   439: putfield 108	alea:b	Ljava/lang/String;
    //   442: invokestatic 123	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   445: ifeq +41 -> 486
    //   448: ldc 125
    //   450: iconst_2
    ...
    //   473: aload_0
    //   474: getfield 108	alea:b	Ljava/lang/String;
    ...
    //   512: aload 14
    //   514: invokevirtual 216	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   517: invokevirtual 66	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   520: invokestatic 218	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   523: aload 13
    //   525: ifnull -135 -> 390
    //   528: aload 13
    //   530: invokevirtual 190	java/io/FileOutputStream:close	()V
    //   533: goto -143 -> 390
    //   536: astore_1
    //   537: goto -147 -> 390
    //   540: astore 13
    ...
    //   545: ifnull +7 -> 552
    //   548: aload_1
    //   549: invokevirtual 190	java/io/FileOutputStream:close	()V
    //   552: aload 13
    //   554: athrow
    //   555: astore_1
    //   556: goto -166 -> 390
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (TextUtils.isEmpty(this.b))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, amtj.a(2131713190), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityShortvideoShortVideoPreviewActivity.getTitleBarHeight());
  ...
  {
    super.onPreExecute();
    this.jdField_a_of_type_Bhht.a(amtj.a(2131713161));
