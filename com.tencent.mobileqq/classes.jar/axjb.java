...
{
  private DialogInterface.OnKeyListener jdField_a_of_type_AndroidContentDialogInterface$OnKeyListener = new axjc(this);
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  public axjd a;
  private FileSaveProgressView jdField_a_of_type_ComTencentMobileqqMultimsgSaveFileSaveProgressView;
  
  public axjb(@NonNull Context paramContext)
  {
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131559207, null);
    setContentView(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqMultimsgSaveFileSaveProgressView = ((FileSaveProgressView)paramContext.findViewById(2131377033));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131364250));
  ...
  public void a(axjd paramaxjd)
  {
    this.jdField_a_of_type_Axjd = paramaxjd;
  }
