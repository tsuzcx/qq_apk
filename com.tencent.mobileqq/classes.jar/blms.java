...
{
  private blmv jdField_a_of_type_Blmv;
  ...
  public blms(Context paramContext)
  {
    super(paramContext);
    this.jdField_b_of_type_Blmr = new blmt(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560235, null);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<AdDislikeInfo> paramArrayList)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(1)))
    {
      ...
      a(this.jdField_g_of_type_JavaUtilArrayList, this.jdField_g_of_type_AndroidViewView, 2130841658, paramArrayList.jdField_a_of_type_JavaLangString, bool);
      ...
      a(this.jdField_h_of_type_JavaUtilArrayList, this.jdField_h_of_type_AndroidViewView, 2130841660, paramArrayList.jdField_a_of_type_JavaLangString, bool);
      label352:
      ...
      a(this.jdField_i_of_type_JavaUtilArrayList, this.jdField_i_of_type_AndroidViewView, 2130841651, paramArrayList.jdField_a_of_type_JavaLangString, bool);
    }
    for (;;)
    {
      paramArrayList = new DislikeInfo();
      paramArrayList.jdField_a_of_type_JavaLangString = anzj.a(2131704834);
      paramArrayList.jdField_a_of_type_Int = 0;
      this.jdField_j_of_type_JavaUtilArrayList.add(paramArrayList);
      a(this.jdField_j_of_type_JavaUtilArrayList, this.jdField_j_of_type_AndroidViewView, 2130841642, paramArrayList.jdField_a_of_type_JavaLangString, false);
      this.jdField_j_of_type_AndroidViewView.findViewById(2131368977).setVisibility(0);
      a();
      if (QLog.isColorLevel()) {
        QLog.d("KandianNegativeWindowForAd", 1, "setData:" + localStringBuilder.toString());
      }
      return;
      a(new ArrayList(), this.jdField_g_of_type_AndroidViewView, 2130841658, anzj.a(2131704818), false);
      break;
      label563:
      a(new ArrayList(), this.jdField_h_of_type_AndroidViewView, 2130841660, anzj.a(2131704821), false);
      break label352;
      label589:
      a(new ArrayList(), this.jdField_i_of_type_AndroidViewView, 2130841651, anzj.a(2131704822), false);
    }
  }
  
  public void a(View paramView)
  {
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365046));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131370571));
    this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout = ((NegativeChildrenLayout)paramView.findViewById(2131364522));
    ...
    this.jdField_g_of_type_AndroidViewView = paramView.findViewById(2131371707);
    this.jdField_h_of_type_AndroidViewView = paramView.findViewById(2131371715);
    this.jdField_i_of_type_AndroidViewView = paramView.findViewById(2131371711);
    this.jdField_j_of_type_AndroidViewView = paramView.findViewById(2131371705);
    ...
    this.jdField_j_of_type_AndroidViewView.findViewById(2131377371).setVisibility(4);
    setBackgroundDrawable(new ColorDrawable());
    ((ImageView)paramView.findViewById(2131366686).findViewById(2131369836)).setOnClickListener(this);
    this.jdField_i_of_type_Int = ((int)bhlo.i());
    this.jdField_j_of_type_Int = ((int)bhlo.j());
    this.l = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298713));
    this.k = (this.jdField_i_of_type_Int - this.l * 2);
    setWidth(this.k);
    this.m = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298689));
    setOnDismissListener(new blmu(this));
  }
  
  public void a(blmv paramblmv)
  {
    this.jdField_a_of_type_Blmv = paramblmv;
  }
  ...
  public void b(pqk parampqk, ArrayList<AdDislikeInfo> paramArrayList)
  {
    int n = 0;
    ...
    {
      m = parampqk.b;
      k = parampqk.jdField_a_of_type_Int;
    }
    for (parampqk = parampqk.a();; parampqk = localObject)
    {
      if (parampqk != null) {
        n = ozs.a(parampqk);
      }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout.setData(this.jdField_g_of_type_JavaUtilArrayList, ((DislikeInfo)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(1))).jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Blmr);
        a(true);
        continue;
        if (paramView.getTag() != null)
        {
        ...
        {
          this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout.setData(this.jdField_g_of_type_JavaUtilArrayList, ((DislikeInfo)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(2))).jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Blmr);
          a(true);
          continue;
          if (paramView.getTag() != null)
          {
          ...
          {
            this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout.setData(this.jdField_g_of_type_JavaUtilArrayList, ((DislikeInfo)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(3))).jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Blmr);
            a(true);
            continue;
            if (this.jdField_a_of_type_Blmv != null) {
              this.jdField_a_of_type_Blmv.a();
            }
            dismiss();
            continue;
            a(false);
