  ...
  extends BaseAdapter
{
  ...
  public auaz(QzonePhotoView paramQzonePhotoView) {}
  ...
  {
    paramViewGroup = (aubb)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    if (paramView == null)
    {
      paramView = new auba(this);
      RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqProfileViewQzonePhotoView.getContext()).inflate(2131496035, null);
      localRelativeLayout.setLayoutParams(new AbsListView.LayoutParams(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int));
      paramView.a = ((URLImageView)localRelativeLayout.findViewById(2131307946));
      paramView.a.setTag(new atuw(25, Integer.valueOf(paramInt)));
      String str2 = azyk.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewQzonePhotoView.a, -1L);
      ...
      if (paramViewGroup.d == 100) {
        if (!TextUtils.isEmpty(str1))
        {
          ...
          paramView.a.setContentDescription(ajjy.a(2131646351) + (paramInt + 1));
        }
      }
      for (;;)
      {
        ...
        {
          atxe.a(paramView.a, "src", QzonePhotoView.a(this.jdField_a_of_type_ComTencentMobileqqProfileViewQzonePhotoView).a, "photoAddSrc");
          paramView.a.setContentDescription(ajjy.a(2131646345));
        }
        else if (paramViewGroup.d == 102)
        {
          ...
          paramView.a.setContentDescription(ajjy.a(2131646354));
        }
      }
    }
    paramViewGroup = (auba)paramView.getTag();
    return paramView;
  }
}
