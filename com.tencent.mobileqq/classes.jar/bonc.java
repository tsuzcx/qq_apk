...
public class bonc
{
  private static bonc jdField_a_of_type_Bonc;
  private WeakReference<DoodleLayout> jdField_a_of_type_JavaLangRefWeakReference;
  private WeakReference<DoodleLayout> b;
  
  public static bonc a()
  {
    if (jdField_a_of_type_Bonc == null) {
      jdField_a_of_type_Bonc = new bonc();
    }
    return jdField_a_of_type_Bonc;
  }
