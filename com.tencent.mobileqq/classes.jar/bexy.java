...
public class bexy
{
  ...
  {
    return beya.a().a("contentboxlaunch", "gocontentboxminiprogram", 0);
  }
  ...
  public static void a(bexz parambexz)
  {
    if (parambexz != null) {
      QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new QZoneConfigHelper.1(parambexz));
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    try
    {
      boolean bool = ((aroj)paramQQAppInterface.getManager(10)).b();
      return bool;
    }
