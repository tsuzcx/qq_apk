  ...
  extends bewd
{
  ...
  public bexy(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    for (paramBundle = "0";; paramBundle = "1")
    {
      ...
      bgip.a("two_comment", "exp", this.d, this.h, "", "");
      return;
    }
  }
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(this.jdField_a_of_type_AndroidContentContext, nta.class);
      ...
      paramString.setObserver(new bexz(this));
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime().startServlet(paramString);
      return;
    }
    catch (Exception paramString)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, 2131696005, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
  ...
  public void dismiss()
  {
    ...
    {
      bgip.a("two_comment", "un", this.d, str, "", "");
