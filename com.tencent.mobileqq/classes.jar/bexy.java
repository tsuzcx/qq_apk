  ...
  implements LayeredSocketFactory
{
  ...
  public bexy(String paramString)
  {
  ...
  public Socket createSocket(Socket paramSocket, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      beuf.a(i + 4, paramString, paramInt, this.jdField_a_of_type_JavaLangString);
      paramSocket.close();
    ...
    beuf.a(i, paramString, paramInt, this.jdField_a_of_type_JavaLangString);
    return paramSocket;
  }
