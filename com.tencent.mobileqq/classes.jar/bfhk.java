  ...
  implements bfhy
{
  ...
  public bfhk(bfhh parambfhh, WheelPickerLayout paramWheelPickerLayout)
  {
    ...
    if (i >= bfhh.a(parambfhh))
    {
      paramWheelPickerLayout.add(5, 1);
      paramWheelPickerLayout.set(11, bfhh.b(parambfhh));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramWheelPickerLayout.add(12, bfhh.c(parambfhh) - i % bfhh.c(parambfhh));
      }
    }
  }
  ...
  private String b(int paramInt)
  {
    ...
    default: 
      return "";
    case 1: 
      return amtj.a(2131714713);
    case 2: 
      return amtj.a(2131714726);
    case 3: 
      return amtj.a(2131714717);
    case 4: 
      return amtj.a(2131714711);
    case 5: 
      return amtj.a(2131714709);
    case 6: 
      return amtj.a(2131714725);
    }
    return amtj.a(2131714727);
  }
  ...
  public int a(int paramInt)
  {
    ...
    default: 
      return 0;
    case 0: 
      return bfhh.d(this.jdField_a_of_type_Bfhh);
    case 1: 
      paramInt = a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0) }).get(11);
      return bfhh.a(this.jdField_a_of_type_Bfhh) - paramInt + 1;
    }
    return (60 - a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0), this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(1) }).get(12)) / bfhh.c(this.jdField_a_of_type_Bfhh);
  }
  ...
  public int a(Calendar paramCalendar, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = (int)((paramCalendar.get(12) - l) / bfhh.c(this.jdField_a_of_type_Bfhh));
    if (paramInt1 > 0) {
      return paramInt1;
    }
    return 0;
  ...
  public Calendar a(int... paramVarArgs)
  {
    ...
    if (paramVarArgs[0] > 0)
    {
      ...
      localCalendar.set(11, bfhh.b(this.jdField_a_of_type_Bfhh));
    ...
    if (paramVarArgs.length > 2) {
      localCalendar.add(12, paramVarArgs[2] * bfhh.c(this.jdField_a_of_type_Bfhh));
    }
  ...
  public int[] a(long paramLong)
  {
    ...
    arrayOfInt[2] = ((localCalendar1.get(12) - localCalendar2.get(12)) / bfhh.c(this.jdField_a_of_type_Bfhh));
    return arrayOfInt;
  }
}
