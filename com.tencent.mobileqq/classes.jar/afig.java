...
public class afig
  extends bgsp
  implements bgvf, bgvy, bgzq, bgzu
{
  protected aadf a;
  private afid a;
  
  public afig(Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
    super(paramContext, paramActivity, paramAppInterface);
    super.preInitPluginEngine();
    this.mWebview = new TouchWebView(paramContext);
    buildBaseWebView(this.mInterface);
    this.jdField_a_of_type_Afid = new afid(paramActivity, this.mWebview);
  }
  ...
  protected aadf a()
  {
    ...
    {
      this.jdField_a_of_type_Aadf = new aadf(this.mInterface, this.mInActivity);
      this.jdField_a_of_type_Aadf.a(this);
    }
    return this.jdField_a_of_type_Aadf;
  }
  ...
  public void bindJavaScript(ArrayList<WebViewPlugin> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      paramArrayList.add(new aadl());
      paramArrayList.add(new oed());
    }
  }
  ...
  {
    this.jdField_a_of_type_Afid.a(a());
  }
