...
public class avin
{
  private static volatile avin jdField_a_of_type_Avin;
  ...
  private avis jdField_a_of_type_Avis;
  ...
  private avin()
  {
    if (Build.VERSION.SDK_INT >= 21) {
      this.jdField_a_of_type_AndroidNetConnectivityManager$NetworkCallback = new avio(this);
    }
    try
    {
      b();
  ...
  public static avin a()
  {
    ...
    {
      if (jdField_a_of_type_Avin == null) {
        jdField_a_of_type_Avin = new avin();
      }
      return jdField_a_of_type_Avin;
    }
    finally {}
  }
  ...
  private void a(avis paramavis)
  {
    this.jdField_a_of_type_Avis = paramavis;
  }
  
  @RequiresApi(api=21)
  private void a(String paramString, Network paramNetwork, aviq paramaviq)
  {
    ThreadManagerV2.excute(new GateWayVerifyManager.2(this, paramString, paramNetwork, paramaviq), 128, null, true);
  }
  
  /* Error */
  private void a(java.net.HttpURLConnection paramHttpURLConnection, java.net.URL paramURL, aviq paramaviq)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
  ...
  private void b(String paramString, aviq paramaviq)
  {
    ThreadManagerV2.excute(new GateWayVerifyManager.3(this, paramString, paramaviq), 128, null, true);
  }
  ...
  private void c(String paramString, aviq paramaviq)
  {
    QLog.d("GateWayVerifyManager", 1, "start changeNetTypeToMobileV19");
    ThreadManagerV2.excute(new GateWayVerifyManager.4(this, paramString, paramaviq), 128, null, true);
  }
  
  @RequiresApi(api=21)
  private void d(String paramString, aviq paramaviq)
  {
    boolean bool = false;
    ...
    a(new avip(this, paramString, paramaviq));
    if (localNetwork == null)
    {
      this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(new GateWayVerifyManager.6(this, paramaviq), 4000L);
      return;
    }
    a(paramString, localNetwork, new avir(paramaviq, localNetwork));
  }
  ...
  public void a()
  {
    ...
    //   2: monitorenter
    //   3: aload_0
    //   4: getfield 414	avin:jdField_a_of_type_Boolean	Z
    //   7: ifeq +16 -> 23
    //   10: ldc 67
    //   12: iconst_1
    //   13: ldc_w 416
    ...
    //   22: return
    //   23: aconst_null
    //   24: putstatic 120	avin:jdField_a_of_type_Avin	Lavin;
    //   27: aload_0
    //   28: iconst_1
    //   29: putfield 414	avin:jdField_a_of_type_Boolean	Z
    //   32: ldc 2
    //   34: monitorexit
    ...
    //   40: if_icmplt +19 -> 59
    //   43: aload_0
    //   44: getfield 42	avin:jdField_a_of_type_AndroidNetConnectivityManager	Landroid/net/ConnectivityManager;
    //   47: aload_0
    //   48: getfield 63	avin:jdField_a_of_type_AndroidNetConnectivityManager$NetworkCallback	Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    //   54: aload_0
    //   55: aconst_null
    //   56: invokespecial 178	avin:a	(Landroid/net/Network;)V
    //   59: aload_0
    //   60: getfield 50	avin:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   63: aconst_null
  ...
  public void a(String paramString, aviq paramaviq)
  {
    ...
    if (this.b)
    {
      paramaviq.a(new Exception("request network error"));
      return;
    }
