...
public class aflh
  implements mwa
{
  public aflh(ScoreQAVFragment paramScoreQAVFragment) {}
  ...
  public void a(Object paramObject, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        if (msq.a("qav_score_bad.jpg")) {
          this.a.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.a.getResources(), msq.b() + "qav_score_bad.jpg"));
        }
        ScoreQAVFragment.a(this.a).setVisibility(0);
        this.a.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.b.setText(2131695234);
      ...
      if (paramInt > 3)
      {
        ...
        try
        {
          if (msq.a("qav_score_good.jpg")) {
            this.a.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.a.getResources(), msq.b() + "qav_score_good.jpg"));
          }
