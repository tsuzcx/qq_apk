...
public class bdjh
{
  ...
  private bdjh(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static bdjh a(QQAppInterface paramQQAppInterface)
  {
    if (jdField_a_of_type_Bdjh == null) {}
    try
    {
      if (jdField_a_of_type_Bdjh == null) {
        jdField_a_of_type_Bdjh = new bdjh(paramQQAppInterface);
      }
      return jdField_a_of_type_Bdjh;
    }
    finally {}
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if ((paramMessageRecord instanceof MessageForStructing))
          {
            ...
            if ((((MessageForStructing)localObject1).structingMsg != null) && (!TextUtils.isEmpty(((MessageForStructing)localObject1).structingMsg.mMsgUrl)) && (atha.a(((MessageForStructing)localObject1).structingMsg.mMsgUrl))) {
          ...
          else
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              try
              {
                ...
                if (((!TextUtils.isEmpty((CharSequence)localObject1)) && (((String)localObject1).equals(String.valueOf(bdjg.a)))) || ((!TextUtils.isEmpty((CharSequence)localObject2)) && (atha.a((String)localObject2))))
                {
                  this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(paramMessageRecord);
                  return;
                }
      ...
      QLog.e(bdhn.i, 2, paramMessageRecord.getMessage());
      return;
    } while ((!(paramMessageRecord instanceof MessageForText)) || (!atha.a(((MessageForText)paramMessageRecord).msg)));
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(paramMessageRecord);
  }
}
