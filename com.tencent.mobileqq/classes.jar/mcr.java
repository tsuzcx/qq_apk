...
public class mcr
  extends antq
{
  public mcr(ConferenceFlyTicketActivity paramConferenceFlyTicketActivity) {}
  ...
  protected void onGetFlyTicket(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.a.jdField_a_of_type_Mcs = new mcs(this.a);
        paramString1 = new ArrayList();
        mvt localmvt = new mvt();
        localmvt.jdField_a_of_type_JavaLangString = ("https://pubacc.mobile.qq.com/mqqweb-rtx2qq/mqqweb/createConfCallback?feedkey=" + this.a.b);
        ...
        localmvt.jdField_a_of_type_JavaLangString = (localmvt.jdField_a_of_type_JavaLangString + "&ret=0&ticket=" + this.a.d);
        paramString1.add(localmvt);
        this.a.jdField_a_of_type_Mcs.execute(new ArrayList[] { paramString1 });
      }
      return;
    }
    this.a.jdField_a_of_type_Antl.c(paramLong2);
    this.a.a(1, paramInt);
  }
  ...
  protected void onJoinDiscussionByFlyTicket(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!TextUtils.isEmpty(this.a.h)) {
        ((antl)this.a.app.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(paramLong);
      }
      return;
    }
    this.a.a(1, paramInt);
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        this.a.c();
        AudioHelper.b(anvx.a(2131701879));
        ((antl)this.a.app.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(l);
        return;
      }
      this.a.finish();
      return;
