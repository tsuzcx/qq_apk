...
final class arov
{
  ...
  public static arov a(aqxa[] paramArrayOfaqxa)
  {
    Object localObject1;
    ...
    arov localarov = new arov();
    int j = paramArrayOfaqxa.length;
    int i = 0;
    for (;;)
    {
      localObject1 = localarov;
      if (i >= j) {
        break;
      }
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          if (((JSONObject)localObject1).has("has_gray")) {
            localarov.jdField_a_of_type_Boolean = ((JSONObject)localObject1).optBoolean("has_gray");
          }
          a((JSONObject)localObject1, localarov.jdField_a_of_type_JavaUtilMap);
        }
        i += 1;
      }
  ...
  public static void a(boolean paramBoolean, arov paramarov)
  {
    if (paramarov == null) {
    ...
    {
      return;
      if (!paramarov.jdField_a_of_type_JavaUtilMap.isEmpty()) {}
      for (i = 1;; i = 0)
      {
        if (i != 0) {
          TdsReaderGlobal.a(paramBoolean, paramarov.jdField_a_of_type_JavaUtilMap);
        }
        if (!paramarov.jdField_a_of_type_Boolean) {
          break;
        }
        aroy.a();
        return;
