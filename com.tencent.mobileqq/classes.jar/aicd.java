...
public class aicd
  implements aich
{
  private static final int jdField_a_of_type_Int = blbz.a(172.0F);
  private static final int b = blbz.a(31.5F);
  private static final int c = jdField_a_of_type_Int + blbz.a(16.0F);
  private static final int d = b + blbz.a(14.0F);
  private static final int e = c / 2;
  private static final int f = blbz.a(65.0F);
  private static final int g = blbz.a(10.0F);
  private static final int h = bbkx.b(30.0F);
  private static final int i = bbkx.b(8.0F);
  private static final int j = bbkx.b(12.0F);
  private static final int k = blbz.a(4.0F);
  ...
  public void a(@NonNull View paramView1, int paramInt1, int paramInt2, @NonNull View paramView2, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetPopupWindow == null)
    {
      ...
      a("create popWindow ");
      paramView2 = ((LayoutInflater)paramView1.getContext().getSystemService("layout_inflater")).inflate(2131559166, null, false);
      this.jdField_a_of_type_ComTencentMobileqqWidgetRoundImageView = ((RoundImageView)paramView2.findViewById(2131362317));
