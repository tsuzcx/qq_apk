  ...
  extends sgy
{
  ...
  private List<rym> jdField_a_of_type_JavaUtilList;
  JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private boolean jdField_a_of_type_Boolean;
  private List<rym> b;
  
  public ryf(boolean paramBoolean, List<rym> paramList1, List<rym> paramList2, JSONObject paramJSONObject, WeakReference paramWeakReference, String paramString)
  {
  ...
  protected boolean a(Integer paramInteger)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((localObject1 != null) && (((rym)localObject1).jdField_a_of_type_Boolean)) {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if (paramInteger.intValue() == 12)
            {
              ...
              bgpu.a(0, (String)localObject2, this.jdField_a_of_type_OrgJsonJSONObject.optString("share_url"), null, str2, str3, null, null, false, -1L).c((String)localObject1).b((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (String)localObject1, 2, null);
              continue;
            }
            ...
            if (paramInteger.intValue() == 16)
            {
              ...
              localObject2 = actj.a(new Intent((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), SplashActivity.class), null);
            ...
            {
              localObject1 = BridgeModule.access$400(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaModulesBridgeModule).a(this.jdField_a_of_type_JavaUtilList, this.b, paramInteger.intValue());
              if (!(localObject1 instanceof ryn)) {
                continue;
              }
              localObject1 = ((ryn)localObject1).b;
