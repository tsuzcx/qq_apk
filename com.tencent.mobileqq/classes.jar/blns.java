...
public class blns
{
  ...
  private void a(int paramInt)
  {
    ...
    {
      f1 = 1.0F;
      this.jdField_a_of_type_Int = agej.a(f1, ((Context)localObject).getResources());
      if (this.h != 0) {
        break label351;
      }
      f1 = 3.0F;
      label48:
      this.jdField_b_of_type_Int = agej.a(f1, ((Context)localObject).getResources());
      if (this.h != 0) {
        break label357;
      }
      f1 = f2;
      label70:
      this.c = agej.a(f1, ((Context)localObject).getResources());
      if (this.h != 0) {
        break label363;
      }
      f1 = 2.0F;
      label92:
      paramInt = agej.a(f1, ((Context)localObject).getResources());
      if (this.h != 0) {
        break label369;
      }
    }
    ...
    {
      int i1 = agej.a(f1, ((Context)localObject).getResources());
      this.e = i1;
      this.d = i1;
  ...
  private void a(Canvas paramCanvas, Context paramContext)
  {
    ...
    if (this.h == 0) {}
    for (int i1 = 2130838099;; i1 = 2130839432)
    {
