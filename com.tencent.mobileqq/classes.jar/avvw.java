...
public class avvw
  implements avvv
{
  static bdvv jdField_a_of_type_Bdvv = new avvz();
  private static File jdField_a_of_type_JavaIoFile;
  private static Comparator<File> jdField_a_of_type_JavaUtilComparator = new avvx();
  private bdvu jdField_a_of_type_Bdvu;
  private bdvw jdField_a_of_type_Bdvw = new avvy(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private ConcurrentHashMap<String, List<avwa>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private ConcurrentHashMap<String, bdvs> b;
  
  public avvw(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a(String paramString)
  {
    ...
    {
      jdField_a_of_type_JavaIoFile = new File(avsu.jdField_a_of_type_JavaLangString);
    ...
    return new File(avsu.jdField_a_of_type_JavaLangString, bita.d(paramString)).getAbsolutePath();
  }
  ...
  private void a(MusicInfo paramMusicInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i = avsv.a().jdField_a_of_type_Int;
        if (i <= 0)
        {
          ...
          if (paramMusicInfo.b.size() > 0)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str)) {
                ((List)localObject1).add(new avwa(paramMusicInfo.jdField_a_of_type_JavaLangString, str));
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (avwa)localIterator.next();
        if (((avwa)localObject2).jdField_a_of_type_Int == 1)
        {
          bool = true;
          break label583;
        }
      ...
      for (;;)
      {
        ...
        break;
        if ((((avwa)localObject2).jdField_a_of_type_Int == 0) && (localObject1 == null))
        {
          localObject1 = localObject2;
          break label595;
        }
        do
        {
          ...
          ((bdvs)localObject2).jdField_a_of_type_Bdvw = this.jdField_a_of_type_Bdvw;
          ((bdvs)localObject2).jdField_a_of_type_JavaLangString = ((avwa)localObject1).b;
          ((bdvs)localObject2).jdField_a_of_type_Int = 0;
          ((bdvs)localObject2).c = ((avwa)localObject1).d;
          ((bdvs)localObject2).d = 1;
          ((bdvs)localObject2).a(new Object[] { paramMusicInfo, localObject1 });
          ((bdvs)localObject2).jdField_a_of_type_Bdvv = jdField_a_of_type_Bdvv;
          this.jdField_a_of_type_Bdvu.a((bdws)localObject2);
          ((avwa)localObject1).jdField_a_of_type_Int = 1;
          break;
          break label595;
          bool = false;
          localObject1 = localObject2;
  ...
  {
    int i = biii.a(BaseApplicationImpl.getContext());
    boolean bool;
    if (paramInt == 0) {
      bool = true;
    }
  ...
  public static void b()
  {
    ...
    Object localObject1 = new File(avsu.jdField_a_of_type_JavaLangString);
  ...
  private boolean b(int paramInt)
  {
    ...
    File localFile1 = new File(avsu.jdField_a_of_type_JavaLangString);
    Object localObject;
    int i;
  ...
  private void c()
  {
    try
    {
      ...
      {
        Object localObject2 = (bdws)((Map.Entry)localIterator.next()).getValue();
        this.jdField_a_of_type_Bdvu.b((bdws)localObject2);
        if ((localObject2 instanceof bdvs))
        {
          localObject2 = (bdvs)localObject2;
          if (QLog.isColorLevel()) {
            QLog.d("ListenTogether.downloader", 2, String.format("cancelAllRequests, cancel req url: %s", new Object[] { ((bdvs)localObject2).jdField_a_of_type_JavaLangString }));
          }
        }
      }
      if (!QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 59	avvw:b	Ljava/util/concurrent/ConcurrentHashMap;
    //   25: aload_1
    //   26: invokevirtual 356	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   29: checkcast 343	bdws
    //   32: astore_2
    //   33: aload_2
    //   34: ifnull +13 -> 47
    //   37: aload_0
    //   38: getfield 52	avvw:jdField_a_of_type_Bdvu	Lbdvu;
    //   41: aload_2
    //   42: invokeinterface 345 2 0
    //   47: aload_0
    //   48: getfield 57	avvw:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   51: aload_1
