  ...
  extends bayp
{
  ...
  private long jdField_b_of_type_Long = basn.L;
  ...
  public baxb(QQAppInterface paramQQAppInterface, int paramInt1, DiscussionInfo paramDiscussionInfo, List<DiscussionMemberInfo> paramList, int paramInt2)
  {
  ...
  private long a(anuz paramanuz, String paramString1, long paramLong, String paramString2)
  {
    ...
    {
    default: 
      return bbgk.a(paramString2, paramString1, paramLong);
    case 0: 
      return bbgk.a(paramString2, paramString1, paramLong);
    }
    if (paramanuz.isUinInRecent(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin)) {
      return bbgk.a(paramString2, paramString1, paramLong, true, false, false);
    }
    return bbgk.a(paramString2, paramString1, paramLong);
  }
  
  private long a(List<List<baxc>> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localObject = ((baxc)((List)paramList.get(i)).get(j)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
        ...
        l2 = l1;
        if (((baxc)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long > l1) {
          l2 = ((baxc)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long;
        }
        j += 1;
        l1 = l2;
      }
    ...
    for (;;)
    {
      ...
      long l3 = ((baxc)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_Long;
      l2 = l1;
      if (l3 > l1) {
        l2 = l3;
      }
      this.jdField_a_of_type_JavaUtilSet.add(((baxc)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo);
      this.jdField_b_of_type_JavaUtilList.add(((baxc)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_JavaLangString);
      i += 1;
      l1 = l2;
    }
  }
  ...
  private void a()
  {
    int i = 0;
    int n = 0;
    if ((bbgk.a(this.jdField_b_of_type_Int)) || (this.jdField_b_of_type_Int == 5))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (int m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(bbgk.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6));
          i += 1;
      ...
      this.jdField_c_of_type_JavaLangCharSequence = (i + amtj.a(2131701661));
      return;
    }
    this.jdField_a_of_type_JavaLangCharSequence = amtj.a(2131701718);
    ...
    for (;;)
    {
      ...
      if (!this.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        ...
        while (i >= 0)
        {
          ((SpannableStringBuilder)localObject).append(bbgk.a((String)this.jdField_b_of_type_JavaUtilList.get(i), (String)this.jdField_c_of_type_JavaUtilList.get(i), 6));
          if (i > 0) {
            ((SpannableStringBuilder)localObject).append("、");
          }
          i -= 1;
  ...
  static boolean a(int paramInt, List<List<baxc>> paramList, long[] paramArrayOfLong, Map<DiscussionMemberInfo, Long> paramMap1, int[] paramArrayOfInt, Map<DiscussionMemberInfo, Integer> paramMap, boolean[] paramArrayOfBoolean, Set<DiscussionMemberInfo> paramSet, Map<DiscussionMemberInfo, Long> paramMap2)
  {
    paramArrayOfBoolean[paramInt] = true;
    int i = 0;
    if (i < ((List)paramList.get(paramInt)).size())
    {
      DiscussionMemberInfo localDiscussionMemberInfo = ((baxc)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
      if (paramSet.contains(localDiscussionMemberInfo)) {}
      for (;;)
      {
        i += 1;
        break;
        long l = paramArrayOfLong[paramInt] + ((Long)paramMap1.get(localDiscussionMemberInfo)).longValue() - ((baxc)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_Long;
        if (l == 0L)
        {
  ...
  private Object[] a(DiscussionMemberInfo paramDiscussionMemberInfo, String paramString)
  {
    ...
    long l1 = a(localanuz, paramDiscussionMemberInfo.inteRemark, basn.k, paramString);
    String str;
    ...
    for (;;)
    {
      long l3 = a(localanuz, paramDiscussionMemberInfo.memberName, basn.l, paramString);
      l1 = l2;
      if (l3 > l2)
      {
      ...
      Friends localFriends = this.jdField_a_of_type_Amsw.b(paramDiscussionMemberInfo.memberUin);
      ...
      if (localFriends != null)
      {
        ...
        {
          l3 = a(localanuz, localFriends.remark, basn.j, paramString);
          paramDiscussionMemberInfo = str;
          l2 = l1;
          if (l3 > l1)
          {
          ...
          l1 = a(localanuz, localFriends.name, basn.l, paramString);
          l3 = l2;
          if (l1 > l2)
          {
      ...
      while (i < paramString.length)
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          for (;;)
          {
            ...
            {
              baxc localbaxc = new baxc();
              localbaxc.jdField_a_of_type_Long = l;
              localbaxc.jdField_a_of_type_JavaLangString = ((String)arrayOfObject[1]);
              localbaxc.jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo = ((DiscussionMemberInfo)this.jdField_a_of_type_JavaUtilList.get(j));
              localArrayList2.add(localbaxc);
            }
          }
        }
  ...
  protected long a(String paramString)
  {
    ...
    {
      l1 = bbgk.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, basn.e);
    ...
    for (;;)
    {
      ...
      if (l2 > l1)
      {
        ...
        {
          i = 1;
          this.jdField_b_of_type_Long = basn.A;
          paramString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
          if (i != 0)
          {
            this.jdField_b_of_type_Long = basn.y;
            label389:
            if (this.jdField_a_of_type_Long != -9223372036854775808L)
            {
        ...
        for (i = 1;; i = 0)
        {
          if (i == 0)
          {
            i = 1;
            break;
            if (paramString.isUinInRecent(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin))
            {
              ...
              this.jdField_b_of_type_Long = basn.J;
              break label389;
            }
            this.jdField_b_of_type_Long = basn.L;
            break label389;
          }
          label564:
          i = 0;
  ...
  public void a(View paramView)
  {
    ...
    if (bbgk.a(this.jdField_b_of_type_Int))
    {
      ...
      akms.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, 3000, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, false);
      anap.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      bbgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a().toString(), this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, "", 3000);
      bbgk.a(this.jdField_a_of_type_JavaLangString, 20, 3, paramView);
      bbgk.a(this.jdField_a_of_type_JavaLangString, 30, paramView, false);
      bbgk.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      new bcek(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("search_result").d("clk_grp").a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin }).a();
      return;
      label299:
  ...
  public String c()
  {
    return ContactUtils.getDiscussionName(BaseApplicationImpl.sApplication, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo);
  }
