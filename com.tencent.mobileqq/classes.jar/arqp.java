  ...
  implements View.OnClickListener
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new arqq(this);
  ...
  public arqp(Context paramContext, ViewGroup paramViewGroup, QQAppInterface paramQQAppInterface, XEditTextEx paramXEditTextEx)
  {
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559629, this.jdField_a_of_type_AndroidViewViewGroup, false);
    ...
    ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364488)).addView(localView, paramString);
    return localView;
  }
  ...
  private void a(String paramString)
  {
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new arqs(this, paramString));
    }
  }
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Ntg == null) {
      this.jdField_a_of_type_Ntg = new ntg(this.jdField_a_of_type_AndroidViewViewGroup, new arqr(this));
    }
  }
