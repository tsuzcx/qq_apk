  ...
  implements behi
{
  ...
  private apzc jdField_a_of_type_Apzc;
  private azwg jdField_a_of_type_Azwg = new azwg(this.jdField_a_of_type_AndroidContentContext, aing.a());
  private baox jdField_a_of_type_Baox = new apzb(this);
  private String jdField_a_of_type_JavaLangString;
  private List<FeedsItemData.FriendInfo> jdField_a_of_type_JavaUtilList;
  
  protected apza(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  public apza(Context paramContext, String paramString, int paramInt)
  {
    this(paramContext);
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = paramString;
    f();
    aing.a().addObserver(this.jdField_a_of_type_Baox);
    ((baot)aing.a().getBusinessHandler(71)).a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
  ...
  private String a(long paramLong)
  {
    ...
    if (paramLong < 60L) {
      return paramLong / 60L + ajjy.a(2131644501);
    }
    if ((paramLong >= 60L) && (paramLong < 3600L)) {
      return paramLong / 60L + ajjy.a(2131644504);
    }
    if ((paramLong >= 3600L) && (paramLong < paramLong / 86400L)) {
      return paramLong / 3600L + ajjy.a(2131644502);
    }
    int i = (int)(paramLong / 86400L);
    if (i >= 30) {
      return i / 30 + ajjy.a(2131644507);
    }
    if (i >= 7) {
      return i / 7 + ajjy.a(2131644505);
    }
    return i + ajjy.a(2131644506);
  }
  
  private void f()
  {
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, aciy.a(500.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    ((ImageView)localObject2).setId(2131301302);
    Object localObject1 = new RelativeLayout.LayoutParams(-1, (int)(babp.k() / 750L * 36L));
    ...
    ((TextView)localObject2).setText(ajjy.a(2131644503));
    Object localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject3).addRule(9);
    ((RelativeLayout.LayoutParams)localObject3).setMargins(aciy.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0);
    ((TextView)localObject2).setTextSize(18.0F);
    ((TextView)localObject2).setTextColor(-16777216);
    ((RelativeLayout)localObject1).addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
    ((TextView)localObject2).setId(2131301304);
    localObject3 = new ListView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Apzc = new apzc(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaUtilList);
    ((ListView)localObject3).setAdapter(this.jdField_a_of_type_Apzc);
    ...
    ((ListView)localObject3).setSelector(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849314));
  ...
  {
    super.dismiss();
    aing.a().removeObserver(this.jdField_a_of_type_Baox);
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = (ajjj)aing.a().getManager(51);
