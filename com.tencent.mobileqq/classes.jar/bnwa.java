  ...
  extends MSFServlet
{
  public static void a(long paramLong, int paramInt1, String paramString, int paramInt2, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    try
    {
      ...
      paramDeviceInfo = new NewIntent(paramString.getApplication(), bnwa.class);
      paramDeviceInfo.putExtra("data", bhuf.a(localVacAdvReq.toByteArray()));
  ...
  public static void a(bnvc parambnvc, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    if (parambnvc == null) {
      return;
    }
    for (;;)
    {
      try
      {
        ...
        if (parambnvc.jdField_a_of_type_JavaLangString == null)
        {
          str = "";
          localPBStringField.set(str);
          localMobileAdvReportReq.adv_pos.set(parambnvc.jdField_a_of_type_Int);
          localMobileAdvReportReq.action_type.set(parambnvc.jdField_b_of_type_Int);
          localMobileAdvReportReq.action_value.set(parambnvc.d);
          localMobileAdvReportReq.feed_index.set(parambnvc.c);
          if (paramDeviceInfo != null) {
            localMobileAdvReportReq.device_info.set(paramDeviceInfo);
          }
          localMobileAdvReportReq.qq.set(parambnvc.jdField_a_of_type_Long);
          if (!TextUtils.isEmpty(parambnvc.jdField_b_of_type_JavaLangString))
          {
            paramDeviceInfo = new adv_report.SubscribeInfo();
            paramDeviceInfo.id.set(parambnvc.jdField_b_of_type_JavaLangString);
            localMobileAdvReportReq.subscribe_info.set(paramDeviceInfo);
          }
          paramDeviceInfo = new NewIntent(localAppRuntime.getApplication(), bnwa.class);
          paramDeviceInfo.putExtra("data", bhuf.a(localMobileAdvReportReq.toByteArray()));
          paramDeviceInfo.putExtra("cmd", "MobileAdv.AdvReport");
          if (QZLog.isColorLevel()) {
            QZLog.i("GdtGeneralServlet", " @getGdtInfo sendGdtADVReportReq " + parambnvc.toString());
          }
          localAppRuntime.startServlet(paramDeviceInfo);
          return;
        }
      }
      catch (Exception parambnvc)
      {
        QZLog.e("GdtGeneralServlet", "sendGdtADVReportReq error" + parambnvc.toString());
        return;
      }
      String str = parambnvc.jdField_a_of_type_JavaLangString;
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        {
          bnvx.a().a(i, paramFromServiceMsg);
          return;
        }
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        bhvd.a(new byte[i], 0, paramFromServiceMsg.getWupBuffer(), 4, i);
      }
      return;
    }
    catch (Exception paramIntent)
