...
public class uwk
{
  ...
  static ArrayList<uwu> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  static boolean jdField_a_of_type_Boolean;
  private static int b;
  private Activity jdField_a_of_type_AndroidAppActivity;
  protected bkij a;
  
  public uwk(Activity paramActivity, ArrayList<uwu> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_Bkij = new uwl(this);
  ...
  static int a()
  {
    ...
    int j = (jdField_a_of_type_Int - afur.a(110.0F, jdField_a_of_type_AndroidContentContext.getResources())) / 3;
    if (i % 2 == 0) {
      return i / 2 * j;
    }
    return (i + 1) / 2 * j;
  ...
  private ArrayList<uwu> a(ArrayList<uwu> paramArrayList)
  {
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    int i = afur.a(2.0F, jdField_a_of_type_AndroidContentContext.getResources());
    int j = (b - i) / 2;
    paramRelativeLayout = (GridView)paramRelativeLayout.findViewById(2131376193);
    ...
    paramRelativeLayout.setOnItemClickListener(this.jdField_a_of_type_Bkij);
    if (Build.VERSION.SDK_INT >= 9) {
      paramRelativeLayout.setOverScrollMode(2);
    }
    paramRelativeLayout.setAdapter(new uwm(this));
  }
  ...
  public View a(Activity paramActivity, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if ((localObject != null) && ((localObject instanceof uwo)))
      {
    ...
    paramActivity = (RelativeLayout)LayoutInflater.from(paramActivity).inflate(2131559591, paramViewGroup, false);
    paramView = paramActivity.getLayoutParams();
    paramView.height = jdField_a_of_type_Int;
    paramActivity.setLayoutParams(paramView);
    paramView = new uwo();
    paramView.jdField_a_of_type_ComTencentWidgetGridView = ((GridView)paramActivity.findViewById(2131376193));
    paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramActivity.findViewById(2131370541));
    paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramActivity.findViewById(2131376179));
    ...
    if ((jdField_a_of_type_JavaUtilArrayList == null) && (jdField_a_of_type_Boolean))
    {
      ...
      int i = afur.a(66.0F, jdField_a_of_type_AndroidContentContext.getResources());
