...
{
  bbhs(bbhp parambbhp, DialogInterface.OnClickListener paramOnClickListener) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener.onClick(this.jdField_a_of_type_Bbhp, 1);
