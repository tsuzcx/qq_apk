...
public final class bbhs
{
  ...
  public bbhs(@NonNull LinearLayout paramLinearLayout)
  {
    this.jdField_a_of_type_AndroidContentContext = paramLinearLayout.getContext();
    this.jdField_a_of_type_AndroidWidgetLinearLayout = paramLinearLayout;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = bcpx.a(this.jdField_a_of_type_AndroidContentContext.getResources(), Color.parseColor("#66ffffff"), this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843304));
    this.b = bcpx.a(this.jdField_a_of_type_AndroidContentContext.getResources(), Color.parseColor("#ffffffff"), this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843304));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout$LayoutParams.leftMargin = azkz.a(7.0F);
  }
