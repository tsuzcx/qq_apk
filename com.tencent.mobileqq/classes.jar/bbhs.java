  ...
  implements View.OnClickListener
{
  ...
  public bbhs(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.jdField_b_of_type_Float = 45.5F;
    this.jdField_c_of_type_Float = 39.0F;
    this.jdField_c_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bbhu(this);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bbhv(this, paramInt));
    }
  }
  ...
  void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.setDispatchKeyEventListener(new bbhw(this));
  }
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131368197)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout != null)
      {
        ...
        {
          a();
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846376);
          this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130846376));
      ...
      if ((paramView != null) && ((paramView instanceof Integer)) && (((Integer)paramView).intValue() == 2130846983))
      {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846983);
      this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130846983));
  ...
  public void setContentView(int paramInt)
  {
    ...
    ynw.a(localContext, this.jdField_a_of_type_AndroidWidgetEditText);
    a(localContext);
  }
  ...
  {
    TextView localTextView = (TextView)findViewById(2131365124);
  ...
  public bbgg setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bbhx(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bbgg setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bbhy(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
