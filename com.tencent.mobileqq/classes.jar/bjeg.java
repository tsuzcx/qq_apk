class bjeg
{
  private static bjeg jdField_a_of_type_Bjeg;
  private static bjeg jdField_b_of_type_Bjeg;
  ...
  public static bjeg a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Bjeg == null) {
        jdField_a_of_type_Bjeg = new bjeg(0);
      }
      return jdField_a_of_type_Bjeg;
    }
    if (jdField_b_of_type_Bjeg == null) {
      jdField_b_of_type_Bjeg = new bjeg(1);
    }
    return jdField_b_of_type_Bjeg;
  }
