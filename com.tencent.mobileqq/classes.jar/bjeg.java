...
public class bjeg
{
  ...
  {
    wab localwab = wab.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    localArrayList.add("-formats");
    localwab.a((String[])localArrayList.toArray(new String[0]), new bjei());
  }
  
  public static void a(String paramString1, String paramString2, bjeu parambjeu)
  {
    a();
    wab localwab = wab.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    ...
    localwab.a((String[])localArrayList.toArray(new String[0]), new bjeh(paramString2, parambjeu));
  }
  
  public static boolean a()
  {
    File localFile = new File(bjet.a);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    try
    {
      new bjee(BaseApplicationImpl.getContext()).a("svm_snr15_random_noise", localFile);
      return true;
    }
