...
public class bmdm
  extends QIPCModule
{
  public bmdm(QQPimGetTipsInfoIPC paramQQPimGetTipsInfoIPC, String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i(bmdk.a, 2, "QQPimGetTipsInfoIPC.onCall()" + paramString);
    }
    if (bmdk.g.equals(paramString)) {
      if (QQPimGetTipsInfoIPC.a() != -1) {}
    }
    while ((!bmdk.h.equals(paramString)) || (System.currentTimeMillis() - QQPimGetTipsInfoIPC.a(this.a) < 500L))
    {
      do
      {
        do
