...
public abstract class lgh<T1 extends MessageMicro, T2 extends MessageMicro>
{
  ...
  {
    Object localObject = lge.a(this);
    ((lgg)localObject).a("QAVMessageHandler", paramLong);
    if ((((lgg)localObject).a != null) && (((lgg)localObject).b != null)) {}
    try
    {
      MessageMicro localMessageMicro = (MessageMicro)((lgg)localObject).a.newInstance();
      localObject = (MessageMicro)((lgg)localObject).b.newInstance();
