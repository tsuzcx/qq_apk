  ...
  extends BusinessHandler
{
  ...
  private lgc jdField_a_of_type_Lgc = lgc.a();
  private lgg jdField_a_of_type_Lgg = lgg.a();
  private int b;
  
  public lgh(AppInterface paramAppInterface)
  {
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.jdField_a_of_type_Lgg.jdField_a_of_type_Long));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(mvk.a());
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Lgc;
    localObject1 = lgc.a(paramArrayOfByte);
    paramArrayOfByte = ((lgd)localObject1).a;
    localObject1 = ((lgd)localObject1).b;
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      localToServiceMsg.putWupBuffer(lgc.a(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
      if (NetworkUtil.isNetworkAvailable(this.mApp.getApplication().getApplicationContext())) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      paramObject = this.jdField_a_of_type_Lgc;
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          this.jdField_a_of_type_Lgg.jdField_a_of_type_Int = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.f())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_Lgg.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              lgc locallgc = this.jdField_a_of_type_Lgc;
              QLog.d("AudioTransClientInterfaceHandler", 2, lgc.a(paramObject.fixed32_IP.get()));
              ...
              locallgc = this.jdField_a_of_type_Lgc;
              QLog.d("AudioTransClientInterfaceHandler", 2, lgc.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
