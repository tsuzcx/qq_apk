  ...
  extends lgq
{
  ...
  private Frame a(List<lgv> paramList, Frame paramFrame)
  {
    ArrayList localArrayList1 = new ArrayList();
    int i = 0;
    while (i < paramList.size())
    {
      float[][] arrayOfFloat = ((TTFaceOriginDataModel)((lgv)paramList.get(i)).jdField_a_of_type_JavaUtilList.get(0)).facePoint;
  ...
  @NotNull
  protected Frame a(List<lgu> paramList, long paramLong)
  {
    Object localObject2 = (lgu)paramList.get(0);
    Object localObject1 = ((lgu)paramList.get(0)).jdField_a_of_type_ComTencentAekitOpenrenderInternalFrame;
    ...
    if (((lgu)localObject2).a())
    {
      int i = 0;
      while (i < ((lgu)localObject2).jdField_a_of_type_JavaUtilList.size())
      {
        localArrayList.addAll(((lgv)((lgu)localObject2).jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaUtilList);
        i += 1;
      }
    }
    ...
    if ((this.d) && (((lgu)localObject2).a()))
    {
      localObject2 = a(((lgu)localObject2).jdField_a_of_type_JavaUtilList, (Frame)localObject1);
      paramList = (List<lgu>)localObject2;
    ...
    for (paramList = (List<lgu>)localObject2;; paramList = (List<lgu>)localObject1)
    {
