  ...
  implements View.OnClickListener
{
  ...
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new amxr(this);
  ...
  public amxq(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, boolean paramBoolean, amxu paramamxu, int paramInt)
  {
    ...
    this.jdField_a_of_type_Amxu = paramamxu;
    if ((paramBoolean) && (this.jdField_a_of_type_Amxu != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Amxu.b))) {}
    ...
    this.jdField_b_of_type_Int = aciy.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.c = aciy.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = aciy.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = aciy.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        return null;
        paramViewGroup = (amxs)paramView.getTag();
        break;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = (amxs)paramView;; paramView = null)
    {
      if (paramView == null) {}
      do
      {
        ...
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FAB", "0X8007FAB", 0, 0, "", "", "", "");
