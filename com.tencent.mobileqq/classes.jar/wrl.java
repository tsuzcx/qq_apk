...
public class wrl
{
  ...
  public static int a(View paramView)
  {
    ...
    do
    {
      ...
      j = xsm.d(paramView.getContext()) / 2;
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    wxe.b("Q.qqstory.home.StoryListUtils", "getDistanceToCenterY=" + i);
    return i;
  }
  
  public static Bitmap a(Drawable paramDrawable, int paramInt1, int paramInt2, Map<String, Bitmap> paramMap, wqx paramwqx)
  {
    ...
    for (Bitmap localBitmap = (Bitmap)paramMap.get("w=" + paramInt1 + "h=" + paramInt2);; localBitmap = null)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            wrk.b("Q.qqstory.home.StoryListUtils", new Object[] { "drawable2Bitmap need create width=", Integer.valueOf(paramInt1), ",height=", Integer.valueOf(paramInt2) });
          ...
          wxe.a("Q.qqstory.home.StoryListUtils", "drawable2Bitmap:width=%d,height=%d,cost time=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis() - l));
          paramDrawable = (Drawable)localObject;
          if (paramwqx == null) {
            break;
          }
          return paramwqx.a((Bitmap)localObject);
        }
        catch (OutOfMemoryError paramDrawable)
        {
          label347:
          wxe.e("Q.qqstory.home.StoryListUtils", "drawable2Bitmap out off memory width=" + paramInt1 + ",height=" + paramInt2);
          return null;
        }
      }
  ...
  public static String a(int paramInt, boolean paramBoolean)
  {
    ...
    default: 
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = alud.a(2131714845);
      }
      break;
    }
    do
    {
      return localObject2;
      localObject1 = alud.a(2131714846);
      break;
      localObject1 = alud.a(2131714844);
      break;
      localObject1 = alud.a(2131714873);
      break;
      localObject1 = alud.a(2131714837);
      break;
      localObject1 = alud.a(2131714834);
      break;
      localObject1 = alud.a(2131714870);
      break;
      localObject1 = alud.a(2131714848);
      break;
      localObject1 = alud.a(2131714838);
      break;
      localObject1 = alud.a(2131714859);
      break;
      localObject1 = alud.a(2131714860);
      break;
      localObject1 = alud.a(2131714875);
      break;
      localObject1 = alud.a(2131714855);
      break;
      localObject1 = alud.a(2131714874);
      break;
      localObject1 = alud.a(2131714868);
      break;
      localObject1 = alud.a(2131714853);
      break;
      localObject1 = alud.a(2131714852);
      break;
      localObject1 = alud.a(2131714842);
      break;
      localObject1 = alud.a(2131714869);
      break;
      localObject1 = alud.a(2131714833);
      break;
      localObject1 = alud.a(2131714839);
      break;
      localObject1 = alud.a(2131714847);
      break;
      localObject1 = alud.a(2131714856);
      break;
      localObject1 = alud.a(2131714867);
      break;
      localObject1 = alud.a(2131714851);
      break;
      localObject1 = alud.a(2131714864);
      break;
      localObject1 = alud.a(2131714835);
      break;
      localObject2 = localObject1;
    } while (!paramBoolean);
    return alud.a(2131714857) + (String)localObject1;
  }
  ...
  {
    Object localObject = ((ulu)paramQQAppInterface.getManager(181)).a(false);
  ...
  public static void a(ArrayList<String> paramArrayList)
  {
    ...
    wxe.b("Q.qqstory.home.StoryListUtils", "reportShieldFriendStory:" + paramArrayList.size());
    wrv localwrv = new wrv();
    localwrv.a = paramArrayList;
    umc.a().dispatch(localwrv);
  }
  ...
  public static int b(View paramView)
  {
    ...
    wxe.b("Q.qqstory.home.StoryListUtils", "getDistanceToTop=" + i);
    return i;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (m == i3) {
      return String.format(Locale.getDefault(), alud.a(2131714854), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    localCalendar.setTimeInMillis(paramLong);
    localCalendar.add(6, 1);
    if (localCalendar.get(6) == i3) {
      return String.format(Locale.getDefault(), alud.a(2131714843), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    if (i != i2) {
  ...
  public static int c(View paramView)
  {
    ...
    do
    {
      ...
      paramView.getLocationOnScreen(arrayOfInt);
      i = paramView.getHeight();
      j = xsm.d(paramView.getContext());
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    wxe.b("Q.qqstory.home.StoryListUtils", "getDistanceToBottom=" + i);
    return i;
  }
}
