  ...
  extends apin
{
  ...
  public apir(Intent paramIntent)
  {
    super(paramIntent);
  ...
  private void G()
  {
    ...
    for (;;)
    {
      ...
      if ((m == 10000) || (m == 10001) || (m == 10002) || (m == 10004) || (m == 10003))
      {
        ...
        if (localObject1 != null) {
          apbf.a((FileManagerEntity)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, m, 12);
        }
      }
      else if (m == 10006)
      {
        ...
        {
          localObject2 = azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (FileManagerEntity)localObject2);
          ...
          apdq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, null, null, l1, (ayqd)localObject2, (String)localObject1, l2, -1, 12, null, false, false);
          return;
          if (bace.b(this.jdField_i_of_type_JavaLangString)) {
            try
            {
              localObject1 = apck.a(new FileInfo(this.jdField_i_of_type_JavaLangString));
              if (localObject1 != null)
              {
                apbf.a((FileManagerEntity)localObject1).a(this.jdField_a_of_type_AndroidAppActivity, 12);
                return;
              }
            }
  ...
  public static int a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    case 7: 
      ...
      {
        return 10000;
      } while (apdh.b(paramFileManagerEntity.getFilePath()));
      return 10009;
    case 1: 
      return 10002;
    case 2: 
  ...
  private Drawable a()
  {
    ...
    if (bace.b(str))
    {
      ...
      localURLDrawableOptions.mLoadingDrawable = axwd.b();
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      bacm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), paramString, str, 600, 800);
      return str;
    }
  ...
  protected View a()
  {
    ...
    int m = aciy.a(8.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int n = aciy.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i1 = aciy.a(15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i2 = aciy.a(16.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i3 = aciy.a(20.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i4 = aciy.a(32.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    int i5 = aciy.a(40.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidAppActivity);
    Object localObject1 = new RelativeLayout.LayoutParams(-2, -2);
    localRelativeLayout.setOnClickListener(new apit(this));
    localRelativeLayout.setOnTouchListener(new apiu(this));
    ...
    if (i6 == 2)
    {
      ...
      ((URLImageView)localObject1).setId(2131301031);
      ((URLImageView)localObject1).setAdjustViewBounds(true);
      ((URLImageView)localObject1).setMaxHeight(bajq.a(140.0F));
      ...
      ((View)localObject2).setId(2131301026);
      ((View)localObject2).setBackgroundColor(Color.argb(0, 0, 0, 0));
      localObject3 = new RelativeLayout.LayoutParams(-1, -1);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131301031);
      ((RelativeLayout.LayoutParams)localObject3).addRule(8, 2131301031);
      ((RelativeLayout.LayoutParams)localObject3).addRule(5, 2131301031);
      ((RelativeLayout.LayoutParams)localObject3).addRule(7, 2131301031);
    ...
    if (i6 == 3)
    {
      ...
      ((ImageView)localObject2).setId(2131301032);
      ...
      ((ImageView)localObject2).setImageResource(2130839565);
      return localRelativeLayout;
    }
    if (i6 == 1)
    {
      ...
      ((ImageView)localObject1).setId(2131301025);
      ...
      ((AsyncImageView)localObject3).setId(2131301027);
      localObject1 = new RelativeLayout.LayoutParams(i4, i4);
      ((RelativeLayout.LayoutParams)localObject1).addRule(15);
      ((RelativeLayout.LayoutParams)localObject1).addRule(0, 2131301025);
      ...
      ((LinearLayout)localObject1).setId(2131301030);
      ...
      ((RelativeLayout.LayoutParams)localObject4).addRule(0, 2131301027);
      ...
      ((TextView)localObject4).setId(2131301028);
      ...
      localTextView.setId(2131301029);
      ...
      localObject1 = new LinearLayout(this.jdField_a_of_type_AndroidAppActivity);
      ((LinearLayout)localObject1).setId(2131301026);
      ((LinearLayout)localObject1).setOrientation(1);
      ((LinearLayout)localObject1).setBackgroundColor(Color.argb(0, 0, 0, 0));
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
      localLayoutParams.addRule(6, 2131301030);
      localLayoutParams.addRule(8, 2131301030);
      ...
      {
        apck.a((AsyncImageView)localObject3, (String)localObject1);
        ((TextView)localObject4).setText((CharSequence)localObject1);
        localTextView.setText(apdh.a(l1, this.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics().densityDpi));
        return localRelativeLayout;
    ...
    ((AnimationTextView)localObject1).setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131100028));
    ((AnimationTextView)localObject1).setTextSize(14.0F);
    localObject2 = new RelativeLayout.LayoutParams(-1, -2);
    ((RelativeLayout.LayoutParams)localObject2).bottomMargin = awmc.a(10.0F);
    localRelativeLayout.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 1006) || (a(aphf.h))) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 7000)) {
        if (this.jdField_j_of_type_Boolean)
        {
          if (((localRecentUser.getType() == 1) && (!a(localRecentUser.uin))) || ((localRecentUser.getType() == 0) && (!mqb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 3000) || (-1L != apck.a(localRecentUser.getType()))) {
            localArrayList.add(localRecentUser);
          }
        }
        else if (this.l)
        {
          if (((localRecentUser.getType() == 0) && (!mqb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 1) || (localRecentUser.getType() == 3000) || (localRecentUser.getType() == 1006) || (localRecentUser.getType() == 1004) || (localRecentUser.getType() == 1000)) {
            localArrayList.add(localRecentUser);
          }
        }
        ...
        else if ((localRecentUser != null) && (!azzz.a(localRecentUser.uin)) && (((localRecentUser.getType() == 0) && (!mqb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) || (localRecentUser.getType() == 3000) || ((localRecentUser.getType() == 1) && (a(c)) && (!a(localRecentUser.uin))) || (-1L != apck.a(localRecentUser.getType())))) {
          localArrayList.add(localRecentUser);
        }
      }
    }
  ...
  protected void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo != null) {
      if (ajgm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo.b())))
      {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if ((localForwardFileInfo == null) || (!ajgm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localForwardFileInfo.b())))) {
          break;
        }
        this.jdField_a_of_type_JavaUtilSet.add(jdField_f_of_type_JavaLangInteger);
        this.jdField_a_of_type_JavaUtilSet.add(jdField_k_of_type_JavaLangInteger);
  ...
  {
    if ((this.jdField_j_of_type_Boolean) && (!this.jdField_i_of_type_Boolean) && (-1L != apck.a(paramBundle.getInt("uintype"))))
    {
      babr.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getString(2131632181), this.jdField_a_of_type_AndroidAppActivity.getString(2131632140), null, this.jdField_a_of_type_AndroidAppActivity.getString(2131654515), new apis(this), null).show();
      return;
    }
  ...
  public DeviceInfo[] a(DeviceInfo[] paramArrayOfDeviceInfo)
  {
    ...
    if (m < n)
    {
      ...
      {
        int i1 = apck.a(f());
        localProductInfo = localxrh.a(localDeviceInfo.productId);
        if ((i1 != 2) || (!localxrh.c(localDeviceInfo.din)) || (!localxrh.a(localDeviceInfo.din, 17))) {
          break label105;
        }
      }
      for (;;)
  ...
  protected boolean c()
  {
    ...
    if (f())
    {
      ...
      if (bool)
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajjy.a(2131638964));
        ...
        if (this.jdField_f_of_type_Boolean)
        {
          ...
          if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_i_of_type_Boolean))
          {
            ...
            while (((Iterator)localObject).hasNext())
            {
              ...
              bbsv.a().a(4, f(), localResultRecord.a(), localResultRecord.a);
              bbsv.a().a();
            }
          }
        }
    ...
    if (m == 1008)
    {
      ...
      this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajjy.a(2131638963));
      localIntent.addFlags(268435456);
      localIntent.addFlags(67108864);
      localIntent.putExtras(this.jdField_a_of_type_AndroidOsBundle);
      bool = a(localIntent);
      ...
      if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_i_of_type_Boolean))
      {
        bbsv.a().a(4, f(), m, (String)localObject);
        bbsv.a().a();
      }
    }
    for (;;)
  ...
  protected int d()
  {
    ...
    {
      if (!new bfhl(3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, jdField_a_of_type_ComTencentMobileqqDataChatMessage, true)) {
        break label131;
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataForwardFileInfo != null)
      {
        ...
        if ((localFileManagerEntity != null) && (new bfhl(3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localFileManagerEntity, null, true)))
        {
          jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = null;
          m = 0;
          continue;
  ...
  protected void y()
  {
    ...
    for (;;)
    {
      ...
      localxvq.a().a((String)localObject, str2, localArrayList, null);
      this.jdField_a_of_type_AndroidAppActivity.finish();
      return;
      label92:
      localObject = (xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
      if ((localObject != null) && (((xrh)localObject).a(Long.parseLong(this.jdField_a_of_type_AndroidOsBundle.getString("uin")), 17)))
      {
        ((xrh)localObject).a(Long.parseLong(str2), "", "", "", 0, null);
        if (m == 0)
        {
