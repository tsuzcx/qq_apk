...
public class apir
{
  ...
  public static bamp a(appoint_define.RichText paramRichText)
  {
    return a(paramRichText, 16);
  }
  
  public static bamp a(appoint_define.RichText paramRichText, int paramInt)
  {
    return a(ashz.a(paramRichText), paramInt);
  }
  
  public static bamp a(String paramString, int paramInt)
  {
    return new bamp(paramString, 5, paramInt);
  }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          if (((JSONObject)localObject5).has("audio_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + alud.a(2131707333);
            }
          ...
          if (((JSONObject)localObject5).has("video_list"))
          {
            ...
            {
              localObject4 = localObject3;
              localObject1 = (String)localObject3 + alud.a(2131707334);
            }
          }
          else
          {
            ...
            if (((JSONObject)localObject5).has("pic_list"))
            {
              ...
              {
                localObject4 = localObject3;
                localObject1 = (String)localObject3 + alud.a(2131707332);
              }
            }
            else
            {
      ...
      if (i < ((JSONArray)localObject5).length())
      {
        ...
        {
          localObject4 = localObject3;
          localObject1 = (String)localObject3 + alud.a(2131707330);
          break label450;
        }
        localObject4 = localObject3;
        localObject1 = localObject3;
        ...
        localObject4 = localObject3;
        localObject1 = (String)localObject3 + alud.a(2131707331);
        break label450;
  ...
  {
    return (paramInt == -2053) && (!paramString.equals(String.valueOf(1822701914L + alof.l))) && (!paramString.equals("1822701914"));
  }
  ...
  public static boolean a(QQMessageFacade.Message paramMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramMessage.msgtype == -2011) {
      localMessageRecord = paramQQAppInterface.a(1001).a(alof.I, 1001, paramMessage.uniseq);
    }
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        str1 = paramString;
        str2 = paramString;
        if (paramString.indexOf('\024' + bamd.a[i]) == -1) {
          break label268;
        }
        str1 = paramString;
        str2 = paramString.replace('\024' + bamd.a[i], "\024" + (char)i);
      }
      ...
      if (i < bamd.a.length)
      {
        ...
        {
          str1 = paramString;
          str2 = paramString.replace(bamd.a[i], "\024" + (char)i);
        }
        i += 1;
        paramString = str2;
      }
