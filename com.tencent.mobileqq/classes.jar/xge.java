...
public class xge
{
  ...
  {
    return ImageLoader.getInstance().loadImage(paramString, new xgf(this, paramView));
  }
  ...
  private AnimationSet a()
  {
    ...
    localScaleAnimation.setAnimationListener(new xgg(this));
  ...
  private AnimationSet b()
  {
    ...
    localScaleAnimation.setAnimationListener(new xgh(this));
    localAnimationSet.addAnimation(localScaleAnimation);
    return localAnimationSet;
  }
  ...
  private AnimationSet c()
  {
    if (this.b != null)
    {
      ...
      localScaleAnimation.setAnimationListener(new xgi(this));
      localAnimationSet.addAnimation(localScaleAnimation);
  ...
  public void a(FrameLayout paramFrameLayout, View paramView, String paramString)
  {
    ...
    paramFrameLayout = xgm.a().a(paramString);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131363844));
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379433));
