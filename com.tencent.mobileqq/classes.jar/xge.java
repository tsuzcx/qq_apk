...
class xge
  implements Runnable
{
  xge(xgd paramxgd, int paramInt, List paramList) {}
  
  public void run()
  {
    int k = 0;
    EntityManager localEntityManager = BannerManager.a(this.jdField_a_of_type_Xgd.a).app.getEntityManagerFactory().createEntityManager();
