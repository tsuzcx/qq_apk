...
{
  public nnr(TextureVideoView paramTextureVideoView) {}
  ...
  public boolean a(IMediaPlayer paramIMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    {
      new AlertDialog.Builder(this.a.getContext()).setMessage(paramInt1).setPositiveButton(17039376, new nns(this)).setCancelable(false).show();
      return true;
    }
  }
}
