...
public class avfi
  implements Handler.Callback, View.OnClickListener, beqs
{
  public static Boolean a;
  public static WeakReference<avfi> a;
  ...
  public avfi(String paramString, View paramView, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.e = paramInt;
    paramString = (BounceScrollView)paramView.findViewById(2131363439);
    if (paramString != null) {
      paramString.setScrollListener(new beqr(this, paramString.getContext()));
    }
    int i = avjc.jdField_a_of_type_ArrayOfInt.length;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ArrayOfAndroidViewView = new View[i];
    paramInt = 0;
    while (paramInt < i)
    {
      this.jdField_a_of_type_ArrayOfAndroidViewView[paramInt] = paramView.findViewById(avjc.jdField_a_of_type_ArrayOfInt[paramInt]);
      paramInt += 1;
    }
  ...
  {
    if (ausq.a()) {
      ausq.a("InterestGuide", "MSG_CHECK_INTEREST", new Object[] { Integer.valueOf(paramMessage.what), Integer.valueOf(this.d), Integer.valueOf(this.e), Integer.valueOf(this.jdField_a_of_type_AndroidViewView.getMeasuredHeight()) });
    }
    ...
    if ((paramMessage.what == 0) && (this.d == 0) && (this.e != 1) && (this.jdField_a_of_type_AndroidViewView.getMeasuredHeight() > 0))
    {
      ...
      k = 0;
      localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131375932);
      if (localObject != null)
      {
        ((View)localObject).getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
        paramMessage = ((View)localObject).findViewById(2131377976);
        localObject = ((View)localObject).findViewById(2131369223);
      ...
      tmp273_268[1] = 2131371053;
      Message tmp278_273 = tmp273_268;
      tmp278_273[2] = 2131367753;
      tmp278_273;
      i = this.c;
      m = 0;
      if (m < paramMessage.length)
      {
        ...
        if ((localObject != null) && (((View)localObject).getVisibility() == 0))
        {
          ...
          if (ausq.a())
          {
            ausq.a("InterestGuide", "checkShowGuide_bottom", new Object[] { Integer.valueOf(m), Integer.valueOf(this.jdField_a_of_type_ArrayOfInt[0]), Integer.valueOf(this.jdField_a_of_type_ArrayOfInt[1]), Integer.valueOf(((View)localObject).getMeasuredHeight()) });
            n = j;
          }
        }
        for (;;)
        {
          ...
          if (ausq.a())
          {
            ausq.a("InterestGuide", "checkShowGuide_bottom", new Object[] { Integer.valueOf(m), localObject });
            n = i;
          }
        }
      }
      ...
      if (ausq.a()) {
        ausq.a("InterestGuide", "checkShowGuide", new Object[] { Integer.valueOf(this.b), Integer.valueOf(this.c), Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(k), Integer.valueOf(i) });
      }
      localObject = null;
      i = 0;
      ...
      if (paramMessage != null)
      {
        ...
        if (m > 0)
        {
          ...
          paramMessage = LayoutInflater.from(localContext).inflate(2131561040, null);
          ((Button)paramMessage.findViewById(2131363469)).setOnClickListener(this);
        }
      }
    }
    for (;;)
    {
      ...
      if (ausq.a()) {
        ausq.a("InterestGuide", "checkShowGuide", new Object[] { Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m) });
      }
      ...
      return true;
      label1003:
      paramMessage = LayoutInflater.from(localContext).inflate(2131561041, null);
      ((Button)paramMessage.findViewById(2131363469)).setOnClickListener(this);
      break;
      label1032:
      paramMessage = new View(localContext);
