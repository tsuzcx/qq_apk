...
public class aihx
{
  ...
  public static ArrayList<aihw> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bhgg.a(anhk.bG) + File.separator;
  ...
  public static aihw a(int paramInt)
  {
    if (jdField_a_of_type_JavaUtilArrayList.size() > paramInt) {
      return (aihw)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    }
    return null;
  }
  ...
  public static Drawable a(int paramInt)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841465);
    ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841465);
  ...
  public static String a(int paramInt)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = anni.a(2131706681);
    }
    return str1;
  }
  
  public static List<aihw> a(String paramString)
  {
        ...
        for (;;)
        {
          if (i < j) {
            try
            {
              ...
              localaihw.jdField_a_of_type_Int = k;
              localaihw.jdField_a_of_type_JavaLangString = b(k);
              jdField_a_of_type_JavaUtilArrayList.add(localaihw);
              i += 1;
            }
  ...
  public static aihw b(int paramInt)
  {
    Object localObject;
    aihw localaihw;
    if (jdField_a_of_type_JavaUtilArrayList.size() != 0)
    {
      ...
      do
      {
        ...
        localaihw = (aihw)((Iterator)localObject).next();
      } while (localaihw.jdField_a_of_type_Int != paramInt);
    }
    for (;;)
    {
      localObject = localaihw;
      if (localaihw == null)
      {
        localObject = new aihw();
        ((aihw)localObject).jdField_a_of_type_Int = paramInt;
        ((aihw)localObject).jdField_a_of_type_JavaLangString = b(paramInt);
      }
      return localObject;
      localaihw = null;
    }
