  ...
  implements View.OnClickListener
{
  ...
  public amjr(SigCommentListActivity paramSigCommentListActivity, QQAppInterface paramQQAppInterface, XListView paramXListView, View paramView)
  {
  ...
  {
    if (this.b != null) {
      ((amjs)this.b.getTag()).jdField_a_of_type_AndroidWidgetTextView.setText(paramInt);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (1 == i)
      {
        ...
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562888, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          localObject1 = new amjt();
          ((amjt)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377748));
          ((amjt)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377749));
          ((amjt)localObject1).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377746));
          ((amjt)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377747));
          ((amjt)localObject1).c = ((TextView)paramView.findViewById(2131377750));
          ...
          if (localFaceDrawable != null) {
            ((amjt)localObject1).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(localFaceDrawable);
          }
          ...
          ((amjt)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          ((amjt)localObject1).jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130850045);
        ...
        label375:
        for (Object localObject2 = anvx.a(2131713556) + (String)localObject2;; localObject2 = anvx.a(2131713553) + (String)localObject2)
        {
          ((amjt)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          a(localSigCommentInfo.feedsid, ((amjt)localObject1).c);
          break;
          localObject1 = (amjt)paramView.getTag();
          break label171;
        }
      }
      if (2 == i)
      {
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562072, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          paramView.setOnClickListener(this);
          localObject1 = new amjs();
          paramView.setTag(localObject1);
          paramView.findViewById(2131370440).setVisibility(8);
          ((amjs)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371586));
          this.b = paramView;
        }
        for (;;)
        {
          paramView = this.b;
          break;
          paramView = (amjs)paramView.getTag();
        }
      }
    }
  }
