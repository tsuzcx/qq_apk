...
public class bhmq
{
  ...
  public void a()
  {
    ...
    label91:
    for (DisplayMetrics localDisplayMetrics = this.jdField_a_of_type_Bhql.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics();; localDisplayMetrics = BaseApplicationImpl.getContext().getResources().getDisplayMetrics())
    {
      this.jdField_a_of_type_Int = localDisplayMetrics.widthPixels;
      this.jdField_b_of_type_Int = localDisplayMetrics.heightPixels;
      if ((this.jdField_a_of_type_Bhqo == null) || (!this.jdField_a_of_type_Bhqo.d) || (!this.jdField_a_of_type_Bhqo.H)) {
        break;
      }
      c();
      return;
  ...
  {
    if (bkqv.a(paramActivity))
    {
      paramActivity = paramActivity.findViewById(16908290);
      paramActivity.addOnLayoutChangeListener(new bhmu(this, paramActivity));
    }
  }
  
  public void a(View paramView)
  {
    int j = paramView.getResources().getColor(2131167167);
    if (this.jdField_a_of_type_Bhqo.jdField_c_of_type_Boolean) {
      j = paramView.getResources().getColor(2131167168);
    }
    for (;;)
    {
      ...
      label320:
      label326:
      for (int k = 2130842589;; k = 2130842588)
      {
          ...
          for (k = 2130842580;; k = 2130842579)
          {
            ...
            for (k = 2130842577;; k = 2130842576)
            {
              ...
              for (;;)
              {
                ...
                return;
                if (this.jdField_a_of_type_Bhqo.H) {
                  j = 2130842584;
                }
              }
            }
  ...
  public void a(View paramView, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_Bhql.jdField_a_of_type_AndroidAppActivity != null)
    {
      localDisplayMetrics = this.jdField_a_of_type_Bhql.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics();
      if (!this.jdField_a_of_type_Bhqo.d) {
        break label557;
      }
      ...
      this.c = paramView.findViewById(2131378724);
      ...
      this.i = paramView.findViewById(2131370529);
      this.jdField_a_of_type_ComTencentBizWebviewpluginHole = ((Hole)paramView.findViewById(2131367995));
      b();
      if (this.jdField_a_of_type_Bhqo.jdField_c_of_type_Boolean) {
        a(paramView);
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_c_of_type_Long & 1L) != 0L)
      {
        this.f.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_c_of_type_Long & 0x4) != 0L)
      {
        this.d.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((this.jdField_a_of_type_Bhqo.jdField_c_of_type_Long & 0x2) != 0L)
      {
        this.h.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((((this.jdField_a_of_type_Bhqo.b & 0x800) != 0L) || ((this.jdField_a_of_type_Bhqo.a & 0x80000000) != 0L)) && (this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (nhe.a().j(this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUrl)))
      {
      ...
      paramView.getViewTreeObserver().addOnGlobalLayoutListener(new bhmr(this, paramView, localDisplayMetrics));
    }
    for (;;)
    {
      paramView = new bhms(this, localDisplayMetrics);
  ...
  public void a(View paramView, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bhqo.jdField_c_of_type_Boolean)
    {
      paramView.setBackgroundResource(2130842582);
      return;
    }
    if (this.jdField_a_of_type_Bhqo.H)
    {
    ...
    if (paramBoolean)
    {
      paramView.setBackgroundResource(2130842572);
      return;
    }
    paramView.setBackgroundResource(2130842573);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bhqo != null) && (this.jdField_a_of_type_Bhqo.d) && (this.jdField_a_of_type_Bhqo.H) && (this.jdField_a_of_type_AndroidViewView != null) && (8 == this.c.getVisibility())) {
      c();
    }
  }
