...
public class vjx
  extends QIPCModule
{
  private static vjx a;
  public long a;
  public SparseArray<ayoq> a;
  public String a;
  public vjz a;
  public String b;
  ...
  public static String a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        JSONObject localJSONObject = ((vjs)((Iterator)localObject2).next()).a();
  ...
  public static vjx a()
  {
    if (jdField_a_of_type_Vjx == null) {}
    try
    {
      if (jdField_a_of_type_Vjx == null) {
        jdField_a_of_type_Vjx = new vjx();
      }
      return jdField_a_of_type_Vjx;
    }
    finally {}
  }
  ...
  public ayoq a()
  {
    ...
    localaywc.jdField_a_of_type_Int = 0;
    localaywc.c = "";
    localaywc.jdField_a_of_type_Boolean = true;
    localaywc.e = false;
    return new ayoq(((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(), localaywc, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a()
  {
    ...
    {
      ((ayoq)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i)).a();
      i += 1;
    }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ("action_get_art_filter_path".equals(paramString))
      {
        ...
        if ((this.b != null) && (this.b.equals(str)))
        {
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            {
              if (this.jdField_a_of_type_Vjz == null) {
                this.jdField_a_of_type_Vjz = vjz.a(str, l1);
              }
              paramBundle = a();
              paramBundle.a("current_TaskCount", String.valueOf(this.jdField_a_of_type_AndroidUtilSparseArray.size()));
              paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Vjz, bool1);
        ...
        else
        {
          ...
          paramBundle = a();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramBundle);
          paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Vjz, true);
        }
      }
      else if ("action_cancel_art_filter_task".equals(paramString))
      {
        ...
        {
          ((ayoq)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt)).a();
      ...
      else if ("action_exit_art_filter".equals(paramString))
      {
        a(true);
        a();
        this.jdField_a_of_type_Vjz = null;
      }
    }
  }
}
