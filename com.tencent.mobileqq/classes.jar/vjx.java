...
{
  static final String jdField_a_of_type_JavaLangString = skt.a("StoryGroupSvc.do_group_video_forward");
  public int a;
  ajmm jdField_a_of_type_Ajmm = new vjz(this);
  public Handler a;
  public QQAppInterface a;
  public MessageForTroopStory a;
  mml jdField_a_of_type_Mml = new vjy(this);
  protected boolean a;
  public int b;
  public String b;
  public int c;
  ...
  private vjx(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
  ...
  private vjx(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
  ...
  public static vjx a(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
    try
    {
      paramQQAppInterface = new vjx(paramQQAppInterface, paramBundle, paramSessionInfo);
  ...
  public static vjx a(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
    return new vjx(paramQQAppInterface, paramMessageForTroopStory);
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        mmj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Mml, localReqGroupVideoForward.toByteArray(), jdField_a_of_type_JavaLangString);
        return;
      }
  ...
  public void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopStory, this.jdField_a_of_type_Ajmm);
  }
