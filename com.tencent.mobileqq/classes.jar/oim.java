  ...
  extends pgp
{
  ...
  private oidb_cmd0xe16.ReqBody a(RIJBiuAndCommentRequestData paramRIJBiuAndCommentRequestData, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      label235:
      paramArticleInfo = omz.a(paramArticleInfo);
  ...
  {
    szp.a(pvb.a(paramFromServiceMsg, paramObject, new oidb_cmd0xe16.RspBody()), paramToServiceMsg, 2, null);
  }
  ...
  public void a(ArticleInfo paramArticleInfo, RIJBiuAndCommentRequestData paramRIJBiuAndCommentRequestData)
  {
    ...
    do
    {
      ...
      localToServiceMsg = pvb.a("OidbSvc.0xe16", 3606, 1, a(paramRIJBiuAndCommentRequestData, paramArticleInfo).toByteArray());
