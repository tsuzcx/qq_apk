...
public class axas
{
  ...
  {
    return aqou.a().jdField_a_of_type_JavaLangString;
  }
  
  public static String a(int paramInt1, int paramInt2)
  {
    String str = "";
    aqot localaqot = aqou.a();
    switch (paramInt1)
    {
    default: 
      str = localaqot.c;
  ...
  {
    Uri.Builder localBuilder = Uri.parse(aqou.a().jdField_b_of_type_JavaLangString).buildUpon();
  ...
  public static List<String> a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    String str3 = awzn.a(paramQQAppInterface, paramString1, paramInt, 0L);
    String str1 = awzn.a(paramQQAppInterface, paramString1, paramInt, 1L);
    String str2 = awzn.a(paramQQAppInterface, paramString1, paramInt, 2L);
  ...
  public static List<String> a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, anmw paramanmw, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    String str3 = awzn.a(paramQQAppInterface, paramInt, 0L);
    String str2 = awzn.a(paramQQAppInterface, paramInt, 1L);
    String str1 = awzn.a(paramQQAppInterface, paramInt, 2L);
    paramInt = paramanmw.n;
    int i = paramanmw.o;
    int j = paramanmw.p;
    paramQQAppInterface = paramString1;
    ...
    localArrayList.add(0, paramString1.replace(anni.a(2131703660), paramString2));
    return localArrayList;
  }
  
  private static void a(QQAppInterface paramQQAppInterface, anmw paramanmw, String paramString1, String paramString2, int paramInt1, int paramInt2, aofx paramaofx, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
      QLog.i("FriendIntimateRelationshipHelper", 2, "insertGrayTips uin:" + paramString1 + " grayTips:" + paramString2 + " intimateType:" + paramInt1);
    }
    if ((TextUtils.isEmpty(paramString2)) || (awzy.a(paramQQAppInterface))) {
      return;
    }
    Object localObject2 = bglf.m(paramQQAppInterface, paramString1);
    ...
    if (paramInt3 == 2097154)
    {
      ...
      if (paramInt4 == 0)
      {
        localObject3 = aqxo.c();
        localObject1 = paramString2;
        if (((aqxn)localObject3).jdField_a_of_type_Boolean) {
          localObject1 = paramString2 + ((aqxn)localObject3).jdField_a_of_type_JavaLangString;
        }
      }
    }
    localObject2 = a(paramQQAppInterface, (String)localObject1, (String)localObject2, paramanmw, paramInt1);
    Object localObject3 = a(paramQQAppInterface, paramString1, (String)((List)localObject2).get(0), paramInt1);
    paramanmw = (String)((List)localObject3).get(0);
    ((List)localObject3).remove(0);
    ((List)localObject2).remove(0);
    paramString2 = new auxc(paramString1, paramString1, paramanmw, 0, -5040, paramInt3, bbyp.a());
    ...
    ((MessageForUniteGrayTip)localObject1).tipParam.d = (paramString1 + "_intimate_" + String.valueOf(paramaofx.jdField_b_of_type_Long) + "_" + String.valueOf(paramaofx.jdField_b_of_type_Int));
    int i;
    Object localObject4;
    int j;
    if (((List)localObject3).size() > 0)
    {
      ...
      {
        paramaofx = new Bundle();
        localObject4 = (String)((List)localObject3).get(i);
        if (!TextUtils.isEmpty((CharSequence)localObject4))
        {
          paramaofx.putString("image_resource", (String)localObject4);
          j = 0;
          do
          {
            k = paramanmw.indexOf((String)localObject4, j);
            j = ((String)localObject4).length() + k;
            if (k >= 0)
            {
              paramString2.a(k, j, paramaofx);
              if (QLog.isColorLevel()) {
    ...
    {
      Collections.sort((List)localObject2, new axau());
      paramaofx = new ArrayList();
      i = 0;
      m = 0;
      if (m < ((List)localObject2).size())
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          ...
          j = 0;
          i2 = paramanmw.indexOf(str1, j);
          i3 = str1.length();
          i1 = i2 + i3;
          localObject5 = paramaofx.iterator();
          do
          {
          ...
          if (i2 >= 0)
          {
            ...
            if (i2 < j)
            {
              ...
              if (i1 >= 0)
              {
                n = k;
                if (i1 < j) {
                  if (paramanmw.indexOf(str1, i1) >= 0)
                  {
                    j = 1;
                    ...
                    localObject5 = paramanmw.substring(0, i2);
                    localObject6 = paramanmw.substring(i1);
        ...
        if (((String)localObject5).endsWith(str2))
        {
          ...
          for (;;)
          {
            if (i2 < 0)
            {
              ...
              i = j;
              break;
              paramaofx.add(new Pair(Integer.valueOf(i2), Integer.valueOf(i2 + i3)));
              j = i;
              if (i2 >= 0)
              {
                i += 1;
              ...
              {
                paramaofx = aqxo.c();
                if (paramaofx.jdField_a_of_type_Boolean)
                {
              ...
              for (;;)
              {
                ((Bundle)localObject2).putString("key_action_DATA", String.format(paramaofx.jdField_b_of_type_JavaLangString, new Object[] { paramString1, Integer.valueOf(paramInt1) }));
                paramInt2 = paramanmw.length() - paramaofx.jdField_a_of_type_JavaLangString.length();
                if (paramInt2 >= 0)
                {
                  paramString2.a(paramInt2, paramanmw.length(), (Bundle)localObject2);
                  bcst.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009CA5", paramInt1, 0, "", "", "", "");
                }
                auxd.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject1);
                return;
                if (paramInt2 == 0)
                {
                  paramInt1 = 25;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FriendIntimateRelationshipHelper", 1, "decodeC2CMsgPkgSubMsgType0xc7 app:" + paramQQAppInterface + "  changeInfo:" + paramRelationalChainChange + "  msginfo:" + paramaofx);
    }
    ...
    do
    {
      ...
      {
        return;
        l1 = paramaofx.jdField_b_of_type_Long;
        l2 = paramaofx.c;
        localafyd = afyd.a(paramRelationalChainChange, paramaofx.jdField_a_of_type_Boolean);
      ...
      paramRelationalChainChange = localanmw.e(localafyd.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 msginfo:" + paramaofx + "changePushInfo:" + localafyd);
      }
    ...
    if (localExtensionInfo == null)
    {
      ...
      localExtensionInfo.uin = localafyd.jdField_b_of_type_JavaLangString;
    }
    for (;;)
    {
      Object localObject4 = (auov)paramQQAppInterface.a(153);
      ...
      case 1: 
        do
        {
          ...
          QLog.i("FriendIntimateRelationshipHelper", 1, "decodeC2CMsgPkgSubMsgType0xc7 changeType:" + localafyd.jdField_a_of_type_Int + " grayTips:" + paramRelationalChainChange + " uin:" + localExtensionInfo.uin + " isOpen:" + a(localafyd.jdField_a_of_type_JavaLangString) + " intimate_type:" + localExtensionInfo.intimate_type + " intimate_level:" + localExtensionInfo.intimate_level + " intimate_chatDays:" + localExtensionInfo.intimate_chatDays + " isExtinguish:" + localExtensionInfo.isExtinguish + " last_intimate_chatTime:" + localExtensionInfo.last_intimate_chatTime);
          return;
          paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
        } while (localafyd.jdField_b_of_type_Afyg == null);
        if ((localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 1) || (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 2) || (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 3))
        {
          localExtensionInfo.intimate_type = localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int;
          localExtensionInfo.intimate_chatDays = 0;
          localExtensionInfo.intimate_level = localafyd.jdField_b_of_type_Afyg.a();
          localExtensionInfo.isExtinguish = false;
          if ((localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi != null) && (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi.c > 0L)) {
            localExtensionInfo.last_intimate_chatTime = localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi.c;
          }
          localObject1 = axav.a(paramQQAppInterface.getApp(), 162);
          localanmw.a(localExtensionInfo);
          if (a(localafyd.jdField_a_of_type_JavaLangString))
          {
            i = awzs.a(localafyd);
            a(paramQQAppInterface, localanmw, localafyd.jdField_b_of_type_JavaLangString, (String)localObject1, localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int, localafyd.jdField_b_of_type_Afyg.a(), paramaofx, 2097153, i);
            ((auov)localObject4).notifyUI(2, true, new Object[] { localafyd.jdField_b_of_type_JavaLangString });
          }
          paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
          if (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 1)
          {
            paramQQAppInterface = (anpi)paramQQAppInterface.a(172);
            paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
            if (paramQQAppInterface != null) {
      ...
      for (paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;; paramRelationalChainChange = null)
      {
        if (QLog.isColorLevel())
        {
          QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Add friendUin:" + localafyd.jdField_b_of_type_JavaLangString + " changePushInfo.now:" + localafyd.jdField_b_of_type_Afyg);
          break label327;
          int k = 0;
          int j = 0;
          if (localafyd.jdField_a_of_type_Afyg != null)
          {
            k = localafyd.jdField_a_of_type_Afyg.jdField_a_of_type_Int;
            j = localafyd.jdField_a_of_type_Afyg.a();
          }
          int m = j;
          i = k;
          if (k == 0)
          {
            m = j;
            i = k;
            if (localafyd.jdField_b_of_type_Afyg != null)
            {
              i = localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int;
              m = localafyd.jdField_b_of_type_Afyg.a();
            }
          }
          if (i == 0)
          {
          ...
          for (;;)
          {
            if ((j == 1) || (j == 2) || (j == 3))
            {
              ...
              if (k == 1)
              {
                i = 164;
                label939:
                localObject1 = axav.a(paramQQAppInterface.getApp(), i);
                localanmw.a(localExtensionInfo);
                if (a(localafyd.jdField_a_of_type_JavaLangString))
                {
                  a(paramQQAppInterface, localanmw, localafyd.jdField_b_of_type_JavaLangString, (String)localObject1, j, 0, paramaofx, 2097154, 1);
                  ((auov)localObject4).notifyUI(1, true, new Object[] { localafyd.jdField_b_of_type_JavaLangString, Boolean.valueOf(true) });
                  ((auox)paramQQAppInterface.getManager(323)).a(localafyd.jdField_b_of_type_JavaLangString);
                }
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                if (j == 1)
                {
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Del intimate_type:" + j + " intimate_level:" + k + " friendUin:" + localafyd.jdField_b_of_type_JavaLangString);
              }
              break label327;
              if (k != 2) {
                break label939;
              ...
              k = localafyd.jdField_b_of_type_Afyg.a();
              m = localafyd.jdField_a_of_type_Afyg.a();
              if ((localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int != 1) && (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int != 2))
              {
                localObject1 = localObject2;
                if (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int != 3) {}
              }
              else
              {
                localObject1 = localObject2;
              ...
              for (;;)
              {
                ...
                localanmw.a(localExtensionInfo);
                i = awzs.a(localafyd);
                a(paramQQAppInterface, localanmw, localafyd.jdField_b_of_type_JavaLangString, (String)localObject1, localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int, k, paramaofx, 2097153, i);
                ((auov)localObject4).notifyUI(3, true, new Object[] { localafyd.jdField_b_of_type_JavaLangString, Integer.valueOf(localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int), Integer.valueOf(m), Integer.valueOf(k) });
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                if (!QLog.isColorLevel()) {
                  break;
                }
                QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Upgrade intimate_type:" + localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int + " intimate_level:" + k + " old_intimate_level:" + m);
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                break;
                label1514:
                if (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 2)
                {
                  i = 158;
                }
                else
                {
                  ...
                  if (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 3)
                  {
                    ...
                    if (k == 2) {
                      ...
                      else if (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 2)
                      {
                        i = 159;
                      }
                      else
              ...
              for (;;)
              {
                ...
                localExtensionInfo.intimate_level = k;
                localanmw.a(localExtensionInfo);
                a(paramQQAppInterface, localanmw, localafyd.jdField_b_of_type_JavaLangString, (String)localObject1, localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int, k, paramaofx, 2097154, 0);
                ((auov)localObject4).notifyUI(3, true, new Object[] { localafyd.jdField_b_of_type_JavaLangString, Integer.valueOf(localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int), Integer.valueOf(m), Integer.valueOf(k) });
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                if (!QLog.isColorLevel()) {
                  break;
                }
                QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Downgrade intimate_type:" + localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int + " intimate_level:" + k + " old_intimate_level:" + m);
                paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                break;
                label1991:
                if (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int == 2)
              ...
              if ((localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int != 0) && (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi != null)) {
                if ((!TextUtils.isEmpty(localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi.jdField_a_of_type_JavaLangString)) && (!awzy.a(paramQQAppInterface)))
                {
                  localObject2 = axav.a(paramQQAppInterface, localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi.jdField_a_of_type_JavaLangString, bglf.m(paramQQAppInterface, localafyd.jdField_b_of_type_JavaLangString), localanmw);
                  localObject3 = axav.a(paramQQAppInterface, (String)((List)localObject2).get(0), localafyd.jdField_b_of_type_JavaLangString);
                  paramRelationalChainChange = (String)((List)localObject3).get(0);
                  ((List)localObject2).remove(0);
                  ((List)localObject3).remove(0);
                  paramaofx = new auxc(localafyd.jdField_b_of_type_JavaLangString, localafyd.jdField_b_of_type_JavaLangString, paramRelationalChainChange, 0, -5020, 2097153, bbyp.a());
                  if ((localObject3 != null) && (((List)localObject3).size() > 0))
                  {
                    ...
                    while (i < ((List)localObject3).size())
                    {
                      ...
                      if (!TextUtils.isEmpty(str))
                      {
                        ...
                        if (j >= 0) {
                          paramaofx.a(j, str.length() + j, localBundle);
                        }
                        if (QLog.isColorLevel()) {
                  ...
                  {
                    Collections.sort((List)localObject2, new axat());
              ...
              for (;;)
              {
                ...
                for (k = 1;; k = 0)
                {
                  ...
                  ((MessageForUniteGrayTip)localObject2).initGrayTipMsg(paramQQAppInterface, paramaofx);
                  paramaofx = new StringBuilder(21);
                  paramaofx.append(l1).append("_").append(l2);
                  ((MessageForUniteGrayTip)localObject2).tipParam.d = paramaofx.toString();
                  paramaofx = paramQQAppInterface.a().b(localafyd.jdField_b_of_type_JavaLangString, 0);
                  if ((paramaofx != null) && (!paramaofx.isEmpty()))
                  {
                    paramaofx = (MessageRecord)paramaofx.get(paramaofx.size() - 1);
                    if (((paramaofx instanceof MessageForUniteGrayTip)) && (((MessageForUniteGrayTip)paramaofx).tipParam != null) && (((MessageForUniteGrayTip)paramaofx).subType == ((MessageForUniteGrayTip)localObject2).subType) && (((MessageForUniteGrayTip)paramaofx).tipParam.c.equals(((MessageForUniteGrayTip)localObject2).tipParam.c)) && (((MessageForUniteGrayTip)localObject2).tipParam.jdField_a_of_type_Long - ((MessageForUniteGrayTip)paramaofx).tipParam.jdField_a_of_type_Long <= 1L))
                    {
                      if (!QLog.isColorLevel()) {
                        break;
                      }
                  ...
                  localExtensionInfo.intimate_level = localafyd.jdField_b_of_type_Afyg.a();
                  if (localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi.c > 0L) {
                    localExtensionInfo.last_intimate_chatTime = localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Afyi.c;
                  }
                  localanmw.a(localExtensionInfo);
                  paramRelationalChainChange = new ArrayList();
                  paramRelationalChainChange.add(localafyd.jdField_b_of_type_JavaLangString);
                  paramQQAppInterface.a(1).notifyUI(107, true, paramRelationalChainChange);
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!QLog.isColorLevel()) {
                    break label327;
                  }
                  QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Egalitarian_Soon intimate_type:" + localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int + " intimate_level:" + localafyd.jdField_b_of_type_Afyg.a());
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  break label327;
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!a()) {
                  ...
                  else
                  {
                    localExtensionInfo.isExtinguish = false;
                    localanmw.a(localExtensionInfo);
                    localObject1 = axav.a(paramQQAppInterface.getApp(), 167);
                    a(paramQQAppInterface, localanmw, localafyd.jdField_b_of_type_JavaLangString, (String)localObject1, localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int, localafyd.jdField_b_of_type_Afyg.a(), paramaofx, 2097153, 0);
                    ((auov)localObject4).notifyUI(3, true, new Object[] { localafyd.jdField_b_of_type_JavaLangString, Integer.valueOf(localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int), Integer.valueOf(localafyd.jdField_b_of_type_Afyg.a()), Integer.valueOf(localafyd.jdField_b_of_type_Afyg.a()) });
                    ((FriendListHandler)paramQQAppInterface.a(1)).notifyUI(3, true, localafyd.jdField_b_of_type_JavaLangString);
                  }
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!QLog.isColorLevel()) {
                    break label327;
                  }
                  QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Icon_Light intimate_type:" + localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int + " intimate_level:" + localafyd.jdField_b_of_type_Afyg.a());
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  break label327;
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  if (!a()) {
                  ...
                  else
                  {
                    ...
                    localanmw.a(localExtensionInfo);
                    localObject1 = axav.a(paramQQAppInterface.getApp(), 166);
                    a(paramQQAppInterface, localanmw, localafyd.jdField_b_of_type_JavaLangString, (String)localObject1, localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int, localafyd.jdField_b_of_type_Afyg.a(), paramaofx, 2097154, 0);
                    ((auov)localObject4).notifyUI(3, true, new Object[] { localafyd.jdField_b_of_type_JavaLangString, Integer.valueOf(localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int), Integer.valueOf(localafyd.jdField_b_of_type_Afyg.a()), Integer.valueOf(localafyd.jdField_b_of_type_Afyg.a()) });
                    ((FriendListHandler)paramQQAppInterface.a(1)).notifyUI(3, true, localafyd.jdField_b_of_type_JavaLangString);
                  }
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  ...
                  QLog.i("FriendIntimateRelationshipHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 Type_Icon_Extinguish intimate_type:" + localafyd.jdField_b_of_type_Afyg.jdField_a_of_type_Int + " intimate_level:" + localafyd.jdField_b_of_type_Afyg.a());
                  paramRelationalChainChange = (submsgtype0xc7.RelationalChainChange)localObject1;
                  break label327;
                }
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, intimate_relation.IntimateInfo paramIntimateInfo)
  {
    ...
    ExtensionInfo localExtensionInfo2 = localanmw.a(Long.toString(l));
  ...
  public static boolean a()
  {
    ...
    b = aqou.a().jdField_a_of_type_Boolean;
    if (QLog.isColorLevel()) {
