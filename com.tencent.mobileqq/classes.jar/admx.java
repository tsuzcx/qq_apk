  ...
  extends BaseBubbleBuilder
{
  ...
  public admx(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new adna(this);
  }
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, acxj paramacxj)
  {
    ...
    paramChatMessage = (RelativeLayout)paramViewGroup.findViewById(2131376566);
    "com.tencent.mobileqq".equals(this.jdField_a_of_type_AndroidContentContext.getPackageName());
    paramacxj = ((FlashChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(217)).a;
  ...
  public View a(ChatMessage paramChatMessage, acuj paramacuj, View paramView, BaseChatItemLayout paramBaseChatItemLayout, acxj paramacxj)
  {
    ...
    if (paramBaseChatItemLayout.arkContainer == null)
    {
      ...
      localadnd = (adnd)paramacuj;
      paramacuj = paramView;
      if (paramView == null)
      {
        paramacuj = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558728, null);
        paramView = paramacuj.findViewById(2131362789);
        localObject = (ArkAppLoadLayout)paramacuj.findViewById(2131369476);
        ...
        localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout = ((ArkAppLoadLayout)localObject);
        localadnd.d = localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.findViewById(2131366293);
        localadnd.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.findViewById(2131366294));
        localadnd.c = localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.findViewById(2131369486);
        localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)paramacuj.findViewById(2131362768));
        localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar = ((AutoStartProgressBar)paramacuj.findViewById(2131375878));
        localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setRadius(15.0F, true);
        localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setShowCorner(false);
        localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setDrawStatus(0);
        paramView = (RelativeLayout.LayoutParams)localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.getLayoutParams();
        paramView.width = ((int)FlashChatPanel.a());
        paramView.height = ((int)FlashChatPanel.b());
        paramView.leftMargin = 0;
        localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setLayoutParams(paramView);
      }
      paramChatMessage.isSend();
      paramView = localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView;
      ...
      paramChatMessage = localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localadnd.jdField_a_of_type_AndroidViewView = paramacuj;
        localadnd.d.setVisibility(8);
        localadnd.c.setVisibility(0);
        localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setVisibility(8);
        localadnd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.b();
        localadnd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.setBkgColorNormal(ArkAppLoadLayout.b);
        ...
        bool = true;
        break label562;
        paramView.setCallback(new admz(this, paramBaseChatItemLayout));
      }
    }
  }
  ...
  public String a(ChatMessage paramChatMessage)
  {
    ...
    {
      paramChatMessage = (MessageForArkFlashChat)paramChatMessage;
      return ajya.a(2131700681) + paramChatMessage.ark_app_message.promptText;
    }
    return ajya.a(2131700680) + paramChatMessage.msg;
  }
  ...
  {
    super.a(paramView);
    paramView = (MessageForArkFlashChat)actj.a(paramView);
    if (paramView == null) {}
    String str1;
    String str2;
    do
    ...
    bbdj.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new adnb(this, paramView), new adnc(this)).show();
  }
  ...
  public boolean a(String paramString1, String paramString2, MessageForArkFlashChat paramMessageForArkFlashChat)
  {
    ...
    sgg.a(paramMessageForArkFlashChat, localIntent, paramString1);
  ...
  public boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      if (paramString2.getPackageInfo(paramString1[0], 1) != null)
      {
        ...
        try
        {
          ((akgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(23)).b(paramString1[0].trim(), this.jdField_a_of_type_AndroidContentContext, paramString2);
          return true;
        }
  ...
  public bbmh[] a(View paramView)
  {
    ...
    localbbmf.a(2131364824, ajya.a(2131700679), 2130838597);
    if (paramView != null)
    {
      ...
      if ((localMessageForArkFlashChat != null) && (localMessageForArkFlashChat.ark_app_message != null))
      {
        ...
        if ((localMessageForArkFlashChat.isSend()) && (localMessageForArkFlashChat.extraflag != 32768) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(localMessageForArkFlashChat))) {
          a(localbbmf, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, localMessageForArkFlashChat);
        }
        a(localbbmf, localMessageForArkFlashChat);
  ...
  protected void g(ChatMessage paramChatMessage)
  {
    ...
    bgpu.a(null, paramChatMessage.msg).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage).a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
  }
}
