...
{
  public bcjc(WerewolvesHostInterface paramWerewolvesHostInterface, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    try
    {
      ((aszf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106)).d.put(this.jdField_a_of_type_JavaLangString, Integer.valueOf(1));
      if (!paramBoolean) {
        break label348;
      }
      ...
      if (paramInt != 0)
      {
        ...
        bcql.a(BaseApplicationImpl.getContext(), 1, paramBundle, 0).a();
        return;
      }
    ...
    bcql.a((Context)localObject, 2, localBaseApplication.getString(paramInt), 0).a();
    if (QLog.isColorLevel())
    {
