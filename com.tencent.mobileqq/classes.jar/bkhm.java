...
public class bkhm
{
  ...
  public bkhm(int paramInt1, int paramInt2, Typeface paramTypeface, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
  ...
  public static bkhm a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, Typeface paramTypeface, bkgu parambkgu)
  {
    paramTypeface = new bkhm(paramInt1, paramInt2, paramTypeface, paramInt3, paramInt4, paramInt5, paramInt6);
    paramTypeface.f = 1;
    paramTypeface.a(paramCharSequence, parambkgu);
  ...
  public void a(CharSequence paramCharSequence, bkgu parambkgu)
  {
    a(paramCharSequence, parambkgu, 0);
  }
  
  public void a(CharSequence paramCharSequence, bkgu parambkgu, int paramInt)
  {
    ...
    for (int j = (paramInt - this.e) / (paramCharSequence.length() - 1);; j = 0)
    {
      ...
      while (k < paramCharSequence.length())
      {
        ...
        else
        {
          ...
          if (this.f == 0)
          {
            localbkhf.b = parambkgu.a("", this.c + a(), this.d, 0, 255, new LinearInterpolator());
            label282:
            localbkhf.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject);
            if (k != 0) {
              break label374;
            }
            localbkhf.jdField_a_of_type_Int = paramInt;
          }
          for (paramInt = localbkhf.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + paramInt;; paramInt = localbkhf.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + j + paramInt)
          {
            this.jdField_a_of_type_JavaUtilArrayList.add(localbkhf);
            break;
            localbkhf.b = parambkgu.a("", this.c + this.d * k / paramCharSequence.length(), this.d, 0, 255, new LinearInterpolator());
            break label282;
            label374:
            localbkhf.jdField_a_of_type_Int = (paramInt + j);
          }
        }
      }
      return;
