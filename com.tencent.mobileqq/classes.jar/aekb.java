  ...
  implements View.OnClickListener
{
  ...
  public aekb(PhotoListPanel paramPhotoListPanel) {}
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aeke == null) {}
    while (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aeke.getItemCount() <= 0) {
      return;
    }
    paramView = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aeke.a(this.jdField_a_of_type_Int);
    int j = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aeke.getItemViewType(this.jdField_a_of_type_Int);
    if ((!paramView.mChecked) && (bbbj.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_JavaUtilLinkedList, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidAppActivity, PhotoListPanel.jdField_a_of_type_Int)))
    {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 9501) && (!paramView.mChecked))
    {
      ...
      String str;
      for (i = 0; ((Iterator)localObject).hasNext(); i = (int)(i + bbdj.a(str))) {
        str = (String)((Iterator)localObject).next();
      }
      if (i + bbdj.a(paramView.path) > 52428800L)
      {
        localObject = (yak)this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
        if ((localObject != null) && (((yak)localObject).a()))
        {
          long l1 = 0L;
          try
          {
          ...
          if (((yak)localObject).a(l1, 1))
          {
            bcpw.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidAppActivity, "选择图片总大小不能超过50M", 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.getResources().getDimensionPixelSize(2131298865));
            this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(paramView.mChecked);
            return;
          }
        }
    ...
    if (!paramView.mChecked)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aekc != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aekc.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a());
      }
      ...
      axqw.b(null, "CliOper", "", "", "0X8005E08", "0X8005E08", 0, 0, "", "", "", "");
