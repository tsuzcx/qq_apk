...
{
  public jxp(MultiVideoEnterPageActivity paramMultiVideoEnterPageActivity) {}
  ...
  protected void a(long paramLong, ArrayList paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      this.a.c();
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().removeCallbacks(this.a.jdField_a_of_type_Jxx);
      return;
