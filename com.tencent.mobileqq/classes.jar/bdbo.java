...
public class bdbo
  implements bdny
{
  public bdbo(OpenAuthorityFragment paramOpenAuthorityFragment) {}
  ...
  public void a()
  {
    ...
    QLog.d("OpenAuthorityFragment", 1, new Object[] { "updatePreAuthFromServer use cached appid=", OpenAuthorityFragment.a(this.a), ", appInfo=", ((aqaq)localObject1).toString() });
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = this.a.jdField_a_of_type_Bdnx;
      if (((GetVirtualListResult)localObject1).a == 0)
      {
        bool = true;
        ((bdnx)localObject2).a(bool, (GetVirtualListResult)localObject1);
      }
    }
    for (;;)
    {
  ...
  {
    QLog.d("OpenAuthorityFragment", 1, new Object[] { "updatePreAuthFromServer | onFail: | uin : *" + bdem.a(this.a.jdField_a_of_type_Bdna.a), ", errorCode=", Integer.valueOf(paramInt), ", errorMsg=", paramString });
    if (!OpenAuthorityFragment.b(this.a))
    {
    ...
    paramString.obj = this.a.getResources().getString(2131694896);
