  ...
  implements Manager
{
  ...
  public aril(QQAppInterface paramQQAppInterface)
  {
  ...
  public MessageForText a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForText == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForText.senderuin = ajed.av;
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForText.frienduin = ajed.av;
  ...
  public void a(Intent paramIntent)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemPullActivePush == null)
    {
      localObject = new RecentUser(ajed.av, 9653);
