...
public class aril
{
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Boolean localBoolean = (Boolean)bnrf.a("local_kd_tab_has_set");
    boolean bool3 = TextUtils.equals("1", paramString);
    bnrf.a(paramQQAppInterface, "remote_kd_tab_switch", Boolean.valueOf(bool3));
    boolean bool2;
  ...
  public void a(araj[] paramArrayOfaraj)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int j = 0;
        if (j < paramArrayOfaraj.length)
        {
          if (TextUtils.isEmpty(paramArrayOfaraj[j].a))
          {
          ...
          try
          {
            str2 = paramArrayOfaraj[j].a.trim();
            ...
            bnrf.c(localQQAppInterface, str1);
            continue;
            if (!QLog.isColorLevel()) {
              continue;
            }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("ReadinjoyCommonConfProcessor", 2, "received readinjoy cropandgroup config error,cmd : 92" + paramArrayOfaraj.toString());
        }
      }
      if (TextUtils.equals((CharSequence)localObject2, "feeds_group"))
      {
        bnrf.a(localQQAppInterface, str1);
      }
      else if (TextUtils.equals((CharSequence)localObject2, "remind_only_wifi"))
      {
        bnrf.b(localQQAppInterface, str1);
      }
      ...
      {
        bnrf.d(localQQAppInterface, TextUtils.equals(str1, "1"));
      }
      else
      {
        ...
        else
        {
          ...
          if (TextUtils.equals((CharSequence)localObject2, "socializeWebUrl"))
          {
            ...
            if (localObject1 != null)
            {
              if (((Node)localObject1).getNodeType() == 1)
              {
                ...
                if (!bnrf.a((String)localObject2)) {
                  break label641;
                }
                bnrf.a(localQQAppInterface, (String)localObject2, (String)localObject3);
              }
              for (;;)
              {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_tt"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bnrf.k(localQQAppInterface, true);
            } else {
              bnrf.k(localQQAppInterface, false);
            }
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_user_apps_switch"))
          {
            ...
            bnrf.a("kandian_report_user_apps_switch", localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_times"))
          {
            ...
            bnrf.h(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_feeds"))
          {
            ...
            bnrf.i(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "feedsbackWebUrl"))
          {
            bnrf.b(localQQAppInterface, (String)localObject2, (String)localObject1);
            if (QLog.isColorLevel()) {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsSwitch"))
          {
            ...
            bnrf.k(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsName"))
          {
            ...
            bnrf.d(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsWebUrl"))
          {
            ...
            bnrf.e(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "badgeNumber"))
          {
            ...
            bnrf.y(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_word_count"))
          {
            ...
            bnrf.f(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "new_channel_style"))
          {
            ...
            bnrf.l(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time"))
          {
            ...
            bnrf.b(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds"))
          {
            ...
            bnrf.z(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi"))
          {
            ...
            bnrf.c(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_weishi"))
          {
            ...
            bnrf.A(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandianWebPreLoadData"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bnrf.p(localQQAppInterface, true);
            } else {
              bnrf.p(localQQAppInterface, false);
            }
          }
          else if ((TextUtils.equals((CharSequence)localObject2, "ExitAIO_Android_Uin")) && (localObject1 != null))
          {
            ...
            if (localObject1.length >= 2) {
              bnrf.b(Integer.valueOf(localObject1[0]).intValue(), Integer.valueOf(localObject1[1]).intValue());
            }
          }
          ...
          {
            bnrf.a(localQQAppInterface, "remote_kd_tab_type", localObject1);
            ...
            if (!bool)
            {
              bnrf.a(localQQAppInterface, "local_kd_tab_type", localObject1);
          ...
          {
            bnrf.G(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump"))
          {
            bnrf.a(localQQAppInterface, "kd_topic_recommend_card_jump_switch", Boolean.valueOf(((String)localObject1).equals("1")));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump_url"))
          {
            bnrf.a(localQQAppInterface, "kd_topic_recommend_card_jump_url", localObject1);
          }
          ...
          else if ((TextUtils.equals((CharSequence)localObject2, "KW")) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            ozs.a("kandian_aio_sp_word", localObject2, true);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_gif_switch"))
          {
            ...
            bnrf.h(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "ugc_gif_switch"))
          {
            ...
            bnrf.i(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_at_switch"))
          {
            ...
            bnrf.n(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "UGC_at_switch"))
          {
            ...
            bnrf.m(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_at_switch"))
          {
            ...
            bnrf.v(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_profile_switch"))
          {
            ...
            bnrf.o(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_BiuMsg"))
          {
            ...
            bnrf.b(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_InteractiveMsg"))
          {
            ...
            bnrf.c(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_SubscribeMsg"))
          {
            ...
            bnrf.d((String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_support"))
          {
            bnrf.q(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_preload"))
          {
            bnrf.r(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "arkapp_enable_switch"))
          {
            ...
            bnrf.b(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "exposure_strengthen"))
          {
            bnrf.s(localQQAppInterface, "1".equals(localObject1));
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "diandian_publish_switch_new"))
          {
            ...
            bnrf.p(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_publish_switch_new"))
          {
            ...
            bnrf.q(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_QA_square_autoTimeval"))
          {
            ...
            bnrf.r(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "WXShareFromKandian_Switch"))
          {
            ...
            bnrf.s(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "zhitu"))
          {
            ...
            bnrf.j(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_biu_switch"))
          {
            ...
            bnrf.t(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "native_comment_biu"))
          {
            ...
            bnrf.u(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_width_height_ratio"))
          {
            ...
            bnrf.b(localQQAppInterface, Float.valueOf((String)localObject1).floatValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_max_duration_limit"))
          {
            ...
            bnrf.w(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "record_duration_count"))
          {
            ...
            bnrf.g(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandiansettings"))
          {
            ...
            bnrf.C(localQQAppInterface, str2);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "is_show_weishi_entrance"))
          {
            ...
            bnrf.D(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "is_jump_to_video_content"))
          {
            ...
            bnrf.K(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_Red_Pnt_Push_Article_Preload_Switch"))
          {
            ...
            bnrf.l(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "video_switch"))
          {
            ...
            try
            {
              ...
              bool = true;
              label4507:
              bnrf.a("sp_key_readinjoy_video_entrance_reddot_button_switch", Boolean.valueOf(bool));
            }
          ...
          else
          {
            ...
            if (bool)
            {
              try
              {
                bnrf.a("sp_key_readinjoy_video_entrance_reddot_button_color", Integer.valueOf(Color.parseColor(localNumberFormatException1)));
              }
            ...
            {
              bnrf.a("sp_key_readinjoy_video_entrance_reddot_expire_time_list", localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_guanzhu_Auto_Refresh_Time_Duration"))
            {
              ...
              bnrf.a("sp_key_kandian_subscribe_auto_refresh_config", Integer.valueOf(i));
            ...
            else if (TextUtils.equals((CharSequence)localObject2, "weishi_with_channel_discovery_switch"))
            {
              ...
              bnrf.e(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ugc_upload_lbs_switch"))
            {
              i = Integer.parseInt(localIllegalArgumentException);
              bnrf.a(opb.READINJOY_UGC_LBS, Integer.valueOf(i));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi_recommend"))
            {
              ...
              bnrf.b(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_counts_weishi_recommend"))
            {
              ...
              bnrf.c(localIllegalArgumentException);
            }
            else
            {
              ...
              bnrf.a("should_request_aladdin_config", Boolean.valueOf(TextUtils.equals("1", localIllegalArgumentException)));
            }
          }
        }
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              for (;;)
              {
                for (;;)
                {
                  for (;;)
                  {
                    for (;;)
                    {
                      try
                      {
                        ...
                        bool = true;
                        bnrf.a("sp_key_create_topic_switch", Boolean.valueOf(bool));
                      }
                      ...
                      {
                        bnrf.a("readinjoy_coin_item_jump_url", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                      ...
                      {
                        bnrf.a("readinjoy_coin_item_title", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                    ...
                    {
                      bnrf.a("kandianreport_ON", Integer.valueOf(Integer.parseInt(localNumberFormatException2)));
                      break;
                    }
                  ...
                  {
                    bnrf.a("kandian_daily_fast_web_bottom_share", localException3);
                    break;
                  }
                  ...
                  try
                  {
                    bnrf.f(Integer.parseInt(localException3));
                  }
                ...
                try
                {
                  bnrf.g(Integer.parseInt(localException4));
                }
              ...
              try
              {
                bnrf.h(Integer.parseInt(localException5));
              }
            ...
            try
            {
              ...
              bnrf.a("readinjoy_video_ff_probesize", Long.valueOf(Long.parseLong(localException6)));
            }
          ...
          try
          {
            ...
            bnrf.a("readinjoy_video_is_ff_probelist_switch", Integer.valueOf(Integer.parseInt(localException7)));
          }
        ...
        try
        {
          ...
          bnrf.a("readinjoy_video_is_download_async_io", Integer.valueOf(Integer.parseInt(localException8)));
        }
      ...
      {
        bnrf.a("kandian_daily_wrapper_alpha", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_default_text"))
      {
        bnrf.a("kandian_daily_wrapper_default_text", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_drag_text"))
      {
        bnrf.a("kandian_daily_wrapper_drag_text", localException9);
        break;
      }
      ...
      bnrf.a("kandian_video_extract_frame", localException9);
      break;
      label6364:
