...
{
  aynw(Context paramContext, String paramString, AppActivity paramAppActivity, Intent paramIntent) {}
  ...
  public void grant(int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    try
    {
      aynv.a(this.jdField_a_of_type_AndroidContentContext).edit().putString("camera_photo_path", this.jdField_a_of_type_JavaLangString).commit();
    ...
    catch (Exception paramArrayOfString)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131690695, 0).a();
    }
  }
}
