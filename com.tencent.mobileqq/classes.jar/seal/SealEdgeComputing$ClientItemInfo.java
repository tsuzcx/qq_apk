...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 25, 34 }, new String[] { "cate_name", "sub_cate_name", "seal_score", "extend" }, new Object[] { "", "", Double.valueOf(0.0D), "" }, ClientItemInfo.class);
