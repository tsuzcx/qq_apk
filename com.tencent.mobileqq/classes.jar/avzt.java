...
public class avzt
{
  ...
  private final avzm jdField_a_of_type_Avzm;
  private final bkxx jdField_a_of_type_Bkxx;
  private final String jdField_a_of_type_JavaLangString;
  private ByteBuffer jdField_a_of_type_JavaNioByteBuffer;
  private final List<avzv> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public avzt(bkxx parambkxx, String paramString, avzm paramavzm)
  {
    this.jdField_a_of_type_Bkxx = parambkxx;
  ...
  private void b()
  {
    ...
    avzv localavzv;
    for (int i = 0; localIterator.hasNext(); i = avzv.b(localavzv) + i)
    {
      localavzv = (avzv)localIterator.next();
      avzv.a(localavzv, localBufferInfo, i);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(a(avzv.a(localavzv)), this.jdField_a_of_type_JavaNioByteBuffer, localBufferInfo);
    }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bkxx.a())
      {
  ...
  public void a(int paramInt, ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new avzv(paramInt, paramBufferInfo.size, paramBufferInfo, null));
      return;
    }
