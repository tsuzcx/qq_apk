...
{
  private static boolean jdField_a_of_type_Boolean = azcw.c(azcw.z);
  private int jdField_a_of_type_Int;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  public azgf a;
  private azgg jdField_a_of_type_Azgg = new azgg(null);
  azgj jdField_a_of_type_Azgj;
  ...
  public azge()
  {
    this.jdField_a_of_type_Azgf = new azgf();
    f();
  ...
  private azgy a()
  {
    azgy localazgy = this.jdField_a_of_type_Azgf.a.b();
    if (localazgy != null) {
      return localazgy;
    }
    localazgy = this.jdField_a_of_type_Azgf.a.a();
    if (localazgy != null)
    {
      this.jdField_a_of_type_Azgj.a(localazgy.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localazgy;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Azgg.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Azgg.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Azgg.jdField_b_of_type_Int = 0;
    ajsi.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Azgg.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (azgf.a(this.jdField_a_of_type_Azgf))
    {
      Object localObject2 = azgf.a(this.jdField_a_of_type_Azgf);
  ...
  private void h()
  {
    if (this.jdField_a_of_type_Azgj != null) {
      this.jdField_a_of_type_Azgj.c();
    }
    this.jdField_a_of_type_Azgj = null;
    c();
  ...
  public void a(int paramInt1, int paramInt2, ajow paramajow)
  {
    ...
    this.jdField_e_of_type_Int = azcx.a().b();
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        ...
        this.jdField_a_of_type_Azgj.a(false, false);
        d();
      }
      azev.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (ajow)paramMessage.obj);
      this.h = true;
      if (this.i) {
        a(a());
      }
    ...
    do
    {
      do
      {
        ...
        f();
        this.jdField_a_of_type_Azgf.a();
        this.jdField_a_of_type_Azgf.a = null;
        this.jdField_a_of_type_Azgg.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Azgg.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Azgg.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (j != 0)
    {
      ajsi.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
      return true;
    }
    if (this.jdField_a_of_type_Azgj != null) {
      azev.a(PtvFilterUtils.a() / 1000L);
    }
    boolean bool1;
    if (paramMessage.obj != null)
    {
      ...
      for (;;)
      {
        ...
        ajsi.a("handleMessage:[copyDataToByteBuffer] steptime=" + l1 + " us");
        azev.d(l1);
        ...
        if (this.jdField_a_of_type_Azgf.a != null) {
          break;
        }
        ajsi.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
        if (paramMessage.arg1 == 1) {
          localObject = ((azdw)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
        }
      }
      ...
      if (localazgy != null)
      {
        this.jdField_a_of_type_Azgj.a(localazgy.jdField_a_of_type_Int);
        ajsi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] bindTextureId=" + localazgy.jdField_a_of_type_Int);
        ajsi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] Begin drawFrame mWidth=" + this.jdField_a_of_type_Int + " mHeight=" + this.jdField_b_of_type_Int);
        e();
        ajsi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] End drawFrame");
        if (!jdField_a_of_type_Boolean) {}
        AVIOStruct localAVIOStruct;
        for (bool1 = true;; bool1 = false)
        {
          PtvFilterUtils.a(bool1);
          ajsi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] glSyncCommand OK: sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
          if (paramMessage.arg1 != 1) {
            break label1126;
          }
          localAVIOStruct = ((azdw)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
        ...
        {
          this.jdField_a_of_type_Azgg.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        bool1 = true;
        label739:
        localazgy.a(j, localObject, bool1);
        localazgy.e();
        bool1 = this.jdField_a_of_type_Azgf.a.a();
        ajsi.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_Azgg.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_Azgg.jdField_a_of_type_Boolean) {
            a((AVIOStruct)localObject);
          }
          localazgy.a();
        }
        ajsi.a("handleMessage:writeVideoFrame frameBufferTime=" + l2 + "  sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
      }
      l1 = (PtvFilterUtils.a() - l1) / 1000L;
      azev.c(l1);
    ...
    for (;;)
    {
      ...
      break label739;
      label1143:
      ajsi.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
    }
  }
}
