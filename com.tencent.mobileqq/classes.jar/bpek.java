  ...
  implements MessageQueue.IdleHandler
{
  ...
  public boolean queueIdle()
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Bpfx.getActivity().getIntent().getExtras();
    ...
    for (localObject = "null";; localObject = str6)
    {
      ...
      localObject = new bpqt(str4);
      ((bpqt)localObject).b = str1;
      ((bpqt)localObject).c = str2;
      ((bpqt)localObject).d = str3;
      this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoLinkerLinkerSummaryView.setLinkerObject((bpqt)localObject);
      this.a.jdField_a_of_type_Bpep.a(Message.obtain(null, 15, 1, 0));
      return false;
      localObject = str4;
      break label168;
      localObject = str1;
