  ...
  extends ContentObserver
{
  ...
  private static final String jdField_b_of_type_JavaLangString = anvx.a(2131713039);
  ...
  public uvz(Context paramContext, int paramInt1, int paramInt2)
  {
    super(null);
    ...
    if (Build.VERSION.SDK_INT < 23) {
      ...
      {
        paramContext = uwc.jdField_b_of_type_JavaLangString;
        this.jdField_a_of_type_AndroidOsFileObserver = new uwa(this, paramContext, 256, paramContext);
      }
    }
    for (;;)
    {
      ...
      paramContext = uwc.jdField_a_of_type_JavaLangString;
      break;
  ...
  public void onChange(boolean paramBoolean, Uri paramUri)
  {
    ...
    //   46: aload_0
    //   47: getfield 96	uvz:jdField_a_of_type_AndroidContentContentResolver	Landroid/content/ContentResolver;
    //   50: getstatic 21	android/provider/MediaStore$Images$Media:EXTERNAL_CONTENT_URI	Landroid/net/Uri;
    //   53: getstatic 37	uvz:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   56: aconst_null
    //   57: aconst_null
    //   58: ldc 180
    ...
    //   135: invokespecial 206	uvz:a	(J)Z
    //   138: ifeq +134 -> 272
    //   141: aload 4
    //   143: astore_3
    //   144: aload_0
    //   145: aload 5
    //   147: invokespecial 208	uvz:a	(Ljava/lang/String;)Z
    //   150: ifeq +122 -> 272
    //   153: aload 4
    //   155: astore_3
    ...
    //   204: aload 5
    //   206: aload_0
    //   207: getfield 98	uvz:c	Ljava/lang/String;
    ...
    //   240: aload_0
    //   241: aload 5
    //   243: putfield 98	uvz:c	Ljava/lang/String;
    //   246: aload 4
    //   248: astore_3
    //   249: aload_0
    //   250: getfield 102	uvz:jdField_a_of_type_Uwb	Luwb;
    //   253: ifnull +19 -> 272
    //   256: aload 4
    //   258: astore_3
    //   259: aload_0
    //   260: getfield 102	uvz:jdField_a_of_type_Uwb	Luwb;
    //   263: aload_2
    //   264: aload 5
    //   266: iconst_1
    ...
    //   355: getstatic 29	uvz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   370: astore_3
    //   371: aload_0
    //   372: getfield 96	uvz:jdField_a_of_type_AndroidContentContentResolver	Landroid/content/ContentResolver;
    //   375: aload_2
    //   376: getstatic 37	uvz:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   379: aconst_null
    //   380: aconst_null
    //   381: ldc 180
    ...
    //   486: invokespecial 206	uvz:a	(J)Z
    //   489: ifeq +178 -> 667
    //   492: aload 5
    //   494: astore 6
    //   496: aload 5
    ...
    //   503: aload_0
    //   504: aload 7
    //   506: invokespecial 208	uvz:a	(Ljava/lang/String;)Z
    //   509: ifeq +158 -> 667
    //   512: aload 5
    //   514: astore 4
    //   516: aload 5
    ...
    //   579: aload 7
    //   581: aload_0
    //   582: getfield 98	uvz:c	Ljava/lang/String;
    ...
    //   619: aload_0
    //   620: aload 7
    //   622: putfield 98	uvz:c	Ljava/lang/String;
    //   625: aload 5
    //   627: astore 6
    //   629: aload 5
    //   631: astore 4
    ...
    //   635: astore_3
    //   636: aload_0
    //   637: getfield 102	uvz:jdField_a_of_type_Uwb	Luwb;
    //   640: ifnull +27 -> 667
    //   643: aload 5
    //   645: astore 4
    //   647: aload 5
    //   649: astore_3
    //   650: aload_0
    //   651: getfield 102	uvz:jdField_a_of_type_Uwb	Luwb;
    //   654: aload_2
    //   655: aload 7
    //   657: iconst_1
