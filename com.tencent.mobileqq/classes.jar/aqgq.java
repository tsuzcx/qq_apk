...
{
  public static final String a = ajed.aU + "hotvideo/preview/";
  ...
  public static Drawable a(Context paramContext, HotVideoData paramHotVideoData)
  {
    ...
    paramHotVideoData = aqgs.a(paramHotVideoData, 10.0F, paramContext);
  ...
  private void a(File paramFile, HotVideoData paramHotVideoData, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramFile = new batm(paramHotVideoData.url.replaceFirst("https", "http"), localFile);
    paramFile.n = true;
    paramFile.b = 2;
    int i = bato.a(paramFile, null, null);
    if (i == 0)
    {
      paramFile = attn.a(localFile.getAbsolutePath());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramURLDrawableHandler = attn.a(paramFile.getAbsolutePath());
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    {
      paramDownloadParams.GetPreviewURLAsync((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), 0, "0", new aqgr(this, paramDownloadParams, localFile, paramURLDrawableHandler));
      return localFile;
    }
