...
public class bakg
{
  ...
  public static bakd a(Intent paramIntent)
  {
    ...
    bakd localbakd = bake.a(paramIntent.getStringExtra("q_qssistant_openaction"));
    localbakd.jdField_a_of_type_JavaLangString = paramIntent.getStringExtra("q_qssistant_str_name");
    localbakd.b = paramIntent.getStringExtra("q_qssistant_str_scheme");
    localbakd.e = paramIntent.getStringExtra("q_qssistant_str_package");
    localbakd.c = paramIntent.getStringExtra("q_qssistant_str_server");
    localbakd.d = paramIntent.getStringExtra("q_qssistant_str_action");
    localbakd.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("q_qssistant_openenable", false);
    localbakd.g = paramIntent.getStringExtra("q_qssistant_jump_host");
    if (paramIntent.hasExtra("q_qssistant_extra_field_key"))
    {
      ...
      {
        HashMap localHashMap = localbakd.jdField_a_of_type_JavaUtilHashMap;
  ...
  public static bakd a(JSONObject paramJSONObject)
  {
    int i = 0;
    ...
    bakd localbakd = bake.a(str5);
    localbakd.jdField_a_of_type_JavaLangString = ((String)localObject);
    ...
    localbakd.jdField_a_of_type_Boolean = bool;
    ...
    for (;;)
    {
      ...
      {
        localbakd.jdField_a_of_type_JavaUtilHashMap.put(str2, str1);
        i += 1;
        break;
        return localbakd;
      }
  ...
  public static List<bakd> a(String paramString, List<String> paramList)
  {
    int j = 0;
    Object localObject1;
    if (StringUtil.isEmpty(paramString))
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject2).has("qassistantconfigs"))
        {
          ...
          {
            bakd localbakd = a(((JSONArray)localObject1).getJSONObject(i));
            if (localbakd == null) {
              break label230;
            }
            localArrayList.add(localbakd);
            break label230;
          }
        }
  ...
  public static void a(bakd parambakd, boolean paramBoolean, Intent paramIntent)
  {
    if ((parambakd == null) || (paramIntent == null)) {
      return;
    }
    paramIntent.putExtra("q_qssistant_debug_mode", paramBoolean);
    if (parambakd.jdField_a_of_type_JavaLangString == null)
    {
      localObject = "";
      label29:
      ...
      paramIntent.putExtra("q_qssistant_openenable", parambakd.jdField_a_of_type_Boolean);
      if (parambakd.f != null) {
        break label327;
      }
      localObject = "";
    ...
    label327:
    label336:
    for (Object localObject = "";; localObject = parambakd.g)
    {
      paramIntent.putExtra("q_qssistant_jump_host", (String)localObject);
      int i = parambakd.jdField_a_of_type_JavaUtilHashMap.size();
      if (i <= 0) {
        break;
      }
      arrayOfString1 = new String[i];
      arrayOfString2 = new String[i];
      Iterator localIterator = parambakd.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
      i = 0;
      while (localIterator.hasNext())
      {
        localObject = (Map.Entry)localIterator.next();
        parambakd = (String)((Map.Entry)localObject).getKey();
        localObject = (String)((Map.Entry)localObject).getValue();
        arrayOfString1[i] = parambakd;
        parambakd = (bakd)localObject;
        if (localObject == null) {
          parambakd = "";
        }
        arrayOfString2[i] = parambakd;
        i += 1;
      }
      localObject = parambakd.jdField_a_of_type_JavaLangString;
      break label29;
      localObject = parambakd.b;
      break label49;
      localObject = parambakd.e;
      break label69;
      localObject = parambakd.c;
      break label89;
      localObject = parambakd.d;
      break label109;
      localObject = parambakd.f;
      break label140;
    }
  ...
  public static void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bdla.b(null, "dc00898", "", "", "0X800A99A", "0X800A99A", 0, 0, str2, "", paramString, Build.MODEL);
        return;
      }
    }
  }
