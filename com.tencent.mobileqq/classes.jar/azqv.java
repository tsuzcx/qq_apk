  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject2 = paramView.findViewById(2131377085);
    if (localObject2 == null) {}
    for (;;)
    {
      return;
      Object localObject1 = ((View)localObject2).getTag(2131377085);
      if ((localObject1 != null) && ((localObject1 instanceof StructMsgForAudioShare)))
      {
        localObject1 = (StructMsgForAudioShare)localObject1;
        paramView = paramView.getTag();
        if ((paramView != null) && ((paramView instanceof afyi)))
        {
      ...
      try
      {
        ...
        {
          azmj.b(localQQAppInterface, "P_CliOper", "Pb_account_lifeservice", ((StructMsgForAudioShare)localObject1).uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(((StructMsgForAudioShare)localObject1).msgId), "");
    ...
    azmj.b(null, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, ((StructMsgForAudioShare)localObject1).mMsgServiceID + "", "", "", "");
    azmj.b(null, "CliOper", "", "", "0X8004B5C", "0X8004B5C", 1, 0, "", "", "", "");
    azmj.b(null, "dc00898", "", "", "0X800A630", "0X800A630", 0, 0, "2", ForwardUtils.b(((StructMsgForAudioShare)localObject1).uinType), ((StructMsgForAudioShare)localObject1).mContentTitle, "");
