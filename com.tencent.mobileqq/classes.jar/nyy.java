  ...
  implements DownloadListener
{
  ...
  public static nyy a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      paramJSONObject = nzd.a(paramJSONObject.optJSONObject("singleImageModule"));
      continue;
      paramJSONObject = nzg.a(paramJSONObject.optJSONObject("mixVideoModule"));
      continue;
  ...
  private void d()
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 1, this.jdField_a_of_type_AndroidContentContext.getString(2131717088), 0).b(0);
      return;
    }
  ...
  private void e()
  {
    nzq.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nyq, this);
    if (this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131717188));
    ...
    nzq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, 3, 2, 0);
  }
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_AndroidContentContext != null) && (!((Activity)this.jdField_a_of_type_AndroidContentContext).isFinishing()))
    {
      ...
      {
        this.jdField_a_of_type_AndroidAppDialog = nzq.a(this.jdField_a_of_type_AndroidContentContext, null, this.jdField_a_of_type_AndroidContentContext.getString(2131717196), new nzb(this), this.jdField_a_of_type_AndroidContentContext.getString(2131717197), new nzc(this), this.jdField_a_of_type_AndroidContentContext.getString(2131717198));
  ...
  private void g()
  {
    if (this.jdField_c_of_type_Int == 3)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 1, this.jdField_a_of_type_AndroidContentContext.getString(2131717199), 0).b(0);
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_Nyq != null) && (this.jdField_a_of_type_Nyq.jdField_a_of_type_Int == 2))
    {
      localAdProgressButton = (AdProgressButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131373053);
      if (this.jdField_a_of_type_Nyq.jdField_b_of_type_Int != 2) {
        break label70;
      }
      localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131717202));
    }
    label70:
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Nyq.jdField_b_of_type_Int != 1);
      if (nzq.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nyq.f))
      {
        localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131717200));
        this.jdField_c_of_type_Int = 1;
        return;
      }
      if (nzj.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nyq.f))
      {
        localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131717193));
        this.jdField_c_of_type_Int = 2;
        return;
      }
    } while (this.jdField_c_of_type_Int == 3);
    localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131717187));
    this.jdField_c_of_type_Int = 0;
  }
  
  public void a(Context paramContext, View paramView)
  {
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131560224, null);
    Object localObject2 = new RelativeLayout.LayoutParams(-1, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(12, -1);
    ((ViewGroup)paramView).addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
    if (((this.jdField_a_of_type_Nyq == null) || (this.jdField_a_of_type_Nyq.jdField_a_of_type_Int != 1)) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_b_of_type_Int == 1) || (this.jdField_b_of_type_Int == 2)))
    {
      paramView.findViewById(2131378900).setVisibility(0);
      if (this.jdField_b_of_type_Int == 1) {
        paramView.findViewById(2131378902).setVisibility(8);
      }
      localObject1 = paramView.findViewById(2131380543);
      localObject2 = paramView.findViewById(2131380544);
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Nyq != null) && (this.jdField_a_of_type_Nyq.jdField_a_of_type_Int == 2)) {
      paramView.findViewById(2131365703).setVisibility(0);
    }
    try
    {
      localObject1 = new URL(this.jdField_a_of_type_Nyq.jdField_a_of_type_JavaLangString);
      ((ResizeURLImageView)paramView.findViewById(2131365715)).setImage((URL)localObject1);
      ((TextView)paramView.findViewById(2131365712)).setText(this.jdField_a_of_type_Nyq.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton = ((AdProgressButton)paramView.findViewById(2131373053));
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgressColor(paramContext.getResources().getColor(2131165367));
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setOnClickListener(new nyz(this));
      int i = nzq.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nyq);
      if (i >= 0)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131717188));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-16777216);
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new nza(this);
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    if (a(paramDownloadInfo))
    {
      ...
      nzq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, 3, 4, 0);
    }
  }
