  ...
  extends BusinessHandler
{
  ...
  public nyy(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString1, long paramLong, String paramString2, nyz paramnyz)
  {
    this.jdField_a_of_type_Nyz = null;
    this.jdField_a_of_type_Nyz = paramnyz;
    ...
    paramnyz = new ilive_get_record_info_svr.GetRoomStateReq();
    paramnyz.source.set(paramString1);
    paramnyz.roomid.set((int)paramLong);
    ...
    paramString1.busi_buf.set(ByteStringMicro.copyFrom(((ilive_get_record_info_svr.GetRoomStateReq)paramnyz.get()).toByteArray()));
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3)
  {
    if (this.jdField_a_of_type_Nyz != null) {
      this.jdField_a_of_type_Nyz.a(paramBoolean, paramString2, paramString1, paramLong, paramString3);
    }
  }
