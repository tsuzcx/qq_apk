...
public class suj
{
  protected static ssj<String, suk> a = new ssj(200);
  ...
  public static File a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((vwp.a(paramString)) && (a(paramString, paramInt) != null))
    {
  ...
  {
    return ssf.h + a(paramString, false, 0L) + "/" + b(paramString, paramInt, paramBoolean1, paramBoolean2);
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (vwp.a(paramString)) {}
    for (String str = ssf.h;; str = ssf.i) {
  ...
  public static void a(StoryVideoItem paramStoryVideoItem, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        localtcw.a(paramStoryVideoItem.mVid, paramStoryVideoItem);
        return;
  ...
  {
    suk localsuk = new suk();
    localsuk.a = paramString2;
    a.a(paramString1, localsuk);
  }
  ...
  {
    paramString = (suk)a.a(paramString);
    if (paramString != null) {
