...
{
  spr(spp paramspp, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    spp.a(this.jdField_a_of_type_Spp).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.d(spp.a, 2, paramBundle.getMessage());
        continue;
      ...
      if (QLog.isColorLevel()) {
        QLog.d(spp.a, 2, "build struct msg fail");
      }
      return;
