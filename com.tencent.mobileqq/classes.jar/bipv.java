  ...
  implements View.OnClickListener
{
  ...
  public bipv(View paramView, apgz paramapgz)
  {
    super(paramView);
    this.jdField_a_of_type_Apgz = paramapgz;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299951));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299952));
    this.c = ((ImageView)paramView.findViewById(2131299954));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131299953);
    this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView = ((QIMCommonLoadingView)paramView.findViewById(2131303832));
    this.d = ((ImageView)paramView.findViewById(2131302436));
    paramView.setOnClickListener(this);
    paramapgz = (RelativeLayout.LayoutParams)this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.c.getLayoutParams();
    paramView = (ViewGroup.MarginLayoutParams)paramView.getLayoutParams();
    paramapgz.width = paramView.width;
    paramapgz.height = paramView.height;
    paramapgz.addRule(10);
    paramapgz.addRule(9);
    paramapgz.addRule(12);
    paramapgz.addRule(11);
    this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.setLayoutParams(paramapgz);
  ...
  public void onClick(View paramView)
  {
    if (paramView == this.jdField_a_of_type_AndroidViewView)
    {
      if (this.jdField_a_of_type_Apgz != null) {
        this.jdField_a_of_type_Apgz.a(paramView, getAdapterPosition(), -1);
      }
      urp.a("video_edit_text", "clk_textIcon", 0, 0, new String[] { (String)sob.a().a("EditVideoDTextFace.mSrcFrom"), String.valueOf(getAdapterPosition() + 1), "", "" });
    }
  }
}
