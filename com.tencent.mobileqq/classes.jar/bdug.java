  ...
  extends alpd
{
  ...
  public Bundle a;
  public awst a;
  private WeakReference<bduh> jdField_a_of_type_JavaLangRefWeakReference;
  private List<bdui> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public bdug(QQAppInterface paramQQAppInterface)
  {
  ...
  private void B(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramIntent = (aknx)this.app.getManager(153);
  ...
  private void C(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramIntent)
      {
        ...
        localBundle.putString("msg", alud.a(2131716436));
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      localBundle.putString("msg", alud.a(2131716437));
      if (QLog.isColorLevel()) {
  ...
  private void E(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      paramArrayOfByte = new bbub();
      paramArrayOfByte.a(paramFromServiceMsg);
      paramIntent.a(paramArrayOfByte);
      paramIntent.a(paramFromServiceMsg);
      bdne.f(this.app.getApplication(), this.app.getCurrentAccountUin(), System.currentTimeMillis());
    ...
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (paramIntent.ret.get() == 0L)
        {
          if (this.app != null)
          {
            ((aknt)this.app.getManager(211)).a(paramIntent.ret.get(), paramIntent.pbRsqData.get().toByteArray());
            return;
          }
    ...
    if ((paramIntent != null) && (paramArrayOfByte != null) && (paramFromServiceMsg != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (paramFromServiceMsg.ret.get() == 0L)
        {
          if (this.app != null)
          {
            ((aknt)this.app.getManager(211)).a(paramFromServiceMsg.ret.get(), paramFromServiceMsg.pbRsqData.get().toByteArray(), paramIntent.getBundleExtra("extras"));
            return;
          }
      ...
      try
      {
        ...
        if (paramIntent.ret.get() == 0L)
        {
          ...
          if (paramFromServiceMsg.getResultCode() == 1002)
          {
            ...
            azri.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "RichTextIllegalWordTime", bool1, l, 0L, null, "");
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "costTime:" + l + " isTimeOut:" + bool2 + " legalSuccess:" + bool1);
            }
            ((assg)this.app.getManager(219)).b(bool1);
          }
        }
        else
        {
  ...
  private void J(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent = new akux(paramFromServiceMsg.ip_list.get(), i, paramFromServiceMsg.aes_key.get(), paramFromServiceMsg.distribute_ts.get(), paramFromServiceMsg.sign.get());
      }
      catch (Exception paramIntent)
      {
      ...
      paramFromServiceMsg = ((aknx)this.mApp.getManager(153)).a();
      if (paramIntent != null)
      {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        try
        {
          ...
          if (paramFromServiceMsg.ret.get() == 0L)
          {
            ...
            if (paramIntent != null)
            {
              ...
              if (paramArrayOfByte.cmshow3dFlag != j)
              {
                ...
                paramArrayOfByte = albi.a(this.app);
                if (paramArrayOfByte != null) {
          ...
          {
            paramIntent = (bduh)this.jdField_a_of_type_JavaLangRefWeakReference.get();
            if (paramFromServiceMsg.ret.get() == 0L)
            {
              bool = true;
              paramIntent.a(bool);
    ...
    try
    {
      ...
      if (paramIntent.ret.get() == 0L)
      {
        ...
        if (paramIntent != null)
        {
          ...
          {
            paramIntent = (azbi)this.app.getManager(12);
  ...
  private void a(Long[] paramArrayOfLong, String paramString)
  {
    try
    {
      ...
      localJSONObject.put("cpuCount", bdgk.b());
      localJSONObject.put("cpuFrequency", bdgk.a());
      localJSONObject.put("systemTotalMemory", bdgk.d());
      ...
      paramString = new NewIntent(this.app.getApp(), bdum.class);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          if ((this.jdField_a_of_type_AndroidOsBundle == null) || (this.jdField_a_of_type_Awst == null)) {
            break;
          }
          this.jdField_a_of_type_Awst.a(i, j, paramIntent, this.jdField_a_of_type_AndroidOsBundle);
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            if (aknx.a(this.app, this.app.c()) == 2) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (0L == paramFromServiceMsg.ret.get())
        {
          ...
          localaknx = (aknx)this.app.getManager(153);
          ...
          if (localJSONArray != null)
          {
            ...
            if (i < localJSONArray.length())
            {
              ...
              ApolloBaseInfo localApolloBaseInfo = localaknx.b(l1 + "");
          ...
          if (paramArrayOfByte != null)
          {
            ...
            if (i < paramArrayOfByte.length())
            {
              ...
              paramFromServiceMsg = localaknx.b(l1 + "");
              j = 1;
              ...
              aldv.a(this.app, paramFromServiceMsg.jdField_a_of_type_JavaLangString, null);
              break label1111;
            }
          }
      ...
      for (;;)
      {
        ...
        break;
        label839:
        localaknx.b(localArrayList);
        ((aknx)this.app.getManager(153)).a(localArrayList);
        continue;
        label867:
  ...
  private void z(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (int i = paramArrayOfByte.length;; i = -1)
    {
      ...
      if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
        try
        {
          ...
          if ((paramFromServiceMsg.uint32_result.has()) && (paramFromServiceMsg.uint32_result.get() == 0))
          {
            ...
            localObject1 = (aknx)this.app.getManager(153);
            i = 0;
          }
          for (;;)
          {
            if (i < paramIntent.rpt_msg_uin_data.size())
            {
              ...
              ApolloBaseInfo localApolloBaseInfo = ((aknx)localObject1).b((String)localObject2);
              ...
              else
              {
                synchronized (this.jdField_a_of_type_JavaUtilList)
                {
                  ...
                  do
                  {
                    ...
                    localbdui = (bdui)localIterator.next();
                  } while (!localbdui.a((String)localObject2, localApolloBaseInfo));
                  localArrayList.add(localbdui);
                }
                return;
              }
            }
      ...
      do
      {
        ...
        break;
        ((aknx)localObject1).b(paramArrayOfByte);
      ...
      while (i < j)
      {
        ...
        localObject1 = ((aknx)this.app.getManager(153)).b(paramArrayOfByte);
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        ...
        boolean bool = ((aknx)this.app.getManager(153)).c(this.app.c());
        if (bool)
        {
          ...
          NewIntent localNewIntent = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(int paramInt)
  {
    ...
    ((IndividPub.Platform_Comm_Req)localObject).mqqver.set("8.3.5.4555");
    ...
    localObject = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(int paramInt, Bundle paramBundle, awst paramawst)
  {
    if (QLog.isColorLevel()) {
    ...
    localTPraiseSsoReq.str_qq_ver.set("8.3.5.4555");
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = Long.valueOf(0L);; paramString1 = Long.valueOf(Long.parseLong(paramString1)))
    {
      ...
      paramString1 = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      break;
      localUniSsoServerReq.pbReqData.set(ByteStringMicro.copyFrom(((MonitReport.MonitReportReq)localObject).toByteArray()));
      paramList = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    localSetAddonReq.str_qq_version.set("8.3.5");
    if (paramInt2 != -1) {
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    localReqBody.str_version.set(bdgk.c());
    Object localObject;
    if (paramLong1 == 8192L)
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = new NewIntent(this.mApp.getApp(), bdum.class);
  ...
  public void a(Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      localObject1 = ((alto)localObject2).a((String)localObject3);
      paramArrayOfByte = (byte[])localObject1;
      ...
      ((alto)localObject2).a(paramArrayOfByte);
      label679:
  ...
  public void a(bduh parambduh)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambduh);
  }
  
  public void a(bdui parambdui)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(parambdui);
      return;
    }
  }
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramReportChannlInfo = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(QQAppInterface paramQQAppInterface, int[] paramArrayOfInt)
  {
    ...
    try
    {
      ...
      paramArrayOfInt = new NewIntent(paramQQAppInterface.getApp(), bdum.class);
  ...
  public void a(String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(localJSONObject.toString());
        paramString2 = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(String paramString, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    Card localCard = ((alto)localObject).b(paramString);
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, List<String> paramList, boolean paramBoolean, String paramString2, String paramString3)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      localJSONObject2.put("qq_version", "8.3.5");
      localJSONObject2.put("skey", ((TicketManager)this.app.getManager(2)).getSkey(this.app.getCurrentAccountUin()));
      localJSONObject1.put("req", localJSONObject2);
  ...
  public void a(String paramString, ApolloBaseInfo paramApolloBaseInfo)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        bdui localbdui = (bdui)localIterator.next();
        if (localbdui.b(paramString, paramApolloBaseInfo)) {
          localArrayList.add(localbdui);
        }
      }
    }
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject2 = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(String paramString, ArrayList<benz> paramArrayList)
  {
    ...
    if (localIterator.hasNext())
    {
      benz localbenz = (benz)localIterator.next();
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ColorNick", 2, "modifyTroopMemberCardInfoWithColorNick type = " + localbenz.c + " text = " + localbenz.jdField_a_of_type_JavaLangString);
        }
        localArrayList2.add(localRichCardNameElem);
        break;
        localRichCardNameElem.bytes_text.set(ByteStringMicro.copyFrom(localbenz.jdField_a_of_type_JavaLangString.getBytes()));
        localStringBuilder.append(localbenz.jdField_a_of_type_JavaLangString);
        continue;
        paramArrayList = localbenz.jdField_a_of_type_JavaLangString;
    ...
    paramString.string_clientver.set(bdgk.c());
    ...
    paramArrayList = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(long... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
        paramVarArgs = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public void a(String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    localObject1 = new NewIntent(this.app.getApp(), bdum.class);
  ...
  public boolean a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localSCUpdateReq.comm.qver.set(ByteStringMicro.copyFrom("8.3.5.4555".getBytes()));
      localSCUpdateReq.comm.osrelease.set(ByteStringMicro.copyFrom(String.valueOf(Build.VERSION.SDK_INT).getBytes()));
      localSCUpdateReq.comm.network.set(bdin.b(this.app.getApplication()));
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (aknx.a(this.app, this.app.c()) != 2);
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
    {
      try
      {
        ...
        if (i != 0)
        {
          paramFromServiceMsg = (aknx)this.app.getManager(153);
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      paramString = new aspy(paramString, paramString, (String)localObject1, 0, -5020, 2097156, ayzl.a());
      localObject2 = new Bundle();
      String str = alud.a(2131716438);
      if (!TextUtils.isEmpty(str))
      {
      ...
      return;
      localObject1 = this.app.getApp().getString(2131693293);
      continue;
      localObject1 = this.app.getApp().getString(2131693292);
      continue;
  ...
  public void e()
  {
    ...
    try
    {
      ...
      localAddrDistribueReq.net_type.set(akwd.d());
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
      localUniSsoServerReq.comm.set((MessageMicro)localObject);
  ...
  public void e(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()) && (!TextUtils.isEmpty((CharSequence)localObject1)))
    {
      try
      {
        ...
        localObject3 = (aknx)this.mApp.getManager(153);
        if (localObject3 != null) {
          ((aknx)localObject3).a = ((HashMap)localObject1);
        }
        localObject2 = (aliw)this.mApp.getManager(155);
        if (localObject2 == null) {
          break label1385;
        }
        ((aliw)localObject2).a((JSONArray)localObject4);
        Object localObject5 = ((aliw)localObject2).a(1);
        localObject4 = ((aliw)localObject2).b();
        k = 0;
        i = 0;
        if (localObject5 == null) {
          break label1395;
        ...
        if (k < ((List)localObject5).size())
        {
          ...
          if (localObject3 != null) {
            ((aknx)localObject3).a(localApolloActionData, localBundle);
          }
          m = 1;
          i = m;
          if (!QLog.isColorLevel()) {
        ...
        ((aliw)localObject2).b((List)localObject5);
        k = i;
      }
      catch (Exception paramIntent)
      {
      ...
      ((aliw)localObject2).b((List)localObject4);
      m = i;
      break label1418;
    }
    label1102:
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        if (((aliw)localObject2).a(((Integer)((Iterator)localObject1).next()).intValue()) == null)
        {
      ...
      do
      {
        ...
        if (paramIntent.has("CurrencyInfo"))
        {
          ...
          if (localObject1 != null)
          {
            ((akoq)localObject1).jdField_a_of_type_Int = i;
            if (((akoq)localObject1).jdField_a_of_type_Boolean) {
              ((akoq)localObject1).b();
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public void e(String paramString)
  {
    ...
    for (Object localObject1 = str1.replace("gray_small_ship", " ");; localObject1 = str1)
    {
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(str1))
        {
          str1 = aush.a(this.app, 12L, 1L);
          str2 = aush.a(this.app, 12L, 2L);
  ...
  public void f(String paramString)
  {
    ...
    localFilter_Req_Comm.mqqver.set("8.3.5");
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess())) {
      try
      {
        ...
        if (0L == paramIntent.ret.get())
        {
          ...
          paramArrayOfByte = (aknx)this.app.getManager(153);
          if (paramArrayOfByte != null)
          {
  ...
  public void l(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        ((aknt)this.app.getManager(211)).a((int)paramFromServiceMsg.ret.get(), paramArrayOfByte.rpt_msg_list.get(), paramIntent);
        return;
      }
    ...
    if ((paramArrayOfByte != null) && (paramFromServiceMsg != null)) {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject = (aknt)this.app.getManager(211);
          ...
          {
            ((aknt)localObject).a(localUniSsoServerRsp.ret.get(), paramArrayOfByte, paramFromServiceMsg, paramIntent.getStringExtra("reqData"));
            if (!QLog.isColorLevel()) {
              return;
            }
        ...
        {
          localObject = ((aknx)this.app.getManager(153)).a();
          if (localObject != null) {
            ((akoq)localObject).a(localUniSsoServerRsp.ret.get(), paramFromServiceMsg, paramIntent.getStringExtra("reqData"));
          }
        }
      }
    }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_result.has()) && (paramFromServiceMsg.uint32_result.get() == 0))
        {
          ...
          if (i1 < i2)
          {
            ...
            paramFromServiceMsg = localalto.a(str);
            if (paramFromServiceMsg != null) {
              break label2102;
            }
            ...
            if (localUdcUinData.uint32_rsp_qq_level_icon_type.has())
            {
              ...
              localObject3 = (alto)this.app.getManager(51);
              Card localCard = ((alto)localObject3).b(str + "");
              if ((localCard != null) && (localCard.mQQLevelType != j))
              {
                localCard.mQQLevelType = j;
                ((alto)localObject3).a(localCard);
                this.app.a(2).notifyUI(1, true, localCard);
              }
            }
            if (localUdcUinData.uint32_rsp_theme_font_id.has()) {
              bdvy.b(localUdcUinData.uint32_rsp_theme_font_id.get());
            }
          ...
          paramIntent = localalto.a(this.app.getCurrentAccountUin());
          fx.a(this.app, this.app.getCurrentAccountUin(), paramIntent, i, j);
          localalto.b((List)localObject2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i != 0)
        {
          ...
          aldv.a(this.app, (String)localObject4, str);
        }
      ...
      Object localObject1 = localaknx.b((String)localObject1);
      if (localObject1 != null)
      {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramIntent = (aliw)this.app.getManager(155);
  ...
  public void s(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramIntent = ((aknx)this.app.getManager(153)).a();
        if (paramIntent != null) {
      ...
      if (i == 0) {
        ApolloItemBuilder.a(alud.a(2131716439), 1, BaseApplicationImpl.getContext());
      }
      return;
      label397:
      i = 0;
