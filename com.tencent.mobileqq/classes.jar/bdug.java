...
public class bdug
  extends bdsi
{
  public bdug(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((j != 0) && (bgnt.g(this.a.getApplicationContext())))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        new bdvl().a(paramOutputStream, paramDownloadParams, paramURLDrawableHandler);
        paramOutputStream.close();
        paramURLDrawableHandler = new File(str3);
        localFile = new File(str1);
        if (!paramURLDrawableHandler.renameTo(localFile))
        {
          bgmg.a(paramURLDrawableHandler, localFile);
          paramURLDrawableHandler.delete();
        }
        bljv.a(this.a.waitAppRuntime(null), false, new File(str1).length());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      if (5 == atvo.a(paramFile.getName()))
      {
        localObject = atvg.a(this.a, paramFile.getPath());
        if (localObject != null)
        {
