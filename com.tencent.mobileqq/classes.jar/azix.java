...
public class azix
  extends wme
{
  public azix(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.UploadFileRspBody paramUploadFileRspBody, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      awqx.b((QQAppInterface)this.b.get(), "P_CliOper", "Grp_files", "", "file", "fail_upload", 0, 0, l + "", "", "", "");
      paramUploadFileRspBody = new azie(paramBundle.FileName, this.a.e, 3, 207);
      this.a.a(paramBundle, 3, paramUploadFileRspBody);
      if (QLog.isDevelopLevel()) {
        QLog.w("TroopFileTransferManager", 2, "onReqResendFileResult,errCode=" + paramInt);
      }
      azld.a(azle.b, azle.z);
      return;
    }
    ...
    if (i < 0)
    {
      ...
      case -138: 
        for (;;)
        {
          paramUploadFileRspBody = new azie(paramBundle.FileName, this.a.e, 3, paramInt);
          this.a.a(paramBundle, 3, paramUploadFileRspBody);
          azld.a(azle.c, i);
          return;
          paramInt = 202;
      ...
      paramUploadFileRspBody = new azie(paramBundle.FileName, this.a.e, 3, 704, paramUploadFileRspBody);
      this.a.a(paramBundle, 3, paramUploadFileRspBody);
      return;
    }
    ...
    if (!this.a.b(paramBundle)) {
      this.a.jdField_a_of_type_ArrayOfAzjd[2].a(new TroopFileTransferManager.TaskHttpUpload(this.a, paramBundle));
    }
  }
}
