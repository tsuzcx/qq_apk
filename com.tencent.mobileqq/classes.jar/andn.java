...
public class andn
{
  private static andn jdField_a_of_type_Andn;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  private static String jdField_a_of_type_JavaLangString;
  int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long = System.currentTimeMillis();
  private ArrayList<ando> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static andn a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if ((jdField_a_of_type_Andn == null) || (!jdField_a_of_type_Andn.a()) || (!paramQQAppInterface.getCurrentAccountUin().equals(jdField_a_of_type_JavaLangString)))
      {
        jdField_a_of_type_Andn = new andn();
        jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
        jdField_a_of_type_Andn.a(paramQQAppInterface);
      }
      paramQQAppInterface = jdField_a_of_type_Andn;
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((List)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            paramQQAppInterface.b((auko)localObject5);
            continue;
          }
        }
        Object localObject2;
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        else
        {
          ...
          do
          {
            ...
            localObject7 = (ando)((Iterator)localObject6).next();
          } while ((((ando)localObject7).b != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType) || (((ando)localObject7).jdField_a_of_type_Int != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType));
        }
      }
      for (int i = 1;; i = 0)
      {
        if (i == 0)
        {
          localObject6 = new ando();
          ((ando)localObject6).b = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType;
          ((ando)localObject6).jdField_a_of_type_Int = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType;
  ...
  {
    if (jdField_a_of_type_Andn == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      jdField_a_of_type_Andn.a();
      jdField_a_of_type_Andn = null;
      return;
    }
  }
  ...
  public int a(String paramString, int paramInt, QQOperationViopTipTask paramQQOperationViopTipTask, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList)
  {
    ...
    if (k >= 0)
    {
      ...
      {
        if ((!akpx.o(paramString.msgtype)) || (paramString.extraflag != 0)) {
          break label221;
        }
  ...
  public andp a(String paramString, int paramInt1, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, boolean paramBoolean, int paramInt2)
  {
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (paramBoolean)
        {
          ...
          paramList = (andq)paramQQAppInterface.next();
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject1 = (ando)paramQQAppInterface.next();
          if ((((ando)localObject1).b != paramQQOperationVoipTipsTaskExcuteRecord.uinType) || (((ando)localObject1).jdField_a_of_type_Int != paramQQOperationVoipTipsTaskExcuteRecord.tipType)) {
            continue;
          }
          if (i == 0)
          {
            paramQQAppInterface = new ando();
          ...
          localaukp.b(paramQQOperationVoipTipsTaskExcuteRecord);
          localaukp.a();
          return;
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    //   43: return
    //   44: aload_1
    //   45: invokevirtual 149	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   48: invokevirtual 155	aukq:createEntityManager	()Laukp;
    //   51: astore_3
    //   52: aload_3
    //   53: invokevirtual 468	aukp:a	()Laukr;
    //   56: astore_1
    //   57: aload_1
    //   58: invokevirtual 471	aukr:a	()V
    //   61: aload_3
    //   62: ldc 157
    //   64: invokevirtual 474	aukp:a	(Ljava/lang/Class;)Z
    //   67: pop
    //   68: aload_2
    ...
    //   95: invokevirtual 247	aukp:b	(Lauko;)V
    //   98: goto -24 -> 74
    //   101: astore_2
    //   102: aload_2
    //   103: invokevirtual 226	java/lang/Exception:printStackTrace	()V
    //   106: aload_1
    //   107: invokevirtual 476	aukr:b	()V
    //   110: aload_3
    //   111: invokevirtual 228	aukp:a	()V
    //   114: aload_0
    //   115: invokevirtual 312	andn:a	()V
    //   118: return
    ...
    //   154: aload_1
    //   155: invokevirtual 480	aukr:c	()V
    //   158: aload_1
    //   159: invokevirtual 476	aukr:b	()V
    //   162: goto -52 -> 110
    //   165: astore_2
    //   166: aload_1
    //   167: invokevirtual 476	aukr:b	()V
    //   170: aload_2
    //   171: athrow
  ...
  public void a(String paramString, int paramInt, ArrayList<andq> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ((ajud)paramQQAppInterface.a(4)).a(paramString, paramInt, paramArrayList, false);
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    while (localIterator.hasNext())
    {
      ando localando = (ando)localIterator.next();
      if ((paramInt1 == localando.b) && (paramInt2 == localando.jdField_a_of_type_Int)) {
        return true;
      }
    }
    return false;
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, ArrayList<andq> paramArrayList, boolean paramBoolean, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if ((TextUtils.isEmpty(((QQOperationViopTipTask)localObject3).keywordString)) && (((QQOperationViopTipTask)localObject3).frequencyTime == 0))
      {
        ...
        {
          if (paramQQAppInterface.hasNext()) {
            if (((andq)paramQQAppInterface.next()).jdField_a_of_type_Int == ((QQOperationViopTipTask)localObject3).taskid)
            {
              paramInt1 = 1;
              label632:
              if (paramInt1 == 0)
              {
                paramQQAppInterface = new andq();
        ...
        for (;;)
        {
          ...
          if ((TextUtils.isEmpty(localQQOperationViopTipTask.keywordString)) && (localQQOperationViopTipTask.frequencyTime == 0))
          {
            ...
            while (((Iterator)localObject2).hasNext()) {
              if (((andq)((Iterator)localObject2).next()).jdField_a_of_type_Int == localQQOperationViopTipTask.taskid)
              {
                paramInt2 = 1;
                label1325:
                if (paramInt2 == 0)
                {
                  ...
                  ((andq)localObject2).jdField_a_of_type_Int = localQQOperationViopTipTask.taskid;
                  ((andq)localObject2).b = i;
                  ((andq)localObject2).jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
