...
{
  private ArrayList<ando> a = new ArrayList();
  ...
  protected andn(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    ...
    while (localIterator.hasNext()) {
      ((ando)localIterator.next()).a();
    }
  }
  
  public void a(ando paramando)
  {
    if (paramando == null) {}
    while (this.a.contains(paramando)) {
      return;
    }
    this.a.add(paramando);
  }
  ...
  public void b(ando paramando)
  {
    if ((paramando != null) && (this.a.contains(paramando))) {
      this.a.remove(paramando);
    }
  }
