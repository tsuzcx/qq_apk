  ...
  implements Manager
{
  ...
  private CopyOnWriteArrayList<ande> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public andn(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    QLog.i("cmgame_process.CmGameManager", 1, "[CmGameManager] created.");
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = new ApolloCmdChannel(anbd.a());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new andp();
  ...
  public amxt a()
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 379	andn:jdField_a_of_type_Amxt	Lamxt;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 381	amxt
    //   28: dup
    //   29: invokespecial 382	amxt:<init>	()V
    //   32: putfield 379	andn:jdField_a_of_type_Amxt	Lamxt;
    ...
    //   50: aload_0
    //   51: getfield 379	andn:jdField_a_of_type_Amxt	Lamxt;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
  ...
  public ande a()
  {
    ...
    {
      ande localande = (ande)localIterator.next();
      if ((localande != null) && (!anbd.a(localande.a())) && (!anbd.b(localande.a()))) {
        return localande;
      }
    }
    return null;
  ...
  public ande a(int paramInt)
  {
    ...
    {
      ande localande = (ande)localIterator.next();
      if ((localande != null) && (paramInt == localande.a())) {
        return localande;
      }
    }
    return null;
  ...
  public ande a(int paramInt1, int paramInt2)
  {
    if (paramInt1 <= 0) {}
    for (;;)
    {
      ...
      ande localande = new ande(paramInt1);
      localande.d = paramInt2;
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, localande);
  ...
  /* Error */
  public ande a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	andn:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   28: checkcast 390	ande
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 423	ande:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
  ...
  public List<andq> a()
  {
    ...
    Collections.sort(localArrayList, new ando(this));
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      andq localandq = (andq)localIterator.next();
      if (localandq != null) {
        if (localandq.jdField_a_of_type_JavaLangRefWeakReference == null)
        {
          localArrayList.add(localandq);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localandq.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localandq);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localandq = (andq)localIterator.next();
        if ((localandq != null) && (localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localandq.jdField_a_of_type_Int = 1;
          localandq.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localandq);
        }
      }
      for (;;)
      {
        ...
        localandq = new andq();
        localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localandq.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localandq.jdField_a_of_type_Int = 1;
        localandq.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localandq);
        return;
        localandq = null;
      }
    }
  ...
  /* Error */
  public ande b(int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 392	ande:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 406	ande:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 47	andn:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    ...
    //   89: aload_0
    //   90: getfield 47	andn:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localandq != null) && (localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localandq.jdField_a_of_type_Int = 2;
          localandq.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localandq.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localandq);
        }
      }
      for (paramActivity = localandq; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (andq)localIterator.next();
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      amze.a();
      if (this.jdField_a_of_type_Amxt != null) {
