...
{
  private static final String jdField_a_of_type_JavaLangString = avec.jdField_a_of_type_JavaLangString + "GameMsgManager";
  private static boolean jdField_e_of_type_Boolean;
  public int a;
  private long jdField_a_of_type_Long;
  private arba jdField_a_of_type_Arba = new arba();
  public avcc a;
  private aved jdField_a_of_type_Aved = new avdt(this);
  ...
  public boolean b;
  private Map<String, GameBasicInfo> c = Collections.synchronizedMap(new HashMap());
  public boolean c;
  private Map<String, GameSwitchConfig> d = Collections.synchronizedMap(new HashMap());
  public boolean d;
  ...
  public avds(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Avcc = new avcc();
  ...
  private void a(GameBasicInfo paramGameBasicInfo)
  {
    ...
    this.c.put(paramGameBasicInfo.mAppId, paramGameBasicInfo);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!TextUtils.isEmpty(((GameBasicInfo)localObject2).mAppId)) {
              this.c.put(((GameBasicInfo)localObject2).mAppId, localObject2);
            }
          }
        }
        QLog.i(jdField_a_of_type_JavaLangString, 1, "gameConfig.size:" + this.c.size());
      }
    }
    catch (Throwable localThrowable)
    {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!TextUtils.isEmpty(((GameSwitchConfig)localObject2).mAppId)) {
              this.d.put(((GameSwitchConfig)localObject2).mAppId, localObject2);
            }
          }
        }
        QLog.i(jdField_a_of_type_JavaLangString, 1, "gameSwitchConfig.size:" + this.d.size());
      }
    }
    catch (Throwable localThrowable)
    {
  ...
  public int a(boolean paramBoolean)
  {
    ...
    String str;
    for (int j = 0; localIterator.hasNext(); j = ((GameCenterSessionInfo)this.g.get(str)).c() + j) {
  ...
  public long a()
  {
    long l1 = avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_key_req_msg_unread_num");
    long l2 = avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_key_req_msg_read_time");
    if ((avdu.a(l1)) && (!avdu.a(l2)) && (this.f.size() > 0)) {
      return 1L;
    }
    return 0L;
  }
  
  public avdr a(String paramString)
  {
    if (QLog.isColorLevel()) {
    ...
    return avdr.a(localGameBasicInfo, localGameUserInfo);
  }
  ...
  public GameBasicInfo a(String paramString)
  {
    ...
    {
      return paramString;
      localObject = (GameBasicInfo)this.c.get(paramString);
      if (localObject == null) {
        break;
      }
  ...
  public GameSwitchConfig a(String paramString)
  {
    ...
    {
      return paramString;
      localObject = (GameSwitchConfig)this.d.get(paramString);
      if (localObject == null) {
        break;
      }
      paramString = (String)localObject;
  ...
  public String a()
  {
    if ((this.jdField_a_of_type_Arba != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Arba.e))) {
      return this.jdField_a_of_type_Arba.e;
    }
    return avdu.d;
  }
  ...
  {
    if ((this.jdField_a_of_type_Arba != null) && (this.jdField_a_of_type_Arba.jdField_a_of_type_JavaUtilHashMap != null) && (!TextUtils.isEmpty(paramString))) {
      return (ArrayList)this.jdField_a_of_type_Arba.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    }
    return null;
  }
  
  public HashMap<String, avdr> a(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList == null) || (paramArrayList.size() == 0)) {
      return null;
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        {
          localHashMap.put(str, avdr.a(localGameBasicInfo, localGameUserInfo));
        }
      }
    }
  ...
  public List<GameCenterSessionInfo> a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      if (((Iterator)localObject3).hasNext())
      {
        ...
        else
        {
          ...
          localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getLastMessage(((ConversationInfo)localObject4).uin, ((ConversationInfo)localObject4).type);
          ...
          localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getFirstUnreadMessage(((ConversationInfo)localObject4).uin, ((ConversationInfo)localObject4).type);
          if (localObject6 != null)
          {
            localCharSequence = ((QQMessageFacade.Message)localObject6).emoRecentMsg;
            if (!TextUtils.isEmpty(localCharSequence)) {
          ...
          ((GameCenterSessionInfo)localObject5).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          if (QLog.isColorLevel()) {
          ...
          if ((((ConversationInfo)localObject4).tinyInfo != null) && (!TextUtils.isEmpty(((ConversationInfo)localObject4).tinyInfo.fromRoleId)))
          {
            ...
            if (localObject2 != null)
            {
              localObject6 = (avdr)((HashMap)localObject2).get(((ConversationInfo)localObject4).tinyInfo.fromRoleId);
              if (!QLog.isColorLevel()) {
                break label1530;
              }
    ...
    for (;;)
    {
      if (localObject6 != null)
      {
        ((GameCenterSessionInfo)localObject5).i(((avdr)localObject6).e);
        ((GameCenterSessionInfo)localObject5).f(((avdr)localObject6).jdField_c_of_type_JavaLangString);
        ((GameCenterSessionInfo)localObject5).e(((avdr)localObject6).jdField_b_of_type_Int);
        ((GameCenterSessionInfo)localObject5).h(((avdr)localObject6).d);
        ((GameCenterSessionInfo)localObject5).g(((avdr)localObject6).i);
        ((GameCenterSessionInfo)localObject5).c(((avdr)localObject6).k);
        ((GameCenterSessionInfo)localObject5).a(((avdr)localObject6).j);
      }
  ...
  public void a()
  {
    avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_key_req_msg_unread_num", 0L);
    avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_key_req_msg_read_time", System.currentTimeMillis());
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_key_req_msg_unread_num", System.currentTimeMillis());
      avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "sp_key_req_msg_read_time", 0L);
    }
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (((RecentUser)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().findRecentUser("2747277822", 1008) == null) && (paramInt != 0));
  ...
  public void a(arba paramarba)
  {
    ...
    QLog.i(jdField_a_of_type_JavaLangString, 1, "graySwitch:" + paramarba.jdField_a_of_type_Int + ",msgListUrl:" + paramarba.b + ",prefix:" + paramarba.jdField_c_of_type_JavaLangString);
    if (this.jdField_a_of_type_Arba == null) {
      this.jdField_a_of_type_Arba = new arba();
    }
    if (!TextUtils.isEmpty(paramarba.b)) {
      this.jdField_a_of_type_Arba.b = paramarba.b;
    }
    this.jdField_a_of_type_Arba.jdField_a_of_type_Int = paramarba.jdField_a_of_type_Int;
    if (!TextUtils.isEmpty(paramarba.jdField_c_of_type_JavaLangString)) {
      this.jdField_a_of_type_Arba.jdField_c_of_type_JavaLangString = paramarba.jdField_c_of_type_JavaLangString;
    }
    this.jdField_a_of_type_Arba.jdField_c_of_type_Int = paramarba.jdField_c_of_type_Int;
    this.jdField_a_of_type_Arba.e = paramarba.e;
    this.jdField_a_of_type_Arba.jdField_a_of_type_JavaUtilHashMap = paramarba.jdField_a_of_type_JavaUtilHashMap;
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setReaded(localGameCenterSessionInfo.d(), 10007);
  ...
  public int b()
  {
    ...
    Iterator localIterator = this.g.keySet().iterator();
    String str;
    for (int i = 0; localIterator.hasNext(); i = ((GameCenterSessionInfo)this.g.get(str)).c() + i) {
      str = (String)localIterator.next();
    }
    long l = a();
    int j = (int)(0 + i + l);
  ...
  public String b()
  {
    if ((this.jdField_a_of_type_Arba != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Arba.b))) {
      return this.jdField_a_of_type_Arba.b;
    }
    return avdu.b;
  }
  ...
  {
    return avdw.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (paramString.equals(localGameCenterSessionInfo.e()))
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().clearHistory(localGameCenterSessionInfo.d(), 10007);
          }
        }
      }
  ...
  public void b(ArrayList<GameBasicInfo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        {
          GameBasicInfo localGameBasicInfo2 = (GameBasicInfo)this.c.get(localGameBasicInfo1.mAppId);
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Arba != null) && (this.jdField_a_of_type_Arba.jdField_c_of_type_Int == 1);
  }
  ...
  public int c()
  {
    ...
    if (!avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {}
    while ((!c()) || (uot.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "2747277822"))) {
      return 0;
    }
  ...
  public String c()
  {
    if ((this.jdField_a_of_type_Arba != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Arba.jdField_c_of_type_JavaLangString))) {
      return this.jdField_a_of_type_Arba.jdField_c_of_type_JavaLangString;
    }
    return avdu.jdField_c_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    ((avec)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.GAME_CENTER_UNISSO_HANDLER)).a();
    ...
    for (;;)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localGameSwitchConfig != null)
        {
          ...
          this.d.put(localGameSwitchConfig.mAppId, localGameSwitchConfig);
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Arba != null) && (this.jdField_a_of_type_Arba.jdField_a_of_type_Int == 1);
  }
  ...
  {
    if (this.jdField_a_of_type_Arba != null) {
      return this.jdField_a_of_type_Arba.d;
    }
    return "";
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aved);
    }
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    do
    {
      ...
      c();
      localConversationInfo = avdw.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, localMessageRecord.istroop);
      if (QLog.isColorLevel()) {
    ...
    if (paramObject == null)
    {
      ...
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getFirstUnreadMessage(localMessageRecord.frienduin, localMessageRecord.istroop);
      if (localObject != null) {
      ...
      if (localObject != null)
      {
        paramObject.f(((avdr)localObject).jdField_c_of_type_JavaLangString);
        paramObject.g(((avdr)localObject).i);
        paramObject.i(((avdr)localObject).e);
        paramObject.e(((avdr)localObject).jdField_b_of_type_Int);
        paramObject.c(((avdr)localObject).k);
        paramObject.h(((avdr)localObject).d);
        paramObject.a(((avdr)localObject).j);
      }
      if (a(paramObservable.gameAppId + ""))
      {
        ...
        paramObservable.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        j = a();
        k = paramObservable.c();
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if ((!avdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (i == k)) {
        break;
      }
