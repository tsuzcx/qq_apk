...
public class alqp
{
  ...
  public alqp(WeakReference<GLTextureView> paramWeakReference)
  {
  ...
  private void d()
  {
    if ((this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface != null) && (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface != EGL10.EGL_NO_SURFACE))
    {
      ...
      if (localGLTextureView != null) {
        GLTextureView.access$800(localGLTextureView).a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface);
      }
  ...
  public GL a()
  {
    ...
    {
      localGL1 = localGL2;
      if (GLTextureView.access$900(localGLTextureView) != null) {
        localGL1 = GLTextureView.access$900(localGLTextureView).a(localGL2);
      }
      localObject = localGL1;
      if ((GLTextureView.access$1000(localGLTextureView) & 0x3) != 0)
      {
        i = 0;
        if ((GLTextureView.access$1000(localGLTextureView) & 0x1) != 0) {
          i = 1;
        }
        if ((GLTextureView.access$1000(localGLTextureView) & 0x2) == 0) {
          break label106;
        }
      }
    }
    label106:
    for (localObject = new alqs();; localObject = null)
    {
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLSurface = null;
        return;
        this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLConfig = GLTextureView.access$500((GLTextureView)localObject).a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay);
        this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext = GLTextureView.access$600((GLTextureView)localObject).a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLConfig);
      }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext != null)
    {
      GLTextureView localGLTextureView = (GLTextureView)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localGLTextureView != null) {
        GLTextureView.access$600(localGLTextureView).a(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext);
      }
      this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext = null;
    }
    if (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay != null)
