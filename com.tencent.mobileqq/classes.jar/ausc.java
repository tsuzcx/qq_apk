...
public class ausc
{
  public static SparseArray<Class<? extends aupt>> a = new SparseArray(30);
  ...
  public static aupt a(Intent paramIntent)
  {
    ...
    if (localClass != null) {
      try
      {
        paramIntent = (aupt)localClass.getDeclaredConstructor(new Class[] { Intent.class }).newInstance(new Object[] { paramIntent });
        return paramIntent;
      }
  ...
  public static aupt a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
