...
{
  public ajgm(TroopGiftActionButton paramTroopGiftActionButton, TextView paramTextView) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      paramMotionEvent.setAnimationListener(new ajgn(this));
      ...
      ((ScaleAnimation)localObject).setAnimationListener(new ajgo(this, paramMotionEvent));
