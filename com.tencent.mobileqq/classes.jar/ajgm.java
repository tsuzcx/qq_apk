  ...
  implements ajfk, ajfo
{
  ...
  public void a()
  {
    ...
    if ((this.jdField_b_of_type_Int > 0) && (this.jdField_a_of_type_Ajgh != null)) {
      VipUtils.a(null, "cmshow", "Apollo", "play_times", ApolloUtil.b(this.jdField_a_of_type_Ajgh.jdField_a_of_type_Int), 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), this.jdField_a_of_type_Ajgh.jdField_a_of_type_JavaLangString });
    }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) || (this.jdField_a_of_type_Ajgh == null))
    {
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localajfp != null) {
        localajfp.a(localSpriteTaskParam, localSpriteTaskParam.jdField_a_of_type_Long);
      }
    }
    if ((this.jdField_a_of_type_Ajfz != null) && (!TextUtils.isEmpty(paramString)) && (paramString.equals(localSpriteTaskParam.jdField_a_of_type_JavaLangString))) {
      this.jdField_a_of_type_Ajfz.a(localSpriteTaskParam.jdField_a_of_type_JavaLangString, localSpriteTaskParam.f, localSpriteTaskParam.jdField_a_of_type_Int);
    }
    ...
    do
    {
      do
      {
        ...
        while (localIterator.hasNext())
        {
          ajfp localajfp = (ajfp)localIterator.next();
          if (localajfp != null) {
            localajfp.a(localSpriteTaskParam, localSpriteTaskParam.jdField_a_of_type_Long, paramInt2);
          }
        }
      } while ((this.jdField_a_of_type_Ajfz == null) || (TextUtils.isEmpty(paramString)) || (!paramString.equals(localSpriteTaskParam.jdField_a_of_type_JavaLangString)));
      this.jdField_a_of_type_Ajfz.a(localSpriteTaskParam.jdField_a_of_type_JavaLangString, localSpriteTaskParam.f, localSpriteTaskParam.jdField_a_of_type_Int, localSpriteTaskParam.l, localSpriteTaskParam.jdField_a_of_type_AndroidOsBundle);
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_Ajgh == null) || (!this.jdField_a_of_type_Ajgh.a()))
    {
