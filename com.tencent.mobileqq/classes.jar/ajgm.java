  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private ajmm jdField_a_of_type_Ajmm = new ajgq(this);
  public ajoj a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  private bfhb jdField_a_of_type_Bfhb;
  ...
  private cz jdField_a_of_type_Cz = new cz(this);
  public dd a;
  public String a;
  private ArrayList<avzb> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  protected HashMap<Long, avza> a;
  ...
  ajgm(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Ajoj = new ajoj(paramQQAppInterface);
    this.jdField_a_of_type_Dd = new dd(paramQQAppInterface);
    this.jdField_a_of_type_Cv = new cv(paramQQAppInterface);
    this.jdField_c_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131165620);
    this.jdField_d_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131165619);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ajgn(this);
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new ajgo(this, paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new ajgp(this);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Ajmm);
    this.jdField_a_of_type_Bfhb = new bfhb(paramQQAppInterface);
    f();
    g();
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2, int paramInt4)
  {
    ...
    localawbn.jdField_a_of_type_Int = paramInt2;
    localawbn.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, localawbn, l, awbk.b(paramLong1), paramLong2);
  ...
  private msg_svc.PbSendMsgReq a(int paramInt1, String paramString, awbn paramawbn, long paramLong1, int paramInt2, long paramLong2)
  {
    return awbg.a(this.app, paramInt1, paramString, paramawbn, paramLong1, paramInt2);
  }
  ...
  private void a(int paramInt, long paramLong, String paramString)
  {
    ...
    localDataLineMsgRecord.md5 = bach.a(paramString);
    if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
      QLog.d("DataLineHandler", 4, "SessionUpdateType_FileMD5, uSessionID[" + paramLong + "], strValuebuf[" + paramString + "], strMD5MR[" + bach.a(localDataLineMsgRecord.md5) + "], strMD5Notify" + paramString);
    }
    this.app.a().a(i).a(localDataLineMsgRecord.msgId, localDataLineMsgRecord.serverPath, localDataLineMsgRecord.md5);
  }
  ...
  private void a(int paramInt1, DataLineMsgRecord paramDataLineMsgRecord, int paramInt2)
  {
    ...
    if (paramDataLineMsgRecord.isSend())
    {
      if (paramInt2 == 2)
      {
        ...
        awqx.b(this.app, "CliOper", "", "", "0X8006223", "0X8006223", 0, 0, "", "", "", "");
        return;
      }
      if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
      {
        ...
        awqx.b(this.app, "CliOper", "", "", "0X8006224", "0X8006224", 0, 0, "", "", "", "");
        return;
      }
      paramDataLineMsgRecord.fileMsgStatus = 0L;
      this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
    ...
    if (paramInt2 == 2)
    {
      ...
      awqx.b(this.app, "CliOper", "", "", "0X8006226", "0X8006226", 0, 0, "", "", "", "");
      return;
    }
    if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
    {
      ...
      this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
      this.app.a().a(paramInt1).b(paramDataLineMsgRecord.msgId);
      awqx.b(this.app, "CliOper", "", "", "0X8006227", "0X8006227", 0, 0, "", "", "", "");
      return;
    }
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      {
        ((axhd)this.app.getManager(305)).a(localDataLineMsgRecord, i);
        return;
      }
    ...
    do
    {
      for (;;)
      {
        ...
        if (localFile.exists()) {
          try
          {
            String str = apck.a(paramString);
            Object localObject = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
            localObject = axxf.a(paramContext, str);
  ...
  {
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), ajgt.class);
  ...
  private boolean a(avzb paramavzb)
  {
    int j = 0;
    int i = 0;
    StringBuffer localStringBuffer = new StringBuffer();
    int m = paramavzb.a(localStringBuffer);
    if (m == -1) {
      return false;
    }
    int k;
        ...
        if (localStringBuffer.charAt(i) == '\024')
        {
          ...
          if (i < localStringBuffer.length() - 1)
          {
            ...
            if (k >= 0)
            {
              ...
              if (k < awbk.a.length)
              {
                localStringBuffer.setCharAt(i + 1, (char)awbk.a[k]);
                j = i + 1;
              }
            }
          }
    ...
    paramavzb.a(a(paramavzb.a().longValue(), 1001, paramavzb.a(), m, localStringBuffer.toString().getBytes()));
    return true;
  }
  ...
  private void b(List<SubMsgType0x7.MsgBody.MoloNotify> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localDataLineMsgRecord = this.jdField_a_of_type_Cz.a(((SubMsgType0x7.MsgBody.MoloNotify)localObject).bytes_buf.get().toByteArray());
        if (localDataLineMsgRecord == null)
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      localDataLineMsgRecord.fileMsgStatus = 1L;
      bool = badq.h(BaseApplication.getContext());
      ...
      {
        b(111);
        this.jdField_a_of_type_Cz.a(localDataLineMsgRecord.strMoloKey);
        dj.c(this.app);
        label729:
        this.app.a().a(j).c(localDataLineMsgRecord.msgId);
        continue;
  ...
  private void c(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (bace.b(paramDataLineMsgRecord.thumbPath));
      str = apck.a(str, 384, 384);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    paramToServiceMsg.path = (ajed.bj + paramToServiceMsg.filename);
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size()) {
      if (!((avzb)this.jdField_a_of_type_JavaUtilArrayList.get(i)).a().equals(paramToServiceMsg)) {}
    }
    for (paramToServiceMsg = (avzb)this.jdField_a_of_type_JavaUtilArrayList.get(i);; paramToServiceMsg = null)
    {
      if (paramToServiceMsg == null) {}
      do
      {
  ...
  public void GetThumbFilePath(int paramInt, Session paramSession)
  {
    ...
    Object localObject = (ajrc)this.app.a(10);
    if ((localObject != null) && (((ajrc)localObject).a() == 0))
    {
    ...
    localObject = ew.a(BaseApplication.getContext(), paramSession.strFilePathSrc);
    if (localObject == null)
    {
  ...
  {
    es.a(this.app, paramReportItem, es.jdField_b_of_type_Int);
  }
  ...
  public boolean OnQueryAutoDownload(long paramLong, byte paramByte)
  {
    ...
    if (paramByte == 2)
    {
      boolean bool1 = badq.h(BaseApplication.getContext());
  ...
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    if (paramSession.bSend)
    {
      awqx.b(this.app, "CliOper", "", "", "0X8006222", "0X8006222", 0, 0, "", "", "", "");
      if ((paramSession.actionInfo != null) && (paramSession.actionInfo.strServiceName != null) && (paramSession.actionInfo.strServiceName.length() != 0)) {
        break label210;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      a(paramSession);
      return;
      awqx.b(this.app, "CliOper", "", "", "0X8006225", "0X8006225", 0, 0, "", "", "", "");
      break;
      label199:
  ...
  public int a(String paramString)
  {
    ...
    return this.jdField_a_of_type_Cz.a(paramString);
  }
  ...
  public bfhb a()
  {
    return this.jdField_a_of_type_Bfhb;
  }
  ...
  public Session a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
        QLog.d("DataLineHandler", 4, "getSessionFromMsgRecord, uSessionID[" + localDataLineMsgRecord.sessionid + "], strMR[" + bach.a(localDataLineMsgRecord.md5) + "], filesize[" + localDataLineMsgRecord.filesize);
      }
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x345 paramMsgCSBody0x345)
  {
    ...
    for (localObject = arrayOfByte;; localObject = createToServiceMsg("GTalkFileAppSvr.CMD_DISCUSS_FILE", null))
    {
      ...
      if (localObject != null)
      {
        ...
        bakz.a(arrayOfByte, 0, paramMsgCSBody0x345.length + 4);
        bakz.a(arrayOfByte, 4, paramMsgCSBody0x345, paramMsgCSBody0x345.length);
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x346 paramMsgCSBody0x346)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bakz.a((byte[])localObject2, 0, paramMsgCSBody0x346.length + 4);
        bakz.a((byte[])localObject2, 4, paramMsgCSBody0x346, paramMsgCSBody0x346.length);
        paramMsgCSBody0x346 = (MsgCSBody0x346)localObject1;
  ...
  public cv a()
  {
    return this.jdField_a_of_type_Cv;
  }
  ...
  public Long a(String paramString, int paramInt)
  {
    ...
    localDataLineMsgRecord.issuc = false;
    ((ajrm)this.app.a(13)).a(localDataLineMsgRecord);
    ...
    localDataLineMsgRecord.issuc = true;
    paramString = new avzb(paramString, localLong, localDataLineMsgRecord);
    if (!a(paramString)) {
      return Long.valueOf(0L);
    }
  ...
  {
    this.jdField_a_of_type_Cz.b(paramInt);
  }
  ...
  public void a(int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Cz.c(localDataLineMsgRecord.strMoloKey);
      return;
    }
  ...
  protected void a(long paramLong1, long paramLong2, SubMsgType0x7.MsgBody.GenericSubCmd paramGenericSubCmd, SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        case 1: 
          ...
          default: 
            ...
            {
              localavza = new avza(Long.valueOf(paramGenericSubCmd.uint32_size.get()), Long.valueOf(l));
              this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localavza);
            ...
            {
              localavza = (avza)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
              continue;
            }
            if (!paramGenericSubCmd.uint32_index.has()) {
              break label697;
            }
            localavza.a(paramGenericSubCmd.uint32_index.get(), paramMsgHeader);
            if (!localavza.a()) {
              break label697;
            }
            ...
            if (i == 1)
            {
              paramGenericSubCmd = localavza.a();
              i = 0;
              if (i < axjs.a.length)
              {
                paramMsgHeader = paramGenericSubCmd;
                if (paramGenericSubCmd.indexOf('\024' + axjs.a[i]) == -1) {
                  break label714;
                }
                paramMsgHeader = paramGenericSubCmd.replace('\024' + axjs.a[i], "\024" + (char)i);
                break label714;
              }
              ...
              h();
              a(8, true, new Object[] { Integer.valueOf((int)paramLong1), localavza.a(), Long.valueOf(((DataLineMsgRecord)localObject1).sessionid) });
              return;
            }
            break;
          }
      ...
      ((DataLineMsgRecord)localObject1).msg = localavza.a();
      continue;
      aror.a().a(paramGenericSubCmd);
      return;
      label691:
      break label705;
      label694:
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getServiceCmd().equals("MessageSvc.PbSendMsg"))
    {
      ...
      aror.a().a(paramToServiceMsg, paramFromServiceMsg, paramObject);
    }
    label72:
  ...
  {
    this.jdField_a_of_type_Bfhb.a(paramMsg);
  }
  
  public void a(msg_comm.Msg paramMsg, SubMsgType0x7.MsgBody paramMsgBody)
  {
    this.jdField_a_of_type_Bfhb.a(paramMsg, paramMsgBody);
    DataLineMsgRecord localDataLineMsgRecord;
    try
    {
      localDataLineMsgRecord = new DataLineMsgRecord();
    ...
    localObject = (ajrc)this.app.a(10);
    if ((localObject != null) && (((ajrc)localObject).d() != 1)) {
      ((ajrc)localObject).e(1);
    }
  ...
  public void a(msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    this.jdField_a_of_type_Ajoj.a(this, paramMsg, paramMsgBody);
  }
  ...
  public boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    for (;;)
    {
      ...
      bakz.a(arrayOfByte, 0, localObject2.length + 4);
      bakz.a(arrayOfByte, 4, (byte[])localObject2, localObject2.length);
      if (localObject1 != null)
      {
  ...
  public boolean a(DataLineMsgSet paramDataLineMsgSet)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localDataLineMsgRecord.strMoloKey != null)
      {
        ...
        {
          this.jdField_a_of_type_Cz.d(localDataLineMsgRecord.strMoloKey);
          if (QLog.isDevelopLevel()) {
  ...
  public boolean a(String paramString)
  {
    ...
    return this.jdField_a_of_type_Cz.e(paramString);
  }
  ...
  public boolean a(List<Long> paramList)
  {
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      {
        this.jdField_a_of_type_Cz.a(((DataLineMsgRecord)localObject3).strMoloKey);
        bool1 = true;
      }
      for (;;)
      {
    ...
    if (TextUtils.isEmpty(localDataLineMsgRecord.path)) {
      localDataLineMsgRecord.path = (ajed.bj + "/" + localDataLineMsgRecord.filename);
    }
  ...
  {
    this.jdField_a_of_type_Cz.a(paramInt);
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    bakz.a(arrayOfByte, 0, paramFromServiceMsg.getWupBuffer(), 4, j);
    label390:
  ...
  public boolean b(String paramString)
  {
    ...
    return this.jdField_a_of_type_Cz.b(paramString);
  }
  ...
  public void d()
  {
    long l = this.app.a().a(String.valueOf(ajed.z), 6000).time;
    ...
    if ((l != 0L) && (l != this.jdField_c_of_type_Long))
    {
      ...
      ((akak)this.app.a().a("c2c_processor")).b(localArrayList);
      this.jdField_c_of_type_Long = l;
    }
    l = this.app.a().a(String.valueOf(ajed.A), 6003).time;
  ...
  public void onDestroy()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if ((this.app != null) && (this.app.getApp() != null) && (this.jdField_a_of_type_Ajmm != null))
        {
        ...
        this.jdField_a_of_type_Bfhb.a();
        this.jdField_a_of_type_Cz.a();
        this.jdField_a_of_type_Ajoj.a();
        this.jdField_a_of_type_Cv.a();
        if (this.jdField_a_of_type_JavaUtilTimer != null)
        {
          this.jdField_a_of_type_JavaUtilTimer.cancel();
          this.jdField_a_of_type_JavaUtilTimer = null;
  ...
  {
    this.jdField_a_of_type_Bfhb.a(paramToServiceMsg, paramFromServiceMsg, (byte[])paramObject);
