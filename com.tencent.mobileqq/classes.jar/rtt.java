  ...
  extends rrp
{
  ...
  public rtt(Activity paramActivity, rtw paramrtw)
  {
    super(paramActivity);
  ...
  public View a(LayoutInflater paramLayoutInflater)
  {
    ...
    paramLayoutInflater.setLayoutParams(new FrameLayout.LayoutParams(-1, actn.a(60.0F, this.jdField_a_of_type_AndroidAppActivity.getResources())));
    ImageView localImageView = (ImageView)paramLayoutInflater.findViewById(2131368335);
    localImageView.setImageResource(2130841223);
    ((TextView)paramLayoutInflater.findViewById(2131368379)).setVisibility(8);
    ((TextView)paramLayoutInflater.findViewById(2131368383)).setText(ajyc.a(2131714160));
    paramLayoutInflater.findViewById(2131368368).setVisibility(8);
    paramLayoutInflater.findViewById(2131375887).setVisibility(8);
    paramLayoutInflater.setOnClickListener(new rtu(this));
    localImageView.setOnClickListener(new rtv(this));
