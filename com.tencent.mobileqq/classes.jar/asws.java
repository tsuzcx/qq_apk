...
public class asws
{
  private static Map<String, asws> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aswt(this);
  ...
  private final List<aswu> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private asws(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.3.3");
      return localIntent;
    }
  }
  
  public static asws a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      asws localasws2 = (asws)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      asws localasws1 = localasws2;
      if (localasws2 == null)
      {
        localasws1 = new asws(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localasws1);
      }
      return localasws1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", alpo.a(2131706014));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", alpo.a(2131706024) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", alpo.a(2131706028) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + alpo.a(2131706023) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", alpo.a(2131706022) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", alpo.a(2131706012) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!aswm.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        aswy.a("2691707");
      ...
      a("HuayangPluginLauncher", alpo.a(2131706027) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + alpo.a(2131706020) + (System.currentTimeMillis() - l));
      return;
      if (aswm.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        aswy.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", alpo.a(2131706018) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", alpo.a(2131706016) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + alpo.a(2131706013) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
      for (;;)
      {
        ...
        aswh.a(paramRunningPlugin);
      }
    }
  }
  
  public void a(aswu paramaswu)
  {
    if (paramaswu != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramaswu);
    }
  }
  ...
  public void b(aswu paramaswu)
  {
    if (paramaswu != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramaswu);
    }
  }
}
