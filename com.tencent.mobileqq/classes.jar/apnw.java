  ...
  extends apnx
{
  ...
  protected void a()
  {
    ...
    apob.a("glGetAttribLocation u_threshold");
    this.b = GLES20.glGetUniformLocation(this.d, "u_clipBlack");
    apob.a("glGetAttribLocation u_clipBlack");
    this.c = GLES20.glGetUniformLocation(this.d, "u_clipWhite");
    apob.a("glGetAttribLocation u_clipWhite");
  }
  ...
  protected void a(apoa paramapoa)
  {
    ...
    GLES20.glUniform1f(this.a, paramapoa.f);
    GLES20.glUniform1f(this.b, paramapoa.g);
    GLES20.glUniform1f(this.c, paramapoa.h);
  }
}
