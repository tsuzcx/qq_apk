...
public class bciu
{
  ...
  public static EIPCResult a(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    ((atxb)paramString.getManager(160)).a(10014);
    paramBundle.code = 0;
    return paramBundle;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    {
      localObject1 = (atxb)paramQQAppInterface.getManager(160);
      paramQQAppInterface = ((atxb)localObject1).a(10013);
      localObject2 = ((atxb)localObject1).a(10014);
      if (!((atxb)localObject1).a(paramQQAppInterface, false)) {
        break label1102;
      }
    ...
    for (;;)
    {
      int k = i;
      int m = j;
      if (((atxb)localObject1).a((RedTouchItem)localObject2, false))
      {
        k = i;
        m = j;
        ...
        for (;;)
        {
          ...
          if (!TextUtils.isEmpty(paramQQAppInterface.icon))
          {
            if (!TextUtils.isEmpty(paramQQAppInterface.tips))
            {
              ...
              localObject2 = new BusinessInfoCheckUpdate.RedTypeInfo();
              ((BusinessInfoCheckUpdate.RedTypeInfo)localObject2).red_content.set(bawz.a(BaseApplicationImpl.sApplication.getApplicationContext(), 3.0F) + "");
            ...
            try
            {
              ...
              try
              {
                ...
                paramQQAppInterface.setPadding(actn.a(160.0F, paramQQAppInterface.getResources()), paramQQAppInterface.getPaddingTop(), paramQQAppInterface.getPaddingRight(), paramQQAppInterface.getPaddingBottom());
                return;
              }
  ...
  public static EIPCResult b(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    paramString = (atxb)paramString.getManager(160);
