...
public class ore
{
  ...
  private HashMap<String, orf> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private AppRuntime jdField_a_of_type_MqqAppAppRuntime;
  
  public ore(AppRuntime paramAppRuntime, TroopMemberApiService paramTroopMemberApiService)
  {
  ...
  public void a()
  {
    ...
    pnn localpnn = (pnn)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    Iterator localIterator = this.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
    while (localIterator.hasNext()) {
      localpnn.b((batl)((Map.Entry)localIterator.next()).getValue());
    }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    String str = ((pnn)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261)).a();
    if (!pnc.a(str)) {
      str = "";
    }
    for (;;)
    {
      boolean bool = baig.u(((AppInterface)this.jdField_a_of_type_MqqAppAppRuntime).getApp().getApplicationContext(), ((AppInterface)this.jdField_a_of_type_MqqAppAppRuntime).getCurrentAccountUin());
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject1 = (pnn)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    ...
    label208:
    for (localObject1 = ((pnn)localObject1).a(0, "", l1, (String)localObject2, str2, l2, l3, bool);; localObject1 = ((pnn)localObject1).a(1, str1, l1, (String)localObject2, str2, l2, l3, bool))
    {
  ...
  public void c(Bundle paramBundle)
  {
    ...
    {
      return;
      localObject = (pnn)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
      ...
      long l2 = paramBundle.getLong("startTime");
      long l3 = paramBundle.getLong("endTime");
      orf localorf = new orf(this.jdField_a_of_type_MqqAppAppRuntime, str1, paramBundle, this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiService);
      this.jdField_a_of_type_JavaUtilHashMap.put(str1, localorf);
      bool = ((pnn)localObject).a(str1, str2, str3, l1, l2, l3, localorf);
      if (QLog.isColorLevel()) {
  ...
  public void d(Bundle paramBundle)
  {
    ...
    Object localObject = (pnn)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    String str = paramBundle.getString("skinId");
    paramBundle.getString("skinUrl");
    boolean bool = ((pnn)localObject).a(str);
