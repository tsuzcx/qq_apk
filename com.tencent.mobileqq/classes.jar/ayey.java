  ...
  extends anii
{
  ...
  public ayey(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        bctj.a(this.mApp.getApplication()).a(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      Object localObject4 = bdud.a().b(l1);
      Object localObject5 = bdud.a().a(l1);
      ...
      try
      {
        ...
        ((bdvs)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject5);
        ((bdvs)localObject1).jdField_a_of_type_Bdvw = new ayez(this, paramIntent, (byte[])localObject2, (String)localObject3);
        ((bdvs)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ((bdvs)localObject1).jdField_a_of_type_Int = 1;
        ((bdvs)localObject1).e = 57;
        ((bdvs)localObject1).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
        ((bdvs)localObject1).jdField_b_of_type_Int = 2;
        ((bdvs)localObject1).c = 15000L;
        ((bdvs)localObject1).f = true;
        ((bdvs)localObject1).g = true;
        ((bdvs)localObject1).jdField_b_of_type_JavaLangString = "sslv6.htdata.qq.com";
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((bdws)localObject1);
          if (QLog.isColorLevel()) {
