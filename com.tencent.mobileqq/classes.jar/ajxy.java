...
{
  private ajxy(AbsWebView paramAbsWebView) {}
  ...
  protected WebResourceResponse a(WebView paramWebView, String paramString)
  {
    ...
    for (WebView localWebView = paramWebView;; localWebView = null)
    {
      ...
      {
        this.b.jdField_a_of_type_ComTencentBizUiTouchWebView.post(new ajxz(this, localWebViewPluginEngine, localWebView));
      ...
      if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("jsbridge")) && (this.b.jdField_a_of_type_ComTencentBizUiTouchWebView != null)) {
        this.b.jdField_a_of_type_ComTencentBizUiTouchWebView.post(new ajya(this, localWebViewPluginEngine, paramString));
      }
      try
      {
