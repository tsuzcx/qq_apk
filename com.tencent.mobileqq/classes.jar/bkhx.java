  ...
  extends QzoneExternalRequest
{
  ...
  public bkhx(long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.androidId = String.valueOf(bdgk.f());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.imsi = String.valueOf(b());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.mode = String.valueOf(bdgk.i());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.manufacture = String.valueOf(bdgk.h());
    ...
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.uniqueId = String.valueOf(bfmw.c());
  ...
  public static String a()
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = bhsp.a("b94d1a");
      label27:
      return jdField_a_of_type_JavaLangString;
    }
