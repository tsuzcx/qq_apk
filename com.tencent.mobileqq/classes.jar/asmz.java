  ...
  implements BusinessObserver
{
  ...
  private final SparseArray<WeakReference<asnb>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  private void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        localObject2 = (asnb)((WeakReference)localObject1).get();
        ...
        ((asnb)localObject1).a(paramBoolean, i, j, paramBundle, (String)localObject2);
        return;
      }
  ...
  int a(asnb paramasnb)
  {
    synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
    {
      ...
      localSparseArray2.append(i, new WeakReference(paramasnb));
