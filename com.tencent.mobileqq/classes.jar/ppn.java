...
public class ppn
{
  ...
  public ppn(AppInterface paramAppInterface)
  {
  ...
  {
    int i = 0;
    SharedPreferences localSharedPreferences = bnrf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, false);
  ...
  {
    Object localObject = bnrf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, false);
    if (localObject != null)
    {
  ...
  public void a(qzb paramqzb)
  {
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Qzb = paramqzb;
        if (paramqzb == null)
        {
          i = 0;
          ...
          if ((paramqzb == null) || (paramqzb.a == null)) {
            break;
          }
          localStringBuilder.append(paramqzb.a.size()).append(" ");
          Iterator localIterator = paramqzb.a.iterator();
          if (!localIterator.hasNext()) {
            break label141;
          }
          localStringBuilder.append(((qzd)localIterator.next()).jdField_a_of_type_Int).append(" ");
          continue;
        }
        int i = 1;
      }
    ...
    label151:
    ThreadManager.executeOnFileThread(new FollowCoverInfoModule.2(this, paramqzb));
  }
