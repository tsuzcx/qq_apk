...
public class ppn
{
  ...
  public static boolean a(String paramString)
  {
    ...
    try
    {
      ...
      bool1 = rqj.a(((JSONObject)localObject).optString("min_version", null), ((JSONObject)localObject).optString("max_version", null), ((JSONObject)localObject).optString("min_android_build", null), ((JSONObject)localObject).optString("max_android_build", null));
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    try
    {
      boolean bool2 = nap.a(paramString1, paramString2);
      bool1 = bool2;
    }
    catch (Throwable localThrowable)
    {
