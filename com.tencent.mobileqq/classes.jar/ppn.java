...
public class ppn
{
  ...
  private static ppn a(String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return a(bakz.a(paramString), paramInt);
  }
  
  private static ppn a(ppn paramppn)
  {
    SharedPreferences localSharedPreferences = bgmq.a(obz.a(), true, false);
    if ((localSharedPreferences == null) || (paramppn == null)) {
      return paramppn;
    }
    paramppn.jdField_d_of_type_Long = localSharedPreferences.getLong("kandian_push_0x210_c5_msg_time", 0L);
    return paramppn;
  }
  
  public static ppn a(byte[] paramArrayOfByte)
  {
    return a(paramArrayOfByte, 1);
  }
  
  public static ppn a(byte[] paramArrayOfByte, int paramInt)
  {
    int i1 = 0;
    ...
    for (;;)
    {
      try
      {
        submsgtype0xc5.MsgBody localMsgBody = new submsgtype0xc5.MsgBody();
        localMsgBody.mergeFrom(paramArrayOfByte);
        localppn.jdField_a_of_type_Int = paramInt;
        localppn.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
        localppn.jdField_b_of_type_Int = localMsgBody.uint32_source.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, bid = " + localppn.jdField_b_of_type_Int);
        }
        localppn.jdField_c_of_type_Int = localMsgBody.uint32_bid.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, realbid = " + localppn.jdField_c_of_type_Int);
        }
        localppn.jdField_a_of_type_Long = localMsgBody.uint64_article_id.get();
        localppn.jdField_b_of_type_Long = localMsgBody.uint64_seq.get();
        if (localMsgBody.bytes_diandian_cookie.has()) {
          localppn.jdField_c_of_type_JavaLangString = localMsgBody.bytes_diandian_cookie.get().toStringUtf8();
        }
        if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null))
        {
          ...
          {
            localppn.jdField_a_of_type_JavaUtilArrayList.clear();
            ...
            if (paramInt < paramArrayOfByte.size())
            {
              ...
              localppn.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
              paramInt += 1;
              continue;
            }
          }
          ...
          if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_folder.has())
          {
            ...
            localppn.jdField_e_of_type_Int = paramInt;
            ...
            localppn.jdField_g_of_type_Int = paramInt;
            ...
            localppn.jdField_a_of_type_JavaLangString = paramArrayOfByte;
            ...
            localppn.jdField_b_of_type_JavaLangString = paramArrayOfByte;
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localppn.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
              return null;
            }
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localppn.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
              return localppn;
            ...
            if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_lock_screen.has())
            {
              ...
              localppn.jdField_f_of_type_Int = paramInt;
              paramInt = i1;
              ...
              if (((submsgtype0xc5.TipsBody)localObject2).uint64_uin.has())
              {
                ...
                localppn.jdField_e_of_type_Long = l1;
                ...
                localppn.jdField_e_of_type_JavaLangString = paramArrayOfByte;
                ...
                localppn.jdField_d_of_type_JavaLangString = paramArrayOfByte;
                ...
                localppn.jdField_f_of_type_JavaLangString = paramArrayOfByte;
                ...
                localppn.jdField_g_of_type_JavaLangString = paramArrayOfByte;
                if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null) && (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.has())) {
                  localppn.i = ((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.get();
                }
                if ((((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.get() != null))
                {
                  ...
                  localppn.jdField_c_of_type_Long = paramArrayOfByte.uint64_bb_uin.get();
                  localppn.jdField_d_of_type_Int = paramArrayOfByte.uint32_src.get();
                }
                return localppn;
              }
            }
  ...
  public static ppn b()
  {
    return a(a(bgmq.a(obz.a(), true, false).getString("kandian_push_0x210_msg_for_follow", ""), 1));
  }
  ...
  public static ppn c()
  {
    return a(a(bgmq.a(obz.a(), true, false).getString("kandian_push_0x210_msg_for_follow_show_in_folder", ""), 1));
  }
  ...
  public String a()
  {
    return bakz.a(this.jdField_a_of_type_ArrayOfByte);
  }
