...
public class auwl
{
  ...
  public auwl(int paramInt)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static auwl a(appoint_define.InterestTag paramInterestTag)
  {
    auwl localauwl = null;
    if (paramInterestTag != null)
    {
      localauwl = new auwl(paramInterestTag.uint32_tag_type.get());
  ...
  public static auwl a(JSONObject paramJSONObject)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      if (i < paramJSONObject.length())
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            localauwl.jdField_a_of_type_JavaUtilArrayList.add(localObject);
            break label140;
            label114:
            localObject = null;
          }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!bdal.a(this.jdField_a_of_type_JavaUtilArrayList.get(i), paramObject.jdField_a_of_type_JavaUtilArrayList.get(i))) {
        break;
      }
      i += 1;
    }
