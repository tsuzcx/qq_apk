...
public final class akzh
{
  ...
  {
    vyi.a(BaseApplicationImpl.getContext(), paramFile);
  }
  ...
  {
    bbjn.a(BaseApplicationImpl.getApplication().getSharedPreferences("ARRecordUtils_AR", 4).edit().putBoolean("ARVideoRecordPressKey12", paramBoolean));
  }
