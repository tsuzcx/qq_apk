...
{
  akzh(akyh paramakyh, String paramString, Long paramLong, int paramInt) {}
  
  public void onClick(View paramView)
  {
    if (!akyh.a(this.jdField_a_of_type_Akyh)) {}
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      akyh.a(this.jdField_a_of_type_Akyh, false);
      new Handler().postDelayed(new BannerManager.30.1(this), 1000L);
      Object localObject1 = (QQAppInterface)akyh.a(this.jdField_a_of_type_Akyh).getAppRuntime();
      ...
      ((StringBuilder)localObject2).append("&version=8.4.1.4680");
      ...
      VasWebviewUtil.openQQBrowserActivity(akyh.a(this.jdField_a_of_type_Akyh), (String)localObject2, 32768L, localIntent, false, -1);
      ...
      try
      {
        ...
        bcst.a(akyh.a(this.jdField_a_of_type_Akyh).app, "dc00898", "", "", "0X8009EE3", "0X8009EE3", 9, 0, "", "", "", "");
      }
