...
final class akzh
  implements akzo
{
  akzh(akji paramakji, int[] paramArrayOfInt, AppInterface paramAppInterface, akzo paramakzo, boolean paramBoolean, int paramInt) {}
  ...
  public void onDownLoadFinish(boolean paramBoolean, String paramString, int paramInt1, int[] paramArrayOfInt, int paramInt2)
  {
    if (paramBoolean)
    {
      ...
      {
        localFile = new File(akzg.a(1, paramInt1), "dress.zip");
        if (!localFile.exists()) {}
      }
      try
      {
        paramArrayOfInt = alef.f;
        if (paramInt1 == 0) {
          paramArrayOfInt = alef.c + "/def/dress/";
        }
        new File(paramArrayOfInt).mkdirs();
        ndr.a(localFile, paramArrayOfInt);
        paramArrayOfInt = akzg.a(paramInt1);
        if ((paramArrayOfInt != null) && (paramArrayOfInt.length > 0))
        {
          ...
          while (i < j)
          {
            ...
            akzg.a(this.jdField_a_of_type_Akji, 2, k);
            i += 1;
          }
        }
      ...
      catch (OutOfMemoryError paramArrayOfInt)
      {
        ...
        this.jdField_a_of_type_Akzo.onDownLoadFinish(true, paramString, this.jdField_a_of_type_Int, this.jdField_a_of_type_ArrayOfInt, paramInt2);
        return;
      }
      if ((this.jdField_a_of_type_ArrayOfInt != null) && (this.jdField_a_of_type_ArrayOfInt.length > 0)) {
        akzg.b(this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramString, this.jdField_a_of_type_Akzo, -1, this.jdField_a_of_type_ArrayOfInt, -1, -1, this.jdField_a_of_type_Boolean);
      }
    }
    do
    {
      ...
      if (this.jdField_a_of_type_Akzo != null) {
        this.jdField_a_of_type_Akzo.onDownLoadFinish(false, paramString, this.jdField_a_of_type_Int, this.jdField_a_of_type_ArrayOfInt, paramInt2);
      }
