  ...
  implements Serializable
{
  ...
  private static CARDSETTYPE[] a = new CARDSETTYPE[5];
  ...
  public static CARDSETTYPE convert(int paramInt)
  {
    ...
    for (;;)
    {
      CARDSETTYPE[] arrayOfCARDSETTYPE = a;
      if (i >= arrayOfCARDSETTYPE.length) {
        break;
      }
      if (arrayOfCARDSETTYPE[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static CARDSETTYPE convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfCARDSETTYPE[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
