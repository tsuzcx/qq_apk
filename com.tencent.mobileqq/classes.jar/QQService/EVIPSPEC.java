  ...
  implements Serializable
{
  ...
  private static EVIPSPEC[] a = new EVIPSPEC[7];
  ...
  public static EVIPSPEC convert(int paramInt)
  {
    ...
    for (;;)
    {
      EVIPSPEC[] arrayOfEVIPSPEC = a;
      if (i >= arrayOfEVIPSPEC.length) {
        break;
      }
      if (arrayOfEVIPSPEC[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static EVIPSPEC convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfEVIPSPEC[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
