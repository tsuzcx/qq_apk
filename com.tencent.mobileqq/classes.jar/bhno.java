...
public class bhno
{
  private static final bhmt<bhno, Void> jdField_a_of_type_Bhmt = new bhnp();
  private LinkedHashMap<Long, WebAppIpRecord> jdField_a_of_type_JavaUtilLinkedHashMap;
  
  public static bhno a()
  {
    return (bhno)jdField_a_of_type_Bhmt.b(null);
  }
  
  private File a()
  {
    File localFile = new File(bhcg.n() + File.separator + "webapp_iplist");
    if (!localFile.exists())
    {
  ...
  public void a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 159	bhno:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   8: ifnull +17 -> 25
    //   11: aload_0
    //   12: getfield 159	bhno:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   49: aload_0
    //   50: getfield 159	bhno:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   92: aload_0
    //   93: aload_0
    //   94: getfield 159	bhno:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   97: iload_2
    //   98: sipush 1000
    //   101: imul
    //   102: i2l
    //   103: invokespecial 191	bhno:a	(Ljava/util/LinkedHashMap;J)Ljava/util/LinkedHashMap;
    //   106: astore 8
    //   108: aload 6
    //   110: astore 5
    ...
    //   506: astore 5
    //   508: aload_0
    //   509: invokespecial 277	bhno:a	()Ljava/io/File;
    //   512: astore 8
    //   514: aload 8
    //   516: ifnull +91 -> 607
    //   519: aload 6
  ...
  public void b()
  {
    ...
    //   19: invokestatic 39	bhcg:n	()Ljava/lang/String;
    ...
    //   78: pop
    //   79: aload 4
    //   81: invokestatic 314	bhoh:a	(Ljava/io/File;)Z
    //   84: pop
    //   85: aload 5
    //   87: ifnonnull +39 -> 126
    //   90: aload_3
    ...
    //   388: invokestatic 360	bhms:c	(ILjava/lang/String;)V
    //   391: goto -83 -> 308
    //   394: astore_3
    //   395: aload_3
    ...
    //   510	71	4	localObject9	Object
    //   60	317	5	localObject10	Object
    ...
    //   584	13	5	localObject13	Object
    //   4	570	6	localObject14	Object
    //   1	586	7	localObject15	Object
