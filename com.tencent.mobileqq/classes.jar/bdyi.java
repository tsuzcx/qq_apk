  ...
  implements Manager
{
  ...
  bdvu jdField_a_of_type_Bdvu = new bdyn(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public bdyi(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bdcs.a(len.f(), new StringBuffer("config.json"), localInputStream);
      }
  ...
  public static VipFullScreenVideoView a(Activity paramActivity, RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    {
      return null;
      localView = paramActivity.getLayoutInflater().inflate(2131562806, null);
      localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
      localLayoutParams.addRule(13);
    } while (paramActivity.isFinishing());
    paramRelativeLayout.addView(localView, 0, localLayoutParams);
    return (VipFullScreenVideoView)localView.findViewById(2131379545);
  }
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    } while (bdcs.a(paramString2));
    String str = b(paramAppRuntime, paramInt2, 8, null);
    paramString2 = new Bundle();
    paramString1 = new bdvv(str, paramString1);
    ((bdvx)paramAppRuntime.getManager(47)).a(1).a(paramString1, null, paramString2);
  }
  
  public static boolean a()
  {
    return new File(bdyh.jdField_a_of_type_JavaLangString).exists();
  }
  
  public static boolean a(Context paramContext, VideoView paramVideoView, String paramString, int paramInt1, bdyo parambdyo, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramContext.exists()) && (!paramVideoView.isPlaying()))
    {
      ...
      if (paramInt1 == 6)
      {
        paramVideoView.setOnTouchListener(new bdyj());
        paramVideoView.setVideoPath(paramContext.getAbsolutePath());
        paramVideoView.requestFocus();
        paramVideoView.setVisibility(0);
        paramVideoView.setOnPreparedListener(new bdyk(parambdyo));
        paramVideoView.setOnCompletionListener(new bdyl(paramVideoView));
        paramVideoView.setOnErrorListener(new bdym(paramInt2, parambdyo, paramVideoView, paramBoolean));
        return true;
      }
      if (paramInt1 == 7)
      {
        paramContext = bcwc.a(paramString);
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bdqr.a("externalStorageType", paramString, i + "_t", l2 + "", bool + "", l2 + "", bool + "_p", "", "", "");
        return bool;
      }
      catch (Exception paramContext)
      {
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    for (int i = 0;; i = paramInt2)
    {
      ...
      if (bool)
      {
        ...
        localObject = new bdvv(str1, (File)localObject);
        ((bdvv)localObject).a(3);
        ((bdvv)localObject).jdField_a_of_type_Int = 0;
        ((bdvv)localObject).a(localBundle);
        this.jdField_a_of_type_Bdvu.onDone((bdvv)localObject);
        return;
        label519:
        bool = false;
        break label298;
      ...
      if (i == 0)
      {
        label530:
        localObject = new bdvv(str1, (File)localObject);
        ((bdvv)localObject).jdField_a_of_type_Byte = 1;
        ((bdvv)localObject).jdField_e_of_type_Long = 5242880L;
        ((bdvv)localObject).jdField_e_of_type_JavaLangString = jdField_a_of_type_JavaLangString;
      ...
      {
        ((bdvv)localObject).l = paramBoolean;
        if (7 != paramInt2) {
          ((bdvv)localObject).b = true;
        }
        this.jdField_a_of_type_Bdvx.a(1).a((bdvv)localObject, this.jdField_a_of_type_Bdvu, localBundle);
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, bdwb parambdwb)
  {
    ...
    if (paramInt2 != 0)
    {
      bdnv localbdnv = (bdnv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(45);
      localbdnv.jdField_a_of_type_Bdwb = parambdwb;
      localbdnv.a(paramInt2, 3, paramBoolean, paramInt3, "comering");
    }
    if (i == 6) {
