  ...
  implements bhwo
{
  ...
  private MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new agit(this);
  public FragmentActivity a;
  private View jdField_a_of_type_AndroidViewView;
  public ViewGroup a;
  private bhwo jdField_a_of_type_Bhwo = new agiv(this);
  ...
  public agis(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetDrawerFrame.setDrawerCallbacks(this.jdField_a_of_type_Bhwo);
    m();
  ...
  {
    boolean bool = true;
    if ((ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null)) || (bcnj.b())) {
      bool = false;
    }
    return bool;
  }
  ...
  private void m()
  {
    ...
    if (localNavBarAIO != null) {
      localNavBarAIO.addOnLayoutChangeListener(new agiu(this, localNavBarAIO));
    }
  }
