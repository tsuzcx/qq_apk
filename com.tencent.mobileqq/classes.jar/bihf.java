...
public class bihf
{
  public static final LruCache<String, bihf> a;
  public static final AtomicInteger c = new AtomicInteger(1);
  public String a;
  public final CopyOnWriteArrayList<bihi> a;
  ...
  /* Error */
  public static bihf a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   60: astore_0
    //   61: aload_0
    //   62: invokestatic 90	bihf:b	(Ljava/lang/String;)Lbihf;
    //   65: astore_2
    //   66: goto -52 -> 14
    //   69: astore_0
    //   70: aload_0
  ...
  public static bihf b(String paramString)
  {
    ...
    try
    {
      ...
      {
        bihf localbihf = (bihf)jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
        localObject = localbihf;
        if (localbihf == null)
        {
          localObject = new bihf(paramString);
  ...
  public void a(bihi parambihi, String paramString)
  {
    if ((this.b.get() == 3) && (parambihi != null))
    {
      ...
      parambihi.onCheckOfflineFinish(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
    }
    do
    {
      return;
      if ((parambihi != null) && (!this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(parambihi))) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambihi);
      }
      parambihi = new SwiftBrowserOfflineHandler.1(this, paramString);
    ...
    ThreadManager.postImmediately(parambihi, new bihh(this), false);
  }
  ...
  public void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Nro.a("ex_offline", "");
