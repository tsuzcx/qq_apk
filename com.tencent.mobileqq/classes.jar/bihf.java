  ...
  extends WebViewPlugin
{
  ...
  public bihf()
  {
    ...
    this.jdField_a_of_type_Aser = new bihg(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      do
      {
          ...
          for (;;)
          {
            try
            {
              ...
              if (paramString1.has("callback"))
              {
                ...
                paramJsBridgeListener = asev.a("ipc_video_isinstalled", paramJsBridgeListener, this.jdField_a_of_type_Aser.key, paramString1);
        ...
        paramString1 = new Bundle();
        paramJsBridgeListener = asev.a("ipc_video_install_plugin", paramJsBridgeListener, this.jdField_a_of_type_Aser.key, paramString1);
        asjw.a().a(paramJsBridgeListener);
        return true;
        bool1 = bool2;
