  ...
  implements ogv
{
  ...
  private ViewPager.OnPageChangeListener jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new nig(this);
  private View jdField_a_of_type_AndroidViewView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private bekd jdField_a_of_type_Bekd;
  private TabChannelCoverInfo jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo;
  ...
  private Map<Integer, pov> jdField_a_of_type_JavaUtilMap = new HashMap();
  private nhi jdField_a_of_type_Nhi;
  private nih jdField_a_of_type_Nih;
  private ogy jdField_a_of_type_Ogy;
  private ohe jdField_a_of_type_Ohe = new nif(this);
  private ohx jdField_a_of_type_Ohx = new nie(this);
  ...
  static
  {
    ...
    jdField_b_of_type_Int = bajq.b(0.0F);
    jdField_c_of_type_Int = bajq.b(0.0F);
    jdField_a_of_type_Long = bgmq.g(obz.a());
  }
  
  public nia(Context paramContext, View paramView, ReadInJoyChannelViewPager paramReadInJoyChannelViewPager)
  {
    ...
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout = ((TabLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131311014));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131302990));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131303038));
  ...
  private void a(int paramInt1, float paramFloat, int paramInt2)
  {
    ...
    {
      localView2 = localViewGroup.findViewById(2131302725);
      paramInt2 = 0;
      if (paramInt1 != i - 1) {
        break label274;
      }
  ...
  public static void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      paramString = new ocg().b().f().a(paramInt1).b(paramInt2 + 1).d(paramString);
      if (paramInt1 == 41695)
      {
        localObject = ogy.a().a();
        if (localObject != null)
  ...
  private void a(View paramView1, View paramView2)
  {
    ...
    paramView1 = (TextView)paramView1.findViewById(2131312553);
    paramView2 = (TextView)paramView2.findViewById(2131312553);
    a(paramView1);
    b(paramView2);
  }
  ...
  {
    paramTextView.setTextColor(paramTextView.getResources().getColor(2131101156));
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    ndn.a(null, "", paramString1, paramString1, 0, 0, paramString2, "", "", paramString3, false);
  }
  ...
  private void a(List<TabChannelCoverInfo> paramList)
  {
    ...
    if (this.jdField_a_of_type_Nih != null)
    {
      ...
      this.jdField_a_of_type_Nih.a(paramList);
    }
    ThreadManager.executeOnSubThread(new ReadInJoyChannelViewPagerController.2(this));
    k();
    l();
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo != null) && (a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo.mChannelCoverId) != null)) {
      c(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo.mChannelCoverId);
    }
    for (;;)
    {
  ...
  private void a(Map<Integer, pov> paramMap)
  {
    if (paramMap != null)
    {
      ...
      if (paramMap.hasNext())
      {
        ...
        int j = nti.jdField_b_of_type_Int;
        ...
        for (int i = localpov.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo.redPoint.jdField_a_of_type_Int + 1;; i = 0)
        {
          nti.a("0X8009495", localTabChannelCoverInfo, j, i, localpov.l);
          break;
        }
      }
    }
  ...
  {
    paramTextView.setTextColor(paramTextView.getResources().getColor(2131101157));
  ...
  private void b(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    KandianSubscribeManager localKandianSubscribeManager = (KandianSubscribeManager)obz.a().getManager(280);
    prk localprk = new prk();
    localprk.jdField_a_of_type_Long = 0L;
    localprk.b = 9223372036854775807L;
    localprk.jdField_a_of_type_Boolean = localKandianSubscribeManager.a();
    paramTabChannelCoverInfo.redPoint = localprk;
    a(paramTabChannelCoverInfo);
  }
  
  private void b(List<TabChannelCoverInfo> paramList)
  {
    List localList = this.jdField_a_of_type_Ogy.a();
    if ((localList != null) && (localList.size() > 0))
    {
      ((pox)localList.get(0)).jdField_a_of_type_JavaUtilList = paramList;
      this.jdField_a_of_type_Ogy.a(localList, 1, true);
    }
  ...
  private int d()
  {
    List localList = this.jdField_a_of_type_Ogy.b();
    int k;
    if ((localList == null) || (localList.size() == 0))
    {
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_Qsz = new qsz(this.jdField_b_of_type_AndroidViewView.getContext(), this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentBizWidgetsTabLayout, this);
    this.jdField_a_of_type_JavaUtilMap.clear();
    this.jdField_a_of_type_Qsz.a(this.jdField_a_of_type_JavaUtilMap);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.setAdapter(this.jdField_a_of_type_Qsz);
    ...
    ohs.a(this.jdField_a_of_type_Ohx);
  }
  ...
  private void h()
  {
    Object localObject = (ohd)obz.a().getManager(163);
    List localList;
    if (localObject != null)
    {
  ...
  {
    if (odi.a()) {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848189);
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Nhi != null) {
        this.jdField_a_of_type_Nhi.d();
      }
      return;
  ...
  private void j()
  {
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new nib(this));
  }
  ...
  private void m()
  {
    ...
    int k = (int)(babp.m() - i) / 2 - bajq.a(12.0F);
    i = 200;
    ...
    if (this.jdField_a_of_type_Bekd == null) {
      this.jdField_a_of_type_Bekd = new nid(this);
    }
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.setOnScrollStateChangedListener(this.jdField_a_of_type_Bekd);
  ...
  private void n()
  {
    Object localObject = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo;
    if (localObject != null)
    {
  ...
  public void C_()
  {
    ...
    prk localprk = new prk();
    localprk.jdField_a_of_type_Boolean = true;
    localprk.jdField_a_of_type_Long = 0L;
    localprk.b = 9223372036854775807L;
    localTabChannelCoverInfo.redPoint = localprk;
    a(localTabChannelCoverInfo);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.a();
  }
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      localObject = new ocg().a("source", "302").a(((TabChannelCoverInfo)localObject).mChannelCoverId);
      if (!nhi.a()) {
        break label374;
      }
      i = 1;
    ...
    catch (JSONException localJSONException1)
    {
      try
      {
        for (;;)
        {
          a("0X8009665", "", obz.a().a(((TabChannelCoverInfo)localObject).mChannelCoverId).m(ReadInJoyChannelPanelFragment.a((ChannelCoverInfo)localObject)).n(ReadInJoyChannelPanelFragment.a((TabChannelCoverInfo)localObject)).a());
          bool = bgmq.z();
          if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_JavaUtilList.size())) {
            break label427;
          }
    ...
    a("0X8009B94", "", ((ocg)localObject).b("style", i).a());
    if (b() == paramInt)
    {
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = (ohd)obz.a().getManager(163);
      } while (localObject == null);
      localObject = ((ohd)localObject).a();
    } while (localObject == null);
    if (obz.j())
    {
      ((ogy)localObject).a(paramTabChannelCoverInfo);
      return;
    }
    obz.b().post(new ReadInJoyChannelViewPagerController.3(this, (ogy)localObject, paramTabChannelCoverInfo));
  }
  
  public void a(nhi paramnhi)
  {
    this.jdField_a_of_type_Nhi = paramnhi;
  }
  
  public void a(nih paramnih)
  {
    if (paramnih != null) {
      paramnih.a(a(this.jdField_a_of_type_JavaUtilList));
    }
    this.jdField_a_of_type_Nih = paramnih;
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (i > 0)
      {
        ...
        this.jdField_a_of_type_Ogy.a(localTabChannelCoverInfo.mChannelCoverId, 5, false, false);
        i -= 1;
      }
  ...
  public void e()
  {
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo = null;
    jdField_a_of_type_JavaUtilHashMap.clear();
    jdField_b_of_type_JavaUtilHashMap.clear();
    this.jdField_a_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_Qsz = new qsz(this.jdField_b_of_type_AndroidViewView.getContext(), this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentBizWidgetsTabLayout, this);
