...
public class bkwe
{
  ...
  public static void a(Bundle paramBundle, bkwf parambkwf)
  {
    ArrayList localArrayList = new ArrayList();
    for (Object localObject = parambkwf.getClass(); localObject != null; localObject = ((Class)localObject).getSuperclass()) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (str2.equals("String")) {
            ((Field)localObject).set(parambkwf, str3);
          }
        }
