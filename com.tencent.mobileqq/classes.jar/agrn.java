...
public class agrn
  implements Runnable
{
  public agrn(ShareHelper paramShareHelper, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4) {}
  ...
  public void run()
  {
    ...
    ShareHelper.a(this.jdField_a_of_type_ComTencentMobileqqPortalShareHelper).runOnUiThread(new agro(this, localBitmap1));
  }
}
