...
public class bpcw
{
  ...
  public bpcw(int paramInt1, int paramInt2, Typeface paramTypeface, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
  ...
  public static bpcw a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, Typeface paramTypeface, bpcg parambpcg)
  {
  ...
  public void a(CharSequence paramCharSequence, bpcg parambpcg)
  {
    a(paramCharSequence, parambpcg, 0);
  }
  
  public void a(CharSequence paramCharSequence, bpcg parambpcg, int paramInt)
  {
    ...
    for (int j = (paramInt - this.e) / (paramCharSequence.length() - 1);; j = 0)
    {
      ...
      while (k < paramCharSequence.length())
      {
        ...
        else
        {
          ...
          if (this.f == 0)
          {
            localbpcp.b = parambpcg.a("", this.c + a(), this.d, 0, 255, new LinearInterpolator());
            label282:
            localbpcp.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject);
            if (k != 0) {
              break label374;
            }
            localbpcp.jdField_a_of_type_Int = paramInt;
          }
          for (paramInt = localbpcp.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + paramInt;; paramInt = localbpcp.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + j + paramInt)
          {
            this.jdField_a_of_type_JavaUtilArrayList.add(localbpcp);
            break;
            localbpcp.b = parambpcg.a("", this.c + this.d * k / paramCharSequence.length(), this.d, 0, 255, new LinearInterpolator());
            break label282;
            label374:
            localbpcp.jdField_a_of_type_Int = (paramInt + j);
          }
        }
      }
      return;
