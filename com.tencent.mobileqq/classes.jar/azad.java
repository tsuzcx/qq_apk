...
public class azad
{
  ...
  public static azae a(YoutuOcr.YoutuOcrRsp paramYoutuOcrRsp)
  {
    ...
    if (paramYoutuOcrRsp.youtu_ocr_errorcode.has())
    {
      ...
      localazae.jdField_a_of_type_Int = i;
      if (!paramYoutuOcrRsp.youtu_ocr_errormsg.has()) {
        break label215;
      }
      localObject = paramYoutuOcrRsp.youtu_ocr_errormsg.get();
      label49:
      localazae.jdField_a_of_type_JavaLangString = ((String)localObject);
      if (paramYoutuOcrRsp.youtu_orc_detail.has())
      {
        ...
        label93:
        localazae.jdField_b_of_type_Int = i;
        if (!((YoutuOcr.YoutuOcrDetail)localObject).errormsg.has()) {
          break label226;
        }
        paramYoutuOcrRsp = ((YoutuOcr.YoutuOcrDetail)localObject).errormsg.get();
        label116:
        localazae.jdField_b_of_type_JavaLangString = paramYoutuOcrRsp;
        if (((YoutuOcr.YoutuOcrDetail)localObject).language.has()) {
          localazae.e = ((YoutuOcr.YoutuOcrDetail)localObject).language.get();
        }
        if (((YoutuOcr.YoutuOcrDetail)localObject).ocr_language_list.has())
        {
          localazae.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          localazae.jdField_a_of_type_JavaUtilArrayList.addAll(((YoutuOcr.YoutuOcrDetail)localObject).ocr_language_list.get());
        }
    ...
    for (paramYoutuOcrRsp = ((YoutuOcr.YoutuOcrDetail)localObject).ocr_item.get();; paramYoutuOcrRsp = null)
    {
      if (paramYoutuOcrRsp != null) {
        localazae.d = a(paramYoutuOcrRsp);
      }
      return localazae;
      i = 0;
      break;
