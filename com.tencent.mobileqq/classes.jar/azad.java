...
public class azad
{
  private static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    if (paramQQAppInterface != null)
    {
      i = j;
      if (localakpc != null) {
        i = localakpc.a(paramQQAppInterface.frienduin, paramQQAppInterface.istroop);
      }
    }
    return i;
  }
  ...
  {
    Object localObject = paramQQAppInterface.a(1001).a(ajsf.aj, 1001);
    if (localObject == null)
    {
  ...
  {
    Object localObject1 = paramQQAppInterface.a(1001).a(ajsf.aj, 1001);
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == ((ArrayList)localObject2).size())
      {
        ...
        paramQQAppInterface.a().a(ajsf.H, 1001, ajsf.aj, paramQQAppInterface.getCurrentAccountUin());
        return;
      }
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramQQAppInterface.a().a(ajsf.aj, 1001, (String)localObject2, paramQQAppInterface.getCurrentAccountUin());
      }
    }
  }
  ...
  {
    int i = 0;
    Object localObject = paramQQAppInterface.a(1001).a(ajsf.H, 1001);
    if (localObject == null)
    {
    ...
    try
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if (ajsf.aj.equals(localMessageRecord.senderuin))
        {
          a(paramQQAppInterface, localJSONObject2);
          break label402;
        }
        if ((!ajsf.al.equals(localMessageRecord.senderuin)) && (!ajsf.am.equals(localMessageRecord.senderuin)) && (!ajsf.an.equals(localMessageRecord.senderuin)) && (!ajsf.ao.equals(localMessageRecord.senderuin)) && (!ajsf.ap.equals(localMessageRecord.senderuin)))
        {
          localArrayList.add(localMessageRecord);
  ...
  public static final void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      default: 
        return;
      case 1: 
        a(paramQQAppInterface, paramString, ajsf.H);
        return;
      }
      a(paramQQAppInterface, paramString, ajsf.aj);
      return;
    }
