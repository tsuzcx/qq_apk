...
public abstract class blhu
{
  ...
  private static final Interpolator sDragScrollInterpolator = new blhv();
  private static final Interpolator sDragViewScrollCapInterpolator = new blhw();
  private static final blic sUICallback = new blie();
  ...
  public static blic getDefaultUIUtil()
  {
    return sUICallback;
  }
  ...
  void onDraw(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<blhy> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      blhy localblhy = (blhy)paramList.get(i);
      localblhy.c();
      int k = paramCanvas.save();
      onChildDraw(paramCanvas, paramRecyclerView, localblhy.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localblhy.e, localblhy.f, localblhy.jdField_b_of_type_Int, false);
  ...
  void onDrawOver(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<blhy> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      blhy localblhy = (blhy)paramList.get(i);
      int k = paramCanvas.save();
      onChildDrawOver(paramCanvas, paramRecyclerView, localblhy.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localblhy.e, localblhy.f, localblhy.jdField_b_of_type_Int, false);
      paramCanvas.restoreToCount(k);
      i += 1;
    }
    if (paramViewHolder != null)
    ...
    if (i >= 0)
    {
      paramCanvas = (blhy)paramList.get(i);
  ...
  public void onMoved(RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder1, int paramInt1, RecyclerView.ViewHolder paramViewHolder2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((localLayoutManager instanceof blib)) {
      ((blib)localLayoutManager).a(paramViewHolder1.itemView, paramViewHolder2.itemView, paramInt3, paramInt4);
    }
    do
    {
      do
