  ...
  extends awoh
{
  ...
  public awne(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt)
  {
    this.jdField_c_of_type_Int = 2131166929;
    this.jdField_f_of_type_Int = -1;
    this.jdField_a_of_type_ArrayOfInt = new int[3];
  ...
  private void a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bdto.a((QQAppInterface)localObject3, this.jdField_i_of_type_Int, this.jdField_b_of_type_JavaLangString);
          bdto.a((QQAppInterface)localObject3, this.jdField_b_of_type_JavaLangString, str1);
          if ((!bdto.b(this.jdField_i_of_type_Int)) && (!bdto.c(this.jdField_i_of_type_Int))) {
            break;
          }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131696445);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = awvm.a(Long.parseLong(((JSONObject)localObject3).optString("create_time")));
  ...
  public CharSequence a()
  {
    ...
    do
    {
      try
      {
        CharSequence localCharSequence = awvy.a(this.jdField_c_of_type_JavaLangString, a(), true);
      ...
      localObject = new awvn(this.jdField_a_of_type_JavaUtilList, a());
      if (d() != 1002) {
        break;
      }
      this.jdField_c_of_type_JavaLangString = awvy.a(this.jdField_c_of_type_JavaLangString);
      localSpannableString = ((awvn)localObject).a(this.jdField_c_of_type_JavaLangString, true);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
    this.jdField_c_of_type_JavaLangString = awvy.a(this.jdField_c_of_type_JavaLangString);
    SpannableString localSpannableString = ((awvn)localObject).a(this.jdField_c_of_type_JavaLangString, true);
    if (((awvn)localObject).jdField_a_of_type_Int > 0) {}
    for (;;)
    {
  ...
  public Object a(String paramString)
  {
    ...
    {
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699597);
      ...
      for (;;)
      {
        ...
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699599);
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699597);
        bool = true;
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699598);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      if ((localObject2 instanceof awin))
      {
        localObject3 = (awin)localObject2;
        if (((awin)localObject3).b()) {}
        localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        localObject1 = ((awin)localObject3).a();
        if (!(localObject1 instanceof awim)) {
          break label2491;
        }
      }
      break;
    ...
    label2485:
    label2491:
    for (Object localObject1 = (awim)localObject1;; localObject1 = null)
    {
      label204:
      Object localObject4;
      switch (((awin)localObject3).a())
      {
      default: 
        if (d() == 268435456)
        {
          awvy.a("all_result", "clk_function", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + this.jdField_b_of_type_JavaLangString, "" + (this.jdField_g_of_type_Int + 1) });
          if (((paramView.getContext() instanceof UniteSearchActivity)) && (awiu.jdField_b_of_type_JavaUtilHashMap.containsKey(this)))
          {
            localObject1 = (awiv)awiu.jdField_b_of_type_JavaUtilHashMap.get(this);
            localObject3 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ...
      do
      {
        try
        {
          for (;;)
          {
            ...
            return;
            awvy.a(this.jdField_a_of_type_JavaLangString, 70, 0, this.jdField_g_of_type_Int, paramView);
            if (this.jdField_l_of_type_Int == 1)
            {
              axqw.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
              axqw.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 2, 0, "", "", "", "");
              break;
            }
            axqw.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
            axqw.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 1, 0, "", "", "", "");
            break;
            awvy.a(this.jdField_a_of_type_JavaLangString, 80, 0, this.jdField_g_of_type_Int, paramView);
            break;
            awvy.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_JavaLangString, this.jdField_n_of_type_JavaLangString, e(), e());
            awvy.a(this.jdField_a_of_type_JavaLangString, 120, 0, this.jdField_g_of_type_Int, paramView);
            if ((this.jdField_n_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_n_of_type_JavaLangString)))
            {
              awso.a(null, 0, this.jdField_a_of_type_Int, "0X8009D31", 4, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            ...
            {
              awso.a(null, 0, this.jdField_a_of_type_Int, "0X8009D35", 0, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            awso.a(null, 0, this.jdField_a_of_type_Int, "0X8009D49", 0, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
            QQAppInterface localQQAppInterface;
            JSONObject localJSONObject;
            if ((awiu.jdField_b_of_type_JavaUtilHashMap.containsKey(this)) && (d() != 268435456))
            {
              localObject4 = (awiv)awiu.jdField_b_of_type_JavaUtilHashMap.get(this);
            ...
            try
            {
              ...
              localJSONObject.put("obj_lct", ((awiv)localObject4).jdField_a_of_type_Int);
              localJSONObject.put("get_src", "web");
              awso.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(((awiv)localObject4).jdField_b_of_type_JavaLangString).ver1(this.jdField_a_of_type_JavaLangString).ver2(awso.a(this.jdField_a_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + awiu.jdField_a_of_type_Long));
              if (awvy.a(this.jdField_a_of_type_Long)) {
                if (awiu.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
                {
                  localObject4 = (awiv)awiu.jdField_a_of_type_JavaUtilHashMap.get(this);
                  if (((awiv)localObject4).jdField_b_of_type_Boolean)
                  {
                    i1 = 2;
                    awvy.a("all_result", "clk_object", i1, 0, new String[] { this.jdField_a_of_type_JavaLangString, "" + this.jdField_a_of_type_Long, ((awiv)localObject4).jdField_b_of_type_JavaLangString + "", ((awiv)localObject4).jdField_a_of_type_Int + "" });
                  }
                }
                else
                {
                  if ((localObject1 == null) || (!((awim)localObject1).b())) {
                    break label204;
                  }
                  ((awim)localObject1).a(true);
                  awvy.a("all_result", "clk_first_result", new String[] { ((awin)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(3), awvy.a("dynamic_tab_search.1", ((awin)localObject3).a()) });
                }
              }
            }
            catch (JSONException localJSONException2)
            {
              ...
              if (awiu.jdField_b_of_type_Boolean) {}
              for (i1 = 2;; i1 = 1)
              {
                awvy.a("all_result", "clk_content", i1, 0, new String[] { ((awin)localObject3).a(), "" + this.jdField_a_of_type_Long, "", awvy.a("dynamic_tab_search.1", ((awin)localObject3).a()) });
                if ((localObject1 == null) || (!((awim)localObject1).b())) {
                  break;
                }
                ((awim)localObject1).a(true);
                awvy.a("all_result", "clk_first_result", new String[] { ((awin)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awvy.a("dynamic_tab_search.1", ((awin)localObject3).a()) });
                break;
              }
            }
          }
          ...
          {
            ((awim)localObject1).a(true);
            awvy.a("all_result", "clk_tab_first_result", new String[] { ((awin)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awvy.a("dynamic_tab_search.1", ((awin)localObject3).a()) });
          }
          awvy.a("all_result", "clk_tab_result", new String[] { ((awin)localObject3).a(), "" + this.jdField_a_of_type_Long, "", awvy.a("dynamic_tab_search.1", ((awin)localObject3).a()) });
          break label204;
          if ((localObject1 != null) && (((awim)localObject1).b()))
          {
            ((awim)localObject1).a(true);
            awvy.a("sub_result", "clk_sub_first_result", new String[] { ((awin)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awvy.a("dynamic_tab_search.1", ((awin)localObject3).a()) });
          }
          awvy.a("sub_result", "clk_result", new String[] { ((awin)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awvy.a("dynamic_tab_search.1", ((awin)localObject3).a()) });
        }
        catch (JSONException localJSONException1)
        {
          for (;;)
          ...
          {
            paramView = bbej.a(((BaseActivity)paramView.getContext()).app, (Context)localObject2, this.jdField_e_of_type_JavaLangString);
            if (paramView != null)
            {
              paramView.c();
              return;
        ...
        {
          awvy.a(paramView.getContext(), Integer.valueOf(this.jdField_b_of_type_JavaLangString).intValue(), this.jdField_a_of_type_Int);
          return;
        }
        if (this.jdField_a_of_type_Long == 1001L)
        {
          ...
          if (bahx.b((QQAppInterface)localObject1, this.jdField_b_of_type_JavaLangString))
          {
      ...
      for (i2 = 113;; i2 = 104)
      {
        ...
        bamn.a(paramView.getContext(), (Bundle)localObject1, 2);
        return;
      }
    }
  }
  ...
  {
    Object localObject = new awvn(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_g_of_type_JavaLangString = awvy.a(this.jdField_g_of_type_JavaLangString);
    SpannableString localSpannableString = ((awvn)localObject).a(this.jdField_g_of_type_JavaLangString);
    localObject = localSpannableString;
    if (localSpannableString == null) {
      localObject = "";
    }
  ...
  {
    boolean bool = false;
    awvn localawvn = new awvn(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_a_of_type_JavaLangCharSequence = awvy.a(this.jdField_a_of_type_JavaLangCharSequence);
    SpannableString localSpannableString = localawvn.a(this.jdField_a_of_type_JavaLangCharSequence, false, false, false);
    if (localawvn.jdField_a_of_type_Int > 0) {
      bool = true;
    }
    this.h = bool;
    if (localSpannableString == null) {
  ...
  public CharSequence d()
  {
    ...
    {
      return localObject;
      localSpannableString = new awvn(this.jdField_a_of_type_JavaUtilList, a()).a(this.jdField_b_of_type_JavaLangCharSequence, false, this.jdField_a_of_type_Boolean);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
  }
