...
public class aowe
{
  public static int a(String paramString)
  {
    try
    {
      int i = aovv.a("arsdk2", a(), aovv.b("arsdk2", a(), "arsdk2"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aovv.a("arsdk2", a(), "arsdk2", paramString2);
        try
        {
          aovr.a(paramString1, aovv.a("arsdk2", a(), aovv.b("arsdk2", a(), "arsdk2")));
          paramString2 = aovv.a("arsdk2", a(), aovv.b("arsdk2", a(), "arsdk2")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bgmg.a(aovv.a("arsdk2", a(), aovv.b("arsdk2", a(), "arsdk2")), false);
      ...
      try
      {
        ...
        {
          paramString1 = aovv.a("arsdk2", a(), aovv.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          aovv.a("arsdk2", a(), "libAlphaAR", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(aovv.a("arsdk2", a(), aovv.b("arsdk2", a(), "arsdk2")) + File.separator + "libAlphaAR" + ".so").exists();
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        String str = aovv.a("arsdk2", a(), aovv.b("arsdk2", a(), "arsdk2")) + File.separator + paramString + ".so";
        ...
        if (((File)localObject).exists())
        {
          paramString = aovv.b("arsdk2", a(), paramString);
          localObject = azby.a(str);
