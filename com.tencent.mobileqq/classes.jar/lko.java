  ...
  implements Handler.Callback
{
  ...
  Comparator<lkq> jdField_a_of_type_JavaUtilComparator = new lkp(this);
  private final ConcurrentHashMap<ChatRoomInfo, ConcurrentLinkedQueue<lkq>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private final ConcurrentLinkedQueue<lkr> b = new ConcurrentLinkedQueue();
  
  public lko(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private ChatRoomInfo a(chatroom_sso.RoomKey paramRoomKey)
  {
    ...
    int i = ((lga)localObject1).d();
    long l5 = ((lga)localObject1).a();
    long l3 = ((lga)localObject1).b();
    long l4 = ((lga)localObject1).e();
    long l2 = l4;
    long l1 = l3;
    Object localObject2;
    if (i == paramRoomKey.type.get())
    {
      ...
      if (l5 == paramRoomKey.id.get())
      {
        ...
        if (localObject2 != null) {
          ((VideoController)localObject2).a("pushMsg", (lga)localObject1);
        }
        l1 = ((lga)localObject1).b();
        l2 = ((lga)localObject1).e();
      }
    }
    if ((i == paramRoomKey.type.get()) && (l5 == paramRoomKey.id.get()) && (l1 == paramRoomKey.room_id.get()) && (l2 == paramRoomKey.create_ts.get())) {}
    for (localObject1 = a((lga)localObject1);; localObject1 = null)
    {
  ...
  private ConcurrentLinkedQueue<lkq> a(ChatRoomInfo paramChatRoomInfo)
  {
  ...
  private void a(lkq paramlkq)
  {
    if ((paramlkq == null) || (paramlkq.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo == null)) {}
    ChatRoomInfo localChatRoomInfo;
    do
    {
      return;
      localChatRoomInfo = paramlkq.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo;
      long l1 = 0L;
      try
      {
      ...
      l2 = AudioHelper.b();
      if (QLog.isColorLevel()) {
        QLog.i("ChatRoomMng", 2, "sendMsg, seq[" + l2 + "], room[" + localChatRoomInfo + "], msg[" + paramlkq + "]");
      }
      paramlkq.a();
      ...
      localMsg.msg.set(paramlkq.jdField_a_of_type_JavaLangString);
      localMsg.uin.set(l1);
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication(), ldz.class);
      ...
      ((NewIntent)localObject).putExtra("localSeq", paramlkq.jdField_b_of_type_Long);
      mtj.a((Intent)localObject, l2);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
    } while (paramlkq.e != lkq.jdField_a_of_type_Int);
    a(1, localChatRoomInfo);
  }
  
  private void b(lkq paramlkq)
  {
    if (!this.jdField_a_of_type_AndroidOsHandler.hasMessages(2, paramlkq))
    {
      Message localMessage = Message.obtain();
      localMessage.what = 2;
      localMessage.obj = paramlkq;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(localMessage);
    }
  }
  ...
  public ChatRoomInfo a(lga paramlga)
  {
    ChatRoomInfo localChatRoomInfo = a(paramlga, true);
    Object localObject;
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (paramlga != null)) {
        QLog.i("ChatRoomMng", 4, "enterChatRoom, SessionType[" + paramlga.jdField_d_of_type_Int + "], relationType[" + paramlga.E + "], relationId[" + paramlga.g + "], peerUin[" + paramlga.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlga.f + "], isDoubleVideoMeeting[" + paramlga.I + "], room[" + localChatRoomInfo + "]");
      }
      return localChatRoomInfo;
      label189:
  ...
  public ChatRoomInfo a(lga paramlga, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (localChatRoomInfo2 == null)
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            QLog.i("ChatRoomMng", 4, "getRoomInfo, SessionType[" + paramlga.jdField_d_of_type_Int + "], relationType[" + paramlga.E + "], relationId[" + paramlga.g + "], peerUin[" + paramlga.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlga.f + "], isDoubleVideoMeeting[" + paramlga.I + "], type[" + i + "], roomID[" + l2 + "], id[" + l5 + "], createTime[" + l1 + "], room[" + localChatRoomInfo1 + "]");
            localObject = localChatRoomInfo1;
          }
        }
      }
  ...
  public lkq a(ChatRoomInfo paramChatRoomInfo, long paramLong)
  {
    if (paramChatRoomInfo == null) {
      return null;
    }
    ...
    if ((paramChatRoomInfo != null) && (paramChatRoomInfo.size() > 0))
    {
      ...
      do
      {
        ...
        paramChatRoomInfo = (lkq)localIterator.next();
          ...
          do
          {
            do
            {
              do
              {
                ...
                for (;;)
                {
                  ...
                  catch (InvalidProtocolBufferMicroException paramArrayOfByte)
                  {
                    try
                    {
                      ...
                      ((lkq)localObject2).a(lkq.jdField_b_of_type_Int);
                      b((lkq)localObject2);
                      if (!((lkq)localObject2).b()) {
                        break;
                      }
                ...
                ((lkq)localObject2).jdField_d_of_type_Long = l1;
                ((lkq)localObject2).a(lkq.jdField_c_of_type_Int);
                b((lkq)localObject2);
              ...
              } while ((((ChatRoomInfo)localObject1).jdField_b_of_type_Boolean) || (TextUtils.isEmpty(((lkq)localObject2).jdField_a_of_type_JavaLangString)) || (((lkq)localObject2).jdField_a_of_type_JavaLangString.indexOf('\024') < 0));
              lks.a("0X800A8D5");
  ...
  public void a(VideoController paramVideoController, lga paramlga)
  {
    ChatRoomInfo localChatRoomInfo2 = a(paramlga, false);
    boolean bool = paramVideoController.a("onSwitchTerminalSuccess", paramlga);
    ChatRoomInfo localChatRoomInfo1 = a(paramlga, false);
    paramVideoController = localChatRoomInfo1;
    if (localChatRoomInfo1 == null) {
      paramVideoController = a(paramlga);
    }
    if (paramVideoController != null)
    {
      ...
      paramlga = Message.obtain();
      paramlga.obj = paramVideoController;
      paramlga.what = 3;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramlga);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, String paramString, long paramLong)
  {
    ...
    paramString = new lkq(paramChatRoomInfo, l1, paramString, paramLong, -9223372036854775808L, lkq.jdField_a_of_type_Int);
    a(paramChatRoomInfo).add(paramString);
    a(paramString);
  }
  
  public void a(ChatRoomInfo paramChatRoomInfo, List<lkq> paramList)
  {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, chatroom_sso.Msg paramMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        locallkq = (lkq)localIterator.next();
        if (locallkq != null) {
          if (locallkq.a(paramMsg))
          {
            bool = true;
            locallkq.jdField_c_of_type_Long = paramMsg.msg_time.get();
            locallkq.a(lkq.jdField_d_of_type_Int);
          }
        }
      }
    }
    for (;;)
    {
      ...
      {
        bool = true;
        ((lkq)localObject).jdField_d_of_type_Long = paramMsg.msg_id.get();
        ((lkq)localObject).jdField_c_of_type_Long = paramMsg.msg_time.get();
        ((lkq)localObject).a(lkq.jdField_d_of_type_Int);
        label140:
        if (!bool)
        {
          localObject = new lkq(paramChatRoomInfo, paramMsg.uin.get(), paramMsg.msg.get(), paramMsg.msg_time.get(), paramMsg.msg_id.get(), lkq.jdField_d_of_type_Int);
        ...
        else
        {
          ...
          return;
          if ((locallkq.jdField_d_of_type_Long != -9223372036854775808L) || (locallkq.jdField_a_of_type_Long != l) || (!TextUtils.equals(locallkq.jdField_a_of_type_JavaLangString, paramMsg.msg.get()))) {
            break label329;
          }
          localObject = locallkq;
        }
      }
      label320:
      label329:
  ...
  {
    ChatRoomInfo localChatRoomInfo = a(paramlga, false);
    a(localChatRoomInfo);
    if ((QLog.isDevelopLevel()) && (paramlga != null)) {
      QLog.i("ChatRoomMng", 4, "quitChatRoom, SessionType[" + paramlga.jdField_d_of_type_Int + "], relationType[" + paramlga.E + "], relationId[" + paramlga.g + "], peerUin[" + paramlga.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlga.f + "], isDoubleVideoMeeting[" + paramlga.I + "], room[" + localChatRoomInfo + "]");
    }
  }
  
  public void a(lkr paramlkr)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "addObserver, observer[" + paramlkr + "]");
    }
    if ((paramlkr != null) && (!this.b.contains(paramlkr))) {
      this.b.add(paramlkr);
    }
  }
  ...
  public void b(ChatRoomInfo paramChatRoomInfo)
  {
    ...
    mtj.a((Intent)localObject, l);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
  }
  
  public void b(lkr paramlkr)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "removeObserver, observer[" + paramlkr + "]");
    }
    if (paramlkr != null) {
      this.b.remove(paramlkr);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 1)
    {
      ...
      while (localIterator.hasNext())
      {
        locallkr = (lkr)localIterator.next();
        if (locallkr != null) {
          locallkr.a(i, paramMessage);
        }
      }
    }
    if (paramMessage.what == 2)
    {
      paramMessage = (lkq)paramMessage.obj;
      localIterator = this.b.iterator();
      while (localIterator.hasNext())
      {
        locallkr = (lkr)localIterator.next();
        if (locallkr != null) {
          locallkr.a(paramMessage);
        }
      }
    }
