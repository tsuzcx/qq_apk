  ...
  implements bkwz
{
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (muy.a(this.a) != null) {
      muy.a(this.a).a(paramString);
    }
  }
  ...
  public void a(int paramInt, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvVideoController != null)
      {
        ...
        muy.a(this.a, paramArrayOfString);
        muy.a(this.a, paramString2, paramString1);
        if (paramArrayOfString != null)
        {
          ...
          while (paramInt < paramArrayOfString.length)
          {
            if (paramArrayOfString[paramInt].equals("DEVICE_WIREDHEADSET")) {
              msa.k(this.a.jdField_a_of_type_ComTencentAvVideoController);
            }
            paramInt += 1;
          }
        }
  ...
  public void a(long paramLong, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        ...
        paramString2 = "";
        String[] arrayOfString = ((lfe)localObject).a;
        if (((lfe)localObject).c != 3)
        {
          paramString2 = ((lfe)localObject).q;
          ((lfe)localObject).b("onDeviceListUpdate", paramString1);
        }
        ((lfe)localObject).a = paramArrayOfString;
        ((lfe)localObject).r = paramString3;
        muy.a(this.a, paramArrayOfString);
        muy.a(this.a, paramString2, paramString1);
        if (muy.a(this.a) != null) {
          muy.a(this.a).notifyDataSetChanged();
        }
        this.a.a();
      ...
      } while (muy.a(this.a) == null);
      muy.a(this.a).a(null, new mve(paramArrayOfString));
    } while (this.a.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null);
