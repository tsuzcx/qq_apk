  ...
  implements php
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localpdm.a(str1).c(paramBaseArticleInfo, str2).j(paramBaseArticleInfo).r(paramBaseArticleInfo);
        return localpdm.a();
      }
      ...
      try
      {
        localpdm.a("ReadInjoy_QA_NoImage_cell");
      }
      catch (JSONException paramBaseArticleInfo)
      {
        paramBaseArticleInfo.printStackTrace();
  ...
  public void a(int paramInt1, Container paramContainer, pau parampau, int paramInt2)
  {
    ...
    if ((localObject == null) || (parampau == null) || (parampau.a() == null)) {}
    ...
    boolean bool = osg.a().a(parampau.a().mArticleID);
