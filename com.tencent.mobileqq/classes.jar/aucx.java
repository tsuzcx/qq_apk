...
public class aucx
{
  ...
  public static aucx a(MessageForFile paramMessageForFile)
  {
    try
    {
    ...
    catch (Exception localException)
    {
      ...
      return a(auea.a(localQQAppInterface2, paramMessageForFile));
    }
  }
  
  public static aucx a(FileManagerEntity paramFileManagerEntity)
  {
    aucx localaucx = new aucx();
    if ((paramFileManagerEntity == null) && (QLog.isDevelopLevel())) {
      throw new NullPointerException("newFileModel entity is null!");
    }
    localaucx.a = paramFileManagerEntity;
    return localaucx;
  }
  
  public static aucx a(String paramString)
  {
    try
    {
      paramString = a(auea.a(new FileInfo(paramString)));
      return paramString;
    }
  ...
  private void b(Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    for (Object localObject = ((QQAppInterface)localObject).getAccount();; localObject = this.a.peerUin)
    {
      ...
      ((Intent)localObject).putExtra("selfSet_leftViewText", anvx.a(2131704035));
  ...
  public void a(Activity paramActivity, int paramInt)
  {
    if (this.a.nFileType == 2)
    {
      ...
      {
        return;
        if ((this.a.getCloudType() != 1) || (!auea.a()) || (this.a.status == 2) || (this.a.fileSize <= 1048576L)) {
          break;
        }
        localauda = new auda(this, paramActivity, paramInt);
        boolean bool2 = bhyk.a(paramActivity, 2, new audb(this, paramActivity, paramInt), "");
        bool1 = bool2;
        if (bool2) {
          bool1 = bixr.a(paramActivity, 3, new audc(this, paramActivity, paramInt));
        }
      } while (!bool1);
      audn.a(paramActivity, paramActivity.getString(2131692476), paramActivity.getString(2131692478), localauda);
      return;
  ...
  public void a(boolean paramBoolean, Context paramContext, audq paramaudq)
  {
    int j = 2;
    ...
    do
    {
      ...
      i = 3;
      boolean bool2 = bhyk.a(localActivity, i, new aucy(this, paramaudq), "");
      bool1 = bool2;
      if (bool2)
      {
        ...
        i = j;
        bool1 = bixr.a(localActivity, i, new aucz(this, paramaudq));
      }
    } while (!bool1);
    if (paramBoolean) {}
    for (int i = 2131692481;; i = 2131692478)
    {
      audn.a(paramContext, 2131692476, i, paramaudq);
      return;
      bool1 = false;
      break;
      label140:
