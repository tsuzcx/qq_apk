  ...
  extends bdmr
{
  ...
  public bdmu(JSONObject paramJSONObject)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      while (i1 < paramJSONObject.length())
      {
        ...
        {
          localObject = new bdms(l1, ((JSONObject)localObject).optString("name") + amtj.a(2131714115), this.jdField_e_of_type_JavaLangString.replace("${bid}", String.valueOf(l1)));
  ...
  public static ArrayList<bdmu> a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      if (i1 < paramJSONArray.length()) {
        try
        {
          bdmu localbdmu = new bdmu(paramJSONArray.optJSONObject(i1));
          if (localbdmu != null) {
            localArrayList.add(new bdmu(paramJSONArray.optJSONObject(i1)));
          }
          i1 += 1;
        }
