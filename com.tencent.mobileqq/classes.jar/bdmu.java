...
public class bdmu
{
  ...
  public bdmu a(long paramLong)
  {
    this.jdField_a_of_type_Long = paramLong;
    return this;
  }
  
  public bdmu a(boolean paramBoolean)
  {
  ...
  public Pair<ArrayList<String>, ArrayList<String>> a(List<String> paramList, boolean paramBoolean, Map<String, LocalMediaInfo> paramMap1, Map<String, LocalMediaInfo> paramMap2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        {
          int i = bdfa.getMediaType((LocalMediaInfo)localObject);
  ...
  public boolean a(Context paramContext, String paramString, boolean paramBoolean1, Map<String, LocalMediaInfo> paramMap1, Map<String, LocalMediaInfo> paramMap2, boolean paramBoolean2)
  {
    ...
    int i = bdfa.getMediaType(paramMap1);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (paramMap1 = paramContext.getResources().getString(2131689928);; paramMap1 = paramContext.getResources().getString(2131689929))
        {
          ...
          bhta.a(new SendByFile.1(this, paramContext, paramMap1));
