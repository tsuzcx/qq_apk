...
public class aplm
{
  ...
  public static ColorNote a(ColorNote paramColorNote)
  {
    ...
    String str = BaseApplicationImpl.getContext().getString(2131690807);
    int i = paramColorNote.getServiceType();
    return new aple().a(i | 0x80000000).a(paramColorNote.getSubType()).b(0).b(paramColorNote.getMainTitle()).c(str).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).a();
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localQQCustomDialog.setTitle(paramContext.getString(2131690799));
    localQQCustomDialog.setNegativeButton(paramContext.getString(2131690798), new apln(localQQCustomDialog, paramContext));
  ...
  public static ColorNote b(ColorNote paramColorNote)
  {
    ...
    return new aple().a(i).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).a(paramColorNote.getReserve()).a();
  }
  ...
  public static ColorNote c(ColorNote paramColorNote)
  {
    ...
    return new aple().a(paramColorNote.getServiceType()).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).b(paramColorNote.mExtra).a();
  }
