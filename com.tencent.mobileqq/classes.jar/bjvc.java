...
public class bjvc
  extends bjwu
  implements bjsd, bkdn, bkdo, IEventReceiver
{
  ...
  private ViewTreeObserver.OnGlobalLayoutListener jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bjvj(this);
  bjvl jdField_a_of_type_Bjvl;
  bjvm jdField_a_of_type_Bjvm;
  bjvn jdField_a_of_type_Bjvn;
  private bjxi jdField_a_of_type_Bjxi = new bjvd(this);
  public bkbs a;
  bkyu jdField_a_of_type_Bkyu = new bjvf(this);
  ...
  public bjvc(@NonNull bjww parambjww, long paramLong)
  {
    super(parambjww);
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_JavaLangRunnable = new EditVideoDoodle.7(this);
    this.jdField_a_of_type_Bkbs = new bjvk(this);
  ...
  private void j()
  {
    ...
    int i;
    float f;
    if ((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.d()) && (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) && (this.jdField_a_of_type_Bjww.a() != null) && (!this.jdField_a_of_type_Bjww.a().isLandTakePicToVideo()) && ((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
    {
      k = ((EditLocalVideoSource)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.rotation;
      j = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();
      i = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b();
      if ((k == 90) || (k == 270))
      {
        j = Math.min(this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
        i = Math.max(this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
      }
      f = j / i;
      if (!this.jdField_a_of_type_Bjww.a().getTakePicToVideo()) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.b();
      }
      j = axli.jdField_a_of_type_Int;
      i = axli.b;
      if (axli.a(a())) {
        break label328;
      }
  ...
  public JobSegment<bkkm, bkkm> a(int paramInt)
  {
    if (((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource)) || ((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource))) {
      return (JobSegment)sxp.a(bkkx.class, new Object[] { this, (bjse)a(bjse.class), Integer.valueOf(paramInt) });
    }
    return (JobSegment)sxp.a(bkkn.class, new Object[] { this, (bjse)a(bjse.class), Integer.valueOf(paramInt) });
  }
  ...
  public void a()
  {
    ...
    PtvTemplateManager.a(localAppInterface).a(localAppInterface, this.jdField_a_of_type_Bkyu, false);
  ...
  {
    this.jdField_a_of_type_Bjww.a(false, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
  }
  
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    a().a(ajyc.a(2131703770), true, 0L, new bjve(this));
    this.jdField_a_of_type_Bjww.a(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6);
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle != null))
    {
      Bundle localBundle = this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bjzt.jdField_a_of_type_JavaLangString);
      if (localBundle != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(localBundle);
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bkaj.jdField_a_of_type_JavaLangString));
      }
    }
  }
  ...
  public void a(int paramInt, @NonNull bkkm parambkkm)
  {
    ...
    parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoDoodleDescription = a().a(paramInt);
    this.jdField_a_of_type_Bjww.a().setWordId(a().b());
    this.jdField_a_of_type_Bjww.a().setStickerId(a().c());
    parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("all_doodle_text", a().a());
    parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicMask = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(paramInt);
    parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicSize = 16;
    if (a().b(paramInt).size() > 0)
    {
      localObject1 = (bjeu)bjae.a(4);
      parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription = ((bjeu)localObject1).a();
    }
    label280:
    label337:
    int i;
    ...
    else
    {
      if (a().b(paramInt))
      {
        ...
        localObject1 = "2";
        ((bjww)localObject2).a("change_graffiti", 0, 0, new String[] { localObject1 });
        vem.a("0X80076C0");
      }
      if (a().a(paramInt))
      {
        ...
        localObject1 = "2";
        ((bjww)localObject2).a("change_color", 0, 0, new String[] { localObject1 });
        vem.a("0X80076C4");
      }
      ...
      if ((localObject2 != null) && (localObject2.length == 2))
      {
        ...
        localObject3 = this.jdField_a_of_type_Bjww;
        j = this.jdField_a_of_type_Bjww.b();
        if (!this.jdField_a_of_type_Bjww.a()) {
          break label980;
        }
        localObject1 = "2";
        label455:
        ((bjww)localObject3).b("pub_graffiti", j, 0, new String[] { "1", "", localObject1 });
        vem.a("0X80076E0", vem.b);
        vem.b("0X80075EA", vem.jdField_a_of_type_Int);
        parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        parambkkm.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasGraffiti = true;
        label527:
        if (localObject2[1] <= 0) {
          break label1019;
        }
        ...
        localObject1 = "2";
        label564:
        ((bjww)localObject3).b("pub_mosaics", j, 0, new String[] { "1", "", localObject1 });
        vem.a("0X80076E1");
        vem.b("0X80075EB");
        parambkkm.jdField_b_of_type_Boolean = true;
        if (localObject2[0] == 0) {
          parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        }
      }
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalPhotoSource))
      {
        parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalPhotoSource)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
      ...
      parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalGifSource)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
      parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalGifSource)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
      break;
      label959:
      localObject1 = "1";
      break label280;
    ...
    if (localObject2[0] > 0)
    {
      ...
      {
        localObject1 = "2";
        ((bjww)localObject5).b("pub_face", j, 0, new String[] { String.valueOf(k), localObject6, localObject1 });
        vem.a("0X80076E3", vem.b);
        vem.b("0X80075ED", vem.jdField_a_of_type_Int);
        parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
        parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject3).toString();
        label1300:
        if (localObject2[1] <= 0) {
          break label1713;
        }
        this.jdField_a_of_type_Bjww.b("pub_poi", this.jdField_a_of_type_Bjww.b(), 0, new String[] { String.valueOf(localObject2[1]), ((StringBuilder)localObject4).toString() });
        vem.a("0X80076E4");
        vem.b("0X80075EE");
        if (localObject2[0] <= 0) {
          break label1684;
        }
        parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = (parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 + "," + ((StringBuilder)localObject4).toString());
        label1407:
        localObject2 = a().a(paramInt);
        ...
        localObject3 = this.jdField_a_of_type_Bjww;
        i = this.jdField_a_of_type_Bjww.b();
        if (!this.jdField_a_of_type_Bjww.a()) {
          break label1739;
        }
        localObject1 = "2";
        label1462:
        ((bjww)localObject3).b("pub_text", i, 0, new String[] { "1", localObject2, localObject1 });
        vem.a("0X80076E2", vem.b);
        vem.b("0X80075EC", vem.jdField_a_of_type_Int);
        parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("3");
        parambkkm.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasText = true;
      }
    }
    for (;;)
    {
      ...
      label1684:
      parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
      parambkkm.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject4).toString();
      break label1407;
      label1713:
      if ((i == 0) || (!bkks.a(3))) {
        break label1407;
    ...
    this.jdField_a_of_type_Bjww.b("person_gra", this.jdField_a_of_type_Bjww.b(), 0, new String[] { localObject1 });
    label1797:
    Object localObject2 = bizu.a().getCurrentAccountUin();
    if (bkfj.jdField_b_of_type_Boolean) {}
    for (Object localObject1 = parambkkm.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription;; localObject1 = "")
    {
      ...
      parambkkm.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasFace = true;
      return;
    }
  }
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (localbjxg != null) {
      localbjxg.a(paramBitmap, paramBoolean);
    }
  }
  
  public void a(Animation paramAnimation)
  {
    this.jdField_a_of_type_Bjww.a(paramAnimation);
  }
  ...
  public void a(bkfq parambkfq)
  {
    ...
    boolean bool = this.jdField_a_of_type_Bjww.b(6);
    if (this.jdField_a_of_type_Bjww.a())
    {
      parambkfq = "2";
      if (!bool) {
    ...
    {
      vel.a("video_edit", "add_place", 0, 0, new String[] { parambkfq, "", str, "" });
      return;
      parambkfq = "1";
      break;
    }
  ...
  {
    if (!this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a())
    {
      this.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      VideoSourceHelper.nativeSetMosaic(16, this.jdField_a_of_type_ArrayOfByte);
      bjxg localbjxg = (bjxg)a(bjxg.class);
      if (localbjxg != null) {
        localbjxg.a(16, paramArrayOfByte);
      }
    }
  }
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    case 6: 
      a(0);
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(this.jdField_a_of_type_Bjww.a());
      switch (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.c())
      {
      }
      for (;;)
  ...
  public Bitmap b()
  {
    return this.jdField_a_of_type_Bjww.a();
  }
  ...
  public void b(int paramInt, Object paramObject)
  {
    ...
    case 0: 
    case 7: 
      if ((this.jdField_a_of_type_Bjww.a(13)) || (this.jdField_a_of_type_Bjww.a(14)) || (this.jdField_a_of_type_Bjww.a(15)) || (this.jdField_a_of_type_Bjww.a(16)))
      {
      ...
      {
        this.jdField_a_of_type_Bjww.a(36);
        return;
      }
      this.jdField_a_of_type_Bjww.a(0);
      return;
    case 2: 
      this.jdField_a_of_type_Bjww.a(7, paramObject);
      return;
    case 3: 
      this.jdField_a_of_type_Bjww.a(5, paramObject);
      return;
    case 4: 
      this.jdField_a_of_type_Bjww.a(9);
      return;
    case 5: 
      this.jdField_a_of_type_Bjww.a(8, paramObject);
      return;
    }
    this.jdField_a_of_type_Bjww.a(8);
  }
  
  public void b(Animation paramAnimation)
  {
    this.jdField_a_of_type_Bjww.b(paramAnimation);
  }
  ...
  public void b(String paramString)
  {
    ...
    {
      localbjww.a("exp_editpoi", 0, 0, new String[] { str });
      vem.a("0X80076CF");
      vem.b("0X80075E4");
      paramString = new bjvp(this.jdField_a_of_type_Bjxi, paramString);
      this.jdField_a_of_type_Bjww.a(3, paramString);
      return;
    }
  }
  ...
  public void d()
  {
    ...
    label740:
    for (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)this.jdField_a_of_type_AndroidViewViewStub.inflate());; this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)a(2131365312)))
    {
      if (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.f == birc.c.a()) {
      ...
      if (!bjww.a(this.jdField_a_of_type_Long, 1)) {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setMosaicStandardSize(this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setEditVideoParams(this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
      ...
      {
        if (this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bjzt.jdField_a_of_type_JavaLangString) != null) {
          this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bjzt.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Bjww.a());
        }
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bjzt.jdField_a_of_type_JavaLangString));
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null)
        {
          if (this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bkaj.jdField_a_of_type_JavaLangString) != null) {
            this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bkaj.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Bjww.a());
          }
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle(bkaj.jdField_a_of_type_JavaLangString));
        }
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null)
        {
          localObject1 = this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidOsBundle.getBundle("VoteLayer");
          if (localObject1 != null)
          {
            localObject1 = (InteractPasterParcelData)((Bundle)localObject1).getParcelable("vote_paster");
            localObject2 = (bjsi)this.jdField_a_of_type_Bjww.a(bjsi.class);
            if (localObject2 != null) {
              ((bjsi)localObject2).a((InteractPasterParcelData)localObject1);
            }
          }
        }
      }
      bjir.a().a(this.jdField_a_of_type_Bjww.h(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout);
      ...
      if (localObject1 != null)
      {
        ...
        ((DoodleEditView)localObject1).a(bjww.a(this.jdField_a_of_type_Long, 134217728));
      }
      if (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer == null)
      {
        this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer = this.jdField_a_of_type_Bjww.jdField_a_of_type_Bjtg.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer;
        if (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null) {
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setLiuHaiParentView(this.jdField_a_of_type_Bjww.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        if ((localObject1 != null) && (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null))
        {
          int i = 0;
          if ((this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)) {
            i = ((EditLocalVideoSource)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_Int;
          }
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setVideoSegmentPickerListener(new bjvg(this, i));
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setStickerListener(((DoodleEditView)localObject1).a());
          ((DoodleEditView)localObject1).setDoodleEditViewListener(new bjvh(this));
        }
        a(2131365488).setOnTouchListener(new bjvi(this));
      }
      localObject1 = ste.a();
      Object localObject2 = new bjvm(this);
      this.jdField_a_of_type_Bjvm = ((bjvm)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = ste.a();
      localObject2 = new bjvl(this);
      this.jdField_a_of_type_Bjvl = ((bjvl)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = ste.a();
      localObject2 = new bjvn(this);
      this.jdField_a_of_type_Bjvn = ((bjvn)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      return;
    }
  }
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_Bjvm != null) {
      ste.a().unRegisterSubscriber(this.jdField_a_of_type_Bjvm);
    }
    if (this.jdField_a_of_type_Bjvl != null) {
      ste.a().unRegisterSubscriber(this.jdField_a_of_type_Bjvl);
    }
    if (this.jdField_a_of_type_Bjvn != null) {
      ste.a().unRegisterSubscriber(this.jdField_a_of_type_Bjvn);
    }
    ...
    bjir.a().a(this.jdField_a_of_type_Bjww.h());
  }
  
  public boolean g_()
  {
    if (System.currentTimeMillis() < this.jdField_d_of_type_Long) {}
    while ((!bjww.a(this.jdField_a_of_type_Long, 1)) || (!TextUtils.isEmpty(a().a(this.jdField_a_of_type_Bjww.a())))) {
      return false;
    }
    if (this.jdField_a_of_type_Bjww.jdField_a_of_type_Int == 28) {
      this.jdField_a_of_type_Bjww.a(0);
    }
    return true;
  }
  ...
  public void q()
  {
    this.jdField_a_of_type_Bjww.g();
  }
  
  public void r()
  {
    this.jdField_a_of_type_Bjye.a().postDelayed(new EditVideoDoodle.9(this), 200L);
  }
  ...
  public void t()
  {
    this.jdField_a_of_type_Bjww.a(true, 0.0F, 0.0F, 0.0F, 0.0F);
  }
}
