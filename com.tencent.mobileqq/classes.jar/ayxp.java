...
public class ayxp
  ...
  implements bjmq
{
  private static amky jdField_a_of_type_Amky;
  private static amle jdField_a_of_type_Amle;
  ...
  {
    SosoInterface.SosoLbsInfo localSosoLbsInfo = amkv.a(paramString);
    if (localSosoLbsInfo != null) {}
    for (boolean bool = true;; bool = false)
    {
      bjmr.a(bool, paramString);
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      return;
      e = l;
    } while (jdField_a_of_type_Amky == null);
  ...
  {
    if ((jdField_a_of_type_Boolean) && (jdField_a_of_type_Amky == null))
    {
      jdField_a_of_type_Amky = new ayxq(paramString, false);
      try
      {
  ...
  {
    super.onDestroy();
    if (jdField_a_of_type_Amle != null) {
      SosoInterface.b(jdField_a_of_type_Amle);
    }
    jdField_a_of_type_Amle = null;
    if (jdField_a_of_type_Amky != null) {
      amkv.b(jdField_a_of_type_Amky);
    }
    jdField_a_of_type_Amky = null;
    bjmn.a().b(this);
    if (this.jdField_a_of_type_MqqOsMqqHandler != null)
    {
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      aywn.a(paramIntent, paramFromServiceMsg, (QQAppInterface)localObject, this);
      return;
    }
    aywn.a((QQAppInterface)localObject, paramIntent, paramFromServiceMsg, this);
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject2 = (ayxn)((QQAppInterface)localObject1).getManager(10);
        Object localObject3;
        if (localObject2 != null)
        {
          paramIntent = ((ayxn)localObject2).a;
          if (paramIntent != null)
          {
            localObject3 = aywn.a(paramIntent);
            ...
            if (j < i1)
            {
              ...
              localObject4 = (bjct)((ayxn)localObject2).a.get(Integer.valueOf(i2));
              ArrayList localArrayList;
              if (localObject4 != null)
              {
                localObject5 = new single_count(((bjct)localObject4).jdField_a_of_type_Long, (byte)((bjct)localObject4).jdField_a_of_type_Int);
                localArrayList = new ArrayList();
                if ((((bjct)localObject4).jdField_a_of_type_JavaUtilArrayList == null) || (((bjct)localObject4).jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
                  break label765;
                }
              }
              label765:
              for (paramIntent = new feed_host_info(((QZoneCountUserInfo)((bjct)localObject4).jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long, "", ((bjct)localObject4).jdField_a_of_type_JavaLangString, null, null, null);; paramIntent = new feed_host_info(0L, "", ((bjct)localObject4).jdField_a_of_type_JavaLangString, null, null, null))
              {
                localArrayList.add(paramIntent);
                localConcurrentHashMap1.put(Integer.valueOf(i2), new count_info((single_count)localObject5, localArrayList, ((bjct)localObject4).jdField_b_of_type_JavaLangString, ((bjct)localObject4).c, ((bjct)localObject4).e, ((bjct)localObject4).f, ((bjct)localObject4).g, ((bjct)localObject4).jdField_b_of_type_Long, ((bjct)localObject4).d));
                j += 1;
                break;
              }
            }
            paramIntent = (bjct)((ayxn)localObject2).a.get(Integer.valueOf(56));
            if (paramIntent != null)
            {
        ...
        for (;;)
        {
          ...
          paramIntent = aywn.a(Long.valueOf(((QQAppInterface)localObject1).getCurrentAccountUin()).longValue(), null, m, n, i, k, localConcurrentHashMap1, paramIntent, localConcurrentHashMap2);
          if (paramIntent == null)
          {
            paramIntent = new byte[4];
            notifyObserver(null, 1000, false, new Bundle(), avqu.class);
          }
          for (;;)
          {
            a();
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    aywn.a((QQAppInterface)paramString, i, paramBundle);
  }
  ...
  public void service(Intent paramIntent)
  {
    if (paramIntent.getAction().equals("Qzone_Refresh_UI"))
    {
      ...
      notifyObserver(null, 1000, true, paramIntent, avqu.class);
      if (QLog.isColorLevel()) {
