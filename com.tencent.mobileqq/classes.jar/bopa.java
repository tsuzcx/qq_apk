  ...
  implements bfpo, wrk
{
  ...
  WeakReference<bpfb> jdField_a_of_type_MqqUtilWeakReference;
  ...
  public bopa(bopd parambopd)
  {
    this.jdField_a_of_type_Bopd = parambopd;
  }
  ...
  public bpfb a()
  {
    if (this.jdField_a_of_type_MqqUtilWeakReference != null) {
      return (bpfb)this.jdField_a_of_type_MqqUtilWeakReference.get();
    }
    return null;
  }
  ...
  public void a()
  {
    yqp.b("FacePoiManager", "requestPoiList");
  ...
  {
    yqp.b("FacePoiManager", "onPOIListRequestResult.");
    ...
    if ((paramInt == 0) && (paramwrl != null)) {
      if (!paramwrl.a())
      {
        ...
        yqp.a("FacePoiManager", "onPOIListRequestResult, CurrentPOIList : %s , CurrentPOI : %s .", this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
        this.jdField_a_of_type_Bopd.a(true, bool, this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
      }
    }
    for (;;)
    {
      ...
      bool = false;
      break;
      this.jdField_a_of_type_Bopd.a(false, false, null, null);
    }
  }
  
  public void a(bpfb parambpfb, String paramString)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(parambpfb);
  ...
  {
    yqp.b("FacePoiManager", "requestSosoPoi");
    this.jdField_a_of_type_Bopd.a(2, new String[0]);
    new banu(paramActivity, new bopb(this, paramBoolean)).a();
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_MqqUtilWeakReference != null)
    {
      bpfb localbpfb = (bpfb)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (localbpfb != null) {
        localbpfb.a();
      }
    }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Wrl != null) {
      this.jdField_a_of_type_Wrl.a();
    }
  }
}
