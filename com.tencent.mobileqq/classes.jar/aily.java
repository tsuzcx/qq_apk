  ...
  implements View.OnClickListener
{
  ...
  public aily(AbsShareMsg paramAbsShareMsg) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject3 = new aima(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, localQQAppInterface, paramView);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID == 114) {
        ThreadManager.post(new ailz(this, localQQAppInterface), 0, null, false);
      }
      label791:
      label926:
      label1515:
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if ((paramView instanceof StructMsgItemLayout5))
          {
            ...
            for (paramView = paramView.B;; paramView = "0")
            {
              ...
              break;
              if (((aima)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData))
              {
                paramView = "run";
                break label413;
              }
              if (((aima)localObject3).a(((FragmentActivity)localContext).getActivity(), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid, localAbsShareMsg.mSourceName, localAbsShareMsg.mSourceActionData, localAbsShareMsg.mSource_A_ActionData))
              {
                paramView = "setup";
                break label413;
              }
              ((aima)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl);
              paramView = "setup";
              break label413;
              if ("web".equals(paramView))
              {
                ...
                for (;;)
                {
                  ...
                  if (localAbsShareMsg.uinType == 1) {
                    ...
                    {
                      localObject1 = String.format("%s&gc=%s", new Object[] { localObject1, NearbyURLSafeUtil.a(localAbsShareMsg.uin) });
                      paramView = (View)localObject1;
                      if (QLog.isColorLevel())
                      {
              ...
              {
                if ((localAbsShareMsg.uinType == 1) && ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID == 116) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID == 123)))
                {
                ...
                ((aima)localObject3).c(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
              ...
              ((aima)localObject3).a(paramView, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
              break label443;
            }
          }
        }
