...
public class blqj
{
  ...
  public void a(Canvas paramCanvas, blqk paramblqk)
  {
    if ((paramCanvas == null) || (paramblqk == null)) {
      return;
    }
    if ((this.jdField_a_of_type_Boolean) && (a()))
    {
      this.jdField_a_of_type_AndroidGraphicsRectF.set(0.0F, 0.0F, paramblqk.getWidth(), paramblqk.getHeight());
      int i = this.e;
      if (b()) {
        i = c;
      }
