  ...
  implements lho
{
  ...
  public ljp(VideoAppInterface paramVideoAppInterface)
  {
  ...
  {
    ((ljp)paramVideoAppInterface.a(0)).b();
  ...
  private boolean b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      try
      {
        ...
        lcg.c("EffectZimuManager", "parse ZIMU:" + paramString);
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    ((lgs)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1)).a();
    new mcl(paramLong, "onSessionStatusChanged", 2, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
  }
  ...
  public void a(String paramString, long paramLong)
  {
    if (this.b)
    {
      lgv locallgv = (lgv)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
      locallgv.a(paramString, paramLong, "TransInfo.ExitSession", null);
      locallgv.onDestroy();
      ((lgs)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1)).a();
    }
    this.b = false;
  ...
  public void a(String paramString1, boolean paramBoolean, long paramLong, String paramString2)
  {
    ...
    if (!this.b)
    {
      lgs locallgs = (lgs)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(1);
      locallgs.a(paramString1, "TransInfoCreate.CreateSession", paramLong, paramString2);
      locallgs.onDestroy();
      this.c = paramBoolean;
    }
    this.b = true;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      if ((!ljo.a(localZimuItem.getId())) || (localZimuItem.isUsable() == paramBoolean)) {
        break label82;
      }
  ...
  public boolean a(long paramLong, ZimuItem paramZimuItem)
  {
    ...
    for (int i = 4;; i = 5)
    {
      ...
      if (paramZimuItem != null)
      {
        ...
        if (localObject != null) {
          ((lhn)localObject).a(3001, paramZimuItem.getId());
        }
      }
      return bool;
  ...
  public void b(String paramString, long paramLong)
  {
    ...
    {
      lgv locallgv = (lgv)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
      locallgv.a(paramString, paramLong, "TransInfo.ChangeSession", null);
      locallgv.onDestroy();
    }
  }
