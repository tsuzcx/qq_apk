  ...
  extends amab
{
  ...
  protected void a(String paramString, List<Pair<String, String>> paramList)
  {
    ...
    label76:
    while (!paramString.equals(amfi.a(this.a)))
    {
      return;
      i = paramList.size();
      break;
    ...
    if (j < k)
    {
      ...
      if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((aloz)localObject).b(str2))) {
        break label283;
      }
      i += 1;
    }
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    try
    {
      ...
      if (paramBoolean)
      {
        ...
        if (String.valueOf(l).equals(amfi.a(this.a)))
        {
          ...
          amfi.a(this.a, String.valueOf(l));
          return;
        }
      }
    }
