  ...
  extends apfc
{
  ...
  public apfb(QQAppInterface paramQQAppInterface, asug paramasug, HashMap<String, ArrayList<MessageRecord>> paramHashMap, astt paramastt)
  {
    ...
    if (this.b == null)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (i < ((ArrayList)localObject).size())
        {
          ...
          if ((localMessageRecord2 == null) || (!apug.a(localMessageRecord2))) {
            break label165;
          }
  ...
  public void a(String paramString, List<MessageRecord> paramList, MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      paramList = ajya.a(2131707023) + paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName");
