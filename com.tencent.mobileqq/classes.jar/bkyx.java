...
public class bkyx
{
  ...
  {
    return bkyz.a().a("contentboxlaunch", "gocontentboxminiprogram", 0);
  }
  ...
  public static void a(bkyy parambkyy)
  {
    if (parambkyy != null) {
      QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new QZoneConfigHelper.1(parambkyy));
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    try
    {
      boolean bool = ((awnb)paramQQAppInterface.getManager(10)).b();
      return bool;
    }
