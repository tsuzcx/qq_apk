...
public class angh
{
  private SparseArray<ampe> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private VasWebviewJsPlugin jdField_a_of_type_ComTencentMobileqqVaswebviewpluginVasWebviewJsPlugin;
  
  public angh(VasWebviewJsPlugin paramVasWebviewJsPlugin)
  {
  ...
  private void a(int[] paramArrayOfInt, String paramString, JSONArray paramJSONArray)
  {
    ...
    if (paramArrayOfInt != null)
    {
      ...
      {
        amow localamow = amov.a().a(8, paramArrayOfInt[i]);
        if (localamow == null) {
          j = 1;
        }
        for (;;)
      ...
      if (j != 0)
      {
        ...
        paramArrayOfInt = new angm(this, i, paramArrayOfInt, localArrayList, localAppInterface, paramJSONArray, paramString);
        this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramArrayOfInt);
        ampa.a().a(i, paramArrayOfInt);
        ampa.a().a(localAppInterface, i, true);
      }
    }
    else
    {
    ...
    if (localArrayList.isEmpty())
    {
      ...
      a(paramString, anvx.a(2131699998), paramJSONArray);
      return;
    }
    amox.a(localAppInterface, "", new ango(this, paramArrayOfInt, paramJSONArray, paramString), localArrayList, false, null);
  }
  ...
  private WebResourceResponse b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Uri)localObject7).isHierarchical())
        {
            ...
            if (localObject6 != null)
            {
              ...
              if (((JSONArray)localObject6).length() > 0)
              {
                ...
                if (k < i1)
                {
                  ...
                  localObject4 = amov.a().a(8, localObject2[k]);
                  if ((localObject4 == null) || (!((amow)localObject4).a())) {
                    break label1319;
                  }
                  m = 1;
          ...
          if (i3 != 0)
          {
            ...
            {
              localObject1 = (amow)((List)localObject7).get(i);
              localObject1 = a(((amow)localObject1).b, 8, "/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/room/" + ((amow)localObject1).b + File.separator, false);
          ...
          if ((i > 0) || ((localObject1 != null) && (localObject1.length > 0))) {
            anex.b(localAppInterface, "", new angi(this, (JSONArray)localObject2, (File)localObject3, localAppInterface, (String)localObject8, (int[])localObject4, str1), i, (int[])localObject1, -1, -1, false);
          }
        }
        else
        {
          localObject1 = new WebResourceResponse("application/octet-stream", "utf-8", new anhk(null, null, null));
          a((WebResourceResponse)localObject1);
          return localObject1;
        }
      }
      catch (Exception localException)
      {
        ...
        localWebResourceResponse = new WebResourceResponse("application/octet-stream", "utf-8", new anhk(null, null, null));
        a(localWebResourceResponse);
        QLog.e("ApolloPluginRscLoader", 1, "getCombination url 解析失败:" + paramString);
        a(d(paramString), -1, anvx.a(2131700008));
        return localWebResourceResponse;
      }
      if ((localObject3 != null) && (!((File)localObject3).exists()))
      {
        anex.a(localAppInterface, (String)localObject8, new angl(this, (String)localObject8, (File)localObject3, (JSONArray)localObject2, (int[])localObject4, str1));
      }
      else
      {
        if (!TextUtils.isEmpty((CharSequence)localObject8)) {
        ...
        {
          a(str1, anvx.a(2131699994), (JSONArray)localObject2);
        }
        else
        {
  ...
  public WebResourceResponse a(String paramString)
  {
    ...
    do
    {
      ...
      if (paramString.startsWith("https://cmshow.qq.com/3dresource/Room/"))
      {
        ...
        localObject2 = amov.a().a(8, i);
        if (localObject2 == null)
        {
          QLog.i("ApolloPluginRscLoader", 1, "idolRscItem == null ");
          int j = ((File)localObject1).hashCode();
          ampa.a().a(localAppInterface, j, true);
          ampa.a().a(j, new angp(this, i, paramString, localAppInterface, (File)localObject1));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new anhk(null, null, null));
          a(paramString);
          return paramString;
          if (((amow)localObject2).a())
          {
            if (((File)localObject1).exists())
            {
            ...
            a((String)localObject1, 1, i + anvx.a(2131699993));
          }
          else
          {
            localObject3 = new ArrayList();
            ((List)localObject3).add(localObject2);
            amox.a(localAppInterface, "", new angr(this, paramString, (File)localObject1, i), (List)localObject3, false, null);
          }
        }
      }
      if (paramString.startsWith("https://cmshow.qq.com/3dresource/Role/"))
      {
        ...
        if (ApolloUtil.d(i)) {
          a((String)localObject2, 1, i + anvx.a(2131700002));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new anhk(null, null, null));
          ...
          anex.b(localAppInterface, null, new angs(this, (File)localObject1, (String)localObject2), i, null, -1, -1, false);
        }
      }
      if (paramString.startsWith("https://cmshow.qq.com/3dresource/Dress/"))
      {
        ...
        if (ApolloUtil.c(i)) {
          a((String)localObject2, 1, i + anvx.a(2131700014));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new anhk(null, null, null));
          ...
          anex.b(localAppInterface, null, new angt(this, i, (File)localObject1, (String)localObject2), -1, new int[] { i }, -1, -1, false);
        }
      }
      if (paramString.startsWith("https://cmshow.qq.com/3dresource/Action/"))
      {
        ...
        if (ApolloUtil.a(i, 0)) {
          a((String)localObject2, 1, i + anvx.a(2131700003));
        }
        for (;;)
        {
          paramString = new WebResourceResponse("application/octet-stream", "utf-8", new anhk(null, null, null));
          ...
          anex.b(localAppInterface, null, new angu(this, (File)localObject1, (String)localObject2), -1, null, i, -1, false);
        }
      }
    ...
    for (paramString = "application/json";; paramString = "application/octet-stream")
    {
      ...
      anex.a(localAppInterface, str1, new angk(this, (File)localObject1, paramString));
      localObject1 = new anhk(null, null, null);
      if (str3.endsWith(".json")) {}
      for (paramString = "application/json";; paramString = "application/octet-stream")
      {
        paramString = new WebResourceResponse(paramString, "utf-8", (InputStream)localObject1);
