public abstract class angh<DATA, CONFIG extends angu>
  extends anga<DATA, CONFIG>
{
  private float[] a;
  private float d;
  ...
  public void a(float paramFloat1, float paramFloat2, long paramLong1, long paramLong2)
  {
    if (!a(paramLong1))
    {
      anic.c("BaseDanmaku", "onLayout, Y = " + paramFloat2 + ", danmaku = " + toString());
      this.d = a(paramLong2);
      if (!c())
      {
        this.e = paramFloat2;
  ...
  public float[] a(long paramLong)
  {
    ...
    this.jdField_a_of_type_ArrayOfFloat[0] = (f1 - angj.a().b());
  ...
  {
    super.g();
    this.f = ((int)(f() + this.jdField_a_of_type_Float) / (float)this.jdField_a_of_type_Anhs.a());
  }
