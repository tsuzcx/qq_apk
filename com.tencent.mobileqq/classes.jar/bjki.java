...
public class bjki
{
  ...
  private bjki(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4)
  {
  ...
  public static bjki a(@NonNull BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    int j = 0;
    ...
    for (;;)
    {
      ...
      catch (Exception paramAppInfo)
      {
        try
        {
          ...
          j = k;
          localObject2 = localObject3;
          return new bjki((String)localObject1, i, (String)localObject2, j, "vab_red", "vab_red");
        }
        catch (Exception paramAppInfo)
        {
          break label123;
