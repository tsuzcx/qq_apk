...
{
  public bekf(QQAppInterface paramQQAppInterface)
  {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      localObject2 = ((bejv)this.mApp.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(i);
    ...
    return;
    ((bekg)localObject2).a(paramToServiceMsg, (aio_media.RspLatestPlayingState)localObject1);
    for (;;)
    {
      ...
      if ("QQAIOMediaSvc.get_dynamic_info".equals(paramFromServiceMsg.getServiceCmd()))
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          try
          {
            ...
            localObject2 = new bekd();
            ((bekd)localObject2).b = 1001;
            ((bekd)localObject2).jdField_a_of_type_Boolean = true;
            ((bekd)localObject2).f = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)((aio_media.RspGetDynamicInfo)localObject1).get()).msg_music_info.get()).uint32_user_num.get();
            ...
            ((bekd)localObject2).jdField_a_of_type_JavaUtilArrayList = new ArrayList(((List)localObject3).size());
            localObject3 = ((List)localObject3).iterator();
            while (((Iterator)localObject3).hasNext())
            {
              localLong = (Long)((Iterator)localObject3).next();
              ((bekd)localObject2).jdField_a_of_type_JavaUtilArrayList.add(localLong + "");
            }
            if (!QLog.isColorLevel()) {
              continue;
            }
          ...
          QLog.d("TogetherOperationHandler", 2, "InvalidProtocolBufferMicroException");
          continue;
          bejv.a(this.app).a((bekd)localObject2);
          label489:
          if (((aio_media.RspGetDynamicInfo)localInvalidProtocolBufferMicroException.get()).msg_video_info.has())
          {
            localObject2 = new bekd();
            ((bekd)localObject2).b = 1002;
            ((bekd)localObject2).jdField_a_of_type_Boolean = true;
            ((bekd)localObject2).f = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)localInvalidProtocolBufferMicroException.get()).msg_video_info.get()).uint32_user_num.get();
          ...
          {
            localObject2 = new bekd();
            ((bekd)localObject2).b = 1003;
            ((bekd)localObject2).jdField_a_of_type_Boolean = true;
            ((bekd)localObject2).f = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)localInvalidProtocolBufferMicroException.get()).msg_ksing_info.get()).uint32_user_num.get();
          ...
          {
            localObject2 = new bekd();
            ((bekd)localObject2).b = 1004;
            ((bekd)localObject2).jdField_a_of_type_Boolean = true;
            ((bekd)localObject2).f = ((aio_media.DynamicInfo)((aio_media.RspGetDynamicInfo)localInvalidProtocolBufferMicroException.get()).msg_play_info.get()).uint32_user_num.get();
          ...
          if (((aio_media.RspGetDynamicInfo)localInvalidProtocolBufferMicroException.get()).rpt_dynamic_info.has())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                localObject2 = new bekd();
                ((bekd)localObject2).b = 1005;
                ((bekd)localObject2).jdField_a_of_type_Boolean = true;
                ((bekd)localObject2).f = ((aio_media.DynamicInfo)localObject3).uint32_user_num.get();
