...
public class asjr
{
  ...
  public asjr(asjs paramasjs)
  {
    this.jdField_a_of_type_Asjs = paramasjs;
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterTextureRender = new TextureRender();
    this.jdField_a_of_type_Int = asjm.a(paramasjs.jdField_c_of_type_Int, paramasjs.jdField_b_of_type_Int);
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer = new RenderBuffer(paramasjs.jdField_c_of_type_Int, paramasjs.jdField_b_of_type_Int);
    asjn.a(false);
    this.jdField_a_of_type_Long = RecogProxy.QCodeInit(this.jdField_a_of_type_Asjs.jdField_a_of_type_Int, this.jdField_a_of_type_Asjs.jdField_b_of_type_Int, this.jdField_a_of_type_Asjs.jdField_c_of_type_Int, this.jdField_a_of_type_Asjs.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Asjs.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Asjs.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Asjs.d, 0.35F);
  ...
  public List<alje> a(int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Long != 0L)
        {
          ...
          if (j < i)
          {
            ...
            localalje.jdField_a_of_type_Int = m;
            localalje.jdField_a_of_type_Float = localObject2[4];
      ...
      for (;;)
      {
        ...
        try
        {
          ??? = asjm.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_Asjs.jdField_c_of_type_Int, this.jdField_a_of_type_Asjs.jdField_b_of_type_Int);
          ...
          asjn.a((Bitmap)???, (String)localObject2);
