  ...
  extends ajfb
{
  ...
  public ajrx(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131653645);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131653646);
    this.c = paramQQAppInterface.getApplication().getString(2131653643);
    this.d = paramQQAppInterface.getApplication().getString(2131653647);
    this.f = paramQQAppInterface.getApplication().getString(2131653641);
    this.g = paramQQAppInterface.getApplication().getString(2131653639);
    this.h = paramQQAppInterface.getApplication().getString(2131653642);
    this.e = paramQQAppInterface.getApplication().getString(2131653644);
    this.i = paramQQAppInterface.getApplication().getString(2131653640);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((arip)this.app.getManager(16)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    if (j < m)
    {
      ...
      if (k != 1006) {
        if (paramBoolean)
        {
          ...
          if (k == 1024)
          {
            localbcpn = (bcpn)this.app.getManager(165);
            if (localbcpn != null)
            {
              localObject1 = localObject2;
              if (!localbcpn.a((String)localObject3))
              {
                localObject1 = localObject2;
                if (localbcpn.f((String)localObject3)) {}
              }
            }
            else
            {
          ...
          if ((localObject1 == null) || (((List)localObject1).size() <= 0) || (!akbm.a((MessageRecord)((List)localObject1).get(((List)localObject1).size() - 1), (MessageRecord)localObject3, false))) {
            break label594;
          }
          if (QLog.isColorLevel()) {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      do
      {
        ...
        localObject2 = babh.f(this.app, String.valueOf(l1));
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    long l1 = bakz.a(arrayOfByte1, 0);
    long l2 = bakz.a(arrayOfByte1, 4);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (arip)this.app.getManager(16);
    int j = 0;
  ...
  private byte[] a(sso2sns_comm_info.Sso2SnsCommInfo paramSso2SnsCommInfo, sso2sns_0x3_blocklist.ReqBody paramReqBody)
  {
    ...
    bakz.a(arrayOfByte1, 0, l1);
    bakz.a(arrayOfByte2, 0, l2);
  ...
  private void d()
  {
    ...
    ((arip)this.app.getManager(16)).a(localArrayList);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1006)
    {
      paramString = babh.e(this.app, paramString);
