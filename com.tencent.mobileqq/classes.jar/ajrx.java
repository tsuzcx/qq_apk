...
public class ajrx
{
  ...
  private static HashMap<String, List<ajpy>> c = new HashMap();
  ...
  public static List<ajpy> a(String paramString)
  {
  ...
  public static List<ajoq> a(ArrayList<ajpy> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      String str = String.valueOf(((ajpy)paramArrayList.get(i)).jdField_a_of_type_Long);
      ...
      {
        ajoq localajoq = new ajoq();
        localajoq.jdField_a_of_type_ComTencentMobileqqDataTroopInfo = localTroopInfo;
        localajoq.jdField_a_of_type_JavaLangString = str;
        localajoq.jdField_a_of_type_Int = ((ajpy)paramArrayList.get(i)).jdField_a_of_type_Int;
        localArrayList.add(localajoq);
      }
      i += 1;
    }
    return localArrayList;
  ...
  public static void a(String paramString1, String paramString2, String paramString3, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      paramString2 = (aoip)paramQQAppInterface.a(20);
  ...
  public static void a(String paramString, List<ajpy> paramList)
  {
  ...
  public static boolean a(long paramLong, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (avgv)paramQQAppInterface.a(153);
    if (!a(str))
    {
