...
{
  public acet(HotChatFlashPicActivity paramHotChatFlashPicActivity) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      do
      {
        ...
        do
        {
          ...
          HotChatFlashPicActivity.a(this.a).setImageResource(2130840604);
          if (HotChatFlashPicActivity.b(this.a)) {
            HotChatFlashPicActivity.a(this.a).setText(2131438091);
          }
          while (HotChatFlashPicActivity.a(this.a).a())
          {
            HotChatFlashPicActivity.a(this.a).b();
            return false;
            HotChatFlashPicActivity.a(this.a).setText(2131438102);
          }
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            HotChatFlashPicActivity.a(this.a).setImageResource(2130840606);
            if (HotChatFlashPicActivity.b(this.a)) {
              HotChatFlashPicActivity.a(this.a).setText(2131438089);
            }
            while (HotChatFlashPicActivity.a(this.a).a())
            {
              HotChatFlashPicActivity.a(this.a).b();
              return false;
              HotChatFlashPicActivity.a(this.a).setText(2131438100);
            }
          }
          HotChatFlashPicActivity.a(this.a).sendEmptyMessage(1);
          return false;
    ...
    case 4: 
      if (HotChatFlashPicActivity.b(this.a)) {
        if (HotChatFlashPicActivity.a(this.a) >= 2) {
          paramMessage = this.a.getString(2131438093);
        }
      }
      break;
    }
    for (;;)
    {
      HotChatFlashPicActivity.a(this.a, DialogUtil.a(this.a, paramMessage, 0, 2131435285, null, new aceu(this)));
      ...
      return false;
      paramMessage = this.a.getString(2131438092);
      continue;
      if (HotChatFlashPicActivity.a(this.a) == 2)
      {
        paramMessage = this.a.getString(2131438109);
      ...
      {
        paramMessage = this.a.getString(2131438103);
        localObject = paramMessage;
        if (!HotChatFlashPicActivity.e(this.a))
        {
          if (HotChatFlashPicActivity.b(this.a) == 0)
