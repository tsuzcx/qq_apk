  ...
  extends Handler
{
  ...
  public ahec(ReceiptMessageDetailFragment paramReceiptMessageDetailFragment)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    while (ReceiptMessageDetailFragment.a(localReceiptMessageDetailFragment))
    {
      ...
      i = 0;
      break label126;
      QQToast.a(ReceiptMessageDetailFragment.a(localReceiptMessageDetailFragment).getApp(), 1, 2131439003, 0).a(localReceiptMessageDetailFragment);
      i = 0;
      break label126;
      ...
      i = 0;
      break label126;
      ThreadManager.post(new ahed(this, localReceiptMessageDetailFragment), 8, null, false);
      i = 0;
      break label126;
