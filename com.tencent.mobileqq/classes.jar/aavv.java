...
public class aavv
{
  ...
  private static int a(aawe paramaawe)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	aawe:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	aavv:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  private static void a(aawe paramaawe)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramaawe = paramaawe.b();
      String str = PatchCommonUtil.getPatchPath(paramaawe);
      if ("Success".equals(amdh.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramaawe;
      }
      for (;;)
      {
    ...
    catch (Throwable paramaawe)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramaawe);
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    aawe localaawe = aawf.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, localaawe)))
    {
      a(localaawe);
      int j;
      if (jdField_a_of_type_Int == 500) {
        if ((localaawe.b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a(localaawe);
          i = j;
          if (j != 800)
          {
            String str = amdh.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, localaawe);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, localaawe.b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, localaawe);
        }
      }
    }
  ...
  private static void a(Context paramContext, aawe paramaawe)
  {
    paramContext = new DexPatchInstaller.1(paramaawe, paramContext);
  ...
  private static boolean a(Context paramContext, aawe paramaawe)
  {
    if (paramaawe == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramaawe.a(paramContext, true)) {
      return false;
    }
    String str = paramaawe.b();
    ...
    if (localFile.length() != paramaawe.b())
    {
