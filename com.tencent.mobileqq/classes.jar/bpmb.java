...
public class bpmb
  extends MqqHandler
{
  public bpmb(ShortVideoPlayActivity paramShortVideoPlayActivity) {}
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          paramMessage = bhdj.a(this.a.jdField_a_of_type_AndroidContentContext, 232, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718864), this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718863), 2131718847, 2131718048, new bpmc(this), new bpmd(this));
