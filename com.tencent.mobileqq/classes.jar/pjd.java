  ...
  implements ViewBase.OnClickListener
{
  ...
  public pjd(ArticleInfo paramArticleInfo, Context paramContext, int paramInt, String paramString)
  {
  ...
  private void a()
  {
    bbeg localbbeg = bbex.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString);
    if (localbbeg != null) {
      localbbeg.c();
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject.put("feeds_type", onh.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      localJSONObject.put("channel_id", "" + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mChannelID);
      localJSONObject.put("feeds_source", onh.c(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
  ...
  public void onClick(ViewBase paramViewBase)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qde != null) && ((this.jdField_a_of_type_Int == 72) || (this.jdField_a_of_type_Int == 73)))
      {
        a("4");
        return;
      }
