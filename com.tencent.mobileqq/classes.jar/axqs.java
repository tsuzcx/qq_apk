...
public class axqs
{
  ...
  private static String a(QQAppInterface paramQQAppInterface, axqt paramaxqt)
  {
    paramaxqt.a = bbdh.d();
    SosoInterface.SosoLbsInfo localSosoLbsInfo = SosoInterface.b();
    if ((localSosoLbsInfo != null) && (localSosoLbsInfo.a != null)) {
      paramaxqt.c = localSosoLbsInfo.a.e;
    }
    paramaxqt.b = a(paramQQAppInterface);
    return paramaxqt.toString();
  }
  
  public static void a(QQAppInterface paramQQAppInterface, axqt paramaxqt)
  {
    paramaxqt = a(paramQQAppInterface, paramaxqt);
    if (QLog.isColorLevel()) {
      QLog.i("PushReportController", 1, "reportPushEvent detail=" + paramaxqt);
    }
    if (paramQQAppInterface == null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramQQAppInterface.putExtra("reporting_detail", paramaxqt);
    ...
    axqy.b(paramQQAppInterface, "dc03266", paramaxqt, 1);
  }
  
  public static void a(String paramString, axqt paramaxqt)
  {
