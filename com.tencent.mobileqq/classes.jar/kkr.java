...
public class kkr
  extends BaseAdapter
{
  public kkr(TroopCardSameCity paramTroopCardSameCity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localObject = LayoutInflater.from(this.a.getContext()).inflate(2130969416, paramViewGroup, false);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131366419));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131366421));
      paramView.b = ((TextView)((View)localObject).findViewById(2131366422));
