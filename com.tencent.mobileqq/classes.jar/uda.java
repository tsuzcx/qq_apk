...
public class uda
{
  ...
  private uda()
  {
    ...
    this.jdField_a_of_type_JavaUtilComparator = new udb(this);
  ...
  private List<TroopBarData> a(QQAppInterface paramQQAppInterface, List<TroopBarData> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (uaw.d(paramQQAppInterface, localTroopBarData.mUin)) {
  ...
  {
    if (!uaw.d(paramQQAppInterface, paramString)) {
      return;
    }
  ...
  private boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if (i != 0)
    {
      localObject = (RecentUser)localanuz.findRecentUserByUin(AppConstants.TROOP_BAR_ASSISTANT_UIN, 7210);
    ...
    for (;;)
    {
      ...
      break;
      localObject = (RecentUser)localanuz.findRecentUser(AppConstants.TROOP_BAR_ASSISTANT_UIN, 7210);
      if (localObject != null) {
        localanuz.delRecentUser((BaseRecentUser)localObject);
      }
    }
  }
        ...
        if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue())
        {
          ...
          try
          {
            ...
            if (i < ((JSONArray)localObject).length())
            {
              ...
              if (!uaw.d(paramQQAppInterface, str)) {
                continue;
              }
  ...
  {
    paramString = ((amxz)paramQQAppInterface.getManager(56)).a(paramString);
    if (paramString != null) {
      return paramString.name;
    }
    return "";
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        if (i != 0)
        {
          ...
          ((EntityManager)???).close();
          paramQQAppInterface = ((amxz)paramQQAppInterface.getManager(56)).a();
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    k(paramQQAppInterface);
    akms.b(paramQQAppInterface, paramString, ugf.b(paramQQAppInterface, paramString));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, List<PublicAccountInfo> paramList)
  {
    ...
    {
      return;
      if (((amxz)paramQQAppInterface.getManager(56)).jdField_a_of_type_Boolean) {
        break;
      }
    } while (!bkwm.b());
  ...
  public void a(EntityManager paramEntityManager, QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      ((PublicAccountHandler)paramQQAppInterface.getBusinessHandler(11)).c();
  ...
  public void a(String paramString, QQAppInterface paramQQAppInterface, Context paramContext, amyh paramamyh)
  {
    ugf.a(paramQQAppInterface, paramContext, paramString, true, paramamyh);
  }
  ...
  {
    return (paramInt == 1008) && (uaw.d(paramQQAppInterface, paramString));
  }
  ...
  public List<ucy> b(QQAppInterface paramQQAppInterface)
  {
    a(paramQQAppInterface);
    Object localObject1 = new ArrayList();
    Object localObject3;
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = ucy.a(paramQQAppInterface, paramQQAppInterface.getApplication().getApplicationContext(), (TroopBarData)localObject3);
  ...
  {
    Object localObject = ((amxz)paramQQAppInterface.getManager(56)).a();
    if (localObject != null)
    {
      ArrayList localArrayList = new ArrayList();
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (uaw.d(paramQQAppInterface, localPublicAccountInfo.getUin())) {
  ...
  public void f(QQAppInterface paramQQAppInterface)
  {
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        for (((TroopBarData)localObject4).mLastMsgTime = ((QQMessageFacade.Message)localObject5).time;; ((TroopBarData)localObject4).mLastMsgTime = ((RecentUser)???).lastmsgtime)
        {
          ...
          localanuz.delRecentUser((BaseRecentUser)???);
    ...
    if (((ArrayList)localObject1).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = (RecentUser)localanuz.findRecentUserByUin(((TroopBarData)???).mUin, 1008);
        ...
        if (bkwm.b())
        {
          localObject1 = (amxz)paramQQAppInterface.getManager(56);
          QLog.i("TroopBarAssistantManager", 2, "uinConfigMap size: " + this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.size() + ", pam cache: " + ((amxz)localObject1).jdField_a_of_type_Boolean);
        ...
        if (a(localEntityManager, ((TroopBarData)???).mUin))
        {
          ...
          for (localObject1 = null;; localObject1 = (PublicAccountInfo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(((TroopBarData)???).mUin))
          {
            if (localObject1 != null) {
              localanuz.saveRecentUser((BaseRecentUser)localObject4);
            }
            if (bkwm.b()) {
