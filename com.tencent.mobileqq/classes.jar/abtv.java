...
public class abtv
{
  ...
  private WeakReference<abtx> jdField_a_of_type_JavaLangRefWeakReference;
  private URL jdField_a_of_type_JavaNetURL;
  private boolean jdField_a_of_type_Boolean;
  
  public abtv(String paramString, WeakReference<abtx> paramWeakReference)
  {
    try
    {
    ...
    {
      abrl.d("GdtDrawableLoader", "GdtDrawableLoader error " + paramString, paramWeakReference);
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    abrl.b("GdtDrawableLoader", "notify " + paramBoolean + " " + a());
    this.jdField_a_of_type_Boolean = true;
    if (paramBoolean)
    {
      ((abtx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_ComTencentImageURLDrawable);
      return;
    }
    ((abtx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  private boolean a()
  {
    ...
    abrl.b("GdtDrawableLoader", "retry " + a());
  ...
  private void b()
  {
    ...
    if ((!b()) || (this.jdField_a_of_type_ComTencentImageURLDrawable == null)) {
      abrl.b("GdtDrawableLoader", "update error " + a());
    }
    for (;;)
    {
      return;
      ...
      {
        abrl.b("GdtDrawableLoader", "drawable status is loading " + a());
        i = j;
      ...
      while ((i != 0) && (!this.jdField_a_of_type_Boolean))
      {
        ...
        {
          abrl.b("GdtDrawableLoader", "drawable status is file downloaded " + a());
          i = j;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 1)
        {
          abrl.b("GdtDrawableLoader", "drawable status is successed " + a());
          a(true);
          i = 0;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 2)
        {
          abrl.d("GdtDrawableLoader", "drawable status is failed " + a());
          i = j;
          if (!a())
          {
            a(false);
        ...
        {
          abrl.d("GdtDrawableLoader", "drawable status is cancled " + a());
          a(false);
          i = 0;
        }
        else
        {
          abrl.d("GdtDrawableLoader", "drawable status is " + this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() + " " + a());
          i = 0;
        }
      }
    }
  ...
  public void a()
  {
    ...
    abrl.b("GdtDrawableLoader", "load " + a());
    ...
    {
      abrl.d("GdtDrawableLoader", "load error " + a());
      return;
    }
