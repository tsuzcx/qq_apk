...
public class bcni
  extends yuh
{
  public bcni(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  private final void a(TroopFileTransferManager.Item paramItem, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, long paramLong)
  {
    ...
    //   43: ifeq +44 -> 87
    //   46: aload_1
    //   47: getfield 53	com/tencent/mobileqq/troop/utils/TroopFileTransferManager$Item:mForwardCallback	Larss;
    //   50: ifnull +34 -> 84
    //   53: aload_1
    //   54: getfield 53	com/tencent/mobileqq/troop/utils/TroopFileTransferManager$Item:mForwardCallback	Larss;
    //   57: iconst_0
    //   58: lload 7
    //   60: iload_2
    //   61: aload 6
    ...
    //   86: return
    //   87: aload_1
    //   88: getfield 53	com/tencent/mobileqq/troop/utils/TroopFileTransferManager$Item:mForwardCallback	Larss;
    //   91: ifnull -7 -> 84
    //   94: aload_1
    //   95: getfield 53	com/tencent/mobileqq/troop/utils/TroopFileTransferManager$Item:mForwardCallback	Larss;
    //   98: iconst_1
    //   99: lload 7
    //   101: iload_2
    //   102: ldc 72
  ...
  public final void a(TroopFileTransferManager.Item paramItem, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3)
  {
    for (;;)
    {
      ...
      paramString1 = new bcmr(paramItem.FileName, paramItem.ForwardTroopuin, 5, paramInt1, paramString1);
      ...
      continue;
      paramInt1 = 706;
      paramString1 = alud.a(2131715718);
      continue;
      if (paramItem.BusId == 102)
      {
        paramItem.BusId = 104;
        ytu.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, this.a.e, paramItem, this.a.e, 0L, TroopFileTransferManager.a(this.a));
      }
      else
      {
        paramInt1 = 204;
        ...
        if ((!TextUtils.isEmpty(paramItem.LocalFile)) && (new File(paramItem.LocalFile).exists()))
        {
          ...
          paramItem.BusId = 102;
          this.a.jdField_a_of_type_ArrayOfBcnq[0].a(new TroopFileTransferManager.TaskScan(this.a, paramItem));
          continue;
          label444:
          while (paramInt1 >= 0)
          {
  ...
  public final void b(TroopFileTransferManager.Item paramItem, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3)
  {
    for (;;)
    {
      try
      {
        ...
        {
        case -3: 
          paramString1 = new bcmr(paramItem.FileName, this.a.e, 5, paramInt1, paramString3);
          this.a.a(paramItem, 5, paramString1);
          return;
        }
      }
      ...
      else
      {
        ...
        if (!TextUtils.isEmpty(paramString3))
        {
          ...
          continue;
          label290:
          paramString1 = new bcmr(paramItem.FileName, this.a.e, 5, 602);
          this.a.a(paramItem, 5, paramString1);
          continue;
          paramInt1 = paramInt2;
        }
