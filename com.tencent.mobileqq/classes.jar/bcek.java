...
public class bcek
{
  public static final LruCache<String, bcek> a;
  public static final AtomicInteger c = new AtomicInteger(1);
  public String a;
  public final CopyOnWriteArrayList<bcen> a;
  ...
  /* Error */
  public static bcek a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   60: astore_0
    //   61: aload_0
    //   62: invokestatic 90	bcek:b	(Ljava/lang/String;)Lbcek;
    //   65: astore_2
    //   66: goto -52 -> 14
    //   69: astore_0
    //   70: aload_0
  ...
  public static bcek b(String paramString)
  {
    ...
    try
    {
      ...
      {
        bcek localbcek = (bcek)jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
        localObject = localbcek;
        if (localbcek == null)
        {
          localObject = new bcek(paramString);
  ...
  public void a(bcen parambcen, String paramString)
  {
    if ((this.b.get() == 3) && (parambcen != null))
    {
      ...
      parambcen.onCheckOfflineFinish(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
    }
    do
    {
      return;
      if ((parambcen != null) && (!this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(parambcen))) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambcen);
      }
      parambcen = new SwiftBrowserOfflineHandler.1(this, paramString);
    ...
    ThreadManager.postImmediately(parambcen, new bcem(this), false);
  }
  ...
  public void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Mvv.a("ex_offline", "");
