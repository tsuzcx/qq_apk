...
public class axbg
{
  ...
  public static JceStruct a(byte[] paramArrayOfByte, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      localObject1 = ((WNSStream)localObject1).unpack(bbma.b(paramArrayOfByte));
  ...
  private static void a(QQAppInterface paramQQAppInterface, mobile_get_config_rsp parammobile_get_config_rsp)
  {
    ...
    try
    {
      xoy.a(parammobile_get_config_rsp.config, true);
      label32:
      ...
      xoz.a(parammobile_get_config_rsp.config, parammobile_get_config_rsp.cookies, str1, paramQQAppInterface);
      return;
    }
  ...
  public static byte[] a(JceStruct paramJceStruct, String paramString, long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   16: aload 7
    //   18: getstatic 13	axbg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   21: lload_2
    ...
    //   105: invokestatic 247	bgyh:a	()Lbgyh;
    //   108: invokevirtual 250	bgyh:c	()Ljava/lang/String;
    //   111: invokevirtual 65	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   114: pop
    //   115: ldc 252
    //   117: invokestatic 257	axcl:a	(Ljava/lang/String;)Lcooperation/qzone/LbsDataV2$GpsInfo;
    //   120: astore 11
    //   122: ldc 89
    //   124: astore 7
    //   126: ldc 89
    ...
    //   134: ldc 252
    //   136: invokestatic 259	axcl:a	(Ljava/lang/String;)V
    //   139: aload 10
    //   141: bipush 38
    ...
    //   217: dup
    //   218: ldc 78
    //   220: invokestatic 269	bgyp:a	()Ljava/lang/String;
    //   223: lload_2
    //   224: iconst_0
    //   225: newarray byte
    //   227: aload_0
    ...
    //   239: astore_0
    //   240: iload 6
    //   242: invokestatic 274	axbg:a	(I)Lcom/qq/taf/jce/JceStruct;
    //   245: astore 7
    //   247: aload 7
    //   249: astore_0
    //   250: aload 8
    //   252: getstatic 38	axbg:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   285: invokestatic 285	bbma:a	([B)[B
    //   288: areturn
    //   289: dconst_1
    //   290: aload 11
