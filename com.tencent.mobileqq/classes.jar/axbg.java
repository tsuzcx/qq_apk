  ...
  implements Manager
{
  ...
  public axbg(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), axbi.class);
  ...
  public boolean b()
  {
    ...
    Object localObject = (axlx)this.a.getManager(36);
    if (localObject == null) {
      return false;
    }
    localObject = ((axlx)localObject).a(String.valueOf(100180));
    return (localObject != null) && (((BusinessInfoCheckUpdate.AppInfo)localObject).iNewFlag.get() == 1);
  }
  
  public void c()
  {
    if ((!bjup.d()) && (bjup.c()) && (bjup.e()))
    {
  ...
  public void d()
  {
    ...
    while ((i == 1) && (this.a != null) && (this.a.getApp() != null) && (axbj.a(this.a.getApp(), 84)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QzoneAlbumRedTouchManager", 2, "GetQZonePhotoGuideCheck supportJumpToQzone");
      }
      new axbj(this.a, this).a();
      return;
      localEditor.apply();
    }
    a();
