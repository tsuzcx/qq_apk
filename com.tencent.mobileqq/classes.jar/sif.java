...
public class sif
{
  ...
  public static String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if (aeht.b(paramAbsStructMsg.mMsgActionData))
    {
      paramAbsStructMsg = aeht.b(paramAbsStructMsg.mMsgActionData);
  ...
  public static sif a()
  {
    if (jdField_a_of_type_Sif == null) {
      jdField_a_of_type_Sif = new sif();
    }
    return jdField_a_of_type_Sif;
  }
  ...
  public static boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
    {
      ...
      if (!TextUtils.isEmpty(paramAbsStructMsg.mMsgUrl))
      {
        ...
        try
        {
          ...
          if (bbsk.a().a(localUri.getHost())) {
            return true;
          }
          bool = bggg.c(localUri.getHost());
          if (bool) {
            return true;
          }
        }
    ...
    try
    {
      bool = sfe.b(new URL(paramAbsStructMsg.mMsgUrl).getHost());
      if (!bool) {
        break label407;
      }
      return true;
  ...
  public void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, akat paramakat, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (arrayOfByte == null)
      {
        ...
        paramMessageRecord.extraflag = 32768;
        paramQQAppInterface.a().a(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.uniseq);
        paramakat = paramMessageRecord.frienduin;
        int i = paramMessageRecord.istroop;
        long l = paramMessageRecord.uniseq;
        ((MessageHandler)paramQQAppInterface.a(0)).notifyUI(MessageHandler.a(paramMessageRecord.istroop), false, new Object[] { paramakat, Integer.valueOf(i), Integer.valueOf(-1), null, Long.valueOf(0L), Long.valueOf(l) });
        return;
      }
      paramBoolean = a(paramQQAppInterface, arrayOfByte, paramQQAppInterface.getCurrentAccountUin(), paramMessageRecord.frienduin, paramMessageRecord.selfuin, paramMessageRecord.istroop, paramMessageRecord.uniseq + 1L, 1035, new sig(this, paramMessageRecord, paramQQAppInterface, paramakat, paramBoolean));
      if (!paramBoolean) {
        break;
      }
    } while (!QLog.isColorLevel());
