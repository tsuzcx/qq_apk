...
{
  public int a;
  private akqc jdField_a_of_type_Akqc;
  private akqm jdField_a_of_type_Akqm;
  public Context a;
  Handler jdField_a_of_type_AndroidOsHandler = new akqf(this, Looper.getMainLooper());
  private aobx jdField_a_of_type_Aobx;
  private aoby jdField_a_of_type_Aoby = new aoby(this.jdField_a_of_type_AndroidOsHandler);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected Object a;
  public String a;
  public HashMap<String, akqd> a;
  public List<akqn> a;
  ...
  public akqe(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Akqc = new akqc(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aoby);
    this.jdField_a_of_type_Aobx = ((aobx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QWALLET_HANDLER));
    ...
    try
    {
      ...
      this.jdField_a_of_type_Akqm = new akqm(this, null);
      paramQQAppInterface.addAction("grap_idiom_hb_result_action");
      this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_Akqm, paramQQAppInterface);
      return;
    }
  ...
  private akqd a(SessionInfo paramSessionInfo, String paramString, Object[] paramArrayOfObject)
  {
    ...
    paramSessionInfo = a(paramSessionInfo.curType) + "_" + paramSessionInfo.curFriendUin + "_";
    ...
    if (localObject3 != null) {
      for (;;)
      {
        try
        {
          ...
          localObject5 = (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(localObject5);
        }
        finally {}
      ...
      else
      {
        ...
        if ((localObject3 != null) && (!((List)localObject3).isEmpty()))
        {
          ...
          while (paramString.hasNext())
          {
            ...
            {
              localObject4 = (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(localObject4);
        ...
        {
          Collections.sort((List)localObject2, new akqg(this));
          localObject2 = ((List)localObject2).iterator();
          paramString = null;
          while (((Iterator)localObject2).hasNext())
          {
            paramSessionInfo = (akqd)((Iterator)localObject2).next();
  ...
  private String a(akqd paramakqd)
  {
    if (paramakqd == null) {
      return "";
    }
    String str = "";
    if (StringUtil.isEmpty(paramakqd.e)) {
      str = paramakqd.d;
    }
    while (StringUtil.isEmpty(str))
    {
      return "";
      String[] arrayOfString = paramakqd.e.trim().split("_");
  ...
  public static String a(String paramString)
  {
    ...
    if ((StringUtil.isEmpty(paramString)) || (!paramString.contains("_"))) {
      return "";
    }
  ...
  /* Error */
  private void a(akqd paramakqd)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    //   3: aload_1
    //   4: getfield 363	akqd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   7: astore 7
    //   9: aload_1
    //   10: getfield 375	akqd:d	Ljava/lang/String;
    //   13: astore 8
    //   15: aload_0
    //   16: getfield 138	akqe:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   19: aload 7
    //   21: aload_1
    //   22: invokevirtual 391	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   25: pop
    //   26: aload_1
    //   27: getfield 345	akqd:jdField_a_of_type_Int	I
    //   30: ifne +161 -> 191
    //   33: aload_0
    //   34: getfield 127	akqe:jdField_b_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   37: aload 8
    //   39: invokevirtual 230	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   42: checkcast 232	java/util/List
    //   45: astore 6
    //   47: aload 6
    //   49: ifnonnull +617 -> 666
    //   52: new 309	java/util/LinkedList
    //   55: dup
    //   56: invokespecial 310	java/util/LinkedList:<init>	()V
    //   59: astore 6
    //   61: aload_0
    //   62: getfield 127	akqe:jdField_b_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   65: aload 8
    //   67: aload 6
    //   69: invokevirtual 391	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   72: pop
    //   73: aload_0
    //   74: getfield 48	akqe:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   77: astore 8
    //   79: aload 8
    //   81: monitorenter
    //   82: aload 6
    //   84: invokeinterface 307 1 0
    //   89: istore 5
    //   91: iconst_0
    //   92: istore_2
    //   93: iload 4
    ...
    //   102: aload 6
    //   104: iload_2
    //   105: invokeinterface 394 2 0
    //   110: checkcast 250	java/lang/String
    //   113: astore 9
    //   115: aload 9
    //   117: invokestatic 322	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   120: ifne +550 -> 670
    //   123: aload_0
    //   124: getfield 138	akqe:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   127: aload 9
    //   129: invokevirtual 230	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   132: checkcast 265	akqd
    //   135: astore 9
    //   137: aload 9
    //   139: ifnull +531 -> 670
    //   142: aload 9
    //   144: getfield 354	akqd:jdField_a_of_type_Long	J
    //   147: aload_1
    //   148: getfield 354	akqd:jdField_a_of_type_Long	J
    //   151: lcmp
    //   152: ifge +518 -> 670
    //   155: iload_2
    //   156: istore_3
    ...
    //   159: iload_3
    //   160: aload 7
    //   162: invokeinterface 397 3 0
    //   167: aload 8
    //   169: monitorexit
    //   170: return
    //   171: astore_1
    //   172: invokestatic 400	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   175: ifeq -8 -> 167
    //   178: aload_1
    //   179: invokevirtual 403	java/lang/Throwable:printStackTrace	()V
    //   182: goto -15 -> 167
    //   185: astore_1
    //   186: aload 8
    //   188: monitorexit
    ...
    //   190: athrow
    //   191: aload_1
    //   192: getfield 345	akqd:jdField_a_of_type_Int	I
    //   195: iconst_4
    //   196: if_icmpne +473 -> 669
    //   199: aload_1
    //   200: invokevirtual 380	akqd:a	()I
    //   203: ifeq +19 -> 222
    //   206: aload_1
    //   207: invokevirtual 380	akqd:a	()I
    //   210: iconst_1
    //   211: if_icmpeq +11 -> 222
    //   214: aload_1
    //   215: invokevirtual 380	akqd:a	()I
    //   218: iconst_3
    //   219: if_icmpne +198 -> 417
    //   222: aload_1
    //   223: getfield 373	akqd:e	Ljava/lang/String;
    //   226: invokestatic 405	akqe:a	(Ljava/lang/String;)Ljava/lang/String;
    //   229: ldc_w 407
    //   232: invokevirtual 378	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   235: astore 8
    //   237: aload 8
    //   239: arraylength
    //   240: istore 4
    ...
    //   254: astore 9
    //   256: aload_0
    //   257: getfield 129	akqe:jdField_c_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   260: aload 9
    //   262: invokevirtual 230	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   265: checkcast 232	java/util/List
    //   268: astore 6
    //   270: aload 6
    //   272: ifnonnull +391 -> 663
    //   275: new 309	java/util/LinkedList
    //   278: dup
    //   279: invokespecial 310	java/util/LinkedList:<init>	()V
    //   282: astore 6
    //   284: aload_0
    //   285: getfield 129	akqe:jdField_c_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   288: aload 9
    //   290: aload 6
    //   292: invokevirtual 391	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   295: pop
    //   296: aload_0
    //   297: getfield 48	akqe:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   300: astore 9
    //   302: aload 9
    //   304: monitorenter
    //   305: aload 6
    //   307: invokeinterface 307 1 0
    //   312: istore 5
    //   314: iconst_0
    //   315: istore_2
    //   316: iload_2
    ...
    //   322: aload 6
    //   324: iload_2
    //   325: invokeinterface 394 2 0
    //   330: checkcast 250	java/lang/String
    //   333: astore 10
    //   335: aload 10
    //   337: invokestatic 322	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   340: ifne +337 -> 677
    //   343: aload_0
    //   344: getfield 138	akqe:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   347: aload 10
    //   349: invokevirtual 230	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   352: checkcast 265	akqd
    //   355: astore 10
    //   357: aload 10
    //   359: ifnull +318 -> 677
    //   362: aload 10
    //   364: getfield 354	akqd:jdField_a_of_type_Long	J
    //   367: aload_1
    //   368: getfield 354	akqd:jdField_a_of_type_Long	J
    //   371: lcmp
    //   372: ifge +305 -> 677
    //   375: aload 6
    //   377: iload_2
    //   378: aload 7
    //   380: invokeinterface 397 3 0
    //   385: aload 9
    //   387: monitorexit
    //   388: iload_3
    //   389: iconst_1
    ...
    //   392: goto -148 -> 244
    //   395: astore 6
    //   397: invokestatic 400	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   400: ifeq -15 -> 385
    //   403: aload 6
    //   405: invokevirtual 403	java/lang/Throwable:printStackTrace	()V
    //   408: goto -23 -> 385
    //   411: astore_1
    //   412: aload 9
    //   414: monitorexit
    ...
    //   416: athrow
    //   417: aload_1
    //   418: invokevirtual 380	akqd:a	()I
    //   421: iconst_2
    //   422: if_icmpne +247 -> 669
    //   425: aload_1
    //   426: invokevirtual 410	akqd:a	()Ljava/util/List;
    //   429: invokeinterface 239 1 0
    //   434: astore 8
    //   436: aload 8
    //   438: invokeinterface 244 1 0
    //   443: ifeq +226 -> 669
    //   446: aload 8
    //   448: invokeinterface 248 1 0
    //   453: checkcast 296	java/lang/Integer
    //   456: invokevirtual 413	java/lang/Integer:intValue	()I
    //   459: istore_2
    //   460: aload_0
    //   461: getfield 131	akqe:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   464: iload_2
    //   465: invokestatic 300	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   468: invokeinterface 304 2 0
    //   473: checkcast 232	java/util/List
    //   476: astore 6
    //   478: aload 6
    //   480: ifnonnull +175 -> 655
    //   483: new 309	java/util/LinkedList
    //   486: dup
    //   487: invokespecial 310	java/util/LinkedList:<init>	()V
    //   490: astore 6
    //   492: aload_0
    //   493: getfield 131	akqe:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   496: iload_2
    //   497: invokestatic 300	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   500: aload 6
    //   502: invokeinterface 414 3 0
    //   507: pop
    //   508: aload_0
    //   509: getfield 48	akqe:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   512: astore 9
    //   514: aload 9
    //   516: monitorenter
    //   517: aload 6
    //   519: invokeinterface 307 1 0
    //   524: istore_3
    //   525: iconst_0
    //   526: istore_2
    //   527: iload_2
    ...
    //   532: aload 6
    //   534: iload_2
    //   535: invokeinterface 394 2 0
    //   540: checkcast 312	android/util/Pair
    //   543: getfield 328	android/util/Pair:first	Ljava/lang/Object;
    //   546: checkcast 250	java/lang/String
    //   549: astore 10
    //   551: aload 10
    //   553: invokestatic 322	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   556: ifne +71 -> 627
    //   559: aload_0
    //   560: getfield 138	akqe:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   563: aload 10
    //   565: invokevirtual 230	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   568: checkcast 265	akqd
    //   571: astore 10
    //   573: aload 10
    //   575: ifnull +52 -> 627
    //   578: aload 10
    //   580: getfield 354	akqd:jdField_a_of_type_Long	J
    //   583: aload_1
    //   584: getfield 354	akqd:jdField_a_of_type_Long	J
    //   587: lcmp
    //   588: ifge +39 -> 627
    //   591: aload 6
    //   593: iload_2
    //   594: new 312	android/util/Pair
    //   597: dup
    //   598: aload 7
    //   600: aload_1
    //   601: getfield 373	akqd:e	Ljava/lang/String;
    //   604: invokestatic 405	akqe:a	(Ljava/lang/String;)Ljava/lang/String;
    //   607: invokespecial 417	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   610: invokeinterface 397 3 0
    //   615: aload 9
    //   617: monitorexit
    //   618: goto -182 -> 436
    //   621: astore_1
    ...
    //   631: goto -104 -> 527
    //   634: astore 6
    //   636: invokestatic 400	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   639: ifeq -24 -> 615
    //   642: aload 6
    //   644: invokevirtual 403	java/lang/Throwable:printStackTrace	()V
    //   647: goto -32 -> 615
    //   650: iconst_0
    //   651: istore_2
    //   652: goto -61 -> 591
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (!localakqe.jdField_b_of_type_Boolean)
    {
      ...
      {
        localakqe.jdField_c_of_type_Boolean = paramQQAppInterface.getBoolean(str + "_" + "redbag_fold_msg_switch", MessageForFoldMsgGrayTips.PASSWD_REDBAG_MSG_SWITCH_DEFAULT);
        localakqe.jdField_a_of_type_Int = paramQQAppInterface.getInt(str + "_" + "redbag_fold_msg_num", MessageForFoldMsgGrayTips.PASSWD_REDBAG_MSG_DISPLAY_NUM_DEFAULT);
        localakqe.jdField_d_of_type_Boolean = paramQQAppInterface.getBoolean(str + "_" + "redbag_fold_index_switch", MessageForFoldMsgGrayTips.PASSWD_REDBAG_MSG_SWITCH_INDEX);
        localakqe.jdField_e_of_type_Boolean = paramQQAppInterface.getBoolean(str + "_" + "redbag_fold_index_with_redbagid", MessageForFoldMsgGrayTips.PASSWD_REDBAG_MSG_INDEX_WITH_ID);
      }
      if (QLog.isColorLevel()) {
        QLog.d("msgFold", 2, String.format("getFoldSwitch, first init, switch: %s, num: %d, indexSwitch: %s, indexWithId: %s ", new Object[] { Boolean.valueOf(localakqe.jdField_c_of_type_Boolean), Integer.valueOf(localakqe.jdField_a_of_type_Int), Boolean.valueOf(localakqe.jdField_d_of_type_Boolean), Boolean.valueOf(localakqe.jdField_e_of_type_Boolean) }));
      }
    }
    localakqe.jdField_b_of_type_Boolean = true;
  }
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        if ((i5 == 0) || (i6 == 0) || (i3 == 0) || (i4 == 0))
        {
          ...
          paramString = (akqe)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER);
          ...
          bhhr.a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), paramInt, bool1, k, bool2, bool3);
          return;
        }
        i3 = n;
        i4 = k;
  ...
  private void a(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((paramBoolean) && ((paramInt == 1) || (paramInt == 3000))) {
        akwm.a(paramString2, paramInt, paramString1);
      }
      paramString2 = (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    return ((akqe)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER)).jdField_c_of_type_Boolean;
  }
  ...
  {
    boolean bool = true;
    if ((!StringUtil.isEmpty(paramString)) && (paramString.trim().length() > 1) && (paramString.trim().matches("[a-zA-Z]+"))) {}
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  private boolean a(String paramString1, String paramString2, akqd paramakqd)
  {
    if (TextUtils.isEmpty(paramString1)) {}
    String str;
    do
    ...
    } while ((TextUtils.isEmpty(paramString2)) || (!paramString2.contains(str)) || (!paramakqd.a(paramString1.length())));
    return true;
  }
  ...
  {
    a(paramQQAppInterface);
    return ((akqe)paramQQAppInterface.getManager(QQManagerFactory.PASSWD_RED_BAG_MANAGER)).jdField_d_of_type_Boolean;
  }
  ...
  private boolean b(String paramString1, String paramString2, akqd paramakqd)
  {
    if (TextUtils.isEmpty(paramString1)) {}
    do
    {
      return false;
      paramString1 = paramString1.trim();
    } while ((TextUtils.isEmpty(paramString1)) || (paramString1.length() <= 1) || (!paramString1.contains(paramString2)) || (!paramakqd.a(paramString1.length())));
    return true;
  }
  ...
  public akqd a(String paramString)
  {
    if (paramString == null) {
      return null;
    }
    a(false);
    return (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
  }
      ...
      if (localBitmap1 == null) {
        ...
        catch (Exception localException1)
        {
          for (;;)
          {
            try
            {
              localObject2 = Bitmap.createScaledBitmap(localObject1, DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 15.0F), true);
  ...
  public MessageRecord a(List<MessageRecord> paramList, MessageForFoldMsg paramMessageForFoldMsg, LinkedHashSet<String> arg3, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Object localObject2;
    Object localObject3;
    if ((QLog.isColorLevel()) && (bhhy.a()) && (paramList.size() > 0))
    {
    ...
    for (;;)
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80064BC", "0X80064BC", 0, 0, "", "", "", "");
      return paramList;
      ...
      {
        localObject1 = (MessageForFoldMsgGrayTips)bcsa.a(-5011);
        bcsa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, paramMessageForFoldMsg.frienduin, paramMessageForFoldMsg.frienduin, paramMessageForFoldMsg.istroop);
        ...
        for (;;)
        {
          synchronized (this.jdField_b_of_type_JavaLangObject)
          {
            ...
            if (paramBoolean2)
            {
              ...
              try
              {
                acnh.c(paramList, (MessageRecord)localObject1, true);
                ((Lock)localObject2).unlock();
                ...
                if ((!QLog.isColorLevel()) || (!bhhy.a()) || (paramList == null) || (paramList.size() <= 0)) {
                  break label1221;
                }
  ...
  public Boolean a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getAIOList(paramString1, paramInt);
  ...
  public void a()
  {
    ...
    do
    {
      ...
      List localList = this.jdField_a_of_type_Akqc.a(1);
      Iterator localIterator = this.jdField_i_of_type_JavaUtilHashMap.keySet().iterator();
      while (localIterator.hasNext())
      {
        Object localObject = (String)localIterator.next();
        akqn localakqn = new akqn();
        localakqn.jdField_a_of_type_Long = Long.parseLong((String)localObject);
        localakqn.jdField_a_of_type_Int = 1;
        localakqn.b = Long.parseLong((String)this.jdField_i_of_type_JavaUtilHashMap.get(localObject));
        int k = localList.indexOf(localakqn);
        if (k != -1)
        {
          localObject = (akqn)localList.get(k);
          if (localakqn.b <= ((akqn)localObject).b) {}
        }
        else
        {
          localObject = new oidb_0x438.ReqInfo();
          ((oidb_0x438.ReqInfo)localObject).uint64_code.set(localakqn.jdField_a_of_type_Long);
          ((oidb_0x438.ReqInfo)localObject).uint64_last_redbag_time.set(localakqn.b);
          localArrayList.add(localObject);
          this.jdField_a_of_type_JavaUtilList.add(localakqn);
        }
      }
      this.jdField_i_of_type_JavaUtilHashMap.clear();
    } while (this.jdField_a_of_type_JavaUtilList.isEmpty());
    this.jdField_a_of_type_Aobx.a(0, localArrayList);
  }
  
  public void a(akqd paramakqd, String paramString)
  {
    if (paramakqd != null) {}
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (k < m)
        {
          ...
          if ((localList != null) && (!localList.isEmpty()))
          {
            ...
            {
              if (!((String)localIterator.next()).equals(paramakqd.jdField_a_of_type_JavaLangString)) {
                continue;
              }
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramContext = (agjr)paramContext.getHelper(27);
    } while (paramContext == null);
  ...
  public void a(SessionInfo paramSessionInfo, akqd paramakqd, long paramLong, int paramInt)
  {
    a(paramSessionInfo, paramakqd, paramLong, 32, "", 0, paramInt, null);
  }
  
  public void a(SessionInfo paramSessionInfo, akqd paramakqd, long paramLong, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    a(paramSessionInfo, paramakqd, paramLong, paramInt1, "", 0, paramInt2, paramBundle);
  }
  
  public void a(SessionInfo paramSessionInfo, akqd paramakqd, long paramLong, int paramInt, Bundle paramBundle)
  {
    a(paramSessionInfo, paramakqd, paramLong, 524288, "", 0, paramInt, paramBundle);
  }
  
  public void a(SessionInfo paramSessionInfo, akqd paramakqd, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, Bundle paramBundle)
  {
    if ((paramSessionInfo == null) || (paramakqd == null)) {}
    String str2;
    do
    {
      return;
      d();
      str2 = (String)this.jdField_d_of_type_JavaUtilHashMap.get(a(paramSessionInfo.curType) + "_" + paramSessionInfo.curFriendUin + "_" + paramakqd.jdField_a_of_type_JavaLangString);
    } while (TextUtils.isEmpty(str2));
    int k;
    Object localObject;
    if ((paramSessionInfo.curType == 0) || (paramSessionInfo.curType == 2) || (paramSessionInfo.curType == 1004) || (paramSessionInfo.curType == 1001) || (paramSessionInfo.curType == 10002))
    {
      k = 1;
      str1 = paramSessionInfo.curFriendUin;
      localObject = String.valueOf(paramakqd.jdField_c_of_type_JavaLangString);
      if (k != 0) {
    ...
    label412:
    for (String str1 = paramSessionInfo.curFriendUin;; str1 = this.jdField_a_of_type_JavaLangString)
    {
      localObject = albv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo);
      k = ((Bundle)localObject).getInt("groupType");
      localObject = ((Bundle)localObject).getString("name");
      paramakqd = paramakqd.jdField_a_of_type_JavaLangString;
      paramSessionInfo = albv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo, k, (String)localObject, paramakqd, str2, str1, "appid#1344242394|bargainor_id#1000030201|channel#msg", "graphb", null, paramInt1, 0, paramString, paramInt2, paramInt3, paramBundle);
      paramString = new Bundle();
      paramString.putString("json", paramSessionInfo.toString());
      paramString.putString("callbackSn", "0");
      paramSessionInfo = paramakqd;
      if (paramakqd != null)
      {
        paramSessionInfo = paramakqd;
        if (paramakqd.length() > 4) {
          paramSessionInfo = "****" + paramakqd.substring(4);
        }
      }
  ...
  public void a(SessionInfo paramSessionInfo, ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (!paramArrayList.isEmpty())) {
      alcm.a().a(new akqh(this, paramArrayList, paramSessionInfo));
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      return;
      a(false);
      localakqd = (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    } while ((localakqd == null) || (localakqd.jdField_b_of_type_Boolean));
    localakqd.jdField_b_of_type_Boolean = true;
    ThreadManager.getFileThreadHandler().post(new PasswdRedBagManager.13(this, paramString));
  }
  
  public void a(String paramString, int paramInt)
  {
    String str = anvx.a(2131707352);
    if (paramInt == 8) {
      str = "匿名不能抢K歌红包哦";
    }
    for (;;)
    {
      ((bgmf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_TIPS_MSG_MANAGER)).a(paramString, str, NetConnInfoCenter.getServerTime(), 10000L, 0, 1);
      return;
      if (paramInt == 9) {
        str = anvx.a(2131707355);
      } else if (paramInt == 10) {
        str = anvx.a(2131707351);
      } else if (paramInt == 11) {
        str = anvx.a(2131707358);
      }
    }
  }
  ...
  public void a(String paramString, SessionInfo paramSessionInfo, akqd paramakqd, long paramLong, int paramInt)
  {
    long l1 = akrn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "idiom_match_in_phone", 0L);
    ...
    if (bool1) {
      alcm.a().a(new akqj(this, paramakqd, paramString, paramSessionInfo, paramLong, paramInt));
    }
  }
  ...
  {
    if ((StringUtil.isEmpty(paramString2)) || (StringUtil.isEmpty(paramString1)) || (StringUtil.isEmpty(paramString3))) {
      return;
    }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    for (;;)
    {
      try
      {
        ...
        a(false);
        akqd localakqd = (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
        if (QLog.isColorLevel()) {
          QLog.d("PasswdRedBagManager", 2, "setPasswdRedBagLastedWord|passwdRedBagInfo: " + localakqd);
        }
        if (localakqd != null) {
          if (TextUtils.isEmpty(paramString3))
          {
            ...
            try
            {
              JSONObject localJSONObject = this.jdField_a_of_type_Akqc.a(localakqd.f);
              if (localJSONObject != null)
              {
                int k = localJSONObject.optInt("key_extstr_idiomseq");
                if (QLog.isColorLevel()) {
                  QLog.d("PasswdRedBagManager", 2, "oldSeq: " + k + " newSeq: " + paramInt + " extObj: " + localJSONObject.toString() + " lastpassword: " + localakqd.e);
                }
                if (paramInt > k)
                {
                  localJSONObject.put("key_extstr_idiomseq", paramInt);
                  akqd.a(localJSONObject, paramString4);
                  localakqd.f = localJSONObject.toString();
                  paramString2 = paramString2.trim() + "_" + paramString3.trim();
                  if (QLog.isColorLevel()) {
                    QLog.d("PasswdRedBagManager", 2, "finalLastWord: " + paramString2);
                  }
                  paramString3 = a(localakqd.e);
                  localakqd.e = paramString2;
                  a(localakqd, paramString3);
  ...
  {
    if ((akqd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1) == null)
    {
      paramString2 = new akqd(paramString1, paramString2, paramString4, paramLong, new QQText(paramString3, 5, 16).toString(), paramBoolean1, paramBoolean2, false, paramInt, paramString8, paramString9);
      a(paramString2);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      bdla.b(localQQAppInterface, "CliOper", "", "", "0X8006115", "0X8006115", 0, 0, "", str, paramString, "0");
      return;
    }
  }
  ...
  {
    alcm.a().a(new akql(this, paramInt2, paramInt1, paramBusinessObserver));
  }
  ...
  public void a(boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        ...
        Iterator localIterator = this.jdField_a_of_type_Akqc.a().iterator();
        if (localIterator.hasNext())
        {
          akqd localakqd = (akqd)localIterator.next();
          a(localakqd);
          a(false, localakqd.jdField_a_of_type_JavaLangString, localakqd.jdField_b_of_type_JavaLangString);
          continue;
        }
  ...
  public boolean a(String paramString, akqd paramakqd)
  {
    if ((StringUtil.isEmpty(paramString)) || (paramakqd == null)) {}
    String str;
    do
    {
      do
      {
            ...
            for (;;)
            {
              ...
              if (paramString.trim().length() >= 4)
              {
                ...
                if ((paramString != null) && (paramString.length != 0))
                {
                  ...
                  while (k < m)
                  {
                    paramakqd = paramString[k];
                    if ((!StringUtil.isEmpty(str)) && (paramakqd.equals(str.trim()))) {
                      return true;
                    }
                    k += 1;
                  }
        ...
        } while ((StringUtil.isEmpty(paramString)) || (!paramString.equalsIgnoreCase(str)));
        return true;
        if (paramakqd.a() != 2) {
          break;
        }
      } while (!b(paramString, str, paramakqd));
      return true;
    } while ((paramakqd.a() != 3) || (!a(paramString, str, paramakqd)));
    return true;
  }
  ...
  public Object[] a(SessionInfo paramSessionInfo, String paramString, int paramInt)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      if (localakqd.jdField_a_of_type_Int != 0) {
        break label327;
      }
    }
    if (QLog.isColorLevel()) {
      QLog.i("PasswdRedBagManager", 2, "----word hb----" + localakqd.jdField_a_of_type_JavaLangString);
    }
    if ((!StringUtil.isEmpty(paramString)) && (localakqd != null) && (!StringUtil.isEmpty(localakqd.d)) && (paramString.trim().equals(localakqd.d.trim())))
    {
      a(localakqd.jdField_a_of_type_JavaLangString, paramSessionInfo.curFriendUin, paramSessionInfo.curType);
      a(paramSessionInfo, localakqd, l, paramInt);
    }
    for (;;)
    {
      return arrayOfObject;
      label327:
      if (4 == localakqd.jdField_a_of_type_Int)
      {
        if (QLog.isColorLevel()) {
          QLog.i("PasswdRedBagManager", 2, "----word chain hb----" + localakqd.jdField_a_of_type_JavaLangString);
        }
        if (a(paramString, localakqd)) {
          a(paramString.trim(), paramSessionInfo, localakqd, l, paramInt);
        }
      }
    }
  }
  ...
  public Object[] a(String paramString1, SessionInfo paramSessionInfo, String paramString2, int paramInt)
  {
    ...
    a(false);
    d();
    akqd localakqd = (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString2);
    if (localakqd == null)
    {
      VACDReportUtil.endReport(l, "pwd.end", "", -1, "no redid");
      return arrayOfObject;
    }
    arrayOfObject[1] = Long.valueOf(localakqd.jdField_c_of_type_JavaLangString);
    if (4 == localakqd.jdField_a_of_type_Int)
    {
      arrayOfObject[2] = null;
      arrayOfObject[3] = null;
    }
    while (4 != localakqd.jdField_a_of_type_Int) {
      if (localakqd.jdField_a_of_type_Boolean)
      {
        VACDReportUtil.endReport(l, "pwd.end", "", -1, "opened");
        return arrayOfObject;
        if ((!localakqd.jdField_c_of_type_Boolean) && (localakqd.jdField_a_of_type_Long >= NetConnInfoCenter.getServerTimeMillis() / 1000L))
        {
          arrayOfObject[2] = paramString2;
          arrayOfObject[3] = localakqd.jdField_b_of_type_JavaLangString;
        }
      }
      else
      {
        if (localakqd.jdField_b_of_type_Boolean)
        {
        ...
        if ((localakqd.jdField_c_of_type_Boolean) || (localakqd.jdField_a_of_type_Long < NetConnInfoCenter.getServerTimeMillis() / 1000L))
        {
          if (!localakqd.jdField_c_of_type_Boolean) {
            b(paramString2);
          }
          if (4 != localakqd.jdField_a_of_type_Int)
          {
    ...
    {
      if ((localakqd.jdField_a_of_type_Int != 0) || (StringUtil.isEmpty(localakqd.d)) || (!paramString1.equals(localakqd.d))) {
        break label436;
      }
      a(localakqd.jdField_a_of_type_JavaLangString, paramSessionInfo.curFriendUin, paramSessionInfo.curType);
      a(paramSessionInfo, localakqd, l, paramInt);
    ...
    for (;;)
    {
      ...
      return arrayOfObject;
      label436:
      if ((4 != localakqd.jdField_a_of_type_Int) || (!a(paramString1, localakqd)) || (localakqd.jdField_b_of_type_Boolean) || (localakqd.a())) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.i("PasswdRedBagManager", 2, "----成语接龙红包----" + localakqd.jdField_a_of_type_JavaLangString);
      }
      a(paramString1.trim(), paramSessionInfo, localakqd, l, paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    do
    {
      ...
      localArrayList = new ArrayList();
      List localList = this.jdField_a_of_type_Akqc.a(2);
      ...
      while (localIterator.hasNext())
      {
        ...
        akqn localakqn = new akqn();
        localakqn.jdField_a_of_type_Long = Long.parseLong((String)localObject);
        localakqn.jdField_a_of_type_Int = 2;
        localakqn.b = Long.parseLong((String)this.jdField_j_of_type_JavaUtilHashMap.get(localObject));
        int k = localList.indexOf(localakqn);
        if (k != -1)
        {
          localObject = (akqn)localList.get(k);
        ...
        else
        {
          ...
          ((oidb_0x438.ReqInfo)localObject).uint64_last_redbag_time.set(localakqn.b);
          localArrayList.add(localObject);
          this.jdField_b_of_type_JavaUtilList.add(localakqn);
        }
      }
      this.jdField_j_of_type_JavaUtilHashMap.clear();
    } while (this.jdField_b_of_type_JavaUtilList.isEmpty());
    this.jdField_a_of_type_Aobx.a(1, localArrayList);
  }
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      a(false);
      localakqd = (akqd)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    } while ((localakqd == null) || (localakqd.jdField_c_of_type_Boolean));
    localakqd.jdField_c_of_type_Boolean = true;
    ThreadManager.getFileThreadHandler().post(new PasswdRedBagManager.14(this, paramString));
  }
  
  public void b(String paramString, int paramInt)
  {
    String str = anvx.a(2131707356);
    if (paramInt == 8) {
      str = "禁言不能抢K歌红包哦";
    }
    for (;;)
    {
      ...
      return;
      if (paramInt == 9) {
        str = anvx.a(2131707353);
      } else if (paramInt == 10) {
        str = anvx.a(2131707354);
      } else if (paramInt == 11) {
        str = anvx.a(2131707357);
      }
    }
  }
  ...
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006116", "0X8006116", 0, 0, "", "0", paramString, "0");
  }
  ...
  public void d()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 1289	akqe:a	()Z
    //   6: ifeq +7 -> 13
    //   9: aload_0
    //   10: invokevirtual 1291	akqe:e	()V
    //   13: aload_0
    //   14: getfield 155	akqe:jdField_h_of_type_Boolean	Z
    //   17: ifeq +12 -> 29
    //   20: aload_0
    //   21: getfield 577	akqe:jdField_i_of_type_Boolean	Z
    //   24: istore_1
    //   25: iload_1
    //   26: ifeq +6 -> 32
    //   29: aload_0
    ...
    //   32: aload_0
    //   33: iconst_1
    //   34: putfield 577	akqe:jdField_i_of_type_Boolean	Z
    //   37: new 1412	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager$10
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 1413	com/tencent/mobileqq/activity/qwallet/PasswdRedBagManager$10:<init>	(Lakqe;)V
    //   45: bipush 32
    //   47: aconst_null
    //   48: iconst_1
    //   49: invokestatic 1414	com/tencent/mobileqq/app/ThreadManager:excute	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   52: goto -23 -> 29
    //   55: astore_2
    //   56: aload_0
    //   57: monitorexit
  ...
  {
    this.jdField_a_of_type_Aoby.a();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aoby);
    this.jdField_a_of_type_Akqc.a();
    if ((this.jdField_a_of_type_Akqm != null) && (this.jdField_a_of_type_AndroidContentContext != null)) {
      this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Akqm);
    }
  }
}
