...
public class akqe
  extends akon
{
  public akqe(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    super(paramQQAppInterface, paramMessageHandler);
  }
  
  private int a(SubMsgType0x27.ForwardBody paramForwardBody, ajxl paramajxl, TroopManager paramTroopManager, Object paramObject, airx paramairx, Friends[] paramArrayOfFriends, int paramInt)
  {
      ...
      if (paramObject.hasNext())
      {
        ...
        case 20002: 
          for (paramInt = i2;; paramInt = n)
          {
            ...
            localObject = paramajxl.e(Long.toString(l2));
            paramForwardBody = null;
            if (localObject != null) {
              paramForwardBody = ((Friends)localObject).name;
            }
            paramArrayOfFriends[i1] = paramajxl.a(l2 + "", paramTroopManager);
            if ((localObject != null) && (((Friends)localObject).isFriend()) && (akes.a(paramTroopManager, paramForwardBody))) {
              akes.a(l2, paramTroopManager, (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53));
            }
            paramForwardBody = paramajxl.b(l2 + "");
            if (paramForwardBody != null)
            {
              paramForwardBody.strNick = paramTroopManager;
              paramajxl.a(paramForwardBody);
        ...
        case 20014: 
          if (paramForwardBody.bytes_value.has())
          {
            ...
            {
              paramTroopManager = (ajti)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2);
    ...
    for (;;)
    {
      ...
      a(i2);
      ((akfv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).notifyUI(101, true, Integer.valueOf(i2));
      n = k;
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      paramForwardBody = paramForwardBody.bytes_value.get();
      paramTroopManager = paramajxl.e(Long.toString(l2));
      n = k;
      if (paramTroopManager == null) {
        break;
      }
      ...
      for (;;)
      {
        ...
        paramajxl.a(paramTroopManager);
        ((akfv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).notifyUI(100, true, null);
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(Long.toString(l2)))
        {
          ...
          paramForwardBody = (ajvn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(12);
          paramForwardBody.a(0, 0);
          paramForwardBody.a(0, 0, 1, 0);
          if (QLog.isColorLevel()) {
            QLog.d("QVipSettingMe.", 2, "[vipInfoPush] 23105 request vipInfoHandler");
          }
          bbxj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "last_pull_pay_rule", 0L);
          ...
          ((akjn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(27)).a(paramForwardBody, l2 + "");
        }
        n = paramInt;
        paramInt = m;
        m = n;
      ...
      localObject = paramajxl.e(paramTroopManager);
      n = k;
      if (localObject == null) {
        break;
      }
      ...
      for (;;)
      {
        ...
        paramajxl.a((Friends)localObject);
      ...
      if ((paramForwardBody.byteAt(12) & 0x8) != 0)
      {
        bool1 = true;
        label3354:
        ayaj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool1);
      ...
      paramTroopManager = paramajxl.a(String.valueOf(l2));
      ...
      if (paramForwardBody.colorRingId != n)
      {
        ...
        paramForwardBody.timestamp = System.currentTimeMillis();
        paramajxl.a(paramForwardBody);
        bbpb.a(paramForwardBody.uin, 1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
      n = k;
      if (!QLog.isColorLevel()) {
        break;
      ...
      break label689;
      i2 = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asShortBuffer().get();
      paramForwardBody = paramairx.b(String.valueOf(l2));
      if (QLog.isColorLevel()) {
      ...
      if (paramForwardBody.apolloStatus != n)
      {
        ...
        {
          paramForwardBody = (bbrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
          if (paramForwardBody != null) {
      ...
      paramTroopManager = ajfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (paramTroopManager != null) {
      ...
      paramTroopManager = paramairx.b(paramForwardBody);
      if (paramForwardBody.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c())) {
        ((bbrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(new long[] { l2 });
      }
      ...
      if ((!paramForwardBody.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c())) || (airx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != 2))
      {
        n = k;
        if (i2 == 0) {
          break;
      ...
      n = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asShortBuffer().get();
      if (n != airx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
      {
        paramForwardBody = (airx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
      ...
      if (paramairx != null)
      {
        paramForwardBody = paramairx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      ...
      for (i2 = paramForwardBody[0];; i2 = ByteBuffer.wrap(paramForwardBody).asShortBuffer().get())
      {
        ...
        paramForwardBody = paramairx.b((String)localObject);
        ...
        if (paramForwardBody.cmshow3dFlag != i2)
        {
          ...
          localObject = ajfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          if (localObject != null) {
            ((ajfe)localObject).a(3, paramTroopManager);
          }
        }
        n = k;
        if ((i2 & 0x1) != 1) {
      ...
      for (n = paramForwardBody[0];; n = ByteBuffer.wrap(paramForwardBody).asShortBuffer().get())
      {
        paramForwardBody = paramajxl.e(Long.toString(l2));
        if (paramForwardBody != null)
        {
      ...
      break label689;
      n = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asIntBuffer().get();
      ((bbrg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.b(Long.toString(l2), n);
      if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        bool1 = true;
        paramTroopManager = (aseu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(303);
      ...
      {
        paramForwardBody = aujf.a(n);
        paramTroopManager = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getOnlineStatus();
        l3 = aujc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      if ((!bool1) && (aylh.a(String.valueOf(i2)))) {
      ...
      for (;;)
      {
        ...
        m = n;
        break label689;
        aymn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(i2), "20000000");
      }
      i2 = ByteBuffer.wrap(paramForwardBody.bytes_value.get().toByteArray()).asIntBuffer().get();
      ...
      for (;;)
      {
        aexb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(bool1);
      ...
      if (paramForwardBody.length > 1) {
        if (paramForwardBody[1] == 1)
        {
          ...
          if (bool1)
          {
            paramForwardBody = (amue)ampl.a().a(442);
            bool2 = bool1;
            if (paramForwardBody != null)
            {
              bool2 = bool1;
      ...
      for (;;)
      {
        ...
        paramForwardBody = (ajti)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2);
        paramTroopManager = new ArrayList();
      ...
      amgb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(n);
      n = paramInt;
      paramInt = m;
      m = n;
      break label689;
      ...
      if (m != 0)
      {
        ...
        paramajxl = paramajxl.a(String.valueOf(l2));
        paramForwardBody = paramajxl;
        if (paramajxl == null)
        {
          paramForwardBody = new ExtensionInfo();
          paramForwardBody.uin = String.valueOf(l2);
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    bbmx.a(paramMsgInfo, 0);
    int i = paramMsgInfo[4];
    bbmx.a(paramMsgInfo, 5);
    bbmx.a(paramMsgInfo, 9);
    bbmx.a(paramMsgInfo, 13);
    i = paramMsgInfo[17];
    bbmx.a(paramMsgInfo, 18);
    bbmx.a(paramMsgInfo, 22);
    bbmx.a(paramMsgInfo, 24);
    return null;
  }
  
  private void a(int paramInt)
  {
    ((akfv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(paramInt);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(localMsgInfo.lFromUin);
        ...
        if ((42 != j) && (83 != j) && (127 != j) && (QLog.isColorLevel())) {
          akas.a("Q.msg.BaseMessageProcessor", str1, localMsgInfo.shMsgSeq, String.valueOf(l3), String.valueOf(localMsgInfo.lFromUin));
        }
        if (QLog.isColorLevel()) {
        ...
        if (!akqh.a().containsKey(Integer.valueOf(j))) {
          continue;
        }
      ...
      catch (Exception paramToServiceMsg)
      {
        ...
        QLog.w("Q.msg.BaseMessageProcessor", 2, "~~~~~handleC2COnlinePushMsgResp Exception msgInfo.vMsg: " + bbea.a(localMsgInfo.vMsg));
        continue;
      }
      if (paramToServiceMsg != null)
      {
        localMessageRecord = axas.a(i);
        if (j != 1006) {
          break label2065;
        }
        str2 = bbcz.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2));
        localMessageRecord.init(String.valueOf(l3), bbcz.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1)), str2, paramToServiceMsg, localMsgInfo.uRealMsgTime, i, j, localMsgInfo.uMsgTime);
        ...
        if (!akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, true)) {
          localArrayList1.add(localMessageRecord);
        }
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleC2COnlinePushMsgResp after analysis friendUin: " + l1 + " msgType: " + i + " friendType: " + j + " shMsgSeq: " + localMsgInfo.shMsgSeq + " msgContent: " + bbbr.a(paramToServiceMsg));
        }
      }
      if (localMsgInfo.uAppShareID <= 0L) {
        break label153;
      }
      localArrayList4.add(bbcc.a(localMsgInfo.uAppShareID));
      break label153;
      bazy.a(false);
      break;
      ...
      if (169 == j)
      {
        ...
        if (akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, String.valueOf(l1), String.valueOf(l2), localMsgInfo.uMsgTime, localMsgInfo.shMsgSeq)) {
          break label153;
        }
      ...
      if (8 == j)
      {
        ...
        if (localMsgInfo.vMsg.length > 4) {
          bbmx.a(paramToServiceMsg, 0, localMsgInfo.vMsg, 0, 4);
        }
        l2 = bbmx.a(paramToServiceMsg, 0);
        if (localMsgInfo.vMsg.length >= 9)
        {
          paramToServiceMsg = new byte[localMsgInfo.vMsg.length - 9];
          bbmx.a(paramToServiceMsg, 0, localMsgInfo.vMsg, 8, paramToServiceMsg.length);
          paramToServiceMsg = new String(axau.a(paramToServiceMsg), "utf-8");
          break label2280;
        }
      }
      else
      {
        ...
        if (732 == j)
        {
          ...
          bbmx.a(paramToServiceMsg, 0, localMsgInfo.vMsg, 0, paramToServiceMsg.length);
          i = paramToServiceMsg[4];
          if (!QLog.isColorLevel()) {
            break label2325;
          }
          QLog.d("Q.msg.BaseMessageProcessor", 2, "<---0x2dc push  groupCode:" + bbmx.a(localMsgInfo.vMsg, 0) + " subType:" + i + "msgSeq:" + localMsgInfo.shMsgSeq);
          break label2325;
          label1367:
          if (localMsgInfo.vMsg.length <= 7) {
            break label2349;
          }
          paramToServiceMsg = (bamx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(81);
          localObject = new byte[localMsgInfo.vMsg.length - 7];
          bbmx.a((byte[])localObject, 0, localMsgInfo.vMsg, 7, localObject.length);
          ...
          break label2349;
          label1459:
          ((baky)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramToServiceMsg, localMsgInfo.shMsgSeq);
          break label2349;
          label1484:
          if (i == 15)
          {
          ...
          bbmx.a(paramToServiceMsg, 0, localMsgInfo.vMsg, 7, paramToServiceMsg.length);
          b(paramToServiceMsg, i);
          break label2349;
        }
        if (230 == j)
        {
          paramToServiceMsg = new String(axau.a(localMsgInfo.vMsg), "utf-8");
          localObject = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(l1 + "");
          ...
          for (j = 0;; j = 1006)
          {
            ...
            bool1 = true;
            break;
            localObject = ((askn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11)).b(String.valueOf(l2));
        ...
        if (SystemMsg.isTroopSystemMessage(j))
        {
          ...
          if (j == 45)
          {
            ...
            if ((paramToServiceMsg == null) || (akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramToServiceMsg, true))) {
              break label2413;
            }
            localArrayList1.add(paramToServiceMsg);
            break label2413;
      ...
      for (;;)
      {
        aydd.a().a(l2, localMsgInfo.uMsgTime, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        k = i;
        localObject = null;
        paramToServiceMsg = null;
        int m = 0;
        ...
        {
          bool2 = akas.a(localArrayList1);
          i = akpx.a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private void a(String paramString, long paramLong1, long[] paramArrayOfLong, byte[] paramArrayOfByte, long paramLong2, short paramShort, boolean paramBoolean)
  {
    ...
    paramArrayOfByte = ayph.a(paramArrayOfByte, paramArrayOfLong);
  ...
  {
    boolean bool = false;
    long l1 = bbmx.a(paramArrayOfByte, 0);
    if (paramArrayOfByte[4] == 15)
    {
      long l2 = bbmx.a(paramArrayOfByte, 5);
      long l3 = bbmx.a(paramArrayOfByte, 9);
      int i = bbmx.b(paramArrayOfByte, 13);
      paramArrayOfByte = bbmx.a(paramArrayOfByte, 15, i);
  ...
  private akqi b(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    return this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(akqh.a(paramInt)).a(akqh.a(paramInt), paramMsgInfo, paramSvcReqPushMsg);
  }
  ...
  private MessageRecord b(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    //   19: invokestatic 1507	awzq:a	([B)LIMMsgBodyPack/MsgType0x210;
    //   22: astore 32
    //   24: aload 32
    //   26: ifnonnull +5 -> 31
    //   29: aconst_null
    ...
    //   122: ifle -93 -> 29
    //   125: aload_0
    //   126: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   129: bipush 12
    //   131: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   134: checkcast 1528	axbv
    //   137: astore_1
    //   138: aload_1
    //   139: ifnull -110 -> 29
    //   142: aload 28
    ...
    //   204: invokevirtual 1543	axbv:a	(JZJ)V
    //   207: goto -56 -> 151
    //   210: iconst_1
    //   211: istore 19
    //   213: goto -18 -> 195
    ...
    //   257: invokevirtual 1552	akqe:a	([B)V
    //   260: aconst_null
    //   261: areturn
    //   262: aload 32
    ...
    //   314: aload_0
    //   315: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   318: bipush 11
    //   320: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    ...
    //   369: aload_0
    //   370: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   373: bipush 18
    //   375: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   378: checkcast 1575	akgg
    //   381: aload 32
    //   383: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   386: invokevirtual 1576	akgg:a	([B)V
    //   389: aconst_null
    //   390: areturn
    //   391: aload 32
    ...
    //   410: invokespecial 1580	akqe:b	(J[B)V
    //   413: aconst_null
    //   414: areturn
    //   415: aload 32
    ...
    //   637: istore 4
    //   639: aload_0
    //   640: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   643: iconst_1
    //   644: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    ...
    //   720: sipush -1000
    //   723: invokestatic 1219	axas:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   737: aload_0
    //   738: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   758: aload 31
    //   760: aload_0
    //   761: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   787: iload 4
    //   789: aload_0
    //   790: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   816: aload_0
    //   817: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   820: invokevirtual 694	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/message/QQMessageFacade;
    //   823: aload 31
    //   825: aload_0
    //   826: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   917: ifeq +140 -> 1057
    //   920: sipush -5001
    //   923: invokestatic 1219	axas:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    //   926: checkcast 1670	com/tencent/mobileqq/data/MessageForNewGrayTips
    //   929: astore 31
    //   931: aload 31
    //   933: aload_0
    //   934: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   952: lconst_1
    //   953: aload_0
    //   954: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   990: aload_0
    //   991: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   994: invokevirtual 694	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/message/QQMessageFacade;
    //   997: aload 31
    //   999: aload_0
    //   1000: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1054: goto -372 -> 682
    //   1057: sipush -5000
    //   1060: invokestatic 1219	axas:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    //   1063: astore 31
    //   1065: aload 31
    //   1067: aload_0
    //   1068: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1086: lconst_1
    //   1087: aload_0
    //   1088: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1113: aload_0
    //   1114: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1117: invokevirtual 694	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/message/QQMessageFacade;
    //   1120: aload 31
    //   1122: aload_0
    //   1123: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1324: astore_1
    //   1325: aload_0
    //   1326: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1329: bipush 52
    ...
    //   1371: aload_0
    //   1372: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1375: bipush 20
    //   1377: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   1380: checkcast 1718	akhp
    //   1383: aload_1
    //   1384: invokevirtual 1720	akhp:f	(Ljava/lang/String;)V
    //   1387: aload 28
    ...
    //   1406: lstore_2
    //   1407: aload_0
    //   1408: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1411: bipush 20
    //   1413: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   1416: checkcast 1718	akhp
    //   1419: lload_2
    //   1420: invokestatic 495	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   1423: invokevirtual 1720	akhp:f	(Ljava/lang/String;)V
    //   1426: aconst_null
    //   1427: areturn
    //   1428: astore_1
    ...
    //   1468: ifne +25 -> 1493
    //   1471: aload_0
    //   1472: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1475: bipush 17
    //   1477: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1480: checkcast 446	ayaj
    //   1483: aload 32
    //   1485: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   1488: invokevirtual 1725	ayaj:a	([B)V
    //   1491: aconst_null
    //   1492: areturn
    //   1493: aload 32
    ...
    //   1502: ifne +17 -> 1519
    //   1505: aload_0
    //   1506: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1509: aload 32
    //   1511: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   1514: invokestatic 1732	ajud:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[B)V
    //   1517: aconst_null
    //   1518: areturn
    //   1519: aload 32
    //   1521: ifnull +35 -> 1556
    ...
    //   1551: invokevirtual 1735	akqe:a	(J[B)V
    //   1554: aconst_null
    //   1555: areturn
    //   1556: aload 32
    //   1558: ifnull +35 -> 1593
    ...
    //   1587: invokevirtual 1738	akqe:a	([B)Ljava/lang/String;
    //   1590: pop
    //   1591: aconst_null
    //   1592: areturn
    //   1593: aload 32
    ...
    //   1619: invokespecial 1742	akqe:f	([B)V
    //   1622: aconst_null
    //   1623: areturn
    //   1624: aload 32
    ...
    //   1650: invokevirtual 1746	akqe:b	([B)V
    //   1653: aconst_null
    //   1654: areturn
    //   1655: aload 32
    ...
    //   1681: invokespecial 1751	akqe:g	([B)V
    //   1684: aconst_null
    //   1685: areturn
    //   1686: aload 32
    ...
    //   1712: invokespecial 1756	akqe:h	([B)V
    //   1715: aconst_null
    //   1716: areturn
    //   1717: aload 32
    ...
    //   1735: invokevirtual 1760	akqe:d	([B)V
    //   1738: aconst_null
    //   1739: areturn
    //   1740: aload 32
    ...
    //   1758: invokevirtual 1764	akqe:e	([B)V
    //   1761: aconst_null
    //   1762: areturn
    //   1763: aload 32
    ...
    //   1789: invokevirtual 1768	akqe:c	([B)V
    //   1792: aconst_null
    //   1793: areturn
    //   1794: aload 32
    ...
    //   1988: pop
    //   1989: aload_0
    //   1990: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1993: aload 28
    ...
    //   2063: aload 30
    //   2065: aastore
    //   2066: invokevirtual 1827	akqe:a	(IZLjava/lang/Object;)V
    //   2069: aconst_null
    //   2070: areturn
    //   2071: astore_1
    ...
    //   2106: ldc 140
    //   2108: aastore
    //   2109: invokevirtual 1827	akqe:a	(IZLjava/lang/Object;)V
    //   2112: aconst_null
    //   2113: areturn
    //   2114: aload 32
    ...
    //   2372: invokestatic 1860	aoes:a	()Laoes;
    //   2375: aload_0
    //   2376: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2379: aload 28
    //   2381: aload 29
    //   2383: aload 30
    //   2385: aload 31
    //   2387: invokevirtual 1863	aoes:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[B)V
    //   2390: aload_1
    ...
    //   2411: istore 5
    //   2413: aload_0
    //   2414: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   2417: lload_2
    //   2418: iload 4
    //   2420: lload 15
    //   2422: iload 5
    //   2424: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   2427: aconst_null
    //   2428: areturn
    //   2429: astore 28
    ...
    //   2467: ifnull +25 -> 2492
    //   2470: aload_0
    //   2471: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2474: bipush 24
    //   2476: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   2479: checkcast 1874	akfz
    //   2482: aload 32
    //   2484: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   2487: invokevirtual 1875	akfz:a	([B)V
    //   2490: aconst_null
    //   2491: areturn
    //   2492: aload 32
    ...
    //   2528: aload_0
    //   2529: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2532: iconst_4
    //   2533: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   2536: checkcast 1729	ajud
    //   2539: astore_1
    //   2540: aload_1
    //   2541: ifnull -2512 -> 29
    ...
    //   2705: iload 4
    //   2707: aload 29
    //   2709: invokevirtual 1909	ajud:a	(Ljava/lang/String;ILjava/util/ArrayList;)V
    //   2712: aconst_null
    //   2713: areturn
    //   2714: sipush 3000
    //   2717: istore 4
    ...
    //   2846: astore_1
    //   2847: aload_0
    //   2848: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2851: iconst_3
    //   2852: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   2855: checkcast 1929	ajzj
    //   2858: astore 28
    //   2860: aload 28
    //   2862: ifnull -2833 -> 29
    //   2865: aload 28
    //   2867: aload_1
    //   2868: invokevirtual 1932	ajzj:a	(Ljava/util/List;)V
    //   2871: aconst_null
    //   2872: areturn
    //   2873: iconst_0
    //   2874: istore 19
    ...
    //   2930: ifne +27 -> 2957
    //   2933: aload_0
    //   2934: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2937: bipush 22
    //   2939: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   2942: checkcast 1939	akfc
    //   2945: astore_1
    //   2946: aload_1
    //   2947: ifnull -2918 -> 29
    //   2950: aload_1
    //   2951: invokevirtual 1940	akfc:a	()Z
    //   2954: pop
    //   2955: aconst_null
    //   2956: areturn
    //   2957: aload 32
    ...
    //   2993: aload_0
    //   2994: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2997: ldc_w 1946
    //   3000: ldc 140
    //   3002: ldc 140
    //   3004: ldc_w 1948
    ...
    //   3016: ldc 140
    //   3018: ldc 140
    //   3020: invokestatic 1953	axqy:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   3038: invokespecial 1962	lxq:<init>	(Landroid/content/Context;)V
    //   3041: new 1964	akqf
    //   3044: dup
    //   3045: aload_0
    //   3046: aload 32
    //   3048: invokespecial 1967	akqf:<init>	(Lakqe;LIMMsgBodyPack/MsgType0x210;)V
    //   3051: invokevirtual 1970	lxq:a	(Llxr;)V
    //   3054: aconst_null
    //   3055: areturn
    //   3056: aload 32
    ...
    //   3092: aload_0
    //   3093: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   3096: aload 32
    ...
    //   3117: invokestatic 1981	agwy:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BJIJI)V
    //   3120: aconst_null
    //   3121: areturn
    //   3122: aload 32
    ...
    //   3139: ifnull +17 -> 3156
    //   3142: aload_0
    //   3143: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   3146: aload 32
    //   3148: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   3151: invokestatic 1986	aeym:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[B)V
    //   3154: aconst_null
    //   3155: areturn
    //   3156: aload 32
    ...
    //   3192: aload_0
    //   3193: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   3196: aload 32
    ...
    //   3217: invokestatic 1992	agwy:b	(Lcom/tencent/mobileqq/app/QQAppInterface;[BJIJI)V
    //   3220: aconst_null
    //   3221: areturn
    //   3222: aload 32
    ...
    //   3258: aload_0
    //   3259: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   3262: aload 32
    //   3264: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   3267: invokestatic 1999	axaq:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[B)V
    //   3270: aload_1
    ...
    //   3291: istore 5
    //   3293: aload_0
    //   3294: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   3297: invokevirtual 1284	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/MessageHandler;
    //   3300: lload_2
    //   3301: iload 4
    //   3303: lload 15
    //   3305: iload 5
    //   3307: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   3310: aconst_null
    //   3311: areturn
    //   3312: aload 32
    ...
    //   3384: lstore_2
    //   3385: aload_0
    //   3386: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   3603: aload 32
    //   3605: aastore
    //   3606: invokevirtual 1827	akqe:a	(IZLjava/lang/Object;)V
    //   3609: aload_1
    ...
    //   3630: istore 5
    //   3632: aload_0
    //   3633: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   3636: lload_2
    //   3637: iload 4
    //   3639: lload 15
    //   3641: iload 5
    //   3643: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   3646: aconst_null
    //   3647: areturn
    //   3648: astore 30
    //   3650: aload 29
    ...
    //   3726: ldc 140
    //   3728: aastore
    //   3729: invokevirtual 1827	akqe:a	(IZLjava/lang/Object;)V
    //   3732: goto -123 -> 3609
    ...
    //   3763: ifne +46 -> 3809
    //   3766: aload_0
    //   3767: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   3770: aload 32
    //   3772: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   3775: invokestatic 2043	mxn:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[B)Ltencent/im/oidb/cmd0x791/oidb_0x791$RedDotInfo;
    //   3778: astore_1
    //   3779: aload_1
    //   3780: ifnull -3751 -> 29
    ...
    //   3802: iconst_1
    //   3803: aload_1
    //   3804: invokevirtual 1827	akqe:a	(IZLjava/lang/Object;)V
    //   3807: aconst_null
    //   3808: areturn
    //   3809: aload 32
    ...
    //   3835: ldc_w 2055
    //   3838: aastore
    //   3839: invokestatic 2060	vei:a	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   3842: aconst_null
    //   3843: areturn
    //   3844: aload 32
    ...
    //   4179: aload_0
    //   4180: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4183: bipush 71
    //   4185: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   4188: checkcast 2110	anmj
    //   4191: astore 28
    //   4193: aload 28
    //   4195: ifnull +13 -> 4208
    //   4198: aload 28
    //   4200: invokevirtual 2113	anmj:a	()Lannm;
    //   4203: aload 30
    //   4205: invokevirtual 2118	annm:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x6f/SubMsgType0x6f$MCardNotificationLike;)V
    //   4208: aload_1
    ...
    //   4229: istore 6
    //   4231: aload_0
    //   4232: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   4235: lload_2
    //   4236: iload 5
    //   4238: lload 15
    //   4240: iload 6
    //   4242: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   4245: iload 4
    //   4247: iconst_1
    //   4248: iadd
    //   4249: istore 4
    ...
    //   4509: aload_0
    //   4510: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4513: sipush 131
    //   4516: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   4519: checkcast 2154	ajzd
    //   4522: astore 31
    //   4524: aload 31
    //   4526: iload 7
    //   4528: iload 8
    //   4530: iconst_1
    //   4531: invokevirtual 2157	ajzd:a	(IIZ)V
    //   4534: aload 31
    //   4536: iload 9
    //   4538: aload 30
    //   4540: invokevirtual 2160	ajzd:a	(ILjava/lang/String;)V
    ...
    //   4631: aload_0
    //   4632: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4635: iconst_2
    ...
    //   4649: astore 30
    //   4651: aload_0
    //   4652: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4655: bipush 27
    //   4657: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   4660: checkcast 386	akjn
    //   4663: aload 30
    //   4665: aload 28
    //   4667: invokevirtual 389	akjn:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   4670: aload_0
    //   4671: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4674: invokestatic 2173	bbtq:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Lbbtq;
    //   4677: invokevirtual 2175	bbtq:b	()V
    //   4680: goto -472 -> 4208
    //   4683: astore_1
    ...
    //   4857: aload_0
    //   4858: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4861: bipush 51
    //   4863: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   4866: checkcast 2211	yah
    //   4869: bipush 111
    //   4871: aload 30
    //   4873: invokevirtual 2214	yah:a	(ILandroid/os/Bundle;)V
    //   4876: goto -668 -> 4208
    //   4879: iload 5
    //   4881: sipush 2007
    ...
    //   4914: aload_0
    //   4915: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4918: bipush 53
    //   4920: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   4923: checkcast 2225	ajsi
    //   4926: aload 28
    //   4928: invokevirtual 2228	ajsi:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x6f/SubMsgType0x6f$ForwardBody;)V
    //   4931: goto -723 -> 4208
    //   4934: iload 5
    //   4936: sipush 2011
    ...
    //   5173: aload 30
    //   5175: invokestatic 2307	awzy:a	()J
    ...
    //   5197: aload_0
    //   5198: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5201: bipush 34
    //   5203: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   5206: checkcast 2317	akbn
    //   5209: aload 30
    //   5211: invokevirtual 2320	akbn:b	(Lcom/tencent/mobileqq/data/QIMFollwerAdd;)V
    //   5214: goto -1006 -> 4208
    //   5217: iload 5
    //   5219: iconst_2
    ...
    //   5466: goto -88 -> 5378
    //   5469: aload 30
    //   5471: invokestatic 2307	awzy:a	()J
    ...
    //   5514: aload_0
    //   5515: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5518: sipush 257
    //   5521: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   5524: checkcast 2403	akdq
    //   5527: aload 30
    //   5529: invokevirtual 2406	akdq:a	(Lcom/tencent/mobileqq/data/QIMNotifyAddFriend;)V
    //   5532: goto -1324 -> 4208
    //   5535: aload 32
    ...
    //   5632: aload_0
    //   5633: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5636: bipush 79
    ...
    //   5692: aload_0
    //   5693: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5696: aload_0
    //   5697: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   5710: invokestatic 2439	andt:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;I)V
    //   5713: aconst_null
    //   5714: areturn
    //   5715: iload 4
    //   5717: bipush 46
    ...
    //   5722: aload_0
    //   5723: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5726: aload_0
    //   5727: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   5740: ldc_w 2441
    //   5743: invokestatic 2446	zct:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;ILjava/lang/String;)V
    //   5746: aconst_null
    //   5747: areturn
    //   5748: iload 4
    //   5750: sipush 1003
    ...
    //   5756: aload_0
    //   5757: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5760: sipush 167
    ...
    //   5783: aload_0
    //   5784: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   5813: aload_0
    //   5814: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5817: sipush 222
    //   5820: aload_0
    //   5821: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5824: invokevirtual 319	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   5827: invokestatic 2458	andt:a	(Lcom/tencent/mobileqq/app/QQAppInterface;ILjava/lang/String;)V
    ...
    //   5890: aload_0
    //   5891: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5894: sipush 341
    //   5897: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   5900: checkcast 2462	ahfo
    //   5903: astore 28
    //   5905: aload_0
    //   5906: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5909: ifnull -5880 -> 29
    //   5912: aload 28
    //   5914: aload_0
    //   5915: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5918: aload_1
    ...
    //   5925: invokevirtual 2465	ahfo:a	(Lcom/tencent/mobileqq/app/QQAppInterface;I)V
    //   5928: aconst_null
    //   5929: areturn
    //   5930: iload 4
    //   5932: sipush 539
    ...
    //   5954: invokestatic 1018	ampl:a	()Lampl;
    //   5957: iload 4
    //   5959: aload_0
    //   5960: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   5963: invokevirtual 319	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   5966: invokevirtual 2468	ampl:a	(ILjava/lang/String;)I
    //   5969: istore 5
    ...
    //   6021: invokestatic 1018	ampl:a	()Lampl;
    //   6024: iconst_1
    //   6025: newarray int
    //   6027: dup
    //   6028: iconst_0
    //   6029: iload 4
    //   6031: iastore
    //   6032: invokevirtual 2473	ampl:a	([I)V
    //   6035: aconst_null
    //   6036: areturn
    //   6037: astore_1
    //   6038: ldc_w 520
    ...
    //   6076: ifne +26 -> 6102
    //   6079: aload_0
    //   6080: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6083: bipush 36
    //   6085: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   6088: checkcast 2479	avps
    //   6091: aload 32
    //   6093: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   6096: invokevirtual 2482	avps:a	([B)Z
    //   6099: pop
    //   6100: aconst_null
    //   6101: areturn
    //   6102: aload 32
    ...
    //   6111: ifne +25 -> 6136
    //   6114: aload_0
    //   6115: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6118: bipush 36
    //   6120: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   6123: checkcast 2479	avps
    //   6126: aload 32
    //   6128: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   6131: invokevirtual 2485	avps:a	([B)V
    //   6134: aconst_null
    //   6135: areturn
    //   6136: aload 32
    ...
    //   6145: ifne +284 -> 6429
    //   6148: aload_0
    //   6149: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6152: bipush 85
    //   6154: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   6157: checkcast 2489	akjv
    //   6160: astore 28
    //   6162: aload 28
    //   6164: aload_1
    //   6165: getfield 1164	OnlinePushPack/MsgInfo:shMsgSeq	S
    //   6168: invokevirtual 2491	akjv:a	(I)Z
    //   6171: ifne +220 -> 6391
    ...
    //   6315: invokevirtual 2531	akjv:a	(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    //   6334: aload_0
    //   6335: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6338: ldc_w 2535
    //   6341: ldc_w 2537
    //   6344: ldc 140
    //   6346: ldc 140
    ...
    //   6364: ldc 140
    //   6366: invokestatic 1953	axqy:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   6369: aconst_null
    //   6370: areturn
    //   6371: astore_1
    ...
    //   6471: istore 6
    //   6473: aload_0
    //   6474: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6477: bipush 85
    //   6479: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   6482: checkcast 2489	akjv
    //   6485: aload_1
    //   6486: getfield 1164	OnlinePushPack/MsgInfo:shMsgSeq	S
    //   6489: invokevirtual 2491	akjv:a	(I)Z
    //   6492: ifeq +56 -> 6548
    ...
    //   6531: aload_0
    //   6532: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   6535: lload 15
    //   6537: iload 4
    //   6539: lload 17
    //   6541: iload 5
    //   6543: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   6546: aconst_null
    //   6547: areturn
    //   6548: aload_0
    //   6549: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6552: aload 32
    ...
    //   6562: iload 5
    //   6564: iload 6
    //   6566: invokestatic 2550	axaq:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BJJIII)Z
    //   6569: ifeq -38 -> 6531
    //   6572: aload_0
    //   6573: ldc_w 2552
    //   6576: iconst_1
    ...
    //   6578: iconst_1
    //   6579: iconst_0
    //   6580: invokevirtual 1462	akqe:a	(Ljava/lang/String;ZIZZ)V
    //   6583: goto -52 -> 6531
    //   6586: aload 32
    ...
    //   6595: ifne +25 -> 6620
    //   6598: aload_0
    //   6599: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6602: bipush 47
    //   6604: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   6607: checkcast 2556	akdu
    //   6610: aload 32
    //   6612: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   6615: invokevirtual 2557	akdu:a	([B)V
    //   6618: aconst_null
    //   6619: areturn
    //   6620: aload 32
    ...
    //   6753: iconst_m1
    //   6754: aload_0
    //   6755: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   6789: aload_0
    //   6790: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   6822: aload_0
    //   6823: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6826: bipush 10
    //   6828: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   6831: checkcast 2594	axcj
    //   6834: astore_1
    ...
    //   6853: aload 29
    //   6855: aload_0
    //   6856: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   6884: iconst_1
    //   6885: ldc 140
    //   6887: invokevirtual 2601	axcj:a	(IJLjava/util/ArrayList;Ljava/lang/String;ZZLjava/lang/String;)Z
    //   6890: pop
    //   6891: aconst_null
    //   6892: areturn
    //   6893: astore_1
    ...
    //   6986: lstore_2
    //   6987: aload_0
    //   6988: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   7001: ifeq -6972 -> 29
    //   7004: aload_0
    //   7005: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   7008: bipush 94
    //   7010: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   7013: checkcast 2612	awyl
    //   7016: aload_1
    //   7017: iconst_3
    //   7018: invokevirtual 2615	awyl:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x7c/submsgtype0x7c$MsgBody;I)V
    //   7021: aconst_null
    //   7022: areturn
    //   7023: astore_1
    ...
    //   7166: astore_1
    //   7167: aload_0
    //   7168: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   7171: iload 19
    //   7173: aload_1
    //   7174: invokestatic 2636	avet:a	(Lcom/tencent/mobileqq/app/QQAppInterface;ZLjava/lang/String;)V
    //   7177: aload_0
    //   7178: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   7237: astore 28
    //   7239: sipush -2029
    //   7242: invokestatic 1219	axas:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   7413: aload_0
    //   7414: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   7417: invokevirtual 319	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   7420: astore 30
    //   7422: aload_0
    //   7423: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   7621: aload_0
    //   7622: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   7650: astore_1
    //   7651: ldc_w 2724
    //   7654: invokestatic 2727	ajya:a	(I)Ljava/lang/String;
    //   7657: astore 28
    //   7659: ldc_w 2728
    //   7662: invokestatic 2727	ajya:a	(I)Ljava/lang/String;
    //   7665: astore 30
    //   7667: aload 29
    //   7669: aload_0
    //   7670: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   7673: aload_1
    ...
    //   7713: aload 29
    //   7715: aload_0
    //   7716: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   7719: aload 31
    //   7721: aload 29
    ...
    //   7834: astore_1
    //   7835: aload_0
    //   7836: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   7839: bipush 85
    //   7841: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   7844: checkcast 2759	bdvn
    //   7847: aload_1
    //   7848: invokevirtual 2762	bdvn:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x92/SubMsgType0x92$MsgBody;)V
    //   7851: aconst_null
    //   7852: areturn
    //   7853: astore_1
    ...
    //   7919: astore_1
    //   7920: aload_0
    //   7921: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   7924: bipush 85
    //   7926: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   7929: checkcast 2759	bdvn
    //   7932: aload_1
    //   7933: invokevirtual 2777	bdvn:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xe5/Submsgtype0xe5$MsgBody;)V
    //   7936: aconst_null
    //   7937: areturn
    //   7938: astore_1
    ...
    //   7977: astore 31
    //   7979: sipush -2029
    //   7982: invokestatic 1219	axas:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   8166: aload_0
    //   8167: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8170: invokevirtual 319	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   8173: astore 31
    //   8175: aload_0
    //   8176: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   8336: ifne +305 -> 8641
    //   8339: aload_0
    //   8340: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8343: bipush 51
    //   8345: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   8348: checkcast 125	ajxl
    //   8351: astore 34
    ...
    //   8360: astore 33
    //   8362: sipush -2029
    //   8365: invokestatic 1219	axas:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   8438: astore 30
    //   8440: aload_0
    //   8441: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   8459: aload 34
    //   8461: aload 28
    //   8463: invokevirtual 129	ajxl:e	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   8466: astore 32
    //   8468: aload 32
    ...
    //   8546: aload 31
    //   8548: aload_0
    //   8549: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   8650: ifne +62 -> 8712
    //   8653: aload_0
    //   8654: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8657: bipush 62
    //   8659: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   8662: checkcast 2815	akua
    //   8665: aload 32
    //   8667: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   8670: invokevirtual 2816	akua:a	([B)V
    //   8673: aload_1
    ...
    //   8694: istore 5
    //   8696: aload_0
    //   8697: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   8700: lload_2
    //   8701: iload 4
    //   8703: lload 15
    //   8705: iload 5
    //   8707: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   8710: aconst_null
    //   8711: areturn
    //   8712: aload 32
    ...
    //   8769: ifeq +14 -> 8783
    //   8772: aload_0
    //   8773: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   8776: invokevirtual 1386	com/tencent/mobileqq/app/MessageHandler:a	()Lakqw;
    //   8779: iconst_2
    //   8780: invokevirtual 1389	akqw:a	(I)V
    //   8783: aload_1
    ...
    //   8790: ifeq -8761 -> 29
    //   8793: aload_0
    //   8794: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8797: aload_1
    //   8798: invokestatic 2833	afjk:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ltencent/im/s2c/msgtype0x210/submsgtype0x87/SubMsgType0x87$MsgBody;)V
    //   8801: aconst_null
    //   8802: areturn
    //   8803: astore_1
    ...
    //   8892: pop
    //   8893: aload_0
    //   8894: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8897: aload_1
    //   8898: lconst_0
    //   8899: iconst_0
    //   8900: invokestatic 2848	axaq:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ltencent/im/msgsync/cmd0x100/Submsgtype0x8a$ReqBody;JZ)V
    //   8903: aconst_null
    //   8904: areturn
    //   8905: astore_1
    ...
    //   8933: ifne +25 -> 8958
    //   8936: aload_0
    //   8937: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8940: bipush 51
    //   8942: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   8945: checkcast 2211	yah
    //   8948: aload 32
    //   8950: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   8953: invokevirtual 2853	yah:a	([B)V
    //   8956: aconst_null
    //   8957: areturn
    //   8958: aload 32
    ...
    //   9112: pop
    //   9113: aload_0
    //   9114: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   9265: invokestatic 2910	bdot:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   9282: astore 28
    //   9284: ldc_w 2914
    //   9287: invokestatic 2917	yoa:a	(Ljava/lang/String;)Ljava/lang/String;
    //   9290: ldc_w 2919
    ...
    //   9364: aload 28
    //   9366: ldc_w 2925
    //   9369: invokestatic 2927	yoa:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   9372: pop
    //   9373: aload 28
    //   9375: aload_1
    //   9376: ldc_w 2929
    //   9379: invokestatic 2932	yoa:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   9382: pop
    //   9383: invokestatic 2936	ynw:a	()V
    //   9386: invokestatic 2939	com/tencent/gamecenter/appointment/GameCenterCheck:b	()V
    //   9389: aload_0
    //   9390: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   9393: ldc_w 2941
    //   9396: ldc_w 2943
    //   9399: aload 28
    //   9401: ldc_w 2945
    //   9404: ldc_w 2947
    //   9407: ldc_w 2949
    //   9410: invokestatic 2952	yoa:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   9413: aconst_null
    //   9414: areturn
    //   9415: astore_1
    //   9416: aload_1
    ...
    //   9476: pop
    //   9477: aload_0
    //   9478: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   9481: bipush 12
    //   9483: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   9486: checkcast 1528	axbv
    //   9489: aload_1
    //   9490: invokevirtual 2963	axbv:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x11c/MsgBody;)V
    //   9493: aconst_null
    //   9494: areturn
    //   9495: astore_1
    //   9496: aconst_null
    ...
    //   10163: istore 24
    //   10165: aload_0
    //   10166: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   10189: astore 28
    //   10191: aload_0
    //   10192: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   10663: aload_0
    //   10664: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10667: bipush 88
    //   10669: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   10672: checkcast 3106	nqn
    //   10675: invokestatic 581	com/tencent/mobileqq/msf/core/NetConnInfoCenter:getServerTime	()J
    //   10678: iload 23
    //   10680: invokevirtual 3109	nqn:a	(JZ)V
    //   10683: aload_0
    //   10684: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10687: bipush 68
    //   10689: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   10692: checkcast 3111	nqr
    //   10695: invokevirtual 3112	nqr:a	()V
    //   10698: aconst_null
    //   10699: astore_1
    //   10700: iload 25
    ...
    //   10708: astore_1
    //   10709: aload_0
    //   10710: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10713: ldc_w 3116
    //   10716: ldc 140
    //   10718: ldc 140
    //   10720: ldc_w 3118
    ...
    //   10730: ldc 140
    //   10732: ldc 140
    //   10734: invokestatic 1953	axqy:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   10737: aconst_null
    //   10738: areturn
    //   10739: ldc 140
    //   10741: astore_1
    ...
    //   10884: aload_0
    //   10885: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10888: ldc_w 3122
    ...
    //   10986: aload_0
    //   10987: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10990: sipush 153
    //   10993: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   10996: checkcast 605	airx
    //   10999: astore 28
    //   11001: aload 28
    ...
    //   11013: invokevirtual 3144	airx:a	([B)V
    //   11016: aload_1
    ...
    //   11037: istore 5
    //   11039: aload_0
    //   11040: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   11043: lload_2
    //   11044: iload 4
    //   11046: lload 15
    //   11048: iload 5
    //   11050: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   11053: aconst_null
    //   11054: areturn
    //   11055: aload 32
    ...
    //   11165: istore 19
    //   11167: aload_0
    //   11168: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   11171: sipush 138
    //   11174: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   11177: checkcast 3175	afax
    //   11180: iload 19
    //   11182: invokevirtual 3177	afax:c	(Z)V
    //   11185: aconst_null
    //   11186: areturn
    //   11187: iconst_0
    //   11188: istore 19
    ...
    //   11229: istore 19
    //   11231: aload_0
    //   11232: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   11327: istore 19
    //   11329: aload_0
    //   11330: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   11352: ifeq +18 -> 11370
    //   11355: aload_0
    //   11356: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   11550: dup
    //   11551: aload_0
    //   11552: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   11593: ldc_w 3253
    //   11596: aload_0
    //   11597: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   11665: aload_0
    //   11666: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   11669: aload 29
    ...
    //   11694: ldc 140
    //   11696: ldc 140
    //   11698: invokestatic 1953	axqy:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   11701: aconst_null
    //   11702: areturn
    //   11703: astore_1
    ...
    //   11860: istore 19
    //   11862: aload_0
    //   11863: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   11866: sipush 138
    //   11869: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   11872: checkcast 3175	afax
    //   11875: iload 19
    //   11877: invokevirtual 3177	afax:c	(Z)V
    //   11880: aconst_null
    //   11881: areturn
    //   11882: iconst_0
    //   11883: istore 19
    ...
    //   11980: pop
    //   11981: aload_0
    //   11982: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   11985: bipush 20
    //   11987: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   11990: checkcast 1718	akhp
    //   11993: aload_1
    //   11994: invokevirtual 3309	akhp:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xab/SubMsgType0xab$MsgBody;)V
    //   11997: aconst_null
    //   11998: areturn
    //   11999: astore_1
    ...
    //   12049: aload_0
    //   12050: aload_1
    //   12051: invokevirtual 3322	akqe:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xa8/SubMsgType0xa8$MsgBody;)V
    //   12054: aconst_null
    //   12055: areturn
    //   12056: astore_1
    ...
    //   12120: pop
    //   12121: aload_0
    //   12122: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   12125: sipush 156
    //   12128: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   12131: checkcast 3338	aqui
    //   12134: aload_1
    //   12135: iconst_0
    //   12136: invokevirtual 3341	aqui:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xaa/SubMsgType0xaa$MsgBody;Z)V
    //   12139: aconst_null
    //   12140: areturn
    //   12141: astore 28
    ...
    //   12802: istore 5
    //   12804: aload_0
    //   12805: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   12808: lload_2
    //   12809: iload 4
    //   12811: lload 15
    //   12813: iload 5
    //   12815: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   12818: aconst_null
    //   12819: areturn
    //   12820: aload 28
    ...
    //   12848: astore 28
    //   12850: aload_0
    //   12851: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   12854: aload_0
    //   12855: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   12973: ifeq +59 -> 13032
    //   12976: aload_0
    //   12977: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   12980: bipush 94
    //   12982: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   12985: checkcast 3488	auev
    //   12988: astore 28
    //   12990: aload 28
    ...
    //   13007: invokevirtual 3492	auev:a	(Ltencent/im/oidb/olympic/torch_transfer$TorchbearerInfo;)V
    //   13010: aconst_null
    //   13011: areturn
    //   13012: astore_1
    ...
    //   13059: ifne +18 -> 13077
    //   13062: aload_0
    //   13063: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13066: aload 32
    //   13068: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   13071: iconst_1
    //   13072: invokestatic 3501	axaq:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BZ)V
    //   13075: aconst_null
    //   13076: areturn
    //   13077: aload 32
    ...
    //   13122: pop
    //   13123: aload_0
    //   13124: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13127: invokevirtual 3514	com/tencent/mobileqq/app/QQAppInterface:a	()Lakee;
    //   13130: aload_1
    //   13131: invokevirtual 3519	akee:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xc1/submsgtype0xc1$MsgBody;)V
    //   13134: aconst_null
    //   13135: areturn
    //   13136: astore_1
    ...
    //   13201: pop
    //   13202: aload_0
    //   13203: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13206: invokevirtual 3514	com/tencent/mobileqq/app/QQAppInterface:a	()Lakee;
    //   13209: aload_1
    //   13210: invokevirtual 3534	akee:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xe9/SubMsgType0xe9$MsgBody;)V
    ...
    //   13408: iload 6
    //   13410: iconst_1
    //   13411: invokespecial 3557	akqm:<init>	(JJJIIZ)V
    //   13414: astore_1
    //   13415: aload_0
    //   13416: aload 32
    //   13418: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   13421: aload_1
    //   13422: invokevirtual 3560	akqe:a	([BLakqm;)V
    //   13425: aload_0
    //   13426: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   13429: lload_2
    //   13430: iload 4
    //   13432: lload 15
    //   13434: iload 5
    //   13436: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   13439: aconst_null
    //   13440: areturn
    //   13441: aload 32
    ...
    //   13463: i2l
    //   13464: invokevirtual 3565	akqe:a	([BJ)V
    //   13467: aconst_null
    //   13468: areturn
    //   13469: aload 32
    ...
    //   13478: ifne +28 -> 13506
    //   13481: aload_0
    //   13482: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   13485: aload_1
    ...
    //   13501: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   13504: aconst_null
    //   13505: areturn
    //   13506: aload 32
    ...
    //   13528: i2l
    //   13529: invokevirtual 3571	akqe:b	([BJ)V
    //   13532: aconst_null
    //   13533: areturn
    //   13534: aload 32
    ...
    //   13552: iconst_1
    //   13553: aload_1
    //   13554: invokevirtual 3576	akqe:a	([BILOnlinePushPack/MsgInfo;)V
    //   13557: aload_0
    //   13558: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   13561: aload_1
    ...
    //   13577: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   13580: aconst_null
    //   13581: areturn
    //   13582: aload 32
    ...
    //   13600: iconst_1
    //   13601: invokevirtual 3580	akqe:a	([BI)V
    //   13604: aload_0
    //   13605: getfield 1456	akqe:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   13608: aload_1
    ...
    //   13624: invokestatic 1868	axaq:a	(Lcom/tencent/mobileqq/app/MessageHandler;JIJI)V
    //   13627: aconst_null
    //   13628: areturn
    //   13629: aload 32
    ...
    //   13657: aload_0
    //   13658: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13661: bipush 34
    //   13663: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   13666: checkcast 3588	akgd
    //   13669: astore_1
    //   13670: aload_1
    ...
    //   13685: invokevirtual 3589	akgd:a	(J[B)V
    //   13688: aconst_null
    //   13689: areturn
    ...
    //   13726: aload_1
    //   13727: invokevirtual 3596	akqe:a	([BLOnlinePushPack/MsgInfo;)V
    //   13730: aconst_null
    //   13731: areturn
    //   13732: aload 32
    ...
    //   13741: ifne +25 -> 13766
    //   13744: aload_0
    //   13745: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13748: bipush 98
    //   13750: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   13753: checkcast 3600	sss
    //   13756: aload 32
    //   13758: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   13761: invokevirtual 3601	sss:a	([B)V
    //   13764: aconst_null
    //   13765: areturn
    //   13766: aload 32
    ...
    //   13811: pop
    //   13812: aload_0
    //   13813: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13816: invokevirtual 3514	com/tencent/mobileqq/app/QQAppInterface:a	()Lakee;
    //   13819: aload_1
    //   13820: invokevirtual 3612	akee:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xcf/submsgtype0xcf$MsgBody;)V
    //   13823: aconst_null
    //   13824: areturn
    //   13825: astore_1
    ...
    //   13854: ifne +25 -> 13879
    //   13857: aload_0
    //   13858: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13861: bipush 98
    //   13863: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   13866: checkcast 3600	sss
    //   13869: aload 32
    //   13871: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   13874: invokevirtual 3617	sss:b	([B)V
    //   13877: aconst_null
    //   13878: areturn
    //   13879: aload 32
    ...
    //   13888: ifne +25 -> 13913
    //   13891: aload_0
    //   13892: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13895: bipush 98
    //   13897: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   13900: checkcast 3600	sss
    //   13903: aload 32
    //   13905: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   13908: invokevirtual 3620	sss:c	([B)V
    //   13911: aconst_null
    //   13912: areturn
    //   13913: aload 32
    ...
    //   13941: aload_0
    //   13942: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13945: sipush 202
    ...
    //   13992: aload_0
    //   13993: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13996: sipush 202
    ...
    //   14024: ifne +25 -> 14049
    //   14027: aload_0
    //   14028: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14031: bipush 107
    //   14033: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   14036: checkcast 3640	bciq
    //   14039: aload 32
    //   14041: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   14044: invokevirtual 3641	bciq:a	([B)V
    //   14047: aconst_null
    //   14048: areturn
    //   14049: aload 32
    ...
    //   14094: pop
    //   14095: aload_0
    //   14096: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14099: invokevirtual 3514	com/tencent/mobileqq/app/QQAppInterface:a	()Lakee;
    //   14102: aload_1
    //   14103: invokevirtual 3654	akee:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0xdb/submsgtype0xdb$MsgBody;)V
    //   14106: aconst_null
    //   14107: areturn
    //   14108: astore_1
    ...
    //   14275: invokestatic 3695	bbbr:a	(I)J
    //   14278: lstore 15
    //   14280: aload_0
    //   14281: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14284: sipush 211
    //   14287: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   14290: checkcast 3697	airt
    //   14293: astore 28
    //   14295: lload_2
    //   14296: lload 15
    //   14298: lcmp
    ...
    //   14359: invokestatic 3695	bbbr:a	(I)J
    //   14362: lstore 15
    //   14364: lload 15
    //   14366: lload_2
    //   14367: lcmp
    ...
    //   14380: aload_1
    //   14381: invokevirtual 3706	airt:a	(IILjava/lang/String;Ltencent/im/apollo_game_status$STCMGameMessage;)V
    //   14384: goto -48 -> 14336
    //   14387: astore_1
    //   14388: ldc_w 3668
    //   14391: iconst_1
    ...
    //   14410: aload_1
    //   14411: invokevirtual 3706	airt:a	(IILjava/lang/String;Ltencent/im/apollo_game_status$STCMGameMessage;)V
    //   14414: aconst_null
    //   14415: areturn
    //   14416: aload 32
    ...
    //   14476: astore_1
    //   14477: aload_0
    //   14478: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14481: ifnull -14452 -> 29
    //   14484: aload_0
    //   14485: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14488: sipush 227
    //   14491: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   14494: checkcast 3728	aisr
    //   14497: astore 28
    //   14499: aload 28
    //   14501: iconst_0
    //   14502: aload_1
    //   14503: invokevirtual 3731	aisr:a	(ILtencent/im/apollo_push_msgInfo$STPushMsgElem;)V
    //   14506: aload 28
    //   14508: aload_1
    //   14509: invokevirtual 3734	aisr:c	(Ltencent/im/apollo_push_msgInfo$STPushMsgElem;)V
    //   14512: aload 28
    //   14514: aload_1
    //   14515: invokevirtual 3736	aisr:b	(Ltencent/im/apollo_push_msgInfo$STPushMsgElem;)V
    //   14518: aload 28
    //   14520: aload_1
    //   14521: invokevirtual 3738	aisr:a	(Ltencent/im/apollo_push_msgInfo$STPushMsgElem;)V
    //   14524: aconst_null
    //   14525: areturn
    //   14526: astore_1
    //   14527: aload_1
    ...
    //   14616: pop
    //   14617: aload_0
    //   14618: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14621: aload_1
    //   14622: invokestatic 3751	akjv:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ltencent/im/c2c/msgtype0x210/submsgtype0xeb/submsgtype0xeb$MsgBody;)V
    //   14625: aconst_null
    //   14626: areturn
    //   14627: astore_1
    //   14628: ldc_w 520
    ...
    //   14809: aload_0
    //   14810: iload 5
    //   14812: invokespecial 3776	com/tencent/mobileqq/app/message/OnLinePushMessageProcessor$2:<init>	(Lakqe;I)V
    ...
    //   14855: aload_1
    //   14856: aload 28
    //   14858: invokestatic 3785	akvz:a	(I[B[B)Z
    //   14861: pop
    //   14862: aconst_null
    //   14863: areturn
    //   14864: aload 32
    ...
    //   14892: aload_0
    //   14893: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14896: sipush 252
    //   14899: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   14902: checkcast 3791	tfz
    //   14905: astore_1
    ...
    //   14925: pop
    //   14926: aload_0
    //   14927: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14930: sipush 251
    //   14933: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   14936: checkcast 3797	tfy
    //   14939: astore 29
    //   14941: aload_1
    //   14942: getfield 3798	tfz:jdField_a_of_type_Boolean	Z
    //   14945: ifeq -14916 -> 29
    //   14948: aload 29
    //   14950: invokevirtual 3801	tfy:a	()Ltfk;
    //   14953: aload 28
    //   14955: invokevirtual 3806	tfk:a	(Lcom/tencent/biz/qqstory/network/pb/qqstory_service$MsgTabNodePushNotify;)V
    //   14958: aconst_null
    //   14959: areturn
    //   14960: astore_1
    //   14961: ldc_w 520
    ...
    //   15042: aload_0
    //   15043: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15046: sipush 253
    //   15049: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   15052: checkcast 3815	ssr
    //   15055: astore 28
    //   15057: aload_1
    ...
    //   15075: invokevirtual 3818	ssr:a	([BLjava/lang/String;)Lcom/tencent/mobileqq/data/MessageForQQStoryFeed;
    //   15078: invokevirtual 3821	ssr:a	(Lcom/tencent/mobileqq/data/MessageForQQStoryFeed;)V
    //   15081: aconst_null
    //   15082: areturn
    //   15083: aload 32
    ...
    //   15168: astore 28
    //   15170: aload_0
    //   15171: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15174: sipush 266
    //   15177: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   15180: checkcast 3836	atzm
    //   15183: aload 28
    //   15185: invokevirtual 3839	atzm:a	(Lcom/tencent/mobileqq/now/enter/pb/NowPushMsgList$NowPushMsg;)V
    ...
    //   15360: aload_0
    //   15361: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15364: aload 32
    //   15366: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   15369: aload_1
    //   15370: invokestatic 3871	anmf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BLOnlinePushPack/MsgInfo;)Lcom/tencent/mobileqq/data/MessageRecord;
    //   15373: areturn
    //   15374: aload 32
    ...
    //   15405: pop
    //   15406: aload_0
    //   15407: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15410: sipush 284
    //   15413: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   15416: checkcast 3879	aseq
    //   15419: aload 28
    //   15421: aload_1
    //   15422: getfield 1164	OnlinePushPack/MsgInfo:shMsgSeq	S
    //   15425: aload_1
    //   15426: getfield 1194	OnlinePushPack/MsgInfo:lMsgUid	J
    //   15429: invokevirtual 3882	aseq:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x101/SubMsgType0x27$MsgBody;SJ)V
    //   15432: aconst_null
    //   15433: areturn
    //   15434: astore_1
    //   15435: ldc_w 520
    ...
    //   15478: pop
    //   15479: aload_0
    //   15480: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15483: invokevirtual 3894	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   15486: invokevirtual 3899	com/tencent/mobileqq/app/proxy/ProxyManager:a	()Lamnw;
    //   15489: aload_1
    //   15490: invokevirtual 3904	amnw:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x103/submsgtype0x103$MsgBody;)V
    //   15493: aconst_null
    //   15494: areturn
    //   15495: astore_1
    ...
    //   15563: pop
    //   15564: aload_0
    //   15565: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15568: invokevirtual 3894	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   15571: invokevirtual 3899	com/tencent/mobileqq/app/proxy/ProxyManager:a	()Lamnw;
    //   15574: aload_1
    //   15575: invokevirtual 3916	amnw:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x104/submsgtype0x104$MsgBody;)V
    //   15578: aconst_null
    //   15579: areturn
    //   15580: astore_1
    ...
    //   15647: aload_0
    //   15648: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15651: aload 32
    //   15653: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   15656: aload_1
    //   15657: invokestatic 3925	annj:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BLOnlinePushPack/MsgInfo;)Lcom/tencent/mobileqq/data/MessageRecord;
    //   15660: areturn
    //   15661: aload 32
    ...
    //   15689: aload_0
    //   15690: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15693: aload 32
    //   15695: getfield 1546	IMMsgBodyPack/MsgType0x210:vProtobuf	[B
    //   15698: invokestatic 3932	akaa:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[B)V
    //   15701: aconst_null
    //   15702: areturn
    //   15703: aload 32
    ...
    //   15731: aload_0
    //   15732: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15735: iconst_1
    //   15736: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    ...
    //   15789: aload_0
    //   15790: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15793: aload 32
    ...
    //   15807: i2l
    //   15808: iconst_0
    //   15809: invokestatic 3946	arrl:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BJJZ)V
    //   15812: aconst_null
    //   15813: areturn
    //   15814: aload 32
    ...
    //   15835: ifne +92 -> 15927
    //   15838: aload_0
    //   15839: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15842: sipush 339
    //   15845: invokevirtual 160	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   15848: checkcast 3952	aync
    //   15851: iconst_4
    //   15852: invokevirtual 3955	aync:a	(I)Laynn;
    //   15855: astore 28
    //   15857: aload 28
    //   15859: ifnull -15830 -> 29
    //   15862: aload_0
    //   15863: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15866: astore 29
    //   15868: aload 32
    ...
    //   15960: lload_2
    //   15961: invokestatic 3965	avdu:a	([BJ)V
    //   15964: aconst_null
    //   15965: areturn
    //   15966: aload 32
    ...
    //   16094: astore_1
    //   16095: aload_0
    //   16096: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   16099: sipush 316
    ...
    //   16129: iload 5
    //   16131: aload_1
    //   16132: invokevirtual 4000	ardx:a	(JJJIIILjava/lang/String;)V
    //   16135: aconst_null
    //   16136: areturn
    //   16137: astore_1
    //   16138: ldc_w 520
    ...
    //   16261: invokestatic 4015	ayfx:a	(I)Z
    //   16264: ifne -16235 -> 29
    //   16267: aload_0
    //   16268: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   16271: aload 28
    //   16273: invokestatic 4018	ayfx:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ltencent/im/s2c/msgtype0x210/submsgtype0x119/SubMsgType0x119$MsgBody;)V
    //   16276: ldc_w 520
    //   16279: iconst_1
    //   16280: ldc_w 4020
    ...
    //   16374: pop
    //   16375: aload_0
    //   16376: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   16379: aload_1
    ...
    //   16443: ifne +26 -> 16469
    //   16446: aload_0
    //   16447: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   16450: aload 32
    ...
    //   16463: iconst_0
    //   16464: invokestatic 4044	arup:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BSIZ)V
    //   16467: aconst_null
    //   16468: areturn
    //   16469: aload 32
    ...
    //   16522: pop
    //   16523: invokestatic 4057	askx:a	()Laskx;
    //   16526: aload_1
    //   16527: invokevirtual 4060	askx:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x11a/submsgtype0x11a$MsgBody;)V
    //   16530: aconst_null
    //   16531: areturn
    //   16532: astore_1
    //   16533: ldc_w 520
    ...
    //   16644: aload_0
    //   16645: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   16793: aload_0
    //   16794: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   16797: ldc_w 4091
    //   16800: bipush 11
    //   16802: iconst_1
    //   16803: aload 28
    ...
    //   16888: pop
    //   16889: invokestatic 4057	askx:a	()Laskx;
    //   16892: aload_1
    //   16893: invokevirtual 4106	askx:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x11b/submsgtype0x11b$MsgBody;)V
    //   16896: aconst_null
    //   16897: areturn
    //   16898: astore_1
    //   16899: ldc_w 520
    ...
    //   16952: ifne +49 -> 17001
    //   16955: aload_0
    //   16956: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   16959: astore 28
    //   16961: aload 32
    ...
    //   16987: aload_1
    //   16988: iload 19
    //   16990: invokestatic 4117	aqvc:a	(Lcom/tencent/mobileqq/app/QQAppInterface;[BLOnlinePushPack/MsgInfo;Z)V
    //   16993: aconst_null
    //   16994: areturn
    //   16995: iconst_0
    //   16996: istore 19
    ...
    //   17054: pop
    //   17055: aload_0
    //   17056: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   17059: bipush 127
    //   17061: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   17064: checkcast 4127	aoet
    //   17067: aload_1
    //   17068: invokevirtual 4130	aoet:a	(Ltencent/im/s2c/msgtype0x210/submsgtype0x128/submsgtype0x128$MsgBody;)V
    //   17071: ldc_w 4132
    //   17074: iconst_2
    //   17075: ldc_w 4134
    ...
    //   17156: aload_0
    //   17157: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   17160: sipush 169
    //   17163: invokevirtual 180	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   17166: checkcast 4144	afhv
    //   17169: checkcast 4144	afhv
    //   17172: astore_1
    //   17173: aload_1
    ...
    //   17183: invokevirtual 4145	afhv:a	([B)V
    //   17186: aconst_null
    //   17187: areturn
    //   17188: aload 32
    ...
    //   17289: astore 28
    //   17291: invokestatic 4162	alub:a	()Lalub;
    //   17294: aload_0
    //   17295: getfield 154	akqe:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   17298: aload_1
    //   17299: aload 28
    //   17301: invokevirtual 4164	alub:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;)V
    //   17304: aconst_null
    //   17305: areturn
    //   17306: astore_1
    //   17307: ldc_w 520
  ...
  private void b(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte == null)
      {
        ...
        axrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBPushNotifaction", false, 0L, 0L, paramArrayOfByte, "");
        return;
      }
    }
    catch (Exception paramArrayOfByte)
    {
      do
      {
        ...
        axrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "actSBPushNotifaction", true, 0L, 0L, (HashMap)localObject1, "");
        localObject1 = (ayaq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(62);
        if (i == 1)
        {
          ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte)0, paramArrayOfByte.c);
          ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte.c);
          paramArrayOfByte.a = 1;
          ((ayaq)localObject1).a(paramArrayOfByte.c, 1);
          a(8004, true, paramArrayOfByte);
          return;
        }
      } while (i != 0);
      localObject1 = String.valueOf(l1);
      localayax = (ayax)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
      paramArrayOfByte.a((String)localObject1);
      localayax.a(paramArrayOfByte);
      ...
      boolean bool = false;
      localObject2 = ayaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1);
    ...
    localayax.a((String)localObject1, 1);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getSubAccountKey(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), String.valueOf(l1), new akqg(this, localayax));
    for (;;)
    {
      ...
      return;
      label783:
      if (localayax.a(String.valueOf(l1), 2))
      {
        ...
        if (i != 0)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(new String[] { ajsd.x, localObject1 });
        }
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
      {
        ...
        if (((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(String.valueOf(l)))
        {
          ...
          paramArrayOfByte = (String)localObject + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131693300);
        }
      }
      for (;;)
      {
        akoi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l), paramArrayOfByte, 1, false, true);
        return;
        label395:
        i = 0;
        break;
        ...
        if (paramInt == 13) {
          if (1 == i) {
            paramArrayOfByte = (String)localObject + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131693322);
          } else {
            paramArrayOfByte = (String)localObject + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131693304);
          }
        }
      }
      return;
  ...
  private void g(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      long l1 = ldu.a(((submsgtype0x116.MsgBody)localObject).uint32_group_id.get());
      long l2 = ldu.a(((submsgtype0x116.MsgBody)localObject).uint32_room_id.get());
      if (QLog.isColorLevel()) {
    ...
    do
    {
      for (;;)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramArrayOfByte)
        {
          ...
          localObject = new StringBuilder(ajya.a(2131707850));
  ...
  {
    long l = bbmx.a(paramArrayOfByte, 0);
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  ajyi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHotChatInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693317), true);
                  ajys.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 6);
                  ((ajyg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(35)).notifyUI(1041, true, new Object[] { str, HotChatManager.HotChatStateWrapper.STATE_HOT_CHAT_IS_DISBANDED });
                  return;
                } while (localHotChatInfo == null);
                localHotChatManager.a(localHotChatInfo, HotChatManager.HotChatStateWrapper.STATE_KICK_OUT);
                ajyi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHotChatInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693293), true);
                ajys.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 6);
                ((ajyg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(35)).notifyUI(1041, true, new Object[] { str, HotChatManager.HotChatStateWrapper.STATE_KICK_OUT });
                return;
              } while (localHotChatInfo == null);
              localHotChatManager.a(localHotChatInfo, HotChatManager.HotChatStateWrapper.STATE_KICK_OUT);
              ajyi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHotChatInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693294), true);
              ajys.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 6);
              ((ajyg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(35)).notifyUI(1041, true, new Object[] { str, HotChatManager.HotChatStateWrapper.STATE_KICK_OUT });
              return;
              if (j != 2) {
            ...
            ajyi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHotChatInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693292), false);
            ajys.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 6);
            ((ajyg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(35)).notifyUI(1041, true, new Object[] { str, HotChatManager.HotChatStateWrapper.STATE_LEFT__LONG_TIME_NOT_SAY });
            return;
          } while (j != 1);
    ...
    if (paramArrayOfByte.msg_friend_msg_sync.get() != null) {
      if (a(paramArrayOfByte.msg_friend_msg_sync.uint32_processflag.get()))
      {
        ...
        if (c(paramArrayOfByte.msg_friend_msg_sync.uint32_processtype.get()))
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (bbkk.c((String)localObject2)))
          {
    ...
    for (int j = i;; j = 0)
    {
      ...
      if (paramArrayOfByte.msg_group_msg_sync.has())
      {
        ...
        if (paramArrayOfByte.msg_group_msg_sync.get() != null)
        {
          ...
          if (b(paramArrayOfByte.msg_group_msg_sync.uint32_msg_type.get()))
          {
            ...
            Object localObject3 = ayde.a(paramArrayOfByte.msg_group_msg_sync.uint64_grp_code.get());
            if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject3)) && (bbkk.c((String)localObject1)))
            {
              ...
              if (localTroopManager.b((String)localObject1) == null)
              {
                ...
                localObject3 = (akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
                ((akhp)localObject3).a(((TroopInfo)localObject2).troopuin, false, "", true, true, true, false);
                ((akhp)localObject3).a(1, ajsx.a(((TroopInfo)localObject2).troopuin), 0L, 2, 0, 0, true);
                ((akhp)localObject3).notifyUI(6, true, new Object[] { Integer.valueOf(6), Byte.valueOf(0), localObject1 });
                ((akhp)localObject3).notifyUI(127, true, new Object[] { localObject1 });
              }
              a(2001, true, null);
            }
          }
      ...
      for (;;)
      {
        if ((paramArrayOfByte.msg_clean_count_msg.has()) && (paramArrayOfByte.msg_clean_count_msg.get() != null))
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(ajsd.W, 9000, 0 - aydd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
            ...
            localObject1 = (akbn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34);
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      if (localArrayList.size() > 0) {
        awzb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localArrayList);
      }
    }
  }
  ...
  public void a(SubMsgType0xa8.MsgBody paramMsgBody)
  {
    ...
    do
    {
      ...
      {
        return;
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80065A9", "0X80065A9", 0, 0, "", "", "", "");
    ...
    for (;;)
    {
      localIntent.putExtra(asep.b, (String)localObject1);
      localIntent.putExtra("activepull_push_flag", true);
      Object localObject2 = asep.jdField_a_of_type_JavaLangString;
      Object localObject3 = baxi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources(), 2130840055);
      ...
      if (!bbjc.a((Context)localObject1)) {
        break;
      }
      localObject2 = (asep)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(145);
      ((asep)localObject2).a(localIntent);
      localObject3 = (ases)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(72);
      if (SettingCloneUtil.readValue((Context)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((Context)localObject1).getString(2131694020), "qqsetting_lock_screen_whenexit_key", true))
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQLSActivity", 2, "handlePullActivePushMsg, start lsActivity");
        }
        ((ases)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ajsd.aw, 9653, false, aseo.a(paramMsgBody, 1008, localIntent));
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(((asep)localObject2).jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemPullActivePush);
      return;
      if (i == 2)
      {
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
            ...
            for (;;)
            {
              ...
              case 1: 
                if (paramArrayOfByte.msg_del_group.has())
                {
                  ...
                  {
                    localObject2 = localajxl.a(((SubMsgType0x27.DelGroup)localObject1).uint32_groupid.get() + "");
                    if (QLog.isColorLevel()) {
        ...
        paramArrayOfByte = localajxl.a(String.valueOf(i));
        if (paramArrayOfByte != null) {}
    ...
    for (;;)
    {
      ...
      localajxl.a(paramArrayOfByte, (byte[])localObject1);
      break;
      ...
      for (i = ((Integer)((SubMsgType0x27.FriendGroup)localObject1).rpt_uint32_old_group_id.get(0)).intValue();; i = 0)
      {
        ...
        paramArrayOfByte = (ssr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(253);
        ...
        for (;;)
        {
          ...
          try
          {
            localObject2 = (bduf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(165);
            if ((localObject2 != null) && (((bduf)localObject2).a(l1 + "")))
            {
          ...
          aknx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2);
        }
        label2070:
            ...
            while (((Iterator)localObject4).hasNext())
            {
              ...
              if ((i == 13569) && (((SubMsgType0x27.SnsUpateBuffer)localObject3).uint32_result.get() == 0))
              {
                ...
                else if (i >= 4)
                {
                  ...
                  if (localTroopManager.a((String)localObject5, akas.a((byte[])localObject7))) {
              ...
              else if (i == 13571)
              {
                ...
                if (i >= 6)
                {
                  ...
                  if (i == 1)
                  {
                    ...
                    if (localTroopManager.b((String)localObject5, akas.a((byte[])localObject7))) {
            ...
            while (((Iterator)localObject6).hasNext())
            {
              ...
              if ((localObject7 != null) && (((SubMsgType0x27.SnsUpdateItem)localObject7).uint32_update_sns_type.has()) && (((SubMsgType0x27.SnsUpdateItem)localObject7).bytes_value.has()) && (!FriendsStatusUtil.a((SubMsgType0x27.SnsUpdateItem)localObject7, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject5)))
              {
                if (((SubMsgType0x27.SnsUpdateItem)localObject7).uint32_update_sns_type.get() == 13568) {
                  aiiz.a((String)localObject5, ((SubMsgType0x27.SnsUpdateItem)localObject7).bytes_value.get().toStringUtf8(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                }
                localObject1 = (SpecialCareInfo)((HashMap)localObject3).get(localObject5);
                paramArrayOfByte = (byte[])localObject1;
                if (localObject1 == null)
                {
                  localObject1 = localajxl.a(String.valueOf(l1));
                  paramArrayOfByte = (byte[])localObject1;
                  if (localObject1 == null)
                  {
        ...
        do
        {
          ...
          localObject1 = localajxl.e(String.valueOf(l1));
        ...
        j = a(paramArrayOfByte, localajxl, localTroopManager, null, localairx, arrayOfFriends, j);
        break;
        ...
        {
          paramArrayOfByte = localajxl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (((SubMsgType0x27.FriendRemark)localObject3).uint32_type.has()) {
            if (((SubMsgType0x27.FriendRemark)localObject3).uint32_type.get() == 0)
            {
              ...
              localObject4 = localajxl.e(Long.toString(l1));
              paramArrayOfByte = null;
              ...
              localajxl.b(((SubMsgType0x27.FriendRemark)localObject3).uint64_fuin.get() + "", ((SubMsgType0x27.FriendRemark)localObject3).bytes_rmk_name.get().toStringUtf8());
              localObject5 = localajxl.b(((SubMsgType0x27.FriendRemark)localObject3).uint64_fuin.get() + "");
              ...
              if ((localObject5 != null) && (!((String)localObject6).equals(((Card)localObject5).strReMark)))
              {
                ...
                localajxl.a((Card)localObject5);
              }
              if ((localObject4 != null) && (((Friends)localObject4).isFriend()) && (akes.b((String)localObject6, paramArrayOfByte))) {
                akes.b(l1, (String)localObject6, (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53));
              }
        ...
        localObject1 = localajxl.a((String)localObject3);
        paramArrayOfByte = (byte[])localObject1;
        if (localObject1 == null)
        {
        ...
        localajxl.a(paramArrayOfByte);
        paramArrayOfByte = localajxl.b(((SubMsgType0x27.ModLongNick)localObject5).uint64_uin.get() + "");
        if (paramArrayOfByte != null)
        {
        ...
        paramArrayOfByte = bbdd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l2 + "", l3 + "");
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if ((((SubMsgType0x27.GroupMemberProfileInfo)localObject3).uint32_field.has()) && (((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.has()))
          {
            ...
            akes.a("cardpush", ((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.get().toByteArray(), ((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.get().size());
            if (paramArrayOfByte != null)
            {
              paramArrayOfByte.colorNick = bbos.a(((SubMsgType0x27.GroupMemberProfileInfo)localObject3).bytes_value.get());
              paramArrayOfByte.name = bbos.b(paramArrayOfByte.colorNick);
          ...
          for (;;)
          {
            ...
            bbdd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte);
        ...
        ((atxd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(160)).a(paramArrayOfByte.bytes_redpoint_info.get().toByteArray());
        break;
        ...
        ((yah)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(39, (Bundle)localObject1);
        break;
        ...
        for (i = paramArrayOfByte.uint32_msg_type.get();; i = -1)
        {
          ...
          if (i == 1)
          {
            localObject1 = (ajzj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(3);
            if (localObject1 == null) {
              break;
            }
            ((ajzj)localObject1).a(paramArrayOfByte);
            break;
          }
          if ((i != 2) && (i != 3)) {
            break;
          }
          localObject1 = (akbf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(57);
          if (localObject1 == null) {
            break;
          }
          ((akbf)localObject1).a(i, paramArrayOfByte);
          break;
          ...
          for (paramArrayOfByte = paramArrayOfByte.str_msg.get();; paramArrayOfByte = null)
          {
            for (;;)
            {
              for (;;)
              {
                ...
                localObject1 = baxi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources(), 2130840055);
                ...
                try
                {
                  ...
                  ((amga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(240)).a(paramArrayOfByte);
                }
                catch (Exception paramArrayOfByte) {}
              }
              if (!QLog.isColorLevel()) {
  ...
  {
    ((ardi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(268)).a(paramArrayOfByte, paramInt);
  }
  
  public void a(byte[] paramArrayOfByte, int paramInt, MsgInfo paramMsgInfo)
  {
    ((ardi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(268)).a(paramArrayOfByte, paramInt, paramMsgInfo);
  }
  ...
  public void a(byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    ...
    try
    {
      ...
      paramArrayOfByte = (MessageForNearbyLiveTip)axas.a(-2053);
      if (((SubMsgType0xcb.MsgBody)localObject).uint32_anchor_status.get() == 1)
      {
        ...
        paramArrayOfByte.senderuin = String.valueOf(paramMsgInfo.lFromUin + ajsd.l);
        paramArrayOfByte.frienduin = String.valueOf(paramMsgInfo.lFromUin + ajsd.l);
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      } while (akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte, true));
      paramMsgInfo.add(paramArrayOfByte);
      if (paramArrayOfByte.senderuin.equals(String.valueOf(1822701914L + ajsd.l))) {
        paramArrayOfByte.isLiving = true;
      }
      if (paramArrayOfByte.isLiving)
      {
        bool2 = akas.a(paramMsgInfo);
        int i = akpx.a(paramMsgInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  public void a(byte[] paramArrayOfByte, akqm paramakqm)
  {
    if (QLog.isColorLevel()) {
      ...
      if (((submsgtype0xc7.ForwardBody)localObject).uint32_op_type.has()) {
        ...
        case 3000: 
          if (((submsgtype0xc7.ForwardBody)localObject).msg_hot_friend_notify.has())
          {
            ...
            asyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (submsgtype0xc7.HotFriendNotify)localObject, paramakqm);
          }
          break;
        case 4000: 
          if (((submsgtype0xc7.ForwardBody)localObject).msg_relational_chain_change.has())
          {
            ...
            if (((submsgtype0xc7.RelationalChainChange)localObject).uint64_appid.get() == 10001L) {
              asyg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (submsgtype0xc7.RelationalChainChange)localObject, paramakqm);
            } else if (((submsgtype0xc7.RelationalChainChange)localObject).uint64_appid.get() == 19999L) {
              asyp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (submsgtype0xc7.RelationalChainChange)localObject, paramakqm);
            } else if (((submsgtype0xc7.RelationalChainChange)localObject).uint64_appid.get() == 10002L) {
              acvs.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (submsgtype0xc7.RelationalChainChange)localObject, paramakqm);
            }
          }
          break;
        }
      ...
      do
      {
        do
        {
          do
          {
              ...
              if (localMsgBody.rpt_msg_subcmd_0x1_push_body.has())
              {
                ...
                while (j < ((List)localObject1).size())
                {
                  ...
                  if (((submsgtype0x26.MsgBody.SubCmd0x1UpdateAppUnreadNum)localObject2).msg_app_id.uint64_app_id.get() == 101846662L)
                  {
                    ...
                    localObject2 = (baft)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(355);
                    if (localObject2 != null) {
                      ((baft)localObject2).a(l1);
                    }
                    i = 1;
                  }
                  j += 1;
            ...
            if ((k != 0) && (l2 != 0L))
            {
              localObject1 = (bafr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(171);
              if (localObject1 != null) {
                ((bafr)localObject1).notifyUI(6, true, new Object[] { Long.valueOf(l2) });
              }
            }
            if ((localMsgBody.uint32_sub_cmd.get() == 1) || (localMsgBody.uint32_sub_cmd.get() == 4))
            {
              ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(paramArrayOfByte);
              return;
            }
