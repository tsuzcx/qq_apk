...
{
  public nhf(VideoPlayModeBase paramVideoPlayModeBase, String paramString, StoryVideoItem paramStoryVideoItem, DownloadUrlManager paramDownloadUrlManager, int paramInt) {}
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryPlaymodeVideoPlayModeBase.jdField_a_of_type_AndroidOsHandler.post(new nhh(this, paramString1, paramString2));
  }
  ...
  public void a(String paramString1, String paramString2, File paramFile)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      ThreadManager.post(new nhg(this, paramString2), 8, null, true);
    }
    for (;;)
    {
