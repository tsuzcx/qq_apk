  ...
  implements View.OnClickListener
{
  ...
  private List<ajsm> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public ajvl(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean, PhoneContactFragment paramPhoneContactFragment)
  {
    ...
    do
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!localPhoneContact.isHiden) {
          ((List)localObject1).add(ajsl.a(1, localPhoneContact, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        }
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (a())
    {
      ...
      {
        this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558948, null);
        ...
        this.jdField_a_of_type_AndroidViewView.findViewById(2131369324).setVisibility(8);
        localObject1 = (SingleLineTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367726);
        ((SingleLineTextView)localObject1).setText(anzj.a(2131706874));
        ...
        ((SimpleTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364983)).setText("0");
      }
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject1 = ((ajsm)this.jdField_a_of_type_JavaUtilList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, this);
      if (localObject1 != null)
      {
        localObject2 = (ajsp)((View)localObject1).getTag();
        if (((ajsp)localObject2).d != null) {
          ((ajsp)localObject2).d.setBackgroundDrawable(new BitmapDrawable(a(((ajsp)localObject2).b, ((ajsp)localObject2).jdField_a_of_type_JavaLangString)));
        }
        ((View)localObject1).setOnClickListener(this);
        if ((localObject2 instanceof ajvk)) {
          ((ajvk)localObject2).a.setOnClickListener(this);
        }
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    int i = 17;
    Object localObject;
    if ((paramView != null) && (paramView.getId() == 2131376575) && ((paramView.getTag() instanceof PhoneContact)))
    {
    ...
    for (;;)
    {
      ...
      localObject = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, ((PhoneContact)localObject).unifiedCode, null, 3006, i, ((PhoneContact)localObject).name, null, null, anzj.a(2131706869), null);
      this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "contact", "", "addbook", "add_friend", 0, 0, "", "", "", "");
      do
      {
        do
        {
          ...
          return;
        } while ((paramView == null) || (!(paramView.getTag() instanceof ajsp)));
        localObject = (ajsp)paramView.getTag();
      } while (!(((ajsp)localObject).jdField_a_of_type_JavaLangObject instanceof PhoneContact));
      PhoneContact localPhoneContact = (PhoneContact)((ajsp)localObject).jdField_a_of_type_JavaLangObject;
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80053DF", "0X80053DF", 0, 0, "1", "", "", "");
        break;
