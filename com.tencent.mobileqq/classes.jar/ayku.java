...
public class ayku
{
  ...
  public ayku(QQAppInterface paramQQAppInterface)
  {
  ...
  public ArrayList<atmo> a(String paramString)
  {
    ...
    Object localObject2 = (akfb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(2);
    Object localObject1 = ((akfb)localObject2).a(paramString);
    ...
    if (j < ((List)localObject1).size())
    {
      ...
      {
        localObject6 = ((akeu)localObject4).a(((TroopIndex)localObject5).mTroopUin, 1);
    ...
    for (float f2 = f1;; f2 = 0.0F)
    {
      ...
      localObject7 = ((akfb)localObject2).b((String)localObject7);
      ...
      if ((((ajjj)localObject1).b(((TroopIndex)localObject8).mMemberUin)) && (!((String)localObject6).equals(((TroopIndex)localObject8).mMemberUin)) && (!paramString.equals(((TroopIndex)localObject8).mMemberUin)))
      {
        if (((HashMap)localObject5).containsKey(((TroopIndex)localObject8).mMemberUin)) {
          break label668;
        }
        aykx localaykx = new aykx(this, f3);
        localaykx.b = f2;
        localaykx.jdField_a_of_type_Int = 1;
        RecentUser localRecentUser = ((akeu)localObject4).a(((TroopIndex)localObject8).mMemberUin, 0);
        if (localRecentUser != null) {
          localaykx.jdField_a_of_type_Long = localRecentUser.lastmsgtime;
        }
        ((HashMap)localObject5).put(((TroopIndex)localObject8).mMemberUin, localaykx);
      }
      for (;;)
      {
        j += 1;
        break;
        localObject8 = (aykx)((HashMap)localObject5).get(((TroopIndex)localObject8).mMemberUin);
        ((aykx)localObject8).jdField_a_of_type_Int += 1;
        ((aykx)localObject8).b += f2;
      }
      if (QLog.isColorLevel()) {
      ...
      Collections.sort(paramString, new aykv(this));
      i = paramString.size();
      if ((i > 1) && (((aykx)((Map.Entry)paramString.get(i - 1)).getValue()).a() == ((aykx)((Map.Entry)paramString.get(0)).getValue()).a())) {}
      for (i = 1;; i = 0)
      {
        if (i != 0)
        {
          ...
          Collections.sort(paramString, new aykw(this));
        }
        localObject2 = new ArrayList();
        i = 0;
        if (i < paramString.size())
        {
          localObject3 = (aykx)((Map.Entry)paramString.get(i)).getValue();
          localObject4 = ((ajjj)localObject1).b((String)((Map.Entry)paramString.get(i)).getKey());
          if (localObject4 != null)
          {
            ((ArrayList)localObject2).add(localObject4);
            if ((i < 20) && (QLog.isColorLevel())) {
              QLog.i("RelationFriendsSearchHelper", 2, "top20:uin" + baip.e(((Friends)localObject4).uin) + ",scores:" + ((aykx)localObject3).a() + ",frequency:" + ((aykx)localObject3).jdField_a_of_type_Int + ",activefactor:" + ((aykx)localObject3).b + ",c2clastmsgtime:" + ((aykx)localObject3).jdField_a_of_type_Long);
            }
          }
          for (;;)
          {
