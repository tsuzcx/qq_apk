...
public abstract class ajnu
{
  ...
  protected aoga a;
  private aojs jdField_a_of_type_Aojs = new ajnw(this);
  private blih jdField_a_of_type_Blih = new ajnv(this);
  ...
  public ajnu(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, ajnx paramajnx)
  {
  ...
  {
    g();
    this.jdField_a_of_type_Ajno = a();
    this.jdField_a_of_type_Ajno.a(null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajno);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131712141));
  ...
  private void h()
  {
    ...
    if (a()) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131712142));
    }
  }
  
  protected abstract ajno a();
  ...
  {
    Object localObject = apch.a("recommend_troop");
    double d1;
    int k;
    double d2;
    String str;
    ...
    ((oidb_0x935.GPS)localObject).bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.4.5"));
  ...
  protected boolean a()
  {
    return this.jdField_a_of_type_Aoga.a == 1;
  }
  
  protected void b()
  {
    this.jdField_a_of_type_Ajno.a(this.jdField_a_of_type_Aoga.b);
    this.jdField_a_of_type_Ajno.notifyDataSetChanged();
  }
  
  protected void b(boolean paramBoolean)
  {
    this.jdField_a_of_type_Aoga.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), a(), 21);
  }
