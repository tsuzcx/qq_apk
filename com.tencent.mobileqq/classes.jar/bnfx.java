  ...
  extends bnfz
{
  ...
  public bnfx(DoodleView paramDoodleView)
  {
  ...
  public static Drawable a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 20	yoy:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +74 -> 86
  ...
  {
    int k = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_Int;
    int m = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.b;
    int j = paramInt1;
    int i = paramInt2;
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            localDynamicStickerData.centerP = localbngd.jdField_a_of_type_AndroidGraphicsPointF;
            localDynamicStickerData.scale = localbngd.q;
            localDynamicStickerData.rotate = localbngd.r;
            localDynamicStickerData.translateX = (localbngd.s + paramInt1);
            localDynamicStickerData.translateY = (localbngd.t + paramInt2);
            localDynamicStickerData.height = localbngd.v;
            localDynamicStickerData.width = localbngd.u;
            localDynamicStickerData.path = localbngd.jdField_f_of_type_JavaLangString;
            localDynamicStickerData.type = localbngd.h;
            localDynamicStickerData.data = localbngd.jdField_g_of_type_JavaLangString;
            localDynamicStickerData.layerWidth = j;
            localDynamicStickerData.layerHeight = i;
            localDynamicStickerData.mapMotionTrack = localbngd.jdField_a_of_type_JavaUtilMap;
        ...
        if (((ArrayList)localObject).size() > 0)
        {
          ...
          return bnnm.a((ArrayList)localObject);
        }
      }
      return null;
      i = m;
  ...
  public void a(ArrayList<PasterParcelData> paramArrayList, boolean paramBoolean, JSONArray paramJSONArray)
  {
    ...
    if (i < paramArrayList.size())
    {
      ...
      if ((localPasterParcelData.jdField_d_of_type_Int == 3) && (!TextUtils.isEmpty(localPasterParcelData.jdField_e_of_type_JavaLangString)))
      {
        ...
        j = 1;
        localbnmy = bnlj.a(BaseApplicationImpl.getContext(), localPasterParcelData.jdField_e_of_type_JavaLangString);
        if (j == 0) {
          break label443;
        }
        paramJSONArray = localbnmy;
      }
    }
    for (;;)
    {
      ...
      if (paramJSONArray != null)
      {
        ...
        localbngd = new bngd(this, paramJSONArray, new bngh(localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.x, localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.y, localPasterParcelData.jdField_a_of_type_Float, localPasterParcelData.jdField_b_of_type_Float, localPasterParcelData.jdField_c_of_type_Float, localPasterParcelData.jdField_d_of_type_Float, (int)localPasterParcelData.jdField_e_of_type_Float, (int)localPasterParcelData.f), localPasterParcelData.jdField_a_of_type_JavaLangString, localPasterParcelData.jdField_b_of_type_JavaLangString, localPasterParcelData.jdField_c_of_type_JavaLangString, localPasterParcelData.jdField_d_of_type_Int);
        localbngd.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.set(localPasterParcelData.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper);
        localbngd.jdField_g_of_type_JavaLangString = localPasterParcelData.jdField_e_of_type_JavaLangString;
        localbngd.jdField_g_of_type_Int = localPasterParcelData.jdField_e_of_type_Int;
        localbngd.jdField_e_of_type_Int = 0;
        localbngd.jdField_f_of_type_Int = 1;
        localbngd.b = bnlj.a(localbnmy.a());
        localbngd.c = bnlj.b(localbnmy.a());
        if (localbngd.b)
        {
          this.b.add(localbngd);
          if (!TextUtils.isEmpty(localPasterParcelData.jdField_d_of_type_JavaLangString))
          {
            localbngd.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", localPasterParcelData.jdField_d_of_type_JavaLangString, 0, "", 0, "");
            localbngd.jdField_a_of_type_Long = System.currentTimeMillis();
          }
        }
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())) {
          break label471;
        ...
        this.jdField_a_of_type_JavaUtilList.add(localbngd);
      }
      for (;;)
      {
        i += 1;
        ...
        paramJSONArray = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localbnmy.a());
        break label90;
        label471:
        localbngd.h = 0;
        paramJSONArray = (bnfz)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(bnfz.jdField_a_of_type_JavaLangString);
        if (paramJSONArray != null) {
          paramJSONArray.jdField_a_of_type_JavaUtilList.add(localbngd);
        }
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        {
          Object localObject = (bngd)localIterator.next();
          if ((((bngd)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && ((((bngd)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof URLDrawable)))
          {
            localObject = (URLDrawable)((bngd)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
            if (localObject != null)
            {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        Drawable localDrawable = ((bngd)localIterator.next()).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        if ((localDrawable instanceof bnnj)) {
          ((bnnj)localDrawable).a();
        }
      }
    }
    super.b();
  ...
  public void c(Canvas paramCanvas)
  {
    ...
    {
      bngd localbngd = (bngd)localIterator.next();
      Object localObject2 = a(a(localbngd.jdField_f_of_type_JavaLangString));
      if (localObject2 != null) {
        ((Drawable)localObject2).setBounds(0, 0, (int)localbngd.u, (int)localbngd.v);
      }
      Object localObject1 = localObject2;
      if (localbngd.h == 3)
      {
        localObject1 = localObject2;
        if (localbngd.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          localObject1 = localObject2;
          if (!(localbngd.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bnmy)) {}
        }
      }
      for (;;)
      {
        try
        {
          localObject1 = (bnmy)localbngd.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), ((bnmy)localObject1).a());
        }
        catch (Exception localException2)
        {
          try
          {
            ...
            paramCanvas.save();
            paramCanvas.translate(-localbngd.u / 2.0F, -localbngd.v / 2.0F);
