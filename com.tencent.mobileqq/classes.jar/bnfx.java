...
public class bnfx
  extends ayxo
{
  private static bnfx a;
  
  public static bnfx a()
  {
    if (a == null) {}
    try
    {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), bcvt.class);
    try
    {
  ...
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), bcvu.class);
    try
    {
      localNewIntent.putExtra("uin", Long.parseLong(localAppRuntime.getAccount()));
      localNewIntent.putExtra("qua", bmsw.a());
