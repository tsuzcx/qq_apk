...
public class adep
{
  private static adep jdField_a_of_type_Adep = new adep();
  public long a;
  public final Object a;
  public Map<String, adej> a;
  public JSONObject a;
  ...
  static
  {
    Bosses.initWithBoss(BaseApplicationImpl.getApplication(), new wfk(BaseApplicationImpl.getApplication()));
  }
  ...
  public static adep a()
  {
    return jdField_a_of_type_Adep;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    if ((adej)this.jdField_a_of_type_JavaUtilMap.get(paramString) != null) {
      return true;
    }
  ...
  public adej a(String paramString)
  {
    ...
    {
      return localObject;
      localadej = (adej)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      localObject = localadej;
    } while (localadej != null);
      ...
      if (localJSONObject2 != null)
      {
        ...
        if (localJSONArray != null)
        {
          ...
          for (i = 1;; i = 0)
          {
            ...
            paramString = new adej((String)localObject, localJSONObject2.optString("name"));
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 43	adep:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   70: aload_0
    //   71: aload 4
    //   73: invokespecial 222	adep:b	(Ljava/lang/String;)Z
    //   76: istore_2
    //   77: iload_2
    //   78: istore_1
    //   79: iload_2
    ...
    //   113: ldc 200
    //   115: invokestatic 235	adep:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   118: astore_3
    //   119: aload_3
    ...
    //   126: aload_0
    //   127: aload_3
    //   128: invokespecial 222	adep:b	(Ljava/lang/String;)Z
    //   131: istore_1
    //   132: iload_1
    //   133: ifne +11 -> 144
    //   136: ldc 177
    ...
    //   144: aload_0
    //   145: iconst_1
    //   146: putfield 43	adep:jdField_a_of_type_Boolean	Z
    //   149: goto -138 -> 11
    //   152: astore_3
    //   153: aload_0
    //   154: monitorexit
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, adez paramadez)
  {
    awlp localawlp = awlu.a().a(paramString2, paramInt, 1, false, null, 1);
    paramString1 = localawlp;
    if (localawlp == null) {
      paramString1 = new awlp(paramString2, paramInt);
    }
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new adew(null)).map(new VerifyUrlJobSegment(paramString3)).map(new adex(null)).map(new adeu(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new adet(this, paramadez));
  }
  
  public void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, adez paramadez)
  {
    paramString1 = awlu.a().a(paramString2, paramInt, 1, false, null, 1);
    if (paramString1 != null)
    {
      ThreadManager.getUIHandler().post(new DefaultDoraemonAppInfoHelper.2(this, paramadez, paramString1));
      return;
    }
    paramString1 = new awlp(paramString2, paramInt);
    ...
    Stream.of(paramString1).map(new ThreadOffFunction("DoraemonOpenAPI.permissionHelper", 16)).map(new adew(null)).map(new adex(null)).map(new ader(this, paramString2, paramInt)).map(new UIThreadOffFunction(null)).subscribe(new adeq(this, paramadez));
  }
