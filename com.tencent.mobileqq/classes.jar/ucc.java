...
class ucc
  implements Runnable
{
  ucc(ucb paramucb, ArrayList paramArrayList) {}
  
  public void run()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty()))
    {
      this.jdField_a_of_type_Ucb.a.a.jdField_a_of_type_JavaUtilList.clear();
      ...
      while (localIterator.hasNext())
      {
        ...
        this.jdField_a_of_type_Ucb.a.a.jdField_a_of_type_JavaUtilList.add(localGagMemInfo);
      }
    }
    this.jdField_a_of_type_Ucb.a.a.jdField_a_of_type_Ucf.notifyDataSetChanged();
  }
}
