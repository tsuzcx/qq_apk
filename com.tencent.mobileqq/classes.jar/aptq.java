...
{
  aptq(Context paramContext, QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, apnf paramapnf, SessionInfo paramSessionInfo, EmojiStickerManager.StickerInfo paramStickerInfo) {}
  ...
  public void a(EmoticonPackage paramEmoticonPackage)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Apnf.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, Boolean.valueOf(false))) {
        break label170;
      }
    ...
    return;
    label170:
    Object localObject = atuj.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
    if ((localObject != null) && (((attr)localObject).a))
    {
      if (atva.a())
      {
    ...
    do
    {
      ...
      return;
      int j = attl.a(atuj.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0));
      int i = 0;
      ...
      if ((localObject != null) && (!((attr)localObject).c))
      {
        acex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, "", "", "");
        return;
      }
      localObject = ((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment();
    } while (localObject == null);
    ((ChatFragment)localObject).a().a().a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, new aptr(this, paramEmoticonPackage));
    return;
    label483:
