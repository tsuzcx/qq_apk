...
public class ajdo
  extends ajtb
{
  public ajdo(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<ajcw> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        ajcw localajcw = (ajcw)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localajcw.jdField_a_of_type_Int);
        localSTLocalCVerInfo.itemId.set(localajcw.jdField_a_of_type_JavaLangString);
        localSTLocalCVerInfo.localVer.set(localajcw.jdField_b_of_type_Int);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), ajdp.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), ajdp.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), ajdp.class);
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.mApp.getApp(), ajdp.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = ajac.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), ajdp.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ((ajdf)localObject1).c(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((ajdf)localObject1).c(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new ajde();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((ajde)localObject2).jdField_a_of_type_Boolean = bool;
    ...
    {
      ((ajde)localObject2).jdField_b_of_type_Boolean = bool;
      ((ajde)localObject2).jdField_a_of_type_Int = paramArrayOfByte.svrVer.get();
      ((ajde)localObject2).jdField_b_of_type_Int = i;
      ((ajde)localObject2).jdField_d_of_type_JavaLangString = paramArrayOfByte.url.get();
      ((ajde)localObject2).c = paramArrayOfByte.md5.get();
      ((ajde)localObject2).jdField_a_of_type_ArrayOfByte = paramArrayOfByte.patchContent.get().toByteArray();
      ((ajde)localObject2).e = paramArrayOfByte.patchUrl.get();
      ((ajde)localObject2).jdField_b_of_type_Long = paramArrayOfByte.packageSize.get();
      ((ajde)localObject2).jdField_a_of_type_Long = paramArrayOfByte.tipsSize.get();
      ((ajde)localObject2).jdField_a_of_type_JavaLangString = paramArrayOfByte.itemId.get();
      ((ajde)localObject2).jdField_b_of_type_JavaLangString = paramIntent;
      ((ajde)localObject2).jdField_d_of_type_Int = 1;
      ((ajdf)localObject1).a((ajde)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localajco == null) || (localajco.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new aiyo(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localajco.a().updateUserInfo((aiyo)localObject1);
            if (j == ajbo.jdField_a_of_type_Int) {
              localajco.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == ajbo.jdField_b_of_type_Int) {
              localajco.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localajco.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localajco.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == ajbo.jdField_a_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localajco.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_HEAD error openid=" + paramIntent.getString(0));
          return;
        }
        if (j == ajbo.jdField_b_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localajco.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localajco.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localajco.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == ajbo.c)
        {
          localajco.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localajco.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localajco.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = ajac.a(localJSONObject1.optInt("gameId"));
    ...
    localajco.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
