...
public class ajdo
  implements Runnable
{
  public ajdo(AvatarWallAdapter paramAvatarWallAdapter, BorderURLImageView paramBorderURLImageView, String paramString) {}
  ...
  public void run()
  {
    ...
    ((Activity)localObject).runOnUiThread(new ajdp(this, localSetting));
  }
}
