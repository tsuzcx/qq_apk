...
public class ajdo
  extends baox
  implements acoq, aiil, View.OnClickListener
{
  ...
  public ajdo(BaseChatPie paramBaseChatPie)
  {
  ...
  public static void a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    ((ngh)paramQQAppInterface.a(88)).a(paramInt, "", "", "", "", 0L, false);
  }
  ...
  private void d()
  {
    ...
    ngh localngh = (ngh)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88);
    String str = Integer.toString(nfp.a(((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int));
    ...
    {
      localngh.a(134247330, "", str, (String)localObject, "", 0L, false);
      return;
    }
  }
  ...
  public void a()
  {
    ...
    nfp localnfp = (nfp)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    ((baot)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(localnfp.b);
  }
  ...
  public void a(String paramString)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)View.inflate(BaseApplicationImpl.getContext(), 2131493064, null);
    ...
    do
    {
      ...
      {
        return;
        Object localObject = (ImageView)localLinearLayout.findViewById(2131303105);
        TextView localTextView = (TextView)localLinearLayout.findViewById(2131302972);
        ((ImageView)localObject).setOnClickListener(this);
        localTextView.setOnClickListener(this);
        localObject = (URLImageView)localLinearLayout.findViewById(2131302867);
  ...
  public void b()
  {
    ...
    nfp localnfp = (nfp)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    if (QLog.isColorLevel()) {
      QLog.d("ChatApolloViewListener", 2, "currentDelay:" + localnfp.c);
    }
    ...
    if (localnfp.c > 0)
    {
      ((MqqHandler)localObject).postDelayed(this.jdField_a_of_type_JavaLangRunnable, localnfp.c * 1000);
      return;
    }
    c();
  ...
  protected void onChangeUserApolloStatus(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        aisc.a(localBaseChatPie.a(), "cmshow_status", true);
        return;
      }
    } while (1 != ((Integer)paramObject.second).intValue());
    aisc.a(localBaseChatPie.a(), "cmshow_status", false);
    ...
    ((aifc)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).e();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          case 2131301970: 
            if (localBaseChatPie.c == null)
            {
              ...
              localBaseChatPie.c = new bbms(localBaseChatPie.jdField_a_of_type_AndroidContentContext, i);
            }
            localBaseChatPie.c.a(ajjy.a(2131635786));
            localBaseChatPie.c.show();
            c();
            paramView = (nfp)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
            localObject = (baot)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
          }
        } while ((paramView == null) || (localObject == null));
        ((baot)localObject).a(paramView.b, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b);
        Object localObject = (ngh)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88);
        String str = Integer.toString(nfp.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int));
        ...
        {
          ((ngh)localObject).a(134247331, "", str, paramView, Integer.toString(nfp.b()), 0L, false);
          return;
        }
    ...
    do
    {
      ...
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    bbmy.a(BaseApplicationImpl.getContext(), ajjy.a(2131635788), 1).a();
                    return;
                  }
          ...
          bbmy.a(BaseApplicationImpl.getContext(), ajjy.a(2131635787), 1).a();
          return;
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (!azge.b(paramString))) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localBaseChatPie = (BaseChatPie)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        } while ((localBaseChatPie == null) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (localBaseChatPie.jdField_a_of_type_Aihg == null) || (!localBaseChatPie.jdField_a_of_type_Aihg.a()) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null));
        if (!badq.g(localBaseChatPie.jdField_a_of_type_AndroidContentContext))
        {
          ApolloItemBuilder.a(localBaseChatPie.jdField_a_of_type_AndroidContentContext.getString(2131624510), 1, localBaseChatPie.jdField_a_of_type_AndroidContentContext);
          return;
        }
        localObject = aisl.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (localObject == null) {
          break;
        }
        localObject = ((aisi)localObject).a();
      } while ((localObject != null) && (((aisj)localObject).a()));
      localObject = (aifg)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
      ...
      if (((aifg)localObject).b(paramString) != 1)
      {
        ApolloItemBuilder.a(localBaseChatPie.jdField_a_of_type_AndroidContentContext.getString(2131624565), 1, localBaseChatPie.jdField_a_of_type_AndroidContentContext);
        return;
      }
    } while (aifg.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString) == 2);
    if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject = babh.m(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      localBaseChatPie.jdField_a_of_type_Aihg.b();
      ...
      if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) {
        localObject = babh.e(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramString);
      } else if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) {
        localObject = babh.b(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
      } else {
        localObject = "";
      }
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            if (paramInt == 7)
            {
              localObject = (aifc)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211);
              if (((aifc)localObject).jdField_a_of_type_Int != -1)
              {
                ApolloGameUtil.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((aifc)localObject).jdField_a_of_type_Int, 0L, 0, "", 321, null);
                return;
              }
            }
            Object localObject = aisl.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (localObject != null) {
              ((airu)localObject).a(aisl.a(paramInt), null, paramString);
            }
            paramString = (aisi)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
          } while (paramString == null);
        ...
        if (9 == paramInt) {
          bajr.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "click_action_hotspot", ApolloUtil.b(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int), 0, new String[0]);
        }
        if (i != 1) {
          break;
        }
      } while ((!bool) || (-1 == j));
      bajr.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "avatar_clk_togame", ApolloUtil.b(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int), 1, new String[] { String.valueOf(j) });
  ...
  protected void onQueryUserApolloAction(boolean paramBoolean, Object paramObject)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      aifg.jdField_a_of_type_Boolean = true;
      if (QLog.isColorLevel()) {
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    aisi localaisi = (aisi)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    if (localaisi.a() != null) {
      aixo.a(aisl.b(localaisi.a().e), 100, 0, new Object[] { "onSurfaceReady" });
    }
    if (!localBaseChatPie.jdField_a_of_type_Aihg.jdField_a_of_type_Boolean)
    {
      ajas.a("TraceReport_initApolloSurfaceView_PreLoadJS");
