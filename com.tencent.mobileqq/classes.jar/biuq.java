...
public class biuq
{
  private static final biuq jdField_a_of_type_Biuq = new biuq();
  ...
  private biuq()
  {
    a(bixi.a(BaseApplicationImpl.getContext()));
    a();
  }
  
  public static biuq a()
  {
    return jdField_a_of_type_Biuq;
  }
  
  private void a()
  {
    bixw.a(bixw.b, new biur(this), true);
  }
  ...
  private void a(String paramString)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          bixe.a("QRLocalManager", "json parse err", paramString);
          return;
        }
