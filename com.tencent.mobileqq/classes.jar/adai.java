...
public class adai
  extends adaj
{
  private static final Set<WeakReference<adai>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public WeakReference<MessageForArkApp> a;
  public boolean a;
  protected WeakReference<adai> b = new WeakReference(this);
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return null;
              localObject = (adai)((WeakReference)localObject).get();
            } while (localObject == null);
            localObject = ((adai)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          } while (localObject == null);
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (adai)((WeakReference)localObject2).get();
      ((adai)localObject2).doOnEvent(paramInt);
      if (paramInt == 2) {
        b((adai)localObject2);
      }
    }
  ...
  public static void a(adai paramadai)
  {
    if (paramadai == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      jdField_a_of_type_JavaUtilSet.remove(paramadai.b);
      return;
    }
  }
  
  public static void b(adai paramadai)
  {
    WeakReference localWeakReference = paramadai.jdField_a_of_type_JavaLangRefWeakReference;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((MessageForArkApp)localWeakReference.get()).arkContainer = null;
    }
    localWeakReference = paramadai.f;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage)localWeakReference.get()).mOldAppInfo.mArkContainer = null;
    }
    localWeakReference = paramadai.g;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage.ArkMsgAppInfo)localWeakReference.get()).mArkContainer = null;
    }
    paramadai = paramadai.jdField_e_of_type_JavaLangRefWeakReference;
    if ((paramadai != null) && (paramadai.get() != null)) {
      ((ArkBabyqCardInfo)paramadai.get()).mArkBabyqContainer = null;
    }
  }
