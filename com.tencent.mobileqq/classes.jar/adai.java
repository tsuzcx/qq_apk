...
public abstract class adai
  implements adan
{
  private adak jdField_a_of_type_Adak = new adaj(this);
  ...
  public adai(Context paramContext)
  {
  ...
  @Nullable
  public static adan a(@IntRange(from=0L, to=3L) int paramInt, Activity paramActivity)
  {
    if (QLog.isColorLevel()) {
    ...
    default: 
      return null;
    case 1: 
      return new aczx(paramActivity);
    case 2: 
      return new aczz(paramActivity);
    }
    return new adad(paramActivity);
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimFriendshipImplBaseFriendShipLayout == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimFriendshipImplBaseFriendShipLayout.setBackListener(this.jdField_a_of_type_Adak);
