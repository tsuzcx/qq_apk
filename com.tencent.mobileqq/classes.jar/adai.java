  ...
  extends apap
{
  ...
  public adai(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, adah paramadah)
  {
  ...
  private QQMessageFacade.Message a(String paramString, EntityManager paramEntityManager, int paramInt1, int paramInt2)
  {
    ...
    if ((paramString.startsWith("mr_discusssion")) || (paramString.startsWith("mr_troop")))
    {
      ...
      str = "select * from (select count() as unReadNum from %s mr where mr.isread=0),(select count() as hasReply from %s mr where mr.issend=0),%s m where m.isValid=1 and m.msgtype " + adak.a() + " and m.longMsgId='%d' and m.issend='%d' order by %s limit 1";
      if (!bool) {
        break label177;
      }
      if (i == 0) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (!adak.a(paramMessageRecord1, paramMessageRecord2)) {
            break;
          }
  ...
  private List<MessageRecord> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (localList2 == null)
    {
      ...
      localList1 = b(paramString1, paramInt, new bdmj());
  ...
  private List<MessageRecord> a(String paramString, int paramInt, List<MessageRecord> paramList1, List<MessageRecord> paramList2)
  {
    if (paramList1.size() > 15)
    {
      ...
      if ((!adak.a(paramString, paramInt, paramList2)) && (!adak.c(paramList2))) {
        break label207;
      }
      paramInt = 1;
      label60:
  ...
  private void a(bdmj parambdmj)
  {
    if ((parambdmj.jdField_b_of_type_Int != 0) && (bdmc.a()) && (bdmc.a(1)))
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("param_IsMainThread", String.valueOf(parambdmj.jdField_a_of_type_Int));
      localHashMap.put("param_OptType", parambdmj.jdField_a_of_type_JavaLangString);
      localHashMap.put("param_OptTotalCost", String.valueOf(parambdmj.jdField_a_of_type_Long));
      localHashMap.put("param_OptCount", String.valueOf(parambdmj.jdField_b_of_type_Int));
      localHashMap.put("param_OptMsgCount", String.valueOf(parambdmj.c));
      localHashMap.put("param_OptOneCost", String.valueOf(parambdmj.jdField_b_of_type_Long));
      localHashMap.put("param_OptScene", parambdmj.jdField_b_of_type_JavaLangString);
      localHashMap.put("param_WalSwitch", String.valueOf(SQLiteOpenHelper.WAL_ENABLE));
      bdmc.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, parambdmj.c, 0L, localHashMap, null, false);
    }
  }
  ...
  private void a(String paramString, int paramInt, bdmj parambdmj, long paramLong)
  {
    if (TextUtils.equals(parambdmj.jdField_b_of_type_JavaLangString, "launch"))
    {
      paramLong = (System.nanoTime() - paramLong) / 1000L;
      parambdmj.jdField_a_of_type_Long += paramLong;
      parambdmj.jdField_b_of_type_Int += 1;
      parambdmj.c += 1;
      parambdmj.jdField_b_of_type_Long = (parambdmj.jdField_a_of_type_Long / parambdmj.jdField_b_of_type_Int);
      if ((bdmc.c) && (QLog.isColorLevel()) && (adak.a(paramString, paramInt))) {
    ...
    {
      return;
      if (TextUtils.equals(parambdmj.jdField_b_of_type_JavaLangString, "AIO"))
      {
        paramLong = (System.nanoTime() - paramLong) / 1000L;
        parambdmj.jdField_a_of_type_Long = paramLong;
        parambdmj.jdField_b_of_type_Int = 1;
      ...
      else
      {
        ...
        for (paramInt = 1; (paramInt != 0) && (bdmc.a()) && (bdmc.a(2)); paramInt = 0)
        {
          parambdmj.jdField_a_of_type_Int = 1;
          parambdmj.jdField_a_of_type_JavaLangString = "select";
          parambdmj.jdField_b_of_type_JavaLangString = "mainThread";
          parambdmj.jdField_a_of_type_Long = paramLong;
          parambdmj.jdField_b_of_type_Int = 1;
          parambdmj.c = 1;
          parambdmj.jdField_b_of_type_Long = (parambdmj.jdField_a_of_type_Long / parambdmj.jdField_b_of_type_Int);
          paramString = new HashMap();
          paramString.put("param_IsMainThread", String.valueOf(parambdmj.jdField_a_of_type_Int));
          paramString.put("param_OptType", parambdmj.jdField_a_of_type_JavaLangString);
          paramString.put("param_OptTotalCost", String.valueOf(parambdmj.jdField_a_of_type_Long));
          paramString.put("param_OptCount", String.valueOf(parambdmj.jdField_b_of_type_Int));
          paramString.put("param_OptMsgCount", String.valueOf(parambdmj.c));
          paramString.put("param_OptOneCost", String.valueOf(parambdmj.jdField_b_of_type_Long));
          paramString.put("param_OptScene", parambdmj.jdField_b_of_type_JavaLangString);
          paramString.put("param_WalSwitch", String.valueOf(SQLiteOpenHelper.WAL_ENABLE));
          bdmc.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, parambdmj.c, 0L, paramString, null, false);
          return;
        }
      }
    }
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    if (i >= 0)
    {
      String str = adak.a((MessageRecord)paramList.get(i));
  ...
  {
    Object localObject = e(antf.Y, 4001);
    int i;
    if (localObject != null)
    {
      ...
      a(String.valueOf(antf.Y), 4001, c(String.valueOf(antf.Y), 4001), "msgtype=?", new String[] { String.valueOf(paramInt) }, null);
    }
    for (;;)
    {
      if ((localObject != null) && (((List)localObject).size() == 0) && (bdzi.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) <= 0))
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
        RecentUser localRecentUser = (RecentUser)((apaw)localObject).findRecentUserByUin(antf.W, 9000);
  ...
  {
    Object localObject = new bdmj();
    if (Looper.myLooper() == Looper.getMainLooper()) {}
    for (int i = 1;; i = 0)
    {
      ((bdmj)localObject).jdField_a_of_type_Int = i;
      ((bdmj)localObject).jdField_a_of_type_JavaLangString = "select";
      ((bdmj)localObject).jdField_b_of_type_JavaLangString = "AIO";
      localList = a(paramString, paramInt, (bdmj)localObject);
      a((bdmj)localObject);
      if ((localList == null) || (localList.isEmpty())) {
        break label292;
      }
  ...
  private void b(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    adak.a((List)localObject, paramMessageRecord, true);
    if ((localObject != null) && (((List)localObject).size() > 40) && (!adak.a(paramString))) {
  ...
  private MessageRecord c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (localObject2 == null)
      {
        ...
        aosq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt1);
  ...
  private List<MessageRecord> c(String paramString, int paramInt, bdmj parambdmj)
  {
    String str = a(paramString, paramInt);
    ...
    {
      long l = System.nanoTime();
      localList1 = b(paramString, paramInt, parambdmj);
      a(paramString, paramInt, localList1);
      a(paramString, str, localList1, l);
    }
    if (QLog.isColorLevel())
    {
      parambdmj = new StringBuilder();
      parambdmj.append("getMsgList2 uin ").append(paramString).append(" , type = ").append(paramInt).append(" itemList size=").append(localList1.size());
      if ((jdField_b_of_type_Int % 20 == 0) && (jdField_b_of_type_Int > 100)) {
        parambdmj.append("\n").append(QLog.getStackTraceString(new Throwable("MsgProxy_getMsgList1")));
      }
      QLog.d("Q.msg.MsgProxy", 2, parambdmj.toString());
      jdField_b_of_type_Int += 1;
    }
    return localList1;
  }
  ...
  private void c(String paramString, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((!localMessageRecord.isread) && (a(paramInt, paramLong, localMessageRecord)) && ((!adak.b(paramInt)) || (!adak.n(localMessageRecord.msgtype)))) {
          localMessageRecord.isread = true;
        }
      }
      ...
      if ((paramString != null) && (!paramString.isEmpty()))
      {
        ...
        {
          localObject = (MessageRecord)paramString.next();
          if ((!((MessageRecord)localObject).isread) && (a(paramInt, paramLong, (MessageRecord)localObject)) && ((!adak.b(paramInt)) || (!adak.n(((MessageRecord)localObject).msgtype)))) {
            ((MessageRecord)localObject).isread = true;
          }
        }
      }
  ...
  private void c(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (localList != null)
    {
      adak.a(localList, paramMessageRecord, true);
  ...
  private List<MessageRecord> d(String paramString, int paramInt, bdmj parambdmj)
  {
    ...
    do
    {
      ...
      a(paramString, paramInt, parambdmj, l2);
      if (localObject1 != null)
      {
        ...
        while (i < j)
        {
          parambdmj = (MessageRecord)((List)localObject1).get(i);
          ((List)localObject1).set(i, ((List)localObject1).get(paramInt));
          ((List)localObject1).set(paramInt, parambdmj);
          i += 1;
          paramInt -= 1;
        }
      }
      for (parambdmj = (bdmj)localObject1;; parambdmj = new ArrayList())
      {
        localObject1 = adak.a(parambdmj, localList).iterator();
        while (((Iterator)localObject1).hasNext()) {
          adak.a(parambdmj, (MessageRecord)((Iterator)localObject1).next(), true);
        }
      }
      localObject1 = parambdmj;
    } while (!QLog.isColorLevel());
    QLog.d("Q.msg.MsgProxy", 2, new Object[] { "init from db, uin=", paramString, ", isSaveToDatabase=", Boolean.valueOf(bool), ", cost=", Long.valueOf(System.currentTimeMillis() - l1), " sqlStr = ", localObject2, " size =", Integer.valueOf(parambdmj.size()) });
    return parambdmj;
  }
  ...
  private List<MessageRecord> g(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      localObject1 = adak.a(paramString, (List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext()) {
        adak.a(paramString, (MessageRecord)((Iterator)localObject1).next(), true);
      }
      label348:
  ...
  private void g()
  {
    akwu localakwu = (akwu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(125);
    localakwu.e = null;
    localakwu.f = null;
  }
  ...
  {
    Lock localLock = a(antf.Y, paramInt);
    localLock.lock();
    try
    {
      paramInt = b(paramInt);
  ...
  public int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (adak.d(paramInt))
    {
      paramString = "( msgtype " + adak.b() + " and isValid=1 ) and ( time < ? or (time = ? and longMsgIndex <= ? and _id <= ?))";
  ...
  public int a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localazor = (azor)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
      Looper localLooper = Looper.getMainLooper();
      if (Thread.currentThread() != localLooper.getThread()) {
        break label95;
      }
      ThreadManager.post(new MsgProxy.1(this, localazor, paramString, paramInt), 10, null, false);
    }
    label95:
    while (localazor == null) {
      return i;
    }
    localazor.a(c(paramString, paramInt), null, null);
    return i;
  }
  ...
  public adah a()
  {
    return this.jdField_a_of_type_Adah;
  }
  ...
  public Cursor a(String paramString, int paramInt)
  {
    ...
    if (paramString.equals(String.valueOf(antf.G)))
    {
      ArrayList localArrayList = new ArrayList();
      int i = 0;
      ...
      return new adaf(this, localArrayList);
    }
    return new adaf(this, (List)((ArrayList)localList).clone());
  }
  ...
  public QQMessageFacade.Message a(String paramString, EntityManager paramEntityManager, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().transSaveLock)
      {
        ...
        ((StringBuilder)localObject1).append(adak.a());
  ...
  public FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt1, String paramString2, int paramInt2, aops paramaops)
  {
    ...
    for (;;)
    {
      ...
      long l2 = aopx.jdField_a_of_type_Long;
      ...
      try
      {
        paramString2 = a(paramString1, paramInt1, paramString2, paramaops, (Cursor)localObject);
  ...
  protected FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt, String paramString2, aops paramaops, Cursor paramCursor)
  {
    return aopu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aznw, paramCursor, paramString1, paramInt, paramString2, paramaops);
  }
  ...
  protected ChatHistorySearchData a(Cursor paramCursor, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      if (str1 != null)
      {
        localObject = bhlg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo, str1.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()), str1);
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    //   44: invokevirtual 497	adai:c	(Ljava/lang/String;I)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_0
    //   49: invokevirtual 182	adai:a	()Laznw;
    //   52: iconst_0
    //   53: aload_3
    //   54: aconst_null
    //   55: ldc_w 1112
    ...
    //   73: ldc_w 1003
    //   76: aconst_null
    //   77: invokevirtual 859	aznw:query	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   80: astore 5
    //   82: aload_0
    //   83: aload 5
    //   85: aload_1
    //   86: aload_2
    //   87: invokevirtual 1114	adai:a	(Landroid/database/Cursor;Lcom/tencent/mobileqq/activity/aio/SessionInfo;Ljava/lang/String;)Lcom/tencent/mobileqq/data/ChatHistorySearchData;
    //   90: astore_1
    //   91: aload_1
    //   92: astore_3
    //   93: aload 5
  ...
  protected String a(Cursor paramCursor, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    if (bhnt.a(paramCursor.getInt(paramCursor.getColumnIndex("issend")))) {
  ...
  {
    return beyo.b(paramString1, paramString2, paramString3, paramLong, paramInt);
  }
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if ((!adak.a(paramInt1)) || (((MessageRecord)localObject2).versionCode != 3) || (((MessageRecord)localObject2).shmsgseq != l3) || (l3 == 0L)) {
            for (;;)
            {
              int j;
              long l5;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByMsgUniseqFromDB, peerUin[" + aunj.e(paramString) + "] type[" + paramInt + "] uniseq[" + paramLong + "]");
    }
    if (paramLong == 0L)
    {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localObject = ((aznw)localObject).a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
  ...
  protected List<MessageRecord> a(String paramString1, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, String paramString2)
  {
    ...
    paramString2 = bhnp.a(d(paramString1, paramInt1), c(paramString1, paramInt1), paramLong1, paramInt2, paramLong2, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString2);
    if (paramString2 != null)
    {
      if (a(paramString1, paramInt1, true)) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.transSaveToDatabase(a());
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    for (int i = aqyt.a(paramInt1, paramInt2) << 3;; i = 0)
    {
      ...
      if (i == 0)
      {
        ...
        localObject1 = ((aznw)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, (QQAppInterface)localObject3);
        if (QLog.isColorLevel())
        {
      ...
      for (paramInt1 = 0;; paramInt1 = ((List)localObject1).size())
      {
        ...
        localObject1 = ((StringBuilder)localObject1).toString();
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        localObject1 = ((aznw)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2), String.valueOf(i) }, (QQAppInterface)localObject3);
        break;
      }
    }
  }
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, bdmj parambdmj)
  {
    Lock localLock = a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = c(paramString, paramInt, parambdmj);
      return paramString;
    }
    finally
    {
  ...
  public List<MessageRecord> a(String paramString, int paramInt, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfInt.hasNext())
      {
        ...
        if (((!adak.a(paramInt)) || (((MessageRecord)localObject).versionCode != 3) || (((MessageRecord)localObject).shmsgseq != l) || (l == 0L)) && ((paramString.contains(Integer.valueOf(((MessageRecord)localObject).msgtype))) || (paramString.isEmpty()))) {
  ...
  {
    return this.jdField_a_of_type_Adah.a();
  }
  
  protected ConcurrentHashMap<String, List<MessageRecord>> a()
  {
    return this.jdField_a_of_type_Adah.b();
  }
  
  protected Lock a(String paramString, int paramInt)
  {
    return this.jdField_a_of_type_Adah.a(paramString, paramInt);
  }
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    if ((localList != null) && (localList.size() == 0))
    {
      ...
      a().remove(a(paramString, paramInt));
      a(paramString, paramInt, b(paramString, paramInt, new bdmj()));
    }
  }
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    for (String str1 = "shmsgseq";; str1 = "time")
    {
      ...
      if ((!adak.b(paramInt)) || (adak.d() == null)) {
        break;
      }
      a(paramString, paramInt, str3, localContentValues, String.format("isread=? and %s<=? and " + adak.d(), new Object[] { str1 }), new String[] { "0", str2 }, null);
      return;
    }
  ...
  protected void a(String paramString, int paramInt1, MessageRecord paramMessageRecord, int paramInt2)
  {
    ...
    if (((paramInt1 == 1001) || (paramInt1 == 10002)) && (paramMessageRecord.msgtype != -1003) && (paramMessageRecord.msgtype != -1031) && (paramMessageRecord.msgtype != -1032) && (paramMessageRecord.msgtype != 201)) {
      ...
      {
        str = c(String.valueOf(antf.H), 1001);
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        str = d(String.valueOf(antf.H), 1001);
        break;
        if (paramInt1 == 1009)
        {
          a(paramString, paramInt1, c(antf.w, 1009), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else if (paramInt1 == 1010)
        {
          a(paramString, paramInt1, c(antf.ab, 1010), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
        else
        {
          if ((paramInt1 != 0) || (!TextUtils.equals(paramString, antf.M))) {
            break label315;
          }
          a(paramString, paramInt1, c(antf.M, 0), localContentValues, "senderuin=? and isread=?", new String[] { paramString, "0" }, null);
        }
      }
      if ((paramInt1 == 1032) && (TextUtils.equals(paramString, antf.aM)))
      {
    ...
    paramInt2 = aqyt.a(paramInt1, paramInt2) << 3;
    a(paramString, paramInt1, c(antf.aM, 1032), localContentValues, "senderuin=? and isread=? and (extLong & 4194296)=? ", new String[] { paramString, "0", Integer.toString(paramInt2) }, null);
  ...
  {
    if ((adak.o(paramMessageRecord.msgtype)) && (!adak.b(paramMessageRecord.frienduin, paramMessageRecord.istroop))) {}
    while (!paramBoolean2) {
      return;
    }
    if (paramBoolean1)
  ...
  {
    b(adak.a(paramList), paramProxyListener);
  }
  ...
  {
    return bhnp.a(c(paramString, paramInt), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
  }
  ...
  protected boolean a(String paramString1, int paramInt, String paramString2, List<MessageRecord> paramList)
  {
    ...
    if ((!a().containsKey(paramString2)) && (localbbnr.a(paramString1)))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
      {
        ...
        if (i < localVector.size())
        {
          ...
          if ((adak.a(localMsgQueueItem.frindUin, paramString, localMsgQueueItem.type, paramInt)) && ((localMsgQueueItem.action == 1) || (localMsgQueueItem.action == 2) || ((paramBoolean) && (localMsgQueueItem.action == 0))))
          {
            if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            MessageRecord localMessageRecord = (MessageRecord)localMsgQueueItem.item;
            if ((adak.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt)) && (localMsgQueueItem.action == 0) && (localMessageRecord.time > paramLong) && (!localMessageRecord.isread) && (!localMessageRecord.isSend())) {
              i += 1;
            }
          }
        }
  ...
  public MessageRecord b(String paramString, int paramInt)
  {
    ...
    if (a(str1, false)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.transSaveToDatabase(this.jdField_a_of_type_Aznw);
    }
    String str2 = adak.b();
    if (adak.a(paramInt)) {}
  ...
  public MessageRecord b(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (adak.a(paramInt))
    {
      localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(adak.a()).append(" ");
      if (paramString2 != null) {}
    ...
    StringBuilder localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(adak.a()).append(" ");
    if (paramString2 != null) {}
    for (paramString1 = "and " + paramString2;; paramString1 = "")
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, bdmj parambdmj)
  {
    Lock localLock = a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = d(paramString, paramInt, parambdmj);
      return paramString;
    }
    finally
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, List<Long> paramList)
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject = new StringBuilder().append("queryMessagesByMsgUniseqFromDB, peerUin[").append(aunj.e(paramString)).append("] type[").append(paramInt).append("] uniseqList[");
      if (paramList == null)
      {
        i = 0;
  ...
  protected List<MessageRecord> c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          MessageRecord localMessageRecord = (MessageRecord)localMsgQueueItem.item;
          if ((adak.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt1)) && (localMsgQueueItem.action == 0) && ((paramInt2 <= 0) || (localMessageRecord.getConfessTopicId() == paramInt2))) {
            localArrayList.add(localMessageRecord);
          }
        }
      }
  ...
  protected List<MessageRecord> c(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    for (;;)
    {
      localObject = a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      paramString2 = ((aznw)localObject).a(paramString2, new String[] { String.valueOf(paramLong), String.valueOf(l) }, localQQAppInterface);
      if (paramString2 == null) {
        break label299;
      }
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> c(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = ((aznw)localObject).a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    paramString = (String)localObject;
    if (localObject == null) {
      paramString = new ArrayList();
    }
  ...
  protected void c(String paramString, int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      List localList = adak.a((List)localObject1, paramList);
      Iterator localIterator = localList.iterator();
      while (localIterator.hasNext())
      {
      ...
      if (akwu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) {
      ...
      if ((paramInt == 0) && (((List)localObject1).size() > 0) && (avpe.a((MessageRecord)((List)localObject1).get(0)))) {
        paramInt = localList.size() - 1;
      }
      while (paramInt >= 0)
      {
        adak.a((List)localObject1, (MessageRecord)localList.get(paramInt), true);
        paramInt -= 1;
        continue;
  ...
  public MessageRecord d(String paramString, int paramInt, long paramLong)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if ((localMessageRecord.shmsgseq == paramLong) && (!adak.a(localMessageRecord))) {
          return localMessageRecord;
        }
      }
    }
  ...
  public List<MessageRecord> d(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Object localObject1 = "select * from " + paramString + " where (shmsgseq < ? and msgtype " + adak.b() + " and isValid=1) order by shmsgseq desc limit ";
    ...
    for (;;)
    {
      ...
      {
        azor localazor = (azor)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
        if (localazor != null)
        {
          localObject1 = localazor.a().a((String)localObject1 + (paramInt2 - paramString.size()), (String[])localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          if (QLog.isColorLevel())
          {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt1, int paramInt2)
  {
    ...
    aznw localaznw = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaznw.a((String)localObject, new String[] { String.valueOf(-2006), String.valueOf(paramInt2) }, localQQAppInterface);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> e(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    paramString = "select * from " + (String)localObject2 + " where (shmsgseq >= ? and msgtype " + adak.b() + " and isValid=1) order by shmsgseq asc limit " + (paramInt2 + 1);
    ...
    for (;;)
    {
      ...
      if (localazor != null)
      {
        localObject2 = "select * from " + (String)localObject2 + " where (shmsgseq > ? and msgtype " + adak.b() + " and isValid=1) order by shmsgseq asc limit " + paramInt2;
        localObject1 = localazor.a().a((String)localObject2, (String[])localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel())
        {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    int i = 0;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByTimeFromDB, peerUin[" + aunj.e(paramString) + "] type[" + paramInt + "] time[" + paramLong1 + "] uid[" + paramLong2 + "]");
    }
    ...
    aznw localaznw = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaznw.a((String)localObject, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByTimeFromDB, peerUin[").append(aunj.e(paramString)).append("] type[").append(paramInt).append("] time[").append(paramLong1).append("] uid[").append(paramLong2).append("], list.size():");
      if (localObject != null) {
        break label287;
      }
    }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 141	adai:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   4: invokevirtual 637	com/tencent/mobileqq/app/proxy/ProxyManager:transSaveToDatabase	()V
    //   7: aload_0
    //   8: getfield 141	adai:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   11: invokevirtual 1984	com/tencent/mobileqq/app/proxy/ProxyManager:clearMsgQueue	()V
    //   14: aload_0
    //   15: invokevirtual 182	adai:a	()Laznw;
    //   18: invokevirtual 1988	aznw:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   21: astore 11
    //   23: aload_0
    //   24: getfield 279	adai:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: return
    //   45: aload_0
    //   46: getfield 279	adai:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   49: sipush 201
    //   52: invokevirtual 769	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   55: checkcast 874	azor
    //   58: astore 14
    //   60: iconst_0
    //   61: istore_1
    //   62: iload_1
    ...
    //   302: astore 8
    //   304: iload_2
    //   305: invokestatic 828	adak:a	(I)Z
    //   308: ifne +20 -> 328
    //   311: lload 6
    //   313: lstore 4
    //   315: iload_3
    ...
    //   330: astore 8
    //   332: aload_0
    //   333: getfield 279	adai:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   336: invokevirtual 284	com/tencent/mobileqq/app/QQAppInterface:a	()Lbcrg;
    //   339: aload 10
    //   341: iload_2
    //   342: lload 4
    //   344: invokevirtual 2023	bcrg:a	(Ljava/lang/String;IJ)V
    //   347: aload 9
    //   349: ifnull +10 -> 359
    //   352: aload 9
    ...
    //   408: aconst_null
    //   409: aconst_null
    //   410: invokevirtual 897	azor:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   413: pop
    //   414: iload_1
    //   415: iconst_1
    //   416: iadd
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + aunj.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    aznw localaznw = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localaznw.a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + aunj.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    ...
    aznw localaznw = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaznw.a((String)localObject, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByShmsgseqFromDB, peerUin[").append(aunj.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
      if (localObject != null) {
        break label261;
      }
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB4Troop, peerUin[" + aunj.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    if ((paramLong == 0L) && (QLog.isColorLevel())) {
    ...
    paramString = "select * from " + c(paramString, paramInt) + " where shmsgseq=? and msgtype " + adak.c();
    aznw localaznw = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localaznw.a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if ((paramString != null) && (paramString.size() > 0)) {
      return (MessageRecord)paramString.get(0);
    }
    return null;
  ...
  public MessageRecord j(String paramString, int paramInt, long paramLong)
  {
    ...
    Object localObject2 = (azor)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    if (localObject2 != null)
    {
      if (QLog.isColorLevel()) {
      ...
      localObject2 = ((azor)localObject2).a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      localObject1 = ((aznw)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
      if (QLog.isColorLevel())
      {
        paramString = new StringBuilder().append("queryMsgItemHistoryByShmsgseq, slow db return peerUin[").append(aunj.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
        if (localObject1 != null) {
          break label211;
        }
      }
