  ...
  implements bfrk
{
  ...
  public assz(MultiCardRootLayout paramMultiCardRootLayout) {}
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        asta localasta = (asta)MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout).get();
        if (localasta != null) {
          MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout, localasta.a(paramMotionEvent));
        }
      }
