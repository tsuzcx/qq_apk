...
public class aqzr
  extends aqyy<aqzc>
{
  aqzr(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt1, int paramInt2, long paramLong, LocationRoom.Venue paramVenue)
  {
    ...
    Object localObject = ardf.a(this.a, paramInt2, paramLong);
  ...
  {
    ardf.a(this.a, paramInt1, paramString, false);
    arde.a(this.a, paramInt1, paramString, false);
  ...
  protected aqzc a()
  {
    return aqzc.a(this.a);
  }
  
  void a(aqyw paramaqyw, LocationRoom.Venue paramVenue)
  {
    if ((paramaqyw == null) || (paramVenue == null)) {
      return;
    }
    a(1, paramaqyw.a(), Long.parseLong(paramaqyw.a()), paramVenue);
  }
  ...
  void b(aqyw paramaqyw, LocationRoom.Venue paramVenue)
  {
    if ((paramaqyw == null) || (paramVenue == null)) {
      return;
    }
    a(3, paramaqyw.a(), Long.parseLong(paramaqyw.a()), paramVenue);
  }
}
