...
public class awel
{
  private static awel jdField_a_of_type_Awel;
  public static boolean a;
  private awem jdField_a_of_type_Awem;
  ...
  {
    if (jdField_a_of_type_Awel == null) {
      jdField_a_of_type_Awel = new awel();
    }
    return jdField_a_of_type_Awel;
  }
  
  public static URLDrawable a(String paramString, int paramInt1, int paramInt2)
  {
    URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
    localURLDrawableOptions.mLoadingDrawable = new asbg(-10065297, 100, 100);
    localURLDrawableOptions.mFailedDrawable = new asbg(-10065297, 100, 100);
  ...
  public static URLDrawable a(String paramString1, String paramString2, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt3, QQLiveDrawable.OnStateListener paramOnStateListener, URLDrawable paramURLDrawable)
  {
    ...
    localQQLiveDrawableParams.mCoverUrl = ShortVideoUtils.getThumbUrl(paramString2).toString();
    localQQLiveDrawableParams.mCoverLoadingDrawable = new asbg(-10065297, 100, 100);
    ...
    for (paramString1.mLoadingDrawable = paramURLDrawable;; paramString1.mLoadingDrawable = new asbg(-10065297, 100, 100))
    {
      paramString1.mRequestWidth = paramInt1;
      paramString1.mRequestHeight = paramInt2;
      return URLDrawable.getDrawable(ahfz.a(paramLong), paramString1);
    }
  }
  ...
  {
    this.jdField_a_of_type_Awem = paramawem;
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Awem != null) {
      this.jdField_a_of_type_Awem.a(paramBoolean);
    }
  }
