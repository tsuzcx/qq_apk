...
public class atvk
{
  ...
  private static atvk jdField_a_of_type_Atvk;
  ...
  public static atvk a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface == null) {
      throw new IllegalArgumentException("DraftTextManager this.app == null");
    }
    if (jdField_a_of_type_Atvk == null)
    {
      jdField_a_of_type_Atvk = new atvk();
      a(paramQQAppInterface);
    }
    return jdField_a_of_type_Atvk;
  }
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((paramQQAppInterface != null) && (!bdje.a(paramQQAppInterface.text))) {
  ...
  public void a(QQAppInterface paramQQAppInterface, DraftTextInfo paramDraftTextInfo)
  {
    ...
    //   14: aload_0
    //   15: getfield 35	atvk:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   18: astore_3
    //   19: aload_3
    //   20: monitorenter
    //   21: aload_2
    ...
    //   36: invokestatic 169	atvk:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   39: astore 4
    //   41: getstatic 31	atvk:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   44: aload 4
    //   46: invokevirtual 183	java/util/HashSet:contains	(Ljava/lang/Object;)Z
    //   49: ifne +12 -> 61
    //   52: getstatic 31	atvk:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   55: aload 4
    //   57: invokevirtual 173	java/util/HashSet:add	(Ljava/lang/Object;)Z
    //   60: pop
    //   61: getstatic 23	atvk:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   64: aload 4
    //   66: aload_2
    //   67: invokevirtual 177	android/support/v4/util/LruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   70: pop
    //   71: getstatic 25	atvk:b	Landroid/support/v4/util/LruCache;
    //   74: aload 4
    //   76: aload_2
    //   77: invokestatic 179	atvk:a	(Lcom/tencent/mobileqq/data/DraftTextInfo;)Lcom/tencent/mobileqq/data/DraftSummaryInfo;
    ...
    //   89: aload_1
    //   90: aload_2
    //   91: invokespecial 253	com/tencent/mobileqq/managers/DraftTextManager$1:<init>	(Latvk;Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/data/DraftTextInfo;)V
    //   94: bipush 8
    //   96: aconst_null
    //   97: iconst_0
  ...
  public DraftTextInfo b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if (localDraftTextInfo == null)
    {
      ...
      {
        localObject = paramQQAppInterface;
        if (!bdje.a(paramQQAppInterface.text))
        {
          jdField_a_of_type_AndroidSupportV4UtilLruCache.put(str, paramQQAppInterface);
          localObject = paramQQAppInterface;
        }
