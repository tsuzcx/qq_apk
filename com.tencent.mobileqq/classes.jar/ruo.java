...
public class ruo
{
  private static final String jdField_a_of_type_JavaLangString = "Q.readinjoy.video." + ruo.class.getSimpleName();
  private static final ruo jdField_a_of_type_Ruo = new ruo();
  ...
  {
    return bmqa.a(pha.a(), true, true).getInt(paramString, 0);
  }
  
  public static ruo a()
  {
    return jdField_a_of_type_Ruo;
  }
  ...
  {
    if (bmqa.a(pha.a(), true, true) == null)
    {
      a("writeToSP() failed");
      return;
    }
    bmqa.a(paramString, Integer.valueOf(paramInt));
  }
  ...
  private static boolean a()
  {
    ...
    localObject1 = i + j + k;
    Object localObject2 = bmqa.a(pha.a(), true, true);
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          ...
          if ((paramtkf instanceof VideoInfo.EntranceDownloadInfo))
          {
            if (bool)
            {
              this.b += 1;
