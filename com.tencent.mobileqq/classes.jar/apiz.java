...
public class apiz
  implements apjy
{
  public apiz(ArConfigService paramArConfigService) {}
    ...
    if (ArConfigService.b(this.a) != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ((aplq)ArConfigService.b(this.a).getBroadcastItem(i)).a(paramInt1, paramInt2);
            i += 1;
          }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ((aplq)ArConfigService.b(this.a).getBroadcastItem(i)).a(paramInt);
        }
        catch (RemoteException localRemoteException)
        {
          localRemoteException.printStackTrace();
        }
        ((aplq)ArConfigService.b(this.a).getBroadcastItem(i)).b(paramInt, 0);
      }
      catch (Exception localException)
      {
        if (QLog.isColorLevel()) {
