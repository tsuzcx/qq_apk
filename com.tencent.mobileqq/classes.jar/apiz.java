  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    if (paramArrayOfByte != null)
    {
      try
      {
        ...
        paramArrayOfByte = (MessageForYanZhi)azaf.a(-2070);
        ...
        paramArrayOfByte.msg = (localMsgBody.uint32_like_count.get() + BaseApplicationImpl.getContext().getString(2131694563));
        ...
        paramArrayOfByte.frienduin = alof.H;
        paramArrayOfByte.senderuin = alof.ap;
