  ...
  implements Closeable
{
  ...
  public bked(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, bkee parambkee)
  {
    ...
    try
    {
      ...
      l2 = a(arrayOfByte, 0);
      long l3 = parambkee.jdField_a_of_type_Long;
      if (l2 != l3) {
        return false;
      }
      k = a(arrayOfByte, 8);
      ...
      if ((parambkee.jdField_a_of_type_ArrayOfByte == null) || (parambkee.jdField_a_of_type_ArrayOfByte.length < m)) {
        parambkee.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = parambkee.jdField_a_of_type_ArrayOfByte;
      parambkee.jdField_a_of_type_Int = m;
    ...
    catch (Throwable parambkee)
    {
      QLog.e("BlobCache", 2, "getBlob failed.", parambkee);
      return false;
    }
    finally
    {
  ...
  public boolean a(bkee parambkee)
  {
    if ((a(parambkee.jdField_a_of_type_Long, this.g)) && (a(this.jdField_d_of_type_JavaIoRandomAccessFile, this.j, parambkee))) {}
    int k;
    do
    {
      return true;
      k = this.i;
      if ((!a(parambkee.jdField_a_of_type_Long, this.h)) || (!a(this.jdField_e_of_type_JavaIoRandomAccessFile, this.j, parambkee))) {
        break;
      }
    } while ((this.jdField_e_of_type_Int + 20 + parambkee.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
      b(parambkee.jdField_a_of_type_Long, parambkee.jdField_a_of_type_ArrayOfByte, parambkee.jdField_a_of_type_Int);
      this.jdField_d_of_type_Int += 1;
      a(this.jdField_a_of_type_ArrayOfByte, 16, this.jdField_d_of_type_Int);
      f();
      return true;
