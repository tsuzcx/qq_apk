  ...
  extends PopupWindow
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new axij(this);
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private axik jdField_a_of_type_Axik;
  private String jdField_a_of_type_JavaLangString;
  
  public axii(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramContext);
    ...
    View localView = LayoutInflater.from(paramContext).inflate(2131559578, null);
  ...
  private void a(Context paramContext, View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363759));
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)paramView.findViewById(2131368505).getLayoutParams();
    ...
    for (;;)
    {
      ...
      setBackgroundDrawable(paramContext.getResources().getDrawable(2130850664));
      return;
  ...
  public void a(axik paramaxik)
  {
    this.jdField_a_of_type_Axik = paramaxik;
  }
