  ...
  implements acna
{
  ...
  public void a(String paramString, int paramInt1, int paramInt2, QQMessageFacade.RefreshMessageContext paramRefreshMessageContext)
  {
    ...
    if (uuc.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))
    {
      if ((paramRefreshMessageContext.resultMsgList == null) || (paramRefreshMessageContext.resultMsgList.size() == 0))
      {
        l = okn.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
        ...
        bdla.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", paramString, "0X8005C99", "0X8005C99", 0, 1, 0, "new", "2", "", "");
        return;
      }
