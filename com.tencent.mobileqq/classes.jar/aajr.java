...
public final class aajr
  implements bbhz
{
  public aajr(aajz paramaajz, QQAppInterface paramQQAppInterface, String paramString, int paramInt, Activity paramActivity) {}
  
  public void a(Dialog paramDialog, View paramView, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Aajz != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Aajz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
        this.jdField_a_of_type_Aajz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
      }
      this.jdField_a_of_type_Aajz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
      this.jdField_a_of_type_Aajz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
    }
    ...
    for (paramDialog = paramDialog.toString();; paramDialog = null)
    {
      if (i <= 0)
      {
        bbmy.a(BaseApplication.getContext(), 2, 2131625935, 1).a();
        if (this.jdField_a_of_type_Aajz != null) {
          this.jdField_a_of_type_Aajz.a(this.jdField_a_of_type_AndroidAppActivity);
        }
      }
      label356:
      do
      {
        ...
        for (;;)
        {
          aisc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "chat_history_c2c_start_del_msg");
          if (!paramBoolean) {
            break label442;
          }
          ...
          bbmy.a(BaseApplication.getContext(), 2131625932, 1).a();
          return;
        ...
        ((ajmp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(92)).h();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
        paramView.m();
      ...
      } while (this.jdField_a_of_type_Aajz == null);
      label405:
      label442:
      this.jdField_a_of_type_Aajz.a(this.jdField_a_of_type_AndroidAppActivity);
      return;
