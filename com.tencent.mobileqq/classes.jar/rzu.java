  ...
  implements ryo
{
  ...
  public static int a(Context paramContext)
  {
    ...
    sai.b("wifiInfo", paramContext.toString());
    sai.b("SSID", "" + paramContext.getIpAddress());
  ...
  public static stReportItem a()
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      localstReportItem.qua = bfpk.a();
      localstReportItem.vendor = babp.h();
      localObject = new stDevice();
      ((stDevice)localObject).encrypted_deviceid = rxf.a().e();
      ...
      if (!vnd.a(BaseApplicationImpl.getContext())) {
        break label200;
      }
    }
    label200:
  ...
  public static stReportItem a(stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      sai.d("weishi-report", "convertFeedToReport feed == null");
      return localstReportItem;
    }
  ...
  private static String a()
  {
    ...
    if ((c.endsWith(ajjy.a(2131650182))) && (c.length() > 1)) {
  ...
  private static String a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      default: 
        return str;
        str = ajjy.a(2131650178);
        continue;
        str = ajjy.a(2131650155);
        continue;
        str = ajjy.a(2131650165);
        continue;
        str = ajjy.a(2131650172);
        continue;
        str = ajjy.a(2131650162);
        continue;
        str = ajjy.a(2131650166);
        continue;
        str = ajjy.a(2131650181);
        continue;
        str = ajjy.a(2131650149);
        continue;
        str = ajjy.a(2131650152);
        continue;
        str = ajjy.a(2131650157);
        continue;
        str = ajjy.a(2131650179);
        continue;
        str = ajjy.a(2131650174);
        continue;
        str = ajjy.a(2131650168);
        switch (paramInt2)
        {
        default: 
          break;
        case 12: 
          str = ajjy.a(2131650144);
          continue;
          str = ajjy.a(2131650176);
          continue;
          str = ajjy.a(2131650183);
          continue;
          str = ajjy.a(2131650156);
          continue;
          str = ajjy.a(2131650177);
          continue;
          str = ajjy.a(2131650151);
          continue;
          str = ajjy.a(2131650147);
          continue;
          str = ajjy.a(2131650167);
          continue;
          str = ajjy.a(2131650145);
          continue;
          str = ajjy.a(2131650171);
          switch (paramInt2)
          {
          default: 
            break;
          case 12: 
            str = ajjy.a(2131650159);
            continue;
            str = ajjy.a(2131650153);
            switch (paramInt2)
            {
            default: 
              break;
            case 12: 
              str = ajjy.a(2131650161);
              continue;
              str = ajjy.a(2131650148);
              continue;
              str = ajjy.a(2131650158);
              continue;
              str = ajjy.a(2131650163);
              switch (paramInt2)
              {
              default: 
                break;
              case 2: 
                str = ajjy.a(2131650180);
                break;
              case 6: 
                str = ajjy.a(2131650169);
                continue;
                str = ajjy.a(2131650170);
                switch (paramInt2)
                {
                default: 
                  break;
                case 2: 
                  str = ajjy.a(2131650173);
                  break;
                case 14: 
                  str = ajjy.a(2131650150);
                  break;
                case 12: 
                  str = ajjy.a(2131650146);
                  break;
                case 6: 
                  str = ajjy.a(2131650154);
                  continue;
                  str = ajjy.a(2131650160);
                  switch (paramInt2)
                  {
                  case 10: 
                  case 11: 
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = befc.a("1d76c6");
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        sai.d("weishi-810", "telephonyManager.getDeviceId encounter error:" + paramContext);
      }
    }
  }
  ...
  public static void a(stReportItem paramstReportItem)
  {
    if (paramstReportItem == null)
    {
      sai.d("weishi-report", "report error item = null");
      return;
    }
  ...
  public static void a(ArrayList<stReportItem> paramArrayList)
  {
    ...
    {
      sai.d("weishi-report", "report error items: " + paramArrayList);
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      sai.b("weishi-report", "report " + str + " stReportItem:" + localstReportItem.toString());
    }
    paramArrayList = new ryz(new sad(paramArrayList), null, new rzv(str), 2001);
    rys.a().a(paramArrayList);
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    try
    {
      sai.b("weishi-810", "try get QIMei from UserAction.getQIMEI!");
      b = UserAction.getQIMEI();
      if (b == null)
      {
        sai.d("weishi-810", "getImei finally encounter error and return empty");
        b = "";
      }
      return b;
    }
    catch (Throwable paramContext)
    {
      for (;;)
      {
        sai.d("weishi-810", "UserAction.getQIMEI encounter error:" + paramContext);
      }
    }
  }
