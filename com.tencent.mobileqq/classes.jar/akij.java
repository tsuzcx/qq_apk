...
public class akij
{
  ...
  private static void a(int paramInt1, int paramInt2, String paramString)
  {
    ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.11(paramString, paramInt1, paramInt2));
  }
  ...
  public static void a(int paramInt1, ChatMessage paramChatMessage, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramChatMessage.mExJsonObject != null) {
        str = b(paramChatMessage.mExJsonObject.optString("report_key_bytes_oac_msg_extend"));
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    case 7230: 
      ...
      if ((paramRecentBaseData instanceof RecentItemPublicAccountChatMsgData))
      {
        ...
        if (adkp.a(str2)) {
          ahyd.a().a(paramQQAppInterface, 2);
        }
    ...
    for (;;)
    {
      ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.4(str2, str1, i, k, paramQQAppInterface, paramRecentBaseData.mLastMsg.toString()));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while (!(paramAbsListView.getAdapter() instanceof bejx));
      localObject = (bejx)paramAbsListView.getAdapter();
    } while (!(((bejx)localObject).getWrappedAdapter() instanceof ahai));
    b.clear();
    ahai localahai = (ahai)((bejx)localObject).getWrappedAdapter();
    ...
    if (i < k - 1)
    {
      paramAbsListView = localahai.getItem(i);
      String str;
      if ((paramAbsListView instanceof RecentBaseData))
      {
        ...
        if (!a.containsKey(str))
        {
          ...
          ahyd.a().a(paramQQAppInterface, 1);
        }
      ...
      do
      {
        for (;;)
        {
          i += 1;
          break;
          if ((!(localRecentBaseData instanceof RecentItemServiceAccountFolderData)) || (!adkp.a(rol.a().a()))) {
            break label186;
          }
          ahyd.a().a(paramQQAppInterface, 1);
          break label186;
      ...
      for (;;)
      {
        ...
        ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.1(str, paramAbsListView, paramInt, localRecentBaseData.mUnreadNum, paramQQAppInterface, (String)localObject));
        break;
        paramInt = j;
        if (j != 2) {
          paramInt = 1;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.6(paramQQAppInterface, paramString, paramInt1, paramInt2));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.7(paramQQAppInterface, paramString, paramInt1, paramInt2, paramLong));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.8(paramQQAppInterface, paramString1, paramInt1, paramInt2, paramLong, paramString2));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.3(paramString1, paramString3, paramInt1, paramInt2, paramQQAppInterface, paramString2));
      return;
      if (paramInt1 != 2) {
        paramInt1 = 1;
      }
  ...
  public static void a(String paramString)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.9(paramString));
  }
  
  private static void a(String paramString, long paramLong)
  {
    ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.10(paramString, paramLong));
  }
  ...
  private static void b(String paramString1, int paramInt, String paramString2, boolean paramBoolean)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new PublicAccountEventReport.2(paramString2, paramString1, paramInt, paramBoolean));
  }
}
