  ...
  implements Handler.Callback
{
  ...
  aprx jdField_a_of_type_Aprx;
  apsf jdField_a_of_type_Apsf = new ahez(this);
  bhhw jdField_a_of_type_Bhhw;
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bjmp(ThreadManager.getSubThreadLooper(), this);
  private View jdField_b_of_type_AndroidViewView;
  private String jdField_b_of_type_JavaLangString;
  protected boolean b;
  
  public ahey(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_a_of_type_Amwl = new ahfd(this);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (localConfessConvInfo != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844882);
    }
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(String.format(amtj.a(2131701544), new Object[] { Integer.valueOf(localConfessConvInfo.holmesTolCount), Integer.valueOf(localConfessConvInfo.holmesCurCount) }));
  ...
  private void b()
  {
    ...
    {
      this.jdField_a_of_type_Aprx.a(this.app.getLongAccountUin(), l1, this.sessionInfo.topicId, this.sessionInfo.curType, true);
      return;
    }
    this.jdField_a_of_type_Aprx.a(l1, this.app.getLongAccountUin(), this.sessionInfo.topicId, this.sessionInfo.curType, false);
  }
  ...
  private void c()
  {
    ...
    {
      String str = apse.a(this.sessionInfo.curFriendUin, this.sessionInfo.curType, this.sessionInfo.topicId);
      if (aprw.c(this.app, str)) {
  ...
  private void d()
  {
    if (this.sessionInfo.curType == 1033)
    {
      this.mCustomTitleView.setBackgroundResource(2130843669);
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.input != null)
        {
          AIOUtils.setViewDrawalbe(this.input, 2130843688);
          this.input.setTextColor(-16777216);
        }
        this.mTitleText.setTextColor(nmy.c);
        ...
        if (this.mTitleBtnLeft.getVisibility() == 0)
        {
          ...
          this.mTitleBtnLeft.setTextColor(nmy.c);
          ...
          this.mSubTilteText.setText(amtj.a(2131701534) + this.jdField_b_of_type_JavaLangString);
          ...
          localObject1 = amtj.a(2131701535);
          if (this.jdField_b_of_type_Boolean) {
            localObject1 = amtj.a(2131701536);
          }
          this.mTitleBtnLeft.setText((CharSequence)localObject1);
          this.mCustomTitleView.findViewById(2131369874).setVisibility(8);
          ...
          if (aprw.a(this.app))
          {
            localObject1 = View.inflate(this.mContext, 2131561007, null);
            this.afRoot.addView((View)localObject1, new ViewGroup.LayoutParams(-1, -1));
            localObject2 = ((View)localObject1).findViewById(2131380988);
            this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject1).findViewById(2131368109));
            this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
            this.jdField_a_of_type_ComTencentMobileqqConfessConfessProgressView = ((ConfessProgressView)((View)localObject1).findViewById(2131364970));
            float f = this.mContext.getResources().getDisplayMetrics().density;
            this.jdField_a_of_type_ComTencentMobileqqConfessConfessProgressView.setSize(24.0F * f, 27.0F * f, -0.15F * f, -0.5F * f);
            this.jdField_a_of_type_AndroidViewView = ((View)localObject1).findViewById(2131368101);
            this.jdField_a_of_type_AndroidViewView.setVisibility(8);
            this.jdField_b_of_type_AndroidViewView = ((View)localObject1).findViewById(2131368099);
            if (this.sessionInfo.curType == 1033)
            {
            ...
            e();
            if (!aprw.b(this.app, "holmes_guide"))
            {
              aprw.a(this.app, "holmes_guide", true);
              if (this.sessionInfo.curType != 1033) {
                break label940;
              }
              localObject1 = View.inflate(this.mContext, 2131561006, null);
              ((View)localObject1).findViewById(2131368104).setOnClickListener(this);
              ((View)localObject1).setOnClickListener(this);
              this.afRoot.getViewTreeObserver().addOnGlobalLayoutListener(new ahfa(this, (View)localObject1, (View)localObject2));
            }
      ...
      catch (Throwable localThrowable)
      {
        ...
        this.mDefautlBtnLeft.setTextColor(nmy.c);
      ...
      this.mTitleBtnRight.setImageResource(2130845480);
      ...
      continue;
      label940:
      View localView = View.inflate(this.mContext, 2131561005, null);
    }
  }
  ...
  private void f()
  {
    ...
    ((bjnw)localObject).a(2131689958, 5);
    ((bjnw)localObject).a(2131690640, 5);
    ((bjnw)localObject).c(2131690620);
    ((bjnw)localObject).a(new ahfe(this, (bjnw)localObject));
  ...
  {
    if (this.jdField_a_of_type_Bhhw == null) {
      this.jdField_a_of_type_Bhhw = new bhhw(this.mActivity);
    }
  ...
  public void clickSendTextButton()
  {
    ...
    acvv.a(this.app, this.mContext, this.sessionInfo, str, null, localacwc);
  ...
  public boolean doOnCreate(boolean paramBoolean)
  {
    ...
    d();
    this.app.addObserver(this.jdField_a_of_type_Apsf);
    this.jdField_a_of_type_Aprx = ((aprx)this.app.getBusinessHandler(125));
    b();
    return paramBoolean;
  }
  ...
  {
    super.doOnDestroy();
    this.app.removeObserver(this.jdField_a_of_type_Apsf);
  ...
  public void onClick(View paramView)
  {
    ...
    if ((i == 2131369082) && (this.sessionInfo != null) && (this.sessionInfo.curType == 1034)) {
      f();
    }
    for (;;)
    {
      ...
      else if (i != 2131368106)
      {
        if (i == 2131368109)
        {
          ...
          if (this.jdField_a_of_type_AndroidViewView != null)
          {
            ...
            {
              this.jdField_a_of_type_AndroidViewView.setVisibility(8);
              str1 = apse.a(this.sessionInfo.curFriendUin, this.sessionInfo.curType, this.sessionInfo.topicId);
              aprw.b(this.app, str1, false);
              i = 1;
            }
          }
          String str2;
          ...
          for (;;)
          {
            aprw.a(localQQAppInterface, localContext, str1, str2, j, bool);
            bcef.b(this.app, "dc00898", "", "", "0X8009573", "0X8009573", i, 0, this.sessionInfo.topicId + "", "", str1 + "", str2 + "");
            break;
  ...
  {
    int i = agkm.a(this.app, "Normal_MaxPtt") * 1000 - 200;
  ...
  {
    apse.a(this.app, this.sessionInfo.curFriendUin, this.sessionInfo.curType, this.sessionInfo.topicId, true, true);
  }
  ...
  public void updateSession(Intent paramIntent)
  {
    ...
    paramIntent = (apsa)this.app.getManager(269);
    ...
    if (!this.isJubaoMode)
    {
      ...
      if (this.sessionInfo.curType == 1033)
      {
        ...
        label209:
        this.jdField_a_of_type_ComTencentMobileqqConfessConfessInfo = localaprv.a(str3, j, k, paramIntent, str1, i, str2, l);
      }
    }
    for (;;)
    {
      ...
      this.refreshMessageContext.msgRefresher = new abwo(this.app.getMessageFacade().getC2CMessageManager());
      return;
    ...
    do
    {
      ...
      if (this.sessionInfo.curType != 1033)
      {
        ...
        if (localObject != null)
        {
          localObject = (ChatFragment)localObject;
          if (((ChatFragment)localObject).a != null) {
            ((ChatFragment)localObject).a.setStatusBarDrawable(getActivity().getResources().getDrawable(2130846068));
          }
        }
        ...
        this.mTitleBtnLeft.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130850030));
        this.mAIORootView.findViewById(2131369874).setVisibility(8);
        this.mCustomTitleView.setIsDefaultTheme(false);
        this.mCustomTitleView.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130850016));
        this.afRoot.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849953));
        AIOUtils.setViewDrawable(this.mInputBar, SkinEngine.getInstances().getDefaultThemeDrawable(2130849759));
        AIOUtils.setViewDrawable(this.input, SkinEngine.getInstances().getDefaultThemeDrawable(2130849760));
        if (this.input != null) {
          this.input.setTextColor(-16777216);
        }
        localObject = SkinEngine.getInstances().getDefaultThemeDrawable(2130849908);
        Drawable localDrawable1 = SkinEngine.getInstances().getDefaultThemeDrawable(2130849905);
        Drawable localDrawable2 = SkinEngine.getInstances().getDefaultThemeDrawable(2130849909);
        ...
        this.panelicons.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849809));
        return;
      }
      AIOUtils.setViewDrawalbe(this.input, 2130843688);
