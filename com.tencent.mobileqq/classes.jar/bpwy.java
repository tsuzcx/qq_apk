  ...
  implements View.OnClickListener
{
  ...
  public bpwy(@NonNull bpxa parambpxa)
  {
    super(parambpxa);
  ...
  private boolean a(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_Bpxa.jdField_d_of_type_Int = paramString.jdField_a_of_type_Int;
      this.jdField_a_of_type_Bpxa.jdField_e_of_type_Int = paramString.b;
      this.jdField_a_of_type_Bpxa.jdField_d_of_type_JavaLangString = paramString.jdField_a_of_type_JavaLangString;
      int i = this.jdField_a_of_type_Bpxa.jdField_d_of_type_Int;
      if (i > 0) {
        return true;
      }
    }
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText.setTextEffect(this.jdField_a_of_type_Bpxa.jdField_e_of_type_JavaLangString);
    String str = blxw.a(this.jdField_a_of_type_Bpxa.jdField_d_of_type_Int, null, null, null);
    if (TextUtils.isEmpty(str)) {
      this.jdField_a_of_type_Bpxa.jdField_d_of_type_Int = -1;
    }
    for (;;)
    {
  ...
  public void a()
  {
    ...
    if (!this.jdField_a_of_type_Bpxa.j) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    if ((this.jdField_a_of_type_Bpxa.g) || (this.jdField_a_of_type_Bpxa.i))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new bpwz(this));
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      if ((paramIntent != null) && (paramIntent.getExtras() != null))
      {
        ...
        if (paramIntent.containsKey("permission_code")) {
          this.jdField_a_of_type_Bpxa.jdField_c_of_type_Int = paramIntent.getInt("permission_code");
        }
        if (paramIntent.containsKey("uin_list"))
        {
          if (this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList == null) {
            this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          }
          this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList.clear();
          localObject = paramIntent.getStringArrayList("uin_list");
          if (localObject != null) {
            this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList.addAll((Collection)localObject);
          }
        }
        if (a(this.jdField_a_of_type_Bpxa.jdField_c_of_type_Int))
        {
          this.jdField_a_of_type_Bpxa.b = paramIntent.getString("key_setting_raw_json");
          this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaLangString = paramIntent.getString("key_selected_tag");
        }
        d();
      }
    }
    do
    {
      ...
      if (this.jdField_a_of_type_Bpxa.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_Bpxa.jdField_a_of_type_AndroidViewView.setVisibility(8);
      }
    ...
    if (localBundle.containsKey("contentIntentKey"))
    {
      ...
      this.jdField_a_of_type_Bpxa.jdField_c_of_type_JavaLangString = paramIntent;
    }
    ...
    this.jdField_a_of_type_Bpxa.jdField_d_of_type_Int = localBundle.getInt("extra_key_font_id", -1);
    this.jdField_a_of_type_Bpxa.jdField_e_of_type_Int = localBundle.getInt("extra_key_font_format_type");
    this.jdField_a_of_type_Bpxa.jdField_d_of_type_JavaLangString = localBundle.getString("extra_key_font_url");
    this.jdField_a_of_type_Bpxa.jdField_f_of_type_Int = localBundle.getInt("extra_key_super_font_id", -1);
    this.jdField_a_of_type_Bpxa.jdField_e_of_type_JavaLangString = localBundle.getString("extra_key_super_font_info");
    j();
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    case 0: 
      ...
      paramInt = i;
      if (this.jdField_a_of_type_Bpxa.h) {
        paramInt = 0;
      }
  ...
  public void d()
  {
    this.jdField_a_of_type_JavaLangString = bmos.a(this.jdField_a_of_type_Bpxa.jdField_c_of_type_Int);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        ((bpxa)this.jdField_a_of_type_Bpep).c(3004);
        localBundle = new Bundle();
        localBundle.putInt("permission_code", this.jdField_a_of_type_Bpxa.jdField_c_of_type_Int);
        if ((this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          localBundle.putStringArrayList("uin_list", this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList);
          localObject2 = new ArrayList(this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList.size());
          localObject3 = this.jdField_a_of_type_Bpxa.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        if ((a(this.jdField_a_of_type_Bpxa.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bpxa.b))) {
          localBundle.putString("key_setting_raw_json", this.jdField_a_of_type_Bpxa.b);
        }
        blsb.a((BaseActivity)this.jdField_a_of_type_Bpfx, (String)localObject1, 1, localBundle, "");
      }
    } while (i != 2131366784);
    ((bpxa)this.jdField_a_of_type_Bpep).c(3001);
    ...
    if (this.jdField_a_of_type_Bpxa.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Bpxa.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
    Object localObject2 = new Bundle();
    ((Bundle)localObject2).putBoolean("key_at_click_hide_keyboard", true);
    Object localObject3 = (BaseActivity)this.jdField_a_of_type_Bpfx;
    String str = this.jdField_a_of_type_Bpxa.jdField_c_of_type_JavaLangString;
    if (this.jdField_a_of_type_Bpxa.g) {}
    for (int i = 0;; i = 1)
    {
      blsb.a((Activity)localObject3, (blsi)localObject1, 1009, "", str, "", "", 0, i, 1, 0, 0, 0, "", 10000, localBundle, this.jdField_a_of_type_Bpxa.g, this.jdField_a_of_type_Bpxa.jdField_f_of_type_Boolean, this.jdField_a_of_type_Bpxa.jdField_d_of_type_Int, this.jdField_a_of_type_Bpxa.jdField_f_of_type_Int, true, (Bundle)localObject2);
      break;
    }
  }
}
