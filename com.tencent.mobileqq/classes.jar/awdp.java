...
public class awdp
{
  ...
  private void b(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    int i;
    switch (((bmii)localObject).jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      i = ((bmii)localObject).jdField_b_of_type_Int;
      if (i > 99) {
    ...
    case 3: 
      ...
      i = ((bmii)localObject).jdField_c_of_type_Int;
      ...
      return;
    case 2: 
      localObject = ((bmii)localObject).jdField_b_of_type_JavaLangString;
      ...
      return;
    case 4: 
      paramContext = ((bmii)localObject).jdField_b_of_type_JavaLangString;
  ...
  private void b(QQAppInterface paramQQAppInterface, String paramString, BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bdla.b(paramQQAppInterface, "dc00899", "Grp_tribe", "", "dynamic", "exp_tribe", 0, 0, i + "", "", "", "");
      return;
    }
  }
  ...
  protected void a(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    if (paramQQAppInterface != null)
    {
      if (!aquz.a(paramQQAppInterface, "redpoint_leba_show")) {
        break label357;
      }
      ...
      localObject = ((aquz)localObject).a(paramQQAppInterface);
  ...
  public void a(QQAppInterface paramQQAppInterface, aymh paramaymh, RedTouch paramRedTouch)
  {
    int i = 1;
    int j = 1;
    ...
    {
      return;
      this.jdField_a_of_type_Int = paramaymh.d;
      this.jdField_b_of_type_Int = paramaymh.jdField_c_of_type_Int;
      switch (paramaymh.jdField_a_of_type_Int)
      {
      default: 
    ...
    } while ((TextUtils.isEmpty(paramaymh.jdField_b_of_type_JavaLangString)) && (TextUtils.isEmpty(paramaymh.jdField_c_of_type_JavaLangString)));
    BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
    if (!TextUtils.isEmpty(paramaymh.jdField_b_of_type_JavaLangString))
    {
      localRedTypeInfo.red_type.set(11);
      localRedTypeInfo.red_content.set(paramaymh.jdField_b_of_type_JavaLangString);
      ((BusinessInfoCheckUpdate.RedDisplayInfo)localObject).red_type_info.add(localRedTypeInfo);
    }
    for (i = 1;; i = 0)
    {
      if (!TextUtils.isEmpty(paramaymh.jdField_c_of_type_JavaLangString))
      {
        localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
        localRedTypeInfo.red_type.set(-100);
        localRedTypeInfo.red_content.set(paramaymh.jdField_c_of_type_JavaLangString);
        ((BusinessInfoCheckUpdate.RedDisplayInfo)localObject).red_type_info.add(localRedTypeInfo);
      }
      for (;;)
      {
        if ((i == 0) && (j != 0))
        {
          paramaymh = new BusinessInfoCheckUpdate.RedTypeInfo();
          paramaymh.red_type.set(0);
          ((BusinessInfoCheckUpdate.RedDisplayInfo)localObject).red_type_info.add(paramaymh);
        }
        ...
        paramQQAppInterface = (String)paramaymh.jdField_a_of_type_JavaUtilList.get(0);
        paramaymh = new BusinessInfoCheckUpdate.RedTypeInfo();
        paramaymh.red_type.set(3);
        paramaymh.red_content.set(paramQQAppInterface);
        paramaymh.red_desc.set("{'av':1, 'dot':1}");
        paramRedTouch.a(paramaymh);
        return;
        localObject = new BusinessInfoCheckUpdate.RedTypeInfo();
        ((BusinessInfoCheckUpdate.RedTypeInfo)localObject).red_type.set(5);
        paramQQAppInterface = paramaymh.jdField_b_of_type_Int + "";
        if (paramaymh.jdField_b_of_type_Int > 99) {
  ...
  protected void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    paramQQAppInterface = (ntq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH_EX);
    ...
    ykv.a("dynamic", "exp_story", 0, paramQQAppInterface.b(), new String[0]);
    BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
    ...
    case 35: 
      ...
      while (i != -1)
      {
        if (QLog.isColorLevel()) {
          QLog.i("storyRedDotDebug", 2, "更新动态红点:" + ntq.a(localRedDotInfo));
        }
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ykq.d("Q.lebatab.LebaSpecificRedTouch", "tag red dot json parse error , %s", new Object[] { localException.getMessage() });
          }
        }
        ...
        try
        {
          ...
          ykq.e("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: red display=%d", new Object[] { Long.valueOf(l) });
          if (l != 0L) {
            break label445;
          }
          paramRedTouch.d();
        ...
        {
          ykq.c("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: Error parse json: ", paramQQAppInterface);
          i = -1;
        }
      }
      label436:
      ykq.b("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: str_custom_buffer is null");
      label445:
      ...
      for (;;)
      {
        ...
        paramQQAppInterface = "https://p.qlogo.cn/gh/" + localRedDotInfo.uint64_cmd_uin.get() + "/" + localRedDotInfo.uint64_cmd_uin.get() + "/100?t=" + ntq.d;
        localRedTypeInfo.red_content.set(paramQQAppInterface);
  ...
  public void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch, String paramString1, String paramString2, long paramLong)
  {
    ...
    {
      paramString2 = ((bbbq)localObject2).a(paramString1);
      if (paramString2 != null)
      {
        ...
        {
          paramString1 = null;
          localObject2 = ((bbbq)localObject2).a(paramString2);
          if (QLog.isColorLevel()) {
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, RedTouch paramRedTouch, String paramString, Map<Long, awdr> paramMap, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilMap = paramMap;
    boolean bool = false;
    paramMap = String.valueOf(paramLong);
    if ((paramMap != null) && (bmii.jdField_a_of_type_JavaLangString.equals(paramMap)))
    {
    ...
    {
      return bool;
      if (String.valueOf(nyv.jdField_a_of_type_Int).equals(paramMap))
      {
        a(paramQQAppInterface, paramRedTouch);
        a(paramLong, paramRedTouch);
        return true;
      }
      if (bill.jdField_a_of_type_JavaLangString.equals(paramString))
      {
        bill.a(paramQQAppInterface, paramRedTouch);
        a(paramLong, paramRedTouch);
        return true;
      }
      if (7759L == paramLong)
