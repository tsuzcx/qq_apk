  ...
  extends BaseAdapter
{
  ...
  public awdp(QQAppInterface paramQQAppInterface, Context paramContext, Drawable paramDrawable)
  {
  ...
  private View a(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (TextView)paramLayoutInflater.findViewById(2131364771);
  ...
  private awdz a(LayoutInflater paramLayoutInflater, int paramInt, View paramView, ViewGroup paramViewGroup, AutoReplyText paramAutoReplyText)
  {
    if ((paramView == null) || (paramView.getTag() == null) || (paramView.getVisibility() == 8))
    {
      ...
      paramLayoutInflater = paramView.findViewById(2131365350);
      if (ThemeUtil.isDefaultTheme())
      {
        ...
        if ((!ThemeUtil.isDefaultTheme()) && (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))) {
          paramView.findViewById(2131375663).setBackgroundResource(2130839264);
        }
        paramView.findViewById(2131369363).setPadding(0, 0, 0, 0);
        paramView.findViewById(2131375835).setVisibility(8);
        paramViewGroup = (TextView)paramView.findViewById(2131369384);
        paramViewGroup.setEditableFactory(new awdr(this, paramViewGroup));
        paramLayoutInflater = new awdz(null);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375812));
        paramLayoutInflater.b = paramView.findViewById(2131365486);
        paramLayoutInflater.c = paramView.findViewById(2131365487);
        paramLayoutInflater.d = paramView.findViewById(2131377636);
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.setTag(paramLayoutInflater);
        label200:
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new awds(this, paramAutoReplyText));
        paramLayoutInflater.b.setOnClickListener(new awdt(this, paramAutoReplyText));
        ...
        paramView = banh.a(paramView, paramLayoutInflater.jdField_a_of_type_AndroidWidgetTextView.getPaint(), 3, i, azkz.a - azkz.a(67.0F), true);
        if (QLog.isColorLevel()) {
          QLog.d("AutoReplyAdapter", 2, "Truncate subText: " + paramView);
        }
        paramViewGroup = new bamp(paramView, 3, i);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(new bamp(alud.a(2131701241) + paramView, 3, i));
        paramLayoutInflater.c.setOnClickListener(new awdu(this, paramAutoReplyText, bool));
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.findViewById(2131375663).setOnClickListener(new awdv(this, paramAutoReplyText));
    ...
    label562:
    label567:
    for (paramInt = 0;; paramInt = azkz.a(200.0F))
    {
      ...
      paramInt = 8;
      break;
      paramLayoutInflater = (awdz)paramView.getTag();
      paramLayoutInflater.jdField_a_of_type_AndroidViewView = paramView;
      break label200;
      paramInt = 0;
      break label259;
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    awdw localawdw = new awdw(this, paramView, paramView.getMeasuredHeight());
    localawdw.setAnimationListener(new awdx(this, paramInt));
    localawdw.setDuration(150L);
    paramView.startAnimation(localawdw);
  }
  ...
  private View b(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    paramLayoutInflater.setOnClickListener(new awdq(this));
    return paramLayoutInflater;
  }
    ...
    if (((Iterator)localObject).hasNext())
    {
      ...
      if (localAutoReplyText.getTextId() == paramInt)
      {
        ...
        if (this.jdField_a_of_type_Awdy != null)
        {
          ...
          {
            bool = true;
            localawdy.a(localAutoReplyText, bool);
          }
        }
        else
        {
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.b = bool;
      if (this.jdField_a_of_type_Awdy != null) {
        this.jdField_a_of_type_Awdy.a(localObject2, localObject1);
      }
      notifyDataSetChanged();
      return;
    }
  ...
  public void a(@Nullable awdy paramawdy)
  {
  ...
  public void a(@Nullable AutoReplyText paramAutoReplyText)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Awdy != null) {
        this.jdField_a_of_type_Awdy.a(paramAutoReplyText);
      }
      a();
      this.b = true;
      notifyDataSetChanged();
