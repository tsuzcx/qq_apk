...
public class aksu
  extends AlbumListLogicBase<AlbumListFragment, aktm>
  implements AlbumListLogic.IalbumListAdapterCallBack
{
  protected akst a;
  
  public aksu(AlbumListFragment paramAlbumListFragment)
  {
    super(paramAlbumListFragment);
    this.mAlbumListAdapterCallBack = this;
    this.mAlbumListData = new akst();
    this.a = ((akst)this.mAlbumListData);
  }
  
  protected aksx a()
  {
    return (aksx)super.getAlbumListAdapter();
  }
  
  protected aktm a()
  {
    return new aksv(this);
  }
  ...
  {
    return new aksx((AlbumListFragment)this.mFragment);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject2 = ((aksx)localObject1).getItem(paramInt);
    paramViewGroup = (TextView)paramView;
    if (((QQAlbumInfo)localObject2)._id.equals("qzone_album"))
    {
      localObject2 = ((aksx)localObject1).mResources.getDrawable(2130847668);
      ((Drawable)localObject2).setBounds(0, 0, ((aksx)localObject1).mCoverWidth, ((aksx)localObject1).mCoverHeight);
      localObject1 = this.a.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState.newDrawable(((aksx)localObject1).mResources);
  ...
  public void initData(Intent paramIntent)
  {
    ...
    a().a(((aktm)this.mOtherCommonData).jdField_a_of_type_Long);
    ...
    if ((this.mPhotoCommonData.isShowQzoneAlbum) && (!((aktm)this.mOtherCommonData).jdField_a_of_type_Boolean))
    {
      this.a.jdField_a_of_type_Ayxo = new aksw(this);
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(this.a.jdField_a_of_type_Ayxo);
      BaseApplicationImpl.getApplication().getRuntime().startServlet(paramIntent);
      this.a.jdField_a_of_type_AndroidGraphicsDrawableDrawable$ConstantState = this.mActivity.getResources().getDrawable(2130839281).getConstantState();
    }
  }
  ...
  public boolean onItemClick(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    if (paramQQAlbumInfo._id.equals("qzone_album"))
    {
      ...
      bmtd.a(((AlbumListFragment)this.mFragment).getActivity(), localbmtk, (Bundle)localObject, 100016);
