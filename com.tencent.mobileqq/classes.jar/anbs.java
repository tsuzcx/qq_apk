...
public class anbs
{
  ...
  private void a(ApolloActionData paramApolloActionData)
  {
    ...
    ((anch)this.a.a().getManager(QQManagerFactory.SPRITE_SCRIPT_MANAGER)).a().a(localSpriteTaskParam);
  }
  ...
  public void a(int paramInt)
  {
    ...
    ApolloActionData localApolloActionData = ((ankc)localQQAppInterface.getManager(QQManagerFactory.APOOLO_DAO_MANAGER)).a(paramInt);
    String str = anvx.a(2131713701);
    ...
    {
      ((amme)localQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).a(localApolloActionData, 4);
      a(str);
      return;
    }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (localJSONArray.length() > 0)
          {
            ...
            {
              paramMessageForApollo = (ApolloSlaveInfo)bgzr.a(localJSONArray.getJSONObject(i), ApolloSlaveInfo.class);
