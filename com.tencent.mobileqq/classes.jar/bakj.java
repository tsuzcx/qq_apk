...
public class bakj
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong)
  {
    ...
    if (i == 0) {
      bajf.a(paramQQAppInterface, paramLong, 106);
    }
    return i;
  }
  ...
  {
    MessageRecord localMessageRecord = axaq.a(-2017);
    adgf.a().a(localMessageRecord.uniseq, paramLong3, paramInt5);
    ...
    localMessageRecord.msgUid = axas.a(paramInt1);
    localMessageRecord.msg = bbet.a(null);
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      Object localObject = bbdr.a(paramString, i);
      try
      {
        paramString = bbdr.a(paramString, (BitmapFactory.Options)localObject);
        if (paramString == null)
        {
          localObject = null;
          return localObject;
  ...
  public static azqt a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    paramQQAppInterface = new azqt(paramString1);
  ...
  public static azqt a(QQAppInterface paramQQAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    Object localObject = null;
    ...
    paramQQAppInterface = new azqt((azqt)localObject);
    if (TextUtils.isEmpty(paramQQAppInterface.g)) {
  ...
  public static azqt a(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  public static TroopFileData a(obj_msg.ObjMsg paramObjMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localTroopFileData.dspFileName = apue.a(localTroopFileData.dspFileName);
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    aptv.d(paramActivity.getString(2131692829));
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    apvk.a(paramQQAppInterface, paramContext, Long.parseLong(paramChatMessage.frienduin), paramChatMessage.uuid, paramChatMessage.url, paramChatMessage.fileName, paramChatMessage.fileSize, paramChatMessage.bisID);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, List<azpg> paramList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        azpg localazpg = (azpg)localIterator.next();
        localObject1 = (List)((Map)localObject2).get(Long.valueOf(paramLong));
        paramList = (List<azpg>)localObject1;
        if (localObject1 == null)
        {
          paramList = new ArrayList();
          ((Map)localObject2).put(Long.valueOf(paramLong), paramList);
        }
        localObject1 = apvk.a(paramQQAppInterface, paramLong, localazpg);
        if ((localObject1 == null) || (((azqt)localObject1).e == null)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, boolean paramBoolean, long paramLong1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, long paramLong2, long paramLong3, String paramString6, String paramString7, int paramInt2)
  {
    ...
    if (l1 < 1L)
    {
      ...
      l2 = 0L;
      i = nam.a();
      if ((i >= ajsf.c.length) || (i < 0)) {
        break label503;
      }
    }
    label482:
    label503:
    for (String str = ajsf.c[i];; str = "NONE")
    {
      ...
      for (i = 0;; i = 1)
      {
        axqw.b(paramQQAppInterface, "P_CliOper", "BizTechReport", "", "troop_troopfile", paramString1, 0, i, paramString3, paramString4, paramLong1 + "KB/s", localHashMap.toString());
        if (QLog.isColorLevel()) {
  ...
  {
    return paramQQAppInterface.getApp().getSharedPreferences("file_config_" + paramQQAppInterface.c(), 0).getBoolean("https_troop_up", false);
  }
  ...
  public static boolean a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    //   4: iload_2
    //   5: iload_3
    //   6: invokestatic 933	bakj:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnonnull +10 -> 23
    //   16: iload 5
    ...
    //   20: iload 4
    //   22: ireturn
    //   23: new 935	java/io/File
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 936	java/io/File:<init>	(Ljava/lang/String;)V
    //   31: astore_0
    //   32: aload_0
    //   33: invokevirtual 939	java/io/File:exists	()Z
    //   36: ifeq +8 -> 44
    //   39: aload_0
    //   40: invokevirtual 942	java/io/File:delete	()Z
    //   43: pop
    //   44: aload_0
    //   45: invokevirtual 945	java/io/File:createNewFile	()Z
    //   48: pop
    //   49: new 947	java/io/BufferedOutputStream
    //   52: dup
    //   53: new 949	java/io/FileOutputStream
    //   56: dup
    //   57: aload_0
    //   58: invokespecial 952	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   61: invokespecial 955	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   64: astore_1
    //   65: aload_1
    //   66: astore_0
    //   67: aload 6
    //   69: getstatic 961	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   72: bipush 100
    //   74: aload_1
    //   75: invokevirtual 965	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   78: pop
    //   79: aload_1
    //   80: astore_0
    //   81: aload 6
    //   83: invokevirtual 354	android/graphics/Bitmap:recycle	()V
    //   86: iconst_1
    //   87: istore 5
    //   89: iload 5
    //   91: istore 4
    ...
    //   94: ifnull -74 -> 20
    //   97: aload_1
    //   98: invokevirtual 968	java/io/BufferedOutputStream:flush	()V
    //   101: aload_1
    //   102: invokevirtual 971	java/io/BufferedOutputStream:close	()V
    //   105: iconst_1
    //   106: ireturn
    //   107: astore_0
    //   108: iload 5
    //   110: istore 4
    //   112: invokestatic 298	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   115: ifeq -95 -> 20
    //   118: ldc_w 973
    //   121: iconst_2
    //   122: new 217	java/lang/StringBuilder
    //   125: dup
    //   126: invokespecial 219	java/lang/StringBuilder:<init>	()V
    //   129: ldc_w 975
    //   132: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   135: aload_0
    //   136: invokevirtual 976	java/io/IOException:toString	()Ljava/lang/String;
    //   139: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   142: invokevirtual 260	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   145: invokestatic 978	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   148: iconst_1
    //   149: ireturn
    //   150: astore_1
    //   151: aload_1
    //   152: invokevirtual 979	java/io/IOException:printStackTrace	()V
    //   155: goto -106 -> 49
    //   158: astore_0
    //   159: invokestatic 298	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   162: ifeq -61 -> 101
    //   165: ldc_w 973
    //   168: iconst_2
    //   169: new 217	java/lang/StringBuilder
    //   172: dup
    //   173: invokespecial 219	java/lang/StringBuilder:<init>	()V
    //   176: ldc_w 975
    //   179: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   182: aload_0
    //   183: invokevirtual 976	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   192: invokestatic 978	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   195: goto -94 -> 101
    //   198: astore 6
    //   200: aconst_null
    //   201: astore_1
    //   202: aload_1
    //   203: astore_0
    //   204: invokestatic 298	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   207: ifeq +36 -> 243
    //   210: aload_1
    //   211: astore_0
    //   212: ldc_w 973
    ...
    //   219: dup
    //   220: invokespecial 219	java/lang/StringBuilder:<init>	()V
    //   223: ldc_w 975
    //   226: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   229: aload 6
    //   231: invokevirtual 980	java/io/FileNotFoundException:toString	()Ljava/lang/String;
    //   234: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   237: invokevirtual 260	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   240: invokestatic 978	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   243: iload 5
    //   245: istore 4
    //   247: aload_1
    //   248: ifnull -228 -> 20
    //   251: aload_1
    //   252: invokevirtual 968	java/io/BufferedOutputStream:flush	()V
    //   255: aload_1
    //   256: invokevirtual 971	java/io/BufferedOutputStream:close	()V
    //   259: iconst_0
    //   260: ireturn
    //   261: astore_0
    //   262: iload 5
    //   264: istore 4
    //   266: invokestatic 298	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   269: ifeq -249 -> 20
    //   272: ldc_w 973
    //   275: iconst_2
    //   276: new 217	java/lang/StringBuilder
    //   279: dup
    //   280: invokespecial 219	java/lang/StringBuilder:<init>	()V
    //   283: ldc_w 975
    //   286: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   289: aload_0
    //   290: invokevirtual 976	java/io/IOException:toString	()Ljava/lang/String;
    //   293: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   296: invokevirtual 260	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   299: invokestatic 978	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   302: iconst_0
    //   303: ireturn
    //   304: astore_0
    ...
    //   311: ldc_w 973
    //   314: iconst_2
    //   315: new 217	java/lang/StringBuilder
    //   318: dup
    //   319: invokespecial 219	java/lang/StringBuilder:<init>	()V
    //   322: ldc_w 975
    //   325: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   328: aload_0
    //   329: invokevirtual 976	java/io/IOException:toString	()Ljava/lang/String;
    //   332: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   335: invokevirtual 260	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   338: invokestatic 978	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   341: goto -86 -> 255
    //   344: astore_1
    //   345: aconst_null
    //   346: astore_0
    ...
    //   348: ifnull +11 -> 359
    //   351: aload_0
    //   352: invokevirtual 968	java/io/BufferedOutputStream:flush	()V
    //   355: aload_0
    //   356: invokevirtual 971	java/io/BufferedOutputStream:close	()V
    //   359: aload_1
    //   360: athrow
    //   361: astore 6
    //   363: invokestatic 298	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   366: ifeq -11 -> 355
    //   369: ldc_w 973
    //   372: iconst_2
    //   373: new 217	java/lang/StringBuilder
    //   376: dup
    //   377: invokespecial 219	java/lang/StringBuilder:<init>	()V
    //   380: ldc_w 975
    //   383: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   386: aload 6
    //   388: invokevirtual 976	java/io/IOException:toString	()Ljava/lang/String;
    //   391: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   394: invokevirtual 260	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   397: invokestatic 978	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   400: goto -45 -> 355
    //   403: astore_0
    //   404: invokestatic 298	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   407: ifeq -48 -> 359
    //   410: ldc_w 973
    //   413: iconst_2
    //   414: new 217	java/lang/StringBuilder
    //   417: dup
    //   418: invokespecial 219	java/lang/StringBuilder:<init>	()V
    //   421: ldc_w 975
    //   424: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   427: aload_0
    //   428: invokevirtual 976	java/io/IOException:toString	()Ljava/lang/String;
    //   431: invokevirtual 225	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   434: invokevirtual 260	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   437: invokestatic 978	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   440: goto -81 -> 359
    //   443: astore_1
    //   444: goto -97 -> 347
    //   447: astore 6
  ...
  {
    return paramQQAppInterface.getApp().getSharedPreferences("file_config_" + paramQQAppInterface.c(), 0).getBoolean("https_troop_down", false);
  }
  ...
  {
    return paramQQAppInterface.getApp().getSharedPreferences("file_config_" + paramQQAppInterface.c(), 0).getBoolean("https_troopzip_down", false);
  }
  
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    return paramQQAppInterface.getApp().getSharedPreferences("file_config_" + paramQQAppInterface.c(), 0).getBoolean("https_troop_thumb", false);
  }
}
