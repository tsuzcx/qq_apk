...
public class aexk
{
  private static aexk jdField_a_of_type_Aexk;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = ajsf.cR + "icons/";
  private static final String jdField_c_of_type_JavaLangString = ajsf.cR + "zip/";
  private static final String jdField_d_of_type_JavaLangString = ajyc.a(2131714985);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bbwg(paramString1, new File(jdField_c_of_type_JavaLangString + "android_tim_theme_icons.zip"));
        paramString1.f = "profileCardDownload";
        paramString1.e = "VIP_profilecard";
        return bbwi.a(paramString1, null);
      }
      ...
      bbdj.b(jdField_b_of_type_JavaLangString);
      continue;
      label183:
      bbdj.b(jdField_c_of_type_JavaLangString);
    }
  }
  
  public static aexk a()
  {
    if (jdField_a_of_type_Aexk == null) {
      jdField_a_of_type_Aexk = new aexk();
    }
    return jdField_a_of_type_Aexk;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	aexk:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   42: invokestatic 316	bbdj:c	(Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_3
    //   46: aload_3
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	aexk:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 143	bbdj:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	aexk:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   71: invokestatic 324	nay:a	(Ljava/io/File;Ljava/lang/String;)V
    //   74: iconst_1
    //   75: ireturn
    //   76: astore_1
  ...
  public Drawable a(int paramInt)
  {
    ...
    localObject = bbdr.a(jdField_b_of_type_JavaLangString + "skin_header_bar.png", localOptions);
    if (localObject != null)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localObject != null)
    {
      localObject = ((ajxn)localObject).e(paramSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public Drawable b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        localBitmap = bbdr.a(jdField_b_of_type_JavaLangString + "skin_aio_qim_header_flag.png", (BitmapFactory.Options)localObject3);
        localObject1 = localObject2;
        if (localBitmap != null)
        {
          ...
          if (localBitmap == null)
          {
            localObject1 = bbdr.a(jdField_b_of_type_JavaLangString + "title_bg_round.9.png", (BitmapFactory.Options)localObject3);
          ...
          if (localObject2 == null)
          {
            localBitmap = bbdr.a(jdField_b_of_type_JavaLangString + "aio_qim_online_icon.png", (BitmapFactory.Options)localObject3);
            localObject1 = localObject2;
            if (localBitmap != null)
            {
              localObject1 = new BitmapDrawable(localBitmap);
              ...
              {
                localObject2 = bbdr.a(jdField_b_of_type_JavaLangString + "tim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bbdr.a(jdField_b_of_type_JavaLangString + "aio_tim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
                    localObject1 = new BitmapDrawable(BaseApplicationImpl.getContext().getResources(), (Bitmap)localObject1);
                    ((Drawable)localObject1).setBounds(0, 0, axli.a(13.0F), axli.a(13.0F));
                    continue;
                    label501:
                    localObject1 = null;
                  }
