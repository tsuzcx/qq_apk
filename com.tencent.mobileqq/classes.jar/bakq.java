...
public class bakq
{
  ...
  public static Pair<CharSequence, CharSequence> a(avoj paramavoj)
  {
    if ((paramavoj instanceof avmy)) {
      return ((avmy)paramavoj).a();
    }
    if ((paramavoj instanceof avmx)) {
      return ((avmx)paramavoj).a();
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      {
      default: 
        return babh.a(paramQQAppInterface, paramString1, paramInt);
      }
      if (ajed.G.equals(paramString1)) {
        return paramContext.getString(2131654085);
      }
      if (ajed.J.equals(paramString1)) {
        return paramContext.getString(2131654084);
      }
      if (ajed.E.equals(paramString1)) {
        return paramContext.getString(2131654150);
      }
      if (paramInt != 1000) {
        break;
      }
    ...
    return babh.a(paramQQAppInterface, paramString1, paramContext.b(paramString2), paramString2, true, null);
    if (paramInt == 1004)
    {
      paramContext = babh.c(paramQQAppInterface, paramString2, paramString1);
      if ((paramContext != null) && (paramContext.equals(paramString1))) {
        return babh.b(paramQQAppInterface, paramString1, true);
      }
    }
    else
    {
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localaprs = new aprs(new StringReader(paramString), paramString.length());
        paramString = null;
      }
      ...
      return paramString;
      if ((paramString != null) && (TextUtils.equals(paramString.b(), "double")) && ((!TextUtils.equals(localaprp.b(), "double")) || (paramString.b() < localaprp.a())) && (!TextUtils.isEmpty(paramString.a())))
      {
        localStringBuilder.append(paramString.a().charAt(paramString.a().length() - 1));
        localStringBuilder.append("*");
        localStringBuilder.append(' ');
      }
      if ((!TextUtils.isEmpty(localaprp.a())) && ((!TextUtils.equals(localaprp.b(), "double")) || (localaprp.a().length() != 1)))
      {
        localStringBuilder.append(localaprp.a());
        localStringBuilder.append(' ');
      }
      paramString = localaprp;
    }
    return null;
  }
  
  public static ArrayList<baks> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (j >= 3)
    {
      ...
      if (j >= 3)
      {
        ...
        localObject2 = babh.b(paramQQAppInterface, (String)localObject1, true);
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131101392)), 0, paramString.length(), 17);
        localArrayList.add(new baks((String)localObject1, 0, new Pair(localObject2, null)));
        i = m + 1;
      }
      label193:
      paramQQAppInterface = new avtz(paramQQAppInterface, 10001, 29, null);
      paramQQAppInterface.a();
      paramQQAppInterface = paramQQAppInterface.a(new avvn(paramString));
    ...
    for (;;)
    {
      ...
      {
        paramString = (avoj)((Iterator)localObject1).next();
        if ((paramString.b() & 0xFFFFFFFF & 0xFF000000) >> 24 != 2L) {
          if (localArrayList.size() < i)
          {
            if ((paramString.d() == 0) || (paramString.d() == 1004))
            {
              ...
              localArrayList.add(new baks(paramString.b(), paramString.d(), paramQQAppInterface));
              j = m;
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            for (paramString = "null";; paramString = paramString.a())
            {
              ...
              if (((String)localObject1).toLowerCase().startsWith(paramString.toLowerCase()))
              {
                ...
                ((SpannableStringBuilder)localObject3).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131101392)), 1, paramString.length() + 1, 17);
                localArrayList.add(new baks((String)localObject1, 0, new Pair(localObject2, localObject3)));
                i = m + 1;
                break label193;
              }
              Object localObject3 = avwf.a((String)localObject2, paramString, 1);
              if (localObject3[0] == 0)
              {
                i = localObject3[1];
                localObject2 = new SpannableStringBuilder((CharSequence)localObject2);
                ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131101392)), 0, i, 17);
                localArrayList.add(new baks((String)localObject1, 0, new Pair(localObject2, null)));
                i = m + 1;
                break label193;
              }
              localObject3 = avwf.a((String)localObject2, paramString, 2);
              i = m;
              if (localObject3[0] != 0) {
                break label193;
              }
              ...
              i = m + 1;
              break label193;
              localArrayList.add(new baks(paramString.b(), paramString.d(), null));
              m = j;
              break label349;
              label767:
  ...
  public static void a(View paramView)
  {
    ...
    bakr.jdField_c_of_type_Int = a(paramView.getContext());
    paramView = (Integer)paramView.getTag(2131313374);
    if (paramView != null) {}
    for (int i = paramView.intValue();; i = -1)
    {
      bakr.jdField_e_of_type_Int = i + 1;
      if (bakr.jdField_f_of_type_Int == 1)
      {
        bakr.jdField_a_of_type_Long = bakr.jdField_d_of_type_Long + (System.nanoTime() - bakr.jdField_c_of_type_Long) / 1000000L;
        bakr.jdField_b_of_type_Long = bakr.jdField_f_of_type_Long + (System.nanoTime() - bakr.jdField_e_of_type_Long) / 1000000L;
      }
      if (bakr.jdField_d_of_type_Int == 1)
      {
        bakr.h = -1;
        bakr.i = -1;
        bakr.j = -1;
      }
      localHashMap.put("keyNum", String.valueOf(bakr.jdField_a_of_type_Int));
      localHashMap.put("firstKeyLen", String.valueOf(bakr.jdField_b_of_type_Int));
      localHashMap.put("itemPage", String.valueOf(bakr.jdField_c_of_type_Int));
      localHashMap.put("itemSearchStrategy", String.valueOf(bakr.jdField_d_of_type_Int));
      localHashMap.put("itemPosition", String.valueOf(bakr.jdField_e_of_type_Int));
      localHashMap.put("itemType", String.valueOf(bakr.jdField_f_of_type_Int));
      localHashMap.put("itemUinType", String.valueOf(bakr.g));
      if (bakr.jdField_f_of_type_Int == 1)
      {
        localHashMap.put("totalCost", String.valueOf(bakr.jdField_a_of_type_Long));
        localHashMap.put("searchCost", String.valueOf(bakr.jdField_b_of_type_Long));
      }
      localHashMap.put("senderNum", String.valueOf(bakr.h));
      localHashMap.put("friendNum", String.valueOf(bakr.i));
      localHashMap.put("friendIndex", String.valueOf(bakr.j));
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "actFtsItemClickEvent", true, bakr.jdField_a_of_type_Long, bakr.jdField_b_of_type_Long, localHashMap, "", false);
      if ((bakr.jdField_f_of_type_Int == 1) && (QLog.isColorLevel())) {
        QLog.d("Q.fts.utils", 2, "actFtsItemClickEvent: totalCost = " + bakr.jdField_a_of_type_Long + ", searchCost = " + bakr.jdField_b_of_type_Long);
      }
      return;
    }
  }
  ...
  public static boolean b()
  {
    ...
    if (a())
    {
      ...
      if (!e((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject1).put("param_ROM", babp.j());
        awrn.a(BaseApplication.getContext()).a(null, "actQQInstallExternal", true, -1L, 0L, (HashMap)localObject1, null, false);
        c((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), true);
      }
    }
    Object localObject1 = babp.a();
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (!f((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject2).put("param_ROM", babp.j());
        ...
        awrn.a(BaseApplication.getContext()).a(null, "actLowRomForFTS", true, -1L, 0L, (HashMap)localObject2, null, false);
  ...
  public static String[] b(String paramString)
  {
    ...
    paramString = new aprt(new StringReader(paramString));
    try
    {
      for (;;)
      {
        aprp localaprp = paramString.a();
        if (localaprp == null) {
          break;
        }
        if (!TextUtils.isEmpty(localaprp.a()))
        {
          ((StringBuilder)localObject).append(localaprp.a());
