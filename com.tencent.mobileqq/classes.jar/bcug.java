  ...
  implements View.OnClickListener
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setOutlineProvider(new bctn(paramInt2));
      ...
      {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.setOutlineProvider(new bctn(paramInt1));
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.setBackgroundColor(paramContext.getResources().getColor(2131167087));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = new FrameLayout(paramContext);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131373165);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundColor(paramContext.getResources().getColor(2131167087));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate(paramContext, 2131561188, null));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373152));
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131704635));
  ...
  {
    this.jdField_a_of_type_Bcue = parambcue;
  }
  ...
  {
    if ((paramInt != 1) || (this.jdField_a_of_type_Bcue == null) || (!this.jdField_a_of_type_Bcue.a()))
    {
  ...
  public void onClick(View paramView)
  {
    ...
    while ((i != 2131373158) || (this.jdField_a_of_type_Bcue == null)) {
      return;
    }
    this.jdField_a_of_type_Bcue.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b());
  }
}
