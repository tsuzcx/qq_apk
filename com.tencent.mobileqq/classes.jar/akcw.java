  ...
  extends ajtd
{
  ...
  private akav jdField_a_of_type_Akav = new akcx(this);
  private akfo jdField_a_of_type_Akfo = new akcy(this);
  private Timer jdField_a_of_type_JavaUtilTimer;
  private boolean jdField_a_of_type_Boolean;
  
  public akcw(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.app.addObserver(this.jdField_a_of_type_Akav);
    this.app.addObserver(this.jdField_a_of_type_Akfo);
    a();
  }
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramString = axao.a(this.app, 13, paramString, localaxav, paramLong2, axas.b(paramLong1));
  ...
  public void a()
  {
    Object localObject1 = (akfm)this.app.a(10);
    if ((((akfm)localObject1).a() != 0) && (((akfm)localObject1).e() == 1))
    {
