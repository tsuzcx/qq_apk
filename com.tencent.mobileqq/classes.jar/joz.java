...
{
  public joz(SmallScreenVideoController paramSmallScreenVideoController) {}
  ...
  public void h()
  {
    ...
    {
      return;
      localView = this.a.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.b.findViewById(2131366258);
      if (localView == null)
      {
      ...
      localView.findViewById(2131366259).startAnimation((Animation)localObject);
      int i;
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().y) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().z))
      {
        ((TextView)localView.findViewById(2131366260)).setText(2131429668);
        i = 1;
      }
      for (;;)
      {
        ...
        ((TextView)localView.findViewById(2131366260)).setTextSize(1, 8.0F);
        return;
        if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().y)
        {
          ((TextView)localView.findViewById(2131366260)).setText(2131429666);
          i = 0;
        }
        else
        {
          ((TextView)localView.findViewById(2131366260)).setText(2131429667);
          i = 1;
        }
      }
    }
