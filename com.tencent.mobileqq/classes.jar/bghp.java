  ...
  implements bgcc
{
  ...
  private void a(WebViewPlugin paramWebViewPlugin, bbac parambbac, String[] paramArrayOfString)
  {
    ...
    do
    {
      for (;;)
      {
        try
        {
          ...
          paramWebViewPlugin = parambbac.getString("giftid");
      ...
      paramWebViewPlugin = new File(bfrb.a(paramWebViewPlugin) + arhc.a());
    ...
    paramWebViewPlugin = "window." + parambbac + "({checkGift:" + i + "})";
  ...
  {
    parambbac.a().getHandler(bgir.class).post(new QZoneGiftFullScreenJsPlugin.1(this, paramArrayOfString));
  }
  ...
  private void c(WebViewPlugin paramWebViewPlugin, bbac parambbac, String[] paramArrayOfString)
  {
    ...
    do
    {
      do
      {
        ...
        paramArrayOfString = bfrb.a(paramWebViewPlugin);
    ...
    this.jdField_a_of_type_Bfre.a(paramWebViewPlugin, paramArrayOfString, new bghq(this, parambbac));
  }
