  ...
  implements AbsListView.OnScrollListener
{
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    j = (int)(j * f1);
    i = (int)(f1 * i);
    return bheg.a(paramBitmap, j, j, i);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          this.jdField_a_of_type_Bghq.sendMessage((Message)localObject);
          if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break;
      label131:
      if ((localObject instanceof swu))
      {
        localObject = (swu)localObject;
        if ((((swu)localObject).a != null) && (((swu)localObject).a.a != null) && ((((swu)localObject).a.a.jdField_a_of_type_Int == 1) || (((swu)localObject).a.a.jdField_a_of_type_Int == 6)) && (!TextUtils.isEmpty(((swu)localObject).a.a.j)) && (((swu)localObject).b != null)) {
          ((swu)localObject).b.setImageBitmap(a(((swu)localObject).a.a.j, paramBoolean));
        }
      }
    }
  }
