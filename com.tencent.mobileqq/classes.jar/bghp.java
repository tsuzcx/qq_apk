...
public class bghp
{
  ...
  public static <T> T b(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(bghs.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label346;
      }
      if (localField.isAnnotationPresent(bghq.class)) {
        paramClass = ((bghq)localField.getAnnotation(bghq.class)).a();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(bghr.class)) {
        return null;
      }
      localClass1 = ((bghr)localField.getAnnotation(bghr.class)).a();
