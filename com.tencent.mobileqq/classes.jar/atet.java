  ...
  implements INetEngine.INetEngineListener
{
  ...
  ateu jdField_a_of_type_Ateu = null;
  atew jdField_a_of_type_Atew = null;
  bjyw jdField_a_of_type_Bjyw = null;
  ...
  public atet(QQAppInterface paramQQAppInterface, ateu paramateu, String paramString1, int paramInt, String paramString2, long paramLong, atew paramatew, boolean paramBoolean, String paramString3, String paramString4)
  {
    this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine = paramQQAppInterface.getNetEngine(0);
    this.jdField_a_of_type_Atew = paramatew;
    ...
    {
      paramatew = paramString1 + ":" + i;
      paramString1 = new ArrayList(1);
      paramString1.add(paramatew);
      if ((!TextUtils.isEmpty(paramString4)) && (asgv.a().a(paramQQAppInterface, 5)))
      {
        QLog.i("FileHttpUploder<FileAssistant>", 1, "[IPv6-File] DiscFile uploader. is config enable IPv6. domain[" + paramString4 + "]");
        paramatew = new asgw(paramString4, i);
        paramatew = asgv.a().a(paramQQAppInterface, paramatew, 5);
        if ((paramatew == null) || (paramatew.a())) {
          break label465;
        }
        if (asgv.a())
        {
        ...
        asgv.a(paramatew.a, paramString1, false, false);
        QLog.i("FileHttpUploder<FileAssistant>", 1, "[IPv6-File] DiscFile uploader. use IPv6. hostlist:" + paramString1.toString());
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Asib = new asib(paramQQAppInterface, paramString1, "/ftn_handler");
      if (this.jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Asib.a(true);
      }
      this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Asib.a();
      this.jdField_c_of_type_JavaLangString = paramString2;
      this.jdField_d_of_type_JavaLangString = String.valueOf(paramLong);
      this.jdField_a_of_type_Ateu = paramateu;
  ...
  public void a(long paramLong)
  {
    ...
    if ((this.jdField_b_of_type_Boolean) && (((String)localObject).startsWith("https")))
    {
      ...
      localHttpNetReq.mIsHostIP = asib.a(this.jdField_b_of_type_JavaLangString);
    ...
    try
    {
      ...
      localObject = this.jdField_a_of_type_Atew.a((byte[])localObject, paramLong, this.jdField_a_of_type_Ateu);
      if (localObject != null)
      {
        localHttpNetReq.mSendData = ((byte[])localObject);
        this.jdField_a_of_type_Ateu.e = System.currentTimeMillis();
        this.jdField_a_of_type_ComTencentMobileqqTransfileHttpNetReq = localHttpNetReq;
        localHttpNetReq.mTimeoutParam = aszt.a();
    ...
    catch (Exception localException)
    {
      ...
      this.jdField_a_of_type_Ateu.jdField_a_of_type_Long = 9360L;
      this.jdField_a_of_type_Ateu.jdField_c_of_type_JavaLangString = aszt.a();
      this.jdField_a_of_type_Atew.a(this.jdField_a_of_type_Ateu);
    }
  }
  ...
  byte[] a(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: lconst_0
    //   8: putfield 51	atet:jdField_b_of_type_Long	J
    //   11: aload_0
    //   12: getfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   15: ifnonnull +23 -> 38
    //   18: aload_0
    //   19: new 326	java/io/FileInputStream
    //   22: dup
    //   23: aload_0
    //   24: getfield 41	atet:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   27: invokespecial 327	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   30: putfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   33: aload_0
    //   34: lconst_0
    //   35: putfield 73	atet:jdField_c_of_type_Long	J
    //   38: lload_1
    //   39: lconst_0
    //   40: lcmp
    //   41: ifne +113 -> 154
    //   44: aload_0
    //   45: getfield 73	atet:jdField_c_of_type_Long	J
    //   48: lconst_0
    //   49: lcmp
    //   50: ifeq +23 -> 73
    //   53: aload_0
    ...
    //   57: dup
    //   58: aload_0
    //   59: getfield 41	atet:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   62: invokespecial 327	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   65: putfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   68: aload_0
    //   69: lconst_0
    //   70: putfield 73	atet:jdField_c_of_type_Long	J
    //   73: aload_0
    //   74: lload_1
    //   75: putfield 73	atet:jdField_c_of_type_Long	J
    //   78: aload_0
    //   79: getfield 43	atet:jdField_a_of_type_Bjyw	Lbjyw;
    //   82: aload_0
    //   83: getfield 47	atet:jdField_a_of_type_Long	J
    //   86: aload_0
    //   87: getfield 51	atet:jdField_b_of_type_Long	J
    //   90: lload_1
    //   91: invokestatic 332	asnl:a	(Lbjyw;JJJ)I
    //   94: istore_3
    //   95: iload_3
    //   96: newarray byte
    //   98: astore 4
    //   100: aload_0
    //   101: getfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   104: aload 4
    //   106: iconst_0
    //   107: iload_3
    ...
    //   112: aload_0
    //   113: aload_0
    //   114: getfield 73	atet:jdField_c_of_type_Long	J
    //   117: iload_3
    //   118: i2l
    //   119: ladd
    //   120: putfield 73	atet:jdField_c_of_type_Long	J
    //   123: aload 4
    //   125: areturn
    //   126: astore 4
    //   128: aload_0
    //   129: aconst_null
    //   130: putfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   133: aload 4
    ...
    //   142: aload_0
    //   143: aconst_null
    //   144: putfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   147: aload 4
    ...
    //   154: lload_1
    //   155: aload_0
    //   156: getfield 73	atet:jdField_c_of_type_Long	J
    //   159: lcmp
    //   160: ifle +29 -> 189
    //   163: aload_0
    //   164: getfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   167: lload_1
    //   168: aload_0
    //   169: getfield 73	atet:jdField_c_of_type_Long	J
    //   172: lsub
    ...
    //   189: lload_1
    //   190: aload_0
    //   191: getfield 73	atet:jdField_c_of_type_Long	J
    //   194: lcmp
    //   195: ifge -122 -> 73
    //   198: aload_0
    ...
    //   202: dup
    //   203: aload_0
    //   204: getfield 41	atet:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   207: invokespecial 327	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   210: putfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   213: aload_0
    //   214: lconst_0
    //   215: putfield 73	atet:jdField_c_of_type_Long	J
    //   218: aload_0
    //   219: getfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   222: lload_1
    ...
    //   232: aload_0
    //   233: aconst_null
    //   234: putfield 49	atet:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   237: aload 4
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Ateu.f = System.currentTimeMillis();
      ...
      if ((paramNetResp.mErrCode == 9364) && (this.jdField_b_of_type_Int < 3))
      {
        ...
        this.jdField_a_of_type_Bjyw.a();
        if (this.jdField_a_of_type_Atew != null)
        {
          this.jdField_a_of_type_Ateu.jdField_a_of_type_Long = 9364L;
          this.jdField_a_of_type_Ateu.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          this.jdField_a_of_type_Ateu.f = System.currentTimeMillis();
          this.jdField_a_of_type_Atew.a(true, this.jdField_a_of_type_Ateu);
        }
      ...
      this.jdField_a_of_type_Ateu.jdField_a_of_type_Long = paramNetResp.mResult;
      this.jdField_a_of_type_Ateu.jdField_c_of_type_JavaLangString = paramNetResp.mErrDesc;
      this.jdField_a_of_type_Ateu.j = ((String)paramNetResp.mRespProperties.get("param_rspHeader"));
      this.jdField_a_of_type_Ateu.g = ((String)paramNetResp.mRespProperties.get("param_url"));
      if ((paramNetResp.mResult == 9056) && (this.f < 5))
      {
        this.jdField_a_of_type_Ateu.a();
        this.f += 1;
        a(this.jdField_b_of_type_Long);
        return;
      }
    ...
    for (long l = Long.parseLong(str);; l = 0L)
    {
      if (l != 0L)
      {
        this.jdField_a_of_type_Ateu.jdField_a_of_type_Long = -9527L;
        this.jdField_a_of_type_Ateu.jdField_c_of_type_JavaLangString = ("ResponCode[206]But UserCode[" + String.valueOf(l) + "]");
        this.jdField_a_of_type_Ateu.j = ((String)paramNetResp.mRespProperties.get("param_rspHeader"));
        this.jdField_a_of_type_Atew.a(this.jdField_a_of_type_Ateu);
        if (!QLog.isColorLevel()) {
          break;
      ...
      l = this.jdField_a_of_type_Atew.a(paramNetResp, this.jdField_a_of_type_Ateu);
      if (l == -1L)
      {
      ...
      {
        this.jdField_a_of_type_Ateu.jdField_a_of_type_Long = 0L;
        this.jdField_a_of_type_Ateu.f = (this.jdField_a_of_type_Ateu.e + 1L);
        this.jdField_a_of_type_Atew.b(this.jdField_a_of_type_Ateu);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (l < this.jdField_b_of_type_Long)
      {
        ...
        this.jdField_a_of_type_Ateu.jdField_a_of_type_Long = 9009L;
        this.jdField_a_of_type_Ateu.jdField_c_of_type_JavaLangString = paramNetResp;
      ...
      this.jdField_a_of_type_Atew.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_Long);
      a(l);
      return;
    }
  }
