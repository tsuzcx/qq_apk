  ...
  implements Handler.Callback
{
  ...
  Map<String, bmdt> jdField_a_of_type_JavaUtilMap;
  Map<String, PluginRecord> b;
  
  bmdr(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    this.b = new HashMap();
    bmds localbmds = new bmds(this);
    bmei.a(paramContext, this.b, localbmds);
  }
  ...
  private boolean a(PluginRecord paramPluginRecord)
  {
    ...
    {
      if (!a(paramPluginRecord, bmei.a(BaseApplicationImpl.getContext(), paramPluginRecord.id), false)) {
        break label69;
      }
  ...
  private void b(bmdt parambmdt)
  {
    Object localObject1 = parambmdt.jdField_a_of_type_Bmdu;
    PluginRecord localPluginRecord = parambmdt.jdField_a_of_type_CooperationQzonePluginPluginRecord;
    if (localObject1 != null) {
      ((bmdu)localObject1).d(parambmdt.jdField_a_of_type_CooperationQzonePluginPluginRecord);
    }
    Object localObject2 = bmei.e(this.jdField_a_of_type_AndroidContentContext, localPluginRecord.id);
    localObject1 = bmei.a(this.jdField_a_of_type_AndroidContentContext, localPluginRecord.id);
    File localFile1 = bmei.b(this.jdField_a_of_type_AndroidContentContext, localPluginRecord.id);
    long l1 = System.currentTimeMillis();
    if (!a(localPluginRecord, (File)localObject2, true))
    {
      QLog.w("QZonePluginManger", 1, "文件校验失败");
      Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 2, parambmdt).sendToTarget();
      return;
    }
    ...
    catch (Exception localException1)
    {
      ...
      Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 3, parambmdt).sendToTarget();
    }
  ...
  public void a(bmdt parambmdt)
  {
    QLog.i("plugin_tag", 1, "unInstallPluginInner : " + parambmdt.jdField_a_of_type_CooperationQzonePluginPluginRecord);
    parambmdt = parambmdt.jdField_a_of_type_CooperationQzonePluginPluginRecord;
    File localFile1 = bmei.a(this.jdField_a_of_type_AndroidContentContext, parambmdt.id);
    File localFile2 = bmei.b(this.jdField_a_of_type_AndroidContentContext, parambmdt.id);
    localFile1.delete();
    localFile2.delete();
    bmei.c(parambmdt);
  }
  
  public void a(PluginRecord paramPluginRecord, bmdu parambmdu)
  {
    QLog.i("plugin_tag", 1, "installPlugin: " + paramPluginRecord);
    bmdt localbmdt = new bmdt(this);
    localbmdt.jdField_a_of_type_CooperationQzonePluginPluginRecord = paramPluginRecord;
    localbmdt.jdField_a_of_type_Bmdu = parambmdu;
    localbmdt.jdField_a_of_type_JavaLangString = paramPluginRecord.id;
    Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 0, localbmdt).sendToTarget();
  }
  
  public void a(PluginRecord paramPluginRecord, bmdv parambmdv)
  {
    QLog.i("plugin_tag", 1, "unInstallPlugin: " + paramPluginRecord);
    bmdt localbmdt = new bmdt(this);
    localbmdt.jdField_a_of_type_CooperationQzonePluginPluginRecord = paramPluginRecord;
    localbmdt.jdField_a_of_type_Bmdv = parambmdv;
    Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 1, localbmdt).sendToTarget();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return false;
              localObject2 = (bmdt)paramMessage.obj;
            } while (this.jdField_a_of_type_JavaUtilMap.containsKey(((bmdt)localObject2).jdField_a_of_type_JavaLangString));
            this.jdField_a_of_type_JavaUtilMap.put(((bmdt)localObject2).jdField_a_of_type_JavaLangString, localObject2);
            localObject1 = ((bmdt)localObject2).jdField_a_of_type_CooperationQzonePluginPluginRecord;
            localObject2 = ((bmdt)localObject2).jdField_a_of_type_Bmdu;
            if (localObject2 != null) {
              ((bmdu)localObject2).d((PluginRecord)localObject1);
            }
            b((bmdt)paramMessage.obj);
            return false;
            paramMessage = (bmdt)paramMessage.obj;
          ...
          localObject2 = paramMessage.jdField_a_of_type_Bmdu;
          if (localObject2 != null) {
            ((bmdu)localObject2).a(false, (PluginRecord)localObject1);
          }
          this.jdField_a_of_type_JavaUtilMap.remove(paramMessage.jdField_a_of_type_JavaLangString);
          return false;
          paramMessage = (bmdt)paramMessage.obj;
          localObject1 = paramMessage.jdField_a_of_type_CooperationQzonePluginPluginRecord;
          localObject2 = paramMessage.jdField_a_of_type_Bmdv;
          if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramMessage.jdField_a_of_type_JavaLangString))
          {
            if (localObject2 != null) {
              ((bmdv)localObject2).e((PluginRecord)localObject1);
            }
            ...
            bmei.c((PluginRecord)localObject1);
            if (localObject2 != null) {
              ((bmdv)localObject2).b(true, (PluginRecord)localObject1);
            }
          }
        } while (localObject2 == null);
        ((bmdv)localObject2).b(false, (PluginRecord)localObject1);
        return false;
        localObject1 = (bmdt)paramMessage.obj;
      } while (!this.jdField_a_of_type_JavaUtilMap.containsKey(((bmdt)localObject1).jdField_a_of_type_JavaLangString));
      paramMessage = ((bmdt)localObject1).jdField_a_of_type_CooperationQzonePluginPluginRecord;
      this.jdField_a_of_type_JavaUtilMap.remove(((bmdt)localObject1).jdField_a_of_type_JavaLangString);
      ...
      bmei.b(paramMessage);
      localObject1 = ((bmdt)localObject1).jdField_a_of_type_Bmdu;
    } while (localObject1 == null);
    ((bmdu)localObject1).a(true, paramMessage);
    return false;
  }
}
