  ...
  extends qwp
{
  ...
  public qwm(float paramFloat)
  {
    this.jdField_a_of_type_Float = paramFloat;
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.b = 500;
    this.jdField_a_of_type_Qwr = new qwr((int)paramFloat);
    a(this.jdField_a_of_type_Qwr);
  }
  
  private void c()
  {
    int i = (int)(Math.sqrt(this.jdField_a_of_type_Qwr.a) * this.jdField_a_of_type_Float);
    if (i > 0) {
      this.b = i;
    }
  }
