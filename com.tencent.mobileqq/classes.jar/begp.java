  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  public int a;
  private bcaf jdField_a_of_type_Bcaf;
  ...
  static
  {
    jdField_c_of_type_JavaLangString = anzj.a(2131710020);
    jdField_b_of_type_ArrayOfJavaLangObject = new Object[0];
    jdField_a_of_type_AndroidTextSpannable$Factory = new begq();
    try
    {
  ...
  public begp(CharSequence paramCharSequence, int paramInt)
  {
    this(paramCharSequence, paramInt, 32);
  }
  
  public begp(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  }
  
  public begp(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3) {}
  
  protected begp(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    for (paramInt4 = 1;; paramInt4 = 0)
    {
      ...
      if (paramInt4 != 0)
      {
        localObject2 = (begw[])getSpans(paramInt1, paramInt2, begw.class);
        if (localObject2 != null)
        {
          ...
          if (paramInt4 < paramInt5)
          {
            ...
            if (((begw)localObject3).jdField_c_of_type_Int == 1) {
              ((begw)localObject3).jdField_a_of_type_Int &= 0x7FFFFFFF;
            }
            for (;;)
            {
              paramInt4 += 1;
              break;
              if (((begw)localObject3).jdField_c_of_type_Int == 2) {
                ((begy)localObject3).jdField_b_of_type_Boolean = false;
              }
            }
          }
        }
      ...
      {
        ((bdmc)localObject3).a(null, "qq_url_length_report", bool, 0L, 0L, (HashMap)localObject2, null);
        if (this.e.length() < 1000) {
          a();
        }
      ...
      bdmc.a(BaseApplication.getContext()).a(null, "qqTextData", false, 0L, 0L, (HashMap)localObject2, null);
      return;
    }
  }
  
  public begp(CharSequence paramCharSequence, int paramInt1, int paramInt2, MessageRecord paramMessageRecord)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  ...
  private int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, StringBuilder paramStringBuilder)
  {
    ...
    if (k < paramInt2)
    {
      ...
      if ((paramInt3 & 0x4) == 4)
      {
        ...
        a(new begw(i, paramInt4, 1), k, k + 2, 33);
        i = k + 1;
        k = j + 1;
        paramInt1 += 1;
        j = i;
    ...
    for (;;)
    {
      ...
      if ((m >= 255) && (k + 4 < i5))
      {
        ...
        {
          bool2 = true;
          a(new begy(arrayOfChar, paramInt4, bool1, bool2), k, k + 5, 33);
          i = 2;
          if (i >= 5) {
            break label504;
          }
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    localblir.a(String.format(paramContext.getString(2131694070), new Object[] { paramString }));
    localblir.a(2131691150, 1);
    localblir.a(2131689612, 1);
    localblir.c(2131690580);
    localblir.a(new begv(blhl.a(new begu(paramContext, paramString, localblir)).a(1000L)));
    localblir.show();
  }
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt == 0)
    {
      localblir.a(String.format(paramContext.getString(2131694069), new Object[] { paramString1 }));
      localblir.a(2131691440, 1);
      localblir.a(2131691140, 1);
      localblir.a(2131689606, 1);
      localblir.a(2131689571, 1);
      localblir.a(2131693167, 1);
    }
    for (;;)
    {
      localblir.c(2131690580);
      localblir.a(new begr(paramInt, paramString1, paramContext, paramString2, localblir));
      localblir.show();
      return;
      if (paramInt == 1)
      {
        localblir.a(String.format(paramContext.getString(2131694070), new Object[] { paramString1 }));
        localblir.a(2131691440, 1);
        localblir.a(2131691140, 1);
        localblir.a(2131689606, 1);
      }
      ...
      {
        localblir.a(String.format(paramContext.getString(2131693467), new Object[] { paramString1 }));
        localblir.a(2131717885, 1);
        localblir.a(2131691140, 1);
      }
      else if (paramInt == 3)
      {
  ...
  private static void c(String paramString1, String paramString2)
  {
    try
    {
      bdll.b((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(jdField_a_of_type_JavaLangString), "dc00898", "", "", paramString1, paramString2, 0, 0, "", "", "", "");
      return;
    }
  ...
  private static void d(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      {
        bdll.b(localQQAppInterface1, "P_CliOper", "Grp_join", "", "send", "Clk_url", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString2, "");
        return;
      }
    }
    catch (ClassCastException localClassCastException)
    {
      ...
      bdll.b(localQQAppInterface2, "P_CliOper", "Grp_join", "", "send", "Clk_item", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString1, "");
      return;
    }
    catch (AccountNotMatchException paramString1) {}
  }
  ...
  public begp a(String paramString, boolean paramBoolean, int... paramVarArgs)
  {
    begp localbegp = new begp("", 0);
    localbegp.jdField_d_of_type_Int = this.jdField_d_of_type_Int;
    localbegp.jdField_c_of_type_Int = this.jdField_c_of_type_Int;
    localbegp.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    localbegp.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
    localbegp.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localbegp.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localbegp.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localbegp.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
    int i = 0;
    int j = 0;
    ...
    if (paramBoolean)
    {
      ...
      int k = 0;
      while (k < localbegp.jdField_a_of_type_ArrayOfJavaLangObject.length)
      {
      ...
      if (i != 0) {
        localbegp.a(0, paramString.length(), i, j, localStringBuilder);
      }
      localbegp.jdField_d_of_type_JavaLangString = (paramString + this.jdField_d_of_type_JavaLangString);
      localbegp.e = localStringBuilder.toString();
    ...
    {
      if (i != 0) {
        localbegp.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
      }
      return localbegp;
      localStringBuilder = new StringBuilder().append(paramString).append(this.e);
      if (i != 0) {
        localbegp.a(this.e.length(), this.e.length() + paramString.length(), i, j, localStringBuilder);
      }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (j < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject instanceof begw))
      {
        ...
        localObject = (begw)localObject;
        switch (((begw)localObject).jdField_c_of_type_Int)
        {
        default: 
          i = k;
        }
      ...
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          continue;
          localObject = asle.a(((begw)localObject).jdField_a_of_type_Int & 0x7FFFFFFF);
          localStringBuffer.replace(n + k, i1 + k, (String)localObject);
          i = k + (((String)localObject).length() - (i1 - n));
        }
      }
  ...
  protected void a()
  {
    Object localObject = behd.a(this.e);
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      localObject = ((List)localObject).iterator();
      while (((Iterator)localObject).hasNext())
      {
        bege localbege = (bege)((Iterator)localObject).next();
        a(new begx(this, localbege.jdField_a_of_type_JavaLangString), localbege.jdField_a_of_type_Int, localbege.jdField_b_of_type_Int, 33);
      }
    }
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (paramInt == 2)
    {
      ...
      localObject3 = (anyw)((QQAppInterface)localObject1).getManager(51);
      if (paramInt != 0) {
        break label402;
      }
      if (bhnv.a()) {
      ...
      localblir.a(String.format(paramContext.getString(2131694070), new Object[] { paramString }));
      localblir.a(2131691140, 1);
      localblir.a(2131691990, 1);
      localblir.a(2131691440, 1);
      localblir.a(2131689606, 1);
      bdll.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", bcaf.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      bdll.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800B0C0", "0X800B0C0", bcaf.a(paramMessageRecord.istroop), 0, "", "", "", "");
    }
    for (;;)
    {
      localblir.c(2131690580);
      localblir.a(new begs(this, paramContext, paramString, (QQAppInterface)localObject1, i, paramMessageRecord, paramInt, localblir));
      localblir.a(new begt(this, (QQAppInterface)localObject1, i));
      localblir.show();
      return;
      i = 4;
      break;
      label363:
      if (this.jdField_a_of_type_Bcaf == null) {
        this.jdField_a_of_type_Bcaf = new bcaf(this.f);
      }
      this.jdField_a_of_type_Bcaf.a((QQAppInterface)localObject1, paramContext, paramString, (ChatMessage)paramMessageRecord);
      return;
      label402:
      if (paramInt == 1)
      {
        if (!bhnv.a())
        {
          ...
          localblir.a(2131691440, 1);
          localblir.a(2131689606, 1);
          if ((!paramMessageRecord.isSend()) && (((anyw)localObject3).b(paramMessageRecord.senderuin)))
          {
            localObject3 = (anum)((QQAppInterface)localObject1).a(2);
            if (localObject3 != null) {
              ((anum)localObject3).a(jdField_a_of_type_JavaLangString, paramMessageRecord.senderuin, 1, 0L, (byte)1, 0L, 0L, null, "", 0L, 10004, null, (byte)0);
            }
            localblir.a(2131689615, 1);
          }
          bdll.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", bcaf.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
          bdll.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800B0C0", "0X800B0C0", bcaf.a(paramMessageRecord.istroop), 0, "", "", "", "");
        }
      ...
      {
        localblir.a(String.format(paramContext.getString(2131693467), new Object[] { paramString }));
        localblir.a(2131691140, 1);
        localblir.a(2131691990, 1);
        localblir.a(2131717885, 1);
        bdll.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A924", "0X800A924", bcaf.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      }
      else if (paramInt == 3)
      {
        localblir.a(String.format(paramContext.getString(2131694070), new Object[] { paramString }));
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    try
    {
      ...
      if ((localObject1 instanceof QQAppInterface)) {
        agsd.a((QQAppInterface)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, 5, paramString);
      }
      localObject2 = null;
      ...
      if (becb.a((String)localObject1))
      {
        ...
        if (bhnv.d(BaseApplication.getContext()))
        {
          ...
          bdll.b(null, "CliOper", "", "", "0X80061B1", "0X80061B1", 0, 0, "", "", "", "");
          return;
        }
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        continue;
        QQToast.a((Context)localObject2, ((Context)localObject2).getResources().getString(2131691989), 0).b(((Context)localObject2).getResources().getDimensionPixelSize(2131299011));
        continue;
        axkb.a(paramView.getContext(), localThrowable, true, true, true, false, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.f);
      }
    }
    for (;;)
    {
      try
      {
        ...
        if (paramView.istroop == 1)
        {
          ...
          bdll.b(null, "CliOper", "", str1, "0X80061B1", "0X80061B1", i, 0, "", "", paramView, paramString);
  ...
  {
    begp localbegp = (begp)super.clone();
    localbegp.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localbegp.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localbegp.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localbegp.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
  ...
  {
    if ((paramObject instanceof begp)) {
      return this.jdField_d_of_type_JavaLangString.equals(((begp)paramObject).jdField_d_of_type_JavaLangString);
    }
    return false;
  }
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    label73:
    return new begp(this.e, paramInt1, paramInt2, this.jdField_a_of_type_Int, this.jdField_d_of_type_Int, this.jdField_c_of_type_Int);
  }
