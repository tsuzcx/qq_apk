  ...
  implements IRequestCallback
{
  ...
  public void onResponse(HwResponse paramHwResponse)
  {
    ...
    {
      if (!this.a.jdField_a_of_type_Zae.b.equals(this.a.jdField_a_of_type_Zag.jdField_a_of_type_JavaLangString)) {
        return;
      }
      this.a.jdField_a_of_type_Zae.jdField_a_of_type_Long = this.a.f;
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (paramHwResponse.retCode == 222)
        {
          if (this.a.jdField_a_of_type_Zae.b.equals(this.a.jdField_a_of_type_Zag.jdField_a_of_type_JavaLangString))
          {
            this.a.jdField_a_of_type_Zae.jdField_a_of_type_Long = 0L;
            this.a.jdField_a_of_type_Zae.jdField_a_of_type_JavaLangString = null;
            l3 = 0L;
            l2 = l1;
            l1 = l3;
          }
