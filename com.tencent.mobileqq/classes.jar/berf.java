...
{
  berf(berd paramberd, Context paramContext, LinearLayoutManager paramLinearLayoutManager)
  {
    super(paramContext);
  }
  ...
  {
    return berd.a(this.jdField_a_of_type_Berd) / paramDisplayMetrics.densityDpi;
  }
  ...
  {
    paramView = berd.a(this.jdField_a_of_type_Berd, this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager, paramView);
    int i = paramView[0];
    int j = paramView[1];
    ...
    berj.a(berd.a(this.jdField_a_of_type_Berd));
  }
}
