...
public final class rlf
{
  ...
  private final void b()
  {
    ...
    rle.b(str);
    rle.a(System.currentTimeMillis());
    rle.b(rle.b() + 1);
    tbz.a(rle.b(), (tjn)new rlh());
  }
  ...
  public final List<String> a(@NotNull JSONObject paramJSONObject, @NotNull String paramString)
  {
    ...
    if (paramJSONObject != null) {
      try
      {
        paramJSONObject = new Gson().fromJson(paramJSONObject.toString(), new rlg().getType());
  ...
  public final void a()
  {
    ...
    {
      ((rlf)this).b(true);
      String str = ((rlf)this).a();
      ((rlf)this).a(((rlf)this).a(str));
    }
    if (((rlf)this).a() == Aladdin.getConfig(309).getIntegerFromString("config_version", -1)) {}
    for (int i = 1; i != 0; i = 0) {
      return;
    }
    rle.b(0);
  ...
  public final void a(@NotNull TPPlayerMsg.TPMediaCodecInfo paramTPMediaCodecInfo, @NotNull qwv paramqwv)
  {
    Intrinsics.checkParameterIsNotNull(paramTPMediaCodecInfo, "mediaCodecInfo");
    Intrinsics.checkParameterIsNotNull(paramqwv, "reportData");
    if (paramTPMediaCodecInfo.mediaType == TPPlayerMsg.TPMediaCodecInfo.TP_DEC_MEDIA_TYPE_VIDEO)
    {
      ...
      paramqwv.n = paramTPMediaCodecInfo;
    }
    label119:
    while (paramTPMediaCodecInfo.infoType != TPPlayerMsg.TPMediaCodecInfo.TP_INFO_MEDIA_CODEC_EXCEPTION) {
      try
      {
        ...
        paramqwv.j = paramTPMediaCodecInfo.optBoolean("reuseEnable");
        paramqwv.k = paramTPMediaCodecInfo.optBoolean("isReuse");
        paramqwv.u = paramTPMediaCodecInfo.optInt("totalCodec");
        return;
      }
    ...
    try
    {
      ...
      paramqwv.o = ((rlf)this).a(paramqwv.o, str, ";");
      paramqwv.p = ((rlf)this).a(paramqwv.p, paramTPMediaCodecInfo.msg, ";");
      return;
    }
    catch (Throwable paramqwv)
    {
      LogUtils.e("CodecReuseHelper", "onCodecReuseInfo error for jsonObject:" + paramTPMediaCodecInfo.msg);
    }
  }
  
  public final void a(@NotNull Object paramObject, @NotNull qwv paramqwv)
  {
    ...
    if ((paramObject instanceof TPPlayerMsg.TPMediaCodecInfo))
    {
      ...
      ((rlf)this).a(paramObject, paramqwv);
    }
  }
  ...
  public final boolean a(@NotNull String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((rlf)this).a(paramString.optInt("version", -1));
        List localList;
        if (i == 0)
        {
          localList = ((rlf)this).a(paramString, "black_brand_list");
          paramString = ((rlf)this).a(paramString, "black_model_list");
        ...
        {
          localList = ((rlf)this).a(paramString, "white_brand_list");
          paramString = ((rlf)this).a(paramString, "white_model_list");
          if (!localList.contains(Build.BRAND))
          {
