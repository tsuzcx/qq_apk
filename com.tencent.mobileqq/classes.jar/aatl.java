...
public class aatl
  implements bfph
{
  public aatl(ChatSettingActivity paramChatSettingActivity, String paramString, bfpc parambfpc) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (bbfj.d(BaseApplication.getContext()))
      {
        ...
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.app, "CliOper", "", "", "AIO", "AIO_delete_frd", 0, 0, "", "", "", "");
        if (bbbr.b(this.jdField_a_of_type_JavaLangString)) {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.app, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
        }
      ...
      else
      {
        ...
        continue;
        if (bbbr.b(this.jdField_a_of_type_JavaLangString)) {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingActivity.app, "dc00898", "", "", "0X8007FE0", "0X8007FE0", 0, 0, "", "", "", "");
        }
      }
    }
  }
