...
public class bghi
{
  static EIPCResultCallback jdField_a_of_type_EipcEIPCResultCallback = new bghj();
  static Vector<bghk> jdField_a_of_type_JavaUtilVector;
  ...
  public static void a(bghk parambghk)
  {
    if (parambghk != null) {
      jdField_a_of_type_JavaUtilVector.add(parambghk);
    }
  }
      ...
      try
      {
        ...
        if ((paramString != null) && (paramString.length() > 0))
        {
          ...
          if (i < paramString.length())
          {
            ...
            if ((localObject == null) || (!bcgq.a((JSONObject)localObject, "VipComicCommonConfig"))) {
              break label118;
            }
            ...
            {
              localObject = (bghk)paramString.next();
              if (localObject == null) {
                continue;
              }
              ((bghk)localObject).a(jdField_a_of_type_OrgJsonJSONObject);
              continue;
            }
          }
        }
