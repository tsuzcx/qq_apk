  ...
  extends anri
{
  ...
  {
    paramQQAppInterface = new anrb(paramQQAppInterface, paramContext);
        ...
        catch (Exception paramanrl)
        {
          for (;;)
          {
            if (QLog.isColorLevel()) {
              QLog.d("HuaYangParser", 2, "failed to decode param value,tmps[1] is:" + paramString[0] + ",tmps[1] is:" + paramString[1], paramanrl);
            }
          }
        }
      }
