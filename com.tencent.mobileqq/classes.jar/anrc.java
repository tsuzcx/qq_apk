  ...
  implements BusinessObserver
{
  ...
  private void j(int paramInt, boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    for (paramInt = ((Integer)paramArrayOfObject[0]).intValue(); (paramBoolean) && (paramArrayOfObject != null) && (paramArrayOfObject.length >= 4); paramInt = 2131695868)
    {
  ...
  private void l(int paramInt, boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    a((bfjs)paramArrayOfObject[0], ((Integer)paramArrayOfObject[1]).intValue(), ((Integer)paramArrayOfObject[2]).intValue(), (String)paramArrayOfObject[3], (String)paramArrayOfObject[4], (Bundle)paramArrayOfObject[5]);
  }
  ...
  private void u(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    a(paramBoolean, (String)paramObject[0], (String)paramObject[1], (Long)paramObject[2]);
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, ArrayList<bghl> paramArrayList, int paramInt4) {}
