  ...
  extends QIPCModule
{
  ...
  public static String a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        JSONObject localJSONObject = ((ywe)((Iterator)localObject2).next()).a();
  ...
  public static ywj a()
  {
    if (jdField_a_of_type_Ywj == null) {}
    try
    {
      if (jdField_a_of_type_Ywj == null) {
        jdField_a_of_type_Ywj = new ywj();
      }
      return jdField_a_of_type_Ywj;
    }
    finally {}
  }
  ...
  public bdsl a()
  {
    ...
    localbdzn.jdField_a_of_type_Int = 0;
    localbdzn.c = "";
    localbdzn.jdField_a_of_type_Boolean = true;
    localbdzn.e = false;
    return new bdsl(((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(), localbdzn, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a()
  {
    ...
    {
      ((bdsl)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i)).a();
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ("action_get_art_filter_path".equals(paramString))
      {
          ...
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            for (bool1 = false;; bool1 = bool2)
            {
              if (this.jdField_a_of_type_Ywl == null) {
                this.jdField_a_of_type_Ywl = ywl.a(str, l1);
              }
              paramBundle = a();
              paramBundle.a("current_TaskCount", String.valueOf(this.jdField_a_of_type_AndroidUtilSparseArray.size()));
              paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Ywl, bool1);
        ...
        else
        {
          ...
          paramBundle = a();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramBundle);
          paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Ywl, true);
        }
      }
      else if ("action_cancel_art_filter_task".equals(paramString))
      {
        ...
        {
          ((bdsl)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt)).a();
