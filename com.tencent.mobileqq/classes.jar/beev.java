...
class beev
  extends nac
{
  beev(beer parambeer, beex parambeex, int paramInt) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfByte == null)
        {
          ...
          if (this.jdField_a_of_type_Beex != null)
          {
            ...
            this.jdField_a_of_type_Beex.a(paramBundle);
          }
          return;
        }
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramBundle = paramArrayOfByte;
          localObject = new beew(null);
          paramBundle = paramArrayOfByte;
          ((beew)localObject).jdField_a_of_type_Long = (l2 * 1000L + l1);
          paramBundle = paramArrayOfByte;
          ((beew)localObject).jdField_a_of_type_Int = localUrlCheckResult.result.get();
          paramBundle = paramArrayOfByte;
          ((beew)localObject).jdField_b_of_type_Int = localUrlCheckResult.jump_result.get();
          paramBundle = paramArrayOfByte;
          ((beew)localObject).jdField_a_of_type_JavaLangString = localUrlCheckResult.jump_url.get();
          paramBundle = paramArrayOfByte;
          ((beew)localObject).c = localUrlCheckResult.uint32_level.get();
          paramBundle = paramArrayOfByte;
          ((beew)localObject).d = localUrlCheckResult.uint32_sub_level.get();
          paramBundle = paramArrayOfByte;
          ((beew)localObject).e = localUrlCheckResult.uint32_umrtype.get();
          paramBundle = paramArrayOfByte;
          ((beew)localObject).f = localUrlCheckResult.ret_from.get();
          paramBundle = paramArrayOfByte;
          ((beew)localObject).jdField_b_of_type_Long = localUrlCheckResult.operation_bit.get();
          if (paramInt == 0) {
            paramArrayOfByte = (byte[])localObject;
          }
          paramBundle = paramArrayOfByte;
          this.jdField_a_of_type_Beer.a.put(str, localObject);
          paramInt += 1;
        }
