  ...
  extends BaseAdapter
{
  ...
  public ujp(Context paramContext, View.OnTouchListener paramOnTouchListener)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      {
        i = 2131561440;
        paramView = new vap(paramView.inflate(i, null));
        ...
        tsr.a(this.jdField_a_of_type_AndroidContentContext.getResources(), (TextView)localObject, str, 13.0F, 2.0F);
        label127:
        ((TextView)localObject).setText(tsr.a(paramViewGroup));
        localObject = (ImageView)paramView.a(2131367427);
        if ((!paramViewGroup.isVip) || (!naj.a(paramViewGroup.headUrl))) {
          break label267;
        }
        vzl.a((ImageView)localObject, paramViewGroup.headUrl, 38, 38, 1);
      }
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Uyi != null) {
        paramView.a(this.jdField_a_of_type_Uyi);
      }
      return paramView.a();
      ...
      if (!TextUtils.isEmpty(paramViewGroup.qq)) {
        tsr.a((ImageView)localObject, paramViewGroup.qq);
      } else {
        ((ImageView)localObject).setImageDrawable(bbef.a());
      }
    }
  }
}
