...
public class bipl
{
  public static View a(Context paramContext, Intent paramIntent, List<WebViewTabBarData> paramList, bjdq parambjdq)
  {
    int i = 0;
    if (paramIntent != null) {
      i = paramIntent.getIntExtra("tabBarStyle", 0);
    }
    bmqw.d("WebviewFragmentTabBarBuilder", "tab bar style =" + i);
    if (i == 1)
    {
      paramContext = new QQComicTabBarView(paramContext);
      paramContext.a(paramIntent, paramList, parambjdq);
      return paramContext;
    }
    if (i == 2)
    {
    ...
    paramContext.a(paramList, parambjdq);
    return paramContext;
  }
}
