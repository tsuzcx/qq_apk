  ...
  implements agma
{
  ...
  public agnw(BaseChatPie paramBaseChatPie)
  {
  ...
  private boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    {
      boolean bool4 = bgjw.b(localSessionInfo.jdField_a_of_type_JavaLangString);
      boolean bool5 = bfpx.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo.jdField_a_of_type_JavaLangString);
      bool2 = bool1;
      if (!bool4)
      {
        bool2 = bool1;
    ...
    if ((paramBaseChatPie instanceof aidf)) {}
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838365);
      if (QLog.isColorLevel()) {
        QLog.d("UnreadBackBottomHelper", 2, "resume button to unread mode");
      }
      if (AppSetting.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anni.a(2131689950) + this.jdField_a_of_type_Int + anni.a(2131689951));
      }
    }
  }
      ...
      if (Math.abs(paramInt) >= 20) {
        ...
        else if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_Int == 0) && (!this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130837969);
            this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
            if (AppSetting.jdField_c_of_type_Boolean) {
              this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anni.a(2131689950));
            }
            if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) {
              break;
            }
