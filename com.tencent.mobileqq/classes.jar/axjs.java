  ...
  implements Manager
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new axjt(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajsd.aW + "VideoRedbagRes" + File.separator;
  ...
  public axjs(AppInterface paramAppInterface)
  {
  ...
  private RelativeLayout.LayoutParams a(CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    if ((paramCustomFrameAnimationDrawable != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      paramCustomFrameAnimationDrawable = new RelativeLayout.LayoutParams(actj.a(j / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(k / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()));
  ...
  public static axjs a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Axjs == null) {}
    try
    {
      if (jdField_a_of_type_Axjs == null) {
        jdField_a_of_type_Axjs = new axjs(paramAppInterface);
      }
  ...
  private CustomFrameAnimationDrawable a(String paramString)
  {
    ...
    //   11: getstatic 57	axjs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: aload_1
    //   155: invokestatic 229	bbef:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   158: astore_1
    ...
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 235	axjs:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
  ...
  public static void a(Intent paramIntent, Activity paramActivity)
  {
    ...
    ahpd.a(paramActivity, paramIntent);
  }
  
  public static void a(View paramView, aeaf paramaeaf, ChatMessage paramChatMessage, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j != 0)
        {
          if (paramView.findViewById(2131372977) != null)
          {
            paramView.findViewById(2131372976).setVisibility(0);
            paramaeaf = (ImageView)paramView.findViewById(2131372977);
            if (j == 1) {
              paramaeaf.setImageResource(2130848680);
            }
            for (;;)
            {
              paramaeaf.setVisibility(0);
              paramView = (RelativeLayout.LayoutParams)((ImageView)paramView.findViewById(2131372976)).getLayoutParams();
              if (!paramChatMessage.isSend()) {
                break label213;
              }
              paramView.rightMargin = actj.a(6.0F, paramContext.getResources());
              ...
              break;
              if (j == 2) {
                paramaeaf.setImageResource(2130848681);
              } else if (j == 3) {
                paramaeaf.setImageResource(2130848679);
              }
            }
            paramView.rightMargin = 0;
            paramView.leftMargin = actj.a(6.0F, paramContext.getResources());
            return;
          }
          paramaeaf = new ImageView(paramContext);
          paramaeaf.setBackgroundDrawable(paramContext.getResources().getDrawable(2130848678));
          paramaeaf.setId(2131372976);
          paramaeaf.setVisibility(0);
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, actj.a(70.0F, paramContext.getResources()));
          localLayoutParams.addRule(7, 2131371608);
          localLayoutParams.addRule(8, 2131371608);
          if (paramChatMessage.isSend())
          {
            localLayoutParams.rightMargin = actj.a(6.0F, paramContext.getResources());
            localLayoutParams.leftMargin = 0;
            ((RelativeLayout)paramView).addView(paramaeaf, localLayoutParams);
            paramaeaf = new ImageView(paramContext);
            if (j != 1) {
              break label441;
            }
          ...
          for (;;)
          {
            paramaeaf.setId(2131372977);
            paramaeaf.setVisibility(0);
            paramChatMessage = new RelativeLayout.LayoutParams(-2, -2);
            paramChatMessage.addRule(8, 2131371608);
            paramChatMessage.addRule(14);
            ((RelativeLayout)paramView).addView(paramaeaf, paramChatMessage);
            return;
            localLayoutParams.rightMargin = 0;
            localLayoutParams.leftMargin = actj.a(6.0F, paramContext.getResources());
            break;
            if (j == 2) {
              paramaeaf.setImageResource(2130848681);
            } else if (j == 3) {
        ...
        paramView.findViewById(2131372977).setVisibility(4);
        paramView.findViewById(2131372976).setVisibility(4);
        return;
        j = 0;
      }
    }
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), axkc.class);
  ...
  private void b(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      new axka(this).execute(new String[] { paramAIOShortVideoData.jdField_c_of_type_JavaLangString });
    }
    for (;;)
    {
  ...
  private static boolean b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (bbkb.c(paramQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramQQAppInterface.exists()) && (!paramQQAppInterface.isDirectory()))
    {
      try
      {
        paramQQAppInterface = bbdx.b(paramQQAppInterface);
  ...
  public static void c()
  {
    try
    {
      if (!jdField_a_of_type_Boolean) {
        bbkb.e(BaseApplication.getContext(), true);
      }
      return;
    }
    finally {}
  ...
  private void c(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130848682);
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848691);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
    ...
    for (;;)
    {
      ...
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848692);
      c();
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!ajya.a(2131713297).trim().equals(localObject)) {
          break;
        }
    ...
    } while (!ajya.a(2131713295).trim().equals(localObject));
    ahtz.b("", "0X80088E6");
    j();
    a();
  }
  ...
  private void g()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131713294));
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130848683, 0);
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131713298));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
  ...
  private void i()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new axjz(this));
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
      }
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131713296));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(actj.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130848687);
    this.jdField_a_of_type_AndroidWidgetTextView.bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    ObjectAnimator.ofFloat(this.jdField_a_of_type_AndroidWidgetTextView, "alpha", new float[] { 0.0F, 1.0F }).setDuration(180L).start();
  }
  ...
  private void l()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.a(new axju(this, localCustomFrameAnimationDrawable));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848686);
    c();
  ...
  private void n()
  {
    ...
    for (;;)
    {
      ...
      h();
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848690);
      c();
    }
  }
  ...
  public ImageView a(Activity paramActivity, ViewGroup paramViewGroup, String paramString)
  {
    ...
    paramString.setId(2131373029);
    Object localObject = new RelativeLayout.LayoutParams(-1, actj.a(180.0F, paramActivity.getResources()));
    ...
    ((TextView)localObject).setId(2131373030);
    localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(12);
    localLayoutParams.addRule(14);
    localLayoutParams.bottomMargin = actj.a(10.0F, paramActivity.getResources());
    paramViewGroup.addView((View)localObject, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject);
    ((TextView)localObject).bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new axjy(this));
    e();
    return paramString;
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == -1)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new axjv(this));
    }
    for (;;)
    {
  ...
  public void a(Activity paramActivity)
  {
    if (a())
    {
      ...
      Bundle localBundle = bigo.a(null, paramActivity.getClass().getName(), 10004, 8);
      vwj.a().a(paramActivity, localBundle, 9010);
    }
  }
