  ...
  implements axjo
{
  ...
  public axjs(VideoData paramVideoData, QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    try
    {
      int i = Integer.parseInt("8.4.1".replace(".", ""));
      return i;
    }
  ...
  public void a(int paramInt, axjq paramaxjq)
  {
    ...
    nir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new axjt(this, paramaxjq), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public void a(Comments.Comment paramComment, axjp paramaxjp)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    if (a(localReqBody))
    {
      ...
      nir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new axjv(this, paramaxjp, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
    paramaxjp.a(paramComment, -1);
  }
  
  public void a(Comments.Comment paramComment, axjr paramaxjr)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      nir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new axju(this, paramaxjr, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
