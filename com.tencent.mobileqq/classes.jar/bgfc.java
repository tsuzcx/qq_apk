...
public class bgfc
{
  ...
  private bgfd jdField_a_of_type_Bgfd;
  ...
  private String jdField_b_of_type_JavaLangString = ajed.aT + "/tencent/Qzone/AntishakeGif/";
  ...
  static
  {
    ...
    jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor = new ThreadPoolExecutor(babp.b(), babp.b() + 5, 200L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    a();
  }
  ...
  public static bgfc a()
  {
    try
    {
      if (jdField_a_of_type_Bgfc == null) {
        jdField_a_of_type_Bgfc = new bgfc();
      }
      bgfc localbgfc = jdField_a_of_type_Bgfc;
      return localbgfc;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      localFile = new File(this.jdField_b_of_type_JavaLangString + this.jdField_c_of_type_JavaLangString);
      if (localFile.exists()) {}
    }
    try
    {
  ...
  {
    if (this.jdField_a_of_type_Bgfd != null) {
      this.jdField_a_of_type_Bgfd.a(paramInt);
    }
  }
  ...
  public ArrayList<String> a(ArrayList<Bitmap> paramArrayList)
  {
    ...
    catch (IOException localIOException)
    {
      ...
      catch (InterruptedException paramArrayList)
      {
        ...
        System.gc();
        this.jdField_a_of_type_Bgfd = null;
  ...
  public boolean a(ArrayList<String> paramArrayList)
  {
    ...
    String str = ajed.aT + "/tencent/Qzone/AlbumAutoVConvGif/";
  ...
  public boolean a(ArrayList<String> paramArrayList, LruCache<Integer, BitmapDrawable> paramLruCache)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QzoneVision", 2, "DeviceInfoUtil.getMemoryClass() = " + babp.f() / 1048576L + "M, DeviceInfoUtil.getSystemAvaialbeMemory() = " + babp.e() / 1048576L + "M");
    }
