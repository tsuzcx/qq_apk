...
public class beko
{
  ...
  public static beko a(String paramString)
  {
    GsonBuilder localGsonBuilder = new GsonBuilder();
    localGsonBuilder.registerTypeAdapter(beko.class, a());
    return (beko)localGsonBuilder.create().fromJson(paramString, beko.class);
  }
  ...
  public static JsonSerializer<beko> a()
  {
    return new bekp();
  }
