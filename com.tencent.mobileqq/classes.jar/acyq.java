  ...
  implements ValueAnimator.AnimatorUpdateListener
{
  ...
  public acyq(Context paramContext, ListView paramListView, BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setId(2131362314);
  ...
  public acyq a(int paramInt1, int paramInt2)
  {
    int j = 0;
    int k = 0;
