...
public class acyq
{
  private static volatile acyq jdField_a_of_type_Acyq;
  ...
  {
    if (jdField_a_of_type_Acyq == null) {}
    try
    {
      if (jdField_a_of_type_Acyq == null) {
        jdField_a_of_type_Acyq = new acyq();
      }
      return jdField_a_of_type_Acyq;
    }
    finally {}
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage, int paramInt1, int paramInt2, acyr paramacyr)
  {
    int j = -1;
    int i;
    if (paramInt1 == 0)
    {
      ...
      axqy.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_stack_rec", 0, 0, String.valueOf(i), String.valueOf(paramacyr.jdField_a_of_type_Int), "", "");
    }
    label100:
    while (paramInt2 != 3)
    {
      ...
      i = 2;
      break;
      axqy.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_stack_launch", 0, 0, String.valueOf(i), String.valueOf(paramacyr.jdField_a_of_type_Int), "", "");
      return;
    }
    label134:
    if (!paramChatMessage.isSendFromLocal())
    {
      axqy.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_jump_rec", 0, 0, String.valueOf(i), String.valueOf(paramacyr.jdField_a_of_type_Int), "", "");
      return;
    }
    axqy.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_jump_launch", 0, 0, String.valueOf(i), String.valueOf(paramacyr.jdField_a_of_type_Int), "", "");
  }
  
  private void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage, acyr paramacyr)
  {
    boolean bool = false;
    ...
    if ((paramChatMessage.isSendFromLocal()) && (this.jdField_b_of_type_Boolean) && (paramChatMessage.shmsgseq == this.jdField_b_of_type_Long + 1L)) {
      axqy.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Eggs_stack_new", 0, 0, String.valueOf(0), String.valueOf(paramacyr.jdField_a_of_type_Int), "", "");
    }
    if (!paramChatMessage.isSendFromLocal()) {
      bool = true;
    }
  ...
  public String a(AbsShareMsg paramAbsShareMsg)
  {
    if ((paramAbsShareMsg != null) && (paramAbsShareMsg.getItemCount() > 0))
    {
      ...
      {
        Object localObject = (axup)paramAbsShareMsg.next();
        if ((localObject instanceof axuq))
        {
          localObject = ((axuq)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject).hasNext())
          {
            axup localaxup = (axup)((Iterator)localObject).next();
            String str = localaxup.jdField_a_of_type_JavaLangString;
            if ("title".equals(str)) {
              localStringBuilder.append(((StructMsgItemTitle)localaxup).b());
            } else if ("summary".equals(str)) {
              localStringBuilder.append(((axzj)localaxup).b());
            }
          }
        }
      }
  ...
  public ArrayList<acyr> a(ChatMessage paramChatMessage)
  {
    acyr localacyr = null;
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        paramChatMessage = localacyr;
        localObject1 = paramChatMessage;
        if (localIterator.hasNext())
        {
          localacyr = (acyr)localIterator.next();
          if (localacyr.jdField_a_of_type_JavaUtilArrayList == null) {
            break label401;
          }
          localObject1 = localacyr.jdField_a_of_type_JavaUtilArrayList.iterator();
          for (;;)
          {
            ...
            {
              if (localacyr.jdField_a_of_type_Acys == null) {
                break;
              }
              l2 = System.currentTimeMillis() / 1000L;
              if ((localacyr.jdField_a_of_type_Acys.jdField_a_of_type_Int != 1) || ((localacyr.jdField_a_of_type_Acys.jdField_b_of_type_Int <= l2) && (localacyr.jdField_a_of_type_Acys.c >= l2))) {
                break;
              }
              if (QLog.isColorLevel()) {
          ...
          label292:
          paramChatMessage.add(localacyr);
          localObject1 = paramChatMessage;
          if (QLog.isColorLevel()) {
            QLog.d("AioAnimationDetector", 2, "matched ===> rule: id=" + localacyr.jdField_a_of_type_Int);
          }
        }
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, MessageRecord paramMessageRecord, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    for (;;)
    {
      ...
      if ((!(paramMessageRecord instanceof MessageForArkFlashChat)) && (!this.jdField_a_of_type_Boolean))
      {
        ...
        if ((paramSessionInfo.jdField_a_of_type_Int == 1008) || (akpx.a(paramSessionInfo.jdField_a_of_type_Int) == 1032)) {
          break;
        }
        int j = 0;
        int i;
        ...
        {
          label109:
          if (((i == 0) && (j == 0)) || (!paramSessionInfo.jdField_a_of_type_JavaLangString.equals(paramMessageRecord.frienduin)) || ((paramSessionInfo.jdField_a_of_type_Int != paramMessageRecord.istroop) && ((j == 0) || (!akpx.c(paramMessageRecord.istroop))))) {
            break label448;
          }
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<acyr> paramArrayList, boolean paramBoolean1, ChatMessage paramChatMessage, boolean paramBoolean2, AIOAnimationConatiner paramAIOAnimationConatiner, int paramInt)
  {
    ...
    do
    {
      ...
      {
        localacyr = (acyr)paramArrayList.next();
        i = paramChatMessage.getRepeatCount();
        j = localacyr.jdField_b_of_type_Int;
        m = localacyr.c;
        if (QLog.isColorLevel()) {
          QLog.d("AioAnimationDetector", 2, "detect : troopOrDiscussion=" + paramBoolean1 + " matched (" + paramChatMessage.uniseq + "), rule: id=" + localacyr.jdField_a_of_type_Int + ",M=" + i + ",X=" + j + ",Y=" + m + ",crazyMode=" + localacyr.jdField_a_of_type_Boolean);
        }
        if (paramBoolean1) {
          break label504;
        }
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("AioAnimationDetector", 2, "detect c2c =======>  egg_jumper animation, crazyModeEnable=" + localacyr.jdField_a_of_type_Boolean);
          }
          a(paramQQAppInterface, paramChatMessage, 0, 3, localacyr);
          if ((paramChatMessage instanceof MessageForStructing)) {
            a(paramQQAppInterface, paramChatMessage, 0);
          }
          if (localacyr.jdField_a_of_type_Boolean)
          {
            j = localacyr.jdField_b_of_type_JavaUtilArrayList.size();
            i = 0;
            while (i < j)
            {
              localObject = (acyt)localacyr.jdField_b_of_type_JavaUtilArrayList.get(i);
              localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
              k = i * 800;
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.2(this, paramAIOAnimationConatiner, (Drawable)localObject, k, localacyr), paramInt + k);
              i += 1;
            }
          }
          localObject = (acyt)localacyr.jdField_b_of_type_JavaUtilArrayList.get(0);
          localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.3(this, paramAIOAnimationConatiner, (Drawable)localObject, localacyr), paramInt);
        }
      }
      do
      {
        for (;;)
        {
          if ((localacyr.jdField_a_of_type_Acys == null) || (localacyr.jdField_a_of_type_Acys.jdField_a_of_type_Int != 1) || (localnqn == null)) {
            break label1503;
          }
          localnqn.jdField_b_of_type_Int = localacyr.jdField_a_of_type_Acys.d;
          localnqn.c = localacyr.jdField_a_of_type_Acys.e;
          break label74;
          break;
          if ((j != 0) || (m != 0)) {
            break label731;
          ...
          if (QLog.isColorLevel()) {
            QLog.d("AioAnimationDetector", 2, "detect =======>  egg_jumper animation ,crazyModeEnable=" + localacyr.jdField_a_of_type_Boolean);
          }
          a(paramQQAppInterface, paramChatMessage, 1, 3, localacyr);
          if ((paramChatMessage instanceof MessageForStructing)) {
          ...
          if (localacyr.jdField_a_of_type_Boolean)
          {
            ...
            while (i < j)
            {
              ...
              localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
              k = i * 800;
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.4(this, paramAIOAnimationConatiner, (Drawable)localObject, k, localacyr), paramInt + k);
              i += 1;
            }
          }
          else
          {
            localObject = (acyt)localacyr.jdField_b_of_type_JavaUtilArrayList.get(0);
            localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.5(this, paramAIOAnimationConatiner, (Drawable)localObject, localacyr), paramInt);
          }
        }
      } while (j >= m);
    } while (i < j);
    ...
    if (i == m)
    {
      ...
      if (paramBoolean2)
      {
        a(paramQQAppInterface, paramChatMessage, 1, 2, localacyr);
        a(paramQQAppInterface, paramChatMessage, localacyr);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AioAnimationDetector", 2, "detect (M == Y) =======>  egg_jumper animation ,Y=" + m + ",crazyModeEnable=" + localacyr.jdField_a_of_type_Boolean);
      }
      a(paramQQAppInterface, paramChatMessage, 1, 3, localacyr);
      i = 0;
      if (i < m) {
    ...
    for (int j = 1000;; j = 0)
    {
      if (localacyr.jdField_a_of_type_Boolean)
      {
        int n = localacyr.jdField_b_of_type_JavaUtilArrayList.size();
        k = 0;
        while (k < n)
        {
          localObject = (acyt)localacyr.jdField_b_of_type_JavaUtilArrayList.get(k);
          localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
          int i1 = (k + i) * 800;
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.7(this, paramAIOAnimationConatiner, (Drawable)localObject, i1, localacyr), paramInt + j + i1);
          k += 1;
        }
      }
      localObject = (acyt)localacyr.jdField_b_of_type_JavaUtilArrayList.get(0);
      localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
      k = i * 800;
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.8(this, paramAIOAnimationConatiner, (Drawable)localObject, k, localacyr), paramInt + j + k);
      i += 1;
      break label898;
      break label450;
      if (i > m)
      ...
      for (i = 1000;; i = 0)
      {
        if (localacyr.jdField_a_of_type_Boolean)
        {
          k = localacyr.jdField_b_of_type_JavaUtilArrayList.size();
          j = 0;
          while (j < k)
          {
            localObject = (acyt)localacyr.jdField_b_of_type_JavaUtilArrayList.get(j);
            localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
            m = j * 800;
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.10(this, paramAIOAnimationConatiner, (Drawable)localObject, m, localacyr), paramInt + i + m);
            j += 1;
          }
          break label450;
        }
        localObject = (acyt)localacyr.jdField_b_of_type_JavaUtilArrayList.get(0);
        localObject = acyt.a(paramQQAppInterface.getApplication(), (acyt)localObject);
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.11(this, paramAIOAnimationConatiner, (Drawable)localObject, localacyr), paramInt + i);
        break label450;
        if (QLog.isColorLevel()) {
