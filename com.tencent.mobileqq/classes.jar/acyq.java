...
public class acyq
  extends acyf
  implements acxv, IDropFrameListener
{
  public String a()
  {
    return "dropframe";
  ...
  {
    DropFrameMonitor.uploadDropFrameToDenta(paramDropFrameResultMeta.scene, (paramDropFrameResultMeta.duration / 1000000.0F), paramDropFrameResultMeta.dropCount, paramDropFrameResultMeta.dropIntervals);
