...
public class bivi
{
  ...
  private String jdField_b_of_type_JavaLangString = biig.jdField_b_of_type_JavaLangString;
  private int jdField_c_of_type_Int;
  private String jdField_c_of_type_JavaLangString;
  private int d;
  
  public bivi(String paramString)
  {
  ...
  public void a(bivj parambivj)
  {
    this.jdField_a_of_type_Bivj = parambivj;
    QLog.d(jdField_a_of_type_JavaLangString, 4, "start add text to png");
    this.jdField_a_of_type_AndroidOsHandler.post(new PngsTextDrawer.2(this, parambivj));
  }
