  ...
  extends azwo
{
  ...
  public baby(azxt paramazxt, azrb paramazrb)
  {
    super(paramazxt, paramazrb);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new babz(this);
  }
  ...
  private boolean a(Card paramCard, boolean paramBoolean)
  {
    ...
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "", "", "", "0X800A1C6", "0X800A1C6", 0, 0, "", "", "", "");
      QZLog.d("cardInfo.allinone.pa", 2, new Object[] { Integer.valueOf(((azrb)this.b).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a) });
      if ((paramCard.presentSwitch) && (!ProfileActivity.AllInOne.f(((azrb)this.b).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne))) {
        break label152;
      }
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      return paramBoolean;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "", "", "", "0X800A1C8", "0X800A1C8", 0, 0, "", "", "", "");
      break;
    }
    label152:
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131561410, null);
    this.jdField_a_of_type_JavaLangObject = localView;
    Object localObject1 = (ViewGroup)localView.findViewById(2131368848);
    TextView localTextView = (TextView)localView.findViewById(2131378815);
    ImageView localImageView1 = (ImageView)localView.findViewById(2131368541);
    Object localObject2 = (ImageView)localView.findViewById(2131368849);
    Object localObject3 = (ImageView)localView.findViewById(2131368850);
    Object localObject4 = (ImageView)localView.findViewById(2131368851);
    ImageView localImageView2 = (ImageView)localView.findViewById(2131368852);
    ...
    if ((paramCard.showPresent) && (paramCard.presentUrl != null))
    {
      ...
      i = ((Resources)localObject1).getDimensionPixelSize(2131298340);
      j = ((Resources)localObject1).getDimensionPixelSize(2131297538);
      k = ((Resources)localObject1).getDimensionPixelSize(2131297535);
      ...
      if ((localObject2 != null) && (!((List)localObject2).isEmpty())) {
        if (((List)localObject2).size() > 4)
        {
          ...
          localObject1 = new ColorDrawable(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getColor(2131165729));
        }
      }
    }
    label705:
    ...
    for (;;)
    {
      ...
      if (((azrb)this.b).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a == 0)
      {
        localObject1 = anvx.a(2131707922);
      ...
      {
        localTextView.setText((String)localObject1 + anvx.a(2131707929) + paramCard);
        localView.setTag(new azpb(94, null));
        localView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        localView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691148));
        a(localTextView, null, localImageView1);
        return true;
        localObject1 = ((azrb)this.b).jdField_a_of_type_ArrayOfJavaLangString[0];
        break;
      }
    }
  }
