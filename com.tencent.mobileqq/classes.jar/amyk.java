  ...
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bkzq
{
  ...
  public amyk(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = amwn.a(this.jdField_a_of_type_Int);
      if (paramString != null)
      {
  ...
  private boolean a(long paramLong)
  {
    try
    {
      ...
      CmGameStartChecker.StartCheckParam localStartCheckParam = localamyo.a();
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      ...
      this.jdField_a_of_type_Bkzi.a(new amyl(this));
