  ...
  implements Handler.Callback, EIPCResultCallback
{
  ...
  @RequiresApi(api=18)
  public arcm(QQIdentiferActivity paramQQIdentiferActivity, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity = paramQQIdentiferActivity;
    this.jdField_a_of_type_Arcn = arcn.a(paramInt, paramQQIdentiferActivity.getIntent(), paramQQIdentiferActivity);
  ...
  public void a()
  {
    ...
    QLog.d("qq_Identification.Helper", 1, new Object[] { "preCheck is pass, so version is ", Integer.valueOf(bbjn.b()), " current bits is : ", Integer.valueOf(b()) });
  ...
  public void b()
  {
    ...
    if (!jdField_a_of_type_Boolean) {
      jdField_a_of_type_Boolean = this.jdField_a_of_type_Arcn.a(this.jdField_a_of_type_JavaLangString + "identification/so/");
    }
    int i;
    if (jdField_a_of_type_Boolean)
    {
    ...
    for (;;)
    {
      ...
      return;
      i = this.jdField_a_of_type_Arcn.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity, this.jdField_a_of_type_JavaLangString);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      if (paramMessage.arg1 == 0)
      {
        ...
        this.jdField_a_of_type_Arcn.a(true, this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity);
      }
      if (paramMessage.arg1 != 0) {
        break label238;
      }
