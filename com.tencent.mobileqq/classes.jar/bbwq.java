...
public class bbwq
{
  ...
  public static Drawable a(Context paramContext)
  {
    ...
    return paramContext.getResources().getDrawable(2130846185);
  }
  ...
  public static void a(Context paramContext, SingleLineTextView paramSingleLineTextView, String paramString)
  {
    ...
    do
    {
      ...
      if ((!(localAppRuntime instanceof QQAppInterface)) || (!bgpy.b((QQAppInterface)localAppRuntime, paramString))) {
        break;
      }
  ...
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    return ((localAppRuntime instanceof QQAppInterface)) && (bgpy.b((QQAppInterface)localAppRuntime, paramString));
  }
}
