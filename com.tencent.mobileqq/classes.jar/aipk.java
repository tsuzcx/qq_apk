  ...
  implements View.OnClickListener
{
  ...
  public aipk(SigCommentListActivity paramSigCommentListActivity, QQAppInterface paramQQAppInterface, XListView paramXListView, View paramView)
  {
  ...
  {
    if (this.b != null) {
      ((aipl)this.b.getTag()).jdField_a_of_type_AndroidWidgetTextView.setText(paramInt);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (1 == i)
      {
        ...
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562444, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          paramViewGroup = new aipm();
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376189));
          paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376190));
          paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376187));
          paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376188));
          paramViewGroup.c = ((TextView)paramView.findViewById(2131376191));
          paramView.setTag(paramViewGroup);
          localSigCommentInfo = a(paramInt);
          localObject = String.valueOf(localSigCommentInfo.uin);
          baxt localbaxt = baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, (String)localObject);
          if (localbaxt != null) {
            paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(localbaxt);
          }
          localObject = bbcl.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject);
          paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
          paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130848962);
        ...
        for (Object localObject = ajyc.a(2131714103) + (String)localObject;; localObject = ajyc.a(2131714100) + (String)localObject)
        {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561647, this.jdField_a_of_type_ComTencentWidgetXListView, false);
      paramView.setOnClickListener(this);
      paramViewGroup = new aipl();
      paramView.setTag(paramViewGroup);
      paramView.findViewById(2131369481).setVisibility(8);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370443));
      this.b = paramView;
    }
    for (;;)
    {
      return this.b;
      paramView = (aipl)paramView.getTag();
    }
  }
