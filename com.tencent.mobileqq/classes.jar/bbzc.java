...
public class bbzc
{
  ...
  private WeakReference<bbzd> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private String b;
  private String c = "android";
  private String d = "8.3.0";
  ...
  public bbzc(String paramString, int paramInt, bbzd parambbzd)
  {
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambbzd);
  }
  ...
  private bbyu a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bbyu((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bbyu();
        ((bbyu)localObject).jdField_a_of_type_Int = i;
        return localObject;
      }
    }
  ...
  private void a(bbyu parambbyu)
  {
    if ((parambbyu != null) && (QLog.isColorLevel())) {
      QLog.i("GetRegisterLiangHaoList", 2, "onResponse " + parambbyu);
    }
    ...
    if (parambbyu != null)
    {
      i = parambbyu.jdField_a_of_type_Int;
    ...
    {
      localaxrn.a(null, "reg_lh_get_list", bool, l1 - l2, 0L, (HashMap)localObject, "", true);
      localObject = (bbzd)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject != null) {
        break label143;
      }
      return;
    ...
    label143:
    ThreadManagerV2.getUIHandlerV2().post(new GetRegisterLiangHaoList.2(this, parambbyu, (bbzd)localObject));
  }
  ...
  private String b()
  {
    ...
    try
    {
      this.jdField_a_of_type_JavaLangString = bfnn.a("ecd027");
