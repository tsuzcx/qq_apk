...
public class udd
{
  public static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf)
  {
    if (paramCommentEntry.commentType == 1) {
      return c(paramCommentLikeFeedItem, paramCommentEntry, paramudf);
    }
    if (paramCommentEntry.commentType == 2) {
      return d(paramCommentLikeFeedItem, paramCommentEntry, paramudf);
    }
    if (paramCommentEntry.commentType == 5) {
      return c(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramudf);
    }
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramudf, true);
    }
    return a(paramCommentLikeFeedItem, paramCommentEntry, paramudf);
  }
  
  private static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf, boolean paramBoolean)
  {
    paramContext = ((sqs)sqg.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str5))
    {
      ...
      if (!axku.a(paramCommentEntry.content)) {
        break label511;
      }
    }
    label84:
    ...
    label125:
    label511:
    for (paramCommentLikeFeedItem = awbk.b(paramCommentEntry.content);; paramCommentLikeFeedItem = null)
    {
      String str1;
      String str2;
      if (paramBoolean)
      {
        paramContext = ajjy.a(2131648452);
        if (i == 0) {
          break label403;
        }
        str1 = "V";
      ...
      for (paramCommentLikeFeedItem = new axkn(str2 + paramContext + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + paramContext + ": " + str6))
      {
        for (;;)
        {
          i = 0;
          if (paramBoolean)
          {
            ...
            a(paramCommentLikeFeedItem, 0, k, paramudf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
            j = str4.length() + k;
            i = j;
            if (k != j)
            {
          ...
          catch (Exception paramContext)
          {
            ...
            a(paramCommentLikeFeedItem, paramCommentLikeFeedItem.length() - "I".length(), paramCommentLikeFeedItem.length(), 2130845366, 15, 15, 3);
            return paramCommentLikeFeedItem;
          }
        }
        paramContext = ajjy.a(2131648455);
        break label84;
        str1 = "";
        break label93;
        str2 = "";
  ...
  private static SpannableStringBuilder a(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    String str1 = null;
    if (axku.a(paramCommentEntry.content)) {
      str1 = awbk.b(paramCommentEntry.content);
    }
    String str3 = ajjy.a(2131648453);
    if (str1 != null) {}
    for (paramCommentEntry = new axkn(str3 + ": " + str1, 3, 16);; paramCommentEntry = new SpannableStringBuilder(str3 + ": " + str2))
    {
  ...
  private static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf)
  {
    Object localObject1 = (sqs)sqg.a(2);
    Object localObject3 = ((sqs)localObject1).c(paramCommentEntry.authorUnionId);
    ...
    {
      localObject2 = ((sqs)localObject1).c(paramCommentEntry.replierUnionId);
    ...
    for (paramCommentLikeFeedItem = (CommentLikeFeedItem)localObject2;; paramCommentLikeFeedItem = null)
    {
      ...
      if (!TextUtils.isEmpty(str4))
      {
        ...
        if (axku.a(paramCommentEntry.content)) {
          paramCommentLikeFeedItem = awbk.b(paramCommentEntry.content);
        }
        str6 = ajjy.a(2131648458);
        if (i == 0) {
          break label415;
        }
        localObject2 = "V";
      ...
      label422:
      label429:
      for (paramCommentLikeFeedItem = new axkn(str2 + (String)localObject2 + str3 + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + ": " + str7))
      {
        j = str2.length();
        ...
        a(paramCommentLikeFeedItem, 0, i, paramudf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
        j = str3.length() + i;
        paramudf = paramCommentLikeFeedItem;
        if (i != j)
        {
          b(paramCommentLikeFeedItem, i, j, -4473925);
          paramudf = paramCommentLikeFeedItem;
        ...
        {
          paramudf.append(" ");
          paramCommentLikeFeedItem = ajjy.a(2131648457);
          i = paramudf.length();
          j = paramCommentLikeFeedItem.length();
          paramudf.append(paramCommentLikeFeedItem);
          b(paramudf, i, j + i, -48606);
          i = paramudf.length();
          j = "[icon]  ".length();
          paramudf.append("[icon]  ");
          a(paramudf, i, j + i, 2130847475);
        }
        return paramudf;
        i = 0;
        break;
      ...
      label475:
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new axkn(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + str7))
      {
        j = str2.length();
        a(paramCommentLikeFeedItem, 0, j);
        if (sku.a()) {
        ...
        a(paramCommentLikeFeedItem, i - str1.length(), j, paramudf, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  public static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, List<LikeEntry> paramList, udf paramudf)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    String str1 = paramCommentLikeFeedItem.feedId + "_" + paramList.hashCode();
    Object localObject = sob.a().a(str1);
    ...
    for (paramCommentLikeFeedItem = paramCommentLikeFeedItem.qq;; paramCommentLikeFeedItem = null)
    {
      ...
      for (;;)
      {
        if (j < paramList.size())
        {
          ...
          localObject = ((sqs)sqg.a(2)).c(localLikeEntry.unionId);
          ...
          for (localObject = "";; localObject = ", ")
          {
            ...
            a(localSpannableStringBuilder, m, n, paramudf, localLikeEntry.unionId);
            break;
            k = 0;
            break label220;
            localObject = "";
      ...
      if (i != 0) {
        sob.a().a(str1, localSpannableStringBuilder);
      }
  ...
  private static String a(CommentLikeFeedItem paramCommentLikeFeedItem, QQUserUIItem paramQQUserUIItem)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        return ((sqo)sqg.a(23)).a(paramQQUserUIItem, paramCommentLikeFeedItem, false, false);
        i = 0;
        break;
      }
      return tfy.a(paramQQUserUIItem);
      label93:
      paramCommentLikeFeedItem = null;
      continue;
      paramCommentLikeFeedItem = null;
  ...
  {
    paramString1 = ((sqs)sqg.a(2)).c(paramString1);
    if (paramBoolean) {
      return ((sqo)sqg.a(23)).a(paramString1, paramString3, false, false);
    }
    return tfy.a(paramString1);
  }
  ...
  {
    paramInt4 = vms.a(BaseApplicationImpl.getContext(), paramInt4);
    paramInt5 = vms.a(BaseApplicationImpl.getContext(), paramInt5);
    ...
    for (;;)
    {
      ...
      if (paramInt6 == 0) {
        ...
        localObject = new vpx((Drawable)localObject);
      } else {
        localObject = new vrc((Drawable)localObject);
      }
    }
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, udf paramudf, String paramString)
  {
    a(paramSpannableStringBuilder, paramInt1, paramInt2, paramudf, paramString, 0);
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, udf paramudf, String paramString, int paramInt3)
  {
    paramSpannableStringBuilder.setSpan(new ude(paramudf, paramString, paramInt3), paramInt1, paramInt2, 33);
  }
  ...
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString, int paramInt1, int paramInt2)
  {
    ...
    int i = vms.a(BaseApplicationImpl.getContext(), 13.0F);
    paramString.setBounds(0, 0, i, i);
    paramSpannableStringBuilder.setSpan(new vrc(paramString), paramInt1, paramInt2, 33);
  }
  
  public static SpannableStringBuilder b(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf)
  {
    if (paramCommentEntry.commentType == 1) {
    ...
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramudf, false);
    }
    return b(paramCommentLikeFeedItem, paramCommentEntry, paramudf);
  }
  
  private static SpannableStringBuilder b(@NonNull CommentEntry paramCommentEntry)
  {
    String str = ajjy.a(2131648454);
    ...
    default: 
      return paramCommentEntry;
    case 1: 
      a(paramCommentEntry, j, k, 2130843697, 37, 16);
      return paramCommentEntry;
    case 2: 
      a(paramCommentEntry, j, k, 2130843699, 37, 16);
      return paramCommentEntry;
    case 3: 
      a(paramCommentEntry, j, k, 2130843698, 37, 16);
      return paramCommentEntry;
    case 4: 
      a(paramCommentEntry, j, k, 2130843696, 37, 16);
      return paramCommentEntry;
    }
    a(paramCommentEntry, j, k, 2130843695, 37, 16);
    return paramCommentEntry;
  }
  
  private static SpannableStringBuilder b(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf)
  {
    String str1 = null;
    Object localObject1 = (sqs)sqg.a(2);
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          if (paramCommentLikeFeedItem != null)
          {
            paramCommentEntry = new axkn(paramCommentLikeFeedItem, 3, 16);
            return paramCommentEntry;
            i = 0;
            break;
            label153:
      ...
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new axkn(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + str4))
      {
        int j = str3.length();
        i = ((String)localObject1).length() + j;
        a(paramCommentLikeFeedItem, j, i);
        ...
        a(paramCommentLikeFeedItem, i - ((String)localObject1).length(), j, paramudf, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  private static SpannableStringBuilder c(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf)
  {
    paramContext = ((sqs)sqg.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      paramContext = ajjy.a(2131648447);
      label100:
      if (i == 0) {
        break label370;
      }
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, i, paramudf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = i + str2.length();
      if (i != j) {
      ...
      j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130845366, 15, 15, 3);
      }
      return localSpannableStringBuilder;
      i = 0;
      break;
      paramContext = " @" + paramContext + ajjy.a(2131648447);
      break label100;
    }
  }
  ...
  private static SpannableStringBuilder c(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    for (paramCommentEntry = ajjy.a(2131648451);; paramCommentEntry = "@" + paramCommentEntry + ajjy.a(2131648449))
    {
      ...
      int j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130845366, 15, 15);
      }
      return localSpannableStringBuilder;
    }
  }
  
  private static SpannableStringBuilder c(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf)
  {
    Object localObject = ((sqs)sqg.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      localObject = null;
      if (axku.a(paramCommentEntry.content)) {
        localObject = awbk.b(paramCommentEntry.content);
      }
      str4 = ajjy.a(2131648450);
      if (i == 0) {
        break label272;
      }
    ...
    label272:
    label278:
    for (localObject = new axkn(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + (String)localObject, 3, 16);; localObject = new SpannableStringBuilder(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + str5))
    {
      int j = str1.length();
      ...
      a((SpannableStringBuilder)localObject, 0, i, paramudf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = str2.length() + i;
      if (i != j) {
  ...
  private static SpannableStringBuilder d(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, udf paramudf)
  {
    Object localObject = ((sqs)sqg.a(2)).c(paramCommentEntry.authorUnionId);
    String str1 = a(paramCommentLikeFeedItem, (QQUserUIItem)localObject);
    String str2 = a(paramCommentEntry.authorRole, (QQUserUIItem)localObject);
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, j, paramudf, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      k = str2.length() + j;
      if (j != k) {
    ...
    a(localSpannableStringBuilder, j, k, 2130843697, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843699, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843698, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843696, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130843695, 37, 16, 3);
    return localSpannableStringBuilder;
  }
}
