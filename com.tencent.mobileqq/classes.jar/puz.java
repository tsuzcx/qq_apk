...
public class puz
{
  private static puz jdField_a_of_type_Puz;
  private int jdField_a_of_type_Int;
  private DecimalFormat jdField_a_of_type_JavaTextDecimalFormat = new DecimalFormat("0.00");
  private ConcurrentHashMap<Integer, WeakReference<pgp>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static puz a()
  {
    if (jdField_a_of_type_Puz == null) {
      jdField_a_of_type_Puz = new puz();
    }
    return jdField_a_of_type_Puz;
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      localObject = (pgp)((WeakReference)localObject).get();
    } while (localObject == null);
    ((pgp)localObject).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private boolean a(ToServiceMsg paramToServiceMsg)
  {
    int i;
    int k;
    if (paramToServiceMsg.getAttribute(pgp.f) != null)
    {
      i = ((Integer)paramToServiceMsg.getAttribute(pgp.f)).intValue();
      if (i == 2)
      {
        k = 1;
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    ors.a().post(paramToServiceMsg);
  }
  
  public final void a(ToServiceMsg paramToServiceMsg, pgp parampgp)
  {
    if ((paramToServiceMsg == null) || (parampgp == null)) {
      return;
    }
    paramToServiceMsg.extraData.putBoolean("req_pb_protocol_flag", true);
    parampgp = new WeakReference(parampgp);
    ors.a().post(new ReadInJoyMSFService.1(this, paramToServiceMsg, parampgp));
    a(paramToServiceMsg);
  }
    ...
    for (;;)
    {
      ...
      if (paramFromServiceMsg.getResultCode() == 2008)
      {
        ...
        if (paramFromServiceMsg == null) {
          paramToServiceMsg = ors.a().getApplication();
        }
