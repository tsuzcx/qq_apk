  ...
  extends BaseAdapter
{
  ...
  public npv(QQStoryShieldListActivity paramQQStoryShieldListActivity, List paramList)
  {
    if (paramList != null)
    {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_ComTencentBizQqstorySettingsQQStoryShieldListActivity).inflate(2130970788, null);
      paramViewGroup = new npw(this);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362721));
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131370795));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (npw)paramView.getTag();
      break;
      label225:
