...
public class naz
{
  ...
  public static Intent a(Context paramContext, Intent paramIntent, String paramString, boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    try
    {
      bool = ((bduf)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(165)).c(paramString, false);
      if (bool) {
        if (paramIntent == null)
        {
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      ...
      {
        paramQQAppInterface = ((ajxl)paramQQAppInterface.getManager(51)).b(paramString);
        if (paramQQAppInterface == null) {
          break label189;
        }
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramQQAppInterface != null)
        {
          paramQQAppInterface = ((ajvr)paramQQAppInterface).a(paramString);
          if (paramQQAppInterface != null) {
  ...
  private static void a(int paramInt, bcqf parambcqf)
  {
    b(paramInt, parambcqf);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if ((llw.c()) && (llw.d()))
      {
        ...
        localbfpc.b(2131720362);
        localbfpc.c(2131690596);
        localbfpc.a(new nbc(localbfpc, paramQQAppInterface, paramContext, paramSessionInfo));
        localbfpc.show();
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    if (bduf.b(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString)) {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        localObject = ((akdh)localObject).c(paramSessionInfo.jdField_a_of_type_JavaLangString);
        if (localObject == null)
        {
          localObject = (ajvr)paramQQAppInterface.getManager(69);
          if (localObject != null)
          {
            localObject = ((ajvr)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
            if (localObject == null)
            {
              if (QLog.isDevelopLevel()) {
              ...
              if ((paramContext instanceof Activity)) {
                localbcqf = new bcqf(paramContext, paramContext.getResources().getDimensionPixelSize(2131298865));
              }
              if (localbcqf != null) {
              ...
              localObject = new NewIntent(paramContext.getApplicationContext(), mxe.class);
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new nba(paramContext, paramQQAppInterface, localbcqf, paramSessionInfo, paramString));
        ...
        return;
        a(paramContext, 2131695569);
        axqy.b(paramQQAppInterface, "CliOper", "", "", "0X80049DF", "GetDetailFalse", 0, 0, "", "", "", "");
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      paramContext = new NewIntent(paramContext.getApplicationContext(), mxe.class);
  ...
  {
    if ((paramQQAppInterface != null) && (myv.a(paramString)) && (myv.b(paramString)))
    {
  ...
  public static String b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      str = bduf.a(paramQQAppInterface, paramString);
    }
    label25:
    do
    {
  ...
  private static void b(int paramInt, bcqf parambcqf)
  {
    if (parambcqf != null)
    {
      parambcqf.c(paramInt);
      parambcqf.show();
    }
  }
  
  private static void b(bcqf parambcqf)
  {
  ...
  private static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, PublicAccountInfo paramPublicAccountInfo, EqqDetail paramEqqDetail, String paramString)
  {
    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if ((paramContext instanceof Activity)) {
          paramPublicAccountInfo = new bcqf(paramContext, paramContext.getResources().getDimensionPixelSize(2131298865));
        }
        if (paramPublicAccountInfo != null) {
          paramPublicAccountInfo.setCanceledOnTouchOutside(true);
        }
        NewIntent localNewIntent = new NewIntent(paramContext.getApplicationContext(), nor.class);
        ...
        localNewIntent.setObserver(new nbb(paramContext, paramQQAppInterface, paramPublicAccountInfo, paramEqqDetail, paramSessionInfo, paramString));
        paramQQAppInterface.startServlet(localNewIntent);
      }
      try
      {
        if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing())) {
          a(2131695620, paramPublicAccountInfo);
        }
        label257:
        if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      new bcqr(paramContext).a(2131693459, paramContext.getResources().getDimensionPixelSize(2131298865), 0, 1);
      return;
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, EqqDetail paramEqqDetail)
  {
    ...
    ajvr localajvr = (ajvr)paramQQAppInterface.getManager(69);
    if (localajvr != null) {
      localajvr.a(paramEqqDetail);
    }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (boolean bool1 = false;; bool1 = false)
    {
      ...
      if ((localObject != null) && (((ajvr)localObject).a(paramString) != null))
      {
        if (QLog.isColorLevel()) {
  ...
  private static void c(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    {
      if (i == 0) {
        axqy.b(paramQQAppInterface, "CliOper", "", "", "0X8004628", "0X8004628", 0, 0, "", "", "", "");
      }
      if (paramSessionInfo.jdField_a_of_type_Int != 1008) {
        paramSessionInfo.jdField_a_of_type_Int = 1024;
      }
      acxs.a(paramQQAppInterface, paramContext, paramSessionInfo, true, paramString, null);
      return;
    }
  }
  ...
  {
    if (!((ajxl)paramQQAppInterface.getManager(51)).b(paramString2)) {}
    for (;;)
    {
      return;
      try
      {
        ...
        {
          ((bdvn)paramQQAppInterface.a(85)).a(Long.valueOf(paramString1).longValue(), Long.valueOf(paramString2).longValue());
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  private static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if (paramInt == 1024)
    {
      ...
      {
        if (((akdh)localManager).c(paramString) != null) {}
        for (bool1 = true;; bool1 = true)
        {
          ...
          if (((ajvr)paramQQAppInterface).a(paramString) == null) {
            break label157;
          }
        }
        label157:
