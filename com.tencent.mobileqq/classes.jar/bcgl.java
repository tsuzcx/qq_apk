...
public class bcgl
{
  private static final LRULinkedHashMap<String, bcgm> jdField_a_of_type_ComTencentUtilLRULinkedHashMap = new LRULinkedHashMap(4);
  private static WeakReference<xli> jdField_a_of_type_MqqUtilWeakReference;
  
  public static bcgm a(String paramString)
  {
    if (AppSetting.g) {
      return null;
    }
    ...
    for (paramString = null;; paramString = (bcgm)jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString))
    {
      String str;
      if (paramString != null)
      {
  ...
  public static boolean a(String paramString)
  {
    ...
    //   9: ireturn
    //   10: aload_0
    //   11: invokestatic 55	bcgl:a	(Ljava/lang/String;)Lbcgm;
    //   14: ifnull +19 -> 33
    ...
    //   71: lstore 4
    //   73: getstatic 89	mzb:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   76: ifnull +42 -> 118
    //   79: getstatic 89	mzb:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   82: aload 14
    //   84: invokevirtual 95	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   87: ifeq +31 -> 118
    //   90: getstatic 89	mzb:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   93: aload 14
    ...
    //   125: aload 14
    //   127: invokestatic 106	mzh:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   186: astore 12
    //   188: aload 12
    //   190: invokestatic 137	nap:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   193: astore 13
    //   195: getstatic 89	mzb:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   198: aload 14
    //   200: aload 13
    ...
    //   272: astore 12
    //   274: aload_0
    //   275: invokestatic 33	mzb:d	(Ljava/lang/String;)Ljava/lang/String;
    //   278: astore 15
    //   280: aload 15
    //   282: ifnonnull +5 -> 287
    //   285: iconst_0
    ...
    //   299: lstore 8
    //   301: getstatic 158	bcgl:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    //   304: ifnull +12 -> 316
    //   307: getstatic 158	bcgl:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   358: invokespecial 190	xli:<init>	(Lcom/tencent/common/app/AppInterface;)V
    //   361: astore 12
    //   363: new 160	mqq/util/WeakReference
    //   366: dup
    //   367: aload 12
    //   369: invokespecial 193	mqq/util/WeakReference:<init>	(Ljava/lang/Object;)V
    //   372: putstatic 158	bcgl:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    //   375: goto +558 -> 933
    //   378: aload 12
    //   380: instanceof 185
    //   383: ifeq +509 -> 892
    ...
    //   395: invokespecial 190	xli:<init>	(Lcom/tencent/common/app/AppInterface;)V
    //   398: astore 12
    //   400: goto -37 -> 363
    //   403: getstatic 158	bcgl:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    //   406: invokevirtual 163	mqq/util/WeakReference:get	()Ljava/lang/Object;
    //   409: checkcast 187	xli
    //   412: astore 12
    //   414: goto +519 -> 933
    //   417: aload 12
    //   419: aload 13
    //   421: invokevirtual 196	xli:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/OfflineWebRes;
    //   424: astore 12
    ...
    //   654: aload 14
    //   656: astore 13
    //   658: getstatic 19	bcgl:jdField_a_of_type_ComTencentUtilLRULinkedHashMap	Lcom/tencent/util/LRULinkedHashMap;
    //   661: aload 15
    //   663: new 41	bcgm
    //   666: dup
    //   667: aload 12
    //   669: aload 16
    //   671: ldc_w 256
    //   674: invokespecial 262	bcgm:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   778: aload_0
    //   779: invokestatic 33	mzb:d	(Ljava/lang/String;)Ljava/lang/String;
