...
final class bcgl
  implements alzv
{
  bcgl(String paramString1, String paramString2, boolean paramBoolean, QQAppInterface paramQQAppInterface, bcgm parambcgm) {}
  ...
  public void a(TroopMemberInfo paramTroopMemberInfo)
  {
    ...
    for (Object localObject = "";; localObject = Integer.valueOf(paramTroopMemberInfo.hwIdentity))
    {
      ...
      try
      {
        ...
        ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1, l2, true);
        return;
      }
    ...
    label216:
    if (!bcgk.a(paramTroopMemberInfo.hwIdentity))
    {
      ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).d(this.jdField_a_of_type_JavaLangString, this.b);
      return;
    }
    bcgk.a(this.jdField_a_of_type_Bcgm, paramTroopMemberInfo.level);
  }
}
