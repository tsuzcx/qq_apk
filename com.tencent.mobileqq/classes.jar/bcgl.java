...
public class bcgl
{
  ...
  /* Error */
  public static bcgl a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   145: aload 9
    //   147: iload 4
    //   149: invokespecial 82	bcgk:<init>	(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    //   181: new 2	bcgl
    //   184: dup
    //   185: invokespecial 93	bcgl:<init>	()V
    //   188: astore 6
    //   190: aload 6
    //   192: aload 7
    //   194: putfield 17	bcgl:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   197: iload_3
    //   198: iconst_1
    ...
    //   205: aload 6
    //   207: iload 5
    //   209: putfield 95	bcgl:jdField_a_of_type_Boolean	Z
  ...
  private void a()
  {
    bcgk localbcgk1 = new bcgk(1, "龙王", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150116_n4PxCiurbm.png", 1);
    bcgk localbcgk2 = new bcgk(2, "群聊之火", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150231_zLczuKN4tp.png", 2);
    bcgk localbcgk3 = new bcgk(3, "群聊炽焰", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150305_AJiyOgHCDg.png", 3);
    bcgk localbcgk4 = new bcgk(4, "冒尖小春笋", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150335_tUJCAtoKVP.png", 4);
    bcgk localbcgk5 = new bcgk(5, "茁壮小春笋", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150408_nw0sOEFzqw.png", 5);
    bcgk localbcgk6 = new bcgk(6, "快乐源泉", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150434_3tDmsJExCP.png", 6);
    a(localbcgk1);
    a(localbcgk2);
    a(localbcgk3);
    a(localbcgk4);
  ...
  public bcgk a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null) {
      return (bcgk)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.put(parambcgk.a, parambcgk);
    }
  }
