        ...
        if ((paramObject != null) && (localObject1 != null))
        {
          ...
          try
          {
            ...
            if (paramInt <= k)
            {
              ...
              m = twr.a((AdvertisementInfo)localObject3);
              String str = twr.a((AdvertisementInfo)localObject3);
              ...
              if ((localObject2 == null) || (!(localObject2 instanceof tyx))) {
                break label717;
              }
              ((tyx)localObject2).a(true, (AdvertisementInfo)localObject3, paramVarArgs);
            }
          }
