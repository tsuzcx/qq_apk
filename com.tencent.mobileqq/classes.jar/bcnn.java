  ...
  implements bcnv
{
  ...
  private static Map<String, bcnm> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(LoadParam.LoadItem paramLoadItem, @NonNull SoLoadInfo paramSoLoadInfo)
  {
    ...
    if (j == 0)
    {
      ...
      bcod.a(paramLoadItem, paramSoLoadInfo.soPathToLoad);
      bcod.a(paramLoadItem, paramSoLoadInfo);
      bcod.a(paramLoadItem.name);
      i = j;
    }
    label116:
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        catch (Throwable paramString)
        {
          ...
          this.jdField_a_of_type_JavaLangString = akww.a(paramString);
        }
      }
    }
    return 6;
  ...
  private LoadExtResult a(int paramInt, String paramString)
  {
    ...
    {
      bcnm localbcnm = (bcnm)jdField_a_of_type_JavaUtilMap.get(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name);
      paramString = localbcnm;
      if (localbcnm == null) {
        paramString = new bcnm();
      }
      boolean bool = bgnt.d(BaseApplicationImpl.getApplication());
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mCallType == LoadParam.CALL_TYPE_SYNC) {
      localLoadExtResult.failInfo = ((bcnm)jdField_a_of_type_JavaUtilMap.get(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name));
    }
    if (this.jdField_a_of_type_Bcob != null) {
      this.jdField_a_of_type_Bcob.a(paramInt, localLoadExtResult);
    }
    ...
    for (;;)
    {
      bcst.b(null, "dc00899", "SoLoad", "", "resSingle", this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mCallType, paramInt, this.jdField_a_of_type_ComTencentMobileqqSoloadSoLoadInfo.getVer(), i + "", l1 - l2 + "", "");
  ...
  private void a(boolean paramBoolean, String paramString1, String paramString2, LoadParam.LoadItem paramLoadItem)
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      paramLoadItem.append(BaseApplicationImpl.processName).append("_").append(akww.c(paramString2));
      if (QLog.isColorLevel()) {
  ...
  private boolean b(LoadParam.LoadItem paramLoadItem)
  {
    ...
    {
      String str = bcod.a(paramLoadItem);
  ...
  public LoadExtResult a(LoadParam paramLoadParam)
  {
    ...
    return a(a(new bcnu(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem).a()));
  }
  
  public void a(LoadParam paramLoadParam, bcob parambcob)
  {
    b(paramLoadParam, parambcob);
    if (a())
    {
      a(0);
      return;
    }
    new bcnp(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem).a(new bcno(this));
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      bcoc.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, this.jdField_a_of_type_ComTencentMobileqqSoloadSoLoadInfo.getVer(), 0);
      return;
