  ...
  extends MSFServlet
{
  public void a()
  {
    ...
    localObject1 = new NewIntent(localQQAppInterface.getApp(), bajc.class);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    bakl.a("AssistantServlet", "AssistantServlet#onReceive, oidbCode:" + i);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bakl.a("AssistantServlet", String.format("oidbHeader:%s, error:%s", new Object[] { Integer.valueOf(paramIntent.uint32_result.get()), paramIntent.str_error_msg.get() }));
        ...
        bakl.a("AssistantServlet", "ret code:" + i);
        return;
      }
      catch (InvalidProtocolBufferMicroException paramIntent)
      {
        for (;;)
        {
          bakl.a("AssistantServlet", paramIntent.getMessage());
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bakl.a("AssistantServlet", "AssistantServlet#onSend");
  }
}
