  ...
  implements bngj
{
  ...
  private void a(bnoq parambnoq)
  {
    int i = 0;
    if (TextUtils.isEmpty(parambnoq.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (TextUtils.isEmpty(parambnoq.jdField_a_of_type_JavaLangString)) {
      i = 101;
    ...
    while (i != 0)
    {
      ...
      try
      {
        ...
        localJSONObject2.put("id", parambnoq.jdField_a_of_type_Int);
        localJSONObject2.put("url", "");
        localJSONObject1.put("data", localJSONObject2);
        localJSONObject1.put("msg", "");
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(parambnoq.c, new String[] { localJSONObject1.toString() });
        return;
      }
      catch (JSONException parambnoq)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "JSONException error !", parambnoq);
        return;
        parambnoq.d = bnoo.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), parambnoq.jdField_a_of_type_JavaLangString);
        if ((!TextUtils.isEmpty(parambnoq.d)) && (new File(parambnoq.d).exists()))
        {
          this.jdField_a_of_type_JavaUtilMap.put(parambnoq.d, Integer.valueOf(parambnoq.jdField_a_of_type_Int));
          if (!bnoo.a(parambnoq.d, parambnoq.b)) {
            i = 102;
          }
        }
        else
      ...
      catch (Exception parambnoq)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "parentPlugin.callJs error !", parambnoq);
      }
    }
  }
  ...
  protected void a(String... paramVarArgs)
  {
    ...
    //   30: invokespecial 202	bnoq:<init>	(Lbnop;I)V
    //   33: astore_1
    //   34: aload_1
    //   35: aload_2
    //   36: ldc 204
    //   38: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   41: putfield 42	bnoq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   44: aload_1
    //   45: aload_2
    //   46: ldc 206
    //   48: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   51: putfield 156	bnoq:b	Ljava/lang/String;
    //   54: aload_1
    //   55: aload_2
    //   56: ldc 184
    //   58: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   61: putfield 103	bnoq:c	Ljava/lang/String;
    //   64: aload_1
    //   65: ifnull +26 -> 91
    //   68: aload_0
    //   69: getfield 31	bnop:jdField_b_of_type_JavaUtilMap	Ljava/util/Map;
    //   72: aload_1
    //   73: getfield 86	bnoq:jdField_a_of_type_Int	I
    ...
    //   86: aload_0
    //   87: aload_1
    //   88: invokespecial 208	bnop:a	(Lbnoq;)V
    //   91: return
    //   92: astore_2
    //   93: aconst_null
    //   94: astore_1
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (bnoq)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(j));
    if (paramBundle == null)
    {
