  ...
  implements BusinessObserver
{
  ...
  public anel(QQAppInterface paramQQAppInterface)
  {
        ...
        if (localObject2 != null) {
          if (6129 == ((Conch)localObject2).cmdId)
          {
            ...
            else
            {
              ...
              bhnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), i, (String)localObject2);
              bhnr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
          else if (6142 == ((Conch)localObject2).cmdId)
          {
            ...
            else
            {
              ...
              bhnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), (String)localObject2);
              bhnr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), System.currentTimeMillis());
            }
          }
        }
  ...
  public void a(anem paramanem)
  {
    this.jdField_a_of_type_Anem = paramanem;
  }
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Anem != null) {
        this.jdField_a_of_type_Anem.a(paramInt);
      }
      return;
      try
      {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bhnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramObject);
          continue;
          paramObject = (bhnt)paramObject;
          a(paramObject.jdField_a_of_type_MConchSCPullConchs);
          if (this.jdField_a_of_type_Anem != null) {
            this.jdField_a_of_type_Anem.a(paramObject.jdField_a_of_type_MWIFISCGet3rdCloudCheck);
          }
        }
      }
    }
