...
public class avhf
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    avhg.a(paramQQAppInterface, 0, paramString, false);
    a(paramQQAppInterface, 0, paramString, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bdyi parambdyi)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (parambdyi != null) {}
      for (paramQQAppInterface = parambdyi.a;; paramQQAppInterface = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("elemType:LbsShareMsg;\n");
      }
      paramList = (MessageForLocationShare)bbli.a(-2076);
      paramList.msgtype = -2076;
      paramList.msg = BaseApplicationImpl.context.getString(2131718576);
  ...
  {
    avhg.a(paramQQAppInterface, 1, paramString, false);
