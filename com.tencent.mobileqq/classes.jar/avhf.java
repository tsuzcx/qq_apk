...
public class avhf
  implements apym, Manager
{
  static int jdField_a_of_type_Int = 3600;
  public long a;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  protected Handler a;
  private avhl jdField_a_of_type_Avhl;
  public String a;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  public Vector<avhk> a;
  ...
  public avhf(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilVector = new Vector();
    this.jdField_a_of_type_AndroidOsHandler = new avhg(this, Looper.getMainLooper());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        a("https://openmobile.qq.com/gameteam/get_team_context?uin=" + paramQQAppInterface.getCurrentAccountUin(), new avhh(this));
        this.jdField_a_of_type_Avhl = ((avhl)a());
        apyl.a("com.tencent.qqopen.teamup", this);
        return;
        i = 0;
      }
  ...
  private void a(SubMsgType0xaa.GameTeam_TurnOverMessage paramGameTeam_TurnOverMessage, boolean paramBoolean)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  this.jdField_c_of_type_Int = j;
                  this.e = k;
                  this.jdField_a_of_type_Avhl.setChanged();
                  this.jdField_a_of_type_Avhl.notifyObservers(Integer.valueOf(2));
                  return;
                  if (!bool2) {
                    break;
                  }
      ...
      if (localObject == null)
      {
        this.jdField_a_of_type_JavaUtilVector.add(new avhk(this, this.f, this.jdField_c_of_type_JavaLangString));
        this.jdField_a_of_type_JavaLangString = str1;
        this.jdField_b_of_type_Int = i;
        this.jdField_c_of_type_Int = j;
        this.jdField_a_of_type_Long = l;
      ...
      while (paramGameTeam_TurnOverMessage.hasNext())
      {
        ...
        if ((((SubMsgType0xaa.InviteSource)localObject).type.has()) && (((SubMsgType0xaa.InviteSource)localObject).src.has()))
        {
          ...
          {
            localObject = new avhk(this, b(m), (String)localObject);
    ...
    this.jdField_a_of_type_JavaUtilVector.clear();
    if (localObject == null) {
      this.jdField_a_of_type_JavaUtilVector.add(new avhk(this, b(m), str3));
    }
    for (;;)
    {
      this.jdField_a_of_type_Avhl.setChanged();
      ...
      while (paramGameTeam_TurnOverMessage.hasNext())
      {
        ...
        if ((((SubMsgType0xaa.InviteSource)localObject).type.has()) && (((SubMsgType0xaa.InviteSource)localObject).src.has()))
        {
          ...
          {
            localObject = new avhk(this, b(i), (String)localObject);
            this.jdField_a_of_type_JavaUtilVector.add(localObject);
          }
        }
      }
  ...
  private void b(SubMsgType0xaa.GameTeam_TurnOverMessage paramGameTeam_TurnOverMessage)
  {
    ...
    if (bool)
    {
      paramGameTeam_TurnOverMessage = localQQAppInterface.getApp().getString(2131692704);
      switch (j)
      {
      case 5: 
      default: 
        return;
      case 1: 
        localObject1 = localQQAppInterface.getApp().getString(2131692717);
      }
    }
    for (;;)
    {
      String str3 = localQQAppInterface.getApp().getString(2131692719);
      paramGameTeam_TurnOverMessage = paramGameTeam_TurnOverMessage + (String)localObject1 + str3;
      localObject1 = (MessageForGrayTips)bcsa.a(-2049);
      ...
      localQQAppInterface.getMessageFacade().addMessage((MessageRecord)localObject1, localQQAppInterface.getCurrentAccountUin());
      bjgx.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2011", "0", false);
      return;
      switch (k)
      {
      default: 
        ...
        break;
      case 0: 
        paramGameTeam_TurnOverMessage = ContactUtils.getDisplayName(localQQAppInterface, str1, (String)localObject2, 0, 0);
        break;
      case 1: 
        paramGameTeam_TurnOverMessage = ContactUtils.getDisplayName(localQQAppInterface, str1, (String)localObject2, 1, 0);
        break;
      case 3000: 
        paramGameTeam_TurnOverMessage = ContactUtils.getDisplayName(localQQAppInterface, str1, (String)localObject2, 2, 0);
        break;
        localObject1 = localQQAppInterface.getApp().getString(2131692720);
        continue;
        localObject1 = localQQAppInterface.getApp().getString(2131692710);
        continue;
        localObject1 = localQQAppInterface.getApp().getString(2131692718);
      }
    }
  }
  ...
  public Observable a()
  {
    if (this.jdField_a_of_type_Avhl == null) {
      this.jdField_a_of_type_Avhl = new avhl();
    }
    return this.jdField_a_of_type_Avhl;
  }
  ...
  public void a()
  {
    ...
    if (l1 > 0L)
    {
      ...
      {
        this.jdField_a_of_type_Avhl.setChanged();
        this.jdField_a_of_type_Avhl.notifyObservers(Integer.valueOf(1));
      }
      this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(localMessage, l1 * 1000L + 30000L);
    }
  }
  
  public void a(String paramString, avhj paramavhj)
  {
    ThreadManager.post(new GamePartyManager.4(this, paramString, paramavhj), 5, null, false);
  }
  ...
  protected void a(SubMsgType0xaa.GameTeam_StartGameMessage paramGameTeam_StartGameMessage, boolean paramBoolean)
  {
    ...
    for (l1 -= l2;; l1 = l2 - l1)
    {
      ...
      a("https://openmobile.qq.com/gameteam/get_team_info?uin=" + localQQAppInterface.getCurrentAccountUin() + "&team_list=" + (String)localObject, new avhi(this, l1, paramGameTeam_StartGameMessage, l2, paramBoolean));
      return;
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramInt >= 0) && (!TextUtils.isEmpty(paramString)))
    {
      if (((QQAppInterface)localObject).getCurrentAccountUin().equals(this.jdField_b_of_type_JavaLangString))
      {
        ...
        do
        {
          ...
          localavhk = (avhk)((Iterator)localObject).next();
        } while ((paramInt != localavhk.jdField_a_of_type_Int) || (!paramString.equals(localavhk.jdField_a_of_type_JavaLangString)));
        return true;
      }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Avhl.setChanged();
      this.jdField_a_of_type_Avhl.notifyObservers(Integer.valueOf(3));
    }
    c();
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
  }
  ...
  public void onDestroy()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localEditor.commit();
        apyl.a("com.tencent.qqopen.teamup");
        return;
      }
      catch (JSONException localJSONException)
      {
