...
public class bnyl
{
  ...
  private bnyo jdField_a_of_type_Bnyo = new bnyo();
  ...
  private HashMap<String, String> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if ((this.jdField_d_of_type_Int == 4) || (this.jdField_d_of_type_Int == 5) || (this.jdField_d_of_type_Int == 6) || (this.jdField_d_of_type_Int == 7) || (this.jdField_d_of_type_Int == 2))
    {
      ...
      localHashMap.put("cameraId", bnyk.a(alin.jdField_a_of_type_Int));
      if (jdField_g_of_type_JavaLangLong.longValue() != 1L) {
        break label427;
      }
      localHashMap.put("resolution", bnlm.a.d());
    }
    for (;;)
    {
      ...
      if (jdField_g_of_type_JavaLangLong.longValue() == 2L) {
        localHashMap.put("resolution", bnlm.a.g());
      } else {
  ...
  public bnyo a()
  {
    return this.jdField_a_of_type_Bnyo;
  }
  ...
  public String a()
  {
    ...
    return bisz.a(localStringBuilder.toString());
  }
  ...
  public HashMap<String, String> a(int paramInt)
  {
    ...
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_b_of_type_Long));
    localHashMap.put("MD5", this.jdField_a_of_type_Bnyo.jdField_a_of_type_JavaLangString);
    Object localObject2 = (String)this.jdField_a_of_type_Bnyo.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    Object localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = "none";
    }
    localHashMap.put("filter_id", localObject1);
    localObject1 = (Float)this.jdField_a_of_type_Bnyo.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    ...
    for (localObject1 = "none";; localObject1 = String.valueOf(((Float)localObject1).intValue()))
    {
      ...
      localObject2 = (String)this.jdField_a_of_type_Bnyo.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
      localObject1 = localObject2;
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = "none";
      }
      localHashMap.put("color_type", localObject1);
      localObject2 = (String)this.jdField_a_of_type_Bnyo.jdField_c_of_type_AndroidUtilSparseArray.get(paramInt);
      localObject1 = localObject2;
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = "none";
      }
      localHashMap.put("ai_color_frame_states", localObject1);
      localObject2 = (String)this.jdField_a_of_type_Bnyo.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
      localObject1 = localObject2;
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = "none";
      }
      ...
      localHashMap.put("video_id", this.jdField_a_of_type_Bnyo.jdField_a_of_type_JavaLangString);
      localObject2 = (Integer)this.jdField_a_of_type_Bnyo.jdField_c_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
      localObject1 = localObject2;
  ...
  public HashMap<String, String> a(long paramLong)
  {
    ...
    for (;;)
    {
      localHashMap.put("duration", bnyk.a(Long.valueOf(System.currentTimeMillis() - paramLong)));
      localHashMap.put("cameraId", bnyk.a(alin.jdField_a_of_type_Int));
      if (jdField_g_of_type_JavaLangLong.longValue() != 1L) {
        break label242;
      }
  ...
  public HashMap<String, String> a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.jdField_h_of_type_JavaLangString == null) || (!this.jdField_h_of_type_JavaLangString.equals(paramString)))
      {
        ...
        this.jdField_i_of_type_JavaLangString = bita.d(QQStoryContext.a().getAccount() + bnyk.a());
      }
  ...
  public void a()
  {
    ...
    bnzb.b("AEBaseReportParam", "【operation_time】:" + str);
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("content_type", this.jdField_a_of_type_Bnyo.jdField_b_of_type_Long + "");
    localHashMap.put("MD5", this.jdField_a_of_type_Bnyo.jdField_a_of_type_JavaLangString);
  ...
  public HashMap<String, String> b(long paramLong)
  {
    ...
    if ((this.jdField_d_of_type_Int == 4) || (this.jdField_d_of_type_Int == 5) || (this.jdField_d_of_type_Int == 6) || (this.jdField_d_of_type_Int == 7) || (this.jdField_d_of_type_Int == 2))
    {
      ...
      localHashMap.put("face_uin", this.jdField_d_of_type_JavaLangString + UserAction.getQIMEI());
      label333:
      localHashMap.put("preview_view_size", bnlm.a.a());
      localHashMap.put("configed_preview_resolution", bnlm.a.b());
      localHashMap.put("configed_capture_resolution", bnlm.a.c());
      localHashMap.put("render_resolution", bnlm.a.e());
      if (jdField_g_of_type_JavaLangLong.longValue() != 1L) {
        break label528;
      }
      localHashMap.put("resolution", bnlm.a.d());
      ...
      if (!bnlm.a.jdField_b_of_type_Boolean) {
        break label571;
      }
    }
    label528:
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bnyk.a(Long.valueOf(paramLong)));
    return localHashMap;
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("music_id", this.jdField_a_of_type_Bnyo.jdField_c_of_type_JavaLangString);
    localHashMap.put("video_id", this.jdField_a_of_type_Bnyo.jdField_a_of_type_JavaLangString);
    localHashMap.put("music_value", String.valueOf(paramInt));
    return localHashMap;
  }
  ...
  public HashMap<String, String> e()
  {
    ...
    localHashMap.put("face_id", bnyp.a().a("camera_ad_op_id", "", 4));
    return localHashMap;
  }
  ...
  {
    return bnyk.a(g(), a(paramString, "3"));
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bnyk.a(Long.valueOf(a())));
    return localHashMap;
  }
  ...
  public HashMap<String, String> g()
  {
    ...
    for (String str = bita.d(QQStoryContext.a().getAccount() + bnyk.a());; str = this.jdField_i_of_type_JavaLangString) {
      return a(str, 1, "-1");
    }
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_a_of_type_Long));
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_b_of_type_Long));
    localHashMap.put("MD5", this.jdField_a_of_type_Bnyo.jdField_a_of_type_JavaLangString);
    String str2 = this.jdField_a_of_type_Bnyo.jdField_b_of_type_JavaLangString;
    String str1 = str2;
    if (TextUtils.isEmpty(str2)) {
      str1 = "none";
    }
    localHashMap.put("filter_id", str1);
    localHashMap.put("filter_value", String.valueOf((int)this.jdField_a_of_type_Bnyo.jdField_a_of_type_Float));
    localHashMap.put("music_id", this.jdField_a_of_type_Bnyo.jdField_c_of_type_JavaLangString);
    str2 = (String)this.jdField_a_of_type_Bnyo.jdField_a_of_type_AndroidUtilSparseArray.get(0);
    str1 = str2;
    if (TextUtils.isEmpty(str2)) {
      str1 = "none";
    }
    localHashMap.put("color_type", str1);
    str2 = (String)this.jdField_a_of_type_Bnyo.jdField_b_of_type_AndroidUtilSparseArray.get(0);
    str1 = str2;
    if (TextUtils.isEmpty(str2)) {
      str1 = "none";
    }
    localHashMap.put("text_item_id", str1);
    localHashMap.put("sound_type", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_a_of_type_Int));
    localHashMap.put("text_count", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_d_of_type_Int));
    localHashMap.put("music_list", this.jdField_a_of_type_Bnyo.jdField_e_of_type_JavaLangString);
    localHashMap.put("video_id", this.jdField_a_of_type_Bnyo.jdField_a_of_type_JavaLangString);
    localHashMap.put("music_common_info", this.jdField_a_of_type_Bnyo.jdField_d_of_type_JavaLangString);
    localHashMap.put("lyric_status", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_f_of_type_Int));
    if (this.jdField_a_of_type_Bnyo.jdField_a_of_type_Boolean) {}
    for (str1 = "1";; str1 = "0")
    {
      localHashMap.put("is_recommend", str1);
      localHashMap.put("recommend_index", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_b_of_type_Int));
      localHashMap.put("music_duration", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_c_of_type_Int));
      localHashMap.put("video_duration", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_a_of_type_Long));
      localHashMap.put("video_source", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_e_of_type_Int));
      localHashMap.put("face_id", this.jdField_c_of_type_JavaLangString);
      localHashMap.put("change_speed_type", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_a_of_type_Double));
      return localHashMap;
    }
  }
  ...
  public HashMap<String, String> i()
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("content_type", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_b_of_type_Long));
    localHashMap.put("red_point", String.valueOf(this.jdField_a_of_type_Bnyo.h));
    return localHashMap;
  }
  ...
  public void j()
  {
    ...
    localStringBuilder.append(" ");
    localStringBuilder.append(str);
    this.n = bisz.a(localStringBuilder.toString());
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("color_type", this.jdField_a_of_type_Bnyo.jdField_f_of_type_JavaLangString);
    localHashMap.put("text_item_id", this.jdField_a_of_type_Bnyo.jdField_g_of_type_JavaLangString);
    localHashMap.put("common_color_list", String.valueOf(this.jdField_a_of_type_Bnyo.jdField_g_of_type_Int));
    return localHashMap;
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration_first_frame", bnyk.a(Long.valueOf(this.jdField_d_of_type_Long - this.jdField_c_of_type_Long)));
    localHashMap.put("duration_bottom_bar", bnyk.a(Long.valueOf(this.jdField_e_of_type_Long - this.jdField_c_of_type_Long)));
    localHashMap.put("duration_photo_btn", bnyk.a(Long.valueOf(this.jdField_f_of_type_Long - this.jdField_c_of_type_Long)));
    String str;
    if (bnyk.b()) {
      str = "first_launch";
    }
  ...
  public HashMap<String, String> t()
  {
    ...
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bnyk.a(Long.valueOf(l1 - l2)));
    return localHashMap;
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bnyk.a(Long.valueOf(this.jdField_i_of_type_Long)));
