...
public class uwf
  extends nyr
{
  public uwf(PublicAccountImageCollectionMainActivity paramPublicAccountImageCollectionMainActivity) {}
  ...
  public void a(uwr paramuwr)
  {
    ...
    PublicAccountImageCollectionMainActivity.a(this.a, paramuwr);
    if (paramuwr == null)
    {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      oat.a(null, this.a.jdField_a_of_type_JavaLangString, "0X8007B97", "0X8007B97", 0, 0, this.a.b, this.a.c, "" + i, "", false);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, ArrayList<uwu> paramArrayList)
  {
    if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean, uwr paramuwr, byte[] paramArrayOfByte, String paramString)
  {
    ...
    if (paramBoolean) {
      if ((paramString != null) && (!paramString.equals(this.a.b)))
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.pubaccount.video.PublicAccountArticleObserver", 2, "onGetPhotoCollectionInfoRespond isSuccess=" + paramBoolean + " ;articleID = " + paramuwr.jdField_a_of_type_JavaLangString);
          }
          PublicAccountImageCollectionPreloadManager.a().a(paramuwr, paramArrayOfByte);
          PublicAccountImageCollectionPreloadManager.a().b(paramuwr);
        }
        if ((paramuwr == null) || (paramuwr.jdField_a_of_type_JavaUtilArrayList == null)) {
          break label308;
        }
      }
    }
    label308:
    for (int i = paramuwr.jdField_a_of_type_JavaUtilArrayList.size();; i = 0)
    {
      oat.a(null, this.a.jdField_a_of_type_JavaLangString, "0X8007B8A", "0X8007B8A", 0, 0, this.a.b, this.a.c, "" + PublicAccountImageCollectionMainActivity.b(this.a, PublicAccountImageCollectionMainActivity.a(this.a)), "" + i, false);
      return;
      PublicAccountImageCollectionMainActivity.a(this.a, paramuwr);
      if (paramuwr == null)
      {
