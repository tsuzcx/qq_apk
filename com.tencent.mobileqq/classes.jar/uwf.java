...
class uwf
  implements azla
{
  uwf(uwe paramuwe, MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface, anyz paramanyz, boolean paramBoolean) {}
  ...
  public void onSend(azlb paramazlb)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing))
        {
          ...
          localObject1 = bcrx.a(localMessageForStructing);
          if (localObject1 == null) {
            break label283;
          }
          localObject2 = ((im_msg_body.RichText)localObject1).elems.get();
          if (QLog.isColorLevel()) {
            QLog.d("ShareStructLongMessageManager", 2, "current uid is" + paramazlb.c);
          }
          ...
          {
            ((im_msg_body.Elem)localObject3).rich_msg.bytes_msg_resid.set(ByteStringMicro.copyFrom(paramazlb.c.getBytes()));
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ShareStructLongMessageManager", 2, "upload  msg pack failed, catch exception", paramazlb);
        }
        this.jdField_a_of_type_Uwe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
      }
    ...
    {
      label283:
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().sendMessage(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.jdField_a_of_type_Anyz, this.jdField_a_of_type_Boolean);
      return;
      label306:
      ...
      if ((localObject1 != null) && (uwe.b(localMessageForStructing.structingMsg)))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            ((im_msg_body.Elem)localObject2).rich_msg.bytes_msg_resid.set(ByteStringMicro.copyFrom(paramazlb.c.getBytes()));
    ...
    label541:
    if (QLog.isColorLevel()) {
      QLog.d("ShareStructLongMessageManager", 2, "upload  msg pack failed, result.errStr=" + paramazlb.b + ",result.errStr=" + paramazlb.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Uwe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  }
