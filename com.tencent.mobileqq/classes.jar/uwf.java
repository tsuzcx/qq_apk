...
public class uwf
  extends uxo<GeneralFeedItem>
{
  public boolean a;
  
  public uwf(@NonNull GeneralFeedItem paramGeneralFeedItem)
  {
  ...
  public boolean a(qqstory_struct.StoryFeed paramStoryFeed)
  {
    ...
    ved.a("Q.qqstory.home.data.GeneralHomeFeed", "GeneralHomeFeed convertFrom, feedSourceType:%s, feedId:%s", Integer.valueOf(((GeneralFeedItem)this.a).feedSourceTagType), ((GeneralFeedItem)this.a).feedId);
