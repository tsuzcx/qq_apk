...
public class olo
  extends aoeg
{
  public olo(ReadInJoySettingActivity paramReadInJoySettingActivity) {}
  ...
  public void onSetPublicAccountSubscribeStatus(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    if ((this.a.jdField_a_of_type_Int == 0) && (this.a.jdField_a_of_type_Bjbs != null) && (this.a.jdField_a_of_type_Bjbs.isShowing())) {
    ...
    if (paramInt == this.a.b)
    {
      ...
      ocd.a(null, "CliOper", "", "", "0X80067D5", "0X80067D5", 0, 0, "", "", "", ozs.e(), false);
      label147:
    ...
    for (;;)
    {
      ...
      break;
      label173:
      ocd.a(null, "CliOper", "", "", "0X800676D", "0X800676D", 0, 0, "", "", "", ozs.e(), false);
      break label147;
      label202:
      QQToast.a(this.a.getApplicationContext(), 2131698578, 0).a();
      this.a.c = true;
