...
{
  public static int a;
  public static SparseArray<zzo> a;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidUtilSparseArray.put(1, new zzo(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(4, new zzo(0.001F, 100, 10, 0.01F, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(6, new zzo(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(7, new zzo(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(14, new zzo(0.001F, 100, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(9, new zzo(0.001F, 85, 10, 0.1F, 6));
    jdField_a_of_type_AndroidUtilSparseArray.put(16, new zzo(0.001F, 100, 10, 0.1F, 6));
  ...
  public static void a()
  {
    ...
    {
      SparseArray localSparseArray = MagnifierSDK.jdField_a_of_type_Aaag.a();
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        if (((String)localObject).startsWith("p_"))
        {
          ...
          zzo localzzo = (zzo)jdField_a_of_type_AndroidUtilSparseArray.get(n);
          f1 = localzzo.jdField_a_of_type_Float;
          j = localzzo.jdField_a_of_type_Int;
          k = localzzo.jdField_b_of_type_Int;
          f2 = localzzo.jdField_b_of_type_Float;
          m = localzzo.c;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              localObject = new zzo(f1, j, k, f2, m);
              ...
              MagnifierSDK.jdField_a_of_type_Aaag.a(jdField_a_of_type_AndroidUtilSparseArray);
              return;
            }
          }
        }
