...
public class ahji
{
  ...
  public static Map<String, akoi> a;
  ...
  {
    awqx.b(null, "dc00898", "", "", "0X80072C1", "0X80072C1", 0, 0, "", "", "", "");
  }
  ...
  public static void a(int paramInt)
  {
    ...
    awrn.a(BaseApplication.getContext()).a(null, "acQQFilterDownload", true, 0L, 0L, localHashMap, null);
  }
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    awrn.a(BaseApplicationImpl.getApplication()).a(null, "actSetPreviewSizeWay", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(int paramInt, long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    for (String str = "back";; str = "front")
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "cameraStartTimeCost", true, 0L, 0L, localHashMap, null);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      paramString3 = ((akoi)localEntry.getValue()).a();
    ...
    for (;;)
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "dynamic_adjustment_on_destroy", true, paramString1.jdField_a_of_type_ArrayOfLong[((int)(paramString1.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
      a(localHashMap, "DynamicAdjustment", "dynamic_adjustment_on_destroy");
      return;
    }
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, akoj paramakoj)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("camera_type", paramString1);
    ...
    localHashMap.put("is_dynamic", VideoEnvironment.a.d + "");
    if ((paramakoj == null) || (paramakoj.jdField_a_of_type_ArrayOfLong == null) || (paramakoj.jdField_a_of_type_ArrayOfLong.length == 0)) {
      return;
    }
    localHashMap.put("cost_time", paramakoj.jdField_a_of_type_ArrayOfLong[((int)(paramakoj.jdField_a_of_type_ArrayOfLong.length * 0.5F))] + "");
    awrn.a(BaseApplication.getContext()).a(null, "dynamic_adjustment_on_triggering", true, paramakoj.jdField_a_of_type_ArrayOfLong[((int)(paramakoj.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
  ...
  private static void a(String paramString1, String paramString2, HashMap<String, String> paramHashMap)
  {
    ...
    for (paramString1 = new HashMap();; paramString1 = paramHashMap)
    {
      ...
      paramString1.put("DEVICE_TYPE_NAME", alrf.a().a());
      a(paramString1, "open_custom_camera", paramString2);
      awrn.a(BaseApplicationImpl.getApplication()).a(null, paramString2, true, 0L, 0L, paramString1, null);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (String str = "0"; (!baip.a(paramString1)) || (!alrg.a()); str = "1")
    {
      awqx.b(null, "dc00898", "", "", "0X80072C3", "0X80072C3", 0, 0, str, paramString1, "", "");
      if (paramBoolean) {
        awqx.b(null, "dc00898", "", "", "0X80083B0", "0X80083B0", 0, 0, str, paramString1, "", "");
      }
      if (!baip.a(paramString2)) {
        awqx.b(null, "dc00898", "", "", "0X80083B6", "0X80083B6", 0, 0, paramString1, "", paramString2, "");
      }
      return;
    }
    awqx.b(null, "dc00898", "", "", "0X80072C2", "0X80072C2", 0, 0, str, "", "", "");
  }
  ...
  public static void a(String paramString1, boolean paramBoolean, String paramString2, long paramLong)
  {
    ...
    for (paramString1 = "beauty";; paramString1 = "nBeauty")
    {
      ...
      paramString2 = (akoi)jdField_a_of_type_JavaUtilMap.get(localObject);
      paramString1 = paramString2;
      if (paramString2 == null)
      {
        paramString1 = new akoi(2147483647);
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    awrn.a(BaseApplication.getContext()).a(null, "photo_shot_from_shortvideo", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    awrn.a(BaseApplication.getContext()).a(null, "actSetPhotoClipSize", paramBoolean, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public static void a(boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean2, int paramInt5, boolean paramBoolean3)
  {
    ...
    {
      localawrn.a(null, "actShootPhotoClip", bool, 0L, 0L, localHashMap, "");
      if (QLog.isColorLevel()) {
  ...
  public static void b(int paramInt)
  {
    ...
    awrn.a(BaseApplication.getContext()).a(null, "acQQfilterView", true, 0L, 0L, localHashMap, null);
  }
  ...
  public static void l()
  {
    ...
    while (localIterator.hasNext()) {
      ((akoi)((Map.Entry)localIterator.next()).getValue()).a();
    }
    jdField_a_of_type_JavaLangString = "";
  }
}
