  ...
  extends atxd
{
  ...
  {
    paramString = this.jdField_a_of_type_Atwy.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
    if (paramString == null)
    {
    ...
    this.jdField_a_of_type_Atwy.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString.uniseq, paramString.nSessionId, paramString.peerUin, paramString.peerType, 12, null, 5, null);
  ...
  protected void b(int paramInt)
  {
    ...
    atwy.b(this.jdField_a_of_type_Atwy, 9, 11);
    atwy.c(this.jdField_a_of_type_Atwy, 9, 11);
