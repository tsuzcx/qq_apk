  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  public bfyr mCallback;
  private RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback;
  private List<Integer> mDistances;
  private long mDragScrollStartTimeInMs;
  float mDx;
  float mDy;
  bfyi mGestureDetector;
  float mInitialTouchX;
  float mInitialTouchY;
  float mMaxSwipeVelocity;
  private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new bfyo(this);
  View mOverdrawChild = null;
  int mOverdrawChildPosition = -1;
  final List<View> mPendingCleanup = new ArrayList();
  List<bfyv> mRecoverAnimations = new ArrayList();
  ...
  public bfyn(bfyr parambfyr)
  {
    this.mCallback = parambfyr;
  }
  ...
  private void addChildDrawingOrderCallback()
  {
    ...
    if (this.mChildDrawingOrderCallback == null) {
      this.mChildDrawingOrderCallback = new bfyq(this);
    }
  ...
  private void destroyCallbacks()
  {
    ...
    while (i >= 0)
    {
      bfyv localbfyv = (bfyv)this.mRecoverAnimations.get(0);
      this.mCallback.clearView(this.mRecyclerView, localbfyv.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder);
      i -= 1;
    }
  ...
  private void initGestureDetector()
  {
    ...
    this.mGestureDetector = new bfyi(this.mRecyclerView.getContext(), new bfyu(this));
  }
  ...
  private int swipeIfNecessary(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if ((j & k) == 0) {
            return bfyr.convertToRelativeDirection(k, ViewCompat.getLayoutDirection(this.mRecyclerView));
          }
          return k;
        }
    ...
    if ((j & i) == 0) {
      return bfyr.convertToRelativeDirection(i, ViewCompat.getLayoutDirection(this.mRecyclerView));
    }
    return i;
  }
  ...
  public void attachToRecyclerView(@Nullable RecyclerView paramRecyclerView)
  {
    ...
    this.mSwipeEscapeVelocity = paramRecyclerView.getDimension(2131297124);
    this.mMaxSwipeVelocity = paramRecyclerView.getDimension(2131297123);
    setupCallbacks();
  }
  ...
  int endRecoverAnimation(RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
  {
    ...
    while (i >= 0)
    {
      bfyv localbfyv = (bfyv)this.mRecoverAnimations.get(i);
      if (localbfyv.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder == paramViewHolder)
      {
        localbfyv.jdField_b_of_type_Boolean |= paramBoolean;
        if (!localbfyv.jdField_c_of_type_Boolean) {
          localbfyv.b();
        }
        this.mRecoverAnimations.remove(i);
        return localbfyv.jdField_c_of_type_Int;
      }
      i -= 1;
    }
    return 0;
  ...
  bfyv findAnimation(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      bfyv localbfyv = (bfyv)this.mRecoverAnimations.get(i);
      paramMotionEvent = localbfyv;
      if (localbfyv.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder.itemView == localView) {
        break;
      }
      i -= 1;
    }
  ...
  View findChildView(MotionEvent paramMotionEvent)
  {
    ...
    while (i >= 0)
    {
      paramMotionEvent = (bfyv)this.mRecoverAnimations.get(i);
  ...
  public boolean hasRunningRecoverAnim()
  {
    ...
    while (i < j)
    {
      if (!((bfyv)this.mRecoverAnimations.get(i)).jdField_c_of_type_Boolean) {
        return true;
      }
      i += 1;
    }
  ...
  void postDispatchSwipe(bfyv parambfyv, int paramInt)
  {
    this.mRecyclerView.post(new ItemTouchHelper.4(this, parambfyv, paramInt));
  }
    ...
    else
    {
      ...
      default: 
        ...
        if (k == 2)
        {
          ...
          localObject = new bfyp(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2, j, (RecyclerView.ViewHolder)localObject);
          ((bfyv)localObject).a(this.mCallback.getAnimationDuration(this.mRecyclerView, i, f1 - f3, f2 - f4));
