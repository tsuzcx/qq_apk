  ...
  extends ajtd
{
  ...
  public atzr(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        axrl.a(this.mApp.getApplication()).a(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      Object localObject4 = ayqf.a().b(l1);
      Object localObject5 = ayqf.a().a(l1);
      ...
      try
      {
        ...
        ((ayrv)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject5);
        ((ayrv)localObject1).jdField_a_of_type_Aysa = new atzs(this, paramIntent, (byte[])localObject2, (String)localObject3);
        ((ayrv)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ((ayrv)localObject1).jdField_a_of_type_Int = 1;
        ((ayrv)localObject1).f = 57;
        ((ayrv)localObject1).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
        ((ayrv)localObject1).jdField_c_of_type_Int = 2;
        ((ayrv)localObject1).jdField_c_of_type_Long = 15000L;
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((aysw)localObject1);
          if (QLog.isColorLevel()) {
