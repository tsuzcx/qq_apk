  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                    ...
                    for (;;)
                    {
                      ...
                      if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StartVideoChat"))
                      {
                        ...
                        for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                        {
                          ...
                          aavk.a(this.a).add(paramContext);
                          return;
                        }
                      }
                      int i;
                      if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceAdminUnbind"))
                      {
                        ...
                        if (aavk.a(this.a).contains(paramContext) != true)
                        {
                          this.a.app.getMessageFacade().clearHistory(paramContext.toString(), 9501);
                          return;
                        }
                        if (paramContext.longValue() != 0L) {
                          aavk.b(this.a).add(paramContext);
                        }
                      }
                      else if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StopVideoChat"))
                      {
                        ...
                        for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                        {
                          ...
                          if ((i != 0) || (paramContext != null) || (paramIntent.longValue() == 0L) || (!aavk.b(this.a).contains(paramIntent))) {
                            break;
                          }
                          this.a.app.getMessageFacade().clearHistory(paramIntent.toString(), 9501);
                          aavk.b(this.a).remove(paramIntent);
                          return;
                        }
                        if (paramIntent.longValue() != 0L) {
                          aavk.a(this.a).remove(paramIntent);
                        }
                      }
                      else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_receiveDPMsg"))
                      {
                        ...
                        if (localObject1 == null)
                        {
                          ...
                          QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "dp is null in DeviceMsgHandler::onreceive");
                          return;
                        }
                        paramIntent = ((aara)this.a.app.getBusinessHandler(51)).a(((DataPoint)localObject1).mDin);
                        i = 0;
                        if (paramIntent != null) {
                        ...
                        if ((11015 == ((DataPoint)localObject1).mProperityId) || (((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012)) {
                          if (QLog.isColorLevel()) {
                            QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "device info pid is 0; dp.mDin = " + ((DataPoint)localObject1).mDin);
                          }
                        }
                        for (;;)
                        {
                          ...
                          {
                            this.a.jdField_a_of_type_Aave.a((DataPoint)localObject1);
                            if (aavk.a(this.a, ((DataPoint)localObject1).mValue)) {
                              break;
                            }
                            aavk.a(this.a);
                            return;
                          ...
                          for (;;)
                          {
                            try
                            {
                              ...
                              if (paramContext.optInt("flag") == 0)
                              {
                                ...
                                QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "PID_MSG_PROXY JSON :" + ((DataPoint)localObject1).mValue);
                                return;
                              }
                            }
                        ...
                        {
                          this.a.jdField_a_of_type_Aasi.a((DataPoint)localObject1);
                          abdm.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 2, 0, i);
                          if (aavk.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          aavk.a(this.a);
                        ...
                        if (10007 == ((DataPoint)localObject1).mProperityId)
                        {
                          for (;;)
                          {
                            ...
                            catch (Exception paramIntent)
                            {
                              try
                              {
                                ...
                                {
                                  paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                                  paramContext.optLong("msg_time", bbko.a());
                                  paramContext = paramContext.optString("text", " ");
                                  this.a.a(String.valueOf(((DataPoint)localObject1).mDin), paramContext, bbko.a(), true, false, true);
                                  return;
                                }
                                catch (Exception paramContext) {}
                                if (!QLog.isColorLevel()) {
                                ...
                                QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "onRecvRawTextMsg parse from json error:" + paramContext.getMessage());
                                return;
                              }
                              catch (Exception paramIntent)
                              {
                          ...
                          abdm.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 1, 0, i);
                          if (aavk.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          aavk.a(this.a);
                        ...
                        {
                          this.a.jdField_a_of_type_Aavj.a((DataPoint)localObject1);
                          if (aavk.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          aavk.a(this.a);
                        ...
                        if (10009 == ((DataPoint)localObject1).mProperityId)
                        {
                          try
                          {
                            ...
                            localObject4 = (MessageForDevLittleVideo)bbli.a(-4509);
                            ...
                            ((MessageForDevLittleVideo)localObject4).time = bbko.a();
                            ((MessageForDevLittleVideo)localObject4).msg = (ContactUtils.getBuddyName(this.a.app, ((MessageForDevLittleVideo)localObject4).senderuin, true) + amtj.a(2131702310));
                          ...
                          QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "getString from json error:" + paramContext.getMessage());
                          return;
                        }
                        if (((DataPoint)localObject1).mProperityId == 10008)
                        {
                          try
                          {
                            ...
                            l1 = paramIntent.optLong("msg_time", bbko.a());
                            paramIntent = paramIntent.optString("text", " ");
                            l2 = ((DataPoint)localObject1).mDin;
                            aavk.a(this.a, l2, paramContext, paramIntent, l1, true);
                            if (aavk.a(this.a, ((DataPoint)localObject1).mValue)) {
                              continue;
                            }
                            aavk.a(this.a);
                      ...
                      try
                      {
                        if (!DeviceTipActivity.a)
                        {
                          ...
                          l2 = ((JSONObject)localObject2).optLong("appear_time", bbko.a());
                          ...
                          if (QLog.isColorLevel())
                          {
                            QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "ReceiveDoorTip appear_time= " + l2 + " : serverTime = " + bbko.a() + " loginTimeStr= " + (String)localObject2);
                            i = (int)(bbko.a() - l2);
                            QQToast.a(this.a.app.getApp(), amtj.a(2131702307) + i + amtj.a(2131702309), 1).a();
                          }
                          if (l1 - l2 > 1L)
                          {
                            if (QLog.isColorLevel()) {
                              QQToast.a(this.a.app.getApp(), "该消息是手Q登录前" + (l1 - l2) + amtj.a(2131702318), 1).a();
                            }
                            this.a.a(paramContext, amtj.a(2131702312), l2, "");
                            return;
                          }
                          if (bbko.a() - l2 <= 30L)
                          {
                      ...
                      if (((DataPoint)localObject1).mProperityId == 1600006)
                      {
                        try
                        {
                          ...
                          l1 = paramContext.optLong("msg_time", bbko.a());
                      ...
                      if (((DataPoint)localObject1).mProperityId == 10004)
                      {
                        try
                        {
                          ...
                          l1 = paramIntent.optLong("msg_time", bbko.a());
                          aavk.a(this.a, paramContext, Long.toString(((DataPoint)localObject1).mDin), (String)localObject2, (String)localObject3, (String)localObject4, str1, str2, l1);
                          if (aavk.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          aavk.a(this.a);
                      ...
                      else if (((DataPoint)localObject1).mProperityId == 11010)
                      {
                        try
                        {
                          ...
                          paramContext = bbli.a(this.a.app, ((SessionInfo)localObject5).curFriendUin, ((SessionInfo)localObject5).troopUin, ((SessionInfo)localObject5).curType, paramContext);
                      ...
                      else if ((((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012))
                      {
                        ...
                        {
                          paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                          abdn.a(this.a.app, paramContext, String.valueOf(((DataPoint)localObject1).mDin));
                          if (aavk.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          aavk.a(this.a);
                        ...
                        if (QLog.isColorLevel()) {
                          QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "auth_request_structmsg:" + paramContext.getMessage());
                        }
                      }
                      else if (((DataPoint)localObject1).mProperityId == 700154)
                      {
                        try
                        {
                          ...
                          if (QLog.isColorLevel()) {
                            QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "openav roomId:" + i + ",sessionId:" + paramContext + ", cTime: " + j + ", cmd:" + k);
                          }
                          if (k != 1) {
                            continue;
                          }
                        ...
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_sendCCDataPointMsgResult"))
                        {
                          ...
                          if (bool)
                          {
                            aavk.a(this.a, String.valueOf(l1), i);
                            return;
                          }
                          aavk.b(this.a, String.valueOf(l1), i);
                          return;
                        }
                        ...
                        else
                        {
                          if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferComplete"))
                          {
                            ...
                            if ((l1 != 0L) && (this.a.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l1))))
                            {
                              ...
                              paramContext.srcFileName = aszt.a(paramIntent);
                              paramContext.fileSize = aszt.a(paramIntent);
                              paramContext.msg = (ContactUtils.getBuddyName(this.a.app, paramContext.senderuin, true) + ": " + this.a.app.getApp().getString(2131691443));
                              paramContext.serial();
                              this.a.app.getMessageFacade().updateMsgContentByUniseq(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                          ...
                          if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceVasFlagChange"))
                          {
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              localObject2 = ((aara)localObject1).a(l1);
                              if (localObject2 != null)
                              {
                                ...
                                {
                                  paramIntent = this.a.app.getApp().getString(2131694273).split(":")[0];
                                  paramContext = paramIntent;
                                  if (((DeviceInfo)localObject2).isAdmin != 1)
                                  {
                                    ((aara)localObject1).a(((DeviceInfo)localObject2).productId, ((DeviceInfo)localObject2).serialNum);
                                    paramContext = paramIntent;
                                  }
                                }
                                ...
                                {
                                  ahff.f = true;
                                  paramContext = paramContext + this.a.app.getApp().getString(2131691416);
                                  this.a.a(l1 + "", paramContext, bbko.a(), true, false, 1);
                                  return;
                                }
                                if ((i == 0) && (((DeviceInfo)localObject2).isAdmin != 1))
                                {
                                  ahff.f = false;
                                  paramContext = paramContext + this.a.app.getApp().getString(2131691415);
                                  this.a.a(l1 + "", paramContext, bbko.a(), true, false, true);
                                }
                              }
                            }
                          }
                          ...
                          else
                          {
                            ...
                            paramContext = (aara)this.a.app.getBusinessHandler(51);
                            ...
                            if (paramIntent != null)
                            {
                              ...
                              if (localObject1 != null)
                              {
                                ...
                                for (paramContext = amtj.a(2131702320); !TextUtils.isEmpty(paramContext); paramContext = amtj.a(2131702317) + ((ProductInfo)localObject1).deviceName)
                                {
                                  ...
                                  this.a.a(localObject2 + "", paramContext, bbko.a(), true, false, true);
                                  return;
                  ...
                  paramContext = amtj.a(2131702308);
            ...
            } while ((localObject1 != null) && (((aara)localObject1).a(l1, 13)));
            if (arhf.a().a(this.a.app, paramContext) != 0) {
              this.a.a(l1 + "", "【重要！设备安全提醒】\n\n为防止QQ号被盗/丢失手机，导致设备被人恶意控制\n请点这里开启QQ设备锁\n\n\n查看QQ设备锁介绍", bbko.a(), "device_lock_msg");
            }
        ...
        } while ((localObject2 == null) || (((DeviceInfo)localObject2).isAdmin == 1) || (!((aara)localObject1).a(l1).booleanValue()));
        paramContext = paramContext + this.a.app.getApp().getString(2131691416);
        this.a.a(l1 + "", paramContext, bbko.a(), true, false, 1);
        return;
        ...
        if (QLog.isColorLevel()) {
          QLog.d(aavk.jdField_a_of_type_JavaLangString, 2, "DeviceMsghandle intent.getExtras() : " + paramIntent.getExtras());
        }
        paramContext = paramIntent.getExtras();
      ...
      for (paramContext = amtj.a(2131702327);; paramContext = (String)localObject1 + amtj.a(2131702316))
      {
        this.a.a(String.valueOf(paramIntent), paramContext, bbko.a(), "");
        aavk.a(this.a);
        return;
      }
      if ("SmartDevice_sendToAIO_Capture".equals(paramIntent.getAction()))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("msg_time", bbko.a());
          ((JSONObject)localObject2).put("guidewords", amtj.a(2131702314));
          ((JSONObject)localObject2).put("appear_time", bbko.a());
          ((JSONObject)localObject2).put("digest", amtj.a(2131702323));
          ((JSONObject)localObject2).put("title", amtj.a(2131702326));
          paramIntent = (MessageForDeviceSingleStruct)bbli.a(-4502);
          ...
          paramIntent.strMediaFileName = aszt.a((String)localObject1);
    ...
    try
    {
      ...
      ((JSONObject)localObject3).put("msg_time", bbko.a());
      ((JSONObject)localObject3).put("guidewords", amtj.a(2131702325));
      ((JSONObject)localObject3).put("appear_time", bbko.a());
      ...
      localObject2 = (MessageForDeviceSingleStruct)bbli.a(-4502);
      ...
      ((MessageForDeviceSingleStruct)localObject2).strMediaFileName = aszt.a(paramIntent);
