...
public class asax
{
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      localReqBody.version.set("8.4.5");
    ...
    nkm.a(paramQQAppInterface, new asay(), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, asaz paramasaz)
  {
    oidb_0x877.ReqBody localReqBody = new oidb_0x877.ReqBody();
    localReqBody.uint32_refer.set(paramInt);
    nkm.a(paramQQAppInterface, paramasaz, localReqBody.toByteArray(), "OidbSvc.0x877_0", 2167, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, asba paramasba)
  {
    nkm.a(paramQQAppInterface, paramasba, new oidb_0x876.ReqBody().toByteArray(), "OidbSvc.0x876_" + paramInt, 2166, paramInt);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<Long> paramList, Bundle paramBundle, asbb paramasbb)
  {
    ...
    nkm.a(paramQQAppInterface, paramasbb, localReqBatchGetAnchorStatus.toByteArray(), "NearbyNowTips.batch_get_anchor_stats", paramList);
  }
}
