...
public final class bgvq
{
  ...
  public static String a(String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      bgvo.e("ReaderUrlHelper", "getUrlWithBid = " + (String)localObject);
      return localObject;
  ...
  private static String d(String paramString)
  {
    String str2 = null;
    String str1;
    if ((bgud.a != null) && (bgud.a.size() > 0)) {
      str1 = (String)bgud.a.get(paramString);
    }
    for (;;)
    {
      bgvo.d("ReaderUrlHelper", "getUrl = " + str1);
      return str1;
      if (bgud.a != null) {
        str2 = (String)bgud.a.get(paramString);
      }
      str1 = str2;
      if (str2 == null) {
