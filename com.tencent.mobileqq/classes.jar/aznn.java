  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  private void a(TroopAIONotifyItem paramTroopAIONotifyItem)
  {
    ...
    Object localObject1 = (URLThemeImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131377716);
    for (;;)
    {
      try
      {
        ...
        ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131377719)).setText(paramTroopAIONotifyItem.title);
        localObject1 = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131377718);
        ((TextView)localObject1).setText(paramTroopAIONotifyItem.summary);
        if (!TextUtils.isEmpty(paramTroopAIONotifyItem.summary)) {
          break label223;
        }
        ((TextView)localObject1).setVisibility(8);
        ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131377715)).setBackgroundResource(2130849566);
    ...
    if ((this.jdField_c_of_type_AndroidViewView.getVisibility() == 8) && (this.jdField_b_of_type_AndroidViewView != null) && (this.jdField_a_of_type_AndroidViewAnimationAnimation != null))
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        ...
        if ((localTroopAIONotifyItem != null) && (localTroopAIONotifyItem.hideMode == 1)) {
          baiy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTroopAIONotifyItem);
        }
        if ((localTroopAIONotifyItem == null) || (localTroopAIONotifyItem.type != 1)) {
          break label182;
        }
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "exp_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "" + localTroopAIONotifyItem.appId, "");
      }
    }
    for (;;)
    {
      ...
      if ((localTroopAIONotifyItem != null) && (localTroopAIONotifyItem.type == 2)) {
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "exp_oper_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "" + localTroopAIONotifyItem.appId, "");
      }
    }
  }
  ...
  public void a(List<TroopAIONotifyItem> paramList)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      ...
      paramList.topMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
    ...
    int i = azni.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, new int[] { 2131377875, 2131372955, 2131373042, 2131373037 });
    if (i > 0) {
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView.type == 1)
    {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "clk_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "" + paramView.appId, "");
      if (!paramView.url.startsWith("http")) {
        break label300;
      }
      Intent localIntent = new Intent(this.jdField_a_of_type_AndroidContentContext, QQBrowserActivity.class);
      localIntent.putExtra("url", paramView.url);
      sgg.a(localIntent, paramView.url);
      this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
    }
    for (;;)
    {
      if (paramView.hideMode == 2) {
        baiy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
      }
      f();
      return;
      if (paramView.type != 2) {
      ...
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "clk_oper_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "" + paramView.appId, "");
      break;
      label300:
      if (paramView.url.startsWith("mqqapi")) {
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface)) {
          bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramView.url).c();
        } else {
