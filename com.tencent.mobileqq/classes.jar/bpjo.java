...
public class bpjo
  ...
  implements Handler.Callback, View.OnClickListener, bkqk, bpom
{
  private float jdField_a_of_type_Float;
  public int a;
  Context jdField_a_of_type_AndroidContentContext;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bpjq(this);
  public View a;
  public ViewGroup a;
  ...
  public boolean a;
  private InputFilter[] jdField_a_of_type_ArrayOfAndroidTextInputFilter = { new bpkc(20) };
  ...
  private int j = 580;
  private int k;
  private int l = bork.jdField_b_of_type_Int;
  private int m;
  private int n;
  
  public bpjo(Context paramContext, boolean paramBoolean)
  {
    super(paramContext, 2131755181);
    this.jdField_b_of_type_Int = -1;
    this.jdField_c_of_type_Int = bpwe.a(false);
    this.jdField_a_of_type_Bpiy = new bpiy();
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bpkb(this, null);
    this.jdField_a_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new bpka(this, null));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout = ((FitSystemWindowsRelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376810));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setFitsSystemWindows(true);
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setOnTouchListener(new bpjp(this));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378526);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiPanelEditTextPanel = ((EditTextPanel)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365857).findViewById(2131372133));
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView = ((PressScaleTextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378499));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378500));
    if (this.jdField_d_of_type_Boolean)
    {
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setOnClickListener(new bpjr(this));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bpjs(this));
    }
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView = ((EditTextPreView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378538));
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setOnClickListener(new bpjt(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new bpju(this));
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a(this.jdField_a_of_type_AndroidWidgetEditText);
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bpjv(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bpjw(this));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371661));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setStrokeStrategy(new bpwe(), false, 0);
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new bpjx(this));
  }
  ...
  private void b()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (bqcd.f())
      {
        int[] arrayOfInt = bqcd.a(this.jdField_a_of_type_AndroidContentContext);
        if ((arrayOfInt.length == 2) && (arrayOfInt[0] > 0) && (arrayOfInt[1] > 0))
        {
          localLayoutParams.height = arrayOfInt[1];
          if (((!Build.MANUFACTURER.equalsIgnoreCase("HUAWEI")) && (!Build.MODEL.equalsIgnoreCase("V1916A"))) || (!DisplayUtil.checkNavigationBarShow(this.jdField_a_of_type_AndroidContentContext))) {
            break label262;
          }
          i1 = 1;
  ...
  private void c()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new bpjy(this));
  }
  ...
  public void a(boqj paramboqj)
  {
    this.jdField_a_of_type_Boqj = paramboqj;
  }
  
  public void a(bpjz parambpjz)
  {
    this.jdField_a_of_type_Bpjz = parambpjz;
  }
  ...
  public void a(DynamicTextConfigManager.DynamicTextConfigBean paramDynamicTextConfigBean, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_AndroidWidgetEditText != null) && (paramDynamicTextConfigBean != null))
    {
      ...
      paramDynamicTextConfigBean = this.jdField_a_of_type_Boqj.a(paramDynamicTextConfigBean.text_id, (List)localObject);
      ...
      if (!(paramDynamicTextConfigBean instanceof bork)) {
        break label391;
      }
      ((bork)paramDynamicTextConfigBean).a(this.jdField_c_of_type_Int);
      ...
      if (!this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a().equals(boqj.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c(), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.b()))) {
        break label427;
      }
    ...
    for (;;)
    {
      ...
      return;
      label357:
      localObject = boqj.a(boqj.a(paramDynamicTextConfigBean.text_id), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public void a(DynamicTextItem paramDynamicTextItem, int paramInt)
  {
    ...
    yqp.b("EditTextDialog", "setTextInfo:" + paramDynamicTextItem + " index:" + paramInt + " text:" + str1);
    this.jdField_a_of_type_Bpiy.jdField_a_of_type_JavaLangString = str1;
    this.jdField_a_of_type_AndroidWidgetEditText.setText(this.jdField_a_of_type_Bpiy.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c() != 0)
    {
      if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a() == null) {
        this.jdField_a_of_type_AndroidWidgetEditText.setFilters(this.jdField_a_of_type_ArrayOfAndroidTextInputFilter);
    ...
    for (;;)
    {
      paramInt = this.jdField_a_of_type_Boqj.a(paramDynamicTextItem);
      ...
      if (!(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem instanceof bork)) {
        break label494;
      }
      paramDynamicTextItem = (bork)this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bpjz.a(false);
    this.jdField_a_of_type_Bpjz.a(c(), d());
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setPreViewDrawer(null);
    localObject = this.jdField_a_of_type_Bpjz;
    DynamicTextItem localDynamicTextItem = this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
    if (!paramBoolean) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      ((bpjz)localObject).a(localDynamicTextItem, paramBoolean, this.g, this.jdField_c_of_type_Boolean);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 34)
    {
      ...
      {
        int i1 = this.jdField_a_of_type_Boqj.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public int c()
  {
    ...
    yqp.b("EditTextDialog", "getPreViewCenterX:" + i1);
    return i1;
  }
  ...
  public int d()
  {
    ...
    yqp.b("EditTextDialog", "getPreViewCenterY()=" + i1);
    return i1;
  }
  ...
  public void onDetachedFromWindow()
  {
    ...
    if (this.jdField_a_of_type_Bpjz == null) {
      return;
    }
