...
{
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new uvp(this);
  ...
  public uvm(@NonNull uut paramuut)
  {
    super(paramuut);
  }
  ...
  private void l()
  {
    urk.b("Q.qqstory.publish.edit.EditVideoPoiSearch", "requestPoiList");
    String str = this.jdField_a_of_type_AndroidWidgetEditText.getText().toString();
    this.jdField_a_of_type_Ssf.a(str);
    if (TextUtils.isEmpty(str))
    {
      urk.c("Q.qqstory.publish.edit.EditVideoPoiSearch", "requestPoiList text is null ignore");
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      this.jdField_a_of_type_Vfe.notifyDataSetChanged();
      k();
      return;
    }
    srz localsrz = (srz)sqg.a(9);
    sry localsry = vls.a(this.jdField_a_of_type_Uut.a);
    if (localsry != null) {
      localsrz.a(localsry, this.jdField_a_of_type_Ssf, new uvo(this, str));
    }
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)a(2131307633));
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if ((paramObject instanceof uvl)) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((uvl)paramObject);
    }
    f();
  ...
  void a(String paramString)
  {
    ...
    paramString = a().getString(2131633888, new Object[] { paramString });
  ...
  protected boolean b()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      if (this.jdField_a_of_type_AndroidViewView.getVisibility() == 0)
      {
        ...
        this.jdField_a_of_type_Uut.a(3, this.jdField_a_of_type_JavaLangRefWeakReference.get());
        beex.b(a().a());
        bool1 = true;
      }
    }
  ...
  void f()
  {
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_Vfe = new vfe(a());
      this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      this.jdField_a_of_type_Vfe.a(this.jdField_a_of_type_JavaUtilArrayList, null);
      this.jdField_a_of_type_ComTencentWidgetXListView.setEmptyView(this.e);
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new uvn(this));
      i();
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Vfe);
  ...
  protected void i()
  {
    if (this.d == null)
    {
      this.d = LayoutInflater.from(a()).inflate(2131493891, null);
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      g();
      paramView = (uvl)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (paramView != null) {
