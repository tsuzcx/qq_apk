...
public class bcfc
  extends bceg
  implements Handler.Callback, AdapterView.OnItemClickListener, sid
{
  ...
  sib jdField_a_of_type_Sib = null;
  public boolean a;
  int b;
  public String b;
  public boolean b;
  ...
  private void c()
  {
    this.jdField_a_of_type_Rnr = new rnr(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Rnr.a(this);
    ...
    {
      this.jdField_a_of_type_Rnr.a((String)localObject);
      return;
    }
  }
  ...
  View a()
  {
    Object localObject = (bcfx)this.jdField_a_of_type_Bceh.a().a(2);
    if ((((bcfx)localObject).a.jdField_a_of_type_Boolean) || (((bcfx)localObject).a.jdField_b_of_type_Boolean)) {}
    for (int i = 2131363418;; i = 2131377452)
    {
      ...
      {
        localObject = localView;
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx != null)
        {
          localObject = localView;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.d != null) {
  ...
  public String a()
  {
    return this.jdField_a_of_type_Rnr.a();
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Rnr == null);
      ...
      return;
      if ((this.jdField_a_of_type_Rnr != null) && (this.jdField_a_of_type_Rnr.a() != null)) {
        this.jdField_a_of_type_Rnr.a().g();
      }
  ...
  public void a(Uri paramUri, String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Rnr != null) {
      paramUri = this.jdField_a_of_type_Rnr.c();
    }
    int i;
    for (;;)
    {
      ...
      try
      {
        ...
        axqy.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A69", "0X8006A69", 0, 0, "", paramString, "", "");
        nol.a("0X8006A69", "", "", paramString, "", "");
        if (QLog.isDevelopLevel()) {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = rnq.a(this.jdField_a_of_type_AndroidAppActivity.getWindow(), paramString);
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      if (this.jdField_a_of_type_Rnr != null) {
        this.jdField_a_of_type_Rnr.a(paramInt);
      }
      if (paramInt != 1) {
        break label487;
      }
  ...
  {
    if (this.jdField_a_of_type_Rnr != null) {
      this.jdField_a_of_type_Rnr.a(paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Rnr != null) {
      this.jdField_a_of_type_Rnr.a(paramString1, paramString2, paramInt);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Rnr.a().show();
  ...
  {
    if (this.jdField_a_of_type_Rnr != null) {
      this.jdField_a_of_type_Rnr.a(paramJSONArray);
    }
  }
  ...
  void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          if ((this.jdField_a_of_type_AndroidWidgetLinearLayout != null) && ((this.jdField_a_of_type_AndroidWidgetLinearLayout.getTag() instanceof Integer)))
          {
            ...
            if (i != paramInt)
            {
              ...
              localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363418);
              if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.d != null)) {
                this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.d.findViewById(2131363418);
              }
          ...
          if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
          {
            ...
            localLayoutParams.setMargins(0, 0, actj.a(10.0F, BaseApplicationImpl.getContext().getResources()), actj.a(65.0F, BaseApplicationImpl.getContext().getResources()));
            ...
            if (paramInt == 2)
            {
              localObject = (LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131375643).getLayoutParams();
            ...
            this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131375643).setOnClickListener(new bcfe(this));
          }
          ...
          ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131375643)).setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      ...
      ((AlphaAnimation)localObject).setAnimationListener(new bcff(this));
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Sib != null;
  }
  ...
  {
    if ((this.jdField_a_of_type_Sib == null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      this.jdField_a_of_type_Sib = new sib(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
      this.jdField_a_of_type_Sib.a(this);
      localObject = a();
      if (localObject != null)
      {
        ((View)localObject).setDrawingCacheEnabled(true);
        ((View)localObject).getViewTreeObserver().addOnGlobalLayoutListener(new bcfd(this, (View)localObject));
      }
      if (QLog.isColorLevel()) {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Rnr != null)) {
      this.jdField_a_of_type_Rnr.c(paramString.replace("|", "｜"));
    }
    while ((this.jdField_a_of_type_Rnr == null) || (!TextUtils.isEmpty(this.jdField_a_of_type_Rnr.b())) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
      return;
    }
    this.jdField_a_of_type_Rnr.c(BaseApplicationImpl.getContext().getResources().getString(2131695589));
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Rnr != null)) {
      this.jdField_a_of_type_Rnr.b(paramString);
    }
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Rnr != null)) {
      this.jdField_a_of_type_Rnr.e(paramString);
    }
  }
  ...
  public void f(String paramString)
  {
    ...
    paramString.putExtra("EditPicType", this.jdField_a_of_type_Rnr.a());
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      catch (Exception paramView)
      {
        ...
        axqy.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1001", paramView, "", "");
        nol.a("0X8006A1F", "", "1001", paramView, "", "");
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action friend!");
        continue;
        axqy.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1002", paramView, "", "");
        nol.a("0X8006A1F", "", "1002", paramView, "", "");
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action qzone!");
        continue;
        axqy.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1003", paramView, "", "");
        nol.a("0X8006A1F", "", "1003", paramView, "", "");
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat!");
        continue;
        axqy.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1004", paramView, "", "");
        nol.a("0X8006A1F", "", "1004", paramView, "", "");
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat circle!");
        continue;
        nol.a(null, "", "0X800787A", "0X800787A", 0, 0, paramView, str, "", "");
        axqy.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1005", paramView, "", "");
        nol.a("0X8006A1F", "", "1005", paramView, "", "");
        if (!QLog.isColorLevel()) {
          continue;
        }
