  ...
  implements Handler.Callback
{
  ...
  Comparator<ljv> jdField_a_of_type_JavaUtilComparator = new lju(this);
  private final ConcurrentHashMap<ChatRoomInfo, ConcurrentLinkedQueue<ljv>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public ljt(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private ChatRoomInfo a(chatroom_sso.RoomKey paramRoomKey)
  {
    ...
    int i = ((lez)localObject1).e();
    long l5 = ((lez)localObject1).a();
    long l3 = ((lez)localObject1).b();
    long l4 = ((lez)localObject1).f();
    long l2 = l4;
    long l1 = l3;
    Object localObject2;
    if (i == paramRoomKey.type.get())
    {
      ...
      if (l5 == paramRoomKey.id.get())
      {
        ...
        if (localObject2 != null) {
          ((VideoController)localObject2).a("pushMsg", (lez)localObject1);
        }
        l1 = ((lez)localObject1).b();
        l2 = ((lez)localObject1).f();
      }
    }
    if ((i == paramRoomKey.type.get()) && (l5 == paramRoomKey.id.get()) && (l1 == paramRoomKey.room_id.get()) && (l2 == paramRoomKey.create_ts.get())) {}
    for (localObject1 = a((lez)localObject1);; localObject1 = null)
    {
  ...
  private ConcurrentLinkedQueue<ljv> a(ChatRoomInfo paramChatRoomInfo)
  {
  ...
  private void a(ljv paramljv)
  {
    if ((paramljv == null) || (paramljv.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo == null)) {}
    ChatRoomInfo localChatRoomInfo;
    do
    {
      return;
      localChatRoomInfo = paramljv.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo;
      long l1 = 0L;
      try
      {
      ...
      l2 = AudioHelper.b();
      if (QLog.isColorLevel()) {
        QLog.i("ChatRoomMng", 2, "sendMsg, seq[" + l2 + "], room[" + localChatRoomInfo + "], msg[" + paramljv + "]");
      }
      paramljv.a();
      ...
      localMsg.msg.set(paramljv.jdField_a_of_type_JavaLangString);
      localMsg.uin.set(l1);
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication(), lcx.class);
      ...
      ((NewIntent)localObject).putExtra("localSeq", paramljv.jdField_b_of_type_Long);
      mtt.a((Intent)localObject, l2);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
    } while (paramljv.e != ljv.jdField_a_of_type_Int);
    a(1, localChatRoomInfo);
  }
  
  private void b(ljv paramljv)
  {
    if (!this.jdField_a_of_type_AndroidOsHandler.hasMessages(2, paramljv))
    {
      Message localMessage = Message.obtain();
      localMessage.what = 2;
      localMessage.obj = paramljv;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(localMessage);
    }
  }
  ...
  public ChatRoomInfo a(lez paramlez)
  {
    ChatRoomInfo localChatRoomInfo = a(paramlez, true);
    Object localObject;
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (paramlez != null)) {
        QLog.i("ChatRoomMng", 4, "enterChatRoom, SessionType[" + paramlez.jdField_d_of_type_Int + "], relationType[" + paramlez.F + "], relationId[" + paramlez.g + "], peerUin[" + paramlez.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlez.f + "], isDoubleVideoMeeting[" + paramlez.J + "], room[" + localChatRoomInfo + "]");
      }
      return localChatRoomInfo;
      label189:
  ...
  public ChatRoomInfo a(lez paramlez, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (localChatRoomInfo2 == null)
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            QLog.i("ChatRoomMng", 4, "getRoomInfo, SessionType[" + paramlez.jdField_d_of_type_Int + "], relationType[" + paramlez.F + "], relationId[" + paramlez.g + "], peerUin[" + paramlez.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlez.f + "], isDoubleVideoMeeting[" + paramlez.J + "], type[" + i + "], roomID[" + l2 + "], id[" + l5 + "], createTime[" + l1 + "], room[" + localChatRoomInfo1 + "]");
            localObject = localChatRoomInfo1;
          }
        }
      }
  ...
  public ljv a(ChatRoomInfo paramChatRoomInfo, long paramLong)
  {
    if (paramChatRoomInfo == null) {
      return null;
    }
    ...
    if ((paramChatRoomInfo != null) && (paramChatRoomInfo.size() > 0))
    {
      ...
      do
      {
        ...
        paramChatRoomInfo = (ljv)localIterator.next();
          ...
          do
          {
            do
            {
              do
              {
                ...
                for (;;)
                {
                  ...
                  catch (InvalidProtocolBufferMicroException paramArrayOfByte)
                  {
                    try
                    {
                      ...
                      ((ljv)localObject2).a(ljv.jdField_b_of_type_Int);
                      b((ljv)localObject2);
                      if (!((ljv)localObject2).b()) {
                        break;
                      }
                ...
                ((ljv)localObject2).jdField_d_of_type_Long = l1;
                ((ljv)localObject2).a(ljv.jdField_c_of_type_Int);
                b((ljv)localObject2);
              ...
              } while ((((ChatRoomInfo)localObject1).jdField_b_of_type_Boolean) || (TextUtils.isEmpty(((ljv)localObject2).jdField_a_of_type_JavaLangString)) || (((ljv)localObject2).jdField_a_of_type_JavaLangString.indexOf('\024') < 0));
              ljx.a("0X800A8D5");
  ...
  public void a(VideoController paramVideoController, lez paramlez)
  {
    ChatRoomInfo localChatRoomInfo2 = a(paramlez, false);
    boolean bool = paramVideoController.a("onSwitchTerminalSuccess", paramlez);
    ChatRoomInfo localChatRoomInfo1 = a(paramlez, false);
    paramVideoController = localChatRoomInfo1;
    if (localChatRoomInfo1 == null) {
      paramVideoController = a(paramlez);
    }
    if (paramVideoController != null)
    {
      ...
      paramlez = Message.obtain();
      paramlez.obj = paramVideoController;
      paramlez.what = 3;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramlez);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, String paramString, long paramLong)
  {
    ...
    paramString = new ljv(paramChatRoomInfo, l1, paramString, paramLong, -9223372036854775808L, ljv.jdField_a_of_type_Int);
    a(paramChatRoomInfo).add(paramString);
    a(paramString);
  }
  
  public void a(ChatRoomInfo paramChatRoomInfo, List<ljv> paramList)
  {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, chatroom_sso.Msg paramMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        localljv = (ljv)localIterator.next();
        if (localljv != null) {
          if (localljv.a(paramMsg))
          {
            bool = true;
            localljv.jdField_c_of_type_Long = paramMsg.msg_time.get();
            localljv.a(ljv.jdField_d_of_type_Int);
          }
        }
      }
    }
    for (;;)
    {
      ...
      {
        bool = true;
        ((ljv)localObject).jdField_d_of_type_Long = paramMsg.msg_id.get();
        ((ljv)localObject).jdField_c_of_type_Long = paramMsg.msg_time.get();
        ((ljv)localObject).a(ljv.jdField_d_of_type_Int);
        label140:
        if (!bool)
        {
          localObject = new ljv(paramChatRoomInfo, paramMsg.uin.get(), paramMsg.msg.get(), paramMsg.msg_time.get(), paramMsg.msg_id.get(), ljv.jdField_d_of_type_Int);
        ...
        else
        {
          ...
          return;
          if ((localljv.jdField_d_of_type_Long != -9223372036854775808L) || (localljv.jdField_a_of_type_Long != l) || (!TextUtils.equals(localljv.jdField_a_of_type_JavaLangString, paramMsg.msg.get()))) {
            break label329;
          }
          localObject = localljv;
        }
      }
      label320:
      label329:
  ...
  {
    ChatRoomInfo localChatRoomInfo = a(paramlez, false);
    a(localChatRoomInfo);
    if ((QLog.isDevelopLevel()) && (paramlez != null)) {
      QLog.i("ChatRoomMng", 4, "quitChatRoom, SessionType[" + paramlez.jdField_d_of_type_Int + "], relationType[" + paramlez.F + "], relationId[" + paramlez.g + "], peerUin[" + paramlez.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlez.f + "], isDoubleVideoMeeting[" + paramlez.J + "], room[" + localChatRoomInfo + "]");
    }
  }
  
  public void a(ljw paramljw)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "addObserver, observer[" + paramljw + "]");
    }
    if ((paramljw != null) && (!this.b.contains(paramljw))) {
      this.b.add(paramljw);
    }
  }
  ...
  public void b(ChatRoomInfo paramChatRoomInfo)
  {
    ...
    mtt.a((Intent)localObject, l);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
  }
  
  public void b(ljw paramljw)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "removeObserver, observer[" + paramljw + "]");
    }
    if (paramljw != null) {
      this.b.remove(paramljw);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 1)
    {
      ...
      while (localIterator.hasNext())
      {
        localljw = (ljw)localIterator.next();
        if (localljw != null) {
          localljw.a(i, paramMessage);
        }
      }
    }
    if (paramMessage.what == 2)
    {
      paramMessage = (ljv)paramMessage.obj;
      localIterator = this.b.iterator();
      while (localIterator.hasNext())
      {
        localljw = (ljw)localIterator.next();
        if (localljw != null) {
          localljw.a(paramMessage);
        }
      }
    }
