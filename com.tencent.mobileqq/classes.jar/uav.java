  ...
  implements uan
{
  ...
  public pak a;
  private psd jdField_a_of_type_Psd;
  private uak jdField_a_of_type_Uak;
  private ubc jdField_a_of_type_Ubc;
  private long jdField_b_of_type_Long = -1L;
  private String jdField_b_of_type_JavaLangString;
  private List<two> jdField_b_of_type_JavaUtilList;
  private String c;
  
  public uav(psd parampsd, aasb paramaasb)
  {
    this.jdField_a_of_type_Psd = parampsd;
    this.jdField_a_of_type_Bioy = parampsd.mRuntime;
    this.jdField_a_of_type_Aasb = paramaasb;
    this.jdField_a_of_type_AndroidAppActivity = a();
    this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = this.jdField_a_of_type_Bioy.a();
    parampsd = this.jdField_a_of_type_Bioy.a(this.jdField_a_of_type_Bioy.a());
    if ((parampsd != null) && ((parampsd instanceof bits))) {
      this.jdField_a_of_type_Bits = ((bits)parampsd);
    }
    parampsd = this.jdField_a_of_type_Bioy.a(this.jdField_a_of_type_Bioy.a());
    if ((parampsd != null) && ((parampsd instanceof bitg))) {
      this.jdField_a_of_type_Bitg = ((bitg)parampsd);
    }
  }
  ...
  private List<Integer>[] a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList1.add(Integer.valueOf(((two)((Iterator)localObject).next()).a));
    }
    ArrayList localArrayList2 = new ArrayList();
    localObject = this.jdField_b_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext()) {
      localArrayList2.add(Integer.valueOf(((two)((Iterator)localObject).next()).a));
    }
    ...
    for (;;)
    {
      ...
      label152:
      localObject = this.jdField_a_of_type_Ubc.c;
      break;
      label163:
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_Long != -1L) {
      this.jdField_b_of_type_JavaUtilList.add(2, new two("fav_move_group", 39, false));
    }
  }
  ...
  private void e()
  {
    String str1 = this.jdField_a_of_type_Ubc.a;
    String str2 = this.jdField_a_of_type_Ubc.jdField_b_of_type_JavaLangString;
    String str3 = this.jdField_a_of_type_Ubc.d;
    String str4 = this.jdField_a_of_type_Bioy.a().uin;
    String str5 = this.jdField_a_of_type_Ubc.f;
    bmko.a(0, str1, this.jdField_a_of_type_Ubc.c, str5, str2, str3, null, null, false, -1L).a("lCategory", 8L).c(str4).a(this.jdField_a_of_type_Bioy.a(), str4);
  }
  
  private void f()
  {
    Object localObject1 = Pattern.compile("(http|https)://.*.mp.qq.com.*").matcher(this.jdField_a_of_type_Ubc.c);
    int i = 0;
    ...
    try
    {
      localObject1 = URLEncoder.encode(this.jdField_a_of_type_Ubc.c, "UTF-8");
      str2 = this.jdField_a_of_type_Bioy.a().uin;
      if (i != 0)
      {
        String str3 = String.valueOf(NetConnInfoCenter.getServerTime());
        String str1 = bjtz.b((String)localObject1 + 200 + str3 + "jubao@article@123");
        localObject3 = str1;
        if (str1 != null)
        {
          localObject3 = str1;
        ...
        str1 = this.jdField_a_of_type_Bioy.a().publicUin;
  ...
  Activity a()
  {
    for (Activity localActivity = this.jdField_a_of_type_Bioy.a(); (localActivity != null) && ((localActivity instanceof BasePluginActivity)); localActivity = ((BasePluginActivity)localActivity).getOutActivity()) {}
  ...
  {
    this.jdField_a_of_type_Bioy.a().getSettings().setTextZoom(biqq.a[paramInt]);
    this.jdField_a_of_type_Aasb.a(paramInt);
  }
  ...
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Uak == null) {
      this.jdField_a_of_type_Uak = new uak(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bioy.a(), new uba(this));
    }
    this.jdField_a_of_type_Uak.a().setActionSheetTitle("biu出去让更多好友看到");
    this.jdField_a_of_type_Uak.a().setCancelListener(new uaw(this));
    for (;;)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList = uak.b();
          if (localJSONArray2 == null)
          {
            this.jdField_b_of_type_JavaUtilList = uak.c();
            b();
            this.jdField_a_of_type_Ubc = new ubc(null);
            this.jdField_a_of_type_Ubc.c = paramString.optString("share_url");
            this.jdField_a_of_type_Ubc.jdField_b_of_type_JavaLangString = paramString.optString("desc");
            this.jdField_a_of_type_Ubc.a = paramString.optString("title");
            this.jdField_a_of_type_Ubc.d = paramString.optString("image_url");
            this.jdField_a_of_type_Ubc.e = paramString.optString("puin");
            this.jdField_a_of_type_Ubc.f = paramString.optString("nick_name");
            if (TextUtils.isEmpty(this.jdField_a_of_type_Ubc.f)) {
              this.jdField_a_of_type_Ubc.f = paramString.optString("sourceName");
            }
            this.jdField_b_of_type_JavaLangString = paramString.optString("callback");
            int i = paramString.optInt("report_from");
            this.jdField_a_of_type_Uak.a(a(), i);
          }
        }
        else
        {
          this.jdField_a_of_type_JavaUtilList = uak.a(localJSONArray1, null);
          continue;
        }
        this.jdField_b_of_type_JavaUtilList = uak.a(localJSONArray2, null);
      }
      catch (JSONException paramString)
      {
        paramString.printStackTrace();
  ...
  void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        paramString2 = this.jdField_a_of_type_Bioy.a();
  ...
  void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    paramString1.putLong("share_begin_time", biqq.jdField_b_of_type_Long);
    if (this.jdField_a_of_type_Bits != null)
    {
      paramString1.putString("struct_url", this.jdField_a_of_type_Bits.getCurrentUrl());
      paramString1.putBoolean("from_web", true);
    }
    if (this.jdField_a_of_type_Bitg != null) {
      i = this.jdField_a_of_type_Bitg.switchRequestCode(this.jdField_a_of_type_Psd, (byte)2, true);
    }
    bmud.a(this.jdField_a_of_type_Bioy.a(), this.jdField_a_of_type_AndroidAppActivity, paramString1, null, i);
  }
  ...
  public void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131695740, new Object[] { paramString5 }));
      ...
      if (paramJSONObject.has("serviceID"))
      {
        ...
        if ((paramInt == 116) || (paramInt == 123)) {
          localIntent.putExtra("compatible_text", aqyt.a);
        }
      }
      ...
      paramJSONObject = this.jdField_a_of_type_Bioy.a();
      if (paramJSONObject != null)
      {
        c();
        localIntent.putExtra("struct_share_key_source_name", Long.toString(l));
        abgu.a(paramJSONObject, this.jdField_a_of_type_AndroidAppActivity, paramJSONObject.getAccount(), l, 3000L, new uax(this, localIntent));
      }
      return;
    ...
    for (;;)
    {
      ...
      {
        paramString2 = this.jdField_a_of_type_Bioy.a().getEntityManagerFactory(this.jdField_a_of_type_Bioy.a().getAccount()).createEntityManager();
      ...
      for (paramString2 = paramString5.name;; paramString2 = null)
      {
        ...
        for (;;)
        {
          if (paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131698568)))
          {
            boolean bool = paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131698568));
            if (bool)
            {
          ...
          for (;;)
          {
            localIntent.putExtra("stuctmsg_bytes", bdow.a(localIntent.getExtras()).getBytes());
            this.jdField_a_of_type_Psd.startActivityForResult(localIntent, (byte)1);
            return;
            if (paramJSONObject.has("sourceName")) {
            ...
            {
              localIntent.putExtra("app_name", this.jdField_a_of_type_AndroidAppActivity.getString(2131695756));
            }
          }
          paramString2 = paramString3;
        }
