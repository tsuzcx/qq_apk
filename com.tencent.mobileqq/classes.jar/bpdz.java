  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  private bpea jdField_a_of_type_Bpea;
  ...
  public bpdz(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Bpea = new bpea();
    this.jdField_a_of_type_Bpea.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Bpea.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bpea.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bpea = null;
  ...
  {
    this.jdField_a_of_type_Bpea.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bpea.a("before updateTexImage");
