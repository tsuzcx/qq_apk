  ...
  implements Manager
{
  ...
  private agta jdField_a_of_type_Agta;
  private Context jdField_a_of_type_AndroidContentContext;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  public agtb(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Agta = new agta(paramQQAppInterface);
  }
      ...
      else
      {
        ...
        if ((localObject != null) && (localObject.length > 0))
        {
          ...
          while (paramInt1 < paramInt2)
          {
            ...
            {
              int i = baig.e(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), str);
              ...
              {
                long l = baig.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), str);
                ...
                else if (!agsy.a(this.jdField_a_of_type_AndroidContentContext, paramHtmlOfflineCheckConfig.net_type))
                {
                  if (QLog.isColorLevel()) {
                  ...
                  mof.b(str, this.jdField_a_of_type_ComTencentCommonAppAppInterface, new agtc(this, str, i), true, 0, true);
                }
              }
            }
            paramInt1 += 1;
  ...
  {
    int i = 0;
    if (this.jdField_a_of_type_Agta != null) {
      i = this.jdField_a_of_type_Agta.a();
    }
    return i;
  }
  ...
  public SpringFestivalRedpacketConfBean a()
  {
    ...
    return this.jdField_a_of_type_Agta.a();
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    try
    {
      NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_AndroidContentContext, agte.class);
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if ((paramQQAppInterface != null) && (paramInt >= 0)) {
      try
      {
        if (this.jdField_a_of_type_Agta != null)
        {
          int i = this.jdField_a_of_type_Agta.a();
          if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString)
  {
    ...
    boolean bool2 = agsy.a(paramString);
    int i;
    if (bool2)
    {
      i = 0;
      agvn.a(paramString, i, 0);
      if (bool2) {
        break label42;
      }
    }
  ...
  public boolean a(boolean paramBoolean, int paramInt1, int paramInt2, String paramString, List<Integer> paramList, int paramInt3)
  {
    try
    {
      if (this.jdField_a_of_type_Agta != null)
      {
        paramBoolean = this.jdField_a_of_type_Agta.a(paramBoolean, paramInt1, paramInt2, paramString, paramList, paramInt3);
        return paramBoolean;
      }
    }
  ...
  public int b()
  {
    int i = 0;
    if (this.jdField_a_of_type_Agta != null) {
      i = this.jdField_a_of_type_Agta.b();
    }
    return i;
  }
