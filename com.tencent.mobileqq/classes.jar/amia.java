  ...
  implements View.OnClickListener, FaceDecoder.DecodeTaskCompletionListener, HorizontalListView.OnItemScrollEventListener
{
  ...
  View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new amib(this);
  anvi jdField_a_of_type_Anvi = new amih(this);
  anvk jdField_a_of_type_Anvk;
  anyb jdField_a_of_type_Anyb;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected FaceDecoder a;
  private HorizontalListView.OnScrollStateChangedListener jdField_a_of_type_ComTencentWidgetHorizontalListView$OnScrollStateChangedListener = new amif(this);
  private HorizontalListView jdField_a_of_type_ComTencentWidgetHorizontalListView;
  protected Runnable a;
  private Hashtable<String, Bitmap> jdField_a_of_type_JavaUtilHashtable = new Hashtable();
  private List<MayKnowRecommend> jdField_a_of_type_JavaUtilList = new ArrayList();
  private int jdField_b_of_type_Int;
  View.OnTouchListener jdField_b_of_type_AndroidViewView$OnTouchListener = new amic(this);
  private Runnable jdField_b_of_type_JavaLangRunnable = new MayKnowAdapter.7(this);
  private int c;
  private int d;
  
  public amia(Activity paramActivity, QQAppInterface paramQQAppInterface, HorizontalListView paramHorizontalListView, amii paramamii, int paramInt1, int paramInt2)
  {
    ...
    g();
    this.d = anyb.jdField_a_of_type_Int;
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MayKnowAdapter", 2, "MayKnowAdapter ,mFriendObserver = " + this.jdField_a_of_type_Anvi);
      }
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.postDelayed(this.jdField_b_of_type_JavaLangRunnable, 1000L);
      return;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800674D", "0X800674D", 0, 0, "", "", "", "");
      continue;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800673E", "0X800673E", 0, 0, "", "", "", "");
      continue;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800673F", "0X800673F", 0, 0, "", "", "", "");
      continue;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006773", "0X8006773", 0, 0, "", "", "", "");
    }
  }
  ...
  private View a()
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildCount())
    {
      ...
      if ((localView != null) && ((localView.getTag() instanceof amig)))
      {
        amig localamig = (amig)localView.getTag();
        if ((localamig == null) || (localamig.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend == null) || (localamig.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend.friendStatus == 0)) {}
      }
    }
    for (;;)
    {
  ...
  private View a(String paramString)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildCount())
    {
      ...
      {
        amig localamig = (amig)localView.getTag();
        if ((localamig == null) || (localamig.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend == null) || (!TextUtils.equals(localamig.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend.uin, paramString))) {}
      }
    }
    for (;;)
    {
  ...
  {
    a(paramView, new amid(this, paramView));
  }
  
  private void a(View paramView, Animation.AnimationListener paramAnimationListener)
  {
    amie localamie = new amie(this, paramView, paramView.getMeasuredWidth());
    if (paramAnimationListener != null) {
      localamie.setAnimationListener(paramAnimationListener);
    }
    localamie.setDuration(240L);
    paramView.startAnimation(localamie);
  }
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Anyb != null) {
      this.jdField_a_of_type_JavaUtilList = this.jdField_a_of_type_Anyb.c();
    }
  ...
  public void a()
  {
    ...
    int i;
    if ((getCount() > 0) && (this.jdField_a_of_type_ComTencentWidgetHorizontalListView.isShown()) && (this.jdField_a_of_type_Anyb != null)) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Anyb.a(a(i), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
      i += 1;
    }
  }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Anyb.b(a(i), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
      i += 1;
    }
  }
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      if ((localAppRuntime instanceof QQAppInterface)) {
        ((QQAppInterface)localAppRuntime).removeObserver(this.jdField_a_of_type_Anvi);
      }
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    amig localamig = null;
    if (paramView != null) {
      localamig = (amig)paramView.getTag();
    }
    if ((paramView == null) || (localamig == null) || (localamig.jdField_a_of_type_Boolean) || (!TextUtils.equals(localamig.jdField_b_of_type_JavaLangString, ThemeUtil.curThemeId)))
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558471, paramViewGroup, false);
      localamig = new amig();
      localamig.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368094));
      localamig.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371980));
      localamig.jdField_a_of_type_AndroidWidgetTextView.getPaint();
      localamig.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367433));
      localamig.c = ((TextView)paramView.findViewById(2131361946));
      localamig.d = ((TextView)paramView.findViewById(2131362146));
      localamig.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364699);
      localamig.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      localamig.jdField_a_of_type_AndroidViewView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      localamig.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      localamig.jdField_a_of_type_AndroidWidgetImageView.setOnTouchListener(this.jdField_b_of_type_AndroidViewView$OnTouchListener);
      if ((localamig.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)localamig.jdField_a_of_type_AndroidWidgetImageView).setSupportMaskView(false);
      }
      localamig.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
      localamig.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this.jdField_a_of_type_AndroidViewView$OnTouchListener);
      paramView.setTag(localamig);
      if (this.jdField_a_of_type_Int != 25)
      {
        localamig.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167026));
        localamig.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167120));
      }
      localamig.jdField_b_of_type_JavaLangString = ThemeUtil.curThemeId;
    }
    for (;;)
    {
      MayKnowRecommend localMayKnowRecommend = a(paramInt);
      if (this.jdField_a_of_type_Anyb != null) {
        this.jdField_a_of_type_Anyb.a(localMayKnowRecommend, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
      }
      StringBuilder localStringBuilder = new StringBuilder();
      localamig.jdField_a_of_type_JavaLangString = localMayKnowRecommend.uin;
      localamig.jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend = localMayKnowRecommend;
      localamig.jdField_a_of_type_AndroidViewView.setTag(localMayKnowRecommend);
      localamig.jdField_a_of_type_AndroidWidgetImageView.setTag(localamig);
      localamig.jdField_a_of_type_AndroidWidgetTextView.setTag(localamig);
      localamig.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(a(1, localamig.jdField_a_of_type_JavaLangString));
      if (this.jdField_a_of_type_Anyb != null) {}
      for (boolean bool = this.jdField_a_of_type_Anyb.a();; bool = false)
      {
        String str = localMayKnowRecommend.getDisplayName(bool);
        localamig.jdField_a_of_type_AndroidWidgetTextView.setText(str);
        if ((AppSetting.c) && (!TextUtils.isEmpty(str))) {
          localStringBuilder.append(str);
        }
        if (!TextUtils.isEmpty(localMayKnowRecommend.recommendReason))
        {
          localamig.jdField_b_of_type_AndroidWidgetTextView.setText(localMayKnowRecommend.recommendReason);
          if (AppSetting.c) {
          ...
          localamig.c.setVisibility(0);
          localamig.c.setTag(localMayKnowRecommend);
          localamig.d.setVisibility(8);
          localamig.c.setOnClickListener(this);
          if (AppSetting.c)
          {
            localamig.c.setContentDescription(anvx.a(2131689550));
        ...
        for (;;)
        {
          ...
          return paramView;
          localamig.jdField_b_of_type_AndroidWidgetTextView.setText("");
          break;
          label701:
          if (localMayKnowRecommend.friendStatus == 1)
          {
            localamig.c.setVisibility(8);
            localamig.d.setVisibility(0);
            localamig.d.setText(2131718061);
            if (!AppSetting.c) {
              break label636;
            }
            localamig.d.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718061));
            localStringBuilder.append(",等待验证");
            break label636;
          }
          localamig.c.setVisibility(8);
          localamig.d.setVisibility(0);
          localamig.d.setText(2131690030);
          if (!AppSetting.c) {
            break label636;
          }
          localamig.d.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131690030));
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if ((this.jdField_a_of_type_Anvk != null) && (!this.jdField_a_of_type_Anvk.b(((MayKnowRecommend)localObject1).uin)) && (!this.jdField_a_of_type_Anvk.d(((MayKnowRecommend)localObject1).uin)))
          {
            bool = false;
            if (this.jdField_a_of_type_Anyb != null) {
            ...
            ((Intent)localObject2).putExtra("key_param_age_area", bhaa.a(this.jdField_a_of_type_AndroidAppActivity, ((MayKnowRecommend)localObject1).gender, ((MayKnowRecommend)localObject1).age, ((MayKnowRecommend)localObject1).country, ((MayKnowRecommend)localObject1).province, ((MayKnowRecommend)localObject1).city));
          ...
          {
            if (this.jdField_a_of_type_Anyb != null) {
              this.jdField_a_of_type_Anyb.a((MayKnowRecommend)localObject1, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 3);
            }
            ...
            break;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006750", "0X8006750", 0, 0, "", "", "", "");
            continue;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006744", "0X8006744", 0, 0, "", "", "", "");
            continue;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006745", "0X8006745", 0, 0, "", "", "", "");
            continue;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006771", "0X8006771", 0, 0, "", "", "", "");
            continue;
            if ((this.jdField_a_of_type_Anvk != null) && (this.jdField_a_of_type_Anvk.b(((MayKnowRecommend)localObject1).uin)))
            {
        ...
        ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).cancelMayKnowRecommend(((MayKnowRecommend)localObject1).uin);
        switch (this.jdField_b_of_type_Int)
        {
        }
        while ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
        {
          ...
          break;
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800674F", "0X800674F", 0, 0, "", "", "", "");
          continue;
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006742", "0X8006742", 0, 0, "", "", "", "");
          continue;
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006743", "0X8006743", 0, 0, "", "", "", "");
          continue;
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006772", "0X8006772", 0, 0, "", "", "", "");
        }
        localObject1 = (amig)paramView.getTag();
      } while (localObject1 == null);
      localObject1 = ((amig)localObject1).jdField_a_of_type_ComTencentMobileqqDataMayKnowRecommend;
    } while (localObject1 == null);
    int i = 84;
    ...
    default: 
      ...
      {
        j = i;
        if (this.jdField_a_of_type_Anvk.b(((MayKnowRecommend)localObject1).uin)) {
          j = 1;
        }
      }
      ...
      if (this.jdField_a_of_type_Anyb != null) {
        this.jdField_a_of_type_Anyb.a((MayKnowRecommend)localObject1, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 2);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        switch (this.jdField_b_of_type_Int)
        {
    ...
    while ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      i = 107;
      break label872;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800674E", "0X800674E", 0, 0, "", "", "", "");
      continue;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006740", "0X8006740", 0, 0, "", "", "", "");
      continue;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006741", "0X8006741", 0, 0, "", "", "", "");
      continue;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800678A", "0X800678A", 0, 0, "", "", "", "");
    }
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    if (paramInt1 <= 0)
    {
      ...
      while (paramInt1 < paramInt2)
      {
        ...
        if ((paramString != null) && ((paramString instanceof amig)))
        {
          paramString = (amig)paramString;
  ...
  public void onItemScrollNonVisible(int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Anyb != null) {
      this.jdField_a_of_type_Anyb.b(a(paramInt), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, 1);
    }
  }
}
