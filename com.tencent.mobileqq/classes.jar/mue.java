...
{
  mue(QQAppInterface paramQQAppInterface, nbu paramnbu, int paramInt, String paramString) {}
      ...
      try
      {
        ...
        if (paramBundle != null)
        {
          ...
          if (((mobileqq_mp.RetInfo)((mobileqq_mp.SetFunctionFlagResponse)localObject).ret_info.get()).ret_code.get() == 0)
          {
            ...
            if (localObject != null) {
              paramBundle = ((ajoy)localObject).a(this.jdField_a_of_type_JavaLangString);
            }
            if (paramBundle != null)
            {
              if (this.jdField_a_of_type_Nbu.e == 6)
              {
                ...
                localPublicAccountHandler.notifyUI(109, true, this.jdField_a_of_type_Nbu);
                return;
              }
              if (this.jdField_a_of_type_Nbu.e != 3) {
                continue;
              }
              paramBundle.isSyncLbs = true;
              if (this.jdField_a_of_type_Nbu.d != 1) {
                break label315;
              }
              paramBoolean = true;
          ...
          {
            localPublicAccountHandler.notifyUI(109, false, this.jdField_a_of_type_Nbu);
          }
        }
        else
        {
