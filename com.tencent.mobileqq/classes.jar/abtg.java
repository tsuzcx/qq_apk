  ...
  extends absj
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "DoraemonOpenAPI." + abtg.class.getSimpleName();
  }
  ...
  private void a(JSONObject paramJSONObject, absf paramabsf)
  {
    ...
    if (i <= 0)
    {
      abvm.a(paramabsf, -100, "rankingID must be bigger than 0");
      return;
    }
    Object localObject = (abtp)this.jdField_a_of_type_Absi.a(abtp.class, false);
    if (localObject == null)
    {
      abvm.a(paramabsf, -10, "internal error, try again.");
      return;
    }
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject = ((abtp)localObject).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Absi.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Absi.jdField_a_of_type_Int);
    localReqBody.openid.set(((abts)localObject).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((abts)localObject).b);
    ...
    mzy.a(BaseApplicationImpl.getApplication().getRuntime(), new abth(this, (abts)localObject, paramJSONObject, paramabsf), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 2, null, 0L);
  }
  ...
  private void b(JSONObject paramJSONObject, absf paramabsf)
  {
    ...
    if (i <= 0)
    {
      abvm.a(paramabsf, -100, "rankingID 没有传或者值小于等于0");
      return;
    }
    Object localObject1 = (abtp)this.jdField_a_of_type_Absi.a(abtp.class, false);
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject1 = ((abtp)localObject1).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Absi.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Absi.jdField_a_of_type_Int);
    localReqBody.openid.set(((abts)localObject1).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((abts)localObject1).b);
    ...
    {
      abvm.a(paramabsf, -101, "参数处理错误, 是否是类型不对? 查看一下文档吧. \nerrorMsg: " + paramJSONObject.getMessage());
      return;
    }
    mzy.a(BaseApplicationImpl.getApplication().getRuntime(), new abti(this, (abts)localObject1, paramJSONObject, paramabsf), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 1, null, 0L);
  }
