...
public class bdbv
{
  ...
  private static int b(String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    for (;;)
    {
      alzy.a(paramString1, paramInt2, i, 0, 0, paramInt2, i);
      long l1;
      long l3;
      long l2;
      long l4;
      ...
      for (;;)
      {
        ...
        Bitmap localBitmap = alzy.b(l3, l5);
        long l5 = System.currentTimeMillis();
        if (localBitmap != null) {}
        try
        {
          bhmq.a(localBitmap, new File((String)localObject1 + File.separator + l3 + ".jpg"));
          ...
          if (l2 > l3)
          {
            ...
            if (l3 <= l1)
            {
              ...
              if (paramString1 != null) {
                bhmq.a(paramString1.copy(Bitmap.Config.ARGB_8888, true), new File(paramString2 + File.separator + l3 + ".jpg"));
              }
              long l6 = System.currentTimeMillis();
              if (QLog.isColorLevel()) {
  ...
  private static int c(String paramString1, String paramString2)
  {
    ...
    else
    {
      ...
      i = bnlk.a(new String[] { "-i", paramString1, "-vf", localObject1, "-y", str3 });
