  ...
  extends alga
{
  ...
  private String a()
  {
    ...
    if (this.jdField_a_of_type_Bmob.d != 1) {
      return this.jdField_a_of_type_Bmob.j;
    }
    return a(this.jdField_a_of_type_Bmob.e, this.jdField_a_of_type_Bmob.f);
  }
  ...
  public View a()
  {
    ...
    this.b = ((TextView)localView.findViewById(2131380149));
    this.c = ((TextView)localView.findViewById(2131379798));
    return localView;
  }
  ...
  {
    super.a(paramalfw);
    ThreadManagerV2.getUIHandlerV2().post(new QbossADBannerCountDownManager.1(this, paramalfw));
  }
