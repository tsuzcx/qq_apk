  ...
  implements awbo
{
  ...
  public awbp(QQAppInterface paramQQAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    {
      xfp localxfp = this.app.a.a(this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg.getServiceCmd());
      ...
      if (localxfp != null)
      {
        ...
        localObject1 = localObject2;
        if (localxfp.a(this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg, localUniPacket))
        {
