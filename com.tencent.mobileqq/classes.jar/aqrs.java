  ...
  implements aqvz
{
  ...
  protected LinkedHashMap<Long, aqrt> a;
  
  public aqrs(QQAppInterface paramQQAppInterface)
  {
  ...
  protected final aqrt a(long paramLong)
  {
    ...
    aqrt localaqrt = (aqrt)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Long.valueOf(paramLong));
    return localaqrt;
  }
  ...
  protected final void a(aqrt paramaqrt)
  {
    if (paramaqrt == null)
    {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilLinkedHashMap)
    {
      QLog.i("BaseThumbDownloader<FileAssistant>", 2, "[downloadThumb]  ID[" + paramaqrt.jdField_a_of_type_Long + "] addSession");
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(Long.valueOf(paramaqrt.jdField_a_of_type_Long), paramaqrt);
      if (QLog.isDevelopLevel())
      {
        paramaqrt = this.jdField_a_of_type_JavaUtilLinkedHashMap.keySet().iterator();
        if (paramaqrt.hasNext())
        {
          long l = ((Long)paramaqrt.next()).longValue();
  ...
  protected void a(aqrt paramaqrt, String paramString)
  {
    if ((paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext != null) && ((paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext instanceof String)) && ("igonFlow".equalsIgnoreCase((String)paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext))) {
      paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.mContext = null;
    }
    for (int i = 1;; i = 0)
    {
      if ((i == 0) && (!aqxg.a()) && (arni.a()))
      {
        QLog.i("BaseThumbDownloader<FileAssistant>", 1, "[downloadThumb] Id[" + paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId + "] size(wh)[" + paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgWidth + ":" + paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgHeight + "]autoDownload Thumb switch is off!");
        return;
      }
      long l = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString, this);
      if (l == -1L)
      {
        QLog.w("BaseThumbDownloader<FileAssistant>", 1, "[downloadThumb] Id[" + paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId + "] size(wh)[" + paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgWidth + ":" + paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.imgHeight + "] thumb is Downloading,waiting please!");
        return;
      }
      paramString = paramaqrt.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
      ...
      paramaqrt.jdField_a_of_type_Long = l;
      a(paramaqrt);
