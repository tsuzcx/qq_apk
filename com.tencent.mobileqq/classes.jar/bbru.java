  ...
  extends Observable
{
  ...
  public bbru(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new ArrayList());
    this.jdField_a_of_type_AndroidOsHandler = new bbrv(this, Looper.getMainLooper());
    this.jdField_a_of_type_Bckx = new bbrw(this);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangLong = paramLong;
  }
  
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt, bckx parambckx)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("muid", MD5.toMD5(bdgk.a()));
      ((JSONObject)localObject2).put("carrier", bdgk.e());
      ((JSONObject)localObject2).put("conn", ndd.a());
      ...
      if (paramQQAppInterface != null)
      {
        ...
        new bckw(paramQQAppInterface, "GET", parambckx, paramInt, null, true).execute(new HashMap[] { localObject2 });
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          {
            localTroopFeedItem.tag = alud.a(2131715706);
            ...
            localObject = new ByteArrayInputStream(azwm.a(localTroopNotificationCache.xmlBytes, i));
            localbbrx = new bbrx(this);
            SAXParserFactory.newInstance().newSAXParser().parse((InputStream)localObject, localbbrx);
            ((InputStream)localObject).close();
            if (localTroopNotificationCache.serviceID == 20)
            {
              localTroopFeedItem.title = localbbrx.jdField_a_of_type_JavaLangString;
              localTroopFeedItem.content = "";
              localTroopFeedItem.picPath = localbbrx.jdField_b_of_type_JavaLangString;
              localTroopFeedItem.linkUrl = localbbrx.jdField_d_of_type_JavaLangString;
          ...
          for (;;)
          {
            localTroopFeedItem.tag = alud.a(2131715707);
            localTroopFeedItem.type = 133;
            break;
            localTroopFeedItem.title = localTroopNotificationCache.title;
            localTroopFeedItem.content = localbbrx.jdField_c_of_type_JavaLangString;
            break label282;
            i = 0;
            break;
            i = 0;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      new bckw("https://web.qun.qq.com/cgi-bin/announce/get_feed", "GET", this.jdField_a_of_type_Bckx, paramInt, null, true).execute(new HashMap[] { localObject1 });
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    ((HashMap)localObject1).put("CONTEXT", MobileQQ.getContext());
    new bckw("https://web.qun.qq.com/cgi-bin/announce/get_t_list", "GET", this.jdField_a_of_type_Bckx, paramInt, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
