...
public class bgpu
{
  ...
  public bgpu(int paramInt)
  {
    this.a = new Intent();
    this.a.putExtra("nType", paramInt);
  }
  
  public bgpu(Intent paramIntent)
  {
    this.a = paramIntent;
  }
  
  public static bgpu a(float paramFloat1, float paramFloat2, String paramString1, String paramString2, String paramString3)
  {
    return new bgpu(7).b("sLocation", paramString2).b("sBrief", paramString3).b("sPublisher", paramString1).a("fLatitude", paramFloat1).a("fLongitude", paramFloat2);
  }
  
  public static bgpu a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, byte[] paramArrayOfByte, boolean paramBoolean, long paramLong)
  {
    ...
    {
      paramArrayOfByte = bgqm.a(paramArrayOfByte);
      str6 = bgqm.a(paramArrayOfByte[0], paramString1);
      str5 = bgqm.a(paramArrayOfByte[1], paramString2);
      str4 = bgqm.a(paramArrayOfByte[2], paramString3);
      str3 = bgqm.a(paramArrayOfByte[3], paramString4);
      str2 = bgqm.a(paramArrayOfByte[4], paramString5);
      str1 = bgqm.a(paramArrayOfByte[5], paramString6);
    }
    paramString1 = new bgpu(6).a("nLinkType", paramInt).b("sTitle", str6).b("sUrl", str5).a("bAppShare", paramBoolean).a("lAppId", paramLong).b("sPublisher", str4).b("sBrief", str3).b("sPath", str2).b("sResUrl", str1);
    if (paramBoolean) {}
  ...
  public static bgpu a(Intent paramIntent)
  {
    int i = 1;
    if (paramIntent == null) {
      return null;
    ...
    for (i = (int)new File((String)localObject).length();; i = paramIntent.getIntExtra("file_thumb_Size", 0))
    {
      ...
      localObject = new bgpu(5);
      ((bgpu)localObject).a.putExtra("shortVideoContents", localContentValues);
      return ((bgpu)localObject).c(paramIntent.getStringExtra("from_uin"));
      i = j;
      break;
      l = 0L;
      break label132;
  ...
  public static bgpu a(auko paramauko)
  {
    return new bgpu(2).c(paramauko);
  }
  
  public static bgpu a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return null;
    }
    bgpu localbgpu = new bgpu(8).c(paramMessageForStructing);
    if (!bgqm.a(paramMessageForStructing))
    {
      localbgpu.c(paramMessageForStructing);
      return localbgpu;
    }
    ArrayList localArrayList = new ArrayList();
    byte[] arrayOfByte = bgqm.a(paramMessageForStructing.uniseq, paramMessageForStructing.structingMsg);
    if (arrayOfByte != null) {
    ...
    {
      arrayOfByte = bgqm.a(paramMessageForStructing.uniseq, l);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      arrayOfByte = bgqm.a(-1L, paramMap);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      bgqm.a(paramQQAppInterface, paramMessageForStructing, paramList, paramMap, localArrayList);
      if (localArrayList != null) {
        localbgpu.b("sBizDataList", localArrayList);
      }
      return localbgpu;
    }
  }
  
  public static bgpu a(MessageForShortVideo paramMessageForShortVideo)
  {
    ContentValues localContentValues = new ContentValues();
    ...
    for (long l1 = new File(str).length();; l1 = paramMessageForShortVideo.thumbFileSize)
    {
      ...
      paramMessageForShortVideo = new bgpu(5);
  ...
  public static bgpu a(String paramString)
  {
    return new bgpu(6).b("sUrl", paramString);
  }
  
  public static bgpu a(String paramString1, int paramInt, String paramString2)
  {
    return new bgpu(4).b("sPath", paramString1).a("nDuration", paramInt).b("sBrief", paramString2);
  }
  
  public static bgpu a(String paramString1, int paramInt, String paramString2, long paramLong1, String paramString3, long paramLong2)
  {
    paramInt = bgqm.b(paramInt);
    ...
    for (;;)
    {
      ...
      return new bgpu(2).b("sMD5", paramString1).b("sPath", paramString3).a("nPicType", paramInt).b("sPicId", paramString2).a("lSize", paramLong2);
    }
  }
  
  public static bgpu a(String paramString1, String paramString2)
  {
    return new bgpu(1).b("sText", paramString2).b("sTitle", paramString1);
  }
  
  public static bgpu a(ArrayList<String> paramArrayList, boolean paramBoolean1, String paramString1, String paramString2, boolean paramBoolean2, long paramLong, String paramString3)
  {
    paramArrayList = new bgpu(8).a("sPathList", paramArrayList).b("sTitle", paramString1).a("bOnlyPic", paramBoolean1).b("sText", paramString2).a("bAppShare", paramBoolean2).a("lAppId", paramLong).b("sAppName", paramString3);
    if (paramBoolean2) {}
    for (paramLong = 4L;; paramLong = 1L) {
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      bgpw.a(paramActivity, str, bool, null, false);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    {
      return;
      localObject2 = (MessageForArkApp)alsw.a(1, ((MessageForArkApp)localObject1).ark_app_message.appName, localObject1, localObject1);
      ...
      try
      {
        ...
        if (ampu.c.equals(((MessageForArkApp)localObject1).ark_app_message.appName))
        {
          ...
          bgqi.a(paramQQAppInterface, 11, 0, paramChatMessage.istroop);
          return;
        }
      }
    ...
    {
      localObject3 = paramContext.getString(2131719079);
    ...
    for (i = 4;; i = 5)
    {
      ...
      bgqi.a(paramQQAppInterface, 9, 0, paramChatMessage.istroop);
      return;
      bgqi.a(paramQQAppInterface, 8, 0, paramChatMessage.istroop);
      return;
      break label50;
      break;
      i = 1;
  ...
  public static bgpu b(auko paramauko)
  {
    return new bgpu(8).c(paramauko);
  }
  
  public static bgpu b(String paramString)
  {
    return new bgpu(2).b("sPath", paramString);
  }
  ...
  public bgpu a(int paramInt, long paramLong1, String paramString1, long paramLong2, String paramString2)
  {
  ...
  public bgpu a(long paramLong)
  {
    return a("requestId", paramLong);
  }
  
  public bgpu a(long paramLong, String paramString)
  {
    this.a.putExtra("nAuthorType", 1).putExtra("lUin", paramLong).putExtra("sName", paramString);
    return this;
  }
  
  public bgpu a(QQAppInterface paramQQAppInterface)
  {
  ...
  public bgpu a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public bgpu a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if (paramQQAppInterface == null) {
      return this;
    }
    int i = bgqm.a(paramInt2);
    String str2 = "";
    long l6 = 0L;
    Object localObject4 = "";
    long l5 = 0L;
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          l3 = l1;
          localObject1 = bajp.a(paramMessageRecord);
          ...
          paramString1 = (String)localObject4;
          l3 = l1;
          paramMessageRecord = ((bajq)localObject1).c;
        }
        ...
        paramString1 = paramMessageRecord;
        l3 = l1;
        localObject3 = bbcz.a(paramQQAppInterface, (String)localObject1, true);
        l4 = l2;
        localObject2 = localObject3;
        paramString1 = paramMessageRecord;
        l3 = l1;
        ...
        try
        {
          localObject1 = bbcz.c(paramQQAppInterface, paramString2);
          paramString1 = (String)localObject1;
        ...
        if (str1 != null)
        {
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bbcz.b(paramQQAppInterface, str1, paramInt2);
          l1 = 0L;
          l2 = l5;
          localObject3 = localObject4;
          continue;
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bbcz.b(paramQQAppInterface, paramString2, paramInt2);
          l4 = l5;
          localObject2 = localObject4;
          paramString1 = (String)localObject1;
          l3 = l6;
    ...
    for (;;)
    {
      ...
      paramString1 = str2;
      l3 = l6;
      localObject3 = bbcz.b(paramQQAppInterface, str1, 0);
      ...
      if (((String)localObject3).equals(str1))
      {
        ...
        if (paramInt2 == 3000)
        {
          ...
          paramString1 = (String)localObject3;
          l3 = l6;
          localObject1 = bbcz.a(paramQQAppInterface, paramString2, str1);
        }
      }
      l4 = l5;
      localObject2 = localObject4;
      ...
      for (localObject3 = bbcz.a(paramQQAppInterface, paramString2, true);; localObject3 = bbcz.c(paramQQAppInterface, paramString2))
      {
        l4 = l5;
        localObject2 = localObject3;
        paramString1 = (String)localObject1;
  ...
  public bgpu a(String paramString, float paramFloat)
  {
    this.a.putExtra(paramString, paramFloat);
    return this;
  }
  
  public bgpu a(String paramString, int paramInt)
  {
    this.a.putExtra(paramString, paramInt);
    return this;
  }
  
  public bgpu a(String paramString, long paramLong)
  {
    this.a.putExtra(paramString, paramLong);
    return this;
  }
  
  public bgpu a(String paramString, ArrayList<String> paramArrayList)
  {
    this.a.putStringArrayListExtra(paramString, paramArrayList);
    return this;
  }
  
  public bgpu a(String paramString, boolean paramBoolean)
  {
  ...
  public boolean a(Activity paramActivity, String paramString, int paramInt, bgpv parambgpv)
  {
    ...
    bgpw.a(paramActivity, paramString, bool, (String)localObject1, false, paramInt);
    if (parambgpv != null) {
      parambgpv.b(bool);
    }
    return bool;
  ...
  {
    bgqj.a().a = true;
    String str = apvd.a(paramFileManagerEntity.fileName);
    int m = 6;
    ...
    {
      if (!paramBoolean) {
        bgqm.a(paramActivity, 2131692328, 1);
      }
      bgqi.a(paramQQAppInterface, "User_AddFav", 6, -80010, m, i, str, null);
    ...
    int i1 = apug.a(paramFileManagerEntity);
    switch (i1)
    {
    case 3: 
    default: 
      if (!paramBoolean) {
        bgqm.a(paramActivity, 2131692329, 0);
      }
      bgqi.a(paramQQAppInterface, "User_AddFav", 6, -80003, m, i, str, null);
      paramQQAppInterface = new ContentValues();
    ...
    case 1: 
      ...
      {
        if (!paramBoolean) {
          bgqm.a(paramActivity, 2131692327, 1);
        }
        bgqi.a(paramQQAppInterface, "User_AddFav", 6, -80011, m, i, str, null);
        paramQQAppInterface = new ContentValues();
    ...
    case 3: 
      ...
      if (!paramBoolean)
      {
        ...
        label792:
        if (paramChatMessage != null) {
          bgqi.a(paramQQAppInterface, 5, paramFileManagerEntity.nFileType, paramChatMessage.istroop);
        }
        bgqi.a(paramQQAppInterface, "User_AddFav", 6, 0, m, i, str, null);
        return paramBoolean;
  ...
  public bgpu b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public bgpu b(String paramString1, String paramString2)
  {
    this.a.putExtra(paramString1, paramString2);
    return this;
  }
  
  public bgpu b(String paramString, ArrayList<byte[]> paramArrayList)
  {
  ...
  public boolean b(Activity paramActivity, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    } while ((paramIntent.getIntExtra("nPicType", 1) != 1) || (!bgqm.a(str, paramIntent.getLongExtra("lSize", -1L))));
    paramIntent.putExtra("nReasonInt", 2131695192);
    if (QLog.isColorLevel()) {
      QLog.i("qqfav", 1, "QfavBuilder.add: picture too big [" + str + "]");
    }
    bgqi.a(null, "Net_AddFav", 3, 3, -3);
    return false;
  }
  
  public bgpu c(auko paramauko)
  {
    this.a.putExtra("cvEntityContents", bgqm.a(paramauko, ""));
    this.a.putExtra("sEntityClassName", paramauko.getClass().getName());
    return this;
  }
  
  public bgpu c(String paramString)
  {
    try
    {
  ...
  public boolean c(Activity paramActivity, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    bgpw.a(paramActivity, paramString, bool, "", false, 2131692325);
    return bool;
  }
}
