  ...
  implements baxl, bfob
{
  ...
  protected boolean a;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new aimq(this);
  private List<aukm> jdField_b_of_type_JavaUtilList = new ArrayList();
  public boolean b;
  
  public aimo(Context paramContext, aims paramaims, ListView paramListView, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aimr(this);
  ...
  private void a(String paramString, Bitmap paramBitmap)
  {
    ...
    if (i < j)
    {
      ...
      if ((paramString == null) && (!TextUtils.isEmpty(((aimt)localObject).jdField_a_of_type_JavaLangString)))
      {
        paramBitmap = this.jdField_a_of_type_Baxk.a(101, ((aimt)localObject).jdField_a_of_type_JavaLangString);
        if (paramBitmap != null) {
          ((aimt)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        }
      }
    }
    label169:
    for (;;)
    {
      i += 1;
      break;
      this.jdField_a_of_type_Baxk.a(((aimt)localObject).jdField_a_of_type_JavaLangString, 101, true);
      continue;
      if (TextUtils.equals(paramString, ((aimt)localObject).jdField_a_of_type_JavaLangString))
      {
        ((aimt)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap));
        return;
      }
  ...
  private void b()
  {
    this.jdField_a_of_type_JavaUtilList = ((ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a();
    Object localObject1 = new HashMap();
    Object localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131720631);
    ...
    if (localIterator.hasNext())
    {
      ...
      long l = 0L;
      String str2 = bbcl.a(this.jdField_a_of_type_AndroidContentContext, localDiscussionInfo);
    ...
    Collections.sort(this.jdField_a_of_type_JavaUtilList, new aimp(this, (HashMap)localObject1));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == 1)
    {
      ...
      if (paramView == null)
      {
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365229));
        ...
        ((Button)paramView.findViewById(2131365222)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        localObject1 = (DiscussionInfo)getItem(paramInt);
        str = ((DiscussionInfo)localObject1).uin;
        localObject2 = bbcl.a(this.jdField_a_of_type_AndroidContentContext, (DiscussionInfo)localObject1);
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(String.format("(%d)", new Object[] { Integer.valueOf(((ajvk)localObject2).a(str)) }));
        localObject2 = this.jdField_a_of_type_Baxk.a(101, str);
        if (localObject2 != null) {
          break label314;
        }
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(bbdr.e());
      }
      for (;;)
      {
        if (this.jdField_a_of_type_Int == 0) {
          this.jdField_a_of_type_Baxk.a(str, 101, false);
        }
    ...
    if (paramView == null)
    {
      paramView = new aimt(null);
      localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558989, paramViewGroup, false);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131365249));
    ...
    for (;;)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(2131694454);
      return localObject1;
      paramViewGroup = (aimt)paramView.getTag();
      localObject1 = paramView;
    }
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(2131694443);
    return localObject1;
  }
