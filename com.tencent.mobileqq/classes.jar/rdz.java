...
public class rdz
  implements ISuperPlayer.OnCaptureImageListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener, rdy
{
  ...
  private SparseArray<rdu> jdField_b_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  public void a(rdu paramrdu, rdw paramrdw)
  {
    try
    {
      int i = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.captureImageInTime(paramrdu.c, paramrdu.d, paramrdu.e, 0, 0, 300);
      paramrdu.a = i;
      this.jdField_b_of_type_AndroidUtilSparseArray.put(i, paramrdu);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramrdw);
      if (QLog.isColorLevel()) {
        QLog.d("PlayerCaptureProxy", 2, "PlayerCaptureProxy try capture captureTask:" + paramrdu);
      }
      return;
    }
    catch (IllegalAccessException paramrdw)
    {
      for (;;)
      {
        paramrdw.printStackTrace();
      }
    }
    finally {}
  }
  ...
  public void onCaptureImageFailed(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (paramInt2 < this.jdField_a_of_type_AndroidUtilSparseArray.size())
      {
        ...
        {
          paramISuperPlayer = (rdw)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
  ...
  public void onCaptureImageSucceed(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt2 < this.jdField_a_of_type_AndroidUtilSparseArray.size())
      {
        ...
        {
          paramISuperPlayer = (rdw)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
          rdu localrdu = (rdu)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt1);
          this.jdField_b_of_type_AndroidUtilSparseArray.remove(paramInt1);
          if (paramISuperPlayer != null) {
            paramISuperPlayer.a(paramBitmap, localrdu);
          }
          this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt1);
        }
      }
  ...
  {
    bkdz.c(new PlayerCaptureProxy.2(this));
  }
}
