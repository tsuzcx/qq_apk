...
public class rdz
{
  private static QQHashMap<String, rdg> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap = new QQHashMap(2019, 10, 10000);
  public static String a;
  private static Map<String, rea> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public static rdg a(String paramString)
  {
    try
    {
      paramString = (rdg)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(paramString);
      return paramString;
    }
    finally
    {
  ...
  public static rea a(String paramString)
  {
    rea localrea = (rea)jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localrea != null) {
      return localrea;
    }
    localrea = new rea();
    ...
    if (str == null)
    {
      ...
      localrea.a = false;
      jdField_a_of_type_JavaUtilMap.put(paramString, localrea);
      return localrea;
    }
    str = str + paramString;
  ...
  public static void a(String paramString, rdg paramrdg)
  {
    try
    {
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(paramString, paramrdg);
      return;
    }
    finally
    {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      return false;
      paramString3 = a("8.2.6");
      paramString3.add(Integer.valueOf(Integer.parseInt("4370")));
  ...
  {
    String str = bgmq.a("default_feeds_proteus_offline_bid");
    bace.a(mol.a(str) + str);
  }
}
