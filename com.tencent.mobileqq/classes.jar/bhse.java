  ...
  implements antf
{
  public static Intent a(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, String paramString15, String paramString16, String paramString17, String paramString18, Intent paramIntent, int paramInt3, String paramString19, long paramLong)
  {
    ...
    if ((paramContext instanceof binz))
    {
      paramString2 = ((binz)paramContext).a();
    ...
    paramString1 = bdow.a(localIntent.getExtras());
    if (paramString1 != null)
    {
      ...
      do
      {
        do
        {
          ...
          {
            return localIntent;
          } while (((1001 != paramInt1) && (38 != paramInt1)) || (!(paramContext instanceof binz)));
          paramContext = ((binz)paramContext).a();
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int i = bcpt.a;
        bcpt.a = i + 1;
        paramString = bcry.a(paramQQAppInterface, str, paramString, str, paramInt, i, paramAbsStructMsg);
        agsg.a().a(paramString.uniseq, 0L, paramAbsStructMsg.forwardID);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, AbsStructMsg paramAbsStructMsg, anui paramanui)
  {
    if (paramAbsStructMsg != null) {
      bdkt.a(paramAbsStructMsg);
    }
    ThreadManager.post(new ShareMsgHelper.1(paramQQAppInterface, paramString, paramInt, paramAbsStructMsg, paramanui), 8, null, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, AbsStructMsg paramAbsStructMsg, anui paramanui, String paramString2, String paramString3)
  {
    switch (paramInt)
    {
    default: 
    ...
    for (paramanui = str;; paramanui = paramString1)
    {
      paramAbsStructMsg = bcry.a(paramQQAppInterface, str, paramString1, paramanui, paramInt, l, paramAbsStructMsg);
      QLog.i(beai.i, 1, "sendDocsStructingMsg. disUin = " + paramString1 + ", disUinType = " + paramInt + ", seq = " + l + ", shmsgseq = " + paramAbsStructMsg.shmsgseq + ", time = " + paramAbsStructMsg.time);
      paramQQAppInterface.a().a(paramAbsStructMsg, null);
      if ((paramInt != 0) && (paramInt != 1)) {
        break;
      }
      becb.a(paramQQAppInterface, paramString1, paramInt, paramAbsStructMsg.shmsgseq, paramAbsStructMsg.time + 1L, paramString2, paramString3);
      return;
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, AbsStructMsg paramAbsStructMsg, anui paramanui)
  {
    if (paramAbsStructMsg != null) {
      bdkt.a(paramAbsStructMsg);
    }
    ThreadManager.getSubThreadHandler().post(new ShareMsgHelper.2(paramQQAppInterface, paramString1, paramString2, paramInt, paramAbsStructMsg, paramanui));
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, AbsStructMsg paramAbsStructMsg, anui paramanui)
  {
    switch (paramInt)
    {
    }
    do
    {
      ...
      {
        return;
        paramanui = paramQQAppInterface.getCurrentAccountUin();
        i = bcpt.a;
        bcpt.a = i + 1;
        long l = i;
        ...
        if (paramAbsStructMsg.mMsgServiceID == 80)
        {
          if (TextUtils.isEmpty(paramString2)) {
            paramString2 = paramanui;
          }
          for (;;)
          {
            paramString2 = bcry.a(paramQQAppInterface, paramanui, paramString1, paramString2, paramInt, l, paramAbsStructMsg);
            if (paramAbsStructMsg.mMsgServiceID != 41) {
              break;
            }
            agsg.a().a(paramString2.uniseq, paramAbsStructMsg.parentUniseq, i);
        ...
        if (paramAbsStructMsg.mMsgServiceID == 100)
        {
          ...
          paramString1 = bcry.a(paramQQAppInterface, paramanui, paramString1, paramanui, paramInt, l, paramAbsStructMsg);
          agsg.a().a(paramString1.uniseq, paramAbsStructMsg.parentUniseq, i);
          paramQQAppInterface.a().a(paramString1, new bhsf());
          return;
        }
        agsg.a().a(paramString2.uniseq, paramAbsStructMsg.parentUniseq, i);
      ...
      if (paramAbsStructMsg.mMsgServiceID == 1)
      {
        ...
        i = bcpt.a;
        bcpt.a = i + 1;
        paramString1 = bcry.a(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, i, paramAbsStructMsg);
