  ...
  implements bjqi
{
  ...
  public alay(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener)
  {
    super(paramContext, paramQQAppInterface, paramExpandableListView);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new alaz(this);
    this.jdField_c_of_type_AndroidViewView$OnClickListener = new alba(this);
  ...
  private void a(aiph paramaiph, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      str = amtj.a(2131714304);
      i = this.jdField_b_of_type_JavaUtilList.size();
      break;
      str = amtj.a(2131714308);
      i = this.jdField_c_of_type_JavaUtilList.size();
      break;
      str = amtj.a(2131714305);
      i = this.d.size();
      break;
      str = amtj.a(2131714306);
      i = this.e.size();
      break;
      str = amtj.a(2131714307);
      i = this.f.size();
      break;
      str = amtj.a(2131714309);
      i = this.g.size();
      break;
      label356:
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (albb)paramView.getTag();
      paramViewGroup = paramView;
      paramView = (View)localObject;
      localalbo = a(paramInt1, paramInt2);
      if ((localalbo == null) || (localalbo.jdField_a_of_type_ComTencentMobileqqPersistenceEntity == null)) {
        break label573;
      }
      if (!(localalbo.jdField_a_of_type_ComTencentMobileqqPersistenceEntity instanceof TroopInfo)) {
        break label363;
      }
      localTroopInfo = (TroopInfo)localalbo.jdField_a_of_type_ComTencentMobileqqPersistenceEntity;
      ...
      paramView.jdField_a_of_type_Int = localalbo.jdField_a_of_type_Int;
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        for (;;)
        {
          ...
          paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562787, this.jdField_a_of_type_ComTencentWidgetExpandableListView, false);
          paramView = new albb(this);
          paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131366241));
          paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131366267));
          paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131379260));
          paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131379246));
          paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131362968));
        ...
        if ((localalbo.jdField_a_of_type_ComTencentMobileqqPersistenceEntity instanceof DiscussionInfo))
        {
          localObject = (DiscussionInfo)localalbo.jdField_a_of_type_ComTencentMobileqqPersistenceEntity;
          ...
          {
            paramView.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
            paramView.jdField_b_of_type_AndroidWidgetTextView.setText(String.format("(%d)", new Object[] { Integer.valueOf(this.jdField_a_of_type_Amrb.a(((DiscussionInfo)localObject).uin)) }));
          }
          paramViewGroup.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
          a(paramView, null);
      ...
      QLog.d("TroopDiscussionMemSelectAdapter", 2, "getChildView data:" + localalbo.jdField_a_of_type_ComTencentMobileqqPersistenceEntity + " groupPosition:" + paramInt1 + " childPosition:" + paramInt2);
      return paramViewGroup;
    }
    label573:
