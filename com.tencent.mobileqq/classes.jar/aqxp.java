  ...
  extends akfy
{
  ...
  public aqxp(Context paramContext)
  {
  ...
  public void b(boolean paramBoolean, Object paramObject)
  {
    ...
    Object localObject = aqxj.a(localContext);
    if ((localObject != null) && (((bcqf)localObject).isShowing())) {
      ((bcqf)localObject).dismiss();
    }
    label124:
    int j;
    if ((paramBoolean) && ((paramObject instanceof Object[])))
    {
      ...
      if (arrayOfObject.length >= 5)
      {
        ...
        for (paramObject = (String)arrayOfObject[3];; paramObject = null)
        {
          ...
          aqxj.a(localContext, (byte[])localObject, j);
          aqxj.b.set(false);
          return;
          i = -1;
          break;
    ...
    {
    default: 
      bcql.a(localContext, 1, ajya.a(2131705481), 0).a();
      aqxj.b.set(false);
      return;
    case 1: 
      label234:
      ...
      ((Bundle)localObject).putInt("key_hiboom_type", aqxj.a(j));
      paramObject = new Intent();
      paramObject.putExtras((Bundle)localObject);
      aqbe.a((Activity)localContext, paramObject, 21);
      return;
    }
    if ((localContext instanceof FragmentActivity))
    {
      ...
      if ((((FragmentActivity)localObject).getChatFragment() != null) && (((FragmentActivity)localObject).getChatFragment().a() != null))
      {
        ...
        ((aqxj)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a((BaseChatPie)localObject, paramObject, j, aqxj.a(j));
  ...
  public void c(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localObject.length >= 5)
        {
          ...
          for (localObject = (String)localObject[4];; localObject = null)
          {
            ...
            aqxj.a(localContext, paramObject, j);
            aqxj.b.set(false);
            return;
            i = -1;
            break label102;
          ...
          if (paramBoolean)
          {
            if ((localContext instanceof FragmentActivity))
            {
              ...
              if ((paramObject.getChatFragment() != null) && (paramObject.getChatFragment().a() != null))
              {
                ...
                ((aqxj)paramObject.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a(paramObject, (String)localObject, j, aqxj.a(j));
                paramObject.aC();
          ...
          ((akfv)((QQAppInterface)paramObject).a(13)).b();
          return;
        }
        paramBoolean = false;
      }
      while (paramBoolean)
      {
        bcql.a(localContext, 1, ajya.a(2131705478), 0).a();
        aqxj.b.set(false);
        return;
