  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public aqxp(HiBoomPanelView paramHiBoomPanelView)
  {
  ...
  {
    if ((paramViewHolder instanceof aqxq))
    {
      paramViewHolder = (aqxq)paramViewHolder;
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    try
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext()).inflate(2131562605, paramViewGroup, false);
      localObject = paramViewGroup;
      if (paramViewGroup == null) {
        localObject = new View(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext());
      }
      return new aqxq(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView, (View)localObject, bool);
    }
