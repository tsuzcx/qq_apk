...
public class ajtl
{
  ...
  /* Error */
  public static void a(ajtg paramajtg, ToServiceMsg paramToServiceMsg, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    // Byte code:
    //   0: aload_1
    ...
    //   86: aload_1
    //   87: aastore
    //   88: invokevirtual 78	ajtg:notifyUI	(IZLjava/lang/Object;)V
    //   91: return
    ...
    //   137: pop
    //   138: aload_0
    //   139: getfield 111	ajtg:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   142: bipush 52
    ...
    //   163: aload_1
    //   164: aastore
    //   165: invokevirtual 78	ajtg:notifyUI	(IZLjava/lang/Object;)V
    //   168: return
    //   169: astore_2
    //   170: ldc 38
    //   172: iconst_1
    ...
    //   188: aload_1
    //   189: aastore
    //   190: invokevirtual 78	ajtg:notifyUI	(IZLjava/lang/Object;)V
    //   193: return
    //   194: astore_2
  ...
  public static void a(ajtg paramajtg, String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      localObject = paramajtg.createToServiceMsg(jdField_a_of_type_JavaLangString);
      ((ToServiceMsg)localObject).putWupBuffer(localOIDBSSOPkg.toByteArray());
      ((ToServiceMsg)localObject).extraData.putString("troopUin", paramString);
      paramajtg.sendPbReq((ToServiceMsg)localObject);
      return;
    }
    catch (NumberFormatException paramajtg)
    {
      QLog.e(".troop.survey", 1, "send_oidb_0xb36 error! ", paramajtg);
    }
  }
  
  /* Error */
  public static boolean a(ajtg paramajtg, azrn paramazrn, tencent.im.s2c.msgtype0x210.submsgtype0x26.submsgtype0x26.MsgBody.SubCmd0x1UpdateAppUnreadNum paramSubCmd0x1UpdateAppUnreadNum, int paramInt)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 207	azrn:jdField_a_of_type_Long	J
    //   4: ldc2_w 208
    //   7: lcmp
    //   8: ifeq +5 -> 13
    //   11: iconst_0
    ...
    //   33: iconst_1
    //   34: aload_1
    //   35: getfield 212	azrn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   38: aastore
    //   39: dup
    //   40: iconst_2
    //   41: ldc 214
    ...
    //   60: iconst_5
    //   61: aload_1
    //   62: getfield 228	azrn:jdField_a_of_type_Int	I
    ...
    //   140: iconst_1
    //   141: aload_1
    //   142: getfield 212	azrn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   145: aastore
    //   146: dup
    //   147: iconst_2
    //   148: ldc_w 257
    ...
    //   210: aload_1
    //   211: getfield 218	azrn:b	I
    //   214: ifeq +82 -> 296
    //   217: aload_0
    //   218: aload_1
    //   219: getfield 212	azrn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   222: aload_1
    //   223: getfield 218	azrn:b	I
    //   226: invokestatic 278	ajtl:a	(Lajtg;Ljava/lang/String;I)V
    //   229: iconst_1
    //   230: ireturn
    //   231: astore 5
    //   233: ldc 38
    ...
    //   316: iconst_1
    //   317: aload_1
    //   318: getfield 212	azrn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   321: aastore
    //   322: dup
    //   323: iconst_2
    //   324: ldc 214
    ...
    //   343: iconst_5
    //   344: aload_1
    //   345: getfield 228	azrn:jdField_a_of_type_Int	I
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	373	0	paramajtg	ajtg
    //   0	373	1	paramazrn	azrn
