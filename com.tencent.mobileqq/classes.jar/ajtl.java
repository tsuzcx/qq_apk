...
public class ajtl
  implements Runnable
{
  public ajtl(HomeworkTroopController paramHomeworkTroopController, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (i != 0) {}
    for (int i = 2131430727;; i = 2131430728)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopLogicHomeworkTroopController.jdField_a_of_type_ComTencentWidgetCalloutpopupwindowCalloutPopupWindow.a(new ajtm(this));
