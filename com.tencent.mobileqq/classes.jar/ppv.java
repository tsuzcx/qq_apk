  ...
  extends pqj
{
  ...
  public ppv(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qfo paramqfo, Handler paramHandler)
  {
    ...
    for (paramFromServiceMsg = localRspBody.rpt_uint32_default_interest_label_id_list.get();; paramFromServiceMsg = null)
    {
      ...
      if (localRspBody.rpt_interest_label_list.has())
      {
        ...
        if (localRspBody.rpt_interest_label_list.get() != null) {
          paramToServiceMsg = qfn.a(localRspBody.rpt_interest_label_list.get(), paramFromServiceMsg);
        }
      }
      ...
      for (;;)
      {
        ...
        return;
        paramToServiceMsg = qfn.a(null, null);
        continue;
        bool = true;
      }
    }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    a(qfq.a("OidbSvc.0x6e5", 1765, 0, localReqBody.toByteArray()));
  }
  ...
  {
    b(qfq.a(paramFromServiceMsg, paramObject, new oidb_cmd0x6e4.RspBody()));
  }
}
