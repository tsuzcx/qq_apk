...
public class bdrc
  implements bdnf
{
  public bdrc(TroopBarPublishActivity paramTroopBarPublishActivity) {}
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    int j = this.a.jdField_a_of_type_Bdnl.b.length();
    int k = this.a.jdField_a_of_type_Bdnl.a.length();
    int n = this.a.jdField_a_of_type_Bdnl.c.length() + (j + k);
    if ((paramInt1 < this.a.A.length() + n) && (paramInt2 < this.a.A.length() + n))
    {
      if (TroopBarPublishActivity.a(this.a).size() > 1)
      {
        ...
        bjmm.b(this.a.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText);
        return;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramInt1 = this.a.A.length() + n;
        break label258;
        if (TextUtils.isEmpty(this.a.jdField_a_of_type_Bdnl.b)) {
          break;
        }
        k = 0;
        j = paramInt1;
