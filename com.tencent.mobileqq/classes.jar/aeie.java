...
class aeie
  implements Runnable
{
  aeie(aeic paramaeic, PicFeedUploadInfo paramPicFeedUploadInfo, VideoFeedsUploader.UploadResult paramUploadResult) {}
  ...
  public void run()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelPicFeedUploadInfo.uploadStatus == 3)
    {
      ...
      new NowVideoReporter().h("video_public").i("public_suc").d(SmallVideoCameraCaptureFragment.a).a(2).b(this.jdField_a_of_type_Aeic.a.a);
      return;
    }
    ...
    new NowVideoReporter().h("video_public").i("public_fail").d(SmallVideoCameraCaptureFragment.a).a(2).b(this.jdField_a_of_type_Aeic.a.a);
  }
}
