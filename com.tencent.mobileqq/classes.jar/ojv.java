...
public class ojv
{
  ...
  public ojv(ViewGroup paramViewGroup, ReadInJoyNavigationGridview paramReadInJoyNavigationGridview, ImageView paramImageView)
  {
    this.jdField_a_of_type_Pkt = new ojz(this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyNavigationGridview.setChannelButtonListener(new oka(this));
  ...
  {
    JSONObject localJSONObject = pay.b();
    switch (paramInt)
    {
    }
    for (;;)
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      odq.a(null, "CliOper", "", "", str, str, 0, 0, "", "", "", paramString, false);
      return;
      str = "0X8008B81";
      continue;
      str = "0X8008B83";
  ...
  {
    pay.b().postDelayed(new ReadInJoyNaviController.4(this), paramLong);
  }
  ...
  public void a(int paramInt)
  {
    ...
    pay.b().postDelayed(new ReadInJoyNaviController.1(this), 0L);
  }
  ...
  public void a(ChannelCoverInfo paramChannelCoverInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        pay.b().postDelayed(new ReadInJoyNaviController.2(this, paramChannelCoverInfo), 0L);
        return;
      }
      i += 1;
    }
