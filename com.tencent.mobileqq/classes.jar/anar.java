  ...
  extends anat
{
  ...
  protected void a()
  {
    ...
    anax.a("glGetAttribLocation u_threshold");
    this.b = GLES20.glGetUniformLocation(this.d, "u_clipBlack");
    anax.a("glGetAttribLocation u_clipBlack");
    this.c = GLES20.glGetUniformLocation(this.d, "u_clipWhite");
    anax.a("glGetAttribLocation u_clipWhite");
  }
  ...
  protected void a(anaw paramanaw)
  {
    ...
    GLES20.glUniform1f(this.a, paramanaw.f);
    GLES20.glUniform1f(this.b, paramanaw.g);
    GLES20.glUniform1f(this.c, paramanaw.h);
  }
}
