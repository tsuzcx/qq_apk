...
public final class aysg
{
  ...
  public aysg(@NotNull String paramString, @NotNull List<String> paramList)
  {
  ...
  @NotNull
  public final aysg a(@Nullable String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((CharSequence)localObject2).length() > 0)
        {
          ...
          localObject2 = paramString.optString("worst_thing");
          Intrinsics.checkExpressionValueIsNotNull(localObject2, "worstThing");
          localObject2 = (CharSequence)localObject2;
          localObject2 = new Regex("[,，]").split((CharSequence)localObject2, 0);
          if (((Collection)localObject2).isEmpty()) {
            break label582;
          }
          i = 1;
          if (i != 0) {
            ((List)localObject1).add("今日忌" + (String)((List)localObject2).get(0));
          }
          ...
          i = 1;
          if (i != 0) {
            ((List)localObject1).add("今日宜" + (String)((List)localObject2).get(0));
          }
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof aysg))
      {
        paramObject = (aysg)paramObject;
