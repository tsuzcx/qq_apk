...
public abstract class alrs
{
  ...
  public static float a(alrw paramalrw1, alrw paramalrw2)
  {
    float f2 = 1.0F;
    float f1 = f2;
    if (paramalrw1 != null)
    {
      ...
      if (paramalrw2 != null)
      {
        f1 = a(paramalrw1.jdField_g_of_type_Float);
        f2 = paramalrw1.h * 2;
        f1 = (a(paramalrw2.jdField_g_of_type_Float) + paramalrw2.h * 2) / (f1 + f2);
      }
    }
    return f1;
  }
  ...
  /* Error */
  public Bitmap a(alrw paramalrw)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   7: ifnull +17 -> 24
    //   10: aload_1
    //   11: getfield 96	alrw:e	I
    //   14: ifeq +10 -> 24
    //   17: aload_1
    //   18: getfield 99	alrw:f	I
    //   21: ifne +7 -> 28
    //   24: aconst_null
    //   25: astore_3
    //   26: aload_3
    ...
    //   28: aload_0
    //   29: aload_1
    //   30: invokevirtual 101	alrs:b	(Lalrw;)Landroid/graphics/Bitmap;
    //   33: astore_2
    //   34: aload_2
    //   35: ifnull +48 -> 83
    //   38: aload_2
    ...
    //   68: aload_1
    //   69: getfield 126	alrw:jdField_a_of_type_JavaLangCharSequence	Ljava/lang/CharSequence;
    ...
    //   104: aload_1
    //   105: getfield 126	alrw:jdField_a_of_type_JavaLangCharSequence	Ljava/lang/CharSequence;
    ...
    //   124: astore 6
    //   126: aload_1
    //   127: getfield 96	alrw:e	I
    //   130: aload_1
    //   131: getfield 99	alrw:f	I
    ...
    //   149: astore_2
    //   150: aload_1
    //   151: getfield 159	alrw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   154: invokestatic 165	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   157: ifne +101 -> 258
    //   160: aload_0
    //   161: getfield 34	alrs:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   164: aload_1
    //   165: getfield 159	alrw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   202: dup
    //   203: aload_1
    //   204: getfield 159	alrw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   223: dup
    //   224: aload_1
    //   225: getfield 159	alrw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   237: astore_2
    //   238: aload_0
    //   239: getfield 34	alrs:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   242: aload_1
    //   243: getfield 159	alrw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   262: aload_0
    //   263: getfield 34	alrs:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   266: ldc 197
    ...
    //   309: astore 4
    //   311: aload_0
    //   312: getfield 34	alrs:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   315: ldc 197
    ...
    //   364: iconst_0
    //   365: aload_1
    //   366: getfield 96	alrw:e	I
    //   369: aload_1
    //   370: getfield 99	alrw:f	I
    ...
    //   381: astore_2
    //   382: aload_1
    //   383: getfield 235	alrw:jdField_a_of_type_AndroidTextStaticLayout	Landroid/text/StaticLayout;
    //   386: ifnull +27 -> 413
    //   389: aload 6
    //   391: aload_1
    //   392: getfield 237	alrw:jdField_g_of_type_Int	I
    //   395: i2f
    //   396: aload_1
    //   397: getfield 88	alrw:h	I
    //   400: i2f
    //   401: invokevirtual 241	android/graphics/Canvas:translate	(FF)V
    //   404: aload_1
    //   405: getfield 235	alrw:jdField_a_of_type_AndroidTextStaticLayout	Landroid/text/StaticLayout;
    //   408: aload 6
    //   410: invokevirtual 246	android/text/StaticLayout:draw	(Landroid/graphics/Canvas;)V
    //   413: aload_0
    //   414: aload_1
    //   415: aload_2
    //   416: invokevirtual 249	alrs:a	(Lalrw;Landroid/graphics/Bitmap;)V
    //   419: aload_2
    //   420: areturn
    //   421: aload 6
    //   423: aload 4
    ...
    //   449: iconst_0
    //   450: aload_1
    //   451: getfield 96	alrw:e	I
    //   454: aload_1
    //   455: getfield 99	alrw:f	I
  ...
  {
    if ((paramalrw == null) || (TextUtils.isEmpty(paramalrw.jdField_a_of_type_JavaLangCharSequence)) || (paramalrw.jdField_a_of_type_Boolean)) {
      return;
    }
    if (jdField_a_of_type_AndroidTextTextPaint.getTextSize() != paramalrw.jdField_g_of_type_Float) {
      jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramalrw.jdField_g_of_type_Float);
    }
    jdField_a_of_type_AndroidTextTextPaint.setColor(paramalrw.b);
    String str = paramalrw.jdField_a_of_type_JavaLangCharSequence + "_" + Float.valueOf(paramalrw.jdField_g_of_type_Float);
    Integer localInteger = (Integer)c.get(str);
    Object localObject = localInteger;
    if (localInteger == null)
    {
      localObject = Integer.valueOf((int)Math.ceil(StaticLayout.getDesiredWidth(paramalrw.jdField_a_of_type_JavaLangCharSequence, jdField_a_of_type_AndroidTextTextPaint)));
      c.put(str, localObject);
    }
    localObject = new StaticLayout(paramalrw.jdField_a_of_type_JavaLangCharSequence, jdField_a_of_type_AndroidTextTextPaint, ((Integer)localObject).intValue(), Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, true);
    paramalrw.e = (((StaticLayout)localObject).getWidth() + paramalrw.jdField_g_of_type_Int * 2);
    paramalrw.f = (((StaticLayout)localObject).getHeight() + paramalrw.h * 2);
    paramalrw.jdField_a_of_type_Boolean = true;
    paramalrw.jdField_a_of_type_AndroidTextStaticLayout = ((StaticLayout)localObject);
  }
  
  public abstract void a(alrw paramalrw, Bitmap paramBitmap);
  
  public abstract Bitmap b(alrw paramalrw);
}
