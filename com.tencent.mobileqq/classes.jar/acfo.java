...
{
  public acfo(QfileBaseCloudFileTabView paramQfileBaseCloudFileTabView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView != null) {
      if (localCloudItemHolder.c == 1)
      {
        ...
        FileModel.a(paramView).a(false, this.a.a, new acfp(this, paramView));
      }
    }
    for (;;)
    {
      ...
      if (localCloudItemHolder.c == 3)
      {
        ...
        FileModel.a(paramView).a(false, this.a.a, new acfq(this, paramView));
      }
      ...
      else if (localCloudItemHolder.c == 2)
      {
        ...
        continue;
        this.a.a.a().ac();
        paramView = new acfr(this, (WeiYunFileInfo)localObject);
