...
public class acfo
  implements Runnable
{
  public acfo(EmotionKeywordAdapter paramEmotionKeywordAdapter, EmoticonResp paramEmoticonResp, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.getUIHandler().post(new acfp(this, localArrayList));
      return;
    }
  }
}
