...
public class ascf
{
  ...
  {
    Object localObject5 = babh.m(paramQQAppInterface, paramString1);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FriendReactive", 2, "addHotFriendAIOGrayTips type=" + paramInt1 + "level=" + paramInt2 + "flag=" + paramInt3 + "IsDisableInteractive=" + localajjj.q + "prelevel=" + paramInt4);
    }
    Object localObject2;
    label251:
    int k;
      ...
      case 1: 
        for (;;)
        {
          ...
          default: 
            ...
            localObject2 = new amjc();
            if (!bool) {
              break label4818;
            }
            bool = ((amjc)localObject2).jdField_a_of_type_Boolean;
            if (!bool) {
              break label4815;
            }
            paramString2 = paramString2 + ((amjc)localObject2).jdField_a_of_type_JavaLangString;
            ...
            localObject4 = ascd.a(paramQQAppInterface, (String)localObject4, (String)localObject5, localajjj);
            localObject6 = ascd.a(paramQQAppInterface, (String)((List)localObject4).get(0), paramString1);
            paramString2 = (String)((List)localObject6).get(0);
            ((List)localObject4).remove(0);
            ((List)localObject6).remove(0);
            if ((k != 0) && (!ahwj.a(paramString1, paramQQAppInterface))) {
              ((baot)paramQQAppInterface.a(71)).b(paramString1, k);
            }
            if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (n != 0)) {
              ((baot)paramQQAppInterface.a(71)).b(paramString1, n, (String)ascd.a(paramQQAppInterface, (String)ascd.a(paramQQAppInterface, (String)localObject1, (String)localObject5, localajjj).get(0), paramString1).get(0));
            }
            if (paramInt3 != 1) {
              break label3738;
            }
            paramInt5 = 2097153;
            localObject1 = new aqax(paramString1, paramString1, paramString2, 0, -5040, paramInt5, awao.a());
            ...
            while (paramInt5 < ((List)localObject6).size())
            {
              ...
              if (!TextUtils.isEmpty(str))
              {
                ...
                if (k >= 0) {
                  ((aqax)localObject1).a(k, str.length() + k, (Bundle)localObject5);
                }
                if (QLog.isColorLevel()) {
        ...
        if (TextUtils.isEmpty(paramString2)) {
          localObject1 = ascd.a(paramQQAppInterface.getApp(), 65);
        }
        break;
      }
    }
    for (;;)
    {
      ...
      break label1008;
      if (TextUtils.isEmpty(paramString2)) {
        localObject1 = ascd.a(paramQQAppInterface.getApp(), 68);
      }
      k = 10;
      j = 38;
      localObject2 = localObject1;
      ...
      case 1: 
        if (TextUtils.isEmpty(paramString2)) {
          localObject1 = ascd.a(paramQQAppInterface.getApp(), 71);
        }
      case 2: 
        label4874:
        for (;;)
        {
          ...
          break label1204;
          if (TextUtils.isEmpty(paramString2)) {
            localObject1 = ascd.a(paramQQAppInterface.getApp(), 72);
          }
          k = 10;
          j = 40;
          localObject2 = localObject1;
          ...
          case 0: 
            if (paramInt4 == 1)
            {
              ...
              localObject1 = ascd.a(paramQQAppInterface.getApp(), 69);
            }
            label3738:
            label4895:
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                {
                  if (TextUtils.isEmpty(paramString2)) {
                    localObject1 = ascd.a(paramQQAppInterface.getApp(), 70);
                  }
                  i = 10;
                  localObject2 = localObject1;
                }
              ...
              localObject2 = localObject1;
              break;
              paramInt4 = localajjj.e;
              paramInt4 = localajjj.f;
              if (paramInt2 == 1)
              {
                if (paramInt3 == 1)
                {
                  paramString2 = ascd.a(paramQQAppInterface.getApp(), 21);
                  paramInt4 = 0;
                  i = 5;
                  j = 1;
                  localObject1 = "";
                ...
                paramString2 = ascd.a(paramQQAppInterface.getApp(), 24);
                paramInt4 = 0;
                i1 = 8;
                j = i;
                localObject1 = "";
              ...
              if (paramInt2 == 2)
              {
                paramString2 = ascd.a(paramQQAppInterface.getApp(), 42);
                paramInt4 = 0;
                i = 6;
                j = 2;
                localObject1 = "";
              ...
              paramString2 = ascd.a(paramQQAppInterface.getApp(), 27);
              paramInt4 = 0;
              i1 = 7;
              j = i;
              localObject1 = "";
              ...
              i = i1;
              break label323;
              paramInt4 = localajjj.jdField_a_of_type_Int;
              paramInt4 = localajjj.b;
              if (paramInt2 == 1)
              {
                if (paramInt3 == 1)
                {
                  paramString2 = ascd.a(paramQQAppInterface.getApp(), 20);
                  paramInt4 = bajr.a(paramQQAppInterface, paramString1, 0);
                  if (paramInt4 == 2) {
                    paramInt4 = 27;
                  }
                  for (;;)
                ...
                paramString2 = ascd.a(paramQQAppInterface.getApp(), 23);
                paramInt4 = bajr.a(paramQQAppInterface, paramString1, 0);
                if (paramInt4 == 2) {
                  paramInt4 = 29;
                }
              ...
              if (paramInt2 == 2)
              {
                paramString2 = ascd.a(paramQQAppInterface.getApp(), 41);
                paramInt4 = bajr.a(paramQQAppInterface, paramString1, 0);
                if (paramInt4 == 2) {
                  paramInt4 = 29;
                }
              ...
              paramString2 = ascd.a(paramQQAppInterface.getApp(), 26);
              paramInt4 = 0;
              i1 = 3;
              j = i;
              localObject1 = "";
              ...
              if (paramInt2 == 1)
              {
                if (paramInt3 == 1)
                {
                  paramString2 = ascd.a(paramQQAppInterface.getApp(), 22);
                  paramInt4 = bajr.a(paramQQAppInterface, paramString1, 1);
                  if (paramInt4 == 2) {
                    paramInt4 = 31;
                  }
                  for (;;)
              ...
              if (paramInt2 == 2)
              {
                paramString2 = ascd.a(paramQQAppInterface.getApp(), 43);
                paramInt4 = bajr.a(paramQQAppInterface, paramString1, 1);
                if (paramInt4 == 2) {
                  paramInt4 = 33;
                }
              ...
              if (paramInt4 == 1)
              {
                paramString2 = ascd.a(paramQQAppInterface.getApp(), 28);
                paramInt4 = 0;
                i1 = 11;
                j = i;
                localObject1 = "";
              ...
              paramString2 = ascd.a(paramQQAppInterface.getApp(), 25);
              paramInt4 = 0;
              i1 = 12;
              j = i;
              localObject1 = "";
              ...
              for (;;)
              {
                ...
                if (n > 0)
                {
                  awqx.b(paramQQAppInterface, "dc00898", "", "", "0X8009500", "0X8009500", n, 0, "", "", "", "");
                  ...
                  if (paramInt3 == 1)
                  {
                    if (paramInt2 == 1)
                    {
                      localObject1 = ascd.a(paramQQAppInterface.getApp(), 78);
                      paramInt4 = bajr.a(paramQQAppInterface, paramString1, 1);
                      if (paramInt4 == 2) {
                        paramInt4 = 31;
                      }
                    ...
                    if (paramInt2 == 2)
                    {
                      if (paramInt4 == 0)
                      {
                        localObject1 = ascd.a(paramQQAppInterface.getApp(), 80);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                      ...
                      if (paramInt4 == 1)
                      {
                        localObject1 = ascd.a(paramQQAppInterface.getApp(), 79);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                  ...
                  else if (paramInt3 == 2)
                  {
                    if (paramInt2 == 0)
                    {
                      if (paramInt4 == 1)
                      {
                        localObject1 = ascd.a(paramQQAppInterface.getApp(), 81);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                      ...
                      if (paramInt4 == 2)
                      {
                        localObject1 = ascd.a(paramQQAppInterface.getApp(), 83);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                    ...
                    {
                      localObject1 = ascd.a(paramQQAppInterface.getApp(), 82);
                      paramInt4 = 0;
                      paramString2 = "";
                      i = 0;
                      j = 2097153;
              ...
              for (i = 1;; i = 0)
              {
                if (paramInt2 == 0)
                {
                  paramString2 = ascd.a(paramQQAppInterface.getApp(), 84);
                  paramInt4 = 7;
                  label3315:
                  if (i == 0) {
                    break label4874;
                ...
                for (;;)
                {
                  ...
                  if (paramInt2 == 1)
                  {
                    paramString2 = ascd.a(paramQQAppInterface.getApp(), 85);
                    paramInt4 = 9;
                    break label3315;
                  }
                  paramString2 = "";
                  ...
                  if (paramInt3 == 4)
                  {
                    ...
                    paramString2 = ascd.a(paramQQAppInterface.getApp(), 86);
                    if (paramInt4 == 0) {
                      break label4859;
                    }
                    localObject1 = "";
                  ...
                  for (;;)
                  {
                    ...
                    if (paramInt3 == 5)
                    {
                      if (paramInt2 > 0)
                      {
                        if (paramInt2 == 2)
                        {
                          paramString2 = ascd.a(paramQQAppInterface.getApp(), 88);
                          paramInt4 = 11;
                        }
                        for (;;)
                        {
                          ...
                          if (paramInt2 == 1)
                          {
                            paramString2 = ascd.a(paramQQAppInterface.getApp(), 87);
                            paramInt4 = 10;
                          }
                          else
                          {
                    ...
                    else
                    {
                      if (paramInt3 == 6)
                      {
                        ...
                        localObject1 = ascd.a(paramQQAppInterface.getApp(), 88);
                        paramInt4 = 1;
                        paramString2 = "";
                        i = 0;
                        j = 2097155;
                    ...
                    if ((localObject4 != null) && (((List)localObject4).size() > 0))
                    {
                      ...
                      while (paramInt5 < ((List)localObject4).size())
                      {
                        ...
                        if (!TextUtils.isEmpty((CharSequence)localObject6))
                        {
                          ...
                          if (k >= 0) {
                            ((aqax)localObject1).a(k, ((String)localObject6).length() + k, (Bundle)localObject5);
                          }
                          if (QLog.isColorLevel()) {
                    ...
                    for (;;)
                    {
                      ((Bundle)localObject4).putString("key_action_DATA", String.format(((amjc)localObject2).b, new Object[] { paramString1, Integer.valueOf(paramInt5) }));
                      paramInt2 = paramString2.length() - ((amjc)localObject2).jdField_a_of_type_JavaLangString.length();
                      if (paramInt2 >= 0)
                      {
                        ((aqax)localObject1).a(paramInt2, paramString2.length(), (Bundle)localObject4);
                        awqx.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009CA5", paramInt5, 0, "", "", "", "");
                      }
                      ...
                      try
                      {
                        ...
                        if (paramInt2 >= 0) {
                          ((aqax)localObject1).a(paramInt2, paramString2.length(), (Bundle)localObject2);
                        }
                      }
                      ...
                      while (((Iterator)localObject4).hasNext())
                      {
                        ...
                        if ((!TextUtils.isEmpty((CharSequence)localObject5)) && (!TextUtils.isEmpty(str)))
                        {
                          ...
                          if (paramInt2 >= 0) {
                            ((aqax)localObject1).a(paramInt2, ((String)localObject5).length() + paramInt2, (Bundle)localObject6);
                          }
                          if (QLog.isColorLevel()) {
                    ...
                    do
                    {
                      ...
                      if (!TextUtils.isEmpty(paramString2))
                      {
                        ...
                        if (paramInt4 != 0) {
                          localajjj.f(paramString1);
                        }
                      }
                    } while (paramInt1 == 6);
                    awqx.b(paramQQAppInterface, "dc00898", "", "", "0X8007779", "0X8007779", i, 0, "", "", "", "");
                    return;
                    label4815:
                    break label393;
                    label4818:
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, long paramLong1, long paramLong2)
  {
    ...
    try
    {
      localObject2 = babh.m(paramQQAppInterface, paramString1);
    ...
    Object localObject2 = amby.a().b("" + paramInt2);
    paramString2 = (String)localObject2;
    if (localObject2 == null) {
      paramString2 = new ambx().b("0");
    }
    ...
    for (;;)
    {
      localObject2 = new aqax(paramString1, paramString1, (String)localObject1, 0, paramInt1, 655384, awao.a());
      ...
      if (paramInt1 >= 0) {
        ((aqax)localObject2).a(paramInt1, ((String)localObject1).length(), localBundle);
      }
      paramString2 = new MessageForUniteGrayTip();
      paramString2.hasRead = 0;
      paramString2.subType = 9;
      paramString2.initGrayTipMsg(paramQQAppInterface, (aqax)localObject2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, submsgtype0xc7.HotFriendNotify paramHotFriendNotify, akcb paramakcb)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramHotFriendNotify != null)
    {
      ...
      str1 = babh.m(paramQQAppInterface, (String)localObject1);
      i = 1;
      if (paramHotFriendNotify.bytes_wildcard_wording.has())
      {
        localObject3 = ascd.a(paramQQAppInterface, paramHotFriendNotify.bytes_wildcard_wording.get().toStringUtf8(), str1, localajjj);
        localObject4 = ascd.a(paramQQAppInterface, (String)((List)localObject3).get(0), (String)localObject1);
        str1 = (String)((List)localObject4).get(0);
        ((List)localObject3).remove(0);
        ((List)localObject4).remove(0);
        localObject2 = new aqax((String)localObject1, (String)localObject1, str1, 0, -5040, 2097153, awao.a());
        if ((localObject4 != null) && (((List)localObject4).size() > 0))
        {
          i = 0;
        ...
        {
          Collections.sort((List)localObject3, new ascg());
    ...
    for (;;)
    {
      ...
      for (int k = 1;; k = 0)
      {
        ...
        if (!paramHotFriendNotify.uint32_notify_type.has())
        {
          ...
          paramakcb = localajjj.a(String.valueOf(l2));
          if (paramakcb != null) {
            break label2382;
          }
          paramakcb = new ExtensionInfo();
          paramakcb.uin = String.valueOf(l2);
        }
        for (;;)
        {
          ...
          {
            j = i;
            if (paramakcb.lastGrayPushTime == l1)
            {
              j = i;
              if (l1 != -1L)
              {
          ...
          if (paramHotFriendNotify.uint32_chat_hot_level.has())
          {
            ...
            k = paramakcb.chatHotLevel;
            paramakcb.chatHotLevel = i;
          ...
          if (paramHotFriendNotify.uint32_key_trans_flag.has())
          {
            ...
            {
              bool2 = true;
              paramakcb.loverTransFlag = bool2;
              ((StringBuilder)localObject3).append(", loverTransFlag=").append(paramakcb.loverTransFlag);
            }
          }
          else
          {
            ...
            {
              i = paramakcb.newBestIntimacyType;
              k = paramHotFriendNotify.uint32_boat_level.get();
              paramakcb.newBestIntimacyType = k;
          ...
          for (;;)
          {
            ...
            if (paramHotFriendNotify.uint64_last_praise_time.has())
            {
              ...
              paramakcb.lastpraiseTime = (86400L * l1 - 28800L);
            ...
            if (paramHotFriendNotify.uint64_last_chat_time.has())
            {
              ...
              paramakcb.lastChatTime = (86400L * l1 - 28800L);
            ...
            if (paramHotFriendNotify.uint64_last_key_time.has())
            {
              ...
              paramakcb.loverLastChatTime = (86400L * l1 - 28800L);
            ...
            {
              i = paramakcb.bestIntimacyType;
              k = paramHotFriendNotify.uint32_close_level.get();
              paramakcb.bestIntimacyType = k;
          ...
          ascd.a(paramQQAppInterface, paramakcb, (submsgtype0xc7.FriendShipFlagNotify)paramHotFriendNotify.msg_friendship_flag_notify.get());
          return;
          if (!QLog.isColorLevel()) {
            break;
          }
