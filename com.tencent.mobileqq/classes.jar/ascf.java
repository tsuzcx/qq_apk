...
public class ascf
  extends asbv
{
  public ascf(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (!bahq.a)
        {
          FileUtils.deleteDirectory(bahq.b());
          FileUtils.rename(str, bahq.b());
        }
        super.a(paramString);
        return;
      }
  ...
  public boolean h()
  {
    ...
    int i = llq.f();
    if (QLog.isColorLevel()) {
      QLog.d("PttSilkAndChangeVoiceSoHandler", 2, "isUserNeedDownload cpuArch = " + i + " isUserNeedDownload try match version=" + "8.4.10" + " data.version=" + ((PttSilkAndChangeVoiceSoData)localObject).version);
    }
