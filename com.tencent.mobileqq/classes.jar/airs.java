...
public class airs
{
  ...
  public airs(QQAppInterface paramQQAppInterface, airv paramairv)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListHandler = ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1));
    this.jdField_a_of_type_Airv = paramairv;
    this.jdField_a_of_type_Amsu = new airt(this);
  ...
  private long a()
  {
    long l = this.jdField_a_of_type_Amvo.a(2);
    if (QLog.isColorLevel()) {
  ...
  private void a(ArrayList<MayKnowRecommend> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Amvo.a((List)???, l2, l1, true);
  ...
  private void a(List<MayKnowRecommend> paramList)
  {
    ...
    for (String str = "NULL";; str = paramList.toString())
    {
      ...
      this.jdField_a_of_type_Airv.a(paramList);
      return;
    }
  }
  ...
  private boolean a()
  {
    ...
    return this.jdField_a_of_type_Amvo.b(2);
  }
  ...
  private boolean a(Bundle paramBundle)
  {
    ...
    return this.jdField_a_of_type_Amvo.a(2, paramBundle);
  }
  ...
  private boolean a(MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    {
      if (!this.jdField_a_of_type_Amsw.b(paramMayKnowRecommend.uin))
      {
        boolean bool = this.jdField_a_of_type_Amsw.a(paramMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int i = 1;; i = 0)
        {
  ...
  private ArrayList<MayKnowRecommend> c()
  {
    ...
    Collections.sort(localArrayList, new airu(this));
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Airv.a())
    {
      if (a())
      {
        int i;
