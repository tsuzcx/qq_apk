  ...
  implements lfm
{
  ...
  public loa a()
  {
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {}
      localObject2 = new loa((short)5, (short)localObject2.length, (byte[])localObject2);
      return localObject2;
      label412:
      i -= 1;
    }
  ...
  public void a(String paramString, loa paramloa)
  {
    boolean bool;
    if ((!QLog.isColorLevel()) || (paramloa != null))
    {
      try
      {
        if (paramloa.a() == null) {
      ...
      try
      {
        localFrameSyncInfo.mergeFrom(paramloa.a());
        paramloa = ltd.a(this.a, localFrameSyncInfo);
        paramString = paramloa;
        bool = true;
      }
      catch (Exception paramloa)
      {
        bool = false;
        break label78;
      }
