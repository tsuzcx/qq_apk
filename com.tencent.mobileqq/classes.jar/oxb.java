  ...
  implements ViewBase.OnClickListener
{
  ...
  public oxb(ArticleInfo paramArticleInfo, Context paramContext)
  {
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject2).put("imei", obz.f());
        ((JSONObject)localObject2).put("imsi", obz.g());
      ...
      ndn.a(null, obz.c(paramArticleInfo), str2, str2, 0, 0, String.valueOf(paramArticleInfo.mFeedId), (String)localObject2, "" + paramArticleInfo.mStrategyId, (String)localObject1, false);
      return;
      paramInt = 1;
      continue;
      paramInt = 0;
  ...
  {
    int i = obz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
    ogy.a().a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mExtraBiuBriefInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
