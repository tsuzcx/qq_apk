  ...
  extends vmu
{
  ...
  public vmq(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  boolean b(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      paramMotionEvent.setAnimationListener(new vmr(this, f2));
      break;
