...
public class abew
  implements bliz
{
  public abew(NewerGuidePlugin paramNewerGuidePlugin, Activity paramActivity, blir paramblir) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramView = bhhz.a();
      paramInt = bhhz.b(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        paramView = bigv.a(antf.ba + "photo/");
