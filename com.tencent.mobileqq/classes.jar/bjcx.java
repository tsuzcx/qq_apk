  ...
  extends bjcl
{
  ...
  public bjcx(CaptureModeController paramCaptureModeController)
  {
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_Bjlq.a().bringToFront();
    ...
    boolean bool = vzz.a(this.jdField_a_of_type_Bify.a());
    this.jdField_a_of_type_Bjlq.a(bool);
    if (bool) {}
    for (int i = 0;; i = 1)
    {
      vel.a("weishi_share", "clk_ws_entry", 0, 0, new String[] { String.valueOf(i) });
      return;
    }
  }
  ...
  private void b()
  {
    if (this.b == null)
    {
      ...
      this.b.addListener(new bjcz(this));
    }
    ...
    if (this.jdField_a_of_type_Bjlq.a().getVisibility() != 8) {
      this.b.start();
    }
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    while (this.jdField_a_of_type_Bjlq == null) {
      return;
    }
    b();
  }
  ...
  public void g()
  {
    ...
    {
      ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131379418)).inflate();
      this.jdField_a_of_type_DovComQqImCaptureMusicQIMMusicConfigManager.i();
      this.jdField_a_of_type_Bjlq = new bjlq(this.jdField_a_of_type_AndroidViewView, "biz_src_jc_hyws");
      this.jdField_a_of_type_Bjlq.a(this);
      this.jdField_a_of_type_Bjlq.a(this.jdField_a_of_type_DovComQqImCaptureMusicQIMMusicConfigManager.b);
      this.jdField_a_of_type_Bjlq.a().setOnTouchListener(new bjcy(this));
    }
  }
