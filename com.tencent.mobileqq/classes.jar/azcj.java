...
public class azcj
{
  ...
  public azcj(Settings paramSettings)
  {
  ...
  private void a(Rect paramRect)
  {
    ...
    if (!azcn.a(this.jdField_a_of_type_Float, 0.0F))
    {
  ...
  public azcj a(azcn paramazcn)
  {
    Object localObject = jdField_a_of_type_AndroidGraphicsRectF;
    azcp.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings, jdField_a_of_type_AndroidGraphicsRect);
    ...
    {
      this.jdField_a_of_type_Float = paramazcn.d();
      ...
      azcp.a(jdField_a_of_type_AndroidGraphicsMatrix, this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings, localRect);
      switch (azck.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
    ...
    for (;;)
    {
      ...
      {
        paramazcn.a(jdField_a_of_type_AndroidGraphicsMatrix);
        paramazcn = jdField_a_of_type_AndroidGraphicsRectF;
        paramazcn.set(0.0F, 0.0F, this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.e(), this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.f());
        jdField_a_of_type_AndroidGraphicsMatrix.mapRect(paramazcn);
        localObject = jdField_a_of_type_ArrayOfFloat;
        jdField_a_of_type_ArrayOfFloat[1] = 0.0F;
        localObject[0] = 0.0F;
        jdField_a_of_type_AndroidGraphicsMatrix.mapPoints(jdField_a_of_type_ArrayOfFloat);
        this.jdField_b_of_type_AndroidGraphicsRectF.offset(jdField_a_of_type_ArrayOfFloat[0] - paramazcn.left, jdField_a_of_type_ArrayOfFloat[1] - paramazcn.top);
      }
      return this;
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, PointF paramPointF)
  {
    ...
    jdField_a_of_type_ArrayOfFloat[0] = azcq.a(jdField_a_of_type_ArrayOfFloat[0], this.jdField_b_of_type_AndroidGraphicsRectF.left - paramFloat3, this.jdField_b_of_type_AndroidGraphicsRectF.right + paramFloat3);
    jdField_a_of_type_ArrayOfFloat[1] = azcq.a(jdField_a_of_type_ArrayOfFloat[1], this.jdField_b_of_type_AndroidGraphicsRectF.top - paramFloat4, this.jdField_b_of_type_AndroidGraphicsRectF.bottom + paramFloat4);
    if (this.jdField_a_of_type_Float != 0.0F)
    {
      jdField_a_of_type_AndroidGraphicsMatrix.setRotate(this.jdField_a_of_type_Float, this.jdField_b_of_type_Float, this.c);
      jdField_a_of_type_AndroidGraphicsMatrix.mapPoints(jdField_a_of_type_ArrayOfFloat);
