...
public class awax
{
  ...
  private Object c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return new awaz(this, localRespGetSign.vKey, localRespGetSign.vSign);
  }
  ...
  private Object d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return new awba(awuc.a(paramFromServiceMsg.iMsgId, 0), paramToServiceMsg.shResetSeq, paramFromServiceMsg.shFlowLayer, paramFromServiceMsg, paramToServiceMsg.result);
  }
  ...
  private Object o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ardv.a("Video", "Receive message packet: seq = " + paramFromServiceMsg.getRequestSsoSeq() + " size = " + paramToServiceMsg.vMsgInfos.size());
      return paramToServiceMsg;
    }
    return null;
  }
  ...
  private Object q(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    long l1 = bakz.a(localRespOffFilePack.vBody, 1);
    int i = bakz.a(localRespOffFilePack.vBody, 5);
    paramFromServiceMsg = new byte[i];
    bakz.a(paramFromServiceMsg, 0, localRespOffFilePack.vBody, 7, i);
    paramFromServiceMsg = bakz.a(paramFromServiceMsg, 0, i);
    i += 7;
    if (QLog.isColorLevel()) {
    ...
    default: 
      return null;
    case 1: 
      l2 = bakz.b(localRespOffFilePack.vBody, i);
      i += 8;
      l3 = bakz.b(localRespOffFilePack.vBody, i);
      i += 8;
      l4 = bakz.a(localRespOffFilePack.vBody, i);
      i += 4;
      l5 = bakz.a(localRespOffFilePack.vBody, i);
      i += 4;
      short s = bakz.a(localRespOffFilePack.vBody, i);
      j = i + 2;
      i = bakz.a(localRespOffFilePack.vBody, j);
      j += 2;
      paramToServiceMsg = new byte[i];
      bakz.a(paramToServiceMsg, 0, localRespOffFilePack.vBody, j, paramToServiceMsg.length);
      j += paramToServiceMsg.length;
      i = bakz.a(localRespOffFilePack.vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      bakz.a(arrayOfByte, 0, localRespOffFilePack.vBody, j, arrayOfByte.length);
      i = j + arrayOfByte.length;
      byte b3 = localRespOffFilePack.vBody[i];
      i += 1;
      long l6 = bakz.a(localRespOffFilePack.vBody, i);
      if (QLog.isColorLevel()) {
        QLog.d("wk", 2, "" + l1 + "|" + l5 + "|" + s + "|" + paramToServiceMsg + "|" + arrayOfByte + "|" + b3);
      }
      return new away(this, l1, paramFromServiceMsg, b2, b1, l2, l3, l4, l5, s, paramToServiceMsg, arrayOfByte, b3, l6);
    case 2: 
      return new away(this, l1, paramFromServiceMsg, b2, b1);
    case 3: 
      j = localRespOffFilePack.vBody[i];
      i += 1;
      bakz.a(localRespOffFilePack.vBody, i);
      i += 2;
      bakz.a(localRespOffFilePack.vBody, i);
      i += 2;
      bakz.a(localRespOffFilePack.vBody, i);
      ...
      j = localRespOffFilePack.vBody[i];
      i += 1;
      l2 = bakz.a(localRespOffFilePack.vBody, i);
      j = i + 4;
      i = bakz.a(localRespOffFilePack.vBody, j);
      j += 2;
      bakz.a(new byte[i], 0, localRespOffFilePack.vBody, j, i);
      j += i;
      i = bakz.a(localRespOffFilePack.vBody, j);
      j += 2;
      arrayOfByte = new byte[i];
      bakz.a(arrayOfByte, 0, localRespOffFilePack.vBody, j, i);
      j += i;
      ...
      bakz.a((byte[])localObject, 0, localRespOffFilePack.vBody, j, i);
      localObject = bakz.a((byte[])localObject, 0, i);
      i = j + i;
      j = localRespOffFilePack.vBody[i];
      i += 1;
      l3 = bakz.a(localRespOffFilePack.vBody, i);
      i += 4;
      l4 = bakz.a(localRespOffFilePack.vBody, i);
      i += 4;
      bakz.a(localRespOffFilePack.vBody, i);
      ...
      return new away(this, l1, paramFromServiceMsg, b2, b1, l2, HexUtil.bytes2HexStr(arrayOfByte), l4, paramToServiceMsg.extraData.getLong("msgTime"), paramToServiceMsg.extraData.getShort("msgSeq"), l3, (String)localObject, paramToServiceMsg.extraData.getLong("delUin"));
    }
    int j = bakz.a(localRespOffFilePack.vBody, i);
    paramToServiceMsg = new byte[j];
    bakz.a(paramToServiceMsg, 0, localRespOffFilePack.vBody, i + 2, j);
    return new away(this, l1, paramFromServiceMsg, b2, b1, paramToServiceMsg);
  }
