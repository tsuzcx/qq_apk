  ...
  extends WebViewPlugin
{
  ...
  protected Context a;
  private Handler jdField_a_of_type_AndroidOsHandler = new awaz(this, Looper.getMainLooper());
  protected String a;
  private int b;
  protected String b;
  ...
  public awax()
  {
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new away(this);
  ...
  public boolean handleJsRequest(com.tencent.mobileqq.webview.swift.JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    //   68: invokespecial 107	awax:a	(Ljava/lang/String;)V
    //   71: ldc 154
    //   73: aload 4
    //   75: invokevirtual 146	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   78: ifeq +510 -> 588
    //   81: ldc 156
    //   83: invokestatic 159	awbj:a	(Ljava/lang/String;)V
    //   86: aconst_null
    //   87: astore 4
    //   89: aconst_null
    //   90: astore 8
    ...
    //   174: putfield 172	awax:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   177: aload_0
    //   178: aload 5
    //   180: ldc 174
    //   182: invokevirtual 166	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   185: putfield 55	awax:d	Ljava/lang/String;
    //   188: aload_0
    //   189: aload 5
    //   191: ldc 176
    //   193: invokevirtual 166	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   196: putfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   199: aload 5
    //   201: ldc 180
    ...
    //   216: putfield 184	awax:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   219: aload 5
    //   221: ldc 186
    ...
    //   257: dup
    //   258: aload_0
    //   259: getfield 97	awax:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   262: ldc 202
    ...
    //   278: ldc 211
    //   280: aload_0
    //   281: getfield 184	awax:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   284: invokevirtual 214	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   287: pop
    //   288: aload_2
    //   289: ldc 176
    //   291: aload_0
    //   292: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   309: ldc 174
    //   311: aload_0
    //   312: getfield 55	awax:d	Ljava/lang/String;
    ...
    //   333: pop
    //   334: aload_0
    //   335: getfield 97	awax:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   338: aload_2
    ...
    //   347: goto -288 -> 59
    //   350: aload_0
    //   351: getfield 97	awax:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   354: aload_0
    //   355: getfield 184	awax:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   358: aload_2
    //   359: invokestatic 230	awbk:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    //   362: aload_1
    //   363: astore_2
    //   364: aload_1
    //   365: ifnull +10 -> 375
    ...
    //   377: astore_1
    //   378: aload_0
    //   379: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   382: invokestatic 198	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   385: ifeq +9 -> 394
    //   388: aload_0
    //   389: ldc 133
    //   391: putfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   394: new 240	android/content/IntentFilter
    //   397: dup
    //   398: aload_0
    //   399: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   402: invokestatic 242	awax:a	(Ljava/lang/String;)Ljava/lang/String;
    //   405: invokespecial 243	android/content/IntentFilter:<init>	(Ljava/lang/String;)V
    //   408: astore 4
    //   410: aload 4
    //   412: aload_0
    //   413: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   416: invokestatic 245	awax:b	(Ljava/lang/String;)Ljava/lang/String;
    //   419: invokevirtual 248	android/content/IntentFilter:addAction	(Ljava/lang/String;)V
    //   422: aload 4
    //   424: aload_0
    //   425: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   428: invokestatic 250	awax:c	(Ljava/lang/String;)Ljava/lang/String;
    //   431: invokevirtual 248	android/content/IntentFilter:addAction	(Ljava/lang/String;)V
    //   434: aload 4
    //   436: aload_0
    //   437: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   440: invokestatic 252	awax:d	(Ljava/lang/String;)Ljava/lang/String;
    //   443: invokevirtual 248	android/content/IntentFilter:addAction	(Ljava/lang/String;)V
    //   446: aload_0
    //   447: getfield 97	awax:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   450: aload_0
    //   451: getfield 28	awax:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   454: aload 4
    ...
    //   464: putfield 264	awax:jdField_a_of_type_Long	J
    //   467: aload_0
    //   468: getfield 266	awax:jdField_a_of_type_Aasb	Laasb;
    //   471: aload_0
    //   472: getfield 184	awax:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   475: aload_3
    //   476: aload_2
    //   477: aload_0
    //   478: getfield 55	awax:d	Ljava/lang/String;
    //   481: aload_0
    //   482: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   485: aload_1
    //   486: invokevirtual 271	aasb:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   489: ldc 43
    //   491: ldc_w 273
    //   494: aload_0
    //   495: getfield 51	awax:jdField_b_of_type_Int	I
    //   498: invokestatic 262	java/lang/System:currentTimeMillis	()J
    //   501: aload_0
    //   502: getfield 264	awax:jdField_a_of_type_Long	J
    //   505: lsub
    //   506: l2i
    //   507: iconst_4
    ...
    //   512: iconst_0
    //   513: aload_0
    //   514: getfield 55	awax:d	Ljava/lang/String;
    //   517: aastore
    //   518: dup
    //   519: iconst_1
    //   520: aconst_null
    ...
    //   523: iconst_2
    //   524: aload_0
    //   525: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   528: aastore
    //   529: dup
    //   530: iconst_3
    //   531: ldc_w 275
    //   534: aastore
    //   535: invokestatic 280	yup:a	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   538: iconst_1
    //   539: ireturn
    //   540: astore_2
    //   541: aload_2
    ...
    //   580: aload 4
    //   582: invokestatic 292	awas:a	(Ljava/lang/Throwable;)V
    //   585: goto -207 -> 378
    //   588: ldc_w 294
    //   591: aload 4
    ...
    //   596: ifeq +153 -> 749
    //   599: aload_0
    //   600: getfield 266	awax:jdField_a_of_type_Aasb	Laasb;
    //   603: aload_0
    //   604: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   607: aload_0
    //   608: getfield 184	awax:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   611: invokevirtual 297	aasb:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   614: aload_0
    //   615: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   618: invokestatic 299	awax:a	(Ljava/lang/String;)Z
    //   621: ifeq +67 -> 688
    //   624: ldc_w 301
    //   627: invokestatic 159	awbj:a	(Ljava/lang/String;)V
    //   630: aload_0
    //   631: invokespecial 303	awax:a	()V
    //   634: ldc 43
    //   636: ldc_w 294
    //   639: aload_0
    //   640: getfield 51	awax:jdField_b_of_type_Int	I
    //   643: invokestatic 262	java/lang/System:currentTimeMillis	()J
    //   646: aload_0
    //   647: getfield 264	awax:jdField_a_of_type_Long	J
    //   650: lsub
    //   651: l2i
    //   652: iconst_4
    ...
    //   657: iconst_0
    //   658: aload_0
    //   659: getfield 21	awax:jdField_a_of_type_Int	I
    ...
    //   671: iconst_2
    //   672: aload_0
    //   673: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   676: aastore
    //   677: dup
    //   678: iconst_3
    //   679: ldc_w 275
    //   682: aastore
    //   683: invokestatic 280	yup:a	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   686: iconst_0
    //   687: ireturn
    //   688: aload_0
    //   689: getfield 178	awax:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   692: invokestatic 308	awax:b	(Ljava/lang/String;)Z
    //   695: ifeq +12 -> 707
    //   698: ldc_w 310
    //   701: invokestatic 159	awbj:a	(Ljava/lang/String;)V
    //   704: goto -74 -> 630
    //   707: getstatic 313	awbk:a	Ljava/util/Map;
    //   710: aload_0
    //   711: getfield 184	awax:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   714: invokeinterface 319 2 0
    //   719: ifnull -89 -> 630
    //   722: getstatic 313	awbk:a	Ljava/util/Map;
    //   725: aload_0
    //   726: getfield 184	awax:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   729: invokeinterface 319 2 0
    //   734: checkcast 227	awbk
    //   737: getfield 322	awbk:h	I
    //   740: invokestatic 306	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   743: invokestatic 324	awbj:b	(Ljava/lang/String;)V
    //   746: goto -116 -> 630
    //   749: ldc_w 326
    //   752: aload 4
    ...
    //   763: dup
    //   764: aload_0
    //   765: getfield 97	awax:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   768: ldc 202
    ...
    //   801: pop
    //   802: aload_0
    //   803: getfield 97	awax:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   806: aload_1
  ...
  public void onDestroy()
  {
    ...
    {
      this.jdField_a_of_type_Aasb.c(this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString);
