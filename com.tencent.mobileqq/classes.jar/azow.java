  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  private final avaj jdField_a_of_type_Avaj = new avaj("qzone_friendprofile", "com.tencent.mobileqq:qzone", QzonePluginProxyActivity.a());
  private bkgm jdField_a_of_type_Bkgm;
  private boolean jdField_a_of_type_Boolean;
  private bkgm b;
  
  public azow(azlw paramazlw, azfe paramazfe)
  {
  ...
  private String a(QQAppInterface paramQQAppInterface, azfe paramazfe, Card paramCard, boolean paramBoolean, ViewGroup paramViewGroup)
  {
    Object localObject;
    if ((!paramBoolean) && (paramCard.isShowFeeds()) && (!TextUtils.isEmpty(paramCard.strQzoneFeedsDesc))) {
      localObject = bafy.a(paramCard.strQzoneFeedsDesc, paramQQAppInterface);
    }
    String str;
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            localObject = ProfileCardMoreInfoView.a(paramazfe);
            if (paramazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) {
              localObject = anni.a(2131707249);
            }
            str = String.format("%s%s", new Object[] { localObject, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693035) });
            localObject = str;
    ...
    paramQQAppInterface = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131561433, null);
    paramViewGroup.addView(paramQQAppInterface);
    paramQQAppInterface.setOnClickListener(new azoy(this));
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 7)
    {
      this.jdField_b_of_type_Bkgm.post(new ProfileQZoneComponent.7(this));
      return;
    }
    ...
    localObject2 = blsi.a();
    ((blsi)localObject2).jdField_a_of_type_JavaLangString = localQQAppInterface.getCurrentAccountUin();
    ((blsi)localObject2).b = ((String)localObject1);
    localObject1 = localazfe.jdField_a_of_type_ComTencentMobileqqDataCard.vQzoneCoverInfo;
    ...
    for (paramInt = 0;; paramInt = localObject1.length)
    {
      ...
      blsb.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (blsi)localObject2, localazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, localazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.g, -1, 5, this.jdField_a_of_type_Avaj, (byte[])localObject1, false);
      localObject1 = new blrv();
      ((blrv)localObject1).c = "1";
      ((blrv)localObject1).d = "0";
      ((blrv)localObject1).b = 4;
      ((blrv)localObject1).l = "3";
      ((blrv)localObject1).m = "userSummary";
      ((blrv)localObject1).n = "homePage";
      QZoneClickReport.startReportImediately(localQQAppInterface.getAccount(), (blrv)localObject1);
      ...
      bctj.a(BaseApplicationImpl.getContext()).a(localQQAppInterface.getAccount(), "actQZSourceDataReport", true, 0L, 0L, (HashMap)localObject1, null);
      return;
    }
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, azfe paramazfe, Card paramCard, ViewGroup paramViewGroup, List<PhotoInfo> paramList)
  {
    label10:
    int j;
    int i;
    ...
    else
    {
      ...
      j = localResources.getDimensionPixelSize(2131298259);
      i = localResources.getDimensionPixelSize(2131297470);
      k = bgtn.b(30.0F);
      ...
      if ((paramazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int != 0) || ((LocalMultiProcConfig.getInt4Uin("qzone_feed_gray_mask", 1, paramQQAppInterface.getLongAccountUin()) & 0x4000) == 0)) {
        break label337;
      }
      paramazfe = ((LayoutInflater)localObject).inflate(2131561432, null);
      if (ThemeUtil.isInNightMode(paramQQAppInterface)) {
        paramazfe.setBackgroundColor(Color.parseColor("#77F5F6FA"));
      }
      paramViewGroup.addView(paramazfe);
      localObject = paramazfe.getLayoutParams();
      if ((localObject instanceof LinearLayout.LayoutParams))
      {
        ...
        paramazfe.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      i = 0 + m;
      paramazfe.setOnClickListener(new azox(this));
      LpReportInfo_pf00064.allReport(699, 7);
    }
    for (;;)
    {
      paramazfe = paramList.iterator();
      if (!paramazfe.hasNext()) {
        break label10;
      }
      if (!a(paramQQAppInterface, paramCard, paramViewGroup, (PhotoInfo)paramazfe.next(), m, j, new int[] { i }, k)) {
        break;
      }
      return;
      label337:
  ...
  private boolean a(QQAppInterface paramQQAppInterface, Card paramCard, ViewGroup paramViewGroup, PhotoInfo paramPhotoInfo, int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3)
  {
    ...
    View localView2 = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131561431, null);
    ImageView localImageView = (ImageView)localView2.findViewById(2131368611);
    View localView3 = localView2.findViewById(2131368613);
    View localView1 = localView2.findViewById(2131368610);
    View localView4 = localView2.findViewById(2131368612);
    TextView localTextView = (TextView)localView2.findViewById(2131368607);
    UnderlineTextView localUnderlineTextView = (UnderlineTextView)localView2.findViewById(2131368606);
    localUnderlineTextView.setEditableFactory(bdod.a);
    String str2 = "";
    String str1 = "";
    boolean bool = false;
  ...
  private boolean a(Card paramCard)
  {
    ...
    if ((!ProfileActivity.AllInOne.g(localazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne)) || (paramCard == null) || (this.jdField_a_of_type_Boolean))
    {
    ...
    ThreadManager.post(new ProfileQZoneComponent.2(this, localazfe), 8, null, true);
    Object localObject1 = (View)this.jdField_a_of_type_JavaLangObject;
    Object localObject2;
    if (localObject1 == null)
    {
      localObject2 = this.jdField_a_of_type_Azqi.a("map_key_qzone");
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = ((LayoutInflater)localObject3).inflate(2131561430, null);
      }
      this.jdField_a_of_type_JavaLangObject = localObject1;
    }
    for (boolean bool1 = true;; bool1 = false)
    {
      ViewGroup localViewGroup1 = (ViewGroup)((View)localObject1).findViewById(2131368608);
      ViewGroup localViewGroup2 = (ViewGroup)((View)localObject1).findViewById(2131368609);
      ...
      if ((paramCard.ulShowControl & 0x80) != 0)
      {
        ...
        localTextView.setVisibility(8);
        a(localQQAppInterface, localazfe, paramCard, localViewGroup1, (List)localObject2);
        ...
        if (localazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) {
          localTextView.setText(anni.a(2131707210));
        }
        label433:
      ...
      for (localObject2 = "";; localObject2 = localTextView.getText().toString())
      {
        ...
        a(String.format("makeOrRefreshQZone, [h:%s, des: %s, space: %s, remark: %s, nick: %s, info: %s]", new Object[] { paramCard.strQzoneHeader, paramCard.strQzoneFeedsDesc, paramCard.strSpaceName, localazfe.jdField_a_of_type_ArrayOfJavaLangString[4], localazfe.jdField_a_of_type_ArrayOfJavaLangString[0], localObject2 }));
        return bool1;
        bool2 = false;
        break;
        ...
        localTextView.setVisibility(0);
        localTextView.setText(a(localQQAppInterface, localazfe, paramCard, bool2, localViewGroup2));
        break label433;
      }
    }
  }
  ...
  private boolean b()
  {
    azfe localazfe = (azfe)this.jdField_b_of_type_JavaLangObject;
    if (localazfe != null) {
      return azfl.a(localazfe.jdField_a_of_type_Long);
    }
    return false;
  }
  ...
  private void i()
  {
    ...
    blsb.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1037);
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 1037) && (paramInt2 == -1) && (paramIntent != null) && (this.jdField_b_of_type_JavaLangObject != null) && (((azfe)this.jdField_b_of_type_JavaLangObject).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne != null) && (((azfe)this.jdField_b_of_type_JavaLangObject).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0))
    {
    ...
    label150:
    for (Object localObject = null;; localObject = ((anmw)localObject).b(((azfe)this.jdField_b_of_type_JavaLangObject).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString))
    {
      if (localObject != null)
      {
        ((Card)localObject).addQzonePhotoList(localArrayList, paramIntent);
        ((Card)localObject).hasFakeData = true;
        ((azfe)this.jdField_b_of_type_JavaLangObject).jdField_a_of_type_ComTencentMobileqqDataCard = ((Card)localObject);
        a(((azfe)this.jdField_b_of_type_JavaLangObject).jdField_a_of_type_ComTencentMobileqqDataCard);
      }
      return;
    }
  }
  ...
  public void a(@NonNull BaseActivity paramBaseActivity, @Nullable Bundle paramBundle)
  {
    ...
    this.jdField_b_of_type_Bkgm = new bkgm(Looper.getMainLooper(), null);
    ThreadManager.post(new ProfileQZoneComponent.1(this, (azfe)this.jdField_b_of_type_JavaLangObject), 8, null, true);
  }
  ...
  public void c()
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      if (localWebProcessManager != null) {
        localWebProcessManager.a(-1, new azoz(this.jdField_a_of_type_Avaj));
      }
      blsb.a(localQQAppInterface, this.jdField_a_of_type_Avaj);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    a();
    ThreadManager.post(new ProfileQZoneComponent.5(this, localazfe), 8, null, true);
    bcst.b(localQQAppInterface, "CliOper", "", "", "P_prof", "Pp_clk_qzone", ProfileActivity.a(localazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.h), 0, Integer.toString(ProfileActivity.a(localazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne)), "", "", "");
    if (localazfe.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) {
      bcst.b(localQQAppInterface, "CliOper", "", "", "0X8006A7C", "0X8006A7C", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      if (localazfe.b) {
        new bcsy(localQQAppInterface).a("dc00899").b("Grp_mem_card").c("page").d("zone_clk").a(new String[] { localazfe.jdField_a_of_type_JavaLangString }).a();
      }
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      bcst.b(localQQAppInterface, "CliOper", "", "", "0X8006A90", "0X8006A90", 0, 0, "", "", "", "");
    }
  }
}
