...
{
  public int a;
  private HashMap<String, bizc> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private HashSet<String> jdField_a_of_type_JavaUtilHashSet = new HashSet();
  private List<bizd> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private bizc a(String paramString1, String paramString2, bizd parambizd)
  {
    if ((TextUtils.isEmpty(paramString2)) || (parambizd == null)) {}
    ...
    do
    {
      ...
      arrayOfString = str1.split(parambizd.jdField_b_of_type_JavaLangString);
      if ((paramString2.length >= parambizd.jdField_a_of_type_Int) && (arrayOfString.length >= parambizd.d)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("WadlCommConfig", 1, "interrupt url fail, pathInfo.length=" + paramString2.length + ",fileInfo.length=" + arrayOfString.length);
    return null;
    String str2 = paramString2[parambizd.jdField_b_of_type_Int];
    if (parambizd.c > -1)
    {
      paramString2 = paramString2[parambizd.c];
      if (parambizd.e <= -1) {
        break label192;
      }
    }
    label192:
    for (String str1 = arrayOfString[parambizd.e];; str1 = "")
    {
      return new bizc(str2, paramString2, str1, arrayOfString[parambizd.f], paramString1);
      paramString2 = "";
      break;
    }
  }
  ...
  /* Error */
  public bizc a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 39	bizg:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   4: aload_1
    //   5: invokevirtual 128	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   8: checkcast 113	bizc
    //   11: astore_2
    //   12: aload_2
    //   13: astore_3
    //   14: aload_2
    //   15: ifnonnull +70 -> 85
    //   18: aload_0
    //   19: getfield 34	bizg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   48: checkcast 68	bizd
    //   51: astore_3
    //   52: aload_3
    //   53: getfield 145	bizd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   80: aload_3
    //   81: invokespecial 165	bizg:a	(Ljava/lang/String;Ljava/lang/String;Lbizd;)Lbizc;
    //   84: astore_3
    //   85: aload_3
    //   86: areturn
    //   87: astore_1
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < j)
        {
          ...
          localObject4 = new bizd();
          ((bizd)localObject4).jdField_a_of_type_JavaLangString = ((JSONObject)localObject3).getString("pattern");
          ((bizd)localObject4).jdField_a_of_type_Int = ((JSONObject)localObject3).getInt("path_node_num");
          ((bizd)localObject4).jdField_b_of_type_Int = ((JSONObject)localObject3).getInt("appid_index");
          ((bizd)localObject4).c = ((JSONObject)localObject3).optInt("app_name_index", -1);
          ((bizd)localObject4).jdField_b_of_type_JavaLangString = ((JSONObject)localObject3).getString("split_name_char");
          ((bizd)localObject4).d = ((JSONObject)localObject3).getInt("name_node_num");
          ((bizd)localObject4).e = ((JSONObject)localObject3).optInt("channel_index", -1);
          ((bizd)localObject4).f = ((JSONObject)localObject3).getInt("pkg_name_index");
          if ((((bizd)localObject4).jdField_b_of_type_Int < ((bizd)localObject4).jdField_a_of_type_Int) && (((bizd)localObject4).c < ((bizd)localObject4).jdField_a_of_type_Int) && (((bizd)localObject4).e < ((bizd)localObject4).d) && (((bizd)localObject4).f < ((bizd)localObject4).d)) {
        ...
        else
        {
          ...
          while (i < j)
          {
            ...
            this.jdField_a_of_type_JavaUtilHashMap.put(localObject2, new bizc((String)localObject3, (String)localObject4, str1, str2, (String)localObject5));
            i += 1;
          }
          break label146;
          label544:
