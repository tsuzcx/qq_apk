...
public class bmko
{
  ...
  public bmko(int paramInt)
  {
    this.a = new Intent();
    this.a.putExtra("nType", paramInt);
  }
  
  public bmko(Intent paramIntent)
  {
    this.a = paramIntent;
  }
  
  public static bmko a()
  {
    return new bmko(3);
  }
  
  public static bmko a(float paramFloat1, float paramFloat2, String paramString1, String paramString2, String paramString3)
  {
    return new bmko(7).b("sLocation", paramString2).b("sBrief", paramString3).b("sPublisher", paramString1).a("fLatitude", paramFloat1).a("fLongitude", paramFloat2);
  }
  
  public static bmko a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, byte[] paramArrayOfByte, boolean paramBoolean, long paramLong)
  {
    ...
    {
      paramArrayOfByte = bmlc.a(paramArrayOfByte);
      str6 = bmlc.a(paramArrayOfByte[0], paramString1);
      str5 = bmlc.a(paramArrayOfByte[1], paramString2);
      str4 = bmlc.a(paramArrayOfByte[2], paramString3);
      str3 = bmlc.a(paramArrayOfByte[3], paramString4);
      str2 = bmlc.a(paramArrayOfByte[4], paramString5);
      str1 = bmlc.a(paramArrayOfByte[5], paramString6);
    }
    paramString1 = new bmko(6).a("nLinkType", paramInt).b("sTitle", str6).b("sUrl", str5).a("bAppShare", paramBoolean).a("lAppId", paramLong).b("sPublisher", str4).b("sBrief", str3).b("sPath", str2).b("sResUrl", str1);
    if (paramBoolean) {}
  ...
  public static bmko a(Intent paramIntent)
  {
    int i = 1;
    if (paramIntent == null) {
      return null;
    ...
    for (i = (int)new File((String)localObject).length();; i = paramIntent.getIntExtra("file_thumb_Size", 0))
    {
      ...
      localObject = new bmko(5);
      ((bmko)localObject).a.putExtra("shortVideoContents", localContentValues);
      if (j == 0) {
        ((bmko)localObject).a.putExtra("sBizDataList", bmkq.a());
      }
      return ((bmko)localObject).c(paramIntent.getStringExtra("from_uin"));
      i = j;
      break;
      l = 0L;
      break label132;
  ...
  public static bmko a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return null;
    }
    bmko localbmko = new bmko(8).c(paramMessageForStructing);
    if (!bmlc.a(paramMessageForStructing))
    {
      localbmko.c(paramMessageForStructing);
      return localbmko;
    }
    ArrayList localArrayList = new ArrayList();
    byte[] arrayOfByte = bmlc.a(paramMessageForStructing.uniseq, paramMessageForStructing.structingMsg);
    if (arrayOfByte != null) {
    ...
    {
      arrayOfByte = bmlc.a(paramMessageForStructing.uniseq, l);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      arrayOfByte = bmlc.a(-1L, paramMap);
      if (arrayOfByte != null) {
        localArrayList.add(arrayOfByte);
      }
      bmlc.a(paramQQAppInterface, paramMessageForStructing, paramList, paramMap, localArrayList);
      if (localArrayList != null) {
        localbmko.b("sBizDataList", localArrayList);
      }
      return localbmko;
    }
  }
  
  public static bmko a(MessageForShortVideo paramMessageForShortVideo)
  {
    ContentValues localContentValues = new ContentValues();
  ...
  public static bmko a(Entity paramEntity)
  {
    return new bmko(2).c(paramEntity);
  }
  
  public static bmko a(String paramString)
  {
    return new bmko(6).b("sUrl", paramString);
  }
  
  public static bmko a(String paramString1, int paramInt, String paramString2)
  {
    return new bmko(4).b("sPath", paramString1).a("nDuration", paramInt).b("sBrief", paramString2);
  }
  
  public static bmko a(String paramString1, int paramInt, String paramString2, long paramLong1, String paramString3, long paramLong2)
  {
    paramInt = bmlc.b(paramInt);
    ...
    for (;;)
    {
      ...
      return new bmko(2).b("sMD5", paramString1).b("sPath", paramString3).a("nPicType", paramInt).b("sPicId", paramString2).a("lSize", paramLong2);
    }
  }
  
  public static bmko a(String paramString1, String paramString2)
  {
    return new bmko(1).b("sText", paramString2).b("sTitle", paramString1);
  }
  
  public static bmko a(ArrayList<String> paramArrayList, boolean paramBoolean1, String paramString1, String paramString2, boolean paramBoolean2, long paramLong, String paramString3)
  {
    paramArrayList = new bmko(8).a("sPathList", paramArrayList).b("sTitle", paramString1).a("bOnlyPic", paramBoolean1).b("sText", paramString2).a("bAppShare", paramBoolean2).a("lAppId", paramLong).b("sAppName", paramString3);
    if (paramBoolean2) {}
    for (paramLong = 4L;; paramLong = 1L) {
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      bmkq.a(paramActivity, str, bool, null, false);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    {
      return;
      localObject2 = (MessageForArkApp)aqbu.a(1, ((MessageForArkApp)localObject1).ark_app_message.appName, localObject1, localObject1);
      ...
      try
      {
        ...
        if (araw.c.equals(((MessageForArkApp)localObject1).ark_app_message.appName))
        {
          ...
          bmky.a(paramQQAppInterface, 11, 0, paramChatMessage.istroop);
          return;
        }
      }
    ...
    {
      localObject3 = paramContext.getString(2131717740);
    ...
    for (i = 4;; i = 5)
    {
      ...
      bmky.a(paramQQAppInterface, 9, 0, paramChatMessage.istroop);
      return;
      bmky.a(paramQQAppInterface, 8, 0, paramChatMessage.istroop);
      return;
      break label50;
      break;
      i = 1;
  ...
  public static bmko b(Entity paramEntity)
  {
    return new bmko(8).c(paramEntity);
  }
  
  public static bmko b(String paramString)
  {
    return new bmko(2).b("sPath", paramString);
  }
  ...
  public bmko a(int paramInt, long paramLong1, String paramString1, long paramLong2, String paramString2)
  {
  ...
  public bmko a(long paramLong)
  {
    return a("requestId", paramLong);
  }
  
  public bmko a(long paramLong, String paramString)
  {
    this.a.putExtra("nAuthorType", 1).putExtra("lUin", paramLong).putExtra("sName", paramString);
    return this;
  }
  
  public bmko a(QQAppInterface paramQQAppInterface)
  {
  ...
  public bmko a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public bmko a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if (paramQQAppInterface == null) {
      return this;
    }
    int i = bmlc.a(paramInt2);
    String str2 = "";
    long l6 = 0L;
    Object localObject4 = "";
    long l5 = 0L;
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (paramMessageRecord != null)
          {
            ...
            if (nlj.a(paramMessageRecord))
            {
              ...
              else
              {
                ...
                paramString1 = (String)localObject1;
                l3 = l1;
                localObject4 = BaseApplicationImpl.getContext().getString(2131689997);
              }
            }
          }
          l4 = l2;
          ...
          l3 = l1;
          localObject1 = bgrf.a(paramMessageRecord);
          ...
          paramString1 = (String)localObject4;
          l3 = l1;
          paramMessageRecord = ((bgrg)localObject1).c;
        }
        ...
        paramString1 = paramMessageRecord;
        l3 = l1;
        localObject3 = bhlg.a(paramQQAppInterface, (String)localObject1, true);
        l4 = l2;
        localObject2 = localObject3;
        paramString1 = paramMessageRecord;
        l3 = l1;
        ...
        try
        {
          localObject1 = bhlg.c(paramQQAppInterface, paramString2);
          paramString1 = (String)localObject1;
        ...
        if (str1 != null)
        {
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bhlg.b(paramQQAppInterface, str1, paramInt2);
          l1 = 0L;
          l2 = l5;
          localObject3 = localObject4;
          continue;
          ...
          paramString1 = str2;
          l3 = l6;
          localObject1 = bhlg.b(paramQQAppInterface, paramString2, paramInt2);
          l4 = l5;
          localObject2 = localObject4;
          paramString1 = (String)localObject1;
          l3 = l6;
    ...
    for (;;)
    {
      ...
      paramString1 = str2;
      l3 = l6;
      localObject3 = bhlg.b(paramQQAppInterface, str1, 0);
      ...
      if (((String)localObject3).equals(str1))
      {
        ...
        if (paramInt2 == 3000)
        {
          ...
          paramString1 = (String)localObject3;
          l3 = l6;
          localObject1 = bhlg.a(paramQQAppInterface, paramString2, str1);
        }
      }
      l4 = l5;
      localObject2 = localObject4;
      ...
      for (localObject3 = bhlg.a(paramQQAppInterface, paramString2, true);; localObject3 = bhlg.c(paramQQAppInterface, paramString2))
      {
        l4 = l5;
        localObject2 = localObject3;
        paramString1 = (String)localObject1;
  ...
  public bmko a(String paramString, float paramFloat)
  {
    this.a.putExtra(paramString, paramFloat);
    return this;
  }
  
  public bmko a(String paramString, int paramInt)
  {
    this.a.putExtra(paramString, paramInt);
    return this;
  }
  
  public bmko a(String paramString, long paramLong)
  {
    this.a.putExtra(paramString, paramLong);
    return this;
  }
  
  public bmko a(String paramString, ArrayList<String> paramArrayList)
  {
    this.a.putStringArrayListExtra(paramString, paramArrayList);
    return this;
  }
  
  public bmko a(String paramString, boolean paramBoolean)
  {
  ...
  {
    return a(paramActivity, paramString, 2131691991, null);
  }
  ...
  public boolean a(Activity paramActivity, String paramString, int paramInt, Intent paramIntent, boolean paramBoolean)
  {
    ...
    } while ((paramIntent.getIntExtra("nPicType", 1) != 1) || (!bmlc.a(str, paramIntent.getLongExtra("lSize", -1L))));
    paramIntent.putExtra("nReasonInt", 2131694372);
    if (QLog.isColorLevel()) {
      QLog.i("qqfav", 1, "QfavBuilder.add: picture too big [" + str + "]");
    }
    bmky.a(null, "Net_AddFav", 3, 3, -3);
    return false;
  }
  
  public boolean a(Activity paramActivity, String paramString, int paramInt, bmkp parambmkp)
  {
    ...
    if (!bool)
    {
      ...
      if (this.a != null) {
        localObject1 = paramActivity.getString(this.a.getIntExtra("nReasonInt", 2131691992));
      }
    }
    bmkq.a(paramActivity, paramString, bool, (String)localObject1, false, paramInt);
    if (parambmkp != null) {
      parambmkp.b(bool);
    }
    return bool;
    ...
    for (;;)
    {
      ...
      for (paramString = new File(str1);; paramString = null)
      {
        ...
        if (paramFileManagerEntity != null)
        {
          ...
          str2 = auog.a((String)localObject);
          n = 6;
        ...
        for (paramString = paramFileManagerEntity.fileName.getBytes();; paramString = paramString.getName().getBytes())
        {
          ...
          if (!paramBoolean1) {
            bmlc.a(paramContext, 2131691994, 1);
          }
          bmky.a(paramQQAppInterface, "User_AddFav", 6, -80010, n, i, str2, null);
          paramQQAppInterface = new ContentValues();
          paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692008));
          this.a.putExtra("fileContents", paramQQAppInterface);
          return false;
          m = aunj.a(paramFileManagerEntity);
          break;
          localObject = str1;
          break label78;
        ...
        default: 
          if (!paramBoolean1) {
            bmlc.a(paramContext, 2131691995, 0);
          }
          bmky.a(paramQQAppInterface, "User_AddFav", 6, -80003, n, i, str2, null);
          paramQQAppInterface = new ContentValues();
          paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692010));
          this.a.putExtra("fileContents", paramQQAppInterface);
          return false;
        case 1: 
          ...
          {
            if (!paramBoolean1) {
              bmlc.a(paramContext, 2131691993, 1);
            }
            bmky.a(paramQQAppInterface, "User_AddFav", 6, -80011, n, i, str2, null);
            paramQQAppInterface = new ContentValues();
            paramQQAppInterface.put("errorMsg", BaseApplicationImpl.getContext().getResources().getString(2131692007));
            this.a.putExtra("fileContents", paramQQAppInterface);
            return false;
          }
          break;
        ...
        while (paramFileManagerEntity == null)
        {
          ...
          case 3: 
            ...
            if (!paramBoolean1)
            {
              paramString = str1;
              if (this.a != null) {
                paramString = paramContext.getString(this.a.getIntExtra("nReasonInt", 2131691992));
              }
            }
            paramQQAppInterface.runOnUiThread(new QfavBuilder.1(this, paramContext, paramQQAppInterface, paramBoolean1, paramString));
            if (paramChatMessage != null) {
              bmky.a(paramQQAppInterface, 5, paramFileManagerEntity.nFileType, paramChatMessage.istroop);
            }
            bmky.a(paramQQAppInterface, "User_AddFav", 6, 0, n, i, str2, null);
  ...
  public bmko b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public bmko b(String paramString1, String paramString2)
  {
    this.a.putExtra(paramString1, paramString2);
    return this;
  }
  
  public bmko b(String paramString, ArrayList<byte[]> paramArrayList)
  {
  ...
  public bmko c(Entity paramEntity)
  {
    this.a.putExtra("cvEntityContents", bmlc.a(paramEntity, ""));
    this.a.putExtra("sEntityClassName", paramEntity.getClass().getName());
    return this;
  }
  
  public bmko c(String paramString)
  {
    try
    {
  ...
  public boolean c(Activity paramActivity, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    bmkq.a(paramActivity, paramString, bool, "", false, 2131691991);
    return bool;
  }
}
