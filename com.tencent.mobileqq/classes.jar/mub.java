  ...
  implements bfle
{
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (mtt.a(this.a) != null) {
      mtt.a(this.a).a(paramString);
    }
  }
  ...
  public void a(int paramInt, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvVideoController != null)
      {
        ...
        mtt.a(this.a, paramArrayOfString);
        mtt.a(this.a, paramString2, paramString1);
        if (paramArrayOfString != null)
        {
          ...
          while (paramInt < paramArrayOfString.length)
          {
            if (paramArrayOfString[paramInt].equals("DEVICE_WIREDHEADSET")) {
              mqz.k(this.a.jdField_a_of_type_ComTencentAvVideoController);
            }
            paramInt += 1;
          }
        }
  ...
  public void a(long paramLong, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        ...
        paramString2 = "";
        String[] arrayOfString = ((lgf)localObject).a;
        if (((lgf)localObject).c != 3)
        {
          paramString2 = ((lgf)localObject).q;
          ((lgf)localObject).a("onDeviceListUpdate", paramString1);
        }
        ((lgf)localObject).a = paramArrayOfString;
        ((lgf)localObject).r = paramString3;
        mtt.a(this.a, paramArrayOfString);
        mtt.a(this.a, paramString2, paramString1);
        if (mtt.a(this.a) != null) {
          mtt.a(this.a).notifyDataSetChanged();
        }
        this.a.a();
      ...
      } while (mtt.a(this.a) == null);
      mtt.a(this.a).a(null, new mtz(paramArrayOfString));
    } while (this.a.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null);
