  ...
  implements View.OnClickListener
{
  ...
  public mnm(View paramView, BaseData paramBaseData)
  {
  ...
  private void a()
  {
    try
    {
      ThreadManager.post(new mnn(this), 8, null, false);
      return;
    }
    catch (Exception localException) {}
  }
  ...
  private void b()
  {
    ...
    {
      a(true);
      PublicAccountUtil.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidViewView.getContext(), Long.toString(a()), new mnp(this));
    }
  }
