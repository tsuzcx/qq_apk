  ...
  extends Dialog
{
  ...
  private HashMap<CharSequence, beng> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private HashSet<Integer> jdField_a_of_type_JavaUtilHashSet;
  public boolean a;
  private int jdField_b_of_type_Int = 300;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new benk(this);
  private CharSequence jdField_b_of_type_JavaLangCharSequence;
  private HashMap<Integer, Drawable> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  protected boolean b;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new benl(this);
  ...
  protected benh(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true);
  }
  
  @TargetApi(14)
  protected benh(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    super(paramContext, 2131755750);
    ...
    if ((paramBoolean3) && (bffu.jdField_a_of_type_Boolean)) {
    ...
    bffu.a(getWindow(), true);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559287, null));
    super.setContentView(this.jdField_a_of_type_AndroidViewViewGroup);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131361911));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131361917));
  ...
  private int a(int paramInt)
  {
    ...
    {
    default: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165734);
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165734);
    case 1: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165734);
    ...
    case 4: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165734);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165738);
    case 5: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165734);
    case 6: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165734);
    ...
    return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165741);
  }
  
  public static benh a(Context paramContext)
  {
    paramContext = new benh(paramContext, false, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755747);
    }
    return paramContext;
  }
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131694211) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131694212) + paramTextView.getText());
  }
  ...
  private void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559290, null);
      ((View)localObject1).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840702));
      ((View)localObject1).setOnClickListener(new beni(this));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131361927));
      ...
      {
        localObject2 = (TextView)((View)localObject1).findViewById(2131361924);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          localObject2 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559289, null);
          TextView localTextView = (TextView)((View)localObject2).findViewById(2131361914);
          ...
          beke.a(localTextView, Button.class.getName());
          if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
          {
            localObject3 = (beng)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
            if ((localObject3 != null) && (((beng)localObject3).jdField_a_of_type_Int != 0)) {
              localTextView.setId(((beng)localObject3).jdField_a_of_type_Int);
            }
          }
          Object localObject3 = (ImageView)((View)localObject2).findViewById(2131361925);
          RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)((ImageView)localObject3).getLayoutParams();
          localLayoutParams.rightMargin = bffu.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
          ...
          if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(i)))
          {
            ...
            label415:
            localObject3 = (ImageView)((View)localObject2).findViewById(2131361926);
            ...
            {
              localLayoutParams.width = bffu.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
              localLayoutParams.height = bffu.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
              localLayoutParams.addRule(15);
            }
            localLayoutParams.rightMargin = bffu.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
            ((ImageView)localObject3).setLayoutParams(localLayoutParams);
            ...
            if (this.jdField_c_of_type_Boolean)
            {
              ...
              ((View)localObject2).findViewById(2131361915).setVisibility(0);
      ...
      {
        localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559288, null);
  ...
  public Drawable a(int paramInt)
  {
    ...
    case 2: 
    default: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840701);
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840698);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840701);
    }
    return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840705);
  }
