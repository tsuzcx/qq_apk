  ...
  implements aeng
{
  ...
  public aemy(QQAppInterface paramQQAppInterface, aeob paramaeob, Activity paramActivity, SessionInfo paramSessionInfo, acka paramacka)
  {
  ...
  {
    paramVarArgs = awbi.a(-1016);
    long l = awao.a();
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131626253), l, -1017, 3000, l);
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = amnb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (((amnb)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            localList = this.jdField_a_of_type_Acka.a();
            if (localList == null)
            {
              if (!QLog.isColorLevel()) {
                break;
            ...
            if (!badq.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramInt >= 5) && (i >= 2))
        {
          if (!this.jdField_a_of_type_Aeob.a(this, new Object[0])) {
            break label1201;
          }
          ((amnb)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2);
        ...
        for (;;)
        {
          try
          {
            awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8003F01", "0X8003F01", 0, 0, "", "", "", "");
