...
public class bdiw
{
  ...
  {
    PackageManager localPackageManager = bcxm.a().a().getPackageManager();
    try
    {
    ...
    {
      bdht.b("AppUtil", "getApkVersonCode>>>", paramString);
    }
    return 0;
  }
  ...
  public static Bitmap a(String paramString)
  {
    try
    {
      ...
      if ((paramString != null) && (paramString.applicationInfo != null))
      {
        ...
        if (paramString != null)
        {
          paramString = bdhr.b(paramString);
          return paramString;
        }
      }
    }
  ...
  public static String a(Context paramContext, String paramString)
  {
    try
    {
      ...
      if (paramContext != null)
      {
        ...
        {
          paramContext = bdhv.d(paramContext[(paramContext.length - 1)].toCharsString());
          return paramContext;
        }
      }
    }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = bcxm.a().a().getPackageManager().getPackageArchiveInfo(paramString, 1);
        if (paramString != null)
        {
      ...
      {
        bdht.c("AppUtil", "getApkName>>>", paramString);
      }
    }
    return null;
  }
  ...
  public static List<PackageInfo> a(Context paramContext)
  {
    if (paramContext != null)
    {
      ...
      if (paramContext != null)
      {
        bdht.b("AppUtil", "getInstalledPackages switch is open, will scan local packages");
        return paramContext.getInstalledPackages(0);
      }
    }
    bdht.b("AppUtil", "getInstalledPackages switch is closed, will not scan local packages");
    return null;
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      bdht.c("add", ">>has add platformid=qzone_m");
    ...
    catch (Exception localException)
    {
      ...
      if (paramString1 != null)
      {
        ...
        catch (Exception paramString1)
        {
          ...
          Toast.makeText(paramContext, ajyc.a(2131700622), 0).show();
          return;
        }
      }
      Toast.makeText(paramContext, ajyc.a(2131700623), 0).show();
    }
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      bdht.c("add", ">>has add appCustom=" + paramString3);
    }
    paramString1.putExtra("platformId", "qzone_m");
    bdht.c("add", ">>has add platformid=qzone_m");
    try
    ...
    {
      Toast.makeText(paramContext, ajyc.a(2131700624), 0).show();
    }
  }
  ...
  public static boolean a(Context paramContext)
  {
    if (paramContext == null)
    {
      bdht.e("AppUtil", "isPackageScanAllowed context is null");
      return true;
    }
    try
    {
      boolean bool = bcxm.a().a().getSharedPreferences("package_scan", 0).getBoolean("qqsetting_package_scan_flag", true);
      return bool;
    }
    catch (Exception paramContext)
    {
    ...
    if (localIntent == null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((akgs)((BaseActivity)paramContext).app.a(23)).b(paramString.trim(), paramContext, localIntent);
            return true;
          }
          catch (Exception paramBundle)
          {
            for (;;)
            {
              try
              {
                new akgs((QQAppInterface)null).a(paramString.trim(), paramContext, localIntent);
              }
              catch (Exception paramString)
              {
      ...
      {
        Toast.makeText(paramContext, ajyc.a(2131700625), 0).show();
        return false;
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      if (new File(paramString1).exists())
      {
        ...
        {
          bdht.b("AppUtil", "installApp>>> put source " + paramString2);
          paramString1.putExtra("big_brother_source_key", paramString2);
        }
        if (!TextUtils.isEmpty(paramString3))
        {
          bdht.b("AppUtil", "installApp>>> put ref id " + paramString3);
    ...
    {
      bdht.c("AppUtil", "installApp>>>", paramContext);
    }
    return false;
  }
  ...
  public static int b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bdht.c("AppUtil", "getApkVersonCodeFromApkFile>>>", paramString);
      }
    }
    return 0;
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    {
      bdht.b("AppUtil", "getCurProcessName err", paramContext);
    }
    return null;
  }
  ...
  {
    bdht.b("AppUtil", "getAppVersionCode: " + paramString);
    localObject1 = null;
    try
    {
      a(paramString);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bdht.e("AppUtil", "openManifest failed: " + localException.getMessage());
      }
    }
    ...
    for (;;)
    {
      ...
      {
        String str;
        bdht.e("AppUtil", "error: " + paramString.getMessage());
        localObject1.close();
        return 0;
      }
      ...
      if ((!TextUtils.isEmpty(str)) && (str.equals("manifest")))
      {
        ...
        if (i < localObject1.getAttributeCount())
        {
          if (localObject1.getAttributeName(i).equals("versionCode"))
          {
            ...
            localObject1.close();
            bdht.b("AppUtil", "apkPath:" + paramString + ",versionCode:" + str);
