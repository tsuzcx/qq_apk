...
final class awwj
  implements ayxc
{
  awwj(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2) {}
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          Object localObject4 = new bepr();
          ((bepr)localObject4).jdField_a_of_type_Int = localMessageRecord.istroop;
          ArrayList localArrayList1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramayxd.jdField_a_of_type_ArrayOfByte, (HashMap)localObject1, null, (bepr)localObject4);
          ...
          if (((MessageRecord)localArrayList1.get(0)).msgtype == -1035)
          {
            ...
            ((awmg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(174)).a(true, this.jdField_a_of_type_Int);
            ...
            {
              ((bepr)localObject4).jdField_a_of_type_Beps.a(13, this.jdField_a_of_type_Long);
              ((bepr)localObject4).jdField_a_of_type_Beps.a(24, this.jdField_a_of_type_Long);
              ...
              if (QLog.isColorLevel()) {
                QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg update MessageInfo-- groupUin:" + str + "lastSeq:" + l + ",shMsgSeq:" + localMessageRecord.shmsgseq + ",msgInfo.hasFlag:" + ((bepr)localObject4).a());
              }
              if ((localMessageRecord.shmsgseq > l) && (((bepr)localObject4).a()))
              {
                localMessageRecord.mMessageInfo = ((bepr)localObject4);
                localObject4 = (acvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1);
                ArrayList localArrayList2 = new ArrayList();
                localArrayList2.add(localMessageRecord);
                ((acvk)localObject4).a(str, localArrayList2);
              }
            }
            ...
            ((awwg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(166)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Int, paramayxd.jdField_a_of_type_Int, 1);
            return;
          }
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg onDownload exception! resultCode:" + paramayxd.jdField_a_of_type_Int + ",errCode: " + paramayxd.b + ",errStr:" + paramayxd.jdField_a_of_type_JavaLangString + ",cost:" + (System.currentTimeMillis() - this.b));
        continue;
        ...
        try
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg onDownload failed! resultCode:" + paramayxd.jdField_a_of_type_Int + ",errCode: " + paramayxd.b + ",errStr:" + paramayxd.jdField_a_of_type_JavaLangString + ",cost:" + (System.currentTimeMillis() - this.b));
          }
        }
