...
public class apim
{
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      localReqBody.version.set("8.3.5");
    ...
    mzy.a(paramQQAppInterface, new apin(), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, apio paramapio)
  {
    oidb_0x877.ReqBody localReqBody = new oidb_0x877.ReqBody();
    localReqBody.uint32_refer.set(paramInt);
    mzy.a(paramQQAppInterface, paramapio, localReqBody.toByteArray(), "OidbSvc.0x877_0", 2167, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, apip paramapip)
  {
    mzy.a(paramQQAppInterface, paramapip, new oidb_0x876.ReqBody().toByteArray(), "OidbSvc.0x876_" + paramInt, 2166, paramInt);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<Long> paramList, Bundle paramBundle, apiq paramapiq)
  {
    ...
    mzy.a(paramQQAppInterface, paramapiq, localReqBatchGetAnchorStatus.toByteArray(), "NearbyNowTips.batch_get_anchor_stats", paramList);
  }
}
