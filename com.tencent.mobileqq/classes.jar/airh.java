  ...
  implements bksu
{
  ...
  public airh(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_JavaLangString == null) && (Build.VERSION.SDK_INT >= 21) && (this.jdField_b_of_type_Boolean))
    {
      if (!bdin.a())
      {
        QQToast.a(this.mActivity, alud.a(2131689825), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
        return;
      }
    ...
    if (this.mPhotoCommonData.selectedPhotoList.size() == 0)
    {
      ...
      {
        QQToast.a(this.mActivity, alud.a(2131689826), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
        return;
      }
      this.mPhotoCommonData.selectedPhotoList.add(this.jdField_b_of_type_JavaLangString);
    }
    blpw.a(this.jdField_b_of_type_Int, this.mActivity, this.mPhotoCommonData, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Boolean);
  ...
  public void initUI()
  {
    super.initUI();
    ((NewPhotoPreviewActivity)this.mActivity).selectLayout.setVisibility(8);
    ((NewPhotoPreviewActivity)this.mActivity).sendBtn.setOnClickListener(new airi(this));
  }
  ...
  public void onSelectClick(View paramView)
  {
    ...
    for (String str = (String)this.mPhotoPreviewData.paths.get(i);; str = "")
    {
      ...
      int j = bdfa.getMediaType(localLocalMediaInfo);
      if (!this.mPhotoCommonData.selectedIndex.contains(Integer.valueOf(i)))
      {
        ...
        {
          QQToast.a(this.mActivity, alud.a(2131689827), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
          return;
        }
        ...
        {
          QQToast.a(this.mActivity, alud.a(2131689828), 0).b(((NewPhotoPreviewActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
          return;
        }
        if (j != 1) {}
      }
