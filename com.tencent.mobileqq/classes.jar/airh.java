...
public class airh
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new airi(this, Looper.getMainLooper());
  ...
  public boolean a()
  {
    ...
    airl localairl = new airl();
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localairl);
      this.jdField_a_of_type_Int = localairl.a();
      this.jdField_a_of_type_JavaUtilArrayList = localairl.a();
      return true;
    }
