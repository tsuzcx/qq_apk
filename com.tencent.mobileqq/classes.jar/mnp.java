...
public class mnp
  implements mnu
{
  mnu jdField_a_of_type_Mnu;
  
  public mnp(EffectFilterPanel paramEffectFilterPanel, mnu parammnu)
  {
    a(parammnu);
  }
  ...
  {
    if (AudioHelper.f()) {
      QLog.w("EffectFilterPanel", 1, "OnItemSelected, id[" + paramInt + "], name[" + paramString + "], seq[" + paramLong + "], Visibility[" + EffectFilterPanel.a(this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectFilterPanel).getVisibility() + "], mlistener[" + this.jdField_a_of_type_Mnu + "]");
    }
  ...
  public void a(mnu parammnu)
  {
    this.jdField_a_of_type_Mnu = parammnu;
  }
}
