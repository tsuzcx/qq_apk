...
{
  public aadu(EditUniqueTitleActivity paramEditUniqueTitleActivity) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (paramEditable = this.a.getResources().getColorStateList(2131167168);; paramEditable = this.a.getResources().getColorStateList(2131167112))
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.getString(2131695878), new Object[] { Integer.valueOf(i) }));
      return;
