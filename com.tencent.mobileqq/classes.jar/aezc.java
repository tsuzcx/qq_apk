...
public class aezc
{
  ...
  private aezd jdField_a_of_type_Aezd;
  ...
  {
    SpannableString localSpannableString = new SpannableString(alud.a(2131717243) + this.jdField_a_of_type_JavaLangString);
  ...
  public void a(QQAppInterface paramQQAppInterface, ColorStateList paramColorStateList, aezd paramaezd)
  {
    this.jdField_a_of_type_AndroidContentResColorStateList = paramColorStateList;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilTimer = new Timer();
    this.jdField_a_of_type_Aezd = paramaezd;
  }
