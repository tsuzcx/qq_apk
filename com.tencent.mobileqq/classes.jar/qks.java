...
public class qks
{
  ...
  public qks(qls paramqls, List<VideoInfo> paramList, VideoFeedsRecyclerView paramVideoFeedsRecyclerView, Handler paramHandler)
  {
    ...
    onk.a().getManager(163);
    this.jdField_a_of_type_Pao = new qkt(this);
  }
  ...
  private VideoInfo a(AdvertisementInfo paramAdvertisementInfo, boolean paramBoolean)
  {
    ...
    localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo = nmf.a(paramAdvertisementInfo);
    ...
    try
    {
      ...
      {
        localObject = onk.a(paramAdvertisementInfo.mJsonVideoList, paramAdvertisementInfo);
  ...
  private void a(AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      nlc localnlc = new nlc();
      localnlc.jdField_a_of_type_Int = paramAdvertisementInfo.mAdMaterialId;
      localnlc.jdField_b_of_type_Int = 1;
      localnlc.jdField_c_of_type_Int = paramAdvertisementInfo.mAdKdPos;
      localnlc.jdField_a_of_type_Long = paramAdvertisementInfo.mAdPosID;
      osj.a().a().a(paramInt2, this.jdField_a_of_type_Pao);
      ThreadManager.executeOnSubThread(new VideoAdExposureManager.1(this, paramInt3, paramInt2, localnlc));
      return;
  ...
  private void b(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    this.jdField_a_of_type_Qls.notifyItemChanged(paramInt);
  }
  
  private void b(AdvertisementInfo paramAdvertisementInfo)
  {
    paramAdvertisementInfo = a(paramAdvertisementInfo, false);
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecyclerView != null) && (this.jdField_a_of_type_Qls != null) && ((this.e < this.jdField_a_of_type_JavaUtilList.size()) || (this.e <= 0)))
    {
      ...
      if ((localVideoInfo != null) && (!localVideoInfo.jdField_c_of_type_Boolean) && (this.e > k))
      {
        ...
        this.jdField_a_of_type_Qls.notifyItemInserted(this.e);
        this.e = 0;
      }
      if ((localVideoInfo != null) && (localVideoInfo.jdField_c_of_type_Boolean) && (localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo != null) && (this.jdField_a_of_type_Qls.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h)))
      {
        this.jdField_b_of_type_JavaUtilArrayList.remove(paramAdvertisementInfo);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == this.jdField_b_of_type_Int)
        {
          k = this.f;
          this.f = 0;
          AdvertisementInfo localAdvertisementInfo1 = osj.a().a(paramInt, k);
  ...
  public void a()
  {
    ozn localozn = osj.a().a();
    if (localozn != null)
    {
      localozn.a(this.jdField_a_of_type_Int);
      localozn.a(this.jdField_b_of_type_Int);
    }
  }
  ...
  public void a(int paramInt, qqo paramqqo, ArrayList<VideoInfo> paramArrayList)
  {
    if ((paramqqo == null) || (paramqqo.a == null) || (!this.jdField_c_of_type_Boolean)) {}
    for (;;)
    {
      return;
      if (!paramqqo.a.jdField_c_of_type_Boolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoAdExposureManager", 2, "checkAndInsert , mPlayVmCount=" + this.j);
        }
        b(paramInt, paramqqo, paramArrayList);
      }
      while (QLog.isColorLevel())
      {
  ...
  public void a(VideoInfo paramVideoInfo, int paramInt)
  {
    ...
    a(nmf.a(paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo), paramInt, this.jdField_b_of_type_Int, 6);
  }
  
  public void a(qmi paramqmi)
  {
    try
    {
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        if ((paramqmi != null) && (paramqmi.a != null) && (paramqmi.a.a != null) && (paramqmi.a.a.jdField_c_of_type_Boolean) && (paramqmi.a.a.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo != null))
        {
          d(paramqmi.jdField_b_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VideoAdExposureManager", 2, "checkAndRecord reset notCountFlag , mPlayingVideoHolder.position=" + paramqmi.jdField_b_of_type_Int);
          }
        }
      }
      return;
  ...
  public void a(boolean paramBoolean, int paramInt, ArrayList<VideoInfo> paramArrayList)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if ((!oat.f(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) || (!this.jdField_d_of_type_Boolean)) {
        break label740;
      }
    }
    label735:
  ...
  public void b(int paramInt, qqo paramqqo, ArrayList<VideoInfo> paramArrayList)
  {
    boolean bool;
    label25:
    int m;
      ...
      do
      {
        do
        {
          try
          {
            ...
            if (paramqqo != null)
            {
              bool = paramqqo.jdField_c_of_type_Boolean;
              if (!bool) {
                break label25;
              }
            }
      ...
      else
      {
        for (;;)
        {
          ...
          if (k == -1) {
            ...
            {
              paramqqo = (VideoInfo)this.jdField_b_of_type_JavaUtilArrayList.get(0);
              this.jdField_b_of_type_JavaUtilArrayList.remove(0);
            }
          }
          for (;;)
          {
            if ((paramqqo != null) || (n == -1) || (n >= paramArrayList.size())) {
              break label587;
            }
            ...
            paramqqo = (VideoInfo)paramArrayList.get(k);
          ...
          paramArrayList.add(m, paramqqo);
          if (this.jdField_a_of_type_Qls != null) {
            this.jdField_a_of_type_Qls.b(paramqqo);
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          paramqqo = (VideoInfo)paramArrayList.get(m);
          if ((paramqqo == null) || (!paramqqo.jdField_c_of_type_Boolean) || (paramqqo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo == null) || (this.jdField_a_of_type_Qls == null) || (!this.jdField_a_of_type_Qls.a(paramqqo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo.h))) {
            break;
          }
          VideoInfo localVideoInfo = (VideoInfo)this.jdField_b_of_type_AndroidUtilSparseArray.get(m);
          paramqqo = localVideoInfo;
