...
public class qks
{
  public static void a(ToServiceMsg paramToServiceMsg, int paramInt)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ...
      Long localLong = (Long)paramToServiceMsg.getAttribute(qhj.d);
    ...
    for (;;)
    {
      try
      {
        ((pqg)localObject).a("is_reddot", paramToServiceMsg);
        if (!bool1) {
          continue;
        }
        paramToServiceMsg = "1";
        ((pqg)localObject).a("hit_preload", paramToServiceMsg);
        ((pqg)localObject).a("refresh_cost", String.valueOf(l));
        ((pqg)localObject).a("refresh_num", String.valueOf(paramInt));
      }
  ...
  {
    qkq.a().a(new FeedsPreloadDataReport.1(paramString1, paramString2));
  }
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    try
    {
      for (;;)
      {
        localpqg.a("preload_reddot", str);
        localpqg.a("preload_num", String.valueOf(paramInt));
        a("0X8009C15", localpqg.a());
        return;
        str = "0";
      }
    }
  ...
  public static void a(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        localpqg.a("preload_reddot", str);
        localpqg.a("preload_num", String.valueOf(paramInt));
        localpqg.a("package_size", String.valueOf(paramLong));
        if (paramLong <= 20000L) {
          continue;
        }
        str = "1";
        localpqg.a("is_too_large", str);
      }
      catch (JSONException localJSONException)
      {
