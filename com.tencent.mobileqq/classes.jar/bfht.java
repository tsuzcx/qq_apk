...
public class bfht
{
  ...
  public static String a(int paramInt)
  {
    try
    {
      ...
      String str2 = bbdh.e();
      String str3 = bbdh.a(MobileQQ.sMobileQQ);
      String str4 = bfhs.a();
      String str5 = bfhs.b();
      ...
      localbfhw.a((byte[])localObject).a(str2).a(str3).a(str4).a(str5).a(str6).a(str7).a(str8);
      if (paramInt >= 2) {
        localbfhw.a(bfhs.c()).a(AppSetting.a()).a(bbdh.f()).a("").a("");
      }
      localObject = localbfhw.toString();
    }
  ...
  private static void b(QQAppInterface paramQQAppInterface, SafeReport.ReqBody paramReqBody)
  {
    ...
    for (;;)
    {
      mxf.a(paramQQAppInterface, new bfhu(), paramReqBody.toByteArray(), "MqqSafeDataRpt.MQDun");
      return;
    }
  }
