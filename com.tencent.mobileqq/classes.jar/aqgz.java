...
public class aqgz
{
  ...
  public static EditExtendFriendInfo.SchoolInfo a(oidb_0xdb1.SchoolInfo paramSchoolInfo)
  {
    ...
    if (paramSchoolInfo != null)
    {
      ...
      if (paramSchoolInfo.uint32_verified.has()) {
        localSchoolInfo.uint32_verified.set(paramSchoolInfo.uint32_verified.get());
      }
    }
  ...
  public static void a(Activity paramActivity, aqbe paramaqbe, String paramString, EditExtendFriendInfo.SchoolInfo paramSchoolInfo)
  {
    ...
    paramString = String.format(paramActivity.getString(2131699261), new Object[] { paramString });
    bdgm.a(paramActivity, 230).setMessage(paramString).setPositiveButton(paramActivity.getString(2131699262), new aqhe(paramaqbe, paramSchoolInfo)).setNegativeButton(paramActivity.getString(2131690654), new aqhd()).show();
  }
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    View localView = paramActivity.getLayoutInflater().inflate(2131560934, null);
    localDialogFromBottom.setContentView(localView);
    ((TextView)localView.findViewById(2131378022)).setText(new bamp(paramActivity.getResources().getString(2131699272) + "\024\022", 6, 16));
    ((ImageView)localView.findViewById(2131362823)).setOnClickListener(new aqha(localDialogFromBottom));
    localDialogFromBottom.setOnCancelListener(new aqhb());
    Button localButton = (Button)localView.findViewById(2131367266);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new aqhc(paramActivity, paramString, localDialogFromBottom));
    ((LinearLayout)localView.findViewById(2131364701)).setVisibility(8);
    ((Button)localView.findViewById(2131376171)).setVisibility(8);
    localDialogFromBottom.show();
  }
  
  public static void a(QQAppInterface paramQQAppInterface)
  {
    a(paramQQAppInterface).edit().putBoolean("has_campus_shown_dialog_before", true).commit();
    if (QLog.isColorLevel()) {
  ...
  {
    boolean bool = a(paramQQAppInterface).getBoolean("has_campus_shown_dialog_before", false);
    if (QLog.isColorLevel()) {
