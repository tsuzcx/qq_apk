...
public class aqgz
  extends aqbe
{
  public aqgz(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  {
    int i = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 164.0F);
    int j = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 265.0F);
    ...
    ((ImageView)localObject5).setImageResource(2130839314);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    int m = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F);
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      ...
      ((LinearLayout.LayoutParams)localObject5).topMargin = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 5.0F);
    ...
    parambbgu = this.jdField_a_of_type_AndroidOsBundle.getString("key_thumb_url");
    try
    {
      ...
      parambbgu = URLDrawable.getDrawable(parambbgu, (URLDrawable.URLDrawableOptions)localObject2);
      if (parambbgu.getStatus() == 2) {
        parambbgu.restartDownload();
      }
      localURLImageView.setImageDrawable(parambbgu);
    }
    catch (Exception parambbgu)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.w("Q.qqstory.troopstory.share", 2, "addStructView:", parambbgu);
        }
      }
    }
    return true;
