  ...
  extends aweq
{
  ...
  String b()
  {
    ...
    {
      localObject = new awfl();
      ((awfl)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
      ((awfl)localObject).d = this.d;
      ((awfl)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      ((awfl)localObject).f = this.f;
      localObject = baul.a((awfl)localObject, n, null);
      if (localObject == null) {
        break label129;
      }
    ...
    Object localObject = baul.a(this, n, null);
    if (localObject != null) {
      return ((URL)localObject).toString();
    }
    label129:
