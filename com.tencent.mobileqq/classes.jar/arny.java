  ...
  implements Manager
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = ajjy.a(2131636425);
    jdField_b_of_type_JavaLangString = ajjy.a(2131636424);
  }
  
  public arny(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    {
      i = ((arny)paramQQAppInterface.getManager(200)).a(paramMessageForMarketFace.time, String.valueOf(localMarkFaceMessage.dwTabID), localMarkFaceMessage.copywritingContent, localMarkFaceMessage.copywritingType);
      if (i != 0) {
        break label70;
      }
    ...
    for (;;)
    {
      try
      {
        paramMessageForMarketFace.msgData = akhp.a(localMarkFaceMessage);
        return;
      }
