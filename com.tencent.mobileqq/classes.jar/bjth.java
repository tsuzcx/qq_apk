  ...
  extends bjts
{
  ...
  public bjth()
  {
    this.jdField_a_of_type_JavaLangString = bjth.class.getSimpleName();
  }
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      paramString1 = paramJsBridgeListener.getTag(2131367858);
      if ((paramString1 != null) && ((paramString1 instanceof bjti)))
      {
        paramString1 = (bjti)paramString1;
    ...
    for (;;)
    {
      ...
      if (i == 1) {
        ...
        paramString1.setBannerHeight((int)bdkf.a((float)d));
      } else if (i == 3) {
        paramString1.setBannerHeight((int)(d * bdkf.a()));
      } else {
