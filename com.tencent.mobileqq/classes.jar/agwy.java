...
public class agwy
{
  ...
  private static ArrayList<agwz> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static int a()
  {
    ...
    {
      agwz localagwz = (agwz)jdField_a_of_type_JavaUtilArrayList.get(i);
      k = j;
      if (localagwz != null)
      {
        k = j;
        if (localagwz.jdField_c_of_type_Int == 0) {
          k = j + 1;
        }
      }
      i += 1;
  ...
  private static agwz a()
  {
    ...
    for (;;)
    {
      ...
      if (localagwz != null)
      {
        localObject = localagwz;
        if (localagwz.jdField_c_of_type_Int == 1) {
          break;
        }
      }
      i += 1;
  ...
  public static agwz a(boolean paramBoolean)
  {
    Object localObject;
    if (jdField_a_of_type_JavaUtilArrayList == null)
    {
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        localagwz = (agwz)jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localagwz != null)
        {
          localObject = localagwz;
          if (localagwz.jdField_c_of_type_Int == 0) {
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      {
        agwz localagwz = (agwz)jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localagwz == null) || (localagwz.jdField_c_of_type_Int == 1)) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, agwz paramagwz)
  {
    if ((paramQQAppInterface == null) || (jdField_a_of_type_JavaUtilArrayList == null) || (paramagwz == null) || (paramagwz.jdField_b_of_type_Int < 1) || (paramagwz.jdField_b_of_type_Int > 7) || (TextUtils.isEmpty(paramagwz.jdField_a_of_type_JavaLangString)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.qwallet.push", 2, "params error, pcPayDatas=" + jdField_a_of_type_JavaUtilArrayList + ",app=" + paramQQAppInterface + ",pcPayData=" + paramagwz);
      }
      return;
    }
    if (paramagwz.jdField_b_of_type_Int == 1) {
    ...
    for (;;)
    {
      ...
      {
        jdField_a_of_type_JavaUtilArrayList.add(paramagwz);
        if (b(paramQQAppInterface))
        {
          ...
          b(paramQQAppInterface, paramagwz);
          return;
        }
      }
      if (jdField_a_of_type_Long != 0L) {
      ...
      c(paramQQAppInterface, paramagwz);
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        ...
        if ((k == 1) && (m == 2))
        {
          bbdx.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()));
          bbdx.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()) + "_");
          i = 1;
          continue;
        }
        if ((k == 2) && (m == 1))
        ...
        if ((k == 2) && (m == 2))
        {
          bbdx.d(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getPersonalInfoFileName(paramQQAppInterface.getCurrentAccountUin()));
          i = 1;
          continue;
        }
        if ((k != 8) || (m != 1)) {
        ...
        ((agzd)paramQQAppInterface.getManager(245)).b(0);
        break label462;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ahbc.a(0, paramQQAppInterface, null);
          return;
        }
        catch (Exception paramQQAppInterface) {}
      }
  ...
  private static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      boolean bool2 = bbjc.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (!bool2)
      {
        ...
        if (localagwz == null)
        {
          ...
          localagwz = (agwz)jdField_a_of_type_JavaUtilArrayList.get(0);
          if (localagwz == null)
          {
          ...
          i = a(localagwz.jdField_b_of_type_Int);
          if (i == 0)
          {
            jdField_a_of_type_JavaUtilArrayList.remove(0);
            b(paramQQAppInterface);
        ...
        for (;;)
        {
          ...
          {
            localagwz.jdField_c_of_type_Int = 2;
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (bool1)
          {
            ...
            bool2 = bool1;
            if (43200L * 1000L + localagwz.jdField_c_of_type_Long > l) {
              bool2 = false;
            }
          }
          if (bool2) {
  ...
  private static void b(QQAppInterface paramQQAppInterface, agwz paramagwz)
  {
    String str1;
    boolean bool1;
    if (bbjc.a(paramQQAppInterface.getApp()))
    {
      ((PowerManager)paramQQAppInterface.getApp().getSystemService("power")).newWakeLock(268435462, "Q.qwallet.push").acquire(10000L);
      String str2 = String.format(BaseApplication.getContext().getString(2131717401), new Object[] { Integer.valueOf(a()) });
      if (!TextUtils.isEmpty(paramagwz.jdField_b_of_type_JavaLangString))
      {
        str1 = paramagwz.jdField_b_of_type_JavaLangString;
        ...
        localIntent.putExtra("time", bbkp.b(BaseApplication.getContext(), paramagwz.jdField_b_of_type_Long));
    ...
    else
    {
      ...
      boolean bool5 = bazy.a(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool2 = false;; bool2 = true)
    {
      ...
      if (bool1)
      {
        ...
        bbcf.a(Uri.fromFile(paramQQAppInterface), false, true);
      }
      return;
      str1 = BaseApplication.getContext().getString(2131717400);
      break;
      bool1 = true;
      break label327;
    }
    label495:
    bbcf.a(2131230759, false);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    //   23: lload 5
    //   25: iload 7
    //   27: invokestatic 267	agwy:a	(JIJI)Z
    //   30: ifeq +19 -> 49
    ...
    //   877: invokespecial 773	auka:<init>	(IILjava/lang/String;)V
    //   880: astore_0
    ...
    //   884: aload_0
    //   885: invokevirtual 783	com/tencent/mobileqq/openapi/OpenApiManager:onPayMsgRsp	(Lauka;)V
    //   888: goto -337 -> 551
    //   891: astore 12
  ...
  private static void c(QQAppInterface paramQQAppInterface, agwz paramagwz)
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.qwallet.push", 2, "startBackgroundPay");
    }
    if ((paramQQAppInterface == null) || (paramQQAppInterface.getApp() == null) || (paramagwz == null)) {}
    for (;;)
    {
      return;
      String str = String.format(BaseApplication.getContext().getString(2131717401), new Object[] { Integer.valueOf(a()) });
      Object localObject = paramagwz.jdField_b_of_type_JavaLangString;
      paramagwz = (agwz)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramagwz = BaseApplication.getContext().getString(2131717400);
      }
      ...
      try
      {
        paramQQAppInterface = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_SHOW_BADGE").setSmallIcon(2130841012).setWhen(System.currentTimeMillis()).setAutoCancel(true).setContentTitle(str).setContentText(paramagwz).setContentIntent(paramQQAppInterface).build();
        paramagwz = QQNotificationManager.getInstance();
        if (paramagwz != null)
        {
          paramagwz.cancel("Q.qwallet.push", 238);
          paramagwz.notify("Q.qwallet.push", 238, paramQQAppInterface);
          return;
        }
      }
