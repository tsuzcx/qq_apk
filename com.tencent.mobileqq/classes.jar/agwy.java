  ...
  implements agvc
{
  ...
  private bixo jdField_a_of_type_Bixo = new agxb(this);
  private BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public agwy(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramBaseChatPie.jdField_a_of_type_AndroidContentContext;
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
    this.jdField_a_of_type_Bgwl = new agwz(this);
  }
  
  private int a(int paramInt)
  {
    if (paramInt == 4) {
      return agej.a(-11.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    }
    return 0;
  }
  ...
  private void e()
  {
    ...
    anga localanga = ((angf)localObject).a();
    if (localanga == null) {}
    do
    {
      do
  ...
  public RobotPanelLayoutBase a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aihd)) {
      localTroopAIORobotLayout = ((aihd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
    }
    while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aipj)) {
      return localTroopAIORobotLayout;
    }
    return ((aipj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
  }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (localRobotPanelLayoutBase.getVisibility() != 0) {
      bgpy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8009FA1", str, "");
    }
  ...
  public void a()
  {
    ...
    {
      return;
      ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131364389);
      if ((localViewGroup != null) && (this.jdField_a_of_type_AndroidContentContext != null))
      {
        Object localObject1 = (RobotPanelLayoutBase)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131362476);
        c();
        if (localObject1 != null)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aihd)) {
            ((aihd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((TroopAIORobotLayout)localObject1);
          }
          for (;;)
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Bgwl);
            return;
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aipj)) {
              ((aipj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((RobotChatPanelLayout)localObject1);
            }
          }
        }
        if (QLog.isColorLevel()) {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aihd)) {
          localObject1 = (TroopAIORobotLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558656, localViewGroup, false);
        }
        for (;;)
        {
          label193:
          ...
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131362375);
          int i = 1;
          ...
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Bgwl);
            localObject1 = (agwy)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
            if (localObject1 == null) {
              break;
            }
            ...
            localObject1 = (RobotChatPanelLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558636, localViewGroup, false);
            break label193;
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aipj)) {
              ((aipj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((RobotChatPanelLayout)localObject1);
            }
  ...
  public void a(int paramInt, RobotPanelLayoutBase paramRobotPanelLayoutBase, RelativeLayout paramRelativeLayout)
  {
    ...
    do
    {
      ...
      {
        return;
        paramRobotPanelLayoutBase = (TextView)paramRelativeLayout.findViewById(2131371498);
    ...
    ((RelativeLayout.LayoutParams)paramRobotPanelLayoutBase).addRule(2, 2131362476);
  }
  ...
  public void a(View paramView)
  {
    ...
    ((RelativeLayout.LayoutParams)paramView).addRule(2, 2131362476);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131380590);
    ...
    if (paramBoolean)
    {
      ((RelativeLayout.LayoutParams)localObject).addRule(6, 2131362476);
      return;
    }
  ...
  public boolean a()
  {
    return ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aihd)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aipj));
  }
  ...
  public boolean a(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        paramMotionEvent = ((angf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a();
      }
    }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    else if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aipj))
    {
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      Object localObject;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aihd)) {
        localObject = ((aihd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
      }
      while (localObject != null)
      {
        ...
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aipj)) {
          localObject = ((aipj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
        } else {
          localObject = null;
        }
      }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aihd)) && (((aihd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).W))
      {
        String str1 = ((aihd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).g;
        String str2 = ((aihd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).h;
        ((TroopAIORobotLayout)localRobotPanelLayoutBase).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str1, str2, (aihd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new agxa(this, str1));
        return;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aipj))
      {
