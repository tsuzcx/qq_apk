  ...
  implements View.OnClickListener
{
  ...
  private alhd jdField_a_of_type_Alhd;
  ...
  private WeakReference<alhh> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public algy(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewGroup != paramView)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131367039));
      this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364752));
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131367827));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131367817));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131367846));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131367828));
      this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131367826));
      this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131364748));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363678));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363721));
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363722));
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363514));
      this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364761));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_d_of_type_AndroidViewViewGroup.findViewById(2131372329));
      this.e = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131372332));
  ...
  private void a(ApolloGameData paramApolloGameData)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a();
        if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_JavaLangRefWeakReference.get() == null))
        {
          localObject2 = new alhh(this);
          this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localObject2);
          ((akqu)localObject1).a((akqw)localObject2);
        }
        ((alhh)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int = ((int)(System.currentTimeMillis() / 1000L));
        if (!paramApolloGameData.isGameApp)
        {
          ((akqu)localObject1).a(paramApolloGameData.gameId, ((alhh)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          ...
          if (((SparseArray)localObject1).get(2000) != null)
          {
            ...
            ApolloGameUtil.a(this.jdField_a_of_type_Awbw, paramApolloGameData.gameId, 2000);
            if (this.jdField_a_of_type_Alhd != null) {
              this.jdField_a_of_type_Alhd.notifyDataSetChanged();
            }
          }
        }
      }
      ...
      for (int i = 1;; i = 0)
      {
        ...
        for (localObject2 = "1";; localObject2 = "0")
        {
          ...
          return;
          akqq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_AndroidContentContext, this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo, paramApolloGameData, ((alhh)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          break;
  ...
  private void b(ApolloGameData paramApolloGameData)
  {
    ...
    bdcd.a(this.jdField_b_of_type_AndroidContentContext, 230).setMessage(this.jdField_b_of_type_AndroidContentContext.getResources().getString(2131690161)).setPositiveButton(2131690143, new alhb(this, paramApolloGameData)).setNegativeButton(2131690144, new alha(this)).show();
  }
  ...
  private void c(ApolloGameData paramApolloGameData)
  {
    ...
    bdcd.a(this.jdField_b_of_type_AndroidContentContext, 230).setMessage(this.jdField_b_of_type_AndroidContentContext.getResources().getString(2131690146)).setPositiveButton(2131690144, new alhc(this)).show();
  }
  
  private void e()
  {
    QQToast.a(BaseApplicationImpl.getContext(), 1, alpo.a(2131700720), 0).a();
  }
  ...
  public View a()
  {
    ...
    do
    {
      ...
      default: 
        ...
        localObject2 = (XListView)((ViewGroup)localObject1).findViewById(2131367039);
        return localObject1;
      }
      localObject2 = (ViewGroup)LayoutInflater.from(this.jdField_b_of_type_AndroidContentContext).inflate(2131558640, null);
      localTextView = (TextView)((ViewGroup)localObject2).findViewById(2131371174);
      if (akje.a())
      {
    ...
    } while (!bdee.g(this.jdField_b_of_type_AndroidContentContext));
    localTextView.setText(alpo.a(2131700750));
    localTextView.setOnClickListener(new algz(this));
    return localObject2;
  }
  ...
  public ApolloGameData a()
  {
    ...
    localApolloGameData.name = akpd.a("aio.enter.name");
    localApolloGameData.listCoverUrl = akpd.a("aio.enter.bg");
    localApolloGameData.isSetting = true;
    localApolloGameData.toolUrl = akpd.a("aio.enter");
  ...
  public void a()
  {
    super.a();
    if (this.jdField_a_of_type_Alhd != null) {
      this.jdField_a_of_type_Alhd.a();
    }
    if ((a()) && (akje.a("apollo_aio_game_guide") == -1))
    {
      akje.a("apollo_aio_game_guide", 1);
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        alhh localalhh = (alhh)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localalhh != null)
        {
          ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().b(localalhh);
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Alhd == null) {
      this.jdField_a_of_type_Alhd = new alhd(this.jdField_b_of_type_AndroidContentContext, this);
    }
    this.jdField_a_of_type_Alhd.a(this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Alhd);
    if ((this.jdField_a_of_type_Akoa != null) && (this.jdField_a_of_type_Akoa.jdField_a_of_type_Int > 0) && (this.jdField_b_of_type_JavaUtilList.size() > 1))
    {
      paramView = this.jdField_b_of_type_JavaUtilList.iterator();
      while (paramView.hasNext()) {
        if (((ApolloGameData)paramView.next()).gameId == this.jdField_a_of_type_Akoa.jdField_a_of_type_Int)
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloGameViewBinder", 2, new Object[] { "[updatePanel] jump gameId:", Integer.valueOf(this.jdField_a_of_type_Akoa.jdField_a_of_type_Int), ",from:", Integer.valueOf(this.jdField_a_of_type_Akoa.jdField_b_of_type_Int) });
          }
          VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "avatar_clk_togame", this.jdField_b_of_type_Int, this.jdField_a_of_type_Akoa.jdField_b_of_type_Int, new String[] { String.valueOf(this.jdField_a_of_type_Akoa.jdField_a_of_type_Int) });
        }
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(List<ApolloGameData> paramList)
  {
    ...
    if ((this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1036) && (paramList != null) && (akpd.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == akpe.jdField_d_of_type_Int)) {
      paramList.add(0, a());
    }
    this.jdField_b_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_AndroidUtilSparseArray = ApolloGameUtil.a(this.jdField_a_of_type_Awbw);
    ...
    this.jdField_c_of_type_JavaUtilList = ((aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).g(6);
  }
  ...
  public boolean a(int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ??? = (aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (TextUtils.isEmpty(a())) {
        return false;
      }
      if (this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo != null) {
        this.jdField_c_of_type_JavaUtilList = ((aleh)???).a(ApolloGameUtil.a(), this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
  ...
  public void b(List<ApolloGameData> paramList)
  {
    ...
    {
      return;
      if ((paramList != null) && (akpd.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == akpe.jdField_d_of_type_Int)) {
        paramList.add(0, a());
      }
    } while ((this.jdField_b_of_type_JavaUtilList == null) || (paramList == null) || (this.jdField_a_of_type_Alhd == null));
    this.jdField_b_of_type_JavaUtilList.clear();
    this.jdField_b_of_type_JavaUtilList.addAll(paramList);
    this.jdField_a_of_type_Alhd.notifyDataSetChanged();
  }
  ...
  public void d()
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      if (akpd.a("aio.panel.rank.time") < System.currentTimeMillis() / 1000L)
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0)) {
        ...
        akpd.a("aio.panel.rank.time", (int)(System.currentTimeMillis() / 1000L) + 300);
      }
      return;
    }
  }
