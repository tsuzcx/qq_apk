  ...
  extends BaseAdapter
{
  ...
  public amiu(Context paramContext, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramView = new amiv();
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558893, null);
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetSquareImageView = ((SquareImageView)localView.findViewById(2131377811));
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131368869);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (amiv)paramView.getTag();
      localView = paramView;
