  ...
  extends rcj
{
  ...
  public bheo(@NotNull ViewGroup paramViewGroup, @NotNull String paramString1, @NotNull String paramString2, @Nullable Function1<? super Integer, Unit> paramFunction1)
  {
  ...
  {
    ImageView localImageView = (ImageView)a(2131380725);
  ...
  {
    TextView localTextView = (TextView)a(2131380392);
  ...
  public final void a(int paramInt, @NotNull String paramString)
  {
    ...
    localObject = (ImageView)a(2131372550);
    if (localObject != null) {
  ...
  public final void a(@NotNull String paramString)
  {
    ...
    TextView localTextView = (TextView)a(2131378877);
    if (localTextView != null) {
  ...
  protected View b()
  {
    View localView = LayoutInflater.from(a().getContext()).inflate(2131561629, a(), false);
  ...
  public void onClick(@Nullable View paramView)
  {
    ...
    if (Intrinsics.areEqual(paramView, a(2131380725)))
    {
