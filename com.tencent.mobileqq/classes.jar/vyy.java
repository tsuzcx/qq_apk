  ...
  implements View.OnTouchListener
{
  ...
  public static final int[] c = { 2130843835, 2130843838 };
  public static final int[] d = { 2131377155, 2131377156 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131363602, 2131363603 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2130843834, 2130843837 };
  }
  
  public vyy(vzb paramvzb, View paramView, int paramInt)
  {
  ...
  public void a(CharSequence paramCharSequence)
  {
    ...
    for (CharSequence localCharSequence = this.jdField_a_of_type_AndroidWidgetTextView.getHint();; localCharSequence = paramCharSequence)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 0)
      {
        ...
        k = vzl.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 72.5F);
      ...
      for (;;)
      {
        ...
        break;
        label201:
        k = vzl.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 84.0F);
      ...
      if ((n <= k) || (i == arrayOfFloat1.length - 1))
      {
        ...
        ved.a("Q.qqstory.widget.PollWidgetUtils", "text size = %s", Float.valueOf(arrayOfFloat1[i]));
      }
      for (;;)
      {
        paramCharSequence = vyq.a(this.jdField_a_of_type_AndroidWidgetTextView, 2);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramCharSequence);
  ...
  public void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130843782);
      return;
    }
  ...
  {
    if ((a()) || (this.jdField_a_of_type_Vyv == null) || (!this.jdField_a_of_type_Vzb.a())) {
