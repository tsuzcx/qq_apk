...
{
  public bdkb(MiniAppVideoPlayer paramMiniAppVideoPlayer) {}
  
  public boolean onError(VideoPlayerProxy paramVideoPlayerProxy, int paramInt1, int paramInt2)
  {
    bdnw.d("MiniAppVideoPlayer", "video onError: m what=" + paramInt1 + " extra=" + paramInt2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.a.jdField_a_of_type_Bdcy.a("onVideoError", paramVideoPlayerProxy.toString(), this.a.jdField_a_of_type_Int);
        bdnw.a("MiniAppVideoPlayer", "evaluateSubcribeJS onVideoError = " + paramVideoPlayerProxy.toString());
      }
