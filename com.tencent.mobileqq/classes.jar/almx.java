...
public class almx
  implements Runnable
{
  public almx(QidianProfileCardActivity paramQidianProfileCardActivity) {}
  
  public void run()
  {
    int j = 0;
    LinearLayout localLinearLayout1 = (LinearLayout)this.a.getLayoutInflater().inflate(2130970065, null);
    LinearLayout localLinearLayout2 = (LinearLayout)localLinearLayout1.findViewById(2131362841);
    int i = j;
    Object localObject1;
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (j = i;; j = i)
      {
        ...
        {
          localLinearLayout1 = (LinearLayout)this.a.getLayoutInflater().inflate(2130970064, null);
          localLinearLayout2 = (LinearLayout)localLinearLayout1.findViewById(2131362841);
        ...
        return;
        RelativeLayout localRelativeLayout = (RelativeLayout)this.a.getLayoutInflater().inflate(2130970066, null);
        URLImageView localURLImageView = (URLImageView)localRelativeLayout.findViewById(2131362719);
        TextView localTextView1 = (TextView)localRelativeLayout.findViewById(2131362754);
        ImageView localImageView = (ImageView)localRelativeLayout.findViewById(2131362720);
        TextView localTextView2 = (TextView)localRelativeLayout.findViewById(2131363579);
        localURLImageView.post(new almy(this, (GroupItem)localObject2, localURLImageView));
        ...
        i += 1;
        break;
        localRelativeLayout = (RelativeLayout)this.a.getLayoutInflater().inflate(2130970066, null);
        localURLImageView = (URLImageView)localRelativeLayout.findViewById(2131362719);
        localTextView1 = (TextView)localRelativeLayout.findViewById(2131362754);
        localImageView = (ImageView)localRelativeLayout.findViewById(2131362720);
        localTextView2 = (TextView)localRelativeLayout.findViewById(2131363579);
        localURLImageView.post(new almz(this, (PublicAccountItem)localObject2, localURLImageView));
