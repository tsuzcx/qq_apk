  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  public Object b;
  protected List<akcy> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = akcz.class.getSimpleName();
  }
  
  public akbp(Context paramContext, bkyc parambkyc, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  protected ChatHistorySearchData a(ChatHistorySearchData paramChatHistorySearchData, ArrayList<akcy> paramArrayList)
  {
      ...
      do
      {
        ...
        while (i < paramChatHistorySearchData.mSearchData1.size())
        {
          ...
          if (a(localMessageRecord)) {
            paramArrayList.add(new akcy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
          }
          i += 1;
        }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      paramMessageRecord = akcy.a(paramMessageRecord.msg).toLowerCase(Locale.US);
    } while ((!str.contains(akcy.jdField_a_of_type_JavaLangString)) && (!paramMessageRecord.contains(akcy.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public ChatHistorySearchData b(ChatHistorySearchData paramChatHistorySearchData, ArrayList<akcy> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
