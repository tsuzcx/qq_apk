  ...
  implements View.OnClickListener
{
  ...
  public usb(@NonNull uut paramuut)
  {
    super(paramuut);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new usc(this));
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      if (!this.jdField_a_of_type_Uut.a.jdField_a_of_type_Boolean) {
        break label193;
      }
      paramInt = (int)this.jdField_a_of_type_Uut.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a();
      this.e = paramInt;
      this.c = paramInt;
    }
  ...
  public void a(@NonNull vfh paramvfh)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_Uut.a.jdField_a_of_type_Boolean)
      {
        paramvfh.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_Uut.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a());
        paramvfh.a.c = this.jdField_a_of_type_Boolean;
        if (QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_Uut.jdField_b_of_type_Int == 21)
    {
      ...
      if (this.jdField_a_of_type_Uut.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_Uut.a.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131310018: 
      do
      {
        return;
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      } while (this.jdField_a_of_type_Uut.jdField_b_of_type_Int != 21);
      this.jdField_a_of_type_Uut.a(0);
      return;
    }
    a();
