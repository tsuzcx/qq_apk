  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localActionSheetItem.label = paramContext.getString(2131690081);
    localActionSheetItem.icon = 2130840385;
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    if ("S".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + amtj.a(2131715389) + amtj.a(2131715397);
    }
    if ("A".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + amtj.a(2131715383) + amtj.a(2131715373);
    }
    if ("B".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + amtj.a(2131715385) + amtj.a(2131715393);
    }
    if ("C".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + amtj.a(2131715379) + amtj.a(2131715408);
    }
    return "[QQ高能舞室]" + amtj.a(2131715398);
  }
  ...
  {
    new yby(this.jdField_a_of_type_AndroidAppActivity, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramInt1, this.jdField_a_of_type_MqqUtilWeakReference, paramInt2).execute(new Void[0]);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt2 == 2)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, amtj.a(2131715375), 1).a();
    }
    do
    {
      do
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bada = new bada(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Bada.a(a(this.jdField_a_of_type_AndroidAppActivity));
    this.jdField_a_of_type_Bada.a(this);
    this.jdField_a_of_type_Bada.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131718400));
  ...
  {
    if (this.jdField_a_of_type_Bada.a().isShowing()) {
      this.jdField_a_of_type_Bada.a().dismiss();
    }
