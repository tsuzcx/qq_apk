  ...
  implements View.OnClickListener
{
  ...
  public rdl(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  private TextView a(int paramInt)
  {
    ...
    localTextView.setId(2131376172);
    localTextView.setTextSize(2, 11.0F);
    localTextView.setGravity(17);
    localTextView.setText(anvx.a(2131703923));
    localTextView.setWidth(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 30.0F));
    localTextView.setHeight(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 17.0F));
    if (paramInt == 0)
    {
      localTextView.setTextColor(Color.argb(255, 255, 255, 255));
      localTextView.setBackgroundResource(2130849430);
      return localTextView;
    }
    localTextView.setTextColor(-89258);
    localTextView.setBackgroundResource(2130849431);
    return localTextView;
  }
  ...
  public rbp d()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560293, localRelativeLayout, true);
    this.jdField_d_of_type_AndroidViewView = localView.findViewById(2131369938);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131372922));
    this.jdField_b_of_type_AndroidViewView = localView.findViewById(2131376803);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)localView.findViewById(2131369370));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380210));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380077));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131369431));
    this.jdField_c_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.leftMargin = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    localLayoutParams.gravity = 16;
    this.jdField_c_of_type_AndroidWidgetTextView.setTextSize(2, 12.0F);
    this.jdField_c_of_type_AndroidWidgetTextView.setId(2131376165);
    ((FrameLayout)localView.findViewById(2131366888)).addView(this.jdField_c_of_type_AndroidWidgetTextView, localLayoutParams);
    this.jdField_a_of_type_ComTencentImageURLImageView.setOnClickListener(this);
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131370287));
    this.jdField_c_of_type_AndroidViewView = localView.findViewById(2131381136);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363748));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131366896));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131366895));
  ...
  public rbp o()
  {
    ...
    {
      localqfw = (qfw)this.jdField_a_of_type_JavaLangObject;
    ...
    if (localArticleInfo.mVideoCoverUrl != null)
    {
      ...
      pjr.a((KandianUrlImageView)localObject2, (URL)localObject1, this.jdField_a_of_type_AndroidContentContext, true);
      if (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = bheg.b();
      }
    ...
    for (;;)
    {
      ...
      if (localqfw.e() == 0)
      {
        ...
        ((FrameLayout.LayoutParams)localObject1).setMargins(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, 0, DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 2.0F));
        ...
        ((ViewGroup.LayoutParams)localObject1).height = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 47.0F);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject1);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundColor(this.jdField_a_of_type_AndroidWidgetLinearLayout.getResources().getColor(2131167363));
        return this;
        ...
        localObject1 = pqa.a(localArticleInfo.mFirstPagePicUrl);
        break;
    ...
    for (;;)
    {
      ...
      return this;
      label766:
      this.jdField_b_of_type_AndroidWidgetTextView.setText(six.c(localArticleInfo.mVideoPlayCount));
