  ...
  extends WebViewPlugin
{
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Nad == null)
    {
      ...
      if (localCustomWebView != null) {
        this.jdField_a_of_type_Nad = new nad(localCustomWebView, new beas(this));
      }
    }
  }
  ...
  void a(long paramLong)
  {
    ...
    } while (this.jdField_a_of_type_Ymk == null);
    try
    {
      localObject3 = beep.a((String)localObject1);
      ...
      this.jdField_a_of_type_Ymk.a(1, str, (String)localObject1, (Bundle)localObject3);
      return;
    }
    ...
    if (("UrlSaveVerifyV2".equals(paramString2)) && ("continueVisit".equals(paramString3)) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramJsBridgeListener))
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("WebSecurityPluginV2", 2, "continueVisit url=" + ndq.b(paramJsBridgeListener, new String[0]));
            }
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (!b(paramString1))
      {
        ...
        QLog.i("UrlCheckLog", 1, "now check url=" + ndq.b(paramString1, new String[0]) + ", async=" + bool2);
        ...
        j = k;
        label392:
        this.jdField_a_of_type_Ymk.a(paramString1, j, i, str2, str3, str1, paramString2, new bear(this, paramString1, bool2));
        if (QLog.isColorLevel()) {
