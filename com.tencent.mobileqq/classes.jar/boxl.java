...
public class boxl
{
  ...
  public static boyh a(RectF paramRectF1, RectF paramRectF2)
  {
    boyh localboyh = new boyh(0.0F, 0.0F, 1.0F, 0.0F);
    if (paramRectF1.equals(paramRectF2)) {
      return localboyh;
    }
    localboyh.c = Math.max(paramRectF1.width() / paramRectF2.width(), paramRectF1.height() / paramRectF2.height());
    RectF localRectF = new RectF();
    a.setScale(localboyh.c, localboyh.c, paramRectF2.centerX(), paramRectF2.centerY());
    a.mapRect(localRectF, paramRectF2);
    localboyh.a += paramRectF1.centerX() - localRectF.centerX();
    float f = localboyh.b;
    localboyh.b = (paramRectF1.centerY() - localRectF.centerY() + f);
    return localboyh;
  }
  
  public static boyh a(RectF paramRectF1, RectF paramRectF2, float paramFloat1, float paramFloat2)
  {
    boyh localboyh = new boyh(0.0F, 0.0F, 1.0F, 0.0F);
    ...
    do
    {
      ...
      if ((paramRectF2.width() < paramRectF1.width()) && (paramRectF2.height() < paramRectF1.height())) {
        localboyh.c = Math.min(paramRectF1.width() / paramRectF2.width(), paramRectF1.height() / paramRectF2.height());
      }
      localRectF = new RectF();
      a.setScale(localboyh.c, localboyh.c, paramFloat1, paramFloat2);
      a.mapRect(localRectF, paramRectF2);
      ...
      {
        paramFloat1 = localboyh.b;
        localboyh.b = (paramRectF1.centerY() - localRectF.centerY() + paramFloat1);
        return localboyh;
        if (localRectF.left > paramRectF1.left) {
          localboyh.a += paramRectF1.left - localRectF.left;
        } else if (localRectF.right < paramRectF1.right) {
          localboyh.a += paramRectF1.right - localRectF.right;
        }
      }
      if (localRectF.top > paramRectF1.top)
      {
        paramFloat1 = localboyh.b;
        localboyh.b = (paramRectF1.top - localRectF.top + paramFloat1);
        return localboyh;
      }
    } while (localRectF.bottom >= paramRectF1.bottom);
    paramFloat1 = localboyh.b;
    localboyh.b = (paramRectF1.bottom - localRectF.bottom + paramFloat1);
    return localboyh;
  }
  ...
  public static boyh b(RectF paramRectF1, RectF paramRectF2, float paramFloat1, float paramFloat2)
  {
    boyh localboyh = new boyh(0.0F, 0.0F, 1.0F, 0.0F);
    if (paramRectF2.contains(paramRectF1)) {}
    RectF localRectF;
