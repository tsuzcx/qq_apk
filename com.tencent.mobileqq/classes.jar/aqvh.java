...
public class aqvh
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131701902);
  }
  ...
  public static im_msg_body.Elem a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localC2CConfessContext.uint64_confessor_uin.set(Long.parseLong(((aqve)localObject2).jdField_c_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_to_uin.set(Long.parseLong(((aqve)localObject2).jdField_b_of_type_JavaLangString));
      localC2CConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localC2CConfessContext.bytes_confess.set(ByteStringMicro.copyFromUtf8(((aqve)localObject2).jdField_d_of_type_JavaLangString));
      localC2CConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((aqve)localObject2).jdField_e_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_time.set(((aqve)localObject2).jdField_a_of_type_Long);
      localC2CConfessContext.uint32_bg_type.set(((aqve)localObject2).jdField_b_of_type_Int);
      localC2CConfessContext.uint32_topic_id.set(((aqve)localObject2).jdField_a_of_type_Int);
      localC2CConfessContext.uint32_confessor_sex.set(((aqve)localObject2).jdField_c_of_type_Int);
      localC2CConfessContext.uint32_confess_num.set(((aqve)localObject2).jdField_d_of_type_Int);
      localC2CConfessContext.uint32_biz_type.set(((aqve)localObject2).f);
      localC2CConfessContext.uint32_confess_to_sex.set(((aqve)localObject2).jdField_e_of_type_Int);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramQQAppInterface != null) && (aquz.a(paramQQAppInterface, "redpoint_leba_show"))) {
      aquz.a(paramQQAppInterface, "redpoint_leba_show", 0L);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    paramQQAppInterface = (aqvd)paramQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER);
    ...
    {
      paramString1 = String.format("&topicId=%d&fromEncodeUin=%s&fromGender=%d&toUin=%s", new Object[] { Integer.valueOf(paramInt1), axqj.a(paramString1), Integer.valueOf(paramInt2), axqj.a(paramString2) });
  ...
  {
    if ((paramInt2 <= 0) || (acnh.a(paramInt1) != 1032)) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localConfessInfo = ((aqvd)paramQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER)).a().a(paramString, paramInt1, paramInt2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    ...
    Object localObject1 = ((aqvd)paramQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER)).b();
    int i;
    long l;
    if (localObject1 == null)
    {
      i = 24;
      Object localObject2 = String.format(aquz.jdField_d_of_type_JavaLangString, new Object[] { Integer.valueOf(i) });
      localObject1 = anvx.a(2131701900);
      i = ((String)localObject2).indexOf((String)localObject1);
      int j = ((String)localObject1).length();
      localObject1 = new avhz(paramString, paramString, (String)localObject2, paramInt1, -5020, 655369, bcrg.a());
      ((avhz)localObject1).jdField_c_of_type_JavaLangString = ((String)localObject2);
      localObject2 = new Bundle();
      ((Bundle)localObject2).putInt("key_action", 31);
      ((avhz)localObject1).a(i, j + i, (Bundle)localObject2);
      ...
      paramString.initGrayTipMsg(paramQQAppInterface, (avhz)localObject1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    avhz localavhz = new avhz(paramString1, paramString1, paramString2, paramInt1, -5040, 655377, bcrg.a());
    localavhz.jdField_c_of_type_JavaLangString = paramString2;
    String str = anvx.a(2131701897);
    int i = paramString2.indexOf(str);
    int j = str.length();
    paramString2 = new Bundle();
    paramString2.putInt("key_action", 34);
    localavhz.a(i, j + i, paramString2);
    ...
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      ...
      paramString1.initGrayTipMsg(paramQQAppInterface, localavhz);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    if (QLog.isColorLevel())
    {
      localObject = bhbx.a(paramString2);
      if (paramConfessInfo != null) {
        break label75;
      }
    }
    ...
    Object localObject = new avhz(paramString1, paramString1, paramString2, paramInt1, -5020, 655376, bcrg.a());
    ((avhz)localObject).jdField_c_of_type_JavaLangString = paramString2;
    paramString1 = paramQQAppInterface.getMessageFacade().getAIOList(paramString1, paramInt1);
    long l;
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      l = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
      paramString1 = new MessageForUniteGrayTip();
      paramString1.initGrayTipMsg(paramQQAppInterface, (avhz)localObject);
      paramString1.isread = true;
      paramString1.shmsgseq = l;
      paramString1.mNeedTimeStamp = true;
      paramString1.updateUniteGrayTipMsgData(paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((localMessageRecord.isSend()) || (acnh.a(localMessageRecord.istroop) != 1032) || (!a(localMessageRecord))) {
        break label429;
      }
      ...
      if (((MessageRecord)((List)localObject2).get(j)).getConfessTopicId() == localMessageRecord.getConfessTopicId())
      {
        ...
        if (i == 0)
        {
          ...
          {
            localObject2 = bcsa.a(paramQQAppInterface, paramQQAppInterface.getCurrentUin(), localMessageRecord.senderuin, null, localMessageRecord.istroop, (byte)0, (byte)0, (short)0, (String)localObject1);
  ...
  {
    aquz.a(paramQQAppInterface, "redpoint_box_show", 0L);
    aquz.a(paramQQAppInterface, "redpoint_clear_time", bcrg.a());
  }
  ...
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            paramList = (aqvd)paramQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER);
            if (paramList.a(paramElem, (String)localObject3, str1, i) != 1) {
              break;
            }
            localObject1 = new aqve();
            ((aqve)localObject1).jdField_a_of_type_Int = i;
            ((aqve)localObject1).jdField_b_of_type_Int = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).uint32_bg_type.get();
            ((aqve)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject3);
            ((aqve)localObject1).jdField_c_of_type_JavaLangString = str1;
            ((aqve)localObject1).jdField_d_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confess.get().toStringUtf8();
            ((aqve)localObject1).jdField_e_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confessor_nick.get().toStringUtf8();
            ((aqve)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentNickname();
            ...
            ((aqve)localObject1).jdField_c_of_type_Int = i;
            ...
            ((aqve)localObject1).jdField_a_of_type_Long = l1;
            ...
            ((aqve)localObject1).jdField_d_of_type_Int = i;
            ...
            ((aqve)localObject1).jdField_e_of_type_Int = i;
            l1 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_time.get() - 1L;
            l2 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get() - 1L;
            paramList.a(paramElem, (aqve)localObject1, l1, l2);
            if (!QLog.isColorLevel()) {
              break;
            }
            l3 = bcrg.a();
            QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem strConfessorDesc:" + ((aqve)localObject1).jdField_d_of_type_JavaLangString + " msgTime:" + l1 + " msgSeq:" + l2 + " nowTime" + l3);
            return;
    ...
    Object localObject1 = (aqvd)paramQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER);
    int k = ((aqvd)localObject1).a(paramElem, paramList, str1, str2, j);
    if ((i == 0) && (k == 1))
    {
      localObject2 = new aqvf();
      ((aqvf)localObject2).jdField_a_of_type_JavaLangString = paramElem;
      ((aqvf)localObject2).jdField_a_of_type_Int = j;
      ((aqvf)localObject2).jdField_b_of_type_Int = (j % 4);
      ((aqvf)localObject2).jdField_d_of_type_JavaLangString = paramList;
      ((aqvf)localObject2).jdField_e_of_type_JavaLangString = str2;
      ...
      label1784:
      ((aqvf)localObject2).jdField_c_of_type_Int = i;
      ...
      if (TextUtils.isEmpty(paramList)) {
        if (((aqvf)localObject2).jdField_c_of_type_Int == 1)
        {
          paramList = anvx.a(2131701898);
          label1837:
          ((aqvf)localObject2).g = paramList;
          label1843:
          ...
          label1866:
          ((aqvf)localObject2).jdField_c_of_type_JavaLangString = paramList;
          ...
          label1893:
          ((aqvf)localObject2).jdField_a_of_type_Long = l1;
    ...
    {
      ((aqvf)localObject2).jdField_d_of_type_Int = i;
      ((aqvf)localObject2).jdField_b_of_type_JavaLangString = str1;
      ...
      if ((l4 < l1 - 5L) && (l1 >= 0L))
      {
        ...
        ThreadManager.getSubThreadHandler().postDelayed(new ConfessMsgUtil.1((aqvd)localObject1, paramElem, (aqvf)localObject2, l3, l4), 250L);
        return;
        paramList = anvx.a(2131701901);
        break label1837;
        ((aqvf)localObject2).g = paramList;
        break label1843;
      }
      ((aqvd)localObject1).a(paramElem, (aqvf)localObject2, l3, l3, l4);
      if (!QLog.isColorLevel()) {
        break;
      }
      l1 = bcrg.a();
      QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem 2 strConfessorDesc:" + ((aqvf)localObject2).f + " msgTime:" + l3 + " msgSeq:" + l4 + " nowTime" + l1);
      return;
      if ((!paramMsg.msg_head.has()) || (!((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.has())) {
        break;
      }
      ((aqvd)localObject1).a(paramElem, paramList, str1, str2, j, ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get());
      return;
      i = 0;
      paramElem = "";
      break label1558;
  ...
  {
    if ((acnh.a(paramInt1) == 1032) || (acnh.a(paramInt3) == 1032)) {}
  ...
  public static im_msg_body.Elem b(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localGroupConfessContext.uint64_confessor_uin.set(Long.parseLong(((aqvf)localObject2).jdField_e_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_to_uin.set(Long.parseLong(((aqvf)localObject2).jdField_d_of_type_JavaLangString));
      localGroupConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localGroupConfessContext.bytes_topic.set(ByteStringMicro.copyFromUtf8(((aqvf)localObject2).f));
      localGroupConfessContext.bytes_confess_to_nick.set(ByteStringMicro.copyFromUtf8(((aqvf)localObject2).jdField_c_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_time.set(((aqvf)localObject2).jdField_a_of_type_Long);
      localGroupConfessContext.uint32_topic_id.set(((aqvf)localObject2).jdField_a_of_type_Int);
      localGroupConfessContext.uint32_confessor_sex.set(((aqvf)localObject2).jdField_c_of_type_Int);
      localGroupConfessContext.uint32_confess_to_nick_type.set(((aqvf)localObject2).jdField_d_of_type_Int);
      localGroupConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((aqvf)localObject2).g));
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString)
  {
    ...
    do
    {
      ...
      aqvf localaqvf = paramQQAppInterface.a();
      if (localaqvf != null)
      {
        paramMessageRecord.saveExtInfoToExtStr("ext_key_group_chat_confess_info", localaqvf.a());
        paramQQAppInterface.a(paramString, localaqvf.jdField_d_of_type_JavaLangString, localaqvf.jdField_b_of_type_JavaLangString, localaqvf.jdField_e_of_type_JavaLangString, localaqvf.jdField_a_of_type_Int);
      }
    } while (!QLog.isColorLevel());
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      return;
      localObject = (aymd)paramQQAppInterface.getManager(QQManagerFactory.LOCAL_REDTOUCH_MANAGER);
      RedTouchItem localRedTouchItem = ((aymd)localObject).a(10018);
      if ((paramBoolean) && (localRedTouchItem != null)) {
        localRedTouchItem.extMsgs = null;
      }
      ((aymd)localObject).a(10018);
      localObject = ((aqvd)paramQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER)).a();
      if ((localObject != null) && (((aqvp)localObject).jdField_a_of_type_Int > 0)) {
        break;
      }
    } while (!QLog.isDevelopLevel());
    ...
    boolean bool2;
    if (localObject != null) {
      if (((aqvp)localObject).jdField_a_of_type_Int != 0)
      {
        bool1 = true;
        ((aqvp)localObject).jdField_a_of_type_Int = 0;
        bool2 = bool1;
        if (paramBoolean)
        {
          bool2 = bool1 | ((aqvp)localObject).a();
          ((aqvp)localObject).jdField_a_of_type_JavaLangString = "";
          ((aqvp)localObject).jdField_c_of_type_JavaLangString = "";
          ((aqvp)localObject).jdField_b_of_type_JavaLangString = "";
          ((aqvp)localObject).jdField_b_of_type_Int = 0;
        }
        ThreadManager.post(new ConfessMsgUtil.2((aqvp)localObject), 8, null, false);
      }
    }
    for (;;)
    {
      if (bool2) {
        ((aqva)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.CONFESS_HANDLER)).a((aqvp)localObject);
      }
