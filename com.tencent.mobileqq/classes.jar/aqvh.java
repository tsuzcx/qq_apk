...
public class aqvh
  implements aqxq
{
  public aqvh(ListenTogetherManager paramListenTogetherManager) {}
  
  public void a(String paramString, int paramInt)
  {
    QLog.i("ListenTogether.Manager", 1, "onPlayStateChanged: " + aqxl.a(paramInt));
    ...
    for (;;)
    {
      ...
      if (!localHashMap.isEmpty()) {
        awrn.a(BaseApplication.getContext()).a("", "listen_together_player_status", true, 0L, 0L, localHashMap, "");
      }
      return;
