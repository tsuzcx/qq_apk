...
{
  public achp(AppInterface paramAppInterface)
  {
  ...
  public void a(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (arqj.a(paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramContext))
    {
      achx.a(paramGdtBaseAdItem.f);
      ...
      {
        acik.b(paramContext, paramGdtBaseAdItem);
        return;
      }
      acik.a(paramContext, paramGdtBaseAdItem);
      return;
    }
    if (!TextUtils.isEmpty(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString))
    {
      ...
      label133:
      String str;
      if ((acik.a()) && (paramGdtBaseAdItem.jdField_a_of_type_Boolean))
      {
        localObject = "1";
        if (QLog.isColorLevel()) {
          QLog.d("GdtAdHandler", 2, "doAppJump autoDownload  " + (String)localObject);
        }
        if (!acik.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString)) {
          break label576;
        }
        if (("1".equals(localObject)) && (TextUtils.isEmpty((String)acik.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("acttype")))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&acttype=42";
        }
        if (TextUtils.isEmpty((String)acik.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("wv"))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&wv=1";
        }
        str = (String)acik.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("_autodownload");
      ...
      label576:
      achx.a(paramGdtBaseAdItem.f);
      paramContext = (String)bjht.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("auto_download");
