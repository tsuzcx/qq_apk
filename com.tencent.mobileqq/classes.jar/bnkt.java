  ...
  extends bnkd
{
  ...
  {
    int k = 0;
    xvv.b("MosaicOperator", "increaseMask:x=" + paramInt1 + ",y=" + paramInt2 + ",MosaicMaskWidth:" + this.jdField_e_of_type_Int + ",MosaicMaskHeight:" + this.f);
  ...
  {
    int k = 0;
    xvv.b("MosaicOperator", "decreaseMask:x=" + paramInt1 + ",y=" + paramInt2 + ",MosaicMaskWidth:" + this.jdField_e_of_type_Int + ",MosaicMaskHeight:" + this.f);
    int[] arrayOfInt1 = new int[5];
    arrayOfInt1[0] = paramInt1;
    arrayOfInt1[1] = (paramInt1 - 1);
    arrayOfInt1[2] = paramInt1;
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      while (k < this.jdField_a_of_type_Array2dOfByte.length)
      {
        ...
        xvv.b("MosaicOperator", localStringBuilder.toString());
  ...
  public void a(Canvas paramCanvas, bnks parambnks, float paramFloat)
  {
    if (parambnks.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (parambnks.jdField_a_of_type_Int == 104)
      {
        ...
        paramCanvas.drawPath(parambnks.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (parambnks.jdField_a_of_type_Int != 105);
    if (this.jdField_a_of_type_AndroidGraphicsCanvas == null)
    {
      xvv.d("MosaicOperator", "do not init yet");
      return;
    }
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(parambnks.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsCanvas.restore();
    this.jdField_b_of_type_Boolean = true;
  }
  
  public void a(bngk parambngk, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
  ...
  public void a(bnks parambnks)
  {
    if (parambnks.jdField_a_of_type_Int == 103)
    {
      DoodleLayout.a("delete_mosaics");
      xwb.a("0X80076C2");
      List localList = parambnks.jdField_a_of_type_JavaUtilList;
      parambnks = parambnks.b;
      int k = 0;
      while ((k < localList.size()) && (k < parambnks.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)parambnks.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      xvv.a("MosaicOperator", "clearMp4MosaicCanvasAndDraw notify=%s", Boolean.valueOf(paramBoolean));
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bnks = new bnks(this.g);
      if (this.jdField_a_of_type_Bnjz != null) {
        this.jdField_a_of_type_Bnjz.a(this.jdField_a_of_type_Bnks);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Bnks.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Bnks.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Bnks.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Bnks.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Bnks.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
        this.jdField_a_of_type_Bnks.jdField_a_of_type_JavaUtilArrayList.add(new bnla(bnla.jdField_a_of_type_Int, f1, f2));
        this.jdField_a_of_type_Bnks.jdField_a_of_type_JavaUtilArrayList.add(new bnla(bnla.jdField_b_of_type_Int, f1 + 1.0F, 1.0F + f2));
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Bnks.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Bnks.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Bnks.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Bnks.b.get(this.jdField_a_of_type_Bnks.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Bnks.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Bnks.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        else
        {
          ...
          if (this.g == 104)
          {
            ...
            this.jdField_a_of_type_Bnks.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, f3, f4);
            this.jdField_a_of_type_Bnks.jdField_a_of_type_JavaUtilArrayList.add(new bnla(bnla.jdField_c_of_type_Int, this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, f3, f4));
            this.jdField_d_of_type_Float = f1;
            this.jdField_e_of_type_Float = f2;
          }
          else if (this.g == 105)
  ...
  public void b()
  {
    ...
    for (int k = 2;; k = 8)
    {
      ...
      try
      {
        ...
        xvv.a("MosaicOperator", "init matrix. scale[%f, %f]. translate[%f, %f].", Float.valueOf(f1), Float.valueOf(f1), Float.valueOf(0.0F), Float.valueOf(0.0F));
      ...
      {
        xvv.c("MosaicOperator", "initMosaicPicMode.", localOutOfMemoryError);
        return;
      }
      catch (IllegalArgumentException localIllegalArgumentException)
      {
        xvv.c("MosaicOperator", "initMosaicPicMode.", localIllegalArgumentException);
        return;
      }
      localBitmap = null;
      break label24;
  ...
  {
    xvv.b("MosaicOperator", "set MosaicSize:" + paramInt);
    this.jdField_b_of_type_Int = paramInt;
  }
  
  public void b(int paramInt1, int paramInt2)
  {
    xvv.b("MosaicOperator", "standardWidth:" + paramInt1 + ",standardHeight:" + paramInt2);
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Bngk != null)
    {
      if (this.g != 105) {
        break label50;
      }
      this.jdField_a_of_type_Bngk.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Bngk.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    {
      xvv.e("MosaicOperator", "mosaicHeightScale <= 0.");
    ...
    xvv.b("MosaicOperator", "create mosaic mask array, width:" + this.jdField_e_of_type_Int + ",height:" + this.f + ",array length:" + this.jdField_e_of_type_Int * this.f);
