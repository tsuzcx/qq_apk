...
public class pra
{
  public static void a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        TVK_PlayerVideoInfo localTVK_PlayerVideoInfo = new TVK_PlayerVideoInfo(2, obb.a(paramString), "");
  ...
  public static boolean a(String paramString)
  {
    ...
    Object localObject2 = obb.a(paramString);
    ...
    ((TVK_PlayerVideoInfo)localObject2).setConfigMap("cache_servers_type", sdi.a);
