  ...
  extends pqj
{
  ...
  private SparseArray<WeakReference<prc>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  
  public pra(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qfo paramqfo, Handler paramHandler)
  {
    super(paramAppInterface, paramEntityManager, paramExecutorService, paramqfo, paramHandler);
  }
  
  public pra(EntityManager paramEntityManager, ExecutorService paramExecutorService, qfo paramqfo, Handler paramHandler)
  {
    super(null, paramEntityManager, paramExecutorService, paramqfo, paramHandler);
  }
  ...
  private ToServiceMsg a(List<ReportInfo> paramList)
  {
    ...
    return qfq.a("OidbSvc.0x64e", 1614, 0, localReqBody.toByteArray());
  }
  ...
  private void a(int paramInt1, String paramString1, String paramString2, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      qig.a.a().a(paramInt1, paramString1, paramString2, paramInt2, paramBoolean);
      return;
    }
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localReportInfo.mFolderStatus == 0) {
          localReportInfo.mFolderStatus = ozs.d;
        }
        ...
        localReportInfo1.bytes_device_id.set(ByteStringMicro.copyFromUtf8(ozs.j()));
  ...
  private void b(oidb_cmd0x64e.ReportInfo paramReportInfo, ReportInfo paramReportInfo1)
  {
    ...
    if (localObject != null)
    {
      ...
      paramReportInfo1.uint64_feeds_id.set(((qxa)localObject).jdField_a_of_type_Long);
      paramReportInfo1.uint64_publish_uin.set(((qxa)localObject).jdField_b_of_type_Long);
      paramReportInfo1.uint32_like_total_count.set(((qxa)localObject).jdField_a_of_type_Int);
      paramReportInfo1.uint32_comment_total_count.set(((qxa)localObject).jdField_b_of_type_Int);
      ArrayList localArrayList2 = new ArrayList();
      if ((((qxa)localObject).jdField_a_of_type_JavaUtilList != null) && (!((qxa)localObject).jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        localObject = ((qxa)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext()) {
  ...
  {
    qxb localqxb = paramReportInfo1.mVideoExtraRepoerData;
    if (localqxb != null)
    {
      paramReportInfo.enum_network_type.set(b());
      paramReportInfo.operator_platform.set(3);
      if (localqxb.jdField_b_of_type_Boolean) {
        paramReportInfo.whether_click_in.set(localqxb.jdField_a_of_type_Boolean);
      }
      if (localqxb.jdField_a_of_type_Int != -1) {
        paramReportInfo.enum_jumpway_which.set(localqxb.jdField_a_of_type_Int);
      }
      if (localqxb.jdField_b_of_type_Int != -1) {
        paramReportInfo.enum_in_onetree_source.set(localqxb.jdField_b_of_type_Int);
      }
      if (localqxb.c != -1) {
        paramReportInfo.enum_in_videochannel_source.set(localqxb.c);
      }
      if (localqxb.d != -1) {
        paramReportInfo.uint32_current_video_time.set(localqxb.d);
      }
      if (localqxb.e != -1) {
        paramReportInfo.uint32_video_duration.set(localqxb.e);
      }
      if ((paramReportInfo1.mOpSource == 5) && (localqxb.f != -1)) {
        paramReportInfo.uint32_onetree_video_from_type.set(localqxb.f);
      }
    }
  }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (long l1 = paramToServiceMsg.uint64_uin.get();; l1 = 0L)
    {
      ...
      if ((paramToServiceMsg.AIOPulseMaxCnt.has()) && (paramToServiceMsg.firstScnRedPntPulseMaxCnt.has()) && (paramToServiceMsg.leftBtmRedPntPulseMaxCnt.has()))
      {
        ...
        bnrf.a(ozs.a(), l1, l2, l3);
      }
      if ((paramToServiceMsg.lastRecvMsgDuration.has()) && (paramToServiceMsg.lastSendMsgDuration.has())) {
        bnrf.a((int)paramToServiceMsg.lastRecvMsgDuration.get(), (int)paramToServiceMsg.lastSendMsgDuration.get());
      }
      if ((paramToServiceMsg.pulseTimerDuration.has()) && (paramToServiceMsg.pulseTimerDuration.get() != 12345678L)) {
        pfs.a().b((int)paramToServiceMsg.pulseTimerDuration.get());
      }
      if (paramToServiceMsg.leftBtmRedCntMaxForExitAIO.has()) {
        bnrf.e((int)paramToServiceMsg.leftBtmRedCntMaxForExitAIO.get());
      }
      if ((paramToServiceMsg.uint64_main_video_tab_red.has()) && (paramToServiceMsg.uint64_main_video_tab_red.get() > 0L)) {
        ((KandianMergeManager)ozs.a().getManager(162)).a(new KandianRedDotInfo("kandian_video_tab_reddot_info"));
      }
      if (paramToServiceMsg.uint64_scroll_interval_time.has()) {
        pgf.jdField_a_of_type_Long = paramToServiceMsg.uint64_scroll_interval_time.get();
      }
      if (paramToServiceMsg.uint64_scroll_all_time.has()) {
        pgf.jdField_b_of_type_Long = paramToServiceMsg.uint64_scroll_all_time.get();
      }
      if (paramToServiceMsg.uint64_chat_aio_time.has()) {
        pfs.c = paramToServiceMsg.uint64_chat_aio_time.get();
      }
      ...
      if (paramToServiceMsg.idle_push_wake_param.has()) {
        uby.a(paramToServiceMsg.idle_push_wake_param.get());
      }
      if (paramToServiceMsg.msg_srt_rule_list.has()) {
        ozo.a().a(paramToServiceMsg.msg_srt_rule_list.get());
      }
      if ((paramToServiceMsg.uint64_delete_kdtab_num_redpnt.has()) && (paramToServiceMsg.uint64_delete_kdtab_num_redpnt.get() == 1L))
      {
        ...
        if (paramFromServiceMsg != null) {
          ((KandianMergeManager)paramFromServiceMsg.getManager(162)).r();
        }
      }
      ...
      {
        bnrf.a("sp_msg_box_80a_enable_receive", Boolean.valueOf(bool));
  ...
  {
    int i = qfq.a(paramFromServiceMsg, paramObject, new oidb_cmd0x64e.RspBody());
    if (QLog.isColorLevel()) {
  ...
  {
    int i = qfq.a(paramFromServiceMsg, paramObject, new oidb_cmd0xde0.RspBody());
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, List<oidb_cmd0x80a.AttributeList> paramList, String paramString2, int paramInt3)
  {
    ...
    if (bdgb.b())
    {
      ...
      localReqBody.uint32_privacy_status.set(uas.b());
      if (!bnrf.i()) {
        break label223;
      }
    ...
    for (;;)
    {
      ...
      a(qfq.a(paramString2, paramInt3, 0, localReqBody.toByteArray()));
      return;
      i = 0;
      break;
      label223:
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      bhvd.a(paramString, 0, l);
      paramString[4] = 0;
      bhvd.a(paramString, 5, (short)1);
      bhvd.a(paramString, 7, jdField_a_of_type_Int);
      paramString = qfq.a("OidbSvc.0x480_9", 1152, 9, paramString);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      bhvd.a(paramString, 5, (short)1);
      bhvd.a(paramString, 7, jdField_a_of_type_Int);
      bhvd.a(paramString, 9, (short)2);
      bhvd.a(paramString, 11, (short)paramInt);
      paramString = qfq.a("OidbSvc.0x4ff_9", 1279, 9, paramString);
      paramString.extraData.putBoolean("reqFromReadinjoyHandler", true);
      a(paramString);
      return;
    }
  ...
  public void a(String paramString1, long paramLong, boolean paramBoolean, String paramString2, pre parampre, int paramInt)
  {
    a(paramString1, String.valueOf(paramLong), paramBoolean, paramString2, parampre, paramInt);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, pre parampre)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, parampre, 2);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, pre parampre, int paramInt)
  {
    a(paramString1, paramString2, paramBoolean, paramString3, parampre, paramInt, false);
  }
  
  public void a(String paramString1, String paramString2, boolean paramBoolean1, String paramString3, pre parampre, int paramInt, boolean paramBoolean2)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        ...
        Object localObject1 = qfq.a("OidbSvc.0x978", 2424, 0, ((oidb_cmd0x978.ReqBody)localObject2).toByteArray());
        paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(parampre));
  ...
  public void a(ArrayList<pow> paramArrayList, prd paramprd, int paramInt)
  {
    a(paramArrayList, true, paramprd, paramInt);
  }
  
  protected void a(ArrayList<pow> paramArrayList, boolean paramBoolean, prc paramprc, int paramInt)
  {
    int i = 2;
    if (QLog.isColorLevel()) {
      QLog.d("UserOperationModule", 2, "batch0x978, followList = " + paramArrayList + ", isFollow = " + paramBoolean + ", callback = " + paramprc + ", refer = " + paramInt);
    }
    ...
    {
      localObject = (pow)paramArrayList.get(i);
      oidb_cmd0x978.OneFollowOperationInfo localOneFollowOperationInfo = new oidb_cmd0x978.OneFollowOperationInfo();
      localOneFollowOperationInfo.uint64_dst_uin.set(Long.valueOf(((pow)localObject).jdField_a_of_type_Long).longValue());
      localOneFollowOperationInfo.uint32_op_account_type.set(((pow)localObject).jdField_a_of_type_Int);
    ...
    paramArrayList = qfq.a("OidbSvc.0x978", 2424, 0, paramArrayList.toByteArray());
    paramInt = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(paramprc));
  ...
  public void a(qrn paramqrn, Context paramContext)
  {
    ThreadManager.executeOnSubThread(new UserOperationModule.7(this, paramqrn, paramContext));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg.getAttribute("distUin") != null)
    {
      ...
      paramToServiceMsg = (prc)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
      this.jdField_a_of_type_AndroidUtilSparseArray.remove(i);
      localRspBody = new oidb_cmd0x978.RspBody();
      i = qfq.a(paramFromServiceMsg, paramObject, localRspBody);
    ...
    if (bool1)
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          paramObject.add(new pow(l, i, bool1));
          break;
        }
      }
    ...
    while (paramFromServiceMsg.hasNext())
    {
      ...
      {
        pfa.a().a(Long.valueOf((String)localObject1).longValue(), paramObject.enum_follow_status.get());
  ...
  public void b(ArrayList<pow> paramArrayList, prd paramprd, int paramInt)
  {
    a(paramArrayList, false, paramprd, paramInt);
  }
