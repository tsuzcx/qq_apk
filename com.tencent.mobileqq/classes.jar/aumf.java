...
public class aumf
  extends BaseAdapter
{
  public aumf(LangSettingFragment paramLangSettingFragment) {}
  
  private View.OnClickListener a(int paramInt)
  {
    return new aumg(this, paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == LangSettingFragment.a(this.a)) {
      localFormSimpleItem.setRightIcon(this.a.getResources().getDrawable(2130844713));
    }
    for (;;)
    {
