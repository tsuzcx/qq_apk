  ...
  implements PluginManagerHelper.OnPluginManagerLoadedListener
{
  ...
  public void b()
  {
    ...
    upe.b("QzoneVerticalVideoPluginApk", "initPluginThreshold configBean = " + localObject);
    if ((localObject == null) || (((ugf)localObject).a == null))
    {
      upe.d("QzoneVerticalVideoPluginApk", "doDownloadWeishi : configBean is null");
      return;
    }
    localObject = ((ugf)localObject).a;
    this.jdField_a_of_type_Long = (((ugi)localObject).jdField_a_of_type_Long * 1000L);
    this.d = ((ugi)localObject).jdField_a_of_type_Boolean;
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    ...
    for (;;)
    {
      ...
      if (paramPluginManagerClient != null)
      {
        ...
        try
        {
          this.jdField_a_of_type_ComTencentMobileqqPluginsdkPluginManagerClient.installPlugin("qzone_vertical_video_plugin.apk", new uou(this));
        }
