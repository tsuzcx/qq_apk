...
public final class aqgw
{
  ...
  @NotNull
  public static final List<aqgv> a(@NotNull Context paramContext, @Nullable arab paramarab)
  {
    ...
    if (paramarab != null)
    {
      Object localObject1 = ((Iterable)paramarab.a()).iterator();
      Object localObject2;
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (aqgv)((Iterator)localObject1).next();
        localList.add(localObject2);
        localSet.add(((aqgv)localObject2).e());
      }
      ...
      for (;;)
      {
        if (paramContext.hasNext())
        {
          ...
          try
          {
            bool1 = bkyz.a((Context)BaseApplication.context, (String)localObject1);
            boolean bool2 = localSet.contains(localObject1);
            boolean bool3 = paramarab.b().contains(localObject1);
            if ((bool1) && (!bool3) && (!bool2))
            {
              localObject2 = bkyz.a((Context)BaseApplication.context, (String)localObject1);
              if (localObject2 != null) {
                localList.add(new aqgv((String)localObject2, "", "", "", (String)localObject1, true));
              }
            }
            if (QLog.isColorLevel()) {
              QLog.d("[BrowserOpt] BrowserUtil", 2, new Object[] { "loadValidBrowserList: called. ", "topBrowsers: " + paramarab.a() + "  " + "packageInstalled: " + bool1 + "  inBlackList: " + bool3 + " inTopBrowserList: " + bool2 });
            }
          }
          catch (Exception localException)
          {
            for (;;)
            {
              QLog.e("[BrowserOpt] BrowserUtil", 1, new Object[] { "convertToTopBrowserList: called. ", "topBrowsers: " + paramarab.a(), localException });
              boolean bool1 = false;
            }
          }
        }
  ...
  public static final void a(@NotNull Context paramContext, @NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    auea.a(paramContext, paramString1, localBundle);
  }
}
