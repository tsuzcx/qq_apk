  ...
  extends Drawable
{
  ...
  public beuw(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof beuw))) {}
    Object localObject;
    do
    {
    ...
    return new beuw((Bitmap)localObject);
  }
  
  public static beuw a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new beuw(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f1 = 0.0F;
    switch (beux.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
    {
    case 4: 
    default: 
      this.d.set(this.c);
  ...
  public beuw a(float paramFloat)
  {
  ...
  public beuw a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public beuw a(ColorStateList paramColorStateList)
  {
  ...
  public beuw a(Shader.TileMode paramTileMode)
  {
  ...
  public beuw a(ImageView.ScaleType paramScaleType)
  {
  ...
  public beuw a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public beuw b(Shader.TileMode paramTileMode)
  {
