  ...
  implements Manager
{
  ...
  public static atzm a(QQAppInterface paramQQAppInterface)
  {
    return (atzm)paramQQAppInterface.getManager(349);
  }
  ...
  {
    return aljq.M.equals(paramString);
  }
  ...
  private Bitmap b(String paramString)
  {
    ...
    String str = bame.d(paramString);
    Object localObject = new File(str);
    long l1 = SystemClock.uptimeMillis();
    localObject = new bdvv(paramString, (File)localObject);
    ((bdvv)localObject).n = true;
    ((bdvv)localObject).b = 2;
    ((bdvv)localObject).a = str;
    ((bdvv)localObject).b(512);
    int i = bdvx.a((bdvv)localObject, null, null);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
      QLog.i("NewMsgNotificationManager", 2, "download cost " + (l2 - l1) + " result " + i + " key " + ((bdvv)localObject).a + " iconUrl: " + paramString);
    }
  ...
  {
    Intent localIntent = bddv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
  ...
  {
    this.jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new atzn(this, paramNotifyPushSettingActivity, paramFormSwitchItem);
  ...
  public void a(BaseActivity paramBaseActivity)
  {
    ...
    atzq localatzq = new atzq(this, paramBaseActivity);
    bdcd.a(paramBaseActivity, 230, null, paramBaseActivity.getString(2131693815), paramBaseActivity.getString(2131690648), paramBaseActivity.getString(2131693814), localatzq, localatzp).show();
  }
  ...
  public void a(BaseActivity paramBaseActivity, TextView paramTextView)
  {
    ...
    String str = ((Resources)localObject).getString(2131695450);
    localObject = new SpannableString(str + "允许QQ通知" + ((Resources)localObject).getString(2131695451));
    ((SpannableString)localObject).setSpan(new atzo(this, paramBaseActivity), str.length(), (str + "允许QQ通知").length(), 17);
