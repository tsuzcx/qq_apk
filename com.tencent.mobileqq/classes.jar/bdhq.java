  ...
  implements bdht
{
  ...
  private bdee jdField_a_of_type_Bdee;
  private bdef jdField_a_of_type_Bdef;
  ...
  public bdhq(bdee parambdee, bdef parambdef, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_Bdee = parambdee;
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if (i == 0)
    {
      ...
      if (this.jdField_a_of_type_Bdha != null) {
        this.jdField_a_of_type_Bdha.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilList, true);
      }
    }
    this.e = paramString1;
    ...
    {
      if (i == 0) {
        this.jdField_a_of_type_Bdhh.b();
      }
      this.jdField_a_of_type_Bdhh.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_Bdee.jdField_a_of_type_JavaLangString.length());
    }
    if (i == 0) {
      this.jdField_a_of_type_Bdhm.b(paramString2);
    }
    this.jdField_a_of_type_Bdhm.a(paramString1, paramString2);
  }
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_Bdha != null)
    {
      ...
      b(localList);
      localbdha = this.jdField_a_of_type_Bdha;
    ...
    {
      localbdha.a(str, localList, bool);
      return;
      bool = false;
      break;
  ...
  {
    Collections.sort(paramList, new bdhr(this));
  }
  ...
  public bdee a()
  {
    return this.jdField_a_of_type_Bdee;
  }
  ...
  public bdhl a()
  {
    bdhl localbdhl = new bdhl();
    localbdhl.d = this.jdField_a_of_type_Bdee.jdField_a_of_type_JavaLangString;
    localbdhl.e = this.jdField_a_of_type_Bdee.jdField_b_of_type_JavaLangString;
    localbdhl.c = this.jdField_a_of_type_Bdef.a();
    return localbdhl;
  }
  
  public bdho a()
  {
    return this.jdField_a_of_type_Bdho;
  }
  
  public Pair<Integer, Integer> a()
  {
    return this.jdField_a_of_type_Bdhm.a();
  }
  ...
  {
    if (this.jdField_a_of_type_Bdha != null) {
      this.jdField_a_of_type_Bdha.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaUtilList, false);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bdhm != null) {
      this.jdField_a_of_type_Bdhm.a(paramInt1, paramInt2, false);
    }
  }
  ...
  {
    bdee localbdee = parambdee;
    if (parambdee == null) {
      localbdee = new bdee("", "");
    }
    this.jdField_a_of_type_Bdee = localbdee;
  }
  
  public void a(bdef parambdef)
  {
    bdef localbdef = parambdef;
    if (parambdef == null) {
      localbdef = new bdef();
    }
    this.jdField_a_of_type_Bdef = localbdef;
  }
  ...
  public void a(bdha parambdha)
  {
    this.jdField_a_of_type_Bdha = parambdha;
  }
  
  public void a(bdhh parambdhh)
  {
    this.jdField_a_of_type_Bdhh = parambdhh;
  }
  ...
  public void a(bdho parambdho)
  {
    this.jdField_a_of_type_Bdho = parambdho;
    this.jdField_a_of_type_JavaLangString = parambdho.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_Long = parambdho.jdField_a_of_type_Long;
  ...
  public void a(String paramString)
  {
    ...
    b();
    this.jdField_a_of_type_Bdhm.a(paramString);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Bdhm.a(paramString, paramInt1, paramInt2);
  ...
  public void a(String paramString, long paramLong, bdhy parambdhy)
  {
    ...
    do
    {
      return;
      b();
    } while (parambdhy.jdField_a_of_type_JavaLangString.equals(this.jdField_b_of_type_JavaLangString));
    this.jdField_a_of_type_Bdhm.a(paramString, parambdhy);
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bdee = bdej.a(paramString1, this.jdField_a_of_type_Bdee, this.jdField_a_of_type_Bdef);
    if (paramBoolean) {
      this.jdField_a_of_type_Bdgy.a(this.jdField_a_of_type_Bdee.jdField_a_of_type_JavaLangString);
    }
  ...
  {
    this.jdField_a_of_type_Bdhm.a(paramBoolean);
  }
