...
{
  public bfyy(TroopGiftActionButton paramTroopGiftActionButton, TextView paramTextView) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      paramMotionEvent.setAnimationListener(new bfyz(this));
      ...
      ((GradientDrawable)localObject).setCornerRadius(bggq.a(this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftActionButton.getContext(), 56.0F));
      ...
      localObject = new RelativeLayout.LayoutParams(bggq.a(this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftActionButton.getContext(), 56.0F), bggq.a(this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftActionButton.getContext(), 56.0F));
      ...
      ((ScaleAnimation)localObject).setAnimationListener(new bfza(this, paramMotionEvent));
