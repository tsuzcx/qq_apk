...
public final class bhto
{
  ...
  public static int a()
  {
    ...
    if (!TextUtils.isEmpty(bhjr.a("ro.build.version.opporom"))) {
      return 3;
    }
    if (!TextUtils.isEmpty(bhjr.a("ro.vivo.os.version"))) {
      return 4;
    }
    return 0;
  }
  ...
  public static void a()
  {
    ...
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      avrl localavrl = (avrl)((QQAppInterface)localObject).getManager(219);
      if (localavrl != null) {
        localavrl.d();
      }
  ...
  public static void a(Activity paramActivity, AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      {
        localObject1 = bhyk.a("signatureEntrance");
        str1 = str2;
      }
    ...
    for (;;)
    {
      ...
      localObject1 = bhyk.a("signatureDIYEntrance");
  ...
  {
    int i3 = 1;
    bcuy localbcuy = (bcuy)paramQQAppInterface.getManager(12);
    int i;
    int j;
    label51:
    int k;
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {
          ((bbav)paramQQAppInterface.getManager(36)).b("100005");
        }
        return;
        i = 0;
        break;
    ...
    for (BubbleManager localBubbleManager = (BubbleManager)paramQQAppInterface.getManager(44);; localBubbleManager = null)
    {
      if ((paramXListView != null) && (localBubbleManager != null))
      {
        ...
        while (i >= 0)
        {
          ...
          {
            aggl localaggl = (aggl)agej.a((View)localObject);
            localObject = agej.a((View)localObject);
            if ((localObject != null) && (((ChatMessage)localObject).needVipBubble()) && (localaggl != null) && (localaggl.a != null) && (localaggl.a.jdField_a_of_type_Int == aqlt.a.jdField_a_of_type_Int) && (localBubbleManager.a(aogu.a(((ChatMessage)localObject).vipBubbleID)))) {
              return true;
            }
            if ((localObject != null) && (((gc)paramQQAppInterface.getManager(42)).a(localaggl, (ChatMessage)localObject))) {
              return true;
            }
          }
          else if ((localObject != null) && ((agej.a((View)localObject) instanceof ahql)))
          {
            return true;
          }
          i -= 1;
  ...
  public static byte[] a(byte[] paramArrayOfByte, tencent.im.msg.im_msg_body.GeneralFlags paramGeneralFlags, int paramInt)
  {
    ...
    //   154: invokestatic 267	bhto:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Ljava/lang/String;
    ...
    //   165: aload_0
    //   166: iload_2
    //   167: invokestatic 741	bdqf:a	([BI)[B
    //   170: ldc_w 743
    ...
    //   188: ifeq +68 -> 256
    //   191: getstatic 13	bhto:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   194: iconst_1
    ...
    //   261: aconst_null
    //   262: astore_1
    //   263: getstatic 13	bhto:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   266: iconst_1
    //   267: aload 4
    //   269: iconst_0
