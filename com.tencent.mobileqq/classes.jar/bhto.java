  ...
  extends bhsh
{
  ...
  {
    bccw localbccw = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a());
    int i = paramInt;
    if ((localbccw instanceof bcdq)) {
      i = ((bcdq)localbccw).switchRequestCode(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean, String paramString4)
  {
    ...
    String str1 = ((Activity)localObject2).getString(2131718284);
    String str3 = ((Activity)localObject2).getString(2131718285);
    paramString4 = "";
    Object localObject1 = "";
    if ("1".equals(paramString3))
    {
      paramString4 = "xxjzgw";
      str1 = ((Activity)localObject2).getString(2131718284);
    ...
    for (;;)
    {
      try
      {
        ...
        paramString3.put("pf", a(bgyi.a(), str2));
      ...
      if ("2".equals(paramString3))
      {
        ...
        str1 = ((Activity)localObject2).getString(2131717899);
