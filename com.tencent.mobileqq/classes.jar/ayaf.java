...
public class ayaf
{
  ...
  public ayaf(ayae paramayae)
  {
    this.jdField_a_of_type_JavaLangString = paramayae.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramayae.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramayae.jdField_a_of_type_Int;
    this.d = paramayae.jdField_b_of_type_Int;
    this.e = paramayae.jdField_c_of_type_Int;
    if (paramayae.jdField_b_of_type_Boolean)
    {
      this.jdField_a_of_type_Long = paramayae.d;
      this.jdField_a_of_type_ArrayOfByte = a(paramayae.jdField_c_of_type_Long);
      this.jdField_b_of_type_Long = paramayae.jdField_b_of_type_Long;
      this.jdField_b_of_type_ArrayOfByte = a(paramayae.jdField_a_of_type_Long);
      return;
    }
    this.jdField_a_of_type_Long = paramayae.jdField_b_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = a(paramayae.jdField_a_of_type_Long);
  }
