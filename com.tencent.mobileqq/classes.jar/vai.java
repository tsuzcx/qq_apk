...
public class vai
  extends unk
{
  private static final String jdField_a_of_type_JavaLangString = ume.a("StorySvc.feed_comment_list_batch_775");
  private List<String> jdField_a_of_type_JavaUtilList;
  private int c;
  
  public vai(List<String> paramList, boolean paramBoolean)
  {
  ...
  public unf a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new vaj(localRspBatchFeedComment);
    }
