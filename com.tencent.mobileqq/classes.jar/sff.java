...
public class sff
{
  ...
  public sff(BaseApplicationImpl paramBaseApplicationImpl, int paramInt)
  {
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl = paramBaseApplicationImpl;
    this.jdField_a_of_type_Int = onk.c();
  ...
  {
    return new sfg(paramURLDrawableHandler, this);
  }
  ...
  public void a(int paramInt, DownloadParams paramDownloadParams)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        switch (sgj.a((QQAppInterface)localObject2, (String)localObject1))
        {
        }
      ...
      paramDownloadParams = ayxe.a().a(this.jdField_c_of_type_JavaLangString, 1009);
      if (paramDownloadParams != null)
      {
      ...
      for (;;)
      {
        ...
        axrl.a(BaseApplication.getContext()).a(null, paramDownloadParams, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long, this.jdField_c_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "", true);
        return;
        j = 1;
        break;
        j = 2;
