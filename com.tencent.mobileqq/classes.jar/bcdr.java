  ...
  extends bcff
{
  ...
  private long jdField_b_of_type_Long = bbzc.L;
  ...
  public bcdr(QQAppInterface paramQQAppInterface, int paramInt1, DiscussionInfo paramDiscussionInfo, List<DiscussionMemberInfo> paramList, int paramInt2)
  {
  ...
  private long a(aoxz paramaoxz, String paramString1, long paramLong, String paramString2)
  {
    ...
    {
    default: 
      return bcnc.a(paramString2, paramString1, paramLong);
    case 0: 
      return bcnc.a(paramString2, paramString1, paramLong);
    }
    if (paramaoxz.isUinInRecent(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin)) {
      return bcnc.a(paramString2, paramString1, paramLong, true, false, false);
    }
    return bcnc.a(paramString2, paramString1, paramLong);
  }
  
  private long a(List<List<bcds>> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localObject = ((bcds)((List)paramList.get(i)).get(j)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
        ...
        l2 = l1;
        if (((bcds)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long > l1) {
          l2 = ((bcds)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long;
        }
        j += 1;
        l1 = l2;
      }
    ...
    for (;;)
    {
      ...
      long l3 = ((bcds)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_Long;
      l2 = l1;
      if (l3 > l1) {
        l2 = l3;
      }
      this.jdField_a_of_type_JavaUtilSet.add(((bcds)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo);
      this.jdField_b_of_type_JavaUtilList.add(((bcds)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_JavaLangString);
      i += 1;
      l1 = l2;
    }
  }
  ...
  private void a()
  {
    int i = 0;
    int n = 0;
    if ((bcnc.a(this.jdField_b_of_type_Int)) || (this.jdField_b_of_type_Int == 5))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (int m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(bcnc.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6));
          i += 1;
      ...
      this.jdField_c_of_type_JavaLangCharSequence = (i + anvx.a(2131702012));
      return;
    }
    this.jdField_a_of_type_JavaLangCharSequence = anvx.a(2131702069);
    ...
    for (;;)
    {
      ...
      if (!this.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        ...
        while (i >= 0)
        {
          ((SpannableStringBuilder)localObject).append(bcnc.a((String)this.jdField_b_of_type_JavaUtilList.get(i), (String)this.jdField_c_of_type_JavaUtilList.get(i), 6));
          if (i > 0) {
            ((SpannableStringBuilder)localObject).append("、");
          }
          i -= 1;
  ...
  static boolean a(int paramInt, List<List<bcds>> paramList, long[] paramArrayOfLong, Map<DiscussionMemberInfo, Long> paramMap1, int[] paramArrayOfInt, Map<DiscussionMemberInfo, Integer> paramMap, boolean[] paramArrayOfBoolean, Set<DiscussionMemberInfo> paramSet, Map<DiscussionMemberInfo, Long> paramMap2)
  {
    paramArrayOfBoolean[paramInt] = true;
    int i = 0;
    if (i < ((List)paramList.get(paramInt)).size())
    {
      DiscussionMemberInfo localDiscussionMemberInfo = ((bcds)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
      if (paramSet.contains(localDiscussionMemberInfo)) {}
      for (;;)
      {
        i += 1;
        break;
        long l = paramArrayOfLong[paramInt] + ((Long)paramMap1.get(localDiscussionMemberInfo)).longValue() - ((bcds)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_Long;
        if (l == 0L)
        {
  ...
  private Object[] a(DiscussionMemberInfo paramDiscussionMemberInfo, String paramString)
  {
    ...
    long l1 = a(localaoxz, paramDiscussionMemberInfo.inteRemark, bbzc.k, paramString);
    String str;
    ...
    for (;;)
    {
      long l3 = a(localaoxz, paramDiscussionMemberInfo.memberName, bbzc.l, paramString);
      l1 = l2;
      if (l3 > l2)
      {
      ...
      Friends localFriends = this.jdField_a_of_type_Anvk.b(paramDiscussionMemberInfo.memberUin);
      ...
      if (localFriends != null)
      {
        ...
        {
          l3 = a(localaoxz, localFriends.remark, bbzc.j, paramString);
          paramDiscussionMemberInfo = str;
          l2 = l1;
          if (l3 > l1)
          {
          ...
          l1 = a(localaoxz, localFriends.name, bbzc.l, paramString);
          l3 = l2;
          if (l1 > l2)
          {
      ...
      while (i < paramString.length)
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          for (;;)
          {
            ...
            {
              bcds localbcds = new bcds();
              localbcds.jdField_a_of_type_Long = l;
              localbcds.jdField_a_of_type_JavaLangString = ((String)arrayOfObject[1]);
              localbcds.jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo = ((DiscussionMemberInfo)this.jdField_a_of_type_JavaUtilList.get(j));
              localArrayList2.add(localbcds);
            }
          }
        }
  ...
  protected long a(String paramString)
  {
    ...
    {
      l1 = bcnc.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, bbzc.e);
        ...
        for (i = 1;; i = 0)
        {
          if (i == 0)
          {
            ...
            if (paramString.isUinInRecent(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin))
            {
              ...
              this.jdField_b_of_type_Long = bbzc.J;
              break label389;
            }
            this.jdField_b_of_type_Long = bbzc.L;
            break label389;
          }
          label564:
          i = 0;
  ...
  public void a(View paramView)
  {
    ...
    if (bcnc.a(this.jdField_b_of_type_Int))
    {
      ...
      alik.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, 3000, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, false);
      aode.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      bcnc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a().toString(), this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, "", 3000);
      bcnc.a(this.jdField_a_of_type_JavaLangString, 20, 3, paramView);
      bcnc.a(this.jdField_a_of_type_JavaLangString, 30, paramView, false);
      bcnc.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      new bdlf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("search_result").d("clk_grp").a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin }).a();
      return;
      label299:
