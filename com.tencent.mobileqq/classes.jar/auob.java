...
public class auob
{
  ...
  public static auoc a(int paramInt1, int paramInt2, auod paramauod, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramauod.jdField_a_of_type_Int)
        {
        default: 
          paramauod = new auoc();
          paramauod.jdField_a_of_type_Int = paramInt1;
          paramauod.b = paramInt2;
          return paramauod;
        }
      }
      break;
  ...
  public static auoc a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    ...
    if (bhmi.b(paramString))
    {
      ...
      localauoc.jdField_a_of_type_Int = localOptions.outWidth;
      localauoc.b = localOptions.outHeight;
      paramString = localauoc;
  ...
  public static auoc a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      auod localauod = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localauod, false);
      i = paramInt1;
    }
  }
  
  public static auoc a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (bhmi.b(paramFileManagerEntity.strMiddleThumPath))
    {
      ...
      localauoc.jdField_a_of_type_Int = localOptions.outWidth;
      localauoc.b = localOptions.outHeight;
      paramFileManagerEntity = localauoc;
  ...
  private static auod a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      ...
      localauod.jdField_a_of_type_Int = paramInt2;
      localauod.b = paramInt1;
      return localauod;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = blev.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = blev.a(paramFileManagerEntity.Uuid);
      }
      else if (auog.b(paramFileManagerEntity.getFilePath()))
      {
        localObject = aunj.e(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = bhml.a((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = blev.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = bhml.a(aunj.e(paramString));
      a();
      str1 = aumo.a().d() + a(5, str1);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          {
            if (!bhmi.b(str2)) {
              azru.a(paramString, str2, true, "", 1);
            }
            if ((!bhmi.b(str2)) || (bhmi.b(new File(str2), new File(str1)) != true)) {
              break;
            }
            return str1;
          }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        azru.a(paramString1, str, true, "", paramInt);
        if (bhmi.b(str)) {
          break label220;
        }
      ...
      continue;
      label220:
      if (!bhmi.b(new File(str), new File(paramString2)))
      {
        bhmi.a(str, true);
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = bhml.a(aunj.e(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = aumo.a().d() + a(5, blev.a((String)localObject2));
    if ((bhmi.b(str)) && (!auog.b(paramFileManagerEntity.strMiddleThumPath)) && (bhmi.b(new File(str), new File((String)localObject1)) == true)) {
  ...
  {
    File localFile = new File(aumo.a().d());
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  }
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, aumo.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  {
    if ((paramFileManagerEntity.status == 16) && (!aunj.e(paramFileManagerEntity))) {}
    while ((paramFileManagerEntity.cloudType == 1) && (aunj.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
