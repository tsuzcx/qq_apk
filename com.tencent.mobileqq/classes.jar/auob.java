  ...
  extends aunh
{
  ...
  public int a()
  {
    ...
    if (this.jdField_g_of_type_JavaLangString != null)
    {
      ...
      aune.b("PIC_TAG_ERROR", "PicUploadInfo.getProtocolType", "localPath == null");
    }
  ...
  public boolean a()
  {
    ...
    if (this.i)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.rawMd5)) || (!bbdj.b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoSendParams.thumbPath)))
      {
    ...
    if (!bbdj.b(this.jdField_g_of_type_JavaLangString))
    {
    ...
    Object localObject = agvp.a(this.jdField_g_of_type_JavaLangString);
    if (localObject != null)
    {
      if (this.jdField_g_of_type_Int == 1)
      {
        localObject = ((agvp)localObject).a();
        if (localObject != null) {
  ...
  String b()
  {
    ...
    {
      aune.b("PIC_TAG_ERROR", "PicUploadInfo.getUrlString", "protocol == null");
      return null;
    }
    if ("chatthumb".equals(this.jdField_e_of_type_JavaLangString)) {}
    for (;;)
    {
      URL localURL = aywk.a(this, i1, null);
      if (localURL == null) {
        break;
      }
