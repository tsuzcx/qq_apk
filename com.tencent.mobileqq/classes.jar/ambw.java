  ...
  implements azal
{
  ...
  public ambw(AppInterface paramAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    for (long l = ((MessageHandler)localObject2).a().e("last_friend_seq_47");; l = 0L)
    {
      ...
      bdqa.a((byte[])localObject2, 0, localObject1.length + 4);
      bdqa.a((byte[])localObject2, 4, (byte[])localObject1, localObject1.length);
