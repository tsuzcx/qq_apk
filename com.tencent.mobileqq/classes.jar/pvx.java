...
{
  pvx(pvu parampvu, AdvertisementInfo paramAdvertisementInfo) {}
        ...
        if (paramInt == 0)
        {
          ...
          if (paramInt == 0)
          {
            ...
            if ((paramBundle != null) && (paramBundle.length() > 0))
            {
              ...
              this.jdField_a_of_type_Pvu.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo);
            }
          }
        }
        return;
