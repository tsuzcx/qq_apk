  ...
  extends MSFServlet
{
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), ameg.class);
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (paramAppActivity.checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        if (l2 - l1 > 86400000L)
        {
          ...
          paramAppActivity.requestPermissions(new amei(paramQQAppInterface, paramNewIntent, paramAppActivity, null), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
          return;
        }
  ...
  private static void b(QQAppInterface paramQQAppInterface, NewIntent paramNewIntent)
  {
    ...
    LbsManagerService.startLocation(new ameh("qq_weather", false, paramNewIntent, paramQQAppInterface));
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, i, bool1, localBundle, amee.class);
      return;
      bool1 = false;
      continue;
