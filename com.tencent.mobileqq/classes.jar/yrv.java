  ...
  extends yty
{
  ...
  private void b(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EditPicActivity.EditPicPartManager", 2, "reset2Camera begin " + this.jdField_a_of_type_Yvj.getActivity() + " new path " + str);
    }
    PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_Yvj.a()).edit().putString("edit_pic_new_path", str).commit();
    Intent localIntent;
    if (paramInt == 101)
    {
    ...
    try
    {
      QQToast.a(localActivity, anni.a(2131702472), 0).a();
  ...
  private void w()
  {
    ...
    localzem.b = zfc.a(2);
    localzem.jdField_a_of_type_Zeq = new zeq(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
    localzem.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064 = new LpReportInfo_pf00064();
    localzem.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.actionType = 615;
    localzem.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.subactionType = 8;
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 3)
    {
      ...
      int i = 0;
      while (i < localzem.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.size())
      {
        ((StringBuilder)localObject).append((String)localzem.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.get(i) + ",");
        i += 1;
      }
      if (((StringBuilder)localObject).length() > 0) {
        ((StringBuilder)localObject).deleteCharAt(((StringBuilder)localObject).length() - 1);
      }
      localzem.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves5 = ((StringBuilder)localObject).toString();
      LpReportManager.getInstance().reportToPF00064(localzem.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064, true, false);
    }
    yqv.b("0X80076EA");
    yqp.d("EditPicActivity.EditPicPartManager", "PUBLISH start ...");
    this.jdField_a_of_type_Yvj.a(anni.a(2131702471), false, 500L);
    Stream.of(localzem).map(new zeo((yrd)a(yrd.class), null)).map(new ThreadOffFunction("EditPicActivity.EditPicPartManager", 2)).map(new zfa(yrt.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(new yrw(this, localzem));
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 1000) && (paramInt2 != -1) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      zkr.b(BaseApplication.getContext(), new File(this.jdField_a_of_type_JavaLangString));
  ...
  void a(Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    default: 
      ...
      this.jdField_a_of_type_Yvj.a(-1, null, 2130772029, 0);
    case 101: 
    case 104: 
      do
      {
    ...
    case 5: 
      ...
      paramIntent.putExtra("param_title", paramActivity.getString(2131690528));
  ...
  protected void a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    Object localObject = new ysk(this, paramEditVideoParams.b);
    this.jdField_a_of_type_Ysk = ((ysk)localObject);
    localArrayList.add(localObject);
    localObject = new ysm(this, paramEditVideoParams.b);
    ...
    {
      localObject = new yri(this);
      this.jdField_a_of_type_Yri = ((yri)localObject);
      localArrayList.add(localObject);
    }
    a(localArrayList);
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_Yvj.getActivity().getIntent();
    ...
    if ((i == 103) && (i == 103))
    {
      ...
      bcst.b(null, "dc00898", "", "", "0X80072C5", "0X80072C5", 0, 0, (String)localObject, "" + j, "", "");
      if (bool) {
        bcst.b(null, "dc00898", "", "", "0X80083B2", "0X80083B2", 0, 0, (String)localObject, "" + j, "", "");
      }
      yqv.b("0X80075E8");
    }
    for (;;)
    {
      ...
      break;
      label379:
      bcst.b(null, "dc00898", "", "", "0X80072C4", "0X80072C4", 0, 0, (String)localObject, "" + j, "", "");
    }
  }
  ...
  protected void c()
  {
    ...
    if (i != -1)
    {
      ...
      bgmo.a(this.jdField_a_of_type_Yvj.a(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
      ...
      if (i == 103)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Yvj.a(0, localIntent, 2130772029, 0);
          return;
          localObject = "1";
          break;
          label264:
