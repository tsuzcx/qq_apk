  ...
  implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener
{
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo != null)
    {
      ...
      xhe.a("edit_smart_music_play", xhe.a((HashMap)localObject));
    }
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Xhs == null);
      this.jdField_a_of_type_Xhs.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -2, -1);
      return;
    ...
    this.jdField_a_of_type_Xhs.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -1, -1);
    return;
  ...
  {
    if ((this.jdField_a_of_type_Xhs != null) && (paramInt1 != -38)) {
      this.jdField_a_of_type_Xhs.a(paramMediaPlayer, paramInt1, paramInt2);
    }
    return false;
  }
  ...
  {
    if ((paramMediaPlayer != null) && (this.jdField_a_of_type_Xhs != null) && (!paramMediaPlayer.isPlaying()))
    {
      this.c = (System.currentTimeMillis() - this.jdField_a_of_type_Long);
      this.jdField_b_of_type_Long = System.currentTimeMillis();
      this.jdField_a_of_type_Xhs.a(paramMediaPlayer, this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo);
    }
  }
}
