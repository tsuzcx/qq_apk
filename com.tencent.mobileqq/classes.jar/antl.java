  ...
  extends antk
{
  ...
  public static antk a(JSONObject paramJSONObject)
  {
    ...
    {
      antl localantl = new antl();
      localantl.jdField_b_of_type_JavaLangString = ((String)localObject);
      localObject = BaseApplicationImpl.getApplication().getApplicationContext();
      localantl.jdField_a_of_type_JavaLangString = paramJSONObject.optString("align").toUpperCase();
      if (paramJSONObject.has("rect"))
      {
        JSONArray localJSONArray = paramJSONObject.optJSONArray("rect");
        localantl.jdField_a_of_type_ArrayOfInt = new int[4];
        int i = 0;
        while (i < localJSONArray.length())
        {
          localantl.jdField_a_of_type_ArrayOfInt[i] = bcwh.a((Context)localObject, localJSONArray.optInt(i) / 2);
          i += 1;
        }
      }
      localantl.jdField_a_of_type_Boolean = paramJSONObject.optBoolean("mirror", true);
  ...
  @TargetApi(11)
  public Rect a(anty paramanty, Canvas paramCanvas)
  {
    int i1 = 0;
    paramCanvas = paramanty.getBounds();
    Resources localResources = BaseApplicationImpl.getContext().getResources();
    if (jdField_b_of_type_Int == -1) {
      jdField_b_of_type_Int = aekt.a(48.0F, localResources);
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          n = aekt.a(10.0F, localResources);
          m = aekt.a(7.0F, localResources);
  ...
  public void a(anty paramanty, Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      if ("diy_chartlet".equalsIgnoreCase(this.jdField_b_of_type_JavaLangString)) {
        localBitmap = ansd.a().b(paramanty, this);
      }
      while (localBitmap != null)
      {
        int i = paramCanvas.save();
        if ((paramanty.b) && (this.jdField_a_of_type_Boolean)) {
          paramCanvas.scale(-1.0F, 1.0F, paramanty.getBounds().centerX(), paramanty.getBounds().centerY());
        }
        Paint localPaint = new Paint();
        paramanty = a(paramanty, paramCanvas);
        if (paramCanvas.getHeight() < jdField_b_of_type_Int) {
          paramCanvas.drawBitmap(localBitmap, null, paramanty, localPaint);
        }
        for (;;)
        {
          ...
          localBitmap = ansd.a().a(paramanty, this);
          break;
          paramCanvas.drawBitmap(localBitmap, paramanty.left, paramanty.top, localPaint);
        }
        label166:
        localBitmap = null;
      }
