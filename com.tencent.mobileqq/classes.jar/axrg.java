...
public class axrg
{
  ...
  public axrg()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new axrh(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper(), this);
  }
  ...
  private void b(String paramString)
  {
    ...
    if (azds.o == 16)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaFormat.setInteger("bitrate", azds.n);
      ...
      if (!paramString.exists()) {
        bdcs.c(paramString.getAbsolutePath());
      }
