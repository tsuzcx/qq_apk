...
{
  public bcxq(AgentActivity paramAgentActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("action_login_sucess".equals(paramIntent.getAction())) {
      ...
      {
        paramContext = bdem.a(paramIntent, "login_success_uin");
        ...
        abtu.a(this.a, AgentActivity.a(this.a), PublicFragmentActivityForOpenSDK.class, OpenAuthorityFragment.class, 0);
      }
    }
    for (;;)
    {
