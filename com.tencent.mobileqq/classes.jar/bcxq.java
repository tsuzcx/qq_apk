  ...
  implements View.OnClickListener
{
  ...
  public bcxq(Context paramContext, View.OnClickListener paramOnClickListener)
  {
  ...
  private void a(AsyncImageView paramAsyncImageView, GroupPadTemplateInfo paramGroupPadTemplateInfo)
  {
    ...
    {
      Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840298);
      if (!bjnd.a(paramGroupPadTemplateInfo.mobThumbUrl)) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramGroupPadTemplateInfo != null)
          {
            ...
            paramGroupPadTemplateInfo.setDownloadListener(new bcxr(this, str));
    ...
    paramAsyncImageView.setImageResource(2130840298);
  }
  ...
  public GroupPadTemplateInfo a()
  {
    ...
    localGroupPadTemplateInfo.templateName = this.jdField_a_of_type_AndroidContentContext.getString(2131692867);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559253, null);
      paramView = new bcxs(this);
      paramView.jdField_a_of_type_Int = jdField_b_of_type_Int;
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)localView.findViewById(2131367769));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367765));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367763));
    ...
    for (;;)
    {
      ...
      return localView;
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559252, null);
      paramView = new bcxs(this);
      paramView.jdField_a_of_type_Int = jdField_a_of_type_Int;
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)localView.findViewById(2131367768));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367767));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367762));
      paramView.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupPadTemplateInfo = localGroupPadTemplateInfo;
      localView.setTag(paramView);
      localView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      break;
      ...
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setImageResource(2130840300);
      break label141;
      label316:
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setImageResource(2130840298);
