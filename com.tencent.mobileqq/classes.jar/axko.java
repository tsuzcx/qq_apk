...
public class axko
{
  ...
  private axkr jdField_a_of_type_Axkr = new axkr(null);
  private String jdField_a_of_type_JavaLangString;
  private int jdField_b_of_type_Int;
  private MediaExtractor jdField_b_of_type_AndroidMediaMediaExtractor;
  private String jdField_b_of_type_JavaLangString;
  
  public axko(String paramString1, String paramString2)
  {
  ...
  {
    int i = 0;
    this.jdField_a_of_type_Axkr.jdField_a_of_type_JavaNioByteBuffer.position(0);
    if (this.jdField_a_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Axkr.jdField_a_of_type_JavaNioByteBuffer, 0) <= 0)
    {
      a();
      i = -5;
    }
    do
    {
      return i;
      this.jdField_a_of_type_Axkr.jdField_a_of_type_JavaNioByteBuffer.position(0);
    } while (this.jdField_b_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Axkr.jdField_a_of_type_JavaNioByteBuffer, 0) > 0);
    a();
    return -6;
  }
  ...
  public static int a(String paramString1, String paramString2, int paramInt)
  {
    ...
    //   3: invokestatic 69	axkj:a	(Landroid/content/Context;)Ljava/lang/String;
    //   6: astore 5
    ...
    //   54: aconst_null
    //   55: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   58: aload_0
    //   59: iload_2
    //   60: invokestatic 104	axko:b	(Ljava/lang/String;I)I
    //   63: pop
    ...
    //   196: invokestatic 133	axkj:b	(Landroid/content/Context;)Ljava/lang/String;
    //   199: invokeinterface 113 2 0
    //   204: pop
    //   205: new 135	axkq
    //   208: dup
    //   209: aconst_null
    //   210: invokespecial 136	axkq:<init>	(Laxkp;)V
    //   213: astore_0
    ...
    //   247: astore 4
    //   249: aload 4
    //   251: putstatic 157	axko:jdField_b_of_type_JavaLangProcess	Ljava/lang/Process;
    //   254: aload_0
    //   255: aload 4
    //   257: putfield 159	axkq:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   260: aload_0
    //   261: invokevirtual 160	axkq:a	()V
    //   264: aload 4
    ...
    //   320: aconst_null
    //   321: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   324: aload_0
    //   325: invokevirtual 178	axkq:b	()V
    //   328: aload 4
    //   330: ifnull +18 -> 348
    //   333: aload 4
    //   335: invokevirtual 181	java/lang/Process:destroy	()V
    //   338: getstatic 157	axko:jdField_b_of_type_JavaLangProcess	Ljava/lang/Process;
    //   341: ifnull +7 -> 348
    //   344: aconst_null
    //   345: putstatic 157	axko:jdField_b_of_type_JavaLangProcess	Ljava/lang/Process;
    //   348: iload_2
    //   349: ireturn
    //   350: bipush 244
    //   352: ireturn
    ...
    //   354: ldc 183
    //   356: aload_0
    //   357: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   360: bipush 245
    //   362: ireturn
    //   363: astore 5
    //   365: ldc 183
    //   367: aload 5
    //   369: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   372: goto -102 -> 270
  ...
  public static boolean a()
  {
    ...
    if ((jdField_a_of_type_JavaLangProcess != null) && (!wak.a(jdField_a_of_type_JavaLangProcess)))
    {
    ...
    for (int i = 1;; i = 0)
    {
      if ((jdField_b_of_type_JavaLangProcess != null) && (!wak.a(jdField_b_of_type_JavaLangProcess)))
      {
  ...
  {
    int j = new axko(paramString1, paramString2).a(null, paramInt);
    int i;
    if ((j == -2) || (j == -4) || (j == -6)) {
  ...
  private static int c(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    //   70: aconst_null
    //   71: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   74: aload_0
    //   75: iload_3
    //   76: invokestatic 104	axko:b	(Ljava/lang/String;I)I
    //   79: pop
    ...
    //   235: invokestatic 133	axkj:b	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   265: aconst_null
    //   266: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   269: new 135	axkq
    //   272: dup
    //   273: aconst_null
    //   274: invokespecial 136	axkq:<init>	(Laxkp;)V
    //   277: astore_0
    ...
    //   307: astore_1
    //   308: aload_1
    //   309: putstatic 209	axko:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   312: aload_0
    //   313: aload_1
    //   314: putfield 159	axkq:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   317: aload_0
    //   318: invokevirtual 160	axkq:a	()V
    //   321: aload_1
    ...
    //   378: aconst_null
    //   379: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    //   414: aconst_null
    //   415: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   418: aload_0
    //   419: invokevirtual 178	axkq:b	()V
    //   422: aload_1
    //   423: ifnull +17 -> 440
    //   426: aload_1
    //   427: invokevirtual 181	java/lang/Process:destroy	()V
    //   430: getstatic 209	axko:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   433: ifnull +7 -> 440
    //   436: aconst_null
    //   437: putstatic 209	axko:jdField_a_of_type_JavaLangProcess	Ljava/lang/Process;
    //   440: iload_3
    //   441: ireturn
    //   442: bipush 244
    //   444: ireturn
    ...
    //   446: ldc 183
    //   448: aload_0
    //   449: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   452: bipush 245
    //   454: ireturn
    //   455: astore 5
    //   457: ldc 183
    //   459: aload 5
    //   461: invokestatic 101	axko:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   464: goto -138 -> 326
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Axkr.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      j = a();
      i = j;
    } while (j != 0);
    if (!a(paramString))
    ...
    try
    {
      ...
      this.jdField_a_of_type_Axkr.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack(localMediaFormat);
      this.jdField_a_of_type_Axkr.jdField_b_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack((MediaFormat)localObject);
      return j;
    }
