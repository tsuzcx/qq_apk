...
public class mxm
  extends anud
{
  public mxm(QQAppInterface paramQQAppInterface)
  {
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localmxc = (mxc)this.app.getManager(373);
      if (i != 0) {
        break;
      }
      localmxc.a().a(paramFromServiceMsg, k);
      return;
    }
    ...
    localmxc.a().a(paramFromServiceMsg, k, str);
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2, long paramLong)
  {
    ...
    try
    {
      ...
      localCmdRoomEnterReq.uin.set(nhv.a(str));
      if ((paramInt == 1) || (paramInt == 2))
      {
        localCmdRoomEnterReq.invitor_uin.set(nhv.a(paramString2));
        if (TextUtils.isEmpty(paramString2)) {
          QLog.e("AvGameRoomListHandler", 1, "INVITER UIN EMPTY FP=" + paramInt);
        }
      }
      localCmdRoomEnterReq.roomid.set(nhv.a(paramString1));
      localCmdRoomEnterReq.invitor_uin.set(nhv.a(paramString2));
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      localCmdRoomDestroyReq.uin.set(nhv.a((String)localObject));
      localCmdRoomDestroyReq.type.set(2);
      localCmdRoomDestroyReq.groupid.set(nhv.a(paramString));
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      ...
      localCmdRoomBatchForGroupReq.groupid.set(nhv.a(paramString));
      localCmdRoomBatchForGroupReq.uin.set(nhv.a((String)localObject));
