  ...
  implements arwj
{
  ...
  public Context a;
  DialogInterface.OnCancelListener jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener = new arvz(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private DBFixManager jdField_a_of_type_ComTencentMobileqqDatabaseCorruptDBFixManager;
  String jdField_a_of_type_JavaLangString;
  private String h = "";
  
  public arvy(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void c()
  {
    ...
    jdField_a_of_type_AndroidAppDialog = new arwh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this);
  ...
  private void d()
  {
    jdField_a_of_type_AndroidAppDialog = bhdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(anvx.a(2131702356)).setPositiveButton(anvx.a(2131702362), new arwd(this));
    jdField_a_of_type_AndroidAppDialog.setOnKeyListener(new arwe(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
    a(jdField_a_of_type_AndroidAppDialog, "fix succ");
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_JavaLangString, e, e, 0, 0, "", "", "", "");
  }
  
  private void e()
  {
    jdField_a_of_type_AndroidAppDialog = bhdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(anvx.a(2131702357)).setPositiveButton("重启QQ", new arwf(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
  ...
  private void f()
  {
    jdField_a_of_type_AndroidAppDialog = bhdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(anvx.a(2131702359)).setPositiveButton(anvx.a(2131702355), new arwa(this)).setNegativeButton(anvx.a(2131702361), new arwg(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Int != arwh.d)
    {
  ...
  public void b()
  {
    jdField_a_of_type_AndroidAppDialog = bhdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(anvx.a(2131702358)).setPositiveButton(anvx.a(2131702360), new arwc(this)).setNegativeButton("取消", new arwb(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
    a(jdField_a_of_type_AndroidAppDialog, "checked corrupt");
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_JavaLangString, b, b, 0, 0, "", "", "", "");
  }
}
