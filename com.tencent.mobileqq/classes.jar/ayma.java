...
public class ayma
{
  Handler jdField_a_of_type_AndroidOsHandler = new aymc(this, Looper.getMainLooper());
  aymj jdField_a_of_type_Aymj;
  aymm jdField_a_of_type_Aymm = new aymb(this);
  private WeakReference<Activity> jdField_a_of_type_JavaLangRefWeakReference;
  ArrayList<aymd> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  AppRuntime jdField_a_of_type_MqqAppAppRuntime;
  
  public ayma(AppRuntime paramAppRuntime)
  {
    this.jdField_a_of_type_MqqAppAppRuntime = paramAppRuntime;
    this.jdField_a_of_type_Aymj = ((aymj)paramAppRuntime.getManager(185));
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    {
      aymd localaymd = (aymd)localIterator.next();
      if (1 == paramInt) {
        localaymd.b(paramBundle);
      } else if (-2 == paramInt) {
        localaymd.a(paramBundle);
      }
    }
  }
  ...
  public void a(aymd paramaymd, boolean paramBoolean)
  {
    if (paramaymd != null)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaymd);
      if (paramBoolean) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramaymd);
      }
    }
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_MqqAppAppRuntime instanceof QQAppInterface)) {
      ((axmp)((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime).a(154)).b();
    }
  }
  ...
  public boolean b()
  {
    ...
    boolean bool2 = axmt.b();
    if (!bool1) {
      if (bool2)
      {
        localObject = "2920";
        axqw.b((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime, "CliOper", "", "", "Setting_tab", "Night_mode", 0, 0, "1", "", "", "");
    ...
    for (;;)
    {
      ...
      ThemeSwitcher.a((String)localObject, "202", this.jdField_a_of_type_Aymm);
      return true;
      localObject = "1103";
      break;
      if (!bool2) {
    ...
    label187:
    Bundle localBundle = ayml.a((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime);
    ...
    for (;;)
    {
      axqw.b((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime, "CliOper", "", "", "Setting_tab", "Night_mode", 0, 0, "0", "", "", "");
      break;
      localObject = "1000";
    }
  }
