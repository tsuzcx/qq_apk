...
public class ayma
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, ayjz paramayjz, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramayjz == null) || (paramayjz.b)) {
          break label519;
        }
        paramayjz.b = true;
        if ((paramInt == 1) && (paramayjz.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramayjz, paramInt);
        paramayjz = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramayjz)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramayjz.toString() + ",filePath:" + paramString2);
        paramayjz = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramayjz = (ayjz)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramayjz);
      if (QLog.isColorLevel())
      {
        if (paramayjz != null) {
          continue;
