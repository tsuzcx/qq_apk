  ...
  implements ancm
{
  ...
  public andj(andi paramandi, ancp paramancp, ando paramando, andp paramandp)
  {
    this.jdField_a_of_type_Andi = paramandi;
    this.jdField_a_of_type_Ancp = paramancp;
    this.jdField_a_of_type_Ando = paramando;
    this.jdField_a_of_type_Andp = paramandp;
  }
  
  private boolean a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Andi == null) {}
    while (this.jdField_a_of_type_Andp.a(paramInt1, paramInt2) == null) {
      return false;
    }
    return true;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject = this.jdField_a_of_type_Andp.a(100);
      if (localObject == null)
      {
        QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
        return;
      }
      ((andg)localObject).a(localStringBuilder.toString());
      this.jdField_a_of_type_Ancp.a(paramInt2);
      return;
    }
  ...
  public void a(andi paramandi, int paramInt, anda paramanda, Bundle paramBundle)
  {
    ...
    anis.a(paramandi.a());
    anis.a(paramandi.a(), 300);
    if ((this.jdField_a_of_type_Ando == null) || (!paramandi.a()))
    {
      anis.a(paramandi.a(), 300, 160, new Object[] { "glview is not ready" });
      return;
    }
    if (!a(100, -1))
    {
      QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "[initSprite], fail to load script.");
      if (paramandi.jdField_e_of_type_Int == 1) {
        ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.5(this, paramandi));
      }
      anis.a(paramandi.a(), 300, 200, new Object[] { "script no exit" });
      return;
    }
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramandi.a();
    if (paramBundle != null)
    {
      ...
      if (!TextUtils.isEmpty(paramandi.jdField_b_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramandi.jdField_b_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.d));
      }
      if (!TextUtils.isEmpty(paramandi.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramandi.jdField_a_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.jdField_e_of_type_Int));
      }
    }
    localBundle.putParcelable("IPCSpriteContext", localIPCSpriteContext);
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new andm(this, paramanda, paramInt, paramandi));
  }
  
  public void a(andi paramandi, CmShowRenderView.PlayActionConfig paramPlayActionConfig)
  {
    int i = 1;
    if ((paramandi == null) || (paramPlayActionConfig == null)) {
      return;
    }
    long l = System.currentTimeMillis();
    Object localObject1 = ancv.a(paramPlayActionConfig);
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if ((!TextUtils.isEmpty(paramandi.jdField_b_of_type_JavaLangString)) && (!paramandi.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
      {
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramandi.jdField_b_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramandi.jdField_a_of_type_JavaLangString;
      ...
      for (;;)
      {
        ...
        ((SpriteTaskParam)localObject2).jdField_a_of_type_Ancm = this;
        ...
        return;
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramandi.jdField_a_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramandi.jdField_b_of_type_JavaLangString;
        break;
        label222:
        i = 0;
      }
    ...
    Object localObject2 = paramandi.a();
    if ((!TextUtils.isEmpty(paramandi.jdField_b_of_type_JavaLangString)) && (!paramandi.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
    {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_play_action", (Bundle)localObject1, new andk(this, l, paramPlayActionConfig));
  }
  
  public void a(andi paramandi, String paramString1, String paramString2)
  {
    if (QLog.isColorLevel()) {
      QLog.d("CmShow_SpriteDrawerInfoBridge", 2, "[initSprite]");
    }
    if ((this.jdField_a_of_type_Ando == null) || (paramandi == null) || (!paramandi.a())) {
      if (paramandi != null) {
        anis.a(paramandi.a(), 300, 160, new Object[] { "glview is not ready" });
      }
    }
    ...
    } while (paramandi.jdField_e_of_type_Int != 1);
    ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.3(this, paramandi));
    return;
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramandi.a();
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new andl(this, paramandi));
  }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      ((andg)localObject).a(paramString.toString());
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 1)
        {
          ...
          localObject2 = this.jdField_a_of_type_Andp.a(100);
          if (localObject2 == null)
          {
            QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
            return;
          }
          ((andg)localObject2).a(((StringBuilder)localObject1).toString());
          ancv.a(paramString, paramInt);
          return;
        }
      }
      catch (Throwable paramString)
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("text", anck.a(bhcu.encodeToString(paramString2.getBytes("utf-8"), 0)));
        localJSONObject.put("direction", paramInt1);
        paramString1 = "";
        if (paramInt2 != 1) {
          break label408;
        }
        Object localObject = ancd.a(paramString2, 1);
        if (QLog.isColorLevel()) {
        ...
        if (TextUtils.isEmpty(paramString1))
        {
          ...
          localObject = ancd.a(paramString2, 0, 1);
        }
        ...
        if (paramInt2 == 1)
        {
          localObject = ancd.a(paramString2, 2);
          if (QLog.isColorLevel()) {
          ...
          if (localObject != null)
          {
            ...
            localObject = paramString1;
            if (TextUtils.isEmpty(paramString1)) {
              localObject = ancd.a(paramString2, 0, 2);
            }
            ...
            paramString2 = this.jdField_a_of_type_Andp.a(100);
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((andg)localObject).a(paramList.toString());
      return;
      label172:
      if (paramBoolean) {
        i = 1;
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Ando == null) || (this.jdField_a_of_type_Andi == null) || (!this.jdField_a_of_type_Andi.a())) {
      return;
    }
    Object localObject1 = this.jdField_a_of_type_Ando;
    ando.a(paramSpriteTaskParam);
    localObject1 = "";
    ...
    Object localObject3 = this.jdField_a_of_type_Andp.a(paramSpriteTaskParam.jdField_c_of_type_Int);
    Object localObject2 = localObject3;
    if (localObject3 == null)
    {
      QLog.i("CmShow_SpriteDrawerInfoBridge", 1, "playAction CmShow_ get sdk basic script");
      localObject3 = this.jdField_a_of_type_Andp.a(100);
    ...
    {
      anhm.a((QQAppInterface)localObject1, paramSpriteTaskParam, bool, paramSpriteTaskParam.jdField_b_of_type_Boolean);
      return;
    }
  }
}
