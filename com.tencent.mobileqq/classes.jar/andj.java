...
{
  public andj(QRScanEntryView paramQRScanEntryView) {}
  
  public void onClick(View paramView)
  {
    this.a.findViewById(2131368833).setAlpha(1.0F);
    ...
    for (paramView = localScanTorchActivity.a;; paramView = str)
    {
      ...
      localIntent.putExtra("title", localScanTorchActivity.getString(2131717624));
