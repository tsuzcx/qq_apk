...
public class avqw
{
  private static volatile avqw a;
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, Intent paramIntent)
  {
    ...
    {
      return;
      localChatMessage = ((avqs)paramQQAppInterface.getManager(340)).a(l);
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, String paramString1, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList1, aaok paramaaok, MessageRecord paramMessageRecord, String paramString2, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList2)
  {
    ...
    localMessageForReplyText.mSourceMsgInfo = paramaaok.a;
    localMessageForReplyText.setSourceMessageRecord(paramMessageRecord);
    localMessageForReplyText.isBarrageMsg = paramaaok.jdField_d_of_type_Boolean;
    localMessageForReplyText.barrageTimeLocation = paramaaok.b;
    localMessageForReplyText.barrageSourceMsgType = paramaaok.jdField_d_of_type_Int;
    if ((!TextUtils.isEmpty(paramString2)) && (paramArrayList2 != null) && (!paramArrayList2.isEmpty()))
    {
      ...
      localMessageForReplyText.saveExtInfoToExtStr("sens_reply_special_at_list", bafh.a(paramArrayList2));
    }
    int i = 2;
    if (!TextUtils.isEmpty(paramaaok.a.mSourceMsgTroopName)) {
      i = 0;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    new avqv(paramQQAppInterface).e(paramChatMessage);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, MessageForMixedMsg paramMessageForMixedMsg, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    if (paramMessageForMixedMsg.getReplyMessage(paramQQAppInterface) != null)
    {
      ...
      paramMessageForMixedMsg = new asue();
      ...
      new avqt(paramQQAppInterface).e(paramMessageForMixedMsg);
      return;
    }
    ((asjs)paramQQAppInterface.getManager(174)).a(paramSessionInfo, paramMessageForMixedMsg, false, paramInt);
  }
}
