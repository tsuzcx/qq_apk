  ...
  extends ajtd
{
  ...
  public muj(QQAppInterface paramQQAppInterface)
  {
  ...
  public ToServiceMsg a(long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramLong1 = apue.b();
    long l = apue.a();
    Object localObject = new axav();
    ((axav)localObject).jdField_a_of_type_Int = paramInt2;
    ((axav)localObject).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, (axav)localObject, l, axas.b(paramLong1), paramLong2);
