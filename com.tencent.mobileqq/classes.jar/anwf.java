...
public class anwf
{
  public static Dialog a(Activity paramActivity, View.OnClickListener paramOnClickListener)
  {
    ...
    Button localButton1 = (Button)paramActivity.findViewById(2131363801);
    Button localButton2 = (Button)paramActivity.findViewById(2131363812);
    localButton1.setOnClickListener(new anwg(paramActivity));
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramString.exists())
          {
            ...
            bgyo.a(paramString.getAbsolutePath(), localOptions);
            int i = localOptions.outWidth;
            if (i > 150) {
              localOptions.inSampleSize = (i / 150);
            }
            localOptions.inJustDecodeBounds = false;
            paramString = bgyo.a(paramString.getAbsolutePath(), localOptions);
            return paramString;
          }
        }
  ...
  public static QQCustomDialog a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    paramQQAppInterface = bhdj.a(paramActivity, 0, 2131559983, paramActivity.getString(2131693097), null, paramActivity.getString(2131693462), paramActivity.getString(2131692830), new anwh(paramActivity, paramQQAppInterface), new anwi(paramQQAppInterface));
    paramQQAppInterface.setOnDismissListener(new anwj(paramActivity, i));
    paramQQAppInterface.getBtnight().setTypeface(Typeface.DEFAULT_BOLD);
    paramQQAppInterface.setMessageCount(paramActivity.getString(2131693096));
    paramQQAppInterface.setPreviewImage(paramActivity.getResources().getDrawable(2130842605), true, 1);
  ...
  public static QQCustomDialog a(HotChatInfo paramHotChatInfo, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramHotChatInfo = bhdj.a(localBaseActivity, 230, localBaseActivity.getString(2131693093), localBaseActivity.getString(2131693092), 2131690697, 2131692031, paramOnClickListener, new anwk());
    ...
    paramHotChatInfo.setOnDismissListener(new anwl(localBaseActivity, i));
  ...
  public static void a(int paramInt, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    paramString5.setActionSheetTitle(paramBaseActivity.getString(2131718786));
    paramString5.setActionSheetItems(a(paramBaseActivity));
    paramString5.setItemClickListener(new anwm(paramString5, paramInt, paramQQAppInterface, paramBaseActivity, paramString1, paramString6, paramString3, paramString4, paramString7, paramString2, paramString8));
    try
    {
      paramString5.show();
      return;
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (paramBaseActivity == null) {
      paramString1 = bgyo.b(BaseApplicationImpl.getApplication().getResources(), 2130845279);
    }
  ...
  static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    ...
    for (int i = 69;; i = 65)
    {
      paramString4 = new bdnr(StructMsgForGeneralShare.class).c(i).a(paramString2).a("web", paramString4, paramString5, null, null).a(anvx.a(2131705035), null).a();
      paramString5 = bdoe.a(2);
      ...
      aupt.a(paramBaseActivity, paramString1, 3);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo)
  {
    ...
    do
    {
      ...
      {
        a(paramQQAppInterface, paramHotChatInfo, paramQQAppInterface.getApp().getString(2131693090), true);
        return;
      }
      a(paramQQAppInterface, paramHotChatInfo, paramQQAppInterface.getApp().getString(2131693095), true);
      aoxz localaoxz = paramQQAppInterface.getProxyManager().a();
      RecentUser localRecentUser = (RecentUser)localaoxz.findRecentUserByUin(paramHotChatInfo.troopUin, 1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo, String paramString, boolean paramBoolean)
  {
    ...
    aonr.a(paramQQAppInterface, paramHotChatInfo.troopUin, paramString, 1, paramBoolean, false);
  }
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    if (paramString2.startsWith("邀请加入QQ热聊：")) {
      paramString1 = paramString2 + anvx.a(2131705036);
    }
  ...
  static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (paramString2.startsWith("邀请加入QQ热聊：")) {}
    for (paramBaseActivity = paramString2 + anvx.a(2131705038);; paramBaseActivity = paramString2)
    {
