...
public abstract class bojo
{
  ...
  public bojo()
  {
    ...
    this.jdField_b_of_type_Long = ((Long)abac.a().a("SmartCutPicSpacing", Long.valueOf(500L))).longValue();
  ...
  public void a(boolean paramBoolean, int paramInt, bojn parambojn)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    this.l = paramInt;
    this.jdField_a_of_type_Bojn = parambojn;
  }
  ...
  public void c(int paramInt)
  {
    if (this.jdField_a_of_type_Boiu != null)
    {
      ...
      {
        this.jdField_a_of_type_Boiu.a(GlUtil.captureFrame(paramInt, this.e, this.f, 0));
