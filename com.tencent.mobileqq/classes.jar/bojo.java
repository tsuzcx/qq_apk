  ...
  implements boty, bplh
{
  ...
  private bopi jdField_a_of_type_Bopi = new boju(this);
  private bopj jdField_a_of_type_Bopj;
  private bopm jdField_a_of_type_Bopm = new bojt(this);
  boym jdField_a_of_type_Boym;
  private bpfb jdField_a_of_type_Bpfb = new bojs(this);
  ...
  public bojo(AppInterface paramAppInterface, View paramView, boym paramboym)
  {
    this.jdField_a_of_type_Bolh = new bojr(this);
    if (paramView == null) {
      throw new IllegalStateException("rootView is null");
    }
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Boym = paramboym;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView = ((EffectsCameraCaptureView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364093));
    this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView = ((QIMProviderContainerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372978));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131367085));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364153));
    ...
    this.jdField_b_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)paramView.findViewById(2131364143));
    this.jdField_c_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)paramView.findViewById(2131377120));
  ...
  public void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout == null)
      {
        ...
        this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131365634));
        this.jdField_a_of_type_AndroidViewViewStub.inflate();
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364145));
        ...
        bosj.a().a(0, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout);
      ...
      {
        l1 = System.currentTimeMillis();
        this.jdField_b_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131374015));
        ...
        this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer = ((ProviderViewEditContainer)this.jdField_a_of_type_AndroidViewView.findViewById(2131372980));
        ...
        ((DoodleEditView)localObject).setDoodleEditViewListener(new bojp(this));
        this.jdField_a_of_type_AndroidViewView.findViewById(2131365808).setOnTouchListener(new bojq(this));
        l2 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidViewView.getContext(), anni.a(2131708543), 0).a();
  ...
  public void a(int paramInt, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    if (paramInt != -1)
    {
      localObject = (VideoFilterViewPager)this.jdField_a_of_type_AndroidViewView.findViewById(2131366795);
      if (localObject != null) {
    ...
    if (paramQIMFilterCategoryItem != null)
    {
      ...
      while (paramQIMFilterCategoryItem.hasNext())
      {
        ...
        if (EffectsCameraCaptureView.a(bpye.a().a((String)localObject))) {
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (paramInt == 104)
    {
      paramObject = (QIMMusicConfigManager)bojv.a(2);
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, String paramString)
  {
    ...
    else
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView != null) {
        if ((bckg.a(bqgc.a)) && (paramPtvTemplateInfo != null))
        {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_Bope.b())
    {
      this.jdField_a_of_type_Bope.e();
      return true;
    }
    return false;
  }
  ...
  public void b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Bopj.a().a(true, (Activity)this.jdField_a_of_type_AndroidViewView.getContext());
    }
  ...
  {
    bpye.a().a(0);
    ((bolb)bojv.a(5)).a[0].a((Activity)this.jdField_a_of_type_AndroidViewView.getContext());
  }
  ...
  public void n()
  {
    ...
    bpye.a().a(0);
    VideoFilterViewPager localVideoFilterViewPager = (VideoFilterViewPager)this.jdField_a_of_type_AndroidViewView.findViewById(2131366795);
  ...
  public void u()
  {
    ...
    MusicProviderView localMusicProviderView = (MusicProviderView)this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView.a(MusicProviderView.class);
    DoodleLayout localDoodleLayout = bosj.a().a(0);
  ...
  public void x()
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewQIMProviderContainerView.b(this.jdField_c_of_type_Int, boke.jdField_b_of_type_Int, boke.jdField_b_of_type_JavaLangString);
