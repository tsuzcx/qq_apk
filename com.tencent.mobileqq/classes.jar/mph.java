  ...
  extends mpf
{
  ...
  private boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    //   1: astore 12
    //   3: aload_0
    //   4: getfield 113	mph:i	Ljava/lang/String;
    //   7: astore 6
    ...
    //   61: ifnull +708 -> 769
    //   64: ldc 139
    //   66: invokestatic 144	anni:a	(I)Ljava/lang/String;
    //   69: aload_2
    ...
    //   274: aload_0
    //   275: invokevirtual 206	mph:a	()Lmoy;
    //   278: astore 14
    //   280: aload_2
    //   281: astore 13
    //   283: aload 9
    ...
    //   324: astore 11
    //   326: aload 14
    //   328: getfield 211	moy:a	Lmpe;
    //   331: getfield 217	mpe:jdField_c_of_type_Boolean	Z
    //   334: ifeq +59 -> 393
    //   337: aload_2
    //   338: astore 13
    //   340: aload 9
    ...
    //   346: astore 11
    //   348: aload 14
    //   350: getfield 211	moy:a	Lmpe;
    //   353: getfield 219	mpe:a	Ljava/lang/String;
    //   356: aload_0
    //   357: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   360: getfield 225	mpv:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   363: invokestatic 228	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   366: ifeq +27 -> 393
    //   369: ldc 230
    //   371: astore 13
    //   373: aload 14
    //   375: getfield 211	moy:a	Lmpe;
    //   378: getfield 233	mpe:b	Ljava/lang/String;
    //   381: astore 11
    //   383: aload 14
    //   385: getfield 211	moy:a	Lmpe;
    //   388: getfield 234	mpe:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   391: astore 12
    //   393: aload 13
    //   395: aload 11
    //   397: aload 12
    //   399: invokestatic 236	mph:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    //   402: istore_3
    //   403: aload_0
    //   404: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   407: aload 13
    //   409: putfield 237	mpv:i	Ljava/lang/String;
    //   412: aload_0
    //   413: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   416: aload 8
    //   418: putfield 238	mpv:h	Ljava/lang/String;
    //   421: aload_0
    //   422: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   425: aload 10
    //   427: putfield 239	mpv:g	Ljava/lang/String;
    //   430: aload_0
    //   431: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   434: aload 11
    //   436: putfield 242	mpv:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   439: aload_0
    //   440: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   443: aload 12
    //   445: putfield 245	mpv:f	Ljava/lang/String;
    //   448: aload_0
    //   449: getfield 113	mph:i	Ljava/lang/String;
    //   452: iconst_1
    ...
    //   495: aload_0
    //   496: getfield 190	mph:g	Ljava/lang/String;
    ...
    //   507: aload_0
    //   508: getfield 194	mph:h	Ljava/lang/String;
    ...
    //   590: istore 4
    //   592: aload_0
    //   593: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   596: iload 4
    //   598: putfield 269	mpv:jdField_e_of_type_Int	I
    //   601: aload_0
    //   602: invokevirtual 271	mph:b	()V
    //   605: aload_0
    //   606: getfield 221	mph:jdField_a_of_type_Mpv	Lmpv;
    //   609: invokestatic 276	mpt:b	(Lmpv;)V
    //   612: iconst_1
    //   613: ireturn
    //   614: iconst_0
    //   615: istore 5
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Mpv.jdField_e_of_type_Int = 4;
    b();
  }
  
  public boolean a(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity, mpv parammpv, WeakReference<mpi> paramWeakReference)
  {
    ...
    long l = mpu.a(paramVideoAppInterface);
    if (l == 0L)
    {
      QLog.w(this.i, 1, "GetRedBag, userId为空");
      parammpv.jdField_e_of_type_Int = 2;
      return false;
    }
    ...
    try
    {
      ...
      localJSONObject2.put("listid", parammpv.jdField_c_of_type_JavaLangString);
      localJSONObject2.put("authkey", parammpv.d);
      ...
      if ((paramAVActivity != null) && (paramAVActivity.b() != -1) && (paramAVActivity.b() != 5))
      {
        ...
        QLog.w(this.i, 1, "GetRedBag, userName[" + str + "], userId[" + l + "], redPocketId[" + parammpv.jdField_c_of_type_JavaLangString + "], json[" + AudioHelper.a(localJSONObject1) + "], Activity[" + paramAVActivity + "]");
        parammpv.jdField_e_of_type_Int = 1;
        return true;
      }
    }
  ...
  void b()
  {
    ...
    {
      mpi localmpi = (mpi)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localmpi != null) {
        localmpi.a(this);
      }
      this.jdField_a_of_type_JavaLangRefWeakReference = null;
    }
    if (this.jdField_a_of_type_Mpv.jdField_e_of_type_Int == 0) {}
    for (boolean bool = true;; bool = false)
    {
      ltb.b(bool, this.jdField_a_of_type_Mpv.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Mpv.f);
      return;
    }
  }
}
