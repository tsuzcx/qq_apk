  ...
  extends mhn
{
  ...
  public mph(AppInterface paramAppInterface, Context paramContext, ArrayList<min> paramArrayList, HorizontalListView paramHorizontalListView, ZimuToolbar paramZimuToolbar)
  {
  ...
  public void a(String paramString1, long paramLong, String paramString2)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      {
        min localmin = a(i);
        if ((localmin != null) && (paramString2.equals(localmin.a))) {
          bool1 = true;
        }
      }
    }
