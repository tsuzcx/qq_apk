  ...
  extends MainBrowserModel
{
      ...
      do
      {
        do
        {
          do
          {
            ...
            new axue().a((AIOPictureData)localObject, paramInt2, paramString);
            return i;
          ...
          new axuf().a((AIOVideoData)localObject, paramInt2, paramString);
          return i;
        ...
        new axua().a((AIOFilePictureData)localObject, paramInt2, paramString);
        return i;
  ...
  public void b(RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    if (a(paramRichMediaBrowserInfo))
    {
      ...
      ((AIOVideoData)paramRichMediaBrowserInfo.baseData).f = true;
    }
    label32:
    while (paramRichMediaBrowserInfo.baseData.getType() != 103) {
      return;
    }
    ((AIOFileVideoData)paramRichMediaBrowserInfo.baseData).l = true;
  }
  ...
  public void c(RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    ((AIOFileVideoData)paramRichMediaBrowserInfo.baseData).m = true;
  }
