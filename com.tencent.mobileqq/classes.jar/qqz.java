...
public class qqz
  extends qrr
{
  public qqz(ArticleInfo paramArticleInfo, Context paramContext)
  {
  ...
  private void a(ButtonBase paramButtonBase)
  {
    ...
    for (int j = 1;; j = 0)
    {
      ...
      if ((!pqa.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID))) {
        break label141;
      }
  ...
  private void b(ViewBase paramViewBase)
  {
    ...
    } while (!(paramViewBase instanceof qtv));
    ((qtv)paramViewBase).onClick();
  }
  ...
  {
    String str2 = pqf.a(paramArticleInfo);
    ...
    if (bool)
    {
      ...
      if (!ppe.o(paramArticleInfo)) {
        olh.a(null, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Long), (String)localObject, (String)localObject, 0, 0, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Long), "0", "" + paramArticleInfo.mStrategyId, str2, false);
      }
    ...
    do
    {
      ...
      str1 = "0X8007B66";
      break label35;
      if (pqa.a(paramArticleInfo))
      {
        localObject = new JSONObject();
        try
        {
          ((JSONObject)localObject).put("like", 0);
          pih.a(this.jdField_a_of_type_AndroidContentContext, paramArticleInfo, "0X8009A74", (JSONObject)localObject);
          return;
        }
      ...
      olh.a(null, paramArticleInfo.mSubscribeID, (String)localObject, (String)localObject, 0, 0, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Long), String.valueOf(paramArticleInfo.mArticleID), "" + paramArticleInfo.mStrategyId, str2, false);
      return;
      if ((!ppe.i(paramArticleInfo)) && (!ppe.g(paramArticleInfo)) && (!ppe.j(paramArticleInfo)) && (!ppe.k(paramArticleInfo))) {
        break label383;
      }
      if (!ppe.o(paramArticleInfo)) {
        olh.a(null, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Long), localJSONException1, localJSONException1, 0, 0, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Long), "0", "" + paramArticleInfo.mStrategyId, str2, false);
      }
    } while ((pqw.l(paramArticleInfo)) || (pqw.m(paramArticleInfo)));
    label268:
    pqb.b(paramArticleInfo, (int)paramArticleInfo.mChannelID);
    return;
    label383:
    ...
    olh.a(null, paramArticleInfo.mSubscribeID, localJSONException2, localJSONException2, 0, 0, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Long), String.valueOf(paramArticleInfo.mArticleID), "" + paramArticleInfo.mStrategyId, str2, false);
  }
