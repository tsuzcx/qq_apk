...
public class qqz
  extends ajxl
{
  private qqz(VideoFeedsRecommendFragment paramVideoFeedsRecommendFragment) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        for (localObject1 = bbcl.b((QQAppInterface)localObject1, paramString, false);; localObject1 = null)
        {
