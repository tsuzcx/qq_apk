...
class axjt
  extends niu
{
  axjt(axjs paramaxjs, axjq paramaxjq) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      if (paramArrayOfByte.lists.has())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (!axjs.a(this.jdField_a_of_type_Axjs).contains(Long.valueOf(localComment.comment_id.get()))) {
            axjs.a(this.jdField_a_of_type_Axjs).add(Long.valueOf(localComment.comment_id.get()));
          }
      ...
      this.jdField_a_of_type_Axjq.a(paramBundle);
      return;
    }
