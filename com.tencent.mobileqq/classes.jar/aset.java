  ...
  implements Manager
{
  ...
  public aset(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean a(aukp paramaukp, auko paramauko)
  {
    boolean bool = false;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          List localList = localaukp.a(ShieldListInfo.class);
          int i;
          if (localList == null)
          {
            i = 0;
  ...
  {
    akgg localakgg = (akgg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(18);
    ...
    localakgg.a(paramInt1, arrayOfLong, paramInt2);
  }
  ...
  public boolean a(List<ShieldListInfo> paramList)
  {
    ...
    for (;;)
    {
        ...
        try
        {
          ...
          if ((localShieldListInfo2 != null) && ((localShieldListInfo2.getStatus() == 1001) || (localShieldListInfo2.getStatus() == 1002))) {
            if (localShieldListInfo1.flags != localShieldListInfo2.flags)
            {
              ...
              a(localaukp, localShieldListInfo2);
            }
          }
        }
      ...
      a(localaukp, localShieldListInfo1);
  ...
  public void b(int paramInt1, List<Long> paramList, int paramInt2)
  {
    ...
    localakgg.b(paramInt1, arrayOfLong, paramInt2);
  }
