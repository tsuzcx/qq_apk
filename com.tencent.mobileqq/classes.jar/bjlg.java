...
public class bjlg
  extends bjkz<Bundle, Void, HashMap<String, Object>>
{
  protected Handler a;
  public bjlh a;
  private boolean a;
  
  public bjlg(String paramString1, String paramString2, bjlh parambjlh)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bjlh = parambjlh;
  }
  
  public bjlg(String paramString1, String paramString2, bjlh parambjlh, boolean paramBoolean)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bjlh = parambjlh;
  ...
  public bjlc a(String paramString1, String paramString2, Bundle paramBundle)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bjlh = null;
  }
  ...
  public HashMap<String, Object> b(Bundle... paramVarArgs)
  {
    ...
    try
    {
      ...
      j = bjlt.a(bizw.a().a(), (String)localObject).a("Common_HttpRetryCount");
      bjko.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            config_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
      if (j == 0)
      {
        j = 3;
        bjko.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            result_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            localbjlc = a(this.jdField_a_of_type_JavaLangString, this.b, paramVarArgs[0]);
            l2 = l1;
            l4 = l1;
            str1 = localbjlc.jdField_a_of_type_JavaLangString;
            l2 = l1;
            l4 = l1;
            ...
            l2 = l1;
            l4 = l1;
            ((JSONObject)localObject).put("content", localbjlc.jdField_a_of_type_JavaIoInputStream);
          }
          catch (ConnectTimeoutException localConnectTimeoutException)
          {
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject1.put("httpdatamodified", localbjlc.jdField_a_of_type_Int);
            continue;
          }
          ...
          catch (HttpBaseUtil.HttpStatusException paramVarArgs)
          {
            ...
            try
            {
              ...
              bjmb.a().a(str2, l3, l2, 0L, i, bizw.a().a(), "1000002", null, this.jdField_a_of_type_Boolean);
              return localHashMap;
            }
          ...
          catch (Exception paramVarArgs)
          {
            ...
            {
              i = Integer.parseInt(paramVarArgs.getMessage().replace("http status code error:", ""));
              bjmb.a().a(str2, l3, l4, 0L, i, bizw.a().a(), "1000002", null, this.jdField_a_of_type_Boolean);
              return localHashMap;
            }
            catch (Exception paramVarArgs)
            {
          ...
          l2 = l1;
          l4 = l1;
          bjko.a("HttpCgiAsyncTask", "response.isModified= " + localbjlc.jdField_a_of_type_Int);
          l2 = l1;
          l4 = l1;
          if (localbjlc.jdField_a_of_type_Int == 0)
          {
            if (!bool) {
              continue;
            }
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject2.put("httpdatamodified", localbjlc.jdField_a_of_type_Int);
            l2 = l1;
            l4 = l1;
          ...
          l2 = l1;
          l4 = l1;
          l1 = localbjlc.jdField_a_of_type_Long;
          l2 = l1;
          l4 = l1;
          l5 = localbjlc.b;
          l2 = l5;
          l4 = l3;
          bjko.c("ReportManager", str2 + " | " + l4 + " | " + l1 + " | " + l2 + " | " + i);
          l3 = 0L;
          try
          {
          ...
          bjmb.a().a(str2, l4, l1, l2, i, l3, "1000002", null, this.jdField_a_of_type_Boolean);
          return localHashMap;
          if (!bool) {
            continue;
          }
