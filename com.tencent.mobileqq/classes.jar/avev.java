  ...
  extends aksv
{
  ...
  public avev(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  private Cursor a(String paramString)
  {
    ...
    paramString = akpy.a(paramString);
  ...
  private ArrayList<QCallRecord> a(List<QCallRecord> paramList)
  {
    ...
    Collections.sort(paramList, new avew(this));
  ...
  private List<QCallRecord> b(String paramString, int paramInt)
  {
    ...
    //   4: astore 7
    //   6: aload_0
    //   7: getfield 124	avev:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   48: iload_2
    //   49: aload_0
    //   50: getfield 39	avev:jdField_a_of_type_Int	I
    //   53: if_icmple +39 -> 92
    //   56: aload 8
    //   58: ldc_w 384
    //   61: iconst_3
    ...
    //   75: iload_2
    //   76: aload_0
    //   77: getfield 39	avev:jdField_a_of_type_Int	I
    //   80: isub
    ...
    //   118: astore_1
    //   119: aload_0
    //   120: invokespecial 400	avev:a	()Laukn;
    //   123: ldc 214
    //   125: aload_1
    //   126: aconst_null
    //   127: invokevirtual 403	aukn:a	(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    //   130: astore_1
    //   131: aload_1
    //   132: ifnull +310 -> 442
    //   135: invokestatic 408	awzw:a	()J
    //   138: lstore 4
    //   140: aload_1
    ...
    //   196: aload_0
    //   197: aload_1
    //   198: invokespecial 95	avev:a	(Ljava/lang/String;)Landroid/database/Cursor;
    //   201: astore_1
    //   202: aload_1
    //   203: ifnull +201 -> 404
    ...
    //   258: iload_3
    //   259: aload_0
    //   260: getfield 39	avev:jdField_a_of_type_Int	I
    ...
    //   287: iload_3
    //   288: aload_0
    //   289: getfield 39	avev:jdField_a_of_type_Int	I
    //   292: isub
    ...
    //   331: astore 7
    //   333: aload_0
    //   334: invokespecial 400	avev:a	()Laukn;
    //   337: ldc 214
    //   339: aload 7
    //   341: aconst_null
    //   342: invokevirtual 403	aukn:a	(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    //   345: astore 7
    //   347: aload 7
    //   349: ifnull +13 -> 362
    //   352: aload 6
    ...
    //   367: dup
    //   368: aload_0
    //   369: invokespecial 431	avex:<init>	(Lavev;)V
  ...
  public List<QCallRecent> a(avey arg1)
  {
  ...
  public void d()
  {
    ...
    try
    {
      List localList1 = localaukn.a(QCallRecent.class, false, null, null, null, null, "lastCallTime desc", null);
    ...
    try
    {
      bool = localaukn.b("delete from" + "recent_call" + " where lastCallTime < " + ((QCallRecent)localList1.get(90)).lastCallTime + ";");
