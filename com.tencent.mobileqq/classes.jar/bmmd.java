...
public class bmmd
{
  ...
  static
  {
    ...
    for (;;)
    {
      ...
      {
        if (bmmd.class.getName().equals(arrayOfStackTraceElement[i].getClassName())) {
  ...
  public bmmd a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public bmmd a(String paramString1, int paramInt, String paramString2)
  {
  ...
  public bmmd b(String paramString1, int paramInt, String paramString2)
  {
    a(paramString1, paramInt, 4, paramString2, this.b);
    return this;
  }
  
  public bmmd c(String paramString1, int paramInt, String paramString2)
  {
