...
{
  public bbyv(QuickLoginAuthorityActivity paramQuickLoginAuthorityActivity) {}
  
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    QLog.e("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onFailed--action = " + paramInt1 + ", ret = " + paramInt2 + ", ssoAccount = *" + bcam.a(paramString));
    this.a.f();
    if (paramInt2 == -1000)
    {
      this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a(this.a, this.a.getResources().getString(2131629228));
      return;
    }
    paramBundle = (ErrMsg)paramBundle.getParcelable("lastError");
    if (paramBundle == null) {}
    for (paramBundle = this.a.getString(2131629224);; paramBundle = paramBundle.getMessage())
    {
      QLog.e("Q.quicklogin.QuickLoginAuthorityActivity", 1, new Object[] { "ssoAccount failed, error: ", paramBundle });
      bbmy.a(BaseApplicationImpl.getContext(), paramBundle + "(" + paramInt2 + ")", 0).a();
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onGetA1WithA1--ret = " + paramInt1 + ", ssoAccount = *" + bcam.a(paramString));
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onGetTicketNoPasswd--ssoAccount = *" + bcam.a(paramString));
    this.a.b = null;
    ...
    amfd localamfd = (amfd)alzw.a().a(546);
    paramBundle = "";
    if (paramInt == 32) {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localamfd.jdField_a_of_type_Int == 1)
          {
            paramBundle = (String)localamfd.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
            if ((this.a.a(paramString, paramBundle)) && (paramArrayOfByte != null))
            {
              ...
              if ((localamfd.b != 1) || (paramInt != 0)) {
                break label754;
              }
              this.a.f();
              bbmy.a(BaseApplicationImpl.getContext(), ajjy.a(2131645445), 1).a();
              ...
              awrn.a(BaseApplicationImpl.getContext()).a("", "kQuickLoginForBrowser", true, 0L, 0L, paramArrayOfByte, "");
              return;
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onUserCancel--action = " + paramInt + ", ssoAccount = *" + bcam.a(paramString));
    this.a.f();
  }
}
