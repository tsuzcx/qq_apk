...
public class bbyv
  extends bbyr
{
  private static final Map<String, List<bbzg>> a;
  ...
  public bbyv(LoadParam paramLoadParam, LoadParam.LoadItem paramLoadItem)
  {
  ...
  private void a(int paramInt)
  {
    ...
    synchronized (jdField_a_of_type_JavaUtilMap)
    {
      ...
      if (localObject3 != null)
      {
        ...
        {
          localObject3 = (bbzg)((Iterator)???).next();
          if (localObject3 != null) {
            ((bbzg)localObject3).a(localSoLoadInfo);
          }
        }
      }
    }
  ...
  private void a(akbj paramakbj)
  {
    ...
    PreloadManager.a().a(localDownloadParam, paramakbj);
  }
  
  private void a(LoadParam.LoadItem paramLoadItem)
  {
    boolean bool2 = false;
    paramLoadItem = bbzk.b(paramLoadItem, this.jdField_a_of_type_ComTencentMobileqqSoloadConfigSoConfig$SoDetailInfo);
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      b(new bbyy(this, bool4, bool1, paramLoadItem));
      return;
    }
  ...
  private void a(LoadParam.LoadItem paramLoadItem, SoConfig.SoInfo paramSoInfo)
  {
    ...
    paramSoInfo = bbzk.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, this.jdField_a_of_type_ComTencentMobileqqSoloadConfigSoConfig$SoDetailInfo.ver);
    ...
    if ((paramSoInfo != null) && (paramSoInfo.f()))
    {
      ...
      bbzq.a().a(paramLoadItem.name, paramSoInfo, new bbyx(this, str, paramSoInfo, paramLoadItem));
      return;
    }
    a(paramLoadItem);
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, bbzx parambbzx, String paramString, long paramLong, int paramInt)
  {
    if (paramBoolean1)
    {
      a(parambbzx.f, paramString, paramLong, paramInt);
      return;
    }
    if (paramBoolean2)
    {
    ...
    a(new bbyz(this, paramString, paramLong, paramInt));
  }
  
  private boolean a(bbzg parambbzg)
  {
    synchronized (jdField_a_of_type_JavaUtilMap)
    {
  ...
  private void b(akbj paramakbj)
  {
    ...
    bbzi.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mReportSeq, null, "load.item.download.start", null, 0, null);
    if (this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mCallType == LoadParam.CALL_TYPE_ASYNC_BY_SYNC) {
      localDownloadParam.isPreDownload = true;
    }
    PreloadManager.a().a(localDownloadParam, paramakbj);
  ...
  public void a(bbzg parambbzg)
  {
    if (a())
    {
      ...
      akfu.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem, parambbzg);
    }
    do
    {
      return;
    ...
    return;
    bbzi.a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam, this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam.mReportSeq, null, "load.item.getconfig.start", this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, 0, null);
    bbzq.a().a(this.jdField_a_of_type_ComTencentMobileqqSoloadLoadParam$LoadItem.name, new bbyw(this), false);
  }
}
