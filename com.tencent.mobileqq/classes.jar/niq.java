  ...
  implements Handler.Callback
{
  ...
  private nii jdField_a_of_type_Nii = new nii();
  private nij jdField_a_of_type_Nij = new nij();
  private niy jdField_a_of_type_Niy = new nir(this);
  ...
  private nij jdField_b_of_type_Nij = new nij();
  ...
  private nij jdField_c_of_type_Nij = new nij();
  ...
  public niq(Context paramContext, ner paramner)
  {
    super(paramContext);
    paramContext = nie.d();
  ...
  public void a(Bitmap paramBitmap, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Nih.d = paramInt4;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.jdField_a_of_type_AndroidGraphicsBitmap = nhs.a("avgame_songfallback@2x.png");
        if (this.jdField_a_of_type_AndroidGraphicsBitmap == null)
        {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
        this.jdField_c_of_type_Nij.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_Nij.a(), this.jdField_c_of_type_Nij.b(), 0, 0);
      }
      return;
    }
  ...
  public int[] a()
  {
    ...
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      this.jdField_a_of_type_Nij.a(720, 720);
      this.jdField_b_of_type_Nij.a(720, 720);
      this.jdField_a_of_type_Nii.a(720, 720);
      this.jdField_c_of_type_Nij.a(720, 720);
      this.jdField_b_of_type_Boolean = false;
      this.jdField_b_of_type_JavaLangString = b();
      this.jdField_c_of_type_JavaLangString = c();
      bkdp.c(this.jdField_a_of_type_JavaLangString, "doNeedStartRecord rW=720, rH=720");
      localbbmc = new bbmc(this.jdField_b_of_type_JavaLangString, 720, 720, 5120000, 1, false, 0);
  ...
  public void b(Bitmap paramBitmap, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_b_of_type_Nih.d = paramInt4;
      ...
      if (e())
      {
        ...
        if (d())
        {
          ...
          if ((this.jdField_a_of_type_Ner != null) && (this.jdField_a_of_type_Ner.a() != null))
          {
            ...
            if (d())
            {
              bkdp.c(this.jdField_a_of_type_JavaLangString, "render call .");
              if ((this.jdField_a_of_type_Ner != null) && (this.jdField_a_of_type_Ner.a() != null))
              {
                this.jdField_a_of_type_Ner.a().requestRender();
  ...
  public void q()
  {
    if (this.jdField_c_of_type_Boolean)
    {
      bkdp.c(this.jdField_a_of_type_JavaLangString, "releaseGameTexture");
