  ...
  extends bmxt
{
  ...
  private String jdField_c_of_type_JavaLangString = alud.a(2131706410);
  ...
  public bmxx(Context paramContext, String paramString)
  {
  ...
  protected void b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.i = this.jdField_a_of_type_Bmxh.a("lineHeight", 20L, 200L, 0, this.jdField_b_of_type_Int - a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), new LinearInterpolator());
        this.j = this.jdField_a_of_type_Bmxh.a("offsetX", 180L, 330L, -this.jdField_a_of_type_Int, 0, new LinearInterpolator());
        return;
      }
