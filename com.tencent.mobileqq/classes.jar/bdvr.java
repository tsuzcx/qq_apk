...
public class bdvr
{
  ...
  public static bdvs a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localbdvs.jdField_a_of_type_JavaLangString = a(paramString);
    String str;
    if (!localSharedPreferences.getBoolean("guideEnable", false))
    {
      ...
      localbdvs.jdField_a_of_type_Int = 4;
      switch (localbdvs.jdField_a_of_type_Int)
      {
      case 3: 
      default: 
        str = "P3";
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guidePopupOpen", 0) == 1)
      {
        ...
        if ((i == 0) || (i == 1))
        {
          ...
          {
            localbdvs.jdField_a_of_type_Int = 3;
          ...
          for (str = "lastTipTime_";; str = "lastDialogTime_")
          {
            ...
            if (localbdvs.jdField_a_of_type_Int == 4) {
              break;
            }
            localSharedPreferences.edit().putLong(str, l).commit();
            break;
            localbdvs.jdField_a_of_type_Int = 2;
            break label365;
          }
        }
        localbdvs.jdField_a_of_type_Int = 4;
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(ambd.h);
    boolean bool3 = paramBundle.getBoolean(ambd.i);
    String str2 = paramBundle.getString(ambd.j);
    String str1 = paramBundle.getString(ambd.k);
  ...
  public static boolean a(Activity paramActivity, int paramInt, bdvt parambdvt, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      localbdvs = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + localbdvs.jdField_a_of_type_Int);
      }
    } while (localbdvs.jdField_a_of_type_Int == 4);
    if (localbdvs.jdField_a_of_type_Int == 1)
    {
      if (parambdvt != null) {
        parambdvt.callback(2);
      }
      return false;
    }
    new bdvq(paramActivity, parambdvt, paramInt, paramString, localbdvs.jdField_a_of_type_Int).show();
    return false;
  }
