...
public class awgn
  extends awgs
{
  public awgn(ambz paramambz, String paramString)
  {
    ...
    catch (Exception paramawgp)
    {
      try
      {
        if (paramClass.getName().equals(MessageRecord.class.getName()))
        {
          ...
          paramawgp = paramCursor.getString(paramCursor.getColumnIndex("extStr"));
          int k = paramCursor.getInt(paramCursor.getColumnIndex("istroop"));
          MessageRecord localMessageRecord = azaf.a(i, paramClass, j, paramawgp, k);
          localMessageRecord.msgData = paramClass;
          localMessageRecord._id = l1;
          localMessageRecord.extLong = j;
          localMessageRecord.extStr = paramawgp;
