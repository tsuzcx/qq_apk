  ...
  implements bfpc
{
  ...
  private awgo jdField_a_of_type_Awgo;
  private List<bbje> jdField_a_of_type_JavaUtilList;
  
  public awgn(Context paramContext, List<bbje> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Awgo == null) {
      this.jdField_a_of_type_Awgo = new awgo(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
    ...
    if (paramViewGroup.jdField_a_of_type_Bbje.e > 0)
    {
      ...
      localObject1 = this.jdField_a_of_type_Awgo.a((Drawable)localObject1, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_Bbje.c) {
        break label486;
      }
      localObject2 = awgo.a(this.jdField_a_of_type_Awgo, (Drawable)localObject1);
      localObject1 = this.jdField_a_of_type_Awgo.a((Drawable)localObject1, (Drawable)localObject2);
    ...
    for (paramViewGroup = paramViewGroup.jdField_a_of_type_Bbje.jdField_a_of_type_JavaLangString;; paramViewGroup = "")
    {
      ...
      break label324;
      label486:
      localObject1 = awgo.b(this.jdField_a_of_type_Awgo, (Drawable)localObject1);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
      break label403;
      label509:
