...
public class bihw
{
  private static bihw jdField_a_of_type_Bihw;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentLinkedQueue<bihx> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static bihw a()
  {
    try
    {
      if (jdField_a_of_type_Bihw == null) {
        jdField_a_of_type_Bihw = new bihw();
      }
      bihw localbihw = jdField_a_of_type_Bihw;
      return localbihw;
    }
    finally {}
  }
  ...
  private String a(String paramString)
  {
    try
    {
      ...
      if (localFile.exists())
      {
        ...
        paramString = bkfg.a(paramString);
        return paramString;
      }
    }
  ...
  private String b(PackageInfo paramPackageInfo)
  {
    ...
    return bkcx.a(paramPackageInfo);
  }
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.4.1"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.4.1", Integer.valueOf(a("8.4.1")) }));
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
        break label561;
      }
      localSendInfo = new SecSharedInfo.SendInfo();
      localObject1 = (bihx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      i = ((bihx)localObject1).a();
      localObject3 = ((bihx)localObject1).a();
      str3 = ((bihx)localObject1).b();
      j = ((bihx)localObject1).b();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = bkdr.a((String)localObject3);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.offer(new bihx(paramInt1, paramString1, paramInt2, paramString2));
  }
