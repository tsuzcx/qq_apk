...
public class aubn
{
  public static final String g = alud.a(2131714336);
  ...
  public aubn(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    AbsShareMsg localAbsShareMsg = new azup(StructMsgForGeneralShare.class).c(114).a(this.b).e(this.jdField_a_of_type_JavaLangString).a();
    localAbsShareMsg.mSourceName = this.e;
    localAbsShareMsg.mSourceAction = "web";
    localAbsShareMsg.mSourceUrl = this.f;
    Object localObject = azvc.a(2);
    ((azut)localObject).a(this.d, this.b, this.c);
  ...
  private void b()
  {
    ...
    bjev.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localBundle, null);
  }
  ...
  {
    if (!a()) {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, alud.a(2131714337), 0).a();
    }
    do
    {
      for (;;)
      {
        ...
        {
          aubo localaubo = new aubo(this);
          paramOnDismissListener = new aubp(this, paramOnDismissListener);
          ...
          this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setItemClickListener(localaubo);
