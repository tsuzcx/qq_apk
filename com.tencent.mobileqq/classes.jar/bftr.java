...
public class bftr
{
  ...
  private static HashMap<String, bftq> d;
  ...
  public static bftq a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "HasUnReadRepeatTroopNotification");
    }
    Object localObject = (bftq)jdField_d_of_type_JavaUtilHashMap.get(paramString);
    if (localObject != null)
    {
      paramQQAppInterface = (QQAppInterface)localObject;
      if (QLog.isColorLevel())
      {
        QLog.d("TroopNotificationHelper", 2, "HasUnReadRepeatTroopNotification. type = " + ((bftq)localObject).jdField_a_of_type_Int);
        paramQQAppInterface = (QQAppInterface)localObject;
      }
    }
    label314:
    do
    {
      do
      {
        ...
        paramString = (bftq)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      ...
      return null;
      paramString = new bftq(((TroopInfo)localObject).feeds_id, ((TroopInfo)localObject).troopRepeatType);
      paramQQAppInterface = paramString;
    } while (!QLog.isColorLevel());
  ...
  public static bfts a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static bfts a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    boolean bool1 = true;
    boolean bool2 = false;
    label846:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          localObject5 = new bfts();
          ((bfts)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((bfts)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((bfts)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((bfts)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((bfts)localObject5).jdField_a_of_type_Int = 1;
          if (!localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
            break label894;
          }
          i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
          ((bfts)localObject5).jdField_e_of_type_Int = i;
          ...
          paramBoolean = bool1;
          ((bfts)localObject5).jdField_a_of_type_Boolean = paramBoolean;
          break label891;
        }
        if (i == 22)
        {
          ...
          localObject3 = new bfts();
          ((bfts)localObject3).jdField_b_of_type_JavaLangString = paramString;
          ((bfts)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
          ((bfts)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
          ((bfts)localObject3).jdField_a_of_type_Int = 2;
          ((bfts)localObject3).jdField_b_of_type_Long = l1;
          ((bfts)localObject3).jdField_d_of_type_Int = i;
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has())
          {
            i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
            ((bfts)localObject3).jdField_e_of_type_Int = i;
            if ((!localGroupFeedsMessage.memo_ctrl_info.has()) || (!((group_feeds.GroupFeedsMessage.MemoCtrlInfo)localGroupFeedsMessage.memo_ctrl_info.get()).uint32_need_confirmation.has())) {
              break;
            }
            paramBoolean = bool2;
            ...
            ((bfts)localObject3).jdField_a_of_type_Boolean = paramBoolean;
            break;
          }
        }
        return null;
  ...
  public static TroopNotificationCache a(bfts parambfts, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (parambfts != null)
    {
      if (parambfts.jdField_a_of_type_Int == 1)
      {
        String str2 = a(parambfts.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(parambfts.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(parambfts.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(parambfts.jdField_c_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = parambfts.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = parambfts.jdField_a_of_type_Long;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = parambfts.jdField_c_of_type_Int;
        localTroopNotificationCache.feedsId = parambfts.jdField_b_of_type_JavaLangString;
        localTroopNotificationCache.serviceID = 27;
        localTroopNotificationCache.needConfirm = parambfts.jdField_a_of_type_Boolean;
        String str3 = new SimpleDateFormat("M-d HH:mm").format(new Date(localTroopNotificationCache.time * 1000L));
        if (TextUtils.isEmpty(parambfts.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, parambfts.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (parambfts.jdField_a_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = parambfts.jdField_a_of_type_Long;
        paramString.troopUin = paramLong;
        paramString.time = parambfts.jdField_c_of_type_Int;
        paramString.feedsId = parambfts.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = parambfts.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = parambfts.jdField_a_of_type_ArrayOfByte;
        paramString.src = parambfts.jdField_d_of_type_Int;
        paramString.filterID = parambfts.jdField_b_of_type_Long;
  ...
  public static TroopNotificationCache a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramQQAppInterface)
      {
        ...
        QLog.d(bftr.class.getSimpleName(), 2, paramQQAppInterface.getMessage());
        continue;
      }
      return null;
      label310:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString1, int paramInt2, String paramString2, short paramShort, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(bftr.class.getSimpleName(), 2, localException.getMessage());
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        paramArrayOfByte = null;
        if ((((bfts)localObject).jdField_a_of_type_Int == 1) || (((bfts)localObject).jdField_a_of_type_Int == 2)) {
          paramArrayOfByte = a((bfts)localObject, paramString, 23, paramInt1, paramLong2);
        }
        QQMessageFacade localQQMessageFacade = paramQQAppInterface.a();
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(paramArrayOfByte);
        paramInt1 = (int)bbyp.a();
        localQQMessageFacade.a().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((bfts)localObject).jdField_e_of_type_Int, ((bfts)localObject).jdField_b_of_type_JavaLangString);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((anwd)paramQQAppInterface.a(20)).a(paramQQAppInterface, paramString, arrayOfByte, paramInt);
      return;
    }
    try
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramQQAppInterface = new bftq(paramString1, paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, List<TroopNotificationCache> paramList, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt2 == 1)
      {
        ...
        paramQQAppInterface = albs.a(paramString1.uin, paramString1.getType());
        ...
        if (!(paramString1.msg instanceof alez)) {
          break label472;
        }
        localObject = (alez)paramString1.msg;
        if (!bool1) {
          break label459;
        }
        paramQQAppInterface = BaseApplication.getContext().getString(2131718576);
        ((alez)localObject).jdField_a_of_type_JavaLangString = paramQQAppInterface;
      }
      for (;;)
      {
        ((alez)paramString1.msg).jdField_c_of_type_Int = paramInt2;
        paramString1.lastmsgtime = paramInt1;
        paramString2.a().saveRecentUser(paramString1);
        paramList.sendEmptyMessage(1009);
        return;
        if ((!(paramString1.msg instanceof alez)) || (((alez)paramString1.msg).jdField_c_of_type_Int != 1)) {
          break;
        }
        return;
        i = 11;
        break label345;
        paramQQAppInterface = BaseApplication.getContext().getString(2131718575);
        break label385;
        paramString1.msg = new alez(BaseApplication.getContext(), bool1);
      }
    }
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    QLog.d("TroopNotificationHelper", 2, bftr.class.getSimpleName() + "-->clearTroopNotification");
  }
  ...
  public static byte[] a(long paramLong, short paramShort, byte[] paramArrayOfByte, String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(bftr.class.getSimpleName(), 2, paramArrayOfByte.getMessage());
      }
    }
    return null;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(bftr.class.getSimpleName(), 2, "handGetTroopAuth");
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    aaqa.b("https://gdynamic.qpic.cn/gdynamic/");
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    } while (((paramString2.msg instanceof alez)) && (((alez)paramString2.msg).jdField_c_of_type_Int == 1));
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "setUnReadRepeatTroopNotificationPre, update recent user list");
    }
    Object localObject = albs.a(paramString2.uin, paramString2.getType());
    albs.a().a((String)localObject);
    paramString2.msgType = 11;
    localObject = new alez(BaseApplication.getContext(), true);
    ((alez)localObject).jdField_c_of_type_Int = 0;
