...
public class atut
{
  ...
  private List<atuz> jdField_a_of_type_JavaUtilList;
  private int b = 0;
  ...
  private boolean a()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString == null) || (this.jdField_a_of_type_JavaLangString.trim().length() == 0) || (this.jdField_a_of_type_JavaLangString.equals(localFileManagerEntity.peerUin)))
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(atus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity));
          break;
        }
      }
    }
  ...
  private boolean a(ForwardFileInfo paramForwardFileInfo)
  {
    ...
    while (paramForwardFileInfo.hasNext())
    {
      ...
      if (localObject != null)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.add(atus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (FileManagerEntity)localObject));
          i += 1;
          break;
        }
      }
  ...
  private boolean b()
  {
    ...
    if ((localObject2 != null) && (((Set)localObject2).size() > 0))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (((FileInfo)localObject3).a() == 0) {
          this.jdField_a_of_type_JavaUtilList.add(atus.a((FileInfo)localObject3));
        }
      }
    }
    if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (auea.a(((WeiYunFileInfo)localObject2).c) == 0) {
          this.jdField_a_of_type_JavaUtilList.add(atus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (WeiYunFileInfo)localObject2));
        }
      }
    }
  ...
  private boolean b(Intent paramIntent)
  {
    ...
    if (paramIntent.hasNext())
    {
      ...
      if ((i == 0) && (((FileInfo)localObject).hashCode() == k))
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(atus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity));
        i = 1;
      }
      for (;;)
      {
        j += 1;
        break;
        this.jdField_a_of_type_JavaUtilList.add(atus.a((FileInfo)localObject));
      }
    }
    atpm.a();
    return true;
  ...
  private boolean c(Intent paramIntent)
  {
    ...
    while (paramIntent.hasNext())
    {
      ...
      do
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(atus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localWeiYunFileInfo));
          break;
        } while (auea.a(localWeiYunFileInfo.c) == 0);
  ...
  {
    return new atuu(this, paramBaseActivity);
  }
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = bebf.a(localForwardFileInfo);
    }
    ...
    if (5 != this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.cloudType) {
      auea.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    }
    boolean bool;
    ...
    {
      this.jdField_a_of_type_Atuz = atus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.b = 3;
      return true;
    }
    return bool;
