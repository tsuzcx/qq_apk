  ...
  extends zim
{
  ...
  public void a(Activity paramActivity, zin paramzin, int paramInt)
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)paramzin.a();
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131367027);
    ...
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new zjg(this));
    this.b.setAnimationListener(new zjh(this));
  }
