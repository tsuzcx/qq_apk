...
public final class bgtl
{
  ...
  public static int a()
  {
    ...
    if (!TextUtils.isEmpty(bgjq.a("ro.build.version.opporom"))) {
      return 3;
    }
    if (!TextUtils.isEmpty(bgjq.a("ro.vivo.os.version"))) {
      return 4;
    }
    return 0;
  }
  ...
  public static void a()
  {
    ...
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      auzk localauzk = (auzk)((QQAppInterface)localObject).getManager(219);
      if (localauzk != null) {
        localauzk.d();
      }
  ...
  public static void a(Activity paramActivity, AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      {
        localObject1 = bgyg.a("signatureEntrance");
        str1 = str2;
      }
    ...
    for (;;)
    {
      ...
      localObject1 = bgyg.a("signatureDIYEntrance");
  ...
  {
    int i3 = 1;
    bccg localbccg = (bccg)paramQQAppInterface.getManager(12);
    int i;
    int j;
    label51:
    int k;
    ...
    if (localbccg != null)
    {
      if (localbccg.a("100005.100001") == -1) {
        break label263;
      }
      i = 1;
      if (i != 0)
      {
        if (localbccg.a("100005.100003") == -1) {
          break label268;
        }
        j = 1;
        if (localbccg.a("100005.100002") == -1) {
          break label273;
        }
        k = 1;
        if (localbccg.a("100005.100006") == -1) {
          break label278;
        }
        m = 1;
        if (localbccg.a("100005.100018") == -1) {
          break label284;
        }
        n = 1;
        if (localbccg.a("100005.100020") == -1) {
          break label290;
        }
        i1 = 1;
        if (localbccg.a("100005.100021") == -1) {
          break label296;
        }
        i2 = 1;
        bool = ((gc)paramQQAppInterface.getManager(42)).a;
        if (!bool) {
          break label312;
        }
        if (localbccg.a("100005.100011") == -1) {
          break label302;
        }
        i = 1;
      }
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {
          ((baif)paramQQAppInterface.getManager(36)).b("100005");
        }
        return;
        i = 0;
        break;
    ...
    for (BubbleManager localBubbleManager = (BubbleManager)paramQQAppInterface.getManager(44);; localBubbleManager = null)
    {
      if ((paramXListView != null) && (localBubbleManager != null))
      {
        ...
        while (i >= 0)
        {
          ...
          {
            afwr localafwr = (afwr)afur.a((View)localObject);
            localObject = afur.a((View)localObject);
            if ((localObject != null) && (((ChatMessage)localObject).needVipBubble()) && (localafwr != null) && (localafwr.a != null) && (localafwr.a.jdField_a_of_type_Int == apxt.a.jdField_a_of_type_Int) && (localBubbleManager.a(anuk.a(((ChatMessage)localObject).vipBubbleID)))) {
              return true;
            }
            if ((localObject != null) && (((gc)paramQQAppInterface.getManager(42)).a(localafwr, (ChatMessage)localObject))) {
              return true;
            }
          }
          else if ((localObject != null) && ((afur.a((View)localObject) instanceof ahgz)))
          {
            return true;
          }
          i -= 1;
  ...
  public static byte[] a(byte[] paramArrayOfByte, tencent.im.msg.im_msg_body.GeneralFlags paramGeneralFlags, int paramInt)
  {
    ...
    //   4: ifnull +295 -> 299
    //   7: aload_1
    //   8: getfield 706	tencent/im/msg/im_msg_body$GeneralFlags:bytes_pb_reserve	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   11: invokevirtual 711	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   14: ifeq +285 -> 299
    //   17: new 713	tencent/im/msg/hummer/resv/generalflags$ResvAttr
    //   20: dup
    //   21: invokespecial 714	tencent/im/msg/hummer/resv/generalflags$ResvAttr:<init>	()V
    //   24: astore 4
    //   26: aload 4
    //   28: aload_1
    //   29: getfield 706	tencent/im/msg/im_msg_body$GeneralFlags:bytes_pb_reserve	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   32: invokevirtual 718	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   35: invokevirtual 724	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   38: invokevirtual 728	tencent/im/msg/hummer/resv/generalflags$ResvAttr:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   41: pop
    //   42: aload 4
    //   44: getfield 731	tencent/im/msg/hummer/resv/generalflags$ResvAttr:bytes_oac_msg_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   47: invokevirtual 711	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   50: ifeq +244 -> 294
    ...
    //   60: dup
    //   61: aload 4
    //   63: getfield 731	tencent/im/msg/hummer/resv/generalflags$ResvAttr:bytes_oac_msg_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   66: invokevirtual 718	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   69: invokevirtual 734	com/tencent/mobileqq/pb/ByteStringMicro:toStringUtf8	()Ljava/lang/String;
    ...
    //   125: arraylength
    //   126: ifle +130 -> 256
    //   129: invokestatic 323	com/tencent/common/app/BaseApplicationImpl:getApplication	()Lcom/tencent/common/app/BaseApplicationImpl;
    //   132: invokevirtual 354	com/tencent/common/app/BaseApplicationImpl:getRuntime	()Lmqq/app/AppRuntime;
    //   135: astore 4
    //   137: aload 4
    //   139: instanceof 69
    //   142: ifeq +149 -> 291
    ...
    //   146: ldc_w 269
    //   149: aload 4
    //   151: checkcast 69	com/tencent/mobileqq/app/QQAppInterface
    //   154: invokestatic 267	bgtl:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Ljava/lang/String;
    //   157: invokevirtual 281	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   160: astore_1
    //   161: new 271	java/lang/String
    //   164: dup
    //   165: aload_0
    //   166: iload_2
    //   167: invokestatic 741	bcxm:a	([BI)[B
    //   170: ldc_w 743
    //   173: invokespecial 746	java/lang/String:<init>	([BLjava/lang/String;)V
    //   176: astore_0
    //   177: aload 5
    //   179: astore 4
    //   181: aload_0
    //   182: ldc_w 748
    //   185: invokevirtual 394	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   188: ifeq +68 -> 256
    //   191: getstatic 13	bgtl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   194: iconst_1
    //   195: new 104	java/lang/StringBuilder
    //   198: dup
    //   199: invokespecial 107	java/lang/StringBuilder:<init>	()V
    //   202: ldc_w 750
    ...
    //   215: invokestatic 753	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   218: aload_0
    //   219: ldc_w 755
    //   222: new 104	java/lang/StringBuilder
    //   225: dup
    //   226: invokespecial 107	java/lang/StringBuilder:<init>	()V
    //   229: ldc_w 748
    ...
    //   248: invokevirtual 760	java/lang/String:replaceFirst	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   251: invokevirtual 763	java/lang/String:getBytes	()[B
    //   254: astore 4
    //   256: aload 4
    //   258: areturn
    //   259: astore 4
    //   261: aconst_null
    //   262: astore_1
    //   263: getstatic 13	bgtl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   266: iconst_1
    //   267: aload 4
    //   269: iconst_0
    //   270: anewarray 4	java/lang/Object
    //   273: invokestatic 766	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   276: goto -164 -> 112
    //   279: astore_0
    //   280: aload_0
    //   281: invokevirtual 767	java/io/UnsupportedEncodingException:printStackTrace	()V
    //   284: aconst_null
    //   285: areturn
    //   286: astore 4
    //   288: goto -25 -> 263
