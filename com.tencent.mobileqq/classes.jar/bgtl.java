  ...
  implements bgtk
{
  ...
  public bgtl(Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface)
  {
  ...
  private void initLayout()
  {
    ...
    View localView = LayoutInflater.from(this.mContext).inflate(2131562992, null);
    this.mInActivity.setContentView(localView);
    this.mViewRoot = localView.findViewById(2131381027);
    ...
    this.titleContainer = ((FrameLayout)this.mViewRoot.findViewById(2131378747));
    this.bottomContainer = ((FrameLayout)this.mViewRoot.findViewById(2131363641));
    this.webviewContainer = ((RelativeLayout)this.mViewRoot.findViewById(2131381046));
    this.mLoadProgress = ((ProgressBar)this.mViewRoot.findViewById(2131376213));
    this.maskView = this.mViewRoot.findViewById(2131381049);
    this.contentContainer = ((LinearLayout)this.mViewRoot.findViewById(2131365083));
    if ((this.mIntent != null) && (!this.mIntent.getBooleanExtra("webview_hide_progress", false)))
    {
      this.mLoadingProgressBar = ((WebViewProgressBar)this.mViewRoot.findViewById(2131373019));
  ...
  protected void adjustLayout(boolean paramBoolean, bgtn parambgtn)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean)
    {
      localLayoutParams = (RelativeLayout.LayoutParams)parambgtn.b.getLayoutParams();
      localLayoutParams.topMargin = i;
      parambgtn.b.setLayoutParams(localLayoutParams);
      localLayoutParams = (RelativeLayout.LayoutParams)parambgtn.a.getLayoutParams();
      localLayoutParams.topMargin = 0;
      localLayoutParams.addRule(3, 0);
      parambgtn.a.setLayoutParams(localLayoutParams);
      return;
    }
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)parambgtn.b.getLayoutParams();
    localLayoutParams.topMargin = i;
    parambgtn.b.setLayoutParams(localLayoutParams);
    localLayoutParams = (RelativeLayout.LayoutParams)parambgtn.a.getLayoutParams();
  ...
  public void buildLayout()
  {
    ...
    this.mWebview.setId(2131381043);
  ...
  public void buildTitleBar()
  {
    ...
    this.mTitleBar = new bgyf(this.mInActivity, this.mWebview, this.titleContainer);
    this.titleContainer.setBackgroundResource(2130850016);
    ...
    this.mTitleBar.a(new bgtm(this));
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if ((this.bNeedStatusTrans) && (ImmersiveUtils.isSupporImmersive() == 1))
    {
      ...
      int i = this.mInActivity.getResources().getColor(2131167070);
  ...
  protected void onImmersive(boolean paramBoolean, bgtn parambgtn)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean)
    {
      ...
      parambgtn.b.getBackground().setAlpha(0);
      return;
    }
    if (this.mSystemBarComp != null) {
      this.mSystemBarComp.setgetStatusBarVisible(true, 0);
    }
    parambgtn.b.setBackgroundResource(2130850016);
  ...
  protected final void setTittlebarImmersive(boolean paramBoolean, bgtn parambgtn)
  {
    if (QLog.isColorLevel()) {
      QLog.d("WebViewBaseBuilder", 2, "setTittlebarImmersive");
    }
    adjustLayout(paramBoolean, parambgtn);
    onImmersive(paramBoolean, parambgtn);
  }
}
