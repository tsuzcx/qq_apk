...
public class arve
{
  public static String a(QQAppInterface paramQQAppInterface, bhhf parambhhf, boolean paramBoolean)
  {
    ArrayList localArrayList = null;
    if ((paramQQAppInterface == null) && (parambhhf == null)) {}
    ...
    int i = ((Bundle)localObject).getInt("jsonType", arup.c);
    File localFile = (File)parambhhf.jdField_a_of_type_JavaUtilMap.get(parambhhf.jdField_a_of_type_JavaLangString);
    Object localObject = new arvr();
    parambhhf = localArrayList;
    if (localFile != null)
    {
      if (localFile.exists()) {
        parambhhf = bgmg.a(localFile);
      }
    }
    else
    {
    ...
    label162:
    for (paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambhhf, localArrayList);; paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambhhf, localArrayList, (arvr)localObject))
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, arvr paramarvr)
  {
    if (QLog.isColorLevel()) {
      QLog.d("EmotionJsonUtils", 2, "parseJson : parseJson start");
    }
    Object localObject = a(paramQQAppInterface, paramEmoticonPackage, paramArrayOfByte, paramArrayList, paramarvr);
    if (localObject != null) {
    ...
    {
      return paramQQAppInterface;
      localObject = (awmr)paramQQAppInterface.getManager(14);
      try
      {
        ...
        paramArrayOfByte = a(paramEmoticonPackage, paramInt, (awmr)localObject, localJSONObject, str, paramQQAppInterface, "");
        ...
        for (paramEmoticonPackage.supportSize = paramQQAppInterface;; paramEmoticonPackage.supportSize = localJSONObject.getJSONArray("supportSize").toString()) {
          do
          {
            ...
            ((awmr)localObject).a(paramEmoticonPackage);
            int i = ((awmr)localObject).a(str);
            boolean bool = false;
            if (arze.a(paramEmoticonPackage)) {
              bool = true;
            }
            if (QLog.isColorLevel()) {
              QLog.d("EmotionJsonUtils", 2, "parseJson: ep = " + paramEmoticonPackage + " ,update :" + bool);
            }
            paramArrayOfByte = a(paramEmoticonPackage, paramInt, paramArrayList, paramarvr, (awmr)localObject, localJSONObject, str, i, bool);
            paramQQAppInterface = paramArrayOfByte;
            if (paramArrayOfByte != null) {
              break;
            }
  ...
  protected static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, arvr paramarvr)
  {
    if (paramQQAppInterface == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList == null) || (paramarvr == null))
    {
      if (QLog.isColorLevel()) {
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt, awmr paramawmr, JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3)
  {
    int i2 = 0;
            ...
            for (int n = paramJSONObject.getInt("updateTime");; n = 0)
            {
              ...
              for (;;)
              {
                ...
                for (int i1 = 3;; i1 = 0)
                {
                  ...
                  a(paramEmoticonPackage, paramInt, paramawmr, paramJSONObject, paramString1, m, j, n);
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, arvr paramarvr, awmr paramawmr, JSONObject paramJSONObject, String paramString, int paramInt2, boolean paramBoolean)
  {
    ...
    if (j < n)
    {
      ...
      localObject = paramawmr.a(paramString, str1);
      if (localObject == null) {
        if (paramInt1 != arup.d)
        {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        k = i;
        break;
        paramawmr.b(localArrayList);
        if (paramEmoticonPackage.newSoundEp) {
          paramawmr.a(paramEmoticonPackage);
        }
        if (i == 0) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramarvr.a = paramBoolean;
          return null;
        }
      }
    }
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, awmr paramawmr, JSONObject paramJSONObject, String paramString, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramEmoticonPackage.copywritingType != awmq.a)
    {
    ...
    paramawmr = paramawmr.b(paramString);
    if (paramawmr != null)
    {
      paramEmoticonPackage.status = paramawmr.status;
      paramEmoticonPackage.valid = paramawmr.valid;
    }
    ...
    if (paramawmr != null)
    {
      paramEmoticonPackage.wordingId = paramawmr.wordingId;
      return;
    }
    paramEmoticonPackage.wordingId = -1L;
  }
  
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, awmr paramawmr, JSONArray paramJSONArray, int paramInt2, boolean paramBoolean)
  {
    int i = 0;
    Object localObject;
    String str1;
    ...
    if (i < paramInt2)
    {
      ...
      localObject = paramawmr.a(str3, str1);
      if (localObject == null)
      {
        if (paramInt1 == arup.d) {
          break label362;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramBoolean) && (j == 0)) {
          paramawmr.a((Emoticon)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt, ArrayList<Emoticon> paramArrayList, awmr paramawmr, JSONObject paramJSONObject1, long paramLong, JSONObject paramJSONObject2, JSONArray paramJSONArray1, JSONArray paramJSONArray2)
  {
    ...
    for (int i = paramJSONArray1.getInt("isOriginal");; i = 0)
    {
      ...
      for (j = paramJSONArray2.getInt("feeType");; j = 0)
      {
        ...
        for (;;)
        {
          ...
          a(paramEmoticonPackage, paramInt, paramArrayList, paramawmr, paramJSONObject1, paramJSONObject1.length(), true);
          return;
          if (j <= 0) {
            break;
          }
          paramEmoticonPackage.extraFlags &= i;
          break;
          paramJSONObject1 = paramawmr.b(paramEmoticonPackage.epId);
