...
public class uqm
{
  ...
  private aoav jdField_a_of_type_Aoav = new uqo(this);
  public QQAppInterface a;
  HorizontalListView jdField_a_of_type_ComTencentWidgetHorizontalListView;
  public WeakReference<Activity> a;
  private upz jdField_a_of_type_Upz = new uqn(this);
  uqa jdField_a_of_type_Uqa;
  uqf jdField_a_of_type_Uqf;
  public boolean a;
  int b = 0;
  int c = 0;
  private int d;
  
  public uqm(Activity paramActivity, QQAppInterface paramQQAppInterface, uqa paramuqa)
  {
    ...
    this.d = ((int)paramActivity.getResources().getDimension(2131297987));
    i();
  ...
  private void i()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Upz);
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Upz);
    }
  }
  ...
  private void k()
  {
    ...
    localAnimation.setAnimationListener(new uqt(this));
    a(0);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewStub == null) {
      if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
      {
        this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131377130));
        if (this.jdField_a_of_type_AndroidViewViewStub != null)
        {
          this.jdField_a_of_type_AndroidViewViewStub.setOnInflateListener(new uqp(this));
  ...
  void a(int paramInt)
  {
    ...
    {
      return;
      localView = ((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131370180);
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      ((upy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SUBSCRIPT_HANDLER)).a(paramString);
    }
  }
  
  void a(List<uqe> paramList)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_JavaLangRefWeakReference.get() == null)) {
      return;
    }
    if (this.jdField_a_of_type_Uqf == null) {
      this.jdField_a_of_type_Uqf = new uqf((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Uqa);
    }
    this.jdField_a_of_type_Uqf.a();
    this.jdField_a_of_type_Uqf.a(paramList);
  }
  ...
  public boolean a()
  {
    ...
    View localView = localActivity.findViewById(2131366160);
    ...
    int k = (int)localActivity.getResources().getDimension(2131299080);
    int m = (int)localActivity.getResources().getDimension(2131299086);
    int n = this.d;
  ...
  public void b()
  {
    ...
    if (bool)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new uqq(this));
      Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378270);
      ...
      localObject2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379001);
      if (!bool) {
        break label270;
      }
      i = ((Resources)localObject1).getColor(2131166088);
      label126:
      ((TextView)localObject2).setTextColor(i);
      if (this.jdField_a_of_type_ComTencentWidgetHorizontalListView == null)
      {
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377125));
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setDividerWidth((int)((Resources)localObject1).getDimension(2131297988));
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Uqf);
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131364699));
    ...
    label270:
    label281:
    for (int i = 2130843284;; i = 2130843286)
    {
      ((ImageButton)localObject1).setImageResource(i);
      this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new uqr(this));
      return;
      i = 2131166089;
      break;
      i = 2131166377;
      break label93;
      i = ((Resources)localObject1).getColor(2131166087);
      break label126;
    }
  }
  ...
  public void c()
  {
    ...
    Object localObject = (ImageView)((Activity)localObject).findViewById(2131373323);
  ...
  void e()
  {
    ...
    localAnimation.setFillAfter(true);
    localAnimation.setAnimationListener(new uqs(this));
  ...
  {
    if (this.jdField_a_of_type_Uqf != null) {
      this.jdField_a_of_type_Uqf.notifyDataSetChanged();
    }
