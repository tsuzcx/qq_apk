  ...
  implements Manager
{
  ...
  private final List<atfy> jdField_a_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  private boolean[] jdField_a_of_type_ArrayOfBoolean;
  private final List<atfy> jdField_b_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_b_of_type_MqqOsMqqHandler;
  
  public atfx(NearbyAppInterface paramNearbyAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface = paramNearbyAppInterface;
    this.jdField_a_of_type_Atfz = new atfz(paramNearbyAppInterface, this);
  ...
  {
    return this.jdField_a_of_type_Atfz.a(paramInt);
  }
  ...
  public int a()
  {
    Object[] arrayOfObject = this.jdField_a_of_type_Atfz.a(4156);
  ...
  public Message a(Message paramMessage)
  {
    ...
    ((bayd)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a(FaceInfo.a(i, (String)localObject, j, 3));
    return null;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 28	atfx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: iconst_0
    ...
    //   14: iload_3
    //   15: aload_0
    //   16: getfield 28	atfx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   19: invokeinterface 276 1 0
    //   24: if_icmpge +45 -> 69
    //   27: aload_0
    //   28: getfield 28	atfx:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   31: iload_3
    //   32: invokeinterface 279 2 0
    //   37: checkcast 281	atfy
    //   40: astore 6
    //   42: aload_0
    //   43: getfield 45	atfx:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    ...
    //   53: iload_1
    //   54: aload_2
    //   55: invokespecial 286	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1:<init>	(Latfx;Latfy;I[Ljava/lang/Object;)V
    ...
    //   71: monitorexit
    //   72: aload_0
    //   73: getfield 26	atfx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: astore 5
    //   78: aload 5
    //   80: monitorenter
    //   81: iload 4
    ...
    //   84: iload_3
    //   85: aload_0
    //   86: getfield 26	atfx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   89: invokeinterface 276 1 0
    //   94: if_icmpge +51 -> 145
    //   97: aload_0
    //   98: getfield 26	atfx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   101: iload_3
    //   102: invokeinterface 279 2 0
    //   107: checkcast 281	atfy
    //   110: astore 6
    //   112: aload_0
    //   113: getfield 50	atfx:jdField_b_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    ...
    //   123: iload_1
    //   124: aload_2
    //   125: invokespecial 295	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2:<init>	(Latfx;Latfy;I[Ljava/lang/Object;)V
  ...
  public void a(atfy paramatfy, boolean paramBoolean)
  {
    if (paramatfy == null) {
      return;
    }
    if (paramBoolean) {
      ...
      {
        if (!this.jdField_a_of_type_JavaUtilList.contains(paramatfy)) {
          this.jdField_a_of_type_JavaUtilList.add(paramatfy);
        }
        return;
      }
    }
    ...
    {
      if (!this.jdField_b_of_type_JavaUtilList.contains(paramatfy)) {
        this.jdField_b_of_type_JavaUtilList.add(paramatfy);
      }
      return;
    }
  }
  ...
  public void a(oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    try
    {
      ...
      if (localObject1 == null)
      {
        ...
        atbp.a("Q.nearby", "updateSelfCard", new Object[] { paramSelfInfo, localObject1 });
        return;
      }
    }
    catch (Exception localException)
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Atfz.a();
  }
  ...
  public boolean a(int paramInt, boolean paramBoolean)
  {
    boolean bool1 = false;
    Object localObject = null;
    SharedPreferences localSharedPreferences = atbg.a("nearby_event_file", this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getAccount(), 4);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            ...
            if (QLog.isColorLevel()) {
              atbp.a("onGetMyTabConfig", new Object[] { Boolean.valueOf(bool2), Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean) });
            }
            return bool1;
          }
          ...
          catch (Exception localException)
          {
            ...
            {
              localException.printStackTrace();
              atbp.a("onGetMyTabConfig", new Object[] { "save config", Integer.valueOf(paramInt), localException.toString() });
            }
            bool1 = true;
          }
        }
  ...
  public Object[] a(int paramInt, Object... paramVarArgs)
  {
    ...
    case 4146: 
      do
      {
        do
        {
          do
          {
            do
            {
              for (;;)
              {
                ...
                if ((paramVarArgs != null) && (paramVarArgs.length == 1) && ((paramVarArgs[0] instanceof Integer)))
                {
                  ...
                  if (QLog.isColorLevel())
                  {
                    atbp.a("MSG_NOTIFY_HAS_UNREAD_MSG", new Object[] { Integer.valueOf(paramInt) });
                    return null;
                        ...
                        if ((paramVarArgs != null) && (paramVarArgs.length == 2))
                        {
                          ...
                          if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                          {
                            ...
                            if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                            {
                              a(4116, paramVarArgs);
                              return null;
                              atyq.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface, 0, true);
                              return null;
            ...
            return null;
            ((ampe)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(210)).a();
            return null;
        ...
        try
        {
          ...
          ((atbe)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(219)).a(l, paramInt, i, j);
          return null;
        }
        catch (Exception paramVarArgs)
        {
      ...
      ((akbm)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(3)).a(paramInt, i);
      return null;
    case 4159: 
      a(4159, new Object[0]);
      return null;
  ...
  public int b()
  {
    Object[] arrayOfObject = b(4163, new Object[] { ajsf.I });
    try
    {
      int i = ((Integer)arrayOfObject[0]).intValue();
      if (QLog.isColorLevel()) {
  ...
  public void b(atfy paramatfy)
  {
    ...
    {
      if (this.jdField_b_of_type_JavaUtilList.contains(paramatfy)) {
        this.jdField_b_of_type_JavaUtilList.remove(paramatfy);
      }
    }
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramatfy)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramatfy);
      }
      return;
      paramatfy = finally;
      throw paramatfy;
