...
public class bdfn
{
  ...
  public static int a()
  {
    return bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).getInt("appTabVersionCode", -1);
  }
  ...
  public static String a(WebView paramWebView, HashMap<String, arly> paramHashMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < localJSONArray2.length())
        {
          ...
          bdii.c("Common", "nameSpace:" + paramString + ",methodName=" + str1 + ",paramsStr=" + paramWebView);
      ...
      catch (UnsupportedEncodingException paramWebView)
      {
        try
        {
          ...
          {
            paramWebView = (Class)bdfv.jdField_a_of_type_JavaUtilHashMap.get(paramString);
            if (bdfv.jdField_a_of_type_JavaUtilArrayList.contains(str1)) {
            ...
            if (paramWebView != null)
            {
              ...
              if (j < k)
              {
                ...
                if ((paramWebView.getName().equals(str1)) && (paramWebView.getParameterTypes().length == ((List)localObject).size()))
                {
                  ...
                  try
                  {
                    bdii.c("Common", "callBatch <call> class : " + paramString.getClass().getName() + " , method : " + str1 + "\n , args : " + localObject.toString());
                  ...
                  {
                    bdii.c("Common", "callBatch error", paramWebView);
                  }
                  paramWebView = paramWebView;
                  bdii.b("Common", "callBatch decode params format err", paramWebView);
        ...
        {
          bdii.e("Common", "callBatch args error : " + paramWebView.toString());
        }
      }
      catch (JSONException paramWebView)
      {
        bdii.b("Common", "callBatch request params format err", paramWebView);
        continue;
        j += 1;
        continue;
        ...
        else if ((paramString instanceof Boolean))
        {
          ...
          localJSONObject.put("data", localJSONArray1);
          bdii.c("Common", "Response<callBatch> syncCallBatch result : " + localJSONObject);
        }
        else
        {
          paramWebView = "";
  ...
  public static void a()
  {
    try
    {
      bdii.b("Common", "<initSystemFolder> begin to init system file... ");
  ...
  {
    SharedPreferences.Editor localEditor = bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    bdii.c("Common", "setResourceMD5=" + paramString);
    SharedPreferences.Editor localEditor = bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  public static long[] a()
  {
    SharedPreferences localSharedPreferences = bcyb.a().a().getSharedPreferences("qzoneappcenter", 4);
  ...
  public static String[] a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      bdii.c("Common", "url params= " + str2 + " " + paramString);
  ...
  {
    bdii.c("Common", "setLastResourceZipMd5=" + paramString);
    SharedPreferences.Editor localEditor = bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    return bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).getBoolean("appstoreclearcache", false);
  }
  ...
  {
    String str = q();
    bdii.b("Common", "<getSDResDir> getSDResDir=" + str);
    if (TextUtils.isEmpty(str)) {
      return "";
    }
  ...
  {
    return bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).getString("relastmd5", "");
  }
  
  public static String o()
  {
    return bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).getString("lastresourcezipmd5", "");
  }
  
  public static String p()
  {
    return bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).getString("appstoreagentversion", "");
  }
  
  public static String q()
  {
    return bcyb.a().a().getSharedPreferences("qzoneappcenter", 4).getString("sdhtmldir", "");
  }
  ...
  public static String r()
  {
    ...
    {
      bdii.c("Common", "exception happened!");
      return "";
    }
    return "";
  }
