...
public class ooh
{
  ...
  public static Pair<List<GiftServiceBean>, List<GiftServiceBean>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = nlw.a(BaseApplicationImpl.getContext(), paramString, "GET", null, (Bundle)localObject1);
        if (paramString != null)
        {
  ...
  public static Pair<Boolean, String> a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    paramString1 = pha.a();
    paramString1 = ((TicketManager)((QQAppInterface)pha.a()).getManager(2)).getSkey(paramString1);
    ...
    for (paramString1 = "";; paramString1 = a(paramString1))
    {
      ...
      try
      {
        paramString1 = nlw.a(BaseApplicationImpl.getContext(), localStringBuilder.toString(), "GET", null, paramString1);
        if (paramString1 == null) {
          break;
        }
        bool2 = bool5;
        ...
        if (paramString1 != null)
        {
          ...
          while (i < paramString1.length())
          {
            ...
            if ((!TextUtils.isEmpty(paramString3.ck)) && (TextUtils.isEmpty(paramString3.t))) {
              paramString3.t = anni.a(2131704058);
            }
  ...
  public static JSONObject a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localJSONObject.put("net_type", String.valueOf(nve.a()));
    localJSONObject.put("plat_id", 1);
    localJSONObject.put("imei", opp.a());
    if (!TextUtils.isEmpty(pha.a())) {
      localJSONObject.put("uin", Long.valueOf(pha.a()));
    }
