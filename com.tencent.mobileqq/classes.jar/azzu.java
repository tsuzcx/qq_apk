  ...
  extends blgm
{
  ...
  public static Animation a(Animation.AnimationListener paramAnimationListener, float paramFloat1, float paramFloat2)
  {
    ...
    localAnimationSet.setInterpolator(new azzv());
    return localAnimationSet;
  }
  
  public void a(QQAppInterface paramQQAppInterface, HeartLayout paramHeartLayout, Bitmap paramBitmap, azzz paramazzz, int paramInt1, boolean paramBoolean, int paramInt2, float paramFloat1, float paramFloat2)
  {
    if (bdgb.b())
    {
    ...
    do
    {
      ...
      {
        localPraiseManager.a(paramazzz);
      ...
      paramazzz = localPraiseManager.a(paramInt1, paramBoolean, "from_nearby_people");
      if (paramazzz != null)
      {
        if ((paramInt2 == 2) && (paramazzz.c != null))
        {
          if (this.jdField_a_of_type_Avsz != null)
          {
            paramHeartLayout.a(paramazzz, paramazzz.c, paramQQAppInterface, this.jdField_a_of_type_Avsz.a(paramInt2, paramHeartLayout.a), paramFloat1 - bhgr.a(paramHeartLayout.getContext(), 20.0F), paramFloat2 - bhgr.a(paramHeartLayout.getContext(), 120.0F), bhgr.a(paramHeartLayout.getContext(), 75.0F), bhgr.a(paramHeartLayout.getContext(), 65.0F));
            return;
          }
          paramHeartLayout.a(paramazzz, paramazzz.c, paramFloat1, paramFloat2);
          return;
        }
        paramHeartLayout.a(paramazzz, paramazzz.b, paramFloat1, paramFloat2);
        return;
      }
    } while (paramBoolean);
    paramHeartLayout.a(paramBitmap, paramFloat1, paramFloat2);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, Drawable paramDrawable, Resources paramResources)
  {
    ...
    if (paramBoolean2) {
      localDrawable1 = nnw.a(localDrawable2, paramResources.getColor(2131165710));
    }
    while (this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable == null)
    {
      ...
      if (paramBoolean1) {
        localDrawable1 = nnw.a(localDrawable2, paramResources.getColor(2131165713));
      }
    }
  ...
  public void onAnimationRepeat(Animation paramAnimation)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int / 2 >= azzw.jdField_a_of_type_Int)
      {
