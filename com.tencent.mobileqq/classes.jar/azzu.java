...
public class azzu
{
  public static void a(BaseActivity paramBaseActivity)
  {
    ...
    azzv.a.a(paramBaseActivity, true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, azzl paramazzl)
  {
    boolean bool = false;
    if (QLog.isColorLevel()) {
      QLog.d("AnonymousViewHelper", 0, "before onClickLike() question.mPraised = " + paramazzl.b);
    }
    paramQQAppInterface = (azzn)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.ANONYMOUS_ANSWER_HANDLER);
    if (!paramazzl.b) {
      bool = true;
    }
    paramQQAppInterface.a(paramazzl, bool);
  }
