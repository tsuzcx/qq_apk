  ...
  extends Handler
{
  ...
  public aekw(MusicPlayerActivity paramMusicPlayerActivity)
  {
  ...
  private void a(int[] paramArrayOfInt, boolean paramBoolean)
  {
    ...
    if ((paramArrayOfInt != null) && (paramArrayOfInt.length >= 2) && (localMusicPlayerActivity != null))
    {
      ...
      ((ImageView)localMusicPlayerActivity.findViewById(2131365185)).setImageDrawable(localGradientDrawable);
      localMusicPlayerActivity.findViewById(2131365188).setBackgroundColor(i);
      i = paramArrayOfInt[1];
      ...
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130839768, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130839769, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130839051, i);
      if (paramBoolean)
      {
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130839451, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130839453, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130839452, i);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  if ((paramMessage instanceof Integer))
                  {
                    ...
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130839768, j);
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130839769, j);
                  }
                  if ((i == 3) || (i == 4)) {
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130839769);
                  }
                  for (;;)
                  {
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
                    return;
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130839768);
                  }
                } while (!(paramMessage.obj instanceof aeky));
                localObject2 = (aeky)paramMessage.obj;
                ...
                if (MusicPlayerActivity.a((MusicPlayerActivity)localObject1).isSelected()) {
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130839452);
                }
                for (;;)
                {
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setVisibility(i);
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setImageResource(2130839451);
                  ...
                  return;
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130839453);
                }
              ...
              for (;;)
              {
                ...
                paramMessage = (URLImageView)((MusicPlayerActivity)localObject1).findViewById(2131365184);
              ...
              for (;;)
              {
                ...
                MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(2131438482);
                return;
                localObject3 = new aekx((MusicPlayerActivity)localObject1, bool1, (String)localObject3);
                if (localURLDrawable.getStatus() == 1)
                {
                  localObject4 = localURLDrawable.getCurrDrawable();
                  if ((localObject4 instanceof RegionDrawable)) {
                    ((aekx)localObject3).run(null, ((RegionDrawable)localObject4).getBitmap());
                  }
                }
                else
                {
              ...
              MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(((MusicPlayerActivity)localObject1).getString(2131438481, new Object[] { paramMessage }));
              return;
              MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
              return;
      ...
      } while (!(localObject1 instanceof aeky));
    ...
    WXShareHelper.a().a(String.valueOf(l), ((aeky)localObject1).a, (Bitmap)localObject2, ((aeky)localObject1).b, ((aeky)localObject1).d, i, ((aeky)localObject1).e);
  }
}
