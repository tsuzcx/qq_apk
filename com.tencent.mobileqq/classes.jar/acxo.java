  ...
  extends RelativeLayout
{
  ...
  public acxo(PanelAdapter paramPanelAdapter, Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    int k = paramPanelAdapter.a();
    int m = paramPanelAdapter.b();
    int i = actn.a(15.0F, getContext().getResources());
    ...
    while (i < m)
    {
      ...
      localLayoutParams.leftMargin = actn.a(20.0F, getContext().getResources());
      localLayoutParams.rightMargin = actn.a(20.0F, getContext().getResources());
      ...
      while (j < k)
      {
        ...
        localObject = new acxp();
        ((acxp)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367800));
        ((acxp)localObject).jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch = new RedTouch(paramContext, ((acxp)localObject).jdField_a_of_type_AndroidWidgetImageView).a(8388661).a();
        ((acxp)localObject).b = ((ImageView)localView.findViewById(2131366359));
        ((acxp)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131377044));
  ...
  public void a()
  {
    ...
    while (i < getChildCount())
    {
      ...
      if (localObject != null)
      {
        localObject = (acxp)((View)localObject).getTag();
        if ((localObject != null) && (((acxp)localObject).jdField_a_of_type_AndroidWidgetImageView != null)) {
          ((acxp)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
        }
      }
      i += 1;
    }
  ...
  protected void a(Context paramContext)
  {
    ...
    {
      int i = actn.a(18.0F, getContext().getResources());
      int j = actn.a(18.0F, getContext().getResources());
