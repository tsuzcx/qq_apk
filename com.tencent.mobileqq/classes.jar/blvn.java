...
public class blvn
{
  private static WeakReference<blvo> a;
  ...
  public static void a()
  {
    ...
    {
      return;
      localblvo = (blvo)jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localblvo == null);
    localblvo.onPreloadEnd();
  }
  ...
  public static void a(blvo paramblvo)
  {
    if (paramblvo == null) {
      jdField_a_of_type_JavaLangRefWeakReference = null;
    }
    jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramblvo);
  }
  ...
  {
    Object localObject = blux.a();
    if ((localObject == null) || (((bluw)localObject).a == null) || (((bluw)localObject).a.size() == 0))
    {
      QLog.e("IlivePreloadHelper", 1, "isManagerConfigEnable IliveManagerCfnBean has not data , currentVersion = " + Build.VERSION.SDK_INT);
      return true;
    }
    localObject = ((bluw)localObject).a.iterator();
