...
public class qao
  extends pxl
{
  public qao(Context paramContext, bcws parambcws, rqj paramrqj)
  {
  ...
  public pxl d()
  {
    ...
    if ((this.jdField_a_of_type_Pxk != null) && ((this.jdField_a_of_type_Pxk instanceof ComponentContentThree))) {
      localLinearLayout.addView((ComponentContentThree)this.jdField_a_of_type_Pxk);
    }
  ...
  public pxl g()
  {
    this.jdField_a_of_type_Pxk = new ComponentContentThree(this.jdField_a_of_type_AndroidContentContext);
    return this;
  }
}
