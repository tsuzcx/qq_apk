...
public class aatq
  extends MqqHandler
{
  public aatq(ChatSettingActivity paramChatSettingActivity) {}
        ...
        do
        {
          do
          {
            ...
            if ((ChatSettingActivity.a(this.a) != 1001) && (ChatSettingActivity.a(this.a) != 10002)) {
              ...
              {
                paramMessage = (aser)this.a.app.getManager(16);
            ...
            for (;;)
            {
              ...
              return;
              paramMessage = bbcl.e(this.a.app, ChatSettingActivity.c(this.a));
              ...
              bool1 = false;
              break label308;
              paramMessage = (ajxn)this.a.app.getManager(51);
              if (paramMessage != null)
              {
