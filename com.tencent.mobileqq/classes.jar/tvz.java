...
public class tvz
{
  ...
  private aoeg jdField_a_of_type_Aoeg = new twb(this);
  public QQAppInterface a;
  HorizontalListView jdField_a_of_type_ComTencentWidgetHorizontalListView;
  public WeakReference<Activity> a;
  private tvm jdField_a_of_type_Tvm = new twa(this);
  tvn jdField_a_of_type_Tvn;
  tvs jdField_a_of_type_Tvs;
  public boolean a;
  int b = 0;
  int c = 0;
  private int d;
  
  public tvz(Activity paramActivity, QQAppInterface paramQQAppInterface, tvn paramtvn)
  {
    ...
    this.d = ((int)paramActivity.getResources().getDimension(2131297929));
    i();
  ...
  private void i()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Tvm);
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Tvm);
    }
  }
  ...
  private void k()
  {
    ...
    localAnimation.setAnimationListener(new twg(this));
    a(0);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewStub == null) {
      if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
      {
        this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131377106));
        if (this.jdField_a_of_type_AndroidViewViewStub != null)
        {
          this.jdField_a_of_type_AndroidViewViewStub.setOnInflateListener(new twc(this));
  ...
  void a(int paramInt)
  {
    ...
    {
      return;
      localView = ((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131370012);
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      ((tvl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(64)).a(paramString);
    }
  }
  
  void a(List<tvr> paramList)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_JavaLangRefWeakReference.get() == null)) {
      return;
    }
    if (this.jdField_a_of_type_Tvs == null) {
      this.jdField_a_of_type_Tvs = new tvs((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Tvn);
    }
    this.jdField_a_of_type_Tvs.a();
    this.jdField_a_of_type_Tvs.a(paramList);
  }
  ...
  public boolean a()
  {
    ...
    View localView = localActivity.findViewById(2131366029);
    ...
    int k = (int)localActivity.getResources().getDimension(2131299011);
    int m = (int)localActivity.getResources().getDimension(2131299017);
    int n = this.d;
  ...
  public void b()
  {
    ...
    if (bool)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new twd(this));
      Object localObject2 = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378212);
      ...
      localObject2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378936);
      if (!bool) {
        break label270;
      }
      i = ((Resources)localObject1).getColor(2131166060);
      label126:
      ((TextView)localObject2).setTextColor(i);
      if (this.jdField_a_of_type_ComTencentWidgetHorizontalListView == null)
      {
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377101));
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setDividerWidth((int)((Resources)localObject1).getDimension(2131297930));
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Tvs);
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131364584));
    ...
    label270:
    label281:
    for (int i = 2130843186;; i = 2130843188)
    {
      ((ImageButton)localObject1).setImageResource(i);
      this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new twe(this));
      return;
      i = 2131166061;
      break;
      i = 2131166349;
  ...
  public void c()
  {
    ...
    int i = bhgr.a((Context)localObject, 100.0F);
    Object localObject = (ImageView)((Activity)localObject).findViewById(2131373142);
  ...
  void e()
  {
    ...
    localAnimation.setFillAfter(true);
    localAnimation.setAnimationListener(new twf(this));
  ...
  {
    if (this.jdField_a_of_type_Tvs != null) {
      this.jdField_a_of_type_Tvs.notifyDataSetChanged();
    }
