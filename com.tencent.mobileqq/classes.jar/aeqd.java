  ...
  implements Manager
{
  ...
  private aeqy jdField_b_of_type_Aeqy;
  ...
  public aeqd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new BlessManager.1(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface = ajed.aU + jdField_a_of_type_JavaLangString;
  ...
  private void a(akeu paramakeu)
  {
    RecentUser localRecentUser = paramakeu.a(ajed.at, 9003);
    long l = NetConnInfoCenter.getServerTime();
    localRecentUser.uin = ajed.at;
  ...
  private void a(akeu paramakeu, RecentUser paramRecentUser)
  {
    paramakeu.b(paramRecentUser);
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
      ...
      for (;;)
      {
        if (m < arrayOfString.length) {
          ...
          else
          {
            ...
            {
              localObject = bcdu.b(arrayOfString[m]);
              j = 1;
  ...
  private void a(BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    for (;;)
    {
      ...
      {
        localatmr.a();
        localatmp.a(BlessTask.class);
        if (paramBlessTask != null) {
          localatmp.b(paramBlessTask);
        }
        localatmp.a(BlessPtvModule.class);
        if (paramArrayList != null)
        {
          paramBlessTask = paramArrayList.iterator();
          if (paramBlessTask.hasNext())
          {
            localatmp.b((BlessPtvModule)paramBlessTask.next());
            continue;
          }
        }
      }
      catch (Exception paramBlessTask)
      {
        ...
        localatmr.b();
        return;
        localatmp.a(BlessWording.class);
        if (paramArrayList1 != null)
        {
          paramBlessTask = paramArrayList1.iterator();
          if (paramBlessTask.hasNext())
          {
            localatmp.b((BlessWording)paramBlessTask.next());
            continue;
          }
        }
      }
  ...
  private void a(String paramString, BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    aeqy.a((SharedPreferences)localObject1, this.jdField_a_of_type_Aeqy, 1);
  ...
  {
    if (badq.a(BaseApplicationImpl.getApplication()) == 0) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localbatm = (batm)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
      if (localbatm == null) {
        break label147;
      }
    ...
    localbatr.a(localbatm, new aeqe(this, paramString2, paramString1), null);
  }
  ...
  private void a(ArrayList<BlessPtvModule> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bace.a(this.jdField_b_of_type_JavaLangString + str1);
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          if ((befo.d()) && (!new File((String)localObject1).exists()))
          {
            k();
            if (QLog.isColorLevel()) {
  ...
  private void d(boolean paramBoolean)
  {
    ...
    RecentUser localRecentUser = localakeu.b(ajed.at, 9003);
    int i;
    label78:
    Object localObject;
  ...
  private void h()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    this.jdField_a_of_type_Aeqy = aeqy.a((SharedPreferences)localObject1, 1);
    this.jdField_b_of_type_Aeqy = aeqy.a((SharedPreferences)localObject1, 2);
    Object localObject3 = baih.a((SharedPreferences)localObject1, "bless_uin_to_send", null);
    if (localObject3 != null)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (this.jdField_b_of_type_Aeqy != null) {
          break label212;
        }
      }
    }
    ...
    label198:
    label212:
    for (localObject1 = localObject2;; localObject1 = Integer.valueOf(this.jdField_b_of_type_Aeqy.a()))
    {
      ...
      break label112;
      localObject1 = Integer.valueOf(this.jdField_a_of_type_Aeqy.a());
      break label133;
    }
  }
  ...
  private void i()
  {
    ...
    Object localObject2 = (ArrayList)((atmp)localObject1).a(BlessTask.class, new BlessTask().getTableName(), false, null, null, null, null, null, null);
    if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask = ((BlessTask)((ArrayList)localObject2).get(0));
    }
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)((atmp)localObject1).a(BlessPtvModule.class, new BlessPtvModule().getTableName(), false, null, null, null, null, null, null));
    this.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)((atmp)localObject1).a(BlessWording.class, new BlessWording().getTableName(), false, null, null, null, null, null, null));
    ((atmp)localObject1).a();
    if (QLog.isColorLevel())
    {
  ...
  private void k()
  {
    if ((befo.d()) && (!this.jdField_a_of_type_Boolean)) {
  ...
  public aaep a(int paramInt1, int paramInt2)
  {
    aaep localaaep = new aaep();
    localaaep.jdField_a_of_type_Int = 0;
    if (paramInt1 == 2) {
      localaaep.jdField_b_of_type_Int = 1;
    }
    for (;;)
    {
      localaaep.jdField_b_of_type_Long = paramInt2;
      return localaaep;
      if (paramInt1 == 3) {
        localaaep.jdField_b_of_type_Int = 4;
      } else {
        localaaep.jdField_b_of_type_Int = 0;
      }
    }
  }
  ...
  public Drawable a()
  {
    Object localObject2 = BaseApplication.getContext().getResources().getDrawable(2130838538);
    boolean bool = awnu.a();
    Object localObject3;
    Object localObject1;
    int i;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.recentHeadImgUrl != null))
    {
      if ((this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) || (this.jdField_d_of_type_Boolean != bool))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          i = aciy.a(50.0F, BaseApplication.getContext().getResources());
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    return paramString1 + baaw.encodeToString(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentNickname().getBytes(), 2);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    acgk.a(paramContext, localIntent, str);
  }
  ...
  public void a(ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        this.jdField_a_of_type_Aeqy.a(str);
      }
      aeqy.a(localSharedPreferences, this.jdField_a_of_type_Aeqy, 1);
    }
    while (paramInt != 2) {
      return;
    }
    ...
    {
      str = (String)paramArrayList.next();
      this.jdField_b_of_type_Aeqy.a(str);
    }
    aeqy.a(localSharedPreferences, this.jdField_b_of_type_Aeqy, 2);
  }
  ...
  public void a(List<String> paramList)
  {
    ...
    baih.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", paramList.toArray()).commit();
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(ajed.at, 9003) != null;
  }
  
  public boolean a(String paramString)
  {
    this.jdField_a_of_type_Aeqy.a();
    return this.jdField_a_of_type_Aeqy.a(paramString);
  }
  ...
  {
    this.jdField_c_of_type_JavaUtilArrayList.clear();
    baih.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", new String[0]).commit();
  }
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        while ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.unread != -1) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed))
        {
          ...
          {
            localatmr.a();
            localatmp.a(this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask);
            localatmr.c();
          }
  ...
  {
    this.jdField_b_of_type_Aeqy.a();
    return this.jdField_b_of_type_Aeqy.a(paramString);
  }
  ...
  {
    this.jdField_a_of_type_Aeqy.a();
    return c() - this.jdField_a_of_type_Aeqy.a();
  }
  ...
  public int f()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_a_of_type_Aeqy.b();
    }
    return i;
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask == null) {}
    while ((!befo.d()) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed) || (!d()) || (!i())) {
      return false;
    }
    return true;
  }
  ...
  {
    this.jdField_b_of_type_Aeqy.a();
    return i() - this.jdField_b_of_type_Aeqy.a();
  }
  ...
  public int k()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_b_of_type_Aeqy.b();
    }
    return i;
  }
  ...
  {
    Object localObject = (bato)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47);
    if (localObject != null)
    {
      localObject = ((bato)localObject).a(1);
      if (localObject != null) {
        ((batr)localObject).a(true, null);
      }
    }
    ThreadManager.getSubThreadHandler().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
  }
