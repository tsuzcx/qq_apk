  ...
  implements awcr
{
  ...
  public aeqd(NewAuthDevUgFragment paramNewAuthDevUgFragment)
  {
  ...
  public void a(int paramInt, Exception paramException)
  {
    ...
    {
      awcu.a(NewAuthDevUgFragment.a(localNewAuthDevUgFragment), paramException, 3, NewAuthDevUgFragment.b(localNewAuthDevUgFragment));
      return;
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1 = ptj.a();
        if ((!bgnt.h(localNewAuthDevUgFragment.getActivity())) && (paramString1 != null)) {
        ...
        int i = asfr.a().a(NewAuthDevUgFragment.a(localNewAuthDevUgFragment).getAppInterface(), NewAuthDevUgFragment.a(localNewAuthDevUgFragment), paramString1);
        if (i != 0)
        {
