...
public class aeqd
{
  private static volatile aeqd jdField_a_of_type_Aeqd;
  ...
  {
    if (jdField_a_of_type_Aeqd == null) {}
    try
    {
      if (jdField_a_of_type_Aeqd == null) {
        jdField_a_of_type_Aeqd = new aeqd();
      }
      return jdField_a_of_type_Aeqd;
    }
    finally {}
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage, int paramInt1, int paramInt2, aeqf paramaeqf)
  {
    int j = -1;
    int i;
    if (paramInt1 == 0)
    {
      ...
      azmj.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_stack_rec", 0, 0, String.valueOf(i), String.valueOf(paramaeqf.jdField_a_of_type_Int), "", "");
    }
    label100:
    while (paramInt2 != 3)
    {
      ...
      i = 2;
      break;
      azmj.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_stack_launch", 0, 0, String.valueOf(i), String.valueOf(paramaeqf.jdField_a_of_type_Int), "", "");
      return;
    }
    label134:
    if (!paramChatMessage.isSendFromLocal())
    {
      azmj.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_jump_rec", 0, 0, String.valueOf(i), String.valueOf(paramaeqf.jdField_a_of_type_Int), "", "");
      return;
    }
    azmj.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Egg_jump_launch", 0, 0, String.valueOf(i), String.valueOf(paramaeqf.jdField_a_of_type_Int), "", "");
  }
  
  private void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage, aeqf paramaeqf)
  {
    boolean bool = false;
    ...
    if ((paramChatMessage.isSendFromLocal()) && (this.jdField_b_of_type_Boolean) && (paramChatMessage.shmsgseq == this.jdField_b_of_type_Long + 1L)) {
      azmj.b(paramQQAppInterface, "CliOper", "", "", "Supr-Eggs", "Eggs_stack_new", 0, 0, String.valueOf(0), String.valueOf(paramaeqf.jdField_a_of_type_Int), "", "");
    }
    if (!paramChatMessage.isSendFromLocal()) {
      bool = true;
    }
  ...
  public String a(AbsShareMsg paramAbsShareMsg)
  {
    if ((paramAbsShareMsg != null) && (paramAbsShareMsg.getItemCount() > 0))
    {
      ...
      {
        Object localObject = (azqj)paramAbsShareMsg.next();
        if ((localObject instanceof azqk))
        {
          localObject = ((azqk)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject).hasNext())
          {
            azqj localazqj = (azqj)((Iterator)localObject).next();
            String str = localazqj.jdField_a_of_type_JavaLangString;
            if ("title".equals(str)) {
              localStringBuilder.append(((StructMsgItemTitle)localazqj).b());
            } else if ("summary".equals(str)) {
              localStringBuilder.append(((azvd)localazqj).b());
            }
          }
        }
      }
  ...
  public ArrayList<aeqf> a(ChatMessage paramChatMessage)
  {
    aeqf localaeqf = null;
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        paramChatMessage = localaeqf;
        localObject1 = paramChatMessage;
        if (localIterator.hasNext())
        {
          localaeqf = (aeqf)localIterator.next();
          if (localaeqf.jdField_a_of_type_JavaUtilArrayList == null) {
            break label401;
          }
          localObject1 = localaeqf.jdField_a_of_type_JavaUtilArrayList.iterator();
          for (;;)
          {
            ...
            {
              if (localaeqf.jdField_a_of_type_Aeqg == null) {
                break;
              }
              l2 = System.currentTimeMillis() / 1000L;
              if ((localaeqf.jdField_a_of_type_Aeqg.jdField_a_of_type_Int != 1) || ((localaeqf.jdField_a_of_type_Aeqg.jdField_b_of_type_Int <= l2) && (localaeqf.jdField_a_of_type_Aeqg.c >= l2))) {
                break;
              }
              if (QLog.isColorLevel()) {
          ...
          label292:
          paramChatMessage.add(localaeqf);
          localObject1 = paramChatMessage;
          if (QLog.isColorLevel()) {
            QLog.d("AioAnimationDetector", 2, "matched ===> rule: id=" + localaeqf.jdField_a_of_type_Int);
          }
        }
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, MessageRecord paramMessageRecord, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    ...
    for (;;)
    {
      ...
      if ((!(paramMessageRecord instanceof MessageForArkFlashChat)) && (!this.jdField_a_of_type_Boolean))
      {
        ...
        if ((paramSessionInfo.jdField_a_of_type_Int == 1008) || (abot.a(paramSessionInfo.jdField_a_of_type_Int) == 1032)) {
          break;
        }
        int j = 0;
        int i;
        ...
        {
          label109:
          if (((i == 0) && (j == 0)) || (!paramSessionInfo.jdField_a_of_type_JavaLangString.equals(paramMessageRecord.frienduin)) || ((paramSessionInfo.jdField_a_of_type_Int != paramMessageRecord.istroop) && ((j == 0) || (!abot.d(paramMessageRecord.istroop))))) {
            break label468;
          }
          ...
          aeqd localaeqd = a();
          long l = localaeqd.jdField_a_of_type_Long;
          ...
          if (j >= 0)
          {
            ...
            if (!localChatMessage.isAioAnimChecked)
            {
              ...
              localArrayList = localaeqd.a(localChatMessage);
              if (localArrayList != null) {
                localaeqd.a(paramQQAppInterface, localArrayList, true, localChatMessage, true, paramAIOAnimationConatiner, 0, paramSessionInfo.b, paramBaseChatPie);
              }
              localaeqd.jdField_a_of_type_Long = localChatMessage.shmsgseq;
            }
          }
          for (;;)
          {
            ...
            if (!localChatMessage.isAioAnimChecked)
            {
              ...
              localArrayList = localaeqd.a(localChatMessage);
              if (localArrayList != null) {
                localaeqd.a(paramQQAppInterface, localArrayList, false, localChatMessage, true, paramAIOAnimationConatiner, 0, paramSessionInfo.b, paramBaseChatPie);
              }
              localaeqd.jdField_a_of_type_Long = localChatMessage.time;
            }
          }
          i = 0;
        }
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<aeqf> paramArrayList, boolean paramBoolean1, ChatMessage paramChatMessage, boolean paramBoolean2, AIOAnimationConatiner paramAIOAnimationConatiner, int paramInt, String paramString, BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        else
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            j = localaeqf.jdField_b_of_type_Int;
            m = localaeqf.c;
            if (QLog.isColorLevel()) {
              QLog.d("AioAnimationDetector", 2, "detect : troopOrDiscussion=" + paramBoolean1 + " matched (" + paramChatMessage.uniseq + "), rule: id=" + localaeqf.jdField_a_of_type_Int + ",M=" + i + ",X=" + j + ",Y=" + m + ",crazyMode=" + localaeqf.jdField_a_of_type_Boolean);
            }
            if (paramBoolean1) {
              break label499;
            }
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.d("AioAnimationDetector", 2, "detect c2c =======>  egg_jumper animation, crazyModeEnable=" + localaeqf.jdField_a_of_type_Boolean);
              }
              a(paramQQAppInterface, paramChatMessage, 0, 3, localaeqf);
              if ((paramChatMessage instanceof MessageForStructing)) {
                a(paramQQAppInterface, paramChatMessage, 0);
              }
              if (localaeqf.jdField_a_of_type_Boolean)
              {
                j = localaeqf.jdField_b_of_type_JavaUtilArrayList.size();
                i = 0;
                while (i < j)
                {
                  paramArrayList = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(i);
                  paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), paramArrayList);
                  k = i * 800;
                  this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.2(this, paramAIOAnimationConatiner, paramArrayList, k, localaeqf), paramInt + k);
                  i += 1;
                }
              }
              paramArrayList = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(0);
              paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), paramArrayList);
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.3(this, paramAIOAnimationConatiner, paramArrayList, localaeqf), paramInt);
              if ((localaeqf.jdField_a_of_type_Aeqg == null) || (localaeqf.jdField_a_of_type_Aeqg.jdField_a_of_type_Int != 1) || (localntw == null)) {
                break label1736;
              }
              localntw.jdField_b_of_type_Int = localaeqf.jdField_a_of_type_Aeqg.d;
              localntw.c = localaeqf.jdField_a_of_type_Aeqg.e;
            }
          }
        }
      }
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AioAnimationDetector", 2, "detect =======>  egg_jumper animation ,crazyModeEnable=" + localaeqf.jdField_a_of_type_Boolean);
      }
      a(paramQQAppInterface, paramChatMessage, 1, 3, localaeqf);
      if ((paramChatMessage instanceof MessageForStructing)) {
      ...
      n = localaeqf.jdField_b_of_type_JavaUtilArrayList.size();
      i = 0;
      if (i >= n) {
        break;
      }
      localaeqh = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(i);
      if (localaeqh.jdField_b_of_type_Int != 3) {
        break label881;
      }
    ...
    int j = m;
    String str;
    if (k < localaeqf.jdField_a_of_type_JavaUtilArrayList.size())
    {
      if (((String)localaeqf.jdField_a_of_type_JavaUtilArrayList.get(k)).equals(paramChatMessage.msg)) {
        j = 1;
      }
    }
    else if (j != 0)
    ...
    for (paramArrayList = paramArrayList.b(paramString);; paramArrayList = null)
    {
      ...
      azmj.b(paramQQAppInterface, "dc00898", "", paramQQAppInterface.getCurrentAccountUin(), "0X800AE16", "0X800AE16", localaeqf.jdField_a_of_type_Int, 0, paramString, str, "", "");
      boolean bool = nav.a().a(paramString);
      paramArrayList = (aerk)aogj.a().a(609);
      if ((paramArrayList != null) && (paramArrayList.a(paramString))) {}
      for (k = 1;; k = 0)
      {
        if ((k != 0) && (j != 0) && (!bool)) {
          ((bcbt)paramQQAppInterface.getManager(346)).a(paramString, paramChatMessage.senderuin, new aeqe(this, paramQQAppInterface, paramString, localaeqf, localaeqh, paramBaseChatPie, paramInt));
        }
        for (;;)
        {
          i += 1;
          ...
          break label635;
          label881:
          paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), localaeqh);
          j = i * 800;
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.5(this, paramAIOAnimationConatiner, paramArrayList, j, localaeqf), paramInt + j);
        }
        paramArrayList = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(0);
        paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), paramArrayList);
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.6(this, paramAIOAnimationConatiner, paramArrayList, localaeqf), paramInt);
        break label445;
        if (j >= m) {
          break label445;
        }
        ...
        if (i == m)
        {
          ...
          if (paramBoolean2)
          {
            a(paramQQAppInterface, paramChatMessage, 1, 2, localaeqf);
            a(paramQQAppInterface, paramChatMessage, localaeqf);
          ...
          if (QLog.isColorLevel()) {
            QLog.d("AioAnimationDetector", 2, "detect (M == Y) =======>  egg_jumper animation ,Y=" + m + ",crazyModeEnable=" + localaeqf.jdField_a_of_type_Boolean);
          }
          a(paramQQAppInterface, paramChatMessage, 1, 3, localaeqf);
          i = 0;
          label1147:
        ...
        for (j = 1000;; j = 0)
        {
          if (localaeqf.jdField_a_of_type_Boolean)
          {
            ...
            while (k < n)
            {
              paramArrayList = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(k);
              paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), paramArrayList);
              int i1 = (k + i) * 800;
              this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.8(this, paramAIOAnimationConatiner, paramArrayList, i1, localaeqf), paramInt + j + i1);
              k += 1;
            }
          }
          paramArrayList = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(0);
          paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), paramArrayList);
          k = i * 800;
          this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.9(this, paramAIOAnimationConatiner, paramArrayList, k, localaeqf), paramInt + j + k);
          i += 1;
          break label1147;
          break label445;
          if (i > m)
          ...
          for (i = 1000;; i = 0)
          {
            if (localaeqf.jdField_a_of_type_Boolean)
            {
              k = localaeqf.jdField_b_of_type_JavaUtilArrayList.size();
              j = 0;
              while (j < k)
              {
                paramArrayList = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(j);
                paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), paramArrayList);
                m = j * 800;
                this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.11(this, paramAIOAnimationConatiner, paramArrayList, m, localaeqf), paramInt + i + m);
                j += 1;
              }
              break label445;
            }
            paramArrayList = (aeqh)localaeqf.jdField_b_of_type_JavaUtilArrayList.get(0);
            paramArrayList = aeqh.a(paramQQAppInterface.getApplication(), paramArrayList);
            this.jdField_a_of_type_AndroidOsHandler.postDelayed(new AioAnimationDetector.12(this, paramAIOAnimationConatiner, paramArrayList, localaeqf), paramInt + i);
            break label445;
            if (QLog.isColorLevel()) {
