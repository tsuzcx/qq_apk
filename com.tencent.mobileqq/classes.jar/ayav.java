  ...
  implements Manager
{
  ...
  public ayav(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = this.jdField_a_of_type_Aukn.a(SubAccountInfo.class);
        ...
        if (localObject != null)
        {
          ...
          if (i2 != 0)
          {
            ...
            if ((((SubAccountMessage)localObject).mEmoRecentMsg == null) && (((SubAccountMessage)localObject).msg != null)) {
              ((SubAccountMessage)localObject).mEmoRecentMsg = new ayki(((SubAccountMessage)localObject).msg, 3, 16);
            }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukn.a(SubAccountMessage.class, SubAccountMessage.class.getSimpleName(), false, "subUin=?", new String[] { str }, null, null, "time desc", null);
            ...
            if ((paramString1.equals(localSubAccountMessage.subUin)) && (paramString2.equals(localSubAccountMessage.senderuin)))
            {
              ...
              if (localIterator.hasNext())
              {
                ...
                if (localSubAccountMessage != null) {
                  this.jdField_a_of_type_Aukn.b(localSubAccountMessage);
                }
                if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aukn.a(SubAccountMessage.class.getSimpleName());
  }
  ...
  public void a(ayaw paramayaw)
  {
    ...
    {
      if ((paramayaw != null) && (paramayaw.jdField_b_of_type_JavaLangString != null) && (paramayaw.c())) {
        break label183;
      }
      if (QLog.isColorLevel())
      {
    ...
    label143:
    for (paramayaw = "data == null";; paramayaw = "data.mMainAccount=" + paramayaw.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramayaw.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, paramayaw);
      return;
      localObject1 = "data.mMainAccount=" + paramayaw.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramayaw.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ArrayList localArrayList2 = paramayaw.a();
    Object localObject1 = paramayaw.c();
    ArrayList localArrayList3 = paramayaw.b();
    if (QLog.isColorLevel())
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!paramayaw.jdField_b_of_type_JavaLangString.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
          ...
          ((SubAccountInfo)localObject2).trunkuin = paramayaw.jdField_b_of_type_JavaLangString;
          ((SubAccountInfo)localObject2).serverErrorType = paramayaw.jdField_b_of_type_Int;
          ((SubAccountInfo)localObject2).serverErrorMsg = paramayaw.jdField_a_of_type_JavaLangString;
      ...
      {
        paramayaw = localArrayList3.iterator();
        while (paramayaw.hasNext()) {
          a((String)paramayaw.next());
        }
      }
      label575:
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      ...
      paramayaw = localArrayList1.iterator();
      while (paramayaw.hasNext()) {
        a((SubAccountInfo)paramayaw.next());
      }
      break;
      label629:
      localObject1 = null;
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          ayao.a(paramQQAppInterface, paramString1, 6);
          paramQQAppInterface.a().c(paramString1, 7000, -i);
          paramQQAppInterface.a().a(new String[] { ajsf.x, paramString1 });
          paramQQAppInterface.D();
          paramString2 = new ayaw();
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      boolean bool = this.jdField_a_of_type_Aukn.a((String)localObject1, (ContentValues)localObject2, "subUin=?", new String[] { paramString });
      if (!QLog.isColorLevel()) {
        break;
      }
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 != null) && (((ArrayList)localObject2).size() != 0))
            {
              ...
              if (((Iterator)localObject2).hasNext())
              {
                ...
                localSubAccountMessage.mTimeString = bbkb.a(localSubAccountMessage.time * 1000L, true, paramString);
                if (i == 0) {
                  break label332;
                }
                i = 0;
  ...
  public void g(String paramString)
  {
    ...
    boolean bool = this.jdField_a_of_type_Aukn.a(str, localContentValues, null, null);
    if (QLog.isColorLevel()) {
