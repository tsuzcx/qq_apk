  ...
  extends ImageSpan
{
  ...
  public asbj(Context paramContext, int paramInt1, String paramString, int paramInt2, Drawable.Callback paramCallback)
  {
  ...
  public asbj(Context paramContext, int paramInt, String paramString, Drawable.Callback paramCallback)
  {
  ...
  public Drawable getDrawable()
  {
    ...
    if (this.jdField_a_of_type_JavaLangString != null)
    {
      ...
      if (this.jdField_a_of_type_MqqUtilWeakReference != null)
      {
        ...
        this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new asbk(this));
        if (QLog.isColorLevel())
        {
