...
public class alzi
{
  private static final String a = alwf.a + "/RDModules" + File.separator + "ConfigData_";
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.ConfigSeq paramConfigSeq, boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      if (b(paramQQAppInterface.getApp(), i, paramString) < 0) {
        a(paramQQAppInterface.getApp(), i, paramString, new alzj(paramQQAppInterface, i, paramString));
      }
    } while (!QLog.isColorLevel());
  ...
  public static boolean a(int paramInt, String paramString)
  {
    ...
    while (!bhmi.a(paramString + File.separator + paramInt + ".cfg")) {
      return false;
    }
    return true;
  }
  ...
  private static boolean a(int paramInt, String paramString, ConfigurationService.Config paramConfig)
  {
    ...
    //   21: iload_0
    //   22: aload_1
    //   23: invokestatic 270	alzi:a	(ILjava/lang/String;)Ljava/lang/String;
    //   26: astore 9
    //   28: aload 9
    ...
    //   154: athrow
    //   155: aload 9
    //   157: invokestatic 292	bhmi:d	(Ljava/lang/String;)Z
    //   160: pop
    //   161: aload 10
    //   163: aload 9
    //   165: invokestatic 300	bhmi:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   168: pop
    //   169: iconst_0
    //   170: ireturn
    //   171: astore_1
    ...
    //   204: goto -61 -> 143
    //   207: astore_1
    //   208: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   211: ifeq -56 -> 155
    //   214: ldc 96
    //   216: iconst_2
    //   217: ldc_w 307
    //   220: aload_1
    //   221: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   224: goto -69 -> 155
    //   227: new 312	java/io/FileOutputStream
    //   230: dup
    //   231: aload 10
    //   233: invokespecial 313	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   236: astore_1
    //   237: aload 8
    //   239: astore_2
    //   240: aload_1
    ...
    //   245: astore 6
    //   247: aload_1
    //   248: invokevirtual 317	java/io/FileOutputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   251: invokevirtual 323	java/nio/channels/FileChannel:tryLock	()Ljava/nio/channels/FileLock;
    //   254: astore 4
    //   256: aload 4
    //   258: ifnull +62 -> 320
    //   261: aload 4
    ...
    //   269: astore 6
    //   271: aload_1
    //   272: invokevirtual 317	java/io/FileOutputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   275: lconst_0
    //   276: invokevirtual 327	java/nio/channels/FileChannel:position	(J)Ljava/nio/channels/FileChannel;
    //   279: pop
    //   280: aload 4
    //   282: astore_2
    //   283: aload_1
    ...
    //   291: aload 11
    //   293: arraylength
    //   294: invokestatic 332	agpj:a	(I)[B
    //   297: invokevirtual 336	java/io/FileOutputStream:write	([B)V
    //   300: aload 4
    //   302: astore_2
    //   303: aload_1
    //   304: astore 5
    ...
    //   314: aload 11
    //   316: arraylength
    //   317: invokevirtual 339	java/io/FileOutputStream:write	([BII)V
    //   320: aload 4
    //   322: ifnull +8 -> 330
    //   325: aload 4
    //   327: invokevirtual 344	java/nio/channels/FileLock:release	()V
    //   330: aload_1
    //   331: ifnull +7 -> 338
    //   334: aload_1
    //   335: invokevirtual 347	java/io/FileOutputStream:close	()V
    //   338: aload 9
    //   340: invokestatic 292	bhmi:d	(Ljava/lang/String;)Z
    //   343: pop
    //   344: aload 10
    //   346: aload 9
    //   348: invokestatic 300	bhmi:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   351: istore_3
    //   352: iload_3
    //   353: ireturn
    //   354: astore_2
    //   355: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   358: ifeq -28 -> 330
    //   361: ldc 96
    //   363: iconst_2
    //   364: new 10	java/lang/StringBuilder
    //   367: dup
    //   368: invokespecial 13	java/lang/StringBuilder:<init>	()V
    //   371: ldc_w 302
    //   374: invokevirtual 21	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   377: aload_2
    //   378: invokevirtual 305	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   381: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   384: invokestatic 151	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   387: goto -57 -> 330
    //   390: astore_1
    //   391: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   394: ifeq -56 -> 338
    //   397: ldc 96
    //   399: iconst_2
    //   400: ldc_w 307
    //   403: aload_1
    //   404: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   407: goto -69 -> 338
    //   410: astore 4
    //   412: aconst_null
    //   413: astore_1
    //   414: aload 5
    //   416: astore_2
    //   417: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   420: ifeq +30 -> 450
    //   423: ldc 96
    //   425: iconst_2
    //   426: new 10	java/lang/StringBuilder
    //   429: dup
    //   430: invokespecial 13	java/lang/StringBuilder:<init>	()V
    //   433: ldc_w 349
    //   436: invokevirtual 21	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   439: aload 4
    //   441: invokevirtual 305	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   444: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   447: invokestatic 156	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   450: aload_1
    //   451: ifnull +7 -> 458
    //   454: aload_1
    //   455: invokevirtual 344	java/nio/channels/FileLock:release	()V
    //   458: aload_2
    //   459: ifnull +7 -> 466
    //   462: aload_2
    //   463: invokevirtual 347	java/io/FileOutputStream:close	()V
    //   466: aload 9
    //   468: invokestatic 292	bhmi:d	(Ljava/lang/String;)Z
    //   471: pop
    //   472: aload 10
    //   474: aload 9
    //   476: invokestatic 300	bhmi:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   479: istore_3
    //   480: goto -128 -> 352
    //   483: astore_1
    //   484: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   487: ifeq -29 -> 458
    //   490: ldc 96
    //   492: iconst_2
    //   493: new 10	java/lang/StringBuilder
    //   496: dup
    //   497: invokespecial 13	java/lang/StringBuilder:<init>	()V
    //   500: ldc_w 302
    //   503: invokevirtual 21	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   506: aload_1
    //   507: invokevirtual 305	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   510: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   513: invokestatic 151	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   516: goto -58 -> 458
    //   519: astore_1
    //   520: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   523: ifeq -57 -> 466
    //   526: ldc 96
    //   528: iconst_2
    //   529: ldc_w 307
    //   532: aload_1
    //   533: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   536: goto -70 -> 466
    //   539: astore 4
    //   541: aconst_null
    //   542: astore_1
    ...
    //   546: aload_1
    //   547: astore 5
    //   549: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   552: ifeq +36 -> 588
    //   555: aload 6
    //   557: astore_2
    //   558: aload_1
    ...
    //   561: ldc 96
    //   563: iconst_2
    //   564: new 10	java/lang/StringBuilder
    //   567: dup
    //   568: invokespecial 13	java/lang/StringBuilder:<init>	()V
    //   571: ldc_w 351
    //   574: invokevirtual 21	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   577: aload 4
    //   579: invokevirtual 305	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   582: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   585: invokestatic 151	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   588: aload 6
    //   590: ifnull +8 -> 598
    //   593: aload 6
    //   595: invokevirtual 344	java/nio/channels/FileLock:release	()V
    //   598: aload_1
    //   599: ifnull +7 -> 606
    //   602: aload_1
    //   603: invokevirtual 347	java/io/FileOutputStream:close	()V
    //   606: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   609: ifeq +225 -> 834
    //   612: ldc 96
    //   614: iconst_2
    //   615: ldc_w 353
    //   618: invokestatic 151	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   621: iconst_0
    //   622: istore_3
    //   623: goto -271 -> 352
    //   626: astore_2
    //   627: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   630: ifeq -32 -> 598
    //   633: ldc 96
    //   635: iconst_2
    //   636: new 10	java/lang/StringBuilder
    //   639: dup
    //   640: invokespecial 13	java/lang/StringBuilder:<init>	()V
    //   643: ldc_w 302
    //   646: invokevirtual 21	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   649: aload_2
    //   650: invokevirtual 305	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   653: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   656: invokestatic 151	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   659: goto -61 -> 598
    //   662: astore_1
    //   663: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   666: ifeq -60 -> 606
    //   669: ldc 96
    //   671: iconst_2
    //   672: ldc_w 307
    //   675: aload_1
    //   676: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   679: goto -73 -> 606
    //   682: astore_1
    //   683: aconst_null
    //   684: astore 5
    ...
    //   690: ifnull +7 -> 697
    //   693: aload_2
    //   694: invokevirtual 344	java/nio/channels/FileLock:release	()V
    //   697: aload 5
    //   699: ifnull +8 -> 707
    //   702: aload 5
    //   704: invokevirtual 347	java/io/FileOutputStream:close	()V
    //   707: aload 9
    //   709: invokestatic 292	bhmi:d	(Ljava/lang/String;)Z
    //   712: pop
    //   713: aload 10
    //   715: aload 9
    //   717: invokestatic 300	bhmi:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   720: pop
    //   721: aload_1
    //   722: athrow
    //   723: astore_2
    //   724: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   727: ifeq -30 -> 697
    //   730: ldc 96
    //   732: iconst_2
    //   733: new 10	java/lang/StringBuilder
    //   736: dup
    //   737: invokespecial 13	java/lang/StringBuilder:<init>	()V
    //   740: ldc_w 302
    //   743: invokevirtual 21	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   746: aload_2
    //   747: invokevirtual 305	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   750: invokevirtual 34	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   753: invokestatic 151	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   756: goto -59 -> 697
    //   759: astore_2
    //   760: invokestatic 94	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   763: ifeq -56 -> 707
    //   766: ldc 96
    //   768: iconst_2
    //   769: ldc_w 307
    //   772: aload_2
    //   773: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   776: goto -69 -> 707
    //   779: astore_1
    //   780: goto -91 -> 689
    //   783: astore 4
    ...
    //   0	839	0	paramInt	int
    //   0	839	1	paramString	String
    //   0	839	2	paramConfig	ConfigurationService.Config
    //   351	485	3	bool	boolean
    //   4	322	4	localFileLock	java.nio.channels.FileLock
    //   410	30	4	localOverlappingFileLockException1	java.nio.channels.OverlappingFileLockException
    //   539	148	4	localException1	Exception
    //   783	8	4	localObject1	Object
    //   796	1	4	localException2	Exception
    //   801	16	4	localOverlappingFileLockException2	java.nio.channels.OverlappingFileLockException
    //   824	1	4	localOverlappingFileLockException3	java.nio.channels.OverlappingFileLockException
    //   13	816	5	localObject2	Object
    //   1	593	6	localObject3	Object
    //   814	9	6	localOverlappingFileLockException4	java.nio.channels.OverlappingFileLockException
    //   10	234	7	localObject4	Object
    //   7	231	8	localObject5	Object
    //   26	690	9	str1	String
    //   112	602	10	str2	String
    //   124	191	11	arrayOfByte	byte[]
    // Exception table:
    //   from	to	target	type
    //   135	143	171	java/lang/Exception
    //   147	155	207	java/lang/Exception
    //   325	330	354	java/lang/Exception
    //   334	338	390	java/lang/Exception
    //   120	126	410	java/nio/channels/OverlappingFileLockException
    //   227	237	410	java/nio/channels/OverlappingFileLockException
    //   454	458	483	java/lang/Exception
    //   462	466	519	java/lang/Exception
    //   120	126	539	java/lang/Exception
    //   227	237	539	java/lang/Exception
    //   593	598	626	java/lang/Exception
    //   602	606	662	java/lang/Exception
    //   120	126	682	finally
    //   227	237	682	finally
    //   693	697	723	java/lang/Exception
    //   702	707	759	java/lang/Exception
    //   247	256	779	finally
    //   271	280	779	finally
    //   290	300	779	finally
    //   310	320	779	finally
    ...
    //   561	588	779	finally
    //   417	450	783	finally
    //   247	256	796	java/lang/Exception
    //   271	280	796	java/lang/Exception
    //   290	300	796	java/lang/Exception
    //   310	320	796	java/lang/Exception
    //   247	256	801	java/nio/channels/OverlappingFileLockException
    //   271	280	814	java/nio/channels/OverlappingFileLockException
    //   290	300	814	java/nio/channels/OverlappingFileLockException
    //   310	320	814	java/nio/channels/OverlappingFileLockException
  }
  
  /* Error */
  public static boolean a(Context paramContext, int paramInt, String paramString, alzk paramalzk)
  {
    // Byte code:
    //   0: aload_0
    //   1: ifnull +7 -> 8
    ...
    //   14: iload_1
    //   15: aload_2
    //   16: invokestatic 270	alzi:a	(ILjava/lang/String;)Ljava/lang/String;
    //   19: astore_0
    //   20: aload_0
    ...
    //   59: astore_2
    //   60: aload_2
    //   61: invokestatic 277	bhmi:a	(Ljava/lang/String;)Z
    //   64: ifne +5 -> 69
    //   67: iconst_0
    //   68: ireturn
    //   69: aconst_null
    ...
    //   127: aload 11
    //   129: iconst_0
    //   130: invokestatic 378	agpj:a	([BI)I
    //   133: istore 4
    //   135: iload 4
    //   137: iconst_4
    ...
    //   521: invokestatic 202	azet:a	([B)[B
    //   524: astore_2
    //   525: aload_2
    ...
    //   1097: invokestatic 202	azet:a	([B)[B
    //   1100: astore 10
    //   1102: aload 10
