...
public class aadt
{
  ...
  public aadt(Activity paramActivity)
  {
  ...
  public bcci a()
  {
    ...
    {
      localActivity = a();
      if (!(localActivity instanceof bcci)) {
        break label45;
      }
    }
    label45:
    for (this.d = new WeakReference((bcci)localActivity);; this.d = new WeakReference(a())) {
  ...
  public WebViewFragment a()
  {
    ...
    {
      localActivity = a();
      if (!(localActivity instanceof bcce)) {
        break label50;
      }
    }
    label50:
    for (this.e = new WeakReference(((bcce)localActivity).b());; this.e = new WeakReference(null)) {
