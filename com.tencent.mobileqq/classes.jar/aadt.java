  ...
  extends WebViewPlugin
{
  ...
  private aadv jdField_a_of_type_Aadv = new aadv();
  private aadw jdField_a_of_type_Aadw;
  private Handler jdField_a_of_type_AndroidOsHandler = new aadu(this, Looper.getMainLooper());
  public String a;
  ...
  private void a(Bundle paramBundle)
  {
    ...
    for (CustomWebView localCustomWebView = this.mRuntime.a();; localCustomWebView = null)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        QLog.e("WebSoPlugin", 1, "QZoneWebViewPlugin onReceive 503, now it reload url! " + npn.c(str2, new String[0]));
      ...
      {
        QLog.d("WebSoPlugin", 1, bool1 + ") currentUrl(" + str3 + ") cache hit(" + bool4 + ") hasLoadCache(" + this.jdField_b_of_type_Boolean + ") load Url: " + npn.c(str2, new String[0]) + ",silent_mode:" + paramBundle.getBoolean("is_silent_mode", false) + ",isLocalData:" + bool2);
        if ((localWebSo3 == null) || (!localWebSo3.jdField_a_of_type_Boolean)) {
          break;
        }
        this.jdField_a_of_type_Aadv.a(this, localWebSo3);
        return;
      }
      this.jdField_a_of_type_Aadv.a();
      if ((!bool3) && (Build.VERSION.SDK_INT >= 17))
      {
        if (!bool2) {
          break label481;
        }
        if (this.jdField_a_of_type_Aadw == null)
        {
          this.jdField_a_of_type_Aadw = new aadw(this, localCustomWebView);
          localCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Aadw, "_webso");
          if (QLog.isColorLevel()) {
            QLog.d("WebSoPlugin", 1, "js method : " + Arrays.toString(this.jdField_a_of_type_Aadw.getClass().getDeclaredMethods()));
          }
        }
      }
      label426:
      if ((!this.jdField_b_of_type_Boolean) && (!bool3) && (i != 0))
      {
        ...
        if (bool2) {}
        for (paramBundle = bgzd.a(str2, str1);; paramBundle = bgzd.b(str2, str1))
        {
          ...
          this.jdField_a_of_type_Aadw.a(str1);
          return;
        }
      }
      if (bool4)
      {
        ...
        if (this.jdField_a_of_type_Aadw != null) {
          this.jdField_a_of_type_Aadw.a("{\"code\":0,\"data\":null}");
        }
      ...
      label770:
      for (paramBundle = bgzd.b(str2, str1);; paramBundle = str1)
      {
        a(localCustomWebView, str2, paramBundle);
        return;
  ...
  public static void a(CustomWebView paramCustomWebView, String paramString1, String paramString2)
  {
    ...
    {
      paramCustomWebView.setTag(2131374242, paramString2);
      paramCustomWebView.setTag(2131374243, Long.valueOf(System.currentTimeMillis()));
  ...
  private boolean a(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    do
    {
      ...
      {
        QLog.e("WebSoPlugin", 1, "now onHandleEventBeforeLoaded current url is not null! so return! " + npn.c(paramMap, new String[0]));
        return false;
      }
      a(paramString);
    } while ((!bgzd.b(paramString)) || (bgzd.e(paramString)));
  ...
  {
    if ((this.mRuntime == null) || (this.mRuntime.a() == null) || (this.mRuntime.a().getRootView() == null) || (this.mRuntime.a().getRootView().findViewById(2131381053) == null)) {}
    View localView;
    do
    {
      return;
      localView = this.mRuntime.a().getRootView().findViewById(2131381053).findViewById(2131373019);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if ((paramString2 != null) && ("WebSo".equals(paramString2)))
    {
      ...
      do
      {
        ...
        {
          bgzd.a("js call getData");
          this.jdField_a_of_type_Aadv.a(this, paramJsBridgeListener);
          return true;
        }
        if ("updateWebsoCache".equals(paramString3)) {}
        try
        {
          bgzd.a("js call updateWebsoCache");
          if (this.jdField_a_of_type_Aadv.a() != null)
          {
            if (this.mRuntime != null) {
        ...
        if ("updateScreenshot".equals(paramString3)) {
          try
          {
            bgzd.a("js call updateScreenshot");
            if (this.mRuntime != null)
            {
              paramString1 = this.mRuntime.a();
              paramString2 = paramString1.getUrl();
              if (bgzd.b(paramString2)) {
