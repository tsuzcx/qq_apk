  ...
  implements View.OnClickListener
{
  ...
  public View a(String paramString, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130846192);
    ...
    localLayoutParams.addRule(3, 2131372955);
    localLayoutParams.addRule(11);
    localLayoutParams.rightMargin = baxn.b(this.jdField_a_of_type_AndroidContentContext, 20.0F);
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      try
      {
        localObject2 = (ViewGroup)((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment().a().c.findViewById(2131364075);
    ...
    if (this.b == null)
    {
      ...
      this.b.setId(2131362419);
      i = baxn.a(this.jdField_a_of_type_AndroidContentContext, 62.0F);
      localObject2 = new RelativeLayout.LayoutParams(i, i);
      ((RelativeLayout.LayoutParams)localObject2).topMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
      ((RelativeLayout.LayoutParams)localObject2).rightMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131372955);
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      this.b.setLayoutParams((ViewGroup.LayoutParams)localObject2);
    }
    this.b.setTag(2131362422, paramString2);
    this.b.setTag(2131362420, String.valueOf(paramInt1));
    this.b.setTag(2131362421, String.valueOf(paramInt2));
    this.b.setTag(2131362423, Integer.valueOf(paramInt3));
    ...
    try
    {
      ...
      ((URLImageView)this.b).setURLDrawableDownListener(new nqa(this));
    }
    ...
    axqy.b(null, "dc00899", "Pb_account_lifeservice", "1", "0X80075A0", "0X80075A0", 0, 0, "", "", String.valueOf(paramInt1), String.valueOf(paramInt2));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    } while ((paramView.getId() != 2131362419) || (this.jdField_a_of_type_AndroidContentContext == null));
    String str1 = (String)paramView.getTag(2131362422);
    String str2 = (String)paramView.getTag(2131362420);
    String str3 = (String)paramView.getTag(2131362421);
    if (((Integer)paramView.getTag(2131362423)).intValue() == 1)
    {
    ...
    for (;;)
    {
      axqy.b(null, "dc00899", "Pb_account_lifeservice", "1", "0X80075A1", "0X80075A1", 0, 0, "", "", str2, str3);
      return;
