...
public class bnbf
{
  ...
  public static void a(Activity paramActivity, String paramString1, LocalMediaInfo paramLocalMediaInfo, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString2, String paramString3, boolean paramBoolean, int paramInt6, int paramInt7, Bundle paramBundle)
  {
    ...
    for (;;)
    {
        ...
        if (paramInt4 == 10004)
        {
          ...
          if ((TextUtils.isEmpty(paramLocalMediaInfo.path)) || (paramLocalMediaInfo.path.equalsIgnoreCase("null")))
          {
            ...
            if (paramInt7 == 11)
            {
              bool2 = false;
              bool1 = false;
              localObject = bbae.a(paramActivity.getIntent().getExtras());
              if (localObject == null) {
                break label1531;
              }
            ...
            break label1734;
            label639:
            if (bkwm.a(paramActivity.getIntent(), paramInt7)) {
              break label1757;
            }
            if (!bkwm.c(paramActivity.getIntent())) {
              break label1764;
            }
            break label1757;
            label664:
            ...
            paramString1.f = paramActivity.getIntent().getIntExtra("VIDEO_STORY_FROM_TYPE", bkwm.a.a());
            if (paramActivity.getIntent().getBooleanExtra("is_video_forward", false)) {
              paramString1.e = 4;
            }
            if (l4 != 0L) {
            ...
            if ((paramInt1 / paramInt2 >= azgq.jdField_a_of_type_Int / azgq.jdField_b_of_type_Int) && (!paramActivity.getIntent().getBooleanExtra("is_video_forward", false)))
            {
              paramString1.a.putBoolean("extra_is_fit_center", true);
              if (xom.a(paramInt1, paramInt2, azgq.jdField_a_of_type_Int, azgq.jdField_b_of_type_Int)) {
            ...
            wsv.b("Q.qqstory.publish.QQStoryFlowCallback", "EditVideoParams params:" + paramString1.toString());
            ...
            paramLocalMediaInfo.putExtra("VIDEO_STORY_FROM_TYPE", bkwm.a(paramActivity.getIntent()));
            if (paramInt7 == 14)
            {
              paramLocalMediaInfo.putExtra("VIDEO_STORY_JUMP_TO_TYPE", bkwm.b(paramActivity.getIntent()));
              paramLocalMediaInfo.putExtra("VIDEO_STORY_MEDIA_TYPE", bkwm.c(paramActivity.getIntent()));
            }
            if (paramBundle != null) {
      ...
      {
        wsv.e("Q.qqstory.publish.QQStoryFlowCallback", "startEditVideoActivity exception:" + paramActivity);
        return;
      }
      label1295:
  ...
  public static boolean a()
  {
    ...
    if (localurk == null)
    {
      wsv.e("Q.qqstory.publish.QQStoryFlowCallback", "StoryConfigManager(CONFIG_MANAGER) is null!");
      return false;
    }
    int i = localurk.b();
    if (i == h) {
    ...
    jdField_a_of_type_Int = ((Integer)localurk.b("localUploadVideoSizeLimit", Integer.valueOf(jdField_a_of_type_Int))).intValue();
    jdField_b_of_type_Int = ((Integer)localurk.b("localUploadVideoMinResolutionLimit", Integer.valueOf(jdField_b_of_type_Int))).intValue();
    c = ((Integer)localurk.b("localUploadVideoDurationLimit", Integer.valueOf(c))).intValue();
    e = ((Integer)localurk.b("localUploadVideoRatioLimit", Integer.valueOf(e))).intValue();
    f = ((Integer)localurk.b("localUploadImageSizeLimit", Integer.valueOf(f))).intValue();
    g = ((Integer)localurk.b("localUploadImageMinResolutionLimit", Integer.valueOf(g))).intValue();
    jdField_a_of_type_Float = e / 10000 / 1000.0F;
    jdField_b_of_type_Float = e % 10000 / 1000.0F;
    wsv.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config %d|%d|%d|%d|%d|%d", new Object[] { Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(c), Integer.valueOf(e), Integer.valueOf(f), Integer.valueOf(g) });
    wsv.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config from %d to %d", new Object[] { Integer.valueOf(h), Integer.valueOf(i) });
    h = localurk.b();
    return true;
  }
  ...
  public static boolean a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    if (localLocalMediaInfo == null) {
      throw new IllegalArgumentException(alpo.a(2131711263));
    }
  ...
  public static boolean a(@NonNull Activity paramActivity, @NonNull LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo.mMimeType.contains("video")) {
      if (paramLocalMediaInfo.mDuration > c)
      {
        ...
        wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 4;
        k = 5;
        i = 1;
      }
    ...
    for (;;)
    {
      wta.b("upload_local_video", "choose_media_info", 0, j, new String[] { a(paramLocalMediaInfo) });
      if (i != 0)
      {
        String str1 = String.valueOf(1);
        label200:
        wta.a("video_shoot", "chose_video", 0, 0, new String[] { str1, String.valueOf(k), String.valueOf(f1) });
        if ((i != 0) && (paramLocalMediaInfo.mDuration >= 20500L)) {
          wta.a("video_shoot", "local_over", 0, 0, new String[0]);
        }
        if (paramLocalMediaInfo.addedDate == 0L)
        {
          ...
          i = 0;
          label307:
          wta.b("upload_local_video", "media_info_missing", 0, i, new String[] { a(paramLocalMediaInfo) });
        }
        if (localObject != null) {
      ...
      for (;;)
      {
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alpo.a(2131711253), 0);
          wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alpo.a(2131711241), 0);
          wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 1;
        ...
        if ((f1 < 0.4F) || (f1 > 2.2F))
        {
          localObject = QQToast.a(paramActivity, 1, alpo.a(2131711246), 0);
          wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          j = 3;
          i = 1;
          break;
        ...
        localObject = QQToast.a(paramActivity, 1, alpo.a(2131711232), 0);
        wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 6;
        k = 8;
        i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alpo.a(2131711248), 0);
          wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 0;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alpo.a(2131711247), 0);
          wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 0;
        ...
        localObject = QQToast.a(paramActivity, 1, alpo.a(2131711245), 0);
        wsv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 3;
        i = 0;
        break;
