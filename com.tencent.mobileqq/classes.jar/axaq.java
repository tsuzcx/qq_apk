...
public class axaq
{
    ...
    for (;;)
    {
      ...
      if ((str.charAt(k) == '\024') && (k + 1 < str.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + j + ",max len:" + axau.a.length);
        }
        if ((j >= 0) && (j < axau.a.length))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "---faceIndex:" + axau.a[j]);
          }
          paramString = new im_msg_body.Face();
          paramString.index.set(axau.a[j]);
        ...
        arrayOfInt = anqz.a((char[])localObject2);
      ...
      for (paramString = paramString.getSharedPreferences("Last_Login", j).getString("uin", "");; paramString = null) {
        for (;;)
        {
          try
          {
            ...
            localObject1 = aykk.jdField_c_of_type_JavaLangString;
            if (paramString == null) {
              break label1013;
            }
            paramString = (askf)paramString.getManager(14);
            if (paramString == null) {
              break label1019;
            }
  ...
  public static long a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (long l1 = bbmx.a(arrayOfByte, 0);; l1 = 0L)
    {
  ...
  public static axag a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, long paramLong1, boolean paramBoolean1, boolean paramBoolean2, long paramLong2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        if (!paramMessageHandler.app.a().a((apey)localObject))
        {
          if (QLog.isColorLevel()) {
        ...
        if (!((apey)localObject).jdField_b_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
        ...
        paramMessageHandler.app.a().b(i, String.valueOf(paramLong1), paramMsg, l, s, paramBoolean1, 0, null, (apey)localObject, paramLong2, paramInt);
      }
      else
      {
        if (QLog.isColorLevel()) {
  ...
  public static axaw a(msg_comm.Msg paramMsg)
  {
    ...
    if (!localC2CTmpMsgHead.c2c_type.has())
    {
      ...
      localaxaw.jdField_b_of_type_Int = localC2CTmpMsgHead.direction_flag.get();
      ...
      default: 
        ...
        localaxaw.jdField_a_of_type_Long = -1L;
        localaxaw.jdField_b_of_type_Long = -1L;
        switch (k)
        {
        }
        break;
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        ...
        paramMsg.append(" c2cType:").append(j).append(" serviceType:").append(k).append("direction_flag:").append(localaxaw.jdField_b_of_type_Int).append(" info:").append(localaxaw.toString());
      ...
      break label284;
      i = 1024;
      if ((!myv.a(BaseApplicationImpl.getContext(), String.valueOf(paramMsg.msg_head.from_uin.get()))) && (!myv.a(BaseApplicationImpl.getContext(), String.valueOf(paramMsg.msg_head.to_uin.get())))) {
        break label284;
      }
      i = 1025;
      break label284;
      ...
      i = 1044;
      break label284;
      localaxaw.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaxaw.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
      continue;
      localaxaw.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaxaw.jdField_b_of_type_Long = localC2CTmpMsgHead.group_code.get();
      continue;
      localaxaw.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaxaw.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localMsgBody.uint32_anchor_status.get() == 1)
        {
          ...
          paramArrayOfByte.senderuin = String.valueOf(ajsd.l + l1);
          paramArrayOfByte.frienduin = String.valueOf(ajsd.l + l1);
          ...
          axqy.b(null, "dc00899", "grp_lbs", "", "msg_box", "view_live_message", 0, 0, "", "", "", "");
  ...
  public static MessageRecord a(List<MessageRecord> paramList, byte[] paramArrayOfByte, azml paramazml)
  {
        ...
        for (;;)
        {
          ...
          else if (localInvalidProtocolBufferMicroException.msgtype == -1049)
          {
            try
            {
              ...
              localObject2 = akwa.a(localMessageForReplyText.mSourceMsgInfo);
              localElem.sourceMsgInfo.set(bbea.a((byte[])localObject2));
    ...
    paramList = (MessageForMixedMsg)axas.a(-1035);
    paramList.msgtype = -1035;
    paramList.msgData = localMsg.toByteArray();
    if ((paramazml != null) && (paramazml.jdField_a_of_type_Int == 3000)) {
      paramList.frienduin = paramazml.jdField_a_of_type_JavaLangString;
    }
    if (i != 0) {
      bafv.a(paramazml.jdField_a_of_type_Int, localJSONObject.toString(), paramList);
    }
    if (paramArrayOfByte != null) {
      paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bbea.a(paramArrayOfByte));
    }
    paramList.parse();
    return paramList;
  }
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 1 < paramString.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + k + ",max len:" + axau.a.length);
        }
        j = i;
        if (k >= 0)
        {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, axax paramaxax, long paramLong, int paramInt2)
  {
    if (paramaxax == null) {
    ...
    do
    {
      ...
      {
        l = 0x0 | paramaxax.jdField_a_of_type_ArrayOfByte.length << 16 | 0xA6;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S>--->createPbSendMsgReq: routingType:" + paramInt1 + ",toUin:" + paramString + ",msgUid:" + l + ",msgSeq:" + paramLong + ",uint32Seq:" + k + ",shortSeq:" + j + ",randomNum:" + paramInt2 + ",msgContext:" + paramaxax);
        }
      ...
      for (;;)
      {
        ...
        ((msg_svc.TransMsg)localObject).c2c_cmd.set(paramaxax.jdField_a_of_type_Int);
        ...
        ((msg_svc.Trans0x211)localObject).cc_cmd.set(paramaxax.jdField_a_of_type_Int);
      ...
      localMsgBody.msg_content.set(ByteStringMicro.copyFrom(paramaxax.jdField_a_of_type_ArrayOfByte));
      ...
      paramaxax = paramQQAppInterface.a();
      paramQQAppInterface = paramString;
    } while (paramaxax == null);
    paramString.sync_cookie.set(ByteStringMicro.copyFrom(paramaxax));
    return paramString;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    ...
    do
    {
      ...
      k = axau.a(l);
      localawzy = paramQQAppInterface.a();
      localRoutingHead = new msg_svc.RoutingHead();
    ...
    if ((i != 2) && (i != 4) && (i != 21))
    {
      paramQQAppInterface = localawzy.a();
  ...
  public static im_msg_body.RichText a(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      byte[] arrayOfByte = axwj.b((byte[])localObject3);
      localObject1 = localObject2;
      if (arrayOfByte == null) {
        continue;
      }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((paramChatMessage == null) || (paramChatMessage.length() == 0)) {
            localObject1 = BaseApplication.getContext().getString(2131693794);
          } else {
            localObject1 = String.format(BaseApplication.getContext().getString(2131693795), new Object[] { paramChatMessage });
          }
        }
        return null;
      }
  ...
  public static im_msg_body.RichText a(MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    for (String str = ajya.a(2131706659);; str = "[" + paramMessageForMarketFace.mMarkFaceMessage.faceName + "]")
    {
      boolean bool = true;
  ...
  public static im_msg_body.RichText a(MessageForReplyText paramMessageForReplyText)
  {
    ...
    try
    {
      String str = bbea.a(akwa.a(paramMessageForReplyText.mSourceMsgInfo));
      localObject1 = str;
      localObject2 = str;
      ...
      if ((paramMessageForStructing.structingMsg instanceof AbsShareMsg))
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((axuq)localObject2).a;
              if (localObject2 != null)
              {
  ...
  public static im_msg_body.RichText a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject4))
      {
        try
        {
          localSourceMsgInfo = (MessageForReplyText.SourceMsgInfo)akwa.a(bbea.a((String)localObject4));
  ...
  {
    lcy locallcy = lcy.a();
    locallcy.a(0L, paramLong1, paramLong2);
    locallcy.a(paramInt, 2, paramLong2);
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          ((akgg)paramMessageHandler.app.a(18)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          ...
          return;
          ((ayaj)paramMessageHandler.app.getManager(17)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          ...
          ((akhp)paramMessageHandler.app.a(20)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          if (QLog.isColorLevel()) {
          ...
          agwy.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramMessageHandler, paramLong, i, l1, j);
          return;
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        localObject2 = (anmj)paramMessageHandler.app.getManager(71);
        if (localObject2 != null) {
          ((anmj)localObject2).a().a((SubMsgType0x6f.MCardNotificationLike)localObject4);
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          ((akjn)paramMessageHandler.app.a(27)).a((String)localObject4, (String)localObject2);
          break label1914;
          if ((i == 2003) && (((SubMsgType0x6f.ForwardBody)localObject2).msg_push_lost_dev_found.has()))
          {
            ...
            ((yah)paramMessageHandler.app.a(51)).a(111, (Bundle)localObject4);
            break label1914;
          }
          ...
          ((QIMNotifyAddFriend)localObject4).pushTime = awzy.a();
          if (QLog.isColorLevel()) {
            QLog.d("QIMNewNotifyPush_offLine", 2, "receive data= " + ((QIMNotifyAddFriend)localObject4).toString());
          }
          ((akdq)paramMessageHandler.app.getManager(257)).a((QIMNotifyAddFriend)localObject4);
          break label1914;
          if (QLog.isColorLevel()) {
            QLog.d("TurnBrand", 2, "decode recv msg0x210.Submsgtype0x6e");
          }
          localObject2 = (akfc)paramMessageHandler.app.getManager(22);
          if (localObject2 != null) {
            ((akfc)localObject2).a();
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          ...
          try
          {
            ...
            if (((submsgtype0x67.MsgBody)localObject4).rpt_msg_grpinfo.has())
            {
              ...
              localObject4 = (ajzj)paramMessageHandler.app.a(3);
              if (localObject4 != null) {
                ((ajzj)localObject4).a((List)localObject2);
              }
            }
            a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
            return;
          ...
          ((akdu)paramMessageHandler.app.a(47)).a(true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
          ...
          try
          {
            ...
            ((awyl)paramMessageHandler.app.getManager(94)).a(paramMsg, 1);
            return;
          }
          catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        }
        ...
        try
        {
          ...
          if (((SubMsgType0x87.MsgBody)localObject4).rpt_msg_msg_notify.has()) {
            afjk.a(paramMessageHandler.app, (SubMsgType0x87.MsgBody)localObject4);
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        try
        {
          ...
          ((aqui)paramMessageHandler.app.getManager(156)).a((SubMsgType0xaa.MsgBody)localObject4, true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        label4681:
        paramMsg = ((akqe)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray());
        if (TextUtils.isEmpty(paramMsg)) {
          break;
        }
        paramBoolean1 = ((ajxl)paramMessageHandler.app.getManager(51)).b(paramMsg);
        if (QLog.isColorLevel()) {
        ...
        ((akqe)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "handleMsgType0x210SubMsgType0xee receive 0xee push message");
        }
        ((akqe)paramMessageHandler.a("businessbase_processor")).b(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        localObject4 = (akqe)paramMessageHandler.a("businessbase_processor");
        ...
        ((akqe)localObject4).a(localException5.msg_content.get().toByteArray(), 2, (MsgInfo)localObject5);
        ...
        ((MsgInfo)localObject5).lMsgUid = paramMsg.msg_head.msg_uid.get();
        ((MsgInfo)localObject5).shMsgType = ((short)paramMsg.msg_head.msg_type.get());
        ((akqe)localObject4).a(localException5.msg_content.get().toByteArray(), 2);
        a(paramMessageHandler, ((MsgInfo)localObject5).lFromUin, ((MsgInfo)localObject5).shMsgSeq, ((MsgInfo)localObject5).lMsgUid, ((MsgInfo)localObject5).shMsgType);
        return;
        if (QLog.isColorLevel()) {
        ...
        paramMsg = new akqm(paramLong, i, l1, j, k, false);
        ((akqe)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg);
        a(paramMessageHandler, paramLong, i, l1, j);
        return;
        if (QLog.isColorLevel()) {
        ...
        if ((localObject3 == null) || (akas.a(paramMessageHandler.app, (MessageRecord)localObject3, true)) || (((MessageRecord)localObject3).msgtype != -2053)) {
          break;
        }
        ...
        localObject4 = (airx)paramMessageHandler.app.getManager(153);
        if (localObject4 != null) {
          ((airx)localObject4).a(((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray());
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        ...
        try
        {
          ...
          paramMessageHandler = (aisr)paramMessageHandler.app.getManager(227);
      ...
      paramMessageHandler = (ssr)paramMessageHandler.app.getManager(253);
      ...
      try
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (paramMessageHandler.app != null) {
            ((atzm)paramMessageHandler.app.getManager(266)).b((NowPushMsgList.NowPushMsg)localObject4);
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        akaa.a(paramMessageHandler.app, (byte[])localObject3);
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
      catch (Exception paramMessageHandler)
      ...
      arrl.a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray();
      localObject4 = ((aync)paramMessageHandler.app.getManager(339)).a(4);
      if (localObject4 != null) {
        ((aynn)localObject4).a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      }
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = anmf.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = annj.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (!QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (!ayfx.a(paramMsg.msg_head.msg_seq.get()))
        {
          ayfx.a(paramMessageHandler.app, (SubMsgType0x119.MsgBody)localObject4);
      ...
      {
        aqvc.a(paramMessageHandler, (byte[])localObject3, (MsgInfo)localObject4, paramBoolean1);
        return;
      }
      if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        ((aoet)paramMessageHandler.app.a(127)).a((submsgtype0x128.MsgBody)localObject4);
      ...
      {
        localObject3 = ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray();
        localObject4 = (afhv)paramMessageHandler.app.a(169);
        if (localObject4 != null) {
          ((afhv)localObject4).a((byte[])localObject3);
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (!paramMessageHandler.a().a(str))
        {
          ...
          if ((paramInt1 == 241) || (axau.a(str, paramInt1)))
          {
            ...
            paramMsg = (MessageForPic)axas.a(-2000);
        ...
        for (;;)
        {
          ...
          QLog.d("Q.msg.MessageHandler", 2, localStringBuilder.toString());
          return;
          if ((paramInt1 != 242) && (!axau.b(str, paramInt1))) {
            break;
          }
          ...
          for (;;)
          {
            paramMsg = aywk.a((String)localObject1, paramLong1, 2, false, (String)localObject1, null, "ftn");
            ...
            localObject1 = (MessageForPtt)axas.a(-2002);
            ...
            aytn.a(paramMessageHandler.app, 1, false, 4);
            break;
            if (QLog.isColorLevel()) {
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg)
  {
    ...
    Object localObject4;
    long l2;
    if (ayaj.a(paramMessageHandler.app))
    {
      i4 = 1;
      l1 = -1L;
      localObject2 = "";
      ...
      i2 = localObject7[i1];
      i1 += 1;
      i5 = bbmx.a((byte[])localObject7, i1);
      i6 = i1 + 2;
      if (i2 != 3) {
        break label514;
      }
      localObject4 = new byte[i5];
      bbmx.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
      l2 = bbmx.a((byte[])localObject4, 0);
      if (l2 > 0L) {
        l1 = l2;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i2 == 9)
      {
        localObject4 = new byte[i5];
        bbmx.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        n = bbjg.b(bbbr.a(bbmx.a((byte[])localObject4, 0)));
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else if (i2 == 8)
      {
        localObject4 = new byte[i5];
        bbmx.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        m = (int)bbmx.a((byte[])localObject4, 0);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else
      {
        ...
        bbmx.a((byte[])localObject5, 0, (byte[])localObject7, i6, i5);
    ...
    for (;;)
    {
      ...
      for (localObject4 = ((ByteStringMicro)localObject4).toStringUtf8();; localObject4 = "") {
        for (;;)
        {
          ...
          {
            i1 = 1;
            axqy.b(paramMessageHandler.app, "CliOper", "", "", "0X80060E4", "0X80060E4", i1, 0, "", "", "", "8.3.0");
            ...
            localObject8 = bbea.a(((im_msg_body.Ptt)localObject6).bytes_file_md5.get().toByteArray());
          }
          try
          {
            ...
            for (;;)
            {
              try
              {
                ...
                if (((generalflags.ResvAttr)localObject6).bytes_pb_ptt_waveform.has())
                {
                  ...
                  ((MessageForPtt)localObject5).waveformArray = bbga.a((ptt_waveform.PttWaveform)localObject7);
                  if (QLog.isColorLevel())
                  {
            ...
            if (localRichText.elems.has())
            {
              ...
              while (paramList.hasNext())
              {
                ...
                if ((((im_msg_body.Elem)localObject3).common_elem.has()) && (21 == ((im_msg_body.Elem)localObject3).common_elem.uint32_service_type.get()))
                {
                  ...
                  amnr.a(paramMsg, (im_msg_body.Elem)localObject3, localArrayList, paramMessageHandler.app);
                }
              }
            }
            ahjk.b((String)localObject1, (MessageRecord)localObject4);
            return;
          }
        }
      }
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      localObject1 = bbcc.a((msg_comm.PluginInfo)localObject1);
      if (QLog.isColorLevel()) {
      ...
      if (localObject2 == null)
      {
        paramMessageHandler.a().a((auko)localObject1);
        if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject2 = BaseApplication.getContext().getString(2131719430);
          ...
          for (localObject1 = localObject4;; localObject1 = null)
          {
            if (localObject1 != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                localObject2 = localObject1;
                ((PBStringField)localObject4).set((String)localObject2);
                localObject2 = aywk.a((String)localObject1, j, 1, false, (String)localObject1);
                if (QLog.isColorLevel()) {
            ...
            for (localObject1 = localObject3;; localObject1 = localObject3)
            {
              ...
              for (;;)
              {
                ...
                {
                  paramMessageHandler.a().b((auko)localObject2);
                  paramMessageHandler.a().a((auko)localObject1);
                  if (!QLog.isColorLevel()) {
                    break;
                  }
                ...
                else if (((im_msg_body.Elem)localObject1).custom_face.has())
                {
                  ...
                  localObject7 = bbea.a((byte[])localObject7);
                  localObject5 = bbea.a((byte[])localObject5);
                  localObject6 = bbea.a((byte[])localObject6);
                  if (QLog.isColorLevel()) {
                  ...
                  {
                    ((PBStringField)localObject4).set((String)localObject2);
                    localObject2 = aywk.a((String)localObject1, 0L, 1, false, (String)localObject1);
                    paramBoolean = true;
                    break;
                    localObject2 = "";
                    break label1455;
                  ...
                  for (;;)
                  {
                    ...
                    do
                    {
                      ...
                      if ((!paramBoolean) && (bool1))
                      {
                        paramMessageHandler = (MessageForText)axas.a(-1000);
                    ...
                    paramMessageHandler.d(String.valueOf(bbcc.b(l1)));
                    paramMsg = bbbu.a(localAppShareInfo.appshare_cookie.get().toByteArray());
                    if (QLog.isColorLevel()) {
                    ...
                    localObject1 = bbbu.a((String)localObject2, (String)localObject1, l1, paramMsg.jdField_a_of_type_JavaLangString);
                    if (QLog.isColorLevel()) {
                      QLog.d("Q.msg.MessageHandler", 2, "<--decodeC2CMsgPkg_AppShared : content:" + (String)localObject2 + ",encodeMsg:" + (String)localObject1);
                    }
                    localObject2 = axas.a(paramMsg.jdField_b_of_type_Int);
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      paramMessageHandler = BaseApplication.getContext().getString(2131690310);
      paramMsg = new axan().a((List)localObject);
      if (TextUtils.isEmpty(paramMsg)) {
        break;
      }
      paramMessageHandler = paramMessageHandler + " " + paramMsg;
      paramMsg = axas.a(-10000);
    ...
    do
    {
      ...
      do
      {
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  try
                  {
                    ...
                    if (!paramBoolean4)
                    {
                      ((ajum)paramMessageHandler.app.a(8)).a(paramMsg, paramList);
                      return;
                    }
                  }
                  catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        ...
        try
        {
          ...
          if (paramMsg != null)
          {
            apel.a(String.valueOf(paramLong1), paramMsg);
            paramList = (List<MessageRecord>)localObject1;
          }
        }
      ...
      ((yah)paramMessageHandler.app.a(51)).a(paramLong1, paramLong2, paramInt, l1, i, "im_push.msg_push", (byte[])localObject2);
    } while (!QLog.isColorLevel());
    label801:
    label943:
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, axaw paramaxaw, awzw paramawzw)
  {
    ...
    do
    {
      ...
      k = ((msg_comm.C2CTmpMsgHead)localObject1).service_type.get();
      if ((paramawzw.d) || (paramaxaw.jdField_a_of_type_Int != 1006)) {
        break label260;
      }
      localObject3 = ((msg_comm.C2CTmpMsgHead)localObject1).from_phone.get();
      if ((((msg_comm.C2CTmpMsgHead)localObject1).from_phone.has()) && (localObject3 != null) && (!((String)localObject3).equals("+0"))) {
        break label222;
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    label222:
    bbcz.a(paramMessageHandler.app, ((msg_comm.C2CTmpMsgHead)localObject1).from_phone.get(), paramawzw.e + "");
    label260:
    if ((!paramawzw.d) && (((msg_comm.C2CTmpMsgHead)localObject1).sig.has()))
    {
      localObject3 = ((msg_comm.C2CTmpMsgHead)localObject1).sig.get().toByteArray();
      localObject1 = localObject3;
      if (QLog.isDevelopLevel()) {
        QLog.d("Q.msg.MessageHandler", 4, "tempHead.sig.get()----> sig:" + bbea.a((byte[])localObject3) + ",length:" + localObject3.length);
      }
    }
    label520:
    label1269:
    ...
    for (localObject1 = localObject3;; localObject2 = null)
    {
      ...
      {
        if (localObject1 != null) {}
        switch (paramaxaw.jdField_a_of_type_Int)
        {
        default: 
          k = 0;
          i = k;
        ...
        for (i = 1;; i = 0)
        {
          ...
          if (paramawzw.jdField_b_of_type_Boolean) {
            break;
          }
          paramMessageHandler = BaseApplication.getContext().getString(2131690310) + " " + paramMessageHandler.str.get().toStringUtf8();
          paramMsg = axas.a(-10000);
          paramMsg.msgtype = -10000;
          paramMsg.msg = paramMessageHandler;
          paramList.add(paramMsg);
          ...
          bbmx.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().a(String.valueOf(paramawzw.e), (byte[])localObject3);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bbmx.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().b(String.valueOf(paramawzw.e), (byte[])localObject3);
          break label520;
          paramMessageHandler.app.a().c(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bbmx.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().e(String.valueOf(paramawzw.e), (byte[])localObject3);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bbmx.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().f(String.valueOf(paramawzw.e), (byte[])localObject3);
          break label520;
          paramMessageHandler.app.a().g(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().h(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().i(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().j(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().m(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().o(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().l(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().k(String.valueOf(paramawzw.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().a(String.valueOf(paramawzw.e), String.valueOf(paramawzw.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().b(String.valueOf(paramawzw.e), String.valueOf(paramawzw.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().c(String.valueOf(paramawzw.e), String.valueOf(paramawzw.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
        }
        if (paramaxaw == null) {
          break;
        ...
        {
          paramawzw = ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.get().toByteArray();
          localObject1 = new im_msg_body.TmpPtt();
          try
          {
            paramawzw = (im_msg_body.TmpPtt)((im_msg_body.TmpPtt)localObject1).mergeFrom(paramawzw);
            if ((paramawzw == null) || (!paramawzw.uint32_file_type.has()) || (paramawzw.uint32_file_type.get() != 4) || (!paramawzw.bytes_file_uuid.has())) {
              break;
            }
            localObject1 = paramawzw.bytes_file_uuid.get().toStringUtf8();
            if (QLog.isColorLevel()) {
            ...
            localPttRec.localPath.set(paramawzw.bytes_file_uuid.get().toStringUtf8());
            localPttRec.size.set(paramawzw.uint32_file_size.get());
            ...
            i = 0;
            k = i;
            if (paramawzw.uint32_user_type.has())
            {
              j = paramawzw.uint32_user_type.get();
              if (j != 1)
              {
                k = i;
                if (j != 2) {}
            ...
            localObject3 = "";
            localObject1 = localObject3;
            if (paramawzw.bytes_pb_reserve.has())
            {
            ...
            try
            {
              ((ptt_reserve.ReserveStruct)localObject1).mergeFrom(paramawzw.bytes_pb_reserve.get().toByteArray());
              j = n;
              i = m;
            ...
            localPttRec.longPttVipFlag.set(k);
            l1 = System.currentTimeMillis() / 1000L;
            l2 = paramMsg.msg_head.msg_time.get();
            localPttRec.msgRecTime.set(l1);
            localPttRec.msgTime.set(l2);
            localPttRec.voiceChangeFlag.set(i);
            localPttRec.busiType.set(paramawzw.uint32_busi_type.get());
            localPttRec.autototext_voice.set(j);
            localPttRec.sttText.set((String)localObject1);
            localObject1 = axas.a(-2002);
            ((MessageRecord)localObject1).msgtype = -2002;
            ((MessageRecord)localObject1).msgData = localPttRec.toByteArray();
            ((MessageForPtt)localObject1).parse();
            if ((paramawzw.uint64_msg_id.has()) && (paramawzw.uint64_msg_id.get() != 0L)) {
              ((MessageRecord)localObject1).saveExtInfoToExtStr("pa_msgId", paramawzw.uint64_msg_id.get() + "");
            }
            amnr.a(paramMsg, (MessageRecord)localObject1, paramMessageHandler.app);
            bdwa.a(paramaxaw, paramMsg, (MessageRecord)localObject1);
            paramList.add(localObject1);
            return;
          }
          catch (InvalidProtocolBufferMicroException paramawzw)
          {
            for (;;)
            {
              paramawzw.printStackTrace();
              paramawzw = null;
            }
          }
        }
      }
      localObject1 = new azml();
      ((azml)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(paramawzw.e);
      a(paramMessageHandler, paramList, paramMsg, true, paramawzw.jdField_b_of_type_Boolean, (azml)localObject1, paramaxaw);
      return;
    }
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, azml paramazml)
  {
    a(paramMessageHandler, paramList, paramMsg, paramBoolean1, paramBoolean2, paramazml, null);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, azml paramazml, axaw paramaxaw)
  {
    ...
    for (;;)
    {
      if (paramList.isEmpty()) {
        localaxan.g(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      }
      if (paramList.isEmpty()) {
        localaxan.i(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      }
      localaxan.a(localList, paramList);
      if (axam.a((ArrayList)localObject2)) {
        localaxan.a((ArrayList)localObject2, localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml, paramaxaw);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      return;
      localaxan.a(localList, paramList, (StringBuilder)localObject1, paramBoolean2);
      continue;
      localaxan.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxan.b(localList, paramList, (StringBuilder)localObject1, paramBoolean1);
      continue;
      localaxan.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxan.d(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.b(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.c(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.e(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.c(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.a(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.d(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.h(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.b(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxan.f(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.h(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.i(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.g(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml, paramBoolean1);
      continue;
      localaxan.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml, paramBoolean1);
      continue;
      localaxan.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.i(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazml);
      continue;
      localaxan.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localaxan.b(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localaxan.e(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.f(localList, paramList, (StringBuilder)localObject1);
      continue;
      if (paramBoolean1)
      {
        ...
        {
          localaxan.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramMessageHandler);
          break;
        }
      }
      if (paramazml != null) {}
      for (paramMessageHandler = paramazml.jdField_a_of_type_JavaLangString;; paramMessageHandler = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      localaxan.g(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.c(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      amom.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxan.j(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxan.b(localList, paramList, (StringBuilder)localObject1);
      continue;
      aryy.a(paramMessageHandler.app, localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1, paramazml);
    }
  }
  
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awzw paramawzw)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        i = ldu.a(arrayOfByte2, 4);
        int j = arrayOfByte1.length - 8 - i;
        if (j >= 0)
        {
          arrayOfByte2 = new byte[j];
          System.arraycopy(arrayOfByte1, i + 8, arrayOfByte2, 0, j);
          bool = llm.a(arrayOfByte2);
          if (((!paramawzw.jdField_a_of_type_Boolean) && (!paramawzw.f)) || ((paramawzw.jdField_a_of_type_Long != paramawzw.jdField_b_of_type_Long) || ((paramawzw.jdField_a_of_type_Long == paramawzw.jdField_b_of_type_Long) && (!bool))))
          {
            if (QLog.isColorLevel()) {
              QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_SharpVideo return null:,isReaded:" + paramawzw.jdField_a_of_type_Boolean + "syncOther:" + paramawzw.f + ",isSharpRequest" + bool);
            }
          }
          else
          {
            ...
            else
            {
              ...
              try
              {
                ...
                if (-1 == i)
                {
                  VideoMsgTools.a(paramMessageHandler.app, 0, 6, true, paramawzw, String.valueOf(l4), false, null, false, new Object[] { paramMsg });
                  a(l4, l2, 208);
                  if (!QLog.isColorLevel()) {
                    continue;
                  }
    ...
    {
      VideoMsgTools.a(paramMessageHandler.app, 0, 6, bool, paramawzw, String.valueOf(l2), false, null, false, new Object[] { paramMsg });
      break;
    }
    label775:
    if (bool) {
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList)
  {
    ...
    for (Object localObject5 = ((ByteStringMicro)localObject5).toStringUtf8();; localObject5 = "")
    {
      ...
      localObject2 = bbea.a((byte[])localObject2);
      Object localObject6 = bbea.a((byte[])localObject1);
      ...
      for (localObject1 = localPtt.bytes_group_file_key.get().toByteArray();; localMessageRecord = null) {
        try
        {
          ...
          if (localObject6 == null)
          {
            ...
            if (localPtt.bytes_pb_reserve.has())
            {
              ...
              ((RichMsg.PttRec)localObject7).voiceLength.set(bbbr.a(l1));
              ...
              new axan().a((List)localObject3, paramList);
              ahjk.b((String)localObject2, (MessageRecord)localObject1);
              if (localObject1 == null)
              {
                return;
                m = 0;
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          for (;;)
          {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if (paramList.uint32_holiday_flag.has())
                  {
                    ...
                    if (j == 1) {
                      localMessageRecord.saveExtInfoToExtStr(axaf.jdField_c_of_type_JavaLangString, String.valueOf(j));
                    }
                    if (QLog.isColorLevel()) {
                ...
                try
                {
                  ...
                  ((MessageForPtt)localMessageRecord).waveformArray = bbga.a((ptt_waveform.PttWaveform)localObject2);
                  if (QLog.isColorLevel())
                  {
                    ...
                    for (;;)
                    {
                      if (j < k)
                      {
                        ...
                        new axan().a((List)localObject5, paramMsg, (StringBuilder)localObject4);
                        break;
                      }
                    }
            ...
            bool = ((bamk)paramMessageHandler.app.getManager(203)).a(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get());
            ...
            amnr.a(paramMsg, localMessageRecord, paramMessageHandler.app);
            if (QLog.isColorLevel())
            {
              QLog.d("Q.msg.MessageHandler", 2, ((StringBuilder)localObject4).toString());
              return;
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean)
  {
    ...
    ((ajum)paramMessageHandler.app.a(8)).a(paramMsg);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Submsgtype0x8a.ReqBody paramReqBody, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!((ArrayList)localObject2).isEmpty())
      {
        ...
        ayax localayax = (ayax)paramQQAppInterface.getManager(61);
        if (localayax != null)
        {
          List localList = localayax.a(str1);
          paramReqBody = null;
          localObject1 = null;
          ...
          for (;;)
          {
            ...
            localObject2 = ajya.a(2131706665);
            localObject3 = (SubAccountMessage)((SubAccountMessage)localObject1).deepCopyByReflect();
            ((SubAccountMessage)localObject3).msg = ((String)localObject2).concat(BaseApplicationImpl.getApplication().getString(2131694429));
            ...
            ((SubAccountMessage)localObject3).mTimeString = bbkp.a(((SubAccountMessage)localObject3).time * 1000L, true, ayaq.jdField_a_of_type_JavaLangString);
            ((SubAccountMessage)localObject3).mEmoRecentMsg = new aykk(((SubAccountMessage)localObject3).msg, 0);
            if (localayax != null) {
              localayax.a((SubAccountMessage)localObject3);
            }
            ayaq.a(paramQQAppInterface, str1, 6);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if ((TroopNotificationCache)paramArrayOfByte.a(TroopNotificationCache.class, "troopUin=? and feedsId=?", new String[] { String.valueOf(l2), str }) != null)
      {
        ...
        bame.a(paramQQAppInterface, i, l1, l2, l3, str, j, "OidbSvc.0x852_35", (short)23, false, false);
      }
    }
    paramArrayOfByte.a();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.RoutingHead paramRoutingHead)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramQQAppInterface = ((awzy)localObject1).b(paramMessageRecord.frienduin);
      ...
      if (paramQQAppInterface != null)
      {
        ...
        bbmx.a(paramMessageRecord, 0, paramQQAppInterface, 2, paramQQAppInterface.length - 2);
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "wpa------>" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      continue;
      paramQQAppInterface = ((awzy)localObject1).c(paramMessageRecord.frienduin);
      ...
      continue;
      Object localObject2 = ((awzy)localObject1).d(paramMessageRecord.frienduin);
      paramQQAppInterface = new msg_svc.BusinessWPATmp();
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "conversation------>sig:" + bbea.a((byte[])localObject2) + ",length:" + localObject2.length);
        }
      ...
      for (;;)
      {
        ...
        break;
        paramMessageRecord = ((awzy)localObject1).e(paramMessageRecord.frienduin);
        if (paramMessageRecord != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "conversation------>sigt:" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
          }
      ...
      paramMessageRecord = ((awzy)localObject1).f(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      continue;
      paramQQAppInterface = ((awzy)localObject1).a(paramMessageRecord.frienduin);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).j(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
      ...
      paramQQAppInterface = ((awzy)localObject1).m(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送附近人临时会消息 有keyLBSFriend------>" + bbea.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramQQAppInterface = ((awzy)localObject1).k(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送兴趣部落临时会消息 有key------>" + bbea.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramMessageRecord = ((awzy)localObject1).l(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "movieTicket------>" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).g(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "circleGroup------>" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).i(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "friendValidation------>" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface = ((awzy)localObject1).p(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_dating", 4, "发送附近人约会临时会话消息 有keyNearbyDating------>" + bbea.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).o(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_assistant", 4, "发送附近人助手临时会话消息 有NearbyAssistantKey------>" + bbea.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).n(paramMessageRecord.frienduin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).a(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).b(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzy)localObject1).c(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
  ...
  {
    Object localObject2 = paramQQAppInterface.a().b(ajsd.ad, 0);
        ...
        for (;;)
        {
          ...
          if (paramArrayOfByte.hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForActivateFriends))
            {
              ...
              paramQQAppInterface.a().b(ajsd.ad, 0, ((MessageForActivateFriends)localObject2).uniseq);
              continue;
              return false;
            }
          }
    ...
    do
    {
      ...
      break label113;
      paramArrayOfByte = axas.a(-5003);
      paramArrayOfByte.selfuin = paramQQAppInterface.getCurrentAccountUin();
      paramArrayOfByte.frienduin = ajsd.ad;
      paramArrayOfByte.istroop = 9002;
      paramArrayOfByte.senderuin = "";
      localObject2 = (ajxl)paramQQAppInterface.getManager(51);
      localakjv = (akjv)paramQQAppInterface.getManager(85);
      if (j != 1) {
        break label584;
      }
      ...
      ((MessageForActivateFriends)localObject2).msg = akjv.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      break label883;
      axqy.b(paramQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject2, localakjv.jdField_a_of_type_Int, 0, "", "", "", "");
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (j == 2)
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msg = akjv.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      else
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msgData = ((SubMsgType0x76.MsgBody)localObject1).toByteArray();
          localMessageForActivateFriends.msg = akjv.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8007AD4", "0X8007AD4", (int)((SubMsgType0x76.OneMemorialDayInfo)localObject2).uint32_type.get(), 0, "", "", "", "");
        }
        else
        {
          if (!QLog.isColorLevel()) {
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForLimitChatConfirm)))
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(ajya.a(2131706662)));
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    localObject2 = axwj.b((byte[])localObject2);
    if ((localObject2 == null) || (localObject2.length == 0)) {
      return null;
    }
    ...
    if (((MessageForArkApp)localObject1).ark_app_message.containStructMsg != null)
    {
      ...
      if (!"1".equals(paramChatMessage.getExtInfoFromExtStr(axaf.e))) {
        break label469;
      }
    }
    label469:
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
          ...
          localObject1 = String.format(BaseApplication.getContext().getString(2131693795), new Object[] { localObject1 });
        }
      }
    }
  }
  ...
  public static im_msg_body.RichText b(MessageForApollo paramMessageForApollo)
  {
    ...
    localApolloActMsg.uint32_peer_uin.set(bbbr.a(localApolloMessage.peer_uin));
    localApolloActMsg.uint32_sender_ts.set(bbbr.a(localApolloMessage.sender_ts));
    localApolloActMsg.uint32_peer_ts.set(bbbr.a(localApolloMessage.peer_ts));
    ...
    localObject1 = ajya.a(2131706663);
  ...
  public static void b(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awzw paramawzw)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      for (;;)
      {
        ...
        else
        {
          ...
          int i = ldu.a((byte[])localObject1, 4);
          int j = ldu.a((byte[])localObject2, 4);
          if ((i <= 0) || (j <= 0))
          {
            if (QLog.isColorLevel()) {
          ...
          else
          {
            ...
            catch (Exception localException)
            {
              ...
              boolean bool = llm.a(paramMsg);
              if (((!paramawzw.jdField_a_of_type_Boolean) && (!paramawzw.f)) || ((paramawzw.jdField_a_of_type_Long != paramawzw.jdField_b_of_type_Long) || ((paramawzw.jdField_a_of_type_Long == paramawzw.jdField_b_of_type_Long) && (!bool))))
              {
                if (QLog.isColorLevel()) {
                  QLog.e("decodeC2CMsgPkg_QCall", 2, "<---decodeC2CMsgPkg_QCall return null:,isReaded:" + paramawzw.jdField_a_of_type_Boolean + "syncOther:" + paramawzw.f + ",isSharpRequest" + bool);
                }
              }
              else
              {
                ...
                try
                {
                  new lxq(BaseApplicationImpl.getContext()).a(new axar(paramMsg, l3 - l1, paramMessageHandler, l4, l2, l1, bool));
                  return;
                }
                catch (Exception paramMessageHandler) {}
              }
  ...
  private static void b(QQAppInterface paramQQAppInterface, submsgtype0xb1.InviteInfo paramInviteInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramInviteInfo.putExtra("memberType", mua.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), localInviteInfo.uint64_group_code.get() + ""));
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      localObject2 = axwj.b((byte[])localObject1);
    ...
    try
    {
      ...
      paramChatMessage = a(axau.a(paramChatMessage.getSummery(), true, null), null);
      paramChatMessage.elems.add((MessageMicro)localObject2);
      return paramChatMessage;
    }
    catch (Exception paramChatMessage) {}
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    paramChatMessage = axwj.b(paramChatMessage);
    if ((paramChatMessage == null) || (paramChatMessage.length == 0)) {
      return null;
    }
  ...
  public static void c(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awzw paramawzw)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has()) || (paramawzw.jdField_a_of_type_Boolean) || (paramawzw.f)) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_Video return null:hasBody:" + paramMsg.msg_body.has() + ",hasMsgContent" + ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has() + ",isReaded:" + paramawzw.jdField_a_of_type_Boolean + "syncOther:" + paramawzw.f);
      }
    }
    long l1;
    long l2;
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          return;
          localHashMap = (HashMap)paramawzw.a(1000);
          paramawzw = (HashSet)paramawzw.a(1001);
          if (i != 1) {
            break label511;
          }
          if (llw.c()) {
  ...
  public static im_msg_body.RichText e(ChatMessage paramChatMessage)
  {
    ...
    paramChatMessage = new im_msg_body.Elem();
    paramChatMessage.common_elem.set((MessageMicro)localObject1);
    Object localObject2 = ajya.a(2131706661);
    localObject1 = new im_msg_body.Text();
    ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8((String)localObject2));
    localObject2 = new im_msg_body.Elem();
    ((im_msg_body.Elem)localObject2).text.set((MessageMicro)localObject1);
  ...
  public static im_msg_body.RichText f(ChatMessage paramChatMessage)
  {
    ...
    Object localObject2 = ajya.a(2131706666);
    Object localObject1 = "";
  ...
  public static im_msg_body.RichText g(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForScribble)))
    {
      ...
      localObject1 = new im_msg_body.Elem();
      localObject2 = new im_msg_body.Text();
      ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(ajya.a(2131706658)));
      ((im_msg_body.Elem)localObject1).text.set((MessageMicro)localObject2);
      ((im_msg_body.Elem)localObject1).text.setHasFlag(true);
      localObject2 = new im_msg_body.RichText();
      ((im_msg_body.RichText)localObject2).elems.add((MessageMicro)localObject1);
