...
public class ajso
  extends ajra
  implements ajkh, View.OnClickListener
{
  ...
  public ajso(FragmentActivity paramFragmentActivity)
  {
  ...
  public int a()
  {
    return this.jdField_a_of_type_Ajti.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_Int];
  }
  ...
  {
    super.a();
    a(2131369231).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131369262));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView = ((FadeIconImageView)a(2131369230));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator = ((SimpleSlidingIndicator)a(2131377844));
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager = ((QQViewPager)a(2131364479));
    this.jdField_a_of_type_Ajti = new ajti();
    int[] arrayOfInt1 = a();
    int[] arrayOfInt2 = b();
    if ((arrayOfInt1 != null) && (arrayOfInt2 != null))
    {
      this.jdField_a_of_type_Ajti.a(a(), arrayOfInt1, arrayOfInt2);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Ajti.jdField_a_of_type_ArrayOfJavaLangString, arrayOfInt1);
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsBaseTabsSimpleSlidingIndicator.setOnTabListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryViewPagerAdapter = new ChatHistoryViewPagerAdapter(a(), a(), this, this.jdField_a_of_type_Ajti, this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager.setOnPageChangeListener(new ajsp(this));
    c(0);
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 1602: 
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131689980);
      this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setVisibility(8);
      this.c = 1;
      return;
    }
