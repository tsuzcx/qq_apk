...
public class mli
  extends mci
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mlj(this);
  Intent jdField_a_of_type_AndroidContentIntent;
  public VideoController a;
  lee jdField_a_of_type_Lee = new mll(this);
  lfk jdField_a_of_type_Lfk = new mlk(this);
  ...
  public mli(VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, Intent paramIntent)
  {
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      bdla.b(null, "dc00899", "Grp_video", "", "invite", (String)localObject, 0, 0, String.valueOf(this.jdField_a_of_type_ComTencentAvVideoController.a().g), this.jdField_d_of_type_Int + "", "", "");
      bool1 = true;
      return bool1;
    }
  }
  ...
  public int a(long paramLong, Intent paramIntent)
  {
    ...
    if (mrr.b(this.jdField_b_of_type_Int))
    {
      ...
      paramIntent = lbz.a(this.jdField_c_of_type_Int, String.valueOf(this.jdField_a_of_type_Long), new int[0]);
      if (lbz.a().a(paramIntent))
      {
        this.jdField_a_of_type_Lfe = lbz.a().c(paramIntent);
        return 2;
      }
      this.jdField_a_of_type_Lfe = lbz.a().a();
      return 2;
    }
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Lfe = lbz.a().c(paramIntent);
      this.jdField_a_of_type_Lfe.a(paramLong, "onStartCommand.1", 4);
      this.jdField_a_of_type_Lfe.e("onStartCommand", true);
    ...
    {
      this.jdField_a_of_type_Lfe.a(paramLong, "onStartCommand.2", 1);
    ...
    for (;;)
    {
      ...
      return 2;
      this.jdField_a_of_type_Lfe.a(paramLong, "onStartCommand.3", 2);
      paramIntent = this.jdField_a_of_type_Lfe;
  ...
  public void a(long paramLong)
  {
    ...
    int i = 1;
    if (!this.jdField_a_of_type_Lfe.N) {
      i = 4;
    }
    if (1008 == this.jdField_a_of_type_Lfe.j) {
      i = 4;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Mlh != null) {
          this.jdField_a_of_type_Mlh.c(anvx.a(2131715646));
        }
        if (!this.jdField_a_of_type_Lfe.S) {
          break;
        }
        ...
        return;
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_a_of_type_Lfe.jdField_d_of_type_JavaLangString, j, i);
      }
  ...
  protected boolean a()
  {
    if (this.jdField_a_of_type_Mvp == null) {
      this.jdField_a_of_type_Mvp = new mvp(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext(), 1, "video wifi lock");
    }
    if ((mtj.f(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext())) && (this.jdField_a_of_type_Mvp != null)) {
  ...
  public void b(long paramLong)
  {
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      long l = mry.a(this.jdField_c_of_type_JavaLangString);
  ...
  public void d(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Mlh != null) {
      this.jdField_a_of_type_Mlh.c(anvx.a(2131715647));
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_Int, this.jdField_a_of_type_Lfe.g, this.jdField_a_of_type_ArrayOfLong, false);
