...
public class bewh
{
  private static volatile bewh a;
  protected List<bbgl> a;
  protected List<bewj> b;
  ...
  public static bewh a()
  {
    if (jdField_a_of_type_Bewh == null) {}
    try
    {
      if (jdField_a_of_type_Bewh == null) {
        jdField_a_of_type_Bewh = new bewh();
      }
      return jdField_a_of_type_Bewh;
    }
    finally {}
  }
  ...
  public static ArrayList<Long> a(List<? extends bbgm> paramList)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        Object localObject = (bbgm)paramList.get(i);
        if ((localObject instanceof bbfg))
        {
          localObject = (bbfg)localObject;
          try
          {
            if ((((bbfg)localObject).a() == 0) || (((bbfg)localObject).a() == 3)) {
              break label116;
            }
            localArrayList.add(Long.valueOf(Long.parseLong(((bbfg)localObject).d())));
          }
  ...
  public final bbfg a(String paramString)
  {
    ...
    while (i < j)
    {
      bbgl localbbgl = (bbgl)this.jdField_a_of_type_JavaUtilList.get(i);
      if (((localbbgl instanceof bbfg)) && (paramString.equals(localbbgl.d()))) {
        return (bbfg)localbbgl;
      }
      i += 1;
    }
    return null;
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    if (this.b == null)
    {
      ...
      localObject = (bewj)this.b.get(j);
      if (!((bewj)localObject).a.equals(paramString2)) {
        break label143;
      }
    }
    label143:
    label152:
    for (Object localObject = bewj.a(paramString1, (bewj)localObject);; localObject = null)
    {
  ...
  public List<bbgl> a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList1 = new ArrayList();
    ExecutorService localExecutorService = Executors.newFixedThreadPool(1);
    ArrayList localArrayList2 = new ArrayList();
    localArrayList2.add(localExecutorService.submit(new bewi(this, paramContext, paramQQAppInterface, bbgl.E, paramInt)));
    paramInt = 0;
    try
    {
  ...
  @SuppressLint({"UseSparseArrays"})
  public List<bbgl> a(Context paramContext, QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    if (localanmw != null)
    {
      ...
      if (localObject != null)
      {
        ...
        while (localIterator1.hasNext())
        {
          ...
          localObject = localanmw.a(String.valueOf(localGroups.group_id));
          if (localObject != null)
          {
            ...
            label176:
            for (localObject = paramContext.getResources().getString(2131718934);; localObject = localGroups.group_name)
            {
              localArrayList.add(new bbfg(paramContext, paramQQAppInterface, localFriends, (String)localObject, 0L, paramLong));
              break label105;
              break;
            }
          }
    ...
    if (paramBoolean)
    {
      ...
      localArrayList.add(new bbfg(paramContext, paramQQAppInterface, (Friends)localObject, paramContext.getResources().getString(2131718934), 0L, paramLong));
    }
  ...
  public List<bewj> a(Context paramContext, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList = new ArrayList();
    anmw localanmw = (anmw)paramQQAppInterface.getManager(51);
    if (localanmw != null)
    {
      Object localObject1 = localanmw.b();
      if (localObject1 != null)
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          Object localObject2 = localanmw.a(String.valueOf(((Groups)((Iterator)localObject1).next()).group_id));
          if (localObject2 != null)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              localArrayList.add(new bewj(paramContext, localFriends.uin, localFriends.name, localFriends.remark));
            }
          }
        }
      }
    ...
    if (paramBoolean) {
      localArrayList.add(new bewj(paramContext, paramQQAppInterface.getCurrentAccountUin(), paramQQAppInterface.getCurrentNickname(), null));
    }
    long l2 = System.currentTimeMillis();
    if (QLog.isColorLevel()) {
