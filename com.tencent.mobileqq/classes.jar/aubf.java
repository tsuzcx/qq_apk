...
public class aubf
{
  private static aubf jdField_a_of_type_Aubf;
  ...
  public static aubf a()
  {
    try
    {
      if (jdField_a_of_type_Aubf == null) {
        jdField_a_of_type_Aubf = new aubf();
      }
      aubf localaubf = jdField_a_of_type_Aubf;
      return localaubf;
    }
    finally {}
  }
    ...
    if (localObject1 != null)
    {
      ...
      if (localArrayList.size() == 0)
      {
        ...
        if ((localObject1 != null) && (!TextUtils.isEmpty(((EndPoint)localObject1).host)))
        {
          ...
          if (!beus.b(((EndPoint)localObject1).host)) {
            break label304;
          }
