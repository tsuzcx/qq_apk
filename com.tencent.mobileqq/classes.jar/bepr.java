...
public class bepr
  implements Manager
{
  private beqb jdField_a_of_type_Beqb;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager;
  private boolean jdField_a_of_type_Boolean;
  
  public bepr(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Beqb = new beqb();
    ThreadManager.getSubThreadHandler().post(new TroopHonorManager.1(this));
  }
  
  public List<beqa> a(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    paramString = bepv.a(paramString);
    if ((paramString != null) && (paramString.size() > 0))
    {
      ...
      while (paramString.hasNext())
      {
        ...
        localObject = this.jdField_a_of_type_Beqb.a(((Integer)localObject).intValue());
        if (localObject != null) {
  ...
  public List<beqa> a(String paramString1, String paramString2)
  {
    if (!b(paramString1)) {
      return null;
    }
  ...
  public void a(beqb parambeqb, boolean paramBoolean)
  {
    if (parambeqb == null) {}
    for (;;)
    {
      ...
      else
      {
        ...
        this.jdField_a_of_type_Beqb = parambeqb;
        if (QLog.isColorLevel()) {
          QLog.d("TroopHonor.manager", 2, String.format("updateConfig, isInit: %s, config: %s", new Object[] { Boolean.valueOf(paramBoolean), parambeqb }));
        }
        if (!paramBoolean) {
          ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).notifyUI(80, true, null);
        }
      }
    }
  }
  
  public void a(String paramString1, String paramString2, bepu parambepu)
  {
    ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(paramString1, paramString2, new beps(this, paramString1, paramString2, parambepu));
  }
      ...
      try
      {
        ...
        if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
        {
          ...
          if (((Iterator)localObject).hasNext())
          {
            ...
            a(paramString, str, bepv.a(paramArrayOfByte));
            if ((!TextUtils.isEmpty(str)) && (str.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
              ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).notifyUI(80, true, new Object[] { paramString, str });
            }
            if (!QLog.isColorLevel()) {
              continue;
            }
  ...
  {
    if ((this.jdField_a_of_type_Beqb != null) && (this.jdField_a_of_type_Beqb.jdField_a_of_type_Boolean)) {}
    for (int i = 1;; i = 0)
    {
      TroopManager localTroopManager = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
      if (i == 0)
  ...
  public void b(String paramString1, String paramString2, bepu parambepu)
  {
    if ((!b(paramString1)) && (parambepu != null))
    {
      parambepu.a(null);
      return;
    }
    ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(paramString1, paramString2, new bept(this, paramString1, paramString2, parambepu));
  }
