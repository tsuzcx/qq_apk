  ...
  extends anud
{
  ...
  public odp(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public odp(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          tpx.a("AdVideoDataLink", "视频浮层混排回包: article size=" + localList.size());
          ...
          try
          {
            ...
            tpx.a("AdVideoDataLink", "isAd = " + ((VideoInfo)localObject2).jdField_c_of_type_Boolean + " article = " + ((VideoInfo)localObject2).jdField_c_of_type_JavaLangString);
          }
      ...
      if (!bool3)
      {
        ...
        nzx.a(localBundle, (ArrayList)localObject4);
        ...
        localObject3 = localObject5;
        localObject1 = localStringBuilder;
        nzx.a(localRspBody, localBundle, this.jdField_a_of_type_Long);
        paramFromServiceMsg = null;
        paramObject = null;
        continue;
        paramObject = localObject1;
  ...
  private void a(Object paramObject, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<oidb_0x885.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, int paramInt7, ArrayList<VideoInfo> paramArrayList2, Bundle paramBundle)
  {
    ...
    paramString3.msg_phone_info.set(tpb.a());
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramString1 = new acwc();
        paramString1.jdField_a_of_type_JavaLangString = "ce2d9f";
        paramString1 = acwb.a(BaseApplication.getContext(), paramString1);
      ...
      catch (Exception paramString3)
      {
        ...
        for (;;)
        {
          ...
          for (paramInt1 = 1;; paramInt1 = 0)
          {
            ...
            ((JSONObject)localObject2).put("last_expo_ad_pos", oct.a().a());
            ((JSONObject)localObject2).put("last_req_video_cnt", oct.a().b());
    ...
    for (;;)
    {
      tpx.a("AdVideoDataLink", paramString1.toString());
      break;
    ...
    label2025:
    a(localReqBody);
    paramInt1 = ((Integer)bnrf.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0))).intValue();
  ...
  private void a(oidb_0x6cf.ReqBody paramReqBody)
  {
    ...
    if (i < k)
    {
      ...
      str = bhny.a(BaseApplicationImpl.getContext(), str);
    ...
    try
    {
      ...
      try
      {
        ...
        if (k == 2) {
          ...
          {
            localVideoInfo.jdField_a_of_type_Odl = new odl();
            localVideoInfo.jdField_a_of_type_Odl.jdField_a_of_type_JavaLangString = str1;
            localVideoInfo.jdField_a_of_type_Odl.jdField_b_of_type_JavaLangString = str2;
            localVideoInfo.jdField_a_of_type_Odl.jdField_c_of_type_JavaLangString = str3;
            localVideoInfo.jdField_a_of_type_Odl.jdField_d_of_type_JavaLangString = str4;
            localVideoInfo.jdField_a_of_type_Odl.jdField_e_of_type_JavaLangString = str5;
            localVideoInfo.jdField_a_of_type_Odl.jdField_f_of_type_JavaLangString = str6;
            localVideoInfo.jdField_a_of_type_Odl.jdField_g_of_type_JavaLangString = str7;
            localVideoInfo.jdField_a_of_type_Odl.jdField_h_of_type_JavaLangString = str8;
            localVideoInfo.jdField_a_of_type_Odl.i = str9;
            localVideoInfo.jdField_a_of_type_Odl.jdField_j_of_type_JavaLangString = str10;
            localVideoInfo.jdField_a_of_type_Odl.jdField_k_of_type_JavaLangString = str11;
            localVideoInfo.jdField_a_of_type_Odl.jdField_l_of_type_JavaLangString = str12;
            localVideoInfo.jdField_a_of_type_Odl.jdField_m_of_type_JavaLangString = str13;
            localVideoInfo.jdField_a_of_type_Odl.jdField_a_of_type_Int = i;
            localVideoInfo.jdField_a_of_type_Odl.jdField_b_of_type_Int = j;
            localVideoInfo.jdField_a_of_type_Odl.jdField_n_of_type_JavaLangString = ((String)localObject5);
            localVideoInfo.jdField_a_of_type_Odl.jdField_c_of_type_Int = k;
          }
        }
      }
      catch (Exception localException4)
      {
        for (;;)
        {
          ...
          {
            localVideoInfo.jdField_b_of_type_Odl = new odl();
            localVideoInfo.jdField_b_of_type_Odl.jdField_a_of_type_JavaLangString = localException4;
            localVideoInfo.jdField_b_of_type_Odl.jdField_b_of_type_JavaLangString = str2;
            localVideoInfo.jdField_b_of_type_Odl.jdField_c_of_type_JavaLangString = str3;
            localVideoInfo.jdField_b_of_type_Odl.jdField_d_of_type_JavaLangString = str4;
            localVideoInfo.jdField_b_of_type_Odl.jdField_e_of_type_JavaLangString = str5;
            localVideoInfo.jdField_b_of_type_Odl.jdField_f_of_type_JavaLangString = str6;
            localVideoInfo.jdField_b_of_type_Odl.jdField_g_of_type_JavaLangString = str7;
            localVideoInfo.jdField_b_of_type_Odl.jdField_h_of_type_JavaLangString = str8;
            localVideoInfo.jdField_b_of_type_Odl.i = str9;
            localVideoInfo.jdField_b_of_type_Odl.jdField_j_of_type_JavaLangString = str10;
            localVideoInfo.jdField_b_of_type_Odl.jdField_k_of_type_JavaLangString = str11;
            localVideoInfo.jdField_b_of_type_Odl.jdField_l_of_type_JavaLangString = str12;
            localVideoInfo.jdField_b_of_type_Odl.jdField_m_of_type_JavaLangString = str13;
            localVideoInfo.jdField_b_of_type_Odl.jdField_a_of_type_Int = i;
            localVideoInfo.jdField_b_of_type_Odl.jdField_b_of_type_Int = j;
            localVideoInfo.jdField_b_of_type_Odl.jdField_n_of_type_JavaLangString = ((String)localObject5);
            localVideoInfo.jdField_b_of_type_Odl.jdField_c_of_type_Int = k;
          }
        }
      }
      try
      {
        ...
        {
          localVideoInfo.jdField_b_of_type_Odl = new odl();
          localVideoInfo.jdField_b_of_type_Odl.jdField_a_of_type_JavaLangString = str1;
          localVideoInfo.jdField_b_of_type_Odl.jdField_b_of_type_JavaLangString = str2;
          localVideoInfo.jdField_b_of_type_Odl.jdField_c_of_type_JavaLangString = str3;
          localVideoInfo.jdField_b_of_type_Odl.jdField_d_of_type_JavaLangString = str4;
          localVideoInfo.jdField_b_of_type_Odl.jdField_e_of_type_JavaLangString = str5;
      ...
      catch (Exception localException2)
      {
        ...
        for (;;)
        {
          ...
          if ((paramArticleSummary.bytes_video_subscript_txt.has()) && (paramArticleSummary.bytes_video_subscript_txt.get() != null)) {
            localVideoInfo.x = paramArticleSummary.bytes_video_subscript_txt.get().toStringUtf8();
          }
          if ((paramArticleSummary.bytes_video_subscript_color.has()) && (paramArticleSummary.bytes_video_subscript_color.get() != null)) {
            localVideoInfo.y = paramArticleSummary.bytes_video_subscript_color.get().toStringUtf8();
          }
          Object localObject3;
          ...
          else
          {
            ...
            if (paramArticleSummary.bytes_video_report_info.has()) {
              localVideoInfo.z = a(paramArticleSummary.bytes_video_report_info);
            }
            if (paramArticleSummary.uint64_article_id.has()) {
              localVideoInfo.jdField_c_of_type_Long = paramArticleSummary.uint64_article_id.get();
            }
          ...
          catch (JSONException localJSONException1)
          {
            try
            {
              ...
              localVideoInfo.q = ((JSONObject)localObject3).optString("thirdUinName");
              ...
              if ((paramArticleSummary.uint32_is_ugc.has()) && (paramArticleSummary.uint32_is_ugc.get() == 1))
              {
                ...
                if ((paramArticleSummary.msg_ugc_feeds_info.has()) && (paramArticleSummary.msg_ugc_feeds_info.get() != null))
                {
                  ...
                  if ((((oidb_0x6cf.UGCFeedsInfo)localObject3).msg_ugc_video_info_list.has()) && (((oidb_0x6cf.UGCFeedsInfo)localObject3).msg_ugc_video_info_list.get() != null))
                  {
                    ...
                    localVideoInfo.r = a(((oidb_0x6cf.UGCVideoInfo)localObject3).bytes_video_url);
        ...
        AdvertisementInfo localAdvertisementInfo = nzq.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
        if (!tpz.a(null, localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) {
          break label4170;
        }
        ...
        try
        {
          ...
          nzq.a(new tlx().a(BaseApplication.getContext()).a(nzq.jdField_k_of_type_Int).b(nzq.V).a(localAdvertisementInfo).a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo).b(localJSONObject).a());
          tqa.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
          ...
          localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$SoftAdDownloadBarInfo.jdField_a_of_type_Tmd = tmd.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$SoftAdDownloadBarInfo.jdField_e_of_type_JavaLangString);
        ...
        catch (JSONException localJSONException2)
        {
          ...
          localVideoInfo.A = a(paramArticleSummary.bytes_avatar_jump_url);
          ...
          nzx.a(paramArticleSummary, localVideoInfo);
          ...
          for (bool = true;; bool = false)
          {
            ...
            localVideoInfo.w = a(paramArticleSummary.bytes_wechat_share_url);
  ...
  public void a(odq paramodq, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, ArrayList<VideoInfo> paramArrayList2)
  {
    a(paramodq, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramArrayList2, null);
  }
  ...
  public void a(odq paramodq, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, ArrayList<VideoInfo> paramArrayList2, Bundle paramBundle)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.1(this, paramodq, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramArrayList2, paramBundle), 5, null, true);
  }
  ...
  public void a(odq paramodq, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<VideoInfo.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, ArrayList<VideoInfo> paramArrayList2)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.2(this, paramArrayList, paramodq, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramInt5, paramInt6, paramArrayList2), 5, null, true);
  }
  
  public void a(odq paramodq, long paramLong, String paramString, int paramInt, VideoInfo paramVideoInfo)
  {
    ThreadManager.post(new VideoPlayRecommendHandler.3(this, paramLong, paramInt, paramString, paramodq, paramVideoInfo), 5, null, true);
  }
  
  public void a(odq paramodq, String paramString, int paramInt, boolean paramBoolean)
  {
    oidb_0x6cf.ReqBody localReqBody = new oidb_0x6cf.ReqBody();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString = qfq.a("OidbSvc.0x6cf", 1743, 1, localReqBody.toByteArray());
      paramString.addAttribute("is_from_first_recommend_video", Boolean.valueOf(true));
      paramString.addAttribute("VALUE_OBSERVER_TAG", Integer.valueOf(paramodq.hashCode()));
