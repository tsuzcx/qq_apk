...
public class onb
{
  public static int a()
  {
    SharedPreferences localSharedPreferences = a(onh.a());
  ...
  {
    int i = bbkb.N(BaseApplicationImpl.getApplication(), onh.a());
    int j = a();
  ...
  private static void a(SharedPreferences paramSharedPreferences)
  {
    ...
    {
      List localList = qeb.a(paramSharedPreferences.getAll().keySet(), new onc());
  ...
  public static void d()
  {
    ...
    if (localObject != null)
    {
      ...
      if (((SharedPreferences.Editor)localObject).commit())
      {
        ...
        localObject = bhvy.a(onh.a(), false, true);
        if (localObject == null) {
          break label138;
        }
        localObject = ((SharedPreferences)localObject).edit();
  ...
  public static void e()
  {
    ...
    try
    {
      aukq localaukq = osg.a().a();
      if ((localaukq instanceof ReadInJoyEntityManagerFactory)) {
        ((ReadInJoyEntityManagerFactory)localaukq).a();
      }
      return;
    }
    catch (Exception localException)
  ...
  private static void g()
  {
    ...
    SettingCloneUtil.writeValue(BaseApplicationImpl.getApplication(), onh.a(), null, "qqsetting_kandian_download_pic_flag", false);
  ...
  private static void h()
  {
    ...
    Object localObject = new File(bdfn.e());
    ...
    try
    {
      localObject = (pyy)onh.a().getManager(271);
      if (localObject != null)
      {
        ((pyy)localObject).a();
