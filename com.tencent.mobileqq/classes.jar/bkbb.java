...
public class bkbb
{
  ...
  private List<bkbq> jdField_a_of_type_JavaUtilList = new ArrayList();
  private List<String> b = new ArrayList();
  
  public bkbb(JSONObject paramJSONObject)
  {
      ...
      try
      {
        ...
        if (localObject != null)
        {
          ...
          if (i < ((JSONArray)localObject).length())
          {
            ...
            this.jdField_a_of_type_JavaUtilList.add(new bkbq(localJSONObject));
            break label248;
          }
        }
  ...
  public boolean a(Object paramObject)
  {
    if (!this.jdField_a_of_type_JavaUtilList.isEmpty())
    {
      ...
      {
        bkbq localbkbq = (bkbq)localIterator.next();
        if (!localbkbq.a()) {
          return false;
        }
        if (!localbkbq.a(paramObject)) {
          return false;
        }
      }
      return true;
