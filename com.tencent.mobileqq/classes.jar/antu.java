  ...
  extends BusinessHandler
{
  ...
  private CopyOnWriteArrayList<asio> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public antu(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, EmosmPb.RspBody paramRspBody)
  {
    ...
    if (paramRspBody.msg_subcmd0x19_rsp.has())
    {
      ...
      localawyr = (awyr)this.app.getManager(QQManagerFactory.EMOTICON_MANAGER);
      localEmoticonPackage = localawyr.a(String.valueOf(i), paramInt);
      if (localEmoticonPackage != null)
      {
        ...
        if (TextUtils.isEmpty(str)) {
          paramRspBody = anvx.a(2131703563);
        }
  ...
  private void a(int paramInt, EmosmPb.RspBody paramRspBody, awyr paramawyr)
  {
    ...
    if (bool1)
    {
      ...
      paramawyr.a(paramRspBody, paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(EmosmPb.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.size() > 1))
    {
      ...
      ((CommonUsedSystemEmojiManager)this.app.getManager(QQManagerFactory.COMMONUSED_SYSTEM_EMOJI_MANAGERT)).updateItemInfo(paramRspBody);
      return;
    }
  ...
  {
    awyr localawyr = (awyr)this.app.getManager(QQManagerFactory.EMOTICON_MANAGER);
    if (paramInt1 == 2)
    {
      if (paramBoolean)
      {
        ThreadManagerV2.excute(new EmoticonHandler.1(this, localawyr, paramEmoticonResp, paramInt2), 32, null, true);
        return;
      }
    ...
    if (paramInt1 == 3)
    {
      ...
      while (paramFromServiceMsg.hasNext()) {
        ((asio)paramFromServiceMsg.next()).a(paramBoolean, paramInt1, paramEmoticonResp);
      }
    }
    notifyUI(paramInt1, paramBoolean, paramEmoticonResp);
  }
  
  private void a(ToServiceMsg paramToServiceMsg, int paramInt, EmoticonResp paramEmoticonResp, awyr paramawyr)
  {
    ...
    for (;;)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        paramawyr.g(paramEmoticonResp, paramInt);
        paramEmoticonResp = paramawyr.a(paramEmoticonResp, paramInt);
        asig.a().b(paramEmoticonResp);
      }
    }
  }
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        case 1: 
          ...
          ((awyr)localObject).g(paramToServiceMsg, j);
          paramToServiceMsg = ((awyr)localObject).a(paramToServiceMsg, j);
          asig.a().b(paramToServiceMsg);
          break;
        case 17: 
          a(paramToServiceMsg, j, localEmoticonResp, (awyr)localObject);
          break;
        case 2: 
      ...
      if (paramToServiceMsg.extraData.getBoolean("EmosmSubCmdFllow"))
      {
        ...
        a(j, paramArrayOfByte, (awyr)localObject);
        continue;
        a(paramArrayOfByte);
        continue;
    ...
    for (;;)
    {
      try
      {
        ...
        case 1: 
          ...
          if (this.app != null)
          {
            localObject3 = (awyr)this.app.getManager(QQManagerFactory.EMOTICON_MANAGER);
            if (localObject3 != null)
            {
              localObject1 = ((awyr)localObject3).a((String)localObject1);
              ((EmoticonPackage)localObject1).ipSiteInfo = ((VipIPSiteInfo)localObject2);
              ((EmoticonPackage)localObject1).ipSiteInfoBytes = ((awyr)localObject3).a((VipIPSiteInfo)localObject2);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localReqBody.str_app_version.set("8.4.10");
  ...
  public void a(asio paramasio)
  {
    if (paramasio != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.addIfAbsent(paramasio);
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    paramString.str_app_version.set("8.4.10");
  ...
  public void a(String paramString, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramList2.str_app_version.set("8.4.10");
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    localModuleReq.mqqver.set("8.4.10");
  ...
  public void a(List<String> paramList, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        ...
        paramList.str_app_version.set("8.4.10");
  ...
  public void b()
  {
    ...
    localReqBody.str_app_version.set("8.4.10");
    Object localObject1 = ((CommonUsedSystemEmojiManager)this.app.getManager(QQManagerFactory.COMMONUSED_SYSTEM_EMOJI_MANAGERT)).getLocalSystemEmojiInfoFromFile();
  ...
  public void b(asio paramasio)
  {
    if (paramasio != null) {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramasio);
    }
  }
    ...
    if (localObject1 != null)
    {
      ...
      if ((localJSONArray != null) && (localJSONArray.length() > 0))
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          for (;;)
          {
            String str2 = bhnp.a(BaseApplicationImpl.context, "emojiDetail", String.valueOf(j), "") + "&sceneType=1";
        ...
        localObject2 = (awyr)this.app.getManager(QQManagerFactory.EMOTICON_MANAGER);
        if (localObject2 != null) {
          ((awyr)localObject2).a((EmosmPb.SubCmd0x5RspBQRecommend)localObject1, 1);
        }
      }
    }
  }
