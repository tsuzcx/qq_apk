...
{
  public affs(TroopMemberListActivity paramTroopMemberListActivity) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j == 2131365473)
        {
          ...
          if (this.a.jdField_d_of_type_Int == 20)
          {
            ...
            localObject1 = ((afgp)localObject2).a.getTag();
            ...
            localObject1 = (afgi)this.a.jdField_a_of_type_Afgk.getItem(i);
            this.a.a((afgi)localObject1);
            break;
            i = 0;
            break label100;
            label314:
          ...
          {
            if (this.a.jdField_a_of_type_Afgk.jdField_b_of_type_JavaUtilList.contains(localObject1)) {
              this.a.jdField_a_of_type_Afgk.jdField_b_of_type_JavaUtilList.remove(localObject1);
            }
            for (;;)
            {
              TroopMemberListActivity.a(this.a);
              this.a.jdField_a_of_type_Afgk.notifyDataSetChanged();
              break;
              if (i != 0) {
                this.a.jdField_a_of_type_Afgk.jdField_b_of_type_JavaUtilList.add(localObject1);
              }
            }
          }
          if (bool1)
          {
            ...
            if (localObject2 != null) {
              ((afgp)localObject2).a.a(true);
            }
            if (!TextUtils.isEmpty(this.a.u))
            {
              localObject2 = this.a.a(this.a.u, bool1);
              if (localObject2 != null) {
                ((afgp)localObject2).a.b(true);
              }
            }
      ...
      if (j == 2131377832)
      {
        ...
        for (;;)
        {
          ...
          {
            ((afgp)localObject1).a.b(true);
            this.a.u = "";
          }
          this.a.jdField_a_of_type_Afgm.notifyDataSetChanged();
          break;
          label767:
          if (i != 0) {
            this.a.jdField_a_of_type_Afgk.jdField_b_of_type_JavaUtilList.add(localObject1);
      ...
      else if ((j == 2131363940) && (this.a.c))
      {
        ...
        {
          if (this.a.isResume()) {
            QQToast.a(this.a, this.a.getString(2131694255), 0).b(this.a.getTitleBarHeight());
          }
        }
