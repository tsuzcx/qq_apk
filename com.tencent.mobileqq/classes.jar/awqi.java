  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject2 = paramView.getTag(2131376880);
    Object localObject3 = paramView.getTag(2131376881);
    ...
    if ((localObject2 instanceof String))
    {
      ...
      if ((localContext instanceof UniteSearchActivity))
      {
        ...
        default: 
          i = 0;
          awvy.a("all_result", "clk_relatedsearch_list", new String[] { "" + localObject3, ((UniteSearchActivity)localObject1).a + "", "" + awvv.a((String)localObject3, i) });
          paramView = (awne)paramView.getTag(2131379208);
    ...
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject1).put("experiment_id", awso.b);
        QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        ReportModelDC02528 localReportModelDC02528 = new ReportModelDC02528().module("all_result").action("clk_relatedsearch_list").obj1(paramView.d() + "").obj2(paramView.b).ver1(paramView.a()).ver2(awso.a(paramView.a));
        if (localObject3 == null)
        {
          paramView = "";
          awso.a(null, localReportModelDC02528.ver4(paramView).ver7(((JSONObject)localObject1).toString()).session_id(localQQAppInterface.getCurrentAccountUin() + awiu.a));
          localObject1 = awvv.e(i);
          ...
          paramView = awvv.a((String)localObject3, 3, paramView);
          if (QLog.isColorLevel()) {
      ...
      catch (JSONException localJSONException)
      {
        ...
        {
          localObject1 = bbej.a(((BaseActivity)localContext).app, localContext, paramView);
