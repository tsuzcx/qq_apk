  ...
  public static boolean c()
  {
    for (;;)
    {
      try
      {
        ...
        switch (bajo.a(bajo.a(), "libvipfont808.so"))
        {
        case 1: 
          ...
          localObject1 = ((ajjj)localQQAppInterface.getManager(51)).a(localQQAppInterface.getAccount());
          if ((localObject1 != null) && (0L != ((ExtensionInfo)localObject1).uVipFont) && (((ExtensionInfo)localObject1).vipFontType == 1))
          {
            localObject1 = "0";
            awqx.b(localQQAppInterface, "CliOper", "", "", "Font_Mall", "0X80072C8", 0, 0, "1", (String)localObject1, "", "");
            if (!QLog.isColorLevel()) {
              break label250;
            }
