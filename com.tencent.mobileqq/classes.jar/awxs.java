  ...
  implements INetInfoHandler
{
  ...
  public void a(bawy parambawy, int paramInt)
  {
    Object localObject = null;
    if (parambawy != null)
    {
      localObject = new StringBuffer(200);
      ((StringBuffer)localObject).append("http://").append(parambawy.jdField_a_of_type_JavaLangString);
      if (parambawy.jdField_a_of_type_Int != 80) {
        ((StringBuffer)localObject).append(":").append(parambawy.jdField_a_of_type_Int);
      }
