...
public class bhjm
{
  ...
  private WeakReference<bhjn> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private final String b = "a4d7xwsbelhregistercard";
  private final String c = "https://proxy.vip.qq.com/cgi-bin/srfentry.fcgi";
  
  public bhjm(String paramString, bhjn parambhjn)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambhjn);
  }
  ...
  private bhjh a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bhjh((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bhjh();
        ((bhjh)localObject).a = i;
        return localObject;
      }
    }
  ...
  private void a(bhjh parambhjh)
  {
    ...
    {
      ((bctj)localObject2).a(null, "reg_lh_check_uin", bool, l1 - l2, 0L, (HashMap)localObject1, "", true);
      localObject1 = (bhjn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject1 != null) {
        break label159;
      }
      return;
      localObject1 = parambhjh.toString();
      break;
      i = -30009;
      break label63;
    }
    label159:
    ThreadManagerV2.getUIHandlerV2().post(new CheckRegisterLiangHao.2(this, (bhjn)localObject1, parambhjh));
  }
