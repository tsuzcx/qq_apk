  ...
  implements bgfk
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bgbb(this, Looper.getMainLooper());
  private bgau jdField_a_of_type_Bgau;
  private bgbc jdField_a_of_type_Bgbc;
  
  bgba(bgau parambgau, bgbc parambgbc)
  {
    this.jdField_a_of_type_Bgbc = parambgbc;
    this.jdField_a_of_type_Bgau = parambgau;
    NetworkState.addListener(this);
  }
  
  void a()
  {
    if ((bgau.b()) && (this.jdField_a_of_type_Bgbc.a() != null)) {
      try
      {
        ...
        while (i < j)
        {
          ...
          this.jdField_a_of_type_Bgau.a(str, this, 0);
          i += 1;
        }
        return;
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if ((jdField_a_of_type_Int < paramInt) && (this.jdField_a_of_type_Bgau != null))
    {
