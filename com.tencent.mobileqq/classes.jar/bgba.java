  ...
  extends Handler
{
  ...
  public bgba(SubmitHomeWorkFragment paramSubmitHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        ...
        if (paramSubmitHomeWorkFragment.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
        {
          ...
          paramSubmitHomeWorkFragment.jdField_b_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.setHint(paramSubmitHomeWorkFragment.getActivity().getString(2131696815));
      ...
      while (localIterator.hasNext())
      {
        ...
        paramSubmitHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.a(bgeh.a(localJSONObject));
      }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      ...
      localSubmitHomeWorkFragment.jdField_a_of_type_Blir.d(false);
      return;
    case 513: 
    ...
    if (i < 1000)
    {
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), anzj.a(2131713435), 0).a();
      localSubmitHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCommonRecordSoundPanel.d();
      return;
    }
    if (!bhnv.d(localSubmitHomeWorkFragment.getActivity()))
    {
      if (QLog.isColorLevel()) {
        QLog.d("SubmitHomeWorkFragment", 2, "no network toast");
      }
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), 2131696546, 0).a();
      localSubmitHomeWorkFragment.jdField_a_of_type_Boolean = false;
      localSubmitHomeWorkFragment.j();
      return;
    }
    ...
    {
      paramMessage = new bgef(paramMessage, null, i / 1000, (int)l, localSubmitHomeWorkFragment.d);
