...
public class wab
  extends uhw<QQStoryShareGroupProfileActivity, uow>
{
  public wab(QQStoryShareGroupProfileActivity paramQQStoryShareGroupProfileActivity)
  {
  ...
  {
    if ((paramuow.b != 3) || (paramuow.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem == null)) {}
    ...
    do
    {
      ...
      if (paramuow.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.mHadLike == 1)
      {
        i = 1;
        ...
        } while (!localHotSortVideoEntry.feedId.equals(paramuow.jdField_a_of_type_JavaLangString));
        if (i == 0) {
          break label164;
        }
      }
      for (int j = localHotSortVideoEntry.likeCount + 1;; j = localHotSortVideoEntry.likeCount - 1)
      {
        ...
        localwbb.a(localHotSortVideoEntry);
  ...
  public void b(@NonNull QQStoryShareGroupProfileActivity paramQQStoryShareGroupProfileActivity, @NonNull uow paramuow) {}
}
