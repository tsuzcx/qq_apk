...
{
  public awve(StructMsgForGeneralShare paramStructMsgForGeneralShare, Context paramContext, Resources paramResources, PopupWindow paramPopupWindow) {}
  ...
  public void onClick(View paramView)
  {
    ...
    try
    {
      ViewGroup localViewGroup = (ViewGroup)((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment().a().c.findViewById(2131297012);
    ...
    catch (Exception localException)
    {
      ...
      k = aciy.a(106.0F, this.jdField_a_of_type_AndroidContentResResources);
    ...
    this.jdField_a_of_type_AndroidWidgetPopupWindow.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846008));
    ...
    for (;;)
    {
      ((nfw)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(139)).a(9, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message);
      ...
      this.jdField_a_of_type_AndroidWidgetPopupWindow.setOnDismissListener(new awvf(this));
      return;
      label257:
      this.jdField_a_of_type_AndroidWidgetPopupWindow.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846007));
