...
public class awve
{
  static awvf jdField_a_of_type_Awvf;
  ...
  {
    if (jdField_a_of_type_Awvf == null)
    {
      ...
      paramString1.start();
      jdField_a_of_type_Awvf = new awvf(paramString1.getLooper());
      jdField_a_of_type_Awvf.sendEmptyMessageDelayed(1, paramLong);
      jdField_a_of_type_Awvf.sendEmptyMessageDelayed(2, paramLong);
    }
  }
