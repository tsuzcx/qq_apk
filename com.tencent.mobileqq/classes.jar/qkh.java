  ...
  extends ImageBase
{
  ...
  public qkh(VafContext paramVafContext)
  {
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramString.startsWith("http")) && (!DateUtils.isToday(bgsg.b("search_word_prefix_ug_weishi_opt_day_show_time"))))
    {
      bgsg.a("search_word_prefix_ug_weishi_opt_day_show_time", System.currentTimeMillis());
      if (a(new Date(System.currentTimeMillis()), new Date(bgsg.b("search_word_prefix_ug_weishi_opt_week_first_show_time"))) <= 7L) {
        break label87;
      }
    ...
    label87:
    while (bgsg.a("search_word_prefix_ug_weishi_opt_week_first_show_count") >= 3) {
      return;
    }
