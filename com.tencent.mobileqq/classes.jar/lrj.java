  ...
  extends lrk
{
  ...
  public void a(lqb paramlqb, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        paramlqb.a(3);
        paramlqb.a(this.jdField_a_of_type_Float);
      }
  ...
  public void e()
  {
    ...
    {
      j = mrb.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (int j = 1;; j = 0)
    {
      if (j != 0)
      {
        ...
        this.jdField_a_of_type_JavaLangString = (mrb.a(this.jdField_a_of_type_JavaLangString, 0, i) + "...");
        i = (int)Math.ceil(this.jdField_a_of_type_AndroidTextTextPaint.measureText(this.jdField_a_of_type_JavaLangString));
      }
