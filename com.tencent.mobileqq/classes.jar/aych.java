...
public class aych
{
  private static aych jdField_a_of_type_Aych;
  ...
  public static aych a()
  {
    if (jdField_a_of_type_Aych == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Aych == null) {
        jdField_a_of_type_Aych = new aych();
      }
      return jdField_a_of_type_Aych;
    }
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.regGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.4.8", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localQQCustomDialog.setTitle(2131716138);
    localQQCustomDialog.setMessage(2131716137);
    paramQQAppInterface = new ayci(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new aycj(this);
    localQQCustomDialog.setPositiveButton(2131716136, paramQQAppInterface);
