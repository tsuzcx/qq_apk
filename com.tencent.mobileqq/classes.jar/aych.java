  ...
  extends ReportDialog
{
  ...
  public aych(Context paramContext)
  {
    super(paramContext, 2131755017);
    paramContext = LayoutInflater.from(paramContext).inflate(2131561738, null);
    paramContext.setOnTouchListener(new ayci(this));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewAnimationPoint.setOnAnimationListener(new aycj(this));
  }
