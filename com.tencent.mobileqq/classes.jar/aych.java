...
public class aych
  implements bapx
{
  public aych(ScribbleResMgr.4 param4) {}
  
  public void onResp(baqw parambaqw)
  {
    int j = 2;
    if (QLog.isColorLevel()) {
      QLog.i("ScribbleResMgr", 2, "onResp  mResult: " + parambaqw.jdField_a_of_type_Int + " url:" + this.a.a.sourceUrl);
    }
    int i = j;
    Object localObject;
    String str1;
    ...
    for (i = 0;; i = 1)
    {
      ...
      {
        j = i;
        localObject = (bavr)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(193);
        i = j;
        if (((bavr)localObject).a())
        {
          ((bavr)localObject).a(this.a.a.sourceUrl, parambaqw.jdField_a_of_type_Long);
          i = j;
        }
