...
public class nxe
  extends Handler
{
  public nxe(PublicAccountAdvertisementActivity paramPublicAccountAdvertisementActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        paramMessage.add(2131381044, PublicAccountAdvertisementActivity.a(this.a));
        paramMessage.commit();
      } while (!ThemeUtil.isInNightMode(this.a.getAppRuntime()));
      paramMessage = this.a.findViewById(2131371800);
