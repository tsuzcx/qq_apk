...
public class aszq
{
  void a(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    default: 
      ...
      return;
    case 5004: 
      a(paramBoolean, (aszn)localObject[0], (anqe)localObject[1], (List)localObject[2]);
      return;
    case 5005: 
      a(paramBoolean, (aszn)localObject[0], (anqe)localObject[1]);
      return;
    case 5006: 
      ...
      return;
    case 5007: 
      b(paramBoolean, (aszn)localObject[0], (anqe)localObject[1]);
      return;
    case 5013: 
    ...
    case 5016: 
      ...
      return;
    case 5020: 
      b(paramBoolean, (aszn)localObject[0], (anqe)localObject[1], (List)localObject[2]);
      return;
    case 5022: 
