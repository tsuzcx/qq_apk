  ...
  extends aigc
{
  ...
  public aieh a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aiii(this);
  ...
  public aiie(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new aiif(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131367817)).setOnClickListener(new aiig(this));
    Button localButton = (Button)findViewById(2131363522);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new aiih(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Aieh = new aieh(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bhsl, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aieh);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new aiij(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new aiik(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new aiil(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new aiim(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Aieh.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Aieh.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(alud.a(2131715575));
        ...
        {
          this.jdField_a_of_type_Aieh.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Aieh.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Aieh.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Aieh.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Aieh.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(alud.a(2131715577));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131372333).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Aieh.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Aieh.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aieh);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
