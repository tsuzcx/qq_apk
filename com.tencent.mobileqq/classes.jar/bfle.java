...
class bfle
{
  ...
  void a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        ...
        if (!bflc.a().equals(new bfli(arrayOfByte))) {
          break;
        }
    ...
    } while (!bflc.b().equals(new bfli(paramArrayOfByte)));
    if (i - j <= 2)
    {
    ...
    localByteBuffer.get(paramArrayOfByte);
    int k = new bflj(paramArrayOfByte).a();
    if (i - j - 2 < k)
    {
    ...
    return;
    if (bflc.b().equals(new bfli(arrayOfByte)))
    {
      j = bflc.b().a().length;
      if (paramArrayOfByte.length - i <= 2)
      {
  ...
  byte[] a()
  {
    ...
    {
      localByteArrayOutputStream.write(bflc.a().a());
      ...
      localByteArrayOutputStream.write(new bflj(localObject1.length).a());
      localByteArrayOutputStream.write((byte[])localObject1);
    }
    if ((this.jdField_a_of_type_ArrayOfByte != null) && (this.jdField_a_of_type_ArrayOfByte.length > 0))
    {
      localByteArrayOutputStream.write(bflc.b().a());
      localByteArrayOutputStream.write(new bflj(this.jdField_a_of_type_ArrayOfByte.length).a());
