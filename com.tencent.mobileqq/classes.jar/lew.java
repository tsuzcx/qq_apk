  ...
  implements lev
{
  ...
  private final List<lfb> jdField_a_of_type_JavaUtilList = new ArrayList(11);
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Int < 3)
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!bace.a(str))) {
        break label223;
      }
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Lfa.a(0, this.jdField_a_of_type_JavaUtilList);
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        lfb locallfb = (lfb)localIterator.next();
        if (locallfb != null) {
          switch (locallfb.jdField_a_of_type_Int)
          {
          default: 
            break;
          case 1: 
            localAEFilterManager.setSmoothLevel(locallfb.d);
            break;
          case 2: 
          case 3: 
            localAEFilterManager.setBeautyOrTransformLevel(locallfb.jdField_a_of_type_ComTencentTtpicOpenapiConfigBeautyRealConfig$TYPE, locallfb.d);
          }
        }
      }
    }
  ...
  public int a(int paramInt, boolean paramBoolean1, lfl paramlfl, boolean paramBoolean2)
  {
    ...
    paramlfl.a(a(), (float)a(), paramBoolean2);
    return paramInt;
  }
  ...
  {
    if ((!lfw.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem, paramPendantItem)) || (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial != paramVideoMaterial)) {
      if (QLog.isColorLevel()) {
  ...
  public void a(FilterDesc paramFilterDesc)
  {
    ...
    if (!lfw.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, paramFilterDesc))
    {
      ...
      str = a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc);
      if ((this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager == null) || ((!TextUtils.isEmpty(str)) && (!bace.a(str)))) {
        break label112;
      }
      this.jdField_a_of_type_ComTencentAekitApiStandardFilterAEFilterManager.updateLutGL(str);
      if (QLog.isColorLevel())
  ...
  public void a(lfi paramlfi, lfl paramlfl)
  {
    ...
    for (boolean bool1 = localPendantItem.hasFace();; bool1 = false)
    {
      ...
      if ((kyd.a(localVideoMaterial)) && (!bool2)) {
        bool1 = false;
      }
      for (;;)
      {
        this.jdField_a_of_type_Lfx.a(paramlfi, paramlfl.jdField_a_of_type_Int, false, bool1, str1, str2);
        return;
      }
    }
  }
  ...
  public boolean a(lfa paramlfa)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Lfa.a(paramlfa);
    }
  }
