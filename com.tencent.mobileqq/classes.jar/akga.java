  ...
  extends ajtd
{
  ...
  public akga(QQAppInterface paramQQAppInterface)
  {
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                case 2: 
                  ...
                  paramArrayOfByte = new bcxa(this.app.getApp().getApplicationContext(), paramArrayOfByte);
                }
              } while (paramArrayOfByte == null);
              paramArrayOfByte = (bcxd)paramArrayOfByte.a("intchk");
            } while (paramArrayOfByte == null);
            ...
            paramArrayOfByte.b("8.2.8." + AppSetting.g());
            return;
            paramArrayOfByte = (MSFNetTransportProvider)this.app.a(63);
            paramArrayOfByte = new bcxa(this.app.getApp().getApplicationContext(), paramArrayOfByte);
          } while (paramArrayOfByte == null);
          paramArrayOfByte = (bcxc)paramArrayOfByte.a("app_scan");
        } while (paramArrayOfByte == null);
