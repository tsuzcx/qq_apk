...
{
  private bdig jdField_a_of_type_Bdig = bdig.a();
  ...
  private void a(String paramString, List<akfa> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        akfa localakfa = (akfa)paramList.next();
        JSONObject localJSONObject3 = new JSONObject();
        localJSONObject3.put("id", localakfa.jdField_a_of_type_Int);
        localJSONObject3.put("soundName", localakfa.jdField_a_of_type_JavaLangString);
        localJSONObject3.put("type", localakfa.jdField_b_of_type_Int);
        localJSONObject3.put("soundVersion", localakfa.jdField_b_of_type_JavaLangString);
        localJSONObject3.put("soundUrl", localakfa.jdField_c_of_type_JavaLangString);
        localJSONObject3.put("whiteList", localakfa.jdField_d_of_type_JavaLangString);
        localJSONObject3.put("isShow", localakfa.jdField_c_of_type_Int);
        localJSONObject3.put("backgroundUrl", localakfa.jdField_e_of_type_JavaLangString);
        localJSONObject3.put("access", localakfa.f);
        localJSONObject3.put("useNum", localakfa.jdField_d_of_type_Int);
        localJSONObject3.put("classify", localakfa.jdField_e_of_type_Int);
        localJSONObject3.put("classifyName", localakfa.g);
        localJSONObject3.put("limitFreeStart", localakfa.h);
        localJSONObject3.put("limitFreeEnd", localakfa.i);
        if ((localakfa.jdField_c_of_type_JavaLangString != null) && (!TextUtils.isEmpty(localakfa.jdField_c_of_type_JavaLangString)) && (f(localakfa.jdField_c_of_type_JavaLangString)))
        {
          localJSONObject3.put("isDownload", true);
          localJSONObject2.put(String.valueOf(localakfa.jdField_a_of_type_Int), localJSONObject3);
        }
        else
        {
  ...
  private boolean a(int paramInt, String paramString)
  {
    ...
    if (bdwp.a(this.mRuntime.a(), paramInt))
    {
    ...
    callJs(paramString, new String[] { localJSONObject.toString() });
    QuickUpdateIPCModule.a(37L, bdwp.a.getScid(paramInt), new akgd(this, paramString));
    return true;
  }
  ...
  private boolean a(int paramInt, String paramString1, String paramString2)
  {
    ...
    sendRemoteReq(apml.a("sepcial_care_delete_ring", paramString2, this.mOnRemoteResp.key, localBundle), false, false);
    return true;
  }
  ...
  private boolean a(int paramInt, String paramString1, boolean paramBoolean, String paramString2)
  {
    ...
    localBundle.putInt("id", paramInt);
    localBundle.putString("uin", paramString1);
    sendRemoteReq(apml.a("special_care_set_ring", paramString2, this.mOnRemoteResp.key, localBundle), false, false);
    return true;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a()) {
      this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new akgb(this, paramString));
    }
    for (;;)
    {
      return true;
  ...
  private boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    sendRemoteReq(apml.a("special_care_get_ring", paramString2, this.mOnRemoteResp.key, (Bundle)localObject), false, false);
    return true;
  }
  ...
  private void b(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new akgc(this, paramString));
  }
  ...
  private boolean b(int paramInt, String paramString)
  {
    ...
    JSONObject localJSONObject = new JSONObject();
    if (this.jdField_a_of_type_Bdig.d()) {}
    for (boolean bool = this.jdField_a_of_type_Bdig.b();; bool = true)
    {
      this.jdField_a_of_type_Bdig.a(new akge(this, paramInt, paramString));
      String str = bdwp.a(this.mRuntime.a(), paramInt);
      ...
      this.jdField_a_of_type_Bdig.a(this.mRuntime.a().getApplicationContext(), str, new akgf(this, localJSONObject, paramString, bool));
      return true;
    }
  }
  ...
  private boolean b(String paramString)
  {
    ...
    sendRemoteReq(apml.a("special_care_get_friend_count", paramString, this.mOnRemoteResp.key, null), false, false);
    return true;
  }
  ...
  private boolean b(String paramString1, String paramString2)
  {
    ...
    sendRemoteReq(apml.a("is_special_friend", paramString2, this.mOnRemoteResp.key, localBundle), false, false);
    return true;
  }
  ...
  private boolean c(String paramString)
  {
    ...
    for (;;)
    {
      callJs(paramString, new String[] { localJSONObject.toString() });
      return true;
      bool = this.jdField_a_of_type_Bdig.b();
      break;
      label97:
      localJSONObject.put("code", 0);
    }
  ...
  private boolean d(String paramString)
  {
    ...
    sendRemoteReq(apml.a("special_care_get_switch_state", paramString, this.mOnRemoteResp.key, null), false, false);
    return true;
  }
