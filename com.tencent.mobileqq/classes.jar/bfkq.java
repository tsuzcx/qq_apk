...
public class bfkq
{
  ...
  public static boolean a(Context paramContext)
  {
    ...
    //   0: aconst_null
    //   1: astore 5
    //   3: invokestatic 13	bbct:a	()Ljava/lang/String;
    //   6: astore 4
    //   8: aload 4
    //   10: astore_3
    //   11: aload 4
    ...
    //   39: invokestatic 48	anet:a	(Landroid/content/Context;)I
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    try
    {
      ...
      if (localPackageInfo.signatures.length >= 1) {
        str = bfkp.a(localPackageInfo.signatures[(localPackageInfo.signatures.length - 1)].toCharsString());
      }
      if ((!TextUtils.isEmpty(str)) && (str.equals(paramString2)))
      {
        int i = bfko.a(paramContext, paramString1);
        if (i < paramInt) {
          return true;
        }
      }
  ...
  public static boolean b(Context paramContext)
  {
    ...
    //   375: invokestatic 48	anet:a	(Landroid/content/Context;)I
    //   378: istore_1
    //   379: iload 4
    //   381: istore_3
    //   382: aload 5
    ...
    //   400: invokestatic 13	bbct:a	()Ljava/lang/String;
