...
{
  private static azsk jdField_a_of_type_Azsk;
  ...
  private static String[] jdField_c_of_type_ArrayOfJavaLangString = { azsk.class.getName() };
  private int jdField_a_of_type_Int = -1;
  private long jdField_a_of_type_Long;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private azsp jdField_a_of_type_Azsp;
  private azsq jdField_a_of_type_Azsq;
  private List<azsl> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "CPU", alud.a(2131701458), alud.a(2131701457), alud.a(2131701461), "WakeLock", "WIFI", "GPS" };
    jdField_a_of_type_JavaUtilSet = new BatteryStatsImpl.1();
  }
  
  public static azsk a()
  {
    if (jdField_a_of_type_Azsk != null) {
      return jdField_a_of_type_Azsk;
    }
    try
    {
      if (jdField_a_of_type_Azsk == null) {
        jdField_a_of_type_Azsk = new azsk();
      }
      azsk localazsk = jdField_a_of_type_Azsk;
      return localazsk;
    }
    finally {}
  }
  ...
  private final void a(long paramLong1, long paramLong2)
  {
    ...
    //   1: lload_3
    //   2: ldc2_w 194
    //   5: invokestatic 198	azsh:a	(JJJ)Ljava/util/List;
    //   8: astore 19
    //   10: aload 19
    //   12: ifnonnull +12 -> 24
    //   15: ldc 200
    ...
    //   552: invokestatic 364	azri:a	(Landroid/content/Context;)Lazri;
    //   555: aconst_null
    //   556: ldc_w 366
    //   559: iconst_1
    //   560: lconst_0
    ...
    //   562: aload 24
    //   564: aconst_null
    //   565: invokevirtual 369	azri:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    //   568: return
    //   569: iload 7
    //   571: istore 18
    //   573: iload 6
    ...
    //   3198: iconst_2
    //   3199: isub
    //   3200: invokespecial 500	azsk:a	([Ljava/lang/String;II)Ljava/lang/String;
    //   3203: astore 29
    //   3205: iload 7
    //   3207: istore 16
    //   3209: iload 6
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Azsq != null) {
      this.jdField_a_of_type_Azsq.a(paramString);
    }
  }
  ...
  private void a(String... paramVarArgs)
  {
    if ((this.jdField_a_of_type_Int == 1) && (b())) {
      azsh.a(new Object[] { Long.valueOf(System.currentTimeMillis()), paramVarArgs });
    }
  }
  ...
  public void a()
  {
    if (b())
    {
      ...
      if ((BaseApplicationImpl.sProcessId == 4) || (BaseApplicationImpl.sProcessId == 1) || (!azaw.a(BaseApplicationImpl.sProcessId, BaseApplicationImpl.processName))) {
        break label146;
      }
    }
    for (;;)
  ...
  void a(int paramInt, String... paramVarArgs)
  {
    ...
    {
      azsh.b(new Object[] { localObject, Integer.valueOf(paramInt), Long.valueOf(l), paramVarArgs });
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext()) {
          ((azsl)localIterator.next()).a(paramBundle);
        }
        if (!QLog.isColorLevel()) {}
      }
  ...
  public void a(String paramString, Object[] paramArrayOfObject)
  {
    if (this.jdField_a_of_type_Azsp != null) {
      this.jdField_a_of_type_Azsp.a(paramString, paramArrayOfObject);
    }
  }
    ...
    do
    {
      ...
      if (a() == 1)
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          ((azsl)((Iterator)localObject).next()).b();
        }
  ...
  public void d()
  {
    ...
    if (a() == 1)
    {
      localObject = this.jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((azsl)((Iterator)localObject).next()).c();
      }
        ...
        for (;;)
        {
          ...
          catch (Exception localException5)
          {
            try
            {
              ...
              bool2 = new File(bdzf.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/AutoTestFlag_01")).exists();
              if (!bool2) {
                continue;
              }
              bool1 = false;
              ...
              this.jdField_a_of_type_JavaUtilList.add(new azsn(this, paramMessage[1]));
              this.jdField_a_of_type_JavaUtilList.add(new azsr(this, paramMessage[3]));
              this.jdField_a_of_type_JavaUtilList.add(new azsm(this, paramMessage[4]));
              this.jdField_a_of_type_JavaUtilList.add(new azst(this, paramMessage[5]));
              this.jdField_a_of_type_JavaUtilList.add(new azsw(this, paramMessage[6]));
              this.jdField_a_of_type_Azsp = new azsp(this, paramMessage[7]);
              this.jdField_a_of_type_JavaUtilList.add(this.jdField_a_of_type_Azsp);
              if (!b()) {
                continue;
              }
              this.jdField_a_of_type_JavaUtilList.add(new azss(this, paramMessage[2]));
              azsh.a(BaseApplicationImpl.sApplication.getQQProcessName(), this.jdField_a_of_type_Long);
              paramMessage = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramMessage.hasNext()) {
                continue;
              }
              localObject4 = (azsl)paramMessage.next();
              ((azsl)localObject4).a();
          ...
          if ((paramMessage.length >= 3) && (paramMessage[2].equals("1")))
          {
            ...
            if (Math.abs(System.currentTimeMillis() - l1) > 86400000L)
            {
              ...
              if (this.jdField_a_of_type_Long != 0L)
              {
                ...
                {
                  localObject5 = azsh.a(l1, l2, 10, 3000L);
              ...
              azri.a(BaseApplication.getContext()).a(null, "batteryFileRpt", true, 0L, 0L, null, null);
              paramMessage.edit().putLong("battery_report_timestamp", l2).commit();
            }
          }
          for (;;)
          {
            azsh.a(this.jdField_a_of_type_Long - 172800000L);
            this.e = true;
            break;
