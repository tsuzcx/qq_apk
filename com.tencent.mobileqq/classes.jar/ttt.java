      ...
      try
      {
        ...
        if ((paramBundle != null) && (paramBundle.bytes_ad_user_info.has()))
        {
          ...
          if (paramInt == 0)
          {
            ...
            tvg.a.a(null, true, "no error", paramBundle.bytes_ad_user_info.get().toStringUtf8(), "resource_fetch_key");
            tvg.a.a("", "requestSuccess", 1);
          }
        }
        else
        {
          tvg.a.a(null, true, "error with errorcode: " + paramInt, null, "resource_fetch_key");
          tvg.a.a("", "requestFail", 1);
          return;
        }
      }
