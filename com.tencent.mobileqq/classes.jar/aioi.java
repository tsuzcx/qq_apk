...
public class aioi
  implements Runnable
{
  public aioi(TroopAioKeywordTipManager paramTroopAioKeywordTipManager, List paramList) {}
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipManager.b)
      {
        synchronized (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipManager.jdField_a_of_type_AndroidUtilSparseArray)
        {
          ...
          else
          {
            ...
            label500:
            if ((??? != null) && (((List)???).size() > 0)) {
              ((TroopHandler)this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipManager.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a((List)???, new aioj(this));
            }
            return;
          }
        }
