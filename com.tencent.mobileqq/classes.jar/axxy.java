  ...
  extends axxs
{
  ...
  void a(int paramInt, axyr paramaxyr, cmd0x388.ReqBody paramReqBody)
  {
    ...
    localTryUpImgReq.uint32_app_pic_type.set(paramaxyr.jdField_b_of_type_Int);
    ...
    for (paramInt = 1;; paramInt = 2)
    {
      ...
      localTryUpImgReq.uint32_srv_upload.set(paramaxyr.e);
      if (paramaxyr.jdField_b_of_type_Boolean) {
        localTryUpImgReq.uint32_original_pic.set(1);
      }
      if (!TextUtils.isEmpty(paramaxyr.jdField_b_of_type_JavaLangString)) {
        localTryUpImgReq.bytes_transfer_url.set(ByteStringMicro.copyFromUtf8(paramaxyr.jdField_b_of_type_JavaLangString));
      }
  ...
  public void a(axtc paramaxtc, axtb paramaxtb)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          localObject1 = (axza)localaxyv.jdField_a_of_type_JavaUtilList.get((int)paramaxtc.uint64_file_id.get());
          ...
          try
          {
            if (localFromServiceMsg.getAttributes().containsKey("_attr_send_by_quickHttp")) {
              ((axza)localObject1).d = ((Boolean)localFromServiceMsg.getAttribute("_attr_send_by_quickHttp", Boolean.valueOf(false))).booleanValue();
            }
            i = paramaxtc.uint32_result.get();
            if (i != 0) {
              break label977;
            }
            ((axza)localObject1).jdField_a_of_type_Long = paramaxtc.uint64_fileid.get();
            long l1;
            long l2;
            if ((paramaxtc.bool_file_exit.has()) && (paramaxtc.bool_file_exit.get()))
            {
              ((axza)localObject1).jdField_a_of_type_Boolean = true;
              localList = paramaxtc.rpt_uint32_up_ip.get();
              paramaxtc = paramaxtc.rpt_uint32_up_port.get();
              ...
              while (i < localList.size())
              {
                ...
                l2 = ((Integer)paramaxtc.get(i)).intValue();
                localObject2 = new axuh();
                ((axuh)localObject2).jdField_a_of_type_JavaLangString = bakz.a(l1 & 0xFFFFFFFF);
                ((axuh)localObject2).jdField_a_of_type_Int = ((int)l2);
                ((axza)localObject1).jdField_a_of_type_JavaUtilArrayList.add(i, localObject2);
                i += 1;
              }
            }
            List localList = paramaxtc.rpt_uint32_up_ip.get();
            ...
            if ((localList != null) && (localList.size() > 0))
            {
              ...
              while (i < localList.size())
              {
                ...
                ((axza)localObject1).jdField_a_of_type_JavaUtilArrayList.add(i, localaxuh);
                i += 1;
              }
            }
        ...
        continue;
        label826:
        ((axza)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject2);
        ((axza)localObject1).jdField_a_of_type_Int = ((int)paramaxtc.uint64_block_size.get());
        ((axza)localObject1).jdField_b_of_type_Int = ((int)paramaxtc.uint64_up_offset.get());
        if (axsr.a().a() == this.jdField_a_of_type_Int) {
          break label1041;
        }
        bool = true;
        ((axza)localObject1).jdField_b_of_type_Boolean = bool;
        ((axza)localObject1).jdField_b_of_type_Long = paramaxtc.uint64_up_offset.get();
  ...
  public void a(axyg paramaxyg)
  {
    if ((paramaxyg != null) && (paramaxyg.jdField_a_of_type_JavaUtilList != null) && (paramaxyg.jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager != null))
    {
      ...
      localaxtb.jdField_a_of_type_JavaLangString = "ImgStore.GroupPicUp";
  ...
  void b(axyg paramaxyg)
  {
    ...
    {
      axza localaxza = new axza();
      localaxyv.jdField_a_of_type_JavaUtilList.add(i, localaxza);
      i += 1;
    }
  }
}
