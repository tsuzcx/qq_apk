  ...
  extends bdre
{
  ...
  public bdss()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdst(this);
  }
  ...
  public static String a(AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    } while ((!(localObject1 instanceof bdom)) || (((bdom)localObject1).a == null) || (((bdom)localObject1).a.isEmpty()));
    Object localObject1 = ((bdom)localObject1).a.iterator();
    label191:
    if (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bdol)((Iterator)localObject1).next();
      if ((paramString.equals("cover")) && ((localObject2 instanceof bdqo)))
      {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramAbsShareMsg))
      {
        ...
        if ((!paramString.equals("summary")) || (!(localObject2 instanceof bdtj))) {
          break label301;
        }
        paramAbsShareMsg = StructMsgForGeneralShare.getSummary((bdol)localObject2);
        break label231;
        label295:
        break label191;
      }
  ...
  void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null))
    {
      ...
      {
        localObject = (AbsShareMsg)bdow.a(((MessageRecord)localObject).msgData);
  ...
  {
    Object localObject = new bdsv(this);
    Resources localResources = paramContext.getResources();
    View localView;
    int i;
    label122:
    int j;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && (paramView.findViewById(2131363998) != null) && ((paramView.getTag() instanceof bdsv)))
    {
      localObject = (bdsv)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
      a();
      boolean bool = paramBundle.getBoolean("isSend", true);
      paramBundle = (BubbleViewLayout)localView.findViewById(2131363998);
      i = 19;
      ...
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(agej.a(9.0F, localResources), 0, agej.a(i, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(agej.a(9.0F, localResources), agej.a(3.0F, localResources), agej.a(i, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j == 0) {
        break label925;
      }
      paramBundle.setMargins(agej.a(18.0F, localResources), 0, 0, 0);
      ...
      paramBundle.setMargins(agej.a(18.0F, localResources), 0, 0, 0);
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(agej.a(19.5F, localResources), 0, agej.a(10.0F, localResources), 0);
      label339:
      paramBundle = localResources.getDrawable(2130850460);
    ...
    try
    {
      localObject = URLDrawable.getDrawable(new URL(this.ad), agej.a(249.0F, localResources), agej.a(139.0F, localResources), paramBundle, paramBundle, true);
    ...
    for (;;)
    {
      ...
      i = (int)(BaseChatItemLayout.B * 0.8F) - agej.a(19.5F, localResources) - agej.a(10.0F, localResources) - agej.a(13.0F, localResources);
      paramView.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(i);
      i /= agej.a(14.0F, localResources);
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView.setText(new begz(paramBundle, 3, 15));
      paramView.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      paramContext = new bdsu(this, paramContext, new String(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgActionData), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.mMsgUrl);
      ...
      return localView;
      localView = LayoutInflater.from(paramContext).inflate(2131559632, null);
      ((bdsv)localObject).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131365160));
      ((bdsv)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378936));
      ((bdsv)localObject).jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)localView.findViewById(2131378243));
      ((bdsv)localObject).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131363998));
      ((bdsv)localObject).jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131362319));
      ((bdsv)localObject).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131364804));
      ((bdsv)localObject).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362318));
      ((bdsv)localObject).c = ((RelativeLayout)localView.findViewById(2131364046));
      ((bdsv)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364039));
      ...
      break label339;
      paramView.jdField_a_of_type_AndroidWidgetTextView.setPadding(agej.a(i, localResources), 0, agej.a(9.0F, localResources), 0);
      paramView.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setPadding(agej.a(i, localResources), agej.a(3.0F, localResources), agej.a(9.0F, localResources), 0);
      paramBundle = (ViewGroup.MarginLayoutParams)paramView.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if (j != 0)
      {
        paramBundle.setMargins(0, 0, agej.a(18.0F, localResources), 0);
        ((RelativeLayout.LayoutParams)paramView.c.getLayoutParams()).addRule(11);
        paramBundle = (RelativeLayout.LayoutParams)paramView.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
        paramBundle.addRule(11);
        paramBundle.setMargins(0, 0, agej.a(18.0F, localResources), 0);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(agej.a(10.0F, localResources), 0, agej.a(19.5F, localResources), 0);
        break label339;
      }
      paramBundle.setMargins(0, 0, 0, 0);
      break label339;
