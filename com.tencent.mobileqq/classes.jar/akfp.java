  ...
  implements axay
{
  ...
  public akfp(AppInterface paramAppInterface)
  {
  ...
  public void a(RespItem paramRespItem)
  {
    ...
    if (paramRespItem.eServiceID == 117)
    {
      ...
      arrayOfByte = bbma.b(paramRespItem.vecUpdate);
      if (arrayOfByte != null) {
    ...
    else
    {
      ...
      catch (InvalidProtocolBufferMicroException paramRespItem)
      {
        ...
        if ((this.a instanceof QQAppInterface)) {
          ((sss)((QQAppInterface)this.a).a(98)).notifyUI(1023, true, Boolean.valueOf(false));
        }
      }
    }
    for (;;)
