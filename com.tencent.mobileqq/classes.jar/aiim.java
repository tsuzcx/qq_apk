  ...
  implements axmg
{
  ...
  public aiim(String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public axmh a(int paramInt1, int paramInt2)
  {
    ...
    label278:
    label307:
    for (localaxmh.jdField_a_of_type_Int = ((int)(819200 * 1.0D / paramInt1 * paramInt2));; localaxmh.jdField_a_of_type_Int = 819200)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressTask", 2, "CompressTask, step: getEncodeConfig() config.setRotation = " + localaxmh.jdField_b_of_type_Boolean + ", scaleRate=" + localaxmh.jdField_a_of_type_Float + ", videoBitRate=" + localaxmh.jdField_a_of_type_Int + ", videoFrameRate=" + localaxmh.jdField_b_of_type_Int + ", beginTime=" + localaxmh.jdField_a_of_type_Long + ", endTime=" + localaxmh.jdField_b_of_type_Long + ",quality:" + (String)localObject + ",videoLongestEdge=" + paramInt1);
      }
      return localaxmh;
      paramInt2 = paramInt1;
      break;
