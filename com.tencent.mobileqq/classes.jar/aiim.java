...
public class aiim
  extends baox
{
  public aiim(SettingMeApolloViewController paramSettingMeApolloViewController) {}
  ...
  protected void onGetExploreMsg(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean) {
      try
      {
        ...
        localObject = new aiku(localQQAppInterface, (JSONObject)localObject, localQQSettingMe);
        this.a.jdField_a_of_type_Aikq.a((aiks)localObject);
        if ((localQQSettingMe.a()) && (SettingMeApolloViewController.a(this.a) > 0)) {
          this.a.jdField_a_of_type_Aikq.a(SettingMeApolloViewController.a(this.a), localViewGroup.getContext(), localQQAppInterface, this.a.jdField_a_of_type_Int);
        }
