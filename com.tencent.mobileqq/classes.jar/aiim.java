...
{
  public aiim(StructMsgItemButton paramStructMsgItemButton) {}
                ...
                catch (JSONException localJSONException)
                {
                  for (;;)
                  {
                    try
                    {
                      ...
                      ((PublicQuickPayManager)localObject2).a(localStructMsgForGeneralShare.message.frienduin, paramView, new aiin(this, localStructMsgForGeneralShare, localContext));
                      ...
                      ThreadManager.getSubThreadHandler().postDelayed(new aiio(this, localStructMsgItemButton, localStructMsgForGeneralShare, (QQAppInterface)localObject1, bool), 0L);
                      return;
