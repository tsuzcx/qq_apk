  ...
  implements Handler.Callback
{
  ...
  protected aocj a;
  aqym jdField_a_of_type_Aqym;
  aqyu jdField_a_of_type_Aqyu = new aiin(this);
  bjbv jdField_a_of_type_Bjbv;
  ...
  public aiim(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_b_of_type_MqqOsMqqHandler = new blha(ThreadManager.getSubThreadLooper(), this);
    this.jdField_a_of_type_Aocj = new aiir(this);
  }
  ...
  {
    long l1;
    if (aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      v(false);
      l1 = 0L;
    }
    ...
    {
      this.jdField_a_of_type_Aqym.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), l1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, true);
      return;
    }
    this.jdField_a_of_type_Aqym.a(l1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false);
  }
  ...
  private void bq()
  {
    ...
    {
      String str = aqyt.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e);
      if (aqyl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str)) {
  ...
  private void br()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundResource(2130843607);
      this.jdField_d_of_type_AndroidViewViewGroup.setBackgroundResource(2130843607);
    ...
    for (;;)
    {
      try
      {
        agej.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout, 2130843613);
        if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
        {
          agej.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130843626);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
        }
        this.e.setTextColor(nlj.c);
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getColor(2131166987));
        if (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0)
        {
          this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130843633);
          this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(nlj.c);
          ...
          agej.a(this.jdField_a_of_type_AndroidWidgetImageView, null);
          ...
          c(true);
          this.f.setText(anzj.a(2131701299) + this.g);
          ...
          localObject1 = anzj.a(2131701300);
          if (this.S) {
            localObject1 = anzj.a(2131701301);
          }
          this.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
          this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.findViewById(2131369880).setVisibility(8);
          ...
          if (aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
          {
            localObject1 = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131561133, null);
            this.jdField_d_of_type_AndroidViewViewGroup.addView((View)localObject1, new ViewGroup.LayoutParams(-1, -1));
            localObject2 = ((View)localObject1).findViewById(2131381270);
            this.l = ((ImageView)((View)localObject1).findViewById(2131368078));
            this.l.setOnClickListener(this);
            this.jdField_a_of_type_ComTencentMobileqqConfessConfessProgressView = ((ConfessProgressView)((View)localObject1).findViewById(2131364943));
            ...
            this.n = ((View)localObject1).findViewById(2131368070);
            this.n.setVisibility(8);
            this.o = ((View)localObject1).findViewById(2131368068);
            if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
            {
            ...
            bs();
            if (!aqyl.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "holmes_guide"))
            {
              aqyl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "holmes_guide", true);
              if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1033) {
                break label933;
              }
              localObject1 = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131561132, null);
              ((View)localObject1).findViewById(2131368073).setOnClickListener(this);
              ((View)localObject1).setOnClickListener(this);
              this.jdField_d_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new aiio(this, (View)localObject1, (View)localObject2));
            }
      ...
      catch (Throwable localThrowable)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130850669);
        this.jdField_b_of_type_AndroidWidgetImageView.setPadding(0, 0, 0, 0);
        this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(nlj.c);
        this.jdField_c_of_type_AndroidWidgetTextView.setBackgroundResource(2130837983);
        continue;
      }
      ...
      continue;
      label933:
      View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131561131, null);
    }
  }
  ...
  private void bt()
  {
    ...
    ((blir)localObject).a(2131689944, 5);
    ((blir)localObject).a(2131690600, 5);
    ((blir)localObject).c(2131690580);
    ((blir)localObject).a(new aiis(this, (blir)localObject));
  ...
  private void v(boolean paramBoolean)
  {
    ...
    if (localConfessConvInfo != null)
    {
      ...
      this.l.setImageResource(2130845001);
    }
    for (int i = 0;; i = 1)
    {
      ...
      this.l.setContentDescription(String.format(anzj.a(2131701309), new Object[] { Integer.valueOf(localConfessConvInfo.holmesTolCount), Integer.valueOf(localConfessConvInfo.holmesCurCount) }));
      ...
      return;
      label215:
      this.l.setImageResource(2130845000);
    }
  }
  ...
  {
    super.H();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aqyu);
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    if (this.jdField_a_of_type_Bjbv == null) {
      this.jdField_a_of_type_Bjbv = new bjbv(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    }
  ...
  {
    aqyt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, true, true);
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    br();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aqyu);
    this.jdField_a_of_type_Aqym = ((aqym)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(125));
    bp();
    return paramBoolean;
  }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1033)
    {
      ...
      if (localObject != null)
      {
        ...
        if (((ChatFragment)localObject).a != null) {
          ((ChatFragment)localObject).a.setStatusBarDrawable(a().getResources().getDrawable(2130846177));
        }
      }
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130850113));
      this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131369880).setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setIsDefaultTheme(false);
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130850099));
      this.jdField_d_of_type_AndroidViewViewGroup.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130850036));
      agej.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout, SkinEngine.getInstances().getDefaultThemeDrawable(2130849842));
      agej.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, SkinEngine.getInstances().getDefaultThemeDrawable(2130849843));
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
      localObject = SkinEngine.getInstances().getDefaultThemeDrawable(2130849991);
      Drawable localDrawable1 = SkinEngine.getInstances().getDefaultThemeDrawable(2130849988);
      Drawable localDrawable2 = SkinEngine.getInstances().getDefaultThemeDrawable(2130849992);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849892));
      return;
    }
    agej.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130843626);
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
  ...
  public void as()
  {
    ...
    localaeau.i = this.I;
    this.I = false;
    aean.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, str, null, localaeau);
    ...
    aW();
    this.jdField_a_of_type_Aiwh.a(1002, new Object[] { str });
  }
  ...
  public void c(Intent paramIntent)
  {
    ...
    this.g = str1;
    paramIntent = (aqyp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269);
    ...
    for (;;)
    {
      ...
      if (!this.K)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqConfessConfessInfo = localaqyk.a(str3, j, k, paramIntent, str1, i, str2, l1);
        }
      }
      for (;;)
      {
  ...
  public int f()
  {
    int i = ahnz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Normal_MaxPtt") * 1000 - 200;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((i == 2131369056) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1034)) {
      bt();
    }
    for (;;)
    {
      ...
      else if (i != 2131368075)
      {
        if (i == 2131368078)
        {
          ...
          if (this.n != null)
          {
            ...
            {
              this.n.setVisibility(8);
              str1 = aqyt.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e);
              aqyl.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, false);
              i = 1;
            }
          }
          String str2;
          ...
          for (;;)
          {
            aqyl.a(localQQAppInterface, localContext, str1, str2, j, bool);
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009573", "0X8009573", i, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e + "", "", str1 + "", str2 + "");
            break;
