  ...
  implements umg
{
  ...
  private void a(LikeRspEvent paramLikeRspEvent, udo paramudo, List<stSimpleMetaFeed> paramList)
  {
    int j = 0;
    int i = 0;
  ...
  {
    upe.b("WSRecommendFragmentPresenter", "WSAddCommentEvent feedId = " + paramWSAddCommentEvent.getFeedId() + "; position = " + paramWSAddCommentEvent.getPosition() + "; num = " + paramWSAddCommentEvent.getCommentNum());
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      stSimpleMetaFeed localstSimpleMetaFeed = (stSimpleMetaFeed)paramList.next();
  ...
  public static void a(String paramString, int paramInt, byte paramByte1, byte paramByte2, WSRedDotPushMsg paramWSRedDotPushMsg, List<stSimpleMetaFeed> paramList, ujj paramujj)
  {
    ...
    paramString = new uju(new unx(paramString, paramByte1, paramByte2, localArrayList, paramInt, jdField_b_of_type_JavaLangString, "", jdField_c_of_type_JavaLangString, paramList), null, paramujj, 1001);
    ujn.a().a(paramString);
  }
  
  private void a(String paramString, boolean paramBoolean)
  {
    upe.b("WSRecommendFragmentPresenter", "doPlanDefaultLoad");
    a(false, true, false, paramString);
    a(false, paramBoolean);
  }
  
  private void a(uju paramuju, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_Long = (System.currentTimeMillis() - paramLong);
      umw.a(302, new Object[] { Integer.valueOf(paramuju.jdField_a_of_type_Int), Long.valueOf(this.jdField_a_of_type_Long) });
    }
  }
  
  private void a(uju paramuju, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    upe.b("WSRecommendFragmentPresenter", "onTaskResponse-resultCode:" + paramuju.b + " | resultBean:" + paramuju.jdField_a_of_type_JavaLangObject + " | thread" + Thread.currentThread().getName());
    ...
    Observable.create(new ulk(this, paramuju, paramLong, paramBoolean1, localWSRecommendFragment)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new ulj(this, localWSRecommendFragment, paramBoolean1, paramBoolean2, paramuju, paramLong, paramBoolean3));
  }
  
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    upe.d("WSRecommendFragmentPresenter", "getCacheData");
    uen.a().a(new ulh(this, paramBoolean1, paramBoolean2));
  }
  ...
  private static void b(JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    {
      acqy.d("WSRecommendFragmentPresenter", "onResult", paramJSONObject1);
    }
  }
  
  private void c()
  {
    upe.b("WSRecommendFragmentPresenter", "doPlanRedDotPreload");
    a(true, true);
  }
  ...
  public static void c(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      ...
      {
        acqy.d("WSRecommendFragmentPresenter", "setGdtArgs", paramString);
      }
    }
    for (;;)
    {
  ...
  {
    if ((a() == null) || (!(((umh)a()).b() instanceof udo))) {}
    List localList;
    do
    {
      udo localudo;
      ...
      {
        return;
        localudo = (udo)((umh)a()).b();
        localList = localudo.a();
      } while (localList == null);
      if ((paramWSSimpleBaseEvent instanceof LikeRspEvent))
      {
        a((LikeRspEvent)paramWSSimpleBaseEvent, localudo, localList);
        return;
      }
  ...
  {
    paramString = new uju(new unr(paramString), this.jdField_a_of_type_AndroidOsHandler, new ulg(this), 2001);
    ujn.a().a(paramString);
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString)
  {
    ...
    if (paramBoolean2)
    {
      ...
      if (!paramBoolean1)
      {
        ...
        upe.d("WSAioLog", "rowKey:" + str1 + ", magActionData:" + paramString);
        localObject2 = ups.a();
        str2 = ups.jdField_a_of_type_JavaLangString;
        localObject1 = str2;
        if (localObject2 != null)
        {
          localObject1 = str2;
          if (TextUtils.isEmpty(str2)) {
            localObject1 = ((pnp)localObject2).c();
          }
        }
        upe.a("WSAioLog", "getFeedList lastFeedId:" + (String)localObject1);
    ...
    upe.a("WSAioLog", "getFeedList isFirstFromService:" + paramBoolean2 + ", contentFeedIds:" + localArrayList);
    ...
    for (int i = 1;; i = 0)
    {
      paramString = new uju(new unx(paramString, b1, (byte)i, localArrayList, 1, jdField_b_of_type_JavaLangString, str1, jdField_c_of_type_JavaLangString, (String)localObject1), this.jdField_a_of_type_AndroidOsHandler, new uli(this, paramBoolean2, l, paramBoolean1, paramBoolean3), 1001);
      ujn.a().a(paramString);
      return;
      i = 0;
      break;
  ...
  public void b(String paramString)
  {
    ...
    upe.b("WSRecommendFragmentPresenter", "isFromWeiShiPush = " + bool);
    if ((bool) && (uen.a().a()) && (uen.a().a() >= 8) && (uen.a().b()))
    {
      c();
      return;
    }
