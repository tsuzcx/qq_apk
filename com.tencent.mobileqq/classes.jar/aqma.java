...
public class aqma
{
  private static HashMap<String, aqma> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aqmb(this);
  ...
  private aqma(Context paramContext, File paramFile, String paramString)
  {
    ...
    this.jdField_a_of_type_Boolean = aqli.a();
  ...
  public static aqma a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      String str = paramString2 + paramString1;
      aqma localaqma = (aqma)jdField_a_of_type_JavaUtilHashMap.get(str);
      paramString1 = localaqma;
      if (localaqma == null)
      {
        paramString1 = new aqma(paramContext.getApplicationContext(), a(paramContext), paramString2);
  ...
  private InstalledPlugin a(ProgressFuture<InstalledPlugin> paramProgressFuture)
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (aqmd.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (str.equals("SOURCE_CGI"))
        {
          ...
          aqmd.a("2653754");
          localObject1 = localObject2;
          a("HuayangPluginNewDownloader", ajjy.a(2131639847) + localTargetDownloadInfo.url);
          localObject1 = localObject2;
      ...
      catch (VersionCheckException localVersionCheckException)
      {
        ...
        try
        {
          ...
          localObject3 = localInstalledPlugin;
          a("HuayangPluginNewDownloader", ajjy.a(2131639861) + k);
          localObject3 = localInstalledPlugin;
          if (!str.equals("SOURCE_CGI")) {
            continue;
          }
  ...
  private void a(InstalledPlugin paramInstalledPlugin)
  {
    ...
    try
    {
      ...
      a("HuayangPluginNewDownloader", ajjy.a(2131639843));
      str1 = str2;
      if (!this.jdField_b_of_type_Boolean)
      {
  ...
  {
    Object localObject = new StringBuilder().append(ajjy.a(2131639849));
    boolean bool;
    if (paramInstalledPlugin == null)
    {
      bool = true;
  ...
  {
    Intent localIntent = new Intent(aqlr.c(this.jdField_b_of_type_JavaLangString));
    int i;
    if (paramBoolean)
    {
      i = 1;
      ...
      if (!paramBoolean)
      {
        if (!aqlr.a(this.jdField_b_of_type_JavaLangString)) {
          break label64;
        }
        aqmd.a("2714209");
      }
    ...
    label64:
    while (!aqlr.b(this.jdField_b_of_type_JavaLangString))
    {
      return;
      i = 0;
      break;
  ...
  private void b(InstalledPlugin paramInstalledPlugin)
  {
    ...
    if (this.jdField_a_of_type_Aqmc != null) {
      this.jdField_a_of_type_Aqmc.a(10, new Object[0]);
    }
    ...
    a("HuayangPluginNewDownloader", ajjy.a(2131639863));
  }
  
  private void b(InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
    a("HuayangPluginNewDownloader", ajjy.a(2131639851) + paramInstalledPlugin);
  ...
  private void c()
  {
    ...
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      {
        a("HuayangPluginNewDownloader", ajjy.a(2131639858) + (String)localObject3 + " mPluginVersion:" + this.e);
        aqlw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getPackageName() + ":troophomework");
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!"huiyin".equals(this.d)) || (badq.a(this.jdField_a_of_type_AndroidContentContext)) || (!bool)) {
          break label559;
        }
        return;
      }
      ...
      if (aqme.jdField_a_of_type_JavaUtilMap.get(this.d) != null) {
        aqmd.b(String.valueOf(((aqme)aqme.jdField_a_of_type_JavaUtilMap.get(this.d)).g));
      }
      localObject3 = null;
      break;
      label553:
    ...
    if (!this.jdField_b_of_type_Boolean) {
      if (localException1 == null)
      {
        ...
        a("HuayangPluginNewDownloader", ajjy.a(2131639857));
