  ...
  extends aqly
{
  ...
  public static aqly a(JSONObject paramJSONObject)
  {
    ...
    localaqma.jdField_a_of_type_JavaLangString = paramJSONObject.optString("align");
    localaqma.d = (bhgr.c(localContext, paramJSONObject.optInt("text_size") / 2) + 1);
    localaqma.jdField_c_of_type_JavaLangString = paramJSONObject.optString("text_align");
    ...
    try
    {
      localaqma.jdField_c_of_type_Int = Color.parseColor("#" + (String)localObject);
      if (paramJSONObject.has("rect"))
      {
        localObject = paramJSONObject.optJSONArray("rect");
        localaqma.jdField_a_of_type_ArrayOfInt = new int[4];
        int i = 0;
        while (i < ((JSONArray)localObject).length())
        {
          localaqma.jdField_a_of_type_ArrayOfInt[i] = bhgr.a(localContext, ((JSONArray)localObject).optInt(i) / 2);
          i += 1;
        }
      }
    }
    catch (Exception localException)
    {
      ...
      localaqma.e = paramJSONObject.optInt("text_max_count");
      if (QLog.isColorLevel()) {
  ...
  @TargetApi(11)
  public Rect a(aqmm paramaqmm, Canvas paramCanvas, Paint paramPaint)
  {
    float f1 = 0.0F;
    paramCanvas = paramaqmm.getBounds();
    Object localObject = BaseApplicationImpl.getContext().getResources();
    if (b == -1) {
      b = agej.a(48.0F, (Resources)localObject);
    }
    float f4 = 1.0F;
    ...
    {
      i = agej.a(2.0F, (Resources)localObject);
      int j = agej.a(9.0F, (Resources)localObject);
      int k = agej.a(7.0F, (Resources)localObject);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_JavaLangString.endsWith("L"))
        {
          ...
          localObject = aqkr.a().a(paramaqmm, paramaqmm.jdField_a_of_type_JavaLangString);
          Paint.FontMetrics localFontMetrics = paramPaint.getFontMetrics();
          f4 = aqly.a(paramPaint, (String)localObject);
  ...
  public void a(aqmm paramaqmm, Canvas paramCanvas)
  {
    ...
    {
      return;
      str = aqkr.a().a(paramaqmm, paramaqmm.jdField_a_of_type_JavaLangString);
    ...
    paramaqmm = a(paramaqmm, paramCanvas, localPaint);
    paramCanvas.drawText(str, paramaqmm.left, paramaqmm.top, localPaint);
  }
}
