...
public class blcs
  extends PopupWindow
{
  private static final Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = a(2130850738);
  ...
  private static final Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = a(2130850739);
  ...
  private View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new blcv(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new blcw(this);
  ...
  public blcs(Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void f()
  {
    ...
    setWidth(-1);
    setHeight(-1);
    this.jdField_a_of_type_ComTencentComponentAnimationReboundSpring = SpringSystem.create().createSpring().setSpringConfig(jdField_a_of_type_ComTencentComponentAnimationReboundSpringConfig).addListener(new blct(this));
    this.jdField_a_of_type_Blcx = new blcx(this, this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365809));
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Blcx);
    this.jdField_a_of_type_AndroidWidgetListView.setOnTouchListener(new blcu(this));
  }
  ...
  public void a(blcy paramblcy)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (paramblcy != null)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramblcy);
    }
  }
  ...
  public void e()
  {
    int i = 0;
    int j = 0;
    while (i < this.jdField_a_of_type_Blcx.getCount())
    {
      View localView = this.jdField_a_of_type_Blcx.getView(i, null, this.jdField_a_of_type_AndroidWidgetListView);
