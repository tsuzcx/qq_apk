...
public class obj
{
  ...
  public static float a(Context paramContext, qht paramqht)
  {
    if ((paramqht != null) && (paramqht.jdField_d_of_type_Boolean)) {}
    for (int i = 28;; i = 12) {
      return babp.a(paramContext) - azvv.a(paramContext, i);
    }
  }
  ...
  public static float a(android.view.View paramView)
  {
    ...
    //   5: monitorenter
    //   6: aload_0
    //   7: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   10: invokevirtual 63	android/view/View:getLocalVisibleRect	(Landroid/graphics/Rect;)Z
    //   13: pop
    //   14: aload_0
    //   15: invokevirtual 67	android/view/View:getHeight	()I
    //   18: istore_3
    //   19: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   22: getfield 71	android/graphics/Rect:top	I
    //   25: ifne +24 -> 49
    //   28: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   31: getfield 74	android/graphics/Rect:bottom	I
    //   34: istore 4
    //   36: iload 4
    //   38: iload_3
    //   39: if_icmpne +10 -> 49
    ...
    //   47: fload_1
    //   48: freturn
    //   49: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   52: getfield 71	android/graphics/Rect:top	I
    //   55: ifle +22 -> 77
    //   58: ldc 57
    //   60: iload_3
    //   61: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   64: getfield 71	android/graphics/Rect:top	I
    //   67: isub
    //   68: i2f
    //   69: fmul
    //   70: iload_3
    ...
    //   77: fload_2
    //   78: fstore_1
    //   79: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   82: getfield 74	android/graphics/Rect:bottom	I
    //   85: ifle -41 -> 44
    //   88: fload_2
    //   89: fstore_1
    //   90: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   93: getfield 74	android/graphics/Rect:bottom	I
    //   96: iload_3
    //   97: if_icmpge -53 -> 44
    //   100: getstatic 31	obj:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   103: getfield 74	android/graphics/Rect:bottom	I
    //   106: istore 4
    //   108: ldc 57
    //   110: iload 4
    //   112: i2f
  ...
  {
    return (paramInt - (aciy.a(24.0F, paramResources) + aciy.a(3.0F, paramResources))) / 2;
  }
  ...
  public static Pair<Integer, Integer> a()
  {
    ...
    return new Pair(Integer.valueOf((localResources.getDisplayMetrics().widthPixels - aciy.a(3.0F, localResources)) / 3), Integer.valueOf(localResources.getDimensionPixelSize(2131167459)));
  }
  
  public static Pair<Integer, Integer> a(int paramInt1, int paramInt2)
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = aciy.a(1.5F, localResources);
    if (paramInt2 == 56) {
      i = aciy.a(3.0F, localResources);
    }
    ...
    {
      f1 = localbgmu.a;
      f2 = localbgmu.jdField_b_of_type_Float;
      paramInt2 = aciy.a(localbgmu.jdField_b_of_type_Int, localResources);
    }
    for (;;)
    {
      switch (paramInt1)
      ...
      for (paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - aciy.a(6, localResources) - i * 2) / 2.1F);; paramInt1 = paramInt2)
      {
        i = (int)(paramInt1 / f2);
        paramInt2 = paramInt1;
        paramInt1 = i;
        for (;;)
        {
          ...
          paramInt2 = localResources.getDisplayMetrics().widthPixels - aciy.a(12, localResources);
          paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - aciy.a(6, localResources) - i * 2) / 2.5F * 1.3356F);
          continue;
          paramInt2 = (int)((localResources.getDisplayMetrics().widthPixels - aciy.a(12, localResources) - i) * 0.5F);
  ...
  public static String a(String paramString)
  {
    ...
    do
    {
      return str;
      str = paramString;
    } while (!axku.a(paramString));
    paramString = new StringBuilder(paramString);
    int i = 0;
    while (i < axjs.a.length)
    {
      str = axjs.a[i];
      int j = -1;
      for (;;)
  ...
  {
    a(paramImageView, obz.a(paramString), paramContext);
  }
  ...
  public static void a(ImageView paramImageView, URL paramURL, Context paramContext)
  {
    if (paramURL == null)
    {
      ...
      paramImageView.setImageResource(2130841183);
      return;
    }
    ...
    for (Object localObject = (BaseActivity)paramContext;; localObject = null)
    {
      ...
      {
        if ((!badq.h(paramContext)) && (bool) && (!rcv.a().a(paramURL)))
        {
          paramImageView.setImageResource(2130841183);
          return;
        }
        localObject = URLDrawable.URLDrawableOptions.obtain();
        ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = paramContext.getResources().getDrawable(2130841183);
        ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = paramContext.getResources().getDrawable(2130841183);
    ...
    for (BaseActivity localBaseActivity = (BaseActivity)paramContext;; localBaseActivity = null)
    {
      ...
      for (boolean bool = SettingCloneUtil.readValue(localBaseActivity, str, null, "qqsetting_kandian_download_pic_flag", false);; bool = false)
      {
        if ((!badq.h(paramContext)) && (bool) && (!rcv.a().a(paramURL)))
        {
          ...
          paramKandianUrlImageView.setImageDrawable(new ColorDrawable(paramContext.getResources().getColor(2131099738)));
          return;
        }
        if (!paramBoolean)
        {
          ...
          {
            paramKandianUrlImageView.a(paramContext.getResources().getDrawable(2130840063)).a(paramURL);
            return;
          }
          paramKandianUrlImageView.a(paramContext.getResources().getDrawable(2130841183)).a(paramURL);
          return;
        }
        paramKandianUrlImageView.setBackgroundDrawable(new ColorDrawable(paramContext.getResources().getColor(2131099738)));
        paramKandianUrlImageView.a(new ColorDrawable(paramContext.getResources().getColor(2131099738))).a(paramURL);
        return;
      }
    }
  }
  ...
  public static void a(ViewBase paramViewBase, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    opt localopt = ogy.a().a();
    if ((localopt != null) && (localopt.b()))
    {
    ...
    {
      a(true, paramViewBase, localopt);
      return;
    }
    if ((localopt != null) && (localopt.a()))
    {
      a(true, paramViewBase, localopt);
  ...
  public static void a(boolean paramBoolean, ViewBase paramViewBase, opt paramopt)
  {
  ...
  public static boolean a(qht paramqht)
  {
    if (paramqht == null)
    {
      if (QLog.isColorLevel()) {
    ...
    return a(paramqht.c, paramqht.jdField_d_of_type_Int);
  }
  
  public static Pair<Integer, Integer> b()
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - aciy.a(3.0F, localResources)) / 2;
  ...
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - aciy.a(3.0F, localResources)) / 3;
