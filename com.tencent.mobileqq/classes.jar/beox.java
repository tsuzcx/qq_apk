  ...
  implements TextWatcher
{
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Beoy.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, str1, this.jdField_a_of_type_JavaLangString, paramEditable);
    }
    for (;;)
    {
      a();
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Beoy.b(this.jdField_a_of_type_Int, this.jdField_c_of_type_Int, str1, this.jdField_a_of_type_JavaLangString, paramEditable);
      }
      else if (this.jdField_c_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Beoy.b(this.jdField_a_of_type_Int, this.jdField_c_of_type_Int, str1, this.jdField_a_of_type_JavaLangString, str2);
        this.jdField_a_of_type_Beoy.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, str3, this.jdField_a_of_type_JavaLangString, paramEditable);
      }
    }
  }
