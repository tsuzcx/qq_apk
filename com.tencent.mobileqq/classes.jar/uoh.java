...
{
  public uoh(ServiceAccountFolderActivityNew paramServiceAccountFolderActivityNew) {}
  
  public void onClick(View paramView)
  {
    if (aala.a("service_account_folder_publish_feed_button", 2000L))
    {
    ...
    for (boolean bool = PermissionUtils.isStorePermissionEnable(this.a);; bool = true)
    {
      ...
      {
        aanb.a(str, (String)localObject, "post_clk", 0, 0, new String[] { "", "" });
        break;
        bool = false;
        break label141;
      }
