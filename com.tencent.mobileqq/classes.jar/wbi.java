  ...
  implements INetEngine.IBreakDownFix
{
  ...
  public void fixReq(NetReq paramNetReq, NetResp paramNetResp)
  {
    ...
    if ((paramNetReq != null) && ((paramNetReq instanceof wbk))) {
      ((wbk)paramNetReq).b = true;
    }
    ykq.b("AsyncFileDownloader", String.format("breakDown , range = %s , url = %s", new Object[] { paramNetResp, str1 }));
  }
}
