...
{
  public pbn(NewerGuidePlugin paramNewerGuidePlugin, Activity paramActivity, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (!QavCameraUsage.b(BaseApplicationImpl.getContext()))
      {
        ...
        paramView = new File(AppConstants.aJ + "photo/" + System.currentTimeMillis() + ".jpg");
