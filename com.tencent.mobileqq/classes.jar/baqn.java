...
public class baqn
{
  ...
  public int a;
  public long a;
  private baqo jdField_a_of_type_Baqo;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajyc.a(2131713522);
    jdField_b_of_type_JavaLangString = ajyc.a(2131713526);
  }
  
  public baqn(QQAppInterface paramQQAppInterface, String paramString, int paramInt, baqo parambaqo, List<String> paramList)
  {
    ...
    this.jdField_a_of_type_Baqo = parambaqo;
  ...
  public static List<TroopMemberInfo> a(QQAppInterface paramQQAppInterface, String paramString, List<String> paramList, boolean paramBoolean)
  {
    ...
    //   63: lstore 7
    //   65: aload_0
    //   66: invokevirtual 163	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lauko;
    //   69: invokevirtual 169	auko:createEntityManager	()Laukn;
    //   72: astore 13
    //   74: ldc 83
    ...
    //   284: aload 9
    //   286: aconst_null
    //   287: invokevirtual 242	aukn:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   290: astore_1
    //   291: aload_1
    //   292: ifnull +690 -> 982
    //   295: aload_1
    ...
    //   509: invokevirtual 267	ajxn:b	(Ljava/lang/String;)Z
    ...
    //   537: invokevirtual 267	ajxn:b	(Ljava/lang/String;)Z
    //   540: ifne +85 -> 625
    //   543: aload_1
    //   544: astore_2
    //   545: iload 4
    ...
    //   557: invokestatic 274	bbbd:d	(Ljava/lang/String;)Z
    //   560: ifeq +65 -> 625
    //   563: aload_1
    //   564: astore_2
    //   565: iload 4
    ...
    //   600: invokestatic 283	bahx:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Z
    //   603: ifne +22 -> 625
    //   606: aload_1
    //   607: astore_2
    //   608: iload 4
    ...
    //   681: astore 9
    //   683: aload 13
    //   685: invokevirtual 295	aukn:a	()V
    //   688: aload_1
    //   689: astore_2
    //   690: iload 4
    //   692: istore 5
    ...
    //   764: iconst_0
    //   765: aload 11
    //   767: getfield 320	com/tencent/mobileqq/data/TroopInfo:troopuin	Ljava/lang/String;
    //   770: aastore
    //   771: dup
    //   772: iconst_1
    //   773: aload 10
    ...
    //   821: aload 9
    //   823: aconst_null
    //   824: invokevirtual 242	aukn:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   827: astore_1
    //   828: goto -537 -> 291
    //   831: astore_0
    ...
    //   18	513	12	localajxn	ajxn
    //   72	730	13	localaukn	aukn
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, baqn parambaqn)
  {
    Object localObject = a(paramQQAppInterface, parambaqn.jdField_c_of_type_JavaLangString);
    if (localObject == null) {}
    int j;
    int k;
    do
    {
      ...
      akvp localakvp = ((TroopManager)paramQQAppInterface.getManager(52)).a();
      int n = (int)(localakvp.jdField_a_of_type_Float * i);
      k = (int)(localakvp.jdField_b_of_type_Float * i);
      if ((m >= n) && (j >= k) && (j > 0)) {}
      for (boolean bool = true;; bool = false)
      {
        QLog.d("troopBatchAddFrd.Scene", 1, String.format("doInsertGrayTip_V1 check nComFrdCnt_limit_nNonFrdCnt_limit_check=%d_%d_%d_%d_%b_%s", new Object[] { Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(j), Integer.valueOf(k), Boolean.valueOf(bool), parambaqn.jdField_c_of_type_JavaLangString }));
        if (!bool) {
          break;
        }
        akvn.a(paramQQAppInterface, parambaqn.jdField_c_of_type_JavaLangString, m, j, paramTroopInfo, (String)localObject);
        return;
      }
      if ((m < n) && (i != 0))
      {
        ...
        axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "commonFrd", 0, 0, parambaqn.jdField_c_of_type_JavaLangString, "", paramTroopInfo.substring(0, m - 1), "");
      }
    } while ((j >= k) || (i == 0));
    paramTroopInfo = String.format(Locale.getDefault(), "%.2f", new Object[] { Float.valueOf(j / i) });
    int i = paramTroopInfo.length();
    axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "nonFrd", 0, 0, parambaqn.jdField_c_of_type_JavaLangString, "", paramTroopInfo.substring(0, i - 1), "");
  }
  ...
  public static Object[] a(com.tencent.common.app.AppInterface paramAppInterface, String paramString)
  {
    ...
    //   75: checkcast 475	balw
    //   78: astore 21
    //   80: invokestatic 159	android/os/SystemClock:elapsedRealtime	()J
    //   83: lstore 9
    //   85: aload_0
    //   86: invokevirtual 476	com/tencent/common/app/AppInterface:getEntityManagerFactory	()Lauko;
    //   89: invokevirtual 169	auko:createEntityManager	()Laukn;
    //   92: astore 18
    //   94: aload 18
    //   96: iconst_1
    //   97: ldc 83
    ...
    //   144: ldc 150
    //   146: aconst_null
    //   147: invokevirtual 242	aukn:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   150: astore 12
    //   152: aload 12
    ...
    //   316: invokestatic 274	bbbd:d	(Ljava/lang/String;)Z
    //   319: ifeq +70 -> 389
    //   322: iload_3
    //   323: istore 7
    //   325: iload 5
    ...
    //   334: invokestatic 478	bbbd:c	(Ljava/lang/String;)Z
    //   337: ifne +52 -> 389
    //   340: iload_3
    //   341: istore 7
    //   343: iload 5
    ...
    //   379: invokevirtual 479	balw:b	(Ljava/lang/String;)Z
    //   382: istore 11
    //   384: iload 11
    //   386: ifeq +266 -> 652
    //   389: aload_1
    ...
    //   446: astore 17
    //   448: aload 18
    //   450: invokevirtual 295	aukn:a	()V
    //   453: aload_0
    //   454: astore 17
    ...
    //   666: invokevirtual 267	ajxn:b	(Ljava/lang/String;)Z
    //   669: ifeq +26 -> 695
    //   672: aload_1
    //   673: astore 13
    //   675: aload_0
  ...
  public static void b(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, baqn parambaqn)
  {
    int j = parambaqn.jdField_e_of_type_Int;
    int i = parambaqn.jdField_d_of_type_Int;
    Object localObject1 = parambaqn.jdField_e_of_type_JavaLangString;
    ...
    QLog.i("troopBatchAddFrd.Scene", 1, String.format("doInsertGrayTip_V2 troopUin_type_nonFrdCnt_cmnFrdCnt=%s_%d_%d_%d", new Object[] { paramTroopInfo.troopuin, Integer.valueOf(parambaqn.jdField_a_of_type_Int), Integer.valueOf(j), Integer.valueOf(i) }));
    ...
    label584:
    label607:
    for (localObject1 = (String)localObject1 + ajyc.a(2131713523);; localObject1 = (String)localObject1 + ajyc.a(2131713525))
    {
      localObject2 = ajyc.a(2131713524);
      j = ((String)localObject1).indexOf((String)localObject2);
      int k = ((String)localObject2).length();
      localObject2 = new aquz(paramTroopInfo.troopuin, paramTroopInfo.troopuin, (String)localObject1, 1, -5020, 135178, l2);
      ((aquz)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
      ...
      ((aquz)localObject2).a(j, j + k, (Bundle)localObject1);
      ((aquz)localObject2).jdField_d_of_type_JavaLangString = (a(parambaqn.jdField_a_of_type_Int) + "-" + parambaqn.jdField_d_of_type_JavaLangString);
      localObject1 = new MessageForUniteGrayTip();
      ((MessageForUniteGrayTip)localObject1).initGrayTipMsg(paramQQAppInterface, (aquz)localObject2);
      ...
      localObject1 = ((akhq)paramQQAppInterface.a(20)).a();
      ((TroopBatchAddFriendMgr)localObject1).b(parambaqn.jdField_d_of_type_JavaLangString, parambaqn.jdField_c_of_type_JavaLangString);
      if (parambaqn.jdField_a_of_type_Int == 4) {
        ((TroopBatchAddFriendMgr)localObject1).b(parambaqn.jdField_c_of_type_JavaLangString);
      }
      localObject1 = "1";
      if (i > 0) {
        localObject1 = "0";
      }
      axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", a(true, parambaqn.jdField_a_of_type_Int), 0, 0, paramTroopInfo.troopuin, Integer.toString(parambaqn.f), Integer.toString(paramTroopInfo.wMemberNum), (String)localObject1);
      return;
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    akvp localakvp = ((TroopManager)localObject).a();
    if (localakvp.jdField_a_of_type_Int != 1) {
      return false;
    }
    ...
    if (!localakvp.a((TroopInfo)localObject, akvp.jdField_a_of_type_ArrayOfLong)) {
      return false;
    }
    if (((TroopInfo)localObject).dwCmdUinJoinTime < localakvp.jdField_a_of_type_Long)
    {
    ...
    long l1 = localakvp.jdField_c_of_type_Int * 86400;
    long l2 = NetConnInfoCenter.getServerTime();
    long l3 = l2 - ((TroopInfo)localObject).dwCmdUinJoinTime;
    if ((l3 > l1) || (l3 < 0L))
    {
      axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "joinDate", 0, 0, paramString, "", String.valueOf(l3 / 86400L), "");
      return false;
    }
    if (((TroopInfo)localObject).wMemberNum > localakvp.jdField_b_of_type_Int)
    {
      axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "mberNum", 0, 0, paramString, "", String.valueOf(((TroopInfo)localObject).wMemberNum), "");
      return false;
    }
    if (((TroopInfo)localObject).wClickBAFTipCount != 0) {
      return false;
    }
    if (((TroopInfo)localObject).wInsertBAFTipCount >= localakvp.jdField_d_of_type_Int) {
      return false;
    }
    ...
    return akvn.a(((TroopInfo)localObject).dwLastInsertBAFTipTime, l2);
  }
  ...
  private boolean c()
  {
    ...
    int n = (int)(((akvp)localObject).jdField_a_of_type_Float * i);
    int k = (int)(((akvp)localObject).jdField_b_of_type_Float * i);
    if ((m >= n) && (j >= k) && (j > 0)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((m < n) && (i != 0))
    {
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "commonFrd", 0, 0, this.jdField_c_of_type_JavaLangString, "", ((String)localObject).substring(0, m - 1), "");
    }
    if ((j < k) && (i != 0))
    {
      localObject = String.format(Locale.getDefault(), "%.2f", new Object[] { Float.valueOf(j / i) });
      i = ((String)localObject).length();
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "nonFrd", 0, 0, this.jdField_c_of_type_JavaLangString, "", ((String)localObject).substring(0, i - 1), "");
    }
    return false;
  }
  ...
  public static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    TroopBatchAddFriendMgr localTroopBatchAddFriendMgr = ((akhq)paramQQAppInterface.a(20)).a();
    ...
    if (!((akvp)localObject).a(localTroopInfo, ((akvp)localObject).jdField_b_of_type_ArrayOfLong))
    {
    ...
    if (localTroopInfo.wMemberNum > ((akvp)localObject).s)
    {
      axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "mberNum", 0, 0, localTroopInfo.troopuin, Integer.toString(a(paramInt)), Integer.toString(localTroopInfo.wMemberNum), "");
      localStringBuilder.append(" ").append("err:").append("member count").append(localTroopInfo.wMemberNum).append(">").append(((akvp)localObject).s);
      if (QLog.isColorLevel()) {
        QLog.i("troopBatchAddFrd.Scene", 2, localStringBuilder.toString());
      }
      return false;
    ...
    {
      axqw.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "grpNum", 0, 0, localTroopInfo.troopuin, Integer.toString(a(paramInt)), Integer.toString(localTroopInfo.wMemberNum), "");
  ...
  private boolean d()
  {
    TroopBatchAddFriendMgr localTroopBatchAddFriendMgr = ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a();
    List localList = a();
  ...
  public int a()
  {
    ...
    if (i == 0)
    {
      ...
      ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(localTroopInfo.troopuin, localTroopInfo.troopcode, this.jdField_a_of_type_Long, this.jdField_a_of_type_Int);
      return 0;
    }
    if (i != 1)
    {
  ...
  List<TroopMemberInfo> a()
  {
    ...
    int k = ((akvp)localObject2).a(this.jdField_a_of_type_Int);
    int j;
    int i;
    ...
    for (;;)
    {
      ...
      if (i < k)
      {
        ...
        {
          axqw.b((QQAppInterface)localObject2, "dc00899", "Grp_addFrd", "", "nonGreyTip", "actvie-res", 0, 0, (String)localObject3, str, Integer.toString(i), "");
          return null;
        }
        ...
        for (;;)
        {
          ...
          {
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "discus-res", 0, 0, this.jdField_c_of_type_JavaLangString, Integer.toString(i), Integer.toString(((List)localObject2).size()), "");
            return localObject1;
            localObject1 = new ArrayList();
            ...
            if (((List)localObject1).size() == 0)
            {
              ...
              {
                axqw.b((QQAppInterface)localObject3, "dc00899", "Grp_addFrd", "", "nonGreyTip", "new_res", 0, 0, str, Integer.toString(i), "", "");
                return localObject1;
              }
              localObject1 = new ArrayList();
              localObject2 = a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilList, false);
              ...
              if (((List)localObject1).size() == 0)
              {
                ...
                for (i = 0;; i = ((TroopMemberInfo)((List)localObject2).get(0)).commonFrdCnt)
                {
                  axqw.b((QQAppInterface)localObject3, "dc00899", "Grp_addFrd", "", "nonGreyTip", "@_res", 0, 0, str, Integer.toString(i), "", "");
                  return localObject1;
                }
              }
              return localObject1;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Baqo != null) {
      this.jdField_a_of_type_Baqo.b(this);
    }
  }
  ...
  void a(List<TroopMemberInfo> paramList)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_addFrd", "", "nonGreyTip", "UinNum_total", 0, 0, this.jdField_c_of_type_JavaLangString, Integer.toString(a(this.jdField_a_of_type_Int)), Integer.toString(i), "");
        return;
      }
    }
  }
  ...
  public int b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      switch (((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.jdField_c_of_type_JavaLangString, l, this.jdField_a_of_type_Int))
      {
      default: 
        i = -1;
      case 1: 
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Baqo != null) {
      this.jdField_a_of_type_Baqo.a(this);
    }
  }
  ...
  public int c()
  {
    ...
    String str;
    int k;
    if ((l == 0L) || (System.currentTimeMillis() - l > ((akvp)localObject).t * 60 * 60 * 1000))
    {
      bool = true;
      ...
      {
        localObject = ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a();
        str = this.jdField_c_of_type_JavaLangString;
  ...
  public int d()
  {
    ...
    String str;
    int k;
    if ((l == 0L) || (System.currentTimeMillis() - l > ((akvp)localObject).u * 60 * 60 * 1000))
    {
      bool = true;
