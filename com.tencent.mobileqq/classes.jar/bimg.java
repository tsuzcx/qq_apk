...
public abstract class bimg
{
  ...
  public bimg(Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
  ...
  private void bindWebChromeClient()
  {
    if (this.mChromeClient == null) {
      this.mChromeClient = new bimk(this);
    }
  ...
  private void bindWebViewClient()
  {
    ...
    for (this.mWebViewClient = new bimi(this);; this.mWebViewClient = new bimj(this))
    {
    ...
    if (this.mOfflinePlugin == null)
    {
      ...
      if (localObject != null)
      {
        ...
        if ((localObject != null) && ((localObject instanceof abff))) {
          this.mOfflinePlugin = ((abff)localObject);
        }
      }
    }
  }
  ...
  private void initWebView(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      localWebSettings.setUserAgentString(birz.a(paramAppInterface, str1, bool));
      ...
      catch (RuntimeException paramAppInterface)
      {
        try
        {
          for (;;)
          {
            ...
            this.mWebview.setDownloadListener(new bimh(this));
            CookieSyncManager.createInstance(this.mContext.getApplicationContext());
            if (this.mWebview.getX5WebViewExtension() != null)
            {
              this.mWebview.getX5WebViewExtension().setWebViewClientExtension(new biml(this, this.mWebview));
  ...
  public void initPluginEngine()
  {
    ...
    //   17: aload_0
    //   18: getfield 193	bimg:mPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   21: ifnull +4 -> 25
    //   24: return
    //   25: aload_0
    //   26: getfield 58	bimg:sInitEngineLock	Ljava/lang/Object;
    //   29: astore 5
    //   31: aload 5
    //   33: monitorenter
    //   34: aload_0
    //   35: getfield 193	bimg:mPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   38: ifnonnull +100 -> 138
    //   41: aload_0
    //   42: invokespecial 552	bimg:bindAllJavaScript	()V
    //   45: iconst_0
    //   46: istore_3
    //   47: iconst_0
    //   48: istore 4
    ...
    //   52: istore_1
    //   53: aload_0
    //   54: getfield 81	bimg:mInterface	Lcom/tencent/common/app/AppInterface;
    //   57: invokestatic 557	bilz:a	(Lmqq/app/AppRuntime;)Z
    //   60: ifeq +55 -> 115
    //   63: iload 4
    //   65: istore_1
    //   66: getstatic 560	bilz:c	Z
    //   69: ifne +46 -> 115
    //   72: iload 4
    //   74: istore_1
    //   75: getstatic 562	bilz:jdField_a_of_type_Boolean	Z
    //   78: ifeq +37 -> 115
    //   81: getstatic 564	bilz:jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   84: astore 6
    //   86: aload_0
    //   87: aload 6
    //   89: putfield 193	bimg:mPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   92: aload 6
    //   94: ifnull +56 -> 150
    ...
    //   116: ifeq +112 -> 228
    //   119: aload_0
    //   120: getfield 193	bimg:mPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   123: aload_0
    //   124: getfield 81	bimg:mInterface	Lcom/tencent/common/app/AppInterface;
    //   127: aload_0
    //   128: getfield 79	bimg:mInActivity	Landroid/app/Activity;
    //   131: aload_0
    //   132: getfield 102	bimg:mPluginList	Ljava/util/ArrayList;
    ...
    //   147: aload 6
    //   149: athrow
    //   150: getstatic 571	bilz:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   153: astore 6
    //   155: aload 6
    //   157: monitorenter
    //   158: getstatic 571	bilz:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   161: ldc2_w 572
    //   164: invokevirtual 576	java/lang/Object:wait	(J)V
    //   167: getstatic 564	bilz:jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   170: astore 7
    //   172: aload_0
    //   173: aload 7
    //   175: putfield 193	bimg:mPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   178: aload 7
    //   180: ifnull +78 -> 258
    //   183: iload_2
    //   184: istore_1
    ...
    //   232: aload_0
    //   233: getfield 81	bimg:mInterface	Lcom/tencent/common/app/AppInterface;
    //   236: aload_0
    //   237: getfield 79	bimg:mInActivity	Landroid/app/Activity;
    //   240: aconst_null
    //   241: aload_0
    //   242: invokevirtual 591	bimg:myCommonJsPlugins	()Lcom/tencent/mobileqq/webprocess/WebAccelerateHelper$CommonJsPluginFactory;
    //   245: aload_0
    //   246: getfield 102	bimg:mPluginList	Ljava/util/ArrayList;
    ...
    //   252: putfield 193	bimg:mPluginEngine	Lcom/tencent/mobileqq/webview/swift/WebViewPluginEngine;
    //   255: goto -117 -> 138
    //   258: iconst_0
    //   259: istore_1
    //   260: goto -58 -> 202
  ...
  protected final void preInitPluginEngine()
  {
    ...
    if ((bilz.a(this.mInterface)) && (!bilz.c))
    {
      localWebViewPluginEngine = bilz.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPluginEngine;
    ...
    if ((bilz.b(this.mInterface)) && (!bilz.d))
    {
      localWebViewPluginEngine = bilz.b;
      this.mPluginEngine = localWebViewPluginEngine;
      if (localWebViewPluginEngine != null)
      {
        if (QLog.isColorLevel()) {
