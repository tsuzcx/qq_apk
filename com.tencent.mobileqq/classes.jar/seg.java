...
{
  public seg(Conversation paramConversation) {}
  
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 0) {
      this.a.a(new sej(this));
    }
  }
  ...
  protected void c(boolean paramBoolean)
  {
    ...
    if (this.a.b > 0L) {
      StartupTracker.a("Conversation_PullToRefresh_msgCB", SystemClock.uptimeMillis() - this.a.b);
    }
    if (this.a.jdField_a_of_type_Long != 1000L) {
      this.a.jdField_a_of_type_Long = 1000L;
    }
    this.a.a(new seh(this, paramBoolean));
  ...
  {
    this.a.a(new sei(this, paramBoolean));
  }
}
