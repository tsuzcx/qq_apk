  ...
  implements sdw
{
  ...
  public Bundle a;
  bcya jdField_a_of_type_Bcya = new sek(this);
  bcyc jdField_a_of_type_Bcyc = new sej(this);
  private WeakReference<Context> jdField_a_of_type_JavaLangRefWeakReference;
  private sdu jdField_a_of_type_Sdu;
  private sea jdField_a_of_type_Sea;
  private seb jdField_a_of_type_Seb = new seh(this);
  private long jdField_b_of_type_Long;
  private QQAppInterface jdField_b_of_type_ComTencentMobileqqAppQQAppInterface;
  private WeakReference<rtc> jdField_b_of_type_JavaLangRefWeakReference;
  private sea jdField_b_of_type_Sea;
  private seb jdField_b_of_type_Seb = new sei(this);
  private long c;
  ...
  public seg(Context paramContext, rtc paramrtc, Intent paramIntent)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramrtc);
    this.jdField_a_of_type_AndroidOsBundle = paramIntent.getExtras();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a(this.jdField_a_of_type_AndroidOsBundle);
    rsz.a(this.jdField_a_of_type_AndroidOsBundle);
    this.jdField_a_of_type_Sea = new sec(paramContext, this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Seb);
    this.jdField_b_of_type_Sea = new sel(paramContext, this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_Seb, this.jdField_d_of_type_JavaLangString);
  }
  ...
  private void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    if ((this.jdField_b_of_type_JavaLangRefWeakReference != null) && (this.jdField_b_of_type_JavaLangRefWeakReference.get() != null)) {
      ((rtc)this.jdField_b_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_JavaLangString, paramInt, sdx.a().a(paramString1).b(paramString2).d(paramString4).c(paramString3).e(paramString5).a(this.c).b(this.jdField_d_of_type_Long).a());
    }
  }
  
  private void a(Bundle paramBundle)
  {
    this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface = ((QQAppInterface)pkh.a());
  ...
  private void a(sdx paramsdx)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString("compressPath", this.jdField_h_of_type_JavaLangString);
    a(false, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidOsBundle, paramsdx, (rtc)this.jdField_b_of_type_JavaLangRefWeakReference.get());
  }
  ...
  private void b(float paramFloat)
  {
    ...
    if ((this.jdField_b_of_type_JavaLangRefWeakReference != null) && (this.jdField_b_of_type_JavaLangRefWeakReference.get() != null) && (!this.jdField_g_of_type_Boolean)) {
      ((rtc)this.jdField_b_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Float);
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Sea.a(this.jdField_e_of_type_JavaLangString, true);
      continue;
      c(100.0F);
      if (!this.jdField_g_of_type_Boolean)
      {
        this.jdField_b_of_type_Sea.a(this.jdField_h_of_type_JavaLangString, true);
        continue;
        b(100.0F);
      }
    }
  ...
  private void c()
  {
    this.jdField_a_of_type_Sdu = new sdu((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_e_of_type_Boolean, this.jdField_f_of_type_Boolean, this);
    this.jdField_a_of_type_Sdu.execute(new String[] { this.jdField_d_of_type_JavaLangString });
  ...
  private void d()
  {
    ...
    {
      VideoEnvironment.LogDownLoad("ReadInJoyDeliverVideoActivity_AvCodecSo", anvx.a(2131707073), null);
      return;
    }
    if (this.jdField_f_of_type_Boolean)
    {
    ...
    {
      VideoEnvironment.LogDownLoad("ReadInJoyDeliverVideoActivity_AvCodecSo", anvx.a(2131707068), null);
      ShortVideoResourceManager.b(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Bcyc);
      return;
    }
    VideoEnvironment.LogDownLoad("ReadInJoyDeliverVideoActivity_AvCodecSo", anvx.a(2131707066), null);
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_Sea.b();
    this.jdField_b_of_type_Sea.b();
  }
}
