  ...
  extends bhgj
{
  ...
  public bhsf(FriendListOpenFrame paramFriendListOpenFrame)
  {
  ...
  protected void a()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bhvo.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Int);
    bhzm.c("FriendListOpenFrame", "-->start constructHashStruct()");
    ...
    bhzm.c("FriendListOpenFrame", "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562780, paramViewGroup, false);
      paramView = new bhsg();
      ...
      if (!this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_Bhvo.a(((Friend)localObject).a)) {
        break label399;
      }
      ...
      if ((((Friend)localObject).d == null) || ("".equals(((Friend)localObject).d))) {
        ((Friend)localObject).d = bhvv.a(this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), ((Friend)localObject).a);
      }
      ...
      bhvs.a().a(((Friend)localObject).d, this.jdField_a_of_type_ComTencentOpenAgentFriendListOpenFrame);
      label330:
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (bhsg)paramView.getTag();
      localView = paramView;
