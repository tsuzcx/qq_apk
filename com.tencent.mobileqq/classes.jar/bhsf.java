...
public class bhsf
{
  ...
  {
    paramQQAppInterface = paramQQAppInterface.getMessageFacade().getMessages(AppConstants.QQ_VIP_UIN, 1008, 50);
  ...
  public static void a(int paramInt1, QQVipMsgInfo paramQQVipMsgInfo, int paramInt2)
  {
    ...
    apau.a(paramInt1, paramInt2, str, paramQQVipMsgInfo.triggerInfo);
  }
  ...
  {
    Object localObject = (aoan)((QQAppInterface)a()).getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER);
    if (localObject != null)
    {
      localObject = ((aoan)localObject).b(AppConstants.QQ_VIP_UIN);
      if (localObject != null) {
  ...
  public static void c(Context paramContext)
  {
    ...
    paramContext = new NewIntent(paramContext, oln.class);
    ...
    try
    {
      ...
      paramContext.setObserver(new bhsg(localQQAppInterface));
