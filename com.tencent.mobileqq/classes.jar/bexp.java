...
public class bexp
  implements bexf
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bexr(this);
  ...
  {
    bejn.c().post(new VConsoleLogManager.4(this, paramString));
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    {
      betc.d("[minigame] VConsoleLogManager", "consoleWebView is not ready");
      return;
    }
    bejn.c().post(new VConsoleLogManager.3(this, paramString1, paramString2));
  }
  ...
  public void a(VConsoleView paramVConsoleView, VConsoleDragView paramVConsoleDragView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWebkitWebView.setWebViewClient(new bexq(this));
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    catch (Throwable paramString1)
    {
      for (;;)
      {
        betc.d("[minigame] VConsoleLogManager", "injectLog error", paramString1);
      }
    }
    finally {}
  }
