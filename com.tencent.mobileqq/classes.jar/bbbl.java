  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Integer, bbbk> a;
  private boolean a;
  
  public bbbl(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Anzt = ((anzt)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.NUMREDMSG_HANDLER));
  }
  ...
  private void a(long[] paramArrayOfLong, bbbk parambbbk, String paramString, boolean paramBoolean)
  {
    ThreadManager.post(new NumRedMsgManager.2(this, paramArrayOfLong, parambbbk, paramBoolean, paramString), 5, null, false);
  }
  ...
  {
    boolean bool = FileUtils.pushData2File(new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "NumRedMsgFileName_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramNumMsgRspBody.toByteArray(), false);
    if (bool) {
  ...
  public void a(NumRedMsg.NumMsgRspBody paramNumMsgRspBody, ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      paramNumMsgRspBody = (bbbk)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
      if (paramNumMsgRspBody == null) {
        break;
      }
  ...
  public void a(List<Submsgtype0x89.NumRedBusiInfo> paramList, String paramString, bbbk parambbbk)
  {
    ThreadManager.post(new NumRedMsgManager.1(this, paramList, parambbbk, paramString), 5, null, false);
  }
  
  public void a(long[] paramArrayOfLong, String paramString, bbbk parambbbk)
  {
    a(paramArrayOfLong, parambbbk, paramString, false);
  }
