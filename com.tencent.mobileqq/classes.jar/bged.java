  ...
  extends aofu
{
  ...
  {
    if ((paramRespBatchProcess == null) || (paramRespBatchProcess.batch_response_list == null) || (paramRespBatchProcess.batch_response_list.size() == 0) || (bgdy.a(this.a) == null)) {}
    int j;
    do
    {
      do
      {
        ...
        {
          return;
        } while ((!String.valueOf(paramLong).equals(bgdy.a(this.a).troopUin)) || (bgdy.a(this.a) == null) || (bgdy.a(this.a) == null));
        if (bgdy.a(this.a).a != null) {
          bgdy.a(this.a).a.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }
      } while (!String.valueOf(paramLong).equals(bgdy.a(this.a).troopUin));
  ...
  protected void onCmdTroopAvatar(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, List<TroopClipPic> paramList)
  {
    ...
    while (!bhbx.a(paramString1, bgdy.a(this.a).troopUin)) {
      return;
    }
    if (paramInt1 == 0)
    {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramString1 = bgdy.a(this.a).getString(2131695804);
    }
    for (;;)
    {
      bgdy.a(this.a).a(paramString1);
      return;
      label106:
      if (paramInt1 == 2) {
        paramString1 = bgdy.a(this.a).getString(2131695802);
      } else if (paramInt1 == 3) {
        paramString1 = bgdy.a(this.a).getString(2131695815);
      } else if (paramInt1 == 4) {
        paramString1 = bgdy.a(this.a).getString(2131695816);
      } else {
        paramString1 = bgdy.a(this.a).getString(2131695813);
      }
    }
  }
  ...
  protected void onGetAddTroopWebInfo(String paramString)
  {
    ...
    bgdy.a(this.a).d(paramString);
  }
  
  protected void onGetTroopAuthSubmitTime(boolean paramBoolean, String paramString, int paramInt)
  {
    if ((paramBoolean) && (bgdy.a(this.a) != null) && (paramString.equals(bgdy.a(this.a).troopUin))) {
      this.a.a = paramInt;
    }
  }
  ...
  protected void onGetTroopAvatar(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, List<TroopClipPic> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((!paramBoolean) || (!bhbx.a(paramString1, bgdy.a(this.a).troopUin)));
      if (paramInt1 == 0)
      {
        this.a.a(paramList, true);
        return;
    ...
    if ((paramInt1 == 1) || (paramInt1 == 2)) {
      paramString2 = bgdy.a(this.a).getString(2131695804);
    }
    for (;;)
    {
      bgdy.a(this.a).a(paramString2);
      return;
      if (paramInt1 == 19) {
        paramString2 = bgdy.a(this.a).getString(2131695802);
      } else if (paramInt1 == 65) {
        paramString2 = bgdy.a(this.a).getString(2131695803);
      }
    }
  }
  ...
  {
    if ((paramBoolean) && (bgdy.a(this.a) != null) && (bgdy.a(this.a) != null) && (!TextUtils.isEmpty(bgdy.a(this.a).troopUin)) && (bgdy.a(this.a).troopUin.equals(paramString1))) {
      bgdy.a(this.a).a(paramBoolean, paramString1, paramString2);
    }
  }
  ...
  protected void onJoinTroopSecurityTips(boolean paramBoolean, String paramString, int paramInt, long paramLong)
  {
    ...
    if ((bgdy.a(this.a) == null) || (TextUtils.isEmpty(bgdy.a(this.a).troopUin)) || (TextUtils.isEmpty(paramString)) || (!bgdy.a(this.a).troopUin.equals(paramString)) || (paramBoolean)) {
      return;
    }
    bgdy.a(this.a).a(paramBoolean, paramString, paramInt, paramLong);
  }
  ...
  protected void onOIDB0X88D_1_Ret(boolean paramBoolean, long paramLong, int paramInt1, TroopInfo paramTroopInfo, int paramInt2, String paramString)
  {
    ...
    bgdy.a(this.a).a(paramBoolean, paramLong, paramTroopInfo);
  }
  ...
  protected void onOIDB0X899_1_Ret(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if (paramInt1 != 2) {}
    while ((!paramBoolean) || (bgdy.a(this.a) == null) || (paramList == null) || (paramList.isEmpty())) {
      return;
    }
    bgdy.a(this.a).a(paramLong1, paramList);
  }
  ...
  protected void onTroopManagerFailed(int paramInt1, int paramInt2)
  {
    ...
    bgdy.a(this.a).a(paramInt1, paramInt2);
  }
  ...
  protected void onTroopManagerSuccess(int paramInt1, int paramInt2, String paramString)
  {
    ...
    label123:
    bgdy.a(this.a).a(paramInt1, paramInt2, paramString);
  }
}
