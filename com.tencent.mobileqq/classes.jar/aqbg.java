  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      break;
      aqbc.a(this.a, "user_click", "more_about", "share", "success");
      continue;
      aqbc.a(this.a, "user_click", "custom_button", "share_QQ", "success");
      continue;
      aqbc.a(this.a, "user_click", "more_button", "share_QQ", "success");
    }
    label171:
    if (this.a.f())
    {
      if ((aqbc.a(this.a) != null) && (!aqbc.a(this.a).isEmpty()))
      {
        paramDialogInterface = aqbc.a(this.a).iterator();
        while (paramDialogInterface.hasNext())
        {
          localObject1 = (ResultRecord)paramDialogInterface.next();
          if (((ResultRecord)localObject1).b == 6000) {
            this.a.b(aqas.f.intValue());
          } else if (((ResultRecord)localObject1).b == 6003) {
            this.a.b(aqas.k.intValue());
          }
        }
        if ((aqbc.b(this.a) == null) || (aqbc.b(this.a).isEmpty()))
        {
        ...
        this.a.jdField_a_of_type_AndroidOsBundle.putParcelableArrayList("forward_multi_target", aqbc.b(this.a));
        this.a.jdField_a_of_type_AndroidContentIntent.putParcelableArrayListExtra("forward_multi_target", aqbc.b(this.a));
      }
      this.a.d();
      if (this.a.c) {}
      for (;;)
      {
        if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
          axqw.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A4A2", "0X800A4A2", 0, 0, "0", "", "", "");
        }
        aqbc.b(this.a);
    ...
    if (((bakk)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((String)localObject2, true).a)
    {
      bcpw.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697656, 0).b(this.a.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      return;
    }
    bool1 = false;
    ...
    if (bool1)
    {
      ...
      noo.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", paramDialogInterface, "0X8005A2C", "0X8005A2C", 0, 0, "", "", "", "", false);
    }
    if (this.a.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_source_from_shoot_quick", false))
    {
      ...
      if (i == 21)
      {
        ...
        label851:
        axqw.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramDialogInterface, paramDialogInterface, 0, 0, "", "", "", "");
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramDialogInterface)
      {
        ...
        continue;
        if (i != aqas.j.intValue()) {
          continue;
        }
        this.a.y();
        continue;
        if (i != aqas.m.intValue()) {
          continue;
        }
        this.a.z();
        continue;
        if (i != aqas.e.intValue()) {
          continue;
        }
        paramDialogInterface = null;
        if (!(this.a.jdField_a_of_type_Bbgg instanceof bbhb)) {
          continue;
        }
        paramDialogInterface = ((bbhb)this.a.jdField_a_of_type_Bbgg).a();
        ...
        paramInt = 1001;
        continue;
        noo.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X80059DC", "0X80059DC", paramInt, 0, (String)localObject1, (String)localObject2, paramDialogInterface, (String)localObject3, false);
        continue;
        continue;
      }
      ...
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("forward_report_confirm")))
      {
        ...
        axqw.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramDialogInterface, paramDialogInterface, 0, 0, (String)localObject1, "", "", "");
      }
      bool1 = false;
      if (this.a.jdField_a_of_type_AndroidOsBundle != null)
      {
        ...
        noo.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", (String)localObject1, "0X8005B07", "0X8005B07", paramInt, 0, str, (String)localObject2, paramDialogInterface, (String)localObject3, false);
      }
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (!bool1))
      {
        ...
        if (localObject2 != null)
        {
          ...
          {
            localObject3 = axuy.a(paramDialogInterface);
            if (localObject3 != null)
            {
              localObject1 = this.a.jdField_a_of_type_AndroidOsBundle.getString("uin");
              paramDialogInterface = (DialogInterface)localObject1;
              ...
              noo.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", paramDialogInterface, "0X8005B06", "0X8005B06", 0, 0, (String)localObject2, "" + ((AbsStructMsg)localObject3).msgId, "", "", false);
              noo.a("0X8005B06", paramDialogInterface, (String)localObject2, "" + ((AbsStructMsg)localObject3).msgId, "", "");
            }
          }
        }
      }
      if (this.a.c) {
        bded.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", String.valueOf(this.a.jdField_a_of_type_Long), "1000", "50", "0", false);
      }
      ...
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("KEY_FROM_OCR", false))) {
        axqw.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C8E", "0X8009C8E", 0, 0, "", "", "", "");
      }
      ...
      axqw.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C85", "0X8009C85", 0, 0, "", "", "", "");
      break;
      if (i != 1) {
        break label851;
      }
