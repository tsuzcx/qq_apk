  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    if (this.a.c) {
      bdes.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", String.valueOf(this.a.jdField_a_of_type_Long), "1000", "52", "0", false);
    }
    ...
    bgpw.a(this.a.jdField_a_of_type_AndroidAppActivity, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), localIntent, -1, true);
    bgqi.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 5, 0);
    this.a.jdField_a_of_type_AndroidAppActivity.setResult(1);
  }
}
