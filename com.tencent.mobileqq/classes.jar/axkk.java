  ...
  extends ReplacementSpan
{
  ...
  public axkk(int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  protected Drawable b()
  {
    ...
    {
      localDrawable2 = axku.a(this.jdField_a_of_type_Int);
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localDrawable2 = axku.a(this.jdField_a_of_type_Int, false);
          localDrawable1 = localDrawable2;
        } while (localDrawable2 == null);
        localDrawable2.setBounds(0, 0, this.jdField_b_of_type_Int, this.jdField_b_of_type_Int);
        return localDrawable2;
        i = 0x7FFFFFFF & this.jdField_a_of_type_Int;
        if ((i < 0) || (i >= axjs.b.length)) {
          break label169;
        }
        if (axjs.b[i] != axjs.a[i]) {
          break;
        }
        localDrawable2 = axku.a(i, false);
        localDrawable1 = localDrawable2;
      } while (localDrawable2 == null);
      localDrawable2.setBounds(0, 0, this.jdField_b_of_type_Int, this.jdField_b_of_type_Int);
      return localDrawable2;
      localDrawable2 = axku.a(i, true);
      localDrawable1 = localDrawable2;
    } while (localDrawable2 == null);
    localDrawable2.setBounds(0, 0, this.jdField_b_of_type_Int, this.jdField_b_of_type_Int);
    return localDrawable2;
