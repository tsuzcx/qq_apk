...
public class afjm
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, SubMsgType0x87.MsgBody paramMsgBody)
  {
    ...
    Object localObject2 = ajyc.a(2131701947);
    String str4 = String.format("%s(%s)", new Object[] { str2, localObject1 });
    String str5 = ajyc.a(2131701945);
    if (j == 1) {}
    for (paramMsgBody = ajyc.a(2131701939);; paramMsgBody = ajyc.a(2131701942))
    {
      String str7 = String.format(str5, new Object[] { paramMsgBody });
      String str6 = String.format("%s(%s)", new Object[] { str3, str1 });
      paramMsgBody = ajyc.a(2131701943);
      str5 = ajyc.a(2131701940);
      aquz localaquz = new aquz(str1, str1, (String)localObject2 + str4 + str7 + str6 + "的好友列表中。\n不想和他们是好友关系，可选择" + paramMsgBody + "。\n不想再被其他好友克隆，可选择" + str5 + "。", 0, -5040, 2686977, awzw.a());
      ...
      localaquz.a(j, str5.length() + j, (Bundle)localObject1);
      ...
      paramMsgBody.msg = String.format(ajyc.a(2131701944), new Object[] { str2, str3, str1 });
      paramMsgBody.time = awzw.a();
      paramQQAppInterface.a().a(paramMsgBody, paramQQAppInterface.c());
      paramMsgBody = new MessageForUniteGrayTip();
      paramMsgBody.initGrayTipMsg(paramQQAppInterface, new aquz(str1, str1, ajyc.a(2131701941), 0, -5020, 2686977, awzw.a()));
      aqva.a(paramQQAppInterface, paramMsgBody);
