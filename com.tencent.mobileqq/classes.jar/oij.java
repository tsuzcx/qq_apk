  ...
  implements BaseLayer.OnLayerTouchListener
{
  ...
  private oij(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new oik(this));
    ...
    localAlphaAnimation.setAnimationListener(new oil(this));
    if (paramBoolean2) {
