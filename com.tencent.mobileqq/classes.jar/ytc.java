...
public class ytc
{
  public static ytb a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (TextUtils.isEmpty(paramContext))
        {
          ...
          if (i < paramContext.length())
          {
            ...
            paramString.add(new ytb(localJSONObject));
            break label130;
          }
        }
        else
      ...
      catch (JSONException paramContext)
      {
        ...
        if (paramString.size() > 1) {
          Collections.sort(paramString, new ytd());
        }
        if (paramString.size() > 0) {
          return (ytb)paramString.get(0);
        }
        return null;
      }
      label125:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(paramString))
        {
          ...
          localObject3 = new ytb((JSONObject)localObject2).a();
  ...
  public static void a(Context paramContext, ytb paramytb)
  {
    int i = 0;
    if (paramytb == null) {
      return;
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          ((JSONArray)localObject).put(new JSONObject(paramytb.e()));
      ...
      {
        localObject = new ytb(((JSONArray)localObject).getJSONObject(0));
        if (localObject != null)
        {
          int j = ((ytb)localObject).a();
          int k = paramytb.a();
          if (j >= k) {}
        }
        else
