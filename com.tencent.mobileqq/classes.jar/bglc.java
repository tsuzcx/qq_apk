  ...
  extends bgix
{
  ...
  public bglc()
  {
    this.jdField_a_of_type_JavaLangString = bglc.class.getSimpleName();
  }
  ...
  private void a(String paramString)
  {
    ...
    localObject = bgld.a((Bundle)localObject);
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localIntent.putExtras(bgld.b(localIntent.getExtras(), paramString1));
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    paramString1 = bgld.b(paramString1);
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(paramString2, new String[] { paramString1 });
  }
  ...
  private void c(String paramString1, String paramString2)
  {
    ...
    do
    {
      return;
      localIntent = new Intent();
      localIntent.putExtras(bgld.a(localIntent.getExtras(), paramString1));
      ((Activity)localObject).setResult(-1, localIntent);
    } while (TextUtils.isEmpty(paramString2));
    localObject = localIntent.getStringExtra("key_parse_json_status");
    paramString1 = "{\"ret\":0, \"msg\":\"sucess\"}";
