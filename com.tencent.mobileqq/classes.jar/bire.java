  ...
  implements bird
{
  ...
  {
    if (jdField_a_of_type_Bire == null) {
      jdField_a_of_type_Bire = new bire();
    }
    return jdField_a_of_type_Bire;
  }
  ...
  protected String a(int paramInt)
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        bisy.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", localJSONException);
      }
    }
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bisy.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  public JSONObject a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      bisy.c("DownloadCallbackWebImpl", "onNetworkConnect " + paramDownloadInfo.getMessage(), paramDownloadInfo);
    }
    return localJSONObject;
  }
  ...
  {
    biri localbiri = biri.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbiri.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (biud)localbiri.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((biud)localObject).getJsCallbackMethod()))
            {
              ...
              bisy.a("DownloadCallbackWebImpl", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bisy.c("DownloadCallbackWebImpl", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
