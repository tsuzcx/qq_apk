  ...
  implements View.OnTouchListener
{
  ...
  private bgap(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = paramString2;
    Friends localFriends = ((amsw)paramQQAppInterface.getManager(51)).e(paramString1);
    int i;
    if (localFriends != null)
    {
      if (!bgan.a(localFriends.nameplateVipType)) {
        break label166;
      }
      paramQQAppInterface = bgao.a(localFriends.nameplateVipType);
      if (!bgan.b(localFriends.grayNameplateFlag)) {
        break label116;
      }
      i = 1;
      this.c = i;
      this.jdField_a_of_type_Int = paramQQAppInterface.jdField_a_of_type_Int;
      if ((paramQQAppInterface != bgao.f) && (paramQQAppInterface != bgao.g)) {
        break label122;
      }
    ...
    do
    {
      do
      {
        ...
        i = 0;
        break;
        if ((paramQQAppInterface == bgao.d) || (paramQQAppInterface == bgao.e))
        {
          this.jdField_b_of_type_Int = localFriends.superVipTemplateId;
          return;
        }
      } while ((paramQQAppInterface != bgao.b) && (paramQQAppInterface != bgao.c));
  ...
  public static bgap a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    return new bgap(paramQQAppInterface, paramString1, paramString2);
  }
  ...
  {
    if (!bgje.a.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "namePlate_UrlConfig")) {
    ...
    {
      paramMotionEvent = bgje.a.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c);
      ...
      bool = true;
      bgan.b((String)localObject1, i, bool);
