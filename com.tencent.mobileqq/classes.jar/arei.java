...
public class arei
{
  ...
  arel jdField_a_of_type_Arel = new arel(this);
  List<arem> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      arem localarem = (arem)localIterator.next();
      if (localarem != null) {
        localarem.a(paramString, paramBoolean, paramInt);
      }
    }
  ...
  public arel a()
  {
    return this.jdField_a_of_type_Arel;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Arel = new arel(this);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, arem paramarem)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Arel.b))
    {
      if (paramarem != null) {
        paramarem.a(paramString1, true, 0);
      }
      return;
    }
    arek localarek = new arek(this, paramarem, paramString1);
    ...
    paramString2 = bdiw.a(paramContext);
    ...
    for (;;)
    {
      ...
      paramContext = new NewIntent(paramContext, mxh.class);
      ...
      try
      {
        ...
        paramContext.setObserver(localarek);
      ...
      catch (Exception paramString2)
      {
        for (;;)
        {
          paramarem.a(paramString1, false, -10001);
        }
      }
    }
  }
  
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, arem paramarem, boolean paramBoolean, String paramString5)
  {
    QLog.i("XProxy", 2, "开始拉取A1，uin = " + paramString1 + " appid = " + paramString4);
    if ((this.jdField_a_of_type_Arel.a != null) && (!paramBoolean) && (System.currentTimeMillis() - this.jdField_a_of_type_Long < 43200000L))
    {
      if (paramarem != null) {
        paramarem.a(paramString2, true, 0);
      }
      return true;
    }
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramarem);
      return true;
    }
    ...
    for (;;)
    {
      this.jdField_a_of_type_OicqWlogin_sdkRequestWtloginHelper.SetListener(new arej(this, paramString2));
      this.jdField_a_of_type_JavaUtilList.add(paramarem);
      ...
      {
        paramString5 = bbdm.a(paramString5);
      }
    }
  }
}
