...
{
  public aady(CommentBottomBar paramCommentBottomBar) {}
  ...
  public void a(boolean paramBoolean, long paramLong, String paramString, CertifiedAccountWrite.StDoLikeRsp paramStDoLikeRsp)
  {
    ...
    for (;;)
    {
      ...
      if (paramStDoLikeRsp.like.status.get() == 1)
      {
        ...
        zwp.a().a(new PraisedUpdateEvents(CommentBottomBar.a(this.a).id.get(), paramStDoLikeRsp.like.status.get(), i));
      ...
      for (int i = 1;; i = 0)
      {
        ...
        QIPCClientHelper.getInstance().callServer(zwp.a, zwp.b, paramString, null);
        return;
        i = CommentBottomBar.a(this.a).likeInfo.count.get() - 1;
        break;
      }
