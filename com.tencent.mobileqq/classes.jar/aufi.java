...
public class aufi
  implements AdapterView.OnItemClickListener, auls
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aljq.aX + "TempMail" + File.separator;
    j = alpo.a(2131700495);
  }
  
  public aufi(QQAppInterface paramQQAppInterface, Context paramContext, Activity paramActivity, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  {
    URL localURL = baul.a(paramMessageForPic, 131075);
    if (bame.a(localURL.toString()) != null) {
      return bame.d(localURL.toString());
    }
    localURL = baul.a(paramMessageForPic, 1);
    if (bame.a(localURL.toString()) != null) {
      return bame.d(localURL.toString());
    }
    paramMessageForPic = baul.a(paramMessageForPic, 65537);
    if (bame.a(paramMessageForPic.toString()) != null) {
      return bame.d(paramMessageForPic.toString());
    }
    return null;
  }
  ...
  public static String a(MessageForPic paramMessageForPic, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramMessageForPic = "";
    if (str2.indexOf(".") == -1) {
      paramMessageForPic = bdcs.b(str1);
    }
    paramMessageForPic = alpo.a(2131700499) + paramList1.size() + "." + paramMessageForPic;
    paramList1 = paramMessageForPic + alpo.a(2131700494);
      ...
      if (paramMessageForStructing == null)
      {
        ...
        if (((StructMsgForGeneralShare)localObject2).mStructMsgItemLists != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject3 = (aztc)localObject3;
              localObject1 = paramMessageForStructing;
              if (((aztc)localObject3).a != null)
              {
                localObject3 = ((aztc)localObject3).a.iterator();
                for (;;)
                {
                  localObject1 = paramMessageForStructing;
                  ...
                  if ((localObject1 instanceof azvd)) {
                    paramMessageForStructing = ((azvd)localObject1).Y;
                  }
                }
              }
            }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramArrayList = Intent.createChooser((Intent)paramMap.remove(0), alpo.a(2131700493));
    ...
    this.jdField_a_of_type_AndroidContentContext.startActivity(Intent.createChooser(localIntent, alpo.a(2131700491)));
  }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, Intent paramIntent)
  {
    ...
    //   19: ifne +725 -> 744
    //   22: aload_0
    //   23: getfield 103	aufi:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   26: ldc_w 415
    ...
    //   37: iconst_0
    //   38: aload_0
    //   39: getfield 101	aufi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload 6
    //   44: getfield 421	com/tencent/mobileqq/data/ChatMessage:selfuin	Ljava/lang/String;
    //   47: invokestatic 426	bdbt:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   50: aastore
    //   51: dup
    //   52: iconst_1
    //   53: aload_0
    //   54: getfield 101	aufi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   57: aload 6
    //   59: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   62: invokestatic 426	bdbt:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   65: aastore
    ...
    //   80: pop
    //   81: getstatic 56	aufi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: invokestatic 438	bdcs:a	(Ljava/lang/String;Z)V
    //   88: new 47	java/io/File
    //   91: dup
    //   92: getstatic 56	aufi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   165: getstatic 56	aufi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   168: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: getstatic 64	aufi:j	Ljava/lang/String;
    ...
    //   180: invokestatic 448	bdcs:a	(Ljava/lang/String;)Ljava/io/File;
    //   183: pop
    ...
    //   199: getstatic 56	aufi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   202: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   205: getstatic 64	aufi:j	Ljava/lang/String;
    ...
    //   442: astore 7
    //   444: aload 5
    //   446: invokestatic 521	baiy:a	(Ljava/lang/String;)Z
    //   449: ifeq +1189 -> 1638
    //   452: aload 5
    //   454: invokestatic 522	baiy:d	(Ljava/lang/String;)Ljava/lang/String;
    //   457: astore 7
    //   459: goto +1179 -> 1638
    //   462: aload 6
    //   464: astore 7
    ...
    //   753: aload_0
    //   754: getfield 103	aufi:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   757: ldc_w 547
    ...
    //   768: iconst_0
    //   769: aload_0
    //   770: getfield 101	aufi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   773: aload 6
    //   775: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   778: invokestatic 549	bdbt:g	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   781: aastore
    ...
    //   801: aload_0
    //   802: getfield 103	aufi:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   805: ldc_w 547
    ...
    //   816: iconst_0
    //   817: aload_0
    //   818: getfield 101	aufi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   821: aload_0
    //   822: getfield 101	aufi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   833: invokestatic 558	bdbt:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   836: aastore
    ...
    //   868: aload 12
    //   870: aload 13
    //   872: invokestatic 563	aufi:a	(Lcom/tencent/mobileqq/data/MessageForPic;Ljava/util/List;Ljava/util/List;)Ljava/lang/String;
    //   875: astore 5
    //   877: goto -415 -> 462
    //   880: aload 16
    //   882: instanceof 565
    ...
    //   951: ldc_w 574
    //   954: invokestatic 62	alpo:a	(I)Ljava/lang/String;
    ...
    //   993: ldc_w 577
    //   996: invokestatic 62	alpo:a	(I)Ljava/lang/String;
    ...
    //   1111: ldc_w 595
    //   1114: invokestatic 62	alpo:a	(I)Ljava/lang/String;
    //   1117: astore 5
    //   1119: goto -657 -> 462
    //   1122: ldc_w 597
    //   1125: aload 7
    ...
    //   1136: ifeq +14 -> 1150
    //   1139: ldc_w 603
    //   1142: invokestatic 62	alpo:a	(I)Ljava/lang/String;
    //   1145: astore 5
    //   1147: goto -41 -> 1106
    //   1150: aload 7
    ...
    //   1163: aload_0
    //   1164: aload 7
    //   1166: invokevirtual 608	aufi:a	(Lcom/tencent/mobileqq/data/MessageForStructing;)Ljava/lang/String;
    //   1169: astore 5
    //   1171: goto -65 -> 1106
    //   1174: aload 7
    ...
    //   1277: aload_1
    //   1278: aload_0
    //   1279: getstatic 64	aufi:j	Ljava/lang/String;
    //   1282: invokevirtual 630	aufi:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1336: getstatic 56	aufi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1367: invokestatic 637	bdcs:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1370: ifeq -63 -> 1307
    //   1373: aload_1
    //   1374: aload_0
    //   1375: aload 13
    ...
    //   1394: invokevirtual 630	aufi:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1512: getstatic 56	aufi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1543: invokestatic 637	bdcs:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1546: ifeq -63 -> 1483
    //   1549: aload_1
    //   1550: aload_0
    //   1551: aload 11
    ...
    //   1570: invokevirtual 630	aufi:a	(Ljava/lang/String;)Landroid/net/Uri;
  ...
  public boolean a()
  {
    Iterator localIterator = aukx.a().a.entrySet().iterator();
    boolean bool2 = false;
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        ...
        bool2 |= alnp.a((MessageRecord)localObject);
        if (amgm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        do
        {
          ...
          localObject = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject);
        } while (localObject == null);
        bool1 = bool2;
        if (((bbpe)localObject).b == 8) {
          break;
        }
        bool1 = bool2;
        if (((bbpe)localObject).b == 9) {
          break;
        }
        bool1 = bool2;
        if (((bbpe)localObject).b == 6) {
          break;
        }
        bool1 = bool2;
        if (((bbpe)localObject).b == 7) {
          break;
        }
        if (((bbpe)localObject).b == 11)
        {
          bool1 = bool2;
          if (arof.a(((bbpe)localObject).jdField_a_of_type_JavaLangString)) {
            break;
          }
        }
      } while (((bbpe)localObject).b != 10);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  {
    if (((paramChatMessage instanceof MessageForPic)) && (alnp.a(paramChatMessage))) {
      return false;
    }
    ...
    else if (((paramChatMessage instanceof MessageForPic)) && (agwq.a((MessageForPic)paramChatMessage)))
    {
      return false;
    }
    return amgm.a(paramChatMessage);
  }
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696877);
      ...
      {
        localObject = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131692995);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject).icon = 2130839738;
      ...
      if (k != 0)
      {
        ...
        localActionSheetItem.label = paramContext.getString(2131696879);
        localActionSheetItem.icon = 2130839160;
      ...
      {
        localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
        localActionSheetItem.label = paramContext.getString(2131696894);
        localActionSheetItem.icon = 2130839298;
        localActionSheetItem.iconNeedBg = true;
      ...
      localActionSheetItem.label = paramContext.getString(2131696875);
      ...
      ((ArrayList)localObject).add(localActionSheetItem);
      localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
      localActionSheetItem.label = paramContext.getString(2131696870);
      localActionSheetItem.icon = 2130839706;
      localActionSheetItem.iconNeedBg = true;
  ...
  public void b()
  {
    Iterator localIterator = aukx.a().a().iterator();
    ...
    do
    {
      ...
      k = aflj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    } while ((!(localChatMessage instanceof MessageForPic)) || (k != 1) || (bdec.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localChatMessage, false)));
  ...
  public void b(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    if (k < paramArrayList.size())
    {
      ...
      for (;;)
      {
        ...
        {
          localObject1 = alpo.a(2131700492);
        }
        else if ((localChatMessage instanceof MessageForShortVideo))
        {
          localObject1 = alpo.a(2131700496);
        }
        else
        {
    ...
    for (;;)
    {
      ...
      localObject1 = alpo.a(2131700498);
      break;
      ...
      else
      {
        ...
        if (((MessageForStructing)localObject1).structingMsg.mMsgUrl != null)
        {
          ...
          if (((localChatMessage instanceof MessageForArkFlashChat)) && (localChatMessage.msg != null))
          {
            ...
            QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694623, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
            return;
          }
          localObject1 = null;
          break;
  ...
  public boolean b()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        localObject = (ChatMessage)((Map.Entry)localObject).getKey();
        bool2 |= alnp.a((MessageRecord)localObject);
        if (amgm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        ...
        localObject = (MessageForTroopFile)localObject;
      } while (bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject) == null);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  public boolean b(ChatMessage paramChatMessage)
  {
    ...
    if (((paramChatMessage instanceof MessageForPic)) && (agwq.a((MessageForPic)paramChatMessage))) {
      return false;
    }
    return amgm.a(paramChatMessage);
  }
  ...
  public boolean c()
  {
    ...
    Object localObject1 = aukx.a().a();
    if (((List)localObject1).size() == 0)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131698770, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ...
    if (localArrayList1.size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        bcjk.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2);
      }
    }
    ...
    if (localArrayList2.size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localFileManagerEntity = arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForFile);
      ...
      localObject2 = arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)localObject1);
      if (localObject2 == null)
      {
        armz.a(2131692746);
        return false;
      ...
      arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1, BaseActivity.sTopActivity);
    }
    while ((localArrayList1.size() == 0) && (localArrayList2.size() == 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2, BaseActivity.sTopActivity);
      }
    }
    return true;
  }
  ...
  public boolean e()
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694617, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((afau)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 3);
    return true;
  }
  ...
  public boolean g()
  {
    ...
    if (localList.isEmpty())
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694622, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((afau)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 4);
    return true;
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      default: 
        return;
      case 9: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", e, e, 0, 0, "", "", "", "");
        paramInt = -1;
        ...
        if (this.jdField_a_of_type_Bevy != null) {
          this.jdField_a_of_type_Bevy = new aufj(this);
        }
        WXShareHelper.a().a(this.jdField_a_of_type_Bevy);
        ((afau)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aelz, true);
        return;
      case 25: 
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", f, f, 0, 0, "", "", "", "");
        if (!d())
        {
          bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694615)).setPositiveButton(17039370, new aufn(this)).setNegativeButton(17039360, new aufm(this)).show();
          return;
        }
        break;
      }
    } while ((aukx.a().a().isEmpty()) || (!e()));
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
    return;
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", i, i, 0, 0, "", "", "", "");
    paramView = aukx.a().a();
    ...
    if (paramView.hasNext())
    {
      ...
      k = aflj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1);
      if (((localObject1 instanceof MessageForPic)) && (k == 1))
      {
        if (bdec.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localObject1, false)) {
          break label1246;
        }
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131719314), 0).a();
        return;
      }
      ...
      axur.a(this.jdField_a_of_type_AndroidAppActivity, paramView, (String)localObject1, (String)localObject2, k, paramAdapterView, 102);
      return;
      if (!b())
      {
        bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694626)).setPositiveButton(17039370, new aufp(this)).setNegativeButton(17039360, new aufo(this)).show();
        return;
      }
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80067F7", "0X80067F7", 0, 0, "", "", "", "");
      if (!c()) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", g, g, 0, 0, "", "", "", "");
      if (!a())
      {
        bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694624)).setPositiveButton(17039370, new aufr(this)).setNegativeButton(17039360, new aufq(this)).show();
        return;
      }
      if (!bkfg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), this.jdField_a_of_type_MqqOsMqqHandler)) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", h, h, 0, 0, "", "", "", "");
      if (!f())
      {
        bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694621)).setPositiveButton(17039370, new auft(this)).setNegativeButton(17039360, new aufs(this)).show();
        return;
      }
      if ((aukx.a().a().isEmpty()) || (!g())) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      paramAdapterView = new aulk(this.jdField_a_of_type_AndroidAppActivity);
      paramView = (ault)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(324);
      if ((paramView == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aelz == null)) {
        break;
      }
      localObject1 = new ArrayList();
      localObject2 = aukx.a().a.entrySet().iterator();
      while (((Iterator)localObject2).hasNext())
      {
      ...
      localObject1 = aulo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (List)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aelz.a, this);
      if ((localObject1 == null) || (((List)localObject1).isEmpty()))
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131719313), 0).a();
        return;
      }
      ...
      paramView.a(new aufk(this, paramAdapterView, paramView, (List)localObject1));
