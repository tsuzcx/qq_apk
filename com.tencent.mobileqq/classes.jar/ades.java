...
public class ades
  implements adci
{
  private static void a(adan paramadan, byte[] paramArrayOfByte)
  {
    ...
    for (long l1 = ((SubMsgType0x83.MsgBody)localObject).uint64_seq.get();; l1 = -1L)
    {
      ...
      for (long l2 = ((SubMsgType0x83.MsgBody)localObject).uint64_group_id.get();; l2 = -1L)
      {
        ...
        for (;;)
        {
          ...
          a(paramadan.a(), l1, l2, (SubMsgType0x83.MsgParams)localObject, j);
        }
      }
    }
  }
    ...
    do
    {
      ...
      do
      {
        ...
        try
        {
          ...
          paramQQAppInterface.a().a(paramInt, paramMsgParams.uint64_from_uin.get(), paramMsgParams.uint64_to_uin.get(), i, paramLong1, paramLong2);
          return;
        }
      ...
      try
      {
        ...
        paramQQAppInterface.a().a(paramMsgParams.uint32_type.get(), paramMsgParams.uint64_from_uin.get(), paramMsgParams.uint64_to_uin.get(), paramInt, i, paramLong1, paramLong2);
        return;
      }
      catch (Exception paramQQAppInterface)
      {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramMsgParams.getInt("sndRank") != 0)
        {
          ...
          paramQQAppInterface.a().a(paramLong2);
          return;
        }
      }
      catch (Exception paramQQAppInterface)
