...
public class amog
  implements ancq, Manager
{
  int jdField_a_of_type_Int = 0;
  amok jdField_a_of_type_Amok;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new amoh(this);
  ...
  Comparator<ApolloActionData> jdField_a_of_type_JavaUtilComparator = new amoi(this);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetListView != null)
    {
      ...
      this.jdField_a_of_type_Amok = null;
    }
  ...
  public void a(BaseChatPie paramBaseChatPie, ApolloActionData paramApolloActionData, int paramInt, String paramString)
  {
    ...
    if (amme.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      if (amme.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin()) == 1) {
    ...
    for (;;)
    {
      ...
      paramBaseChatPie = (RelativeLayout)paramBaseChatPie.getActivity().findViewById(2131364488);
      int i;
      if (this.jdField_a_of_type_ComTencentWidgetListView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetListView.setSelector(localBaseActivity.getResources().getDrawable(2130850736));
        this.jdField_a_of_type_ComTencentWidgetListView.setCacheColorHint(2131165498);
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(localBaseActivity.getResources().getColor(2131167033));
        ...
        this.jdField_a_of_type_Amok = new amok(this, localBaseActivity);
        this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Amok);
      ...
      try
      {
        for (;;)
        {
          ...
          if (paramBaseChatPie.getBoolean("first_show_resp", true))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131700016));
            this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130838487, 0);
          }
          else
          {
            ...
            paramBaseChatPie = String.format(anvx.a(2131700018), new Object[] { paramBaseChatPie });
        ...
        this.jdField_a_of_type_Amok.a(paramBaseChatPie, paramInt);
        return;
      }
  ...
  public void a(SpriteTaskParam paramSpriteTaskParam, long paramLong)
  {
    ...
    do
    {
      do
      {
        ...
        localApolloActionData = ((ankc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOOLO_DAO_MANAGER)).b(i);
