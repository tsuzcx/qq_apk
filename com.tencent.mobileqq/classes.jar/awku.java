  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        arrayOfByte = bakc.b(paramFromServiceMsg.getWupBuffer());
          ...
          try
          {
            if (paramFromServiceMsg.isSuccess())
            {
              ...
              if (i == 0)
              {
                ...
                ((akia)((QQAppInterface)paramIntent).a(118)).notifyUI(1, true, new Object[] { Integer.valueOf(i) });
                return;
              }
            }
          }
    ...
    for (;;)
    {
      ...
      continue;
      awhg.a().a(paramFromServiceMsg, arrayOfByte);
      return;
      awhg.a().b(paramFromServiceMsg, arrayOfByte);
      return;
      label461:
      if (paramIntent == null) {
        paramIntent = "no pkg";
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      ...
      case 1: 
        ...
        return;
      case 2: 
        awhg.a().a(paramPacket, str);
        return;
      }
      i = paramIntent.getIntExtra("key_dance_score", 0);
    } while (i <= 0);
    awhg.a().a(paramPacket, str, i);
  }
}
