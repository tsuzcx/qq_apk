  ...
  extends Handler
{
  ...
  public aswr(MusicPlayerActivity paramMusicPlayerActivity)
  {
  ...
  private void a(int[] paramArrayOfInt, boolean paramBoolean)
  {
    ...
    if ((paramArrayOfInt != null) && (paramArrayOfInt.length >= 2) && (localMusicPlayerActivity != null))
    {
      ...
      ((ImageView)localMusicPlayerActivity.findViewById(2131370572)).setImageDrawable(localGradientDrawable);
      localMusicPlayerActivity.findViewById(2131370575).setBackgroundColor(i);
      i = paramArrayOfInt[1];
      ...
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841334, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841335, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130839569, i);
      if (paramBoolean)
      {
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130840930, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130840932, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130840931, i);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  if ((paramMessage instanceof Integer))
                  {
                    ...
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130841334, j);
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130841335, j);
                  }
                  if ((i == 3) || (i == 4)) {
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130841335);
                  }
                  for (;;)
                  {
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
                    return;
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130841334);
                  }
                } while (!(paramMessage.obj instanceof aswt));
                localObject2 = (aswt)paramMessage.obj;
                ...
                if (MusicPlayerActivity.a((MusicPlayerActivity)localObject1).isSelected()) {
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130840931);
                }
                for (;;)
                {
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setVisibility(i);
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setImageResource(2130840930);
                  ...
                  return;
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130840932);
                }
              ...
              for (;;)
              {
                ...
                paramMessage = (URLImageView)((MusicPlayerActivity)localObject1).findViewById(2131370581);
                localURLDrawable = URLDrawable.getDrawable((String)localObject3, URLDrawable.URLDrawableOptions.obtain());
                localObject4 = asvz.a((String)localObject3);
              ...
              for (;;)
              {
                ...
                MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(2131694482);
                return;
                localObject3 = new asvz((String)localObject3, MusicPlayerActivity.a((MusicPlayerActivity)localObject1), Boolean.valueOf(bool1));
                if (localURLDrawable.getStatus() == 1)
                {
                  localObject4 = localURLDrawable.getCurrDrawable();
                  if ((localObject4 instanceof RegionDrawable)) {
                    ((asvz)localObject3).run(null, ((RegionDrawable)localObject4).getBitmap());
                  }
                }
                else
                {
              ...
              MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(((MusicPlayerActivity)localObject1).getString(2131694480, new Object[] { paramMessage }));
              return;
              MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
              return;
            } while (!(paramMessage.obj instanceof View));
            localObject2 = (View)paramMessage.obj;
            paramMessage = bfxh.a((Context)localObject1).b(3).a(((MusicPlayerActivity)localObject1).getString(paramMessage.arg1)).a(paramMessage.arg2);
            paramMessage.c(49);
            paramMessage = new bfxj(paramMessage).b(Color.argb(13, 255, 255, 255)).a(5).a();
      ...
      } while (!(localObject1 instanceof aswt));
    ...
    WXShareHelper.a().a(String.valueOf(l), ((aswt)localObject1).a, (Bitmap)localObject2, ((aswt)localObject1).b, ((aswt)localObject1).d, i, ((aswt)localObject1).e);
  }
}
