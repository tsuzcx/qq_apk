...
public class bkmd
{
  ...
  public static void a(Context paramContext, bkmg parambkmg)
  {
    ...
    {
      if (parambkmg != null) {
        parambkmg.a(localFile1.getAbsolutePath(), localFile2.getAbsolutePath());
      }
      return;
    }
    String str2 = bkmi.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    bkks.a().a(b, str1, "SoHelper", new bkme(str2, str1, parambkmg, paramContext, localFile1, localFile2));
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    paramContext = bkmc.a(paramContext, "0", "key_local_so_version");
