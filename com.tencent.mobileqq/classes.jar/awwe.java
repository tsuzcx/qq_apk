  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  private final List<awwf> jdField_a_of_type_JavaUtilList = new LinkedList();
  private boolean jdField_a_of_type_Boolean;
  private int b = 200;
  
  public awwe(View paramView)
  {
    this(paramView, false);
  }
  
  public awwe(View paramView, boolean paramBoolean)
  {
  ...
  private void a()
  {
    ...
    {
      awwf localawwf = (awwf)localIterator.next();
      if (localawwf != null) {
        localawwf.onSoftKeyboardClosed();
      }
    }
  }
  ...
  private void a(int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      awwf localawwf = (awwf)localIterator.next();
      if (localawwf != null) {
        localawwf.onSoftKeyboardOpened(paramInt);
      }
    }
  }
  
  public void a(awwf paramawwf)
  {
    this.jdField_a_of_type_JavaUtilList.add(paramawwf);
  }
  
  public void b(awwf paramawwf)
  {
    this.jdField_a_of_type_JavaUtilList.remove(paramawwf);
  }
