...
public class qjr
  implements qia
{
  private static final String jdField_a_of_type_JavaLangString = qjr.class.getSimpleName();
  ...
  {
    if (paramInt1 == 2) {
      ocm.a().a(paramString1, "PubAccountArticleCenter.GetUrlByVid", new qjs(this, paramString1, paramInt2, paramLong));
    }
    do
    {
      do
      ...
      } while (this.jdField_a_of_type_Qju == null);
      paramString2 = (String)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    } while (TextUtils.isEmpty(paramString2));
    this.jdField_a_of_type_Qju.a(paramString1, 1, paramString2);
  }
  ...
  private void a(String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    if (paramString1 != null) {
      ...
      {
        localObject = nbe.a(paramString1);
      }
    }
    ...
    ((TVK_PlayerVideoInfo)localObject).setConfigMap("cache_servers_type", qhv.jdField_a_of_type_JavaLangString);
    if (paramLong > 0L) {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new qjt(this));
  }
