  ...
  extends bjxz
{
  ...
  private static final String b = alud.a(2131712719);
  bjsb jdField_a_of_type_Bjsb = new bjxf(this);
  ...
  private String a(byte[] paramArrayOfByte)
  {
    ...
    //   10: getstatic 76	bjsa:b	Ljava/lang/String;
    ...
    //   37: dup
    //   38: getstatic 76	bjsa:b	Ljava/lang/String;
  ...
  private void a(begz parambegz, String... paramVarArgs)
  {
    QLog.i("QZoneSharePictureJsPlugin", 1, "saxon handleGenerateGif start");
    if ((parambegz == null) || (paramVarArgs == null) || (paramVarArgs.length < 1))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = PhotoUtils.a(bdzf.a(alof.bd), "IMG", ".gif");
        ...
        if (!bool1)
        {
          ...
          parambegz = a(new File((String)localObject1));
      ...
      {
        QLog.e("QZoneSharePictureJsPlugin", 1, "handleGenerateGif fail, compressGIFTask exception.", parambegz);
        return;
      }
      boolean bool1 = false;
    }
    ...
    if (!bool3)
    {
      ...
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambegz, parambegz.length());
      return;
    }
    if (parambegz.length() <= k)
    {
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 不分片callback len=" + parambegz.length());
      a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, 1, 0, parambegz, parambegz.length());
      return;
    }
    int m = parambegz.length() / k;
    if (parambegz.length() % k == 0) {
      j = 0;
    }
    for (;;)
    {
      m += j;
      QLog.i("QZoneSharePictureJsPlugin", 1, "saxon 分片callback pcount＝" + m + ",filelen=" + parambegz.length());
      j = 0;
      label578:
      if (j < m - 1)
      {
        a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, j, parambegz.substring(j * k, (j + 1) * k), parambegz.length());
    ...
    a(this.jdField_a_of_type_JavaLangString, i, paramVarArgs, m, m - 1, parambegz.substring((m - 1) * k), parambegz.length());
    ...
    paramVarArgs = bjea.a();
    bjdt.a(parambegz.a(), paramVarArgs, (String)localObject1, alud.a(2131712732), localInterruptedException, -1);
  }
    ...
    for (;;)
    {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        try
        {
          ...
          paramString2.put("msg", alud.a(2131712721));
  ...
  private void a(JSONObject paramJSONObject, String paramString, begz parambegz)
  {
    ThreadManager.getSubThreadHandler().post(new QZoneSharePictureJsPlugin.7(this, paramJSONObject, paramString, parambegz));
  }
  
  private void a(String... paramVarArgs)
  {
    bjts.a().a(new bjxg(this, paramVarArgs));
  }
  ...
  {
    Bitmap localBitmap1 = bfll.a(paramString, 120, 120, false);
  ...
  private void b(begz parambegz, String... paramVarArgs)
  {
    int i = 0;
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null) && (parambegz != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      String str;
      try
      {
        ...
        {
          QLog.w("QZoneSharePictureJsPlugin", 1, "Base64.decode Exception: " + parambegz.toString());
          a(alud.a(2131712708));
          return;
        }
      ...
      {
        QLog.w("QZoneSharePictureJsPlugin", 1, "handleSharePicture catch an exception in disPatchMethod", parambegz);
        return;
      }
      QLog.d("QZoneSharePictureJsPlugin", 1, "the filePath is " + (String)localObject);
      label206:
      if ((!TextUtils.isEmpty(str)) && (parambegz != null) && (parambegz.a() != null)) {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        for (;;)
        {
          ...
          i = bjdt.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, parambegz, 21);
          aryv.a(parambegz.a(), localIntent, i);
          continue;
          a(paramVarArgs, (String)localObject, parambegz);
          continue;
          if (bjsa.a().a())
          {
            bjsa.a().a(this.jdField_a_of_type_Bjsb);
            paramVarArgs = a((String)localObject);
            bjsa.a().a(BaseApplicationImpl.getContext(), (String)localObject, paramVarArgs, 0);
          }
          else if (parambegz.a() != null)
          {
            parambegz.a().post(new QZoneSharePictureJsPlugin.5(this, parambegz));
            continue;
            if (bjsa.a().a())
            {
              bjsa.a().a(this.jdField_a_of_type_Bjsb);
              bjsa.a().a(BaseApplicationImpl.getContext(), (String)localObject, null, 1);
            }
            else if (parambegz.a() != null)
            {
              parambegz.a().post(new QZoneSharePictureJsPlugin.6(this, parambegz));
            }
          }
        }
      }
      ...
      default: 
        ...
        if ((parambegz != null) && ((parambegz instanceof belp)))
        {
          parambegz = ((belp)parambegz).a().a();
          if ((parambegz != null) && (parambegz.isShowing())) {
            parambegz.dismiss();
          }
        }
  ...
  private void b(String paramString)
  {
    ...
    localObject2 = localObject1;
    label113:
    paramString = bjhx.b().a();
    if (TextUtils.isEmpty(paramString))
    {
      a(localObject2, -1, alud.a(2131712717));
      return;
    }
    try
    {
      localObject1 = new File(paramString);
      if ((!arso.a(paramString)) && (!((File)localObject1).mkdirs()))
      {
    ...
    catch (Exception paramString)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = bjhx.b().a(paramString);
        try
        {
        ...
        long l = bdeu.a((File)localObject1);
      ...
      a(localObject2, -1, alud.a(2131712738));
      return;
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    a(paramString, -1, alud.a(2131712724));
  }
  ...
  {
    super.a();
    if (this.jdField_a_of_type_Bjsb != null) {
      bjsa.a().b(this.jdField_a_of_type_Bjsb);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    for (paramIntent = alud.a(2131712746);; paramIntent = alud.a(2131712712))
    {
