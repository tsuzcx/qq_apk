...
public class bjxe
  extends bjwu
  implements bjxg, bjza, blcv, blcw
{
  public float a;
  public long a;
  protected Handler a;
  ...
  public bjxe(@NonNull bjww parambjww)
  {
    super(parambjww);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    veg.c("Q.qqstory.record.EditVideoPlayer", "updateVideoDrawablePlayerUI width" + paramInt1 + "heightRatio=" + f + "dst_height" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.d + "dst_width=" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.jdField_c_of_type_Int);
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.a(paramInt1, paramInt2, f, false, blbz.a(5.0F));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    veg.d("Q.qqstory.record.EditVideoPlayer", "pausePreview but the player has not started : " + this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_Int);
  }
  ...
  private void o()
  {
    ...
    veg.d("Q.qqstory.record.EditVideoPlayer", "restartPreview but the player is not stopping : " + this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_Int);
  }
  ...
  public long a(int paramInt)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        localObject = (bjyz)((List)localObject).get(paramInt);
        return ((bjyz)localObject).d - ((bjyz)localObject).jdField_c_of_type_Long;
      }
    }
    return -1L;
  }
  ...
  public Bitmap a(int paramInt)
  {
    ...
    if (Looper.myLooper() == this.jdField_a_of_type_AndroidOsHandler.getLooper())
    {
      ...
      if ((localObject != null) && (paramInt < ((List)localObject).size())) {}
      for (localObject = (bjyz)((List)localObject).get(paramInt); localObject == null; localObject = null) {
        return null;
      }
      return a((bjyz)localObject);
    }
  ...
  public Bitmap a(@NonNull bjyz parambjyz)
  {
    Bitmap localBitmap = null;
    Object localObject = (bjse)a(bjse.class);
    int j;
    int i;
    if (localObject != null)
    {
      j = ((bjse)localObject).a(parambjyz.jdField_c_of_type_Int);
      i = ((bjse)localObject).a(this.jdField_a_of_type_Bjww.a());
      veg.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap for %d, playModeNeeded = %d, currentPlayMode = %d", Integer.valueOf(parambjyz.jdField_c_of_type_Int), Integer.valueOf(j), Integer.valueOf(i));
    }
    for (;;)
    {
      localObject = (bjsd)a(bjsd.class);
      int k;
      byte[] arrayOfByte;
      if (localObject != null)
      {
        k = ((bjsd)localObject).a();
        arrayOfByte = ((bjsd)localObject).a(parambjyz.jdField_c_of_type_Int);
      }
      for (localObject = ((bjsd)localObject).a(this.jdField_a_of_type_Bjww.a());; localObject = null)
      {
        ...
        try
        {
          ...
          veg.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap, playMode=%d, info=%s", Integer.valueOf(j), parambjyz);
          if (j == 1)
          {
            localBitmap = ((MultiBlockVideoPlayer)this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(parambjyz.b - 1L, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.a(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.b());
            return localBitmap;
          }
          parambjyz = ((MultiBlockVideoPlayer)this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(parambjyz.jdField_a_of_type_Long, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.a(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.b());
          return parambjyz;
        }
        finally
        {
  ...
  public List<? extends bjzj> a()
  {
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer instanceof MultiBlockVideoPlayer))
    {
      ...
      if (localList != null)
      {
        ...
        if (i > 1) {}
        for (bjyz localbjyz = (bjyz)localList.get(i - 1); (localbjyz != null) && (localbjyz.b - localbjyz.jdField_a_of_type_Long < 3L); localbjyz = null) {
  ...
  public void a()
  {
    ...
    boolean bool1 = bjww.a(this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Long, 262144);
    ...
    if ((bool1) && (bool2))
    {
      ...
      if (!(this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditRecordVideoSource)) {
        break label459;
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource = ((EditRecordVideoSource)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource);
      ...
      localObject = null;
      str1 = null;
      Bundle localBundle = this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_AndroidOsBundle;
      if (localBundle == null) {
        break label569;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label272;
        label492:
        vem.jdField_a_of_type_Long = this.jdField_a_of_type_Bjye.getActivity().getIntent().getLongExtra("stop_record_time", 0L);
  ...
  public void a(int paramInt)
  {
    ...
    long l2;
    long l1;
    if ((paramInt == 1) && (this.jdField_a_of_type_Long == 0L) && (!this.jdField_a_of_type_Bjww.a()))
    {
    ...
    for (;;)
    {
      ...
      if (l3 != 0L) {
        vel.b("video_edit", "startEditVideoTime", this.jdField_a_of_type_Bjww.b(), 0, new String[] { String.valueOf(l4 - l3) });
      }
      return;
      label229:
      l1 = 0L;
  ...
  public void a(int paramInt, @NonNull bkkm parambkkm)
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      parambkkm.a.hasFragments = false;
    }
    for (;;)
    {
      return;
      ...
      {
        localObject1 = (bjyz)((Iterator)localObject2).next();
        if (localObject1 == null)
        {
          veg.e("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish error. RecordVideoBlockInfo is null.");
        }
        else if (((bjyz)localObject1).jdField_c_of_type_Int == paramInt)
        {
      ...
      try
      {
        ((JSONObject)localObject2).put("vfFrameIndexStart", ((bjyz)localObject1).jdField_a_of_type_Long);
        ((JSONObject)localObject2).put("vfFrameIndexEnd", ((bjyz)localObject1).b);
        ((JSONObject)localObject2).put("afTimeStart", ((bjyz)localObject1).jdField_c_of_type_Long);
        ((JSONObject)localObject2).put("afTimeEnd", ((bjyz)localObject1).d);
        parambkkm.a.fragments = ((JSONObject)localObject2).toString();
        veg.b("Q.qqstory.record.EditVideoPlayer", "fragments = %s.", parambkkm.a.fragments);
        veg.b("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish : %s", parambkkm.a.fragments);
        if (parambkkm.a.hasFragments) {
          continue;
        }
  ...
  public void a(bjyz parambjyz)
  {
    veg.a("Q.qqstory.record.EditVideoPlayer", "updateVideoFrameBitmap info=%s", parambjyz);
    Object localObject = a(parambjyz);
    if (localObject != null)
    {
      ...
      if (localBitmap != null)
      {
        ...
        bjyz localbjyz = (bjyz)((List)localObject).get(parambjyz.jdField_c_of_type_Int);
        ((List)localObject).set(parambjyz.jdField_c_of_type_Int, localbjyz.a(localBitmap));
  ...
  public void f()
  {
    ...
    switch (this.jdField_a_of_type_Bjww.jdField_a_of_type_Int)
    {
    case 0: 
    case 2: 
    case 5: 
  ...
  public void i()
  {
    ...
    if (localBitmap1 != null)
    {
      ...
      if (this.jdField_b_of_type_Boolean) {
        Stream.of(localBitmap1).map(new ThreadOffFunction("Q.qqstory.record.EditVideoPlayer", 2)).map(new bjzl(0.2F, false)).map(new bjzm(10)).map(new UIThreadOffFunction(this)).subscribe(new bjxf(this));
      }
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
  }
