...
class lak
  extends kzp
{
  lak(lai paramlai, List paramList, lau paramlau, Long paramLong) {}
  ...
  public void a(int paramInt, Header[] paramArrayOfHeader, String paramString)
  {
    ...
    try
    {
      localObject = this.jdField_a_of_type_Lai.a.parse(new InputSource(new StringReader(paramString)));
    ...
    catch (IOException localIOException)
    {
      ...
      this.jdField_a_of_type_Lau.a(localIOException, paramString, this.jdField_a_of_type_JavaLangLong);
    }
