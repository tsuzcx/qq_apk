...
public class lak
{
  private static lag jdField_a_of_type_Lag;
  private static lah jdField_a_of_type_Lah;
  
  /* Error */
  public static lag a(Context paramContext)
  {
    // Byte code:
    //   0: getstatic 17	lak:jdField_a_of_type_Lag	Llag;
    //   3: ifnonnull +81 -> 84
    //   6: aload_0
    //   7: ldc 19
    ...
    //   56: ldc 2
    //   58: monitorenter
    //   59: getstatic 17	lak:jdField_a_of_type_Lag	Llag;
    //   62: astore_2
    //   63: aload_2
    //   64: ifnonnull +17 -> 81
    //   67: new 62	lag
    ...
    //   73: iload_1
    //   74: i2l
    //   75: invokespecial 65	lag:<init>	(Landroid/content/Context;IJ)V
    //   78: putstatic 17	lak:jdField_a_of_type_Lag	Llag;
    //   81: ldc 2
    //   83: monitorexit
    //   84: getstatic 17	lak:jdField_a_of_type_Lag	Llag;
    //   87: areturn
    //   88: astore_0
  ...
  public static lah a(Context paramContext)
  {
    try
    {
      if (jdField_a_of_type_Lah == null) {
        jdField_a_of_type_Lah = new lah(65536);
      }
  ...
  public static lag b(Context paramContext)
  {
    if (jdField_a_of_type_Lag == null) {
      ThreadManager.post(new TranslateCache.1(paramContext), 5, null, true);
    }
    return jdField_a_of_type_Lag;
  }
}
