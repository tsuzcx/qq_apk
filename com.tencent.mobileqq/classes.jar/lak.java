...
public class lak
{
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            localObject2 = localObject1;
            if (ksn.a().b((String)localObject3) == null)
            {
              localObject2 = localObject1;
    ...
    for (;;)
    {
      ...
      if (c.equals(paramString))
      {
        ...
        if ((j == 1) || (j == 3000))
        {
          ...
          label155:
          paramIntent = ksn.a(i, paramString, new int[0]);
      ...
      do
      {
        for (;;)
        {
          ...
          paramString = ksn.a(i, String.valueOf(l), new int[0]);
      ...
      for (;;)
      {
        paramString = ksn.a(i, (String)localObject2, new int[0]);
        localObject1 = paramString;
        if (localStringBuilder == null) {
          break;
        }
  ...
  public boolean a(BaseActivity paramBaseActivity)
  {
    ...
    kvq localkvq = ksn.a().a();
    if (localkvq != null) {}
    for (Object localObject1 = localkvq.c;; localObject1 = null)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      for (Intent localIntent = b(localkvq.c);; localIntent = null)
      {
        label74:
        boolean bool1;
        if (localIntent != null)
