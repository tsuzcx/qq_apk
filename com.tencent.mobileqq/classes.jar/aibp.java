  ...
  extends aibl
{
  ...
  protected List<aicu> a;
  public Set<Long> a;
  
  public aibp(Context paramContext, bhoe parambhoe, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  {
    Object localObject = ((aicu)getItem(paramInt)).a;
    try
    {
      localObject = bbig.a(((MessageRecord)localObject).msgData);
      if (localObject != null)
      {
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      MessageForText localMessageForText = ayvw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localC2CLinkElement.uin, "", 0, (byte)1, (byte)0, (short)0, localC2CLinkElement.description());
      localMessageForText.msgData = bbig.a(localC2CLinkElement);
  ...
  public void a(List<Object> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      localObject = C2CLinkElement.parseFrom(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localObject, this.jdField_a_of_type_Aloz, this.jdField_a_of_type_JavaTextSimpleDateFormat, i);
      if (localObject != null) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559253, null);
    ...
    for (Object localObject = localaicu.a;; localObject = null)
    {
      try
      {
        localObject = bbig.a(((MessageRecord)localObject).msgData);
        ...
        if (localObject != null)
        {
          CharSequence localCharSequence = localaicu.a(((C2CLinkElement)localObject).title, -11353092);
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView.setText(localCharSequence);
          paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(localaicu.a(((C2CLinkElement)localObject).timeSecond, -11353092));
          ahzk.a(paramViewGroup.jdField_a_of_type_AndroidWidgetImageView, ((C2CLinkElement)localObject).iconUrl);
        }
        return paramView;
      }
