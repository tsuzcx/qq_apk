...
public class bpla
{
  private static final int jdField_a_of_type_Int = bhtq.a(2.0F);
  private static final int jdField_b_of_type_Int = bhtq.a(4.0F);
  private float jdField_a_of_type_Float;
  private Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private Paint jdField_a_of_type_AndroidGraphicsPaint = new Paint();
  private GestureDetector.OnGestureListener jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener = new bplb(this);
  private GestureDetector jdField_a_of_type_AndroidViewGestureDetector;
  private bplc jdField_a_of_type_Bplc;
  private bpld jdField_a_of_type_Bpld;
  ...
  public bpla(bpld parambpld, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, int paramInt5)
  {
    this.jdField_a_of_type_Bpld = parambpld;
    ...
    if (this.jdField_c_of_type_Int < this.jdField_d_of_type_Int)
    {
      ...
      this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_Bpld.a(), this.jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener);
    ...
    {
      if (this.m > 10000) {
        bpam.c("AEEditorMusicWaveScrollProcessor", "AEEditorMusicWaveScrollProcessor() called with: parent = [" + parambpld + "], audioPath = [" + paramString2 + "], audioDuration = [" + paramInt1 + "], perScreenDuration = [" + paramInt2 + "], padding = [" + paramInt3 + "], isFromLibrary = [" + paramBoolean + "], width = [" + paramInt4 + "], height = [" + paramInt5 + "] lineCount=" + this.m);
      }
      bpkz.a(paramString1, paramString2, this.m);
      return;
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidGraphicsBitmap == null) {
      this.jdField_a_of_type_AndroidGraphicsBitmap = BitmapUtils.decodeSampledBitmapFromResource(BaseApplicationImpl.getApplication().getResources(), 2130837752, 16, 118);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Bpld != null) {
      this.jdField_a_of_type_Bpld.a();
    }
  }
  ...
  {
    paramCanvas.save();
    int i1 = BaseApplicationImpl.getContext().getResources().getColor(2131165248);
    Object localObject = BaseApplicationImpl.getContext().getResources().getColorStateList(2131165248);
    if (localObject != null) {
      i1 = ((ColorStateList)localObject).getDefaultColor();
    }
    int i2 = BaseApplicationImpl.getContext().getResources().getColor(2131165250);
    localObject = BaseApplicationImpl.getContext().getResources().getColorStateList(2131165250);
    if (localObject != null) {
      i2 = ((ColorStateList)localObject).getDefaultColor();
    }
    int i3 = BaseApplicationImpl.getContext().getResources().getColor(2131165249);
    localObject = BaseApplicationImpl.getContext().getResources().getColorStateList(2131165249);
    if (localObject != null) {
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_AndroidGraphicsPaint != null) && (paramCanvas != null))
      {
        ...
        this.jdField_b_of_type_AndroidGraphicsPaint.setColor(BaseApplicationImpl.getContext().getResources().getColor(2131165246));
      ...
      if (i4 < i6)
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          i7 = (int)(bpkz.a(i4 - i5) * (this.e - this.g * 4));
      ...
      if ((!this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_AndroidGraphicsPaint != null) && (paramCanvas != null))
      {
        ...
        this.jdField_b_of_type_AndroidGraphicsPaint.setColor(BaseApplicationImpl.getContext().getResources().getColor(2131165247));
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 1) {
      if (this.jdField_a_of_type_Bplc != null) {
        this.jdField_a_of_type_Bplc.b();
      }
    }
