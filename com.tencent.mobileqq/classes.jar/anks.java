  ...
  extends LinearLayout
{
  ...
  public anks(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    if (i < this.b)
    {
      ...
      for (;;)
      {
        ...
        ((ImageView)localView.findViewById(2131364363)).setPadding(k, k, k, k);
        addView(localView);
        i += 1;
        break;
        if (this.b - 1 == i) {
  ...
  public void a(LocationFacePackage paramLocationFacePackage, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131364361);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131364363);
      localObject3 = (TextView)((View)localObject1).findViewById(2131364362);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131364364);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localObject2 = new ankt((String)localObject1, localURLImageView, localProgressBar);
        ...
        if (((URLDrawable)localObject1).getStatus() == 1) {
          ((ankt)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
        }
