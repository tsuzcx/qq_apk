  ...
  implements pax
{
  ...
  public pbi(Context paramContext, ArticleInfo paramArticleInfo1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean, int paramInt5, ArticleInfo paramArticleInfo2, rap paramrap)
  {
  ...
  public int b()
  {
    ...
    return this.jdField_a_of_type_Rap.getItemViewType(this.jdField_b_of_type_Int + 1);
  }
  ...
  public int c()
  {
    return pyp.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
  }
  ...
  public boolean g()
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_a_of_type_Int == 41403) || (oox.a(this.jdField_a_of_type_Int)) || (bhvh.a(this.jdField_a_of_type_Int)));
      localBaseArticleInfo = this.jdField_a_of_type_Rap.a(this.jdField_a_of_type_Int);
    ...
    if (onk.j(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo))
    {
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null) {}
    while ((!bhvh.a(this.d)) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mGroupId == -1L) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mGroupCount <= 0L) || ((c() != 1) && (c() != 2))) && (!pyp.b(a()))) {
      return false;
    }
    return true;
  }
