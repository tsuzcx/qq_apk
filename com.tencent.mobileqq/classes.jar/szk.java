  ...
  extends slz
{
  ...
  public String a()
  {
    if (QQStoryContext.a().a(this.jdField_b_of_type_JavaLangString)) {
      return skt.a("StorySvc.get_date_collection_list");
    }
    return skt.a("StorySvc.get_others_video_list");
  }
  ...
  public slu a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new tbi(this.jdField_b_of_type_JavaLangString, localRspDateVideoCollectionList);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      urk.b("Q.qqstory.memories:GetDateCollectionListRequest", a(), paramArrayOfByte);
    }
    return null;
  }
