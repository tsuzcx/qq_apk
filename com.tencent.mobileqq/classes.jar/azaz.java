...
public final class azaz
{
  ...
  public azaz(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public azaz(int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.c = paramInt2;
  }
  
  public azaz(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    this.c = paramInt4;
