...
public class ova
  extends Handler
{
  public ova(ReadInJoyUploadAvatarFragment paramReadInJoyUploadAvatarFragment, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
    default: 
      localBundle.putString("msg", anvx.a(2131712485));
    ...
    for (;;)
    {
      ...
      localBundle.putString("msg", anvx.a(2131712544));
      localIntent.putExtra("Bundle", localBundle);
      localFragmentActivity.setResult(-1, localIntent);
    }
  }
