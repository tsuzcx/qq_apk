...
public class ozb
{
  ...
  private ozu jdField_a_of_type_Ozu = new ozu();
  
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.atlas.." + ozb.class.getSimpleName();
    b = ajya.a(2131712909);
    c = ajya.a(2131712820);
    d = ajya.a(2131712980);
  ...
  {
    new bgpu(6).a("nLinkType", 0).b("sTitle", paramString2).b("sUrl", paramString6).a("bAppShare", false).a("lAppId", 0L).b("sPublisher", paramString4).b("sBrief", paramString3).b("sPath", paramString5).b("sResUrl", paramString6).a("lCategory", 8L).b("sBizDataList", paramArrayList).b(paramActivity, paramString1, -1, null);
  }
  
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    boolean bool = false;
    if (onh.a(BaseApplicationImpl.getApplication().getRuntime(), "Key_First_ReadInJoy_Favorite", true) == null)
    {
      onh.a("Key_First_ReadInJoy_Favorite", Integer.valueOf(1), true);
      if (!paramBoolean) {
        bbdj.a(paramContext, 230, paramContext.getString(2131692366), "你可在看点内点击“我的”找到“我的收藏”。\n收藏的内容将会上传保存，在其他手机上登录QQ，也可以在看点内找到你收藏的内容。\n", 2131690596, 2131692364, new ozd(), null).setMessageCount(null).show();
      }
      bool = true;
    }
    return bool;
  ...
  public void a(Activity paramActivity, String paramString1, int paramInt, String paramString2, ArrayList<String> paramArrayList)
  {
    ...
    new bgpu(6).a("sCIDListToBeDelete", paramArrayList).b("sBizDataList", paramString2).a(paramActivity, paramString1, -1, null);
  }
  
  public void a(List<String> paramList, oze paramoze)
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "getAtlasFavoriteStatus, rowKeyList = " + paramList + ", callback = " + paramoze);
    }
    ...
    mxf.a((AppInterface)BaseApplicationImpl.getApplication().getRuntime(), new ozc(this, paramoze), localReqBody.toByteArray(), "OidbSvc.0xb40", 2880, 1, paramList, 0L);
  }
}
