...
public class ozb
{
  ...
  public static int a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      paramInt2 = i;
    } while (!pay.a(paramInt1));
    return 3;
  }
  
  public static String a()
  {
    return (int)Math.ceil(Float.valueOf((float)DeviceInfoUtil.getSystemTotalMemory()).floatValue() / 1024.0F / 1024.0F / 1024.0F) + "";
  }
  
  public static String a(Context paramContext)
  {
    paramContext = DeviceInfoUtil.getNetInfo(paramContext).networkType;
  ...
  public static JSONObject a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      localJSONObject.put("rowkey", uhv.a(paramArticleInfo));
  ...
  public static void a(int paramInt1, long paramLong1, int paramInt2, int paramInt3, long paramLong2, int paramInt4, String paramString1, String paramString2)
  {
    ...
    if (!TextUtils.isEmpty("8.4.8")) {
      localGalleryExpReported.client_ver.set(ByteStringMicro.copyFromUtf8("8.4.8"));
    }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = a(paramContext, pay.a() + "", i, paramArticleInfo.mArticleID, 0, paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(pay.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, paramJSONObject);
        odq.a(null, "" + paramArticleInfo.publishUin, paramString, paramString, 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
        return;
      }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, slt paramslt)
  {
    if ((pay.d(paramArticleInfo)) || (pay.e(paramArticleInfo)) || (pay.b(paramArticleInfo)))
    {
      paramContext = a(paramContext, pay.a() + "", ComponentContentGalleryBiu.a(paramArticleInfo, paramslt), paramArticleInfo.mArticleID, paramslt.a().indexOf(paramArticleInfo), paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(pay.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, null);
      odq.a(null, "" + paramArticleInfo.publishUin, "0X8008E2F", "0X8008E2F", 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
    }
  }
  ...
  public static void a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      odq.a(null, "", paramString, paramString, 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (JSONException paramContext)
    {
  ...
  public static void a(ozd paramozd)
  {
    odq.a(null, paramozd.a, paramozd.b, paramozd.c, 0, 0, "", paramozd.e, paramozd.f, paramozd.g, false);
  }
  ...
  public static String b()
  {
    ...
    if (!a)
    {
      ...
      a = true;
      SosoInterface.startLocation(new ozc(3, true, true, 300000L, false, false, "GalleryReportedUtils"));
    }
    return "";
  }
}
