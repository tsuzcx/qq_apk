...
public class ancb
{
  ...
  public static String aC = anni.a(2131699126);
  public static String aD = anni.a(2131699125);
  ...
  public static String aH = anni.a(2131699124);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bhgg.a(anhk.ba + "/.apollo");
    ...
    localStringBuilder.append("?client=androidQQ").append("&version=").append("8.4.1.4680").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE);
    ...
    af = "https://sqimg.qq.com/qq_product_operations/tmg_sdk/QAVOPENSDK_1.9.6.16.zip";
