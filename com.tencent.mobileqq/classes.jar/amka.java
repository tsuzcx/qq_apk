...
public class amka
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForPoke paramMessageForPoke)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((alto)paramQQAppInterface.getManager(51)).b(paramString);
        if (localObject != null) {
          break;
        }
      ...
      Object localObject = String.format(Locale.getDefault(), alud.a(2131706083), new Object[] { ((Friends)localObject).getFriendNickWithAlias() });
      paramMessageForPoke = new aspy(paramString, paramQQAppInterface.c(), (String)localObject, paramInt, -5040, 655379, l);
      ...
      azqs.b(paramQQAppInterface, "dc00898", "", "", "0X8009891", "0X8009891", 0, 0, "", "", "", "");
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramString.length() < 5) || (azah.a(paramMessageRecord.msgtype)) || (abti.j(paramMessageRecord.msgtype)) || (a(paramMessageRecord.msgtype)));
        paramQQAppInterface = (amjx)paramQQAppInterface.getManager(285);
        if (paramInt == 1)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      localObject = (amjx)paramQQAppInterface.getManager(285);
      localFriends = localalto.b(paramString);
    } while ((localFriends == null) || (!localFriends.isFriend()));
    if (agyv.a(paramQQAppInterface).b()) {
      if (((amjx)localObject).a(true))
      {
        if (!((amjx)localObject).c(paramString)) {
          break label227;
        }
        ((amjx)localObject).a(paramString);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = localalto.a(paramString, true);
      ...
      return;
      label227:
      ((amjx)localObject).a(paramString, true);
      break;
      if (QLog.isColorLevel()) {
  ...
  {
    if (((b(paramInt)) || (c(paramInt)) || (d(paramInt))) && (!bdeu.b(paramString)) && (!bclg.b(paramQQAppInterface, paramString))) {}
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        amjx localamjx = (amjx)paramQQAppInterface.getManager(285);
        if (!localamjx.a(false))
        {
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          else if (localamjx.e(paramString))
          {
            if (QLog.isColorLevel()) {
          ...
          {
            float f = localamjx.a();
            Object localObject2 = localalto.a(paramString, true);
  ...
  {
    ((amjx)paramQQAppInterface.getManager(285)).h(paramString);
  }
  
  public static boolean d(int paramInt)
  {
    return atlt.b(paramInt);
  }
  
  private static void e(QQAppInterface paramQQAppInterface, String paramString)
  {
    ((amjx)paramQQAppInterface.getManager(285)).i(paramString);
  }
}
