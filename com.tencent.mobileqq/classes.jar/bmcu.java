...
public class bmcu
{
  private static final String jdField_a_of_type_JavaLangString = bmcu.class.getSimpleName();
  private FragmentManager jdField_a_of_type_AndroidSupportV4AppFragmentManager;
  private HashMap<Class<? extends AEEditorBaseFragment>, AEEditorBaseFragment> jdField_a_of_type_JavaUtilHashMap;
  
  public bmcu(FragmentManager paramFragmentManager)
  {
  ...
  private void a(AEEditorBaseFragment paramAEEditorBaseFragment, Class<? extends AEEditorBaseFragment> paramClass, String paramString, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        bmbx.d(jdField_a_of_type_JavaLangString, "replaceFragment: " + Log.getStackTraceString(paramAEEditorBaseFragment));
        return;
      }
    ...
    if (this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.findFragmentByTag(paramClass.getName()) == null) {
      paramBundle.add(2131362292, localAEEditorBaseFragment, paramClass.getName()).commit();
    }
    for (;;)
    {
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          bmbx.b(jdField_a_of_type_JavaLangString, "goBack finish activity");
          b(paramActivity);
      ...
      {
        bmbx.d(jdField_a_of_type_JavaLangString, Log.getStackTraceString(paramActivity));
        return;
      }
  ...
  {
    bmbx.b(jdField_a_of_type_JavaLangString, "enter");
    if (bmct.a(paramBundle))
    {
      a(null, paramBundle);
      return;
    }
    if (bmct.b(paramBundle))
    {
      b(null, paramBundle);
      return;
    }
    if (bmct.c(paramBundle))
    {
      e(null, paramBundle);
      return;
    }
  ...
  {
    bmbx.b(jdField_a_of_type_JavaLangString, "gotoVideoClipModule from " + paramString);
    a(paramAEEditorBaseFragment, AEEditorVideoClipFragment.class, paramString, paramBundle, paramBoolean);
  }
  
  public void a(String paramString, Bundle paramBundle)
  {
    bmbx.b(jdField_a_of_type_JavaLangString, "gotoImageEditModule from " + paramString);
  ...
  {
    bmbx.b(jdField_a_of_type_JavaLangString, "gotoVideoEditModule from " + paramString);
    a(AEEditorVideoEditFragment.class, paramString, paramBundle);
  }
  
  public void d(String paramString, Bundle paramBundle)
  {
    bmbx.b(jdField_a_of_type_JavaLangString, "gotoMultiVideoEditModule from " + paramString);
    a(AEEditorMultiVideoEditFragment.class, paramString, paramBundle);
  }
  
  public void e(String paramString, Bundle paramBundle)
  {
    bmbx.b(jdField_a_of_type_JavaLangString, "gotoMultiCutEditModule from" + paramString);
