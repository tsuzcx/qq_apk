...
public class apnm
{
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaLangString = (apjh.a() + "ar_cloud_img/");
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, ARRecognition paramARRecognition, apnn paramapnn)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[ScanStarFace]pretreatFaceRecogInfo,  FaceScanModelsLoader.hasFaceModelInit =  " + apjz.b);
    }
    if (apjz.c)
    {
    ...
    apnp localapnp = new apnp();
    localapnp.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    ...
    if (apoj.a != null)
    {
      if (apoj.a.hasMessages(4))
      {
        if (QLog.isColorLevel()) {
          QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[DEBUG_SCAN_yt_face] pretreatFaceRecogInfo, remove pending task");
        }
        apoj.a.removeMessages(4);
      }
      paramArrayOfByte = Message.obtain(apoj.a, new ARCloudPretreatmentManager.1(this, paramARRecognition, localFaceCluster, paramArrayOfByte, paramInt1, paramInt2));
      paramArrayOfByte.what = 4;
      if (apoj.a != null) {
        apoj.a.sendMessage(paramArrayOfByte);
      }
    }
    for (;;)
    {
      ...
      {
        localapnp.jdField_a_of_type_ArrayOfComTencentYTFaceModelFaceStatus = paramARRecognition;
        bdll.b(null, "dc00898", "", "", "0X800834C", "0X800834C", 0, 0, "", "", "", "");
      }
      paramapnn.a(localapnp);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apnn paramapnn)
  {
    paramArrayOfByte = new apnz();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapnn.a(paramArrayOfByte);
  }
  
  public void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList, apnn paramapnn, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramArrayOfByte.hasNext())
    {
      ...
      if (l3 == 1L) {
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapnn);
      }
      for (;;)
      {
        break;
        if (l3 == 2L)
        {
          b(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapnn);
        }
        else if (l3 == 4L)
        {
          l1 = System.currentTimeMillis();
          a(this.jdField_a_of_type_ArrayOfByte, j, i, paramArrayList, paramapnn);
          l1 = System.currentTimeMillis() - l1;
        }
        else if (l3 == 64L)
        {
          d(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapnn);
        }
        else if (l3 == 128L)
        {
          c(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapnn);
        }
        else if (l3 == 2048L)
        {
          e(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramapnn);
        }
      }
    }
    paramArrayList = new YuvImage(this.jdField_a_of_type_ArrayOfByte, paramInt3, j, i, null);
    paramArrayOfByte = a();
    paramArrayOfByte = new apno(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte);
    ...
    apog localapog = apog.a();
    localapog.c = l1;
    localapog.b = l2;
    l1 = paramArrayOfByte.jdField_a_of_type_ArrayOfByte.length / 8192;
    paramapnn.a(jdField_a_of_type_Int, paramArrayList, l1);
  }
  ...
  public void b(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apnn paramapnn)
  {
    paramArrayOfByte = new apnq();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapnn.a(paramArrayOfByte);
  }
  
  public void c(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apnn paramapnn)
  {
    paramArrayOfByte = new apnq();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapnn.b(paramArrayOfByte);
  }
  
  public void d(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apnn paramapnn)
  {
    paramArrayOfByte = new apnr();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapnn.a(paramArrayOfByte);
  }
  
  public void e(byte[] paramArrayOfByte, ARRecognition paramARRecognition, apnn paramapnn)
  {
    paramArrayOfByte = new apns();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramapnn.a(paramArrayOfByte);
  }
}
