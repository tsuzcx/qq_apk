...
public class mac
{
  ...
  public mac(byte[] paramArrayOfByte)
  {
    this.jdField_a_of_type_Short = 320;
    paramArrayOfByte = lpg.a(paramArrayOfByte);
    lpf locallpf = (lpf)paramArrayOfByte.get(4);
    if (locallpf != null) {
      this.jdField_a_of_type_ArrayOfByte = locallpf.a();
    }
    if (this.jdField_a_of_type_ArrayOfByte != null)
    {
      paramArrayOfByte = (lpf)paramArrayOfByte.get(3);
