  ...
  implements Handler.Callback
{
  ...
  private HashMap<String, bkgp> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public bkgo(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (i < j)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            ...
            localObject4 = new bkgp(this, localObject3[0], Integer.valueOf(localObject3[1]).intValue(), Integer.valueOf(localObject3[2]).intValue(), Long.valueOf(localObject3[3]).longValue(), Integer.valueOf(localObject3[4]).intValue());
            localHashMap2.put(localObject3[0], localObject4);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "LimitEntry:[" + ((bkgp)localObject4).toString() + "]");
            }
          }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    {
      bkgp localbkgp = (bkgp)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      paramContext = paramContext.getSharedPreferences("config_prefile", 0).edit();
      paramContext.putString("extra_limit_entry_" + this.mApp.getAccount() + "_" + paramString, localbkgp.toString());
      paramContext.apply();
    }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            l = a().longValue();
            localObject = (bkgp)((HashMap)localObject).get(paramString);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "todayBeginTime = " + new Date(l) + "----" + l + " ，entry.mBaseLineTime = " + new Date(((bkgp)localObject).jdField_a_of_type_Long) + "----" + ((bkgp)localObject).jdField_a_of_type_Long);
            }
            if (((bkgp)localObject).jdField_a_of_type_Long >= 1L) {
              continue;
            }
            if (((bkgp)localObject).b <= 0) {
              continue;
            }
            ((bkgp)localObject).jdField_a_of_type_Long = l;
            ((bkgp)localObject).c += 1;
            paramInt = 1;
            bool2 = bool1;
            if (paramInt != 0)
            {
      ...
      if (!bool2) {
        bcst.b(this.app, "dc00898", "", paramString, "0X8009995", "0X8009995", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      }
      bcst.b(this.app, "dc00898", "", paramString, "0X8009996", "0X8009996", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      if (QLog.isColorLevel()) {
      ...
      bool1 = false;
      continue;
      if ((int)((l - ((bkgp)localObject).jdField_a_of_type_Long) / 86400000L) >= ((bkgp)localObject).jdField_a_of_type_Int)
      {
        ((bkgp)localObject).jdField_a_of_type_Long = l;
        ((bkgp)localObject).c = 0;
        paramInt = 1;
        if ((((bkgp)localObject).b > 0) && (((bkgp)localObject).c < ((bkgp)localObject).b))
        {
          ((bkgp)localObject).c += 1;
          paramInt = 1;
        }
  ...
  public void b(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject3 = (bkgp)((HashMap)localObject1).get(paramString);
        ((HashMap)localObject1).remove(paramString);
        if ((j == ((bkgp)localObject3).jdField_a_of_type_Int) && (k == ((bkgp)localObject3).b))
        {
          localHashMap.put(paramString, localObject3);
          break label935;
        }
        localHashMap.put(paramString, new bkgp(this, paramString, j, k, 0L, 0));
        break label935;
      }
      localHashMap.put(paramString, new bkgp(this, paramString, j, k, 0L, 0));
      break label935;
    ...
    for (;;)
    {
      ...
      if (localHashMap.size() > 0)
      {
        ...
        {
          str = (String)((Iterator)localObject1).next();
          bkgp localbkgp = (bkgp)localHashMap.get(str);
          ((SharedPreferences.Editor)localObject2).putString("extra_limit_entry_" + (String)localObject3 + "_" + str, localbkgp.toString());
          paramString.append(str).append(",");
          if (QLog.isColorLevel()) {
            QLog.d("NCtr", 2, "LimitEntry:[" + localbkgp.toString() + "]");
          }
        }
