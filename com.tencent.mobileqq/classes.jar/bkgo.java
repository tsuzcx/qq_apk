  ...
  implements View.OnClickListener
{
  ...
  public bkgo(QQComicTabBarView paramQQComicTabBarView, int paramInt, boolean paramBoolean, List<WebViewTabBarData> paramList)
  {
  ...
  void a(QQComicTabBarView paramQQComicTabBarView)
  {
    ...
    try
    {
      ...
      ((bkgd)localObject).dispatchJsEvent("qbrowserTabClick", null, localJSONObject);
