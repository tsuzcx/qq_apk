...
public class bhkf
{
  ...
  public static Pair<CharSequence, CharSequence> a(bcff parambcff)
  {
    if ((parambcff instanceof bcdu)) {
      return ((bcdu)parambcff).a();
    }
    if ((parambcff instanceof bcdt)) {
      return ((bcdt)parambcff).a();
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      {
      default: 
        return ContactUtils.getNick(paramQQAppInterface, paramString1, paramInt);
      }
      if (AppConstants.SYSTEM_MSG_UIN.equals(paramString1)) {
        return paramContext.getString(2131719141);
      }
      if (AppConstants.QQBROADCAST_MSG_UIN.equals(paramString1)) {
        return paramContext.getString(2131719140);
      }
      if (AppConstants.VOTE_MSG_UIN.equals(paramString1)) {
        return paramContext.getString(2131719172);
      }
      if (paramInt != 1000) {
        break;
      }
    ...
    return ContactUtils.getTroopNickName(paramQQAppInterface, paramString1, paramContext.b(paramString2), paramString2, true, null);
    if (paramInt == 1004)
    {
      paramContext = ContactUtils.getDiscussionMemberShowName(paramQQAppInterface, paramString2, paramString1);
      if ((paramContext != null) && (paramContext.equals(paramString1))) {
        return ContactUtils.getBuddyName(paramQQAppInterface, paramString1, true);
      }
    }
    else
    {
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localavaf = new avaf(new StringReader(paramString), paramString.length());
        paramString = null;
      }
      ...
      return paramString;
      if ((paramString != null) && (TextUtils.equals(paramString.b(), "double")) && ((!TextUtils.equals(localavac.b(), "double")) || (paramString.b() < localavac.a())) && (!TextUtils.isEmpty(paramString.a())))
      {
        localStringBuilder.append(paramString.a().charAt(paramString.a().length() - 1));
        localStringBuilder.append("*");
        localStringBuilder.append(' ');
      }
      if ((!TextUtils.isEmpty(localavac.a())) && ((!TextUtils.equals(localavac.b(), "double")) || (localavac.a().length() != 1)))
      {
        localStringBuilder.append(localavac.a());
        localStringBuilder.append(' ');
      }
      paramString = localavac;
    }
    return null;
  }
  
  public static ArrayList<bhkh> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (j >= 3)
    {
      ...
      if (j >= 3)
      {
        ...
        localObject2 = ContactUtils.getBuddyName(paramQQAppInterface, (String)localObject1, true);
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167171)), 0, paramString.length(), 17);
        localArrayList.add(new bhkh((String)localObject1, 0, new Pair(localObject2, null)));
        i = m + 1;
      }
      label193:
      paramQQAppInterface = new bckw(paramQQAppInterface, 10001, 29, null);
      paramQQAppInterface.a();
      paramQQAppInterface = paramQQAppInterface.a(new bcmk(paramString));
    ...
    for (;;)
    {
      ...
      {
        paramString = (bcff)((Iterator)localObject1).next();
        if ((paramString.b() & 0xFFFFFFFF & 0xFF000000) >> 24 != 2L) {
          if (localArrayList.size() < i)
          {
            if ((paramString.d() == 0) || (paramString.d() == 1004))
            {
              ...
              localArrayList.add(new bhkh(paramString.b(), paramString.d(), paramQQAppInterface));
              j = m;
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            for (paramString = "null";; paramString = paramString.a())
            {
              ...
              if (((String)localObject1).toLowerCase().startsWith(paramString.toLowerCase()))
              {
                ...
                ((SpannableStringBuilder)localObject3).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167171)), 1, paramString.length() + 1, 17);
                localArrayList.add(new bhkh((String)localObject1, 0, new Pair(localObject2, localObject3)));
                i = m + 1;
                break label193;
              }
              Object localObject3 = bcnc.a((String)localObject2, paramString, 1);
              if (localObject3[0] == 0)
              {
                i = localObject3[1];
                localObject2 = new SpannableStringBuilder((CharSequence)localObject2);
                ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167171)), 0, i, 17);
                localArrayList.add(new bhkh((String)localObject1, 0, new Pair(localObject2, null)));
                i = m + 1;
                break label193;
              }
              localObject3 = bcnc.a((String)localObject2, paramString, 2);
              i = m;
              if (localObject3[0] != 0) {
                break label193;
              }
              ...
              i = m + 1;
              break label193;
              localArrayList.add(new bhkh(paramString.b(), paramString.d(), null));
              m = j;
              break label349;
              label767:
  ...
  public static void a(View paramView)
  {
    ...
    bhkg.jdField_c_of_type_Int = a(paramView.getContext());
    paramView = (Integer)paramView.getTag(2131381184);
    if (paramView != null) {}
    for (int i = paramView.intValue();; i = -1)
    {
      bhkg.jdField_e_of_type_Int = i + 1;
      if (bhkg.jdField_f_of_type_Int == 1)
      {
        bhkg.jdField_a_of_type_Long = bhkg.jdField_d_of_type_Long + (System.nanoTime() - bhkg.jdField_c_of_type_Long) / 1000000L;
        bhkg.jdField_b_of_type_Long = bhkg.jdField_f_of_type_Long + (System.nanoTime() - bhkg.jdField_e_of_type_Long) / 1000000L;
      }
      if (bhkg.jdField_d_of_type_Int == 1)
      {
        bhkg.h = -1;
        bhkg.i = -1;
        bhkg.j = -1;
      }
      localHashMap.put("keyNum", String.valueOf(bhkg.jdField_a_of_type_Int));
      localHashMap.put("firstKeyLen", String.valueOf(bhkg.jdField_b_of_type_Int));
      localHashMap.put("itemPage", String.valueOf(bhkg.jdField_c_of_type_Int));
      localHashMap.put("itemSearchStrategy", String.valueOf(bhkg.jdField_d_of_type_Int));
      localHashMap.put("itemPosition", String.valueOf(bhkg.jdField_e_of_type_Int));
      localHashMap.put("itemType", String.valueOf(bhkg.jdField_f_of_type_Int));
      localHashMap.put("itemUinType", String.valueOf(bhkg.g));
      if (bhkg.jdField_f_of_type_Int == 1)
      {
        localHashMap.put("totalCost", String.valueOf(bhkg.jdField_a_of_type_Long));
        localHashMap.put("searchCost", String.valueOf(bhkg.jdField_b_of_type_Long));
      }
      localHashMap.put("senderNum", String.valueOf(bhkg.h));
      localHashMap.put("friendNum", String.valueOf(bhkg.i));
      localHashMap.put("friendIndex", String.valueOf(bhkg.j));
      StatisticCollector.getInstance(BaseApplicationImpl.getApplication()).collectPerformance(null, "actFtsItemClickEvent", true, bhkg.jdField_a_of_type_Long, bhkg.jdField_b_of_type_Long, localHashMap, "", false);
      if ((bhkg.jdField_f_of_type_Int == 1) && (QLog.isColorLevel())) {
        QLog.d("Q.fts.utils", 2, "actFtsItemClickEvent: totalCost = " + bhkg.jdField_a_of_type_Long + ", searchCost = " + bhkg.jdField_b_of_type_Long);
      }
      return;
    }
  }
  ...
  public static boolean b()
  {
    ...
    if (a())
    {
      ...
      if (!e((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject1).put("param_ROM", DeviceInfoUtil.getRomInfo());
    ...
    Object localObject1 = DeviceInfoUtil.getRomMemroy();
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (!f((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject2).put("param_ROM", DeviceInfoUtil.getRomInfo());
  ...
  public static String[] b(String paramString)
  {
    ...
    paramString = new avag(new StringReader(paramString));
    try
    {
      for (;;)
      {
        avac localavac = paramString.a();
        if (localavac == null) {
          break;
        }
        if (!TextUtils.isEmpty(localavac.a()))
        {
          ((StringBuilder)localObject).append(localavac.a());
