...
public class acsj
{
  ...
  public static int a(String paramString, int paramInt)
  {
    ...
    {
      acqy.d("GdtUIUtils", "getColor error", paramString);
    }
    return paramInt;
  }
  ...
  public static Drawable a(@ColorInt int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      localPaintDrawable.setShaderFactory(new acsk(f1, f3, f2, f4, arrayOfInt));
  ...
  public static void a(Activity paramActivity)
  {
    ...
    {
      a(paramActivity);
      acqy.a("GdtMvViewController", "enableNotch && updateLiuhaiTopHeight 0");
    }
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    acqy.a("GdtMvViewController", "hasTopLiuHai  " + bqcd.a);
    return bqcd.a;
  }
  ...
  private static int b(Activity paramActivity)
  {
    ...
    if (i > 27) {
      return bqcd.a(paramActivity);
    }
    return bqcd.b(paramActivity);
  }
  ...
  public static int b(Context paramContext)
  {
    ...
    while ((paramContext.getResources() == null) || (paramContext.getResources().getDisplayMetrics() == null))
    {
      acqy.d("GdtUIUtils", "getScreenWidth error");
      return -2147483648;
    }
  ...
  public static int d(Context paramContext)
  {
    ...
    while ((paramContext.getResources() == null) || (paramContext.getResources().getDisplayMetrics() == null))
    {
      acqy.d("GdtUIUtils", "getScreenHeight error");
      return -2147483648;
    }
