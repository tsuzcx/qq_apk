  ...
  extends DynamicDrawableSpan
{
  ...
  private bfmd(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint)
  {
    super(0);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = a(String.format("%s%s", new Object[] { "@", new bdnf(paramString2, 32).a() }));
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a(paramPaint);
  }
  
  private bfmd(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint, String paramString3)
  {
    this(paramContext, paramString1, paramString2, paramInt, paramPaint);
    this.d = a(String.format("%s%s", new Object[] { "@", new bdnf(paramString3, 32).a() }));
  }
  ...
  public static Spannable a(Spannable paramSpannable, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    bfmd[] arrayOfbfmd = (bfmd[])paramSpannable.getSpans(0, m - 1, bfmd.class);
    if (arrayOfbfmd.length == 0) {
      return localSpannableStringBuilder;
    }
    if (arrayOfbfmd.length > 1) {
      Arrays.sort(arrayOfbfmd, new bfme(paramSpannable));
    }
    int j = 0;
    int i = 0;
    int n;
    ...
    for (;;)
    {
      if (i >= arrayOfbfmd.length) {
        break label342;
      }
      bfmd localbfmd = arrayOfbfmd[i];
      n = paramSpannable.getSpanStart(localbfmd) + j;
      i1 = paramSpannable.getSpanEnd(localbfmd) + j;
      String str = localbfmd.jdField_b_of_type_JavaLangString;
      if (!TextUtils.isEmpty(localbfmd.d)) {
        str = localbfmd.d;
      }
      try
      {
        ...
        localAtTroopMemberInfo.uin = Long.valueOf(localbfmd.jdField_a_of_type_JavaLangString).longValue();
        if ((localbfmd.jdField_a_of_type_JavaLangString != null) && (localbfmd.jdField_a_of_type_JavaLangString.equalsIgnoreCase("0"))) {
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, EditText paramEditText)
  {
    ...
    try
    {
      paramQQAppInterface = new bfmd(paramContext, paramString2, paramString3, i - j - k, paramEditText.getPaint(), paramString4);
    ...
    catch (OutOfMemoryError paramQQAppInterface)
    {
      ...
      paramString1 = new SpannableString(new bdnf(paramContext + " ", 16).a());
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, EditText paramEditText, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    bfmd[] arrayOfbfmd = (bfmd[])paramEditText.getEditableText().getSpans(0, paramEditText.getEditableText().toString().length(), bfmd.class);
    int i = paramEditText.getWidth();
    int j = paramEditText.getPaddingLeft();
    int k = paramEditText.getPaddingRight();
    try
  ...
  private static bfmd a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, int paramInt, Paint paramPaint, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {
        ...
        {
          paramString1 = bglf.e(paramQQAppInterface, paramString1, paramString2);
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("_At_Me_DISC", 2, " memUin:" + paramString2 + " troopMemName:" + bgjw.a(paramQQAppInterface) + " isTroop:" + paramBoolean2);
        }
        return new bfmd(paramContext, paramString2, paramQQAppInterface, paramInt, paramPaint);
        paramQQAppInterface = paramString3;
        continue;
        if (!paramString2.equalsIgnoreCase("0"))
        {
          paramString1 = bglf.c(paramQQAppInterface, paramString2, true);
          paramQQAppInterface = paramString1;
      ...
      catch (JSONException paramQQAppInterface)
      {
        try
        {
          ...
          if (i1 == 0)
          {
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
            str = "@" + bglf.c(paramQQAppInterface, paramString2, str);
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
  ...
  private List<bhvd> a(Paint paramPaint)
  {
    int i = (int)Math.ceil(paramPaint.measureText(" "));
    List localList = bgwv.a(this.jdField_b_of_type_Int - i * 2, this.jdField_b_of_type_JavaLangString, paramPaint, this.jdField_a_of_type_Bhve, 16);
    localList.add(new bhvd(1, 0, 0, "  ", null));
    this.jdField_a_of_type_Int = bgwv.a(localList, paramPaint, new Rect());
    return localList;
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    {
      localObject3 = (bhvd)((Iterator)localObject2).next();
      switch (((bhvd)localObject3).c)
      {
      default: 
        break;
      case 1: 
        localCanvas.drawText(((bhvd)localObject3).jdField_a_of_type_JavaLangString, f1, f2, paramPaint);
        f1 += paramPaint.measureText(((bhvd)localObject3).jdField_a_of_type_JavaLangString);
        break;
      case 2: 
        localObject3 = (bdoa)((bhvd)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle;
        j = ((bdoa)localObject3).a().getBounds().height();
        ((bdoa)localObject3).draw(localCanvas, "", 0, 0, f1, (i - j) / 2, (i + j) / 2, (j + i) / 2, paramPaint);
        f1 += ((bdoa)localObject3).a().getBounds().width();
      }
    }
    localCanvas.save();
    localCanvas.restore();
