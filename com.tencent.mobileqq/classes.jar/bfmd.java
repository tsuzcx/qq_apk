...
public class bfmd
{
      ...
      try
      {
        ...
        if (j == -1)
        {
          ...
          if (-1 == m)
          {
            ...
            localbfme.jdField_a_of_type_JavaLangString = paramString;
            localbfme.jdField_a_of_type_Int = Integer.valueOf(str1).intValue();
            if (i == 0) {
              break;
            }
            localbfme.b = 1;
          ...
          str1 = str1 + ":" + str2;
          continue;
          localbfme.jdField_a_of_type_JavaLangString = str2;
          localbfme.jdField_a_of_type_Int = 0;
          continue;
        }
        j += 3;
      }
  ...
  public static bgjh a(long paramLong)
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
      return null;
    }
    return bgjh.a(localQQAppInterface, paramLong);
  }
