...
{
  public jwy(MultiVideoCtrlLayerUI4Discussion paramMultiVideoCtrlLayerUI4Discussion) {}
  ...
  protected void a(int paramInt, String paramString)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      this.a.jdField_a_of_type_Jxs.a(paramInt, paramString);
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(this.a.jdField_a_of_type_Jxs, 500L);
    }
  }
  ...
  protected void a(int paramInt, ArrayList paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131559815);
        ...
        f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131559815);
        localObject1 = UITools.a((Context)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), (String)localObject1, this.a.i, f);
      ...
      return;
      paramArrayList = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429135);
      continue;
      paramArrayList = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429136);
      continue;
      paramArrayList = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429137);
      continue;
      paramArrayList = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429138);
      continue;
      paramArrayList = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429133);
      continue;
      paramArrayList = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429134);
      continue;
  ...
  protected void a(long paramLong)
  {
    ...
    for (i = 4;; i = 3)
    {
      ...
      if ((this.a.jdField_f_of_type_Boolean) && (this.a.jdField_f_of_type_Boolean) && (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
        this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jxa(this), 500L);
      }
  ...
  protected void b(long paramLong)
  {
    ...
    for (int i = 2;; i = 1)
    {
      ...
      this.a.jdField_a_of_type_ComTencentAvUtilsSensorHelper.b(true);
      this.a.jdField_a_of_type_ComTencentAvUtilsSensorHelper.a();
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jxe(this.a), 500L);
      if ((this.a.jdField_f_of_type_Boolean) && (this.a.jdField_f_of_type_Boolean) && (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
        this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jxb(this), 600L);
      }
      if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_f_of_type_Boolean) {
        this.a.L();
      }
  ...
  protected void c()
  {
    super.c();
    if (this.a.d != 2) {}
    while (this.a.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131365369)) {
      return;
    }
    this.a.t_();
  }
  ...
  protected void d()
  {
    ...
    if (localAVActivity != null) {
      localAVActivity.runOnUiThread(new jwz(this));
    }
    while (!QLog.isColorLevel()) {
      return;
    }
