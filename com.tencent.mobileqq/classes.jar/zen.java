  ...
  extends zel
{
  ...
  public zen(zeh paramzeh)
  {
    ...
    this.jdField_a_of_type_Zeh = paramzeh;
  }
  ...
  public void a(Canvas paramCanvas, zem paramzem, float paramFloat)
  {
    if (paramzem.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (paramzem.jdField_a_of_type_Int == 104)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(45.0F);
        this.jdField_a_of_type_AndroidGraphicsPaint.setShader(this.jdField_a_of_type_AndroidGraphicsBitmapShader);
        paramCanvas.drawPath(paramzem.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (paramzem.jdField_a_of_type_Int != 105);
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(paramzem.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
  ...
  public void a(zbe paramzbe, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
  ...
  public void a(zem paramzem)
  {
    if (paramzem.jdField_a_of_type_Int == 103)
    {
      ...
      yuq.a("0X80076C2");
      List localList = paramzem.jdField_a_of_type_JavaUtilList;
      paramzem = paramzem.b;
      int k = 0;
      while ((k < localList.size()) && (k < paramzem.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)paramzem.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Zem = new zem(new Path(), this.g);
      if (this.jdField_a_of_type_Zeh != null) {
        this.jdField_a_of_type_Zeh.a(this.jdField_a_of_type_Zem);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Zem.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Zem.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Zem.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Zem.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Zem.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Zem.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Zem.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Zem.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Zem.b.get(this.jdField_a_of_type_Zem.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Zem.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Zem.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        ...
        {
          this.jdField_a_of_type_Zem.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, (this.jdField_d_of_type_Float + f1) / 2.0F, (this.jdField_e_of_type_Float + f2) / 2.0F);
          this.jdField_d_of_type_Float = f1;
          this.jdField_e_of_type_Float = f2;
        }
        else if (this.g == 105)
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Zbe != null)
    {
      ...
      this.jdField_a_of_type_Zbe.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Zbe.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Zem = null;
    if (this.g == 104) {
      return;
    }
    if (this.g == 105)
