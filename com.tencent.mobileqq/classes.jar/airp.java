...
public class airp
  implements amdt
{
  public airp(AddContactsView paramAddContactsView) {}
  ...
  public void b()
  {
    ...
    this.a.e();
    this.a.jdField_a_of_type_ComTencentWidgetSwipListView.getViewTreeObserver().addOnGlobalLayoutListener(new airq(this));
  }
}
