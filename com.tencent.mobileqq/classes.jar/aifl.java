...
{
  private anmu jdField_a_of_type_Anmu = new aifo(this);
  private anqd jdField_a_of_type_Anqd = new aifn(this);
  ...
  private Comparator<MessageRecord> jdField_a_of_type_JavaUtilComparator = new aifm(this);
  private byte[] jdField_a_of_type_ArrayOfByte;
  private MessageRecord b;
  private String g;
  private volatile int q;
  
  public aifl(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  private void g(String paramString)
  {
    ...
    VSNetworkHelper.a().a(this.jdField_a_of_type_AndroidContentContext, paramString, new aifp(this));
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 1)
    {
      vrf.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 45, 5, 2);
  ...
  public void f()
  {
    ...
    vrf.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 45, 1, 1);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (paramView.getId() == 2131367274) {
      vrf.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 45, 6, 3);
    }
