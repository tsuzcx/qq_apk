  ...
  implements Handler.Callback
{
  ...
  private anvi jdField_a_of_type_Anvi = new aifo(this);
  private anyz jdField_a_of_type_Anyz = new aifn(this);
  ...
  private void a(String paramString)
  {
    ...
    VSNetworkHelper.getInstance().sendRequest(this.mContext, paramString, new aifp(this));
  }
  ...
  public void updateSession_updateUI(Intent paramIntent)
  {
    ...
    if ((paramIntent.getBooleanExtra("qcircle_chat_hide_menu_key", false)) && (this.mCustomTitleView != null)) {
      this.mCustomTitleView.setRightRootVisibility(4);
    }
  }
}
