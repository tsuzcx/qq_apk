  ...
  extends atab
{
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    atam localatam = (atam)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = b(paramInt1, paramInt2 * 4 + i, paramBoolean, localatam.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new atam(null));
    ...
    for (FileManagerEntity localFileManagerEntity = (FileManagerEntity)paramViewGroup;; localView = null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          try
          {
            localataa.jdField_a_of_type_JavaLangObject = localFileManagerEntity;
            ...
            auea.a(localataa.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localFileManagerEntity);
            paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692304) + localFileManagerEntity.fileName;
        ...
        continue;
        paramViewGroup = paramViewGroup + anvx.a(2131709153);
