...
public class atak
  implements asvc, Manager
{
  QQAppInterface a;
  
  public atak(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  public static Bundle a(IVPluginInfo paramIVPluginInfo, asuy paramasuy)
  {
    int m = 0;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = (aloz)((AppRuntime)localObject1).getManager(51);
        localObject3 = ((aloz)localObject2).e(str2);
        ...
        localObject3 = ((aloz)localObject2).b(str2);
        if (localObject3 == null) {
          break label452;
        }
      ...
      localBundle.putString("payToken", paramasuy.a().c);
