...
public class rpt
{
  ...
  {
    if (bnrf.b(paramAppRuntime, "VIDEO_FEEDS_SOFT_AD_LOCAL_CONFIG_DATE")) {
  ...
  {
    if (((paramView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) && (paramView.getTag(2131362696) == null))
    {
      ...
      localValueAnimator.addUpdateListener(new rpz(i, localMarginLayoutParams, j, paramView));
      localValueAnimator.addListener(new rqa(paramView));
      paramView.setTag(2131362696, localValueAnimator);
  ...
  public static ObjectAnimator a(View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      localObjectAnimator1.addListener(new rqe(paramView));
      localObjectAnimator1.start();
    }
    for (;;)
    {
      ...
      paramView.setTag(2131376115, localObjectAnimator1);
      ...
      if ((paramInt1 == 8) || (paramInt1 == 4))
      {
        ...
        localObjectAnimator1.start();
        paramView.setLayerType(2, null);
        localObjectAnimator1.addListener(new rqf(paramView));
        localObjectAnimator1.start();
      }
    }
  }
  ...
  private static Drawable a(Context paramContext)
  {
    ...
    localGradientDrawable.setCornerRadius(agej.a(3.0F, paramContext.getResources()));
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      localVideoInfo.x = paramBundle.getString("VIDEO_SUBS_TEXT");
      localVideoInfo.y = paramBundle.getString("VIDEO_SUBS_COLOR");
  ...
  public static Long a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      if (sel.g(paramBaseArticleInfo)) {
        return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt.jdField_a_of_type_Long);
      }
      return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.jdField_a_of_type_Long);
    }
  ...
  public static String a(int paramInt)
  {
    ...
    return f(paramInt) + anzj.a(2131714938);
  }
  ...
  {
    return bjtz.d(paramQQAppInterface.getCurrentAccountUin() + "_" + paramString + "_" + System.currentTimeMillis());
  }
  ...
  public static JSONObject a(String paramString, List<rvu> paramList, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramList != null)
      {
        ...
        {
          rvu localrvu = (rvu)paramList.next();
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      ...
      if (paramBaseArticleInfo.mSocialFeedInfo != null)
      {
        ...
        i = j;
        localObject1 = localObject2;
        if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr != null)
        {
          bool1 = bool2;
          l1 = l2;
          i = j;
          ...
          if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl != null)
          {
            ...
            i = j;
            localObject1 = localObject2;
            if (paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.b != null)
            {
              bool1 = bool2;
              l1 = l2;
              i = j;
              localObject1 = localObject2;
              if (!paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.b.isEmpty())
              {
                bool1 = true;
                l1 = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.a.longValue();
                i = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.b.intValue();
                localObject1 = ((qyn)paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.b.get(0)).jdField_b_of_type_JavaLangString;
              }
            }
          }
        }
  ...
  public static void a(Context paramContext, Bundle paramBundle, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBoolean = pbn.a(localBundle.getInt("VIDEO_FROM_TYPE", -1));
        for (;;)
        {
          if (!paramBoolean) {
            break label247;
          ...
          rze.a(paramContext, paramBundle);
          ...
          if (paramBundle != null) {
            paramBoolean = pbn.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), paramBundle.jdField_b_of_type_Int, paramBundle.jdField_c_of_type_Int, paramBundle.jdField_d_of_type_Int);
          } else {
            paramBoolean = pbn.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue(), localBundle);
          }
        }
      }
  ...
  {
    a(paramContext, paramTextView, anzj.a(2131714984), anzj.a(2131714989), bihq.a("kandian"), null);
  }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1.setSpan(new rpu(paramString3, paramContext, paramOnClickListener), i, j, 33);
  ...
  public static void a(Context paramContext, UrlJumpInfo paramUrlJumpInfo)
  {
    if ((paramUrlJumpInfo != null) && (paramContext != null))
    {
      ...
      if (!TextUtils.isEmpty(paramUrlJumpInfo.jdField_a_of_type_JavaLangString)) {
        ozs.a(paramContext, paramUrlJumpInfo.jdField_a_of_type_JavaLangString);
      }
    }
    for (;;)
    {
      ...
      {
        if (!oix.a(paramUrlJumpInfo.jdField_b_of_type_JavaLangString))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
        ...
        if (bhny.a(paramContext, paramUrlJumpInfo.jdField_b_of_type_JavaLangString)) {
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      int i = agej.a(16.0F, paramContext.getResources());
      localTextView.setPadding(i, 0, i, 0);
      paramString = new ReportDialog(paramContext, 2131755324);
      paramString.setContentView(localTextView, new ViewGroup.LayoutParams(-2, bhgr.a(paramContext, 40.0F)));
  ...
  public static void a(View paramView)
  {
    ...
    paramView = paramView.getTag(2131376115);
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new rqg(paramView));
        paramView.clearAnimation();
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new rqh(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramInt2 == 0)
      {
        ...
        paramView.setLayerType(2, null);
        localObjectAnimator2.addListener(new rqc(paramView));
    ...
    localObjectAnimator1.setRepeatCount(0);
    paramView.setLayerType(2, null);
    localObjectAnimator1.addListener(new rqd(paramView));
    localObjectAnimator1.start();
  }
  ...
  public static void a(ViewGroup paramViewGroup)
  {
    if ((("sm-g9650".equalsIgnoreCase(Build.DEVICE)) || ("star2qltezc".equalsIgnoreCase(Build.PRODUCT))) && ((paramViewGroup.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)))
    {
      ...
      paramViewGroup.bottomMargin += bhtq.a(20.0F);
    }
  }
  ...
  public static void a(TextView paramTextView, rwf paramrwf, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    bnrf.i(ozs.a());
    if (paramTextView != null) {
    ...
    if (paramVideoInfo.jdField_a_of_type_Int != 0)
    {
      if (paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null)
      {
        ...
        if (paramVideoInfo.jdField_b_of_type_Boolean)
        {
          ...
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.b = new ArrayList();
          qyn localqyn = new qyn();
          localqyn.jdField_h_of_type_JavaLangString = paramVideoInfo.jdField_f_of_type_JavaLangString;
          localqyn.e = paramVideoInfo.jdField_c_of_type_JavaLangString;
          localqyn.jdField_d_of_type_JavaLangString = paramVideoInfo.jdField_b_of_type_JavaLangString;
          localqyn.jdField_a_of_type_Long = paramVideoInfo.jdField_d_of_type_Int;
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qyl.b.add(localqyn);
        }
  ...
  public static void a(VideoInfo paramVideoInfo, TextView paramTextView)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      swh localswh = new swh(-12541697);
      localswh.a(new rqb(paramTextView, (VideoInfo.RichTitleInfo)localObject, paramVideoInfo));
      localObject = new SpannableStringBuilder(((VideoInfo.RichTitleInfo)localObject).jdField_c_of_type_JavaLangString + " ");
      ((SpannableStringBuilder)localObject).setSpan(localswh, 0, ((SpannableStringBuilder)localObject).length(), 33);
      paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean, String paramString)
  {
    ...
    ((ocw)paramQQAppInterface.a(155)).a(paramInt, paramBoolean, paramString);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2)
  {
    ...
    rpx localrpx = new rpx(paramString1, paramBoolean1);
    if (paramBoolean1) {}
    for (int i = 2;; i = 1)
    {
      localpra.a(paramQQAppInterface, paramString1, true, paramString2, localrpx, i, paramBoolean2);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, TextView paramTextView)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      try
      {
        oxr.a(paramTextView, paramString1);
  ...
  {
    bnrf.x(paramAppRuntime, paramInt);
  }
  
  public static void a(AppRuntime paramAppRuntime, Activity paramActivity)
  {
    if (pnx.a(paramActivity, true)) {
      bhlq.a(paramActivity, 230, paramActivity.getString(2131717348), paramActivity.getString(2131717347), 2131690580, 2131717346, new rpy(), null).setMessageCount(null).show();
    }
  }
  
  public static void a(rwc paramrwc, View paramView)
  {
    if (!pbn.a()) {}
    do
    {
    ...
    if (!TextUtils.isEmpty(str)) {
      paramrwc.jdField_b_of_type_JavaLangString = str;
    }
    paramrwc.j = paramView.getNativeView().getWidth();
    paramrwc.k = paramView.getNativeView().getHeight();
  }
  ...
  public static boolean a(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (i == 1)
    {
      if (ozs.a(paramBaseArticleInfo.bytes_jump_url))
      {
        ozs.a(paramActivity, ozs.a(paramBaseArticleInfo.bytes_jump_url));
        return true;
      }
    }
    else if ((i == 2) && (ozs.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bhny.a(paramActivity, ozs.a(paramBaseArticleInfo.bytes_jump_bundle))))
    {
      a(paramActivity, ozs.a(paramBaseArticleInfo.bytes_jump_schema));
      return true;
    }
    return false;
  }
  ...
  {
    String str = oyj.a(paramBaseArticleInfo);
    if (!TextUtils.isEmpty(str))
    {
      if (quv.a(str))
      {
        ozs.a(paramContext, paramBaseArticleInfo, str);
        return true;
      }
      a(paramContext, str);
      return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    try
    {
      boolean bool = ppo.a(paramLong, null);
      return bool;
    }
  ...
  public static String b(int paramInt)
  {
    ...
    return f(paramInt) + anzj.a(2131714983);
  }
  ...
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1 = new SpannableString(paramString1);
    paramString1.setSpan(new rpv(paramTextView), i, j, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(paramString1);
    paramTextView.setOnClickListener(new rpw(paramString3, paramContext, paramOnClickListener));
  }
  ...
  public static boolean b(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      if ((ozs.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bhny.a(paramActivity, ozs.a(paramBaseArticleInfo.bytes_jump_bundle))))
      {
        a(paramActivity, ozs.a(paramBaseArticleInfo.bytes_jump_schema));
        return true;
      }
  ...
  {
    if (paramLong <= 0L) {
      return anzj.a(2131715002);
    }
    return b(paramLong) + anzj.a(2131714998);
  }
  ...
  public static String e(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt >= 10004999)
      {
        ...
        return jdField_d_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + anzj.a(2131714950);
      }
      if (paramInt >= 10000)
      {
        ...
        return jdField_c_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + anzj.a(2131714930);
      }
    } while (paramInt <= 0);
    return paramInt + "";
  }
  ...
  private static String f(int paramInt)
  {
    ...
    if (paramInt >= 100000000) {
      str = jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 100000000.0D) + anzj.a(2131714977);
    }
    do
    {
      return str;
      if (paramInt >= 10000) {
        return jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + anzj.a(2131714975);
      }
    } while (paramInt < 0);
    return paramInt + "";
  }
