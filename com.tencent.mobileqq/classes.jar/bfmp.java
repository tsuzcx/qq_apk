...
public class bfmp
{
  private static volatile bfmp a;
  protected List<bbzc> a;
  protected List<bfmr> b;
  ...
  public static ArrayList<Long> a(List<? extends bbzd> paramList)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        Object localObject = (bbzd)paramList.get(i);
        if ((localObject instanceof bbyj))
        {
          localObject = (bbyj)localObject;
          try
          {
            if ((((bbyj)localObject).a() == 0) || (((bbyj)localObject).a() == 3)) {
              break label116;
            }
            localArrayList.add(Long.valueOf(Long.parseLong(((bbyj)localObject).d())));
          }
  ...
  public final bbyj a(String paramString)
  {
    ...
    while (i < j)
    {
      bbzc localbbzc = (bbzc)this.jdField_a_of_type_JavaUtilList.get(i);
      if (((localbbzc instanceof bbyj)) && (paramString.equals(localbbzc.d()))) {
        return (bbyj)localbbzc;
      }
      i += 1;
    }
    return null;
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    if (this.b == null)
    {
      ...
      localObject = (bfmr)this.b.get(j);
      if (!((bfmr)localObject).a.equals(paramString2)) {
        break label143;
      }
    }
    label143:
    label152:
    for (Object localObject = bfmr.a(paramString1, (bfmr)localObject);; localObject = null)
    {
  ...
  public List<bbzc> a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList1 = new ArrayList();
    ExecutorService localExecutorService = Executors.newFixedThreadPool(1);
    ArrayList localArrayList2 = new ArrayList();
    localArrayList2.add(localExecutorService.submit(new bfmq(this, paramContext, paramQQAppInterface, bbzc.E, paramInt)));
    paramInt = 0;
    try
    {
  ...
  @SuppressLint({"UseSparseArrays"})
  public List<bbzc> a(Context paramContext, QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    if (localanvk != null)
    {
      ...
      if (localObject != null)
      {
        ...
        while (localIterator1.hasNext())
        {
          ...
          localObject = localanvk.a(String.valueOf(localGroups.group_id));
          if (localObject != null)
          {
            ...
            label178:
            for (localObject = paramContext.getResources().getString(2131719792);; localObject = localGroups.group_name)
            {
              localArrayList.add(new bbyj(paramContext, paramQQAppInterface, localFriends, (String)localObject, 0L, paramLong));
              break label106;
              break;
            }
          }
    ...
    if (paramBoolean)
    {
      ...
      localArrayList.add(new bbyj(paramContext, paramQQAppInterface, (Friends)localObject, paramContext.getResources().getString(2131719792), 0L, paramLong));
    }
  ...
  public List<bfmr> a(Context paramContext, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList = new ArrayList();
    anvk localanvk = (anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
    if (localanvk != null)
    {
      Object localObject1 = localanvk.b();
      if (localObject1 != null)
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          Object localObject2 = localanvk.a(String.valueOf(((Groups)((Iterator)localObject1).next()).group_id));
          if (localObject2 != null)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              localArrayList.add(new bfmr(paramContext, localFriends.uin, localFriends.name, localFriends.remark));
            }
          }
        }
      }
    ...
    if (paramBoolean) {
      localArrayList.add(new bfmr(paramContext, paramQQAppInterface.getCurrentAccountUin(), paramQQAppInterface.getCurrentNickname(), null));
    }
    long l2 = System.currentTimeMillis();
    if (QLog.isColorLevel()) {
