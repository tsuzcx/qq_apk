...
public class blba
{
  ...
  private blaz jdField_a_of_type_Blaz = new blbb(this);
  ...
  public float a(int paramInt)
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_Blay != null) && (this.jdField_a_of_type_Blay.jdField_a_of_type_Boolean) && (paramInt >= this.jdField_a_of_type_Int)) {
      return this.jdField_a_of_type_Blay.a(paramInt - this.jdField_a_of_type_Int);
    }
    return -1.0F;
  }
