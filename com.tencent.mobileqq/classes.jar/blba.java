...
public class blba
{
  ...
  public blba(int paramInt1, String paramString, Map<String, String> paramMap, int paramInt2, WebSocketProxy.WebSocketListener paramWebSocketListener)
  {
    ...
    this.jdField_a_of_type_Okhttp3OkHttpClient.newWebSocket(paramMap, new blbb(this, paramInt1));
  }
}
