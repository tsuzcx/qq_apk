  ...
  implements Manager
{
  ...
  public aleh(QQAppInterface paramQQAppInterface)
  {
  ...
  private void c(ApolloActionData paramApolloActionData)
  {
    ...
    {
      return;
      if ((TextUtils.isEmpty(paramApolloActionData.minVer)) || (TextUtils.isEmpty(paramApolloActionData.maxVer)) || (alee.a(AppSetting.f(), paramApolloActionData.minVer, paramApolloActionData.maxVer)))
      {
  ...
  private void i(List<ApolloObtainedActionData> paramList)
  {
    ...
    //   10: ifeq +10 -> 20
    //   13: aload_0
    //   14: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   17: ifnonnull +4 -> 21
    //   20: return
    //   21: aload_0
    //   22: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   25: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   28: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   31: astore_3
    //   32: aload_3
    //   33: ifnull +148 -> 181
    //   36: aload_3
    //   37: invokevirtual 322	awbw:a	()Lawby;
    //   40: astore_2
    //   41: aload_2
    //   42: invokevirtual 326	awby:a	()V
    ...
    //   97: aload_3
    //   98: aload 6
    //   100: invokevirtual 336	aleh:a	(Lawbw;Lawbv;)Z
    //   103: pop
    ...
    //   177: aload_2
    //   178: invokevirtual 353	awby:b	()V
    //   181: aload_0
    //   182: getfield 78	aleh:h	Ljava/util/List;
    //   185: ifnull +32 -> 217
    //   188: aload_0
    //   189: getfield 78	aleh:h	Ljava/util/List;
    //   192: astore_2
    //   193: aload_2
    //   194: monitorenter
    //   195: aload_0
    //   196: getfield 78	aleh:h	Ljava/util/List;
    //   199: invokeinterface 356 1 0
    //   204: aload_0
    //   205: getfield 78	aleh:h	Ljava/util/List;
    //   208: aload_1
    ...
    //   216: monitorexit
    //   217: aload_0
    //   218: getfield 82	aleh:jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   221: ifnull +10 -> 231
    //   224: aload_0
    //   225: getfield 82	aleh:jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   228: invokevirtual 360	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   231: aload_0
    //   232: getfield 80	aleh:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   235: ifnull -215 -> 20
    //   238: aload_0
    //   239: getfield 80	aleh:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   289: aload_2
    //   290: invokevirtual 362	awby:c	()V
    //   293: aload_2
    //   294: invokevirtual 353	awby:b	()V
    //   297: goto -116 -> 181
    //   300: astore_1
    //   301: aload_2
    //   302: invokevirtual 353	awby:b	()V
    //   305: aload_1
    //   306: athrow
    //   307: astore_1
    //   308: aload_2
  ...
  public ApolloActionData a(int paramInt)
  {
    ...
    do
    {
      ...
      localObject2 = (ApolloActionData)((awbw)localObject2).a(ApolloActionData.class, paramInt + "");
      localObject1 = localObject2;
  ...
  public ApolloActionPackage a(int paramInt)
  {
    ...
    if (??? != null) {
      return (ApolloActionPackage)((awbw)???).a(ApolloActionPackage.class, paramInt + "");
    }
    return null;
  }
  ...
  public ApolloFavActionData a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        for (localObject3 = (ApolloFavActionData)((awbw)localObject3).a(ApolloFavActionData.class, paramLong);; localObject3 = null) {
          return localObject3;
        }
      }
      return null;
  ...
  public ApolloGameData a(int paramInt)
  {
    ...
    do
    {
      ...
      localApolloGameData2 = (ApolloGameData)((awbw)localObject1).a(ApolloGameData.class, paramInt + "");
  ...
  public Pair<List<ApolloFavActionData>, List<ApolloActionData>> a()
  {
    ...
    List localList = d();
    Collections.sort(localList, new alei(this));
    ...
    for (;;)
    {
      ...
      if (m == 0)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_b_of_type_Boolean))
        {
          ...
          ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(false, "getFavPanelActionPairInfo action not exit", 1);
        }
      }
  ...
  public List<ApolloActionData> a()
  {
    ...
    Object localObject = ((awbw)localObject).a(ApolloActionData.class);
    if (QLog.isColorLevel()) {
      if (localObject != null) {
        break label90;
      }
  ...
  public List<ApolloActionData> a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        ??? = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
        if (??? != null) {
          return ((awbw)???).a(ApolloActionData.class, false, "feeType!=?", new String[] { String.valueOf(paramInt) }, null, null, null, null);
        }
      }
  ...
  public Map<String, ApolloPreDownloadData> a()
  {
    ...
    try
    {
      localObject1 = (ArrayList)localawbw.a(ApolloPreDownloadData.class);
      return this.jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap;
    }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((StringBuilder)localObject2).append(alef.s).append(localApolloGameData.gameId).append(File.separator).append("config.json");
        ...
        localObject2 = new JSONObject(bdcs.b((File)localObject2)).optString("version");
      }
  ...
  public void a(long paramLong)
  {
    ...
    {
      ((awby)???).a();
      localawbw.b(" DELETE FROM ApolloActionPush WHERE mId = " + paramLong);
      ((awby)???).c();
      return;
    }
    catch (Exception localException)
  ...
  public void a(awbw paramawbw, List<ApolloGameScoreData> paramList)
  {
    if ((paramawbw != null) && (paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        paramawbw.b(localApolloGameScoreData);
        if (QLog.isColorLevel()) {
  ...
  public void a(BaseChatPie paramBaseChatPie, List<ApolloActionData> paramList)
  {
    ...
    Object localObject = (akji)paramBaseChatPie.a().getManager(153);
    boolean bool = ((akji)localObject).a(paramBaseChatPie.a().getCurrentAccountUin());
    int n = ((akji)localObject).a(paramBaseChatPie.a().getCurrentAccountUin());
    ...
    Collections.sort(paramBaseChatPie, new alej(this));
    Collections.sort(localArrayList1, new alek(this));
    Collections.sort((List)localObject, new alel(this));
    Collections.sort(localArrayList2, new alem(this));
    Collections.sort(localArrayList3, new alen(this));
    paramList.clear();
  ...
  public void a(ApolloPreDownloadData paramApolloPreDownloadData)
  {
    ...
    try
    {
      localawbw.a(paramApolloPreDownloadData);
      localawby.c();
      return;
    }
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilList)
      {
        ...
        else
        {
          ...
          ((awbw)???).a(paramApolloActionPackage);
          return;
        }
        m -= 1;
      }
  ...
  public void a(ApolloFavActionData paramApolloFavActionData)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaUtilList)
      {
        ...
        ((awbw)???).a(paramApolloFavActionData);
        return;
      }
    }
  }
  ...
  public void a(ApolloObtainedActionData paramApolloObtainedActionData)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.h)
      {
        ...
        ((awbw)???).a(paramApolloObtainedActionData);
        return;
      }
    }
  }
  ...
  public void a(ArrayList<ApolloGameRoamData> paramArrayList)
  {
    ...
    //   8: ifeq +10 -> 18
    //   11: aload_0
    //   12: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15: ifnonnull +4 -> 19
    //   18: return
    //   19: aload_0
    //   20: getfield 69	aleh:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   23: ifnull +130 -> 153
    //   26: aload_0
    //   27: getfield 69	aleh:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   30: astore_2
    //   31: aload_2
    //   32: monitorenter
    //   33: aload_1
    ...
    //   56: astore 4
    //   58: aload_0
    //   59: getfield 69	aleh:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   111: if_icmpne -42 -> 69
    //   114: aload_0
    //   115: getfield 69	aleh:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   118: aload 6
    ...
    //   137: aload_0
    //   138: aload 6
    //   140: invokevirtual 743	aleh:a	(Lcom/tencent/mobileqq/data/ApolloGameRoamData;)V
    //   143: goto -105 -> 38
    //   146: astore_1
    //   147: aload_2
    //   148: monitorexit
    ...
    //   152: monitorexit
    //   153: aload_0
    //   154: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   157: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   160: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   163: astore_3
    //   164: aload_3
    //   165: ifnull -147 -> 18
    //   168: aload_3
    //   169: invokevirtual 322	awbw:a	()Lawby;
    //   172: astore_2
    //   173: aload_2
    //   174: invokevirtual 326	awby:a	()V
    //   177: aload_1
    ...
    //   232: invokevirtual 644	awbw:b	(Ljava/lang/String;)Z
    //   235: pop
    //   236: goto -54 -> 182
    //   239: astore_1
    //   240: aload_1
    ...
    //   244: aload_2
    //   245: invokevirtual 353	awby:b	()V
    //   248: return
    //   249: aload_2
    //   250: invokevirtual 362	awby:c	()V
    //   253: aload_2
    //   254: invokevirtual 353	awby:b	()V
    //   257: return
    //   258: astore_1
    //   259: aload_2
    //   260: invokevirtual 353	awby:b	()V
    //   263: aload_1
    //   264: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          a(localawbw, localApolloActionData);
          if (QLog.isColorLevel())
          {
  ...
  public void a(List<AioPushData> paramList, int paramInt)
  {
    ...
    //   28: astore 5
    //   30: aload_0
    //   31: getfield 84	aleh:l	Ljava/util/List;
    //   34: ifnull +277 -> 311
    //   37: aload_0
    //   38: getfield 84	aleh:l	Ljava/util/List;
    //   41: astore 6
    //   43: aload 6
    //   45: monitorenter
    //   46: aload_1
    ...
    //   121: ifne -54 -> 67
    //   124: aload_0
    //   125: getfield 84	aleh:l	Ljava/util/List;
    //   128: aload 8
    ...
    //   139: iflt +67 -> 206
    //   142: aload_0
    //   143: getfield 84	aleh:l	Ljava/util/List;
    //   146: iload 4
    ...
    //   245: aload_0
    //   246: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   249: sipush 255
    //   252: invokevirtual 471	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   255: checkcast 767	alpr
    //   258: astore 9
    //   260: aload 9
    //   262: ifnull +33 -> 295
    //   265: aload 9
    ...
    //   277: invokevirtual 773	alpr:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   280: aload_0
    //   281: getfield 84	aleh:l	Ljava/util/List;
    //   284: aload 8
    ...
    //   310: monitorexit
    //   311: aload_0
    //   312: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   315: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   318: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   321: astore 7
    //   323: aload 7
    //   325: ifnull +105 -> 430
    //   328: aload 7
    //   330: invokevirtual 322	awbw:a	()Lawby;
    //   333: astore 6
    //   335: aload 6
    //   337: invokevirtual 326	awby:a	()V
    //   340: aload 5
    ...
    //   387: invokevirtual 336	aleh:a	(Lawbw;Lawbv;)Z
    //   390: pop
    //   391: goto -25 -> 366
    //   394: astore_1
    //   395: ldc_w 290
    ...
    //   425: aload 6
    //   427: invokevirtual 353	awby:b	()V
    //   430: aload_0
    //   431: invokespecial 779	aleh:f	()V
    //   434: return
    //   435: aload 6
    //   437: invokevirtual 362	awby:c	()V
    //   440: aload 6
    //   442: invokevirtual 353	awby:b	()V
    //   445: goto -15 -> 430
    //   448: astore_1
    //   449: aload 6
    //   451: invokevirtual 353	awby:b	()V
    //   454: aload_1
    //   455: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void a(Map<String, ApolloPreDownloadData> paramMap, boolean paramBoolean)
  {
    ...
    //   1: ifeq +10 -> 11
    //   4: aload_0
    //   5: getfield 96	aleh:jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   8: invokevirtual 360	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   11: aload_0
    //   12: getfield 96	aleh:jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   15: aload_1
    //   16: invokevirtual 787	java/util/concurrent/ConcurrentHashMap:putAll	(Ljava/util/Map;)V
    //   19: aload_0
    //   20: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   23: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   26: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   29: astore 4
    //   31: aload 4
    //   33: ifnull +80 -> 113
    //   36: aload 4
    //   38: invokevirtual 322	awbw:a	()Lawby;
    //   41: astore_3
    //   42: aload_3
    //   43: invokevirtual 326	awby:a	()V
    //   46: iload_2
    //   47: ifeq +12 -> 59
    //   50: aload 4
    //   52: ldc_w 789
    //   55: invokevirtual 644	awbw:b	(Ljava/lang/String;)Z
    //   58: pop
    //   59: aload_1
    ...
    //   91: invokevirtual 173	awbw:a	(Lawbv;)V
    //   94: goto -23 -> 71
    //   97: astore_1
    //   98: ldc_w 290
    //   101: iconst_1
    ...
    //   109: aload_3
    //   110: invokevirtual 353	awby:b	()V
    //   113: return
    //   114: aload_3
    //   115: invokevirtual 362	awby:c	()V
    //   118: aload_3
    //   119: invokevirtual 353	awby:b	()V
    //   122: return
    //   123: astore_1
    //   124: aload_3
    //   125: invokevirtual 353	awby:b	()V
    //   128: aload_1
    //   129: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    //   41	84	3	localawby	awby
    //   29	52	4	localawbw	awbw
    // Exception table:
    //   from	to	target	type
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (alee.c != null)
    {
      localApolloActionPackage.mIconUnselectedUrl = alee.c.optString("apImg");
      localApolloActionPackage.mIconSelectedUrl = alee.c.optString("apcImg");
      b(2);
      ArrayList localArrayList = new ArrayList();
  ...
  public void a(boolean paramBoolean, List<ApolloWhiteFaceID> paramList)
  {
    ...
    awby localawby = ((awbw)localObject).a();
    localawby.a();
    if (paramBoolean) {}
    try
    {
      paramList = ((awbw)localObject).a(ApolloWhiteFaceID.class);
      if (paramList != null)
      {
        if (QLog.isColorLevel()) {
    ...
    catch (Exception paramList)
    {
      ...
      if (paramList != null)
      {
        ...
        ((awbw)localObject).b(" DELETE FROM ApolloWhiteFaceID ");
        ...
        while (paramList.hasNext())
        {
          ...
          ((awbw)localObject).a(localApolloWhiteFaceID);
        }
      }
    }
    finally
  ...
  public boolean a(awbw paramawbw, awbv paramawbv)
  {
    boolean bool = false;
    if (paramawbw.a()) {
    ...
    QLog.d("ApolloDaoManager", 2, "updateEntity em closed e=" + paramawbv.getTableName());
    return false;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (((ArrayList)localObject1).size() > 0)
        {
          ...
          ((awbw)localObject4).b(" DELETE FROM ApolloGameRoamData ");
          if (this.jdField_f_of_type_JavaUtilList != null) {}
          synchronized (this.jdField_f_of_type_JavaUtilList)
          {
            ...
            for (;;)
            {
              if (m < n)
              {
                ...
                a((awbw)localObject4, localApolloGameRoamData2);
  ...
  public List<ApolloActionData> b()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        ??? = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
        if (??? != null) {
          return ((awbw)???).a(ApolloActionData.class, false, "isShow=?", new String[] { String.valueOf(0) }, null, null, null, null);
        }
      }
      return new ArrayList();
      label170:
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localawbw != null)
        {
          localList = localawbw.a(ApolloActionData.class);
          if (localList != null) {
            ??? = localawbw.a();
          }
        }
    ...
    try
    {
      ...
      while (m < localList.size())
      {
        ...
        if (localApolloActionData != null) {
          localawbw.b(localApolloActionData);
        }
        m += 1;
        continue;
  ...
  public void b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: ifnonnull +4 -> 8
    //   7: return
    //   8: aload_0
    //   9: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   12: ifnull +125 -> 137
    //   15: aload_0
    //   16: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   19: astore 7
    //   21: aload 7
    //   23: monitorenter
    //   24: iconst_1
    ...
    //   29: aload_0
    //   30: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   106: astore 5
    //   108: aload_0
    //   109: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   112: invokeinterface 356 1 0
    //   117: aload 5
    //   119: ifnull +15 -> 134
    //   122: aload_0
    //   123: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   126: aload 5
    ...
    //   136: monitorexit
    //   137: aload_0
    //   138: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   141: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   144: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   147: astore 6
    //   149: aload 6
    //   151: ifnull -144 -> 7
    //   154: aload 6
    //   156: invokevirtual 322	awbw:a	()Lawby;
    //   159: astore 5
    //   161: aload 5
    //   163: invokevirtual 326	awby:a	()V
    //   166: iconst_1
    //   167: iload_1
    //   168: if_icmpne +178 -> 346
    //   171: aload 6
    //   173: ldc_w 969
    //   176: invokevirtual 644	awbw:b	(Ljava/lang/String;)Z
    //   179: pop
    //   180: aload 5
    //   182: invokevirtual 362	awby:c	()V
    //   185: aload 5
    //   187: invokevirtual 353	awby:b	()V
    //   190: return
    //   191: iconst_2
    //   192: iload_1
    ...
    //   197: istore_2
    //   198: aload_0
    //   199: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   298: ifle -164 -> 134
    //   301: aload_0
    //   302: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   305: iload 4
    ...
    //   323: aload_0
    //   324: getfield 61	aleh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   327: iload 4
    ...
    //   351: aload 6
    //   353: ldc_w 973
    //   356: invokevirtual 644	awbw:b	(Ljava/lang/String;)Z
    //   359: pop
    //   360: goto -180 -> 180
    //   363: astore 6
    //   365: aload 6
    ...
    //   370: aload 5
    //   372: invokevirtual 353	awby:b	()V
    //   375: return
    //   376: astore 6
    //   378: aload 5
    //   380: invokevirtual 353	awby:b	()V
    //   383: aload 6
    //   385: athrow
    //   386: aconst_null
    //   387: astore 5
  ...
  /* Error */
  public void b(awbw paramawbw, List<ApolloGameRankData> paramList)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +134 -> 135
    ...
    //   14: ifle +121 -> 135
    //   17: aload_0
    //   18: getfield 92	aleh:k	Ljava/util/List;
    //   21: ifnull +114 -> 135
    //   24: aload_0
    //   25: getfield 92	aleh:k	Ljava/util/List;
    //   28: astore_3
    //   29: aload_3
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 92	aleh:k	Ljava/util/List;
    //   35: aload_2
    //   36: invokeinterface 273 2 0
    //   41: pop
    //   42: aload_0
    //   43: getfield 92	aleh:k	Ljava/util/List;
    //   46: aload_2
    ...
    //   81: aload_1
    //   82: aload_3
    //   83: invokevirtual 650	awbw:b	(Lawbv;)V
  ...
  public void b(AioPushData paramAioPushData)
  {
    ...
    try
    {
      ...
      boolean bool = ((awbw)localObject2).a(paramAioPushData);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaUtilList)
      {
        ...
        else
        {
          ...
          ((awbw)???).b(paramApolloFavActionData);
          return;
        }
        m -= 1;
      }
  ...
  public void b(ArrayList<ApolloGameRoamData> paramArrayList)
  {
    ...
    //   68: aload_0
    //   69: getfield 69	aleh:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   72: ifnull +29 -> 101
    //   75: aload_0
    //   76: getfield 69	aleh:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   79: astore_2
    //   80: aload_2
    //   81: monitorenter
    //   82: aload_0
    //   83: getfield 69	aleh:jdField_f_of_type_JavaUtilList	Ljava/util/List;
    //   86: iconst_0
    //   87: aload_1
    ...
    //   94: aload_0
    //   95: aload_1
    //   96: invokevirtual 925	aleh:g	(Ljava/util/List;)V
    //   99: aload_2
    //   100: monitorexit
    //   101: aload_0
    //   102: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   105: ifnull -68 -> 37
    //   108: aload_0
    //   109: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   112: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   115: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   118: astore_3
    //   119: aload_3
    //   120: ifnull -83 -> 37
    //   123: aload_3
    //   124: invokevirtual 322	awbw:a	()Lawby;
    //   127: astore_2
    //   128: aload_2
    //   129: invokevirtual 326	awby:a	()V
    ...
    //   170: aload_3
    //   171: aload 5
    //   173: invokevirtual 336	aleh:a	(Lawbw;Lawbv;)Z
    //   176: pop
    ...
    //   221: aload_2
    //   222: invokevirtual 353	awby:b	()V
    //   225: return
    //   226: astore_1
    //   227: aload_2
    //   228: monitorexit
    ...
    //   260: aload_2
    //   261: invokevirtual 362	awby:c	()V
    //   264: aload_2
    //   265: invokevirtual 353	awby:b	()V
    //   268: return
    //   269: astore_1
    //   270: aload_2
    //   271: invokevirtual 353	awby:b	()V
    //   274: aload_1
    //   275: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void b(List<ApolloActionData> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          a(localawbw, (awbv)paramList.get(m));
          m += 1;
          continue;
          paramList = finally;
          throw paramList;
  ...
  public ApolloActionData c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        ??? = ((awbw)???).a(ApolloActionData.class, false, "actionId=?", new String[] { String.valueOf(paramInt) }, null, null, null, null);
        if ((??? == null) || (((List)???).size() <= 0)) {
          continue;
        }
  ...
  public List<ApolloActionPackage> c(int paramInt)
  {
    ...
    Object localObject1 = ((awbw)localObject2).a(ApolloActionPackage.class, false, "sessionType=? or sessionType=?", new String[] { "0", localObject1 }, null, null, null, null);
    h((List)localObject1);
    return localObject1;
  }
  ...
  /* Error */
  public void c(awbw paramawbw, List<ApolloGameRankData> paramList)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +124 -> 125
    ...
    //   70: aload_1
    //   71: aload_3
    //   72: invokevirtual 177	awbw:b	(Lawbv;)Z
    //   75: pop
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (paramList.hasNext())
        {
          ...
          a(localawbw, localApolloActionPackage);
  ...
  public List<ApolloFavActionData> d()
  {
    ...
    return localawbw.a(ApolloFavActionData.class);
  }
  ...
  public List<ApolloActionData> d(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject5 = ((awbw)localObject5).a(ApolloActionPackageData.class, false, "packageId=?", new String[] { paramInt + "" }, null, null, null, null);
        if (QLog.isColorLevel()) {
          if (localObject5 != null) {
            break label283;
          }
        ...
        if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (m == 0)
          {
            ...
            {
              this.jdField_b_of_type_Boolean = false;
              ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(false, "getActionByPackageId action not exit", 1);
            }
          }
          label453:
  ...
  public void d()
  {
    ...
    {
      ((awby)???).a();
      localawbw.b(" DELETE FROM ApolloActionPackageData ");
      ((awby)???).c();
      return;
    }
    catch (Exception localException)
  ...
  public void d(List<ApolloActionPackageData> paramList)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 63	aleh:jdField_c_of_type_JavaUtilList	Ljava/util/List;
    //   18: ifnull +23 -> 41
    //   21: aload_0
    //   22: getfield 63	aleh:jdField_c_of_type_JavaUtilList	Ljava/util/List;
    //   25: astore_2
    //   26: aload_2
    //   27: monitorenter
    //   28: aload_0
    //   29: getfield 63	aleh:jdField_c_of_type_JavaUtilList	Ljava/util/List;
    //   32: aload_1
    ...
    //   40: monitorexit
    //   41: aload_0
    //   42: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   45: ifnull -32 -> 13
    //   48: aload_0
    //   49: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   52: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   55: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   58: astore_3
    //   59: aload_3
    //   60: ifnull -47 -> 13
    //   63: aload_3
    //   64: invokevirtual 322	awbw:a	()Lawby;
    //   67: astore_2
    //   68: aload_2
    //   69: invokevirtual 326	awby:a	()V
    ...
    //   112: aload_3
    //   113: aload 5
    //   115: invokevirtual 336	aleh:a	(Lawbw;Lawbv;)Z
    //   118: pop
    ...
    //   204: aload_2
    //   205: invokevirtual 353	awby:b	()V
    //   208: return
    //   209: astore_1
    //   210: aload_2
    //   211: monitorexit
    ...
    //   243: aload_2
    //   244: invokevirtual 362	awby:c	()V
    //   247: aload_2
    //   248: invokevirtual 353	awby:b	()V
    //   251: return
    //   252: astore_1
    //   253: aload_2
    //   254: invokevirtual 353	awby:b	()V
  ...
  public List<ApolloActionPackageData> e(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      awbw localawbw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
      if (localawbw != null) {
        localList = localawbw.a(ApolloActionPackageData.class, false, "packageId=?", new String[] { paramInt + "" }, null, null, null, null);
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.h)
      {
        ...
        if (localawbw != null)
        {
          localList = localawbw.a(ApolloObtainedActionData.class);
          if (localList != null) {
            ??? = localawbw.a();
          }
        }
    ...
    try
    {
      ...
      while (m < localList.size())
      {
        ...
        if (localApolloObtainedActionData != null) {
          localawbw.b(localApolloObtainedActionData);
        }
        m += 1;
        continue;
        localObject2 = finally;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          ((awbw)localObject2).b(" DELETE FROM ApolloGameData WHERE gameId = " + localApolloGameData.gameId);
      ...
      catch (Exception paramList)
      {
        ...
        if (paramList.hasNext())
        {
          ...
          a((awbw)localObject2, (awbv)localObject3);
  ...
  public List<ApolloGameData> f()
  {
    ...
    return ((awbw)???).a(ApolloGameData.class);
  }
  ...
  public void f(List<ApolloFavActionData> paramList)
  {
    ...
    //   7: return
    //   8: aload_0
    //   9: getfield 65	aleh:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   12: ifnull +90 -> 102
    //   15: aload_0
    //   16: getfield 65	aleh:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   19: astore 5
    //   21: aload 5
    //   23: monitorenter
    //   24: iconst_0
    ...
    //   33: if_icmpge +66 -> 99
    //   36: aload_0
    //   37: getfield 65	aleh:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   49: iflt +163 -> 212
    //   52: aload_0
    //   53: getfield 65	aleh:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   56: iload_3
    ...
    //   82: ifne +123 -> 205
    //   85: aload_0
    //   86: getfield 65	aleh:jdField_d_of_type_JavaUtilList	Ljava/util/List;
    //   89: iload_3
    ...
    //   101: monitorexit
    //   102: aload_0
    //   103: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   106: ifnull -99 -> 7
    //   109: aload_0
    //   110: getfield 113	aleh:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   113: invokevirtual 146	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   116: invokevirtual 152	awbx:createEntityManager	()Lawbw;
    //   119: astore 6
    //   121: aload 6
    //   123: invokevirtual 322	awbw:a	()Lawby;
    //   126: astore 5
    //   128: aload 5
    //   130: invokevirtual 326	awby:a	()V
    //   133: iload 4
    //   135: istore_2
    //   136: iload_2
    //   137: aload_1
    ...
    //   155: checkcast 883	awbv
    //   158: invokevirtual 177	awbw:b	(Lawbv;)Z
    //   161: pop
    //   162: iload_2
    //   163: iconst_1
    //   164: iadd
    ...
    //   174: athrow
    //   175: aload 5
    //   177: invokevirtual 362	awby:c	()V
    //   180: aload 5
    //   182: invokevirtual 353	awby:b	()V
    //   185: return
    //   186: astore_1
    //   187: aload_1
    //   188: invokevirtual 647	java/lang/Exception:printStackTrace	()V
    //   191: aload 5
    //   193: invokevirtual 353	awby:b	()V
    //   196: return
    //   197: astore_1
    //   198: aload 5
    //   200: invokevirtual 353	awby:b	()V
    //   203: aload_1
    //   204: athrow
    //   205: iload_3
    //   206: iconst_1
  ...
  public List<ApolloGameRoamData> g()
  {
    ...
    do
    {
      do
      {
        ...
        localObject3 = ((awbw)localObject3).a(ApolloGameRoamData.class);
        ??? = localObject3;
  ...
  public List<ApolloGameData> h()
  {
    ...
    if (((Iterator)localObject).hasNext())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localApolloGameData != null) && (localApolloGameRoamData != null) && (localApolloGameData.gameId == localApolloGameRoamData.gameId) && (localApolloGameData.isShow != 0) && (localApolloGameData.gameId != 1) && (localApolloGameData.gameId != 2) && (!localApolloGameData.isGameApp) && (alee.a("8.3.3", localApolloGameData.minVer, localApolloGameData.maxVer)))
        {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (m != 0) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        ((akje)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).e();
  ...
  public List<ApolloActionPush> i()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      if (localawbw != null)
      {
        List localList = localawbw.a(ApolloActionPush.class);
        ??? = localList;
        if (this.jdField_g_of_type_JavaUtilList != null)
        {
          ??? = localList;
