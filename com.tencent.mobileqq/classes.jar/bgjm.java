...
public class bgjm
{
  ...
  {
    if (bgte.a().a() != null) {}
    for (String str = bgte.a().a(); (this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelApkgBaseInfo == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelApkgBaseInfo.appId)); str = "") {
  ...
  private static void d()
  {
    ...
    //   60: pop
    //   61: iconst_1
    //   62: putstatic 164	bgjm:b	Z
    //   65: goto -54 -> 11
    //   68: astore_1
    //   69: getstatic 19	bgjm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   72: ldc 178
    //   74: aload_1
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      while (i >= 0)
      {
        ...
        {
          bgkv.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(i), false);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          if (paramBoolean) {
            bgtf.a(new WeakReference(paramActivity), bgte.a().a(), paramMiniAppInfo);
          }
          return false;
          i = 2;
        }
  ...
  public String d(String paramString)
  {
    ...
    if (new File(str).exists())
    {
      ...
      if (bgkv.b(str, new File(a(1), paramString).getAbsolutePath())) {
  ...
  public String h(String paramString)
  {
    ...
    //   17: aload_0
    //   18: iconst_0
    //   19: invokespecial 102	bgjm:a	(I)Ljava/lang/String;
    ...
    //   46: aload_0
    //   47: aload 4
    //   49: invokestatic 340	bgjm:a	(Ljava/io/File;)Ljava/lang/String;
    //   52: invokevirtual 336	bgjm:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   145: aload 4
    //   147: astore 5
    //   149: getstatic 19	bgjm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   152: ldc_w 372
    //   155: aload 7
