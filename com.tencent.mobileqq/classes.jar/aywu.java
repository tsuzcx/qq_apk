  ...
  extends Handler
{
  ...
  public aywu(PublishHomeWorkFragment paramPublishHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
  ...
  void a()
  {
    ...
    localObject = localPublishHomeWorkFragment.getString(2131631976, new Object[] { Integer.valueOf(i), Integer.valueOf(j), localPublishHomeWorkFragment.jdField_a_of_type_JavaLangString }).trim();
    String str1 = localPublishHomeWorkFragment.getString(2131631976, new Object[] { Integer.valueOf(i), Integer.valueOf(j), "" }).trim();
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      case 3: 
        ...
        localPublishHomeWorkFragment.jdField_a_of_type_Begr.c(false);
        return;
      case 515: 
      ...
      case 102: 
        ...
        if (i < 1000)
        {
          bbmy.a(localPublishHomeWorkFragment.getActivity(), ajjy.a(2131643048), 0).a();
          localPublishHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCommonRecordSoundPanel.b();
          return;
        }
        if (!badq.d(localPublishHomeWorkFragment.getActivity()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("PublishHomeWorkFragment", 2, "no network toast");
          }
          bbmy.a(localPublishHomeWorkFragment.getActivity(), 2131631771, 0).a();
          localPublishHomeWorkFragment.f = false;
          localPublishHomeWorkFragment.l();
          return;
        }
        ...
        {
          paramMessage = new ayzz(paramMessage, null, i / 1000, (int)l, localPublishHomeWorkFragment.b);
