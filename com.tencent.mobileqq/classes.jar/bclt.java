...
public class bclt
{
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          paramQQAppInterface = localawgf.a(TroopAIONotifyItem.class, false, "troopUin=?", new String[] { paramString }, null, null, null, null);
          localawgf.a();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localamdu.e(Long.valueOf(paramString).longValue());
      bcpa.a(paramQQAppInterface, paramString, 1102858908);
      ChatActivityUtils.a(paramQQAppInterface, paramString, Integer.valueOf(0));
      return;
    }
    ThreadManager.post(new TroopAioNotifyManager.1(paramQQAppInterface, paramString, localamdu), 8, null, true);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, List<TroopAIONotifyItem> paramList)
  {
    ...
    //   21: return
    //   22: aload_0
    //   23: invokevirtual 22	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawgg;
    //   26: invokevirtual 28	awgg:createEntityManager	()Lawgf;
    //   29: astore_0
    //   30: iconst_0
    //   31: istore_2
    //   32: iload_2
    ...
    //   45: checkcast 239	awge
    //   48: invokevirtual 241	awgf:b	(Lawge;)Z
    //   51: pop
    //   52: iload_2
    //   53: iconst_1
    //   54: iadd
