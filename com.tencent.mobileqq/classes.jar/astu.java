  ...
  extends asti
{
  ...
  private asuv jdField_a_of_type_Asuv;
  ...
  public astu(asuv paramasuv, BaseFileAssistantActivity paramBaseFileAssistantActivity, Object paramObject, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, View.OnClickListener paramOnClickListener3, View.OnLongClickListener paramOnLongClickListener, View.OnClickListener paramOnClickListener4)
  {
    ...
    this.jdField_a_of_type_Asuv = paramasuv;
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    astw localastw = (astw)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = b(paramInt1, paramInt2 * 4 + i, paramBoolean, localastw.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new astw(null));
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (Object localObject1 = (WeiYunFileInfo)paramViewGroup;; localObject2 = null)
    {
      if (localObject1 == null)
      {
        ...
        if (this.jdField_a_of_type_Asuv.c()) {
          return null;
        }
        ...
        paramViewGroup.setOnClickListener(this.jdField_a_of_type_Asuv.a(paramView.jdField_a_of_type_AndroidWidgetTextView));
        paramViewGroup.setTag(paramView);
        if ((this.jdField_b_of_type_JavaUtilLinkedHashMap.size() == 0) && (!this.jdField_a_of_type_Asuv.a()))
        {
          paramViewGroup.setVisibility(8);
          if (!this.jdField_a_of_type_Asuv.b()) {
            break label295;
          }
      ...
      for (;;)
      {
        try
        {
          ...
          paramViewGroup = paramView;
          localObject3 = new asth();
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131368246));
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368263));
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368260));
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.jdField_c_of_type_AndroidViewView$OnClickListener);
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localObject3);
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_a_of_type_AndroidWidgetImageView.setTag(localObject3);
          paramViewGroup = paramView;
          ((asth)localObject3).jdField_a_of_type_Boolean = false;
          paramViewGroup = paramView;
        ...
        try
        {
          ...
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setDefaultImage(2130847826);
          ...
          if ((((WeiYunFileInfo)localObject1).h != null) && (((WeiYunFileInfo)localObject1).h.length() > 0) && (atwl.b(((WeiYunFileInfo)localObject1).h))) {
          ...
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692161) + ((WeiYunFileInfo)localObject1).c;
          if (!this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.f()) {
            continue;
          }
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
          if (!athc.a((WeiYunFileInfo)localObject1)) {
            continue;
          }
          localObject1 = (String)localObject3 + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692162);
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840485);
        ...
        return paramViewGroup;
        paramViewGroup = paramView;
        localObject3 = (asth)paramView.getTag();
        paramViewGroup = paramView;
        if (!((asth)localObject3).jdField_a_of_type_Boolean) {
          continue;
        }
        paramViewGroup = paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560858, null);
        ...
        paramViewGroup = (ViewGroup)localObject3;
        continue;
        localObject2 = (String)localObject3 + anni.a(2131708496);
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845690);
  ...
  public int getChildrenCount(int paramInt)
  {
    ...
    do
    {
      ...
      break;
      paramInt = j;
    } while (this.jdField_a_of_type_Asuv.c());
    return 1;
  }
