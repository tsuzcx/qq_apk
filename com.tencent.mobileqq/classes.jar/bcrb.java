  ...
  extends aauq
{
  ...
  public static ReqSummaryCard a(ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        localObject4 = new SSummaryCardQueryReq(1, Long.parseLong(paramToServiceMsg.getUin()), l2, "8.4.10", k, 109L);
        ...
        try
        {
          ...
          if ((l2 > 0L) || (bool))
          {
            ...
            if (((Iterator)localObject3).hasNext())
            {
              ...
              ((SummaryCardBusiEntry.comm)localObject8).qqver.set("8.4.10.4875");
              ((SummaryCardBusiEntry.comm)localObject8).build.set(i);
              Object localObject9;
              if ((((BusinessBuff)localObject7).a() == 17) || (((BusinessBuff)localObject7).a() == 19) || (((BusinessBuff)localObject7).a() == 18))
              {
              ...
              else
              {
                ...
                localObject9[0] = 40;
                PkgTools.DWord2Byte((byte[])localObject9, 1, i1);
                PkgTools.DWord2Byte((byte[])localObject9, 5, j);
                PkgTools.copyData((byte[])localObject9, 9, (byte[])localObject8, i1);
                j = localObject8.length + 9;
                if (((BusinessBuff)localObject7).a() == null) {
                  break label1050;
                }
                PkgTools.copyData((byte[])localObject9, j, ((BusinessBuff)localObject7).a(), ((BusinessBuff)localObject7).a().length);
  ...
  public static ArrayList<aiuk> a(ArrayList<byte[]> paramArrayList)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject2 = new aiuk();
            ((aiuk)localObject2).jdField_a_of_type_Int = n;
            ((aiuk)localObject2).jdField_b_of_type_Int = ((AccountSearchPb.search)localObject1).start.get();
            if (((AccountSearchPb.search)localObject1).end.get() != 1) {
              break label509;
            }
            bool = true;
            ((aiuk)localObject2).jdField_a_of_type_Boolean = bool;
            ((aiuk)localObject2).jdField_b_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).list.get();
            ((aiuk)localObject2).jdField_a_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).highlight.get();
            ((aiuk)localObject2).jdField_a_of_type_JavaLangString = ((AccountSearchPb.search)localObject1).article_more_url.get();
            ((aiuk)localObject2).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord = ((AccountSearchPb.hotwordrecord)((AccountSearchPb.search)localObject1).hotword_record.get());
            ((aiuk)localObject2).jdField_c_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).result_items.get();
            ((aiuk)localObject2).jdField_b_of_type_Boolean = ((AccountSearchPb.search)localObject1).bool_keyword_suicide.get();
            ((aiuk)localObject2).jdField_c_of_type_Boolean = ((AccountSearchPb.search)localObject1).bool_exact_search.get();
            if (((((aiuk)localObject2).jdField_b_of_type_JavaUtilList == null) || (((aiuk)localObject2).jdField_b_of_type_JavaUtilList.size() <= 0)) && ((((aiuk)localObject2).jdField_c_of_type_JavaUtilList == null) || (((aiuk)localObject2).jdField_c_of_type_JavaUtilList.size() <= 0)) && (!((aiuk)localObject2).jdField_b_of_type_Boolean)) {
              break;
            }
    ...
    for (int j = 1;; j = 2)
    {
      ((aiuk)localObject2).jdField_c_of_type_Int = j;
      break;
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.vClientVersion = "8.4.10".getBytes();
  ...
  private boolean f(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if ((localObject1 == null) || (((SosoInterface.SosoLbsInfo)localObject1).mLocation == null) || (((SosoInterface.SosoLbsInfo)localObject1).mLocation.mLat84 == 0.0D) || (((SosoInterface.SosoLbsInfo)localObject1).mLocation.mLon84 == 0.0D))
    {
      SosoInterface.reqRawLbsData(60000L, getClass().getSimpleName());
      localObject1 = SosoInterface.getRawSosoInfo();
    }
    for (;;)
    {
      if (localObject1 != null)
      {
        ...
        localReqUserInfo.stGps = new GPS((int)(((SosoInterface.SosoLbsInfo)localObject1).mLocation.mLat84 * 1000000.0D), (int)(((SosoInterface.SosoLbsInfo)localObject1).mLocation.mLon84 * 1000000.0D), -1, 0);
        ...
        {
          localObject1 = ((SosoInterface.SosoLbsInfo)localObject1).mWifis.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (SosoInterface.SosoWifi)((Iterator)localObject1).next();
            localReqUserInfo.vSOSOMac.add(new SOSO_Wifi(((SosoInterface.SosoWifi)localObject2).mMac, (short)((SosoInterface.SosoWifi)localObject2).mRssi));
          }
        }
  ...
  private Object i(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.vUserList != null) && (!paramFromServiceMsg.vUserList.isEmpty()))
    {
      ...
      while (i < paramFromServiceMsg.vUserList.size())
      {
        ...
        String str1 = anrz.a(paramToServiceMsg.dwCountry);
        String str2 = anrz.a(paramToServiceMsg.dwProvince);
        String str3 = anrz.a(paramToServiceMsg.dwCity);
        paramToServiceMsg.locDesc = ((anrz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER)).b(new String[] { str1, str2, str3, "0" });
        i += 1;
      }
    }
    return paramFromServiceMsg;
  ...
  private boolean l(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localSSummaryCardSetLabel.version = "8.4.10";
  ...
  private boolean m(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    try
    {
      ...
      localSSummaryCardLikeIt.version = "8.4.10";
      paramUniPacket.setServantName("SummaryCard");
      ...
      if (m == 3)
      {
        ...
        try
        {
          ...
          for (;;)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject3).qqver.set("8.4.10.4875");
  ...
  private boolean u(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    {
      localByteBuffer.putInt(anrz.a(localObject3[0]));
      localByteBuffer.putInt(anrz.a(localObject3[1]));
      localByteBuffer.putInt(anrz.a(localObject3[2]));
      localByteBuffer.putInt(anrz.a(localObject3[3]));
      localObject3 = ByteBuffer.allocate(16);
      if ((localObject2 == null) || (localObject2.length != 4)) {
        break label485;
      }
      ((ByteBuffer)localObject3).putInt(anrz.a(localObject2[0]));
      ((ByteBuffer)localObject3).putInt(anrz.a(localObject2[1]));
      ((ByteBuffer)localObject3).putInt(anrz.a(localObject2[2]));
      ((ByteBuffer)localObject3).putInt(anrz.a(localObject2[3]));
    }
    for (;;)
    {
      short s2 = (short)k;
