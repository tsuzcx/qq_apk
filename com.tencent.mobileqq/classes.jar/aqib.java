  ...
  implements Manager
{
  ...
  anwh jdField_a_of_type_Anwh = new aqie(this);
  private aqhr jdField_a_of_type_Aqhr;
  public aqhs a;
  private aqhu jdField_a_of_type_Aqhu = new aqid(this);
  private aqia jdField_a_of_type_Aqia = new aqic(this);
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  public Runnable a;
  public String a;
  public ArrayList<WeakReference<aonz>> a;
  public ConcurrentHashMap<String, DynamicAvatar> a;
  public volatile boolean a;
  public String b;
  public ArrayList<WeakReference<aonz>> b;
  public ArrayList<WeakReference<aonz>> c;
  public ArrayList<WeakReference<aonz>> d;
  ...
  public aqib(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Aqia, true);
    this.d = new ArrayList();
    this.c = new ArrayList();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.b = new ArrayList();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_Aqhs = new aqhs(paramAppInterface);
    ...
    a();
    jdField_a_of_type_Int = this.jdField_a_of_type_Aqhr.jdField_a_of_type_Int;
  ...
  private Setting a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 18)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof NearbyAppInterface)) {
        localObject1 = ((aope)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(216)).a(paramString);
      }
    }
    do
    {
  ...
  public static String a(aonz paramaonz, boolean paramBoolean)
  {
    if (paramaonz == null) {
      return "";
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramaonz.jdField_b_of_type_Int).append("_").append(paramaonz.jdField_c_of_type_Int).append("_").append(paramaonz.jdField_a_of_type_JavaLangString);
    if ((paramBoolean) || ((paramaonz.jdField_e_of_type_Boolean) && (!TextUtils.isEmpty(paramaonz.jdField_b_of_type_JavaLangString)))) {
      localStringBuilder.append("_").append(paramaonz.jdField_b_of_type_JavaLangString);
    }
    return localStringBuilder.toString();
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    synchronized (this.c)
    {
      ...
      if (j >= 0)
      {
        ...
        {
          aonz localaonz = (aonz)localWeakReference.get();
          if (localaonz == null) {
            this.c.remove(j);
          } else if (paramString1.equals(localaonz.jdField_d_of_type_JavaLangString)) {
            if (TextUtils.isEmpty(paramString2))
            {
              localaonz.jdField_a_of_type_ComTencentImageURLDrawable = null;
              localaonz.a();
              this.c.remove(j);
            }
            else
            {
              localaonz.jdField_b_of_type_JavaLangString = paramString2;
              localaonz.jdField_c_of_type_JavaLangString = paramString3;
              if ((localaonz.jdField_a_of_type_MqqUtilWeakReference == null) || (localaonz.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (!paramString2.equals(((DynamicAvatarView)localaonz.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString))) {
                break label225;
              }
  ...
  public aqhr a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "getConfig DynamicAvatarConfig|" + this.jdField_a_of_type_Aqhr);
    }
    return this.jdField_a_of_type_Aqhr;
  }
  
  public aqhs a()
  {
    return this.jdField_a_of_type_Aqhs;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aqhr = new aqhr();
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "DynamicAvatarConfig|init config:" + this.jdField_a_of_type_Aqhr + ",costTime:" + (System.currentTimeMillis() - l));
    }
  }
  ...
  public void a(aonz paramaonz)
  {
    ...
    synchronized (this.d)
    {
      this.d.remove(paramaonz.jdField_b_of_type_MqqUtilWeakReference);
    }
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaonz.jdField_b_of_type_MqqUtilWeakReference);
      this.b.remove(paramaonz.jdField_b_of_type_MqqUtilWeakReference);
      synchronized (this.c)
      {
        this.c.remove(paramaonz.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
      paramaonz = finally;
      throw paramaonz;
  ...
  public void a(aonz paramaonz, boolean paramBoolean)
  {
    if (paramaonz == null) {
      return;
    }
    if (paramBoolean)
    {
      String str = a(paramaonz, false);
      ArrayList localArrayList2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramaonz.jdField_e_of_type_Int);
      ArrayList localArrayList1 = localArrayList2;
      if (localArrayList2 == null)
      {
        localArrayList1 = new ArrayList();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramaonz.jdField_e_of_type_Int, localArrayList1);
      }
      localArrayList1.add(str);
      localArrayList1.add(a(paramaonz, true));
      if ((paramaonz.jdField_e_of_type_Int == 1) || (paramaonz.jdField_e_of_type_Int == 0)) {
        ThreadManager.post(new DynamicAvatarManager.6(this, paramaonz, System.currentTimeMillis()), 5, null, true);
      }
      if (paramaonz.jdField_a_of_type_MqqUtilWeakReference.get() != null) {
        ((DynamicAvatarView)paramaonz.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString = "";
      }
    }
    ThreadManager.postImmediately(new DynamicAvatarManager.7(this, paramaonz), null, true);
  }
  
  public void a(aonz paramaonz, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((this.c.size() < jdField_a_of_type_Int) || (paramBoolean1))
    {
      ??? = paramaonz.jdField_d_of_type_JavaLangString;
      synchronized (this.c)
      {
        this.c.add(paramaonz.jdField_b_of_type_MqqUtilWeakReference);
        if (paramBoolean1) {}
      }
      for (;;)
      {
        ...
        {
          this.d.remove(paramaonz.jdField_b_of_type_MqqUtilWeakReference);
          ??? = new DynamicAvatarManager.3(this, paramaonz, (String)???);
          if (!paramBoolean2)
          {
            l1 = 0L;
            long l2 = l1;
        ...
        if (paramaonz.jdField_e_of_type_Int == 0) {
          l1 = 1500L;
        } else {
          l1 = 400L;
        }
    ...
    synchronized (this.d)
    {
      this.d.add(paramaonz.jdField_b_of_type_MqqUtilWeakReference);
      return;
    }
  }
  
  public void a(aqhv paramaqhv)
  {
    if (paramaqhv == null) {}
    while (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if ((paramaqhv == null) || (paramaqhv.jdField_a_of_type_JavaUtilArrayList == null) || (paramaqhv.jdField_a_of_type_JavaUtilArrayList.isEmpty())) {
            continue;
          }
          paramaqhv = paramaqhv.jdField_a_of_type_JavaUtilArrayList.iterator();
          if (!paramaqhv.hasNext()) {
            continue;
          }
          localObject1 = DynamicAvatar.convertFrom((aqhw)paramaqhv.next());
          if (localObject1 == null) {
            continue;
          }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString.basicSmallUrl)) {
        localObject = aqhs.a(paramString.basicSmallUrl);
      }
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString.basicMiddleUrl)) {
          localObject = aqhs.a(paramString.basicMiddleUrl);
        }
      }
      catch (Exception localException1)
      {
        try
        {
          do
          {
            ...
            paramString = aqhs.a(paramString.basicBigUrl);
            try
            {
  ...
  {
    if ((paramBoolean) && (this.jdField_a_of_type_Aqhr != null) && (this.jdField_a_of_type_Aqhr.jdField_a_of_type_Boolean)) {}
    synchronized (this.jdField_a_of_type_Aqhr)
    {
      this.jdField_a_of_type_Aqhr.a();
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "---onDpcPullFinished---|mDynamicAvatarConfig:" + this.jdField_a_of_type_Aqhr);
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "isPlayDynamicAvatar|source:" + paramInt + ",isPlay:" + bool1 + "\n" + this.jdField_a_of_type_Aqhr);
      }
      return bool1;
      bool1 = this.jdField_a_of_type_Aqhr.jdField_c_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Aqhr.d;
      continue;
      bool1 = this.jdField_a_of_type_Aqhr.f;
      continue;
      bool1 = this.jdField_a_of_type_Aqhr.g;
      continue;
      bool1 = this.jdField_a_of_type_Aqhr.jdField_e_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Aqhr.h;
      continue;
      bool1 = true;
      continue;
      bool1 = this.jdField_a_of_type_Aqhr.f;
  ...
  public boolean a(aonz paramaonz)
  {
    ...
    if (!paramaonz.f)
    {
      localObject1 = a(paramaonz, false);
      localObject2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramaonz.jdField_e_of_type_Int);
    ...
    File localFile = aqhs.a(paramaonz.jdField_b_of_type_JavaLangString);
    if (paramaonz.jdField_d_of_type_Int == 640) {}
    for (;;)
    {
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mRequestWidth = i;
      localURLDrawableOptions.mRequestHeight = i;
      localObject2 = paramaonz.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      localObject1 = localObject2;
      if ((localObject2 instanceof aoot)) {
        localObject1 = ((aoot)localObject2).a();
      }
      ...
      ((VideoDrawable.VideoDrawableParams)localObject1).mRequestedFPS = this.jdField_a_of_type_Aqhr.jdField_c_of_type_Int;
      int j = i;
      if (bdgb.b()) {
        j = bhmq.a(i);
      }
      ...
      boolean bool2 = paramaonz.a(URLDrawable.getDrawable(localFile, localURLDrawableOptions));
      bool1 = bool2;
      if (!bool2) {
        break;
      }
      ...
      bool1 = bool2;
      if (aonz.jdField_a_of_type_ArrayOfInt.length <= paramaonz.jdField_e_of_type_Int) {
        break;
      }
      bool1 = bool2;
      ...
      aqin.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, "0X800711C", aonz.jdField_a_of_type_ArrayOfInt[paramaonz.jdField_e_of_type_Int]);
      return bool2;
      if (paramaonz.jdField_d_of_type_Int == 200) {
        i = 200;
      } else {
        i = 100;
      }
  ...
  public void b(aonz paramaonz)
  {
    ...
    do
    {
      ...
      ??? = a(paramaonz, false);
      localArrayList = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramaonz.jdField_e_of_type_Int);
    ...
    a(paramaonz, true, true);
  }
  
  public void b(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (this.jdField_a_of_type_Aqhs == null) {
      return;
    }
    ...
    synchronized (this.d)
    {
      ...
      if (i >= 0)
      {
        ...
        if ((localWeakReference1 != null) && (localWeakReference1.get() != null)) {
          ((aonz)localWeakReference1.get()).a();
        } else {
          this.d.remove(i);
        }
      }
      ...
      synchronized (this.c)
      {
        ...
        if (m >= jdField_a_of_type_Int)
        {
          ...
          if (j >= k - i)
          {
            ...
            ((ArrayList)localObject2).add(((aonz)localWeakReference2.get()).jdField_b_of_type_JavaLangString);
            break label434;
          }
        }
        else
        ...
        if (this.jdField_a_of_type_Aqhs != null) {
          this.jdField_a_of_type_Aqhs.a((ArrayList)localObject2);
        }
      }
      synchronized (this.d)
      {
        ...
        while (i >= 0)
        {
          ...
          {
            a((aonz)((WeakReference)localObject2).get(), false, false);
            i -= 1;
            continue;
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Aqia);
    this.jdField_a_of_type_Aqhs.b();
    this.jdField_a_of_type_Aqhs = null;
    this.jdField_a_of_type_Aqia = null;
