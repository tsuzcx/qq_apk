...
public class lio
{
  ...
  public static List<lip> a()
  {
    lio locallio = a();
    if (locallio != null) {
      return locallio.jdField_a_of_type_JavaUtilList;
    }
    return null;
  }
  ...
  public static lio a()
  {
    if ((jdField_a_of_type_Lio == null) || (jdField_a_of_type_Lio.jdField_a_of_type_Boolean)) {
      jdField_a_of_type_Lio = b();
    }
    return jdField_a_of_type_Lio;
  }
  
  public static boolean a()
  {
    lio locallio = a();
    return (locallio != null) && (locallio.jdField_a_of_type_Int == 1);
  }
  ...
  private static lio b()
  {
          ...
          try
          {
            if (!TextUtils.isEmpty((CharSequence)localObject3))
            {
              ...
              if (k < localObject3.length)
              {
                ...
                i = j;
                m = arag.a(localObject4[0], 0);
                i = j;
                n = arag.a(localObject4[1], 0);
                label204:
                if ((m <= 0) || (n <= 0)) {
                  break label623;
                }
                i = j;
                localArrayList.add(new lip(n, m));
                break label623;
              }
            }
            i = j;
            k = arag.a(localObject1[2], 3);
            i = j;
            label249:
            if (localArrayList.size() == 0)
            {
              localArrayList.add(new lip(215, 4));
              localArrayList.add(new lip(150, 8));
            }
            localObject1 = new lio();
            ((lio)localObject1).jdField_a_of_type_Int = i;
            ((lio)localObject1).b = k;
            ((lio)localObject1).jdField_a_of_type_JavaUtilList = localArrayList;
            if ((str == null) || (str.isEmpty())) {
              bool = true;
            }
            ((lio)localObject1).jdField_a_of_type_Boolean = bool;
            return localObject1;
          }
    ...
    for (;;)
    {
      ...
      if (k < localObject2.length)
      {
        ...
        {
          i = j;
          m = arag.a(localObject3[0], 0);
          i = j;
          n = arag.a(localObject3[1], 0);
          if ((m <= 0) || (n <= 0)) {
            break label630;
          }
          i = j;
  ...
  public String toString()
  {
    ...
    {
      lip locallip = (lip)localIterator.next();
      if (locallip != null) {
        str = str + locallip.b + "_" + locallip.jdField_a_of_type_Int + "-";
      }
    }
