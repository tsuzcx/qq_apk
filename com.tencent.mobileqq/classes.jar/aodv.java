  ...
  implements mqq.observer.BusinessObserver
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new aodw(this, Looper.getMainLooper());
  public aody a;
  public aoea a;
  ...
  Queue<aodz> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  public boolean a;
  final int jdField_b_of_type_Int = 2;
  private Handler jdField_b_of_type_AndroidOsHandler = new aodx(this, Looper.getMainLooper());
  final int c = 3;
  
  public aodv(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (aodz)paramArrayOfByte.next();
      ...
      {
        localObject3 = (aodz)((Iterator)localObject2).next();
        if (((aodz)localObject3).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
      ...
      {
        localObject4 = (aodz)((Iterator)localObject3).next();
        if (((aodz)localObject4).jdField_a_of_type_JavaLangString.equals(paramArrayOfByte))
        {
  ...
  private boolean a(signature.SignatureResult paramSignatureResult)
  {
    ...
    this.jdField_a_of_type_Aody.jdField_b_of_type_Long = System.currentTimeMillis();
    if (paramSignatureResult.u32_timeout.has()) {
      this.jdField_a_of_type_Aody.jdField_a_of_type_Long = paramSignatureResult.u32_timeout.get();
    }
    if (paramSignatureResult.u32_check_result.has()) {
      this.jdField_a_of_type_Aody.jdField_a_of_type_Int = paramSignatureResult.u32_check_result.get();
    }
    if (paramSignatureResult.str_title.has()) {
      this.jdField_a_of_type_Aody.jdField_c_of_type_JavaLangString = paramSignatureResult.str_title.get();
    }
    if (paramSignatureResult.str_content.has()) {
      this.jdField_a_of_type_Aody.d = paramSignatureResult.str_content.get();
    }
    if (paramSignatureResult.str_left_button.has()) {
      this.jdField_a_of_type_Aody.e = paramSignatureResult.str_left_button.get();
    }
    if (paramSignatureResult.str_right_button.has()) {
      this.jdField_a_of_type_Aody.f = paramSignatureResult.str_right_button.get();
    }
    if (paramSignatureResult.str_url.has()) {
      this.jdField_a_of_type_Aody.g = paramSignatureResult.str_url.get();
    }
    this.jdField_a_of_type_Aody.b();
  ...
  public void b(String paramString, Context paramContext, Intent paramIntent)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Aoea = new aoea(this, paramString);
      this.jdField_a_of_type_Aody = new aody(this, paramString);
      if (Long.valueOf(System.currentTimeMillis()).longValue() >= this.jdField_a_of_type_Aody.jdField_b_of_type_Long + 86400000L) {
        break label452;
      }
      PackageInfo localPackageInfo = a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication(), this.jdField_a_of_type_Aoea.jdField_a_of_type_JavaLangString);
      ...
      if ((this.jdField_a_of_type_Aody.jdField_c_of_type_Long != l) || (!this.jdField_a_of_type_Aody.jdField_a_of_type_JavaLangString.equalsIgnoreCase(str))) {
        break label452;
      }
      if (this.jdField_a_of_type_Aody.jdField_a_of_type_Int == 2) {
        break;
      }
    ...
    paramContext.putString("dlg_title", this.jdField_a_of_type_Aody.jdField_c_of_type_JavaLangString);
    paramContext.putString("dlg_content", this.jdField_a_of_type_Aody.d);
    paramContext.putString("dlg_lbutton", this.jdField_a_of_type_Aody.e);
    paramContext.putString("dlg_rbutton", this.jdField_a_of_type_Aody.f);
    paramContext.putString("dlg_url", this.jdField_a_of_type_Aody.g);
    ...
    try
    {
      bdla.b(null, "P_CliOper", "Safe_StartAppCheck", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), "startAppByCheckValid", this.jdField_a_of_type_Aody.jdField_b_of_type_JavaLangString, 0, 0, "", "", "", "");
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        label452:
        this.jdField_a_of_type_Aoea.jdField_a_of_type_Long = Long.valueOf(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount()).longValue();
        this.jdField_a_of_type_Aoea.jdField_a_of_type_Int = 1;
        this.jdField_a_of_type_Aoea.jdField_a_of_type_JavaLangString = paramString;
        paramString = new aodz(this, paramString, paramContext, paramIntent);
        ...
        if (this.jdField_a_of_type_Aody.jdField_a_of_type_Long <= 0L) {
          break label595;
        }
        l = this.jdField_a_of_type_Aody.jdField_a_of_type_Long;
