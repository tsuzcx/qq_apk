...
public class aodv
{
  ...
  public aodv(String paramString, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Int = paramInt;
  }
  
  public static Drawable a(Context paramContext, aoeb paramaoeb)
  {
    Object localObject = paramaoeb.a;
    ...
    for (paramContext = paramContext.a("fromAIO", true);; paramContext = null)
    {
      ...
      do
      {
        ...
        localURL = aywm.a((MessageForPic)localObject, 1);
        ...
        localURL = advs.a((MessageForPic)localObject);
        localObject = URLDrawable.getDrawable(localURL, a(paramContext));
        paramaoeb.c = false;
        paramContext = (Context)localObject;
      } while (!QLog.isColorLevel());
      QLog.d("EmotionDataManager", 2, new Object[] { "init view,big pic not exist:", ayoi.a(localURL.toString()) });
      return localObject;
      return null;
    }
  }
  
  public static aobp a(MessageForMarketFace paramMessageForMarketFace)
  {
    return ((askf)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramMessageForMarketFace.mMarkFaceMessage);
  }
  ...
  {
    return ((askf)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramString);
  }
  ...
  private List<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localObject1 instanceof MessageForPic))
      {
        ...
        if ((!aezl.a((MessageForPic)localObject2)) && (advs.a((MessageForPic)localObject2))) {
        ...
        if (((MessageForMixedMsg)localObject1).msgElemList != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForPic))
            {
              ...
              ((MessageForPic)localObject2).parse();
              if (advs.a((MessageForPic)localObject2)) {
