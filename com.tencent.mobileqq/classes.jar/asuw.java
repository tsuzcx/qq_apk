...
public class asuw
{
  private static asuw jdField_a_of_type_Asuw;
  ...
  public apcq a;
  private asuv jdField_a_of_type_Asuv = new asuv();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected Runnable a;
  private ArrayList<asuy> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private double jdField_b_of_type_Double;
  private long jdField_b_of_type_Long = 1800000L;
  
  private asuw(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new EnterpriseQQManager.1(this);
    this.jdField_a_of_type_Apcq = new asux(this, 4, true, true, 0L, false, false, "EnterpriseQQManager");
    if (paramQQAppInterface != null) {
      a(paramQQAppInterface);
    }
  }
  
  public static asuw a(QQAppInterface paramQQAppInterface)
  {
    if (jdField_a_of_type_Asuw == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Asuw == null) {
        jdField_a_of_type_Asuw = new asuw(paramQQAppInterface);
      }
      return jdField_a_of_type_Asuw;
    }
  }
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, StructMsg.ButtonInfo paramButtonInfo)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("assignBackText", paramContext.getResources().getString(2131690559));
  ...
  public List<StructMsg.ButtonInfo> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (this.jdField_a_of_type_Asuv != null) {
      return this.jdField_a_of_type_Asuv.a(paramString);
    }
    return null;
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2)
  {
    ...
    {
      paramContext = (anwz)paramQQAppInterface.a(21);
  ...
  {
    if (this.jdField_a_of_type_Asuv == null) {
      this.jdField_a_of_type_Asuv = new asuv();
    }
    if (paramQQAppInterface != null)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Asuv.a(localEnterpriseQQMenuEntity.uin, localGetCRMMenuResponse.button_info.get(), localEnterpriseQQMenuEntity.seqno, localEnterpriseQQMenuEntity.savedDateTime);
        continue;
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StructMsg.GetCRMMenuResponse paramGetCRMMenuResponse)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Asuv.a(paramString) != paramInt) && (paramGetCRMMenuResponse != null))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Asuv.a(paramString, localList, paramInt, l);
          return;
    ...
    this.jdField_a_of_type_Asuv.a(paramString, l);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    if ((paramQQAppInterface != null) && (!TextUtils.isEmpty(paramString)))
    {
      long l = 0L;
      if (this.jdField_a_of_type_Asuv != null) {
        l = this.jdField_a_of_type_Asuv.a(paramString);
      }
      if ((paramBoolean) || ((!paramBoolean) && (System.currentTimeMillis() - l > 43200000L)))
      {
        paramQQAppInterface = (anwz)paramQQAppInterface.a(21);
        if (paramQQAppInterface != null) {
