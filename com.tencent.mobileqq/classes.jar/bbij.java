  ...
  implements ymm
{
  ...
  private void g(String paramString)
  {
    ...
    a();
    localObject = new bepp((Context)localObject, ((BaseActivity)localObject).getTitleBarHeight());
    ((bepp)localObject).a(paramString);
    ((bepp)localObject).setCancelable(false);
    ((bepp)localObject).setOnDismissListener(new bbil(this));
    this.jdField_a_of_type_Bepp = ((bepp)localObject);
  ...
  private void h(String paramString)
  {
    ...
    {
      QQToast.a((Context)localObject, 2131694764, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131721132));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131693786));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131694951));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131694952));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131696589));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131721137));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  {
    c();
    bhpy localbhpy = (bhpy)bhql.a(this.mRuntime.a(), null);
    localbhpy.a(2131721130);
    localbhpy.a(2131721131, 3);
    localbhpy.c(2131690648);
    localbhpy.setOnDismissListener(new bbim(this));
    localbhpy.a(new bbin(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!bdee.d(localBaseActivity)) {
      QQToast.a(localBaseActivity, 2131694764, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  public void d(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	bbij:mRuntime	Lbecq;
    //   4: invokevirtual 70	becq:a	()Landroid/app/Activity;
    //   7: astore_3
    ...
    catch (JSONException paramString)
    {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          bbii.a(localActivity, localActivity.getIntent().getExtras(), paramString);
        }
        return;
      }
      catch (JSONException paramString) {}
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString3 = this.jdField_a_of_type_Ymk;
      if (j == -1) {}
      ...
      if (paramString3.equals("insertCreateGroupSuccessMsg")) {
        try
        {
          ...
          this.jdField_a_of_type_Ymk.a(paramJsBridgeListener, paramString1, i, paramString2, this);
        }
      ...
      {
        paramJsBridgeListener.a("8.3.3.4515");
        break label2264;
      }
      if (paramString3.equals("isNetworkConnected"))
      {
        paramJsBridgeListener.a(Boolean.valueOf(bfhb.d(bexd.a().a())));
        break label2264;
      }
    ...
    else
    {
      ...
      if ("updateTroopBindedPubAccount".equals(paramString3))
      {
        try
        {
          ...
          if (j > 0)
          {
            ...
            this.jdField_a_of_type_Ymk.a(l, paramString1);
          }
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("getLastSpeakMessage".equals(paramString3))
      {
        try
        {
          ...
          paramString2 = paramString2.optString("callback");
          this.jdField_a_of_type_Ymk.a(paramJsBridgeListener, paramString1, new bbik(this, paramString2));
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("notifyTroopEnterEffectStatus".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Ymk.a(i, j, k, paramString1);
      ...
      else if ("returnToTroopAIO".equals(paramString3))
      {
        ...
        SensorAPIJavaScript.returnToAio(this.jdField_a_of_type_Ymk, this.mRuntime.a(), paramJsBridgeListener, true);
        break label2264;
      }
      else
      {
        if ("notifyCreateTroops".equals(paramString3))
        {
          try
          {
            ...
            paramString2 = paramString2.optString("callback");
            this.jdField_a_of_type_Ymk.b(paramJsBridgeListener, paramString1, paramString2, this);
          }
          catch (JSONException paramJsBridgeListener)
          {
            if (!QLog.isColorLevel()) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramString2 != null) && (paramString2.length() > 0))
              {
                ...
                this.jdField_a_of_type_Ymk.a(paramString3);
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      if (bool) {
        QQToast.a((Context)localObject2, 2131721129, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        QQToast.a((Context)localObject2, 2131721134, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131721142);
    }
    for (;;)
    {
      ...
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131721128);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131721133);
      }
    }
  }
