...
public class bohp
  extends bohl<bogv>
  implements bohd, bohe, bohf, zkm
{
  public akte a;
  private List<bohw> a;
  
  public bohp(bogv parambogv)
  {
    super(parambogv);
    ...
    this.a = new akte();
    this.jdField_a_of_type_Akte = ((akte)this.a);
  }
  
  private void a(boolean paramBoolean, int paramInt)
  {
    if (!paramBoolean) {
      this.jdField_a_of_type_JavaUtilList.add(new bohw(this, paramInt));
    }
  }
  ...
  {
    if (!boem.a()) {
      this.jdField_a_of_type_JavaUtilList.add(new bohw(this, -1));
    }
    for (;;)
    {
      TAVCut.initTAVCut(BaseApplicationImpl.context, FeatureManager.getResourceDir(), FeatureManager.getResourceDir(), new bohq(this));
      return;
  ...
  public Intent a(View paramView, int paramInt)
  {
    ...
    paramView.putExtra("PhotoConst.SHOW_MAGIC_USE_PASTER", this.jdField_a_of_type_Akte.e);
    paramView.putExtra("PhotoConst.editPathMap", akre.a(this.jdField_a_of_type_Akte.jdField_c_of_type_JavaUtilHashMap));
    paramView.putExtra("p_e_s_type", 6);
    paramView.putExtra("PasterConstants.paster_id", this.jdField_a_of_type_Akte.jdField_a_of_type_JavaLangString);
    paramView.putExtra("PasterConstants.paster_cate_id", this.jdField_a_of_type_Akte.jdField_b_of_type_JavaLangString);
    paramView.putExtra("PasterConstants.pasters_data", this.jdField_a_of_type_Akte.jdField_b_of_type_JavaUtilHashMap);
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size() > 0)) {
      bdll.b(null, "CliOper", "", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.myUin, "0X8005674", "0X8005674", 0, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size(), 0, "", "", "", "");
    }
    return paramView;
  }
      ...
      if (this.jdField_a_of_type_Akte.isSupportVideoCheckbox)
      {
        ...
        if (paramLocalMediaInfo != null)
        {
          ...
          if ("video".equals(paramLocalMediaInfo[0])) {
            str1 = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131694317, new Object[] { Integer.valueOf(i) });
          }
        }
      }
    }
  ...
  public List<LocalMediaInfo> a()
  {
    ...
    List localList = bhkd.getAlbumMedias(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName, i, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.filter, this.jdField_a_of_type_Akte.filterVideoDurationLimit);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    RecyclerView localRecyclerView = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
    bogq localbogq = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq;
    if ((paramInt1 >= 0) && (paramInt1 < localArrayList.size()) && (paramInt2 >= 0) && (paramInt2 < localArrayList.size()))
    {
      ...
      while (paramInt1 <= i)
      {
        Object localObject = localbogq.a(paramInt1);
        int j = localArrayList.indexOf(((LocalMediaInfo)localObject).path);
        if (j >= 0)
        {
          localObject = (bogs)localRecyclerView.getChildViewHolder(localRecyclerView.getChildAt(((LocalMediaInfo)localObject).position.intValue() - paramInt2));
          if ((localObject != null) && (((bogs)localObject).a != null)) {
            ((bogs)localObject).a.setCheckedNumber(j + 1 + a());
          }
        }
        paramInt1 += 1;
      }
      zkg.a().b(localArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.allMediaInfoHashMap);
    }
    ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).b(true);
  }
  ...
  public void a(Intent paramIntent)
  {
    ...
    k();
    l();
    this.jdField_a_of_type_Akte.k = paramIntent.getBooleanExtra("PhotoConst.IS_FROM_EDIT", false);
    akre.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramIntent, false, this.jdField_a_of_type_Akte.jdField_c_of_type_JavaUtilHashMap);
    this.jdField_a_of_type_Akte.jdField_a_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_PATHS_FROM_QZONEALBUM"));
    if (this.jdField_a_of_type_Akte.jdField_a_of_type_JavaUtilHashMap == null) {
      this.jdField_a_of_type_Akte.jdField_a_of_type_JavaUtilHashMap = new HashMap(1);
    }
    ...
    this.jdField_a_of_type_Akte.jdField_c_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.original_button", false);
    this.jdField_a_of_type_Akte.jdField_d_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.quality_count_tv", true);
    ...
    this.jdField_a_of_type_Akte.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.HANDLE_DEST_RESULT", false);
    this.jdField_a_of_type_Akte.f = paramIntent.getBooleanExtra("PhotoConst.IS_SINGLE_DERECTBACK_MODE", false);
    this.jdField_a_of_type_Akte.g = paramIntent.getBooleanExtra("PhotoConst.IS_SINGLE_NEED_EDIT", false);
    this.jdField_a_of_type_Akte.h = paramIntent.getBooleanExtra("PhotoConst.IS_CALL_IN_PLUGIN", false);
    this.jdField_a_of_type_Akte.jdField_a_of_type_Int = paramIntent.getIntExtra("uintype", -1);
    ...
    if (paramIntent.getBooleanExtra("PhotoConst.ALWAYS_SHOW_NUMBER_WHEN_ONLY_ONE_IMAGE", false)) {
      this.jdField_a_of_type_Akte.isSingleMode = false;
    }
    this.jdField_a_of_type_Akte.i = paramIntent.getBooleanExtra("PhotoConst.IS_FINISH_RESTART_INIT_ACTIVITY", false);
    this.jdField_a_of_type_Akte.jdField_c_of_type_JavaLangString = paramIntent.getStringExtra("uinname");
    this.jdField_a_of_type_Akte.jdField_d_of_type_JavaLangString = paramIntent.getStringExtra("uin");
    ...
    this.jdField_a_of_type_Akte.jdField_b_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_PREVIEW_VIDEO", true);
    ...
    try
    {
      this.jdField_a_of_type_Akte.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = ((SessionInfo)paramIntent.getParcelableExtra("session_info"));
      if (!this.jdField_a_of_type_Akte.e) {
        this.jdField_a_of_type_Akte.e = paramIntent.getBooleanExtra("PhotoConst.SHOW_MAGIC_USE_PASTER", false);
      }
      if (this.jdField_a_of_type_Akte.e)
      {
        this.jdField_a_of_type_Akte.jdField_b_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PasterConstants.pasters_data"));
        this.jdField_a_of_type_Akte.jdField_a_of_type_JavaLangString = paramIntent.getStringExtra("PasterConstants.paster_id");
        this.jdField_a_of_type_Akte.jdField_b_of_type_JavaLangString = paramIntent.getStringExtra("PasterConstants.paster_cate_id");
      }
      this.jdField_a_of_type_Akte.jdField_a_of_type_Long = paramIntent.getLongExtra("PhotoConst.PHOTOLIST_KEY_MAX_MEDIA_SIZE", -1L);
      return;
    }
  ...
  {
    int i2 = PhotoUtils.b(this.jdField_a_of_type_Akte.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    ...
    while (i1 < paramArrayList.size())
    {
      ...
      {
        int n;
        if (((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)localObject2) == 1)
        {
          localObject2 = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)localObject2);
          n = j;
          m = i;
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        localObject1 = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131717873);
        ...
        if (bjhk.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 4, new bohr(this, paramIntent))) {
          bhlq.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 232, null, (String)localObject1, new bohs(this, paramIntent), new boht(this)).show();
        }
        if (QLog.isColorLevel()) {
      ...
      if (paramBoolean) {
        PhotoUtils.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramIntent, paramArrayList, this.jdField_a_of_type_Akte.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.currentQualityType, false);
      }
      for (;;)
      {
        bdll.b(null, "CliOper", "", "", "0X8009AB0", "0X8009AB0", i2, 0, (String)localObject2, (String)localObject3, "", "");
        return;
        PhotoUtils.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), paramIntent, paramArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.currentQualityType, this.jdField_a_of_type_Akte.jdField_a_of_type_Boolean);
      }
    }
  }
  ...
  public void a(Message paramMessage)
  {
    ...
    ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).f();
    ArrayList localArrayList = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList;
    String str;
    if ((paramMessage.obj instanceof String))
    {
      ...
      QQToast.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), String.format(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131694317), new Object[] { Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.maxSelectNum) }), 0).a();
    }
    for (;;)
    {
      ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).b(str);
      return;
      label168:
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.add(str);
      ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).j();
    }
  }
  ...
  public void a(View paramView, int paramInt, CheckBox paramCheckBox)
  {
    ...
    } while (l - this.jdField_a_of_type_Akte.lastTimeShowToast < 1000L);
    QQToast.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), a(localLocalMediaInfo), 0).b(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).d);
    paramCheckBox.setChecked(false);
    this.jdField_a_of_type_Akte.lastTimeShowToast = l;
    return;
    Object localObject1;
    if ((this.jdField_a_of_type_Akte.jdField_a_of_type_Int == 9501) && (((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false)) && (i != 1))
    {
      localObject1 = paramView.iterator();
      for (l = 0L; ((Iterator)localObject1).hasNext(); l = bhmi.a((String)((Iterator)localObject1).next()) + l) {}
      if (bhmi.a(localLocalMediaInfo.path) + l > 52428800L)
      {
        QQToast.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), "选择图片总大小不能超过50M", 0).b(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).d);
        paramCheckBox.setChecked(false);
        return;
      }
    }
    if ((((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(localLocalMediaInfo)) && (bhmi.a(localLocalMediaInfo.path) > 3145728L))
    {
      QQToast.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), "图片文件过大", 0).b(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).d);
      paramCheckBox.setChecked(false);
      return;
    }
    boolean bool1;
    ...
    if (i == 1)
    {
      ...
      akte localakte;
      if ((this.jdField_a_of_type_Akte.isSupportVideoCheckbox) && (localObject2 != null) && ("video".equals(localObject2[0])))
      {
        localakte = this.jdField_a_of_type_Akte;
        localakte.videoSelectedCnt += 1;
        if (this.jdField_a_of_type_Akte.videoSelectedCnt == 1) {
          this.jdField_a_of_type_Akte.selectedVideoInfo = localLocalMediaInfo;
        }
      }
      if ((!TextUtils.isEmpty(localLocalMediaInfo.mMimeType)) && ("image/gif".equals(localLocalMediaInfo.mMimeType)))
      {
        localakte = this.jdField_a_of_type_Akte;
        localakte.gifSelectedCount += 1;
      }
      ...
      if ((localObject1 != null) && (localObject2 != null) && (localObject2[0] != null) && (!"video".equals(localObject2[0]))) {
        ((PresendPicMgr)localObject1).a(paramCheckBox, 1052, ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getIntExtra("entrance", 0));
      }
      akrx.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent(), "param_totalSelNum");
      paramView = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
    ...
    for (;;)
    {
      paramView.put(paramCheckBox, Integer.valueOf(((GridLayoutManager)((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition()));
      ...
      ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt, bool1);
      paramView = (bogv)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (!bool1) {}
      for (bool1 = bool2;; bool1 = false)
      {
        ...
        if ((this.jdField_a_of_type_Akte.isSupportVideoCheckbox) && (localObject2 != null) && ("video".equals(localObject2[0])))
        {
          localObject2 = this.jdField_a_of_type_Akte;
        ...
        akrx.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent(), "param_cancelSelNum");
        paramView = (HashMap)bhkd.sSelectItemPosMap.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId);
        if (paramView != null) {
          paramView.remove(paramCheckBox);
        }
        paramView = bhkd.sSelectItemAlbum;
  ...
  {
    if (akre.a(paramLocalMediaInfo.path, this.jdField_a_of_type_Akte.jdField_c_of_type_JavaUtilHashMap))
    {
      if (Build.VERSION.SDK_INT >= 21) {
        parambogs.e.setImageDrawable(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getDrawable(2130839361));
      }
      for (;;)
      {
        parambogs.e.setVisibility(0);
        return;
        parambogs.e.setImageResource(2130839361);
      }
    }
    parambogs.e.setVisibility(8);
  }
  
  public void a(SlideItemInfo paramSlideItemInfo)
  {
    Object localObject1 = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq;
    ArrayList localArrayList = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList;
    Object localObject2;
    int i;
    if ((localObject1 != null) && (paramSlideItemInfo != null))
    {
      localObject2 = ((bogq)localObject1).a();
      i = 0;
    ...
    for (;;)
    {
      ...
      {
        paramSlideItemInfo = ((bogq)localObject1).a(i);
        ...
        if ((this.jdField_a_of_type_Akte.isSupportVideoCheckbox) && (localObject2 != null) && ("video".equals(localObject2[0])))
        {
          ...
          ((akte)localObject2).videoSelectedCnt -= 1;
          if (this.jdField_a_of_type_Akte.videoSelectedCnt == 1) {
            this.jdField_a_of_type_Akte.selectedVideoInfo = paramSlideItemInfo;
          }
        }
        ...
        akrx.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent(), "param_cancelSelNum");
        localObject2 = (HashMap)bhkd.sSelectItemPosMap.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId);
        if (localObject2 != null) {
        ...
        if (this.jdField_a_of_type_Bohg != null) {
          this.jdField_a_of_type_Bohg.a(false, paramSlideItemInfo);
        }
        ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(i, false);
        d();
        zkg.a().b(localArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.allMediaInfoHashMap);
      }
      label402:
      ...
      akrx.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent(), "param_cancelSelNum");
      localObject1 = (HashMap)bhkd.sSelectItemPosMap.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId);
      if (localObject1 != null) {
      ...
      ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).h();
      d();
      zkg.a().b(localArrayList, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.allMediaInfoHashMap);
      return;
      label562:
  ...
  {
    Intent localIntent = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
    ArrayList localArrayList = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList;
    ...
    if ((i > 0) && (i < ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq.getItemCount()))
    {
      localObject = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq.a(i);
    ...
    akte.sPhotoListFirstPos = ((GridLayoutManager)((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
    localIntent.putExtra("PhotoConst.CURRENT_SELECTED_INDEX", localArrayList.indexOf(paramString));
    localIntent.setClass(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), NewPhotoPreviewActivity.class);
    localIntent.addFlags(603979776);
    c(localIntent);
    bhkd.anim(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), true, true);
  }
  
  public void a(List<LocalMediaInfo> paramList)
  {
    akre.a(paramList, 0, null, this.jdField_a_of_type_Akte.jdField_c_of_type_JavaUtilHashMap);
  }
  ...
  protected void a(boolean paramBoolean, Intent paramIntent)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if ((localArrayList != null) && (localArrayList.size() > 0)) {
        bdll.b(null, "CliOper", "", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.myUin, "0X8004072", "0X8004072", 0, localArrayList.size(), 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      paramIntent.putExtra("PasterConstants.pasters_data", this.jdField_a_of_type_Akte.jdField_b_of_type_JavaUtilHashMap);
      akte.sPhotoListFirstPos = ((GridLayoutManager)((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getLayoutManager()).findFirstVisibleItemPosition();
      paramIntent.setClass(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), NewPhotoPreviewActivity.class);
      paramIntent.addFlags(603979776);
      c(paramIntent);
      bhkd.anim(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), true, true);
      return;
      paramIntent.putExtra("PhotoConst.SINGLE_PHOTO_PATH", this.jdField_a_of_type_Akte.currentPhotoPath);
    }
  }
  ...
  public boolean a(List<LocalMediaInfo> paramList)
  {
    ...
    int j;
    int k;
    if (this.jdField_a_of_type_Akte.firstResume)
    {
      this.jdField_a_of_type_Akte.firstResume = false;
      if (this.jdField_a_of_type_Akte.photoListStartPos != -1) {
        break label344;
      }
      ...
      Object localObject = (LinkedHashMap)bhkd.sSelectItemPosMap.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId);
      j = i;
      if (localObject != null)
      {
      ...
      {
        i = j;
        if (this.jdField_a_of_type_Akte.isRecodeLastAlbumPath)
        {
      ...
      label296:
      i = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq.getItemCount();
      if (i != 0) {
        break label382;
      }
    }
    for (;;)
    {
      ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.post(new AEPhotoListLogicDefault.8(this));
      return true;
      label344:
      i = this.jdField_a_of_type_Akte.photoListStartPos;
      break;
      label355:
      k += 1;
      break label157;
  ...
  {
    if (!bhjx.a()) {
      QQToast.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131717719), 0).a();
    }
    do
    {
      return;
      paramView = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq.a(paramInt);
    } while (paramView == null);
    Object localObject1 = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
    if (paramView.fileSize > this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.videoSizeLimit)
    {
      paramView = bhlq.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), "你选择的视频文件过大，无法发送。");
    ...
    ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramView.path);
    if (!this.jdField_a_of_type_Akte.jdField_b_of_type_Boolean)
    {
      ...
      PhotoUtils.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), (Intent)localObject1, (ArrayList)localObject2, 2, false);
      return;
    }
    if (!this.jdField_a_of_type_Akte.isSingleMode)
    {
      ...
      localObject1 = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq.a(paramInt);
      ...
      paramView.putExtra("PasterConstants.pasters_data", this.jdField_a_of_type_Akte.jdField_b_of_type_JavaUtilHashMap);
      paramView.setClass(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), NewPhotoPreviewActivity.class);
      paramView.addFlags(603979776);
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size() > 0)) {
        bdll.b(null, "CliOper", "", this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.myUin, "0X8005674", "0X8005674", 0, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size(), 0, "", "", "", "");
      }
    ...
    localObject2 = new Intent(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), ShortVideoPreviewActivity.class);
    ...
    ((Intent)localObject2).putExtra("uin", this.jdField_a_of_type_Akte.jdField_d_of_type_JavaLangString);
    ...
    ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).startActivityForResult((Intent)localObject2, 17);
  }
  ...
  public void c(View paramView)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.isEmpty()) {
      ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size() - 1));
    }
    bhkd.a();
    ...
    if (((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false))
    {
      ...
      if (aunj.a())
      {
        aumw.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), 2131692326, 2131692331, new bohu(this));
        return;
      }
    }
    i();
  ...
  public void c(View paramView, int paramInt)
  {
    ...
    ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).i();
  }
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Akte.requestCode == 100016)
    {
      if (!((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().getBooleanExtra("FROM_QZONR_NO_FINISH", false)) {
        ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().finish();
      }
    }
    else {
    ...
    ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent().removeExtra("FROM_QZONR_NO_FINISH");
    this.jdField_a_of_type_Akte.requestCode = 0;
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumId.equals("$RecentAlbumId")) {
      bdmc.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity()).a(null, "sendAlbumRecent", true, 0L, 0L, null, "");
    }
    for (;;)
    {
      PresendPicMgr.a();
      if ((!this.jdField_a_of_type_Akte.e) || ((TextUtils.isEmpty(this.jdField_a_of_type_Akte.jdField_a_of_type_JavaLangString)) && (TextUtils.isEmpty(this.jdField_a_of_type_Akte.jdField_b_of_type_JavaLangString)))) {
        break;
      }
      return;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName.equalsIgnoreCase("Camera")) || (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName.equalsIgnoreCase("camera")) || (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName.contains("Camera")) || (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.albumName.contains("camera"))) {
        bdmc.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity()).a(null, "sendAlbumRecent", false, 0L, 0L, null, "");
      } else {
        bdmc.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity()).a(null, "sendAlbumOther", true, 0L, 0L, null, "");
      }
    }
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList != null)
    {
      akrx.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size());
      akrx.a(((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList.size(), this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.currentQualityType);
    }
    Intent localIntent = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity().getIntent();
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList != null) {
      alwe.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.selectedPhotoList);
    }
  ...
  {
    Handler localHandler = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidOsHandler;
    ...
    do
    {
      ...
      {
        return;
        localObject = ((bogv)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Bogq;
      } while ((localObject == null) || (((bogq)localObject).a == null));
      localObject = (LocalMediaInfo)((bogq)localObject).a.get(paramInt);
