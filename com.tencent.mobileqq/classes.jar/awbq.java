...
public class awbq
  implements blel
{
  public awbq(UiApiPlugin paramUiApiPlugin, JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void a(blek paramblek)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof BasePluginActivity))
      {
        ...
        ((Intent)localObject2).putExtras(paramblek);
