  ...
  extends xfp
{
  ...
  public awbq(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Awcf = new awcf(paramAppInterface);
  }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        localObject = (awbo)((Map.Entry)localObject).getValue();
        if ((((awbo)localObject).a() & i) != 0)
        {
          localObject = ((awbo)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
    ...
    paramToServiceMsg = (awbo)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).a.a().get(Integer.valueOf(101));
  ...
  private boolean o(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if (localObject != null)
      {
        ...
        bakz.a(arrayOfByte, 0, (short)20002);
        bakz.a(arrayOfByte, 2, s);
        bakz.a(arrayOfByte, 4, (byte[])localObject, localObject.length);
        j = s + 4;
      }
      i = j;
      if (localInteger != null)
      {
        bakz.a(arrayOfByte, j, (short)20031);
        i = j + 2;
        bakz.a(arrayOfByte, i, (short)4);
        i += 2;
        bakz.a(arrayOfByte, i, localInteger.intValue());
        i += 4;
      }
      j = i;
      if (localByte != null)
      {
        bakz.a(arrayOfByte, i, (short)20009);
        i += 2;
        bakz.a(arrayOfByte, i, (short)1);
        i += 2;
      ...
      {
        bakz.a(arrayOfByte, j, (short)20032);
        i = j + 2;
        bakz.a(arrayOfByte, i, (short)12);
        i += 2;
        bakz.a(arrayOfByte, i, arrayOfInteger[0].intValue());
        i += 4;
        bakz.a(arrayOfByte, i, arrayOfInteger[1].intValue());
        i += 4;
        bakz.a(arrayOfByte, i, arrayOfInteger[2].intValue());
      }
  ...
  private boolean r(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    ajjj localajjj = (ajjj)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
    ...
    if (i < k)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (j != 1)
          {
            localObject = localajjj.a((String)localObject);
            if (localObject != null)
            {
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    return this.jdField_a_of_type_Awcf.a(paramToServiceMsg, paramFromServiceMsg);
  }
  ...
  public boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    return this.jdField_a_of_type_Awcf.a(paramToServiceMsg, paramUniPacket);
  }
}
