...
public class aqvq
{
  ...
  public WeakReference<aqwl> a;
  public HashSet<String> a;
  
  public aqvq(BaseActivity paramBaseActivity, aqwl paramaqwl)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_JavaUtilHashSet = bbei.a(paramBaseActivity);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaqwl);
  }
  ...
  public ArrayList<String> a(Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && ((paramBundle instanceof ArrayList)))
    {
      ...
      aqvt localaqvt = new aqvt(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, null);
      int i = 0;
      while (i < paramBundle.size())
      {
        String str = localaqvt.a((Uri)paramBundle.get(i), false);
  ...
  public void a(String paramString)
  {
    ...
    aqwi localaqwi = (aqwi)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
    ...
    paramString = (aqwl)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
      localaqwi.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, "android.intent.action.SEND", paramString);
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localaqwi = (aqwi)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(311);
      ...
      if ((!TextUtils.isEmpty(paramString1)) && (new File(paramString1).exists()))
      {
        ...
        String str = bbdm.a(apue.d(paramString1));
        ...
        localVideoInfo.sha1.set(aqvs.a(paramString1));
        localVideoInfo.play_duration.set((int)l);
        localCheckShareExtensionReq.videos.add(localVideoInfo);
      }
      paramString1 = (aqwl)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramString1 == null);
    localaqwi.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString2, paramString1);
  }
  ...
  public void a(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            String str = bbdm.a(apue.d((String)localObject2));
            if (QLog.isColorLevel()) {
              QLog.d("CheckForward.Security", 2, "sendCheckImgShareReq md5= " + str);
            }
            localImgInfo.md5.set(str);
            localImgInfo.sha1.set(aqvs.a((String)localObject2));
            localObject2 = aqvs.a((String)localObject2);
            ...
            localObject1 = aqvs.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (File)localObject1);
      ...
      paramArrayList = (aqwl)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramArrayList == null);
    localaqwi.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localCheckShareExtensionReq, paramString, paramArrayList);
  }
  ...
  public boolean a(Uri paramUri, int paramInt, String paramString)
  {
    if (this.jdField_a_of_type_Aqvt == null) {
      this.jdField_a_of_type_Aqvt = new aqvt(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, false, new aqvr(this, paramInt, paramString));
    }
    String str = this.jdField_a_of_type_Aqvt.a(paramUri);
    ...
    {
      return false;
      if ((this.jdField_a_of_type_Aqvt.b) || (this.jdField_a_of_type_Aqvt.a)) {
        return true;
      }
      paramUri = new File(str);
      l = paramUri.length();
    } while ((!this.jdField_a_of_type_Aqvt.b) && (!this.jdField_a_of_type_Aqvt.a) && (l == 0L));
    if ((aqca.b(str)) || (!paramUri.canRead()))
    {
