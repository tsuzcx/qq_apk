  ...
  extends biwa
{
  ...
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { ajyc.a(2131689815), ajyc.a(2131689816), ajyc.a(2131689817) };
  ...
  public biru(Activity paramActivity, View paramView, biwb parambiwb)
  {
  ...
  private void a(Runnable paramRunnable)
  {
    ...
    localAnimationSet.setAnimationListener(new birw(this, paramRunnable));
  ...
  {
    if (!this.jdField_b_of_type_Boolean) {}
    while (bizj.a().a("has_enter_aio_gif", false, 0)) {
      return false;
    }
    return true;
  }
  ...
  {
    int i = 200;
    Intent localIntent = this.jdField_a_of_type_Biim.a().getIntent();
    if (localIntent != null) {
  ...
  private void e()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimation.setAnimationListener(new birv(this));
  ...
  private void f()
  {
    ...
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.setAnimationListener(new birx(this));
    this.jdField_b_of_type_AndroidViewView.startAnimation(localAnimationSet);
  }
  ...
  private void k()
  {
    ...
    bizj.a().a("has_enter_aio_gif", true, 0);
  }
