...
public class aeul
  implements anpd, anpe
{
  private int jdField_a_of_type_Int;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<JumpActivity> jdField_a_of_type_JavaLangRefWeakReference;
  
  public aeul(JumpActivity paramJumpActivity, int paramInt, String paramString)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      amsx localamsx = (amsx)localJumpActivity.app.getManager(153);
      ...
      localStartCheckParam.version = localamsx.a(this.jdField_a_of_type_Int);
      ApolloGameUtil.a(localJumpActivity, localStartCheckParam);
      JumpActivity.a(localJumpActivity, true);
      localJumpActivity.b();
      return;
    }
    QQToast.a(BaseApplicationImpl.getApplication(), anzj.a(2131704812), 0).a();
  ...
  public void b(boolean paramBoolean)
  {
    ...
    localWebProcessManager.a(100, new aeum(this, localJumpActivity));
    return;
    QQToast.a(BaseApplicationImpl.getApplication(), anzj.a(2131704811), 0).a();
  ...
  {
    if ((paramObject instanceof aeul))
    {
      paramObject = (aeul)paramObject;
