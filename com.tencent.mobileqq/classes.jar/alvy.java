  ...
  extends IArkDelegateNet
{
  public void download(String paramString, boolean paramBoolean1, boolean paramBoolean2, HashMap<String, String> paramHashMap, File paramFile, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    for (paramFile = paramFile.getAbsolutePath();; paramFile = "")
    {
      ...
      alvj.a().a("callDownload", (Bundle)localObject, new alwb(this, paramString, paramIArkDelegateNetCallback));
      return;
      str = "";
      break;
      paramHashMap = "";
    ...
    label175:
    Object localObject = ((bbww)BaseApplicationImpl.getApplication().getRuntime().getManager(47)).a(1);
    paramFile = new bbwu(paramString, new File(paramFile));
    ...
    ((bbwz)localObject).a(paramFile, new alwc(this, paramString, paramIArkDelegateNetCallback), paramHashMap);
  }
  
  public int getNetworkType()
  {
    return bbfj.b(BaseApplication.getContext());
  }
  ...
  public void sendAppMsg(String paramString1, String paramString2, int paramInt1, int paramInt2, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      alvj.a().a("callSendAppMsg", (Bundle)localObject, new alvz(this, paramString1, paramString2, paramIArkDelegateNetCallback, paramInt2));
      return;
    }
    ...
    ((altm)localObject).a(paramString1, paramString2, paramInt1, paramInt2, new alwa(this, paramIArkDelegateNetCallback));
  }
}
