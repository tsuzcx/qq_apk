  ...
  implements QIMInformationPasterManager.IInformationPasterResDownloaderCallback
{
  ...
  public ankk(InformationFaceAdapter paramInformationFaceAdapter, QIMCommonLoadingView paramQIMCommonLoadingView, ImageView paramImageView)
  {
  ...
  public void a(float paramFloat, String paramString, int paramInt)
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.post(new ankl(this, paramInt));
  }
  ...
  public void a(boolean paramBoolean, String paramString, InfomationFacePackage.Item paramItem)
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewQIMCommonLoadingView.post(new ankm(this, paramBoolean, paramItem));
  }
}
