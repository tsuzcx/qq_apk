...
public abstract class bpaw
{
  ...
  public bpaw(@NonNull String paramString)
  {
  ...
  public void a(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ykq.e("FacePackage", "config json is empty.");
      i = 0;
      if (i == 0)
      {
        ykq.e("FacePackage", "config json is illegal, use default value, type : %s", new Object[] { a() });
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            ykq.e("FacePackage", "config json is illegal : %s", new Object[] { paramString });
            i = 0;
            break;
          }
          this.f = paramString;
        ...
        {
          ykq.e("FacePackage", "parse config json error : " + paramString + ", exception : " + localException.toString());
          i = 0;
        }
      }
      break;
